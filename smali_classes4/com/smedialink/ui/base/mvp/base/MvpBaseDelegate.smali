.class public abstract Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;
.super Ljava/lang/Object;
.source "MvpBaseDelegate.kt"

# interfaces
.implements Lcom/smedialink/ui/base/mvp/base/BaseDelegate;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        ">",
        "Ljava/lang/Object;",
        "Lcom/smedialink/ui/base/mvp/base/BaseDelegate<",
        "TT;>;"
    }
.end annotation
...
.field private final resettableLazyManager:Lcom/smedialink/utils/extentions/delegate/ResettableLazyManager;
...
.method public constructor <init>()V
    ...
    .line 20
    new-instance v0, Lcom/smedialink/utils/extentions/delegate/ResettableLazyManager;

    invoke-direct {v0}, Lcom/smedialink/utils/extentions/delegate/ResettableLazyManager;-><init>()V

    iput-object v0, p0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->resettableLazyManager:Lcom/smedialink/utils/extentions/delegate/ResettableLazyManager;
    ...
    iput-object v0, p0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->viewHandler:Landroid/os/Handler;

    .line 26
    new-instance v0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate$progressDialog$2;

    invoke-direct {v0, p0}, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate$progressDialog$2;-><init>(Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;)V

    invoke-static {v0}, Lkotlin/LazyKt;->lazy(Lkotlin/jvm/functions/Function0;)Lkotlin/Lazy;

    move-result-object v0

    iput-object v0, p0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->progressDialog$delegate:Lkotlin/Lazy;
...
.method private final getProgressDialog()Lorg/telegram/ui/ActionBar/AlertDialog;
    ...
    .line 26
    iget-object v0, p0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->progressDialog$delegate:Lkotlin/Lazy;
...
.method private static final showLoadingDialog$lambda-2(Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;ZZLio/reactivex/disposables/Disposable;)V
    ...
    .line 99
    invoke-interface {p0}, Lcom/smedialink/ui/base/mvp/base/BaseDelegate;->getContext()Landroid/content/Context;
    ...
    .line 104
    new-instance p1, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate$$ExternalSyntheticLambda0;

    invoke-direct {p1, p3}, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate$$ExternalSyntheticLambda0;-><init>(Lio/reactivex/disposables/Disposable;)V
...
.method public getMvpDelegate()Lmoxy/MvpDelegate;
    ...
    .line 86
    iget-object v0, p0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->mMvpDelegate:Lmoxy/MvpDelegate;
    ...
    .line 89
    :cond_0
    invoke-interface {p0}, Lcom/smedialink/ui/base/mvp/base/BaseDelegate;->createDelegate()Lmoxy/MvpDelegate;

    move-result-object v0

    iput-object v0, p0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->mMvpDelegate:Lmoxy/MvpDelegate;

    return-object v0
.end method

.method public getResettableLazyManager()Lcom/smedialink/utils/extentions/delegate/ResettableLazyManager;
    .locals 1

    .line 20
    iget-object v0, p0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->resettableLazyManager:Lcom/smedialink/utils/extentions/delegate/ResettableLazyManager;
...
.method public getViewHandler()Landroid/os/Handler;
    ...
    .line 21
    iget-object v0, p0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->viewHandler:Landroid/os/Handler;
...
.method public onDetachedFromWindow()V
    ...
    .line 69
    invoke-virtual {p0}, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->getViewHandler()Landroid/os/Handler;
    ...
    .line 70
    invoke-virtual {p0}, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;->getResettableLazyManager()Lcom/smedialink/utils/extentions/delegate/ResettableLazyManager;

    move-result-object v0

    invoke-virtual {v0}, Lcom/smedialink/utils/extentions/delegate/ResettableLazyManager;->destroy()V
...
.method public showLoadingDialog(ZZLio/reactivex/disposables/Disposable;)V
    ...
    .line 98
    new-instance v0, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0, p1, p2, p3}, Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate$$ExternalSyntheticLambda1;-><init>(Lcom/smedialink/ui/base/mvp/base/MvpBaseDelegate;ZZLio/reactivex/disposables/Disposable;)V
