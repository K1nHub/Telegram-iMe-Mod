.class public final Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter$Companion;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public constructor <init>(Lcom/smedialink/storage/domain/model/catalog/ChatType;Lcom/smedialink/storage/domain/interactor/catalog/CatalogInteractor;Lcom/smedialink/storage/domain/utils/system/ResourceManager;Lcom/smedialink/storage/domain/utils/rx/SchedulersProvider;Lcom/smedialink/manager/TelegramApi;)V
    ...
    .line 29
    iput-object p1, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->chatType:Lcom/smedialink/storage/domain/model/catalog/ChatType;

    .line 30
    iput-object p2, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->catalogInteractor:Lcom/smedialink/storage/domain/interactor/catalog/CatalogInteractor;

    .line 31
    iput-object p3, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->resourceManager:Lcom/smedialink/storage/domain/utils/system/ResourceManager;

    .line 32
    iput-object p4, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->schedulersProvider:Lcom/smedialink/storage/domain/utils/rx/SchedulersProvider;

    .line 33
    iput-object p5, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->telegramApi:Lcom/smedialink/manager/TelegramApi;
    ...
    iput-object p1, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->channelsByCategories:Ljava/util/Map;
    ...
    iput-object p1, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->categoriesChannelsCursors:Ljava/util/Map;
    ...
    iput-object p1, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->categories:Ljava/util/List;

    return-void
.end method

.method public static final synthetic access$getCategoryAll(Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;)Lcom/smedialink/model/catalog/CategoryItem;
    .locals 0

    .line 27
    invoke-direct {p0}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->getCategoryAll()Lcom/smedialink/model/catalog/CategoryItem;
...
.method public static final synthetic access$getChatType$p(Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;)Lcom/smedialink/storage/domain/model/catalog/ChatType;
    .locals 0

    .line 27
    iget-object p0, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->chatType:Lcom/smedialink/storage/domain/model/catalog/ChatType;

    return-object p0
.end method

.method public static final synthetic access$processChannelsResult(Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;Lcom/smedialink/storage/domain/model/Result;Z)V
    .locals 0

    .line 27
    invoke-direct {p0, p1, p2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->processChannelsResult(Lcom/smedialink/storage/domain/model/Result;Z)V

    return-void
.end method

.method public static final synthetic access$setCategories$p(Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;Ljava/util/List;)V
    .locals 0
...
.method private final getCategoriesObservable(Lcom/smedialink/storage/domain/model/Result;Z)Lio/reactivex/Observable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 27
    new-instance v0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter$getCategoriesObservable$$inlined$mapSuccess$1;
...
.method private final getCategoryAll()Lcom/smedialink/model/catalog/CategoryItem;
    .locals 5

    .line 236
    new-instance v0, Lcom/smedialink/model/catalog/CategoryItem;
    ...
    .line 236
    invoke-direct {v0, v2, v3, v1, v4}, Lcom/smedialink/model/catalog/CategoryItem;-><init>(JLjava/lang/String;Z)V
...
.method private final getNodesWithCategoriesFilter(Ljava/util/List;)Ljava/util/List;
    ...
    .line 231
    new-instance v1, Lcom/smedialink/model/catalog/CategoriesFilterItem;
    ...
    invoke-direct {v1, v2}, Lcom/smedialink/model/catalog/CategoriesFilterItem;-><init>(Ljava/util/List;)V
...
.method private final getSelectedCategoryId()J
    ...
    check-cast v2, Lcom/smedialink/model/catalog/CategoryItem;

    .line 40
    invoke-virtual {v2}, Lcom/smedialink/model/catalog/CategoryItem;->isSelected()Z
    ...
    :goto_0
    check-cast v1, Lcom/smedialink/model/catalog/CategoryItem;
    ...
    :cond_2
    invoke-virtual {v1}, Lcom/smedialink/model/catalog/CategoryItem;->getId()J
...
.method private final loadInitial(Z)V
    ...
    .line 44
    new-instance v0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter$loadInitial$$inlined$subscribeWithErrorHandle$default$1;
...
.method static synthetic loadInitial$default(Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;ZILjava/lang/Object;)V
    .locals 0
    ...
    .line 118
    :cond_0
    invoke-direct {p0, p1}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->loadInitial(Z)V
...
.method private final onChannelsLoading(Z)V
    ...
    invoke-direct {v1, v2}, Lcom/smedialink/model/common/GlobalStateItem;-><init>(Lcom/smedialink/model/state/GlobalState;)V
...
.method private final onChannelsLoadingError(Lcom/smedialink/storage/data/network/model/error/ErrorModel;Z)V
    .locals 1
    ...
    iget-object v0, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->resourceManager:Lcom/smedialink/storage/domain/utils/system/ResourceManager;
    ...
    sget-object p1, Lcom/smedialink/model/state/GlobalState$NoInternet;->INSTANCE:Lcom/smedialink/model/state/GlobalState$NoInternet;
...
.method private final onChannelsLoadingSuccess(Lcom/smedialink/storage/domain/model/catalog/CampaignsCursored;Z)V
    ...
    invoke-static {v0}, Lcom/smedialink/mapper/catalog/CatalogCampaignsUiMappingKt;->mapToUi(Ljava/util/List;)Ljava/util/List;
    ...
    sget-object v3, Lcom/smedialink/model/state/GlobalState$Empty$Common;->INSTANCE:Lcom/smedialink/model/state/GlobalState$Empty$Common;

    invoke-direct {v2, v3}, Lcom/smedialink/model/common/GlobalStateItem;-><init>(Lcom/smedialink/model/state/GlobalState;)V
    ...
    invoke-interface {p2}, Lcom/smedialink/ui/base/mvp/LoadMoreView;->onLoadMoreComplete()V
    ...
    invoke-direct {p0, v0}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->getNodesWithCategoriesFilter(Ljava/util/List;)Ljava/util/List;
...
.method private final processChannelsResult(Lcom/smedialink/storage/domain/model/Result;Z)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->onChannelsLoadingSuccess(Lcom/smedialink/storage/domain/model/catalog/CampaignsCursored;Z)V
    ...
    invoke-direct {p0, p2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->onChannelsLoading(Z)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->onChannelsLoadingError(Lcom/smedialink/storage/data/network/model/error/ErrorModel;Z)V
...
.method public static synthetic reloadAll$default(Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;ZILjava/lang/Object;)V
    .locals 0
    ...
    .line 45
    :cond_0
    invoke-virtual {p0, p1}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->reloadAll(Z)V

    return-void
.end method

.method public static synthetic reloadChannels$default(Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;ZZILjava/lang/Object;)V
    .locals 1
    ...
    .line 50
    :cond_1
    invoke-virtual {p0, p1, p2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->reloadChannels(ZZ)V
...
.method public final loadChannels(Z)V
    ...
    .line 87
    iget-object v1, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->schedulersProvider:Lcom/smedialink/storage/domain/utils/rx/SchedulersProvider;
    ...
    .line 44
    new-instance v1, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter$loadChannels$$inlined$subscribeWithErrorHandle$default$1;
...
.method public final onCategorySelected(J)V
    ...
    invoke-interface {v0}, Lcom/smedialink/ui/base/mvp/LoadMoreView;->onLoadMoreComplete()V
    ...
    check-cast v5, Lcom/smedialink/model/catalog/CategoryItem;
    ...
    .line 70
    invoke-virtual {v5}, Lcom/smedialink/model/catalog/CategoryItem;->getId()J
    ...
    invoke-static/range {v5 .. v11}, Lcom/smedialink/model/catalog/CategoryItem;->copy$default(Lcom/smedialink/model/catalog/CategoryItem;JLjava/lang/String;ZILjava/lang/Object;)Lcom/smedialink/model/catalog/CategoryItem;
    ...
    .line 69
    :cond_2
    iput-object v1, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->categories:Ljava/util/List;
    ...
    check-cast v1, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesView;
    ...
    invoke-direct {p0, v2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->getNodesWithCategoriesFilter(Ljava/util/List;)Ljava/util/List;

    move-result-object v2

    invoke-interface {v1, v2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesView;->renderNodes(Ljava/util/List;)V
    ...
    .line 75
    invoke-virtual {p0, v4}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->loadChannels(Z)V

    goto :goto_4

    .line 77
    :cond_6
    iget-object v0, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->categoriesChannelsCursors:Ljava/util/Map;
...
.method public final onChannelClick(Lcom/smedialink/model/catalog/CampaignItem;)V
    ...
    .line 93
    iget-object v0, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->telegramApi:Lcom/smedialink/manager/TelegramApi;
    ...
    .line 44
    new-instance v1, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter$onChannelClick$$inlined$subscribeWithErrorHandle$default$1;
...
.method protected onFirstViewAttach()V
    ...
    .line 111
    invoke-static {p0, v0, v1, v2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->loadInitial$default(Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;ZILjava/lang/Object;)V
...
.method public final reloadAll(Z)V
    ...
    iput-object v0, p0, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->categories:Ljava/util/List;

    const/4 v0, 0x1

    .line 47
    invoke-virtual {p0, v0, p1}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->reloadChannels(ZZ)V
...
.method public final reloadChannels(ZZ)V
    ...
    sget-object v2, Lcom/smedialink/model/state/GlobalState$Empty$Common;->INSTANCE:Lcom/smedialink/model/state/GlobalState$Empty$Common;

    invoke-direct {v0, v2}, Lcom/smedialink/model/common/GlobalStateItem;-><init>(Lcom/smedialink/model/state/GlobalState;)V
    ...
    invoke-interface {p1, p2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesView;->renderNodes(Ljava/util/List;)V
    ...
    .line 59
    invoke-direct {p0, p2}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->loadInitial(Z)V

    goto :goto_0

    .line 61
    :cond_1
    invoke-virtual {p0, v1}, Lcom/smedialink/ui/catalog/tabs/categories/CatalogCategoriesPresenter;->loadChannels(Z)V
