...
.method public static final mapToDomain(Lcom/iMe/storage/data/network/model/response/crypto/swap/AvailableSwapTokensResponse;)Lcom/iMe/storage/domain/model/common/CursoredData;
    ...
    .line 1621
    check-cast v2, Lcom/iMe/storage/data/network/model/response/wallet/TokenDetailedWithRateResponse;

    .line 18
    invoke-static {v2}, Lcom/iMe/storage/data/mapper/wallet/TokenMappingKt;->mapToDomain(Lcom/iMe/storage/data/network/model/response/wallet/TokenDetailedWithRateResponse;)Lcom/iMe/storage/domain/model/wallet/token/TokenDetailedWithRate;
...
.method public static final mapToDomain(Lcom/iMe/storage/data/network/model/response/crypto/swap/TokensApprovalInfoResponse;)Ljava/util/List;
    ...
    sget-object v4, Lcom/iMe/storage/data/mapper/crypto/SwapMappingKt$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    .line 51
    new-instance v2, Lcom/iMe/storage/domain/model/crypto/swap/TokenApproveData$NeedApprove$NotAllowed;

    move-object v4, v2

    invoke-direct/range {v4 .. v9}, Lcom/iMe/storage/domain/model/crypto/swap/TokenApproveData$NeedApprove$NotAllowed;-><init>(Lcom/iMe/storage/domain/model/wallet/token/TokenDetailed;Ljava/lang/String;Lcom/iMe/storage/domain/model/crypto/TransactionParams$Ether;Ljava/lang/String;Lcom/iMe/storage/domain/model/wallet/token/TokenDetailed;)V
    ...
    .line 44
    :cond_1
    new-instance v3, Lcom/iMe/storage/domain/model/crypto/swap/TokenApproveData$InProgress;
    ...
    .line 44
    invoke-direct {v3, v4, v2}, Lcom/iMe/storage/domain/model/crypto/swap/TokenApproveData$InProgress;-><init>(Lcom/iMe/storage/domain/model/wallet/token/TokenDetailed;Ljava/lang/String;)V
    ...
    .line 33
    new-instance v2, Lcom/iMe/storage/domain/model/crypto/swap/TokenApproveData$NeedApprove$Error;
    ...
    .line 26
    :cond_4
    new-instance v3, Lcom/iMe/storage/domain/model/crypto/swap/TokenApproveData$Allowed;
    ...
    .line 26
    invoke-direct {v3, v4, v2}, Lcom/iMe/storage/domain/model/crypto/swap/TokenApproveData$Allowed;-><init>(Lcom/iMe/storage/domain/model/wallet/token/TokenDetailed;Ljava/lang/String;)V
