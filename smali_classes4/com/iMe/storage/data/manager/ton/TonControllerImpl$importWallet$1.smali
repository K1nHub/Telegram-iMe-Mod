...
# direct methods
.method public static synthetic $r8$lambda$5TNvPBvAyATCwQVSi2gU18wPWWE(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;Ljava/lang/Object;)Lio/reactivex/ObservableSource;
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/iMe/storage/data/manager/ton/TonControllerImpl$importWallet$1;->invoke$lambda$1(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;Ljava/lang/Object;)Lio/reactivex/ObservableSource;
...
.method public static synthetic $r8$lambda$EvNyZMErOEb77rys7usrXgJDrec(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;Ljava/lang/Object;)Lio/reactivex/ObservableSource;
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/iMe/storage/data/manager/ton/TonControllerImpl$importWallet$1;->invoke$lambda$1$lambda$0(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;Ljava/lang/Object;)Lio/reactivex/ObservableSource;
...
.method constructor <init>(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final invoke$lambda$1(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;Ljava/lang/Object;)Lio/reactivex/ObservableSource;
    .locals 4
    ...
    .line 121
    new-instance p2, Ldrinkless/org/ton/TonApi$ImportKey;
    ...
    .line 121
    invoke-direct {p2, v1, v2, v3}, Ldrinkless/org/ton/TonApi$ImportKey;-><init>([B[BLdrinkless/org/ton/TonApi$ExportedKey;)V
    ...
    .line 128
    new-instance v0, Lcom/iMe/storage/data/manager/ton/TonControllerImpl$importWallet$1$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0, p1}, Lcom/iMe/storage/data/manager/ton/TonControllerImpl$importWallet$1$$ExternalSyntheticLambda1;-><init>(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;)V
...
.method private static final invoke$lambda$1$lambda$0(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;Ljava/lang/Object;)Lio/reactivex/ObservableSource;
    .locals 1
    ...
    check-cast p2, Ldrinkless/org/ton/TonApi$Key;

    invoke-static {p0, p2, p1}, Lcom/iMe/storage/data/manager/ton/TonControllerImpl;->access$processInputKey(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ldrinkless/org/ton/TonApi$Key;Ljava/util/List;)Lio/reactivex/Observable;
...
.method public final invoke(Ljava/lang/Boolean;)Lio/reactivex/ObservableSource;
    ...
    new-instance v2, Lcom/iMe/storage/data/manager/ton/TonControllerImpl$importWallet$1$$ExternalSyntheticLambda0;

    invoke-direct {v2, v0, v1}, Lcom/iMe/storage/data/manager/ton/TonControllerImpl$importWallet$1$$ExternalSyntheticLambda0;-><init>(Lcom/iMe/storage/data/manager/ton/TonControllerImpl;Ljava/util/List;)V
