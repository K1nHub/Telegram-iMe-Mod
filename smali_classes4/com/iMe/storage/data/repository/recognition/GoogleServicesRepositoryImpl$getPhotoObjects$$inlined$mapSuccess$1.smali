.class public final Lcom/iMe/storage/data/repository/recognition/GoogleServicesRepositoryImpl$getPhotoObjects$$inlined$mapSuccess$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/iMe/storage/data/repository/recognition/GoogleServicesRepositoryImpl;->getPhotoObjects(Landroid/graphics/Bitmap;)Lio/reactivex/Observable;
.end annotation
...
.method public constructor <init>(Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lcom/iMe/storage/data/repository/recognition/GoogleServicesRepositoryImpl$getPhotoObjects$$inlined$mapSuccess$1;->$errorHandler:Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;

    iput-object p2, p0, Lcom/iMe/storage/data/repository/recognition/GoogleServicesRepositoryImpl$getPhotoObjects$$inlined$mapSuccess$1;->$file$inlined:Ljava/io/File;
...
.method public final invoke(Lcom/iMe/storage/data/network/model/response/base/ApiBaseResponse;)Lcom/iMe/storage/domain/model/Result;
    ...
    .line 87
    :try_start_0
    iget-object v0, p0, Lcom/iMe/storage/data/repository/recognition/GoogleServicesRepositoryImpl$getPhotoObjects$$inlined$mapSuccess$1;->$file$inlined:Ljava/io/File;
    ...
    invoke-static {p1}, Lcom/iMe/storage/data/mapper/google/GoogleServicesMapperKt;->toDomain(Lcom/iMe/storage/data/network/model/response/google/ImageToObjectsResponse;)Ljava/util/List;
    ...
    .line 72
    :cond_0
    iget-object v0, p0, Lcom/iMe/storage/data/repository/recognition/GoogleServicesRepositoryImpl$getPhotoObjects$$inlined$mapSuccess$1;->$errorHandler:Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/iMe/storage/data/repository/recognition/GoogleServicesRepositoryImpl$getPhotoObjects$$inlined$mapSuccess$1;->invoke(Lcom/iMe/storage/data/network/model/response/base/ApiBaseResponse;)Lcom/iMe/storage/domain/model/Result;
