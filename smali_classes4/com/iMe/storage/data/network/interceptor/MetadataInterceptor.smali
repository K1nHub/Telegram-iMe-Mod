...
.method public constructor <init>()V
    ...
    .line 17
    iput-object v1, p0, Lcom/iMe/storage/data/network/interceptor/MetadataInterceptor;->walletSessionRepository$delegate:Lkotlin/Lazy;
...
.method private final getWalletSessionRepository()Lcom/iMe/storage/domain/repository/wallet/WalletSessionRepository;
    .locals 1

    .line 17
    iget-object v0, p0, Lcom/iMe/storage/data/network/interceptor/MetadataInterceptor;->walletSessionRepository$delegate:Lkotlin/Lazy;

    invoke-interface {v0}, Lkotlin/Lazy;->getValue()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/iMe/storage/domain/repository/wallet/WalletSessionRepository;
...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 23
    invoke-direct {p0}, Lcom/iMe/storage/data/network/interceptor/MetadataInterceptor;->getWalletSessionRepository()Lcom/iMe/storage/domain/repository/wallet/WalletSessionRepository;
    ...
    .line 24
    invoke-interface {v0, v1}, Lcom/iMe/storage/domain/repository/wallet/WalletSessionRepository;->getCurrentAccountToken(Z)Lio/reactivex/Observable;
    ...
    invoke-interface {v3}, Lcom/iMe/storage/domain/gateway/TelegramGateway;->getDeviceId()Ljava/lang/String;
    ...
    invoke-interface {v3}, Lcom/iMe/storage/domain/gateway/TelegramGateway;->getAppVersion()Ljava/lang/String;
    ...
    .line 35
    sget-object v4, Lcom/iMe/storage/data/network/interceptor/MetadataInterceptor;->Companion:Lcom/iMe/storage/data/network/interceptor/MetadataInterceptor$Companion;

    const-string v5, "token"

    invoke-static {v0, v5}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v4, v0}, Lcom/iMe/storage/data/network/interceptor/MetadataInterceptor$Companion;->formatAuthToken(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {v0, v1}, Lcom/iMe/storage/data/network/interceptor/MetadataInterceptor$Companion;->formatAuthToken(Ljava/lang/String;)Ljava/lang/String;
