...
.method public constructor <init>(JLjava/lang/String;Lcom/iMe/storage/data/repository/topics/Topic;ILjava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 11
    iput-object p6, p0, Lcom/iMe/storage/domain/model/topics/TopicModel;->presets:Ljava/util/Set;

    .line 12
    iput-object p7, p0, Lcom/iMe/storage/domain/model/topics/TopicModel;->dialogs:Ljava/util/Set;

    .line 13
    iput-object p8, p0, Lcom/iMe/storage/domain/model/topics/TopicModel;->filterDialogs:Ljava/util/Set;

    .line 14
    iput-object p9, p0, Lcom/iMe/storage/domain/model/topics/TopicModel;->filterArchivedDialogs:Ljava/util/Set;

    return-void
.end method

.method public synthetic constructor <init>(JLjava/lang/String;Lcom/iMe/storage/data/repository/topics/Topic;ILjava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 12
    ...
    .line 6
    invoke-direct/range {v2 .. v11}, Lcom/iMe/storage/domain/model/topics/TopicModel;-><init>(JLjava/lang/String;Lcom/iMe/storage/data/repository/topics/Topic;ILjava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)V

    return-void
.end method

.method public static synthetic copy$default(Lcom/iMe/storage/domain/model/topics/TopicModel;JLjava/lang/String;Lcom/iMe/storage/data/repository/topics/Topic;ILjava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;ILjava/lang/Object;)Lcom/iMe/storage/domain/model/topics/TopicModel;
    .locals 10
    ...
    iget-object v7, v0, Lcom/iMe/storage/domain/model/topics/TopicModel;->presets:Ljava/util/Set;
    ...
    iget-object v8, v0, Lcom/iMe/storage/domain/model/topics/TopicModel;->dialogs:Ljava/util/Set;
    ...
    iget-object v9, v0, Lcom/iMe/storage/domain/model/topics/TopicModel;->filterDialogs:Ljava/util/Set;
    ...
    invoke-virtual/range {p0 .. p9}, Lcom/iMe/storage/domain/model/topics/TopicModel;->copy(JLjava/lang/String;Lcom/iMe/storage/data/repository/topics/Topic;ILjava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)Lcom/iMe/storage/domain/model/topics/TopicModel;
...
.method public final copy(JLjava/lang/String;Lcom/iMe/storage/data/repository/topics/Topic;ILjava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)Lcom/iMe/storage/domain/model/topics/TopicModel;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-direct/range {v1 .. v10}, Lcom/iMe/storage/domain/model/topics/TopicModel;-><init>(JLjava/lang/String;Lcom/iMe/storage/data/repository/topics/Topic;ILjava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)V
