...
.method private synthetic lambda$setWallpaperToPeer$11(Lorg/telegram/tgnet/TLObject;JZLjava/lang/String;Ljava/lang/Runnable;)V
    ...
    .line 640
    iget-object v6, v5, Lorg/telegram/tgnet/TLRPC$UserFull;->wallpaper:Lorg/telegram/tgnet/TLRPC$WallPaper;
    ...
    .line 642
    iget-object v6, v7, Lorg/telegram/tgnet/TLRPC$ChatFull;->wallpaper:Lorg/telegram/tgnet/TLRPC$WallPaper;
    ...
    .line 651
    iget-object v9, v6, Lorg/telegram/tgnet/TLRPC$WallPaper;->uploadingImage:Ljava/lang/String;
    ...
    iput-object v6, v4, Lorg/telegram/tgnet/TLRPC$WallPaper;->stripedThumb:Landroid/graphics/Bitmap;
    ...
    .line 655
    iget-object v7, v10, Lorg/telegram/tgnet/TLRPC$MessageAction;->wallpaper:Lorg/telegram/tgnet/TLRPC$WallPaper;

    iput-object v7, v5, Lorg/telegram/tgnet/TLRPC$UserFull;->wallpaper:Lorg/telegram/tgnet/TLRPC$WallPaper;
    ...
    .line 657
    invoke-virtual {p0, v2, v3, v7}, Lorg/telegram/messenger/ChatThemeController;->saveChatWallpaper(JLorg/telegram/tgnet/TLRPC$WallPaper;)V
    ...
    invoke-virtual {v7, v5, v8}, Lorg/telegram/messenger/MessagesStorage;->updateUserInfo(Lorg/telegram/tgnet/TLRPC$UserFull;Z)V
    ...
    invoke-virtual {v7, v9, v4}, Lorg/telegram/messenger/NotificationCenter;->postNotificationName(I[Ljava/lang/Object;)V
    ...
    iput-object v5, v7, Lorg/telegram/tgnet/TLRPC$ChatFull;->wallpaper:Lorg/telegram/tgnet/TLRPC$WallPaper;

    .line 662
    iget v9, v7, Lorg/telegram/tgnet/TLRPC$ChatFull;->flags2:I

    or-int/lit16 v9, v9, 0x80

    iput v9, v7, Lorg/telegram/tgnet/TLRPC$ChatFull;->flags2:I
    ...
    invoke-virtual {v2, v7, v8}, Lorg/telegram/messenger/MessagesStorage;->updateChatInfo(Lorg/telegram/tgnet/TLRPC$ChatFull;Z)V
...
.method public clearWallpaper(JZZ)V
    ...
    invoke-virtual {p4, v1}, Lorg/telegram/messenger/MessagesController;->getChat(Ljava/lang/Long;)Lorg/telegram/tgnet/TLRPC$Chat;
    ...
    invoke-virtual {p4, v6, v7}, Lorg/telegram/messenger/MessagesController;->getChatFull(J)Lorg/telegram/tgnet/TLRPC$ChatFull;
...
.method public requestAllChatThemes(Lorg/telegram/tgnet/ResultCallback;Z)V
    ...
    invoke-direct {v3, p0, p1, p2}, Lorg/telegram/messenger/ChatThemeController$$ExternalSyntheticLambda10;-><init>(Lorg/telegram/messenger/ChatThemeController;Lorg/telegram/tgnet/ResultCallback;Z)V
...
.method public setWallpaperToPeer(JLjava/lang/String;Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;Lorg/telegram/messenger/MessageObject;Ljava/lang/Runnable;)I
    ...
    iput-object v6, v8, Lorg/telegram/tgnet/TLRPC$TL_messages_setChatWallPaper;->peer:Lorg/telegram/tgnet/TLRPC$InputPeer;
    ...
    .line 546
    :goto_0
    iget-boolean v6, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->forBoth:Z

    iput-boolean v6, v8, Lorg/telegram/tgnet/TLRPC$TL_messages_setChatWallPaper;->for_both:Z
    ...
    .line 550
    iget v11, v8, Lorg/telegram/tgnet/TLRPC$TL_messages_setChatWallPaper;->flags:I

    const/4 v12, 0x2

    or-int/2addr v11, v12

    iput v11, v8, Lorg/telegram/tgnet/TLRPC$TL_messages_setChatWallPaper;->flags:I
    ...
    iput v11, v8, Lorg/telegram/tgnet/TLRPC$TL_messages_setChatWallPaper;->id:I
    ...
    invoke-virtual {v4, v2, v3}, Lorg/telegram/messenger/MessagesController;->getUserFull(J)Lorg/telegram/tgnet/TLRPC$UserFull;
    ...
    invoke-virtual {v4, v13, v14}, Lorg/telegram/messenger/MessagesController;->getChatFull(J)Lorg/telegram/tgnet/TLRPC$ChatFull;
    ...
    iget-wide v11, v15, Lorg/telegram/tgnet/TLRPC$WallPaper;->id:J

    iput-wide v11, v14, Lorg/telegram/tgnet/TLRPC$WallPaper;->id:J

    .line 564
    iget-object v11, v15, Lorg/telegram/tgnet/TLRPC$WallPaper;->document:Lorg/telegram/tgnet/TLRPC$Document;

    iput-object v11, v14, Lorg/telegram/tgnet/TLRPC$WallPaper;->document:Lorg/telegram/tgnet/TLRPC$Document;

    .line 565
    new-instance v11, Lorg/telegram/tgnet/TLRPC$TL_wallPaperSettings;

    invoke-direct {v11}, Lorg/telegram/tgnet/TLRPC$TL_wallPaperSettings;-><init>()V

    iput-object v11, v14, Lorg/telegram/tgnet/TLRPC$WallPaper;->settings:Lorg/telegram/tgnet/TLRPC$WallPaperSettings;

    .line 566
    iget v12, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->intensity:F
    ...
    iput v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->intensity:I

    .line 567
    iget-boolean v12, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->isMotion:Z

    iput-boolean v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->motion:Z

    .line 568
    iget-boolean v12, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->isBlurred:Z

    iput-boolean v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->blur:Z

    .line 569
    iget v12, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->color:I

    iput v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->background_color:I

    .line 570
    iget v12, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->gradientColor1:I

    iput v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->second_background_color:I

    .line 571
    iget v12, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->gradientColor2:I

    iput v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->third_background_color:I

    .line 572
    iget v12, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->gradientColor3:I

    iput v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->fourth_background_color:I

    .line 573
    iget v12, v0, Lorg/telegram/ui/ActionBar/Theme$OverrideWallpaperInfo;->rotation:I

    iput v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->rotation:I
    ...
    .line 577
    iget-object v11, v4, Lorg/telegram/tgnet/TLRPC$UserFull;->wallpaper:Lorg/telegram/tgnet/TLRPC$WallPaper;
    ...
    .line 581
    iget-object v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->uploadingImage:Ljava/lang/String;
    ...
    .line 582
    iget-object v11, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->stripedThumb:Landroid/graphics/Bitmap;

    iput-object v11, v14, Lorg/telegram/tgnet/TLRPC$WallPaper;->stripedThumb:Landroid/graphics/Bitmap;

    .line 585
    :cond_4
    iget-object v11, v14, Lorg/telegram/tgnet/TLRPC$WallPaper;->settings:Lorg/telegram/tgnet/TLRPC$WallPaperSettings;

    iget v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->flags:I

    or-int/2addr v12, v9

    iput v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaperSettings;->flags:I
    ...
    iget-boolean v12, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->pattern:Z

    iput-boolean v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->pattern:Z

    .line 593
    iget-wide v9, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->id:J

    iput-wide v9, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->id:J

    .line 594
    iget-object v9, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->document:Lorg/telegram/tgnet/TLRPC$Document;

    iput-object v9, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->document:Lorg/telegram/tgnet/TLRPC$Document;

    .line 595
    iget v9, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->flags:I

    iput v9, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->flags:I

    .line 596
    iget-boolean v10, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->creator:Z

    iput-boolean v10, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->creator:Z

    .line 597
    iget-boolean v10, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->dark:Z

    iput-boolean v10, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->dark:Z

    .line 598
    iget-boolean v10, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->isDefault:Z

    iput-boolean v10, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->isDefault:Z

    .line 599
    iget-object v10, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->slug:Ljava/lang/String;

    iput-object v10, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->slug:Ljava/lang/String;

    move-object v10, v13

    .line 600
    iget-wide v12, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->access_hash:J

    iput-wide v12, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->access_hash:J

    .line 601
    iget-object v1, v1, Lorg/telegram/tgnet/TLRPC$WallPaper;->stripedThumb:Landroid/graphics/Bitmap;

    iput-object v1, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->stripedThumb:Landroid/graphics/Bitmap;

    .line 602
    iget-object v1, v14, Lorg/telegram/tgnet/TLRPC$WallPaper;->settings:Lorg/telegram/tgnet/TLRPC$WallPaperSettings;

    iput-object v1, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->settings:Lorg/telegram/tgnet/TLRPC$WallPaperSettings;

    or-int/lit8 v1, v9, 0x4

    .line 603
    iput v1, v11, Lorg/telegram/tgnet/TLRPC$WallPaper;->flags:I

    if-eqz v4, :cond_5

    .line 605
    iput-object v11, v4, Lorg/telegram/tgnet/TLRPC$UserFull;->wallpaper:Lorg/telegram/tgnet/TLRPC$WallPaper;

    .line 606
    iget v1, v4, Lorg/telegram/tgnet/TLRPC$UserFull;->flags:I

    const/high16 v9, 0x1000000

    or-int/2addr v1, v9

    iput v1, v4, Lorg/telegram/tgnet/TLRPC$UserFull;->flags:I
    ...
    invoke-virtual {v1, v4, v9}, Lorg/telegram/messenger/MessagesStorage;->updateUserInfo(Lorg/telegram/tgnet/TLRPC$UserFull;Z)V
    ...
    invoke-virtual {v1, v10, v11}, Lorg/telegram/messenger/NotificationCenter;->postNotificationName(I[Ljava/lang/Object;)V
    ...
    .line 610
    iput-object v11, v4, Lorg/telegram/tgnet/TLRPC$ChatFull;->wallpaper:Lorg/telegram/tgnet/TLRPC$WallPaper;

    .line 611
    iget v1, v4, Lorg/telegram/tgnet/TLRPC$ChatFull;->flags2:I

    or-int/lit16 v1, v1, 0x80

    iput v1, v4, Lorg/telegram/tgnet/TLRPC$ChatFull;->flags2:I
    ...
    invoke-virtual {v1, v4, v9}, Lorg/telegram/messenger/MessagesStorage;->updateChatInfo(Lorg/telegram/tgnet/TLRPC$ChatFull;Z)V
    ...
    sget v10, Lorg/telegram/messenger/NotificationCenter;->chatInfoDidLoad:I
    ...
    new-instance v10, Lorg/telegram/messenger/ChatThemeController$$ExternalSyntheticLambda9;
