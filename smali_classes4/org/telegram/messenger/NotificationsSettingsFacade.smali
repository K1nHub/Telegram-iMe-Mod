...
.method private synthetic lambda$applyDialogNotificationsSettings$1(JILorg/telegram/tgnet/TLRPC$PeerNotifySettings;)V
    ...
    .line 97
    invoke-static {v3, v4, v5, v1}, Lorg/telegram/messenger/NotificationsController;->getSharedPrefKey(JIZ)Ljava/lang/String;
    ...
    .line 100
    iget v9, v8, Lorg/telegram/messenger/NotificationsSettingsFacade;->currentAccount:I
    ...
    .line 101
    iget v10, v8, Lorg/telegram/messenger/NotificationsSettingsFacade;->currentAccount:I

    invoke-static {v10}, Lorg/telegram/messenger/NotificationsController;->getInstance(I)Lorg/telegram/messenger/NotificationsController;
    ...
    invoke-interface {v12, v15, v1}, Landroid/content/SharedPreferences;->getInt(Ljava/lang/String;I)I
    ...
    .line 107
    iget v1, v0, Lorg/telegram/tgnet/TLRPC$PeerNotifySettings;->flags:I
    ...
    iget-boolean v8, v0, Lorg/telegram/tgnet/TLRPC$PeerNotifySettings;->silent:Z

    invoke-interface {v15, v1, v8}, Landroid/content/SharedPreferences$Editor;->putBoolean(Ljava/lang/String;Z)Landroid/content/SharedPreferences$Editor;
    ...
    invoke-interface {v15, v1}, Landroid/content/SharedPreferences$Editor;->remove(Ljava/lang/String;)Landroid/content/SharedPreferences$Editor;
    ...
    const-string/jumbo v8, "stories_"
    ...
    iget-boolean v8, v0, Lorg/telegram/tgnet/TLRPC$PeerNotifySettings;->stories_muted:Z
    ...
    .line 120
    iget-object v1, v6, Lorg/telegram/messenger/MessagesController;->dialogs_dict:Landroidx/collection/LongSparseArray;
    ...
    .line 123
    iput-object v0, v1, Lorg/telegram/tgnet/TLRPC$Dialog;->notify_settings:Lorg/telegram/tgnet/TLRPC$PeerNotifySettings;

    .line 126
    :cond_3
    iget v6, v0, Lorg/telegram/tgnet/TLRPC$PeerNotifySettings;->flags:I
    ...
    .line 129
    iget v3, v0, Lorg/telegram/tgnet/TLRPC$PeerNotifySettings;->mute_until:I
    ...
    .line 134
    iget-object v1, v1, Lorg/telegram/tgnet/TLRPC$Dialog;->notify_settings:Lorg/telegram/tgnet/TLRPC$PeerNotifySettings;
    ...
    invoke-interface {v15, v4, v3}, Landroid/content/SharedPreferences$Editor;->putInt(Ljava/lang/String;I)Landroid/content/SharedPreferences$Editor;
    ...
    .line 149
    invoke-virtual {v9, v3, v4, v1, v2}, Lorg/telegram/messenger/MessagesStorage;->setDialogFlags(JJ)V

    .line 150
    invoke-virtual {v10, v3, v4}, Lorg/telegram/messenger/NotificationsController;->removeNotificationsForDialog(J)V
    ...
    iput v10, v1, Lorg/telegram/tgnet/TLRPC$PeerNotifySettings;->mute_until:I
    ...
    invoke-interface {v15, v1, v10}, Landroid/content/SharedPreferences$Editor;->putInt(Ljava/lang/String;I)Landroid/content/SharedPreferences$Editor;
    ...
    .line 161
    invoke-virtual {v9, v3, v4, v6, v7}, Lorg/telegram/messenger/MessagesStorage;->setDialogFlags(JJ)V
...
.method public applySoundSettings(Lorg/telegram/tgnet/TLRPC$NotificationSound;Landroid/content/SharedPreferences$Editor;JIIZ)V
    ...
    .line 194
    invoke-static {p3, p4, p5, v1}, Lorg/telegram/messenger/NotificationsController;->getSharedPrefKey(JIZ)Ljava/lang/String;
...
.method public clearPreference(JI)V
    ...
    .line 33
    invoke-static {p1, p2, p3, v0}, Lorg/telegram/messenger/NotificationsController;->getSharedPrefKey(JIZ)Ljava/lang/String;
...
.method public getProperty(Ljava/lang/String;JII)I
    ...
    .line 47
    invoke-static {p2, p3, p4, v0}, Lorg/telegram/messenger/NotificationsController;->getSharedPrefKey(JIZ)Ljava/lang/String;
