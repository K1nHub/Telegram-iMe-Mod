...
.method constructor <init>(Lio/grpc/internal/AbstractManagedChannelImplBuilder;Lio/grpc/internal/ClientTransportFactory;Lio/grpc/internal/BackoffPolicy$Provider;Lio/grpc/internal/ObjectPool;Lcom/google/common/base/Supplier;Ljava/util/List;Lio/grpc/internal/TimeProvider;)V
    ...
    invoke-direct {v14, v11, v10}, Lio/grpc/internal/CallCredentialsApplyingTransportFactory;-><init>(Lio/grpc/internal/ClientTransportFactory;Ljava/util/concurrent/Executor;)V

    iput-object v14, v0, Lio/grpc/internal/ManagedChannelImpl;->transportFactory:Lio/grpc/internal/ClientTransportFactory;

    .line 569
    new-instance v15, Lio/grpc/internal/ManagedChannelImpl$RestrictedScheduledExecutor;
    ...
    invoke-direct {v15, v11, v7}, Lio/grpc/internal/ManagedChannelImpl$RestrictedScheduledExecutor;-><init>(Ljava/util/concurrent/ScheduledExecutorService;Lio/grpc/internal/ManagedChannelImpl$1;)V

    iput-object v15, v0, Lio/grpc/internal/ManagedChannelImpl;->scheduledExecutor:Lio/grpc/internal/ManagedChannelImpl$RestrictedScheduledExecutor;
    ...
    iput-object v7, v0, Lio/grpc/internal/ManagedChannelImpl;->channelTracer:Lio/grpc/internal/ChannelTracer;

    .line 575
    new-instance v6, Lio/grpc/internal/ChannelLoggerImpl;

    invoke-direct {v6, v7, v3}, Lio/grpc/internal/ChannelLoggerImpl;-><init>(Lio/grpc/internal/ChannelTracer;Lio/grpc/internal/TimeProvider;)V

    iput-object v6, v0, Lio/grpc/internal/ManagedChannelImpl;->channelLogger:Lio/grpc/ChannelLogger;
    ...
    iput-object v7, v0, Lio/grpc/internal/ManagedChannelImpl;->nameResolverFactory:Lio/grpc/NameResolver$Factory;

    .line 578
    iget-object v11, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->proxyDetector:Lio/grpc/ProxyDetector;
    ...
    :cond_0
    sget-object v11, Lio/grpc/internal/GrpcUtil;->DEFAULT_PROXY_DETECTOR:Lio/grpc/ProxyDetector;

    .line 579
    :goto_0
    iget-boolean v12, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->retryEnabled:Z

    if-eqz v12, :cond_1

    iget-boolean v12, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->temporarilyDisableRetry:Z
    ...
    iget-object v14, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->defaultLbPolicy:Ljava/lang/String;
    ...
    .line 581
    new-instance v14, Lio/grpc/internal/ManagedChannelImpl$ExecutorHolder;
    ...
    invoke-direct {v14, v3}, Lio/grpc/internal/ManagedChannelImpl$ExecutorHolder;-><init>(Lio/grpc/internal/ObjectPool;)V

    iput-object v14, v0, Lio/grpc/internal/ManagedChannelImpl;->offloadExecutorHolder:Lio/grpc/internal/ManagedChannelImpl$ExecutorHolder;

    .line 585
    new-instance v3, Lio/grpc/internal/ManagedChannelImpl$ScParser;

    iget v14, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->maxRetryAttempts:I
    ...
    invoke-direct/range {v18 .. v23}, Lio/grpc/internal/ManagedChannelImpl$ScParser;-><init>(ZIILio/grpc/internal/AutoConfiguredLoadBalancerFactory;Lio/grpc/ChannelLogger;)V
    ...
    invoke-virtual {v13, v14}, Lio/grpc/NameResolver$Args$Builder;->setDefaultPort(I)Lio/grpc/NameResolver$Args$Builder;

    move-result-object v13

    .line 595
    invoke-virtual {v13, v11}, Lio/grpc/NameResolver$Args$Builder;->setProxyDetector(Lio/grpc/ProxyDetector;)Lio/grpc/NameResolver$Args$Builder;

    move-result-object v11

    .line 596
    invoke-virtual {v11, v4}, Lio/grpc/NameResolver$Args$Builder;->setSynchronizationContext(Lio/grpc/SynchronizationContext;)Lio/grpc/NameResolver$Args$Builder;

    move-result-object v11

    .line 597
    invoke-virtual {v11, v8}, Lio/grpc/NameResolver$Args$Builder;->setScheduledExecutorService(Ljava/util/concurrent/ScheduledExecutorService;)Lio/grpc/NameResolver$Args$Builder;

    move-result-object v8

    .line 598
    invoke-virtual {v8, v3}, Lio/grpc/NameResolver$Args$Builder;->setServiceConfigParser(Lio/grpc/NameResolver$ServiceConfigParser;)Lio/grpc/NameResolver$Args$Builder;

    move-result-object v8

    .line 599
    invoke-virtual {v8, v6}, Lio/grpc/NameResolver$Args$Builder;->setChannelLogger(Lio/grpc/ChannelLogger;)Lio/grpc/NameResolver$Args$Builder;

    move-result-object v8

    new-instance v11, Lio/grpc/internal/ManagedChannelImpl$2;

    invoke-direct {v11, v0}, Lio/grpc/internal/ManagedChannelImpl$2;-><init>(Lio/grpc/internal/ManagedChannelImpl;)V

    .line 600
    invoke-virtual {v8, v11}, Lio/grpc/NameResolver$Args$Builder;->setOffloadExecutor(Ljava/util/concurrent/Executor;)Lio/grpc/NameResolver$Args$Builder;

    move-result-object v8

    .line 608
    invoke-virtual {v8}, Lio/grpc/NameResolver$Args$Builder;->build()Lio/grpc/NameResolver$Args;

    move-result-object v8

    iput-object v8, v0, Lio/grpc/internal/ManagedChannelImpl;->nameResolverArgs:Lio/grpc/NameResolver$Args;

    .line 609
    invoke-static {v9, v7, v8}, Lio/grpc/internal/ManagedChannelImpl;->getNameResolver(Ljava/lang/String;Lio/grpc/NameResolver$Factory;Lio/grpc/NameResolver$Args;)Lio/grpc/NameResolver;
    ...
    .line 610
    invoke-static {v2, v7}, Lcom/google/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v7, v2}, Lio/grpc/internal/ManagedChannelImpl$ExecutorHolder;-><init>(Lio/grpc/internal/ObjectPool;)V
    ...
    invoke-direct {v2, v10, v4}, Lio/grpc/internal/DelayedClientTransport;-><init>(Ljava/util/concurrent/Executor;Lio/grpc/SynchronizationContext;)V

    iput-object v2, v0, Lio/grpc/internal/ManagedChannelImpl;->delayedTransport:Lio/grpc/internal/DelayedClientTransport;

    .line 613
    invoke-virtual {v2, v5}, Lio/grpc/internal/DelayedClientTransport;->start(Lio/grpc/internal/ManagedClientTransport$Listener;)Ljava/lang/Runnable;
    ...
    invoke-direct {v2, v12}, Lio/grpc/internal/ServiceConfigInterceptor;-><init>(Z)V
    ...
    .line 617
    iget-object v5, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->defaultServiceConfig:Ljava/util/Map;

    if-eqz v5, :cond_3

    .line 619
    invoke-virtual {v3, v5}, Lio/grpc/internal/ManagedChannelImpl$ScParser;->parseServiceConfig(Ljava/util/Map;)Lio/grpc/NameResolver$ConfigOrError;
    ...
    .line 620
    invoke-static {v5, v8, v7}, Lcom/google/common/base/Preconditions;->checkState(ZLjava/lang/String;Ljava/lang/Object;)V

    .line 624
    new-instance v5, Lio/grpc/internal/ManagedChannelImpl$ServiceConfigHolder;
    ...
    check-cast v3, Lio/grpc/internal/ManagedChannelServiceConfig;

    invoke-direct {v5, v7, v3}, Lio/grpc/internal/ManagedChannelImpl$ServiceConfigHolder;-><init>(Ljava/util/Map;Lio/grpc/internal/ManagedChannelServiceConfig;)V
    ...
    .line 630
    iput-object v3, v0, Lio/grpc/internal/ManagedChannelImpl;->defaultServiceConfig:Lio/grpc/internal/ManagedChannelImpl$ServiceConfigHolder;

    .line 632
    :goto_3
    iget-boolean v5, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->lookUpServiceConfig:Z

    iput-boolean v5, v0, Lio/grpc/internal/ManagedChannelImpl;->lookUpServiceConfig:Z

    .line 633
    new-instance v7, Lio/grpc/internal/ManagedChannelImpl$RealChannel;

    iget-object v8, v0, Lio/grpc/internal/ManagedChannelImpl;->nameResolver:Lio/grpc/NameResolver;

    invoke-virtual {v8}, Lio/grpc/NameResolver;->getServiceAuthority()Ljava/lang/String;

    move-result-object v8

    invoke-direct {v7, v0, v8, v3}, Lio/grpc/internal/ManagedChannelImpl$RealChannel;-><init>(Lio/grpc/internal/ManagedChannelImpl;Ljava/lang/String;Lio/grpc/internal/ManagedChannelImpl$1;)V

    const/4 v3, 0x1

    new-array v8, v3, [Lio/grpc/ClientInterceptor;
    ...
    .line 634
    invoke-static {v7, v8}, Lio/grpc/ClientInterceptors;->intercept(Lio/grpc/Channel;[Lio/grpc/ClientInterceptor;)Lio/grpc/Channel;
    ...
    .line 638
    invoke-static {v2, v7}, Lio/grpc/ClientInterceptors;->intercept(Lio/grpc/Channel;Ljava/util/List;)Lio/grpc/Channel;
    ...
    .line 640
    iget-wide v10, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->idleTimeoutMillis:J
    ...
    .line 641
    iput-wide v10, v0, Lio/grpc/internal/ManagedChannelImpl;->idleTimeoutMillis:J

    goto :goto_4

    .line 643
    :cond_4
    sget-wide v12, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->IDLE_MODE_MIN_TIMEOUT_MILLIS:J
    ...
    .line 647
    iget-wide v2, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->idleTimeoutMillis:J

    iput-wide v2, v0, Lio/grpc/internal/ManagedChannelImpl;->idleTimeoutMillis:J

    .line 650
    :goto_4
    new-instance v2, Lio/grpc/internal/Rescheduler;

    new-instance v3, Lio/grpc/internal/ManagedChannelImpl$IdleModeTimer;

    const/4 v8, 0x0

    invoke-direct {v3, v0, v8}, Lio/grpc/internal/ManagedChannelImpl$IdleModeTimer;-><init>(Lio/grpc/internal/ManagedChannelImpl;Lio/grpc/internal/ManagedChannelImpl$1;)V

    .line 653
    invoke-interface/range {p2 .. p2}, Lio/grpc/internal/ClientTransportFactory;->getScheduledExecutorService()Ljava/util/concurrent/ScheduledExecutorService;
    ...
    check-cast v7, Lcom/google/common/base/Stopwatch;

    invoke-direct {v2, v3, v4, v8, v7}, Lio/grpc/internal/Rescheduler;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;Lcom/google/common/base/Stopwatch;)V
    ...
    .line 660
    iget-wide v2, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->retryBufferSize:J

    iput-wide v2, v0, Lio/grpc/internal/ManagedChannelImpl;->channelBufferLimit:J

    .line 661
    iget-wide v2, v1, Lio/grpc/internal/AbstractManagedChannelImplBuilder;->perRpcBufferLimit:J

    iput-wide v2, v0, Lio/grpc/internal/ManagedChannelImpl;->perRpcBufferLimit:J
    ...
    invoke-direct {v2, v0, v3}, Lio/grpc/internal/ManagedChannelImpl$1ChannelCallTracerFactory;-><init>(Lio/grpc/internal/ManagedChannelImpl;Lio/grpc/internal/TimeProvider;)V
    ...
    invoke-virtual {v6, v1, v2}, Lio/grpc/ChannelLogger;->log(Lio/grpc/ChannelLogger$ChannelLogLevel;Ljava/lang/String;)V
