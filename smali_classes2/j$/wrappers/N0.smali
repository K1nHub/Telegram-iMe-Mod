...
.method public synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/e1;->average()Lj$/util/i;

    move-result-object v0

    invoke-static {v0}, Lj$/util/a;->r(Lj$/util/i;)Ljava/util/OptionalDouble;
...
.method public synthetic findAny()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/e1;->findAny()Lj$/util/k;

    move-result-object v0

    invoke-static {v0}, Lj$/util/a;->t(Lj$/util/k;)Ljava/util/OptionalLong;
...
.method public synthetic findFirst()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/e1;->findFirst()Lj$/util/k;
...
.method public synthetic iterator()Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/e1;->iterator()Lj$/util/q;

    move-result-object v0

    invoke-static {v0}, Lj$/wrappers/f;->a(Lj$/util/q;)Ljava/util/PrimitiveIterator$OfLong;
...
.method public synthetic max()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/e1;->max()Lj$/util/k;
...
.method public synthetic min()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/e1;->min()Lj$/util/k;
...
.method public synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/e1;->g(Lj$/util/function/o;)Lj$/util/k;

    move-result-object p1

    invoke-static {p1}, Lj$/util/a;->t(Lj$/util/k;)Ljava/util/OptionalLong;
...
.method public synthetic spliterator()Ljava/util/Spliterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/e1;->spliterator()Lj$/util/s$c;

    move-result-object v0

    invoke-static {v0}, Lj$/wrappers/n;->a(Lj$/util/s$c;)Ljava/util/Spliterator$OfLong;
...
.method public summaryStatistics()Ljava/util/LongSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/e1;->summaryStatistics()Lj$/util/h;
