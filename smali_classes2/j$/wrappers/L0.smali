...
.method public synthetic iterator()Ljava/util/PrimitiveIterator$OfDouble;
    ...
    invoke-static {v0}, Lj$/wrappers/b;->a(Lj$/util/m;)Ljava/util/PrimitiveIterator$OfDouble;
...
.method public synthetic reduce(Ljava/util/function/DoubleBinaryOperator;)Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/U;->G(Lj$/util/function/d;)Lj$/util/i;

    move-result-object p1

    invoke-static {p1}, Lj$/util/a;->r(Lj$/util/i;)Ljava/util/OptionalDouble;
...
.method public synthetic spliterator()Ljava/util/Spliterator$OfDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/U;->spliterator()Lj$/util/s$a;

    move-result-object v0

    invoke-static {v0}, Lj$/wrappers/j;->a(Lj$/util/s$a;)Ljava/util/Spliterator$OfDouble;
