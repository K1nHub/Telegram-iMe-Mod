...
.method private synthetic constructor <init>(Lj$/util/stream/Stream;)V
    ...
    iput-object p1, p0, Lj$/wrappers/L0;->a:Lj$/util/stream/Stream;
...
.method public static synthetic m0(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    invoke-direct {v0, p0}, Lj$/wrappers/L0;-><init>(Lj$/util/stream/Stream;)V
...
.method public synthetic allMatch(Ljava/util/function/Predicate;)Z
    ...
    iget-object v0, p0, Lj$/wrappers/L0;->a:Lj$/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->V(Lj$/util/function/Predicate;)Z
...
.method public synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->i(Lj$/util/function/x;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public synthetic collect(Ljava/util/stream/Collector;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lj$/wrappers/F0;->d(Ljava/util/stream/Collector;)Lj$/wrappers/F0;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->a0(Lj$/wrappers/F0;)Ljava/lang/Object;
...
.method public synthetic filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->S(Lj$/util/function/Predicate;)Lj$/util/stream/Stream;
...
.method public synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/util/k;->m(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->D(Lj$/util/function/Function;)Lj$/util/stream/U;
...
.method public synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->W(Lj$/util/function/Function;)Lj$/util/stream/e1;
...
.method public synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-static {p1}, Lj$/wrappers/x0;->a(Ljava/util/function/ToDoubleFunction;)Lj$/util/function/ToDoubleFunction;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->i0(Lj$/util/function/ToDoubleFunction;)Lj$/util/stream/U;
...
.method public synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-static {p1}, Lj$/wrappers/z0;->a(Ljava/util/function/ToIntFunction;)Lj$/util/function/ToIntFunction;
...
.method public synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-static {p1}, Lj$/wrappers/B0;->a(Ljava/util/function/ToLongFunction;)Lj$/util/function/ToLongFunction;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->f0(Lj$/util/function/ToLongFunction;)Lj$/util/stream/e1;
...
.method public synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/k;->m(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public synthetic peek(Ljava/util/function/Consumer;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->U(Lj$/util/function/Consumer;)Lj$/util/stream/Stream;
...
.method public synthetic reduce(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lj$/wrappers/t;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/b;

    move-result-object p3

    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->A(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/b;)Ljava/lang/Object;
...
.method public synthetic reduce(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/wrappers/t;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/b;

    move-result-object p2

    invoke-interface {v0, p1, p2}, Lj$/util/stream/Stream;->l0(Ljava/lang/Object;Lj$/util/function/b;)Ljava/lang/Object;
...
.method public synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/wrappers/t;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/b;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->s(Lj$/util/function/b;)Lj$/util/Optional;
