...
.method public static b(Lj$/util/s$a;Lj$/util/function/Consumer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/s$a;->e(Lj$/util/function/f;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/s$a;->e(Lj$/util/function/f;)V
    ...
    invoke-static {p0, p1}, Lj$/util/K;->a(Ljava/lang/Class;Ljava/lang/String;)V
...
.method public static c(Lj$/util/s$b;Lj$/util/function/Consumer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/s$b;->c(Lj$/util/function/l;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/s$b;->c(Lj$/util/function/l;)V
...
.method public static d(Lj$/util/s$c;Lj$/util/function/Consumer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/s$c;->d(Lj$/util/function/q;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/s$c;->d(Lj$/util/function/q;)V
...
.method public static e(Lj$/util/s;)J
    .locals 2
...
.method public static f(Lj$/util/s;I)Z
    .locals 0
...
.method public static g(Ljava/util/Collection;)Lj$/util/stream/Stream;
    ...
    invoke-static {p0, v0}, Lj$/util/stream/o1;->y(Lj$/util/s;Z)Lj$/util/stream/Stream;
...
.method public static j(Lj$/util/s$a;Lj$/util/function/Consumer;)Z
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/s$a;->k(Lj$/util/function/f;)Z
    ...
    invoke-interface {p0, v0}, Lj$/util/s$a;->k(Lj$/util/function/f;)Z
...
.method public static k(Lj$/util/s$b;Lj$/util/function/Consumer;)Z
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/s$b;->g(Lj$/util/function/l;)Z
    ...
    invoke-interface {p0, v0}, Lj$/util/s$b;->g(Lj$/util/function/l;)Z
...
.method public static l(Lj$/util/s$c;Lj$/util/function/Consumer;)Z
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/s$c;->i(Lj$/util/function/q;)Z
    ...
    invoke-interface {p0, v0}, Lj$/util/s$c;->i(Lj$/util/function/q;)Z
...
.method public static n(Ljava/util/OptionalDouble;)Lj$/util/i;
    .locals 2
...
.method public static o(Ljava/util/OptionalInt;)Lj$/util/j;
    .locals 1
...
.method public static p(Ljava/util/OptionalLong;)Lj$/util/k;
    .locals 2
...
.method public static r(Lj$/util/i;)Ljava/util/OptionalDouble;
    .locals 2
...
.method public static s(Lj$/util/j;)Ljava/util/OptionalInt;
    .locals 1
...
.method public static t(Lj$/util/k;)Ljava/util/OptionalLong;
    .locals 2
