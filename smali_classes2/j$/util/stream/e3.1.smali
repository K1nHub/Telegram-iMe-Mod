...
# virtual methods
.method public final A(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/b;)Ljava/lang/Object;
    .locals 2
...
.method public final D(Lj$/util/function/Function;)Lj$/util/stream/U;
    .locals 7
...
.method final J0(Lj$/util/stream/y2;Lj$/util/function/x;Z)Lj$/util/Spliterator;
    ...
    invoke-direct {v0, p1, p2, p3}, Lj$/util/stream/L4;-><init>(Lj$/util/stream/y2;Lj$/util/function/x;Z)V

    return-object v0
.end method

.method public final S(Lj$/util/function/Predicate;)Lj$/util/stream/Stream;
    .locals 7
...
.method public final U(Lj$/util/function/Consumer;)Lj$/util/stream/Stream;
    .locals 7
...
.method public final W(Lj$/util/function/Function;)Lj$/util/stream/e1;
    .locals 7
...
.method public final a0(Lj$/wrappers/F0;)Ljava/lang/Object;
    .locals 9
    ...
    invoke-virtual {p1}, Lj$/wrappers/F0;->b()Ljava/util/Set;
    ...
    :cond_0
    invoke-virtual {p1}, Lj$/wrappers/F0;->f()Lj$/util/function/x;
    ...
    invoke-virtual {p1}, Lj$/wrappers/F0;->a()Lj$/util/function/BiConsumer;
    ...
    invoke-virtual {p1}, Lj$/wrappers/F0;->c()Lj$/util/function/b;
    ...
    invoke-direct/range {v3 .. v8}, Lj$/util/stream/I2;-><init>(Lj$/util/stream/e4;Lj$/util/function/b;Lj$/util/function/BiConsumer;Lj$/util/function/x;Lj$/wrappers/F0;)V
    ...
    :cond_2
    invoke-virtual {p1}, Lj$/wrappers/F0;->e()Lj$/util/function/Function;
...
.method public final count()J
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/e3;->f0(Lj$/util/function/ToLongFunction;)Lj$/util/stream/e1;
...
.method public final f0(Lj$/util/function/ToLongFunction;)Lj$/util/stream/e1;
    .locals 7
...
.method public final i(Lj$/util/function/x;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
    .locals 2
    ...
    invoke-direct {v0, v1, p3, p2, p1}, Lj$/util/stream/z2;-><init>(Lj$/util/stream/e4;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;Lj$/util/function/x;)V
...
.method public final i0(Lj$/util/function/ToDoubleFunction;)Lj$/util/stream/U;
    .locals 7
...
.method public final l0(Ljava/lang/Object;Lj$/util/function/b;)Ljava/lang/Object;
    .locals 2
...
.method public final max(Ljava/util/Comparator;)Lj$/util/Optional;
    ...
    .line 3
    invoke-virtual {p0, v0}, Lj$/util/stream/e3;->s(Lj$/util/function/b;)Lj$/util/Optional;
...
.method public final s(Lj$/util/function/b;)Lj$/util/Optional;
    .locals 2
...
.method final s0(JLj$/util/function/IntFunction;)Lj$/util/stream/s1;
    ...
    invoke-static {p1, p2, p3}, Lj$/util/stream/x2;->d(JLj$/util/function/IntFunction;)Lj$/util/stream/s1;
...
.method public final toArray()[Ljava/lang/Object;
    ...
    invoke-static {v1, v0}, Lj$/util/stream/x2;->l(Lj$/util/stream/A1;Lj$/util/function/IntFunction;)Lj$/util/stream/A1;

    move-result-object v1

    invoke-interface {v1, v0}, Lj$/util/stream/A1;->p(Lj$/util/function/IntFunction;)[Ljava/lang/Object;
...
.method public final toArray(Lj$/util/function/IntFunction;)[Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lj$/util/stream/c;->x0(Lj$/util/function/IntFunction;)Lj$/util/stream/A1;

    move-result-object v0

    invoke-static {v0, p1}, Lj$/util/stream/x2;->l(Lj$/util/stream/A1;Lj$/util/function/IntFunction;)Lj$/util/stream/A1;

    move-result-object v0

    invoke-interface {v0, p1}, Lj$/util/stream/A1;->p(Lj$/util/function/IntFunction;)[Ljava/lang/Object;
...
.method final y0(Lj$/util/stream/y2;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/A1;
    ...
    invoke-static {p1, p2, p3, p4}, Lj$/util/stream/x2;->e(Lj$/util/stream/y2;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/A1;
