...
.field private static final k:[Lj$/time/f;
...
.field private final d:[Lj$/time/f;
...
.method static constructor <clinit>()V
    ...
    new-array v1, v0, [Lj$/time/f;

    sput-object v1, Lj$/time/zone/c;->k:[Lj$/time/f;
...
.method private constructor <init>(Lj$/time/o;)V
    ...
    sget-object p1, Lj$/time/zone/c;->k:[Lj$/time/f;

    iput-object p1, p0, Lj$/time/zone/c;->d:[Lj$/time/f;
...
.method constructor <init>(Ljava/util/TimeZone;)V
    ...
    invoke-static {v1}, Lj$/time/zone/c;->j(I)Lj$/time/o;
    ...
    sget-object v1, Lj$/time/zone/c;->k:[Lj$/time/f;

    iput-object v1, p0, Lj$/time/zone/c;->d:[Lj$/time/f;
...
.method private a(Lj$/time/f;Lj$/time/zone/a;)Ljava/lang/Object;
    .locals 2

    invoke-virtual {p2}, Lj$/time/zone/a;->b()Lj$/time/f;
    ...
    invoke-virtual {p1, v0}, Lj$/time/f;->q(Lj$/time/chrono/c;)Z
    ...
    :cond_0
    invoke-virtual {p2}, Lj$/time/zone/a;->a()Lj$/time/f;
...
.method private b(I)[Lj$/time/zone/a;
    ...
    invoke-static {v3, v6, v7, v5, v5}, Lj$/time/f;->r(IIIII)Lj$/time/f;

    move-result-object v3

    iget-object v6, v0, Lj$/time/zone/c;->b:[Lj$/time/o;

    aget-object v5, v6, v5

    invoke-virtual {v3, v5}, Lj$/time/f;->A(Lj$/time/o;)J
    ...
    :goto_3
    invoke-static {v3}, Lj$/time/zone/c;->j(I)Lj$/time/o;
    ...
    invoke-static {v4}, Lj$/time/zone/c;->j(I)Lj$/time/o;

    move-result-object v7

    invoke-direct {v0, v5, v6, v7}, Lj$/time/zone/c;->c(JLj$/time/o;)I
    ...
    invoke-direct {v12, v5, v6, v3, v7}, Lj$/time/zone/a;-><init>(JLj$/time/o;Lj$/time/o;)V
...
.method private c(JLj$/time/o;)I
    ...
    invoke-virtual {p1}, Lj$/time/d;->p()I
...
.method private e(Lj$/time/f;)Ljava/lang/Object;
    .locals 6
    ...
    invoke-virtual {p1}, Lj$/time/f;->o()I
    ...
    invoke-virtual {p1, v1}, Lj$/time/f;->A(Lj$/time/o;)J
    ...
    invoke-static {p1}, Lj$/time/zone/c;->j(I)Lj$/time/o;
    ...
    invoke-direct {p0, p1, v1}, Lj$/time/zone/c;->a(Lj$/time/f;Lj$/time/zone/a;)Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lj$/time/zone/a;->f()Lj$/time/o;
    ...
    iget-object v0, p0, Lj$/time/zone/c;->d:[Lj$/time/f;
    ...
    invoke-virtual {p1, v0}, Lj$/time/f;->p(Lj$/time/chrono/c;)Z
    ...
    iget-object p1, p0, Lj$/time/zone/c;->e:[Lj$/time/o;
    ...
    invoke-virtual {v1, v0}, Lj$/time/f;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lj$/time/zone/c;->e:[Lj$/time/o;
    ...
    invoke-virtual {v3}, Lj$/time/o;->p()I
    ...
    invoke-direct {v0, v1, v3, p1}, Lj$/time/zone/a;-><init>(Lj$/time/f;Lj$/time/o;Lj$/time/o;)V
    ...
    invoke-direct {v1, v0, v3, p1}, Lj$/time/zone/a;-><init>(Lj$/time/f;Lj$/time/o;Lj$/time/o;)V

    return-object v1

    :cond_e
    iget-object v0, p0, Lj$/time/zone/c;->e:[Lj$/time/o;
...
.method public static i(Lj$/time/o;)Lj$/time/zone/c;
    .locals 1
...
.method private static j(I)Lj$/time/o;
    .locals 0

    div-int/lit16 p0, p0, 0x3e8

    invoke-static {p0}, Lj$/time/o;->s(I)Lj$/time/o;
...
# virtual methods
.method public d(Lj$/time/Instant;)Lj$/time/o;
    .locals 6
    ...
    invoke-direct {p0, v2, v3, p1}, Lj$/time/zone/c;->c(JLj$/time/o;)I
    ...
    :cond_3
    invoke-virtual {v0}, Lj$/time/zone/a;->e()Lj$/time/o;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v3}, Lj$/util/k;->q(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public f(Lj$/time/f;)Lj$/time/zone/a;
    .locals 1

    invoke-direct {p0, p1}, Lj$/time/zone/c;->e(Lj$/time/f;)Ljava/lang/Object;
...
.method public g(Lj$/time/f;)Ljava/util/List;
    .locals 1
...
.method public h()Z
    ...
    invoke-direct {v0, v10, v11, v1}, Lj$/time/zone/c;->c(JLj$/time/o;)I
    ...
    invoke-static {v4, v3, v3}, Lj$/time/d;->r(III)Lj$/time/d;

    move-result-object v4

    invoke-virtual {v4}, Lj$/time/d;->A()J
    ...
    invoke-direct {v0, v5, v6, v1}, Lj$/time/zone/c;->c(JLj$/time/o;)I
    ...
    iget-object v1, v0, Lj$/time/zone/c;->e:[Lj$/time/o;
    ...
    :cond_d
    invoke-direct {v0, v4, v5, v1}, Lj$/time/zone/c;->c(JLj$/time/o;)I
    ...
    iget-object v4, v0, Lj$/time/zone/c;->e:[Lj$/time/o;

    aget-object v5, v4, v5

    aget-object v1, v4, v1

    invoke-direct {v9, v6, v7, v5, v1}, Lj$/time/zone/a;-><init>(JLj$/time/o;Lj$/time/o;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lj$/time/zone/c;->b:[Lj$/time/o;
