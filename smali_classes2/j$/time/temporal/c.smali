...
.method public c(Ljava/util/Map;Lj$/time/temporal/k;Lj$/time/format/z;)Lj$/time/temporal/k;
    ...
    invoke-static {p2}, Lj$/time/temporal/g;->j(Lj$/time/temporal/k;)V
    ...
    invoke-static {v1, v8, v8}, Lj$/time/d;->r(III)Lj$/time/d;
    ...
    invoke-virtual {p2, v8, v9}, Lj$/time/d;->w(J)Lj$/time/d;
    ...
    :cond_1
    invoke-interface {v2}, Lj$/time/temporal/o;->a()Lj$/time/temporal/A;
    ...
    invoke-static {v1, p2, v8}, Lj$/time/d;->r(III)Lj$/time/d;
    ...
    invoke-virtual {p0, p2}, Lj$/time/temporal/c;->g(Lj$/time/temporal/k;)Lj$/time/temporal/A;
    ...
    :cond_3
    invoke-virtual {p0}, Lj$/time/temporal/c;->a()Lj$/time/temporal/A;
    ...
    invoke-virtual {p2, v3, v4}, Lj$/time/d;->v(J)Lj$/time/d;
...
.method public d(Lj$/time/temporal/k;)J
    ...
    invoke-virtual {p0, p1}, Lj$/time/temporal/c;->e(Lj$/time/temporal/k;)Z
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/k;->c(Lj$/time/temporal/o;)I
    ...
    invoke-static {}, Lj$/time/temporal/g;->i()[I
...
.method public f(Lj$/time/temporal/j;J)Lj$/time/temporal/j;
    ...
    invoke-virtual {p0, p1}, Lj$/time/temporal/c;->d(Lj$/time/temporal/k;)J
