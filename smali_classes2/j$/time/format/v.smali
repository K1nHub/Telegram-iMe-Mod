...
.method constructor <init>(Lj$/time/temporal/k;Lj$/time/format/a;)V
    ...
    invoke-virtual {p2}, Lj$/time/format/a;->e()Lj$/time/n;
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/k;->g(Lj$/time/temporal/x;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v3}, Lj$/time/temporal/k;->g(Lj$/time/temporal/x;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lj$/time/n;

    invoke-static {v0, v2}, Lj$/util/k;->q(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/k;->i(Lj$/time/temporal/o;)Z
    ...
    :goto_1
    invoke-static {p1}, Lj$/time/Instant;->k(Lj$/time/temporal/k;)Lj$/time/Instant;

    move-result-object p1

    .line 2
    invoke-static {p1, v1}, Lj$/time/r;->m(Lj$/time/Instant;Lj$/time/n;)Lj$/time/r;
    ...
    :cond_6
    :try_start_0
    invoke-virtual {v1}, Lj$/time/n;->k()Lj$/time/zone/c;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/k;->c(Lj$/time/temporal/o;)I
    ...
    invoke-virtual {v7}, Lj$/time/o;->p()I
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/k;->i(Lj$/time/temporal/o;)Z
    ...
    invoke-interface {p1, v7}, Lj$/time/temporal/k;->i(Lj$/time/temporal/o;)Z
    ...
    invoke-direct {v0, v5, p1, v4, v3}, Lj$/time/format/u;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/k;Lj$/time/chrono/g;Lj$/time/n;)V

    move-object p1, v0

    .line 7
    :goto_7
    iput-object p1, p0, Lj$/time/format/v;->a:Lj$/time/temporal/k;

    iput-object p2, p0, Lj$/time/format/v;->b:Lj$/time/format/a;
...
.method b()Lj$/time/format/x;
    ...
    iget-object v0, p0, Lj$/time/format/v;->b:Lj$/time/format/a;
...
.method d()Lj$/time/temporal/k;
    ...
    iget-object v0, p0, Lj$/time/format/v;->a:Lj$/time/temporal/k;
...
.method f(Lj$/time/temporal/x;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lj$/time/format/v;->a:Lj$/time/temporal/k;
