...
.method public a(Lj$/time/format/v;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v5, p1, p2}, Lj$/time/format/h;->a(Lj$/time/format/v;Ljava/lang/StringBuilder;)Z
...
.method public b(Lj$/time/format/t;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {p1}, Lj$/time/format/t;->q()V

    iget-object v0, p0, Lj$/time/format/g;->a:[Lj$/time/format/h;
    ...
    invoke-interface {v5, p1, p2, v4}, Lj$/time/format/h;->b(Lj$/time/format/t;Ljava/lang/CharSequence;I)I

    move-result v4

    if-gez v4, :cond_0

    invoke-virtual {p1, v1}, Lj$/time/format/t;->e(Z)V
    ...
    invoke-virtual {p1, p2}, Lj$/time/format/t;->e(Z)V
    ...
    invoke-interface {v3, p1, p2, p3}, Lj$/time/format/h;->b(Lj$/time/format/t;Ljava/lang/CharSequence;I)I
...
.method public c(Z)Lj$/time/format/g;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Lj$/time/format/g;-><init>([Lj$/time/format/h;Z)V
