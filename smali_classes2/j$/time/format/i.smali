...
# direct methods
.method constructor <init>(Lj$/time/temporal/o;IIZ)V
    .locals 2
...
.method public a(Lj$/time/format/v;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v0}, Lj$/time/temporal/o;->a()Lj$/time/temporal/A;

    move-result-object v0

    iget-object v4, p0, Lj$/time/format/i;->a:Lj$/time/temporal/o;

    invoke-virtual {v0, v2, v3, v4}, Lj$/time/temporal/A;->b(JLj$/time/temporal/o;)J
    ...
    invoke-virtual {p1}, Lj$/time/format/x;->c()C
...
.method public b(Lj$/time/format/t;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {p1}, Lj$/time/format/t;->k()Z
    ...
    :cond_3
    iget-boolean v4, p0, Lj$/time/format/i;->d:Z
    ...
    invoke-virtual {p1}, Lj$/time/format/t;->f()Lj$/time/format/x;

    move-result-object v5

    invoke-virtual {v5}, Lj$/time/format/x;->c()C
    ...
    invoke-virtual {v5, v2}, Lj$/time/format/x;->b(C)I
    ...
    invoke-interface {p3}, Lj$/time/temporal/o;->a()Lj$/time/temporal/A;

    move-result-object p3

    invoke-virtual {p3}, Lj$/time/temporal/A;->e()J
    ...
    invoke-virtual {p3}, Lj$/time/temporal/A;->d()J
    ...
    .line 2
    iget-object v5, p0, Lj$/time/format/i;->a:Lj$/time/temporal/o;

    move-object v4, p1

    invoke-virtual/range {v4 .. v9}, Lj$/time/format/t;->n(Lj$/time/temporal/o;JII)I
