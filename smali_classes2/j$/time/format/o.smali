...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Lj$/time/format/o;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lj$/time/format/o;->SENSITIVE:Lj$/time/format/o;
    ...
    invoke-direct {v1, v3, v4}, Lj$/time/format/o;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lj$/time/format/o;->INSENSITIVE:Lj$/time/format/o;
    ...
    invoke-direct {v3, v5, v6}, Lj$/time/format/o;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lj$/time/format/o;->STRICT:Lj$/time/format/o;
    ...
    invoke-direct {v5, v7, v8}, Lj$/time/format/o;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lj$/time/format/o;->LENIENT:Lj$/time/format/o;

    const/4 v7, 0x4

    new-array v7, v7, [Lj$/time/format/o;
    ...
    sput-object v7, Lj$/time/format/o;->a:[Lj$/time/format/o;
...
.method public b(Lj$/time/format/t;Ljava/lang/CharSequence;I)I
    ...
    :cond_0
    invoke-virtual {p1, v1}, Lj$/time/format/t;->p(Z)V

    goto :goto_0

    :cond_1
    invoke-virtual {p1, v0}, Lj$/time/format/t;->p(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {p1, v1}, Lj$/time/format/t;->l(Z)V

    goto :goto_0

    :cond_3
    invoke-virtual {p1, v0}, Lj$/time/format/t;->l(Z)V
