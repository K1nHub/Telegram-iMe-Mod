...
.method public d(Ljava/util/Map;Lj$/time/format/z;)Lj$/time/chrono/b;
    .locals 15
    ...
    sget-object v11, Lj$/time/format/z;->STRICT:Lj$/time/format/z;
    ...
    invoke-static {v2, v10, v10}, Lj$/time/d;->r(III)Lj$/time/d;

    move-result-object v2

    invoke-virtual {v2, v6, v7}, Lj$/time/d;->w(J)Lj$/time/d;

    move-result-object v2

    invoke-virtual {v2, v0, v1}, Lj$/time/d;->v(J)Lj$/time/d;
    ...
    sget-object v4, Lj$/time/format/z;->SMART:Lj$/time/format/z;
    ...
    sget-object v1, Lj$/time/j;->FEBRUARY:Lj$/time/j;

    int-to-long v4, v2

    sget v9, Lj$/time/m;->a:I
    ...
    :cond_11
    :goto_4
    invoke-virtual {v1, v10}, Lj$/time/j;->l(Z)I
    ...
    :cond_13
    invoke-static {v2, v3, v0}, Lj$/time/d;->r(III)Lj$/time/d;
    ...
    .line 10
    invoke-virtual {v2}, Lj$/time/temporal/a;->a()Lj$/time/temporal/A;
    ...
    .line 14
    invoke-virtual {v2, v11, v12, v3}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;
    ...
    .line 16
    invoke-virtual {v2, v13, v14, v3}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;
    ...
    .line 18
    invoke-virtual {v2, v0, v1, v3}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;
    ...
    .line 19
    :cond_15
    invoke-virtual {v3}, Lj$/time/temporal/a;->a()Lj$/time/temporal/A;
    ...
    .line 21
    invoke-virtual {v6}, Lj$/time/temporal/a;->a()Lj$/time/temporal/A;
    ...
    .line 23
    invoke-virtual {v7}, Lj$/time/temporal/a;->a()Lj$/time/temporal/A;
    ...
    .line 25
    invoke-static {v2, v4, v10}, Lj$/time/d;->r(III)Lj$/time/d;
    ...
    .line 27
    invoke-virtual {v2, v5, v6, v0}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;

    move-result-object v0

    .line 28
    sget-object v2, Lj$/time/format/z;->STRICT:Lj$/time/format/z;

    if-ne v1, v2, :cond_23

    invoke-virtual {v0, v3}, Lj$/time/d;->c(Lj$/time/temporal/o;)I
    ...
    invoke-direct {v0, v11}, Lj$/time/DateTimeException;-><init>(Ljava/lang/String;)V
    ...
    .line 42
    invoke-virtual {v2, v5, v6, v7}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;
    ...
    invoke-static {v0}, Lj$/time/temporal/n;->d(Lj$/time/b;)Lj$/time/temporal/l;

    move-result-object v0

    invoke-virtual {v2, v0}, Lj$/time/d;->C(Lj$/time/temporal/l;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v1, v3}, Lj$/time/d;->c(Lj$/time/temporal/o;)I
    ...
    .line 47
    invoke-static {v2, v10}, Lj$/time/d;->t(II)Lj$/time/d;
    ...
    .line 52
    invoke-static {v2, v0}, Lj$/time/d;->t(II)Lj$/time/d;
    ...
    .line 56
    invoke-static {v7, v10}, Lj$/time/d;->t(II)Lj$/time/d;
    ...
    .line 58
    invoke-virtual {v0, v1, v2, v5}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;
    ...
    .line 60
    invoke-virtual {v0, v3, v4, v1}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;
    ...
    .line 67
    invoke-virtual {v4, v5, v6, v0}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;
    ...
    invoke-virtual {v0, v2}, Lj$/time/d;->c(Lj$/time/temporal/o;)I
    ...
    .line 80
    invoke-virtual {v4, v5, v6, v3}, Lj$/time/d;->u(JLj$/time/temporal/y;)Lj$/time/d;
    ...
    invoke-virtual {v3, v0}, Lj$/time/d;->C(Lj$/time/temporal/l;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v1, v2}, Lj$/time/d;->c(Lj$/time/temporal/o;)I
