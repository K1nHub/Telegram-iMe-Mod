...
# direct methods
.method public static synthetic $r8$lambda$b37gJ1iHO4RO8VkxuL3Rp9ZcLr8(Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl;Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1}, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl;->clearTokensData$lambda$5(Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl;Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)Lkotlin/Unit;
...
.method private static final clearTokensData$lambda$5(Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl;Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)Lkotlin/Unit;
    .locals 1
    ...
    invoke-interface {p0, p1}, Lcom/smedialink/storage/domain/storage/CryptoPreferenceHelper;->resetTokensSettingsByBlockchainType(Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)V
...
# virtual methods
.method public clearTokensData(Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)Lio/reactivex/Observable;
    .locals 6
    ...
    invoke-direct {v1, p0, p1}, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$$ExternalSyntheticLambda0;-><init>(Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl;Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)V
    ...
    .line 74
    iget-object v0, p0, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl;->errorHandler:Lcom/smedialink/storage/data/network/handlers/impl/ApiErrorHandler;

    .line 26
    new-instance v1, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$clearTokensData$$inlined$handleError$1;

    invoke-direct {v1, v0}, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$clearTokensData$$inlined$handleError$1;-><init>(Lcom/smedialink/storage/data/network/handlers/ErrorHandler;)V
...
.method public linkWallet(Ljava/lang/String;Lcom/smedialink/storage/domain/model/crypto/NetworkType;Ljava/lang/String;)Lio/reactivex/Observable;
    ...
    invoke-direct {v1, p1, p2, p3}, Lcom/smedialink/storage/data/network/model/request/crypto/wallet/LinkWalletAddressRequest;-><init>(Ljava/lang/String;Lcom/smedialink/storage/domain/model/crypto/NetworkType;Ljava/lang/String;)V
...
.method public unlinkWallet(Lcom/smedialink/storage/domain/model/crypto/NetworkType;)Lio/reactivex/Observable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1}, Lcom/smedialink/storage/data/network/model/request/crypto/wallet/UnlinkWalletAddressRequest;-><init>(Lcom/smedialink/storage/domain/model/crypto/NetworkType;)V
    ...
    .line 52
    iget-object v0, p0, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl;->firebaseErrorHandler:Lcom/smedialink/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;

    .line 70
    new-instance v1, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$unlinkWallet$$inlined$mapSuccess$1;

    invoke-direct {v1, v0}, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$unlinkWallet$$inlined$mapSuccess$1;-><init>(Lcom/smedialink/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;)V
    ...
    .line 64
    new-instance v1, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$unlinkWallet$$inlined$mapError$1;

    invoke-direct {v1, v0}, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$unlinkWallet$$inlined$mapError$1;-><init>(Lcom/smedialink/storage/data/network/model/error/IErrorStatus;)V

    new-instance v0, Lcom/smedialink/storage/domain/utils/extentions/ObservableExtKt$sam$i$io_reactivex_functions_Function$0;

    invoke-direct {v0, v1}, Lcom/smedialink/storage/domain/utils/extentions/ObservableExtKt$sam$i$io_reactivex_functions_Function$0;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    .line 26
    new-instance v1, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$unlinkWallet$$inlined$handleError$1;

    invoke-direct {v1, v0}, Lcom/smedialink/storage/data/repository/crypto/CryptoWalletRepositoryImpl$unlinkWallet$$inlined$handleError$1;-><init>(Lcom/smedialink/storage/data/network/handlers/ErrorHandler;)V
