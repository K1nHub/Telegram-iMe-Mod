.class Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->createOpenHelper(Landroidx/room/DatabaseConfiguration;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field final synthetic this$0:Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;


# direct methods
.method constructor <init>(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;I)V
    .locals 0
    ...
    .line 67
    iput-object p1, p0, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl$1;->this$0:Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;
...
.method public createAllTables(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'994e7f15e3505c9ef787432b912dde6a\')"
...
.method public dropAllTables(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    .line 92
    iget-object v0, p0, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl$1;->this$0:Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;

    invoke-static {v0}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$000(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
    ...
    .line 93
    iget-object v1, p0, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl$1;->this$0:Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;

    invoke-static {v1}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$100(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
    ...
    .line 94
    iget-object v2, p0, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl$1;->this$0:Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;

    invoke-static {v2}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$200(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
...
.method protected onCreate(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    invoke-static {v0}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$300(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$400(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
    ...
    invoke-static {v2}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$500(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
...
.method public onOpen(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    invoke-static {v0, p1}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$602(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;Landroidx/sqlite/db/SupportSQLiteDatabase;)Landroidx/sqlite/db/SupportSQLiteDatabase;

    .line 111
    iget-object v0, p0, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl$1;->this$0:Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;

    invoke-static {v0, p1}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$700(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;Landroidx/sqlite/db/SupportSQLiteDatabase;)V

    .line 112
    iget-object v0, p0, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl$1;->this$0:Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;

    invoke-static {v0}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$800(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$900(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
    ...
    invoke-static {v2}, Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;->access$1000(Lcom/smedialink/storage/data/locale/db/database/AppMainDatabase_Impl;)Ljava/util/List;
...
.method protected onValidateSchema(Landroidx/sqlite/db/SupportSQLiteDatabase;)Landroidx/room/RoomOpenHelper$ValidationResult;
    ...
    const-string v3, "FilterSettingsDb(com.smedialink.storage.data.locale.db.model.filter.FilterSettingsDb).\n Expected:\n"
    ...
    const-string v9, "isInTextTranslateEnabled"
    ...
    const-string v8, "isInTextTranslateEnabled"
    ...
    const-string v10, "inTextTranslateTargetLangCode"
    ...
    const-string v8, "inTextTranslateTargetLangCode"
    ...
    const-string v10, "isOutTextTranslateEnabled"
    ...
    const-string v8, "outTextTranslateTargetLangCode"
    ...
    const-string v3, "DialogTranslationSettingsDb(com.smedialink.storage.data.locale.db.model.translation.DialogTranslationSettingsDb).\n Expected:\n"
    ...
    const-string v3, "TopicDb(com.smedialink.storage.data.locale.db.model.topics.TopicDb).\n Expected:\n"
    ...
    const-string v4, "remotePeerMetaName"
    ...
    const-string v4, "remotePeerMetaUrl"
    ...
    const-string v10, "remotePeerMetaDescription"
    ...
    const-string v4, "remotePeerMetaDescription"
    ...
    const-string v10, "remotePeerMetaIcons"
    ...
    const-string v4, "remotePeerMetaIcons"
    ...
    const-string v3, "WalletConnectSessionDb(com.smedialink.storage.data.locale.db.model.wallet.WalletConnectSessionDb).\n Expected:\n"
    ...
    const-string v3, "TemplatesDb(com.smedialink.storage.data.locale.db.model.templates.TemplatesDb).\n Expected:\n"
    ...
    const-string v3, "BookmarksDb(com.smedialink.storage.data.locale.db.model.bookmarks.BookmarksDb).\n Expected:\n"
    ...
    const-string v3, "PlaylistsDb(com.smedialink.storage.data.locale.db.model.music.PlaylistsDb).\n Expected:\n"
    ...
    const-string v5, "HistoryDialogDb"
    ...
    const-string v3, "HistoryDialogDb(com.smedialink.storage.data.locale.db.model.recent_chats.HistoryDialogDb).\n Expected:\n"
