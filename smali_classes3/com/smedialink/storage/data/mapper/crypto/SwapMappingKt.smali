.class public final Lcom/smedialink/storage/data/mapper/crypto/SwapMappingKt;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/smedialink/storage/data/mapper/crypto/SwapMappingKt$WhenMappings;
    }
.end annotation
...
.method public static final mapToDomain(Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetQuoteToSwapResponse;)Lcom/smedialink/storage/domain/model/crypto/swap/CryptoSwapMetadata;
    ...
    .line 64
    invoke-virtual/range {p0 .. p0}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetQuoteToSwapResponse;->getQuoteId()Ljava/lang/String;
    ...
    .line 66
    invoke-virtual/range {p0 .. p0}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetQuoteToSwapResponse;->getSpenderContractAddress()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetQuoteToSwapResponse;->getInputCryptoTokenCode()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Lcom/smedialink/storage/domain/model/wallet/token/TokenCode$Companion;->map(Ljava/lang/String;)Lcom/smedialink/storage/domain/model/wallet/token/TokenCode;

    move-result-object v5

    .line 68
    invoke-virtual/range {p0 .. p0}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetQuoteToSwapResponse;->getOutputCryptoTokenCode()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v0, v7}, Lcom/smedialink/storage/domain/model/wallet/token/TokenCode$Companion;->map(Ljava/lang/String;)Lcom/smedialink/storage/domain/model/wallet/token/TokenCode;

    move-result-object v7

    .line 69
    sget-object v8, Lcom/smedialink/storage/domain/model/wallet/swap/SwapMethod;->Companion:Lcom/smedialink/storage/domain/model/wallet/swap/SwapMethod$Companion;

    invoke-virtual/range {p0 .. p0}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetQuoteToSwapResponse;->getSwapMethod()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v8, v9}, Lcom/smedialink/storage/domain/model/wallet/swap/SwapMethod$Companion;->map(Ljava/lang/String;)Lcom/smedialink/storage/domain/model/wallet/swap/SwapMethod;

    move-result-object v8

    .line 70
    invoke-virtual/range {p0 .. p0}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetQuoteToSwapResponse;->getPath()Ljava/util/List;
...
.method public static final mapToDomain(Lcom/smedialink/storage/data/network/model/response/crypto/swap/AvailableSwapTokensResponse;)Ljava/util/List;
    ...
    .line 15
    invoke-virtual {p0}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/AvailableSwapTokensResponse;->getCryptoTokenCodes()Ljava/util/List;
    ...
    invoke-virtual {v2, v1}, Lcom/smedialink/storage/domain/model/wallet/token/TokenInfo$Companion;->map(Ljava/lang/String;)Lcom/smedialink/storage/domain/model/wallet/token/TokenInfo;
...
.method public static final mapToDomain(Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse;)Ljava/util/List;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 19
    invoke-virtual {p0}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse;->getCryptoTokens()Ljava/util/List;
    ...
    .line 20
    sget-object v2, Lcom/smedialink/storage/domain/model/wallet/swap/TokenApproveStatus;->Companion:Lcom/smedialink/storage/domain/model/wallet/swap/TokenApproveStatus$Companion;

    invoke-virtual {v1}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse$CryptoTokenApprovalQuote;->getStatus()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/smedialink/storage/domain/model/wallet/swap/TokenApproveStatus$Companion;->map(Ljava/lang/String;)Lcom/smedialink/storage/domain/model/wallet/swap/TokenApproveStatus;

    move-result-object v6

    sget-object v2, Lcom/smedialink/storage/data/mapper/crypto/SwapMappingKt$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    invoke-virtual {v1}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse$CryptoTokenApprovalQuote;->getCryptoTokenCode()Ljava/lang/String;
    ...
    .line 51
    invoke-virtual {v1}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse$CryptoTokenApprovalQuote;->getValue()Ljava/lang/String;

    move-result-object v7

    .line 52
    invoke-virtual {v1}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse$CryptoTokenApprovalQuote;->getContractAddress()Ljava/lang/String;

    move-result-object v9

    .line 53
    invoke-virtual {v1}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse$CryptoTokenApprovalQuote;->getSpenderContractAddress()Ljava/lang/String;
    ...
    .line 55
    invoke-virtual {v1}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse$CryptoTokenApprovalQuote;->getFeeTokenCode()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v2, v1}, Lcom/smedialink/storage/domain/model/wallet/token/TokenCode$Companion;->map(Ljava/lang/String;)Lcom/smedialink/storage/domain/model/wallet/token/TokenCode;

    move-result-object v11

    .line 48
    new-instance v1, Lcom/smedialink/storage/domain/model/crypto/swap/CryptoTokenApproveMetadata$NeedApprove$NotAllowed;
    ...
    .line 41
    :cond_1
    new-instance v2, Lcom/smedialink/storage/domain/model/crypto/swap/CryptoTokenApproveMetadata$InProgress;
    ...
    .line 41
    invoke-direct {v2, v3, v6, v1}, Lcom/smedialink/storage/domain/model/crypto/swap/CryptoTokenApproveMetadata$InProgress;-><init>(Lcom/smedialink/storage/domain/model/wallet/token/TokenCode;Lcom/smedialink/storage/domain/model/wallet/swap/TokenApproveStatus;Ljava/lang/String;)V
    ...
    .line 36
    invoke-virtual {v1}, Lcom/smedialink/storage/data/network/model/response/crypto/swap/GetApproveTokensInfoResponse$CryptoTokenApprovalQuote;->getLastErrorMessage()Ljava/lang/String;
    ...
    .line 29
    new-instance v1, Lcom/smedialink/storage/domain/model/crypto/swap/CryptoTokenApproveMetadata$NeedApprove$Error;
    ...
    .line 22
    :cond_4
    new-instance v2, Lcom/smedialink/storage/domain/model/crypto/swap/CryptoTokenApproveMetadata$Allowed;
    ...
    .line 22
    invoke-direct {v2, v3, v6, v1}, Lcom/smedialink/storage/domain/model/crypto/swap/CryptoTokenApproveMetadata$Allowed;-><init>(Lcom/smedialink/storage/domain/model/wallet/token/TokenCode;Lcom/smedialink/storage/domain/model/wallet/swap/TokenApproveStatus;Ljava/lang/String;)V
