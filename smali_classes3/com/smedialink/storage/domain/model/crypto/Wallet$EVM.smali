.class public final Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;
...
.method public static synthetic copy$default(Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;Ljava/lang/String;Ljava/lang/String;Lorg/web3j/crypto/Credentials;ILjava/lang/Object;)Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;
    .locals 0
    ...
    invoke-virtual {p0}, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->getGuid()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->getMnemonic()Ljava/lang/String;
    ...
    iget-object p3, p0, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->credentials:Lorg/web3j/crypto/Credentials;

    :cond_2
    invoke-virtual {p0, p1, p2, p3}, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->copy(Ljava/lang/String;Ljava/lang/String;Lorg/web3j/crypto/Credentials;)Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;
...
.method public final copy(Ljava/lang/String;Ljava/lang/String;Lorg/web3j/crypto/Credentials;)Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;
    .locals 1
    ...
    new-instance v0, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;

    invoke-direct {v0, p1, p2, p3}, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;-><init>(Ljava/lang/String;Ljava/lang/String;Lorg/web3j/crypto/Credentials;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;
    ...
    :cond_1
    check-cast p1, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;

    invoke-virtual {p0}, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->getGuid()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->getGuid()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->getMnemonic()Ljava/lang/String;
    ...
    :cond_3
    iget-object v1, p0, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->credentials:Lorg/web3j/crypto/Credentials;

    iget-object p1, p1, Lcom/smedialink/storage/domain/model/crypto/Wallet$EVM;->credentials:Lorg/web3j/crypto/Credentials;
