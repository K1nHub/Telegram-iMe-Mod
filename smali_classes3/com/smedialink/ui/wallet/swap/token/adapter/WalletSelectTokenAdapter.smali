.class public final Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter;
...
# virtual methods
.method protected convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/smedialink/model/wallet/select/SelectableTokenItem;)V
    .locals 5
    ...
    .line 29
    invoke-static {p1, v0, v2}, Lcom/smedialink/utils/extentions/common/BaseQuickAdapterExtKt;->setThemedBackgroundColor(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;ILjava/lang/String;)Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;
    ...
    .line 37
    invoke-virtual {p2}, Lcom/smedialink/model/wallet/select/SelectableTokenItem;->isWithBalance()Z

    move-result v0

    invoke-static {p1, v2, v0}, Lcom/smedialink/utils/extentions/common/BaseQuickAdapterExtKt;->setVisibleElseGone(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;IZ)Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;
    ...
    invoke-static {p1, v3, v0}, Lcom/smedialink/utils/extentions/common/BaseQuickAdapterExtKt;->setVisibleElseGone(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;IZ)Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;
    ...
    new-instance v1, Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter$convert$2;

    invoke-direct {v1, p2}, Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter$convert$2;-><init>(Lcom/smedialink/model/wallet/select/SelectableTokenItem;)V
    ...
    new-instance v1, Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter$convert$3;

    invoke-direct {v1, p2}, Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter$convert$3;-><init>(Lcom/smedialink/model/wallet/select/SelectableTokenItem;)V
...
.method protected convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/smedialink/model/wallet/select/SelectableTokenItem;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2}, Lcom/smedialink/model/wallet/select/SelectableToken;->getName()Ljava/lang/String;
    ...
    new-instance v0, Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter$convert$1;

    invoke-direct {v0, p2}, Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter$convert$1;-><init>(Lcom/smedialink/model/wallet/select/SelectableTokenItem;)V
...
.method public bridge synthetic convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter;->convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/smedialink/model/wallet/select/SelectableTokenItem;)V
...
.method public bridge synthetic convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Ljava/lang/Object;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/smedialink/ui/wallet/swap/token/adapter/WalletSelectTokenAdapter;->convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/smedialink/model/wallet/select/SelectableTokenItem;Ljava/util/List;)V
