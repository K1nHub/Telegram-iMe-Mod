...
# direct methods
.method public static synthetic $r8$lambda$51P6CbevJFuvLA_ES67p2OjnBD0(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Ljava/util/List;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->startChooseWalletOptionsFlow$lambda$6$lambda$5(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Ljava/util/List;Landroid/content/DialogInterface;I)V
...
.method public static synthetic $r8$lambda$_pmeqegRQWbucUcZM56NJOEP_yI(Lcom/smedialink/manager/wallet/create/WalletCreateManager;)V
    .locals 0

    invoke-direct {p0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->activateBib39BasedWallet()V

    return-void
.end method

.method public static synthetic $r8$lambda$pzmUlxR6xvFL4rEN0dPtr7OHHjw(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Ljava/util/List;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->startChooseWalletOptionsFlow$lambda$6(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Ljava/util/List;)V
...
.method public constructor <init>(Lcom/smedialink/storage/domain/manager/crypto/CryptoAccessManager;Lcom/smedialink/storage/domain/storage/CryptoPreferenceHelper;Lcom/smedialink/storage/domain/interactor/crypto/CryptoWalletInteractor;Lcom/smedialink/storage/domain/utils/system/ResourceManager;Lcom/smedialink/storage/domain/utils/rx/RxEventBus;Lcom/smedialink/storage/domain/utils/rx/SchedulersProvider;)V
    ...
    .line 31
    iput-object p1, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->cryptoAccessManager:Lcom/smedialink/storage/domain/manager/crypto/CryptoAccessManager;

    .line 32
    iput-object p2, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->cryptoPreferenceHelper:Lcom/smedialink/storage/domain/storage/CryptoPreferenceHelper;

    .line 33
    iput-object p3, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->cryptoWalletInteractor:Lcom/smedialink/storage/domain/interactor/crypto/CryptoWalletInteractor;

    .line 34
    iput-object p4, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->resourceManager:Lcom/smedialink/storage/domain/utils/system/ResourceManager;

    .line 35
    iput-object p5, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->rxEventBus:Lcom/smedialink/storage/domain/utils/rx/RxEventBus;

    .line 36
    iput-object p6, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->schedulersProvider:Lcom/smedialink/storage/domain/utils/rx/SchedulersProvider;
...
.method public static final synthetic access$getRxEventBus$p(Lcom/smedialink/manager/wallet/create/WalletCreateManager;)Lcom/smedialink/storage/domain/utils/rx/RxEventBus;
    .locals 0

    .line 30
    iget-object p0, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->rxEventBus:Lcom/smedialink/storage/domain/utils/rx/RxEventBus;
...
.method public static final synthetic access$openScreenByWalletCreationType(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;Ljava/util/List;Ljava/lang/String;)V
    .locals 0

    .line 30
    invoke-direct {p0, p1, p2, p3}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->openScreenByWalletCreationType(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;Ljava/util/List;Ljava/lang/String;)V
...
.method private final activateBib39BasedWallet()V
    ...
    .line 138
    invoke-direct {p0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->getCurrentBlockchainType()Lcom/smedialink/storage/domain/model/crypto/BlockchainType;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/smedialink/storage/domain/interactor/crypto/CryptoWalletInteractor;->activateBip39BasedWallet(Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)Lio/reactivex/Observable;
    ...
    .line 44
    new-instance v2, Lcom/smedialink/manager/wallet/create/WalletCreateManager$activateBib39BasedWallet$$inlined$subscribeWithErrorHandle$default$1;

    invoke-direct {v2, p0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager$activateBib39BasedWallet$$inlined$subscribeWithErrorHandle$default$1;-><init>(Lcom/smedialink/manager/wallet/create/WalletCreateManager;)V
    ...
    new-instance v2, Lcom/smedialink/manager/wallet/create/WalletCreateManager$activateBib39BasedWallet$$inlined$subscribeWithErrorHandle$default$2;

    invoke-direct {v2, v1}, Lcom/smedialink/manager/wallet/create/WalletCreateManager$activateBib39BasedWallet$$inlined$subscribeWithErrorHandle$default$2;-><init>(Lcom/smedialink/ui/base/mvp/base/BaseView;)V
...
.method private final getActivationConfirmationDialogModel()Lcom/smedialink/model/dialog/DialogModel;
    .locals 6
...
.method private final getAnimatedSpannableDialogModelByType(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;)Lcom/smedialink/model/dialog/AnimatedSpannableDialogModel;
    .locals 1

    .line 209
    sget-object v0, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Create;->INSTANCE:Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Create;
    ...
    .line 210
    :cond_0
    sget-object v0, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Import;->INSTANCE:Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Import;
    ...
    .line 211
    :cond_1
    sget-object v0, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Restore;->INSTANCE:Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Restore;
...
.method private final getCurrentBlockchainType()Lcom/smedialink/storage/domain/model/crypto/BlockchainType;
    .locals 1

    .line 45
    iget-object v0, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->cryptoPreferenceHelper:Lcom/smedialink/storage/domain/storage/CryptoPreferenceHelper;
...
.method private final getWarningDialogModelByType(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;)Lcom/smedialink/model/dialog/DialogModel;
    .locals 1
...
.method private final openScreenByWalletCreationType(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;Ljava/util/List;Ljava/lang/String;)V
    .locals 2
    ...
    .line 190
    :cond_0
    sget-object p2, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Import;->INSTANCE:Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Import;
    ...
    invoke-static {v0, p3, p2, p1, p2}, Lcom/smedialink/manager/wallet/create/WalletCreateManagerView$DefaultImpls;->openImportWalletScreen$default(Lcom/smedialink/manager/wallet/create/WalletCreateManagerView;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)V

    goto :goto_0

    .line 191
    :cond_1
    sget-object p2, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Restore;->INSTANCE:Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Restore;
...
.method static synthetic openScreenByWalletCreationType$default(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;Ljava/util/List;Ljava/lang/String;ILjava/lang/Object;)V
    .locals 0
...
.method private final prepareCreateWalletFlow(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;)V
    .locals 7
    ...
    invoke-static {v0, v1, v2, v3, v5}, Lcom/smedialink/utils/extentions/rx/RxExtKt;->withLoadingDialog$default(Lio/reactivex/Observable;Lcom/smedialink/ui/base/mvp/base/BaseView;ZILjava/lang/Object;)Lio/reactivex/Observable;
    ...
    invoke-direct {v2, p0, p1, v4}, Lcom/smedialink/manager/wallet/create/WalletCreateManager$prepareCreateWalletFlow$$inlined$subscribeWithErrorHandle$default$1;-><init>(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;Ljava/lang/String;)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->openScreenByWalletCreationType$default(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;Ljava/util/List;Ljava/lang/String;ILjava/lang/Object;)V
...
.method private static final startChooseWalletOptionsFlow$lambda$6(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Ljava/util/List;)V
    .locals 6
    ...
    .line 1621
    check-cast v4, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType;

    .line 94
    iget-object v5, p0, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->resourceManager:Lcom/smedialink/storage/domain/utils/system/ResourceManager;

    invoke-virtual {v4}, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType;->getStringResId()I

    move-result v4

    invoke-interface {v5, v4}, Lcom/smedialink/storage/domain/utils/system/ResourceManager;->getString(I)Ljava/lang/String;
    ...
    invoke-direct {v3, p0, p1}, Lcom/smedialink/manager/wallet/create/WalletCreateManager$$ExternalSyntheticLambda0;-><init>(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Ljava/util/List;)V
...
.method private static final startChooseWalletOptionsFlow$lambda$6$lambda$5(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Ljava/util/List;Landroid/content/DialogInterface;I)V
    .locals 0
    ...
    check-cast p1, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType;

    .line 99
    instance-of p2, p1, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Activate;
    ...
    .line 100
    :cond_0
    sget-object p1, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;->Companion:Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Companion;

    invoke-virtual {p1, p3}, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Companion;->getByIndex(I)Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;
...
.method private static final startWalletCreationFlow$lambda$3$lambda$1(Lcom/smedialink/manager/wallet/create/WalletCreateManagerView;Lcom/smedialink/manager/wallet/create/WalletCreateManager;Lcom/smedialink/model/wallet/crypto/create/WalletCreationType;)V
    ...
    check-cast v0, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;

    invoke-direct {p1, v0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->getAnimatedSpannableDialogModelByType(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;)Lcom/smedialink/model/dialog/AnimatedSpannableDialogModel;
...
.method private static final startWalletCreationFlow$lambda$3$lambda$1$lambda$0(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Lcom/smedialink/model/wallet/crypto/create/WalletCreationType;)V
    ...
    invoke-direct {p0, p1}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->prepareCreateWalletFlow(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;)V
...
.method public getAvailableWalletCreationTypes()Ljava/util/List;
    ...
    invoke-interface {v0}, Lcom/smedialink/storage/domain/manager/crypto/CryptoAccessManager;->isAnyBip39PhraseBasedWalletCreated()Z
    ...
    .line 109
    new-instance v0, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Activate;

    invoke-direct {p0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->getCurrentBlockchainType()Lcom/smedialink/storage/domain/model/crypto/BlockchainType;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Activate;-><init>(Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)V
    ...
    .line 111
    :cond_0
    sget-object v0, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;->Companion:Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Companion;

    invoke-virtual {p0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->isRestoreAvailable()Z

    move-result v1

    invoke-virtual {v0, v1}, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial$Companion;->getValuesOrdered(Z)Ljava/util/List;
...
.method public startChooseWalletOptionsFlow(Lcom/smedialink/storage/domain/model/crypto/BlockchainType;)V
    ...
    .line 89
    invoke-virtual {p0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->getAvailableWalletCreationTypes()Ljava/util/List;

    move-result-object p1

    .line 90
    new-instance v0, Lcom/smedialink/manager/wallet/create/WalletCreateManager$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0, p1}, Lcom/smedialink/manager/wallet/create/WalletCreateManager$$ExternalSyntheticLambda4;-><init>(Lcom/smedialink/manager/wallet/create/WalletCreateManager;Ljava/util/List;)V

    invoke-virtual {p0, v0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->loadCryptoInformation(Lorg/fork/utils/Callbacks$Callback;)V
...
.method public startWalletCreationFlow(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType;)V
    ...
    .line 61
    instance-of v1, p1, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;
    ...
    check-cast v1, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;

    invoke-direct {p0, v1}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->getWarningDialogModelByType(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;)Lcom/smedialink/model/dialog/DialogModel;
    ...
    .line 63
    :cond_0
    new-instance v3, Lcom/smedialink/manager/wallet/create/WalletCreateManager$$ExternalSyntheticLambda5;

    invoke-direct {v3, v0, p0, p1}, Lcom/smedialink/manager/wallet/create/WalletCreateManager$$ExternalSyntheticLambda5;-><init>(Lcom/smedialink/manager/wallet/create/WalletCreateManagerView;Lcom/smedialink/manager/wallet/create/WalletCreateManager;Lcom/smedialink/model/wallet/crypto/create/WalletCreationType;)V
    ...
    invoke-direct {p0, v1}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->getAnimatedSpannableDialogModelByType(Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Initial;)Lcom/smedialink/model/dialog/AnimatedSpannableDialogModel;
    ...
    .line 77
    :cond_2
    instance-of p1, p1, Lcom/smedialink/model/wallet/crypto/create/WalletCreationType$Activate;

    if-eqz p1, :cond_3

    .line 78
    invoke-direct {p0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager;->getActivationConfirmationDialogModel()Lcom/smedialink/model/dialog/DialogModel;

    move-result-object p1

    .line 79
    new-instance v1, Lcom/smedialink/manager/wallet/create/WalletCreateManager$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0}, Lcom/smedialink/manager/wallet/create/WalletCreateManager$$ExternalSyntheticLambda1;-><init>(Lcom/smedialink/manager/wallet/create/WalletCreateManager;)V

    .line 77
    invoke-interface {v0, p1, v1}, Lcom/smedialink/manager/wallet/create/WalletCreateManagerView;->showActivationConfirmationDialog(Lcom/smedialink/model/dialog/DialogModel;Lorg/fork/utils/Callbacks$Callback;)V
