...
# direct methods
.method public static synthetic $r8$lambda$2U7kVOtAVRPr2dvcN8_BIoXrLSQ(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Landroid/database/Cursor;)Lcom/google/firebase/firestore/model/mutation/MutationBatch;
    .locals 0
...
.method public static synthetic $r8$lambda$GzdLOeMskz3vRcjeXIgQoQR8N1c(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Landroid/database/Cursor;)V
    .locals 0
...
.method public static synthetic $r8$lambda$K09qkItrx5W3B8vszRamcw_Wqmc(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;Landroid/database/Cursor;)V
    .locals 0
...
.method public static synthetic $r8$lambda$KqrqJaUiLugzAKp96OWQhkKTO8k(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;Landroid/database/Cursor;)V
    .locals 0
...
.method public static synthetic $r8$lambda$LfDma1BpsGNmt0S6unoen31o5Yo(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Landroid/database/Cursor;)V
    .locals 0
...
.method public static synthetic $r8$lambda$MwuPXFVvedRgZzxT_WtIg_k9tSg(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;ILandroid/database/Cursor;)V
    .locals 0
...
.method public static synthetic $r8$lambda$NivRM3d5OpJzinTiN30tKx-dDn4(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/Set;Ljava/util/List;Landroid/database/Cursor;)V
    .locals 0
...
.method public static synthetic $r8$lambda$d40UCQgeOZ-kVCIem5n1nYKJHRg(Ljava/util/List;Landroid/database/Cursor;)V
    .locals 0
...
.method public static synthetic $r8$lambda$dlV7glJYsFIzTUL-zzLKk-Rr6tU(Ljava/util/List;Landroid/database/Cursor;)V
    .locals 0
...
.method public static synthetic $r8$lambda$e28wVf9S5-TN48AtSmHM979-_7E(Lcom/google/firebase/firestore/model/mutation/MutationBatch;Lcom/google/firebase/firestore/model/mutation/MutationBatch;)I
    .locals 0
...
.method public static synthetic $r8$lambda$smzqX3sw5gpX14vDSdqR4xjgR9s(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;ILandroid/database/Cursor;)Lcom/google/firebase/firestore/model/mutation/MutationBatch;
    .locals 0
...
.method public getAllMutationBatches()Ljava/util/List;
    ...
    invoke-direct {v2, p0, v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda3;-><init>(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;)V
...
.method public getAllMutationBatchesAffectingDocumentKey(Lcom/google/firebase/firestore/model/DocumentKey;)Ljava/util/List;
    ...
    invoke-direct {v1, p0, v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda2;-><init>(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;)V
...
.method public getAllMutationBatchesAffectingDocumentKeys(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    new-instance v3, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda5;

    invoke-direct {v3, p0, v1, v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda5;-><init>(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/Set;Ljava/util/List;)V
    ...
    .line 318
    sget-object p1, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda10;->INSTANCE:Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda10;
...
.method public getAllMutationBatchesAffectingQuery(Lcom/google/firebase/firestore/core/Query;)Ljava/util/List;
    ...
    invoke-direct {v1, p0, v4, v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda4;-><init>(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;I)V
...
.method public lookupMutationBatch(I)Lcom/google/firebase/firestore/model/mutation/MutationBatch;
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda9;-><init>(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;I)V
...
.method public performConsistencyCheck()V
    ...
    new-instance v3, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda6;

    invoke-direct {v3, v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda6;-><init>(Ljava/util/List;)V
...
.method public start()V
    ...
    invoke-direct {v1, p0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$ExternalSyntheticLambda1;-><init>(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;)V
