...
.method public static final mapToUi(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Lcom/iMe/storage/domain/model/staking/StakingStats;->isParticipated()Z
    ...
    .line 21
    sget-object v8, Lcom/iMe/storage/domain/model/wallet/token/TokenInfo;->Companion:Lcom/iMe/storage/domain/model/wallet/token/TokenInfo$Companion;

    invoke-virtual {v2}, Lcom/iMe/storage/domain/model/staking/StakingMetadata;->getToken()Lcom/iMe/storage/domain/model/staking/StakingToken;
    ...
    invoke-virtual {v8, v9}, Lcom/iMe/storage/domain/model/wallet/token/TokenInfo$Companion;->map(Ljava/lang/String;)Lcom/iMe/storage/domain/model/wallet/token/TokenInfo;

    move-result-object v8

    .line 20
    invoke-virtual {v3, v8}, Lcom/iMe/storage/domain/model/wallet/token/TokenBalance$Companion;->createEmptyBalanceFor(Lcom/iMe/storage/domain/model/wallet/token/TokenInfo;)Lcom/iMe/storage/domain/model/wallet/token/TokenBalance;

    move-result-object v9

    .line 23
    invoke-virtual {v2}, Lcom/iMe/storage/domain/model/staking/StakingMetadata;->getNetworkType()Lcom/iMe/storage/domain/model/crypto/NetworkType;
    ...
    invoke-virtual {v3}, Lcom/iMe/storage/domain/model/staking/StakingStats;->getDebt()Lcom/iMe/storage/domain/model/staking/StakingValues;
    ...
    invoke-virtual {v3}, Lcom/iMe/storage/domain/model/staking/StakingValues;->getAsUsd()Ljava/math/BigDecimal;
    ...
    sget-object v3, Lcom/iMe/model/staking/StakingAnnualPercentageMode;->APY:Lcom/iMe/model/staking/StakingAnnualPercentageMode;
    ...
    sget-object v3, Lcom/iMe/model/staking/StakingAnnualPercentageMode;->APR:Lcom/iMe/model/staking/StakingAnnualPercentageMode;

    goto :goto_1

    .line 33
    :cond_1
    sget-object v3, Lcom/iMe/model/staking/StakingAnnualPercentageMode;->NONE:Lcom/iMe/model/staking/StakingAnnualPercentageMode;
    ...
    sget-object v3, Lcom/iMe/utils/formatter/DateFormatter$DateType;->ONLY_DATE:Lcom/iMe/utils/formatter/DateFormatter$DateType;
    ...
    .line 16
    new-instance v2, Lcom/iMe/model/staking/StakingProgrammeItem;

    move-object v3, v2

    invoke-direct/range {v3 .. v12}, Lcom/iMe/model/staking/StakingProgrammeItem;-><init>(JLjava/lang/String;ZLcom/iMe/storage/domain/model/wallet/token/TokenBalance;Ljava/lang/String;Ljava/lang/String;Lcom/iMe/model/staking/StakingAnnualPercentageMode;Ljava/lang/String;)V
