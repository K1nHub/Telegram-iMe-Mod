.class public final Lcom/iMe/storage/data/mapper/wallet/WalletConnectSessionMappingKt;
.super Ljava/lang/Object;
.source "WalletConnectSessionMapping.kt"


# direct methods
.method public static final mapToDb(Lcom/trustwallet/walletconnect/WCSessionStoreItem;J)Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;
    .locals 17
    ...
    .line 29
    invoke-direct/range {v1 .. v16}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;-><init>(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;ZLjava/util/Date;)V

    return-object v0
.end method

.method public static final mapToDomain(Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;)Lcom/trustwallet/walletconnect/WCSessionStoreItem;
    .locals 11
    ...
    .line 11
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getSessionTopic()Ljava/lang/String;

    move-result-object v1

    .line 12
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getSessionVersion()Ljava/lang/String;

    move-result-object v3

    .line 13
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getSessionBridge()Ljava/lang/String;

    move-result-object v4

    .line 14
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getSessionKey()Ljava/lang/String;
    ...
    .line 16
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getChainId()I

    move-result v3

    .line 17
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getPeerId()Ljava/lang/String;

    move-result-object v4

    .line 18
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getRemotePeerId()Ljava/lang/String;
    ...
    .line 20
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getRemotePeerMetaName()Ljava/lang/String;

    move-result-object v1

    .line 21
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getRemotePeerMetaUrl()Ljava/lang/String;

    move-result-object v7

    .line 22
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getRemotePeerMetaDescription()Ljava/lang/String;

    move-result-object v8

    .line 23
    invoke-virtual {p0}, Lcom/iMe/storage/data/locale/db/model/wallet/WalletConnectSessionDb;->getRemotePeerMetaIcons()Ljava/util/List;
