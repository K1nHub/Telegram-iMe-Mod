...
.method private final createTransactionByType(Lcom/iMe/storage/domain/model/crypto/send/TransferArgs$TRON;Ljava/lang/String;)Lwallet/core/jni/proto/Tron$Transaction;
    ...
    invoke-virtual {v0}, Lcom/iMe/storage/domain/model/crypto/TronBlockHeader;->getNumber()J
    ...
    invoke-virtual {v0}, Lcom/iMe/storage/domain/model/crypto/TronBlockHeader;->getTxTrieRoot()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/iMe/storage/data/datasource/transfer/impl/TRONWalletTransferDataSourceImpl;->hexToByteString(Ljava/lang/String;)Lcom/google/protobuf/ByteString;
    ...
    invoke-virtual {v0}, Lcom/iMe/storage/domain/model/crypto/TronBlockHeader;->getWitnessAddress()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/iMe/storage/domain/model/crypto/TronBlockHeader;->getParentHash()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/iMe/storage/domain/model/crypto/TronBlockHeader;->getVersion()I
    ...
    invoke-virtual {v0}, Lcom/iMe/storage/domain/model/crypto/TronBlockHeader;->getTimestamp()J
...
.method public sign(Lcom/iMe/storage/domain/model/crypto/send/TransactionArgs;)Lio/reactivex/Observable;
    ...
    .line 74
    :cond_1
    invoke-direct {p0, p1, v2}, Lcom/iMe/storage/data/datasource/transfer/impl/TRONWalletTransferDataSourceImpl;->createTransactionByType(Lcom/iMe/storage/domain/model/crypto/send/TransferArgs$TRON;Ljava/lang/String;)Lwallet/core/jni/proto/Tron$Transaction;
