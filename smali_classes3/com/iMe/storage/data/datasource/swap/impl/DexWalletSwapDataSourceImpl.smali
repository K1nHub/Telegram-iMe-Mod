...
.method private final createSmartFunctionParams(Lcom/iMe/storage/domain/model/crypto/swap/SwapArgs$Dex;)Ljava/lang/String;
    .locals 13

    .line 118
    const-class v0, Lorg/web3j/abi/datatypes/Address;

    invoke-virtual {p1}, Lcom/iMe/storage/domain/model/crypto/swap/SwapArgs$Dex;->getDeadline()I

    move-result v1

    invoke-direct {p0, v1}, Lcom/iMe/storage/data/datasource/swap/impl/DexWalletSwapDataSourceImpl;->calculateDeadline(I)Ljava/math/BigInteger;
    ...
    invoke-virtual {p1}, Lcom/iMe/storage/domain/model/crypto/swap/SwapArgs$Dex;->getNetworkType()Lcom/iMe/storage/domain/model/crypto/NetworkType;

    move-result-object v4

    invoke-static {v3, v4}, Lcom/iMe/storage/domain/utils/extentions/model/TokenInfoExtKt;->getWeiConvertUnit(Lcom/iMe/storage/domain/model/wallet/token/TokenInfo$Crypto$Ethereum;Lcom/iMe/storage/domain/model/crypto/NetworkType;)Lcom/iMe/storage/domain/utils/crypto/Convert$Unit;

    move-result-object v3

    invoke-static {v2, v3}, Lcom/iMe/storage/data/utils/extentions/NumberExtKt;->convertToWei(Ljava/lang/Number;Lcom/iMe/storage/domain/utils/crypto/Convert$Unit;)Ljava/math/BigInteger;
    ...
    sget-object v5, Lcom/iMe/storage/data/datasource/swap/impl/DexWalletSwapDataSourceImpl$WhenMappings;->$EnumSwitchMapping$1:[I
    ...
    .line 136
    invoke-static {v2, p1, v11, v10, v11}, Lcom/iMe/storage/data/utils/extentions/Web3jExtKt;->createSmartFunctionDataFor$default(Ljava/lang/String;Ljava/util/List;Ljava/util/List;ILjava/lang/Object;)Ljava/lang/String;
    ...
    .line 124
    invoke-static {v3, p1, v11, v10, v11}, Lcom/iMe/storage/data/utils/extentions/Web3jExtKt;->createSmartFunctionDataFor$default(Ljava/lang/String;Ljava/util/List;Ljava/util/List;ILjava/lang/Object;)Ljava/lang/String;
...
.method private final createTransactionByType(Lcom/iMe/storage/domain/model/crypto/swap/SwapArgs$Dex;)Lorg/web3j/crypto/RawTransaction;
    .locals 8
    ...
    sget-object v1, Lcom/iMe/storage/data/datasource/swap/impl/DexWalletSwapDataSourceImpl$WhenMappings;->$EnumSwitchMapping$1:[I
    ...
    sget-object v1, Lcom/iMe/storage/data/datasource/swap/impl/DexWalletSwapDataSourceImpl$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    .line 108
    invoke-virtual {p1}, Lcom/iMe/storage/domain/model/crypto/swap/SwapArgs$Dex;->getData()Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Lcom/iMe/storage/domain/utils/extentions/model/TokenInfoExtKt;->getWeiConvertUnit(Lcom/iMe/storage/domain/model/wallet/token/TokenInfo$Crypto$Ethereum;Lcom/iMe/storage/domain/model/crypto/NetworkType;)Lcom/iMe/storage/domain/utils/crypto/Convert$Unit;

    move-result-object v6

    invoke-static {v0, v6}, Lcom/iMe/storage/data/utils/extentions/NumberExtKt;->convertToWei(Ljava/lang/Number;Lcom/iMe/storage/domain/utils/crypto/Convert$Unit;)Ljava/math/BigInteger;

    move-result-object v6

    .line 96
    invoke-direct {p0, p1}, Lcom/iMe/storage/data/datasource/swap/impl/DexWalletSwapDataSourceImpl;->createSmartFunctionParams(Lcom/iMe/storage/domain/model/crypto/swap/SwapArgs$Dex;)Ljava/lang/String;
...
.method public sign(Lcom/iMe/storage/domain/model/crypto/send/TransactionArgs;)Lio/reactivex/Observable;
    ...
    invoke-direct {p0, p1}, Lcom/iMe/storage/data/datasource/swap/impl/DexWalletSwapDataSourceImpl;->createTransactionByType(Lcom/iMe/storage/domain/model/crypto/swap/SwapArgs$Dex;)Lorg/web3j/crypto/RawTransaction;
    ...
    .line 66
    iget-object p1, p0, Lcom/iMe/storage/data/datasource/swap/impl/DexWalletSwapDataSourceImpl;->cryptoAccessManager:Lcom/iMe/storage/domain/manager/crypto/CryptoAccessManager;
