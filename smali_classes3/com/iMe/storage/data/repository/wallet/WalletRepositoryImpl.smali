...
.field private final walletBalanceDao:Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;


# direct methods
.method public static synthetic $r8$lambda$LEgJ7YFZNxzIXc8FGyAs21EnnG4(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lcom/iMe/storage/domain/model/Result;
    .locals 0

    invoke-static {p0, p1}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->getTokensBalance$lambda$8(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lcom/iMe/storage/domain/model/Result;
...
.method public static synthetic $r8$lambda$uPDJOYB0PGptKy5h-0BbAwpduMc(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lcom/iMe/storage/domain/model/Result;
    .locals 0

    invoke-static {p0, p1}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->getWalletBalance$lambda$2(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lcom/iMe/storage/domain/model/Result;
...
.method public constructor <init>(Lcom/iMe/storage/data/network/api/own/WalletApi;Lcom/iMe/storage/data/datasource/transfer/WalletTransferDataSourceFactory;Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;Lcom/iMe/storage/domain/utils/rx/SchedulersProvider;Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;Lcom/iMe/storage/data/network/handlers/impl/ApiErrorHandler;Lcom/iMe/storage/domain/gateway/TelegramGateway;)V
    ...
    .line 31
    iput-object p1, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->walletApi:Lcom/iMe/storage/data/network/api/own/WalletApi;

    .line 32
    iput-object p2, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->dataSourceFactory:Lcom/iMe/storage/data/datasource/transfer/WalletTransferDataSourceFactory;

    .line 33
    iput-object p3, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->walletBalanceDao:Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;

    .line 34
    iput-object p4, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->schedulersProvider:Lcom/iMe/storage/domain/utils/rx/SchedulersProvider;

    .line 35
    iput-object p5, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->firebaseErrorHandler:Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;

    .line 36
    iput-object p6, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->errorHandler:Lcom/iMe/storage/data/network/handlers/impl/ApiErrorHandler;

    .line 37
    iput-object p7, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->telegramGateway:Lcom/iMe/storage/domain/gateway/TelegramGateway;
    ...
    iput-object p1, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->lastUpdateBalanceTime:Ljava/util/HashMap;
...
.method public static final synthetic access$getWalletBalanceDao$p(Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;)Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;
    .locals 0

    .line 30
    iget-object p0, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->walletBalanceDao:Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;

    return-object p0
.end method

.method private final getLastUpdateBalanceTimeByNetworkType(Lcom/iMe/storage/domain/model/crypto/NetworkType;)J
    .locals 2
...
.method private static final getTokensBalance$lambda$8(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lcom/iMe/storage/domain/model/Result;
    .locals 1
...
.method private static final getWalletBalance$lambda$2(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lcom/iMe/storage/domain/model/Result;
    .locals 1
...
.method public activateWallet()Lio/reactivex/Observable;
    ...
    .line 60
    new-instance v1, Lcom/iMe/storage/data/network/model/request/wallet/ActivateWalletRequest;

    const/4 v2, 0x0

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v2}, Lcom/iMe/storage/data/network/model/request/wallet/ActivateWalletRequest;-><init>(Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-interface {v0, v1}, Lcom/iMe/storage/data/network/api/own/WalletApi;->activateWallet(Lcom/iMe/storage/data/network/model/request/wallet/ActivateWalletRequest;)Lio/reactivex/Observable;
    ...
    .line 70
    new-instance v2, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$activateWallet$$inlined$mapSuccess$1;

    invoke-direct {v2, v1}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$activateWallet$$inlined$mapSuccess$1;-><init>(Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;)V
    ...
    .line 26
    new-instance v2, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$activateWallet$$inlined$handleError$1;

    invoke-direct {v2, v1}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$activateWallet$$inlined$handleError$1;-><init>(Lcom/iMe/storage/data/network/handlers/ErrorHandler;)V
...
.method public getCryptoTransferMetadata(Lcom/iMe/storage/domain/model/wallet/token/TokenCode;Ljava/lang/String;Ljava/lang/String;Lcom/iMe/storage/domain/model/crypto/NetworkType;)Lio/reactivex/Observable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 54
    invoke-virtual {p4}, Lcom/iMe/storage/domain/model/crypto/NetworkType;->getBlockchainType()Lcom/iMe/storage/domain/model/crypto/BlockchainType;
    ...
    .line 55
    invoke-interface {v0, p1, p2, p3, p4}, Lcom/iMe/storage/data/datasource/transfer/WalletTransferDataSource;->getTransferMetadata(Lcom/iMe/storage/domain/model/wallet/token/TokenCode;Ljava/lang/String;Ljava/lang/String;Lcom/iMe/storage/domain/model/crypto/NetworkType;)Lio/reactivex/Observable;
...
.method public getTokensBalance(Ljava/util/List;ZLcom/iMe/storage/domain/model/crypto/NetworkType;)Lio/reactivex/Observable;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 102
    :cond_0
    iget-object v1, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->walletBalanceDao:Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;
    ...
    .line 1621
    check-cast v7, Lcom/iMe/storage/domain/model/wallet/token/TokenCode;
    ...
    .line 103
    :cond_1
    invoke-virtual {v1, v2, v3, v4, v5}, Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;->getTokensBalances(JLjava/lang/String;Ljava/util/List;)Lio/reactivex/Single;
    ...
    new-instance v3, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$$ExternalSyntheticLambda0;

    invoke-direct {v3, v2}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$$ExternalSyntheticLambda0;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    .line 113
    invoke-direct {p0, p3}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->getLastUpdateBalanceTimeByNetworkType(Lcom/iMe/storage/domain/model/crypto/NetworkType;)J
    ...
    .line 116
    new-instance p3, Lcom/iMe/storage/data/network/model/request/wallet/GetTokensBalanceRequest;

    invoke-direct {p3, v2, p1}, Lcom/iMe/storage/data/network/model/request/wallet/GetTokensBalanceRequest;-><init>(Ljava/util/List;Ljava/lang/String;)V

    .line 115
    invoke-interface {p2, p3}, Lcom/iMe/storage/data/network/api/own/WalletApi;->getWalletTokensBalance(Lcom/iMe/storage/data/network/model/request/wallet/GetTokensBalanceRequest;)Lio/reactivex/Observable;
...
.method public getWalletBalance(ZLcom/iMe/storage/domain/model/crypto/NetworkType;)Lio/reactivex/Observable;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 66
    iget-object v0, p0, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->walletBalanceDao:Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/iMe/storage/data/locale/db/dao/minor/wallet/WalletTokenBalanceDao;->getAllWalletBalances(JLjava/lang/String;)Lio/reactivex/Single;
    ...
    .line 77
    invoke-direct {p0, p2}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;->getLastUpdateBalanceTimeByNetworkType(Lcom/iMe/storage/domain/model/crypto/NetworkType;)J
    ...
    .line 79
    new-instance v1, Lcom/iMe/storage/data/network/model/request/wallet/GetTokensBalanceRequest;
    ...
    .line 79
    invoke-direct {v1, v4, v2, v3, v4}, Lcom/iMe/storage/data/network/model/request/wallet/GetTokensBalanceRequest;-><init>(Ljava/util/List;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-interface {p1, v1}, Lcom/iMe/storage/data/network/api/own/WalletApi;->getWalletTokensBalance(Lcom/iMe/storage/data/network/model/request/wallet/GetTokensBalanceRequest;)Lio/reactivex/Observable;
    ...
    invoke-direct {v2, v1, p0, p2}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$getWalletBalance$$inlined$flatMapSuccess$1;-><init>(Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl;Lcom/iMe/storage/domain/model/crypto/NetworkType;)V
...
.method public getWalletTransactionHistory(ZLjava/lang/String;Lcom/iMe/storage/domain/model/wallet/token/TokenCode;ILcom/iMe/storage/domain/model/crypto/NetworkType;)Lio/reactivex/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 147
    invoke-virtual {p3}, Lcom/iMe/storage/domain/model/wallet/token/TokenCode;->getName()Ljava/lang/String;
    ...
    invoke-direct {v0, p2, p4, p5, p3}, Lcom/iMe/storage/data/network/model/request/wallet/GetWalletTransactionsRequest;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
...
.method public sendTokens(Lcom/iMe/storage/domain/model/wallet/token/TokenCode;Lcom/iMe/storage/domain/model/crypto/send/TransferArgs;Lcom/iMe/storage/domain/model/crypto/BlockchainType;)Lio/reactivex/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/iMe/storage/data/datasource/transfer/WalletTransferDataSourceFactory;->getDataSource(Lkotlin/Pair;)Lcom/iMe/storage/data/datasource/transfer/WalletTransferDataSource;

    move-result-object p1

    .line 157
    invoke-interface {p1, p2}, Lcom/iMe/storage/data/datasource/transfer/WalletTransferDataSource;->transfer(Lcom/iMe/storage/domain/model/crypto/send/TransactionArgs;)Lio/reactivex/Observable;
    ...
    .line 26
    new-instance p3, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$sendTokens$$inlined$handleError$1;

    invoke-direct {p3, p2}, Lcom/iMe/storage/data/repository/wallet/WalletRepositoryImpl$sendTokens$$inlined$handleError$1;-><init>(Lcom/iMe/storage/data/network/handlers/ErrorHandler;)V
