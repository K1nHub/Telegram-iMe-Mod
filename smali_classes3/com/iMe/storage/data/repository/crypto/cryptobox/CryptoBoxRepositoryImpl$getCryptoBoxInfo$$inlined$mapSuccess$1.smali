.class public final Lcom/iMe/storage/data/repository/crypto/cryptobox/CryptoBoxRepositoryImpl$getCryptoBoxInfo$$inlined$mapSuccess$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/iMe/storage/data/repository/crypto/cryptobox/CryptoBoxRepositoryImpl;->getCryptoBoxInfo(Ljava/lang/String;)Lio/reactivex/Observable;
.end annotation
...
.method public constructor <init>(Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;)V
    ...
    iput-object p1, p0, Lcom/iMe/storage/data/repository/crypto/cryptobox/CryptoBoxRepositoryImpl$getCryptoBoxInfo$$inlined$mapSuccess$1;->$errorHandler:Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;
...
.method public final invoke(Lcom/iMe/storage/data/network/model/response/base/ApiBaseResponse;)Lcom/iMe/storage/domain/model/Result;
    ...
    invoke-virtual {p1}, Lcom/iMe/storage/data/network/model/response/crypto/cryptobox/CryptoBoxResponse;->getCryptobox()Lcom/iMe/storage/data/network/model/response/crypto/cryptobox/CryptoBoxInfoResponse;

    move-result-object p1

    invoke-static {p1}, Lcom/iMe/storage/data/mapper/cryptobox/CryptoBoxInfoMappingKt;->mapToDomain(Lcom/iMe/storage/data/network/model/response/crypto/cryptobox/CryptoBoxInfoResponse;)Lcom/iMe/storage/domain/model/crypto/cryptobox/CryptoBoxInfo;
    ...
    .line 72
    :cond_0
    iget-object v0, p0, Lcom/iMe/storage/data/repository/crypto/cryptobox/CryptoBoxRepositoryImpl$getCryptoBoxInfo$$inlined$mapSuccess$1;->$errorHandler:Lcom/iMe/storage/data/network/handlers/impl/FirebaseFunctionsErrorHandler;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/iMe/storage/data/repository/crypto/cryptobox/CryptoBoxRepositoryImpl$getCryptoBoxInfo$$inlined$mapSuccess$1;->invoke(Lcom/iMe/storage/data/network/model/response/base/ApiBaseResponse;)Lcom/iMe/storage/domain/model/Result;
