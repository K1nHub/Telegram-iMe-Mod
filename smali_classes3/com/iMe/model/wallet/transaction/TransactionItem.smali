...
.method public final getAmount(Lcom/iMe/storage/domain/utils/system/ResourceManager;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v0}, Lcom/iMe/storage/domain/model/wallet/token/TokenInfo$Companion;->map(Lcom/iMe/storage/domain/model/wallet/token/TokenCode;)Lcom/iMe/storage/domain/model/wallet/token/TokenInfo;
    ...
    invoke-virtual {v7}, Lcom/iMe/storage/domain/model/wallet/transaction/Transaction;->getTokenCode()Lcom/iMe/storage/domain/model/wallet/token/TokenCode;

    move-result-object v7

    invoke-virtual {v1, v7}, Lcom/iMe/storage/domain/model/wallet/token/TokenInfo$Companion;->map(Lcom/iMe/storage/domain/model/wallet/token/TokenCode;)Lcom/iMe/storage/domain/model/wallet/token/TokenInfo;
    ...
    .line 48
    iget-object v8, p0, Lcom/iMe/model/wallet/transaction/TransactionItem;->transaction:Lcom/iMe/storage/domain/model/wallet/transaction/Transaction;

    check-cast v8, Lcom/iMe/storage/domain/model/wallet/transaction/Transaction$Crypto$SimplexPurchase;

    invoke-virtual {v8}, Lcom/iMe/storage/domain/model/wallet/transaction/Transaction$Crypto$SimplexPurchase;->getSpentAmount()Ljava/math/BigDecimal;
    ...
    invoke-static {v0, v2}, Lcom/iMe/utils/formatter/BalanceFormatter;->formatBalance(Ljava/lang/Number;I)Ljava/lang/String;
    ...
    .line 46
    invoke-interface {p1, v7, v6}, Lcom/iMe/storage/domain/utils/system/ResourceManager;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/iMe/storage/domain/model/wallet/transaction/Transaction$Crypto$Swap;->getInputTokenCode()Lcom/iMe/storage/domain/model/wallet/token/TokenCode;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/iMe/storage/domain/model/wallet/token/TokenInfo$Companion;->map(Lcom/iMe/storage/domain/model/wallet/token/TokenCode;)Lcom/iMe/storage/domain/model/wallet/token/TokenInfo;
    ...
    invoke-virtual {v7}, Lcom/iMe/storage/domain/model/wallet/transaction/Transaction$Crypto$Swap;->getOutputTokenCode()Lcom/iMe/storage/domain/model/wallet/token/TokenCode;
    ...
    check-cast v8, Lcom/iMe/storage/domain/model/wallet/transaction/Transaction$Crypto$Swap;

    invoke-virtual {v8}, Lcom/iMe/storage/domain/model/wallet/transaction/Transaction$Crypto$Swap;->getInputAmount()Ljava/math/BigDecimal;
    ...
    invoke-virtual {v2}, Lcom/iMe/storage/domain/model/wallet/transaction/Transaction;->getTokenCode()Lcom/iMe/storage/domain/model/wallet/token/TokenCode;
...
.method public final getAmountWithSymbol(Z)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/iMe/storage/domain/model/wallet/transaction/TransactionDirection;->getSymbol()Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/iMe/utils/extentions/model/wallet/TransactionExtKt;->getFormattedAmount(Lcom/iMe/storage/domain/model/wallet/transaction/Transaction;)Ljava/lang/String;
