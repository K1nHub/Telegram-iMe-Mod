...
.method public final onPinChanged(Ljava/lang/String;)V
    ...
    .line 86
    :cond_0
    invoke-virtual {p0, p1}, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->validatePin(Ljava/lang/String;)V
...
.method public final validatePin(Ljava/lang/String;)V
    ...
    .line 43
    iget-object p1, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->guid:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->seed:Ljava/lang/String;
    ...
    .line 61
    iget-object v6, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->guid:Ljava/lang/String;

    iget-object v7, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->password:Ljava/lang/String;

    invoke-virtual {p1, v6, v7}, Lcom/iMe/storage/domain/interactor/crypto/CryptoWalletInteractor;->generateMnemonic(Ljava/lang/String;Ljava/lang/String;)Lio/reactivex/Observable;

    move-result-object p1

    .line 62
    iget-object v6, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->schedulersProvider:Lcom/iMe/storage/domain/utils/rx/SchedulersProvider;

    invoke-interface {v6}, Lcom/iMe/storage/domain/utils/rx/SchedulersProvider;->ui()Lio/reactivex/Scheduler;
    ...
    invoke-static {p1, v4, v1, v3, v5}, Lcom/iMe/utils/extentions/rx/RxExtKt;->withLoadingDialog$default(Lio/reactivex/Observable;Lcom/iMe/ui/base/mvp/base/BaseView;ZILjava/lang/Object;)Lio/reactivex/Observable;

    move-result-object p1

    .line 44
    new-instance v1, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$3;

    invoke-direct {v1, p0}, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$3;-><init>(Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;)V
    ...
    new-instance v1, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$4;

    invoke-direct {v1, v5}, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$4;-><init>(Lcom/iMe/ui/base/mvp/base/BaseView;)V
    ...
    .line 75
    invoke-static {p0, p1, v5, v0, v5}, Lcom/iMe/ui/base/mvp/base/BasePresenter;->autoDispose$default(Lcom/iMe/ui/base/mvp/base/BasePresenter;Lio/reactivex/disposables/Disposable;Lio/reactivex/disposables/CompositeDisposable;ILjava/lang/Object;)V
    ...
    :cond_3
    :goto_2
    iget-object v6, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->cryptoWalletInteractor:Lcom/iMe/storage/domain/interactor/crypto/CryptoWalletInteractor;

    .line 45
    iget-object v7, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->password:Ljava/lang/String;

    iget-object v8, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->pin:Ljava/lang/String;

    iget-object v9, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->guid:Ljava/lang/String;

    iget-object v10, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->seed:Ljava/lang/String;

    iget-object p1, p0, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;->cryptoPreferenceHelper:Lcom/iMe/storage/domain/storage/CryptoPreferenceHelper;
    ...
    invoke-virtual/range {v6 .. v11}, Lcom/iMe/storage/domain/interactor/crypto/CryptoWalletInteractor;->createWallet(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/iMe/storage/domain/model/crypto/BlockchainType;)Lio/reactivex/Observable;
    ...
    invoke-static {p1, v4, v1}, Lcom/iMe/utils/extentions/rx/RxExtKt;->withLoadingDialog(Lio/reactivex/Observable;Lcom/iMe/ui/base/mvp/base/BaseView;Z)Lio/reactivex/Observable;
    ...
    .line 44
    new-instance v3, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$1;

    invoke-direct {v3, p0}, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$1;-><init>(Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter;)V
    ...
    new-instance v3, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$2;

    invoke-direct {v3, v1}, Lcom/iMe/ui/wallet/crypto/create/pin/CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$2;-><init>(Lcom/iMe/ui/base/mvp/base/BaseView;)V
