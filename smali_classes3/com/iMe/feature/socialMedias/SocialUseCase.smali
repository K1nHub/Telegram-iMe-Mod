...
.method private final updateSocialAccess(Lcom/iMe/feature/profile/ProfileData;Lcom/iMe/storage/domain/model/Result;)Lio/reactivex/Observable;
    ...
    const-string p2, "just(result.data?.copy(h\u2026)?.toSuccess() ?: result)"
...
.method public final listenSocialChanges()Lcom/jakewharton/rxrelay2/PublishRelay;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lcom/iMe/feature/socialMedias/SocialRepository;->listenSocialChanges()Lcom/jakewharton/rxrelay2/PublishRelay;
...
.method public final startSocialAuth(Lcom/iMe/feature/socialMedias/SocialType;J)Lio/reactivex/Observable;
    ...
    const-string p2, "fun startSocialAuth(soci\u2026 profileId, socialType) }"
