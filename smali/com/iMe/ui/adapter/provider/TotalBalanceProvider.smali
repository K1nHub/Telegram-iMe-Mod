...
.method public convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/iMe/model/wallet/home/TotalBalanceItem;)V
    ...
    .line 30
    iget-object v2, p0, Lcom/iMe/ui/adapter/provider/TotalBalanceProvider;->cryptoPreferenceHelper:Lcom/iMe/storage/domain/storage/CryptoPreferenceHelper;

    invoke-interface {v2}, Lcom/iMe/storage/domain/storage/CryptoPreferenceHelper;->getCryptoHiddenBalance()Z

    move-result v2

    invoke-virtual {p2, v2}, Lcom/iMe/model/wallet/home/TotalBalanceItem;->getFormattedBalance(Z)Ljava/lang/String;
    ...
    invoke-static {p1, v0, p2}, Lcom/iMe/utils/extentions/common/BaseQuickAdapterExtKt;->setThemedImageColor(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Ljava/lang/String;[I)Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;
