.class final Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;->convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/iMe/model/catalog/CategoryWithCampaignsItem;)V
.end annotation
...
.field final synthetic $item:Lcom/iMe/model/catalog/CategoryWithCampaignsItem;

.field final synthetic this$0:Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;


# direct methods
.method public static synthetic $r8$lambda$CmT9vbnul5pWpWPa4ygwmBDoZl0(Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;Lcom/iMe/model/catalog/CategoryWithCampaignsItem;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;->invoke$lambda$5$lambda$4$lambda$3(Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;Lcom/iMe/model/catalog/CategoryWithCampaignsItem;)V

    return-void
.end method

.method public static synthetic $r8$lambda$oDpdwMtEk9DAJzQ3PTZ14AKQ-Yg(Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;->invoke$lambda$5$lambda$2(Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V

    return-void
.end method

.method constructor <init>(Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/iMe/model/catalog/CategoryWithCampaignsItem;)V
    .locals 0

    iput-object p1, p0, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;->this$0:Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;

    iput-object p2, p0, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;->$helper:Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;

    iput-object p3, p0, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;->$item:Lcom/iMe/model/catalog/CategoryWithCampaignsItem;
...
.method private static final invoke$lambda$1(Lkotlin/Lazy;)Lcom/iMe/ui/catalog/tabs/all/adapter/CatalogAllChannelsRecycleAdapter;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast p0, Lcom/iMe/ui/catalog/tabs/all/adapter/CatalogAllChannelsRecycleAdapter;

    return-object p0
.end method

.method private static final invoke$lambda$5$lambda$2(Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V
    .locals 1
    ...
    instance-of p2, p1, Lcom/iMe/model/catalog/CampaignItem;
...
.method private static final invoke$lambda$5$lambda$4$lambda$3(Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;Lcom/iMe/model/catalog/CategoryWithCampaignsItem;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lcom/iMe/model/catalog/CategoryWithCampaignsItem;->getCategory()Lcom/iMe/storage/domain/model/catalog/CatalogCategory;

    move-result-object p1

    invoke-virtual {p1}, Lcom/iMe/storage/domain/model/catalog/CatalogCategory;->getId()J
...
.method public final invoke(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object v1, p0, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;->this$0:Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider;

    iget-object v2, p0, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;->$helper:Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;
    ...
    .line 61
    new-instance v2, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1$invoke$$inlined$inject$default$1;

    const/4 v3, 0x0

    invoke-direct {v2, v0, v3, v3}, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1$invoke$$inlined$inject$default$1;-><init>(Lorg/koin/core/component/KoinComponent;Lorg/koin/core/qualifier/Qualifier;Lkotlin/jvm/functions/Function0;)V
    ...
    iget-object v1, p0, Lcom/iMe/ui/adapter/provider/CategoryWithCampaignsProvider$convert$1;->$item:Lcom/iMe/model/catalog/CategoryWithCampaignsItem;
    ...
    invoke-virtual {v1}, Lcom/iMe/model/catalog/CategoryWithCampaignsItem;->getCategory()Lcom/iMe/storage/domain/model/catalog/CatalogCategory;
