.class public final Lcom/iMe/ui/adapter/provider/CexProtocolProvider;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/iMe/model/wallet/swap/CexProtocolItem;",
        ">;"
    }
.end annotation
...
.method public constructor <init>(Lcom/iMe/storage/domain/utils/system/ResourceManager;)V
    ...
    .line 16
    iput-object p1, p0, Lcom/iMe/ui/adapter/provider/CexProtocolProvider;->resourceManager:Lcom/iMe/storage/domain/utils/system/ResourceManager;

    .line 20
    sget p1, Lcom/iMe/common/IdFabric$ViewTypes;->CENTRALIZED_EXCHANGES:I

    iput p1, p0, Lcom/iMe/ui/adapter/provider/CexProtocolProvider;->itemViewType:I

    .line 21
    sget p1, Lorg/telegram/messenger/R$layout;->fork_recycle_item_wallet_card_icon_title_subtitle:I

    iput p1, p0, Lcom/iMe/ui/adapter/provider/CexProtocolProvider;->layoutId:I
...
# virtual methods
.method public convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/iMe/model/wallet/swap/CexProtocolItem;)V
    .locals 4
    ...
    invoke-virtual {p2}, Lcom/iMe/model/wallet/swap/CexProtocolItem;->getInfo()Lcom/iMe/storage/domain/model/wallet/swap/CentralizedExchangesInfo;

    move-result-object v3

    invoke-virtual {v3}, Lcom/iMe/storage/domain/model/wallet/swap/CentralizedExchangesInfo;->getLogo()I
    ...
    .line 32
    iget-object v2, p0, Lcom/iMe/ui/adapter/provider/CexProtocolProvider;->resourceManager:Lcom/iMe/storage/domain/utils/system/ResourceManager;

    invoke-virtual {p2}, Lcom/iMe/model/wallet/swap/CexProtocolItem;->getInfo()Lcom/iMe/storage/domain/model/wallet/swap/CentralizedExchangesInfo;

    move-result-object v3

    invoke-virtual {v3}, Lcom/iMe/storage/domain/model/wallet/swap/CentralizedExchangesInfo;->getName()I
    ...
    .line 33
    iget-object v0, p0, Lcom/iMe/ui/adapter/provider/CexProtocolProvider;->resourceManager:Lcom/iMe/storage/domain/utils/system/ResourceManager;

    invoke-virtual {p2}, Lcom/iMe/model/wallet/swap/CexProtocolItem;->getInfo()Lcom/iMe/storage/domain/model/wallet/swap/CentralizedExchangesInfo;

    move-result-object p2

    invoke-virtual {p2}, Lcom/iMe/storage/domain/model/wallet/swap/CentralizedExchangesInfo;->getDescription()I
...
.method public bridge synthetic convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Ljava/lang/Object;)V
    ...
    .line 15
    check-cast p2, Lcom/iMe/model/wallet/swap/CexProtocolItem;

    invoke-virtual {p0, p1, p2}, Lcom/iMe/ui/adapter/provider/CexProtocolProvider;->convert(Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;Lcom/iMe/model/wallet/swap/CexProtocolItem;)V
...
.method public getItemViewType()I
    ...
    .line 20
    iget v0, p0, Lcom/iMe/ui/adapter/provider/CexProtocolProvider;->itemViewType:I
...
.method public getLayoutId()I
    ...
    .line 21
    iget v0, p0, Lcom/iMe/ui/adapter/provider/CexProtocolProvider;->layoutId:I
