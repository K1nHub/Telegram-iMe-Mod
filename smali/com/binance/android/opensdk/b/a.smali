...
.method public handleResp(Landroid/content/Intent;)V
    .locals 5
    ...
    iget-object p1, p0, Lcom/binance/android/opensdk/b/a;->b:Lcom/binance/android/opensdk/api/BinanceListener;
    ...
    :goto_4
    invoke-interface {p1, v0, v2}, Lcom/binance/android/opensdk/api/BinanceListener;->onSuccess(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_9
    invoke-interface {p1, v3}, Lcom/binance/android/opensdk/api/BinanceListener;->onError(I)V
