...
public class ViewDragHelper {
    ...
    private void clearMotionHistory() {
        ...
        Arrays.fill(this.mInitialMotionY, (float) BitmapDescriptorFactory.HUE_RED);
        Arrays.fill(this.mLastMotionX, (float) BitmapDescriptorFactory.HUE_RED);
        Arrays.fill(this.mLastMotionY, (float) BitmapDescriptorFactory.HUE_RED);
