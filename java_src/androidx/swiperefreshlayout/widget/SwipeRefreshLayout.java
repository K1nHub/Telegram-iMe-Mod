...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild, NestedScrollingParent {
    ...
    private void moveSpinner(float f) {
        ...
        this.mProgress.setStartEndTrim(BitmapDescriptorFactory.HUE_RED, Math.min(0.8f, max * 0.8f));
    ...
    private void finishSpinner(float f) {
        ...
        this.mRefreshing = false;
        this.mProgress.setStartEndTrim(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED);
