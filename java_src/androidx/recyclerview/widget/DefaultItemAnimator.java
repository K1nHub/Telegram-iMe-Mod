...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view2 != null) {
            ...
            animate.translationX(BitmapDescriptorFactory.HUE_RED).translationY(BitmapDescriptorFactory.HUE_RED).setDuration(getChangeAddDuration()).setStartDelay(getChangeDelay() + (getChangeDuration() - getChangeAddDuration())).setInterpolator(getChangeInterpolator()).alpha(1.0f);
