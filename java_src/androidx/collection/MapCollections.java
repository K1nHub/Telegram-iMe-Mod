...
public abstract class MapCollections<K, V> {
    ...
    /* loaded from: classes.dex */
    final class ArrayIterator<T> implements Iterator<T>, p033j$.util.Iterator {
    ...
    /* loaded from: classes.dex */
    final class MapIterator implements java.util.Iterator<Map.Entry<K, V>>, Map.Entry<K, V>, p033j$.util.Iterator, Map.Entry {
        int mEnd;
        ...
        @Override // java.util.Map.Entry, p033j$.util.Map.Entry
        public K getKey() {
            if (!this.mEntryValid) {
