...
public class ExifInterface {
    ...
    static {
        ...
        ExifTag[] exifTagArr8 = {new ExifTag("PreviewImageStart", TsExtractor.TS_STREAM_TYPE_AIT, 4), new ExifTag("PreviewImageLength", 258, 4)};
        ...
        Charset forName = Charset.forName(C0479C.ASCII_NAME);
        ASCII = forName;
    ...
    private void loadAttributes(InputStream inputStream) {
        ...
        if (!this.mIsExifDataOnly) {
            BufferedInputStream bufferedInputStream = new BufferedInputStream(inputStream, DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS);
    ...
    private int getMimeType(BufferedInputStream bufferedInputStream) throws IOException {
        bufferedInputStream.mark(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS);
