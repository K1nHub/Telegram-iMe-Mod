...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(BitmapDescriptorFactory.HUE_RED, this.mRawShadowSize / 2.0f);
        drawShadow(canvas);
        canvas.translate(BitmapDescriptorFactory.HUE_RED, (-this.mRawShadowSize) / 2.0f);
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f4 = f3 * 2.0f;
        boolean z = this.mCardBounds.width() - f4 > BitmapDescriptorFactory.HUE_RED;
        boolean z2 = this.mCardBounds.height() - f4 > BitmapDescriptorFactory.HUE_RED;
        int save = canvas.save();
        RectF rectF = this.mCardBounds;
        canvas.translate(rectF.left + f3, rectF.top + f3);
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (z) {
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f2, this.mCardBounds.width() - f4, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
        ...
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (z) {
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f2, this.mCardBounds.width() - f4, (-this.mCornerRadius) + this.mShadowSize, this.mEdgeShadowPaint);
        }
        ...
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (z2) {
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f2, this.mCardBounds.height() - f4, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
    ...
    private void buildShadowCorners() {
        ...
        this.mCornerShadowPath.moveTo(-this.mCornerRadius, BitmapDescriptorFactory.HUE_RED);
        this.mCornerShadowPath.rLineTo(-this.mShadowSize, BitmapDescriptorFactory.HUE_RED);
        ...
        paint.setShader(new RadialGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, f5, new int[]{i, i, this.mShadowEndColor}, new float[]{BitmapDescriptorFactory.HUE_RED, f4, 1.0f}, Shader.TileMode.CLAMP));
        Paint paint2 = this.mEdgeShadowPaint;
        float f6 = this.mCornerRadius;
        float f7 = this.mShadowSize;
        int i2 = this.mShadowStartColor;
        paint2.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (-f6) + f7, (float) BitmapDescriptorFactory.HUE_RED, (-f6) - f7, new int[]{i2, i2, this.mShadowEndColor}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
