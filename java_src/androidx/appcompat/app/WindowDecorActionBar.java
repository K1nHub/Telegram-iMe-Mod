...
public class WindowDecorActionBar extends AbstractC0025ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public void doShow(boolean z) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || z)) {
            ...
            ViewPropertyAnimatorCompat translationY = ViewCompat.animate(this.mContainerView).translationY(BitmapDescriptorFactory.HUE_RED);
            translationY.setUpdateListener(this.mUpdateListener);
            viewPropertyAnimatorCompatSet2.play(translationY);
            if (this.mContentAnimations && (view2 = this.mContentView) != null) {
                view2.setTranslationY(f);
                viewPropertyAnimatorCompatSet2.play(ViewCompat.animate(this.mContentView).translationY(BitmapDescriptorFactory.HUE_RED));
            }
