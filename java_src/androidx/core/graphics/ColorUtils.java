...
public final class ColorUtils {
    ...
    public static void RGBToHSL(int i, int i2, int i3, float[] fArr) {
        ...
        fArr[0] = constrain(f7, (float) BitmapDescriptorFactory.HUE_RED, 360.0f);
        fArr[1] = constrain(abs, (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
        fArr[2] = constrain(f6, (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
    }
