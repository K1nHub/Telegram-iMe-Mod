...
import android.support.p008v4.app.INotificationSideChannel;
...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f37id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f37id + ", tag:" + this.tag + "]";
        }
    }
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f36id, this.tag);
            }
        }
