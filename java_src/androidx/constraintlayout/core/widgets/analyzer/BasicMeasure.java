...
public class BasicMeasure {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:54:0x0094, code lost:
        if (r5.mDimensionRatio <= com.google.android.gms.maps.model.BitmapDescriptorFactory.HUE_RED) goto L55;
     */
    /*
    ...
    public long solverMeasure(ConstraintWidgetContainer constraintWidgetContainer, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (z4) {
            for (int i14 = 0; i14 < size; i14++) {
                ...
                ConstraintWidget.DimensionBehaviour horizontalDimensionBehaviour = constraintWidget.getHorizontalDimensionBehaviour();
                ConstraintWidget.DimensionBehaviour dimensionBehaviour = ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT;
                boolean z5 = (horizontalDimensionBehaviour == dimensionBehaviour) && (constraintWidget.getVerticalDimensionBehaviour() == dimensionBehaviour) && constraintWidget.getDimensionRatio() > BitmapDescriptorFactory.HUE_RED;
        ...
        if (size2 > 0) {
            ...
            while (i16 < size2) {
                ...
                if (constraintWidget2 instanceof VirtualLayout) {
                    ...
                    boolean measure = basicMeasure.measure(measurer, constraintWidget2, Measure.TRY_GIVEN_DIMENSIONS) | z9;
