    ...
    */
    ...
    private int enforceBFS(Row row) throws Exception {
        ...
        while (true) {
            ...
            ArrayRow[] arrayRowArr = this.mRows;
            if (arrayRowArr[i].variable.mType != SolverVariable.Type.UNRESTRICTED && arrayRowArr[i].constantValue < BitmapDescriptorFactory.HUE_RED) {
                z = true;
                break;
            }
            i++;
        ...
        if (z) {
            ...
            while (!z2) {
                ...
                for (int i6 = 0; i6 < this.mNumRows; i6++) {
                    ...
                    if (arrayRow.variable.mType != SolverVariable.Type.UNRESTRICTED && !arrayRow.isSimpleDefinition && arrayRow.constantValue < BitmapDescriptorFactory.HUE_RED) {
                        int i7 = 9;
                        if (SKIP_COLUMNS) {
