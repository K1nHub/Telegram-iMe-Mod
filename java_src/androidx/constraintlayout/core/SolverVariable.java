...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    int synonym = -1;
    float synonymDelta = BitmapDescriptorFactory.HUE_RED;
    ...
    public void reset() {
        ...
        this.inGoal = false;
        Arrays.fill(this.goalStrengthVector, (float) BitmapDescriptorFactory.HUE_RED);
    }
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f20id - solverVariable.f20id;
    }
