...
public class ArrayRow implements LinearSystem.Row {
    ...
    public boolean hasKeyVariable() {
        ...
        return solverVariable != null && (solverVariable.mType == SolverVariable.Type.UNRESTRICTED || this.constantValue >= BitmapDescriptorFactory.HUE_RED);
    }
    ...
    */
    ...
    SolverVariable chooseSubjectInVariables(LinearSystem linearSystem) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variable.mType == SolverVariable.Type.UNRESTRICTED) {
                ...
                f = variableValue;
                solverVariable = variable;
            } else if (solverVariable == null && variableValue < BitmapDescriptorFactory.HUE_RED) {
    ...
    public boolean isEmpty() {
        return this.variable == null && this.constantValue == BitmapDescriptorFactory.HUE_RED && this.variables.getCurrentSize() == 0;
    }
