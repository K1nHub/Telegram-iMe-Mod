...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            if (widget.getVisibility() == 8 && !widget.isInPlaceholder()) {
                ...
                boolean z7 = z3 && widget.mDimensionRatio > BitmapDescriptorFactory.HUE_RED;
                boolean z8 = z4 && widget.mDimensionRatio > BitmapDescriptorFactory.HUE_RED;
                if (view == null) {
                    return;
                }
    ...
    static /* synthetic */ class C01131 {
        ...
        static {
            ...
            try {
                f35x6d00e4a2[ConstraintWidget.DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35x6d00e4a2[ConstraintWidget.DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f35x6d00e4a2[ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (i2) {
                    ...
                    case 35:
                        this.matchConstraintPercentWidth = Math.max((float) BitmapDescriptorFactory.HUE_RED, obtainStyledAttributes.getFloat(index, this.matchConstraintPercentWidth));
                    ...
                    case 38:
                        this.matchConstraintPercentHeight = Math.max((float) BitmapDescriptorFactory.HUE_RED, obtainStyledAttributes.getFloat(index, this.matchConstraintPercentHeight));
