...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo2130getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            ...
            Object putIfAbsent2 = access$getSerializers$p.putIfAbsent(arrayList, m1942boximpl);
            obj = putIfAbsent2 == null ? m1942boximpl : putIfAbsent2;
        }
        Intrinsics.checkNotNullExpressionValue(obj, "serializers.getOrPut(wra… { producer() }\n        }");
        return ((Result) obj).m1951unboximpl();
    }
}
