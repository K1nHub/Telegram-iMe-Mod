...
public final class UIntArrayBuilder extends PrimitiveArrayBuilder<UIntArray> {
    ...
    public /* bridge */ /* synthetic */ UIntArray build$kotlinx_serialization_core() {
        return UIntArray.m1972boximpl(m2134buildhP7Qyg$kotlinx_serialization_core());
    }

    private UIntArrayBuilder(int[] iArr) {
        this.buffer = iArr;
        this.position = UIntArray.m1979getSizeimpl(iArr);
    ...
    public void ensureCapacity$kotlinx_serialization_core(int i) {
        int coerceAtLeast;
        if (UIntArray.m1979getSizeimpl(this.buffer) < i) {
            int[] iArr = this.buffer;
            coerceAtLeast = RangesKt___RangesKt.coerceAtLeast(i, UIntArray.m1979getSizeimpl(iArr) * 2);
            int[] copyOf = Arrays.copyOf(iArr, coerceAtLeast);
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
            this.buffer = UIntArray.m1974constructorimpl(copyOf);
        }
    }

    /* renamed from: append-WZ4Q5Ns$kotlinx_serialization_core  reason: not valid java name */
    public final void m2133appendWZ4Q5Ns$kotlinx_serialization_core(int i) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        int[] iArr = this.buffer;
        int position$kotlinx_serialization_core = getPosition$kotlinx_serialization_core();
        this.position = position$kotlinx_serialization_core + 1;
        UIntArray.m1983setVXSXFK8(iArr, position$kotlinx_serialization_core, i);
    }

    /* renamed from: build--hP7Qyg$kotlinx_serialization_core  reason: not valid java name */
    public int[] m2134buildhP7Qyg$kotlinx_serialization_core() {
        int[] copyOf = Arrays.copyOf(this.buffer, getPosition$kotlinx_serialization_core());
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return UIntArray.m1974constructorimpl(copyOf);
    }
}
