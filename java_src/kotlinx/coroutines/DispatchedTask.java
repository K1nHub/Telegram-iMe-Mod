    ...
    public final void run() {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m1479constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m1479constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m1479constructorimpl(successfulResult$kotlinx_coroutines_core));
            }
            ...
            try {
                ...
                m1479constructorimpl2 = Result.m1479constructorimpl(unit);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m1479constructorimpl2 = Result.m1479constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m1480exceptionOrNullimpl(m1479constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m1479constructorimpl = Result.m1479constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m1480exceptionOrNullimpl(m1479constructorimpl));
        }
    }
}
