...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2118trySendImplMj0NB7M = conflatedBufferedChannel.m2118trySendImplMj0NB7M(e, true);
        if (m2118trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2107exceptionOrNullimpl(m2118trySendImplMj0NB7M);
    ...
    public Object mo2103trySendJP2dKIU(E e) {
        return m2118trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m2118trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2116trySendDropLatestMj0NB7M(e, z) : m2117trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m2116trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2103trySendJP2dKIU = super.mo2103trySendJP2dKIU(e);
        if (ChannelResult.m2110isSuccessimpl(mo2103trySendJP2dKIU) || ChannelResult.m2109isClosedimpl(mo2103trySendJP2dKIU)) {
            return mo2103trySendJP2dKIU;
        }
    ...
    private final Object m2117trySendDropOldestJP2dKIU(E e) {
        ...
        while (true) {
            ...
            if (channelSegment2.f1399id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.Companion.m2113closedJP2dKIU(getSendException());
                }
            } else {
