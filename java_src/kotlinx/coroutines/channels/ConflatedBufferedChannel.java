...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2110trySendImplMj0NB7M = conflatedBufferedChannel.m2110trySendImplMj0NB7M(e, true);
        if (m2110trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2099exceptionOrNullimpl(m2110trySendImplMj0NB7M);
    ...
    public Object mo2095trySendJP2dKIU(E e) {
        return m2110trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m2110trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2108trySendDropLatestMj0NB7M(e, z) : m2109trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m2108trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2095trySendJP2dKIU = super.mo2095trySendJP2dKIU(e);
        if (ChannelResult.m2102isSuccessimpl(mo2095trySendJP2dKIU) || ChannelResult.m2101isClosedimpl(mo2095trySendJP2dKIU)) {
            return mo2095trySendJP2dKIU;
        }
        ...
        return ChannelResult.Companion.m2107successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU  reason: not valid java name */
    private final Object m2109trySendDropOldestJP2dKIU(E e) {
        ...
        while (true) {
            ...
            if (channelSegment2.f1399id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.Companion.m2105closedJP2dKIU(getSendException());
                }
            } else {
