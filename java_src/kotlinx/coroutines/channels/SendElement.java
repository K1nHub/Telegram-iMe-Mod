...
public class SendElement<E> extends Send {
    ...
    public Symbol tryResumeSend(LockFreeLinkedListNode.PrepareOp prepareOp) {
        Object tryResume = this.cont.tryResume(Unit.INSTANCE, null);
        if (tryResume == null) {
            return null;
        }
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m1574constructorimpl(ResultKt.createFailure(closed.getSendException())));
    }
