...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, Flow {
    ...
    private final Object awaitValue(SharedFlowSlot sharedFlowSlot, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryPeekLocked(sharedFlowSlot) < 0) {
                ...
                cancellableContinuationImpl.resumeWith(Result.m1574constructorimpl(Unit.INSTANCE));
            }
            unit = Unit.INSTANCE;
        }
    ...
    private final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation<Unit> continuation2 : continuationArr) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m1574constructorimpl(Unit.INSTANCE));
            }
        }
        Object result = cancellableContinuationImpl.getResult();
        coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
    ...
    */
    ...
    public boolean tryEmit(T t) {
        ...
        for (Continuation<Unit> continuation : continuationArr) {
            if (continuation != null) {
                Result.Companion companion = Result.Companion;
                continuation.resumeWith(Result.m1574constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x003c, code lost:
        r4 = ((kotlinx.coroutines.flow.internal.AbstractSharedFlow) r19).slots;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
