...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f2192default;
    ...
    static {
        ...
        f2192default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }

    @Override // java.util.concurrent.Executor
    public void execute(Runnable runnable) {
        mo2122dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    /* renamed from: dispatch */
    public void mo2122dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f2192default.mo2122dispatch(coroutineContext, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        f2192default.dispatchYield(coroutineContext, runnable);
    }
