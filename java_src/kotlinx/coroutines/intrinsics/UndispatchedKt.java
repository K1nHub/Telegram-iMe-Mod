        ...
        try {
            ...
            if (function1 != null) {
                ...
                if (invoke != coroutine_suspended) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m1571constructorimpl(invoke));
                    return;
                }
                return;
            }
            ...
            probeCoroutineCreated.resumeWith(Result.m1571constructorimpl(ResultKt.createFailure(th)));
        }
    }
