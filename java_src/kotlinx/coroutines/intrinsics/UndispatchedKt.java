        ...
        try {
            ...
            if (function1 != null) {
                ...
                if (invoke != coroutine_suspended) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m1479constructorimpl(invoke));
                    return;
                }
                return;
            }
            ...
            probeCoroutineCreated.resumeWith(Result.m1479constructorimpl(ResultKt.createFailure(th)));
        }
    }
