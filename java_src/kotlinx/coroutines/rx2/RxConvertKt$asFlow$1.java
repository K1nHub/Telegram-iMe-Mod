...
final class RxConvertKt$asFlow$1 extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C31451 c31451 = new C31451(atomicReference);
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c31451, this) == coroutine_suspended) {
    ...
    /* loaded from: classes4.dex */
    public static final class C31451 extends Lambda implements Function0<Unit> {
        final /* synthetic */ AtomicReference<Disposable> $disposableRef;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C31451(AtomicReference<Disposable> atomicReference) {
            super(0);
