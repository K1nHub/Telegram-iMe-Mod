...
public final class LockFreeTaskQueueCore<E> {
    ...
    */
    ...
    private final LockFreeTaskQueueCore<E> allocateNextCopy(long j) {
        ...
        while (true) {
            ...
            if ((i & i3) != (i2 & i3)) {
                ...
                _state$FU.set(lockFreeTaskQueueCore, Companion.m132wo(j, 1152921504606846976L));
                return lockFreeTaskQueueCore;
            }
        }
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: wo */
        public final long m132wo(long j, long j2) {
            return j & (~j2);
        }
        ...
        public final long updateHead(long j, int i) {
            return m132wo(j, 1073741823L) | (i << 0);
        }

        public final long updateTail(long j, int i) {
            return m132wo(j, 1152921503533105152L) | (i << 30);
        }
    }
}
