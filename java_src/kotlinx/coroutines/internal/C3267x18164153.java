...
public final class C3267x18164153 extends Lambda implements Function1<Throwable, Throwable> {
    final /* synthetic */ Constructor $constructor$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3267x18164153(Constructor constructor) {
        super(1);
    ...
    public final Throwable invoke(Throwable th) {
        ...
        m1601constructorimpl = Result.m1601constructorimpl((Throwable) newInstance);
