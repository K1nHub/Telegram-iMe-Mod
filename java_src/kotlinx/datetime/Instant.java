...
public final class Instant implements Comparable<Instant> {
    ...
    public final Instant m2128minusLRDsOJo(long j) {
        return m2129plusLRDsOJo(Duration.m2091unaryMinusUwyO8pc(j));
    }

    /* renamed from: minus-5sfh64U  reason: not valid java name */
    public final long m2127minus5sfh64U(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.Companion;
        return Duration.m2087plusLRDsOJo(DurationKt.toDuration(this.value.getEpochSecond() - other.value.getEpochSecond(), DurationUnit.SECONDS), DurationKt.toDuration(this.value.getNano() - other.value.getNano(), DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m2129plusLRDsOJo(long j) {
        try {
            p033j$.time.Instant plusNanos = this.value.plusSeconds(Duration.m2074getInWholeSecondsimpl(j)).plusNanos(Duration.m2076getNanosecondsComponentimpl(j));
            ...
            if ((e instanceof ArithmeticException) || (e instanceof DateTimeException)) {
                return Duration.m2086isPositiveimpl(j) ? MAX : MIN;
            }
            throw e;
        }
    }
