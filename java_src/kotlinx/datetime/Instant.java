...
public final class Instant implements Comparable<Instant> {
    ...
    public final Instant m2120minusLRDsOJo(long j) {
        return m2121plusLRDsOJo(Duration.m2083unaryMinusUwyO8pc(j));
    }

    /* renamed from: minus-5sfh64U  reason: not valid java name */
    public final long m2119minus5sfh64U(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.Companion;
        return Duration.m2079plusLRDsOJo(DurationKt.toDuration(this.value.getEpochSecond() - other.value.getEpochSecond(), DurationUnit.SECONDS), DurationKt.toDuration(this.value.getNano() - other.value.getNano(), DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m2121plusLRDsOJo(long j) {
        try {
            p033j$.time.Instant plusNanos = this.value.plusSeconds(Duration.m2066getInWholeSecondsimpl(j)).plusNanos(Duration.m2068getNanosecondsComponentimpl(j));
            ...
            if ((e instanceof ArithmeticException) || (e instanceof DateTimeException)) {
                return Duration.m2078isPositiveimpl(j) ? MAX : MIN;
            }
            throw e;
        }
    }
