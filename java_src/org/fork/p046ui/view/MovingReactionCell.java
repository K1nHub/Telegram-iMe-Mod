...
/* renamed from: org.fork.ui.view.MovingReactionCell */
...
public final class MovingReactionCell extends FrameLayout {
    ...
    public final void updateUrlButton(UrlButton urlButton) {
        ...
        if (urlButton.getTitle().length() == 0) {
            getEditText().setHint(LocaleController.getInternalString(C3158R.string.chat_reaction_enter_the_title));
        }
        TextView valueTextView = getValueTextView();
        String url = urlButton.getUrl();
        if (url.length() == 0) {
            url = LocaleController.getInternalString(C3158R.string.chat_reaction_link_not_added);
        }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [android.widget.TextView, android.widget.EditText, org.fork.ui.view.MovingReactionCell$initEditText$1] */
    public final MovingReactionCell$initEditText$1 initEditText() {
        final Context context = getContext();
        ?? r1 = new EditTextBoldCursor(context) { // from class: org.fork.ui.view.MovingReactionCell$initEditText$1
        ...
        r1.setHint(LocaleController.getInternalString(C3158R.string.chat_reaction_enter_the_title));
    ...
    public final ImageView initMoveImageView() {
        ...
        imageView.setImageResource(C3158R.C3160drawable.poll_reorder);
        return imageView;
    }
    ...
    public final TextView initValueTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3158R.string.chat_reaction_link_not_added));
    ...
    public final ImageView initDeleteImageView() {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor("stickers_menu"), PorterDuff.Mode.MULTIPLY));
        imageView.setClickable(true);
        imageView.setImageResource(C3158R.C3160drawable.delete);
        return imageView;
    }
    ...
    public final ImageView initLinkImageView() {
        ...
        imageView.setVisibility(getLinkIconShow() ? 0 : 8);
        imageView.setImageResource(C3158R.C3160drawable.msg_link);
        return imageView;
    }
    ...
    /* compiled from: MovingReactionCell.kt */
    /* renamed from: org.fork.ui.view.MovingReactionCell$Companion */
    /* loaded from: classes4.dex */
