...
/* renamed from: org.fork.ui.view.PollEditTextCellWrapper */
...
public final class PollEditTextCellWrapper extends LinearLayout {
    ...
    public final TextView initNoIconTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3301R.string.no_icon));
    ...
    public final ImageView initArrowImageView() {
        ImageView imageView = new ImageView(getContext());
        imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
        imageView.setImageResource(C3301R.C3303drawable.arrow_more);
        return imageView;
    }

    /* compiled from: PollEditTextCellWrapper.kt */
    /* renamed from: org.fork.ui.view.PollEditTextCellWrapper$Companion */
    /* loaded from: classes4.dex */
