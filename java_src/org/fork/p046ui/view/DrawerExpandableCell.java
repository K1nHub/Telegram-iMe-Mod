...
/* renamed from: org.fork.ui.view.DrawerExpandableCell */
...
public final class DrawerExpandableCell extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        getTextView().setTextColor(Theme.getColor("chats_menuItemText"));
    }
    ...
    public final TextView initTextView() {
        ...
        textView.setCompoundDrawablePadding(AndroidUtilities.m50dp(29));
    ...
    public final ImageView initArrowView() {
        ...
        imageView.setImageResource(C3301R.C3303drawable.msg_expand);
        return imageView;
    }
