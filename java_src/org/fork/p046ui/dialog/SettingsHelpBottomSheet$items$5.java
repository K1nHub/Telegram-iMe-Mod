...
/* renamed from: org.fork.ui.dialog.SettingsHelpBottomSheet$items$5 */
...
final class SettingsHelpBottomSheet$items$5 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        Browser.openUrl(this.this$0.getContext(), LocaleController.getInternalString(C3158R.string.settings_help_alert_faq_url));
    }
}
