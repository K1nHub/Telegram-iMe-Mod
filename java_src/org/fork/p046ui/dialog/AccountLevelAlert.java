...
public final class AccountLevelAlert extends AlertDialog.Builder implements KoinComponent {
    ...
    public AccountLevelAlert(Context mContext, AccountLevelInformation accountLevelInformation, OnVisibilityChangedListener visibilityChangedListener) {
        ...
        setTitle(LocaleController.formatStringInternal(C3286R.string.wallet_account_level_alert_title, accountLevelInformation.getLevel().name()));
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setOrientation(1);
        for (AccountLevel accountLevel : AccountLevel.values()) {
            TextView textView = new TextView(linearLayout.getContext());
            textView.setText(LocaleController.formatStringInternal(C3286R.string.wallet_account_level_description, accountLevel.name(), accountLevel.getFullDescription(getResourceManager())));
            textView.setTextColor(Theme.getColor("dialogTextBlack"));
            Drawable drawable2 = ContextCompat.getDrawable(mContext, C3286R.C3288drawable.fork_account_level_badge_20);
        ...
        checkBoxCell.setText(LocaleController.getInternalString(C3286R.string.wallet_account_level_alert_public), null, this.accountLevelInformation.isPublic(), false);
        ...
        setPositiveButton(LocaleController.getString("OK", C3286R.string.OK), null);
    }
