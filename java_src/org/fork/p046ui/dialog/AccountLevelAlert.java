...
/* renamed from: org.fork.ui.dialog.AccountLevelAlert */
...
public final class AccountLevelAlert extends AlertDialog.Builder implements KoinComponent {
    ...
    /* compiled from: AccountLevelAlert.kt */
    /* renamed from: org.fork.ui.dialog.AccountLevelAlert$OnVisibilityChangedListener */
    /* loaded from: classes4.dex */
    ...
    public AccountLevelAlert(Context mContext, AccountLevelInformation accountLevelInformation, OnVisibilityChangedListener visibilityChangedListener) {
        ...
        setTitle(LocaleController.formatStringInternal(C3158R.string.wallet_account_level_alert_title, accountLevelInformation.getLevel().name()));
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setOrientation(1);
        for (AccountLevel accountLevel : AccountLevel.values()) {
            TextView textView = new TextView(linearLayout.getContext());
            textView.setText(LocaleController.formatStringInternal(C3158R.string.wallet_account_level_description, accountLevel.name(), accountLevel.getFullDescription(getResourceManager())));
            textView.setTextColor(Theme.getColor("dialogTextBlack"));
            Drawable drawable = ContextCompat.getDrawable(mContext, C3158R.C3160drawable.fork_account_level_badge_20);
            if (drawable == null || (mutate = drawable.mutate()) == null) {
                mutate = null;
            } else {
                mutate.setColorFilter(new PorterDuffColorFilter(ContextCompat.getColor(mContext, accountLevel.getColorResId()), PorterDuff.Mode.SRC_IN));
        ...
        checkBoxCell.setText(LocaleController.getInternalString(C3158R.string.wallet_account_level_alert_public), null, this.accountLevelInformation.isPublic(), false);
        ...
        checkBoxCell.setOnClickListener(new View.OnClickListener() { // from class: org.fork.ui.dialog.AccountLevelAlert$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AccountLevelAlert.m1963lambda5$lambda4$lambda3(CheckBoxCell.this, this, view);
            }
        });
        linearLayout.addView(checkBoxCell);
        setView(linearLayout);
        setPositiveButton(LocaleController.getString("OK", C3158R.string.OK), null);
    }
    ...
    public static final void m1963lambda5$lambda4$lambda3(CheckBoxCell this_apply, AccountLevelAlert this$0, View view) {
    ...
    /* compiled from: AccountLevelAlert.kt */
    /* renamed from: org.fork.ui.dialog.AccountLevelAlert$Companion */
    /* loaded from: classes4.dex */
