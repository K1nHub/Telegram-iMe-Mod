...
public final class SettingsToolsActivity extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3366ActionBar.setTitle(LocaleController.getInternalString(C3301R.string.settings_tools));
        c3366ActionBar.setActionBarMenuOnItemClick(new C3366ActionBar.ActionBarMenuOnItemClick() { // from class: org.fork.ui.fragment.SettingsToolsActivity$setupActionBar$1$1
