...
public final class C3019xcb29bd9c extends Lambda implements Function1<DialogType, Unit> {
    ...
    public C3019xcb29bd9c(ChatAttachAlertButtonsSettingsActivity chatAttachAlertButtonsSettingsActivity, ChatAttachAlertButtonsSettingsActivity.ListAdapter listAdapter) {
        super(1);
