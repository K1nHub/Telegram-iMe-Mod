...
public final class CreateReactionButtonsActivity$presenter$2 extends Lambda implements Function0<ReactionPresenter> {
    ...
    /* loaded from: classes4.dex */
    public static final class C30251 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ CreateReactionButtonsActivity this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C30251(CreateReactionButtonsActivity createReactionButtonsActivity) {
            super(0);
            this.this$0 = createReactionButtonsActivity;
        }
    ...
    public final ReactionPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C3024x788df6f3(createReactionButtonsActivity, null, new C30251(createReactionButtonsActivity)));
