...
public enum DrawerSocialNetwork {
    TELEGRAM(C3158R.C3160drawable.fork_drawer_social_telegram, C3158R.string.drawer_social_network_telegram),
    TWITTER(C3158R.C3160drawable.fork_drawer_social_twitter, C3158R.string.drawer_social_network_twitter),
    YOUTUBE(C3158R.C3160drawable.fork_drawer_social_youtube, C3158R.string.drawer_social_network_youtube),
    APP_STORE(C3158R.C3160drawable.fork_drawer_social_app_store, C3158R.string.drawer_social_network_app_store),
    GOOGLE_PLAY(C3158R.C3160drawable.fork_drawer_social_google_play, C3158R.string.drawer_social_network_google_play),
    SITE(C3158R.C3160drawable.fork_drawer_social_site, C3158R.string.drawer_social_network_site);
    ...
    public final String url() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String internalString = LocaleController.getInternalString(C3158R.string.settings_help_alert_channel_username);
