...
public enum ExtendedAvatarPreviewerItem {
    MENTION_BY_NAME(null, C3158R.string.chat_avatar_previewer_mention_by_name, C3158R.C3160drawable.fork_avatar_previewer_mention_by_name),
    MENTION("Mention", C3158R.string.Mention, C3158R.C3160drawable.msg_mention),
    COPY_ID(null, C3158R.string.wallet_user_id_dialog_copy_id_action, C3158R.C3160drawable.fork_avatar_previewer_copy_id),
    COPY_USERNAME(null, C3158R.string.wallet_channel_name_dialog_copy_id_action, C3158R.C3160drawable.fork_avatar_previewer_copy_username),
    OPEN_PROFILE("OpenProfile", C3158R.string.OpenProfile, C3158R.C3160drawable.msg_openprofile),
    SEND_MESSAGE("SendMessage", C3158R.string.SendMessage, C3158R.C3160drawable.msg_discussion),
    USER_MESSAGES(null, C3158R.string.chat_avatar_previewer_user_messages, C3158R.C3160drawable.fork_filter_icon_bubbles),
    TRANSFER(null, C3158R.string.wallet_user_id_dialog_transfer_action, C3158R.C3160drawable.fork_avatar_previewer_transfer),
    ADD_TO_CONTACTS("AddContact", C3158R.string.AddContact, C3158R.C3160drawable.msg_addcontact),
    REMOVE_CONTACT("DeleteContact", C3158R.string.DeleteContact, C3158R.C3160drawable.msg_delete),
    REMOVE_FROM_GROUP("KickFromGroup", C3158R.string.KickFromGroup, C3158R.C3160drawable.msg_remove);
