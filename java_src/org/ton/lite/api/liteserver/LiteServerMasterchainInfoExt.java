...
public final class LiteServerMasterchainInfoExt {
    ...
    public int hashCode() {
        return (((((((((((((this.mode * 31) + this.version) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.capabilities)) * 31) + this.last.hashCode()) * 31) + this.lastUtime) * 31) + this.now) * 31) + Arrays.hashCode(this.stateRootHash)) * 31) + this.init.hashCode();
    }
