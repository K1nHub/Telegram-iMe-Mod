...
public final class LiteServerAccountState {
    ...
    public String toString() {
        return "LiteServerAccountState(id=" + this.f2100id + ", shardBlock=" + this.shardBlock + ", shardProof=" + Arrays.toString(this.shardProof) + ", proof=" + Arrays.toString(this.proof) + ", state=" + Arrays.toString(this.state) + ')';
    }
    ...
    public static final /* synthetic */ void write$Self(LiteServerAccountState liteServerAccountState, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, tonNodeBlockIdExt$$serializer, liteServerAccountState.f2100id);
