...
public final class LiteServerAccountId {
    ...
    /* renamed from: id */
    private final ByteString f2117id;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LiteServerAccountId) {
            ...
            return this.workchain == liteServerAccountId.workchain && Intrinsics.areEqual(this.f2117id, liteServerAccountId.f2117id);
        }
        return false;
    }

    public int hashCode() {
        return (this.workchain * 31) + this.f2117id.hashCode();
    }

    public String toString() {
        return "LiteServerAccountId(workchain=" + this.workchain + ", id=" + this.f2117id + ')';
    }
    ...
    public static final /* synthetic */ void write$Self(LiteServerAccountId liteServerAccountId, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ByteStringSerializer.INSTANCE, liteServerAccountId.f2117id);
    }
