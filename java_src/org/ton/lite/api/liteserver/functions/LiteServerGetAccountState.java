...
public final class LiteServerGetAccountState {
    ...
    /* renamed from: id */
    private final TonNodeBlockIdExt f2119id;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LiteServerGetAccountState) {
            ...
            return Intrinsics.areEqual(this.f2119id, liteServerGetAccountState.f2119id) && Intrinsics.areEqual(this.account, liteServerGetAccountState.account);
        }
        return false;
    }

    public int hashCode() {
        return (this.f2119id.hashCode() * 31) + this.account.hashCode();
    }

    public String toString() {
        return "LiteServerGetAccountState(id=" + this.f2119id + ", account=" + this.account + ')';
    }
    ...
    public /* synthetic */ LiteServerGetAccountState(int i, TonNodeBlockIdExt tonNodeBlockIdExt, LiteServerAccountId liteServerAccountId, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f2119id = tonNodeBlockIdExt;
    ...
    public static final /* synthetic */ void write$Self(LiteServerGetAccountState liteServerGetAccountState, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, TonNodeBlockIdExt$$serializer.INSTANCE, liteServerGetAccountState.f2119id);
