...
public final class LiteClient implements Closeable, CoroutineScope {
    ...
    public final long m5419latencyUwyO8pc() {
        return getServerTimeGotAt().m2127minus5sfh64U(getServerTime());
    }
    ...
    public final long m5420setServerTime5sfh64U(int i) {
        ...
        final long m5419latencyUwyO8pc = m5419latencyUwyO8pc();
        this.logger.debug(new Function0<String>() { // from class: org.ton.lite.client.LiteClient$setServerTime$1
            ...
            public final String invoke() {
                ...
                sb.append(" (latency ");
                sb.append((Object) Duration.m2090toStringimpl(m5419latencyUwyO8pc));
                sb.append(')');
                return sb.toString();
            }
        });
        return m5419latencyUwyO8pc;
    }
