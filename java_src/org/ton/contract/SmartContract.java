...
public interface SmartContract<T> {
    ...
    public static final class DefaultImpls {
        public static <T> Cell getData(SmartContract<T> smartContract) {
            ...
            StateInit m5246unboximpl = state instanceof AccountActive ? ((AccountActive) state).m5246unboximpl() : null;
            if (m5246unboximpl == null || (data = m5246unboximpl.data()) == null || (value = data.getValue()) == null) {
                return null;
            }
