...
public final class LiteServerDesc {
    ...
    /* renamed from: id */
    private final PublicKey f2019id;

    /* renamed from: ip */
    private final int f2020ip;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LiteServerDesc) {
            ...
            return Intrinsics.areEqual(this.f2019id, liteServerDesc.f2019id) && this.f2020ip == liteServerDesc.f2020ip && this.port == liteServerDesc.port;
        }
        return false;
    }

    public int hashCode() {
        return (((this.f2019id.hashCode() * 31) + this.f2020ip) * 31) + this.port;
    }
    ...
    public static final /* synthetic */ void write$Self(LiteServerDesc liteServerDesc, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, $childSerializers[0], liteServerDesc.f2019id);
        compositeEncoder.encodeIntElement(serialDescriptor, 1, liteServerDesc.f2020ip);
    ...
    public String toString() {
        ...
        sb.append(this.f2020ip);
        sb.append(':');
        sb.append(this.port);
        sb.append(':');
        sb.append(this.f2019id);
        return sb.toString();
    }
}
