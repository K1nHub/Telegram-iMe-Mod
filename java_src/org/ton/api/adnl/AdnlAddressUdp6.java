...
public final class AdnlAddressUdp6 implements AdnlAddress {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdnlAddressUdp6) {
            ...
            return Intrinsics.areEqual(this.f2045ip, adnlAddressUdp6.f2045ip) && this.port == adnlAddressUdp6.port;
        }
        return false;
    }

    public int hashCode() {
        return (Arrays.hashCode(this.f2045ip) * 31) + this.port;
    }

    public String toString() {
        return "AdnlAddressUdp6(ip=" + Arrays.toString(this.f2045ip) + ", port=" + this.port + ')';
    }
