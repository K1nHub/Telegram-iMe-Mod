...
public final class AdnlAddressTunnel implements AdnlAddress {
    ...
    /* renamed from: to */
    private final byte[] f2043to;
    public static final Companion Companion = new Companion(null);
    private static final KSerializer<Object>[] $childSerializers = {null, new SealedClassSerializer("org.ton.api.pub.PublicKey", Reflection.getOrCreateKotlinClass(PublicKey.class), new KClass[]{Reflection.getOrCreateKotlinClass(PublicKeyAes.class), Reflection.getOrCreateKotlinClass(PublicKeyEd25519.class), Reflection.getOrCreateKotlinClass(PublicKeyOverlay.class), Reflection.getOrCreateKotlinClass(PublicKeyUnencrypted.class)}, new KSerializer[]{PublicKeyAes$$serializer.INSTANCE, PublicKeyEd25519$$serializer.INSTANCE, PublicKeyOverlay$$serializer.INSTANCE, PublicKeyUnencrypted$$serializer.INSTANCE}, new Annotation[]{new C7689x63816b8c("@type")})};
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdnlAddressTunnel) {
            ...
            return Intrinsics.areEqual(this.f2043to, adnlAddressTunnel.f2043to) && Intrinsics.areEqual(this.pubkey, adnlAddressTunnel.pubkey);
        }
        return false;
    }

    public int hashCode() {
        return (Arrays.hashCode(this.f2043to) * 31) + this.pubkey.hashCode();
    }

    public String toString() {
        return "AdnlAddressTunnel(to=" + Arrays.toString(this.f2043to) + ", pubkey=" + this.pubkey + ')';
    }
    ...
    public static final /* synthetic */ void write$Self(AdnlAddressTunnel adnlAddressTunnel, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, ByteArraySerializer.INSTANCE, adnlAddressTunnel.f2043to);
