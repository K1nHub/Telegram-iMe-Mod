...
public final class DhtNode {
    ...
    /* renamed from: id */
    private final PublicKey f2047id;
    private final byte[] signature;
    private final int version;
    public static final Companion Companion = new Companion(null);
    private static final KSerializer<Object>[] $childSerializers = {new SealedClassSerializer("org.ton.api.pub.PublicKey", Reflection.getOrCreateKotlinClass(PublicKey.class), new KClass[]{Reflection.getOrCreateKotlinClass(PublicKeyAes.class), Reflection.getOrCreateKotlinClass(PublicKeyEd25519.class), Reflection.getOrCreateKotlinClass(PublicKeyOverlay.class), Reflection.getOrCreateKotlinClass(PublicKeyUnencrypted.class)}, new KSerializer[]{PublicKeyAes$$serializer.INSTANCE, PublicKeyEd25519$$serializer.INSTANCE, PublicKeyOverlay$$serializer.INSTANCE, PublicKeyUnencrypted$$serializer.INSTANCE}, new Annotation[]{new C7695x6c935aed("@type")}), null, null, null};

    public String toString() {
        return "DhtNode(id=" + this.f2047id + ", addrList=" + this.addrList + ", version=" + this.version + ", signature=" + Arrays.toString(this.signature) + ')';
    }
    ...
    public static final /* synthetic */ void write$Self(DhtNode dhtNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, $childSerializers[0], dhtNode.f2047id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DhtNode) {
            ...
            return Intrinsics.areEqual(this.f2047id, dhtNode.f2047id) && Intrinsics.areEqual(this.addrList, dhtNode.addrList) && this.version == dhtNode.version && Arrays.equals(getSignature(), dhtNode.getSignature());
        }
        return false;
    }

    public int hashCode() {
        return (((((this.f2047id.hashCode() * 31) + this.addrList.hashCode()) * 31) + this.version) * 31) + Arrays.hashCode(getSignature());
    }
