...
public final class DhtConfigGlobal {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DhtConfigGlobal) {
            ...
            return Intrinsics.areEqual(this.staticNodes, dhtConfigGlobal.staticNodes) && this.f2049k == dhtConfigGlobal.f2049k && this.f2048a == dhtConfigGlobal.f2048a;
        }
        return false;
    }

    public int hashCode() {
        return (((this.staticNodes.hashCode() * 31) + this.f2049k) * 31) + this.f2048a;
    }

    public String toString() {
        return "DhtConfigGlobal(staticNodes=" + this.staticNodes + ", k=" + this.f2049k + ", a=" + this.f2048a + ')';
    }
    ...
    public static final /* synthetic */ void write$Self(DhtConfigGlobal dhtConfigGlobal, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.shouldEncodeElementDefault(serialDescriptor, 1) || dhtConfigGlobal.f2049k != 0) {
            compositeEncoder.encodeIntElement(serialDescriptor, 1, dhtConfigGlobal.f2049k);
        }
        if (compositeEncoder.shouldEncodeElementDefault(serialDescriptor, 2) || dhtConfigGlobal.f2048a != 0) {
            compositeEncoder.encodeIntElement(serialDescriptor, 2, dhtConfigGlobal.f2048a);
        }
    }
