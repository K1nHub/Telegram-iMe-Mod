...
public final class TonNodeBlockIdExt implements TonNodeBlockId {
    ...
    public int hashCode() {
        return (((((((this.workchain * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.shard)) * 31) + this.seqno) * 31) + this.rootHash.hashCode()) * 31) + this.fileHash.hashCode();
    }
    ...
    */
    ...
    public String toString() {
        ...
        sb.append(":");
        String upperCase = UStringsKt.m2060toStringJSWoG40(ULong.m1997constructorimpl(getShard()), 16).toUpperCase(Locale.ROOT);
