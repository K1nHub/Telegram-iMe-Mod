...
final class TonNodeBlockIdImpl implements TonNodeBlockId {
    ...
    public int hashCode() {
        return (((this.workchain * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.shard)) * 31) + this.seqno;
    }
    ...
    public String toString() {
        ...
        sb.append(':');
        padStart = StringsKt__StringsKt.padStart(UStringsKt.m2060toStringJSWoG40(ULong.m1997constructorimpl(Shard.m5239constructorimpl(getShard())), 16), 16, '0');
        sb.append(padStart);
        sb.append(':');
        sb.append(getSeqno());
        sb.append(')');
