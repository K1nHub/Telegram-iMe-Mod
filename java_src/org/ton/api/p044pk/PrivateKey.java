...
public interface PrivateKey extends Decryptor {
    ...
    public static final class Companion extends TlCombinator<PrivateKey> {
        ...
        private Companion() {
            super(Reflection.getOrCreateKotlinClass(PrivateKey.class), TuplesKt.m146to(Reflection.getOrCreateKotlinClass(PrivateKeyUnencrypted.class), PrivateKeyUnencrypted.Companion), TuplesKt.m146to(Reflection.getOrCreateKotlinClass(PrivateKeyEd25519.class), PrivateKeyEd25519.Companion.tlConstructor()), TuplesKt.m146to(Reflection.getOrCreateKotlinClass(PrivateKeyAes.class), PrivateKeyAes.Companion), TuplesKt.m146to(Reflection.getOrCreateKotlinClass(PrivateKeyOverlay.class), PrivateKeyOverlay.Companion));
        }
