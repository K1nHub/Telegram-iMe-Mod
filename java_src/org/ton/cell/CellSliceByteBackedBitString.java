...
public final class CellSliceByteBackedBitString extends CellSliceImpl {
    ...
    public final long m5207getLongI7RO_PI(int i) {
        long j = 0;
        if (i == 0) {
            return 0L;
        }
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            j = ULong.m1996constructorimpl(j | ULong.m1996constructorimpl(ULong.m1996constructorimpl(getByte(i4 * 8) & 255) << ((7 - i4) * 8)));
        }
        if (i3 != 0) {
            j = ULong.m1996constructorimpl(j | ULong.m1996constructorimpl(ULong.m1996constructorimpl(getBits(i2 * 8, i3) & 255) << (((7 - i2) * 8) + (8 - i3))));
        }
        return ULong.m1996constructorimpl(j >>> (64 - i));
    }
    ...
    public BigInteger preloadUInt(int i) {
        ...
        long m5207getLongI7RO_PI = m5207getLongI7RO_PI(i);
        compare = Long.compare(m5207getLongI7RO_PI ^ Long.MIN_VALUE, ULong.m1996constructorimpl(Long.MAX_VALUE) ^ Long.MIN_VALUE);
        if (compare > 0) {
            m29m = CellSliceByteBackedBitString$$ExternalSyntheticBackport1.m29m(m5207getLongI7RO_PI, 10);
            return new BigInteger(m29m, 10);
        }
        return BigIntJvmKt.toBigInt(m5207getLongI7RO_PI);
    }
    ...
    public BigInteger preloadInt(int i) {
        ...
        long m5207getLongI7RO_PI = m5207getLongI7RO_PI(i);
        long j = 1 << (i - 1);
        if (m5207getLongI7RO_PI >= j) {
            return BigIntJvmKt.toBigInt(m5207getLongI7RO_PI - (j * 2));
        }
        return BigIntJvmKt.toBigInt(m5207getLongI7RO_PI);
    }
    ...
    public long preloadTinyInt(int i) {
        ...
        if (i <= 64) {
            long m5207getLongI7RO_PI = m5207getLongI7RO_PI(i);
            long j = 1 << (i - 1);
            return m5207getLongI7RO_PI >= j ? m5207getLongI7RO_PI - (j * 2) : m5207getLongI7RO_PI;
        }
