...
public final class VirtualCell implements Cell {
    ...
    public int mo5188getLevelMaskKat384U() {
        return LevelMask.m5220virtualizespGXSBY(this.cell.mo5188getLevelMaskKat384U(), this.offset);
    }
    ...
    public BitString hash(int i) {
        return this.cell.hash(LevelMask.m5215getLevelimpl(LevelMask.m5208applyspGXSBY(mo5188getLevelMaskKat384U(), i)));
    }

    @Override // org.ton.cell.Cell
    public int depth(int i) {
        return this.cell.depth(LevelMask.m5215getLevelimpl(LevelMask.m5208applyspGXSBY(mo5188getLevelMaskKat384U(), i)));
    }
