...
public final class CellDescriptorImpl implements CellDescriptor {
    ...
    /* renamed from: d1 */
    private final byte f2056d1;

    /* renamed from: d2 */
    private final byte f2057d2;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CellDescriptorImpl) {
            ...
            return this.f2056d1 == cellDescriptorImpl.f2056d1 && this.f2057d2 == cellDescriptorImpl.f2057d2;
        }
        return false;
    }

    public int hashCode() {
        return (this.f2056d1 * 31) + this.f2057d2;
    }
    ...
    public int mo5199getLevelMaskKat384U() {
        return LevelMask.m5210constructorimpl(getD1() >>> 5);
    }
    ...
    public int getHashCount() {
        int m5215getLevelimpl = LevelMask.m5215getLevelimpl(mo5199getLevelMaskKat384U());
        if (isExotic() && getReferenceCount() == 0 && m5215getLevelimpl > 0) {
            return 1;
        }
        return 1 + m5215getLevelimpl;
    }
