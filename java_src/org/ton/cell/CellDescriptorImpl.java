...
public final class CellDescriptorImpl implements CellDescriptor {
    ...
    /* renamed from: d1 */
    private final byte f2074d1;

    /* renamed from: d2 */
    private final byte f2075d2;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CellDescriptorImpl) {
            ...
            return this.f2074d1 == cellDescriptorImpl.f2074d1 && this.f2075d2 == cellDescriptorImpl.f2075d2;
        }
        return false;
    }

    public int hashCode() {
        return (this.f2074d1 * 31) + this.f2075d2;
    }
    ...
    public int mo5384getLevelMaskKat384U() {
        return LevelMask.m5395constructorimpl(getD1() >>> 5);
    }
    ...
    public int getHashCount() {
        int m5400getLevelimpl = LevelMask.m5400getLevelimpl(mo5384getLevelMaskKat384U());
        if (isExotic() && getReferenceCount() == 0 && m5400getLevelimpl > 0) {
            return 1;
        }
        return 1 + m5400getLevelimpl;
    }
