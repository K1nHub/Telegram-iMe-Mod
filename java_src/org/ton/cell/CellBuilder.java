...
public interface CellBuilder {
    ...
    void mo5375setLevelMaskfuO3_sE(LevelMask levelMask);
    ...
    CellBuilder mo5376storeUInt16xj2QHRw(short s);

    /* renamed from: storeUInt32-WZ4Q5Ns  reason: not valid java name */
    CellBuilder mo5377storeUInt32WZ4Q5Ns(int i);

    /* renamed from: storeUInt64-VKZWuLQ  reason: not valid java name */
    CellBuilder mo5378storeUInt64VKZWuLQ(long j);
    ...
    public static final class DefaultImpls {
        ...
        /* renamed from: storeUInt16-xj2QHRw  reason: not valid java name */
        public static CellBuilder m5379storeUInt16xj2QHRw(CellBuilder cellBuilder, short s) {
            return cellBuilder.storeInt(s, 16);
        }

        /* renamed from: storeUInt32-WZ4Q5Ns  reason: not valid java name */
        public static CellBuilder m5380storeUInt32WZ4Q5Ns(CellBuilder cellBuilder, int i) {
            return cellBuilder.storeInt(i, 32);
        }

        /* renamed from: storeUInt64-VKZWuLQ  reason: not valid java name */
        public static CellBuilder m5381storeUInt64VKZWuLQ(CellBuilder cellBuilder, long j) {
