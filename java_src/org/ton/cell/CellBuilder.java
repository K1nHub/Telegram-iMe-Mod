...
public interface CellBuilder {
    ...
    void mo5054setLevelMaskfuO3_sE(LevelMask levelMask);
    ...
    CellBuilder mo5055storeUInt16xj2QHRw(short s);

    /* renamed from: storeUInt32-WZ4Q5Ns  reason: not valid java name */
    CellBuilder mo5056storeUInt32WZ4Q5Ns(int i);

    /* renamed from: storeUInt64-VKZWuLQ  reason: not valid java name */
    CellBuilder mo5057storeUInt64VKZWuLQ(long j);
    ...
    public static final class DefaultImpls {
        ...
        /* renamed from: storeUInt16-xj2QHRw  reason: not valid java name */
        public static CellBuilder m5058storeUInt16xj2QHRw(CellBuilder cellBuilder, short s) {
            return cellBuilder.storeInt(s, 16);
        }

        /* renamed from: storeUInt32-WZ4Q5Ns  reason: not valid java name */
        public static CellBuilder m5059storeUInt32WZ4Q5Ns(CellBuilder cellBuilder, int i) {
            return cellBuilder.storeInt(i, 32);
        }

        /* renamed from: storeUInt64-VKZWuLQ  reason: not valid java name */
        public static CellBuilder m5060storeUInt64VKZWuLQ(CellBuilder cellBuilder, long j) {
