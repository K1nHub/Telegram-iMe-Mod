...
public final class PrunedBranchCell implements Cell {
    ...
    public BitString hash(int i) {
        byte[] copyOfRange;
        int m5078getHashIndeximpl = LevelMask.m5078getHashIndeximpl(LevelMask.m5072applyspGXSBY(getDescriptor().mo5063getLevelMaskKat384U(), i));
        if (m5078getHashIndeximpl == LevelMask.m5079getLevelimpl(getDescriptor().mo5063getLevelMaskKat384U())) {
            return this.hash;
        }
        int i2 = (m5078getHashIndeximpl * 32) + 2;
    ...
    public int depth(int i) {
        ...
        int m5079getLevelimpl = (LevelMask.m5079getLevelimpl(getDescriptor().mo5063getLevelMaskKat384U()) * 32) + 2 + (m5078getHashIndeximpl * 2);
        byte[] byteArray$default = BitString.DefaultImpls.toByteArray$default(getBits(), false, 1, null);
        return (byteArray$default[m5079getLevelimpl + 1] & 255) | ((byteArray$default[m5079getLevelimpl] & 255) << 8);
    }
