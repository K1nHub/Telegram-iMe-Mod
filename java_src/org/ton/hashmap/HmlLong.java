...
public final class HmlLong implements HmLabel {
    ...
    /* renamed from: n */
    private final int f2079n;

    /* renamed from: s */
    private final BitString f2080s;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HmlLong) {
            ...
            return this.f2079n == hmlLong.f2079n && Intrinsics.areEqual(this.f2080s, hmlLong.f2080s);
        }
        return false;
    }

    public int hashCode() {
        return (this.f2079n * 31) + this.f2080s.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(HmlLong hmlLong, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeIntElement(serialDescriptor, 0, hmlLong.f2079n);
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, FiftHexBitStringSerializer.INSTANCE, hmlLong.f2080s);
    }
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("n", Integer.valueOf(this.f2079n));
        open.field("s", this.f2080s);
