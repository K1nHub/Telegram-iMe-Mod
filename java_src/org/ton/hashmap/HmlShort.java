...
public final class HmlShort implements HmLabel {
    ...
    /* renamed from: s */
    private final BitString f2096s;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HmlShort) {
            ...
            return Intrinsics.areEqual(this.len, hmlShort.len) && Intrinsics.areEqual(this.f2096s, hmlShort.f2096s);
        }
        return false;
    }

    public int hashCode() {
        return (this.len.hashCode() * 31) + this.f2096s.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(HmlShort hmlShort, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, FiftHexBitStringSerializer.INSTANCE, hmlShort.f2096s);
    }
