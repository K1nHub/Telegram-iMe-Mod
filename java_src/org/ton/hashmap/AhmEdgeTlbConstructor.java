...
public final class AhmEdgeTlbConstructor<X, Y> extends TlbConstructor<HashmapAug.AhmEdge<X, Y>> {
    ...
    /* renamed from: x */
    private final TlbCodec<X> f2056x;

    /* renamed from: y */
    private final TlbCodec<Y> f2057y;
    ...
    public HashmapAug.AhmEdge<X, Y> loadTlb(CellSlice cellSlice) {
        ...
        TlbNegatedResult<HmLabel> loadNegatedTlb = HmLabel.Companion.tlbCodec(this.f2055n).loadNegatedTlb(cellSlice);
        int component1 = this.f2055n - loadNegatedTlb.component1();
        return HashmapAug.Companion.edge(this.f2055n, loadNegatedTlb.component2(), HashmapAugNode.Companion.tlbCodec(this.f2056x, this.f2057y, component1).loadTlb(cellSlice));
    }
    ...
    public void storeTlb(CellBuilder cellBuilder, HashmapAug.AhmEdge<X, Y> value) {
        ...
        int i = this.f2055n;
        if (n == i) {
            HashmapAugNode.Companion.tlbCodec(this.f2056x, this.f2057y, this.f2055n - HmLabel.Companion.tlbCodec(i).storeNegatedTlb(cellBuilder, value.getLabel())).storeTlb(cellBuilder, value.getNode());
            return;
        }
        throw new IllegalStateException(("Invalid n, expected: " + this.f2055n + ", actual: " + value.getN()).toString());
    }
}
