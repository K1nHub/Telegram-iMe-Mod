...
public final class AhmeEdgeImpl<X, Y> implements HashmapAug.AhmEdge<X, Y> {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AhmeEdgeImpl) {
            ...
            return this.f2071n == ahmeEdgeImpl.f2071n && Intrinsics.areEqual(this.label, ahmeEdgeImpl.label) && Intrinsics.areEqual(this.node, ahmeEdgeImpl.node);
        }
        return false;
    }

    public int hashCode() {
        return (((this.f2071n * 31) + this.label.hashCode()) * 31) + this.node.hashCode();
    }
