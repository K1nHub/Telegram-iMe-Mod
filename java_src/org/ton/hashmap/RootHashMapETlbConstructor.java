...
public final class RootHashMapETlbConstructor<X> extends TlbConstructor<HmeRoot<X>> {
    ...
    /* renamed from: ID */
    private static final BitString f2115ID;
    private final TlbCodec<CellRef<HmEdge<X>>> cellRef;

    static {
        new Companion(null);
        f2115ID = BitString.Companion.m42of(Arrays.copyOf(new boolean[]{true}, 1));
    }
    ...
    public RootHashMapETlbConstructor(int i, TlbCodec<X> x) {
        super("hme_root$1 {n:#} {X:Type} root:^(Hashmap n X) = HashmapE n X;", f2115ID);
