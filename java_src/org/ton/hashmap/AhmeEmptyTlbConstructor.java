...
public final class AhmeEmptyTlbConstructor<X, Y> extends TlbConstructor<HashmapAugE.AhmeEmpty<X, Y>> {
    ...
    /* renamed from: y */
    private final TlbCodec<Y> f2074y;
    ...
    public HashmapAugE.AhmeEmpty<X, Y> loadTlb(CellSlice cellSlice) {
        ...
        return new AhmeEmptyImpl(this.f2073n, this.f2074y.loadTlb(cellSlice));
    }

    public void storeTlb(CellBuilder cellBuilder, HashmapAugE.AhmeEmpty<X, Y> value) {
        Intrinsics.checkNotNullParameter(cellBuilder, "cellBuilder");
        Intrinsics.checkNotNullParameter(value, "value");
        if (!(value.getN() == this.f2073n)) {
            throw new IllegalArgumentException(("n mismatch, expected: " + this.f2073n + ", actual: " + value.getN()).toString());
        }
        this.f2074y.storeTlb(cellBuilder, value.getExtra());
    }
}
