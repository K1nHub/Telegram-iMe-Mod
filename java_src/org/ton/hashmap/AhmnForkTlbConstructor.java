...
final class AhmnForkTlbConstructor<X, Y> extends TlbConstructor<HashmapAugNode.AhmnFork<X, Y>> {
    ...
    /* renamed from: y */
    private final TlbCodec<Y> f2098y;
    ...
    public HashmapAugNode.AhmnFork<X, Y> loadTlb(CellSlice cellSlice) {
        ...
        return new AhmnForkImpl(this.f2097n, companion.valueOf(loadRef, (TlbCodec) tlbCodec), companion.valueOf(cellSlice.loadRef(), (TlbCodec) this.hashmapAug), this.f2098y.loadTlb(cellSlice));
    }

    public void storeTlb(CellBuilder cellBuilder, HashmapAugNode.AhmnFork<X, Y> value) {
        Intrinsics.checkNotNullParameter(cellBuilder, "cellBuilder");
        Intrinsics.checkNotNullParameter(value, "value");
        if (value.getN() == this.f2097n) {
            cellBuilder.storeRef(value.getLeft().toCell(this.hashmapAug));
            cellBuilder.storeRef(value.getRight().toCell(this.hashmapAug));
            this.f2098y.storeTlb(cellBuilder, value.getExtra());
            return;
        }
        throw new IllegalStateException(("n mismatch, expected: " + this.f2097n + ", actual: " + value.getN()).toString());
    }
}
