...
public final class HashMapEdgeTlbConstructor<X> extends TlbConstructor<HmEdge<X>> {
    ...
    /* renamed from: x */
    private final TlbCodec<X> f2071x;
    ...
    public void storeTlb(CellBuilder cellBuilder, HmEdge<X> value) {
        ...
        HashMapNode.Companion.tlbCodec(this.f2070n - this.hashMapLabelCodec.storeNegatedTlb(cellBuilder, value.getLabel()), this.f2071x).storeTlb(cellBuilder, value.getNode());
    }
    ...
    public HmEdge<X> loadTlb(CellSlice cellSlice) {
        ...
        return new HmEdge<>(loadNegatedTlb.component2(), HashMapNode.Companion.tlbCodec(this.f2070n - loadNegatedTlb.component1(), this.f2071x).loadTlb(cellSlice));
    }
}
