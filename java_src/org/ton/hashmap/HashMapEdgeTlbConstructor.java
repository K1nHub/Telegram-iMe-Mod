...
public final class HashMapEdgeTlbConstructor<X> extends TlbConstructor<HmEdge<X>> {
    ...
    /* renamed from: n */
    private final int f2101n;

    /* renamed from: x */
    private final TlbCodec<X> f2102x;
    ...
    public void storeTlb(CellBuilder cellBuilder, HmEdge<X> value) {
        ...
        HashMapNode.Companion.tlbCodec(this.f2101n - this.hashMapLabelCodec.storeNegatedTlb(cellBuilder, value.getLabel()), this.f2102x).storeTlb(cellBuilder, value.getNode());
    }
    ...
    public HmEdge<X> loadTlb(CellSlice cellSlice) {
        ...
        return new HmEdge<>(loadNegatedTlb.component2(), HashMapNode.Companion.tlbCodec(this.f2101n - loadNegatedTlb.component1(), this.f2102x).loadTlb(cellSlice));
    }
}
