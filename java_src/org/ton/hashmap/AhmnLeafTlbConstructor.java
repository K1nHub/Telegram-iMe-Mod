...
final class AhmnLeafTlbConstructor<X, Y> extends TlbConstructor<HashmapAugNode.AhmnLeaf<X, Y>> {
    ...
    /* renamed from: x */
    private final TlbCodec<X> f2099x;

    /* renamed from: y */
    private final TlbCodec<Y> f2100y;
    ...
    public HashmapAugNode.AhmnLeaf<X, Y> loadTlb(CellSlice cellSlice) {
        ...
        return new AhmnLeafImpl(this.f2100y.loadTlb(cellSlice), this.f2099x.loadTlb(cellSlice));
    }

    public void storeTlb(CellBuilder cellBuilder, HashmapAugNode.AhmnLeaf<X, Y> value) {
        Intrinsics.checkNotNullParameter(cellBuilder, "cellBuilder");
        Intrinsics.checkNotNullParameter(value, "value");
        this.f2100y.storeTlb(cellBuilder, value.getExtra());
        this.f2099x.storeTlb(cellBuilder, value.getValue());
    }
}
