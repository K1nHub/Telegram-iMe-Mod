...
public final class AhmnForkImpl<X, Y> implements HashmapAugNode.AhmnFork<X, Y> {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AhmnForkImpl) {
            ...
            return this.f2096n == ahmnForkImpl.f2096n && Intrinsics.areEqual(this.left, ahmnForkImpl.left) && Intrinsics.areEqual(this.right, ahmnForkImpl.right) && Intrinsics.areEqual(this.extra, ahmnForkImpl.extra);
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((this.f2096n * 31) + this.left.hashCode()) * 31) + this.right.hashCode()) * 31;
        Y y = this.extra;
