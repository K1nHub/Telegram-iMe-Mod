...
public final class HashMapLabelTlbCombinator extends TlbNegatedCombinator<HmLabel> {
    ...
    public HashMapLabelTlbCombinator(int i, TlbNegatedConstructor<HmlLong> hmlLong, TlbNegatedConstructor<HmlShort> hmlShort, TlbNegatedConstructor<HmlSame> hmlSame) {
        super(Reflection.getOrCreateKotlinClass(HmLabel.class), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(HmlLong.class), hmlLong), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(HmlShort.class), hmlShort), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(HmlSame.class), hmlSame));
