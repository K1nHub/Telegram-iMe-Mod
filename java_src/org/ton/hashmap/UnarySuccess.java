...
public final class UnarySuccess extends Unary {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UnarySuccess) && Intrinsics.areEqual(this.f2116x, ((UnarySuccess) obj).f2116x);
    }

    public int hashCode() {
        return this.f2116x.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(UnarySuccess unarySuccess, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, $childSerializers[0], unarySuccess.f2116x);
    }
