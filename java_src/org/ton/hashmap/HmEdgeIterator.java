    ...
    public static abstract class WalkState<T> {
        ...
        public static final class Leaf<T> extends WalkState<T> {
            ...
            public Pair<BitString, HashMapNode<T>> step() {
                ...
                this.visited = true;
                return TuplesKt.m149to(this.prefix, getNode());
            }
        }
        ...
        public static final class Fork<T> extends WalkState<T> {
            ...
            public Pair<BitString, HashMapNode<T>> step() {
                if (this.leftVisited) {
                    ...
                    return TuplesKt.m149to(beginCell.getBits().toBitString(), getNode().getRight().getValue().getNode());
                }
                ...
                return TuplesKt.m149to(beginCell2.getBits().toBitString(), getNode().getLeft().getValue().getNode());
            }
        }
    }
        ...
        while (true) {
            ...
            if (step == null) {
                ...
                if (component2 instanceof HmnLeaf) {
                    return TuplesKt.m149to(component1, ((HmnLeaf) component2).getValue());
                }
