...
public final class HmlSame implements HmLabel {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HmlSame) {
            ...
            return this.f2113v == hmlSame.f2113v && this.f2112n == hmlSame.f2112n;
        }
        return false;
    }
    ...
    public int hashCode() {
        boolean z = this.f2113v;
        ?? r0 = z;
        if (z) {
            r0 = 1;
        }
        return (r0 * 31) + this.f2112n;
    }
    ...
    public static final /* synthetic */ void write$Self(HmlSame hmlSame, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeBooleanElement(serialDescriptor, 0, hmlSame.f2113v);
        compositeEncoder.encodeIntElement(serialDescriptor, 1, hmlSame.f2112n);
    }
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("v", Boolean.valueOf(this.f2113v));
        open.field("n", Integer.valueOf(this.f2112n));
