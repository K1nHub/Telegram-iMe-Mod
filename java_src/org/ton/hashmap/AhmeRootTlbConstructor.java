...
public final class AhmeRootTlbConstructor<X, Y> extends TlbConstructor<HashmapAugE.AhmeRoot<X, Y>> {
    ...
    /* renamed from: y */
    private final TlbCodec<Y> f2095y;
    ...
    public HashmapAugE.AhmeRoot<X, Y> loadTlb(CellSlice cellSlice) {
        ...
        return new AhmeRootImpl(this.f2094n, CellRef.Companion.valueOf(cellSlice.loadRef(), (TlbCodec) tlbCodec), this.f2095y.loadTlb(cellSlice));
    }

    public void storeTlb(CellBuilder cellBuilder, HashmapAugE.AhmeRoot<X, Y> value) {
        Intrinsics.checkNotNullParameter(cellBuilder, "cellBuilder");
        Intrinsics.checkNotNullParameter(value, "value");
        if (value.getN() == this.f2094n) {
            cellBuilder.storeRef(value.getRoot().toCell(this.hashmapAug));
            this.f2095y.storeTlb(cellBuilder, value.getExtra());
            return;
        }
        throw new IllegalArgumentException(("n mismatch, expected: " + this.f2094n + ", actual: " + value.getN()).toString());
    }
}
