...
final class HashMapLabelLongTlbConstructor extends TlbNegatedConstructor<HmlLong> {
    ...
    /* renamed from: ID */
    private static final BitString f2103ID;

    /* renamed from: m */
    private final int f2104m;

    public HashMapLabelLongTlbConstructor(int i) {
        super("hml_long$10 {m:#} n:(#<= m) s:(n * Bit) = HmLabel ~n m;", f2103ID);
        this.f2104m = i;
    }
    ...
    public int storeNegatedTlb(CellBuilder cellBuilder, HmlLong value) {
        ...
        cellBuilder.storeUIntLeq(value.getN(), this.f2104m);
    ...
    public TlbNegatedResult<HmlLong> loadNegatedTlb(CellSlice cellSlice) {
        ...
        int intValue = cellSlice.loadUIntLeq(this.f2104m).intValue();
    ...
    static {
        new Companion(null);
        f2103ID = BitString.Companion.m42of(Arrays.copyOf(new boolean[]{true, false}, 2));
    }
}
