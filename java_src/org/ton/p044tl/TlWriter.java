...
public final class TlWriter {
    ...
    public final void writeBytes(byte[] value, int i, int i2) {
        ...
        Intrinsics.checkNotNullParameter(value, "value");
        if (i2 < 254) {
            this.output.writeByte(UByte.m1945constructorimpl((byte) i2));
            i3 = i2 + 1;
        } else if (i2 < 16777216) {
            this.output.writeByte((byte) -2);
            this.output.writeByte(UByte.m1945constructorimpl((byte) (i2 & 255)));
            this.output.writeByte(UByte.m1945constructorimpl((byte) ((i2 >> 8) & 255)));
            this.output.writeByte(UByte.m1945constructorimpl((byte) (i2 >> 16)));
            i3 = i2 + 4;
            ...
            this.output.writeByte(UByte.m1945constructorimpl((byte) (i2 & 255)));
            this.output.writeByte(UByte.m1945constructorimpl((byte) ((i2 >> 8) & 255)));
            this.output.writeByte(UByte.m1945constructorimpl((byte) ((i2 >> 16) & 255)));
            this.output.writeByte(UByte.m1945constructorimpl((byte) ((i2 >> 24) & 255)));
