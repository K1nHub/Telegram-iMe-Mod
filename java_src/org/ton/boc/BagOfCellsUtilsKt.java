...
public final class BagOfCellsUtilsKt {
    private static final int readInt(Input input, int i) {
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return (UByte.m1945constructorimpl(input.readByte()) & 255) | ((UByte.m1945constructorimpl(input.readByte()) & 255) << 16) | ((UByte.m1945constructorimpl(input.readByte()) & 255) << 8);
                }
                return UInt.m1967constructorimpl(InputPrimitivesKt.readInt(input));
            }
            return UShort.m2011constructorimpl(InputPrimitivesKt.readShort(input)) & 65535;
        }
        return UByte.m1945constructorimpl(input.readByte()) & 255;
    }
    ...
    public static final BagOfCells readBagOfCell(ByteReadPacket byteReadPacket) {
        ...
        if (readInt != -1396463832) {
            if (readInt != -1242653582) {
                ...
                throw new IllegalArgumentException("Unknown magic prefix: " + UStringsKt.m2053toStringV7xB4Y4(UInt.m1967constructorimpl(readInt), 16));
            }
