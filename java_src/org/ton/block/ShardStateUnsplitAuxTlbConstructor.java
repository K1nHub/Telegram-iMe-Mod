...
public final class ShardStateUnsplitAuxTlbConstructor extends org.ton.tlb.TlbConstructor<ShardStateUnsplitAux> {
    ...
    public void storeTlb(CellBuilder cellBuilder, ShardStateUnsplitAux value) {
        ...
        cellBuilder.storeUInt(value.m5368getOverloadHistorysVKNKU(), 64);
        cellBuilder.storeUInt(value.m5369getUnderloadHistorysVKNKU(), 64);
    ...
    public ShardStateUnsplitAux loadTlb(CellSlice cellSlice) {
        ...
        long m1997constructorimpl2 = ULong.m1997constructorimpl(cellSlice.loadUInt(64).longValue());
        CurrencyCollection.Companion companion = CurrencyCollection.Companion;
        return new ShardStateUnsplitAux(m1997constructorimpl, m1997constructorimpl2, companion.loadTlb(cellSlice), companion.loadTlb(cellSlice), hashMapELibDesc.loadTlb(cellSlice), maybeBlkMasterInfo.loadTlb(cellSlice), null);
    }
}
