...
public final class ShardStateUnsplitAuxTlbConstructor extends org.ton.tlb.TlbConstructor<ShardStateUnsplitAux> {
    ...
    public void storeTlb(CellBuilder cellBuilder, ShardStateUnsplitAux value) {
        ...
        cellBuilder.storeUInt(value.m5183getOverloadHistorysVKNKU(), 64);
        cellBuilder.storeUInt(value.m5184getUnderloadHistorysVKNKU(), 64);
    ...
    public ShardStateUnsplitAux loadTlb(CellSlice cellSlice) {
        ...
        long m1996constructorimpl2 = ULong.m1996constructorimpl(cellSlice.loadUInt(64).longValue());
        CurrencyCollection.Companion companion = CurrencyCollection.Companion;
        return new ShardStateUnsplitAux(m1996constructorimpl, m1996constructorimpl2, companion.loadTlb(cellSlice), companion.loadTlb(cellSlice), hashMapELibDesc.loadTlb(cellSlice), maybeBlkMasterInfo.loadTlb(cellSlice), null);
    }
}
