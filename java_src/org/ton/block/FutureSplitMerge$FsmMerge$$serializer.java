...
public final class FutureSplitMerge$FsmMerge$$serializer implements GeneratedSerializer<FutureSplitMerge.FsmMerge> {
    public static final FutureSplitMerge$FsmMerge$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        FutureSplitMerge$FsmMerge$$serializer futureSplitMerge$FsmMerge$$serializer = new FutureSplitMerge$FsmMerge$$serializer();
        INSTANCE = futureSplitMerge$FsmMerge$$serializer;
        ...
        pluginGeneratedSerialDescriptor.pushClassAnnotation(new C7481xec1cadf2("@type"));
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private FutureSplitMerge$FsmMerge$$serializer() {
    }
    ...
    public FutureSplitMerge.FsmMerge deserialize(Decoder decoder) {
        int i;
        Object obj;
        Object obj2;
        ...
        return new FutureSplitMerge.FsmMerge(i, (UInt) obj, (UInt) obj2, null, null);
    }
    ...
    public void serialize(Encoder encoder, FutureSplitMerge.FsmMerge value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        FutureSplitMerge.FsmMerge.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
