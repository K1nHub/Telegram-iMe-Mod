...
final class ComputeSkipReasonTlbCombinator extends TlbCombinator<ComputeSkipReason> {
    ...
    private ComputeSkipReasonTlbCombinator() {
        super(Reflection.getOrCreateKotlinClass(ComputeSkipReason.class), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(ComputeSkipReason.class), ComputeSkipReasonNoStateTlbConstructor.INSTANCE), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(ComputeSkipReason.class), ComputeSkipReasonBadStateTlbConstructor.INSTANCE), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(ComputeSkipReason.class), ComputeSkipReasonNoGasTlbConstructor.INSTANCE));
    }
