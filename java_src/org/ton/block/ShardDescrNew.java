...
public final class ShardDescrNew implements ShardDescr {
    ...
    /* renamed from: r1 */
    private final CellRef<ShardDescrAux> f2068r1;
    ...
    private static final KSerializer<Object>[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new SealedClassSerializer("org.ton.block.FutureSplitMerge", Reflection.getOrCreateKotlinClass(FutureSplitMerge.class), new KClass[]{Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmMerge.class), Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmNone.class), Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmSplit.class)}, new KSerializer[]{FutureSplitMerge$FsmMerge$$serializer.INSTANCE, new ObjectSerializer("fsm_none", FutureSplitMerge.FsmNone.INSTANCE, new Annotation[]{new C7785x18a57a5b("@type")}), FutureSplitMerge$FsmSplit$$serializer.INSTANCE}, new Annotation[]{new C7785x18a57a5b("@type")}), new PolymorphicSerializer(Reflection.getOrCreateKotlinClass(CellRef.class), new Annotation[0])};
    ...
    public int hashCode() {
        int m1977hashCodeimpl = ((((((((((UInt.m1977hashCodeimpl(this.seqNo) * 31) + UInt.m1977hashCodeimpl(this.regMcSeqno)) * 31) + ULong.m1999hashCodeimpl(this.startLt)) * 31) + ULong.m1999hashCodeimpl(this.endLt)) * 31) + this.rootHash.hashCode()) * 31) + this.fileHash.hashCode()) * 31;
        ...
        return ((((((((((((((i8 + (z5 ? 1 : z5 ? 1 : 0)) * 31) + this.flags) * 31) + UInt.m1977hashCodeimpl(this.nextCatchainSeqno)) * 31) + ULong.m1999hashCodeimpl(this.nextValidatorShard)) * 31) + UInt.m1977hashCodeimpl(this.minRefMcSeqno)) * 31) + UInt.m1977hashCodeimpl(this.genUtime)) * 31) + this.splitMergeAt.hashCode()) * 31) + this.f2068r1.hashCode();
    }
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("reg_mc_seqno", UInt.m1974boximpl(this.regMcSeqno));
        ...
        open.field("next_catchain_seqno", UInt.m1974boximpl(this.nextCatchainSeqno));
        open.field("next_validator_shard", ULong.m1996boximpl(this.nextValidatorShard));
    ...
    private ShardDescrNew(int i, UInt uInt, UInt uInt2, ULong uLong, ULong uLong2, BitString bitString, BitString bitString2, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, int i2, UInt uInt3, ULong uLong3, UInt uInt4, UInt uInt5, FutureSplitMerge futureSplitMerge, CellRef<ShardDescrAux> cellRef, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.regMcSeqno = uInt2.m1979unboximpl();
        ...
        this.nxCcUpdated = z5;
        this.flags = i2;
        this.nextCatchainSeqno = uInt3.m1979unboximpl();
        this.nextValidatorShard = uLong3.m2001unboximpl();
        this.minRefMcSeqno = uInt4.m1979unboximpl();
        this.genUtime = uInt5.m1979unboximpl();
        this.splitMergeAt = futureSplitMerge;
        this.f2068r1 = cellRef;
    ...
    public static final /* synthetic */ void write$Self(ShardDescrNew shardDescrNew, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, uIntSerializer, UInt.m1974boximpl(shardDescrNew.seqNo));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uIntSerializer, UInt.m1974boximpl(shardDescrNew.regMcSeqno));
        ULongSerializer uLongSerializer = ULongSerializer.INSTANCE;
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, uLongSerializer, ULong.m1996boximpl(shardDescrNew.startLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, uLongSerializer, ULong.m1996boximpl(shardDescrNew.endLt));
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 12, uIntSerializer, UInt.m1974boximpl(shardDescrNew.nextCatchainSeqno));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 13, uLongSerializer, ULong.m1996boximpl(shardDescrNew.nextValidatorShard));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 14, uIntSerializer, UInt.m1974boximpl(shardDescrNew.minRefMcSeqno));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 15, uIntSerializer, UInt.m1974boximpl(shardDescrNew.genUtime));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 16, kSerializerArr[16], shardDescrNew.splitMergeAt);
        compositeEncoder.encodeSerializableElement(serialDescriptor, 17, kSerializerArr[17], shardDescrNew.f2068r1);
    }

    /* renamed from: getSeqNo-pVg5ArA  reason: not valid java name */
    public final int m5337getSeqNopVg5ArA() {
        return this.seqNo;
    }

    /* renamed from: getRegMcSeqno-pVg5ArA  reason: not valid java name */
    public final int m5336getRegMcSeqnopVg5ArA() {
        return this.regMcSeqno;
    }

    /* renamed from: getStartLt-s-VKNKU  reason: not valid java name */
    public final long m5338getStartLtsVKNKU() {
        return this.startLt;
    }

    /* renamed from: getEndLt-s-VKNKU  reason: not valid java name */
    public final long m5331getEndLtsVKNKU() {
        return this.endLt;
    }
