...
public final class ShardDescrNew implements ShardDescr {
    ...
    /* renamed from: r1 */
    private final CellRef<ShardDescrAux> f2037r1;
    ...
    private static final KSerializer<Object>[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new SealedClassSerializer("org.ton.block.FutureSplitMerge", Reflection.getOrCreateKotlinClass(FutureSplitMerge.class), new KClass[]{Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmMerge.class), Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmNone.class), Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmSplit.class)}, new KSerializer[]{FutureSplitMerge$FsmMerge$$serializer.INSTANCE, new ObjectSerializer("fsm_none", FutureSplitMerge.FsmNone.INSTANCE, new Annotation[]{new C7520x18a57a5b("@type")}), FutureSplitMerge$FsmSplit$$serializer.INSTANCE}, new Annotation[]{new C7520x18a57a5b("@type")}), new PolymorphicSerializer(Reflection.getOrCreateKotlinClass(CellRef.class), new Annotation[0])};
    ...
    public int hashCode() {
        ...
        return ((((((((((((((i8 + (z5 ? 1 : z5 ? 1 : 0)) * 31) + this.flags) * 31) + UInt.m1969hashCodeimpl(this.nextCatchainSeqno)) * 31) + ULong.m1991hashCodeimpl(this.nextValidatorShard)) * 31) + UInt.m1969hashCodeimpl(this.minRefMcSeqno)) * 31) + UInt.m1969hashCodeimpl(this.genUtime)) * 31) + this.splitMergeAt.hashCode()) * 31) + this.f2037r1.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(ShardDescrNew shardDescrNew, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, uIntSerializer, UInt.m1966boximpl(shardDescrNew.seqNo));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uIntSerializer, UInt.m1966boximpl(shardDescrNew.regMcSeqno));
        ULongSerializer uLongSerializer = ULongSerializer.INSTANCE;
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, uLongSerializer, ULong.m1988boximpl(shardDescrNew.startLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, uLongSerializer, ULong.m1988boximpl(shardDescrNew.endLt));
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 12, uIntSerializer, UInt.m1966boximpl(shardDescrNew.nextCatchainSeqno));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 13, uLongSerializer, ULong.m1988boximpl(shardDescrNew.nextValidatorShard));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 14, uIntSerializer, UInt.m1966boximpl(shardDescrNew.minRefMcSeqno));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 15, uIntSerializer, UInt.m1966boximpl(shardDescrNew.genUtime));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 16, kSerializerArr[16], shardDescrNew.splitMergeAt);
        compositeEncoder.encodeSerializableElement(serialDescriptor, 17, kSerializerArr[17], shardDescrNew.f2037r1);
    }

    /* renamed from: getSeqNo-pVg5ArA  reason: not valid java name */
    public final int m5016getSeqNopVg5ArA() {
        return this.seqNo;
    }

    /* renamed from: getRegMcSeqno-pVg5ArA  reason: not valid java name */
    public final int m5015getRegMcSeqnopVg5ArA() {
        return this.regMcSeqno;
    }

    /* renamed from: getStartLt-s-VKNKU  reason: not valid java name */
    public final long m5017getStartLtsVKNKU() {
        return this.startLt;
    }

    /* renamed from: getEndLt-s-VKNKU  reason: not valid java name */
    public final long m5010getEndLtsVKNKU() {
        return this.endLt;
    }
