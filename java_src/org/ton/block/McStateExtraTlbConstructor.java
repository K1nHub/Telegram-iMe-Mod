...
public final class McStateExtraTlbConstructor extends org.ton.tlb.TlbConstructor<McStateExtra> {
    ...
    public void storeTlb(CellBuilder cellBuilder, McStateExtra value) {
        ...
        ShardHashes.Companion.storeTlb(cellBuilder, ShardHashes.m5347boximpl(value.m5289getShardHashes78z5ENA()));
    ...
    public McStateExtra loadTlb(CellSlice cellSlice) {
        ...
        HashMapE m5354unboximpl = ShardHashes.Companion.loadTlb(cellSlice).m5354unboximpl();
        ...
        return new McStateExtra(m5354unboximpl, loadTlb, CellRef.Companion.valueOf(cellSlice.loadRef(), (TlbCodec) companion), CurrencyCollection.Companion.loadTlb(cellSlice), null);
    }
}
