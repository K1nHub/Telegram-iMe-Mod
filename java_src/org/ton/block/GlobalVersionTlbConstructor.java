...
public final class GlobalVersionTlbConstructor extends org.ton.tlb.TlbConstructor<GlobalVersion> {
    ...
    public void storeTlb(CellBuilder cellBuilder, GlobalVersion value) {
        ...
        cellBuilder.storeUInt(value.m5097getVersionpVg5ArA(), 32);
        cellBuilder.storeUInt(value.m5096getCapabilitiessVKNKU(), 64);
    }

    @Override // org.ton.tlb.TlbConstructor, org.ton.tlb.TlbLoader
    public GlobalVersion loadTlb(CellSlice cellSlice) {
        Intrinsics.checkNotNullParameter(cellSlice, "cellSlice");
        return new GlobalVersion(UInt.m1974constructorimpl(cellSlice.loadUInt(32).intValue()), ULong.m1996constructorimpl(cellSlice.loadUInt(64).longValue()), null);
    }
}
