...
public final class CertificateTlbConstructor extends org.ton.tlb.TlbConstructor<Certificate> {
    ...
    public void storeTlb(CellBuilder cellBuilder, Certificate value) {
        ...
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5262getValid_sincepVg5ArA());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5263getValid_untilpVg5ArA());
    }

    @Override // org.ton.tlb.TlbConstructor, org.ton.tlb.TlbLoader
    public Certificate loadTlb(CellSlice cellSlice) {
        Intrinsics.checkNotNullParameter(cellSlice, "cellSlice");
        return new Certificate(SigPubKey.Companion.loadTlb(cellSlice), cellSlice.mo5387loadUInt32pVg5ArA(), cellSlice.mo5387loadUInt32pVg5ArA(), null);
    }
}
