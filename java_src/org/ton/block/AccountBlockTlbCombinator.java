...
public final class AccountBlockTlbCombinator extends TlbCombinator<AccountBlock> {
    ...
    private AccountBlockTlbCombinator() {
        super(Reflection.getOrCreateKotlinClass(AccountBlock.class), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(AccountBlock.class), AccountBlockTlbConstructor.INSTANCE));
    }
}
