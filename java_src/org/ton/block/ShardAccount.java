...
public final class ShardAccount implements TlbObject {
    ...
    public int hashCode() {
        return (((this.account.hashCode() * 31) + this.lastTransHash.hashCode()) * 31) + ULong.m1991hashCodeimpl(this.lastTransLt);
    }
    ...
    public static final /* synthetic */ void write$Self(ShardAccount shardAccount, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, ULongSerializer.INSTANCE, ULong.m1988boximpl(shardAccount.lastTransLt));
    }
    ...
    public final long m4994getLastTransLtsVKNKU() {
