...
public final class ShardStateUnsplitAux implements TlbObject {
    ...
    public int hashCode() {
        return (((((((((ULong.m1998hashCodeimpl(this.overloadHistory) * 31) + ULong.m1998hashCodeimpl(this.underloadHistory)) * 31) + this.totalBalance.hashCode()) * 31) + this.totalValidatorFees.hashCode()) * 31) + this.libraries.hashCode()) * 31) + this.masterRef.hashCode();
    }
    ...
    private ShardStateUnsplitAux(int i, ULong uLong, ULong uLong2, CurrencyCollection currencyCollection, CurrencyCollection currencyCollection2, HashMapE<LibDescr> hashMapE, Maybe<BlkMasterInfo> maybe, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.overloadHistory = uLong.m2000unboximpl();
        this.underloadHistory = uLong2.m2000unboximpl();
    ...
    public static final /* synthetic */ void write$Self(ShardStateUnsplitAux shardStateUnsplitAux, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, uLongSerializer, ULong.m1995boximpl(shardStateUnsplitAux.overloadHistory));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uLongSerializer, ULong.m1995boximpl(shardStateUnsplitAux.underloadHistory));
    ...
    public final long m5183getOverloadHistorysVKNKU() {
        return this.overloadHistory;
    }

    /* renamed from: getUnderloadHistory-s-VKNKU  reason: not valid java name */
    public final long m5184getUnderloadHistorysVKNKU() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("overload_history", ULong.m1995boximpl(this.overloadHistory));
        open.field("underload_history", ULong.m1995boximpl(this.underloadHistory));
