...
public final class ProcessedUpto implements TlbObject {
    ...
    public int hashCode() {
        return (ULong.m1999hashCodeimpl(this.lastMsgLt) * 31) + this.lastMsgHash.hashCode();
    }
    ...
    private ProcessedUpto(int i, ULong uLong, BitString bitString, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.lastMsgLt = uLong.m2001unboximpl();
    ...
    public static final /* synthetic */ void write$Self(ProcessedUpto processedUpto, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, ULongSerializer.INSTANCE, ULong.m1996boximpl(processedUpto.lastMsgLt));
    ...
    public final long m5314getLastMsgLtsVKNKU() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("last_msg_lt", ULong.m1996boximpl(this.lastMsgLt));
