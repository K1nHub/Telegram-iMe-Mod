...
public final class IntermediateAddressExt implements IntermediateAddress {
    ...
    public int hashCode() {
        return (this.workchainId * 31) + ULong.m1998hashCodeimpl(this.addrPfx);
    }
    ...
    private IntermediateAddressExt(int i, int i2, ULong uLong, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.workchainId = i2;
        this.addrPfx = uLong.m2000unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(IntermediateAddressExt intermediateAddressExt, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ULongSerializer.INSTANCE, ULong.m1995boximpl(intermediateAddressExt.addrPfx));
    }
    ...
    public final long m5099getAddrPfxsVKNKU() {
        return this.addrPfx;
    }
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("addr_pfx", ULong.m1995boximpl(this.addrPfx));
