...
public final class MerkleUpdateTlbConstructor<X> extends org.ton.tlb.TlbConstructor<MerkleUpdate<X>> {
    ...
    public void storeTlb(CellBuilder cellBuilder, MerkleUpdate<X> value) {
        ...
        cellBuilder.mo5376storeUInt16xj2QHRw(value.m5292getOldDepthMh2AYeg());
        cellBuilder.mo5376storeUInt16xj2QHRw(value.m5291getNewDepthMh2AYeg());
    ...
    public MerkleUpdate<X> loadTlb(CellSlice cellSlice) {
        ...
        return new MerkleUpdate<>(cellSlice.loadBits(256), cellSlice.loadBits(256), cellSlice.mo5386loadUInt16Mh2AYeg(), cellSlice.mo5386loadUInt16Mh2AYeg(), this.xCellRef.loadTlb(cellSlice), this.xCellRef.loadTlb(cellSlice), null);
    }
}
