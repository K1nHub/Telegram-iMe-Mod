...
public final class OldMcBlocksInfo$$serializer implements GeneratedSerializer<OldMcBlocksInfo> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return OldMcBlocksInfo.m4977boximpl(m4985deserializea38pvyo(decoder));
    }

    /* renamed from: deserialize-a38pvyo  reason: not valid java name */
    public HashmapAugE<KeyExtBlkRef, KeyMaxLt> m4985deserializea38pvyo(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return OldMcBlocksInfo.m4978constructorimpl((HashmapAugE) decoder.decodeInline(getDescriptor()).decodeSerializableValue(new PolymorphicSerializer(Reflection.getOrCreateKotlinClass(HashmapAugE.class), new Annotation[]{new C7514xa42a768e("@type")})));
    }
    ...
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m4986serializet0Hynxs(encoder, ((OldMcBlocksInfo) obj).m4984unboximpl());
    }

    /* renamed from: serialize-t0Hynxs  reason: not valid java name */
    public void m4986serializet0Hynxs(Encoder encoder, HashmapAugE<KeyExtBlkRef, KeyMaxLt> value) {
        ...
        encodeInline.encodeSerializableValue(new PolymorphicSerializer(Reflection.getOrCreateKotlinClass(HashmapAugE.class), new Annotation[]{new C7514xa42a768e("@type")}), value);
    }
