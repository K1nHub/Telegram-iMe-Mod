    ...
    public static final class Companion implements TlbCodec<AddrStd> {
        ...
        public final AddrStd parseUserFriendly(String address) {
            ...
            try {
                ...
                ByteBuffer m1913constructorimpl = Memory.m1913constructorimpl(order);
                byte b = m1913constructorimpl.get(0);
                byte b2 = (byte) (b & Byte.MAX_VALUE);
                if ((b2 == 81) | (b2 == 17)) {
                    byte b3 = m1913constructorimpl.get(1);
                    copyInto$default = ArraysKt___ArraysJvmKt.copyInto$default(bArr, bArr2, 0, 2, 34, 2, (Object) null);
                    if (!((UShort.m2019constructorimpl(m1913constructorimpl.getShort(34)) & 65535) == checksum(b, b3, copyInto$default))) {
