...
public final class MsgDiscardTr implements InMsg {
    ...
    private static final KSerializer<Object>[] $childSerializers = {new PolymorphicSerializer(Reflection.getOrCreateKotlinClass(CellRef.class), new Annotation[0]), null, null, new PolymorphicSerializer(Reflection.getOrCreateKotlinClass(Cell.class), new Annotation[]{new C7499x6f655aa4("@type")})};
    ...
    public int hashCode() {
        return (((((this.inMsg.hashCode() * 31) + ULong.m1991hashCodeimpl(this.transactionId)) * 31) + this.fwdFee.hashCode()) * 31) + this.proofDelivered.hashCode();
    }

    public String toString() {
        return "MsgDiscardTr(inMsg=" + this.inMsg + ", transactionId=" + ((Object) ULong.m1992toStringimpl(this.transactionId)) + ", fwdFee=" + this.fwdFee + ", proofDelivered=" + this.proofDelivered + ')';
    }
    ...
    public static final /* synthetic */ void write$Self(MsgDiscardTr msgDiscardTr, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ULongSerializer.INSTANCE, ULong.m1988boximpl(msgDiscardTr.transactionId));
    ...
    public final long m4973getTransactionIdsVKNKU() {
