...
public final class TrComputePhaseAux implements TlbObject {
    ...
    public int hashCode() {
        return (((((((((((((((this.gasUsed.hashCode() * 31) + this.gasLimit.hashCode()) * 31) + this.gasCredit.hashCode()) * 31) + this.mode) * 31) + this.exitCode) * 31) + this.exitArg.hashCode()) * 31) + UInt.m1976hashCodeimpl(this.vmSteps)) * 31) + this.vmInitStateHash.hashCode()) * 31) + this.vmFinalStateHash.hashCode();
    }
    ...
    private TrComputePhaseAux(int i, VarUInteger varUInteger, VarUInteger varUInteger2, Maybe<VarUInteger> maybe, int i2, int i3, Maybe<Integer> maybe2, UInt uInt, BitString bitString, BitString bitString2, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.exitCode = i3;
        this.exitArg = maybe2;
        this.vmSteps = uInt.m1978unboximpl();
    ...
    public static final /* synthetic */ void write$Self(TrComputePhaseAux trComputePhaseAux, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 6, UIntSerializer.INSTANCE, UInt.m1973boximpl(trComputePhaseAux.vmSteps));
    ...
    public final int m5185getVmStepspVg5ArA() {
        return this.vmSteps;
    }
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("vm_steps", UInt.m1973boximpl(this.vmSteps));
