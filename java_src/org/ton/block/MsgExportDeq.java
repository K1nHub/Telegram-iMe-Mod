...
public final class MsgExportDeq implements OutMsg {
    ...
    public int hashCode() {
        return (this.outMsg.hashCode() * 31) + ULong.m1998hashCodeimpl(this.importBlockLt);
    }
    ...
    private MsgExportDeq(int i, CellRef<MsgEnvelope> cellRef, ULong uLong, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.outMsg = cellRef;
        this.importBlockLt = uLong.m2000unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(MsgExportDeq msgExportDeq, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ULongSerializer.INSTANCE, ULong.m1995boximpl(msgExportDeq.importBlockLt));
    }
    ...
    public final long m5110getImportBlockLtsVKNKU() {
