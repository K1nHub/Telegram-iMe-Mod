...
public final class MsgExportDeq implements OutMsg {
    ...
    public int hashCode() {
        return (this.outMsg.hashCode() * 31) + ULong.m1999hashCodeimpl(this.importBlockLt);
    }
    ...
    private MsgExportDeq(int i, CellRef<MsgEnvelope> cellRef, ULong uLong, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.outMsg = cellRef;
        this.importBlockLt = uLong.m2001unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(MsgExportDeq msgExportDeq, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ULongSerializer.INSTANCE, ULong.m1996boximpl(msgExportDeq.importBlockLt));
    }
    ...
    public final long m5295getImportBlockLtsVKNKU() {
