...
public final class MsgDiscardFin implements InMsg {
    ...
    public int hashCode() {
        return (((this.inMsg.hashCode() * 31) + ULong.m1998hashCodeimpl(this.transactionId)) * 31) + this.fwdFee.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(MsgDiscardFin msgDiscardFin, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ULongSerializer.INSTANCE, ULong.m1995boximpl(msgDiscardFin.transactionId));
    ...
    public final long m5108getTransactionIdsVKNKU() {
