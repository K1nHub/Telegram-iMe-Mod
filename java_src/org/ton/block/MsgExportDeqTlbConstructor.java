...
public final class MsgExportDeqTlbConstructor extends org.ton.tlb.TlbConstructor<MsgExportDeq> {
    ...
    public void storeTlb(CellBuilder cellBuilder, MsgExportDeq value) {
        ...
        cellBuilder.storeUInt(value.m5295getImportBlockLtsVKNKU(), 63);
    }
    ...
    public MsgExportDeq loadTlb(CellSlice cellSlice) {
        ...
        return new MsgExportDeq(CellRef.Companion.valueOf(cellSlice.loadRef(), (TlbCodec) companion), ULong.m1997constructorimpl(cellSlice.loadUInt(63).longValue()), null);
    }
}
