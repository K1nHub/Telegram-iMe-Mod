...
public final class ShardDescrNewTlbConstructor extends org.ton.tlb.TlbConstructor<ShardDescrNew> {
    ...
    public ShardDescrNew loadTlb(CellSlice cellSlice) {
        ...
        return new ShardDescrNew(mo5066loadUInt32pVg5ArA, mo5066loadUInt32pVg5ArA2, mo5067loadUInt64sVKNKU, mo5067loadUInt64sVKNKU2, loadBits, loadBits2, loadBit, loadBit2, loadBit3, loadBit4, loadBit5, intValue, mo5066loadUInt32pVg5ArA3, mo5067loadUInt64sVKNKU3, mo5066loadUInt32pVg5ArA4, mo5066loadUInt32pVg5ArA5, loadTlb, CellRef.Companion.valueOf(cellSlice.loadRef(), (TlbCodec) companion), null);
    }
    ...
    public void storeTlb(CellBuilder cellBuilder, ShardDescrNew value) {
        ...
        cellBuilder.mo5056storeUInt32WZ4Q5Ns(value.m5016getSeqNopVg5ArA());
        cellBuilder.mo5056storeUInt32WZ4Q5Ns(value.m5015getRegMcSeqnopVg5ArA());
        cellBuilder.mo5057storeUInt64VKZWuLQ(value.m5017getStartLtsVKNKU());
        cellBuilder.mo5057storeUInt64VKZWuLQ(value.m5010getEndLtsVKNKU());
        ...
        cellBuilder.mo5056storeUInt32WZ4Q5Ns(value.m5013getNextCatchainSeqnopVg5ArA());
        cellBuilder.mo5057storeUInt64VKZWuLQ(value.m5014getNextValidatorShardsVKNKU());
        cellBuilder.mo5056storeUInt32WZ4Q5Ns(value.m5012getMinRefMcSeqnopVg5ArA());
        cellBuilder.mo5056storeUInt32WZ4Q5Ns(value.m5011getGenUtimepVg5ArA());
