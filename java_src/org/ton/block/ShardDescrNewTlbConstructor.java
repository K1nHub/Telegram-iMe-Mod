...
public final class ShardDescrNewTlbConstructor extends org.ton.tlb.TlbConstructor<ShardDescrNew> {
    ...
    public ShardDescrNew loadTlb(CellSlice cellSlice) {
        ...
        return new ShardDescrNew(mo5387loadUInt32pVg5ArA, mo5387loadUInt32pVg5ArA2, mo5388loadUInt64sVKNKU, mo5388loadUInt64sVKNKU2, loadBits, loadBits2, loadBit, loadBit2, loadBit3, loadBit4, loadBit5, intValue, mo5387loadUInt32pVg5ArA3, mo5388loadUInt64sVKNKU3, mo5387loadUInt32pVg5ArA4, mo5387loadUInt32pVg5ArA5, loadTlb, CellRef.Companion.valueOf(cellSlice.loadRef(), (TlbCodec) companion), null);
    }
    ...
    public void storeTlb(CellBuilder cellBuilder, ShardDescrNew value) {
        ...
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5337getSeqNopVg5ArA());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5336getRegMcSeqnopVg5ArA());
        cellBuilder.mo5378storeUInt64VKZWuLQ(value.m5338getStartLtsVKNKU());
        cellBuilder.mo5378storeUInt64VKZWuLQ(value.m5331getEndLtsVKNKU());
        ...
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5334getNextCatchainSeqnopVg5ArA());
        cellBuilder.mo5378storeUInt64VKZWuLQ(value.m5335getNextValidatorShardsVKNKU());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5333getMinRefMcSeqnopVg5ArA());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5332getGenUtimepVg5ArA());
