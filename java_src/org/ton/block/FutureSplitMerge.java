...
public interface FutureSplitMerge extends TlbObject {
        ...
        static {
            ...
            lazy = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0<KSerializer<Object>>() { // from class: org.ton.block.FutureSplitMerge.FsmNone.1
                ...
                public final KSerializer<Object> invoke() {
                    return new ObjectSerializer("fsm_none", FsmNone.INSTANCE, new Annotation[]{new C7746xec1cadf2("@type")});
                }
            });
    ...
    public static final class FsmMerge implements FutureSplitMerge {
        ...
        public int hashCode() {
            return (UInt.m1977hashCodeimpl(this.mergeUtime) * 31) + UInt.m1977hashCodeimpl(this.interval);
        }
        ...
        private FsmMerge(int i, UInt uInt, UInt uInt2, SerializationConstructorMarker serializationConstructorMarker) {
            ...
            this.mergeUtime = uInt.m1979unboximpl();
            this.interval = uInt2.m1979unboximpl();
        }
        ...
        public static final /* synthetic */ void write$Self(FsmMerge fsmMerge, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.encodeSerializableElement(serialDescriptor, 0, uIntSerializer, UInt.m1974boximpl(fsmMerge.mergeUtime));
            compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uIntSerializer, UInt.m1974boximpl(fsmMerge.interval));
        }

        /* renamed from: getMergeUtime-pVg5ArA  reason: not valid java name */
        public final int m5278getMergeUtimepVg5ArA() {
            return this.mergeUtime;
        }

        /* renamed from: getInterval-pVg5ArA  reason: not valid java name */
        public final int m5277getIntervalpVg5ArA() {
        ...
        public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
            ...
            open.field("merge_utime", UInt.m1974boximpl(this.mergeUtime));
            open.field("interval", UInt.m1974boximpl(this.interval));
    ...
    public static final class FsmSplit implements FutureSplitMerge {
        ...
        public int hashCode() {
            return (UInt.m1977hashCodeimpl(this.splitUtime) * 31) + UInt.m1977hashCodeimpl(this.interval);
        }
        ...
        private FsmSplit(int i, UInt uInt, UInt uInt2, SerializationConstructorMarker serializationConstructorMarker) {
            ...
            this.splitUtime = uInt.m1979unboximpl();
            this.interval = uInt2.m1979unboximpl();
        }
        ...
        public static final /* synthetic */ void write$Self(FsmSplit fsmSplit, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            UIntSerializer uIntSerializer = UIntSerializer.INSTANCE;
            compositeEncoder.encodeSerializableElement(serialDescriptor, 0, uIntSerializer, UInt.m1974boximpl(fsmSplit.splitUtime));
            compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uIntSerializer, UInt.m1974boximpl(fsmSplit.interval));
        }

        /* renamed from: getSplitUtime-pVg5ArA  reason: not valid java name */
        public final int m5280getSplitUtimepVg5ArA() {
            return this.splitUtime;
        }

        /* renamed from: getInterval-pVg5ArA  reason: not valid java name */
        public final int m5279getIntervalpVg5ArA() {
            return this.interval;
        }
        ...
        public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
            ...
            open.field("split_utime", UInt.m1974boximpl(this.splitUtime));
            open.field("interval", UInt.m1974boximpl(this.interval));
            TlbPrettyPrinter.close$default(open, null, 1, null);
            return printer;
        }
    ...
    public static final class Companion implements TlbCombinatorProvider<FutureSplitMerge> {
        ...
        public final KSerializer<FutureSplitMerge> serializer() {
            return new SealedClassSerializer("org.ton.block.FutureSplitMerge", Reflection.getOrCreateKotlinClass(FutureSplitMerge.class), new KClass[]{Reflection.getOrCreateKotlinClass(FsmMerge.class), Reflection.getOrCreateKotlinClass(FsmNone.class), Reflection.getOrCreateKotlinClass(FsmSplit.class)}, new KSerializer[]{FutureSplitMerge$FsmMerge$$serializer.INSTANCE, new ObjectSerializer("fsm_none", FsmNone.INSTANCE, new Annotation[]{new C7746xec1cadf2("@type")}), FutureSplitMerge$FsmSplit$$serializer.INSTANCE}, new Annotation[]{new C7746xec1cadf2("@type")});
        }
    }
}
