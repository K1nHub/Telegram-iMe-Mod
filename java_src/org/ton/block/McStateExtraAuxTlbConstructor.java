...
public final class McStateExtraAuxTlbConstructor extends org.ton.tlb.TlbConstructor<McStateExtraAux> {
    ...
    public McStateExtraAux loadTlb(CellSlice cellSlice) {
        ...
        return new McStateExtraAux(intValue, ValidatorInfo.Companion.loadTlb(cellSlice), OldMcBlocksInfo.Companion.loadTlb(cellSlice).m5305unboximpl(), cellSlice.loadBit(), maybeExtBlkRef.loadTlb(cellSlice), (intValue & 1) != 0 ? BlockCreateStats.Companion.loadTlb(cellSlice) : null, null);
    }
    ...
    public void storeTlb(CellBuilder cellBuilder, McStateExtraAux value) {
        ...
        OldMcBlocksInfo.Companion.storeTlb(cellBuilder, OldMcBlocksInfo.m5298boximpl(value.m5290getPrevBlocksD6f0ERk()));
