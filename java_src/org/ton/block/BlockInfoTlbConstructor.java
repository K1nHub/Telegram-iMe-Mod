...
public final class BlockInfoTlbConstructor extends org.ton.tlb.TlbConstructor<BlockInfo> {
    ...
    public void storeTlb(CellBuilder cellBuilder, BlockInfo value) {
        ...
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5261getVersionpVg5ArA());
        ...
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5256getGenUtimepVg5ArA());
        cellBuilder.mo5378storeUInt64VKZWuLQ(value.m5260getStartLtsVKNKU());
        cellBuilder.mo5378storeUInt64VKZWuLQ(value.m5254getEndLtsVKNKU());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5257getGenValidatorListHashShortpVg5ArA());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5255getGenCatchainSeqnopVg5ArA());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5258getMinRefMcSeqnopVg5ArA());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5259getPrevKeyBlockSeqnopVg5ArA());
    ...
    public BlockInfo loadTlb(CellSlice cellSlice) {
        ...
        return new BlockInfo(mo5387loadUInt32pVg5ArA, loadBit, loadBit2, loadBit3, loadBit4, loadBit5, loadBit6, loadBit7, loadBit8, intValue, cellSlice.mo5387loadUInt32pVg5ArA(), cellSlice.mo5387loadUInt32pVg5ArA(), ShardIdent.Companion.loadTlb(cellSlice), cellSlice.mo5387loadUInt32pVg5ArA(), cellSlice.mo5388loadUInt64sVKNKU(), cellSlice.mo5388loadUInt64sVKNKU(), cellSlice.mo5387loadUInt32pVg5ArA(), cellSlice.mo5387loadUInt32pVg5ArA(), cellSlice.mo5387loadUInt32pVg5ArA(), cellSlice.mo5387loadUInt32pVg5ArA(), (intValue & 1) != 0 ? GlobalVersion.Companion.loadTlb(cellSlice) : null, loadBit ? blkMasterInfo.loadTlb(cellSlice) : null, (CellRef) CellRef.Companion.tlbCodec(BlkPrevInfo.Companion.tlbCodec(loadBit2)).loadTlb(cellSlice), loadBit8 ? blkPrevInfoVert.loadTlb(cellSlice) : null, null);
    }
}
