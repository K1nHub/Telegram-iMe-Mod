...
public final class MsgExportDeqShortTlbConstructor extends org.ton.tlb.TlbConstructor<MsgExportDeqShort> {
    ...
    public void storeTlb(CellBuilder cellBuilder, MsgExportDeqShort value) {
        ...
        cellBuilder.mo5378storeUInt64VKZWuLQ(value.m5297getNextAddrPfxsVKNKU());
        cellBuilder.mo5378storeUInt64VKZWuLQ(value.m5296getImportBlockLtsVKNKU());
    }

    @Override // org.ton.tlb.TlbConstructor, org.ton.tlb.TlbLoader
    public MsgExportDeqShort loadTlb(CellSlice cellSlice) {
        Intrinsics.checkNotNullParameter(cellSlice, "cellSlice");
        return new MsgExportDeqShort(cellSlice.loadBits(256), (int) cellSlice.loadTinyInt(32), cellSlice.mo5388loadUInt64sVKNKU(), cellSlice.mo5388loadUInt64sVKNKU(), null);
    }
}
