...
public final class TrPhaseComputeVm implements TrComputePhase {
    ...
    /* renamed from: r1 */
    private final CellRef<TrComputePhaseAux> f2039r1;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TrPhaseComputeVm) {
            ...
            return this.success == trPhaseComputeVm.success && this.msgStateUsed == trPhaseComputeVm.msgStateUsed && this.accountActivated == trPhaseComputeVm.accountActivated && Intrinsics.areEqual(this.gasFees, trPhaseComputeVm.gasFees) && Intrinsics.areEqual(this.f2039r1, trPhaseComputeVm.f2039r1);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((i3 + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.gasFees.hashCode()) * 31) + this.f2039r1.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(TrPhaseComputeVm trPhaseComputeVm, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 4, kSerializerArr[4], trPhaseComputeVm.f2039r1);
    }
