...
public final class Certificate {
    ...
    public int hashCode() {
        return (((this.temp_key.hashCode() * 31) + UInt.m1976hashCodeimpl(this.valid_since)) * 31) + UInt.m1976hashCodeimpl(this.valid_until);
    }

    public String toString() {
        return "Certificate(temp_key=" + this.temp_key + ", valid_since=" + ((Object) UInt.m1977toStringimpl(this.valid_since)) + ", valid_until=" + ((Object) UInt.m1977toStringimpl(this.valid_until)) + ')';
    }
    ...
    private Certificate(int i, SigPubKey sigPubKey, UInt uInt, UInt uInt2, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.valid_since = uInt.m1978unboximpl();
        this.valid_until = uInt2.m1978unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(Certificate certificate, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uIntSerializer, UInt.m1973boximpl(certificate.valid_since));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, uIntSerializer, UInt.m1973boximpl(certificate.valid_until));
    }
    ...
    public final int m5077getValid_sincepVg5ArA() {
        return this.valid_since;
    }

    /* renamed from: getValid_until-pVg5ArA  reason: not valid java name */
    public final int m5078getValid_untilpVg5ArA() {
