...
public final class GlobalVersion implements TlbObject {
    ...
    public int hashCode() {
        return (UInt.m1976hashCodeimpl(this.version) * 31) + ULong.m1998hashCodeimpl(this.capabilities);
    }
    ...
    private GlobalVersion(int i, UInt uInt, ULong uLong, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.capabilities = uLong.m2000unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(GlobalVersion globalVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, UIntSerializer.INSTANCE, UInt.m1973boximpl(globalVersion.version));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ULongSerializer.INSTANCE, ULong.m1995boximpl(globalVersion.capabilities));
    }

    /* renamed from: getVersion-pVg5ArA  reason: not valid java name */
    public final int m5097getVersionpVg5ArA() {
        return this.version;
    }

    /* renamed from: getCapabilities-s-VKNKU  reason: not valid java name */
    public final long m5096getCapabilitiessVKNKU() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("capabilities", ULong.m1995boximpl(this.capabilities));
