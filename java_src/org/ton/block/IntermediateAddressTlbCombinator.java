...
public final class IntermediateAddressTlbCombinator extends TlbCombinator<IntermediateAddress> {
    ...
    private IntermediateAddressTlbCombinator() {
        super(Reflection.getOrCreateKotlinClass(IntermediateAddress.class), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(IntermediateAddressExt.class), IntermediateAddressExt.Companion), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(IntermediateAddressRegular.class), IntermediateAddressRegular.Companion), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(IntermediateAddressSimple.class), IntermediateAddressSimple.Companion));
    }
}
