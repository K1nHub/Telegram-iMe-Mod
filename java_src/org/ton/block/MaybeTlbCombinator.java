...
public final class MaybeTlbCombinator extends TlbCombinator<Maybe<?>> {
    ...
    public MaybeTlbCombinator(TlbCodec<?> typeCodec, JustConstructor<?> justConstructor) {
        super(Reflection.getOrCreateKotlinClass(Maybe.class), TuplesKt.m146to(Reflection.getOrCreateKotlinClass(Nothing.class), NothingConstructor.INSTANCE), TuplesKt.m146to(Reflection.getOrCreateKotlinClass(Just.class), justConstructor));
