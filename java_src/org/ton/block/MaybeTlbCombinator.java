...
public final class MaybeTlbCombinator extends TlbCombinator<Maybe<?>> {
    ...
    public MaybeTlbCombinator(TlbCodec<?> typeCodec, JustConstructor<?> justConstructor) {
        super(Reflection.getOrCreateKotlinClass(Maybe.class), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(Nothing.class), NothingConstructor.INSTANCE), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(Just.class), justConstructor));
