...
public final class IhrPendingSince {
    ...
    public int hashCode() {
        return ULong.m1999hashCodeimpl(this.import_lt);
    }

    public String toString() {
        return "IhrPendingSince(import_lt=" + ((Object) ULong.m2000toStringimpl(this.import_lt)) + ')';
    }
    ...
    private IhrPendingSince(int i, ULong uLong, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.import_lt = uLong.m2001unboximpl();
    }
    ...
    public final long m5283getImport_ltsVKNKU() {
