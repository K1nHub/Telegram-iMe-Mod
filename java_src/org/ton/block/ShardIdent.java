...
public final class ShardIdent implements TlbObject {
    ...
    public int hashCode() {
        return (((this.shardPfxBits * 31) + this.workchainId) * 31) + ULong.m1999hashCodeimpl(this.shardPrefix);
    }
    ...
    private ShardIdent(int i, int i2, int i3, ULong uLong, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.workchainId = i3;
        this.shardPrefix = uLong.m2001unboximpl();
        if (i2 <= 60) {
            return;
        }
    ...
    public static final /* synthetic */ void write$Self(ShardIdent shardIdent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, ULongSerializer.INSTANCE, ULong.m1996boximpl(shardIdent.shardPrefix));
    }
    ...
    public final long m5363getShardPrefixsVKNKU() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("shard_prefix", ULong.m1996boximpl(this.shardPrefix));
