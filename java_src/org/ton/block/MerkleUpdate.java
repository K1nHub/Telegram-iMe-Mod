...
public final class MerkleUpdate<X> implements TlbObject {
    ...
    private final CellRef<X> f2175new;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MerkleUpdate) {
            ...
            return Intrinsics.areEqual(this.oldHash, merkleUpdate.oldHash) && Intrinsics.areEqual(this.newHash, merkleUpdate.newHash) && this.oldDepth == merkleUpdate.oldDepth && this.newDepth == merkleUpdate.newDepth && Intrinsics.areEqual(this.old, merkleUpdate.old) && Intrinsics.areEqual(this.f2175new, merkleUpdate.f2175new);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((this.oldHash.hashCode() * 31) + this.newHash.hashCode()) * 31) + UShort.m2020hashCodeimpl(this.oldDepth)) * 31) + UShort.m2020hashCodeimpl(this.newDepth)) * 31) + this.old.hashCode()) * 31) + this.f2175new.hashCode();
    }

    public String toString() {
        return "MerkleUpdate(oldHash=" + this.oldHash + ", newHash=" + this.newHash + ", oldDepth=" + ((Object) UShort.m2021toStringimpl(this.oldDepth)) + ", newDepth=" + ((Object) UShort.m2021toStringimpl(this.newDepth)) + ", old=" + this.old + ", new=" + this.f2175new + ')';
    }
    ...
    private MerkleUpdate(int i, BitString bitString, BitString bitString2, UShort uShort, UShort uShort2, CellRef<? extends X> cellRef, CellRef<? extends X> cellRef2, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.oldDepth = uShort.m2022unboximpl();
        this.newDepth = uShort2.m2022unboximpl();
        this.old = cellRef;
        this.f2175new = cellRef2;
    ...
    public static final /* synthetic */ void write$Self(MerkleUpdate merkleUpdate, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor, KSerializer kSerializer) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, uShortSerializer, UShort.m2017boximpl(merkleUpdate.oldDepth));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, uShortSerializer, UShort.m2017boximpl(merkleUpdate.newDepth));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 4, kSerializerArr[4], merkleUpdate.old);
        compositeEncoder.encodeSerializableElement(serialDescriptor, 5, kSerializerArr[5], merkleUpdate.f2175new);
    }
    ...
    public final short m5107getOldDepthMh2AYeg() {
        return this.oldDepth;
    }

    /* renamed from: getNewDepth-Mh2AYeg  reason: not valid java name */
    public final short m5106getNewDepthMh2AYeg() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("old_depth", UShort.m2017boximpl(this.oldDepth));
        open.field("new_depth", UShort.m2017boximpl(this.newDepth));
        open.field("old", CellRef.DefaultImpls.toCell$default(this.old, null, 1, null));
        open.field("new", CellRef.DefaultImpls.toCell$default(this.f2175new, null, 1, null));
