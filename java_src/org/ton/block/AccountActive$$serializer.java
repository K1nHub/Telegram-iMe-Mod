...
public final class AccountActive$$serializer implements GeneratedSerializer<AccountActive> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return AccountActive.m5240boximpl(m5247deserializeP1cIiig(decoder));
    }

    /* renamed from: deserialize-P1cIiig  reason: not valid java name */
    public StateInit m5247deserializeP1cIiig(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return AccountActive.m5241constructorimpl((StateInit) decoder.decodeInline(getDescriptor()).decodeSerializableValue(StateInit$$serializer.INSTANCE));
    }
    ...
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m5248serializewKbCAR4(encoder, ((AccountActive) obj).m5246unboximpl());
    }

    /* renamed from: serialize-wKbCAR4  reason: not valid java name */
    public void m5248serializewKbCAR4(Encoder encoder, StateInit value) {
