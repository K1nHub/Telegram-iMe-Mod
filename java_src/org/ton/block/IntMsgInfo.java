...
public final class IntMsgInfo implements CommonMsgInfo {
    ...
    public int hashCode() {
        ...
        return ((((((((((((((i3 + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.src.hashCode()) * 31) + this.dest.hashCode()) * 31) + this.value.hashCode()) * 31) + this.ihr_fee.hashCode()) * 31) + this.fwd_fee.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.created_lt)) * 31) + this.created_at;
    }
