...
public final class McStateExtraAux implements TlbObject {
    ...
    public int hashCode() {
        int hashCode = ((((this.flags * 31) + this.validatorInfo.hashCode()) * 31) + OldMcBlocksInfo.m5302hashCodeimpl(this.prevBlocks)) * 31;
    ...
    public static final /* synthetic */ void write$Self(McStateExtraAux mcStateExtraAux, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, OldMcBlocksInfo$$serializer.INSTANCE, OldMcBlocksInfo.m5298boximpl(mcStateExtraAux.prevBlocks));
    ...
    public final HashmapAugE<KeyExtBlkRef, KeyMaxLt> m5290getPrevBlocksD6f0ERk() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("prev_blocks", OldMcBlocksInfo.m5298boximpl(this.prevBlocks));
