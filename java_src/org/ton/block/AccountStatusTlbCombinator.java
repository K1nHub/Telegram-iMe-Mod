...
final class AccountStatusTlbCombinator extends TlbCombinator<AccountStatus> {
    ...
    private AccountStatusTlbCombinator() {
        super(Reflection.getOrCreateKotlinClass(AccountStatus.class), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(AccountStatus.class), AccountStatusUninitTlbConstructor.INSTANCE), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(AccountStatus.class), AccountStatusFrozenTlbConstructor.INSTANCE), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(AccountStatus.class), AccountStatusActiveTlbConstructor.INSTANCE), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(AccountStatus.class), AccountStatusNonExistTlbConstructor.INSTANCE));
    }
