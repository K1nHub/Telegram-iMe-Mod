...
public final class ShardDescrAux$$serializer implements GeneratedSerializer<ShardDescrAux> {
    public static final ShardDescrAux$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        ShardDescrAux$$serializer shardDescrAux$$serializer = new ShardDescrAux$$serializer();
        INSTANCE = shardDescrAux$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("org.ton.block.ShardDescrAux", shardDescrAux$$serializer, 2);
    ...
    private ShardDescrAux$$serializer() {
    }
    ...
    public ShardDescrAux deserialize(Decoder decoder) {
        Object obj;
        Object obj2;
        int i;
        ...
        return new ShardDescrAux(i, (CurrencyCollection) obj2, (CurrencyCollection) obj, null);
    }
    ...
    public void serialize(Encoder encoder, ShardDescrAux value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        ShardDescrAux.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
