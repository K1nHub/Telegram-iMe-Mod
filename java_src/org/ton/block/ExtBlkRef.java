...
public final class ExtBlkRef implements TlbObject {
    ...
    public int hashCode() {
        return (((((ULong.m1991hashCodeimpl(this.endLt) * 31) + UInt.m1969hashCodeimpl(this.seqNo)) * 31) + this.rootHash.hashCode()) * 31) + this.fileHash.hashCode();
    }
    ...
    private ExtBlkRef(int i, ULong uLong, UInt uInt, BitString bitString, BitString bitString2, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.endLt = uLong.m1993unboximpl();
    ...
    public static final /* synthetic */ void write$Self(ExtBlkRef extBlkRef, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, ULongSerializer.INSTANCE, ULong.m1988boximpl(extBlkRef.endLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, UIntSerializer.INSTANCE, UInt.m1966boximpl(extBlkRef.seqNo));
    ...
    public final long m4952getEndLtsVKNKU() {
        return this.endLt;
    }

    /* renamed from: getSeqNo-pVg5ArA  reason: not valid java name */
    public final int m4953getSeqNopVg5ArA() {
        return this.seqNo;
    }
