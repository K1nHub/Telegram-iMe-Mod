...
final class EitherTlbCombinator<X, Y> extends TlbCombinator<Either<?, ?>> {
    ...
    public EitherTlbCombinator(TlbCodec<X> x, TlbCodec<Y> y, LeftTlbConstructor<X, Y> left, RightTlbConstructor<X, Y> right) {
        super(Reflection.getOrCreateKotlinClass(Either.class), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(Either.Left.class), left), TuplesKt.m149to(Reflection.getOrCreateKotlinClass(Either.Right.class), right));
