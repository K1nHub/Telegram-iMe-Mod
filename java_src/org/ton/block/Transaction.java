...
public final class Transaction implements TlbObject {
    ...
    /* renamed from: r1 */
    private final CellRef<TransactionAux> f2054r1;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Transaction) {
            ...
            return Intrinsics.areEqual(this.accountAddr, transaction.accountAddr) && this.f2053lt == transaction.f2053lt && Intrinsics.areEqual(this.prevTransHash, transaction.prevTransHash) && this.prevTransLt == transaction.prevTransLt && this.now == transaction.now && this.outMsgCnt == transaction.outMsgCnt && this.origStatus == transaction.origStatus && this.endStatus == transaction.endStatus && Intrinsics.areEqual(this.f2054r1, transaction.f2054r1) && Intrinsics.areEqual(this.totalFees, transaction.totalFees) && Intrinsics.areEqual(this.stateUpdate, transaction.stateUpdate) && Intrinsics.areEqual(this.description, transaction.description);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((((((((this.accountAddr.hashCode() * 31) + ULong.m1998hashCodeimpl(this.f2053lt)) * 31) + this.prevTransHash.hashCode()) * 31) + ULong.m1998hashCodeimpl(this.prevTransLt)) * 31) + UInt.m1976hashCodeimpl(this.now)) * 31) + this.outMsgCnt) * 31) + this.origStatus.hashCode()) * 31) + this.endStatus.hashCode()) * 31) + this.f2054r1.hashCode()) * 31) + this.totalFees.hashCode()) * 31) + this.stateUpdate.hashCode()) * 31) + this.description.hashCode();
    }
    ...
    private Transaction(int i, BitString bitString, ULong uLong, BitString bitString2, ULong uLong2, UInt uInt, int i2, AccountStatus accountStatus, AccountStatus accountStatus2, CellRef<TransactionAux> cellRef, CurrencyCollection currencyCollection, CellRef<HashUpdate> cellRef2, CellRef<? extends TransactionDescr> cellRef3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f2053lt = uLong.m2000unboximpl();
        this.prevTransHash = bitString2;
        this.prevTransLt = uLong2.m2000unboximpl();
        this.now = uInt.m1978unboximpl();
        this.outMsgCnt = i2;
        this.origStatus = accountStatus;
        this.endStatus = accountStatus2;
        this.f2054r1 = cellRef;
    ...
    public static final /* synthetic */ void write$Self(Transaction transaction, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uLongSerializer, ULong.m1995boximpl(transaction.f2053lt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, fiftHexBitStringSerializer, transaction.prevTransHash);
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, uLongSerializer, ULong.m1995boximpl(transaction.prevTransLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 4, UIntSerializer.INSTANCE, UInt.m1973boximpl(transaction.now));
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 8, kSerializerArr[8], transaction.f2054r1);
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("lt", ULong.m1995boximpl(this.f2053lt));
        open.field("prev_trans_hash", this.prevTransHash);
        open.field("prev_trans_lt", ULong.m1995boximpl(this.prevTransLt));
        open.field("now", UInt.m1973boximpl(this.now));
