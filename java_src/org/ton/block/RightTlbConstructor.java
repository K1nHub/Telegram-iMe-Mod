...
public final class RightTlbConstructor<X, Y> extends org.ton.tlb.TlbConstructor<Either.Right<X, Y>> {
    ...
    /* renamed from: ID */
    private static final BitString f2065ID;

    /* renamed from: y */
    private final TlbCodec<Y> f2066y;

    static {
        new Companion(null);
        f2065ID = BitString.Companion.m42of(Arrays.copyOf(new boolean[]{true}, 1));
    }
    ...
    public RightTlbConstructor(TlbCodec<Y> y) {
        super("right$1 {X:Type} {Y:Type} value:Y = Either X Y;", f2065ID);
    ...
    public void storeTlb(CellBuilder cellBuilder, Either.Right<X, Y> value) {
        ...
        this.f2066y.storeTlb(cellBuilder, value.getValue());
    }

    @Override // org.ton.tlb.TlbConstructor, org.ton.tlb.TlbLoader
    public Either.Right<X, Y> loadTlb(CellSlice cellSlice) {
        Intrinsics.checkNotNullParameter(cellSlice, "cellSlice");
        return new Either.Right<>(this.f2066y.loadTlb(cellSlice));
    }
