...
public final class FsmSplitTlbConstructor extends org.ton.tlb.TlbConstructor<FutureSplitMerge.FsmSplit> {
    ...
    public void storeTlb(CellBuilder cellBuilder, FutureSplitMerge.FsmSplit value) {
        ...
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5280getSplitUtimepVg5ArA());
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5279getIntervalpVg5ArA());
    }

    @Override // org.ton.tlb.TlbConstructor, org.ton.tlb.TlbLoader
    public FutureSplitMerge.FsmSplit loadTlb(CellSlice cellSlice) {
        Intrinsics.checkNotNullParameter(cellSlice, "cellSlice");
        return new FutureSplitMerge.FsmSplit(cellSlice.mo5387loadUInt32pVg5ArA(), cellSlice.mo5387loadUInt32pVg5ArA(), null);
    }
}
