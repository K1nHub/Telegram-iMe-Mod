...
public final class MsgDiscardFinTlbConstructor extends org.ton.tlb.TlbConstructor<MsgDiscardFin> {
    ...
    public void storeTlb(CellBuilder cellBuilder, MsgDiscardFin value) {
        ...
        cellBuilder.mo5057storeUInt64VKZWuLQ(value.m4972getTransactionIdsVKNKU());
    ...
    public MsgDiscardFin loadTlb(CellSlice cellSlice) {
        ...
        return new MsgDiscardFin(CellRef.Companion.valueOf(cellSlice.loadRef(), (TlbCodec) companion), cellSlice.mo5067loadUInt64sVKNKU(), Coins.Companion.loadTlb(cellSlice), null);
    }
}
