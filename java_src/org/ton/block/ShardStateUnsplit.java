...
public final class ShardStateUnsplit implements ShardState {
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((this.globalId * 31) + this.shardId.hashCode()) * 31) + UInt.m1976hashCodeimpl(this.seqNo)) * 31) + this.vertSeqNo) * 31) + UInt.m1976hashCodeimpl(this.genUtime)) * 31) + ULong.m1998hashCodeimpl(this.genLt)) * 31) + UInt.m1976hashCodeimpl(this.minRefMcSeqno)) * 31) + this.outMsgQueueInfo.hashCode()) * 31;
        boolean z = this.beforeSplit;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((((((hashCode + i) * 31) + this.accounts.hashCode()) * 31) + this.f2051r1.hashCode()) * 31) + this.custom.hashCode();
    }
    ...
    private ShardStateUnsplit(int i, int i2, ShardIdent shardIdent, UInt uInt, int i3, UInt uInt2, ULong uLong, UInt uInt3, CellRef<OutMsgQueueInfo> cellRef, boolean z, CellRef<ShardAccounts> cellRef2, CellRef<ShardStateUnsplitAux> cellRef3, Maybe<CellRef<McStateExtra>> maybe, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.genLt = uLong.m2000unboximpl();
        this.minRefMcSeqno = uInt3.m1978unboximpl();
        this.outMsgQueueInfo = cellRef;
        this.beforeSplit = z;
        this.accounts = cellRef2;
        this.f2051r1 = cellRef3;
        this.custom = maybe;
    }
    ...
    public static final /* synthetic */ void write$Self(ShardStateUnsplit shardStateUnsplit, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, uIntSerializer, UInt.m1973boximpl(shardStateUnsplit.seqNo));
        compositeEncoder.encodeIntElement(serialDescriptor, 3, shardStateUnsplit.vertSeqNo);
        compositeEncoder.encodeSerializableElement(serialDescriptor, 4, uIntSerializer, UInt.m1973boximpl(shardStateUnsplit.genUtime));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 5, ULongSerializer.INSTANCE, ULong.m1995boximpl(shardStateUnsplit.genLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 6, uIntSerializer, UInt.m1973boximpl(shardStateUnsplit.minRefMcSeqno));
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 10, kSerializerArr[10], shardStateUnsplit.f2051r1);
    ...
    public final int m5182getSeqNopVg5ArA() {
        return this.seqNo;
    }
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("gen_lt", ULong.m1995boximpl(this.genLt));
