...
public final class BlockInfo implements TlbObject {
    ...
    public int hashCode() {
        int m1977hashCodeimpl = UInt.m1977hashCodeimpl(this.version) * 31;
        boolean z = this.notMaster;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        int i2 = (m1977hashCodeimpl + i) * 31;
        ...
        int hashCode = (((((((((((((((((((((((i14 + (z8 ? 1 : z8 ? 1 : 0)) * 31) + this.flags) * 31) + this.seqNo) * 31) + this.vertSeqNo) * 31) + this.shard.hashCode()) * 31) + UInt.m1977hashCodeimpl(this.genUtime)) * 31) + ULong.m1999hashCodeimpl(this.startLt)) * 31) + ULong.m1999hashCodeimpl(this.endLt)) * 31) + UInt.m1977hashCodeimpl(this.genValidatorListHashShort)) * 31) + UInt.m1977hashCodeimpl(this.genCatchainSeqno)) * 31) + UInt.m1977hashCodeimpl(this.minRefMcSeqno)) * 31) + UInt.m1977hashCodeimpl(this.prevKeyBlockSeqno)) * 31;
    ...
    private BlockInfo(int i, UInt uInt, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, int i2, int i3, int i4, ShardIdent shardIdent, UInt uInt2, ULong uLong, ULong uLong2, UInt uInt3, UInt uInt4, UInt uInt5, UInt uInt6, GlobalVersion globalVersion, CellRef<BlkMasterInfo> cellRef, CellRef<? extends BlkPrevInfo> cellRef2, CellRef<? extends BlkPrevInfo> cellRef3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.genUtime = uInt2.m1979unboximpl();
        this.startLt = uLong.m2001unboximpl();
        this.endLt = uLong2.m2001unboximpl();
        this.genValidatorListHashShort = uInt3.m1979unboximpl();
        this.genCatchainSeqno = uInt4.m1979unboximpl();
        this.minRefMcSeqno = uInt5.m1979unboximpl();
        this.prevKeyBlockSeqno = uInt6.m1979unboximpl();
    ...
    public static final /* synthetic */ void write$Self(BlockInfo blockInfo, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, uIntSerializer, UInt.m1974boximpl(blockInfo.version));
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 13, uIntSerializer, UInt.m1974boximpl(blockInfo.genUtime));
        ULongSerializer uLongSerializer = ULongSerializer.INSTANCE;
        compositeEncoder.encodeSerializableElement(serialDescriptor, 14, uLongSerializer, ULong.m1996boximpl(blockInfo.startLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 15, uLongSerializer, ULong.m1996boximpl(blockInfo.endLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 16, uIntSerializer, UInt.m1974boximpl(blockInfo.genValidatorListHashShort));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 17, uIntSerializer, UInt.m1974boximpl(blockInfo.genCatchainSeqno));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 18, uIntSerializer, UInt.m1974boximpl(blockInfo.minRefMcSeqno));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 19, uIntSerializer, UInt.m1974boximpl(blockInfo.prevKeyBlockSeqno));
    ...
    public final int m5261getVersionpVg5ArA() {
        return this.version;
    }
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("gen_utime", UInt.m1974boximpl(this.genUtime));
        open.field("start_lt", ULong.m1996boximpl(this.startLt));
        open.field("end_lt", ULong.m1996boximpl(this.endLt));
        open.field("gen_validator_list_hash_short", UInt.m1974boximpl(this.genValidatorListHashShort));
        open.field("gen_catchain_seqno", UInt.m1974boximpl(this.genCatchainSeqno));
        open.field("min_ref_mc_seqno", UInt.m1974boximpl(this.minRefMcSeqno));
        open.field("prevKeyBlockSeqno", UInt.m1974boximpl(this.prevKeyBlockSeqno));
