...
public final class EnqueuedMsg implements TlbObject {
    ...
    public int hashCode() {
        return (ULong.m1999hashCodeimpl(this.enqueuedLt) * 31) + this.outMsg.hashCode();
    }

    public String toString() {
        return "EnqueuedMsg(enqueuedLt=" + ((Object) ULong.m2000toStringimpl(this.enqueuedLt)) + ", outMsg=" + this.outMsg + ')';
    }
    ...
    private EnqueuedMsg(int i, ULong uLong, CellRef<MsgEnvelope> cellRef, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.enqueuedLt = uLong.m2001unboximpl();
        this.outMsg = cellRef;
    }
    ...
    public static final /* synthetic */ void write$Self(EnqueuedMsg enqueuedMsg, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, ULongSerializer.INSTANCE, ULong.m1996boximpl(enqueuedMsg.enqueuedLt));
    ...
    public final long m5272getEnqueuedLtsVKNKU() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("enqueued_lt", ULong.m1996boximpl(this.enqueuedLt));
