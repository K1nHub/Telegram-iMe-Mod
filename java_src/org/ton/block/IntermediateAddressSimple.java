...
public final class IntermediateAddressSimple implements IntermediateAddress {
    ...
    public String toString() {
        return "IntermediateAddressSimple(workchainId=" + this.workchainId + ", addrPfx=" + ((Object) ULong.m1999toStringimpl(this.addrPfx)) + ')';
    }
    ...
    public static final /* synthetic */ void write$Self(IntermediateAddressSimple intermediateAddressSimple, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ULongSerializer.INSTANCE, ULong.m1995boximpl(intermediateAddressSimple.addrPfx));
    }
    ...
    public final long m5100getAddrPfxsVKNKU() {
        return this.addrPfx;
    }
