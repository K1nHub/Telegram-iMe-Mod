...
public final class ShardStateUnsplitTlbConstructor extends org.ton.tlb.TlbConstructor<ShardStateUnsplit> {
    ...
    public void storeTlb(CellBuilder cellBuilder, ShardStateUnsplit value) {
        ...
        cellBuilder.storeUInt(value.m5367getSeqNopVg5ArA(), 32);
        cellBuilder.storeInt(value.getVertSeqNo(), 32);
        cellBuilder.storeUInt(value.m5365getGenUtimepVg5ArA(), 32);
        cellBuilder.storeUInt(value.m5364getGenLtsVKNKU(), 64);
        cellBuilder.storeUInt(value.m5366getMinRefMcSeqnopVg5ArA(), 32);
    ...
    public ShardStateUnsplit loadTlb(CellSlice cellSlice) {
        ...
        int m1975constructorimpl = UInt.m1975constructorimpl(cellSlice.loadUInt(32).intValue());
        int intValue2 = cellSlice.loadInt(32).intValue();
        int m1975constructorimpl2 = UInt.m1975constructorimpl(cellSlice.loadUInt(32).intValue());
        long m1997constructorimpl = ULong.m1997constructorimpl(cellSlice.loadUInt(64).longValue());
        int m1975constructorimpl3 = UInt.m1975constructorimpl(cellSlice.loadUInt(32).intValue());
