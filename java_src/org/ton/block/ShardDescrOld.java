...
public final class ShardDescrOld implements ShardDescr {
    ...
    private static final KSerializer<Object>[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new SealedClassSerializer("org.ton.block.FutureSplitMerge", Reflection.getOrCreateKotlinClass(FutureSplitMerge.class), new KClass[]{Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmMerge.class), Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmNone.class), Reflection.getOrCreateKotlinClass(FutureSplitMerge.FsmSplit.class)}, new KSerializer[]{FutureSplitMerge$FsmMerge$$serializer.INSTANCE, new ObjectSerializer("fsm_none", FutureSplitMerge.FsmNone.INSTANCE, new Annotation[]{new C7785x18a57a5b("@type")}), FutureSplitMerge$FsmSplit$$serializer.INSTANCE}, new Annotation[]{new C7785x18a57a5b("@type")}), null, null};
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((i8 + (z5 ? 1 : z5 ? 1 : 0)) * 31) + this.flags) * 31) + UInt.m1977hashCodeimpl(this.nextCatchainSeqno)) * 31) + ULong.m1999hashCodeimpl(this.nextValidatorShard)) * 31) + UInt.m1977hashCodeimpl(this.minRefMcSeqno)) * 31) + UInt.m1977hashCodeimpl(this.genUtime)) * 31) + this.splitMergeAt.hashCode()) * 31) + this.feesCollected.hashCode()) * 31) + this.fundsCreated.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(ShardDescrOld shardDescrOld, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, uIntSerializer, UInt.m1974boximpl(shardDescrOld.seqNo));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uIntSerializer, UInt.m1974boximpl(shardDescrOld.regMcSeqno));
        ULongSerializer uLongSerializer = ULongSerializer.INSTANCE;
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, uLongSerializer, ULong.m1996boximpl(shardDescrOld.startLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, uLongSerializer, ULong.m1996boximpl(shardDescrOld.endLt));
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 12, uIntSerializer, UInt.m1974boximpl(shardDescrOld.nextCatchainSeqno));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 13, uLongSerializer, ULong.m1996boximpl(shardDescrOld.nextValidatorShard));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 14, uIntSerializer, UInt.m1974boximpl(shardDescrOld.minRefMcSeqno));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 15, uIntSerializer, UInt.m1974boximpl(shardDescrOld.genUtime));
