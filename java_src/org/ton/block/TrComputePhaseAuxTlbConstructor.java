...
public final class TrComputePhaseAuxTlbConstructor extends org.ton.tlb.TlbConstructor<TrComputePhaseAux> {
    ...
    static {
        ...
        MaybeInt32 = companion2.tlbCodec(IntTlbConstructor.Companion.m5421int(32));
    }
    ...
    public TrComputePhaseAux loadTlb(CellSlice cellSlice) {
        ...
        return new TrComputePhaseAux(tlbCodec.loadTlb(cellSlice), tlbCodec.loadTlb(cellSlice), MaybeVarUInteger3.loadTlb(cellSlice), cellSlice.loadInt(8).intValue(), cellSlice.loadInt(32).intValue(), MaybeInt32.loadTlb(cellSlice), cellSlice.mo5387loadUInt32pVg5ArA(), cellSlice.loadBits(256), cellSlice.loadBits(256), null);
    }
    ...
    public void storeTlb(CellBuilder cellBuilder, TrComputePhaseAux value) {
        ...
        cellBuilder.mo5377storeUInt32WZ4Q5Ns(value.m5370getVmStepspVg5ArA());
