...
public final class McBlockExtra implements TlbObject {
    ...
    /* renamed from: r1 */
    private final CellRef<McBlockExtraAux> f2063r1;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof McBlockExtra) {
            ...
            return this.keyBlock == mcBlockExtra.keyBlock && Intrinsics.areEqual(this.shardHashes, mcBlockExtra.shardHashes) && Intrinsics.areEqual(this.shardFees, mcBlockExtra.shardFees) && Intrinsics.areEqual(this.f2063r1, mcBlockExtra.f2063r1) && Intrinsics.areEqual(this.config, mcBlockExtra.config);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((r0 * 31) + this.shardHashes.hashCode()) * 31) + this.shardFees.hashCode()) * 31) + this.f2063r1.hashCode()) * 31;
    ...
    public static final /* synthetic */ void write$Self(McBlockExtra mcBlockExtra, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, kSerializerArr[3], mcBlockExtra.f2063r1);
