...
public final class McStateExtra implements TlbObject {
    ...
    /* renamed from: r1 */
    private final CellRef<McStateExtraAux> f2046r1;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof McStateExtra) {
            ...
            return ShardHashes.m5165equalsimpl0(this.shardHashes, mcStateExtra.shardHashes) && Intrinsics.areEqual(this.config, mcStateExtra.config) && Intrinsics.areEqual(this.f2046r1, mcStateExtra.f2046r1) && Intrinsics.areEqual(this.globalBalance, mcStateExtra.globalBalance);
        }
        return false;
    }

    public int hashCode() {
        return (((((ShardHashes.m5166hashCodeimpl(this.shardHashes) * 31) + this.config.hashCode()) * 31) + this.f2046r1.hashCode()) * 31) + this.globalBalance.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(McStateExtra mcStateExtra, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, ShardHashes$$serializer.INSTANCE, ShardHashes.m5162boximpl(mcStateExtra.shardHashes));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ConfigParams$$serializer.INSTANCE, mcStateExtra.config);
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, kSerializerArr[2], mcStateExtra.f2046r1);
    ...
    public final HashMapE<CellRef<? extends BinTree<ShardDescr>>> m5104getShardHashes78z5ENA() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("shard_hashes", ShardHashes.m5162boximpl(this.shardHashes));
        open.field("config", this.config);
        open.field(this.f2046r1);
