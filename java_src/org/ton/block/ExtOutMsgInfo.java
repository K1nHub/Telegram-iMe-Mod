...
public final class ExtOutMsgInfo implements CommonMsgInfo {
    ...
    private static final KSerializer<Object>[] $childSerializers = {new SealedClassSerializer("org.ton.block.MsgAddressInt", Reflection.getOrCreateKotlinClass(MsgAddressInt.class), new KClass[]{Reflection.getOrCreateKotlinClass(AddrStd.class), Reflection.getOrCreateKotlinClass(AddrVar.class)}, new KSerializer[]{AddrStd$$serializer.INSTANCE, AddrVar$$serializer.INSTANCE}, new Annotation[]{new C7551xb643addd("@type")}), new SealedClassSerializer("org.ton.block.MsgAddressExt", Reflection.getOrCreateKotlinClass(MsgAddressExt.class), new KClass[]{Reflection.getOrCreateKotlinClass(AddrExtern.class), Reflection.getOrCreateKotlinClass(AddrNone.class)}, new KSerializer[]{AddrExtern$$serializer.INSTANCE, new ObjectSerializer("addr_none", AddrNone.INSTANCE, new Annotation[]{new C7551xb643addd("@type")})}, new Annotation[]{new C7551xb643addd("@type")}), null, null};
    ...
    private ExtOutMsgInfo(int i, MsgAddressInt msgAddressInt, MsgAddressExt msgAddressExt, ULong uLong, UInt uInt, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.createdLt = uLong.m2000unboximpl();
        this.createdAt = uInt.m1978unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(ExtOutMsgInfo extOutMsgInfo, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, ULongSerializer.INSTANCE, ULong.m1995boximpl(extOutMsgInfo.createdLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, UIntSerializer.INSTANCE, UInt.m1973boximpl(extOutMsgInfo.createdAt));
    }
    ...
    public final long m5091getCreatedLtsVKNKU() {
        return this.createdLt;
    }

    /* renamed from: getCreatedAt-pVg5ArA  reason: not valid java name */
    public final int m5090getCreatedAtpVg5ArA() {
