...
public final class ExtOutMsgInfo implements CommonMsgInfo {
    ...
    private static final KSerializer<Object>[] $childSerializers = {new SealedClassSerializer("org.ton.block.MsgAddressInt", Reflection.getOrCreateKotlinClass(MsgAddressInt.class), new KClass[]{Reflection.getOrCreateKotlinClass(AddrStd.class), Reflection.getOrCreateKotlinClass(AddrVar.class)}, new KSerializer[]{AddrStd$$serializer.INSTANCE, AddrVar$$serializer.INSTANCE}, new Annotation[]{new C7743xb643addd("@type")}), new SealedClassSerializer("org.ton.block.MsgAddressExt", Reflection.getOrCreateKotlinClass(MsgAddressExt.class), new KClass[]{Reflection.getOrCreateKotlinClass(AddrExtern.class), Reflection.getOrCreateKotlinClass(AddrNone.class)}, new KSerializer[]{AddrExtern$$serializer.INSTANCE, new ObjectSerializer("addr_none", AddrNone.INSTANCE, new Annotation[]{new C7743xb643addd("@type")})}, new Annotation[]{new C7743xb643addd("@type")}), null, null};
    ...
    public int hashCode() {
        return (((((this.src.hashCode() * 31) + this.dest.hashCode()) * 31) + ULong.m1999hashCodeimpl(this.createdLt)) * 31) + UInt.m1977hashCodeimpl(this.createdAt);
    }
    ...
    private ExtOutMsgInfo(int i, MsgAddressInt msgAddressInt, MsgAddressExt msgAddressExt, ULong uLong, UInt uInt, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.createdLt = uLong.m2001unboximpl();
        this.createdAt = uInt.m1979unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(ExtOutMsgInfo extOutMsgInfo, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, ULongSerializer.INSTANCE, ULong.m1996boximpl(extOutMsgInfo.createdLt));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, UIntSerializer.INSTANCE, UInt.m1974boximpl(extOutMsgInfo.createdAt));
    }
    ...
    public final long m5276getCreatedLtsVKNKU() {
        return this.createdLt;
    }

    /* renamed from: getCreatedAt-pVg5ArA  reason: not valid java name */
    public final int m5275getCreatedAtpVg5ArA() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("created_lt", ULong.m1996boximpl(this.createdLt));
        open.field("created_at", UInt.m1974boximpl(this.createdAt));
