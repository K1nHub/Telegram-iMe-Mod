...
public final class ShardAccountTlbConstructor extends org.ton.tlb.TlbConstructor<ShardAccount> {
    ...
    public void storeTlb(CellBuilder cellBuilder, ShardAccount value) {
        ...
        cellBuilder.mo5378storeUInt64VKZWuLQ(value.m5315getLastTransLtsVKNKU());
    }
    ...
    public ShardAccount loadTlb(CellSlice cellSlice) {
        ...
        return new ShardAccount(CellRef.Companion.valueOf(cellSlice.loadRef(), (TlbCodec) companion), cellSlice.loadBits(256), cellSlice.mo5388loadUInt64sVKNKU(), null);
    }
}
