...
public final class KeyMaxLt implements TlbObject {
    ...
    public int hashCode() {
        ...
        return (r0 * 31) + ULong.m1999hashCodeimpl(this.maxEndLt);
    }
    ...
    private KeyMaxLt(int i, boolean z, ULong uLong, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.key = z;
        this.maxEndLt = uLong.m2001unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(KeyMaxLt keyMaxLt, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, ULongSerializer.INSTANCE, ULong.m1996boximpl(keyMaxLt.maxEndLt));
    }
    ...
    public final long m5286getMaxEndLtsVKNKU() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("max_end_lt", ULong.m1996boximpl(this.maxEndLt));
