...
public interface CommonMsgInfoRelaxed extends TlbObject {
    ...
    public static final class IntMsgInfoRelaxed implements CommonMsgInfoRelaxed {
        ...
        public int hashCode() {
            ...
            return ((((((((((((((i3 + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.src.hashCode()) * 31) + this.dest.hashCode()) * 31) + this.value.hashCode()) * 31) + this.ihrFee.hashCode()) * 31) + this.fwdFee.hashCode()) * 31) + ULong.m1991hashCodeimpl(this.createdLt)) * 31) + UInt.m1969hashCodeimpl(this.createdAt);
        }
        ...
        public final long m4946getCreatedLtsVKNKU() {
            return this.createdLt;
        }

        /* renamed from: getCreatedAt-pVg5ArA  reason: not valid java name */
        public final int m4945getCreatedAtpVg5ArA() {
    ...
    public static final class ExtOutMsgInfoRelaxed implements CommonMsgInfoRelaxed {
        ...
        /* renamed from: getCreatedLt-s-VKNKU  reason: not valid java name */
        public final long m4944getCreatedLtsVKNKU() {
            return this.createdLt;
        }

        /* renamed from: getCreatedAt-pVg5ArA  reason: not valid java name */
        public final int m4943getCreatedAtpVg5ArA() {
            return this.createdAt;
        }
