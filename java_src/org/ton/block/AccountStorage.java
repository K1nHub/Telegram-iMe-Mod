...
public final class AccountStorage implements TlbObject {
    ...
    public int hashCode() {
        return (((ULong.m1998hashCodeimpl(this.lastTransLt) * 31) + this.balance.hashCode()) * 31) + this.state.hashCode();
    }
    ...
    public static final /* synthetic */ void write$Self(AccountStorage accountStorage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, ULongSerializer.INSTANCE, ULong.m1995boximpl(accountStorage.lastTransLt));
