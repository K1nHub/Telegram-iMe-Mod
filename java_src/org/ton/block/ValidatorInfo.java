...
public final class ValidatorInfo implements TlbObject {
    ...
    public int hashCode() {
        int m1969hashCodeimpl = ((UInt.m1969hashCodeimpl(this.validatorListHashShort) * 31) + UInt.m1969hashCodeimpl(this.catchainSeqno)) * 31;
        boolean z = this.nxCcUpdated;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return m1969hashCodeimpl + i;
    }
    ...
    private ValidatorInfo(int i, UInt uInt, UInt uInt2, boolean z, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.validatorListHashShort = uInt.m1971unboximpl();
        this.catchainSeqno = uInt2.m1971unboximpl();
        this.nxCcUpdated = z;
    }
    ...
    public static final /* synthetic */ void write$Self(ValidatorInfo validatorInfo, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, uIntSerializer, UInt.m1966boximpl(validatorInfo.validatorListHashShort));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uIntSerializer, UInt.m1966boximpl(validatorInfo.catchainSeqno));
    ...
    public final int m5051getValidatorListHashShortpVg5ArA() {
        return this.validatorListHashShort;
    }

    /* renamed from: getCatchainSeqno-pVg5ArA  reason: not valid java name */
    public final int m5050getCatchainSeqnopVg5ArA() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("validator_list_hash_short", UInt.m1966boximpl(this.validatorListHashShort));
        open.field("catchain_seqno", UInt.m1966boximpl(this.catchainSeqno));
