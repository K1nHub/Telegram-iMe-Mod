...
public final class Counters implements TlbObject {
    ...
    public int hashCode() {
        return (((((UInt.m1977hashCodeimpl(this.lastUpdated) * 31) + ULong.m1999hashCodeimpl(this.total)) * 31) + ULong.m1999hashCodeimpl(this.cnt2048)) * 31) + ULong.m1999hashCodeimpl(this.cnt65536);
    }
    ...
    private Counters(int i, UInt uInt, ULong uLong, ULong uLong2, ULong uLong3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.lastUpdated = uInt.m1979unboximpl();
        this.total = uLong.m2001unboximpl();
        this.cnt2048 = uLong2.m2001unboximpl();
        this.cnt65536 = uLong3.m2001unboximpl();
    }
    ...
    public static final /* synthetic */ void write$Self(Counters counters, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.encodeSerializableElement(serialDescriptor, 0, UIntSerializer.INSTANCE, UInt.m1974boximpl(counters.lastUpdated));
        ULongSerializer uLongSerializer = ULongSerializer.INSTANCE;
        compositeEncoder.encodeSerializableElement(serialDescriptor, 1, uLongSerializer, ULong.m1996boximpl(counters.total));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 2, uLongSerializer, ULong.m1996boximpl(counters.cnt2048));
        compositeEncoder.encodeSerializableElement(serialDescriptor, 3, uLongSerializer, ULong.m1996boximpl(counters.cnt65536));
    }

    /* renamed from: getLastUpdated-pVg5ArA  reason: not valid java name */
    public final int m5270getLastUpdatedpVg5ArA() {
        return this.lastUpdated;
    }

    /* renamed from: getTotal-s-VKNKU  reason: not valid java name */
    public final long m5271getTotalsVKNKU() {
        return this.total;
    }

    /* renamed from: getCnt2048-s-VKNKU  reason: not valid java name */
    public final long m5268getCnt2048sVKNKU() {
        return this.cnt2048;
    }

    /* renamed from: getCnt65536-s-VKNKU  reason: not valid java name */
    public final long m5269getCnt65536sVKNKU() {
    ...
    public TlbPrettyPrinter print(TlbPrettyPrinter printer) {
        ...
        open.field("last_updated", UInt.m1974boximpl(this.lastUpdated));
        open.field("total", ULong.m1996boximpl(this.total));
        open.field("cnt2048", ULong.m1996boximpl(this.cnt2048));
        open.field("cnt65536", ULong.m1996boximpl(this.cnt65536));
