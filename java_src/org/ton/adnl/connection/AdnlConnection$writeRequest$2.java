...
public final class AdnlConnection$writeRequest$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            launch$default = BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.$callContext.plus(new CoroutineName("Request body writer"))), null, null, new C74951(this.this$0, this.$output, this.$cipher, this.$request, this.$closeChannel, null), 3, null);
    ...
    /* loaded from: classes6.dex */
    public static final class C74951 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ AesCtr $cipher;
        final /* synthetic */ boolean $closeChannel;
        final /* synthetic */ ByteWriteChannel $output;
        final /* synthetic */ AdnlRequestData $request;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C74951(AdnlConnection adnlConnection, ByteWriteChannel byteWriteChannel, AesCtr aesCtr, AdnlRequestData adnlRequestData, boolean z, Continuation<? super C74951> continuation) {
            super(2, continuation);
            this.this$0 = adnlConnection;
            this.$output = byteWriteChannel;
            this.$cipher = aesCtr;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C74951(this.this$0, this.$output, this.$cipher, this.$request, this.$closeChannel, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C74951) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
