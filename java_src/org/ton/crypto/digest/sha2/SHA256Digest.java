...
public final class SHA256Digest extends GeneralDigest {
    ...
    /* renamed from: x */
    private final int[] f2066x = new int[64];
    private int xOff;
    ...
    public byte[] build(byte[] output, int i) {
        ...
        m1912constructorimpl.putInt(i, this.f2058h1);
        m1912constructorimpl.putInt(i + 4, this.f2059h2);
        m1912constructorimpl.putInt(i + 8, this.f2060h3);
        m1912constructorimpl.putInt(i + 12, this.f2061h4);
        m1912constructorimpl.putInt(i + 16, this.f2062h5);
        m1912constructorimpl.putInt(i + 20, this.f2063h6);
        m1912constructorimpl.putInt(i + 24, this.f2064h7);
        m1912constructorimpl.putInt(i + 28, this.f2065h8);
        reset();
        return output;
    }
    ...
    public void reset() {
        super.reset();
        this.f2058h1 = 1779033703;
        this.f2059h2 = -1150833019;
        this.f2060h3 = 1013904242;
        this.f2061h4 = -1521486534;
        this.f2062h5 = 1359893119;
        this.f2063h6 = -1694144372;
        this.f2064h7 = 528734635;
        this.f2065h8 = 1541459225;
        this.xOff = 0;
        ArraysKt___ArraysJvmKt.fill$default(this.f2066x, 0, 0, 0, 6, (Object) null);
    }
    ...
    protected void processBlock() {
        ...
        int i8 = this.f2063h6;
        int i9 = this.f2064h7;
        int i10 = this.f2065h8;
        int i11 = 0;
        for (int i12 = 0; i12 < 8; i12++) {
            Sum1 = SHA256DigestKt.Sum1(i7);
            m28Ch = SHA256DigestKt.m28Ch(i7, i8, i9);
            int i13 = Sum1 + m28Ch;
            iArr = SHA256DigestKt.f2067k;
            int i14 = i10 + i13 + iArr[i11] + this.f2066x[i11];
            int i15 = i6 + i14;
            ...
            iArr2 = SHA256DigestKt.f2067k;
            int i19 = i9 + i18 + iArr2[i17] + this.f2066x[i17];
            int i20 = i5 + i19;
            ...
            iArr3 = SHA256DigestKt.f2067k;
            int i24 = i8 + i23 + iArr3[i22] + this.f2066x[i22];
            int i25 = i4 + i24;
            ...
            iArr4 = SHA256DigestKt.f2067k;
            int i29 = i7 + i28 + iArr4[i27] + this.f2066x[i27];
            int i30 = i3 + i29;
            ...
            iArr5 = SHA256DigestKt.f2067k;
            int i34 = i15 + i33 + iArr5[i32] + this.f2066x[i32];
            i10 = i16 + i34;
            ...
            iArr6 = SHA256DigestKt.f2067k;
            int i37 = i20 + i36 + iArr6[i35] + this.f2066x[i35];
            i9 = i21 + i37;
            ...
            iArr7 = SHA256DigestKt.f2067k;
            int i40 = i25 + i39 + iArr7[i38] + this.f2066x[i38];
            i8 = i26 + i40;
            ...
            iArr8 = SHA256DigestKt.f2067k;
            int i43 = i30 + i42 + iArr8[i41] + this.f2066x[i41];
            i7 = i31 + i43;
