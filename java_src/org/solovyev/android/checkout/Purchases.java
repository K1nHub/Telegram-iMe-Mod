...
public final class Purchases {
    ...
    public static List<Purchase> neutralize(List<Purchase> list) {
        ...
        while (!linkedList.isEmpty()) {
            ...
            int i = C31551.$SwitchMap$org$solovyev$android$checkout$Purchase$State[purchase.state.ordinal()];
            if (i == 1) {
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C31551 {
    ...
    private static boolean isNeutralized(List<Purchase> list, Purchase purchase) {
        ...
        for (int i = 1; i < list.size(); i++) {
            ...
            if (purchase2.sku.equals(purchase.sku)) {
                int i2 = C31551.$SwitchMap$org$solovyev$android$checkout$Purchase$State[purchase2.state.ordinal()];
                if (i2 == 1) {
