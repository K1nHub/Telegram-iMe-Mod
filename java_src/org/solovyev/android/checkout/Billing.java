...
public final class Billing {
    ...
    void setState(State state) {
        synchronized (this.mLock) {
            ...
            sb.append(" state");
            this.mState = state;
            int i = C32197.$SwitchMap$org$solovyev$android$checkout$Billing$State[state.ordinal()];
            if (i == 1) {
        ...
        if (this.mCache.hasCache()) {
            requestListener = new RequestListenerWrapper<Purchase>(requestListener) { // from class: org.solovyev.android.checkout.Billing.6
                ...
                public void onSuccess(Purchase purchase) {
                    Billing.this.mCache.removeAll(RequestType.GET_PURCHASES.getCacheKeyType());
                    super.onSuccess((C32186) purchase);
                }
            };
        }
    ...
    public class CachingRequestListener<R> extends RequestListenerWrapper<R> {
        ...
        public void onSuccess(R r) {
            ...
            int i = C32197.$SwitchMap$org$solovyev$android$checkout$RequestType[type.ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                Billing.this.mCache.removeAll(RequestType.GET_PURCHASES.getCacheKeyType());
            }
            super.onSuccess(r);
        ...
        @Override // org.solovyev.android.checkout.RequestListenerWrapper, org.solovyev.android.checkout.RequestListener
        public void onError(int i, Exception exc) {
            int i2 = C32197.$SwitchMap$org$solovyev$android$checkout$RequestType[this.mRequest.getType().ordinal()];
            if (i2 == 1 || i2 == 2) {
                if (i == 7) {
                    Billing.this.mCache.removeAll(RequestType.GET_PURCHASES.getCacheKeyType());
                }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C32197 {
