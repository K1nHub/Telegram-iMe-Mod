...
public final class Scope {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Scope) {
            ...
            return Intrinsics.areEqual(this.scopeQualifier, scope.scopeQualifier) && Intrinsics.areEqual(this.f1423id, scope.f1423id) && this.isRoot == scope.isRoot && Intrinsics.areEqual(this._koin, scope._koin);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.scopeQualifier.hashCode() * 31) + this.f1423id.hashCode()) * 31;
    ...
    */
    ...
    public final <T> T resolveInstance(Qualifier qualifier, KClass<?> kClass, Function0<? extends ParametersHolder> function0) {
        if (this._closed) {
            throw new ClosedScopeException("Scope '" + this.f1423id + "' is closed");
        }
