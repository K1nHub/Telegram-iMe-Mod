...
public final class Scope {
    ...
    */
    ...
    private final <T> T resolveInstance(Qualifier qualifier, KClass<?> kClass, Function0<? extends ParametersHolder> function0) {
        ...
        if (invoke != null) {
            ...
            KoinPlatformTools.INSTANCE.m2172synchronized(this, new Function0<Unit>() { // from class: org.koin.core.scope.Scope$resolveInstance$2
        ...
        if (invoke != null) {
            ...
            KoinPlatformTools.INSTANCE.m2172synchronized(this, new Function0<ParametersHolder>() { // from class: org.koin.core.scope.Scope$resolveInstance$3
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
        ...
        if (t == null) {
            ...
            if (t == null) {
                ...
                if (t == null) {
                    ...
                    if (t == null) {
                        KoinPlatformTools.INSTANCE.m2172synchronized(this, new Function0<Unit>() { // from class: org.koin.core.scope.Scope$resolveValue$4$1
                            /* JADX INFO: Access modifiers changed from: package-private */
                            {
                                super(0);
                            }
    ...
    */
    ...
    public final void close() {
        KoinPlatformTools.INSTANCE.m2172synchronized(this, new Function0<Unit>() { // from class: org.koin.core.scope.Scope$close$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
