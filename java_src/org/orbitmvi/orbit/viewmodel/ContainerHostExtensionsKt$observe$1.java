...
@DebugMetadata(m148c = "org.orbitmvi.orbit.viewmodel.ContainerHostExtensionsKt$observe$1", m147f = "ContainerHostExtensions.kt", m146l = {50}, m145m = "invokeSuspend")
...
public final class ContainerHostExtensionsKt$observe$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C35391 c35391 = new C35391(this.$state, this.$sideEffect, this.$this_observe, null);
            this.label = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(lifecycle, state, c35391, this) == coroutine_suspended) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: ContainerHostExtensions.kt */
    @DebugMetadata(m148c = "org.orbitmvi.orbit.viewmodel.ContainerHostExtensionsKt$observe$1$1", m147f = "ContainerHostExtensions.kt", m146l = {}, m145m = "invokeSuspend")
    /* renamed from: org.orbitmvi.orbit.viewmodel.ContainerHostExtensionsKt$observe$1$1 */
    /* loaded from: classes4.dex */
    public static final class C35391 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function2<SIDE_EFFECT, Continuation<? super Unit>, Object> $sideEffect;
        final /* synthetic */ Function2<STATE, Continuation<? super Unit>, Object> $state;
        final /* synthetic */ ContainerHost<STATE, SIDE_EFFECT> $this_observe;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C35391(Function2<? super STATE, ? super Continuation<? super Unit>, ? extends Object> function2, Function2<? super SIDE_EFFECT, ? super Continuation<? super Unit>, ? extends Object> function22, ContainerHost<STATE, SIDE_EFFECT> containerHost, Continuation<? super C35391> continuation) {
            super(2, continuation);
            this.$state = function2;
            this.$sideEffect = function22;
            this.$this_observe = containerHost;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C35391 c35391 = new C35391(this.$state, this.$sideEffect, this.$this_observe, continuation);
            c35391.L$0 = obj;
            return c35391;
        }
