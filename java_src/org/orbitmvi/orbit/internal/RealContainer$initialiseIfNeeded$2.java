...
@DebugMetadata(m148c = "org.orbitmvi.orbit.internal.RealContainer$initialiseIfNeeded$2", m147f = "RealContainer.kt", m146l = {98}, m145m = "invokeSuspend")
...
public final class RealContainer$initialiseIfNeeded$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: RealContainer.kt */
    @DebugMetadata(m148c = "org.orbitmvi.orbit.internal.RealContainer$initialiseIfNeeded$2$1", m147f = "RealContainer.kt", m146l = {99}, m145m = "invokeSuspend")
    /* renamed from: org.orbitmvi.orbit.internal.RealContainer$initialiseIfNeeded$2$1 */
    /* loaded from: classes4.dex */
    public static final class C35361 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C35361(Function2<? super ContainerContext<STATE, SIDE_EFFECT>, ? super Continuation<? super Unit>, ? extends Object> function2, RealContainer<STATE, SIDE_EFFECT> realContainer, Continuation<? super C35361> continuation) {
            super(2, continuation);
            this.$msg = function2;
            this.this$0 = realContainer;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C35361(this.$msg, this.this$0, continuation);
        }
