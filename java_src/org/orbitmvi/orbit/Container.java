...
public interface Container<STATE, SIDE_EFFECT> {
    ...
    public static final class Settings {
        ...
        public int hashCode() {
            ...
            return ((hashCode + (coroutineExceptionHandler == null ? 0 : coroutineExceptionHandler.hashCode())) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.repeatOnSubscribedStopTimeout);
        }
