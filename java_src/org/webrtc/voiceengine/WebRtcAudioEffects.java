...
public class WebRtcAudioEffects {
    ...
    /* renamed from: ns */
    private NoiseSuppressor f2134ns;
    ...
    public boolean setNS(boolean z) {
        ...
        if (!canUseNoiseSuppressor()) {
            ...
            return false;
        } else if (this.f2134ns != null && z != this.shouldEnableNs) {
    ...
    public void enable(int i) {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            if (create2 != null) {
                ...
                sb2.append(z);
                sb2.append(", is now: ");
                sb2.append(this.f2134ns.getEnabled() ? "enabled" : "disabled");
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f2134ns;
