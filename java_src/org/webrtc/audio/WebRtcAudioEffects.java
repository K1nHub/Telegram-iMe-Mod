...
class WebRtcAudioEffects {
    ...
    /* renamed from: ns */
    private NoiseSuppressor f1919ns;
    ...
    public boolean setNS(boolean z) {
        ...
        if (!isNoiseSuppressorSupported()) {
            ...
            return false;
        } else if (this.f1919ns != null && z != this.shouldEnableNs) {
    ...
    public void enable(int i) {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            if (create2 != null) {
                ...
                sb2.append(z);
                sb2.append(", is now: ");
                sb2.append(this.f1919ns.getEnabled() ? "enabled" : "disabled");
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f1919ns;
