...
public class FilterCreateActivity extends JavaMvpFragment {
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(FilterCreateActivity filterCreateActivity, Context context) {
            ...
            if (filterActivityType == filterActivityType2) {
                this.imageView.setAnimation(C3158R.C3164raw.fork_topic_new, 125, 125);
            } else {
                this.imageView.setAnimation(C3158R.C3164raw.filter_new, 100, 100);
            }
    ...
    public FilterCreateActivity(MessagesController.DialogFilter dialogFilter, ArrayList<Long> arrayList, TopicModel topicModel, Set<Long> set, FilterActivityType filterActivityType) {
        ...
        if (dialogFilter == null) {
            ...
            dialogFilter3.f1434id = 2;
            while (getMessagesController().dialogFiltersById.get(this.filter.f1434id) != null) {
                this.filter.f1434id++;
            }
            this.filter.name = "";
            this.creatingNew = true;
        }
        this.newFilterSettings = getFiltersController().getSettings(this.filter.f1434id).getCopy();
    ...
    public View createView(Context context) {
        ...
        if (this.creatingNew) {
            if (this.type == FilterActivityType.TOPIC) {
                this.actionBar.setTitle(LocaleController.getInternalString(C3158R.string.topic_new));
            } else {
                this.actionBar.setTitle(LocaleController.getString("FilterNew", C3158R.string.FilterNew));
            }
        } else {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3222ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.FilterCreateActivity.1
        ...
        this.doneItem = createMenu.addItem(1, LocaleController.getString("Save", C3158R.string.Save).toUpperCase());
    ...
    public /* synthetic */ void lambda$createView$6(View view, final int i, float f, float f2) {
        ...
        if (i == this.includeShowMoreRow) {
            ...
            if (i == i2 || i == this.excludeAddRow) {
                ...
                builder.setPositiveButton(LocaleController.getString("Delete", C3158R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda2
    ...
    public /* synthetic */ void lambda$createView$5(DialogInterface dialogInterface, int i) {
        ...
        tLRPC$TL_messages_updateDialogFilter.f1604id = this.filter.f1434id;
            ...
            if (TextUtils.isEmpty(this.newFilterName) || !this.nameChangedManually) {
                ...
                if ((i3 & i2) == i2) {
                    if ((MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_READ & i) != 0) {
                        string = LocaleController.getString("FilterNameUnread", C3158R.string.FilterNameUnread);
                    } else {
                        if ((i & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED) != 0) {
                            string = LocaleController.getString("FilterNameNonMuted", C3158R.string.FilterNameNonMuted);
                        }
                        string = "";
                    }
                } else {
                    ...
                    if ((i3 & i4) != 0) {
                        if (((~i4) & i3) == 0) {
                            string = LocaleController.getString("FilterContacts", C3158R.string.FilterContacts);
                        }
                        string = "";
                    } else {
                        ...
                        if ((i3 & i5) != 0) {
                            if (((~i5) & i3) == 0) {
                                string = LocaleController.getString("FilterNonContacts", C3158R.string.FilterNonContacts);
                            }
                            string = "";
                        } else {
                            ...
                            if ((i3 & i6) != 0) {
                                if (((~i6) & i3) == 0) {
                                    string = LocaleController.getString("FilterGroups", C3158R.string.FilterGroups);
                                }
                                string = "";
                            } else {
                                ...
                                if ((i3 & i7) != 0) {
                                    if (((~i7) & i3) == 0) {
                                        string = LocaleController.getString("FilterBots", C3158R.string.FilterBots);
                                    }
                                    string = "";
                                } else {
                                    int i8 = MessagesController.DIALOG_FILTER_FLAG_CHANNELS;
                                    if ((i3 & i8) != 0 && ((~i8) & i3) == 0) {
                                        string = LocaleController.getString("FilterChannels", C3158R.string.FilterChannels);
                                    }
                                    string = "";
                                }
                            }
    ...
    public boolean checkDiscard() {
        if (this.doneItem.getAlpha() == 1.0f) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            if (this.creatingNew) {
                builder.setTitle(LocaleController.getString("FilterDiscardNewTitle", C3158R.string.FilterDiscardNewTitle));
                builder.setMessage(LocaleController.getString("FilterDiscardNewAlert", C3158R.string.FilterDiscardNewAlert));
                if (this.type == FilterActivityType.TOPIC) {
                    builder.setTitle(LocaleController.getInternalString(C3158R.string.topic_create_discard_title));
                    builder.setMessage(LocaleController.getInternalString(C3158R.string.topic_create_discard_message));
                }
                builder.setPositiveButton(LocaleController.getString("FilterDiscardNewSave", C3158R.string.FilterDiscardNewSave), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                ...
                builder.setTitle(LocaleController.getString("FilterDiscardTitle", C3158R.string.FilterDiscardTitle));
                if (this.type == FilterActivityType.TOPIC) {
                    builder.setMessage(LocaleController.getInternalString(C3158R.string.topic_edit_discard_message));
                } else {
                    builder.setMessage(LocaleController.getString("FilterDiscardAlert", C3158R.string.FilterDiscardAlert));
                }
                builder.setPositiveButton(LocaleController.getString("ApplyTheme", C3158R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda3
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder.setNegativeButton(LocaleController.getString("PassportDiscard", C3158R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showRemoveAlert(final int i, CharSequence charSequence, Object obj, final boolean z) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        if (z) {
            builder.setTitle(LocaleController.getString("FilterRemoveInclusionTitle", C3158R.string.FilterRemoveInclusionTitle));
            if (obj instanceof String) {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionText", C3158R.string.FilterRemoveInclusionText, charSequence));
            } else if (obj instanceof TLRPC$User) {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionUserText", C3158R.string.FilterRemoveInclusionUserText, charSequence));
            } else {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionChatText", C3158R.string.FilterRemoveInclusionChatText, charSequence));
            }
        } else {
            builder.setTitle(LocaleController.getString("FilterRemoveExclusionTitle", C3158R.string.FilterRemoveExclusionTitle));
            if (obj instanceof String) {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionText", C3158R.string.FilterRemoveExclusionText, charSequence));
            } else if (obj instanceof TLRPC$User) {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionUserText", C3158R.string.FilterRemoveExclusionUserText, charSequence));
            } else {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionChatText", C3158R.string.FilterRemoveExclusionChatText, charSequence));
            }
        }
        if (this.type == FilterActivityType.TOPIC) {
            builder.setTitle(LocaleController.getInternalString(C3158R.string.topic_remove_chat_title));
            builder.setMessage(LocaleController.formatStringInternal(C3158R.string.topic_remove_chat_message, charSequence));
        }
        builder.setNegativeButton(LocaleController.getString("Cancel", C3158R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("StickersRemove", C3158R.string.StickersRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda4
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public static void saveFilterToServer(final MessagesController.DialogFilter dialogFilter, final int i, final String str, final ArrayList<Long> arrayList, final ArrayList<Long> arrayList2, final LongSparseIntArray longSparseIntArray, final boolean z, final boolean z2, final boolean z3, final boolean z4, final boolean z5, final BaseFragment baseFragment, final Runnable runnable) {
        ...
        tLRPC$TL_dialogFilter.f1501id = dialogFilter.f1434id;
    ...
    private boolean hasChanges() {
        ...
        if (filterActivityType == FilterActivityType.TOPIC) {
            ...
            FilterSettingsModel copy = getFiltersController().getSettings(this.filter.f1434id).getCopy();
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onViewAttachedToWindow(RecyclerView.ViewHolder viewHolder) {
            if (viewHolder.getItemViewType() == 2) {
                ...
                pollEditTextCell.setTag(1);
                pollEditTextCell.setTextAndHint(FilterCreateActivity.this.newFilterName != null ? FilterCreateActivity.this.newFilterName : "", LocaleController.getString("FilterNameHint", C3158R.string.FilterNameHint), false);
                if (FilterCreateActivity.this.type == FilterActivityType.TOPIC) {
                    pollEditTextCell.setHint(LocaleController.getInternalString(C3158R.string.topic_name_hint));
                }
                pollEditTextCell.setTag(null);
            }
        }
