...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int i) {
        ...
        rLottieImageView.setAnimation(C3286R.C3291raw.db_migration_placeholder, ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        ...
        this.title.setText(LocaleController.getString("OptimizingTelegram", C3286R.string.OptimizingTelegram));
        ...
        this.description1.setText(LocaleController.getString("OptimizingTelegramDescription1", C3286R.string.OptimizingTelegramDescription1));
        ...
        this.description2.setText(LocaleController.getString("OptimizingTelegramDescription2", C3286R.string.OptimizingTelegramDescription2));
