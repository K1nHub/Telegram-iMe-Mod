...
public class PasscodeActivity extends JavaWalletAuthFragment implements CreateWalletPasswordView, CreateWalletPinView, EnterWalletPasswordView, NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ BaseFragment lambda$goToBackUpTutorial$1(String str, String str2, String str3) {
        return CreateWalletFragment.newInstance(new CreateWalletFragment.ScreenType.SecretWords(Arrays.asList(str.split(" ")), "", str2, str3, false));
    }
    ...
    private void showForgotPasswordOptionsDialog() {
        ...
        builder.setItems(new CharSequence[]{LocaleController.getInternalString(C3158R.string.wallet_enter_eth_password_forgot_option_restore), LocaleController.getInternalString(C3158R.string.wallet_enter_eth_password_forgot_option_delete)}, new int[]{C3158R.C3160drawable.fork_ic_eth_wallet_restore, C3158R.C3160drawable.msg_delete}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PasscodeActivity$$ExternalSyntheticLambda3
    ...
    */
    ...
    public /* synthetic */ void lambda$createView$11(View view, final int i) {
        if (view.isEnabled()) {
            if (i == this.disablePasscodeRow) {
                AlertDialog create = new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString(C3158R.string.DisablePasscode)).setMessage(LocaleController.getString(C3158R.string.DisablePasscodeConfirmMessage)).setNegativeButton(LocaleController.getString(C3158R.string.Cancel), null).setPositiveButton(LocaleController.getString(C3158R.string.DisablePasscodeTurnOff), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PasscodeActivity$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                ...
                builder.setTitle(LocaleController.getString("AutoLock", C3158R.string.AutoLock));
                ...
                builder.setNegativeButton(LocaleController.getString("Done", C3158R.string.Done), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PasscodeActivity$$ExternalSyntheticLambda4
                    @Override // android.content.DialogInterface.OnClickListener
                ...
                AlertsCreator.showSimpleAlert(this, LocaleController.getString("ScreenCaptureAlert", C3158R.string.ScreenCaptureAlert));
            }
        }
    }
    ...
    public static /* synthetic */ String lambda$createView$9(int i) {
        if (i == 0) {
            return LocaleController.getString("AutoLockDisabled", C3158R.string.AutoLockDisabled);
        }
        return i == 1 ? LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 1, new Object[0])) : i == 2 ? LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 5, new Object[0])) : i == 3 ? LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 1, new Object[0])) : i == 4 ? LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 5, new Object[0])) : "";
    }
    ...
    /* loaded from: classes5.dex */
    public class C58624 extends C3222ActionBar.ActionBarMenuOnItemClick {
        final /* synthetic */ ActionBarMenuSubItem val$switchItem;

        C58624(ActionBarMenuSubItem actionBarMenuSubItem) {
        ...
        public void onItemClick(int i) {
            ...
            if (i == 1) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.PasscodeActivity$4$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        PasscodeActivity.C58624.this.lambda$onItemClick$0(actionBarMenuSubItem);
                    }
                }, 150L);
        ...
        public /* synthetic */ void lambda$onItemClick$0(ActionBarMenuSubItem actionBarMenuSubItem) {
            actionBarMenuSubItem.setText(LocaleController.getString(PasscodeActivity.this.currentPasswordType == 0 ? C3158R.string.PasscodeSwitchToPassword : C3158R.string.PasscodeSwitchToPIN));
            actionBarMenuSubItem.setIcon(PasscodeActivity.this.currentPasswordType == 0 ? C3158R.C3160drawable.msg_permissions : C3158R.C3160drawable.msg_pin_code);
    ...
    /* loaded from: classes5.dex */
    public class C58668 extends CodeFieldContainer {
        C58668(Context context) {
            super(context);
        }
        ...
        protected void processNextPressed() {
            ...
            postDelayed(new Runnable() { // from class: org.telegram.ui.PasscodeActivity$8$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    PasscodeActivity.C58668.this.lambda$processNextPressed$0();
                }
            }, 260L);
        }
    ...
    public void updateFields() {
        ...
        if (this.type == 2) {
            charSequence = LocaleController.getString(C3158R.string.EnterYourPasscodeInfo);
        } else if (this.passcodeSetStep == 0) {
            int i = this.screenType;
            if (i == 1) {
                charSequence = LocaleController.getInternalString(C3158R.string.wallet_create_eth_password_description);
            } else if (i == 0) {
                charSequence = LocaleController.getInternalString(C3158R.string.wallet_create_eth_pin_code_description);
            } else if (i == 3) {
                charSequence = LocaleController.getInternalString(C3158R.string.wallet_enter_eth_password_description);
            } else {
                charSequence = LocaleController.getString(this.currentPasswordType == 0 ? C3158R.string.CreatePasscodeInfoPIN : C3158R.string.CreatePasscodeInfoPassword);
            }
        } else {
        ...
        if (this.type == 2) {
            this.descriptionTextSwitcher.setText(LocaleController.getString(C3158R.string.EnterYourPasscodeInfo), z2);
        } else if (this.passcodeSetStep == 0) {
            if (isWalletScreen()) {
                this.descriptionTextSwitcher.setText(charSequence, z2);
            } else {
                this.descriptionTextSwitcher.setText(LocaleController.getString(this.currentPasswordType == 0 ? C3158R.string.CreatePasscodeInfoPIN : C3158R.string.CreatePasscodeInfoPassword), z2);
            }
        }
        if (isPinCode()) {
    ...
    public void processNext() {
        ...
        if (i2 == 1) {
            this.titleTextView.setText(LocaleController.getInternalString(C3158R.string.wallet_confirm_eth_password_title));
        } else if (i2 == 0) {
            this.titleTextView.setText(LocaleController.getInternalString(C3158R.string.wallet_confirm_eth_pin_code_title));
        } else {
            this.titleTextView.setText(LocaleController.getString("ConfirmCreatePasscode", C3158R.string.ConfirmCreatePasscode));
        }
        int i3 = this.screenType;
        if (i3 == 1) {
            this.descriptionTextSwitcher.setText(LocaleController.getInternalString(C3158R.string.wallet_confirm_eth_password_description));
        } else if (i3 == 0) {
            this.descriptionTextSwitcher.setText(LocaleController.getInternalString(C3158R.string.wallet_confirm_eth_pin_code_description));
        } else {
            this.descriptionTextSwitcher.setText(AndroidUtilities.replaceTags(LocaleController.getString("PasscodeReinstallNotice", C3158R.string.PasscodeReinstallNotice)));
        }
    ...
    public /* synthetic */ void lambda$processDone$25() {
        this.codeFieldContainer.postDelayed(this.hidePasscodesDoNotMatch, C0474C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
            ...
            if (itemViewType == 0) {
                ...
                if (i == PasscodeActivity.this.fingerprintRow) {
                    if (PasscodeActivity.this.sectionPasscodeData != null) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", C3158R.string.UnlockFingerprint), PasscodeActivity.this.sectionPasscodeData.getUseFingerprint(), true);
                    } else if (PasscodeActivity.this.screenType == 2) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", C3158R.string.UnlockFingerprint), PasscodeActivity.this.getWalletFingerprintController().isWalletFingerprintUnlockEnabled(), true);
                    } else {
                        textCheckCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", C3158R.string.UnlockFingerprint), SharedConfig.useFingerprint, true);
                    }
                } else if (i == PasscodeActivity.this.captureRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString(C3158R.string.ScreenCaptureShowContent), SharedConfig.allowScreenCapture, false);
                }
                ...
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        ...
                        rLottieImageHolderView.imageView.setAnimation(C3158R.C3164raw.utyan_passcode, 100, 100);
                    ...
                    if (i == PasscodeActivity.this.captureHeaderRow) {
                        headerCell.setText(LocaleController.getString(C3158R.string.ScreenCaptureHeader));
                        return;
                    }
                    return;
                }
                ...
                if (i != PasscodeActivity.this.hintRow || PasscodeActivity.this.screenType == 2) {
                    if (i != PasscodeActivity.this.autoLockDetailRow) {
                        if (i == PasscodeActivity.this.captureDetailRow) {
                            textInfoPrivacyCell.setText(LocaleController.getString(C3158R.string.ScreenCaptureInfo));
                    ...
                    textInfoPrivacyCell.setText(LocaleController.getString(C3158R.string.AutoLockInfo));
                ...
                textInfoPrivacyCell.setText(LocaleController.getString(C3158R.string.PasscodeScreenHint));
                textInfoPrivacyCell.setBackground(null);
                textInfoPrivacyCell.getTextView().setGravity(1);
            } else {
                TextSettingsCell textSettingsCell = (TextSettingsCell) viewHolder.itemView;
                if (i == PasscodeActivity.this.changePasscodeRow) {
                    textSettingsCell.setText(PasscodeActivity.this.screenType == 2 ? LocaleController.getInternalString(C3158R.string.wallet_settings_pin_code_change) : LocaleController.getString("ChangePasscode", C3158R.string.ChangePasscode), true);
                        ...
                        if (PasscodeActivity.this.sectionPasscodeData.getAutoLockIn() != AutoLockTime.NONE) {
                            if (PasscodeActivity.this.sectionPasscodeData.getAutoLockIn() != AutoLockTime.MINUTE && PasscodeActivity.this.sectionPasscodeData.getAutoLockIn() != AutoLockTime.FIVE_MINUTES) {
                                if (PasscodeActivity.this.sectionPasscodeData.getAutoLockIn() == AutoLockTime.HOUR || PasscodeActivity.this.sectionPasscodeData.getAutoLockIn() == AutoLockTime.FIVE_HOURS) {
                                    formatString = LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", (int) Math.ceil(TimeUnit.SECONDS.toHours(PasscodeActivity.this.sectionPasscodeData.getAutoLockIn().getTimeInSeconds())), new Object[0]));
                                } else {
                                    formatString = LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Days", (int) Math.ceil(TimeUnit.SECONDS.toDays(PasscodeActivity.this.sectionPasscodeData.getAutoLockIn().getTimeInSeconds())), new Object[0]));
                                }
                            } else {
                                formatString = LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", (int) Math.ceil(TimeUnit.SECONDS.toMinutes(PasscodeActivity.this.sectionPasscodeData.getAutoLockIn().getTimeInSeconds())), new Object[0]));
                            }
                        } else {
                            formatString = LocaleController.formatString("AutoLockDisabled", C3158R.string.AutoLockDisabled, new Object[0]);
                        }
                    } else {
                        int i2 = SharedConfig.autoLockIn;
                        if (i2 == 0) {
                            ...
                            formatString = LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", i2 / 60, new Object[0]));
                        } else if (i2 < 86400) {
                            formatString = LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", (int) Math.ceil((i2 / 60.0f) / 60.0f), new Object[0]));
                        } else {
                            formatString = LocaleController.formatString("AutoLockInTime", C3158R.string.AutoLockInTime, LocaleController.formatPluralString("Days", (int) Math.ceil(((i2 / 60.0f) / 60.0f) / 24.0f), new Object[0]));
                        }
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("AutoLock", C3158R.string.AutoLock), formatString, true);
                    textSettingsCell.setTag("windowBackgroundWhiteBlackText");
                    textSettingsCell.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText"));
                } else if (i == PasscodeActivity.this.disablePasscodeRow) {
                    textSettingsCell.setText(LocaleController.getString(C3158R.string.DisablePasscode), false);
