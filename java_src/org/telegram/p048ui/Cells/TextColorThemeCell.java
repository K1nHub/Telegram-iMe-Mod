...
public class TextColorThemeCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            ...
            canvas.drawCircle(!LocaleController.isRTL ? AndroidUtilities.m50dp(28) : getMeasuredWidth() - AndroidUtilities.m50dp(28), getMeasuredHeight() / 2, AndroidUtilities.m50dp(10), colorPaint);
        }
    }
}
