...
import org.telegram.p048ui.Components.Reactions.AnimatedEmojiEffect;
import org.telegram.p048ui.Components.Reactions.ReactionsLayoutInBubble;
import org.telegram.p048ui.Components.SnowflakesEffect;
...
public class DrawerProfileCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
            ...
            if (z2) {
                ...
                if (drawerAccountData3 == DrawerAccountData.PHONE) {
                    ...
                    if (TextUtils.isEmpty(this.currentUser.username)) {
                        str2 = LocaleController.getInternalString(C3316R.string.drawer_profile_cell_alert_username);
                    } else {
                        str2 = LocaleController.formatStringInternal(C3316R.string.common_username, this.currentUser.username);
                    }
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    ...
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = LocaleController.formatStringInternal(C3316R.string.common_id, Long.valueOf(this.currentUser.f1642id));
                } else {
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = null;
                ...
                layoutParams.height = AndroidUtilities.m50dp(z ? 14 : 12);
                view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m50dp(10), -16777216));
                view.setAlpha(0.3f);
                str = "";
            }
            if (z) {
                this.nameTextView.setPadding(z2 ? 0 : AndroidUtilities.m50dp(32), AndroidUtilities.m50dp(4), 0, AndroidUtilities.m50dp(4));
                this.nameTextView.setMinWidth(z2 ? 0 : AndroidUtilities.m50dp(64));
    ...
    private void createEditButton(Context context) {
        ...
        this.editButton.setImageResource(C3316R.C3318drawable.fork_filter_icon_eye);
    ...
    private void createArchiveButton(Context context) {
        ...
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.archiveButton.setImageResource(C3316R.C3318drawable.msg_archive);
    ...
    public DrawerProfileCell(Context context, final DrawerLayoutContainer drawerLayoutContainer, final boolean z) {
        ...
        this.shadowView.setImageResource(C3316R.C3318drawable.bottom_shadow);
        addView(this.shadowView, LayoutHelper.createFrame(-1, 70, 83));
        BackupImageView backupImageView = new BackupImageView(context);
        this.avatarImageView = backupImageView;
        backupImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m50dp(32));
        ...
        SimpleTextView simpleTextView = new SimpleTextView(context) { // from class: org.telegram.ui.Cells.DrawerProfileCell.1
            @Override // org.telegram.p048ui.ActionBar.SimpleTextView, android.view.View
        ...
        this.nameTextView.setPadding(0, AndroidUtilities.m50dp(4), 0, AndroidUtilities.m50dp(4));
        ...
        this.arrowView.setImageResource(C3316R.C3318drawable.msg_expand);
        addView(this.arrowView, LayoutHelper.createFrame(59, 59, 85));
        setArrowState(false);
        boolean z2 = sunDrawable == null;
        if (z2) {
            int i = C3316R.C3321raw.sun;
        ...
        RLottieImageView rLottieImageView = new RLottieImageView(this, context) { // from class: org.telegram.ui.Cells.DrawerProfileCell.2
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (Theme.isCurrentThemeDark()) {
                    accessibilityNodeInfo.setText(LocaleController.getString("AccDescrSwitchToDayTheme", C3316R.string.AccDescrSwitchToDayTheme));
                } else {
                    accessibilityNodeInfo.setText(LocaleController.getString("AccDescrSwitchToNightTheme", C3316R.string.AccDescrSwitchToNightTheme));
                }
            }
        };
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.darkThemeView.setBackgroundDrawable(Theme.createSelectorDrawable(Theme.getColor("listSelectorSDK21"), 1, AndroidUtilities.m50dp(17)));
        ...
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this, AndroidUtilities.m50dp(20));
    ...
    */
    public /* synthetic */ void lambda$new$2(boolean r6, final org.telegram.p048ui.ActionBar.DrawerLayoutContainer r7, android.view.View r8) {
        /*
            ...
            return
        L3:
            boolean r6 = org.telegram.p048ui.Cells.DrawerProfileCell.switchingTheme
            if (r6 == 0) goto L8
            return
        L8:
            r6 = 1
        ...
        L2d:
            ...
            org.telegram.ui.ActionBar.Theme$ThemeInfo r2 = org.telegram.p048ui.ActionBar.Theme.getTheme(r6)
            if (r2 == 0) goto L45
            org.telegram.ui.ActionBar.Theme$ThemeInfo r2 = org.telegram.p048ui.ActionBar.Theme.getTheme(r6)
            boolean r2 = r2.isDark()
            if (r2 != 0) goto L46
    ...
    public static class AnimatedStatusView extends View {
        ...
        /* renamed from: y1 */
        private float f1671y1;

        /* renamed from: y2 */
        private float f1672y2;
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(Math.max(this.renderedEffectsSize, Math.max(this.stateSize, this.effectsSize))), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(Math.max(this.renderedEffectsSize, Math.max(this.stateSize, this.effectsSize))), 1073741824));
        }

        public void translate(float f, float f2) {
            setTranslationX(f - (getMeasuredWidth() / 2.0f));
            float measuredHeight = f2 - (getMeasuredHeight() / 2.0f);
            this.f1671y1 = measuredHeight;
            setTranslationY(measuredHeight + this.f1672y2);
        }

        public void translateY2(float f) {
            float f2 = this.f1671y1;
            this.f1672y2 = f;
        ...
        public void dispatchDraw(Canvas canvas) {
            int m50dp = AndroidUtilities.m50dp(this.renderedEffectsSize);
            int m50dp2 = AndroidUtilities.m50dp(this.effectsSize);
            for (int i = 0; i < this.animations.size(); i++) {
                Object obj = this.animations.get(i);
                if (obj instanceof ImageReceiver) {
                    ImageReceiver imageReceiver = (ImageReceiver) obj;
                    float f = m50dp2;
                    imageReceiver.setImageCoords((getMeasuredWidth() - m50dp2) / 2.0f, (getMeasuredHeight() - m50dp2) / 2.0f, f, f);
                    imageReceiver.draw(canvas);
                } else if (obj instanceof AnimatedEmojiEffect) {
                    AnimatedEmojiEffect animatedEmojiEffect = (AnimatedEmojiEffect) obj;
                    animatedEmojiEffect.setBounds((int) ((getMeasuredWidth() - m50dp) / 2.0f), (int) ((getMeasuredHeight() - m50dp) / 2.0f), (int) ((getMeasuredWidth() + m50dp) / 2.0f), (int) ((getMeasuredHeight() + m50dp) / 2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        if (Build.VERSION.SDK_INT >= 21 && !this.previewMode) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(148) + AndroidUtilities.statusBarHeight, 1073741824));
            return;
        }
        try {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(148), 1073741824));
        } catch (Exception e) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m50dp(148));
            FileLog.m45e(e);
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.drawPremium) {
            if (this.starParticlesDrawable == null) {
                ...
                drawable2.minLifeTime = C0482C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
            }
    ...
    */
    protected void onDraw(android.graphics.Canvas r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Cells.DrawerProfileCell.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setUser(TLRPC$User tLRPC$User, boolean z, DrawerHeaderSettings drawerHeaderSettings) {
        ...
        try {
            userName = Emoji.replaceEmoji(userName, this.nameTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m50dp(22), false);
        ...
        if (z3 && emojiStatusDocumentId != null) {
            ...
            if (this.premiumStar == null) {
                this.premiumStar = getResources().getDrawable(C3316R.C3318drawable.msg_premium_liststar).mutate();
            }
        ...
        textView.setText(c3233PhoneFormat.format("+" + tLRPC$User.phone));
    ...
    private void setArrowState(boolean z) {
        ...
        if (this.accountsShown) {
            i = C3316R.string.AccDescrHideAccounts;
            str = "AccDescrHideAccounts";
        } else {
            i = C3316R.string.AccDescrShowAccounts;
