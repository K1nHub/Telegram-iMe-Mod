...
public class ThemePreviewMessagesCell extends LinearLayout {
    ...
    public ThemePreviewMessagesCell(Context context, INavigationLayout iNavigationLayout, int i) {
        ...
        if (i == 2) {
            ...
            tLRPC$TL_message.message = LocaleController.getString("DoubleTapPreviewMessage", C3316R.string.DoubleTapPreviewMessage);
            ...
            messageObject3.customName = LocaleController.getString("DoubleTapPreviewSenderName", C3316R.string.DoubleTapPreviewSenderName);
            messageObject3.customAvatarDrawable = ContextCompat.getDrawable(context, C3316R.C3318drawable.dino_pic);
            ...
            if (i == 0) {
                tLRPC$TL_message2.message = LocaleController.getString("FontSizePreviewReply", C3316R.string.FontSizePreviewReply);
            } else {
                tLRPC$TL_message2.message = LocaleController.getString("NewThemePreviewReply", C3316R.string.NewThemePreviewReply);
            }
            ...
            if (i == 0) {
                tLRPC$TL_message3.message = LocaleController.getString("FontSizePreviewLine2", C3316R.string.FontSizePreviewLine2);
            } else {
                String string = LocaleController.getString("NewThemePreviewLine3", C3316R.string.NewThemePreviewLine3);
            ...
            if (i == 0) {
                tLRPC$TL_message4.message = LocaleController.getString("FontSizePreviewLine1", C3316R.string.FontSizePreviewLine1);
            } else {
                tLRPC$TL_message4.message = LocaleController.getString("NewThemePreviewLine1", C3316R.string.NewThemePreviewLine1);
            }
            ...
            if (i == 0) {
                messageObject6.customReplyName = LocaleController.getString("FontSizePreviewName", C3316R.string.FontSizePreviewName);
            } else {
                messageObject6.customReplyName = LocaleController.getString("NewThemePreviewName", C3316R.string.NewThemePreviewName);
            }
        ...
        while (true) {
            ...
            chatMessageCellArr[i5] = new ChatMessageCell(context, context, i2, i) { // from class: org.telegram.ui.Cells.ThemePreviewMessagesCell.1
                ...
                /* loaded from: classes5.dex */
                public class C37311 extends GestureDetector.SimpleOnGestureListener {
                    C37311() {
                    }

                    @Override // android.view.GestureDetector.SimpleOnGestureListener, android.view.GestureDetector.OnDoubleTapListener
                    public boolean onDoubleTap(MotionEvent motionEvent) {
                        if (MediaDataController.getInstance(C37301.this.val$currentAccount).getDoubleTapReaction() == null) {
                            return false;
                        }
                        boolean selectReaction = getMessageObject().selectReaction(ReactionsLayoutInBubble.VisibleReaction.fromEmojicon(MediaDataController.getInstance(C37301.this.val$currentAccount).getDoubleTapReaction()), false, false);
                        C37301 c37301 = C37301.this;
                        c37301.setMessageObject(c37301.getMessageObject(), null, false, false);
                        requestLayout();
                        ReactionsEffectOverlay.removeCurrent(false);
                        if (selectReaction) {
                            ThemePreviewMessagesCell themePreviewMessagesCell = ThemePreviewMessagesCell.this;
                            ReactionsEffectOverlay.show(themePreviewMessagesCell.fragment, null, themePreviewMessagesCell.cells[1], null, motionEvent.getX(), motionEvent.getY(), ReactionsLayoutInBubble.VisibleReaction.fromEmojicon(MediaDataController.getInstance(C37301.this.val$currentAccount).getDoubleTapReaction()), C37301.this.val$currentAccount, 0);
                            ReactionsEffectOverlay.startAnimation();
                        }
                        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC37321());
                        return true;
                    }
                    ...
                    /* loaded from: classes5.dex */
                    public class ViewTreeObserver$OnPreDrawListenerC37321 implements ViewTreeObserver.OnPreDrawListener {
                        ViewTreeObserver$OnPreDrawListenerC37321() {
                        }
                        ...
                        public boolean onPreDraw() {
                            ...
                            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Cells.ThemePreviewMessagesCell$1$1$1$$ExternalSyntheticLambda0
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    ThemePreviewMessagesCell.C37301.C37311.ViewTreeObserver$OnPreDrawListenerC37321.this.lambda$onPreDraw$0(valueAnimator);
                                }
                            });
...

                {
                    ...
                    this.val$type = i;
                    this.gestureDetector = new GestureDetector(context, new C37311());
                }
