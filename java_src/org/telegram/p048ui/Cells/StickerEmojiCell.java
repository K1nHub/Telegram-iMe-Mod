...
import org.telegram.p048ui.Components.ListView.RecyclerListViewWithOverlayDraw;
...
public class StickerEmojiCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, RecyclerListViewWithOverlayDraw.OverlayView {
        ...
        if (importingSticker != null) {
            ...
            if (tLRPC$Document != null) {
                ...
                if (str != null) {
                    ...
                    z3 = false;
                    if (!z3) {
                        this.emojiTextView.setText(Emoji.replaceEmoji(MediaDataController.getInstance(this.currentAccount).getEmojiForSticker(this.sticker.f1510id), this.emojiTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m50dp(16), false));
                    }
                    this.emojiTextView.setVisibility(0);
                } else {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        String string = LocaleController.getString("AttachSticker", C3316R.string.AttachSticker);
    ...
    @Override // org.telegram.p048ui.Components.ListView.RecyclerListViewWithOverlayDraw.OverlayView
