...
public class StickerSetGroupInfoCell extends LinearLayout {
    ...
    public StickerSetGroupInfoCell(Context context) {
        ...
        textView.setText(LocaleController.getString("GroupStickersInfo", C3316R.string.GroupStickersInfo));
        ...
        this.addButton.setText(LocaleController.getString("ChooseStickerSet", C3316R.string.ChooseStickerSet).toUpperCase());
