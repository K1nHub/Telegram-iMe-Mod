...
public class SendLocationCell extends FrameLayout {
    ...
    public void checkText() {
        ...
        if (sharingLocationInfo != null) {
            String string = LocaleController.getString("StopLiveLocation", C3316R.string.StopLiveLocation);
        ...
        setText(LocaleController.getString("SendLiveLocation", C3316R.string.SendLiveLocation), LocaleController.getString("SendLiveLocationInfo", C3316R.string.SendLiveLocationInfo));
    }
