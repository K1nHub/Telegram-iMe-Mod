...
/* renamed from: org.telegram.ui.Cells.PatternCell */
...
public class PatternCell extends BackupImageView implements DownloadController.FileDownloadProgressListener {
    ...
    /* renamed from: org.telegram.ui.Cells.PatternCell$PatternCellDelegate */
    /* loaded from: classes5.dex */
    ...
    public void updateSelected(boolean z) {
        ...
        if ((tLRPC$TL_wallPaper == null && selectedPattern == null) || !(selectedPattern == null || tLRPC$TL_wallPaper == null || tLRPC$TL_wallPaper.f1650id != selectedPattern.f1650id)) {
    ...
    public void onProgressDownload(String str, long j, long j2) {
        ...
        TLRPC$TL_wallPaper selectedPattern = this.delegate.getSelectedPattern();
        TLRPC$TL_wallPaper tLRPC$TL_wallPaper = this.currentPattern;
        if (!((tLRPC$TL_wallPaper == null && selectedPattern == null) || !(selectedPattern == null || tLRPC$TL_wallPaper == null || tLRPC$TL_wallPaper.f1650id != selectedPattern.f1650id)) || this.radialProgress.getIcon() == 10) {
            return;
        }
