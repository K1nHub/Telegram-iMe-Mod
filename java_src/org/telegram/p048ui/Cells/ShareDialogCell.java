...
public class ShareDialogCell extends FrameLayout {
    ...
    public void setDialog(long j, boolean z, CharSequence charSequence) {
        if (DialogObject.isUserDialog(j)) {
            ...
            if (this.currentType != 2 && UserObject.isReplyUser(this.user)) {
                this.nameTextView.setText(LocaleController.getString("RepliesTitle", C3316R.string.RepliesTitle));
            ...
            if (this.currentType != 2 && chat != null && ChatObject.isTemplatesChat(this.currentAccount, chat.f1502id)) {
                this.nameTextView.setText(LocaleController.getInternalString(C3316R.string.chat_templates));
    ...
    public /* synthetic */ void lambda$setTopic$2(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
        this.topicTextView.setTag(C3316R.C3319id.spring_tag, null);
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.imageView && this.currentType != 2 && (tLRPC$User = this.user) != null && !MessagesController.isSupportUser(tLRPC$User)) {
            ...
            boolean z = (tLRPC$User2.self || tLRPC$User2.bot || (((tLRPC$UserStatus = tLRPC$User2.status) == null || tLRPC$UserStatus.expires <= ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()) && !MessagesController.getInstance(this.currentAccount).onlinePrivacy.containsKey(Long.valueOf(this.user.f1642id)))) ? false : true;
