...
public class LocationDirectionCell extends FrameLayout {
    ...
    public LocationDirectionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.buttonTextView.setText(LocaleController.getString("Directions", C3316R.string.Directions));
        this.buttonTextView.setLeftDrawable(C3316R.C3318drawable.navigate);
