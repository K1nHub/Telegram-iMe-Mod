...
public class LocationDirectionCell extends FrameLayout {
    ...
    public LocationDirectionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.buttonTextView.setText(LocaleController.getString("Directions", C3158R.string.Directions));
        this.buttonTextView.setLeftDrawable(C3158R.C3160drawable.navigate);
