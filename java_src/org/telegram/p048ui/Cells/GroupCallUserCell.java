...
public class GroupCallUserCell extends FrameLayout {
    ...
    private static class VerifiedDrawable extends Drawable {
        ...
        public VerifiedDrawable(Context context) {
            ...
            drawableArr[0] = context.getResources().getDrawable(C3316R.C3318drawable.verified_area).mutate();
            this.drawables[0].setColorFilter(new PorterDuffColorFilter(-9063442, PorterDuff.Mode.MULTIPLY));
            this.drawables[1] = context.getResources().getDrawable(C3316R.C3318drawable.verified_check).mutate();
        }
    ...
    public GroupCallUserCell(Context context) {
        ...
        Drawable drawable = context.getResources().getDrawable(C3316R.C3318drawable.voice_volume_mini);
        ...
        while (true) {
            ...
            if (i == 4) {
                ...
                if (i == 0) {
                    ...
                    this.statusTextView[i].setText(LocaleController.getString("Listening", C3316R.string.Listening));
                } else if (i == 1) {
                    this.statusTextView[i].setTextColor(Theme.getColor("voipgroup_speakingText"));
                    this.statusTextView[i].setText(LocaleController.getString("Speaking", C3316R.string.Speaking));
                    ...
                    this.statusTextView[i].setText(LocaleController.getString("VoipGroupMutedForMe", C3316R.string.VoipGroupMutedForMe));
                } else if (i == 3) {
                    this.statusTextView[i].setTextColor(Theme.getColor("voipgroup_listeningText"));
                    this.statusTextView[i].setText(LocaleController.getString("WantsToSpeak", C3316R.string.WantsToSpeak));
                }
    ...
    public boolean isSelfUser() {
        ...
        if (j > 0) {
            ...
            return tLRPC$User != null && tLRPC$User.f1642id == j;
        }
        TLRPC$Chat tLRPC$Chat = this.currentChat;
        return tLRPC$Chat != null && tLRPC$Chat.f1502id == (-j);
    }
            ...
            if (tLRPC$User2 == null || !tLRPC$User2.verified) {
                ...
                if (isShowPremiumBadgeEnabled && (tLRPC$User = this.currentUser) != null && tLRPC$User.premium) {
                    if (this.premiumDrawable == null) {
                        this.premiumDrawable = getContext().getResources().getDrawable(C3316R.C3318drawable.msg_premium_liststar).mutate();
