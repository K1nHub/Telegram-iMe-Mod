...
public class AboutLinkCell extends FrameLayout {
    private static final int COLLAPSED_HEIGHT = AndroidUtilities.m50dp(76);
    ...
    public void updateColors() {
        ...
        this.bottomShadow.getBackground().setColorFilter(new PorterDuffColorFilter(Theme.getColor("windowBackgroundWhite"), PorterDuff.Mode.SRC_ATOP));
        this.showMoreTextView.setTextColor(Theme.getColor("windowBackgroundWhiteBlueText"));
        this.showMoreBackgroundDrawable.setColorFilter(new PorterDuffColorFilter(Theme.getColor("windowBackgroundWhite"), PorterDuff.Mode.MULTIPLY));
    ...
    public AboutLinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.SPACE = AndroidUtilities.m51dp(3.0f);
        this.longPressedRunnable = new RunnableC35952();
        ...
        Drawable mutate = context.getResources().getDrawable(C3286R.C3288drawable.gradient_bottom).mutate();
        ...
        TextView textView2 = new TextView(this, context) { // from class: org.telegram.ui.Cells.AboutLinkCell.1
            ...
            protected void onDraw(Canvas canvas) {
                if (this.pressed) {
                    ...
                    canvas.drawRoundRect(rectF, AndroidUtilities.m50dp(4), AndroidUtilities.m50dp(4), Theme.chat_urlPaint);
                }
                super.onDraw(canvas);
            }
        };
        ...
        this.showMoreTextView.setText(LocaleController.getString("DescriptionMore", C3286R.string.DescriptionMore));
        ...
        this.showMoreTextView.setPadding(AndroidUtilities.m50dp(2), 0, AndroidUtilities.m50dp(2), 0);
        this.showMoreTextBackgroundView = new FrameLayout(context);
        Drawable mutate2 = context.getResources().getDrawable(C3286R.C3288drawable.gradient_left).mutate();
        ...
        frameLayout2.setPadding(frameLayout2.getPaddingLeft() + AndroidUtilities.m50dp(4), AndroidUtilities.m50dp(1), 0, AndroidUtilities.m50dp(3));
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(AndroidUtilities.m50dp(15), AndroidUtilities.m50dp(8), getWidth() - AndroidUtilities.m50dp(23), getHeight());
        ...
        this.textY = m50dp2;
        canvas.translate(BitmapDescriptorFactory.HUE_RED, m50dp2);
        try {
    ...
    public void setTextAndValue(String str, String str2, boolean z) {
        ...
        Emoji.replaceEmoji(this.stringBuilder, Theme.profile_aboutTextPaint.getFontMetricsInt(), AndroidUtilities.m50dp(20), false);
        if (this.lastMaxWidth <= 0) {
            this.lastMaxWidth = AndroidUtilities.displaySize.x - AndroidUtilities.m50dp(46);
        }
    ...
    /* loaded from: classes5.dex */
    public class RunnableC35952 implements Runnable {
        RunnableC35952() {
        }
        ...
        public void run() {
            if (AboutLinkCell.this.pressedLink != null) {
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3286R.string.Open), LocaleController.getString("Copy", C3286R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        AboutLinkCell.RunnableC35952.this.lambda$run$0(clickableSpan, layout, f, url, dialogInterface, i);
                    }
                });
                builder.setOnPreDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda1
                    ...
                    public final void onDismiss(DialogInterface dialogInterface) {
                        AboutLinkCell.RunnableC35952.this.lambda$run$1(dialogInterface);
                    }
                });
                builder.show();
        ...
        public /* synthetic */ void lambda$run$0(ClickableSpan clickableSpan, Layout layout, float f, String str, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    if (str.startsWith("@")) {
                        BulletinFactory.m27of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3286R.C3291raw.copy, LocaleController.getString("UsernameCopied", C3286R.string.UsernameCopied)).show();
                    } else if (str.startsWith("#") || str.startsWith("$")) {
                        BulletinFactory.m27of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3286R.C3291raw.copy, LocaleController.getString("HashtagCopied", C3286R.string.HashtagCopied)).show();
                    } else {
                        BulletinFactory.m27of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3286R.C3291raw.copy, LocaleController.getString("LinkCopied", C3286R.string.LinkCopied)).show();
                    }
                }
            }
        }
    ...
    private LinkSpanDrawable hitLink(int i, int i2) {
        if (i < this.showMoreTextView.getLeft() || i > this.showMoreTextView.getRight() || i2 < this.showMoreTextView.getTop() || i2 > this.showMoreTextView.getBottom()) {
            if (getMeasuredWidth() <= 0 || i <= getMeasuredWidth() - AndroidUtilities.m50dp(23)) {
    ...
    public void onLinkClick(ClickableSpan clickableSpan, Layout layout, float f) {
        ...
        if (layout != null && clickableSpan != null) {
            c35963 = new C35963(layout, clickableSpan, f);
        }
        this.currentProgress = c35963;
    ...
    /* loaded from: classes5.dex */
    public class C35963 extends Browser.Progress {
        ...
        C35963(Layout layout, ClickableSpan clickableSpan, float f) {
        ...
        public void end(boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.AboutLinkCell$3$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AboutLinkCell.C35963.this.lambda$end$0();
                }
            }, z ? 0L : 350L);
        }
    ...
    private int fromHeight() {
        return Math.min(COLLAPSED_HEIGHT + (this.valueTextView.getVisibility() == 0 ? AndroidUtilities.m50dp(20) : 0), textHeight());
    }
    ...
    protected void onMeasure(int i, int i2) {
        checkTextLayout(View.MeasureSpec.getSize(i) - AndroidUtilities.m50dp(46), false);
    ...
    private StaticLayout makeTextLayout(CharSequence charSequence, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            return StaticLayout.Builder.obtain(charSequence, 0, charSequence.length(), Theme.profile_aboutTextPaint, max).setBreakStrategy(1).setHyphenationFrequency(0).setAlignment(LocaleController.isRTL ? StaticLayoutEx.ALIGN_RIGHT() : StaticLayoutEx.ALIGN_LEFT()).build();
        }
    ...
    private void checkTextLayout(int i, boolean z) {
        ...
        if (spannableStringBuilder != null && (i != this.lastMaxWidth || z)) {
            ...
            if (this.shouldExpand && this.firstThreeLinesLayout != null) {
                int fromHeight = fromHeight() - AndroidUtilities.m50dp(8);
                StaticLayout staticLayout = this.firstThreeLinesLayout;
    ...
    private int textHeight() {
        ...
        int height = (staticLayout != null ? staticLayout.getHeight() : AndroidUtilities.m50dp(20)) + AndroidUtilities.m50dp(16);
        return this.valueTextView.getVisibility() == 0 ? height + AndroidUtilities.m50dp(23) : height;
    }
