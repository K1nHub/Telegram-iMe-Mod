...
public class SharingLiveLocationCell extends FrameLayout {
    ...
    public void setDialog(MessageObject messageObject, Location location, boolean z) {
        ...
        if (!TextUtils.isEmpty(messageObject.messageOwner.media.title)) {
            ...
            Drawable drawable = getResources().getDrawable(C3316R.C3318drawable.pin);
        ...
        if (location != null) {
            ...
            this.distanceTextView.setText(LocaleController.getString("Loading", C3316R.string.Loading));
        } else {
    ...
    public void setDialog(LocationActivity.LiveLocation liveLocation, Location location) {
        ...
        if (DialogObject.isUserDialog(liveLocation.f1836id)) {
            TLRPC$User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(liveLocation.f1836id));
            if (user != null) {
            ...
            TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-liveLocation.f1836id));
            if (chat != null) {
