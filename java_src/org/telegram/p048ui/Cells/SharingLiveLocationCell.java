...
public class SharingLiveLocationCell extends FrameLayout {
    ...
    public void setDialog(MessageObject messageObject, Location location, boolean z) {
        ...
        if (location != null) {
            ...
            this.distanceTextView.setText(LocaleController.getString("Loading", C3158R.string.Loading));
        } else {
    ...
    public void setDialog(LocationActivity.LiveLocation liveLocation, Location location) {
        ...
        if (DialogObject.isUserDialog(liveLocation.f1821id)) {
            TLRPC$User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(liveLocation.f1821id));
            if (user != null) {
            ...
            TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-liveLocation.f1821id));
            if (chat != null) {
