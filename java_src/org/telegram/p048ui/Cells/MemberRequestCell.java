...
public class MemberRequestCell extends FrameLayout {
    ...
    public MemberRequestCell(Context context, final OnClickListener onClickListener, boolean z) {
        ...
        textView2.setText(LocaleController.getString("Dismiss", C3158R.string.Dismiss));
    ...
    public void setData(LongSparseArray<TLRPC$User> longSparseArray, TLRPC$TL_chatInviteImporter tLRPC$TL_chatInviteImporter, boolean z) {
        ...
        if (j == 0) {
            this.statusTextView.setText(LocaleController.formatString("RequestedToJoinAt", C3158R.string.RequestedToJoinAt, formatDateAudio));
            return;
        }
        TLRPC$User tLRPC$User2 = longSparseArray.get(j);
        if (tLRPC$User2 != null) {
            this.statusTextView.setText(LocaleController.formatString("AddedBy", C3158R.string.AddedBy, UserObject.getFirstName(tLRPC$User2), formatDateAudio));
        } else {
