...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ProfileSearchCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.countTop = AndroidUtilities.m50dp(19);
        this.rect = new RectF();
        this.resourcesProvider = resourcesProvider;
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.avatarImage = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.m50dp(23));
        ...
        this.statusDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this, AndroidUtilities.m50dp(20));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m50dp(60) + (this.useSeparator ? 1 : 0));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.checkBox != null) {
            int m50dp = LocaleController.isRTL ? (i3 - i) - AndroidUtilities.m50dp(42) : AndroidUtilities.m50dp(42);
            int m50dp2 = AndroidUtilities.m50dp(36);
            CheckBox2 checkBox2 = this.checkBox;
            checkBox2.layout(m50dp, m50dp2, checkBox2.getMeasuredWidth() + m50dp, this.checkBox.getMeasuredHeight() + m50dp2);
        }
        if (z) {
            buildLayout();
        }
    ...
    public void buildLayout() {
        ...
        if (this.encryptedChat != null) {
            ...
            this.dialog_id = DialogObject.makeEncryptedDialogId(tLRPC$EncryptedChat.f1511id);
            if (!LocaleController.isRTL) {
                ...
                this.nameLockLeft = (getMeasuredWidth() - AndroidUtilities.m50dp(AndroidUtilities.leftBaseline + 2)) - Theme.dialogs_lockDrawable.getIntrinsicWidth();
                this.nameLeft = AndroidUtilities.m50dp(11);
            }
            this.nameLockTop = AndroidUtilities.m51dp(22.0f);
            updateStatus(false, null, false);
        } else {
            TLRPC$Chat tLRPC$Chat = this.chat;
            if (tLRPC$Chat != null) {
                this.dialog_id = -tLRPC$Chat.f1499id;
                ...
                if (tLRPC$User != null) {
                    this.dialog_id = tLRPC$User.f1639id;
                    if (!LocaleController.isRTL) {
                        this.nameLeft = AndroidUtilities.m50dp(AndroidUtilities.leftBaseline);
                    } else {
                        this.nameLeft = AndroidUtilities.m50dp(11);
                    }
                    this.nameLockTop = AndroidUtilities.m50dp(21);
        ...
        if (str4 == null) {
            ...
            if (tLRPC$Chat2 != null) {
                ...
                if (tLRPC$User2 == null) {
                    ...
                    str3 = LocaleController.getString("SavedMessages", C3286R.string.SavedMessages);
                } else {
        ...
        if (str4.length() == 0) {
            ...
            if (tLRPC$User3 != null && (str2 = tLRPC$User3.phone) != null && str2.length() != 0) {
                str4 = C3204PhoneFormat.getInstance().format("+" + this.user.phone);
            } else {
                str4 = LocaleController.getString("HiddenName", C3286R.string.HiddenName);
            }
        }
        if (this.encryptedChat != null) {
        ...
        if (!LocaleController.isRTL) {
            measuredWidth = (getMeasuredWidth() - this.nameLeft) - AndroidUtilities.m50dp(14);
            this.nameWidth = measuredWidth;
        } else {
            measuredWidth = (getMeasuredWidth() - this.nameLeft) - AndroidUtilities.m50dp(AndroidUtilities.leftBaseline);
            this.nameWidth = measuredWidth;
        }
        if (this.drawNameLock) {
            this.nameWidth -= AndroidUtilities.m50dp(6) + Theme.dialogs_lockDrawable.getIntrinsicWidth();
        }
        if (this.contact != null) {
            TextPaint textPaint3 = Theme.dialogs_countTextPaint;
            int i = C3286R.string.Invite;
            ...
            if (!LocaleController.isRTL) {
                this.actionLeft = ((getMeasuredWidth() - measureText) - AndroidUtilities.m50dp(19)) - AndroidUtilities.m50dp(16);
            } else {
                this.actionLeft = AndroidUtilities.m50dp(19) + AndroidUtilities.m50dp(16);
                this.nameLeft += measureText;
            }
            this.nameWidth -= AndroidUtilities.m50dp(32) + measureText;
        }
        ...
        if (this.promoSubscribeIcon != null) {
            ...
            if (!LocaleController.isRTL) {
                this.promoSubscribeIconLeft = (getMeasuredWidth() - this.promoSubscribeIconSize) - AndroidUtilities.m50dp(19);
            } else {
                this.countLeft = AndroidUtilities.m50dp(19);
        ...
        if (this.drawCount) {
            ...
            if (dialogUnreadCount != 0) {
                ...
                this.countWidth = Math.max(AndroidUtilities.m50dp(12), (int) Math.ceil(Theme.dialogs_countTextPaint.measureText(format)));
                ...
                int m50dp2 = this.countWidth + AndroidUtilities.m50dp(18);
                this.nameWidth -= m50dp2;
                paddingLeft -= m50dp2;
                if (!LocaleController.isRTL) {
                    this.countLeft = (getMeasuredWidth() - this.countWidth) - AndroidUtilities.m50dp(19);
                } else {
                    this.countLeft = AndroidUtilities.m50dp(19);
        ...
        CharSequence ellipsize = TextUtils.ellipsize(str4, textPaint2, this.nameWidth - AndroidUtilities.m50dp(12), TextUtils.TruncateAt.END);
        if (ellipsize != null) {
            ellipsize = Emoji.replaceEmoji(ellipsize, textPaint2.getFontMetricsInt(), AndroidUtilities.m50dp(20), false);
        }
        ...
        if (!LocaleController.isRTL) {
            this.statusLeft = AndroidUtilities.m50dp(AndroidUtilities.leftBaseline);
        } else {
            this.statusLeft = AndroidUtilities.m50dp(11);
        }
        ...
        if (tLRPC$Chat3 == null || this.subLabel != null) {
            ...
            if (charSequence != null) {
                ...
                if (tLRPC$User4 == null) {
                    ...
                    str = LocaleController.getString("SupportStatus", C3286R.string.SupportStatus);
                } else {
                    TLRPC$User tLRPC$User5 = this.user;
                    if (tLRPC$User5.bot) {
                        str = LocaleController.getString("Bot", C3286R.string.Bot);
                    } else {
                        long j = tLRPC$User5.f1639id;
                        if (j == 333000 || j == 777000) {
                            str = LocaleController.getString("ServiceNotifications", C3286R.string.ServiceNotifications);
                        } else {
                            ...
                            if (tLRPC$User6 != null && (tLRPC$User6.f1639id == UserConfig.getInstance(this.currentAccount).getClientUserId() || ((tLRPC$UserStatus = this.user.status) != null && tLRPC$UserStatus.expires > ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()))) {
                                textPaint4 = Theme.dialogs_onlinePaint;
                                str = LocaleController.getString("Online", C3286R.string.Online);
                            }
                        }
                    }
                }
            ...
            if (this.savedMessages || UserObject.isReplyUser(this.user)) {
                this.nameTop = AndroidUtilities.m50dp(20);
                str = null;
            }
        } else {
            if (this.albumMode) {
                str = LocaleController.getInternalString(C3286R.string.cloud_album).toLowerCase();
            } else {
                if (ChatObject.isChannel(tLRPC$Chat3)) {
                    ...
                    if (!tLRPC$Chat4.megagroup) {
                        ...
                        if (i2 != 0) {
                            ...
                            str = LocaleController.getString("ChannelPrivate", C3286R.string.ChannelPrivate).toLowerCase();
                        } else {
                            str = LocaleController.getString("ChannelPublic", C3286R.string.ChannelPublic).toLowerCase();
                        }
                    }
                }
                ...
                if (i3 != 0) {
                    ...
                    str = LocaleController.getString("MegaLocation", C3286R.string.MegaLocation);
                } else if (!ChatObject.isPublic(tLRPC$Chat5)) {
                    str = LocaleController.getString("MegaPrivate", C3286R.string.MegaPrivate).toLowerCase();
                } else {
                    str = LocaleController.getString("MegaPublic", C3286R.string.MegaPublic).toLowerCase();
                }
            }
            this.nameTop = AndroidUtilities.m50dp(19);
        }
        if (!TextUtils.isEmpty(str)) {
            this.statusLayout = new StaticLayout(TextUtils.ellipsize(str, textPaint4, paddingLeft - AndroidUtilities.m50dp(12), TextUtils.TruncateAt.END), textPaint4, paddingLeft, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            this.nameTop = AndroidUtilities.m50dp(9);
            this.nameLockTop -= AndroidUtilities.m50dp(10);
        } else {
            this.nameTop = AndroidUtilities.m50dp(20);
            this.statusLayout = null;
        }
        if (LocaleController.isRTL) {
            m50dp = (getMeasuredWidth() - AndroidUtilities.m50dp(57)) - getPaddingRight();
        } else {
            m50dp = AndroidUtilities.m50dp(11) + getPaddingLeft();
        }
        this.avatarImage.setImageCoords(m50dp, AndroidUtilities.m50dp(7), AndroidUtilities.m50dp(46), AndroidUtilities.m50dp(46));
        if (LocaleController.isRTL) {
    ...
    */
    public void update(int r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Cells.ProfileSearchCell.update(int):void");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.nameLayout != null) {
            ...
            if (LocaleController.isRTL) {
                if (this.nameLayout.getLineLeft(0) == BitmapDescriptorFactory.HUE_RED) {
                    lineRight = (this.nameLeft - AndroidUtilities.m50dp(6)) - this.statusDrawable.getIntrinsicWidth();
                } else {
                    lineRight = (int) ((((this.nameLeft + this.nameWidth) - Math.ceil(this.nameLayout.getLineWidth(0))) - AndroidUtilities.m50dp(6)) - this.statusDrawable.getIntrinsicWidth());
                }
            } else {
                lineRight = (int) (this.nameLeft + this.nameLayout.getLineRight(0) + AndroidUtilities.m50dp(6));
            }
        ...
        if (this.statusLayout != null) {
            canvas.save();
            canvas.translate(this.statusLeft + this.sublabelOffsetX, AndroidUtilities.m50dp(33) + this.sublabelOffsetY);
            this.statusLayout.draw(canvas);
            canvas.restore();
        }
        if (this.countLayout != null) {
            int m51dp = this.countLeft - AndroidUtilities.m51dp(5.5f);
            this.rect.set(m51dp, this.countTop, m51dp + this.countWidth + AndroidUtilities.m50dp(11), this.countTop + AndroidUtilities.m50dp(23));
            ...
            canvas.save();
            canvas.translate(this.countLeft, this.countTop + AndroidUtilities.m50dp(4));
        ...
        if (this.actionLayout != null) {
            ...
            rectF2.set(i, this.countTop, i + this.actionLayout.getWidth(), this.countTop + AndroidUtilities.m50dp(23));
            rectF2.inset(-AndroidUtilities.m50dp(16), -AndroidUtilities.m50dp(4));
            this.actionButton.setRect(rectF2);
            this.actionButton.setRounded(true);
            this.actionButton.draw(canvas);
            canvas.save();
            canvas.translate(this.actionLeft, this.countTop + AndroidUtilities.m50dp(4));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.drawCheck) {
            sb.append(", ");
            sb.append(LocaleController.getString("AccDescrVerified", C3286R.string.AccDescrVerified));
            sb.append("\n");
        }
        if (this.statusLayout != null) {
            if (sb.length() > 0) {
