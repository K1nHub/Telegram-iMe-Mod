...
public class PollEditTextCell extends FrameLayout {
    ...
    public PollEditTextCell(Context context, boolean z, View.OnClickListener onClickListener) {
        ...
        if (onClickListener != null) {
            ...
            this.moveImageView.setImageResource(C3316R.C3318drawable.poll_reorder);
            ...
            this.deleteImageView.setImageResource(C3316R.C3318drawable.poll_remove);
            ...
            this.deleteImageView.setContentDescription(LocaleController.getString("Delete", C3316R.string.Delete));
            ...
            this.checkBox.setContentDescription(LocaleController.getString("AccDescrQuizCorrectAnswer", C3316R.string.AccDescrQuizCorrectAnswer));
