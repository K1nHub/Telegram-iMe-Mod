...
public class DrawerAddCell extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        this.textView.setText(LocaleController.getString("AddAccount", C3158R.string.AddAccount));
        Drawable drawable = getResources().getDrawable(C3158R.C3160drawable.msg_add);
        if (drawable != null) {
