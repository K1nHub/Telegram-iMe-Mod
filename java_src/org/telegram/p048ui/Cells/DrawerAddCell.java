...
public class DrawerAddCell extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        this.textView.setText(LocaleController.getString("AddAccount", C3316R.string.AddAccount));
        Drawable drawable = getResources().getDrawable(C3316R.C3318drawable.msg_add);
        if (drawable != null) {
