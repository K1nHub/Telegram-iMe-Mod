...
public class TooManyCommunitiesHintCell extends FrameLayout {
    ...
    public TooManyCommunitiesHintCell(Context context) {
        ...
        this.headerTextView.setText(LocaleController.getString("TooManyCommunities", C3158R.string.TooManyCommunities));
        this.imageView.setImageResource(C3158R.C3160drawable.groups_limit1);
    }
