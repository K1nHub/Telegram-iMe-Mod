...
public class ArchivedStickerSetCell extends FrameLayout implements Checkable {
    ...
    public ArchivedStickerSetCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            progressButton.setText(LocaleController.getString("Add", C3316R.string.Add));
            ...
            progressButton2.setText(LocaleController.getString("StickersRemove", C3316R.string.StickersRemove));
