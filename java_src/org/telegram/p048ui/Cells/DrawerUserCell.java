...
public class DrawerUserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void addMuteButton() {
        ...
        imageView.setImageResource(C3286R.C3288drawable.msg_unmute);
        this.muteButton.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.muteButton.setColorFilter(new PorterDuffColorFilter(Theme.getColor("chats_menuItemIcon"), PorterDuff.Mode.MULTIPLY));
    ...
    public /* synthetic */ void lambda$addMuteButton$0(View view) {
        ...
        if (getForkCommonController().isAccountMuted()) {
            string = LocaleController.getString("NotificationsMutedHint", C3286R.string.NotificationsMutedHint);
        } else {
            string = LocaleController.getString("NotificationsUnmutedHint", C3286R.string.NotificationsUnmutedHint);
        }
    ...
    private void updateMuteButtonIcon() {
        ...
        if (imageView != null) {
            imageView.setImageResource(getForkCommonController().isAccountMuted() ? C3286R.C3288drawable.msg_mute : C3286R.C3288drawable.msg_unmute);
        }
    }
    ...
    public DrawerUserCell(Context context, int i) {
        ...
        avatarDrawable.setTextSize(AndroidUtilities.m50dp(20));
        ...
        simpleTextView.setPadding(0, AndroidUtilities.m50dp(4), 0, AndroidUtilities.m50dp(4));
        ...
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.textView, AndroidUtilities.m50dp(20));
        ...
        this.checkBox.setInnerRadDiff(AndroidUtilities.m51dp(1.5f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(isActionBarAccountSwitchType() ? 56 : 48), 1073741824));
    }
    ...
    public void setAccount(int i) {
        ...
        try {
            formatName = Emoji.replaceEmoji(formatName, this.textView.getPaint().getFontMetricsInt(), AndroidUtilities.m50dp(20), false);
        ...
        if (isShowPremiumStatusEnabled && emojiStatusDocumentId != null) {
            this.textView.setDrawablePadding(AndroidUtilities.m50dp(4));
            ...
            this.textView.setDrawablePadding(AndroidUtilities.m50dp(6));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m51dp = AndroidUtilities.m51dp(isActionBarAccountSwitchType() ? 16.5f : 12.5f);
        int ceil = (int) Math.ceil(Theme.dialogs_countTextPaint.measureText(format));
        int max = Math.max(AndroidUtilities.m50dp(10), ceil);
        int measuredWidth = (getMeasuredWidth() - max) - AndroidUtilities.m50dp(25);
        if (this.muteButton != null) {
            measuredWidth -= AndroidUtilities.m50dp(42);
        }
        int m51dp2 = measuredWidth - AndroidUtilities.m51dp(5.5f);
        this.rect.set(m51dp2, m51dp, m51dp2 + max + AndroidUtilities.m50dp(14), AndroidUtilities.m50dp(23) + m51dp);
        RectF rectF = this.rect;
        float f = AndroidUtilities.density;
        canvas.drawRoundRect(rectF, f * 11.5f, f * 11.5f, Theme.dialogs_countPaint);
        RectF rectF2 = this.rect;
        canvas.drawText(format, rectF2.left + ((rectF2.width() - ceil) / 2.0f), m51dp + AndroidUtilities.m50dp(16), Theme.dialogs_countTextPaint);
        this.textView.setRightPadding(max + AndroidUtilities.m50dp(26));
    }
