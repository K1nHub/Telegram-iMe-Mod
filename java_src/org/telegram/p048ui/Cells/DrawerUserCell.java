...
public class DrawerUserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void addMuteButton() {
        ...
        imageView.setImageResource(C3158R.C3160drawable.msg_unmute);
    ...
    public /* synthetic */ void lambda$addMuteButton$0(View view) {
        ...
        if (getForkCommonController().isAccountMuted()) {
            string = LocaleController.getString("NotificationsMutedHint", C3158R.string.NotificationsMutedHint);
        } else {
            string = LocaleController.getString("NotificationsUnmutedHint", C3158R.string.NotificationsUnmutedHint);
        }
    ...
    private void updateMuteButtonIcon() {
        ...
        if (imageView != null) {
            imageView.setImageResource(getForkCommonController().isAccountMuted() ? C3158R.C3160drawable.msg_mute : C3158R.C3160drawable.msg_unmute);
        }
    }
