...
public class LocationLoadingCell extends FrameLayout {
    ...
    public LocationLoadingCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C3301R.C3303drawable.location_empty);
        ...
        this.textView.setText(LocaleController.getString("NoPlacesFound", C3301R.string.NoPlacesFound));
