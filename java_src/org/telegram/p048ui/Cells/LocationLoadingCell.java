...
public class LocationLoadingCell extends FrameLayout {
    ...
    public LocationLoadingCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C3286R.C3288drawable.location_empty);
        ...
        this.textView.setText(LocaleController.getString("NoPlacesFound", C3286R.string.NoPlacesFound));
