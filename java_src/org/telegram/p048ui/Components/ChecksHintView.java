...
public class ChecksHintView extends FrameLayout {
    ...
    public ChecksHintView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        while (i < 2) {
            ...
            if (i == 0) {
                this.imageView[i].setAnimation(C3286R.C3291raw.ticks_single, 24, 24);
                this.textView[i].setText(LocaleController.getString("HintSent", C3286R.string.HintSent));
            } else {
                this.imageView[i].setAnimation(C3286R.C3291raw.ticks_double, 24, 24);
                this.textView[i].setText(LocaleController.getString("HintRead", C3286R.string.HintRead));
            }
        ...
        imageView.setImageResource(C3286R.C3288drawable.tooltip_arrow);
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, boolean z) {
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C44221());
    ...
    /* loaded from: classes6.dex */
    public class C44221 extends AnimatorListenerAdapter {
        C44221() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(ChecksHintView.this.hideRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChecksHintView$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ChecksHintView.C44221.this.lambda$onAnimationEnd$0();
                }
