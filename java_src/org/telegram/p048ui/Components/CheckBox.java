...
public class CheckBox extends View {
    ...
    public CheckBox(Context context, int i, AttributeSet attributeSet) {
        ...
        backgroundPaint.setStrokeWidth(AndroidUtilities.m50dp(2));
        TextPaint textPaint = new TextPaint(1);
        this.textPaint = textPaint;
        textPaint.setTextSize(AndroidUtilities.m50dp(18));
    ...
    public void setVisibility(int i) {
        ...
        if (i == 0 && this.drawBitmap == null) {
            try {
                this.drawBitmap = Bitmap.createBitmap(AndroidUtilities.m50dp(this.size), AndroidUtilities.m50dp(this.size), Bitmap.Config.ARGB_4444);
                this.bitmapCanvas = new Canvas(this.drawBitmap);
                this.checkBitmap = Bitmap.createBitmap(AndroidUtilities.m50dp(this.size), AndroidUtilities.m50dp(this.size), Bitmap.Config.ARGB_4444);
    ...
    public void setSize(int i) {
        this.size = i;
        if (i == 40) {
            this.textPaint.setTextSize(AndroidUtilities.m50dp(24));
        }
    }
