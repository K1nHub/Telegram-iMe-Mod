...
import org.telegram.p048ui.Components.GroupCallRecordAlert;
...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC$Chat tLRPC$Chat, boolean z) {
        ...
        if (ChatObject.isChannelOrGiga(tLRPC$Chat)) {
            textView.setText(LocaleController.getString("VoipChannelRecordVoiceChat", C3158R.string.VoipChannelRecordVoiceChat));
        } else {
            textView.setText(LocaleController.getString("VoipRecordVoiceChat", C3158R.string.VoipRecordVoiceChat));
        }
        ...
        textView2.setText(LocaleController.getString("VoipRecordVoiceChatInfo", C3158R.string.VoipRecordVoiceChatInfo));
            ...
            */
            protected void onSizeChanged(int r26, int r27, int r28, int r29) {
                ...
                L77:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.GroupCallRecordAlert.C45213.onSizeChanged(int, int, int, int):void");
            }
        ...
        this.positiveButton.setText(LocaleController.getString("VoipRecordStart", C3158R.string.VoipRecordStart));
        ...
        while (true) {
            ...
            if (i2 == 0) {
                this.titles[i2].setText(LocaleController.getString("VoipRecordAudio", C3158R.string.VoipRecordAudio));
            } else if (i2 == 1) {
                this.titles[i2].setText(LocaleController.getString("VoipRecordPortrait", C3158R.string.VoipRecordPortrait));
            } else {
                this.titles[i2].setText(LocaleController.getString("VoipRecordLandscape", C3158R.string.VoipRecordLandscape));
            }
    ...
    public class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) {
            ...
            if (i == 0) {
                imageView.setContentDescription(LocaleController.getString("VoipRecordAudio", C3158R.string.VoipRecordAudio));
            } else if (i == 1) {
                imageView.setContentDescription(LocaleController.getString("VoipRecordPortrait", C3158R.string.VoipRecordPortrait));
            } else {
                imageView.setContentDescription(LocaleController.getString("VoipRecordLandscape", C3158R.string.VoipRecordLandscape));
            }
            if (i == 0) {
                i2 = C3158R.C3164raw.record_audio;
            } else if (i == 1) {
                i2 = C3158R.C3164raw.record_video_p;
            } else {
                i2 = C3158R.C3164raw.record_video_l;
            }
