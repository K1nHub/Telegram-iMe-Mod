...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean z) {
        ...
        this.cancelButton.setText(LocaleController.getString("Cancel", C3301R.string.Cancel).toUpperCase());
        ...
        this.doneButton.setText(LocaleController.getString("Send", C3301R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C3301R.C3303drawable.photobadge : C3301R.C3303drawable.bluecounter);
