...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean z) {
        ...
        this.cancelButton.setText(LocaleController.getString("Cancel", C3316R.string.Cancel).toUpperCase());
        ...
        this.doneButton.setText(LocaleController.getString("Send", C3316R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C3316R.C3318drawable.photobadge : C3316R.C3318drawable.bluecounter);
