...
import org.telegram.p048ui.Components.ChatAttachAlertPhotoLayoutPreview;
...
public class ChatAttachAlertPhotoLayoutPreview extends ChatAttachAlert.AttachAlertLayout {
    ...
    public ChatAttachAlertPhotoLayoutPreview(ChatAttachAlert chatAttachAlert, Context context, ChatActivity.ThemeDelegate themeDelegate) {
        ...
        ActionBarMenuItem actionBarMenuItem = new ActionBarMenuItem(context, createMenu, 0, 0, this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.1
            @Override // org.telegram.p048ui.ActionBar.ActionBarMenuItem, android.view.View
        ...
        this.header.setText(LocaleController.getString("AttachMediaPreview", C3286R.string.AttachMediaPreview));
        ...
        this.listView.setPadding(0, 0, 0, AndroidUtilities.m50dp(46));
        ...
        this.videoPlayImage = context.getResources().getDrawable(C3286R.C3288drawable.play_mini_video);
    }
    ...
    public /* synthetic */ void lambda$onShow$0(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        ...
        if (currentItemTop > AndroidUtilities.m50dp(7)) {
    ...
    public /* synthetic */ void lambda$onShow$1() {
        ...
        this.parentAlert.getPhotoLayout().previewItem.setIcon(C3286R.C3288drawable.ic_ab_back);
        this.parentAlert.getPhotoLayout().previewItem.setText(LocaleController.getString(C3286R.string.Back));
    }
    ...
    public void onHide() {
        ...
        if (getSelectedItemsCount() > 1 && this.parentAlert.getPhotoLayout() != null) {
            this.parentAlert.getPhotoLayout().previewItem.setIcon(C3286R.C3288drawable.msg_view_file);
            this.parentAlert.getPhotoLayout().previewItem.setText(LocaleController.getString(C3286R.string.AttachMediaPreviewButton));
        }
    ...
    public class GroupCalculator {
        ...
        /* JADX WARN: Removed duplicated region for block: B:235:0x07da A[LOOP:2: B:234:0x07d8->B:235:0x07da, LOOP_END] */
        /*
        ...
        */
        public void calculate() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.ChatAttachAlertPhotoLayoutPreview.GroupCalculator.calculate():void");
        }
        ...
        public int getWidth() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                int i2 = groupedMessagePosition.f1436pw;
        ...
        public float getHeight() {
            ...
            for (int i = 0; i < size; i++) {
                MessageObject.GroupedMessagePosition groupedMessagePosition = this.posArray.get(i);
                float f = groupedMessagePosition.f1435ph;
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (groupedMessagePosition2 != groupedMessagePosition && groupedMessagePosition2.maxX < i3) {
                    ...
                    for (int max = Math.max(groupedMessagePosition2.minY - i, 0); max <= min; max++) {
                        fArr[max] = fArr[max] + groupedMessagePosition2.f1436pw;
                    }
                }
            }
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (groupedMessagePosition2 != groupedMessagePosition && groupedMessagePosition2.maxY < i) {
                    for (int i4 = groupedMessagePosition2.minX; i4 <= groupedMessagePosition2.maxX; i4++) {
                        fArr[i4] = fArr[i4] + groupedMessagePosition2.f1435ph;
                    }
                }
            }
    ...
    public int getCurrentItemTop() {
        ...
        if (top < AndroidUtilities.m50dp(8) || holder == null || holder.getAdapterPosition() != 0) {
            top = m50dp;
        }
    ...
    */
    public void onPreMeasure(int r5, int r6) {
        /*
            ...
            int r0 = org.telegram.p048ui.ActionBar.C3351ActionBar.getCurrentActionBarHeight()
            r5.topMargin = r0
        ...
        L74:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.ChatAttachAlertPhotoLayoutPreview.onPreMeasure(int, int):void");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (themeDelegate != null && (wallpaperDrawable = themeDelegate.getWallpaperDrawable()) != null) {
            ...
            if (currentItemTop < C3351ActionBar.getCurrentActionBarHeight()) {
                currentItemTop -= AndroidUtilities.m51dp((1.0f - (currentItemTop / C3351ActionBar.getCurrentActionBarHeight())) * i);
            }
    ...
    public class PreviewGroupsView extends ViewGroup {
        ...
        public PreviewGroupsView(Context context) {
            ...
            this.paddingTop = AndroidUtilities.m50dp(16);
            this.paddingBottom = AndroidUtilities.m50dp(64);
            ...
            this.scroller = new Runnable() { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.2
                ...
                public void run() {
                    ...
                    float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - Math.max(0, computeVerticalScrollOffset - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding())) - AndroidUtilities.m50dp(52));
                    float max2 = Math.max((float) BitmapDescriptorFactory.HUE_RED, ((ChatAttachAlertPhotoLayoutPreview.this.listView.getMeasuredHeight() - (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - computeVerticalScrollOffset)) - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) - AndroidUtilities.m50dp(84));
                    float m50dp2 = AndroidUtilities.m50dp(32);
                    if (max < m50dp2 && computeVerticalScrollOffset > ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) {
                        m50dp = (-(1.0f - (max / m50dp2))) * AndroidUtilities.m50dp(6);
                    } else {
                        m50dp = max2 < m50dp2 ? AndroidUtilities.m50dp(6) * (1.0f - (max2 / m50dp2)) : BitmapDescriptorFactory.HUE_RED;
                    }
                    int i = (int) m50dp;
                    if (Math.abs(i) > 0 && ChatAttachAlertPhotoLayoutPreview.this.listView.canScrollVertically(i) && (m50dp <= BitmapDescriptorFactory.HUE_RED || !z)) {
                        ChatAttachAlertPhotoLayoutPreview.access$1416(ChatAttachAlertPhotoLayoutPreview.this, m50dp);
            ...
            chatActionCell.setCustomText(LocaleController.getString("AttachMediaDragHint", C3286R.string.AttachMediaDragHint));
        ...
        private int measureHeight() {
            return Math.max(measurePureHeight(), (AndroidUtilities.displaySize.y - C3351ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m50dp(45));
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                ...
                canvas.translate(dragTranslate.f1757x, dragTranslate.f1758y);
        ...
        Point dragTranslate() {
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                if (!ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding) {
                    ...
                    this.tmpPoint.f1757x = AndroidUtilities.lerp(rect2.left + (rect.width() / 2.0f), ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchX - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellLeft - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromWidth), this.draggingT);
                    this.tmpPoint.f1758y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1692y + rect2.top + (rect.height() / 2.0f), (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellTop - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromHeight)) + ChatAttachAlertPhotoLayoutPreview.this.draggingCellGroupY, this.draggingT);
                } else {
                    ...
                    this.tmpPoint.f1757x = AndroidUtilities.lerp(rect4.left + (rect3.width() / 2.0f), this.savedDragFromX, this.draggingT / this.savedDraggingT);
                    this.tmpPoint.f1758y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1692y + rect4.top + (rect3.height() / 2.0f), this.savedDragFromY, this.draggingT / this.savedDraggingT);
                }
                return this.tmpPoint;
            }
            Point point = this.tmpPoint;
            point.f1757x = BitmapDescriptorFactory.HUE_RED;
            point.f1758y = BitmapDescriptorFactory.HUE_RED;
            return point;
        }
        ...
        void stopDragging() {
            ...
            this.savedDragFromX = dragTranslate.f1757x;
            this.savedDragFromY = dragTranslate.f1758y;
        ...
        void startDragging(PreviewGroupCell.MediaCell mediaCell) {
            ...
            ChatAttachAlertPhotoLayoutPreview chatAttachAlertPhotoLayoutPreview = ChatAttachAlertPhotoLayoutPreview.this;
            chatAttachAlertPhotoLayoutPreview.draggingCellGroupY = chatAttachAlertPhotoLayoutPreview.draggingCell.groupCell.f1692y;
            ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding = false;
            this.draggingT = BitmapDescriptorFactory.HUE_RED;
            invalidate();
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator != null) {
            ...
            public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC$FileLocation tLRPC$FileLocation, int i, boolean z) {
                ...
                if (i >= 0 && i < this.photos.size() && isPhotoChecked(i) && (photoEntry = this.photos.get(i)) != null) {
                    ...
                    if (previewGroupCell != null && mediaCell != null) {
                        ...
                        placeProviderObject.viewY = iArr[1] + ((int) previewGroupCell.f1692y);
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.onTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        public class PreviewGroupCell {
            ...
            private PreviewGroupCell() {
                this.f1692y = BitmapDescriptorFactory.HUE_RED;
                this.indexStart = 0;
                ...
                this.padding = AndroidUtilities.m50dp(4);
                int m50dp = AndroidUtilities.m50dp(2);
                this.gap = m50dp;
                this.halfGap = m50dp / 2;
            ...
            public class MediaCell {
                ...
                public void layout(GroupCalculator groupCalculator, MessageObject.GroupedMessagePosition groupedMessagePosition, boolean z) {
                    ...
                    float f5 = f3 / f4;
                    float f6 = groupedMessagePosition.f1435ph / f4;
                    this.scale = 1.0f;
                    this.rect.set(f2, f5, (groupedMessagePosition.f1436pw / i) + f2, f6 + f5);
                    ...
                    float f7 = (i2 & 5) == 5 ? m50dp2 : m50dp;
                    float f8 = (i2 & 6) == 6 ? m50dp2 : m50dp;
                    float f9 = (i2 & 10) == 10 ? m50dp2 : m50dp;
                    if ((i2 & 9) == 9) {
                        m50dp = m50dp2;
                    }
                    rectF4.set(f7, f8, f9, m50dp);
                    if (this.fromRect == null) {
                ...
                private void drawPhotoIndex(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    String str2;
                    int m50dp = AndroidUtilities.m50dp(12);
                    int m51dp = AndroidUtilities.m51dp(1.2f);
                    int i = (m50dp + m51dp) * 2;
                    int i2 = m51dp * 4;
                    if (str != null && (this.indexBitmap == null || (str2 = this.indexBitmapText) == null || !str2.equals(str))) {
                        ...
                        this.textPaint.setTextSize(AndroidUtilities.m51dp(f5));
                        float f6 = i / 2.0f;
                        ...
                        this.strokePaint.setStrokeWidth(m51dp);
                        canvas2.drawCircle(f7, f7, f8, this.strokePaint);
                        canvas2.drawText(str, f6 - (this.textPaint.measureText(str) / 2.0f), f6 + AndroidUtilities.m50dp(1) + AndroidUtilities.m51dp(f5 / 4.0f), this.textPaint);
                ...
                private void drawDuration(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    if (str != null) {
                        if (this.videoDurationBitmap == null || (str2 = this.videoDurationBitmapText) == null || !str2.equals(str)) {
                            ...
                            this.videoDurationTextPaint.setTextSize(m50dp);
                            float intrinsicWidth = ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + this.videoDurationTextPaint.measureText(str) + AndroidUtilities.m50dp(15);
                            float max = Math.max(m50dp, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + AndroidUtilities.m50dp(4));
                            ...
                            canvas2.drawRoundRect(rectF, AndroidUtilities.m50dp(4), AndroidUtilities.m50dp(4), Theme.chat_timeBackgroundPaint);
                            int m50dp2 = AndroidUtilities.m50dp(5);
                            int intrinsicHeight = (int) ((max - ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight()) / 2.0f);
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.setBounds(m50dp2, intrinsicHeight, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + m50dp2, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + intrinsicHeight);
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.draw(canvas2);
                            canvas2.drawText(str, AndroidUtilities.m50dp(18), m50dp + AndroidUtilities.m51dp(-0.7f), this.videoDurationTextPaint);
                ...
                */
                public boolean draw(android.graphics.Canvas r20, float r21, boolean r22) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.PreviewGroupCell.MediaCell.draw(android.graphics.Canvas, float, boolean):boolean");
                }
            }
