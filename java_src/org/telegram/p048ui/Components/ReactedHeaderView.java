...
/* renamed from: org.telegram.ui.Components.ReactedHeaderView */
...
public class ReactedHeaderView extends FrameLayout {
    ...
    public ReactedHeaderView(Context context, int i, MessageObject messageObject, long j) {
        ...
        Drawable mutate = ContextCompat.getDrawable(context, C3316R.C3318drawable.msg_reactions).mutate();
    ...
    /* renamed from: org.telegram.ui.Components.ReactedHeaderView$UserSeen */
    /* loaded from: classes6.dex */
    ...
    public /* synthetic */ void lambda$onAttachedToWindow$5(long j, TLRPC$Chat tLRPC$Chat, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject instanceof TLRPC$Vector) {
            ...
            if (ChatObject.isChannel(tLRPC$Chat)) {
                ...
                tLRPC$TL_channels_getParticipants.channel = MessagesController.getInstance(this.currentAccount).getInputChannel(tLRPC$Chat.f1502id);
            ...
            tLRPC$TL_messages_getFullChat.chat_id = tLRPC$Chat.f1502id;
        ...
        while (it.hasNext()) {
            ...
            while (true) {
                if (i >= this.users.size()) {
                    break;
                } else if (this.users.get(i).user.f1642id == userSeen.user.f1642id) {
                    if (userSeen.date > 0) {
    ...
    public /* synthetic */ void lambda$onAttachedToWindow$1(TLObject tLObject, List list, List list2, List list3, Runnable runnable) {
        if (tLObject != null) {
            ...
            for (int i = 0; i < tLRPC$TL_channels_channelParticipants.users.size(); i++) {
                ...
                int indexOf = list.indexOf(Long.valueOf(tLRPC$User.f1642id));
    ...
    public /* synthetic */ void lambda$loadReactions$6(int i, TLRPC$TL_messages_messageReactionsList tLRPC$TL_messages_messageReactionsList) {
        ...
        while (it.hasNext()) {
            ...
            TLRPC$Peer tLRPC$Peer = this.message.messageOwner.from_id;
            if (tLRPC$Peer != null && next.f1642id != tLRPC$Peer.user_id) {
                int i2 = 0;
                while (true) {
                    if (i2 >= this.users.size()) {
                        z2 = false;
                        break;
                    } else if (this.users.get(i2).user.f1642id == next.f1642id) {
                        z2 = true;
                        break;
                    } else {
                        i2++;
    ...
    */
    private void updateView() {
        /*
            r6 = this;
            java.util.List<org.telegram.ui.Components.ReactedHeaderView$UserSeen> r0 = r6.users
            int r0 = r0.size()
            r1 = 1
            r2 = 0
            if (r0 <= 0) goto Lc
        ...
        L11:
            r3 = 3
            if (r0 >= r3) goto L39
            java.util.List<org.telegram.ui.Components.ReactedHeaderView$UserSeen> r3 = r6.users
            int r3 = r3.size()
            if (r0 >= r3) goto L2e
            ...
            org.telegram.ui.Components.ReactedHeaderView$UserSeen r5 = (org.telegram.p048ui.Components.ReactedHeaderView.UserSeen) r5
        ...
        L60:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.ReactedHeaderView.updateView():void");
    }
