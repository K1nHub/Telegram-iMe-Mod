...
public abstract class BottomSheetWithRecyclerListView extends BottomSheet {
    ...
    public BottomSheetWithRecyclerListView(BaseFragment baseFragment, boolean z, final boolean z2, boolean z3, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.headerShadowDrawable = ContextCompat.getDrawable(parentActivity, C3301R.C3303drawable.header_shadow).mutate();
        if (z3) {
        ...
        if (z2) {
            ...
            C3366ActionBar c3366ActionBar = new C3366ActionBar(parentActivity) { // from class: org.telegram.ui.Components.BottomSheetWithRecyclerListView.4
                @Override // android.view.View
            ...
            this.actionBar.setActionBarMenuOnItemClick(new C3366ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.BottomSheetWithRecyclerListView.5
    ...
    public void postDrawInternal(Canvas canvas, View view) {
        ...
        if (z) {
            ...
            if (f != 1.0f) {
                ...
                c3366ActionBar = this.actionBar;
                if (c3366ActionBar != null && c3366ActionBar.getVisibility() == 0 && this.actionBar.getAlpha() != BitmapDescriptorFactory.HUE_RED && this.shadowAlpha != BitmapDescriptorFactory.HUE_RED) {
    ...
    public void updateTitle() {
        C3366ActionBar c3366ActionBar = this.actionBar;
        if (c3366ActionBar != null) {
            c3366ActionBar.setTitle(getTitle());
        }
    }
