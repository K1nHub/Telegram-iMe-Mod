...
public class ProxyDrawable extends Drawable {
    ...
    public ProxyDrawable(Context context) {
        this.emptyDrawable = context.getResources().getDrawable(C3316R.C3318drawable.proxy_off);
        this.fullDrawable = context.getResources().getDrawable(C3316R.C3318drawable.proxy_on);
