...
public class StickerCategoriesListView extends RecyclerListView {
    ...
    public void setBackgroundColor(int i) {
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3316R.C3318drawable.gradient_right).mutate();
        this.leftBoundDrawable = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(i, PorterDuff.Mode.MULTIPLY));
        Drawable mutate2 = getContext().getResources().getDrawable(C3316R.C3318drawable.gradient_left).mutate();
    ...
    public class CategoryButton extends RLottieImageView {
        ...
        @Override // org.telegram.p048ui.Components.RLottieImageView
        ...
        */
        public static /* synthetic */ void lambda$getLocal$1(int r7, java.lang.Integer r8, org.telegram.messenger.Utilities.Callback2 r9) {
            ...
            L6f:
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.StickerCategoriesListView.EmojiGroupFetcher.lambda$getLocal$1(int, java.lang.Integer, org.telegram.messenger.Utilities$Callback2):void");
        }
