...
public class ShutterButton extends View {
    ...
    public ShutterButton(Context context) {
        ...
        this.shadowDrawable = getResources().getDrawable(C3158R.C3160drawable.camera_btn);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(measuredWidth - AndroidUtilities.m50dp(36), measuredHeight - AndroidUtilities.m50dp(36), AndroidUtilities.m50dp(36) + measuredWidth, AndroidUtilities.m50dp(36) + measuredHeight);
        ...
        if (this.pressed || getScaleX() != 1.0f) {
            ...
            canvas.drawCircle(f, f2, AndroidUtilities.m50dp(26), this.whitePaint);
            if (this.state == State.RECORDING) {
                ...
                canvas.drawCircle(f, f2, AndroidUtilities.m51dp(26.5f) * scaleX * this.redProgress, this.redPaint);
            } else if (this.redProgress != BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(f, f2, AndroidUtilities.m51dp(26.5f) * scaleX, this.redPaint);
            }
        } else if (this.redProgress != BitmapDescriptorFactory.HUE_RED) {
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m50dp(84), AndroidUtilities.m50dp(84));
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString("AccActionTakePicture", C3158R.string.AccActionTakePicture)));
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_LONG_CLICK.getId(), LocaleController.getString("AccActionRecordVideo", C3158R.string.AccActionRecordVideo)));
        }
    }
}
