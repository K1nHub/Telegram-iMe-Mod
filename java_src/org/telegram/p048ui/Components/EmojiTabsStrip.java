...
public class EmojiTabsStrip extends ScrollableHorizontalScrollView {
    ...
    private static int[] emojiTabsDrawableIds = {C3316R.C3318drawable.msg_emoji_smiles, C3316R.C3318drawable.msg_emoji_cat, C3316R.C3318drawable.msg_emoji_food, C3316R.C3318drawable.msg_emoji_activities, C3316R.C3318drawable.msg_emoji_travel, C3316R.C3318drawable.msg_emoji_objects, C3316R.C3318drawable.msg_emoji_other, C3316R.C3318drawable.msg_emoji_flags};
    private static int[] emojiTabsAnimatedDrawableIds = {C3316R.C3321raw.msg_emoji_smiles, C3316R.C3321raw.msg_emoji_cat, C3316R.C3321raw.msg_emoji_food, C3316R.C3321raw.msg_emoji_activities, C3316R.C3321raw.msg_emoji_travel, C3316R.C3321raw.msg_emoji_objects, C3316R.C3321raw.msg_emoji_other, C3316R.C3321raw.msg_emoji_flags};
    ...
    public EmojiTabsStrip(Context context, Theme.ResourcesProvider resourcesProvider, boolean z, final boolean z2, int i, Runnable runnable) {
        super(context);
        this.recentDrawableId = C3316R.C3318drawable.msg_emoji_recent;
        this.settingsDrawableId = C3316R.C3318drawable.smiles_tab_settings;
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.Components.EmojiTabsStrip.1
            ...
            /* renamed from: to */
            private RectF f1712to = new RectF();
                ...
                if (z2) {
                    ...
                    for (int i7 = 0; i7 < getChildCount(); i7++) {
                        ...
                        if (childAt != EmojiTabsStrip.this.settingsTab && !EmojiTabsStrip.this.removingViews.containsKey(childAt) && childAt != null) {
                            ...
                            Integer valueOf = z4 ? ((EmojiTabButton) childAt).f1713id : childAt instanceof EmojiTabsView ? Integer.valueOf(((EmojiTabsView) childAt).f1714id) : null;
                    ...
                    if (EmojiTabsStrip.this.settingsTab != null) {
                        ...
                        Integer num = EmojiTabsStrip.this.settingsTab.f1713id;
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                getChildBounds((int) Math.ceil(EmojiTabsStrip.this.selectT), this.f1712to);
                AndroidUtilities.lerp(this.from, this.f1712to, EmojiTabsStrip.this.selectT - floor, this.rect);
        ...
        if (i == 4) {
            ...
            EmojiTabButton emojiTabButton = new EmojiTabButton(context, C3316R.C3318drawable.msg_emoji_stickers, false, false);
            this.toggleEmojiStickersTab = emojiTabButton;
            linearLayout2.addView(emojiTabButton);
        }
        if (i == 3) {
            this.recentDrawableId = C3316R.C3318drawable.msg_emoji_smiles;
        }
        ...
        this.recentTab.f1713id = -934918565;
        if (z2) {
            if (z) {
                ...
                this.emojiTabs.f1714id = 3552126;
            }
            ...
            if (runnable != null) {
                ...
                this.settingsTab.f1713id = 1434631203;
    ...
    private TLRPC$Document getThumbDocument(TLRPC$StickerSet tLRPC$StickerSet, ArrayList<TLRPC$Document> arrayList) {
        ...
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (tLRPC$Document.f1510id == tLRPC$StickerSet.thumb_document_id) {
    ...
    public static class DelayedAnimatedEmojiDrawable extends Drawable {
        ...
        public DelayedAnimatedEmojiDrawable(int i, int i2, TLRPC$Document tLRPC$Document) {
            ...
            if (tLRPC$Document != null) {
                this.documentId = tLRPC$Document.f1510id;
            }
        }
    ...
    public class EmojiTabButton extends ViewGroup {
        ...
        public void setLock(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                this.lockView.setImageResource(C3316R.C3318drawable.msg_mini_lockedemoji);
                return;
            }
            Drawable mutate = getResources().getDrawable(C3316R.C3318drawable.msg_mini_addemoji).mutate();
