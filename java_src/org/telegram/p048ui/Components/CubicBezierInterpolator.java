...
public class CubicBezierInterpolator implements Interpolator {
    ...
    /* renamed from: a */
    protected PointF f1704a;

    /* renamed from: b */
    protected PointF f1705b;

    /* renamed from: c */
    protected PointF f1706c;
    ...
    public CubicBezierInterpolator(PointF pointF, PointF pointF2) throws IllegalArgumentException {
        ...
        this.f1705b = new PointF();
        this.f1706c = new PointF();
        float f = pointF.x;
    ...
    protected float getBezierCoordinateY(float f) {
        PointF pointF = this.f1706c;
        PointF pointF2 = this.start;
        float f2 = pointF2.y * 3.0f;
        pointF.y = f2;
        PointF pointF3 = this.f1705b;
        float f3 = ((this.end.y - pointF2.y) * 3.0f) - f2;
        pointF3.y = f3;
        PointF pointF4 = this.f1704a;
    ...
    private float getXDerivate(float f) {
        return this.f1706c.x + (f * ((this.f1705b.x * 2.0f) + (this.f1704a.x * 3.0f * f)));
    }
