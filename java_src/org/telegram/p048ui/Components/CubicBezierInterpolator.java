...
public class CubicBezierInterpolator implements Interpolator {
    ...
    /* renamed from: a */
    protected PointF f1696a;

    /* renamed from: b */
    protected PointF f1697b;

    /* renamed from: c */
    protected PointF f1698c;
    ...
    public CubicBezierInterpolator(PointF pointF, PointF pointF2) throws IllegalArgumentException {
        this.f1696a = new PointF();
        this.f1697b = new PointF();
        this.f1698c = new PointF();
        float f = pointF.x;
    ...
    protected float getBezierCoordinateY(float f) {
        PointF pointF = this.f1698c;
        PointF pointF2 = this.start;
        float f2 = pointF2.y * 3.0f;
        pointF.y = f2;
        PointF pointF3 = this.f1697b;
        float f3 = ((this.end.y - pointF2.y) * 3.0f) - f2;
        pointF3.y = f3;
        PointF pointF4 = this.f1696a;
    ...
    private float getXDerivate(float f) {
        return this.f1698c.x + (f * ((this.f1697b.x * 2.0f) + (this.f1696a.x * 3.0f * f)));
    }
