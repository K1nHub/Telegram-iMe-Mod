...
public class TranscribeButton {
    ...
    public void draw(Canvas canvas, float f) {
        ...
        canvas.restore();
        float f3 = this.loadingFloat.set(this.loading ? 1.0f : BitmapDescriptorFactory.HUE_RED);
        if (f3 > BitmapDescriptorFactory.HUE_RED) {
            ...
            float f4 = segments[0] + ((1.0f - f3) * max * (this.loading ? BitmapDescriptorFactory.HUE_RED : 1.0f));
            float f5 = (max * f3) + f4;
            float f6 = f4 % 360.0f;
            float f7 = f5 % 360.0f;
    ...
    public static class LoadingPointsSpan extends ImageSpan {
        ...
        */
        public LoadingPointsSpan() {
            /*
                r6 = this;
                org.telegram.ui.Components.TranscribeButton$LoadingPointsDrawable r0 = org.telegram.p048ui.Components.TranscribeButton.LoadingPointsSpan.drawable
                if (r0 != 0) goto Ld
                ...
                android.text.TextPaint r1 = org.telegram.p048ui.ActionBar.Theme.chat_msgTextPaint
                r0.<init>(r1)
                org.telegram.p048ui.Components.TranscribeButton.LoadingPointsSpan.drawable = r0
            Ld:
                r1 = 0
                r6.<init>(r0, r1)
                android.text.TextPaint r0 = org.telegram.p048ui.ActionBar.Theme.chat_msgTextPaint
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.TranscribeButton.LoadingPointsSpan.<init>():void");
        }
