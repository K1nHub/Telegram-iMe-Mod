...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
        ...
        FrameLayout frameLayout = new FrameLayout(activity) { // from class: org.telegram.ui.Components.PipRoundVideoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (drawable != null) {
                    ...
                    Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m50dp(1), AndroidUtilities.m50dp(2), AndroidUtilities.m50dp(125), AndroidUtilities.m50dp(125));
                    Theme.chat_roundVideoShadow.draw(canvas);
                    Theme.chat_docBackPaint.setColor(Theme.getColor("chat_inBubble"));
                    Theme.chat_docBackPaint.setAlpha((int) (getAlpha() * 255.0f));
                    canvas.drawCircle(AndroidUtilities.m50dp(63), AndroidUtilities.m50dp(63), AndroidUtilities.m51dp(59.5f), Theme.chat_docBackPaint);
                }
            }
        };
        this.windowView = frameLayout;
        frameLayout.setWillNotDraw(false);
        this.videoWidth = AndroidUtilities.m50dp(126);
        this.videoHeight = AndroidUtilities.m50dp(126);
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            aspectRatioFrameLayout.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.telegram.ui.Components.PipRoundVideoView.3
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setOval(0, 0, AndroidUtilities.m50dp(120), AndroidUtilities.m50dp(120));
                }
            });
    ...
    private static int getSideCoord(boolean z, int i, float f, int i2) {
        ...
        if (z) {
            ...
            i2 = C3222ActionBar.getCurrentActionBarHeight();
        }
        int i4 = i3 - i2;
        if (i == 0) {
        ...
        return !z ? round + C3222ActionBar.getCurrentActionBarHeight() : round;
    }
    ...
    */
    public void animateToBoundsMaybe() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }
