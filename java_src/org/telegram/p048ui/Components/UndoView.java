...
public class UndoView extends FrameLayout {
    ...
    private boolean isTooltipAction() {
        ...
        return i == IdFabric$CustomType.UNDO_MOVE_TO_FOLDER || i == 6 || i == 3 || i == 5 || i == 7 || i == 8 || i == 87 || i == 9 || i == 10 || i == 13 || i == 14 || i == 19 || i == 20 || i == 21 || i == 22 || i == 23 || i == 30 || i == 31 || i == 32 || i == 33 || i == 34 || i == 35 || i == 36 || i == 74 || i == 37 || i == 38 || i == 39 || i == 40 || i == 42 || i == 43 || i == 77 || i == 44 || i == 78 || i == 79 || i == 100 || i == 101 || i == ACTION_RINGTONE_ADDED;
    }

    private boolean hasSubInfo() {
        int i;
        int i2 = this.currentAction;
        return i2 == 11 || i2 == 24 || i2 == 6 || i2 == 3 || i2 == 5 || i2 == 13 || i2 == 14 || i2 == 74 || (i2 == 7 && ((FiltersController.getInstance(this.currentAccount).isHideFoldersEnabled() || MessagesController.getInstance(this.currentAccount).dialogFilters.isEmpty()) && FiltersController.getInstance(this.currentAccount).getActiveSortingTabsCount(false) == 0)) || (i = this.currentAction) == ACTION_RINGTONE_ADDED || i == 85;
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$showWithAction$6(TLRPC$Message tLRPC$Message, View view) {
        ...
        tLRPC$TL_payments_getPaymentReceipt.msg_id = tLRPC$Message.f1526id;
