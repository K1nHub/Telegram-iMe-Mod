...
import org.telegram.p048ui.Components.Paint.Painting;
import org.telegram.p048ui.Components.Size;
/* renamed from: org.telegram.ui.Components.Paint.Painting */
...
public class Painting {
    ...
    /* renamed from: org.telegram.ui.Components.Paint.Painting$PaintingDelegate */
    /* loaded from: classes6.dex */
    ...
    /* renamed from: org.telegram.ui.Components.Paint.Painting$PaintingData */
    /* loaded from: classes6.dex */
    ...
    public Painting(Size size, Bitmap bitmap, int i) {
        ...
        this.projection = GLMatrix.LoadOrtho(BitmapDescriptorFactory.HUE_RED, size2.width, BitmapDescriptorFactory.HUE_RED, size2.height, -1.0f, 1.0f);
    ...
    public RectF getBounds() {
        Size size = this.size;
        return new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, size.width, size.height);
    }
    ...
    public /* synthetic */ void lambda$setHelperShape$2(Shape shape) {
        ...
        if (this.helperShown != (shape != null)) {
            ...
            fArr[1] = this.helperShown ? 1.0f : BitmapDescriptorFactory.HUE_RED;
            ...
            this.helperAnimator.addListener(new C47971());
    ...
    /* loaded from: classes6.dex */
    public class C47971 extends AnimatorListenerAdapter {
        C47971() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            Painting.this.renderView.performInContext(new Runnable() { // from class: org.telegram.ui.Components.Paint.Painting$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Painting.C47971.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    public boolean applyHelperShape() {
        ...
        this.helperApplyAnimator.addListener(new C47982());
    ...
    /* loaded from: classes6.dex */
    public class C47982 extends AnimatorListenerAdapter {
        C47982() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            Painting.this.renderView.performInContext(new Runnable() { // from class: org.telegram.ui.Components.Paint.Painting$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Painting.C47982.this.lambda$onAnimationEnd$0();
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onAnimationEnd$0() {
            ...
            Painting.this.helperApplyAlpha = BitmapDescriptorFactory.HUE_RED;
            Painting.this.helperApplyAnimator = null;
        }
    }
    ...
    public Slice commitShapeInternal(Shape shape, int i, RectF rectF) {
        ...
        if (brush instanceof Brush.Shape) {
            GLES20.glUniform1i(shader.getUniform(SessionDescription.ATTR_TYPE), shape.getType());
            int uniform = shader.getUniform("resolution");
            Size size2 = this.size;
            GLES20.glUniform2f(uniform, size2.width, size2.height);
            GLES20.glUniform2f(shader.getUniform(TtmlNode.CENTER), shape.centerX, shape.centerY);
        ...
        this.helperApplyAlpha = BitmapDescriptorFactory.HUE_RED;
        this.helperShown = false;
        this.helperAlpha = BitmapDescriptorFactory.HUE_RED;
    ...
    public Slice commitPathInternal(Path path, int i, RectF rectF) {
        ...
        GLES20.glUniform1i(shader.getUniform("texture"), 0);
        GLES20.glUniform1i(shader.getUniform("mask"), 1);
        Shader.SetColorUniform(shader.getUniform(TtmlNode.ATTR_TTS_COLOR), ColorUtils.setAlphaComponent(i, (int) (Color.alpha(i) * brush.getOverrideAlpha())));
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, getTexture());
        GLES20.glTexParameteri(3553, 10241, 9729);
        GLES20.glActiveTexture(33985);
    ...
    public void render() {
        ...
        if (i == 0 || this.helperShape == null || this.helperAlpha <= BitmapDescriptorFactory.HUE_RED) {
            return;
        }
    ...
    private void renderBlitShape(int i, int i2, Shape shape, float f) {
        ...
        Shader.SetColorUniform(shader.getUniform(TtmlNode.ATTR_TTS_COLOR), ColorUtils.setAlphaComponent(currentColor, (int) (Color.alpha(currentColor) * f)));
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, i);
        GLES20.glActiveTexture(33985);
        GLES20.glBindTexture(3553, i2);
        if (brush instanceof Brush.Shape) {
            GLES20.glUniform1i(shader.getUniform(SessionDescription.ATTR_TYPE), ((Brush.Shape) brush).getShapeShaderType());
            int uniform = shader.getUniform("resolution");
            Size size = this.size;
    ...
    private void renderBlitPath(int i, Path path, float f) {
        ...
        Shader.SetColorUniform(shader.getUniform(TtmlNode.ATTR_TTS_COLOR), ColorUtils.setAlphaComponent(color, (int) (Color.alpha(color) * brush.getOverrideAlpha() * f)));
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, getTexture());
        GLES20.glActiveTexture(33985);
        GLES20.glBindTexture(3553, i);
    ...
    public void setBrush(Brush brush) {
        ...
        canvas.drawBitmap(this.imageBitmap, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.imageBitmapPaint);
        canvas.restore();
        ...
        if (renderView != null && (resultBitmap = renderView.getResultBitmap()) != null) {
            ...
            canvas.drawBitmap(resultBitmap, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.imageBitmapPaint);
