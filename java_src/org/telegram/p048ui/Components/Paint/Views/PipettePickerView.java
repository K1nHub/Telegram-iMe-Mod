...
/* renamed from: org.telegram.ui.Components.Paint.Views.PipettePickerView */
...
public class PipettePickerView extends View {
    ...
    public PipettePickerView(Context context, Bitmap bitmap) {
        ...
        this.outlinePaint.setStrokeWidth(AndroidUtilities.m50dp(4));
        ...
        this.colorPaint.setStrokeWidth(AndroidUtilities.m50dp(12));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(this.dstRect, AndroidUtilities.m50dp(1), AndroidUtilities.m50dp(1), this.outlinePaint);
        canvas.restore();
    }
}
