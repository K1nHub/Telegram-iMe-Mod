...
public class RotationGestureDetector {
    ...
    /* renamed from: fX */
    private float f1729fX;

    /* renamed from: fY */
    private float f1730fY;
    private OnRotationGestureListener mListener;

    /* renamed from: sX */
    private float f1731sX;

    /* renamed from: sY */
    private float f1732sY;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    this.angle = angleBetweenLines(this.f1729fX, this.f1730fY, this.f1731sX, this.f1732sY, motionEvent.getX(1), motionEvent.getY(1), x, y);
        ...
        this.f1731sX = motionEvent.getX(0);
        this.f1732sY = motionEvent.getY(0);
        this.f1729fX = motionEvent.getX(1);
        this.f1730fY = motionEvent.getY(1);
        return true;
    }
