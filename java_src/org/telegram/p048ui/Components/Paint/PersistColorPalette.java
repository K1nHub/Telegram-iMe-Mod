...
public class PersistColorPalette {
    ...
    private static PersistColorPalette[] instances = new PersistColorPalette[5];
    ...
    public void selectColorIndex(int i) {
        ...
        for (int i2 = 0; i2 < 14; i2++) {
            if (i2 < arrayList.size() && ((Integer) arrayList.get(i2)).intValue() != intValue) {
