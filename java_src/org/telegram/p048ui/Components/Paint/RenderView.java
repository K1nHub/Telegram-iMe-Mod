...
public class RenderView extends TextureView {
    ...
    public RenderView(Context context, Painting painting, Bitmap bitmap) {
        ...
        setSurfaceTextureListener(new TextureView$SurfaceTextureListenerC46271());
        ...
        this.painting.setDelegate(new Painting.PaintingDelegate() { // from class: org.telegram.ui.Components.Paint.RenderView.2
            @Override // org.telegram.p048ui.Components.Paint.Painting.PaintingDelegate
    ...
    /* loaded from: classes6.dex */
    public class TextureView$SurfaceTextureListenerC46271 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        }

        TextureView$SurfaceTextureListenerC46271() {
        }
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
            ...
            RenderView.this.post(new Runnable() { // from class: org.telegram.ui.Components.Paint.RenderView$1$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    RenderView.TextureView$SurfaceTextureListenerC46271.this.lambda$onSurfaceTextureAvailable$0();
                }
            });
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
            ...
            RenderView.this.internal.postRunnable(new Runnable() { // from class: org.telegram.ui.Components.Paint.RenderView$1$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    RenderView.TextureView$SurfaceTextureListenerC46271.this.lambda$onSurfaceTextureSizeChanged$1();
                }
            });
        }
        ...
        public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
            if (RenderView.this.internal != null && !RenderView.this.shuttingDown) {
                RenderView.this.painting.onPause(new Runnable() { // from class: org.telegram.ui.Components.Paint.RenderView$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        RenderView.TextureView$SurfaceTextureListenerC46271.this.lambda$onSurfaceTextureDestroyed$2();
                    }
                });
            }
            return true;
    ...
    public class CanvasInternal extends DispatchQueue {
        ...
        public CanvasInternal(SurfaceTexture surfaceTexture) {
            ...
            this.drawRunnable = new RunnableC46291();
        ...
        /* loaded from: classes6.dex */
        public class RunnableC46291 implements Runnable {
            RunnableC46291() {
            }
            ...
            public void run() {
                ...
                if (!RenderView.this.firstDrawSent) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Paint.RenderView$CanvasInternal$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            RenderView.CanvasInternal.RunnableC46291.this.lambda$run$0();
                        }
                    });
                }
