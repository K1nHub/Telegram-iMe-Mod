...
public class UpdateAppAlertDialog extends BottomSheet {
    ...
    public UpdateAppAlertDialog(Context context, TLRPC$TL_help_appUpdate tLRPC$TL_help_appUpdate, int i) {
        ...
        textView.setText(LocaleController.getString("AppUpdate", C3286R.string.AppUpdate));
        ...
        int i2 = C3286R.string.AppUpdateVersionAndSize;
        ...
        if (TextUtils.isEmpty(this.appUpdate.text)) {
            textView3.setText(AndroidUtilities.replaceTags(LocaleController.getString("AppUpdateChangelogEmpty", C3286R.string.AppUpdateChangelogEmpty)));
        } else {
        ...
        bottomSheetCell.setText(LocaleController.formatString("AppUpdateDownloadNow", C3286R.string.AppUpdateDownloadNow, new Object[0]), false);
        ...
        bottomSheetCell2.setText(LocaleController.getString("AppUpdateRemindMeLater", C3286R.string.AppUpdateRemindMeLater), false);
