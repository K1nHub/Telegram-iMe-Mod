...
public class RecyclerAnimationScrollHelper {
    ...
    public void scrollToPosition(int i, int i2, boolean z, boolean z2) {
        ...
        if (recyclerListView.getItemAnimator() == null || !this.recyclerView.getItemAnimator().isRunning()) {
            ...
            this.recyclerView.addOnLayoutChangeListener(new View$OnLayoutChangeListenerC48711(adapter, arrayList, z3, animatableAdapter));
        }
    }
    ...
    /* loaded from: classes6.dex */
    public class View$OnLayoutChangeListenerC48711 implements View.OnLayoutChangeListener {
        ...
        View$OnLayoutChangeListenerC48711(RecyclerView.Adapter adapter, ArrayList arrayList, boolean z, AnimatableAdapter animatableAdapter) {
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.RecyclerAnimationScrollHelper$1$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    RecyclerAnimationScrollHelper.View$OnLayoutChangeListenerC48711.this.lambda$onLayoutChange$0(arrayList2, z2, i16, arrayList, valueAnimator2);
                }
            });
            RecyclerAnimationScrollHelper.this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.RecyclerAnimationScrollHelper.1.1
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    Iterator it2 = View$OnLayoutChangeListenerC48711.this.val$oldViews.iterator();
                    while (it2.hasNext()) {
                    ...
                    AnimatableAdapter animatableAdapter = View$OnLayoutChangeListenerC48711.this.val$finalAnimatableAdapter;
                    if (animatableAdapter != null) {
