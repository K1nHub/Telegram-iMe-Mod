...
public class ChatAttachRestrictedLayout extends ChatAttachAlert.AttachAlertLayout {
    ...
    public ChatAttachRestrictedLayout(int i, ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        emptyTextProgressView.setText(LocaleController.getString("NoPhotos", C3316R.string.NoPhotos));
        ...
        emptyTextProgressView.setLottie(C3316R.C3321raw.media_forbidden, ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        ...
        recyclerListView.setPadding(0, 0, 0, AndroidUtilities.m50dp(48));
    ...
    */
    public void onPreMeasure(int r4, int r5) {
        /*
            ...
            int r4 = org.telegram.p048ui.ActionBar.C3381ActionBar.getCurrentActionBarHeight()
            int r4 = r5 - r4
            r0 = 0
        ...
        L3c:
            ...
            org.telegram.ui.Components.RecyclerListView r4 = r3.listView
            r5 = 6
            int r1 = org.telegram.messenger.AndroidUtilities.m50dp(r5)
            int r5 = org.telegram.messenger.AndroidUtilities.m50dp(r5)
            r2 = 48
        ...
        L58:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.ChatAttachRestrictedLayout.onPreMeasure(int, int):void");
    }
}
