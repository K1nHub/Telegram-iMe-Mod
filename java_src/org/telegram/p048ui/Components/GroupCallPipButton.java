...
public class GroupCallPipButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public GroupCallPipButton(Context context, int i, boolean z) {
        ...
        this.blobDrawable.maxRadius = AndroidUtilities.m50dp(37);
        this.blobDrawable.minRadius = AndroidUtilities.m50dp(32);
        this.blobDrawable2.maxRadius = AndroidUtilities.m50dp(37);
        this.blobDrawable2.minRadius = AndroidUtilities.m50dp(32);
        this.blobDrawable.generateBlob();
        this.blobDrawable2.generateBlob();
        int i3 = C3158R.C3164raw.voice_outlined;
        ...
        this.prepareToRemoveShader = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m50dp(350), (float) BitmapDescriptorFactory.HUE_RED, new int[]{-2801343, -561538, 0}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.4f, 1.0f}, Shader.TileMode.CLAMP);
        if (z) {
            setState(0);
        }
    }
    ...
    public static class WeavingState {
        ...
        public void update(long j, float f) {
            ...
            int m50dp = AndroidUtilities.m50dp((int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
    ...
    */
    ...
    public void setState(int i) {
        ...
        if (weavingState == null || weavingState.currentState != i) {
            ...
            if (sharedInstance != null && ChatObject.isChannelOrGiga(sharedInstance.getChat())) {
                string = LocaleController.getString("VoipChannelVoiceChat", C3158R.string.VoipChannelVoiceChat);
            } else {
                string = LocaleController.getString("VoipGroupVoiceChat", C3158R.string.VoipGroupVoiceChat);
            }
            if (i == 0) {
                string = string + ", " + LocaleController.getString("VoipTapToMute", C3158R.string.VoipTapToMute);
            } else if (i == 2) {
                string = string + ", " + LocaleController.getString("Connecting", C3158R.string.Connecting);
            } else if (i == 3) {
                string = string + ", " + LocaleController.getString("VoipMutedByAdmin", C3158R.string.VoipMutedByAdmin);
            }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (GroupCallPip.getInstance().showAlert) {
            i = C3158R.string.AccDescrCloseMenu;
            str = "AccDescrCloseMenu";
        } else {
            i = C3158R.string.AccDescrOpenMenu2;
