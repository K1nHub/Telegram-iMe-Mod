...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, final BaseFragment baseFragment, final TLRPC$ChatFull tLRPC$ChatFull, long j, boolean z2) {
        ...
        int i2 = C3316R.C3321raw.shared_link_enter;
        ...
        textView.setText(LocaleController.getString("InviteLink", C3316R.string.InviteLink));
        ...
        if (z2) {
            i = C3316R.string.LinkInfoChannel;
            str = "LinkInfoChannel";
        } else {
            i = C3316R.string.LinkInfo;
            str = "LinkInfo";
        }
        ...
        textView3.setText(LocaleController.getString("ManageInviteLinks", C3316R.string.ManageInviteLinks));
    ...
    public /* synthetic */ void lambda$new$1(TLRPC$ChatFull tLRPC$ChatFull, BaseFragment baseFragment, View view) {
        ManageLinksActivity manageLinksActivity = new ManageLinksActivity(tLRPC$ChatFull.f1503id, 0L, 0);
