...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, final BaseFragment baseFragment, final TLRPC$ChatFull tLRPC$ChatFull, long j, boolean z2) {
        ...
        int i2 = C3158R.C3164raw.shared_link_enter;
        ...
        textView.setText(LocaleController.getString("InviteLink", C3158R.string.InviteLink));
        ...
        if (z2) {
            i = C3158R.string.LinkInfoChannel;
            str = "LinkInfoChannel";
        } else {
            i = C3158R.string.LinkInfo;
            str = "LinkInfo";
        }
        ...
        textView3.setText(LocaleController.getString("ManageInviteLinks", C3158R.string.ManageInviteLinks));
    ...
    public /* synthetic */ void lambda$new$1(TLRPC$ChatFull tLRPC$ChatFull, BaseFragment baseFragment, View view) {
        ManageLinksActivity manageLinksActivity = new ManageLinksActivity(tLRPC$ChatFull.f1495id, 0L, 0);
