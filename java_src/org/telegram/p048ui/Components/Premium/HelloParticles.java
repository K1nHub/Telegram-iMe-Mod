...
public class HelloParticles {
    ...
    public static class Drawable {
        ...
        /* renamed from: dt */
        private final float f1764dt = 1000.0f / AndroidUtilities.screenRefreshRate;
        ...
        private class Particle {
            ...
            /* renamed from: x */
            private float f1768x;

            /* renamed from: y */
            private float f1769y;
            ...
            public void draw(Canvas canvas, int i, long j) {
                if (!Drawable.this.paused) {
                    ...
                    float unused = Drawable.this.f1764dt;
                    Drawable drawable = Drawable.this;
                    float f = drawable.speedScale;
                    float f2 = this.inProgress;
                    if (f2 != 1.0f) {
                        float f3 = f2 + (drawable.f1764dt / ((float) this.duration));
                        this.inProgress = f3;
                        if (f3 > 1.0f) {
                ...
                if (this.bitmap != null) {
                    ...
                    canvas.translate(this.f1768x - (this.f1767w / 2.0f), this.f1769y - (this.f1765h / 2.0f));
                    canvas.scale(f4, f4, this.f1767w / 2.0f, this.f1765h / 2.0f);
            ...
            public void genPosition(long j, int i, boolean z) {
                ...
                if (staticLayout.getLineCount() <= 0) {
                    ...
                    this.f1766l = (int) this.staticLayout.getLineLeft(0);
                    this.f1767w = (int) this.staticLayout.getLineWidth(0);
                    this.f1765h = this.staticLayout.getHeight();
                }
                Bitmap bitmap = (Bitmap) Drawable.this.bitmaps.get(str);
                this.bitmap = bitmap;
                if (bitmap == null) {
                    this.bitmap = Bitmap.createBitmap(Math.max(1, this.f1767w - Math.max(0, this.f1766l)), Math.max(1, this.f1765h), Bitmap.Config.ARGB_8888);
                    Canvas canvas = new Canvas(this.bitmap);
                    canvas.translate(-this.f1766l, BitmapDescriptorFactory.HUE_RED);
                ...
                if (i % 2 == 0) {
                    f3 = rectF.centerX() - (this.f1767w / 2.0f);
                } else {
                    f2 = (this.f1767w / 2.0f) + rectF.centerX();
                }
                float f4 = f3 - f2;
                ...
                while (i4 < 10) {
                    ...
                    for (int i5 = i2; i5 < Drawable.this.particles.size(); i5++) {
                        ...
                        if (particle.set) {
                            float min = Math.min(Math.abs((particle.f1768x + ((particle.f1767w * (this.scale / Drawable.this.bitmapScale)) * 1.1f)) - abs3), Math.abs(particle.f1768x - abs3));
                            float f7 = particle.f1769y - abs4;
                ...
                this.f1768x = abs;
                this.f1769y = abs2;
                double atan2 = Math.atan2(abs - Drawable.this.rect.centerX(), this.f1769y - Drawable.this.rect.centerY());
                Math.sin(atan2);
                Math.cos(atan2);
