...
import org.telegram.p048ui.Components.Premium.HelloParticles;
...
public class VideoScreenPreview extends FrameLayout implements PagerHeaderView, NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoScreenPreview(Context context, SvgHelper.SvgDrawable svgDrawable, int i, int i2) {
        ...
        if (i2 == 1) {
            ...
            drawable.f1790k3 = 0.98f;
            drawable.f1789k2 = 0.98f;
            drawable.f1788k1 = 0.98f;
            ...
            drawable3.size1 = 6;
            drawable3.size1 = 4;
            drawable3.f1790k3 = 0.98f;
            drawable3.f1789k2 = 0.98f;
            drawable3.f1788k1 = 0.98f;
