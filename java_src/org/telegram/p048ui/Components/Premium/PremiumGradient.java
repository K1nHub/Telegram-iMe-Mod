...
public class PremiumGradient {
    ...
    private PremiumGradient() {
        ...
        int i = C3301R.C3303drawable.msg_premium_liststar;
        this.premiumStarDrawableMini = ContextCompat.getDrawable(context, i).mutate();
        this.premiumStarMenuDrawable = createGradientDrawable(ContextCompat.getDrawable(ApplicationLoader.applicationContext, C3301R.C3303drawable.msg_settings_premium));
        this.premiumStarMenuDrawable2 = createGradientDrawable(ContextCompat.getDrawable(ApplicationLoader.applicationContext, C3301R.C3303drawable.msg_premium_normal));
    ...
    public static class PremiumGradientTools {
        ...
        /* renamed from: cx */
        public float f1772cx;

        /* renamed from: cy */
        public float f1773cy;
        ...
        /* renamed from: x1 */
        public float f1774x1;

        /* renamed from: x2 */
        public float f1775x2;

        /* renamed from: y1 */
        public float f1776y1;

        /* renamed from: y2 */
        public float f1777y2;
        ...
        public PremiumGradientTools(String str, String str2, String str3, String str4, String str5) {
            ...
            this.f1774x1 = BitmapDescriptorFactory.HUE_RED;
            this.f1776y1 = 1.0f;
            this.f1775x2 = 1.5f;
            this.f1777y2 = BitmapDescriptorFactory.HUE_RED;
            this.colorKey1 = str;
            this.colorKey2 = str2;
            this.colorKey3 = str3;
            this.colorKey4 = str4;
        ...
        public void gradientMatrix(int i, int i2, int i3, int i4, float f, float f2) {
            ...
            if (this.exactly) {
                this.matrix.reset();
                this.matrix.postScale((i3 - i) / 100.0f, (i4 - i2) / 100.0f, this.f1772cx * 100.0f, this.f1773cy * 100.0f);
        ...
        public void chekColors() {
            ...
            iArr[4] = color5;
            if (color3 == 0) {
                float f = this.f1774x1 * 100.0f;
                float f2 = this.f1776y1 * 100.0f;
                float f3 = this.f1775x2 * 100.0f;
                float f4 = this.f1777y2 * 100.0f;
                ...
                float f5 = this.f1774x1 * 100.0f;
                float f6 = this.f1776y1 * 100.0f;
                float f7 = this.f1775x2 * 100.0f;
                float f8 = this.f1777y2 * 100.0f;
                ...
                float f9 = this.f1774x1 * 100.0f;
                float f10 = this.f1776y1 * 100.0f;
                float f11 = this.f1775x2 * 100.0f;
                float f12 = this.f1777y2 * 100.0f;
                ...
                float f13 = this.f1774x1 * 100.0f;
                float f14 = this.f1776y1 * 100.0f;
                float f15 = this.f1775x2 * 100.0f;
                float f16 = this.f1777y2 * 100.0f;
