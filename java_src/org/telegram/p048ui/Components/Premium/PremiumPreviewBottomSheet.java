...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC$User tLRPC$User, GiftPremiumBottomSheet.GiftTier giftTier, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumGradientTools.f1764y1 = 1.0f;
        premiumGradientTools.f1763x2 = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1765y2 = BitmapDescriptorFactory.HUE_RED;
    ...
    public void setTitle(boolean z) {
        ...
        if (this.statusStickerSet != null) {
            int i = C3158R.string.TelegramPremiumUserStatusDialogTitle;
                    ...
                    if (stickerSet.set != null) {
                        ...
                        while (true) {
                            if (i2 >= stickerSet.documents.size()) {
                                break;
                            } else if (stickerSet.documents.get(i2).f1502id == stickerSet.set.thumb_document_id) {
            ...
            this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3158R.string.TelegramPremiumUserStatusDialogSubtitle)));
        } else if (this.isEmojiStatus) {
            LinkSpanDrawable.LinksTextView linksTextView = linksTextViewArr[0];
            int i3 = C3158R.string.TelegramPremiumUserStatusDefaultDialogTitle;
            ...
            int i4 = C3158R.string.TelegramPremiumUserStatusDialogSubtitle;
            ...
            if (giftTier != null) {
                if (this.isOutboundGift) {
                    ...
                    int i5 = C3158R.string.TelegramPremiumUserGiftedPremiumOutboundDialogTitleWithPlural;
                    ...
                    int i6 = C3158R.string.TelegramPremiumUserGiftedPremiumOutboundDialogSubtitle;
                ...
                int i7 = C3158R.string.TelegramPremiumUserGiftedPremiumDialogTitleWithPlural;
                ...
                this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3158R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle)));
                return;
            }
            LinkSpanDrawable.LinksTextView linksTextView4 = linksTextViewArr[0];
            int i8 = C3158R.string.TelegramPremiumUserDialogTitle;
            ...
            this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3158R.string.TelegramPremiumUserDialogSubtitle)));
        }
    }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString("TelegramPremium", C3158R.string.TelegramPremium);
    }
    ...
    public boolean onCustomOpenAnimation() {
        ...
        this.enterAnimator.addListener(new C47934());
    ...
    /* loaded from: classes6.dex */
    public class C47934 extends AnimatorListenerAdapter {
        C47934() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$4$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    PremiumPreviewBottomSheet.C47934.this.lambda$onAnimationEnd$0(rightDrawable, valueAnimator);
                }
            });
            ofInt.start();
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.groupStickersDidLoad && (tLRPC$InputStickerSet = this.statusStickerSet) != null && tLRPC$InputStickerSet.f1517id == ((Long) objArr[0]).longValue()) {
            setTitle(true);
        }
    }
}
