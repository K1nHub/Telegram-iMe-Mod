...
public class PremiumTierCell extends ViewGroup {
    ...
    public PremiumTierCell(Context context) {
        ...
        setPadding(AndroidUtilities.m50dp(4), AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(4), AndroidUtilities.m50dp(8));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        rect.set(AndroidUtilities.m50dp(this.leftPaddingToCheckboxDp) + getPaddingLeft(), (int) ((getMeasuredHeight() - this.checkBox.getMeasuredHeight()) / 2.0f), 0, 0);
        checkRtlAndLayout(this.checkBox);
        int measuredHeight = (int) ((getMeasuredHeight() - this.pricePerMonthView.getMeasuredHeight()) / 2.0f);
        if (AndroidUtilities.m50dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp + 24) + this.checkBox.getMeasuredWidth() + (this.pricePerYearStrikeView.getVisibility() == 0 ? this.pricePerYearStrikeView.getMeasuredWidth() : 0) + this.pricePerYearView.getMeasuredWidth() + getPaddingLeft() > getMeasuredWidth() - this.pricePerMonthView.getMeasuredWidth() && this.discountView.getVisibility() == 0) {
            measuredHeight = getPaddingTop() + AndroidUtilities.m50dp(2);
        }
        rect.set(((getMeasuredWidth() - this.pricePerMonthView.getMeasuredWidth()) - AndroidUtilities.m50dp(16)) - getPaddingRight(), measuredHeight, 0, 0);
        checkRtlAndLayout(this.pricePerMonthView);
        rect.set(AndroidUtilities.m50dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp) + this.checkBox.getMeasuredWidth() + getPaddingLeft(), this.pricePerYearView.getVisibility() == 8 ? (int) ((getMeasuredHeight() - this.titleView.getMeasuredHeight()) / 2.0f) : getPaddingTop(), 0, 0);
        checkRtlAndLayout(this.titleView);
        if (this.discountView.getVisibility() == 0) {
            rect.set(AndroidUtilities.m50dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp + 6) + this.checkBox.getMeasuredWidth() + getPaddingLeft() + this.titleView.getMeasuredWidth(), getPaddingTop() + AndroidUtilities.m50dp(2), 0, 0);
            checkRtlAndLayout(this.discountView);
        }
        rect.set(AndroidUtilities.m50dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp) + this.checkBox.getMeasuredWidth() + getPaddingLeft(), (getMeasuredHeight() - this.pricePerYearStrikeView.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
        checkRtlAndLayout(this.pricePerYearStrikeView);
        rect.set(AndroidUtilities.m50dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp) + this.checkBox.getMeasuredWidth() + (this.pricePerYearStrikeView.getVisibility() == 0 ? this.pricePerYearStrikeView.getMeasuredWidth() + AndroidUtilities.m50dp(6) : 0) + getPaddingLeft(), (getMeasuredHeight() - this.pricePerYearView.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
    ...
    public void dispatchDraw(Canvas canvas) {
        if (this.isDrawingGradient) {
            ...
            rectF.set(this.pricePerMonthView.getLeft(), this.pricePerMonthView.getTop() + AndroidUtilities.m50dp(4), this.pricePerMonthView.getRight(), this.pricePerMonthView.getBottom() - AndroidUtilities.m50dp(4));
            canvas.drawRoundRect(rectF, AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(8), paint);
            rectF.set(this.pricePerYearStrikeView.getLeft(), this.pricePerYearStrikeView.getTop() + AndroidUtilities.m50dp(3), this.pricePerYearStrikeView.getRight(), this.pricePerYearStrikeView.getBottom() - AndroidUtilities.m50dp(3));
            canvas.drawRoundRect(rectF, AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(8), paint);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int m50dp = AndroidUtilities.m50dp(58);
        ...
        this.pricePerMonthView.measure(View.MeasureSpec.makeMeasureSpec(size - this.checkBox.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m50dp, Integer.MIN_VALUE));
        this.titleView.measure(View.MeasureSpec.makeMeasureSpec((size - this.checkBox.getMeasuredWidth()) - this.pricePerMonthView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m50dp, Integer.MIN_VALUE));
        if (this.discountView.getVisibility() == 0) {
            this.discountView.measure(View.MeasureSpec.makeMeasureSpec((size - this.checkBox.getMeasuredWidth()) - this.pricePerMonthView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m50dp, Integer.MIN_VALUE));
        } else {
            this.discountView.measure(View.MeasureSpec.makeMeasureSpec(0, 1073741824), View.MeasureSpec.makeMeasureSpec(0, 1073741824));
        }
        this.pricePerYearStrikeView.measure(View.MeasureSpec.makeMeasureSpec(size - this.checkBox.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m50dp, Integer.MIN_VALUE));
        this.pricePerYearView.measure(View.MeasureSpec.makeMeasureSpec(((size - this.checkBox.getMeasuredWidth()) - (this.pricePerYearStrikeView.getVisibility() == 0 ? this.pricePerYearStrikeView.getMeasuredWidth() : 0)) - AndroidUtilities.m50dp(6), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m50dp, Integer.MIN_VALUE));
    ...
    public void bind(PremiumPreviewFragment.SubscriptionTier subscriptionTier, boolean z) {
        ...
        if (months == 1) {
            this.titleView.setText(LocaleController.getString(C3158R.string.PremiumTierMonthly));
        } else if (months == 6) {
            this.titleView.setText(LocaleController.getString(C3158R.string.PremiumTierSemiannual));
        } else if (months != 12) {
            this.titleView.setText(LocaleController.formatPluralString("Months", subscriptionTier.getMonths(), new Object[0]));
        } else {
            this.titleView.setText(LocaleController.getString(C3158R.string.PremiumTierAnnual));
        }
        ...
        if (!z2) {
            if (subscriptionTier.getDiscount() <= 0) {
                ...
                this.discountView.setText(LocaleController.formatString(C3158R.string.GiftPremiumOptionDiscount, Integer.valueOf(subscriptionTier.getDiscount())));
            ...
            this.pricePerYearView.setText(LocaleController.formatString(C3158R.string.PricePerYear, subscriptionTier.getFormattedPricePerYear()));
            this.pricePerMonthView.setText(LocaleController.formatString(C3158R.string.PricePerMonthMe, subscriptionTier.getFormattedPricePerMonth()));
            if (subscriptionTier.subscriptionOption.current) {
                this.pricePerYearView.setVisibility(0);
                this.pricePerYearView.setText(LocaleController.getString(C3158R.string.YourCurrentPlan));
            }
        } else {
            this.discountView.setText(LocaleController.formatString(C3158R.string.GiftPremiumOptionDiscount, 10));
            this.discountView.setVisibility(0);
            this.pricePerYearStrikeView.setVisibility(0);
            this.pricePerYearView.setVisibility(0);
            this.pricePerYearStrikeView.setText("USD00.00");
            this.pricePerYearView.setText(LocaleController.formatString(C3158R.string.PricePerYear, 1000));
            this.pricePerMonthView.setText(LocaleController.formatString(C3158R.string.PricePerMonthMe, 100));
        }
        requestLayout();
    }
