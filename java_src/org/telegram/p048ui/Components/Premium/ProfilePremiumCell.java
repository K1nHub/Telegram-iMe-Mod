...
public class ProfilePremiumCell extends TextCell {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        float paddingTop = ((this.imageView.getPaddingTop() + this.imageView.getY()) + (this.imageView.getHeight() / 2.0f)) - AndroidUtilities.m50dp(3);
        this.drawable.rect.set(x - AndroidUtilities.m50dp(4), paddingTop - AndroidUtilities.m50dp(4), x + AndroidUtilities.m50dp(4), paddingTop + AndroidUtilities.m50dp(4));
        if (z) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // org.telegram.p048ui.Cells.TextCell, android.view.ViewGroup, android.view.View
