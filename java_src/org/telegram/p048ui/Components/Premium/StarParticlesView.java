...
public class StarParticlesView extends View {
    ...
    public static class Drawable {
        ...
        /* renamed from: k1 */
        public float f1788k1 = 0.85f;

        /* renamed from: k2 */
        public float f1789k2 = 0.85f;

        /* renamed from: k3 */
        public float f1790k3 = 0.9f;
        public long minLifeTime = ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS;
        public int randLifeTime = 1000;

        /* renamed from: dt */
        private final float f1787dt = 1000.0f / AndroidUtilities.screenRefreshRate;
        ...
        private void generateBitmaps() {
            ...
            for (int i5 = 0; i5 < 3; i5++) {
                ...
                if (i7 == 9) {
                    if (i5 == 0) {
                        i4 = C3316R.C3321raw.premium_object_folder;
                    } else if (i5 == 1) {
                        i4 = C3316R.C3321raw.premium_object_bubble;
                    } else {
                        i4 = C3316R.C3321raw.premium_object_settings;
                    }
                    this.stars[i5] = SvgHelper.getBitmap(i4, i6, i6, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey), 30));
                    this.svg = true;
                } else if (i7 == 11 || i7 == 4) {
                    if (i5 == 0) {
                        i = C3316R.C3321raw.premium_object_smile1;
                    } else if (i5 == 1) {
                        i = C3316R.C3321raw.premium_object_smile2;
                    } else {
                        i = C3316R.C3321raw.premium_object_like;
                    }
                    this.stars[i5] = SvgHelper.getBitmap(i, i6, i6, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey), 30));
                    this.svg = true;
                } else if (i7 == 3) {
                    if (i5 == 0) {
                        i3 = C3316R.C3321raw.premium_object_adsbubble;
                    } else if (i5 == 1) {
                        i3 = C3316R.C3321raw.premium_object_like;
                    } else {
                        i3 = C3316R.C3321raw.premium_object_noads;
                    }
                    this.stars[i5] = SvgHelper.getBitmap(i3, i6, i6, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey), 30));
                    this.svg = true;
                } else if (i7 == 7) {
                    if (i5 == 0) {
                        i2 = C3316R.C3321raw.premium_object_video2;
                    } else if (i5 == 1) {
                        i2 = C3316R.C3321raw.premium_object_video;
                    } else {
                        i2 = C3316R.C3321raw.premium_object_user;
                    }
                    this.stars[i5] = SvgHelper.getBitmap(i2, i6, i6, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey), 30));
                    this.svg = true;
                } else if (i7 == 1001) {
                    this.stars[i5] = SvgHelper.getBitmap(C3316R.C3321raw.premium_object_fire, i6, i6, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey), 30));
                    this.svg = true;
                } else if (i7 == 1002) {
                    this.stars[i5] = SvgHelper.getBitmap(C3316R.C3321raw.premium_object_star2, i6, i6, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey), 30));
                    this.svg = true;
                } else {
                    ...
                    if (this.type == 6 && (i5 == 1 || i5 == 2)) {
                        android.graphics.drawable.Drawable drawable = ContextCompat.getDrawable(ApplicationLoader.applicationContext, C3316R.C3318drawable.msg_premium_liststar);
        ...
        public void onDraw(Canvas canvas, float f) {
            ...
            if (this.useRotate) {
                ...
                float f3 = this.f1784a + ((f2 / 40000.0f) * 360.0f);
                this.f1784a = f3;
                this.f1785a1 += (f2 / 50000.0f) * 360.0f;
                this.f1786a2 += (f2 / 60000.0f) * 360.0f;
                this.matrix.setRotate(f3, this.rect.centerX(), this.rect.centerY());
                this.matrix2.setRotate(this.f1785a1, this.rect.centerX(), this.rect.centerY());
                this.matrix3.setRotate(this.f1786a2, this.rect.centerX(), this.rect.centerY());
                this.pointsCount1 = 0;
                this.pointsCount2 = 0;
                this.pointsCount3 = 0;
                for (int i = 0; i < this.particles.size(); i++) {
        ...
        public class Particle {
            ...
            /* renamed from: x2 */
            private float f1792x2;

            /* renamed from: y */
            private float f1793y;

            /* renamed from: y2 */
            private float f1794y2;
            ...
            public void draw(Canvas canvas, long j, float f) {
                ...
                if (drawable.useRotate) {
                    ...
                    this.drawingX = this.f1791x;
                    this.drawingY = this.f1793y;
                }
                boolean z = false;
                ...
                float m50dp = AndroidUtilities.m50dp(4) * (Drawable.this.f1787dt / 660.0f);
                Drawable drawable3 = Drawable.this;
                float f5 = m50dp * drawable3.speedScale;
                this.f1791x += this.vecX * f5;
                this.f1793y += this.vecY * f5;
                float f6 = this.inProgress;
                if (f6 != 1.0f) {
                    float f7 = f6 + (drawable3.f1787dt / 200.0f);
                    this.inProgress = f7;
                    if (f7 > 1.0f) {
            ...
            public void genPosition(long j) {
                ...
                if (drawable2.distributionAlgorithm) {
                    ...
                    for (int i2 = 0; i2 < 10; i2++) {
                        ...
                        for (int i3 = 0; i3 < Drawable.this.particles.size(); i3++) {
                            ...
                            if (drawable3.startFromCenter) {
                                f = drawable3.particles.get(i3).f1792x2 - abs3;
                                f2 = Drawable.this.particles.get(i3).f1794y2;
                            } else {
                                f = drawable3.particles.get(i3).f1791x - abs3;
                                f2 = Drawable.this.particles.get(i3).f1793y;
                            }
                            float f5 = f2 - abs4;
                            float f6 = (f * f) + (f5 * f5);
                            if (f6 < f4) {
                    ...
                    this.f1791x = Drawable.this.rect.centerX() + ((float) (Math.sin(Math.toRadians(r4)) * abs5));
                    this.f1793y = Drawable.this.rect.centerY() + ((float) (abs5 * Math.cos(Math.toRadians(r4))));
                } else {
                    this.f1791x = drawable2.rect.left + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.width());
                    this.f1793y = Drawable.this.rect.top + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.height());
                }
                double atan2 = Math.atan2(this.f1791x - Drawable.this.rect.centerX(), this.f1793y - Drawable.this.rect.centerY());
                ...
                if (drawable4.startFromCenter) {
                    this.f1792x2 = this.f1791x;
                    this.f1794y2 = this.f1793y;
                    this.f1791x = drawable4.rect.centerX();
                    this.f1793y = Drawable.this.rect.centerY();
                }
            }
        }
    }
