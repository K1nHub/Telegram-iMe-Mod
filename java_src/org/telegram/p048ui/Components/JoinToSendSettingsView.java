...
public class JoinToSendSettingsView extends LinearLayout {
    ...
    public JoinToSendSettingsView(Context context, TLRPC$Chat tLRPC$Chat) {
        ...
        headerCell.setText(LocaleController.getString("ChannelSettingsJoinTitle", C3301R.string.ChannelSettingsJoinTitle));
        ...
        String string = LocaleController.getString("ChannelSettingsJoinToSend", C3301R.string.ChannelSettingsJoinToSend);
        ...
        this.joinRequestCell.setTextAndCheck(LocaleController.getString("ChannelSettingsJoinRequest", C3301R.string.ChannelSettingsJoinRequest), this.isJoinRequest, false);
        ...
        textInfoPrivacyCell.setText(LocaleController.getString("ChannelSettingsJoinToSendInfo", C3301R.string.ChannelSettingsJoinToSendInfo));
        addView(this.joinToSendInfoCell);
        TextInfoPrivacyCell textInfoPrivacyCell2 = new TextInfoPrivacyCell(context);
        this.joinRequestInfoCell = textInfoPrivacyCell2;
        textInfoPrivacyCell2.setText(LocaleController.getString("ChannelSettingsJoinRequestInfo", C3301R.string.ChannelSettingsJoinRequestInfo));
    ...
    private void updateToggleValue(float f) {
        ...
        float f2 = 1.0f - f;
        this.joinRequestCell.setTranslationY((-AndroidUtilities.m50dp(16)) * f2);
        this.joinRequestCell.setScaleY(1.0f - (0.1f * f2));
        int m50dp = this.joinRequestCell.getMeasuredHeight() <= 0 ? AndroidUtilities.m50dp(50) : this.joinRequestCell.getMeasuredHeight();
        this.joinToSendInfoCell.setAlpha(f2);
        float f3 = (-m50dp) * f2;
        this.joinToSendInfoCell.setTranslationY(((-AndroidUtilities.m50dp(4)) * f) + f3);
        this.joinRequestInfoCell.setAlpha(f);
        this.joinRequestInfoCell.setTranslationY(f3 + (AndroidUtilities.m50dp(4) * f2));
        requestLayout();
    }
