...
public class WebPlayerView extends ViewGroup implements VideoPlayer.VideoPlayerDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    */
    protected java.lang.String downloadUrlContent(android.os.AsyncTask r19, java.lang.String r20, java.util.HashMap<java.lang.String, java.lang.String> r21, boolean r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.WebPlayerView.downloadUrlContent(android.os.AsyncTask, java.lang.String, java.util.HashMap, boolean):java.lang.String");
    }
    ...
    public class YoutubeVideoTask extends AsyncTask<Void, Void, String[]> {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:116:0x02aa, code lost:
            ...
            r0 = org.telegram.p048ui.Components.WebPlayerView.jsPattern.matcher(r3);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:129:0x02ed, code lost:
            if (org.telegram.p048ui.Components.WebPlayerView.playerIdPattern.matcher(r2).find() != false) goto L146;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:149:0x0378, code lost:
            r9 = org.telegram.p048ui.Components.WebPlayerView.sigPattern.matcher(r2);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:152:0x038c, code lost:
            r9 = org.telegram.p048ui.Components.WebPlayerView.sigPattern2.matcher(r2);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:156:0x03a1, code lost:
            r7 = new org.telegram.p048ui.Components.WebPlayerView.JSExtractor(r2).extractFunction(r8);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:171:0x043b, code lost:
            org.telegram.messenger.AndroidUtilities.runOnUIThread(new org.telegram.p048ui.Components.WebPlayerView$YoutubeVideoTask$$ExternalSyntheticLambda1(r23, r0));
        ...
        */
        public java.lang.String[] doInBackground(java.lang.Void... r24) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.WebPlayerView.YoutubeVideoTask.doInBackground(java.lang.Void[]):java.lang.String[]");
        }
    ...
    public class ControlsView extends FrameLayout {
        ...
        public void checkNeedHide() {
            ...
            if (this.isVisible && WebPlayerView.this.videoPlayer.isPlaying()) {
                AndroidUtilities.runOnUIThread(this.hideRunnable, C0468C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
            }
        }
        ...
        */
        protected void onDraw(android.graphics.Canvas r16) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.WebPlayerView.ControlsView.onDraw(android.graphics.Canvas):void");
        }
    }
    ...
    public WebPlayerView(Context context, boolean z, boolean z2, WebPlayerViewDelegate webPlayerViewDelegate) {
        ...
        this.surfaceTextureListener = new TextureView.SurfaceTextureListener() { // from class: org.telegram.ui.Components.WebPlayerView.2
            ...
            /* loaded from: classes6.dex */
            public class ViewTreeObserver$OnPreDrawListenerC53361 implements ViewTreeObserver.OnPreDrawListener {
                ViewTreeObserver$OnPreDrawListenerC53361() {
                }
                ...
                public boolean onPreDraw() {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.WebPlayerView$2$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            WebPlayerView.TextureView$SurfaceTextureListenerC53352.ViewTreeObserver$OnPreDrawListenerC53361.this.lambda$onPreDraw$0();
                        }
                    });
            ...
            public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
                if (WebPlayerView.this.waitingForFirstTextureUpload == 1) {
                    WebPlayerView.this.changedTextureView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC53361());
        ...
        webView.addJavascriptInterface(new JavaScriptInterface(new CallJavaResultInterface() { // from class: org.telegram.ui.Components.WebPlayerView$$ExternalSyntheticLambda5
            @Override // org.telegram.p048ui.Components.WebPlayerView.CallJavaResultInterface
        ...
        if (z2) {
            ...
            this.shareButton.setImageResource(C3286R.C3288drawable.ic_share_video);
    ...
    public void updatePlayButton() {
        ...
        if (!this.videoPlayer.isPlaying()) {
            if (this.isCompleted) {
                this.playButton.setImageResource(this.isInline ? C3286R.C3288drawable.ic_againinline : C3286R.C3288drawable.ic_again);
                return;
            } else {
                this.playButton.setImageResource(this.isInline ? C3286R.C3288drawable.ic_playinline : C3286R.C3288drawable.ic_play);
                return;
            }
        }
        this.playButton.setImageResource(this.isInline ? C3286R.C3288drawable.ic_pauseinline : C3286R.C3288drawable.ic_pause);
    ...
    public void updateFullscreenButton() {
        ...
        if (!this.inFullscreen) {
            this.fullscreenButton.setImageResource(C3286R.C3288drawable.ic_gofullscreen);
            this.fullscreenButton.setLayoutParams(LayoutHelper.createFrame(56, 56, 85, 0, 0, 0, 5));
            return;
        }
        this.fullscreenButton.setImageResource(C3286R.C3288drawable.ic_outfullscreen);
    ...
    public void updateInlineButton() {
        ...
        imageView.setImageResource(this.isInline ? C3286R.C3288drawable.ic_goinline : C3286R.C3288drawable.ic_outinline);
    ...
    */
    public boolean loadVideo(java.lang.String r27, org.telegram.tgnet.TLRPC$Photo r28, java.lang.Object r29, java.lang.String r30, boolean r31) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.WebPlayerView.loadVideo(java.lang.String, org.telegram.tgnet.TLRPC$Photo, java.lang.Object, java.lang.String, boolean):boolean");
    }
    ...
    public void showProgress(boolean z, boolean z2) {
        ...
        this.progressView.setAlpha(z ? 1.0f : BitmapDescriptorFactory.HUE_RED);
    }
}
