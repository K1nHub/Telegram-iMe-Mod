...
import org.telegram.p048ui.Components.ScrollSlidingTabStrip;
...
public class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    public void addKiklikoTrendsTab(Drawable drawable) {
        ...
        if (stickerTabView != null) {
            ...
            stickerTabView.textView.setText(LocaleController.getString("FeaturedStickersShort", C3158R.string.FeaturedStickersShort));
            this.tabsContainer.addView(stickerTabView, i);
        }
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3158R.C3161id.index_tag, Integer.valueOf(i));
    ...
    public /* synthetic */ void lambda$addKiklikoTrendsTab$0(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(C3158R.C3161id.index_tag)).intValue());
    }
    ...
    public void addKiklikoTab(TagResponse tagResponse) {
        ...
        stickerTabView.setTag(C3158R.C3161id.index_tag, Integer.valueOf(i));
        stickerTabView.setTag(C3158R.C3161id.object_tag, tagResponse.getMeme().getFile().getWebp());
        stickerTabView.setSelected(i == this.currentPosition);
    ...
    public ScrollSlidingTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.scrollOffset = AndroidUtilities.m50dp(33);
        this.underlineHeight = AndroidUtilities.m50dp(2);
        AndroidUtilities.m50dp(12);
        AndroidUtilities.m50dp(24);
        this.lastScrollX = 0;
        ...
        this.expanded = false;
        this.stickerTabExpandedWidth = AndroidUtilities.m51dp(EXPANDED_WIDTH);
        this.stickerTabWidth = AndroidUtilities.m50dp(33);
            ...
            */
            public void run() {
                /*
                    ...
                    org.telegram.ui.Components.ScrollSlidingTabStrip r2 = org.telegram.p048ui.Components.ScrollSlidingTabStrip.this
                    ...
                    if (r6 >= 0) goto L23
                    int r0 = org.telegram.messenger.AndroidUtilities.m50dp(r3)
                    int r0 = java.lang.Math.max(r3, r0)
                    org.telegram.ui.Components.ScrollSlidingTabStrip r1 = org.telegram.p048ui.Components.ScrollSlidingTabStrip.this
                ...
                L49:
                    ...
                    r2 = 0
                    r1.scrollBy(r0, r2)
                    org.telegram.ui.Components.ScrollSlidingTabStrip r0 = org.telegram.p048ui.Components.ScrollSlidingTabStrip.this
                    java.lang.Runnable r0 = r0.scrollRunnable
                    org.telegram.messenger.AndroidUtilities.runOnUIThread(r0)
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.ScrollSlidingTabStrip.RunnableC48956.run():void");
            }
        };
        ...
        this.tabsContainer.setPadding(AndroidUtilities.m51dp(9.5f), 0, AndroidUtilities.m51dp(9.5f), 0);
        addView(this.tabsContainer, new FrameLayout.LayoutParams(-1, -1, 16));
        Paint paint = new Paint();
        this.rectPaint = paint;
        paint.setAntiAlias(true);
        this.rectPaint.setStyle(Paint.Style.FILL);
        this.defaultTabLayoutParams = new LinearLayout.LayoutParams(AndroidUtilities.m50dp(33), -1);
    ...
    public void setType(Type type) {
        ...
        this.type = type;
        int i = C48967.$SwitchMap$org$telegram$ui$Components$ScrollSlidingTabStrip$Type[type.ordinal()];
        if (i == 1) {
    ...
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C48967 {
    ...
    public void beginUpdate(boolean z) {
        ...
        autoTransition.addTransition(new C48923());
    ...
    /* loaded from: classes6.dex */
    public class C48923 extends Transition {
        ...
        public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip$3$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ScrollSlidingTabStrip.C48923.this.lambda$createAnimator$0(valueAnimator);
                }
            });
            return ofFloat;
        }
    ...
    public FrameLayout addIconTab(int i, Drawable drawable) {
        ...
        if (frameLayout != null) {
            ...
            frameLayout.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ScrollSlidingTabStrip.this.lambda$addIconTab$3(view);
                }
            });
            this.tabsContainer.addView(frameLayout, i2);
        }
        frameLayout.setTag(C3158R.C3161id.index_tag, Integer.valueOf(i2));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addIconTab$3(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(C3158R.C3161id.index_tag)).intValue());
    }
    ...
    public StickerTabView addStickerIconTab(int i, Drawable drawable) {
        ...
        if (stickerTabView != null) {
            ...
            stickerTabView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip$$ExternalSyntheticLambda6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ScrollSlidingTabStrip.this.lambda$addStickerIconTab$4(view);
                }
            });
            stickerTabView.setExpanded(this.expanded);
            stickerTabView.updateExpandProgress(this.expandProgress);
        ...
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3158R.C3161id.index_tag, Integer.valueOf(i2));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addStickerIconTab$4(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(C3158R.C3161id.index_tag)).intValue());
    }

    public void addStickerTab(TLRPC$Chat tLRPC$Chat) {
        String str = "chat" + tLRPC$Chat.f1494id;
        int i = this.tabCount;
        this.tabCount = i + 1;
        StickerTabView stickerTabView = (StickerTabView) this.prevTypes.get(str);
        if (stickerTabView != null) {
            ...
            avatarDrawable.setTextSize(AndroidUtilities.m50dp(14));
    ...
    public View addEmojiTab(int i, Emoji.EmojiDrawable emojiDrawable, TLRPC$Document tLRPC$Document) {
        ...
        if (stickerTabView != null) {
            ...
            stickerTabView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ScrollSlidingTabStrip.this.lambda$addEmojiTab$6(view);
                }
            });
            stickerTabView.setExpanded(this.expanded);
            stickerTabView.updateExpandProgress(this.expandProgress);
        ...
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3158R.C3161id.index_tag, Integer.valueOf(i2));
        stickerTabView.setTag(C3158R.C3161id.parent_tag, emojiDrawable);
        stickerTabView.setTag(C3158R.C3161id.object_tag, tLRPC$Document);
        stickerTabView.setSelected(i2 == this.currentPosition);
        this.tabTypes.put(str, stickerTabView);
        return stickerTabView;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addEmojiTab$6(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(C3158R.C3161id.index_tag)).intValue());
    }
    ...
    public View addStickerTab(TLObject tLObject, TLRPC$Document tLRPC$Document, TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet) {
        ...
        sb.append("set");
        sb.append(tLRPC$TL_messages_stickerSet == null ? tLRPC$Document.f1502id : tLRPC$TL_messages_stickerSet.set.f1527id);
        ...
        if (stickerTabView != null) {
            ...
            stickerTabView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ScrollSlidingTabStrip.this.lambda$addStickerTab$7(view);
                }
            });
            stickerTabView.setExpanded(this.expanded);
            stickerTabView.updateExpandProgress(this.expandProgress);
        ...
        stickerTabView.setTag(C3158R.C3161id.index_tag, Integer.valueOf(i));
        stickerTabView.setTag(C3158R.C3161id.parent_tag, tLRPC$TL_messages_stickerSet);
        stickerTabView.setTag(C3158R.C3161id.object_tag, tLRPC$Document);
        stickerTabView.setSelected(i == this.currentPosition);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addStickerTab$7(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(C3158R.C3161id.index_tag)).intValue());
    }
        ...
        if (this.expanded != z) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip$$ExternalSyntheticLambda1
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ScrollSlidingTabStrip.this.lambda$expandStickers$8(z, f, valueAnimator2);
                }
            });
            this.expandStickerAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip.4
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    for (int i2 = 0; i2 < ScrollSlidingTabStrip.this.tabsContainer.getChildCount(); i2++) {
                        ...
                        childAt.getLayoutParams().width = AndroidUtilities.m50dp(33);
                    }
                    ScrollSlidingTabStrip scrollSlidingTabStrip3 = ScrollSlidingTabStrip.this;
                    scrollSlidingTabStrip3.animateToExpanded = false;
                    scrollSlidingTabStrip3.getLayoutParams().height = AndroidUtilities.m50dp(36);
            ...
            if (z) {
                ...
                for (int i = 0; i < this.tabsContainer.getChildCount(); i++) {
                    ...
                    childAt.getLayoutParams().width = AndroidUtilities.m51dp(EXPANDED_WIDTH);
                }
                this.tabsContainer.requestLayout();
                getLayoutParams().height = AndroidUtilities.m50dp(86);
            }
            if (z) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$expandStickers$8(boolean z, float f, ValueAnimator valueAnimator) {
        if (!z) {
    ...
    public float getExpandedOffset() {
        return this.animateToExpanded ? AndroidUtilities.m50dp(50) * this.expandProgress : BitmapDescriptorFactory.HUE_RED;
    }
    ...
    public void setImages() {
        ...
        int scrollX = (int) (((getScrollX() - (this.animateToExpanded ? this.expandOffset * (1.0f - f) : BitmapDescriptorFactory.HUE_RED)) - this.tabsContainer.getPaddingLeft()) / (AndroidUtilities.m50dp(33) + (AndroidUtilities.m51dp(EXPANDED_WIDTH - 33.0f) * f)));
        int min = Math.min(this.tabsContainer.getChildCount(), ((int) Math.ceil(getMeasuredWidth() / m50dp)) + scrollX + 1);
        ...
        while (true) {
            ...
            if (childAt instanceof StickerTabView) {
                ...
                if (i2 == 100) {
                    Glide.with(getContext()).load((String) stickerTabView.getTag(C3158R.C3161id.object_tag)).diskCacheStrategy(DiskCacheStrategy.ALL).optionalTransform(WebpDrawable.class, new WebpDrawableTransformation(new CenterCrop())).into(stickerTabView.iconView);
                } else {
                    if (i2 == 2) {
                        Object tag = stickerTabView.getTag(C3158R.C3161id.parent_tag);
                        Object tag2 = stickerTabView.getTag(C3158R.C3161id.object_tag);
                        ...
                        Object tag4 = childAt.getTag(C3158R.C3161id.parent_tag);
                        TLRPC$Document tLRPC$Document = (TLRPC$Document) childAt.getTag(C3158R.C3161id.object_tag);
    ...
    public int getTabSize() {
        return AndroidUtilities.m51dp(this.animateToExpanded ? EXPANDED_WIDTH : 33.0f);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.animateToExpanded) {
            height = getHeight() - (AndroidUtilities.m50dp(50) * (1.0f - this.expandProgress));
        }
        float f4 = height;
        ...
        if (!isInEditMode() && this.tabCount != 0 && this.indicatorHeight >= 0) {
            ...
            if (childAt != null && view != null) {
                float f8 = f6 - floor;
                float lerp = AndroidUtilities.lerp(childAt.getLeft() + childAt.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m50dp(33), AndroidUtilities.m51dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f), view.getLeft() + view.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m50dp(33), AndroidUtilities.m51dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f), f8);
                ...
                f = childAt.getLeft() + childAt.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m50dp(33), AndroidUtilities.m51dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f);
                if (childAt instanceof StickerTabView) {
                ...
                if (view != null) {
                    f = view.getLeft() + view.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m50dp(33), AndroidUtilities.m51dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f);
                    if (view instanceof StickerTabView) {
            ...
            float m50dp = AndroidUtilities.m50dp(30);
            float abs = (1.25f - ((Math.abs(0.5f - this.currentPositionAnimated.getTransitionProgressInterpolated()) * 0.25f) * 2.0f)) * m50dp;
            float interpolation = CubicBezierInterpolator.EASE_IN.getInterpolation(this.expandProgress);
            float lerp2 = f7 + AndroidUtilities.lerp(0, AndroidUtilities.m50dp(26), interpolation);
            float lerp3 = AndroidUtilities.lerp(abs, textWidth + AndroidUtilities.m50dp(10), interpolation) / 2.0f;
            float abs2 = ((m50dp * (((Math.abs(0.5f - this.currentPositionAnimated.getTransitionProgressInterpolated()) * 0.1f) * 2.0f) + 0.9f)) * AndroidUtilities.lerp(1.0f, 0.55f, interpolation)) / 2.0f;
            ...
            canvas.drawRoundRect(this.tabBounds, AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(8), this.selectorPaint);
        }
            ...
            if (this.draggingView != null) {
                ...
                if (i3 != i4) {
                    ...
                    for (int i5 = 0; i5 < this.tabsContainer.getChildCount(); i5++) {
                        this.tabsContainer.getChildAt(i5).setTag(C3158R.C3161id.index_tag, Integer.valueOf(i5));
                    }
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(BitmapDescriptorFactory.HUE_RED, 1.0f);
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ScrollSlidingTabStrip.this.lambda$checkLongPress$9(valueAnimator);
                    }
                });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkLongPress$9(ValueAnimator valueAnimator) {
