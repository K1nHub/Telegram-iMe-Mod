...
public class GroupCreateSpan extends View {
    ...
    */
    public GroupCreateSpan(android.content.Context r27, java.lang.Object r28, org.telegram.messenger.ContactsController.Contact r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.GroupCreateSpan.<init>(android.content.Context, java.lang.Object, org.telegram.messenger.ContactsController$Contact):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m50dp(57) + this.textWidth, AndroidUtilities.m50dp(32));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m50dp(32));
        ...
        if (this.progress != BitmapDescriptorFactory.HUE_RED) {
            ...
            canvas.drawCircle(AndroidUtilities.m50dp(16), AndroidUtilities.m50dp(16), AndroidUtilities.m50dp(16), backPaint);
            canvas.save();
            canvas.rotate((1.0f - this.progress) * 45.0f, AndroidUtilities.m50dp(16), AndroidUtilities.m50dp(16));
            this.deleteDrawable.setBounds(AndroidUtilities.m50dp(11), AndroidUtilities.m50dp(11), AndroidUtilities.m50dp(21), AndroidUtilities.m50dp(21));
            this.deleteDrawable.setAlpha((int) (this.progress * 255.0f));
            this.deleteDrawable.draw(canvas);
            canvas.restore();
        }
        canvas.translate(this.textX + AndroidUtilities.m50dp(41), AndroidUtilities.m50dp(8));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString("Delete", C3316R.string.Delete)));
    }
}
