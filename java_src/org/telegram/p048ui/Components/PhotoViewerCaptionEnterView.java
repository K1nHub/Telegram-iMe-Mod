...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayoutPhoto.SizeNotifierFrameLayoutPhotoDelegate {
    ...
    public PhotoViewerCaptionEnterView(final PhotoViewer photoViewer, Context context, final SizeNotifierFrameLayoutPhoto sizeNotifierFrameLayoutPhoto, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.messageEditText.setHint(LocaleController.getString("AddCaption", C3316R.string.AddCaption));
        ...
        this.messageEditText.addTextChangedListener(new C48842(photoViewer, sizeNotifierFrameLayoutPhoto));
        this.doneDrawable = Theme.createCircleDrawable(AndroidUtilities.m50dp(16), -10043398);
        this.checkDrawable = context.getResources().getDrawable(C3316R.C3318drawable.input_done).mutate();
        ...
        imageView3.setContentDescription(LocaleController.getString("Done", C3316R.string.Done));
    ...
    /* loaded from: classes6.dex */
    public class C48842 implements TextWatcher {
        ...
        C48842(PhotoViewer photoViewer, SizeNotifierFrameLayoutPhoto sizeNotifierFrameLayoutPhoto) {
        ...
        */
        public void afterTextChanged(android.text.Editable r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.PhotoViewerCaptionEnterView.C48842.afterTextChanged(android.text.Editable):void");
        }
    ...
    private void createEmojiView() {
        ...
        emojiView2.setDelegate(new EmojiView.EmojiViewDelegate() { // from class: org.telegram.ui.Components.PhotoViewerCaptionEnterView.3
            ...
            /* loaded from: classes6.dex */
            class C48871 extends BaseFragment {
                C48871() {
                }
                ...
                public Dialog getVisibleDialog() {
                    return new Dialog(PhotoViewerCaptionEnterView.this.getContext()) { // from class: org.telegram.ui.Components.PhotoViewerCaptionEnterView.3.1.1
                        ...
                        public void dismiss() {
                            if ((C48871.this.getParentActivity() instanceof LaunchActivity) && ((LaunchActivity) C48871.this.getParentActivity()).getActionBarLayout() != null) {
                                C48871 c48871 = C48871.this;
                                ((BaseFragment) c48871).parentLayout = ((LaunchActivity) c48871.getParentActivity()).getActionBarLayout();
                                if (((BaseFragment) C48871.this).parentLayout != null && ((BaseFragment) C48871.this).parentLayout.getLastFragment() != null && ((BaseFragment) C48871.this).parentLayout.getLastFragment().getVisibleDialog() != null) {
                                    Dialog visibleDialog = ((BaseFragment) C48871.this).parentLayout.getLastFragment().getVisibleDialog();
            ...
            public void onAnimatedEmojiUnlockClick() {
                new PremiumFeatureBottomSheet(new C48871(), 11, false).show();
            }
