...
public class SenderSelectView extends View {
    ...
    public SenderSelectView(Context context) {
        ...
        updateColors();
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C3316R.string.AccDescrSendAsPeer, ""));
    }
    ...
    public void setAvatar(TLObject tLObject) {
        ...
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C3316R.string.AccDescrSendAsPeer, str));
