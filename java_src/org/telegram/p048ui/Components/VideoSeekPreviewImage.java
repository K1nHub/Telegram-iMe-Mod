...
public class VideoSeekPreviewImage extends View {
    ...
    public VideoSeekPreviewImage(Context context, VideoSeekPreviewImageDelegate videoSeekPreviewImageDelegate) {
        ...
        setVisibility(4);
        this.frameDrawable = context.getResources().getDrawable(C3301R.C3303drawable.videopreview);
    ...
    public /* synthetic */ void lambda$open$4(Uri uri) {
        ...
        if ("tg".equals(uri.getScheme())) {
            ...
            tLRPC$TL_document.f1508id = Utilities.parseLong(uri.getQueryParameter(TtmlNode.ATTR_ID)).longValue();
            ...
            if (FileLoader.getInstance(intValue).isLoadingFile(FileLoader.getAttachFileName(tLRPC$TL_document))) {
                ...
                absolutePath = new File(directory, tLRPC$TL_document.dc_id + "_" + tLRPC$TL_document.f1508id + ".temp").getAbsolutePath();
            } else {
