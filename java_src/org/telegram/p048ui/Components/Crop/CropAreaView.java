...
public class CropAreaView extends ViewGroup {
    ...
    /* renamed from: tx */
    public float f1692tx;

    /* renamed from: ty */
    public float f1693ty;
    ...
    public CropAreaView(Context context) {
        ...
        this.scale = 1.0f;
        this.f1692tx = BitmapDescriptorFactory.HUE_RED;
        this.f1693ty = BitmapDescriptorFactory.HUE_RED;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.freeform) {
            ...
            canvas.save();
            canvas.translate(this.f1692tx, this.f1693ty);
            float f4 = this.scale;
            float f5 = (i10 / 2) + i7;
            float f6 = (i11 / 2) + i8;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            switch (C43073.$SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control[this.activeControl.ordinal()]) {
                case 1:
