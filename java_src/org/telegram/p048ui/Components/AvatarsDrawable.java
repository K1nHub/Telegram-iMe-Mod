...
public class AvatarsDrawable {
    ...
    public void commitTransition(boolean z, boolean z2) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (drawingStateArr2[i].f1677id != this.animatingStates[i].f1677id) {
                z4 = true;
            } else {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            while (true) {
                if (i3 >= 3) {
                    z3 = false;
                    break;
                } else if (this.currentStates[i3].f1677id == this.animatingStates[i2].f1677id) {
    ...
    public void setObject(int i, int i2, TLObject tLObject) {
        ...
        TLRPC$Chat chat;
        this.animatingStates[i].f1677id = 0L;
        ...
        if (tLObject instanceof TLRPC$TL_groupCallParticipant) {
            ...
            this.animatingStates[i].f1677id = peerId;
            tLRPC$Chat = chat;
            ...
            this.animatingStates[i].f1677id = tLRPC$User2.f1633id;
            ...
            this.animatingStates[i].f1677id = -tLRPC$Chat.f1494id;
        }
        if (tLRPC$User == null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:242:0x04fc A[SYNTHETIC] */
    ...
    */
    public void onDraw(android.graphics.Canvas r32) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.AvatarsDrawable.onDraw(android.graphics.Canvas):void");
    }
