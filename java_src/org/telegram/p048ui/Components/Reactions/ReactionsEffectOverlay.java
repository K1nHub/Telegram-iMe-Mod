...
public class ReactionsEffectOverlay {
    ...
    */
    ...
    /* loaded from: classes6.dex */
    public class C50211 extends FrameLayout {
        ...
        C50211(Context context, BaseFragment baseFragment, ChatMessageCell chatMessageCell, ChatActivity chatActivity, int i, int i2, boolean z, float f, float f2, float f3, ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
            super(context);
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.Reactions.ReactionsEffectOverlay.C50211.dispatchDraw(android.graphics.Canvas):void");
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void show(org.telegram.p048ui.ActionBar.BaseFragment r16, org.telegram.p048ui.Components.ReactionsContainerLayout r17, org.telegram.p048ui.Cells.ChatMessageCell r18, android.view.View r19, float r20, float r21, org.telegram.p048ui.Components.Reactions.ReactionsLayoutInBubble.VisibleReaction r22, int r23, int r24) {
        /*
            r11 = r16
            r12 = r24
            if (r18 == 0) goto Lc8
        ...
        L36:
            ...
            if (r12 != r13) goto L57
            org.telegram.p048ui.Components.Reactions.ReactionsEffectOverlay.currentShortOverlay = r15
            goto L59
        L57:
            org.telegram.p048ui.Components.Reactions.ReactionsEffectOverlay.currentOverlay = r15
        L59:
            r0 = 0
            boolean r1 = r11 instanceof org.telegram.p048ui.ChatActivity
            if (r1 == 0) goto L70
            r1 = r11
            org.telegram.ui.ChatActivity r1 = (org.telegram.p048ui.ChatActivity) r1
            if (r12 == 0) goto L65
            if (r12 != r14) goto L70
        L65:
    ...
    private class AvatarParticle {
        ...
        /* synthetic */ AvatarParticle(ReactionsEffectOverlay reactionsEffectOverlay, C50211 c50211) {
