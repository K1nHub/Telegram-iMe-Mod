                    ...
                    if (errorWhileGenerateLegacyBitmap) {
                        ...
                        if (this.legacyBitmap != null) {
                            if (this.invalidateLegacy) {
                                this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, bitmap.getWidth(), this.legacyBitmap.getHeight());
                                int alpha = this.paint.getAlpha();
        ...
        if (f4 < 1.0f) {
            ...
            if (z2) {
                ...
                if (this.rotatingPreview) {
                    ...
                    if (this.ignoreInterpolator && (f3 == BitmapDescriptorFactory.HUE_RED || f3 == 1.0f)) {
                    ...
                    if (this.ignoreInterpolator && (f == BitmapDescriptorFactory.HUE_RED || f == 1.0f)) {
                        this.ignoreInterpolator = false;
                    }
                    if (this.rotationBack) {
                        f = 1.0f - f;
            ...
            if (z3) {
                ...
                if (f2 != 1.0f) {
                    ...
                    if (i6 == 0) {
                        this.gradientCanvas.drawBitmap(this.gradientFromBitmap, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (Paint) null);
                    } else {
                        this.gradientCanvas.drawBitmap(this.gradientToBitmap[i6 - 1], BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (Paint) null);
                    }
                    this.paint3.setAlpha((int) (((f2 - (i6 * 0.33333334f)) / 0.33333334f) * 255.0f));
                    this.gradientCanvas.drawBitmap(this.gradientToBitmap[i6], BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.paint3);
                } else {
                    this.gradientCanvas.drawBitmap(this.gradientToBitmap[2], BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.paint3);
                }
            }
            if (z) {
                invalidateParent();
