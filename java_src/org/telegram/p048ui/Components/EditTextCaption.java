...
public class EditTextCaption extends EditTextBoldCursor {
    ...
    public void makeSelectedUrl() {
        ...
        builder.setPositiveButton(LocaleController.getString("OK", C3316R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda0
    ...
    public boolean performMenuAction(int i) {
        if (i == C3316R.C3319id.menu_regular) {
            makeSelectedRegular();
            return true;
        } else if (i == C3316R.C3319id.menu_bold) {
            makeSelectedBold();
            return true;
        } else if (i == C3316R.C3319id.menu_italic) {
            makeSelectedItalic();
            return true;
        } else if (i == C3316R.C3319id.menu_mono) {
            makeSelectedMono();
            return true;
        } else if (i == C3316R.C3319id.menu_link) {
            makeSelectedUrl();
            return true;
        } else if (i == C3316R.C3319id.menu_strike) {
            makeSelectedStrike();
            return true;
        } else if (i == C3316R.C3319id.menu_underline) {
            makeSelectedUnderline();
            return true;
        } else if (i == C3316R.C3319id.menu_spoiler) {
            makeSelectedSpoiler();
            return true;
        } else {
            return false;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (hasSelection()) {
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3316R.C3319id.menu_spoiler, LocaleController.getString("Spoiler", C3316R.string.Spoiler)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3316R.C3319id.menu_bold, LocaleController.getString("Bold", C3316R.string.Bold)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3316R.C3319id.menu_italic, LocaleController.getString("Italic", C3316R.string.Italic)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3316R.C3319id.menu_mono, LocaleController.getString("Mono", C3316R.string.Mono)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3316R.C3319id.menu_strike, LocaleController.getString("Strike", C3316R.string.Strike)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3316R.C3319id.menu_underline, LocaleController.getString("Underline", C3316R.string.Underline)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3316R.C3319id.menu_link, LocaleController.getString("CreateLink", C3316R.string.CreateLink)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3316R.C3319id.menu_regular, LocaleController.getString("Regular", C3316R.string.Regular)));
        }
    }
