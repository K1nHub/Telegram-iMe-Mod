...
import org.telegram.p048ui.Components.CrossOutDrawable;
...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    public GroupCallMiniTextureView(final GroupCallRenderersContainer groupCallRenderersContainer, ArrayList<GroupCallMiniTextureView> arrayList, final ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(groupCallRenderersContainer.getContext(), C3158R.C3160drawable.calls_video, null);
        ...
        this.castingScreenDrawable = groupCallRenderersContainer.getContext().getResources().getDrawable(C3158R.C3160drawable.screencast_big).mutate();
        ...
        final String string = LocaleController.getString("VoipVideoOnPause", C3158R.string.VoipVideoOnPause);
        final StaticLayout staticLayout = new StaticLayout(LocaleController.getString("VoipVideoScreenSharingTwoLines", C3158R.string.VoipVideoScreenSharingTwoLines), textPaint, AndroidUtilities.m50dp(400), Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(call.chatId));
        final StaticLayout staticLayout2 = new StaticLayout(LocaleController.formatString("VoipVideoNotAvailable", C3158R.string.VoipVideoNotAvailable, LocaleController.formatPluralString("Participants", MessagesController.getInstance(this.currentAccount).groupCallVideoMaxParticipants, new Object[0])), textPaint, AndroidUtilities.m50dp(400), Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        final String string2 = LocaleController.getString("VoipVideoScreenSharing", C3158R.string.VoipVideoScreenSharing);
        ...
        VoIPTextureView voIPTextureView = new VoIPTextureView(groupCallRenderersContainer.getContext(), false, false, true, true) { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView.1
            ...
            @Override // org.telegram.p048ui.Components.voip.VoIPTextureView
            ...
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // org.telegram.p048ui.Components.voip.VoIPTextureView, android.view.ViewGroup, android.view.View
            public void dispatchDraw(Canvas canvas) {
                ...
                if (!this.renderer.isFirstFrameRendered() || ((this.renderer.getAlpha() != 1.0f && this.blurRenderer.getAlpha() != 1.0f) || GroupCallMiniTextureView.this.videoIsPaused)) {
                    ...
                    if (videoParticipant == call.videoNotAvailableParticipant) {
                        ...
                        float f6 = GroupCallMiniTextureView.this.drawFirst ? BitmapDescriptorFactory.HUE_RED : groupCallRenderersContainer.progressToFullscreenMode;
                        ...
                        if (groupCallMiniTextureView5.animateToFullscreen || groupCallMiniTextureView5.showingInFullscreen) {
                            ...
                            f = m50dp3;
                            m50dp = AndroidUtilities.m50dp(10) * Math.max(1.0f - groupCallRenderersContainer.progressToFullscreenMode, (GroupCallMiniTextureView.this.showingAsScrimView || GroupCallMiniTextureView.this.animateToScrimView) ? groupCallRenderersContainer.progressToScrimView : BitmapDescriptorFactory.HUE_RED);
                        }
                        int i2 = (int) (f + m50dp);
                        int measuredWidth = (getMeasuredWidth() - i2) / 2;
                        float f7 = (GroupCallMiniTextureView.this.showingAsScrimView || GroupCallMiniTextureView.this.animateToScrimView) ? groupCallRenderersContainer.progressToScrimView : BitmapDescriptorFactory.HUE_RED;
                        ...
                        int m50dp6 = (int) ((measuredHeight - ((m50dp4 + (m50dp5 * ((groupCallMiniTextureView7.showingInFullscreen || groupCallMiniTextureView7.animateToFullscreen) ? groupCallRenderersContainer.progressToFullscreenMode : BitmapDescriptorFactory.HUE_RED))) * f6)) + (AndroidUtilities.m50dp(17) * f2));
            ...
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // org.telegram.p048ui.Components.voip.VoIPTextureView, android.widget.FrameLayout, android.view.ViewGroup, android.view.View
            ...
            @Override // org.telegram.p048ui.Components.voip.VoIPTextureView, android.view.View, android.view.ViewParent
        ...
        imageView.setImageDrawable(ContextCompat.getDrawable(groupCallRenderersContainer.getContext(), C3158R.C3160drawable.voicechat_screencast));
        ...
        textView.setText(LocaleController.getString("VoipVideoScreenStopSharing", C3158R.string.VoipVideoScreenStopSharing));
        ...
        if (ChatObject.canManageCalls(chat)) {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3158R.string.NoRtmpStreamFromAppOwner)));
        } else {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoRtmpStreamFromAppViewer", C3158R.string.NoRtmpStreamFromAppViewer, chat.title)));
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.attached) {
            ...
            this.infoContainer.setTranslationX(this.drawFirst ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m50dp(6) * this.parentContainer.progressToFullscreenMode);
        }
        super.dispatchDraw(canvas);
        if (this.attached) {
    ...
    */
    protected void onMeasure(int r16, int r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.voip.GroupCallMiniTextureView.onMeasure(int, int):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:109:0x0190, code lost:
        if (r1 != r12.videoNotAvailableParticipant) goto L348;
     */
    /* JADX WARN: Code restructure failed: missing block: B:111:0x0198, code lost:
        if (org.telegram.messenger.ChatObject.Call.videoIsActive(r11, r1.presentation, r12) == false) goto L348;
     */
    /* JADX WARN: Code restructure failed: missing block: B:119:0x01bf, code lost:
        if (r1 != false) goto L312;
     */
    /* JADX WARN: Code restructure failed: missing block: B:45:0x008b, code lost:
        if (r23.participant != r11.videoNotAvailableParticipant) goto L282;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:253:0x044a  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:272:0x04e6 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:314:0x05aa  */
    ...
    */
    public void updateAttachState(boolean r24) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.voip.GroupCallMiniTextureView.updateAttachState(boolean):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:58:0x0117, code lost:
        if (org.telegram.p048ui.GroupCallActivity.isTabletMode != false) goto L57;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void updatePosition(android.view.ViewGroup r9, android.view.ViewGroup r10, org.telegram.p048ui.Components.RecyclerListView r11, org.telegram.p048ui.Components.voip.GroupCallRenderersContainer r12) {
        /*
            Method dump skipped, instructions count: 444
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.voip.GroupCallMiniTextureView.updatePosition(android.view.ViewGroup, android.view.ViewGroup, org.telegram.ui.Components.RecyclerListView, org.telegram.ui.Components.voip.GroupCallRenderersContainer):void");
    }
    ...
    @Override // org.telegram.p048ui.Components.voip.GroupCallStatusIcon.Callback
    ...
    */
    private void updateIconColor(boolean r10) {
        ...
        L13:
            ...
            if (r0 == 0) goto L22
            int r0 = org.telegram.p048ui.ActionBar.Theme.getColor(r1)
            goto L11
        L22:
            int r0 = org.telegram.p048ui.ActionBar.Theme.getColor(r1)
            r1 = -1
        ...
        L71:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.voip.GroupCallMiniTextureView.updateIconColor(boolean):void");
    }
    ...
    public class NoVideoStubLayout extends View {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.f1817cx = getMeasuredWidth() >> 1;
            this.f1818cy = (getMeasuredHeight() >> 1) + (GroupCallActivity.isLandscapeMode ? BitmapDescriptorFactory.HUE_RED : (-getMeasuredHeight()) * 0.12f);
            float f = m50dp / 2.0f;
            this.avatarImageReceiver.setRoundRadius((int) f);
            this.avatarImageReceiver.setImageCoords(this.f1817cx - f, this.f1818cy - f, m50dp, m50dp);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.scale(f10, f10, this.f1817cx, this.f1818cy);
            GroupCallActivity.WeavingState weavingState3 = this.currentState;
            if (weavingState3 != null) {
                weavingState3.update((int) (this.f1818cy - AndroidUtilities.m50dp(100)), (int) (this.f1817cx - AndroidUtilities.m50dp(100)), AndroidUtilities.m50dp(200), 16L, this.amplitude);
            }
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.bigWaveDrawable.draw(this.f1817cx, this.f1818cy, canvas, this.paint);
                this.tinyWaveDrawable.draw(this.f1817cx, this.f1818cy, canvas, this.paint);
            }
            canvas.restore();
            float f11 = (this.amplitude * 0.2f) + 1.0f;
            canvas.save();
            canvas.scale(f11, f11, this.f1817cx, this.f1818cy);
