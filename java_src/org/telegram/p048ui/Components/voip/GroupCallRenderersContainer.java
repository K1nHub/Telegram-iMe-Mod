...
public class GroupCallRenderersContainer extends FrameLayout {
    ...
    public GroupCallRenderersContainer(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList<GroupCallMiniTextureView> arrayList, ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        this.hideUiRunnable = new Runnable() { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.1
            ...
            public void run() {
                if (!GroupCallRenderersContainer.this.canHideUI()) {
                    AndroidUtilities.runOnUIThread(GroupCallRenderersContainer.this.hideUiRunnable, C0474C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                    return;
                }
        ...
        ImageView imageView = new ImageView(this, context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.2
            ...
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(C3222ActionBar.getCurrentActionBarHeight(), 1073741824));
            }
        };
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(context, C3158R.C3160drawable.msg_pin_filled, null);
        ...
        this.pinTextView.setText(LocaleController.getString("CallVideoPin", C3158R.string.CallVideoPin));
        ...
        this.unpinTextView.setText(LocaleController.getString("CallVideoUnpin", C3158R.string.CallVideoUnpin));
        ...
        this.pipView.setImageResource(C3158R.C3160drawable.ic_goinline);
        this.pipView.setContentDescription(LocaleController.getString(C3158R.string.AccDescrPipMode));
        ...
        for (int i = 0; i < 2; i++) {
            this.undoView[i] = new UndoView(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.6
                @Override // org.telegram.p048ui.Components.UndoView, android.view.View
                public void invalidate() {
                    super.invalidate();
                    GroupCallRenderersContainer.this.invalidate();
                }
    ...
    public void setIsTablet(boolean z) {
        if (this.isTablet != z) {
            ...
            if (this.isTablet) {
                this.backButton.setImageDrawable(ContextCompat.getDrawable(getContext(), C3158R.C3160drawable.msg_calls_minimize));
                return;
            }
            BackDrawable backDrawable = new BackDrawable(false);
            backDrawable.setColor(-1);
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.voip.GroupCallRenderersContainer.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    */
    public void requestFullscreen(org.telegram.messenger.ChatObject.VideoParticipant r17) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.voip.GroupCallRenderersContainer.requestFullscreen(org.telegram.messenger.ChatObject$VideoParticipant):void");
    }
        ...
        if (this.uiVisible != z) {
            ...
            if (z && this.inFullscreenMode) {
                if (!this.hideUiRunnableIsScheduled) {
                    ...
                    AndroidUtilities.runOnUIThread(this.hideUiRunnable, C0474C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                }
            } else {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.voip.GroupCallRenderersContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
