...
public class GroupCallRenderersContainer extends FrameLayout {
    ...
    public GroupCallRenderersContainer(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList<GroupCallMiniTextureView> arrayList, ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        this.hideUiRunnable = new Runnable() { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.1
            ...
            public void run() {
                if (!GroupCallRenderersContainer.this.canHideUI()) {
                    AndroidUtilities.runOnUIThread(GroupCallRenderersContainer.this.hideUiRunnable, C0482C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                    return;
                }
        ...
        ImageView imageView = new ImageView(this, context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.2
            ...
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(C3381ActionBar.getCurrentActionBarHeight(), 1073741824));
            }
        };
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(context, C3316R.C3318drawable.msg_pin_filled, null);
        ...
        this.pinTextView.setText(LocaleController.getString("CallVideoPin", C3316R.string.CallVideoPin));
        ...
        this.unpinTextView.setText(LocaleController.getString("CallVideoUnpin", C3316R.string.CallVideoUnpin));
        ...
        this.pipView.setImageResource(C3316R.C3318drawable.ic_goinline);
        this.pipView.setContentDescription(LocaleController.getString(C3316R.string.AccDescrPipMode));
    ...
    public void setIsTablet(boolean z) {
        if (this.isTablet != z) {
            ...
            if (this.isTablet) {
                this.backButton.setImageDrawable(ContextCompat.getDrawable(getContext(), C3316R.C3318drawable.msg_calls_minimize));
                return;
            }
            BackDrawable backDrawable = new BackDrawable(false);
            backDrawable.setColor(-1);
        ...
        if (this.uiVisible != z) {
            ...
            if (z && this.inFullscreenMode) {
                if (!this.hideUiRunnableIsScheduled) {
                    ...
                    AndroidUtilities.runOnUIThread(this.hideUiRunnable, C0482C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                }
            } else {
