...
public class VoIPToggleButton extends FrameLayout {
    ...
    public VoIPToggleButton(Context context, float f) {
        ...
        this.xRefPaint.setStrokeWidth(AndroidUtilities.m50dp(3));
        this.crossPaint.setStrokeWidth(AndroidUtilities.m50dp(2));
    ...
    public void setData(int i, int i2, int i3, float f, boolean z, String str, boolean z2, boolean z3) {
        ...
        if (this.rippleDrawable == null || z) {
            if (Color.alpha(i3) == 255 && AndroidUtilities.computePerceivedBrightness(i3) > 0.5d) {
                Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m51dp(this.radius), 0, ColorUtils.setAlphaComponent(-16777216, (int) (f * 25.5f)));
                this.rippleDrawable = createSimpleSelectorCircleDrawable;
                createSimpleSelectorCircleDrawable.setCallback(this);
            } else {
                Drawable createSimpleSelectorCircleDrawable2 = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m51dp(this.radius), 0, ColorUtils.setAlphaComponent(-1, (int) (f * 76.5f)));
