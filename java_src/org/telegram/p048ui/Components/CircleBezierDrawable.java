...
public class CircleBezierDrawable {
    ...
    /* renamed from: L */
    private final float f1695L;

    /* renamed from: N */
    private final int f1696N;
    public float radius;
    ...
    /* renamed from: m */
    private Matrix f1697m = new Matrix();
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        float max = this.f1695L * Math.max(f6, f7) * this.cubicBezierK;
        this.path.reset();
        int i = 0;
        while (i < this.f1696N) {
            this.f1697m.reset();
            this.f1697m.setRotate((360.0f / this.f1696N) * i, f, f2);
            ...
            float f11 = f2 - f10;
            fArr2[1] = f11;
            fArr2[2] = f + max + (f9 * fArr[i] * this.f1695L);
            fArr2[3] = f11;
            this.f1697m.mapPoints(fArr2);
            int i2 = i + 1;
            int i3 = i2 >= this.f1696N ? 0 : i2;
            ...
            fArr4[1] = f14;
            fArr4[2] = (f - max) + (f13 * fArr3[i3] * this.f1695L);
            fArr4[3] = f14;
            this.f1697m.reset();
            this.f1697m.setRotate((360.0f / this.f1696N) * i3, f, f2);
            this.f1697m.mapPoints(this.pointEnd);
            if (i == 0) {
                Path path = this.path;
