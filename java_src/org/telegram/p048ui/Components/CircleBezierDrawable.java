...
public class CircleBezierDrawable {
    ...
    /* renamed from: m */
    private Matrix f1700m = new Matrix();
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        float max = this.f1698L * Math.max(f6, f7) * this.cubicBezierK;
        this.path.reset();
        int i = 0;
        while (i < this.f1699N) {
            this.f1700m.reset();
            this.f1700m.setRotate((360.0f / this.f1699N) * i, f, f2);
            ...
            float f11 = f2 - f10;
            fArr2[1] = f11;
            fArr2[2] = f + max + (f9 * fArr[i] * this.f1698L);
            fArr2[3] = f11;
            this.f1700m.mapPoints(fArr2);
            int i2 = i + 1;
            int i3 = i2 >= this.f1699N ? 0 : i2;
            ...
            fArr4[1] = f14;
            fArr4[2] = (f - max) + (f13 * fArr3[i3] * this.f1698L);
            fArr4[3] = f14;
            this.f1700m.reset();
            this.f1700m.setRotate((360.0f / this.f1699N) * i3, f, f2);
            this.f1700m.mapPoints(this.pointEnd);
            if (i == 0) {
                Path path = this.path;
