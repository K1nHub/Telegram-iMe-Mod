...
public class FireworksOverlay extends View {
    ...
    public class Particle {
        ...
        public void draw(Canvas canvas) {
            byte b = this.type;
            if (b == 0) {
                canvas.drawCircle(this.f1719x, this.f1720y, AndroidUtilities.m50dp((int) this.typeSize), FireworksOverlay.paint[this.colorType]);
            } else if (b == 1) {
                FireworksOverlay.this.rect.set(this.f1719x - AndroidUtilities.m50dp((int) this.typeSize), this.f1720y - AndroidUtilities.m50dp(2), this.f1719x + AndroidUtilities.m50dp((int) this.typeSize), this.f1720y + AndroidUtilities.m50dp(2));
                canvas.save();
                ...
                float f = this.f1719x;
                float f2 = this.f1720y;
                drawable.setBounds(((int) f) - intrinsicWidth, ((int) f2) - intrinsicHeight, ((int) f) + intrinsicWidth, ((int) f2) + intrinsicHeight);
                canvas.save();
                canvas.rotate(this.rotation, this.f1719x, this.f1720y);
                byte b2 = this.typeSize;
                canvas.scale(b2 / 6.0f, b2 / 6.0f, this.f1719x, this.f1720y);
        ...
        public boolean update(int i) {
            ...
            return this.f1720y >= ((float) FireworksOverlay.this.getHeightForAnimation());
        }
    }
    ...
    private void loadHeartDrawables() {
        ...
        while (true) {
            ...
            drawableArr[i] = ApplicationLoader.applicationContext.getResources().getDrawable(C3301R.C3303drawable.heart_confetti).mutate();
    ...
    private Particle createParticle(boolean z) {
        ...
        if (z) {
            particle.f1720y = (-Utilities.random.nextFloat()) * getHeightForAnimation() * 1.2f;
            particle.f1719x = AndroidUtilities.m50dp(5) + Utilities.random.nextInt(getWidthForAnimation() - AndroidUtilities.m50dp(10));
            ...
            if (particle.side == 0) {
                particle.f1719x = -m50dp;
            } else {
                particle.f1719x = getWidthForAnimation() + m50dp;
            }
            ...
            particle.f1720y = (heightForAnimation / 2) + Utilities.random.nextInt(heightForAnimation * 2);
        }
        return particle;
    }
