...
public class TermsOfServiceView extends FrameLayout {
    ...
    public TermsOfServiceView(Context context) {
        ...
        imageView.setImageResource(C3158R.C3160drawable.logo_middle);
        ...
        this.titleTextView.setText(LocaleController.getString("PrivacyPolicyAndTerms", C3158R.string.PrivacyPolicyAndTerms));
        ...
        textView3.setText(LocaleController.getString("Decline", C3158R.string.Decline).toUpperCase());
        ...
        textView4.setText(LocaleController.getString(RtspHeaders.ACCEPT, C3158R.string.Accept));
    ...
    public /* synthetic */ void lambda$new$4(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("DeclineDeactivate", C3158R.string.DeclineDeactivate), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                TermsOfServiceView.this.lambda$new$3(dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Back", C3158R.string.Back), null);
        builder.setMessage(LocaleController.getString("TosUpdateDecline", C3158R.string.TosUpdateDecline));
        builder.show();
    }
    ...
    public /* synthetic */ void lambda$new$3(DialogInterface dialogInterface, int i) {
        ...
        builder.setMessage(LocaleController.getString("TosDeclineDeleteAccount", C3158R.string.TosDeclineDeleteAccount));
        builder.setTitle(LocaleController.getString("AppName", C3158R.string.AppName));
        builder.setPositiveButton(LocaleController.getString("Deactivate", C3158R.string.Deactivate), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void lambda$new$6(View view) {
        if (this.currentTos.min_age_confirm != 0) {
            AlertDialog.Builder builder = new AlertDialog.Builder(view.getContext());
            builder.setTitle(LocaleController.getString("TosAgeTitle", C3158R.string.TosAgeTitle));
            builder.setPositiveButton(LocaleController.getString("Agree", C3158R.string.Agree), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder.setNegativeButton(LocaleController.getString("Cancel", C3158R.string.Cancel), null);
            builder.setMessage(LocaleController.formatString("TosAgeText", C3158R.string.TosAgeText, LocaleController.formatPluralString("Years", this.currentTos.min_age_confirm, new Object[0])));
            builder.show();
            return;
        }
        accept();
    ...
    private void accept() {
        ...
        tLRPC$TL_help_acceptTermsOfService.f1550id = this.currentTos.f1552id;
