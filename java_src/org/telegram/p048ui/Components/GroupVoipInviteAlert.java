    ...
    */
    ...
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void searchUsers(final String str) {
            ...
            this.searchAdapterHelper.queryServerSearch(null, true, false, true, false, false, GroupVoipInviteAlert.this.currentChat.f1494id, false, 2, -1);
        ...
        public /* synthetic */ void lambda$processSearch$2(final String str, final int i) {
            ...
            this.searchAdapterHelper.queryServerSearch(str, ChatObject.canAddUsers(GroupVoipInviteAlert.this.currentChat), false, true, false, false, ChatObject.isChannel(GroupVoipInviteAlert.this.currentChat) ? GroupVoipInviteAlert.this.currentChat.f1494id : 0L, false, 2, i);
        }
        ...
        */
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                manageChatUserCell2.setCustomRightImage(C3158R.C3160drawable.msg_invited);
                ...
                if (i != GroupVoipInviteAlert.this.membersHeaderRow) {
                    if (i == GroupVoipInviteAlert.this.contactsHeaderRow) {
                        if (GroupVoipInviteAlert.this.showContacts) {
                            graySectionCell.setText(LocaleController.getString("YourContactsToInvite", C3158R.string.YourContactsToInvite));
                            return;
                        } else {
                            graySectionCell.setText(LocaleController.getString("GroupContacts", C3158R.string.GroupContacts));
                            return;
                        }
                    }
                    return;
                }
                graySectionCell.setText(LocaleController.getString("ChannelOtherMembers", C3158R.string.ChannelOtherMembers));
            }
        }
