...
public class InviteMembersBottomSheet extends UsersAlertBase implements NotificationCenter.NotificationCenterDelegate {
    ...
    public InviteMembersBottomSheet(final Context context, int i, final LongSparseArray<TLObject> longSparseArray, final long j, final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.chatId = j;
        fixNavigationBar();
        this.searchView.searchEditText.setHint(LocaleController.getString("SearchForChats", C3158R.string.SearchForChats));
        ...
        imageView.setImageResource(C3158R.C3160drawable.floating_check);
        if (i3 >= 21) {
        ...
        imageView.setContentDescription(LocaleController.getString("Next", C3158R.string.Next));
    ...
    */
    ...
    public /* synthetic */ void lambda$new$2(Context context, long j, View view) {
        ...
        if (this.selectedContacts.size() > 5) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", C3158R.string.AddMembersAlertNamesText, sb, chat.title)));
        }
        builder.setPositiveButton(LocaleController.getString("Add", C3158R.string.Add), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda1
    ...
    */
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 2) {
                ...
                manageChatTextCell2.setText(LocaleController.getString("VoipGroupCopyInviteLink", C3158R.string.VoipGroupCopyInviteLink), null, C3158R.C3160drawable.msg_link, 7, true);
                ...
                if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                    stickerEmptyView.title.setText(LocaleController.getString("FilterNoChats", C3158R.string.FilterNoChats));
                } else {
                    stickerEmptyView.title.setText(LocaleController.getString("NoContacts", C3158R.string.NoContacts));
                }
        ...
        public TLObject getObject(int i) {
            if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                ...
                return DialogObject.isUserDialog(tLRPC$Dialog.f1500id) ? MessagesController.getInstance(((BottomSheet) InviteMembersBottomSheet.this).currentAccount).getUser(Long.valueOf(tLRPC$Dialog.f1500id)) : MessagesController.getInstance(((BottomSheet) InviteMembersBottomSheet.this).currentAccount).getChat(Long.valueOf(-tLRPC$Dialog.f1500id));
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 2) {
                ...
                if (object2 instanceof TLRPC$User) {
                    j = ((TLRPC$User) object2).f1633id;
                } else {
                    j = object2 instanceof TLRPC$Chat ? -((TLRPC$Chat) object2).f1494id : 0L;
                }
                groupCreateUserCell.setObject(object, null, null, i != InviteMembersBottomSheet.this.contactsEndRow);
                if (object instanceof TLRPC$User) {
                    j2 = ((TLRPC$User) object).f1633id;
                } else {
                    j2 = object instanceof TLRPC$Chat ? -((TLRPC$Chat) object).f1494id : 0L;
                }
                if (j2 != 0) {
    ...
    protected void onSearchViewTouched(MotionEvent motionEvent, final EditTextBoldCursor editTextBoldCursor) {
        if (motionEvent.getAction() == 0) {
            this.f1718y = this.scrollOffsetY;
        } else if (motionEvent.getAction() != 1 || Math.abs(this.scrollOffsetY - this.f1718y) >= this.touchSlop || this.enterEventSent) {
        } else {
