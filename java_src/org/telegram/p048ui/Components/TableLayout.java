...
public class TableLayout extends View {
    ...
    static final Alignment UNDEFINED_ALIGNMENT = new Alignment() { // from class: org.telegram.ui.Components.TableLayout.1
        @Override // org.telegram.p048ui.Components.TableLayout.Alignment
        ...
        */
        public void measure(int r2, int r3, boolean r4) {
            ...
            L18:
                ...
                int r2 = r1.textHeight
                int r3 = r3 - r2
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p048ui.Components.TableLayout.this
                int r2 = org.telegram.p048ui.Components.TableLayout.access$100(r2)
                int r3 = r3 - r2
                r1.textY = r3
                goto L31
            L29:
            ...
            L4a:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p048ui.Components.TableLayout.this
                org.telegram.ui.Components.TableLayout$TableLayoutDelegate r2 = org.telegram.p048ui.Components.TableLayout.access$300(r2)
                org.telegram.tgnet.TLRPC$TL_pageTableCell r3 = r1.cell
                int r4 = r1.measuredWidth
                org.telegram.ui.Components.TableLayout r0 = org.telegram.p048ui.Components.TableLayout.this
                int r0 = org.telegram.p048ui.Components.TableLayout.access$200(r0)
                int r0 = r0 * 2
                int r4 = r4 - r0
                org.telegram.ui.ArticleViewer$DrawingText r2 = r2.createTextLayout(r3, r4)
                r1.setTextLayout(r2)
                int r2 = r1.textHeight
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p048ui.Components.TableLayout.this
                int r3 = org.telegram.p048ui.Components.TableLayout.access$100(r3)
                int r3 = r3 * 2
                int r2 = r2 + r3
                r1.fixedHeight = r2
            L71:
                ...
                int r4 = r1.textWidth
                int r3 = r3 - r4
                org.telegram.ui.Components.TableLayout r4 = org.telegram.p048ui.Components.TableLayout.this
                int r4 = org.telegram.p048ui.Components.TableLayout.access$200(r4)
                int r3 = r3 - r4
                int r2 = r2 + r3
                r1.textX = r2
                goto Lb4
            ...
            La2:
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p048ui.Components.TableLayout.this
                int r3 = org.telegram.p048ui.Components.TableLayout.access$200(r3)
                int r2 = r2 + r3
                r1.textX = r2
                goto Lb4
            Lac:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p048ui.Components.TableLayout.this
                int r2 = org.telegram.p048ui.Components.TableLayout.access$200(r2)
                r1.textX = r2
            Lb4:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.TableLayout.Child.measure(int, int, boolean):void");
        }
        ...
        public int getTextX() {
            return this.f1814x + this.textX;
        }

        public int getTextY() {
            return this.f1815y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view) {
            ...
            boolean z = false;
            boolean z2 = true;
            boolean z3 = this.f1814x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
            boolean z4 = this.f1815y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
            int m50dp = AndroidUtilities.m50dp(3);
            if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                if (this.f1814x != 0 || this.f1815y != 0) {
                ...
                if (z2) {
                    TableLayout.this.rect.set(this.f1814x, this.f1815y, i5 + this.measuredWidth, i6 + this.measuredHeight);
                    ...
                    canvas.drawRect(this.f1814x, this.f1815y, i3 + this.measuredWidth, i4 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                } else {
                    canvas.drawRect(this.f1814x, this.f1815y, i + this.measuredWidth, i2 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                }
            }
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i10 == 0) {
                    ...
                    canvas.drawLine(i10 - strokeWidth2, this.f1815y, i10 - strokeWidth2, i7 + this.measuredHeight, linePaint2);
                }
                int i13 = this.f1815y;
                if (i13 == 0) {
                    int i14 = this.f1814x;
                    ...
                    canvas.drawLine(this.f1814x, i13 - strokeWidth2, i8 + this.measuredWidth, i13 - strokeWidth2, linePaint2);
                }
                float f12 = (z3 && (i9 = this.f1815y) == 0) ? i9 + m50dp : this.f1815y - strokeWidth;
                if (z3 && z4) {
                    f = (this.f1815y + this.measuredHeight) - m50dp;
                } else {
                    f = (this.f1815y + this.measuredHeight) - strokeWidth;
                }
                float f13 = f;
                int i16 = this.f1814x;
                ...
                int i18 = this.f1814x;
                float f14 = (i18 == 0 && z4) ? i18 + m50dp : i18 - strokeWidth;
                if (z3 && z4) {
                    f2 = (i18 + this.measuredWidth) - m50dp;
                } else {
    ...
    public TableLayout(Context context, TableLayoutDelegate tableLayoutDelegate, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper) {
        ...
        this.itemPaddingTop = AndroidUtilities.m50dp(7);
        this.itemPaddingLeft = AndroidUtilities.m50dp(8);
            ...
            if (childAt.cell != null) {
                ...
                if (childAt.fixedHeight != 0 && childAt.fixedHeight != sizeInCell2 && childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min <= 1) {
                    ...
                    while (true) {
                        ...
                        if (point.f1758x <= childAt.layoutParams.rowSpec.span.min && point.f1759y > childAt.layoutParams.rowSpec.span.min) {
                            z2 = true;
                            break;
                        }
                        i17++;
    ...
    public final class Axis {
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc m22of = Assoc.m22of(Spec.class, Bounds.class);
            int childCount = TableLayout.this.getChildCount();
            for (int i = 0; i < childCount; i++) {
                LayoutParams layoutParams = TableLayout.this.getChildAt(i).getLayoutParams();
                boolean z = this.horizontal;
                Spec spec = z ? layoutParams.columnSpec : layoutParams.rowSpec;
                m22of.put(spec, spec.getAbsoluteAlignment(z).getBounds());
            }
            return m22of.pack();
        }
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc m22of = Assoc.m22of(Interval.class, MutableInt.class);
            Spec[] specArr = getGroupBounds().keys;
            int length = specArr.length;
            for (int i = 0; i < length; i++) {
                m22of.put(z ? specArr[i].span : specArr[i].span.inverse(), new MutableInt());
            }
            return m22of.pack();
        }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        static {
            Interval interval = new Interval(Integer.MIN_VALUE, C0468C.RATE_UNSET_INT);
        ...
        */
        public LayoutParams() {
            /*
                r1 = this;
                org.telegram.ui.Components.TableLayout$Spec r0 = org.telegram.p048ui.Components.TableLayout.Spec.UNDEFINED
                r1.<init>(r0, r0)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.TableLayout.LayoutParams.<init>():void");
        }
    ...
    public static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m22of(Class<K> cls, Class<V> cls2) {
        ...
        BASELINE = new Alignment() { // from class: org.telegram.ui.Components.TableLayout.6
            ...
            public Bounds getBounds() {
                return new Bounds(this) { // from class: org.telegram.ui.Components.TableLayout.6.1
                    ...
                    @Override // org.telegram.p048ui.Components.TableLayout.Bounds
                    protected void reset() {
                        super.reset();
