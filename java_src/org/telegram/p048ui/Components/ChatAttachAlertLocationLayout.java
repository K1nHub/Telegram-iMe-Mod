...
public class ChatAttachAlertLocationLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class MapOverlayView extends FrameLayout {
        ...
        public void addInfoView(IMapsProvider.IMarker iMarker) {
            ...
            ChatAttachAlertLocationLayout.this.lastPressedMarkerView.setBackgroundResource(C3316R.C3318drawable.venue_tooltip);
    ...
    public ChatAttachAlertLocationLayout(ChatAttachAlert chatAttachAlert, Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        int currentActionBarHeight = (AndroidUtilities.displaySize.x - C3381ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m50dp(66);
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = createMenu.addItem(0, C3316R.C3318drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.Components.ChatAttachAlertLocationLayout.1
        ...
        if (i2 < 21) {
            Drawable mutate = context.getResources().getDrawable(C3316R.C3318drawable.places_btn).mutate();
        ...
        this.mapTypeButton.addSubItem(2, C3316R.C3318drawable.msg_map, LocaleController.getString("Map", C3316R.string.Map), resourcesProvider);
        this.mapTypeButton.addSubItem(3, C3316R.C3318drawable.msg_satellite, LocaleController.getString("Satellite", C3316R.string.Satellite), resourcesProvider);
        this.mapTypeButton.addSubItem(4, C3316R.C3318drawable.msg_hybrid, LocaleController.getString("Hybrid", C3316R.string.Hybrid), resourcesProvider);
        ...
        imageView2.setImageResource(C3316R.C3318drawable.location_empty);
        ...
        imageView3.setImageResource(C3316R.C3318drawable.map_pin2);
        ...
        LocationActivitySearchAdapter locationActivitySearchAdapter2 = new LocationActivitySearchAdapter(context) { // from class: org.telegram.ui.Components.ChatAttachAlertLocationLayout.9
            ...
            public void notifyDataSetChanged() {
                ...
                if (ChatAttachAlertLocationLayout.this.emptySubtitleTextView != null) {
                    ChatAttachAlertLocationLayout.this.emptySubtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoPlacesFoundInfo", C3316R.string.NoPlacesFoundInfo, ChatAttachAlertLocationLayout.this.searchAdapter.getLastSearchString())));
                }
    ...
    */
    public void onPreMeasure(int r4, int r5) {
        ...
        L60:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Components.ChatAttachAlertLocationLayout.onPreMeasure(int, int):void");
    }
        ...
        if (this.checkGpsEnabled && getParentActivity() != null) {
            ...
            try {
                if (!((LocationManager) ApplicationLoader.applicationContext.getSystemService("location")).isProviderEnabled("gps")) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("ConnectingToProxyEnable", C3316R.string.ConnectingToProxyEnable), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlertLocationLayout$$ExternalSyntheticLambda0
    ...
    public void onShow(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        this.parentAlert.actionBar.setTitle(LocaleController.getString("ShareLocation", C3316R.string.ShareLocation));
