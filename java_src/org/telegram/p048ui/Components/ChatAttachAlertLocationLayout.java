...
public class ChatAttachAlertLocationLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class MapOverlayView extends FrameLayout {
        ...
        public void addInfoView(IMapsProvider.IMarker iMarker) {
            ...
            ChatAttachAlertLocationLayout.this.lastPressedMarkerView.setBackgroundResource(C3301R.C3303drawable.venue_tooltip);
    ...
    public ChatAttachAlertLocationLayout(ChatAttachAlert chatAttachAlert, Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        int currentActionBarHeight = (AndroidUtilities.displaySize.x - C3366ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m50dp(66);
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = createMenu.addItem(0, C3301R.C3303drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.Components.ChatAttachAlertLocationLayout.1
        ...
        if (i2 < 21) {
            Drawable mutate = context.getResources().getDrawable(C3301R.C3303drawable.places_btn).mutate();
        ...
        this.mapTypeButton.addSubItem(2, C3301R.C3303drawable.msg_map, LocaleController.getString("Map", C3301R.string.Map), resourcesProvider);
        this.mapTypeButton.addSubItem(3, C3301R.C3303drawable.msg_satellite, LocaleController.getString("Satellite", C3301R.string.Satellite), resourcesProvider);
        this.mapTypeButton.addSubItem(4, C3301R.C3303drawable.msg_hybrid, LocaleController.getString("Hybrid", C3301R.string.Hybrid), resourcesProvider);
        ...
        imageView2.setImageResource(C3301R.C3303drawable.location_empty);
        ...
        imageView3.setImageResource(C3301R.C3303drawable.map_pin2);
        ...
        LocationActivitySearchAdapter locationActivitySearchAdapter2 = new LocationActivitySearchAdapter(context) { // from class: org.telegram.ui.Components.ChatAttachAlertLocationLayout.9
            ...
            public void notifyDataSetChanged() {
                ...
                if (ChatAttachAlertLocationLayout.this.emptySubtitleTextView != null) {
                    ChatAttachAlertLocationLayout.this.emptySubtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoPlacesFoundInfo", C3301R.string.NoPlacesFoundInfo, ChatAttachAlertLocationLayout.this.searchAdapter.getLastSearchString())));
                }
    ...
    */
        ...
        if (this.checkGpsEnabled && getParentActivity() != null) {
            ...
            try {
                if (!((LocationManager) ApplicationLoader.applicationContext.getSystemService("location")).isProviderEnabled("gps")) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("ConnectingToProxyEnable", C3301R.string.ConnectingToProxyEnable), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlertLocationLayout$$ExternalSyntheticLambda0
    ...
    public void onShow(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        this.parentAlert.actionBar.setTitle(LocaleController.getString("ShareLocation", C3301R.string.ShareLocation));
