...
public class WallpaperUpdater {
    ...
    public void showAlert(final boolean z) {
        ...
        if (z) {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3158R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3158R.string.SelectFromGallery), LocaleController.getString("SelectColor", C3158R.string.SelectColor), LocaleController.getString("Default", C3158R.string.Default)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3158R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3158R.string.SelectFromGallery)};
            iArr = new int[]{C3158R.C3160drawable.msg_camera, C3158R.C3160drawable.msg_photos};
        }
