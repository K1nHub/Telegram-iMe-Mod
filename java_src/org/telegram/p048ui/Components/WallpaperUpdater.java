...
public class WallpaperUpdater {
    ...
    public void showAlert(final boolean z) {
        ...
        if (z) {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3316R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3316R.string.SelectFromGallery), LocaleController.getString("SelectColor", C3316R.string.SelectColor), LocaleController.getString("Default", C3316R.string.Default)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3316R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3316R.string.SelectFromGallery)};
            iArr = new int[]{C3316R.C3318drawable.msg_camera, C3316R.C3318drawable.msg_photos};
        }
