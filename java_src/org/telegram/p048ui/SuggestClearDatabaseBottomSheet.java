...
public class SuggestClearDatabaseBottomSheet extends BottomSheet {
    ...
    private SuggestClearDatabaseBottomSheet(final BaseFragment baseFragment) {
        ...
        textView.setText(LocaleController.getString("SuggestClearDatabaseTitle", C3286R.string.SuggestClearDatabaseTitle));
        ...
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString("SuggestClearDatabaseMessage", C3286R.string.SuggestClearDatabaseMessage, AndroidUtilities.formatFileSize(baseFragment.getMessagesStorage().getDatabaseSize()))));
        ...
        textView3.setText(LocaleController.getString("ClearLocalDatabase", C3286R.string.ClearLocalDatabase));
    ...
    public /* synthetic */ void lambda$new$1(final BaseFragment baseFragment, View view) {
        ...
        builder.setTitle(LocaleController.getString("LocalDatabaseClearTextTitle", C3286R.string.LocalDatabaseClearTextTitle));
        builder.setMessage(LocaleController.getString("LocalDatabaseClearText", C3286R.string.LocalDatabaseClearText));
        builder.setNegativeButton(LocaleController.getString("Cancel", C3286R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("CacheClear", C3286R.string.CacheClear), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.SuggestClearDatabaseBottomSheet$$ExternalSyntheticLambda0
