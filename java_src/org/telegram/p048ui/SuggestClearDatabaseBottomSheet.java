...
public class SuggestClearDatabaseBottomSheet extends BottomSheet {
    ...
    private SuggestClearDatabaseBottomSheet(final BaseFragment baseFragment) {
        ...
        textView.setText(LocaleController.getString("SuggestClearDatabaseTitle", C3158R.string.SuggestClearDatabaseTitle));
        ...
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString("SuggestClearDatabaseMessage", C3158R.string.SuggestClearDatabaseMessage, AndroidUtilities.formatFileSize(baseFragment.getMessagesStorage().getDatabaseSize()))));
        ...
        textView3.setText(LocaleController.getString("ClearLocalDatabase", C3158R.string.ClearLocalDatabase));
    ...
    public /* synthetic */ void lambda$new$1(final BaseFragment baseFragment, View view) {
        ...
        builder.setTitle(LocaleController.getString("LocalDatabaseClearTextTitle", C3158R.string.LocalDatabaseClearTextTitle));
        builder.setMessage(LocaleController.getString("LocalDatabaseClearText", C3158R.string.LocalDatabaseClearText));
        builder.setNegativeButton(LocaleController.getString("Cancel", C3158R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("CacheClear", C3158R.string.CacheClear), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.SuggestClearDatabaseBottomSheet$$ExternalSyntheticLambda0
