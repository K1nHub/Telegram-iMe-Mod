...
public class ChatEditTypeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public void onResume() {
        ...
        if (textSettingsCell != null && (tLRPC$ChatFull = this.info) != null) {
            if (tLRPC$ChatFull.stickerset != null) {
                textSettingsCell.setTextAndValue(LocaleController.getString("GroupStickers", C3316R.string.GroupStickers), this.info.stickerset.title, false);
            } else {
                textSettingsCell.setText(LocaleController.getString("GroupStickers", C3316R.string.GroupStickers), false);
            }
        }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ChatEditTypeActivity.1
        ...
        this.doneButton = createMenu.addItemWithWidth(1, crossfadeDrawable, AndroidUtilities.m50dp(56), LocaleController.getString("Done", C3316R.string.Done));
        ...
        if (this.isForcePublic) {
            this.actionBar.setTitle(LocaleController.getString("TypeLocationGroup", C3316R.string.TypeLocationGroup));
        } else if (this.isChannel) {
            this.actionBar.setTitle(LocaleController.getString("ChannelSettingsTitle", C3316R.string.ChannelSettingsTitle));
        } else {
            this.actionBar.setTitle(LocaleController.getString("GroupSettingsTitle", C3316R.string.GroupSettingsTitle));
        }
        ...
        if (this.isChannel) {
            this.headerCell2.setText(LocaleController.getString("ChannelTypeHeader", C3316R.string.ChannelTypeHeader));
        } else {
            this.headerCell2.setText(LocaleController.getString("GroupTypeHeader", C3316R.string.GroupTypeHeader));
        }
        ...
        if (this.isChannel) {
            this.radioButtonCell2.setTextAndValue(LocaleController.getString("ChannelPrivate", C3316R.string.ChannelPrivate), LocaleController.getString("ChannelPrivateInfo", C3316R.string.ChannelPrivateInfo), false, this.isPrivate);
        } else {
            this.radioButtonCell2.setTextAndValue(LocaleController.getString("MegaPrivate", C3316R.string.MegaPrivate), LocaleController.getString("MegaPrivateInfo", C3316R.string.MegaPrivateInfo), false, this.isPrivate);
        }
        ...
        if (this.isChannel) {
            this.radioButtonCell1.setTextAndValue(LocaleController.getString("ChannelPublic", C3316R.string.ChannelPublic), LocaleController.getString("ChannelPublicInfo", C3316R.string.ChannelPublicInfo), false, !this.isPrivate);
        } else {
            this.radioButtonCell1.setTextAndValue(LocaleController.getString("MegaPublic", C3316R.string.MegaPublic), LocaleController.getString("MegaPublicInfo", C3316R.string.MegaPublicInfo), false, !this.isPrivate);
        }
        ...
        this.usernameTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C3316R.string.ChannelUsernamePlaceholder));
        ...
        C39656 c39656 = new C39656(context);
        this.checkTextView = c39656;
        c39656.setBackgroundDrawable(Theme.getThemedDrawable(context, C3316R.C3318drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
        ...
        this.manageLinksTextView.setTextAndIcon(LocaleController.getString("ManageInviteLinks", C3316R.string.ManageInviteLinks), C3316R.C3318drawable.msg_link2, false);
        ...
        this.saveHeaderCell.setText(LocaleController.getString("SavingContentTitle", C3316R.string.SavingContentTitle));
        ...
        this.saveRestrictCell.setTextAndCheck(LocaleController.getString("RestrictSavingContent", C3316R.string.RestrictSavingContent), this.isSaveRestricted, false);
        ...
        if (this.isChannel && !ChatObject.isMegagroup(this.currentChat)) {
            this.saveRestrictInfoCell.setText(LocaleController.getString("RestrictSavingContentInfoChannel", C3316R.string.RestrictSavingContentInfoChannel));
        } else {
            this.saveRestrictInfoCell.setText(LocaleController.getString("RestrictSavingContentInfoGroup", C3316R.string.RestrictSavingContentInfoGroup));
        }
    ...
    /* loaded from: classes5.dex */
    class C39656 extends TextInfoPrivacyCell {
        int prevHeight;
        ValueAnimator translateAnimator;

        C39656(Context context) {
            super(context);
            this.prevHeight = -1;
        }
                ...
                for (int i = 0; i < typefaceSpanArr.length; i++) {
                    charSequence.setSpan(new ClickableSpan() { // from class: org.telegram.ui.ChatEditTypeActivity.6.1
                        ...
                        public void onClick(View view) {
                            Context context = C39656.this.getContext();
            ...
            if (this.prevHeight != -1 && ChatEditTypeActivity.this.linearLayout != null) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ChatEditTypeActivity$6$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatEditTypeActivity.C39656.lambda$onLayout$0(arrayList, height, valueAnimator2);
                    }
                });
    ...
    */
    ...
    public class UsernamesListView extends RecyclerListView {
        ...
        public UsernamesListView(Context context) {
            ...
            setOnItemClickListener(new C39671(ChatEditTypeActivity.this));
        ...
        /* loaded from: classes5.dex */
        public class C39671 implements RecyclerListView.OnItemClickListener {
            C39671(ChatEditTypeActivity chatEditTypeActivity) {
            }
            ...
            public void onItemClick(final View view, int i) {
                ...
                message.setPositiveButton(LocaleController.getString(str3, i4), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i5) {
                        ChatEditTypeActivity.UsernamesListView.C39671.this.lambda$onItemClick$4(tLRPC$TL_username, view, dialogInterface, i5);
                    }
                }).setNegativeButton(LocaleController.getString("Cancel", C3316R.string.Cancel), DialogInterface$OnClickListenerC3971xdfb97325.INSTANCE).show();
            }
            ...
            public /* synthetic */ void lambda$onItemClick$4(final TLRPC$TL_username tLRPC$TL_username, View view, DialogInterface dialogInterface, int i) {
                if (tLRPC$TL_username.editable) {
                    ...
                    tLRPC$TL_inputChannel.channel_id = ChatEditTypeActivity.this.currentChat.f1502id;
                    ...
                    ChatEditTypeActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_channels_toggleUsername, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda5
                        ...
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            ChatEditTypeActivity.UsernamesListView.C39671.this.lambda$onItemClick$3(tLRPC$TL_channels_toggleUsername, tLRPC$TL_username, z2, tLObject, tLRPC$TL_error);
                        }
                    });
            ...
            public /* synthetic */ void lambda$onItemClick$3(final TLRPC$TL_channels_toggleUsername tLRPC$TL_channels_toggleUsername, final TLRPC$TL_username tLRPC$TL_username, final boolean z, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatEditTypeActivity.UsernamesListView.C39671.this.lambda$onItemClick$2(tLRPC$TL_channels_toggleUsername, tLObject, tLRPC$TL_username, z, tLRPC$TL_error);
                    }
                });
            }
            ...
            public /* synthetic */ void lambda$onItemClick$2(TLRPC$TL_channels_toggleUsername tLRPC$TL_channels_toggleUsername, TLObject tLObject, final TLRPC$TL_username tLRPC$TL_username, final boolean z, TLRPC$TL_error tLRPC$TL_error) {
                ...
                if (tLObject instanceof TLRPC$TL_boolTrue) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatEditTypeActivity.UsernamesListView.C39671.this.lambda$onItemClick$1(tLRPC$TL_username, z);
                        }
                    });
                } else {
            ...
            public /* synthetic */ void lambda$onItemClick$1(final TLRPC$TL_username tLRPC$TL_username, final boolean z) {
                new AlertDialog.Builder(UsernamesListView.this.getContext(), ((RecyclerListView) UsernamesListView.this).resourcesProvider).setTitle(LocaleController.getString("UsernameActivateErrorTitle", C3316R.string.UsernameActivateErrorTitle)).setMessage(LocaleController.getString("UsernameActivateErrorMessage", C3316R.string.UsernameActivateErrorMessage)).setPositiveButton(LocaleController.getString("OK", C3316R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        ChatEditTypeActivity.UsernamesListView.C39671.this.lambda$onItemClick$0(tLRPC$TL_username, z, dialogInterface, i);
                    }
                }).show();
            }
        ...
        public class Adapter extends RecyclerListView.SelectionAdapter {
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (itemViewType == 0) {
                    ...
                    ((HeaderCell) viewHolder.itemView).setText(LocaleController.getString("UsernamesChannelHeader", C3316R.string.UsernamesChannelHeader));
                    return;
                }
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                    ...
                    ((TextInfoPrivacyCell) viewHolder.itemView).setText(LocaleController.getString("UsernamesChannelHelp", C3316R.string.UsernamesChannelHelp));
                    ((TextInfoPrivacyCell) viewHolder.itemView).setBackgroundDrawable(Theme.getThemedDrawable(UsernamesListView.this.getContext(), C3316R.C3318drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                    return;
                }
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$18(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3316R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
    ...
    private void updatePrivatePublic() {
        ...
        if (!this.isPrivate && !this.canCreatePublic && getUserConfig().isPremium()) {
            this.typeInfoCell.setText(LocaleController.getString("ChangePublicLimitReached", C3316R.string.ChangePublicLimitReached));
            ...
            if (this.loadingAdminedChannels) {
                ...
                this.typeInfoCell.setBackgroundDrawable(this.checkTextView.getVisibility() == 0 ? null : Theme.getThemedDrawable(this.typeInfoCell.getContext(), C3316R.C3318drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                this.adminedInfoCell.setBackgroundDrawable(null);
            } else {
                ShadowSectionCell shadowSectionCell = this.adminedInfoCell;
                shadowSectionCell.setBackgroundDrawable(Theme.getThemedDrawable(shadowSectionCell.getContext(), C3316R.C3318drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                TextInfoPrivacyCell textInfoPrivacyCell = this.typeInfoCell;
                textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(textInfoPrivacyCell.getContext(), C3316R.C3318drawable.greydivider_top, "windowBackgroundGrayShadow"));
            ...
            if (this.isChannel) {
                ...
                if (this.isPrivate) {
                    i2 = C3316R.string.ChannelPrivateLinkHelp;
                    str2 = "ChannelPrivateLinkHelp";
                } else {
                    i2 = C3316R.string.ChannelUsernameHelp;
                    str2 = "ChannelUsernameHelp";
                }
                textInfoPrivacyCell3.setText(LocaleController.getString(str2, i2));
                this.headerCell.setText(this.isPrivate ? LocaleController.getString("ChannelInviteLinkTitle", C3316R.string.ChannelInviteLinkTitle) : LocaleController.getString("ChannelLinkTitle", C3316R.string.ChannelLinkTitle));
            } else {
                TextInfoPrivacyCell textInfoPrivacyCell4 = this.typeInfoCell;
                if (this.isPrivate) {
                    i = C3316R.string.MegaPrivateLinkHelp;
                    str = "MegaPrivateLinkHelp";
                } else {
                    i = C3316R.string.MegaUsernameHelp;
            ...
            this.manageLinksInfoCell.setText(LocaleController.getString("ManageLinksInfoHelp", C3316R.string.ManageLinksInfoHelp));
            if (this.isPrivate) {
                TextInfoPrivacyCell textInfoPrivacyCell6 = this.typeInfoCell;
                textInfoPrivacyCell6.setBackgroundDrawable(Theme.getThemedDrawable(textInfoPrivacyCell6.getContext(), C3316R.C3318drawable.greydivider, "windowBackgroundGrayShadow"));
    ...
    public boolean checkUserName(final String str) {
        ...
        if (str != null) {
            if (str.startsWith("_") || str.endsWith("_")) {
                this.checkTextView.setText(LocaleController.getString("LinkInvalid", C3316R.string.LinkInvalid));
            ...
            for (int i = 0; i < str.length(); i++) {
                ...
                if (i == 0 && charAt >= '0' && charAt <= '9') {
                    if (this.isChannel) {
                        this.checkTextView.setText(LocaleController.getString("LinkInvalidStartNumber", C3316R.string.LinkInvalidStartNumber));
                    } else {
                        this.checkTextView.setText(LocaleController.getString("LinkInvalidStartNumberMega", C3316R.string.LinkInvalidStartNumberMega));
                    }
                    this.checkTextView.setTextColor("windowBackgroundWhiteRedText4");
                    return false;
        ...
        if (str == null || str.length() < 4) {
            if (this.isChannel) {
                this.checkTextView.setText(LocaleController.getString("LinkInvalidShort", C3316R.string.LinkInvalidShort));
            } else {
                this.checkTextView.setText(LocaleController.getString("LinkInvalidShortMega", C3316R.string.LinkInvalidShortMega));
            }
            this.checkTextView.setTextColor("windowBackgroundWhiteRedText4");
            return false;
        } else if (str.length() > 32) {
            this.checkTextView.setText(LocaleController.getString("LinkInvalidLong", C3316R.string.LinkInvalidLong));
            this.checkTextView.setTextColor("windowBackgroundWhiteRedText4");
            return false;
        } else {
            this.checkTextView.setText(LocaleController.getString("LinkChecking", C3316R.string.LinkChecking));
    ...
    public /* synthetic */ void lambda$checkUserName$21(String str, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, TLRPC$TL_channels_checkUsername tLRPC$TL_channels_checkUsername) {
        ...
        if (tLRPC$TL_error == null && (tLObject instanceof TLRPC$TL_boolTrue)) {
            this.checkTextView.setText(LocaleController.formatString("LinkAvailable", C3316R.string.LinkAvailable, str));
        ...
        if (tLRPC$TL_error != null && "USERNAME_INVALID".equals(tLRPC$TL_error.text) && tLRPC$TL_channels_checkUsername.username.length() == 4) {
            this.checkTextView.setText(LocaleController.getString("UsernameInvalidShort", C3316R.string.UsernameInvalidShort));
            ...
            if (tLRPC$TL_channels_checkUsername.username.length() == 4) {
                this.checkTextView.setText(LocaleController.getString("UsernameInvalidShortPurchase", C3316R.string.UsernameInvalidShortPurchase));
            } else {
                this.checkTextView.setText(LocaleController.getString("UsernameInUsePurchase", C3316R.string.UsernameInUsePurchase));
            }
            ...
            this.checkTextView.setText(LocaleController.getString("LinkInUse", C3316R.string.LinkInUse));
            this.checkTextView.setTextColor("windowBackgroundWhiteRedText4");
        }
        this.lastNameAvailable = false;
    }
