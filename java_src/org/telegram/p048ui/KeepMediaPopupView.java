...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public KeepMediaPopupView(final BaseFragment baseFragment, Context context) {
        ...
        setFitItems(true);
        this.oneDay = ActionBarMenuItem.addItem(this, C3286R.C3288drawable.msg_autodelete_1d, LocaleController.formatPluralString("Days", 1, new Object[0]), false, null);
        this.oneWeek = ActionBarMenuItem.addItem(this, C3286R.C3288drawable.msg_autodelete_1w, LocaleController.formatPluralString("Weeks", 1, new Object[0]), false, null);
        this.oneMonth = ActionBarMenuItem.addItem(this, C3286R.C3288drawable.msg_autodelete_1m, LocaleController.formatPluralString("Months", 1, new Object[0]), false, null);
        this.forever = ActionBarMenuItem.addItem(this, C3286R.C3288drawable.msg_cancel, LocaleController.getString("AutoDeleteMediaNever", C3286R.string.AutoDeleteMediaNever), false, null);
        ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(this, C3286R.C3288drawable.msg_delete, LocaleController.getString("DeleteException", C3286R.string.DeleteException), false, null);
        this.delete = addItem;
        ...
        view.setBackground(Theme.getThemedDrawable(context, C3286R.C3288drawable.greydivider, "windowBackgroundGrayShadow", null));
        this.gap.addView(view, LayoutHelper.createFrame(-1, -1));
        this.gap.setTag(C3286R.C3289id.fit_width_tag, 1);
        ...
        linksTextView.setTag(C3286R.C3289id.fit_width_tag, 1);
        linksTextView.setPadding(AndroidUtilities.m50dp(13), 0, AndroidUtilities.m50dp(13), AndroidUtilities.m50dp(8));
        ...
        linksTextView.setText(LocaleController.getString("KeepMediaPopupDescription", C3286R.string.KeepMediaPopupDescription));
    ...
    public void update(int i) {
        ...
        if (keepMediaExceptions.isEmpty()) {
            this.exceptionsView.titleView.setText(LocaleController.getString("AddAnException", C3286R.string.AddAnException));
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m50dp(8));
            ...
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m50dp((Math.max(0, min - 1) * 12) + 64));
    ...
    public class ExceptionsView extends FrameLayout {
        ...
        public ExceptionsView(Context context) {
            ...
            this.titleView.setRightPadding(AndroidUtilities.m50dp(68));
    ...
    public void updateAvatarsPosition() {
        if (this.exceptions != null) {
            this.exceptionsView.avatarsImageView.setTranslationX(AndroidUtilities.m50dp(12) * (3 - Math.min(3, this.exceptions.size())));
        }
    }
