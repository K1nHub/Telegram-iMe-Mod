...
public class LinkEditActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        ...
        int i = this.type;
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString("NewLink", C3316R.string.NewLink));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("EditLink", C3316R.string.EditLink));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.LinkEditActivity.1
        ...
        int i2 = this.type;
        if (i2 == 0) {
            this.createTextView.setText(LocaleController.getString("CreateLinkHeader", C3316R.string.CreateLinkHeader));
        } else if (i2 == 1) {
            this.createTextView.setText(LocaleController.getString("SaveLinkHeader", C3316R.string.SaveLinkHeader));
        }
        ...
        this.createTextView.setPadding(AndroidUtilities.m50dp(18), AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(18), AndroidUtilities.m50dp(8));
        this.actionBar.addView(this.createTextView, LayoutHelper.createFrame(-2, -2, 8388629, 0, this.actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight / AndroidUtilities.m50dp(2) : 0, 0, 0));
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.LinkEditActivity.2
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                if (i5 == i6 || i6 <= AndroidUtilities.m50dp(20) || !z2) {
                ...
                if (i7 != 0 && i7 < AndroidUtilities.m50dp(20)) {
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.LinkEditActivity.3
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                int m50dp2 = size - ((AndroidUtilities.m50dp(48) + AndroidUtilities.m50dp(24)) + AndroidUtilities.m50dp(16));
                if (i5 >= m50dp2) {
                    m50dp = AndroidUtilities.m50dp(24);
                } else {
                    m50dp = (AndroidUtilities.m50dp(24) + m50dp2) - i5;
                }
                if (((LinearLayout.LayoutParams) LinkEditActivity.this.buttonTextView.getLayoutParams()).topMargin != m50dp) {
                    int i7 = ((LinearLayout.LayoutParams) LinkEditActivity.this.buttonTextView.getLayoutParams()).topMargin;
                    ((LinearLayout.LayoutParams) LinkEditActivity.this.buttonTextView.getLayoutParams()).topMargin = m50dp;
                    if (!LinkEditActivity.this.firstLayout) {
                        LinkEditActivity.this.buttonTextView.setTranslationY(i7 - m50dp);
        ...
        int i3 = this.type;
        if (i3 == 0) {
            this.buttonTextView.setText(LocaleController.getString("CreateLink", C3316R.string.CreateLink));
        } else if (i3 == 1) {
            this.buttonTextView.setText(LocaleController.getString("SaveLink", C3316R.string.SaveLink));
        }
        ...
        if (chat == null || chat.username == null) {
            TextCheckCell textCheckCell = new TextCheckCell(this, context) { // from class: org.telegram.ui.LinkEditActivity.4
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // org.telegram.p048ui.Cells.TextCheckCell, android.view.View
            ...
            this.approveCell.setTextAndCheck(LocaleController.getString("ApproveNewMembers", C3316R.string.ApproveNewMembers), false, false);
        ...
        int i4 = C3316R.C3318drawable.greydivider;
        textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(context, i4, "windowBackgroundGrayShadow"));
        if (z) {
            textInfoPrivacyCell.setText(LocaleController.getString("ApproveNewMembersDescription", C3316R.string.ApproveNewMembersDescription));
        }
        linearLayout.addView(textInfoPrivacyCell);
        HeaderCell headerCell = new HeaderCell(context);
        this.timeHeaderCell = headerCell;
        headerCell.setText(LocaleController.getString("LimitByPeriod", C3316R.string.LimitByPeriod));
        ...
        textView3.setPadding(AndroidUtilities.m50dp(22), 0, AndroidUtilities.m50dp(22), 0);
        this.timeEditText.setGravity(16);
        this.timeEditText.setTextSize(1, 16.0f);
        this.timeEditText.setHint(LocaleController.getString("TimeLimitHint", C3316R.string.TimeLimitHint));
        ...
        textInfoPrivacyCell2.setText(LocaleController.getString("TimeLimitHelp", C3316R.string.TimeLimitHelp));
        linearLayout.addView(this.divider);
        HeaderCell headerCell2 = new HeaderCell(context);
        this.usesHeaderCell = headerCell2;
        headerCell2.setText(LocaleController.getString("LimitNumberOfUses", C3316R.string.LimitNumberOfUses));
        ...
        editText.setPadding(AndroidUtilities.m50dp(22), 0, AndroidUtilities.m50dp(22), 0);
        this.usesEditText.setGravity(16);
        this.usesEditText.setTextSize(1, 16.0f);
        this.usesEditText.setHint(LocaleController.getString("UsesLimitHint", C3316R.string.UsesLimitHint));
        ...
        textInfoPrivacyCell3.setText(LocaleController.getString("UsesLimitHelp", C3316R.string.UsesLimitHelp));
        ...
        this.nameEditText.setHint(LocaleController.getString("LinkNameHint", C3316R.string.LinkNameHint));
        this.nameEditText.setHintTextColor(Theme.getColor("windowBackgroundWhiteGrayText"));
        this.nameEditText.setLines(1);
        this.nameEditText.setPadding(AndroidUtilities.m50dp(22), 0, AndroidUtilities.m50dp(22), 0);
        ...
        this.dividerName.setText(LocaleController.getString("LinkNameHelp", C3316R.string.LinkNameHelp));
        linearLayout.addView(this.dividerName);
        if (this.type == 1) {
            TextSettingsCell textSettingsCell = new TextSettingsCell(context);
            this.revokeLink = textSettingsCell;
            textSettingsCell.setBackgroundColor(Theme.getColor("windowBackgroundWhite"));
            this.revokeLink.setText(LocaleController.getString("RevokeLink", C3316R.string.RevokeLink), false);
    ...
    public /* synthetic */ void lambda$createView$6(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3316R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.LinkEditActivity$$ExternalSyntheticLambda0
    ...
    */
    public void onCreateClicked(android.view.View r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.LinkEditActivity.onCreateClicked(android.view.View):void");
    }
    ...
    public void chooseUses(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (i4 == size - 1) {
                strArr[i4] = LocaleController.getString("NoLimit", C3316R.string.NoLimit);
            } else {
    ...
    private void chooseDate(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (i4 == size - 1) {
                ...
                long j2 = currentTime;
                if (j2 < 86400) {
                    strArr[i4] = LocaleController.getString("MessageScheduleToday", C3316R.string.MessageScheduleToday);
                } else if (j2 < 31449600) {
    ...
    private void resetDates() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                this.timeChooseView.setOptions(3, LocaleController.formatPluralString("Hours", 1, new Object[0]), LocaleController.formatPluralString("Days", 1, new Object[0]), LocaleController.formatPluralString("Weeks", 1, new Object[0]), LocaleController.getString("NoLimit", C3316R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public void resetUses() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                this.usesChooseView.setOptions(3, IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, "10", "100", LocaleController.getString("NoLimit", C3316R.string.NoLimit));
                return;
            }
        }
    }
    ...
    private void setUsesVisible(boolean z) {
        ...
        this.divider.setBackground(Theme.getThemedDrawable(getParentActivity(), z ? C3316R.C3318drawable.greydivider : C3316R.C3318drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
    }
    ...
    public /* synthetic */ void lambda$getThemeDescriptions$11() {
        ...
        if (textInfoPrivacyCell != null) {
            ...
            int i = C3316R.C3318drawable.greydivider_bottom;
            textInfoPrivacyCell2.setBackgroundDrawable(Theme.getThemedDrawable(context, i, "windowBackgroundGrayShadow"));
            this.divider.setBackgroundDrawable(Theme.getThemedDrawable(context, C3316R.C3318drawable.greydivider, "windowBackgroundGrayShadow"));
            this.buttonTextView.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m50dp(6), Theme.getColor("featuredStickers_addButton"), Theme.getColor("featuredStickers_addButtonPressed")));
            this.usesEditText.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText"));
            this.usesEditText.setHintTextColor(Theme.getColor("windowBackgroundWhiteGrayText"));
            this.timeEditText.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText"));
