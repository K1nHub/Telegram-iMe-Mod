...
public class DataUsage2Activity extends BaseFragment {
    ...
    private static int[] particles = {C3158R.C3160drawable.msg_filled_data_videos, C3158R.C3160drawable.msg_filled_data_files, C3158R.C3160drawable.msg_filled_data_photos, C3158R.C3160drawable.msg_filled_data_messages, C3158R.C3160drawable.msg_filled_data_music, C3158R.C3160drawable.msg_filled_data_voice, C3158R.C3160drawable.msg_filled_data_calls};
    private static int[] titles = {C3158R.string.LocalVideoCache, C3158R.string.LocalDocumentCache, C3158R.string.LocalPhotoCache, C3158R.string.MessagesSettings, C3158R.string.LocalMusicCache, C3158R.string.LocalAudioCache, C3158R.string.CallsDataUsage};
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("NetworkUsage", C3158R.string.NetworkUsage));
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3222ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.DataUsage2Activity.1
    ...
    private class PageAdapter extends ViewPagerFixed.Adapter {
        ...
        public View createView(int i) {
            ...
            return new C5319ListView(dataUsage2Activity.getContext());
        }

        @Override // org.telegram.p048ui.Components.ViewPagerFixed.Adapter
        public void bindView(View view, int i, int i2) {
            C5319ListView c5319ListView = (C5319ListView) view;
            c5319ListView.setType(i);
            c5319ListView.scrollToPosition(0);
        }
        ...
        public String getItemTitle(int i) {
            if (i != 0) {
                if (i != 1) {
                    if (i != 2) {
                        return i != 3 ? "" : LocaleController.getString("NetworkUsageRoamingTab", C3158R.string.NetworkUsageRoamingTab);
                    }
                    return LocaleController.getString("NetworkUsageWiFiTab", C3158R.string.NetworkUsageWiFiTab);
                }
                return LocaleController.getString("NetworkUsageMobileTab", C3158R.string.NetworkUsageMobileTab);
            }
            return LocaleController.getString("NetworkUsageAllTab", C3158R.string.NetworkUsageAllTab);
        }
    }
    ...
    /* loaded from: classes5.dex */
    public class C5319ListView extends RecyclerListView {
        Adapter adapter;
        ...
        public C5319ListView(Context context) {
            super(context);
            ...
            setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.DataUsage2Activity$ListView$$ExternalSyntheticLambda2
                ...
                public final void onItemClick(View view, int i) {
                    DataUsage2Activity.C5319ListView.this.lambda$new$1(view, i);
                }
            });
        ...
        public /* synthetic */ void lambda$new$1(View view, int i) {
            if ((view instanceof Cell) && i >= 0 && i < this.itemInners.size()) {
                ...
                builder.setTitle(LocaleController.getString("ResetStatisticsAlertTitle", C3158R.string.ResetStatisticsAlertTitle));
                builder.setMessage(LocaleController.getString("ResetStatisticsAlert", C3158R.string.ResetStatisticsAlert));
                builder.setPositiveButton(LocaleController.getString("Reset", C3158R.string.Reset), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DataUsage2Activity$ListView$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i3) {
                        DataUsage2Activity.C5319ListView.this.lambda$new$0(dialogInterface, i3);
                    }
                });
        ...
        public class Size extends CacheChart.SegmentSize {
            ...
            public Size(C5319ListView c5319ListView, int i, long j, long j2, long j3, int i2, int i3) {
                this.index = i;
                this.size = j;
                this.selected = true;
                this.inSize = j2;
        ...
        private void updateRows(boolean z) {
            ...
            long j = 0;
            if (this.totalSize > 0) {
                formatString = LocaleController.formatString("YourNetworkUsageSince", C3158R.string.YourNetworkUsageSince, LocaleController.getInstance().formatterStats.format(getResetStatsDate()));
            } else {
                formatString = LocaleController.formatString("NoNetworkUsageSince", C3158R.string.NoNetworkUsageSince, LocaleController.getInstance().formatterStats.format(getResetStatsDate()));
            }
            ...
            if (!arrayList.isEmpty()) {
                ...
                Drawable mutate = getContext().getResources().getDrawable(C3158R.C3160drawable.msg_mini_upload).mutate();
                ...
                Drawable mutate2 = getContext().getResources().getDrawable(C3158R.C3160drawable.msg_mini_download).mutate();
                    ...
                    if (i5 >= 0 && !this.collapsed[i5]) {
                        ...
                        if (DataUsage2Activity.stats[size.index] != 0) {
                            if (DataUsage2Activity.stats[size.index] != 1) {
                                ...
                                if (size.outSize > 0 || size.outCount > 0) {
                                    i4++;
                                    arrayList.add(i4, ItemInner.asCell(-1, 0, 0, TextUtils.concat(spannableString2, " ", LocaleController.getString("BytesSent", C3158R.string.BytesSent)), AndroidUtilities.formatFileSize(size.outSize)));
                                }
                                if (size.inSize > 0 || size.inCount > 0) {
                                    i4++;
                                    arrayList.add(i4, ItemInner.asCell(-1, 0, 0, TextUtils.concat(spannableString3, " ", LocaleController.getString("BytesReceived", C3158R.string.BytesReceived)), AndroidUtilities.formatFileSize(size.inSize)));
                                }
                                i4++;
                            }
                        } else {
                ...
                if (!this.empty) {
                    this.itemInners.add(ItemInner.asSeparator(LocaleController.getString("DataUsageSectionsInfo", C3158R.string.DataUsageSectionsInfo)));
                }
            }
            if (!this.empty) {
                this.itemInners.add(ItemInner.asHeader(LocaleController.getString("TotalNetworkUsage", C3158R.string.TotalNetworkUsage)));
                this.itemInners.add(ItemInner.asCell(-1, C3158R.C3160drawable.msg_filled_data_sent, getThemedColor("statisticChartLine_lightblue"), LocaleController.getString("BytesSent", C3158R.string.BytesSent), AndroidUtilities.formatFileSize(this.totalSizeOut)));
                this.itemInners.add(ItemInner.asCell(-1, C3158R.C3160drawable.msg_filled_data_received, getThemedColor("statisticChartLine_green"), LocaleController.getString("BytesReceived", C3158R.string.BytesReceived), AndroidUtilities.formatFileSize(this.totalSizeIn)));
            }
            if (!arrayList.isEmpty()) {
            ...
            if (this.currentType != 0) {
                ...
                this.itemInners.add(ItemInner.asCell(-2, C3158R.C3160drawable.msg_download_settings, getThemedColor("statisticChartLine_lightblue"), LocaleController.getString("AutomaticDownloadSettings", C3158R.string.AutomaticDownloadSettings), null));
                int i6 = this.currentType;
                if (i6 == 1) {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoMobile", C3158R.string.AutomaticDownloadSettingsInfoMobile);
                } else if (i6 == 3) {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoRoaming", C3158R.string.AutomaticDownloadSettingsInfoRoaming);
                } else {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoWiFi", C3158R.string.AutomaticDownloadSettingsInfoWiFi);
                }
                this.itemInners.add(ItemInner.asSeparator(string));
            }
            if (!arrayList.isEmpty()) {
                this.itemInners.add(new ItemInner(5, LocaleController.getString("ResetStatistics", C3158R.string.ResetStatistics)));
            }
            this.itemInners.add(ItemInner.asSeparator());
        ...
        public class Adapter extends AdapterWithDiffUtils {
            ...
            /* loaded from: classes5.dex */
            class C53201 extends CacheChart {
                /* JADX INFO: Access modifiers changed from: private */
                ...
                C53201(Context context, int i, String[] strArr, int i2, int[] iArr) {
                ...
                protected void onSectionDown(int i, boolean z) {
                    final int i2;
                    if (z) {
                        if (i < 0 || i >= C5319ListView.this.segments.length) {
                            return;
                        }
                        int i3 = 0;
                        while (true) {
                            i2 = -1;
                            if (i3 >= C5319ListView.this.segments.length) {
                                i3 = -1;
                                break;
                            } else if (C5319ListView.this.segments[i3].index == i) {
                                break;
                            } else {
                                i3++;
                            }
                        ...
                        int i4 = 0;
                        while (true) {
                            if (i4 < C5319ListView.this.itemInners.size()) {
                                ItemInner itemInner = (ItemInner) C5319ListView.this.itemInners.get(i4);
                        ...
                        if (i2 >= 0) {
                            C5319ListView.this.highlightRow(new RecyclerListView.IntReturnCallback() { // from class: org.telegram.ui.DataUsage2Activity$ListView$Adapter$1$$ExternalSyntheticLambda0
                                @Override // org.telegram.p048ui.Components.RecyclerListView.IntReturnCallback
                                public final int run() {
                                    int lambda$onSectionDown$0;
                                    lambda$onSectionDown$0 = DataUsage2Activity.C5319ListView.Adapter.C53201.lambda$onSectionDown$0(i2);
                                    return lambda$onSectionDown$0;
                                }
                            }, 0);
                            return;
                        } else {
                            C5319ListView.this.removeHighlightRow();
                            return;
                        }
                    }
                    C5319ListView.this.removeHighlightRow();
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                TextCell textCell;
                if (i == 0) {
                    C5319ListView.this.chart = new C53201(C5319ListView.this.getContext(), DataUsage2Activity.colors.length, DataUsage2Activity.colors, 1, DataUsage2Activity.particles);
                    C5319ListView.this.chart.setInterceptTouch(false);
                    textCell = C5319ListView.this.chart;
                } else if (i == 1) {
                    C5319ListView c5319ListView = C5319ListView.this;
                    textCell = new SubtitleCell(DataUsage2Activity.this, c5319ListView.getContext());
                } else if (i == 3) {
                    textCell = new TextInfoPrivacyCell(C5319ListView.this.getContext());
                } else if (i == 4) {
                    View headerCell = new HeaderCell(C5319ListView.this.getContext());
                    headerCell.setBackgroundColor(C5319ListView.this.getThemedColor("windowBackgroundWhite"));
                    textCell = headerCell;
                } else if (i == 5) {
                    TextCell textCell2 = new TextCell(C5319ListView.this.getContext());
                    textCell2.setTextColor(C5319ListView.this.getThemedColor("windowBackgroundWhiteRedText5"));
                    textCell2.setBackgroundColor(C5319ListView.this.getThemedColor("windowBackgroundWhite"));
                    textCell = textCell2;
                } else if (i == 6) {
                    textCell = new RoundingCell(C5319ListView.this.getContext());
                } else if (i == 7) {
                    textCell = new View(C5319ListView.this.getContext()) { // from class: org.telegram.ui.DataUsage2Activity.ListView.Adapter.2
                        {
                            setBackgroundColor(C5319ListView.this.getThemedColor("windowBackgroundWhite"));
                        }
                    ...
                    C5319ListView c5319ListView2 = C5319ListView.this;
                    textCell = new Cell(DataUsage2Activity.this, c5319ListView2.getContext());
                }
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                int i2;
                int i3;
                ItemInner itemInner = (ItemInner) C5319ListView.this.itemInners.get(viewHolder.getAdapterPosition());
                int itemViewType = viewHolder.getItemViewType();
                boolean z = false;
                if (itemViewType == 0) {
                    CacheChart cacheChart = (CacheChart) viewHolder.itemView;
                    if (C5319ListView.this.segments != null) {
                        cacheChart.setSegments(C5319ListView.this.totalSize, C5319ListView.this.animateChart, C5319ListView.this.chartSegments);
                    }
                    C5319ListView.this.animateChart = false;
                    return;
                }
                Boolean bool = null;
                if (itemViewType == 1) {
                    ...
                    int i4 = i + 1;
                    if (i4 < C5319ListView.this.itemInners.size() && (i3 = ((ItemInner) C5319ListView.this.itemInners.get(i4)).viewType) != itemInner.viewType && i3 != 3 && i3 != 6) {
                        z = true;
                    }
                    if (z) {
                        subtitleCell.setBackground(Theme.getThemedDrawable(C5319ListView.this.getContext(), C3158R.C3160drawable.greydivider_top, "windowBackgroundGrayShadow"));
                    } else {
                    ...
                    int i5 = i + 1;
                    cell.set(itemInner.imageColor, itemInner.imageResId, itemInner.text, itemInner.valueText, i5 < getItemCount() && ((ItemInner) C5319ListView.this.itemInners.get(i5)).viewType == itemViewType);
                    if (!itemInner.pad && (i2 = itemInner.index) >= 0 && (i2 >= C5319ListView.this.segments.length || C5319ListView.this.segments[itemInner.index].size > 0)) {
                        bool = Boolean.valueOf(C5319ListView.this.collapsed[itemInner.index]);
                    }
                    cell.setArrow(bool);
                    ...
                    boolean z2 = i > 0 && itemInner.viewType != ((ItemInner) C5319ListView.this.itemInners.get(i + (-1))).viewType;
                    int i6 = i + 1;
                    if (i6 < C5319ListView.this.itemInners.size() && ((ItemInner) C5319ListView.this.itemInners.get(i6)).viewType != itemInner.viewType) {
                        z = true;
                    }
                    if (z2 && z) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(C5319ListView.this.getContext(), C3158R.C3160drawable.greydivider, "windowBackgroundGrayShadow"));
                    } else if (z2) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(C5319ListView.this.getContext(), C3158R.C3160drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                    } else if (z) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(C5319ListView.this.getContext(), C3158R.C3160drawable.greydivider_top, "windowBackgroundGrayShadow"));
                    } else {
            ...
            @Override // androidx.recyclerview.widget.RecyclerView.Adapter
            public int getItemCount() {
                return C5319ListView.this.itemInners.size();
            }

            @Override // androidx.recyclerview.widget.RecyclerView.Adapter
            public int getItemViewType(int i) {
                return ((ItemInner) C5319ListView.this.itemInners.get(i)).viewType;
            }
    ...
    public class Cell extends FrameLayout {
        ...
        public Cell(DataUsage2Activity dataUsage2Activity, Context context) {
            ...
            this.arrowView.setImageResource(C3158R.C3160drawable.arrow_more);
    ...
    public boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        return motionEvent.getY() <= ((float) (C3222ActionBar.getCurrentActionBarHeight() + AndroidUtilities.m50dp(48))) || this.pager.getCurrentPosition() == 0;
    }
}
