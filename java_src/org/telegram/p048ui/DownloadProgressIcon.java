...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C3301R.C3306raw.download_progress, "download_progress", AndroidUtilities.m50dp(28), AndroidUtilities.m50dp(28), true, null);
        ...
        RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C3301R.C3306raw.download_finish, "download_finish", AndroidUtilities.m50dp(28), AndroidUtilities.m50dp(28), true, null);
