...
public class LogoutActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("LogOutTitle", C3286R.string.LogOutTitle));
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setActionBarMenuOnItemClick(new C3351ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.LogoutActivity.1
    ...
    public static AlertDialog makeLogOutDialog(Context context, final int i) {
        ...
        builder.setMessage(LocaleController.getString("AreYouSureLogout", C3286R.string.AreYouSureLogout));
        int i2 = C3286R.string.LogOut;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == LogoutActivity.this.alternativeHeaderRow) {
                    headerCell.setText(LocaleController.getString("AlternativeOptions", C3286R.string.AlternativeOptions));
                }
                ...
                if (itemViewType == 3) {
                    ...
                    if (i == LogoutActivity.this.logoutRow) {
                        ...
                        textSettingsCell.setText(LocaleController.getString("LogOutTitle", C3286R.string.LogOutTitle), false);
                    }
                } else if (itemViewType != 4) {
                } else {
                    TextInfoPrivacyCell textInfoPrivacyCell = (TextInfoPrivacyCell) viewHolder.itemView;
                    if (i == LogoutActivity.this.logoutSectionRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString("LogOutInfo", C3286R.string.LogOutInfo));
                    }
                }
            } else {
                        ...
                        if (i != LogoutActivity.this.cacheRow) {
                            if (i != LogoutActivity.this.phoneRow) {
                                if (i == LogoutActivity.this.supportRow) {
                                    textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString("ContactSupport", C3286R.string.ContactSupport), LocaleController.getString("ContactSupportInfo", C3286R.string.ContactSupportInfo), C3286R.C3288drawable.msg_help, false);
                                    return;
                                }
                                return;
                            }
                            textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString("ChangePhoneNumber", C3286R.string.ChangePhoneNumber), LocaleController.getString("ChangePhoneNumberInfo", C3286R.string.ChangePhoneNumberInfo), C3286R.C3288drawable.msg_newphone, true);
                            return;
                        }
                        textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString("ClearCache", C3286R.string.ClearCache), LocaleController.getString("ClearCacheInfo", C3286R.string.ClearCacheInfo), C3286R.C3288drawable.msg_clearcache, true);
                        return;
                    }
                    textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString("SetPasscode", C3286R.string.SetPasscode), LocaleController.getString("SetPasscodeInfo", C3286R.string.SetPasscodeInfo), C3286R.C3288drawable.msg_permissions, true);
                    return;
                }
                textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString("AddAnotherAccount", C3286R.string.AddAnotherAccount), LocaleController.getString("AddAnotherAccountInfo", C3286R.string.AddAnotherAccountInfo), C3286R.C3288drawable.msg_contact_add, true);
            }
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                if (i == 2) {
                    ...
                    view.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C3286R.C3288drawable.greydivider, "windowBackgroundGrayShadow"));
                }
