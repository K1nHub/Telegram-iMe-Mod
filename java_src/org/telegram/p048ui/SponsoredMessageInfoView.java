...
public class SponsoredMessageInfoView extends FrameLayout {
    public SponsoredMessageInfoView(final Activity activity, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setText(LocaleController.getString("SponsoredMessageInfo", C3301R.string.SponsoredMessageInfo));
        textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText", resourcesProvider));
        textView.setTextSize(1, 20.0f);
        TextView textView2 = new TextView(activity);
        textView2.setText(LocaleController.getString("SponsoredMessageInfoDescription1", C3301R.string.SponsoredMessageInfoDescription1));
        ...
        textView3.setText(LocaleController.getString("SponsoredMessageInfoDescription2", C3301R.string.SponsoredMessageInfoDescription2));
        ...
        textView4.setText(LocaleController.getString("SponsoredMessageInfoDescription3", C3301R.string.SponsoredMessageInfoDescription3));
        ...
        textView5.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.SponsoredMessageInfoView.2
            ...
            public void onClick(View view) {
                Browser.openUrl(activity, LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", C3301R.string.SponsoredMessageAlertLearnMoreUrl));
            }
        });
        textView5.setPadding(AndroidUtilities.m50dp(12), 0, AndroidUtilities.m50dp(12), 0);
        textView5.setText(LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", C3301R.string.SponsoredMessageAlertLearnMoreUrl));
        ...
        textView6.setText(LocaleController.getString("SponsoredMessageInfoDescription4", C3301R.string.SponsoredMessageInfoDescription4));
