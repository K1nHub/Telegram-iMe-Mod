...
public class BottomSheet extends Dialog {
    ...
    public class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        public ContainerView(Context context) {
            ...
            this.f1648y = BitmapDescriptorFactory.HUE_RED;
        ...
        public boolean processTouchEvent(MotionEvent motionEvent, boolean z) {
            ...
            if (BottomSheet.this.canDismissWithTouchOutside() && motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.startedTracking && !this.maybeStartTracking && motionEvent.getPointerCount() == 1)) {
                ...
                BottomSheet.this.onScrollUpBegin(this.f1648y);
                ...
                boolean onScrollUp = BottomSheet.this.onScrollUp(this.f1648y + y2);
                ...
                if (!BottomSheet.this.disableScroll && this.maybeStartTracking && !this.startedTracking && y2 > BitmapDescriptorFactory.HUE_RED && y2 / 3.0f > Math.abs(abs) && Math.abs(y2) >= BottomSheet.this.touchSlop) {
                    ...
                    float f = this.f1648y + y2;
                    this.f1648y = f;
                    if (!onScrollUp) {
                        this.f1648y = Math.max(f, (float) BitmapDescriptorFactory.HUE_RED);
                    }
                    BottomSheet.this.containerView.setTranslationY(Math.max(this.f1648y, (float) BitmapDescriptorFactory.HUE_RED));
                    this.startedTrackingY = (int) motionEvent.getY();
                    BottomSheet.this.container.invalidate();
                }
                ...
                BottomSheet.this.onScrollUpEnd(this.f1648y);
                if (this.startedTracking || this.f1648y > BitmapDescriptorFactory.HUE_RED) {
        ...
        */
        protected void onMeasure(int r14, int r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.ActionBar.BottomSheet.ContainerView.onMeasure(int, int):void");
        }
        ...
        */
        protected void onLayout(boolean r17, int r18, int r19, int r20, int r21) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.ActionBar.BottomSheet.ContainerView.onLayout(boolean, int, int, int, int):void");
        }
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r12) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.ActionBar.BottomSheet.ContainerView.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        */
        protected void onDraw(android.graphics.Canvas r11) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.ActionBar.BottomSheet.ContainerView.onDraw(android.graphics.Canvas):void");
        }
    ...
    protected int getBottomSheetWidth(boolean z, int i, int i2) {
        return z ? i : (int) Math.max(i * 0.8f, Math.min(AndroidUtilities.m50dp((int) LiteMode.FLAGS_CHAT), i));
    }
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(i4), 1073741824));
        }
        ...
        public void setTextAndIcon(CharSequence charSequence, int i, Drawable drawable, boolean z) {
            ...
            if (i != 0 || drawable != null) {
                ...
                if (z) {
                    this.textView.setPadding(AndroidUtilities.m50dp(LocaleController.isRTL ? 21 : 72), 0, AndroidUtilities.m50dp(LocaleController.isRTL ? 72 : 21), 0);
                    this.imageView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m50dp(5), 0, LocaleController.isRTL ? AndroidUtilities.m50dp(5) : 5, 0);
                    return;
                }
                this.textView.setPadding(AndroidUtilities.m50dp(LocaleController.isRTL ? 16 : 72), 0, AndroidUtilities.m50dp(LocaleController.isRTL ? 72 : 16), 0);
                this.imageView.setPadding(0, 0, 0, 0);
                return;
            }
            this.imageView.setVisibility(4);
            this.textView.setPadding(AndroidUtilities.m50dp(z ? 21 : 16), 0, AndroidUtilities.m50dp(z ? 21 : 16), 0);
        }
    ...
    public BottomSheet(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        ContainerView containerView = new ContainerView(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.2
            @Override // org.telegram.p048ui.ActionBar.BottomSheet.ContainerView, android.view.ViewGroup
            ...
            @Override // org.telegram.p048ui.ActionBar.BottomSheet.ContainerView, android.view.ViewGroup, android.view.View
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.containerView == null) {
            ...
            this.containerView.setPadding(this.backgroundPaddingLeft, ((this.applyTopPadding ? AndroidUtilities.m50dp(8) : 0) + this.backgroundPaddingTop) - 1, this.backgroundPaddingLeft, this.applyBottomPadding ? AndroidUtilities.m50dp(8) : 0);
        }
        ...
        if (this.title != null) {
                        ...
                        if (BottomSheet.this.customView != null) {
                            ...
                            for (int i4 = 1; i4 < BottomSheet.this.containerView.getChildCount(); i4++) {
                                ...
                                if (childAt instanceof BottomSheetCell) {
                                    ...
                                    measuredHeight += AndroidUtilities.m50dp(48);
                                }
                            }
                        }
                    }
            ...
            if (this.bigTitle) {
                ...
                this.titleView.setPadding(AndroidUtilities.m50dp(21), AndroidUtilities.m50dp(this.multipleLinesTitle ? 14 : 6), AndroidUtilities.m50dp(21), AndroidUtilities.m50dp(8));
            } else {
                this.titleView.setTextColor(getThemedColor("dialogTextGray2"));
                this.titleView.setTextSize(1, 16.0f);
                this.titleView.setPadding(AndroidUtilities.m50dp(16), AndroidUtilities.m50dp(this.multipleLinesTitle ? 8 : 0), AndroidUtilities.m50dp(16), AndroidUtilities.m50dp(8));
            }
        ...
        if (this.description != null) {
            ...
            this.descriptionView.setTextColor(getThemedColor("dialogTextGray3"));
            ...
            this.descriptionView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.x - AndroidUtilities.m50dp(42), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(0, 0));
            this.descriptionView.setPadding(AndroidUtilities.m50dp(21), AndroidUtilities.m50dp(44), AndroidUtilities.m50dp(21), AndroidUtilities.m50dp(8));
            this.containerView.addView(this.descriptionView, LayoutHelper.createFrame(-1, -2));
            i += AndroidUtilities.m49px(this.descriptionView.getMeasuredHeight()) + 8;
        }
        int i2 = i;
        ...
        if (view != null) {
            ...
            if (!this.useBackgroundTopPadding) {
                ...
                this.containerView.addView(this.customView, LayoutHelper.createFrame(-1, -2, this.customViewGravity, 0, (-this.backgroundPaddingTop) + i2, 0, 0));
            } else {
                this.containerView.addView(this.customView, LayoutHelper.createFrame(-1, -2, this.customViewGravity, 0, i2, 0, 0));
            }
            ...
            while (true) {
                ...
                if (charSequenceArr[i3] != null) {
                    ...
                    if (zArr != null) {
                        bottomSheetCell.setNeedDivider(zArr[i3]);
                    }
                    CharSequence charSequence = this.items[i3];
                    int[] iArr = this.itemIcons;
                    bottomSheetCell.setTextAndIcon(charSequence, iArr != null ? iArr[i3] : 0, null, this.bigTitle);
                    this.containerView.addView(bottomSheetCell, LayoutHelper.createFrame(-1, 48, 51, 0, i2, 0, 0));
                    i2 += 48;
    ...
    public void startOpenAnimation() {
        ...
        this.containerView.setTranslationY(getContainerViewHeight() + this.container.keyboardHeight + AndroidUtilities.m50dp(10) + (this.scrollNavBar ? getBottomInset() : 0));
        ...
        animatorArr[0] = ObjectAnimator.ofFloat(this.containerView, View.TRANSLATION_Y, BitmapDescriptorFactory.HUE_RED);
    ...
    public void dismissWithButtonClick(int i) {
        ...
        this.currentSheetAnimation.addListener(new C32867(i));
        NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.stopAllHeavyOperations, 512);
        this.currentSheetAnimation.start();
    }
    ...
    /* loaded from: classes5.dex */
    public class C32867 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ActionBar.BottomSheet$7$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        BottomSheet.C32867.this.lambda$onAnimationEnd$0();
                    }
                });
            }
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.startAllHeavyOperations, 512);
    ...
    public void dismiss() {
        ...
        if ((bottomSheetDelegateInterface == null || bottomSheetDelegateInterface.canDismiss()) && !this.dismissed) {
            ...
            if (this.allowCustomAnimation && onCustomCloseAnimation()) {
                ...
                this.currentSheetAnimation.setInterpolator(CubicBezierInterpolator.EASE_OUT);
                this.currentSheetAnimation.addListener(new C32878());
                NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.stopAllHeavyOperations, 512);
                this.currentSheetAnimation.start();
            }
    ...
    /* loaded from: classes5.dex */
    public class C32878 extends AnimatorListenerAdapter {
        C32878() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ActionBar.BottomSheet$8$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        BottomSheet.C32878.this.lambda$onAnimationEnd$0();
                    }
                });
            }
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.startAllHeavyOperations, 512);
