...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    public DrawerLayoutContainer(Context context) {
        ...
        this.shadowLeft = getResources().getDrawable(C3316R.C3318drawable.menu_shadow);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.drawCurrentPreviewFragmentAbove && (iNavigationLayout = this.parentActionBarLayout) != null && !iNavigationLayout.isPreviewOpenAnimationInProgress()) {
            ...
            if (previewMenu != null && lastFragment != null) {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.ActionBar.DrawerLayoutContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public static class PreviewForegroundDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            int i = bounds.left;
            int i2 = bounds.top;
            canvas.clipRect(i, i2, bounds.right, C3381ActionBar.getCurrentActionBarHeight() + i2);
            this.topDrawable.draw(canvas);
            canvas.restore();
            canvas.save();
            canvas.clipRect(bounds.left, bounds.top + C3381ActionBar.getCurrentActionBarHeight(), bounds.right, bounds.bottom);
