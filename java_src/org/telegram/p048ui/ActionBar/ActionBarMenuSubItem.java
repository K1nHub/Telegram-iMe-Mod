...
public class ActionBarMenuSubItem extends FrameLayout {
    ...
    public ActionBarMenuSubItem(Context context, int i, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider, int i2) {
        ...
        updateBackground();
        setPadding(AndroidUtilities.m50dp(18), 0, AndroidUtilities.m50dp(18), 0);
        ...
        if (i > 0) {
            ...
            this.textView.setPadding(LocaleController.isRTL ? AndroidUtilities.m50dp(34) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m50dp(34), 0);
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(this.itemHeight), 1073741824));
    }
    ...
    public void setRightIcon(int i) {
        ...
        setPadding(AndroidUtilities.m50dp(LocaleController.isRTL ? 8 : 18), 0, AndroidUtilities.m50dp(LocaleController.isRTL ? 18 : 8), 0);
    ...
    public void setSubtext(String str) {
        if (this.subtextView == null) {
            ...
            this.subtextView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m50dp(43), 0, LocaleController.isRTL ? AndroidUtilities.m50dp(43) : 0, 0);
        ...
        if (z != (this.subtextView.getVisibility() == 0)) {
            ...
            layoutParams.bottomMargin = z ? AndroidUtilities.m50dp(10) : 0;
