...
public final class FloatingToolbar {
    ...
    public final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View view) {
            ...
            Drawable mutate = context.getDrawable(C3316R.C3318drawable.ft_avd_tooverflow).mutate();
            this.mArrow = mutate;
            mutate.setAutoMirrored(true);
            Drawable mutate2 = context.getDrawable(C3316R.C3318drawable.ft_avd_toarrow).mutate();
            this.mOverflow = mutate2;
            mutate2.setAutoMirrored(true);
            AnimatedVectorDrawable animatedVectorDrawable = (AnimatedVectorDrawable) context.getDrawable(C3316R.C3318drawable.ft_avd_toarrow_animation).mutate();
            this.mToArrow = animatedVectorDrawable;
            animatedVectorDrawable.setAutoMirrored(true);
            AnimatedVectorDrawable animatedVectorDrawable2 = (AnimatedVectorDrawable) context.getDrawable(C3316R.C3318drawable.ft_avd_tooverflow_animation).mutate();
            ...
            this.mDismissAnimation = FloatingToolbar.createExitAnimation(createContentContainer, ImageReceiver.DEFAULT_CROSSFADE_DURATION, new C34623(FloatingToolbar.this));
            this.mHideAnimation = FloatingToolbar.createExitAnimation(createContentContainer, 0, new C34634(FloatingToolbar.this));
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: org.telegram.ui.ActionBar.FloatingToolbar$FloatingToolbarPopup$3 */
        /* loaded from: classes5.dex */
        public class C34623 extends AnimatorListenerAdapter {
            C34623(FloatingToolbar floatingToolbar) {
            }
            ...
            public void onAnimationEnd(Animator animator) {
                NotificationCenter.getInstance(UserConfig.selectedAccount).doOnIdle(new Runnable() { // from class: org.telegram.ui.ActionBar.FloatingToolbar$FloatingToolbarPopup$3$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        FloatingToolbar.FloatingToolbarPopup.C34623.this.lambda$onAnimationEnd$0();
                    }
                });
            }
        ...
        /* loaded from: classes5.dex */
        public class C34634 extends AnimatorListenerAdapter {
            C34634(FloatingToolbar floatingToolbar) {
            }
            ...
            public void onAnimationEnd(Animator animator) {
                NotificationCenter.getInstance(UserConfig.selectedAccount).doOnIdle(new Runnable() { // from class: org.telegram.ui.ActionBar.FloatingToolbar$FloatingToolbarPopup$4$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        FloatingToolbar.FloatingToolbarPopup.C34634.this.lambda$onAnimationEnd$0();
                    }
                });
            }
        ...
        public void setPanelsStatesAtRestingPosition() {
            ...
            if (this.mIsOverflowOpen) {
                ...
                this.mOverflowButton.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3316R.string.AccDescrMoreOptions));
                if (isInRTLMode()) {
        ...
        /* loaded from: classes5.dex */
        public class animationAnimation$AnimationListenerC346013 implements Animation.AnimationListener {
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationRepeat(Animation animation) {
            }

            animationAnimation$AnimationListenerC346013() {
            }
            ...
            public void onAnimationEnd(Animation animation) {
                FloatingToolbarPopup.this.mContentContainer.post(new Runnable() { // from class: org.telegram.ui.ActionBar.FloatingToolbar$FloatingToolbarPopup$13$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        FloatingToolbar.FloatingToolbarPopup.animationAnimation$AnimationListenerC346013.this.lambda$onAnimationEnd$0();
                    }
                });
            }
        ...
        private Animation.AnimationListener createOverflowAnimationListener() {
            return new animationAnimation$AnimationListenerC346013();
        }
