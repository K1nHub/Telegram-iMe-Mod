...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("EncryptionKey", C3158R.string.EncryptionKey));
        this.actionBar.setActionBarMenuOnItemClick(new C3222ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.IdenticonActivity.1
        ...
        frameLayout3.setPadding(AndroidUtilities.m50dp(20), AndroidUtilities.m50dp(20), AndroidUtilities.m50dp(20), AndroidUtilities.m50dp(20));
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.telegram.ui.IdenticonActivity.2
            ...
            protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (IdenticonActivity.this.codeTextView != null) {
                    ...
                    int measuredHeight = (((IdenticonActivity.this.codeTextView.getMeasuredHeight() - IdenticonActivity.this.emojiTextView.getMeasuredHeight()) / 2) + IdenticonActivity.this.linearLayout1.getTop()) - AndroidUtilities.m50dp(16);
        ...
        this.linearLayout1.setPadding(AndroidUtilities.m50dp(10), 0, AndroidUtilities.m50dp(10), 0);
        ...
        if (encryptedChat != null) {
            ...
            int i6 = C3158R.string.EncryptionKeyDescription;
            ...
            if (indexOf != -1) {
                spannableStringBuilder.setSpan(new URLSpanReplacement(LocaleController.getString("EncryptionKeyLink", C3158R.string.EncryptionKeyLink)), indexOf, indexOf + 12, 33);
            }
    ...
    public void onTransitionAnimationEnd(boolean z, boolean z2) {
        ...
        TextView textView = this.emojiTextView;
        textView.setText(Emoji.replaceEmoji(str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m50dp(32), false));
    }
