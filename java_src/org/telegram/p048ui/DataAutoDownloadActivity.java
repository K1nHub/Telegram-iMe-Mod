...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnMobileData", C3316R.string.AutoDownloadOnMobileData));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnWiFiData", C3316R.string.AutoDownloadOnWiFiData));
        } else if (i == 2) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnRoamingData", C3316R.string.AutoDownloadOnRoamingData));
        }
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.DataAutoDownloadActivity.1
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == DataAutoDownloadActivity.this.autoDownloadRow) {
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getString("AutoDownloadMedia", C3316R.string.AutoDownloadMedia), DataAutoDownloadActivity.this.typePreset.enabled, false);
                ...
                if (i != DataAutoDownloadActivity.this.usageHeaderRow) {
                    if (i == DataAutoDownloadActivity.this.typeHeaderRow) {
                        headerCell.setText(LocaleController.getString("AutoDownloadTypes", C3316R.string.AutoDownloadTypes));
                        return;
                    }
                    return;
                }
                headerCell.setText(LocaleController.getString("AutoDownloadDataUsage", C3316R.string.AutoDownloadDataUsage));
                            ...
                            if (DataAutoDownloadActivity.this.currentType != 0) {
                                if (DataAutoDownloadActivity.this.currentType != 1) {
                                    if (DataAutoDownloadActivity.this.currentType == 2) {
                                        textInfoPrivacyCell.setText(LocaleController.getString("AutoDownloadOnRoamingDataInfo", C3316R.string.AutoDownloadOnRoamingDataInfo));
                                    }
                                } else {
                                    textInfoPrivacyCell.setText(LocaleController.getString("AutoDownloadOnWiFiDataInfo", C3316R.string.AutoDownloadOnWiFiDataInfo));
                                }
                            } else {
                                textInfoPrivacyCell.setText(LocaleController.getString("AutoDownloadOnMobileDataInfo", C3316R.string.AutoDownloadOnMobileDataInfo));
                            }
                ...
                textInfoPrivacyCell.setText(LocaleController.getString("AutoDownloadAudioInfo", C3316R.string.AutoDownloadAudioInfo));
                textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C3316R.C3318drawable.greydivider, "windowBackgroundGrayShadow"));
                ...
                if (i != DataAutoDownloadActivity.this.photosRow) {
                    if (i == DataAutoDownloadActivity.this.videosRow) {
                        string = LocaleController.getString("AutoDownloadVideos", C3316R.string.AutoDownloadVideos);
                        i2 = 4;
                    } else {
                        i2 = 8;
                        string = LocaleController.getString("AutoDownloadFiles", C3316R.string.AutoDownloadFiles);
                    }
                } else {
                    string = LocaleController.getString("AutoDownloadPhotos", C3316R.string.AutoDownloadPhotos);
                    i2 = 1;
                }
                ...
                while (true) {
                    ...
                    if ((iArr[i3] & i2) != 0) {
                        ...
                        if (i3 == 0) {
                            sb2.append(LocaleController.getString("AutoDownloadContacts", C3316R.string.AutoDownloadContacts));
                        } else if (i3 == 1) {
                            sb2.append(LocaleController.getString("AutoDownloadPm", C3316R.string.AutoDownloadPm));
                        } else if (i3 == 2) {
                            sb2.append(LocaleController.getString("AutoDownloadGroups", C3316R.string.AutoDownloadGroups));
                        } else if (i3 == 3) {
                            sb2.append(LocaleController.getString("AutoDownloadChannels", C3316R.string.AutoDownloadChannels));
                        }
                        i4++;
                    }
                    i3++;
                ...
                if (i4 == 4) {
                    sb2.setLength(0);
                    if (i == DataAutoDownloadActivity.this.photosRow) {
                        sb2.append(LocaleController.getString("AutoDownloadOnAllChats", C3316R.string.AutoDownloadOnAllChats));
                    } else {
                        sb2.append(LocaleController.formatString("AutoDownloadUpToOnAllChats", C3316R.string.AutoDownloadUpToOnAllChats, AndroidUtilities.formatFileSize(j)));
                    }
                } else if (i4 != 0) {
                    if (i == DataAutoDownloadActivity.this.photosRow) {
                        sb = new StringBuilder(LocaleController.formatString("AutoDownloadOnFor", C3316R.string.AutoDownloadOnFor, sb2.toString()));
                    } else {
                        sb = new StringBuilder(LocaleController.formatString("AutoDownloadOnUpToFor", C3316R.string.AutoDownloadOnUpToFor, AndroidUtilities.formatFileSize(j), sb2.toString()));
                    }
                    sb2 = sb;
                } else {
                    sb2.append(LocaleController.getString("AutoDownloadOff", C3316R.string.AutoDownloadOff));
                }
    ...
    public void updatePresetChoseView(SlideChooseView slideChooseView) {
        ...
        for (int i = 0; i < this.presets.size(); i++) {
            ...
            if (preset == this.lowPreset) {
                strArr[i] = LocaleController.getString("AutoDownloadLow", C3316R.string.AutoDownloadLow);
            } else if (preset == this.mediumPreset) {
                strArr[i] = LocaleController.getString("AutoDownloadMedium", C3316R.string.AutoDownloadMedium);
            } else if (preset == this.highPreset) {
                strArr[i] = LocaleController.getString("AutoDownloadHigh", C3316R.string.AutoDownloadHigh);
            } else {
                strArr[i] = LocaleController.getString("AutoDownloadCustom", C3316R.string.AutoDownloadCustom);
            }
        }
