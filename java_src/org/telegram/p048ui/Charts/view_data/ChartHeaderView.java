...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3158R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3158R.C3160drawable.msg_zoomout_stats);
