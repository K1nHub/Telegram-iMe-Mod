...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3301R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3301R.C3303drawable.msg_zoomout_stats);
