...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3316R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3316R.C3318drawable.msg_zoomout_stats);
