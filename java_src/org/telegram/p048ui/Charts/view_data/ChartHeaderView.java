...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3286R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3286R.C3288drawable.msg_zoomout_stats);
