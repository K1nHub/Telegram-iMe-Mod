...
import org.telegram.p048ui.Charts.ChartPickerDelegate;
import org.telegram.p048ui.Charts.data.ChartData;
import org.telegram.p048ui.Charts.view_data.ChartBottomSignatureData;
import org.telegram.p048ui.Charts.view_data.ChartHeaderView;
import org.telegram.p048ui.Charts.view_data.ChartHorizontalLinesData;
import org.telegram.p048ui.Charts.view_data.LegendSignatureView;
import org.telegram.p048ui.Charts.view_data.LineViewData;
import org.telegram.p048ui.Charts.view_data.TransitionParams;
import org.telegram.p048ui.Components.CubicBezierInterpolator;
/* renamed from: org.telegram.ui.Charts.BaseChartView */
...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    public static final int SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m51dp(18.0f);
    private static final int BOTTOM_SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m51dp(14.0f);
    public static final int BOTTOM_SIGNATURE_START_ALPHA = AndroidUtilities.m51dp(10.0f);
    protected static final int PICKER_PADDING = AndroidUtilities.m51dp(16.0f);
    private static final int PICKER_CAPTURE_WIDTH = AndroidUtilities.m50dp(24);
    private static final int LANDSCAPE_END_PADDING = AndroidUtilities.m50dp(16);
    private static final int BOTTOM_SIGNATURE_OFFSET = AndroidUtilities.m50dp(10);
    private static final int DP_12 = AndroidUtilities.m50dp(12);
    private static final int DP_6 = AndroidUtilities.m50dp(6);
    private static final int DP_5 = AndroidUtilities.m50dp(5);
    private static final int DP_2 = AndroidUtilities.m50dp(2);
    private static final int DP_1 = AndroidUtilities.m50dp(1);

    /* renamed from: org.telegram.ui.Charts.BaseChartView$DateSelectionListener */
    /* loaded from: classes5.dex */
    ...
    public BaseChartView(Context context) {
        ...
        this.pikerHeight = AndroidUtilities.m50dp(46);
    ...
    public void updateColors() {
        ...
        if (this.legendShowing) {
            ...
            long[] jArr = this.chartData.f1671x;
            if (i < jArr.length) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.landscape) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.displaySize.y - AndroidUtilities.m50dp(56));
        }
    ...
    private void measureSizes() {
        ...
        if (this.chartData != null) {
            this.bottomSignatureOffset = (int) (AndroidUtilities.m50dp(20) / (this.pickerWidth / this.chartData.f1671x.length));
        }
    ...
    public void drawBottomSignature(Canvas canvas) {
        ...
        while (true) {
            ...
            while (true) {
                if (i6 % i4 == 0 && i6 >= this.chartData.f1671x.length - 1) {
                    break;
                }
                i6++;
                c = 0;
                    ...
                    if (i8 < jArr.length - 1) {
                        ...
                        if (f4 > BitmapDescriptorFactory.HUE_RED) {
                            ...
                            if (f4 <= f5 + f6) {
                                ...
                                canvas.drawText(this.chartData.getDayString(i8), f3, (getMeasuredHeight() - this.chartBottom) + BOTTOM_SIGNATURE_TEXT_HEIGHT + AndroidUtilities.m50dp(3), this.bottomSignaturePaint);
                                i8 += i4;
                                c = 0;
                            }
                        }
    ...
    public void drawBottomLine(Canvas canvas) {
        ...
        canvas.drawText(SessionDescription.SUPPORTED_SDP_VERSION, HORIZONTAL_PADDING, measuredHeight - textSize, this.signaturePaint);
    }
    ...
    public void drawSelection(Canvas canvas) {
        ...
        while (true) {
            ...
            if (l.enabled || l.alpha != BitmapDescriptorFactory.HUE_RED) {
                ...
                float measuredHeight = (getMeasuredHeight() - this.chartBottom) - (((l.line.f1673y[this.selectedIndex] - f7) / (this.currentMaxHeight - f7)) * ((getMeasuredHeight() - this.chartBottom) - SIGNATURE_TEXT_HEIGHT));
    ...
    */
    public void drawHorizontalLines(android.graphics.Canvas r12, org.telegram.p048ui.Charts.view_data.ChartHorizontalLinesData r13) {
        /*
            r11 = this;
            int[] r0 = r13.values
            int r1 = r0.length
        ...
        L3f:
            ...
            int r0 = r0 - r2
            int r2 = org.telegram.p048ui.Charts.BaseChartView.SIGNATURE_TEXT_HEIGHT
            int r0 = r0 - r2
        ...
        L9d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Charts.BaseChartView.drawHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void drawSignaturesToHorizontalLines(android.graphics.Canvas r11, org.telegram.p048ui.Charts.view_data.ChartHorizontalLinesData r12) {
        /*
            r10 = this;
            int[] r0 = r12.values
            int r1 = r0.length
        ...
        L7b:
            ...
            r5 = r5[r3]
            float r6 = org.telegram.p048ui.Charts.BaseChartView.HORIZONTAL_PADDING
            int r4 = r4 - r2
            float r4 = (float) r4
        ...
        La6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Charts.BaseChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    */
    public void drawPicker(android.graphics.Canvas r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.Charts.BaseChartView.drawPicker(android.graphics.Canvas):void");
    }
    ...
    protected void setMaxMinValue(int i, int i2, boolean z, boolean z2, boolean z3) {
        if ((Math.abs(((float) ChartHorizontalLinesData.lookupHeight(i)) - this.animateToMaxHeight) >= this.thresholdMaxHeight && i != 0) || i != this.animateToMinHeight) {
            ...
            if (currentTimeMillis - this.lastTime >= 320 || z2) {
                ...
                ValueAnimator createAnimator = createAnimator(BitmapDescriptorFactory.HUE_RED, 255.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.BaseChartView$$ExternalSyntheticLambda3
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        if (f3 < BitmapDescriptorFactory.HUE_RED) {
            ...
            this.selectedIndex = t.f1671x.length - 1;
        } else {
    ...
    public void moveLegend(float f) {
        ...
        this.legendSignatureView.setData(i, t.f1671x[i], this.lines, false);
            ...
            if (t != null) {
                if (t.f1671x[0] == 0) {
                    ...
                    if (f - chartPickerDelegate2.pickerStart < f2) {
                        ...
                        if (f3 < BitmapDescriptorFactory.HUE_RED) {
                            chartPickerDelegate2.pickerStart = BitmapDescriptorFactory.HUE_RED;
    ...
    @Override // org.telegram.p048ui.Charts.ChartPickerDelegate.Listener
    ...
    public void onPickerJumpTo(float f, float f2, boolean z) {
        ...
        if (z) {
            int findStartIndex = t.findStartIndex(Math.max(f, (float) BitmapDescriptorFactory.HUE_RED));
    ...
    public void updateIndexes() {
        ...
        int findStartIndex = t.findStartIndex(Math.max(this.pickerDelegate.pickerStart, (float) BitmapDescriptorFactory.HUE_RED));
    ...
    private void updateDates(int i) {
        ...
        if (chartBottomSignatureData == null || i >= chartBottomSignatureData.stepMax || i <= chartBottomSignatureData.stepMin) {
            ...
            if (chartBottomSignatureData2 == null || chartBottomSignatureData2.step != highestOneBit) {
                ...
                ValueAnimator duration = createAnimator(BitmapDescriptorFactory.HUE_RED, 1.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.BaseChartView$$ExternalSyntheticLambda2
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
    ...
    public void onCheckChanged() {
        ...
        while (true) {
            ...
            if (!l.enabled && l.alpha != BitmapDescriptorFactory.HUE_RED && ((valueAnimator = l.animatorOut) == null || !valueAnimator.isRunning())) {
                ValueAnimator createAnimator2 = createAnimator(l.alpha, BitmapDescriptorFactory.HUE_RED, new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.BaseChartView$$ExternalSyntheticLambda5
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator5) {
        ...
        if (this.legendShowing) {
            ...
            int i3 = this.selectedIndex;
            legendSignatureView.setData(i3, this.chartData.f1671x[i3], this.lines, true);
        }
    }
    ...
    public long getSelectedDate() {
        ...
        return this.chartData.f1671x[i];
    }
    ...
    public void selectDate(long j) {
        this.selectedIndex = Arrays.binarySearch(this.chartData.f1671x, j);
        this.legendShowing = true;
        this.legendSignatureView.setVisibility(0);
    ...
    public long getStartDate() {
        return this.chartData.f1671x[this.startXIndex];
    }

    public long getEndDate() {
        return this.chartData.f1671x[this.endXIndex];
    }

    public void updatePicker(ChartData chartData, long j) {
        int length = chartData.f1671x.length;
        long j2 = j - (j % 86400000);
        long j3 = (86400000 + j2) - 1;
        int i = 0;
        int i2 = 0;
        for (int i3 = 0; i3 < length; i3++) {
            long[] jArr = chartData.f1671x;
            if (j2 > jArr[i3]) {
                i = i3;
            }
            if (j3 > jArr[i3]) {
    ...
    /* renamed from: org.telegram.ui.Charts.BaseChartView$SharedUiComponents */
    /* loaded from: classes5.dex */
    public static class SharedUiComponents {
        ...
        Bitmap getPickerMaskBitmap(int i, int i2) {
            int i3 = (i + i2) << 10;
            if (i3 != this.f1669k || this.invalidate) {
                ...
                this.canvas.drawRoundRect(this.rectF, AndroidUtilities.m50dp(4), AndroidUtilities.m50dp(4), this.xRefP);
            }
