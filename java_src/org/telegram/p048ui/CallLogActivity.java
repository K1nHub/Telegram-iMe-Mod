...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class EmptyTextProgressView extends FrameLayout {
        ...
        public EmptyTextProgressView(Context context, View view) {
            ...
            rLottieImageView.setAnimation(C3158R.C3164raw.utyan_call, 120, 120);
            ...
            this.emptyTextView1.setText(LocaleController.getString("NoRecentCalls", C3158R.string.NoRecentCalls));
            ...
            String string = LocaleController.getString("NoRecentCallsInfo", C3158R.string.NoRecentCallsInfo);
        ...
        if (i == NotificationCenter.didReceiveNewMessages) {
                ...
                while (it.hasNext()) {
                    ...
                    if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionPhoneCall) {
                        ...
                        if (this.calls.size() > 0) {
                            ...
                            if (callLogRow.user.f1633id == j && callLogRow.type == i3) {
            ...
            if (this.firstLoaded && !((Boolean) objArr[2]).booleanValue()) {
                ...
                while (it2.hasNext()) {
                    ...
                    while (it3.hasNext()) {
                        if (arrayList2.contains(Integer.valueOf(it3.next().f1518id))) {
                            it3.remove();
                            r3 = 1;
                        }
                    }
            ...
            if (l2 == null || ((TLRPC$ChatFull) objArr[0]).f1495id != l2.longValue() || getMessagesController().getGroupCall(this.waitingForCallChatId.longValue(), true) == null) {
                return;
            }
    ...
    public class CallCell extends FrameLayout {
        ...
        public CallCell(Context context) {
            ...
            this.imageView.setContentDescription(LocaleController.getString("Call", C3158R.string.Call));
        ...
        public /* synthetic */ void lambda$new$0(View view) {
            ...
            TLRPC$UserFull userFull = CallLogActivity.this.getMessagesController().getUserFull(callLogRow.user.f1633id);
    ...
    public class GroupCallCell extends FrameLayout {
        ...
        public GroupCallCell(Context context) {
            super(context);
            setBackgroundColor(Theme.getColor("windowBackgroundWhite"));
            String string = LocaleController.getString("VoipChatJoin", C3158R.string.VoipChatJoin);
    ...
    public View createView(Context context) {
        Drawable mutate = getParentActivity().getResources().getDrawable(C3158R.C3160drawable.ic_call_made_green_18dp).mutate();
        ...
        int i = C3158R.C3160drawable.ic_call_received_green_18dp;
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3222ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.CallLogActivity.1
        ...
        ActionBarMenuItem addItem = this.actionBar.createMenu().addItem(10, C3158R.C3160drawable.ic_ab_other);
        ...
        this.otherItem.addSubItem(1, C3158R.C3160drawable.msg_delete, LocaleController.getString("DeleteAllCalls", C3158R.string.DeleteAllCalls));
        ...
        this.listView.setOnScrollListener(new C34512());
        if (this.loading) {
        ...
        if (i2 < 21) {
            Drawable mutate4 = context.getResources().getDrawable(C3158R.C3160drawable.floating_shadow).mutate();
        ...
        this.floatingButton.setImageResource(C3158R.C3160drawable.ic_call);
        this.floatingButton.setContentDescription(LocaleController.getString("Call", C3158R.string.Call));
        if (i2 >= 21) {
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i) {
        if (!(view instanceof CallCell)) {
            if (view instanceof GroupCallCell) {
                ...
                bundle.putLong("chat_id", ((GroupCallCell) view).currentChat.f1494id);
        ...
        bundle2.putLong("user_id", callLogRow.user.f1633id);
        bundle2.putInt("message_id", callLogRow.calls.get(0).f1518id);
        getNotificationCenter().postNotificationName(NotificationCenter.closeChats, new Object[0]);
    ...
    /* loaded from: classes5.dex */
    public class C34512 extends RecyclerView.OnScrollListener {
        C34512() {
        }
        ...
        */
        public void onScrolled(androidx.recyclerview.widget.RecyclerView r5, int r6, int r7) {
            ...
            Ld1:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.CallLogActivity.C34512.onScrolled(androidx.recyclerview.widget.RecyclerView, int, int):void");
        }
        ...
        public /* synthetic */ void lambda$onScrolled$0(CallLogRow callLogRow) {
            ...
            callLogActivity.getCalls(arrayList.get(arrayList.size() - 1).f1518id, 100);
        }
    }
    ...
    public /* synthetic */ void lambda$createView$2(TLRPC$User tLRPC$User, String str, ContactsActivity contactsActivity) {
        TLRPC$UserFull userFull = getMessagesController().getUserFull(tLRPC$User.f1633id);
    ...
    public void showDeleteAlert(final boolean z) {
        ...
        if (z) {
            builder.setTitle(LocaleController.getString("DeleteAllCalls", C3158R.string.DeleteAllCalls));
            builder.setMessage(LocaleController.getString("DeleteAllCallsText", C3158R.string.DeleteAllCallsText));
        } else {
            builder.setTitle(LocaleController.getString("DeleteCalls", C3158R.string.DeleteCalls));
            builder.setMessage(LocaleController.getString("DeleteSelectedCallsText", C3158R.string.DeleteSelectedCallsText));
        }
        final boolean[] zArr = {false};
        FrameLayout frameLayout = new FrameLayout(getParentActivity());
        CheckBoxCell checkBoxCell = new CheckBoxCell(getParentActivity(), 1);
        checkBoxCell.setBackgroundDrawable(Theme.getSelectorDrawable(false));
        checkBoxCell.setText(LocaleController.getString("DeleteCallsForEveryone", C3158R.string.DeleteCallsForEveryone), "", false, false);
        ...
        builder.setPositiveButton(LocaleController.getString("Delete", C3158R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda0
    ...
    public boolean isSelected(ArrayList<TLRPC$Message> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.selectedIds.contains(Integer.valueOf(arrayList.get(i).f1518id))) {
                return true;
            }
        }
        return false;
    ...
    private void createActionMode() {
        ...
        this.actionModeViews.add(createActionMode.addItemWithWidth(2, C3158R.C3160drawable.msg_delete, AndroidUtilities.m50dp(54), LocaleController.getString("Delete", C3158R.string.Delete)));
    }
    ...
    private boolean addOrRemoveSelectedDialog(ArrayList<TLRPC$Message> arrayList, CallCell callCell) {
        ...
        if (isSelected(arrayList)) {
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
                this.selectedIds.remove(Integer.valueOf(arrayList.get(i).f1518id));
            }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            Integer valueOf = Integer.valueOf(arrayList.get(i2).f1518id);
    ...
    private void showOrUpdateActionMode() {
        ...
        if (this.actionBar.isActionModeShowed()) {
            ...
            for (int i = 0; i < this.actionModeViews.size(); i++) {
                ...
                view.setPivotY(C3222ActionBar.getCurrentActionBarHeight() / 2);
        ...
        if (tLRPC$TL_error == null) {
            ...
            for (int i2 = 0; i2 < tLRPC$messages_Messages.messages.size(); i2++) {
                ...
                if (tLRPC$MessageAction != null && !(tLRPC$MessageAction instanceof TLRPC$TL_messageActionHistoryClear)) {
                    ...
                    if (callLogRow == null || callLogRow.user.f1633id != fromChatId || callLogRow.type != i3) {
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        ...
        if (i == 101 || i == 102 || i == 103) {
            ...
            if (iArr.length <= 0 || !z) {
                ...
                TLRPC$UserFull userFull = this.lastCallUser != null ? getMessagesController().getUserFull(this.lastCallUser.f1633id) : null;
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                if (i == 1) {
                    ...
                    callCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C3158R.C3160drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                } else if (i == 3) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                callCell.imageView.setImageResource(callLogRow.video ? C3158R.C3160drawable.profile_video : C3158R.C3160drawable.profile_phone);
                ...
                if (i == this.activeHeaderRow) {
                    headerCell.setText(LocaleController.getString("VoipChatActiveChats", C3158R.string.VoipChatActiveChats));
                } else if (i == this.callsHeaderRow) {
                    headerCell.setText(LocaleController.getString("VoipChatRecentCalls", C3158R.string.VoipChatRecentCalls));
                }
                ...
                groupCallCell.button.setTag(Long.valueOf(chat.f1494id));
                if (ChatObject.isChannel(chat) && !chat.megagroup) {
                    if (!ChatObject.isPublic(chat)) {
                        lowerCase = LocaleController.getString("ChannelPrivate", C3158R.string.ChannelPrivate).toLowerCase();
                    } else {
                        lowerCase = LocaleController.getString("ChannelPublic", C3158R.string.ChannelPublic).toLowerCase();
                    }
                } else if (chat.has_geo) {
                    lowerCase = LocaleController.getString("MegaLocation", C3158R.string.MegaLocation);
                } else if (!ChatObject.isPublic(chat)) {
                    lowerCase = LocaleController.getString("MegaPrivate", C3158R.string.MegaPrivate).toLowerCase();
                } else {
                    lowerCase = LocaleController.getString("MegaPublic", C3158R.string.MegaPublic).toLowerCase();
                }
