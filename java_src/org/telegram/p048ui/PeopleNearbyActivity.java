...
public class PeopleNearbyActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, LocationController.LocationFetchCallback {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("PeopleNearby", C3316R.string.PeopleNearby));
        this.actionBar.getTitleTextView().setAlpha(BitmapDescriptorFactory.HUE_RED);
        this.actionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PeopleNearbyActivity.2
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.PeopleNearbyActivity.3
            ...
            protected void onMeasure(int i, int i2) {
                ((FrameLayout.LayoutParams) PeopleNearbyActivity.this.actionBarBackground.getLayoutParams()).height = C3381ActionBar.getCurrentActionBarHeight() + (((BaseFragment) PeopleNearbyActivity.this).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + AndroidUtilities.m50dp(3);
    ...
    public /* synthetic */ void lambda$createView$2(View view, int i) {
        ...
        if (i >= i3 && i < this.chatsEndRow) {
            ...
            if (this.showingMe) {
                ...
                builder.setTitle(LocaleController.getString("MakeMyselfVisibleTitle", C3316R.string.MakeMyselfVisibleTitle));
                builder.setMessage(LocaleController.getString("MakeMyselfVisibleInfo", C3316R.string.MakeMyselfVisibleInfo));
                builder.setPositiveButton(LocaleController.getString("OK", C3316R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda1
    ...
    */
    public void checkScroll(boolean r11) {
        ...
        L15:
            ...
            org.telegram.ui.PeopleNearbyActivity$HintInnerCell r0 = (org.telegram.p048ui.PeopleNearbyActivity.HintInnerCell) r0
            android.widget.TextView r3 = org.telegram.p048ui.PeopleNearbyActivity.HintInnerCell.access$2200(r0)
            int[] r4 = r10.location
            r3.getLocationOnScreen(r4)
            int[] r3 = r10.location
            r3 = r3[r2]
            android.widget.TextView r0 = org.telegram.p048ui.PeopleNearbyActivity.HintInnerCell.access$2200(r0)
        ...
        Lc6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.PeopleNearbyActivity.checkScroll(boolean):void");
    }

    private void openGroupCreate() {
        if (!this.canCreateGroup) {
            AlertsCreator.showSimpleAlert(this, LocaleController.getString("YourLocatedChannelsTooMuch", C3316R.string.YourLocatedChannelsTooMuch));
            return;
        }
    ...
    public void sendRequest(boolean z, final int i) {
        ...
        if (!z && (location = this.lastLoadedLocation) != null) {
            ...
            if (BuildVars.DEBUG_VERSION) {
                FileLog.m48d("located distance = " + distanceTo);
            }
            if (i == 0 && (SystemClock.elapsedRealtime() - this.lastLoadedLocationTime < C0482C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS || this.lastLoadedLocation.distanceTo(lastKnownLocation) <= 20.0f)) {
                return;
            }
            if (this.reqId != 0) {
    ...
    */
    public void didReceivedNotification(int r19, int r20, java.lang.Object... r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.PeopleNearbyActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
    ...
    public static class HeaderCellProgress extends HeaderCell {
        ...
        public HeaderCellProgress(Context context) {
            ...
            radialProgressView.setSize(AndroidUtilities.m50dp(14));
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(PeopleNearbyActivity peopleNearbyActivity, Context context) {
            super(context);
            int currentActionBarHeight = ((int) ((C3381ActionBar.getCurrentActionBarHeight() + (((BaseFragment) peopleNearbyActivity).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0)) / AndroidUtilities.density)) - 44;
            ImageView imageView = new ImageView(context);
            this.imageView = imageView;
            imageView.setBackgroundDrawable(Theme.createCircleDrawable(AndroidUtilities.m50dp(74), Theme.getColor("chats_archiveBackground")));
            ...
            this.titleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("PeopleNearby", C3316R.string.PeopleNearby, new Object[0])));
            ...
            this.messageTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("PeopleNearbyInfo2", C3316R.string.PeopleNearbyInfo2, new Object[0])));
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                manageChatUserCell2.setBackgroundColor(Theme.getColor("windowBackgroundWhite"));
                ...
                if (i == 1) {
                    ...
                    TextView textView = new TextView(this, this.mContext) { // from class: org.telegram.ui.PeopleNearbyActivity.ListAdapter.1
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(67), 1073741824));
                        }
                    };
                    textView.setBackgroundColor(Theme.getColor("windowBackgroundWhite"));
                    textView.setPadding(0, 0, AndroidUtilities.m50dp(3), 0);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i != PeopleNearbyActivity.this.usersSectionRow) {
                    ...
                    shadowSectionCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C3316R.C3318drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                    return;
                }
                shadowSectionCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C3316R.C3318drawable.greydivider, "windowBackgroundGrayShadow"));
                ...
                if (i != PeopleNearbyActivity.this.usersHeaderRow) {
                    if (i == PeopleNearbyActivity.this.chatsHeaderRow) {
                        headerCellProgress.setText(LocaleController.getString("ChatsNearbyHeader", C3316R.string.ChatsNearbyHeader));
                        return;
                    }
                    return;
                }
                headerCellProgress.setText(LocaleController.getString("PeopleNearbyHeader", C3316R.string.PeopleNearbyHeader));
            } else {
                ...
                if (i == PeopleNearbyActivity.this.chatsCreateRow) {
                    manageChatTextCell.setText(LocaleController.getString("NearbyCreateGroup", C3316R.string.NearbyCreateGroup), null, C3316R.C3318drawable.msg_groups_create, PeopleNearbyActivity.this.chatsStartRow != -1);
                } else if (i != PeopleNearbyActivity.this.showMeRow) {
                    if (i == PeopleNearbyActivity.this.showMoreRow) {
                        manageChatTextCell.setText(LocaleController.formatPluralString("ShowVotes", PeopleNearbyActivity.this.users.size() - 5, new Object[0]), null, C3316R.C3318drawable.arrow_more, false);
                    }
                } else {
                    ...
                    if (peopleNearbyActivity.showingMe = peopleNearbyActivity.getUserConfig().sharingMyLocationUntil > PeopleNearbyActivity.this.getConnectionsManager().getCurrentTime()) {
                        manageChatTextCell.setText(LocaleController.getString("StopShowingMe", C3316R.string.StopShowingMe), null, C3316R.C3318drawable.msg_nearby_off, PeopleNearbyActivity.this.usersStartRow != -1);
                        manageChatTextCell.setColors("windowBackgroundWhiteRedText5", "windowBackgroundWhiteRedText5");
                        return;
                    }
                    manageChatTextCell.setText(LocaleController.getString("MakeMyselfVisible", C3316R.string.MakeMyselfVisible), null, C3316R.C3318drawable.msg_nearby, PeopleNearbyActivity.this.usersStartRow != -1);
                }
            }
        }
