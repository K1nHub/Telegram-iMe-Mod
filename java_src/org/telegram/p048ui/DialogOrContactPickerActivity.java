...
public class DialogOrContactPickerActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("BlockUserMultiTitle", C3158R.string.BlockUserMultiTitle));
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3222ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.DialogOrContactPickerActivity.1
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C3158R.C3160drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.DialogOrContactPickerActivity.2
                    ...
                    if (this.startedTracking) {
                        ...
                        DialogOrContactPickerActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogOrContactPickerActivity.4.1
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                DialogOrContactPickerActivity.this.tabsAnimationInProgress = false;
                                C53424.this.maybeStartTracking = false;
                                C53424.this.startedTracking = false;
    ...
    private void showBlockAlert(final TLRPC$User tLRPC$User) {
        ...
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AreYouSureBlockContact2", C3158R.string.AreYouSureBlockContact2, ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name))));
        builder.setPositiveButton(LocaleController.getString("BlockContact", C3158R.string.BlockContact), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogOrContactPickerActivity$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ void lambda$showBlockAlert$3(TLRPC$User tLRPC$User, DialogInterface dialogInterface, int i) {
        if (MessagesController.isSupportUser(tLRPC$User)) {
            AlertsCreator.showSimpleToast(this, LocaleController.getString("ErrorOccurred", C3158R.string.ErrorOccurred));
        } else {
            MessagesController.getInstance(this.currentAccount).blockPeer(tLRPC$User.f1633id);
            AlertsCreator.showSimpleToast(this, LocaleController.getString("UserBlocked", C3158R.string.UserBlocked));
        }
        finishFragment();
    }
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString("BlockUserChatsTitle", C3158R.string.BlockUserChatsTitle));
        this.scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString("BlockUserContactsTitle", C3158R.string.BlockUserContactsTitle));
