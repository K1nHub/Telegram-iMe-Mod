...
public class SaveToGallerySettingsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3351ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.SaveToGallerySettingsActivity.1
        ...
        if (this.dialogException != null) {
            if (this.isNewException) {
                this.actionBar.setTitle(LocaleController.getString(C3286R.string.NotificationsNewException));
            } else {
                this.actionBar.setTitle(LocaleController.getString(C3286R.string.SaveToGalleryException));
            }
        } else {
            int i2 = this.type;
            if (i2 == 1) {
                this.actionBar.setTitle(LocaleController.getString(C3286R.string.SaveToGalleryPrivate));
            } else if (i2 == 2) {
                this.actionBar.setTitle(LocaleController.getString(C3286R.string.SaveToGalleryGroups));
            } else {
                this.actionBar.setTitle(LocaleController.getString(C3286R.string.SaveToGalleryChannels));
            }
        }
        ...
        if (this.dialogException != null) {
            ...
            if (this.isNewException) {
                i = C3286R.string.AddException;
                str = "AddException";
            } else {
                i = C3286R.string.SaveException;
                str = "SaveException";
            }
    ...
    public /* synthetic */ void lambda$createView$2(View view, int i, float f, float f2) {
        if (i == this.savePhotosRow) {
            ...
            AlertDialog create = AlertsCreator.createSimpleAlert(getContext(), LocaleController.getString("NotificationsDeleteAllExceptionTitle", C3286R.string.NotificationsDeleteAllExceptionTitle), LocaleController.getString("NotificationsDeleteAllExceptionAlert", C3286R.string.NotificationsDeleteAllExceptionAlert), LocaleController.getString("Delete", C3286R.string.Delete), new Runnable() { // from class: org.telegram.ui.SaveToGallerySettingsActivity$$ExternalSyntheticLambda3
    ...
    public /* synthetic */ boolean lambda$createView$5(View view, final int i, float f, float f2) {
        if (this.items.get(i).viewType == 2) {
            ...
            ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3286R.C3288drawable.msg_customize, LocaleController.getString("EditException", C3286R.string.EditException), false, null);
            ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3286R.C3288drawable.msg_delete, LocaleController.getString("DeleteException", C3286R.string.DeleteException), false, null);
    ...
    private void updateRows() {
        ...
        this.items.add(new Item(5, LocaleController.getString("SaveToGallery", C3286R.string.SaveToGallery)));
        this.savePhotosRow = this.items.size();
        this.items.add(new Item(6));
        this.saveVideosRow = this.items.size();
        this.items.add(new Item(6));
        if (this.dialogException != null) {
            string = LocaleController.getString("SaveToGalleryHintCurrent", C3286R.string.SaveToGalleryHintCurrent);
        } else {
            int i2 = this.type;
            if (i2 == 1) {
                string = LocaleController.getString("SaveToGalleryHintUser", C3286R.string.SaveToGalleryHintUser);
            } else if (i2 == 4) {
                string = LocaleController.getString("SaveToGalleryHintChannels", C3286R.string.SaveToGalleryHintChannels);
            } else {
                string = i2 == 2 ? LocaleController.getString("SaveToGalleryHintGroup", C3286R.string.SaveToGalleryHintGroup) : null;
            }
        }
        this.items.add(new Item(7, string));
        if (getSettings().saveVideo) {
            this.items.add(new Item(5, LocaleController.getString("MaxVideoSize", C3286R.string.MaxVideoSize)));
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                case 1:
                    ...
                    textCell2.setTextAndIcon(LocaleController.getString("NotificationsAddAnException", C3286R.string.NotificationsAddAnException), C3286R.C3288drawable.msg_contact_add, true);
                ...
                case 4:
                    ...
                    textCell3.setText(LocaleController.getString("NotificationsDeleteAllException", C3286R.string.NotificationsDeleteAllException), false);
                    ...
                    seekBarView.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.telegram.ui.SaveToGallerySettingsActivity.Adapter.1
                        ...
                        public void onSeekBarDrag(boolean z, float f) {
                            ...
                            if (f >= 1.0f) {
                                ...
                                selectableAnimatedTextView2.setText(LocaleController.formatString("UpToFileSize", C3286R.string.UpToFileSize, AndroidUtilities.formatFileSize(j3, true)), false);
                                selectableAnimatedTextView.setSelectedInternal(false, isAttachedToWindow);
                ...
                case 10:
                    ...
                    shadowSectionCell2.setBackgroundDrawable(Theme.getThemedDrawable(SaveToGallerySettingsActivity.this.getContext(), C3286R.C3288drawable.greydivider_bottom, Theme.getColor("windowBackgroundGrayShadow", SaveToGallerySettingsActivity.this.getResourceProvider())));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            if (SaveToGallerySettingsActivity.this.items.get(i).viewType == 1) {
                ...
                if (i == SaveToGallerySettingsActivity.this.savePhotosRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString(C3286R.string.SaveToGalleryPhotos), settings.savePhoto, true);
                    textCheckCell.setColorfullIcon(SaveToGallerySettingsActivity.this.getThemedColor("statisticChartLine_lightblue"), C3286R.C3288drawable.msg_filled_data_photos);
                    return;
                }
                textCheckCell.setTextAndCheck(LocaleController.getString(C3286R.string.SaveToGalleryVideos), settings.saveVideo, false);
                textCheckCell.setColorfullIcon(SaveToGallerySettingsActivity.this.getThemedColor("statisticChartLine_green"), C3286R.C3288drawable.msg_filled_data_videos);
                ...
                if (i == saveToGallerySettingsActivity.videoDividerRow) {
                    ...
                    if (saveToGallerySettingsActivity2.dialogException != null) {
                        textInfoPrivacyCell.setText(LocaleController.formatString("SaveToGalleryVideoHintCurrent", C3286R.string.SaveToGalleryVideoHintCurrent, new Object[0]));
                        return;
                    }
                    int i2 = saveToGallerySettingsActivity2.type;
                    if (i2 == 1) {
                        textInfoPrivacyCell.setText(LocaleController.formatString("SaveToGalleryVideoHintUser", C3286R.string.SaveToGalleryVideoHintUser, new Object[0]));
                        return;
                    } else if (i2 == 4) {
                        textInfoPrivacyCell.setText(LocaleController.formatString("SaveToGalleryVideoHintChannels", C3286R.string.SaveToGalleryVideoHintChannels, new Object[0]));
                        return;
                    } else if (i2 == 2) {
                        textInfoPrivacyCell.setText(LocaleController.formatString("SaveToGalleryVideoHintGroup", C3286R.string.SaveToGalleryVideoHintGroup, new Object[0]));
                        return;
                    } else {
                        return;
                    }
                ...
                if (userOrChat instanceof TLRPC$User) {
                    ...
                    if (tLRPC$User.self) {
                        str = LocaleController.getString("SavedMessages", C3286R.string.SavedMessages);
                    } else {
