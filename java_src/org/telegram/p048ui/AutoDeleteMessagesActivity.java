...
import org.telegram.p048ui.AutoDeleteMessagesActivity;
...
public class AutoDeleteMessagesActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("AutoDeleteMessages", C3286R.string.AutoDeleteMessages));
        this.actionBar.setActionBarMenuOnItemClick(new C3351ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.AutoDeleteMessagesActivity.1
        ...
        headerCell.setText(LocaleController.getString("MessageLifetime", C3286R.string.MessageLifetime));
        ...
        radioCellInternal.setText(LocaleController.getString("ShortMessageLifetimeForever", C3286R.string.ShortMessageLifetimeForever), false, true);
        ...
        radioCellInternal3.setText(LocaleController.getString("AutoDeleteAfter1Day", C3286R.string.AutoDeleteAfter1Day), false, true);
        ...
        radioCellInternal5.setText(LocaleController.getString("AutoDeleteAfter1Week", C3286R.string.AutoDeleteAfter1Week), false, true);
        ...
        radioCellInternal7.setText(LocaleController.getString("AutoDeleteAfter1Month", C3286R.string.AutoDeleteAfter1Month), false, true);
        ...
        radioCellInternal9.setText(LocaleController.getString("SetCustomTime", C3286R.string.SetCustomTime), false, false);
        ...
        textInfoPrivacyCell.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString("GlobalAutoDeleteInfo", C3286R.string.GlobalAutoDeleteInfo), new RunnableC35402()));
    ...
    /* loaded from: classes5.dex */
    public class RunnableC35402 implements Runnable {
        RunnableC35402() {
        }
        ...
        public void run() {
            ...
            usersSelectActivity.setDelegate(new UsersSelectActivity.FilterUsersActivityDelegate() { // from class: org.telegram.ui.AutoDeleteMessagesActivity$2$$ExternalSyntheticLambda1
                ...
                public final void didSelectChats(ArrayList arrayList, int i) {
                    AutoDeleteMessagesActivity.RunnableC35402.this.lambda$run$1(arrayList, i);
                }
            });
        ...
        public /* synthetic */ void lambda$run$1(final ArrayList arrayList, int i) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.AutoDeleteMessagesActivity$2$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AutoDeleteMessagesActivity.RunnableC35402.this.lambda$run$0(arrayList);
                }
            }, 100L);
        }
        ...
        public /* synthetic */ void lambda$run$0(ArrayList arrayList) {
            ...
            if (AutoDeleteMessagesActivity.this.getSelectedTime() > 0) {
                BulletinFactory.m27of(AutoDeleteMessagesActivity.this).createSimpleBulletin(C3286R.C3291raw.fire_on, AndroidUtilities.replaceTags(LocaleController.formatString("AutodeleteTimerEnabledForChats", C3286R.string.AutodeleteTimerEnabledForChats, LocaleController.formatTTLString(AutoDeleteMessagesActivity.this.getSelectedTime() * 60), LocaleController.formatPluralString("Chats", arrayList.size(), Integer.valueOf(arrayList.size()))))).show();
            } else {
                BulletinFactory.m27of(AutoDeleteMessagesActivity.this).createSimpleBulletin(C3286R.C3291raw.fire_off, LocaleController.formatString("AutodeleteTimerDisabledForChats", C3286R.string.AutodeleteTimerDisabledForChats, LocaleController.formatPluralString("Chats", arrayList.size(), Integer.valueOf(arrayList.size())))).show();
            }
        }
    }
    ...
    /* loaded from: classes5.dex */
    public class C35413 implements AlertsCreator.ScheduleDatePickerDelegate {
        ...
        public void didSelectDate(boolean z, final int i, String str) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.AutoDeleteMessagesActivity$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AutoDeleteMessagesActivity.C35413.this.lambda$didSelectDate$0(i);
                }
            }, 50L);
        }
    ...
    public /* synthetic */ void lambda$updateItems$2(final View view) {
        if (view == this.customTimeButton) {
            AlertsCreator.createAutoDeleteDatePickerDialog(getContext(), 1, null, new C35413());
            return;
        }
        int i = ((RadioCellInternal) view).time;
        if (getSelectedTime() == 0 && i > 0) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
            builder.setTitle(LocaleController.getString("MessageLifetime", C3286R.string.MessageLifetime));
            builder.setMessage(LocaleController.formatString("AutoDeleteConfirmMessage", C3286R.string.AutoDeleteConfirmMessage, LocaleController.formatTTLString(i * 60)));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3286R.string.Cancel), AutoDeleteMessagesActivity$$ExternalSyntheticLambda1.INSTANCE);
            builder.setPositiveButton(LocaleController.getString("Enable", C3286R.string.Enable), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.AutoDeleteMessagesActivity$$ExternalSyntheticLambda0
    ...
    public void selectDate(int i, boolean z) {
        ...
        radioCellInternal.setText(LocaleController.formatString("AutoDeleteAfterShort", C3286R.string.AutoDeleteAfterShort, LocaleController.formatTTLString(i * 60)), false, true);
    ...
    private void selectRadioButton(View view, boolean z) {
        ...
        BulletinFactory.m27of(this).createSimpleBulletin(C3286R.C3291raw.fire_on, AndroidUtilities.replaceTags(LocaleController.formatString("AutoDeleteGlobalTimerEnabled", C3286R.string.AutoDeleteGlobalTimerEnabled, LocaleController.formatTTLString(i * 60)))).show();
    }
