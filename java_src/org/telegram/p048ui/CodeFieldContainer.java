...
public class CodeFieldContainer extends LinearLayout {
    ...
    */
    public void setNumbersCount(final int r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.CodeFieldContainer.setNumbersCount(int, int):void");
    }
    ...
    public String getCode() {
        ...
        while (true) {
            ...
            if (i < codeNumberFieldArr.length) {
                sb.append(C3218PhoneFormat.stripExceptNumbers(codeNumberFieldArr[i].getText().toString()));
                i++;
            } else {
                return sb.toString();
            }
