...
public class EmojiAnimationsOverlay implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void checkStickerPack() {
        ...
        if (this.set != null) {
            ...
            for (int i = 0; i < this.set.documents.size(); i++) {
                hashMap.put(Long.valueOf(this.set.documents.get(i).f1502id), this.set.documents.get(i));
            }
    ...
    public boolean onTapItem(ChatMessageCell chatMessageCell, ChatActivity chatActivity, boolean z) {
        ...
        if (chatMessageCell.getMessageObject().isPremiumSticker() || chatActivity.currentUser != null) {
            ...
            if ((printingStringType == null || printingStringType.intValue() != 5) && this.hintRunnable == null && showAnimationForCell && ((Bulletin.getVisibleBulletin() == null || !Bulletin.getVisibleBulletin().isShowing()) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.currentAccount).getClientUserId() != chatActivity.currentUser.f1633id)) {
                ...
                stickerSetBulletinLayout.titleTextView.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString("EmojiInteractionTapHint", C3158R.string.EmojiInteractionTapHint, chatActivity.currentUser.first_name)), stickerSetBulletinLayout.titleTextView.getPaint().getFontMetricsInt(), false));
    ...
    public boolean showAnimationForActionCell(ChatActionCell chatActionCell, TLRPC$Document tLRPC$Document, TLRPC$VideoSize tLRPC$VideoSize) {
        if (this.drawingObjects.size() <= 12 && chatActionCell.getPhotoImage().hasNotThumb()) {
            ...
            for (int i3 = 0; i3 < this.drawingObjects.size(); i3++) {
                ...
                if (this.drawingObjects.get(i3).document != null && tLRPC$Document != null && this.drawingObjects.get(i3).document.f1502id == tLRPC$Document.f1502id) {
                    i2++;
                }
            }
            if (i >= 4) {
            ...
            if (i2 > 0) {
                Integer num = this.lastAnimationIndex.get(Long.valueOf(tLRPC$Document.f1502id));
                int intValue = num == null ? 0 : num.intValue();
                this.lastAnimationIndex.put(Long.valueOf(tLRPC$Document.f1502id), Integer.valueOf((intValue + 1) % 4));
    ...
    private void preloadAnimation(TLRPC$Document tLRPC$Document, int i) {
        ...
        if (hashMap == null || !hashMap.containsKey(Long.valueOf(tLRPC$Document.f1502id))) {
            if (this.preloaded == null) {
                this.preloaded = new HashMap<>();
            }
            this.preloaded.put(Long.valueOf(tLRPC$Document.f1502id), Boolean.TRUE);
                ...
                if ((supportedEmoji.contains(unwrapEmoji) || isPremiumSticker) && (!((arrayList = this.emojiInteractionsStickersMap.get(unwrapEmoji)) == null || arrayList.isEmpty()) || isPremiumSticker)) {
                    ...
                    while (i3 < this.drawingObjects.size()) {
                        ...
                        if (this.drawingObjects.get(i3).document == null || chatMessageCell.getMessageObject().getDocument() == null) {
                            ...
                            z3 = isPremiumSticker;
                            if (this.drawingObjects.get(i3).document.f1502id == chatMessageCell.getMessageObject().getDocument().f1502id) {
                                i5++;
                            }
                        }
                        i3++;
                    ...
                    if (z && z5 && i4 > 0) {
                        if (Bulletin.getVisibleBulletin() == null || Bulletin.getVisibleBulletin().hash != messageObject.getId()) {
                            ...
                            if (stickerSetByName == null) {
                                stickerSetByName = MediaDataController.getInstance(this.currentAccount).getStickerSetById(inputStickerSet.f1517id);
                            }
                            if (stickerSetByName == null) {
                                ...
                                if (i2 < 0 || i2 > arrayList.size() - 1) {
                                    ...
                                    for (int i6 = 0; i6 < arrayList.size(); i6++) {
                                        ...
                                        if (tLRPC$Document2 != null) {
                                            HashMap<Long, Boolean> hashMap = this.preloaded;
                                            Boolean bool = hashMap != null ? hashMap.get(Long.valueOf(tLRPC$Document2.f1502id)) : null;
                        ...
                        if (tLRPC$Document != null) {
                            ...
                            this.lastAnimationIndex.put(Long.valueOf(tLRPC$Document.f1502id), Integer.valueOf(intValue));
                            ImageLocation forDocument = ImageLocation.getForDocument(tLRPC$Document);
                            ImageReceiver imageReceiver = drawingObject.imageReceiver;
                            imageReceiver.setUniqKeyPrefix(intValue + "_" + drawingObject.messageId + "_");
                            ImageReceiver imageReceiver2 = drawingObject.imageReceiver;
                            ...
                            if (i5 > 0) {
                                Integer num2 = this.lastAnimationIndex.get(Long.valueOf(messageObject.getDocument().f1502id));
                                int intValue2 = num2 == null ? 0 : num2.intValue();
                                this.lastAnimationIndex.put(Long.valueOf(messageObject.getDocument().f1502id), Integer.valueOf((intValue2 + 1) % 4));
    ...
    public void lambda$showAnimationForCell$0(TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, final MessageObject messageObject) {
        ...
        stickerSetBulletinLayout.subtitleTextView.setText(LocaleController.getString("PremiumStickerTooltip", C3158R.string.PremiumStickerTooltip));
        ...
        undoButton.setText(LocaleController.getString("ViewAction", C3158R.string.ViewAction));
