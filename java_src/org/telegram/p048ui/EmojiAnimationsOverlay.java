...
public class EmojiAnimationsOverlay implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void checkStickerPack() {
        ...
        if (this.set != null) {
            ...
            for (int i = 0; i < this.set.documents.size(); i++) {
                hashMap.put(Long.valueOf(this.set.documents.get(i).f1510id), this.set.documents.get(i));
            }
    ...
    public void draw(Canvas canvas) {
        ...
        while (i < this.drawingObjects.size()) {
            ...
            if (drawingObject.removing) {
                ...
                if (f3 != 1.0f) {
                    float clamp = Utilities.clamp(f3 + 0.10666667f, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
    ...
    public boolean onTapItem(ChatMessageCell chatMessageCell, ChatActivity chatActivity, boolean z) {
        ...
        if (chatMessageCell.getMessageObject().isPremiumSticker() || chatActivity.currentUser != null) {
            ...
            if ((printingStringType == null || printingStringType.intValue() != 5) && this.hintRunnable == null && showAnimationForCell && ((Bulletin.getVisibleBulletin() == null || !Bulletin.getVisibleBulletin().isShowing()) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.currentAccount).getClientUserId() != chatActivity.currentUser.f1642id)) {
                ...
                stickerSetBulletinLayout.titleTextView.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString("EmojiInteractionTapHint", C3316R.string.EmojiInteractionTapHint, chatActivity.currentUser.first_name)), stickerSetBulletinLayout.titleTextView.getPaint().getFontMetricsInt(), false));
    ...
    public boolean showAnimationForActionCell(ChatActionCell chatActionCell, TLRPC$Document tLRPC$Document, TLRPC$VideoSize tLRPC$VideoSize) {
        if (this.drawingObjects.size() <= 12 && chatActionCell.getPhotoImage().hasNotThumb()) {
            ...
            for (int i3 = 0; i3 < this.drawingObjects.size(); i3++) {
                ...
                if (this.drawingObjects.get(i3).document != null && tLRPC$Document != null && this.drawingObjects.get(i3).document.f1510id == tLRPC$Document.f1510id) {
                    i2++;
                }
            }
            if (i >= 4) {
            ...
            if (i2 > 0) {
                Integer num = this.lastAnimationIndex.get(Long.valueOf(tLRPC$Document.f1510id));
                int intValue = num == null ? 0 : num.intValue();
                this.lastAnimationIndex.put(Long.valueOf(tLRPC$Document.f1510id), Integer.valueOf((intValue + 1) % 4));
                drawingObject.imageReceiver.setUniqKeyPrefix(intValue + "_" + drawingObject.messageId + "_");
            }
            drawingObject.document = tLRPC$Document;
            drawingObject.imageReceiver.setImage(ImageLocation.getForDocument(tLRPC$VideoSize, tLRPC$Document), i4 + "_" + i4, null, "tgs", this.set, 1);
    ...
    private void preloadAnimation(TLRPC$Document tLRPC$Document, int i) {
        ...
        if (hashMap == null || !hashMap.containsKey(Long.valueOf(tLRPC$Document.f1510id))) {
            if (this.preloaded == null) {
                this.preloaded = new HashMap<>();
            }
            this.preloaded.put(Long.valueOf(tLRPC$Document.f1510id), Boolean.TRUE);
    ...
    private boolean showAnimationForCell(final ChatMessageCell chatMessageCell, int i, final boolean z, boolean z2) {
        ...
        if (this.drawingObjects.size() <= 12 && chatMessageCell.getPhotoImage().hasNotThumb()) {
            ...
            if (!isPremiumSticker || ForkCommonController.getInstance(this.currentAccount).isPremiumAnimateStickers()) {
                if ((supportedEmoji.contains(unwrapEmoji) || isPremiumSticker) && (!((arrayList = this.emojiInteractionsStickersMap.get(unwrapEmoji)) == null || arrayList.isEmpty()) || isPremiumSticker)) {
                    ...
                    while (i3 < this.drawingObjects.size()) {
                        ...
                        if (this.drawingObjects.get(i3).document == null || chatMessageCell.getMessageObject().getDocument() == null) {
                            ...
                            z3 = isPremiumSticker;
                            if (this.drawingObjects.get(i3).document.f1510id == chatMessageCell.getMessageObject().getDocument().f1510id) {
                                i5++;
                            }
                        }
                        i3++;
                    ...
                    if (z && z5 && i4 > 0) {
                        if (Bulletin.getVisibleBulletin() == null || Bulletin.getVisibleBulletin().hash != messageObject.getId()) {
                            ...
                            if (stickerSetByName == null) {
                                stickerSetByName = MediaDataController.getInstance(this.currentAccount).getStickerSetById(inputStickerSet.f1525id);
                            }
                            if (stickerSetByName == null) {
                                ...
                                if (i2 < 0 || i2 > arrayList.size() - 1) {
                                    ...
                                    for (int i6 = 0; i6 < arrayList.size(); i6++) {
                                        ...
                                        if (tLRPC$Document2 != null) {
                                            HashMap<Long, Boolean> hashMap = this.preloaded;
                                            Boolean bool = hashMap != null ? hashMap.get(Long.valueOf(tLRPC$Document2.f1510id)) : null;
                        ...
                        DrawingObject drawingObject = new DrawingObject();
                        drawingObject.isPremiumSticker = messageObject.isPremiumSticker() && ForkCommonController.getInstance(this.currentAccount).isPremiumAnimateStickers();
                        drawingObject.randomOffsetX = (imageWidth / 4.0f) * ((this.random.nextInt() % 101) / 100.0f);
                        drawingObject.randomOffsetY = (imageHeight / 4.0f) * ((this.random.nextInt() % 101) / 100.0f);
                        ...
                        if (tLRPC$Document != null) {
                            ...
                            this.lastAnimationIndex.put(Long.valueOf(tLRPC$Document.f1510id), Integer.valueOf(intValue));
                            ImageLocation forDocument = ImageLocation.getForDocument(tLRPC$Document);
                            drawingObject.imageReceiver.setUniqKeyPrefix(intValue + "_" + drawingObject.messageId + "_");
                            ...
                            if (i5 > 0) {
                                Integer num2 = this.lastAnimationIndex.get(Long.valueOf(messageObject.getDocument().f1510id));
                                int intValue2 = num2 == null ? 0 : num2.intValue();
                                this.lastAnimationIndex.put(Long.valueOf(messageObject.getDocument().f1510id), Integer.valueOf((intValue2 + 1) % 4));
                            ...
                            drawingObject.imageReceiver.setImage(ImageLocation.getForDocument(tLRPC$VideoSize, messageObject.getDocument()), i8 + "_" + i8, null, "tgs", this.set, 1);
                        }
                        drawingObject.imageReceiver.setLayerNum(Integer.MAX_VALUE);
                        drawingObject.imageReceiver.setAutoRepeat(0);
                        if (drawingObject.imageReceiver.getLottieAnimation() != null) {
    ...
    public void lambda$showAnimationForCell$0(TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, final MessageObject messageObject) {
        ...
        stickerSetBulletinLayout.subtitleTextView.setText(LocaleController.getString("PremiumStickerTooltip", C3316R.string.PremiumStickerTooltip));
        ...
        undoButton.setText(LocaleController.getString("ViewAction", C3316R.string.ViewAction));
    ...
    */
    public static java.lang.String unwrapEmoji(java.lang.String r8) {
        ...
        L88:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.EmojiAnimationsOverlay.unwrapEmoji(java.lang.String):java.lang.String");
    }
