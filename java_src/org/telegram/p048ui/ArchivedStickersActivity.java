...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (this.currentType == 0) {
            this.actionBar.setTitle(LocaleController.getString("ArchivedStickers", C3316R.string.ArchivedStickers));
        } else {
            this.actionBar.setTitle(LocaleController.getString("ArchivedMasks", C3316R.string.ArchivedMasks));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ArchivedStickersActivity.1
        ...
        if (this.currentType == 0) {
            emptyTextProgressView.setText(LocaleController.getString("ArchivedStickersEmpty", C3316R.string.ArchivedStickersEmpty));
        } else {
            emptyTextProgressView.setText(LocaleController.getString("ArchivedMasksEmpty", C3316R.string.ArchivedMasksEmpty));
        }
    ...
    public /* synthetic */ void lambda$createView$0(final View view, int i) {
        ...
        if (tLRPC$StickerSetCovered.set.f1535id != 0) {
            tLRPC$TL_inputStickerSetShortName = new TLRPC$TL_inputStickerSetID();
            tLRPC$TL_inputStickerSetShortName.f1525id = tLRPC$StickerSetCovered.set.f1535id;
        } else {
        ...
        stickersAlert.setInstallDelegate(new StickersAlert.StickersAlertInstallDelegate() { // from class: org.telegram.ui.ArchivedStickersActivity.2
            ...
            public void onStickerSetInstalled() {
                ...
                longSparseArray.put(tLRPC$StickerSetCovered2.set.f1535id, tLRPC$StickerSetCovered2);
            }
        });
    ...
    public void getStickers() {
        ...
        if (this.sets.isEmpty()) {
            ...
            j = arrayList.get(arrayList.size() - 1).set.f1535id;
        }
        ...
        if (i == NotificationCenter.needAddArchivedStickers) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                ...
                while (true) {
                    if (i3 >= size2) {
                        break;
                    } else if (this.sets.get(i3).set.f1535id == ((TLRPC$StickerSetCovered) arrayList.get(size)).set.f1535id) {
            ...
            for (int i4 = 0; i4 < childCount; i4++) {
                ...
                if ((childAt instanceof ArchivedStickerSetCell) && (stickersSet = (archivedStickerSetCell = (ArchivedStickerSetCell) childAt).getStickersSet()) != null) {
                    boolean isStickerPackInstalled = MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(stickersSet.set.f1535id);
                    if (isStickerPackInstalled) {
                        this.installingStickerSets.remove(stickersSet.set.f1535id);
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            if (getItemViewType(i) == 0) {
                ...
                boolean isStickerPackInstalled = MediaDataController.getInstance(((BaseFragment) ArchivedStickersActivity.this).currentAccount).isStickerPackInstalled(tLRPC$StickerSetCovered.set.f1535id);
                archivedStickerSetCell.setChecked(isStickerPackInstalled, false, false);
                if (isStickerPackInstalled) {
                    ArchivedStickersActivity.this.installingStickerSets.remove(tLRPC$StickerSetCovered.set.f1535id);
                    archivedStickerSetCell.setDrawProgress(false, false);
                } else {
                    archivedStickerSetCell.setDrawProgress(ArchivedStickersActivity.this.installingStickerSets.indexOfKey(tLRPC$StickerSetCovered.set.f1535id) >= 0, false);
                }
                ...
                if (i == ArchivedStickersActivity.this.archiveInfoRow) {
                    ...
                    textInfoPrivacyCell.setText(LocaleController.getString("ArchivedStickersInfo", C3316R.string.ArchivedStickersInfo));
                    return;
                }
        ...
        public /* synthetic */ void lambda$onBindViewHolder$0(TLRPC$StickerSetCovered tLRPC$StickerSetCovered, ArchivedStickerSetCell archivedStickerSetCell, boolean z) {
            if (z) {
                ...
                if (ArchivedStickersActivity.this.installingStickerSets.indexOfKey(tLRPC$StickerSetCovered.set.f1535id) >= 0) {
                    return;
                }
                archivedStickerSetCell.setDrawProgress(true, true);
                ArchivedStickersActivity.this.installingStickerSets.put(tLRPC$StickerSetCovered.set.f1535id, tLRPC$StickerSetCovered);
            }
