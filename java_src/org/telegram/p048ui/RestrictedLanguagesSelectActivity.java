...
public class RestrictedLanguagesSelectActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("DoNotTranslate", C3316R.string.DoNotTranslate));
        this.actionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.RestrictedLanguagesSelectActivity.1
        ...
        this.actionBar.createMenu().addItem(0, C3316R.C3318drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.RestrictedLanguagesSelectActivity.2
        ...
        emptyTextProgressView.setText(LocaleController.getString("NoResult", C3316R.string.NoResult));
    ...
    private void fillLanguages() {
        ...
        for (int i2 = 0; i2 < arrayList2.size(); i2++) {
            ...
            language3.f1477q = language3.code.toLowerCase();
    ...
    private void processSearch(String str) {
        ...
        for (int i = 0; i < this.allLanguages.size(); i++) {
            ...
            if (language.f1477q.startsWith(lowerCase)) {
                this.searchResult.add(0, language);
            } else if (language.f1477q.contains(lowerCase)) {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                headerCell.setText(LocaleController.getString("ChooseLanguages", C3316R.string.ChooseLanguages));
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r6, int r7) {
            ...
            Lb:
                ...
                int r0 = org.telegram.messenger.C3316R.C3318drawable.greydivider
