...
public class FiltersView extends RecyclerListView {
    ...
    public static final MediaFilterData[] filters = {new MediaFilterData(C3316R.C3318drawable.search_media_filled, LocaleController.getString("SharedMediaTab2", C3316R.string.SharedMediaTab2), new TLRPC$TL_inputMessagesFilterPhotoVideo(), 0), new MediaFilterData(C3316R.C3318drawable.search_links_filled, LocaleController.getString("SharedLinksTab2", C3316R.string.SharedLinksTab2), new TLRPC$TL_inputMessagesFilterUrl(), 2), new MediaFilterData(C3316R.C3318drawable.search_files_filled, LocaleController.getString("SharedFilesTab2", C3316R.string.SharedFilesTab2), new TLRPC$TL_inputMessagesFilterDocument(), 1), new MediaFilterData(C3316R.C3318drawable.search_music_filled, LocaleController.getString("SharedMusicTab2", C3316R.string.SharedMusicTab2), new TLRPC$TL_inputMessagesFilterMusic(), 3), new MediaFilterData(C3316R.C3318drawable.search_voice_filled, LocaleController.getString("SharedVoiceTab2", C3316R.string.SharedVoiceTab2), new TLRPC$TL_inputMessagesFilterRoundVoice(), 5)};
    ...
    public FiltersView(Context context, Theme.ResourcesProvider resourcesProvider) {
                    ...
                    if (i3 == 4) {
                        ...
                        if (tLObject instanceof TLRPC$User) {
                            ...
                            if (tLObject2 instanceof TLRPC$User) {
                                return ((TLRPC$User) tLObject).f1642id == ((TLRPC$User) tLObject2).f1642id;
                            }
                        }
                        if (tLObject instanceof TLRPC$Chat) {
                            TLObject tLObject3 = mediaFilterData2.chat;
                            return (tLObject3 instanceof TLRPC$Chat) && ((TLRPC$Chat) tLObject).f1502id == ((TLRPC$Chat) tLObject3).f1502id;
                        }
                    } else if (i3 == 6) {
        ...
        addItemDecoration(new RecyclerView.ItemDecoration(this) { // from class: org.telegram.ui.Adapters.FiltersView.2
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                rect.left = AndroidUtilities.m50dp(8);
                if (childAdapterPosition == state.getItemCount() - 1) {
                    rect.right = AndroidUtilities.m50dp(10);
                }
                if (childAdapterPosition == 0) {
                    rect.left = AndroidUtilities.m50dp(10);
                }
            }
        });
            ...
            public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                animate.alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C35033.this).mAddAnimations.remove(viewHolder);
            ...
            protected void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                animate.setDuration(getRemoveDuration()).alpha(BitmapDescriptorFactory.HUE_RED).scaleX(BitmapDescriptorFactory.HUE_RED).scaleY(BitmapDescriptorFactory.HUE_RED).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.2
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C35033.this).mRemoveAnimations.remove(viewHolder);
                        dispatchFinishedWhenDone();
                    }
                }).start();
            }
        ...
        setSelectorRadius(AndroidUtilities.m50dp(28));
    ...
    public void setUsersAndDates(ArrayList<Object> arrayList, ArrayList<DateData> arrayList2, boolean z) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof TLRPC$User) {
                    ...
                    if (UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f1642id == tLRPC$User.f1642id) {
                        formatName = LocaleController.getString("SavedMessages", C3316R.string.SavedMessages);
                    } else {
                        formatName = ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name, 10);
                    }
                    MediaFilterData mediaFilterData = new MediaFilterData(C3316R.C3318drawable.search_users_filled, formatName, null, 4);
                    ...
                    MediaFilterData mediaFilterData2 = new MediaFilterData(C3316R.C3318drawable.search_users_filled, str, null, 4);
        ...
        if (arrayList2 != null) {
            for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                ...
                MediaFilterData mediaFilterData3 = new MediaFilterData(C3316R.C3318drawable.search_date_filled, dateData.title, null, 6);
                mediaFilterData3.setDate(dateData);
                this.usersFilters.add(mediaFilterData3);
            }
        }
        if (z) {
            this.usersFilters.add(new MediaFilterData(C3316R.C3318drawable.chats_archive, LocaleController.getString("ArchiveSearchFilter", C3316R.string.ArchiveSearchFilter), null, 7));
        }
        if (getAdapter() != null) {
    ...
    public static void fillTipDates(String str, ArrayList<DateData> arrayList) {
        ...
        int i = C3316R.string.SearchTipToday;
        ...
        int i5 = C3316R.string.SearchTipYesterday;
    ...
    public static int getMonth(String str) {
        String[] strArr = {LocaleController.getString("January", C3316R.string.January).toLowerCase(), LocaleController.getString("February", C3316R.string.February).toLowerCase(), LocaleController.getString("March", C3316R.string.March).toLowerCase(), LocaleController.getString("April", C3316R.string.April).toLowerCase(), LocaleController.getString("May", C3316R.string.May).toLowerCase(), LocaleController.getString("June", C3316R.string.June).toLowerCase(), LocaleController.getString("July", C3316R.string.July).toLowerCase(), LocaleController.getString("August", C3316R.string.August).toLowerCase(), LocaleController.getString("September", C3316R.string.September).toLowerCase(), LocaleController.getString("October", C3316R.string.October).toLowerCase(), LocaleController.getString("November", C3316R.string.November).toLowerCase(), LocaleController.getString("December", C3316R.string.December).toLowerCase()};
    ...
    private class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            RecyclerView.LayoutParams layoutParams = new RecyclerView.LayoutParams(-2, AndroidUtilities.m50dp(32));
            ((ViewGroup.MarginLayoutParams) layoutParams).topMargin = AndroidUtilities.m50dp(6);
    ...
    public static class FilterView extends FrameLayout {
        ...
        public void updateColors() {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m50dp(28), getThemedColor("groupcreate_spanBackground")));
        ...
        public void setData(MediaFilterData mediaFilterData) {
            ...
            if (mediaFilterData.filterType == 7) {
                CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m50dp(32), C3316R.C3318drawable.chats_archive);
            ...
            CombinedDrawable createCircleDrawableWithIcon2 = Theme.createCircleDrawableWithIcon(AndroidUtilities.m50dp(32), mediaFilterData.iconResFilled);
