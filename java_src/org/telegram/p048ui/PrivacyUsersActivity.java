...
public class PrivacyUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ContactsActivity.ContactsActivityDelegate {
    ...
    private boolean isWalletWhitelist;
    ...
    public PrivacyUsersActivity(int i, ArrayList<Long> arrayList, boolean z, boolean z2, boolean z3) {
        this.isWalletWhitelist = z3;
    ...
    public View createView(Context context) {
        ...
        if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("BlockedUsers", C3286R.string.BlockedUsers));
        } else if (i == 2) {
            if (this.isAlwaysShare) {
                this.actionBar.setTitle(LocaleController.getString("FilterAlwaysShow", C3286R.string.FilterAlwaysShow));
            } else {
                this.actionBar.setTitle(LocaleController.getString("FilterNeverShow", C3286R.string.FilterNeverShow));
            }
        } else if (this.isGroup) {
            if (this.isAlwaysShare) {
                this.actionBar.setTitle(LocaleController.getString("AlwaysAllow", C3286R.string.AlwaysAllow));
            } else {
                this.actionBar.setTitle(LocaleController.getString("NeverAllow", C3286R.string.NeverAllow));
            }
        } else if (this.isAlwaysShare) {
            this.actionBar.setTitle(LocaleController.getString("AlwaysShareWithTitle", C3286R.string.AlwaysShareWithTitle));
        } else {
            this.actionBar.setTitle(LocaleController.getString("NeverShareWithTitle", C3286R.string.NeverShareWithTitle));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3351ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PrivacyUsersActivity.1
        ...
        if (this.currentType == 1) {
            emptyTextProgressView.setText(LocaleController.getString("NoBlocked", C3286R.string.NoBlocked));
        } else {
            emptyTextProgressView.setText(LocaleController.getString("NoContacts", C3286R.string.NoContacts));
        }
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda3
        ...
        this.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda4
    ...
    public /* synthetic */ void lambda$createView$2(View view, int i) {
        if (i == this.deleteAllRow) {
            AlertDialog create = AlertsCreator.createSimpleAlert(getContext(), LocaleController.getString(C3286R.string.NotificationsDeleteAllExceptionTitle), LocaleController.getString(C3286R.string.NotificationsDeleteAllExceptionAlert), LocaleController.getString(C3286R.string.Delete), new Runnable() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda1
            ...
            if (this.isWalletWhitelist) {
                bundle.putBoolean("isOnlyUsers", true);
            }
            GroupCreateActivity groupCreateActivity = new GroupCreateActivity(bundle);
            groupCreateActivity.setDelegate(new GroupCreateActivity.GroupCreateActivityDelegate() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda5
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$1(ArrayList arrayList) {
    ...
    public void showUnblockAlert(final Long l) {
        ...
        builder.setItems(this.currentType == 1 ? new CharSequence[]{LocaleController.getString("Unblock", C3286R.string.Unblock)} : new CharSequence[]{LocaleController.getString("Delete", C3286R.string.Delete)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda0
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showUnblockAlert$4(Long l, DialogInterface dialogInterface, int i) {
        if (i == 0) {
            if (this.currentType == 1) {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                textCell.setText(LocaleController.getString("NotificationsDeleteAllException", C3286R.string.NotificationsDeleteAllException), false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (keyAt > 0) {
                    ...
                    if (user == null) {
                        manageChatUserCell.setData(Long.valueOf(keyAt), LocaleController.formatStringInternal(C3286R.string.common_id, Long.valueOf(keyAt)), LocaleController.getString("NumberUnknown", C3286R.string.NumberUnknown), i != PrivacyUsersActivity.this.usersEndRow - 1);
                        return;
                    }
                    if (user.bot) {
                        StringBuilder sb = new StringBuilder();
                        int i2 = C3286R.string.Bot;
                        ...
                        if (str != null && str.length() != 0) {
                            ...
                            string2 = c3204PhoneFormat.format("+" + user.phone);
                        } else {
                            string2 = LocaleController.getString("NumberUnknown", C3286R.string.NumberUnknown);
                        }
                    }
                ...
                if (chat != null) {
                    ...
                    if (i3 != 0) {
                        ...
                        string = LocaleController.getString("MegaLocation", C3286R.string.MegaLocation);
                    } else if (!ChatObject.isPublic(chat)) {
                        string = LocaleController.getString("MegaPrivate", C3286R.string.MegaPrivate);
                    } else {
                        string = LocaleController.getString("MegaPublic", C3286R.string.MegaPublic);
                    }
                ...
                if (i == PrivacyUsersActivity.this.blockUserDetailRow) {
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        ...
                        textInfoPrivacyCell.setText(LocaleController.getString("BlockedUsersInfo", C3286R.string.BlockedUsersInfo));
                    } else {
                    ...
                    if (PrivacyUsersActivity.this.usersStartRow == -1) {
                        ...
                        textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C3286R.C3288drawable.greydivider, "windowBackgroundGrayShadow"));
                    }
                ...
                if (i == PrivacyUsersActivity.this.usersHeaderRow) {
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        ...
                        headerCell.setText(LocaleController.getString("PrivacyExceptions", C3286R.string.PrivacyExceptions));
                    }
                }
            } else {
                ManageChatTextCell manageChatTextCell = (ManageChatTextCell) viewHolder.itemView;
                manageChatTextCell.setColors("windowBackgroundWhiteBlueIcon", "windowBackgroundWhiteBlueButton");
                if (!PrivacyUsersActivity.this.isWalletWhitelist) {
                    if (PrivacyUsersActivity.this.currentType != 1) {
                        manageChatTextCell.setText(LocaleController.getString("PrivacyAddAnException", C3286R.string.PrivacyAddAnException), null, C3286R.C3288drawable.msg_contact_add, PrivacyUsersActivity.this.uidArray.size() > 0);
                        return;
                    } else {
                        manageChatTextCell.setText(LocaleController.getString("BlockUser", C3286R.string.BlockUser), null, C3286R.C3288drawable.msg_contact_add, false);
                        return;
                    }
                }
                manageChatTextCell.setText(LocaleController.getString("EmpryUsersPlaceholder", C3286R.string.EmpryUsersPlaceholder), null, C3286R.C3288drawable.msg_contact_add, false);
            }
        }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda2
