...
public class GroupInviteActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("InviteLink", C3301R.string.InviteLink));
        this.actionBar.setActionBarMenuOnItemClick(new C3366ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.GroupInviteActivity.1
    ...
    public /* synthetic */ void lambda$createView$1(View view, int i) {
        ...
        if (i == this.copyLinkRow || i == this.linkRow) {
            ...
            try {
                ...
                getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C3301R.string.InviteToGroupByLink)), 500);
            } catch (Exception e2) {
                FileLog.m45e(e2);
            }
            ...
            builder.setPositiveButton(LocaleController.getString("RevokeButton", C3301R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupInviteActivity$$ExternalSyntheticLambda0
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.chatInfoDidLoad) {
            ...
            if (((TLRPC$ChatFull) objArr[0]).f1501id == this.chatId && intValue == this.classGuid) {
    ...
    public /* synthetic */ void lambda$generateLink$2(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, boolean z) {
        if (tLRPC$TL_error == null) {
            ...
            if (z) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setMessage(LocaleController.getString("RevokeAlertNewLink", C3301R.string.RevokeAlertNewLink));
                builder.setTitle(LocaleController.getString("RevokeLink", C3301R.string.RevokeLink));
                ...
                if (i != GroupInviteActivity.this.copyLinkRow) {
                    if (i != GroupInviteActivity.this.shareLinkRow) {
                        if (i == GroupInviteActivity.this.revokeLinkRow) {
                            textSettingsCell.setText(LocaleController.getString("RevokeLink", C3301R.string.RevokeLink), true);
                            return;
                        }
                        return;
                    }
                    textSettingsCell.setText(LocaleController.getString("ShareLink", C3301R.string.ShareLink), false);
                    return;
                }
                textSettingsCell.setText(LocaleController.getString("CopyLink", C3301R.string.CopyLink), true);
                ...
                if (i != GroupInviteActivity.this.shadowRow) {
                    if (i == GroupInviteActivity.this.linkInfoRow) {
                        ...
                        if (ChatObject.isChannel(chat) && !chat.megagroup) {
                            textInfoPrivacyCell.setText(LocaleController.getString("ChannelLinkInfo", C3301R.string.ChannelLinkInfo));
                        } else {
                            textInfoPrivacyCell.setText(LocaleController.getString("LinkInfo", C3301R.string.LinkInfo));
                        }
