...
import org.telegram.p048ui.SecretMediaViewer;
...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            this.afterDeleteProgressPaint.setStrokeWidth(AndroidUtilities.m50dp(2));
            Paint paint3 = new Paint(1);
            this.circlePaint = paint3;
            paint3.setColor(2130706432);
            this.drawable = context.getResources().getDrawable(C3316R.C3318drawable.flame_small);
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int measuredHeight = (getMeasuredHeight() / 2) - (AndroidUtilities.m50dp(28) / 2);
            this.deleteProgressRect.set(getMeasuredWidth() - AndroidUtilities.m50dp(49), measuredHeight, getMeasuredWidth() - AndroidUtilities.m50dp(21), measuredHeight + AndroidUtilities.m50dp(28));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawCircle(getMeasuredWidth() - AndroidUtilities.m50dp(35), getMeasuredHeight() / 2, AndroidUtilities.m50dp(16), this.circlePaint);
            float f = 1.0f;
            if (this.useVideoProgress) {
                if (SecretMediaViewer.this.videoPlayer != null) {
                    ...
                    if (duration != C0482C.TIME_UNSET && currentPosition != C0482C.TIME_UNSET) {
            ...
            int measuredWidth = getMeasuredWidth() - AndroidUtilities.m50dp(40);
            int measuredHeight = ((getMeasuredHeight() - AndroidUtilities.m50dp(14)) / 2) - AndroidUtilities.m51dp(0.5f);
            this.drawable.setBounds(measuredWidth, measuredHeight, AndroidUtilities.m50dp(10) + measuredWidth, AndroidUtilities.m50dp(14) + measuredHeight);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        } else if (i == NotificationCenter.updateMessageMedia && this.currentMessageObject.getId() == ((TLRPC$Message) objArr[0]).f1526id) {
            if (this.isVideo && !this.videoWatchedOneTime) {
                this.closeVideoAfterWatch = true;
            } else if (!closePhoto(true, true)) {
                this.closeAfterAnimation = true;
    ...
    public void preparePlayer(File file) {
        ...
        if (this.videoPlayer == null) {
            ...
            this.videoPlayer.setDelegate(new C64181(file));
        }
    ...
    /* loaded from: classes5.dex */
    public class C64181 implements VideoPlayer.VideoPlayerDelegate {
            ...
            if (SecretMediaViewer.this.playerRetryPlayCount > 0) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        SecretMediaViewer.C64181.this.lambda$onError$0(file);
                    }
                }, 100L);
                return;
            }
    ...
    public void setParentActivity(Activity activity) {
        ...
        FrameLayout frameLayout = new FrameLayout(activity) { // from class: org.telegram.ui.SecretMediaViewer.2
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, getMeasuredHeight(), getMeasuredWidth(), getMeasuredHeight() + windowInsets.getSystemWindowInsetBottom(), SecretMediaViewer.this.blackPaint);
            }
        };
        ...
        FrameLayoutDrawer frameLayoutDrawer = new FrameLayoutDrawer(activity) { // from class: org.telegram.ui.SecretMediaViewer.3
            ...
            protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                if (SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight = ((C3381ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
        ...
        C3381ActionBar c3381ActionBar = new C3381ActionBar(activity);
        this.actionBar = c3381ActionBar;
        c3381ActionBar.setTitleColor(-1);
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.SecretMediaViewer.4
    ...
    public void openMedia(MessageObject messageObject, PhotoViewer.PhotoViewerProvider photoViewerProvider, final Runnable runnable) {
        ...
        this.clipTop = f2;
        float f3 = abs;
        this.clipTop = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.max(f2, f3));
        ...
        this.clipBottom = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.max(height2, f3));
        this.clipTopOrigin = BitmapDescriptorFactory.HUE_RED;
        this.clipTopOrigin = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.max((float) BitmapDescriptorFactory.HUE_RED, f3));
        this.clipBottomOrigin = BitmapDescriptorFactory.HUE_RED;
        this.clipBottomOrigin = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.max((float) BitmapDescriptorFactory.HUE_RED, f3));
        ...
        if (document != null) {
            if (MessageObject.isGifDocument(document)) {
                this.actionBar.setTitle(LocaleController.getString("DisappearingGif", C3316R.string.DisappearingGif));
                ...
                this.actionBar.setTitle(LocaleController.getString("DisappearingVideo", C3316R.string.DisappearingVideo));
            ...
            i2 = 21;
            c = 4;
            this.actionBar.setTitle(LocaleController.getString("DisappearingPhoto", C3316R.string.DisappearingPhoto));
        ...
        animatorArr[1] = ObjectAnimator.ofFloat(this.secretDeleteTimer, View.ALPHA, BitmapDescriptorFactory.HUE_RED, 1.0f);
        ...
        animatorArr[3] = ObjectAnimator.ofFloat(this.secretDeleteTimer, View.ALPHA, BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    private void toggleActionBar(boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            fArr[0] = z ? 1.0f : 0.0f;
            arrayList.add(ObjectAnimator.ofFloat(c3381ActionBar, property, fArr));
            AnimatorSet animatorSet = new AnimatorSet();
    ...
    */
    public boolean closePhoto(boolean r19, boolean r20) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.SecretMediaViewer.closePhoto(boolean, boolean):boolean");
    }
    ...
    /* loaded from: classes5.dex */
    public class C64247 extends AnimatorListenerAdapter {
        final /* synthetic */ PhotoViewer.PlaceProviderObject val$object;

        C64247(PhotoViewer.PlaceProviderObject placeProviderObject) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$7$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SecretMediaViewer.C64247.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    */
    private void checkMinMax(boolean r6) {
        ...
        L2b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p048ui.SecretMediaViewer.checkMinMax(boolean):void");
    }
