...
public class SuggestUserPhotoView extends View {
    ...
    public SuggestUserPhotoView(Context context) {
        ...
        Drawable drawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_arrow_avatar);
    ...
    public void draw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - AndroidUtilities.m102dp(30);
        int m102dp = AndroidUtilities.m102dp(46) + measuredWidth;
        setImageCoords(this.currentPhoto, measuredWidth - AndroidUtilities.m102dp(46), measuredHeight);
        setImageCoords(this.newPhoto, m102dp, measuredHeight);
        ...
        this.path.reset();
        this.path.addCircle(m102dp, measuredHeight, AndroidUtilities.m102dp(30), Path.Direction.CW);
        ...
        if (this.containterView != null) {
            ...
            float m102dp2 = AndroidUtilities.m102dp(60) / cropAreaView.size;
            float f = left - cropAreaView.left;
            canvas.save();
            canvas.clipPath(this.path);
            canvas.scale(m102dp2, m102dp2, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED);
            canvas.translate(f, top - cropAreaView.top);
            canvas.translate((m102dp - AndroidUtilities.m102dp(30)) / m102dp2, (measuredHeight - AndroidUtilities.m102dp(30)) / m102dp2);
    ...
    private void setImageCoords(ImageReceiver imageReceiver, int i, int i2) {
        imageReceiver.setImageCoords(i - AndroidUtilities.m102dp(30), i2 - AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(60), AndroidUtilities.m102dp(60));
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        this.currentPhoto.setRoundRadius(AndroidUtilities.m102dp(30));
        this.newPhoto.setRoundRadius(AndroidUtilities.m102dp(30));
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(86), 1073741824));
    }
