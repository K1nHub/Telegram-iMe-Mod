...
public class CodeFieldContainer extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float m103dp = AndroidUtilities.m103dp(1.5f);
        this.strokeWidth = m103dp;
        paint.setStrokeWidth(m103dp);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt instanceof CodeNumberField) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), this.paint);
            }
        }
    ...
    */
    public void setNumbersCount(final int r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.CodeFieldContainer.setNumbersCount(int, int):void");
    }
    ...
    public String getCode() {
        ...
        while (true) {
            ...
            if (i < codeNumberFieldArr.length) {
                sb.append(C3545PhoneFormat.stripExceptNumbers(codeNumberFieldArr[i].getText().toString()));
                i++;
            } else {
                return sb.toString();
            }
