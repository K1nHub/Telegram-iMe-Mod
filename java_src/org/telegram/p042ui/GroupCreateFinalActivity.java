    ...
    */
    private void setDefaultGroupName() {
        ...
        L31:
            ...
            int r9 = org.telegram.messenger.C3630R.string.GroupCreateMembersFive     // Catch: java.lang.Exception -> Laa
        ...
        L58:
            ...
            int r4 = org.telegram.messenger.C3630R.string.GroupCreateMembersFour     // Catch: java.lang.Exception -> Laa
        ...
        L79:
            ...
            int r4 = org.telegram.messenger.C3630R.string.GroupCreateMembersThree     // Catch: java.lang.Exception -> Laa
        ...
        L94:
            ...
            int r4 = org.telegram.messenger.C3630R.string.GroupCreateMembersTwo     // Catch: java.lang.Exception -> Laa
        ...
        Lb9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.GroupCreateFinalActivity.setDefaultGroupName():void");
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("NewGroup", C3630R.string.NewGroup));
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.GroupCreateFinalActivity.1
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout2 = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.GroupCreateFinalActivity.2
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                if (measureKeyboardHeight() > AndroidUtilities.m102dp(20) && !GroupCreateFinalActivity.this.editText.isPopupShowing()) {
            ...
            */
            public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                /*
                    ...
                    if (r1 != 0) goto L26
                    org.telegram.ui.GroupCreateFinalActivity r1 = org.telegram.p042ui.GroupCreateFinalActivity.this
                    org.telegram.ui.Components.EditTextEmoji r1 = org.telegram.p042ui.GroupCreateFinalActivity.access$100(r1)
                ...
                L97:
                    int r4 = r7 - r4
                L99:
                    org.telegram.ui.GroupCreateFinalActivity r7 = org.telegram.p042ui.GroupCreateFinalActivity.this
                    org.telegram.ui.Components.EditTextEmoji r7 = org.telegram.p042ui.GroupCreateFinalActivity.access$100(r7)
                    if (r7 == 0) goto Lc6
                    org.telegram.ui.GroupCreateFinalActivity r7 = org.telegram.p042ui.GroupCreateFinalActivity.this
                    org.telegram.ui.Components.EditTextEmoji r7 = org.telegram.p042ui.GroupCreateFinalActivity.access$100(r7)
                ...
                Lcf:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.GroupCreateFinalActivity.C61742.onLayout(boolean, int, int, int, int):void");
            }
        ...
        this.shadowDrawable = context.getResources().getDrawable(C3630R.C3632drawable.greydivider_top).mutate();
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m102dp(this.chatType == 5 ? 16 : 32));
        this.avatarDrawable.setInfo(5L, null, null);
        this.avatarImage.setImageDrawable(this.avatarDrawable);
        this.avatarImage.setContentDescription(LocaleController.getString("ChoosePhoto", C3630R.string.ChoosePhoto));
        ...
        int i2 = C3630R.raw.camera;
        this.cameraDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m102dp(60), AndroidUtilities.m102dp(60), false, null);
        ...
        if (i3 == 0 || i3 == 4 || i3 == 5) {
            i = C3630R.string.EnterGroupNamePlaceholder;
            str = "EnterGroupNamePlaceholder";
        } else {
            i = C3630R.string.EnterListName;
            str = "EnterListName";
        }
        ...
        this.floatingButtonIcon.setImageResource(C3630R.C3632drawable.checkbig);
        this.floatingButtonIcon.setPadding(0, AndroidUtilities.m102dp(2), 0, 0);
    ...
    public class GroupCreateAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void notifyDataSetChanged() {
            ...
            if (GroupCreateFinalActivity.this.chatType == 5) {
                ...
                this.items.add(new InnerItem(this, 5, LocaleController.getString("ForumToggleDescription", C3630R.string.ForumToggleDescription)));
            } else {
                this.items.add(new InnerItem(this, 4));
                this.items.add(new InnerItem(this, 5, LocaleController.getString("GroupCreateAutodeleteDescription", C3630R.string.GroupCreateAutodeleteDescription)));
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(this.context, C3630R.C3632drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
                ...
                if (i == 1) {
                    ...
                    CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(this.context, GroupCreateFinalActivity.this.selectedContacts.size() == 0 ? C3630R.C3632drawable.greydivider_bottom : C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            ...
            switch (viewHolder.getItemViewType()) {
                case 1:
                    ...
                    if (GroupCreateFinalActivity.this.currentGroupCreateAddress == null || i != 1) {
                        ...
                        headerCell.setText(LocaleController.getString("AttachLocation", C3630R.string.AttachLocation));
                        return;
                    }
                case 2:
                ...
                case 4:
                    ...
                    if (GroupCreateFinalActivity.this.ttlPeriod != 0) {
                        ...
                        formatTTLString = LocaleController.getString("PasswordOff", C3630R.string.PasswordOff);
                    }
                    textCell.setTextAndValueAndIcon(LocaleController.getString("AutoDeleteMessages", C3630R.string.AutoDeleteMessages), formatTTLString, ((BaseFragment) GroupCreateFinalActivity.this).fragmentBeginToShow, C3630R.C3632drawable.msg_autodelete, false);
                    return;
                case 5:
                ...
                case 6:
                    ...
                    textCell2.setTextAndCheckAndIcon(LocaleController.getString("ChannelTopics", C3630R.string.ChannelTopics), true, C3630R.C3632drawable.msg_topics, false);
