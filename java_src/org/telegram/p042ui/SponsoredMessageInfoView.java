...
public class SponsoredMessageInfoView extends FrameLayout {
    public SponsoredMessageInfoView(final Activity activity, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setText(LocaleController.getString("SponsoredMessageInfo", C3630R.string.SponsoredMessageInfo));
        ...
        linksTextView.setLineSpacing(AndroidUtilities.m102dp(2), 1.0f);
        ...
        linksTextView2.setLineSpacing(AndroidUtilities.m102dp(2), 1.0f);
        ...
        linksTextView3.setLineSpacing(AndroidUtilities.m102dp(2), 1.0f);
        final Paint paint = new Paint(1);
        paint.setStyle(Paint.Style.STROKE);
        int i2 = Theme.key_featuredStickers_addButton;
        paint.setColor(Theme.getColor(i2, resourcesProvider));
        paint.setStrokeWidth(AndroidUtilities.m102dp(1));
        TextView textView2 = new TextView(this, activity) { // from class: org.telegram.ui.SponsoredMessageInfoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                rectF.set(AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), getMeasuredWidth() - AndroidUtilities.m102dp(1), getMeasuredHeight() - AndroidUtilities.m102dp(1));
                canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), paint);
            }
        };
        textView2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.SponsoredMessageInfoView.2
            ...
            public void onClick(View view) {
                Browser.openUrl(activity, LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", C3630R.string.SponsoredMessageAlertLearnMoreUrl));
            }
        });
        textView2.setPadding(AndroidUtilities.m102dp(12), 0, AndroidUtilities.m102dp(12), 0);
        textView2.setText(LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", C3630R.string.SponsoredMessageAlertLearnMoreUrl));
        ...
        linksTextView4.setLineSpacing(AndroidUtilities.m102dp(2), 1.0f);
        linksTextView4.setTextColor(Theme.getColor(i, resourcesProvider));
        linksTextView4.setTextSize(1, 14.0f);
        textView.setPadding(AndroidUtilities.m102dp(22), 0, AndroidUtilities.m102dp(22), 0);
        linearLayout.addView(textView);
        linksTextView.setPadding(AndroidUtilities.m102dp(22), 0, AndroidUtilities.m102dp(22), 0);
        linearLayout.addView(linksTextView, LayoutHelper.createLinear(-1, -2, 0, 0, 18, 0, 0));
        linksTextView2.setPadding(AndroidUtilities.m102dp(22), 0, AndroidUtilities.m102dp(22), 0);
        linearLayout.addView(linksTextView2, LayoutHelper.createLinear(-1, -2, 0, 0, 24, 0, 0));
        linksTextView3.setPadding(AndroidUtilities.m102dp(22), 0, AndroidUtilities.m102dp(22), 0);
        ...
        linksTextView4.setPadding(AndroidUtilities.m102dp(22), 0, AndroidUtilities.m102dp(22), 0);
