...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C3630R.raw.download_progress, "download_progress", AndroidUtilities.m102dp(28), AndroidUtilities.m102dp(28), true, null);
        ...
        RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C3630R.raw.download_finish, "download_finish", AndroidUtilities.m102dp(28), AndroidUtilities.m102dp(28), true, null);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float m103dp = AndroidUtilities.m103dp(1.0f);
        float m102dp = AndroidUtilities.m102dp(16);
        RectF rectF = AndroidUtilities.rectTmp;
        float measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m102dp(8);
        float f5 = measuredHeight - m103dp;
        float f6 = measuredHeight + m103dp;
        rectF.set(m102dp, f5, getMeasuredWidth() - m102dp, f6);
        canvas.drawRoundRect(rectF, m103dp, m103dp, this.paint2);
        rectF.set(m102dp, f5, ((getMeasuredWidth() - (2.0f * m102dp)) * this.currentProgress) + m102dp, f6);
        canvas.drawRoundRect(rectF, m103dp, m103dp, this.paint);
        canvas.save();
