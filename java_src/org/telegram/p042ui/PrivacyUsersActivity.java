...
public class PrivacyUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ContactsActivity.ContactsActivityDelegate {
    ...
    public View createView(Context context) {
        ...
        if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("BlockedUsers", C3630R.string.BlockedUsers));
        } else if (i == 2) {
            ...
            if (this.isAlwaysShare) {
                this.actionBar.setTitle(LocaleController.getString("AlwaysAllow", C3630R.string.AlwaysAllow));
            } else {
                this.actionBar.setTitle(LocaleController.getString("NeverAllow", C3630R.string.NeverAllow));
            }
        } else if (this.isAlwaysShare) {
            this.actionBar.setTitle(LocaleController.getString("AlwaysShareWithTitle", C3630R.string.AlwaysShareWithTitle));
        } else {
            this.actionBar.setTitle(LocaleController.getString("NeverShareWithTitle", C3630R.string.NeverShareWithTitle));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PrivacyUsersActivity.1
        ...
        if (this.currentType == 1) {
            emptyTextProgressView.setText(LocaleController.getString("NoBlocked", C3630R.string.NoBlocked));
        } else {
            emptyTextProgressView.setText(LocaleController.getString("NoContacts", C3630R.string.NoContacts));
        }
    ...
    public /* synthetic */ void lambda$createView$3(View view, int i) {
        if (i == this.deleteAllRow) {
            AlertDialog create = AlertsCreator.createSimpleAlert(getContext(), LocaleController.getString(C3630R.string.NotificationsDeleteAllExceptionTitle), LocaleController.getString(C3630R.string.NotificationsDeleteAllExceptionAlert), LocaleController.getString(C3630R.string.Delete), new Runnable() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda0
    ...
    public void showUnblockAlert(final Long l, View view) {
        ...
        int i = this.currentType;
        addIf.addIf(i != 1, i == 0 ? C3630R.C3632drawable.msg_user_remove : 0, (CharSequence) LocaleController.getString("Remove", C3630R.string.Remove), true, new Runnable() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                textCell.setText(LocaleController.getString("NotificationsDeleteAllException", C3630R.string.NotificationsDeleteAllException), false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (keyAt > 0) {
                    ...
                    if (user == null) {
                        manageChatUserCell.setData(Long.valueOf(keyAt), LocaleController.formatStringInternal(C3630R.string.common_id, Long.valueOf(keyAt)), LocaleController.getString("NumberUnknown", C3630R.string.NumberUnknown), i != PrivacyUsersActivity.this.usersEndRow - 1);
                        return;
                    }
                    if (user.bot) {
                        StringBuilder sb = new StringBuilder();
                        int i2 = C3630R.string.Bot;
                        ...
                        if (str != null && str.length() != 0) {
                            ...
                            string2 = c3545PhoneFormat.format("+" + user.phone);
                        } else {
                            string2 = LocaleController.getString("NumberUnknown", C3630R.string.NumberUnknown);
                        }
                    }
                ...
                if (chat != null) {
                    ...
                    if (i3 != 0) {
                        ...
                        string = LocaleController.getString("MegaLocation", C3630R.string.MegaLocation);
                    } else if (!ChatObject.isPublic(chat)) {
                        string = LocaleController.getString("MegaPrivate", C3630R.string.MegaPrivate);
                    } else {
                        string = LocaleController.getString("MegaPublic", C3630R.string.MegaPublic);
                    }
                ...
                if (i == PrivacyUsersActivity.this.blockUserDetailRow) {
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        ...
                        textInfoPrivacyCell.setText(LocaleController.getString("BlockedUsersInfo", C3630R.string.BlockedUsersInfo));
                    } else {
                ...
                if (i == PrivacyUsersActivity.this.usersHeaderRow) {
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        ...
                        headerCell.setText(LocaleController.getString("PrivacyExceptions", C3630R.string.PrivacyExceptions));
                    }
                }
            } else {
                ...
                if (!PrivacyUsersActivity.this.isWalletWhitelist) {
                    if (PrivacyUsersActivity.this.currentType != 1) {
                        manageChatTextCell.setText(LocaleController.getString("PrivacyAddAnException", C3630R.string.PrivacyAddAnException), null, C3630R.C3632drawable.msg_contact_add, PrivacyUsersActivity.this.uidArray.size() > 0);
                        return;
                    } else {
                        manageChatTextCell.setText(LocaleController.getString("BlockUser", C3630R.string.BlockUser), null, C3630R.C3632drawable.msg_contact_add, false);
                        return;
                    }
                }
                manageChatTextCell.setText(LocaleController.getString("EmpryUsersPlaceholder", C3630R.string.EmpryUsersPlaceholder), null, C3630R.C3632drawable.msg_contact_add, false);
            }
        }
