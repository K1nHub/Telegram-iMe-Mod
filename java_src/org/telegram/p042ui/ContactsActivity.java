...
import org.telegram.p042ui.Adapters.ContactsAdapter;
import org.telegram.p042ui.Adapters.SearchAdapter;
...
public class ContactsActivity extends JavaMvpFragment implements NotificationCenter.NotificationCenterDelegate, ContactsView, WalletSendRecipientView {
    ...
    public void onSelectedQtyChange(int i) {
        ...
        C3702ActionBar c3702ActionBar = this.actionBar;
        if (c3702ActionBar == null || !c3702ActionBar.isActionModeShowed() || (numberTextView = this.selectedContactsCount) == null) {
            return;
        }
    ...
    public void showRequestPermissionSuccessDialog(String str, String str2, Callbacks$Callback callbacks$Callback) {
        DialogsFactoryKt.showSuccessAlert(this, str, str2, this.resourceManager.getValue().getString(C3630R.string.common_ok), callbacks$Callback);
    }
    ...
    public void processSwitchCheckedUserCell(UserCell userCell) {
        if (userCell.getCurrentObject() instanceof TLRPC$User) {
            long j = ((TLRPC$User) userCell.getCurrentObject()).f1762id;
    ...
    private void createActionMode() {
        ...
        createActionMode.addItemWithWidth(IdFabric$Menu.DELETE, C3630R.C3632drawable.msg_delete, AndroidUtilities.m102dp(54));
    }
    ...
    public void openDeleteContactsDialog(final Runnable runnable) {
        ...
        AlertsCreator.showConfirmationDialog(this, getParentActivity(), LocaleController.getString("SyncContactsDeleteTitle", C3630R.string.SyncContactsDeleteTitle), AndroidUtilities.replaceTags(LocaleController.getString("SyncContactsDeleteText", C3630R.string.SyncContactsDeleteText)), LocaleController.getString("Delete", C3630R.string.Delete), true, getResourceProvider(), new Callbacks$Callback1() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda9
    ...
    private void sendInvitationToChat(long j) {
        SendMessagesHelper.prepareSendingMedia(getAccountInstance(), this.transferRecipientPresenter.getSendingMediaInfo(), j, null, null, null, false, true, null, true, 0, false, null, null);
    }
    ...
    */
    public android.view.View createView(android.content.Context r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ContactsActivity.createView(android.content.Context):android.view.View");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.ContactsActivity$2 */
    /* loaded from: classes5.dex */
    public class C58492 extends C3702ActionBar.ActionBarMenuOnItemClick {
        C58492() {
        }
        ...
        public void onItemClick(int i) {
            if (i == -1 && ((BaseFragment) ContactsActivity.this).actionBar != null && ((BaseFragment) ContactsActivity.this).actionBar.isActionModeShowed()) {
                ...
                ContactsActivity.this.openDeleteContactsDialog(new Runnable() { // from class: org.telegram.ui.ContactsActivity$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ContactsActivity.C58492.this.lambda$onItemClick$0();
                    }
                });
            } else if (i == -1) {
                ...
                if (i == 1) {
                    ...
                    ContactsActivity.this.sortItem.setIcon(ContactsActivity.this.sortByName ? C3630R.C3632drawable.msg_contacts_time : C3630R.C3632drawable.msg_contacts_name);
                }
            }
        }
    ...
    public /* synthetic */ void lambda$createView$9(int i, View view, int i2, float f, float f2) {
        ...
        if (adapter == searchAdapter) {
            ...
            if (item instanceof TLRPC$User) {
                ...
                if (this.returnAsResult) {
                    ...
                    if (longSparseArray == null || longSparseArray.indexOfKey(tLRPC$User.f1762id) < 0) {
                        didSelectResult(tLRPC$User, true, null);
                        return;
                    }
                    return;
                } else if (this.createSecretChat) {
                    if (tLRPC$User.f1762id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                        return;
                    }
        ...
        if (z2 && this.needPhonebook && (c3702ActionBar = this.actionBar) != null && c3702ActionBar.isActionModeShowed()) {
            ...
            if (item2 instanceof TLRPC$User) {
                ...
                if (this.returnAsResult) {
                    ...
                    if (longSparseArray2 == null || longSparseArray2.indexOfKey(tLRPC$User2.f1762id) < 0) {
                    ...
                    bundle4.putLong("user_id", tLRPC$User2.f1762id);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setMessage(LocaleController.getString("InviteUser", C3630R.string.InviteUser));
                builder.setTitle(LocaleController.getString("AppName", C3630R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("OK", C3630R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda4
                    @Override // android.content.DialogInterface.OnClickListener
    ...
    /* loaded from: classes5.dex */
    public class C58558 implements RecyclerListView.OnItemLongClickListener {
        C58558() {
        }
        ...
        public boolean onItemClick(View view, int i) {
            ...
            if (ContactsActivity.this.listViewAdapter.hasStories && sectionForPosition == 1 && (view instanceof UserCell)) {
                ...
                ItemOptions addIf = ItemOptions.makeOptions(ContactsActivity.this, view).setScrimViewBackground(Theme.createRoundRectDrawable(0, 0, Theme.getColor(Theme.key_windowBackgroundWhite))).add(C3630R.C3632drawable.msg_discussion, LocaleController.getString("SendMessage", C3630R.string.SendMessage), new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ContactsActivity.C58558.this.lambda$onItemClick$0(dialogId);
                    }
                }).add(C3630R.C3632drawable.msg_openprofile, LocaleController.getString("OpenProfile", C3630R.string.OpenProfile), new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ContactsActivity.C58558.this.lambda$onItemClick$1(dialogId);
                    }
                }).addIf(!z, C3630R.C3632drawable.msg_mute, LocaleController.getString("NotificationsStoryMute", C3630R.string.NotificationsStoryMute), new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        ContactsActivity.C58558.this.lambda$onItemClick$2(sharedPrefKey, dialogId, user);
                    }
                }).addIf(z, C3630R.C3632drawable.msg_unmute, LocaleController.getString("NotificationsStoryUnmute", C3630R.string.NotificationsStoryUnmute), new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        ContactsActivity.C58558.this.lambda$onItemClick$3(sharedPrefKey, dialogId, user);
                    }
                });
                addIf.add(C3630R.C3632drawable.msg_viewintopic, LocaleController.getString("ShowInChats", C3630R.string.ShowInChats), new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        ContactsActivity.C58558.this.lambda$onItemClick$6(dialogId, user);
                    }
                });
        ...
        public /* synthetic */ void lambda$onItemClick$0(long j) {
            ContactsActivity.this.presentFragment(ChatActivity.m64of(j));
        }
        ...
        public /* synthetic */ void lambda$onItemClick$2(String str, long j, TLRPC$User tLRPC$User) {
            ...
            BulletinFactory.m61of(ContactsActivity.this).createUsersBulletin(Arrays.asList(tLRPC$User), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", C3630R.string.NotificationsStoryMutedHint, trim))).show();
        }
        ...
        public /* synthetic */ void lambda$onItemClick$3(String str, long j, TLRPC$User tLRPC$User) {
            ...
            BulletinFactory.m61of(ContactsActivity.this).createUsersBulletin(Arrays.asList(tLRPC$User), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", C3630R.string.NotificationsStoryUnmutedHint, trim))).show();
        }
        ...
        public /* synthetic */ void lambda$onItemClick$6(final long j, TLRPC$User tLRPC$User) {
            ...
            undoObject.onUndo = new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    ContactsActivity.C58558.this.lambda$onItemClick$4(j);
                }
            };
            undoObject.onAction = new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ContactsActivity.C58558.this.lambda$onItemClick$5(j);
                }
            };
            BulletinFactory.global().createUsersBulletin(Arrays.asList(tLRPC$User), AndroidUtilities.replaceTags(LocaleController.formatString("StoriesMovedToDialogs", C3630R.string.StoriesMovedToDialogs, ContactsController.formatName(tLRPC$User.first_name, null, 20))), null, undoObject).show();
        }
    ...
    public C3702ActionBar createActionBar(Context context) {
        C3702ActionBar createActionBar = super.createActionBar(context);
        ...
        if (z && this.selectAlertString != null) {
            ...
            if (tLRPC$User.bot) {
                if (tLRPC$User.bot_nochats) {
                    try {
                        BulletinFactory.m61of(this).createErrorBulletin(LocaleController.getString("BotCantJoinGroups", C3630R.string.BotCantJoinGroups)).show();
                        return;
                    } catch (Exception e) {
                        FileLog.m97e(e);
                        return;
                    ...
                    if (ChatObject.canAddAdmins(chat)) {
                        builder.setTitle(LocaleController.getString("AddBotAdminAlert", C3630R.string.AddBotAdminAlert));
                        builder.setMessage(LocaleController.getString("AddBotAsAdmin", C3630R.string.AddBotAsAdmin));
                        builder.setPositiveButton(LocaleController.getString("AddAsAdmin", C3630R.string.AddAsAdmin), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda6
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        builder.setMessage(LocaleController.getString("CantAddBotAsAdmin", C3630R.string.CantAddBotAsAdmin));
            ...
            if (tLRPC$User.bot || !this.needForwardCount) {
                ...
                formatStringSimple = String.format("%s\n\n%s", formatStringSimple, LocaleController.getString("AddToTheGroupForwardCount", C3630R.string.AddToTheGroupForwardCount));
            ...
            builder2.setPositiveButton(LocaleController.getString("OK", C3630R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda5
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            validateAndGoNext(String.valueOf(tLRPC$User.f1762id), true);
        } else {
        ...
        if (frameLayout != null) {
            frameLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: org.telegram.ui.ContactsActivity.13
                ...
                public void onGlobalLayout() {
                    ContactsActivity.this.floatingButtonContainer.setTranslationY(ContactsActivity.this.floatingHidden ? AndroidUtilities.m102dp(100) : 0);
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        if (i == 34) {
            ...
            builder.setNegativeButton(LocaleController.getString("PermissionOpenSettings", C3630R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda3
                @Override // android.content.DialogInterface.OnClickListener
    ...
    public void hideFloatingButton(boolean z) {
        ...
        fArr[0] = this.floatingHidden ? AndroidUtilities.m102dp(100) : 0;
    ...
    public AnimatorSet onCustomTransitionAnimation(final boolean z, final Runnable runnable) {
        ...
        if (this.floatingButtonContainer == null || view == null || floatingButton.getVisibility() != 0 || Math.abs(view.getTranslationY()) > AndroidUtilities.m102dp(4) || Math.abs(this.floatingButtonContainer.getTranslationY()) > AndroidUtilities.m102dp(4) || dialogsActivity.isFabAnimationsDisabled()) {
            if (checkCurrentFab) {
                this.floatingButton.setAnimation(C3630R.raw.write_contacts_fab_icon_camera, 56, 56);
            } else {
                this.floatingButton.setAnimation(C3630R.raw.write_contacts_fab_icon, 52, 52);
            }
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ContactsActivity.16
            ...
            public void onAnimationEnd(Animator animator) {
                if (ContactsActivity.this.floatingButtonContainer != null) {
                    ...
                    if (!z) {
                        if (checkCurrentFab) {
                            floatingButton.setAnimation(C3630R.raw.write_contacts_fab_icon_reverse_camera, 56, 56);
                        } else {
                            floatingButton.setAnimation(C3630R.raw.write_contacts_fab_icon_reverse, 52, 52);
                        }
    ...
    public static /* synthetic */ void lambda$onCustomTransitionAnimation$16(ValueAnimator valueAnimator, ViewGroup viewGroup, ValueAnimator valueAnimator2) {
        ...
        viewGroup.setTranslationX(AndroidUtilities.m102dp(48) * floatValue);
    ...
    public /* synthetic */ void lambda$onCustomTransitionAnimation$17(AnimatorSet animatorSet, boolean z, boolean z2, final View view) {
        ...
        if (z) {
            ...
            this.floatingButton.setAnimation(C3630R.raw.write_contacts_fab_icon_reverse_camera, 56, 56);
        } else {
            this.floatingButton.setAnimation(C3630R.raw.write_contacts_fab_icon_reverse, 52, 52);
        }
