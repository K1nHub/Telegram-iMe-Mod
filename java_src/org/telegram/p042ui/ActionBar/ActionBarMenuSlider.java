...
public class ActionBarMenuSlider extends FrameLayout {
    ...
    public void setDrawShadow(boolean z) {
        this.drawShadow = z;
        int m102dp = z ? AndroidUtilities.m102dp(8) : 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawShadow) {
            canvas.drawRoundRect(rectF, AndroidUtilities.m103dp(this.roundRadiusDp), AndroidUtilities.m103dp(this.roundRadiusDp), this.shadowPaint);
        }
        if (this.drawBlur) {
            ...
            if (f < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m103dp(this.roundRadiusDp), AndroidUtilities.m103dp(this.roundRadiusDp), this.pseudoBlurPaint);
            }
            if (this.blurBitmap != null && this.value < 1.0f && f > BitmapDescriptorFactory.HUE_RED) {
                this.blurPaint.setAlpha((int) (f * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.m103dp(this.roundRadiusDp), AndroidUtilities.m103dp(this.roundRadiusDp), this.blurPaint);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.m103dp(this.roundRadiusDp), AndroidUtilities.m103dp(this.roundRadiusDp), this.brightenBlurPaint);
            canvas.drawRoundRect(rectF, AndroidUtilities.m103dp(this.roundRadiusDp), AndroidUtilities.m103dp(this.roundRadiusDp), this.darkenBlurPaint);
            this.fillPaint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.m103dp(this.roundRadiusDp), AndroidUtilities.m103dp(this.roundRadiusDp), this.backgroundPaint);
        }
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.m103dp(this.roundRadiusDp), AndroidUtilities.m103dp(this.roundRadiusDp), this.fillPaint);
        if (!this.backgroundDark) {
    ...
    private void drawText(Canvas canvas, boolean z) {
        ...
        this.textDrawable.setBounds(getPaddingLeft() + AndroidUtilities.m102dp(20), getMeasuredHeight() / 2, (getMeasuredWidth() - getPaddingRight()) - AndroidUtilities.m102dp(20), getMeasuredHeight() / 2);
    ...
    private Pair<Integer, Integer> getBitmapGradientColors(Bitmap bitmap) {
        ...
        float currentActionBarHeight = ((this.location[1] - AndroidUtilities.statusBarHeight) - C3702ActionBar.getCurrentActionBarHeight()) / AndroidUtilities.displaySize.y;
    ...
    public static class SpeedSlider extends ActionBarMenuSlider {
        ...
        public SpeedSlider(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            FloatSeekBarAccessibilityDelegate floatSeekBarAccessibilityDelegate = new FloatSeekBarAccessibilityDelegate(false) { // from class: org.telegram.ui.ActionBar.ActionBarMenuSlider.SpeedSlider.1
                ...
                public CharSequence getContentDescription(View view) {
                    return SpeedIconDrawable.formatNumber(SpeedSlider.this.getSpeed()) + "x  " + LocaleController.getString("AccDescrSpeedSlider", C3630R.string.AccDescrSpeedSlider);
                }
            };
        ...
        @Override // org.telegram.p042ui.ActionBar.ActionBarMenuSlider
        protected String getStringValue(float f) {
