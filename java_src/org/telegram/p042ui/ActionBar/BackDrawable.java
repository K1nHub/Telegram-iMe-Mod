...
public class BackDrawable extends Drawable {
    ...
    public BackDrawable(boolean z) {
        ...
        this.prevPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
    ...
    public void draw(Canvas canvas) {
        ...
        float f3 = 1.0f - f2;
        canvas.drawLine(AndroidUtilities.m103dp(AndroidUtilities.lerp(-6.75f, -8.0f, f2)), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(8) - ((this.paint.getStrokeWidth() / 2.0f) * f3), BitmapDescriptorFactory.HUE_RED, this.paint);
        float m103dp = AndroidUtilities.m103dp(-0.25f);
        float m103dp2 = AndroidUtilities.m103dp(AndroidUtilities.lerp(7.0f, 8.0f, f2)) - ((this.paint.getStrokeWidth() / 4.0f) * f3);
        float m103dp3 = AndroidUtilities.m103dp(AndroidUtilities.lerp(-7.25f, (float) BitmapDescriptorFactory.HUE_RED, f2));
        canvas.drawLine(m103dp3, -m103dp, BitmapDescriptorFactory.HUE_RED, -m103dp2, this.paint);
        canvas.drawLine(m103dp3, m103dp, BitmapDescriptorFactory.HUE_RED, m103dp2, this.paint);
        canvas.restore();
    }
