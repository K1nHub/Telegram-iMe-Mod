...
public class SimpleTextView extends View {
    ...
    public SimpleTextView(Context context) {
        ...
        this.drawablePadding = AndroidUtilities.m102dp(4);
    ...
    public void setTextSize(int i) {
        float m102dp = AndroidUtilities.m102dp(i);
        if (m102dp == this.textPaint.getTextSize()) {
            return;
        }
        this.textPaint.setTextSize(m102dp);
    ...
    private void updateFadePaints() {
        if ((this.fadePaint == null || this.fadePaintBack == null) && this.scrollNonFitText) {
            ...
            paint.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(6), (float) BitmapDescriptorFactory.HUE_RED, new int[]{-1, 0}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP));
            this.fadePaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
            Paint paint2 = new Paint();
            this.fadePaintBack = paint2;
            paint2.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(6), (float) BitmapDescriptorFactory.HUE_RED, new int[]{0, -1}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP));
            this.fadePaintBack.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        }
        Boolean bool = this.forceEllipsizeByGradientLeft;
        boolean booleanValue = bool != null ? bool.booleanValue() : false;
        if (!(this.fadeEllpsizePaint != null && this.fadeEllpsizePaintWidth == AndroidUtilities.m102dp(this.ellipsizeByGradientWidthDp) && this.ellipsizeByGradientLeft == booleanValue) && this.ellipsizeByGradient) {
            ...
            if (booleanValue) {
                ...
                int m102dp = AndroidUtilities.m102dp(this.ellipsizeByGradientWidthDp);
                this.fadeEllpsizePaintWidth = m102dp;
                paint3.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, m102dp, (float) BitmapDescriptorFactory.HUE_RED, new int[]{-1, 0}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP));
            } else {
                Paint paint4 = this.fadeEllpsizePaint;
                int m102dp2 = AndroidUtilities.m102dp(this.ellipsizeByGradientWidthDp);
                this.fadeEllpsizePaintWidth = m102dp2;
                paint4.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, m102dp2, (float) BitmapDescriptorFactory.HUE_RED, new int[]{0, -1}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP));
            }
    ...
    private void calcOffset(int i) {
        ...
        if (layout.getLineCount() > 0) {
            ...
            if ((i2 & 7) == 1) {
                ...
                this.offsetX = -AndroidUtilities.m102dp(8);
            }
                ...
                if (this.buildFullLayout) {
                    ...
                    if (!this.ellipsizeByGradient && !ellipsize.equals(spannableStringBuilder)) {
                        ...
                        if (createStaticLayout != null) {
                            ...
                            this.firstLineLayout = new StaticLayout(ellipsize, 0, ellipsize.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m102dp(2000) : AndroidUtilities.m102dp(8) + i5, getAlignment(), 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                            StaticLayout staticLayout = new StaticLayout(subSequence, 0, subSequence.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m102dp(2000) : AndroidUtilities.m102dp(8) + i5, getAlignment(), 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                            ...
                            this.partLayout = new StaticLayout(charSequence2, 0, charSequence2.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m102dp(2000) : AndroidUtilities.m102dp(8) + i5, getAlignment(), 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                            this.fullLayout = StaticLayoutEx.createStaticLayout(valueOf2, 0, valueOf2.length(), this.textPaint, AndroidUtilities.m102dp(8) + i5 + this.fullLayoutAdditionalWidth, getAlignment(), 1.0f, BitmapDescriptorFactory.HUE_RED, false, TextUtils.TruncateAt.END, i5 + this.fullLayoutAdditionalWidth, this.fullTextMaxLines, false);
                        }
                    } else {
                        int length = ellipsize.length();
                        TextPaint textPaint = this.textPaint;
                        if (!this.scrollNonFitText && !this.ellipsizeByGradient) {
                            m102dp2 = AndroidUtilities.m102dp(8) + i5;
                            this.layout = new StaticLayout(ellipsize, 0, length, textPaint, m102dp2, getAlignment(), 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                            this.fullLayout = null;
                            this.partLayout = null;
                            this.firstLineLayout = null;
                        }
                        m102dp2 = AndroidUtilities.m102dp(2000);
                        this.layout = new StaticLayout(ellipsize, 0, length, textPaint, m102dp2, getAlignment(), 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                        this.fullLayout = null;
                        this.partLayout = null;
                        this.firstLineLayout = null;
                    ...
                    if (!this.scrollNonFitText && !this.ellipsizeByGradient) {
                        m102dp = AndroidUtilities.m102dp(8) + i5;
                        this.layout = new StaticLayout(charSequence4, 0, length2, textPaint2, m102dp, getAlignment(), 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                    }
                    m102dp = AndroidUtilities.m102dp(2000);
                    this.layout = new StaticLayout(charSequence4, 0, length2, textPaint2, m102dp, getAlignment(), 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int m102dp = this.totalWidth + AndroidUtilities.m102dp(16);
        float f2 = this.scrollingOffset;
        if (f2 != BitmapDescriptorFactory.HUE_RED) {
            if (this.leftDrawable != null) {
                int i20 = ((int) (-f2)) + m102dp;
                if ((this.gravity & 112) == 16) {
            ...
            if (this.rightDrawable != null && !this.rightDrawableOutside) {
                ...
                int i22 = this.textWidth + i16 + this.drawablePadding + ((int) (-this.scrollingOffset)) + m102dp;
                if ((this.gravity & 112) == 16) {
        ...
        if (this.layout != null) {
            if (this.rightDrawableOutside || this.ellipsizeByGradient || this.paddingRight > 0) {
                ...
                canvas.clipRect(0, 0, maxTextWidth - AndroidUtilities.m102dp((drawable7 == null || (drawable7 instanceof AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable) || !this.rightDrawableOutside) ? 0 : 2), getMeasuredHeight());
            }
            ...
            if (this.partLayout != null && this.fullAlpha < 1.0f) {
                ...
                if (this.partLayout.getText().length() == 1) {
                    f = this.fullTextMaxLines == 1 ? AndroidUtilities.m103dp(0.5f) : AndroidUtilities.m102dp(4);
                } else {
                    f = 0.0f;
                }
            ...
            if (z) {
                if (this.scrollingOffset < AndroidUtilities.m102dp(10)) {
                    this.fadePaint.setAlpha((int) ((this.scrollingOffset / AndroidUtilities.m102dp(10)) * 255.0f));
                } else if (this.scrollingOffset > (this.totalWidth + AndroidUtilities.m102dp(16)) - AndroidUtilities.m102dp(10)) {
                    this.fadePaint.setAlpha((int) ((1.0f - ((this.scrollingOffset - ((this.totalWidth + AndroidUtilities.m102dp(16)) - AndroidUtilities.m102dp(10))) / AndroidUtilities.m102dp(10))) * 255.0f));
                } else {
                    this.fadePaint.setAlpha(255);
                }
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(6), getMeasuredHeight(), this.fadePaint);
                canvas.save();
                canvas.translate((getMaxTextWidth() - this.paddingRight) - AndroidUtilities.m102dp(6), BitmapDescriptorFactory.HUE_RED);
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(6), getMeasuredHeight(), this.fadePaintBack);
                canvas.restore();
                ...
                if (!this.ellipsizeByGradientLeft) {
                    ...
                    canvas.translate(maxTextWidth2 - AndroidUtilities.m102dp((drawable8 == null || (drawable8 instanceof AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable) || !this.rightDrawableOutside) ? 0 : 2), BitmapDescriptorFactory.HUE_RED);
                }
        ...
        int min = Math.min(i27 + (f6 == BitmapDescriptorFactory.HUE_RED ? -m102dp : (int) (-f6)) + m102dp, (getMaxTextWidth() - this.paddingRight) + this.drawablePadding);
        ...
        if (this.scrollNonFitText) {
            if (this.textDoesNotFit || this.scrollingOffset != BitmapDescriptorFactory.HUE_RED) {
                ...
                if (i > 0) {
                    ...
                    int m102dp = this.totalWidth + AndroidUtilities.m102dp(16);
                    float f = 50.0f;
                    if (this.scrollingOffset < AndroidUtilities.m102dp(100)) {
                        f = ((this.scrollingOffset / AndroidUtilities.m102dp(100)) * 20.0f) + 30.0f;
                    } else if (this.scrollingOffset >= m102dp - AndroidUtilities.m102dp(100)) {
                        f = 50.0f - (((this.scrollingOffset - (m102dp - AndroidUtilities.m102dp(100))) / AndroidUtilities.m102dp(100)) * 20.0f);
                    }
                    float m103dp = this.scrollingOffset + ((((float) j) / 1000.0f) * AndroidUtilities.m103dp(f));
                    this.scrollingOffset = m103dp;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.rightDrawableOnClickListener != null && this.rightDrawable != null) {
            ...
            rectF.set(this.rightDrawableX - AndroidUtilities.m102dp(16), this.rightDrawableY - AndroidUtilities.m102dp(16), this.rightDrawableX + AndroidUtilities.m102dp(16), this.rightDrawableY + AndroidUtilities.m102dp(16));
