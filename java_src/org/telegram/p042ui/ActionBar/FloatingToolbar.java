...
import org.telegram.p042ui.ActionBar.FloatingToolbar;
...
public final class FloatingToolbar {
    ...
    private static final List<Integer> premiumOptions = Arrays.asList(Integer.valueOf(C3630R.C3633id.menu_bold), Integer.valueOf(C3630R.C3633id.menu_italic), Integer.valueOf(C3630R.C3633id.menu_strike), Integer.valueOf(C3630R.C3633id.menu_link), Integer.valueOf(C3630R.C3633id.menu_mono), Integer.valueOf(C3630R.C3633id.menu_underline), Integer.valueOf(C3630R.C3633id.menu_spoiler));
    ...
    private List<MenuItem> getVisibleAndEnabledMenuItems(Menu menu) {
        ...
        for (int i = 0; menu != null && i < menu.size(); i++) {
            ...
            if (item.isVisible() && item.isEnabled()) {
                ...
                } else if (item.getItemId() != 16908353 && (item.getItemId() != C3630R.C3633id.menu_regular || this.premiumLockClickListener == null)) {
                    arrayList.add(item);
                }
            }
        }
    ...
    public final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View view) {
            ...
            this.mMarginHorizontal = AndroidUtilities.m102dp(16);
            this.mMarginVertical = AndroidUtilities.m102dp(8);
            this.mLineHeight = AndroidUtilities.m102dp(48);
            int m102dp = AndroidUtilities.m102dp(8);
            this.mIconTextSpacing = m102dp;
            ...
            Drawable mutate = context.getDrawable(C3630R.C3632drawable.ft_avd_tooverflow).mutate();
            this.mArrow = mutate;
            mutate.setAutoMirrored(true);
            Drawable mutate2 = context.getDrawable(C3630R.C3632drawable.ft_avd_toarrow).mutate();
            this.mOverflow = mutate2;
            mutate2.setAutoMirrored(true);
            AnimatedVectorDrawable animatedVectorDrawable = (AnimatedVectorDrawable) context.getDrawable(C3630R.C3632drawable.ft_avd_toarrow_animation).mutate();
            this.mToArrow = animatedVectorDrawable;
            animatedVectorDrawable.setAutoMirrored(true);
            AnimatedVectorDrawable animatedVectorDrawable2 = (AnimatedVectorDrawable) context.getDrawable(C3630R.C3632drawable.ft_avd_tooverflow_animation).mutate();
            ...
            imageButton.setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m102dp(56), AndroidUtilities.m102dp(48)));
            imageButton.setPaddingRelative(AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(12));
            imageButton.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            imageButton.setImageDrawable(mutate2);
            TextView textView = new TextView(context);
            this.mOverflowButtonText = textView;
            textView.setText(LocaleController.getString(C3630R.string.Back));
            ...
            this.mOverflowPanelViewHelper = new OverflowPanelViewHelper(context, m102dp);
            ...
            this.mDismissAnimation = FloatingToolbar.createExitAnimation(viewGroup2, ImageReceiver.DEFAULT_CROSSFADE_DURATION, new C37904(FloatingToolbar.this));
            this.mHideAnimation = FloatingToolbar.createExitAnimation(viewGroup2, 0, new C37915(FloatingToolbar.this));
        }
        ...
        /* loaded from: classes5.dex */
        public class C37904 extends AnimatorListenerAdapter {
            C37904(FloatingToolbar floatingToolbar) {
            }
            ...
            public void onAnimationEnd(Animator animator) {
                NotificationCenter.getInstance(UserConfig.selectedAccount).doOnIdle(new Runnable() { // from class: org.telegram.ui.ActionBar.FloatingToolbar$FloatingToolbarPopup$4$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        FloatingToolbar.FloatingToolbarPopup.C37904.this.lambda$onAnimationEnd$0();
                    }
                });
            }
        ...
        /* loaded from: classes5.dex */
        public class C37915 extends AnimatorListenerAdapter {
            C37915(FloatingToolbar floatingToolbar) {
            }
            ...
            public void onAnimationEnd(Animator animator) {
                NotificationCenter.getInstance(UserConfig.selectedAccount).doOnIdle(new Runnable() { // from class: org.telegram.ui.ActionBar.FloatingToolbar$FloatingToolbarPopup$5$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        FloatingToolbar.FloatingToolbarPopup.C37915.this.lambda$onAnimationEnd$0();
                    }
                });
            }
        ...
        public void setPanelsStatesAtRestingPosition() {
            ...
            if (this.mIsOverflowOpen) {
                ...
                this.mOverflowButton.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3630R.string.AccDescrMoreOptions));
                if (isInRTLMode()) {
        ...
        private int getAdjustedToolbarWidth(int i) {
            refreshViewPort();
            int width = this.mViewPortOnScreen.width() - (AndroidUtilities.m102dp(16) * 2);
            if (i <= 0) {
                i = AndroidUtilities.m102dp(400);
            }
        ...
        /* loaded from: classes5.dex */
        public class animationAnimation$AnimationListenerC378714 implements Animation.AnimationListener {
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationRepeat(Animation animation) {
            }

            animationAnimation$AnimationListenerC378714() {
            }
            ...
            public void onAnimationEnd(Animation animation) {
                FloatingToolbarPopup.this.mContentContainer.post(new Runnable() { // from class: org.telegram.ui.ActionBar.FloatingToolbar$FloatingToolbarPopup$14$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        FloatingToolbar.FloatingToolbarPopup.animationAnimation$AnimationListenerC378714.this.lambda$onAnimationEnd$0();
                    }
                });
            }
        ...
        private Animation.AnimationListener createOverflowAnimationListener() {
            return new animationAnimation$AnimationListenerC378714();
        }
        ...
        public final class OverflowPanelViewHelper {
            private final Context mContext;
            private final int mIconTextSpacing;
            private final int mSidePadding = AndroidUtilities.m102dp(18);
    ...
    public View createMenuItemButton(Context context, MenuItem menuItem, int i, boolean z, boolean z2) {
        ...
        linearLayout.setMinimumWidth(AndroidUtilities.m102dp(48));
        linearLayout.setMinimumHeight(AndroidUtilities.m102dp(48));
        linearLayout.setPaddingRelative(AndroidUtilities.m102dp(16), 0, AndroidUtilities.m102dp(16), 0);
        TextView textView = new TextView(context);
        ...
        textView.setPaddingRelative(AndroidUtilities.m102dp(11), 0, 0, 0);
        linearLayout.addView(textView, new LinearLayout.LayoutParams(-2, AndroidUtilities.m102dp(48)));
        linearLayout.addView(new Space(context), new LinearLayout.LayoutParams(-1, 1, 1.0f));
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C3630R.C3632drawable.msg_mini_lock3);
    ...
    public ViewGroup createContentContainer(Context context) {
        ...
        marginLayoutParams.rightMargin = m102dp;
        marginLayoutParams.topMargin = m102dp;
        marginLayoutParams.leftMargin = m102dp;
        marginLayoutParams.bottomMargin = m102dp;
        relativeLayout.setLayoutParams(marginLayoutParams);
        relativeLayout.setElevation(AndroidUtilities.m102dp(2));
        relativeLayout.setFocusable(true);
        relativeLayout.setFocusableInTouchMode(true);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(0);
        float m102dp2 = AndroidUtilities.m102dp(6);
        gradientDrawable.setCornerRadii(new float[]{m102dp2, m102dp2, m102dp2, m102dp2, m102dp2, m102dp2, m102dp2, m102dp2});
