...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    public DrawerLayoutContainer(Context context) {
        ...
        this.shadowLeft = getResources().getDrawable(C3630R.C3632drawable.menu_shadow);
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ActionBar.DrawerLayoutContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.allowDrawContent) {
            ...
            if (z) {
                ...
                if (i != 0) {
                    canvas.clipRect(i - AndroidUtilities.m102dp(1), 0, width, getHeight());
                }
                i2 = i3;
            } else {
                i = 0;
            ...
            if (this.scrimOpacity > BitmapDescriptorFactory.HUE_RED && z) {
                ...
                float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(this.drawerPosition / AndroidUtilities.m102dp(20), 1.0f));
    ...
    public static class PreviewForegroundDrawable extends Drawable {
        ...
        public PreviewForegroundDrawable() {
            ...
            gradientDrawable.setStroke(AndroidUtilities.m102dp(1), Theme.getColor(Theme.key_actionBarDefault));
            ...
            gradientDrawable2.setCornerRadius(AndroidUtilities.m102dp(6));
        }
        ...
        public void draw(Canvas canvas) {
            ...
            int i = bounds.left;
            int i2 = bounds.top;
            canvas.clipRect(i, i2, bounds.right, C3702ActionBar.getCurrentActionBarHeight() + i2);
            this.topDrawable.draw(canvas);
            canvas.restore();
            canvas.save();
            canvas.clipRect(bounds.left, bounds.top + C3702ActionBar.getCurrentActionBarHeight(), bounds.right, bounds.bottom);
