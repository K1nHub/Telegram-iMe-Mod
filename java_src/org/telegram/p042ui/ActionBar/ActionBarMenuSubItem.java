...
public class ActionBarMenuSubItem extends FrameLayout {
    ...
    public void setIcon(String str) {
        ...
        this.textView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m102dp(43), 0, LocaleController.isRTL ? AndroidUtilities.m102dp(43) : 0, 0);
    }
    ...
    public ActionBarMenuSubItem(Context context, int i, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider, int i2) {
        ...
        updateBackground();
        setPadding(AndroidUtilities.m102dp(18), 0, AndroidUtilities.m102dp(18), 0);
        ...
        if (i > 0) {
            ...
            this.textView.setPadding(LocaleController.isRTL ? AndroidUtilities.m102dp(34) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m102dp(34), 0);
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(this.itemHeight), 1073741824));
        if (!this.expandIfMultiline || this.textView.getLayout().getLineCount() <= 1) {
            return;
        }
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(this.itemHeight + 8), 1073741824));
    }
    ...
    public void setRightIcon(int i) {
        ...
        setPadding(AndroidUtilities.m102dp(LocaleController.isRTL ? 8 : 18), 0, AndroidUtilities.m102dp(LocaleController.isRTL ? 18 : 8), 0);
    ...
    public void setSubtext(String str) {
        if (this.subtextView == null) {
            ...
            this.subtextView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m102dp(43), 0, LocaleController.isRTL ? AndroidUtilities.m102dp(43) : 0, 0);
        ...
        if (z != (this.subtextView.getVisibility() == 0)) {
            ...
            layoutParams.bottomMargin = z ? AndroidUtilities.m102dp(10) : 0;
