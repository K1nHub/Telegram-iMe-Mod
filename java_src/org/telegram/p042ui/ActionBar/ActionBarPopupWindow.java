...
public class ActionBarPopupWindow extends PopupWindow {
    ...
    public static class ActionBarPopupWindowLayout extends FrameLayout {
        ...
        public ActionBarPopupWindowLayout(Context context, Theme.ResourcesProvider resourcesProvider) {
            this(context, C3630R.C3632drawable.popup_fixed_alert2, resourcesProvider);
        }
                    ...
                    if (ActionBarPopupWindowLayout.this.fitItems) {
                        ...
                        for (int i7 = 0; i7 < childCount; i7++) {
                            ...
                            if (childAt.getVisibility() != 8) {
                                Object tag = childAt.getTag(C3630R.C3633id.width_tag);
                                Object tag2 = childAt.getTag(C3630R.C3633id.object_tag);
                                Object tag3 = childAt.getTag(C3630R.C3633id.fit_width_tag);
                                if (tag != null) {
                                ...
                                if (tag3 == null) {
                                    ...
                                    if (!z && tag2 == null) {
                                        ...
                                        actionBarPopupWindowLayout.gapEndY = actionBarPopupWindowLayout.gapStartY + AndroidUtilities.m102dp(6);
                                        i6 = max;
                                    }
                                }
                                if (arrayList == null) {
        ...
        public void setBackScaleY(float f) {
            ...
            if (this.backScaleY != f) {
                ...
                if (this.animationEnabled && this.updateAnimation) {
                    int measuredHeight = getMeasuredHeight() - AndroidUtilities.m102dp(16);
                    if (this.shownFromBottom) {
                        for (int i = this.lastStartedChild; i >= 0; i--) {
                            ...
                            if (itemAt != null && itemAt.getVisibility() == 0 && !(itemAt instanceof GapView)) {
                                if (this.positions.get(itemAt) != null && measuredHeight - ((num.intValue() * AndroidUtilities.m102dp(48)) + AndroidUtilities.m102dp(32)) > measuredHeight * f) {
                                    break;
                                }
                        ...
                        for (int i3 = 0; i3 < itemsCount; i3++) {
                            ...
                            if (itemAt2.getVisibility() == 0) {
                                ...
                                if (i3 < this.lastStartedChild) {
                                    continue;
                                } else if (this.positions.get(itemAt2) != null && i2 - AndroidUtilities.m102dp(24) > measuredHeight * f) {
                                    break;
                                } else {
        ...
        private void startChildAnimation(final View view) {
            if (this.animationEnabled) {
                ...
                fArr2[0] = AndroidUtilities.m102dp(this.shownFromBottom ? 6 : -6);
                fArr2[1] = 0.0f;
        ...
        /* JADX WARN: Removed duplicated region for block: B:109:0x027a A[SYNTHETIC] */
        ...
        */
        public void dispatchDraw(android.graphics.Canvas r20) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        public void updateRadialSelectors() {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (childAt2.getVisibility() == 0) {
                    Object tag = childAt2.getTag(C3630R.C3633id.object_tag);
    ...
    public static /* synthetic */ void lambda$startAnimation$2(ActionBarPopupWindowLayout actionBarPopupWindowLayout, ValueAnimator valueAnimator) {
        ...
        for (int i = 0; i < itemsCount; i++) {
            ...
            if (!(itemAt instanceof GapView)) {
                itemAt.setTranslationY((1.0f - AndroidUtilities.cascade(floatValue, actionBarPopupWindowLayout.shownFromBottom ? (itemsCount - 1) - i : i, itemsCount, 4.0f)) * AndroidUtilities.m102dp(-6));
            }
        }
    }
    ...
    public void dismiss(boolean z) {
        ...
        if (this.animationEnabled && z) {
            ...
            if (this.outEmptyTime > 0) {
                ...
                fArr[0] = AndroidUtilities.m102dp((actionBarPopupWindowLayout == null || !actionBarPopupWindowLayout.shownFromBottom) ? -5 : 5);
    ...
    public static class GapView extends FrameLayout {
        ...
        public GapView(Context context, int i, int i2) {
            super(context);
            this.shadowDrawable = Theme.getThemedDrawable(getContext(), C3630R.C3632drawable.greydivider, i2);
