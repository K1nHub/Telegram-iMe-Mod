...
public class ActionBarLayout extends FrameLayout implements INavigationLayout, FloatingDebugProvider {
    ...
    private C3702ActionBar currentActionBar;
    ...
    @Override // org.telegram.p042ui.ActionBar.INavigationLayout
            ...
            if (baseFragment.isAllowPinnedPlayer()) {
                ...
                if ((view instanceof FrameLayout) && baseFragment.pinnedPlayerView != null) {
                    ...
                    if (isPinnedPlayerVisible()) {
                        layoutParams.bottomMargin = AndroidUtilities.m102dp(PinnedPlayerView.getPlayerHeight());
    ...
    public class LayoutContainer extends FrameLayout {
        ...
        protected boolean drawChild(Canvas canvas, View view, long j) {
            ...
            if ((view instanceof C3702ActionBar) || (view instanceof PinnedPlayerView) || (view instanceof PasscodeView)) {
            ...
            while (true) {
                ...
                if (childAt == view || !(childAt instanceof C3702ActionBar) || childAt.getVisibility() != 0) {
                    i3++;
                } else if (((C3702ActionBar) childAt).getCastShadows()) {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (int i6 = 0; i6 < childCount; i6++) {
                ...
                if (!(childAt3 instanceof C3702ActionBar) && !(childAt3 instanceof PinnedPlayerView) && !(childAt3 instanceof PasscodeView)) {
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            for (int i7 = 0; i7 < childCount; i7++) {
                ...
                if (childAt2 instanceof PinnedPlayerView) {
                    childAt2.layout(0, i4 - AndroidUtilities.m102dp(PinnedPlayerView.getPlayerHeight()), childAt2.getMeasuredWidth(), i4);
                } else if (childAt2 instanceof PasscodeView) {
        ...
        */
        public boolean dispatchTouchEvent(android.view.MotionEvent r6) {
            /*
                ...
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p042ui.ActionBar.ActionBarLayout.this
                boolean r0 = org.telegram.p042ui.ActionBar.ActionBarLayout.access$500(r0)
                r1 = 1
                r2 = 0
                if (r0 == 0) goto L17
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p042ui.ActionBar.ActionBarLayout.this
                org.telegram.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout r0 = org.telegram.p042ui.ActionBar.ActionBarLayout.access$600(r0)
                if (r0 != 0) goto L17
                r0 = r1
                goto L18
            L17:
            ...
            L18:
                if (r0 != 0) goto L22
                org.telegram.ui.ActionBar.ActionBarLayout r3 = org.telegram.p042ui.ActionBar.ActionBarLayout.this
                boolean r3 = org.telegram.p042ui.ActionBar.ActionBarLayout.access$700(r3)
                if (r3 == 0) goto L30
            L22:
            ...
            L30:
                if (r0 == 0) goto L38
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p042ui.ActionBar.ActionBarLayout.this     // Catch: java.lang.Throwable -> L41
            ...
            L45:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ActionBar.ActionBarLayout.LayoutContainer.dispatchTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        public void processMenuButtonsTouch(MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (!this.allowToPressByHover && Math.sqrt(Math.pow(this.pressX - motionEvent.getX(), 2.0d) + Math.pow(this.pressY - motionEvent.getY(), 2.0d)) > AndroidUtilities.m102dp(30)) {
    ...
    public ActionBarLayout(Context context) {
        ...
        if (layerShadowDrawable == null) {
            layerShadowDrawable = getResources().getDrawable(C3630R.C3632drawable.layer_shadow);
            headerShadowDrawable = getResources().getDrawable(C3630R.C3632drawable.header_shadow).mutate();
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.containerViewBack) {
            paddingLeft2 = AndroidUtilities.m102dp(1) + paddingRight;
        ...
        if (paddingRight != 0 || this.overrideWidthOffset != -1) {
            ...
            if (view == this.containerView) {
                float clamp = MathUtils.clamp(i / AndroidUtilities.m102dp(20), (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    private void drawPreviewDrawables(Canvas canvas, ViewGroup viewGroup) {
        ...
        if (childAt != null) {
            ...
            if (this.previewMenu == null) {
                ...
                int i = m102dp / 2;
                int measuredWidth = (getMeasuredWidth() - m102dp) / 2;
                int top = (int) ((childAt.getTop() + viewGroup.getTranslationY()) - AndroidUtilities.m102dp((Build.VERSION.SDK_INT < 21 ? 20 : 0) + 12));
                Theme.moveUpDrawable.setBounds(measuredWidth, top, m102dp + measuredWidth, i + top);
    ...
    public void onSlideAnimationEnd(boolean z) {
        ...
        if (!z) {
            ...
            C3702ActionBar c3702ActionBar = baseFragment3.actionBar;
            if (c3702ActionBar != null && c3702ActionBar.shouldAddToContainer() && (viewGroup3 = (ViewGroup) baseFragment3.actionBar.getParent()) != null) {
    ...
    private void prepareForMoving(MotionEvent motionEvent) {
        ...
        C3702ActionBar c3702ActionBar = baseFragment.actionBar;
        if (c3702ActionBar != null && c3702ActionBar.shouldAddToContainer()) {
    ...
    public void onBackPressed() {
        ...
        if (!storyViewerAttached() && (c3702ActionBar = this.currentActionBar) != null && !c3702ActionBar.isActionModeShowed()) {
            C3702ActionBar c3702ActionBar2 = this.currentActionBar;
            if (c3702ActionBar2.isSearchFieldVisible) {
                c3702ActionBar2.closeSearchField();
                return;
            }
        }
        List<BaseFragment> list = this.fragmentsStack;
    ...
    private void presentFragmentInternalRemoveOld(boolean z, BaseFragment baseFragment) {
        ...
        if (z) {
            ...
            C3702ActionBar c3702ActionBar = baseFragment.actionBar;
            if (c3702ActionBar != null && c3702ActionBar.shouldAddToContainer() && (viewGroup3 = (ViewGroup) baseFragment.actionBar.getParent()) != null) {
                ...
                if (z) {
                    ...
                    if (z3) {
                        ...
                        if (ActionBarLayout.this.previewMenu != null) {
                            ...
                            ActionBarLayout.this.containerView.setTranslationY(AndroidUtilities.m102dp(40) * f2);
                            ActionBarLayout.this.previewMenu.setTranslationY((-AndroidUtilities.m102dp(70)) * f2);
                        ...
                        ActionBarLayout.this.containerView.setTranslationX(AndroidUtilities.m102dp(48) * (1.0f - interpolation));
                    }
                } else {
                    ...
                    if (z3) {
                        ...
                        ActionBarLayout.this.containerViewBack.setTranslationX(AndroidUtilities.m102dp(48) * interpolation);
                    }
                }
                if (ActionBarLayout.this.animationProgress < 1.0f) {
    ...
    public boolean presentFragment(INavigationLayout.NavigationParams navigationParams) {
        ...
        if ((baseFragment2 instanceof ActionIntroActivity) && ((ActionIntroActivity) baseFragment2).getType() == 3) {
            ...
            if (lastFragment != null) {
                lastFragment.showDialog(AlertsCreator.createOpenTelegramDialog(getParentActivity(), LocaleController.getInternalString(C3630R.string.open_telegram_alert_change_phone_number)));
            }
            return false;
        }
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m100d("present fragment " + baseFragment2.getClass().getSimpleName() + " args=" + baseFragment2.getArguments());
        }
        ...
        if (actionBarPopupWindowLayout != null) {
            ...
            i = actionBarPopupWindowLayout.getMeasuredHeight() + AndroidUtilities.m102dp(24);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) actionBarPopupWindowLayout.getLayoutParams();
            layoutParams.width = -2;
            layoutParams.height = -2;
            layoutParams.topMargin = (getMeasuredHeight() - i) - AndroidUtilities.m102dp(6);
        ...
        if (z4) {
            ...
            if (previewHeight > 0 && previewHeight < getMeasuredHeight() - i2) {
                ...
                int m102dp = AndroidUtilities.m102dp(actionBarPopupWindowLayout != null ? 0 : 24);
                layoutParams2.bottomMargin = m102dp;
                layoutParams2.topMargin = m102dp;
                layoutParams2.topMargin = m102dp + AndroidUtilities.statusBarHeight;
            }
            if (actionBarPopupWindowLayout != null) {
                layoutParams2.bottomMargin += i + AndroidUtilities.m102dp(8);
            }
            ...
            if (baseFragment2.isAllowPinnedPlayer() && isPinnedPlayerVisible()) {
                layoutParams2.bottomMargin = AndroidUtilities.m102dp(PinnedPlayerView.getPlayerHeight());
            }
        }
        view.setLayoutParams(layoutParams2);
        C3702ActionBar c3702ActionBar = baseFragment2.actionBar;
        if (c3702ActionBar != null && c3702ActionBar.shouldAddToContainer()) {
            if (this.removeActionBarExtraHeight) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                view.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.telegram.ui.ActionBar.ActionBarLayout.3
                    ...
                    public void getOutline(View view2, Outline outline) {
                        outline.setRoundRect(0, AndroidUtilities.statusBarHeight, view2.getMeasuredWidth(), view2.getMeasuredHeight(), AndroidUtilities.m102dp(6));
                    }
                });
                view.setClipToOutline(true);
                view.setElevation(AndroidUtilities.m102dp(4));
            }
        ...
        if ((iNavigationLayoutDelegate == null || iNavigationLayoutDelegate.needAddFragmentToStack(baseFragment, this)) && baseFragment.onFragmentCreate() && !this.fragmentsStack.contains(baseFragment)) {
            ...
            if (i == -1 || i == -2) {
                if (!this.fragmentsStack.isEmpty()) {
                    ...
                    C3702ActionBar c3702ActionBar = baseFragment2.actionBar;
                    if (c3702ActionBar != null && c3702ActionBar.shouldAddToContainer() && (viewGroup4 = (ViewGroup) baseFragment2.actionBar.getParent()) != null) {
    ...
    */
    public void movePreviewFragment(float r4) {
        ...
        L37:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ActionBar.ActionBarLayout.movePreviewFragment(float):void");
    }
    ...
    public void bringToFront(int i) {
        ...
        if (this.fragmentsStack.isEmpty() || this.fragmentsStack.size() - 1 != i || this.fragmentsStack.get(i).fragmentView == null) {
            for (int i2 = 0; i2 < i; i2++) {
                ...
                C3702ActionBar c3702ActionBar = baseFragment.actionBar;
                if (c3702ActionBar != null && c3702ActionBar.shouldAddToContainer() && (viewGroup4 = (ViewGroup) baseFragment.actionBar.getParent()) != null) {
            ...
            C3702ActionBar c3702ActionBar2 = baseFragment2.actionBar;
            if (c3702ActionBar2 != null && c3702ActionBar2.shouldAddToContainer()) {
                if (this.removeActionBarExtraHeight) {
                    baseFragment2.actionBar.setOccupyStatusBar(false);
                }
                AndroidUtilities.removeFromParent(baseFragment2.actionBar);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void removeFragmentFromStack(org.telegram.p042ui.ActionBar.BaseFragment r4, boolean r5) {
        /*
            r3 = this;
        ...
        L80:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ActionBar.ActionBarLayout.removeFragmentFromStack(org.telegram.ui.ActionBar.BaseFragment, boolean):void");
    }
    ...
    public boolean onKeyUp(int i, KeyEvent keyEvent) {
        C3702ActionBar c3702ActionBar;
        if (i == 82 && !checkTransitionAnimation() && !this.startedTracking && (c3702ActionBar = this.currentActionBar) != null) {
            c3702ActionBar.onMenuButtonPressed();
        }
    ...
    public void onActionModeStarted(Object obj) {
        C3702ActionBar c3702ActionBar = this.currentActionBar;
    ...
    public void onActionModeFinished(Object obj) {
        C3702ActionBar c3702ActionBar = this.currentActionBar;
        if (c3702ActionBar != null) {
            c3702ActionBar.setVisibility(0);
        }
    ...
    public void setTitleOverlayText(String str, int i, Runnable runnable) {
        ...
        for (int i2 = 0; i2 < this.fragmentsStack.size(); i2++) {
            C3702ActionBar c3702ActionBar = this.fragmentsStack.get(i2).actionBar;
            if (c3702ActionBar != null) {
                c3702ActionBar.setTitleOverlayText(this.titleOverlayText, this.titleOverlayTextId, runnable);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$new$8() {
        if (this.attached && getLastFragment() != null && this.containerView.getChildCount() == 0) {
            if (BuildVars.DEBUG_VERSION) {
                FileLog.m97e(new RuntimeException(TextUtils.join(", ", this.lastActions)));
            }
