...
public class ActionBarMenu extends LinearLayout {
    ...
    protected C3702ActionBar parentActionBar;

    public ActionBarMenu(Context context, C3702ActionBar c3702ActionBar) {
        super(context);
        this.drawBlur = true;
        setOrientation(0);
        this.parentActionBar = c3702ActionBar;
    }
    ...
    public void updateItemsBackgroundColor() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ((childAt instanceof ActionBarMenuItem) && ((ActionBarMenuItem) childAt).isRippleVisible) {
    ...
    public ActionBarMenuItem addItem(int i, Drawable drawable) {
        return addItem(i, 0, null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, drawable, AndroidUtilities.m102dp(48), null);
    }
    ...
    public ActionBarMenuItem addItem(int i, int i2, int i3, Theme.ResourcesProvider resourcesProvider) {
        return addItem(i, i2, null, i3, null, AndroidUtilities.m102dp(48), null, resourcesProvider);
    }
    ...
    public LazyItem lazilyAddItem(int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        return lazilyAddItem(i, i2, null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, null, AndroidUtilities.m102dp(48), null, resourcesProvider);
    }
    ...
    public static class LazyItem {
        ...
        public void add() {
            ...
            if (this.parent.ids != null) {
                int indexOf = this.parent.ids.indexOf(Integer.valueOf(this.f1774id));
            ...
            i = childCount;
            ActionBarMenuItem addItemAt = this.parent.addItemAt(i, this.f1774id, this.icon, this.text, this.backgroundColor, this.drawable, this.width, this.title, this.resourcesProvider);
            this.cell = addItemAt;
    ...
    public void onItemClick(int i) {
        C3702ActionBar.ActionBarMenuOnItemClick actionBarMenuOnItemClick = this.parentActionBar.actionBarMenuOnItemClick;
    ...
    public int getItemsMeasuredWidth(boolean z) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if ((z || (childAt.getAlpha() != BitmapDescriptorFactory.HUE_RED && childAt.getVisibility() == 0)) && (childAt instanceof ActionBarMenuItem)) {
