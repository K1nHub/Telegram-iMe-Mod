...
public class WebAppDisclaimerAlert {
    ...
    public static void show(final Context context, final Consumer<Boolean> consumer, TLRPC$User tLRPC$User) {
        ...
        builder.setTitle(LocaleController.getString("TermsOfUse", C3630R.string.TermsOfUse));
        ...
        textView.setText(AndroidUtilities.replaceTags(LocaleController.getString("BotWebAppDisclaimerSubtitle", C3630R.string.BotWebAppDisclaimerSubtitle)));
        webAppDisclaimerAlert.cell.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString("BotWebAppDisclaimerCheck", C3630R.string.BotWebAppDisclaimerCheck), new Runnable() { // from class: org.telegram.ui.WebAppDisclaimerAlert$$ExternalSyntheticLambda3
        ...
        builder.setPositiveButton(LocaleController.getString("Continue", C3630R.string.Continue), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.WebAppDisclaimerAlert$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                WebAppDisclaimerAlert.lambda$show$1(Consumer.this, dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.WebAppDisclaimerAlert$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public static /* synthetic */ void lambda$show$0(Context context) {
        Browser.openUrl(context, LocaleController.getString("WebAppDisclaimerUrl", C3630R.string.WebAppDisclaimerUrl));
    }
