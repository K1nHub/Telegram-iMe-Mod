...
public class SettingsSuggestionCell extends LinearLayout {
    ...
    public void setType(int i) {
        ...
        if (i != 0) {
            if (i == 1) {
                this.textView.setText(LocaleController.getString("YourPasswordHeader", C3630R.string.YourPasswordHeader));
                this.detailTextView.setText(LocaleController.getString("YourPasswordRemember", C3630R.string.YourPasswordRemember));
                this.yesButton.setText(LocaleController.getString("YourPasswordRememberYes", C3630R.string.YourPasswordRememberYes));
                this.noButton.setText(LocaleController.getString("YourPasswordRememberNo", C3630R.string.YourPasswordRememberNo));
                return;
            }
            return;
        }
        ...
        int i2 = C3630R.string.CheckPhoneNumber;
        C3545PhoneFormat c3545PhoneFormat = C3545PhoneFormat.getInstance();
        textView.setText(LocaleController.formatString("CheckPhoneNumber", i2, c3545PhoneFormat.format("+" + user.phone)));
        String string = LocaleController.getString("CheckPhoneNumberInfo", C3630R.string.CheckPhoneNumberInfo);
        ...
        if (indexOf >= 0 && lastIndexOf >= 0 && indexOf != lastIndexOf) {
            ...
            try {
                spannableStringBuilder.setSpan(new URLSpanNoUnderline(LocaleController.getString("CheckPhoneNumberLearnMoreUrl", C3630R.string.CheckPhoneNumberLearnMoreUrl)), indexOf, lastIndexOf - 2, 33);
            } catch (Exception e) {
                FileLog.m97e(e);
            }
        }
        this.detailTextView.setText(spannableStringBuilder);
        this.yesButton.setText(LocaleController.getString("CheckPhoneNumberYes", C3630R.string.CheckPhoneNumberYes));
        this.noButton.setText(LocaleController.getString("CheckPhoneNumberNo", C3630R.string.CheckPhoneNumberNo));
    }
