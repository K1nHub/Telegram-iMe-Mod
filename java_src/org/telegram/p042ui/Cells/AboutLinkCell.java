...
public class AboutLinkCell extends FrameLayout {
    private static final int COLLAPSED_HEIGHT = AndroidUtilities.m102dp(76);
    ...
    public AboutLinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.SPACE = AndroidUtilities.m103dp(3.0f);
        this.longPressedRunnable = new RunnableC39702();
        ...
        Drawable mutate = context.getResources().getDrawable(C3630R.C3632drawable.gradient_bottom).mutate();
        int i = Theme.key_windowBackgroundWhite;
        ...
        TextView textView2 = new TextView(this, context) { // from class: org.telegram.ui.Cells.AboutLinkCell.1
            ...
            protected void onDraw(Canvas canvas) {
                if (this.pressed) {
                    ...
                    canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), Theme.chat_urlPaint);
                }
                super.onDraw(canvas);
            }
        };
        ...
        this.showMoreTextView.setText(LocaleController.getString("DescriptionMore", C3630R.string.DescriptionMore));
        ...
        this.showMoreTextView.setPadding(AndroidUtilities.m102dp(2), 0, AndroidUtilities.m102dp(2), 0);
        this.showMoreTextBackgroundView = new FrameLayout(context);
        Drawable mutate2 = context.getResources().getDrawable(C3630R.C3632drawable.gradient_left).mutate();
        ...
        frameLayout2.setPadding(frameLayout2.getPaddingLeft() + AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(1), 0, AndroidUtilities.m102dp(3));
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(8), getWidth() - AndroidUtilities.m102dp(23), getHeight());
        int m102dp = AndroidUtilities.m102dp(23);
        this.textX = m102dp;
        float f = BitmapDescriptorFactory.HUE_RED;
        canvas.translate(m102dp, BitmapDescriptorFactory.HUE_RED);
        LinkSpanDrawable.LinkCollector linkCollector = this.links;
        ...
        this.textY = m102dp2;
        canvas.translate(BitmapDescriptorFactory.HUE_RED, m102dp2);
        try {
    ...
    public void setTextAndValue(String str, String str2, boolean z) {
        ...
        Emoji.replaceEmoji(this.stringBuilder, Theme.profile_aboutTextPaint.getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
        if (this.lastMaxWidth <= 0) {
            this.lastMaxWidth = AndroidUtilities.displaySize.x - AndroidUtilities.m102dp(46);
        }
    ...
    /* loaded from: classes5.dex */
    public class RunnableC39702 implements Runnable {
        RunnableC39702() {
        }
        ...
        public void run() {
            if (AboutLinkCell.this.pressedLink != null) {
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3630R.string.Open), LocaleController.getString("Copy", C3630R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        AboutLinkCell.RunnableC39702.this.lambda$run$0(clickableSpan, layout, f, url, dialogInterface, i);
                    }
                });
                builder.setOnPreDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda1
                    ...
                    public final void onDismiss(DialogInterface dialogInterface) {
                        AboutLinkCell.RunnableC39702.this.lambda$run$1(dialogInterface);
                    }
                });
                builder.show();
        ...
        public /* synthetic */ void lambda$run$0(ClickableSpan clickableSpan, Layout layout, float f, String str, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    if (str.startsWith("@")) {
                        BulletinFactory.m61of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3630R.raw.copy, LocaleController.getString("UsernameCopied", C3630R.string.UsernameCopied)).show();
                    } else if (str.startsWith("#") || str.startsWith("$")) {
                        BulletinFactory.m61of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3630R.raw.copy, LocaleController.getString("HashtagCopied", C3630R.string.HashtagCopied)).show();
                    } else {
                        BulletinFactory.m61of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3630R.raw.copy, LocaleController.getString("LinkCopied", C3630R.string.LinkCopied)).show();
                    }
                }
            }
        }
    ...
    private LinkSpanDrawable hitLink(int i, int i2) {
        if (i < this.showMoreTextView.getLeft() || i > this.showMoreTextView.getRight() || i2 < this.showMoreTextView.getTop() || i2 > this.showMoreTextView.getBottom()) {
            if (getMeasuredWidth() <= 0 || i <= getMeasuredWidth() - AndroidUtilities.m102dp(23)) {
    ...
    public void onLinkClick(ClickableSpan clickableSpan, Layout layout, float f) {
        ...
        if (layout != null && clickableSpan != null) {
            c39713 = new C39713(layout, clickableSpan, f);
        }
        this.currentProgress = c39713;
    ...
    /* loaded from: classes5.dex */
    public class C39713 extends Browser.Progress {
        ...
        C39713(Layout layout, ClickableSpan clickableSpan, float f) {
        ...
        public void end(boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.AboutLinkCell$3$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AboutLinkCell.C39713.this.lambda$end$0();
                }
            }, z ? 0L : 350L);
        }
    ...
    private int fromHeight() {
        return Math.min(COLLAPSED_HEIGHT + (this.valueTextView.getVisibility() == 0 ? AndroidUtilities.m102dp(20) : 0), textHeight());
    }
    ...
    protected void onMeasure(int i, int i2) {
        checkTextLayout(View.MeasureSpec.getSize(i) - AndroidUtilities.m102dp(46), false);
    ...
    private void checkTextLayout(int i, boolean z) {
        ...
        if (spannableStringBuilder != null && (i != this.lastMaxWidth || z)) {
            ...
            if (this.shouldExpand && this.firstThreeLinesLayout != null) {
                int fromHeight = fromHeight() - AndroidUtilities.m102dp(8);
                StaticLayout staticLayout = this.firstThreeLinesLayout;
    ...
    private int textHeight() {
        ...
        int height = (staticLayout != null ? staticLayout.getHeight() : AndroidUtilities.m102dp(20)) + AndroidUtilities.m102dp(16);
        return this.valueTextView.getVisibility() == 0 ? height + AndroidUtilities.m102dp(23) : height;
    }
