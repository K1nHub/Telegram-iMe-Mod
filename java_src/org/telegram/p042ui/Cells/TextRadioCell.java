...
public class TextRadioCell extends FrameLayout {
    ...
    public void updateRTL() {
        ...
        layoutParams.leftMargin = AndroidUtilities.m102dp(z3 ? this.padding : 64);
        layoutParams.rightMargin = AndroidUtilities.m102dp(LocaleController.isRTL ? 64 : this.padding);
        ...
        layoutParams2.leftMargin = AndroidUtilities.m102dp(z4 ? this.padding : 64);
        layoutParams2.rightMargin = AndroidUtilities.m102dp(LocaleController.isRTL ? 64 : this.padding);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.animatedColorBackground != 0) {
            canvas.drawCircle(this.lastTouchX, getMeasuredHeight() / 2, (Math.max(this.lastTouchX, getMeasuredWidth() - this.lastTouchX) + AndroidUtilities.m102dp(40)) * this.animationProgress, this.animationPaint);
        }
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m102dp(64), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m102dp(64) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.radioButton.isChecked()) {
            i = C3630R.string.NotificationsOn;
            str = "NotificationsOn";
        } else {
            i = C3630R.string.NotificationsOff;
