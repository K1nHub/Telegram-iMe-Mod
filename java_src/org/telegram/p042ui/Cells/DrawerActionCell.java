...
public class DrawerActionCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.isRectIconType) {
            ...
            float m102dp2 = AndroidUtilities.m102dp(30) / 2.0f;
            this.rect.set(x - m102dp2, y - m102dp2, x + m102dp2, y + m102dp2);
        ...
        if (this.currentId == 8) {
            ...
            if (set.contains("VALIDATE_PHONE_NUMBER") || set.contains("VALIDATE_PASSWORD")) {
                int m103dp = AndroidUtilities.m103dp(12.5f);
                this.rect.set(((getMeasuredWidth() - AndroidUtilities.m102dp(9)) - AndroidUtilities.m102dp(25)) - AndroidUtilities.m103dp(5.5f), m103dp, measuredWidth + m102dp + AndroidUtilities.m102dp(14), m103dp + AndroidUtilities.m102dp(23));
    ...
    public void setBot(TLRPC$TL_attachMenuBot tLRPC$TL_attachMenuBot) {
        ...
        try {
            if (j == 1985737506) {
                this.textView.setText(LocaleController.getInternalString(C3630R.string.drawer_wallet_bot));
            ...
            if (sideAttachMenuBotIcon != null) {
                ...
                this.imageView.setImageResource(C3630R.C3632drawable.msg_bot, Theme.getColor(Theme.key_chats_menuItemIcon));
            }
