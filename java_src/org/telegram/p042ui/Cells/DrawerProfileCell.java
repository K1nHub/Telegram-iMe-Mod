...
public class DrawerProfileCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
            ...
            if (z2) {
                ...
                if (drawerAccountData3 == DrawerAccountData.PHONE) {
                    ...
                    if (TextUtils.isEmpty(this.currentUser.username)) {
                        str2 = LocaleController.getInternalString(C3630R.string.drawer_profile_cell_alert_username);
                    } else {
                        str2 = LocaleController.formatStringInternal(C3630R.string.common_username, this.currentUser.username);
                    }
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    ...
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = LocaleController.formatStringInternal(C3630R.string.common_id, Long.valueOf(this.currentUser.f1762id));
                } else {
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = null;
                ...
                layoutParams.height = AndroidUtilities.m102dp(z ? 14 : 12);
                view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m102dp(10), -16777216));
                view.setAlpha(0.3f);
                str = "";
            }
            if (z) {
                this.nameTextView.setPadding(z2 ? 0 : AndroidUtilities.m102dp(32), AndroidUtilities.m102dp(4), 0, AndroidUtilities.m102dp(4));
                this.nameTextView.setMinWidth(z2 ? 0 : AndroidUtilities.m102dp(64));
    ...
    private void createEditButton(Context context) {
        ...
        this.editButton.setImageResource(C3630R.C3632drawable.fork_filter_icon_eye);
    ...
    private void createArchiveButton(Context context) {
        ...
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.archiveButton.setImageResource(C3630R.C3632drawable.msg_archive);
    ...
    public DrawerProfileCell(Context context, final DrawerLayoutContainer drawerLayoutContainer, final boolean z) {
        ...
        this.shadowView.setImageResource(C3630R.C3632drawable.bottom_shadow);
        addView(this.shadowView, LayoutHelper.createFrame(-1, 70, 83));
        BackupImageView backupImageView = new BackupImageView(context);
        this.avatarImageView = backupImageView;
        backupImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m102dp(32));
        ...
        SimpleTextView simpleTextView = new SimpleTextView(context) { // from class: org.telegram.ui.Cells.DrawerProfileCell.1
            ...
            @Override // org.telegram.p042ui.ActionBar.SimpleTextView, android.view.View, android.graphics.drawable.Drawable.Callback
        ...
        this.nameTextView.setPadding(0, AndroidUtilities.m102dp(4), 0, AndroidUtilities.m102dp(4));
        ...
        this.arrowView.setImageResource(C3630R.C3632drawable.msg_expand);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.darkThemeView.setBackgroundDrawable(Theme.createSelectorDrawable(Theme.getColor(Theme.key_listSelector), 1, AndroidUtilities.m102dp(17)));
    ...
    */
    public /* synthetic */ void lambda$new$2(boolean r6, final org.telegram.p042ui.ActionBar.DrawerLayoutContainer r7, android.view.View r8) {
        /*
            r5 = this;
            if (r6 == 0) goto L3
            return
        L3:
            boolean r6 = org.telegram.p042ui.Cells.DrawerProfileCell.switchingTheme
            if (r6 == 0) goto L8
            return
        L8:
            r6 = 1
            org.telegram.p042ui.Cells.DrawerProfileCell.switchingTheme = r6
            ...
            org.telegram.ui.ActionBar.Theme$ThemeInfo r2 = org.telegram.p042ui.ActionBar.Theme.getTheme(r8)
            if (r2 == 0) goto L2c
            org.telegram.ui.ActionBar.Theme$ThemeInfo r2 = org.telegram.p042ui.ActionBar.Theme.getTheme(r8)
        ...
        L2d:
            ...
            org.telegram.ui.ActionBar.Theme$ThemeInfo r2 = org.telegram.p042ui.ActionBar.Theme.getTheme(r6)
            if (r2 == 0) goto L45
            org.telegram.ui.ActionBar.Theme$ThemeInfo r2 = org.telegram.p042ui.ActionBar.Theme.getTheme(r6)
            boolean r2 = r2.isDark()
            if (r2 != 0) goto L46
        L45:
            r6 = r3
        L46:
            org.telegram.ui.ActionBar.Theme$ThemeInfo r2 = org.telegram.p042ui.ActionBar.Theme.getActiveTheme()
        ...
        L68:
            ...
            if (r6 == 0) goto L7e
            org.telegram.ui.ActionBar.Theme$ThemeInfo r8 = org.telegram.p042ui.ActionBar.Theme.getTheme(r3)
            org.telegram.ui.Components.RLottieDrawable r0 = org.telegram.p042ui.Cells.DrawerProfileCell.sunDrawable
            r1 = 36
            r0.setCustomEndFrame(r1)
            goto L87
        L7e:
            org.telegram.ui.ActionBar.Theme$ThemeInfo r8 = org.telegram.p042ui.ActionBar.Theme.getTheme(r1)
            org.telegram.ui.Components.RLottieDrawable r1 = org.telegram.p042ui.Cells.DrawerProfileCell.sunDrawable
        ...
        La1:
            ...
            r8.<init>()
            org.telegram.p042ui.ActionBar.Theme.turnOffAutoNight(r6, r8)
        La9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.DrawerProfileCell.lambda$new$2(boolean, org.telegram.ui.ActionBar.DrawerLayoutContainer, android.view.View):void");
    }
    ...
    public static class AnimatedStatusView extends View {
        ...
        /* renamed from: y1 */
        private float f1792y1;

        /* renamed from: y2 */
        private float f1793y2;
        ...
        public void dispatchDraw(Canvas canvas) {
            int m102dp = AndroidUtilities.m102dp(this.renderedEffectsSize);
            int m102dp2 = AndroidUtilities.m102dp(this.effectsSize);
            for (int i = 0; i < this.animations.size(); i++) {
                Object obj = this.animations.get(i);
                if (obj instanceof ImageReceiver) {
                    ImageReceiver imageReceiver = (ImageReceiver) obj;
                    float f = m102dp2;
                    imageReceiver.setImageCoords((getMeasuredWidth() - m102dp2) / 2.0f, (getMeasuredHeight() - m102dp2) / 2.0f, f, f);
                    imageReceiver.draw(canvas);
                } else if (obj instanceof AnimatedEmojiEffect) {
                    AnimatedEmojiEffect animatedEmojiEffect = (AnimatedEmojiEffect) obj;
                    animatedEmojiEffect.setBounds((int) ((getMeasuredWidth() - m102dp) / 2.0f), (int) ((getMeasuredHeight() - m102dp) / 2.0f), (int) ((getMeasuredWidth() + m102dp) / 2.0f), (int) ((getMeasuredHeight() + m102dp) / 2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        if (Build.VERSION.SDK_INT >= 21 && !this.previewMode) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(148) + AndroidUtilities.statusBarHeight, 1073741824));
            return;
        }
        try {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(148), 1073741824));
        } catch (Exception e) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m102dp(148));
            FileLog.m97e(e);
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.drawPremium) {
            if (this.starParticlesDrawable == null) {
                ...
                drawable2.minLifeTime = C0479C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
            }
            ...
            this.starParticlesDrawable.rect.inset(-AndroidUtilities.m102dp(20), -AndroidUtilities.m102dp(20));
    ...
    */
    protected void onDraw(android.graphics.Canvas r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.DrawerProfileCell.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setUser(TLRPC$User tLRPC$User, boolean z, DrawerHeaderSettings drawerHeaderSettings) {
        ...
        try {
            userName = Emoji.replaceEmoji(userName, this.nameTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(22), false);
        ...
        if (z3 && emojiStatusDocumentId != null) {
            ...
            this.nameTextView.setDrawablePadding(AndroidUtilities.m102dp(4));
            ...
            if (this.premiumStar == null) {
                this.premiumStar = getResources().getDrawable(C3630R.C3632drawable.msg_premium_liststar).mutate();
            }
        ...
        textView.setText(c3545PhoneFormat.format("+" + tLRPC$User.phone));
    ...
    private void setArrowState(boolean z) {
        ...
        if (this.accountsShown) {
            i = C3630R.string.AccDescrHideAccounts;
            str = "AccDescrHideAccounts";
        } else {
            i = C3630R.string.AccDescrShowAccounts;
