...
public class GraySectionCell extends FrameLayout {
    ...
    public GraySectionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextView.setPadding(AndroidUtilities.m102dp(2), 0, AndroidUtilities.m102dp(2), 0);
        this.rightTextView.setAnimationProperties(1.0f, 0L, 400L, CubicBezierInterpolator.EASE_OUT_QUINT);
        this.rightTextView.setTextSize(AndroidUtilities.m102dp(14));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(32), 1073741824));
    }
