...
public class DialogsEmptyCell extends LinearLayout {
    ...
    public DialogsEmptyCell(final Context context) {
        ...
        this.subtitleView.setInAnimation(context, C3630R.anim.alpha_in);
        this.subtitleView.setOutAnimation(context, C3630R.anim.alpha_out);
    ...
    public void setType(int i, boolean z) {
        ...
        if (i >= 100) {
            ...
            i2 = C3630R.raw.utyan_newborn;
            string = LocaleController.getString("NoChatsHelp", C3630R.string.NoChatsHelp);
            this.titleView.setText(LocaleController.getString("NoChats", C3630R.string.NoChats));
        } else if (i == 2) {
            this.imageView.setAutoRepeat(false);
            int i3 = C3630R.raw.filter_no_chats;
            if (z) {
                this.titleView.setText(LocaleController.getString("FilterNoChatsToForward", C3630R.string.FilterNoChatsToForward));
                string = LocaleController.getString("FilterNoChatsToForwardInfo", C3630R.string.FilterNoChatsToForwardInfo);
            } else {
                this.titleView.setText(LocaleController.getString("FilterNoChatsToDisplay", C3630R.string.FilterNoChatsToDisplay));
                string = LocaleController.getString("FilterNoChatsToDisplayInfo", C3630R.string.FilterNoChatsToDisplayInfo);
            }
            i2 = i3;
        } else {
            this.imageView.setAutoRepeat(true);
            i2 = C3630R.raw.filter_new;
            string = LocaleController.getString("FilterAddingChatsInfo", C3630R.string.FilterAddingChatsInfo);
            this.titleView.setText(LocaleController.getString("FilterAddingChats", C3630R.string.FilterAddingChats));
        }
        if (i2 != 0) {
            ...
            if (this.currentType == 1) {
                if (isUtyanAnimationTriggered()) {
                    ...
                    String string2 = LocaleController.getString("NoChatsContactsHelp", C3630R.string.NoChatsContactsHelp);
    ...
    public void startUtyanCollapseAnimation(boolean z) {
        ...
        if (z) {
            String string = LocaleController.getString("NoChatsContactsHelp", C3630R.string.NoChatsContactsHelp);
            if (AndroidUtilities.isTablet() && !AndroidUtilities.isSmallTablet()) {
                string = string.replace('\n', ' ');
            }
    ...
    public void updateLayout() {
        ...
        if (i3 == 0 || i3 == 1) {
            i2 = (int) (i2 - (((int) (C3702ActionBar.getCurrentActionBarHeight() / 2.0f)) * (1.0f - this.utyanCollapseProgress)));
        }
        float f = i2;
    ...
    private int measureUtyanHeight(int i) {
        ...
        return (int) (size + ((AndroidUtilities.m102dp(320) - size) * this.utyanCollapseProgress));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 == 0 || i3 == 1) {
            ...
            if (!arrayList.isEmpty()) {
                size -= (((AndroidUtilities.m102dp(72) * arrayList.size()) + arrayList.size()) - 1) + AndroidUtilities.m102dp(50);
            }
