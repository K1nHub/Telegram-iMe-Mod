...
public class StickerCell extends FrameLayout {
    ...
    public StickerCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumLockIconView.setPadding(AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(76) + getPaddingLeft() + getPaddingRight(), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(78), 1073741824));
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (str != null) {
            accessibilityNodeInfo.setText(str + " " + LocaleController.getString("AttachSticker", C3630R.string.AttachSticker));
        } else {
            accessibilityNodeInfo.setText(LocaleController.getString("AttachSticker", C3630R.string.AttachSticker));
        }
