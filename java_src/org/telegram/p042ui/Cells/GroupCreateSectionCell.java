...
public class GroupCreateSectionCell extends FrameLayout {
    ...
    public GroupCreateSectionCell(Context context) {
        ...
        Drawable drawable = getResources().getDrawable(C3630R.C3632drawable.shadowdown);
    ...
    protected void onDraw(Canvas canvas) {
        this.drawable.setBounds(0, getMeasuredHeight() - AndroidUtilities.m102dp(3), getMeasuredWidth(), getMeasuredHeight());
