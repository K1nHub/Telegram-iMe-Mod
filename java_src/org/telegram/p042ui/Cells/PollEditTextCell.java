...
public class PollEditTextCell extends FrameLayout {
    ...
    public PollEditTextCell(Context context, boolean z, View.OnClickListener onClickListener) {
        ...
        if (z) {
            EditTextCaption editTextCaption = new EditTextCaption(context, null) { // from class: org.telegram.ui.Cells.PollEditTextCell.1
                ...
                @Override // org.telegram.p042ui.Components.EditTextCaption, org.telegram.p042ui.Components.EditTextBoldCursor, org.telegram.p042ui.Components.EditTextEffects, android.widget.TextView, android.view.View
                ...
                @Override // org.telegram.p042ui.Components.EditTextCaption, org.telegram.p042ui.Components.EditTextBoldCursor, android.view.View
        ...
        this.textView.setPadding(AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(11));
        if (onClickListener != null) {
            ...
            this.moveImageView.setImageResource(C3630R.C3632drawable.poll_reorder);
            ...
            this.deleteImageView.setImageResource(C3630R.C3632drawable.poll_remove);
            ...
            this.deleteImageView.setContentDescription(LocaleController.getString("Delete", C3630R.string.Delete));
            ...
            this.checkBox.setContentDescription(LocaleController.getString("AccDescrQuizCorrectAnswer", C3630R.string.AccDescrQuizCorrectAnswer));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (imageView != null) {
            imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48), 1073741824));
        }
        ImageView imageView2 = this.moveImageView;
        if (imageView2 != null) {
            imageView2.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48), 1073741824));
        }
        SimpleTextView simpleTextView = this.textView2;
        if (simpleTextView != null) {
            simpleTextView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(24), 1073741824));
        }
        CheckBox2 checkBox2 = this.checkBox;
        if (checkBox2 != null) {
            checkBox2.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48), 1073741824));
        }
        ...
        this.textView.measure(View.MeasureSpec.makeMeasureSpec(((size - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m102dp(i3), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
        int measuredHeight = this.textView.getMeasuredHeight();
        setMeasuredDimension(size, Math.max(AndroidUtilities.m102dp(50), this.textView.getMeasuredHeight()) + (this.needDivider ? 1 : 0));
        SimpleTextView simpleTextView2 = this.textView2;
        if (simpleTextView2 == null || this.alwaysShowText2) {
            return;
        }
        simpleTextView2.setAlpha(measuredHeight >= AndroidUtilities.m102dp(52) ? 1.0f : BitmapDescriptorFactory.HUE_RED);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider && drawDivider()) {
            if (LocaleController.isRTL) {
                m102dp = BitmapDescriptorFactory.HUE_RED;
            } else {
                m102dp = AndroidUtilities.m102dp(this.moveImageView != null ? 63 : 20);
            }
            float f = m102dp;
            float measuredHeight2 = getMeasuredHeight() - 1;
            int measuredWidth2 = getMeasuredWidth();
            if (LocaleController.isRTL) {
                i = AndroidUtilities.m102dp(this.moveImageView == null ? 20 : 63);
            } else {
                i = 0;
            }
