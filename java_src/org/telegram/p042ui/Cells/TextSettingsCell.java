...
public class TextSettingsCell extends FrameLayout {
    ...
    public TextSettingsCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.valueTextView.setTextSize(AndroidUtilities.m102dp(16));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.imageView.getVisibility() == 0) {
            if (this.imageViewIsColorful) {
                this.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(28), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(28), 1073741824));
            } else {
        ...
        if (this.valueTextView.getVisibility() == 0) {
            ...
            measuredWidth = (measuredWidth - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m102dp(8);
            if (this.valueImageView.getVisibility() == 0) {
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.valueImageView.getLayoutParams();
                if (LocaleController.isRTL) {
                    marginLayoutParams.leftMargin = AndroidUtilities.m102dp(this.padding + 4) + this.valueTextView.getMeasuredWidth();
                } else {
                    marginLayoutParams.rightMargin = AndroidUtilities.m102dp(this.padding + 4) + this.valueTextView.getMeasuredWidth();
                }
            }
        }
    ...
    public void setIcon(int i) {
        ...
        if (i == 0) {
            this.imageView.setVisibility(8);
            if (LocaleController.isRTL) {
                marginLayoutParams.rightMargin = AndroidUtilities.m102dp(this.padding);
                return;
            } else {
                marginLayoutParams.leftMargin = AndroidUtilities.m102dp(this.padding);
                return;
            }
        }
        ...
        if (LocaleController.isRTL) {
            marginLayoutParams.rightMargin = AndroidUtilities.m102dp(71);
        } else {
            marginLayoutParams.leftMargin = AndroidUtilities.m102dp(71);
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (z || this.drawLoadingProgress != BitmapDescriptorFactory.HUE_RED) {
            ...
            rectF.set((getMeasuredWidth() - AndroidUtilities.m102dp(this.padding)) - AndroidUtilities.m102dp(this.loadingSize), measuredHeight - AndroidUtilities.m102dp(3), getMeasuredWidth() - AndroidUtilities.m102dp(this.padding), measuredHeight + AndroidUtilities.m102dp(3));
            if (LocaleController.isRTL) {
        ...
        if (this.needDivider) {
            int m102dp = AndroidUtilities.m102dp(this.imageView.getVisibility() == 0 ? 71 : 20);
            if (!LocaleController.isRTL) {
                f = m102dp;
            }
            canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? m102dp : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
