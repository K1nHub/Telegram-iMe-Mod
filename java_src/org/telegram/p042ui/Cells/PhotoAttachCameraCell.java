...
public class PhotoAttachCameraCell extends FrameLayout {
    ...
    public PhotoAttachCameraCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.imageView.setImageResource(C3630R.C3632drawable.instant_camera);
        addView(this.imageView, LayoutHelper.createFrame(80, 80));
        setFocusable(true);
        this.itemSize = AndroidUtilities.m102dp(0);
    }

    @Override // android.widget.FrameLayout, android.view.View
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m102dp(5), 1073741824), View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m102dp(5), 1073741824));
    }
    ...
    public void updateBitmap() {
        ...
        if (bitmap != null) {
            ...
            this.backgroundView.setImageResource(C3630R.C3632drawable.icplaceholder);
        }
    }
