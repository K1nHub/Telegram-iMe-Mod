...
public class TextInfoPrivacyCell extends FrameLayout {
    ...
    public TextInfoPrivacyCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        LinkSpanDrawable.LinksTextView linksTextView = new LinkSpanDrawable.LinksTextView(context, linkCollector, resourcesProvider) { // from class: org.telegram.ui.Cells.TextInfoPrivacyCell.1
            ...
            @Override // org.telegram.p042ui.Components.LinkSpanDrawable.LinksTextView, android.widget.TextView, android.view.View
        ...
        this.textView.setPadding(0, AndroidUtilities.m102dp(10), 0, AndroidUtilities.m102dp(17));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.fixedSize != 0) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(this.fixedSize), 1073741824));
        } else {
    ...
    public void setText(CharSequence charSequence) {
        ...
        if (charSequence == null) {
            this.textView.setPadding(0, AndroidUtilities.m102dp(2), 0, 0);
        } else {
            this.textView.setPadding(0, AndroidUtilities.m102dp(this.topPadding), 0, AndroidUtilities.m102dp(this.bottomPadding));
        }
