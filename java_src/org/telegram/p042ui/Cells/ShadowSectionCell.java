...
public class ShadowSectionCell extends View {
    ...
    private int getBackgroundResId() {
        boolean z = this.top;
        if (z && this.bottom) {
            return C3630R.C3632drawable.greydivider;
        }
        if (z) {
            return C3630R.C3632drawable.greydivider_bottom;
        }
        if (this.bottom) {
            return C3630R.C3632drawable.greydivider_top;
        }
        return C3630R.C3632drawable.transparent;
    }
