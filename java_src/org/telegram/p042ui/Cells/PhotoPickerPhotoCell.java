...
public class PhotoPickerPhotoCell extends FrameLayout {
    ...
    public PhotoPickerPhotoCell(Context context) {
        ...
        this.videoInfoContainer.setPadding(AndroidUtilities.m102dp(3), 0, AndroidUtilities.m102dp(3), 0);
        addView(this.videoInfoContainer, LayoutHelper.createFrame(-1, 16, 83));
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C3630R.C3632drawable.ic_video);
    ...
    public void setImage(MediaController.PhotoEntry photoEntry) {
        Drawable drawable = getResources().getDrawable(C3630R.C3632drawable.nophotos);
        ...
        if (str != null) {
            ...
            if (photoEntry.isVideo) {
                ...
                setContentDescription(LocaleController.getString("AttachVideo", C3630R.string.AttachVideo) + ", " + LocaleController.formatDuration(photoEntry.duration));
                BackupImageView backupImageView = this.imageView;
                backupImageView.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, drawable);
                return;
            }
            this.videoInfoContainer.setVisibility(4);
            setContentDescription(LocaleController.getString("AttachPhoto", C3630R.string.AttachPhoto));
