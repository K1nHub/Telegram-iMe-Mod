...
public class LocationLoadingCell extends FrameLayout {
    ...
    public LocationLoadingCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C3630R.C3632drawable.location_empty);
        ...
        this.textView.setText(LocaleController.getString("NoPlacesFound", C3630R.string.NoPlacesFound));
        addView(this.textView, LayoutHelper.createFrame(-2, -2, 17, 0, 34, 0, 0));
    }

    @Override // android.widget.FrameLayout, android.view.View
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec((int) (AndroidUtilities.m102dp(56) * 2.5f), 1073741824));
    }
