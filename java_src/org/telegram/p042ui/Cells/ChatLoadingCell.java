...
public class ChatLoadingCell extends FrameLayout {
    ...
    public ChatLoadingCell(Context context, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.setBackground(Theme.createServiceDrawable(AndroidUtilities.m102dp(18), this.frameLayout, view, getThemedPaint("paintChatActionBackground")));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(44), 1073741824));
    }
