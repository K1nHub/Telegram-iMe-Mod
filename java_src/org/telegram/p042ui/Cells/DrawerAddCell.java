...
public class DrawerAddCell extends FrameLayout {
    ...
    public DrawerAddCell(Context context) {
        ...
        this.textView.setCompoundDrawablePadding(AndroidUtilities.m102dp(29));
    ...
    protected void onAttachedToWindow() {
        ...
        this.textView.setText(LocaleController.getString("AddAccount", C3630R.string.AddAccount));
        Drawable drawable = getResources().getDrawable(C3630R.C3632drawable.msg_add);
        if (drawable != null) {
