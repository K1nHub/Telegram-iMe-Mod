...
public class AccountSelectCell extends FrameLayout {
    ...
    public AccountSelectCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            this.infoTextView.setMaxWidth(AndroidUtilities.m102dp(320));
        ...
        imageView.setImageResource(C3630R.C3632drawable.account_check);
    ...
    protected void onMeasure(int i, int i2) {
        if (this.checkImageView != null || (this.infoTextView != null && getLayoutParams().width != -2)) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(56), 1073741824));
        } else {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(56), 1073741824));
        }
    }
