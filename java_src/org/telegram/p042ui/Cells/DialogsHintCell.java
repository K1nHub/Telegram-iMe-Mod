...
public class DialogsHintCell extends FrameLayout {
    ...
    public DialogsHintCell(Context context) {
        ...
        setPadding(AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(8));
        LinearLayout linearLayout = new LinearLayout(context);
        this.contentView = linearLayout;
        linearLayout.setOrientation(1);
        this.contentView.setPadding(LocaleController.isRTL ? AndroidUtilities.m102dp(24) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m102dp(24), 0);
        ...
        imageView.setImageResource(C3630R.C3632drawable.arrow_newchat);
    ...
    public int height() {
        ...
        if (this.height <= 0) {
            this.height = AndroidUtilities.m102dp(72) + 1;
        }
        return this.height;
    }
}
