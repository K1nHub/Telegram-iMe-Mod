...
public class MaxFileSizeCell extends FrameLayout {
    ...
    public MaxFileSizeCell(Context context) {
        ...
        this.seekBarView.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.telegram.ui.Cells.MaxFileSizeCell.2
            ...
            public void onSeekBarDrag(boolean z, float f) {
                ...
                if (f <= 0.25f) {
                    ...
                    if (f < 0.25f) {
                        ...
                        if (f > 0.25f) {
                            ...
                            long j = i;
                            MaxFileSizeCell.this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C3630R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j)));
                ...
                i = (int) (f2 + ((f / 0.25f) * f3));
                long j2 = i;
                MaxFileSizeCell.this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C3630R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j2)));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(80), 1073741824));
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m102dp(80));
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m102dp(42);
        this.sizeTextView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(30), 1073741824));
        this.textView.measure(View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m102dp(10), (measuredWidth - this.sizeTextView.getMeasuredWidth()) - AndroidUtilities.m102dp(8)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(30), 1073741824));
        this.seekBarView.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth() - AndroidUtilities.m102dp(20), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(30), 1073741824));
    }
    ...
    public void setSize(long j) {
        ...
        float f;
        this.currentSize = j;
        this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C3630R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j)));
        long j2 = j - 512000;
        if (j2 < 536576) {
