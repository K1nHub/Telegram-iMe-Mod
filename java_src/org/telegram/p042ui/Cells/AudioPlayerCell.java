...
public class AudioPlayerCell extends View implements DownloadController.FileDownloadProgressListener {
    ...
    public AudioPlayerCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        this.titleY = AndroidUtilities.m102dp(9);
        this.descriptionY = AndroidUtilities.m102dp(29);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m102dp(AndroidUtilities.leftBaseline)) - AndroidUtilities.m102dp(28);
        try {
            String musicTitle = this.currentMessageObject.getMusicTitle();
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(musicTitle.replace('\n', ' '), Theme.chat_contextResult_titleTextPaint, Math.min((int) Math.ceil(Theme.chat_contextResult_titleTextPaint.measureText(musicTitle)), size), TextUtils.TruncateAt.END), Theme.chat_contextResult_titleTextPaint, size + AndroidUtilities.m102dp(4), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        try {
            ...
            StaticLayout staticLayout2 = new StaticLayout(TextUtils.ellipsize(replace, Theme.chat_contextResult_descriptionTextPaint, size, TextUtils.TruncateAt.END), Theme.chat_contextResult_descriptionTextPaint, size + AndroidUtilities.m102dp(4), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m102dp(56));
        int size2 = LocaleController.isRTL ? (View.MeasureSpec.getSize(i) - AndroidUtilities.m102dp(8)) - AndroidUtilities.m102dp(52) : AndroidUtilities.m102dp(8);
        RadialProgress2 radialProgress2 = this.radialProgress;
        int m102dp = AndroidUtilities.m102dp(4) + size2;
        this.buttonX = m102dp;
        int m102dp2 = AndroidUtilities.m102dp(6);
        this.buttonY = m102dp2;
        radialProgress2.setProgressRect(m102dp, m102dp2, size2 + AndroidUtilities.m102dp(48), AndroidUtilities.m102dp(50));
    }
    ...
    */
    private boolean checkAudioMotionEvent(android.view.MotionEvent r9) {
        ...
        L7f:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.AudioPlayerCell.checkAudioMotionEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.currentMessageObject.isMusic()) {
            accessibilityNodeInfo.setText(LocaleController.formatString("AccDescrMusicInfo", C3630R.string.AccDescrMusicInfo, this.currentMessageObject.getMusicAuthor(), this.currentMessageObject.getMusicTitle()));
            return;
        }
