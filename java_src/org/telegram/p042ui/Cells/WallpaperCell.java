...
/* renamed from: org.telegram.ui.Cells.WallpaperCell */
...
public class WallpaperCell extends FrameLayout {
    ...
    /* renamed from: org.telegram.ui.Cells.WallpaperCell$WallpaperView */
    /* loaded from: classes5.dex */
    public class WallpaperView extends FrameLayout {
        ...
        public WallpaperView(Context context) {
            ...
            BackupImageView backupImageView = new BackupImageView(context, WallpaperCell.this) { // from class: org.telegram.ui.Cells.WallpaperCell.WallpaperView.1
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    if (WallpaperView.this.isSelected) {
                        ...
                        canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m102dp(20), WallpaperCell.this.circlePaint);
            ...
            imageView.setImageResource(C3630R.C3632drawable.ic_gallery_background);
            ...
            CheckBox checkBox = new CheckBox(context, C3630R.C3632drawable.round_check2);
            this.checkBox = checkBox;
            checkBox.setVisibility(4);
            this.checkBox.setColor(Theme.getColor(Theme.key_checkbox), Theme.getColor(Theme.key_checkboxCheck));
            addView(this.checkBox, LayoutHelper.createFrame(22, 22, 53, 0, 2, 2, 0));
        }
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            if (obj instanceof TLRPC$TL_wallPaper) {
                ...
                TLRPC$PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(tLRPC$TL_wallPaper.document.thumbs, AndroidUtilities.m102dp(100));
                TLRPC$PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tLRPC$TL_wallPaper.document.thumbs, AndroidUtilities.m102dp(180));
                ...
                if (colorWallpaper.path != null || colorWallpaper.pattern != null || "d".equals(colorWallpaper.slug)) {
                    if (colorWallpaper.gradientColor2 != 0) {
                        ...
                        if (colorWallpaper.intensity >= BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if ("d".equals(colorWallpaper.slug)) {
                        if (colorWallpaper.defaultCache == null) {
                            colorWallpaper.defaultCache = SvgHelper.getBitmap(C3630R.raw.default_pattern, 100, 180, -16777216);
                        }
                ...
                if (tLRPC$Photo != null) {
                    TLRPC$PhotoSize closestPhotoSizeWithSize4 = FileLoader.getClosestPhotoSizeWithSize(tLRPC$Photo.sizes, AndroidUtilities.m102dp(100));
                    TLRPC$PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.m102dp(180));
    ...
    public WallpaperCell(Context context, int i) {
        ...
        while (true) {
            ...
            if (i2 < wallpaperViewArr.length) {
                ...
                this.checkDrawable = context.getResources().getDrawable(C3630R.C3632drawable.background_selected).mutate();
    ...
    protected void onMeasure(int i, int i2) {
        int i3 = 0;
        if (this.spanCount == 1) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.size, 1073741824), View.MeasureSpec.makeMeasureSpec(this.size + AndroidUtilities.m102dp(6), 1073741824));
            setPadding(0, 0, 0, AndroidUtilities.m102dp(6));
            return;
        }
        int size = View.MeasureSpec.getSize(i);
        int m102dp = size - AndroidUtilities.m102dp(((this.spanCount - 1) * 6) + 28);
        int i4 = m102dp / this.spanCount;
        int m102dp2 = this.currentType == 0 ? AndroidUtilities.m102dp(180) : i4;
        setMeasuredDimension(size, (this.isTop ? AndroidUtilities.m102dp(14) : 0) + m102dp2 + AndroidUtilities.m102dp(this.isBottom ? 14 : 6));
        while (true) {
            int i5 = this.spanCount;
            if (i3 >= i5) {
                return;
            }
            this.wallpaperViews[i3].measure(View.MeasureSpec.makeMeasureSpec(i3 == i5 + (-1) ? m102dp : i4, 1073741824), View.MeasureSpec.makeMeasureSpec(m102dp2, 1073741824));
            m102dp -= i4;
            i3++;
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int m102dp2 = this.isTop ? AndroidUtilities.m102dp(14) : 0;
        for (int i5 = 0; i5 < this.spanCount; i5++) {
            int measuredWidth = this.wallpaperViews[i5].getMeasuredWidth();
            WallpaperView[] wallpaperViewArr = this.wallpaperViews;
            wallpaperViewArr[i5].layout(m102dp, m102dp2, m102dp + measuredWidth, wallpaperViewArr[i5].getMeasuredHeight() + m102dp2);
            m102dp += measuredWidth + AndroidUtilities.m102dp(6);
        }
    }
