...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ProfileSearchCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.countTop = AndroidUtilities.m102dp(19);
        this.avatarStoryParams = new StoriesUtilities.AvatarStoryParams(false);
        this.rect = new RectF();
        this.resourcesProvider = resourcesProvider;
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.avatarImage = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.m102dp(23));
        ...
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this, AndroidUtilities.m102dp(20));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m102dp(60) + (this.useSeparator ? 1 : 0));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.checkBox != null) {
            int m102dp = LocaleController.isRTL ? (i3 - i) - AndroidUtilities.m102dp(42) : AndroidUtilities.m102dp(42);
            int m102dp2 = AndroidUtilities.m102dp(36);
            CheckBox2 checkBox2 = this.checkBox;
            checkBox2.layout(m102dp, m102dp2, checkBox2.getMeasuredWidth() + m102dp, this.checkBox.getMeasuredHeight() + m102dp2);
        }
        if (z) {
            buildLayout();
        }
    ...
    public void buildLayout() {
        ...
        if (this.encryptedChat != null) {
            ...
            this.dialog_id = DialogObject.makeEncryptedDialogId(tLRPC$EncryptedChat.f1612id);
            if (!LocaleController.isRTL) {
                this.nameLockLeft = AndroidUtilities.m102dp(AndroidUtilities.leftBaseline);
                this.nameLeft = AndroidUtilities.m102dp(AndroidUtilities.leftBaseline + 4) + Theme.dialogs_lockDrawable.getIntrinsicWidth();
            } else {
                this.nameLockLeft = (getMeasuredWidth() - AndroidUtilities.m102dp(AndroidUtilities.leftBaseline + 2)) - Theme.dialogs_lockDrawable.getIntrinsicWidth();
                this.nameLeft = AndroidUtilities.m102dp(11);
            }
            this.nameLockTop = AndroidUtilities.m103dp(22.0f);
            updateStatus(false, null, false);
        } else {
            TLRPC$Chat tLRPC$Chat = this.chat;
            if (tLRPC$Chat != null) {
                this.dialog_id = -tLRPC$Chat.f1600id;
                this.drawCheck = tLRPC$Chat.verified;
                if (!LocaleController.isRTL) {
                    this.nameLeft = AndroidUtilities.m102dp(AndroidUtilities.leftBaseline);
                } else {
                    this.nameLeft = AndroidUtilities.m102dp(11);
                }
                ...
                if (tLRPC$User != null) {
                    this.dialog_id = tLRPC$User.f1762id;
                    if (!LocaleController.isRTL) {
                        this.nameLeft = AndroidUtilities.m102dp(AndroidUtilities.leftBaseline);
                    } else {
                        this.nameLeft = AndroidUtilities.m102dp(11);
                    }
                    this.nameLockTop = AndroidUtilities.m102dp(21);
        ...
        if (!LocaleController.isRTL) {
            this.statusLeft = AndroidUtilities.m102dp(AndroidUtilities.leftBaseline);
        } else {
            this.statusLeft = AndroidUtilities.m102dp(11);
        }
        ...
        if (str4 == null) {
            ...
            if (tLRPC$Chat2 != null) {
                ...
                if (tLRPC$User2 == null) {
                    ...
                    str3 = LocaleController.getString("SavedMessages", C3630R.string.SavedMessages);
                } else {
        ...
        if (str4.length() == 0) {
            ...
            if (tLRPC$User3 != null && (str2 = tLRPC$User3.phone) != null && str2.length() != 0) {
                str4 = C3545PhoneFormat.getInstance().format("+" + this.user.phone);
            } else {
                str4 = LocaleController.getString("HiddenName", C3630R.string.HiddenName);
            }
        }
        if (this.encryptedChat != null) {
        ...
        if (!LocaleController.isRTL) {
            measuredWidth = (getMeasuredWidth() - this.nameLeft) - AndroidUtilities.m102dp(14);
            this.nameWidth = measuredWidth;
        } else {
            measuredWidth = (getMeasuredWidth() - this.nameLeft) - AndroidUtilities.m102dp(AndroidUtilities.leftBaseline);
            this.nameWidth = measuredWidth;
        }
        if (this.drawNameLock) {
            this.nameWidth -= AndroidUtilities.m102dp(6) + Theme.dialogs_lockDrawable.getIntrinsicWidth();
        }
        if (this.contact != null) {
            TextPaint textPaint3 = Theme.dialogs_countTextPaint;
            int i = C3630R.string.Invite;
            ...
            if (!LocaleController.isRTL) {
                this.actionLeft = ((getMeasuredWidth() - measureText) - AndroidUtilities.m102dp(19)) - AndroidUtilities.m102dp(16);
            } else {
                this.actionLeft = AndroidUtilities.m102dp(19) + AndroidUtilities.m102dp(16);
                this.nameLeft += measureText;
                this.statusLeft += measureText;
            }
            this.nameWidth -= AndroidUtilities.m102dp(32) + measureText;
        }
        ...
        if (this.promoSubscribeIcon != null) {
            ...
            if (!LocaleController.isRTL) {
                this.promoSubscribeIconLeft = (getMeasuredWidth() - this.promoSubscribeIconSize) - AndroidUtilities.m102dp(19);
            } else {
                this.countLeft = AndroidUtilities.m102dp(19);
        ...
        if (this.drawCount) {
            ...
            if (dialogUnreadCount != 0) {
                ...
                this.countWidth = Math.max(AndroidUtilities.m102dp(12), (int) Math.ceil(Theme.dialogs_countTextPaint.measureText(format)));
                ...
                int m102dp2 = this.countWidth + AndroidUtilities.m102dp(18);
                this.nameWidth -= m102dp2;
                paddingLeft -= m102dp2;
                if (!LocaleController.isRTL) {
                    this.countLeft = (getMeasuredWidth() - this.countWidth) - AndroidUtilities.m102dp(19);
                } else {
                    this.countLeft = AndroidUtilities.m102dp(19);
                    this.nameLeft += m102dp2;
                    this.statusLeft += m102dp2;
                }
            } else {
        ...
        CharSequence ellipsize = TextUtils.ellipsize(str4, textPaint2, this.nameWidth - AndroidUtilities.m102dp(12), TextUtils.TruncateAt.END);
        if (ellipsize != null) {
            ellipsize = Emoji.replaceEmoji(ellipsize, textPaint2.getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
        }
        ...
        if (tLRPC$Chat3 == null || this.subLabel != null) {
            ...
            if (charSequence != null) {
                ...
                if (tLRPC$User4 == null) {
                    ...
                    str = LocaleController.getString("SupportStatus", C3630R.string.SupportStatus);
                } else {
                    TLRPC$User tLRPC$User5 = this.user;
                    if (tLRPC$User5.bot) {
                        str = LocaleController.getString("Bot", C3630R.string.Bot);
                    } else {
                        long j = tLRPC$User5.f1762id;
                        if (j == 333000 || j == 777000) {
                            str = LocaleController.getString("ServiceNotifications", C3630R.string.ServiceNotifications);
                        } else {
                            ...
                            if (tLRPC$User6 != null && (tLRPC$User6.f1762id == UserConfig.getInstance(this.currentAccount).getClientUserId() || ((tLRPC$UserStatus = this.user.status) != null && tLRPC$UserStatus.expires > ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()))) {
                                textPaint4 = Theme.dialogs_onlinePaint;
                                str = LocaleController.getString("Online", C3630R.string.Online);
                            }
                        }
                    }
                }
            ...
            if (this.savedMessages || UserObject.isReplyUser(this.user)) {
                this.nameTop = AndroidUtilities.m102dp(20);
                str = null;
            }
        } else {
            if (this.albumMode) {
                str = LocaleController.getInternalString(C3630R.string.cloud_album).toLowerCase();
            } else {
                if (ChatObject.isChannel(tLRPC$Chat3)) {
                    ...
                    if (!tLRPC$Chat4.megagroup) {
                        ...
                        if (i2 != 0) {
                            ...
                            str = LocaleController.getString("ChannelPrivate", C3630R.string.ChannelPrivate).toLowerCase();
                        } else {
                            str = LocaleController.getString("ChannelPublic", C3630R.string.ChannelPublic).toLowerCase();
                        }
                    }
                }
                ...
                if (i3 != 0) {
                    ...
                    str = LocaleController.getString("MegaLocation", C3630R.string.MegaLocation);
                } else if (!ChatObject.isPublic(tLRPC$Chat5)) {
                    str = LocaleController.getString("MegaPrivate", C3630R.string.MegaPrivate).toLowerCase();
                } else {
                    str = LocaleController.getString("MegaPublic", C3630R.string.MegaPublic).toLowerCase();
                }
            }
            this.nameTop = AndroidUtilities.m102dp(19);
        }
        if (!TextUtils.isEmpty(str)) {
            this.statusLayout = new StaticLayout(TextUtils.ellipsize(str, textPaint4, paddingLeft - AndroidUtilities.m102dp(12), TextUtils.TruncateAt.END), textPaint4, paddingLeft, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            this.nameTop = AndroidUtilities.m102dp(9);
            this.nameLockTop -= AndroidUtilities.m102dp(10);
        } else {
            this.nameTop = AndroidUtilities.m102dp(20);
            this.statusLayout = null;
        }
        if (LocaleController.isRTL) {
            m102dp = (getMeasuredWidth() - AndroidUtilities.m102dp(57)) - getPaddingRight();
        } else {
            m102dp = AndroidUtilities.m102dp(11) + getPaddingLeft();
        }
        this.avatarStoryParams.originalAvatarRect.set(m102dp, AndroidUtilities.m102dp(7), m102dp + AndroidUtilities.m102dp(46), AndroidUtilities.m102dp(7) + AndroidUtilities.m102dp(46));
        if (LocaleController.isRTL) {
    ...
    */
    public void update(int r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.ProfileSearchCell.update(int):void");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.useSeparator) {
            if (LocaleController.isRTL) {
                canvas.drawLine(BitmapDescriptorFactory.HUE_RED, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.m102dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, Theme.dividerPaint);
            } else {
                canvas.drawLine(AndroidUtilities.m102dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
        if (this.drawNameLock) {
        ...
        if (this.nameLayout != null) {
            ...
            if (LocaleController.isRTL) {
                if (this.nameLayout.getLineLeft(0) == BitmapDescriptorFactory.HUE_RED) {
                    lineRight = (this.nameLeft - AndroidUtilities.m102dp(3)) - this.statusDrawable.getIntrinsicWidth();
                } else {
                    lineRight = (int) ((((this.nameLeft + this.nameWidth) - Math.ceil(this.nameLayout.getLineWidth(0))) - AndroidUtilities.m102dp(3)) - this.statusDrawable.getIntrinsicWidth());
                }
            } else {
                lineRight = (int) (this.nameLeft + this.nameLayout.getLineRight(0) + AndroidUtilities.m102dp(6));
            }
        ...
        if (this.statusLayout != null) {
            canvas.save();
            canvas.translate(this.statusLeft + this.sublabelOffsetX, AndroidUtilities.m102dp(33) + this.sublabelOffsetY);
            this.statusLayout.draw(canvas);
            canvas.restore();
        }
        if (this.countLayout != null) {
            int m103dp = this.countLeft - AndroidUtilities.m103dp(5.5f);
            this.rect.set(m103dp, this.countTop, m103dp + this.countWidth + AndroidUtilities.m102dp(11), this.countTop + AndroidUtilities.m102dp(23));
            ...
            canvas.save();
            canvas.translate(this.countLeft, this.countTop + AndroidUtilities.m102dp(4));
        ...
        if (this.actionLayout != null) {
            ...
            rectF2.set(i, this.countTop, i + this.actionLayout.getWidth(), this.countTop + AndroidUtilities.m102dp(23));
            rectF2.inset(-AndroidUtilities.m102dp(16), -AndroidUtilities.m102dp(4));
            this.actionButton.setRect(rectF2);
            this.actionButton.setRounded(true);
            this.actionButton.draw(canvas);
            canvas.save();
            canvas.translate(this.actionLeft, this.countTop + AndroidUtilities.m102dp(4));
            this.actionLayout.draw(canvas);
            canvas.restore();
        }
        TLRPC$User tLRPC$User = this.user;
        if (tLRPC$User != null) {
            StoriesUtilities.drawAvatarWithStory(tLRPC$User.f1762id, canvas, this.avatarImage, this.avatarStoryParams);
        } else {
            TLRPC$Chat tLRPC$Chat = this.chat;
            if (tLRPC$Chat != null) {
                StoriesUtilities.drawAvatarWithStory(-tLRPC$Chat.f1600id, canvas, this.avatarImage, this.avatarStoryParams);
            } else {
