...
public class StickerEmojiCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, RecyclerListViewWithOverlayDraw.OverlayView {
    ...
    public StickerEmojiCell(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.premiumIconView.setPadding(AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4));
    ...
    public MessageObject.SendAnimationData getSendAnimationData() {
        ...
        if (imageReceiver.hasNotThumb()) {
            ...
            sendAnimationData.f1535x = imageReceiver.getCenterX() + iArr[0];
            sendAnimationData.f1536y = imageReceiver.getCenterY() + iArr[1];
    ...
    public void setSticker(TLRPC$Document tLRPC$Document, SendMessagesHelper.ImportingSticker importingSticker, Object obj, String str, boolean z) {
        ...
        if (importingSticker != null) {
            ...
            if (str != null) {
                ...
                textView.setText(Emoji.replaceEmoji(str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(16), false));
            ...
            if (tLRPC$Document != null) {
                ...
                if (str != null) {
                    ...
                    textView2.setText(Emoji.replaceEmoji(str, textView2.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(16), false));
                    this.emojiTextView.setVisibility(0);
                } else if (z) {
                    int i2 = 0;
                    while (true) {
                        ...
                        if (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeSticker) {
                            ...
                            if (str3 != null && str3.length() > 0) {
                                ...
                                textView3.setText(Emoji.replaceEmoji(tLRPC$DocumentAttribute.alt, textView3.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(16), false));
                                z3 = true;
                            }
                        } else {
                            i2++;
                    ...
                    z3 = false;
                    if (!z3) {
                        this.emojiTextView.setText(Emoji.replaceEmoji(MediaDataController.getInstance(this.currentAccount).getEmojiForSticker(this.sticker.f1608id), this.emojiTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(16), false));
                    }
                    this.emojiTextView.setVisibility(0);
                } else {
    ...
    private void updatePremiumStatus(boolean z) {
        ...
        if (!UserConfig.getInstance(this.currentAccount).isPremium()) {
            ...
            layoutParams.bottomMargin = AndroidUtilities.m102dp(8);
            this.premiumIconView.setPadding(AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4));
        } else {
            int m102dp2 = AndroidUtilities.m102dp(16);
            layoutParams.width = m102dp2;
            layoutParams.height = m102dp2;
            layoutParams.gravity = 85;
            layoutParams.bottomMargin = AndroidUtilities.m102dp(8);
            layoutParams.rightMargin = AndroidUtilities.m102dp(8);
            this.premiumIconView.setPadding(AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1));
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        String string = LocaleController.getString("AttachSticker", C3630R.string.AttachSticker);
            ...
            while (true) {
                ...
                if (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeSticker) {
                    ...
                    if (str != null && str.length() > 0) {
                        TextView textView = this.emojiTextView;
                        textView.setText(Emoji.replaceEmoji(tLRPC$DocumentAttribute.alt, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(16), false));
    ...
    @Override // org.telegram.p042ui.Components.ListView.RecyclerListViewWithOverlayDraw.OverlayView
    ...
    private void drawInternal(View view, Canvas canvas) {
        ...
        int min = Math.min(AndroidUtilities.m102dp(66), Math.min(getMeasuredHeight(), getMeasuredWidth()));
