...
public class ShareDialogCell extends FrameLayout {
    ...
    public ShareDialogCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m102dp(28));
        if (i == 2) {
        ...
        TextView textView = new TextView(this, context) { // from class: org.telegram.ui.Cells.ShareDialogCell.1
            ...
            public void setText(CharSequence charSequence, TextView.BufferType bufferType) {
                super.setText(Emoji.replaceEmoji(charSequence, getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(10), false), bufferType);
            }
        };
        ...
        setBackground(Theme.createRadSelectorDrawable(Theme.getColor(Theme.key_listSelector), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2)));
    }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(this.currentType == 2 ? 95 : 103), 1073741824));
    }
    ...
    public void setDialog(long j, boolean z, CharSequence charSequence) {
        if (DialogObject.isUserDialog(j)) {
            ...
            if (this.currentType != 2 && UserObject.isReplyUser(this.user)) {
                this.nameTextView.setText(LocaleController.getString("RepliesTitle", C3630R.string.RepliesTitle));
                ...
                this.nameTextView.setText(LocaleController.getString("SavedMessages", C3630R.string.SavedMessages));
            ...
            this.imageView.setRoundRadius(AndroidUtilities.m102dp(28));
        } else {
            this.user = null;
            ...
            if (this.currentType != 2 && chat != null && ChatObject.isTemplatesChat(this.currentAccount, chat.f1600id)) {
                this.nameTextView.setText(LocaleController.getInternalString(C3630R.string.chat_templates));
            ...
            this.imageView.setRoundRadius((chat == null || !chat.forum) ? AndroidUtilities.m102dp(28) : AndroidUtilities.m102dp(16));
        }
    ...
    public void setTopic(TLRPC$TL_forumTopic tLRPC$TL_forumTopic, boolean z) {
        ...
        int i = C3630R.C3633id.spring_tag;
        ...
        if (z) {
            ...
            this.nameTextView.setTranslationX(AndroidUtilities.m102dp(10));
        } else {
            this.topicTextView.setAlpha(BitmapDescriptorFactory.HUE_RED);
            this.nameTextView.setAlpha(1.0f);
            this.topicTextView.setTranslationX(-AndroidUtilities.m102dp(10));
    ...
    public /* synthetic */ void lambda$setTopic$1(DynamicAnimation dynamicAnimation, float f, float f2) {
        ...
        this.topicTextView.setTranslationX(f4 * (-AndroidUtilities.m102dp(10)));
        this.nameTextView.setTranslationX(f3 * AndroidUtilities.m102dp(10));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTopic$2(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
        this.topicTextView.setTag(C3630R.C3633id.spring_tag, null);
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.imageView && this.currentType != 2 && (tLRPC$User = this.user) != null && !MessagesController.isSupportUser(tLRPC$User)) {
            ...
            boolean z = (tLRPC$User2.self || tLRPC$User2.bot || (((tLRPC$UserStatus = tLRPC$User2.status) == null || tLRPC$UserStatus.expires <= ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()) && !MessagesController.getInstance(this.currentAccount).onlinePrivacy.containsKey(Long.valueOf(this.user.f1762id)))) ? false : true;
            if (z || this.onlineProgress != BitmapDescriptorFactory.HUE_RED) {
                int bottom = this.imageView.getBottom() - AndroidUtilities.m102dp(6);
                int right = this.imageView.getRight() - AndroidUtilities.m102dp(10);
                ...
                float f = right;
                float f2 = bottom;
                canvas.drawCircle(f, f2, AndroidUtilities.m102dp(7) * this.onlineProgress, Theme.dialogs_onlineCirclePaint);
                Theme.dialogs_onlineCirclePaint.setColor(getThemedColor(Theme.key_chats_onlineCircle));
                canvas.drawCircle(f, f2, AndroidUtilities.m102dp(5) * this.onlineProgress, Theme.dialogs_onlineCirclePaint);
                if (z) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m102dp = AndroidUtilities.m102dp(this.currentType == 2 ? 24 : 28);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(left - m102dp, top - m102dp, left + m102dp, top + m102dp);
