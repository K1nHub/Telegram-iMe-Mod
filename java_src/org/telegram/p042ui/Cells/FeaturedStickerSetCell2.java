...
public class FeaturedStickerSetCell2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FeaturedStickerSetCell2(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView3.setText(LocaleController.getString("StickersRemove", C3630R.string.StickersRemove));
        ...
        premiumButtonView.setButton(LocaleController.getString("Unlock", C3630R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.FeaturedStickerSetCell2$$ExternalSyntheticLambda0
        ...
        try {
            ...
            ((ViewGroup.MarginLayoutParams) premiumButtonView.getTextView().getLayoutParams()).leftMargin = AndroidUtilities.m102dp(3);
            premiumButtonView.getChildAt(0).setPadding(AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8), 0);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (measuredWidth2 < measuredWidth) {
            layoutParams.rightMargin = AndroidUtilities.m102dp(14) + ((measuredWidth - measuredWidth2) / 2);
        } else {
            layoutParams.rightMargin = AndroidUtilities.m102dp(14);
        }
    ...
    public void setStickersSet(TLRPC$StickerSetCovered tLRPC$StickerSetCovered, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z2) {
            Drawable drawable = new Drawable(this) { // from class: org.telegram.ui.Cells.FeaturedStickerSetCell2.1
                ...
                public void draw(Canvas canvas) {
                    ...
                    canvas.drawCircle(AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(5), AndroidUtilities.m102dp(3), this.paint);
                }
                ...
                public int getIntrinsicHeight() {
                    return AndroidUtilities.m102dp(8);
                }
            };
        ...
        if ((tLRPC$StickerSetCovered instanceof TLRPC$TL_stickerSetNoCovered) && (tLRPC$StickerSet = tLRPC$StickerSetCovered.set) != null) {
            this.waitingForStickerSetId = Long.valueOf(tLRPC$StickerSet.f1634id);
            ...
            if (stickerSet != null && (arrayList = stickerSet.documents) != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    if (i >= stickerSet.documents.size()) {
                        break;
                    } else if (stickerSet.documents.get(i).f1608id == tLRPC$StickerSetCovered.set.thumb_document_id) {
                ...
                if (!tLRPC$StickerSetCovered.covers.isEmpty()) {
                    ...
                    if (tLRPC$StickerSetCovered.set != null) {
                        for (int i2 = 0; i2 < tLRPC$StickerSetCovered.covers.size(); i2++) {
                            if (tLRPC$StickerSetCovered.covers.get(i2).f1608id == tLRPC$StickerSetCovered.set.thumb_document_id) {
                    ...
                    if (!tLRPC$TL_stickerSetFullCovered.documents.isEmpty()) {
                        ...
                        for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                            if (arrayList2.get(i3).f1608id == tLRPC$StickerSetCovered.set.thumb_document_id) {
        ...
        this.isInstalled = z3 || MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(tLRPC$StickerSetCovered.set.f1634id);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m102dp(71), getHeight() - 1, getWidth() - (LocaleController.isRTL ? AndroidUtilities.m102dp(71) : 0), getHeight() - 1, Theme.dividerPaint);
        }
    }
