...
public class SharedAudioCell extends FrameLayout implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public void onSubItemClick(int r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.SharedAudioCell.onSubItemClick(int):void");
    }
    ...
    public /* synthetic */ void lambda$onSubItemClick$2(Uri uri) {
        BulletinFactory.m62of(this, null).createDownloadBulletin(BulletinFactory.FileType.AUDIO).show();
    }
    ...
    public SharedAudioCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.captionY = AndroidUtilities.m102dp(29);
        ...
        if (i == IdFabric$CustomType.SHARED_AUDIO_CELL_MUSIC) {
            this.isInPlaylistMarkDrawable = AppCompatResources.getDrawable(getContext(), C3630R.C3632drawable.msg_tone_on);
        ...
        if (resourcesProvider != null) {
            ...
            this.titlePaint.setTextSize(AndroidUtilities.m102dp(15));
    ...
    public /* synthetic */ void lambda$new$9(View view) {
        ...
        scrimViewBackground.add(z ? C3630R.C3632drawable.msg_tone_off : C3630R.C3632drawable.msg_tone_add, LocaleController.getInternalString(z ? C3630R.string.music_player_remove_from_playlist : C3630R.string.music_player_add_to_playlist), new Runnable() { // from class: org.telegram.ui.Cells.SharedAudioCell$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                SharedAudioCell.this.lambda$new$3();
            }
        }).addIf(!this.isChatNoForwards, C3630R.C3632drawable.msg_forward, LocaleController.getString("Forward", C3630R.string.Forward), new Runnable() { // from class: org.telegram.ui.Cells.SharedAudioCell$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                SharedAudioCell.this.lambda$new$4();
            }
        }).addIf(!this.isChatNoForwards, C3630R.C3632drawable.fork_forward_cloud, LocaleController.getInternalString(C3630R.string.chat_message_popup_option_forward_cloud), new Runnable() { // from class: org.telegram.ui.Cells.SharedAudioCell$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                SharedAudioCell.this.lambda$new$5();
            }
        }).addIf(!this.isChatNoForwards, C3630R.C3632drawable.msg_shareout, LocaleController.getString("ShareFile", C3630R.string.ShareFile), new Runnable() { // from class: org.telegram.ui.Cells.SharedAudioCell$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                SharedAudioCell.this.lambda$new$6();
            }
        }).addIf(!this.isChatNoForwards, C3630R.C3632drawable.msg_download, LocaleController.getString("SaveToMusic", C3630R.string.SaveToMusic), new Runnable() { // from class: org.telegram.ui.Cells.SharedAudioCell$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                SharedAudioCell.this.lambda$new$7();
            }
        }).add(C3630R.C3632drawable.msg_message, LocaleController.getString("ShowInChat", C3630R.string.ShowInChat), new Runnable() { // from class: org.telegram.ui.Cells.SharedAudioCell$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.optionsButton != null) {
            size -= AndroidUtilities.m102dp(48);
        }
        int i4 = size;
        if (this.viewType == 1) {
            ...
            this.dateLayoutX = ((i4 - ceil) - AndroidUtilities.m102dp(8)) + AndroidUtilities.m102dp(20);
            i3 = ceil + AndroidUtilities.m102dp(12);
        } else {
            i3 = 0;
        }
        float f = BitmapDescriptorFactory.HUE_RED;
        try {
            ...
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(replace, textPaint, i4 - i3, TextUtils.TruncateAt.END), textPaint, (AndroidUtilities.m102dp(4) + i4) - i3, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        try {
            if (this.viewType == 1 && (this.currentMessageObject.isVoice() || this.currentMessageObject.isRoundVideo())) {
                ...
                this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(formatDuration, textPaint2, i4, TextUtils.TruncateAt.END), textPaint2, i4 + AndroidUtilities.m102dp(4), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            } else {
                ...
                this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(spannableStringBuilder, textPaint3, i4, TextUtils.TruncateAt.END), textPaint3, i4 + AndroidUtilities.m102dp(4), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            }
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m102dp(56) + (this.captionLayout != null ? AndroidUtilities.m102dp(18) : 0) + (this.needDivider ? 1 : 0));
        ...
        if (this.captionLayout != null) {
            this.captionY = AndroidUtilities.m102dp(29);
            this.descriptionY = AndroidUtilities.m102dp(29) + AndroidUtilities.m102dp(18);
            return;
        }
        this.descriptionY = AndroidUtilities.m102dp(29);
    }
    ...
    */
    private boolean checkAudioMotionEvent(android.view.MotionEvent r9) {
        ...
        Lc5:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.SharedAudioCell.checkAudioMotionEvent(android.view.MotionEvent):boolean");
    }
        ...
        if (z || this.showReorderIconProgress != BitmapDescriptorFactory.HUE_RED) {
            if (z) {
                ...
                if (f != 1.0f) {
                    ...
                    int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m102dp(12)) - Theme.dialogs_reorderDrawable.getIntrinsicWidth();
            ...
            this.showReorderIconProgress = Utilities.clamp(this.showReorderIconProgress, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            int measuredWidth2 = (getMeasuredWidth() - AndroidUtilities.m102dp(12)) - Theme.dialogs_reorderDrawable.getIntrinsicWidth();
    ...
    private void drawInternal(Canvas canvas) {
        ...
        if (this.dateLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m102dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? 0 : this.dateLayoutX), this.titleY);
        ...
        if (this.titleLayout != null) {
            ...
            canvas.save();
            int m102dp = AndroidUtilities.m102dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline);
            if (!LocaleController.isRTL || (staticLayout = this.dateLayout) == null) {
                i = 0;
            } else {
                i = staticLayout.getWidth() + AndroidUtilities.m102dp(LocaleController.isRTL ? 12 : 4);
            }
            canvas.translate(((m102dp + i) + (LocaleController.isRTL ? this.titleLayout.getWidth() - this.titleLayoutWidth : 0.0f)) - this.titleLayoutLeft, this.titleY);
        ...
        if (this.captionLayout != null) {
            ...
            canvas.save();
            canvas.translate((AndroidUtilities.m102dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? this.captionLayout.getWidth() - this.captionLayoutWidth : 0.0f)) - this.captionLayoutLeft, this.captionY);
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            canvas.translate((AndroidUtilities.m102dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? this.descriptionLayout.getWidth() - this.descriptionLayoutWidth : 0.0f)) - this.descriptionLayoutLeft, this.descriptionY);
            if (this.isInPlaylist) {
                this.isInPlaylistMarkDrawable.setBounds(0, 0, AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16));
                ...
                canvas.translate(AndroidUtilities.m102dp(20), BitmapDescriptorFactory.HUE_RED);
            }
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                canvas.drawLine(BitmapDescriptorFactory.HUE_RED, getHeight() - 1, (getWidth() - AndroidUtilities.m102dp(72)) - getPaddingRight(), getHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            } else {
                canvas.drawLine(AndroidUtilities.m102dp(72), getHeight() - 1, getWidth() - getPaddingRight(), getHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            }
        }
    }
