    ...
    public TooManyCommunitiesHintCell(Context context) {
        ...
        FrameLayout frameLayout = new FrameLayout(this, context) { // from class: org.telegram.ui.Cells.TooManyCommunitiesHintCell.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.save();
                canvas.translate((getMeasuredWidth() - textPaint.measureText(r5)) - AndroidUtilities.m102dp(8), AndroidUtilities.dpf2(7.0f));
                ...
                this.rect.inset(-AndroidUtilities.m102dp(6), -AndroidUtilities.m102dp(3));
                float textSize = (textPaint.getTextSize() / 2.0f) + AndroidUtilities.m102dp(3);
        ...
        this.headerTextView.setText(LocaleController.getString("TooManyCommunities", C3630R.string.TooManyCommunities));
        this.imageView.setImageResource(C3630R.C3632drawable.groups_limit1);
    }
