...
public class BotHelpCell extends View {
    ...
    public BotHelpCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.imagePadding = AndroidUtilities.m102dp(4);
    ...
    public void setText(boolean z, String str, TLObject tLObject, TLRPC$BotInfo tLRPC$BotInfo) {
        ...
        if (z2) {
            ...
            if (!Objects.equals(this.currentPhotoKey, keyForParentObject)) {
                ...
                int m102dp = AndroidUtilities.m102dp(SharedConfig.bubbleRadius) - AndroidUtilities.m102dp(2);
                int m102dp2 = AndroidUtilities.m102dp(4);
                if (!this.isTextVisible) {
                    m102dp2 = m102dp;
                }
                this.imageReceiver.setRoundRadius(m102dp, m102dp, m102dp2, m102dp2);
            }
        }
        ...
        if (this.isTextVisible) {
            ...
            String string = LocaleController.getString(C3630R.string.BotInfoTitle);
            if (z) {
            ...
            Emoji.replaceEmoji(spannableStringBuilder, Theme.chat_msgTextPaint.getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
            try {
                StaticLayout staticLayout = new StaticLayout(spannableStringBuilder, Theme.chat_msgTextPaint, i - (this.isPhotoVisible ? AndroidUtilities.m102dp(5) : 0), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                this.textLayout = staticLayout;
                this.width = 0;
                this.height = staticLayout.getHeight() + AndroidUtilities.m102dp(22);
        ...
        int m102dp3 = this.width + AndroidUtilities.m102dp(22);
        this.width = m102dp3;
        if (this.isPhotoVisible) {
            int i4 = this.height;
            int i5 = (int) (m102dp3 * 0.5625d);
            this.photoHeight = i5;
            this.height = i4 + i5 + AndroidUtilities.m102dp(4);
        }
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.BotHelpCell.onTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), this.height + AndroidUtilities.m102dp(8));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m102dp = this.photoHeight + AndroidUtilities.m102dp(2);
        Drawable shadowDrawable = Theme.chat_msgInMediaDrawable.getShadowDrawable();
        if (shadowDrawable != null) {
            shadowDrawable.setBounds(width, m102dp, this.width + width, this.height + m102dp);
        ...
        if (drawable != null) {
            ...
            this.selectorDrawable.setBounds(AndroidUtilities.m102dp(2) + width, AndroidUtilities.m102dp(2), (this.width + width) - AndroidUtilities.m102dp(2), this.height - AndroidUtilities.m102dp(2));
        ...
        canvas.save();
        int m102dp2 = AndroidUtilities.m102dp(this.isPhotoVisible ? 14 : 11) + width;
        this.textX = m102dp2;
        float f = m102dp2;
        int m102dp3 = AndroidUtilities.m102dp(11) + m102dp;
        this.textY = m102dp3;
        canvas.translate(f, m102dp3);
