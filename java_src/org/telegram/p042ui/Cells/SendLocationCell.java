...
public class SendLocationCell extends FrameLayout {
    ...
    public SendLocationCell(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m102dp(42), getThemedColor(z ? Theme.key_location_sendLiveLocationBackground : Theme.key_location_sendLocationBackground), getThemedColor(z ? Theme.key_location_sendLiveLocationBackground : Theme.key_location_sendLocationBackground));
        if (z) {
            this.rect = new RectF();
            ...
            combinedDrawable2.setCustomSize(AndroidUtilities.m102dp(42), AndroidUtilities.m102dp(42));
            combinedDrawable2.setIconSize(AndroidUtilities.m102dp(24), AndroidUtilities.m102dp(24));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(66), 1073741824));
    }
    ...
    public void checkText() {
        ...
        if (sharingLocationInfo != null) {
            String string = LocaleController.getString("StopLiveLocation", C3630R.string.StopLiveLocation);
        ...
        setText(LocaleController.getString("SendLiveLocation", C3630R.string.SendLiveLocation), LocaleController.getString("SendLiveLocationInfo", C3630R.string.SendLiveLocationInfo));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (sharingLocationInfo != null && (i = sharingLocationInfo.stopTime) >= (currentTime = ConnectionsManager.getInstance(this.currentAccount).getCurrentTime())) {
            ...
            if (LocaleController.isRTL) {
                this.rect.set(AndroidUtilities.m102dp(13), AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(43), AndroidUtilities.m102dp(48));
            } else {
                this.rect.set(getMeasuredWidth() - AndroidUtilities.m102dp(43), AndroidUtilities.m102dp(18), getMeasuredWidth() - AndroidUtilities.m102dp(13), AndroidUtilities.m102dp(48));
            }
            ...
            canvas.drawText(formatLocationLeftTime, this.rect.centerX() - (Theme.chat_livePaint.measureText(formatLocationLeftTime) / 2.0f), AndroidUtilities.m102dp(37), Theme.chat_livePaint);
        }
    }
