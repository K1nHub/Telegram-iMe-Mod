...
import org.telegram.p042ui.Stories.StoryWidgetsImageDecorator;
...
public class SharedPhotoVideoCell2 extends FrameLayout {
    ...
    public void setStyle(int i) {
        ...
        if (i == 1) {
            ...
            this.checkBoxBase.setBounds(0, 0, AndroidUtilities.m102dp(24), AndroidUtilities.m102dp(24));
            if (this.attached) {
        ...
        if (messageObject2 == null || messageObject == null || messageObject2.getId() != messageObject.getId() || i2 != i) {
            ...
            if (TextUtils.isEmpty(restrictionReason)) {
                ...
                if (tLRPC$StoryItem != null && (tLRPC$StoryItem.media instanceof TLRPC$TL_messageMediaUnsupported)) {
                    ...
                    Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.msg_emoji_recent).mutate();
            ...
            if (z) {
                this.imageReceiver.setImageBitmap(ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.photo_placeholder_in));
            }
            if (this.blurImageReceiver.getBitmap() != null) {
                this.blurImageReceiver.getBitmap().recycle();
    ...
    */
    protected void onDraw(android.graphics.Canvas r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.SharedPhotoVideoCell2.onDraw(android.graphics.Canvas):void");
    }
        ...
        if (this.showVideoLayout) {
            ...
            if (imageReceiver == null || imageReceiver.getVisible()) {
                ...
                if (this.videoInfoLayot == null) {
                    ...
                    m102dp = AndroidUtilities.m102dp(4) + this.videoInfoLayot.getWidth() + AndroidUtilities.m102dp(4);
                }
                if (this.drawVideoIcon) {
                    m102dp += AndroidUtilities.m102dp(10);
                }
                canvas.translate(AndroidUtilities.m102dp(5), ((AndroidUtilities.m102dp(1) + rectF.height()) - AndroidUtilities.m102dp(17)) - AndroidUtilities.m102dp(4));
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, m102dp, AndroidUtilities.m102dp(17));
                int alpha = Theme.chat_timeBackgroundPaint.getAlpha();
                Theme.chat_timeBackgroundPaint.setAlpha((int) (alpha * f));
                canvas.drawRoundRect(rectF2, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), Theme.chat_timeBackgroundPaint);
                Theme.chat_timeBackgroundPaint.setAlpha(alpha);
                if (this.drawVideoIcon) {
                    canvas.save();
                    canvas.translate(this.videoInfoLayot == null ? AndroidUtilities.m102dp(5) : AndroidUtilities.m102dp(4), (AndroidUtilities.m102dp(17) - this.sharedResources.playDrawable.getIntrinsicHeight()) / 2.0f);
                    this.sharedResources.playDrawable.setAlpha((int) (this.imageAlpha * 255.0f * f));
                    this.sharedResources.playDrawable.draw(canvas);
                    canvas.restore();
                }
                if (this.videoInfoLayot != null) {
                    canvas.translate(AndroidUtilities.m102dp((this.drawVideoIcon ? 10 : 0) + 4), (AndroidUtilities.m102dp(17) - this.videoInfoLayot.getHeight()) / 2.0f);
    ...
    public void drawCrossafadeImage(Canvas canvas) {
        if (this.crossfadeView != null) {
            ...
            this.crossfadeView.setImageScale(((getMeasuredWidth() - AndroidUtilities.m102dp(2)) * this.imageScale) / (this.crossfadeView.getMeasuredWidth() - AndroidUtilities.m102dp(2)), false);
    ...
    public static class SharedResources {
        ...
        public SharedResources(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            Drawable drawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.play_mini_video);
