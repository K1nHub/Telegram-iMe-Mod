...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        if (i != 0) {
            ...
            if (i == 1) {
                ...
                this.optionsButton.setImageResource(C3630R.C3632drawable.msg_actions);
                ...
                this.reorderButton.setImageResource(C3630R.C3632drawable.list_reorder);
                ...
                this.optionsButton.setImageResource(C3630R.C3632drawable.floating_check);
        ...
        this.addButtonView.setPadding(AndroidUtilities.m102dp(14), 0, AndroidUtilities.m102dp(14), 0);
        ...
        PremiumButtonView premiumButtonView = new PremiumButtonView(context, AndroidUtilities.m102dp(4), false, resourcesProvider);
        this.premiumButtonView = premiumButtonView;
        premiumButtonView.setIcon(C3630R.raw.unlock_icon);
        this.premiumButtonView.setButton(LocaleController.getString("Unlock", C3630R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        try {
            ...
            ((ViewGroup.MarginLayoutParams) this.premiumButtonView.getTextView().getLayoutParams()).leftMargin = AndroidUtilities.m102dp(3);
            this.premiumButtonView.getChildAt(0).setPadding(AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8), 0);
        ...
        this.sideButtons.setPadding(AndroidUtilities.m102dp(10), 0, AndroidUtilities.m102dp(10), 0);
        ...
        TextView textView4 = new TextView(this, context) { // from class: org.telegram.ui.Cells.StickerSetCell.1
            ...
            public void setText(CharSequence charSequence, TextView.BufferType bufferType) {
                super.setText(Emoji.replaceEmoji(charSequence, getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(14), false), bufferType);
            }
        };
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(58) + (this.needDivider ? 1 : 0), 1073741824));
    }
    ...
    public void setText(String str, String str2, int i, boolean z) {
        ...
        if (TextUtils.isEmpty(str2)) {
            this.textView.setTranslationY(AndroidUtilities.m102dp(10));
        } else {
    ...
    public void setStickersSet(TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, boolean z, boolean z2) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                if (tLRPC$Document != null && tLRPC$Document.f1608id == tLRPC$TL_messages_stickerSet.set.thumb_document_id) {
                    break;
                }
                i++;
            }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m102dp(71), getHeight() - 1, (getWidth() - getPaddingRight()) - (LocaleController.isRTL ? AndroidUtilities.m102dp(71) : 0), getHeight() - 1, Theme.dividerPaint);
        }
    }

    public void updateRightMargin() {
        this.sideButtons.measure(View.MeasureSpec.makeMeasureSpec(999999, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(58), 1073741824));
        int m102dp = AndroidUtilities.m102dp(26) + this.sideButtons.getMeasuredWidth();
        if (LocaleController.isRTL) {
            ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).leftMargin = m102dp;
            ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).leftMargin = m102dp;
            return;
        }
        ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).rightMargin = m102dp;
        ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).rightMargin = m102dp;
    }
    ...
    public void updateButtonState(final int i, boolean z) {
        ...
        if (i == 1) {
            this.premiumButtonView.setButton(LocaleController.getString("Unlock", C3630R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.premiumButtonView.setButton(LocaleController.getString("Restore", C3630R.string.Restore), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
