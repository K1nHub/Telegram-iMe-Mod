...
import org.telegram.p042ui.Cells.TextSelectionHelper.SelectableView;
...
public abstract class TextSelectionHelper<Cell extends SelectableView> {
    ...
    public TextSelectionHelper() {
            ...
            public void run() {
                ...
                if (TextSelectionHelper.this.scrolling) {
                    ...
                    if (textSelectionHelper.multiselect && textSelectionHelper.selectedView == null) {
                        lineHeight = AndroidUtilities.m102dp(8);
        ...
        this.startSelectionRunnable = new Runnable() { // from class: org.telegram.ui.Cells.TextSelectionHelper.2
            ...
            public void run() {
                ...
                if (charOffsetFromCord >= text.length()) {
                    ...
                    if (f < textSelectionHelper6.layoutBlock.layout.getLineRight(lineCount) + AndroidUtilities.m102dp(4) && f > TextSelectionHelper.this.layoutBlock.layout.getLineLeft(lineCount)) {
        ...
        paint.setPathEffect(new CornerPathEffect(m102dp));
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            this.textArea.inset(-AndroidUtilities.m102dp(8), -AndroidUtilities.m102dp(8));
            if (this.textArea.contains(this.capturedX, this.capturedY) && this.maybeSelectedView != null) {
                ...
                if (charOffsetFromCord >= text.length()) {
                    ...
                    if (f < this.layoutBlock.layout.getLineRight(lineCount) + AndroidUtilities.m102dp(4) && f > this.layoutBlock.layout.getLineLeft(lineCount)) {
                        charOffsetFromCord = text.length() - 1;
                    }
                }
                if (charOffsetFromCord >= 0 && charOffsetFromCord < text.length() && text.charAt(charOffsetFromCord) != '\n') {
    ...
    public void showMagnifier(int i) {
        ...
        int lineTop = (int) (((((layout.getLineTop(lineForOffset) + this.textY) + coordsInParent[1]) - lineBottom) - AndroidUtilities.m102dp(8)) + this.layoutBlock.yOffset);
        ...
        this.magnifier.show(this.magnifierXanimated, this.magnifierYanimated + (lineBottom * 1.5f) + AndroidUtilities.m102dp(8));
    ...
    */
    public void showActions() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.TextSelectionHelper.showActions():void");
    }
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r22) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.TextSelectionHelper.TextSelectionOverlay.onTouchEvent(android.view.MotionEvent):boolean");
        }
                    ...
                    if (i4 >= 0 && i4 <= length) {
                        ...
                        if (layout != null) {
                            ...
                            if (f4 <= textSelectionHelper2.keyboardSize + i2 || f4 >= textSelectionHelper2.parentView.getMeasuredHeight()) {
                                ...
                                TextSelectionHelper.this.endArea.inset(-AndroidUtilities.m102dp(8), -AndroidUtilities.m102dp(8));
                                i = 1;
                                canvas.restore();
                            } else {
                                canvas.save();
                        ...
                        if (layout2 != null) {
                            ...
                            if (f14 > i2 + textSelectionHelper.keyboardSize && f14 < textSelectionHelper.parentView.getMeasuredHeight()) {
                                if (!layout2.isRtlCharAt(TextSelectionHelper.this.selectionStart)) {
                                    ...
                                    TextSelectionHelper.this.startArea.inset(-AndroidUtilities.m102dp(8), -AndroidUtilities.m102dp(8));
                                    i++;
                                } else {
                                    canvas.save();
    ...
    /* loaded from: classes5.dex */
    public class ActionMode$CallbackC40684 implements ActionMode.Callback {
        private String translateFromLanguage = null;

        ActionMode$CallbackC40684() {
        }
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            menu.add(0, 3, 2, LocaleController.getString("TranslateMessage", C3630R.string.TranslateMessage));
            menu.add(0, IdFabric$Menu.QUOTE, 3, LocaleController.getInternalString(C3630R.string.chat_menu_quote));
            return true;
        }
            ...
            if (TextSelectionHelper.this.onTranslateListener != null && LanguageDetector.hasSupport() && TextSelectionHelper.this.getSelectedText() != null) {
                LanguageDetector.detectLanguage(TextSelectionHelper.this.getSelectedText().toString(), new LanguageDetector.StringCallback() { // from class: org.telegram.ui.Cells.TextSelectionHelper$4$$ExternalSyntheticLambda2
                    ...
                    public final void run(String str) {
                        TextSelectionHelper.ActionMode$CallbackC40684.this.lambda$onPrepareActionMode$0(menu, str);
                    }
                    ...
                    public final void run(Exception exc) {
                        TextSelectionHelper.ActionMode$CallbackC40684.this.lambda$onPrepareActionMode$1(menu, exc);
                    }
                });
            } else {
        ...
        public /* synthetic */ void lambda$onPrepareActionMode$1(Menu menu, Exception exc) {
            FileLog.m99e("mlkit: failed to detect language in selection");
            FileLog.m97e(exc);
            this.translateFromLanguage = null;
            updateTranslateButton(menu);
        }
                    ...
                    if (TextSelectionHelper.this.onTranslateListener != null) {
                        TextSelectionHelper.this.onTranslateListener.run(TextSelectionHelper.this.getSelectedText(), this.translateFromLanguage, LocaleController.getInstance().getCurrentLocale().getLanguage(), new Runnable() { // from class: org.telegram.ui.Cells.TextSelectionHelper$4$$ExternalSyntheticLambda0
                            ...
                            public final void run() {
                                TextSelectionHelper.ActionMode$CallbackC40684.this.lambda$onActionItemClicked$2();
                            }
                        });
                    }
                    TextSelectionHelper.this.hideActions();
    ...
    private ActionMode.Callback createActionCallback() {
        final ActionMode$CallbackC40684 actionMode$CallbackC40684 = new ActionMode$CallbackC40684();
        return Build.VERSION.SDK_INT >= 23 ? new ActionMode.Callback2() { // from class: org.telegram.ui.Cells.TextSelectionHelper.5
            @Override // android.view.ActionMode.Callback
            public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
                return actionMode$CallbackC40684.onCreateActionMode(actionMode, menu);
            }

            @Override // android.view.ActionMode.Callback
            public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
                return actionMode$CallbackC40684.onPrepareActionMode(actionMode, menu);
            }

            @Override // android.view.ActionMode.Callback
            public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
                return actionMode$CallbackC40684.onActionItemClicked(actionMode, menuItem);
            }

            @Override // android.view.ActionMode.Callback
            public void onDestroyActionMode(ActionMode actionMode) {
                actionMode$CallbackC40684.onDestroyActionMode(actionMode);
            }
            ...
            public void onGetContentRect(ActionMode actionMode, View view, Rect rect) {
                ...
                if (TextSelectionHelper.this.isInSelectionMode()) {
                    ...
                    if (textSelectionHelper.selectedView != null) {
                        ...
                        int m102dp = (((offsetToCord[1] + textSelectionHelper3.textY) + coordsInParent[1]) + ((-textSelectionHelper.getLineHeight()) / 2)) - AndroidUtilities.m102dp(4);
                        if (m102dp >= 1) {
                            i2 = m102dp;
                        }
                    } else {
    ...
    public static class ArticleTextSelectionHelper extends TextSelectionHelper<ArticleSelectableView> {
        ...
        private int findClosestLayoutIndex(int i, int i2, ArticleSelectableView articleSelectableView) {
            ...
            if (row > 0 && i3 < AndroidUtilities.m102dp(24)) {
