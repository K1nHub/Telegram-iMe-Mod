...
public class DialogsRequestedEmptyCell extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DialogsRequestedEmptyCell(Context context) {
        ...
        LinearLayout linearLayout = new LinearLayout(this, context) { // from class: org.telegram.ui.Cells.DialogsRequestedEmptyCell.1
...

            {
                ...
                this.paint.setShadowLayer(AndroidUtilities.m103dp(1.33f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m103dp(0.33f), 503316480);
            }
            ...
            protected void onMeasure(int i, int i2) {
                ...
                rectF.set(AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(6), getMeasuredWidth() - AndroidUtilities.m102dp(12), getMeasuredHeight() - AndroidUtilities.m102dp(12));
                this.path.addRoundRect(rectF, AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10), Path.Direction.CW);
            }
        };
        linearLayout.setWillNotDraw(false);
        linearLayout.setOrientation(1);
        linearLayout.setPadding(AndroidUtilities.m102dp(32), AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(32), AndroidUtilities.m102dp(32));
        ...
        this.buttonView.setPadding(AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(14));
    ...
    public void set(TLRPC$RequestPeerType tLRPC$RequestPeerType) {
        if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeBroadcast) {
            this.titleView.setText(LocaleController.getString("NoSuchChannels", C3630R.string.NoSuchChannels));
            this.subtitleView.setText(LocaleController.getString("NoSuchChannelsInfo", C3630R.string.NoSuchChannelsInfo));
            this.buttonView.setVisibility(0);
            this.buttonView.setText(LocaleController.getString("CreateChannelForThis", C3630R.string.CreateChannelForThis));
        } else if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeChat) {
            this.titleView.setText(LocaleController.getString("NoSuchGroups", C3630R.string.NoSuchGroups));
            this.subtitleView.setText(LocaleController.getString("NoSuchGroupsInfo", C3630R.string.NoSuchGroupsInfo));
            this.buttonView.setVisibility(0);
            this.buttonView.setText(LocaleController.getString("CreateGroupForThis", C3630R.string.CreateGroupForThis));
        } else {
            this.titleView.setText(LocaleController.getString("NoSuchUsers", C3630R.string.NoSuchUsers));
            this.subtitleView.setText(LocaleController.getString("NoSuchUsersInfo", C3630R.string.NoSuchUsersInfo));
