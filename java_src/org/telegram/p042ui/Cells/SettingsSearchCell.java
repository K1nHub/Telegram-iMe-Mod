...
public class SettingsSearchCell extends FrameLayout {
    ...
    public void setTextAndValueAndIcon(CharSequence charSequence, String[] strArr, int i, boolean z) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m102dp(LocaleController.isRTL ? 16 : 71);
        layoutParams.rightMargin = AndroidUtilities.m102dp(LocaleController.isRTL ? 71 : 16);
        if (strArr != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (i2 != 0) {
                    spannableStringBuilder.append((CharSequence) " > ");
                    Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.settings_arrow).mutate();
            ...
            layoutParams2.leftMargin = AndroidUtilities.m102dp(LocaleController.isRTL ? 16 : 71);
            layoutParams2.rightMargin = AndroidUtilities.m102dp(LocaleController.isRTL ? 71 : 16);
        } else {
            layoutParams.topMargin = AndroidUtilities.m102dp(21);
    ...
    public void setTextAndValue(CharSequence charSequence, String[] strArr, boolean z, boolean z2) {
            ...
            if (strArr != null) {
                ...
                for (int i2 = 0; i2 < strArr.length; i2++) {
                    if (i2 != 0) {
                        ...
                        Drawable mutate2 = getContext().getResources().getDrawable(C3630R.C3632drawable.settings_arrow).mutate();
        ...
        layoutParams2.rightMargin = m102dp2;
        layoutParams2.leftMargin = m102dp2;
        this.imageView.setVisibility(8);
        this.needDivider = z2;
        setWillNotDraw(!z2);
        this.left = 16;
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m102dp(this.left), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m102dp(this.left) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
}
