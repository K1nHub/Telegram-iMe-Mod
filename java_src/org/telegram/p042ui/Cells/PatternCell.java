...
public class PatternCell extends BackupImageView implements DownloadController.FileDownloadProgressListener {
    ...
    public PatternCell(Context context, int i, PatternCellDelegate patternCellDelegate) {
        ...
        setRoundRadius(AndroidUtilities.m102dp(6));
        this.maxWallpaperSize = i;
        this.delegate = patternCellDelegate;
        RadialProgress2 radialProgress2 = new RadialProgress2(this);
        this.radialProgress = radialProgress2;
        radialProgress2.setProgressRect(AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(70), AndroidUtilities.m102dp(70));
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.telegram.ui.Cells.PatternCell.1
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setRoundRect(AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), view.getMeasuredWidth() - AndroidUtilities.m102dp(1), view.getMeasuredHeight() - AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(6));
                }
            });
    ...
    public void setPattern(TLRPC$TL_wallPaper tLRPC$TL_wallPaper) {
        ...
        if (tLRPC$TL_wallPaper != null) {
            setImage(ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tLRPC$TL_wallPaper.document.thumbs, AndroidUtilities.m102dp(100)), tLRPC$TL_wallPaper.document), "100_100", null, null, "png", 0L, 1, tLRPC$TL_wallPaper);
        } else {
    ...
    public void updateSelected(boolean z) {
        ...
        if ((tLRPC$TL_wallPaper == null && selectedPattern == null) || !(selectedPattern == null || tLRPC$TL_wallPaper == null || tLRPC$TL_wallPaper.f1770id != selectedPattern.f1770id)) {
    ...
    public void onDraw(Canvas canvas) {
            ...
            if (this.gradientShader == null || backgroundColor != this.currentBackgroundColor || backgroundGradientColor1 != this.currentGradientColor1 || backgroundGradientColor2 != this.currentGradientColor2 || backgroundGradientColor3 != this.currentGradientColor3 || backgroundGradientAngle != this.currentGradientAngle) {
                ...
                if (backgroundGradientColor2 != 0) {
                    ...
                    if (motionBackgroundDrawable != null) {
                        ...
                        motionBackgroundDrawable2.setRoundRadius(AndroidUtilities.m102dp(6));
        ...
        if (motionBackgroundDrawable3 != null) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), this.backgroundPaint);
        }
        super.onDraw(canvas);
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m102dp(100), AndroidUtilities.m102dp(100));
    }
    ...
    public void onProgressDownload(String str, long j, long j2) {
        ...
        TLRPC$TL_wallPaper selectedPattern = this.delegate.getSelectedPattern();
        TLRPC$TL_wallPaper tLRPC$TL_wallPaper = this.currentPattern;
        if (!((tLRPC$TL_wallPaper == null && selectedPattern == null) || !(selectedPattern == null || tLRPC$TL_wallPaper == null || tLRPC$TL_wallPaper.f1770id != selectedPattern.f1770id)) || this.radialProgress.getIcon() == 10) {
            return;
        }
