...
public class NotificationsCheckCell extends FrameLayout {
    ...
    public boolean isInSwitch(float f) {
        ...
        return (z && f <= ((float) m102dp)) || (!z && f >= ((float) (getMeasuredWidth() - m102dp)));
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(this.currentHeight), 1073741824));
        }
    }
    ...
    public void setTextAndValueAndIconAndCheck(String str, CharSequence charSequence, int i, boolean z, int i2, boolean z2, boolean z3) {
        ...
        if (z2) {
            ...
            this.valueTextView.setPadding(0, 0, 0, AndroidUtilities.m102dp(14));
        } else {
            this.valueTextView.setLines(1);
            this.valueTextView.setMaxLines(1);
            this.valueTextView.setSingleLine(true);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                ...
                m102dp = AndroidUtilities.m102dp(this.imageView != null ? 64 : 20);
            }
            float f = m102dp;
            float measuredHeight2 = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (LocaleController.isRTL) {
                i = AndroidUtilities.m102dp(this.imageView == null ? 20 : 64);
            } else {
                i = 0;
            }
        ...
        if (this.drawLine) {
            int m102dp2 = LocaleController.isRTL ? AndroidUtilities.m102dp(76) : (getMeasuredWidth() - AndroidUtilities.m102dp(76)) - 1;
            canvas.drawRect(m102dp2, (getMeasuredHeight() - AndroidUtilities.m102dp(22)) / 2, m102dp2 + 2, measuredHeight + AndroidUtilities.m102dp(22), Theme.dividerPaint);
        }
    }
