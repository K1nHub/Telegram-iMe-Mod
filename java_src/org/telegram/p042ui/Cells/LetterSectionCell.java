...
public class LetterSectionCell extends FrameLayout {
    ...
    public LetterSectionCell(Context context) {
        super(context);
        setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m102dp(54), AndroidUtilities.m102dp(64)));
    ...
    public void setCellHeight(int i) {
        setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m102dp(54), i));
    }
}
