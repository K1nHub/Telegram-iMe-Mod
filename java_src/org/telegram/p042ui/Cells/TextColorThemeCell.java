...
public class TextColorThemeCell extends FrameLayout {
    ...
    public TextColorThemeCell(Context context) {
        ...
        this.textView.setPadding(0, 0, 0, AndroidUtilities.m102dp(3));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(50) + (this.needDivider ? 1 : 0), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            ...
            canvas.drawCircle(!LocaleController.isRTL ? AndroidUtilities.m102dp(28) : getMeasuredWidth() - AndroidUtilities.m102dp(28), getMeasuredHeight() / 2, AndroidUtilities.m102dp(10), colorPaint);
        }
    }
}
