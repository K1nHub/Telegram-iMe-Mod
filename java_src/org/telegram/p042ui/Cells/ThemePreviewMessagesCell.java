...
import org.telegram.p042ui.Components.Reactions.ReactionsEffectOverlay;
...
/* renamed from: org.telegram.ui.Cells.ThemePreviewMessagesCell */
...
public class ThemePreviewMessagesCell extends LinearLayout {
    ...
    public ThemePreviewMessagesCell(Context context, INavigationLayout iNavigationLayout, int i) {
        ...
        if (i == 2) {
            ...
            tLRPC$TL_message.message = LocaleController.getString("DoubleTapPreviewMessage", C3630R.string.DoubleTapPreviewMessage);
            ...
            messageObject.customName = LocaleController.getString("DoubleTapPreviewSenderName", C3630R.string.DoubleTapPreviewSenderName);
            messageObject.customAvatarDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.dino_pic);
            messageObject2 = null;
        } else {
            TLRPC$TL_message tLRPC$TL_message2 = new TLRPC$TL_message();
            if (i == 0) {
                tLRPC$TL_message2.message = LocaleController.getString("FontSizePreviewReply", C3630R.string.FontSizePreviewReply);
            } else {
                tLRPC$TL_message2.message = LocaleController.getString("NewThemePreviewReply", C3630R.string.NewThemePreviewReply);
            }
            ...
            if (i == 0) {
                tLRPC$TL_message3.message = LocaleController.getString("FontSizePreviewLine2", C3630R.string.FontSizePreviewLine2);
            } else {
            ...
            messageObject = new MessageObject(UserConfig.selectedAccount, tLRPC$TL_message3, true, false);
            messageObject.resetLayout();
            messageObject.eventId = 1L;
            TLRPC$TL_message tLRPC$TL_message4 = new TLRPC$TL_message();
            if (i == 0) {
                tLRPC$TL_message4.message = LocaleController.getString("FontSizePreviewLine1", C3630R.string.FontSizePreviewLine1);
            } else {
            ...
            messageObject2 = new MessageObject(UserConfig.selectedAccount, tLRPC$TL_message4, true, false);
            if (i == 0) {
                messageObject2.customReplyName = LocaleController.getString("FontSizePreviewName", C3630R.string.FontSizePreviewName);
            } else {
                messageObject2.customReplyName = LocaleController.getString("NewThemePreviewName", C3630R.string.NewThemePreviewName);
            }
        ...
        while (true) {
            ...
            chatMessageCellArr[i4] = new ChatMessageCell(context, context, i) { // from class: org.telegram.ui.Cells.ThemePreviewMessagesCell.1
                ...
                /* loaded from: classes5.dex */
                public class C40741 extends GestureDetector.SimpleOnGestureListener {
                    C40741() {
                    }

                    @Override // android.view.GestureDetector.SimpleOnGestureListener, android.view.GestureDetector.OnDoubleTapListener
                    public boolean onDoubleTap(MotionEvent motionEvent) {
                        if (MediaDataController.getInstance(C40731.this.currentAccount).getDoubleTapReaction() == null) {
                            return false;
                        }
                        boolean selectReaction = getMessageObject().selectReaction(ReactionsLayoutInBubble.VisibleReaction.fromEmojicon(MediaDataController.getInstance(C40731.this.currentAccount).getDoubleTapReaction()), false, false);
                        C40731 c40731 = C40731.this;
                        c40731.setMessageObject(c40731.getMessageObject(), null, false, false);
                        requestLayout();
                        ReactionsEffectOverlay.removeCurrent(false);
                        if (selectReaction) {
                            ThemePreviewMessagesCell themePreviewMessagesCell = ThemePreviewMessagesCell.this;
                            ReactionsEffectOverlay.show(themePreviewMessagesCell.fragment, null, themePreviewMessagesCell.cells[1], null, motionEvent.getX(), motionEvent.getY(), ReactionsLayoutInBubble.VisibleReaction.fromEmojicon(MediaDataController.getInstance(C40731.this.currentAccount).getDoubleTapReaction()), C40731.this.currentAccount, 0);
                            ReactionsEffectOverlay.startAnimation();
                        }
                        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC40751());
                        return true;
                    }
                    ...
                    /* loaded from: classes5.dex */
                    public class ViewTreeObserver$OnPreDrawListenerC40751 implements ViewTreeObserver.OnPreDrawListener {
                        ViewTreeObserver$OnPreDrawListenerC40751() {
                        }
                        ...
                        public boolean onPreDraw() {
                            ...
                            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Cells.ThemePreviewMessagesCell$1$1$1$$ExternalSyntheticLambda0
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    ThemePreviewMessagesCell.C40731.C40741.ViewTreeObserver$OnPreDrawListenerC40751.this.lambda$onPreDraw$0(valueAnimator);
                                }
                            });
...

                {
                    ...
                    this.val$type = i;
                    this.gestureDetector = new GestureDetector(context, new C40741());
                }

                @Override // org.telegram.p042ui.Cells.ChatMessageCell, android.view.View
                ...
                protected void dispatchDraw(Canvas canvas) {
                    if (getAvatarImage() != null && getAvatarImage().getImageHeight() != BitmapDescriptorFactory.HUE_RED) {
                        getAvatarImage().setImageCoords(getAvatarImage().getImageX(), (getMeasuredHeight() - getAvatarImage().getImageHeight()) - AndroidUtilities.m102dp(4), getAvatarImage().getImageWidth(), getAvatarImage().getImageHeight());
            ...
            this.cells[i4].setDelegate(new ChatMessageCell.ChatMessageCellDelegate(this) { // from class: org.telegram.ui.Cells.ThemePreviewMessagesCell.2
                ...
                @Override // org.telegram.p042ui.Cells.ChatMessageCell.ChatMessageCellDelegate
                public /* synthetic */ boolean didLongPressUserAvatar(ChatMessageCell chatMessageCell, TLRPC$User tLRPC$User, float f, float f2, boolean z) {
                    return ChatMessageCell.ChatMessageCellDelegate.CC.$default$didLongPressUserAvatar(this, chatMessageCell, tLRPC$User, f, f2, z);
                }
                ...
                @Override // org.telegram.p042ui.Cells.ChatMessageCell.ChatMessageCellDelegate
                public /* synthetic */ void needOpenWebView(MessageObject messageObject4, String str, String str2, String str3, String str4, int i5, int i6) {
                    ChatMessageCell.ChatMessageCellDelegate.CC.$default$needOpenWebView(this, messageObject4, str, str2, str3, str4, i5, i6);
                }

                @Override // org.telegram.p042ui.Cells.ChatMessageCell.ChatMessageCellDelegate
                public /* synthetic */ boolean needPlayMessage(MessageObject messageObject4, boolean z) {
                    return ChatMessageCell.ChatMessageCellDelegate.CC.$default$needPlayMessage(this, messageObject4, z);
                }
            ...
            MessageObject messageObject4 = i4 == 0 ? messageObject2 : messageObject;
            if (messageObject4 != null) {
                this.cells[i4].setMessageObject(messageObject4, null, false, false);
