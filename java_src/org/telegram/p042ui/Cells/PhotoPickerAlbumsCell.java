...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    private class AlbumView extends FrameLayout {
        ...
        public AlbumView(Context context) {
            ...
            linearLayout.setBackgroundResource(C3630R.C3632drawable.album_shadow);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (AndroidUtilities.isTablet()) {
            m102dp = ((AndroidUtilities.m102dp(490) - AndroidUtilities.m102dp(12)) - ((this.albumsCount - 1) * AndroidUtilities.m102dp(4))) / this.albumsCount;
        } else {
            m102dp = ((AndroidUtilities.displaySize.x - AndroidUtilities.m102dp(12)) - ((this.albumsCount - 1) * AndroidUtilities.m102dp(4))) / this.albumsCount;
        }
        for (int i3 = 0; i3 < this.albumsCount; i3++) {
            ...
            layoutParams.topMargin = AndroidUtilities.m102dp(4);
            layoutParams.leftMargin = (AndroidUtilities.m102dp(4) + m102dp) * i3;
            layoutParams.width = m102dp;
            layoutParams.height = m102dp;
            layoutParams.gravity = 51;
            this.albumViews[i3].setLayoutParams(layoutParams);
        }
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(4) + m102dp, 1073741824));
    }
}
