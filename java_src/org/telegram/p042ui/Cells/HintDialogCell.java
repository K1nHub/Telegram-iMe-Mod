...
public class HintDialogCell extends FrameLayout {
    ...
    public HintDialogCell(Context context, boolean z) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m102dp(27));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(86), 1073741824));
        this.counterView.counterDrawable.horizontalPadding = AndroidUtilities.m102dp(13);
    }

    public void update(int i) {
        int i2;
        if ((MessagesController.UPDATE_MASK_STATUS & i) != 0 && this.currentUser != null) {
            this.currentUser = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.currentUser.f1762id));
    ...
    */
    protected boolean drawChild(android.graphics.Canvas r6, android.view.View r7, long r8) {
        ...
        L76:
            ...
            if (r7 == 0) goto Lc1
            r7 = 53
            int r7 = org.telegram.messenger.AndroidUtilities.m102dp(r7)
            r0 = 59
            ...
            android.graphics.Paint r1 = org.telegram.p042ui.ActionBar.Theme.dialogs_onlineCirclePaint
            ...
            float r1 = (float) r1
            android.graphics.Paint r2 = org.telegram.p042ui.ActionBar.Theme.dialogs_onlineCirclePaint
            r6.drawCircle(r0, r7, r1, r2)
            android.graphics.Paint r1 = org.telegram.p042ui.ActionBar.Theme.dialogs_onlineCirclePaint
            int r2 = org.telegram.p042ui.ActionBar.Theme.key_chats_onlineCircle
            int r2 = org.telegram.p042ui.ActionBar.Theme.getColor(r2)
            r1.setColor(r2)
            r1 = 5
            int r1 = org.telegram.messenger.AndroidUtilities.m102dp(r1)
        ...
        Lc3:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Cells.HintDialogCell.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.drawCheckbox) {
            ...
            canvas.drawCircle(left, top, AndroidUtilities.m102dp(28), Theme.checkboxSquare_checkPaint);
        }
    }
