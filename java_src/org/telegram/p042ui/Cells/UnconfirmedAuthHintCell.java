...
public class UnconfirmedAuthHintCell extends FrameLayout {
    ...
    public UnconfirmedAuthHintCell(Context context) {
        ...
        textView.setText(LocaleController.getString(C3630R.string.UnconfirmedAuthTitle));
        ...
        textViewWithLoading.setPadding(AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(5), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(7));
        ...
        textViewWithLoading.setText(LocaleController.getString(C3630R.string.UnconfirmedAuthConfirm));
        ...
        textViewWithLoading2.setPadding(AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(5), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(7));
        ...
        textViewWithLoading2.setText(LocaleController.getString(C3630R.string.UnconfirmedAuthDeny));
    ...
    public void set(final BaseFragment baseFragment, final int i) {
        ...
        this.titleTextView.setText(LocaleController.getString(C3630R.string.UnconfirmedAuthTitle));
        this.yesButton.setText(LocaleController.getString(C3630R.string.UnconfirmedAuthConfirm));
        this.yesButton.setLoading(false, false);
        this.noButton.setText(LocaleController.getString(C3630R.string.UnconfirmedAuthDeny));
        ...
        if (arrayList != null && arrayList.size() == 1) {
            ...
            this.messageTextView.setText(LocaleController.formatString(C3630R.string.UnconfirmedAuthSingle, str + arrayList.get(0).location));
    ...
    public static /* synthetic */ void lambda$set$2(final BaseFragment baseFragment, int i, ArrayList arrayList, View view) {
        String string = LocaleController.getString(C3630R.string.UnconfirmedAuthConfirmedMessage);
        ...
        coloredImageSpan.setWidth(AndroidUtilities.m102dp(12));
        spannableString.setSpan(coloredImageSpan, 0, spannableString.length(), 33);
        AndroidUtilities.replaceCharSequence(">", replaceSingleTag, spannableString);
        BulletinFactory.m61of(baseFragment).createSimpleBulletin(C3630R.raw.contact_check, LocaleController.getString(C3630R.string.UnconfirmedAuthConfirmed), replaceSingleTag).show();
    ...
    public void updateColors() {
        ...
        this.yesButton.setBackground(Theme.createSelectorDrawable(Theme.multAlpha(Theme.getColor(i), Theme.isCurrentThemeDark() ? 0.3f : 0.15f), 7, AndroidUtilities.m102dp(8)));
        ...
        this.noButton.setBackground(Theme.createSelectorDrawable(Theme.multAlpha(Theme.getColor(i2), Theme.isCurrentThemeDark() ? 0.3f : 0.15f), 7, AndroidUtilities.m102dp(8)));
    }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (f > BitmapDescriptorFactory.HUE_RED) {
                if (f < 1.0f) {
                    ...
                    canvas.translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(-12) * f);
                    super.onDraw(canvas);
                    canvas.restore();
                }
                if (this.progressDrawable == null) {
                    CircularProgressDrawable circularProgressDrawable = new CircularProgressDrawable(AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(2), getCurrentTextColor());
                ...
                float f3 = 1.0f - f;
                this.progressDrawable.setBounds(getWidth() / 2, (getHeight() / 2) + ((int) (AndroidUtilities.m102dp(12) * f3)), getWidth() / 2, (getHeight() / 2) + ((int) (f3 * AndroidUtilities.m102dp(12))));
    ...
    public void showLoginPreventedSheet(ArrayList<UnconfirmedAuthController.UnconfirmedAuth> arrayList) {
        if (arrayList == null || arrayList.size() == 0) {
            BulletinFactory.m62of(Bulletin.BulletinWindow.make(getContext()), null).createErrorBulletin(LocaleController.getString(C3630R.string.UnknownError)).show();
            return;
        }
        ...
        rLottieImageView.setAnimation(C3630R.raw.ic_ban, 50, 50);
        rLottieImageView.playAnimation();
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m102dp(80), Theme.getColor(Theme.key_windowBackgroundWhiteValueText)));
        ...
        textView2.setGravity(17);
        if (arrayList.size() == 1) {
            textView2.setText(LocaleController.formatString(C3630R.string.UnconfirmedAuthDeniedMessageSingle, from(arrayList.get(0))));
        } else {
            String str = "\n";
            for (int i = 0; i < Math.min(arrayList.size(), 10); i++) {
                str = str + "• " + from(arrayList.get(i)) + "\n";
            }
            textView2.setText(LocaleController.formatString(C3630R.string.UnconfirmedAuthDeniedMessageMultiple, str));
        }
        textView2.setTextColor(Theme.getColor(Theme.key_dialogTextBlack));
        linearLayout.addView(textView2, LayoutHelper.createLinear(-1, -2, 40, 9, 40, 0));
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setPadding(AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10));
        int m102dp = AndroidUtilities.m102dp(8);
        int i2 = Theme.key_text_RedBold;
        frameLayout.setBackground(Theme.createRoundRectDrawable(m102dp, Theme.multAlpha(Theme.getColor(i2), Theme.isCurrentThemeDark() ? 0.2f : 0.15f)));
        TextView textView3 = new TextView(getContext());
        textView3.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView3.setTextSize(1, 14.0f);
        textView3.setGravity(17);
        textView3.setTextColor(Theme.getColor(i2));
        textView3.setText(LocaleController.getString(C3630R.string.UnconfirmedAuthDeniedWarning));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C3630R.string.GotIt), false);
