...
public class StatisticPostInfoCell extends FrameLayout {
    ...
    public StatisticPostInfoCell(Context context, TLRPC$ChatFull tLRPC$ChatFull) {
        ...
        addView(backupImageView, LayoutHelper.createFrame(46, 46, 8388627, 12, 0, 16, 0));
        ...
        linearLayout.addView(linearLayout2, LayoutHelper.createFrame(-1, -2, 8388659, 0, 8, 0, 0));
        ...
        linearLayout.addView(linearLayout3, LayoutHelper.createFrame(-1, -2, 8388659, 0, 2, 0, 8));
        addView(linearLayout, LayoutHelper.createFrame(-1, -2, 0, 72, 0, 12, 0));
    ...
    public void setData(StatisticActivity.RecentPostInfo recentPostInfo) {
        ...
        if (arrayList != null) {
            ...
            this.imageView.setRoundRadius(AndroidUtilities.m102dp(4));
            ...
            this.imageView.setRoundRadius(AndroidUtilities.m102dp(46) >> 1);
        }
