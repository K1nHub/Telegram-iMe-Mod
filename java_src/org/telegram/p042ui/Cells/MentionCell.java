...
public class MentionCell extends LinearLayout {
    ...
    public MentionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m102dp(14));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(36), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needsDivider) {
            canvas.drawLine(AndroidUtilities.m102dp(52), getHeight() - 1, getWidth() - AndroidUtilities.m102dp(8), getHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public void setEmojiSuggestion(MediaDataController.KeywordResult keywordResult) {
        ...
        this.nameTextView.setPadding(AndroidUtilities.m102dp(22), 0, 0, 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        Drawable drawable = this.emojiDrawable;
        if (drawable != null) {
            int m102dp = AndroidUtilities.m102dp(drawable instanceof AnimatedEmojiDrawable ? 24 : 20);
            int m102dp2 = AndroidUtilities.m102dp(this.emojiDrawable instanceof AnimatedEmojiDrawable ? -2 : 0);
            this.emojiDrawable.setBounds(this.nameTextView.getLeft() + m102dp2, ((this.nameTextView.getTop() + this.nameTextView.getBottom()) - m102dp) / 2, this.nameTextView.getLeft() + m102dp2 + m102dp, ((this.nameTextView.getTop() + this.nameTextView.getBottom()) + m102dp) / 2);
    ...
    public void setBotCommand(String str, String str2, TLRPC$User tLRPC$User) {
        ...
        this.nameTextView.setText(str);
        TextView textView = this.usernameTextView;
        textView.setText(Emoji.replaceEmoji(str2, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false));
    }
