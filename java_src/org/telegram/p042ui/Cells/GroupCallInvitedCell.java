...
public class GroupCallInvitedCell extends FrameLayout {
    ...
    public GroupCallInvitedCell(Context context) {
        ...
        this.statusTextView.setText(LocaleController.getString("Invited", C3630R.string.Invited));
        ...
        this.muteButton.setImageResource(C3630R.C3632drawable.msg_invited);
        this.muteButton.setImportantForAccessibility(2);
        this.muteButton.setPadding(0, 0, AndroidUtilities.m102dp(4), 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m102dp(68), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m102dp(68) : 0), getMeasuredHeight() - 1, this.dividerPaint);
        }
