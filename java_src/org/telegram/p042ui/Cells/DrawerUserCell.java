...
import org.telegram.p042ui.Components.GroupCreateCheckBox;
...
public class DrawerUserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void addMuteButton() {
        ...
        imageView.setImageResource(C3630R.C3632drawable.msg_unmute);
    ...
    public /* synthetic */ void lambda$addMuteButton$0(View view) {
        ...
        if (getForkCommonController().isAccountMuted()) {
            string = LocaleController.getString("NotificationsMutedHint", C3630R.string.NotificationsMutedHint);
        } else {
            string = LocaleController.getString("NotificationsUnmutedHint", C3630R.string.NotificationsUnmutedHint);
        }
    ...
    private void updateMuteButtonIcon() {
        ...
        if (imageView != null) {
            imageView.setImageResource(getForkCommonController().isAccountMuted() ? C3630R.C3632drawable.msg_mute : C3630R.C3632drawable.msg_unmute);
        }
    }
    ...
    public DrawerUserCell(Context context, int i) {
        ...
        if (isActionBarAccountSwitchType()) {
            setPadding(0, AndroidUtilities.m102dp(4), 0, AndroidUtilities.m102dp(4));
        } else {
            addMuteButton();
        }
        AvatarDrawable avatarDrawable = new AvatarDrawable();
        this.avatarDrawable = avatarDrawable;
        avatarDrawable.setTextSize(AndroidUtilities.m102dp(20));
        ...
        simpleTextView.setPadding(0, AndroidUtilities.m102dp(4), 0, AndroidUtilities.m102dp(4));
        ...
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.textView, AndroidUtilities.m102dp(20));
        ...
        this.checkBox.setInnerRadDiff(AndroidUtilities.m103dp(1.5f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(isActionBarAccountSwitchType() ? 56 : 48), 1073741824));
    }
    ...
    public void setAccount(int i) {
        ...
        try {
            formatName = Emoji.replaceEmoji(formatName, this.textView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
        ...
        if (isShowPremiumStatusEnabled && emojiStatusDocumentId != null) {
            this.textView.setDrawablePadding(AndroidUtilities.m102dp(4));
            ...
            this.textView.setDrawablePadding(AndroidUtilities.m102dp(6));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m103dp = AndroidUtilities.m103dp(isActionBarAccountSwitchType() ? 16.5f : 12.5f);
        int ceil = (int) Math.ceil(Theme.dialogs_countTextPaint.measureText(format));
        int max = Math.max(AndroidUtilities.m102dp(10), ceil);
        int measuredWidth = (getMeasuredWidth() - max) - AndroidUtilities.m102dp(25);
        if (this.muteButton != null) {
            measuredWidth -= AndroidUtilities.m102dp(42);
        }
        int m103dp2 = measuredWidth - AndroidUtilities.m103dp(5.5f);
        this.rect.set(m103dp2, m103dp, m103dp2 + max + AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(23) + m103dp);
        RectF rectF = this.rect;
        float f = AndroidUtilities.density;
        canvas.drawRoundRect(rectF, f * 11.5f, f * 11.5f, Theme.dialogs_countPaint);
        RectF rectF2 = this.rect;
        canvas.drawText(format, rectF2.left + ((rectF2.width() - ceil) / 2.0f), m103dp + AndroidUtilities.m102dp(16), Theme.dialogs_countTextPaint);
        this.textView.setRightPadding(max + AndroidUtilities.m102dp(26));
    }
