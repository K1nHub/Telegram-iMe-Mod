...
public class CreateTopicEmptyView extends LinearLayout {
    ...
    public CreateTopicEmptyView(Context context, FrameLayout frameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        setBackground(Theme.createServiceDrawable(AndroidUtilities.m102dp(18), this, frameLayout, getThemedPaint("paintChatActionBackground")));
        ...
        textView.setMaxWidth(AndroidUtilities.m102dp(210));
        textView.setText(LocaleController.getString(C3630R.string.AlmostDone));
        TextView textView2 = new TextView(context);
        textView2.setTextSize(1, 13.0f);
        textView2.setTextColor(getThemedColor(i));
        textView2.setGravity(1);
        textView2.setMaxWidth(AndroidUtilities.m102dp(160));
        textView2.setText(LocaleController.getString(C3630R.string.TopicEmptyViewDescription));
