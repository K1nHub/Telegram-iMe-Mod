...
import org.telegram.p042ui.AvatarPreviewer;
import org.telegram.p042ui.Cells.ChatActionCell;
import org.telegram.p042ui.Cells.ChatLoadingCell;
import org.telegram.p042ui.Cells.ChatMessageCell;
import org.telegram.p042ui.Cells.ChatUnreadCell;
import org.telegram.p042ui.Cells.TextSelectionHelper;
import org.telegram.p042ui.ChannelAdminLogActivity;
import org.telegram.p042ui.Components.AdminLogFilterAlert;
...
import org.telegram.p042ui.Components.ChatScrimPopupContainerLayout;
import org.telegram.p042ui.Components.EmbedBottomSheet;
import org.telegram.p042ui.Components.InviteLinkBottomSheet;
import org.telegram.p042ui.Components.LayoutHelper;
import org.telegram.p042ui.Components.PhonebookShareAlert;
...
public class ChannelAdminLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateEmptyPlaceholder() {
        ...
        if (!TextUtils.isEmpty(this.searchQuery)) {
            this.emptyView.setPadding(AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(5), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(5));
            this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("EventLogEmptyTextSearch", C3630R.string.EventLogEmptyTextSearch, this.searchQuery)));
        } else if (this.selectedAdmins != null || this.currentFilter != null) {
            this.emptyView.setPadding(AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(5), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(5));
            this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmptySearch", C3630R.string.EventLogEmptySearch)));
        } else {
            this.emptyView.setPadding(AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16));
            if (this.currentChat.megagroup) {
                this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmpty", C3630R.string.EventLogEmpty)));
            } else {
                this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmptyChannel", C3630R.string.EventLogEmptyChannel)));
            }
        }
    }
    ...
    public void loadMessages(boolean z) {
        ...
        tLRPC$TL_channels_getAdminLog.f1641q = this.searchQuery;
    ...
    public /* synthetic */ void lambda$loadMessages$0(TLRPC$TL_channels_adminLogResults tLRPC$TL_channels_adminLogResults) {
        ...
        for (int i2 = 0; i2 < tLRPC$TL_channels_adminLogResults.events.size(); i2++) {
            ...
            if (this.messagesDict.indexOfKey(tLRPC$TL_channelAdminLogEvent.f1638id) < 0) {
                ...
                this.minEventId = Math.min(this.minEventId, tLRPC$TL_channelAdminLogEvent.f1638id);
                ...
                if (messageObject.contentType >= 0) {
                    this.messagesDict.put(tLRPC$TL_channelAdminLogEvent.f1638id, messageObject);
                }
                z = true;
            }
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ChannelAdminLogActivity.3
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C3630R.C3632drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.ChannelAdminLogActivity.4
        ...
        this.avatarContainer.setSubtitle(LocaleController.getString("EventLogAllEvents", C3630R.string.EventLogAllEvents));
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.5
            ...
            public void onAttachedToWindow() {
                ...
                MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                if (playingMessageObject == null || !playingMessageObject.isRoundVideo() || playingMessageObject.eventId == 0 || playingMessageObject.getDialogId() != (-ChannelAdminLogActivity.this.currentChat.f1600id)) {
                    return;
                }
                ...
                for (int i4 = 0; i4 < childCount; i4++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && childAt != ((BaseFragment) ChannelAdminLogActivity.this).actionBar) {
                        if (childAt != ChannelAdminLogActivity.this.chatListView && childAt != ChannelAdminLogActivity.this.progressView) {
                            ...
                            childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m102dp(10), paddingTop - AndroidUtilities.m102dp(50)), 1073741824));
                        }
                    }
                }
            }
            ...
            */
            public void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChannelAdminLogActivity.C41235.onLayout(boolean, int, int, int, int):void");
            }
        ...
        this.emptyView.setBackground(Theme.createServiceDrawable(AndroidUtilities.m102dp(6), this.emptyView, this.contentView));
        this.emptyView.setPadding(AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.6
            ...
            public boolean drawChild(Canvas canvas, View view, long j) {
                ...
                if ((view instanceof ChatMessageCell) && (avatarImage = (chatMessageCell = (ChatMessageCell) view).getAvatarImage()) != null) {
                    ...
                    if (y3 - AndroidUtilities.m102dp(48) < y2) {
                        y3 = y2 + AndroidUtilities.m102dp(48);
                    }
                    ...
                    avatarImage.setImageY(y3 - AndroidUtilities.m102dp(44));
        ...
        this.chatListView.setPadding(0, AndroidUtilities.m102dp(4), 0, AndroidUtilities.m102dp(3));
        RecyclerListView recyclerListView3 = this.chatListView;
        C41268 c41268 = new C41268(null, this.chatListView, null);
        this.chatListItemAnimator = c41268;
        recyclerListView3.setItemAnimator(c41268);
        ...
        view.setBackground(Theme.createServiceDrawable(AndroidUtilities.m102dp(18), this.progressView2, this.contentView));
        this.progressView.addView(this.progressView2, LayoutHelper.createFrame(36, 36, 17));
        RadialProgressView radialProgressView = new RadialProgressView(context);
        this.progressBar = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.m102dp(28));
        ...
        this.bottomOverlayChat.setPadding(0, AndroidUtilities.m102dp(3), 0, 0);
        ...
        this.bottomOverlayChatText.setText(LocaleController.getString("SETTINGS", C3630R.string.SETTINGS).toUpperCase());
        ...
        imageView.setImageResource(C3630R.C3632drawable.msg_help);
        ...
        this.bottomOverlayImage.setContentDescription(LocaleController.getString("BotHelp", C3630R.string.BotHelp));
        ...
        this.searchContainer.setPadding(0, AndroidUtilities.m102dp(3), 0, 0);
        ...
        this.searchCalendarButton.setImageResource(C3630R.C3632drawable.msg_calendar);
        ...
        undoView.setAdditionalTranslationY(AndroidUtilities.m102dp(51));
    ...
    /* loaded from: classes5.dex */
    public class C41268 extends ChatListItemAnimator {
        Runnable finishRunnable;
        int scrollAnimationIndex;

        C41268(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onAnimationStart() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m100d("admin logs chatItemAnimator disable notifications");
            }
        }
        ...
        public void onAllAnimationsDone() {
            ...
            Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.ChannelAdminLogActivity$8$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ChannelAdminLogActivity.C41268.this.lambda$onAllAnimationsDone$0();
                }
            };
        ...
        public /* synthetic */ void lambda$onAllAnimationsDone$0() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m100d("admin logs chatItemAnimator enable notifications");
            }
        }
    }
    ...
    public /* synthetic */ void lambda$createView$4(View view) {
        ...
        adminLogFilterAlert.setAdminLogFilterAlertDelegate(new AdminLogFilterAlert.AdminLogFilterAlertDelegate() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda16
            @Override // org.telegram.p042ui.Components.AdminLogFilterAlert.AdminLogFilterAlertDelegate
    ...
    public /* synthetic */ void lambda$createView$3(TLRPC$TL_channelAdminLogEventsFilter tLRPC$TL_channelAdminLogEventsFilter, LongSparseArray longSparseArray) {
        ...
        if (tLRPC$TL_channelAdminLogEventsFilter != null || longSparseArray != null) {
            this.avatarContainer.setSubtitle(LocaleController.getString("EventLogSelectedEvents", C3630R.string.EventLogSelectedEvents));
        } else {
            this.avatarContainer.setSubtitle(LocaleController.getString("EventLogAllEvents", C3630R.string.EventLogAllEvents));
        }
        loadMessages(true);
    ...
    public /* synthetic */ void lambda$createView$5(View view) {
        ...
        if (this.currentChat.megagroup) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("EventLogInfoDetail", C3630R.string.EventLogInfoDetail)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("EventLogInfoDetailChannel", C3630R.string.EventLogInfoDetailChannel)));
        }
        builder.setPositiveButton(LocaleController.getString("OK", C3630R.string.OK), null);
        builder.setTitle(LocaleController.getString("EventLogInfoTitle", C3630R.string.EventLogInfoTitle));
    ...
    */
    public boolean createMenu(final android.view.View r22, final float r23, final float r24) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChannelAdminLogActivity.createMenu(android.view.View, float, float):boolean");
    }
    ...
    public /* synthetic */ void lambda$createMenu$9(final ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, View view, float f, float f2) {
        ...
        int i = C3630R.C3632drawable.popup_fixed_alert;
        int i2 = 0;
        ...
        actionBarPopupWindowLayout.setMinimumWidth(AndroidUtilities.m102dp(200));
        Rect rect = new Rect();
        ...
        while (true) {
            ...
            if (arrayList.get(i3) == null) {
                ...
                actionBarMenuSubItem.setMinimumWidth(AndroidUtilities.m102dp(200));
        ...
        this.scrimPopupWindow.setAnimationStyle(C3630R.style.PopupContextAnimation);
        this.scrimPopupWindow.setFocusable(true);
        chatScrimPopupContainerLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(1000), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(1000), Integer.MIN_VALUE));
        ...
        int left = (((view.getLeft() + ((int) f)) - chatScrimPopupContainerLayout.getMeasuredWidth()) + rect.left) - AndroidUtilities.m102dp(28);
        if (left < AndroidUtilities.m102dp(6)) {
            left = AndroidUtilities.m102dp(6);
        } else if (left > (this.chatListView.getMeasuredWidth() - AndroidUtilities.m102dp(6)) - chatScrimPopupContainerLayout.getMeasuredWidth()) {
            left = (this.chatListView.getMeasuredWidth() - AndroidUtilities.m102dp(6)) - chatScrimPopupContainerLayout.getMeasuredWidth();
        }
        ...
        int measuredHeight = chatScrimPopupContainerLayout.getMeasuredHeight() + AndroidUtilities.m102dp(48);
        ...
        if (measuredHeight < height) {
            ...
            if ((measuredHeight - rect.top) - rect.bottom > AndroidUtilities.m102dp((int) PsExtractor.VIDEO_STREAM_MASK)) {
                i2 += AndroidUtilities.m102dp((int) PsExtractor.VIDEO_STREAM_MASK) - measuredHeight;
            }
            if (i2 < this.chatListView.getY() + AndroidUtilities.m102dp(24)) {
                i2 = (int) (this.chatListView.getY() + AndroidUtilities.m102dp(24));
            } else {
                int i4 = height - measuredHeight;
                if (i2 > i4 - AndroidUtilities.m102dp(8)) {
                    i2 = i4 - AndroidUtilities.m102dp(8);
                }
            }
    ...
    public static /* synthetic */ void lambda$createMenu$10(ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, Runnable runnable, boolean z, TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, String str) {
        if (z) {
            arrayList.add(LocaleController.getString("BanUser", C3630R.string.BanUser));
            arrayList2.add(Integer.valueOf(C3630R.C3632drawable.msg_block2));
            arrayList3.add(33);
        }
    ...
    */
    private void processSelectedOption(int r12) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChannelAdminLogActivity.processSelectedOption(int):void");
    }
    ...
    public /* synthetic */ void lambda$processSelectedOption$11(TLObject tLObject) {
        if (tLObject instanceof TLRPC$TL_boolTrue) {
            BulletinFactory.m61of(this).createSimpleBulletin(C3630R.raw.msg_antispam, LocaleController.getString("ChannelAntiSpamFalsePositiveReported", C3630R.string.ChannelAntiSpamFalsePositiveReported)).show();
        } else if (tLObject instanceof TLRPC$TL_boolFalse) {
            BulletinFactory.m61of(this).createSimpleBulletin(C3630R.raw.error, LocaleController.getString("UnknownError", C3630R.string.UnknownError)).show();
        } else {
            BulletinFactory.m61of(this).createSimpleBulletin(C3630R.raw.error, LocaleController.getString("UnknownError", C3630R.string.UnknownError)).show();
        }
    }
        ...
        if (i == 10 || i == 11 || i == 16) {
            ...
            if (messageObject.isSticker() || messageObject.isAnimatedSticker()) {
                ...
                if (inputStickerSet instanceof TLRPC$TL_inputStickerSetID) {
                    if (!MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(inputStickerSet.f1623id)) {
                        return 7;
                    }
    ...
    public /* synthetic */ void lambda$loadAdmins$13(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (tLRPC$TL_error == null) {
            ...
            if (this.currentChat != null && (chatFull = getMessagesController().getChatFull(this.currentChat.f1600id)) != null && chatFull.antispam) {
    ...
    private void loadAntispamUser(long j) {
        ...
        tLRPC$TL_users_getUsers.f1758id.add(tLRPC$TL_inputUser);
    ...
    public void updateMessagesVisiblePart() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                chatMessageCell2.setVisiblePart(i4, measuredHeight2 - i4, (this.contentView.getHeightWithKeyboard() - AndroidUtilities.m102dp(48)) - this.chatListView.getTop(), BitmapDescriptorFactory.HUE_RED, (childAt.getY() + this.actionBar.getMeasuredHeight()) - this.contentView.getBackgroundTranslationY(), this.contentView.getMeasuredWidth(), this.contentView.getBackgroundSizeY(), 0, 0);
    ...
    public void alertUserOpenError(MessageObject messageObject) {
        ...
        if (messageObject.type == 3) {
            builder.setMessage(LocaleController.getString("NoPlayerInstalled", C3630R.string.NoPlayerInstalled));
        } else {
            builder.setMessage(LocaleController.formatString("NoHandleAppInstalled", C3630R.string.NoHandleAppInstalled, messageObject.getDocument().mime_type));
        }
        showDialog(builder.create());
    }
    ...
    public void addCanBanUser(Bundle bundle, long j) {
        ...
        if (tLRPC$Chat.megagroup && this.admins != null && ChatObject.canBlockUsers(tLRPC$Chat)) {
            ...
            bundle.putLong("ban_chat_id", this.currentChat.f1600id);
        }
    }
    ...
    public void showOpenUrlAlert(final String str, boolean z) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setTitle(LocaleController.getString("OpenUrlTitle", C3630R.string.OpenUrlTitle));
        builder.setMessage(LocaleController.formatString("OpenUrlAlert2", C3630R.string.OpenUrlAlert2, str));
        builder.setPositiveButton(LocaleController.getString("Open", C3630R.string.Open), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda0
    ...
    public class ChatActivityAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                chatMessageCell.setDelegate(new C41281());
                ...
                ChatActionCell chatActionCell2 = new ChatActionCell(this, this.mContext) { // from class: org.telegram.ui.ChannelAdminLogActivity.ChatActivityAdapter.2
                    @Override // org.telegram.p042ui.Cells.ChatActionCell, android.view.View
                    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                        super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                        accessibilityNodeInfo.setVisibleToUser(true);
                    }
                };
                chatActionCell2.setDelegate(new C41303());
        ...
        /* loaded from: classes5.dex */
        public class C41281 implements ChatMessageCell.ChatMessageCellDelegate {
            ...
            public void didPressUserAvatar(ChatMessageCell chatMessageCell, TLRPC$User tLRPC$User, float f, float f2) {
                if (tLRPC$User == null || tLRPC$User.f1762id == UserConfig.getInstance(((BaseFragment) ChannelAdminLogActivity.this).currentAccount).getClientUserId()) {
                    return;
                }
            ...
            @Override // org.telegram.p042ui.Cells.ChatMessageCell.ChatMessageCellDelegate
            public boolean didLongPressUserAvatar(final ChatMessageCell chatMessageCell, final TLRPC$User tLRPC$User, float f, float f2, boolean z) {
                AvatarPreviewer.Data m66of;
                if (tLRPC$User != null && tLRPC$User.f1762id != UserConfig.getInstance(((BaseFragment) ChannelAdminLogActivity.this).currentAccount).getClientUserId()) {
                    AvatarPreviewer.MenuItem[] menuItemArr = {AvatarPreviewer.MenuItem.OPEN_PROFILE, AvatarPreviewer.MenuItem.SEND_MESSAGE};
                    TLRPC$UserFull userFull = ChannelAdminLogActivity.this.getMessagesController().getUserFull(tLRPC$User.f1762id);
                    if (userFull == null) {
                        m66of = AvatarPreviewer.Data.m66of(tLRPC$User, ((BaseFragment) ChannelAdminLogActivity.this).classGuid, menuItemArr);
                    } else {
                        m66of = AvatarPreviewer.Data.m65of(userFull, menuItemArr);
                    }
                    if (AvatarPreviewer.canPreview(m66of)) {
                        AvatarPreviewer.getInstance().show((ViewGroup) ((BaseFragment) ChannelAdminLogActivity.this).fragmentView, m66of, new AvatarPreviewer.Callback() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$1$$ExternalSyntheticLambda1
                            @Override // org.telegram.p042ui.AvatarPreviewer.Callback
                            public final void onMenuClick(AvatarPreviewer.MenuItem menuItem) {
                                ChannelAdminLogActivity.ChatActivityAdapter.C41281.this.lambda$didLongPressUserAvatar$0(chatMessageCell, tLRPC$User, menuItem);
                            }
                        });
                        return true;
                    }
            ...
            public /* synthetic */ void lambda$didLongPressUserAvatar$0(ChatMessageCell chatMessageCell, TLRPC$User tLRPC$User, AvatarPreviewer.MenuItem menuItem) {
                int i = C412023.$SwitchMap$org$telegram$ui$AvatarPreviewer$MenuItem[menuItem.ordinal()];
                if (i == 1) {
            ...
            private void openProfile(TLRPC$User tLRPC$User) {
                ...
                ChannelAdminLogActivity.this.addCanBanUser(bundle, tLRPC$User.f1762id);
            ...
            public void didPressUrl(ChatMessageCell chatMessageCell, CharacterStyle characterStyle, boolean z) {
                ...
                if (characterStyle instanceof URLSpanMono) {
                    ...
                    if (AndroidUtilities.shouldShowClipboardToast()) {
                        Toast.makeText(ChannelAdminLogActivity.this.getParentActivity(), LocaleController.getString("TextCopied", C3630R.string.TextCopied), 0).show();
                    }
                    ...
                    if (z) {
                        ...
                        builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3630R.string.Open), LocaleController.getString("Copy", C3630R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$1$$ExternalSyntheticLambda0
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i) {
                                ChannelAdminLogActivity.ChatActivityAdapter.C41281.this.lambda$didPressUrl$1(url2, dialogInterface, i);
                            }
                        });
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public void didPressImage(org.telegram.p042ui.Cells.ChatMessageCell r10, float r11, float r12) {
                /*
                    Method dump skipped, instructions count: 500
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChannelAdminLogActivity.ChatActivityAdapter.C41281.didPressImage(org.telegram.ui.Cells.ChatMessageCell, float, float):void");
            }
        ...
        /* loaded from: classes5.dex */
        public class C41303 implements ChatActionCell.ChatActionCellDelegate {
            ...
            public void needOpenInviteLink(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported) {
                ...
                if (obj == null) {
                    ...
                    tLRPC$TL_messages_getExportedChatInvite.peer = ChannelAdminLogActivity.this.getMessagesController().getInputPeer(-ChannelAdminLogActivity.this.currentChat.f1600id);
                    ...
                    alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda0
                        ...
                        public final void onCancel(DialogInterface dialogInterface) {
                            ChannelAdminLogActivity.ChatActivityAdapter.C41303.this.lambda$needOpenInviteLink$0(zArr, dialogInterface);
                        }
                    });
                    ...
                    ChannelAdminLogActivity.this.getConnectionsManager().bindRequestToGuid(ChannelAdminLogActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_messages_getExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda2
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            ChannelAdminLogActivity.ChatActivityAdapter.C41303.this.lambda$needOpenInviteLink$2(tLRPC$TL_chatInviteExported, zArr, alertDialog, tLObject, tLRPC$TL_error);
                        }
                    ...
                    BulletinFactory.m61of(ChannelAdminLogActivity.this).createSimpleBulletin(C3630R.raw.linkbroken, LocaleController.getString("LinkHashExpired", C3630R.string.LinkHashExpired)).show();
                }
            }
            ...
            public /* synthetic */ void lambda$needOpenInviteLink$2(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, final boolean[] zArr, final AlertDialog alertDialog, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                ...
                if (tLRPC$TL_error == null) {
                    ...
                    for (int i = 0; i < tLRPC$TL_messages_exportedChatInvite.users.size(); i++) {
                        ...
                        ChannelAdminLogActivity.this.usersMap.put(Long.valueOf(tLRPC$User.f1762id), tLRPC$User);
                    }
                } else {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChannelAdminLogActivity.ChatActivityAdapter.C41303.this.lambda$needOpenInviteLink$1(tLRPC$TL_chatInviteExported, tLRPC$TL_messages_exportedChatInvite2, zArr, alertDialog);
                    }
                });
            }
            ...
            public long getDialogId() {
                return -ChannelAdminLogActivity.this.currentChat.f1600id;
            }
        }
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r14, int r15) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChannelAdminLogActivity.ChatActivityAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C412023 {
    ...
    public void showInviteLinkBottomSheet(TLRPC$TL_messages_exportedChatInvite tLRPC$TL_messages_exportedChatInvite, HashMap<Long, TLRPC$User> hashMap) {
        TLRPC$ChatFull chatFull = getMessagesController().getChatFull(this.currentChat.f1600id);
        InviteLinkBottomSheet inviteLinkBottomSheet = new InviteLinkBottomSheet(this.contentView.getContext(), (TLRPC$TL_chatInviteExported) tLRPC$TL_messages_exportedChatInvite.invite, chatFull, hashMap, this, chatFull.f1601id, false, ChatObject.isChannel(this.currentChat));
        inviteLinkBottomSheet.setInviteDelegate(new InviteLinkBottomSheet.InviteDelegate() { // from class: org.telegram.ui.ChannelAdminLogActivity.22
            @Override // org.telegram.p042ui.Components.InviteLinkBottomSheet.InviteDelegate
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(c3702ActionBar2, i3, null, null, null, null, i4));
        ...
        arrayList.add(new ThemeDescription(c3702ActionBar3, i5, null, null, null, null, i6));
