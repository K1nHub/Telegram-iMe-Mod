...
public class SelfStoryViewsView extends FrameLayout {
    ...
    public SelfStoryViewsView(Context context, final StoryViewer storyViewer) {
        ...
        this.selfStoriesPreviewView = new SelfStoriesPreviewView(getContext()) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.1
            @Override // org.telegram.p042ui.Stories.SelfStoriesPreviewView
            void onDragging() {
        ...
        ViewPagerInner viewPagerInner = new ViewPagerInner(context) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.2
            ...
            @Override // org.telegram.p042ui.Stories.SelfStoryViewsView.ViewPagerInner, androidx.viewpager.widget.ViewPager, android.view.ViewGroup
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (!checkTopOffset(motionEvent) && Math.abs(SelfStoryViewsView.this.getCurrentTopOffset() - SelfStoryViewsView.this.bottomPadding) <= AndroidUtilities.m102dp(1)) {
                    return super.onInterceptTouchEvent(motionEvent);
                }
                return false;
            }

            @Override // org.telegram.p042ui.Stories.SelfStoryViewsView.ViewPagerInner, androidx.viewpager.widget.ViewPager, android.view.View
        ...
        C70564 c70564 = new C70564(storyViewer, context);
        this.pagerAdapter = c70564;
        viewPagerInner2.setAdapter(c70564);
    ...
    /* loaded from: classes6.dex */
    public class C70564 extends PagerAdapter {
        ...
        C70564(StoryViewer storyViewer, Context context) {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            SelfStoryViewsPage selfStoryViewsPage = new SelfStoryViewsPage(this.val$storyViewer, this.val$context, SelfStoryViewsView.this.sharedFilterState, new Consumer() { // from class: org.telegram.ui.Stories.SelfStoryViewsView$4$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    SelfStoryViewsView.C70564.this.lambda$instantiateItem$0((SelfStoryViewsPage) obj);
                }
            }) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.4.1
                @Override // org.telegram.p042ui.Stories.SelfStoryViewsPage
            ...
            selfStoryViewsPage.setPadding(0, AndroidUtilities.m102dp(16), 0, 0);
    ...
    public void setKeyboardHeight(int i) {
        ...
        boolean z = this.keyboardHeight >= AndroidUtilities.m102dp(20);
        boolean z2 = i >= AndroidUtilities.m102dp(20);
        if (z2 != z) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.toY = AndroidUtilities.m102dp(20) + i3;
        ((FrameLayout.LayoutParams) this.viewPagerContainer.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight;
        float m102dp = (((i3 + AndroidUtilities.m102dp(20)) + this.toHeight) + AndroidUtilities.m102dp(24)) - AndroidUtilities.statusBarHeight;
        this.bottomPadding = m102dp;
        this.maxSelfStoriesViewsOffset = size - m102dp;
    ...
    public void setOffset(float f) {
        ...
        if (f2 == 1.0f && this.progressToOpen != 1.0f) {
            if (this.storyViewer.storiesList != null) {
                ...
                this.storyViewer.storiesViewPager.setCurrentDate(day, messageObject.storyItem.f1635id);
