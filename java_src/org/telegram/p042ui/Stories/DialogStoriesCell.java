...
public class DialogStoriesCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DialogStoriesCell(Context context, BaseFragment baseFragment, int i, int i2) {
        ...
        recyclerListView.setPadding(AndroidUtilities.m102dp(3), 0, AndroidUtilities.m102dp(3), 0);
        ...
        this.titleView.setPadding(0, AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8));
        this.titleView.setTextSize(AndroidUtilities.m102dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20 : 18));
        ...
        this.grayPaint.setStrokeWidth(AndroidUtilities.m102dp(1));
        this.addNewStoryDrawable = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.msg_mini_addstory);
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                for (int i4 = 0; i4 < DialogStoriesCell.this.viewsDrawInParent.size(); i4++) {
                    ...
                    if (storyCell2.getAlpha() != 1.0f) {
                        canvas.saveLayerAlpha(-AndroidUtilities.m102dp(4), -AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(50), AndroidUtilities.m102dp(50), (int) (storyCell2.getAlpha() * 255.0f), 31);
                    }
                    canvas.scale(storyCell2.getScaleX(), storyCell2.getScaleY(), AndroidUtilities.m102dp(14), storyCell2.getCy());
        ...
        this.listViewMini.addItemDecoration(new RecyclerView.ItemDecoration(this) { // from class: org.telegram.ui.Stories.DialogStoriesCell.4
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (childLayoutPosition == 1) {
                    rect.left = (-AndroidUtilities.m102dp(85)) + AndroidUtilities.m103dp(33.0f);
    ...
    public void updateItems(boolean z, boolean z2) {
        ...
        if (this.storiesController.hasOnlySelfStories()) {
            if (this.storiesController.hasUploadingStories(UserConfig.getInstance(this.currentAccount).getClientUserId())) {
                String string = LocaleController.getString("UploadingStory", C3630R.string.UploadingStory);
                if (string.indexOf("…") > 0) {
                ...
                this.currentTitle = LocaleController.getString("MyStory", C3630R.string.MyStory);
            }
        } else {
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.DialogStoriesCell.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        this.titleView.setTextSize(AndroidUtilities.m102dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20 : 18));
        this.currentCellWidth = AndroidUtilities.m103dp(70.0f);
        ...
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(89), 1073741824));
    }
    ...
    public void setProgressToCollapse(float f, boolean z) {
        ...
        final boolean z2 = f > this.f1968K;
    ...
    public void setOverscoll(float f) {
        this.overscrollPrgoress = f / AndroidUtilities.m102dp(90);
        invalidate();
    ...
    public void setActionBar(C3702ActionBar c3702ActionBar) {
    ...
    public class StoryCell extends FrameLayout {
        ...
        /* renamed from: cx */
        private float f1969cx;

        /* renamed from: cy */
        private float f1970cy;
        long dialogId;
        ...
        public StoryCell(Context context) {
            ...
            this.avatarImage.setRoundRadius(AndroidUtilities.m102dp(48) / 2);
            this.crossfageToAvatarImage.setRoundRadius(AndroidUtilities.m102dp(48) / 2);
        }
        ...
        public void setDialogId(long j) {
            ...
            if (DialogStoriesCell.this.storiesController.isLastUploadingFailed(j)) {
                this.textView.setText(LocaleController.getString("FailedStory", C3630R.string.FailedStory));
                ...
                if (z && this.isUploadingState && !this.mini) {
                    ...
                    DialogStoriesCell.this.textAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.DialogStoriesCell.StoryCell.1
                        ...
                        public void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ...
                            simpleTextView.setTranslationY((-AndroidUtilities.m102dp(5)) * floatValue);
                            StoryCell.this.textView.setAlpha(floatValue);
                            StoryCell.this.textView.setTranslationY(AndroidUtilities.m102dp(5) * f);
                        }
                    });
                    ...
                    this.textView.setTranslationY(AndroidUtilities.m102dp(5));
                ...
                this.isUploadingState = false;
                this.textView.setText(LocaleController.getString("MyStory", C3630R.string.MyStory));
            } else {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.mini ? AndroidUtilities.m103dp(70.0f) : DialogStoriesCell.this.currentCellWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(81), 1073741824));
        }

        float getCy() {
            float m102dp = AndroidUtilities.m102dp(28);
            return AndroidUtilities.lerp(AndroidUtilities.m102dp(5), (C3702ActionBar.getCurrentActionBarHeight() - m102dp) / 2.0f, DialogStoriesCell.this.collapsedProgress1) + (AndroidUtilities.lerp(AndroidUtilities.m102dp(48), m102dp, this.progressToCollapsed) / 2.0f);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float m102dp = AndroidUtilities.m102dp(48);
            float m102dp2 = AndroidUtilities.m102dp(28);
            float m102dp3 = AndroidUtilities.m102dp(8) * Utilities.clamp(DialogStoriesCell.this.overscrollPrgoress / 0.5f, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            if (this.selectedForOverscroll) {
                m102dp3 += AndroidUtilities.m102dp(16) * Utilities.clamp((DialogStoriesCell.this.overscrollPrgoress - 0.5f) / 0.5f, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            }
            float lerp = AndroidUtilities.lerp(m102dp + m102dp3, m102dp2, this.progressToCollapsed);
            float f6 = lerp / 2.0f;
            ...
            float lerp3 = AndroidUtilities.lerp(AndroidUtilities.m102dp(5), (C3702ActionBar.getCurrentActionBarHeight() - m102dp2) / 2.0f, this.progressToCollapsed);
            ...
            if (this.progressToCollapsed != BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(this.f1969cx, this.f1970cy, AndroidUtilities.m102dp(3) + f6, DialogStoriesCell.this.backgroundPaint);
            }
            canvas.save();
            float f10 = this.bounceScale;
            canvas.scale(f10, f10, this.f1969cx, this.f1970cy);
            ...
            if (z2 || (this.progressWasDrawn && (radialProgress = this.radialProgress) != null && radialProgress.getAnimatedProgress() < 0.98f)) {
                ...
                this.radialProgress.setProgressRect((int) (this.avatarImage.getImageX() - AndroidUtilities.m102dp(3)), (int) (this.avatarImage.getImageY() - AndroidUtilities.m102dp(3)), (int) (this.avatarImage.getImageX2() + AndroidUtilities.m102dp(3)), (int) (this.avatarImage.getImageY2() + AndroidUtilities.m102dp(3)));
                ...
                if (this.drawAvatar) {
                    ...
                    avatarStoryParams3.progressToArc = getArcProgress(this.f1969cx, f6);
                    ...
                    if (f13 > BitmapDescriptorFactory.HUE_RED) {
                        ...
                        errorPaint.setStrokeWidth(AndroidUtilities.m102dp(i));
                        errorPaint.setAlpha((int) (255.0f * f13));
                        canvas.drawCircle(f5, f4, (f6 + AndroidUtilities.m102dp(4)) * this.params.getScale(), errorPaint);
                    }
                    f12 = f13;
                    z = false;
                } else {
                ...
                if (this.drawAvatar) {
                    ...
                    canvas.scale(f14, f14, this.f1969cx + AndroidUtilities.m102dp(16), this.f1970cy + AndroidUtilities.m102dp(16));
                    drawPlus(canvas, this.f1969cx, this.f1970cy, 1.0f);
                    drawFail(canvas, this.f1969cx, this.f1970cy, f12);
                    canvas.restore();
                }
            }
            canvas.restore();
            ...
            this.textViewContainer.setTranslationY(f + (AndroidUtilities.m102dp(7) * (1.0f - this.progressToCollapsed)));
        ...
        private float getArcProgress(float f, float f2) {
            ...
            if (!this.isLast && DialogStoriesCell.this.overscrollPrgoress <= BitmapDescriptorFactory.HUE_RED) {
                if (AndroidUtilities.lerp(getMeasuredWidth(), AndroidUtilities.m103dp(18.0f), CubicBezierInterpolator.EASE_OUT.getInterpolation(this.progressToCollapsed)) < (f2 + AndroidUtilities.dpf2(3.5f)) * 2.0f) {
        ...
        public void drawPlus(Canvas canvas, float f, float f2, float f3) {
            if (this.isSelf && !DialogStoriesCell.this.storiesController.hasStories(this.dialogId) && Utilities.isNullOrEmpty(DialogStoriesCell.this.storiesController.getUploadingStories(this.dialogId))) {
                float m102dp = f + AndroidUtilities.m102dp(16);
                float m102dp2 = f2 + AndroidUtilities.m102dp(16);
                DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
                ...
                canvas.drawCircle(m102dp, m102dp2, AndroidUtilities.m102dp(11), DialogStoriesCell.this.backgroundPaint);
                canvas.drawCircle(m102dp, m102dp2, AndroidUtilities.m102dp(9), DialogStoriesCell.this.addCirclePaint);
                ...
                DialogStoriesCell.this.addNewStoryDrawable.setBounds((int) (m102dp - (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicWidth() / 2.0f)), (int) (m102dp2 - (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicHeight() / 2.0f)), (int) (m102dp + (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicWidth() / 2.0f)), (int) (m102dp2 + (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicHeight() / 2.0f)));
        ...
        public void drawFail(Canvas canvas, float f, float f2, float f3) {
            ...
            float m102dp = f + AndroidUtilities.m102dp(17);
            float m102dp2 = f2 + AndroidUtilities.m102dp(17);
            ...
            float m102dp3 = AndroidUtilities.m102dp(9) * CubicBezierInterpolator.EASE_OUT_BACK.getInterpolation(f3);
            canvas.drawCircle(m102dp, m102dp2, AndroidUtilities.m102dp(2) + m102dp3, DialogStoriesCell.this.backgroundPaint);
            canvas.drawCircle(m102dp, m102dp2, m102dp3, DialogStoriesCell.this.addCirclePaint);
            DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
            dialogStoriesCell.addCirclePaint.setColor(Theme.multAlpha(dialogStoriesCell.getTextColor(), f3));
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(m102dp - AndroidUtilities.m102dp(1), m102dp2 - AndroidUtilities.dpf2(4.6f), AndroidUtilities.m102dp(1) + m102dp, AndroidUtilities.dpf2(1.6f) + m102dp2);
            canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(3), AndroidUtilities.m102dp(3), DialogStoriesCell.this.addCirclePaint);
            rectF.set(m102dp - AndroidUtilities.m102dp(1), AndroidUtilities.dpf2(2.6f) + m102dp2, m102dp + AndroidUtilities.m102dp(1), m102dp2 + AndroidUtilities.dpf2(4.6f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(3), AndroidUtilities.m102dp(3), DialogStoriesCell.this.addCirclePaint);
        }
        ...
        public void setProgressToCollapsed(float f, float f2, float f3, boolean z) {
            ...
            if (i != 0 || this.progressToCollapsed2 != f2 || this.overscrollProgress != f3 || this.selectedForOverscroll != z) {
                ...
                AndroidUtilities.m102dp(28);
                invalidate();
                DialogStoriesCell.this.recyclerListView.invalidate();
            }
            if (!this.mini) {
                DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
                f4 = 1.0f - Utilities.clamp(dialogStoriesCell.collapsedProgress / dialogStoriesCell.f1968K, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            }
    ...
    public Drawable createVerifiedDrawable() {
        final Drawable mutate = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.verified_area).mutate();
        final Drawable mutate2 = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.verified_check).mutate();
    ...
    static float getAvatarRight(int i, float f) {
        float lerp = AndroidUtilities.lerp(AndroidUtilities.m102dp(48), AndroidUtilities.m102dp(28), f) / 2.0f;
    ...
    private HintView2 makePremiumHint() {
        ...
        this.premiumHint.setPadding(AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(24), AndroidUtilities.m102dp(8), 0);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.currentState == 2) {
            ...
            this.miniItemsClickArea.setRect((int) this.listViewMini.getX(), (int) this.listViewMini.getY(), (int) (this.listViewMini.getX() + AndroidUtilities.m103dp((size * 28) - (Math.max(0, size - 1) * 18.0f))), (int) (this.listViewMini.getY() + this.listViewMini.getHeight()));
