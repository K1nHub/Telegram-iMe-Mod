...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class StoryCircle {
        ...
        public StoryCircle(TLRPC$StoryItem tLRPC$StoryItem) {
            ...
            this.imageReceiver.setRoundRadius(AndroidUtilities.m102dp(200));
    ...
    public ProfileStoriesView(Context context, int i, long j, View view, ProfileActivity.AvatarImageView avatarImageView, Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m102dp(18));
    ...
    public void updateStories(boolean z, boolean z2) {
        ...
        if (arrayList != null) {
            ...
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                ...
                if (!(tLRPC$StoryItem2 instanceof TLRPC$TL_storyItemDeleted)) {
                    if (tLRPC$StoryItem2.f1635id > max) {
                        this.unreadCount++;
                    }
                    i++;
                }
            ...
            for (int i4 = 0; i4 < arrayList.size(); i4++) {
                ...
                if (!(tLRPC$StoryItem3 instanceof TLRPC$TL_storyItemDeleted)) {
                    if (tLRPC$StoryItem3 instanceof TLRPC$TL_storyItemSkipped) {
                        int i5 = tLRPC$StoryItem3.f1635id;
                        if (stories != null) {
                            int i6 = 0;
                            while (true) {
                                if (i6 >= stories.stories.size()) {
                                    break;
                                } else if (stories.stories.get(i6).f1635id == i5) {
                            ...
                            if (tLRPC$PeerStories != null) {
                                ...
                                while (true) {
                                    if (i7 >= tLRPC$PeerStories.stories.size()) {
                                        break;
                                    } else if (tLRPC$PeerStories.stories.get(i7).f1635id == i5) {
                    ...
                    if (z4 || tLRPC$StoryItem3.f1635id > max) {
        ...
        if (arrayList2.size() < 3) {
            for (int i8 = 0; i8 < arrayList.size(); i8++) {
                ...
                if (tLRPC$StoryItem4 instanceof TLRPC$TL_storyItemSkipped) {
                    int i9 = tLRPC$StoryItem4.f1635id;
                    if (stories != null) {
                        int i10 = 0;
                        while (true) {
                            if (i10 >= stories.stories.size()) {
                                break;
                            } else if (stories.stories.get(i10).f1635id == i9) {
                        ...
                        if (tLRPC$PeerStories != null) {
                            ...
                            while (true) {
                                if (i11 >= tLRPC$PeerStories.stories.size()) {
                                    break;
                                } else if (tLRPC$PeerStories.stories.get(i11).f1635id == i9) {
        ...
        for (int i12 = 0; i12 < this.circles.size(); i12++) {
            ...
            while (true) {
                ...
                if (tLRPC$StoryItem.f1635id == storyCircle.storyId) {
                    break;
                }
                i13++;
            }
            if (i13 == -1) {
                ...
                storyCircle.read = z4 || !(tLRPC$PeerStories2 == null || tLRPC$StoryItem == null || tLRPC$StoryItem.f1635id > tLRPC$PeerStories2.max_read_id);
            }
            if (!z) {
                storyCircle.apply();
            }
        ...
        for (int i14 = 0; i14 < arrayList2.size(); i14++) {
            ...
            while (true) {
                if (i15 >= this.circles.size()) {
                    i15 = -1;
                    break;
                } else if (this.circles.get(i15).storyId == tLRPC$StoryItem5.f1635id) {
                    break;
                } else {
                    i15++;
                }
            ...
            if (i15 == -1) {
                ...
                storyCircle2.read = z4 || (tLRPC$PeerStories2 != null && tLRPC$StoryItem5.f1635id <= tLRPC$PeerStories2.max_read_id);
                if (!z) {
                    storyCircle2.apply();
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:139:0x06a1, code lost:
    ...
    /* JADX WARN: Removed duplicated region for block: B:150:0x06dc  */
    /* JADX WARN: Removed duplicated region for block: B:181:0x06fa A[SYNTHETIC] */
    @Override // android.view.View
    /*
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.ProfileStoriesView.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    public void setBounds(float f, float f2, float f3, boolean z) {
        boolean z2 = Math.abs(f - this.left) > 0.1f || Math.abs(f2 - this.right) > 0.1f || Math.abs(f3 - this.f1971cy) > 0.1f;
        this.left = f;
        this.right = f2;
        if (!z) {
    ...
    /* loaded from: classes6.dex */
    public class C70363 implements StoryViewer.PlaceProvider {
            ...
            if (storyCircle != null && storyCircle2 != null) {
                ...
                transitionViewHolder.drawClip = new StoryViewer.HolderClip() { // from class: org.telegram.ui.Stories.ProfileStoriesView$3$$ExternalSyntheticLambda0
                    ...
                    public final void clip(Canvas canvas, RectF rectF3, float f, boolean z) {
                        ProfileStoriesView.C70363.this.lambda$findView$0(rectF, storyCircle, rectF2, storyCircle2, canvas, rectF3, f, z);
                    }
                };
            } else {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.expandProgress < 0.9f) {
            ...
            z = motionEvent.getX() >= (this.expandRight - this.f1972w) - ((float) AndroidUtilities.m102dp(32)) && motionEvent.getX() <= this.expandRight + ((float) AndroidUtilities.m102dp(32)) && Math.abs(motionEvent.getY() - this.expandY) < ((float) AndroidUtilities.m102dp(32));
        }
        ...
        if (motionEvent.getAction() == 1) {
            if (z && System.currentTimeMillis() - this.tapTime <= ViewConfiguration.getTapTimeout() && MathUtils.distance(this.tapX, this.tapY, motionEvent.getX(), motionEvent.getY()) <= AndroidUtilities.m102dp(12) && (this.storiesController.hasUploadingStories(this.dialogId) || this.storiesController.hasStories(this.dialogId) || !this.circles.isEmpty())) {
                onTap(this.provider);
                return true;
            }
