...
public class UserListPoller {
    ...
    private UserListPoller(int i) {
        new ArrayList();
        this.requestCollectedRunnables = new RunnableC70931();
    ...
    /* loaded from: classes6.dex */
    public class RunnableC70931 implements Runnable {
        RunnableC70931() {
        }
        ...
        public void run() {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                tLRPC$TL_stories_getPeerMaxIDs.f1742id.add(MessagesController.getInstance(UserListPoller.this.currentAccount).getInputPeer(((Long) arrayList.get(i)).longValue()));
            }
            ConnectionsManager.getInstance(UserListPoller.this.currentAccount).sendRequest(tLRPC$TL_stories_getPeerMaxIDs, new RequestDelegate() { // from class: org.telegram.ui.Stories.UserListPoller$1$$ExternalSyntheticLambda1
                ...
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    UserListPoller.RunnableC70931.this.lambda$run$1(arrayList, tLObject, tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$run$1(final ArrayList arrayList, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.UserListPoller$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    UserListPoller.RunnableC70931.this.lambda$run$0(tLObject, arrayList);
                }
            });
        }
