...
public class StoryViewer implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void open(Context context, TLRPC$StoryItem tLRPC$StoryItem, ArrayList<Long> arrayList, int i, StoriesController.StoriesList storiesList, TLRPC$PeerStories tLRPC$PeerStories, PlaceProvider placeProvider, boolean z) {
        ...
        if (this.windowView == null) {
            ...
            this.windowView = new C70822(context, lastFragment);
        }
        if (this.containerView == null) {
            this.containerView = new HwFrameLayout(context) { // from class: org.telegram.ui.Stories.StoryViewer.3
                ...
                protected void dispatchDraw(Canvas canvas) {
                    ...
                    if (currentPeerView != null) {
                        StoryViewer.this.volumeControl.setTranslationY(currentPeerView.storyContainer.getY() - AndroidUtilities.m102dp(4));
                    }
            ...
            HwStoriesViewPager hwStoriesViewPager = new HwStoriesViewPager(context, this, this.resourcesProvider) { // from class: org.telegram.ui.Stories.StoryViewer.4
                @Override // org.telegram.p042ui.Stories.StoriesViewPager
            ...
            hwStoriesViewPager.setDelegate(new C70885(storiesList, arrayList));
            ...
            if (this.USE_SURFACE_VIEW) {
                ...
                HwTextureView hwTextureView = new HwTextureView(context) { // from class: org.telegram.ui.Stories.StoryViewer.6
                    @Override // org.telegram.p042ui.Stories.HwTextureView, android.view.View
    ...
    /* loaded from: classes6.dex */
    public class C70822 extends SizeNotifierFrameLayout {
        ...
        C70822(Context context, BaseFragment baseFragment) {
            super(context);
        ...
        */
        public void dispatchDraw(android.graphics.Canvas r18) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.StoryViewer.C70822.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        public boolean dispatchTouchEvent(MotionEvent motionEvent) {
            ...
            if (currentPeerView == null || !currentPeerView.checkTextSelectionEvent(motionEvent)) {
                    ...
                    if (f != BitmapDescriptorFactory.HUE_RED) {
                        ...
                        StoryViewer.this.swipeToDissmissBackAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.StoryViewer$2$$ExternalSyntheticLambda0
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                StoryViewer.C70822.this.lambda$dispatchTouchEvent$0(valueAnimator);
                            }
                        });
                ...
                if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                    ...
                    if (storyViewer10.selfStoriesViewsOffset != BitmapDescriptorFactory.HUE_RED && !storyViewer10.flingCalled && StoryViewer.this.realKeyboardHeight < AndroidUtilities.m102dp(20)) {
            ...
            if (motionEvent.getAction() == 0 && StoryViewer.this.progressToOpen == 1.0f) {
                ...
                if (storyViewer4.allowIntercept && storyViewer4.isCaptionPartVisible) {
                    StoryViewer.this.delayedTapRunnable = new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$2$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            StoryViewer.C70822.this.lambda$onInterceptTouchEvent$1();
                        }
                    };
                ...
                if (storyViewer2.progressToDismiss < 1.0f) {
                    if (!storyViewer2.isClosed) {
                        ...
                        StoryViewer.this.swipeToDissmissBackAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.StoryViewer$2$$ExternalSyntheticLambda1
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                StoryViewer.C70822.this.lambda$onTouchEvent$2(valueAnimator);
                            }
                        });
        ...
        public void onAttachedToWindow() {
            ...
            Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.Stories.StoryViewer.2.3
                ...
                public int getBottomOffset(int i) {
                    ...
                    return (int) (C70822.this.getMeasuredHeight() - (this.position[1] + currentPeerView.storyContainer.getMeasuredHeight()));
                }
            });
        ...
        protected void onMeasure(int i, int i2) {
            ((FrameLayout.LayoutParams) StoryViewer.this.volumeControl.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight - AndroidUtilities.m102dp(2);
            StoryViewer.this.volumeControl.getLayoutParams().height = AndroidUtilities.m102dp(2);
    ...
    /* loaded from: classes6.dex */
    public class C70885 implements PeerStoriesView.Delegate {
        final /* synthetic */ ArrayList val$peerIds;
        final /* synthetic */ StoriesController.StoriesList val$storiesList;

        C70885(StoriesController.StoriesList storiesList, ArrayList arrayList) {
            this.val$storiesList = storiesList;
            this.val$peerIds = arrayList;
        }

        @Override // org.telegram.p042ui.Stories.PeerStoriesView.Delegate
            ...
            if (this.val$storiesList != null) {
                ...
                if (indexOf >= 0) {
                    ...
                    storiesViewPager.onNextIdle(new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$5$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            StoryViewer.C70885.this.lambda$switchToNextAndRemoveCurrentPeer$0(storiesList, arrayList);
                        }
                    });
                    return;
                }
            ...
            if (indexOf2 >= 0) {
                ...
                if (!StoryViewer.this.storiesViewPager.switchToNext(true)) {
                    ...
                    StoryViewer.this.storiesViewPager.onNextIdle(new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$5$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            StoryViewer.C70885.this.lambda$switchToNextAndRemoveCurrentPeer$1(arrayList2, indexOf2);
                        }
                    });
                    return;
                }
    ...
    public /* synthetic */ void lambda$cancelSwipeToReply$3(ValueAnimator valueAnimator) {
        ...
        this.swipeToReplyProgress = Utilities.clamp(this.swipeToReplyOffset / AndroidUtilities.m102dp(200), 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
        StoriesViewPager storiesViewPager = this.storiesViewPager;
    ...
    private void updateTransitionParams() {
        if (this.placeProvider != null) {
            ...
            int i = (currentPeerView == null || selectedPosition < 0 || selectedPosition >= currentPeerView.storyItems.size()) ? 0 : currentPeerView.storyItems.get(selectedPosition).f1635id;
    ...
    public void updateProgressToDismiss() {
        ...
        if (f != BitmapDescriptorFactory.HUE_RED) {
            clamp = MathUtils.clamp(Math.abs(f / AndroidUtilities.m102dp(80)), (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
        } else {
            clamp = MathUtils.clamp(Math.abs(this.swipeToDismissOffset / AndroidUtilities.m102dp(80)), (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
        }
    ...
    public /* synthetic */ void lambda$startCloseAnimation$7() {
        ...
        this.containerView.enableHwAcceleration();
        this.openCloseAnimator.addListener(new C708111());
    ...
    /* loaded from: classes6.dex */
    public class C708111 extends AnimatorListenerAdapter {
        C708111() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            try {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$11$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        StoryViewer.C708111.this.lambda$onAnimationEnd$0();
                    }
                });
            } catch (Exception unused) {
            }
            ...
            if (this.storiesList == ((StoriesController.StoriesList) objArr[0])) {
                ...
                if (selfStoryViewsView != null) {
                    ...
                    while (i3 < this.storiesList.messageObjects.size()) {
                        if (selectedStory != null && selectedStory.f1635id == this.storiesList.messageObjects.get(i3).storyItem.f1635id) {
                            i4 = i3;
                        }
    ...
    private long draftHash(long j, TLRPC$StoryItem tLRPC$StoryItem) {
        return j + (j >> 16) + (tLRPC$StoryItem.f1635id << 16);
    }
    ...
    public class VideoPlayerHolder extends VideoPlayerHolderBase {
        ...
        public /* synthetic */ void lambda$onStateChanged$0() {
            ...
            FileLog.m100d("StoryViewer displayed story buffering dialogId=" + currentPeerView.getCurrentPeer() + " storyId=" + currentPeerView.currentStory.storyItem.f1635id);
        }
        ...
        public /* synthetic */ void lambda$onStateChanged$1() {
            ...
            FileLog.m100d("StoryViewer displayed story playing dialogId=" + currentPeerView.getCurrentPeer() + " storyId=" + currentPeerView.currentStory.storyItem.f1635id);
        }
    }
}
