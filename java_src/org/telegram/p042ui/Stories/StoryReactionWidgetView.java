...
public class StoryReactionWidgetView extends StoryMediaAreasView.AreaView {
    ...
    public StoryReactionWidgetView(Context context, View view, TLRPC$TL_mediaAreaSuggestedReaction tLRPC$TL_mediaAreaSuggestedReaction, EmojiAnimationsOverlay emojiAnimationsOverlay) {
        ...
        this.animatedTextDrawable.setTextSize(AndroidUtilities.m102dp(14));
    ...
    @Override // org.telegram.p042ui.Stories.StoryMediaAreasView.AreaView, android.view.View
    protected void onDraw(Canvas canvas) {
        ...
        this.animatedTextDrawable.setBounds(this.storyReactionWidgetBackground.getBounds().left, (int) (height2 - AndroidUtilities.m102dp(10)), this.storyReactionWidgetBackground.getBounds().right, (int) (AndroidUtilities.m102dp(10) + height2));
        canvas.save();
