...
import org.telegram.p042ui.Components.BitmapShaderTools;
...
import org.telegram.p042ui.Components.Reactions.ReactionImageHolder;
...
import org.telegram.p042ui.Stories.SelfStoriesPreviewView;
...
import org.telegram.p042ui.WrappedResourceProvider;
...
public class PeerStoriesView extends SizeNotifierFrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PeerStoriesView(final Context context, final StoryViewer storyViewer, final SharedResources sharedResources, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.storyAreasView = new StoryMediaAreasView(context, resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.3
            @Override // org.telegram.p042ui.Stories.StoryMediaAreasView
        ...
        C70244 c70244 = new C70244(context, sharedResources, storyViewer);
        this.storyContainer = c70244;
        c70244.setClipChildren(false);
        ...
        C70265 c70265 = new C70265(getContext(), storyViewer.resourcesProvider, storyViewer, resourcesProvider);
        this.storyCaptionView = c70265;
        c70265.captionTextview.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda13
        ...
        storiesLikeButton.setPadding(m102dp, m102dp, m102dp, m102dp);
        ...
        imageView2.setPadding(AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(8));
        ...
        rLottieImageView.setPadding(AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6));
        frameLayout2.addView(rLottieImageView);
        ImageView imageView3 = new ImageView(context);
        this.noSoundIconView = imageView3;
        imageView3.setPadding(AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6));
        ...
        this.storyContainer.addView(c70265, LayoutHelper.createFrame(-1, -1, 0, 0, 64, 0, 0));
        frameLayout2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(20), 0, ColorUtils.setAlphaComponent(-1, 100)));
        imageView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(20), 0, ColorUtils.setAlphaComponent(-1, 100)));
        imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(20), 0, ColorUtils.setAlphaComponent(-1, 100)));
        frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(20), 0, ColorUtils.setAlphaComponent(-1, 100)));
        View overlayView = c70265.textSelectionHelper.getOverlayView(context);
        if (overlayView != null) {
            AndroidUtilities.removeFromParent(overlayView);
            addView(overlayView);
        }
        c70265.textSelectionHelper.setCallback(new TextSelectionHelper.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView.7
        ...
        c70265.textSelectionHelper.setParentView(this);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Stories.PeerStoriesView$4 */
    /* loaded from: classes6.dex */
    public class C70244 extends HwFrameLayout {
        ...
        C70244(Context context, SharedResources sharedResources, StoryViewer storyViewer) {
            super(context);
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r17) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.PeerStoriesView.C70244.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        private void drawLines(Canvas canvas) {
            ...
            if (!PeerStoriesView.this.switchEventSent && f == 1.0f && (!PeerStoriesView.this.currentStory.isVideo || !PeerStoriesView.this.isCaptionPartVisible)) {
                ...
                post(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$4$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C70244.this.lambda$drawLines$0();
                    }
                });
            }
            ...
            canvas.save();
            canvas.translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(8) - (AndroidUtilities.m102dp(8) * PeerStoriesView.this.outT));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (PeerStoriesView.this.drawLinesAsCounter()) {
                ...
                layoutParams.topMargin = AndroidUtilities.m102dp(55);
            } else {
                layoutParams.rightMargin = AndroidUtilities.m102dp(42);
                layoutParams.topMargin = AndroidUtilities.m102dp(15);
            }
    ...
    /* loaded from: classes6.dex */
    public class C70265 extends StoryCaptionView {
        final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;
        final /* synthetic */ StoryViewer val$storyViewer;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C70265(Context context, Theme.ResourcesProvider resourcesProvider, StoryViewer storyViewer, Theme.ResourcesProvider resourcesProvider2) {
            super(context, resourcesProvider);
            this.val$storyViewer = storyViewer;
            this.val$resourcesProvider = resourcesProvider2;
        }

        @Override // org.telegram.p042ui.Stories.StoryCaptionView
        public void onLinkClick(CharacterStyle characterStyle, View view) {
            if (characterStyle instanceof URLSpanUserMention) {
                ...
                BulletinFactory.m62of(PeerStoriesView.this.storyContainer, this.val$resourcesProvider).createCopyBulletin(LocaleController.getString("TextCopied", C3630R.string.TextCopied)).show();
        ...
        public void onLinkLongPress(final URLSpan uRLSpan, final View view, final Runnable runnable) {
            ...
            CharSequence[] charSequenceArr = (storyItemHolder == null || storyItemHolder.allowScreenshots()) ? new CharSequence[]{LocaleController.getString("Open", C3630R.string.Open), LocaleController.getString("Copy", C3630R.string.Copy)} : new CharSequence[]{LocaleController.getString("Open", C3630R.string.Open)};
            ...
            builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$5$$ExternalSyntheticLambda0
                ...
                public final void onClick(DialogInterface dialogInterface, int i) {
                    PeerStoriesView.C70265.this.lambda$onLinkLongPress$0(uRLSpan, view, url, resourcesProvider, dialogInterface, i);
                }
            });
        ...
        public /* synthetic */ void lambda$onLinkLongPress$0(URLSpan uRLSpan, View view, String str, Theme.ResourcesProvider resourcesProvider, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                BulletinFactory.m62of(PeerStoriesView.this.storyContainer, resourcesProvider).createCopyLinkBulletin().show();
            }
        }
        ...
        public void onEmojiClick(AnimatedEmojiSpan animatedEmojiSpan) {
            if (animatedEmojiSpan != null) {
                ...
                BulletinFactory m62of = BulletinFactory.m62of(PeerStoriesView.this.storyContainer, this.val$resourcesProvider);
                final StoryViewer storyViewer = this.val$storyViewer;
                final Theme.ResourcesProvider resourcesProvider = this.val$resourcesProvider;
                Bulletin createContainsEmojiBulletin = m62of.createContainsEmojiBulletin(tLRPC$Document, 2, new Utilities.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView$5$$ExternalSyntheticLambda2
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        PeerStoriesView.C70265.this.lambda$onEmojiClick$2(storyViewer, resourcesProvider, (TLRPC$InputStickerSet) obj);
                    }
                });
    ...
    public /* synthetic */ void lambda$new$5(StoryViewer storyViewer, View view) {
        ...
        if (j == j2) {
            ...
            storyViewer.presentFragment(ChatActivity.m64of(j2));
        }
    }
    ...
    public /* synthetic */ void lambda$new$6(Theme.ResourcesProvider resourcesProvider, Context context, StoryViewer storyViewer, SharedResources sharedResources, View view) {
        ...
        C70276 c70276 = new C70276(getContext(), resourcesProvider, this.isSelf, resourcesProvider, context, storyViewer, sharedResources, zArr);
        this.popupMenu = c70276;
        c70276.show(this.optionsIconView, 0, (-C3702ActionBar.getCurrentActionBarHeight()) + AndroidUtilities.m102dp(6));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Stories.PeerStoriesView$6 */
    /* loaded from: classes6.dex */
    public class C70276 extends CustomPopupMenu {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C70276(Context context, Theme.ResourcesProvider resourcesProvider, boolean z, Theme.ResourcesProvider resourcesProvider2, Context context2, StoryViewer storyViewer, SharedResources sharedResources, boolean[] zArr) {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:52:0x0144, code lost:
            if (r13.stories_hidden != false) goto L39;
         */
        /* JADX WARN: Code restructure failed: missing block: B:53:0x0146, code lost:
            r1 = true;
         */
        /* JADX WARN: Code restructure failed: missing block: B:62:0x0159, code lost:
            if (r14.stories_hidden != false) goto L39;
         */
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        protected void onCreate(org.telegram.p042ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout r31) {
            /*
                Method dump skipped, instructions count: 1464
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.PeerStoriesView.C70276.onCreate(org.telegram.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout):void");
        }
        ...
        public /* synthetic */ void lambda$onCreate$7(Theme.ResourcesProvider resourcesProvider, Context context, final StoryViewer storyViewer, final SharedResources sharedResources, View view) {
            if (view.getAlpha() < 1.0f) {
                ...
                BulletinFactory.m62of(PeerStoriesView.this.storyContainer, resourcesProvider).createErrorBulletin("Wait until current upload is complete").show();
                return;
            }
            ...
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda26
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70276.this.lambda$onCreate$6(findActivity, storyViewer, sharedResources);
                }
            };
        ...
        public /* synthetic */ void lambda$onCreate$6(Activity activity, StoryViewer storyViewer, final SharedResources sharedResources) {
            ...
            storyRecorder.setOnFullyOpenListener(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda24
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70276.this.lambda$onCreate$2();
                }
            });
            storyRecorder.setOnPrepareCloseListener(new Utilities.Callback3() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda28
                ...
                public final void run(Object obj, Object obj2, Object obj3) {
                    PeerStoriesView.C70276.this.lambda$onCreate$5(sharedResources, (Long) obj, (Runnable) obj2, (Boolean) obj3);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onCreate$5(SharedResources sharedResources, Long l, final Runnable runnable, Boolean bool) {
            ...
            if (videoPlayerHolder == null) {
                ...
                peerStoriesView2.onImageReceiverThumbLoaded = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda20
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C70276.lambda$onCreate$3(runnable);
                    }
                };
            ...
            videoPlayerHolder.setOnReadyListener(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda21
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70276.lambda$onCreate$4(runnable, currentTimeMillis);
                }
            });
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$9(final TLRPC$StoryItem tLRPC$StoryItem, final boolean z, final Theme.ResourcesProvider resourcesProvider, View view) {
            ...
            MessagesController.getInstance(PeerStoriesView.this.currentAccount).getStoriesController().updateStoriesPinned(PeerStoriesView.this.dialogId, arrayList, z, new Utilities.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda29
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    PeerStoriesView.C70276.this.lambda$onCreate$8(tLRPC$StoryItem, z, resourcesProvider, (Boolean) obj);
                }
            });
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$8(TLRPC$StoryItem tLRPC$StoryItem, boolean z, Theme.ResourcesProvider resourcesProvider, Boolean bool) {
            int i;
            String str;
            if (bool.booleanValue()) {
                ...
                if (!peerStoriesView.isSelf) {
                    if (z) {
                        BulletinFactory.m62of(peerStoriesView.storyContainer, resourcesProvider).createSimpleBulletin(C3630R.raw.contact_check, LocaleController.getString("StoryPinnedToPosts", C3630R.string.StoryPinnedToPosts), LocaleController.getString("StoryPinnedToPostsDescription", C3630R.string.StoryPinnedToPostsDescription)).show();
                        return;
                    } else {
                        BulletinFactory.m62of(peerStoriesView.storyContainer, resourcesProvider).createSimpleBulletin(C3630R.raw.chats_archived, LocaleController.getString("StoryUnpinnedFromPosts", C3630R.string.StoryUnpinnedFromPosts)).show();
                        return;
                    }
                }
                BulletinFactory m62of = BulletinFactory.m62of(peerStoriesView.storyContainer, resourcesProvider);
                int i2 = z ? C3630R.raw.contact_check : C3630R.raw.chats_archived;
                if (z) {
                    i = C3630R.string.StoryPinnedToProfile;
                    str = "StoryPinnedToProfile";
                } else {
                    i = C3630R.string.StoryArchivedFromProfile;
                    str = "StoryArchivedFromProfile";
                }
                m62of.createSimpleBulletin(i2, LocaleController.getString(str, i)).show();
                return;
            }
            BulletinFactory.m62of(PeerStoriesView.this.storyContainer, resourcesProvider).createSimpleBulletin(C3630R.raw.error, LocaleController.getString("UnknownError", C3630R.string.UnknownError)).show();
        }
        ...
        public /* synthetic */ void lambda$onCreate$14(String str, Theme.ResourcesProvider resourcesProvider, TLObject tLObject, String str2, View view) {
            ...
            BulletinFactory.m62of(PeerStoriesView.this.storyContainer, resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", C3630R.string.NotificationsStoryMutedHint, str2))).setTag(2).show();
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        public /* synthetic */ void lambda$onCreate$15(String str, Theme.ResourcesProvider resourcesProvider, TLObject tLObject, String str2, View view) {
            ...
            NotificationsController.getInstance(PeerStoriesView.this.currentAccount).updateServerNotificationsSettings(PeerStoriesView.this.dialogId, 0);
            BulletinFactory.m62of(PeerStoriesView.this.storyContainer, resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", C3630R.string.NotificationsStoryUnmutedHint, str2))).setTag(2).show();
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        public /* synthetic */ void lambda$onCreate$20(ActionBarMenuSubItem actionBarMenuSubItem, final StoryViewer storyViewer, View view) {
            ...
            if (global != null) {
                global.createSimpleBulletin(C3630R.raw.ic_save_to_gallery, AndroidUtilities.replaceSingleTag(LocaleController.getString("SaveStoryToGalleryPremiumHint", C3630R.string.SaveStoryToGalleryPremiumHint), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda27
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C70276.this.lambda$onCreate$19(storyViewer);
                    }
                })).show();
            }
        }
        ...
        public /* synthetic */ void lambda$onCreate$26(View view) {
            ...
            final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda23
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70276.this.lambda$onCreate$24();
                }
            };
            MessagesController.getInstance(PeerStoriesView.this.currentAccount).getTranslateController().translateStory(PeerStoriesView.this.currentStory.storyItem, new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda22
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70276.lambda$onCreate$25(runnable, currentTimeMillis);
                }
            });
            PeerStoriesView.this.updatePosition();
            PeerStoriesView peerStoriesView2 = PeerStoriesView.this;
        ...
        public /* synthetic */ void lambda$onCreate$27(StoryViewer storyViewer, Theme.ResourcesProvider resourcesProvider, View view) {
            AlertsCreator.createReportAlert(PeerStoriesView.this.getContext(), PeerStoriesView.this.dialogId, 0, PeerStoriesView.this.currentStory.storyItem.f1635id, storyViewer.fragment, resourcesProvider, null);
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        protected void onDismissed() {
            if (!this.edit && !this.val$popupStillVisible[0]) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda25
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C70276.this.lambda$onDismissed$29();
                    }
                });
            }
            PeerStoriesView peerStoriesView = PeerStoriesView.this;
    ...
    */
    public /* synthetic */ void lambda$new$8(android.view.View r13) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.PeerStoriesView.lambda$new$8(android.view.View):void");
    }
    ...
    public void createStealthModeItem(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        if (UserConfig.getInstance(this.currentAccount).isPremium()) {
            ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3630R.C3632drawable.msg_stories_stealth2, LocaleController.getString("StealthMode", C3630R.string.StealthMode), false, this.resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda16
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.msg_gallery_locked2);
        drawable.setColorFilter(new PorterDuffColorFilter(ColorUtils.blendARGB(-1, -16777216, 0.5f), PorterDuff.Mode.MULTIPLY));
        CombinedDrawable combinedDrawable = new CombinedDrawable(this, ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.msg_stealth_locked), drawable) { // from class: org.telegram.ui.Stories.PeerStoriesView.8
            @Override // org.telegram.p042ui.Components.CombinedDrawable, android.graphics.drawable.Drawable
            public void setColorFilter(ColorFilter colorFilter) {
            }
        };
        ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3630R.C3632drawable.msg_stories_stealth2, LocaleController.getString("StealthMode", C3630R.string.StealthMode), false, this.resourcesProvider);
    ...
    private void animateLikeButton() {
        ...
        storiesLikeButton2.setPadding(m102dp, m102dp, m102dp, m102dp);
                ...
                while (i < storyItemHolder.storyItem.entities.size()) {
                    ...
                    if (tLRPC$MessageEntity instanceof TLRPC$TL_messageEntityCustomEmoji) {
                        ...
                        if (tLRPC$Document != null) {
                            ...
                            if (!hashSet.contains(Long.valueOf(inputStickerSet.f1623id))) {
                                hashSet.add(Long.valueOf(inputStickerSet.f1623id));
                ...
                if ((charSequence instanceof Spanned) && (animatedEmojiSpanArr = (AnimatedEmojiSpan[]) ((Spanned) charSequence).getSpans(0, charSequence.length(), AnimatedEmojiSpan.class)) != null) {
                    ...
                    while (i < animatedEmojiSpanArr.length) {
                        ...
                        if (tLRPC$Document2 != null) {
                            ...
                            if (!hashSet2.contains(Long.valueOf(inputStickerSet2.f1623id))) {
                                hashSet2.add(Long.valueOf(inputStickerSet2.f1623id));
    ...
    public /* synthetic */ void lambda$toggleArchiveForStory$15(final MessagesController messagesController, final long j, final boolean z, String str, TLObject tLObject) {
        ...
        BulletinFactory.m62of(this.storyContainer, this.resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), !z ? AndroidUtilities.replaceTags(LocaleController.formatString("StoriesMovedToDialogs", C3630R.string.StoriesMovedToDialogs, ContactsController.formatName(str, null, 10))) : AndroidUtilities.replaceTags(LocaleController.formatString("StoriesMovedToContacts", C3630R.string.StoriesMovedToContacts, ContactsController.formatName(str, null, 10))), null, undoObject).setTag(2).show();
    }
    ...
    private void createEnterView() {
        C699413 c699413 = new C699413(AndroidUtilities.findActivity(getContext()), this, null, true, new WrappedResourceProvider(this, this.resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.12
            @Override // org.telegram.p042ui.WrappedResourceProvider
            public void appendColors() {
                this.sparseIntArray.put(Theme.key_chat_emojiPanelBackground, ColorUtils.setAlphaComponent(-1, 30));
            }
        });
        this.chatActivityEnterView = c699413;
        c699413.getEditField().useAnimatedTextDrawable();
        this.chatActivityEnterView.setOverrideKeyboardAnimation(true);
        this.chatActivityEnterView.setClipChildren(false);
        this.chatActivityEnterView.setDelegate(new C699614());
    ...
    /* loaded from: classes6.dex */
    public class C699413 extends ChatActivityEnterView {
        private int chatActivityEnterViewAnimateFromTop;
        private Animator messageEditTextAnimator;
        int messageEditTextPredrawHeigth;
        int messageEditTextPredrawScrollY;

        C699413(Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, ChatActivity chatActivity, boolean z, Theme.ResourcesProvider resourcesProvider) {
            super(activity, sizeNotifierFrameLayout, chatActivity, z, resourcesProvider);
        }

        @Override // org.telegram.p042ui.Components.ChatActivityEnterView
        ...
        public void checkAnimation() {
            ...
            if (i != 0 && backgroundTop != i) {
                ...
                PeerStoriesView.this.changeBoundAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$13$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        PeerStoriesView.C699413.this.lambda$checkAnimation$0(valueAnimator);
                    }
                });
                PeerStoriesView.this.changeBoundAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.13.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        PeerStoriesView.this.invalidate();
                        ((ChatActivityEnterView) C699413.this).animatedTop = 0;
                        C699413 c699413 = C699413.this;
                        PeerStoriesView.this.forceUpdateOffsets = true;
                        if (((ChatActivityEnterView) c699413).topView != null && ((ChatActivityEnterView) C699413.this).topView.getVisibility() == 0) {
                            ((ChatActivityEnterView) C699413.this).topView.setTranslationY(((ChatActivityEnterView) C699413.this).animatedTop + ((1.0f - ((ChatActivityEnterView) C699413.this).topViewEnterProgress) * ((ChatActivityEnterView) C699413.this).topView.getLayoutParams().height));
                            if (((ChatActivityEnterView) C699413.this).topLineView != null) {
                                ((ChatActivityEnterView) C699413.this).topLineView.setTranslationY(((ChatActivityEnterView) C699413.this).animatedTop);
                            }
                        }
            ...
            if (this.shouldAnimateEditTextWithBounds) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$13$$ExternalSyntheticLambda1
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        PeerStoriesView.C699413.this.lambda$checkAnimation$1(valueAnimator);
                    }
                });
    ...
    /* loaded from: classes6.dex */
    public class C699614 implements ChatActivityEnterView.ChatActivityEnterViewDelegate {
        ...
        public void onMessageSend(CharSequence charSequence, boolean z, int i, String str) {
            if (!PeerStoriesView.this.isRecording) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$14$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C699614.this.lambda$onMessageSend$0();
                    }
                }, 200L);
            }
        }
        ...
        public void needShowMediaBanHint() {
            ...
            PeerStoriesView.this.mediaBanTooltip.setText(AndroidUtilities.replaceTags(LocaleController.formatString(PeerStoriesView.this.chatActivityEnterView.isInVideoMode() ? C3630R.string.VideoMessagesRestrictedByPrivacy : C3630R.string.VoiceMessagesRestrictedByPrivacy, MessagesController.getInstance(PeerStoriesView.this.currentAccount).getUser(Long.valueOf(PeerStoriesView.this.dialogId)).first_name)));
    ...
    public boolean applyMessageToChat(final Runnable runnable) {
        ...
        if (i > 0 && this.stealthModeIsActive) {
            ...
            alertDialog.setTitle(LocaleController.getString("StealthModeConfirmTitle", C3630R.string.StealthModeConfirmTitle));
            alertDialog.setMessage(LocaleController.getString("StealthModeConfirmMessage", C3630R.string.StealthModeConfirmMessage));
            alertDialog.setPositiveButton(LocaleController.getString("Proceed", C3630R.string.Proceed), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda3
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    runnable.run();
                }
            });
            alertDialog.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda7
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
    ...
    private void createChatAttachView() {
        if (this.chatAttachAlert == null) {
            ChatAttachAlert chatAttachAlert = new ChatAttachAlert(getContext(), null, false, false, true, this.resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.17
                @Override // org.telegram.p042ui.Components.ChatAttachAlert, org.telegram.p042ui.ActionBar.BottomSheet
    ...
    public void shareStory(boolean z) {
        ...
        if (z) {
            ...
            ShareAlert shareAlert = new ShareAlert(this.storyViewer.fragment.getContext(), null, createLink, false, createLink, false, new WrappedResourceProvider(this, this.resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.20
                ...
                public void onSend(LongSparseArray<TLRPC$Dialog> longSparseArray, int i, TLRPC$TL_forumTopic tLRPC$TL_forumTopic) {
                    ...
                    PeerStoriesView peerStoriesView = PeerStoriesView.this;
                    BulletinFactory m62of = BulletinFactory.m62of(peerStoriesView.storyContainer, peerStoriesView.resourcesProvider);
                    if (m62of != null) {
                        if (longSparseArray.size() == 1) {
                            long keyAt = longSparseArray.keyAt(0);
                            if (keyAt == UserConfig.getInstance(this.currentAccount).clientUserId) {
                                m62of.createSimpleBulletin(C3630R.raw.saved_messages, AndroidUtilities.replaceTags(LocaleController.formatString("StorySharedToSavedMessages", C3630R.string.StorySharedToSavedMessages, new Object[0])), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).hideAfterBottomSheet(false).show();
                            } else if (keyAt < 0) {
                                TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-keyAt));
                                int i2 = C3630R.raw.forward;
                                int i3 = C3630R.string.StorySharedTo;
                                Object[] objArr = new Object[1];
                                objArr[0] = tLRPC$TL_forumTopic != null ? tLRPC$TL_forumTopic.title : chat.title;
                                m62of.createSimpleBulletin(i2, AndroidUtilities.replaceTags(LocaleController.formatString("StorySharedTo", i3, objArr)), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).hideAfterBottomSheet(false).show();
                            } else {
                                m62of.createSimpleBulletin(C3630R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatString("StorySharedTo", C3630R.string.StorySharedTo, MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(keyAt)).first_name)), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).hideAfterBottomSheet(false).show();
                            }
                        } else {
                            m62of.createSimpleBulletin(C3630R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatPluralString("StorySharedToManyChats", longSparseArray.size(), Integer.valueOf(longSparseArray.size())))).hideAfterBottomSheet(false).show();
                        }
            ...
            this.shareAlert.setDelegate(new ShareAlert.ShareAlertDelegate() { // from class: org.telegram.ui.Stories.PeerStoriesView.22
                @Override // org.telegram.p042ui.Components.ShareAlert.ShareAlertDelegate
        ...
        LaunchActivity.instance.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("StickersShare", C3630R.string.StickersShare)), 500);
    }
    ...
    public void onLickCopied() {
        ...
        tLRPC$TL_stories_exportStoryLink.f1741id = this.currentStory.storyItem.f1635id;
    ...
    private void bindInternal(int i) {
        ...
        if (j >= 0) {
            ...
            if (this.isSelf) {
                this.headerView.titleView.setText(LocaleController.getString("SelfStoryTitle", C3630R.string.SelfStoryTitle));
                this.headerView.titleView.setRightDrawable((Drawable) null);
            } else {
                if (user != null && user.verified) {
                    Drawable mutate = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.verified_profile).mutate();
                    mutate.setAlpha(255);
                    CombinedDrawable combinedDrawable = new CombinedDrawable(mutate, null);
                    combinedDrawable.setFullsize(true);
                    combinedDrawable.setCustomSize(AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16));
        ...
        if (this.isChannel) {
            ...
            if (this.reactionsCounter == null) {
                ...
                this.reactionsCounter.setTextSize(AndroidUtilities.m102dp(14));
            ...
            if (i == -1) {
                ...
                if (arrayList != null) {
                    ...
                    for (int i3 = 0; i3 < this.storyItems.size(); i3++) {
                        if (this.storyItems.get(i3).justUploaded || this.storyItems.get(i3).f1635id > this.storiesController.dialogIdToMaxReadId.get(this.dialogId)) {
    ...
    private void createUnsupportedContainer() {
        ...
        textView.setText(LocaleController.getString("StoryUnsupported", C3630R.string.StoryUnsupported));
        textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, this.resourcesProvider));
        TextView textView2 = new TextView(getContext());
        ScaleStateListAnimator.apply(textView2);
        textView2.setText(LocaleController.getString("AppUpdate", C3630R.string.AppUpdate));
        int i = Theme.key_featuredStickers_buttonText;
        textView2.setTextColor(Theme.getColor(i, this.resourcesProvider));
        textView2.setPadding(AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(12));
        textView2.setGravity(17);
        textView2.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView2.setTextSize(1, 15.0f);
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider), ColorUtils.setAlphaComponent(Theme.getColor(i, this.resourcesProvider), 30)));
            ...
            if (i == -1 && !this.storyViewer.isSingleStory && (tLRPC$PeerStories = this.userStories) != null && tLRPC$PeerStories.max_read_id > 0) {
                ...
                while (true) {
                    if (i2 >= this.storyItems.size()) {
                        break;
                    } else if (this.storyItems.get(i2).f1635id > this.userStories.max_read_id) {
    ...
    private void createSelfPeerView() {
        ...
        FrameLayout frameLayout = new FrameLayout(getContext()) { // from class: org.telegram.ui.Stories.PeerStoriesView.25
            ...
            protected void dispatchDraw(Canvas canvas) {
                int x;
                if (PeerStoriesView.this.selfAvatarsContainer.getVisibility() == 0 && PeerStoriesView.this.selfAvatarsContainer.getLayoutParams().width != (x = (int) (((PeerStoriesView.this.selfStatusView.getX() + PeerStoriesView.this.selfStatusView.getMeasuredWidth()) - PeerStoriesView.this.selfAvatarsContainer.getX()) + AndroidUtilities.m102dp(10)))) {
        ...
        hwAvatarsImageView.setAvatarsTextSize(AndroidUtilities.m102dp(18));
        ...
        this.selfAvatarsContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(15), 0, ColorUtils.setAlphaComponent(-1, 120)));
        imageView.setBackground(Theme.createCircleSelectorDrawable(ColorUtils.setAlphaComponent(-1, 120), -AndroidUtilities.m102dp(2), -AndroidUtilities.m102dp(2)));
    }
    ...
    public void deleteStory() {
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext(), this.resourcesProvider);
        builder.setTitle(LocaleController.getString("DeleteStoryTitle", C3630R.string.DeleteStoryTitle));
        builder.setMessage(LocaleController.getString("DeleteStorySubtitle", C3630R.string.DeleteStorySubtitle));
        builder.setPositiveButton(LocaleController.getString("Delete", C3630R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                PeerStoriesView.this.lambda$deleteStory$22(dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda6
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
            }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.sharedResources.topOverlayGradient.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m102dp(72));
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.isChannel && (animatedTextDrawable = this.reactionsCounter) != null) {
            animatedTextDrawable.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m102dp(40));
        }
        super.dispatchDraw(canvas);
        ...
        if (z && this.reactionsCounter != null) {
            canvas.save();
            canvas.translate((getMeasuredWidth() - this.reactionsCounter.getCurrentWidth()) - AndroidUtilities.m102dp(12), this.likeButtonContainer.getY());
            AnimatedFloat animatedFloat = this.reactionsCounterProgress;
            if (this.reactionsCounterVisible) {
                f = 1.0f;
            }
            f = animatedFloat.set(f);
            canvas.scale(f, f, this.reactionsCounter.getCurrentWidth() / 2.0f, AndroidUtilities.m102dp(20));
        ...
        if (this.movingReaction) {
            ...
            int lerp3 = AndroidUtilities.lerp(this.movingReactionFromSize, m102dp, this.movingReactionProgress);
        ...
        if (this.drawReactionEffect) {
            ...
            int m102dp2 = AndroidUtilities.m102dp(120);
            if (!this.drawAnimatedEmojiAsMovingReaction) {
                float f5 = m102dp2;
                float f6 = f5 / 2.0f;
    ...
    private void updateButtonsOffsets(float f) {
        if (this.isChannel) {
            float m102dp = ((-this.reactionsCounter.getCurrentWidth()) - AndroidUtilities.m102dp(4)) * f;
            this.shareButton.setTranslationX(m102dp);
            this.likeButtonContainer.setTranslationX(m102dp);
        } else if (this.isSelf) {
            this.shareButton.setTranslationX(AndroidUtilities.m102dp(40));
        ...
        if (this.chatActivityEnterView != null && this.isVisible && this.attachedToWindow) {
            ...
            if (stealthMode != null) {
                ...
                if (currentTime < i) {
                    ...
                    int i4 = C3630R.string.StealthModeActiveHintShort;
                    ...
                    if (((int) this.chatActivityEnterView.getEditField().getPaint().measureText(LocaleController.formatString("StealthModeActiveHint", i4, String.format(locale, "%02d:%02d", 99, 99)))) * 1.2f >= this.chatActivityEnterView.getEditField().getMeasuredWidth()) {
                        ...
                        this.chatActivityEnterView.setOverrideHint(LocaleController.formatString("StealthModeActiveHint", C3630R.string.StealthModeActiveHint, String.format(locale, "%02d:%02d", Integer.valueOf(i2), Integer.valueOf(i3))), z);
                    }
            ...
            this.chatActivityEnterView.setOverrideHint(LocaleController.getString("ReplyPrivately", C3630R.string.ReplyPrivately), z);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:253:0x0622, code lost:
        if (r1.captionTranslated != (r8 != null && r8.translated && r8.translatedText != null && android.text.TextUtils.equals(r8.translatedLng, org.telegram.p042ui.Components.TranslateAlert2.getToLanguage()))) goto L298;
     */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    */
    private void updatePosition(boolean r42) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.PeerStoriesView.updatePosition(boolean):void");
    }
    ...
    public /* synthetic */ void lambda$updatePosition$26() {
        if (this.storyViewer.isShown()) {
            ...
            if (this.reactionsLongpressTooltip == null) {
                ...
                this.reactionsLongpressTooltip.setText(LocaleController.getString("ReactionLongTapHint", C3630R.string.ReactionLongTapHint));
                this.reactionsLongpressTooltip.setPadding(AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(1));
    ...
    private void createReplyDisabledView() {
        ...
        this.replyDisabledTextView.setText(LocaleController.getString("StoryReplyDisabled", C3630R.string.StoryReplyDisabled));
    ...
    */
    private void updatePreloadImages() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.PeerStoriesView.updatePreloadImages():void");
    }
        ...
        if (z2 || this.isSelf) {
            if (tLRPC$StoryItem == null) {
                ...
                if (tLRPC$StoryItem.views.views_count > 0) {
                    this.selfStatusView.setText(this.storyViewer.storiesList == null ? LocaleController.getString("NobodyViews", C3630R.string.NobodyViews) : LocaleController.getString("NobodyViewsArchived", C3630R.string.NobodyViewsArchived));
                    this.selfStatusView.setTranslationX(AndroidUtilities.m102dp(16));
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                    spannableStringBuilder.append((CharSequence) "d  ");
                    spannableStringBuilder.setSpan(new ColoredImageSpan(C3630R.C3632drawable.filled_views), spannableStringBuilder.length() - 3, spannableStringBuilder.length() - 2, 0);
                ...
                if (this.reactionsCounterVisible) {
                    this.likeButtonContainer.getLayoutParams().width = (int) (AndroidUtilities.m102dp(40) + this.reactionsCounter.getAnimateToWidth() + AndroidUtilities.m102dp(4));
                    ((FrameLayout.LayoutParams) this.likeButtonContainer.getLayoutParams()).rightMargin = (AndroidUtilities.m102dp(10) + AndroidUtilities.m102dp(40)) - this.likeButtonContainer.getLayoutParams().width;
                } else {
                    this.likeButtonContainer.getLayoutParams().width = AndroidUtilities.m102dp(40);
                    ((FrameLayout.LayoutParams) this.likeButtonContainer.getLayoutParams()).rightMargin = AndroidUtilities.m102dp(10);
                }
                ...
                if (tLRPC$StoryViews2 != null && tLRPC$StoryViews2.views_count > 0) {
                    ...
                    if (tLRPC$StoryItem.views.reactions_count > 0) {
                        ...
                        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C3630R.C3632drawable.mini_views_likes);
                        coloredImageSpan.setOverrideColor(-53704);
                        coloredImageSpan.setTopOffset(AndroidUtilities.m103dp(0.2f));
                    ...
                    if (i2 == 0) {
                        ...
                        this.selfStatusView.setTranslationX(AndroidUtilities.m102dp(13) + AndroidUtilities.m102dp(24) + (AndroidUtilities.m102dp(20) * (i2 - 1)) + AndroidUtilities.m102dp(10));
                    }
                    ...
                    if (tLRPC$StoryItem != null) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                sb.append("&id=");
                                sb.append(tLRPC$Document2.f1608id);
                                sb.append("&hash=");
        ...
        if (captionContainerView == null || !captionContainerView.onBackPressed()) {
            ...
            if (customPopupMenu != null && customPopupMenu.isShowing()) {
                ...
                if (chatActivityEnterView != null && chatActivityEnterView.isPopupShowing()) {
                    ...
                    return true;
                } else if (getKeyboardHeight() >= AndroidUtilities.m102dp(20)) {
                    ChatActivityEnterView chatActivityEnterView2 = this.chatActivityEnterView;
                    if (chatActivityEnterView2 != null) {
            ...
            if (hintView22 == null || !hintView22.shown()) {
                for (int i = 0; i < viewGroup.getChildCount(); i++) {
                    ...
                    if (childAt.getVisibility() == 0) {
                        ...
                        StoryMediaAreasView storyMediaAreasView = this.storyAreasView;
                        if (childAt == storyMediaAreasView && !storyMediaAreasView.hasSelected() && (f < AndroidUtilities.m102dp(60) || f > viewGroup.getMeasuredWidth() - AndroidUtilities.m102dp(60))) {
    ...
    public void setActive(long j, boolean z) {
        if (this.isActive != z) {
            ...
            if (z) {
                ...
                if (this.currentStory.storyItem != null) {
                    FileLog.m100d("StoryViewer displayed story dialogId=" + this.dialogId + " storyId=" + this.currentStory.storyItem.f1635id);
                }
            } else {
                cancelTextSelection();
    ...
    */
    private void sendUriAsDocument(android.net.Uri r19) {
        ...
        L99:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.PeerStoriesView.sendUriAsDocument(android.net.Uri):void");
    }

    private void showAttachmentError() {
        BulletinFactory.m62of(this.storyContainer, this.resourcesProvider).createErrorBulletin(LocaleController.getString("UnsupportedAttachment", C3630R.string.UnsupportedAttachment), this.resourcesProvider).show();
    }
    ...
    public void showNoSoundHint(boolean z) {
        if (this.soundTooltip == null) {
            ...
            joint.setPadding(AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8), 0);
            this.storyContainer.addView(this.soundTooltip, LayoutHelper.createFrame(-1, -2, 55, 0, 52, 0, 0));
        }
        this.soundTooltip.setText(LocaleController.getString(z ? C3630R.string.StoryNoSound : C3630R.string.StoryTapToSound));
    ...
    public static class PeerHeaderView extends FrameLayout {
        ...
        public PeerHeaderView(Context context, StoryItemHolder storyItemHolder) {
            ...
            backupImageView.setRoundRadius(AndroidUtilities.m102dp(16));
            ...
            this.titleView.setEllipsizeByGradient(AndroidUtilities.m102dp(4));
        ...
        public void setSubtitle(CharSequence charSequence, boolean z) {
            ...
            if (z) {
                ...
                this.subtitleView[0].setTranslationY(-AndroidUtilities.m102dp(4));
        ...
        public /* synthetic */ void lambda$setSubtitle$0(ValueAnimator valueAnimator) {
            ...
            this.subtitleView[0].setTranslationY((-AndroidUtilities.m102dp(4)) * f);
            this.subtitleView[1].setAlpha(f);
            this.subtitleView[1].setTranslationY(floatValue * AndroidUtilities.m102dp(4));
        }
        ...
        public void drawUploadingProgress(Canvas canvas, RectF rectF, boolean z, float f) {
            ...
            float m102dp = AndroidUtilities.m102dp(3) - (AndroidUtilities.m102dp(6) * (1.0f - this.progressToUploading));
            this.radialProgress.setProgressRect((int) (rectF.left - m102dp), (int) (rectF.top - m102dp), (int) (rectF.right + m102dp), (int) (rectF.bottom + m102dp));
            ...
            if (z) {
                ...
                if (this.radialProgressPaint == null) {
                    ...
                    paint.setColor(-1);
                    this.radialProgressPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
    ...
    public class StoryItemHolder {
        ...
        public void updateCaption() {
            ...
            if (uploadingStory != null) {
                ...
                CharSequence replaceEmoji = Emoji.replaceEmoji(charSequence, peerStoriesView.storyCaptionView.captionTextview.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
            ...
            if (tLRPC$StoryItem != null) {
                if (tLRPC$StoryItem.translated && tLRPC$StoryItem.translatedText != null && TextUtils.equals(tLRPC$StoryItem.translatedLng, TranslateAlert2.getToLanguage())) {
                    ...
                    this.caption = str;
                    CharSequence replaceEmoji2 = Emoji.replaceEmoji(str, peerStoriesView2.storyCaptionView.captionTextview.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
                ...
                this.caption = str2;
                CharSequence replaceEmoji3 = Emoji.replaceEmoji(str2, peerStoriesView3.storyCaptionView.captionTextview.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
        ...
        */
        public void checkSendView() {
            /*
                r5 = this;
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p042ui.Stories.PeerStoriesView.this
                org.telegram.tgnet.TLRPC$PeerStories r1 = r0.userStories
                if (r1 != 0) goto L2a
                org.telegram.ui.Stories.StoriesController r1 = r0.storiesController
                long r2 = org.telegram.p042ui.Stories.PeerStoriesView.access$5400(r0)
                org.telegram.tgnet.TLRPC$PeerStories r1 = r1.getStories(r2)
                if (r1 != 0) goto L2a
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p042ui.Stories.PeerStoriesView.this
                int r0 = org.telegram.p042ui.Stories.PeerStoriesView.access$3900(r0)
                org.telegram.messenger.MessagesController r0 = org.telegram.messenger.MessagesController.getInstance(r0)
                org.telegram.ui.Stories.PeerStoriesView r2 = org.telegram.p042ui.Stories.PeerStoriesView.this
                long r2 = org.telegram.p042ui.Stories.PeerStoriesView.access$5400(r2)
                org.telegram.tgnet.TLRPC$UserFull r0 = r0.getUserFull(r2)
                if (r0 == 0) goto L2a
                org.telegram.tgnet.TLRPC$PeerStories r1 = r0.stories
            L2a:
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p042ui.Stories.PeerStoriesView.this
                ...
                if (r0 == 0) goto L99
                if (r1 == 0) goto L99
                boolean r0 = org.telegram.p042ui.Stories.StoriesUtilities.hasExpiredViews(r0)
                if (r0 != 0) goto L55
                org.telegram.tgnet.TLRPC$StoryItem r0 = r5.storyItem
                int r0 = r0.f1635id
                int r1 = r1.max_read_id
                if (r0 > r1) goto L5b
                org.telegram.ui.Stories.PeerStoriesView r1 = org.telegram.p042ui.Stories.PeerStoriesView.this
                ...
                long r3 = org.telegram.p042ui.Stories.PeerStoriesView.access$5400(r1)
                r1 = 0
                int r1 = r2.get(r3, r1)
                if (r0 > r1) goto L5b
            L55:
            ...
            L5b:
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p042ui.Stories.PeerStoriesView.this
                org.telegram.ui.Stories.StoryViewer r0 = org.telegram.p042ui.Stories.PeerStoriesView.access$6500(r0)
                org.telegram.tgnet.TLRPC$PeerStories r0 = r0.overrideUserStories
                r1 = 1
                if (r0 == 0) goto L81
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p042ui.Stories.PeerStoriesView.this
            ...
            L81:
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p042ui.Stories.PeerStoriesView.this
                org.telegram.ui.Stories.StoriesController r2 = r0.storiesController
                long r3 = org.telegram.p042ui.Stories.PeerStoriesView.access$5400(r0)
                org.telegram.tgnet.TLRPC$StoryItem r0 = r5.storyItem
            ...
            L99:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.PeerStoriesView.StoryItemHolder.checkSendView():void");
        }
        ...
        public String createLink() {
            if (PeerStoriesView.this.dialogId > 0) {
                ...
                return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", UserObject.getPublicUsername(user), Integer.valueOf(PeerStoriesView.this.currentStory.storyItem.f1635id));
            }
            ...
            return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", ChatObject.getPublicUsername(chat), Integer.valueOf(PeerStoriesView.this.currentStory.storyItem.f1635id));
        }
    ...
    public static int getStoryId(TLRPC$StoryItem tLRPC$StoryItem, StoriesController.UploadingStory uploadingStory) {
        StoryEntry storyEntry;
        if (tLRPC$StoryItem != null) {
            return tLRPC$StoryItem.f1635id;
        }
        if (uploadingStory == null || (storyEntry = uploadingStory.entry) == null) {
            return 0;
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.realKeyboardHeight < AndroidUtilities.m102dp(20)) {
            this.realKeyboardHeight = 0;
        }
        ...
        boolean z3 = size - size2 > AndroidUtilities.m102dp(64);
        this.BIG_SCREEN = z3;
        int m102dp = (size - ((z3 ? AndroidUtilities.m102dp(64) : 0) + size2)) >> 1;
        layoutParams.topMargin = m102dp;
        if (this.BIG_SCREEN) {
            this.enterViewBottomOffset = (((-m102dp) + size) - size2) - AndroidUtilities.m102dp(64);
        } else {
            this.enterViewBottomOffset = ((-m102dp) + size) - size2;
        }
        FrameLayout frameLayout = this.selfView;
        if (frameLayout != null) {
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) frameLayout.getLayoutParams();
            if (this.BIG_SCREEN) {
                layoutParams2.topMargin = m102dp + size2 + AndroidUtilities.m102dp(8);
            } else {
                layoutParams2.topMargin = (m102dp + size2) - AndroidUtilities.m102dp(48);
            }
        }
        ...
        if (textView != null) {
            ...
            if (!this.BIG_SCREEN) {
                ...
                layoutParams3.topMargin = ((m102dp + size2) - AndroidUtilities.m102dp(12)) - AndroidUtilities.m102dp(40);
            } else {
                this.replyDisabledTextView.setTextColor(ColorUtils.blendARGB(-16777216, -1, 0.5f));
                layoutParams3.topMargin = m102dp + size2 + AndroidUtilities.m102dp(12);
            }
        }
        InstantCameraView instantCameraView = this.instantCameraView;
        if (instantCameraView != null) {
            ...
            if (i3 == 0) {
                layoutParams4.bottomMargin = size - ((m102dp + size2) - AndroidUtilities.m102dp(64));
            } else {
                layoutParams4.bottomMargin = i3 + AndroidUtilities.m102dp(64);
            }
        }
        if (!this.BIG_SCREEN) {
            int i4 = m102dp + size2;
            ((FrameLayout.LayoutParams) this.shareButton.getLayoutParams()).topMargin = (i4 - AndroidUtilities.m102dp(12)) - AndroidUtilities.m102dp(40);
            ((FrameLayout.LayoutParams) this.likeButtonContainer.getLayoutParams()).topMargin = (i4 - AndroidUtilities.m102dp(12)) - AndroidUtilities.m102dp(40);
            int m102dp2 = this.isSelf ? AndroidUtilities.m102dp(40) : AndroidUtilities.m102dp(56);
            ((FrameLayout.LayoutParams) this.storyCaptionView.getLayoutParams()).bottomMargin = m102dp2;
            this.storyCaptionView.blackoutBottomOffset = m102dp2;
        } else {
            int i5 = m102dp + size2;
            ((FrameLayout.LayoutParams) this.shareButton.getLayoutParams()).topMargin = AndroidUtilities.m102dp(12) + i5;
            ((FrameLayout.LayoutParams) this.likeButtonContainer.getLayoutParams()).topMargin = i5 + AndroidUtilities.m102dp(12);
            ((FrameLayout.LayoutParams) this.storyCaptionView.getLayoutParams()).bottomMargin = AndroidUtilities.m102dp(8);
            this.storyCaptionView.blackoutBottomOffset = AndroidUtilities.m102dp(8);
        }
        this.forceUpdateOffsets = true;
        float m102dp3 = AndroidUtilities.m102dp(8) + AndroidUtilities.m102dp(40);
        if (this.privacyButton.getVisibility() == 0) {
            m102dp3 += AndroidUtilities.m102dp(60);
        }
        ...
        if (layoutParams5.rightMargin != m102dp3) {
            int i6 = (int) m102dp3;
    ...
    private void updateViewOffsets() {
        ...
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            ...
            if (childAt.getVisibility() != 0 || childAt == this.selfView || childAt.getTag(C3630R.C3633id.parent_tag) != null || childAt == this.storyCaptionView.textSelectionHelper.getOverlayView(getContext())) {
                ...
                if (chatActivityEnterView5 != null && childAt == chatActivityEnterView5.getEmojiView()) {
                    ...
                    float m102dp = ((((-this.enterViewBottomOffset) * (1.0f - this.progressToKeyboard)) - this.animatingKeyboardHeight) - (AndroidUtilities.m102dp(8) * (1.0f - this.progressToKeyboard))) - (AndroidUtilities.m102dp(20) * this.storyViewer.swipeToReplyProgress);
                    ...
                    if (childAt == this.replyDisabledTextView) {
                        m102dp = (-AndroidUtilities.m102dp(20)) * this.storyViewer.swipeToReplyProgress;
                    }
                    if (childAt == this.mentionContainer) {
                        m102dp -= this.chatActivityEnterView.getMeasuredHeight() - this.chatActivityEnterView.getAnimatedTop();
                    ...
                    if (childAt == this.reactionsContainerLayout) {
                        ...
                        childAt.setTranslationY(m102dp);
                        childAt.setAlpha(f5);
                    }
                }
            }
        ...
        if (chatActivityEnterView6 != null) {
            chatActivityEnterView6.setHorizontalPadding(AndroidUtilities.m102dp(10), this.progressToKeyboard, this.allowShare);
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == chatActivityEnterView) {
            this.sharedResources.rect1.set(BitmapDescriptorFactory.HUE_RED, this.chatActivityEnterView.getY() + this.chatActivityEnterView.getAnimatedTop(), getMeasuredWidth() + AndroidUtilities.m102dp(20), getMeasuredHeight());
            this.sharedResources.rect2.set(AndroidUtilities.m102dp(10), (this.chatActivityEnterView.getBottom() - AndroidUtilities.m102dp(48)) + this.chatActivityEnterView.getTranslationY() + AndroidUtilities.m102dp(2), (getMeasuredWidth() - AndroidUtilities.m102dp(10)) - ((this.allowShare ? AndroidUtilities.m103dp(46.0f) : 0) + AndroidUtilities.m102dp(40)), (this.chatActivityEnterView.getY() + this.chatActivityEnterView.getMeasuredHeight()) - AndroidUtilities.m102dp(2));
            if (this.chatActivityEnterView.getMeasuredHeight() > AndroidUtilities.m102dp(50)) {
                this.chatActivityEnterView.getEditField().setTranslationY((1.0f - this.progressToKeyboard) * (this.chatActivityEnterView.getMeasuredHeight() - AndroidUtilities.m102dp(50)));
            } else {
                this.chatActivityEnterView.getEditField().setTranslationY(BitmapDescriptorFactory.HUE_RED);
            }
            float m102dp = (AndroidUtilities.m102dp(50) / 2.0f) * (1.0f - this.progressToKeyboard);
            ...
            if (f > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.drawRoundRect(this.sharedResources.finalRect, m102dp, m102dp, this.bitmapShaderTools.paint);
            }
            canvas.drawRoundRect(this.sharedResources.finalRect, m102dp, m102dp, this.inputBackgroundPaint);
            ...
            if (view == reactionsContainerLayout && this.chatActivityEnterView != null) {
                view.setTranslationY(((-reactionsContainerLayout.getMeasuredHeight()) + (this.chatActivityEnterView.getY() + this.chatActivityEnterView.getAnimatedTop())) - AndroidUtilities.m102dp(18));
                ...
                if (view == reactionsContainerLayout2) {
                    view.setTranslationY(((-(reactionsContainerLayout2.getMeasuredHeight() - this.likesReactionLayout.getPaddingBottom())) + this.likeButtonContainer.getY()) - AndroidUtilities.m102dp(18));
                }
            }
        }
        return super.drawChild(canvas, view, j);
    ...
    public void checkInstantCameraView() {
        ...
        InstantCameraView instantCameraView = new InstantCameraView(getContext(), new InstantCameraView.Delegate() { // from class: org.telegram.ui.Stories.PeerStoriesView.31
            @Override // org.telegram.p042ui.Components.InstantCameraView.Delegate
    ...
    public void afterMessageSend() {
        ...
        BulletinFactory m62of = BulletinFactory.m62of(this.storyContainer, this.resourcesProvider);
        if (m62of != null) {
            m62of.createSimpleBulletin(C3630R.raw.forward, LocaleController.getString("MessageSent", C3630R.string.MessageSent), LocaleController.getString("ViewInChat", C3630R.string.ViewInChat), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS, new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda30
                @Override // java.lang.Runnable
                public final void run() {
    ...
    void checkReactionsLayout() {
        if (this.reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout.setHint(LocaleController.getString("StoryReactionsHint", C3630R.string.StoryReactionsHint));
            ReactionsContainerLayout reactionsContainerLayout2 = this.reactionsContainerLayout;
            ...
            this.reactionsContainerLayout.setDelegate(new C701833());
            this.reactionsContainerLayout.setMessage(null, null);
        }
    ...
    /* loaded from: classes6.dex */
    public class C701833 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        ...
        void onReactionClickedInternal(final View view, final ReactionsLayoutInBubble.VisibleReaction visibleReaction, final boolean z, final boolean z2, boolean z3) {
            ...
            if (z3 && PeerStoriesView.this.applyMessageToChat(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$33$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C701833.this.lambda$onReactionClickedInternal$0(view, visibleReaction, z, z2);
                }
            })) {
                return;
            }
            ...
            reactionsEffectOverlay.windowView.setTag(C3630R.C3633id.parent_tag, 1);
            ...
            if (visibleReaction2.emojicon != null) {
                ...
                SendMessagesHelper.SendMessageParams m91of = SendMessagesHelper.SendMessageParams.m91of(visibleReaction2.emojicon, PeerStoriesView.this.dialogId, null);
                PeerStoriesView peerStoriesView3 = PeerStoriesView.this;
                m91of.replyToStoryItem = peerStoriesView3.currentStory.storyItem;
                SendMessagesHelper.getInstance(peerStoriesView3.currentAccount).sendMessage(m91of);
            } else {
                ...
                SendMessagesHelper.SendMessageParams m91of2 = SendMessagesHelper.SendMessageParams.m91of(findAnimatedEmojiEmoticon, PeerStoriesView.this.dialogId, null);
                m91of2.entities = new ArrayList<>();
                ...
                m91of2.entities.add(tLRPC$TL_messageEntityCustomEmoji);
                PeerStoriesView peerStoriesView4 = PeerStoriesView.this;
                m91of2.replyToStoryItem = peerStoriesView4.currentStory.storyItem;
                SendMessagesHelper.getInstance(peerStoriesView4.currentAccount).sendMessage(m91of2);
                tLRPC$Document = findDocument;
            }
            PeerStoriesView peerStoriesView5 = PeerStoriesView.this;
            BulletinFactory.m62of(peerStoriesView5.storyContainer, peerStoriesView5.resourcesProvider).createEmojiBulletin(tLRPC$Document, LocaleController.getString("ReactionSent", C3630R.string.ReactionSent), LocaleController.getString("ViewInChat", C3630R.string.ViewInChat), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$33$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C701833.this.lambda$onReactionClickedInternal$1();
                }
    ...
    void checkReactionsLayoutForLike() {
        ...
        if (reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout2.setPadding(0, 0, 0, AndroidUtilities.m102dp(22));
            ...
            this.likesReactionLayout.setDelegate(new C702035());
    ...
    /* loaded from: classes6.dex */
    public class C702035 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        @Override // org.telegram.p042ui.Components.ReactionsContainerLayout.ReactionsContainerDelegate
        public /* synthetic */ boolean drawBackground() {
            return ReactionsContainerLayout.ReactionsContainerDelegate.CC.$default$drawBackground(this);
        }
        ...
        public void onReactionClicked(final View view, final ReactionsLayoutInBubble.VisibleReaction visibleReaction, boolean z, boolean z2) {
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$35$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C702035.this.lambda$onReactionClicked$1(visibleReaction, view);
                }
            };
            if (!z) {
        ...
        public /* synthetic */ void lambda$onReactionClicked$1(ReactionsLayoutInBubble.VisibleReaction visibleReaction, View view) {
            ...
            PeerStoriesView.this.storiesLikeButton.setPadding(m102dp, m102dp, m102dp, m102dp);
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$35$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    PeerStoriesView.C702035.this.lambda$onReactionClicked$0(ofFloat, zArr, valueAnimator);
                }
            });
    ...
    public static class SharedResources {
        ...
        public SharedResources(Context context) {
            this.shareDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.media_share);
            this.likeDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.media_like);
            Drawable drawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.media_like_active);
            this.likeDrawableFilled = drawable;
            drawable.setColorFilter(new PorterDuffColorFilter(-53704, PorterDuff.Mode.MULTIPLY));
            this.optionsDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.media_more);
            this.deleteDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_delete);
            int i = C3630R.raw.media_mute_unmute;
            this.muteDrawable = new RLottieDrawable(i, "media_mute_unmute", AndroidUtilities.m102dp(28), AndroidUtilities.m102dp(28), true, null);
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "media_mute_unmute", AndroidUtilities.m102dp(28), AndroidUtilities.m102dp(28), true, null);
            ...
            this.topOverlayGradient = ContextCompat.getDrawable(context, C3630R.C3632drawable.shadow_story_top);
            this.bottomOverlayGradient = ContextCompat.getDrawable(context, C3630R.C3632drawable.shadow_story_bottom);
    ...
    public /* synthetic */ void lambda$editPrivacy$32(final TLRPC$StoryItem tLRPC$StoryItem, final StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy, boolean z, boolean z2, TLRPC$InputPeer tLRPC$InputPeer, final Runnable runnable) {
        ...
        tLRPC$TL_stories_editStory.f1740id = tLRPC$StoryItem.f1635id;
    ...
    public /* synthetic */ void lambda$editPrivacy$30(Runnable runnable, TLRPC$TL_error tLRPC$TL_error, TLRPC$StoryItem tLRPC$StoryItem, StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy) {
        ...
        if (tLRPC$TL_error == null || "STORY_NOT_MODIFIED".equals(tLRPC$TL_error.text)) {
            ...
            if (i2 == 4) {
                BulletinFactory.m62of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3630R.raw.contact_check, LocaleController.getString("StorySharedToEveryone")).show();
            } else if (i2 == 1) {
                BulletinFactory.m62of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3630R.raw.contact_check, LocaleController.getString("StorySharedToCloseFriends")).show();
            } else if (i2 == 2) {
                if (storyPrivacy.selectedUserIds.isEmpty()) {
                    BulletinFactory.m62of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3630R.raw.contact_check, LocaleController.getString("StorySharedToAllContacts")).show();
                } else {
                    BulletinFactory.m62of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3630R.raw.contact_check, LocaleController.formatPluralString("StorySharedToAllContactsExcluded", storyPrivacy.selectedUserIds.size(), new Object[0])).show();
                }
            } else if (i2 == 3) {
                HashSet hashSet = new HashSet();
                ...
                BulletinFactory.m62of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3630R.raw.contact_check, LocaleController.formatPluralString("StorySharedToContacts", hashSet.size(), new Object[0])).show();
            }
        } else {
            BulletinFactory.m62of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3630R.raw.error, LocaleController.getString("UnknownError", C3630R.string.UnknownError)).show();
        }
        updatePosition();
    }
    ...
    public boolean checkRecordLocked(final boolean z) {
        ...
        if (this.chatActivityEnterView.isInVideoMode()) {
            builder.setTitle(LocaleController.getString("DiscardVideoMessageTitle", C3630R.string.DiscardVideoMessageTitle));
            builder.setMessage(LocaleController.getString("DiscardVideoMessageDescription", C3630R.string.DiscardVideoMessageDescription));
        } else {
            builder.setTitle(LocaleController.getString("DiscardVoiceMessageTitle", C3630R.string.DiscardVoiceMessageTitle));
            builder.setMessage(LocaleController.getString("DiscardVoiceMessageDescription", C3630R.string.DiscardVoiceMessageDescription));
        }
        builder.setPositiveButton(LocaleController.getString("DiscardVoiceMessageAction", C3630R.string.DiscardVoiceMessageAction), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda5
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                PeerStoriesView.this.lambda$checkRecordLocked$33(z, dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Continue", C3630R.string.Continue), null);
        this.delegate.showDialog(builder.create());
        return true;
    }
    ...
    public void animateOut(final boolean z) {
        ...
        this.outAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.36
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                PeerStoriesView.this.headerView.setTranslationY((-AndroidUtilities.m102dp(8)) * PeerStoriesView.this.outT);
                PeerStoriesView peerStoriesView = PeerStoriesView.this;
                peerStoriesView.headerView.setAlpha(1.0f - peerStoriesView.outT);
                PeerStoriesView.this.optionsIconView.setTranslationY((-AndroidUtilities.m102dp(8)) * PeerStoriesView.this.outT);
                PeerStoriesView.this.optionsIconView.setAlpha(1.0f - PeerStoriesView.this.outT);
                PeerStoriesView.this.muteIconContainer.setTranslationY((-AndroidUtilities.m102dp(8)) * PeerStoriesView.this.outT);
                ...
                if (PeerStoriesView.this.selfView != null) {
                    PeerStoriesView.this.selfView.setTranslationY(AndroidUtilities.m102dp(8) * PeerStoriesView.this.outT);
                    PeerStoriesView.this.selfView.setAlpha(1.0f - PeerStoriesView.this.outT);
                }
                if (PeerStoriesView.this.privacyButton != null) {
                    PeerStoriesView.this.privacyButton.setTranslationY((-AndroidUtilities.m102dp(8)) * PeerStoriesView.this.outT);
    ...
    public /* synthetic */ void lambda$animateOut$34(ValueAnimator valueAnimator) {
        ...
        this.headerView.setTranslationY((-AndroidUtilities.m102dp(8)) * this.outT);
        this.headerView.setAlpha(1.0f - this.outT);
        this.optionsIconView.setTranslationY((-AndroidUtilities.m102dp(8)) * this.outT);
        this.optionsIconView.setAlpha(1.0f - this.outT);
        this.muteIconContainer.setTranslationY((-AndroidUtilities.m102dp(8)) * this.outT);
        this.muteIconContainer.setAlpha(this.muteIconViewAlpha * (1.0f - this.outT));
        FrameLayout frameLayout = this.selfView;
        if (frameLayout != null) {
            frameLayout.setTranslationY(AndroidUtilities.m102dp(8) * this.outT);
            this.selfView.setAlpha(1.0f - this.outT);
        }
        StoryPrivacyButton storyPrivacyButton = this.privacyButton;
        if (storyPrivacyButton != null) {
            storyPrivacyButton.setTranslationY((-AndroidUtilities.m102dp(8)) * this.outT);
