...
public class StoryWidgetsImageDecorator extends ImageReceiver.Decorator {
    ...
    public class ReactionWidget extends DrawingObject {
        ...
        @Override // org.telegram.p042ui.Stories.StoryWidgetsImageDecorator.DrawingObject
        public void draw(Canvas canvas, ImageReceiver imageReceiver, float f) {
            ...
            float f3 = (float) (storyWidgetsImageDecorator.imageX + ((f2 * tLRPC$TL_mediaAreaCoordinates.f1687x) / 100.0d));
            float f4 = storyWidgetsImageDecorator.imageH;
            float f5 = (float) (storyWidgetsImageDecorator.imageY + ((f4 * tLRPC$TL_mediaAreaCoordinates.f1688y) / 100.0d));
            float f6 = (float) ((f4 * tLRPC$TL_mediaAreaCoordinates.f1685h) / 100.0d);
            float f7 = ((float) ((f2 * tLRPC$TL_mediaAreaCoordinates.f1686w) / 100.0d)) / 2.0f;
            float f8 = f6 / 2.0f;
