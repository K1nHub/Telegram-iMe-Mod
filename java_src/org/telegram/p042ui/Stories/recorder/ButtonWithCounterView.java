...
public class ButtonWithCounterView extends FrameLayout {
    ...
    public ButtonWithCounterView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z) {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m102dp(8), Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider)));
        }
        ...
        animatedTextDrawable2.setTextSize(AndroidUtilities.m102dp(12));
    ...
    public void setCountFilled(boolean z) {
        int textColor;
        this.countFilled = z;
        this.countText.setTextSize(AndroidUtilities.m102dp(z ? 12 : 14));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (f < 1.0f) {
            ...
            rect.set((int) (((getMeasuredWidth() - m103dp) / 2.0f) + currentWidth + AndroidUtilities.m102dp(this.countFilled ? 5 : 2)), (int) ((getMeasuredHeight() - AndroidUtilities.m102dp(18)) / 2.0f), (int) (((getMeasuredWidth() - m103dp) / 2.0f) + currentWidth + AndroidUtilities.m102dp((this.countFilled ? 5 : 2) + 4 + 4) + Math.max(AndroidUtilities.m102dp(9), this.countText.getCurrentWidth())), (int) ((getMeasuredHeight() + AndroidUtilities.m102dp(18)) / 2.0f));
