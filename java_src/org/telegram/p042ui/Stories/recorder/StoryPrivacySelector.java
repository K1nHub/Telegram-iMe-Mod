...
public class StoryPrivacySelector extends View {
    ...
    protected void dispatchDraw(Canvas canvas) {
        float currentWidth = this.textDrawable.getCurrentWidth() + AndroidUtilities.m102dp(26);
        this.rect.set((getWidth() - currentWidth) / 2.0f, AndroidUtilities.m102dp(13), (getWidth() + currentWidth) / 2.0f, AndroidUtilities.m102dp(43));
        this.clickRect.set(this.rect);
        this.clickRect.inset(-AndroidUtilities.m102dp(28), -AndroidUtilities.m102dp(14));
        canvas.drawRoundRect(this.rect, AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(15), this.backgroundPaint);
        ...
        this.textDrawable.setBounds(0, -AndroidUtilities.m102dp(1), getWidth(), getHeight() - AndroidUtilities.m102dp(1));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (contains) {
                Drawable createRadSelectorDrawable = Theme.createRadSelectorDrawable(234881023, AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(15));
    ...
    public /* synthetic */ void lambda$open$3() {
        ...
        storyPrivacyBottomSheet.whenSelectedRules(new StoryPrivacyBottomSheet.DoneCallback() { // from class: org.telegram.ui.Stories.recorder.StoryPrivacySelector$$ExternalSyntheticLambda5
            @Override // org.telegram.p042ui.Stories.recorder.StoryPrivacyBottomSheet.DoneCallback
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(56), 1073741824));
    }
