    ...
    */
    public static /* synthetic */ void lambda$loadInternal$1(org.telegram.messenger.MessagesStorage r6, boolean r7, final org.telegram.messenger.Utilities.Callback r8) {
        ...
        L31:
            ...
            r5.f1974id = r6     // Catch: java.lang.Exception -> L4d java.lang.Throwable -> L55
            r0.add(r5)     // Catch: java.lang.Exception -> L4d java.lang.Throwable -> L55
            goto L51
        L4d:
            r6 = move-exception
            org.telegram.messenger.FileLog.m97e(r6)     // Catch: java.lang.Throwable -> L55 java.lang.Exception -> L57
        L51:
        ...
        L57:
            r6 = move-exception
            org.telegram.messenger.FileLog.m97e(r6)     // Catch: java.lang.Throwable -> L55
            if (r1 == 0) goto L60
        L5d:
            r1.dispose()
        L60:
        ...
        L6e:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.recorder.DraftsController.lambda$loadInternal$1(org.telegram.messenger.MessagesStorage, boolean, org.telegram.messenger.Utilities$Callback):void");
    }
    ...
    */
    public /* synthetic */ void lambda$load$2(java.util.ArrayList r12) {
        ...
        L10:
            ...
            org.telegram.ui.Stories.recorder.DraftsController$StoryDraft r6 = (org.telegram.p042ui.Stories.recorder.DraftsController.StoryDraft) r6
        ...
        L59:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.recorder.DraftsController.lambda$load$2(java.util.ArrayList):void");
    }
    ...
    public static /* synthetic */ void lambda$edit$4(MessagesStorage messagesStorage, StoryDraft storyDraft) {
        ...
        try {
            ...
            int i = 1;
            sQLitePreparedStatement.bindLong(1, storyDraft.f1974id);
    ...
    public void saveForEdit(StoryEntry storyEntry, long j, TLRPC$StoryItem tLRPC$StoryItem) {
        ...
        while (it.hasNext()) {
            ...
            if (next.isEdit && next.editStoryId == tLRPC$StoryItem.f1635id) {
                arrayList.add(next);
            }
        }
        delete(arrayList);
    ...
    public StoryEntry getForEdit(long j, TLRPC$StoryItem tLRPC$StoryItem) {
        ...
        while (it.hasNext()) {
            StoryEntry next = it.next();
            if (next.isEdit && tLRPC$StoryItem.f1635id == next.editStoryId && j == next.editStoryPeerId && ((tLRPC$Document = (tLRPC$MessageMedia = tLRPC$StoryItem.media).document) == null || tLRPC$Document.f1608id == next.editDocumentId)) {
                TLRPC$Photo tLRPC$Photo = tLRPC$MessageMedia.photo;
                if (tLRPC$Photo == null || tLRPC$Photo.f1630id == next.editPhotoId) {
    ...
    public static class StoryDraft {
        ...
        public StoryDraft(StoryEntry storyEntry) {
            ...
            this.f1974id = storyEntry.draftId;
        ...
        public StoryEntry toEntry() {
            ...
            storyEntry.draftId = this.f1974id;
            storyEntry.isDraft = true;
            ...
            for (int i = 0; i < this.parts.size(); i++) {
                storyEntry.partsMaxId = Math.max(storyEntry.partsMaxId, this.parts.get(i).f1980id);
            }
