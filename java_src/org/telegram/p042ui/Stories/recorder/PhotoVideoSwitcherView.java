...
public class PhotoVideoSwitcherView extends View {
    ...
    public PhotoVideoSwitcherView(Context context) {
        ...
        this.scrollWidth = AndroidUtilities.m102dp(32) + (this.photoTextWidth / 2.0f) + (this.videoTextWidth / 2.0f);
    ...
    private float getScrollCx() {
        return (getWidth() / 2.0f) + AndroidUtilities.lerp(AndroidUtilities.m102dp(16) + (this.photoTextWidth / 2.0f), -(AndroidUtilities.m102dp(16) + (this.videoTextWidth / 2.0f)), this.mode);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        int m102dp = AndroidUtilities.m102dp(26);
        RectF rectF = this.photoRect;
        float m102dp2 = (scrollCx - AndroidUtilities.m102dp(28)) - this.photoTextWidth;
        float f = m102dp / 2.0f;
        float f2 = -AndroidUtilities.m102dp(1);
        float f3 = (height - f) + f2;
        float f4 = height + f + f2;
        rectF.set(m102dp2, f3, scrollCx - AndroidUtilities.m102dp(4), f4);
        this.videoRect.set(AndroidUtilities.m102dp(4) + scrollCx, f3, AndroidUtilities.m102dp(28) + scrollCx + this.videoTextWidth, f4);
        ...
        canvas.save();
        canvas.translate(((scrollCx - AndroidUtilities.m102dp(16)) - this.photoTextWidth) - this.photoTextLeft, (height - (this.photoTextHeight / 2.0f)) + f2);
        this.photoText.draw(canvas);
        canvas.restore();
        canvas.save();
        canvas.translate((scrollCx + AndroidUtilities.m102dp(16)) - this.videoTextLeft, (height - (this.videoTextHeight / 2.0f)) + f2);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        L90:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.recorder.PhotoVideoSwitcherView.onTouchEvent(android.view.MotionEvent):boolean");
    }
}
