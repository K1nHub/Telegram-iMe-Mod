...
import org.telegram.p042ui.Components.ButtonBounce;
...
public class CaptionContainerView extends FrameLayout {
    ...
    public CaptionContainerView(Context context, FrameLayout frameLayout, SizeNotifierFrameLayout sizeNotifierFrameLayout, FrameLayout frameLayout2, Theme.ResourcesProvider resourcesProvider, final BlurringShader.BlurManager blurManager) {
        ...
        LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(10), new int[]{-65536, 0}, new float[]{0.05f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        editTextEmoji.getEditText().setShadowLayer(AndroidUtilities.m102dp(10), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 0);
        ...
        editTextEmoji.getEditText().setHintText(LocaleController.getString("AddCaption", C3630R.string.AddCaption), false);
        paint3.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
        editTextEmoji.getEditText().setTranslationX(AndroidUtilities.m102dp(-22));
        editTextEmoji.getEmojiButton().setAlpha(BitmapDescriptorFactory.HUE_RED);
        editTextEmoji.getEditText().addTextChangedListener(new C70982());
        ...
        Drawable mutate = context.getResources().getDrawable(C3630R.C3632drawable.input_done).mutate();
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m102dp(16), Theme.getColor(Theme.key_dialogFloatingButton, resourcesProvider)), this.applyButtonCheck, 0, AndroidUtilities.m102dp(1));
        ...
        this.applyButton.setTranslationY(-AndroidUtilities.m102dp(1));
        addView(this.applyButton, LayoutHelper.createFrame(44, 44, 85));
        AnimatedTextView animatedTextView = new AnimatedTextView(context, false, true, true);
        this.limitTextView = animatedTextView;
        animatedTextView.setGravity(17);
        this.limitTextView.setTextSize(AndroidUtilities.m102dp(15));
        ...
        frameLayout3.setTranslationX(AndroidUtilities.m102dp(2));
    ...
    /* loaded from: classes6.dex */
    public class C70982 implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    CaptionContainerView.C70982.this.lambda$afterTextChanged$0();
                }
            });
        }
    ...
    public void replaceWithText(int i, int i2, CharSequence charSequence, boolean z) {
        ...
        try {
            ...
            if (z) {
                Emoji.replaceEmoji(spannableStringBuilder, this.editText.getEditText().getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
            }
    ...
    public int getEditTextHeightClosedKeyboard() {
        return Math.min(AndroidUtilities.m102dp(82), this.editText.getHeight());
    }
    ...
    public void updateKeyboard(int i) {
        ...
        if (max > AndroidUtilities.m102dp(20)) {
        ...
        this.toKeyboardShow = max > AndroidUtilities.m102dp(20);
    ...
    public void updateEditTextLeft() {
        this.editText.getEditText().setTranslationX(AndroidUtilities.lerp(AndroidUtilities.m102dp(-22) + getEditTextLeft(), AndroidUtilities.m102dp(2), this.keyboardT));
    }
    ...
    private void updateShowKeyboard(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.editText.getEditText().setTranslationX(AndroidUtilities.lerp(AndroidUtilities.m102dp(-22) + getEditTextLeft(), AndroidUtilities.m102dp(2), this.keyboardT));
            this.editText.setTranslationX(AndroidUtilities.lerp(0, AndroidUtilities.m102dp(-8), this.keyboardT));
            this.editText.setTranslationY(AndroidUtilities.lerp(0, AndroidUtilities.m102dp(10), this.keyboardT));
            this.limitTextContainer.setTranslationX(AndroidUtilities.lerp(-AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(2), this.keyboardT));
            this.limitTextContainer.setTranslationY(AndroidUtilities.lerp(-AndroidUtilities.m102dp(8), 0, this.keyboardT));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.keyboardShown) {
            min = Math.max(AndroidUtilities.m102dp(46), height);
        } else {
            min = Math.min(AndroidUtilities.m102dp(82), height);
        }
        float f = min;
        ...
        float lerp = AndroidUtilities.lerp(AndroidUtilities.m102dp(12), 0, this.keyboardT);
        this.bounds.set(lerp, (getHeight() - lerp) - f2, getWidth() - lerp, getHeight() - lerp);
        float lerp2 = AndroidUtilities.lerp(AndroidUtilities.m102dp(21), 0, this.keyboardT);
        if (customBlur()) {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == editTextEmoji) {
            float max = Math.max(0, (editTextEmoji.getHeight() - AndroidUtilities.m102dp(82)) - this.editText.getScrollY()) * (1.0f - this.keyboardT);
            ...
            float f = rectF.left;
            float f2 = rectF.top;
            canvas.drawRect(f, f2, rectF.right, f2 + AndroidUtilities.m102dp(10), this.fadePaint);
            this.matrix.reset();
            ...
            float m102dp = rectF2.bottom - AndroidUtilities.m102dp(10);
            RectF rectF3 = this.bounds;
            canvas.drawRect(f3, m102dp, rectF3.right, rectF3.bottom, this.fadePaint);
            canvas.restore();
            canvas.restore();
            return drawChild;
    ...
    public void updateColors(Theme.ResourcesProvider resourcesProvider) {
        ...
        this.applyButtonDrawable.setBackgroundDrawable(Theme.createCircleDrawable(AndroidUtilities.m102dp(16), Theme.getColor(Theme.key_dialogFloatingButton, resourcesProvider)));
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (customBlur()) {
            ...
            this.hintTextPaint.setTextSize(AndroidUtilities.m102dp(16));
            String string = LocaleController.getString(C3630R.string.AddCaption);
    ...
    public static class PeriodDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            rect.set((int) (centerY - AndroidUtilities.m102dp(20)), (int) (centerY2 - AndroidUtilities.m102dp(20)), (int) (centerY + AndroidUtilities.m102dp(20)), (int) (centerY2 + AndroidUtilities.m102dp(20)));
