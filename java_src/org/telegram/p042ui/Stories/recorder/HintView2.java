...
public class HintView2 extends View {
    ...
    public HintView2(Context context, int i) {
        ...
        this.useAlpha = true;
        this.textMaxWidth = -1;
        this.rounding = AndroidUtilities.m102dp(8);
        this.innerPadding = new RectF(AndroidUtilities.m102dp(11), AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(11), AndroidUtilities.m102dp(7));
        this.closeButtonMargin = AndroidUtilities.m102dp(2);
        this.arrowHalfWidth = AndroidUtilities.m102dp(7);
        this.arrowHeight = AndroidUtilities.m102dp(6);
        ...
        this.iconMargin = AndroidUtilities.m102dp(2);
    ...
    public HintView2 setRounding(float f) {
        this.rounding = AndroidUtilities.m103dp(f);
    ...
    public HintView2 setMultilineText(boolean z) {
        this.multiline = z;
        if (z) {
            this.innerPadding.set(AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(8));
            this.closeButtonMargin = AndroidUtilities.m102dp(6);
        } else {
            this.innerPadding.set(AndroidUtilities.m102dp(11), AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(this.closeButton ? 15 : 11), AndroidUtilities.m102dp(7));
            this.closeButtonMargin = AndroidUtilities.m102dp(2);
        }
        return this;
    }
    ...
    public HintView2 setTextSize(int i) {
        this.textDrawable.setTextSize(AndroidUtilities.m102dp(i));
        this.textPaint.setTextSize(AndroidUtilities.m102dp(i));
        return this;
    }
    ...
    public HintView2 setMaxWidth(float f) {
        this.textMaxWidth = AndroidUtilities.m103dp(f);
        return this;
    }
    ...
    public HintView2 setInnerPadding(int i, int i2, int i3, int i4) {
        this.innerPadding.set(AndroidUtilities.m102dp(i), AndroidUtilities.m102dp(i2), AndroidUtilities.m102dp(i3), AndroidUtilities.m102dp(i4));
        return this;
    }

    public HintView2 setIconMargin(int i) {
        this.iconMargin = AndroidUtilities.m102dp(i);
        return this;
    }
    ...
    public HintView2 setJoint(float f, float f2) {
        if (Math.abs(this.joint - f) >= 1.0f || Math.abs(this.jointTranslate - AndroidUtilities.m103dp(f2)) >= 1.0f) {
            this.pathSet = false;
            invalidate();
        }
        this.joint = f;
        this.jointTranslate = AndroidUtilities.m103dp(f2);
        return this;
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.closeButton) {
            if (this.closeButtonDrawable == null) {
                Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.msg_mini_close_tooltip).mutate();
        ...
        if (this.bounceT != 1.0f) {
            ...
            if (i == 3 || i == 1) {
                canvas.translate(BitmapDescriptorFactory.HUE_RED, (this.bounceT - 1.0f) * Math.max(i == 3 ? getPaddingBottom() : getPaddingTop(), AndroidUtilities.m102dp(24)) * (this.direction == 1 ? -1 : 1));
            } else {
                canvas.translate((this.bounceT - 1.0f) * Math.max(i == 0 ? getPaddingLeft() : getPaddingRight(), AndroidUtilities.m102dp(24)) * (this.direction == 0 ? -1 : 1), BitmapDescriptorFactory.HUE_RED);
            }
        }
        ...
        if (this.closeButton) {
            if (this.closeButtonDrawable == null) {
                Drawable mutate2 = getContext().getResources().getDrawable(C3630R.C3632drawable.msg_mini_close_tooltip).mutate();
    ...
    private void rewindPath(float f, float f2) {
        ...
        if (this.direction == 0) {
            this.path.lineTo(this.bounds.left, this.arrowHalfWidth + clamp + AndroidUtilities.m102dp(2));
            this.path.lineTo(this.bounds.left, this.arrowHalfWidth + clamp);
            this.path.lineTo(this.bounds.left - this.arrowHeight, AndroidUtilities.m102dp(1) + clamp);
            float f9 = this.bounds.left;
            float f10 = this.arrowHeight;
            this.arrowX = f9 - f10;
            this.arrowY = clamp;
            this.path.lineTo(f9 - f10, clamp - AndroidUtilities.m102dp(1));
            this.path.lineTo(this.bounds.left, clamp - this.arrowHalfWidth);
            this.path.lineTo(this.bounds.left, (clamp - this.arrowHalfWidth) - AndroidUtilities.m102dp(2));
        ...
        if (this.direction == 1) {
            this.path.lineTo((clamp - this.arrowHalfWidth) - AndroidUtilities.m102dp(2), this.bounds.top);
            this.path.lineTo(clamp - this.arrowHalfWidth, this.bounds.top);
            this.path.lineTo(clamp - AndroidUtilities.m102dp(1), this.bounds.top - this.arrowHeight);
            this.arrowX = clamp;
            this.arrowY = this.bounds.top - this.arrowHeight;
            this.path.lineTo(AndroidUtilities.m102dp(1) + clamp, this.bounds.top - this.arrowHeight);
            this.path.lineTo(this.arrowHalfWidth + clamp, this.bounds.top);
            this.path.lineTo(this.arrowHalfWidth + clamp + AndroidUtilities.m102dp(2), this.bounds.top);
        ...
        if (this.direction == 2) {
            this.path.lineTo(this.bounds.right, (clamp - this.arrowHalfWidth) - AndroidUtilities.m102dp(2));
            this.path.lineTo(this.bounds.right, clamp - this.arrowHalfWidth);
            this.path.lineTo(this.bounds.right + this.arrowHeight, clamp - AndroidUtilities.m102dp(1));
            float f11 = this.bounds.right;
            float f12 = this.arrowHeight;
            this.arrowX = f11 + f12;
            this.arrowY = clamp;
            this.path.lineTo(f11 + f12, AndroidUtilities.m102dp(1) + clamp);
            this.path.lineTo(this.bounds.right, this.arrowHalfWidth + clamp);
            this.path.lineTo(this.bounds.right, this.arrowHalfWidth + clamp + AndroidUtilities.m102dp(2));
        ...
        if (this.direction == 3) {
            this.path.lineTo(this.arrowHalfWidth + clamp + AndroidUtilities.m102dp(2), this.bounds.bottom);
            this.path.lineTo(this.arrowHalfWidth + clamp, this.bounds.bottom);
            this.path.lineTo(AndroidUtilities.m102dp(1) + clamp, this.bounds.bottom + this.arrowHeight);
            this.arrowX = clamp;
            this.arrowY = this.bounds.bottom + this.arrowHeight;
            this.path.lineTo(clamp - AndroidUtilities.m102dp(1), this.bounds.bottom + this.arrowHeight);
            this.path.lineTo(clamp - this.arrowHalfWidth, this.bounds.bottom);
            this.path.lineTo((clamp - this.arrowHalfWidth) - AndroidUtilities.m102dp(2), this.bounds.bottom);
