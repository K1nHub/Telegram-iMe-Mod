...
public class RecordControl extends View {
    ...
    /* renamed from: cx */
    private float f1992cx;

    /* renamed from: cy */
    private float f1993cy;
    ...
    /* renamed from: h1 */
    private final Point f1994h1;

    /* renamed from: h2 */
    private final Point f1995h2;

    /* renamed from: h3 */
    private final Point f1996h3;

    /* renamed from: h4 */
    private final Point f1997h4;
    ...
    /* renamed from: p1 */
    private final Point f1998p1;

    /* renamed from: p2 */
    private final Point f1999p2;

    /* renamed from: p3 */
    private final Point f2000p3;

    /* renamed from: p4 */
    private final Point f2001p4;
    ...
    public RecordControl(Context context) {
        ...
        this.f1998p1 = new Point();
        this.f1999p2 = new Point();
        this.f2000p3 = new Point();
        this.f2001p4 = new Point();
        this.f1994h1 = new Point();
        this.f1995h2 = new Point();
        this.f1996h3 = new Point();
        this.f1997h4 = new Point();
        setWillNotDraw(false);
        RadialGradient radialGradient = new RadialGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(48), new int[]{-577231, -577231, -1}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.64f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        int i = C3630R.C3632drawable.msg_photo_switch2;
        ...
        Drawable mutate4 = context.getResources().getDrawable(C3630R.C3632drawable.msg_filled_unlockedrecord).mutate();
        this.unlockDrawable = mutate4;
        mutate4.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.MULTIPLY));
        Drawable mutate5 = context.getResources().getDrawable(C3630R.C3632drawable.msg_filled_lockedrecord).mutate();
        this.lockDrawable = mutate5;
        mutate5.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        Drawable mutate6 = context.getResources().getDrawable(C3630R.C3632drawable.msg_round_pause_m).mutate();
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float f = size;
        this.f1992cx = f / 2.0f;
        this.f1993cy = m102dp / 2.0f;
        float min = Math.min(AndroidUtilities.m102dp((int) TsExtractor.TS_STREAM_TYPE_E_AC3), f * 0.35f);
        float f2 = this.f1992cx;
        this.leftCx = f2 - min;
        float f3 = f2 + min;
        this.rightCx = f3;
        setDrawableBounds(this.flipDrawableWhite, f3, this.f1993cy, AndroidUtilities.m102dp(14));
        setDrawableBounds(this.flipDrawableBlack, this.rightCx, this.f1993cy, AndroidUtilities.m102dp(14));
        setDrawableBounds(this.unlockDrawable, this.leftCx, this.f1993cy);
        setDrawableBounds(this.lockDrawable, this.leftCx, this.f1993cy);
        setDrawableBounds(this.pauseDrawable, this.leftCx, this.f1993cy);
        this.galleryImage.setImageCoords(this.leftCx - AndroidUtilities.m102dp(20), this.f1993cy - AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(40));
        this.redMatrix.reset();
        this.redMatrix.postTranslate(this.f1992cx, this.f1993cy);
    ...
    */
    protected void onDraw(android.graphics.Canvas r48) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.recorder.RecordControl.onDraw(android.graphics.Canvas):void");
    }
    ...
    private void getVector(float f, float f2, double d, float f3, Point point) {
        double d2 = f3;
        point.f1887x = (float) (f + (Math.cos(d) * d2));
        point.f1888y = (float) (f2 + (Math.sin(d) * d2));
    }

    private float dist(Point point, Point point2) {
        return MathUtils.distance(point.f1887x, point.f1888y, point2.f1887x, point2.f1888y);
    }
    ...
    private boolean isPressed(float f, float f2, float f3, float f4, float f5, boolean z) {
        return this.recording ? (!z || f4 - f2 <= ((float) AndroidUtilities.m102dp(100))) && Math.abs(f3 - f) <= f5 : MathUtils.distance(f, f2, f3, f4) <= f5;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean isPressed = isPressed(clamp, y, this.rightCx, this.f1993cy, AndroidUtilities.m102dp(7), true);
        boolean z = false;
        if (this.recordingLoading) {
            ...
            this.recordButton.setPressed(isPressed(clamp, y, this.f1992cx, this.f1993cy, AndroidUtilities.m102dp(60), false));
            this.flipButton.setPressed(isPressed(clamp, y, this.rightCx, this.f1993cy, AndroidUtilities.m102dp(30), true));
            this.lockButton.setPressed(isPressed(clamp, y, this.leftCx, this.f1993cy, AndroidUtilities.m102dp(30), false));
        }
        if (action == 0) {
            this.touch = true;
            ...
            this.touchX = clamp;
            if (Math.abs(clamp - this.f1992cx) < AndroidUtilities.m102dp(50)) {
            ...
            if (this.recording && this.longpressRecording) {
                this.delegate.onZoom(Utilities.clamp(((this.f1993cy - AndroidUtilities.m102dp(48)) - y) / (AndroidUtilities.displaySize.y / 2.0f), 1.0f, (float) BitmapDescriptorFactory.HUE_RED));
            }
        } else {
