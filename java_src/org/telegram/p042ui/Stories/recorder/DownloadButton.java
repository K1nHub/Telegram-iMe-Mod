...
public class DownloadButton extends ImageView {
    ...
    public DownloadButton(Context context, Utilities.Callback<Runnable> callback, int i, FrameLayout frameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.progressDrawable = new CircularProgressDrawable(AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(2), -1);
        updateImage();
    }
    ...
    public void onClickInternal() {
        ...
        if (storyEntry.wouldBeVideo()) {
            ...
            if (generatePicturePath == null) {
                this.toast.setDone(C3630R.raw.error, LocaleController.getString("UnknownError"), 3500);
                this.downloading = false;
                updateImage();
                return;
            }
    ...
    public /* synthetic */ void lambda$onClickInternal$2(Uri uri) {
        ...
        this.toast.setDone(C3630R.raw.ic_save_to_gallery, LocaleController.getString("VideoSavedHint"), 3500);
        this.downloading = false;
        updateImage();
    ...
    public /* synthetic */ void lambda$onClickInternal$5() {
        ...
        this.toast.setDone(C3630R.raw.error, LocaleController.getString("VideoConvertFail"), 3500);
        this.downloading = false;
        updateImage();
    }
    ...
    public /* synthetic */ void lambda$onClickInternal$6(Uri uri) {
        ...
        preparingVideoToast2.setDone(C3630R.raw.ic_save_to_gallery, LocaleController.getString("PhotoSavedHint"), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_MS);
        this.container.addView(this.toast);
        this.savedToGalleryUri = uri;
    }
    ...
    private void updateImage() {
        ...
        if (z != (z2 && !this.downloadingVideo)) {
            ...
            if (z4) {
                ...
                AndroidUtilities.updateImageViewImageAnimated(this, C3630R.C3632drawable.media_download);
            }
        }
    ...
    public void showFailedVideo() {
        showToast(C3630R.raw.error, LocaleController.getString("VideoConvertFail"));
    }
    ...
    public static class PreparingVideoToast extends View {
        ...
        /* renamed from: t */
        private final AnimatedFloat f1973t;
        ...
        public PreparingVideoToast(Context context) {
            ...
            this.f1973t = new AnimatedFloat(this);
            ...
            paint3.setStrokeWidth(AndroidUtilities.m102dp(4));
            paint4.setStyle(Paint.Style.STROKE);
            paint4.setStrokeCap(Paint.Cap.ROUND);
            paint4.setStrokeWidth(AndroidUtilities.m102dp(4));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float f2 = this.f1973t.set(this.preparing ? 0.0f : 1.0f);
            float f3 = 1.0f - f2;
            ...
            float max = Math.max(this.preparingLayoutWidth, AndroidUtilities.m102dp(54)) + AndroidUtilities.m102dp(42);
            float m102dp = AndroidUtilities.m102dp(111) + this.preparingLayout.getHeight();
            this.prepareRect.set((getWidth() - max) / 2.0f, (getHeight() - m102dp) / 2.0f, (getWidth() + max) / 2.0f, (getHeight() + m102dp) / 2.0f);
            float m102dp2 = AndroidUtilities.m102dp(74) + this.doneLayoutWidth;
            float m102dp3 = AndroidUtilities.m102dp(48);
            this.toastRect.set((getWidth() - m102dp2) / 2.0f, (getHeight() - m102dp3) / 2.0f, (getWidth() + m102dp2) / 2.0f, (getHeight() + m102dp3) / 2.0f);
            ...
            canvas.drawRoundRect(this.currentRect, AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10), this.backgroundPaint);
            canvas.save();
        ...
        private void drawPreparing(Canvas canvas, float f) {
            ...
            float m102dp = this.prepareRect.top + AndroidUtilities.m102dp(48);
            float m102dp2 = AndroidUtilities.m102dp(25);
            this.greyPaint.setAlpha((int) (51.0f * f));
            canvas.drawCircle(centerX, m102dp, m102dp2, this.greyPaint);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(centerX - m102dp2, m102dp - m102dp2, centerX + m102dp2, m102dp2 + m102dp);
            int i = (int) (f * 255.0f);
            this.whitePaint.setAlpha(i);
            this.whitePaint.setStrokeWidth(AndroidUtilities.m102dp(4));
            canvas.drawArc(rectF, -90.0f, f2 * 360.0f, false, this.whitePaint);
            float scale = this.cancelButton.getScale(0.15f);
            canvas.save();
            canvas.scale(scale, scale, centerX, m102dp);
            this.whitePaint.setStrokeWidth(AndroidUtilities.m103dp(3.4f));
            canvas.drawLine(centerX - AndroidUtilities.m102dp(7), m102dp - AndroidUtilities.m102dp(7), centerX + AndroidUtilities.m102dp(7), m102dp + AndroidUtilities.m102dp(7), this.whitePaint);
            canvas.drawLine(centerX - AndroidUtilities.m102dp(7), m102dp + AndroidUtilities.m102dp(7), centerX + AndroidUtilities.m102dp(7), m102dp - AndroidUtilities.m102dp(7), this.whitePaint);
            canvas.restore();
            canvas.save();
            canvas.translate((this.prepareRect.left + AndroidUtilities.m102dp(21)) - this.preparingLayoutLeft, (this.prepareRect.bottom - AndroidUtilities.m102dp(18)) - this.preparingLayout.getHeight());
        ...
        private void drawToast(Canvas canvas, float f) {
            ...
            if (rLottieDrawable != null) {
                ...
                this.lottieDrawable.setBounds((int) (this.toastRect.left + AndroidUtilities.m102dp(9)), (int) (this.toastRect.top + AndroidUtilities.m102dp(6)), (int) (this.toastRect.left + AndroidUtilities.m102dp(45)), (int) (this.toastRect.top + AndroidUtilities.m102dp(42)));
                this.lottieDrawable.draw(canvas);
            }
            if (this.doneLayout != null) {
                canvas.save();
                canvas.translate((this.toastRect.left + AndroidUtilities.m102dp(52)) - this.doneLayoutLeft, this.toastRect.centerY() - (this.doneLayout.getHeight() / 2.0f));
        ...
        public void setDone(int i, CharSequence charSequence, int i2) {
            ...
            RLottieDrawable rLottieDrawable2 = new RLottieDrawable(i, "" + i, AndroidUtilities.m102dp(36), AndroidUtilities.m102dp(36));
