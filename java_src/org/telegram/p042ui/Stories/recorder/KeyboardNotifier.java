...
public class KeyboardNotifier {
    ...
    public boolean keyboardVisible() {
        return this.keyboardHeight > AndroidUtilities.navigationBarHeight + AndroidUtilities.m102dp(20) || this.awaitingKeyboard;
    }
    ...
    public void fire() {
        if (this.awaitingKeyboard) {
            if (this.keyboardHeight < AndroidUtilities.navigationBarHeight + AndroidUtilities.m102dp(20)) {
                return;
            }
