...
public class VideoTimerView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(45), 1073741824));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        float m103dp = AndroidUtilities.m103dp(12.66f) * f;
        float currentWidth = this.textDrawable.getCurrentWidth() + m103dp;
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(((getWidth() - currentWidth) / 2.0f) - AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(18), ((getWidth() + currentWidth) / 2.0f) + AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(40));
        canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(18), this.backgroundPaint);
        if (f > BitmapDescriptorFactory.HUE_RED) {
            ...
            invalidate();
            canvas.drawCircle(rectF.left + AndroidUtilities.m103dp(10.66f), rectF.centerY(), AndroidUtilities.m102dp(4) * f, this.recordPaint);
        }
        this.textDrawable.setBounds((int) (rectF.left + m103dp), ((int) rectF.top) - AndroidUtilities.m102dp(1), (int) rectF.right, (int) rectF.bottom);
