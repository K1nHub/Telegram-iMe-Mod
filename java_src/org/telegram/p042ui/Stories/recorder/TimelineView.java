...
import org.telegram.p042ui.Components.Scroller;
import org.telegram.p042ui.Stories.recorder.TimelineView;
...
public class TimelineView extends View {
    ...
    public TimelineView(Context context, final ViewGroup viewGroup, final View view, final Theme.ResourcesProvider resourcesProvider, final BlurringShader.BlurManager blurManager) {
        ...
        textPaint2.setTextSize(AndroidUtilities.m102dp(12));
        textPaint2.setColor(-1);
        paint6.setColor(1090519039);
        paint8.setShader(linearGradient);
        paint8.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        paint.setColor(-1);
        paint.setShadowLayer(AndroidUtilities.m102dp(1), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(1), 436207616);
        paint2.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        paint3.setColor(-16777216);
        paint5.setColor(-1);
        paint4.setColor(637534208);
        Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.filled_widget_music).mutate();
    ...
    public /* synthetic */ void lambda$new$2(ViewGroup viewGroup, Theme.ResourcesProvider resourcesProvider, BlurringShader.BlurManager blurManager, View view) {
        ...
        int i3 = this.f2005px;
        int i4 = this.f2004ph;
        float min2 = Math.min((i2 - i3) - i4, i3 + i4 + (((((float) (this.audioOffset - this.scroll)) + (AndroidUtilities.lerp(this.audioRight, 1.0f, this.audioSelectedT.get()) * ((float) this.audioDuration))) / ((float) min)) * this.f2007sw));
        ItemOptions forceTop = ItemOptions.makeOptions(viewGroup, resourcesProvider, this).addView(onValueChange).addSpaceGap().add(C3630R.C3632drawable.msg_delete, LocaleController.getString(C3630R.string.StoryAudioRemove), new Runnable() { // from class: org.telegram.ui.Stories.recorder.TimelineView$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                TimelineView.this.lambda$new$1();
            }
        }).setGravity(5).forceTop(true);
        float m102dp = (-(this.f2008w - min2)) + AndroidUtilities.m102dp(18);
        int m102dp2 = AndroidUtilities.m102dp(4);
        if (this.hasVideo) {
            i = 0;
        } else {
            i = AndroidUtilities.m102dp(this.audioSelected ? 35 : 40);
        }
        forceTop.translate(m102dp, m102dp2 + i).show().setBlurBackground(blurManager, -view.getX(), -view.getY());
        try {
    ...
    private void setupVideoThumbs() {
        ...
        VideoThumbsLoader videoThumbsLoader = new VideoThumbsLoader(this.videoPath, (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), AndroidUtilities.m102dp(38));
    ...
    */
    public void setProgress(long r11) {
        ...
        L50:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.recorder.TimelineView.setProgress(long):void");
    }
    ...
    private int detectHandle(MotionEvent motionEvent) {
        ...
        float clamp = this.f2005px + this.f2004ph + (this.f2007sw * (((float) ((Utilities.clamp(this.progress, getBaseDuration(), 0L) + (!this.hasVideo ? this.audioOffset : 0L)) - this.scroll)) / min));
        if (x < clamp - AndroidUtilities.m102dp(12) || x > clamp + AndroidUtilities.m102dp(12)) {
            boolean z = y > (((float) (this.f2003h - this.f2006py)) - getVideoHeight()) - ((float) AndroidUtilities.m102dp(2));
            if (z) {
                int i2 = this.f2005px;
                int i3 = this.f2004ph;
                ...
                if (x >= f2 - AndroidUtilities.m102dp(15) && x <= AndroidUtilities.m102dp(5) + f2) {
                    return 2;
                }
                if (x >= f3 - AndroidUtilities.m102dp(5) && x <= AndroidUtilities.m102dp(15) + f3) {
                    return 3;
                }
                ...
                if (this.audioSelected || !this.hasVideo) {
                    if (x >= f6 - AndroidUtilities.m102dp(15)) {
                        i = 5;
                        if (x <= AndroidUtilities.m102dp(5) + f6) {
                            return 6;
                        }
                    } else {
                        i = 5;
                    }
                    if (x >= f7 - AndroidUtilities.m102dp(i) && x <= AndroidUtilities.m102dp(15) + f7) {
                        return 7;
                    }
                    if (x >= f6 && x <= f7) {
    ...
    private boolean setProgressAt(float f, boolean z) {
        if (this.hasVideo || this.hasAudio) {
            float min = (((f - this.f2005px) - this.f2004ph) / this.f2007sw) * ((float) Math.min(getBaseDuration(), 120000L));
    ...
    private float getVideoHeight() {
        if (this.hasVideo) {
            return AndroidUtilities.lerp(AndroidUtilities.m102dp(28), AndroidUtilities.m102dp(38), 1.0f - this.audioSelectedT.set(this.audioSelected));
        }
        return BitmapDescriptorFactory.HUE_RED;
    }

    private float getAudioHeight() {
        return AndroidUtilities.lerp(AndroidUtilities.m102dp(28), AndroidUtilities.m102dp(38), this.audioSelectedT.set(this.audioSelected));
    }

    /* JADX WARN: Removed duplicated region for block: B:514:0x05a9  */
    /* JADX WARN: Removed duplicated region for block: B:523:0x05cb  */
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.recorder.TimelineView.onTouchEvent(android.view.MotionEvent):boolean");
    }

    private long minAudioSelect() {
        return Math.max(1000.0f, ((float) Math.min(this.videoDuration, 59000L)) * 0.15f);
    }
    ...
    private void moveAudioOffset(float f) {
        ...
        if (!this.hasVideo) {
            ...
            if (j9 + j10 > j7) {
                ...
                float clamp2 = Utilities.clamp(clamp - min, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
                ...
                float clamp3 = Utilities.clamp((((this.videoLeft * ((float) this.videoDuration)) - ((float) j9)) - ((float) j10)) / ((float) this.audioDuration), 1.0f - min, (float) BitmapDescriptorFactory.HUE_RED);
            ...
            this.audioOffset = Utilities.clamp(j19, ((float) getBaseDuration()) - (((float) j20) * this.audioRight), (-this.audioLeft) * ((float) j20));
        }
        if (!this.hasVideo) {
        ...
        } else if ((z || this.scrolling) && this.hasVideo) {
    ...
    public void computeScroll() {
        if (this.scroller.computeScrollOffset()) {
            ...
            if (this.scrollingVideo) {
                this.scroll = Math.max((float) BitmapDescriptorFactory.HUE_RED, (((currX - this.f2005px) - this.f2004ph) / this.f2007sw) * ((float) min));
            } else {
                int i = this.f2005px;
                int i2 = this.f2004ph;
                int i3 = this.f2007sw;
    ...
    public class WaveformPath extends Path {
        ...
        private void layout(float f, float f2, float f3, float f4, float f5, long j, float f6, float f7, float f8) {
            ...
            int min = Math.min(TimelineView.this.waveform.getCount() - 1, (int) Math.ceil(((TimelineView.this.f2004ph + f3) - f) / round));
            for (int max = Math.max(0, (int) (((f2 - TimelineView.this.f2004ph) - f) / round)); max <= min; max++) {
                float f9 = max;
                float m102dp = (f9 * round) + f + AndroidUtilities.m102dp(2);
                ...
                rectF.set(m102dp, AndroidUtilities.lerp(f8 - max2, f8 - ((f7 + max2) / 2.0f), f4), AndroidUtilities.dpf2(1.66f) + m102dp, AndroidUtilities.lerp(f8, f8 - ((f7 - max2) / 2.0f), f4));
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r38) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.recorder.TimelineView.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    private void drawRegion(Canvas canvas, Paint paint, float f, float f2, float f3, float f4, float f5) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(f3 - AndroidUtilities.m102dp(10), f, f4 + AndroidUtilities.m102dp(10), f2);
        canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.f2008w, this.f2003h, 255, 31);
        int i = (int) (255.0f * f5);
        this.regionPaint.setAlpha(i);
        canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), this.regionPaint);
        rectF.inset(AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(2));
        canvas.drawRect(rectF, this.regionCutPaint);
        float m102dp = AndroidUtilities.m102dp(2);
        float m102dp2 = AndroidUtilities.m102dp(10);
        Paint paint2 = paint != null ? paint : this.regionHandlePaint;
        this.regionHandlePaint.setAlpha(255);
        paint2.setAlpha(i);
        float f6 = f + f2;
        float f7 = (f6 - m102dp2) / 2.0f;
        float f8 = (f6 + m102dp2) / 2.0f;
        rectF.set(f3 - ((AndroidUtilities.m102dp(10) - m102dp) / 2.0f), f7, f3 - ((AndroidUtilities.m102dp(10) + m102dp) / 2.0f), f8);
        canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), paint2);
        if (paint != null) {
            this.regionHandlePaint.setAlpha((int) (f5 * 48.0f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), this.regionHandlePaint);
        }
        rectF.set(f4 + ((AndroidUtilities.m102dp(10) - m102dp) / 2.0f), f7, f4 + ((AndroidUtilities.m102dp(10) + m102dp) / 2.0f), f8);
        canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), paint2);
        if (paint != null) {
    ...
    private void drawProgress(Canvas canvas, float f, float f2, long j, float f3) {
        float clamp = this.f2005px + this.f2004ph + (this.f2007sw * (((float) ((Utilities.clamp(j, getBaseDuration(), 0L) + (!this.hasVideo ? this.audioOffset : 0L)) - this.scroll)) / ((float) Math.min(getBaseDuration(), 120000L))));
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), this.progressShadowPaint);
        rectF.set(clamp - AndroidUtilities.dpf2(1.5f), f5, clamp + AndroidUtilities.dpf2(1.5f), f6);
        canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), this.progressWhitePaint);
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        this.audioAuthorPaint.setTextSize(AndroidUtilities.m102dp(12));
        this.audioTitlePaint.setTextSize(AndroidUtilities.m102dp(12));
        ...
        this.f2005px = m102dp2;
        int m102dp3 = AndroidUtilities.m102dp(5);
        this.f2006py = m102dp3;
        setPadding(m102dp2, m102dp3, AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(5));
        int size = View.MeasureSpec.getSize(i);
        this.f2008w = size;
        int m102dp4 = AndroidUtilities.m102dp(80);
        this.f2003h = m102dp4;
        setMeasuredDimension(size, m102dp4);
        int m102dp5 = AndroidUtilities.m102dp(10);
        this.f2004ph = m102dp5;
        this.f2007sw = (this.f2008w - (m102dp5 * 2)) - (this.f2005px * 2);
        ...
        */
        public VideoThumbsLoader(java.lang.String r10, int r11, int r12) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.recorder.TimelineView.VideoThumbsLoader.<init>(org.telegram.ui.Stories.recorder.TimelineView, java.lang.String, int, int):void");
        }
