...
import org.telegram.p042ui.Stories.recorder.PreviewButtons;
...
public class PreviewButtons extends FrameLayout {
    ...
    public PreviewButtons(Context context) {
        ...
        addButton(0, C3630R.C3632drawable.media_draw, LocaleController.getString("AccDescrPaint", C3630R.string.AccDescrPaint));
        addButton(2, C3630R.C3632drawable.msg_photo_sticker, LocaleController.getString("AccDescrStickers", C3630R.string.AccDescrStickers));
        addButton(1, C3630R.C3632drawable.msg_photo_text2, LocaleController.getString("AccDescrPlaceText", C3630R.string.AccDescrPlaceText));
        addButton(3, C3630R.C3632drawable.msg_photo_settings, LocaleController.getString("AccDescrPhotoAdjust", C3630R.string.AccDescrPhotoAdjust));
        int i = C3630R.string.Send;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int min = Math.min(AndroidUtilities.m102dp(20), this.buttons.size() < 2 ? 0 : (((i5 - AndroidUtilities.m103dp(32.33f)) - this.shareButton.getMeasuredWidth()) - (this.buttons.size() * AndroidUtilities.m102dp(40))) / (this.buttons.size() - 1));
        int m102dp = (i6 - AndroidUtilities.m102dp(40)) / 2;
        int m102dp2 = (i6 + AndroidUtilities.m102dp(40)) / 2;
        int m103dp = AndroidUtilities.m103dp(12.33f);
        for (int i7 = 0; i7 < this.buttons.size(); i7++) {
            this.buttons.get(i7).layout(m103dp, m102dp, AndroidUtilities.m102dp(40) + m103dp, m102dp2);
            m103dp += AndroidUtilities.m102dp(40) + min;
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(52), 1073741824));
    }
    ...
    private void updateAppearT() {
        ...
        this.shadowView.setTranslationY((1.0f - this.appearT) * AndroidUtilities.m102dp(16));
        for (int i = 1; i < getChildCount(); i++) {
            ...
            childAt.setAlpha(f);
            childAt.setTranslationY((1.0f - f) * AndroidUtilities.m102dp(24));
        }
    }
    ...
    public class ShareButtonView extends View {
        ...
        public ShareButtonView(Context context, String str) {
            ...
            Drawable mutate = getResources().getDrawable(C3630R.C3632drawable.attach_arrow_right).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
            mutate.setBounds(0, 0, AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(12));
            ...
            StaticLayout staticLayout = new StaticLayout(append, textPaint, AndroidUtilities.m102dp(180), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            ...
            this.width = f;
            this.f1986w = ((int) f) + AndroidUtilities.m102dp(48);
            this.f1985h = AndroidUtilities.m102dp(40);
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f1986w, 1073741824), View.MeasureSpec.makeMeasureSpec(this.f1985h, 1073741824));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(AndroidUtilities.m102dp(25), AndroidUtilities.m102dp(4), getWidth() - AndroidUtilities.m102dp(25), getHeight() - AndroidUtilities.m102dp(4), this.darkenPaint);
            canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), getHeight(), 255, 31);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(4), getWidth() - AndroidUtilities.m102dp(10), getHeight() - AndroidUtilities.m102dp(4));
            canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(20), this.buttonPaint);
            canvas.save();
            canvas.translate(AndroidUtilities.m102dp(26) - this.left, (getHeight() - this.staticLayout.getHeight()) / 2.0f);
    ...
    public class ButtonView extends ImageView {
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(40));
        }
