...
public class StoriesUtilities {
    ...
    */
    public static void drawAvatarWithStory(long r26, android.graphics.Canvas r28, org.telegram.messenger.ImageReceiver r29, boolean r30, org.telegram.p042ui.Stories.StoriesUtilities.AvatarStoryParams r31) {
        /*
            Method dump skipped, instructions count: 1032
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.StoriesUtilities.drawAvatarWithStory(long, android.graphics.Canvas, org.telegram.messenger.ImageReceiver, boolean, org.telegram.ui.Stories.StoriesUtilities$AvatarStoryParams):void");
    }
    ...
    private static void drawSegmentsInternal(Canvas canvas, StoriesController storiesController, ImageReceiver imageReceiver, AvatarStoryParams avatarStoryParams, Paint paint, Paint paint2, Paint paint3) {
        ...
        if (i2 > 1) {
            ...
            while (i3 < i2) {
                ...
                } else if (tLRPC$PeerStories.stories.get(i3).justUploaded || tLRPC$PeerStories.stories.get(i3).f1635id > max) {
    ...
    private static int getInset(int i, int i2) {
        ...
        if (i == 2) {
            return AndroidUtilities.m102dp(3);
        }
        if (i == 1) {
    ...
    public static void setThumbImage(ImageReceiver imageReceiver, TLRPC$StoryItem tLRPC$StoryItem, int i, int i2) {
        ...
        TLRPC$MessageMedia tLRPC$MessageMedia = tLRPC$StoryItem.media;
        if (tLRPC$MessageMedia != null && (tLRPC$Document = tLRPC$MessageMedia.document) != null) {
            ImageLocation forDocument = ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tLRPC$Document.thumbs, AndroidUtilities.m102dp(Math.max(i, i2)), false, null, true), tLRPC$StoryItem.media.document);
        ...
        TLRPC$Photo tLRPC$Photo = tLRPC$MessageMedia != null ? tLRPC$MessageMedia.photo : null;
        if (tLRPC$Photo != null && (arrayList = tLRPC$Photo.sizes) != null) {
            ImageLocation forPhoto = ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(arrayList, AndroidUtilities.m102dp(Math.max(i, i2)), false, null, true), tLRPC$Photo);
    ...
    public static CharSequence getUploadingStr(TextView textView, boolean z, boolean z2) {
        String string;
        if (z2) {
            string = LocaleController.getString("StoryEditing", C3630R.string.StoryEditing);
        } else {
            string = LocaleController.getString("UploadingStory", C3630R.string.UploadingStory);
        }
        if (string.indexOf("…") > 0) {
    ...
    public static CharSequence createExpiredStoryString() {
        return createExpiredStoryString(false, "ExpiredStory", C3630R.string.ExpiredStory, new Object[0]);
    }
    ...
    public static CharSequence createExpiredStoryString(boolean z, String str, int i, Object... objArr) {
        ...
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C3630R.C3632drawable.msg_mini_bomb);
        if (z) {
    ...
    public static CharSequence createReplyStoryString() {
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) "d ").append((CharSequence) LocaleController.getString("Story", C3630R.string.Story));
        spannableStringBuilder.setSpan(new ColoredImageSpan(C3630R.C3632drawable.msg_mini_replystory2), 0, 1, 0);
        return spannableStringBuilder;
    }
    ...
    public static void applyViewedUser(TLRPC$StoryItem tLRPC$StoryItem, TLRPC$User tLRPC$User) {
        ...
        if (tLRPC$StoryViews.views_count == 0) {
            ...
            tLRPC$StoryViews.recent_viewers.add(Long.valueOf(tLRPC$User.f1762id));
        }
    }
    ...
    public static EnsureStoryFileLoadedObject ensureStoryFileLoaded(TLRPC$PeerStories tLRPC$PeerStories, final Runnable runnable) {
        ...
        while (true) {
            if (i2 >= tLRPC$PeerStories.stories.size()) {
                ...
                break;
            } else if (tLRPC$PeerStories.stories.get(i2).f1635id > i) {
    ...
    public static class AvatarStoryParams {
        ...
        public void openStory(long j, Runnable runnable) {
            ...
            lastFragment.getOrCreateStoryViewer().open(lastFragment.getContext(), j, StoriesListPlaceProvider.m52of((RecyclerListView) this.child.getParent()));
        }
    ...
    public static class UserStoriesLoadOperation {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public /* synthetic */ void lambda$load$2(org.telegram.tgnet.TLObject r10, final long r11, final android.view.View r13, final org.telegram.p042ui.Stories.StoriesUtilities.AvatarStoryParams r14, org.telegram.messenger.MessagesController r15) {
            /*
                r9 = this;
                r0 = 1
                r1 = 0
                if (r10 == 0) goto L42
                org.telegram.tgnet.TLRPC$TL_stories_peerStories r10 = (org.telegram.tgnet.TLRPC$TL_stories_peerStories) r10
                ...
                r2.putChats(r3, r1)
                org.telegram.tgnet.TLRPC$PeerStories r10 = r10.stories
                ...
                r8 = r14
                r3.<init>()
                org.telegram.p042ui.Stories.StoriesUtilities.ensureStoryFileLoaded(r10, r2)
                r10 = r1
                goto L43
            L42:
                r10 = r0
            ...
            L97:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Stories.StoriesUtilities.UserStoriesLoadOperation.lambda$load$2(org.telegram.tgnet.TLObject, long, android.view.View, org.telegram.ui.Stories.StoriesUtilities$AvatarStoryParams, org.telegram.messenger.MessagesController):void");
        }
