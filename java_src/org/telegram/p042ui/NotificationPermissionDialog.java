...
import org.telegram.p042ui.NotificationPermissionDialog;
...
public class NotificationPermissionDialog extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public NotificationPermissionDialog(Context context, Utilities.Callback<Boolean> callback) {
        ...
        this.rLottieImageView.setAnimation(C3630R.raw.silent_unmute, 46, 46);
        ...
        rLottieImageView2.setBackground(Theme.createCircleDrawable(m102dp, Theme.getColor(i)));
        ...
        textView.setPadding(AndroidUtilities.m102dp(30), 0, AndroidUtilities.m102dp(30), 0);
        ...
        textView2.setPadding(AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(21));
        linearLayout.addView(textView2, LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C3630R.C3632drawable.msg_message_s, LocaleController.getString("NotificationsPermissionAlert1")), LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C3630R.C3632drawable.msg_members_list2, LocaleController.getString("NotificationsPermissionAlert2")), LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C3630R.C3632drawable.msg_customize_s, LocaleController.getString("NotificationsPermissionAlert3")), LayoutHelper.createLinear(-1, -2));
    ...
    public void onDismissWithTouchOutside() {
        this.mayBeAccidentalDismiss = System.currentTimeMillis() - this.showTime < C0479C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
    ...
    public static class CounterView extends View {
        ...
        public CounterView(Context context) {
            ...
            paint2.setStrokeWidth(AndroidUtilities.m102dp(4));
            ...
            this.textDrawable.getPaint().setStrokeWidth(AndroidUtilities.m103dp(0.24f));
            this.textDrawable.getPaint().setStrokeJoin(Paint.Join.ROUND);
            this.textDrawable.setTextSize(AndroidUtilities.m103dp(13.3f));
            this.textDrawable.setTextColor(Theme.getColor(Theme.key_featuredStickers_buttonText));
            this.textDrawable.setOverrideFullWidth(AndroidUtilities.m102dp(64));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(30), this.strokePaint);
            this.fillPaint.setAlpha(i);
            canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(30), this.fillPaint);
            canvas.save();
            canvas.translate(BitmapDescriptorFactory.HUE_RED, -AndroidUtilities.m102dp(1));
    ...
    private static class SectionView extends FrameLayout {
        public SectionView(Context context, int i, CharSequence charSequence) {
            super(context);
            setPadding(0, AndroidUtilities.m102dp(7), 0, AndroidUtilities.m102dp(7));
