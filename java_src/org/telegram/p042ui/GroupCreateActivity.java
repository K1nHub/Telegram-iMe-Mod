...
import org.telegram.p042ui.Components.PermanentLinkBottomSheet;
...
public class GroupCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    public class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            GroupCreateActivity.this.editText.measure(View.MeasureSpec.makeMeasureSpec(m102dp - i3, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(32), 1073741824));
            if (this.animationStarted) {
                ...
                GroupCreateActivity.this.fieldY = m102dp2;
                if (GroupCreateActivity.this.currentAnimation != null) {
                    int m102dp7 = m102dp2 + AndroidUtilities.m102dp(42);
                    if (GroupCreateActivity.this.containerHeight != m102dp7) {
                        this.animators.add(ObjectAnimator.ofInt(GroupCreateActivity.this, "containerHeight", m102dp7));
                    }
                    GroupCreateActivity groupCreateActivity = GroupCreateActivity.this;
                    groupCreateActivity.measuredContainerHeight = Math.max(groupCreateActivity.containerHeight, m102dp7);
                    float f3 = m102dp6;
                    ...
                    groupCreateActivity2.measuredContainerHeight = groupCreateActivity2.containerHeight = m102dp5;
                    GroupCreateActivity.this.editText.setTranslationX(m102dp6);
    ...
    public View createView(final Context context) {
        ...
        if (i2 == 2) {
            this.actionBar.setTitle(LocaleController.getString("ChannelAddSubscribers", C3630R.string.ChannelAddSubscribers));
        } else if (this.addToGroup) {
            if (this.channelId != 0) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddSubscribers", C3630R.string.ChannelAddSubscribers));
            } else {
                this.actionBar.setTitle(LocaleController.getString("GroupAddMembers", C3630R.string.GroupAddMembers));
            }
            ...
            if (i2 == 0) {
                i = C3630R.string.NewGroup;
                str = "NewGroup";
            } else {
                i = C3630R.string.NewBroadcastList;
                str = "NewBroadcastList";
            }
            c3702ActionBar.setTitle(LocaleController.getString(str, i));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.GroupCreateActivity.1
        ...
        ViewGroup viewGroup = new ViewGroup(context) { // from class: org.telegram.ui.GroupCreateActivity.2
            ...
            protected void onMeasure(int i5, int i6) {
                ...
                if (AndroidUtilities.isTablet() || size2 > size) {
                    GroupCreateActivity.this.maxSize = AndroidUtilities.m102dp(144);
                } else {
                    GroupCreateActivity.this.maxSize = AndroidUtilities.m102dp(56);
                }
                ...
                if (GroupCreateActivity.this.floatingButton != null) {
                    int m102dp = AndroidUtilities.m102dp(Build.VERSION.SDK_INT < 21 ? 60 : 56);
                    GroupCreateActivity.this.floatingButton.measure(View.MeasureSpec.makeMeasureSpec(m102dp, 1073741824), View.MeasureSpec.makeMeasureSpec(m102dp, 1073741824));
                }
            }
            ...
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                ...
                if (GroupCreateActivity.this.floatingButton != null) {
                    int m102dp = LocaleController.isRTL ? AndroidUtilities.m102dp(14) : ((i7 - i5) - AndroidUtilities.m102dp(14)) - GroupCreateActivity.this.floatingButton.getMeasuredWidth();
                    int m102dp2 = ((i8 - i6) - AndroidUtilities.m102dp(14)) - GroupCreateActivity.this.floatingButton.getMeasuredHeight();
                    GroupCreateActivity.this.floatingButton.layout(m102dp, m102dp2, GroupCreateActivity.this.floatingButton.getMeasuredWidth() + m102dp, GroupCreateActivity.this.floatingButton.getMeasuredHeight() + m102dp2);
                }
            }
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: org.telegram.ui.GroupCreateActivity.3
            ...
            public boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z) {
                ...
                rect.top += GroupCreateActivity.this.fieldY + AndroidUtilities.m102dp(20);
                rect.bottom += GroupCreateActivity.this.fieldY + AndroidUtilities.m102dp(50);
            ...
            if (longSparseArray == null || longSparseArray.indexOfKey(j) < 0) {
                ...
                if (z2) {
                    ...
                    if (this.chatType == 0 && this.selectedContacts.size() == getMessagesController().maxGroupCount) {
                        ...
                        builder.setMessage(LocaleController.getString("SoftUserLimitAlert", C3630R.string.SoftUserLimitAlert));
                        ...
                        if (this.addToGroup && tLRPC$User.bot) {
                            ...
                            if (j2 == 0 && tLRPC$User.bot_nochats) {
                                ...
                                if (ChatObject.canAddAdmins(chat)) {
                                    builder2.setTitle(LocaleController.getString("AddBotAdminAlert", C3630R.string.AddBotAdminAlert));
                                    builder2.setMessage(LocaleController.getString("AddBotAsAdmin", C3630R.string.AddBotAsAdmin));
                                    builder2.setPositiveButton(LocaleController.getString("AddAsAdmin", C3630R.string.AddAsAdmin), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda0
                                    ...
                                    builder2.setMessage(LocaleController.getString("CantAddBotAsAdmin", C3630R.string.CantAddBotAsAdmin));
    ...
    public void updateEditTextHint() {
        ...
        if (this.chatType == 2) {
            editTextBoldCursor.setHintText(LocaleController.getString("AddMutual", C3630R.string.AddMutual));
        } else if (this.addToGroup || (((groupCreateAdapter = this.adapter) != null && groupCreateAdapter.noContactsStubRow == 0) || this.isOnlyUsers)) {
            this.editText.setHintText(LocaleController.getString("SearchForPeople", C3630R.string.SearchForPeople));
            ...
            this.editText.setHintText(LocaleController.getString("SendMessageTo", C3630R.string.SendMessageTo));
        }
    }
    ...
    public boolean onDonePressed(boolean z) {
        ...
        if (z && this.addToGroup) {
            ...
            if (this.selectedContacts.size() > 5) {
                ...
                int i2 = C3630R.string.AddMembersAlertNamesText;
            ...
            if (!ChatObject.isChannel(chat)) {
                ...
                if (this.selectedContacts.size() == 1) {
                    checkBoxCellArr[0].setText(AndroidUtilities.replaceTags(LocaleController.formatString("AddOneMemberForwardMessages", C3630R.string.AddOneMemberForwardMessages, UserObject.getFirstName(getMessagesController().getUser(Long.valueOf(this.selectedContacts.keyAt(0)))))), "", true, false);
                } else {
                    checkBoxCellArr[0].setText(LocaleController.getString("AddMembersForwardMessages", C3630R.string.AddMembersForwardMessages), "", true, false);
                }
            ...
            builder.setPositiveButton(LocaleController.getString("Add", C3630R.string.Add), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
    ...
    public void updateHint() {
        if (!this.isAlwaysShare && !this.isNeverShare && !this.addToGroup) {
            if (this.chatType == 2) {
                ...
                this.actionBar.setSubtitle(LocaleController.formatString("MembersCountZero", C3630R.string.MembersCountZero, LocaleController.formatPluralString("Members", this.maxCount, new Object[0])));
            } else {
    ...
    public class GroupCreateAdapter extends RecyclerListView.FastScrollAdapter {
        ...
        public GroupCreateAdapter(Context context) {
            ...
            if (!GroupCreateActivity.this.isOnlyUsers && (GroupCreateActivity.this.isNeverShare || GroupCreateActivity.this.isAlwaysShare)) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (DialogObject.isChatDialog(tLRPC$Dialog.f1606id) && (chat = GroupCreateActivity.this.getMessagesController().getChat(Long.valueOf(-tLRPC$Dialog.f1606id))) != null && chat.migrated_to == null && ((!ChatObject.isChannel(chat) || chat.megagroup) && !GroupCreateActivity.this.getAlbumsController().isDialogAlbum(tLRPC$Dialog.f1606id))) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (this.searching) {
                    groupCreateSectionCell.setText(LocaleController.getString("GlobalSearch", C3630R.string.GlobalSearch));
                }
                ...
                if (tLObject instanceof TLRPC$User) {
                    ...
                    j = tLObject instanceof TLRPC$Chat ? -((TLRPC$Chat) tLObject).f1600id : 0L;
                }
                if (j != 0) {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder viewHolder) {
            if (GroupCreateActivity.this.ignoreUsers != null) {
                ...
                if (view instanceof GroupCreateUserCell) {
                    ...
                    return !(object instanceof TLRPC$User) || GroupCreateActivity.this.ignoreUsers.indexOfKey(((TLRPC$User) object).f1762id) < 0;
                }
                return true;
            }
            return true;
        ...
        */
        public /* synthetic */ void lambda$searchDialogs$1(java.lang.String r18) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.GroupCreateActivity.GroupCreateAdapter.lambda$searchDialogs$1(java.lang.String):void");
        }
