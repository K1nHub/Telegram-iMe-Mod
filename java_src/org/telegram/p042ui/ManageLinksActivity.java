...
import org.telegram.p042ui.Cells.CreationTextCell;
...
import org.telegram.p042ui.Components.DotDividerSpan;
...
import org.telegram.p042ui.LinkEditActivity;
...
public class ManageLinksActivity extends JavaWalletAuthBaseFragment implements WalletReceiveBinancePayView, WalletDonationsView, StakingCalculatorView, NotificationCenter.NotificationCenterDelegate {
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        if (i == 34) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("QRCodePermissionNoCameraWithHint", C3630R.string.QRCodePermissionNoCameraWithHint)));
            builder.setNegativeButton(LocaleController.getString("PermissionOpenSettings", C3630R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda0
    ...
    public ArrayList<ActionBarMenuSubItem> getInputOptionsMenuItems(final LinkActionView linkActionView) {
        ...
        if (walletDonationsPresenter != null) {
            if (!walletDonationsPresenter.getCurrentDonationsAddress().isEmpty()) {
                ...
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("GetQRCode", C3630R.string.GetQRCode), C3630R.C3632drawable.msg_qrcode);
                ...
                actionBarMenuSubItem2.setTextAndIcon(this.resourceManager.getValue().getString(C3630R.string.channel_donations_unlink_address_dialog_title), C3630R.C3632drawable.msg_delete);
                ...
                if (this.donationsPresenter.isCryptoAddressCreated()) {
                    ...
                    actionBarMenuSubItem3.setTextAndIcon(this.resourceManager.getValue().getString(C3630R.string.channel_donations_link_non_castodial_wallet_address_dialog_title), C3630R.C3632drawable.msg_link2);
                ...
                actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("AuthAnotherClientScan", C3630R.string.AuthAnotherClientScan), C3630R.C3632drawable.msg_qrcode);
    ...
    private void showDonationAddressQrCode() {
        ...
        qRCodeBottomSheet.setupWalletTypeReceive(this.resourceManager.getValue().getString(C3630R.string.wallet_receive_dialog_title), this.resourceManager.getValue().getString(C3630R.string.wallet_receive_dialog_btn_text), currentDonationsAddress);
    ...
    /* loaded from: classes5.dex */
    public class C64233 implements ChatRightsEditActivity.ChatRightsEditActivityDelegate {
            ...
            if (user != null) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$3$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ManageLinksActivity.C64233.this.lambda$didSetRights$0(user);
                    }
                }, 200L);
            }
        }
    ...
    public void openAddAdminScreen() {
        ...
        chatRightsEditActivity.setDelegate(new C64233());
    ...
    public /* synthetic */ void lambda$openSelectToken$9(LinkActionView linkActionView, TokenDetailed tokenDetailed) {
        linkActionView.setText(this.resourceManager.getValue().getString(C3630R.string.wallet_common_token_name_with_ticker, tokenDetailed.getName(), tokenDetailed.getTicker()));
    ...
    public void showCommonInfoAlert(String str, String str2) {
        showDialog(DialogsFactoryKt.createDialogInfoWithAnimation(this, C3630R.raw.fork_common_info, str, str2, 17, LocaleController.getString("OK", C3630R.string.OK), new Callbacks$Callback() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda8
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    private class EmptyView extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public EmptyView(Context context) {
            ...
            setPadding(0, AndroidUtilities.m102dp(12), 0, AndroidUtilities.m102dp(12));
            setOrientation(1);
                ...
                if (!ManageLinksActivity.this.isBinancePayCreateCollectionType) {
                    if (!ManageLinksActivity.this.isDonationsType) {
                        if (ManageLinksActivity.this.isStakingCalculatorType) {
                            i = C3630R.raw.fork_staking_calculator;
                        }
                    } else {
                        i = C3630R.raw.fork_donations;
                    }
                } else {
                    i = C3630R.raw.fork_binance_pay_create_collection;
                }
    ...
    public ManageLinksActivity(long j, long j2, int i) {
        ...
        this.linkEditActivityCallback = new C64299();
    ...
    public /* synthetic */ void lambda$loadLinks$12(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (tLRPC$TL_error == null) {
            ...
            for (int i2 = 0; i2 < tLRPC$TL_messages_chatAdminsWithInvites.users.size(); i2++) {
                ...
                this.users.put(Long.valueOf(tLRPC$User.f1762id), tLRPC$User);
            }
        }
    ...
    */
    public /* synthetic */ void lambda$loadLinks$15(org.telegram.tgnet.TLRPC$TL_chatInviteExported r7, org.telegram.tgnet.TLRPC$TL_error r8, org.telegram.tgnet.TLObject r9, boolean r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ManageLinksActivity.lambda$loadLinks$15(org.telegram.tgnet.TLRPC$TL_chatInviteExported, org.telegram.tgnet.TLRPC$TL_error, org.telegram.tgnet.TLObject, boolean):void");
    }
    ...
    public View createView(final Context context) {
        ...
        if (this.isStakingCalculatorType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3630R.string.staking_calculator_title));
            this.actionBar.createMenu().addItem(IdFabric$Menu.STAKING_HELP, C3630R.C3632drawable.msg_info);
        } else if (this.isBinancePayCreateCollectionType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3630R.string.wallet_binance_pay_action_receive));
        } else if (this.isDonationsType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3630R.string.channel_donations_toolbar_title));
        } else {
            this.actionBar.setTitle(LocaleController.getString("InviteLinks", C3630R.string.InviteLinks));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ManageLinksActivity.5
            ...
            public void onItemClick(int i) {
                if (i == IdFabric$Menu.STAKING_HELP) {
                    ...
                    manageLinksActivity.showCommonInfoAlert(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3630R.string.staking_calculator_help_alert_title), ((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3630R.string.staking_calculator_help_alert_description));
                } else if (i == -1) {
        ...
        this.linkIcon = ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_link_1);
        this.linkIconRevoked = ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_link_2);
    ...
    public /* synthetic */ void lambda$createView$21(Context context, View view, int i) {
        ...
        if (i >= i2 && i < this.donationTransactionsEndRow) {
            ...
            if (i >= i4 && i < this.revokedLinksEndRow) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString("DeleteAllRevokedLinks", C3630R.string.DeleteAllRevokedLinks));
                builder.setMessage(LocaleController.getString("DeleteAllRevokedLinkHelp", C3630R.string.DeleteAllRevokedLinkHelp));
                builder.setPositiveButton(LocaleController.getString("Delete", C3630R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(ManageLinksActivity manageLinksActivity, Context context) {
            ...
            if (manageLinksActivity.isStakingCalculatorType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3630R.string.staking_calculator_description));
            } else if (manageLinksActivity.isBinancePayCreateCollectionType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3630R.string.wallet_binance_receive_description));
            } else if (manageLinksActivity.isDonationsType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3630R.string.channel_donations_description));
            } else {
                TextView textView2 = this.messageTextView;
                if (manageLinksActivity.isChannel) {
                    i = C3630R.string.PrimaryLinkHelpChannel;
                    str = "PrimaryLinkHelpChannel";
                } else {
                    i = C3630R.string.PrimaryLinkHelp;
                    str = "PrimaryLinkHelp";
                }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == IdFabric$ViewTypes.STAKING_PROGNOSIS) {
                ...
                stakingPercentageView.setPadding(AndroidUtilities.m102dp(25), 0, AndroidUtilities.m102dp(23), AndroidUtilities.m102dp(12));
                ...
                transactionActionButtonsView.setPadding(AndroidUtilities.m102dp(25), 0, AndroidUtilities.m102dp(23), 0);
                ...
                stakingSafeWithdrawalView.setPadding(AndroidUtilities.m102dp(25), 0, AndroidUtilities.m102dp(23), 0);
                ...
                stakingWithdrawalFeeView.setPadding(AndroidUtilities.m102dp(25), 0, AndroidUtilities.m102dp(23), ManageLinksActivity.this.feeRow == -1 ? AndroidUtilities.m102dp(12) : 0);
                ...
                feeView.setPadding(AndroidUtilities.m102dp(25), 0, AndroidUtilities.m102dp(23), AndroidUtilities.m102dp(12));
                ...
                if (i == IdFabric$ViewTypes.HEADER_CELL_WITH_NETWORK) {
                    ...
                    headerCellWithImageViewButtonWrapper2.getImageView().setImageResource(C3630R.C3632drawable.msg_info);
                    ...
                    donationBalanceView.setPadding(AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(15));
                    ...
                    switch (i) {
                        ...
                        case 2:
                            ...
                            linkActionView2.setDelegate(new LinkActionView.Delegate() { // from class: org.telegram.ui.ManageLinksActivity.ListAdapter.1
                                @Override // org.telegram.p042ui.Components.LinkActionView.Delegate
                        ...
                        case 7:
                            ...
                            shadowSectionCell.setBackground(Theme.getThemedDrawableByKey(this.mContext, C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                            linkActionView = shadowSectionCell;
                            break;
                        case 8:
                            TextSettingsCell textSettingsCell = new TextSettingsCell(this.mContext);
                            textSettingsCell.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                            textSettingsCell.setText(LocaleController.getString("DeleteAllRevokedLinks", C3630R.string.DeleteAllRevokedLinks), false);
                        ...
                        case 9:
                            ...
                            if (ManageLinksActivity.this.isDonationsType) {
                                textInfoPrivacyCell.setText(((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3630R.string.channel_donations_admin_bot_information, AppConfiguration$Bots.getAuthBotUsernameWithAT()));
                                ...
                                String string = ((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3630R.string.channel_donations_admin_bot_link_key);
                                ...
                                textInfoPrivacyCell.setText(LocaleController.getString("CreateNewLinkHelp", C3630R.string.CreateNewLinkHelp));
                            }
                            textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.mContext, C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                        ...
                        default:
                            ...
                            hintInnerCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundWhite));
                            linkActionView = hintInnerCell;
                            break;
                    }
                } else {
                    View donationSeeMoreButton = new DonationSeeMoreButton(this.mContext);
                    donationSeeMoreButton.setPadding(AndroidUtilities.m102dp(23), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(23), AndroidUtilities.m102dp(15));
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r16, int r17) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ManageLinksActivity.ListAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onBindViewHolder$2() {
            ManageLinksActivity manageLinksActivity = ManageLinksActivity.this;
            manageLinksActivity.showCommonInfoAlert(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3630R.string.wallet_crypto_buy_information_dialog_title), ((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3630R.string.staking_replenishment_percentage_info_alert));
        }
    ...
    public /* synthetic */ void lambda$revokePermanent$23(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported) {
        if (tLRPC$TL_error == null) {
            ...
            updateRecyclerViewAnimated(saveListState);
            BulletinFactory.m61of(this).createSimpleBulletin(C3630R.raw.linkbroken, LocaleController.getString("InviteRevokedHint", C3630R.string.InviteRevokedHint)).show();
        }
    }
        ...
        */
        public /* synthetic */ void lambda$new$3(android.view.View r8) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ManageLinksActivity.LinkCell.lambda$new$3(android.view.View):void");
        }
        ...
        public /* synthetic */ void lambda$new$2(ArrayList arrayList, DialogInterface dialogInterface, int i) {
            ...
            if (intValue == 0) {
                ...
                try {
                    ...
                    ManageLinksActivity.this.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C3630R.string.InviteToGroupByLink)), 500);
                } catch (Exception e2) {
                    FileLog.m97e(e2);
                }
            } else if (intValue == 2) {
                ...
                builder.setPositiveButton(LocaleController.getString("RevokeButton", C3630R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                ...
                builder2.setTitle(LocaleController.getString("DeleteLink", C3630R.string.DeleteLink));
                builder2.setMessage(LocaleController.getString("DeleteLinkHelp", C3630R.string.DeleteLinkHelp));
                builder2.setPositiveButton(LocaleController.getString("Delete", C3630R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface2, int i2) {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(64), 1073741824));
            this.paint2.setStrokeWidth(AndroidUtilities.m102dp(2));
        }
        ...
        */
        protected void onDraw(android.graphics.Canvas r16) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ManageLinksActivity.LinkCell.onDraw(android.graphics.Canvas):void");
        }
        ...
        public void setLink(TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, int i) {
            ...
            if (i4 == 0 && tLRPC$TL_chatInviteExported.usage_limit == 0 && tLRPC$TL_chatInviteExported.requested == 0) {
                formatPluralString = LocaleController.getString("NoOneJoinedYet", C3630R.string.NoOneJoinedYet);
            } else {
            ...
            if (tLRPC$TL_chatInviteExported.permanent && !tLRPC$TL_chatInviteExported.revoked) {
                ...
                dotDividerSpan.setTopPadding(AndroidUtilities.m103dp(1.5f));
                ...
                spannableStringBuilder2.append((CharSequence) LocaleController.getString("Permanent", C3630R.string.Permanent));
                ...
                if (tLRPC$TL_chatInviteExported.revoked && tLRPC$TL_chatInviteExported.usage == 0) {
                    formatPluralString = LocaleController.getString("NoOneJoined", C3630R.string.NoOneJoined);
                }
                ...
                dotDividerSpan2.setTopPadding(AndroidUtilities.m103dp(1.5f));
                ...
                if (z || (i3 = tLRPC$TL_chatInviteExported.usage_limit) <= 0 || tLRPC$TL_chatInviteExported.usage < i3) {
                    if (z) {
                        i2 = C3630R.string.Revoked;
                        str = "Revoked";
                    } else {
                        i2 = C3630R.string.Expired;
                        str = "Expired";
                    }
                    spannableStringBuilder3.append((CharSequence) LocaleController.getString(str, i2));
                } else {
                    spannableStringBuilder3.append((CharSequence) LocaleController.getString("LinkLimitReached", C3630R.string.LinkLimitReached));
                }
                ...
                dotDividerSpan3.setTopPadding(AndroidUtilities.m103dp(1.5f));
    ...
    /* loaded from: classes5.dex */
    public class C64299 implements LinkEditActivity.Callback {
        C64299() {
        }

        @Override // org.telegram.p042ui.LinkEditActivity.Callback
        public void onLinkCreated(final TLObject tLObject) {
            if (tLObject instanceof TLRPC$TL_chatInviteExported) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$9$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ManageLinksActivity.C64299.this.lambda$onLinkCreated$0(tLObject);
                    }
                }, 200L);
            }
        }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(c3702ActionBar, i3, null, null, null, null, i4));
