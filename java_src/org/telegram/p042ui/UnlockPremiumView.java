...
public class UnlockPremiumView extends FrameLayout {
    ...
    public UnlockPremiumView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            textView.setText(LocaleController.getString("UnlockPremiumStickersDescription", C3630R.string.UnlockPremiumStickersDescription));
        } else if (i == 1) {
            textView.setText(LocaleController.getString("UnlockPremiumReactionsDescription", C3630R.string.UnlockPremiumReactionsDescription));
        }
        ...
        if (i == 0) {
            string = LocaleController.getString("UnlockPremiumStickers", C3630R.string.UnlockPremiumStickers);
        } else {
            string = LocaleController.getString("UnlockPremiumReactions", C3630R.string.UnlockPremiumReactions);
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) "d ").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_premium_normal)), 0, 1, 0);
