...
import org.telegram.p042ui.Components.Reactions.AnimatedEmojiEffect;
...
import org.telegram.p042ui.Stories.StoryReactionWidgetView;
...
public class EmojiAnimationsOverlay implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void checkStickerPack() {
        ...
        if (this.set != null) {
            ...
            for (int i = 0; i < this.set.documents.size(); i++) {
                hashMap.put(Long.valueOf(this.set.documents.get(i).f1608id), this.set.documents.get(i));
            }
                    ...
                    if (messageObject == null || messageObject.getId() != drawingObject.messageId) {
                        ...
                        if (drawingObject.isPremiumSticker) {
                            ...
                            if (drawingObject.isOut) {
                                f2 = ((-imageReceiver.getImageWidth()) * 2.0f) + AndroidUtilities.m102dp(24);
                            } else {
                                f2 = -AndroidUtilities.m102dp(24);
                            }
    ...
    public boolean onTapItem(ChatMessageCell chatMessageCell, ChatActivity chatActivity, boolean z) {
        ...
        if (chatMessageCell.getMessageObject().isPremiumSticker() || chatActivity.currentUser != null) {
            ...
            if ((printingStringType == null || printingStringType.intValue() != 5) && this.hintRunnable == null && showAnimationForCell && ((Bulletin.getVisibleBulletin() == null || !Bulletin.getVisibleBulletin().isShowing()) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.currentAccount).getClientUserId() != chatActivity.currentUser.f1762id)) {
                ...
                stickerSetBulletinLayout.titleTextView.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString("EmojiInteractionTapHint", C3630R.string.EmojiInteractionTapHint, chatActivity.currentUser.first_name)), stickerSetBulletinLayout.titleTextView.getPaint().getFontMetricsInt(), false));
    ...
    public boolean showAnimationForActionCell(ChatActionCell chatActionCell, TLRPC$Document tLRPC$Document, TLRPC$VideoSize tLRPC$VideoSize) {
        if (this.drawingObjects.size() <= 12 && chatActionCell.getPhotoImage().hasNotThumb()) {
            ...
            for (int i3 = 0; i3 < this.drawingObjects.size(); i3++) {
                ...
                if (this.drawingObjects.get(i3).document != null && tLRPC$Document != null && this.drawingObjects.get(i3).document.f1608id == tLRPC$Document.f1608id) {
                    i2++;
                }
            }
            if (i >= 4) {
            ...
            if (i2 > 0) {
                Integer num = this.lastAnimationIndex.get(Long.valueOf(tLRPC$Document.f1608id));
                int intValue = num == null ? 0 : num.intValue();
                this.lastAnimationIndex.put(Long.valueOf(tLRPC$Document.f1608id), Integer.valueOf((intValue + 1) % 4));
    ...
    private void preloadAnimation(TLRPC$Document tLRPC$Document) {
        ...
        if (hashMap == null || !hashMap.containsKey(Long.valueOf(tLRPC$Document.f1608id))) {
            if (this.preloaded == null) {
                this.preloaded = new HashMap<>();
            }
            this.preloaded.put(Long.valueOf(tLRPC$Document.f1608id), Boolean.TRUE);
        ...
        if (!z5 || ForkCommonController.getInstance(this.currentAccount).isPremiumAnimateStickers()) {
            if ((supportedEmoji.contains(str) || z5) && (!((arrayList = this.emojiInteractionsStickersMap.get(str)) == null || arrayList.isEmpty()) || z5)) {
                ...
                while (i4 < this.drawingObjects.size()) {
                    ...
                    if (this.drawingObjects.get(i4).document != null && tLRPC$Document != null && this.drawingObjects.get(i4).document.f1608id == tLRPC$Document.f1608id) {
                        i6++;
                    }
                    i4++;
                    z4 = false;
                ...
                if (z && z5 && i5 > 0) {
                    if (Bulletin.getVisibleBulletin() == null || Bulletin.getVisibleBulletin().hash != messageObject.getId()) {
                        ...
                        if (stickerSetByName == null) {
                            stickerSetByName = MediaDataController.getInstance(this.currentAccount).getStickerSetById(inputStickerSet.f1623id);
                        }
                        if (stickerSetByName == null) {
                            ...
                            if (i3 < 0 || i3 > arrayList.size() - 1) {
                                ...
                                for (int i7 = 0; i7 < arrayList.size(); i7++) {
                                    ...
                                    if (tLRPC$Document3 != null) {
                                        HashMap<Long, Boolean> hashMap = this.preloaded;
                                        Boolean bool = hashMap != null ? hashMap.get(Long.valueOf(tLRPC$Document3.f1608id)) : null;
                    ...
                    if (tLRPC$Document2 != null) {
                        int filterWidth = getFilterWidth();
                        Integer num = this.lastAnimationIndex.get(Long.valueOf(tLRPC$Document2.f1608id));
                        int intValue = (num == null ? 0 : num.intValue()) + 1;
                        this.lastAnimationIndex.put(Long.valueOf(tLRPC$Document2.f1608id), Integer.valueOf(intValue));
                        ...
                        if (i6 > 0) {
                            Integer num2 = this.lastAnimationIndex.get(Long.valueOf(messageObject.getDocument().f1608id));
                            int intValue2 = num2 == null ? 0 : num2.intValue();
                            this.lastAnimationIndex.put(Long.valueOf(messageObject.getDocument().f1608id), Integer.valueOf((intValue2 + 1) % 4));
    ...
    public void lambda$createDrawingObject$0(TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, final MessageObject messageObject) {
        if (this.chatActivity == null || MessagesController.getInstance(this.currentAccount).premiumLocked || this.chatActivity.getParentActivity() == null) {
            return;
        }
        ...
        stickerSetBulletinLayout.subtitleTextView.setText(LocaleController.getString("PremiumStickerTooltip", C3630R.string.PremiumStickerTooltip));
        ...
        undoButton.setText(LocaleController.getString("ViewAction", C3630R.string.ViewAction));
    ...
    */
    public static java.lang.String unwrapEmoji(java.lang.String r8) {
        ...
        L88:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.EmojiAnimationsOverlay.unwrapEmoji(java.lang.String):java.lang.String");
    }
