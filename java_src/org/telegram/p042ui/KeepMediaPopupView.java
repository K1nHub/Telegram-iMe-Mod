...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public KeepMediaPopupView(final BaseFragment baseFragment, Context context) {
        ...
        setFitItems(true);
        this.oneDay = ActionBarMenuItem.addItem(this, C3630R.C3632drawable.msg_autodelete_1d, LocaleController.formatPluralString("Days", 1, new Object[0]), false, null);
        this.twoDay = ActionBarMenuItem.addItem(this, C3630R.C3632drawable.msg_autodelete_2d, LocaleController.formatPluralString("Days", 2, new Object[0]), false, null);
        this.oneWeek = ActionBarMenuItem.addItem(this, C3630R.C3632drawable.msg_autodelete_1w, LocaleController.formatPluralString("Weeks", 1, new Object[0]), false, null);
        this.oneMonth = ActionBarMenuItem.addItem(this, C3630R.C3632drawable.msg_autodelete_1m, LocaleController.formatPluralString("Months", 1, new Object[0]), false, null);
        this.forever = ActionBarMenuItem.addItem(this, C3630R.C3632drawable.msg_cancel, LocaleController.getString("AutoDeleteMediaNever", C3630R.string.AutoDeleteMediaNever), false, null);
        ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(this, C3630R.C3632drawable.msg_delete, LocaleController.getString("DeleteException", C3630R.string.DeleteException), false, null);
        this.delete = addItem;
        ...
        view.setBackground(Theme.getThemedDrawableByKey(context, C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow, null));
        this.gap.addView(view, LayoutHelper.createFrame(-1, -1));
        this.gap.setTag(C3630R.C3633id.fit_width_tag, 1);
        ...
        linksTextView.setText(LocaleController.getString("KeepMediaPopupDescription", C3630R.string.KeepMediaPopupDescription));
    ...
    public void update(int i) {
        ...
        if (keepMediaExceptions.isEmpty()) {
            this.exceptionsView.titleView.setText(LocaleController.getString("AddAnException", C3630R.string.AddAnException));
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m102dp(8));
            ...
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m102dp((Math.max(0, min - 1) * 12) + 64));
    ...
    public class ExceptionsView extends FrameLayout {
        ...
        public ExceptionsView(Context context) {
            ...
            this.titleView.setRightPadding(AndroidUtilities.m102dp(68));
    ...
    public void updateAvatarsPosition() {
        if (this.exceptions != null) {
            this.exceptionsView.avatarsImageView.setTranslationX(AndroidUtilities.m102dp(12) * (3 - Math.min(3, this.exceptions.size())));
        }
    }
