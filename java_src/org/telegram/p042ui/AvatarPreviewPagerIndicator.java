...
public class AvatarPreviewPagerIndicator extends View implements ProfileGalleryView.Callback {
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        int currentActionBarHeight = C3702ActionBar.getCurrentActionBarHeight() + 0;
    ...
    */
    public void onDraw(android.graphics.Canvas r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.AvatarPreviewPagerIndicator.onDraw(android.graphics.Canvas):void");
    }
