...
public class PremiumFeatureCell extends FrameLayout {
    ...
    public void setCheckBoxVisible(boolean z) {
        ((ViewGroup.MarginLayoutParams) this.titleSubtitleContainer.getLayoutParams()).rightMargin = this.initialTitleSubtitleContainerLeftMargin + (z ? AndroidUtilities.m102dp(22) : 0);
    ...
    public PremiumFeatureCell(Context context) {
        ...
        imageView2.setImageResource(C3630R.C3632drawable.msg_arrowright);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.drawDivider) {
            canvas.drawRect(AndroidUtilities.m102dp(62), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), Theme.dividerPaint);
        }
    }
}
