...
import org.telegram.p042ui.MessageEnterTransitionContainer;
...
public class TextMessageEnterTransition implements MessageEnterTransitionContainer.Transition {
    ...
    public TextMessageEnterTransition(final ChatMessageCell chatMessageCell, final ChatActivity chatActivity, ViewGroup viewGroup, final MessageEnterTransitionContainer messageEnterTransitionContainer, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (chatMessageCell.getMessageObject().getEmojiOnlyCount() != 0) {
            ...
            if (textPaint2 != null) {
                m102dp = (int) (textPaint2.getTextSize() + AndroidUtilities.m102dp(4));
            }
        }
        ...
        if (editText.length() != charSequence.length() || z2) {
            ...
            charSequence = Emoji.replaceEmoji(editText, textPaint2.getFontMetricsInt(), m102dp, false);
        } else {
            i = 0;
        }
        ...
        this.fromStartY = ((AndroidUtilities.m102dp(10) + y) - chatActivityEnterView.getEditField().getScrollY()) + i;
        ...
        this.drawableFromTop = AndroidUtilities.m102dp(4) + y;
        if (this.enterView.isTopViewVisible()) {
            this.drawableFromTop -= AndroidUtilities.m102dp(12);
        }
        ...
        if (z3) {
            ...
            this.drawableFromTop -= AndroidUtilities.m102dp(46);
        }
        this.gradientMatrix = new Matrix();
        Paint paint = new Paint(1);
        this.gradientPaint = paint;
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
        LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(12), (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, 0, -16777216, Shader.TileMode.CLAMP);
    ...
    @Override // org.telegram.p042ui.MessageEnterTransitionContainer.Transition
    /*
    ...
    */
    public void onDraw(android.graphics.Canvas r44) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.TextMessageEnterTransition.onDraw(android.graphics.Canvas):void");
    }
