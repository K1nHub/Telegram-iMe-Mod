...
import org.telegram.p042ui.ChatEditTypeActivity;
...
public class ChatEditTypeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public boolean onFragmentCreate() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChatEditTypeActivity.onFragmentCreate():boolean");
    }
    ...
    public void onResume() {
        ...
        if (textSettingsCell != null && (tLRPC$ChatFull = this.info) != null) {
            if (tLRPC$ChatFull.stickerset != null) {
                textSettingsCell.setTextAndValue(LocaleController.getString("GroupStickers", C3630R.string.GroupStickers), this.info.stickerset.title, false);
            } else {
                textSettingsCell.setText(LocaleController.getString("GroupStickers", C3630R.string.GroupStickers), false);
            }
        }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ChatEditTypeActivity.1
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: org.telegram.ui.ChatEditTypeActivity.2
            ...
            public boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z) {
                rect.bottom += AndroidUtilities.m102dp(60);
        ...
        if (this.isForcePublic) {
            this.actionBar.setTitle(LocaleController.getString("TypeLocationGroup", C3630R.string.TypeLocationGroup));
        } else if (this.isChannel) {
            this.actionBar.setTitle(LocaleController.getString("ChannelSettingsTitle", C3630R.string.ChannelSettingsTitle));
        } else {
            this.actionBar.setTitle(LocaleController.getString("GroupSettingsTitle", C3630R.string.GroupSettingsTitle));
        }
        ...
        if (this.isChannel) {
            this.headerCell2.setText(LocaleController.getString("ChannelTypeHeader", C3630R.string.ChannelTypeHeader));
        } else {
            this.headerCell2.setText(LocaleController.getString("GroupTypeHeader", C3630R.string.GroupTypeHeader));
        }
        ...
        this.usernameTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C3630R.string.ChannelUsernamePlaceholder));
        this.usernameTextView.setCursorColor(Theme.getColor(i4));
        this.usernameTextView.setCursorSize(AndroidUtilities.m102dp(20));
        ...
        C43136 c43136 = new C43136(context);
        this.checkTextView = c43136;
        c43136.setBackgroundDrawable(Theme.getThemedDrawableByKey(context, C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
        ...
        this.manageLinksTextView.setTextAndIcon(LocaleController.getString("ManageInviteLinks", C3630R.string.ManageInviteLinks), C3630R.C3632drawable.msg_link2, false);
        ...
        this.saveHeaderCell.setText(LocaleController.getString("SavingContentTitle", C3630R.string.SavingContentTitle));
        ...
        this.saveRestrictCell.setTextAndCheck(LocaleController.getString("RestrictSavingContent", C3630R.string.RestrictSavingContent), this.isSaveRestricted, false);
        ...
        if (this.isChannel && !ChatObject.isMegagroup(this.currentChat)) {
            this.saveRestrictInfoCell.setText(LocaleController.getString("RestrictSavingContentInfoChannel", C3630R.string.RestrictSavingContentInfoChannel));
        } else {
            this.saveRestrictInfoCell.setText(LocaleController.getString("RestrictSavingContentInfoGroup", C3630R.string.RestrictSavingContentInfoGroup));
        }
    ...
    /* loaded from: classes5.dex */
    class C43136 extends TextInfoPrivacyCell {
        int prevHeight;
        ValueAnimator translateAnimator;

        C43136(Context context) {
            super(context);
            this.prevHeight = -1;
        }
                ...
                for (int i = 0; i < typefaceSpanArr.length; i++) {
                    charSequence.setSpan(new ClickableSpan() { // from class: org.telegram.ui.ChatEditTypeActivity.6.1
                        ...
                        public void onClick(View view) {
                            Context context = C43136.this.getContext();
            ...
            if (this.prevHeight != -1 && ChatEditTypeActivity.this.linearLayout != null) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ChatEditTypeActivity$6$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatEditTypeActivity.C43136.lambda$onLayout$0(arrayList, height, valueAnimator2);
                    }
                });
    ...
    */
    private boolean tryUpdateJoinSettings() {
        ...
        L77:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChatEditTypeActivity.tryUpdateJoinSettings():boolean");
    }
    ...
    public class UsernamesListView extends RecyclerListView {
        ...
        public UsernamesListView(Context context) {
            ...
            setOnItemClickListener(new C43151(ChatEditTypeActivity.this));
        ...
        /* loaded from: classes5.dex */
        public class C43151 implements RecyclerListView.OnItemClickListener {
            C43151(ChatEditTypeActivity chatEditTypeActivity) {
            }
            ...
            public void onItemClick(final View view, int i) {
                ...
                if (tLRPC$TL_username.editable) {
                    if (((BaseFragment) ChatEditTypeActivity.this).fragmentView instanceof ScrollView) {
                        ((ScrollView) ((BaseFragment) ChatEditTypeActivity.this).fragmentView).smoothScrollTo(0, ChatEditTypeActivity.this.linkContainer.getTop() - AndroidUtilities.m102dp(128));
                    }
                ...
                if (tLRPC$TL_username.active) {
                    i3 = C3630R.string.UsernameDeactivateLinkChannelMessage;
                    str2 = "UsernameDeactivateLinkChannelMessage";
                } else {
                    i3 = C3630R.string.UsernameActivateLinkChannelMessage;
                ...
                message.setPositiveButton(LocaleController.getString(str3, i4), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i5) {
                        ChatEditTypeActivity.UsernamesListView.C43151.this.lambda$onItemClick$4(tLRPC$TL_username, view, dialogInterface, i5);
                    }
                }).setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i5) {
            ...
            public /* synthetic */ void lambda$onItemClick$4(final TLRPC$TL_username tLRPC$TL_username, View view, DialogInterface dialogInterface, int i) {
                if (tLRPC$TL_username.editable) {
                    ...
                    tLRPC$TL_inputChannel.channel_id = ChatEditTypeActivity.this.currentChat.f1600id;
                    ...
                    ChatEditTypeActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_channels_toggleUsername, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda5
                        ...
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            ChatEditTypeActivity.UsernamesListView.C43151.this.lambda$onItemClick$3(tLRPC$TL_channels_toggleUsername, tLRPC$TL_username, z2, tLObject, tLRPC$TL_error);
                        }
                    });
            ...
            public /* synthetic */ void lambda$onItemClick$3(final TLRPC$TL_channels_toggleUsername tLRPC$TL_channels_toggleUsername, final TLRPC$TL_username tLRPC$TL_username, final boolean z, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatEditTypeActivity.UsernamesListView.C43151.this.lambda$onItemClick$2(tLRPC$TL_channels_toggleUsername, tLObject, tLRPC$TL_username, z, tLRPC$TL_error);
                    }
                });
            }
            ...
            public /* synthetic */ void lambda$onItemClick$2(TLRPC$TL_channels_toggleUsername tLRPC$TL_channels_toggleUsername, TLObject tLObject, final TLRPC$TL_username tLRPC$TL_username, final boolean z, TLRPC$TL_error tLRPC$TL_error) {
                ...
                if (tLObject instanceof TLRPC$TL_boolTrue) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatEditTypeActivity.UsernamesListView.C43151.this.lambda$onItemClick$1(tLRPC$TL_username, z);
                        }
                    });
                } else {
        ...
        public class Adapter extends RecyclerListView.SelectionAdapter {
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (itemViewType == 0) {
                    ...
                    ((HeaderCell) viewHolder.itemView).setText(LocaleController.getString("UsernamesChannelHeader", C3630R.string.UsernamesChannelHeader));
                    return;
                }
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                    ...
                    ((TextInfoPrivacyCell) viewHolder.itemView).setText(LocaleController.getString("UsernamesChannelHelp", C3630R.string.UsernamesChannelHelp));
                    ((TextInfoPrivacyCell) viewHolder.itemView).setBackgroundDrawable(Theme.getThemedDrawableByKey(UsernamesListView.this.getContext(), C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    return;
                }
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$18(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3630R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
    ...
    private void updatePrivatePublic() {
        ...
        if (!this.isPrivate && !this.canCreatePublic && getUserConfig().isPremium()) {
            ...
            if (this.loadingAdminedChannels) {
                ...
                this.typeInfoCell.setBackgroundDrawable(this.checkTextView.getVisibility() == 0 ? null : Theme.getThemedDrawableByKey(this.typeInfoCell.getContext(), C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                ...
                int i5 = C3630R.C3632drawable.greydivider_bottom;
                ...
                textInfoPrivacyCell2.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell2.getContext(), C3630R.C3632drawable.greydivider_top, i6));
            ...
            int i8 = C3630R.C3632drawable.greydivider_bottom;
            ...
            if (this.isChannel) {
                ...
                if (this.isPrivate) {
                    i2 = C3630R.string.ChannelPrivateLinkHelp;
                    str2 = "ChannelPrivateLinkHelp";
                } else {
                    i2 = C3630R.string.ChannelUsernameHelp;
                ...
                if (this.isPrivate) {
                    i = C3630R.string.MegaPrivateLinkHelp;
                    str = "MegaPrivateLinkHelp";
                } else {
                    i = C3630R.string.MegaUsernameHelp;
            ...
            this.manageLinksInfoCell.setText(LocaleController.getString("ManageLinksInfoHelp", C3630R.string.ManageLinksInfoHelp));
            if (this.isPrivate) {
                TextInfoPrivacyCell textInfoPrivacyCell8 = this.typeInfoCell;
                textInfoPrivacyCell8.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell8.getContext(), C3630R.C3632drawable.greydivider, i9));
    ...
    public boolean checkUserName(final String str) {
            ...
            for (int i = 0; i < str.length(); i++) {
                ...
                if (i == 0 && charAt >= '0' && charAt <= '9') {
                    if (this.isChannel) {
                        ...
                        this.checkTextView.setText(LocaleController.getString("LinkInvalidStartNumberMega", C3630R.string.LinkInvalidStartNumberMega));
                    }
                    this.checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
                    return false;
        ...
        if (str == null || str.length() < 4) {
            if (this.isChannel) {
                ...
                this.checkTextView.setText(LocaleController.getString("LinkInvalidShortMega", C3630R.string.LinkInvalidShortMega));
            }
            this.checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
            return false;
