...
public class MessageSeenView extends FrameLayout {
    ...
    public MessageSeenView(Context context, final int i, MessageObject messageObject, final TLRPC$Chat tLRPC$Chat) {
        ...
        this.titleView.setRightPadding(AndroidUtilities.m102dp(62));
        addView(this.titleView, LayoutHelper.createFrame(0, -2, 19, 40, 0, 0, 0));
        AvatarsImageView avatarsImageView = new AvatarsImageView(context, false);
        this.avatarsImageView = avatarsImageView;
        avatarsImageView.setStyle(11);
        this.avatarsImageView.setAvatarsTextSize(AndroidUtilities.m102dp(22));
        ...
        Drawable mutate = ContextCompat.getDrawable(context, this.isVoice ? C3630R.C3632drawable.msg_played : C3630R.C3632drawable.msg_seen).mutate();
    ...
    public /* synthetic */ void lambda$new$4(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, long j, final int i, TLRPC$Chat tLRPC$Chat) {
        if (tLRPC$TL_error == null) {
            ...
            if (arrayList.isEmpty()) {
                ...
                tLRPC$TL_channels_getParticipants.channel = MessagesController.getInstance(i).getInputChannel(tLRPC$Chat.f1600id);
                ...
                tLRPC$TL_messages_getFullChat.chat_id = tLRPC$Chat.f1600id;
    ...
    public /* synthetic */ void lambda$new$0(TLObject tLObject, int i, HashMap hashMap, ArrayList arrayList) {
        if (tLObject != null) {
            ...
            for (int i2 = 0; i2 < tLRPC$TL_channels_channelParticipants.users.size(); i2++) {
                ...
                hashMap.put(Long.valueOf(tLRPC$User.f1762id), tLRPC$User);
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.titleView.getLayoutParams().width = getMeasuredWidth() - AndroidUtilities.m102dp(40);
    ...
    private void updateView() {
        ...
        if (this.users.size() == 1) {
            this.avatarsImageView.setTranslationX(AndroidUtilities.m102dp(24));
        } else if (this.users.size() == 2) {
            this.avatarsImageView.setTranslationX(AndroidUtilities.m102dp(12));
        } else {
            this.avatarsImageView.setTranslationX(BitmapDescriptorFactory.HUE_RED);
        }
        this.titleView.setRightPadding(AndroidUtilities.m102dp((Math.min(2, this.users.size() - 1) * 12) + 32 + 6));
        ...
        if (this.peerIds.size() == 1 && this.users.get(0) != null) {
            ...
            this.titleView.setText(LocaleController.getString("NobodyViewed", C3630R.string.NobodyViewed));
        } else {
    ...
    public RecyclerListView createListView() {
        ...
        RecyclerListView recyclerListView2 = new RecyclerListView(this, getContext()) { // from class: org.telegram.ui.MessageSeenView.1
            ...
            public void onMeasure(int i, int i2) {
                ...
                int m102dp = AndroidUtilities.m102dp(4) + (AndroidUtilities.m102dp(50) * getAdapter().getItemCount());
                if (m102dp <= size) {
                    size = m102dp;
                }
        ...
        this.listView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.MessageSeenView.2
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                if (recyclerView.getChildAdapterPosition(view) == MessageSeenView.this.users.size() - 1) {
                    rect.bottom = AndroidUtilities.m102dp(4);
                }
            }
        });
        this.listView.setAdapter(new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.MessageSeenView.3
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                userCell.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m102dp(50)));
    ...
    private static class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        private static MessageSeenCheckDrawable seenDrawable = new MessageSeenCheckDrawable(C3630R.C3632drawable.msg_mini_checks, Theme.key_windowBackgroundWhiteGrayText);
        ...
        public UserCell(Context context) {
            ...
            this.nameView.setDrawablePadding(AndroidUtilities.m102dp(3));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(50), 1073741824));
        }
        ...
        public void setUser(TLObject tLObject, int i) {
            ...
            if (i <= 0) {
                ...
                this.nameView.setTranslationY(AndroidUtilities.m102dp(9));
                return;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            String formatString = LocaleController.formatString("AccDescrPersonHasSeen", C3630R.string.AccDescrPersonHasSeen, this.nameView.getText());
        ...
        public void didReceivedNotification(int i, int i2, Object... objArr) {
            if (i == NotificationCenter.userEmojiStatusUpdated) {
                ...
                if (tLRPC$User2 == null || tLRPC$User == null || tLRPC$User2.f1762id != tLRPC$User.f1762id) {
                    return;
                }
