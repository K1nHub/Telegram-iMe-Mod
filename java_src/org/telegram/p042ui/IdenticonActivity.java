...
import org.telegram.p042ui.Components.IdenticonDrawable;
import org.telegram.p042ui.Components.LayoutHelper;
import org.telegram.p042ui.Components.URLSpanReplacement;
import org.telegram.tgnet.TLRPC$EncryptedChat;
import org.telegram.tgnet.TLRPC$User;
/* renamed from: org.telegram.ui.IdenticonActivity */
...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* renamed from: org.telegram.ui.IdenticonActivity$LinkMovementMethodMy */
    /* loaded from: classes5.dex */
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("EncryptionKey", C3630R.string.EncryptionKey));
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.IdenticonActivity.1
        ...
        frameLayout2.addView(this.linearLayout, LayoutHelper.createFrame(-1, -1));
        FrameLayout frameLayout3 = new FrameLayout(context);
        frameLayout3.setPadding(AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(20));
        this.linearLayout.addView(frameLayout3, LayoutHelper.createLinear(-1, -1, 50.0f));
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.FIT_XY);
        frameLayout3.addView(imageView, LayoutHelper.createFrame(-1, -1));
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.telegram.ui.IdenticonActivity.2
            ...
            protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (IdenticonActivity.this.codeTextView != null) {
                    ...
                    int measuredHeight = (((IdenticonActivity.this.codeTextView.getMeasuredHeight() - IdenticonActivity.this.emojiTextView.getMeasuredHeight()) / 2) + IdenticonActivity.this.linearLayout1.getTop()) - AndroidUtilities.m102dp(16);
        ...
        this.linearLayout1.setPadding(AndroidUtilities.m102dp(10), 0, AndroidUtilities.m102dp(10), 0);
        ...
        this.container.addView(this.emojiTextView, LayoutHelper.createFrame(-2, -2));
        ...
        if (encryptedChat != null) {
            ...
            int i7 = C3630R.string.EncryptionKeyDescription;
            ...
            if (indexOf != -1) {
                spannableStringBuilder.setSpan(new URLSpanReplacement(LocaleController.getString("EncryptionKeyLink", C3630R.string.EncryptionKeyLink)), indexOf, indexOf + 12, 33);
            }
    ...
    public void onTransitionAnimationEnd(boolean z, boolean z2) {
        ...
        TextView textView = this.emojiTextView;
        textView.setText(Emoji.replaceEmoji(str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(32), false));
    }
