...
public class DataSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        BulletinFactory.m61of(this).createSimpleBulletin(C3630R.raw.info, AndroidUtilities.replaceTags(LocaleController.getInternalString(C3630R.string.cloud_albums_undo_forward_cloud))).show();
    }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("DataSettings", C3630R.string.DataSettings));
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.DataSettingsActivity.1
    ...
    */
    public /* synthetic */ void lambda$createView$9(android.content.Context r21, android.view.View r22, final int r23, float r24, float r25) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.DataSettingsActivity.lambda$createView$9(android.content.Context, android.view.View, int, float, float):void");
    }
    ...
    public /* synthetic */ void lambda$createView$5(final String str, boolean z, final AlertDialog.Builder builder, View view) {
        ...
        if (!z) {
            ...
            builder2.setTitle(LocaleController.getString("DecreaseSpeed", C3630R.string.DecreaseSpeed));
            builder2.setMessage(LocaleController.getString("SdCardAlert", C3630R.string.SdCardAlert));
            builder2.setPositiveButton(LocaleController.getString("Proceed", C3630R.string.Proceed), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DataSettingsActivity.3
            ...
            builder2.setNegativeButton(LocaleController.getString("Back", C3630R.string.Back), null);
            builder2.show();
            return;
        }
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r20, int r21) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.DataSettingsActivity.ListAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                shadowSectionCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            } else if (i == 5) {
