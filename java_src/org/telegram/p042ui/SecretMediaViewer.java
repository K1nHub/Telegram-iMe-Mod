...
import org.telegram.p042ui.SecretMediaViewer;
...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            this.afterDeleteProgressPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
            Paint paint3 = new Paint(1);
            this.circlePaint = paint3;
            paint3.setColor(2130706432);
            int i = C3630R.raw.fire_on;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16));
        ...
        public void setOnce() {
            this.once = true;
            this.oncePaint.setTextSize(AndroidUtilities.m102dp(13));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float measuredWidth = getMeasuredWidth() - AndroidUtilities.m102dp(35);
                ...
                if (SecretMediaViewer.this.currentMessageObject.messageOwner.destroyTime != 0 || SecretMediaViewer.this.currentMessageObject.messageOwner.ttl == Integer.MAX_VALUE) {
                    ...
                    if (this.useVideoProgress) {
                        if (SecretMediaViewer.this.videoPlayer != null) {
                            ...
                            if (duration != C0479C.TIME_UNSET && currentPosition != C0479C.TIME_UNSET) {
                    ...
                    if (this.once) {
                        ...
                        float centerY = this.deleteProgressRect.centerY() - AndroidUtilities.m102dp(1);
                        float m102dp = AndroidUtilities.m102dp(8);
                        this.drawable.setBounds((int) (centerX - m102dp), (int) (centerY - m102dp), (int) (centerX + m102dp), (int) (centerY + m102dp));
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        } else if (i == NotificationCenter.updateMessageMedia && this.currentMessageObject.getId() == ((TLRPC$Message) objArr[0]).f1624id) {
            if (this.isVideo && !this.videoWatchedOneTime) {
                this.closeVideoAfterWatch = true;
            } else if (!closePhoto(true, true)) {
                this.closeAfterAnimation = true;
    ...
    public void preparePlayer(File file) {
        ...
        if (this.videoPlayer == null) {
            ...
            this.videoPlayer.setDelegate(new C68552(file));
        }
    ...
    /* loaded from: classes5.dex */
    public class C68552 implements VideoPlayer.VideoPlayerDelegate {
        ...
        public void onError(VideoPlayer videoPlayer, Exception exc) {
            if (SecretMediaViewer.this.playerRetryPlayCount > 0) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        SecretMediaViewer.C68552.this.lambda$onError$0(file);
                    }
                }, 100L);
                return;
            }
    ...
    public void setParentActivity(final Activity activity) {
        ...
        this.containerView = new FrameLayoutDrawer(activity) { // from class: org.telegram.ui.SecretMediaViewer.4
            ...
            protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                if (SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight = ((C3702ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
                ...
                if (SecretMediaViewer.this.secretHint != null && SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight2 = ((((C3702ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) + SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) - AndroidUtilities.m102dp(10);
                ...
                if (SecretMediaViewer.this.captionScrollView != null) {
                    int currentActionBarHeight3 = C3702ActionBar.getCurrentActionBarHeight() + (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                if (SecretMediaViewer.this.captionScrollView != null) {
                    SecretMediaViewer.this.captionScrollView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(((measuredHeight - C3702ActionBar.getCurrentActionBarHeight()) - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - (SecretMediaViewer.this.seekbarContainer.getVisibility() == 0 ? SecretMediaViewer.this.seekbarContainer.getMeasuredHeight() : 0), 1073741824));
                }
                if (SecretMediaViewer.this.navigationBar != null) {
        ...
        C3702ActionBar c3702ActionBar = new C3702ActionBar(activity) { // from class: org.telegram.ui.SecretMediaViewer.5
            @Override // android.view.View
        ...
        this.actionBar.setTitleRightMargin(AndroidUtilities.m102dp(70));
        this.containerView.addView(this.actionBar, LayoutHelper.createFrame(-1, -2));
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.SecretMediaViewer.6
        ...
        this.secretHint.setPadding(AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(8));
        ...
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m102dp(64), 1711276032));
        ...
        this.playButton.setPivotX(AndroidUtilities.m102dp(32));
        this.playButton.setPivotY(AndroidUtilities.m102dp(32));
    ...
    private void setCurrentCaption(MessageObject messageObject, CharSequence charSequence, boolean z, boolean z2) {
        ...
        if (this.captionScrollView == null) {
            ...
            PhotoViewer.CaptionScrollView captionScrollView = new PhotoViewer.CaptionScrollView(this.containerView.getContext(), this.captionTextViewSwitcher, this.captionContainer) { // from class: org.telegram.ui.SecretMediaViewer.10
                ...
                protected void onScrollEnd() {
                    ...
                    AndroidUtilities.runOnUIThread(SecretMediaViewer.this.hideActionBarRunnable, C0479C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                }
            };
        ...
        if (z2 && (i = Build.VERSION.SDK_INT) >= 19) {
            ...
            TransitionSet duration = new TransitionSet().addTransition(new C684512(2, isEmpty2, isEmpty)).addTransition(new C684311(1, isEmpty2, isEmpty)).setDuration(200L);
            if (!isEmpty2) {
                this.captionScrollView.dontChangeTopMargin = true;
                duration.addTransition(new C684713());
            }
            if (isEmpty2 && !isEmpty) {
            ...
            if (!this.val$isCurrentCaptionEmpty && this.val$isCaptionEmpty && view == SecretMediaViewer.this.captionTextViewSwitcher) {
                ...
                ((ObjectAnimator) onDisappear).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.SecretMediaViewer$12$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        SecretMediaViewer.C684512.this.lambda$onDisappear$0(valueAnimator);
                    }
                });
            }
            return onDisappear;
    ...
    /* loaded from: classes5.dex */
    public class C684311 extends Fade {
        final /* synthetic */ boolean val$isCaptionEmpty;
        final /* synthetic */ boolean val$isCurrentCaptionEmpty;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C684311(int i, boolean z, boolean z2) {
            super(i);
            this.val$isCurrentCaptionEmpty = z;
            this.val$isCaptionEmpty = z2;
        }
        ...
        public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            if (this.val$isCurrentCaptionEmpty && !this.val$isCaptionEmpty && view == SecretMediaViewer.this.captionTextViewSwitcher) {
                ...
                ((ObjectAnimator) onAppear).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.SecretMediaViewer$11$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        SecretMediaViewer.C684311.this.lambda$onAppear$0(valueAnimator);
                    }
                });
            }
            return onAppear;
    ...
    /* loaded from: classes5.dex */
    public class C684713 extends Transition {
        C684713() {
        }
        ...
        public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.SecretMediaViewer$13$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    SecretMediaViewer.C684713.this.lambda$createAnimator$0(valueAnimator);
                }
            });
            return ofInt;
        }
    ...
    private void showSecretHint() {
        ...
        String string = LocaleController.getString(this.isVideo ? C3630R.string.VideoShownOnce : C3630R.string.PhotoShownOnce);
        ...
        int i = C3630R.raw.fire_on;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m102dp(34), AndroidUtilities.m102dp(34));
        ...
        if (document != null) {
            ...
            while (true) {
                ...
                if (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeVideo) {
                    ...
                    this.videoWidth = tLRPC$TL_documentAttributeVideo.f1611w;
                    this.videoHeight = tLRPC$TL_documentAttributeVideo.f1610h;
                    break;
                }
                i6++;
            }
            if (MessageObject.isGifDocument(document)) {
                this.actionBar.setTitle(LocaleController.getString("DisappearingGif", C3630R.string.DisappearingGif));
                ...
                this.actionBar.setTitle(LocaleController.getString("DisappearingVideo", C3630R.string.DisappearingVideo));
            ...
            f2 = 0.0f;
            c = 4;
            this.actionBar.setTitle(LocaleController.getString("DisappearingPhoto", C3630R.string.DisappearingPhoto));
            ...
            if (closestPhotoSizeWithSize != null) {
                this.videoWidth = closestPhotoSizeWithSize.f1632w;
                this.videoHeight = closestPhotoSizeWithSize.f1631h;
            }
        }
    ...
    private void toggleActionBar(boolean z, boolean z2) {
        ...
        if (z && this.isVideo) {
            AndroidUtilities.runOnUIThread(this.hideActionBarRunnable, C0479C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
        }
        if (z) {
    ...
    */
    public void onDraw(android.graphics.Canvas r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.SecretMediaViewer.onDraw(android.graphics.Canvas):void");
    }
    ...
    */
    public boolean closePhoto(boolean r19, boolean r20) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.SecretMediaViewer.closePhoto(boolean, boolean):boolean");
    }
    ...
    /* loaded from: classes5.dex */
    public class C685216 extends AnimatorListenerAdapter {
        final /* synthetic */ PhotoViewer.PlaceProviderObject val$object;

        C685216(PhotoViewer.PlaceProviderObject placeProviderObject) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$16$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SecretMediaViewer.C685216.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    */
    public boolean processTouchEvent(android.view.MotionEvent r13) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.SecretMediaViewer.processTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    private void checkMinMax(boolean r6) {
        ...
        L2b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.SecretMediaViewer.checkMinMax(boolean):void");
    }
    ...
    */
    public boolean onDoubleTap(android.view.MotionEvent r10) {
        ...
        L99:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.SecretMediaViewer.onDoubleTap(android.view.MotionEvent):boolean");
    }
    ...
    public class VideoPlayerControlFrameLayout extends FrameLayout {
        ...
        public /* synthetic */ void lambda$new$0(DynamicAnimation dynamicAnimation, float f, float f2) {
            SecretMediaViewer.this.seekbar.setSize((int) (((getMeasuredWidth() - AndroidUtilities.m102dp(16)) - f) - (this.parentWidth > this.parentHeight ? AndroidUtilities.m102dp(48) : 0)), getMeasuredHeight());
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (SecretMediaViewer.this.seekbar.onTouch(motionEvent.getAction(), motionEvent.getX() - AndroidUtilities.m102dp(2), motionEvent.getY())) {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            SecretMediaViewer.this.seekbar.setSize(((getMeasuredWidth() - AndroidUtilities.m102dp(16)) - ceil) - i3, getMeasuredHeight());
