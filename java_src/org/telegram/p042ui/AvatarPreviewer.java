...
public class AvatarPreviewer {
    ...
    public void show(ViewGroup viewGroup, Data data, Callback callback) {
        ...
        if (this.view != viewGroup) {
            ...
            this.layout = new Layout(context, callback) { // from class: org.telegram.ui.AvatarPreviewer.1
                @Override // org.telegram.p042ui.AvatarPreviewer.Layout
    ...
    public static final class MenuItem {
        ...
        static {
            MenuItem menuItem = new MenuItem("OPEN_PROFILE", 0, "OpenProfile", C3630R.string.OpenProfile, C3630R.C3632drawable.msg_openprofile);
            OPEN_PROFILE = menuItem;
            MenuItem menuItem2 = new MenuItem("OPEN_CHANNEL", 1, "OpenChannel2", C3630R.string.OpenChannel2, C3630R.C3632drawable.msg_channel);
            OPEN_CHANNEL = menuItem2;
            int i = C3630R.string.OpenGroup2;
            int i2 = C3630R.C3632drawable.msg_discussion;
            MenuItem menuItem3 = new MenuItem("OPEN_GROUP", 2, "OpenGroup2", i, i2);
            OPEN_GROUP = menuItem3;
            MenuItem menuItem4 = new MenuItem("SEND_MESSAGE", 3, "SendMessage", C3630R.string.SendMessage, i2);
            SEND_MESSAGE = menuItem4;
            MenuItem menuItem5 = new MenuItem("MENTION", 4, "Mention", C3630R.string.Mention, C3630R.C3632drawable.msg_mention);
            MENTION = menuItem5;
    ...
    public static class Data {
        ...
        /* renamed from: of */
        public static Data m66of(TLRPC$User tLRPC$User, int i, MenuItem... menuItemArr) {
        ...
        /* renamed from: of */
        public static Data m65of(TLRPC$UserFull tLRPC$UserFull, MenuItem... menuItemArr) {
        ...
        /* renamed from: of */
        public static Data m68of(TLRPC$Chat tLRPC$Chat, int i, MenuItem... menuItemArr) {
        ...
        /* renamed from: of */
        public static Data m67of(TLRPC$Chat tLRPC$Chat, TLRPC$ChatFull tLRPC$ChatFull, MenuItem... menuItemArr) {
            ImageLocation imageLocation;
            String str;
            ImageLocation forUserOrChat = ImageLocation.getForUserOrChat(tLRPC$Chat, 0);
            ImageLocation forUserOrChat2 = ImageLocation.getForUserOrChat(tLRPC$Chat, 1);
    ...
    public static class UserInfoLoadTask extends InfoLoadTask<TLRPC$User, TLRPC$UserFull> {
        ...
        @Override // org.telegram.p042ui.AvatarPreviewer.InfoLoadTask
        protected void load() {
        ...
        protected void onReceiveNotification(Object... objArr) {
            if (((Long) objArr[0]).longValue() == ((TLRPC$User) this.argument).f1762id) {
    ...
    public static class ChatInfoLoadTask extends InfoLoadTask<TLRPC$Chat, TLRPC$ChatFull> {
        ...
        @Override // org.telegram.p042ui.AvatarPreviewer.InfoLoadTask
        protected void load() {
            MessagesController.getInstance(UserConfig.selectedAccount).loadFullChat(((TLRPC$Chat) this.argument).f1600id, this.classGuid, false);
        }

        @Override // org.telegram.p042ui.AvatarPreviewer.InfoLoadTask
        protected void onReceiveNotification(Object... objArr) {
            TLRPC$ChatFull tLRPC$ChatFull = (TLRPC$ChatFull) objArr[0];
            if (tLRPC$ChatFull == null || tLRPC$ChatFull.f1601id != ((TLRPC$Chat) this.argument).f1600id) {
                return;
            }
    ...
    public static abstract class Layout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public Layout(Context context, Callback callback) {
            super(context);
            this.radialProgressSize = AndroidUtilities.m103dp(64.0f);
            new Rect();
            ...
            this.arrowDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.preview_arrow);
        }
                ...
                if (this.moveAnimator == null) {
                    if (motionEvent.getActionMasked() == 1) {
                        ...
                        if (this.downY < BitmapDescriptorFactory.HUE_RED) {
                            ...
                            float max = Math.max(-1.0f, Math.min((float) BitmapDescriptorFactory.HUE_RED, (motionEvent.getY() - this.downY) / AndroidUtilities.m102dp(56)));
        ...
        public void invalidateSize() {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                int stableInsetLeft = this.insets.getStableInsetLeft() + m102dp;
                i2 = this.insets.getStableInsetRight() + m102dp;
                i = m102dp + Math.max(this.insets.getStableInsetTop(), this.insets.getStableInsetBottom());
                m102dp = stableInsetLeft;
            } else {
                i = m102dp;
                i2 = i;
            }
            ...
            int i3 = width - (i2 + m102dp);
            int i4 = height - (i * 2);
            int min = Math.min(i3, i4);
            int i5 = intrinsicHeight / 2;
            int i6 = m102dp2 + i5;
            int i7 = ((i3 - min) / 2) + m102dp;
        ...
        */
        protected void onDraw(android.graphics.Canvas r10) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.AvatarPreviewer.Layout.onDraw(android.graphics.Canvas):void");
        }
        ...
        public /* synthetic */ void lambda$setData$5(Data data, Object obj) {
            ...
            if (obj instanceof TLRPC$UserFull) {
                setData(Data.m65of((TLRPC$UserFull) obj, data.menuItems));
            } else if (obj instanceof TLRPC$ChatFull) {
                setData(Data.m67of((TLRPC$Chat) data.infoLoadTask.argument, (TLRPC$ChatFull) obj, data.menuItems));
            }
        }
