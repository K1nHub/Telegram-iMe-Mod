...
import org.telegram.p042ui.Cells.RadioButtonCell;
import org.telegram.p042ui.Cells.ShadowSectionCell;
import org.telegram.p042ui.Cells.TextBlockCell;
...
public class ChannelCreateActivity extends JavaMvpFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public static ChannelCreateActivity newInstanceInAlbumMode(final Callbacks$Callback1<Long> callbacks$Callback1) {
        ...
        channelCreateActivity.albumModeDelegate = new AlbumModeDelegate() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda28
            @Override // org.telegram.p042ui.ChannelCreateActivity.AlbumModeDelegate
    ...
    public void showDoneCancelDialog() {
        ...
        builder.setTitle(LocaleController.getString("StopLoadingTitle", C3630R.string.StopLoadingTitle));
        builder.setMessage(LocaleController.getString("StopLoading", C3630R.string.StopLoading));
        builder.setPositiveButton(LocaleController.getString("WaitMore", C3630R.string.WaitMore), null);
        builder.setNegativeButton(LocaleController.getString("Stop", C3630R.string.Stop), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda1
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C41401());
        ...
        if (i4 == 0) {
            if (this.albumMode) {
                this.actionBar.setTitle(LocaleController.getInternalString(C3630R.string.cloud_albums_intro_button));
            } else {
                this.actionBar.setTitle(LocaleController.getString("NewChannel", C3630R.string.NewChannel));
            }
                            ...
                            if (ChannelCreateActivity.this.nameTextView != null && ChannelCreateActivity.this.nameTextView.isPopupView(childAt)) {
                                if (AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) {
                                    if (AndroidUtilities.isTablet()) {
                                        childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m102dp(AndroidUtilities.isTablet() ? 200 : 320), (paddingTop - AndroidUtilities.statusBarHeight) + getPaddingTop()), 1073741824));
                                    } else {
                ...
                */
                public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                    /*
                        ...
                        if (r1 != 0) goto L26
                        org.telegram.ui.ChannelCreateActivity r1 = org.telegram.p042ui.ChannelCreateActivity.this
                        org.telegram.ui.Components.EditTextEmoji r1 = org.telegram.p042ui.ChannelCreateActivity.access$300(r1)
                    ...
                    L97:
                        int r4 = r7 - r4
                    L99:
                        org.telegram.ui.ChannelCreateActivity r7 = org.telegram.p042ui.ChannelCreateActivity.this
                        org.telegram.ui.Components.EditTextEmoji r7 = org.telegram.p042ui.ChannelCreateActivity.access$300(r7)
                        if (r7 == 0) goto Lc6
                        org.telegram.ui.ChannelCreateActivity r7 = org.telegram.p042ui.ChannelCreateActivity.this
                        org.telegram.ui.Components.EditTextEmoji r7 = org.telegram.p042ui.ChannelCreateActivity.access$300(r7)
                    ...
                    Lcf:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChannelCreateActivity.C41422.onLayout(boolean, int, int, int, int):void");
                }
            ...
            sizeNotifierFrameLayout.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda8
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    lambda$createView$7 = ChannelCreateActivity.lambda$createView$7(view, motionEvent);
            ...
            backupImageView.setRoundRadius(AndroidUtilities.m102dp(32));
            ...
            view.setContentDescription(LocaleController.getString("ChatSetPhotoOrVideo", C3630R.string.ChatSetPhotoOrVideo));
            ...
            int i6 = C3630R.raw.camera;
            this.cameraDrawable = new RLottieDrawable(i6, "" + i6, AndroidUtilities.m102dp(60), AndroidUtilities.m102dp(60), false, null);
            ...
            this.avatarEditor.setPadding(AndroidUtilities.m102dp(0), 0, 0, AndroidUtilities.m102dp(1));
            ...
            radialProgressView.setSize(AndroidUtilities.m102dp(30));
            ...
            if (this.albumMode) {
                editTextEmoji2.setHint(LocaleController.getInternalString(C3630R.string.cloud_albums_name_hint));
            } else {
                editTextEmoji2.setHint(LocaleController.getString("EnterChannelName", C3630R.string.EnterChannelName));
            }
            ...
            this.nameTextView.getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda9
                ...
                public final boolean onEditorAction(TextView textView, int i7, KeyEvent keyEvent) {
                    ...
                    lambda$createView$11 = ChannelCreateActivity.this.lambda$createView$11(textView, i7, keyEvent);
            ...
            this.descriptionTextView.setPadding(0, 0, 0, AndroidUtilities.m102dp(6));
            ...
            this.descriptionTextView.setHint(LocaleController.getString("DescriptionPlaceholder", C3630R.string.DescriptionPlaceholder));
            this.descriptionTextView.setCursorColor(Theme.getColor(i7));
            this.descriptionTextView.setCursorSize(AndroidUtilities.m102dp(20));
            ...
            this.descriptionTextView.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda10
                ...
                public final boolean onEditorAction(TextView textView, int i8, KeyEvent keyEvent) {
                    ...
                    lambda$createView$12 = ChannelCreateActivity.this.lambda$createView$12(textView, i8, keyEvent);
            ...
            this.helpTextView.setText(LocaleController.getString("DescriptionInfo", C3630R.string.DescriptionInfo));
            ...
            if (z6) {
                i = C3630R.string.GroupSettingsTitle;
                str = "GroupSettingsTitle";
            } else {
                i = C3630R.string.ChannelSettingsTitle;
            ...
            if (this.isGroup) {
                i2 = C3630R.string.GroupTypeHeader;
                str2 = "GroupTypeHeader";
            } else {
                i2 = C3630R.string.ChannelTypeHeader;
            ...
            if (this.isGroup) {
                this.radioButtonCell1.setTextAndValue(LocaleController.getString("MegaPublic", C3630R.string.MegaPublic), LocaleController.getString("MegaPublicInfo", C3630R.string.MegaPublicInfo), false, !this.isPrivate);
            } else {
                this.radioButtonCell1.setTextAndValue(LocaleController.getString("ChannelPublic", C3630R.string.ChannelPublic), LocaleController.getString("ChannelPublicInfo", C3630R.string.ChannelPublicInfo), false, !this.isPrivate);
            }
            this.radioButtonCell1.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda6
                ...
                public final void onClick(View view4) {
                    ChannelCreateActivity.this.lambda$createView$13(view4);
                }
            });
            ...
            if (this.isGroup) {
                this.radioButtonCell2.setTextAndValue(LocaleController.getString("MegaPrivate", C3630R.string.MegaPrivate), LocaleController.getString("MegaPrivateInfo", C3630R.string.MegaPrivateInfo), false, this.isPrivate);
            } else {
                this.radioButtonCell2.setTextAndValue(LocaleController.getString("ChannelPrivate", C3630R.string.ChannelPrivate), LocaleController.getString("ChannelPrivateInfo", C3630R.string.ChannelPrivateInfo), false, this.isPrivate);
            }
            this.radioButtonCell2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
                    ChannelCreateActivity.this.lambda$createView$14(view4);
                }
            });
            ...
            this.descriptionTextView.setImeOptions(6);
            this.descriptionTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C3630R.string.ChannelUsernamePlaceholder));
            ...
            this.checkTextView.setPadding(AndroidUtilities.m102dp(3), 0, AndroidUtilities.m102dp(3), 0);
            ...
            int i12 = C3630R.C3632drawable.greydivider_bottom;
    ...
    /* loaded from: classes5.dex */
    public class C41401 extends C3702ActionBar.ActionBarMenuOnItemClick {
        C41401() {
        }
                            ...
                            if (ChannelCreateActivity.this.descriptionTextView.length() != 0) {
                                if (ChannelCreateActivity.this.lastNameAvailable) {
                                    ...
                                    messagesController.updateChannelUserName(channelCreateActivity, channelCreateActivity.chatId, ChannelCreateActivity.this.lastCheckName, new Runnable() { // from class: org.telegram.ui.ChannelCreateActivity$1$$ExternalSyntheticLambda0
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            ChannelCreateActivity.C41401.this.lambda$onItemClick$0();
                                        }
                                    }, new Runnable() { // from class: org.telegram.ui.ChannelCreateActivity$1$$ExternalSyntheticLambda1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            ChannelCreateActivity.C41401.this.lambda$onItemClick$1();
                                        }
                                    });
                                } else {
                                ...
                                builder.setTitle(LocaleController.getString("ChannelPublicEmptyUsernameTitle", C3630R.string.ChannelPublicEmptyUsernameTitle));
                                builder.setMessage(LocaleController.getString("ChannelPublicEmptyUsername", C3630R.string.ChannelPublicEmptyUsername));
                                builder.setPositiveButton(LocaleController.getString("Close", C3630R.string.Close), null);
    ...
    private void updatePrivatePublic() {
        ...
        if (!this.isPrivate && !this.canCreatePublic) {
            this.typeInfoCell.setText(LocaleController.getString("ChangePublicLimitReached", C3630R.string.ChangePublicLimitReached));
            ...
            if (this.loadingAdminedChannels) {
                ...
                textInfoPrivacyCell2.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell2.getContext(), C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                this.adminedInfoCell.setVisibility(8);
            } else {
                TextInfoPrivacyCell textInfoPrivacyCell3 = this.typeInfoCell;
                textInfoPrivacyCell3.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell3.getContext(), C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            ...
            textInfoPrivacyCell5.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell5.getContext(), C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            this.linkContainer.setVisibility(0);
            this.loadingAdminedCell.setVisibility(8);
            if (this.isGroup) {
                TextInfoPrivacyCell textInfoPrivacyCell6 = this.typeInfoCell;
                if (this.isPrivate) {
                    i2 = C3630R.string.MegaPrivateLinkHelp;
                    str2 = "MegaPrivateLinkHelp";
                } else {
                    i2 = C3630R.string.MegaUsernameHelp;
                    str2 = "MegaUsernameHelp";
                }
                textInfoPrivacyCell6.setText(LocaleController.getString(str2, i2));
                this.headerCell.setText(this.isPrivate ? LocaleController.getString("ChannelInviteLinkTitle", C3630R.string.ChannelInviteLinkTitle) : LocaleController.getString("ChannelLinkTitle", C3630R.string.ChannelLinkTitle));
            } else {
                TextInfoPrivacyCell textInfoPrivacyCell7 = this.typeInfoCell;
                if (this.isPrivate) {
                    i = C3630R.string.ChannelPrivateLinkHelp;
                    str = "ChannelPrivateLinkHelp";
                } else {
                    i = C3630R.string.ChannelUsernameHelp;
            ...
            this.linkContainer.setPadding(0, 0, 0, this.isPrivate ? 0 : AndroidUtilities.m102dp(7));
            LinkActionView linkActionView = this.permanentLinkView;
            TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported = this.invite;
            linkActionView.setLink(tLRPC$TL_chatInviteExported != null ? tLRPC$TL_chatInviteExported.link : null);
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$21(View view) {
        ...
        if (currentChannel.megagroup) {
            int i = C3630R.string.RevokeLinkAlert;
            ...
            int i2 = C3630R.string.RevokeLinkAlertChannel;
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3630R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public boolean checkUserName(final String str) {
        ...
        if (str != null) {
            if (str.startsWith("_") || str.endsWith("_")) {
                this.checkTextView.setText(LocaleController.getString("LinkInvalid", C3630R.string.LinkInvalid));
                TextView textView = this.checkTextView;
            ...
            for (int i2 = 0; i2 < str.length(); i2++) {
                ...
                if (i2 == 0 && charAt >= '0' && charAt <= '9') {
                    this.checkTextView.setText(LocaleController.getString("LinkInvalidStartNumber", C3630R.string.LinkInvalidStartNumber));
        ...
        if (str == null || str.length() < 4) {
            this.checkTextView.setText(LocaleController.getString("LinkInvalidShort", C3630R.string.LinkInvalidShort));
            ...
            this.checkTextView.setText(LocaleController.getString("LinkInvalidLong", C3630R.string.LinkInvalidLong));
            ...
            this.checkTextView.setText(LocaleController.getString("LinkChecking", C3630R.string.LinkChecking));
    ...
    public /* synthetic */ void lambda$checkUserName$24(String str, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, TLRPC$TL_channels_checkUsername tLRPC$TL_channels_checkUsername) {
        ...
        if (tLRPC$TL_error == null && (tLObject instanceof TLRPC$TL_boolTrue)) {
            this.checkTextView.setText(LocaleController.formatString("LinkAvailable", C3630R.string.LinkAvailable, str));
            TextView textView = this.checkTextView;
        ...
        if (tLRPC$TL_error != null && "USERNAME_INVALID".equals(tLRPC$TL_error.text) && tLRPC$TL_channels_checkUsername.username.length() == 4) {
            this.checkTextView.setText(LocaleController.getString("UsernameInvalidShort", C3630R.string.UsernameInvalidShort));
            ...
            if (tLRPC$TL_channels_checkUsername.username.length() == 4) {
                this.checkTextView.setText(LocaleController.getString("UsernameInvalidShortPurchase", C3630R.string.UsernameInvalidShortPurchase));
            } else {
                this.checkTextView.setText(LocaleController.getString("UsernameInUsePurchase", C3630R.string.UsernameInUsePurchase));
            }
            ...
            this.checkTextView.setTextColor(Theme.getColor(Theme.key_text_RedRegular));
            this.checkTextView.setText(LocaleController.getString("LinkInUse", C3630R.string.LinkInUse));
        }
        this.lastNameAvailable = false;
    }
