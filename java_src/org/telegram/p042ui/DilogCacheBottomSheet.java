...
public class DilogCacheBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    @Override // org.telegram.p042ui.Components.BottomSheetWithRecyclerListView, org.telegram.p042ui.ActionBar.BottomSheet
    ...
    protected CharSequence getTitle() {
        if (this.isArchive) {
            return LocaleController.getString("ArchivedChats", C3630R.string.ArchivedChats);
        }
        ...
        return new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.DilogCacheBottomSheet.1
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                if (i == 0) {
                    ...
                    CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(viewGroup.getContext(), C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    ...
    public DilogCacheBottomSheet(BaseFragment baseFragment, CacheControlActivity.DialogFileEntities dialogFileEntities, final CacheModel cacheModel, final Delegate delegate, boolean z, boolean z2) {
        ...
        StorageDiagramView storageDiagramView = new StorageDiagramView(this, getContext(), dialogFileEntities.dialogId, z2) { // from class: org.telegram.ui.DilogCacheBottomSheet.2
            ...
            @Override // org.telegram.p042ui.Components.StorageDiagramView
        ...
        for (int i4 = 8; i3 < i4; i4 = 8) {
            if (i3 == 0) {
                string = LocaleController.getString("LocalPhotoCache", C3630R.string.LocalPhotoCache);
                i = Theme.key_statisticChartLine_lightblue;
            } else if (i3 == i2) {
                string = LocaleController.getString("LocalVideoCache", C3630R.string.LocalVideoCache);
                i = Theme.key_statisticChartLine_blue;
            } else if (i3 == 2) {
                string = LocaleController.getString("LocalDocumentCache", C3630R.string.LocalDocumentCache);
                i = Theme.key_statisticChartLine_green;
            } else if (i3 == 3) {
                string = LocaleController.getString("LocalMusicCache", C3630R.string.LocalMusicCache);
                i = Theme.key_statisticChartLine_red;
            } else if (i3 == 4) {
                string = LocaleController.getString("LocalAudioCache", C3630R.string.LocalAudioCache);
                i = Theme.key_statisticChartLine_lightgreen;
            } else if (i3 == 5) {
                string = LocaleController.getString("LocalStickersCache", C3630R.string.LocalStickersCache);
                i = Theme.key_statisticChartLine_orange;
            } else if (i3 == 7) {
                string = LocaleController.getString("LocalStoriesCache", C3630R.string.LocalStoriesCache);
                i = Theme.key_statisticChartLine_indigo;
            } else {
                string = LocaleController.getString("LocalMiscellaneousCache", C3630R.string.LocalMiscellaneousCache);
        ...
        CachedMediaLayout cachedMediaLayout = new CachedMediaLayout(getContext(), baseFragment) { // from class: org.telegram.ui.DilogCacheBottomSheet.3
            ...
            public void onMeasure(int i5, int i6) {
                super.onMeasure(i5, View.MeasureSpec.makeMeasureSpec((((BottomSheetWithRecyclerListView) DilogCacheBottomSheet.this).contentHeight - C3702ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.statusBarHeight, 1073741824));
            }
        };
        this.cachedMediaLayout = cachedMediaLayout;
        cachedMediaLayout.setBottomPadding(AndroidUtilities.m102dp(80));
    ...
    public /* synthetic */ void lambda$createButton$3(View view) {
        ...
        builder.setMessage(LocaleController.getString("ClearCacheForChat", C3630R.string.ClearCacheForChat));
        builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DilogCacheBottomSheet$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DilogCacheBottomSheet.this.lambda$createButton$1(dialogInterface, i);
            }
        });
        builder.setPositiveButton(LocaleController.getString("Clear", C3630R.string.Clear), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DilogCacheBottomSheet$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
