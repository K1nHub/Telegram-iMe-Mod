...
import org.telegram.p042ui.Components.ListView.AdapterWithDiffUtils;
...
import org.telegram.p042ui.Components.ProgressButton;
...
import org.telegram.p042ui.FiltersSetupActivity;
...
public class FiltersSetupActivity extends JavaMvpFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void showWidthModeDialog() {
        ...
        String internalString = LocaleController.getInternalString(C3630R.string.folder_tabs_width_mode_item_title);
    ...
    private void showNotificationModeDialog() {
        ...
        String internalString = LocaleController.getInternalString(C3630R.string.folder_tabs_notification_mode_item_title);
    ...
    public class TextCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            AndroidUtilities.m102dp(48);
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m102dp(94), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(20), 1073741824));
            this.imageView.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(50), 1073741824));
            setMeasuredDimension(size, AndroidUtilities.m102dp(50));
        }
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (LocaleController.isRTL) {
                m102dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m102dp(this.imageView.getVisibility() != 0 ? 23 : 64);
            } else {
                m102dp = AndroidUtilities.m102dp(this.imageView.getVisibility() != 0 ? 23 : 64);
            }
            ...
            int m102dp2 = (!LocaleController.isRTL ? AndroidUtilities.m102dp(20) : (i5 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m102dp(20)) + AndroidUtilities.m102dp(LocaleController.isRTL ? 2 : -2);
            ImageView imageView = this.imageView;
            imageView.layout(m102dp2, 0, imageView.getMeasuredWidth() + m102dp2, this.imageView.getMeasuredHeight());
        }
    ...
    public static class SuggestedFilterCell extends FrameLayout {
        ...
        public SuggestedFilterCell(Context context) {
            ...
            progressButton.setText(LocaleController.getString("Add", C3630R.string.Add));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m102dp(64));
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(FiltersSetupActivity filtersSetupActivity, Context context, int i, CharSequence charSequence) {
            ...
            if (filtersSetupActivity.isTopicType()) {
                this.imageView.setAnimation(C3630R.raw.fork_topics, 110, 110);
            } else {
    ...
    public class FilterCell extends FrameLayout {
        ...
        public void setTopic(TopicModel topicModel, boolean z) {
            ...
            if (topicModel.isUserTopic()) {
                ...
                this.textView.setText(Emoji.replaceEmoji(topicModel.getName(), this.textView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false));
            ...
            if (this.iconView.getVisibility() == 0) {
                this.textView.setPadding(AndroidUtilities.m102dp(FilterActivityType.TOPIC.getIconSize()), 0, 0, 0);
            } else {
                this.textView.setPadding(0, 0, 0, 0);
            }
            if (topicModel.isHidden()) {
                this.hiddenTextView.setText(LocaleController.getInternalString(C3630R.string.common_hidden).toUpperCase());
        ...
        public FilterCell(Context context) {
            ...
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            imageView.setImageResource(C3630R.C3632drawable.list_reorder);
            ...
            imageView.setContentDescription(LocaleController.getString("FilterReorder", C3630R.string.FilterReorder));
            ...
            Drawable drawable = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.other_lockedfolders2);
            ...
            loadingDrawable.strokePaint.setStrokeWidth(m102dp);
            loadingDrawable.setRadiiDp(40.0f);
            ImageView imageView2 = new ImageView(context, FiltersSetupActivity.this, m102dp) { // from class: org.telegram.ui.FiltersSetupActivity.FilterCell.1
                final /* synthetic */ int val$stroke;

                {
                    this.val$stroke = m102dp;
                }
            ...
            imageView2.setContentDescription(LocaleController.getString("FilterShare", C3630R.string.FilterShare));
            imageView2.setVisibility(8);
            imageView2.setImageResource(C3630R.C3632drawable.msg_link_folder);
            imageView2.setColorFilter(new PorterDuffColorFilter(Theme.getColor(i), PorterDuff.Mode.MULTIPLY));
            ...
            imageView3.setImageResource(C3630R.C3632drawable.msg_actions);
            imageView3.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3630R.string.AccDescrMoreOptions));
        ...
        */
        public void setFilter(org.telegram.messenger.MessagesController.DialogFilter r10, boolean r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.FiltersSetupActivity.FilterCell.setFilter(org.telegram.messenger.MessagesController$DialogFilter, boolean):void");
        }
        ...
        protected void onDraw(Canvas canvas) {
            if (this.needDivider) {
                canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m102dp(62), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m102dp(62) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
    ...
    public void updateRows(boolean z) {
        ...
        this.items.add(ItemInner.asHeader(LocaleController.getString("Settings", C3630R.string.Settings)));
        if (this.type == FilterActivityType.FILTER) {
            ...
            this.items.add(ItemInner.asHeader(LocaleController.getInternalString(C3630R.string.topics_catalog)));
            this.items.add(new ItemInner(IdFabric$ViewTypes.TOPICS_SETTINGS_CATALOG_UPDATE));
        }
        this.items.add(ItemInner.asShadow(null));
        int i = 0;
        if (!arrayList.isEmpty() && dialogFilters.size() < 10) {
            this.items.add(ItemInner.asHeader(LocaleController.getString("FilterRecommended", C3630R.string.FilterRecommended)));
        ...
        if ((!dialogFilters.isEmpty() && ((dialogFilters.size() > 1 || !dialogFilters.get(0).isDefault()) && this.type == FilterActivityType.FILTER)) || (isTopicType() && !this.topics.isEmpty())) {
            ...
            this.items.add(ItemInner.asHeader(isTopicType() ? LocaleController.getInternalString(C3630R.string.topics) : LocaleController.getString("Filters", C3630R.string.Filters)));
            if (isTopicType()) {
                this.items.add(ItemInner.asButton(LocaleController.getInternalString(C3630R.string.topics_create_new)));
            }
        ...
        if (this.type == FilterActivityType.FILTER && dialogFilters.size() < getMessagesController().dialogFiltersLimitPremium) {
            this.items.add(ItemInner.asButton(LocaleController.getString("CreateNewFilter", C3630R.string.CreateNewFilter)));
        }
        this.items.add(ItemInner.asShadow(null));
    ...
    public void onFragmentDestroy() {
        ...
        if (this.orderChanged) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                tLRPC$TL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(dialogFilters.get(i2).f1537id));
            }
    ...
    public View createView(final Context context) {
        ...
        if (isTopicType()) {
            this.actionBar.setTitle(LocaleController.getInternalString(C3630R.string.topics));
        } else {
            this.actionBar.setTitle(LocaleController.getString("Filters", C3630R.string.Filters));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.FiltersSetupActivity.1
        ...
        this.listView = new C60632(context);
    ...
    /* loaded from: classes5.dex */
    public class C60632 extends RecyclerListView {
        C60632(Context context) {
            super(context);
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        FiltersSetupActivity.C60632.this.lambda$onTouchEvent$0();
                    }
                }, 250L);
            }
    ...
    public /* synthetic */ void lambda$createView$4(Context context, View view, int i, float f, float f2) {
        ...
        if (i2 == IdFabric$ViewTypes.FILTERS_SETTINGS_PANEL_AT_BOTTOM) {
            ...
            showHintDialog(LocaleController.getInternalString(C3630R.string.folder_tabs_remember_last_filter_tab_hint));
    ...
    public /* synthetic */ void lambda$createView$3(Boolean bool) {
        ...
        BulletinFactory.m61of(this).createSimpleBulletin(C3630R.raw.info, LocaleController.getInternalString(bool.booleanValue() ? C3630R.string.topics_catalog_updated : C3630R.string.topics_catalog_update_not_found)).show();
    }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof ItemInner) {
                ...
                if (this.viewType == 2) {
                    ...
                    if (dialogFilter != null && dialogFilter.f1537id != dialogFilter2.f1537id) {
                        return false;
                    }
                }
                if (this.viewType == 5) {
                    ...
                    if (tLRPC$TL_dialogFilterSuggested != null && tLRPC$TL_dialogFilterSuggested.filter.f1607id != tLRPC$TL_dialogFilterSuggested2.filter.f1607id) {
                        return false;
                    }
                }
                return true;
    ...
    public class ListAdapter extends AdapterWithDiffUtils {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == IdFabric$ViewTypes.TOPICS_SETTINGS_PANEL || i == IdFabric$ViewTypes.TOPICS_SETTINGS_PANEL_AT_BOTTOM || i == IdFabric$ViewTypes.FILTERS_SETTINGS_PANEL_AT_BOTTOM || i == IdFabric$ViewTypes.FILTERS_SETTINGS_REMEMBER_LAST_TAB || i == IdFabric$ViewTypes.FILTERS_SETTINGS_HIDE_FOLDERS || i == IdFabric$ViewTypes.FILTERS_SETTINGS_FOLDERS_FIRST) {
                ...
                View textCell = new org.telegram.p042ui.Cells.TextCell(this.mContext);
                ...
                View hintInnerCell = new HintInnerCell(filtersSetupActivity, this.mContext, C3630R.raw.filters, filtersSetupActivity.isTopicType() ? LocaleController.getInternalString(C3630R.string.topic_new_info) : AndroidUtilities.replaceTags(LocaleController.formatString("CreateNewFilterInfo", C3630R.string.CreateNewFilterInfo, new Object[0])));
                hintInnerCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3630R.C3632drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$8(FilterCell filterCell, View view) {
            ...
            makeOptions.add(C3630R.C3632drawable.msg_edit, FiltersSetupActivity.this.isTopicType() ? LocaleController.getInternalString(C3630R.string.topic_edit) : LocaleController.getString("FilterEditItem", C3630R.string.FilterEditItem), new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    FiltersSetupActivity.ListAdapter.this.lambda$onCreateViewHolder$1(currentTopic, currentFilter);
                }
            });
            final boolean isHidden = FiltersSetupActivity.this.isTopicType() ? currentTopic.isHidden() : FiltersSetupActivity.this.getFiltersController().getSettings(currentFilter.f1537id).isHidden();
            makeOptions.add(isHidden ? C3630R.C3632drawable.msg_stories_views : C3630R.C3632drawable.msg_stories_stealth, isHidden ? LocaleController.getInternalString(C3630R.string.hidden_chats_unhide_chats) : LocaleController.getString("HideOnTop", C3630R.string.HideOnTop), new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    FiltersSetupActivity.ListAdapter.this.lambda$onCreateViewHolder$2(currentTopic, isHidden, currentFilter);
                }
            });
            makeOptions.add(C3630R.C3632drawable.msg_delete, (CharSequence) (FiltersSetupActivity.this.isTopicType() ? LocaleController.getInternalString(C3630R.string.topics_remove) : LocaleController.getString("FilterDeleteItem", C3630R.string.FilterDeleteItem)), true, new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$2(TopicModel topicModel, boolean z, MessagesController.DialogFilter dialogFilter) {
            if (FiltersSetupActivity.this.isTopicType()) {
                ...
                FiltersSetupActivity.this.getFiltersController().setHidden(dialogFilter.f1537id, !z);
            }
            FiltersSetupActivity.this.updateRows(true);
        }
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$7(final MessagesController.DialogFilter dialogFilter, final TopicModel topicModel, final boolean z) {
            if (dialogFilter != null && dialogFilter.isChatlist()) {
                FolderBottomSheet.showForDeletion(FiltersSetupActivity.this, dialogFilter.f1537id, new Utilities.Callback() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda9
            ...
            builder.setTitle(FiltersSetupActivity.this.isTopicType() ? LocaleController.getInternalString(C3630R.string.topics_remove) : LocaleController.getString("FilterDelete", C3630R.string.FilterDelete));
            builder.setMessage(FiltersSetupActivity.this.isTopicType() ? LocaleController.getInternalString(C3630R.string.topics_remove_alert) : LocaleController.getString("FilterDeleteAlert", C3630R.string.FilterDeleteAlert));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString("Delete", C3630R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$6(TopicModel topicModel, boolean z, final MessagesController.DialogFilter dialogFilter, DialogInterface dialogInterface, int i) {
            ...
            if (z) {
                FiltersSetupActivity.this.getFiltersController().setHidden(dialogFilter.f1537id, false);
            }
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$10(SuggestedFilterCell suggestedFilterCell, View view) {
            ...
            dialogFilter.f1537id = 2;
            while (FiltersSetupActivity.this.getMessagesController().dialogFiltersById.get(dialogFilter.f1537id) != null) {
                dialogFilter.f1537id++;
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (i3 == i4 || i3 == IdFabric$ViewTypes.FILTERS_SETTINGS_SORTING) {
                org.telegram.p042ui.Cells.TextCell textCell = (org.telegram.p042ui.Cells.TextCell) viewHolder.itemView;
                if (i3 == i4) {
                    textCell.setText(LocaleController.getInternalString(C3630R.string.topics_catalog_update_manually), z);
                    return;
                } else {
                    textCell.setText(LocaleController.getInternalString(C3630R.string.folder_tabs_sorting_settings), z);
                    return;
                }
            }
            ...
            if (i3 == i5 || i3 == IdFabric$ViewTypes.TOPICS_SETTINGS_PANEL_AT_BOTTOM || i3 == IdFabric$ViewTypes.FILTERS_SETTINGS_PANEL_AT_BOTTOM || i3 == IdFabric$ViewTypes.FILTERS_SETTINGS_REMEMBER_LAST_TAB || i3 == IdFabric$ViewTypes.FILTERS_SETTINGS_HIDE_FOLDERS || i3 == IdFabric$ViewTypes.FILTERS_SETTINGS_FOLDERS_FIRST) {
                ...
                if (i7 == i5) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3630R.string.topics_settings_enable), FiltersSetupActivity.this.newTopicsBarEnabled, z);
                    return;
                } else if (i7 == IdFabric$ViewTypes.TOPICS_SETTINGS_PANEL_AT_BOTTOM) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3630R.string.topics_settings_topics_bar_at_bottom), FiltersSetupActivity.this.newTopicsBarAtBottom, z);
                    return;
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3630R.string.folder_tabs_at_bottom_enable_item_title), SharedConfig.isFilterTabsAtBottomEnabled, z);
                    return;
                } else if (i7 == i6) {
                    textCheckCell.setEnabled(FiltersSetupActivity.this.getTotalTabsCount() > 0, null);
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3630R.string.folder_tabs_remember_last_filter_tab_item_title), SharedConfig.isRememberLastFilterTabEnabled, z);
                    return;
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3630R.string.folder_tabs_settings_hide_folders), FiltersSetupActivity.this.getFiltersController().isFoldersHidden(), z);
                    return;
                } else {
                    textCheckCell.setEnabled(FiltersSetupActivity.this.getSortingTabsCount() > 0, null);
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3630R.string.folder_tabs_settings_folders_first), FiltersSetupActivity.this.getFiltersController().isFoldersFirstEnabled(), z);
                    return;
                }
            }
            ...
            if (i3 == i8 || i3 == IdFabric$ViewTypes.FILTERS_SETTINGS_ALL_CHATS_TAB || i3 == IdFabric$ViewTypes.FILTERS_SETTINGS_WIDTH_MODE) {
                ...
                if (i9 == i8) {
                    textSettingsCell.setTextAndValue(LocaleController.getInternalString(C3630R.string.folder_tabs_notification_mode_item_title), LocaleController.getInternalString(SharedConfig.selectedFilterTabsNotificationMode.getTitleResId()), z);
                    ...
                    if (!r1 || FiltersSetupActivity.this.getFiltersController().isAllChatsTabEnabled()) {
                        internalString = LocaleController.getInternalString(C3630R.string.common_on);
                    } else {
                        internalString = LocaleController.getInternalString(C3630R.string.common_off);
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getInternalString(C3630R.string.folder_tabs_all_chats_tab_settings_item_title), internalString, z);
                    textSettingsCell.setEnabled(r1, null);
                    return;
                } else {
                    textSettingsCell.setTextAndValue(LocaleController.getInternalString(C3630R.string.folder_tabs_width_mode_item_title), LocaleController.getInternalString(SharedConfig.selectedFilterTabWidthMode.getTitleResId()), z);
                    textSettingsCell.setEnabled(FiltersSetupActivity.this.getTotalTabsCount() > 0, null);
                    return;
                }
            }
            ...
            if (itemViewType == 0) {
                ...
                viewHolder.itemView.setBackground(Theme.getThemedDrawableByKey(this.mContext, z ? C3630R.C3632drawable.greydivider : C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                ...
                Drawable drawable = this.mContext.getResources().getDrawable(C3630R.C3632drawable.poll_add_circle);
                Drawable drawable2 = this.mContext.getResources().getDrawable(C3630R.C3632drawable.poll_add_plus);
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(this.listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{TextCheckCell.class, TextSettingsCell.class, org.telegram.p042ui.Cells.TextCell.class, NotificationsCheckCell.class}, null, null, null, i));
        ...
        arrayList.add(new ThemeDescription(this.listView, 0, new Class[]{org.telegram.p042ui.Cells.TextCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, i2));
        ...
        arrayList.add(new ThemeDescription(c3702ActionBar, i6, null, null, null, null, i7));
