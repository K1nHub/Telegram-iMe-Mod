...
public class ChannelBoostLayout extends FrameLayout {
        ...
        this.adapter = new AdapterWithDiffUtils() { // from class: org.telegram.ui.ChannelBoostLayout.1
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                switch (i) {
                    ...
                    case 3:
                        ...
                        linkActionView.setPadding(AndroidUtilities.m102dp(11), 0, AndroidUtilities.m102dp(11), AndroidUtilities.m102dp(24));
                        manageChatTextCell = linkActionView;
                        break;
                    case 4:
                        LimitPreviewView limitPreviewView = new LimitPreviewView(ChannelBoostLayout.this.getContext(), C3630R.C3632drawable.filled_limit_boost, 10, 0, ChannelBoostLayout.this.resourcesProvider);
                        limitPreviewView.isStatistic = true;
                        CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawable(ChannelBoostLayout.this.getContext(), C3630R.C3632drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, ChannelBoostLayout.this.resourcesProvider)), 0, 0);
                        combinedDrawable.setFullsize(true);
                        limitPreviewView.setPadding(0, AndroidUtilities.m102dp(20), 0, AndroidUtilities.m102dp(20));
                    ...
                    case 8:
                        FrameLayout frameLayout = new FrameLayout(this, ChannelBoostLayout.this.getContext()) { // from class: org.telegram.ui.ChannelBoostLayout.1.1
                            ...
                            protected void onMeasure(int i2, int i3) {
                                super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(50), 1073741824));
                            }
                        };
                        TextView textView = new TextView(ChannelBoostLayout.this.getContext());
                        textView.setText(LocaleController.getString("NoBoostersHint", C3630R.string.NoBoostersHint));
                        textView.setTextSize(1, 14.0f);
                        textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText));
                        textView.setGravity(17);
                        frameLayout.addView(textView, LayoutHelper.createFrame(-1, -2, 0, 0, 7, 0, 0));
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (viewHolder.getItemViewType() == 1) {
                    ...
                    overviewCell.setData(0, Integer.toString(ChannelBoostLayout.this.boostsStatus.level), null, LocaleController.getString("BoostsLevel2", C3630R.string.BoostsLevel2));
                    ...
                    if (tLRPC$TL_statsPercentValue != null) {
                        if (tLRPC$TL_statsPercentValue.total == 0.0d) {
                            overviewCell.setData(1, "~" + ((int) ChannelBoostLayout.this.boostsStatus.premium_audience.part), String.format(Locale.US, "%.1f", Float.valueOf((((float) tLRPC$TL_statsPercentValue.part) / ((float) d)) * 100.0f)) + "%", LocaleController.getString("PremiumSubscribers", C3630R.string.PremiumSubscribers));
                            overviewCell.setData(2, String.valueOf(ChannelBoostLayout.this.boostsStatus.boosts), null, LocaleController.getString("BoostsExisting", C3630R.string.BoostsExisting));
                            TLRPC$TL_stories_boostsStatus tLRPC$TL_stories_boostsStatus = ChannelBoostLayout.this.boostsStatus;
                            overviewCell.setData(3, String.valueOf(tLRPC$TL_stories_boostsStatus.next_level_boosts - tLRPC$TL_stories_boostsStatus.boosts), null, LocaleController.getString("BoostsToLevel", C3630R.string.BoostsToLevel));
                        }
                    }
                    overviewCell.setData(1, "~0", "0%", LocaleController.getString("PremiumSubscribers", C3630R.string.PremiumSubscribers));
                    overviewCell.setData(2, String.valueOf(ChannelBoostLayout.this.boostsStatus.boosts), null, LocaleController.getString("BoostsExisting", C3630R.string.BoostsExisting));
                    TLRPC$TL_stories_boostsStatus tLRPC$TL_stories_boostsStatus2 = ChannelBoostLayout.this.boostsStatus;
                    overviewCell.setData(3, String.valueOf(tLRPC$TL_stories_boostsStatus2.next_level_boosts - tLRPC$TL_stories_boostsStatus2.boosts), null, LocaleController.getString("BoostsToLevel", C3630R.string.BoostsToLevel));
                    ...
                    ((UserCell) viewHolder.itemView).setData(user, ContactsController.formatName(user), LocaleController.formatString("BoostExpireOn", C3630R.string.BoostExpireOn, LocaleController.formatDate(tLRPC$TL_booster.expires)), 0);
                    ...
                    ((ManageChatTextCell) viewHolder.itemView).setText(LocaleController.formatPluralString("ShowVotes", ChannelBoostLayout.this.nextRemaining, new Object[0]), null, C3630R.C3632drawable.arrow_more, false);
                }
            }
    ...
    public /* synthetic */ void lambda$new$0(BaseFragment baseFragment, View view, int i) {
        if (view instanceof UserCell) {
            baseFragment.presentFragment(ProfileActivity.m54of(((UserCell) view).getDialogId()));
        }
    ...
    private void updateRows(boolean z) {
        ...
        if (this.boostsStatus != null) {
            ...
            this.items.add(new ItemInternal(this, 1, LocaleController.getString("StatisticOverview", C3630R.string.StatisticOverview)));
            this.items.add(new ItemInternal(this, 0, true));
            this.items.add(new ItemInternal(this, 2, false));
            this.items.add(new ItemInternal(this, 1, LocaleController.getString("Boosters", C3630R.string.Boosters)));
            if (this.boosters.isEmpty()) {
                ...
                this.items.add(new ItemInternal(this, 6, LocaleController.getString("BoostersInfoDescription", C3630R.string.BoostersInfoDescription)));
            }
            this.items.add(new ItemInternal(this, 1, LocaleController.getString("LinkForBoosting", C3630R.string.LinkForBoosting)));
    ...
    public void createEmptyView(Context context) {
        ...
        rLottieImageView.setAnimation(C3630R.raw.statistic_preload, 120, 120);
