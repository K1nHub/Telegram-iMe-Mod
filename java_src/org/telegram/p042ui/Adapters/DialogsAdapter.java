...
import org.telegram.p042ui.Cells.ArchiveHintCell;
import org.telegram.p042ui.Cells.DialogCell;
import org.telegram.p042ui.Cells.DialogMeUrlCell;
import org.telegram.p042ui.Cells.DialogsEmptyCell;
import org.telegram.p042ui.Cells.DialogsHintCell;
import org.telegram.p042ui.Cells.DialogsRequestedEmptyCell;
...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter implements DialogCell.DialogCellDelegate {
    ...
    @Override // org.telegram.p042ui.Cells.DialogCell.DialogCellDelegate
    ...
    public int findDialogPosition(long j) {
        for (int i = 0; i < this.itemInternals.size(); i++) {
            if (this.itemInternals.get(i).dialog != null && this.itemInternals.get(i).dialog.f1606id == j) {
                return i;
            }
        }
        return -1;
    ...
    public int fixScrollGap(RecyclerListView recyclerListView, int i, int i2, boolean z, boolean z2, boolean z3, boolean z4) {
        getItemCount();
        int m102dp = AndroidUtilities.m102dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : SharedConfig.useThreeLinesLayout ? 78 : 72);
        recyclerListView.getPaddingTop();
        int paddingTop = ((recyclerListView.getPaddingTop() + i2) - (i * m102dp)) - i;
        if (z2) {
            AndroidUtilities.m102dp(81);
        } else if (z3) {
            AndroidUtilities.m102dp(44);
        }
        if (z) {
            paddingTop += m102dp;
        }
    ...
    public class ItemInternal extends AdapterWithDiffUtils.Item {
        ...
        public ItemInternal(DialogsAdapter dialogsAdapter, int i, TLRPC$Dialog tLRPC$Dialog) {
            ...
            if (tLRPC$Dialog != null) {
                int i2 = dialogsAdapter.dialogsStableIds.get(tLRPC$Dialog.f1606id, -1);
                if (i2 >= 0) {
                    this.stableId = i2;
                } else {
                    ...
                    this.stableId = i3;
                    dialogsAdapter.dialogsStableIds.put(tLRPC$Dialog.f1606id, i3);
                }
            } else if (i == 19) {
                this.stableId = 5;
            } else {
            ...
            if (tLRPC$Dialog != null) {
                if (dialogsAdapter.dialogsType == 7 || dialogsAdapter.dialogsType == 8) {
                    ...
                    this.pinned = (dialogFilter == null || dialogFilter.pinnedDialogs.indexOfKey(tLRPC$Dialog.f1606id) < 0) ? false : z;
                } else {
                    this.pinned = tLRPC$Dialog.pinned;
                }
                this.isFolder = tLRPC$Dialog.isFolder;
                this.isForumCell = MessagesController.getInstance(dialogsAdapter.currentAccount).isForum(tLRPC$Dialog.f1606id);
            }
        }
        ...
        boolean compare(ItemInternal itemInternal) {
            ...
            if (i == 0) {
                ...
                return tLRPC$Dialog3 != null && (tLRPC$Dialog2 = itemInternal.dialog) != null && tLRPC$Dialog3.f1606id == tLRPC$Dialog2.f1606id && this.isFolder == itemInternal.isFolder && this.isForumCell == itemInternal.isForumCell && this.pinned == itemInternal.pinned;
            } else if (i == 14) {
                TLRPC$Dialog tLRPC$Dialog4 = this.dialog;
                return tLRPC$Dialog4 != null && (tLRPC$Dialog = itemInternal.dialog) != null && tLRPC$Dialog4.f1606id == tLRPC$Dialog.f1606id && tLRPC$Dialog4.isFolder == tLRPC$Dialog.isFolder;
            } else if (i == 4) {
    ...
    */
    public static /* synthetic */ int lambda$sortOnlineContacts$0(org.telegram.messenger.MessagesController r2, int r3, org.telegram.tgnet.TLRPC$TL_contact r4, org.telegram.tgnet.TLRPC$TL_contact r5) {
        ...
        L60:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Adapters.DialogsAdapter.lambda$sortOnlineContacts$0(org.telegram.messenger.MessagesController, int, org.telegram.tgnet.TLRPC$TL_contact, org.telegram.tgnet.TLRPC$TL_contact):int");
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 13:
                ...
                if (i == 13) {
                    flickerLoadingView.setItemsCount((int) ((AndroidUtilities.displaySize.y * 0.5f) / AndroidUtilities.m102dp(64)));
                    break;
                }
                break;
            case 2:
                flickerLoadingView = new HeaderCell(this.mContext);
                flickerLoadingView.setText(LocaleController.getString("RecentlyViewed", C3630R.string.RecentlyViewed));
                TextView textView = new TextView(this.mContext);
                textView.setTextSize(1, 15.0f);
                textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
                textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueHeader));
                textView.setText(LocaleController.getString("RecentlyViewedHide", C3630R.string.RecentlyViewedHide));
            ...
            case 3:
                flickerLoadingView = new FrameLayout(this, this.mContext) { // from class: org.telegram.ui.Adapters.DialogsAdapter.2
                    ...
                    protected void onMeasure(int i4, int i5) {
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i4), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(12), 1073741824));
                    }
                };
                flickerLoadingView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
                View view3 = new View(this.mContext);
                view3.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            ...
            case 7:
                flickerLoadingView = new HeaderCell(this.mContext);
                flickerLoadingView.setPadding(0, 0, 0, AndroidUtilities.m102dp(12));
                break;
            case 8:
            ...
            case 11:
                flickerLoadingView = new TextInfoPrivacyCell(this.mContext) { // from class: org.telegram.ui.Adapters.DialogsAdapter.4
                    ...
                    @Override // org.telegram.p042ui.Cells.TextInfoPrivacyCell
                    ...
                    protected void onTextDraw() {
                        if (DialogsAdapter.this.arrowDrawable != null) {
                            Rect bounds = DialogsAdapter.this.arrowDrawable.getBounds();
                            int m102dp = (int) (this.moveProgress * AndroidUtilities.m102dp(3));
                            this.originalX = bounds.left;
                            this.originalY = bounds.top;
                            DialogsAdapter.this.arrowDrawable.setBounds(this.originalX + m102dp, this.originalY + AndroidUtilities.m102dp(1), this.originalX + m102dp + bounds.width(), this.originalY + AndroidUtilities.m102dp(1) + bounds.height());
                ...
                CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(this.mContext, C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            ...
            case 16:
                flickerLoadingView = new DialogsRequestedEmptyCell(this.mContext) { // from class: org.telegram.ui.Adapters.DialogsAdapter.3
                    @Override // org.telegram.p042ui.Cells.DialogsRequestedEmptyCell
            ...
            case 18:
                flickerLoadingView = new View(this, this.mContext) { // from class: org.telegram.ui.Adapters.DialogsAdapter.5
                    ...
                    protected void onMeasure(int i4, int i5) {
                        super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(81), 1073741824));
                    }
                };
                break;
            case 19:
    ...
    public int dialogsEmptyType() {
        if (DialogsActivity.isAlbumsDialogsType(this.dialogsType)) {
            return (isArchive() ? EmptyCellType.ARCHIVE_ALBUMS : EmptyCellType.ALBUMS).m1008id();
        }
        int i = this.dialogsType;
        if (i == DialogsActivity.DIALOGS_TYPE_DRAFTS) {
            return EmptyCellType.DRAFTS.m1008id();
        }
        if (this.folderId == 2) {
            return EmptyCellType.HIDDEN_CHATS.m1008id();
        }
        if (i == 7 || i == 8 || (i == 0 && ForkTopicsController.getInstance(this.currentAccount).hasSelectedTopic(isArchive()))) {
            ...
            return EmptyCellType.ARCHIVE.m1008id();
        } else {
            return 2;
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (itemViewType == 0) {
            ...
            if (i2 == 2 || i2 == 15 || DialogsActivity.isAlbumsDialogsType(this.initialDialogsType)) {
                ...
                if (tLRPC$Dialog.f1606id != 0) {
                    tLRPC$Chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-tLRPC$Dialog.f1606id));
                ...
                if (tLRPC$Chat != null) {
                    ...
                    if (DialogsActivity.isAlbumsDialogsType(this.initialDialogsType)) {
                        lowerCase = LocaleController.getInternalString(C3630R.string.cloud_album).toLowerCase();
                    ...
                    TLRPC$User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(tLRPC$Dialog.f1606id));
                    if (user != null) {
                        ...
                        if (UserObject.isReplyUser(user)) {
                            ...
                            if (user.bot) {
                                formatUserStatus = LocaleController.getString("Bot", C3630R.string.Bot);
                            } else {
                ...
                if (this.dialogsType == 0 && AndroidUtilities.isTablet()) {
                    dialogCell.setDialogSelected(tLRPC$Dialog.f1606id == this.openedDialogId);
                }
                dialogCell.setChecked(this.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog.f1606id)), false);
                ...
                if (dialogsPreloader != null && i < 10) {
                    dialogsPreloader.add(tLRPC$Dialog.f1606id);
                }
            }
            ...
            if (i7 != 11 && i7 != 12 && i7 != 13) {
                headerCell.setText(LocaleController.getString((this.dialogsCount == 0 && this.forceUpdatingContacts) ? C3630R.string.ConnectingYourContacts : C3630R.string.YourContacts));
            } else if (i == 0) {
                headerCell.setText(LocaleController.getString("ImportHeader", C3630R.string.ImportHeader));
            } else {
                headerCell.setText(LocaleController.getString("ImportHeaderContacts", C3630R.string.ImportHeaderContacts));
            }
        } else if (itemViewType == 11) {
            TextInfoPrivacyCell textInfoPrivacyCell = (TextInfoPrivacyCell) viewHolder.itemView;
            textInfoPrivacyCell.setText(LocaleController.getString("TapOnThePencil", C3630R.string.TapOnThePencil));
            if (this.arrowDrawable == null) {
                Drawable drawable = this.mContext.getResources().getDrawable(C3630R.C3632drawable.arrow_newchat);
            ...
            textView.setCompoundDrawablePadding(AndroidUtilities.m102dp(4));
            ...
            switch (itemViewType) {
                case 14:
                    ...
                    if (i8 == 0) {
                        headerCell2.setText(LocaleController.getString("MyChannels", C3630R.string.MyChannels));
                        break;
                    } else if (i8 == 1) {
                        headerCell2.setText(LocaleController.getString("MyGroups", C3630R.string.MyGroups));
                        break;
                    } else if (i8 == 2) {
                        headerCell2.setText(LocaleController.getString("FilterGroups", C3630R.string.FilterGroups));
                        break;
                    }
                    break;
                case 15:
            ...
            if (tLRPC$RequestPeerType != null) {
                if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeBroadcast) {
                    textCell.setTextAndIcon(LocaleController.getString("CreateChannelForThis", C3630R.string.CreateChannelForThis), C3630R.C3632drawable.msg_channel_create, true);
                } else {
                    textCell.setTextAndIcon(LocaleController.getString("CreateGroupForThis", C3630R.string.CreateGroupForThis), C3630R.C3632drawable.msg_groups_create, true);
                }
            } else {
                textCell.setTextAndIcon(LocaleController.getString("CreateGroupForImport", C3630R.string.CreateGroupForImport), C3630R.C3632drawable.msg_groups_create, this.dialogsCount != 0);
            }
    ...
    public void moveDialogs(RecyclerListView recyclerListView, int i, int i2) {
        ...
        if (i3 == 7 || i3 == 8) {
            ...
            int i4 = dialogFilter.pinnedDialogs.get(tLRPC$Dialog.f1606id);
            dialogFilter.pinnedDialogs.put(tLRPC$Dialog.f1606id, dialogFilter.pinnedDialogs.get(tLRPC$Dialog2.f1606id));
            dialogFilter.pinnedDialogs.put(tLRPC$Dialog2.f1606id, i4);
        } else {
    ...
    public void openStory(DialogCell dialogCell, Runnable runnable) {
        ...
        if (MessagesController.getInstance(this.currentAccount).getStoriesController().hasStories(dialogCell.getDialogId())) {
            ...
            this.parentFragment.getOrCreateStoryViewer().open(this.parentFragment.getContext(), dialogCell.getDialogId(), StoriesListPlaceProvider.m52of((RecyclerListView) dialogCell.getParent()));
        }
    }
    ...
    public void openHiddenStories() {
        ...
        this.parentFragment.getOrCreateStoryViewer().open(this.mContext, null, arrayList, 0, null, null, StoriesListPlaceProvider.m51of(this.recyclerListView, true), false);
    }
    ...
    public static class DialogsPreloader {
        ...
        public void start() {
            ...
            MessagesController.getInstance(UserConfig.selectedAccount).ensureMessagesLoaded(longValue, 0, new C38241(longValue));
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: org.telegram.ui.Adapters.DialogsAdapter$DialogsPreloader$1 */
        /* loaded from: classes5.dex */
        public class C38241 implements MessagesController.MessagesLoadedCallback {
            ...
            public void onMessagesLoaded(final boolean z) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.DialogsAdapter$DialogsPreloader$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsAdapter.DialogsPreloader.C38241.this.lambda$onMessagesLoaded$0(z, j);
                    }
                });
            }
            ...
            public void onError() {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.DialogsAdapter$DialogsPreloader$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsAdapter.DialogsPreloader.C38241.this.lambda$onError$1(j);
                    }
                });
            }
    ...
    public class LastEmptyView extends FrameLayout {
        ...
        */
        protected void onMeasure(int r12, int r13) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Adapters.DialogsAdapter.LastEmptyView.onMeasure(int, int):void");
        }
    }

    /* JADX WARN: Removed duplicated region for block: B:128:0x02e9  */
    /* JADX WARN: Removed duplicated region for block: B:173:0x03c6 A[LOOP:2: B:173:0x03c6->B:182:0x03ed, LOOP_START, PHI: r4 
      PHI: (r4v2 int) = (r4v1 int), (r4v4 int) binds: [B:172:0x03c4, B:182:0x03ed] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:183:0x03ef A[ORIG_RETURN, RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private void updateItemList() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Adapters.DialogsAdapter.updateItemList():void");
    }
    ...
    public int getItemHeight(int i) {
        ...
        if (this.itemInternals.get(i).viewType == 0) {
            ...
            return AndroidUtilities.m102dp(SharedConfig.useThreeLinesLayout ? 86 : 91);
        }
        return 0;
    }
}
