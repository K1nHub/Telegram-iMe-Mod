...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 201) {
            ...
            DrawerProfileCell drawerProfileCell2 = new DrawerProfileCell(this.mContext, this.mDrawerLayoutContainer, false) { // from class: org.telegram.ui.Adapters.DrawerLayoutAdapter.1
                @Override // org.telegram.p042ui.Cells.DrawerProfileCell
            ...
            drawerProfileCell = new EmptyCell(this.mContext, AndroidUtilities.m102dp(8));
        }
    ...
    private void resetItems() {
        ...
        if (UserConfig.getInstance(UserConfig.selectedAccount).isClientActivated()) {
            ...
            if (eventType == 0) {
                i = C3630R.C3632drawable.msg_groups_ny;
                i2 = C3630R.C3632drawable.msg_contacts_ny;
                i3 = C3630R.C3632drawable.msg_calls_ny;
                i12 = C3630R.C3632drawable.msg_saved_ny;
                i4 = C3630R.C3632drawable.msg_settings_ny;
                i5 = C3630R.C3632drawable.msg_nearby_ny;
                i6 = C3630R.C3632drawable.fork_drawer_wallet_ny;
                i7 = C3630R.C3632drawable.fork_drawer_catalog_ny;
                i8 = C3630R.C3632drawable.fork_drawer_music_ny;
                i9 = C3630R.C3632drawable.fork_drawer_create_expandable_ny;
                i10 = C3630R.C3632drawable.msg_secret_ny;
                i11 = C3630R.C3632drawable.fork_drawer_channel_ny;
                i13 = C3630R.C3632drawable.fork_drawer_albums_ny;
            } else {
                if (eventType == 1) {
                    i = C3630R.C3632drawable.msg_groups_14;
                    i2 = C3630R.C3632drawable.msg_contacts_14;
                    i3 = C3630R.C3632drawable.msg_calls_14;
                    i12 = C3630R.C3632drawable.msg_saved_14;
                    i4 = C3630R.C3632drawable.msg_settings_14;
                    i5 = C3630R.C3632drawable.msg_secret_14;
                    i6 = C3630R.C3632drawable.fork_drawer_wallet_14;
                    i7 = C3630R.C3632drawable.fork_drawer_catalog_14;
                    i8 = C3630R.C3632drawable.fork_drawer_music_14;
                    i9 = C3630R.C3632drawable.fork_drawer_create_expandable_14;
                    i11 = C3630R.C3632drawable.fork_drawer_channel_14;
                    i13 = C3630R.C3632drawable.fork_drawer_albums_14;
                } else if (eventType == 2) {
                    i = C3630R.C3632drawable.msg_groups_hw;
                    i2 = C3630R.C3632drawable.msg_contacts_hw;
                    i3 = C3630R.C3632drawable.msg_calls_hw;
                    i12 = C3630R.C3632drawable.msg_saved_hw;
                    i4 = C3630R.C3632drawable.msg_settings_hw;
                    i5 = C3630R.C3632drawable.msg_secret_hw;
                    i6 = C3630R.C3632drawable.fork_drawer_wallet_hw;
                    i7 = C3630R.C3632drawable.fork_drawer_catalog_hw;
                    i8 = C3630R.C3632drawable.fork_drawer_music_hw;
                    i9 = C3630R.C3632drawable.fork_drawer_create_expandable_hw;
                    i11 = C3630R.C3632drawable.fork_drawer_channel_hw;
                    i13 = C3630R.C3632drawable.fork_drawer_albums_hw;
                } else {
                    i = C3630R.C3632drawable.msg_groups;
                    i2 = C3630R.C3632drawable.msg_contacts;
                    i3 = C3630R.C3632drawable.msg_calls;
                    i4 = C3630R.C3632drawable.msg_settings_old;
                    i5 = C3630R.C3632drawable.msg_nearby;
                    i6 = C3630R.C3632drawable.fork_drawer_wallet;
                    i7 = C3630R.C3632drawable.fork_drawer_catalog;
                    i8 = C3630R.C3632drawable.files_music;
                    i9 = C3630R.C3632drawable.fork_drawer_create_expandable;
                    i10 = C3630R.C3632drawable.msg_secret;
                    i11 = C3630R.C3632drawable.msg_channel;
                    i12 = C3630R.C3632drawable.fork_drawer_cloud;
                    i13 = C3630R.C3632drawable.fork_drawer_albums;
                }
                i10 = i5;
            }
            int i18 = i13;
            ...
            if (userConfig != null && userConfig.isPremium() && (ForkCommonController.getInstance(UserConfig.selectedAccount).isShowPremiumBadgeEnabled() || ForkCommonController.getInstance(UserConfig.selectedAccount).isShowPremiumStatusEnabled())) {
                if (userConfig.getEmojiStatus() != null) {
                    ...
                    i14 = i18;
                    i15 = i12;
                    this.items.add(new Item(15, LocaleController.getString("ChangeEmojiStatus", C3630R.string.ChangeEmojiStatus), C3630R.C3632drawable.msg_status_edit));
                } else {
                    i14 = i18;
                    i15 = i12;
                    i16 = i4;
                    this.items.add(new Item(15, LocaleController.getString("SetEmojiStatus", C3630R.string.SetEmojiStatus), C3630R.C3632drawable.msg_status_set));
                }
                z = true;
            } else {
                i14 = i18;
            ...
            if (!"disabled".equals(MessagesController.getInstance(UserConfig.selectedAccount).storiesPosting)) {
                this.items.add(new Item(16, LocaleController.getString("ProfileMyStories", C3630R.string.ProfileMyStories), C3630R.C3632drawable.msg_menu_stories));
                z = true;
            }
            ...
            if (attachMenuBots != null && attachMenuBots.bots != null) {
                boolean z3 = z;
                int i19 = 0;
                while (i19 < attachMenuBots.bots.size()) {
                    TLRPC$TL_attachMenuBot tLRPC$TL_attachMenuBot = attachMenuBots.bots.get(i19);
            ...
            DrawerItem drawerItem2 = DrawerItem.CATALOG;
            if (set2.contains(drawerItem2)) {
                this.rectIconItems.add(new Item(IdFabric$ViewTypes.DRAWER_CATALOG, i7, drawerItem2));
            }
            Set<DrawerItem> set3 = SharedConfig.selectedDrawerItems;
            DrawerItem drawerItem3 = DrawerItem.MUSIC;
            if (set3.contains(drawerItem3)) {
                this.rectIconItems.add(new Item(IdFabric$ViewTypes.DRAWER_MUSIC, i8, drawerItem3));
            }
            if (!this.rectIconItems.isEmpty()) {
                this.rectIconItems.add(null);
            }
            this.createGroupItems.add(new Item(2, LocaleController.getString("NewGroup", C3630R.string.NewGroup), i));
            this.createGroupItems.add(new Item(3, LocaleController.getString("NewSecretChat", C3630R.string.NewSecretChat), i10));
            this.createGroupItems.add(new Item(4, LocaleController.getString("NewChannel", C3630R.string.NewChannel), i11));
            this.items.add(new Item(IdFabric$ViewTypes.DRAWER_GROUP_CREATE, LocaleController.getInternalString(C3630R.string.drawer_create_expandable_section), i9));
            this.items.add(null);
            if (SharedConfig.selectedDrawerItems.contains(DrawerItem.CONTACTS)) {
                this.items.add(new Item(6, LocaleController.getString("Contacts", C3630R.string.Contacts), i2));
            }
            if (SharedConfig.selectedDrawerItems.contains(DrawerItem.CALLS)) {
                this.items.add(new Item(10, LocaleController.getString("Calls", C3630R.string.Calls), i3));
            }
            if (SharedConfig.selectedDrawerItems.contains(DrawerItem.PEOPLE_NEARBY) && this.hasGps) {
                this.items.add(new Item(12, LocaleController.getString("PeopleNearby", C3630R.string.PeopleNearby), i5));
            }
            if (SharedConfig.selectedDrawerItems.contains(DrawerItem.CLOUD)) {
                this.items.add(new Item(11, LocaleController.getString("SavedMessages", C3630R.string.SavedMessages), i15));
            }
            if (SharedConfig.selectedDrawerItems.contains(DrawerItem.ALBUMS)) {
                this.items.add(new Item(IdFabric$ViewTypes.DRAWER_ALBUMS, LocaleController.getInternalString(C3630R.string.cloud_albums_toolbar_title), i14));
            }
            this.items.add(new Item(8, LocaleController.getString("Settings", C3630R.string.Settings), i16));
        }
    }
    ...
    public int getId(int i) {
        ...
        if (i2 >= this.prefixItems.size()) {
            ...
            if (this.isCreateGroupExpanded) {
                if (i3 < this.createGroupItems.size()) {
                    return this.createGroupItems.get(i3).f1779id;
                }
                i3 -= this.createGroupItems.size();
            }
            i2 = i3 + 1 + this.prefixItems.size();
    ...
    public static class Item {
        ...
        public Item(TLRPC$TL_attachMenuBot tLRPC$TL_attachMenuBot) {
            ...
            this.f1779id = (int) ((tLRPC$TL_attachMenuBot.bot_id >> 16) + 100);
        }
        ...
        public void bind(DrawerActionCell drawerActionCell) {
            ...
            if (tLRPC$TL_attachMenuBot != null) {
                ...
                drawerActionCell.setTextAndIcon(this.f1779id, this.text, this.icon, this.rectIcon != null);
            }
        }
    }
}
