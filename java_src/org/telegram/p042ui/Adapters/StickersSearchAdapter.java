...
import org.telegram.p042ui.Adapters.StickersSearchAdapter;
import org.telegram.p042ui.Cells.EmptyCell;
import org.telegram.p042ui.Cells.FeaturedStickerSetInfoCell;
import org.telegram.p042ui.Cells.StickerEmojiCell;
import org.telegram.p042ui.Cells.StickerSetNameCell;
...
public class StickersSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    /* loaded from: classes5.dex */
    public class RunnableC38491 implements Runnable {
        RunnableC38491() {
        }
        ...
        */
        public void run() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Adapters.StickersSearchAdapter.RunnableC38491.run():void");
        }
            ...
            if (tLObject instanceof TLRPC$TL_messages_foundStickerSets) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.StickersSearchAdapter$1$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        StickersSearchAdapter.RunnableC38491.this.lambda$run$1(tLRPC$TL_messages_searchStickerSets, tLObject);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void lambda$run$1(TLRPC$TL_messages_searchStickerSets tLRPC$TL_messages_searchStickerSets, TLObject tLObject) {
            if (tLRPC$TL_messages_searchStickerSets.f1716q.equals(StickersSearchAdapter.this.searchQuery)) {
                clear();
        ...
        public /* synthetic */ void lambda$run$4(final TLRPC$TL_messages_getStickers tLRPC$TL_messages_getStickers, final ArrayList arrayList, final LongSparseArray longSparseArray, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.StickersSearchAdapter$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    StickersSearchAdapter.RunnableC38491.this.lambda$run$3(tLRPC$TL_messages_getStickers, tLObject, arrayList, longSparseArray);
                }
            });
        }
            ...
            if (tLRPC$TL_messages_getStickers.emoticon.equals(StickersSearchAdapter.this.searchQuery)) {
                ...
                if (tLObject instanceof TLRPC$TL_messages_stickers) {
                    ...
                    for (int i = 0; i < size2; i++) {
                        ...
                        if (longSparseArray.indexOfKey(tLRPC$Document.f1608id) < 0) {
    ...
    public /* synthetic */ void lambda$onCreateViewHolder$0(View view) {
        ...
        if (stickerSet == null || this.installingStickerSets.indexOfKey(stickerSet.set.f1634id) >= 0 || this.removingStickerSets.indexOfKey(stickerSet.set.f1634id) >= 0) {
            return;
        }
        if (featuredStickerSetInfoCell.isInstalled()) {
            this.removingStickerSets.put(stickerSet.set.f1634id, stickerSet);
        ...
        if (i == 0) {
            StickerEmojiCell stickerEmojiCell = new StickerEmojiCell(this, this.context, false, this.resourcesProvider) { // from class: org.telegram.ui.Adapters.StickersSearchAdapter.2
                ...
                public void onMeasure(int i2, int i3) {
                    super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(82), 1073741824));
                }
            };
            ...
            if (i == 1) {
                ...
                this.emptyImageView.setImageResource(C3630R.C3632drawable.stickers_empty);
                ...
                textView.setText(LocaleController.getString("NoStickersFound", C3630R.string.NoStickersFound));
                ...
                linearLayout2.setMinimumHeight(AndroidUtilities.m102dp(112));
    ...
    public void installStickerSet(TLRPC$InputStickerSet tLRPC$InputStickerSet) {
        for (int i = 0; i < this.serverPacks.size(); i++) {
            ...
            if (tLRPC$StickerSetCovered.set.f1634id == tLRPC$InputStickerSet.f1623id) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x0059, code lost:
        r6.installingStickerSets.put(r7.set.f1634id, r7);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:35:0x008b, code lost:
        if (r2.set.f1634id != r7.set.f1634id) goto L37;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void installStickerSet(org.telegram.tgnet.TLRPC$StickerSetCovered r7, org.telegram.p042ui.Cells.FeaturedStickerSetInfoCell r8) {
        /*
            r6 = this;
            r0 = 0
            r1 = r0
        ...
        L98:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Adapters.StickersSearchAdapter.installStickerSet(org.telegram.tgnet.TLRPC$StickerSetCovered, org.telegram.ui.Cells.FeaturedStickerSetInfoCell):void");
    }
    ...
    private void bindFeaturedStickerSetInfoCell(FeaturedStickerSetInfoCell featuredStickerSetInfoCell, int i, boolean z) {
        ...
        boolean z5 = unreadStickerSets != null && unreadStickerSets.contains(Long.valueOf(tLRPC$StickerSetCovered.set.f1634id));
        int i2 = 0;
        while (true) {
            ...
            if (tLRPC$StickerSetCoveredArr[i2] != null) {
                TLRPC$TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(this.currentAccount).getStickerSetById(this.primaryInstallingStickerSets[i2].set.f1634id);
                if (stickerSetById != null && !stickerSetById.set.archived) {
                    this.primaryInstallingStickerSets[i2] = null;
                } else if (this.primaryInstallingStickerSets[i2].set.f1634id == tLRPC$StickerSetCovered.set.f1634id) {
                    z2 = true;
                    break;
                }
            }
        ...
        if (z5) {
            mediaDataController.markFeaturedStickersByIdAsRead(false, tLRPC$StickerSetCovered.set.f1634id);
        }
        boolean z6 = this.installingStickerSets.indexOfKey(tLRPC$StickerSetCovered.set.f1634id) >= 0;
        boolean z7 = this.removingStickerSets.indexOfKey(tLRPC$StickerSetCovered.set.f1634id) >= 0;
        if (z6 || z7) {
            if (z6 && featuredStickerSetInfoCell.isInstalled()) {
                this.installingStickerSets.remove(tLRPC$StickerSetCovered.set.f1634id);
                z6 = false;
            } else if (z7 && !featuredStickerSetInfoCell.isInstalled()) {
                this.removingStickerSets.remove(tLRPC$StickerSetCovered.set.f1634id);
            }
        }
        if (z2 || !z6) {
            z3 = z;
