...
import org.telegram.p042ui.Components.PopupSwipeBackLayout;
...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, final PopupSwipeBackLayout popupSwipeBackLayout, final Callback callback) {
        ...
        ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3630R.C3632drawable.msg_arrow_back, LocaleController.getString("Back", C3630R.string.Back), false, null);
        ...
        frameLayout.setMinimumWidth(AndroidUtilities.m102dp(196));
        ...
        layoutParams.height = AndroidUtilities.m102dp(8);
        ...
        speedSlider.setMinimumWidth(AndroidUtilities.m102dp(196));
        ...
        frameLayout2.setMinimumWidth(AndroidUtilities.m102dp(196));
        ...
        layoutParams2.height = AndroidUtilities.m102dp(8);
        frameLayout2.setLayoutParams(layoutParams2);
        ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3630R.C3632drawable.msg_speed_0_2, LocaleController.getString("SpeedVerySlow", C3630R.string.SpeedVerySlow), false, null);
        ...
        ActionBarMenuSubItem addItem3 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3630R.C3632drawable.msg_speed_slow, LocaleController.getString("SpeedSlow", C3630R.string.SpeedSlow), false, null);
        ...
        ActionBarMenuSubItem addItem4 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3630R.C3632drawable.msg_speed_normal, LocaleController.getString("SpeedNormal", C3630R.string.SpeedNormal), false, null);
        addItem4.setColors(-328966, -328966);
        addItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ChooseSpeedLayout$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        ActionBarMenuSubItem addItem5 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3630R.C3632drawable.msg_speed_fast, LocaleController.getString("SpeedFast", C3630R.string.SpeedFast), false, null);
        ...
        ActionBarMenuSubItem addItem6 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3630R.C3632drawable.msg_speed_superfast, LocaleController.getString("SpeedVeryFast", C3630R.string.SpeedVeryFast), false, null);
