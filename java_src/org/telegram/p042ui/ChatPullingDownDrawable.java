...
import org.telegram.p042ui.Components.CounterView;
...
public class ChatPullingDownDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatPullingDownDrawable(int i, View view, long j, int i2, int i3, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textPaint2.setTextSize(AndroidUtilities.m102dp(14));
    ...
    public void updateDialog() {
        ...
        if (nextUnreadDialog != null) {
            long j = nextUnreadDialog.f1606id;
            this.nextDialogId = j;
            ...
            if (DialogObject.isUserDialog(j)) {
                this.nextUser = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(nextUnreadDialog.f1606id));
            } else {
                this.nextChat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-nextUnreadDialog.f1606id));
            }
            ...
            MessagesController.getInstance(this.currentAccount).ensureMessagesLoaded(nextUnreadDialog.f1606id, 0, null);
    ...
    public void setWidth(int i) {
        ...
        int i2;
        if (i != this.lastWidth) {
            this.circleRadius = AndroidUtilities.m102dp(56) / 2.0f;
            this.lastWidth = i;
            TLRPC$Chat tLRPC$Chat = this.nextChat;
            String string3 = tLRPC$Chat != null ? tLRPC$Chat.title : LocaleController.getString("SwipeToGoNextChannelEnd", C3630R.string.SwipeToGoNextChannelEnd);
            if (this.nextUser != null) {
                ContactsController contactsController = ContactsController.getInstance(this.currentAccount);
                if (contactsController.contactsDict.get(Long.valueOf(this.nextUser.f1762id)) == null && ((contactsController.contactsDict.size() != 0 || !contactsController.isLoadingContacts()) && !TextUtils.isEmpty(this.nextUser.phone))) {
                    C3545PhoneFormat c3545PhoneFormat = C3545PhoneFormat.getInstance();
                    string3 = c3545PhoneFormat.format("+" + this.nextUser.phone);
                } else {
            ...
            this.chatNameWidth = Math.min(measureText, this.lastWidth - AndroidUtilities.m102dp(60));
            ...
            if (z && (i2 = this.dialogFolderId) != this.folderId && i2 != 0) {
                string = LocaleController.getString("SwipeToGoNextArchive", C3630R.string.SwipeToGoNextArchive);
                string2 = LocaleController.getString("ReleaseToGoNextArchive", C3630R.string.ReleaseToGoNextArchive);
                ...
                string = LocaleController.getString("SwipeToGoNextFolder", C3630R.string.SwipeToGoNextFolder);
                string2 = LocaleController.getString("ReleaseToGoNextFolder", C3630R.string.ReleaseToGoNextFolder);
            } else {
                string = LocaleController.getString("SwipeToGoNextChannel", C3630R.string.SwipeToGoNextChannel);
                string2 = LocaleController.getString("ReleaseToGoNextChannel", C3630R.string.ReleaseToGoNextChannel);
            ...
            this.layout1Width = Math.min(measureText2, this.lastWidth - AndroidUtilities.m102dp(60));
            ...
            this.layout2Width = Math.min(measureText3, this.lastWidth - AndroidUtilities.m102dp(60));
            ...
            this.imageReceiver.setImageCoords((this.lastWidth / 2.0f) - (AndroidUtilities.m102dp(40) / 2.0f), (AndroidUtilities.m102dp(12) + this.circleRadius) - (AndroidUtilities.m102dp(40) / 2.0f), AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(40));
            this.imageReceiver.setRoundRadius((int) (AndroidUtilities.m102dp(40) / 2.0f));
            this.counterDrawable.setSize(AndroidUtilities.m102dp(28), AndroidUtilities.m102dp(100));
        }
    }
    ...
    public void draw(Canvas canvas, View view, float f, float f2) {
        ...
        float m102dp = AndroidUtilities.m102dp(110) * f;
        if (m102dp < AndroidUtilities.m102dp(8)) {
            return;
        }
        float f4 = f < 0.2f ? 5.0f * f * f2 : f2;
        Theme.applyServiceShaderMatrix(this.lastWidth, view.getMeasuredHeight(), BitmapDescriptorFactory.HUE_RED, view.getMeasuredHeight() - m102dp);
        TextPaint textPaint = this.textPaint;
        ...
        float f6 = this.bounceProgress * (-AndroidUtilities.m102dp(4));
        if (this.emptyStub) {
            m102dp -= f6;
        }
        float f7 = m102dp / 2.0f;
        float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(this.circleRadius, (f7 - (AndroidUtilities.m102dp(16) * f)) - AndroidUtilities.m102dp(4)));
        float max2 = ((Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(this.circleRadius * f, f7 - (AndroidUtilities.m102dp(8) * f))) * 2.0f) - AndroidUtilities.dp2(16.0f)) * (1.0f - this.swipeToReleaseProgress);
        float f8 = this.swipeToReleaseProgress;
        float m102dp2 = max2 + (AndroidUtilities.m102dp(56) * f8);
        if (f8 < 1.0f || this.emptyStub) {
            float f9 = -m102dp;
            i3 = alpha2;
            i4 = alpha;
            float m102dp3 = ((-AndroidUtilities.m102dp(8)) * (1.0f - this.swipeToReleaseProgress)) + ((AndroidUtilities.m102dp(56) + f9) * this.swipeToReleaseProgress);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(f5 - max, f9, max + f5, m102dp3);
            if (this.swipeToReleaseProgress > BitmapDescriptorFactory.HUE_RED && !this.emptyStub) {
                float m102dp4 = AndroidUtilities.m102dp(16) * this.swipeToReleaseProgress;
                rectF.inset(m102dp4, m102dp4);
            }
            drawBackground(canvas, rectF);
            float m102dp5 = ((AndroidUtilities.m102dp(24) + f9) + (AndroidUtilities.m102dp(8) * (1.0f - f))) - (AndroidUtilities.m102dp(36) * this.swipeToReleaseProgress);
            canvas.save();
            rectF.inset(AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1));
            canvas.clipRect(rectF);
            float f10 = this.swipeToReleaseProgress;
            if (f10 > BitmapDescriptorFactory.HUE_RED) {
                this.arrowPaint.setAlpha((int) ((1.0f - f10) * 255.0f));
            }
            drawArrow(canvas, f5, m102dp5, AndroidUtilities.m102dp(24) * f);
            if (this.emptyStub) {
                i5 = 2;
                float dp2 = ((((-AndroidUtilities.m102dp(8)) - (AndroidUtilities.dp2(8.0f) * f)) - m102dp2) * (1.0f - this.swipeToReleaseProgress)) + ((f9 - AndroidUtilities.m102dp(2)) * this.swipeToReleaseProgress) + f6;
                this.arrowPaint.setAlpha(alpha4);
                canvas.save();
                canvas.scale(f, f, f5, AndroidUtilities.m102dp(28) + dp2);
                drawCheck(canvas, f5, dp2 + AndroidUtilities.m102dp(28));
                canvas.restore();
            } else {
                i5 = 2;
            }
        ...
        if (this.chatNameLayout != null && this.swipeToReleaseProgress > BitmapDescriptorFactory.HUE_RED) {
            ...
            this.textPaint.setAlpha(i8);
            float m102dp6 = ((AndroidUtilities.m102dp(20) * (1.0f - this.swipeToReleaseProgress)) - (AndroidUtilities.m102dp(36) * this.swipeToReleaseProgress)) + f6;
            RectF rectF2 = AndroidUtilities.rectTmp;
            int i10 = this.lastWidth;
            int i11 = this.chatNameWidth;
            rectF2.set((i10 - i11) / 2.0f, m102dp6, i10 - ((i10 - i11) / 2.0f), this.chatNameLayout.getHeight() + m102dp6);
            rectF2.inset(-AndroidUtilities.m102dp(8), -AndroidUtilities.m102dp(4));
            canvas.drawRoundRect(rectF2, AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(15), getThemedPaint("paintChatActionBackground"));
            if (hasGradientService()) {
                canvas.drawRoundRect(rectF2, AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(15), Theme.chat_actionBackgroundGradientDarkenPaint);
            }
            canvas.save();
            canvas.translate((this.lastWidth - this.chatNameWidth) / 2.0f, m102dp6);
            this.chatNameLayout.draw(canvas);
            canvas.restore();
        }
        if (this.emptyStub || m102dp2 <= BitmapDescriptorFactory.HUE_RED) {
            f3 = 1.0f;
        } else {
            f3 = 1.0f;
            float dp22 = ((((-AndroidUtilities.m102dp(8)) - (AndroidUtilities.dp2(8.0f) * f)) - m102dp2) * (1.0f - this.swipeToReleaseProgress)) + (((-m102dp) + AndroidUtilities.m102dp(4)) * this.swipeToReleaseProgress) + f6;
            float f11 = m102dp2 / 2.0f;
            this.imageReceiver.setRoundRadius((int) f11);
            this.imageReceiver.setImageCoords(f5 - f11, dp22, m102dp2, m102dp2);
            if (this.swipeToReleaseProgress > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.scale(f12, f12, f5 + AndroidUtilities.m102dp(12) + this.counterDrawable.getCenterX(), (dp22 - AndroidUtilities.m102dp(6)) + AndroidUtilities.m102dp(14));
                canvas.translate(f5 + AndroidUtilities.m102dp(12), dp22 - AndroidUtilities.m102dp(6));
                this.counterDrawable.updateBackgroundRect();
                this.counterDrawable.rectF.inset(-AndroidUtilities.m102dp(i12), -AndroidUtilities.m102dp(i12));
                ...
                canvas.scale(f13, f13, f5 + AndroidUtilities.m102dp(12) + this.counterDrawable.getCenterX(), (dp22 - AndroidUtilities.m102dp(6)) + AndroidUtilities.m102dp(14));
                canvas.translate(f5 + AndroidUtilities.m102dp(12), dp22 - AndroidUtilities.m102dp(6));
    ...
    private void drawCheck(Canvas canvas, float f, float f2) {
        if (this.animateCheck) {
            ...
            canvas.translate(f - AndroidUtilities.m102dp(24), f2 - AndroidUtilities.m102dp(24));
            float m102dp = AndroidUtilities.m102dp(16);
            float m102dp2 = AndroidUtilities.m102dp(26);
            float m102dp3 = AndroidUtilities.m102dp(22);
            float m102dp4 = AndroidUtilities.m102dp(32);
            float m102dp5 = AndroidUtilities.m102dp(32);
            float m102dp6 = AndroidUtilities.m102dp(20);
            float f8 = 1.0f - f6;
            canvas.drawLine(m102dp, m102dp2, (m102dp * f8) + (m102dp3 * f6), (f8 * m102dp2) + (f6 * m102dp4), this.arrowPaint);
            if (f7 > BitmapDescriptorFactory.HUE_RED) {
                float f9 = 1.0f - f7;
                canvas.drawLine(m102dp3, m102dp4, (m102dp3 * f9) + (m102dp5 * f7), (f9 * m102dp4) + (m102dp6 * f7), this.arrowPaint);
            }
            canvas.restore();
        }
    }
    ...
    private void drawArrow(Canvas canvas, float f, float f2, float f3) {
        ...
        canvas.scale(dpf2, dpf2, f, f2 - AndroidUtilities.m102dp(20));
        canvas.translate(f - AndroidUtilities.dp2(12.0f), f2 - AndroidUtilities.m102dp(12));
    ...
    public static TLRPC$Dialog getNextUnreadDialog(long j, int i, int i2, boolean z, int[] iArr) {
        ...
        while (i3 < dialogs.size()) {
            ...
            TLRPC$Chat chat = DialogObject.isChatDialog(tLRPC$Dialog.f1606id) ? messagesController.getChat(Long.valueOf(-tLRPC$Dialog.f1606id)) : tLRPC$Chat;
            ToolsController toolsController2 = toolsController;
            TLRPC$User user = DialogObject.isUserDialog(tLRPC$Dialog.f1606id) ? messagesController.getUser(Long.valueOf(tLRPC$Dialog.f1606id)) : null;
            if ((chat != null || (user != null && !user.self && !UserObject.isReplyUser(user) && UserObject.isLive(user))) && tLRPC$Dialog.f1606id != j && tLRPC$Dialog.unread_count > 0) {
                if (dialogType == DialogType.getDialogType(user != null ? user : chat) && !messagesController.isPromoDialog(tLRPC$Dialog.f1606id, false) && (user != null || MessagesController.getRestrictionReason(chat.restriction_reason) == null)) {
                    return tLRPC$Dialog;
                }
            }
            i3++;
        ...
        if (z) {
            if (i2 != 0) {
                for (int i4 = 0; i4 < messagesController.dialogFilters.size(); i4++) {
                    int i5 = messagesController.dialogFilters.get(i4).f1537id;
    ...
    */
    public void drawBottomPanel(android.graphics.Canvas r17, int r18, int r19, int r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.ChatPullingDownDrawable.drawBottomPanel(android.graphics.Canvas, int, int, int):void");
    }
