...
public class FilterCreateActivity extends JavaMvpFragment {
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(FilterCreateActivity filterCreateActivity, Context context) {
            ...
            if (filterActivityType == filterActivityType2) {
                this.imageView.setAnimation(C3630R.raw.fork_topic_new, 125, 125);
            } else {
                this.imageView.setAnimation(C3630R.raw.filter_new, 100, 100);
            }
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(156), 1073741824));
        }
    }
    ...
    public FilterCreateActivity(MessagesController.DialogFilter dialogFilter, ArrayList<Long> arrayList, TopicModel topicModel, Set<Long> set, FilterActivityType filterActivityType) {
        ...
        if (dialogFilter == null) {
            ...
            dialogFilter3.f1537id = 2;
            while (getMessagesController().dialogFiltersById.get(this.filter.f1537id) != null) {
                this.filter.f1537id++;
            }
            this.filter.name = "";
            this.creatingNew = true;
        }
        this.newFilterSettings = getFiltersController().getSettings(this.filter.f1537id).getCopy();
    ...
    private void updateRows(boolean z) {
        ...
        if (this.type == FilterActivityType.FILTER) {
            ...
            this.items.add(ItemInner.asShadow(LocaleController.getInternalString(C3630R.string.create_folder_change_fab_section_description)));
        }
        this.items.add(ItemInner.asHeader(this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3630R.string.topic_main_chats) : LocaleController.getString("FilterInclude", C3630R.string.FilterInclude)));
        this.items.add(ItemInner.asButton(C3630R.C3632drawable.msg2_chats_add, LocaleController.getString("FilterAddChats", C3630R.string.FilterAddChats), false).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_CONTACTS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterContacts", C3630R.string.FilterContacts), "contacts", MessagesController.DIALOG_FILTER_FLAG_CONTACTS));
        }
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_NON_CONTACTS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterNonContacts", C3630R.string.FilterNonContacts), "non_contacts", MessagesController.DIALOG_FILTER_FLAG_NON_CONTACTS));
        }
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_GROUPS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterGroups", C3630R.string.FilterGroups), "groups", MessagesController.DIALOG_FILTER_FLAG_GROUPS));
        }
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_CHANNELS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterChannels", C3630R.string.FilterChannels), "channels", MessagesController.DIALOG_FILTER_FLAG_CHANNELS));
        }
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_BOTS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterBots", C3630R.string.FilterBots), "bots", MessagesController.DIALOG_FILTER_FLAG_BOTS));
        }
        if (!this.newAlwaysShow.isEmpty()) {
            ...
            if (size != this.newAlwaysShow.size()) {
                this.items.add(ItemInner.asButton(C3630R.C3632drawable.arrow_more, LocaleController.formatPluralString("FilterShowMoreChats", this.newAlwaysShow.size() - 5, new Object[0]), false).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
        ...
        FilterActivityType filterActivityType = this.type;
        FilterActivityType filterActivityType2 = FilterActivityType.TOPIC;
        arrayList.add(ItemInner.asShadow(filterActivityType == filterActivityType2 ? LocaleController.getInternalString(C3630R.string.topic_add_main_chats_hint) : LocaleController.getString("FilterIncludeInfo", C3630R.string.FilterIncludeInfo)));
        if (!this.filter.isChatlist()) {
            ArrayList<ItemInner> arrayList2 = this.items;
            if (this.type == filterActivityType2) {
                i = C3630R.string.ArchivedChats;
                str = "ArchivedChats";
            } else {
                i = C3630R.string.FilterExclude;
                str = "FilterExclude";
            }
            arrayList2.add(ItemInner.asHeader(LocaleController.getString(str, i)));
            this.items.add(ItemInner.asButton(C3630R.C3632drawable.msg2_chats_add, this.type == filterActivityType2 ? LocaleController.getString("FilterAddChats", C3630R.string.FilterAddChats) : LocaleController.getString("FilterRemoveChats", C3630R.string.FilterRemoveChats), false).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED) != 0) {
                this.items.add(ItemInner.asChat(false, LocaleController.getString("FilterMuted", C3630R.string.FilterMuted), "muted", MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED));
            }
            if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_READ) != 0) {
                this.items.add(ItemInner.asChat(false, LocaleController.getString("FilterRead", C3630R.string.FilterRead), "read", MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_READ));
            }
            if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED) != 0) {
                this.items.add(ItemInner.asChat(false, LocaleController.getString("FilterArchived", C3630R.string.FilterArchived), "archived", MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED));
            }
            if (!this.newNeverShow.isEmpty()) {
                ...
                if (size2 != this.newNeverShow.size()) {
                    this.items.add(ItemInner.asButton(C3630R.C3632drawable.arrow_more, LocaleController.formatPluralString("FilterShowMoreChats", this.newNeverShow.size() - 5, new Object[0]), false).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda8
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
            ...
            this.items.add(ItemInner.asShadow(this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3630R.string.topic_add_archived_chats_hint) : LocaleController.getString("FilterExcludeInfo", C3630R.string.FilterExcludeInfo)));
        }
        if (this.type == FilterActivityType.FILTER) {
            if (this.invites.isEmpty()) {
                this.items.add(ItemInner.asHeader(LocaleController.getString("FilterShareFolder", C3630R.string.FilterShareFolder), true));
                this.items.add(ItemInner.asButton(C3630R.C3632drawable.msg2_link2, LocaleController.getString("FilterShareFolderButton", C3630R.string.FilterShareFolderButton), false));
                this.items.add(ItemInner.asShadow(LocaleController.getString("FilterInviteLinksHintNew", C3630R.string.FilterInviteLinksHintNew)));
            } else {
                this.items.add(ItemInner.asHeader(LocaleController.getString("FilterInviteLinks", C3630R.string.FilterInviteLinks), true));
                ...
                if (dialogFilter != null && dialogFilter.isChatlist()) {
                    string = LocaleController.getString("FilterInviteLinksHintNew", C3630R.string.FilterInviteLinksHintNew);
                } else {
                    string = LocaleController.getString("FilterInviteLinksHint", C3630R.string.FilterInviteLinksHint);
                }
                arrayList3.add(ItemInner.asShadow(string));
            }
        }
        if (!this.creatingNew) {
            this.items.add(ItemInner.asButton(0, this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3630R.string.topics_remove) : LocaleController.getString("FilterDelete", C3630R.string.FilterDelete), true).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda10
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public View createView(Context context) {
        ...
        if (this.creatingNew) {
            if (this.type == FilterActivityType.TOPIC) {
                this.actionBar.setTitle(LocaleController.getInternalString(C3630R.string.topic_new));
            } else {
                this.actionBar.setTitle(LocaleController.getString("FilterNew", C3630R.string.FilterNew));
            }
        } else {
            TextPaint textPaint = new TextPaint(1);
            textPaint.setTextSize(AndroidUtilities.m102dp(20));
            if (this.type == FilterActivityType.TOPIC) {
                if (this.topic.isUserTopic()) {
                    this.actionBar.setTitle(Emoji.replaceEmoji(this.topic.getName(), textPaint.getFontMetricsInt(), AndroidUtilities.m102dp(20), false));
                ...
                this.actionBar.setTitle(Emoji.replaceEmoji(this.filter.name, textPaint.getFontMetricsInt(), AndroidUtilities.m102dp(20), false));
            }
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.FilterCreateActivity.1
            {
        ...
        this.doneItem = createMenu.addItem(1, LocaleController.getString("Save", C3630R.string.Save).toUpperCase());
    ...
    public /* synthetic */ void lambda$createView$10(View view, int i, float f, float f2) {
        ...
        if (itemInner.onClickListener == null) {
            ...
            } else if (i2 == 8 || (i2 == 4 && itemInner.iconResId == C3630R.C3632drawable.msg2_link2)) {
    ...
    private void onClickCreateLink(View view) {
        if (this.creatingNew && this.doneItem.getAlpha() > BitmapDescriptorFactory.HUE_RED) {
            ...
            if (TextUtils.isEmpty(this.newFilterName) && TextUtils.isEmpty(this.filter.name)) {
                BulletinFactory.m61of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorEmptyName", C3630R.string.FilterInviteErrorEmptyName)).show();
                ...
                if (!this.newNeverShow.isEmpty()) {
                    BulletinFactory.m61of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorTypesExcluded", C3630R.string.FilterInviteErrorTypesExcluded)).show();
                } else {
                    BulletinFactory.m61of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorTypes", C3630R.string.FilterInviteErrorTypes)).show();
                }
            } else if (this.newAlwaysShow.isEmpty()) {
                BulletinFactory.m61of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorEmpty", C3630R.string.FilterInviteErrorEmpty)).show();
            } else {
                BulletinFactory.m61of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorExcluded", C3630R.string.FilterInviteErrorExcluded)).show();
            }
        } else {
    ...
    public /* synthetic */ void lambda$onClickCreateLink$13(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        if (processErrors(tLRPC$TL_error, this, BulletinFactory.m61of(this)) && (tLObject instanceof TLRPC$TL_chatlists_exportedChatlistInvite)) {
            hideNew(0);
    ...
    private void showSaveHint() {
        ...
        if (hintView == null || hintView.getVisibility() != 0) {
            ...
            this.saveHintView.setExtraTranslationY(AndroidUtilities.m102dp(-16));
            this.saveHintView.setText(LocaleController.getString("FilterFinishCreating", C3630R.string.FilterFinishCreating));
    ...
    public void deleteFolder(View view) {
        MessagesController.DialogFilter dialogFilter = this.filter;
        if (dialogFilter != null && dialogFilter.isChatlist()) {
            FolderBottomSheet.showForDeletion(this, this.filter.f1537id, new Utilities.Callback() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda24
        ...
        FilterActivityType filterActivityType = this.type;
        FilterActivityType filterActivityType2 = FilterActivityType.TOPIC;
        builder.setTitle(filterActivityType == filterActivityType2 ? LocaleController.getInternalString(C3630R.string.topics_remove) : LocaleController.getString("FilterDelete", C3630R.string.FilterDelete));
        builder.setMessage(this.type == filterActivityType2 ? LocaleController.getInternalString(C3630R.string.topics_remove_alert) : LocaleController.getString("FilterDeleteAlert", C3630R.string.FilterDeleteAlert));
        builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("Delete", C3630R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda3
    ...
    public /* synthetic */ void lambda$deleteFolder$19(DialogInterface dialogInterface, int i) {
        ...
        tLRPC$TL_messages_updateDialogFilter.f1721id = this.filter.f1537id;
    ...
    private void selectChatsFor(final boolean z) {
        ...
        usersSelectActivity.setDelegate(new UsersSelectActivity.FilterUsersActivityDelegate() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda34
            @Override // org.telegram.p042ui.UsersSelectActivity.FilterUsersActivityDelegate
            ...
            if (TextUtils.isEmpty(this.newFilterName) || !this.nameChangedManually) {
                ...
                if ((i3 & i2) == i2) {
                    if ((MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_READ & i) != 0) {
                        string = LocaleController.getString("FilterNameUnread", C3630R.string.FilterNameUnread);
                    } else {
                        if ((i & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED) != 0) {
                            string = LocaleController.getString("FilterNameNonMuted", C3630R.string.FilterNameNonMuted);
                        }
                        string = "";
                    }
                } else {
                    ...
                    if ((i3 & i4) != 0) {
                        if (((~i4) & i3) == 0) {
                            string = LocaleController.getString("FilterContacts", C3630R.string.FilterContacts);
                        }
                        string = "";
                    } else {
                        ...
                        if ((i3 & i5) != 0) {
                            if (((~i5) & i3) == 0) {
                                string = LocaleController.getString("FilterNonContacts", C3630R.string.FilterNonContacts);
                            }
                            string = "";
                        } else {
                            ...
                            if ((i3 & i6) != 0) {
                                if (((~i6) & i3) == 0) {
                                    string = LocaleController.getString("FilterGroups", C3630R.string.FilterGroups);
                                }
                                string = "";
                            } else {
                                ...
                                if ((i3 & i7) != 0) {
                                    if (((~i7) & i3) == 0) {
                                        string = LocaleController.getString("FilterBots", C3630R.string.FilterBots);
                                    }
                                    string = "";
                                } else {
                                    int i8 = MessagesController.DIALOG_FILTER_FLAG_CHANNELS;
                                    if ((i3 & i8) != 0 && ((~i8) & i3) == 0) {
                                        string = LocaleController.getString("FilterChannels", C3630R.string.FilterChannels);
                                    }
                                    string = "";
                                }
                            }
    ...
    public boolean checkDiscard() {
        if (this.doneItem.getAlpha() == 1.0f) {
            ...
            if (this.creatingNew) {
                FilterActivityType filterActivityType = this.type;
                FilterActivityType filterActivityType2 = FilterActivityType.TOPIC;
                builder.setTitle(filterActivityType == filterActivityType2 ? LocaleController.getInternalString(C3630R.string.topic_create_discard_title) : LocaleController.getString("FilterDiscardNewTitle", C3630R.string.FilterDiscardNewTitle));
                builder.setMessage(this.type == filterActivityType2 ? LocaleController.getInternalString(C3630R.string.topic_create_discard_message) : LocaleController.getString("FilterDiscardNewAlert", C3630R.string.FilterDiscardNewAlert));
                builder.setPositiveButton(LocaleController.getString("FilterDiscardNewSave", C3630R.string.FilterDiscardNewSave), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder.setTitle(LocaleController.getString("FilterDiscardTitle", C3630R.string.FilterDiscardTitle));
                builder.setMessage(this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3630R.string.topic_edit_discard_message) : LocaleController.getString("FilterDiscardAlert", C3630R.string.FilterDiscardAlert));
                builder.setPositiveButton(LocaleController.getString("ApplyTheme", C3630R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder.setNegativeButton(LocaleController.getString("PassportDiscard", C3630R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showRemoveAlert(final ItemInner itemInner, CharSequence charSequence, Object obj, final boolean z) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        if (this.type == FilterActivityType.TOPIC) {
            builder.setTitle(LocaleController.getInternalString(C3630R.string.topic_remove_chat_title));
            builder.setMessage(LocaleController.formatStringInternal(C3630R.string.topic_remove_chat_message, charSequence));
        } else if (z) {
            builder.setTitle(LocaleController.getString("FilterRemoveInclusionTitle", C3630R.string.FilterRemoveInclusionTitle));
            if (obj instanceof String) {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionText", C3630R.string.FilterRemoveInclusionText, charSequence));
            } else if (obj instanceof TLRPC$User) {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionUserText", C3630R.string.FilterRemoveInclusionUserText, charSequence));
            } else {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionChatText", C3630R.string.FilterRemoveInclusionChatText, charSequence));
            }
        } else {
            builder.setTitle(LocaleController.getString("FilterRemoveExclusionTitle", C3630R.string.FilterRemoveExclusionTitle));
            if (obj instanceof String) {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionText", C3630R.string.FilterRemoveExclusionText, charSequence));
            } else if (obj instanceof TLRPC$User) {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionUserText", C3630R.string.FilterRemoveExclusionUserText, charSequence));
            } else {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionChatText", C3630R.string.FilterRemoveExclusionChatText, charSequence));
            }
        }
        builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("StickersRemove", C3630R.string.StickersRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void lambda$processDone$25() {
        ...
        if (this.doNotCloseWhenSave) {
            ...
            TextPaint textPaint = new TextPaint(1);
            textPaint.setTextSize(AndroidUtilities.m102dp(20));
            this.actionBar.setTitleAnimated(Emoji.replaceEmoji(this.filter.name, textPaint.getFontMetricsInt(), AndroidUtilities.m102dp(20), false), true, 220L);
            return;
        }
        finishFragment();
    }
    ...
    public static void saveFilterToServer(final MessagesController.DialogFilter dialogFilter, final int i, final String str, final ArrayList<Long> arrayList, final ArrayList<Long> arrayList2, final LongSparseIntArray longSparseIntArray, final boolean z, final boolean z2, final boolean z3, final boolean z4, final boolean z5, final BaseFragment baseFragment, final Runnable runnable) {
        ...
        tLRPC$TL_dialogFilter.f1607id = dialogFilter.f1537id;
    ...
    private boolean hasChanges() {
        ...
        if (filterActivityType == FilterActivityType.TOPIC) {
            ...
            FilterSettingsModel copy = getFiltersController().getSettings(this.filter.f1537id).getCopy();
    ...
    public class ListAdapter extends AdapterWithDiffUtils {
            ...
            if (i == IdFabric$ViewTypes.FLOATING_ACTION_BUTTON) {
                ...
                switch (i) {
                    ...
                    case 7:
                        ...
                        headerCell = new LinkCell(context, filterCreateActivity3, ((BaseFragment) filterCreateActivity3).currentAccount, FilterCreateActivity.this.filter.f1537id) { // from class: org.telegram.ui.FilterCreateActivity.ListAdapter.2
                            {
                                ListAdapter.this = this;
                            }

                            @Override // org.telegram.p042ui.FilterCreateActivity.LinkCell
        ...
        public void onViewAttachedToWindow(RecyclerView.ViewHolder viewHolder) {
            if (viewHolder.getItemViewType() == 2) {
                ...
                pollEditTextCell.setTag(1);
                pollEditTextCell.setTextAndHint(FilterCreateActivity.this.newFilterName != null ? FilterCreateActivity.this.newFilterName : "", FilterCreateActivity.this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3630R.string.topic_name_hint) : LocaleController.getString("FilterNameHint", C3630R.string.FilterNameHint), false);
                pollEditTextCell.setTag(null);
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (j > 0) {
                    ...
                    if (user != null) {
                        if (user.bot) {
                            string2 = LocaleController.getString("Bot", C3630R.string.Bot);
                        } else if (user.contact) {
                            string2 = LocaleController.getString("FilterContact", C3630R.string.FilterContact);
                        } else {
                            string2 = LocaleController.getString("FilterNonContact", C3630R.string.FilterNonContact);
                        }
                ...
                if (chat != null) {
                    if (chat.participants_count != 0) {
                        ...
                        if (ChatObject.isChannel(chat) && !chat.megagroup) {
                            string = LocaleController.getString("ChannelPrivate", C3630R.string.ChannelPrivate);
                        } else {
                            string = LocaleController.getString("MegaPrivate", C3630R.string.MegaPrivate);
                        }
                    } else if (ChatObject.isChannel(chat) && !chat.megagroup) {
                        string = LocaleController.getString("ChannelPublic", C3630R.string.ChannelPublic);
                    } else {
    ...
    private static class ButtonCell extends FrameLayout {
        ...
        public void set(int i, CharSequence charSequence, boolean z) {
            ...
            if (LocaleController.isRTL) {
                ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).rightMargin = AndroidUtilities.m102dp(i != 0 ? 72 : 24);
            } else {
                ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).leftMargin = AndroidUtilities.m102dp(i != 0 ? 72 : 24);
            }
            ...
            if (bool == null || bool.booleanValue() != z2) {
                ...
                if (i3 == i) {
                    ...
                    if (z2) {
                        f = AndroidUtilities.m102dp(i2 * (-7));
                    }
    ...
    private static class CreateLinkCell extends FrameLayout {
        ...
        public CreateLinkCell(Context context) {
            ...
            this.textView.setText(LocaleController.getString("CreateNewLink", C3630R.string.CreateNewLink));
            this.textView.setGravity(LocaleController.isRTL ? 5 : 3);
            TextView textView2 = this.textView;
            boolean z = LocaleController.isRTL;
            ...
            Drawable drawable = context.getResources().getDrawable(C3630R.C3632drawable.poll_add_circle);
            Drawable drawable2 = context.getResources().getDrawable(C3630R.C3632drawable.poll_add_plus);
    ...
    public static class LinkCell extends FrameLayout {
        ...
        public LinkCell(Context context, BaseFragment baseFragment, int i, int i2) {
            ...
            animatedTextView.setTextSize(AndroidUtilities.m103dp(15.66f));
            ...
            animatedTextView3.setTextSize(AndroidUtilities.m102dp(13));
            ...
            Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.msg_link_1).mutate();
            this.linkIcon = mutate;
            mutate.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
            Drawable mutate2 = getContext().getResources().getDrawable(C3630R.C3632drawable.msg_link_2).mutate();
        ...
        protected void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            int measuredWidth = LocaleController.isRTL ? getMeasuredWidth() - AndroidUtilities.m102dp(32) : AndroidUtilities.m102dp(32);
            float f = measuredWidth;
            canvas.drawCircle(f, getMeasuredHeight() / 2.0f, AndroidUtilities.m102dp(16), this.paint);
            float f2 = this.revokeT;
            float f3 = BitmapDescriptorFactory.HUE_RED;
            if (f2 > BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(f, getMeasuredHeight() / 2.0f, AndroidUtilities.m102dp(16) * this.revokeT, this.revokedPaint);
            }
            float f4 = this.revokeT;
            if (f4 < 1.0f) {
                this.linkIcon.setAlpha((int) ((1.0f - f4) * 255.0f));
                this.linkIcon.setBounds(measuredWidth - AndroidUtilities.m102dp(14), (getMeasuredHeight() / 2) - AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(14) + measuredWidth, (getMeasuredHeight() / 2) + AndroidUtilities.m102dp(14));
                this.linkIcon.draw(canvas);
            }
            float f5 = this.revokeT;
            if (f5 > BitmapDescriptorFactory.HUE_RED) {
                this.revokedLinkIcon.setAlpha((int) (f5 * 255.0f));
                this.revokedLinkIcon.setBounds(measuredWidth - AndroidUtilities.m102dp(14), (getMeasuredHeight() / 2) - AndroidUtilities.m102dp(14), measuredWidth + AndroidUtilities.m102dp(14), (getMeasuredHeight() / 2) + AndroidUtilities.m102dp(14));
                this.revokedLinkIcon.draw(canvas);
            }
            if (this.needDivider) {
                if (!LocaleController.isRTL) {
                    f3 = AndroidUtilities.m102dp(64);
                }
                canvas.drawRect(f3, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m102dp(64) : 0), getMeasuredHeight(), Theme.dividerPaint);
            }
        }
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(60), 1073741824));
        }
        ...
        public void options() {
            ...
            makeOptions.add(C3630R.C3632drawable.msg_qrcode, LocaleController.getString("GetQRCode", C3630R.string.GetQRCode), new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$LinkCell$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    FilterCreateActivity.LinkCell.this.qrcode();
                }
            });
            makeOptions.add(C3630R.C3632drawable.msg_delete, (CharSequence) LocaleController.getString("DeleteLink", C3630R.string.DeleteLink), true, new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$LinkCell$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$deleteLink$5(TLRPC$TL_error tLRPC$TL_error, Runnable runnable) {
            if (tLRPC$TL_error != null) {
                BulletinFactory.m61of(this.fragment).createErrorBulletin(LocaleController.getString("UnknownError", C3630R.string.UnknownError)).show();
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            sb.append(str);
            sb.append(LocaleController.getString("InviteLink", C3630R.string.InviteLink));
            sb.append(", ");
    ...
    public static CharSequence withNew(int i, CharSequence charSequence, boolean z) {
        ...
        if (i >= 0) {
            ...
            if (z) {
                Drawable mutate = context.getResources().getDrawable(C3630R.C3632drawable.msg_other_new_outline).mutate();
                mutate.setBounds(0, -AndroidUtilities.m102dp(8), mutate.getIntrinsicWidth(), mutate.getIntrinsicHeight() - AndroidUtilities.m102dp(8));
                spannableString.setSpan(new ColorImageSpan(mutate, 0), 0, spannableString.length(), 33);
            } else {
                Drawable mutate2 = context.getResources().getDrawable(C3630R.C3632drawable.msg_other_new_filled).mutate();
                Drawable mutate3 = context.getResources().getDrawable(C3630R.C3632drawable.msg_other_new_filled_text).mutate();
    ...
    public static class NewSpan extends ReplacementSpan {
        ...
        public NewSpan(boolean z) {
            ...
            if (z) {
                ...
                this.textPaint.setTextSize(AndroidUtilities.m102dp(10));
        ...
        public NewSpan(float f) {
            ...
            this.textPaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
            this.bgPaint.setStyle(Paint.Style.FILL);
            this.textPaint.setTextSize(AndroidUtilities.m103dp(f));
        }
        ...
        public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
            makeLayout();
            return (int) (AndroidUtilities.m102dp(10) + this.width);
        }
        ...
        public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
            ...
            float m102dp = f + AndroidUtilities.m102dp(2);
            float m102dp2 = (i4 - this.height) + AndroidUtilities.m102dp(1);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(m102dp, m102dp2, this.width + m102dp, this.height + m102dp2);
            if (this.outline) {
                m103dp = AndroidUtilities.m103dp(3.66f);
                rectF.left -= AndroidUtilities.m102dp(4);
                rectF.top -= AndroidUtilities.m103dp(2.33f);
                rectF.right += AndroidUtilities.m103dp(3.66f);
                rectF.bottom += AndroidUtilities.m103dp(1.33f);
            } else {
                m103dp = AndroidUtilities.m103dp(4.4f);
                rectF.inset(AndroidUtilities.m102dp(-4), AndroidUtilities.m103dp(-2.33f));
            }
            canvas.drawRoundRect(rectF, m103dp, m103dp, this.bgPaint);
            canvas.save();
            canvas.translate(m102dp, m102dp2);
    ...
    public /* synthetic */ void lambda$onUpdate$31(boolean z, int i) {
        ...
        BulletinFactory m61of = BulletinFactory.m61of(this);
        int i2 = z ? C3630R.raw.folder_in : C3630R.raw.folder_out;
        if (z) {
        ...
        m61of.createSimpleBulletin(i2, formatPluralString, LocaleController.getString("FolderLinkChatlistUpdate", C3630R.string.FolderLinkChatlistUpdate)).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
    }
    ...
    public static class FilterInvitesBottomSheet extends BottomSheetWithRecyclerListView {
        ...
        public static void show(final BaseFragment baseFragment, final MessagesController.DialogFilter dialogFilter, final Runnable runnable) {
            ...
            TLRPC$TL_inputChatlistDialogFilter tLRPC$TL_inputChatlistDialogFilter = new TLRPC$TL_inputChatlistDialogFilter();
            tLRPC$TL_chatlists_getExportedInvites.chatlist = tLRPC$TL_inputChatlistDialogFilter;
            tLRPC$TL_inputChatlistDialogFilter.filter_id = dialogFilter.f1537id;
        ...
        public static /* synthetic */ void lambda$show$0(BaseFragment baseFragment, TLObject tLObject, MessagesController.DialogFilter dialogFilter, TLRPC$TL_error tLRPC$TL_error, Runnable runnable, long j) {
            ...
            if (tLObject instanceof TLRPC$TL_chatlists_exportedInvites) {
                ...
                BulletinFactory.m61of(baseFragment).createErrorBulletin(LocaleController.getString("UnknownError", C3630R.string.UnknownError)).show();
            }
            if (runnable != null) {
        ...
        public FilterInvitesBottomSheet(BaseFragment baseFragment, MessagesController.DialogFilter dialogFilter, ArrayList<TLRPC$TL_exportedChatlistInvite> arrayList) {
            ...
            this.button.setText(LocaleController.getString("FolderLinkShareButton", C3630R.string.FolderLinkShareButton));
        ...
        public void updateCreateInviteButton() {
            ...
            this.recyclerListView.setPadding(AndroidUtilities.m102dp(6), 0, AndroidUtilities.m102dp(6), this.invites.isEmpty() ? AndroidUtilities.m102dp(68) : 0);
        }

        @Override // org.telegram.p042ui.Components.BottomSheetWithRecyclerListView
        protected CharSequence getTitle() {
            int i = C3630R.string.FolderLinkShareTitle;
            ...
            AdapterWithDiffUtils adapterWithDiffUtils = new AdapterWithDiffUtils() { // from class: org.telegram.ui.FilterCreateActivity.FilterInvitesBottomSheet.1
                ...
                public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                    ...
                    if (i == 8) {
                        ...
                        textInfoPrivacyCell = new C60271(FilterInvitesBottomSheet.this.getContext(), null, ((BottomSheet) FilterInvitesBottomSheet.this).currentAccount, FilterInvitesBottomSheet.this.filter.f1537id);
                        textInfoPrivacyCell.setBackgroundColor(Theme.getColor(Theme.key_dialogBackground));
                    } else if (i == 6 || i == 3) {
                ...
                /* loaded from: classes5.dex */
                public class C60271 extends LinkCell {
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C60271(Context context, BaseFragment baseFragment, int i, int i2) {
                    ...
                    public void options() {
                        ...
                        makeOptions.add(C3630R.C3632drawable.msg_copy, LocaleController.getString("CopyLink", C3630R.string.CopyLink), new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$FilterInvitesBottomSheet$1$1$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                FilterCreateActivity.FilterInvitesBottomSheet.C60261.C60271.this.copy();
                            }
                        });
                        makeOptions.add(C3630R.C3632drawable.msg_qrcode, LocaleController.getString("GetQRCode", C3630R.string.GetQRCode), new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$FilterInvitesBottomSheet$1$1$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                FilterCreateActivity.FilterInvitesBottomSheet.C60261.C60271.this.qrcode();
                            }
                        });
                        makeOptions.add(C3630R.C3632drawable.msg_delete, (CharSequence) LocaleController.getString("DeleteLink", C3630R.string.DeleteLink), true, new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$FilterInvitesBottomSheet$1$1$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                FilterCreateActivity.FilterInvitesBottomSheet.C60261.C60271.this.deleteLink();
                            }
                        });
                        if (LocaleController.isRTL) {
                            makeOptions.setGravity(3);
                    ...
                    public void copy() {
                        ...
                        if (str != null && AndroidUtilities.addToClipboard(str)) {
                            BulletinFactory.m62of(FilterInvitesBottomSheet.this.bulletinContainer, null).createCopyLinkBulletin().show();
                        }
                    }
                ...
                public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    if (itemViewType == 7) {
                        ...
                        if (itemViewType != 0 && itemViewType == 8) {
                            ...
                            createLinkCell.setText(LocaleController.getString("CreateNewInviteLink", C3630R.string.CreateNewInviteLink));
                        ...
                        textInfoPrivacyCell.setForeground(Theme.getThemedDrawableByKey(FilterInvitesBottomSheet.this.getContext(), z ? C3630R.C3632drawable.greydivider : C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    }
                }
        ...
        public class HeaderView extends FrameLayout {
            ...
            public HeaderView(Context context) {
                ...
                this.imageView = imageView;
                imageView.setScaleType(ImageView.ScaleType.CENTER);
                imageView.setImageResource(C3630R.C3632drawable.msg_limit_links);
                imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
                imageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m102dp(22), Theme.getColor(Theme.key_featuredStickers_addButton)));
                ...
                if (r12.invites.isEmpty()) {
                    string = LocaleController.getString("FolderLinkShareSubtitleEmpty", C3630R.string.FolderLinkShareSubtitleEmpty);
                } else {
                    string = LocaleController.getString("FolderLinkShareSubtitle", C3630R.string.FolderLinkShareSubtitle);
                }
                ...
                imageView2.setImageResource(C3630R.C3632drawable.msg_close);
            ...
            @Override // android.widget.FrameLayout, android.view.View
            protected void onMeasure(int i, int i2) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(171), 1073741824));
            }
        }
        ...
        public /* synthetic */ void lambda$createLink$3(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
            if (FilterCreateActivity.processErrors(tLRPC$TL_error, getBaseFragment(), BulletinFactory.m62of(this.bulletinContainer, null)) && (tLObject instanceof TLRPC$TL_chatlists_exportedChatlistInvite)) {
    ...
    public static boolean processErrors(TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, BulletinFactory bulletinFactory) {
        if (tLRPC$TL_error != null && !TextUtils.isEmpty(tLRPC$TL_error.text)) {
            if ("INVITE_PEERS_TOO_MUCH".equals(tLRPC$TL_error.text)) {
                ...
                bulletinFactory.createErrorBulletin(LocaleController.getString("FolderLinkNoChatsError", C3630R.string.FolderLinkNoChatsError)).show();
            } else if ("USER_CHANNELS_TOO_MUCH".equals(tLRPC$TL_error.text)) {
                bulletinFactory.createErrorBulletin(LocaleController.getString("FolderLinkOtherAdminLimitError", C3630R.string.FolderLinkOtherAdminLimitError)).show();
                ...
                bulletinFactory.createErrorBulletin(LocaleController.getString("NoFolderFound", C3630R.string.NoFolderFound)).show();
                ...
                bulletinFactory.createErrorBulletin(LocaleController.getString("UnknownError", C3630R.string.UnknownError)).show();
            }
        }
        return true;
    }
