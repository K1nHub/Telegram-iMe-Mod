...
public class PhotoPickerSearchActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        c3702ActionBar2.setItemsBackgroundColor(Theme.getColor(i2), false);
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PhotoPickerSearchActivity.1
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C3630R.C3632drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.PhotoPickerSearchActivity.2
        ...
        this.scrollSlidingTextTabStrip.setDelegate(new ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate() { // from class: org.telegram.ui.PhotoPickerSearchActivity.3
            ...
            public void onPageSelected(int i4, boolean z) {
                ...
                if (i4 == 0) {
                    PhotoPickerSearchActivity.this.searchItem.setSearchFieldHint(LocaleController.getString("SearchImagesTitle", C3630R.string.SearchImagesTitle));
                } else {
                    PhotoPickerSearchActivity.this.searchItem.setSearchFieldHint(LocaleController.getString("SearchGifsTitle", C3630R.string.SearchGifsTitle));
                }
            }
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.PhotoPickerSearchActivity.4
            ...
            protected void onMeasure(int i4, int i5) {
                ...
                for (int i6 = 0; i6 < PhotoPickerSearchActivity.this.viewPages.length; i6++) {
                    if (PhotoPickerSearchActivity.this.viewPages[i6] != null && PhotoPickerSearchActivity.this.viewPages[i6].listView != null) {
                        PhotoPickerSearchActivity.this.viewPages[i6].listView.setPadding(AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4) + measuredHeight, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4));
                    }
                }
                this.globalIgnoreLayout = false;
            ...
            */
            public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.PhotoPickerSearchActivity.C65914.onLayout(boolean, int, int, int, int):void");
            }
                    ...
                    if (this.startedTracking) {
                        ...
                        PhotoPickerSearchActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.PhotoPickerSearchActivity.4.1
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                PhotoPickerSearchActivity.this.tabsAnimationInProgress = false;
                                C65914.this.maybeStartTracking = false;
                                C65914.this.startedTracking = false;
    ...
    public void setDelegate(PhotoPickerActivity.PhotoPickerActivityDelegate photoPickerActivityDelegate) {
        ...
        this.imagesSearch.setSearchDelegate(new PhotoPickerActivity.PhotoPickerActivitySearchDelegate() { // from class: org.telegram.ui.PhotoPickerSearchActivity.7
            @Override // org.telegram.p042ui.PhotoPickerActivity.PhotoPickerActivitySearchDelegate
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString("ImagesTab2", C3630R.string.ImagesTab2));
        this.scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString("GifsTab2", C3630R.string.GifsTab2));
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(c3702ActionBar2, i5, null, null, null, null, i6));
