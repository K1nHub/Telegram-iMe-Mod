...
/* renamed from: org.telegram.ui.BlurSettingsBottomSheet */
...
public class BlurSettingsBottomSheet extends BottomSheet {
    ...
    private BlurSettingsBottomSheet(BaseFragment baseFragment) {
        ...
        linearLayout.addView(textView, LayoutHelper.createFrame(-2, -1, (LocaleController.isRTL ? 3 : 5) | 48, 21, 13, 21, 0));
        ...
        linearLayout.addView(seekBarView, LayoutHelper.createFrame(-1, 38, 0, 5, 4, 5, 0));
        ...
        linearLayout.addView(textView2, LayoutHelper.createFrame(-2, -1, (LocaleController.isRTL ? 3 : 5) | 48, 21, 13, 21, 0));
        ...
        linearLayout.addView(seekBarView2, LayoutHelper.createFrame(-1, 38, 0, 5, 4, 5, 0));
        ...
        linearLayout.addView(textView3, LayoutHelper.createFrame(-2, -1, (LocaleController.isRTL ? 3 : 5) | 48, 21, 13, 21, 0));
        ...
        linearLayout.addView(seekBarView3, LayoutHelper.createFrame(-1, 38, 0, 5, 4, 5, 0));
        linearLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener(this) { // from class: org.telegram.ui.BlurSettingsBottomSheet.4
