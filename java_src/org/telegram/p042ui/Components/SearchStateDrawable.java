...
public class SearchStateDrawable extends Drawable {
    ...
    /* renamed from: cx */
    private float f1934cx;

    /* renamed from: cy */
    private float f1935cy;
    private Runnable delaySetProgress;
    private int fromState;

    /* renamed from: mn */
    private float f1936mn;
    private Paint paint;
    ...
    public SearchStateDrawable() {
        ...
        this.paint.setStrokeWidth(AndroidUtilities.m103dp(1.333f));
    }
    ...
    public void draw(Canvas canvas) {
        ...
        this.f1936mn = Math.min(bounds.width(), bounds.height());
        this.f1934cx = bounds.centerX();
        this.f1935cy = bounds.centerY();
        int i2 = this.alpha;
        if (i2 < 255) {
        ...
        if (i6 > 0 || f9 > BitmapDescriptorFactory.HUE_RED) {
            canvas.save();
            canvas.rotate(f8 * 45.0f, this.f1934cx, this.f1935cy);
            f2 = 0.75f;
            f3 = 0.5f;
            f4 = 0.2409f;
            f5 = f;
    ...
    private float m57x(float f) {
        return this.f1934cx - (this.f1936mn * (0.5f - f));
    }

    /* renamed from: y */
    private float m56y(float f) {
        return this.f1935cy - (this.f1936mn * (0.5f - f));
    }

    /* renamed from: w */
    private float m58w(float f) {
        return this.f1936mn * f;
    }
