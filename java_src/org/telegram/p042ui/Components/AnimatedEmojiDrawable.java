...
public class AnimatedEmojiDrawable extends Drawable {
    ...
    public static AnimatedEmojiDrawable make(int i, int i2, TLRPC$Document tLRPC$Document) {
        ...
        AnimatedEmojiDrawable animatedEmojiDrawable = longSparseArray.get(tLRPC$Document.f1608id);
        if (animatedEmojiDrawable == null) {
            long j = tLRPC$Document.f1608id;
        ...
        private boolean checkThread() {
            if (Thread.currentThread() != Looper.getMainLooper().getThread()) {
                if (BuildVars.DEBUG_VERSION) {
                    FileLog.m98e("EmojiDocumentFetcher", new IllegalStateException("Wrong thread"));
                    return false;
                }
                return false;
            }
                ...
                while (queryFinalized.next()) {
                    ...
                    try {
                        ...
                        if (TLdeserialize != null && TLdeserialize.f1608id != 0) {
                            ...
                            hashSet.remove(Long.valueOf(TLdeserialize.f1608id));
                        }
                    } catch (Exception e) {
                        FileLog.m97e(e);
                    }
            ...
            if (tLObject instanceof TLRPC$Vector) {
                ...
                for (int i = 0; i < arrayList2.size(); i++) {
                    if (arrayList2.get(i) instanceof TLRPC$Document) {
                        hashSet.remove(Long.valueOf(((TLRPC$Document) arrayList2.get(i)).f1608id));
                    }
                }
                if (hashSet.isEmpty()) {
                    return;
        ...
        */
        public /* synthetic */ void lambda$putToStorage$7(java.util.ArrayList r7) {
            ...
            L11:
                ...
                long r2 = r2.f1608id     // Catch: java.lang.Exception -> L43
                r5 = 1
            ...
            L5b:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.AnimatedEmojiDrawable.EmojiDocumentFetcher.lambda$putToStorage$7(java.util.ArrayList):void");
        }
            ...
            if (checkThread()) {
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    if (arrayList.get(i) instanceof TLRPC$Document) {
                        ...
                        if (hashMap != null && (remove = hashMap.remove(Long.valueOf(tLRPC$Document.f1608id))) != null) {
        ...
        public void putDocument(TLRPC$Document tLRPC$Document) {
            ...
            synchronized (this) {
                ...
                this.emojiDocumentsCache.put(Long.valueOf(tLRPC$Document.f1608id), tLRPC$Document);
            }
        }
    ...
    public long getDocumentId() {
        ...
        return tLRPC$Document != null ? tLRPC$Document.f1608id : this.documentId;
    }
    ...
    private void initDocument(boolean z) {
        ...
        if (this.document != null) {
            ...
            if (imageReceiver == null || z) {
                ...
                this.imageReceiver.setRoundRadius((i9 == 5 || i9 == 6) ? AndroidUtilities.m102dp(6) : i2);
                updateAttachState();
                invalidate();
            }
        }
    ...
    */
    public boolean isDefaultStatusEmoji() {
        ...
        L3a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.AnimatedEmojiDrawable.isDefaultStatusEmoji():boolean");
    }
    ...
    public static class SwapAnimatedEmojiDrawable extends Drawable implements AnimatedEmojiSpan.InvalidateHolder {
            ...
            if (this.drawables[0] != null) {
                ...
                if (drawableArr3[0] instanceof AnimatedEmojiDrawable) {
                    if (((AnimatedEmojiDrawable) drawableArr3[0]).imageReceiver != null) {
                        ((AnimatedEmojiDrawable) this.drawables[0]).imageReceiver.setRoundRadius(AndroidUtilities.m102dp(4));
                    }
                    if (f < 1.0f) {
        ...
        public void set(TLRPC$Document tLRPC$Document, int i, boolean z) {
            Drawable[] drawableArr = this.drawables;
            if ((drawableArr[0] instanceof AnimatedEmojiDrawable) && tLRPC$Document != null && ((AnimatedEmojiDrawable) drawableArr[0]).getDocumentId() == tLRPC$Document.f1608id) {
                return;
            }
            if (z) {
                this.changeProgress.set(BitmapDescriptorFactory.HUE_RED, true);
