package org.telegram.p042ui.Components.Crop;
...
public class CropAreaView extends ViewGroup {
    ...
    /* renamed from: tx */
    public float f1828tx;

    /* renamed from: ty */
    public float f1829ty;
    ...
    public CropAreaView(Context context) {
        ...
        this.scale = 1.0f;
        this.f1828tx = BitmapDescriptorFactory.HUE_RED;
        this.f1829ty = BitmapDescriptorFactory.HUE_RED;
        this.inBubbleMode = context instanceof BubbleActivity;
        this.frameVisible = true;
        this.dimVisibile = true;
        this.sidePadding = AndroidUtilities.m102dp(16);
        this.minWidth = AndroidUtilities.m102dp(32);
        ...
        this.shadowPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
        Paint paint3 = new Paint();
        this.linePaint = paint3;
        paint3.setStyle(Paint.Style.FILL);
        this.linePaint.setColor(-1);
        this.linePaint.setStrokeWidth(AndroidUtilities.m102dp(1));
    ...
    private void updateSubtitle() {
        if (this.subtitle != null) {
            if (this.subtitlePaint == null) {
                ...
                this.subtitlePaint.setTextSize(AndroidUtilities.m102dp(13));
                this.subtitlePaint.setTextAlign(Paint.Align.CENTER);
            }
            this.subtitleLayout = new StaticLayout(this.subtitle, this.subtitlePaint, getMeasuredWidth() - AndroidUtilities.m102dp(120), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            return;
        }
    ...
    public void setIsVideo(boolean z) {
        this.minWidth = AndroidUtilities.m102dp(z ? 64 : 32);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i6;
        if (this.freeform) {
            int m103dp = AndroidUtilities.m103dp(2.0f / this.scale);
            int m103dp2 = AndroidUtilities.m103dp(16.0f / this.scale);
            int m103dp3 = AndroidUtilities.m103dp(3.0f / this.scale);
            RectF rectF = this.actualRect;
            float f2 = rectF.left;
            int i7 = ((int) f2) - m103dp;
            float f3 = rectF.top;
            int i8 = ((int) f3) - m103dp;
            int i9 = m103dp * 2;
            int i10 = ((int) (rectF.right - f2)) + i9;
            int i11 = i9 + ((int) (rectF.bottom - f3));
            canvas.save();
            canvas.translate(this.f1828tx, this.f1829ty);
            float f4 = this.scale;
            float f5 = (i10 / 2) + i7;
            float f6 = (i11 / 2) + i8;
            ...
            if (this.dimVisibile) {
                ...
                i = i8;
                i2 = i7;
                canvas.drawRect(f7, (-getHeight()) * 4, f8, BitmapDescriptorFactory.HUE_RED, this.dimPaint);
                canvas.drawRect(f7, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getHeight(), this.dimPaint);
                canvas.drawRect(getWidth(), BitmapDescriptorFactory.HUE_RED, f8, getHeight(), this.dimPaint);
                canvas.drawRect(f7, getHeight(), f8, getHeight() * 4, this.dimPaint);
                float f9 = i + m103dp;
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), f9, this.dimPaint);
                float f10 = (i + i11) - m103dp;
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f9, i2 + m103dp, f10, this.dimPaint);
                canvas.drawRect((i2 + i10) - m103dp, f9, getWidth(), f10, this.dimPaint);
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f10, getWidth(), getHeight(), this.dimPaint);
            } else {
                i = i8;
                i2 = i7;
            }
            ...
            int i12 = m103dp3 - m103dp;
            int i13 = m103dp3 * 2;
            int i14 = i10 - i13;
            int i15 = i11 - i13;
            GridType gridType = this.gridType;
            if (gridType == GridType.NONE && this.gridProgress > BitmapDescriptorFactory.HUE_RED) {
            ...
            int i16 = i2 + i10;
            float f13 = i16 - i12;
            canvas.drawRect(f11, f12, f13, i4 + m103dp, this.framePaint);
            int i17 = i11 + i;
            float f14 = i17 - i12;
            canvas.drawRect(f11, f12, i3 + m103dp, f14, this.framePaint);
            canvas.drawRect(f11, i6 - m103dp, f13, f14, this.framePaint);
            canvas.drawRect(i5 - m103dp, f12, f13, f14, this.framePaint);
            int i18 = 0;
            while (true) {
                int i19 = 3;
                if (i18 >= 3) {
            ...
            if (bitmap == null || bitmap.getWidth() != this.size) {
                ...
                try {
                    int i28 = this.size;
                    this.circleBitmap = Bitmap.createBitmap(i28, i28, Bitmap.Config.ARGB_8888);
                    Canvas canvas2 = new Canvas(this.circleBitmap);
                    int i29 = this.size;
                    canvas2.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, i29, i29, this.dimPaint);
                    int i30 = this.size;
                    canvas2.drawCircle(i30 / 2, i30 / 2, i30 / 2, this.eraserPaint);
            ...
            if (this.circleBitmap != null) {
                ...
                int i31 = this.size;
                this.left = ((measuredWidth - i31) / 2.0f) + f39;
                float f40 = f39 + ((measuredHeight - i31) / 2.0f) + ((Build.VERSION.SDK_INT < 21 || this.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight);
                this.top = f40;
                float f41 = f40 + i31;
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), (int) this.top, this.dimPaint);
                float f42 = (int) f41;
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, (int) this.top, (int) this.left, f42, this.dimPaint);
                canvas.drawRect((int) (f + i31), (int) this.top, getWidth(), f42, this.dimPaint);
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f42, getWidth(), getHeight(), this.dimPaint);
                ...
                if (getMeasuredHeight() > getMeasuredWidth() && this.subtitleLayout != null) {
                    canvas.save();
                    canvas.translate(getMeasuredWidth() / 2.0f, f41 + AndroidUtilities.m102dp(16));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            switch (C48653.$SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control[this.activeControl.ordinal()]) {
                case 1:
