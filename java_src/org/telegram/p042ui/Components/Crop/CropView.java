...
import org.telegram.p042ui.Components.Crop.CropGestureDetector;
...
public class CropView extends FrameLayout implements CropAreaView.AreaViewListener, CropGestureDetector.CropGestureListener {
    ...
    @Override // org.telegram.p042ui.Components.Crop.CropGestureDetector.CropGestureListener
    ...
    public class CropState {
        ...
        private CropState(int i, int i2, int i3) {
            this.width = i;
            this.height = i2;
            this.f1830x = BitmapDescriptorFactory.HUE_RED;
            this.f1831y = BitmapDescriptorFactory.HUE_RED;
            this.scale = 1.0f;
        ...
        public boolean hasChanges() {
            return Math.abs(this.f1830x) > 1.0E-5f || Math.abs(this.f1831y) > 1.0E-5f || Math.abs(this.scale - this.minimumScale) > 1.0E-5f || Math.abs(this.rotation) > 1.0E-5f || Math.abs(this.orientation) > 1.0E-5f;
        }
    ...
    public void maximize(boolean z) {
        ...
        if (z) {
            ...
            CropState cropState2 = this.state;
            final float f3 = cropState2.f1830x;
            final float f4 = cropState2.f1831y;
        ...
        cropState3.translate(-cropState3.f1830x, -cropState3.f1831y);
    ...
    public /* synthetic */ void lambda$maximize$2(RectF rectF, RectF rectF2, float f, float f2, float f3, float f4, float f5, ValueAnimator valueAnimator) {
        ...
        float f7 = cropState.f1830x - (f * f6);
        float f8 = cropState.f1831y - (f2 * f6);
    ...
    @Override // org.telegram.p042ui.Components.Crop.CropAreaView.AreaViewListener
    ...
    */
    public static void editBitmap(android.content.Context r19, java.lang.String r20, android.graphics.Bitmap r21, android.graphics.Canvas r22, android.graphics.Bitmap r23, android.graphics.Bitmap.CompressFormat r24, android.graphics.Matrix r25, int r26, int r27, float r28, float r29, float r30, float r31, boolean r32, java.util.ArrayList<org.telegram.messenger.VideoEditedInfo.MediaEntity> r33, boolean r34) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.Crop.CropView.editBitmap(android.content.Context, java.lang.String, android.graphics.Bitmap, android.graphics.Canvas, android.graphics.Bitmap, android.graphics.Bitmap$CompressFormat, android.graphics.Matrix, int, int, float, float, float, float, boolean, java.util.ArrayList, boolean):void");
    }
    ...
    public void makeCrop(MediaController.MediaEditState mediaEditState) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m100d("set transformRotation = " + mediaEditState.cropState.transformRotation);
        }
        while (true) {
    ...
    public void showAspectRatioDialog() {
        ...
        strArr[0] = LocaleController.getString("CropOriginal", C3630R.string.CropOriginal);
        strArr[1] = LocaleController.getString("CropSquare", C3630R.string.CropSquare);
        int i = 2;
