...
public class AvatarDrawable extends Drawable {
    ...
    public AvatarDrawable(Theme.ResourcesProvider resourcesProvider) {
        ...
        this.namePaint.setTextSize(AndroidUtilities.m102dp(18));
    }
    ...
    public AvatarDrawable(TLRPC$User tLRPC$User, boolean z) {
        this();
        if (tLRPC$User != null) {
            setInfo(tLRPC$User.f1762id, tLRPC$User.first_name, tLRPC$User.last_name, null);
    ...
    public AvatarDrawable(TLRPC$Chat tLRPC$Chat, boolean z) {
        this();
        if (tLRPC$Chat != null) {
            setInfo(tLRPC$Chat.f1600id, tLRPC$Chat.title, null, null);
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (i2 == 2) {
            ...
            if (i2 == 101) {
                drawable = AppCompatResources.getDrawable(ApplicationLoader.applicationContext, C3630R.C3632drawable.fork_templates_filled);
                if (drawable != null) {
                    drawable.setBounds(0, 0, width, width);
                }
            } else if (i2 == 100) {
                drawable = AppCompatResources.getDrawable(ApplicationLoader.applicationContext, C3630R.C3632drawable.fork_filter_icon_lock_filled);
                if (drawable != null) {
                    drawable.setBounds(0, 0, width, width);
                }
            } else if (i2 == 1) {
            ...
            if (this.drawDeleted) {
                ...
                if (drawableArr[1] != null) {
                    ...
                    if (intrinsicWidth3 > width - AndroidUtilities.m102dp(6) || intrinsicHeight3 > width - AndroidUtilities.m102dp(6)) {
                        float m102dp = width / AndroidUtilities.m102dp(50);
                        intrinsicWidth3 = (int) (intrinsicWidth3 * m102dp);
                        intrinsicHeight3 = (int) (intrinsicHeight3 * m102dp);
                    }
            ...
            if (this.invalidateTextLayout) {
                ...
                if (this.stringBuilder.length() > 0) {
                    CharSequence replaceEmoji = Emoji.replaceEmoji(this.stringBuilder.toString().toUpperCase(), this.namePaint.getFontMetricsInt(), AndroidUtilities.m102dp(16), true);
                    StaticLayout staticLayout = this.textLayout;
                    if (staticLayout == null || !TextUtils.equals(replaceEmoji, staticLayout.getText())) {
                        try {
                            StaticLayout staticLayout2 = new StaticLayout(replaceEmoji, this.namePaint, AndroidUtilities.m102dp(100), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            ...
            if (this.textLayout != null) {
                float f4 = width;
                float m102dp2 = f4 / AndroidUtilities.m102dp(50);
                float f5 = f4 / 2.0f;
                canvas.scale(m102dp2, m102dp2, f5, f5);
