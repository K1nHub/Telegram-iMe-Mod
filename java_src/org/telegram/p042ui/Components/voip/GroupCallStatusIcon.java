...
public class GroupCallStatusIcon {
    ...
    public GroupCallStatusIcon() {
        int i = C3630R.raw.voice_mini;
        this.micDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m102dp(24), AndroidUtilities.m102dp(24), true, null);
        int i2 = C3630R.raw.hand_2;
        this.shakeHandDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(15), true, null);
    }
