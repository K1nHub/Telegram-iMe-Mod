...
import org.telegram.p042ui.Components.AvatarsImageView;
...
public class GroupCallRenderersContainer extends FrameLayout {
    ...
    public GroupCallRenderersContainer(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList<GroupCallMiniTextureView> arrayList, ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        this.hideUiRunnable = new Runnable() { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.1
            ...
            public void run() {
                if (!GroupCallRenderersContainer.this.canHideUI()) {
                    AndroidUtilities.runOnUIThread(GroupCallRenderersContainer.this.hideUiRunnable, C0479C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                    return;
                }
        ...
        ImageView imageView = new ImageView(this, context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.2
            ...
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(C3702ActionBar.getCurrentActionBarHeight(), 1073741824));
            }
        };
        ...
        imageView.setPadding(AndroidUtilities.m102dp(16), 0, AndroidUtilities.m102dp(16), 0);
        ...
        addView(view, LayoutHelper.createFrame(-1, 120));
        ...
        final Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(20), 0, ColorUtils.setAlphaComponent(-1, 100));
        View view3 = new View(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.4
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                canvas.save();
                createSimpleSelectorRoundRectDrawable.setBounds(0, 0, AndroidUtilities.m102dp(50) + ((int) measuredWidth), getMeasuredHeight());
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(context, C3630R.C3632drawable.msg_pin_filled, -1);
        this.pinDrawable = crossOutDrawable;
        crossOutDrawable.setOffsets(-AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(1));
        ...
        this.pinTextView.setText(LocaleController.getString("CallVideoPin", C3630R.string.CallVideoPin));
        ...
        this.unpinTextView.setText(LocaleController.getString("CallVideoUnpin", C3630R.string.CallVideoUnpin));
        ...
        this.pipView.setImageResource(C3630R.C3632drawable.ic_goinline);
        this.pipView.setContentDescription(LocaleController.getString(C3630R.string.AccDescrPipMode));
        int m102dp = AndroidUtilities.m102dp(4);
        this.pipView.setPadding(m102dp, m102dp, m102dp, m102dp);
        ...
        final Drawable createRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m102dp(18), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_voipgroup_listViewBackground), 204));
        ...
        frameLayout.addView(avatarsImageView, LayoutHelper.createFrame(100, 32, 16, 0, 0, 0, 0));
        ...
        addView(frameLayout, LayoutHelper.createFrame(-2, 36, 1, 0, 0, 0, 0));
        ...
        for (int i = 0; i < 2; i++) {
            this.undoView[i] = new UndoView(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.6
                @Override // org.telegram.p042ui.Components.UndoView, android.view.View
                public void invalidate() {
                    super.invalidate();
                    GroupCallRenderersContainer.this.invalidate();
                }
            ...
            this.undoView[i].setAdditionalTranslationY(AndroidUtilities.m102dp(10));
    ...
    public void setIsTablet(boolean z) {
        if (this.isTablet != z) {
            ...
            layoutParams.rightMargin = z ? AndroidUtilities.m102dp(328) : 0;
            layoutParams.bottomMargin = z ? -AndroidUtilities.m102dp(8) : 0;
            if (this.isTablet) {
                this.backButton.setImageDrawable(ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.msg_calls_minimize));
                return;
            }
            BackDrawable backDrawable = new BackDrawable(false);
            backDrawable.setColor(-1);
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        if (this.drawFirst) {
            if ((view instanceof GroupCallMiniTextureView) && ((GroupCallMiniTextureView) view).drawFirst) {
                ...
                canvas.save();
                canvas.clipRect(BitmapDescriptorFactory.HUE_RED, y, getMeasuredWidth(), measuredHeight);
        ...
        if (view instanceof GroupCallMiniTextureView) {
            ...
            if (groupCallMiniTextureView.primaryView != null) {
                ...
                canvas.save();
                float f2 = 1.0f - f;
                canvas.clipRect(BitmapDescriptorFactory.HUE_RED, y2 * f2, getMeasuredWidth(), (measuredHeight2 * f2) + (getMeasuredHeight() * f));
    ...
    /* JADX WARN: Removed duplicated region for block: B:158:0x04a6 A[LOOP:1: B:158:0x04a6->B:165:0x04ff, LOOP_START, PHI: r10 
      PHI: (r10v1 int) = (r10v0 int), (r10v2 int) binds: [B:157:0x04a4, B:165:0x04ff] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:166:0x0502 A[ORIG_RETURN, RETURN] */
    @Override // android.view.ViewGroup, android.view.View
    /*
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.voip.GroupCallRenderersContainer.dispatchDraw(android.graphics.Canvas):void");
    }
        ...
        if (this.uiVisible != z) {
            ...
            if (z && this.inFullscreenMode) {
                if (!this.hideUiRunnableIsScheduled) {
                    ...
                    AndroidUtilities.runOnUIThread(this.hideUiRunnable, C0479C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                }
            } else {
                this.hideUiRunnableIsScheduled = false;
                AndroidUtilities.cancelRunOnUIThread(this.hideUiRunnable);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r14) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.voip.GroupCallRenderersContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (GroupCallActivity.isTabletMode) {
            ((ViewGroup.MarginLayoutParams) this.topShadowView.getLayoutParams()).rightMargin = AndroidUtilities.m102dp(328);
        } else if (GroupCallActivity.isLandscapeMode) {
            ((ViewGroup.MarginLayoutParams) this.topShadowView.getLayoutParams()).rightMargin = isRtmpStream() ? 0 : AndroidUtilities.m102dp(90);
        } else {
        ...
        this.pinContainer.getLayoutParams().height = AndroidUtilities.m102dp(40);
        ...
        this.pinContainer.getLayoutParams().width = AndroidUtilities.m102dp(46) + (!this.hasPinnedVideo ? this.pinTextView : this.unpinTextView).getMeasuredWidth();
        ((ViewGroup.MarginLayoutParams) this.speakingMembersToast.getLayoutParams()).rightMargin = GroupCallActivity.isLandscapeMode ? AndroidUtilities.m102dp(45) : 0;
        for (int i3 = 0; i3 < 2; i3++) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.undoView[i3].getLayoutParams();
            if (this.isTablet) {
                marginLayoutParams.rightMargin = AndroidUtilities.m102dp(344);
            } else {
                marginLayoutParams.rightMargin = GroupCallActivity.isLandscapeMode ? AndroidUtilities.m102dp(180) : 0;
            }
        }
    ...
    public boolean autoPinEnabled() {
        return (this.hasPinnedVideo || System.currentTimeMillis() - this.lastUpdateTime <= ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS || this.swipeToBackGesture || this.isInPinchToZoomTouchMode) ? false : true;
    }
    ...
    public void setVisibleParticipant(boolean z) {
        ...
        while (i3 < this.call.currentSpeakingPeers.size()) {
            ...
            if (tLRPC$TL_groupCallParticipant.self || tLRPC$TL_groupCallParticipant.muted_by_you || MessageObject.getPeerId(this.fullscreenParticipant.participant.peer) == MessageObject.getPeerId(tLRPC$TL_groupCallParticipant.peer)) {
                ...
                if (SystemClock.uptimeMillis() - tLRPC$TL_groupCallParticipant.lastSpeakTime < 500) {
                    ...
                    if (i4 < 3) {
                        int i5 = (peerId > 0L ? 1 : (peerId == 0L ? 0 : -1));
                        TLRPC$User user = i5 > 0 ? MessagesController.getInstance(currentAccount).getUser(Long.valueOf(peerId)) : null;
                        TLRPC$Chat chat = i5 <= 0 ? MessagesController.getInstance(currentAccount).getChat(Long.valueOf(peerId)) : null;
        ...
        if (i4 != 0) {
            if (i4 == 1) {
                ...
                i2 = AndroidUtilities.m102dp(64);
            } else {
                i2 = AndroidUtilities.m102dp(88);
            }
        }
        ((FrameLayout.LayoutParams) this.speakingMembersText.getLayoutParams()).leftMargin = i2;
        ((FrameLayout.LayoutParams) this.speakingMembersText.getLayoutParams()).rightMargin = AndroidUtilities.m102dp(16);
        this.showSpeakingMembersToast = z3;
        invalidate();
        while (i4 < 3) {
