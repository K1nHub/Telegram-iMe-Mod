...
public class AcceptDeclineView extends View {
    ...
    public AcceptDeclineView(Context context) {
        ...
        this.buttonWidth = AndroidUtilities.m102dp(60);
        ...
        String string = LocaleController.getString("AcceptCall", C3630R.string.AcceptCall);
        String string2 = LocaleController.getString("DeclineCall", C3630R.string.DeclineCall);
        String string3 = LocaleController.getString("RetryCall", C3630R.string.RetryCall);
        ...
        this.callDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.calls_decline).mutate();
        Drawable mutate = ContextCompat.getDrawable(context, C3630R.C3632drawable.ic_close_white).mutate();
        this.cancelDrawable = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        this.acceptCirclePaint.setColor(1061534797);
        Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m102dp(52), 0, ColorUtils.setAlphaComponent(-1, 76));
        this.rippleDrawable = createSimpleSelectorCircleDrawable;
        createSimpleSelectorCircleDrawable.setCallback(this);
        this.arrowDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.call_arrow_right);
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, i2);
        this.maxOffset = (getMeasuredWidth() / 2.0f) - ((this.buttonWidth / 2.0f) + AndroidUtilities.m102dp(46));
        int m102dp = (this.buttonWidth - AndroidUtilities.m102dp(28)) / 2;
        this.callDrawable.setBounds(m102dp, m102dp, AndroidUtilities.m102dp(28) + m102dp, AndroidUtilities.m102dp(28) + m102dp);
        this.cancelDrawable.setBounds(m102dp, m102dp, AndroidUtilities.m102dp(28) + m102dp, AndroidUtilities.m102dp(28) + m102dp);
        this.linePaint.setStrokeWidth(AndroidUtilities.m102dp(3));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.voip.AcceptDeclineView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!this.retryMod) {
            if (this.expandSmallRadius) {
                float m102dp = this.smallRadius + (AndroidUtilities.m102dp(2) * 0.04f);
                this.smallRadius = m102dp;
                if (m102dp > AndroidUtilities.m102dp(4)) {
                    this.smallRadius = AndroidUtilities.m102dp(4);
                    this.expandSmallRadius = false;
                }
            } else {
                float m102dp2 = this.smallRadius - (AndroidUtilities.m102dp(2) * 0.04f);
                this.smallRadius = m102dp2;
                if (m102dp2 < BitmapDescriptorFactory.HUE_RED) {
                    this.smallRadius = BitmapDescriptorFactory.HUE_RED;
                    this.expandSmallRadius = true;
                }
            }
            if (this.expandBigRadius) {
                float m102dp3 = this.bigRadius + (AndroidUtilities.m102dp(4) * 0.03f);
                this.bigRadius = m102dp3;
                if (m102dp3 > AndroidUtilities.m102dp(10)) {
                    this.bigRadius = AndroidUtilities.m102dp(10);
                    this.expandBigRadius = false;
                }
            } else {
                float m102dp4 = this.bigRadius - (AndroidUtilities.m102dp(5) * 0.03f);
                this.bigRadius = m102dp4;
                if (m102dp4 < AndroidUtilities.m102dp(5)) {
                    this.bigRadius = AndroidUtilities.m102dp(5);
                    this.expandBigRadius = true;
                }
            }
            invalidate();
        ...
        if (this.screenWasWakeup && !this.retryMod) {
            ...
            int m102dp5 = (int) (AndroidUtilities.m102dp(40) + (this.buttonWidth / 2.0f));
            float m102dp6 = AndroidUtilities.m102dp(46) + this.buttonWidth + AndroidUtilities.m102dp(8);
            float measuredWidth = (getMeasuredWidth() / 2.0f) - AndroidUtilities.m102dp(8);
            float m102dp7 = AndroidUtilities.m102dp(10);
            float f4 = 0.13333333f;
            int i = 0;
            while (i < 3) {
                float f5 = i;
                float f6 = ((((measuredWidth - m102dp6) - m102dp7) / 3.0f) * f5) + m102dp6;
                int i2 = (int) f6;
                float f7 = f5 * f4;
                ...
                canvas.save();
                canvas.clipRect(this.leftOffsetX + AndroidUtilities.m102dp(46) + (this.buttonWidth / 2), BitmapDescriptorFactory.HUE_RED, getMeasuredHeight(), getMeasuredWidth() >> 1);
                this.arrowDrawable.setAlpha((int) (255.0f * f9));
                Drawable drawable = this.arrowDrawable;
                drawable.setBounds(i2, m102dp5 - (drawable.getIntrinsicHeight() / 2), this.arrowDrawable.getIntrinsicWidth() + i2, (this.arrowDrawable.getIntrinsicHeight() / 2) + m102dp5);
                this.arrowDrawable.draw(canvas);
                canvas.restore();
                int measuredWidth2 = (int) (getMeasuredWidth() - f6);
                canvas.save();
                canvas.clipRect(getMeasuredWidth() >> 1, BitmapDescriptorFactory.HUE_RED, ((this.rigthOffsetX + getMeasuredWidth()) - AndroidUtilities.m102dp(46)) - (this.buttonWidth / 2), getMeasuredHeight());
                canvas.rotate(180.0f, measuredWidth2 - (this.arrowDrawable.getIntrinsicWidth() / 2.0f), m102dp5);
                Drawable drawable2 = this.arrowDrawable;
                drawable2.setBounds(measuredWidth2 - drawable2.getIntrinsicWidth(), m102dp5 - (this.arrowDrawable.getIntrinsicHeight() / 2), measuredWidth2, (this.arrowDrawable.getIntrinsicHeight() / 2) + m102dp5);
                this.arrowDrawable.draw(canvas);
                canvas.restore();
                i++;
                m102dp7 = f;
        ...
        this.bigRadius += AndroidUtilities.m102dp(8) * 0.005f;
        canvas.save();
        canvas.translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(40));
        canvas.save();
        canvas.translate(this.leftOffsetX + AndroidUtilities.m102dp(46), BitmapDescriptorFactory.HUE_RED);
        this.declineDrawable.draw(canvas);
        canvas.save();
        canvas.translate((this.buttonWidth / 2.0f) - (this.declineLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m102dp(8));
        this.declineLayout.draw(canvas);
        this.declineRect.set(AndroidUtilities.m102dp(46), AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(46) + this.buttonWidth, AndroidUtilities.m102dp(40) + this.buttonWidth);
        canvas.restore();
        if (this.retryMod) {
        ...
        if (this.leftDrag) {
            this.rippleDrawable.setBounds(AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), this.buttonWidth - AndroidUtilities.m102dp(4), this.buttonWidth - AndroidUtilities.m102dp(4));
            this.rippleDrawable.draw(canvas);
        }
        canvas.restore();
        canvas.save();
        canvas.translate(((this.rigthOffsetX + getMeasuredWidth()) - AndroidUtilities.m102dp(46)) - this.buttonWidth, BitmapDescriptorFactory.HUE_RED);
        if (!this.retryMod) {
            int i3 = this.buttonWidth;
            canvas.drawCircle(i3 / 2.0f, i3 / 2.0f, ((i3 / 2.0f) - AndroidUtilities.m102dp(4)) + this.bigRadius, this.acceptCirclePaint);
            int i4 = this.buttonWidth;
            canvas.drawCircle(i4 / 2.0f, i4 / 2.0f, ((i4 / 2.0f) - AndroidUtilities.m102dp(4)) + this.smallRadius, this.acceptCirclePaint);
        }
        this.acceptDrawable.draw(canvas);
        this.acceptRect.set((getMeasuredWidth() - AndroidUtilities.m102dp(46)) - this.buttonWidth, AndroidUtilities.m102dp(40), getMeasuredWidth() - AndroidUtilities.m102dp(46), AndroidUtilities.m102dp(40) + this.buttonWidth);
        if (this.retryMod) {
            canvas.save();
            canvas.translate((this.buttonWidth / 2.0f) - (this.retryLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m102dp(8));
            this.retryLayout.draw(canvas);
            canvas.restore();
        } else {
            canvas.save();
            canvas.translate((this.buttonWidth / 2.0f) - (this.acceptLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m102dp(8));
            this.acceptLayout.draw(canvas);
            canvas.restore();
        }
        canvas.save();
        canvas.translate(-AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1));
    ...
    public AccessibilityNodeProvider getAccessibilityNodeProvider() {
        if (this.accessibilityNodeProvider == null) {
            this.accessibilityNodeProvider = new AcceptDeclineAccessibilityNodeProvider(this, 2) { // from class: org.telegram.ui.Components.voip.AcceptDeclineView.1
                ...
                @Override // org.telegram.p042ui.Components.voip.AcceptDeclineView.AcceptDeclineAccessibilityNodeProvider
