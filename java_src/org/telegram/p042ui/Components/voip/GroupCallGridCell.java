...
import org.telegram.p042ui.GroupCallTabletGridAdapter;
/* renamed from: org.telegram.ui.Components.voip.GroupCallGridCell */
...
public class GroupCallGridCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float f2 = size;
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec((int) ((GroupCallActivity.isTabletMode ? f2 / 2.0f : f2 / f) + AndroidUtilities.m102dp(4)), 1073741824));
    }
