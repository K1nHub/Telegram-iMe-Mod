...
public class VoIPNotificationsLayout extends LinearLayout {
    ...
    public int getChildsHight() {
        ...
        return (childCount > 0 ? AndroidUtilities.m102dp(16) : 0) + (childCount * AndroidUtilities.m102dp(32));
    }
    ...
    public static class NotificationView extends FrameLayout {
        ...
        public NotificationView(Context context) {
            ...
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m102dp(16), ColorUtils.setAlphaComponent(-16777216, 102)));
