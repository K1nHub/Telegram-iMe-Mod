...
/* renamed from: org.telegram.ui.Components.voip.VoIPButtonsLayout */
...
public class VoIPButtonsLayout extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.childWidth = AndroidUtilities.m102dp(this.childSize);
        ...
        setMeasuredDimension(size, Math.max(i4, AndroidUtilities.m102dp(80)));
    }
