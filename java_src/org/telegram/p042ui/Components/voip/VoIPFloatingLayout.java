...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public VoIPFloatingLayout(Context context) {
        ...
        this.mutedDrawable = ContextCompat.getDrawable(context, C3630R.C3632drawable.calls_mute_mini);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() != this.lastH && getMeasuredWidth() != this.lastW) {
            ...
            this.path.addRoundRect(this.rectF, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), Path.Direction.CW);
    ...
    private void updatePadding() {
        ...
        this.topPadding = this.uiVisible ? AndroidUtilities.m102dp(60) : AndroidUtilities.m102dp(16);
        this.bottomPadding = AndroidUtilities.m102dp(this.uiVisible ? 100 : 16) + this.bottomOffset;
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.voip.VoIPFloatingLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - ((int) ((AndroidUtilities.m102dp(18) * 1.0f) / getScaleY()));
        canvas.save();
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m102dp(14), this.mutedPaint);
