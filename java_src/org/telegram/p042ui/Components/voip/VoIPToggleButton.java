...
public class VoIPToggleButton extends FrameLayout {
    ...
    public VoIPToggleButton(Context context, float f) {
        ...
        this.crossPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
    ...
    */
    protected void onDraw(android.graphics.Canvas r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.voip.VoIPToggleButton.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setData(int i, int i2, int i3, float f, boolean z, String str, boolean z2, boolean z3) {
        ...
        if (this.rippleDrawable == null || z) {
            if (Color.alpha(i3) == 255 && AndroidUtilities.computePerceivedBrightness(i3) > 0.5d) {
                Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m103dp(this.radius), 0, ColorUtils.setAlphaComponent(-16777216, (int) (f * 25.5f)));
                this.rippleDrawable = createSimpleSelectorCircleDrawable;
                createSimpleSelectorCircleDrawable.setCallback(this);
            } else {
                Drawable createSimpleSelectorCircleDrawable2 = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m103dp(this.radius), 0, ColorUtils.setAlphaComponent(-1, (int) (f * 76.5f)));
