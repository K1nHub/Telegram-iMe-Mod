...
public class FilterShaders {
    ...
    private boolean setupExternalShaders() {
        ...
        if (hDRType == 1) {
            ...
            readRes = hDRType == 2 ? RLottieDrawable.readRes(null, C3630R.raw.yuv_pq2rgb) : "";
        }
    ...
    public boolean drawBlurPass() {
        ...
        if (blurType == 1) {
            ...
            GLES20.glUniform2f(this.radialBlurExcludePointHandle, blurExcludePoint.f1887x, blurExcludePoint.f1888y);
            ...
            GLES20.glUniform2f(this.linearBlurExcludePointHandle, blurExcludePoint2.f1887x, blurExcludePoint2.f1888y);
