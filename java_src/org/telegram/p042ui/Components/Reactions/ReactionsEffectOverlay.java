...
public class ReactionsEffectOverlay {
    ...
    */
    ...
    public class C54251 extends FrameLayout {
        ...
        C54251(Context context, BaseFragment baseFragment, ChatMessageCell chatMessageCell, boolean z, ChatActivity chatActivity, int i, int i2, boolean z2, float f, float f2, float f3, ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
            super(context);
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.Reactions.ReactionsEffectOverlay.C54251.dispatchDraw(android.graphics.Canvas):void");
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void show(org.telegram.p042ui.ActionBar.BaseFragment r17, org.telegram.p042ui.Components.ReactionsContainerLayout r18, org.telegram.p042ui.Cells.ChatMessageCell r19, android.view.View r20, float r21, float r22, org.telegram.p042ui.Components.Reactions.ReactionsLayoutInBubble.VisibleReaction r23, int r24, int r25) {
        /*
            r12 = r17
            r13 = r25
            if (r19 == 0) goto Lce
        ...
        L36:
            ...
            if (r13 != r14) goto L5c
            org.telegram.p042ui.Components.Reactions.ReactionsEffectOverlay.currentShortOverlay = r15
            goto L5e
        L5c:
            org.telegram.p042ui.Components.Reactions.ReactionsEffectOverlay.currentOverlay = r15
        L5e:
            r0 = 0
            boolean r1 = r12 instanceof org.telegram.p042ui.ChatActivity
            if (r1 == 0) goto L76
            r1 = r12
            org.telegram.ui.ChatActivity r1 = (org.telegram.p042ui.ChatActivity) r1
            if (r13 == 0) goto L6b
            r2 = 2
            if (r13 != r2) goto L76
        L6b:
    ...
    public static int sizeForBigReaction() {
        int m102dp = AndroidUtilities.m102dp(350);
        Point point = AndroidUtilities.displaySize;
        return (int) (Math.round(Math.min(m102dp, Math.min(point.x, point.y)) * 0.7f) / AndroidUtilities.density);
    }

    public static int sizeForAroundReaction() {
        return (int) ((AndroidUtilities.m102dp(40) * 2.0f) / AndroidUtilities.density);
    }
    ...
    private class AvatarParticle {
        ...
        /* synthetic */ AvatarParticle(ReactionsEffectOverlay reactionsEffectOverlay, C54251 c54251) {
