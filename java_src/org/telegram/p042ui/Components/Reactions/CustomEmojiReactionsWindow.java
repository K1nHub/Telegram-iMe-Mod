...
import org.telegram.p042ui.Components.StableAnimator;
...
public class CustomEmojiReactionsWindow {
    ...
    public CustomEmojiReactionsWindow(int i, BaseFragment baseFragment, List<ReactionsLayoutInBubble.VisibleReaction> list, HashSet<ReactionsLayoutInBubble.VisibleReaction> hashSet, final ReactionsContainerLayout reactionsContainerLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        C54172 c54172 = new C54172(baseFragment, context, false, null, 1, i != 1, resourcesProvider, 16, reactionsContainerLayout, baseFragment);
        this.selectAnimatedEmojiDialog = c54172;
        if (Build.VERSION.SDK_INT >= 21) {
            c54172.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow.3
                ...
                public void getOutline(View view, Outline outline) {
                    float lerp = AndroidUtilities.lerp(CustomEmojiReactionsWindow.this.fromRadius, AndroidUtilities.m102dp(8), CustomEmojiReactionsWindow.this.enterTransitionProgress);
        ...
        this.selectAnimatedEmojiDialog.setOnLongPressedListener(new SelectAnimatedEmojiDialog.onLongPressedListener(this) { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow.4
            @Override // org.telegram.p042ui.SelectAnimatedEmojiDialog.onLongPressedListener
        ...
        this.selectAnimatedEmojiDialog.setOnRecentClearedListener(new SelectAnimatedEmojiDialog.onRecentClearedListener(this) { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow.5
            @Override // org.telegram.p042ui.SelectAnimatedEmojiDialog.onRecentClearedListener
        ...
        if (i == i2 || (reactionsContainerLayout.getDelegate() != null && reactionsContainerLayout.getDelegate().drawBackground())) {
            this.selectAnimatedEmojiDialog.setBackgroundDelegate(new SelectAnimatedEmojiDialog.BackgroundDelegate() { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow$$ExternalSyntheticLambda9
                @Override // org.telegram.p042ui.SelectAnimatedEmojiDialog.BackgroundDelegate
    ...
    /* loaded from: classes6.dex */
    public class C54172 extends SelectAnimatedEmojiDialog {
        ...
        C54172(BaseFragment baseFragment, Context context, boolean z, Integer num, int i, boolean z2, Theme.ResourcesProvider resourcesProvider, int i2, ReactionsContainerLayout reactionsContainerLayout, BaseFragment baseFragment2) {
        ...
        protected void onEmojiSelected(View view, Long l, TLRPC$Document tLRPC$Document, Integer num) {
            if (!UserConfig.getInstance(this.val$baseFragment.getCurrentAccount()).isPremium()) {
                ...
                BulletinFactory.m62of(CustomEmojiReactionsWindow.this.windowView, null).createEmojiBulletin(tLRPC$Document, AndroidUtilities.replaceTags(LocaleController.getString("UnlockPremiumEmojiReaction", C3630R.string.UnlockPremiumEmojiReaction)), LocaleController.getString("PremiumMore", C3630R.string.PremiumMore), new Runnable() { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        CustomEmojiReactionsWindow.C54172.this.lambda$onEmojiSelected$0();
                    }
                }).show();
                return;
            }
    ...
    private void createTransition(final boolean z) {
        ...
        float m102dp = ((((this.location[1] - iArr[1]) - AndroidUtilities.m102dp(44)) - AndroidUtilities.m102dp(52)) - (this.selectAnimatedEmojiDialog.includeHint ? AndroidUtilities.m102dp(26) : 0)) + this.reactionsContainerLayout.getTopOffset();
        if (this.containerView.getMeasuredHeight() + m102dp > this.windowView.getMeasuredHeight() - AndroidUtilities.m102dp(32)) {
            m102dp = (this.windowView.getMeasuredHeight() - AndroidUtilities.m102dp(32)) - this.containerView.getMeasuredHeight();
        }
        if (m102dp < AndroidUtilities.m102dp(16)) {
            m102dp = AndroidUtilities.m102dp(16);
        }
        int i = this.type;
        if (i == 1) {
            this.containerView.setTranslationX(((this.windowView.getMeasuredWidth() - this.containerView.getMeasuredWidth()) / 2.0f) - AndroidUtilities.m102dp(16));
        } else if (i == 2) {
            this.containerView.setTranslationX((this.location[0] - iArr[0]) - AndroidUtilities.m102dp(18));
        } else {
            this.containerView.setTranslationX((this.location[0] - iArr[0]) - AndroidUtilities.m102dp(2));
        }
        if (!z) {
            this.yTranslation = this.containerView.getTranslationY();
        } else {
            this.yTranslation = m102dp;
            this.containerView.setTranslationY(m102dp);
        }
    ...
    public class ContainerView extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (CustomEmojiReactionsWindow.this.type == 1 || CustomEmojiReactionsWindow.this.type == 2) {
                ...
                int m102dp = (AndroidUtilities.m102dp(36) * 8) + AndroidUtilities.m102dp(12);
                if (m102dp < measuredWidth) {
                    measuredWidth = m102dp;
                }
            }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (customEmojiReactionsWindow2.isShowing) {
                ...
                if (CustomEmojiReactionsWindow.this.reactionsContainerLayout != null) {
                    ...
                    canvas.clipRect((int) (CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.getY() + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getY()), x + (AndroidUtilities.m102dp(36) * CustomEmojiReactionsWindow.this.enterTransitionProgress), y + customEmojiReactionsWindow.selectAnimatedEmojiDialog.emojiGridView.getMeasuredHeight(), x + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getMeasuredWidth());
                    int i11 = -1;
                    int i12 = -1;
                        ...
                        if (view.getLeft() < 0 || view.getVisibility() == i9) {
                            ...
                            if (view instanceof ReactionsContainerLayout.ReactionHolderView) {
                                ...
                                if (imageViewEmoji2 != null) {
                                    ...
                                    float x3 = (((imageViewEmoji2.getX() + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.getX()) + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getX()) - reactionHolderView.loopImageView.getX()) - AndroidUtilities.m102dp(i);
                                ...
                                if (imageViewEmoji2 != null) {
                                    if (imageViewEmoji2.selected) {
                                        ...
                                        float measuredWidth4 = reactionHolderView.getMeasuredWidth() - AndroidUtilities.m102dp(2);
                                        float lerp4 = AndroidUtilities.lerp(measuredWidth4, (imageViewEmoji2.getMeasuredWidth() - AndroidUtilities.m102dp(2)) / f7, CustomEmojiReactionsWindow.this.enterTransitionProgress);
                                        RectF rectF7 = AndroidUtilities.rectTmp;
                                        float f13 = lerp4 / 2.0f;
                                        f2 = lerp;
                                        i2 = save;
                                        rectF7.set(measuredWidth3 - f13, measuredHeight - f13, measuredWidth3 + f13, measuredHeight + f13);
                                        float lerp5 = AndroidUtilities.lerp(measuredWidth4 / 2.0f, AndroidUtilities.m102dp(4), CustomEmojiReactionsWindow.this.enterTransitionProgress);
