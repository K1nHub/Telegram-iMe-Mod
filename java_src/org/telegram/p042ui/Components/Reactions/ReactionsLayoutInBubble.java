...
import org.telegram.p042ui.Components.AvatarsDrawable;
...
public class ReactionsLayoutInBubble {
    ...
    */
    public void setMessage(org.telegram.messenger.MessageObject r18, boolean r19, org.telegram.p042ui.ActionBar.Theme.ResourcesProvider r20) {
        /*
            Method dump skipped, instructions count: 559
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.Reactions.ReactionsLayoutInBubble.setMessage(org.telegram.messenger.MessageObject, boolean, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public void measure(int i, int i2) {
        ...
        for (int i6 = 0; i6 < this.reactionButtons.size(); i6++) {
            ...
            if (reactionButton.isSmall) {
                reactionButton.width = AndroidUtilities.m102dp(14);
                reactionButton.height = AndroidUtilities.m102dp(14);
            } else {
                reactionButton.width = AndroidUtilities.m102dp(8) + AndroidUtilities.m102dp(20) + AndroidUtilities.m102dp(4);
                if (reactionButton.avatarsDrawable != null && reactionButton.users.size() > 0) {
                    reactionButton.users.size();
                    reactionButton.width = (int) (reactionButton.width + AndroidUtilities.m102dp(2) + (AndroidUtilities.m102dp(20) * 1) + ((reactionButton.users.size() > 1 ? reactionButton.users.size() - 1 : 0) * AndroidUtilities.m102dp(20) * 0.8f) + AndroidUtilities.m102dp(1));
                    reactionButton.avatarsDrawable.height = AndroidUtilities.m102dp(26);
                } else {
                    reactionButton.width = (int) (reactionButton.width + reactionButton.counterDrawable.textPaint.measureText(reactionButton.countText) + AndroidUtilities.m102dp(8));
                }
                reactionButton.height = AndroidUtilities.m102dp(26);
            }
            if (reactionButton.width + i3 > i) {
                i4 += reactionButton.height + AndroidUtilities.m102dp(4);
                i3 = 0;
            }
            reactionButton.f1926x = i3;
            reactionButton.f1927y = i4;
            i3 += reactionButton.width + AndroidUtilities.m102dp(4);
            if (i3 > i5) {
                i5 = i3;
            }
        }
        if (i2 == 5 && !this.reactionButtons.isEmpty()) {
            int i7 = this.reactionButtons.get(0).f1927y;
            int i8 = 0;
            for (int i9 = 0; i9 < this.reactionButtons.size(); i9++) {
                if (this.reactionButtons.get(i9).f1927y != i7) {
                    int i10 = i9 - 1;
                    int i11 = i - (this.reactionButtons.get(i10).f1926x + this.reactionButtons.get(i10).width);
                    while (i8 < i9) {
                        this.reactionButtons.get(i8).f1926x += i11;
                        i8++;
                    }
                    i8 = i9;
                }
            ...
            int i12 = i - (this.reactionButtons.get(size).f1926x + this.reactionButtons.get(size).width);
            while (i8 <= size) {
                this.reactionButtons.get(i8).f1926x += i12;
                i8++;
            }
        }
        this.lastLineX = i3;
        ...
        this.height = i4 + (this.reactionButtons.size() != 0 ? AndroidUtilities.m102dp(26) : 0);
    ...
    public void draw(Canvas canvas, float f, String str) {
        ...
        for (int i = 0; i < this.reactionButtons.size(); i++) {
            ...
            if (!reactionButton.reaction.equals(this.scrimViewReaction) && (str == null || reactionButton.reaction.equals(str))) {
                canvas.save();
                int i2 = reactionButton.f1926x;
                float f6 = i2;
                int i3 = reactionButton.f1927y;
                float f7 = i3;
        ...
        for (int i5 = 0; i5 < this.outButtons.size(); i5++) {
            ...
            canvas.save();
            canvas.translate(reactionButton2.f1926x, reactionButton2.f1927y);
            float f10 = 1.0f - f;
    ...
    public void recordDrawingState() {
        ...
        this.lastDrawnX = this.f1924x;
        this.lastDrawnY = this.f1925y;
    ...
    public boolean animateChange() {
        ...
        for (int i2 = 0; i2 < this.reactionButtons.size(); i2++) {
            ...
            if (reactionButton2 != null) {
                ...
                int i3 = reactionButton.f1926x;
                int i4 = reactionButton2.f1926x;
                if (i3 != i4 || reactionButton.f1927y != reactionButton2.f1927y || reactionButton.width != reactionButton2.width || reactionButton.count != reactionButton2.count || reactionButton.choosen != reactionButton2.choosen || reactionButton.avatarsDrawable != null || reactionButton2.avatarsDrawable != null) {
                    reactionButton.animateFromX = i4;
                    reactionButton.animateFromY = reactionButton2.f1927y;
        ...
        if (this.wasDrawn) {
            ...
            if (f != this.f1924x || this.lastDrawnY != this.f1925y) {
    ...
    public class ReactionButton {
        ...
        public ReactionButton(ReactionButton reactionButton, TLRPC$ReactionCount tLRPC$ReactionCount, boolean z) {
            ...
            this.counterDrawable.setSize(AndroidUtilities.m102dp(26), AndroidUtilities.m102dp(100));
        ...
        public void draw(Canvas canvas, float f, float f2, boolean z) {
            ...
            if (this.isSmall && imageReceiver != null) {
                ...
                this.drawingImageRect.set(0, 0, AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(14));
            ...
            if (imageReceiver != null) {
                ...
                this.drawingImageRect.set(m102dp, i3, m102dp + i, i + i3);
                imageReceiver.setImageCoords(this.drawingImageRect);
                drawImage(canvas, f2);
            }
            CounterView.CounterDrawable counterDrawable = this.counterDrawable;
            if (counterDrawable != null && (this.count != 0 || counterDrawable.countChangeProgress != 1.0f)) {
                canvas.save();
                canvas.translate(AndroidUtilities.m102dp(8) + AndroidUtilities.m102dp(20) + AndroidUtilities.m102dp(2), BitmapDescriptorFactory.HUE_RED);
                this.counterDrawable.draw(canvas);
                canvas.restore();
            }
            if (this.avatarsDrawable != null) {
                canvas.save();
                canvas.translate(AndroidUtilities.m102dp(10) + AndroidUtilities.m102dp(20) + AndroidUtilities.m102dp(2), BitmapDescriptorFactory.HUE_RED);
        ...
        public void setUsers(ArrayList<TLObject> arrayList) {
            ...
            if (arrayList != null) {
                ...
                if (this.avatarsDrawable == null) {
                    ...
                    avatarsDrawable.setSize(AndroidUtilities.m102dp(20));
                    this.avatarsDrawable.width = AndroidUtilities.m102dp(100);
                    AvatarsDrawable avatarsDrawable2 = this.avatarsDrawable;
                    avatarsDrawable2.height = this.height;
                    avatarsDrawable2.setAvatarsTextSize(AndroidUtilities.m102dp(22));
                }
    ...
    public boolean chekTouchEvent(MotionEvent motionEvent) {
        ...
        float x = motionEvent.getX() - this.f1924x;
        float y = motionEvent.getY() - this.f1925y;
        if (motionEvent.getAction() == 0) {
            int size = this.reactionButtons.size();
            while (true) {
                if (i >= size) {
                    break;
                } else if (x <= this.reactionButtons.get(i).f1926x || x >= this.reactionButtons.get(i).f1926x + this.reactionButtons.get(i).width || y <= this.reactionButtons.get(i).f1927y || y >= this.reactionButtons.get(i).f1927y + this.reactionButtons.get(i).height) {
                    i++;
                } else {
