package org.telegram.p042ui.Components.Reactions;
...
import org.telegram.p042ui.Components.Reactions.ChatSelectionReactionMenuOverlay;
import org.telegram.p042ui.Components.Reactions.ReactionsLayoutInBubble;
import org.telegram.p042ui.Components.ReactionsContainerLayout;
...
public class ChatSelectionReactionMenuOverlay extends FrameLayout {
    ...
    private void checkCreateReactionsLayout() {
        if (this.reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout.setPadding(AndroidUtilities.m102dp(4) + (LocaleController.isRTL ? 0 : this.mSidePadding), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4) + (LocaleController.isRTL ? this.mSidePadding : 0), AndroidUtilities.m102dp(this.mPadding));
            this.reactionsContainerLayout.setDelegate(new C54133());
    ...
    /* loaded from: classes6.dex */
    public class C54133 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        @Override // org.telegram.p042ui.Components.ReactionsContainerLayout.ReactionsContainerDelegate
        ...
        public void onReactionClicked(View view, ReactionsLayoutInBubble.VisibleReaction visibleReaction, boolean z, boolean z2) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Reactions.ChatSelectionReactionMenuOverlay$3$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ChatSelectionReactionMenuOverlay.C54133.this.lambda$onReactionClicked$0();
                }
            });
        }
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                if (messageObject.getId() == this.currentPrimaryObject.getId()) {
                    ...
                    if (reactionsContainerLayout != null) {
                        ...
                        this.reactionsContainerLayout.setPadding(AndroidUtilities.m102dp(4) + ((LocaleController.isRTL || isOutOwner) ? 0 : this.mSidePadding), AndroidUtilities.m102dp(this.mPadding), AndroidUtilities.m102dp(4) + ((LocaleController.isRTL || isOutOwner) ? this.mSidePadding : 0), AndroidUtilities.m102dp(this.mPadding));
                    }
                    ...
                    float y = (chatMessageCell.getY() + pullingDownOffset) - AndroidUtilities.m102dp(74);
                    float m102dp = AndroidUtilities.m102dp(14);
                    float m102dp2 = height2 - AndroidUtilities.m102dp(218);
                    FragmentContextView fragmentContextView = this.parentFragment.getFragmentContextView();
                    if (fragmentContextView != null && fragmentContextView.getVisibility() == 0) {
                        m102dp += fragmentContextView.getHeight();
                    }
                    float f4 = height;
                    if (y > m102dp - (f4 / 2.0f) && y < m102dp2) {
                        this.toOffsetY = BitmapDescriptorFactory.HUE_RED;
                        z2 = false;
                        z3 = true;
                    } else {
                        if (y < (m102dp - f4) - AndroidUtilities.m102dp(92) || y > m102dp2) {
                            z2 = false;
                        } else {
                            this.translationOffsetY = height + AndroidUtilities.m102dp(56);
                            this.toOffsetY = 1.0f;
                            z2 = true;
                        }
                        z3 = z2;
                    ...
                    this.reactionsContainerLayout.setTranslationY(MathUtils.clamp(interpolation, m102dp, m102dp2));
                    ...
                    int max = Math.max(0, chatMessageCell.getBackgroundDrawableLeft() - AndroidUtilities.m102dp(32));
                    int max2 = Math.max((int) chatMessageCell.getNonAnimationTranslationX(true), (chatMessageCell.getWidth() - chatMessageCell.getBackgroundDrawableRight()) - AndroidUtilities.m102dp(32));
                    int m102dp3 = AndroidUtilities.m102dp(40) * 8;
                    if ((getWidth() - max2) - max < m102dp3) {
                        if (isOutOwner) {
                            max = Math.min(max, (getWidth() - 0) - m102dp3);
                            max2 = 0;
                        } else {
                            max2 = Math.min(max2, (getWidth() - 0) - m102dp3);
                            max = 0;
                        }
                    }
    ...
    */
    public void setSelectedMessages(java.util.List<org.telegram.messenger.MessageObject> r10) {
        ...
        L6f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.Reactions.ChatSelectionReactionMenuOverlay.setSelectedMessages(java.util.List):void");
    }
