...
public class ChatAvatarContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatAvatarContainer(Context context, BaseFragment baseFragment, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.leftPadding = AndroidUtilities.m102dp(8);
        this.lastWidth = -1;
        this.largerWidth = -1;
        ...
        this.avatarImageView = new BackupImageView(context) { // from class: org.telegram.ui.Components.ChatAvatarContainer.1
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (z3 && getImageReceiver().hasNotThumb()) {
                    accessibilityNodeInfo.setText(LocaleController.getString("AccDescrProfilePicture", C3630R.string.AccDescrProfilePicture));
                    if (Build.VERSION.SDK_INT >= 21) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("Open", C3630R.string.Open)));
                        return;
                    }
                    return;
                }
        ...
        this.avatarImageView.setContentDescription(LocaleController.getString("AccDescrProfilePicture", C3630R.string.AccDescrProfilePicture));
        this.avatarImageView.setRoundRadius(AndroidUtilities.m102dp(21));
        ...
        this.titleTextView.setLeftDrawableTopPadding(-AndroidUtilities.m103dp(1.3f));
        this.titleTextView.setCanHideRightDrawable(false);
        this.titleTextView.setRightDrawableOutside(true);
        this.titleTextView.setPadding(0, AndroidUtilities.m102dp(6), 0, AndroidUtilities.m102dp(12));
        ...
        this.subtitleTextView.setPadding(0, 0, AndroidUtilities.m102dp(10), 0);
        addView(this.subtitleTextView);
        if (this.parentFragment != null) {
            ImageView imageView = new ImageView(context);
            this.timeItem = imageView;
            imageView.setPadding(AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(5), AndroidUtilities.m102dp(5));
            ...
            if (this.secretChatTimer) {
                this.timeItem.setContentDescription(LocaleController.getString("SetTimer", C3630R.string.SetTimer));
            } else {
                this.timeItem.setContentDescription(LocaleController.getString("AccAutoDeleteTimer", C3630R.string.AccAutoDeleteTimer));
            }
        }
        ...
        this.emojiStatusDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.titleTextView, AndroidUtilities.m102dp(24));
    }
    ...
    public void setTitleExpand(boolean z) {
        int m102dp = z ? AndroidUtilities.m102dp(10) : 0;
        if (this.titleTextView.getPaddingRight() != m102dp) {
            this.titleTextView.setPadding(0, AndroidUtilities.m102dp(6), m102dp, AndroidUtilities.m102dp(12));
            requestLayout();
            invalidate();
        }
    }
    ...
    public boolean openSetTimer() {
        ...
        actionBarPopupWindowArr[0].setAnimationStyle(C3630R.style.PopupContextAnimation);
        actionBarPopupWindowArr[0].setFocusable(true);
        autoDeletePopupWrapper.windowLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(1000), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(1000), Integer.MIN_VALUE));
    ...
    */
    public void openProfile(boolean r8, boolean r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatAvatarContainer.openProfile(boolean, boolean):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int m102dp = size - AndroidUtilities.m102dp((this.avatarImageView.getVisibility() == 0 ? 54 : 0) + 16);
        this.avatarImageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(42), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(42), 1073741824));
        this.titleTextView.measure(View.MeasureSpec.makeMeasureSpec(m102dp, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(32) + this.titleTextView.getPaddingRight(), Integer.MIN_VALUE));
        this.subtitleTextView.measure(View.MeasureSpec.makeMeasureSpec(m102dp, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(20), Integer.MIN_VALUE));
        ImageView imageView = this.timeItem;
        if (imageView != null) {
            imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(34), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(34), 1073741824));
        }
        ...
        if (simpleTextView != null) {
            simpleTextView.measure(View.MeasureSpec.makeMeasureSpec(this.largerWidth - AndroidUtilities.m102dp((this.avatarImageView.getVisibility() != 0 ? 0 : 54) + 16), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(24), Integer.MIN_VALUE));
        }
        this.lastWidth = size;
    }
    ...
    private void fadeOutToLessWidth(int i) {
        ...
        simpleTextView.setLeftDrawableTopPadding(-AndroidUtilities.m103dp(1.3f));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int currentActionBarHeight = ((C3702ActionBar.getCurrentActionBarHeight() - AndroidUtilities.m102dp(42)) / 2) + ((Build.VERSION.SDK_INT < 21 || !this.occupyStatusBar) ? 0 : AndroidUtilities.statusBarHeight);
        BackupImageView backupImageView = this.avatarImageView;
        int i5 = this.leftPadding;
        int i6 = currentActionBarHeight + 1;
        backupImageView.layout(i5, i6, AndroidUtilities.m102dp(42) + i5, AndroidUtilities.m102dp(42) + i6);
        int m102dp = this.leftPadding + (this.avatarImageView.getVisibility() == 0 ? AndroidUtilities.m102dp(54) : 0);
        SimpleTextView simpleTextView = this.titleTextLargerCopyView.get();
        if (this.subtitleTextView.getVisibility() != 8) {
            this.titleTextView.layout(m102dp, (AndroidUtilities.m103dp(1.3f) + currentActionBarHeight) - this.titleTextView.getPaddingTop(), this.titleTextView.getMeasuredWidth() + m102dp, (((this.titleTextView.getTextHeight() + currentActionBarHeight) + AndroidUtilities.m103dp(1.3f)) - this.titleTextView.getPaddingTop()) + this.titleTextView.getPaddingBottom());
            if (simpleTextView != null) {
                simpleTextView.layout(m102dp, AndroidUtilities.m103dp(1.3f) + currentActionBarHeight, simpleTextView.getMeasuredWidth() + m102dp, simpleTextView.getTextHeight() + currentActionBarHeight + AndroidUtilities.m103dp(1.3f));
            }
        } else {
            this.titleTextView.layout(m102dp, (AndroidUtilities.m102dp(11) + currentActionBarHeight) - this.titleTextView.getPaddingTop(), this.titleTextView.getMeasuredWidth() + m102dp, (((this.titleTextView.getTextHeight() + currentActionBarHeight) + AndroidUtilities.m102dp(11)) - this.titleTextView.getPaddingTop()) + this.titleTextView.getPaddingBottom());
            if (simpleTextView != null) {
                simpleTextView.layout(m102dp, AndroidUtilities.m102dp(11) + currentActionBarHeight, simpleTextView.getMeasuredWidth() + m102dp, simpleTextView.getTextHeight() + currentActionBarHeight + AndroidUtilities.m102dp(11));
            }
        }
        ImageView imageView = this.timeItem;
        if (imageView != null) {
            imageView.layout(this.leftPadding + AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(15) + currentActionBarHeight, this.leftPadding + AndroidUtilities.m102dp(50), AndroidUtilities.m102dp(49) + currentActionBarHeight);
        }
        this.subtitleTextView.layout(m102dp, AndroidUtilities.m102dp(24) + currentActionBarHeight, this.subtitleTextView.getMeasuredWidth() + m102dp, this.subtitleTextView.getTextHeight() + currentActionBarHeight + AndroidUtilities.m102dp(24));
        SimpleTextView simpleTextView2 = this.subtitleTextLargerCopyView.get();
        if (simpleTextView2 != null) {
            simpleTextView2.layout(m102dp, AndroidUtilities.m102dp(24) + currentActionBarHeight, simpleTextView2.getMeasuredWidth() + m102dp, currentActionBarHeight + simpleTextView2.getTextHeight() + AndroidUtilities.m102dp(24));
        }
    }
    ...
    public void setTitleIcons(Drawable drawable, Drawable drawable2) {
        ...
        if (drawable2 != null) {
            this.rightDrawableContentDescription = LocaleController.getString("NotificationsMuted", C3630R.string.NotificationsMuted);
        } else {
            this.rightDrawableContentDescription = null;
        }
    ...
    public void setTitle(CharSequence charSequence, boolean z, boolean z2, boolean z3, boolean z4, TLRPC$EmojiStatus tLRPC$EmojiStatus, boolean z5) {
        if (charSequence != null) {
            charSequence = Emoji.replaceEmoji(charSequence, this.titleTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(24), false);
        }
        ...
        if (z || z2) {
            ...
            this.rightDrawableContentDescription = LocaleController.getString("ScamMessage", C3630R.string.ScamMessage);
            this.rightDrawableIsScamOrVerified = true;
        } else if (z3) {
            Drawable mutate = getResources().getDrawable(C3630R.C3632drawable.verified_area).mutate();
            ...
            Drawable mutate2 = getResources().getDrawable(C3630R.C3632drawable.verified_check).mutate();
            ...
            this.rightDrawableIsScamOrVerified = true;
            this.rightDrawableContentDescription = LocaleController.getString("AccDescrVerified", C3630R.string.AccDescrVerified);
        } else if (z6) {
            ...
            if (isShowPremiumStatusEnabled && z7) {
                ...
                if (drawable == null) {
                    drawable = ContextCompat.getDrawable(ApplicationLoader.applicationContext, C3630R.C3632drawable.msg_premium_liststar).mutate();
                }
            ...
            this.rightDrawableIsScamOrVerified = true;
            this.rightDrawableContentDescription = LocaleController.getString("AccDescrPremium", C3630R.string.AccDescrPremium);
                ...
                if (printingString == null || printingString.length() == 0 || (ChatObject.isChannel(currentChat) && !currentChat.megagroup)) {
                    if (this.parentFragment.isThreadChat() && !this.parentFragment.isTopic) {
                        ...
                        if (z) {
                            ...
                            animatorSet2.playTogether(ObjectAnimator.ofFloat(this.titleTextView, View.TRANSLATION_Y, AndroidUtilities.m103dp(9.7f)), ObjectAnimator.ofFloat(this.subtitleTextView, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                        ...
                        this.titleTextView.setTranslationY(AndroidUtilities.m103dp(9.7f));
                    ...
                    if (chatActivity2.isTopic && currentChat != null) {
                        TLRPC$TL_forumTopic findTopic = MessagesController.getInstance(this.currentAccount).getTopicsController().findTopic(currentChat.f1600id, this.parentFragment.getTopicId());
                        int i = findTopic != null ? findTopic.totalMessagesCount - 1 : 0;
                        string = i > 0 ? LocaleController.formatPluralString("messages", i, Integer.valueOf(i)) : LocaleController.formatString("TopicProfileStatus", C3630R.string.TopicProfileStatus, currentChat.title);
                    } else if (currentChat != null) {
                        TLRPC$ChatFull currentChatInfo = chatActivity2.getCurrentChatInfo();
                        if (!this.parentFragment.isTemplatesChannel(true, false)) {
                            if (this.parentFragment.isInAlbumMode()) {
                                string = LocaleController.getInternalString(C3630R.string.cloud_album).toLowerCase();
                            } else {
                        ...
                        if (currentUser != null) {
                            TLRPC$User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(currentUser.f1762id));
                            if (user != null) {
                                currentUser = user;
                            }
                            if (!UserObject.isReplyUser(currentUser)) {
                                if (currentUser.f1762id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                                    string = LocaleController.getString("ChatYourSelf", C3630R.string.ChatYourSelf);
                                } else {
                                    long j = currentUser.f1762id;
                                    if (j == 333000 || j == 777000 || j == 42777) {
                                        string = LocaleController.getString("ServiceNotifications", C3630R.string.ServiceNotifications);
                                    } else if (MessagesController.isSupportUser(currentUser)) {
                                        string = LocaleController.getString("SupportStatus", C3630R.string.SupportStatus);
                                    } else if (currentUser.bot) {
                                        string = LocaleController.getString("Bot", C3630R.string.Bot);
                                    } else {
                    ...
                    str = MessagesController.getInstance(this.currentAccount).getPrintingStringType(this.parentFragment.getDialogId(), this.parentFragment.getThreadId()).intValue() == 5 ? Emoji.replaceEmoji(printingString, this.subtitleTextView.getTextPaint().getFontMetricsInt(), AndroidUtilities.m102dp(15), false) : printingString;
    ...
    public static CharSequence getChatSubtitle(TLRPC$Chat tLRPC$Chat, TLRPC$ChatFull tLRPC$ChatFull, int i) {
        ...
        if (!ChatObject.isChannel(tLRPC$Chat)) {
            if (ChatObject.isKickedFromChat(tLRPC$Chat)) {
                return LocaleController.getString("YouWereKicked", C3630R.string.YouWereKicked);
            }
            if (ChatObject.isLeftFromChat(tLRPC$Chat)) {
                return LocaleController.getString("YouLeft", C3630R.string.YouLeft);
            }
            ...
            if (ChatObject.isPublic(tLRPC$Chat)) {
                return LocaleController.getString("ChannelPublic", C3630R.string.ChannelPublic).toLowerCase();
            }
            return LocaleController.getString("ChannelPrivate", C3630R.string.ChannelPrivate).toLowerCase();
        } else if (tLRPC$ChatFull == null) {
            return LocaleController.getString("Loading", C3630R.string.Loading).toLowerCase();
        } else {
            if (tLRPC$Chat.has_geo) {
                return LocaleController.getString("MegaLocation", C3630R.string.MegaLocation).toLowerCase();
            }
            if (ChatObject.isPublic(tLRPC$Chat)) {
                return LocaleController.getString("MegaPublic", C3630R.string.MegaPublic).toLowerCase();
            }
            return LocaleController.getString("MegaPrivate", C3630R.string.MegaPrivate).toLowerCase();
        }
    }
    ...
    public void setChatAvatar(TLRPC$Chat tLRPC$Chat) {
        ...
        if (this.avatarImageView != null) {
            if (tLRPC$Chat != null && ChatObject.isTemplatesChat(this.currentAccount, tLRPC$Chat.f1600id)) {
            ...
            this.avatarImageView.setRoundRadius(AndroidUtilities.m102dp((tLRPC$Chat == null || !tLRPC$Chat.forum) ? 21 : 16));
        }
    }
    ...
    public void checkAndUpdateAvatar() {
        ...
        if (currentUser == null) {
            if (currentChat != null) {
                ...
                if (this.avatarImageView != null) {
                    if (ChatObject.isTemplatesChat(this.currentAccount, currentChat.f1600id)) {
                        this.avatarDrawable.setScaleSize(0.8f);
                        this.avatarDrawable.setAvatarType(101);
                ...
                this.avatarImageView.setRoundRadius(AndroidUtilities.m102dp(currentChat.forum ? 16 : 21));
                return;
            }
            return;
        }
    ...
    public void updateOnlineCount() {
        ...
        if ((currentChatInfo instanceof TLRPC$TL_chatFull) || (((z = currentChatInfo instanceof TLRPC$TL_channelFull)) && currentChatInfo.participants_count <= 200 && currentChatInfo.participants != null)) {
            for (int i = 0; i < currentChatInfo.participants.participants.size(); i++) {
                ...
                if (user != null && (tLRPC$UserStatus = user.status) != null && ((tLRPC$UserStatus.expires > currentTime || user.f1762id == UserConfig.getInstance(this.currentAccount).getClientUserId()) && user.status.expires > 10000)) {
                    this.onlineCount++;
                }
            }
    ...
    private void updateCurrentConnectionState() {
        ...
        if (i == 2) {
            ...
            string = LocaleController.getString("Connecting", C3630R.string.Connecting);
        } else if (i == 5) {
            string = LocaleController.getString("Updating", C3630R.string.Updating);
        } else {
            string = i == 4 ? LocaleController.getString("ConnectingToProxy", C3630R.string.ConnectingToProxy) : null;
        }
        if (string == null) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("OpenProfile", C3630R.string.OpenProfile)));
    }
