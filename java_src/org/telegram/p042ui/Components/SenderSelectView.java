...
public class SenderSelectView extends View {
    ...
    public SenderSelectView(Context context) {
        ...
        this.menuPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
        this.menuPaint.setStrokeCap(Paint.Cap.ROUND);
        this.menuPaint.setStyle(Paint.Style.STROKE);
        updateColors();
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C3630R.string.AccDescrSendAsPeer, ""));
    }
    ...
    private void updateColors() {
        ...
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(16), 0, Theme.getColor(Theme.key_windowBackgroundWhite));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float m102dp = AndroidUtilities.m102dp(9) + this.menuPaint.getStrokeWidth();
        canvas.drawLine(m102dp, m102dp, getWidth() - m102dp, getHeight() - m102dp, this.menuPaint);
        canvas.drawLine(m102dp, getHeight() - m102dp, getWidth() - m102dp, m102dp, this.menuPaint);
        canvas.restore();
    ...
    public void setAvatar(TLObject tLObject) {
        ...
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C3630R.string.AccDescrSendAsPeer, str));
