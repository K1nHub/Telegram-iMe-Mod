...
import org.telegram.p042ui.Adapters.PaddedListAdapter;
...
public class MentionsContainerView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public MentionsContainerView(Context context, long j, int i, final BaseFragment baseFragment, SizeNotifierFrameLayout sizeNotifierFrameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.botContextProvider = new PhotoViewer.EmptyPhotoViewerProvider() { // from class: org.telegram.ui.Components.MentionsContainerView.5
            ...
            */
            public org.telegram.p042ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r5, org.telegram.tgnet.TLRPC$FileLocation r6, int r7, boolean r8) {
                /*
                    r4 = this;
                    r5 = 0
                    if (r7 < 0) goto L80
                    org.telegram.ui.Components.MentionsContainerView r6 = org.telegram.p042ui.Components.MentionsContainerView.this
                    java.util.ArrayList r6 = org.telegram.p042ui.Components.MentionsContainerView.access$700(r6)
                    int r6 = r6.size()
                    if (r7 < r6) goto L11
                    goto L80
                L11:
                    ...
                    org.telegram.ui.Components.MentionsContainerView r8 = org.telegram.p042ui.Components.MentionsContainerView.this
                    java.util.ArrayList r8 = org.telegram.p042ui.Components.MentionsContainerView.access$700(r8)
                    java.lang.Object r7 = r8.get(r7)
                    r8 = 0
                    r0 = r8
                L27:
                    if (r0 >= r6) goto L80
                    org.telegram.ui.Components.MentionsContainerView r1 = org.telegram.p042ui.Components.MentionsContainerView.this
                    org.telegram.ui.Components.MentionsContainerView$MentionsListView r1 = r1.getListView()
                    android.view.View r1 = r1.getChildAt(r0)
                    boolean r2 = r1 instanceof org.telegram.p042ui.Cells.ContextLinkCell
                    if (r2 == 0) goto L45
                    r2 = r1
                    org.telegram.ui.Cells.ContextLinkCell r2 = (org.telegram.p042ui.Cells.ContextLinkCell) r2
                ...
                L63:
                    int r5 = r5 - r8
                    r6.viewY = r5
                    org.telegram.ui.Components.MentionsContainerView r5 = org.telegram.p042ui.Components.MentionsContainerView.this
                ...
                L80:
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.MentionsContainerView.C51755.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
        ...
        this.listViewPadding = (int) Math.min(AndroidUtilities.m103dp(126.0f), AndroidUtilities.displaySize.y * 0.22f);
        MentionsListView mentionsListView = new MentionsListView(context, resourcesProvider);
        this.listView = mentionsListView;
        mentionsListView.setTranslationY(AndroidUtilities.m102dp(6));
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context) { // from class: org.telegram.ui.Components.MentionsContainerView.1
            ...
            public void setReverseLayout(boolean z) {
                ...
                MentionsContainerView.this.listView.setTranslationY((z ? -1 : 1) * AndroidUtilities.m102dp(6));
            }
        };
        ...
        ExtendedGridLayoutManager extendedGridLayoutManager = new ExtendedGridLayoutManager(context, 100, false, false) { // from class: org.telegram.ui.Components.MentionsContainerView.2
            ...
            @Override // org.telegram.p042ui.Components.ExtendedGridLayoutManager
                ...
                if (i2 != 0) {
                    ...
                    if (item instanceof TLRPC$BotInlineResult) {
                        ...
                        if (tLRPC$Document != null) {
                            ...
                            size2.width = closestPhotoSizeWithSize2 != null ? closestPhotoSizeWithSize2.f1632w : 100.0f;
                            size2.height = closestPhotoSizeWithSize2 != null ? closestPhotoSizeWithSize2.f1631h : 100.0f;
                            while (i4 < tLRPC$BotInlineResult.document.attributes.size()) {
                                ...
                                if ((tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeVideo)) {
                                    ...
                                    size3.width = tLRPC$DocumentAttribute.f1611w;
                                    size3.height = tLRPC$DocumentAttribute.f1610h;
                                    break;
                                }
                                i4++;
                            }
                            ...
                            while (i4 < tLRPC$BotInlineResult.content.attributes.size()) {
                                ...
                                if ((tLRPC$DocumentAttribute2 instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute2 instanceof TLRPC$TL_documentAttributeVideo)) {
                                    ...
                                    size4.width = tLRPC$DocumentAttribute2.f1611w;
                                    size4.height = tLRPC$DocumentAttribute2.f1610h;
                                    break;
                                }
                                i4++;
                            }
                            ...
                            while (i4 < tLRPC$BotInlineResult.thumb.attributes.size()) {
                                ...
                                if ((tLRPC$DocumentAttribute3 instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute3 instanceof TLRPC$TL_documentAttributeVideo)) {
                                    ...
                                    size5.width = tLRPC$DocumentAttribute3.f1611w;
                                    size5.height = tLRPC$DocumentAttribute3.f1610h;
                                    break;
                                }
                                i4++;
                            }
                            ...
                            if (tLRPC$Photo != null && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(tLRPC$Photo.sizes, AndroidUtilities.photoSize.intValue())) != null) {
                                ...
                                size6.width = closestPhotoSizeWithSize.f1632w;
                                size6.height = closestPhotoSizeWithSize.f1631h;
                            }
                        }
                    }
                    return this.size;
        ...
        MentionsAdapter mentionsAdapter = new MentionsAdapter(context, false, j, i, new MentionsAdapter.MentionsAdapterDelegate() { // from class: org.telegram.ui.Components.MentionsContainerView.4
            ...
            @Override // org.telegram.p042ui.Adapters.MentionsAdapter.MentionsAdapterDelegate
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.containerPadding = AndroidUtilities.m102dp(((this.adapter.isStickers() || this.adapter.isBotContext()) && this.adapter.isMediaLayout() && this.adapter.getBotContextSwitch() == null && this.adapter.getBotWebViewSwitch() == null ? 2 : 0) + 2);
        ...
        if (isReversed) {
            ...
            min = Math.min(m102dp, Math.abs(getMeasuredHeight() - this.containerBottom));
            if (min > BitmapDescriptorFactory.HUE_RED) {
                this.rect.top -= (int) min;
            }
        } else {
            if (this.listView.getLayoutManager() == this.gridLayoutManager) {
                this.containerPadding += AndroidUtilities.m102dp(2);
            ...
            min = Math.min(m102dp, Math.abs(this.containerTop));
            if (min > BitmapDescriptorFactory.HUE_RED) {
        ...
        if (this.paint == null) {
            ...
            this.paint = paint;
            paint.setShadowLayer(AndroidUtilities.m102dp(4), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 503316480);
        }
        ...
        if (z) {
            ...
            if (!this.shown) {
                ...
                if (getVisibility() == 8) {
                    ...
                    mentionsListView.setTranslationY(isReversed ? -(this.listViewPadding + AndroidUtilities.m102dp(12)) : mentionsListView.computeVerticalScrollOffset() + this.listViewPadding);
                }
            }
            setVisibility(0);
        } else {
    ...
    private void updateListViewTranslation(final boolean z, boolean z2) {
        ...
        if (this.listView == null || this.paddedAdapter == null) {
            ...
            boolean isReversed = isReversed();
            if (z) {
                f = (-this.containerPadding) - AndroidUtilities.m102dp(6);
            } else {
    ...
    public /* synthetic */ void lambda$withDelegate$4(Delegate delegate, View view, int i) {
        ...
        if (item instanceof TLRPC$TL_document) {
            ...
            if (UserObject.getPublicUsername(tLRPC$User) != null) {
                ...
                spannableString.setSpan(new URLSpanUserMention("" + tLRPC$User.f1762id, 3), 0, spannableString.length(), 33);
    ...
    public class MentionsListView extends RecyclerListView {
        ...
        public MentionsListView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            addItemDecoration(new RecyclerView.ItemDecoration(r1) { // from class: org.telegram.ui.Components.MentionsContainerView.MentionsListView.2
                ...
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    ...
                    if (MentionsContainerView.this.adapter.getBotContextSwitch() == null && MentionsContainerView.this.adapter.getBotWebViewSwitch() == null) {
                        rect.top = AndroidUtilities.m102dp(2);
                    } else if (i == 0) {
                        return;
                    } else {
                        i--;
                    ...
                    rect.right = MentionsContainerView.this.gridLayoutManager.isLastInRow(i) ? 0 : AndroidUtilities.m102dp(2);
                }
            });
        }
        ...
        public void onMeasure(int i, int i2) {
            ...
            MentionsContainerView.this.listViewPadding = (int) Math.min(AndroidUtilities.m103dp(126.0f), AndroidUtilities.displaySize.y * 0.22f);
