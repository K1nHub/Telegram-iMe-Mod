...
public class VideoPlayerSeekBar {
    ...
    private int lineHeight = AndroidUtilities.m102dp(4);
    private int smallLineHeight = AndroidUtilities.m102dp(2);
    ...
    public VideoPlayerSeekBar(View view) {
        ...
        thumbWidth = AndroidUtilities.m102dp(24);
    ...
    public void setProgress(float f, boolean z) {
        ...
        if (z) {
            if (Math.abs(ceil - this.thumbX) > AndroidUtilities.m102dp(10)) {
        ...
        if (Math.abs(this.animatedThumbX - this.thumbX) > AndroidUtilities.m102dp(8)) {
            this.animatedThumbX = this.thumbX;
        }
    }
    ...
    public void draw(Canvas canvas, View view) {
        ...
        int i5 = this.height;
        rectF.top = AndroidUtilities.lerp((i5 - this.lineHeight) / 2.0f, (i5 - AndroidUtilities.m102dp(3)) - this.smallLineHeight, this.transitionProgress);
        RectF rectF2 = this.rect;
        int i6 = this.height;
        rectF2.bottom = AndroidUtilities.lerp((this.lineHeight + i6) / 2.0f, i6 - AndroidUtilities.m102dp(3), this.transitionProgress);
        float f = this.thumbX;
        ...
        float m102dp = AndroidUtilities.m102dp(this.pressed ? 8 : 6);
        if (this.currentRadius != m102dp) {
            ...
            if (f13 < m102dp) {
                float m102dp2 = f13 + (AndroidUtilities.m102dp(1) * (((float) j) / 60.0f));
                this.currentRadius = m102dp2;
                if (m102dp2 > m102dp) {
                    this.currentRadius = m102dp;
                }
            } else {
                float m102dp3 = f13 - (AndroidUtilities.m102dp(1) * (((float) j) / 60.0f));
                this.currentRadius = m102dp3;
                if (m102dp3 < m102dp) {
                    this.currentRadius = m102dp;
                }
            }
    ...
    private void drawProgressBar(Canvas canvas, RectF rectF, Paint paint2) {
        ...
        int i2;
        int i3 = 1;
        float m102dp = AndroidUtilities.m102dp(AndroidUtilities.lerp(2, 1, this.transitionProgress));
        ArrayList<Pair<Float, CharSequence>> arrayList = this.timestamps;
        if (arrayList == null || arrayList.isEmpty()) {
            canvas.drawRoundRect(rectF, m102dp, m102dp, paint2);
            return;
        }
        ...
        tmpPath.reset();
        float m102dp2 = AndroidUtilities.m102dp(4) / (lerp2 - lerp);
        int i4 = 0;
        while (true) {
            i = -1;
            if (i4 >= this.timestamps.size()) {
                i4 = -1;
                break;
            } else if (((Float) this.timestamps.get(i4).first).floatValue() >= m102dp2) {
                break;
            } else {
                i4++;
            }
        ...
        while (i6 <= i5) {
            ...
            while (i6 != i5 && i6 != 0 && i6 < this.timestamps.size() - i3 && ((Float) this.timestamps.get(i6).first).floatValue() - floatValue <= m102dp2) {
                i6++;
                floatValue2 = ((Float) this.timestamps.get(i6).first).floatValue();
            }
            RectF rectF2 = AndroidUtilities.rectTmp;
            rectF2.left = AndroidUtilities.lerp(lerp, lerp2, floatValue) + (i6 > 0 ? m103dp : BitmapDescriptorFactory.HUE_RED);
            float lerp3 = AndroidUtilities.lerp(lerp, lerp2, floatValue2) - (i6 < i5 ? m103dp : BitmapDescriptorFactory.HUE_RED);
            rectF2.right = lerp3;
            ...
            if (f3 < f4) {
                ...
                if (i6 == i4 || (i7 != 0 && rectF2.left >= rectF.left)) {
                    ...
                    fArr[1] = m102dp;
                    fArr[0] = m102dp;
                    float f5 = 0.7f * m102dp * this.timestampsAppearing;
                    fArr[5] = f5;
                    fArr[4] = f5;
                    fArr[3] = f5;
                    fArr[2] = f5;
                    ...
                    i2 = i5;
                    float f6 = 0.7f * m102dp * this.timestampsAppearing;
                    fArr2[7] = f6;
                    fArr2[6] = f6;
                    fArr2[1] = f6;
                    fArr2[0] = f6;
                    ...
                    float f7 = this.timestampsAppearing * 0.7f * m102dp;
                    fArr3[5] = f7;
                    fArr3[4] = f7;
                    fArr3[3] = f7;
                    fArr3[2] = f7;
    ...
    private void drawTimestampLabel(Canvas canvas) {
        ...
        float abs = Math.abs(lerp - f3) - AndroidUtilities.m102dp(16);
        ...
        canvas.save();
        int i2 = this.height;
        canvas.translate(lerp + ((lerp2 - f) * this.transitionProgress), AndroidUtilities.lerp((this.lineHeight + i2) / 2.0f, i2 - AndroidUtilities.m102dp(3), this.transitionProgress) + AndroidUtilities.m102dp(12));
