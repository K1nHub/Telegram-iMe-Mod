...
public class FolderBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public static void showForDeletion(final BaseFragment baseFragment, final int i, final Utilities.Callback<Boolean> callback) {
        ...
        if (dialogFilter != null && dialogFilter.isMyChatlist()) {
            AlertDialog create = new AlertDialog.Builder(baseFragment.getContext()).setTitle(LocaleController.getString("FilterDelete", C3630R.string.FilterDelete)).setMessage(LocaleController.getString("FilterDeleteAlertLinks", C3630R.string.FilterDeleteAlertLinks)).setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    FolderBottomSheet.lambda$showForDeletion$3(Utilities.Callback.this, dialogInterface, i3);
                }
            }).setPositiveButton(LocaleController.getString("Delete", C3630R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    runnable.run();
                }
        ...
        if (arrayList != null) {
            ...
            while (true) {
                if (i2 >= arrayList.size()) {
                    break;
                } else if (arrayList.get(i2).f1537id == i) {
                    dialogFilter = arrayList.get(i2);
                    break;
                } else {
                    i2++;
        ...
        if (arrayList2 != null) {
            while (true) {
                if (i2 >= arrayList2.size()) {
                    break;
                } else if (arrayList2.get(i2).f1537id == i) {
            ...
            if (arrayList2 != null) {
                while (true) {
                    if (i >= arrayList2.size()) {
                        break;
                    } else if (arrayList2.get(i).f1537id == this.filterId) {
    ...
    private void init() {
        ...
        this.recyclerListView.setPadding(AndroidUtilities.m102dp(6), 0, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(this.button != null ? 68 : 0));
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$6(BaseFragment baseFragment, ArrayList arrayList) {
        this.reqId = -1;
        BulletinFactory.m61of(baseFragment).createSimpleBulletin(C3630R.raw.ic_delete, LocaleController.formatString("FolderLinkDeletedTitle", C3630R.string.FolderLinkDeletedTitle, this.title), LocaleController.formatPluralString("FolderLinkDeletedSubtitle", arrayList.size(), new Object[0])).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
        this.success = true;
        dismiss();
        getBaseFragment().getMessagesController().invalidateChatlistFolderUpdate(this.filterId);
    }
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$11(ArrayList arrayList, BaseFragment baseFragment) {
        ...
        if (this.updates != null || (this.invite instanceof TLRPC$TL_chatlists_chatlistInviteAlready)) {
            ...
            int i = C3630R.raw.folder_in;
            SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkUpdatedTitle", C3630R.string.FolderLinkUpdatedTitle, this.escapedTitle));
            if (arrayList.size() <= 0) {
            ...
            m61of.createSimpleBulletin(i, replaceTags, formatPluralString).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
            return;
        }
        BulletinFactory.m61of(baseFragment).createSimpleBulletin(C3630R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkAddedTitle", C3630R.string.FolderLinkAddedTitle, this.escapedTitle)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList.size(), new Object[0])).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
    }
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$17(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, final Utilities.Callback callback) {
        ...
        this.reqId = -1;
        int i2 = 0;
        if (FilterCreateActivity.processErrors(tLRPC$TL_error, getBaseFragment(), BulletinFactory.m61of(getBaseFragment())) && tLObject != null) {
            if (tLObject instanceof TLRPC$Updates) {
                ...
                if (arrayList.isEmpty()) {
                    ...
                    if (tLRPC$Update instanceof TLRPC$TL_updateDialogFilter) {
                        i = ((TLRPC$TL_updateDialogFilter) tLRPC$Update).f1754id;
                    }
                } else {
                    while (true) {
                        if (i2 >= arrayList.size()) {
                            ...
                            i = ((TLRPC$TL_updateDialogFilter) arrayList.get(i2)).f1754id;
                            break;
                        } else {
                            i2++;
                        }
            ...
            if (this.alreadyJoined.contains(Long.valueOf(peerDialogId))) {
                ...
                if (peerDialogId >= 0) {
                    ...
                    if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                        string = LocaleController.getString("FolderLinkAlreadySubscribed", C3630R.string.FolderLinkAlreadySubscribed);
                    } else {
                        string = LocaleController.getString("FolderLinkAlreadyJoined", C3630R.string.FolderLinkAlreadyJoined);
                    }
                    arrayList.add(chat);
                    str = string;
                }
                if (this.lastClickedDialogId != peerDialogId || System.currentTimeMillis() - this.lastClicked > 1500) {
                    ...
                    BulletinFactory.m62of(this.bulletinContainer, null).createChatsBulletin(arrayList, str, null).setDuration(ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED).show();
                    return;
                }
                return;
            }
    ...
    public void updateCount(boolean z) {
        ...
        if (button != null) {
            if (this.deleting) {
                if (size > 0) {
                    i = C3630R.string.FolderLinkButtonRemoveChats;
                    str = "FolderLinkButtonRemoveChats";
                } else {
                    i = C3630R.string.FolderLinkButtonRemove;
                ...
                ArrayList<TLRPC$Peer> arrayList = this.peers;
                if (arrayList == null || arrayList.isEmpty()) {
                    this.button.setText(LocaleController.getString("OK", C3630R.string.OK), z);
                } else if (this.invite instanceof TLRPC$TL_chatlists_chatlistInvite) {
                    this.button.setText(LocaleController.formatString("FolderLinkButtonAdd", C3630R.string.FolderLinkButtonAdd, this.title), z);
                } else {
                    this.button.setText(size > 0 ? LocaleController.formatPluralString("FolderLinkButtonJoinPlural", size, new Object[0]) : LocaleController.getString("FolderLinkButtonNone", C3630R.string.FolderLinkButtonNone), z);
                }
            }
    ...
    public static class Button extends FrameLayout {
        ...
        public Button(Context context, String str) {
            ...
            setBackground((ShapeDrawable) Theme.createRoundRectDrawable(AndroidUtilities.m102dp(8), Theme.getColor(i)));
            ...
            this.text.setTextSize(AndroidUtilities.m102dp(14));
            ...
            this.countText.setTextSize(AndroidUtilities.m102dp(12));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.loadingT > BitmapDescriptorFactory.HUE_RED) {
                ...
                int m102dp = (int) ((1.0f - this.loadingT) * AndroidUtilities.m102dp(24));
                this.loadingDrawable.setBounds(0, m102dp, getWidth(), getHeight() + m102dp);
            ...
            if (f < 1.0f) {
                if (f != BitmapDescriptorFactory.HUE_RED) {
                    canvas.save();
                    canvas.translate(BitmapDescriptorFactory.HUE_RED, (int) (this.loadingT * AndroidUtilities.m102dp(-24)));
                ...
                float m103dp = ((AndroidUtilities.m103dp(15.66f) + this.countText.getCurrentWidth()) * f2) + currentWidth;
                Rect rect = AndroidUtilities.rectTmp2;
                rect.set((int) (((getMeasuredWidth() - m103dp) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - this.text.getHeight()) / 2.0f) - AndroidUtilities.m102dp(1)), (int) ((((getMeasuredWidth() - m103dp) + getWidth()) / 2.0f) + currentWidth), (int) (((getMeasuredHeight() + this.text.getHeight()) / 2.0f) - AndroidUtilities.m102dp(1)));
                ...
                rect.set((int) (((getMeasuredWidth() - m103dp) / 2.0f) + currentWidth + AndroidUtilities.m103dp(5.0f)), (int) ((getMeasuredHeight() - AndroidUtilities.m102dp(18)) / 2.0f), (int) (((getMeasuredWidth() - m103dp) / 2.0f) + currentWidth + AndroidUtilities.m103dp(13.0f) + Math.max(AndroidUtilities.m102dp(9), this.countText.getCurrentWidth())), (int) ((getMeasuredHeight() + AndroidUtilities.m102dp(18)) / 2.0f));
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10), this.paint);
                rect.offset(-AndroidUtilities.m103dp(0.3f), -AndroidUtilities.m103dp(0.4f));
    ...
    protected CharSequence getTitle() {
        if (this.deleting) {
            return LocaleController.getString("FolderLinkTitleRemove", C3630R.string.FolderLinkTitleRemove);
        }
        if (this.invite instanceof TLRPC$TL_chatlists_chatlistInvite) {
            return LocaleController.getString("FolderLinkTitleAdd", C3630R.string.FolderLinkTitleAdd);
        }
        ArrayList<TLRPC$Peer> arrayList = this.peers;
        if (arrayList == null || arrayList.isEmpty()) {
            return LocaleController.getString("FolderLinkTitleAlready", C3630R.string.FolderLinkTitleAlready);
        }
        return LocaleController.getString("FolderLinkTitleAddChats", C3630R.string.FolderLinkTitleAddChats);
    }
        ...
        return new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.Components.FolderBottomSheet.1
            ...
            */
            public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r10, int r11) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.FolderBottomSheet.C50291.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
            }
    ...
    public static class HeaderCell extends FrameLayout {
        ...
        public HeaderCell(Context context) {
            ...
            animatedTextView.setTextSize(AndroidUtilities.m102dp(15));
            ...
            this.actionTextView.setTextSize(AndroidUtilities.m102dp(15));
    ...
    public class TitleCell extends FrameLayout {
        ...
        public void setSelectedCount(int i, boolean z) {
            if (FolderBottomSheet.this.deleting) {
                this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitleRemove", C3630R.string.FolderLinkSubtitleRemove, this.title)));
                ...
                if (FolderBottomSheet.this.peers == null || FolderBottomSheet.this.peers.isEmpty()) {
                    this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitleAlready", C3630R.string.FolderLinkSubtitleAlready, this.title)));
                } else {
                ...
                this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitle", C3630R.string.FolderLinkSubtitle, this.title)));
            }
        }

        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp((int) TsExtractor.TS_STREAM_TYPE_AC4), 1073741824));
        }
        ...
        public class FoldersPreview extends View {
            ...
            public FoldersPreview(TitleCell titleCell, Context context, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, CharSequence charSequence4, CharSequence charSequence5) {
                ...
                this.paint.setTextSize(AndroidUtilities.m103dp(15.33f));
                ...
                this.selectedTextPaint.setTextSize(AndroidUtilities.m102dp(17));
                ...
                this.countText.setCallback(this);
                this.countText.setTextSize(AndroidUtilities.m103dp(11.66f));
                ...
                float m102dp2 = AndroidUtilities.m102dp(1);
                fArr2[7] = m102dp2;
                fArr2[6] = m102dp2;
                fArr2[5] = m102dp2;
                fArr2[4] = m102dp2;
                LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(80), (float) BitmapDescriptorFactory.HUE_RED, new int[]{-1, 16777215}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP);
                ...
                LinearGradient linearGradient2 = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(80), (float) BitmapDescriptorFactory.HUE_RED, new int[]{16777215, -1}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP);
            ...
            private StaticLayout makeLayout(CharSequence charSequence, boolean z) {
                if (charSequence == null || "ALL_CHATS".equals(charSequence.toString())) {
                    charSequence = LocaleController.getString("FilterAllChats", C3630R.string.FilterAllChats);
                }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.save();
                float m103dp = this.middleFolderWidth + (isCountEmpty() ? 0.0f : AndroidUtilities.m103dp(15.32f) + this.countText.getCurrentWidth());
                float f2 = m103dp / 2.0f;
                ...
                if (!isCountEmpty()) {
                    Rect rect = AndroidUtilities.rectTmp2;
                    rect.set((int) (this.middleFolderWidth + f3 + AndroidUtilities.m103dp(4.66f)), (int) (measuredHeight - AndroidUtilities.m102dp(9)), (int) (this.middleFolderWidth + f3 + AndroidUtilities.m103dp(15.32f) + this.countText.getCurrentWidth()), (int) (AndroidUtilities.m102dp(9) + measuredHeight));
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(rect);
                    canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(9), AndroidUtilities.m102dp(9), this.selectedPaint);
                    rect.offset(-AndroidUtilities.m103dp(0.33f), -AndroidUtilities.m103dp(0.66f));
                    this.countText.setBounds(rect);
                    this.countText.draw(canvas);
                }
                float m102dp = AndroidUtilities.m102dp(30);
                float f4 = this.leftFolderWidth;
                float f5 = (f3 - m102dp) - f4;
                if (this.leftFolder2 == null || f4 >= AndroidUtilities.m102dp(64)) {
                    f = f5;
                } else {
                    float f6 = f5 - (this.leftFolder2Width + m102dp);
                    canvas.save();
                    canvas.translate(f6, (measuredHeight - (this.leftFolder2.getHeight() / 2.0f)) + AndroidUtilities.m102dp(1));
                ...
                if (this.leftFolder != null) {
                    canvas.save();
                    canvas.translate(f5, (measuredHeight - (this.leftFolder.getHeight() / 2.0f)) + AndroidUtilities.m102dp(1));
                ...
                if (this.rightFolder != null) {
                    canvas.save();
                    canvas.translate(f7 + m102dp, (measuredHeight - (this.rightFolder.getHeight() / 2.0f)) + AndroidUtilities.m102dp(1));
                    this.rightFolder.draw(canvas);
                    canvas.restore();
                    f7 += this.rightFolderWidth + m102dp;
                }
                if (this.rightFolder2 != null && this.rightFolderWidth < AndroidUtilities.m102dp(64)) {
                    canvas.save();
                    canvas.translate(f7 + m102dp, (measuredHeight - (this.rightFolder2.getHeight() / 2.0f)) + AndroidUtilities.m102dp(1));
                    this.rightFolder2.draw(canvas);
                    canvas.restore();
                    f7 += m102dp + this.rightFolder2Width;
                }
                float height = measuredHeight + (this.middleFolder.getHeight() / 2.0f) + AndroidUtilities.m102dp(12);
                ...
                rectF2.set(f3 - AndroidUtilities.m102dp(4), height - AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4) + f8, height);
                this.path.addRoundRect(rectF2, this.radii, Path.Direction.CW);
                canvas.drawPath(this.path, this.selectedPaint);
                canvas.save();
                float max = Math.max(AndroidUtilities.m102dp(8), f);
                this.leftMatrix.reset();
                this.leftMatrix.postTranslate(Math.min(f3, max + AndroidUtilities.m102dp(8)), BitmapDescriptorFactory.HUE_RED);
                this.leftGradient.setLocalMatrix(this.leftMatrix);
                float min = Math.min(getMeasuredWidth() - AndroidUtilities.m102dp(8), f7);
                this.rightMatrix.reset();
                this.rightMatrix.postTranslate(Math.max(f8, min - AndroidUtilities.m102dp(88)), BitmapDescriptorFactory.HUE_RED);
    ...
    public void updateHeaderCell(boolean z) {
        ...
        if (arrayList != null && arrayList.size() - this.alreadyJoined.size() > 1) {
            ...
            this.headerCell.setAction(LocaleController.getString(z2 ? C3630R.string.DeselectAll : C3630R.string.SelectAll), new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void deselectAll(final HeaderCell headerCell, final boolean z) {
        ...
        updateCount(true);
        headerCell.setAction(LocaleController.getString(z ? C3630R.string.SelectAll : C3630R.string.DeselectAll), new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
