...
public class TranslateButton extends FrameLayout {
    ...
    public TranslateButton(Context context, final int i, long j, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setTextSize(AndroidUtilities.m102dp(15));
        this.textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        this.textView.setPadding(AndroidUtilities.m102dp(4), 0, AndroidUtilities.m102dp(4), 0);
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.msg_translate).mutate();
        this.translateDrawable = mutate;
        mutate.setBounds(0, AndroidUtilities.m102dp(-8), AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(12));
        ...
        this.menuView.setImageResource(C3630R.C3632drawable.msg_mini_customize);
    ...
    protected void onMenuClick() {
        ...
        final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(getContext(), C3630R.C3632drawable.popup_fixed_alert2, this.resourcesProvider, 1);
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (f > BitmapDescriptorFactory.HUE_RED) {
                    if (this.topShadowDrawable == null) {
                        this.topShadowDrawable = getContext().getResources().getDrawable(C3630R.C3632drawable.header_shadow);
                    }
        ...
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("TranslateTo", C3630R.string.TranslateTo), C3630R.C3632drawable.msg_translate);
        ...
        actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("Back", C3630R.string.Back), C3630R.C3632drawable.ic_ab_back);
        ...
        if (languageName != null) {
            ...
            if (this.accusative[0]) {
                formatString = LocaleController.formatString("DoNotTranslateLanguage", C3630R.string.DoNotTranslateLanguage, languageName);
            } else {
                formatString = LocaleController.formatString("DoNotTranslateLanguageOther", C3630R.string.DoNotTranslateLanguageOther, languageName);
            }
            actionBarMenuSubItem6.setTextAndIcon(formatString, C3630R.C3632drawable.msg_block2);
        ...
        actionBarMenuSubItem7.setTextAndIcon(LocaleController.getString("Hide", C3630R.string.Hide), C3630R.C3632drawable.msg_cancel);
        ...
        actionBarPopupWindow.showAsDropDown(imageView, 0, (-imageView.getMeasuredHeight()) - AndroidUtilities.m102dp(8));
    }
    ...
    public /* synthetic */ void lambda$onMenuClick$7(String str, TranslateController translateController, String str2, ActionBarPopupWindow actionBarPopupWindow, View view) {
        ...
        if (this.accusative[0]) {
            formatString = LocaleController.formatString("AddedToDoNotTranslate", C3630R.string.AddedToDoNotTranslate, str2);
        } else {
            formatString = LocaleController.formatString("AddedToDoNotTranslateOther", C3630R.string.AddedToDoNotTranslateOther, str2);
        }
        BulletinFactory.m61of(this.fragment).createSimpleBulletin(C3630R.raw.msg_translate, TranslateAlert2.capitalFirst(AndroidUtilities.replaceTags(formatString)), LocaleController.getString("Settings", C3630R.string.Settings), new Runnable() { // from class: org.telegram.ui.Components.TranslateButton$$ExternalSyntheticLambda8
    ...
    public /* synthetic */ void lambda$onMenuClick$9(final TranslateController translateController, ActionBarPopupWindow actionBarPopupWindow, View view) {
        ...
        if ((chat == null || !ChatObject.isChannelAndNotMegaGroup(chat)) ? false : false) {
            string = LocaleController.getString("TranslationBarHiddenForChannel", C3630R.string.TranslationBarHiddenForChannel);
        } else if (chat != null) {
            string = LocaleController.getString("TranslationBarHiddenForGroup", C3630R.string.TranslationBarHiddenForGroup);
        } else {
            string = LocaleController.getString("TranslationBarHiddenForChat", C3630R.string.TranslationBarHiddenForChat);
        }
        BulletinFactory.m61of(this.fragment).createSimpleBulletin(C3630R.raw.msg_translate, AndroidUtilities.replaceTags(string), LocaleController.getString("Undo", C3630R.string.Undo), new Runnable() { // from class: org.telegram.ui.Components.TranslateButton$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void updateText() {
        ...
        if (translateController.isTranslatingDialog(this.dialogId)) {
            this.textView.setText(TextUtils.concat(this.translateIcon, " ", LocaleController.getString("ShowOriginalButton", C3630R.string.ShowOriginalButton)));
        } else {
            String dialogTranslateTo = translateController.getDialogTranslateTo(this.dialogId);
            ...
            if (this.accusative[0]) {
                formatString = LocaleController.formatString("TranslateToButton", C3630R.string.TranslateToButton, languageName);
            } else {
                formatString = LocaleController.formatString("TranslateToButtonOther", C3630R.string.TranslateToButtonOther, languageName);
            }
            this.textView.setText(TextUtils.concat(this.translateIcon, " ", formatString));
        }
        this.menuView.setImageResource(UserConfig.getInstance(this.currentAccount).isPremium() ? C3630R.C3632drawable.msg_mini_customize : C3630R.C3632drawable.msg_close);
    }
}
