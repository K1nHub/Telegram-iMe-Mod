...
public class ProgressButton extends Button {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawProgress || this.progressAlpha != BitmapDescriptorFactory.HUE_RED) {
            int measuredWidth = getMeasuredWidth() - AndroidUtilities.m102dp(11);
            this.progressRect.set(measuredWidth, AndroidUtilities.m102dp(3), measuredWidth + AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(11));
