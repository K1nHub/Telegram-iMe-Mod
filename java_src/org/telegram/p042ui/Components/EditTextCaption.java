...
import org.telegram.p042ui.ActionBar.AlertDialogDecor;
...
public class EditTextCaption extends EditTextBoldCursor {
    ...
    public void makeSelectedUrl(String str, final FormattingTextController formattingTextController) {
        ...
        builder.setPositiveButton(LocaleController.getString("OK", C3630R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda0
        ...
        if (this.adaptiveCreateLinkDialog) {
            ...
            if (marginLayoutParams != null) {
                ...
                marginLayoutParams.height = AndroidUtilities.m102dp(36);
        ...
        if (marginLayoutParams2 != null) {
            ...
            marginLayoutParams2.leftMargin = m102dp2;
            marginLayoutParams2.rightMargin = m102dp2;
            marginLayoutParams2.height = AndroidUtilities.m102dp(36);
    ...
    public boolean performMenuAction(int i) {
        if (i == C3630R.C3633id.menu_regular) {
            makeSelectedRegular();
            return true;
        } else if (i == C3630R.C3633id.menu_bold) {
            makeSelectedBold();
            return true;
        } else if (i == C3630R.C3633id.menu_italic) {
            makeSelectedItalic();
            return true;
        } else if (i == C3630R.C3633id.menu_mono) {
            makeSelectedMono();
            return true;
        } else if (i == C3630R.C3633id.menu_link) {
            makeSelectedUrl();
            return true;
        } else if (i == C3630R.C3633id.menu_strike) {
            makeSelectedStrike();
            return true;
        } else if (i == C3630R.C3633id.menu_underline) {
            makeSelectedUnderline();
            return true;
        } else if (i == C3630R.C3633id.menu_spoiler) {
            makeSelectedSpoiler();
            return true;
        } else {
            return false;
    ...
    @Override // org.telegram.p042ui.Components.EditTextBoldCursor, android.view.View
    ...
    public void onMeasure(int i, int i2) {
        ...
        try {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m102dp(51));
            FileLog.m97e(e);
        }
        ...
        try {
            ...
            this.yOffset = ((getMeasuredHeight() - this.captionLayout.getLineBottom(0)) / 2) + AndroidUtilities.m103dp(0.5f);
        } catch (Exception e2) {
            FileLog.m97e(e2);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // org.telegram.p042ui.Components.EditTextBoldCursor, org.telegram.p042ui.Components.EditTextEffects, android.widget.TextView, android.view.View
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (hasSelection()) {
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3630R.C3633id.menu_spoiler, LocaleController.getString("Spoiler", C3630R.string.Spoiler)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3630R.C3633id.menu_bold, LocaleController.getString("Bold", C3630R.string.Bold)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3630R.C3633id.menu_italic, LocaleController.getString("Italic", C3630R.string.Italic)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3630R.C3633id.menu_mono, LocaleController.getString("Mono", C3630R.string.Mono)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3630R.C3633id.menu_strike, LocaleController.getString("Strike", C3630R.string.Strike)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3630R.C3633id.menu_underline, LocaleController.getString("Underline", C3630R.string.Underline)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3630R.C3633id.menu_link, LocaleController.getString("CreateLink", C3630R.string.CreateLink)));
            wrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C3630R.C3633id.menu_regular, LocaleController.getString("Regular", C3630R.string.Regular)));
        }
    }
        ...
        if (i == 16908322) {
            ...
            if (primaryClip != null && primaryClip.getItemCount() == 1 && primaryClip.getDescription().hasMimeType("text/html")) {
                try {
                    ...
                    Emoji.replaceEmoji((CharSequence) fromHTML, getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false, (int[]) null);
