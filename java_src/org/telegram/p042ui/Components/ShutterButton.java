...
public class ShutterButton extends View {
    ...
    public ShutterButton(Context context) {
        ...
        this.shadowDrawable = getResources().getDrawable(C3630R.C3632drawable.camera_btn);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(measuredWidth - AndroidUtilities.m102dp(36), measuredHeight - AndroidUtilities.m102dp(36), AndroidUtilities.m102dp(36) + measuredWidth, AndroidUtilities.m102dp(36) + measuredHeight);
        ...
        if (this.pressed || getScaleX() != 1.0f) {
            ...
            canvas.drawCircle(f, f2, AndroidUtilities.m102dp(26), this.whitePaint);
            if (this.state == State.RECORDING) {
                ...
                canvas.drawCircle(f, f2, AndroidUtilities.m103dp(26.5f) * scaleX * this.redProgress, this.redPaint);
            } else if (this.redProgress != BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(f, f2, AndroidUtilities.m103dp(26.5f) * scaleX, this.redPaint);
            }
        } else if (this.redProgress != BitmapDescriptorFactory.HUE_RED) {
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m102dp(84), AndroidUtilities.m102dp(84));
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString("AccActionTakePicture", C3630R.string.AccActionTakePicture)));
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_LONG_CLICK.getId(), LocaleController.getString("AccActionRecordVideo", C3630R.string.AccActionRecordVideo)));
        }
    }
}
