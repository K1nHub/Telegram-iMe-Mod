...
public class CubicBezierInterpolator implements Interpolator {
    ...
    /* renamed from: a */
    protected PointF f1832a;

    /* renamed from: b */
    protected PointF f1833b;

    /* renamed from: c */
    protected PointF f1834c;
    ...
    public CubicBezierInterpolator(PointF pointF, PointF pointF2) throws IllegalArgumentException {
        this.f1832a = new PointF();
        this.f1833b = new PointF();
        this.f1834c = new PointF();
        float f = pointF.x;
    ...
    protected float getBezierCoordinateY(float f) {
        PointF pointF = this.f1834c;
        PointF pointF2 = this.start;
        float f2 = pointF2.y * 3.0f;
        pointF.y = f2;
        PointF pointF3 = this.f1833b;
        float f3 = ((this.end.y - pointF2.y) * 3.0f) - f2;
        pointF3.y = f3;
        PointF pointF4 = this.f1832a;
    ...
    private float getXDerivate(float f) {
        return this.f1834c.x + (f * ((this.f1833b.x * 2.0f) + (this.f1832a.x * 3.0f * f)));
    }
