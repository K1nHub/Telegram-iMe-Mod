...
public class CrossfadeDrawable extends Drawable {
    ...
    public void setProgress(float f) {
        this.progress = f;
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.CrossfadeDrawable$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                CrossfadeDrawable.this.lambda$setProgress$0();
            }
        });
    }
