...
public class RoundStatusDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawCircle(AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(SharedConfig.isDialogsCompactModeEnabled ? 5 : this.isChat ? 8 : 9), AndroidUtilities.m102dp(4), paint);
        if (this.started) {
            update();
        }
    }
    ...
    public int getIntrinsicHeight() {
        return AndroidUtilities.m102dp(10);
    }
}
