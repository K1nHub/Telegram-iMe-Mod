...
import org.telegram.p042ui.Components.MediaActionDrawable;
...
public class RadialProgress2 {
    ...
    public RadialProgress2(final View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        mediaActionDrawable.setDelegate(new MediaActionDrawable.MediaActionDrawableDelegate() { // from class: org.telegram.ui.Components.RadialProgress2$$ExternalSyntheticLambda0
            @Override // org.telegram.p042ui.Components.MediaActionDrawable.MediaActionDrawableDelegate
        ...
        int m102dp = AndroidUtilities.m102dp(22);
        this.circleRadius = m102dp;
        this.overlayImageView.setRoundRadius(m102dp);
    ...
    private void invalidateParent() {
        ...
        int i = ((int) rectF.left) - m102dp;
        int i2 = ((int) rectF.top) - m102dp;
        int i3 = m102dp * 2;
    ...
    public void initMiniIcons() {
        if (this.miniDrawBitmap == null) {
            try {
                this.miniDrawBitmap = Bitmap.createBitmap(AndroidUtilities.m102dp(48), AndroidUtilities.m102dp(48), Bitmap.Config.ARGB_8888);
        ...
        if ((this.mediaActionDrawable.getCurrentIcon() != 4 || this.mediaActionDrawable.getTransitionProgress() < 1.0f) && !this.progressRect.isEmpty()) {
            ...
            if (z && this.drawBackground) {
                if ((this.drawMiniIcon || this.circleCrossfadeColorKey >= 0) && (canvas4 = this.miniDrawCanvas) != null) {
                    ...
                    if (this.backgroundStroke != 0) {
                        canvas.drawCircle(ceil, ceil2, this.circleRadius - AndroidUtilities.m103dp(3.5f), this.circlePaint);
                    } else {
            ...
            if (this.drawMiniIcon || this.circleCrossfadeColorKey >= 0) {
                if (Math.abs(this.progressRect.width() - AndroidUtilities.m102dp(44)) < AndroidUtilities.density) {
                    i3 = 20;
                    centerX = this.progressRect.centerX() + AndroidUtilities.m102dp(16);
                    m102dp = this.progressRect.centerY() + AndroidUtilities.m102dp(16);
                    i15 = 0;
                } else {
                    i3 = 22;
                    centerX = this.progressRect.centerX() + AndroidUtilities.m102dp(18);
                    m102dp = AndroidUtilities.m102dp(18) + this.progressRect.centerY();
                }
                int i19 = i3 / 2;
                if (this.drawMiniIcon) {
                ...
                if (canvas7 != null) {
                    int i20 = i3 + 18 + i15;
                    canvas7.drawCircle(AndroidUtilities.m102dp(i20), AndroidUtilities.m102dp(i20), AndroidUtilities.m102dp(i19 + 1) * f * this.miniIconScale, Theme.checkboxSquare_eraserPaint);
                } else {
                    this.miniProgressBackgroundPaint.setColor(this.progressColor);
                    canvas.drawCircle(centerX, m102dp, AndroidUtilities.m102dp(12), this.miniProgressBackgroundPaint);
                }
                ...
                if (this.miniIconScale < 1.0f) {
                    ...
                    canvas.scale(f3, f3, centerX, m102dp);
                } else {
                    i4 = Integer.MIN_VALUE;
                }
                canvas.drawCircle(centerX, m102dp, (AndroidUtilities.m102dp(i19) * f) + (AndroidUtilities.m102dp(1) * (1.0f - this.circleCheckProgress)), this.circleMiniPaint);
                if (this.drawMiniIcon) {
                    this.miniMediaActionDrawable.setBounds((int) (centerX - (AndroidUtilities.m102dp(i19) * f)), (int) (m102dp - (AndroidUtilities.m102dp(i19) * f)), (int) (centerX + (AndroidUtilities.m102dp(i19) * f)), (int) (m102dp + (AndroidUtilities.m102dp(i19) * f)));
