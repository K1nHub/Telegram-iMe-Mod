...
public class ForwardingPreviewView extends FrameLayout {
    ...
    public void updateOpenEditorItem() {
        ...
        if (this.forwardingMessagesParams.isTemplatePreview() || ((arrayList.size() == 1 && !arrayList.get(0).canEditMessage(null, true)) || this.forwardingMessagesParams.isFromShareAlert)) {
            this.openEditorView.setVisibility(8);
        } else {
            this.openEditorView.setVisibility(0);
            if (arrayList.size() == 1) {
                this.openEditorView.setTextAndIcon(LocaleController.getString("EditMessage", C3630R.string.EditMessage), C3630R.C3632drawable.msg_edit);
            } else {
                this.openEditorView.setTextAndIcon(LocaleController.getString("EventLogPromotedEditMessages", C3630R.string.EventLogPromotedEditMessages), C3630R.C3632drawable.msg_edit);
            }
        }
    ...
    public ForwardingPreviewView(Context context, final ForwardingMessagesParams forwardingMessagesParams, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, int i, final ResourcesDelegate resourcesDelegate) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.chatPreviewContainer.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.ForwardingPreviewView.3
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setRoundRect(0, ForwardingPreviewView.this.currentTopOffset + 1, view.getMeasuredWidth(), view.getMeasuredHeight(), AndroidUtilities.m102dp(6));
                }
            });
            this.chatPreviewContainer.setClipToOutline(true);
            this.chatPreviewContainer.setElevation(AndroidUtilities.m102dp(4));
        }
        C3702ActionBar c3702ActionBar = new C3702ActionBar(context, resourcesDelegate);
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context, resourcesDelegate) { // from class: org.telegram.ui.Components.ForwardingPreviewView.4
            ...
            private void drawChatBackgroundElements(Canvas canvas) {
                ...
                while (i10 < 3) {
                    ...
                    if (i10 != 2 || ForwardingPreviewView.this.chatListView.isFastScrollAnimationRunning()) {
                        int i11 = z2 ? 1 : 0;
                        while (true) {
                            z = true;
                            if (i11 >= childCount) {
                            ...
                            View childAt2 = ForwardingPreviewView.this.chatListView.getChildAt(i11);
                            if (childAt2 instanceof ChatMessageCell) {
                                ChatMessageCell chatMessageCell2 = (ChatMessageCell) childAt2;
                                if (childAt2.getY() <= ForwardingPreviewView.this.chatListView.getHeight() && childAt2.getY() + childAt2.getHeight() >= BitmapDescriptorFactory.HUE_RED && (currentMessagesGroup = chatMessageCell2.getCurrentMessagesGroup()) != null && ((i10 != 0 || currentMessagesGroup.messages.size() != 1) && ((i10 != 1 || currentMessagesGroup.transitionParams.drawBackgroundForDeletedItems) && ((i10 != 0 || !chatMessageCell2.getMessageObject().deleted) && ((i10 != 1 || chatMessageCell2.getMessageObject().deleted) && ((i10 != 2 || chatMessageCell2.willRemovedAfterAnimation()) && (i10 == 2 || !chatMessageCell2.willRemovedAfterAnimation()))))))) {
                                    ...
                                    if ((chatMessageCell2.getCurrentPosition().flags & 4) == 0) {
                                        top -= AndroidUtilities.m102dp(10);
                                    }
                                    if ((chatMessageCell2.getCurrentPosition().flags & 8) == 0) {
                                        top2 += AndroidUtilities.m102dp(10);
                                    }
                        ...
                        int i16 = z2 ? 1 : 0;
                        while (i16 < ForwardingPreviewView.this.drawingGroups.size()) {
                            MessageObject.GroupedMessages groupedMessages2 = (MessageObject.GroupedMessages) ForwardingPreviewView.this.drawingGroups.get(i16);
                            if (groupedMessages2 == null) {
                                ...
                                if (f2 < (-AndroidUtilities.m102dp(20))) {
                                    f2 = -AndroidUtilities.m102dp(20);
                                }
                                if (f4 > ForwardingPreviewView.this.chatListView.getMeasuredHeight() + AndroidUtilities.m102dp(20)) {
                                    f4 = ForwardingPreviewView.this.chatListView.getMeasuredHeight() + AndroidUtilities.m102dp(20);
                                }
                                ...
                                if (z3) {
                                    ...
                                    for (int i17 = 0; i17 < childCount; i17++) {
                                        View childAt3 = ForwardingPreviewView.this.chatListView.getChildAt(i17);
        ...
        C50435 c50435 = new C50435(null, this.chatListView, resourcesDelegate, i);
        this.itemAnimator = c50435;
        recyclerListView.setItemAnimator(c50435);
        this.chatListView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView.6
            ...
            public void onScrolled(RecyclerView recyclerView, int i8, int i9) {
                ...
                for (int i10 = 0; i10 < ForwardingPreviewView.this.chatListView.getChildCount(); i10++) {
                    ((ChatMessageCell) ForwardingPreviewView.this.chatListView.getChildAt(i10)).setParentViewSize(ForwardingPreviewView.this.chatPreviewContainer.getMeasuredWidth(), ForwardingPreviewView.this.chatPreviewContainer.getBackgroundSizeY());
                }
            }
        });
        this.chatListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView.7
            ...
            public void onItemClick(View view, int i8) {
                ...
                int id = forwardingMessagesParams.previewMessages.get(i8).getId();
        ...
        this.chatListView.setPadding(0, AndroidUtilities.m102dp(4), 0, AndroidUtilities.m102dp(4));
        C50468 c50468 = new C50468(context, 1000, 1, true, forwardingMessagesParams);
        this.chatLayoutManager = c50468;
        c50468.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Components.ForwardingPreviewView.9
            @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
            public int getSpanSize(int i8) {
                if (i8 < 0 || i8 >= forwardingMessagesParams.previewMessages.size()) {
                    return 1000;
                }
                MessageObject messageObject = forwardingMessagesParams.previewMessages.get(i8);
        ...
        this.chatListView.addItemDecoration(new RecyclerView.ItemDecoration(this) { // from class: org.telegram.ui.Components.ForwardingPreviewView.10
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                while (true) {
                    ...
                    extraInsetHeight += (int) Math.ceil(fArr[i9] * max);
                    i9++;
                }
                ...
                while (true) {
                    if (i8 < size) {
                        ...
                        if (b == b2 && ((groupedMessagePosition.minX != currentPosition.minX || groupedMessagePosition.maxX != currentPosition.maxX || b != b2 || groupedMessagePosition.maxY != currentPosition.maxY) && b == b2)) {
                            round -= ((int) Math.ceil(max * groupedMessagePosition.f1533ph)) - AndroidUtilities.m102dp(4);
                            break;
                        }
                        i8++;
                    } else {
        ...
        int i8 = C3630R.C3632drawable.popup_fixed_alert;
        ...
        if (this.forwardingMessagesParams.multiplyUsers) {
            i2 = C3630R.string.ShowSenderNames;
            str = "ShowSenderNames";
        } else {
            i2 = C3630R.string.ShowSendersName;
            str = "ShowSendersName";
        }
        ...
        CheckBox2 checkView = this.showSendersNameView.getCheckView();
        int i10 = Theme.key_chat_messagePanelSend;
        int i11 = Theme.key_chat_messagePanelHint;
        int i12 = Theme.key_checkboxCheck;
        checkView.setColor(i10, i11, i12);
        this.showSendersNameView.getCheckView().setDrawBackgroundAsArc(10);
        this.showSendersNameView.setText(LocaleController.getInternalString(C3630R.string.custom_forward_option_author));
        ...
        if (this.forwardingMessagesParams.multiplyUsers) {
            i3 = C3630R.string.HideSenderNames;
            str2 = "HideSenderNames";
        } else {
            i3 = C3630R.string.HideSendersName;
        ...
        if (this.forwardingMessagesParams.hasCaption) {
            View view = new View(this, context) { // from class: org.telegram.ui.Components.ForwardingPreviewView.11
                ...
                protected void onMeasure(int i13, int i14) {
                    super.onMeasure(i13, View.MeasureSpec.makeMeasureSpec(2, 1073741824));
                }
            };
            int i13 = Theme.key_divider;
            view.setBackgroundColor(getThemedColor(i13));
            ...
            this.showCaptionView.setTextAndIcon(LocaleController.getString("ShowCaption", C3630R.string.ShowCaption), 0);
            this.showCaptionView.setChecked(true);
            this.showCaptionView.getCheckView().setDrawUnchecked(true);
            i4 = i10;
            this.showCaptionView.getCheckView().setColor(i4, i11, i12);
            this.showCaptionView.getCheckView().setDrawBackgroundAsArc(10);
            this.showCaptionView.setText(LocaleController.getInternalString(C3630R.string.custom_forward_option_text));
            ...
            actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("HideCaption", C3630R.string.HideCaption), 0);
            ...
            View view2 = new View(this, context) { // from class: org.telegram.ui.Components.ForwardingPreviewView.12
                ...
                protected void onMeasure(int i14, int i15) {
                    super.onMeasure(i14, View.MeasureSpec.makeMeasureSpec(2, 1073741824));
                }
            };
            ...
            this.showMediaView.setTextAndIcon(LocaleController.getInternalString(C3630R.string.custom_forward_option_media), 0);
            this.showMediaView.setChecked(true);
            this.showMediaView.getCheckView().setDrawUnchecked(true);
            i5 = i12;
            this.showMediaView.getCheckView().setColor(i4, i6, i5);
        ...
        if (this.forwardingMessagesParams.hasPreview) {
            ...
            this.showPreviewView.setTextAndIcon(LocaleController.getInternalString(C3630R.string.custom_forward_option_link_preview), 0);
            this.showPreviewView.setChecked(true);
            this.showPreviewView.getCheckView().setDrawUnchecked(true);
            this.showPreviewView.getCheckView().setColor(i4, i6, i5);
        ...
        if (this.forwardingMessagesParams.isTemplatePreview()) {
            ...
            String string = LocaleController.getString("Edit", C3630R.string.Edit);
            int i14 = C3630R.C3632drawable.msg_edit;
            actionBarMenuSubItem7.setTextAndIcon(string, i14);
            actionBarMenuSubItem7.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda4
            ...
            actionBarMenuSubItem8.setTextAndIcon(LocaleController.getString("EditName", C3630R.string.EditName), i14);
            actionBarMenuSubItem8.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
            ...
            actionBarMenuSubItem9.setTextAndIcon(LocaleController.getString("Delete", C3630R.string.Delete), C3630R.C3632drawable.msg_delete);
            actionBarMenuSubItem9.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
        ...
        mutate2.setColorFilter(new PorterDuffColorFilter(getThemedColor(i9), PorterDuff.Mode.MULTIPLY));
        ...
        this.changeRecipientView.setTextAndIcon(LocaleController.getString("ChangeRecipient", C3630R.string.ChangeRecipient), C3630R.C3632drawable.msg_forward_replace);
        ...
        if (this.forwardingMessagesParams.isTemplatePreview()) {
            i7 = C3630R.string.Send;
            str3 = "Send";
        } else {
            i7 = C3630R.string.ForwardSendMessages;
            str3 = "ForwardSendMessages";
        }
        actionBarMenuSubItem12.setTextAndIcon(LocaleController.getString(str3, i7), C3630R.C3632drawable.msg_send);
        ...
        this.showSendersNameView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda12
            @Override // android.view.View.OnClickListener
            public final void onClick(View view4) {
                ForwardingPreviewView.this.lambda$new$6(forwardingMessagesParams2, view4);
            }
        });
        this.hideSendersNameView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view4) {
        ...
        if (forwardingMessagesParams2.hasCaption) {
            this.showCaptionView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda14
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
                    ForwardingPreviewView.this.lambda$new$8(forwardingMessagesParams2, view4);
                }
            });
            this.hideCaptionView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda11
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
                    ForwardingPreviewView.this.lambda$new$9(forwardingMessagesParams2, view4);
                }
            });
            this.showMediaView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda9
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
        ...
        if (forwardingMessagesParams2.hasPreview) {
            this.showPreviewView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda13
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
        ...
        this.sendMessagesView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view4) {
                ForwardingPreviewView.this.lambda$new$12(view4);
            }
        });
        this.changeRecipientView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view4) {
                ForwardingPreviewView.this.lambda$new$13(view4);
            }
        });
        this.openEditorView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view4) {
        ...
        this.menuScrollView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda16
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda15
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view4, MotionEvent motionEvent) {
        ...
        animate().setUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ForwardingPreviewView.this.lambda$new$17(valueAnimator);
            }
        });
        updateColors();
    }
    ...
    /* loaded from: classes6.dex */
    public class C50435 extends ChatListItemAnimator {
        Runnable finishRunnable;
        int scrollAnimationIndex;
        final /* synthetic */ int val$currentAccount;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C50435(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        public void onAllAnimationsDone() {
            ...
            Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.ForwardingPreviewView$5$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    ForwardingPreviewView.C50435.this.lambda$onAllAnimationsDone$0(i);
                }
            };
            ...
            if (forwardingPreviewView.updateAfterAnimations) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ForwardingPreviewView$5$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ForwardingPreviewView.C50435.this.lambda$onAllAnimationsDone$1();
                    }
                });
            }
        }
        ...
        public void endAnimations() {
            ...
            Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.ForwardingPreviewView$5$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ForwardingPreviewView.C50435.this.lambda$endAnimations$2(i);
                }
            };
            this.finishRunnable = runnable2;
            AndroidUtilities.runOnUIThread(runnable2);
    ...
    /* loaded from: classes6.dex */
    public class C50468 extends GridLayoutManagerFixed {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C50468(Context context, int i, int i2, boolean z, ForwardingMessagesParams forwardingMessagesParams) {
        ...
        public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ForwardingPreviewView$8$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ForwardingPreviewView.C50468.this.lambda$onLayoutChildren$0();
                    }
                });
            }
        }
    ...
    public /* synthetic */ void lambda$new$3(View view) {
        if (this.showing) {
            dismiss(true);
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda18
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$new$5(View view) {
        if (this.showing) {
            dismiss(true);
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda19
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void updateSubtitle() {
        ...
        if (!forwardingMessagesParams.hasSenders) {
            if (forwardingMessagesParams.willSeeSenders) {
                if (tLRPC$User != null) {
                    this.actionBar.setSubtitle(LocaleController.formatString("ForwardPreviewSendersNameVisible", C3630R.string.ForwardPreviewSendersNameVisible, ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name)));
                } else if (ChatObject.isChannel(this.currentChat) && !this.currentChat.megagroup) {
                    this.actionBar.setSubtitle(LocaleController.getString("ForwardPreviewSendersNameVisibleChannel", C3630R.string.ForwardPreviewSendersNameVisibleChannel));
                } else {
                    this.actionBar.setSubtitle(LocaleController.getString("ForwardPreviewSendersNameVisibleGroup", C3630R.string.ForwardPreviewSendersNameVisibleGroup));
                }
            } else if (tLRPC$User != null) {
                this.actionBar.setSubtitle(LocaleController.formatString("ForwardPreviewSendersNameVisible", C3630R.string.ForwardPreviewSendersNameVisible, ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name)));
            } else if (ChatObject.isChannel(this.currentChat) && !this.currentChat.megagroup) {
                this.actionBar.setSubtitle(LocaleController.getString("ForwardPreviewSendersNameHiddenChannel", C3630R.string.ForwardPreviewSendersNameHiddenChannel));
            } else {
                this.actionBar.setSubtitle(LocaleController.getString("ForwardPreviewSendersNameHiddenGroup", C3630R.string.ForwardPreviewSendersNameHiddenGroup));
            }
        } else if (forwardingMessagesParams.hideForwardSendersName) {
            if (tLRPC$User != null) {
                this.actionBar.setSubtitle(LocaleController.formatString("ForwardPreviewSendersNameHidden", C3630R.string.ForwardPreviewSendersNameHidden, ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name)));
            } else if (ChatObject.isChannel(this.currentChat) && !this.currentChat.megagroup) {
                this.actionBar.setSubtitle(LocaleController.getString("ForwardPreviewSendersNameHiddenChannel", C3630R.string.ForwardPreviewSendersNameHiddenChannel));
            } else {
                this.actionBar.setSubtitle(LocaleController.getString("ForwardPreviewSendersNameHiddenGroup", C3630R.string.ForwardPreviewSendersNameHiddenGroup));
    ...
    public void dismiss(boolean z) {
        if (this.showing) {
            this.showing = false;
            animate().alpha(BitmapDescriptorFactory.HUE_RED).scaleX(0.95f).scaleY(0.95f).setDuration(250L).setInterpolator(ChatListItemAnimator.DEFAULT_INTERPOLATOR).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ForwardingPreviewView.14
            ...
            animate().setUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ForwardingPreviewView.this.lambda$dismiss$18(valueAnimator);
                }
            });
            onDismiss(z);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$dismiss$18(ValueAnimator valueAnimator) {
    ...
    */
    public void updateMessages() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ForwardingPreviewView.updateMessages():void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        ((ViewGroup.MarginLayoutParams) this.chatListView.getLayoutParams()).topMargin = C3702ActionBar.getCurrentActionBarHeight();
        if (this.isLandscapeMode) {
            this.chatPreviewContainer.getLayoutParams().height = -1;
            ((ViewGroup.MarginLayoutParams) this.chatPreviewContainer.getLayoutParams()).topMargin = AndroidUtilities.m102dp(8);
            ((ViewGroup.MarginLayoutParams) this.chatPreviewContainer.getLayoutParams()).bottomMargin = AndroidUtilities.m102dp(8);
            this.chatPreviewContainer.getLayoutParams().width = (int) Math.min(View.MeasureSpec.getSize(i), Math.max(AndroidUtilities.m102dp(340), View.MeasureSpec.getSize(i) * 0.6f));
            ...
            this.chatPreviewContainer.getLayoutParams().height = ((View.MeasureSpec.getSize(i2) - AndroidUtilities.m102dp(6)) - this.buttonsLayout.getMeasuredHeight()) - this.buttonsLayout2.getMeasuredHeight();
        ...
        if (this.lastSize != size2) {
            for (int i6 = 0; i6 < this.forwardingMessagesParams.previewMessages.size(); i6++) {
                if (this.isLandscapeMode) {
                    ...
                    this.forwardingMessagesParams.previewMessages.get(i6).parentWidth = View.MeasureSpec.getSize(i) - AndroidUtilities.m102dp(16);
                }
    ...
    public void updatePositions() {
        ...
        if (!this.isLandscapeMode) {
            if (this.chatListView.getChildCount() == 0 || this.chatListView.getChildCount() > this.forwardingMessagesParams.previewMessages.size()) {
                ...
                int m102dp = top - AndroidUtilities.m102dp(4);
                if (m102dp < 0) {
                    this.chatTopOffset = 0;
                } else {
                    this.chatTopOffset = m102dp;
                }
            }
            float m102dp2 = (AndroidUtilities.m102dp(8) + (((getMeasuredHeight() - AndroidUtilities.m102dp(16)) - (((this.buttonsLayout.getMeasuredHeight() + this.buttonsLayout2.getMeasuredHeight()) - AndroidUtilities.m102dp(8)) + (this.chatPreviewContainer.getMeasuredHeight() - this.chatTopOffset))) / 2.0f)) - this.chatTopOffset;
            this.yOffset = m102dp2;
            if (m102dp2 > AndroidUtilities.m102dp(8)) {
                this.yOffset = AndroidUtilities.m102dp(8);
            }
            ...
            this.chatTopOffset = 0;
            this.menuScrollView.setTranslationX(this.chatListView.getMeasuredWidth() + AndroidUtilities.m102dp(8));
        }
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ForwardingPreviewView$$ExternalSyntheticLambda2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ForwardingPreviewView.this.lambda$updatePositions$19(i, f, valueAnimator2);
            }
        });
        this.offsetsAnimator.setDuration(250L);
        this.offsetsAnimator.setInterpolator(ChatListItemAnimator.DEFAULT_INTERPOLATOR);
        this.offsetsAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ForwardingPreviewView.15
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                ForwardingPreviewView forwardingPreviewView = ForwardingPreviewView.this;
    ...
    public void setOffset(float f, int i) {
        ...
        this.menuScrollView.setTranslationY((f + this.chatPreviewContainer.getMeasuredHeight()) - AndroidUtilities.m102dp(2));
    }
