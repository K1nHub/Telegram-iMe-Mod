...
public class SendingFileDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        while (true) {
            ...
            float m102dp = (AndroidUtilities.m102dp(5) * i) + (AndroidUtilities.m102dp(5) * this.progress);
            int i2 = 7;
            canvas.drawLine(m102dp, AndroidUtilities.m102dp(this.isChat ? 3 : 4), m102dp + AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(this.isChat ? 7 : 8), paint);
            float m102dp2 = AndroidUtilities.m102dp(this.isChat ? 11 : 12);
            float m102dp3 = m102dp + AndroidUtilities.m102dp(4);
            if (!this.isChat) {
                i2 = 8;
            }
            canvas.drawLine(m102dp, m102dp2, m102dp3, AndroidUtilities.m102dp(i2), paint);
            i++;
        }
        if (this.started) {
            update();
