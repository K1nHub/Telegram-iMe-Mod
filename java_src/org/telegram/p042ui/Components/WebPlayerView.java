...
public class WebPlayerView extends ViewGroup implements VideoPlayer.VideoPlayerDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    */
    protected java.lang.String downloadUrlContent(android.os.AsyncTask r19, java.lang.String r20, java.util.HashMap<java.lang.String, java.lang.String> r21, boolean r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.WebPlayerView.downloadUrlContent(android.os.AsyncTask, java.lang.String, java.util.HashMap, boolean):java.lang.String");
    }
    ...
    public class YoutubeVideoTask extends AsyncTask<Void, Void, String[]> {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:116:0x02aa, code lost:
            ...
            r0 = org.telegram.p042ui.Components.WebPlayerView.jsPattern.matcher(r3);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:129:0x02ed, code lost:
            if (org.telegram.p042ui.Components.WebPlayerView.playerIdPattern.matcher(r2).find() != false) goto L146;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:149:0x0378, code lost:
            r9 = org.telegram.p042ui.Components.WebPlayerView.sigPattern.matcher(r2);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:152:0x038c, code lost:
            r10 = true;
            r9 = org.telegram.p042ui.Components.WebPlayerView.sigPattern2.matcher(r2);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:156:0x03a1, code lost:
            r7 = new org.telegram.p042ui.Components.WebPlayerView.JSExtractor(r2).extractFunction(r8);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:171:0x043b, code lost:
            org.telegram.messenger.AndroidUtilities.runOnUIThread(new org.telegram.p042ui.Components.WebPlayerView$YoutubeVideoTask$$ExternalSyntheticLambda1(r23, r0));
        ...
        */
        public java.lang.String[] doInBackground(java.lang.Void... r24) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.WebPlayerView.YoutubeVideoTask.doInBackground(java.lang.Void[]):java.lang.String[]");
        }
        ...
        public void onPostExecute(String[] strArr) {
            if (strArr[0] != null) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m100d("start play youtube video " + strArr[1] + " " + strArr[0]);
                }
    ...
    public class ControlsView extends FrameLayout {
        ...
        public void setDuration(int i) {
            ...
            this.duration = i;
            StaticLayout staticLayout = new StaticLayout(AndroidUtilities.formatShortDuration(this.duration), this.textPaint, AndroidUtilities.m102dp(1000), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        public void setProgress(int i) {
            ...
            this.progress = i;
            this.progressLayout = new StaticLayout(AndroidUtilities.formatShortDuration(this.progress), this.textPaint, AndroidUtilities.m102dp(1000), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            invalidate();
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (WebPlayerView.this.inFullscreen) {
                i = AndroidUtilities.m102dp(36) + this.durationWidth;
                measuredWidth = (getMeasuredWidth() - AndroidUtilities.m102dp(76)) - this.durationWidth;
                measuredHeight = getMeasuredHeight() - AndroidUtilities.m102dp(28);
            } else {
                measuredWidth = getMeasuredWidth();
                measuredHeight = getMeasuredHeight() - AndroidUtilities.m102dp(12);
                i = 0;
            }
            ...
            if (motionEvent.getAction() == 0) {
                if (this.isVisible && !WebPlayerView.this.isInline && !WebPlayerView.this.isStream) {
                    if (this.duration != 0) {
                        ...
                        if (x >= i3 - AndroidUtilities.m102dp(10) && x <= AndroidUtilities.m102dp(10) + i3 && y >= measuredHeight - AndroidUtilities.m102dp(10) && y <= measuredHeight + AndroidUtilities.m102dp(10)) {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!WebPlayerView.this.isInline) {
                if (this.durationLayout != null) {
                    canvas.save();
                    canvas.translate((measuredWidth - AndroidUtilities.m102dp(58)) - this.durationWidth, measuredHeight - AndroidUtilities.m102dp((WebPlayerView.this.inFullscreen ? 6 : 10) + 29));
                    this.durationLayout.draw(canvas);
                    canvas.restore();
                }
                if (this.progressLayout != null) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m102dp(18), measuredHeight - AndroidUtilities.m102dp((WebPlayerView.this.inFullscreen ? 6 : 10) + 29));
            ...
            if (this.duration != 0) {
                ...
                if (!WebPlayerView.this.isInline) {
                    if (WebPlayerView.this.inFullscreen) {
                        m102dp = measuredHeight - AndroidUtilities.m102dp(29);
                        i3 = this.durationWidth + AndroidUtilities.m102dp(36);
                        measuredWidth = (measuredWidth - AndroidUtilities.m102dp(76)) - this.durationWidth;
                        m102dp2 = AndroidUtilities.m102dp(28);
                    } else {
                        m102dp = measuredHeight - AndroidUtilities.m102dp(13);
                        m102dp2 = AndroidUtilities.m102dp(12);
                    }
                } else {
                    m102dp = measuredHeight - AndroidUtilities.m102dp(3);
                    m102dp2 = AndroidUtilities.m102dp(7);
                }
                int i4 = measuredHeight - m102dp2;
                int i5 = measuredWidth;
                int i6 = m102dp;
                int i7 = i3;
                if (WebPlayerView.this.inFullscreen) {
                    canvas.drawRect(i7, i6, i5, AndroidUtilities.m102dp(3) + i6, this.progressInnerPaint);
                }
                if (this.progressPressed) {
                ...
                if (i9 != 0 && (i2 = this.duration) != 0) {
                    float f = i7;
                    canvas.drawRect(f, i6, ((i5 - i7) * (i9 / i2)) + f, AndroidUtilities.m102dp(3) + i6, WebPlayerView.this.inFullscreen ? this.progressBufferedPaint : this.progressInnerPaint);
                }
                float f2 = i8;
                canvas.drawRect(i7, i6, f2, i6 + AndroidUtilities.m102dp(3), this.progressPaint);
                if (WebPlayerView.this.isInline) {
                    return;
                }
                canvas.drawCircle(f2, i4, AndroidUtilities.m102dp(this.progressPressed ? 7 : 5), this.progressPaint);
            }
        }
    }
    ...
    public WebPlayerView(final Context context, boolean z, boolean z2, WebPlayerViewDelegate webPlayerViewDelegate) {
        ...
        this.surfaceTextureListener = new TextureView.SurfaceTextureListener() { // from class: org.telegram.ui.Components.WebPlayerView.2
            ...
            /* loaded from: classes6.dex */
            public class ViewTreeObserver$OnPreDrawListenerC57521 implements ViewTreeObserver.OnPreDrawListener {
                ViewTreeObserver$OnPreDrawListenerC57521() {
                }
                ...
                public boolean onPreDraw() {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.WebPlayerView$2$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            WebPlayerView.TextureView$SurfaceTextureListenerC57512.ViewTreeObserver$OnPreDrawListenerC57521.this.lambda$onPreDraw$0();
                        }
                    });
            ...
            public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
                if (WebPlayerView.this.waitingForFirstTextureUpload == 1) {
                    WebPlayerView.this.changedTextureView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC57521());
        ...
        webView.addJavascriptInterface(new JavaScriptInterface(new CallJavaResultInterface() { // from class: org.telegram.ui.Components.WebPlayerView$$ExternalSyntheticLambda5
            @Override // org.telegram.p042ui.Components.WebPlayerView.CallJavaResultInterface
        ...
        if (z2) {
            ...
            this.shareButton.setImageResource(C3630R.C3632drawable.ic_share_video);
    ...
    public /* synthetic */ void lambda$new$3(View view) {
        ...
        if (viewGroup != this) {
            ...
            this.aspectRatioFrameLayout.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() - AndroidUtilities.m102dp(10), 1073741824));
        }
    ...
    @Override // android.view.View
    protected void onDraw(Canvas canvas) {
        canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m102dp(10), this.backgroundPaint);
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i6 = i4 - i2;
        int m102dp = ((i6 - AndroidUtilities.m102dp(10)) - this.aspectRatioFrameLayout.getMeasuredHeight()) / 2;
        AspectRatioFrameLayout aspectRatioFrameLayout = this.aspectRatioFrameLayout;
        aspectRatioFrameLayout.layout(measuredWidth, m102dp, aspectRatioFrameLayout.getMeasuredWidth() + measuredWidth, this.aspectRatioFrameLayout.getMeasuredHeight() + m102dp);
        if (this.controlsView.getParent() == this) {
        ...
        this.controlsView.imageReceiver.setImageCoords(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m102dp(10));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.aspectRatioFrameLayout.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2 - AndroidUtilities.m102dp(10), 1073741824));
        if (this.controlsView.getParent() == this) {
        ...
        this.progressView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(44), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(44), 1073741824));
    ...
    public void updatePlayButton() {
        ...
        if (!this.videoPlayer.isPlaying()) {
            if (this.isCompleted) {
                this.playButton.setImageResource(this.isInline ? C3630R.C3632drawable.ic_againinline : C3630R.C3632drawable.ic_again);
                return;
            } else {
                this.playButton.setImageResource(this.isInline ? C3630R.C3632drawable.ic_playinline : C3630R.C3632drawable.ic_play);
                return;
            }
        }
        this.playButton.setImageResource(this.isInline ? C3630R.C3632drawable.ic_pauseinline : C3630R.C3632drawable.ic_pause);
    ...
    public void updateFullscreenButton() {
        ...
        if (!this.inFullscreen) {
            this.fullscreenButton.setImageResource(C3630R.C3632drawable.ic_gofullscreen);
            this.fullscreenButton.setLayoutParams(LayoutHelper.createFrame(56, 56, 85, 0, 0, 0, 5));
            return;
        }
        this.fullscreenButton.setImageResource(C3630R.C3632drawable.ic_outfullscreen);
    ...
    public void updateInlineButton() {
        ...
        imageView.setImageResource(this.isInline ? C3630R.C3632drawable.ic_goinline : C3630R.C3632drawable.ic_outinline);
    ...
    */
    public boolean loadVideo(java.lang.String r27, org.telegram.tgnet.TLRPC$Photo r28, java.lang.Object r29, java.lang.String r30, boolean r31) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.WebPlayerView.loadVideo(java.lang.String, org.telegram.tgnet.TLRPC$Photo, java.lang.Object, java.lang.String, boolean):boolean");
    }
