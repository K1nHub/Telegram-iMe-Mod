...
/* renamed from: org.telegram.ui.Components.ChatAttachAlertAudioLayout */
...
public class ChatAttachAlertAudioLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* renamed from: org.telegram.ui.Components.ChatAttachAlertAudioLayout$AudioSelectDelegate */
    /* loaded from: classes6.dex */
    public interface AudioSelectDelegate {
        void didSelectAudio(ArrayList<MessageObject> arrayList, CharSequence charSequence, boolean z, int i, String str, boolean z2, boolean z3);
    }
    ...
    void onSelectedItemsCountChanged(int i) {
        this.otherItem.showSubItem(ChatAttachAlertPhotoLayout.getOpenInSubItemId());
        boolean z = true;
        this.otherItem.setSubItemVisible(ChatAttachAlertPhotoLayout.getSendWithoutGroupingSubItemId(), (i <= 1 || this.parentAlert.editingMessageObject != null) ? false : false);
    }
    ...
    public ChatAttachAlertAudioLayout(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        SearchField searchField = new SearchField(context, false, resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout.1
            ...
            public void processTouchEvent(MotionEvent motionEvent) {
                ...
                obtain.setLocation(obtain.getRawX(), (obtain.getRawY() - ChatAttachAlertAudioLayout.this.parentAlert.getSheetContainer().getTranslationY()) - AndroidUtilities.m102dp(58));
        ...
        searchField.setHint(LocaleController.getString("SearchMusic", C3630R.string.SearchMusic));
        this.frameLayout.addView(this.searchField, LayoutHelper.createFrame(-1, -1, 51));
        this.searchField.setPadding(0, 0, AndroidUtilities.m102dp(40), 0);
        ...
        actionBarMenuItem.setIcon(C3630R.C3632drawable.ic_ab_other);
        actionBarMenuItem.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3630R.string.AccDescrMoreOptions));
        actionBarMenuItem.setSubMenuOpenSide(2);
        actionBarMenuItem.setDelegate(new ActionBarMenuItem.ActionBarMenuItemDelegate() { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda4
            @Override // org.telegram.p042ui.ActionBar.ActionBarMenuItem.ActionBarMenuItemDelegate
            public final void onItemClick(int i) {
                ChatAttachAlertAudioLayout.this.lambda$new$0(i);
            }
        });
        actionBarMenuItem.setAdditionalYOffset(AndroidUtilities.m102dp(-8));
        actionBarMenuItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatAttachAlertAudioLayout.this.lambda$new$1(view);
            }
        });
        actionBarMenuItem.addSubItem(ChatAttachAlertPhotoLayout.getSendWithoutGroupingSubItemId(), LocaleController.getString("SendWithoutGrouping", C3630R.string.SendWithoutGrouping));
        actionBarMenuItem.addSubItem(ChatAttachAlertPhotoLayout.getOpenInSubItemId(), C3630R.C3632drawable.msg_openin, LocaleController.getString("OpenInExternalApp", C3630R.string.OpenInExternalApp));
        this.frameLayout.addView(actionBarMenuItem, LayoutHelper.createFrame(36, 36, 53, 0, 11, 9, 0));
        EmptyTextProgressView emptyTextProgressView = new EmptyTextProgressView(context, null, resourcesProvider);
        this.progressView = emptyTextProgressView;
        emptyTextProgressView.showProgress();
        addView(this.progressView, LayoutHelper.createFrame(-1, -1));
        ...
        this.emptyView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda1
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                boolean lambda$new$2;
                lambda$new$2 = ChatAttachAlertAudioLayout.lambda$new$2(view, motionEvent);
                return lambda$new$2;
            }
        });
        ImageView imageView = new ImageView(context);
        this.emptyImageView = imageView;
        imageView.setImageResource(C3630R.C3632drawable.music_empty);
        ...
        this.emptyTitleTextView.setPadding(AndroidUtilities.m102dp(40), 0, AndroidUtilities.m102dp(40), 0);
        ...
        this.emptySubtitleTextView.setPadding(AndroidUtilities.m102dp(40), 0, AndroidUtilities.m102dp(40), 0);
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context, resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout.2
            ...
            protected boolean allowSelectChildAtPosition(float f, float f2) {
                return f2 >= ((float) ((ChatAttachAlertAudioLayout.this.parentAlert.scrollOffsetY[0] + AndroidUtilities.m102dp(30)) + ((Build.VERSION.SDK_INT < 21 || ChatAttachAlertAudioLayout.this.parentAlert.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight)));
            }
        };
        this.listView = recyclerListView;
        recyclerListView.setClipToPadding(false);
        RecyclerListView recyclerListView2 = this.listView;
        FillLastLinearLayoutManager fillLastLinearLayoutManager = new FillLastLinearLayoutManager(getContext(), 1, false, AndroidUtilities.m102dp(9), this.listView) { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout.3
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i2) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout.3.1
                    ...
                    public int calculateDyToMakeVisible(View view, int i3) {
                        return super.calculateDyToMakeVisible(view, i3) - (ChatAttachAlertAudioLayout.this.listView.getPaddingTop() - AndroidUtilities.m102dp(7));
                    }
        ...
        addView(this.listView, LayoutHelper.createFrame(-1, -1, 51, 0, 0, 0, 0));
        RecyclerListView recyclerListView3 = this.listView;
        ListAdapter listAdapter = new ListAdapter(context);
        this.listAdapter = listAdapter;
        recyclerListView3.setAdapter(listAdapter);
        this.listView.setGlowColor(getThemedColor(Theme.key_dialogScrollGlow));
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda5
            @Override // org.telegram.p042ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i2) {
                ChatAttachAlertAudioLayout.this.lambda$new$3(view, i2);
            }
        });
        this.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda6
            @Override // org.telegram.p042ui.Components.RecyclerListView.OnItemLongClickListener
            public final boolean onItemClick(View view, int i2) {
                boolean lambda$new$4;
                lambda$new$4 = ChatAttachAlertAudioLayout.this.lambda$new$4(view, i2);
                return lambda$new$4;
            }
        });
        ...
        layoutParams.topMargin = AndroidUtilities.m102dp(58);
    ...
    public void updateEmptyView() {
        ...
        if (this.loadingAudio) {
            ...
            if (this.listView.getAdapter() == this.searchAdapter) {
                this.emptyTitleTextView.setText(LocaleController.getString("NoAudioFound", C3630R.string.NoAudioFound));
            } else {
                this.emptyTitleTextView.setText(LocaleController.getString("NoAudioFiles", C3630R.string.NoAudioFiles));
                this.emptySubtitleTextView.setText(LocaleController.getString("NoAudioFilesInfo", C3630R.string.NoAudioFilesInfo));
            }
    ...
    public int getCurrentItemTop() {
        ...
        int top = childAt.getTop() - AndroidUtilities.m102dp(8);
        ...
        return top + AndroidUtilities.m102dp(12);
    }

    @Override // org.telegram.p042ui.Components.ChatAttachAlert.AttachAlertLayout
    public int getFirstOffset() {
        return getListTopPadding() + AndroidUtilities.m102dp(4);
    }
    ...
    public void onPreMeasure(int i, int i2) {
        int i3;
        if (this.parentAlert.sizeNotifierFrameLayout.measureKeyboardHeight() > AndroidUtilities.m102dp(20)) {
        ...
        if (this.listView.getPaddingTop() != i3) {
            ...
            this.listView.setPadding(0, i3, 0, AndroidUtilities.m102dp(48));
    ...
    */
    private void onItemClick(android.view.View r13) {
        /*
            r12 = this;
            boolean r0 = r13 instanceof org.telegram.p042ui.Cells.SharedAudioCell
            if (r0 != 0) goto L5
            return
        L5:
            org.telegram.ui.Cells.SharedAudioCell r13 = (org.telegram.p042ui.Cells.SharedAudioCell) r13
            ...
            r5.add(r13)
            org.telegram.ui.Components.ChatAttachAlertAudioLayout$AudioSelectDelegate r4 = r12.delegate
            org.telegram.ui.Components.ChatAttachAlert r13 = r12.parentAlert
            org.telegram.ui.Components.EditTextEmoji r13 = r13.commentTextView
            ...
            r10 = 0
            r11 = 1
            r4.didSelectAudio(r5, r6, r7, r8, r9, r10, r11)
        L33:
            r2 = r3
            goto L85
        L35:
            android.util.LongSparseArray<org.telegram.messenger.MediaController$AudioEntry> r1 = r12.selectedAudios
            long r4 = r0.f1531id
            ...
            long r4 = r0.f1531id
            r1.remove(r4)
            java.util.ArrayList<org.telegram.messenger.MediaController$AudioEntry> r1 = r12.selectedAudiosOrder
            r1.remove(r0)
            r13.setChecked(r2, r3)
            goto L85
        L4f:
            int r1 = r12.maxSelectedFiles
            if (r1 < 0) goto L75
            android.util.LongSparseArray<org.telegram.messenger.MediaController$AudioEntry> r1 = r12.selectedAudios
            int r1 = r1.size()
            int r4 = r12.maxSelectedFiles
            if (r1 < r4) goto L75
            int r13 = org.telegram.messenger.C3630R.string.PassportUploadMaxReached
        ...
        L8a:
            r3 = 2
        L8b:
            r13.updateCountButton(r3)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatAttachAlertAudioLayout.onItemClick(android.view.View):void");
    }
    ...
    void sendSelectedItems(boolean z, int i, String str, boolean z2, boolean z3) {
        ...
        this.delegate.didSelectAudio(arrayList, this.parentAlert.commentTextView.getText(), z, i, str, z2, z3);
    }
    ...
    private void loadAudio() {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ChatAttachAlertAudioLayout.this.lambda$loadAudio$6();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadAudio$6() {
        ...
        try {
            ...
            while (query.moveToNext()) {
                ...
                audioEntry.f1531id = query.getInt(0);
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ChatAttachAlertAudioLayout.this.lambda$loadAudio$5(arrayList);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadAudio$5(ArrayList arrayList) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.ChatAttachAlertAudioLayout$ListAdapter */
    /* loaded from: classes6.dex */
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                view.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m102dp(56)));
            } else {
                view = new View(this.mContext);
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            if (viewHolder.getItemViewType() == 0) {
                ...
                sharedAudioCell.setChecked(ChatAttachAlertAudioLayout.this.selectedAudios.indexOfKey(audioEntry.f1531id) >= 0, false);
            }
        }
    ...
    /* renamed from: org.telegram.ui.Components.ChatAttachAlertAudioLayout$SearchAdapter */
    /* loaded from: classes6.dex */
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ void lambda$updateSearchResults$2(int i, String str, ArrayList arrayList) {
            ...
            if (ChatAttachAlertAudioLayout.this.listView.getAdapter() == ChatAttachAlertAudioLayout.this.searchAdapter) {
                ChatAttachAlertAudioLayout.this.emptySubtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoAudioFoundInfo", C3630R.string.NoAudioFoundInfo, str)));
            }
