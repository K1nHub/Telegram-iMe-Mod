...
public class EmptyTextProgressView extends FrameLayout {
    ...
    public EmptyTextProgressView(Context context, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        linearLayout.setPadding(AndroidUtilities.m102dp(20), 0, AndroidUtilities.m102dp(20), 0);
        ...
        this.textView.setText(LocaleController.getString("NoResult", C3630R.string.NoResult));
    ...
    public void setTopImage(int i) {
        ...
        this.textView.setCompoundDrawablePadding(AndroidUtilities.m102dp(1));
    }
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (childAt == view && (view instanceof FlickerLoadingView)) {
                    ...
                    if (i8 == 2) {
                        measuredHeight = (AndroidUtilities.m102dp(100) - childAt.getMeasuredHeight()) / 2;
                        paddingTop = getPaddingTop();
                    } else if (i8 == 1) {
