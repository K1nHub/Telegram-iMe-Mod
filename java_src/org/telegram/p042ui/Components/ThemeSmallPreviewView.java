...
public class ThemeSmallPreviewView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ThemeSmallPreviewView(Context context, int i, Theme.ResourcesProvider resourcesProvider, int i2) {
        super(context);
        this.STROKE_RADIUS = AndroidUtilities.m102dp(8);
        this.INNER_RADIUS = AndroidUtilities.m102dp(6);
        this.INNER_RECT_SPACE = AndroidUtilities.m102dp(4);
        this.BUBBLE_HEIGHT = AndroidUtilities.m102dp(21);
        this.BUBBLE_WIDTH = AndroidUtilities.m102dp(41);
        ...
        this.outlineBackgroundPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.currentType == 1) {
            ...
            int m102dp = AndroidUtilities.m102dp(77);
            int size2 = View.MeasureSpec.getSize(i2);
            if (size2 == 0) {
                size2 = (int) (m102dp * 1.35f);
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(m102dp, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
        }
    ...
    public void setItem(final ChatThemeBottomSheet.ChatThemeItem chatThemeItem, boolean z) {
        ...
        if (emojiThemes == null || emojiThemes.showAsDefaultStub) {
            setContentDescription(LocaleController.getString("ChatNoTheme", C3630R.string.ChatNoTheme));
        } else {
    ...
    public /* synthetic */ void lambda$setItem$3(final ChatThemeBottomSheet.ChatThemeItem chatThemeItem, final int i) {
        final Bitmap bitmap = SvgHelper.getBitmap(C3630R.raw.default_pattern, AndroidUtilities.m102dp(120), AndroidUtilities.m102dp(140), -16777216, AndroidUtilities.density);
    ...
    private Bitmap prescaleBitmap(Bitmap bitmap) {
        ...
        float max = Math.max(AndroidUtilities.m102dp(120) / bitmap.getWidth(), AndroidUtilities.m102dp(140) / bitmap.getHeight());
    ...
    private void fillOutBubblePaint(Paint paint, List<Integer> list) {
        if (list.size() > 1) {
            ...
            float m102dp = this.INNER_RECT_SPACE + AndroidUtilities.m102dp(8);
            paint.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, m102dp, (float) BitmapDescriptorFactory.HUE_RED, m102dp + this.BUBBLE_HEIGHT, iArr, (float[]) null, Shader.TileMode.CLAMP));
            return;
        }
    ...
    private Drawable getPreviewDrawable(EmojiThemes.ThemeItem themeItem) {
        ...
        if (themeItem.themeInfo.getAccent(false) != null) {
            ...
            if (themeInfo != null && (themeInfo.previewWallpaperOffset > 0 || themeInfo.pathToWallpaper != null)) {
                ...
                Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(AndroidUtilities.m102dp(112), AndroidUtilities.m102dp(134), themeInfo2.pathToWallpaper, themeInfo2.pathToFile, themeInfo2.previewWallpaperOffset);
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        textPaint.setColor(getThemedColor(Theme.key_chat_emojiPanelTrendingDescription));
        this.noThemeTextPaint.setTextSize(AndroidUtilities.m102dp(14));
        this.noThemeTextPaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        StaticLayout createStaticLayout2 = StaticLayoutEx.createStaticLayout2(LocaleController.getString("ChatNoTheme", C3630R.string.ChatNoTheme), this.noThemeTextPaint, AndroidUtilities.m102dp(52), Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, true, TextUtils.TruncateAt.END, AndroidUtilities.m102dp(52), 3);
    ...
    public class ThemeDrawable {
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (themeSmallPreviewView.isSelected || themeSmallPreviewView.strokeAlphaAnimator != null) {
                ...
                float strokeWidth = (this.strokePaint.getStrokeWidth() * 0.5f) + (AndroidUtilities.m102dp(4) * (1.0f - ThemeSmallPreviewView.this.selectionProgress));
            ...
            if (emojiThemes == null || (emojiThemes.showAsDefaultStub && emojiThemes.wallpaper == null)) {
                ...
                canvas.translate((ThemeSmallPreviewView.this.getWidth() - noThemeStaticLayout.getWidth()) * 0.5f, AndroidUtilities.m102dp(18));
                noThemeStaticLayout.draw(canvas);
                canvas.restore();
            } else if (themeSmallPreviewView3.currentType != 2) {
                float m102dp = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m102dp(8);
                float m102dp2 = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m102dp(22);
                if (ThemeSmallPreviewView.this.currentType == 0) {
                    ThemeSmallPreviewView.this.rectF.set(m102dp2, m102dp, ThemeSmallPreviewView.this.BUBBLE_WIDTH + m102dp2, ThemeSmallPreviewView.this.BUBBLE_HEIGHT + m102dp);
                } else {
                    m102dp = ThemeSmallPreviewView.this.getMeasuredHeight() * 0.12f;
                    ThemeSmallPreviewView.this.rectF.set(ThemeSmallPreviewView.this.getMeasuredWidth() - (ThemeSmallPreviewView.this.getMeasuredWidth() * 0.65f), m102dp, ThemeSmallPreviewView.this.getMeasuredWidth() - (ThemeSmallPreviewView.this.getMeasuredWidth() * 0.1f), ThemeSmallPreviewView.this.getMeasuredHeight() * 0.32f);
                }
                ...
                if (ThemeSmallPreviewView.this.currentType == 0) {
                    ...
                    themeSmallPreviewView4.messageDrawableOut.setBounds((int) themeSmallPreviewView4.rectF.left, ((int) ThemeSmallPreviewView.this.rectF.top) - AndroidUtilities.m102dp(2), ((int) ThemeSmallPreviewView.this.rectF.right) + AndroidUtilities.m102dp(4), ((int) ThemeSmallPreviewView.this.rectF.bottom) + AndroidUtilities.m102dp(2));
                ...
                if (ThemeSmallPreviewView.this.currentType == 0) {
                    float m102dp3 = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m102dp(5);
                    float m102dp4 = m102dp + ThemeSmallPreviewView.this.BUBBLE_HEIGHT + AndroidUtilities.m102dp(4);
                    ThemeSmallPreviewView.this.rectF.set(m102dp3, m102dp4, ThemeSmallPreviewView.this.BUBBLE_WIDTH + m102dp3, ThemeSmallPreviewView.this.BUBBLE_HEIGHT + m102dp4);
                } else {
                ...
                themeSmallPreviewView6.messageDrawableIn.setBounds(((int) themeSmallPreviewView6.rectF.left) - AndroidUtilities.m102dp(4), ((int) ThemeSmallPreviewView.this.rectF.top) - AndroidUtilities.m102dp(2), (int) ThemeSmallPreviewView.this.rectF.right, ((int) ThemeSmallPreviewView.this.rectF.bottom) + AndroidUtilities.m102dp(2));
                ...
                if (themeSmallPreviewView8.chatThemeItem.icon != null) {
                    canvas.drawBitmap(ThemeSmallPreviewView.this.chatThemeItem.icon, (themeSmallPreviewView8.getWidth() - ThemeSmallPreviewView.this.chatThemeItem.icon.getWidth()) * 0.5f, AndroidUtilities.m102dp(21), (Paint) null);
                }
            }
        }
    }
