...
public class TermsOfServiceView extends FrameLayout {
    ...
    public TermsOfServiceView(Context context) {
        ...
        imageView.setImageResource(C3630R.C3632drawable.logo_middle);
        ...
        this.titleTextView.setText(LocaleController.getString("PrivacyPolicyAndTerms", C3630R.string.PrivacyPolicyAndTerms));
        ...
        this.scrollView.setPadding(AndroidUtilities.m103dp(24.0f), i, AndroidUtilities.m103dp(24.0f), AndroidUtilities.m103dp(75.0f));
        ...
        textView3.setText(LocaleController.getString("Decline", C3630R.string.Decline).toUpperCase());
        ...
        textView3.setPadding(AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(10));
        ...
        textView4.setText(LocaleController.getString(RtspHeaders.ACCEPT, C3630R.string.Accept));
        textView4.setGravity(17);
        textView4.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView4.setTextColor(-1);
        textView4.setTextSize(1, 14.0f);
        textView4.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(4), -11491093, -12346402));
        textView4.setPadding(AndroidUtilities.m102dp(34), 0, AndroidUtilities.m102dp(34), 0);
        ...
        layoutParams.bottomMargin = AndroidUtilities.m103dp(75.0f);
    ...
    public /* synthetic */ void lambda$new$4(View view) {
        ...
        builder.setTitle(LocaleController.getString("TermsOfService", C3630R.string.TermsOfService));
        builder.setPositiveButton(LocaleController.getString("DeclineDeactivate", C3630R.string.DeclineDeactivate), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                TermsOfServiceView.this.lambda$new$3(dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Back", C3630R.string.Back), null);
        builder.setMessage(LocaleController.getString("TosUpdateDecline", C3630R.string.TosUpdateDecline));
        builder.show();
    }
    ...
    public /* synthetic */ void lambda$new$3(DialogInterface dialogInterface, int i) {
        ...
        builder.setMessage(LocaleController.getString("TosDeclineDeleteAccount", C3630R.string.TosDeclineDeleteAccount));
        builder.setTitle(LocaleController.getString("AppName", C3630R.string.AppName));
        builder.setPositiveButton(LocaleController.getString("Deactivate", C3630R.string.Deactivate), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void lambda$new$0(AlertDialog alertDialog, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (tLObject instanceof TLRPC$TL_boolTrue) {
            ...
            String string = LocaleController.getString("ErrorOccurred", C3630R.string.ErrorOccurred);
    ...
    public /* synthetic */ void lambda$new$6(View view) {
        if (this.currentTos.min_age_confirm != 0) {
            AlertDialog.Builder builder = new AlertDialog.Builder(view.getContext());
            builder.setTitle(LocaleController.getString("TosAgeTitle", C3630R.string.TosAgeTitle));
            builder.setPositiveButton(LocaleController.getString("Agree", C3630R.string.Agree), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), null);
            builder.setMessage(LocaleController.formatString("TosAgeText", C3630R.string.TosAgeText, LocaleController.formatPluralString("Years", this.currentTos.min_age_confirm, new Object[0])));
            builder.show();
            return;
        }
        accept();
    ...
    private void accept() {
        ...
        tLRPC$TL_help_acceptTermsOfService.f1660id = this.currentTos.f1662id;
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_help_acceptTermsOfService, new RequestDelegate() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda7
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void show(int i, TLRPC$TL_help_termsOfService tLRPC$TL_help_termsOfService) {
        ...
        addBulletsToText(spannableStringBuilder, '-', AndroidUtilities.m103dp(10.0f), -11491093, AndroidUtilities.m103dp(4.0f));
