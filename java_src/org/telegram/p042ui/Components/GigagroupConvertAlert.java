...
public class GigagroupConvertAlert extends BottomSheet {
    ...
    public GigagroupConvertAlert(final Context context, final BaseFragment baseFragment) {
        ...
        rLottieImageView.setAnimation(C3630R.raw.utyan_gigagroup, 120, 120);
        ...
        textView.setText(LocaleController.getString("GigagroupConvertTitle", C3630R.string.GigagroupConvertTitle));
        ...
        while (true) {
            if (i < 3) {
                ...
                if (i == 0) {
                    textView2.setText(LocaleController.getString("GigagroupConvertInfo1", C3630R.string.GigagroupConvertInfo1));
                } else if (i == 1) {
                    textView2.setText(LocaleController.getString("GigagroupConvertInfo2", C3630R.string.GigagroupConvertInfo2));
                } else if (i == 2) {
                    textView2.setText(LocaleController.getString("GigagroupConvertInfo3", C3630R.string.GigagroupConvertInfo3));
                }
                ...
                bottomSheetCell.setText(LocaleController.getString("GigagroupConvertProcessButton", C3630R.string.GigagroupConvertProcessButton));
                ...
                textView3.setText(LocaleController.getString("GigagroupConvertCancelButton", C3630R.string.GigagroupConvertCancelButton));
    ...
    public /* synthetic */ void lambda$new$1(Context context, BaseFragment baseFragment, View view) {
        ...
        builder.setTitle(LocaleController.getString("GigagroupConvertAlertTitle", C3630R.string.GigagroupConvertAlertTitle));
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("GigagroupConvertAlertText", C3630R.string.GigagroupConvertAlertText)));
        builder.setPositiveButton(LocaleController.getString("GigagroupConvertAlertConver", C3630R.string.GigagroupConvertAlertConver), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.GigagroupConvertAlert$$ExternalSyntheticLambda0
