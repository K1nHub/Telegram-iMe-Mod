...
import org.telegram.p042ui.Stories.StoriesGradientTools;
import org.telegram.tgnet.TLObject;
import org.telegram.tgnet.TLRPC$Chat;
import org.telegram.tgnet.TLRPC$TL_groupCallParticipant;
import org.telegram.tgnet.TLRPC$User;
/* renamed from: org.telegram.ui.Components.AvatarsDrawable */
...
public class AvatarsDrawable {
    ...
    public void commitTransition(boolean z, boolean z2) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (drawingStateArr2[i].f1808id != this.animatingStates[i].f1808id) {
                z4 = true;
            } else {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            while (true) {
                if (i3 >= 3) {
                    z3 = false;
                    break;
                } else if (this.currentStates[i3].f1808id == this.animatingStates[i2].f1808id) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.AvatarsDrawable$DrawingState */
    /* loaded from: classes6.dex */
    ...
    public AvatarsDrawable(View view, boolean z) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            this.currentStates[i].imageReceiver.setRoundRadius(AndroidUtilities.m102dp(12));
            this.currentStates[i].avatarDrawable = new AvatarDrawable();
            this.currentStates[i].avatarDrawable.setTextSize(AndroidUtilities.m102dp(12));
            this.animatingStates[i] = new DrawingState();
            this.animatingStates[i].imageReceiver = new ImageReceiver(view);
            this.animatingStates[i].imageReceiver.setRoundRadius(AndroidUtilities.m102dp(12));
            this.animatingStates[i].avatarDrawable = new AvatarDrawable();
            this.animatingStates[i].avatarDrawable.setTextSize(AndroidUtilities.m102dp(12));
        }
        this.isInCall = z;
    ...
    public void setObject(int i, int i2, TLObject tLObject) {
        ...
        TLRPC$Chat chat;
        this.animatingStates[i].f1808id = 0L;
        ...
        if (tLObject instanceof TLRPC$TL_groupCallParticipant) {
            ...
            this.animatingStates[i].f1808id = peerId;
            tLRPC$Chat = chat;
            ...
            this.animatingStates[i].f1808id = tLRPC$User2.f1762id;
            ...
            this.animatingStates[i].f1808id = -tLRPC$Chat.f1600id;
        }
        if (tLRPC$User == null) {
    ...
    */
    public void onDraw(android.graphics.Canvas r32) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.AvatarsDrawable.onDraw(android.graphics.Canvas):void");
    }
    ...
    public int getSize() {
        ...
        return AndroidUtilities.m102dp(i2 == 4 || i2 == 10 ? 32 : 24);
    }
