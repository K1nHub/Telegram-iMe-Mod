...
public class BotCommandsMenuView extends View {
    ...
    public void setTemplatesMode(boolean z, final ChatActivity chatActivity) {
        ...
        if (z) {
            this.templatesDrawable = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.fork_templates);
    ...
    public BotCommandsMenuView(Context context) {
        ...
        int i = C3630R.raw.bot_webview_sheet_to_cross;
        this.webViewAnimation = new RLottieDrawable(i, String.valueOf(i) + hashCode(), AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(20)) { // from class: org.telegram.ui.Components.BotCommandsMenuView.2
            @Override // android.graphics.drawable.Drawable
            public void invalidateSelf() {
                super.invalidateSelf();
                BotCommandsMenuView.this.invalidate();
        ...
        this.menuText = LocaleController.getString(C3630R.string.BotsMenuTitle);
        ...
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(16), 0, Theme.getColor(Theme.key_featuredStickers_addButtonPressed));
        this.backgroundDrawable = createSimpleSelectorRoundRectDrawable;
        createSimpleSelectorRoundRectDrawable.setCallback(this);
        setContentDescription(LocaleController.getString("AccDescrBotMenu", C3630R.string.AccDescrBotMenu));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        onTranslationChanged((this.menuTextLayout.getWidth() + AndroidUtilities.m102dp(4)) * this.expandProgress);
        int m102dp = AndroidUtilities.m102dp(40);
        if (this.expanded) {
            m102dp += this.menuTextLayout.getWidth() + AndroidUtilities.m102dp(4);
        }
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(m102dp, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(32), 1073741824));
    }
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.BotCommandsMenuView.dispatchDraw(android.graphics.Canvas):void");
    }

    public boolean setMenuText(String str) {
        if (str == null) {
            str = LocaleController.getString(C3630R.string.BotsMenuTitle);
        }
    ...
    public static class BotCommandView extends LinearLayout {
        ...
        public BotCommandView(Context context) {
            ...
            addView(this.description, LayoutHelper.createLinear(-1, -2, 1.0f, 16, 0, 0, AndroidUtilities.m102dp(8), 0));
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(36), 1073741824));
        }
