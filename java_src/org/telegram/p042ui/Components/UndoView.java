...
public class UndoView extends FrameLayout {
    ...
    public void showInfo(CharSequence charSequence, Runnable runnable) {
        showWithAction(0L, 18, charSequence, Integer.valueOf(C3630R.raw.info), (Runnable) null, runnable);
    }

    public void showError(CharSequence charSequence) {
        showWithAction(0L, 18, charSequence, Integer.valueOf(C3630R.raw.error), (Runnable) null, (Runnable) null);
    }
    ...
    public UndoView(Context context, BaseFragment baseFragment, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.enterOffsetMargin = AndroidUtilities.m102dp(8);
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m102dp(15));
        addView(this.avatarImageView, LayoutHelper.createFrame(30, 30, 19, 15, 0, 0, 0));
        LinearLayout linearLayout = new LinearLayout(context);
        this.undoButton = linearLayout;
        linearLayout.setOrientation(0);
        this.undoButton.setBackground(Theme.createRadSelectorDrawable(getThemedColor(i2) & 587202559, AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2)));
        ...
        this.rect = new RectF(AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(33), AndroidUtilities.m102dp(33));
        ...
        this.backgroundDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m102dp(10), getThemedColor(i3));
    ...
    /* JADX WARN: Removed duplicated region for block: B:817:0x1ae6  */
    /* JADX WARN: Removed duplicated region for block: B:820:0x1b06  */
    /* JADX WARN: Removed duplicated region for block: B:823:0x1b2d  */
    /* JADX WARN: Removed duplicated region for block: B:827:0x1b72  */
    /* JADX WARN: Removed duplicated region for block: B:858:0x1c25  */
    ...
    */
    public void showWithAction(java.util.ArrayList<java.lang.Long> r22, int r23, java.lang.Object r24, java.lang.Object r25, java.lang.Runnable r26, java.lang.Runnable r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.UndoView.showWithAction(java.util.ArrayList, int, java.lang.Object, java.lang.Object, java.lang.Runnable, java.lang.Runnable):void");
    }
    ...
    public /* synthetic */ void lambda$showWithAction$6(TLRPC$Message tLRPC$Message, View view) {
        ...
        tLRPC$TL_payments_getPaymentReceipt.msg_id = tLRPC$Message.f1624id;
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.additionalTranslationY != BitmapDescriptorFactory.HUE_RED) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + AndroidUtilities.m102dp(9);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.additionalTranslationY != BitmapDescriptorFactory.HUE_RED) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + this.enterOffsetMargin + AndroidUtilities.m102dp(1);
            if (measuredHeight > BitmapDescriptorFactory.HUE_RED) {
                canvas.clipRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), measuredHeight);
                super.dispatchDraw(canvas);
            }
        ...
        if (i == 1 || i == 0 || i == 27 || i == 26 || i == 81 || i == 88) {
            ...
            if (this.timeLayoutOut != null) {
                ...
                if (f3 < 1.0f) {
                    ...
                    canvas.save();
                    canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m103dp(17.2f) + (AndroidUtilities.m102dp(10) * this.timeReplaceProgress));
            ...
            if (this.timeLayout != null) {
                ...
                canvas.save();
                canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m103dp(17.2f) - (AndroidUtilities.m102dp(10) * (1.0f - this.timeReplaceProgress)));
    ...
    private void updatePosition() {
        setTranslationY(((this.enterOffset - this.enterOffsetMargin) + AndroidUtilities.m102dp(8)) - this.additionalTranslationY);
        invalidate();
    }
