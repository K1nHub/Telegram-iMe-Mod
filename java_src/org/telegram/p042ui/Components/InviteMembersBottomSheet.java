...
import org.telegram.p042ui.Cells.GroupCreateSectionCell;
...
import org.telegram.p042ui.Components.UsersAlertBase;
...
/* renamed from: org.telegram.ui.Components.InviteMembersBottomSheet */
...
public class InviteMembersBottomSheet extends UsersAlertBase implements NotificationCenter.NotificationCenterDelegate {
    ...
    private boolean isCryptoboxChatSelection;
    private int lastRow;
    boolean linkGenerating;
    private int maxSize;
    private int noContactsStubRow;
    private Callbacks$Callback1<Long> onChatSelectedAction;
    ...
    private Long selectedCryptoBoxChatId;
    ...
    /* renamed from: org.telegram.ui.Components.InviteMembersBottomSheet$InviteMembersBottomSheetDelegate */
    /* loaded from: classes6.dex */
    ...
    public static /* synthetic */ void lambda$new$0(Long l) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$setCryptoboxChatSelectionScreen$1(ArrayList arrayList) {
    }
    ...
    public void setCryptoboxChatSelectionScreen(Long l, Callbacks$Callback1<Long> callbacks$Callback1) {
        this.isCryptoboxChatSelection = true;
        this.selectedCryptoBoxChatId = l;
        this.onChatSelectedAction = callbacks$Callback1;
        this.filter.flags = MessagesController.DIALOG_FILTER_FLAG_OWNER;
        setDelegate(new InviteMembersBottomSheetDelegate() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda9
            @Override // org.telegram.p042ui.Components.InviteMembersBottomSheet.InviteMembersBottomSheetDelegate
            public final void didSelectDialogs(ArrayList arrayList) {
                InviteMembersBottomSheet.lambda$setCryptoboxChatSelectionScreen$1(arrayList);
            }
        }, new ArrayList<>());
    }

    private void filterOwnedChats() {
        if (this.isCryptoboxChatSelection) {
            ArrayList<TLRPC$Dialog> arrayList = new ArrayList<>();
            MessagesController.DialogFilter dialogFilter = new MessagesController.DialogFilter();
            dialogFilter.unreadCount = -1;
            dialogFilter.pendingUnreadCount = -1;
            dialogFilter.flags = MessagesController.DIALOG_FILTER_FLAG_OWNER;
            Iterator<TLRPC$Dialog> it = this.dialogsServerOnly.iterator();
            while (it.hasNext()) {
                TLRPC$Dialog next = it.next();
                if (dialogFilter.includesDialog(this.parentFragment.getAccountInstance(), next.f1606id, next)) {
                    arrayList.add(next);
                }
            }
            this.dialogsServerOnly = arrayList;
        }
    }
    ...
    public InviteMembersBottomSheet(final Context context, int i, final LongSparseArray<TLObject> longSparseArray, final long j, final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        final InviteMembersBottomSheet inviteMembersBottomSheet;
        this.filter = new MessagesController.DialogFilter();
        this.isCryptoboxChatSelection = false;
        this.selectedCryptoBoxChatId = null;
        this.onChatSelectedAction = new Callbacks$Callback1() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda3
            @Override // com.iMe.fork.utils.Callbacks$Callback1
            public final void invoke(Object obj) {
                InviteMembersBottomSheet.lambda$new$0((Long) obj);
            }
        };
        ...
        this.chatId = j;
        fixNavigationBar();
        this.searchView.searchEditText.setHint(LocaleController.getString("SearchForChats", C3630R.string.SearchForChats));
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda10
            @Override // org.telegram.p042ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i3) {
                InviteMembersBottomSheet.this.lambda$new$2(j, baseFragment, longSparseArray, context, view, i3);
            }
        });
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.2
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                if (AndroidUtilities.isTablet() || size2 > size) {
                    InviteMembersBottomSheet.this.maxSize = AndroidUtilities.m102dp(144);
                } else {
                    InviteMembersBottomSheet.this.maxSize = AndroidUtilities.m102dp(56);
                }
        ...
        imageView.setImageResource(C3630R.C3632drawable.floating_check);
        if (i3 >= 21) {
            StateListAnimator stateListAnimator = new StateListAnimator();
            stateListAnimator.addState(new int[]{16842919}, ObjectAnimator.ofFloat(imageView, "translationZ", AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(4)).setDuration(200L));
            stateListAnimator.addState(new int[0], ObjectAnimator.ofFloat(imageView, "translationZ", AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(2)).setDuration(200L));
            imageView.setStateListAnimator(stateListAnimator);
            inviteMembersBottomSheet = this;
            imageView.setOutlineProvider(new ViewOutlineProvider(inviteMembersBottomSheet) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.3
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda2
            ...
            public final void onClick(View view) {
                InviteMembersBottomSheet.this.lambda$new$4(context, j, view);
            }
        });
        ...
        imageView.setContentDescription(LocaleController.getString("Next", C3630R.string.Next));
        inviteMembersBottomSheet.containerView.addView(imageView, LayoutHelper.createFrame(i3 >= 21 ? 56 : 60, i3 >= 21 ? 56 : 60, 85, 14, 14, 14, 14));
        ((ViewGroup.MarginLayoutParams) inviteMembersBottomSheet.emptyView.getLayoutParams()).topMargin = AndroidUtilities.m102dp(20);
        ((ViewGroup.MarginLayoutParams) inviteMembersBottomSheet.emptyView.getLayoutParams()).leftMargin = AndroidUtilities.m102dp(4);
        ((ViewGroup.MarginLayoutParams) inviteMembersBottomSheet.emptyView.getLayoutParams()).rightMargin = AndroidUtilities.m102dp(4);
    }
    ...
    */
    public /* synthetic */ void lambda$new$2(long r4, org.telegram.p042ui.ActionBar.BaseFragment r6, androidx.collection.LongSparseArray r7, android.content.Context r8, android.view.View r9, int r10) {
        /*
            Method dump skipped, instructions count: 379
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.InviteMembersBottomSheet.lambda$new$2(long, org.telegram.ui.ActionBar.BaseFragment, androidx.collection.LongSparseArray, android.content.Context, android.view.View, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$4(Context context, long j, View view) {
        ...
        if (this.selectedContacts.size() > 5) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", C3630R.string.AddMembersAlertNamesText, sb, chat.title)));
        }
        builder.setPositiveButton(LocaleController.getString("Add", C3630R.string.Add), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i3) {
                InviteMembersBottomSheet.this.lambda$new$3(dialogInterface, i3);
            }
        });
    ...
    @Override // org.telegram.p042ui.Components.UsersAlertBase, org.telegram.p042ui.ActionBar.BottomSheet, android.app.Dialog, android.content.DialogInterface
    public void dismiss() {
        super.dismiss();
    ...
    */
    public void setSelectedContacts(java.util.ArrayList<java.lang.Long> r12) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.InviteMembersBottomSheet.setSelectedContacts(java.util.ArrayList):void");
    }
            ...
            if (z) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        InviteMembersBottomSheet.this.lambda$spansCountChanged$5(valueAnimator2);
                    }
                });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$spansCountChanged$5(ValueAnimator valueAnimator) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.InviteMembersBottomSheet$ListAdapter */
    /* loaded from: classes6.dex */
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            if (i == 2) {
                manageChatTextCell = new View(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.ListAdapter.1
                    ...
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48) + InviteMembersBottomSheet.this.additionalHeight, 1073741824));
                    }
                };
            } else if (i == 3) {
                ...
                manageChatTextCell2.setText(LocaleController.getString("VoipGroupCopyInviteLink", C3630R.string.VoipGroupCopyInviteLink), null, C3630R.C3632drawable.msg_link, 7, true);
                ...
                StickerEmptyView stickerEmptyView = new StickerEmptyView(this, context, null, 0) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.ListAdapter.2
                    ...
                    @Override // org.telegram.p042ui.Components.StickerEmptyView, android.view.ViewGroup, android.view.View
                ...
                if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                    stickerEmptyView.title.setText(LocaleController.getString("FilterNoChats", C3630R.string.FilterNoChats));
                } else {
                    stickerEmptyView.title.setText(LocaleController.getString("NoContacts", C3630R.string.NoContacts));
                }
        ...
        public TLObject getObject(int i) {
            if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                ...
                return DialogObject.isUserDialog(tLRPC$Dialog.f1606id) ? MessagesController.getInstance(((BottomSheet) InviteMembersBottomSheet.this).currentAccount).getUser(Long.valueOf(tLRPC$Dialog.f1606id)) : MessagesController.getInstance(((BottomSheet) InviteMembersBottomSheet.this).currentAccount).getChat(Long.valueOf(-tLRPC$Dialog.f1606id));
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            long j;
            long j2;
            if (InviteMembersBottomSheet.this.isCryptoboxChatSelection) {
                InviteMembersBottomSheet.this.emptyView.setVisibility(8);
            }
            ...
            if (itemViewType == 2) {
                ...
                if (object2 instanceof TLRPC$User) {
                    j = ((TLRPC$User) object2).f1762id;
                } else {
                    j = object2 instanceof TLRPC$Chat ? -((TLRPC$Chat) object2).f1600id : 0L;
                }
                boolean z = true;
                groupCreateUserCell.setObject(object, null, null, i != InviteMembersBottomSheet.this.contactsEndRow);
                if (object instanceof TLRPC$User) {
                    j2 = ((TLRPC$User) object).f1762id;
                } else {
                    j2 = object instanceof TLRPC$Chat ? -((TLRPC$Chat) object).f1600id : 0L;
                }
                if (j2 != 0) {
                    if (InviteMembersBottomSheet.this.isCryptoboxChatSelection) {
                        if (InviteMembersBottomSheet.this.selectedCryptoBoxChatId == null || InviteMembersBottomSheet.this.selectedCryptoBoxChatId.longValue() != (-j2)) {
                            z = false;
                        }
                        groupCreateUserCell.setChecked(z, false);
                    } else if (InviteMembersBottomSheet.this.ignoreUsers == null || InviteMembersBottomSheet.this.ignoreUsers.indexOfKey(j2) < 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.InviteMembersBottomSheet$SearchAdapter */
    /* loaded from: classes6.dex */
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        private void filterSearchOwnedChats() {
            if (InviteMembersBottomSheet.this.isCryptoboxChatSelection) {
                ArrayList<Object> arrayList = new ArrayList<>();
                Iterator<Object> it = this.searchResult.iterator();
                while (it.hasNext()) {
                    Object next = it.next();
                    if (next instanceof TLRPC$Dialog) {
                        TLRPC$Dialog tLRPC$Dialog = (TLRPC$Dialog) next;
                        if (InviteMembersBottomSheet.this.filter.includesDialog(InviteMembersBottomSheet.this.parentFragment.getAccountInstance(), tLRPC$Dialog.f1606id, tLRPC$Dialog)) {
        ...
        public SearchAdapter() {
            ...
            searchAdapterHelper.setupFilter(InviteMembersBottomSheet.this.filter);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                groupCreateUserCell = new View(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.SearchAdapter.1
                    @Override // android.view.View
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48) + InviteMembersBottomSheet.this.additionalHeight + InviteMembersBottomSheet.this.searchAdditionalHeight, 1073741824));
                    }
                };
            } else if (i != 4) {
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r12, int r13) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.InviteMembersBottomSheet.SearchAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
        ...
        */
        public /* synthetic */ void lambda$searchDialogs$2(java.lang.String r18) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.InviteMembersBottomSheet.SearchAdapter.lambda$searchDialogs$2(java.lang.String):void");
        }
    }

    @Override // org.telegram.p042ui.Components.UsersAlertBase
    protected void onSearchViewTouched(MotionEvent motionEvent, final EditTextBoldCursor editTextBoldCursor) {
        if (motionEvent.getAction() == 0) {
            this.f1854y = this.scrollOffsetY;
        } else if (motionEvent.getAction() != 1 || Math.abs(this.scrollOffsetY - this.f1854y) >= this.touchSlop || this.enterEventSent) {
        } else {
            ...
            if (baseFragment instanceof ChatActivity) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteMembersBottomSheet.this.lambda$onSearchViewTouched$7(editTextBoldCursor);
                    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSearchViewTouched$7(final EditTextBoldCursor editTextBoldCursor) {
        setFocusable(true);
        editTextBoldCursor.requestFocus();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer */
    /* loaded from: classes6.dex */
    public class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            final int m102dp6 = m102dp2 + AndroidUtilities.m102dp(42);
            int min = InviteMembersBottomSheet.this.dialogsDelegate != null ? InviteMembersBottomSheet.this.spanEnter ? Math.min(InviteMembersBottomSheet.this.maxSize, m102dp6) : 0 : Math.max(0, Math.min(InviteMembersBottomSheet.this.maxSize, m102dp6) - AndroidUtilities.m102dp(52));
            int i6 = InviteMembersBottomSheet.this.searchAdditionalHeight;
            InviteMembersBottomSheet inviteMembersBottomSheet = InviteMembersBottomSheet.this;
            inviteMembersBottomSheet.searchAdditionalHeight = (inviteMembersBottomSheet.dialogsDelegate != null || InviteMembersBottomSheet.this.selectedContacts.size() <= 0) ? 0 : AndroidUtilities.m102dp(56);
            ...
            int min2 = Math.min(InviteMembersBottomSheet.this.maxSize, m102dp6);
            ...
            if (this.addAnimation && m102dp6 > InviteMembersBottomSheet.this.maxSize) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteMembersBottomSheet.SpansContainer.this.lambda$onMeasure$1(m102dp6);
                    }
                });
            } else if (!this.addAnimation && InviteMembersBottomSheet.this.spansScrollView.getScrollY() + InviteMembersBottomSheet.this.spansScrollView.getMeasuredHeight() > m102dp6) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteMembersBottomSheet.SpansContainer.this.lambda$onMeasure$2(m102dp6);
                    }
                });
            }
            ...
            setMeasuredDimension(size, Math.max(m102dp6, m102dp5));
        ...
        public void addSpan(GroupCreateSpan groupCreateSpan, boolean z) {
            ...
            if (z) {
                ...
                this.animators.add(ObjectAnimator.ofFloat(groupCreateSpan, View.ALPHA, BitmapDescriptorFactory.HUE_RED, 1.0f));
            }
    ...
    protected UsersAlertBase.ContainerView createContainerView(Context context) {
        return new UsersAlertBase.ContainerView(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.6
            ...
            @Override // org.telegram.p042ui.Components.UsersAlertBase.ContainerView, android.view.ViewGroup, android.view.View
            protected void dispatchDraw(Canvas canvas) {
                InviteMembersBottomSheet inviteMembersBottomSheet;
                InviteMembersBottomSheet inviteMembersBottomSheet2 = InviteMembersBottomSheet.this;
                InviteMembersBottomSheet.this.spansScrollView.setTranslationY((inviteMembersBottomSheet2.scrollOffsetY - ((BottomSheet) inviteMembersBottomSheet2).backgroundPaddingTop) + AndroidUtilities.m102dp(6) + AndroidUtilities.m102dp(64));
                ...
                if (f2 != f3) {
                    ...
                    } else if (f4 < BitmapDescriptorFactory.HUE_RED && f5 < f3) {
                        this.emptyViewOffset = f3;
                    } else {
                        invalidate();
                    }
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                if (view == InviteMembersBottomSheet.this.spansScrollView) {
                    canvas.save();
                    canvas.clipRect(BitmapDescriptorFactory.HUE_RED, view.getY() - AndroidUtilities.m102dp(4), getMeasuredWidth(), view.getY() + InviteMembersBottomSheet.this.scrollViewH + 1.0f);
    ...
    /* renamed from: org.telegram.ui.Components.InviteMembersBottomSheet$ItemAnimator */
    /* loaded from: classes6.dex */
    ...
    private void generateLink() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_messages_exportChatInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda8
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                InviteMembersBottomSheet.this.lambda$generateLink$10(tLObject, tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$generateLink$10(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                InviteMembersBottomSheet.this.lambda$generateLink$9(tLRPC$TL_error, tLObject);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$generateLink$9(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
