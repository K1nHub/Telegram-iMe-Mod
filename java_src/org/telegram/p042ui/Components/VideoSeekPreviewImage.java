...
public class VideoSeekPreviewImage extends View {
    ...
    public VideoSeekPreviewImage(Context context, VideoSeekPreviewImageDelegate videoSeekPreviewImageDelegate) {
        ...
        setVisibility(4);
        this.frameDrawable = context.getResources().getDrawable(C3630R.C3632drawable.videopreview);
    ...
    public /* synthetic */ void lambda$new$0(ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
        ...
        if (getVisibility() == 0 && layoutParams.width == m102dp && layoutParams.height == i) {
            return;
        }
    ...
    public /* synthetic */ void lambda$setProgress$2(float f, long j) {
        ...
        int max = Math.max(200, AndroidUtilities.m102dp(100));
        ...
        if (frameAtTime != null) {
            ...
            try {
                ...
                this.dstR.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, max, i);
    ...
    public /* synthetic */ void lambda$open$4(Uri uri) {
        ...
        if ("tg".equals(uri.getScheme())) {
            ...
            tLRPC$TL_document.f1608id = Utilities.parseLong(uri.getQueryParameter(TtmlNode.ATTR_ID)).longValue();
            ...
            tLRPC$TL_documentAttributeFilename.file_name = uri.getQueryParameter(AppMeasurementSdk.ConditionalUserProperty.NAME);
            ...
            if (FileLoader.getInstance(intValue).isLoadingFile(FileLoader.getAttachFileName(tLRPC$TL_document))) {
                ...
                absolutePath = new File(directory, tLRPC$TL_document.dc_id + "_" + tLRPC$TL_document.f1608id + ".temp").getAbsolutePath();
            } else {
        ...
        if (f != BitmapDescriptorFactory.HUE_RED) {
            ...
            videoSeekPreviewImage.pendingProgress = BitmapDescriptorFactory.HUE_RED;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.bitmapToDraw != null && this.bitmapShader != null) {
            ...
            canvas.drawRoundRect(this.bitmapRect, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), this.bitmapPaint);
            this.frameDrawable.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            this.frameDrawable.draw(canvas);
            canvas.drawText(this.frameTime, (getMeasuredWidth() - this.timeWidth) / 2.0f, getMeasuredHeight() - AndroidUtilities.m102dp(9), this.textPaint);
        } else if (this.isYoutube) {
            canvas.save();
            this.ytPath.rewind();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight());
            this.ytPath.addRoundRect(rectF, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), Path.Direction.CW);
            ...
            imageReceiver.setImageCoords(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, imageReceiver.getBitmapWidth(), this.youtubeBoardsReceiver.getBitmapHeight());
