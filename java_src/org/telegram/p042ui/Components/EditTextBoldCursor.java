...
import org.telegram.p042ui.ActionBar.FloatingActionMode;
...
public class EditTextBoldCursor extends EditTextEffects {
    ...
    private void init() {
        ...
        textPaint.setTextSize(AndroidUtilities.m102dp(11));
        ...
        if (i >= 29) {
            ShapeDrawable shapeDrawable = new ShapeDrawable() { // from class: org.telegram.ui.Components.EditTextBoldCursor.5
                ...
                public int getIntrinsicHeight() {
                    return AndroidUtilities.m102dp(EditTextBoldCursor.this.cursorSize + 20);
                }

                @Override // android.graphics.drawable.ShapeDrawable, android.graphics.drawable.Drawable
                public int getIntrinsicWidth() {
                    return AndroidUtilities.m103dp(EditTextBoldCursor.this.cursorWidth);
                }
            };
        ...
        if (this.cursorDrawable == null) {
            ...
            try {
                ...
                if (field != null) {
                    field.set(this, Integer.valueOf(C3630R.C3632drawable.field_carret_empty));
                }
            } catch (Throwable unused5) {
            }
        }
        this.cursorSize = AndroidUtilities.m102dp(24);
    }
    ...
    public void setLineColors(int i, int i2, int i3) {
        ...
        getContext().getResources().getDrawable(C3630R.C3632drawable.search_dark).getPadding(this.padding);
    ...
    public void setTextSize(int i, float f) {
        AnimatedTextView.AnimatedTextDrawable animatedTextDrawable = this.hintAnimatedDrawable;
        if (animatedTextDrawable != null) {
            animatedTextDrawable.setTextSize(AndroidUtilities.m103dp(f));
        }
        AnimatedTextView.AnimatedTextDrawable animatedTextDrawable2 = this.hintAnimatedDrawable2;
        if (animatedTextDrawable2 != null) {
            animatedTextDrawable2.setTextSize(AndroidUtilities.m103dp(f));
        }
    ...
    @Override // org.telegram.p042ui.Components.EditTextEffects, android.widget.EditText, android.widget.TextView
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (staticLayout != null && this.hintAnimatedDrawable == null) {
            ...
            if (this.hintLayoutYFix) {
                this.lineY = (((getExtendedPaddingTop() + getPaddingTop()) + ((((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom()) - this.hintLayout.getHeight()) / 2.0f)) + this.hintLayout.getHeight()) - AndroidUtilities.m102dp(1);
            } else {
                this.lineY = ((getMeasuredHeight() - this.hintLayout.getHeight()) / 2.0f) + this.hintLayout.getHeight() + AndroidUtilities.m102dp(6);
            }
        } else {
            this.lineY = getMeasuredHeight() - AndroidUtilities.m102dp(2);
        }
    ...
    public void setHintText(CharSequence charSequence, boolean z, TextPaint textPaint) {
        ...
        this.hintLayout = new StaticLayout(charSequence, textPaint, AndroidUtilities.m102dp(1000), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
    }
            ...
            if (animatedTextDrawable != null && !TextUtils.isEmpty(animatedTextDrawable.getText()) && (this.hintVisible || this.hintAlpha != BitmapDescriptorFactory.HUE_RED)) {
                if (this.hintAnimatedDrawable2 != null) {
                    if (this.hintAnimatedDrawable.getCurrentWidth() + this.hintAnimatedDrawable2.getCurrentWidth() < getMeasuredWidth()) {
                        ...
                        this.hintAnimatedDrawable2.draw(canvas);
                        canvas.restore();
                        this.hintAnimatedDrawable.setRightPadding((this.hintAnimatedDrawable2.getCurrentWidth() + AndroidUtilities.m102dp(2)) - this.rightHintOffset);
                    }
                } else {
                    this.hintAnimatedDrawable.setRightPadding(BitmapDescriptorFactory.HUE_RED);
                }
                ...
                if (this.hintVisible || this.hintAlpha != BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (this.supportRtlHint && LocaleController.isRTL) {
                        ...
                        canvas.translate(scrollX, (this.lineY - this.hintLayout.getHeight()) - AndroidUtilities.m102dp(7));
                    } else {
                    ...
                    if (this.transformHintToHeader) {
                        ...
                        canvas.scale(f3, f3);
                        canvas.translate(BitmapDescriptorFactory.HUE_RED, (-AndroidUtilities.m102dp(22)) * this.headerAnimationProgress);
    ...
    @Override // org.telegram.p042ui.Components.EditTextEffects, android.widget.TextView, android.view.View
    /*
    ...
    */
    public void onDraw(android.graphics.Canvas r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.EditTextBoldCursor.onDraw(android.graphics.Canvas):void");
    }
    ...
    private void updateCursorPosition(int i, int i2, float f) {
        ...
        int m103dp = AndroidUtilities.m103dp(this.cursorWidth);
        GradientDrawable gradientDrawable = this.gradientDrawable;
        Rect rect = this.mTempRect;
        gradientDrawable.setBounds(clampHorizontalPosition, i - rect.top, m103dp + clampHorizontalPosition, i2 + rect.bottom);
    }
