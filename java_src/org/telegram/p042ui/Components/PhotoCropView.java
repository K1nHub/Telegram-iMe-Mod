...
import org.telegram.p042ui.Components.Crop.CropRotationWheel;
import org.telegram.p042ui.Components.Crop.CropTransform;
import org.telegram.p042ui.Components.Crop.CropView;
...
public class PhotoCropView extends FrameLayout {
    ...
    public PhotoCropView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        cropView.setListener(new CropView.CropViewListener() { // from class: org.telegram.ui.Components.PhotoCropView.3
            @Override // org.telegram.p042ui.Components.Crop.CropView.CropViewListener
        ...
        this.cropView.setBottomPadding(AndroidUtilities.m102dp(64));
        ...
        cropRotationWheel.setListener(new CropRotationWheel.RotationWheelListener() { // from class: org.telegram.ui.Components.PhotoCropView.4
            @Override // org.telegram.p042ui.Components.Crop.CropRotationWheel.RotationWheelListener
            public void onStart() {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.thumbImageVisible && view == (cropView = this.cropView)) {
            ...
            int i = m102dp / 2;
            int videoThumbX = (this.delegate.getVideoThumbX() - i) + AndroidUtilities.m102dp(2);
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.m102dp(156);
            ...
            float width = actualRect.width() + ((m102dp - actualRect.width()) * this.thumbAnimationProgress);
            ...
            canvas.drawCircle(videoThumbX + i, measuredHeight + m102dp + AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(3), this.circlePaint);
        }
        return drawChild;
    }
    ...
    public float getRectX() {
        return this.cropView.getCropLeft() - AndroidUtilities.m102dp(14);
    }

    public float getRectY() {
        return (this.cropView.getCropTop() - AndroidUtilities.m102dp(14)) - ((Build.VERSION.SDK_INT < 21 || this.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight);
    }
