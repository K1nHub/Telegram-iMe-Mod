...
/* renamed from: org.telegram.ui.Components.VectorAvatarThumbDrawable */
    ...
    */
    private void setImage() {
        ...
        L4f:
            r6 = r3
        L50:
            int r1 = org.telegram.p042ui.ActionBar.Theme.key_windowBackgroundWhiteGrayIcon
        ...
        L8c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.VectorAvatarThumbDrawable.setImage():void");
    }
    ...
    @Override // org.telegram.p042ui.Components.AttachableDrawable
    ...
    @Override // org.telegram.p042ui.Components.AnimatedEmojiSpan.InvalidateHolder
    public void invalidate() {
            ...
            if (this.type == vectorAvatarThumbDrawable.type) {
                ...
                if (i == gradientTools2.color1 && gradientTools.color2 == gradientTools2.color2 && gradientTools.color3 == gradientTools2.color3 && gradientTools.color4 == gradientTools2.color4) {
                    ...
                    if (tLRPC$TL_videoSizeStickerMarkup2 != null && (tLRPC$TL_videoSizeStickerMarkup = vectorAvatarThumbDrawable.sizeStickerMarkup) != null) {
                        return tLRPC$TL_videoSizeStickerMarkup2.stickerset.f1623id == tLRPC$TL_videoSizeStickerMarkup.stickerset.f1623id && tLRPC$TL_videoSizeStickerMarkup2.sticker_id == tLRPC$TL_videoSizeStickerMarkup.sticker_id;
                    }
                }
            }
        }
