...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
        ...
        FrameLayout frameLayout = new FrameLayout(activity) { // from class: org.telegram.ui.Components.PipRoundVideoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (drawable != null) {
                    ...
                    Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(125), AndroidUtilities.m102dp(125));
                    ...
                    canvas.drawCircle(AndroidUtilities.m102dp(63), AndroidUtilities.m102dp(63), AndroidUtilities.m103dp(59.5f), Theme.chat_docBackPaint);
                }
            }
        };
        this.windowView = frameLayout;
        frameLayout.setWillNotDraw(false);
        this.videoWidth = AndroidUtilities.m102dp(126);
        this.videoHeight = AndroidUtilities.m102dp(126);
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            aspectRatioFrameLayout.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.telegram.ui.Components.PipRoundVideoView.3
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setOval(0, 0, AndroidUtilities.m102dp(120), AndroidUtilities.m102dp(120));
                }
            });
    ...
    */
    public void animateToBoundsMaybe() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }
