...
public class TableLayout extends View {
    ...
    static final Alignment UNDEFINED_ALIGNMENT = new Alignment() { // from class: org.telegram.ui.Components.TableLayout.1
        @Override // org.telegram.p042ui.Components.TableLayout.Alignment
        ...
        */
        public void measure(int r2, int r3, boolean r4) {
            ...
            L18:
                ...
                int r2 = r1.textHeight
                int r3 = r3 - r2
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p042ui.Components.TableLayout.this
                int r2 = org.telegram.p042ui.Components.TableLayout.access$100(r2)
                int r3 = r3 - r2
                r1.textY = r3
                goto L31
            L29:
            ...
            L4a:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p042ui.Components.TableLayout.this
                org.telegram.ui.Components.TableLayout$TableLayoutDelegate r2 = org.telegram.p042ui.Components.TableLayout.access$300(r2)
                org.telegram.tgnet.TLRPC$TL_pageTableCell r3 = r1.cell
                int r4 = r1.measuredWidth
                org.telegram.ui.Components.TableLayout r0 = org.telegram.p042ui.Components.TableLayout.this
                int r0 = org.telegram.p042ui.Components.TableLayout.access$200(r0)
                int r0 = r0 * 2
                int r4 = r4 - r0
                org.telegram.ui.ArticleViewer$DrawingText r2 = r2.createTextLayout(r3, r4)
                r1.setTextLayout(r2)
                int r2 = r1.textHeight
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p042ui.Components.TableLayout.this
                int r3 = org.telegram.p042ui.Components.TableLayout.access$100(r3)
                int r3 = r3 * 2
                int r2 = r2 + r3
                r1.fixedHeight = r2
            L71:
                ...
                int r4 = r1.textWidth
                int r3 = r3 - r4
                org.telegram.ui.Components.TableLayout r4 = org.telegram.p042ui.Components.TableLayout.this
                int r4 = org.telegram.p042ui.Components.TableLayout.access$200(r4)
                int r3 = r3 - r4
                int r2 = r2 + r3
                r1.textX = r2
                goto Lb4
            ...
            La2:
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p042ui.Components.TableLayout.this
                int r3 = org.telegram.p042ui.Components.TableLayout.access$200(r3)
                int r2 = r2 + r3
                r1.textX = r2
                goto Lb4
            Lac:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p042ui.Components.TableLayout.this
                int r2 = org.telegram.p042ui.Components.TableLayout.access$200(r2)
                r1.textX = r2
            Lb4:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.TableLayout.Child.measure(int, int, boolean):void");
        }
        ...
        public int getTextX() {
            return this.f1944x + this.textX;
        }

        public int getTextY() {
            return this.f1945y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view) {
            ...
            boolean z = false;
            boolean z2 = true;
            boolean z3 = this.f1944x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
            boolean z4 = this.f1945y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
            int m102dp = AndroidUtilities.m102dp(3);
            if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                if (this.f1944x != 0 || this.f1945y != 0) {
                ...
                if (z2) {
                    TableLayout.this.rect.set(this.f1944x, this.f1945y, i5 + this.measuredWidth, i6 + this.measuredHeight);
                    ...
                    canvas.drawRect(this.f1944x, this.f1945y, i3 + this.measuredWidth, i4 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                } else {
                    canvas.drawRect(this.f1944x, this.f1945y, i + this.measuredWidth, i2 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                }
            }
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i10 == 0) {
                    ...
                    canvas.drawLine(i10 - strokeWidth2, this.f1945y, i10 - strokeWidth2, i7 + this.measuredHeight, linePaint2);
                }
                int i13 = this.f1945y;
                if (i13 == 0) {
                    int i14 = this.f1944x;
                    ...
                    int i15 = this.f1945y;
                    canvas.drawLine(f10, i15 + strokeWidth, f11, i15 + strokeWidth, linePaint);
                } else {
                    canvas.drawLine(this.f1944x, i13 - strokeWidth2, i8 + this.measuredWidth, i13 - strokeWidth2, linePaint2);
                }
                float f12 = (z3 && (i9 = this.f1945y) == 0) ? i9 + m102dp : this.f1945y - strokeWidth;
                if (z3 && z4) {
                    f = (this.f1945y + this.measuredHeight) - m102dp;
                } else {
                    f = (this.f1945y + this.measuredHeight) - strokeWidth;
                }
                float f13 = f;
                int i16 = this.f1944x;
                int i17 = this.measuredWidth;
                canvas.drawLine((i16 + i17) - strokeWidth, f12, (i16 + i17) - strokeWidth, f13, linePaint);
                int i18 = this.f1944x;
                float f14 = (i18 == 0 && z4) ? i18 + m102dp : i18 - strokeWidth;
                if (z3 && z4) {
                    f2 = (i18 + this.measuredWidth) - m102dp;
                } else {
                ...
                canvas.drawLine(f14, (i19 + i20) - strokeWidth, f15, (i19 + i20) - strokeWidth, linePaint);
                if (this.f1944x == 0 && this.f1945y == 0) {
                    RectF rectF = TableLayout.this.rect;
                    int i21 = this.f1944x;
                    int i22 = this.f1945y;
                    float f16 = m102dp * 2;
                    rectF.set(i21 + strokeWidth, i22 + strokeWidth, i21 + strokeWidth + f16, i22 + strokeWidth + f16);
                ...
                if (z3 && this.f1945y == 0) {
                    ...
                    float f17 = m102dp * 2;
                    int i25 = this.f1945y;
                    rectF2.set(((i23 + i24) - strokeWidth) - f17, i25 + strokeWidth, (i23 + i24) - strokeWidth, i25 + strokeWidth + f17);
                ...
                if (this.f1944x == 0 && z4) {
                    ...
                    float f18 = m102dp * 2;
                    rectF3.set(i26 + strokeWidth, ((i27 + i28) - strokeWidth) - f18, i26 + strokeWidth + f18, (i27 + i28) - strokeWidth);
                    canvas.drawArc(TableLayout.this.rect, 180.0f, -90.0f, false, linePaint);
                }
                if (z3 && z4) {
                    ...
                    rectF4.set(((i29 + i30) - strokeWidth) - f19, ((i31 + i32) - strokeWidth) - f19, (i29 + i30) - strokeWidth, (i31 + i32) - strokeWidth);
                    canvas.drawArc(TableLayout.this.rect, BitmapDescriptorFactory.HUE_RED, 90.0f, false, linePaint);
                }
            }
        }
    ...
    public void addChild(int i, int i2, int i3, int i4) {
        ...
        layoutParams.rowSpec = new Spec(false, interval, alignment, (float) BitmapDescriptorFactory.HUE_RED);
        layoutParams.columnSpec = new Spec(false, new Interval(i, i + i3), alignment, (float) BitmapDescriptorFactory.HUE_RED);
    ...
    public void addChild(TLRPC$TL_pageTableCell tLRPC$TL_pageTableCell, int i, int i2, int i3) {
        ...
        Interval interval = new Interval(i2, i6 + i2);
        Alignment alignment = FILL;
        layoutParams.rowSpec = new Spec(false, interval, alignment, (float) BitmapDescriptorFactory.HUE_RED);
        layoutParams.columnSpec = new Spec(false, new Interval(i, i5 + i), alignment, 1.0f);
        child.layoutParams = layoutParams;
        child.rowspan = i2;
        this.childrens.add(child);
        if (tLRPC$TL_pageTableCell.rowspan > 1) {
            this.rowSpans.add(new Point(i2, i4 + i2));
        }
        invalidateStructure();
    }
    ...
    public TableLayout(Context context, TableLayoutDelegate tableLayoutDelegate, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper) {
        ...
        this.itemPaddingTop = AndroidUtilities.m102dp(7);
        this.itemPaddingLeft = AndroidUtilities.m102dp(8);
            ...
            if (childAt.cell != null) {
                ...
                if (childAt.fixedHeight != 0 && childAt.fixedHeight != sizeInCell2 && childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min <= 1) {
                    ...
                    while (true) {
                        ...
                        if (point.f1887x <= childAt.layoutParams.rowSpec.span.min && point.f1888y > childAt.layoutParams.rowSpec.span.min) {
                            z2 = true;
                            break;
                        }
                        i17++;
    ...
    public final class Axis {
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc m55of = Assoc.m55of(Spec.class, Bounds.class);
            int childCount = TableLayout.this.getChildCount();
            for (int i = 0; i < childCount; i++) {
                LayoutParams layoutParams = TableLayout.this.getChildAt(i).getLayoutParams();
                boolean z = this.horizontal;
                Spec spec = z ? layoutParams.columnSpec : layoutParams.rowSpec;
                m55of.put(spec, spec.getAbsoluteAlignment(z).getBounds());
            }
            return m55of.pack();
        }
        ...
        private void computeGroupBounds() {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                boolean z = this.horizontal;
                Spec spec = z ? layoutParams.columnSpec : layoutParams.rowSpec;
                this.groupBounds.getValue(i).include(TableLayout.this, childAt, spec, this, TableLayout.this.getMeasurementIncludingMargin(childAt, z) + (spec.weight == BitmapDescriptorFactory.HUE_RED ? 0 : this.deltas[i]));
            }
        }
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc m55of = Assoc.m55of(Interval.class, MutableInt.class);
            Spec[] specArr = getGroupBounds().keys;
            int length = specArr.length;
            for (int i = 0; i < length; i++) {
                m55of.put(z ? specArr[i].span : specArr[i].span.inverse(), new MutableInt());
            }
            return m55of.pack();
        }
        ...
        public int getMeasure(int i) {
            ...
            if (mode != Integer.MIN_VALUE) {
                ...
                return getMeasure(0, AacUtil.AAC_LC_MAX_RATE_BYTES_PER_SECOND);
            }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        static {
            Interval interval = new Interval(Integer.MIN_VALUE, C0479C.RATE_UNSET_INT);
        ...
        */
        public LayoutParams() {
            /*
                r1 = this;
                org.telegram.ui.Components.TableLayout$Spec r0 = org.telegram.p042ui.Components.TableLayout.Spec.UNDEFINED
                r1.<init>(r0, r0)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.TableLayout.LayoutParams.<init>():void");
        }
    ...
    public static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m55of(Class<K> cls, Class<V> cls2) {
    ...
    public static class Bounds {
        ...
        protected int size(boolean z) {
            return (z || !TableLayout.canStretch(this.flexibility)) ? this.before + this.after : AacUtil.AAC_LC_MAX_RATE_BYTES_PER_SECOND;
        }
        ...
        BASELINE = new Alignment() { // from class: org.telegram.ui.Components.TableLayout.6
            ...
            public Bounds getBounds() {
                return new Bounds(this) { // from class: org.telegram.ui.Components.TableLayout.6.1
                    ...
                    @Override // org.telegram.p042ui.Components.TableLayout.Bounds
                    protected void reset() {
                        super.reset();
