...
public class PhotoFilterBlurControl extends FrameLayout {
    private static final float BlurInsetProximity = AndroidUtilities.m102dp(20);
    private static final float BlurViewCenterInset = AndroidUtilities.m103dp(30.0f);
    private static final float BlurViewRadiusInset = AndroidUtilities.m103dp(30.0f);
    ...
    public PhotoFilterBlurControl(Context context) {
        ...
        this.arcPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.PhotoFilterBlurControl.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void handlePan(int i, MotionEvent motionEvent) {
        ...
        float f = x - actualCenterPoint.f1887x;
        float f2 = y - actualCenterPoint.f1888y;
        ...
        if (i == 1) {
            ...
            int i3 = this.type;
            if (i3 == 0) {
                int i4 = C52841.f1886xcde84254[this.activeControl.ordinal()];
                if (i4 == 1) {
                    ...
                    float f12 = rect.f1928x;
                    float max = Math.max(f12, Math.min(rect.width + f12, this.startCenterPoint.f1887x + f9));
                    float f13 = rect.f1929y;
                    Point point = new Point(max, Math.max(f13, Math.min(rect.height + f13, this.startCenterPoint.f1888y + f10)));
                    float f14 = point.f1887x - rect.f1928x;
                    Size size3 = this.actualAreaSize;
                    float f15 = size3.width;
                    this.centerPoint = new Point(f14 / f15, ((point.f1888y - rect.f1929y) + ((f15 - size3.height) / 2.0f)) / f15);
                } else if (i4 == 2) {
                    ...
                    boolean z = x > actualCenterPoint.f1887x;
                    boolean z2 = y > actualCenterPoint.f1888y;
                ...
                int i5 = C52841.f1886xcde84254[this.activeControl.ordinal()];
                if (i5 == 1) {
                    ...
                    float f21 = rect2.f1928x;
                    float max2 = Math.max(f21, Math.min(rect2.width + f21, this.startCenterPoint.f1887x + f18));
                    float f22 = rect2.f1929y;
                    Point point2 = new Point(max2, Math.max(f22, Math.min(rect2.height + f22, this.startCenterPoint.f1888y + f19)));
                    float f23 = point2.f1887x - rect2.f1928x;
                    Size size5 = this.actualAreaSize;
                    float f24 = size5.width;
                    this.centerPoint = new Point(f23 / f24, ((point2.f1888y - rect2.f1929y) + ((f24 - size5.height) / 2.0f)) / f24);
                } else if (i5 == 2) {
    ...
    public static /* synthetic */ class C52841 {
        ...
        static {
            ...
            try {
                f1886xcde84254[BlurViewActiveControl.BlurViewActiveControlInnerRadius.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1886xcde84254[BlurViewActiveControl.BlurViewActiveControlOuterRadius.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1886xcde84254[BlurViewActiveControl.BlurViewActiveControlRotation.ordinal()] = 4;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.translate(actualCenterPoint.f1887x, actualCenterPoint.f1888y);
        int i2 = this.type;
        if (i2 == 0) {
            canvas.rotate(this.angle);
            float m103dp = AndroidUtilities.m103dp(6.0f);
            float m103dp2 = AndroidUtilities.m103dp(12.0f);
            float m103dp3 = AndroidUtilities.m103dp(1.5f);
            for (int i3 = 0; i3 < 30; i3++) {
                float f = m103dp2 + m103dp;
                float f2 = i3 * f;
                float f3 = -actualInnerRadius;
                float f4 = f2 + m103dp2;
                float f5 = m103dp3 - actualInnerRadius;
                canvas.drawRect(f2, f3, f4, f5, this.paint);
                float f6 = ((-i) * f) - m103dp;
                float f7 = f6 - m103dp2;
                canvas.drawRect(f7, f3, f6, f5, this.paint);
                float f8 = m103dp3 + actualInnerRadius;
                canvas.drawRect(f2, actualInnerRadius, f4, f8, this.paint);
                canvas.drawRect(f7, actualInnerRadius, f6, f8, this.paint);
            }
            float m103dp4 = AndroidUtilities.m103dp(6.0f);
            for (int i4 = 0; i4 < 64; i4++) {
                float f9 = m103dp4 + m103dp;
                float f10 = i4 * f9;
                float f11 = -actualOuterRadius;
                float f12 = m103dp4 + f10;
                float f13 = m103dp3 - actualOuterRadius;
                canvas.drawRect(f10, f11, f12, f13, this.paint);
                float f14 = ((-i4) * f9) - m103dp;
                float f15 = f14 - m103dp4;
                canvas.drawRect(f15, f11, f14, f13, this.paint);
                float f16 = m103dp3 + actualOuterRadius;
        ...
        canvas.drawCircle(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(8), this.paint);
    }

    private Point getActualCenterPoint() {
        float f = this.actualAreaSize.width;
        float width = ((getWidth() - f) / 2.0f) + (this.centerPoint.f1887x * f);
        int i = (Build.VERSION.SDK_INT < 21 || this.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight;
        Size size = this.actualAreaSize;
        float f2 = size.height;
        float height = i + ((getHeight() - f2) / 2.0f);
        float f3 = size.width;
        return new Point(width, (height - ((f3 - f2) / 2.0f)) + (this.centerPoint.f1888y * f3));
    }
