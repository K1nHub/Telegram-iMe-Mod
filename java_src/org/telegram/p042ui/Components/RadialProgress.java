...
public class RadialProgress {
    ...
    private int diff = AndroidUtilities.m102dp(4);
    ...
    public RadialProgress(View view) {
        ...
        this.progressPaint.setStrokeWidth(AndroidUtilities.m102dp(3));
        Paint paint2 = new Paint(1);
        this.miniProgressPaint = paint2;
        paint2.setStyle(Paint.Style.STROKE);
        this.miniProgressPaint.setStrokeCap(Paint.Cap.ROUND);
        this.miniProgressPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.drawMiniProgress && this.currentDrawable != null) {
            ...
            if (canvas2 != null) {
                int i4 = i + 18 + i2;
                canvas2.drawCircle(AndroidUtilities.m102dp(i4), AndroidUtilities.m102dp(i4), AndroidUtilities.m102dp(i3 + 1) * f, Theme.checkboxSquare_eraserPaint);
            } else {
            ...
            if (drawable4 != null) {
                ...
                this.previousMiniDrawable.setBounds((int) (centerX - (AndroidUtilities.m102dp(i3) * f)), (int) (m102dp - (AndroidUtilities.m102dp(i3) * f)), (int) ((AndroidUtilities.m102dp(i3) * f) + centerX), (int) ((AndroidUtilities.m102dp(i3) * f) + m102dp));
            ...
            if (!this.hideCurrentDrawable && (drawable2 = this.currentMiniDrawable) != null) {
                ...
                this.currentMiniDrawable.setBounds((int) (centerX - AndroidUtilities.m102dp(i3)), (int) (m102dp - AndroidUtilities.m102dp(i3)), (int) (AndroidUtilities.m102dp(i3) + centerX), (int) (AndroidUtilities.m102dp(i3) + m102dp));
            ...
            if (this.currentMiniWithRound || this.previousMiniWithRound) {
                ...
                int i5 = i3 - 2;
                this.cicleRect.set(centerX - (AndroidUtilities.m102dp(i5) * f), m102dp - (AndroidUtilities.m102dp(i5) * f), centerX + (AndroidUtilities.m102dp(i5) * f), m102dp + (AndroidUtilities.m102dp(i5) * f));
