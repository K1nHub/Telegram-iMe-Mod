...
import org.telegram.p042ui.Components.Paint.Shader;
...
public class BlurringShader {
    ...
    public boolean setup(float f, boolean z, int i) {
        ...
        String readRes = RLottieDrawable.readRes(null, C3630R.raw.blur_vrt);
        String readRes2 = RLottieDrawable.readRes(null, C3630R.raw.blur_frg);
    ...
    public void draw(float[] fArr, int i, int i2, int i3) {
        ...
        GLES20.glUseProgram(program.f1814gl);
