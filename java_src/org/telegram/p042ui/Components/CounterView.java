...
public class CounterView extends View {
    ...
    public static class CounterDrawable {
        ...
        /* renamed from: cx */
        private float f1825cx;

        /* renamed from: cy */
        private float f1826cy;
        ...
        public CounterDrawable(View view, boolean z, Theme.ResourcesProvider resourcesProvider) {
            ...
            if (this.recentChatsMode) {
                this.textPaint.setTextSize(AndroidUtilities.m102dp(8));
            } else {
        ...
        private void drawInternal(Canvas canvas) {
            ...
            float m103dp = (this.lastH - AndroidUtilities.m103dp(f)) / 2.0f;
            updateX(this.countWidth);
            if (this.recentChatsMode) {
                RectF rectF = this.rectF;
                float f2 = this.f1825cx;
                rectF.set(f2, this.f1826cy, AndroidUtilities.m102dp(20) + f2, this.f1826cy + AndroidUtilities.m102dp(20));
            } else {
                RectF rectF2 = this.rectF;
                float f3 = this.f1827x;
                rectF2.set(f3, m103dp, this.countWidth + f3 + AndroidUtilities.m103dp(this.radius - 0.5f), AndroidUtilities.m103dp(f) + m103dp);
            }
            ...
            if (this.countLayout != null) {
                canvas.save();
                if (this.recentChatsMode) {
                    canvas.translate(this.f1825cx + AndroidUtilities.m102dp(4), this.f1826cy + AndroidUtilities.m103dp(4.5f));
                } else {
                    canvas.translate(this.countLeft, m103dp + AndroidUtilities.m102dp(4));
                }
        ...
        public void setCount(int i, boolean z) {
            ...
            if (!z2) {
                ...
                this.countWidth = Math.max(AndroidUtilities.m102dp(12), (int) Math.ceil(this.textPaint.measureText(stringOfCCount)));
            ...
            if (z2) {
                ...
                if (this.countLayout != null) {
                    ...
                    if (stringOfCCount3.length() == stringOfCCount2.length()) {
                        ...
                        int max = Math.max(AndroidUtilities.m102dp(12), (int) Math.ceil(this.textPaint.measureText(stringOfCCount3)));
            ...
            if (i > 0) {
                this.countWidth = Math.max(AndroidUtilities.m102dp(12), (int) Math.ceil(this.textPaint.measureText(stringOfCCount2)));
        ...
        public void draw(Canvas canvas) {
            ...
            if (f2 != 1.0f) {
                ...
                float m103dp = (this.lastH - AndroidUtilities.m103dp(this.radius * 2.0f)) / 2.0f;
                ...
                RectF rectF = this.rectF;
                float f9 = this.f1827x;
                rectF.set(f9, m103dp, f7 + f9 + AndroidUtilities.m103dp(this.radius - 0.5f), AndroidUtilities.m103dp(this.radius * 2.0f) + m103dp);
                canvas.save();
                ...
                if (this.countAnimationInLayout != null) {
                    ...
                    float m102dp = AndroidUtilities.m102dp(4) + m103dp;
                    int m102dp2 = AndroidUtilities.m102dp(13);
                    if (!z2) {
                        m102dp2 = -m102dp2;
                    }
                    canvas.translate(f15, m102dp + (m102dp2 * (1.0f - f6)));
                    ...
                    float m102dp3 = AndroidUtilities.m102dp(4) + m103dp;
                    int m102dp4 = AndroidUtilities.m102dp(13);
                    if (!z2) {
                        m102dp4 = -m102dp4;
                    }
                    canvas.translate(f16, m102dp3 + (m102dp4 * (1.0f - f6)));
                    this.textPaint.setAlpha((int) (f6 * 255.0f));
                    this.countLayout.draw(canvas);
                    canvas.restore();
                }
                if (this.countOldLayout != null) {
                    canvas.save();
                    canvas.translate(this.countLeft, AndroidUtilities.m102dp(4) + m103dp + ((z2 ? -AndroidUtilities.m102dp(13) : AndroidUtilities.m102dp(13)) * f6));
        ...
        public void updateBackgroundRect() {
            ...
            if (f != 1.0f) {
                ...
                if (i == 0 || i == 1) {
                    ...
                    float m103dp = (this.lastH - AndroidUtilities.m103dp(this.radius * 2.0f)) / 2.0f;
                    RectF rectF = this.rectF;
                    float f2 = this.f1827x;
                    rectF.set(f2, m103dp, this.countWidth + f2 + AndroidUtilities.m102dp(11), AndroidUtilities.m102dp(23) + m103dp);
                    return;
                }
                float f3 = f * 2.0f;
                if (f3 > 1.0f) {
                ...
                float m103dp2 = (this.lastH - AndroidUtilities.m103dp(this.radius * 2.0f)) / 2.0f;
                int i2 = this.countWidth;
                int i3 = this.countWidthOld;
                float f4 = i2 == i3 ? i2 : (i2 * f3) + (i3 * (1.0f - f3));
                updateX(f4);
                RectF rectF2 = this.rectF;
                float f5 = this.f1827x;
                rectF2.set(f5, m103dp2, f4 + f5 + AndroidUtilities.m102dp(11), AndroidUtilities.m102dp(23) + m103dp2);
                return;
            }
            updateX(this.countWidth);
            float m103dp3 = (this.lastH - AndroidUtilities.m103dp(this.radius * 2.0f)) / 2.0f;
            RectF rectF3 = this.rectF;
            float f6 = this.f1827x;
            rectF3.set(f6, m103dp3, this.countWidth + f6 + AndroidUtilities.m102dp(11), AndroidUtilities.m102dp(23) + m103dp3);
        }

        private void updateX(float f) {
            float m103dp = this.drawBackground ? AndroidUtilities.m103dp(5.5f) : 0.0f;
            int i = this.gravity;
            if (i == 5) {
                float f2 = this.width - m103dp;
                this.countLeft = f2;
                ...
                this.countLeft = m103dp;
            } else {
                this.countLeft = (int) ((this.width - f) / 2.0f);
            }
            this.f1827x = this.countLeft - m103dp;
        }
        ...
        public int getWidth() {
            ...
            return this.countWidth + AndroidUtilities.m103dp(this.radius - 0.5f);
        }
    }
