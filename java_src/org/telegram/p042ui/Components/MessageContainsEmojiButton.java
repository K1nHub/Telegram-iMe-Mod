...
public class MessageContainsEmojiButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public MessageContainsEmojiButton(int i, Context context, Theme.ResourcesProvider resourcesProvider, ArrayList<TLRPC$InputStickerSet> arrayList, int i2) {
        ...
        if (arrayList.size() > 1) {
            ...
            if (i2 == 0) {
                string = LocaleController.getString("MessageContainsEmojiPack", C3630R.string.MessageContainsEmojiPack);
            } else if (i2 == 3) {
                string = LocaleController.getString("MessageContainsReactionPack", C3630R.string.MessageContainsReactionPack);
            } else {
                string = LocaleController.getString("MessageContainsReactionsPack", C3630R.string.MessageContainsReactionsPack);
            }
            ...
            if (tLRPC$InputStickerSet == null || (stickerSet = MediaDataController.getInstance(i).getStickerSet(this.inputStickerSet, false)) == null || (tLRPC$StickerSet = stickerSet.set) == null) {
                ...
                while (true) {
                    ...
                    if (arrayList3 == null || i4 >= arrayList3.size()) {
                        break;
                    } else if (stickerSet.documents.get(i4).f1608id == stickerSet.set.thumb_document_id) {
            ...
            if (str != null && tLRPC$Document != null) {
                ...
                spannableString.setSpan(new AnimatedEmojiSpan(tLRPC$Document, this.textPaint.getFontMetricsInt()) { // from class: org.telegram.ui.Components.MessageContainsEmojiButton.1
                    @Override // org.telegram.p042ui.Components.AnimatedEmojiSpan, android.text.style.ReplacementSpan
        ...
        if (charSequence != this.lastMainTextText || this.lastMainTextWidth != i) {
            if (charSequence != null) {
                ...
                if (this.loadingDrawable != null && this.loadingBoundsTo == null) {
                    ...
                    this.lastLineMargin = ((int) this.mainTextLayout.getPrimaryHorizontal(this.mainText.length())) + AndroidUtilities.m102dp(2);
                    this.lastLineTop = this.mainTextLayout.getLineTop(lineCount);
                    this.lastLineHeight = r1 - this.lastLineTop;
                    float min = Math.min(AndroidUtilities.m102dp(100), this.mainTextLayout.getWidth() - this.lastLineMargin);
    ...
    protected void onMeasure(int i, int i2) {
        int i3;
        setPadding(AndroidUtilities.m102dp(13), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(13), AndroidUtilities.m102dp(8));
    ...
    */
    public void didReceivedNotification(int r8, int r9, java.lang.Object... r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.MessageContainsEmojiButton.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
