...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean z) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m102dp(20), 0, AndroidUtilities.m102dp(20), 0);
        ...
        this.doneButton.setPadding(AndroidUtilities.m102dp(20), 0, AndroidUtilities.m102dp(20), 0);
        this.doneButton.setText(LocaleController.getString("Send", C3630R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C3630R.C3632drawable.photobadge : C3630R.C3632drawable.bluecounter);
