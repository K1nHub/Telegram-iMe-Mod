...
public class EditTextEmoji extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate {
    ...
    public EditTextEmoji(Context context, SizeNotifierFrameLayout sizeNotifierFrameLayout, BaseFragment baseFragment, final int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.editText.setCursorSize(AndroidUtilities.m102dp(20));
        ...
        if (i == 0) {
            ...
            this.editText.setPadding(LocaleController.isRTL ? AndroidUtilities.m102dp(40) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(8));
            ...
            this.editText.setPadding(0, AndroidUtilities.m102dp(9), 0, AndroidUtilities.m102dp(9));
            ...
            this.editText.setBackground(null);
            this.editText.setPadding(0, AndroidUtilities.m102dp(11), 0, AndroidUtilities.m102dp(12));
        ...
        if (i == 0) {
            ...
            this.emojiIconDrawable.setIcon(C3630R.C3632drawable.smiles_tab_smiles, false);
            ...
            this.emojiIconDrawable.setIcon(C3630R.C3632drawable.input_smile, false);
        ...
        this.emojiButton.setContentDescription(LocaleController.getString("Emoji", C3630R.string.Emoji));
    }
    ...
    public void setEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.editText.setPadding(0, 0, 0, AndroidUtilities.m102dp(8));
        }
    }
    ...
    public void showPopup(int i) {
        if (i == 1) {
            ...
            if (sizeNotifierFrameLayout != null) {
                ...
                this.emojiIconDrawable.setIcon(C3630R.C3632drawable.input_keyboard, true);
                onWindowSizeChanged();
            }
        ...
        if (this.emojiButton != null) {
            if (this.currentStyle == 0) {
                this.emojiIconDrawable.setIcon(C3630R.C3632drawable.smiles_tab_smiles, true);
            } else {
                this.emojiIconDrawable.setIcon(C3630R.C3632drawable.input_smile, true);
            }
        }
    ...
    public void createEmojiView() {
        ...
        EmojiView emojiView2 = new EmojiView(this.parentFragment, this.allowAnimatedEmoji, false, false, getContext(), false, null, null, this.currentStyle != 2, this.resourcesProvider) { // from class: org.telegram.ui.Components.EditTextEmoji.6
            @Override // org.telegram.p042ui.Components.EmojiView, android.view.ViewGroup, android.view.View
            protected void dispatchDraw(Canvas canvas) {
        ...
        this.emojiView.setDelegate(new C48977());
    ...
    /* loaded from: classes6.dex */
    public class C48977 implements EmojiView.EmojiViewDelegate {
        ...
        public void onEmojiSelected(String str) {
            ...
            try {
                try {
                    ...
                    CharSequence replaceEmoji = Emoji.replaceEmoji(str, EditTextEmoji.this.editText.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
        ...
        public void onClearEmojiRecent() {
            ...
            builder.setPositiveButton(LocaleController.getString("ClearButton", C3630R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.EditTextEmoji$7$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    EditTextEmoji.C48977.this.lambda$onClearEmojiRecent$0(dialogInterface, i);
                }
            });
    ...
    public void onSizeChanged(int i, boolean z) {
        boolean z2;
        int i2;
        if (i > AndroidUtilities.m102dp(50) && ((this.keyboardVisible || (i2 = this.currentStyle) == 2 || i2 == 3) && !AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet())) {
            if (z) {
