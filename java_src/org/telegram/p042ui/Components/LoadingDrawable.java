...
public class LoadingDrawable extends Drawable {
    ...
    public void setRadiiDp(float f) {
        if (this.usePath != null) {
            this.paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m103dp(f)));
            this.strokePaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m103dp(f)));
            return;
        }
        setRadiiDp(f, f, f, f);
    }
    ...
    public void setRadiiDp(float f, float f2, float f3, float f4) {
        setRadii(AndroidUtilities.m103dp(f), AndroidUtilities.m103dp(f2), AndroidUtilities.m103dp(f3), AndroidUtilities.m103dp(f4));
    }
    ...
    */
    public void draw(android.graphics.Canvas r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.LoadingDrawable.draw(android.graphics.Canvas):void");
    }
