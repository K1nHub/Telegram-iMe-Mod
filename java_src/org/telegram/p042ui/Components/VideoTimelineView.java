...
public class VideoTimelineView extends View {
    ...
    public void setRoundFrames(boolean z) {
        ...
        if (z) {
            this.rect1 = new Rect(AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(42), AndroidUtilities.m102dp(42));
            this.rect2 = new Rect();
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m102dp(24);
        float f = measuredWidth;
        int m102dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m102dp(12);
        int m102dp2 = ((int) (this.progressRight * f)) + AndroidUtilities.m102dp(12);
        if (motionEvent.getAction() == 0) {
            getParent().requestDisallowInterceptTouchEvent(true);
            if (this.mediaMetadataRetriever == null) {
                return false;
            }
            int m102dp3 = AndroidUtilities.m102dp(24);
            if (m102dp - m102dp3 <= x && x <= m102dp + m102dp3 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m102dp);
                this.timeHintView.setTime((int) ((((float) this.videoLength) / 1000.0f) * this.progressLeft));
                this.timeHintView.setCx(m102dp + getLeft() + AndroidUtilities.m102dp(4));
                this.timeHintView.show(true);
                invalidate();
                return true;
            } else if (m102dp2 - m102dp3 <= x && x <= m102dp3 + m102dp2 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m102dp2);
                this.timeHintView.setTime((int) ((((float) this.videoLength) / 1000.0f) * this.progressRight));
                this.timeHintView.setCx((m102dp2 + getLeft()) - AndroidUtilities.m102dp(4));
                this.timeHintView.show(true);
                invalidate();
                return true;
            } else {
            ...
            if (this.pressedLeft) {
                ...
                if (i < AndroidUtilities.m102dp(16)) {
                    m102dp2 = AndroidUtilities.m102dp(16);
                } else if (i <= m102dp2) {
                    m102dp2 = i;
                }
                float m102dp4 = (m102dp2 - AndroidUtilities.m102dp(16)) / f;
                this.progressLeft = m102dp4;
                float f2 = this.progressRight;
                float f3 = this.maxProgressDiff;
                if (f2 - m102dp4 > f3) {
                    this.progressRight = m102dp4 + f3;
                } else {
                    float f4 = this.minProgressDiff;
                    if (f4 != BitmapDescriptorFactory.HUE_RED && f2 - m102dp4 < f4) {
                        float f5 = f2 - f4;
                ...
                this.timeHintView.setCx((((f * this.progressLeft) + AndroidUtilities.dpf2(12.0f)) + getLeft()) - AndroidUtilities.m102dp(4));
                this.timeHintView.setTime((int) ((((float) this.videoLength) / 1000.0f) * this.progressLeft));
                this.timeHintView.show(true);
                ...
                if (i2 >= m102dp) {
                    m102dp = i2 > AndroidUtilities.m102dp(16) + measuredWidth ? measuredWidth + AndroidUtilities.m102dp(16) : i2;
                }
                float m102dp5 = (m102dp - AndroidUtilities.m102dp(16)) / f;
                this.progressRight = m102dp5;
                float f6 = this.progressLeft;
                float f7 = this.maxProgressDiff;
                if (m102dp5 - f6 > f7) {
                    this.progressLeft = m102dp5 - f7;
                } else {
                    float f8 = this.minProgressDiff;
                    if (f8 != BitmapDescriptorFactory.HUE_RED && m102dp5 - f6 < f8) {
                        float f9 = f6 + f8;
                ...
                this.timeHintView.setCx((f * this.progressRight) + AndroidUtilities.dpf2(12.0f) + getLeft() + AndroidUtilities.m102dp(4));
                this.timeHintView.show(true);
                this.timeHintView.setTime((int) ((((float) this.videoLength) / 1000.0f) * this.progressRight));
    ...
    public void reloadFrames(int i) {
        ...
        if (i == 0) {
            if (this.isRoundFrames) {
                ...
                this.frameWidth = m102dp;
                this.frameHeight = m102dp;
                this.framesToLoad = Math.max(1, (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m102dp(16)) / (this.frameHeight / 2.0f)));
            } else {
                this.frameHeight = AndroidUtilities.m102dp(40);
                this.framesToLoad = Math.max(1, (getMeasuredWidth() - AndroidUtilities.m102dp(16)) / this.frameHeight);
                this.frameWidth = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m102dp(16)) / this.framesToLoad);
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.useClip) {
            ...
            this.path.rewind();
            int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m102dp(32)) >> 1;
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(BitmapDescriptorFactory.HUE_RED, measuredHeight, getMeasuredWidth(), getMeasuredHeight() - measuredHeight);
            this.path.addRoundRect(rectF, AndroidUtilities.m102dp(7), AndroidUtilities.m102dp(7), Path.Direction.CCW);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float measuredWidth = getMeasuredWidth() - AndroidUtilities.m102dp(24);
        int m102dp = ((int) (this.progressLeft * measuredWidth)) + AndroidUtilities.m102dp(12);
        int m102dp2 = ((int) (measuredWidth * this.progressRight)) + AndroidUtilities.m102dp(12);
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m102dp(32)) >> 1;
        ...
        if (!this.frames.isEmpty()) {
            ...
            for (int i2 = 0; i2 < this.frames.size(); i2++) {
                ...
                if (bitmap != null) {
                    ...
                    int i4 = i3 * i;
                    if (z) {
                        this.rect2.set(i4, measuredHeight, AndroidUtilities.m102dp(28) + i4, AndroidUtilities.m102dp(32) + measuredHeight);
            ...
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f, m102dp, getMeasuredHeight() - measuredHeight, this.paint2);
            canvas.drawRect(m102dp2, f, getMeasuredWidth(), getMeasuredHeight() - measuredHeight, this.paint2);
            canvas.drawLine(m102dp - AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(10) + measuredHeight, m102dp - AndroidUtilities.m102dp(4), (getMeasuredHeight() - AndroidUtilities.m102dp(10)) - measuredHeight, this.thumbPaint);
            canvas.drawLine(AndroidUtilities.m102dp(4) + m102dp2, AndroidUtilities.m102dp(10) + measuredHeight, m102dp2 + AndroidUtilities.m102dp(4), (getMeasuredHeight() - AndroidUtilities.m102dp(10)) - measuredHeight, this.thumbPaint);
            if (this.useClip) {
                canvas.restore();
            } else {
    ...
    private void drawCorners(Canvas canvas, int i, int i2, int i3, int i4) {
        int i5;
        int i6;
        if (AndroidUtilities.m102dp(6) != this.roundCornersSize) {
            this.roundCornersSize = AndroidUtilities.m102dp(6);
            this.roundCornerBitmap = Bitmap.createBitmap(AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), Bitmap.Config.ARGB_8888);
    ...
    public static class TimeHintView extends View {
        ...
        public TimeHintView(Context context) {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m102dp(5), Theme.getColor(Theme.key_chat_gifSaveHintBackground));
            updateColors();
            setTime(0);
        }
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(this.tooltipLayout.getHeight() + AndroidUtilities.m102dp(4) + this.tooltipBackgroundArrow.getIntrinsicHeight(), 1073741824));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            float f6 = this.scale;
            canvas.scale(f6, f6, this.f1954cx, getMeasuredHeight());
            canvas.translate(this.f1954cx - (this.tooltipLayout.getWidth() / 2.0f), BitmapDescriptorFactory.HUE_RED);
            this.tooltipBackground.setBounds(-AndroidUtilities.m102dp(8), 0, this.tooltipLayout.getWidth() + AndroidUtilities.m102dp(8), (int) (this.tooltipLayout.getHeight() + AndroidUtilities.dpf2(4.0f)));
        ...
        public void updateColors() {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(m102dp, Theme.getColor(i));
