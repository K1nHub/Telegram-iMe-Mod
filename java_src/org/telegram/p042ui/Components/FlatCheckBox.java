...
public class FlatCheckBox extends View {
    ...
    public FlatCheckBox(Context context) {
        ...
        this.INNER_PADDING = AndroidUtilities.m102dp(22);
        this.TRANSLETE_TEXT = AndroidUtilities.m102dp(8);
        this.f1848P = AndroidUtilities.m102dp(2);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension((str == null ? 0 : (int) this.textPaint.measureText(str)) + (this.INNER_PADDING << 1) + (this.f1848P * 2), this.HEIGHT + AndroidUtilities.m102dp(4));
        if (getMeasuredWidth() != this.lastW) {
            ...
            this.rectF.inset(this.f1848P + (this.outLinePaint.getStrokeWidth() / 2.0f), this.f1848P + (this.outLinePaint.getStrokeWidth() / 2.0f) + AndroidUtilities.m102dp(2));
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(AndroidUtilities.m102dp(12), measuredHeight - AndroidUtilities.m102dp(9));
        if (this.progress > 0.5f) {
            this.checkPaint.setColor(this.colorTextActive);
            float f4 = 1.0f - f3;
            canvas.drawLine(AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) - (AndroidUtilities.m102dp(4) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m102dp(4) * f4)), this.checkPaint);
            canvas.drawLine((int) AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) + (AndroidUtilities.m102dp(8) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m102dp(8) * f4)), this.checkPaint);
        }
        canvas.restore();
    }
