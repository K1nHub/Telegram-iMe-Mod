...
public class ForumBubbleDrawable extends Drawable {
    ...
    public ForumBubbleDrawable(int i) {
        if (mainDrawable == null) {
            mainDrawable = SvgHelper.getDrawable(C3630R.raw.topic_bubble, -1);
        }
        ...
        paint2.setStrokeWidth(AndroidUtilities.m102dp(1));
    ...
    public /* synthetic */ void lambda$moveNexColor$0(int[] iArr, ValueAnimator valueAnimator) {
        ...
        Paint paint = new Paint(1);
        LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, 100.0f, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, new int[]{ColorUtils.blendARGB(iArr[0], this.currentColors[0], floatValue), ColorUtils.blendARGB(iArr[1], this.currentColors[1], floatValue)}, (float[]) null, Shader.TileMode.CLAMP);
    ...
    public void setColor(int i) {
        ...
        Paint paint = new Paint(1);
        LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, 100.0f, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, iArr2, (float[]) null, Shader.TileMode.CLAMP);
        this.gradient = linearGradient;
        linearGradient.setLocalMatrix(this.gradientMatrix);
        paint.setShader(this.gradient);
        this.svgDrawable.setPaint(paint, 0);
