package org.telegram.p042ui.Components.Forum;
...
import org.telegram.p042ui.Components.AnimatedColor;
...
public class MessageTopicButton {
    ...
    */
    public int set(org.telegram.p042ui.Cells.ChatMessageCell r29, org.telegram.messenger.MessageObject r30, org.telegram.tgnet.TLRPC$TL_forumTopic r31, int r32) {
        /*
            Method dump skipped, instructions count: 1480
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.Forum.MessageTopicButton.set(org.telegram.ui.Cells.ChatMessageCell, org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$TL_forumTopic, int):int");
    }
    ...
    public void draw(Canvas canvas, float f, float f2, float f3) {
        ...
        if (this.topicNameLayout != null) {
            canvas.save();
            canvas.translate((AndroidUtilities.m102dp(this.isGeneralTopic ? 13 : 17) + Theme.chat_topicTextPaint.getTextSize()) - this.topicNameLeft, AndroidUtilities.m103dp(4.5f));
