...
public class TypingDotsDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int i;
        if (this.isChat) {
            m103dp = AndroidUtilities.m103dp(8.5f);
            i = getBounds().top;
        } else {
            m103dp = AndroidUtilities.m103dp(9.3f);
            i = getBounds().top;
        }
        int i2 = m103dp + i;
        Paint paint = this.currentPaint;
        ...
        float f = i2;
        canvas.drawCircle(AndroidUtilities.m102dp(3), f, this.scales[0] * AndroidUtilities.density, paint);
        canvas.drawCircle(AndroidUtilities.m102dp(9), f, this.scales[1] * AndroidUtilities.density, paint);
        canvas.drawCircle(AndroidUtilities.m102dp(15), f, this.scales[2] * AndroidUtilities.density, paint);
        checkUpdate();
    }
