...
public class ProxyDrawable extends Drawable {
    ...
    public ProxyDrawable(Context context) {
        this.emptyDrawable = context.getResources().getDrawable(C3630R.C3632drawable.msg2_proxy_off).mutate();
        this.fullDrawable = context.getResources().getDrawable(C3630R.C3632drawable.msg2_proxy_on).mutate();
        this.outerPaint.setStyle(Paint.Style.STROKE);
        this.outerPaint.setStrokeWidth(AndroidUtilities.m103dp(1.66f));
    ...
    public void draw(Canvas canvas) {
        ...
        if (!this.isEnabled) {
            ...
            int i2 = (width / 2) - m102dp;
            int i3 = (height / 2) - m102dp;
            this.cicleRect.set(i2, i3, i2 + m102dp + m102dp, i3 + m102dp + m102dp);
