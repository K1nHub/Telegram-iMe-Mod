...
public class GroupCreateSpan extends View {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x00dd, code lost:
        if (r1.equals("non_contacts") != false) goto L38;
     */
    ...
    */
    public GroupCreateSpan(android.content.Context r30, java.lang.Object r31, org.telegram.messenger.ContactsController.Contact r32, boolean r33, org.telegram.p042ui.ActionBar.Theme.ResourcesProvider r34) {
        /*
            Method dump skipped, instructions count: 860
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.GroupCreateSpan.<init>(android.content.Context, java.lang.Object, org.telegram.messenger.ContactsController$Contact, boolean, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m102dp((this.small ? 20 : 32) + 25) + this.textWidth, AndroidUtilities.m102dp(this.small ? 28 : 32));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m102dp(this.small ? 28 : 32));
        ...
        canvas.drawRoundRect(this.rect, AndroidUtilities.m102dp(this.small ? 14 : 16), AndroidUtilities.m102dp(this.small ? 14 : 16), backPaint);
        ...
        if (this.progress != BitmapDescriptorFactory.HUE_RED) {
            ...
            canvas.drawCircle(AndroidUtilities.m102dp(this.small ? 14 : 16), AndroidUtilities.m102dp(this.small ? 14 : 16), AndroidUtilities.m102dp(this.small ? 14 : 16), backPaint);
            canvas.save();
            canvas.rotate((1.0f - this.progress) * 45.0f, AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16));
            this.deleteDrawable.setBounds(AndroidUtilities.m102dp(this.small ? 9 : 11), AndroidUtilities.m102dp(this.small ? 9 : 11), AndroidUtilities.m102dp(this.small ? 19 : 21), AndroidUtilities.m102dp(this.small ? 19 : 21));
            this.deleteDrawable.setAlpha((int) (this.progress * 255.0f));
            this.deleteDrawable.draw(canvas);
            canvas.restore();
        }
        canvas.translate(this.textX + AndroidUtilities.m102dp((this.small ? 26 : 32) + 9), AndroidUtilities.m102dp(this.small ? 6 : 8));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString("Delete", C3630R.string.Delete)));
    }
}
