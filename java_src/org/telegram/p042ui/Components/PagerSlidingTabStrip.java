...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.scrollOffset = AndroidUtilities.m102dp(52);
        this.indicatorHeight = AndroidUtilities.m102dp(8);
        this.underlineHeight = AndroidUtilities.m102dp(2);
        this.dividerPadding = AndroidUtilities.m102dp(12);
        this.tabPadding = AndroidUtilities.m102dp(24);
        this.lastScrollX = 0;
    ...
    private void addIconTab(final int i, Drawable drawable, CharSequence charSequence) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            RippleDrawable rippleDrawable = (RippleDrawable) Theme.createSelectorDrawable(getThemedColor(Theme.key_chat_emojiBottomPanelIcon), 1, AndroidUtilities.m102dp(18));
    ...
    private void addTab(final int i, CharSequence charSequence) {
        ...
        textTab.setPadding(AndroidUtilities.m102dp(18), 0, AndroidUtilities.m102dp(18), 0);
        this.tabsContainer.addView(textTab, LayoutHelper.createLinear(-2, -2, 10, 0, 10, 0));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.underlineHeight != 0) {
            ...
            rectF.set(BitmapDescriptorFactory.HUE_RED, height - this.underlineHeight, this.tabsContainer.getWidth(), height);
        ...
        if (childAt != null) {
            ...
            if (this.indicatorHeight != 0) {
                ...
                rectF2.set(f - AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(6), f2 + AndroidUtilities.m102dp(12), height - AndroidUtilities.m102dp(6));
