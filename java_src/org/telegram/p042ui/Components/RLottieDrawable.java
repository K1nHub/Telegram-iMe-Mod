...
public class RLottieDrawable extends BitmapDrawable implements Animatable, BitmapsCache.Cacheable {
            ...
            if (rLottieDrawable2.cacheGenerateTask == null) {
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.RLottieDrawable$3$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        RLottieDrawable.RunnableC54003.this.lambda$run$0();
                    }
                };
    ...
    public RLottieDrawable(File file, int i, int i2, BitmapsCache.CacheOptions cacheOptions, boolean z, int[] iArr, int i3) {
        ...
        this.uiRunnableGenerateCache = new RunnableC54003();
        ...
        this.loadFrameRunnable = new Runnable() { // from class: org.telegram.ui.Components.RLottieDrawable.5
            ...
            */
            public void run() {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.RLottieDrawable.RunnableC54025.run():void");
            }
        };
        ...
        if (this.precache) {
            ...
            if (this.nativePtr == 0) {
                FileLog.m100d("RLottieDrawable nativePtr == 0 " + file.getAbsolutePath() + " remove file");
                file.delete();
            }
    ...
    private void parseLottieMetadata(File file, String str, int[] iArr) {
        ...
        try {
            ...
            iArr[0] = (int) (lottieMetadata.f1923op - lottieMetadata.f1922ip);
            iArr[1] = (int) lottieMetadata.f1921fr;
        } catch (Exception e) {
    ...
    public RLottieDrawable(String str, int i, int i2) {
        ...
        this.isDice = 1;
        if ("🎲".equals(str)) {
            readRes = readRes(null, C3630R.raw.diceloop);
            this.diceSwitchFramesCount = 60;
        } else {
            readRes = "🎯".equals(str) ? readRes(null, C3630R.raw.dartloop) : null;
        }
        getPaint().setFlags(2);
    ...
    public void drawInternal(Canvas canvas, Paint paint, boolean z, long j, int i) {
        ...
        if (!z) {
            ...
            if (this.applyTransformation) {
                ...
                if (Math.abs(rectF.width() - this.width) >= AndroidUtilities.m102dp(1) || Math.abs(rectF.height() - this.height) >= AndroidUtilities.m102dp(1)) {
                    z2 = true;
                }
                this.needScale = z2;
            }
