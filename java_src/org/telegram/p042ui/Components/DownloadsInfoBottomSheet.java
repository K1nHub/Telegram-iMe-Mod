...
public class DownloadsInfoBottomSheet extends BottomSheet {
    ...
    public DownloadsInfoBottomSheet(Context context, final BaseFragment baseFragment, boolean z) {
        ...
        imageView.setImageResource(C3630R.C3632drawable.ic_layer_close);
        ...
        textView.setText(LocaleController.getString("DownloadedFiles", C3630R.string.DownloadedFiles));
        ...
        textView2.setText(LocaleController.formatString("DownloadedFilesMessage", C3630R.string.DownloadedFilesMessage, new Object[0]));
        ...
        textView3.setText(LocaleController.getString("ManageDeviceStorage", C3630R.string.ManageDeviceStorage));
        textView3.setTextColor(Theme.getColor(Theme.key_featuredStickers_buttonText));
        int m102dp2 = AndroidUtilities.m102dp(8);
        int i3 = Theme.key_featuredStickers_addButton;
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(m102dp2, Theme.getColor(i3), ColorUtils.setAlphaComponent(Theme.getColor(i), 120)));
        ...
        textView4.setText(LocaleController.getString("ClearDownloadsList", C3630R.string.ClearDownloadsList));
        textView4.setTextColor(Theme.getColor(i3));
        textView4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), 0, ColorUtils.setAlphaComponent(Theme.getColor(i3), 120)));
