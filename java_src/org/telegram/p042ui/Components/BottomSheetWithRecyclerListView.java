...
public abstract class BottomSheetWithRecyclerListView extends BottomSheet {
    ...
    public BottomSheetWithRecyclerListView(BaseFragment baseFragment, boolean z, final boolean z2, boolean z3, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.headerShadowDrawable = ContextCompat.getDrawable(parentActivity, C3630R.C3632drawable.header_shadow).mutate();
        if (z3) {
            NestedSizeNotifierLayout nestedSizeNotifierLayout = new NestedSizeNotifierLayout(parentActivity) { // from class: org.telegram.ui.Components.BottomSheetWithRecyclerListView.1
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // org.telegram.p042ui.Components.NestedSizeNotifierLayout, android.widget.FrameLayout, android.view.View
        ...
        if (z2) {
                    ...
                    if (i == -1000) {
                        return new RecyclerListView.Holder(new View(parentActivity) { // from class: org.telegram.ui.Components.BottomSheetWithRecyclerListView.3.1
                            ...
                            protected void onMeasure(int i2, int i3) {
                                ...
                                if (i5 == 0) {
                                    i4 = AndroidUtilities.m102dp(300);
                                } else {
            ...
            C3702ActionBar c3702ActionBar = new C3702ActionBar(parentActivity) { // from class: org.telegram.ui.Components.BottomSheetWithRecyclerListView.4
                @Override // android.view.View
            ...
            this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.BottomSheetWithRecyclerListView.5
    ...
    public void postDrawInternal(Canvas canvas, View view) {
        ...
        if (z) {
            ...
            if (f != 1.0f) {
                ...
                c3702ActionBar = this.actionBar;
                if (c3702ActionBar != null && c3702ActionBar.getVisibility() == 0 && this.actionBar.getAlpha() != BitmapDescriptorFactory.HUE_RED && this.shadowAlpha != BitmapDescriptorFactory.HUE_RED) {
    ...
    public void preDrawInternal(Canvas canvas, View view) {
        ...
        int i = -AndroidUtilities.m102dp(16);
        if (findViewHolderForAdapterPosition != null) {
            i = findViewHolderForAdapterPosition.itemView.getBottom() - AndroidUtilities.m102dp(16);
        }
        float m102dp = 1.0f - ((AndroidUtilities.m102dp(16) + i) / AndroidUtilities.m102dp(56));
        if (m102dp < BitmapDescriptorFactory.HUE_RED) {
            m102dp = 0.0f;
        }
        AndroidUtilities.updateViewVisibilityAnimated(this.actionBar, m102dp != BitmapDescriptorFactory.HUE_RED, 1.0f, this.wasDrawn);
        this.shadowDrawable.setBounds(0, i, view.getMeasuredWidth(), view.getMeasuredHeight());
        this.shadowDrawable.draw(canvas);
        onPreDraw(canvas, i, m102dp);
    }
    ...
    public void updateTitle() {
        C3702ActionBar c3702ActionBar = this.actionBar;
        if (c3702ActionBar != null) {
            c3702ActionBar.setTitle(getTitle());
        }
    }
