...
public class UpdateAppAlertDialog extends BottomSheet {
    ...
    public void updateUI() {
        ...
        layoutParams.topMargin = AndroidUtilities.m102dp(this.appUpdate.sticker != null ? 16 : 0);
        this.textView.setLayoutParams(layoutParams);
        TLRPC$TL_help_appUpdate tLRPC$TL_help_appUpdate2 = this.appUpdate;
        int i = tLRPC$TL_help_appUpdate2.document.date;
        if (i != 0) {
            this.messageTextView.setText(LocaleController.formatString("AppUpdateVersionAndSize", C3630R.string.AppUpdateVersionAndSize, tLRPC$TL_help_appUpdate2.version, LocaleController.formatSeenDate(i)));
        } else {
    ...
    public UpdateAppAlertDialog(Context context, TLRPC$TL_help_appUpdate tLRPC$TL_help_appUpdate, int i, FrameLayout frameLayout) {
        ...
        NestedScrollView nestedScrollView = new NestedScrollView(context) { // from class: org.telegram.ui.Components.UpdateAppAlertDialog.2
            ...
            public void onMeasure(int i2, int i3) {
                ...
                int i4 = (size / 5) * 2;
                if (measuredHeight - (size - i4) < AndroidUtilities.m102dp(90) || measuredHeight < (size / 2) + AndroidUtilities.m102dp(90)) {
        ...
        textView.setText(LocaleController.getString("AppUpdate", C3630R.string.AppUpdate));
        ...
        layoutParams.bottomMargin = AndroidUtilities.m102dp((int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
        View view = new View(context);
        this.shadow = view;
        ...
        bottomSheetCell.setText(LocaleController.formatString("AppUpdateDownloadNow", C3630R.string.AppUpdateDownloadNow, new Object[0]), false);
        ...
        bottomSheetCell2.setText(LocaleController.getString("AppUpdateRemindMeLater", C3630R.string.AppUpdateRemindMeLater), false);
    ...
    public void updateLayout() {
        ...
        int max = Math.max(this.location[1] - AndroidUtilities.m102dp(24), 0);
        if (this.location[1] + this.linearLayout.getMeasuredHeight() <= (this.container.getMeasuredHeight() - AndroidUtilities.m102dp(113)) + this.containerView.getTranslationY()) {
