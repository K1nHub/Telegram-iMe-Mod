...
import org.telegram.p042ui.Components.EmojiTabsStrip;
import org.telegram.p042ui.Components.EmojiView;
import org.telegram.p042ui.Components.Premium.PremiumLockIconView;
...
public class EmojiTabsStrip extends ScrollableHorizontalScrollView {
    ...
    private static int[] emojiTabsDrawableIds = {C3630R.C3632drawable.msg_emoji_smiles, C3630R.C3632drawable.msg_emoji_cat, C3630R.C3632drawable.msg_emoji_food, C3630R.C3632drawable.msg_emoji_activities, C3630R.C3632drawable.msg_emoji_travel, C3630R.C3632drawable.msg_emoji_objects, C3630R.C3632drawable.msg_emoji_other, C3630R.C3632drawable.msg_emoji_flags};
    private static int[] emojiTabsAnimatedDrawableIds = {C3630R.raw.msg_emoji_smiles, C3630R.raw.msg_emoji_cat, C3630R.raw.msg_emoji_food, C3630R.raw.msg_emoji_activities, C3630R.raw.msg_emoji_travel, C3630R.raw.msg_emoji_objects, C3630R.raw.msg_emoji_other, C3630R.raw.msg_emoji_flags};
    ...
    public EmojiTabsStrip(Context context, Theme.ResourcesProvider resourcesProvider, boolean z, boolean z2, final boolean z3, int i, Runnable runnable) {
        super(context);
        this.recentDrawableId = C3630R.C3632drawable.msg_emoji_recent;
        this.settingsDrawableId = C3630R.C3632drawable.smiles_tab_settings;
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.Components.EmojiTabsStrip.1
            ...
            /* renamed from: to */
            private RectF f1836to = new RectF();
            ...
            protected void onLayout(boolean z4, int i2, int i3, int i4, int i5) {
                int i6 = (i5 - i3) / 2;
                if (z3) {
                    int paddingLeft = getPaddingLeft() - (!EmojiTabsStrip.this.recentIsShown ? AndroidUtilities.m102dp(33) : 0);
                    for (int i7 = 0; i7 < getChildCount(); i7++) {
                        ...
                        if (childAt != EmojiTabsStrip.this.settingsTab && !EmojiTabsStrip.this.removingViews.containsKey(childAt) && childAt != null) {
                            ...
                            Long m59id = z5 ? ((EmojiTabButton) childAt).m59id() : childAt instanceof EmojiTabsView ? Long.valueOf(((EmojiTabsView) childAt).f1838id) : null;
                            ...
                            if (m59id != null) {
                                Integer num = this.lastX.get(m59id.longValue());
                                if (num != null && num.intValue() != paddingLeft && Math.abs(num.intValue() - paddingLeft) < AndroidUtilities.m102dp(45)) {
                                ...
                                this.lastX.put(m59id.longValue(), Integer.valueOf(paddingLeft));
                            }
                            paddingLeft += childAt.getMeasuredWidth() + AndroidUtilities.m102dp(3);
                        }
                    }
                    if (EmojiTabsStrip.this.settingsTab != null) {
                        int m102dp = paddingLeft + (EmojiTabsStrip.this.recentIsShown ? 0 : AndroidUtilities.m102dp(33));
                        Long l = EmojiTabsStrip.this.settingsTab.f1837id;
                        if (EmojiTabsStrip.this.settingsTab.getMeasuredWidth() + m102dp + getPaddingRight() <= EmojiTabsStrip.this.getMeasuredWidth()) {
                            ...
                            EmojiTabsStrip.this.settingsTab.layout(m102dp, i6 - (EmojiTabsStrip.this.settingsTab.getMeasuredHeight() / 2), EmojiTabsStrip.this.settingsTab.getMeasuredWidth() + m102dp, i6 + (EmojiTabsStrip.this.settingsTab.getMeasuredHeight() / 2));
                        }
                        if (l != null) {
                            if (this.lastX.get(l.longValue()) != null && this.lastX.get(l.longValue()).intValue() != m102dp) {
                                EmojiTabsStrip.this.settingsTab.setTranslationX(this.lastX.get(l.longValue()).intValue() - m102dp);
                                EmojiTabsStrip.this.settingsTab.animate().translationX(BitmapDescriptorFactory.HUE_RED).setDuration(350L).start();
                            }
                            this.lastX.put(l.longValue(), Integer.valueOf(m102dp));
                            return;
                        }
                        return;
                    }
                ...
                int paddingLeft2 = (int) (((((i4 - i2) - getPaddingLeft()) - getPaddingRight()) - (AndroidUtilities.m102dp(30) * childCount)) / Math.max(1, childCount - 1));
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                int paddingLeft = (getPaddingLeft() + getPaddingRight()) - ((int) (EmojiTabsStrip.this.recentIsShown ? BitmapDescriptorFactory.HUE_RED : EmojiTabsStrip.this.recentTab.getAlpha() * AndroidUtilities.m102dp(33)));
                for (int i4 = 0; i4 < getChildCount(); i4++) {
                    View childAt = getChildAt(i4);
                    if (childAt != null) {
                        childAt.measure(makeMeasureSpec, i3);
                        paddingLeft += childAt.getMeasuredWidth() + (i4 + 1 < getChildCount() ? AndroidUtilities.m102dp(3) : 0);
                    }
                }
                if (!z3) {
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                getChildBounds((int) Math.ceil(EmojiTabsStrip.this.selectT), this.f1836to);
                AndroidUtilities.lerp(this.from, this.f1836to, EmojiTabsStrip.this.selectT - floor, this.rect);
                ...
                float m103dp = AndroidUtilities.m103dp(AndroidUtilities.lerp(8.0f, 16.0f, f));
                ...
                this.path.rewind();
                this.path.addRoundRect(this.rect, m103dp, m103dp, Path.Direction.CW);
                ...
                if (EmojiTabsStrip.this.emojiTabs != null) {
                    this.path.addCircle(EmojiTabsStrip.this.emojiTabs.getLeft() + AndroidUtilities.m102dp(15), (EmojiTabsStrip.this.emojiTabs.getTop() + EmojiTabsStrip.this.emojiTabs.getBottom()) / 2.0f, AndroidUtilities.m102dp(15), Path.Direction.CW);
                }
        ...
        if (i == 4) {
            ...
            EmojiTabButton emojiTabButton = new EmojiTabButton(context, C3630R.C3632drawable.msg_emoji_stickers, false, false);
            this.toggleEmojiStickersTab = emojiTabButton;
            linearLayout2.addView(emojiTabButton);
        }
        if (i == 3) {
            this.recentDrawableId = C3630R.C3632drawable.msg_emoji_smiles;
        }
        if (z) {
            ...
            this.recentTab.f1837id = Long.valueOf(-934918565);
        }
        if (z3) {
            if (z2) {
                ...
                this.emojiTabs.f1838id = 3552126;
            }
            ...
            if (runnable != null) {
                ...
                this.settingsTab.f1837id = Long.valueOf(1434631203);
    ...
    private TLRPC$Document getThumbDocument(TLRPC$StickerSet tLRPC$StickerSet, ArrayList<TLRPC$Document> arrayList) {
        ...
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (tLRPC$Document.f1608id == tLRPC$StickerSet.thumb_document_id) {
    ...
    private static class StabDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            this.rectF.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(30));
    ...
    public void updateEmojiPacks(ArrayList<EmojiView.EmojiPack> arrayList) {
        ...
        if (this.includeAnimated) {
            if (!this.first || MediaDataController.getInstance(UserConfig.selectedAccount).areStickersLoaded(5)) {
                ...
                int i = 0;
                while (i < Math.max(arrayList.size(), childCount)) {
                    EmojiTabButton emojiTabButton = i < childCount ? (EmojiTabButton) this.contentView.getChildAt(this.packsIndexStart + i) : bool2;
                    EmojiView.EmojiPack emojiPack2 = i < arrayList.size() ? arrayList.get(i) : bool2;
                    if (emojiPack2 == null) {
                        if (emojiTabButton != null) {
                ...
                for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                    ((EmojiTabButton) arrayList2.get(i2)).keepAttached = false;
                    ((EmojiTabButton) arrayList2.get(i2)).updateAttachState();
                }
                updateClickListeners();
            }
        }
    ...
    protected void onMeasure(int i, int i2) {
        this.contentView.setPadding(AndroidUtilities.m103dp(this.paddingLeftDp), 0, AndroidUtilities.m102dp(11), 0);
    ...
    public void select(int i, boolean z) {
        ...
        if (this.wasIndex != i) {
            ...
            if (emojiTabsView3 != null && this.selected == 1 && i >= 1 && i <= emojiTabsView3.contentView.getChildCount() + 1) {
                int i8 = ((i - 1) * 36) - 6;
                this.emojiTabs.scrollToVisible(AndroidUtilities.m102dp(i8), AndroidUtilities.m102dp(i8 + 30));
            }
            this.wasIndex = i;
        }
    }
    ...
    public class EmojiTabButton extends ViewGroup {
        ...
        public Long m59id() {
            ...
            if (tLRPC$Document != null) {
                return Long.valueOf(tLRPC$Document.f1608id);
            }
            return null;
        }
        ...
        public EmojiTabButton(Context context, int i, int i2, boolean z, boolean z2) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m102dp(24), AndroidUtilities.m102dp(24), false, null);
                this.lottieDrawable = rLottieDrawable;
                rLottieDrawable.setBounds(AndroidUtilities.m102dp(3), AndroidUtilities.m102dp(3), AndroidUtilities.m102dp(27), AndroidUtilities.m102dp(27));
        ...
        public void setAnimatedEmojiDocument(TLRPC$Document tLRPC$Document) {
            ...
            if (tLRPC$Document2 == null || tLRPC$Document == null || tLRPC$Document2.f1608id != tLRPC$Document.f1608id) {
        ...
        public void setLock(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                this.lockView.setImageResource(C3630R.C3632drawable.msg_mini_lockedemoji);
                return;
            }
            Drawable mutate = getResources().getDrawable(C3630R.C3632drawable.msg_mini_addemoji).mutate();
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(30));
            ImageView imageView = this.imageView;
            if (imageView != null) {
                imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(24), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(24), 1073741824));
            }
            PremiumLockIconView premiumLockIconView = this.lockView;
            if (premiumLockIconView != null) {
                premiumLockIconView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(12), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(12), 1073741824));
            }
        }
    ...
    public class EmojiTabsView extends ScrollableHorizontalScrollView {
        ...
        public EmojiTabsView(Context context) {
            ...
            LinearLayout linearLayout = new LinearLayout(context, EmojiTabsStrip.this) { // from class: org.telegram.ui.Components.EmojiTabsStrip.EmojiTabsView.1
                ...
                protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                    ...
                    for (int i6 = 0; i6 < getChildCount(); i6++) {
                        ...
                        if (childAt != EmojiTabsStrip.this.settingsTab && childAt != null) {
                            ...
                            paddingLeft += childAt.getMeasuredWidth() + AndroidUtilities.m102dp(2);
                        }
                    }
                }
                ...
                @Override // android.widget.LinearLayout, android.view.View
                protected void onMeasure(int i, int i2) {
                    super.onMeasure(Math.max(View.MeasureSpec.getSize(i), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(EmojiTabsView.this.contentView.getChildCount() * 32), 1073741824)), i2);
                }
            };
            this.contentView = linearLayout;
        ...
        @Override // android.widget.HorizontalScrollView, android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.lerp(AndroidUtilities.m102dp(30), maxWidth(), this.showT), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(30), 1073741824));
        }

        public int maxWidth() {
            return AndroidUtilities.m103dp(Math.min(5.7f, this.contentView.getChildCount()) * 32.0f);
        }
        ...
        @Override // org.telegram.p042ui.Components.ScrollableHorizontalScrollView, android.widget.HorizontalScrollView, android.view.View
        public boolean onTouchEvent(MotionEvent motionEvent) {
