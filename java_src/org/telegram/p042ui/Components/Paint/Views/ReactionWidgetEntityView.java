...
public class ReactionWidgetEntityView extends EntityView {
    ...
    @Override // org.telegram.p042ui.Components.Paint.Views.EntityView, android.view.ViewGroup, android.view.View
    ...
    public int getPadding() {
        return (int) ((this.baseSize.height - AndroidUtilities.m102dp(84)) / 2.0f);
    }

    @Override // org.telegram.p042ui.Components.Paint.Views.EntityView
    protected org.telegram.p042ui.Components.Rect getSelectionBounds() {
        ViewGroup viewGroup = (ViewGroup) getParent();
        if (viewGroup == null) {
            return new org.telegram.p042ui.Components.Rect();
        }
        float scaleX = viewGroup.getScaleX();
        float measuredWidth = getMeasuredWidth() * (getScale() + 0.4f);
        float f = measuredWidth / 2.0f;
        float f2 = measuredWidth * scaleX;
        return new org.telegram.p042ui.Components.Rect((getPositionX() - f) * scaleX, (getPositionY() - f) * scaleX, f2, f2);
    }
