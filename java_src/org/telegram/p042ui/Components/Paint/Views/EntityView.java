...
import org.telegram.p042ui.Components.Rect;
...
public class EntityView extends FrameLayout {
    ...
    public boolean onTouchMove(float f, float f2, boolean z, float f3, float f4) {
        ...
        if (((float) Math.hypot(f7, f8)) > (this.hasPanned ? 6.0f : 16.0f) || z) {
            ...
            if (entityViewDelegate5 != null) {
                entityViewDelegate5.onEntityDraggedTop(this.position.f1888y - ((((float) getHeight()) / 2.0f) * scaleX) < ((float) AndroidUtilities.m102dp(66)));
                this.delegate.onEntityDraggedBottom(this.position.f1888y + ((((float) getHeight()) / 2.0f) * scaleX) > ((float) (((View) getParent()).getHeight() - AndroidUtilities.m102dp(114))));
            }
            updateTrash(!z && MathUtils.distance(f5, f6, ((float) ((View) getParent()).getWidth()) / 2.0f, (float) (((View) getParent()).getHeight() - AndroidUtilities.m102dp(76))) < ((float) AndroidUtilities.m102dp(32)));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        this.delegate.getTransformedTouch(motionEvent.getRawX(), motionEvent.getRawY(), this.f1870xy);
        ...
        if (z2) {
            ...
            float[] fArr5 = this.f1870xy;
            fArr4[0] = fArr5[0];
            fArr4[1] = fArr5[1];
        }
        if (this.lastIsMultitouch != z2) {
            float[] fArr6 = this.f1870xy;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x012e, code lost:
        if (java.lang.Math.abs((r9.position.f1888y + (((height() / 2.0f) - getStickyPaddingBottom()) * getScaleY())) - (r10.getMeasuredHeight() - org.telegram.messenger.AndroidUtilities.m103dp(64.0f))) <= org.telegram.messenger.AndroidUtilities.m103dp(12.0f)) goto L21;
     */
    ...
    */
    public void pan(float r10, float r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.Paint.Views.EntityView.pan(float, float):void");
    }
    ...
    public float getPositionX() {
        float measuredWidth;
        float f = this.position.f1887x;
        if (getParent() != null) {
            View view = (View) getParent();
            int i = this.stickyX;
            if (i == 1) {
                measuredWidth = AndroidUtilities.m103dp(8.0f) + (((width() / 2.0f) - getStickyPaddingLeft()) * getScaleX());
            } else if (i == 2) {
                measuredWidth = view.getMeasuredWidth() / 2.0f;
            } else {
                measuredWidth = i == 3 ? (view.getMeasuredWidth() - AndroidUtilities.m103dp(8.0f)) - (((width() / 2.0f) + getStickyPaddingRight()) * getScaleX()) : f;
            }
            ValueAnimator valueAnimator = this.stickyXAnimator;
            if (valueAnimator != null) {
                return AndroidUtilities.lerp(f, measuredWidth, ((Float) valueAnimator.getAnimatedValue()).floatValue());
            }
            return measuredWidth != BitmapDescriptorFactory.HUE_RED ? measuredWidth : f;
        }
        return f;
    }
    ...
    public float getPositionY() {
        ...
        float f = this.position.f1888y;
        if (getParent() != null) {
            View view = (View) getParent();
            int i = this.stickyY;
            if (i == 1) {
                measuredHeight = AndroidUtilities.m103dp(64.0f) + (((height() / 2.0f) - getStickyPaddingTop()) * getScaleY());
            } else if (i == 2) {
                measuredHeight = view.getMeasuredHeight() / 2.0f;
            } else {
                measuredHeight = i == 3 ? (view.getMeasuredHeight() - AndroidUtilities.m103dp(64.0f)) - (((height() / 2.0f) + getStickyPaddingBottom()) * getScaleY()) : f;
            }
            ValueAnimator valueAnimator = this.stickyYAnimator;
            if (valueAnimator != null) {
                return AndroidUtilities.lerp(f, measuredHeight, ((Float) valueAnimator.getAnimatedValue()).floatValue());
            }
            return measuredHeight != BitmapDescriptorFactory.HUE_RED ? measuredHeight : f;
        }
        return f;
    }
    ...
    public class SelectionView extends FrameLayout {
        ...
        public SelectionView(Context context) {
            ...
            this.paint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10)}, 0.5f));
        ...
        protected void updatePosition() {
            ...
            layoutParams.leftMargin = (int) selectionBounds.f1928x;
            layoutParams.topMargin = (int) selectionBounds.f1929y;
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r18) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.Paint.Views.EntityView.SelectionView.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (getParent() instanceof View) {
            ...
            float height = (view.getHeight() - AndroidUtilities.m102dp(76)) - getY();
