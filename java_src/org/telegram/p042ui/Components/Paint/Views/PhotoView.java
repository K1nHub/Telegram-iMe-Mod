...
public class PhotoView extends EntityView {
    ...
    public PhotoView(Context context, Point point, float f, float f2, Size size, String str, int i, int i2) {
        ...
        imageReceiver.setRoundRadius(AndroidUtilities.m102dp(12));
    ...
    public class PhotoViewSelectionView extends EntityView.SelectionView {
        ...
        protected int pointInsideHandle(float f, float f2) {
            ...
            float f4 = (measuredHeight / 2.0f) + m103dp2;
            if (f <= m103dp2 - m103dp || f2 <= f4 - m103dp || f >= m103dp2 + m103dp || f2 >= f4 + m103dp) {
                float f5 = m103dp2 + measuredWidth;
                if (f <= f5 - m103dp || f2 <= f4 - m103dp || f >= f5 + m103dp || f2 >= f4 + m103dp) {
                    return (f <= m103dp2 || f >= measuredWidth || f2 <= m103dp2 || f2 >= measuredHeight) ? 0 : 3;
                }
                return 2;
            }
            return 1;
