...
public class PaintTextOptionsView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PaintTextOptionsView(Context context) {
        ...
        rLottieImageView.setAnimation(C3630R.raw.photo_text_allign, 24, 24);
        ...
        this.alignView.setPadding(AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2));
        addView(this.alignView, LayoutHelper.createFrame(28, 28, 16, 0, 0, 16, 0));
        ImageView imageView = new ImageView(context);
        this.outlineView = imageView;
        imageView.setImageResource(C3630R.C3632drawable.msg_text_outlined);
        this.outlineView.setPadding(AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1));
        ...
        imageView2.setImageResource(C3630R.C3632drawable.msg_add);
        ...
        this.plusView.setPadding(AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2));
    ...
    private void layoutChild(View view) {
        if (view.getVisibility() != 8) {
            ...
            int i = this.f1873x + layoutParams.leftMargin;
            this.f1873x = i;
            view.layout(i, (getMeasuredHeight() - layoutParams.height) / 2, this.f1873x + layoutParams.width, (getMeasuredHeight() + layoutParams.height) / 2);
            this.f1873x += layoutParams.width + layoutParams.rightMargin;
        }
    }
    ...
    public void getTypefaceCellBounds(RectF rectF) {
        rectF.set(this.typefaceCell.getLeft() + AndroidUtilities.m102dp(8), this.typefaceCell.getTop(), this.typefaceCell.getRight() + AndroidUtilities.m102dp(8), this.typefaceCell.getBottom());
    }

    public void animatePlusToIcon(int i) {
        if (i == 0) {
            i = C3630R.C3632drawable.msg_add;
        }
        if (this.plusIcon != i) {
    ...
    public void setOutlineType(int i, boolean z) {
        ...
        this.outlineType = i;
        if (i == 1) {
            i2 = C3630R.C3632drawable.msg_photo_text_framed2;
        } else if (i == 2) {
            i2 = C3630R.C3632drawable.msg_photo_text_framed3;
        } else if (i != 3) {
            i2 = C3630R.C3632drawable.msg_photo_text_framed;
        } else {
            i2 = C3630R.C3632drawable.msg_photo_text_regular;
        }
        if (z) {
    ...
    public static final class TypefaceCell extends TextView {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.restore();
            if (this.isCurrent) {
                int height = (getHeight() - AndroidUtilities.m102dp(16)) / 2;
                if (LocaleController.isRTL) {
                    this.expandDrawable.setBounds(AndroidUtilities.m102dp(7), height, AndroidUtilities.m102dp(23), AndroidUtilities.m102dp(16) + height);
                } else {
                    this.expandDrawable.setBounds(getWidth() - AndroidUtilities.m102dp(23), height, getWidth() - AndroidUtilities.m102dp(7), AndroidUtilities.m102dp(16) + height);
                }
        ...
        public void setCurrent(boolean z) {
            this.isCurrent = z;
            if (z) {
                setPadding(AndroidUtilities.m102dp(LocaleController.isRTL ? 27 : 12), AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(LocaleController.isRTL ? 12 : 27), AndroidUtilities.m102dp(6));
                setBackground(Theme.AdaptiveRipple.rect(1090519039, AndroidUtilities.m102dp(32)));
            } else {
                setPadding(AndroidUtilities.m102dp(24), AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(24), AndroidUtilities.m102dp(14));
                setBackground(Theme.AdaptiveRipple.rect(-14145495));
            }
            if (this.isCurrent && this.expandDrawable == null) {
                Drawable drawable = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.photo_expand);
