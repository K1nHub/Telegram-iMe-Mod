        ...
        while (true) {
            ...
            if (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeSticker) {
                ...
                if (tLRPC$TL_maskCoords != null) {
                    this.anchor = tLRPC$TL_maskCoords.f1682n;
                }
            } else {
                i++;
            }
    ...
    public class StickerViewSelectionView extends EntityView.SelectionView {
        ...
        protected int pointInsideHandle(float f, float f2) {
            ...
            if (f <= m103dp2 - m103dp || f2 <= measuredHeight - m103dp || f >= m103dp2 + m103dp || f2 >= measuredHeight + m103dp) {
                if (f <= ((getMeasuredWidth() - f3) + m103dp2) - m103dp || f2 <= measuredHeight - m103dp || f >= m103dp2 + (getMeasuredWidth() - f3) + m103dp || f2 >= measuredHeight + m103dp) {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float m103dp = AndroidUtilities.m103dp(1.0f) + dpf2 + AndroidUtilities.m102dp(15);
            float measuredWidth = (getMeasuredWidth() / 2) - m103dp;
            float f = m103dp + (2.0f * measuredWidth);
            this.arcRect.set(m103dp, m103dp, f, f);
            ...
            float f2 = measuredWidth + m103dp;
            canvas.drawCircle(m103dp, f2, dpf2, this.dotStrokePaint);
            canvas.drawCircle(m103dp, f2, dpf2 - AndroidUtilities.m102dp(1), this.dotPaint);
            canvas.drawCircle(f, f2, dpf2, this.dotStrokePaint);
            canvas.drawCircle(f, f2, dpf2 - AndroidUtilities.m102dp(1), this.dotPaint);
