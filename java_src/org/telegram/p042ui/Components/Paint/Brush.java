...
public abstract class Brush {
    ...
    public int getStampResId() {
        return C3630R.C3632drawable.paint_radial_brush;
    }
    ...
    public static class Radial extends Brush {
        @Override // org.telegram.p042ui.Components.Paint.Brush
        public int getDefaultColor() {
            return -47814;
        }
    ...
    public static class Elliptical extends Brush {
        ...
        @Override // org.telegram.p042ui.Components.Paint.Brush
        public int getStampResId() {
            return C3630R.C3632drawable.paint_elliptical_brush;
        }

        @Override // org.telegram.p042ui.Components.Paint.Brush
        public int getIconRes() {
            return C3630R.raw.photo_marker;
        }
    }
    ...
    public static class Neon extends Brush {
        ...
        @Override // org.telegram.p042ui.Components.Paint.Brush
        public int getStampResId() {
            return C3630R.C3632drawable.paint_neon_brush;
        }

        @Override // org.telegram.p042ui.Components.Paint.Brush
        public int getIconRes() {
            return C3630R.raw.photo_neon;
        }
    }
    ...
    public static class Eraser extends Brush {
        ...
        @Override // org.telegram.p042ui.Components.Paint.Brush
        public int getIconRes() {
            return C3630R.raw.photo_eraser;
        }
    }
    ...
    public static abstract class Shape extends Brush {
        ...
        public static class Circle extends Shape {
            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public int getShapeShaderType() {
                return 0;
            }
            ...
            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public String getShapeName() {
                return LocaleController.getString(C3630R.string.PaintCircle);
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush
            public int getIconRes() {
                return C3630R.C3632drawable.photo_circle;
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public int getFilledIconRes() {
                return C3630R.C3632drawable.photo_circle_fill;
            }
        }
        ...
        public static class Rectangle extends Shape {
            ...
            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public String getShapeName() {
                return LocaleController.getString(C3630R.string.PaintRectangle);
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush
            public int getIconRes() {
                return C3630R.C3632drawable.photo_rectangle;
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public int getFilledIconRes() {
                return C3630R.C3632drawable.photo_rectangle_fill;
            }
        }
        ...
        public static class Star extends Shape {
            ...
            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public String getShapeName() {
                return LocaleController.getString(C3630R.string.PaintStar);
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush
            public int getIconRes() {
                return C3630R.C3632drawable.photo_star;
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public int getFilledIconRes() {
                return C3630R.C3632drawable.photo_star_fill;
            }
        }
        ...
        public static class Bubble extends Shape {
            ...
            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public String getShapeName() {
                return LocaleController.getString(C3630R.string.PaintBubble);
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush
            public int getIconRes() {
                return C3630R.C3632drawable.msg_msgbubble;
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public int getFilledIconRes() {
                return C3630R.C3632drawable.msg_msgbubble2;
            }
        }
        ...
        public static class Arrow extends Shape {
            ...
            @Override // org.telegram.p042ui.Components.Paint.Brush.Shape
            public String getShapeName() {
                return LocaleController.getString(C3630R.string.PaintArrow);
            }

            @Override // org.telegram.p042ui.Components.Paint.Brush
            public int getIconRes() {
                return C3630R.C3632drawable.photo_arrowshape;
            }
