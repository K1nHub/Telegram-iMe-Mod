...
public class ShaderSet {
    ...
    private static Map<String, Map<String, Object>> createMap() {
        ...
        hashMap13.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        ...
        hashMap15.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "clear", TtmlNode.ATTR_TTS_COLOR, SessionDescription.ATTR_TYPE, TtmlNode.ATTR_TTS_COLOR, "resolution", TtmlNode.CENTER, "radius", "thickness", "rounding", "fill", "rotation", "middle", "arrowTriangleLength", "composite"});
