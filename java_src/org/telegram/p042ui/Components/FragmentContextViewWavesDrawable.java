...
public class FragmentContextViewWavesDrawable {
    ...
    */
    public void draw(float r21, float r22, float r23, float r24, android.graphics.Canvas r25, org.telegram.p042ui.Components.FragmentContextView r26, float r27) {
        /*
            Method dump skipped, instructions count: 605
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.FragmentContextViewWavesDrawable.draw(float, float, float, float, android.graphics.Canvas, org.telegram.ui.Components.FragmentContextView, float):void");
    }
