...
public class FiltersListBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FiltersListBottomSheet(BaseFragment baseFragment, ArrayList<Long> arrayList, int i) {
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) { // from class: org.telegram.ui.Components.FiltersListBottomSheet.1
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                int m102dp = AndroidUtilities.m102dp(48) + (AndroidUtilities.m102dp(48) * FiltersListBottomSheet.this.adapter.getItemCount()) + ((BottomSheet) FiltersListBottomSheet.this).backgroundPaddingTop + AndroidUtilities.statusBarHeight;
                int i4 = size / 5;
                int i5 = ((double) m102dp) < ((double) i4) * 3.2d ? 0 : i4 * 2;
                if (i5 != 0 && m102dp < size) {
                    i5 -= size - m102dp;
                }
                if (i5 == 0) {
                ...
                if (FiltersListBottomSheet.this.listView.getPaddingTop() != i5) {
                    FiltersListBottomSheet.this.ignoreLayout = true;
                    FiltersListBottomSheet.this.listView.setPadding(AndroidUtilities.m102dp(10), i5, AndroidUtilities.m102dp(10), 0);
                    FiltersListBottomSheet.this.ignoreLayout = false;
                }
                this.fullHeight = m102dp >= size;
                super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(Math.min(m102dp, size), 1073741824));
            }
            ...
            */
            protected void onDraw(android.graphics.Canvas r13) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.FiltersListBottomSheet.C50181.onDraw(android.graphics.Canvas):void");
            }
        ...
        layoutParams.topMargin = AndroidUtilities.m102dp(48);
        ...
        this.titleTextView.setPadding(AndroidUtilities.m102dp(18), 0, AndroidUtilities.m102dp(18), 0);
        this.titleTextView.setGravity(16);
        this.titleTextView.setText(LocaleController.getString("FilterChoose", C3630R.string.FilterChoose));
    ...
    public static ArrayList<MessagesController.DialogFilter> getCanAddDialogFilters(BaseFragment baseFragment, ArrayList<Long> arrayList, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (dialogFilter.f1537id != i && !getDialogsCount(baseFragment, dialogFilter, arrayList, true, true).isEmpty() && !dialogFilter.isDefault()) {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            Drawable drawable = this.context.getResources().getDrawable(C3630R.C3632drawable.poll_add_circle);
            Drawable drawable2 = this.context.getResources().getDrawable(C3630R.C3632drawable.poll_add_plus);
            ...
            bottomSheetCell.setTextAndIcon(LocaleController.getString("CreateNewFilter", C3630R.string.CreateNewFilter), combinedDrawable);
        }
    }
}
