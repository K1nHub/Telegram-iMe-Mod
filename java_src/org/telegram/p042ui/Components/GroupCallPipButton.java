...
public class GroupCallPipButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public GroupCallPipButton(Context context, int i, boolean z) {
        ...
        this.blobDrawable.maxRadius = AndroidUtilities.m102dp(37);
        this.blobDrawable.minRadius = AndroidUtilities.m102dp(32);
        this.blobDrawable2.maxRadius = AndroidUtilities.m102dp(37);
        this.blobDrawable2.minRadius = AndroidUtilities.m102dp(32);
        this.blobDrawable.generateBlob();
        this.blobDrawable2.generateBlob();
        int i3 = C3630R.raw.voice_outlined;
        this.bigMicDrawable = new RLottieDrawable(i3, "" + i3, AndroidUtilities.m102dp(22), AndroidUtilities.m102dp(30), true, null);
        ...
        this.prepareToRemoveShader = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(350), (float) BitmapDescriptorFactory.HUE_RED, new int[]{-2801343, -561538, 0}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.4f, 1.0f}, Shader.TileMode.CLAMP);
        if (z) {
            setState(0);
        }
    }
    ...
    public static class WeavingState {
        ...
        public void update(long j, float f) {
            ...
            int m102dp = AndroidUtilities.m102dp((int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
    ...
    */
    protected void onDraw(android.graphics.Canvas r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.GroupCallPipButton.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setState(int i) {
        ...
        if (weavingState == null || weavingState.currentState != i) {
            ...
            if (sharedInstance != null && ChatObject.isChannelOrGiga(sharedInstance.getChat())) {
                string = LocaleController.getString("VoipChannelVoiceChat", C3630R.string.VoipChannelVoiceChat);
            } else {
                string = LocaleController.getString("VoipGroupVoiceChat", C3630R.string.VoipGroupVoiceChat);
            }
            if (i == 0) {
                string = string + ", " + LocaleController.getString("VoipTapToMute", C3630R.string.VoipTapToMute);
            } else if (i == 2) {
                string = string + ", " + LocaleController.getString("Connecting", C3630R.string.Connecting);
            } else if (i == 3) {
                string = string + ", " + LocaleController.getString("VoipMutedByAdmin", C3630R.string.VoipMutedByAdmin);
            }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (GroupCallPip.getInstance().showAlert) {
            i = C3630R.string.AccDescrCloseMenu;
            str = "AccDescrCloseMenu";
        } else {
            i = C3630R.string.AccDescrOpenMenu2;
