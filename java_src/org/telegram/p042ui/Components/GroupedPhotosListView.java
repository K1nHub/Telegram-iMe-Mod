...
public class GroupedPhotosListView extends View implements GestureDetector.OnGestureListener {
    ...
    public GroupedPhotosListView(Context context, int i) {
        ...
        this.itemWidth = AndroidUtilities.m102dp(42);
        this.itemHeight = AndroidUtilities.m102dp(56);
        this.itemSpacing = AndroidUtilities.m102dp(1);
        this.itemY = i;
    ...
    */
    public void fillList() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.GroupedPhotosListView.fillList():void");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.hasPhotos || !this.imagesToDraw.isEmpty()) {
            ...
            if (imageLocation != null && (tLRPC$PhotoSize2 = imageLocation.photoSize) != null) {
                i = Math.max(this.itemWidth, (int) (tLRPC$PhotoSize2.f1632w * (this.itemHeight / tLRPC$PhotoSize2.f1631h)));
            } else {
                i = this.itemHeight;
            }
            ...
            if (i13 >= 0 && i13 < this.currentPhotos.size()) {
                ...
                if (imageLocation2 != null && (tLRPC$PhotoSize = imageLocation2.photoSize) != null) {
                    i3 = Math.max(this.itemWidth, (int) (tLRPC$PhotoSize.f1632w * (this.itemHeight / tLRPC$PhotoSize.f1631h)));
                } else {
                    i3 = this.itemHeight;
                }
            } else {
            ...
            while (i17 < size) {
                ...
                imageReceiver.setRoundRadius(AndroidUtilities.m102dp(i7));
