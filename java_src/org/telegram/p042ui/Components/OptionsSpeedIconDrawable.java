...
public class OptionsSpeedIconDrawable extends Drawable {
    ...
    public void setSpeed(Float f, boolean z) {
        ...
        if (this.textDrawable == null) {
            ...
            this.textDrawable.setTextSize(AndroidUtilities.m102dp(7));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.textDrawable != null) {
            canvas.save();
            int m103dp = centerX - AndroidUtilities.m103dp(11.6f);
            int m102dp = centerY + AndroidUtilities.m102dp(4);
            ...
            canvas.save();
            this.textDrawable.setBounds(m103dp, m102dp, m103dp, m102dp);
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m102dp(45);
    }
