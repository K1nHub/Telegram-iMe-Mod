...
public class CheckBoxBase {
    ...
    public CheckBoxBase(View view, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.checkPaint.setStrokeWidth(AndroidUtilities.m103dp(1.9f));
        Paint paint4 = new Paint(1);
        this.backgroundPaint = paint4;
        paint4.setStyle(Paint.Style.STROKE);
        this.backgroundPaint.setStrokeWidth(AndroidUtilities.m103dp(1.2f));
    }
    ...
    public void setBackgroundType(int i) {
        ...
        if (i == 12 || i == 13) {
            this.backgroundPaint.setStrokeWidth(AndroidUtilities.m102dp(1));
        } else if (i == 4 || i == 5) {
            this.backgroundPaint.setStrokeWidth(AndroidUtilities.m103dp(1.9f));
            if (i == 5) {
                this.checkPaint.setStrokeWidth(AndroidUtilities.m103dp(1.5f));
            }
        } else if (i == 3) {
            this.backgroundPaint.setStrokeWidth(AndroidUtilities.m103dp(3.0f));
        } else if (i != 0) {
            this.backgroundPaint.setStrokeWidth(AndroidUtilities.m103dp(1.5f));
        }
    }
    ...
    */
    public void draw(android.graphics.Canvas r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.CheckBoxBase.draw(android.graphics.Canvas):void");
    }
