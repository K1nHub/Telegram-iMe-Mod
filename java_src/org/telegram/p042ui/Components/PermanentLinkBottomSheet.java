...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, final BaseFragment baseFragment, final TLRPC$ChatFull tLRPC$ChatFull, long j, boolean z2) {
        ...
        int i2 = C3630R.raw.shared_link_enter;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m102dp(90), AndroidUtilities.m102dp(90), false, null);
        ...
        textView.setText(LocaleController.getString("InviteLink", C3630R.string.InviteLink));
        ...
        if (z2) {
            i = C3630R.string.LinkInfoChannel;
            str = "LinkInfoChannel";
        } else {
            i = C3630R.string.LinkInfo;
            str = "LinkInfo";
        }
        ...
        textView3.setText(LocaleController.getString("ManageInviteLinks", C3630R.string.ManageInviteLinks));
        ...
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), 0, ColorUtils.setAlphaComponent(Theme.getColor(i3), 120)));
    ...
    public /* synthetic */ void lambda$new$2(TLRPC$ChatFull tLRPC$ChatFull, BaseFragment baseFragment, View view) {
        ManageLinksActivity manageLinksActivity = new ManageLinksActivity(tLRPC$ChatFull.f1601id, 0L, 0);
    ...
    public void updateColors() {
        ...
        int m102dp = AndroidUtilities.m102dp(90);
        int i = Theme.key_featuredStickers_addButton;
        rLottieImageView.setBackground(Theme.createCircleDrawable(m102dp, Theme.getColor(i)));
        this.manage.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), 120)));
