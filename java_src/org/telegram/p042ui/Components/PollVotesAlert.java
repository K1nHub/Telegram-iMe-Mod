...
import org.telegram.p042ui.Components.PollVotesAlert;
...
public class PollVotesAlert extends BottomSheet {
    ...
    public class SectionCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(32), 1073741824);
            ...
            measureChildWithMargins(this.textView, i, this.middleTextView.getMeasuredWidth() + this.righTextView.getMeasuredWidth() + AndroidUtilities.m102dp(32), makeMeasureSpec, 0);
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m102dp(32));
        }
        ...
        public void setText(String str, int i, int i2, int i3, boolean z) {
            ...
            textView.setText(Emoji.replaceEmoji(str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(14), false));
            ...
            if (i3 == 0) {
                ...
                this.righTextView.setText(LocaleController.getString("PollExpand", C3630R.string.PollExpand), z);
            } else {
                this.righTextView.setText(LocaleController.getString("PollCollapse", C3630R.string.PollCollapse), z);
            }
        }
    }
    ...
    public class UserCell extends FrameLayout {
        ...
        public UserCell(Context context) {
            ...
            backupImageView.setRoundRadius(AndroidUtilities.m102dp(18));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48) + (this.needDivider ? 1 : 0), 1073741824));
        }
        ...
        */
        public void update(int r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.PollVotesAlert.UserCell.update(int):void");
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (z || this.placeholderAlpha != BitmapDescriptorFactory.HUE_RED) {
                ...
                if (this.placeholderNum % 2 == 0) {
                    m102dp = AndroidUtilities.m102dp(65);
                    m102dp2 = AndroidUtilities.m102dp(48);
                } else {
                    m102dp = AndroidUtilities.m102dp(65);
                    m102dp2 = AndroidUtilities.m102dp(60);
                }
                if (LocaleController.isRTL) {
                    m102dp = (getMeasuredWidth() - m102dp) - m102dp2;
                }
                PollVotesAlert.this.rect.set(m102dp, top - AndroidUtilities.m102dp(4), m102dp + m102dp2, AndroidUtilities.m102dp(4) + top);
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), PollVotesAlert.this.placeholderPaint);
                if (this.placeholderNum % 2 == 0) {
                    m102dp3 = AndroidUtilities.m102dp(119);
                    m102dp4 = AndroidUtilities.m102dp(60);
                } else {
                    m102dp3 = AndroidUtilities.m102dp(131);
                    m102dp4 = AndroidUtilities.m102dp(80);
                }
                if (LocaleController.isRTL) {
                    m102dp3 = (getMeasuredWidth() - m102dp3) - m102dp4;
                }
                PollVotesAlert.this.rect.set(m102dp3, top - AndroidUtilities.m102dp(4), m102dp3 + m102dp4, top + AndroidUtilities.m102dp(4));
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), PollVotesAlert.this.placeholderPaint);
            }
            if (this.needDivider) {
                if (!LocaleController.isRTL) {
                    f = AndroidUtilities.m102dp(64);
                }
                canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m102dp(64) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
    }
    ...
    public PollVotesAlert(final ChatActivity chatActivity, MessageObject messageObject) {
        ...
        while (i4 < size) {
            ...
            if (tLRPC$TL_pollAnswerVoters.voters == 0) {
                ...
                tLRPC$TL_messages_getPollVotes.f1704id = this.messageObject.getId();
        ...
        updatePlaceholder();
        Drawable mutate = parentActivity.getResources().getDrawable(C3630R.C3632drawable.sheet_shadow_round).mutate();
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) { // from class: org.telegram.ui.Components.PollVotesAlert.3
            ...
            protected void onMeasure(int i10, int i11) {
                ...
                ((FrameLayout.LayoutParams) PollVotesAlert.this.listView.getLayoutParams()).topMargin = C3702ActionBar.getCurrentActionBarHeight();
                ((FrameLayout.LayoutParams) PollVotesAlert.this.actionBarShadow.getLayoutParams()).topMargin = C3702ActionBar.getCurrentActionBarHeight();
                int m102dp = ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + AndroidUtilities.m102dp(15) + AndroidUtilities.statusBarHeight;
                ...
                for (int i12 = 0; i12 < sectionCount; i12++) {
                    if (i12 == 0) {
                        ...
                        m102dp += PollVotesAlert.this.titleTextView.getMeasuredHeight();
                    } else {
                        m102dp += AndroidUtilities.m102dp(32) + (AndroidUtilities.m102dp(50) * (PollVotesAlert.this.listAdapter.getCountForSection(i12) - 1));
                    }
                }
                int m102dp2 = (m102dp < paddingTop ? paddingTop - m102dp : paddingTop - ((paddingTop / 5) * 3)) + AndroidUtilities.m102dp(8);
                if (PollVotesAlert.this.listView.getPaddingTop() != m102dp2) {
                    this.ignoreLayout = true;
                    PollVotesAlert.this.listView.setPinnedSectionOffsetY(-m102dp2);
                    PollVotesAlert.this.listView.setPadding(0, m102dp2, 0, 0);
                    this.ignoreLayout = false;
                }
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0 && PollVotesAlert.this.scrollOffsetY != 0 && motionEvent.getY() < PollVotesAlert.this.scrollOffsetY + AndroidUtilities.m102dp(12) && PollVotesAlert.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i10 = (PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - m102dp;
                if (((BottomSheet) PollVotesAlert.this).currentSheetAnimationType == 1) {
                    i10 = (int) (i10 + PollVotesAlert.this.listView.getTranslationY());
                }
                int m102dp2 = AndroidUtilities.m102dp(20) + i10;
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m102dp(15) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop;
                if (((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10 < C3702ActionBar.getCurrentActionBarHeight()) {
                    float m102dp3 = m102dp + AndroidUtilities.m102dp(4);
                    float min = Math.min(1.0f, ((C3702ActionBar.getCurrentActionBarHeight() - i10) - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) / m102dp3);
                    int currentActionBarHeight = (int) ((C3702ActionBar.getCurrentActionBarHeight() - m102dp3) * min);
                    i10 -= currentActionBarHeight;
                    m102dp2 -= currentActionBarHeight;
                ...
                if (f != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10, getMeasuredWidth() - ((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10 + AndroidUtilities.m102dp(24));
                ...
                if (f != BitmapDescriptorFactory.HUE_RED) {
                    int m102dp4 = AndroidUtilities.m102dp(36);
                    this.rect.set((getMeasuredWidth() - m102dp4) / 2, m102dp2, (getMeasuredWidth() + m102dp4) / 2, m102dp2 + AndroidUtilities.m102dp(4));
        ...
        this.listView.setLayoutManager(new LinearLayoutManager(this, getContext(), 1, false) { // from class: org.telegram.ui.Components.PollVotesAlert.5
            ...
            protected int getExtraLayoutSpace(RecyclerView.State state) {
                return AndroidUtilities.m102dp((int) WearableStatusCodes.TARGET_NODE_NOT_CONNECTED);
            }
        });
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.PollVotesAlert.6
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i11) {
                if (i11 == 0) {
                    if (((PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - AndroidUtilities.m102dp(13)) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop >= C3702ActionBar.getCurrentActionBarHeight() || !PollVotesAlert.this.listView.canScrollVertically(1)) {
                        return;
                    }
                    ...
                    if (holder == null || holder.itemView.getTop() <= AndroidUtilities.m102dp(7)) {
                        return;
                    }
                    PollVotesAlert.this.listView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m102dp(7));
                }
            }
        });
        ...
        this.titleTextView.setPadding(AndroidUtilities.m102dp(21), AndroidUtilities.m102dp(5), AndroidUtilities.m102dp(14), AndroidUtilities.m102dp(21));
        ...
        textView3.setText(Emoji.replaceEmoji(this.poll.question, textView3.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(18), false));
        C3702ActionBar c3702ActionBar = new C3702ActionBar(parentActivity) { // from class: org.telegram.ui.Components.PollVotesAlert.7
            @Override // android.view.View
        ...
        c3702ActionBar.setBackgroundColor(Theme.getColor(i9));
        ...
        this.actionBar.setTitle(LocaleController.getString("PollResults", C3630R.string.PollResults));
        if (this.poll.quiz) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.PollVotesAlert.8
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            if (view instanceof TextCell) {
                ...
                if (userCell.currentUser != null) {
                    bundle.putLong("user_id", userCell.currentUser.f1762id);
                } else {
                    bundle.putLong("chat_id", userCell.currentChat.f1600id);
                }
                dismiss();
                ProfileActivity profileActivity = new ProfileActivity(bundle);
                if (userCell.currentUser != null) {
                    TLRPC$User currentUser = chatActivity.getCurrentUser();
                    if (currentUser != null && currentUser.f1762id == userCell.currentUser.f1762id) {
                        i2 = 1;
                    }
                    profileActivity.setPlayProfileAnimation(i2);
                } else {
                    TLRPC$Chat currentChat = chatActivity.getCurrentChat();
                    if (currentChat != null && currentChat.f1600id == userCell.currentChat.f1600id) {
                        i2 = 1;
                    }
                    profileActivity.setPlayProfileAnimation(i2);
                }
    ...
    public void updateLayout(boolean z) {
        ...
        boolean z2 = top <= AndroidUtilities.m102dp(12);
        if ((z2 && this.actionBar.getTag() == null) || (!z2 && this.actionBar.getTag() != null)) {
            ...
            fArr[0] = z2 ? 1.0f : 0.0f;
            animatorArr[0] = ObjectAnimator.ofFloat(c3702ActionBar, property, fArr);
        ...
        int m102dp2 = top + (layoutParams.topMargin - AndroidUtilities.m102dp(11));
        if (this.scrollOffsetY != m102dp2) {
            RecyclerListView recyclerListView2 = this.listView;
            this.scrollOffsetY = m102dp2;
            recyclerListView2.setTopGlowOffset(m102dp2 - layoutParams.topMargin);
            this.containerView.invalidate();
        }
    }
    ...
    public void updatePlaceholder() {
        ...
        float m102dp = AndroidUtilities.m102dp(500);
        this.gradientWidth = m102dp;
        LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, m102dp, (float) BitmapDescriptorFactory.HUE_RED, new int[]{color2, averageColor, color2}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.18f, 0.36f}, Shader.TileMode.REPEAT);
    ...
    public class Adapter extends RecyclerListView.SectionsAdapter {
        ...
        private SectionCell createSectionCell() {
            return new SectionCell(this.mContext) { // from class: org.telegram.ui.Components.PollVotesAlert.Adapter.1
                ...
                @Override // org.telegram.p042ui.Components.PollVotesAlert.SectionCell
                protected void onCollapseClick() {
                    VotesList votesList = (VotesList) getTag(C3630R.C3633id.object_tag);
            ...
            if (i == 0) {
                ...
                while (true) {
                    ...
                    if (Arrays.equals(tLRPC$TL_pollAnswer.option, votesList.option) && ((Button) PollVotesAlert.this.votesPercents.get(votesList)) != null) {
                        ...
                        sectionCell.setTag(C3630R.C3633id.object_tag, votesList);
                        break;
                    }
                    i2++;
                }
        ...
        public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
            ...
            if (itemViewType != 2) {
                ...
                VotesList votesList = (VotesList) PollVotesAlert.this.voters.get(i - 1);
                ((TextCell) viewHolder.itemView).setTextAndIcon(LocaleController.formatPluralString("ShowVotes", votesList.count - votesList.getCount(), new Object[0]), C3630R.C3632drawable.arrow_more, false);
                return;
            }
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (Arrays.equals(tLRPC$TL_pollAnswer.option, votesList2.option) && ((Button) PollVotesAlert.this.votesPercents.get(votesList2)) != null) {
                    ...
                    sectionCell.setTag(C3630R.C3633id.object_tag, votesList2);
                    return;
                }
            }
        }
    ...
    public void animateSectionUpdates(View view) {
        ...
        while (i < this.listView.getChildCount()) {
            ...
            if (pinnedHeader instanceof SectionCell) {
                int i2 = C3630R.C3633id.object_tag;
