...
import org.telegram.p042ui.Cells.AudioPlayerCell;
...
public class AudioPlayerAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public AudioPlayerAlert(final Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.2
            ...
            protected void onMeasure(int i, int i2) {
                ...
                ((FrameLayout.LayoutParams) AudioPlayerAlert.this.listView.getLayoutParams()).topMargin = C3702ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
                ((FrameLayout.LayoutParams) AudioPlayerAlert.this.actionBarShadow.getLayoutParams()).topMargin = C3702ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
                ((FrameLayout.LayoutParams) AudioPlayerAlert.this.blurredView.getLayoutParams()).topMargin = -getPaddingTop();
                int m102dp2 = AndroidUtilities.m102dp(179);
                if (AudioPlayerAlert.this.playlist.size() > 1) {
                    m102dp2 += ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + (AudioPlayerAlert.this.playlist.size() * AndroidUtilities.m102dp(56));
                }
                if (AudioPlayerAlert.this.searching || ((BottomSheet) AudioPlayerAlert.this).keyboardVisible) {
                    m102dp = AndroidUtilities.m102dp(8);
                } else {
                    if (m102dp2 >= paddingTop) {
                        m102dp2 = (int) ((paddingTop / 5) * 3.5f);
                    }
                    m102dp = (paddingTop - m102dp2) + AndroidUtilities.m102dp(8);
                    if (m102dp > paddingTop - AndroidUtilities.m102dp(329)) {
                        m102dp = paddingTop - AndroidUtilities.m102dp(329);
                    }
                    if (m102dp < 0) {
                        m102dp = 0;
                    }
                }
                if (AudioPlayerAlert.this.listView.getPaddingTop() != m102dp) {
                    AudioPlayerAlert.this.listView.setPadding(0, m102dp, 0, (AudioPlayerAlert.this.searching && ((BottomSheet) AudioPlayerAlert.this).keyboardVisible) ? 0 : AudioPlayerAlert.this.listView.getPaddingBottom());
                }
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0 && AudioPlayerAlert.this.scrollOffsetY != 0 && AudioPlayerAlert.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
                    boolean z = false;
                    if (AudioPlayerAlert.this.listAdapter.getItemCount() <= 0 ? motionEvent.getY() < getMeasuredHeight() - AndroidUtilities.m102dp(191) : motionEvent.getY() < AudioPlayerAlert.this.scrollOffsetY + AndroidUtilities.m102dp(12)) {
                        z = true;
                    }
                    if (z) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i = (AudioPlayerAlert.this.scrollOffsetY - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) - m102dp;
                if (((BottomSheet) AudioPlayerAlert.this).currentSheetAnimationType == 1) {
                    i = (int) (i + AudioPlayerAlert.this.listView.getTranslationY());
                }
                int m102dp2 = AndroidUtilities.m102dp(20) + i;
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m102dp(15) + ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop;
                if (((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i < C3702ActionBar.getCurrentActionBarHeight()) {
                    float m102dp3 = m102dp + AndroidUtilities.m102dp(4);
                    float min = Math.min(1.0f, ((C3702ActionBar.getCurrentActionBarHeight() - i) - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) / m102dp3);
                ...
                if (f != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) AudioPlayerAlert.this).backgroundPaddingLeft, ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i, getMeasuredWidth() - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingLeft, ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i + AndroidUtilities.m102dp(24));
        ...
        C3702ActionBar c3702ActionBar = new C3702ActionBar(context, resourcesProvider) { // from class: org.telegram.ui.Components.AudioPlayerAlert.3
            @Override // android.view.View
        ...
        c3702ActionBar2.setItemsColor(getThemedColor(i2), false);
        ...
        this.actionBar.setTitle(LocaleController.getString("AttachMusic", C3630R.string.AttachMusic));
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C3630R.C3632drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.Components.AudioPlayerAlert.4
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.AudioPlayerAlert.5
        ...
        this.actionBarShadow.setBackgroundResource(C3630R.C3632drawable.header_shadow);
        ...
        this.playerLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.6
            ...
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                ...
                int left = (AudioPlayerAlert.this.durationTextView.getLeft() - AndroidUtilities.m102dp(4)) - AudioPlayerAlert.this.playbackSpeedButton.getMeasuredWidth();
        ...
        if (!SharedConfig.isPlayerPinned) {
            ...
            this.pinPlayerButton.setImageResource(C3630R.C3632drawable.chats_pin);
            ...
            this.pinPlayerButton.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m102dp(24)));
        ...
        C44609 c44609 = new C44609(context, context);
        this.authorTextView = c44609;
        this.playerLayout.addView(c44609, LayoutHelper.createFrame(-1, -2, 51, 14, 47, (SharedConfig.isPlayerPinned ? 0 : 56) + 72, 0));
        SeekBarView seekBarView = new SeekBarView(context, resourcesProvider) { // from class: org.telegram.ui.Components.AudioPlayerAlert.10
            @Override // org.telegram.p042ui.Components.SeekBarView
        ...
        this.playbackSpeedButton.setAdditionalYOffset(-AndroidUtilities.m102dp(224));
        ...
        this.speedItems[0] = this.playbackSpeedButton.addSubItem(0, C3630R.C3632drawable.msg_speed_slow, LocaleController.getString("SpeedSlow", C3630R.string.SpeedSlow));
        this.speedItems[1] = this.playbackSpeedButton.addSubItem(1, C3630R.C3632drawable.msg_speed_normal, LocaleController.getString("SpeedNormal", C3630R.string.SpeedNormal));
        this.speedItems[2] = this.playbackSpeedButton.addSubItem(2, C3630R.C3632drawable.msg_speed_medium, LocaleController.getString("SpeedMedium", C3630R.string.SpeedMedium));
        this.speedItems[3] = this.playbackSpeedButton.addSubItem(3, C3630R.C3632drawable.msg_speed_fast, LocaleController.getString("SpeedFast", C3630R.string.SpeedFast));
        this.speedItems[4] = this.playbackSpeedButton.addSubItem(4, C3630R.C3632drawable.msg_speed_veryfast, LocaleController.getString("SpeedVeryFast", C3630R.string.SpeedVeryFast));
        this.speedItems[5] = this.playbackSpeedButton.addSubItem(5, C3630R.C3632drawable.msg_speed_superfast, LocaleController.getString("SpeedSuperFast", C3630R.string.SpeedSuperFast));
        if (AndroidUtilities.density >= 3.0f) {
            this.playbackSpeedButton.setPadding(0, 1, 0, 0);
        }
        this.playbackSpeedButton.setAdditionalXOffset(AndroidUtilities.m102dp(8));
        this.playbackSpeedButton.setAdditionalYOffset(-AndroidUtilities.m102dp(400));
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.12
            @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                int m102dp = ((i7 - i5) - AndroidUtilities.m102dp(248)) / 4;
                for (int i9 = 0; i9 < 5; i9++) {
                    int m102dp2 = AndroidUtilities.m102dp((i9 * 48) + 4) + (m102dp * i9);
                    int m102dp3 = AndroidUtilities.m102dp(9);
                    AudioPlayerAlert.this.buttons[i9].layout(m102dp2, m102dp3, AudioPlayerAlert.this.buttons[i9].getMeasuredWidth() + m102dp2, AudioPlayerAlert.this.buttons[i9].getMeasuredHeight() + m102dp3);
                }
            }
        };
        ...
        this.repeatButton.setAdditionalYOffset(-AndroidUtilities.m102dp(166));
        int i5 = Build.VERSION.SDK_INT;
        if (i5 >= 21) {
            this.repeatButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m102dp(18)));
        }
        ...
        this.repeatSongItem = this.repeatButton.addSubItem(3, C3630R.C3632drawable.player_new_repeatone, LocaleController.getString("RepeatSong", C3630R.string.RepeatSong));
        this.repeatListItem = this.repeatButton.addSubItem(4, C3630R.C3632drawable.player_new_repeatall, LocaleController.getString("RepeatList", C3630R.string.RepeatList));
        this.shuffleListItem = this.repeatButton.addSubItem(2, C3630R.C3632drawable.player_new_shuffle, LocaleController.getString("ShuffleList", C3630R.string.ShuffleList));
        this.reverseOrderItem = this.repeatButton.addSubItem(1, C3630R.C3632drawable.player_new_order, LocaleController.getString("ReverseOrder", C3630R.string.ReverseOrder));
        ...
        C444013 c444013 = new C444013(context, scaledTouchSlop);
        this.prevButton = c444013;
        viewArr2[1] = c444013;
        c444013.setScaleType(ImageView.ScaleType.CENTER);
        RLottieImageView rLottieImageView = this.prevButton;
        int i7 = C3630R.raw.player_prev;
        ...
        if (i5 >= 21) {
            this.prevButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m102dp(22)));
        }
        frameLayout2.addView(this.prevButton, LayoutHelper.createFrame(48, 48, 51));
        this.prevButton.setContentDescription(LocaleController.getString("AccDescrPrevious", C3630R.string.AccDescrPrevious));
        ...
        if (i5 >= 21) {
            this.playButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m102dp(24)));
        }
        ...
        C444314 c444314 = new C444314(context, scaledTouchSlop);
        this.nextButton = c444314;
        viewArr4[3] = c444314;
        c444314.setScaleType(ImageView.ScaleType.CENTER);
        ...
        if (i5 >= 21) {
            this.nextButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m102dp(22)));
        }
        frameLayout2.addView(this.nextButton, LayoutHelper.createFrame(48, 48, 51));
        this.nextButton.setContentDescription(LocaleController.getString("Next", C3630R.string.Next));
        ...
        this.optionsButton.setAdditionalYOffset(-AndroidUtilities.m102dp(157));
        if (i5 >= 21) {
            this.optionsButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m102dp(18)));
        }
        frameLayout2.addView(this.optionsButton, LayoutHelper.createFrame(48, 48, 51));
        this.optionsButton.addSubItem(1, C3630R.C3632drawable.msg_forward, LocaleController.getString("Forward", C3630R.string.Forward));
        int m102dp = AndroidUtilities.m102dp(96);
        ActionBarMenuItem actionBarMenuItem5 = this.optionsButton;
        actionBarMenuItem5.setAdditionalYOffset(actionBarMenuItem5.getAdditionalYOffset() - m102dp);
        this.optionsButton.addSubItem(IdFabric$Menu.MESSAGE_SAVE_CLOUD, C3630R.C3632drawable.fork_forward_cloud, LocaleController.getInternalString(C3630R.string.chat_message_popup_option_forward_cloud));
        this.optionsButton.addSubItem(2, C3630R.C3632drawable.msg_shareout, LocaleController.getString("ShareFile", C3630R.string.ShareFile));
        this.optionsButton.addSubItem(5, C3630R.C3632drawable.msg_download, LocaleController.getString("SaveToMusic", C3630R.string.SaveToMusic));
        this.optionsButton.addSubItem(4, C3630R.C3632drawable.msg_message, LocaleController.getString("ShowInChat", C3630R.string.ShowInChat));
        ...
        imageView4.setImageResource(C3630R.C3632drawable.music_empty);
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.AudioPlayerAlert.16
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i9) {
                ...
                if (((AudioPlayerAlert.this.scrollOffsetY - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) - AndroidUtilities.m102dp(13)) + ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop >= C3702ActionBar.getCurrentActionBarHeight() || !AudioPlayerAlert.this.listView.canScrollVertically(1)) {
                    return;
                }
                ...
                AudioPlayerAlert.this.listView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m102dp(7));
            }
        ...
        ((FrameLayout.LayoutParams) this.playerShadow.getLayoutParams()).bottomMargin = AndroidUtilities.m102dp(179);
        ...
        this.bigAlbumConver.setRoundRadius(AndroidUtilities.m102dp(8));
    ...
    public /* synthetic */ void lambda$new$2(View view) {
        ...
        if (lastFragment != null && !SharedConfig.hasPreferenceKey(TelegramPreferenceKeys.Global.isPlayerPinned())) {
            ...
            if (undoView != null) {
                undoView.showInfo(LocaleController.getInternalString(C3630R.string.music_pinned_player_enabled_toast));
            } else {
    ...
    public static /* synthetic */ void lambda$new$1(BaseFragment baseFragment) {
        BulletinFactory.m62of((FrameLayout) baseFragment.getFragmentView(), baseFragment.getResourceProvider()).createSimpleBulletin(C3630R.raw.info, LocaleController.getInternalString(C3630R.string.music_pinned_player_enabled_toast)).show();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Components.AudioPlayerAlert$9 */
    /* loaded from: classes6.dex */
    public class C44609 extends ClippingTextViewSwitcher {
        final /* synthetic */ Context val$context;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C44609(Context context, Context context2) {
            super(context);
        ...
        protected TextView createTextView() {
            ...
            textView.setBackground(Theme.createRadSelectorDrawable(AudioPlayerAlert.this.getThemedColor(Theme.key_listSelector), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4)));
            textView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.AudioPlayerAlert$9$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    AudioPlayerAlert.C44609.this.lambda$createTextView$0(textView, view);
                }
            });
            return textView;
        }
    ...
    /* loaded from: classes6.dex */
    class C444013 extends RLottieImageView {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C444013(Context context, float f) {
            super(context);
            ...
            this.pressedRunnable = new Runnable() { // from class: org.telegram.ui.Components.AudioPlayerAlert.13.1
                @Override // java.lang.Runnable
                public void run() {
                    C444013 c444013 = C444013.this;
                    int i = c444013.pressedCount + 1;
                    c444013.pressedCount = i;
                    if (i != 1) {
                        if (i == 2) {
                    ...
                    C444013.this.lastTime = System.currentTimeMillis();
                    AndroidUtilities.runOnUIThread(this, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                    AndroidUtilities.runOnUIThread(C444013.this.backSeek);
                }
            };
            this.backSeek = new Runnable() { // from class: org.telegram.ui.Components.AudioPlayerAlert.13.2
                ...
                public void run() {
                    ...
                    long currentTimeMillis = System.currentTimeMillis();
                    C444013 c444013 = C444013.this;
                    long j = currentTimeMillis - c444013.lastTime;
                    c444013.lastTime = currentTimeMillis;
                    long j2 = currentTimeMillis - c444013.lastUpdateTime;
                    int i = c444013.pressedCount;
                    ...
                    C444013 c4440132 = C444013.this;
                    AudioPlayerAlert audioPlayerAlert = AudioPlayerAlert.this;
                    if (audioPlayerAlert.rewindingState != -1 || c4440132.pressedCount <= 0) {
                        return;
                    }
                    if (j2 > 200 || audioPlayerAlert.rewindingProgress == BitmapDescriptorFactory.HUE_RED) {
                        c4440132.lastUpdateTime = currentTimeMillis;
                    ...
                    C444013 c4440133 = C444013.this;
                    if (c4440133.pressedCount <= 0 || AudioPlayerAlert.this.rewindingProgress <= BitmapDescriptorFactory.HUE_RED) {
                        return;
                    }
                    AndroidUtilities.runOnUIThread(c4440133.backSeek, 16L);
                }
            };
        }
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r10) {
            /*
                r9 = this;
                org.telegram.ui.Components.AudioPlayerAlert r0 = org.telegram.p042ui.Components.AudioPlayerAlert.this
                org.telegram.ui.Components.SeekBarView r0 = org.telegram.p042ui.Components.AudioPlayerAlert.access$5400(r0)
            ...
            L30:
                ...
                if (r10 <= 0) goto Ldc
                org.telegram.ui.Components.AudioPlayerAlert r10 = org.telegram.p042ui.Components.AudioPlayerAlert.this
            ...
            L50:
                ...
                org.telegram.ui.Components.AudioPlayerAlert r10 = org.telegram.p042ui.Components.AudioPlayerAlert.this
                org.telegram.ui.Components.RLottieImageView r10 = org.telegram.p042ui.Components.AudioPlayerAlert.access$5500(r10)
                r0 = 0
                r10.setProgress(r0)
                org.telegram.ui.Components.AudioPlayerAlert r10 = org.telegram.p042ui.Components.AudioPlayerAlert.this
                org.telegram.ui.Components.RLottieImageView r10 = org.telegram.p042ui.Components.AudioPlayerAlert.access$5500(r10)
            ...
            Ldd:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.AudioPlayerAlert.C444013.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    /* loaded from: classes6.dex */
    class C444314 extends RLottieImageView {
        boolean pressed;
        private final Runnable pressedRunnable;
        float startX;
        float startY;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C444314(Context context, float f) {
            super(context);
            this.val$touchSlop = f;
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r7) {
            ...
            L4d:
                ...
                r7.playNextMessage()
                org.telegram.ui.Components.AudioPlayerAlert r7 = org.telegram.p042ui.Components.AudioPlayerAlert.this
                org.telegram.ui.Components.RLottieImageView r7 = org.telegram.p042ui.Components.AudioPlayerAlert.access$5700(r7)
                r0 = 0
                r7.setProgress(r0)
                org.telegram.ui.Components.AudioPlayerAlert r7 = org.telegram.p042ui.Components.AudioPlayerAlert.this
                org.telegram.ui.Components.RLottieImageView r7 = org.telegram.p042ui.Components.AudioPlayerAlert.access$5700(r7)
            ...
            L77:
                ...
                java.lang.Runnable r7 = org.telegram.p042ui.Components.AudioPlayerAlert.access$100(r7)
                r7.run()
            La2:
                org.telegram.ui.Components.AudioPlayerAlert r7 = org.telegram.p042ui.Components.AudioPlayerAlert.this
            ...
            Lda:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.AudioPlayerAlert.C444314.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    public int getContainerViewHeight() {
        ...
        int m102dp = AndroidUtilities.m102dp(13);
        int i = (this.scrollOffsetY - this.backgroundPaddingTop) - m102dp;
        if (this.currentSheetAnimationType == 1) {
            i = (int) (i + this.listView.getTranslationY());
        }
        if (this.backgroundPaddingTop + i < C3702ActionBar.getCurrentActionBarHeight()) {
            float m102dp2 = m102dp + AndroidUtilities.m102dp(4);
            i -= (int) ((C3702ActionBar.getCurrentActionBarHeight() - m102dp2) * Math.min(1.0f, ((C3702ActionBar.getCurrentActionBarHeight() - i) - this.backgroundPaddingTop) / m102dp2));
        }
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    public void updateEmptyViewPosition() {
        ...
        int m102dp = this.playerLayout.getVisibility() == 0 ? AndroidUtilities.m102dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION) : -AndroidUtilities.m102dp(30);
        LinearLayout linearLayout = this.emptyView;
        linearLayout.setTranslationY(((linearLayout.getMeasuredHeight() - this.containerView.getMeasuredHeight()) - m102dp) / 2);
    }
    ...
    private void showSpeedHint() {
        if (this.containerView != null) {
            ...
            hintView.setExtraTranslationY(AndroidUtilities.m102dp(6));
    ...
    public void updateColors() {
        if (this.playbackSpeedButton != null) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                this.playbackSpeedButton.setBackground(Theme.createSelectorDrawable(themedColor & 436207615, 1, AndroidUtilities.m102dp(14)));
            }
        }
    }
    ...
    */
    public void onSubItemClick(int r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.AudioPlayerAlert.onSubItemClick(int):void");
    }
        ...
        if (arrayList2.size() > 1 || ((MessagesStorage.TopicKey) arrayList2.get(0)).dialogId == UserConfig.getInstance(this.currentAccount).getClientUserId() || charSequence != null || dialogsActivity.isInMultiSelect()) {
            ...
            for (int i = 0; i < arrayList2.size(); i++) {
                ...
                if (charSequence != null) {
                    SendMessagesHelper.getInstance(this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m90of(charSequence.toString(), j, null, null, null, true, null, null, null, dialogsActivity.notify, dialogsActivity.scheduleDate, null, false, null));
                }
    ...
    public /* synthetic */ void lambda$onSubItemClick$15(Uri uri) {
        BulletinFactory.m62of((FrameLayout) this.containerView, this.resourcesProvider).createDownloadBulletin(BulletinFactory.FileType.AUDIO).show();
    }
    ...
    public void updateLayout() {
        ...
        int m102dp2 = AndroidUtilities.m102dp(7);
        ...
        int m102dp3 = top + ((layoutParams.topMargin - AndroidUtilities.statusBarHeight) - AndroidUtilities.m102dp(11));
        if (this.scrollOffsetY != m102dp3) {
            RecyclerListView recyclerListView2 = this.listView;
            this.scrollOffsetY = m102dp3;
            recyclerListView2.setTopGlowOffset((m102dp3 - layoutParams.topMargin) - AndroidUtilities.statusBarHeight);
            this.containerView.invalidate();
        }
        int m102dp4 = (this.scrollOffsetY - this.backgroundPaddingTop) - AndroidUtilities.m102dp(13);
        if (this.currentSheetAnimationType == 1) {
            m102dp4 = (int) (m102dp4 + this.listView.getTranslationY());
        }
        if ((this.backgroundPaddingTop + m102dp4 < C3702ActionBar.getCurrentActionBarHeight() ? 1.0f - Math.min(1.0f, ((C3702ActionBar.getCurrentActionBarHeight() - m102dp4) - this.backgroundPaddingTop) / (m102dp + AndroidUtilities.m102dp(4))) : 1.0f) <= 0.5f && ColorUtils.calculateLuminance(getThemedColor(Theme.key_dialogBackground)) > 0.699999988079071d) {
            z = true;
        }
        if (z != this.wasLight) {
    ...
    private void updateTitle(boolean z) {
        ...
        if ((playingMessageObject == null && z) || (playingMessageObject != null && !playingMessageObject.isMusic())) {
            ...
            if ((dialogId < 0 && MessagesController.getInstance(this.currentAccount).isChatNoForwards(-dialogId)) || MessagesController.getInstance(this.currentAccount).isChatNoForwards(playingMessageObject.getChatId()) || playingMessageObject.messageOwner.noforwards) {
                ...
                this.optionsButton.setAdditionalYOffset(-AndroidUtilities.m102dp(16));
            } else {
                ...
                actionBarMenuItem.setAdditionalYOffset(actionBarMenuItem.getAdditionalYOffset() - m102dp);
            }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void notifyDataSetChanged() {
            ...
            if (AudioPlayerAlert.this.playlist.size() > 1) {
                ...
                AudioPlayerAlert.this.listView.setPadding(0, AudioPlayerAlert.this.listView.getPaddingTop(), 0, AndroidUtilities.m102dp(179));
            } else {
        ...
        public /* synthetic */ void lambda$updateSearchResults$3(ArrayList arrayList, String str) {
            if (AudioPlayerAlert.this.searching) {
                ...
                AudioPlayerAlert.this.emptySubtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoAudioFoundPlayerInfo", C3630R.string.NoAudioFoundPlayerInfo, str)));
            }
        }
    }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(c3702ActionBar2, i3, null, null, null, themeDescriptionDelegate, i4));
    ...
    public static abstract class CoverContainer extends FrameLayout {
        ...
        public CoverContainer(Context context) {
            ...
            for (final int i = 0; i < 2; i++) {
                ...
                this.imageViews[i].setRoundRadius(AndroidUtilities.m102dp(4));
                if (i == 1) {
    ...
    public static abstract class ClippingTextViewSwitcher extends FrameLayout {
        ...
        public ClippingTextViewSwitcher(Context context) {
            ...
            this.gradientSize = AndroidUtilities.m102dp(24);
            this.stableOffest = -1;
