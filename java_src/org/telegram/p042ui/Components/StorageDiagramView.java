...
public class StorageDiagramView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    int enabledCount;
    private boolean isNotClickableAvatar;
    ...
    public void setNotClickableAvatar(boolean z) {
        this.isNotClickableAvatar = z;
    }
    ...
    public StorageDiagramView(Context context, long j, boolean z) {
        this(context);
        ...
        if (z) {
            this.dialogText = LocaleController.getString("ArchivedChats", C3630R.string.ArchivedChats);
            CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m102dp(90), Theme.getColor(Theme.key_chats_archiveBackground)), ContextCompat.getDrawable(context, C3630R.C3632drawable.fork_fab_archive));
            combinedDrawable.setIconSize(AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(30));
            this.avatarImageReceiver.setImageBitmap(combinedDrawable);
        } else if (j == Long.MAX_VALUE) {
            this.dialogText = LocaleController.getString("CacheOtherChats", C3630R.string.CacheOtherChats);
            ...
            this.dialogText = Emoji.replaceEmoji(dialogPhotoTitle, null, AndroidUtilities.m102dp(6), false);
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.dialogId != null) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(166), 1073741824));
            i4 = (View.MeasureSpec.getSize(i) - AndroidUtilities.m102dp(110)) / 2;
            this.rectF.set(AndroidUtilities.m102dp(3) + i4, AndroidUtilities.m102dp(3), AndroidUtilities.m102dp(107) + i4, AndroidUtilities.m102dp(107));
        } else {
            int i5 = this.customSize;
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i5 != 0 ? i5 + 6 : AndroidUtilities.m102dp(110), 1073741824);
            int i6 = this.customSize;
            super.onMeasure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(i6 != 0 ? i6 + 6 : AndroidUtilities.m102dp(110), 1073741824));
            RectF rectF = this.rectF;
            float m102dp = AndroidUtilities.m102dp(3);
            float m102dp2 = AndroidUtilities.m102dp(3);
            int i7 = this.customSize;
            rectF.set(m102dp, m102dp2, i7 != 0 ? i7 - 3 : AndroidUtilities.m102dp(107), this.customSize != 0 ? i3 - 3 : AndroidUtilities.m102dp(107));
            i4 = 0;
        }
        ...
        if (this.customCenterText != null) {
            this.text1.setTextSize(AndroidUtilities.m102dp(13));
        } else {
            this.text1.setTextSize(AndroidUtilities.m102dp(24));
        }
        ...
        if (this.dialogId != null) {
            this.text2.setTextSize(AndroidUtilities.m102dp(16));
            this.text1.setGravity(5);
            this.text2.setGravity(3);
        } else {
            this.text2.setTextSize(AndroidUtilities.m102dp(13));
            ...
            if (i8 == 0) {
                i8 = AndroidUtilities.m102dp(110);
            }
            int i9 = ((i8 - textSize) - textSize2) / 2;
            int i10 = textSize + i9;
            this.text1.setBounds(0, i9, getMeasuredWidth(), i10);
            this.text2.setBounds(0, AndroidUtilities.m102dp(2) + i10, getMeasuredWidth(), i10 + textSize2 + AndroidUtilities.m102dp(2));
        ...
        if (this.dialogText != null) {
            ...
            this.dialogTextPaint.setTextSize(AndroidUtilities.m102dp(13));
            int size = View.MeasureSpec.getSize(i) - AndroidUtilities.m102dp(60);
        ...
        if (imageReceiver != null) {
            imageReceiver.setImageCoords(i4 + AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(90), AndroidUtilities.m102dp(90));
            this.avatarImageReceiver.setRoundRadius(AndroidUtilities.m102dp(45));
        }
        updateDescription();
    }
    ...
    protected void onDraw(Canvas canvas) {
            ...
            if (clearViewDataArr[i3] != null) {
                ...
                if (fArr[i3] != BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (clearViewDataArr[i3].firstDraw) {
                        ...
                        clearViewDataArr[i3].paint.setColor(Theme.getColor(clearViewDataArr[i3].colorKey));
            ...
            if (clearViewDataArr2[i4] != null) {
                ...
                if (fArr2[i4] != BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (!clearViewDataArr2[i4].firstDraw) {
                        ...
                        clearViewDataArr2[i4].paint.setColor(Theme.getColor(clearViewDataArr2[i4].colorKey));
        ...
        if (animatedTextDrawable != null) {
            ...
            if (this.dialogId != null) {
                float currentWidth = this.text1.getCurrentWidth() + AndroidUtilities.m102dp(4) + this.text2.getCurrentWidth();
                float width3 = (getWidth() - currentWidth) / 2.0f;
                this.text1.setBounds(0, AndroidUtilities.m102dp(115), (int) (this.text1.getCurrentWidth() + width3), AndroidUtilities.m102dp(145));
                AnimatedTextView.AnimatedTextDrawable animatedTextDrawable2 = this.text2;
                animatedTextDrawable2.setBounds((int) ((width3 + currentWidth) - animatedTextDrawable2.getCurrentWidth()), AndroidUtilities.m102dp(118), getWidth(), AndroidUtilities.m102dp(148));
            }
        ...
        if (this.dialogTextLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(148) - ((this.dialogTextLayout.getHeight() - AndroidUtilities.m102dp(13)) / 2.0f));
    ...
    public static class ClearViewData {
        ...
        public ClearViewData(StorageDiagramView storageDiagramView) {
            ...
            this.paint.setStrokeWidth(AndroidUtilities.m102dp(5));
