...
public class VideoTimelinePlayView extends View {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m102dp(44);
        float f = measuredWidth;
        int m102dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m102dp(22);
        int m102dp2 = ((int) (this.playProgress * f)) + AndroidUtilities.m102dp(22);
        int m102dp3 = ((int) (this.progressRight * f)) + AndroidUtilities.m102dp(22);
        if (motionEvent.getAction() == 0) {
            getParent().requestDisallowInterceptTouchEvent(true);
            if (this.mediaMetadataRetriever == null) {
                return false;
            }
            int m102dp4 = AndroidUtilities.m102dp(16);
            int m102dp5 = AndroidUtilities.m102dp(8);
            if (m102dp3 != m102dp && m102dp2 - m102dp5 <= x && x <= m102dp5 + m102dp2 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                invalidate();
                return true;
            } else if (m102dp - m102dp4 <= x && x <= Math.min(m102dp + m102dp4, m102dp3) && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                invalidate();
                return true;
            } else if (m102dp3 - m102dp4 <= x && x <= m102dp4 + m102dp3 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m102dp3);
                invalidate();
                return true;
            } else if (m102dp <= x && x <= m102dp3 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                this.pressedPlay = true;
                float m102dp6 = (x - AndroidUtilities.m102dp(16)) / f;
                this.playProgress = m102dp6;
                VideoTimelineViewDelegate videoTimelineViewDelegate5 = this.delegate;
                if (videoTimelineViewDelegate5 != null) {
                    videoTimelineViewDelegate5.onPlayProgressChanged(m102dp6);
                }
            ...
            if (this.pressedPlay) {
                float m102dp7 = (((int) (x - this.pressDx)) - AndroidUtilities.m102dp(16)) / f;
                this.playProgress = m102dp7;
                ...
                if (i < AndroidUtilities.m102dp(16)) {
                    m102dp3 = AndroidUtilities.m102dp(16);
                } else if (i <= m102dp3) {
                    m102dp3 = i;
                }
                float m102dp8 = (m102dp3 - AndroidUtilities.m102dp(16)) / f;
                this.progressLeft = m102dp8;
                float f4 = this.progressRight;
                float f5 = this.maxProgressDiff;
                if (f4 - m102dp8 > f5) {
                    this.progressRight = m102dp8 + f5;
                } else {
                    float f6 = this.minProgressDiff;
                    if (f6 != BitmapDescriptorFactory.HUE_RED && f4 - m102dp8 < f6) {
                        float f7 = f4 - f6;
                ...
                float m102dp9 = (m102dp - AndroidUtilities.m102dp(16)) / f;
                this.progressRight = m102dp9;
                float f11 = this.progressLeft;
                float f12 = this.maxProgressDiff;
                if (m102dp9 - f11 > f12) {
                    this.progressLeft = m102dp9 - f12;
                } else {
                    float f13 = this.minProgressDiff;
                    if (f13 != BitmapDescriptorFactory.HUE_RED && m102dp9 - f11 < f13) {
                        float f14 = f11 + f13;
    ...
    public void reloadFrames(int i) {
        ...
        if (i == 0) {
            this.frameHeight = AndroidUtilities.m102dp(38);
            float f = 1.0f;
            int i3 = this.videoWidth;
            if (i3 != 0 && (i2 = this.videoHeight) != 0) {
                f = i3 / i2;
            }
            this.framesToLoad = Math.max(1, (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m102dp(32)) / (this.frameHeight * Utilities.clamp(f, 1.3333334f, 0.5625f))));
            this.frameWidth = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m102dp(32)) / this.framesToLoad);
    ...
    */
    protected void onDraw(android.graphics.Canvas r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.VideoTimelinePlayView.onDraw(android.graphics.Canvas):void");
    }

    private void drawProgress(Canvas canvas, float f, float f2) {
        float dpf2 = AndroidUtilities.dpf2(12.0f);
        float m102dp = AndroidUtilities.m102dp(2);
        float m102dp2 = AndroidUtilities.m102dp(46) + m102dp;
        float f3 = ((m102dp2 - m102dp) / 2.0f) * (1.0f - f2);
        float f4 = m102dp + f3;
        float f5 = m102dp2 - f3;
        this.shadowPaint.setAlpha((int) (38.0f * f2));
        this.whitePaint.setAlpha((int) (f2 * 255.0f));
        float m102dp3 = dpf2 + AndroidUtilities.m102dp(10) + (((getMeasuredWidth() - (dpf2 * 2.0f)) - AndroidUtilities.m102dp(20)) * f);
        this.rect3.set(m102dp3 - AndroidUtilities.dpf2(1.5f), f4, AndroidUtilities.dpf2(1.5f) + m102dp3, f5);
        this.rect3.inset(-AndroidUtilities.dpf2(0.66f), -AndroidUtilities.dpf2(0.66f));
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), this.shadowPaint);
        this.rect3.set(m102dp3 - AndroidUtilities.dpf2(1.5f), f4, m102dp3 + AndroidUtilities.dpf2(1.5f), f5);
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), this.whitePaint);
    }
