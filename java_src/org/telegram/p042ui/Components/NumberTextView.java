...
public class NumberTextView extends View {
    ...
    */
    public void setNumber(int r22, boolean r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.NumberTextView.setNumber(int, boolean):void");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float m102dp = this.addNumber ? AndroidUtilities.m102dp(4) : height;
        if (this.center) {
        ...
        while (i < max) {
            ...
            if (f3 > BitmapDescriptorFactory.HUE_RED) {
                if (staticLayout != null) {
                    ...
                    canvas.save();
                    canvas.translate(f2, (this.progress - 1.0f) * m102dp);
                    staticLayout.draw(canvas);
                    canvas.restore();
                    if (staticLayout2 != null) {
                        this.textPaint.setAlpha((int) ((1.0f - this.progress) * 255.0f));
                        canvas.translate(BitmapDescriptorFactory.HUE_RED, this.progress * m102dp);
                    }
                } else {
            ...
            canvas.restore();
            canvas.translate(staticLayout2 != null ? staticLayout2.getLineWidth(0) : staticLayout.getLineWidth(0) + AndroidUtilities.m102dp(1), BitmapDescriptorFactory.HUE_RED);
