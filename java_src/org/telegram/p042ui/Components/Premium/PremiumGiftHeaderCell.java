...
public class PremiumGiftHeaderCell extends LinearLayout {
    ...
    public PremiumGiftHeaderCell(Context context) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m102dp(50));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        float paddingTop = ((this.avatarImageView.getPaddingTop() + this.avatarImageView.getY()) + (this.avatarImageView.getHeight() / 2.0f)) - AndroidUtilities.m102dp(3);
        float m102dp = AndroidUtilities.m102dp(32);
        this.drawable.rect.set(x - m102dp, paddingTop - m102dp, x + m102dp, paddingTop + m102dp);
        if (z) {
    ...
    public void bind(TLRPC$User tLRPC$User) {
        ...
        this.titleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.GiftTelegramPremiumTitle)));
        this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C3630R.string.GiftTelegramPremiumDescription, tLRPC$User.first_name)));
    }
}
