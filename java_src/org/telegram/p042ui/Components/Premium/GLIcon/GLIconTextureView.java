package org.telegram.p042ui.Components.Premium.GLIcon;
...
public class GLIconTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public GLIconTextureView(Context context, int i) {
        ...
        initialize(context);
        GestureDetector gestureDetector = new GestureDetector(context, new GestureDetector$OnGestureListenerC53271());
    ...
    /* loaded from: classes6.dex */
    public class GestureDetector$OnGestureListenerC53271 implements GestureDetector.OnGestureListener {
        ...
        GestureDetector$OnGestureListenerC53271() {
        }
        ...
        public boolean onSingleTapUp(MotionEvent motionEvent) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.GLIcon.GLIconTextureView$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    GLIconTextureView.GestureDetector$OnGestureListenerC53271.this.lambda$onSingleTapUp$0(nextInt, nextInt2);
                }
            }, 16L);
            return true;
        }
    ...
    public class RenderThread extends Thread {
        ...
        /* synthetic */ RenderThread(GLIconTextureView gLIconTextureView, GestureDetector$OnGestureListenerC53271 gestureDetector$OnGestureListenerC53271) {
            this();
        }
    ...
    private void checkEglError() {
        if (this.mEgl.eglGetError() != 12288) {
            FileLog.m99e("cannot swap buffers!");
        }
    }
    ...
    public void checkGlError() {
        ...
        if (glGetError != 0) {
            FileLog.m99e("GL error = 0x" + Integer.toHexString(glGetError));
        }
    }
    ...
    public void initGL() {
        ...
        if (eGLSurface == null || eGLSurface == EGL10.EGL_NO_SURFACE) {
            ...
            if (eglGetError == 12299) {
                FileLog.m99e("eglCreateWindowSurface returned EGL10.EGL_BAD_NATIVE_WINDOW");
                return;
            }
    ...
    private void pullAnimation() {
        ...
        if (abs == 0) {
            ...
            ofFloat3.setDuration(C0479C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
            ofFloat3.setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT);
            ValueAnimator ofFloat4 = ValueAnimator.ofFloat(f2, BitmapDescriptorFactory.HUE_RED);
            ofFloat4.addUpdateListener(this.xUpdater);
            ofFloat4.setDuration(1000L);
            ofFloat4.setStartDelay(C0479C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
            ofFloat4.setInterpolator(AndroidUtilities.overshootInterpolator);
