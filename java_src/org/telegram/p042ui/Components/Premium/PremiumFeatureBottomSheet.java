...
public class PremiumFeatureBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumFeatureBottomSheet(final BaseFragment baseFragment, Context context, int i, int i2, final boolean z, PremiumPreviewFragment.SubscriptionTier subscriptionTier) {
        ...
        this.svgIcon = SvgHelper.getDrawable(RLottieDrawable.readRes(null, C3630R.raw.star_loader));
        ...
        premiumGradientTools.f1905y1 = 1.1f;
        premiumGradientTools.f1904x2 = 1.5f;
        premiumGradientTools.f1906y2 = -0.2f;
        ...
        this.content = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.2
            ...
            protected void onMeasure(int i4, int i5) {
                super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(PremiumFeatureBottomSheet.this.contentHeight + AndroidUtilities.m102dp(2), 1073741824));
            }
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                rectF.set(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(2), getMeasuredWidth(), getMeasuredHeight() + AndroidUtilities.m102dp(18));
                canvas.save();
                canvas.clipRect(0, 0, getMeasuredWidth(), getMeasuredHeight());
                premiumGradientTools.paint.setAlpha(PremiumFeatureBottomSheet.this.gradientAlpha);
                canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(12) - 1, AndroidUtilities.m102dp(12) - 1, premiumGradientTools.paint);
                canvas.restore();
        ...
        imageView.setImageResource(C3630R.C3632drawable.msg_close);
        imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(12), ColorUtils.setAlphaComponent(-1, 40), ColorUtils.setAlphaComponent(-1, 100)));
        ...
        ViewPager viewPager = new ViewPager(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.3
            ...
            public void onMeasure(int i4, int i5) {
                int m102dp = AndroidUtilities.m102dp(100);
                if (getChildCount() > 0) {
                    getChildAt(0).measure(i4, View.MeasureSpec.makeMeasureSpec(0, 0));
                    m102dp = getChildAt(0).getMeasuredHeight();
                }
                super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(m102dp + PremiumFeatureBottomSheet.this.topGlobalOffset, 1073741824));
            }
        ...
        this.viewPager.addOnPageChangeListener(new C53595(bottomPagesView));
        ...
        if (UserConfig.getInstance(i).isPremium()) {
            this.premiumButtonView.setOverlayText(LocaleController.getString("OK", C3630R.string.OK), false, false);
        }
        ...
        final Drawable mutate = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.header_shadow).mutate();
        FrameLayout frameLayout3 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.6
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                PremiumFeatureBottomSheet premiumFeatureBottomSheet = PremiumFeatureBottomSheet.this;
                drawable.setBounds(0, ((premiumFeatureBottomSheet.topCurrentOffset + ((BottomSheet) premiumFeatureBottomSheet).backgroundPaddingTop) - AndroidUtilities.m102dp(2)) + 1, getMeasuredWidth(), getMeasuredHeight());
                ((BottomSheet) PremiumFeatureBottomSheet.this).shadowDrawable.draw(canvas);
                super.dispatchDraw(canvas);
                C3702ActionBar c3702ActionBar = PremiumFeatureBottomSheet.this.actionBar;
                if (c3702ActionBar == null || c3702ActionBar.getVisibility() != 0 || PremiumFeatureBottomSheet.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
                    return;
                }
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                if (view == scrollView) {
                    ...
                    this.path.rewind();
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(BitmapDescriptorFactory.HUE_RED, PremiumFeatureBottomSheet.this.topCurrentOffset + AndroidUtilities.m102dp(18), getMeasuredWidth(), getMeasuredHeight());
                    this.path.addRoundRect(rectF, AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(18), Path.Direction.CW);
            ...
            public boolean dispatchTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0) {
                    ...
                    PremiumFeatureBottomSheet premiumFeatureBottomSheet = PremiumFeatureBottomSheet.this;
                    if (y < (premiumFeatureBottomSheet.topCurrentOffset - ((BottomSheet) premiumFeatureBottomSheet).backgroundPaddingTop) + AndroidUtilities.m102dp(2)) {
    ...
    /* loaded from: classes6.dex */
    public class C53595 implements ViewPager.OnPageChangeListener {
        ...
        C53595(BottomPagesView bottomPagesView) {
        ...
        public void onPageSelected(int i) {
            if (PremiumFeatureBottomSheet.this.premiumFeatures.get(i).type == 0) {
                PremiumFeatureBottomSheet.this.actionBar.setTitle(LocaleController.getString("DoubledLimits", C3630R.string.DoubledLimits));
                ...
                PremiumFeatureBottomSheet.this.actionBar.setTitle(LocaleController.getString("UpgradedStories", C3630R.string.UpgradedStories));
                PremiumFeatureBottomSheet.this.actionBar.requestLayout();
            }
            checkPage();
        }
        ...
        */
        private void checkPage() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.Premium.PremiumFeatureBottomSheet.C53595.checkPage():void");
        }
    ...
    private void setButtonText() {
        if (this.forceAbout) {
            this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C3630R.string.AboutTelegramPremium));
        } else if (this.onlySelectedType) {
            int i = this.startType;
            if (i == 4) {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C3630R.string.UnlockPremiumReactions));
                this.premiumButtonView.setIcon(C3630R.raw.unlock_icon);
            } else if (i == 3 || i == 2 || i == 9 || i == 8) {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C3630R.string.AboutTelegramPremium));
            } else if (i == 10) {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C3630R.string.UnlockPremiumIcons));
                this.premiumButtonView.setIcon(C3630R.raw.unlock_icon);
            }
        } else {
    ...
    public void onCreate(Bundle bundle) {
        ...
        C3702ActionBar c3702ActionBar = new C3702ActionBar(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.7
            @Override // android.view.View
        ...
        c3702ActionBar.setBackgroundColor(getThemedColor(Theme.key_dialogBackground));
        ...
        this.actionBar.setExtraHeight(AndroidUtilities.m102dp(2));
        this.actionBar.setBackButtonImage(C3630R.C3632drawable.ic_ab_back);
        this.actionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.8
        ...
        ((FrameLayout.LayoutParams) this.actionBar.getLayoutParams()).topMargin = (-this.backgroundPaddingTop) - AndroidUtilities.m102dp(2);
        ...
        if (this.premiumFeatures.get(this.selectedPosition).type == 14) {
            this.actionBar.setTitle(LocaleController.getString("UpgradedStories", C3630R.string.UpgradedStories));
            this.actionBar.requestLayout();
            return;
        }
        this.actionBar.setTitle(LocaleController.getString("DoubledLimits", C3630R.string.DoubledLimits));
        this.actionBar.requestLayout();
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.billingProductDetailsUpdated || i == NotificationCenter.premiumPromoUpdated) {
            ...
            if (UserConfig.getInstance(this.currentAccount).isPremium()) {
                this.premiumButtonView.setOverlayText(LocaleController.getString("OK", C3630R.string.OK), false, true);
            } else {
                this.premiumButtonView.clearOverlayText();
            }
        }
    ...
    public class ViewPage extends LinearLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (((BottomSheet) PremiumFeatureBottomSheet.this).isPortrait) {
                marginLayoutParams.topMargin = AndroidUtilities.m102dp(20);
                marginLayoutParams.bottomMargin = 0;
            } else {
                marginLayoutParams.topMargin = AndroidUtilities.m102dp(10);
                marginLayoutParams.bottomMargin = AndroidUtilities.m102dp(10);
            }
            ((ViewGroup.MarginLayoutParams) this.topView.getLayoutParams()).bottomMargin = 0;
            super.onMeasure(i, i2);
            if (this.topViewOnFullHeight) {
                this.topView.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.m102dp(16);
                ((ViewGroup.MarginLayoutParams) this.topView.getLayoutParams()).bottomMargin = AndroidUtilities.m102dp(16);
                                    ...
                                    if (PremiumFeatureBottomSheet.this.startType != 9) {
                                        if (PremiumFeatureBottomSheet.this.startType != 8) {
                                            if (PremiumFeatureBottomSheet.this.startType == 13) {
                                                this.title.setText(LocaleController.getString(C3630R.string.PremiumPreviewTranslations));
                                                this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.PremiumPreviewTranslationsDescription)));
                                            }
                                        } else {
                                            this.title.setText(LocaleController.getString(C3630R.string.PremiumPreviewVoiceToText));
                                            this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.PremiumPreviewVoiceToTextDescription2)));
                                        }
                                    } else {
                                        this.title.setText(LocaleController.getString(C3630R.string.PremiumPreviewAdvancedChatManagement));
                                        this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.PremiumPreviewAdvancedChatManagementDescription2)));
                                    }
                                } else {
                                    this.title.setText(LocaleController.getString(C3630R.string.PremiumPreviewDownloadSpeed));
                                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.PremiumPreviewDownloadSpeedDescription2)));
                                }
                            } else {
                                this.title.setText(LocaleController.getString("PremiumPreviewAppIcon", C3630R.string.PremiumPreviewAppIcon));
                                this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString("PremiumPreviewAppIconDescription2", C3630R.string.PremiumPreviewAppIconDescription2)));
                            }
                        } else {
                            this.title.setText(LocaleController.getString("PremiumPreviewNoAds", C3630R.string.PremiumPreviewNoAds));
                            this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString("PremiumPreviewNoAdsDescription2", C3630R.string.PremiumPreviewNoAdsDescription2)));
                        }
                    } else {
                        this.title.setText(LocaleController.getString("AdditionalReactions", C3630R.string.AdditionalReactions));
                        this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString("AdditionalReactionsDescription", C3630R.string.AdditionalReactionsDescription)));
                    }
    ...
    View getViewForPosition(Context context, int i) {
        ...
        if (i2 == 0) {
            ...
            return new PremiumStickersPreviewRecycler(this, context, this.currentAccount) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.11
                @Override // org.telegram.p042ui.Components.Premium.PremiumStickersPreviewRecycler, org.telegram.p042ui.Components.Premium.PagerHeaderView
    ...
    void checkTopOffset() {
        ...
        this.content.setTranslationX(frameLayout.getMeasuredWidth() * this.progressToGradient);
        if (i4 != this.topCurrentOffset) {
            ...
            AndroidUtilities.updateViewVisibilityAnimated(this.actionBar, this.topCurrentOffset < AndroidUtilities.m102dp(30), 1.0f, true);
        }
    }
    ...
    public void updateStatusBar() {
        ...
        if (c3702ActionBar != null && c3702ActionBar.getTag() != null) {
