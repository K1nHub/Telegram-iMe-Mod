...
public class PremiumButtonView extends FrameLayout {
    ...
    public PremiumButtonView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        this(context, AndroidUtilities.m102dp(8), z, resourcesProvider);
    }
    ...
    public PremiumButtonView(Context context, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.buttonTextView.setTextSize(AndroidUtilities.m102dp(14));
        ...
        if (z) {
            ...
            animatedTextView2.setPadding(AndroidUtilities.m102dp(34), 0, AndroidUtilities.m102dp(34), 0);
            ...
            this.overlayTextView.setTextSize(AndroidUtilities.m102dp(14));
            ...
            this.overlayTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), 0, ColorUtils.setAlphaComponent(-1, 120)));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (counterView != null) {
            this.counterOffset.set(((counterView.counterDrawable.getWidth() * 0.85f) + AndroidUtilities.m102dp(3)) / 2.0f);
            this.counterOffset2.set((getMeasuredWidth() / 2.0f) + (this.overlayTextView.getDrawable().getWidth() / 2.0f) + AndroidUtilities.m102dp(3));
    ...
    public void updateOverlayProgress() {
        ...
        this.overlayTextView.setTranslationY(AndroidUtilities.m102dp(12) * (1.0f - this.overlayProgress));
        this.buttonLayout.setAlpha(1.0f - this.overlayProgress);
        this.buttonLayout.setTranslationY((-AndroidUtilities.m102dp(12)) * this.overlayProgress);
