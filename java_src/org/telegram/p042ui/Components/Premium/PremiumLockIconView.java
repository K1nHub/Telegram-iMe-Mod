...
public class PremiumLockIconView extends ImageView {
    ...
    public PremiumLockIconView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        setImageResource(i == TYPE_REACTIONS ? C3630R.C3632drawable.msg_premium_lock2 : C3630R.C3632drawable.msg_mini_premiumlock);
        if (i == TYPE_REACTIONS) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.type == TYPE_REACTIONS) {
            ...
            rectF.set((getMeasuredWidth() / 2.0f) + AndroidUtilities.m103dp(2.5f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dpf2(5.7f), getMeasuredWidth() - AndroidUtilities.dpf2(0.2f), getMeasuredHeight());
            this.path.addRoundRect(rectF, AndroidUtilities.m103dp(2.0f), AndroidUtilities.m103dp(2.0f), Path.Direction.CW);
            this.path.close();
            ...
            this.starParticles.rect.inset(AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6));
            return;
        }
        updateGradient();
    }
        ...
        if (paint != null) {
            if (this.type == TYPE_REACTIONS) {
                if (this.currentColor != 0) {
                    ...
                    PremiumGradient.getInstance().updateMainGradientMatrix(0, 0, getMeasuredWidth(), getMeasuredHeight(), -AndroidUtilities.m102dp(24), BitmapDescriptorFactory.HUE_RED);
    ...
    public void setLocked(boolean z) {
        if (this.type != TYPE_REACTIONS) {
            setImageResource(z ? C3630R.C3632drawable.msg_mini_premiumlock : C3630R.C3632drawable.msg_mini_stickerstar);
        }
    }
}
