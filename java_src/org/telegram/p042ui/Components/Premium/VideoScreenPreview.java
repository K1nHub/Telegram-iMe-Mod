...
import org.telegram.p042ui.Components.Premium.HelloParticles;
...
public class VideoScreenPreview extends FrameLayout implements PagerHeaderView, NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoScreenPreview(Context context, SvgHelper.SvgDrawable svgDrawable, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i2 == 1) {
            ...
            drawable3.size1 = 6;
            drawable3.size1 = 4;
            drawable3.f1916k3 = 0.98f;
            drawable3.f1915k2 = 0.98f;
            drawable3.f1914k1 = 0.98f;
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(context) { // from class: org.telegram.ui.Components.Premium.VideoScreenPreview.1
            ...
            public void onMeasure(int i4, int i5) {
                ...
                float m102dp = VideoScreenPreview.this.roundRadius - AndroidUtilities.m102dp(3);
                this.clipPath.addRoundRect(AndroidUtilities.rectTmp, m102dp, m102dp, Path.Direction.CW);
            }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.size != measuredWidth) {
            ...
            if (matrixParticlesDrawable != null) {
                ...
                this.matrixParticlesDrawable.excludeRect.inset(AndroidUtilities.m102dp(16), AndroidUtilities.m102dp(16));
            }
            ...
            if (drawable != null) {
                ...
                if (i5 == 6 || i5 == 9 || i5 == 3 || i5 == 7 || i5 == 11 || i5 == 4) {
                    ...
                    this.starDrawable.rect.inset(AndroidUtilities.m102dp(30), AndroidUtilities.m102dp(30));
                } else {
                    RectF rectF = AndroidUtilities.rectTmp;
                ...
                this.starDrawable.excludeRect.inset(AndroidUtilities.m102dp(10), AndroidUtilities.m102dp(10));
            }
            ...
            if (speedLineParticles$Drawable != null) {
                ...
                this.speedLinesDrawable.rect.inset(AndroidUtilities.m102dp(100), AndroidUtilities.m102dp(100));
            ...
            if (drawable2 != null) {
                ...
                this.helloParticlesDrawable.rect.inset(AndroidUtilities.m102dp(0), getMeasuredHeight() * 0.1f);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.inset(-AndroidUtilities.m102dp(3), -AndroidUtilities.m102dp(3));
        rectF.inset(-AndroidUtilities.m102dp(3), -AndroidUtilities.m102dp(3));
        canvas.drawRoundRect(rectF, this.roundRadius + AndroidUtilities.m102dp(3), this.roundRadius + AndroidUtilities.m102dp(3), this.phoneFrame2);
        rectF.inset(AndroidUtilities.m102dp(3), AndroidUtilities.m102dp(3));
        ...
        float m102dp = this.roundRadius - AndroidUtilities.m102dp(3);
        this.roundRadius = m102dp;
        RoundedBitmapDrawable roundedBitmapDrawable = this.roundedBitmapDrawable;
        if (roundedBitmapDrawable != null) {
            roundedBitmapDrawable.setCornerRadius(m102dp);
        }
        ...
        canvas.drawCircle(this.imageReceiver.getCenterX(), this.imageReceiver.getImageY() + AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(6), this.phoneFrame1);
    }
