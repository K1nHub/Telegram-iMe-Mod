...
public class GiftPremiumBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public GiftPremiumBottomSheet(BaseFragment baseFragment, TLRPC$User tLRPC$User) {
        ...
        this.outlineGradient.paint.setStrokeWidth(AndroidUtilities.m103dp(1.5f));
    ...
    public /* synthetic */ void lambda$new$1(Path path, Canvas canvas) {
        ...
        rectF.set(selectorRect.left + AndroidUtilities.m102dp(20), selectorRect.top + AndroidUtilities.m102dp(3), selectorRect.right - AndroidUtilities.m102dp(20), selectorRect.bottom - AndroidUtilities.m102dp(3));
        path.addRoundRect(rectF, AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(12), Path.Direction.CW);
    ...
    private void initData() {
        ...
        this.rowsCount = 0;
        TLRPC$UserFull userFull = MessagesController.getInstance(this.currentAccount).getUserFull(this.user.f1762id);
        if (userFull != null) {
    ...
    private void updateButtonText(boolean z) {
        ...
        if (!BuildVars.useInvoiceBilling() && (!BillingController.getInstance().isReady() || this.giftTiers.get(this.selectedTierIndex).googlePlayProductDetails == null)) {
            this.premiumButtonView.setButton(LocaleController.getString(C3630R.string.Loading), new View.OnClickListener() { // from class: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet$$ExternalSyntheticLambda1
        ...
        this.premiumButtonView.setButton(LocaleController.formatString(C3630R.string.GiftSubscriptionFor, this.giftTiers.get(this.selectedTierIndex).getFormattedPrice()), new View.OnClickListener() { // from class: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void onGiftSuccess(boolean z) {
        ...
        if (userFull != null) {
            ...
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.userInfoDidLoad, Long.valueOf(this.user.f1762id), userFull);
        }
        if (getBaseFragment() != null) {
            ...
            for (BaseFragment baseFragment : arrayList) {
                if (baseFragment instanceof ChatActivity) {
                    ...
                    if (chatActivity.getDialogId() != this.user.f1762id) {
            ...
            if (chatActivity == null || chatActivity.getDialogId() != this.user.f1762id) {
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C3630R.string.GiftTelegramPremiumTitle);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet$1 */
    /* loaded from: classes6.dex */
    public class C53351 extends RecyclerListView.SelectionAdapter {
        C53351() {
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                final PremiumGiftTierCell premiumGiftTierCell2 = new PremiumGiftTierCell(GiftPremiumBottomSheet.this.getContext()) { // from class: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet.1.1
                    /* JADX INFO: Access modifiers changed from: protected */
                    @Override // org.telegram.p042ui.Components.Premium.PremiumGiftTierCell, android.view.ViewGroup, android.view.View
                    public void dispatchDraw(Canvas canvas) {
                        if (this.discountView.getVisibility() == 0) {
                            ...
                            canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(6), AndroidUtilities.m102dp(6), GiftPremiumBottomSheet.this.gradientTools.paint);
                        }
                        ...
                        rectF2.set(AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(3), getWidth() - AndroidUtilities.m102dp(20), getHeight() - AndroidUtilities.m102dp(3));
                        ...
                        canvas.drawRoundRect(rectF2, AndroidUtilities.m102dp(12), AndroidUtilities.m102dp(12), GiftPremiumBottomSheet.this.outlineGradient.paint);
                ...
                premiumGiftTierCell2.setCirclePaintProvider(new GenericProvider() { // from class: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet$1$$ExternalSyntheticLambda0
                    ...
                    public final Object provide(Object obj) {
                        ...
                        lambda$onCreateViewHolder$0 = GiftPremiumBottomSheet.C53351.this.lambda$onCreateViewHolder$0(premiumGiftTierCell2, (Void) obj);
                ...
                premiumGiftTierCell2.setProgressDelegate(new CheckBoxBase.ProgressDelegate() { // from class: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet$1$$ExternalSyntheticLambda1
                    ...
                    public final void setProgress(float f) {
                        GiftPremiumBottomSheet.C53351.lambda$onCreateViewHolder$1(atomicReference, premiumGiftTierCell2, f);
                    }
                });
                ...
                String string = LocaleController.getString(C3630R.string.GiftPremiumListFeaturesAndTerms);
                ...
                textInfoPrivacyCell.setPadding(AndroidUtilities.m102dp(21), 0, AndroidUtilities.m102dp(21), 0);
                ...
                if (i != 3) {
                    ...
                    view = new View(this, GiftPremiumBottomSheet.this.getContext()) { // from class: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet.1.2
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(68), 1073741824));
                        }
                    };
                }
    ...
    private final class LinkSpan extends ClickableSpan {
        ...
        /* synthetic */ LinkSpan(GiftPremiumBottomSheet giftPremiumBottomSheet, C53351 c53351) {
            this();
        }
