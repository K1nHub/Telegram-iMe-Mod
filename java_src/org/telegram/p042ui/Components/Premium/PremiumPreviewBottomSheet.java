...
import org.telegram.p042ui.Components.Premium.GLIcon.GLIconRenderer;
...
import org.telegram.p042ui.PremiumFeatureCell;
...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC$User tLRPC$User, GiftPremiumBottomSheet.GiftTier giftTier, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumGradientTools.f1905y1 = 1.0f;
        premiumGradientTools.f1904x2 = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1906y2 = BitmapDescriptorFactory.HUE_RED;
        ...
        this.recyclerListView.setPadding(AndroidUtilities.m102dp(6), 0, AndroidUtilities.m102dp(6), 0);
    ...
    public void setTitle(boolean z) {
        ...
        if (this.statusStickerSet != null) {
            int i = C3630R.string.TelegramPremiumUserStatusDialogTitle;
            ...
            if (indexOf >= 0) {
                    ...
                    if (stickerSet.set != null) {
                        ...
                        while (true) {
                            if (i2 >= stickerSet.documents.size()) {
                                break;
                            } else if (stickerSet.documents.get(i2).f1608id == stickerSet.set.thumb_document_id) {
                ...
                if (tLRPC$Document != null) {
                    ...
                    spannableStringBuilder.setSpan(new LoadingSpan(this.titleView[0], AndroidUtilities.m102dp(100)), 0, spannableStringBuilder.length(), 33);
                }
                ...
                this.titleView[1].setOnLinkPressListener(new LinkSpanDrawable.LinksTextView.OnLinkPress() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$$ExternalSyntheticLambda6
                    @Override // org.telegram.p042ui.Components.LinkSpanDrawable.LinksTextView.OnLinkPress
            ...
            this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.TelegramPremiumUserStatusDialogSubtitle)));
        } else if (this.isEmojiStatus) {
            LinkSpanDrawable.LinksTextView linksTextView = linksTextViewArr[0];
            int i3 = C3630R.string.TelegramPremiumUserStatusDefaultDialogTitle;
            ...
            int i4 = C3630R.string.TelegramPremiumUserStatusDialogSubtitle;
            ...
            if (giftTier != null) {
                if (this.isOutboundGift) {
                    ...
                    int i5 = C3630R.string.TelegramPremiumUserGiftedPremiumOutboundDialogTitleWithPlural;
                    ...
                    int i7 = C3630R.string.TelegramPremiumUserGiftedPremiumOutboundDialogSubtitle;
                ...
                if (tLRPC$User6 != null && !TextUtils.isEmpty(tLRPC$User6.first_name)) {
                    ...
                    if (tLRPC$User7.f1762id != 777000) {
                        this.titleView[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3630R.string.TelegramPremiumUserGiftedPremiumDialogTitleWithPlural, tLRPC$User7.first_name, LocaleController.formatPluralString("GiftMonths", this.giftTier.getMonths(), new Object[0])), Theme.key_windowBackgroundWhiteBlueButton, 0, null));
                        this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle)));
                        return;
                    }
                }
                this.titleView[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3630R.string.TelegramPremiumUserGiftedPremiumDialogTitleWithPluralSomeone, LocaleController.formatPluralString("GiftMonths", this.giftTier.getMonths(), new Object[0])), Theme.key_windowBackgroundWhiteBlueButton, 0, null));
                this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle)));
                return;
            }
            LinkSpanDrawable.LinksTextView linksTextView3 = linksTextViewArr[0];
            int i8 = C3630R.string.TelegramPremiumUserDialogTitle;
            ...
            this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3630R.string.TelegramPremiumUserDialogSubtitle)));
        }
    }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString("TelegramPremium", C3630R.string.TelegramPremium);
    }
            ...
            if (i == 0) {
                ...
                if (PremiumPreviewBottomSheet.this.titleViewContainer == null) {
                    ...
                    while (i3 < 2) {
                        ...
                        PremiumPreviewBottomSheet.this.titleView[i3].setTextColor(PremiumPreviewBottomSheet.this.getThemedColor(Theme.key_windowBackgroundWhiteBlackText));
                        PremiumPreviewBottomSheet.this.titleView[i3].setLinkTextColor(PremiumPreviewBottomSheet.this.getThemedColor(Theme.key_windowBackgroundWhiteLinkText));
                ...
                PremiumPreviewBottomSheet.this.starParticlesView = new StarParticlesView(this, context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.4
                    ...
                    public void onMeasure(int i4, int i5) {
                        ...
                        this.drawable.rect2.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m102dp(52));
                    }
                };
                ...
                view = new View(this, context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.7
                    @Override // android.view.View
                    protected void onMeasure(int i4, int i5) {
                        super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(68), 1073741824));
                    }
                };
            } else if (i != 4) {
                view = new PremiumFeatureCell(context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.6
                    ...
                    public void dispatchDraw(Canvas canvas2) {
                        ...
                        canvas2.drawRoundRect(rectF, AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(8), PremiumPreviewBottomSheet.this.gradientTools.paint);
                        super.dispatchDraw(canvas2);
                    }
                };
            } else {
    ...
    public boolean onCustomOpenAnimation() {
        ...
        this.enterAnimator.addListener(new C53674());
    ...
    /* loaded from: classes6.dex */
    public class C53674 extends AnimatorListenerAdapter {
        C53674() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$4$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    PremiumPreviewBottomSheet.C53674.this.lambda$onAnimationEnd$0(rightDrawable, valueAnimator);
                }
            });
            ofInt.start();
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.groupStickersDidLoad && (tLRPC$InputStickerSet = this.statusStickerSet) != null && tLRPC$InputStickerSet.f1623id == ((Long) objArr[0]).longValue()) {
            setTitle(true);
        }
    }
}
