...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public void scrollTo(ChatObject.VideoParticipant videoParticipant, RecyclerListView recyclerListView) {
        ...
        for (int i = 0; i < this.videoParticipants.size(); i++) {
            if (this.videoParticipants.get(i).equals(videoParticipant)) {
                linearLayoutManager.scrollToPositionWithOffset(i, AndroidUtilities.m102dp(13));
                return;
            }
        }
    }
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        public GroupCallUserCell(Context context) {
            ...
            this.avatarWavesDrawable = new GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.m102dp(26), AndroidUtilities.m102dp(29));
            this.avatarDrawable.setTextSize((int) (AndroidUtilities.m102dp(18) / 1.15f));
            ...
            this.selectionPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.name != null) {
                int min = (int) Math.min(AndroidUtilities.m102dp(46), this.textPaint.measureText(this.name));
                this.nameWidth = min;
                this.drawingName = TextUtils.ellipsize(this.name, this.textPaint, min, TextUtils.TruncateAt.END).toString();
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(80), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(80), 1073741824));
        }
        ...
        public void setProgressToFullscreen(float f) {
            ...
            float f2 = 1.0f - f;
            float m102dp = ((AndroidUtilities.m102dp(46) / AndroidUtilities.m102dp(40)) * f2) + (1.0f * f);
            this.avatarImageView.setTranslationY((-top) * f2);
            this.avatarImageView.setScaleX(m102dp);
            this.avatarImageView.setScaleY(m102dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.progress > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(13), AndroidUtilities.m102dp(13), this.backgroundPaint);
                drawSelection(canvas);
            }
            ...
            float m102dp = AndroidUtilities.m102dp(46) / AndroidUtilities.m102dp(40);
            float f = this.progress;
            float f2 = (m102dp * (1.0f - f)) + (f * 1.0f);
        ...
        */
        private void drawSelection(android.graphics.Canvas r7) {
            ...
            L78:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.drawSelection(android.graphics.Canvas):void");
        }
        ...
        public void drawOverlays(Canvas canvas) {
            if (this.drawingName != null) {
                canvas.save();
                int measuredWidth = ((getMeasuredWidth() - this.nameWidth) - AndroidUtilities.m102dp(24)) / 2;
                this.textPaint.setAlpha((int) (this.progress * 255.0f * getAlpha()));
                canvas.drawText(this.drawingName, AndroidUtilities.m102dp(22) + measuredWidth, AndroidUtilities.m102dp(69), this.textPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(measuredWidth, AndroidUtilities.m102dp(53));
        ...
        */
        public void updateState(boolean r10) {
            ...
            L18:
                ...
                goto L16
            L27:
                int r0 = org.telegram.p042ui.ActionBar.Theme.key_voipgroup_nameText
                int r0 = org.telegram.p042ui.ActionBar.Theme.getColor(r0)
                int r1 = org.telegram.p042ui.ActionBar.Theme.key_voipgroup_listeningText
                int r1 = org.telegram.p042ui.ActionBar.Theme.getColor(r1)
            L33:
                if (r10 != 0) goto L6c
            ...
            L97:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.updateState(boolean):void");
        }
