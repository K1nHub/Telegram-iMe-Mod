...
public class DialogsItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
            ...
            if (view == dialogCell2) {
                ...
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.DialogsItemAnimator.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        dialogCell.setClipProgress(BitmapDescriptorFactory.HUE_RED);
                        if (Build.VERSION.SDK_INT >= 21) {
                            dialogCell.setElevation(BitmapDescriptorFactory.HUE_RED);
                        }
        ...
        animate.setDuration(180L).alpha(BitmapDescriptorFactory.HUE_RED).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.DialogsItemAnimator.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
                DialogsItemAnimator.this.dispatchRemoveStarting(viewHolder);
            }
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        ...
        if (this.mPendingAdditions.size() > 2) {
            for (int i = 0; i < this.mPendingAdditions.size(); i++) {
                this.mPendingAdditions.get(i).itemView.setAlpha(BitmapDescriptorFactory.HUE_RED);
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo, int i, int i2, int i3, int i4) {
        if (viewHolder.itemView instanceof DialogCell) {
            ...
            viewHolder2.itemView.setTranslationX(BitmapDescriptorFactory.HUE_RED);
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(viewHolder.itemView, View.ALPHA, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(viewHolder2.itemView, View.ALPHA, 1.0f));
    ...
    public void endAnimation(RecyclerView.ViewHolder viewHolder) {
        ...
        if (this.mPendingRemovals.remove(viewHolder)) {
            if (view instanceof DialogCell) {
                ((DialogCell) view).setClipProgress(BitmapDescriptorFactory.HUE_RED);
            } else {
                view.setAlpha(1.0f);
            }
    ...
    public void endAnimations() {
        ...
        while (true) {
            ...
            if (view3 instanceof DialogCell) {
                ((DialogCell) view3).setClipProgress(BitmapDescriptorFactory.HUE_RED);
            } else {
                view3.setAlpha(1.0f);
            }
            ...
            for (int size7 = this.mAdditionsList.size() - 1; size7 >= 0; size7--) {
                ...
                for (int size8 = arrayList2.size() - 1; size8 >= 0; size8--) {
                    ...
                    if (view5 instanceof DialogCell) {
                        ((DialogCell) view5).setClipProgress(BitmapDescriptorFactory.HUE_RED);
                    } else {
                        view5.setAlpha(1.0f);
                    }
