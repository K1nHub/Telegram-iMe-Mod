...
public class ItemOptions {
    ...
    public ItemOptions add(int i, CharSequence charSequence, int i2, int i3, final Runnable runnable, boolean z, boolean z2) {
        ...
        if (this.context != null && z) {
            ...
            actionBarMenuSubItem.setPadding(AndroidUtilities.m102dp(18), 0, AndroidUtilities.m102dp((LocaleController.isRTL ? 0 : 8) + 18), 0);
            ...
            if (i4 > 0) {
                actionBarMenuSubItem.setMinimumWidth(AndroidUtilities.m102dp(i4));
                this.lastLayout.addView((View) actionBarMenuSubItem, intValue, LayoutHelper.createLinear(this.minWidthDp, -2));
            } else {
                this.lastLayout.addView((View) actionBarMenuSubItem, intValue, LayoutHelper.createLinear(-1, -2));
            }
        }
        return this;
    }
    ...
    public ItemOptions putPremiumLock(final Runnable runnable) {
        if (runnable != null && this.context != null && this.lastLayout.getItemsCount() > 0) {
            ...
            actionBarMenuSubItem.setRightIcon(C3630R.C3632drawable.msg_mini_lock3);
    ...
    public ItemOptions putCheck() {
        if (this.context != null && this.lastLayout.getItemsCount() > 0) {
            ...
            ActionBarMenuSubItem actionBarMenuSubItem = (ActionBarMenuSubItem) itemAt;
            actionBarMenuSubItem.setRightIcon(C3630R.C3632drawable.msg_text_check);
    ...
    public ItemOptions addView(View view) {
        ...
        view.setTag(C3630R.C3633id.fit_width_tag, 1);
    ...
    public ItemOptions setBlurBackground(BlurringShader.BlurManager blurManager, float f, float f2) {
        Drawable mutate = this.context.getResources().getDrawable(C3630R.C3632drawable.popup_fixed_alert2).mutate();
        ViewGroup viewGroup = this.layout;
        if (viewGroup instanceof ActionBarPopupWindow.ActionBarPopupWindowLayout) {
            viewGroup.setBackgroundDrawable(new BlurringShader.StoryBlurDrawer(blurManager, viewGroup, 5).makeDrawable(this.offsetX + f + this.layout.getX(), this.offsetY + f2 + this.layout.getY(), mutate, AndroidUtilities.m102dp(6)));
        } else {
            for (int i = 0; i < this.layout.getChildCount(); i++) {
                View childAt = this.layout.getChildAt(i);
                if (childAt instanceof ActionBarPopupWindow.ActionBarPopupWindowLayout) {
                    childAt.setBackgroundDrawable(new BlurringShader.StoryBlurDrawer(blurManager, childAt, 5).makeDrawable(this.offsetX + f + this.layout.getX() + childAt.getX(), this.offsetY + f2 + this.layout.getY() + childAt.getY(), mutate, AndroidUtilities.m102dp(6)));
                }
            }
        }
        return this;
    ...
    public ItemOptions show() {
        ...
        if (this.actionBarPopupWindow == null && getItemsCount() > 0) {
                ...
                while (i2 < this.layout.getChildCount() - 1) {
                    ...
                    if (childAt2 instanceof ActionBarPopupWindow.ActionBarPopupWindowLayout) {
                        ...
                        for (int i3 = 0; i3 < actionBarPopupWindowLayout2.getItemsCount(); i3++) {
                            actionBarPopupWindowLayout2.getItemAt(i3).setMinimumWidth(AndroidUtilities.m102dp(this.minWidthDp));
                        }
                    }
                    i2++;
                }
            ...
            if (this.context != null && viewGroup != null) {
                ...
                if (this.scrimView != null) {
                    if (this.forceTop || this.layout.getMeasuredHeight() + f + AndroidUtilities.m102dp(16) > AndroidUtilities.displaySize.y) {
    ...
    public void dismissDim(final ViewGroup viewGroup) {
        ...
        this.dimView = null;
        view.animate().cancel();
        view.animate().alpha(BitmapDescriptorFactory.HUE_RED).setDuration(150L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ItemOptions.3
