...
public class RecordStatusDrawable extends StatusDrawable {
    ...
    public RecordStatusDrawable(boolean z) {
        if (z) {
            ...
            this.currentPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        int i = 2;
        if (paint.getStrokeWidth() != AndroidUtilities.m102dp(2)) {
        ...
        canvas.translate(BitmapDescriptorFactory.HUE_RED, intrinsicHeight + AndroidUtilities.m102dp(i));
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            float m102dp = (AndroidUtilities.m102dp(4) * i2) + (AndroidUtilities.m102dp(4) * this.progress);
            float f = -m102dp;
            this.rect.set(f, f, m102dp, m102dp);
