...
public class ArchiveHelp extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ArchiveHelp(Context context, int i, Theme.ResourcesProvider resourcesProvider, Runnable runnable, final Runnable runnable2) {
        ...
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m102dp(80), Theme.getColor(Theme.key_avatar_backgroundSaved, resourcesProvider)));
        imageView.setImageResource(C3630R.C3632drawable.large_archive);
        ...
        textView.setText(LocaleController.getString("ArchiveHintHeader1", C3630R.string.ArchiveHintHeader1));
        ...
        linearLayout.addView(makeHint(C3630R.C3632drawable.msg_archive_archive, LocaleController.getString("ArchiveHintSection1"), LocaleController.getString("ArchiveHintSection1Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        linearLayout.addView(makeHint(C3630R.C3632drawable.msg_archive_hide, LocaleController.getString("ArchiveHintSection2"), LocaleController.getString("ArchiveHintSection2Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        linearLayout.addView(makeHint(C3630R.C3632drawable.msg_archive_stories, LocaleController.getString("ArchiveHintSection3"), LocaleController.getString("ArchiveHintSection3Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        if (runnable2 != null) {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m102dp(400), View.MeasureSpec.getSize(i)), 1073741824), i2);
    }
    ...
    private void updateText() {
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.msg_arrowright).mutate();
        mutate.setColorFilter(new PorterDuffColorFilter(i, PorterDuff.Mode.SRC_IN));
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(mutate);
        coloredImageSpan.setColorKey(i);
        coloredImageSpan.setSize(AndroidUtilities.m102dp(18));
        coloredImageSpan.setWidth(AndroidUtilities.m102dp(11));
        coloredImageSpan.setTranslateX(-AndroidUtilities.m102dp(5));
    ...
    private FrameLayout makeHint(int i, CharSequence charSequence, CharSequence charSequence2, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView.setTextSize(0, AndroidUtilities.m102dp(14));
