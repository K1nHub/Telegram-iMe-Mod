...
import org.telegram.p042ui.Adapters.SearchAdapterHelper;
import org.telegram.p042ui.ArticleViewer;
import org.telegram.p042ui.Cells.ChatActionCell;
import org.telegram.p042ui.Cells.ContextLinkCell;
...
import org.telegram.p042ui.Cells.ManageChatUserCell;
import org.telegram.p042ui.Cells.ProfileSearchCell;
import org.telegram.p042ui.Cells.SharedAudioCell;
import org.telegram.p042ui.Cells.SharedDocumentCell;
import org.telegram.p042ui.Cells.SharedLinkCell;
import org.telegram.p042ui.Cells.SharedMediaSectionCell;
import org.telegram.p042ui.Cells.SharedPhotoVideoCell;
...
public class SharedMediaLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setMembersMenuVisible(boolean z, GroupMembersFilter groupMembersFilter) {
        ...
        if (z) {
            ...
            Drawable mutate = ContextCompat.getDrawable(context, groupMembersFilter == groupMembersFilter2 ? C3630R.C3632drawable.ic_ab_other : C3630R.C3632drawable.msg_delete).mutate();
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (viewHolder.getItemViewType() == IdFabric$ViewTypes.TEXT_INFO_PRIVACY_CELL) {
                ...
                if ((i == this.enableSectionRow && this.storiesController.isEnabled()) || i == this.storiesBarSectionRow) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.context, C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGray));
                    textInfoPrivacyCell.setFixedSize(12);
                    textInfoPrivacyCell.setText(null);
                    return;
                }
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.context, C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGray));
                textInfoPrivacyCell.setFixedSize(0);
                textInfoPrivacyCell.setText(LocaleController.getInternalString(C3630R.string.settings_stories_enable_hint));
            } else if (viewHolder.getItemViewType() == IdFabric$ViewTypes.HEADER_CELL) {
                HeaderCell headerCell = (HeaderCell) viewHolder.itemView;
                if (i == this.avatarsHeaderRow) {
                    headerCell.setText(LocaleController.getInternalString(C3630R.string.settings_stories_avatars));
                }
            } else if (viewHolder.getItemViewType() == IdFabric$ViewTypes.TEXT_CHECK_CELL) {
                TextCheckCell textCheckCell = (TextCheckCell) viewHolder.itemView;
                if (i == this.enableRow) {
                    textCheckCell.setType(1);
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3630R.string.settings_stories_enable), this.storiesController.isEnabled(), isNeedDivider);
                    return;
                }
                textCheckCell.setType(0);
                if (i == this.storiesBarRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3630R.string.settings_stories_bar), this.storiesController.isBarEnabled(), isNeedDivider);
                } else if (i == this.avatarsContactsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString("FilterContacts", C3630R.string.FilterContacts), this.storiesController.isContactsAvatarsEnabled(), isNeedDivider);
                } else if (i == this.avatarsChannelsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString("FilterChannels", C3630R.string.FilterChannels), this.storiesController.isChannelsAvatarsEnabled(), isNeedDivider);
                } else if (i == this.avatarsProfileRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString("PrivacyProfilePhoto", C3630R.string.PrivacyProfilePhoto), this.storiesController.isProfileAvatarEnabled(), isNeedDivider);
                }
            }
        }
        ...
        while (true) {
            ...
            if (mediaPageArr[i] != null && mediaPageArr[i].getVisibility() == 0) {
                for (int i2 = 0; i2 < this.mediaPages[i].listView.getChildCount(); i2++) {
                    ...
                    if (childAt.getY() < this.mediaPages[i].listView.blurTopPadding + AndroidUtilities.m102dp(100)) {
    ...
    public static class MediaPage extends FrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (fastScroll != null) {
                float scrollBarY = fastScroll.getScrollBarY() + AndroidUtilities.m102dp(36);
                if (this.selectedType == 9) {
                    scrollBarY += AndroidUtilities.m102dp(64);
                }
                ...
                this.fastScrollHintView.setTranslationX((getMeasuredWidth() - this.fastScrollHintView.getMeasuredWidth()) - AndroidUtilities.m102dp(16));
    ...
    public static class SharedMediaPreloader implements NotificationCenter.NotificationCenterDelegate {
        ...
        */
        public void didReceivedNotification(int r25, final int r26, java.lang.Object... r27) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.SharedMediaPreloader.didReceivedNotification(int, int, java.lang.Object[]):void");
        }
    ...
    public static class SharedMediaData {
        ...
        public void replaceMid(int i, int i2) {
            ...
            if (messageObject != null) {
                ...
                messageObject.messageOwner.f1624id = i2;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public SharedMediaLayout(android.content.Context r25, long r26, org.telegram.p042ui.Components.SharedMediaLayout.SharedMediaPreloader r28, int r29, java.util.ArrayList<java.lang.Integer> r30, org.telegram.tgnet.TLRPC$ChatFull r31, org.telegram.tgnet.TLRPC$UserFull r32, boolean r33, org.telegram.p042ui.ActionBar.BaseFragment r34, org.telegram.p042ui.Components.SharedMediaLayout.Delegate r35, int r36, org.telegram.p042ui.ActionBar.Theme.ResourcesProvider r37) {
        /*
            Method dump skipped, instructions count: 2774
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.<init>(android.content.Context, long, org.telegram.ui.Components.SharedMediaLayout$SharedMediaPreloader, int, java.util.ArrayList, org.telegram.tgnet.TLRPC$ChatFull, org.telegram.tgnet.TLRPC$UserFull, boolean, org.telegram.ui.ActionBar.BaseFragment, org.telegram.ui.Components.SharedMediaLayout$Delegate, int, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    /* loaded from: classes6.dex */
    public class View$OnClickListenerC55806 implements View.OnClickListener {
        final /* synthetic */ Context val$context;
        final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;

        View$OnClickListenerC55806(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onClick(View view) {
            ...
            ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(this, this.val$context, this.val$resourcesProvider) { // from class: org.telegram.ui.Components.SharedMediaLayout.6.1
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // org.telegram.p042ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout, android.widget.FrameLayout, android.view.View
                public void onMeasure(int i, int i2) {
                    if (dividerCell.getParent() != null) {
                        dividerCell.setVisibility(8);
                        super.onMeasure(i, i2);
                        dividerCell.getLayoutParams().width = getMeasuredWidth() - AndroidUtilities.m102dp(16);
            ...
            SharedMediaLayout.this.mediaZoomInItem.setTextAndIcon(LocaleController.getString("MediaZoomIn", C3630R.string.MediaZoomIn), C3630R.C3632drawable.msg_zoomin);
            SharedMediaLayout.this.mediaZoomInItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda1
                ...
                public final void onClick(View view2) {
                    SharedMediaLayout.View$OnClickListenerC55806.this.lambda$onClick$0(view2);
                }
            });
            actionBarPopupWindowLayout.addView(SharedMediaLayout.this.mediaZoomInItem);
            SharedMediaLayout.this.mediaZoomOutItem.setTextAndIcon(LocaleController.getString("MediaZoomOut", C3630R.string.MediaZoomOut), C3630R.C3632drawable.msg_zoomout);
            SharedMediaLayout.this.mediaZoomOutItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    SharedMediaLayout.View$OnClickListenerC55806.this.lambda$onClick$1(view2);
                }
            });
            ...
            if (!DialogObject.isEncryptedDialog(SharedMediaLayout.this.dialog_id)) {
                ...
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Calendar", C3630R.string.Calendar), C3630R.C3632drawable.msg_calendar2);
                ...
                if (SharedMediaLayout.this.info != null && !SharedMediaLayout.this.isStoriesView() && (chat = MessagesController.getInstance(SharedMediaLayout.this.profileActivity.getCurrentAccount()).getChat(Long.valueOf(SharedMediaLayout.this.info.f1601id))) != null && (tLRPC$TL_chatAdminRights = chat.admin_rights) != null && tLRPC$TL_chatAdminRights.edit_stories) {
                    ...
                    actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString(C3630R.string.OpenChannelArchiveStories), C3630R.C3632drawable.msg_archive);
                    actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            SharedMediaLayout.View$OnClickListenerC55806.this.lambda$onClick$2(view2);
                        }
                    });
                ...
                if (z2) {
                    ...
                    actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("MediaShowPhotos", C3630R.string.MediaShowPhotos), 0);
                    actionBarPopupWindowLayout.addView(actionBarMenuSubItem3);
                    actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("MediaShowVideos", C3630R.string.MediaShowVideos), 0);
                    ...
                    if (c != 0) {
                        ...
                        actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda4
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view2) {
                                SharedMediaLayout.View$OnClickListenerC55806.this.lambda$onClick$3(actionBarMenuSubItem4, actionBarMenuSubItem3, storiesAdapter, view2);
                            }
                        });
                        actionBarMenuSubItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda3
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view2) {
                                SharedMediaLayout.View$OnClickListenerC55806.this.lambda$onClick$4(actionBarMenuSubItem3, actionBarMenuSubItem4, storiesAdapter, view2);
                            }
                        });
                    } else {
            ...
            SharedMediaLayout sharedMediaLayout = SharedMediaLayout.this;
            sharedMediaLayout.optionsWindow = AlertsCreator.showPopupMenu(actionBarPopupWindowLayout, sharedMediaLayout.photoVideoOptionsItem, 0, -AndroidUtilities.m102dp(56));
        }
        ...
        public /* synthetic */ void lambda$onClick$2(View view) {
            ...
            bundle.putLong("dialog_id", -SharedMediaLayout.this.info.f1601id);
    ...
    public /* synthetic */ void lambda$new$11(MediaPage mediaPage, View view, int i, float f, float f2) {
        ...
        if (mediaPage.selectedType != 10) {
            if (mediaPage.selectedType != 7) {
                ...
                Bundle bundle = new Bundle();
                bundle.putLong("chat_id", chat.f1600id);
    ...
    */
    public void showMediaCalendar(int r10, boolean r11) {
        ...
        L22:
            ...
            r6 = 0
            org.telegram.ui.Components.ExtendedGridLayoutManager r11 = org.telegram.p042ui.Components.SharedMediaLayout.MediaPage.access$300(r11)
        ...
        L52:
            ...
            org.telegram.ui.Components.SharedMediaLayout$Period r8 = (org.telegram.p042ui.Components.SharedMediaLayout.Period) r8
            int r8 = r8.startOffset
            if (r11 > r8) goto L6a
            java.lang.Object r11 = r5.get(r7)
            org.telegram.ui.Components.SharedMediaLayout$Period r11 = (org.telegram.p042ui.Components.SharedMediaLayout.Period) r11
            r6 = r11
            goto L6d
        L6a:
            int r7 = r7 + 1
        ...
        L6d:
            ...
            r6 = r11
            org.telegram.ui.Components.SharedMediaLayout$Period r6 = (org.telegram.p042ui.Components.SharedMediaLayout.Period) r6
        L7b:
            if (r6 == 0) goto L80
            int r11 = r6.date
            goto L81
        ...
        L94:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.showMediaCalendar(int, boolean):void");
    }
    ...
    private void startPinchToMediaColumnsCount(boolean z) {
        ...
        mediaPage.animationSupportingListView.setPadding(mediaPage.animationSupportingListView.getPaddingLeft(), AndroidUtilities.m102dp(this.changeColumnsTab == 9 ? 66 : 2), mediaPage.animationSupportingListView.getPaddingRight(), mediaPage.animationSupportingListView.getPaddingBottom());
    ...
    private void animateToMediaColumnsCount(final int i) {
        ...
        if (mediaPage != null) {
            ...
            int m102dp2 = this.changeColumnsTab == 9 ? AndroidUtilities.m102dp(64) : 0;
            internalListView2.hintPaddingTop = m102dp2;
            internalListView.setPadding(paddingLeft, m102dp + m102dp2, mediaPage.animationSupportingListView.getPaddingRight(), mediaPage.animationSupportingListView.getPaddingBottom());
            ...
            */
            public void onPageScrolled(float r11) {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.C556627.onPageScrolled(float):void");
            }
        });
    ...
    public void hideFloatingDateView(boolean z) {
        ...
        if (z) {
            ...
            this.floatingDateAnimation.playTogether(ObjectAnimator.ofFloat(this.floatingDateView, View.ALPHA, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.floatingDateView, View.TRANSLATION_Y, (-AndroidUtilities.m102dp(48)) + this.additionalFloatingTranslation));
    ...
    public void scrollToTop() {
        ...
        if (i == 0) {
            ...
            if (i != 1 && i != 2) {
                if (i == 3) {
                    itemSize = AndroidUtilities.m102dp(100);
                } else if (i != 4) {
                    if (i == 5) {
                        itemSize = AndroidUtilities.m102dp(60);
                    } else {
                        itemSize = AndroidUtilities.m102dp(58);
                    }
                }
            }
            itemSize = AndroidUtilities.m102dp(56);
        }
            ...
            if (mediaPage.selectedType == 7) {
                ...
                if (mediaPage.selectedType != 9) {
                    if (mediaPage.selectedType != 6) {
                        ...
                        commonGroupsAdapter.getChats(((TLRPC$Chat) commonGroupsAdapter.chats.get(this.commonGroupsAdapter.chats.size() - 1)).f1600id, 100);
                        return;
                    }
                }
    ...
    public void onActionBarItemClick(View view, int i) {
        ...
        if (i == IdFabric$Menu.TOGGLE_MUSIC_PLAYLIST) {
            ...
            if (this.info != null) {
                TLRPC$Chat chat2 = this.profileActivity.getMessagesController().getChat(Long.valueOf(this.info.f1601id));
                if (this.profileActivity.getMessagesController().isChatNoForwards(chat2)) {
                    HintView hintView = this.fwdRestrictedHint;
                    if (hintView != null) {
                        hintView.setText((!ChatObject.isChannel(chat2) || chat2.megagroup) ? LocaleController.getString("ForwardsRestrictedInfoGroup", C3630R.string.ForwardsRestrictedInfoGroup) : LocaleController.getString("ForwardsRestrictedInfoChannel", C3630R.string.ForwardsRestrictedInfoChannel));
            ...
            if (hasNoforwardsMessage()) {
                ...
                if (hintView2 != null) {
                    hintView2.setText(LocaleController.getString("ForwardsRestrictedInfoBot", C3630R.string.ForwardsRestrictedInfoBot));
                    this.fwdRestrictedHint.showForView(view, true);
                }
            ...
            int i5 = this.topicId;
            if (i5 != 0) {
                ForumUtilities.applyTopic(chatActivity, MessagesStorage.TopicKey.m94of(dialogId, i5));
                bundle2.putInt("message_id", valueAt.getId());
            }
        ...
        if (arrayList.size() > 1 || ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId == this.profileActivity.getUserConfig().getClientUserId() || charSequence != null || dialogsActivity.isInMultiSelect()) {
            ...
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                ...
                if (charSequence != null) {
                    this.profileActivity.getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.m90of(charSequence.toString(), j, null, null, null, true, null, null, null, dialogsActivity.notify, dialogsActivity.scheduleDate, null, false, null));
                }
    ...
    public void setPadding(int i, int i2, int i3, int i4) {
        ...
        this.fragmentContextView.setTranslationY(AndroidUtilities.m102dp(isStoriesView() ? 0 : 48) + i2);
        this.additionalFloatingTranslation = i2;
        ChatActionCell chatActionCell = this.floatingDateView;
        chatActionCell.setTranslationY((chatActionCell.getTag() == null ? -AndroidUtilities.m102dp(48) : 0) + this.additionalFloatingTranslation);
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void setVisibleHeight(int i) {
        int max = Math.max(i, AndroidUtilities.m102dp(120));
    ...
    */
    public void didReceivedNotification(int r29, int r30, java.lang.Object... r31) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
    ...
    public void animateItemsEnter(RecyclerListView recyclerListView, int i, SparseBooleanArray sparseBooleanArray) {
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC557232(recyclerListView, sparseBooleanArray, view, i));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Components.SharedMediaLayout$32 */
    /* loaded from: classes6.dex */
    public class ViewTreeObserver$OnPreDrawListenerC557232 implements ViewTreeObserver.OnPreDrawListener {
        ...
        ViewTreeObserver$OnPreDrawListenerC557232(RecyclerListView recyclerListView, SparseBooleanArray sparseBooleanArray, View view, int i) {
                    ...
                    for (int i = 0; i < childCount; i++) {
                        ...
                        if (messageId != 0 && this.val$addedMesages.get(messageId, false)) {
                            ...
                            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$32$$ExternalSyntheticLambda0
                                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    SharedMediaLayout.ViewTreeObserver$OnPreDrawListenerC557232.this.lambda$onPreDraw$0(messageId, recyclerListView, valueAnimator);
                                }
                            });
                            ofFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SharedMediaLayout.32.1
                                ...
                                public void onAnimationEnd(Animator animator) {
                                    ...
                                    ViewTreeObserver$OnPreDrawListenerC557232.this.val$finalListView.invalidate();
                                }
                            });
                    ...
                    if (view != null && view.getParent() == null) {
                        ...
                        if (layoutManager != null) {
                            ...
                            ofFloat3.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SharedMediaLayout.32.2
                                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                                public void onAnimationEnd(Animator animator) {
                                    ViewTreeObserver$OnPreDrawListenerC557232.this.val$finalProgressView.setAlpha(1.0f);
                                    layoutManager.stopIgnoringView(ViewTreeObserver$OnPreDrawListenerC557232.this.val$finalProgressView);
                                    ViewTreeObserver$OnPreDrawListenerC557232 viewTreeObserver$OnPreDrawListenerC557232 = ViewTreeObserver$OnPreDrawListenerC557232.this;
                                    viewTreeObserver$OnPreDrawListenerC557232.val$finalListView.removeView(viewTreeObserver$OnPreDrawListenerC557232.val$finalProgressView);
                                }
                            });
                            ofFloat3.start();
                        }
    ...
    */
    private void updateTabs(boolean r17) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.updateTabs(boolean):void");
    }
    ...
    */
    public void switchToCurrentSelectedMode(boolean r30) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.switchToCurrentSelectedMode(boolean):void");
    }
    ...
    private boolean onItemLongClick(MessageObject messageObject, View view, int i) {
        ...
        if (this.addToPlaylistItem != null) {
            if (this.mediaPages[0].selectedType == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
                ...
                this.addToPlaylistItem.setIcon(this.cantAddToPlaylistCount == 0 ? C3630R.C3632drawable.msg_tone_add : C3630R.C3632drawable.msg_tone_off);
    ...
    private void onItemClick(int i, View view, MessageObject messageObject, int i2, int i3) {
        ...
        if (this.isActionModeShowed) {
            ...
            this.profileActivity.getOrCreateStoryViewer().open(getContext(), messageObject.getId(), storiesList, StoriesListPlaceProvider.m52of(this.mediaPages[i2].listView).with(new StoriesListPlaceProvider.LoadNextInterface() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda25
                @Override // org.telegram.p042ui.Stories.StoriesListPlaceProvider.LoadNextInterface
    ...
    /* loaded from: classes6.dex */
    public class C557735 implements SharedLinkCell.SharedLinkCellDelegate {
        C557735() {
        }

        @Override // org.telegram.p042ui.Cells.SharedLinkCell.SharedLinkCellDelegate
        ...
        public void onLinkPress(final String str, boolean z) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3630R.string.Open), LocaleController.getString("Copy", C3630R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$35$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    SharedMediaLayout.C557735.this.lambda$onLinkPress$0(str, dialogInterface, i);
                }
            });
    ...
    public class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        ...
        @Override // org.telegram.p042ui.Components.RecyclerListView.SectionsAdapter
            ...
            if (i == 1) {
                ...
                if (this.currentType == 4 && !SharedMediaLayout.this.audioCellCache.isEmpty()) {
                    ...
                    view2 = new SharedAudioCell(this.mContext, SharedMediaLayout.this.sharedMediaPreloader.isMusicType() ? IdFabric$CustomType.SHARED_AUDIO_CELL_MUSIC : 0, SharedMediaLayout.this.resourcesProvider) { // from class: org.telegram.ui.Components.SharedMediaLayout.SharedDocumentsAdapter.1
                        @Override // org.telegram.p042ui.Cells.SharedAudioCell
    ...
    public static View createEmptyStubView(Context context, int i, long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoMediaSecret", C3630R.string.NoMediaSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoMedia", C3630R.string.NoMedia));
            }
        } else if (i == 1) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedFilesSecret", C3630R.string.NoSharedFilesSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedFiles", C3630R.string.NoSharedFiles));
            }
        } else if (i == 2) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedVoiceSecret", C3630R.string.NoSharedVoiceSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedVoice", C3630R.string.NoSharedVoice));
            }
        } else if (i == 3) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedLinksSecret", C3630R.string.NoSharedLinksSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedLinks", C3630R.string.NoSharedLinks));
            }
        } else if (i == 4 || i == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedAudioSecret", C3630R.string.NoSharedAudioSecret));
            } else if (i == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
                emptyStubView.emptyTextView.setText(LocaleController.getInternalString(C3630R.string.music_playlist_empty_title));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedAudio", C3630R.string.NoSharedAudio));
            }
        } else if (i == 5) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedGifSecret", C3630R.string.NoSharedGifSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoGIFs", C3630R.string.NoGIFs));
            }
        } else if (i == 6) {
            emptyStubView.emptyImageView.setImageDrawable(null);
            emptyStubView.emptyTextView.setText(LocaleController.getString("NoGroupsInCommon", C3630R.string.NoGroupsInCommon));
        } else if (i == 7) {
            emptyStubView.emptyImageView.setImageDrawable(null);
            emptyStubView.emptyTextView.setText("");
            emptyStubView.emptyImageView.setImageResource(C3630R.C3632drawable.fork_members_tip);
            emptyStubView.emptyTextView.setText(LocaleController.getInternalString(C3630R.string.common_empty_state_title));
        }
    ...
    public static class EmptyStubView extends LinearLayout {
        ...
        public EmptyStubView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            textView.setPadding(AndroidUtilities.m102dp(40), 0, AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(128));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (AndroidUtilities.isTablet()) {
                this.emptyTextView.setPadding(AndroidUtilities.m102dp(40), 0, AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(128));
            } else if (rotation == 3 || rotation == 1) {
                this.emptyTextView.setPadding(AndroidUtilities.m102dp(40), 0, AndroidUtilities.m102dp(40), 0);
            } else {
                this.emptyTextView.setPadding(AndroidUtilities.m102dp(40), 0, AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(128));
            }
    ...
    public class MediaSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void queryServerSearch(final String str, final int i, long j) {
            ...
            tLRPC$TL_messages_search.f1714q = str;
        ...
        public /* synthetic */ void lambda$queryServerSearch$1(int i, final int i2, final String str, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (tLRPC$TL_error == null) {
                ...
                for (int i3 = 0; i3 < tLRPC$messages_Messages.messages.size(); i3++) {
                    ...
                    if (i == 0 || tLRPC$Message.f1624id <= i) {
                ...
                if (i == this.lastReqId) {
                    ...
                    for (int i2 = 0; i2 < SharedMediaLayout.this.mediaPages.length; i2++) {
                        if (SharedMediaLayout.this.mediaPages[i2].selectedType == this.currentType) {
                            if (this.searchesInProgress == 0 && itemCount2 == 0) {
                                SharedMediaLayout.this.mediaPages[i2].emptyView.title.setText(LocaleController.formatString("NoResultFoundFor", C3630R.string.NoResultFoundFor, str));
        ...
        public /* synthetic */ void lambda$updateSearchResults$4(ArrayList arrayList) {
            if (SharedMediaLayout.this.searching) {
                ...
                for (int i = 0; i < SharedMediaLayout.this.mediaPages.length; i++) {
                    if (SharedMediaLayout.this.mediaPages[i].selectedType == this.currentType) {
                        if (this.searchesInProgress == 0 && itemCount2 == 0) {
                            SharedMediaLayout.this.mediaPages[i].emptyView.title.setText(LocaleController.getString("NoResult", C3630R.string.NoResult));
    ...
    public class StoriesAdapter extends SharedPhotoVideoAdapter {
        ...
        @Override // org.telegram.p042ui.Components.SharedMediaLayout.SharedPhotoVideoAdapter, androidx.recyclerview.widget.RecyclerView.Adapter
        public int getItemViewType(int i) {
            return 0;
        }

        @Override // org.telegram.p042ui.Components.SharedMediaLayout.SharedPhotoVideoAdapter
        public int getTopOffset() {
            return 0;
        }

        @Override // org.telegram.p042ui.Components.SharedMediaLayout.SharedPhotoVideoAdapter, org.telegram.p042ui.Components.RecyclerListView.SelectionAdapter
        public boolean isEnabled(RecyclerView.ViewHolder viewHolder) {
            return false;
        }
        ...
        public void destroy() {
            StoriesController.StoriesList storiesList = this.storiesList;
            if (storiesList != null) {
                storiesList.unlink(this.f1939id);
            }
        }
        ...
        @Override // org.telegram.p042ui.Components.SharedMediaLayout.SharedPhotoVideoAdapter, org.telegram.p042ui.Components.RecyclerListView.FastScrollAdapter
        public int getTotalItemsCount() {
            return getItemCount();
        }
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r9, int r10) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.ChatUsersAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
    ...
    public class GroupUsersSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public GroupUsersSearchAdapter(Context context) {
            ...
            searchAdapterHelper.setDelegate(new SearchAdapterHelper.SearchAdapterHelperDelegate() { // from class: org.telegram.ui.Components.SharedMediaLayout$GroupUsersSearchAdapter$$ExternalSyntheticLambda4
                @Override // org.telegram.p042ui.Adapters.SearchAdapterHelper.SearchAdapterHelperDelegate
        ...
        public void search(final String str, boolean z) {
            ...
            this.searchAdapterHelper.queryServerSearch(null, true, false, true, false, false, ChatObject.isChannel(this.currentChat) ? this.currentChat.f1600id : 0L, false, 2, 0);
            notifyDataSetChanged();
            for (int i = 0; i < SharedMediaLayout.this.mediaPages.length; i++) {
        ...
        public /* synthetic */ void lambda$processSearch$3(final String str) {
            ...
            this.searchAdapterHelper.queryServerSearch(str, false, false, true, false, false, ChatObject.isChannel(this.currentChat) ? this.currentChat.f1600id : 0L, false, 2, 1);
        }
        ...
        */
        public /* synthetic */ void lambda$processSearch$2(java.lang.String r19, java.util.ArrayList r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.SharedMediaLayout.GroupUsersSearchAdapter.lambda$processSearch$2(java.lang.String, java.util.ArrayList):void");
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            manageChatUserCell.setDelegate(new ManageChatUserCell.ManageChatUserCellDelegate() { // from class: org.telegram.ui.Components.SharedMediaLayout$GroupUsersSearchAdapter$$ExternalSyntheticLambda5
                @Override // org.telegram.p042ui.Cells.ManageChatUserCell.ManageChatUserCellDelegate
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.fragmentContextView) {
            canvas.save();
            canvas.clipRect(0, this.mediaPages[0].getTop(), view.getMeasuredWidth(), this.mediaPages[0].getTop() + view.getMeasuredHeight() + AndroidUtilities.m102dp(12));
    ...
    public static class InternalListView extends BlurredRecyclerView implements StoriesListPlaceProvider.ClippedView {
        ...
        public void updateClip(int[] iArr) {
            iArr[0] = (getPaddingTop() - AndroidUtilities.m102dp(2)) - this.hintPaddingTop;
