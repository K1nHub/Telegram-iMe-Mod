    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate, Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.SharingLocationsAlert.1
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                getMeasuredWidth();
                int m102dp = AndroidUtilities.m102dp(56) + AndroidUtilities.m102dp(56) + 1 + (LocationController.getLocationsCount() * AndroidUtilities.m102dp(54));
                int i5 = size / 5;
                if (m102dp < i5 * 3) {
                ...
                if (SharingLocationsAlert.this.listView.getPaddingTop() != i4) {
                    ...
                    SharingLocationsAlert.this.listView.setPadding(0, i4, 0, AndroidUtilities.m102dp(8));
        ...
        pickerBottomLayout.cancelButton.setPadding(AndroidUtilities.m102dp(18), 0, AndroidUtilities.m102dp(18), 0);
        pickerBottomLayout.cancelButton.setTextColor(getThemedColor(Theme.key_text_RedBold));
        pickerBottomLayout.cancelButton.setText(LocaleController.getString("StopAllLocationSharings", C3630R.string.StopAllLocationSharings));
        ...
        pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString("Close", C3630R.string.Close).toUpperCase());
        pickerBottomLayout.doneButton.setPadding(AndroidUtilities.m102dp(18), 0, AndroidUtilities.m102dp(18), 0);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                sharingLiveLocationCell = new FrameLayout(this, this.context) { // from class: org.telegram.ui.Components.SharingLocationsAlert.ListAdapter.1
                    @Override // android.widget.FrameLayout, android.view.View
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(48) + 1, 1073741824));
                    }

                    @Override // android.view.View
                    protected void onDraw(Canvas canvas) {
                        canvas.drawLine(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(40), getMeasuredWidth(), AndroidUtilities.m102dp(40), Theme.dividerPaint);
                    }
                };
                ...
                SharingLocationsAlert.this.textView.setPadding(0, 0, 0, AndroidUtilities.m102dp(8));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1 && SharingLocationsAlert.this.textView != null) {
                    SharingLocationsAlert.this.textView.setText(LocaleController.formatString("SharingLiveLocationTitle", C3630R.string.SharingLiveLocationTitle, LocaleController.formatPluralString("Chats", LocationController.getLocationsCount(), new Object[0])));
                    return;
                }
                return;
            }
