...
/* renamed from: org.telegram.ui.Components.spoilers.SpoilerEffect2 */
...
public class SpoilerEffect2 {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.spoilers.SpoilerEffect2$SpoilerThread */
    /* loaded from: classes6.dex */
    public class SpoilerThread extends Thread {
        ...
        private void init() {
            ...
            if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
                ...
                if (eglCreateWindowSurface == null) {
                    ...
                    GLES31.glShaderSource(glCreateShader, RLottieDrawable.readRes(null, C3630R.raw.spoiler_vertex) + "\n// " + Math.random());
                    GLES31.glCompileShader(glCreateShader);
                    int[] iArr = new int[1];
                    GLES31.glGetShaderiv(glCreateShader, 35713, iArr, 0);
                    if (iArr[0] == 0) {
                        FileLog.m99e("SpoilerEffect2, compile vertex shader error: " + GLES31.glGetShaderInfoLog(glCreateShader));
                        GLES31.glDeleteShader(glCreateShader);
                        this.running = false;
                        return;
                    }
                    GLES31.glShaderSource(glCreateShader2, RLottieDrawable.readRes(null, C3630R.raw.spoiler_fragment) + "\n// " + Math.random());
                    GLES31.glCompileShader(glCreateShader2);
                    GLES31.glGetShaderiv(glCreateShader2, 35713, iArr, 0);
                    if (iArr[0] == 0) {
                        FileLog.m99e("SpoilerEffect2, compile fragment shader error: " + GLES31.glGetShaderInfoLog(glCreateShader2));
                    ...
                    if (iArr[0] == 0) {
                        FileLog.m99e("SpoilerEffect2, link draw program error: " + GLES31.glGetProgramInfoLog(this.drawProgram));
                        this.running = false;
                        return;
                    }
        ...
        private void drawFrame(float f) {
            ...
            float f2 = 0.65f * f;
            float f3 = this.f1959t + f2;
            this.f1959t = f3;
            if (f3 > 1000.0f) {
                this.f1959t = BitmapDescriptorFactory.HUE_RED;
            }
            ...
            GLES31.glVertexAttribPointer(3, 1, 5126, false, 24, 20);
            GLES31.glEnableVertexAttribArray(3);
            GLES31.glUniform1f(this.timeHandle, this.f1959t);
        ...
        private void checkGlErrors() {
            while (true) {
                ...
                FileLog.m99e("spoiler gles error " + glGetError);
            }
        }
    }
}
