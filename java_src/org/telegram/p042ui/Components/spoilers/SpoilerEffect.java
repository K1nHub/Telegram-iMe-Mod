...
public class SpoilerEffect extends Drawable {
    ...
    public SpoilerEffect() {
        ...
        for (int i = 0; i < ALPHAS.length; i++) {
            ...
            if (i == 0) {
                this.particlePaints[i].setStrokeWidth(AndroidUtilities.m103dp(1.4f));
                this.particlePaints[i].setStyle(Paint.Style.STROKE);
                this.particlePaints[i].setStrokeCap(Paint.Cap.ROUND);
            } else {
                this.particlePaints[i].setStrokeWidth(AndroidUtilities.m103dp(1.2f));
                this.particlePaints[i].setStyle(Paint.Style.STROKE);
                this.particlePaints[i].setStrokeCap(Paint.Cap.ROUND);
            }
        }
    ...
    public void updateMaxParticles() {
        int width = getBounds().width() / AndroidUtilities.m102dp(6);
    ...
    public void setBounds(int i, int i2, int i3, int i4) {
        ...
        while (it.hasNext()) {
            ...
            if (!getBounds().contains((int) next.f1957x, (int) next.f1958y)) {
                it.remove();
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.drawPoints) {
            ...
            while (i8 < this.particles.size()) {
                ...
                if (particle2.currentTime >= particle2.lifeTime || isOutOfBounds(i2, i3, i4, i5, particle2.f1957x, particle2.f1958y)) {
                    if (this.particlesPool.size() < this.maxParticles) {
            ...
            if (size < i9) {
                ...
                while (i10 < size2) {
                    ...
                    while (true) {
                        ...
                        i = size2;
                        f = f6;
                        if (isOutOfBounds(i2, i3, i4, i5, pop.f1957x, pop.f1958y) && i13 < 4) {
                            f6 = f;
                            pop = particle;
                            i12 = i13;
                            size2 = i;
            ...
            for (int length = this.enableAlpha ? 0 : ALPHAS.length - 1; length < ALPHAS.length; length++) {
                ...
                for (int i15 = 0; i15 < this.particles.size(); i15++) {
                    ...
                    if ((rectF == null || rectF.contains(particle3.f1957x, particle3.f1958y)) && (particle3.alpha == length || !this.enableAlpha)) {
                        float[][] fArr2 = this.particlePoints;
                        if (i14 < fArr2[length].length - 2) {
                            fArr2[length][i14] = particle3.f1957x;
                            this.particlePoints[length][i14 + 1] = particle3.f1958y;
                            i14 += 2;
                            if (particle3.f1957x < strokeWidth) {
                                float[][] fArr3 = this.particlePoints;
                                if (i14 < fArr3[length].length - 2) {
                                    fArr3[length][i14] = particle3.f1957x + this.bitmapSize;
                                    this.particlePoints[length][i14 + 1] = particle3.f1958y;
                                    i14 += 2;
                                }
                            }
                            if (particle3.f1957x > this.bitmapSize - strokeWidth) {
                                float[][] fArr4 = this.particlePoints;
                                if (i14 < fArr4[length].length - 2) {
                                    fArr4[length][i14] = particle3.f1957x - this.bitmapSize;
                                    this.particlePoints[length][i14 + 1] = particle3.f1958y;
                                    i14 += 2;
                                }
                            }
                            if (particle3.f1958y < strokeWidth) {
                                float[][] fArr5 = this.particlePoints;
                                if (i14 < fArr5[length].length - 2) {
                                    fArr5[length][i14] = particle3.f1957x;
                                    this.particlePoints[length][i14 + 1] = particle3.f1958y + this.bitmapSize;
                                    i14 += 2;
                                }
                            }
                            if (particle3.f1958y > this.bitmapSize - strokeWidth) {
                                float[][] fArr6 = this.particlePoints;
                                if (i14 < fArr6[length].length - 2) {
                                    fArr6[length][i14] = particle3.f1957x;
                                    this.particlePoints[length][i14 + 1] = particle3.f1958y - this.bitmapSize;
                                    i14 += 2;
                                }
                            }
    ...
    private boolean isOutOfBounds(int i, int i2, int i3, int i4, float f, float f2) {
        if (f < i || f > i3 || f2 < i2 + AndroidUtilities.m103dp(2.5f) || f2 > i4 - AndroidUtilities.m103dp(2.5f)) {
            return true;
        }
    ...
    private void generateRandomLocation(Particle particle, int i) {
        particle.f1957x = getBounds().left + (Utilities.fastRandom.nextFloat() * getBounds().width());
        particle.f1958y = getBounds().top + (Utilities.fastRandom.nextFloat() * getBounds().height());
    }
