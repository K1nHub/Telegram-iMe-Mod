...
/* renamed from: org.telegram.ui.Components.ReactionTabHolderView */
...
public class ReactionTabHolderView extends FrameLayout {
    ...
    public ReactionTabHolderView(Context context) {
        ...
        new Path();
        this.rect = new RectF();
        this.radius = AndroidUtilities.m102dp(32);
        View view = new View(context);
        this.overlaySelectorView = view;
        addView(view, LayoutHelper.createFrame(-1, -1));
        this.iconView = new ImageView(context);
        Drawable mutate = ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_reactions_filled).mutate();
