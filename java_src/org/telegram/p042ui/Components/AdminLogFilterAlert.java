...
import org.telegram.p042ui.Cells.CheckBoxUserCell;
...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    public AdminLogFilterAlert(Context context, TLRPC$TL_channelAdminLogEventsFilter tLRPC$TL_channelAdminLogEventsFilter, LongSparseArray<TLRPC$User> longSparseArray, boolean z) {
        ...
        if (longSparseArray != null) {
            this.selectedAdmins = longSparseArray.m1162clone();
        }
        this.isMegagroup = z;
        if (z) {
            i = 2;
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.AdminLogFilterAlert.1
            ...
            protected void onMeasure(int i9, int i10) {
                ...
                getMeasuredWidth();
                int m102dp = AndroidUtilities.m102dp(48) + ((AdminLogFilterAlert.this.isMegagroup ? 11 : 8) * AndroidUtilities.m102dp(48)) + ((BottomSheet) AdminLogFilterAlert.this).backgroundPaddingTop + AndroidUtilities.m102dp(17);
                if (AdminLogFilterAlert.this.currentAdmins != null) {
                    m102dp += ((AdminLogFilterAlert.this.currentAdmins.size() + 1) * AndroidUtilities.m102dp(48)) + AndroidUtilities.m102dp(20);
                }
                int i11 = size / 5;
                int i12 = ((float) m102dp) < ((float) i11) * 3.2f ? 0 : i11 * 2;
                if (i12 != 0 && m102dp < size) {
                    i12 -= size - m102dp;
                }
                if (i12 == 0) {
                ...
                super.onMeasure(i9, View.MeasureSpec.makeMeasureSpec(Math.min(m102dp, size), 1073741824));
            }
        ...
        this.saveButton.setTextAndIcon(LocaleController.getString("Save", C3630R.string.Save).toUpperCase(), 0);
        ...
        if (view instanceof TextCell) {
            ...
            if (this.selectedAdmins == null) {
                ...
                for (int i4 = 0; i4 < this.currentAdmins.size(); i4++) {
                    ...
                    this.selectedAdmins.put(user.f1762id, user);
                }
            }
            boolean isChecked2 = checkBoxUserCell.isChecked();
            TLRPC$User currentUser = checkBoxUserCell.getCurrentUser();
            if (isChecked2) {
                this.selectedAdmins.remove(currentUser.f1762id);
            } else {
                this.selectedAdmins.put(currentUser.f1762id, currentUser);
            }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (i == 0) {
                textCell.setTextAndCheck(LocaleController.getString("EventLogFilterAll", C3630R.string.EventLogFilterAll), AdminLogFilterAlert.this.currentFilter == null, true);
                ...
                if (i != AdminLogFilterAlert.this.adminsRow) {
                    if (i != AdminLogFilterAlert.this.membersRow) {
                        if (i == AdminLogFilterAlert.this.infoRow) {
                            if (AdminLogFilterAlert.this.isMegagroup) {
                                String string = LocaleController.getString("EventLogFilterGroupInfo", C3630R.string.EventLogFilterGroupInfo);
                            ...
                            String string2 = LocaleController.getString("EventLogFilterChannelInfo", C3630R.string.EventLogFilterChannelInfo);
                            if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.info) {
                                r1 = true;
                            }
                            ...
                            if (i != AdminLogFilterAlert.this.editRow) {
                                if (i != AdminLogFilterAlert.this.pinnedRow) {
                                    if (i == AdminLogFilterAlert.this.leavingRow) {
                                        textCell.setTextAndCheck(LocaleController.getString("EventLogFilterLeavingMembers", C3630R.string.EventLogFilterLeavingMembers), AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.leave, AdminLogFilterAlert.this.callsRow != -1);
                                        return;
                                        ...
                                        if (i != AdminLogFilterAlert.this.invitesRow) {
                                            if (i == AdminLogFilterAlert.this.allAdminsRow) {
                                                textCell.setTextAndCheck(LocaleController.getString("EventLogAllAdmins", C3630R.string.EventLogAllAdmins), AdminLogFilterAlert.this.selectedAdmins == null, true);
                                                return;
                                            }
                                            return;
                                        }
                                        String string3 = LocaleController.getString("EventLogFilterInvites", C3630R.string.EventLogFilterInvites);
                                        ...
                                        String string4 = LocaleController.getString("EventLogFilterCalls", C3630R.string.EventLogFilterCalls);
                                ...
                                String string5 = LocaleController.getString("EventLogFilterPinnedMessages", C3630R.string.EventLogFilterPinnedMessages);
                            ...
                            String string6 = LocaleController.getString("EventLogFilterEditedMessages", C3630R.string.EventLogFilterEditedMessages);
                            ...
                            String string7 = LocaleController.getString("EventLogFilterDeletedMessages", C3630R.string.EventLogFilterDeletedMessages);
                    ...
                    String string8 = LocaleController.getString("EventLogFilterNewMembers", C3630R.string.EventLogFilterNewMembers);
                ...
                String string9 = LocaleController.getString("EventLogFilterNewAdmins", C3630R.string.EventLogFilterNewAdmins);
                ...
                String string10 = LocaleController.getString("EventLogFilterNewRestrictions", C3630R.string.EventLogFilterNewRestrictions);
