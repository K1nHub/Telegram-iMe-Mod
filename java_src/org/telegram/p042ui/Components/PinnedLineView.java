...
public class PinnedLineView extends View {
    ...
    public PinnedLineView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.fadePaint.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(6), new int[]{-1, 0}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP));
        this.fadePaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        this.fadePaint2 = new Paint();
        this.fadePaint2.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(6), new int[]{0, -1}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.replaceInProgress) {
            ...
            measuredHeight = (getMeasuredHeight() - (m102dp * 2)) / Math.min(this.totalCount, 3);
        }
        ...
        if (this.replaceInProgress) {
            ...
            if (f < BitmapDescriptorFactory.HUE_RED) {
                ...
                float f7 = m102dp;
                if ((((this.totalCount - 1) * measuredHeight) + f7) - f < (getMeasuredHeight() - m102dp) - measuredHeight) {
                    f = (f7 + ((this.totalCount - 1) * measuredHeight)) - ((getMeasuredHeight() - m102dp) - measuredHeight);
                }
            }
        }
        ...
        if (z) {
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m102dp(6), this.fadePaint);
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, getMeasuredHeight() - AndroidUtilities.m102dp(6), getMeasuredWidth(), getMeasuredHeight(), this.fadePaint);
            canvas.translate(BitmapDescriptorFactory.HUE_RED, getMeasuredHeight() - AndroidUtilities.m102dp(6));
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m102dp(6), this.fadePaint2);
        }
    }
    ...
    public void set(int i, int i2, boolean z) {
        ...
        if (!z) {
            ...
            int m102dp2 = AndroidUtilities.m102dp(8) * 2;
            this.lineHFrom = (getMeasuredHeight() - m102dp2) / Math.min(this.totalCount, 3);
            this.lineHTo = (getMeasuredHeight() - m102dp2) / Math.min(i2, 3);
            ...
            if (f < BitmapDescriptorFactory.HUE_RED) {
                ...
                if ((((this.totalCount - 1) * i3) + m102dp) - f < (getMeasuredHeight() - m102dp) - i6) {
                    this.startOffsetFrom = (((this.totalCount - 1) * i6) + m102dp) - ((getMeasuredHeight() - m102dp) - this.lineHFrom);
                }
            }
            ...
            if (f2 < BitmapDescriptorFactory.HUE_RED) {
                ...
                int i7 = i2 - 1;
                int i8 = this.lineHTo;
                if (((i4 * i7) + m102dp) - f2 < (getMeasuredHeight() - m102dp) - i8) {
                    this.startOffsetTo = ((i7 * i8) + m102dp) - ((getMeasuredHeight() - m102dp) - this.lineHTo);
                }
            }
            this.animateFromPosition = this.selectedPosition;
            this.animateToPosition = i;
