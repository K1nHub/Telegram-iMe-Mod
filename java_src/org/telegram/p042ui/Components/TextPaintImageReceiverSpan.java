...
public class TextPaintImageReceiverSpan extends ReplacementSpan {
    ...
    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        if (fontMetricsInt != null) {
            if (this.alignTop) {
                int m102dp = (fontMetricsInt.descent - fontMetricsInt.ascent) - AndroidUtilities.m102dp(4);
                int i3 = this.height - m102dp;
                ...
                int m102dp2 = ((-this.height) / 2) - AndroidUtilities.m102dp(4);
                fontMetricsInt.ascent = m102dp2;
                fontMetricsInt.top = m102dp2;
                int i5 = this.height;
                int m102dp3 = (i5 - (i5 / 2)) - AndroidUtilities.m102dp(4);
                fontMetricsInt.descent = m102dp3;
                fontMetricsInt.bottom = m102dp3;
            }
        }
        return this.width;
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (this.alignTop) {
            ...
            int i6 = this.height;
            this.imageReceiver.setImageCoords((int) f, i3 + ((((i5 - AndroidUtilities.m102dp(4)) - i3) - i6) / 2), this.width, i6);
        }
