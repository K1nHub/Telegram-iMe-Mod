...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView {
    ...
    public ScrollSlidingTextTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.tabsContainer.setPadding(AndroidUtilities.m102dp(7), 0, AndroidUtilities.m102dp(7), 0);
    ...
    public void addTextTab(final int i, CharSequence charSequence, SparseArray<View> sparseArray) {
        ...
        if (textView == null) {
            ...
            textView.setPadding(AndroidUtilities.m102dp(16), 0, AndroidUtilities.m102dp(16), 0);
    ...
    protected void onMeasure(int i, int i2) {
        int size = View.MeasureSpec.getSize(i) - AndroidUtilities.m102dp(22);
        int childCount = this.tabsContainer.getChildCount();
    ...
    private void scrollToChild(int i) {
        ...
        if (left - AndroidUtilities.m102dp(50) < scrollX) {
            smoothScrollTo(left - AndroidUtilities.m102dp(50), 0);
            return;
        }
        int i2 = left + measuredWidth;
        if (AndroidUtilities.m102dp(21) + i2 > scrollX + getWidth()) {
            smoothScrollTo(i2, 0);
        }
    }
    ...
    private int getChildWidth(TextView textView) {
        ...
        if (layout != null) {
            return ((int) Math.ceil(layout.getLineWidth(0))) + AndroidUtilities.m102dp(2);
        }
