...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(Context context, TLObject tLObject, String str, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m102dp(45));
        ...
        if (tLRPC$ChatInvite != null) {
            ...
            TLRPC$ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.currentChat.f1600id);
        ...
        if (tLRPC$ChatInvite6 == null || tLRPC$ChatInvite6.request_needed) {
            ...
            this.requestProgressView.setSize(AndroidUtilities.m102dp(32));
            ...
            textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), getThemedColor(i8), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
            ...
            if (z6) {
                i3 = C3630R.string.RequestToJoinChannel;
                str3 = "RequestToJoinChannel";
            } else {
                i3 = C3630R.string.RequestToJoinGroup;
            ...
            if (z6) {
                i4 = C3630R.string.RequestToJoinChannelDescription;
                str4 = "RequestToJoinChannelDescription";
            } else {
                i4 = C3630R.string.RequestToJoinGroupDescription;
            ...
            if (tLRPC$ChatInvite6.participants.isEmpty()) {
                ...
                avatarsImageView.setAvatarsTextSize(AndroidUtilities.m102dp(20));
                avatarsImageView.setSize(AndroidUtilities.m102dp(38));
                ...
                if (min == 1) {
                    ...
                    z4 = false;
                    if (min == 2) {
                        format = LocaleController.formatString("RequestToJoinMembersTwo", C3630R.string.RequestToJoinMembersTwo, ellipsize(textView6, this.chatInvite, 0), ellipsize(textView6, this.chatInvite, 1));
                    } else {
                        if (i2 == 3) {
                            format = LocaleController.formatString("RequestToJoinMembersThree", C3630R.string.RequestToJoinMembersThree, ellipsize(textView6, this.chatInvite, 0), ellipsize(textView6, this.chatInvite, 1), ellipsize(textView6, this.chatInvite, 2));
                            z3 = false;
                        } else {
            ...
            textView7.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
            textView7.setEllipsize(TextUtils.TruncateAt.END);
            textView7.setGravity(17);
            textView7.setSingleLine(true);
            if (z8) {
                i5 = C3630R.string.ProfileJoinChannel;
                str5 = "ProfileJoinChannel";
            } else {
                i5 = C3630R.string.ProfileJoinGroup;
    ...
    public /* synthetic */ void lambda$new$7(final boolean z, View view) {
        ...
        if (this.chatInvite == null && this.currentChat != null) {
            MessagesController.getInstance(this.currentAccount).addUserToChat(this.currentChat.f1600id, UserConfig.getInstance(this.currentAccount).getCurrentUser(), 0, null, null, true, new Runnable() { // from class: org.telegram.ui.Components.JoinGroupAlert$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static void showBulletin(Context context, BaseFragment baseFragment, boolean z) {
        ...
        twoLineLottieLayout.imageView.setAnimation(C3630R.raw.timer_3, 28, 28);
        twoLineLottieLayout.titleTextView.setText(LocaleController.getString("RequestToJoinSent", C3630R.string.RequestToJoinSent));
        if (z) {
            string = LocaleController.getString("RequestToJoinChannelSentDescription", C3630R.string.RequestToJoinChannelSentDescription);
        } else {
            string = LocaleController.getString("RequestToJoinGroupSentDescription", C3630R.string.RequestToJoinGroupSentDescription);
        }
    ...
    private CharSequence ellipsize(TextView textView, TLRPC$ChatInvite tLRPC$ChatInvite, int i) {
        ...
        return TextUtils.ellipsize(str.trim(), textView.getPaint(), AndroidUtilities.m102dp(120), TextUtils.TruncateAt.END);
    }
