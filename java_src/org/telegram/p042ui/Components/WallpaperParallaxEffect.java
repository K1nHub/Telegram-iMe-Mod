...
public class WallpaperParallaxEffect implements SensorEventListener {
    ...
    public WallpaperParallaxEffect(Context context) {
        this.f1956wm = (WindowManager) context.getSystemService("window");
    ...
    public float getScale(int i, int i2) {
        float f = i;
        float m102dp = AndroidUtilities.m102dp(16) * 2;
        float f2 = (f + m102dp) / f;
        float f3 = i2;
        return Math.max(f2, (m102dp + f3) / f3);
    }
    ...
    */
    public void onSensorChanged(android.hardware.SensorEvent r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.WallpaperParallaxEffect.onSensorChanged(android.hardware.SensorEvent):void");
    }
}
