...
public class SlideChooseView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(74), 1073741824));
        this.circleSize = AndroidUtilities.m102dp(6);
        this.gapSize = AndroidUtilities.m102dp(2);
        this.sideSide = AndroidUtilities.m102dp(22);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m102dp(11);
        int i4 = 0;
        while (i4 < this.optionsStr.length) {
            ...
            canvas.drawCircle(i8, f11, AndroidUtilities.lerp(this.circleSize / 2, AndroidUtilities.m102dp(6), max), this.paint);
            if (i4 != 0) {
                ...
                if (i12 != -1 && i4 - 1 >= i12) {
                    int m102dp3 = i11 + AndroidUtilities.m102dp(3);
                    int m102dp4 = (i10 - AndroidUtilities.m102dp(3)) / AndroidUtilities.m102dp(13);
                    if (this.lastDash != m102dp4) {
                        f4 = max;
                        i2 = i8;
                        i3 = 1;
                        this.linePaint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m102dp(6), (m102dp2 - (AndroidUtilities.m102dp(8) * m102dp4)) / (m102dp4 - 1)}, BitmapDescriptorFactory.HUE_RED));
                        this.lastDash = m102dp4;
                    } else {
                        f4 = max;
                        i2 = i8;
                        i3 = 1;
                    ...
                    f = f4;
                    i = i2;
                    canvas.drawLine(AndroidUtilities.m102dp(i3) + m102dp3, f11, (m102dp3 + m102dp2) - AndroidUtilities.m102dp(i3), f11, this.linePaint);
                    f2 = 1.0f;
                    ...
                    int m102dp5 = (int) (i10 - (AndroidUtilities.m102dp(3) * MathUtils.clamp(1.0f - Math.min(Math.abs(f10), Math.abs(f12)), (float) BitmapDescriptorFactory.HUE_RED, 1.0f)));
                    f3 = 0.0f;
                    canvas.drawRect((int) (i11 + (AndroidUtilities.m102dp(3) * clamp)), measuredHeight - AndroidUtilities.m102dp(1), m102dp + m102dp5, AndroidUtilities.m102dp(1) + measuredHeight, this.paint);
                }
            } else {
                f = max;
                i = i8;
            ...
            if (i4 == 0) {
                canvas.drawText(str, AndroidUtilities.m102dp(22), AndroidUtilities.m102dp(28), this.textPaint);
            } else if (i4 == this.optionsStr.length - 1) {
                canvas.drawText(str, (getMeasuredWidth() - i13) - AndroidUtilities.m102dp(22), AndroidUtilities.m102dp(28), this.textPaint);
            } else {
                canvas.drawText(str, i - (i13 / 2), AndroidUtilities.m102dp(28), this.textPaint);
            }
            i4++;
            f7 = f2;
            f6 = f3;
        ...
        canvas.drawCircle(f13, f14, AndroidUtilities.m103dp(f8 * 12.0f), this.paint);
        this.paint.setColor(getThemedColor(i16));
        canvas.drawCircle(f13, f14, AndroidUtilities.m102dp(6), this.paint);
    }
