...
import org.telegram.p042ui.Components.BotCommandsMenuView;
...
public class ChatActivityEnterView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate {
    ...
    public int[] getLocationVideoMessagePopup() {
        ...
        if (this.keyboardVisible) {
            ...
            if (measuredHeight > AndroidUtilities.m102dp((view == null || view.getVisibility() != 0) ? 58 : 106)) {
                iArr[1] = iArr[1] + this.audioVideoSendButton.getMeasuredHeight();
                return iArr;
            }
        }
        iArr[1] = iArr[1] - AndroidUtilities.m102dp(2);
        return iArr;
    }
    ...
    @Override // org.telegram.p042ui.Components.StickersAlert.StickersAlertDelegate
    ...
    public void showChooseCameraPopup() {
        ...
        this.videoMessageCameraOptions.setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m102dp(42), this.backgroundColor)).add(C3630R.C3632drawable.fork_ic_front_camera_24, LocaleController.getInternalString(C3630R.string.frontal_camera_popup_text), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda54
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$showChooseCameraPopup$1();
            }
        }).add(C3630R.C3632drawable.fork_ic_back_camera_24, LocaleController.getInternalString(C3630R.string.main_camera_popup_text), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda63
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$showChooseCameraPopup$3();
            }
        }).translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m102dp(5)).show();
    }
    ...
    public void updateFormattingButton() {
        ...
        if (this.accountInstance.getFormattingTextController().getFormattingPanelType() == FormattingPanelType.ALTERNATIVE_WEB) {
            ...
            this.formattingIcon.setImageResource(C3630R.C3632drawable.fork_formatting_messages);
            ...
            this.formattingIcon.setImageResource(C3630R.C3632drawable.input_keyboard);
        } else {
            this.formattingIcon.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chat_messagePanelIcons), PorterDuff.Mode.SRC_IN));
            this.formattingIcon.setImageResource(C3630R.C3632drawable.fork_formatting_messages);
        }
    ...
    public class RecordDot extends View {
        ...
        public RecordDot(Context context) {
            ...
            int i = C3630R.raw.chat_audio_record_delete;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m102dp(28), AndroidUtilities.m102dp(28), false, null);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!this.playing || !this.drawable.hasBitmap()) {
                canvas.drawCircle(getMeasuredWidth() >> 1, getMeasuredHeight() >> 1, AndroidUtilities.m102dp(5), ChatActivityEnterView.this.redDotPaint);
            }
            invalidate();
        }
    ...
    public class RecordCircle extends View {
        ...
        public RecordCircle(Context context) {
            ...
            this.circleRadiusAmplitude = AndroidUtilities.m102dp(30);
            ...
            this.tinyWaveDrawable.minRadius = AndroidUtilities.m102dp(47);
            this.tinyWaveDrawable.maxRadius = AndroidUtilities.m102dp(55);
            this.tinyWaveDrawable.generateBlob();
            this.bigWaveDrawable.minRadius = AndroidUtilities.m102dp(47);
            this.bigWaveDrawable.maxRadius = AndroidUtilities.m102dp(55);
            ...
            r5.lockShadowDrawable = getResources().getDrawable(C3630R.C3632drawable.lock_round_shadow);
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m102dp(5), r5.getThemedColor(Theme.key_chat_gifSaveHintBackground));
            this.tooltipPaint.setTextSize(AndroidUtilities.m102dp(14));
            this.tooltipBackgroundArrow = ContextCompat.getDrawable(context, C3630R.C3632drawable.tooltip_arrow);
            this.tooltipMessage = LocaleController.getString("SlideUpToLock", C3630R.string.SlideUpToLock);
        ...
        private void checkDrawables() {
            ...
            ChatActivityEnterView.this.micDrawable = getResources().getDrawable(C3630R.C3632drawable.input_mic_pressed).mutate();
            ...
            ChatActivityEnterView.this.cameraDrawable = getResources().getDrawable(C3630R.C3632drawable.input_video_pressed).mutate();
            ...
            ChatActivityEnterView.this.sendDrawable = getResources().getDrawable(C3630R.C3632drawable.attach_send).mutate();
            ...
            ChatActivityEnterView.this.micOutline = getResources().getDrawable(C3630R.C3632drawable.input_mic).mutate();
            ...
            ChatActivityEnterView.this.cameraOutline = getResources().getDrawable(C3630R.C3632drawable.input_video).mutate();
        ...
        public int setLockTranslation(float f) {
            if (f == 10000.0f) {
                ...
                this.lockAnimatedTranslation = f;
                invalidate();
                if (this.canceledByGesture || this.slideToCancelProgress < 0.7f || this.startTranslation - this.lockAnimatedTranslation < AndroidUtilities.m102dp(57)) {
                    return 1;
                }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int m102dp = AndroidUtilities.m102dp(194);
            if (this.lastSize != size) {
                this.lastSize = size;
                StaticLayout staticLayout = new StaticLayout(this.tooltipMessage, this.tooltipPaint, AndroidUtilities.m102dp(220), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, true);
            ...
            if (staticLayout2 != null && staticLayout2.getLineCount() > 1) {
                m102dp += this.tooltipLayout.getHeight() - this.tooltipLayout.getLineBottom(0);
            }
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(m102dp, 1073741824));
            float measuredWidth = getMeasuredWidth() * 0.35f;
            if (measuredWidth > AndroidUtilities.m102dp(140)) {
                measuredWidth = AndroidUtilities.m102dp(140);
            }
        ...
        */
        protected void onDraw(android.graphics.Canvas r38) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatActivityEnterView.RecordCircle.onDraw(android.graphics.Canvas):void");
        }
        ...
        public void updateColors() {
            ...
            int m102dp = AndroidUtilities.m102dp(5);
            ChatActivityEnterView chatActivityEnterView2 = ChatActivityEnterView.this;
            int i2 = Theme.key_chat_gifSaveHintBackground;
            this.tooltipBackground = Theme.createRoundRectDrawable(m102dp, chatActivityEnterView2.getThemedColor(i2));
        ...
        public class VirtualViewHelper extends ExploreByTouchHelper {
            ...
            protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                if (i == 1) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Send", C3630R.string.Send));
                } else if (i == 2) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Stop", C3630R.string.Stop));
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Cancel", C3630R.string.Cancel));
                }
            }
        }
    }
    ...
    public ChatActivityEnterView(final Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, final ChatActivity chatActivity, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.distCanMove = AndroidUtilities.m102dp(80);
        ...
        this.textFieldContainer.setPadding(0, AndroidUtilities.m102dp(1), 0, 0);
        ...
        FrameLayout frameLayout2 = new FrameLayout(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.16
            ...
            protected void onLayout(boolean z2, int i3, int i4, int i5, int i6) {
                ...
                if (ChatActivityEnterView.this.scheduledButton != null) {
                    int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m102dp((ChatActivityEnterView.this.botButton == null || ChatActivityEnterView.this.botButton.getVisibility() != 0) ? 48 : 96)) - AndroidUtilities.m102dp(48);
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                ...
                if (view == chatActivityEnterView.messageEditText) {
                    canvas.save();
                    canvas.clipRect(0, ((-getTop()) - ChatActivityEnterView.this.textFieldContainer.getTop()) - ChatActivityEnterView.this.getTop(), getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m102dp(6));
        ...
        ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView = new ChatActivityEnterViewAnimatedIconView(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.17
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawCircle((getWidth() / 2) + AndroidUtilities.m102dp(9), (getHeight() / 2) - AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(5), ChatActivityEnterView.this.dotPaint);
            }
        };
        this.emojiButton = chatActivityEnterViewAnimatedIconView;
        chatActivityEnterViewAnimatedIconView.setContentDescription(LocaleController.getString(C3630R.string.AccDescrEmojiButton));
        this.emojiButton.setFocusable(true);
        int m103dp = AndroidUtilities.m103dp(9.5f);
        this.emojiButton.setPadding(m103dp, m103dp, m103dp, m103dp);
        ...
        if (z) {
            ...
            imageView.setImageResource(C3630R.C3632drawable.msg_translate);
            ...
            int i7 = C3630R.string.chat_long_action_translate;
            ...
            this.attachLayout.setPivotX(AndroidUtilities.m102dp(48));
            ...
            CrossOutDrawable crossOutDrawable = new CrossOutDrawable(activity, C3630R.C3632drawable.input_notify_on, i3);
            ...
            if (this.silent) {
                i = C3630R.string.AccDescrChanSilentOn;
                str = "AccDescrChanSilentOn";
            } else {
                i = C3630R.string.AccDescrChanSilentOff;
            ...
            this.notifyButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.18
                ...
                public void onClick(View view) {
                    ...
                    if (ChatActivityEnterView.this.notifySilentDrawable == null) {
                        ChatActivityEnterView.this.notifySilentDrawable = new CrossOutDrawable(activity, C3630R.C3632drawable.input_notify_on, Theme.key_chat_messagePanelIcons);
                    }
                    ...
                    if (ChatActivityEnterView.this.silent) {
                        i9 = C3630R.string.AccDescrChanSilentOn;
                        str2 = "AccDescrChanSilentOn";
                    } else {
                        i9 = C3630R.string.AccDescrChanSilentOff;
            ...
            this.attachButton.setImageResource(C3630R.C3632drawable.msg_input_attach2);
            if (i4 >= 21) {
            ...
            this.attachButton.setContentDescription(LocaleController.getString("AccDescrAttachButton", C3630R.string.AccDescrAttachButton));
        }
        ...
        C457020 c457020 = new C457020(activity, resourcesProvider);
        this.audioVideoButtonContainer = c457020;
        c457020.setSoundEffectsEnabled(false);
        ...
        int m103dp2 = AndroidUtilities.m103dp(9.5f);
        this.audioVideoSendButton.setPadding(m103dp2, m103dp2, m103dp2, m103dp2);
        ...
        this.cancelBotButton.setContentDescription(LocaleController.getString("Cancel", C3630R.string.Cancel));
        ...
        if (chatActivity2 != null && chatActivity2.isAllowCombineMessages()) {
            Drawable drawable = activity.getResources().getDrawable(C3630R.C3632drawable.poll_add_circle);
            Drawable drawable2 = activity.getResources().getDrawable(C3630R.C3632drawable.poll_add_plus);
            ...
            this.combineMessagesDrawable.setCustomSize(AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(18));
            this.combineMessagesDrawable.setIconSize(AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(18));
        }
        if (isTemplatesChannel(true, false)) {
            Resources resources = activity.getResources();
            int i9 = C3630R.C3632drawable.fork_templates;
            ...
            int i10 = C3630R.C3632drawable.input_schedule;
            ...
            int i11 = C3630R.C3632drawable.ic_send;
        ...
        View view = new View(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.22
            ...
            protected void onDraw(Canvas canvas) {
                ...
                float f;
                float m102dp2;
                int m102dp3 = AndroidUtilities.m102dp(20);
                ...
                if (!ChatActivityEnterView.this.isTemplatesChannel(true, false)) {
                    if (ChatActivityEnterView.this.isInScheduleMode()) {
                        measuredHeight -= AndroidUtilities.m102dp(1);
                    } else {
                        measuredWidth2 += AndroidUtilities.m102dp(2);
                    }
                }
                ...
                if (z2 || this.animationProgress != 1.0f) {
                    ...
                    if (z2) {
                        ...
                        if (f3 <= 0.25f) {
                            f = m102dp3;
                            m102dp2 = AndroidUtilities.m102dp(2) * CubicBezierInterpolator.EASE_IN.getInterpolation(f3 / 0.25f);
                        } else {
                            float f4 = f3 - 0.25f;
                            if (f4 <= 0.5f) {
                                f = m102dp3;
                                m102dp2 = AndroidUtilities.m102dp(2) - (AndroidUtilities.m102dp(3) * CubicBezierInterpolator.EASE_IN.getInterpolation(f4 / 0.5f));
                            } else {
                                m102dp = m102dp3 + (-AndroidUtilities.m102dp(1)) + (AndroidUtilities.m102dp(1) * CubicBezierInterpolator.EASE_IN.getInterpolation((f4 - 0.5f) / 0.25f));
                                m102dp3 = (int) m102dp;
                            }
                        }
                        m102dp = f + m102dp2;
                    ...
                    canvas.drawCircle(f5, f5, m102dp3, Theme.dialogs_onlineCirclePaint);
        ...
        this.sendButton.setContentDescription(LocaleController.getString("Send", C3630R.string.Send));
        ...
        this.slowModeButton.setPadding(0, 0, AndroidUtilities.m102dp(13), 0);
        ...
        this.keyboardHeight = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.m102dp(200));
        this.keyboardHeightLand = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.m102dp(200));
    ...
    public /* synthetic */ void lambda$new$8(View view) {
        if (this.accountInstance.getFormattingTextController().getFormattingPanelType() == FormattingPanelType.ALTERNATIVE_WEB) {
            ...
            this.delegate.bottomPanelTranslationYChanged(-AndroidUtilities.m102dp(60));
        } else if (isPopupShowing() && this.currentPopupContentType == 2) {
            showPopup(0, 2);
        } else {
    ...
    /* loaded from: classes6.dex */
    public class C457020 extends FrameLayout {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C457020(Context context, Theme.ResourcesProvider resourcesProvider) {
            super(context);
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
                ...
                if (ChatActivityEnterView.this.recordCircle.isSendButtonVisible()) {
                    if (!ChatActivityEnterView.this.hasRecordVideo || ChatActivityEnterView.this.calledRecordRunnable) {
                            ...
                            if ((ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) || (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isTemplatesChannel(true, true))) {
                                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$20$$ExternalSyntheticLambda4
                                    ...
                                    public final void didSelectDate(boolean z, int i2, String str) {
                                        ChatActivityEnterView.C457020.lambda$onTouchEvent$0(z, i2, str);
                                    }
                                    ...
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        ChatActivityEnterView.C457020.lambda$onTouchEvent$1();
                                    }
                        ...
                        AndroidUtilities.runOnUIThread(chatActivityEnterView3.moveToSendStateRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$20$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChatActivityEnterView.C457020.this.lambda$onTouchEvent$2();
                            }
                        }, 200L);
                    }
                    ...
                    if ((ChatActivityEnterView.this.recordCircle == null || !ChatActivityEnterView.this.recordCircle.isSendButtonVisible()) && ((frameLayout = ChatActivityEnterView.this.recordedAudioPanel) == null || frameLayout.getVisibility() != 0)) {
                        if ((((motionEvent.getX() + ChatActivityEnterView.this.audioVideoButtonContainer.getX()) - ChatActivityEnterView.this.startedDraggingX) / ChatActivityEnterView.this.distCanMove) + 1.0f < 0.45d) {
                                ...
                                if (!ChatActivityEnterView.this.sendVoiceEnabled) {
                                    ...
                                    if ((ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) || (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isTemplatesChannel(true, true))) {
                                        AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$20$$ExternalSyntheticLambda5
                                            @Override // org.telegram.p042ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                                            public final void didSelectDate(boolean z, int i2, String str) {
                                                ChatActivityEnterView.C457020.lambda$onTouchEvent$3(z, i2, str);
                                            }
                                            ...
                                            @Override // java.lang.Runnable
                                            public final void run() {
                                                ChatActivityEnterView.C457020.lambda$onTouchEvent$4();
                                            }
                                        }, this.val$resourcesProvider, ChatActivityEnterView.this.parentFragment);
                                    }
                                    ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                            ...
                            AndroidUtilities.runOnUIThread(chatActivityEnterView4.moveToSendStateRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$20$$ExternalSyntheticLambda1
                                @Override // java.lang.Runnable
                                public final void run() {
                                    ChatActivityEnterView.C457020.this.lambda$onTouchEvent$5();
                                }
            ...
            if (motionEvent.getAction() == 2 && ChatActivityEnterView.this.recordingAudioVideo) {
                ...
                if (ChatActivityEnterView.this.startedDraggingX == -1.0f) {
                    ...
                    if (ChatActivityEnterView.this.distCanMove > AndroidUtilities.m102dp(140)) {
                        ChatActivityEnterView.this.distCanMove = AndroidUtilities.m102dp(140);
                    }
                }
    ...
    private void createScheduledButton() {
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.input_calendar1).mutate();
        Drawable mutate2 = getContext().getResources().getDrawable(C3630R.C3632drawable.input_calendar2).mutate();
        ...
        this.scheduledButton.setContentDescription(LocaleController.getString("ScheduledMessages", C3630R.string.ScheduledMessages));
    ...
    private void createGiftButton() {
        ...
        imageView.setImageResource(C3630R.C3632drawable.msg_input_gift);
        ...
        this.giftButton.setContentDescription(LocaleController.getString(C3630R.string.GiftPremium));
    ...
    private void createBotButton() {
        ...
        this.botButtonDrawable.setIcon(C3630R.C3632drawable.input_bot2, false);
    ...
    private void createDoneButton() {
        ...
        ShapeDrawable createCircleDrawable = Theme.createCircleDrawable(AndroidUtilities.m102dp(16), getThemedColor(Theme.key_chat_messagePanelSend));
        Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.input_done).mutate();
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(createCircleDrawable, this.doneCheckDrawable, 0, AndroidUtilities.m102dp(1));
        combinedDrawable.setCustomSize(AndroidUtilities.m102dp(32), AndroidUtilities.m102dp(32));
        ImageView imageView = new ImageView(getContext());
        this.doneButtonImage = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.doneButtonImage.setImageDrawable(combinedDrawable);
        this.doneButtonImage.setContentDescription(LocaleController.getString("Done", C3630R.string.Done));
    ...
    private void createExpandStickersButton() {
        ...
        this.expandStickersButton.setContentDescription(LocaleController.getString("AccDescrExpandPanel", C3630R.string.AccDescrExpandPanel));
    }
    ...
    private void createRecordAudioPanel() {
        ...
        this.recordDeleteImageView.setAnimation(C3630R.raw.chat_audio_record_delete_2, 28, 28);
        this.recordDeleteImageView.getAnimatedDrawable().setInvalidateOnProgressSet(true);
        updateRecordedDeleteIconColors();
        this.recordDeleteImageView.setContentDescription(LocaleController.getString("Delete", C3630R.string.Delete));
        if (Build.VERSION.SDK_INT >= 21) {
        ...
        this.videoTimelineView.setDelegate(new VideoTimelineView.VideoTimelineViewDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView.25
            ...
            @Override // org.telegram.p042ui.Components.VideoTimelineView.VideoTimelineViewDelegate
        ...
        view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m102dp(18), getThemedColor(Theme.key_chat_recordedVoiceBackground)));
        ...
        this.recordedAudioPlayButton.setContentDescription(LocaleController.getString("AccActionPlay", C3630R.string.AccActionPlay));
    ...
    public /* synthetic */ void lambda$createRecordAudioPanel$22(View view) {
        ...
        this.recordedAudioPlayButton.setContentDescription(LocaleController.getString("AccActionPause", C3630R.string.AccActionPause));
    }
    ...
    private void resetRecordedState() {
        ...
        if (this.audioToSendPath != null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m100d("delete file " + this.audioToSendPath);
            }
        ...
        if (botCommandsMenuIsShowing()) {
            ...
            if (this.delegate.getSendAsPeers() != null) {
                ...
                SenderSelectPopup senderSelectPopup2 = new SenderSelectPopup(getContext(), this.parentFragment, messagesController, chatFull, this.delegate.getSendAsPeers(), new SenderSelectPopup.OnSelectCallback() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda76
                    @Override // org.telegram.p042ui.Components.SenderSelectPopup.OnSelectCallback
                    ...
                    @Override // org.telegram.p042ui.Components.SenderSelectPopup, org.telegram.p042ui.ActionBar.ActionBarPopupWindow, android.widget.PopupWindow
                    public void dismiss() {
                ...
                this.senderSelectPopupWindow.getContentView().measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(1000), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(1000), Integer.MIN_VALUE));
                ...
                int i3 = -AndroidUtilities.m102dp(4);
                int[] iArr = new int[2];
                ...
                if (measureKeyboardHeight2 <= AndroidUtilities.m102dp(20)) {
                    contentViewHeight2 += measureKeyboardHeight2;
                }
                if (this.emojiViewVisible) {
                    contentViewHeight2 -= getEmojiPadding();
                }
                int m102dp = AndroidUtilities.m102dp(1);
                if (measuredHeight < (((i3 * 2) + contentViewHeight2) - (this.parentFragment.isInBubbleMode() ? 0 : AndroidUtilities.statusBarHeight)) - this.senderSelectPopupWindow.headerText.getMeasuredHeight()) {
                    ...
                    i2 = ((iArr[1] - measuredHeight) - i3) - AndroidUtilities.m102dp(2);
                    overlayContainerView.addView(this.senderSelectPopupWindow.dimView, new FrameLayout.LayoutParams(-1, i3 + i2 + measuredHeight + m102dp + AndroidUtilities.m102dp(2)));
                } else {
                    int i4 = this.parentFragment.isInBubbleMode() ? 0 : AndroidUtilities.statusBarHeight;
                    int m102dp2 = AndroidUtilities.m102dp(14);
                    this.senderSelectPopupWindow.recyclerContainer.getLayoutParams().height = ((contentViewHeight2 - i4) - m102dp2) - getHeightWithTopView();
                    overlayContainerView.addView(this.senderSelectPopupWindow.dimView, new FrameLayout.LayoutParams(-1, m102dp2 + i4 + this.senderSelectPopupWindow.recyclerContainer.getLayoutParams().height + m102dp));
                    i2 = i4;
                }
    ...
    public /* synthetic */ void lambda$createSenderSelectView$28(final SimpleAvatarView simpleAvatarView, int[] iArr, SenderSelectPopup.SenderView senderView) {
        ...
        final Dialog dialog = new Dialog(getContext(), C3630R.style.TransparentDialogNoAnimation);
        FrameLayout frameLayout = new FrameLayout(getContext());
        ...
        float m102dp = AndroidUtilities.m102dp(5);
        float m102dp2 = iArr[0] + this.popupX + m102dp + AndroidUtilities.m102dp(4) + BitmapDescriptorFactory.HUE_RED;
        float f3 = iArr[1] + this.popupY + m102dp + BitmapDescriptorFactory.HUE_RED;
        simpleAvatarView.setTranslationX(m102dp2);
        simpleAvatarView.setTranslationY(f3);
        float m102dp3 = this.senderSelectView.getLayoutParams().width / AndroidUtilities.m102dp(40);
        ...
        simpleAvatarView.getViewTreeObserver().addOnDrawListener(new ViewTreeObserver$OnDrawListenerC457828(this, simpleAvatarView, senderView));
        dialog.show();
        ...
        }), new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_X).setStartValue(MathUtils.clamp(m102dp2, f - AndroidUtilities.m102dp(6), m102dp2)).setSpring(new SpringForce(f).setStiffness(700.0f).setDampingRatio(0.75f)).setMinValue(f - AndroidUtilities.m102dp(6)), new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_Y).setStartValue(MathUtils.clamp(f3, f3, AndroidUtilities.m102dp(6) + f2)).setSpring(new SpringForce(f2).setStiffness(700.0f).setDampingRatio(0.75f)).setMaxValue(AndroidUtilities.m102dp(6) + f2).addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener(this) { // from class: org.telegram.ui.Components.ChatActivityEnterView.30
        ...
        }), new SpringAnimation(simpleAvatarView, viewProperty).setSpring(new SpringForce(m102dp3).setStiffness(1000.0f).setDampingRatio(1.0f)), new SpringAnimation(simpleAvatarView, viewProperty2).setSpring(new SpringForce(m102dp3).setStiffness(1000.0f).setDampingRatio(1.0f)));
    }

    /* renamed from: org.telegram.ui.Components.ChatActivityEnterView$28 */
    /* loaded from: classes6.dex */
    public class ViewTreeObserver$OnDrawListenerC457828 implements ViewTreeObserver.OnDrawListener {
        final /* synthetic */ SimpleAvatarView val$avatar;
        final /* synthetic */ SenderSelectPopup.SenderView val$senderView;

        ViewTreeObserver$OnDrawListenerC457828(ChatActivityEnterView chatActivityEnterView, SimpleAvatarView simpleAvatarView, SenderSelectPopup.SenderView senderView) {
        ...
        public void onDraw() {
            ...
            simpleAvatarView.post(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$28$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.ViewTreeObserver$OnDrawListenerC457828.this.lambda$onDraw$0(simpleAvatarView, senderView);
                }
            });
        }
    ...
    public void showRestrictedHint() {
        if (DialogObject.isChatDialog(this.dialog_id)) {
            BulletinFactory.m61of(this.parentFragment).createSimpleBulletin(C3630R.raw.passcode_lock_close, LocaleController.formatString("SendPlainTextRestrictionHint", C3630R.string.SendPlainTextRestrictionHint, ChatObject.getAllowedSendString(this.accountInstance.getMessagesController().getChat(Long.valueOf(-this.dialog_id)))), 3).show();
        }
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (z) {
            ...
            if (view == this.textFieldContainer) {
                int m102dp = (int) (this.animatedTop + AndroidUtilities.m102dp(2) + this.chatSearchExpandOffset);
                View view2 = this.topView;
                if (view2 != null && view2.getVisibility() == 0) {
                    m102dp += this.topView.getHeight();
                }
                canvas.clipRect(0, m102dp, getMeasuredWidth(), getMeasuredHeight());
            } else {
                canvas.clipRect(0, this.animatedTop, getMeasuredWidth(), this.animatedTop + view.getLayoutParams().height + AndroidUtilities.m102dp(2));
            }
        }
        boolean drawChild = super.drawChild(canvas, view, j);
        if (z) {
    ...
    public boolean onSendLongClick(View view) {
        ...
        if (z5) {
            ...
            if (SharedConfig.isCombineMessagesEnabled) {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getInternalString(C3630R.string.combine_messages_disable), C3630R.C3632drawable.fork_disable_combine_messages);
            } else {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getInternalString(C3630R.string.combine_messages_enable), C3630R.C3632drawable.fork_enable_combine_messages);
            }
        ...
        if (z6) {
            ...
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getInternalString(C3630R.string.combine_messages_send_without_combine), C3630R.C3632drawable.fork_disable_combine_messages);
        ...
        if (z7) {
            ...
            actionBarMenuSubItem3.setTextAndIcon(LocaleController.getInternalString(C3630R.string.sending_settings_send_add_reactions), C3630R.C3632drawable.fork_ic_reactions);
            actionBarMenuSubItem3.setMinimumWidth(AndroidUtilities.m102dp(196));
        ...
        if (z8) {
            ...
            actionBarMenuSubItem4.setTextAndIcon(LocaleController.getInternalString(C3630R.string.sending_settings_translation_enable_item_title), C3630R.C3632drawable.msg_translate);
            actionBarMenuSubItem4.setMinimumWidth(AndroidUtilities.m102dp(196));
        ...
        if (z3) {
            ...
            if (z2) {
                actionBarMenuSubItem5.setTextAndIcon(LocaleController.getString("SetReminder", C3630R.string.SetReminder), C3630R.C3632drawable.msg_calendar2);
            } else {
                actionBarMenuSubItem5.setTextAndIcon(LocaleController.getString("ScheduleMessage", C3630R.string.ScheduleMessage), C3630R.C3632drawable.msg_calendar2);
            }
            actionBarMenuSubItem5.setMinimumWidth(AndroidUtilities.m102dp(196));
            ...
            if (!z2 && this.dialog_id > 0) {
                ...
                actionBarMenuSubItem6.setTextAndIcon(LocaleController.getString("SendWhenOnline", C3630R.string.SendWhenOnline), C3630R.C3632drawable.msg_online);
                this.sendWhenOnlineButton.setMinimumWidth(AndroidUtilities.m102dp(196));
        ...
        if (z4) {
            ...
            if (this.parentFragment != null && ToolsController.getInstance(this.currentAccount).isSilentSendingEnabledForDialog(this.parentFragment.getDialogId())) {
                actionBarMenuSubItem7.setTextAndIcon(LocaleController.getInternalString(C3630R.string.send_with_sound), C3630R.C3632drawable.input_notify_on);
            } else {
                actionBarMenuSubItem7.setTextAndIcon(LocaleController.getString("SendWithoutSound", C3630R.string.SendWithoutSound), C3630R.C3632drawable.input_notify_off);
            }
            actionBarMenuSubItem7.setMinimumWidth(AndroidUtilities.m102dp(196));
        ...
        ActionBarPopupWindow actionBarPopupWindow = new ActionBarPopupWindow(this.sendPopupLayout, -2, -2) { // from class: org.telegram.ui.Components.ChatActivityEnterView.34
            ...
            @Override // org.telegram.p042ui.ActionBar.ActionBarPopupWindow, android.widget.PopupWindow
            public void dismiss() {
                super.dismiss();
        ...
        this.sendPopupLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(1000), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(1000), Integer.MIN_VALUE));
        ...
        try {
            if (this.keyboardVisible) {
                ...
                View view2 = this.topView;
                if (measuredHeight2 > AndroidUtilities.m102dp((view2 == null || view2.getVisibility() != 0) ? 58 : 106)) {
                    measuredHeight = this.location[1] + view.getMeasuredHeight();
                    this.sendPopupWindow.showAtLocation(view, 51, ((this.location[0] + view.getMeasuredWidth()) - this.sendPopupLayout.getMeasuredWidth()) + AndroidUtilities.m102dp(8), measuredHeight);
        ...
        measuredHeight = (this.location[1] - this.sendPopupLayout.getMeasuredHeight()) - AndroidUtilities.m102dp(2);
        this.sendPopupWindow.showAtLocation(view, 51, ((this.location[0] + view.getMeasuredWidth()) - this.sendPopupLayout.getMeasuredWidth()) + AndroidUtilities.m102dp(8), measuredHeight);
        this.sendPopupWindow.dimBehind();
        this.sendButton.invalidate();
    }
    ...
    private void createBotCommandsMenuContainer() {
        ...
        BotCommandsMenuContainer botCommandsMenuContainer = new BotCommandsMenuContainer(getContext()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.35
            ...
            @Override // org.telegram.p042ui.Components.BotCommandsMenuContainer
        ...
        this.botCommandsMenuContainer.listView.setOnItemClickListener(new C458736());
    ...
    /* loaded from: classes6.dex */
    public class C458736 implements RecyclerListView.OnItemClickListener {
        C458736() {
            ChatActivityEnterView.this = r1;
        }
            ...
            if (view instanceof TemplatesHeaderCell) {
                ...
                if (!ChatActivityEnterView.this.isInScheduleMode()) {
                    if (ChatActivityEnterView.this.parentFragment == null || !ChatActivityEnterView.this.parentFragment.checkSlowMode(view)) {
                        SendMessagesHelper.getInstance(ChatActivityEnterView.this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m90of(command, ChatActivityEnterView.this.dialog_id, ChatActivityEnterView.this.replyingMessageObject, ChatActivityEnterView.this.getThreadMessage(), null, false, null, null, null, true, 0, null, false, null));
                ...
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.dialog_id, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$36$$ExternalSyntheticLambda0
                    @Override // org.telegram.p042ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                    public final void didSelectDate(boolean z, int i2, String str) {
                        ChatActivityEnterView.C458736.this.lambda$onItemClick$0(command, z, i2, str);
                    }
        ...
        public /* synthetic */ void lambda$onItemClick$0(String str, boolean z, int i, String str2) {
            SendMessagesHelper.getInstance(ChatActivityEnterView.this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m90of(str, ChatActivityEnterView.this.dialog_id, ChatActivityEnterView.this.replyingMessageObject, ChatActivityEnterView.this.getThreadMessage(), null, false, null, null, null, z, i, null, false, str2));
            ChatActivityEnterView.this.setFieldText("");
            ChatActivityEnterView.this.botCommandsMenuContainer.dismiss();
        }
    }
    ...
    private void updateBotCommandsMenuContainerTopPadding() {
        ...
        if (this.botCommandsAdapter.getItemCount() > 4) {
            max = Math.max(0, this.sizeNotifierLayout.getMeasuredHeight() - AndroidUtilities.m103dp((i * 4.3f) + 8.0f));
        } else {
            max = Math.max(0, this.sizeNotifierLayout.getMeasuredHeight() - AndroidUtilities.m102dp((i * Math.max(1, Math.min(4, this.botCommandsAdapter.getItemCount()))) + 8));
        }
        if (this.botCommandsMenuContainer.listView.getPaddingTop() != max) {
            ...
            this.botCommandsMenuContainer.listView.setPadding(0, max, 0, AndroidUtilities.m102dp(8));
        }
    }
    ...
    private void createBotWebViewMenuContainer() {
        ...
        BotWebViewMenuContainer botWebViewMenuContainer = new BotWebViewMenuContainer(getContext(), this) { // from class: org.telegram.ui.Components.ChatActivityEnterView.38
            ...
            @Override // org.telegram.p042ui.Components.BotWebViewMenuContainer
            public void onDismiss() {
                super.onDismiss();
                if (ChatActivityEnterView.this.botCommandsMenuButton != null) {
                    ChatActivityEnterView.this.botCommandsMenuButton.setOpened(false);
    ...
    public class ChatActivityEditTextCaption extends EditTextCaption {
        ...
        @Override // org.telegram.p042ui.Components.EditTextCaption
        ...
        @Override // org.telegram.p042ui.Components.EditTextEffects, android.widget.TextView
        ...
        @Override // org.telegram.p042ui.Components.EditTextBoldCursor
        ...
        public boolean requestRectangleOnScreen(Rect rect) {
            rect.bottom += AndroidUtilities.m102dp(1000);
            return super.requestRectangleOnScreen(rect);
        }

        @Override // org.telegram.p042ui.Components.EditTextCaption, org.telegram.p042ui.Components.EditTextBoldCursor, android.widget.TextView, android.view.View
        ...
        @Override // org.telegram.p042ui.Components.EditTextCaption, android.widget.TextView
    ...
    private void createMessageEditText() {
        ...
        this.messageEditText.setDelegate(new EditTextCaption.EditTextCaptionDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda75
            @Override // org.telegram.p042ui.Components.EditTextCaption.EditTextCaptionDelegate
        ...
        this.messageEditText.setPadding(0, AndroidUtilities.m102dp(11), 0, AndroidUtilities.m102dp(12));
        ...
        this.messageEditText.addTextChangedListener(new C459341());
    ...
    /* loaded from: classes6.dex */
    public class C459341 implements TextWatcher {
        ...
        */
        public void afterTextChanged(android.text.Editable r11) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatActivityEnterView.C459341.afterTextChanged(android.text.Editable):void");
        }
    ...
    public void setRecordVideoButtonVisible(boolean z, boolean z2) {
        ...
        this.audioVideoSendButton.setContentDescription(LocaleController.getString(isInVideoMode() ? C3630R.string.AccDescrVideoMessage : C3630R.string.AccDescrVoiceMessage));
        this.audioVideoButtonContainer.setContentDescription(LocaleController.getString(isInVideoMode() ? C3630R.string.AccDescrVideoMessage : C3630R.string.AccDescrVoiceMessage));
    ...
    public void updateSlowModeText() {
        ...
        if (tLRPC$ChatFull != null && tLRPC$ChatFull.slowmode_seconds != 0 && tLRPC$ChatFull.slowmode_next_send_date <= currentTime && ((isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.currentAccount).isUploadingMessageIdDialog(this.dialog_id)) || SendMessagesHelper.getInstance(this.currentAccount).isSendingMessageIdDialog(this.dialog_id))) {
            if (!ChatObject.hasAdminRights(this.accountInstance.getMessagesController().getChat(Long.valueOf(this.info.f1601id)))) {
            ...
            if (i2 >= 2147483646) {
                if (this.info != null) {
                    this.accountInstance.getMessagesController().loadFullChat(this.info.f1601id, 0, true);
                }
                i = 0;
            } else {
                i = i2 - currentTime;
    ...
    private void showTopView(boolean z, boolean z2, boolean z3) {
        if (this.topView == null || this.topViewShowed || getVisibility() != 0) {
            ...
            if (frameLayout == null || frameLayout.getVisibility() != 0) {
                if ((!this.forceShowSendButton || z2) && !this.isFormattingMessagesContainerVisible) {
                    openKeyboard();
                    return;
                }
                return;
    ...
    private void onWindowSizeChanged() {
        ...
        if (this.topView != null) {
            if (height < AndroidUtilities.m102dp(72) + C3702ActionBar.getCurrentActionBarHeight()) {
                if (this.allowShowTopView) {
    ...
    public void resizeForTopView(boolean z) {
        ...
        layoutParams.topMargin = AndroidUtilities.m102dp(2) + (z ? this.topView.getLayoutParams().height : 0);
        this.textFieldContainer.setLayoutParams(layoutParams);
        setMinimumHeight(AndroidUtilities.m102dp(51) + (z ? this.topView.getLayoutParams().height : 0));
        if (this.stickersExpanded) {
            if (this.searchingType == 0) {
                setStickersExpanded(false, true, false);
            } else {
    ...
    public void updateRecordButton(TLRPC$Chat tLRPC$Chat, TLRPC$UserFull tLRPC$UserFull) {
        ...
        if (tLRPC$Chat != null) {
            ...
            if (!this.emojiButtonRestricted && (emojiView = this.emojiView) != null) {
                emojiView.setStickersBanned(!ChatObject.canSendPlain(tLRPC$Chat), !ChatObject.canSendStickers(tLRPC$Chat), tLRPC$Chat.f1600id);
                this.emojiView.setGifsBanned(!ChatObject.canSendGifs(tLRPC$Chat), tLRPC$Chat.f1600id);
            }
    ...
    public void updateFieldHint(boolean z) {
        ...
        if (!this.sendPlainEnabled && !isEditingMessage()) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(" d " + LocaleController.getString("PlainTextRestrictedHint", C3630R.string.PlainTextRestrictedHint));
            spannableStringBuilder.setSpan(new ColoredImageSpan(C3630R.C3632drawable.msg_mini_lock3), 1, 2, 0);
        ...
        if (messageObject2 != null && (tLRPC$ReplyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(tLRPC$ReplyMarkup2.placeholder)) {
            ...
            this.messageEditText.setHintText(this.editingCaption ? LocaleController.getString("Caption", C3630R.string.Caption) : LocaleController.getString("TypeMessage", C3630R.string.TypeMessage));
            ...
            if (DialogObject.isChatDialog(this.dialog_id)) {
                ...
                if (chat == null || ChatObject.getSendAsPeerId(chat, chatFull) != chat.f1600id) {
                    z3 = false;
                }
            } else {
                z3 = false;
            ...
            if (z3) {
                this.messageEditText.setHintText(LocaleController.getString("SendAnonymously", C3630R.string.SendAnonymously));
                return;
            }
            ChatActivity chatActivity = this.parentFragment;
            if (chatActivity != null && chatActivity.isThreadChat()) {
                ...
                if (!chatActivity2.isTopic) {
                    if (chatActivity2.isReplyChatComment()) {
                        this.messageEditText.setHintText(LocaleController.getString("Comment", C3630R.string.Comment));
                        return;
                    } else {
                        this.messageEditText.setHintText(LocaleController.getString("Reply", C3630R.string.Reply));
                        return;
                    }
                }
            }
            if (z2) {
                if (this.parentFragment != null && isTemplatesChannel(false, false)) {
                    this.messageEditText.setHintText(LocaleController.getInternalString(C3630R.string.chat_template));
                    return;
                }
                ChatActivity chatActivity3 = this.parentFragment;
                if (chatActivity3 != null && chatActivity3.isInAlbumMode()) {
                    this.messageEditText.setHintText(LocaleController.getString("TypeMessage", C3630R.string.TypeMessage));
                    return;
                } else if (this.silent) {
                    this.messageEditText.setHintText(LocaleController.getString("ChannelSilentBroadcast", C3630R.string.ChannelSilentBroadcast), z);
                    return;
                } else {
                    this.messageEditText.setHintText(LocaleController.getString("ChannelBroadcast", C3630R.string.ChannelBroadcast), z);
                    return;
                }
            }
            this.messageEditText.setHintText(LocaleController.getString("TypeMessage", C3630R.string.TypeMessage));
    ...
    public void sendMessageInternal(final boolean z, final int i, boolean z2, final String str, boolean z3) {
        ...
        if (chatActivity2 != null && chatActivity2.isInMultipleFilesSending()) {
            ...
            if (this.videoToSendMessageObject != null) {
                ...
                SendMessagesHelper.SendMessageParams m85of = SendMessagesHelper.SendMessageParams.m85of(this.audioToSend, null, this.audioToSendPath, this.dialog_id, this.replyingMessageObject, getThreadMessage(), null, null, null, null, z, i, 0, null, null, false, str);
                applyStoryToSendMessageParams(m85of);
                SendMessagesHelper.getInstance(this.currentAccount).sendMessage(m85of);
                ...
                if (chatActivity4 != null && (currentChat = chatActivity4.getCurrentChat()) != null && currentChat.slowmode_enabled && !ChatObject.hasAdminRights(currentChat)) {
                    if (text.length() > this.accountInstance.getMessagesController().maxMessageLength) {
                        AlertsCreator.showSimpleAlert(this.parentFragment, LocaleController.getString("Slowmode", C3630R.string.Slowmode), LocaleController.getString("SlowmodeSendErrorTooLong", C3630R.string.SlowmodeSendErrorTooLong), this.resourcesProvider);
                        return;
                    } else if (this.forceShowSendButton && text.length() > 0) {
                        AlertsCreator.showSimpleAlert(this.parentFragment, LocaleController.getString("Slowmode", C3630R.string.Slowmode), LocaleController.getString("SlowmodeSendError", C3630R.string.SlowmodeSendError), this.resourcesProvider);
                        return;
                    }
                }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean checkPremiumAnimatedEmoji(int r9, long r10, final org.telegram.p042ui.ActionBar.BaseFragment r12, android.widget.FrameLayout r13, java.lang.CharSequence r14) {
        /*
            Method dump skipped, instructions count: 340
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatActivityEnterView.checkPremiumAnimatedEmoji(int, long, org.telegram.ui.ActionBar.BaseFragment, android.widget.FrameLayout, java.lang.CharSequence):boolean");
    }
    ...
    public void showCaptionLimitBulletin() {
        ...
        BulletinFactory.m61of(this.parentFragment).createCaptionLimitBulletin(MessagesController.getInstance(this.currentAccount).captionLengthLimitPremium, new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda50
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (charSequence2.length() != 0) {
            ...
            while (true) {
                ...
                if (this.delegate.hasForwardingMessages()) {
                    ...
                    sendAnimationData2.height = m102dp;
                    sendAnimationData2.width = m102dp;
                    EditTextCaption editTextCaption = this.messageEditText;
                    if (editTextCaption != null) {
                        editTextCaption.getLocationInWindow(this.location);
                        sendAnimationData2.f1535x = this.location[0] + AndroidUtilities.m102dp(11);
                        sendAnimationData2.f1536y = this.location[1] + AndroidUtilities.m102dp(19);
                    } else {
                        sendAnimationData2.f1535x = AndroidUtilities.m102dp(59);
                        sendAnimationData2.f1536y = AndroidUtilities.displaySize.y - AndroidUtilities.m102dp(19);
                    }
                ...
                SendMessagesHelper.SendMessageParams m90of = SendMessagesHelper.SendMessageParams.m90of(charSequenceArr[c].toString(), this.dialog_id, this.replyingMessageObject, getThreadMessage(), z2 ? null : this.messageWebPage, !z2 && this.messageWebPageSearch, entities, null, null, z, i, sendAnimationData, checkUpdateStickersOrder, str);
                applyStoryToSendMessageParams(m90of);
                SendMessagesHelper.getInstance(this.currentAccount).sendMessage(m90of);
                int i12 = min + 1;
        ...
        if (i4 > 0 && i4 != Integer.MAX_VALUE && !isInScheduleMode()) {
            if (this.slowModeButton.getVisibility() != 0) {
                    ...
                    if (this.attachLayout != null) {
                        ...
                        if (imageView4 != null) {
                            ...
                            if (z3) {
                                ...
                                this.scheduledButton.setPivotX(AndroidUtilities.m102dp(48));
                                ImageView imageView5 = this.scheduledButton;
                                Property property = View.TRANSLATION_X;
                                float[] fArr = new float[1];
                                ImageView imageView6 = this.botButton;
                                int m102dp = AndroidUtilities.m102dp((imageView6 == null || imageView6.getVisibility() != 0) ? 48 : 96);
                                ImageView imageView7 = this.giftButton;
                                fArr[0] = m102dp - AndroidUtilities.m102dp((imageView7 == null || imageView7.getVisibility() != 0) ? 0 : 48);
                                ...
                                int m102dp2 = AndroidUtilities.m102dp((imageView9 == null || imageView9.getVisibility() != 0) ? 48 : 96);
                                ImageView imageView10 = this.giftButton;
                                imageView8.setTranslationX(m102dp2 - AndroidUtilities.m102dp((imageView10 == null || imageView10.getVisibility() != 0) ? 0 : 48));
                ...
                if (imageView13 != null) {
                    ...
                    int m102dp3 = AndroidUtilities.m102dp((imageView15 == null || imageView15.getVisibility() != 0) ? 48 : 96);
                    ImageView imageView16 = this.giftButton;
                    if (imageView16 != null && imageView16.getVisibility() == 0) {
                        i3 = 48;
                    }
                    imageView14.setTranslationX(m102dp3 - AndroidUtilities.m102dp(i3));
                    this.scheduledButton.setAlpha(1.0f);
                    this.scheduledButton.setScaleX(1.0f);
            ...
            if (this.audioVideoButtonContainer.getVisibility() == 0 || this.slowModeButton.getVisibility() == 0 || z5 || z6) {
                        ...
                        if (this.attachLayout != null) {
                            ...
                            if (imageView17 != null) {
                                ...
                                if (z7) {
                                    ...
                                    int m102dp4 = AndroidUtilities.m102dp((imageView19 == null || imageView19.getVisibility() != 0) ? 48 : 96);
                                    ImageView imageView20 = this.giftButton;
                                    fArr2[0] = m102dp4 - AndroidUtilities.m102dp((imageView20 == null || imageView20.getVisibility() != 0) ? 0 : 48);
                                    ...
                                    int m102dp5 = AndroidUtilities.m102dp((imageView22 == null || imageView22.getVisibility() != 0) ? 48 : 96);
                                    ImageView imageView23 = this.giftButton;
                                    imageView21.setTranslationX(m102dp5 - AndroidUtilities.m102dp((imageView23 == null || imageView23.getVisibility() != 0) ? 0 : 48));
                                }
                            }
                ...
                if (this.scheduledButton != null) {
                    ...
                    int m102dp6 = AndroidUtilities.m102dp((imageView27 == null || imageView27.getVisibility() != 0) ? 48 : 96);
                    ImageView imageView28 = this.giftButton;
                    if (imageView28 != null && imageView28.getVisibility() == 0) {
                        i3 = 48;
                    }
                    imageView26.setTranslationX(m102dp6 - AndroidUtilities.m102dp(i3));
                }
            }
                ...
                if (linearLayout4 != null) {
                    ...
                    if (imageView31 != null) {
                        if (z10) {
                            ...
                            fArr3[0] = (imageView33 == null || imageView33.getVisibility() != 0) ? 0.0f : -AndroidUtilities.m102dp(48);
    ...
    public void setSlowModeButtonVisible(boolean z) {
        ...
        int m102dp = z ? AndroidUtilities.m102dp(16) : 0;
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption == null || editTextCaption.getPaddingRight() == m102dp) {
            return;
        }
        this.messageEditText.setPadding(0, AndroidUtilities.m102dp(11), m102dp, AndroidUtilities.m102dp(12));
    }
    ...
    private void updateFieldRight(int i) {
        ...
        if (i == 100) {
            layoutParams.rightMargin = AndroidUtilities.m102dp(this.showForwardSettingsButton ? 80 : 30);
        } else if (i == 1) {
            ...
            if (imageView7 != null && imageView7.getVisibility() == 0 && (imageView6 = this.scheduledButton) != null && imageView6.getVisibility() == 0 && (linearLayout2 = this.attachLayout) != null && linearLayout2.getVisibility() == 0) {
                layoutParams.rightMargin = AndroidUtilities.m102dp(146);
            } else {
                ...
                if ((imageView8 != null && imageView8.getVisibility() == 0) || (((imageView4 = this.notifyButton) != null && imageView4.getVisibility() == 0) || (((imageView5 = this.scheduledButton) != null && imageView5.getTag() != null) || this.showForwardSettingsButton))) {
                    layoutParams.rightMargin = AndroidUtilities.m102dp(98);
                } else {
                    layoutParams.rightMargin = AndroidUtilities.m102dp(50);
                }
            }
        } else if (i == 2) {
            if (i2 != AndroidUtilities.m102dp(2)) {
                ImageView imageView9 = this.botButton;
            ...
            if ((imageView11 != null && imageView11.getTag() != null) || this.showTranslateButton) {
                ...
                layoutParams.rightMargin = AndroidUtilities.m102dp(2);
            }
        }
    ...
    */
    public void updateRecordInterface(final int r24) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatActivityEnterView.updateRecordInterface(int):void");
    }
    ...
    private void createRecordPanel() {
        ...
        linearLayout.setOrientation(0);
        this.recordTimeContainer.setPadding(AndroidUtilities.m102dp(13), 0, 0, 0);
    ...
    public void setCommand(MessageObject messageObject, String str, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            SendMessagesHelper.SendMessageParams m90of = ((this.botCount != 1 || z2) && tLRPC$User != null && tLRPC$User.bot && !str.contains("@")) ? SendMessagesHelper.SendMessageParams.m90of(String.format(Locale.US, "%s@%s", str, UserObject.getPublicUsername(tLRPC$User)), this.dialog_id, this.replyingMessageObject, getThreadMessage(), null, false, null, null, null, true, 0, null, false, null) : SendMessagesHelper.SendMessageParams.m90of(str, this.dialog_id, this.replyingMessageObject, getThreadMessage(), null, false, null, null, null, true, 0, null, false, null);
            applyStoryToSendMessageParams(m90of);
            SendMessagesHelper.getInstance(this.currentAccount).sendMessage(m90of);
        }
    }
    ...
    */
    public void setEditingMessageObject(org.telegram.messenger.MessageObject r18, boolean r19) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatActivityEnterView.setEditingMessageObject(org.telegram.messenger.MessageObject, boolean):void");
    }
    ...
    public void replaceWithText(int i, int i2, CharSequence charSequence, boolean z) {
        ...
        try {
            ...
            if (z) {
                Emoji.replaceEmoji(spannableStringBuilder, this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
            }
    ...
    */
    public void updateGiftButton(boolean r7) {
        ...
        L9c:
            ...
            r0 = 48
            if (r1 == 0) goto Lba
            int r1 = org.telegram.messenger.AndroidUtilities.m102dp(r0)
            int r1 = -r1
            goto Lbb
        Lba:
            r1 = r2
        ...
        Le7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatActivityEnterView.updateGiftButton(boolean):void");
    }
    ...
    public void updateScheduleButton(boolean z) {
        ...
        if (DialogObject.isChatDialog(this.dialog_id)) {
            ...
            if (this.notifyButton != null) {
                ...
                if (this.notifySilentDrawable == null) {
                    this.notifySilentDrawable = new CrossOutDrawable(getContext(), C3630R.C3632drawable.input_notify_on, Theme.key_chat_messagePanelIcons);
                }
                this.notifySilentDrawable.setCrossOut(this.silent, false);
                ...
                if (this.notifyButton != null) {
                    ...
                    if (i != this.notifyButton.getVisibility()) {
                        ...
                        if (linearLayout2 != null) {
                            ...
                            linearLayout2.setPivotX(AndroidUtilities.m102dp(i2));
                            return;
                        }
                        return;
                    }
        ...
        if (!z || z2) {
            ...
            if (imageView5 != null) {
                ...
                if (imageView8 != null && imageView8.getVisibility() == 0) {
                    this.scheduledButton.setTranslationX(-AndroidUtilities.m102dp(48));
                }
            }
        } else {
            ...
            if (imageView9 != null) {
                ...
                this.scheduledButton.setPivotX(AndroidUtilities.m102dp(24));
        ...
        if (linearLayout3 != null) {
            ...
            linearLayout3.setPivotX(AndroidUtilities.m102dp(i2));
        }
    }
    ...
    public void updateSendAsButton(boolean z) {
        ...
        if (tLRPC$Peer != null) {
            if (tLRPC$Peer.channel_id != 0) {
                ...
                if (chat != null && (senderSelectView2 = this.senderSelectView) != null) {
                    ...
                    this.senderSelectView.setContentDescription(LocaleController.formatString(C3630R.string.AccDescrSendAs, chat.title));
                }
            } else {
                ...
                if (user != null && (senderSelectView = this.senderSelectView) != null) {
                    ...
                    this.senderSelectView.setContentDescription(LocaleController.formatString(C3630R.string.AccDescrSendAs, ContactsController.formatName(user.first_name, user.last_name)));
                }
            }
        }
        ...
        if (senderSelectView4 != null) {
            ...
            f = z3 ? ((-this.senderSelectView.getLayoutParams().width) - marginLayoutParams.leftMargin) - m102dp : 0.0f;
            f2 = z3 ? 0.0f : ((-this.senderSelectView.getLayoutParams().width) - marginLayoutParams.leftMargin) - m102dp;
        } else {
            f = 0.0f;
            f2 = 0.0f;
        }
    ...
    private void updateBotButton(boolean z) {
        ...
        if (this.isChat) {
            ...
            if (hasBotWebView || this.hasBotCommands || this.botReplyMarkup != null) {
                if (this.botReplyMarkup != null) {
                    if (isPopupShowing() && this.currentPopupContentType == 1 && this.botReplyMarkup.is_persistent) {
                        ...
                        this.botButtonDrawable.setIcon(C3630R.C3632drawable.input_bot2, true);
                        this.botButton.setContentDescription(LocaleController.getString("AccDescrBotKeyboard", C3630R.string.AccDescrBotKeyboard));
                    }
                } else if (!z2) {
                    createBotButton();
                    this.botButtonDrawable.setIcon(C3630R.C3632drawable.input_bot1, true);
                    this.botButton.setContentDescription(LocaleController.getString("AccDescrBotCommands", C3630R.string.AccDescrBotCommands));
                    this.botButton.setVisibility(0);
                } else {
            ...
            if (botCommandsMenuView != null) {
                ...
                updateTemplatesButton();
                boolean menuText = this.botCommandsMenuButton.setMenuText(this.botMenuButtonType == BotMenuButtonType.COMMANDS ? LocaleController.getString(C3630R.string.BotsMenuTitle) : this.botMenuWebViewTitle);
            ...
            LinearLayout linearLayout = this.attachLayout;
            ImageView imageView9 = this.botButton;
            linearLayout.setPivotX(AndroidUtilities.m102dp(((imageView9 == null || imageView9.getVisibility() == 8) && ((imageView = this.notifyButton) == null || imageView.getVisibility() == 8)) ? 48 : 96));
        }
    }
    ...
    */
    public void setButtons(org.telegram.messenger.MessageObject r6, boolean r7) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatActivityEnterView.setButtons(org.telegram.messenger.MessageObject, boolean):void");
    }
    ...
    public boolean didPressedBotButton(final TLRPC$KeyboardButton tLRPC$KeyboardButton, final MessageObject messageObject, final MessageObject messageObject2, Browser.Progress progress) {
        ...
        if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonUpdateApp) {
            if (BuildVars.isStandaloneApp()) {
                Activity activity = this.parentActivity;
                if (activity instanceof LaunchActivity) {
                    ((LaunchActivity) activity).checkAppUpdate(true);
                }
            } else {
            ...
            SendMessagesHelper.getInstance(this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m90of(tLRPC$KeyboardButton.text, this.dialog_id, messageObject, getThreadMessage(), null, false, null, null, null, true, 0, null, false, null));
            ...
            if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonRequestPoll) {
                ...
                final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView.64
                    ...
                    @Override // java.lang.Runnable
                    public void run() {
                        if (ChatActivityEnterView.this.sizeNotifierLayout.measureKeyboardHeight() > AndroidUtilities.m102dp(20)) {
                        ...
                        botWebViewSheet.requestWebView(i, j4, j5, str2, str3, z ? 1 : 0, messageObject3 != null ? messageObject3.messageOwner.f1624id : 0, false);
                        botWebViewSheet.show();
                    }
                };
                ...
                builder.setTitle(LocaleController.getString("ShareYouLocationTitle", C3630R.string.ShareYouLocationTitle));
                builder.setMessage(LocaleController.getString("ShareYouLocationInfo", C3630R.string.ShareYouLocationInfo));
                builder.setPositiveButton(LocaleController.getString("OK", C3630R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda8
                ...
                FileLog.m99e("button.peer_type is null");
            }
        }
        return true;
    }
    ...
    private void createEmojiView() {
        ...
        EmojiView emojiView2 = new EmojiView(this.parentFragment, this.allowAnimatedEmoji, true, true, getContext(), true, this.info, this.sizeNotifierLayout, this.shouldDrawBackground, this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatActivityEnterView.66
            {
                ChatActivityEnterView.this = this;
            }
            ...
            @Override // org.telegram.p042ui.Components.EmojiView, android.view.View
        ...
        this.emojiView.setDelegate(new C462267());
        this.emojiView.setDragListener(new EmojiView.DragListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.68
            ...
            @Override // org.telegram.p042ui.Components.EmojiView.DragListener
            public void onDragStart() {
                if (allowDragging()) {
                    ...
                    ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
                    chatActivityEnterView.stickersExpandedHeight = (((chatActivityEnterView.sizeNotifierLayout.getHeight() - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C3702ActionBar.getCurrentActionBarHeight()) - ChatActivityEnterView.this.getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
                    if (ChatActivityEnterView.this.searchingType == 2) {
                        ChatActivityEnterView chatActivityEnterView2 = ChatActivityEnterView.this;
                        int i = chatActivityEnterView2.stickersExpandedHeight;
                        int m102dp = AndroidUtilities.m102dp(120);
                        Point point = AndroidUtilities.displaySize;
                        chatActivityEnterView2.stickersExpandedHeight = Math.min(i, m102dp + (point.x > point.y ? ChatActivityEnterView.this.keyboardHeightLand : ChatActivityEnterView.this.keyboardHeight));
                    }
            ...
            public void onDragEnd(float f) {
                if (allowDragging()) {
                    ...
                    if ((this.wasExpanded && f >= AndroidUtilities.m102dp(200)) || ((!this.wasExpanded && f <= AndroidUtilities.m102dp(-200)) || ((this.wasExpanded && ChatActivityEnterView.this.stickersExpansionProgress <= 0.6f) || (!this.wasExpanded && ChatActivityEnterView.this.stickersExpansionProgress >= 0.4f)))) {
    ...
    /* loaded from: classes6.dex */
    public class C462267 implements EmojiView.EmojiViewDelegate {
        C462267() {
            ChatActivityEnterView.this = r1;
        }
        ...
        public void lambda$onKiklikoVideoSelected$0(final String str, final boolean z, boolean z2, int i, String str2) {
            ...
            if ((isInScheduleMode() && i == 0) || (ChatActivityEnterView.this.isTemplatesChannel(true, true) && str2 == null)) {
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$67$$ExternalSyntheticLambda5
                    @Override // org.telegram.p042ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                    public final void didSelectDate(boolean z4, int i2, String str3) {
                        ChatActivityEnterView.C462267.this.lambda$onKiklikoVideoSelected$0(str, z, z4, i2, str3);
                    }
        ...
        public void showKiklikoReportAlert(String str, final Callbacks$Callback1<String> callbacks$Callback1) {
            ...
            final CharSequence[] charSequenceArr = {LocaleController.getString("ReportChatViolence", C3630R.string.ReportChatViolence), LocaleController.getString("ReportChatChild", C3630R.string.ReportChatChild), LocaleController.getString("ReportChatPornography", C3630R.string.ReportChatPornography), LocaleController.getString("ReportChatOther", C3630R.string.ReportChatOther)};
            builder.setItems(charSequenceArr, new int[]{C3630R.C3632drawable.msg_report_violence, C3630R.C3632drawable.msg_block2, C3630R.C3632drawable.msg_report_xxx, C3630R.C3632drawable.msg_report_other}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$67$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.C462267.this.lambda$showKiklikoReportAlert$1(charSequenceArr, callbacks$Callback1, dialogInterface, i);
                }
            });
        ...
        public /* synthetic */ void lambda$showKiklikoReportAlert$1(CharSequence[] charSequenceArr, final Callbacks$Callback1 callbacks$Callback1, DialogInterface dialogInterface, int i) {
            ...
            if (i == charSequenceArr.length - 1) {
                ChatActivityEnterView.this.parentFragment.showDialog(new ReportAlert(ChatActivityEnterView.this.getContext(), 5, ChatActivityEnterView.this.parentFragment.getResourceProvider()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.67.1
                    {
                        C462267.this = this;
                    }
        ...
        public void onEmojiSelected(String str) {
            ...
            try {
                try {
                    ...
                    CharSequence replaceEmoji = Emoji.replaceEmoji(str, ChatActivityEnterView.this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(20), false);
        ...
        public void onCustomEmojiSelected(final long j, final TLRPC$Document tLRPC$Document, final String str, final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$67$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.C462267.this.lambda$onCustomEmojiSelected$2(str, tLRPC$Document, j, z);
                }
            });
        }
        ...
        public void lambda$onGifSelected$3(final View view, final Object obj, final String str, final Object obj2, final boolean z, final int i, final String str2) {
            ...
            if ((!isInScheduleMode() || i != 0) && (!ChatActivityEnterView.this.isTemplatesChannel(true, true) || str2 != null)) {
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$67$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatActivityEnterView.C462267.this.lambda$onGifSelected$4(obj, str, z, i, obj2, str2);
                    }
                };
            ...
            AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$67$$ExternalSyntheticLambda4
                @Override // org.telegram.p042ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                public final void didSelectDate(boolean z2, int i2, String str3) {
                    ChatActivityEnterView.C462267.this.lambda$onGifSelected$3(view, obj, str, obj2, z2, i2, str3);
                }
        ...
        public /* synthetic */ void lambda$onGifSelected$4(Object obj, String str, boolean z, int i, Object obj2, String str2) {
            ...
            if (obj instanceof TLRPC$Document) {
                ...
                hashMap.put(TtmlNode.ATTR_ID, tLRPC$BotInlineResult.f1598id);
        ...
        public void onClearEmojiRecent() {
            ...
            builder.setPositiveButton(LocaleController.getString("ClearButton", C3630R.string.ClearForAll), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$67$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.C462267.this.lambda$onClearEmojiRecent$5(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), null);
        ...
        public void onShowStickerSet(TLRPC$StickerSet tLRPC$StickerSet, TLRPC$InputStickerSet tLRPC$InputStickerSet) {
            if (ChatActivityEnterView.this.trendingStickersAlert == null || ChatActivityEnterView.this.trendingStickersAlert.isDismissed()) {
                ...
                if (tLRPC$StickerSet != null) {
                    ...
                    tLRPC$InputStickerSet.f1623id = tLRPC$StickerSet.f1634id;
                }
        ...
        public void showTrendingStickersAlert(TrendingStickersLayout trendingStickersLayout) {
            ...
            if (baseFragment != null) {
                ChatActivityEnterView.this.trendingStickersAlert = new TrendingStickersAlert(ChatActivityEnterView.this.getContext(), baseFragment, trendingStickersLayout, ChatActivityEnterView.this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatActivityEnterView.67.2
                    {
                        C462267.this = this;
                    }

                    @Override // org.telegram.p042ui.Components.TrendingStickersAlert, org.telegram.p042ui.ActionBar.BottomSheet, android.app.Dialog, android.content.DialogInterface
                    public void dismiss() {
                        super.dismiss();
    ...
    public void showPopup(final int i, int i2, boolean z) {
        ...
        if (i == 1) {
            ...
            if (i2 == 2) {
                i6 = AndroidUtilities.m102dp(280);
            }
            if (viewGroup != null) {
    ...
    public void setSearchingTypeInternal(int i, boolean z) {
        ...
        if (z2 != (this.searchingType != 0)) {
            ...
            if (!z) {
                ...
                this.searchAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.73
                    {
                        ChatActivityEnterView.this = this;
                    }
    ...
    public void onSizeChanged(int i, boolean z) {
        ...
        if (i > AndroidUtilities.m102dp(50) && this.keyboardVisible && !AndroidUtilities.isInMultiwindow) {
            if (z) {
        ...
        if (isPopupShowing()) {
            ...
            if (this.currentPopupContentType == 2) {
                i2 = AndroidUtilities.m102dp(280);
            }
            View view = null;
        ...
        if (i == NotificationCenter.templatesDidChanged) {
            ...
            if (i == NotificationCenter.recordProgressChanged) {
                ...
                if (i == NotificationCenter.recordStartError || i == NotificationCenter.recordStopped) {
                    ...
                    ImageView imageView = this.recordedAudioPlayButton;
                    if (imageView != null) {
                        imageView.setContentDescription(LocaleController.getString("AccActionPlay", C3630R.string.AccActionPlay));
                    }
                    SeekBarWaveformView seekBarWaveformView = this.recordedAudioSeekBar;
                    if (seekBarWaveformView != null) {
                    ...
                    if (((Boolean) objArr[6]).booleanValue() || ((Long) objArr[3]).longValue() != this.dialog_id || (tLRPC$ChatFull = this.info) == null || tLRPC$ChatFull.slowmode_seconds == 0 || (chat = this.accountInstance.getMessagesController().getChat(Long.valueOf(this.info.f1601id))) == null || ChatObject.hasAdminRights(chat)) {
                        return;
                    }
    ...
    public void checkStickresExpandHeight() {
        ...
        int currentActionBarHeight = (((this.originalViewHeight - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C3702ActionBar.getCurrentActionBarHeight()) - getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
        if (this.searchingType == 2) {
            currentActionBarHeight = Math.min(currentActionBarHeight, AndroidUtilities.m102dp(120) + i);
        }
        ...
        if (i2 > currentActionBarHeight) {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.75
                {
                    ChatActivityEnterView.this = this;
                }
        ...
        animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.76
            {
                ChatActivityEnterView.this = this;
            }
    ...
    public void setStickersExpanded(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z3 || this.stickersExpanded != z) {
            ...
            if (this.stickersExpanded) {
                ...
                int currentActionBarHeight = (((height - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C3702ActionBar.getCurrentActionBarHeight()) - getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
                this.stickersExpandedHeight = currentActionBarHeight;
                if (this.searchingType == 2) {
                    this.stickersExpandedHeight = Math.min(currentActionBarHeight, AndroidUtilities.m102dp(120) + i);
                }
                this.emojiView.getLayoutParams().height = this.stickersExpandedHeight;
                this.sizeNotifierLayout.requestLayout();
                if (this.shouldDrawBackground) {
            ...
            if (imageView != null) {
                if (this.stickersExpanded) {
                    imageView.setContentDescription(LocaleController.getString("AccDescrCollapsePanel", C3630R.string.AccDescrCollapsePanel));
                } else {
                    imageView.setContentDescription(LocaleController.getString("AccDescrExpandPanel", C3630R.string.AccDescrExpandPanel));
                }
            }
        }
    }
    ...
    public class SlideTextView extends View {
        ...
        public SlideTextView(Context context) {
            ...
            this.smallSize = AndroidUtilities.displaySize.x <= AndroidUtilities.m102dp(320);
            TextPaint textPaint = new TextPaint(1);
            this.grayPaint = textPaint;
            textPaint.setTextSize(AndroidUtilities.m102dp(this.smallSize ? 13 : 15));
            TextPaint textPaint2 = new TextPaint(1);
            this.bluePaint = textPaint2;
            textPaint2.setTextSize(AndroidUtilities.m102dp(15));
            ...
            this.slideToCancelString = LocaleController.getString("SlideToCancel", C3630R.string.SlideToCancel);
            this.slideToCancelString = this.slideToCancelString.charAt(0) + this.slideToCancelString.substring(1).toLowerCase();
            String upperCase = LocaleController.getString("Cancel", C3630R.string.Cancel).toUpperCase();
        ...
        public void updateColors() {
            ...
            Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m102dp(60), 0, ColorUtils.setAlphaComponent(ChatActivityEnterView.this.getThemedColor(i), 26));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int width = staticLayout.getWidth() + AndroidUtilities.m102dp(16);
            this.grayPaint.setColor(ChatActivityEnterView.this.getThemedColor(Theme.key_chat_recordTime));
            ...
            if (this.smallSize) {
                this.xOffset = AndroidUtilities.m102dp(16);
            } else {
                long currentTimeMillis = System.currentTimeMillis() - this.lastUpdateTime;
                this.lastUpdateTime = System.currentTimeMillis();
                if (this.cancelToProgress == BitmapDescriptorFactory.HUE_RED && this.slideProgress > 0.8f) {
                    if (this.moveForward) {
                        float m102dp = this.xOffset + ((AndroidUtilities.m102dp(3) / 250.0f) * ((float) currentTimeMillis));
                        this.xOffset = m102dp;
                        if (m102dp > AndroidUtilities.m102dp(6)) {
                            this.xOffset = AndroidUtilities.m102dp(6);
                            this.moveForward = false;
                        }
                    } else {
                        float m102dp2 = this.xOffset - ((AndroidUtilities.m102dp(3) / 250.0f) * ((float) currentTimeMillis));
                        this.xOffset = m102dp2;
                        if (m102dp2 < (-AndroidUtilities.m102dp(6))) {
                            this.xOffset = -AndroidUtilities.m102dp(6);
            ...
            int measuredWidth = ((int) ((getMeasuredWidth() - this.slideToCancelWidth) / 2.0f)) + AndroidUtilities.m102dp(5);
            ...
            float m102dp3 = ((measuredWidth + ((f2 * (1.0f - f3)) * this.slideProgress)) - (f * f3)) + AndroidUtilities.m102dp(16);
            float m102dp4 = z ? 0.0f : this.cancelToProgress * AndroidUtilities.m102dp(12);
            if (this.cancelToProgress != 1.0f) {
                ...
                canvas.save();
                canvas.clipRect((ChatActivityEnterView.this.recordTimerView == null ? 0.0f : ChatActivityEnterView.this.recordTimerView.getLeftProperty()) + AndroidUtilities.m102dp(4), BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight());
                canvas.save();
                int i = (int) m102dp3;
                canvas.translate((i - AndroidUtilities.m102dp(this.smallSize ? 7 : 10)) + translationX, m102dp4);
                canvas.drawPath(this.arrowPath, this.arrowPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(i + translationX, ((getMeasuredHeight() - this.slideToLayout.getHeight()) / 2.0f) + m102dp4);
            ...
            if (!z) {
                measuredHeight -= AndroidUtilities.m102dp(12) - m102dp4;
            }
            float f4 = z ? m102dp3 + primaryHorizontal : measuredWidth2;
            ...
            this.cancelRect.inset(-AndroidUtilities.m102dp(16), -AndroidUtilities.m102dp(16));
    ...
    public class TimerView extends View {
        ...
        public TimerView(Context context) {
            ...
            this.replaceDistance = AndroidUtilities.m102dp(15);
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (botCommandsMenuView != null && botCommandsMenuView.getTag() != null) {
            ...
            if (senderSelectView != null && senderSelectView.getVisibility() == 0) {
                ...
                marginLayoutParams.leftMargin = this.initialSenderSelectViewLeftMargin + this.botCommandsMenuButton.getMeasuredWidth() + AndroidUtilities.m102dp(6);
                i3 = marginLayoutParams.width + AndroidUtilities.m102dp(6);
            } else {
                i3 = -AndroidUtilities.m102dp(3);
            }
            ...
            if (frameLayout != null) {
                ...
                BotCommandsMenuView botCommandsMenuView2 = this.botCommandsMenuButton;
                marginLayoutParams2.leftMargin = m102dp + (botCommandsMenuView2 == null ? 0 : botCommandsMenuView2.getMeasuredWidth() + i3);
            }
            ...
            marginLayoutParams3.leftMargin = m102dp2 + (botCommandsMenuView3 == null ? 0 : botCommandsMenuView3.getMeasuredWidth() + i3);
            EditTextCaption editTextCaption = this.messageEditText;
            if (editTextCaption != null) {
                ViewGroup.MarginLayoutParams marginLayoutParams4 = (ViewGroup.MarginLayoutParams) editTextCaption.getLayoutParams();
                int m102dp3 = AndroidUtilities.m102dp(57);
                BotCommandsMenuView botCommandsMenuView4 = this.botCommandsMenuButton;
                marginLayoutParams4.leftMargin = m102dp3 + (botCommandsMenuView4 == null ? 0 : botCommandsMenuView4.getMeasuredWidth() + i3);
            }
        } else {
            SenderSelectView senderSelectView2 = this.senderSelectView;
            if (senderSelectView2 != null && senderSelectView2.getVisibility() == 0) {
                ...
                if (frameLayout2 != null) {
                    ((ViewGroup.MarginLayoutParams) frameLayout2.getLayoutParams()).leftMargin = AndroidUtilities.m102dp(16) + i4;
                }
                ((ViewGroup.MarginLayoutParams) this.emojiButton.getLayoutParams()).leftMargin = AndroidUtilities.m102dp(16) + i4;
                EditTextCaption editTextCaption2 = this.messageEditText;
                if (editTextCaption2 != null) {
                    ((ViewGroup.MarginLayoutParams) editTextCaption2.getLayoutParams()).leftMargin = AndroidUtilities.m102dp(63) + i4;
                }
            } else {
                FrameLayout frameLayout3 = this.formattingButton;
                if (frameLayout3 != null) {
                    ((ViewGroup.MarginLayoutParams) frameLayout3.getLayoutParams()).leftMargin = AndroidUtilities.m102dp(3);
                }
                ((ViewGroup.MarginLayoutParams) this.emojiButton.getLayoutParams()).leftMargin = AndroidUtilities.m102dp(3);
                EditTextCaption editTextCaption3 = this.messageEditText;
                if (editTextCaption3 != null) {
                    ((ViewGroup.MarginLayoutParams) editTextCaption3.getLayoutParams()).leftMargin = AndroidUtilities.m102dp(50);
                }
            }
        }
        updateBotCommandsMenuContainerTopPadding();
        ...
        if (chatActivityBotWebViewButton != null) {
            ...
            this.botWebViewButton.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.m102dp(2);
    ...
    @Override // org.telegram.p042ui.Components.BlurredFrameLayout, android.view.ViewGroup, android.view.View
    public void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0, AndroidUtilities.m102dp(2), getMeasuredWidth(), getMeasuredHeight());
    ...
    public void setHorizontalPadding(float f, float f2, boolean z) {
        ...
        float f3 = 1.0f - f2;
        float f4 = (-f) * f3;
        float f5 = (-(AndroidUtilities.m102dp(40) + f)) * f3;
        this.emojiButtonPaddingScale = (f2 * 0.5f) + 0.5f;
        this.emojiButtonPaddingAlpha = f2;
        updateEmojiButtonParams();
        float f6 = -f4;
        this.emojiButton.setTranslationX(f6);
        this.messageTextPaddingTranslationX = f6 - (AndroidUtilities.m102dp(31) * f3);
        RLottieImageView rLottieImageView = this.recordDeleteImageView;
        if (rLottieImageView != null) {
        ...
        if (this.messageEditText != null) {
            ...
            this.messageEditText.setHintRightOffset(AndroidUtilities.lerp(AndroidUtilities.m102dp(30), 0, f2));
        }
    }
