...
import org.telegram.p042ui.Components.ChatAttachAlertPhotoLayoutPreview;
...
/* renamed from: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview */
...
public class ChatAttachAlertPhotoLayoutPreview extends ChatAttachAlert.AttachAlertLayout {
    ...
    public ChatAttachAlertPhotoLayoutPreview(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.parentAlert.actionBar.addView(actionBarMenuItem, 0, LayoutHelper.createFrame(-2, -1, 51, AndroidUtilities.isTablet() ? 64 : 56, 0, 40, 0));
        ...
        this.header.setText(LocaleController.getString("AttachMediaPreview", C3630R.string.AttachMediaPreview));
        this.header.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        this.header.setCompoundDrawablePadding(AndroidUtilities.m102dp(4));
        this.header.setPadding(0, 0, AndroidUtilities.m102dp(10), 0);
        this.header.setAlpha(BitmapDescriptorFactory.HUE_RED);
        actionBarMenuItem.addView(this.header, LayoutHelper.createFrame(-2, -2, 16, 16, 0, 0, 0));
        ...
        this.listView.setPadding(0, 0, 0, AndroidUtilities.m102dp(46));
        ...
        undoView.setEnterOffsetMargin(AndroidUtilities.m102dp(32));
        addView(this.undoView, LayoutHelper.createFrame(-1, -2, 83, 8, 0, 8, 52));
        this.videoPlayImage = context.getResources().getDrawable(C3630R.C3632drawable.play_mini_video);
    }
    ...
    public /* synthetic */ void lambda$onShow$0(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        ...
        if (currentItemTop > AndroidUtilities.m102dp(7)) {
    ...
    public /* synthetic */ void lambda$onShow$1() {
        ...
        this.parentAlert.getPhotoLayout().previewItem.setIcon(C3630R.C3632drawable.ic_ab_back);
        this.parentAlert.getPhotoLayout().previewItem.setText(LocaleController.getString(C3630R.string.Back));
    }
    ...
    public void onHide() {
        ...
        if (getSelectedItemsCount() > 1 && this.parentAlert.getPhotoLayout() != null) {
            this.parentAlert.getPhotoLayout().previewItem.setIcon(C3630R.C3632drawable.msg_view_file);
            this.parentAlert.getPhotoLayout().previewItem.setText(LocaleController.getString(C3630R.string.AttachMediaPreviewButton));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$GroupCalculator */
    /* loaded from: classes6.dex */
    public class GroupCalculator {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$GroupCalculator$MessageGroupedLayoutAttempt */
        /* loaded from: classes6.dex */
        ...
        /* JADX WARN: Removed duplicated region for block: B:235:0x07cc A[LOOP:2: B:234:0x07ca->B:235:0x07cc, LOOP_END] */
        /*
        ...
        */
        public void calculate() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatAttachAlertPhotoLayoutPreview.GroupCalculator.calculate():void");
        }
        ...
        public int getWidth() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                int i2 = groupedMessagePosition.f1534pw;
        ...
        public float getHeight() {
            ...
            for (int i = 0; i < size; i++) {
                MessageObject.GroupedMessagePosition groupedMessagePosition = this.posArray.get(i);
                float f = groupedMessagePosition.f1533ph;
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (groupedMessagePosition2 != groupedMessagePosition && groupedMessagePosition2.maxX < i3) {
                    ...
                    for (int max = Math.max(groupedMessagePosition2.minY - i, 0); max <= min; max++) {
                        fArr[max] = fArr[max] + groupedMessagePosition2.f1534pw;
                    }
                }
            }
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (groupedMessagePosition2 != groupedMessagePosition && groupedMessagePosition2.maxY < i) {
                    for (int i4 = groupedMessagePosition2.minX; i4 <= groupedMessagePosition2.maxX; i4++) {
                        fArr[i4] = fArr[i4] + groupedMessagePosition2.f1533ph;
                    }
                }
            }
    ...
    public int getCurrentItemTop() {
        ...
        if (top < AndroidUtilities.m102dp(8) || holder == null || holder.getAdapterPosition() != 0) {
            top = m102dp;
        }
    ...
    */
    public void onPreMeasure(int r5, int r6) {
        /*
            ...
            int r0 = org.telegram.p042ui.ActionBar.C3702ActionBar.getCurrentActionBarHeight()
            r5.topMargin = r0
        ...
        L74:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatAttachAlertPhotoLayoutPreview.onPreMeasure(int, int):void");
    }
    ...
    public boolean onBackPressed() {
        if (this.parentAlert.isForwardingEditor()) {
            return false;
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (themeDelegate != null && (wallpaperDrawable = themeDelegate.getWallpaperDrawable()) != null) {
            ...
            if (currentItemTop < C3702ActionBar.getCurrentActionBarHeight()) {
                currentItemTop -= AndroidUtilities.m103dp((1.0f - (currentItemTop / C3702ActionBar.getCurrentActionBarHeight())) * i);
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$PreviewGroupsView */
    /* loaded from: classes6.dex */
    public class PreviewGroupsView extends ViewGroup {
        ...
        public PreviewGroupsView(Context context) {
            ...
            this.paddingTop = AndroidUtilities.m102dp(16);
            this.paddingBottom = AndroidUtilities.m102dp(64);
            ...
            this.scroller = new Runnable() { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.2
                ...
                public void run() {
                    ...
                    float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - Math.max(0, computeVerticalScrollOffset - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding())) - AndroidUtilities.m102dp(52));
                    float max2 = Math.max((float) BitmapDescriptorFactory.HUE_RED, ((ChatAttachAlertPhotoLayoutPreview.this.listView.getMeasuredHeight() - (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - computeVerticalScrollOffset)) - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) - AndroidUtilities.m102dp(84));
                    float m102dp2 = AndroidUtilities.m102dp(32);
                    if (max < m102dp2 && computeVerticalScrollOffset > ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) {
                        m102dp = (-(1.0f - (max / m102dp2))) * AndroidUtilities.m102dp(6);
                    } else {
                        m102dp = max2 < m102dp2 ? AndroidUtilities.m102dp(6) * (1.0f - (max2 / m102dp2)) : 0.0f;
                    }
                    int i = (int) m102dp;
                    if (Math.abs(i) > 0 && ChatAttachAlertPhotoLayoutPreview.this.listView.canScrollVertically(i) && (m102dp <= BitmapDescriptorFactory.HUE_RED || !z)) {
                        ChatAttachAlertPhotoLayoutPreview.access$1416(ChatAttachAlertPhotoLayoutPreview.this, m102dp);
            ...
            chatActionCell.setCustomText(LocaleController.getString("AttachMediaDragHint", C3630R.string.AttachMediaDragHint));
        ...
        private int measureHeight() {
            return Math.max(measurePureHeight(), (AndroidUtilities.displaySize.y - C3702ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m102dp(45));
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            while (true) {
                ...
                canvas.translate(BitmapDescriptorFactory.HUE_RED, measure);
                f += measure;
            ...
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                ...
                canvas.translate(dragTranslate.f1887x, dragTranslate.f1888y);
        ...
        Point dragTranslate() {
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                if (!ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding) {
                    ...
                    this.tmpPoint.f1887x = AndroidUtilities.lerp(rect2.left + (rect.width() / 2.0f), ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchX - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellLeft - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromWidth), this.draggingT);
                    this.tmpPoint.f1888y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1820y + rect2.top + (rect.height() / 2.0f), (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellTop - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromHeight)) + ChatAttachAlertPhotoLayoutPreview.this.draggingCellGroupY, this.draggingT);
                } else {
                    ...
                    this.tmpPoint.f1887x = AndroidUtilities.lerp(rect4.left + (rect3.width() / 2.0f), this.savedDragFromX, this.draggingT / this.savedDraggingT);
                    this.tmpPoint.f1888y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1820y + rect4.top + (rect3.height() / 2.0f), this.savedDragFromY, this.draggingT / this.savedDraggingT);
                }
                return this.tmpPoint;
            }
            Point point = this.tmpPoint;
            point.f1887x = BitmapDescriptorFactory.HUE_RED;
            point.f1888y = BitmapDescriptorFactory.HUE_RED;
            return point;
        }
        ...
        void stopDragging() {
            ...
            this.savedDragFromX = dragTranslate.f1887x;
            this.savedDragFromY = dragTranslate.f1888y;
        ...
        void startDragging(PreviewGroupCell.MediaCell mediaCell) {
            ...
            ChatAttachAlertPhotoLayoutPreview chatAttachAlertPhotoLayoutPreview = ChatAttachAlertPhotoLayoutPreview.this;
            chatAttachAlertPhotoLayoutPreview.draggingCellGroupY = chatAttachAlertPhotoLayoutPreview.draggingCell.groupCell.f1820y;
            ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding = false;
            this.draggingT = BitmapDescriptorFactory.HUE_RED;
            invalidate();
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator != null) {
        ...
        /* renamed from: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$PreviewGroupsView$GroupingPhotoViewerProvider */
        /* loaded from: classes6.dex */
            ...
            public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC$FileLocation tLRPC$FileLocation, int i, boolean z) {
                ...
                if (i >= 0 && i < this.photos.size() && isPhotoChecked(i) && (photoEntry = this.photos.get(i)) != null) {
                    ...
                    if (previewGroupCell != null && mediaCell != null) {
                        ...
                        placeProviderObject.viewY = iArr[1] + ((int) previewGroupCell.f1820y);
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.onTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$PreviewGroupsView$PreviewGroupCell */
        /* loaded from: classes6.dex */
        public class PreviewGroupCell {
            ...
            private PreviewGroupCell() {
                this.f1820y = BitmapDescriptorFactory.HUE_RED;
                this.indexStart = 0;
                ...
                this.padding = AndroidUtilities.m102dp(4);
                int m102dp = AndroidUtilities.m102dp(2);
                this.gap = m102dp;
                this.halfGap = m102dp / 2;
            ...
            /* JADX INFO: Access modifiers changed from: private */
            /* renamed from: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$PreviewGroupsView$PreviewGroupCell$MediaCell */
            /* loaded from: classes6.dex */
            public class MediaCell {
                ...
                public void setImage(final MediaController.PhotoEntry photoEntry) {
                    ...
                    if (this.image == null) {
                        ...
                        this.image.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$PreviewGroupsView$PreviewGroupCell$MediaCell$$ExternalSyntheticLambda1
                ...
                public void layout(GroupCalculator groupCalculator, MessageObject.GroupedMessagePosition groupedMessagePosition, boolean z) {
                    ...
                    float f5 = f3 / f4;
                    float f6 = groupedMessagePosition.f1533ph / f4;
                    this.scale = 1.0f;
                    this.rect.set(f2, f5, (groupedMessagePosition.f1534pw / i) + f2, f6 + f5);
                    float m102dp = AndroidUtilities.m102dp(2);
                    float m102dp2 = AndroidUtilities.m102dp(SharedConfig.bubbleRadius - 1);
                    RectF rectF4 = this.roundRadiuses;
                    int i2 = this.positionFlags;
                    float f7 = (i2 & 5) == 5 ? m102dp2 : m102dp;
                    float f8 = (i2 & 6) == 6 ? m102dp2 : m102dp;
                    float f9 = (i2 & 10) == 10 ? m102dp2 : m102dp;
                    if ((i2 & 9) == 9) {
                        m102dp = m102dp2;
                    }
                    rectF4.set(f7, f8, f9, m102dp);
                    if (this.fromRect == null) {
                ...
                private void drawPhotoIndex(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    int m103dp = AndroidUtilities.m103dp(1.2f);
                    int i = (m102dp + m103dp) * 2;
                    int i2 = m103dp * 4;
                    if (str != null && (this.indexBitmap == null || (str2 = this.indexBitmapText) == null || !str2.equals(str))) {
                        ...
                        this.textPaint.setTextSize(AndroidUtilities.m103dp(f5));
                        float f6 = i / 2.0f;
                        ...
                        this.strokePaint.setStrokeWidth(m103dp);
                        canvas2.drawCircle(f7, f7, f8, this.strokePaint);
                        canvas2.drawText(str, f6 - (this.textPaint.measureText(str) / 2.0f), f6 + AndroidUtilities.m102dp(1) + AndroidUtilities.m103dp(f5 / 4.0f), this.textPaint);
                ...
                private void drawDuration(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    if (str != null) {
                        if (this.videoDurationBitmap == null || (str2 = this.videoDurationBitmapText) == null || !str2.equals(str)) {
                            ...
                            this.videoDurationTextPaint.setTextSize(m102dp);
                            float intrinsicWidth = ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + this.videoDurationTextPaint.measureText(str) + AndroidUtilities.m102dp(15);
                            float max = Math.max(m102dp, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + AndroidUtilities.m102dp(4));
                            ...
                            canvas2.drawRoundRect(rectF, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), Theme.chat_timeBackgroundPaint);
                            int m102dp2 = AndroidUtilities.m102dp(5);
                            int intrinsicHeight = (int) ((max - ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight()) / 2.0f);
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.setBounds(m102dp2, intrinsicHeight, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + m102dp2, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + intrinsicHeight);
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.draw(canvas2);
                            canvas2.drawText(str, AndroidUtilities.m102dp(18), m102dp + AndroidUtilities.m103dp(-0.7f), this.videoDurationTextPaint);
                ...
                public void startRevealMedia(float f, float f2) {
                    ...
                    duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$PreviewGroupsView$PreviewGroupCell$MediaCell$$ExternalSyntheticLambda0
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                /*
                    ...
                    To view partially-correct add '--show-bad-code' argument
                */
                public boolean draw(android.graphics.Canvas r20, float r21, boolean r22) {
                    /*
                        Method dump skipped, instructions count: 779
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.PreviewGroupCell.MediaCell.draw(android.graphics.Canvas, float, boolean):boolean");
                }
            }
            ...
            public void setGroup(GroupCalculator groupCalculator, boolean z) {
                ...
                while (i3 < size3) {
                    ...
                    if (!groupCalculator.positions.containsKey(mediaCell3.photoEntry)) {
                        if (mediaCell3.scale <= BitmapDescriptorFactory.HUE_RED && mediaCell3.lastUpdate + 200 <= elapsedRealtime) {
