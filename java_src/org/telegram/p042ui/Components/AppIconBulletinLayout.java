...
public class AppIconBulletinLayout extends Bulletin.ButtonLayout {
    ...
    public AppIconBulletinLayout(Context context, LauncherIconController.LauncherIcon launcherIcon, Theme.ResourcesProvider resourcesProvider) {
        ...
        adaptiveIconImageView.setOuterPadding(AndroidUtilities.m102dp(8));
        adaptiveIconImageView.setBackgroundOuterPadding(AndroidUtilities.m102dp(24));
        adaptiveIconImageView.setForeground(launcherIcon.foreground);
        textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C3630R.string.AppIconChangedTo, LocaleController.getString(launcherIcon.title))));
    }
}
