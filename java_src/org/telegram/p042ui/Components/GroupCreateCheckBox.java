...
public class GroupCreateCheckBox extends View {
    ...
    public GroupCreateCheckBox(Context context) {
        ...
        this.innerRadDiff = AndroidUtilities.m102dp(2);
        this.checkPaint.setStrokeWidth(AndroidUtilities.m103dp(1.5f));
        eraser2.setStrokeWidth(AndroidUtilities.m102dp(28));
        this.drawBitmap = Bitmap.createBitmap(AndroidUtilities.m102dp(24), AndroidUtilities.m102dp(24), Bitmap.Config.ARGB_4444);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getVisibility() == 0 && this.progress != BitmapDescriptorFactory.HUE_RED) {
            ...
            eraser2.setStrokeWidth(AndroidUtilities.m102dp(30));
            ...
            if (f < 0.2f) {
                m102dp = (AndroidUtilities.m102dp(2) * f) / 0.2f;
            } else {
                m102dp = f < 0.4f ? AndroidUtilities.m102dp(2) - ((AndroidUtilities.m102dp(2) * (f - 0.2f)) / 0.2f) : 0.0f;
            }
            if (f3 != BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(measuredWidth, measuredHeight, ((measuredWidth - AndroidUtilities.m102dp(2)) + (AndroidUtilities.m102dp(2) * f3)) - m102dp, this.backgroundPaint);
            }
            float f4 = (measuredWidth - this.innerRadDiff) - m102dp;
            ...
            float m102dp2 = AndroidUtilities.m102dp(10) * f3 * this.checkScale;
            float m102dp3 = AndroidUtilities.m102dp(5) * f3 * this.checkScale;
            int m102dp4 = measuredWidth - AndroidUtilities.m102dp(1);
            float sqrt = (float) Math.sqrt((m102dp3 * m102dp3) / 2.0f);
            float f7 = m102dp4;
            float m102dp5 = measuredHeight + AndroidUtilities.m102dp(4);
            canvas.drawLine(f7, m102dp5, f7 - sqrt, m102dp5 - sqrt, this.checkPaint);
            float sqrt2 = (float) Math.sqrt((m102dp2 * m102dp2) / 2.0f);
            float m103dp = m102dp4 - AndroidUtilities.m103dp(1.2f);
            canvas.drawLine(m103dp, m102dp5, m103dp + sqrt2, m102dp5 - sqrt2, this.checkPaint);
        }
    }
}
