...
public class InviteLinkBottomSheet extends BottomSheet {
    ...
    public InviteLinkBottomSheet(Context context, final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, TLRPC$ChatFull tLRPC$ChatFull, final HashMap<Long, TLRPC$User> hashMap, final BaseFragment baseFragment, long j, boolean z, boolean z2) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.1
            ...
            */
            protected void onDraw(android.graphics.Canvas r13) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.InviteLinkBottomSheet.C51151.onDraw(android.graphics.Canvas):void");
            }
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.2
            ...
            public void onMeasure(int i, int i2) {
                if (this.lastH != View.MeasureSpec.getSize(i2)) {
                    ...
                    if (i4 < (i3 - measuredHeight) + AndroidUtilities.m102dp(60)) {
        ...
        this.titleTextView.setPadding(AndroidUtilities.m102dp(23), 0, AndroidUtilities.m102dp(23), 0);
        this.titleTextView.setGravity(16);
        this.titleTextView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        if (!z) {
            if (tLRPC$TL_chatInviteExported.expired) {
                this.titleTextView.setText(LocaleController.getString("ExpiredLink", C3630R.string.ExpiredLink));
            } else if (tLRPC$TL_chatInviteExported.revoked) {
                this.titleTextView.setText(LocaleController.getString("RevokedLink", C3630R.string.RevokedLink));
            } else {
                this.titleTextView.setText(LocaleController.getString("InviteLink", C3630R.string.InviteLink));
            }
    ...
    private void updateColorForView(View view) {
        if (view instanceof HeaderCell) {
            ...
            CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
        ...
        if (childViewHolder != null) {
            if (childViewHolder.getItemViewType() == 7) {
                CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow), 0, 0);
                combinedDrawable2.setFullsize(true);
                view.setBackgroundDrawable(combinedDrawable2);
            } else if (childViewHolder.getItemViewType() == 2) {
                CombinedDrawable combinedDrawable3 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow), 0, 0);
    ...
    private void loadCreator() {
        ...
        tLRPC$TL_users_getUsers.f1758id.add(MessagesController.getInstance(UserConfig.selectedAccount).getInputUser(this.invite.admin_id));
    ...
    */
    private void updateRows() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.InviteLinkBottomSheet.updateRows():void");
    }
    ...
    public class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 3:
                    ...
                    linkActionView.setDelegate(new C51201());
                ...
                case 4:
                    ...
                    CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(context, C3630R.C3632drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    combinedDrawable.setFullsize(true);
                ...
                case 5:
                    ...
                    flickerLoadingView.setPaddingLeft(AndroidUtilities.m102dp(10));
                ...
                case 6:
                    headerCell = new View(this, context) { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.Adapter.2
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(5), 1073741824));
                        }
                    };
                    break;
                case 7:
                    View shadowSectionCell = new ShadowSectionCell(context, 12);
                    CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(context, C3630R.C3632drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow), 0, 0);
                    combinedDrawable2.setFullsize(true);
        ...
        /* loaded from: classes6.dex */
        public class C51201 implements LinkActionView.Delegate {
            ...
            public void revokeLink() {
                ...
                if (baseFragment instanceof ManageLinksActivity) {
                    ...
                    ConnectionsManager.getInstance(((BottomSheet) InviteLinkBottomSheet.this).currentAccount).sendRequest(tLRPC$TL_messages_editExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda2
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            InviteLinkBottomSheet.Adapter.C51201.this.lambda$revokeLink$1(tLObject, tLRPC$TL_error);
                        }
                    });
                }
                InviteLinkBottomSheet.this.dismiss();
            ...
            public /* synthetic */ void lambda$revokeLink$1(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteLinkBottomSheet.Adapter.C51201.this.lambda$revokeLink$0(tLRPC$TL_error, tLObject);
                    }
                });
            }
            ...
            public void removeLink() {
                ...
                if (baseFragment instanceof ManageLinksActivity) {
                    ...
                    ConnectionsManager.getInstance(((BottomSheet) InviteLinkBottomSheet.this).currentAccount).sendRequest(tLRPC$TL_messages_deleteExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda3
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            InviteLinkBottomSheet.Adapter.C51201.this.lambda$removeLink$3(tLObject, tLRPC$TL_error);
                        }
                    });
                }
                InviteLinkBottomSheet.this.dismiss();
            ...
            public /* synthetic */ void lambda$removeLink$3(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteLinkBottomSheet.Adapter.C51201.this.lambda$removeLink$2(tLRPC$TL_error);
                    }
                });
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == inviteLinkBottomSheet.creatorHeaderRow) {
                    headerCell.setText(LocaleController.getString("LinkCreatedeBy", C3630R.string.LinkCreatedeBy));
                    ...
                    if (i5 > 0) {
                        ...
                        headerCell.setText(LocaleController.getString("NoOneJoined", C3630R.string.NoOneJoined));
                    }
                ...
                if (i == inviteLinkBottomSheet2.creatorRow) {
                    ...
                    if (tLRPC$User2 != null) {
                        ...
                        str = LocaleController.formatStringInternal(C3630R.string.invite_link_created_date, LocaleController.formatImportedDate(InviteLinkBottomSheet.this.invite.date));
                    } else {
                        str = null;
                    }
                    ...
                    if (tLRPC$ChatFull != null && tLRPC$User2 != null && tLRPC$ChatFull.participants != null) {
                        while (true) {
                            if (i4 >= InviteLinkBottomSheet.this.info.participants.participants.size()) {
                                break;
                            } else if (InviteLinkBottomSheet.this.info.participants.participants.get(i4).user_id == tLRPC$User2.f1762id) {
                                ...
                                if (tLRPC$ChatParticipant instanceof TLRPC$TL_chatChannelParticipant) {
                                    ...
                                    if (!TextUtils.isEmpty(tLRPC$ChannelParticipant.rank)) {
                                        ...
                                        str2 = LocaleController.getString("ChannelCreator", C3630R.string.ChannelCreator);
                                    } else if (tLRPC$ChannelParticipant instanceof TLRPC$TL_channelParticipantAdmin) {
                                        str2 = LocaleController.getString("ChannelAdmin", C3630R.string.ChannelAdmin);
                                    }
                                } else {
                    ...
                    formatStringInternal = LocaleController.formatStringInternal(C3630R.string.invite_link_joined_date, LocaleController.formatImportedDate(tLRPC$TL_chatInviteImporter.date));
                ...
                if (tLRPC$TL_chatInviteExported2.revoked) {
                    timerPrivacyCell.setText(LocaleController.getString("LinkIsNoActive", C3630R.string.LinkIsNoActive));
                    ...
                    if (i9 > 0 && i9 == tLRPC$TL_chatInviteExported2.usage) {
                        timerPrivacyCell.setText(LocaleController.getString("LinkIsExpiredLimitReached", C3630R.string.LinkIsExpiredLimitReached));
                        return;
                    }
                    timerPrivacyCell.setText(LocaleController.getString("LinkIsExpired", C3630R.string.LinkIsExpired));
                    ...
                    if (j > 86400000) {
                        timerPrivacyCell.setText(LocaleController.formatString("LinkExpiresIn", C3630R.string.LinkExpiresIn, LocaleController.formatDateAudio(i10, false)));
                        return;
                    }
                    long j2 = j / 1000;
                    int i11 = (int) (j2 % 60);
                    ...
                    timerPrivacyCell.setText(LocaleController.formatString("LinkExpiresInTime", C3630R.string.LinkExpiresInTime, sb2));
                } else {
    ...
    public class EmptyHintRow extends FrameLayout {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(84), 1073741824));
        }
    }
