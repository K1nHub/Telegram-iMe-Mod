...
public class ViewPagerFixed extends FrameLayout {
    ...
    public TabsView createTabsView(boolean z, int i, TabsView.TabType tabType) {
        TabsView tabsView = new TabsView(getContext(), z, i, this.resourcesProvider) { // from class: org.telegram.ui.Components.ViewPagerFixed.3
            @Override // org.telegram.p042ui.Components.ViewPagerFixed.TabsView
        ...
        this.tabsView.setDelegate(new TabsView.TabsViewDelegate() { // from class: org.telegram.ui.Components.ViewPagerFixed.4
            @Override // org.telegram.p042ui.Components.ViewPagerFixed.TabsView.TabsViewDelegate
    ...
    */
    private boolean prepareForMoving(android.view.MotionEvent r5, boolean r6) {
        ...
        L77:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ViewPagerFixed.prepareForMoving(android.view.MotionEvent, boolean):boolean");
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ViewPagerFixed.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public static class TabsView extends FrameLayout {
        ...
        public void addTabWithIcon(int i, String str, int i2) {
            ...
            this.allTabsWidth += tabWithIcon.getWidth(true, this.textPaint) + AndroidUtilities.m102dp(32);
        ...
        public class TabWithIcon extends Tab {
            ...
            @Override // org.telegram.p042ui.Components.ViewPagerFixed.TabsView.Tab
            public int getWidth(boolean z, TextPaint textPaint) {
                int ceil = ((int) Math.ceil(textPaint.measureText(this.title))) + this.icon.getIntrinsicWidth() + AndroidUtilities.m102dp(this.iconPadding);
                this.titleWidth = ceil;
                return Math.max(AndroidUtilities.m102dp(40), ceil);
            }
        }
        ...
        public class TabView extends View {
            ...
            @Override // android.view.View
            public int getId() {
                return this.currentTab.f1955id;
            }

            @Override // android.view.View
            protected void onMeasure(int i, int i2) {
                setMeasuredDimension(this.currentTab.getWidth(false, TabsView.this.textPaint) + AndroidUtilities.m102dp(TabsView.this.tabMarginDp * 2) + TabsView.this.additionalTabWidth, View.MeasureSpec.getSize(i2));
            }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i10;
                int i11;
                if (this.currentTab.f1955id != Integer.MAX_VALUE && TabsView.this.editingAnimationProgress != BitmapDescriptorFactory.HUE_RED) {
                    canvas.save();
                    float f = TabsView.this.editingAnimationProgress * (this.currentPosition % 2 == 0 ? 1.0f : -1.0f);
                    canvas.translate(AndroidUtilities.m103dp(0.66f) * f, BitmapDescriptorFactory.HUE_RED);
                ...
                if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToId != -1) && ((i7 = this.currentTab.f1955id) == i || i7 == i2)) {
                ...
                if (i12 > 0) {
                    ...
                    i9 = Math.max(AndroidUtilities.m102dp(10), i8) + AndroidUtilities.m102dp(10);
                } else {
                    str = null;
                    i8 = 0;
                    i9 = 0;
                }
                if (this.currentTab.f1955id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != BitmapDescriptorFactory.HUE_RED)) {
                    i9 = (int) (i9 + ((AndroidUtilities.m102dp(20) - i9) * TabsView.this.editingStartAnimationProgress));
                }
                int i13 = this.currentTab.titleWidth;
                if (i9 != 0) {
                    i10 = AndroidUtilities.m103dp((str != null ? 1.0f : TabsView.this.editingStartAnimationProgress) * 6.0f) + i9;
                } else {
                    i10 = 0;
                }
                ...
                if (tab instanceof TabWithIcon) {
                    ...
                    canvas.restore();
                    measuredWidth = ((tabWithIcon.icon.getIntrinsicWidth() + measuredWidth2) + AndroidUtilities.m102dp(tabWithIcon.iconPadding)) - AndroidUtilities.m102dp(3);
                }
                if (!TextUtils.equals(this.currentTab.title, this.currentText)) {
                    String str2 = this.currentTab.title;
                    this.currentText = str2;
                    StaticLayout staticLayout = new StaticLayout(Emoji.replaceEmoji(str2, TabsView.this.textPaint.getFontMetricsInt(), AndroidUtilities.m102dp(15), false), TabsView.this.textPaint, AndroidUtilities.m102dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                ...
                if (str != null || (this.currentTab.f1955id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != BitmapDescriptorFactory.HUE_RED))) {
                    ...
                    if (!Theme.hasThemeKey(i5) || !Theme.hasThemeKey(i6)) {
                        ...
                        if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToPosition != -1) && ((i11 = this.currentTab.f1955id) == i || i11 == i2)) {
                    ...
                    int m102dp = measuredWidth + this.currentTab.titleWidth + AndroidUtilities.m102dp(6);
                    int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m102dp(20)) / 2;
                    if (this.currentTab.f1955id == Integer.MAX_VALUE || ((!TabsView.this.isEditing && TabsView.this.editingStartAnimationProgress == BitmapDescriptorFactory.HUE_RED) || str != null)) {
                    ...
                    this.rect.set(m102dp, measuredHeight, m102dp + i9, AndroidUtilities.m102dp(20) + measuredHeight);
                    RectF rectF = this.rect;
                    float f2 = AndroidUtilities.density;
                    canvas.drawRoundRect(rectF, f2 * 11.5f, f2 * 11.5f, TabsView.this.counterPaint);
                    if (str != null) {
                        if (this.currentTab.f1955id != Integer.MAX_VALUE) {
                            TabsView.this.textCounterPaint.setAlpha((int) ((1.0f - TabsView.this.editingStartAnimationProgress) * 255.0f));
                        }
                        RectF rectF2 = this.rect;
                        canvas.drawText(str, rectF2.left + ((rectF2.width() - i8) / 2.0f), measuredHeight + AndroidUtilities.m103dp(14.5f), TabsView.this.textCounterPaint);
                    }
                    if (this.currentTab.f1955id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != BitmapDescriptorFactory.HUE_RED)) {
                        ...
                        float m102dp2 = AndroidUtilities.m102dp(3);
                        canvas.drawLine(this.rect.centerX() - m102dp2, this.rect.centerY() - m102dp2, this.rect.centerX() + m102dp2, this.rect.centerY() + m102dp2, TabsView.this.deletePaint);
                        canvas.drawLine(this.rect.centerX() - m102dp2, this.rect.centerY() + m102dp2, this.rect.centerX() + m102dp2, this.rect.centerY() - m102dp2, TabsView.this.deletePaint);
                    }
                }
                if (this.currentTab.f1955id == Integer.MAX_VALUE || TabsView.this.editingAnimationProgress == BitmapDescriptorFactory.HUE_RED) {
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                accessibilityNodeInfo.setSelected((this.currentTab == null || TabsView.this.selectedTabId == -1 || this.currentTab.f1955id != TabsView.this.selectedTabId) ? false : true);
            }
        }
        ...
        public TabsView(Context context, boolean z, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.Components.ViewPagerFixed.TabsView.2
                ...
                protected boolean canHighlightChildAt(View view, float f, float f2) {
                    if (TabsView.this.isEditing) {
                        ...
                        float m102dp = AndroidUtilities.m102dp(6);
                        if (tabView.rect.left - m102dp < f && tabView.rect.right + m102dp > f) {
                            return false;
                        }
                    }
                ...
                public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i2) {
                    LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.ViewPagerFixed.TabsView.3.1
                        ...
                        protected void onTargetFound(View view, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                            ...
                            if (calculateDxToMakeVisible > 0 || (calculateDxToMakeVisible == 0 && view.getLeft() - AndroidUtilities.m102dp(21) < 0)) {
                                calculateDxToMakeVisible += AndroidUtilities.m102dp(60);
                            } else if (calculateDxToMakeVisible < 0 || (calculateDxToMakeVisible == 0 && view.getRight() + AndroidUtilities.m102dp(21) > TabsView.this.getMeasuredWidth())) {
                                calculateDxToMakeVisible -= AndroidUtilities.m102dp(60);
                            }
            ...
            this.listView.setPadding(AndroidUtilities.m102dp(7), 0, AndroidUtilities.m102dp(7), 0);
        ...
        public /* synthetic */ void lambda$new$0(View view, int i, float f, float f2) {
            ...
            if (this.delegate.canPerformActions()) {
                ...
                if (i != this.currentPosition || (tabsViewDelegate = this.delegate) == null) {
                    scrollToTab(tabView.currentTab.f1955id, i);
                } else {
        ...
        public void addTab(int i, String str) {
            ...
            this.allTabsWidth += tab.getWidth(true, this.textPaint) + AndroidUtilities.m102dp(this.tabMarginDp * 2);
            this.tabs.add(tab);
        }
        ...
        private void updateTabsWidths() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                this.positionToX.put(i, (this.additionalTabWidth / 2) + m102dp);
                m102dp += width + AndroidUtilities.m102dp(this.tabMarginDp * 2) + this.additionalTabWidth;
            }
        }
        ...
        */
        protected boolean drawChild(android.graphics.Canvas r10, android.view.View r11, long r12) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ViewPagerFixed.TabsView.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
        }

        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            if (!this.tabs.isEmpty()) {
                int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m102dp(7)) - AndroidUtilities.m102dp(7);
        ...
        public void setIsEditing(boolean z) {
            ...
            for (int i = 0; i < size; i++) {
                arrayList.get(i);
                tLRPC$TL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(arrayList.get(i).f1537id));
            }
        ...
        public class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            public long getItemId(int i) {
                return ((Tab) TabsView.this.tabs.get(i)).f1955id;
            }
        ...
        while (true) {
            ...
            if (viewArr[i] != null && viewArr[i].getVisibility() == 0 && (findRecyclerView = findRecyclerView(this.viewPages[i])) != null) {
                for (int i2 = 0; i2 < findRecyclerView.getChildCount(); i2++) {
                    ...
                    if (childAt.getY() < AndroidUtilities.m102dp(203) + AndroidUtilities.m102dp(100)) {
