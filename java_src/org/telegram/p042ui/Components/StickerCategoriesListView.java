...
public class StickerCategoriesListView extends RecyclerListView {
    ...
    public StickerCategoriesListView(Context context, final EmojiCategory[] emojiCategoryArr, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        setPadding(0, 0, AndroidUtilities.m102dp(2), 0);
        ...
        setSelectorRadius(AndroidUtilities.m102dp(15));
        setSelectorType(1);
    ...
    public void lambda$new$1(int i, View view) {
        ...
        if (i >= 1 && (emojiCategoryArr = this.categories) != null) {
            ...
            if (getMeasuredWidth() - view.getRight() < m102dp) {
                smoothScrollBy(m102dp - (getMeasuredWidth() - view.getRight()), 0, CubicBezierInterpolator.EASE_OUT_QUINT);
            } else if (view.getLeft() < m102dp) {
                smoothScrollBy(-(m102dp - view.getLeft()), 0, CubicBezierInterpolator.EASE_OUT_QUINT);
            }
    ...
    public void scrollToSelected() {
        final int max = ((-getScrollToStartWidth()) - Math.max(0, this.dontOccupyWidth)) + (this.selectedCategoryIndex * AndroidUtilities.m102dp(34));
        scrollBy(max, 0);
    ...
    public void setBackgroundColor(int i) {
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3630R.C3632drawable.gradient_right).mutate();
        this.leftBoundDrawable = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(i, PorterDuff.Mode.MULTIPLY));
        Drawable mutate2 = getContext().getResources().getDrawable(C3630R.C3632drawable.gradient_left).mutate();
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.backgroundPaint != null) {
            ...
            if (i < i2) {
                int width = (int) (i2 + ((getWidth() + AndroidUtilities.m102dp(32)) * (1.0f - this.categoriesShownT)));
                canvas.drawRect((int) (i + ((getWidth() + AndroidUtilities.m102dp(32)) * (1.0f - this.categoriesShownT))), BitmapDescriptorFactory.HUE_RED, width, getHeight(), this.backgroundPaint);
    ...
    private void drawSelectedHighlight(Canvas canvas) {
        ...
        if (view != null && view2 != null) {
            ...
            canvas.drawRoundRect(this.rect3, AndroidUtilities.m102dp(15), AndroidUtilities.m102dp(15), this.selectedPaint);
        }
    ...
    private void getChildBounds(View view, RectF rectF) {
        ...
        float width = ((view.getWidth() / 2.0f) - AndroidUtilities.m102dp(1)) * (view instanceof CategoryButton ? ((CategoryButton) view).getScale() : 1.0f);
            ...
            if (i == 0) {
                categoryButton = StickerCategoriesListView.this.paddingView = new View(StickerCategoriesListView.this.getContext()) { // from class: org.telegram.ui.Components.StickerCategoriesListView.Adapter.1
                    ...
                    protected void onMeasure(int i2, int i3) {
                        ...
                        int size2 = View.MeasureSpec.getSize(i3) - AndroidUtilities.m102dp(4);
                        StickerCategoriesListView stickerCategoriesListView = StickerCategoriesListView.this;
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(stickerCategoriesListView.paddingWidth = Math.max(stickerCategoriesListView.dontOccupyWidth > 0 ? StickerCategoriesListView.this.dontOccupyWidth + AndroidUtilities.m102dp(4) : 0, (int) (size - Math.min(((Adapter.this.getItemCount() - 1) * size2) + AndroidUtilities.m102dp(4), StickerCategoriesListView.this.shownButtonsAtStart * size2))), 1073741824), i3);
                    }
                };
            } else {
                StickerCategoriesListView stickerCategoriesListView = StickerCategoriesListView.this;
    ...
    public class CategoryButton extends RLottieImageView {
        ...
        @Override // org.telegram.p042ui.Components.RLottieImageView
        ...
        protected void onMeasure(int i, int i2) {
            int size = View.MeasureSpec.getSize(i2);
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m102dp(4), 1073741824), View.MeasureSpec.makeMeasureSpec(size, 1073741824));
        }
        ...
        */
        public static /* synthetic */ void lambda$getLocal$1(int r7, java.lang.Integer r8, org.telegram.messenger.Utilities.Callback2 r9) {
            ...
            L56:
                ...
                r7 = r2
            L58:
                org.telegram.messenger.FileLog.m97e(r8)     // Catch: java.lang.Throwable -> L68
            ...
            L6f:
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.StickerCategoriesListView.EmojiGroupFetcher.lambda$getLocal$1(int, java.lang.Integer, org.telegram.messenger.Utilities$Callback2):void");
        }
