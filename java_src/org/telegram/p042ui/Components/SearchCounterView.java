...
public class SearchCounterView extends View {
    ...
    public SearchCounterView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.gravity = 17;
        this.f1932dx = BitmapDescriptorFactory.HUE_RED;
        ...
        if (str3 == null || !str3.equals(str2)) {
            ...
            if (!z3) {
                ...
                if (str2 == null) {
                    ...
                    this.countWidth = Math.max(AndroidUtilities.m102dp(12), (int) Math.ceil(this.textPaint.measureText(str2)));
            ...
            if (z3) {
                ...
                if (this.countLayout != null) {
                    ...
                    int i7 = i2;
                    int max = Math.max(AndroidUtilities.m102dp(i7), (int) Math.ceil(this.textPaint.measureText(str4)));
                    int max2 = Math.max(AndroidUtilities.m102dp(i7), (int) Math.ceil(this.textPaint.measureText(str2)));
                    ...
                    this.f1932dx = this.countOldLayout.getPrimaryHorizontal(i3) - this.countAnimationStableLayout.getPrimaryHorizontal(i4);
                } else {
                    z2 = false;
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.countChangeProgress != 1.0f) {
            float measuredHeight = (getMeasuredHeight() - AndroidUtilities.m102dp(23)) / 2.0f;
            ...
            float f3 = this.f1933x;
            rectF.set(f3, measuredHeight, f + f3 + AndroidUtilities.m102dp(11), AndroidUtilities.m102dp(23) + measuredHeight);
            boolean z = this.countAnimationIncrement;
            if (this.countAnimationInLayout != null) {
                canvas.save();
                float f4 = this.countLeft;
                float m102dp = AndroidUtilities.m102dp(2) + measuredHeight;
                int m102dp2 = AndroidUtilities.m102dp(13);
                if (!z) {
                    m102dp2 = -m102dp2;
                }
                canvas.translate(f4, m102dp + (m102dp2 * (1.0f - this.countChangeProgress)));
                ...
                float m102dp3 = AndroidUtilities.m102dp(2) + measuredHeight;
                int m102dp4 = AndroidUtilities.m102dp(13);
                if (!z) {
                    m102dp4 = -m102dp4;
                }
                canvas.translate(f5, m102dp3 + (m102dp4 * (1.0f - this.countChangeProgress)));
                this.textPaint.setAlpha((int) (this.countChangeProgress * 255.0f));
            ...
            if (this.countOldLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft, AndroidUtilities.m102dp(2) + measuredHeight + ((z ? -AndroidUtilities.m102dp(13) : AndroidUtilities.m102dp(13)) * this.countChangeProgress));
            ...
            if (this.countAnimationStableLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft + (this.f1932dx * (1.0f - this.countChangeProgress)), AndroidUtilities.m102dp(2) + measuredHeight);
            ...
            if (this.countAnimationStableLayout2 != null) {
                canvas.save();
                canvas.translate(this.countLeft, measuredHeight + AndroidUtilities.m102dp(2));
                this.textPaint.setAlpha(255);
    ...
    private void updateX(float f) {
        int i = this.gravity;
        if (i == 5) {
            float measuredWidth = getMeasuredWidth() - AndroidUtilities.m103dp(5.5f);
            ...
            this.countLeft = AndroidUtilities.m103dp(5.5f);
        } else {
            this.countLeft = (int) ((getMeasuredWidth() - f) / 2.0f);
        }
        this.f1933x = this.countLeft - AndroidUtilities.m103dp(5.5f);
    }
