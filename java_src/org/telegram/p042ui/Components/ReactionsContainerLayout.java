...
import org.telegram.p042ui.Components.Reactions.CustomEmojiReactionsWindow;
...
public class ReactionsContainerLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ReactionsContainerLayout(int i, BaseFragment baseFragment, Context context, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.rect = new RectF();
        this.mPath = new Path();
        this.radius = AndroidUtilities.m102dp(72);
        float m102dp = AndroidUtilities.m102dp(8);
        this.bigCircleRadius = m102dp;
        this.smallCircleRadius = m102dp / 2.0f;
        this.bigCircleOffset = AndroidUtilities.m102dp(36);
        ...
        this.shadow = ContextCompat.getDrawable(context, C3630R.C3632drawable.reactions_bubble_shadow).mutate();
            ...
            public void getItemOffsets(Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (!ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                    ...
                    if (childAdapterPosition == 0) {
                        rect2.left = AndroidUtilities.m102dp(6);
                    }
                    rect2.right = AndroidUtilities.m102dp(4);
                    if (childAdapterPosition == ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                        if (ReactionsContainerLayout.this.showUnlockPremiumButton() || ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                            rect2.right = AndroidUtilities.m102dp(2);
                            return;
                        } else {
                            rect2.right = AndroidUtilities.m102dp(6);
                            return;
                        }
                    }
                    return;
        ...
        C54335 c54335 = new C54335(context, i);
        this.listAdapter = c54335;
        recyclerListView.setAdapter(c54335);
        ...
        recyclerListView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.ReactionsContainerLayout.7
            ...
            public void getItemOffsets(Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                int childAdapterPosition = recyclerView.getChildAdapterPosition(view);
                if (childAdapterPosition == 0) {
                    rect2.left = AndroidUtilities.m102dp(8);
                }
                if (childAdapterPosition == ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                    rect2.right = AndroidUtilities.m102dp(8);
                }
            }
        });
        ...
        this.nextRecentReaction.getLayoutParams().width = paddingTop - AndroidUtilities.m102dp(12);
    ...
    /* loaded from: classes6.dex */
    public class C54335 extends AdapterWithDiffUtils {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                ReactionsContainerLayout.this.premiumLockIconView.setPadding(AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1), AndroidUtilities.m102dp(1));
                ReactionsContainerLayout reactionsContainerLayout = ReactionsContainerLayout.this;
                ...
                ReactionsContainerLayout.this.premiumLockIconView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$5$$ExternalSyntheticLambda1
                    ...
                    public final void onClick(View view2) {
                        ReactionsContainerLayout.C54335.this.lambda$onCreateViewHolder$0(view2);
                    }
                });
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setImageResource(C3630R.C3632drawable.msg_reactions_expand);
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m102dp(28), 0, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 40)));
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setPadding(AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(2));
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setContentDescription(LocaleController.getString(C3630R.string.AccDescrExpandPanel));
                ReactionsContainerLayout reactionsContainerLayout2 = ReactionsContainerLayout.this;
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$5$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        ReactionsContainerLayout.C54335.this.lambda$onCreateViewHolder$1(view2);
                    }
                });
                view = ReactionsContainerLayout.this.customReactionsContainer;
            }
            int m102dp = ((ReactionsContainerLayout.this.getLayoutParams().height - (ReactionsContainerLayout.this.hasHint ? AndroidUtilities.m102dp(20) : 0)) - ReactionsContainerLayout.this.getPaddingTop()) - ReactionsContainerLayout.this.getPaddingBottom();
            view.setLayoutParams(new RecyclerView.LayoutParams(m102dp - AndroidUtilities.m102dp(12), m102dp));
        ...
        public class InnerItem extends AdapterWithDiffUtils.Item {
            ...
            public InnerItem(C54335 c54335, int i, ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
                super(i, false);
    ...
    private void setVisibleReactionsList(List<ReactionsLayoutInBubble.VisibleReaction> list) {
        ...
        if (showCustomEmojiReaction()) {
            int m102dp = (AndroidUtilities.displaySize.x - AndroidUtilities.m102dp(36)) / AndroidUtilities.m102dp(34);
            if (m102dp > 7) {
                m102dp = 7;
            }
            int i = 0;
            ...
            while (i < Math.min(list.size(), m102dp)) {
        ...
        if ((((getLayoutParams().height - (this.hasHint ? AndroidUtilities.m102dp(20) : 0)) - getPaddingTop()) - getPaddingBottom()) * list.size() < AndroidUtilities.m102dp(200)) {
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Components.ReactionsContainerLayout.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    private void drawBubbles(Canvas canvas, float f, float f2, float f3, int i) {
        ...
        if (this.isTop) {
            ...
            canvas.clipRect(BitmapDescriptorFactory.HUE_RED, (AndroidUtilities.lerp(f4, (float) BitmapDescriptorFactory.HUE_RED, cubicBezierInterpolator.getInterpolation(this.flipVerticalProgress)) - ((int) Math.ceil((this.rect.height() / 2.0f) * (1.0f - this.transitionProgress)))) - 1.0f, getMeasuredWidth(), AndroidUtilities.lerp(getMeasuredHeight() + AndroidUtilities.m102dp(8), getPaddingTop() - expandSize(), cubicBezierInterpolator.getInterpolation(this.flipVerticalProgress)));
        }
        ...
        float lerp = AndroidUtilities.lerp(this.isTop ? (getPaddingTop() - expandSize()) - AndroidUtilities.m102dp(16) : ((getHeight() - this.smallCircleRadius) - f6) + expandSize(), (this.smallCircleRadius + f6) - expandSize(), CubicBezierInterpolator.DEFAULT.getInterpolation(this.flipVerticalProgress));
        float f11 = (-AndroidUtilities.m102dp(1)) * f2;
    ...
    private void checkPressedProgress(Canvas canvas, ReactionHolderView reactionHolderView) {
        ...
        float clamp = this.pullingLeftOffset != BitmapDescriptorFactory.HUE_RED ? Utilities.clamp(reactionHolderView.getLeft() / (getMeasuredWidth() - AndroidUtilities.m102dp(34)), 1.0f, (float) BitmapDescriptorFactory.HUE_RED) * getPullingLeftProgress() * AndroidUtilities.m102dp(46) : 0.0f;
    ...
    public float getPullingLeftProgress() {
        return Utilities.clamp(this.pullingLeftOffset / AndroidUtilities.m102dp(42), 2.0f, (float) BitmapDescriptorFactory.HUE_RED);
    }
    ...
    private void invalidateShaders() {
        ...
        this.leftShadowPaint.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, height, m102dp, height, color, 0, Shader.TileMode.CLAMP));
        this.rightShadowPaint.setShader(new LinearGradient(getWidth(), height, getWidth() - m102dp, height, color, 0, Shader.TileMode.CLAMP));
        invalidate();
    }
    ...
    public void setMessage(MessageObject messageObject, TLRPC$ChatFull tLRPC$ChatFull) {
        ...
        if (tLRPC$ChatFull != null) {
            ...
            if (tLRPC$ChatReactions instanceof TLRPC$TL_chatReactionsAll) {
                TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(tLRPC$ChatFull.f1601id));
    ...
    public int getTotalWidth() {
        ...
        if (!showCustomEmojiReaction()) {
            return (AndroidUtilities.m102dp(36) * itemsCount) + (AndroidUtilities.m102dp(2) * (itemsCount - 1)) + AndroidUtilities.m102dp(16);
        }
        return (AndroidUtilities.m102dp(36) * itemsCount) - AndroidUtilities.m102dp(4);
    }
    ...
    public void setCustomEmojiReactionsBackground(boolean z) {
        if (z) {
            this.customEmojiReactionsIconView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m102dp(28), 0, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 40)));
        } else {
    ...
    public void clearRecentReactions() {
        AlertDialog create = new AlertDialog.Builder(getContext()).setTitle(LocaleController.getString(C3630R.string.ClearRecentReactionsAlertTitle)).setMessage(LocaleController.getString(C3630R.string.ClearRecentReactionsAlertMessage)).setPositiveButton(LocaleController.getString(C3630R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$$ExternalSyntheticLambda1
    ...
    public void setHint(String str) {
        ...
        ((FrameLayout.LayoutParams) this.nextRecentReaction.getLayoutParams()).topMargin = AndroidUtilities.m102dp(20);
        ((FrameLayout.LayoutParams) this.recyclerListView.getLayoutParams()).topMargin = AndroidUtilities.m102dp(20);
    }
    ...
    public float getTopOffset() {
        return this.hasHint ? AndroidUtilities.m102dp(20) : BitmapDescriptorFactory.HUE_RED;
    }
    ...
    public final class ReactionHolderView extends FrameLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (visibleReaction != null) {
                ...
                accessibilityNodeInfo.setText(LocaleController.getString(C3630R.string.AccDescrCustomEmoji));
                accessibilityNodeInfo.setEnabled(true);
            }
        }
        ...
        ReactionHolderView(Context context, boolean z) {
            ...
            this.touchable = true;
            this.enterImageView = new C54402(context, r3);
        ...
        /* loaded from: classes6.dex */
        public class C54402 extends BackupImageView {
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C54402(Context context, ReactionsContainerLayout reactionsContainerLayout) {
                super(context);
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (reactionHolderView.shouldSwitchToLoopView && !reactionHolderView.switchedToLoopView && this.imageReceiver.getLottieAnimation() != null && this.imageReceiver.getLottieAnimation().isLastFrame() && ReactionHolderView.this.loopImageView.imageReceiver.getLottieAnimation() != null && ReactionHolderView.this.loopImageView.imageReceiver.getLottieAnimation().hasBitmap()) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$ReactionHolderView$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ReactionsContainerLayout.ReactionHolderView.C54402.this.lambda$dispatchDraw$0();
                        }
                    });
                }
                invalidate();
        ...
        public void setReaction(ReactionsLayoutInBubble.VisibleReaction visibleReaction, int i) {
            ...
            if (this.selected) {
                ...
                int m102dp2 = AndroidUtilities.m102dp(26);
                layoutParams4.height = m102dp2;
                layoutParams3.width = m102dp2;
                return;
            }
            ...
            int m102dp3 = AndroidUtilities.m102dp(34);
            layoutParams6.height = m102dp3;
            layoutParams5.width = m102dp3;
            ...
            int m102dp4 = AndroidUtilities.m102dp(34);
            layoutParams8.height = m102dp4;
            layoutParams7.width = m102dp4;
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            if (this.selected && this.drawSelected) {
                canvas.drawCircle(getMeasuredWidth() >> 1, getMeasuredHeight() >> 1, (getMeasuredWidth() >> 1) - AndroidUtilities.m102dp(1), ReactionsContainerLayout.this.selectedPaint);
            }
            AnimatedEmojiDrawable animatedEmojiDrawable = this.loopImageView.animatedEmojiDrawable;
            if (animatedEmojiDrawable != null && animatedEmojiDrawable.getImageReceiver() != null) {
                if (this.position == 0) {
                    this.loopImageView.animatedEmojiDrawable.getImageReceiver().setRoundRadius(AndroidUtilities.m102dp(6), 0, 0, AndroidUtilities.m102dp(6));
                } else {
                    this.loopImageView.animatedEmojiDrawable.getImageReceiver().setRoundRadius(this.selected ? AndroidUtilities.m102dp(6) : 0);
                }
            }
            super.dispatchDraw(canvas);
        }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.chatInfoDidLoad) {
            ...
            if (tLRPC$ChatFull.f1601id != this.waitingLoadingChatId || getVisibility() == 0 || (tLRPC$ChatFull.available_reactions instanceof TLRPC$TL_chatReactionsNone)) {
                return;
            }
    ...
    public float expandSize() {
        return (int) (getPullingLeftProgress() * AndroidUtilities.m102dp(6));
    }
