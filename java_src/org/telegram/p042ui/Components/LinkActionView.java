...
public class LinkActionView extends LinearLayout {
    ...
    private BackupImageView clearTextImageView;
    ...
    private final boolean isEditableAsInput;
    private final boolean isWithAvatar;
    ...
    public LinkActionView(Context context, AttributeSet attributeSet) {
        this(context, null, null, -1L, false, false, true, true, true, attributeSet);
    }

    public LinkActionView(Context context, BaseFragment baseFragment, BottomSheet bottomSheet, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        this(context, baseFragment, bottomSheet, j, z, z2, z3, z4, z5, null);
    }
    ...
    public void setAvatarForEditableMode(TLRPC$User tLRPC$User) {
        AvatarDrawable avatarDrawable = new AvatarDrawable();
        this.avatarDrawable = avatarDrawable;
        avatarDrawable.setInfo(tLRPC$User);
        this.avatarImageView.setForUserOrChat(tLRPC$User, this.avatarDrawable);
    ...
    public void setNetworkImage(String str) {
        ...
        materialShapeDrawable.setCornerSize(AndroidUtilities.m102dp(20) / 2.0f);
        ...
        this.networkImageView.setPadding(m102dp, m102dp, m102dp, m102dp);
    ...
    public void setActionButtonListener(final Callbacks$Callback callbacks$Callback) {
        ViewExtKt.setMixedClickListener(this.copyView, new Callbacks$Callback1() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda12
    ...
    public void setOptionsViewClickable(boolean z) {
        this.optionsView.setClickable(z);
    }

    public void hideAvatarsContainer() {
    ...
    public void setupContainerCustomSize(int i, int i2) {
    ...
    public void addMaxButton(final Callbacks$Callback callbacks$Callback) {
        ...
        textView.setText(LocaleController.getInternalString(C3630R.string.common_max));
        ...
        this.frameLayout.addView(this.maxView, LayoutHelper.createFrame(60, 28, 8388629, 0, 12, 12, 12));
        EditTextBoldCursor editTextBoldCursor = this.editText;
        editTextBoldCursor.setPadding(editTextBoldCursor.getPaddingLeft(), this.editText.getPaddingTop(), AndroidUtilities.m102dp(60), this.editText.getPaddingBottom());
        updateColors();
    }

    public TextView getMaxButtonView() {
        return this.maxView;
    }

    public void handleClearEditTextButton() {
        String obj = this.editText.getText().toString();
        if (obj.isEmpty() || this.frameLayout.indexOfChild(this.clearTextImageView) == -1) {
            if (obj.isEmpty()) {
                this.frameLayout.removeView(this.clearTextImageView);
                this.clearTextImageView = null;
                return;
            }
            BackupImageView backupImageView = new BackupImageView(getContext());
            this.clearTextImageView = backupImageView;
            backupImageView.setRoundRadius(AndroidUtilities.m102dp(24));
            Drawable drawable = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.fork_delete_icon);
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chats_menuItemIcon), PorterDuff.Mode.SRC_IN));
            }
            this.clearTextImageView.setImageDrawable(drawable);
            this.clearTextImageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LinkActionView.this.lambda$handleClearEditTextButton$2(view);
                }
            });
            this.frameLayout.addView(this.clearTextImageView, LayoutHelper.createFrame(22, 22, 8388629, 0, 0, 14, 0));
            EditTextBoldCursor editTextBoldCursor = this.editText;
            editTextBoldCursor.setPadding(editTextBoldCursor.getPaddingLeft(), this.editText.getPaddingTop(), AndroidUtilities.m102dp(22), this.editText.getPaddingBottom());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$handleClearEditTextButton$2(View view) {
        this.editText.setText("");
    }

    public void setErrorState(boolean z) {
        this.editText.setBackgroundResource(z ? C3630R.C3632drawable.fork_bg_error : 0);
        this.linkView.setBackgroundResource(z ? C3630R.C3632drawable.fork_bg_error : 0);
    }

    private void updateInputPadding(Boolean bool) {
        if (bool.booleanValue()) {
            this.linkView.setPadding(AndroidUtilities.m102dp(64), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
            EditTextBoldCursor editTextBoldCursor = this.editText;
            if (editTextBoldCursor != null) {
                editTextBoldCursor.setPadding(AndroidUtilities.m102dp(64), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
                return;
            }
            return;
        }
        this.linkView.setPadding(AndroidUtilities.m102dp(20), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
        EditTextBoldCursor editTextBoldCursor2 = this.editText;
        if (editTextBoldCursor2 != null) {
            editTextBoldCursor2.setPadding(AndroidUtilities.m102dp(20), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
        }
    }

    public LinkActionView(final Context context, final BaseFragment baseFragment, final BottomSheet bottomSheet, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, AttributeSet attributeSet) {
        ...
        if (z3) {
            ...
            this.editText.setPadding(AndroidUtilities.m102dp(20), AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(18));
        ...
        textView.setPadding(AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(13), AndroidUtilities.m102dp(40), AndroidUtilities.m102dp(13));
        ...
        imageView.setImageDrawable(ContextCompat.getDrawable(context, C3630R.C3632drawable.ic_ab_other));
        this.optionsView.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3630R.string.AccDescrMoreOptions));
        ...
        spannableStringBuilder.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_copy_filled)), 0, 1, 0);
        spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m102dp(6)), 1, 2, 0);
        int i = C3630R.string.LinkActionCopy;
        ...
        textView2.setPadding(AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8), 0);
        ...
        spannableStringBuilder2.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_share_filled)), 0, 1, 0);
        spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m102dp(6)), 1, 2, 0);
        int i2 = C3630R.string.LinkActionShare;
        ...
        textView3.setPadding(AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8), 0);
        ...
        spannableStringBuilder3.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3630R.C3632drawable.msg_delete_filled)), 0, 1, 0);
        spannableStringBuilder3.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m102dp(8)), 1, 2, 0);
        spannableStringBuilder3.append((CharSequence) LocaleController.getString("DeleteLink", C3630R.string.DeleteLink));
        spannableStringBuilder3.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m102dp(5)), spannableStringBuilder3.length() - 1, spannableStringBuilder3.length(), 0);
        textView4.setText(spannableStringBuilder3);
        textView4.setPadding(AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8), 0);
        textView4.setTextSize(1, 14.0f);
        textView4.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView4.setSingleLine(true);
        linearLayout.addView(textView4, LayoutHelper.createLinear(0, 42, 1.0f, 4, 0, 4, 0));
        textView4.setVisibility(8);
        addView(linearLayout, LayoutHelper.createLinear(-1, -2, 0, 12, 0, 0));
        AvatarsContainer avatarsContainer = new AvatarsContainer(context);
        this.avatarsContainer = avatarsContainer;
        avatarsContainer.avatarsImageView.setAvatarsTextSize(AndroidUtilities.m102dp(18));
        addView(avatarsContainer, LayoutHelper.createLinear(-1, 44, 0, 12, 0, 0));
        textView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LinkActionView.this.lambda$new$3(bottomSheet, baseFragment, view);
            }
        });
        if (z) {
            avatarsContainer.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LinkActionView.this.lambda$new$4(view);
                }
            });
        }
        ...
        textView4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LinkActionView.this.lambda$new$7(baseFragment, view);
            }
        });
        if (z5) {
            this.optionsView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LinkActionView.this.lambda$new$13(context, bottomSheet, baseFragment, view);
                }
            });
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$3(BottomSheet bottomSheet, BaseFragment baseFragment, View view) {
        try {
            if (this.link == null) {
                return;
            }
    ...
    public /* synthetic */ void lambda$new$5(BaseFragment baseFragment, View view) {
        try {
            ...
            baseFragment.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C3630R.string.InviteToGroupByLink)), 500);
        } catch (Exception e) {
            FileLog.m97e(e);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$7(BaseFragment baseFragment, View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(baseFragment.getParentActivity());
        builder.setTitle(LocaleController.getString("DeleteLink", C3630R.string.DeleteLink));
        builder.setMessage(LocaleController.getString("DeleteLinkHelp", C3630R.string.DeleteLinkHelp));
        builder.setPositiveButton(LocaleController.getString("Delete", C3630R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                LinkActionView.this.lambda$new$6(dialogInterface, i);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$13(final Context context, BottomSheet bottomSheet, BaseFragment baseFragment, View view) {
        ...
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                LinkActionView.this.lambda$new$11(context, actionBarPopupWindowLayout);
            }
        };
        ...
        if (container != null) {
            ...
            this.actionBarPopupWindow.setAnimationStyle(C3630R.style.PopupContextAnimation);
            this.actionBarPopupWindow.setInputMethodMode(2);
            this.actionBarPopupWindow.setSoftInputMode(0);
            actionBarPopupWindowLayout.setDispatchKeyEventListener(new ActionBarPopupWindow.OnDispatchKeyEventListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda16
                @Override // org.telegram.p042ui.ActionBar.ActionBarPopupWindow.OnDispatchKeyEventListener
                public final void onDispatchKeyEvent(KeyEvent keyEvent) {
                    LinkActionView.this.lambda$new$12(keyEvent);
                }
            });
            ...
            this.actionBarPopupWindow.showAtLocation(container, 0, (int) (((container.getMeasuredWidth() - actionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.m102dp(16)) + container.getX() + f2), (int) (f + this.frameLayout.getMeasuredHeight() + container.getY()));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$11(Context context, ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        if (!this.permanent && this.canEdit) {
            ActionBarMenuSubItem actionBarMenuSubItem = new ActionBarMenuSubItem(context, true, false);
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Edit", C3630R.string.Edit), C3630R.C3632drawable.msg_edit);
            actionBarPopupWindowLayout.addView((View) actionBarMenuSubItem, LayoutHelper.createLinear(-1, 48));
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("GetQRCode", C3630R.string.GetQRCode), C3630R.C3632drawable.msg_qrcode);
        ...
        actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("RevokeLink", C3630R.string.RevokeLink), C3630R.C3632drawable.msg_delete);
        ...
        actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LinkActionView.this.lambda$new$10(view);
            }
        });
    ...
    private void showQrCode() {
        ...
        String string = LocaleController.getString("InviteByQRCode", C3630R.string.InviteByQRCode);
        String str2 = this.link;
        String str3 = this.qrText;
        if (str3 == null) {
            if (this.isChannel) {
                i = C3630R.string.QRCodeLinkHelpChannel;
                str = "QRCodeLinkHelpChannel";
            } else {
                i = C3630R.string.QRCodeLinkHelpGroup;
        ...
        qRCodeBottomSheet.setCenterAnimation(C3630R.raw.qr_code_logo);
    ...
    public void updateColors() {
        ...
        if (textView2 != null) {
            ...
            this.maxView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(6), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
        }
        ...
        textView4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(m102dp, color, Theme.getColor(i4)));
        this.shareView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), Theme.getColor(i3), Theme.getColor(i4)));
        this.removeView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), Theme.getColor(Theme.key_chat_attachAudioBackground), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhite), 120)));
        this.frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(8), Theme.getColor(Theme.key_graySection), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 76)));
        ...
        this.avatarsContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(6), 0, ColorUtils.setAlphaComponent(Theme.getColor(i5), 76)));
    ...
    public void setLink(String str) {
        this.link = str;
        if (str == null) {
            this.linkView.setText(LocaleController.getString("Loading", C3630R.string.Loading));
    ...
    public void hideRevokeOption(boolean z) {
        if (this.hideRevokeOption != z) {
            ...
            imageView.setImageDrawable(ContextCompat.getDrawable(imageView.getContext(), C3630R.C3632drawable.ic_ab_other));
        }
    }
    ...
    public class AvatarsContainer extends FrameLayout {
        ...
        public AvatarsContainer(Context context) {
            ...
            this.avatarsImageView = new AvatarsImageView(context, false, LinkActionView.this) { // from class: org.telegram.ui.Components.LinkActionView.AvatarsContainer.1
                ...
                @Override // org.telegram.p042ui.Components.AvatarsImageView, android.view.View
                public void onMeasure(int i, int i2) {
                    int min = Math.min(3, LinkActionView.this.usersCount);
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m102dp(min == 0 ? 0 : ((min - 1) * 20) + 24 + 8), 1073741824), i2);
                }
            };
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(0);
            ...
            setPadding(0, AndroidUtilities.m102dp(8), 0, AndroidUtilities.m102dp(8));
    ...
    private void revokeLink() {
        ...
        builder.setTitle(LocaleController.getString("RevokeLink", C3630R.string.RevokeLink));
        builder.setMessage(LocaleController.getString("RevokeAlert", C3630R.string.RevokeAlert));
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3630R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                LinkActionView.this.lambda$revokeLink$14(dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Cancel", C3630R.string.Cancel), null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$revokeLink$14(DialogInterface dialogInterface, int i) {
        Delegate delegate = this.delegate;
        if (delegate != null) {
            delegate.revokeLink();
        }
    ...
    public void setUsers(int i, ArrayList<TLRPC$User> arrayList, boolean z) {
        ...
        if (i == 0) {
            this.avatarsContainer.setVisibility(8);
            setPadding(AndroidUtilities.m102dp(19), AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(19), AndroidUtilities.m102dp(18));
        } else {
            this.avatarsContainer.setVisibility(0);
            setPadding(AndroidUtilities.m102dp(19), AndroidUtilities.m102dp(18), AndroidUtilities.m102dp(19), AndroidUtilities.m102dp(10));
    ...
    public void loadUsers(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, long j) {
        if (tLRPC$TL_chatInviteExported == null) {
            ...
            ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tLRPC$TL_messages_getChatInviteImporters, new RequestDelegate() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda15
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    LinkActionView.this.lambda$loadUsers$16(tLRPC$TL_chatInviteExported, tLObject, tLRPC$TL_error);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadUsers$16(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
                LinkActionView.this.lambda$loadUsers$15(tLRPC$TL_chatInviteExported, tLRPC$TL_error, tLObject);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadUsers$15(TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
