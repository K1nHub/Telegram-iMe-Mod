...
public class LinkSpanDrawable<S extends CharacterStyle> {
    ...
    public boolean draw(Canvas canvas) {
        float f;
        int m102dp = this.isLite ? 0 : AndroidUtilities.m102dp(4);
        boolean z = this.cornerRadius != m102dp;
        ...
        float f3 = 1.0f - f;
        this.mSelectionPaint.setStrokeWidth(Math.min(1.0f, f3) * AndroidUtilities.m102dp(5));
        ...
        this.mRipplePaint.setStrokeWidth(Math.min(1.0f, f3) * AndroidUtilities.m102dp(5));
        ...
        if (i4 < 0) {
            ...
            for (int i6 = 0; i6 < this.mPathesCount; i6++) {
                canvas.drawPath(this.mPathes.get(i6), this.mRipplePaint);
            }
        }
        return i4 < 0 || this.mReleaseStart >= 0 || (this.mSupportsLongPress && elapsedRealtime - this.mStart < this.mLongPressDuration + this.mDuration);
    }
    ...
    public static class ClickableSmallTextView extends SimpleTextView {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // org.telegram.p042ui.ActionBar.SimpleTextView, android.view.View
        public void onDraw(Canvas canvas) {
            if (isClickable()) {
                RectF rectF = AndroidUtilities.rectTmp;
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), this.linkBackgroundPaint);
            }
            super.onDraw(canvas);
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.links != null) {
                if (motionEvent.getAction() == 0) {
                    ...
                    this.links.addLink(linkSpanDrawable);
                    LinkPath obtainNewPath = this.pressedLink.obtainNewPath();
                    obtainNewPath.setCurrentLayout(null, 0, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED);
                    obtainNewPath.addRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getPaddingLeft() + getTextWidth() + getPaddingRight(), getHeight(), Path.Direction.CW);
