...
public class LineProgressView extends View {
    ...
    public LineProgressView(Context context) {
        ...
        if (decelerateInterpolator == null) {
            ...
            progressPaint.setStrokeWidth(AndroidUtilities.m102dp(2));
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        progressPaint.setAlpha((int) (this.animatedAlphaValue * 255.0f));
        this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth() * this.animatedProgressValue, getHeight());
        canvas.drawRoundRect(this.rect, getHeight() / 2.0f, getHeight() / 2.0f, progressPaint);
