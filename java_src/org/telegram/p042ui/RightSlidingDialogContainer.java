...
public abstract class RightSlidingDialogContainer extends FrameLayout {
    ...
    C3702ActionBar currentActionBarView;
    ...
    public void presentFragment(INavigationLayout iNavigationLayout, final BaseFragment baseFragment) {
        ...
        if (baseFragment.onFragmentCreate()) {
            ...
            if (baseFragment.getActionBar() != null) {
                C3702ActionBar actionBar = baseFragment.getActionBar();
            ...
            baseFragment.setPreviewDelegate(new BaseFragment.PreviewDelegate() { // from class: org.telegram.ui.RightSlidingDialogContainer$$ExternalSyntheticLambda6
                @Override // org.telegram.p042ui.ActionBar.BaseFragment.PreviewDelegate
    ...
    protected void updateOpenAnimationProgress() {
        ...
        if (view != null) {
            view.setTranslationX((getMeasuredWidth() - AndroidUtilities.m102dp(getRightPaddingSize())) * (1.0f - this.openedProgress));
        }
        BaseFragment baseFragment = this.parentFragment;
        if ((!(baseFragment instanceof DialogsActivity) || (((DialogsActivity) baseFragment).isMainNoFolderDialogList() && !SharedConfig.isMainActionBarMenuEnabled)) && (c3702ActionBar = this.currentActionBarView) != null) {
            c3702ActionBar.setTranslationX(AndroidUtilities.m102dp(48) * (1.0f - this.openedProgress));
        }
        BaseFragment baseFragment2 = this.currentFragment;
        if (baseFragment2 != null) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (view != null) {
            ...
            layoutParams.leftMargin = AndroidUtilities.m102dp(getRightPaddingSize());
            layoutParams.topMargin = C3702ActionBar.getCurrentActionBarHeight() + i3 + this.fragmentViewPadding;
        }
        C3702ActionBar c3702ActionBar = this.currentActionBarView;
        if (c3702ActionBar != null) {
            ((FrameLayout.LayoutParams) c3702ActionBar.getLayoutParams()).topMargin = i3;
        }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        C3702ActionBar c3702ActionBar = this.currentActionBarView;
        if (view == c3702ActionBar && c3702ActionBar.getActionMode() != null && this.currentActionBarView.getActionMode().getAlpha() == 1.0f) {
            return true;
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        C3702ActionBar c3702ActionBar = this.currentActionBarView;
        float alpha = (c3702ActionBar == null || c3702ActionBar.getActionMode() == null) ? 0.0f : this.currentActionBarView.getActionMode().getAlpha();
        C3702ActionBar c3702ActionBar2 = this.currentActionBarView;
        float max = f * Math.max(alpha, c3702ActionBar2 == null ? 0.0f : c3702ActionBar2.searchFieldVisibleAlpha);
