...
import org.telegram.p042ui.Charts.view_data.ChartBottomSignatureData;
...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    public static final int SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m103dp(18.0f);
    private static final int BOTTOM_SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m103dp(14.0f);
    public static final int BOTTOM_SIGNATURE_START_ALPHA = AndroidUtilities.m103dp(10.0f);
    protected static final int PICKER_PADDING = AndroidUtilities.m103dp(16.0f);
    private static final int PICKER_CAPTURE_WIDTH = AndroidUtilities.m102dp(24);
    private static final int LANDSCAPE_END_PADDING = AndroidUtilities.m102dp(16);
    private static final int BOTTOM_SIGNATURE_OFFSET = AndroidUtilities.m102dp(10);
    private static final int DP_12 = AndroidUtilities.m102dp(12);
    private static final int DP_6 = AndroidUtilities.m102dp(6);
    private static final int DP_5 = AndroidUtilities.m102dp(5);
    private static final int DP_2 = AndroidUtilities.m102dp(2);
    private static final int DP_1 = AndroidUtilities.m102dp(1);
    ...
    public BaseChartView(Context context) {
        ...
        this.pikerHeight = AndroidUtilities.m102dp(46);
    ...
    public void updateColors() {
        ...
        if (this.legendShowing) {
            ...
            long[] jArr = this.chartData.f1796x;
            if (i < jArr.length) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.landscape) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.displaySize.y - AndroidUtilities.m102dp(56));
        }
    ...
    private void measureSizes() {
        ...
        updateLineSignature();
        this.chartBottom = AndroidUtilities.m103dp(100.0f);
        ...
        if (this.chartData != null) {
            this.bottomSignatureOffset = (int) (AndroidUtilities.m102dp(20) / (this.pickerWidth / this.chartData.f1796x.length));
        }
    ...
    public void drawBottomSignature(Canvas canvas) {
        ...
        while (true) {
            ...
            while (true) {
                if (i6 % i4 == 0 && i6 >= this.chartData.f1796x.length - 1) {
                    break;
                }
                i6++;
                c = 0;
                    ...
                    if (i8 < jArr.length - 1) {
                        ...
                        if (f4 > BitmapDescriptorFactory.HUE_RED) {
                            ...
                            if (f4 <= f5 + f6) {
                                ...
                                canvas.drawText(this.chartData.getDayString(i8), f3, (getMeasuredHeight() - this.chartBottom) + BOTTOM_SIGNATURE_TEXT_HEIGHT + AndroidUtilities.m102dp(3), this.bottomSignaturePaint);
                                i8 += i4;
                                c = 0;
                            }
                        }
    ...
    public void drawSelection(Canvas canvas) {
        ...
        while (true) {
            ...
            if (l.enabled || l.alpha != BitmapDescriptorFactory.HUE_RED) {
                ...
                float measuredHeight = (getMeasuredHeight() - this.chartBottom) - (((l.line.f1798y[this.selectedIndex] - f7) / (this.currentMaxHeight - f7)) * ((getMeasuredHeight() - this.chartBottom) - SIGNATURE_TEXT_HEIGHT));
    ...
    */
    public void drawHorizontalLines(android.graphics.Canvas r12, org.telegram.p042ui.Charts.view_data.ChartHorizontalLinesData r13) {
        /*
            r11 = this;
            int[] r0 = r13.values
            int r1 = r0.length
        ...
        L3e:
            ...
            int r0 = r0 - r2
            int r2 = org.telegram.p042ui.Charts.BaseChartView.SIGNATURE_TEXT_HEIGHT
            int r0 = r0 - r2
        ...
        L95:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Charts.BaseChartView.drawHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void drawSignaturesToHorizontalLines(android.graphics.Canvas r10, org.telegram.p042ui.Charts.view_data.ChartHorizontalLinesData r11) {
        /*
            r9 = this;
            int[] r0 = r11.values
            int r1 = r0.length
        ...
        L74:
            ...
            r5 = r5[r3]
            float r6 = org.telegram.p042ui.Charts.BaseChartView.HORIZONTAL_PADDING
            int r4 = r4 - r2
            float r4 = (float) r4
        ...
        L9e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Charts.BaseChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    */
    public void drawPicker(android.graphics.Canvas r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Charts.BaseChartView.drawPicker(android.graphics.Canvas):void");
    }
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        if (f3 < BitmapDescriptorFactory.HUE_RED) {
            ...
            this.selectedIndex = t.f1796x.length - 1;
        } else {
    ...
    public void moveLegend(float f) {
        ...
        this.legendSignatureView.setData(i, t.f1796x[i], this.lines, false);
    ...
    @Override // org.telegram.p042ui.Charts.ChartPickerDelegate.Listener
    ...
    public void onCheckChanged() {
        ...
        if (this.legendShowing) {
            ...
            int i3 = this.selectedIndex;
            legendSignatureView.setData(i3, this.chartData.f1796x[i3], this.lines, true);
        }
    }
    ...
    public long getSelectedDate() {
        ...
        return this.chartData.f1796x[i];
    }
    ...
    public void selectDate(long j) {
        this.selectedIndex = Arrays.binarySearch(this.chartData.f1796x, j);
        this.legendShowing = true;
        this.legendSignatureView.setVisibility(0);
    ...
    public long getStartDate() {
        return this.chartData.f1796x[this.startXIndex];
    }

    public long getEndDate() {
        return this.chartData.f1796x[this.endXIndex];
    }

    public void updatePicker(ChartData chartData, long j) {
        int length = chartData.f1796x.length;
    ...
    public static class SharedUiComponents {
        ...
        Bitmap getPickerMaskBitmap(int i, int i2) {
            int i3 = (i + i2) << 10;
            if (i3 != this.f1794k || this.invalidate) {
                ...
                this.canvas.drawRoundRect(this.rectF, AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(4), this.xRefP);
            }
