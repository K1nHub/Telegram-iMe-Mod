...
import org.telegram.p042ui.Charts.view_data.ChartHorizontalLinesData;
...
public class DoubleLinearChartView extends BaseChartView<DoubleLinearChartData, LineViewData> {
    ...
    protected void drawChart(Canvas canvas) {
        ...
        if (this.chartData != 0) {
            ...
            if (i2 == 2) {
                ...
                canvas.scale((f11 * 2.0f) + 1.0f, 1.0f, transitionParams.f1799pX, transitionParams.f1800pY);
            } else if (i2 == 1) {
                ...
                canvas.scale(f13, f13, transitionParams2.f1799pX, transitionParams2.f1800pY);
            } else {
    ...
    public void drawSelection(Canvas canvas) {
        ...
        while (true) {
            ...
            LineViewData lineViewData = (LineViewData) this.lines.get(i3);
            if (lineViewData.enabled || lineViewData.alpha != BitmapDescriptorFactory.HUE_RED) {
                float f6 = lineViewData.line.f1798y[this.selectedIndex] * ((DoubleLinearChartData) this.chartData).linesK[this.tmpI];
    ...
    */
    public void drawSignaturesToHorizontalLines(android.graphics.Canvas r17, org.telegram.p042ui.Charts.view_data.ChartHorizontalLinesData r18) {
        /*
            Method dump skipped, instructions count: 324
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Charts.DoubleLinearChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
