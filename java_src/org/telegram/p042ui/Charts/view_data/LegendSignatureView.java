...
public class LegendSignatureView extends FrameLayout {
    ...
    public LegendSignatureView(Context context) {
        ...
        imageView.setImageResource(C3630R.C3632drawable.ic_chevron_right_black_18dp);
        RadialProgressView radialProgressView = new RadialProgressView(context);
        this.progressView = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.m102dp(12));
        this.progressView.setStrokeWidth(AndroidUtilities.m103dp(0.5f));
    ...
    public void recolor() {
        ...
        this.shadowDrawable = getContext().getResources().getDrawable(C3630R.C3632drawable.stats_tooltip).mutate();
        this.backgroundDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m102dp(4), Theme.getColor(Theme.key_dialogBackground), Theme.getColor(Theme.key_listSelector), -16777216);
        CombinedDrawable combinedDrawable = new CombinedDrawable(this.shadowDrawable, this.backgroundDrawable, AndroidUtilities.m102dp(3), AndroidUtilities.m102dp(3));
    ...
    public void setData(int i, long j, ArrayList<LineViewData> arrayList, boolean z) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            if (arrayList.get(i3).enabled) {
                i2 += arrayList.get(i3).line.f1798y[i];
            }
        }
        for (int i4 = 0; i4 < length; i4++) {
            ...
            if (!arrayList.get(i4).enabled) {
                ...
                holder.value.setText(formatWholeNumber(line.f1798y[i]));
                ...
                if (this.showPercentage && (textView = holder.percentage) != null) {
                    ...
                    float f = arrayList.get(i4).line.f1798y[i] / i2;
    ...
    public class Holder {
        ...
        Holder(LegendSignatureView legendSignatureView) {
            ...
            linearLayout.setPadding(AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(2), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(2));
            if (legendSignatureView.showPercentage) {
                ...
                this.percentage.getLayoutParams().width = AndroidUtilities.m102dp(36);
            ...
            textView2.getLayoutParams().width = AndroidUtilities.m102dp(legendSignatureView.showPercentage ? 80 : 96);
