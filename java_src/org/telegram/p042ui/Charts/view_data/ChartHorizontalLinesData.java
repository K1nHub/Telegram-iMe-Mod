...
public class ChartHorizontalLinesData {
    ...
    */
    public ChartHorizontalLinesData(int r8, int r9, boolean r10, float r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Charts.view_data.ChartHorizontalLinesData.<init>(int, int, boolean, float):void");
    }
