...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3630R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3630R.C3632drawable.msg_zoomout_stats);
        ...
        this.back.setCompoundDrawablePadding(AndroidUtilities.m102dp(4));
        this.back.setPadding(AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(4), AndroidUtilities.m102dp(8), AndroidUtilities.m102dp(4));
    ...
    public void zoomTo(BaseChartView baseChartView, long j, boolean z) {
        ...
        if (z) {
            ...
            this.back.setPivotY(AndroidUtilities.m102dp(40));
