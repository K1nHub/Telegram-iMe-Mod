...
import org.telegram.p042ui.Charts.view_data.BarViewData;
...
public class BarChartView extends BaseChartView<ChartData, BarViewData> {
    ...
    */
    protected void drawChart(android.graphics.Canvas r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p042ui.Charts.BarChartView.drawChart(android.graphics.Canvas):void");
    }
        ...
        if (this.chartData != 0) {
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (barViewData.enabled || barViewData.alpha != BitmapDescriptorFactory.HUE_RED) {
                    ...
                    int[] iArr = barViewData.line.f1798y;
