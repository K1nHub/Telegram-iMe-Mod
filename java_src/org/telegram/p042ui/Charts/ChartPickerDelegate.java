...
public class ChartPickerDelegate {
    ...
    public class CapturesData {
        ...
        public void captured() {
            ...
            this.f1795a.setInterpolator(BaseChartView.INTERPOLATOR);
            this.f1795a.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.ChartPickerDelegate$CapturesData$$ExternalSyntheticLambda0
        ...
        public void uncapture() {
            ValueAnimator valueAnimator = this.f1795a;
    ...
    public boolean move(int i, int i2, int i3) {
        ...
        if (i4 == 1) {
            ...
            if (f3 < BitmapDescriptorFactory.HUE_RED) {
                this.pickerStart = BitmapDescriptorFactory.HUE_RED;
            }
    ...
    public boolean uncapture(MotionEvent motionEvent, int i) {
        ...
        if (i == 0) {
            if (this.tryMoveTo) {
                ...
                if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.startTapTime < 300 && Math.sqrt((x * x) + (y * y)) < AndroidUtilities.m102dp(10)) {
                    ...
                    this.moveToAnimator = ValueAnimator.ofFloat(BitmapDescriptorFactory.HUE_RED, 1.0f);
