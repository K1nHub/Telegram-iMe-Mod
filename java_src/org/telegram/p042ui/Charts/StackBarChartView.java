package org.telegram.p042ui.Charts;
...
import org.telegram.p042ui.Charts.view_data.StackBarViewData;
import org.telegram.p042ui.Charts.view_data.TransitionParams;
/* renamed from: org.telegram.ui.Charts.StackBarChartView */
...
public class StackBarChartView extends BaseChartView<StackBarChartData, StackBarViewData> {
    ...
    @Override // org.telegram.p042ui.Charts.BaseChartView
    ...
    protected void drawChart(Canvas canvas) {
        ...
        int i4 = ((int) (f9 / f2)) + 1;
        int max = Math.max(0, (this.startXIndex - i4) - 2);
        int min = Math.min(((StackBarChartData) this.chartData).xPercentage.length - 1, this.endXIndex + i4 + 2);
        ...
        if (i6 == 2) {
            ...
            f3 = 1.0f - f14;
            canvas.scale((f14 * 2.0f) + 1.0f, 1.0f, transitionParams.f1799pX, transitionParams.f1800pY);
        } else if (i6 == 1) {
            TransitionParams transitionParams2 = this.transitionParams;
            f3 = transitionParams2.progress;
            canvas.scale(f3, 1.0f, transitionParams2.f1799pX, transitionParams2.f1800pY);
        } else {
            f3 = i6 == 3 ? this.transitionParams.progress : 1.0f;
        }
            ...
            if (this.selectedIndex != max || !z) {
                ...
                while (i7 < this.lines.size()) {
                    ...
                    if (lineViewData.enabled || lineViewData.alpha != f13) {
                        int[] iArr = lineViewData.line.f1798y;
                        ...
                        i3 = min;
                        int i8 = lineViewData.linesPathBottomSize;
                        f4 = f10;
                        int i9 = i8 + 1;
                        ...
                        fArr[i9] = ((getMeasuredHeight() - this.chartBottom) - measuredHeight) - f15;
                        int i11 = i10 + 1;
                        lineViewData.linesPathBottomSize = i11;
                        fArr[i10] = f16;
                        lineViewData.linesPathBottomSize = i11 + 1;
                        fArr[i11] = (getMeasuredHeight() - this.chartBottom) - f15;
                        f15 += measuredHeight;
                    } else {
                        i3 = min;
                        f4 = f10;
        ...
        for (int i12 = 0; i12 < this.lines.size(); i12++) {
            StackBarViewData stackBarViewData = (StackBarViewData) this.lines.get(i12);
        ...
        if (z) {
            ...
            for (i = 0; i < this.lines.size(); i = i + 1) {
                ...
                int[] iArr2 = lineViewData2.line.f1798y;
                float f19 = ((f2 / 2.0f) + (((StackBarChartData) this.chartData).xPercentage[this.selectedIndex] * (f8 - f2))) - f17;
                float measuredHeight2 = (iArr2[i2] / this.currentMaxHeight) * ((getMeasuredHeight() - this.chartBottom) - BaseChartView.SIGNATURE_TEXT_HEIGHT) * lineViewData2.alpha;
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        if (f3 < BitmapDescriptorFactory.HUE_RED) {
            ...
            this.selectedIndex = ((StackBarChartData) t).f1796x.length - 1;
        } else {
            ...
            while (i3 < length) {
                ...
                while (true) {
                    ...
                    if (lineViewData.enabled || lineViewData.alpha != BitmapDescriptorFactory.HUE_RED) {
                        int i5 = lineViewData.line.f1798y[i3];
                ...
                if (i3 % max == 0) {
                    ...
                    while (i6 < size) {
                        ...
                        if (lineViewData2.enabled || lineViewData2.alpha != f) {
                            ...
                            float f5 = (iArr3[i6] / f4) * lineViewData2.alpha;
                            ...
                            fArr[i10] = f2;
                            lineViewData2.linesPathBottomSize = i11 + 1;
                            fArr[i11] = i7 - f3;
                            f3 += f6;
                            iArr3[i6] = 0;
                        }
    ...
    public void onCheckChanged() {
        int length = ((StackBarChartData) this.chartData).lines.get(0).f1798y.length;
        ...
        for (int i = 0; i < length; i++) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                if (((StackBarViewData) this.lines.get(i2)).enabled) {
                    ...
                    iArr[i] = iArr[i] + ((StackBarChartData) t).lines.get(i2).f1798y[i];
                }
            }
        }
        T t2 = this.chartData;
    ...
    public void updatePickerMinMaxHeight() {
        if (BaseChartView.ANIMATE_PICKER_SIZES) {
            int length = ((StackBarChartData) this.chartData).f1796x.length;
            int size = this.lines.size();
            int i = 0;
            for (int i2 = 0; i2 < length; i2++) {
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    ...
                    if (stackBarViewData.enabled) {
                        i3 += stackBarViewData.line.f1798y[i2];
                    }
                }
                if (i3 > i) {
                    i = i3;
    ...
    public void initPickerMaxHeight() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (stackBarViewData.enabled) {
                    i2 += stackBarViewData.line.f1798y[i];
                }
            }
            float f = i2;
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // org.telegram.p042ui.Charts.BaseChartView, android.view.View
