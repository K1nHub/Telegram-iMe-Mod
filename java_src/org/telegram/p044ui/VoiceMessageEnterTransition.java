...
/* renamed from: org.telegram.ui.VoiceMessageEnterTransition */
...
public class VoiceMessageEnterTransition implements MessageEnterTransitionContainer.Transition {
    ...
    public VoiceMessageEnterTransition(final ChatMessageCell chatMessageCell, ChatActivityEnterView chatActivityEnterView, ViewGroup viewGroup, final MessageEnterTransitionContainer messageEnterTransitionContainer, Theme.ResourcesProvider resourcesProvider) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        float x = recordCircle == null ? BitmapDescriptorFactory.HUE_RED : (recordCircle.drawingCx + recordCircle.getX()) - this.container.getX();
        ChatActivityEnterView.RecordCircle recordCircle2 = this.recordCircle;
        float y = recordCircle2 == null ? BitmapDescriptorFactory.HUE_RED : (recordCircle2.drawingCy + recordCircle2.getY()) - this.container.getY();
        ...
        if (this.container.getMeasuredHeight() > 0) {
            this.gradientMatrix.setTranslate(BitmapDescriptorFactory.HUE_RED, measuredHeight);
