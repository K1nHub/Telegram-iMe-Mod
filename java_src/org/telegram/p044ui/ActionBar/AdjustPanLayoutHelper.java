    ...
    */
    public void startTransition(int r6, int r7, boolean r8) {
        ...
        L74:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.ActionBar.AdjustPanLayoutHelper.startTransition(int, int, boolean):void");
    }
    ...
    public void updateTransition(float f) {
        ...
        float f2 = (int) ((this.from * f) + (this.f1588to * (1.0f - f)));
