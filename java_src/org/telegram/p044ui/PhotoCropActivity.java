...
import org.telegram.p044ui.PhotoCropActivity;
...
public class PhotoCropActivity extends BaseFragment {
    ...
    public class PhotoCropView extends FrameLayout {
        ...
        private void init() {
            ...
            this.rectPaint.setStrokeWidth(AndroidUtilities.m50dp(2));
        ...
        */
        public /* synthetic */ boolean lambda$init$0(android.view.View r13, android.view.MotionEvent r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.PhotoCropActivity.PhotoCropView.lambda$init$0(android.view.View, android.view.MotionEvent):boolean");
        }
        ...
        private void updateBitmapSize() {
            ...
            this.bitmapX = ((this.viewWidth - this.bitmapWidth) / 2) + AndroidUtilities.m50dp(14);
            int m50dp = ((this.viewHeight - this.bitmapHeight) / 2) + AndroidUtilities.m50dp(14);
            this.bitmapY = m50dp;
            if (this.rectX == -1.0f && this.rectY == -1.0f) {
                if (this.freeform) {
                    ...
                    if (this.bitmapWidth > this.bitmapHeight) {
                        this.rectY = m50dp;
                        this.rectX = ((this.viewWidth - i2) / 2) + AndroidUtilities.m50dp(14);
                        int i7 = this.bitmapHeight;
                        this.rectSizeX = i7;
                        this.rectSizeY = i7;
                    } else {
                        this.rectX = this.bitmapX;
                        this.rectY = ((this.viewHeight - i) / 2) + AndroidUtilities.m50dp(14);
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            this.viewWidth = (i3 - i) - AndroidUtilities.m50dp(28);
            this.viewHeight = (i4 - i2) - AndroidUtilities.m50dp(28);
            updateBitmapSize();
        }
        ...
        */
        protected void onDraw(android.graphics.Canvas r16) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.PhotoCropActivity.PhotoCropView.onDraw(android.graphics.Canvas):void");
        }
    }
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.imageToCrop == null) {
            ...
            if (AndroidUtilities.isTablet()) {
                max = AndroidUtilities.m50dp(520);
            } else {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("CropImage", C3242R.string.CropImage));
        this.actionBar.setActionBarMenuOnItemClick(new C3306ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PhotoCropActivity.1
        ...
        this.actionBar.createMenu().addItemWithWidth(1, C3242R.C3244drawable.ic_ab_done, AndroidUtilities.m50dp(56), LocaleController.getString("Done", C3242R.string.Done));
