...
public class FiltersView extends RecyclerListView {
    ...
    public static final MediaFilterData[] filters = {new MediaFilterData(C3242R.C3244drawable.search_media_filled, LocaleController.getString("SharedMediaTab2", C3242R.string.SharedMediaTab2), new TLRPC$TL_inputMessagesFilterPhotoVideo(), 0), new MediaFilterData(C3242R.C3244drawable.search_links_filled, LocaleController.getString("SharedLinksTab2", C3242R.string.SharedLinksTab2), new TLRPC$TL_inputMessagesFilterUrl(), 2), new MediaFilterData(C3242R.C3244drawable.search_files_filled, LocaleController.getString("SharedFilesTab2", C3242R.string.SharedFilesTab2), new TLRPC$TL_inputMessagesFilterDocument(), 1), new MediaFilterData(C3242R.C3244drawable.search_music_filled, LocaleController.getString("SharedMusicTab2", C3242R.string.SharedMusicTab2), new TLRPC$TL_inputMessagesFilterMusic(), 3), new MediaFilterData(C3242R.C3244drawable.search_voice_filled, LocaleController.getString("SharedVoiceTab2", C3242R.string.SharedVoiceTab2), new TLRPC$TL_inputMessagesFilterRoundVoice(), 5)};
                    ...
                    if (i3 == 4) {
                        ...
                        if (tLObject instanceof TLRPC$User) {
                            ...
                            if (tLObject2 instanceof TLRPC$User) {
                                return ((TLRPC$User) tLObject).f1567id == ((TLRPC$User) tLObject2).f1567id;
                            }
                        }
                        if (tLObject instanceof TLRPC$Chat) {
                            TLObject tLObject3 = mediaFilterData2.chat;
                            return (tLObject3 instanceof TLRPC$Chat) && ((TLRPC$Chat) tLObject).f1427id == ((TLRPC$Chat) tLObject3).f1427id;
                        }
                    } else if (i3 == 6) {
            ...
            public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                animate.alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C34283.this).mAddAnimations.remove(viewHolder);
            ...
            protected void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                animate.setDuration(getRemoveDuration()).alpha(BitmapDescriptorFactory.HUE_RED).scaleX(BitmapDescriptorFactory.HUE_RED).scaleY(BitmapDescriptorFactory.HUE_RED).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.2
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C34283.this).mRemoveAnimations.remove(viewHolder);
                        dispatchFinishedWhenDone();
                    }
                }).start();
            }
    ...
    public void setUsersAndDates(ArrayList<Object> arrayList, ArrayList<DateData> arrayList2, boolean z) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof TLRPC$User) {
                    ...
                    if (UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f1567id == tLRPC$User.f1567id) {
                        formatName = LocaleController.getString("SavedMessages", C3242R.string.SavedMessages);
                    } else {
                        formatName = ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name, 10);
                    }
                    MediaFilterData mediaFilterData = new MediaFilterData(C3242R.C3244drawable.search_users_filled, formatName, null, 4);
                    ...
                    MediaFilterData mediaFilterData2 = new MediaFilterData(C3242R.C3244drawable.search_users_filled, str, null, 4);
        ...
        if (arrayList2 != null) {
            for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                ...
                MediaFilterData mediaFilterData3 = new MediaFilterData(C3242R.C3244drawable.search_date_filled, dateData.title, null, 6);
                mediaFilterData3.setDate(dateData);
                this.usersFilters.add(mediaFilterData3);
            }
        }
        if (z) {
            this.usersFilters.add(new MediaFilterData(C3242R.C3244drawable.chats_archive, LocaleController.getString("ArchiveSearchFilter", C3242R.string.ArchiveSearchFilter), null, 7));
        }
        if (getAdapter() != null) {
    ...
    public static void fillTipDates(String str, ArrayList<DateData> arrayList) {
        ...
        int i = C3242R.string.SearchTipToday;
        ...
        int i5 = C3242R.string.SearchTipYesterday;
    ...
    public static int getMonth(String str) {
        String[] strArr = {LocaleController.getString("January", C3242R.string.January).toLowerCase(), LocaleController.getString("February", C3242R.string.February).toLowerCase(), LocaleController.getString("March", C3242R.string.March).toLowerCase(), LocaleController.getString("April", C3242R.string.April).toLowerCase(), LocaleController.getString("May", C3242R.string.May).toLowerCase(), LocaleController.getString("June", C3242R.string.June).toLowerCase(), LocaleController.getString("July", C3242R.string.July).toLowerCase(), LocaleController.getString("August", C3242R.string.August).toLowerCase(), LocaleController.getString("September", C3242R.string.September).toLowerCase(), LocaleController.getString("October", C3242R.string.October).toLowerCase(), LocaleController.getString("November", C3242R.string.November).toLowerCase(), LocaleController.getString("December", C3242R.string.December).toLowerCase()};
    ...
    public static class FilterView extends FrameLayout {
        ...
        public void setData(MediaFilterData mediaFilterData) {
            ...
            if (mediaFilterData.filterType == 7) {
                CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m50dp(32), C3242R.C3244drawable.chats_archive);
