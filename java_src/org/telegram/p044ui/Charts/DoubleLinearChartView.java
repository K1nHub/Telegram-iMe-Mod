...
public class DoubleLinearChartView extends BaseChartView<DoubleLinearChartData, LineViewData> {
    ...
    protected void drawChart(Canvas canvas) {
        ...
        if (this.chartData != 0) {
            ...
            if (i2 == 2) {
                ...
                canvas.scale((f11 * 2.0f) + 1.0f, 1.0f, transitionParams.f1603pX, transitionParams.f1604pY);
            } else if (i2 == 1) {
                ...
                canvas.scale(f13, f13, transitionParams2.f1603pX, transitionParams2.f1604pY);
            } else {
    ...
    public void drawSelection(Canvas canvas) {
        ...
        while (true) {
            ...
            LineViewData lineViewData = (LineViewData) this.lines.get(i3);
            if (lineViewData.enabled || lineViewData.alpha != BitmapDescriptorFactory.HUE_RED) {
                float f6 = lineViewData.line.f1602y[this.selectedIndex] * ((DoubleLinearChartData) this.chartData).linesK[this.tmpI];
