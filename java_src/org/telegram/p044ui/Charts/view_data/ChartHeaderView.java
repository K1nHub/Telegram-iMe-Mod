...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3290R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3290R.C3292drawable.msg_zoomout_stats);
