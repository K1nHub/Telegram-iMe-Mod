...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3295R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3295R.C3297drawable.msg_zoomout_stats);
