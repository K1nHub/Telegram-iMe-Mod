package org.telegram.p044ui.Charts.view_data;
...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3242R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3242R.C3244drawable.msg_zoomout_stats);
        ...
        this.back.setCompoundDrawablePadding(AndroidUtilities.m50dp(4));
        this.back.setPadding(AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(4), AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(4));
    ...
    public void zoomTo(BaseChartView baseChartView, long j, boolean z) {
        ...
        if (z) {
            ...
            this.back.setPivotY(AndroidUtilities.m50dp(40));
