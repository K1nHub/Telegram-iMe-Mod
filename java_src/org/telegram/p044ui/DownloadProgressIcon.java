...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C3295R.raw.download_progress, "download_progress", AndroidUtilities.m54dp(28), AndroidUtilities.m54dp(28), true, null);
        ...
        RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C3295R.raw.download_finish, "download_finish", AndroidUtilities.m54dp(28), AndroidUtilities.m54dp(28), true, null);
