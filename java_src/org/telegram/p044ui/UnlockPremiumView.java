...
public class UnlockPremiumView extends FrameLayout {
    ...
    public UnlockPremiumView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            textView.setText(LocaleController.getString("UnlockPremiumStickersDescription", C3295R.string.UnlockPremiumStickersDescription));
        } else if (i == 1) {
            textView.setText(LocaleController.getString("UnlockPremiumReactionsDescription", C3295R.string.UnlockPremiumReactionsDescription));
        }
        ...
        if (i == 0) {
            string = LocaleController.getString("UnlockPremiumStickers", C3295R.string.UnlockPremiumStickers);
        } else {
            string = LocaleController.getString("UnlockPremiumReactions", C3295R.string.UnlockPremiumReactions);
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) "d ").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3295R.C3297drawable.msg_premium_normal)), 0, 1, 0);
