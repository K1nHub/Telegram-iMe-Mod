...
import org.telegram.p044ui.Components.Scroller;
...
import org.telegram.p044ui.SecretMediaViewer;
...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            this.afterDeleteProgressPaint.setStrokeWidth(AndroidUtilities.m54dp(2));
            Paint paint3 = new Paint(1);
            this.circlePaint = paint3;
            paint3.setColor(2130706432);
            this.drawable = context.getResources().getDrawable(C3295R.C3297drawable.flame_small);
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int measuredHeight = (getMeasuredHeight() / 2) - (AndroidUtilities.m54dp(28) / 2);
            this.deleteProgressRect.set(getMeasuredWidth() - AndroidUtilities.m54dp(49), measuredHeight, getMeasuredWidth() - AndroidUtilities.m54dp(21), measuredHeight + AndroidUtilities.m54dp(28));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawCircle(getMeasuredWidth() - AndroidUtilities.m54dp(35), getMeasuredHeight() / 2, AndroidUtilities.m54dp(16), this.circlePaint);
            float f = 1.0f;
            if (this.useVideoProgress) {
                if (SecretMediaViewer.this.videoPlayer != null) {
                    ...
                    if (duration != C0475C.TIME_UNSET && currentPosition != C0475C.TIME_UNSET) {
            ...
            int measuredWidth = getMeasuredWidth() - AndroidUtilities.m54dp(40);
            int measuredHeight = ((getMeasuredHeight() - AndroidUtilities.m54dp(14)) / 2) - AndroidUtilities.m55dp(0.5f);
            this.drawable.setBounds(measuredWidth, measuredHeight, AndroidUtilities.m54dp(10) + measuredWidth, AndroidUtilities.m54dp(14) + measuredHeight);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        } else if (i == NotificationCenter.updateMessageMedia && this.currentMessageObject.getId() == ((TLRPC$Message) objArr[0]).f1457id) {
            if (this.isVideo && !this.videoWatchedOneTime) {
                this.closeVideoAfterWatch = true;
            } else if (!closePhoto(true, true)) {
                this.closeAfterAnimation = true;
    ...
    public void preparePlayer(File file) {
        ...
        if (this.videoPlayer == null) {
            ...
            this.videoPlayer.setDelegate(new C64291(file));
        }
    ...
    /* loaded from: classes5.dex */
    public class C64291 implements VideoPlayer.VideoPlayerDelegate {
            ...
            if (SecretMediaViewer.this.playerRetryPlayCount > 0) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        SecretMediaViewer.C64291.this.lambda$onError$0(file);
                    }
                }, 100L);
                return;
            }
    ...
    public void setParentActivity(Activity activity) {
        ...
        FrameLayoutDrawer frameLayoutDrawer = new FrameLayoutDrawer(activity) { // from class: org.telegram.ui.SecretMediaViewer.3
            ...
            protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                if (SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight = ((C3361ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
        ...
        C3361ActionBar c3361ActionBar = new C3361ActionBar(activity);
        this.actionBar = c3361ActionBar;
        c3361ActionBar.setTitleColor(-1);
        ...
        this.actionBar.setTitleRightMargin(AndroidUtilities.m54dp(70));
        this.containerView.addView(this.actionBar, LayoutHelper.createFrame(-1, -2));
        this.actionBar.setActionBarMenuOnItemClick(new C3361ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.SecretMediaViewer.4
    ...
    public void openMedia(MessageObject messageObject, PhotoViewer.PhotoViewerProvider photoViewerProvider, final Runnable runnable) {
        ...
        if (document != null) {
            if (MessageObject.isGifDocument(document)) {
                this.actionBar.setTitle(LocaleController.getString("DisappearingGif", C3295R.string.DisappearingGif));
                ...
                this.actionBar.setTitle(LocaleController.getString("DisappearingVideo", C3295R.string.DisappearingVideo));
            ...
            i2 = 21;
            c = 4;
            this.actionBar.setTitle(LocaleController.getString("DisappearingPhoto", C3295R.string.DisappearingPhoto));
    ...
    */
    public void onDraw(android.graphics.Canvas r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.SecretMediaViewer.onDraw(android.graphics.Canvas):void");
    }
    ...
    */
    public boolean closePhoto(boolean r19, boolean r20) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.SecretMediaViewer.closePhoto(boolean, boolean):boolean");
    }
    ...
    /* loaded from: classes5.dex */
    public class C64357 extends AnimatorListenerAdapter {
        final /* synthetic */ PhotoViewer.PlaceProviderObject val$object;

        C64357(PhotoViewer.PlaceProviderObject placeProviderObject) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$7$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SecretMediaViewer.C64357.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    */
    public boolean processTouchEvent(android.view.MotionEvent r13) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.SecretMediaViewer.processTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    private void checkMinMax(boolean r6) {
        ...
        L2b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.SecretMediaViewer.checkMinMax(boolean):void");
    }
    ...
    */
    public boolean onDoubleTap(android.view.MotionEvent r10) {
        ...
        L99:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.SecretMediaViewer.onDoubleTap(android.view.MotionEvent):boolean");
    }
}
