...
public class LinkEditActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        ...
        int i = this.type;
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString("NewLink", C3295R.string.NewLink));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("EditLink", C3295R.string.EditLink));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3361ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.LinkEditActivity.1
        ...
        int i2 = this.type;
        if (i2 == 0) {
            this.createTextView.setText(LocaleController.getString("CreateLinkHeader", C3295R.string.CreateLinkHeader));
        } else if (i2 == 1) {
            this.createTextView.setText(LocaleController.getString("SaveLinkHeader", C3295R.string.SaveLinkHeader));
        }
        ...
        int i3 = this.type;
        if (i3 == 0) {
            this.buttonTextView.setText(LocaleController.getString("CreateLink", C3295R.string.CreateLink));
        } else if (i3 == 1) {
            this.buttonTextView.setText(LocaleController.getString("SaveLink", C3295R.string.SaveLink));
        }
        ...
        if (chat == null || chat.username == null) {
            TextCheckCell textCheckCell = new TextCheckCell(this, context) { // from class: org.telegram.ui.LinkEditActivity.4
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // org.telegram.p044ui.Cells.TextCheckCell, android.view.View
            ...
            this.approveCell.setTextAndCheck(LocaleController.getString("ApproveNewMembers", C3295R.string.ApproveNewMembers), false, false);
        ...
        int i5 = C3295R.C3297drawable.greydivider;
        int i6 = Theme.key_windowBackgroundGrayShadow;
        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(context, i5, i6));
        if (z) {
            textInfoPrivacyCell.setText(LocaleController.getString("ApproveNewMembersDescription", C3295R.string.ApproveNewMembersDescription));
        }
        linearLayout.addView(textInfoPrivacyCell);
        HeaderCell headerCell = new HeaderCell(context);
        this.timeHeaderCell = headerCell;
        headerCell.setText(LocaleController.getString("LimitByPeriod", C3295R.string.LimitByPeriod));
        ...
        this.timeEditText.setHint(LocaleController.getString("TimeLimitHint", C3295R.string.TimeLimitHint));
        ...
        textInfoPrivacyCell2.setText(LocaleController.getString("TimeLimitHelp", C3295R.string.TimeLimitHelp));
        linearLayout.addView(this.divider);
        HeaderCell headerCell2 = new HeaderCell(context);
        this.usesHeaderCell = headerCell2;
        headerCell2.setText(LocaleController.getString("LimitNumberOfUses", C3295R.string.LimitNumberOfUses));
        ...
        this.usesEditText.setHint(LocaleController.getString("UsesLimitHint", C3295R.string.UsesLimitHint));
        ...
        textInfoPrivacyCell3.setText(LocaleController.getString("UsesLimitHelp", C3295R.string.UsesLimitHelp));
        ...
        this.nameEditText.setHint(LocaleController.getString("LinkNameHint", C3295R.string.LinkNameHint));
        ...
        int i9 = C3295R.C3297drawable.greydivider_bottom;
        textInfoPrivacyCell4.setBackground(Theme.getThemedDrawableByKey(context, i9, i6));
        this.dividerName.setText(LocaleController.getString("LinkNameHelp", C3295R.string.LinkNameHelp));
        linearLayout.addView(this.dividerName);
        if (this.type == 1) {
            TextSettingsCell textSettingsCell = new TextSettingsCell(context);
            this.revokeLink = textSettingsCell;
            textSettingsCell.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
            this.revokeLink.setText(LocaleController.getString("RevokeLink", C3295R.string.RevokeLink), false);
    ...
    public /* synthetic */ void lambda$createView$6(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3295R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.LinkEditActivity$$ExternalSyntheticLambda0
    ...
    */
    public void onCreateClicked(android.view.View r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.LinkEditActivity.onCreateClicked(android.view.View):void");
    }
    ...
    public void chooseUses(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (i4 == size - 1) {
                strArr[i4] = LocaleController.getString("NoLimit", C3295R.string.NoLimit);
            } else {
    ...
    private void chooseDate(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (i4 == size - 1) {
                ...
                long j2 = currentTime;
                if (j2 < 86400) {
                    strArr[i4] = LocaleController.getString("MessageScheduleToday", C3295R.string.MessageScheduleToday);
                } else if (j2 < 31449600) {
    ...
    private void resetDates() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                this.timeChooseView.setOptions(3, LocaleController.formatPluralString("Hours", 1, new Object[0]), LocaleController.formatPluralString("Days", 1, new Object[0]), LocaleController.formatPluralString("Weeks", 1, new Object[0]), LocaleController.getString("NoLimit", C3295R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public void resetUses() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                this.usesChooseView.setOptions(3, IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, "10", "100", LocaleController.getString("NoLimit", C3295R.string.NoLimit));
                return;
            }
        }
    }
    ...
    private void setUsesVisible(boolean z) {
        ...
        this.divider.setBackground(Theme.getThemedDrawableByKey(getParentActivity(), z ? C3295R.C3297drawable.greydivider : C3295R.C3297drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    }
    ...
    public /* synthetic */ void lambda$getThemeDescriptions$11() {
        ...
        if (textInfoPrivacyCell != null) {
            ...
            int i = C3295R.C3297drawable.greydivider_bottom;
            ...
            this.divider.setBackgroundDrawable(Theme.getThemedDrawableByKey(context, C3295R.C3297drawable.greydivider, i2));
            this.buttonTextView.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m54dp(6), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
