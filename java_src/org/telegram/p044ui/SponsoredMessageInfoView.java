...
public class SponsoredMessageInfoView extends FrameLayout {
    public SponsoredMessageInfoView(final Activity activity, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setText(LocaleController.getString("SponsoredMessageInfo", C3242R.string.SponsoredMessageInfo));
        textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText", resourcesProvider));
        textView.setTextSize(1, 20.0f);
        TextView textView2 = new TextView(activity);
        textView2.setText(LocaleController.getString("SponsoredMessageInfoDescription1", C3242R.string.SponsoredMessageInfoDescription1));
        ...
        textView3.setText(LocaleController.getString("SponsoredMessageInfoDescription2", C3242R.string.SponsoredMessageInfoDescription2));
        ...
        textView4.setText(LocaleController.getString("SponsoredMessageInfoDescription3", C3242R.string.SponsoredMessageInfoDescription3));
        ...
        TextView textView5 = new TextView(this, activity) { // from class: org.telegram.ui.SponsoredMessageInfoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                rectF.set(AndroidUtilities.m50dp(1), AndroidUtilities.m50dp(1), getMeasuredWidth() - AndroidUtilities.m50dp(1), getMeasuredHeight() - AndroidUtilities.m50dp(1));
                canvas.drawRoundRect(rectF, AndroidUtilities.m50dp(4), AndroidUtilities.m50dp(4), paint);
            }
        };
        textView5.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.SponsoredMessageInfoView.2
            ...
            public void onClick(View view) {
                Browser.openUrl(activity, LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", C3242R.string.SponsoredMessageAlertLearnMoreUrl));
            }
        });
        textView5.setPadding(AndroidUtilities.m50dp(12), 0, AndroidUtilities.m50dp(12), 0);
        textView5.setText(LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", C3242R.string.SponsoredMessageAlertLearnMoreUrl));
        ...
        textView6.setText(LocaleController.getString("SponsoredMessageInfoDescription4", C3242R.string.SponsoredMessageInfoDescription4));
