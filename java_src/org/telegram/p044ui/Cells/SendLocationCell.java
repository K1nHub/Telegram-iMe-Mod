...
public class SendLocationCell extends FrameLayout {
    ...
    public void checkText() {
        ...
        if (sharingLocationInfo != null) {
            String string = LocaleController.getString("StopLiveLocation", C3295R.string.StopLiveLocation);
        ...
        setText(LocaleController.getString("SendLiveLocation", C3295R.string.SendLiveLocation), LocaleController.getString("SendLiveLocationInfo", C3295R.string.SendLiveLocationInfo));
    }
