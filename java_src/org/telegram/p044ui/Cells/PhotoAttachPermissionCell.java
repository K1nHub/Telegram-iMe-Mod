...
public class PhotoAttachPermissionCell extends FrameLayout {
    ...
    public void setType(int i) {
        if (i == 0) {
            this.imageView.setImageResource(C3242R.C3244drawable.permissions_camera1);
            this.imageView2.setImageResource(C3242R.C3244drawable.permissions_camera2);
            this.textView.setText(LocaleController.getString("CameraPermissionText", C3242R.string.CameraPermissionText));
        ...
        this.imageView.setImageResource(C3242R.C3244drawable.permissions_gallery1);
        this.imageView2.setImageResource(C3242R.C3244drawable.permissions_gallery2);
        this.textView.setText(LocaleController.getString("GalleryPermissionText", C3242R.string.GalleryPermissionText));
