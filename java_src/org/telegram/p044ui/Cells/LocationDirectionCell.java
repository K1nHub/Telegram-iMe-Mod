...
public class LocationDirectionCell extends FrameLayout {
    ...
    public LocationDirectionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.buttonTextView.setText(LocaleController.getString("Directions", C3295R.string.Directions));
        this.buttonTextView.setLeftDrawable(C3295R.C3297drawable.navigate);
