...
public class LocationDirectionCell extends FrameLayout {
    ...
    public LocationDirectionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.buttonTextView.setText(LocaleController.getString("Directions", C3242R.string.Directions));
        this.buttonTextView.setLeftDrawable(C3242R.C3244drawable.navigate);
