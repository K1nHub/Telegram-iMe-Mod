...
public class DrawerAddCell extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        this.textView.setText(LocaleController.getString("AddAccount", C3295R.string.AddAccount));
        Drawable drawable = getResources().getDrawable(C3295R.C3297drawable.msg_add);
        if (drawable != null) {
