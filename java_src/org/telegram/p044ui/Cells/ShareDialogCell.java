...
public class ShareDialogCell extends FrameLayout {
    ...
    public ShareDialogCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.checkBox.setProgressDelegate(new CheckBoxBase.ProgressDelegate() { // from class: org.telegram.ui.Cells.ShareDialogCell$$ExternalSyntheticLambda2
            @Override // org.telegram.p044ui.Components.CheckBoxBase.ProgressDelegate
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(this.currentType == 2 ? 95 : 103), 1073741824));
    }
    ...
    public void setDialog(long j, boolean z, CharSequence charSequence) {
        if (DialogObject.isUserDialog(j)) {
            ...
            if (this.currentType != 2 && UserObject.isReplyUser(this.user)) {
                this.nameTextView.setText(LocaleController.getString("RepliesTitle", C3242R.string.RepliesTitle));
            ...
            this.imageView.setRoundRadius(AndroidUtilities.m50dp(28));
        } else {
            this.user = null;
            ...
            if (this.currentType != 2 && chat != null && ChatObject.isTemplatesChat(this.currentAccount, chat.f1427id)) {
                this.nameTextView.setText(LocaleController.getInternalString(C3242R.string.chat_templates));
            ...
            this.imageView.setRoundRadius((chat == null || !chat.forum) ? AndroidUtilities.m50dp(28) : AndroidUtilities.m50dp(16));
        }
    ...
    public void setTopic(TLRPC$TL_forumTopic tLRPC$TL_forumTopic, boolean z) {
        ...
        int i = C3242R.C3245id.spring_tag;
        ...
        if (z) {
            ...
            this.nameTextView.setTranslationX(AndroidUtilities.m50dp(10));
        } else {
            this.topicTextView.setAlpha(BitmapDescriptorFactory.HUE_RED);
            this.nameTextView.setAlpha(1.0f);
            this.topicTextView.setTranslationX(-AndroidUtilities.m50dp(10));
    ...
    public /* synthetic */ void lambda$setTopic$1(DynamicAnimation dynamicAnimation, float f, float f2) {
        ...
        this.topicTextView.setTranslationX(f4 * (-AndroidUtilities.m50dp(10)));
        this.nameTextView.setTranslationX(f3 * AndroidUtilities.m50dp(10));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTopic$2(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
        this.topicTextView.setTag(C3242R.C3245id.spring_tag, null);
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.imageView && this.currentType != 2 && (tLRPC$User = this.user) != null && !MessagesController.isSupportUser(tLRPC$User)) {
            ...
            boolean z = (tLRPC$User2.self || tLRPC$User2.bot || (((tLRPC$UserStatus = tLRPC$User2.status) == null || tLRPC$UserStatus.expires <= ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()) && !MessagesController.getInstance(this.currentAccount).onlinePrivacy.containsKey(Long.valueOf(this.user.f1567id)))) ? false : true;
            if (z || this.onlineProgress != BitmapDescriptorFactory.HUE_RED) {
                int bottom = this.imageView.getBottom() - AndroidUtilities.m50dp(6);
                int right = this.imageView.getRight() - AndroidUtilities.m50dp(10);
                ...
                float f = right;
                float f2 = bottom;
                canvas.drawCircle(f, f2, AndroidUtilities.m50dp(7) * this.onlineProgress, Theme.dialogs_onlineCirclePaint);
                Theme.dialogs_onlineCirclePaint.setColor(getThemedColor("chats_onlineCircle"));
                canvas.drawCircle(f, f2, AndroidUtilities.m50dp(5) * this.onlineProgress, Theme.dialogs_onlineCirclePaint);
                if (z) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m50dp = AndroidUtilities.m50dp(this.currentType == 2 ? 24 : 28);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(left - m50dp, top - m50dp, left + m50dp, top + m50dp);
