...
public class StickerSetGroupInfoCell extends LinearLayout {
    ...
    public StickerSetGroupInfoCell(Context context) {
        ...
        textView.setText(LocaleController.getString("GroupStickersInfo", C3242R.string.GroupStickersInfo));
        ...
        this.addButton.setText(LocaleController.getString("ChooseStickerSet", C3242R.string.ChooseStickerSet).toUpperCase());
