...
public class ManageChatUserCell extends FrameLayout {
    ...
    */
    public void update(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Cells.ManageChatUserCell.update(int):void");
    }
