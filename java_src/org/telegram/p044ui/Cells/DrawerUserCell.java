...
public class DrawerUserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void addMuteButton() {
        ...
        imageView.setImageResource(C3242R.C3244drawable.msg_unmute);
    ...
    public /* synthetic */ void lambda$addMuteButton$0(View view) {
        ...
        if (getForkCommonController().isAccountMuted()) {
            string = LocaleController.getString("NotificationsMutedHint", C3242R.string.NotificationsMutedHint);
        } else {
            string = LocaleController.getString("NotificationsUnmutedHint", C3242R.string.NotificationsUnmutedHint);
        }
    ...
    private void updateMuteButtonIcon() {
        ...
        if (imageView != null) {
            imageView.setImageResource(getForkCommonController().isAccountMuted() ? C3242R.C3244drawable.msg_mute : C3242R.C3244drawable.msg_unmute);
        }
    }
