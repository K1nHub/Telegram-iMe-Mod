...
public class GroupCallPipAlertView extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public GroupCallPipAlertView(final Context context, int i) {
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (sharedInstance != null && ChatObject.isChannelOrGiga(sharedInstance.getChat())) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("VoipChannelOpenVoiceChat", C3242R.string.VoipChannelOpenVoiceChat)));
                    } else {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("VoipGroupOpenVoiceChat", C3242R.string.VoipGroupOpenVoiceChat)));
                    }
                }
            }
        };
        ...
        this.leaveButton.setData(C3242R.C3244drawable.calls_decline, -1, -3257782, 0.3f, false, LocaleController.getString("VoipGroupLeave", C3242R.string.VoipGroupLeave), false, false);
    ...
    */
    ...
    protected void onAttachedToWindow() {
        ...
        if (sharedInstance != null && sharedInstance.groupCall != null) {
            ...
            avatarDrawable.setColor(Theme.getColor(Theme.keys_avatar_background[AvatarDrawable.getColorIndex(sharedInstance.getChat().f1427id)]), Theme.getColor(Theme.keys_avatar_background2[AvatarDrawable.getColorIndex(sharedInstance.getChat().f1427id)]));
    ...
    private void updateMembersCount() {
        ...
        if (!sharedInstance.isSwitchingStream() && (callState == 1 || callState == 2 || callState == 6 || callState == 5)) {
            this.subtitleView.setText(LocaleController.getString("VoipGroupConnecting", C3242R.string.VoipGroupConnecting));
            return;
        }
    ...
    private void updateButtons(boolean z) {
        ...
        if (sharedInstance.mutedByAdmin()) {
            this.muteButton.setData(C3242R.C3244drawable.calls_unmute, -1, ColorUtils.setAlphaComponent(-1, 76), 0.1f, true, LocaleController.getString("VoipMutedByAdminShort", C3242R.string.VoipMutedByAdminShort), true, z);
        } else {
            VoIPToggleButton voIPToggleButton = this.muteButton;
            int i2 = C3242R.C3244drawable.calls_unmute;
