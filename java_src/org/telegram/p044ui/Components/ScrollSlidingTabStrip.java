...
public class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    public void addKiklikoTrendsTab(Drawable drawable) {
        ...
        if (stickerTabView != null) {
            ...
            stickerTabView.textView.setText(LocaleController.getString("FeaturedStickersShort", C3295R.string.FeaturedStickersShort));
            this.tabsContainer.addView(stickerTabView, i);
        }
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3295R.C3298id.index_tag, Integer.valueOf(i));
    ...
    public /* synthetic */ void lambda$addKiklikoTrendsTab$0(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(C3295R.C3298id.index_tag)).intValue());
    }
    ...
    public void addKiklikoTab(TagResponse tagResponse) {
        ...
        stickerTabView.setTag(C3295R.C3298id.index_tag, Integer.valueOf(i));
        stickerTabView.setTag(C3295R.C3298id.object_tag, tagResponse.getMeme().getFile().getWebp());
        stickerTabView.setSelected(i == this.currentPosition);
            ...
            */
            public void run() {
                ...
                L48:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.ScrollSlidingTabStrip.RunnableC50686.run():void");
            }
        };
    ...
    public FrameLayout addIconTab(int i, Drawable drawable) {
        ...
        frameLayout.setTag(C3295R.C3298id.index_tag, Integer.valueOf(i2));
    ...
    public StickerTabView addStickerIconTab(int i, Drawable drawable) {
        ...
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3295R.C3298id.index_tag, Integer.valueOf(i2));
    ...
    public View addEmojiTab(int i, Emoji.EmojiDrawable emojiDrawable, TLRPC$Document tLRPC$Document) {
        ...
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3295R.C3298id.index_tag, Integer.valueOf(i2));
        stickerTabView.setTag(C3295R.C3298id.parent_tag, emojiDrawable);
        stickerTabView.setTag(C3295R.C3298id.object_tag, tLRPC$Document);
        stickerTabView.setSelected(i2 == this.currentPosition);
        this.tabTypes.put(str, stickerTabView);
        return stickerTabView;
    }
    ...
    public View addStickerTab(TLObject tLObject, TLRPC$Document tLRPC$Document, TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet) {
        ...
        stickerTabView.setTag(C3295R.C3298id.index_tag, Integer.valueOf(i));
        stickerTabView.setTag(C3295R.C3298id.parent_tag, tLRPC$TL_messages_stickerSet);
        stickerTabView.setTag(C3295R.C3298id.object_tag, tLRPC$Document);
        stickerTabView.setSelected(i == this.currentPosition);
    ...
    public void setImages() {
        ...
        while (true) {
            ...
            if (childAt instanceof StickerTabView) {
                ...
                if (i2 == 100) {
                    Glide.with(getContext()).load((String) stickerTabView.getTag(C3295R.C3298id.object_tag)).diskCacheStrategy(DiskCacheStrategy.ALL).optionalTransform(WebpDrawable.class, new WebpDrawableTransformation(new CenterCrop())).into(stickerTabView.iconView);
                } else {
                    if (i2 == 2) {
                        Object tag = stickerTabView.getTag(C3295R.C3298id.parent_tag);
                        Object tag2 = stickerTabView.getTag(C3295R.C3298id.object_tag);
                        ...
                        Object tag4 = childAt.getTag(C3295R.C3298id.parent_tag);
                        TLRPC$Document tLRPC$Document = (TLRPC$Document) childAt.getTag(C3295R.C3298id.object_tag);
            ...
            if (this.draggingView != null) {
                ...
                if (i3 != i4) {
                    ...
                    for (int i5 = 0; i5 < this.tabsContainer.getChildCount(); i5++) {
                        this.tabsContainer.getChildAt(i5).setTag(C3295R.C3298id.index_tag, Integer.valueOf(i5));
                    }
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(BitmapDescriptorFactory.HUE_RED, 1.0f);
