            ...
            if (stickerSets.isEmpty()) {
                ...
                for (int i2 = 0; i2 < featuredEmojiSets.size(); i2++) {
                    ...
                    if (tLRPC$Document != null) {
                        this.emojiList.document_id.add(Long.valueOf(tLRPC$Document.f1441id));
                        ...
                        if (!tLRPC$TL_stickerSetFullCovered.documents.isEmpty()) {
                            this.emojiList.document_id.add(Long.valueOf(tLRPC$TL_stickerSetFullCovered.documents.get(0).f1441id));
                        }
                    }
                }
            } else {
                for (int i3 = 0; i3 < stickerSets.size(); i3++) {
                    ...
                    if (!tLRPC$TL_messages_stickerSet.documents.isEmpty()) {
                        this.emojiList.document_id.add(Long.valueOf(tLRPC$TL_messages_stickerSet.documents.get(Math.abs(Utilities.fastRandom.nextInt() % tLRPC$TL_messages_stickerSet.documents.size())).f1441id));
                    }
                }
            }
        }
