...
public class GroupCallRenderersContainer extends FrameLayout {
    ...
    public GroupCallRenderersContainer(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList<GroupCallMiniTextureView> arrayList, ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        ImageView imageView = new ImageView(this, context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.2
            ...
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(C3361ActionBar.getCurrentActionBarHeight(), 1073741824));
            }
        };
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(context, C3295R.C3297drawable.msg_pin_filled, -1);
        ...
        this.pinTextView.setText(LocaleController.getString("CallVideoPin", C3295R.string.CallVideoPin));
        ...
        this.unpinTextView.setText(LocaleController.getString("CallVideoUnpin", C3295R.string.CallVideoUnpin));
        ...
        this.pipView.setImageResource(C3295R.C3297drawable.ic_goinline);
        this.pipView.setContentDescription(LocaleController.getString(C3295R.string.AccDescrPipMode));
        ...
        for (int i = 0; i < 2; i++) {
            this.undoView[i] = new UndoView(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.6
                @Override // org.telegram.p044ui.Components.UndoView, android.view.View
                public void invalidate() {
                    super.invalidate();
                    GroupCallRenderersContainer.this.invalidate();
                }
    ...
    public void setIsTablet(boolean z) {
        if (this.isTablet != z) {
            ...
            if (this.isTablet) {
                this.backButton.setImageDrawable(ContextCompat.getDrawable(getContext(), C3295R.C3297drawable.msg_calls_minimize));
                return;
            }
            BackDrawable backDrawable = new BackDrawable(false);
            backDrawable.setColor(-1);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r14) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.voip.GroupCallRenderersContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
