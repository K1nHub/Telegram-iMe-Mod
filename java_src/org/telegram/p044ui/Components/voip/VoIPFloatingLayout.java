...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public VoIPFloatingLayout(Context context) {
        ...
        this.mutedDrawable = ContextCompat.getDrawable(context, C3295R.C3297drawable.calls_mute_mini);
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.voip.VoIPFloatingLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
