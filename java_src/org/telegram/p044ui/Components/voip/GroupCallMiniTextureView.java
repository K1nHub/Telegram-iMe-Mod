...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    public GroupCallMiniTextureView(final GroupCallRenderersContainer groupCallRenderersContainer, ArrayList<GroupCallMiniTextureView> arrayList, final ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(groupCallRenderersContainer.getContext(), C3295R.C3297drawable.calls_video, -1);
        ...
        this.castingScreenDrawable = groupCallRenderersContainer.getContext().getResources().getDrawable(C3295R.C3297drawable.screencast_big).mutate();
        ...
        final String string = LocaleController.getString("VoipVideoOnPause", C3295R.string.VoipVideoOnPause);
        final StaticLayout staticLayout = new StaticLayout(LocaleController.getString("VoipVideoScreenSharingTwoLines", C3295R.string.VoipVideoScreenSharingTwoLines), textPaint, AndroidUtilities.m54dp(400), Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(call.chatId));
        final StaticLayout staticLayout2 = new StaticLayout(LocaleController.formatString("VoipVideoNotAvailable", C3295R.string.VoipVideoNotAvailable, LocaleController.formatPluralString("Participants", MessagesController.getInstance(this.currentAccount).groupCallVideoMaxParticipants, new Object[0])), textPaint, AndroidUtilities.m54dp(400), Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        final String string2 = LocaleController.getString("VoipVideoScreenSharing", C3295R.string.VoipVideoScreenSharing);
        ...
        imageView.setImageDrawable(ContextCompat.getDrawable(groupCallRenderersContainer.getContext(), C3295R.C3297drawable.voicechat_screencast));
        ...
        textView.setText(LocaleController.getString("VoipVideoScreenStopSharing", C3295R.string.VoipVideoScreenStopSharing));
        ...
        if (ChatObject.canManageCalls(chat)) {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3295R.string.NoRtmpStreamFromAppOwner)));
        } else {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoRtmpStreamFromAppViewer", C3295R.string.NoRtmpStreamFromAppViewer, chat.title)));
        }
