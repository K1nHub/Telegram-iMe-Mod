...
import org.telegram.p044ui.CalendarActivity;
...
import org.telegram.p044ui.Cells.SharedPhotoVideoCell2;
...
public class SharedMediaLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setMembersMenuVisible(boolean z, GroupMembersFilter groupMembersFilter) {
        ...
        if (z) {
            ...
            Drawable mutate = ContextCompat.getDrawable(context, groupMembersFilter == groupMembersFilter2 ? C3295R.C3297drawable.ic_ab_other : C3295R.C3297drawable.msg_delete).mutate();
    ...
    public /* synthetic */ void lambda$forwardCloud$0(long j) {
        this.profileActivity.getSendMessagesHelper().sendMessage(prepareForwardingMessages(), j, true, false, true, 0, (MessageObject) null, (ForwardingMessagesParams) null, true);
        closeActionMode();
    }
        ...
        while (true) {
            ...
            if (mediaPageArr[i] != null && mediaPageArr[i].getVisibility() == 0) {
                for (int i2 = 0; i2 < this.mediaPages[i].listView.getChildCount(); i2++) {
                    ...
                    if (childAt.getY() < this.mediaPages[i].listView.blurTopPadding + AndroidUtilities.m54dp(100)) {
    ...
    public static class MediaPage extends FrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (fastScroll != null) {
                ...
                this.fastScrollHintView.setTranslationX((getMeasuredWidth() - this.fastScrollHintView.getMeasuredWidth()) - AndroidUtilities.m54dp(16));
                this.fastScrollHintView.setTranslationY(fastScroll.getScrollBarY() + AndroidUtilities.m54dp(36));
            }
    ...
    public static class SharedMediaPreloader implements NotificationCenter.NotificationCenterDelegate {
        ...
        */
        public void didReceivedNotification(int r25, final int r26, java.lang.Object... r27) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.SharedMediaPreloader.didReceivedNotification(int, int, java.lang.Object[]):void");
        }
    ...
    public static class SharedMediaData {
        ...
        public void replaceMid(int i, int i2) {
            ...
            if (messageObject != null) {
                ...
                messageObject.messageOwner.f1457id = i2;
    ...
    public SharedMediaLayout(Context context, long j, SharedMediaPreloader sharedMediaPreloader, int i, ArrayList<Integer> arrayList, TLRPC$ChatFull tLRPC$ChatFull, boolean z, BaseFragment baseFragment, Delegate delegate, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.provider = new PhotoViewer.EmptyPhotoViewerProvider() { // from class: org.telegram.ui.Components.SharedMediaLayout.1
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public org.telegram.p044ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r17, org.telegram.tgnet.TLRPC$FileLocation r18, int r19, boolean r20) {
                /*
                    Method dump skipped, instructions count: 663
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.C51381.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
        };
        this.sharedMediaData = new SharedMediaData[6];
        this.notificationsLocker = new AnimationNotificationsLocker();
        this.messageAlphaEnter = new SparseArray<>();
        this.sharedLinkCellDelegate = new C516431();
        if (sharedMediaPreloader.isMusicType()) {
            TLRPC$Chat chat = baseFragment.getMessagesController().getChat(Long.valueOf(-j));
            c = 6;
            r4 = 1;
            z2 = false;
            ArrayList<MessageObject> loadPinnedMessages = baseFragment.getMediaDataController().loadPinnedMessages(j, ChatObject.isChannel(chat) ? chat.f1433id : 0L, baseFragment.getMusicController().getPlaylistForDialog(j), false, false, true, true);
        ...
        for (int i6 = z2 ? 1 : 0; i6 < 10; i6++) {
            if (this.initialTab == 4) {
                SharedAudioCell sharedAudioCell = new SharedAudioCell(context, this.sharedMediaPreloader.isMusicType() ? IdFabric$CustomType.SHARED_AUDIO_CELL_MUSIC : z2 ? 1 : 0, null) { // from class: org.telegram.ui.Components.SharedMediaLayout.2
        ...
        this.searching = z2;
        this.searchWas = z2;
        Drawable drawable = context.getResources().getDrawable(C3295R.C3297drawable.photos_header_shadow);
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = createMenu.addItem(z2 ? 1 : 0, C3295R.C3297drawable.ic_ab_search).setIsSearchField(r4).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.Components.SharedMediaLayout.4
        ...
        actionBarMenuItemSearchListener.setTranslationY(AndroidUtilities.m54dp(10));
        ActionBarMenuItem actionBarMenuItem = this.searchItem;
        int i8 = C3295R.string.Search;
        ...
        imageView.setTranslationY(AndroidUtilities.m54dp(10));
        this.membersFilterItem.setVisibility(4);
        this.membersFilterItem.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        Drawable mutate = ContextCompat.getDrawable(context, C3295R.C3297drawable.fork_filter_members).mutate();
        int i9 = Theme.key_windowBackgroundWhiteGrayText2;
        mutate.setColorFilter(new PorterDuffColorFilter(Theme.getColor(i9), PorterDuff.Mode.SRC_IN));
        ...
        imageView2.setTranslationY(AndroidUtilities.m54dp(10));
        this.membersMenuItem.setVisibility(4);
        ...
        imageView3.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3295R.string.AccDescrMoreOptions));
        this.photoVideoOptionsItem.setTranslationY(AndroidUtilities.m54dp(10));
        this.photoVideoOptionsItem.setVisibility(4);
        Drawable mutate2 = ContextCompat.getDrawable(context, C3295R.C3297drawable.ic_ab_other).mutate();
        ...
        this.photoVideoOptionsItem.setOnClickListener(new View$OnClickListenerC51676(context));
        ...
        this.backDrawable.setColor(getThemedColor(i10));
        ImageView imageView6 = this.closeButton;
        int i12 = Theme.key_actionBarActionModeDefaultSelector;
        imageView6.setBackground(Theme.createSelectorDrawable(getThemedColor(i12), 1));
        this.closeButton.setContentDescription(LocaleController.getString("Close", C3295R.string.Close));
        this.actionModeLayout.addView(this.closeButton, new LinearLayout.LayoutParams(AndroidUtilities.m54dp(54), -1));
        ...
        this.selectedMessagesCountTextView.setTextColor(getThemedColor(i10));
        ...
        if (this.sharedMediaPreloader.isMusicType()) {
            r12 = 0;
            ActionBarMenuItem actionBarMenuItem2 = new ActionBarMenuItem(context, (ActionBarMenu) null, Theme.getColor(i12), Theme.getColor(i9), false);
            this.addToPlaylistItem = actionBarMenuItem2;
            actionBarMenuItem2.setIcon(C3295R.C3297drawable.msg_tone_add);
            ...
            this.actionModeLayout.addView(this.addToPlaylistItem, new LinearLayout.LayoutParams(AndroidUtilities.m54dp(54), -1));
            this.actionModeViews.add(this.addToPlaylistItem);
        } else {
            r12 = 0;
        }
        if (!DialogObject.isEncryptedDialog(this.dialog_id)) {
            ActionBarMenuItem actionBarMenuItem3 = new ActionBarMenuItem(context, (ActionBarMenu) null, getThemedColor(i12), getThemedColor(i10), false);
            this.gotoItem = actionBarMenuItem3;
            actionBarMenuItem3.setIcon(C3295R.C3297drawable.msg_message);
            this.gotoItem.setContentDescription(LocaleController.getString("AccDescrGoToMessage", C3295R.string.AccDescrGoToMessage));
            this.gotoItem.setDuplicateParentStateEnabled(r12);
            this.actionModeLayout.addView(this.gotoItem, new LinearLayout.LayoutParams(AndroidUtilities.m54dp(54), -1));
            ...
            ActionBarMenuItem actionBarMenuItem4 = new ActionBarMenuItem(context, (ActionBarMenu) null, getThemedColor(i12), getThemedColor(i9), false);
            this.forwardCloudItem = actionBarMenuItem4;
            actionBarMenuItem4.setIcon(C3295R.C3297drawable.fork_forward_cloud);
            this.forwardCloudItem.setContentDescription(LocaleController.getInternalString(C3295R.string.chat_message_popup_option_forward_cloud));
            this.forwardCloudItem.setDuplicateParentStateEnabled(r12);
            ...
            ActionBarMenuItem actionBarMenuItem5 = new ActionBarMenuItem(context, (ActionBarMenu) null, getThemedColor(i12), getThemedColor(i10), false);
            this.forwardItem = actionBarMenuItem5;
            actionBarMenuItem5.setIcon(C3295R.C3297drawable.msg_forward);
            this.forwardItem.setContentDescription(LocaleController.getString("Forward", C3295R.string.Forward));
            this.forwardItem.setDuplicateParentStateEnabled(r12);
            this.actionModeLayout.addView(this.forwardItem, new LinearLayout.LayoutParams(AndroidUtilities.m54dp(54), -1));
        ...
        ActionBarMenuItem actionBarMenuItem6 = new ActionBarMenuItem(context, (ActionBarMenu) null, getThemedColor(i12), getThemedColor(i10), false);
        this.deleteItem = actionBarMenuItem6;
        actionBarMenuItem6.setIcon(C3295R.C3297drawable.msg_delete);
        this.deleteItem.setContentDescription(LocaleController.getString("Delete", C3295R.string.Delete));
        this.deleteItem.setDuplicateParentStateEnabled(r12);
        this.actionModeLayout.addView(this.deleteItem, new LinearLayout.LayoutParams(AndroidUtilities.m54dp(54), -1));
        ...
        if (sharedMediaPreloader.isMusicType()) {
            int i13 = IdFabric$CustomType.MEDIA_TAB_PLAYLIST;
            this.playlistAdapter = new SharedDocumentsAdapter(context, i13);
            this.playlistSearchAdapter = new MediaSearchAdapter(context, i13);
        }
        ...
        while (true) {
                ...
                */
                public void setTranslationX(float r9) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.C51748.setTranslationX(float):void");
                }
            };
            ...
            final ExtendedGridLayoutManager extendedGridLayoutManager = mediaPageArr2[i16].layoutManager = new ExtendedGridLayoutManager(context, 100) { // from class: org.telegram.ui.Components.SharedMediaLayout.9
                private Size size = new Size();

                @Override // org.telegram.p044ui.Components.ExtendedGridLayoutManager, androidx.recyclerview.widget.GridLayoutManager, androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
                ...
                public void calculateExtraLayoutSpace(RecyclerView.State state, int[] iArr3) {
                    ...
                    if (mediaPage.selectedType != 0) {
                        if (mediaPage.selectedType == 1) {
                            iArr3[1] = Math.max(iArr3[1], AndroidUtilities.m55dp(56.0f) * 2);
                            return;
                        }
                        return;
                    }
                ...
                protected Size getSizeForItem(int i18) {
                    ...
                    if (document != null) {
                        ...
                        if (closestPhotoSizeWithSize != null && (i19 = closestPhotoSizeWithSize.f1464w) != 0 && (i20 = closestPhotoSizeWithSize.f1463h) != 0) {
            ...
            this.mediaPages[i16].listView = new BlurredRecyclerView(context) { // from class: org.telegram.ui.Components.SharedMediaLayout.11
                ...
                public void onLayout(boolean z3, int i18, int i19, int i20, int i21) {
                    super.onLayout(z3, i18, i19, i20, i21);
                    SharedMediaLayout sharedMediaLayout = SharedMediaLayout.this;
                ...
                */
                public void dispatchDraw(android.graphics.Canvas r26) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.C514011.dispatchDraw(android.graphics.Canvas):void");
                }
            ...
            this.mediaPages[i16].listView.setPinnedSectionOffsetY(-AndroidUtilities.m54dp(i14));
            this.mediaPages[i16].listView.setPadding(r12, AndroidUtilities.m54dp(i14), r12, r12);
            this.mediaPages[i16].listView.setItemAnimator(null);
            this.mediaPages[i16].listView.setClipToPadding(r12);
            this.mediaPages[i16].listView.setSectionsType(i14);
            ...
            this.mediaPages[i16].animationSupportingListView = new BlurredRecyclerView(context);
            this.mediaPages[i16].animationSupportingListView.setLayoutManager(this.mediaPages[i16].animationSupportingLayoutManager = new GridLayoutManager(context, 3) { // from class: org.telegram.ui.Components.SharedMediaLayout.12
            ...
            this.mediaPages[i16].listView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.SharedMediaLayout.13
                ...
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    if (mediaPage.listView.getAdapter() == SharedMediaLayout.this.gifAdapter) {
                        ...
                        rect.right = mediaPage.layoutManager.isLastInRow(childAdapterPosition) ? 0 : AndroidUtilities.m54dp(2);
                        return;
                    }
                    rect.left = 0;
                    rect.top = 0;
            ...
            this.mediaPages[i16].listView.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda21
            ...
            this.mediaPages[i16].listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SharedMediaLayout.14
                ...
                public void onScrolled(RecyclerView recyclerView, int i18, int i19) {
                    ...
                    if (i19 != 0 && mediaPage.selectedType == 0) {
            ...
            this.mediaPages[i16].listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda22
            ...
            final BlurredRecyclerView blurredRecyclerView = this.mediaPages[i16].listView;
            this.mediaPages[i16].animatingImageView = new ClippingImageView(this, context) { // from class: org.telegram.ui.Components.SharedMediaLayout.15
                @Override // android.view.View
            ...
            this.mediaPages[i16].progressView = new FlickerLoadingView(context) { // from class: org.telegram.ui.Components.SharedMediaLayout.16
                ...
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // org.telegram.p044ui.Components.FlickerLoadingView, android.view.View
            ...
            this.mediaPages[i16].progressView.showDate(r12);
            if (i16 != 0) {
            ...
            this.mediaPages[i16].emptyView.setOnTouchListener(SharedMediaLayout$$ExternalSyntheticLambda8.INSTANCE);
            this.mediaPages[i16].emptyView.showProgress(true, r12);
            this.mediaPages[i16].emptyView.title.setText(LocaleController.getString("NoResult", C3295R.string.NoResult));
            this.mediaPages[i16].emptyView.subtitle.setText(LocaleController.getString("SearchEmptyViewFilteredSubtitle2", C3295R.string.SearchEmptyViewFilteredSubtitle2));
            ...
            this.mediaPages[i16].listView.setAnimateEmptyView(true, r12);
        ...
        chatActionCell.setCustomDate((int) (System.currentTimeMillis() / 1000), r12, r12);
        ...
        this.floatingDateView.setTranslationY(-AndroidUtilities.m54dp(48));
        ...
        this.fragmentContextView.setDelegate(new FragmentContextView.FragmentContextViewDelegate() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda20
            @Override // org.telegram.p044ui.Components.FragmentContextView.FragmentContextViewDelegate
        ...
        layoutParams.topMargin = AndroidUtilities.m54dp(48) - 1;
    ...
    /* loaded from: classes6.dex */
    public class View$OnClickListenerC51676 implements View.OnClickListener {
        final /* synthetic */ Context val$context;

        View$OnClickListenerC51676(Context context) {
        ...
        public void onClick(View view) {
            ...
            ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(this, this.val$context) { // from class: org.telegram.ui.Components.SharedMediaLayout.6.1
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // org.telegram.p044ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout, android.widget.FrameLayout, android.view.View
                public void onMeasure(int i, int i2) {
                    if (dividerCell.getParent() != null) {
                        dividerCell.setVisibility(8);
                        super.onMeasure(i, i2);
                        dividerCell.getLayoutParams().width = getMeasuredWidth() - AndroidUtilities.m54dp(16);
            ...
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("MediaZoomIn", C3295R.string.MediaZoomIn), C3295R.C3297drawable.msg_zoomin);
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view2) {
                    SharedMediaLayout.View$OnClickListenerC51676.this.lambda$onClick$0(actionBarMenuSubItem, actionBarMenuSubItem2, view2);
                }
            });
            actionBarPopupWindowLayout.addView(actionBarMenuSubItem);
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("MediaZoomOut", C3295R.string.MediaZoomOut), C3295R.C3297drawable.msg_zoomout);
            ...
            if (!DialogObject.isEncryptedDialog(SharedMediaLayout.this.dialog_id)) {
                ...
                actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("Calendar", C3295R.string.Calendar), C3295R.C3297drawable.msg_calendar2);
                ...
                if (z2) {
                    ...
                    actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("MediaShowPhotos", C3295R.string.MediaShowPhotos), 0);
                    ...
                    actionBarMenuSubItem5.setTextAndIcon(LocaleController.getString("MediaShowVideos", C3295R.string.MediaShowVideos), 0);
            ...
            SharedMediaLayout sharedMediaLayout = SharedMediaLayout.this;
            sharedMediaLayout.optionsWindow = AlertsCreator.showPopupMenu(actionBarPopupWindowLayout, sharedMediaLayout.photoVideoOptionsItem, 0, -AndroidUtilities.m54dp(56));
        }
    ...
    public /* synthetic */ void lambda$new$11(MediaPage mediaPage, View view, int i, float f, float f2) {
        ...
        if (mediaPage.selectedType != 7) {
            ...
            bundle.putLong("chat_id", chat.f1433id);
            ...
            } else if (i >= 0 && i < this.chatUsersAdapter.chatInfo.participants.participants.size()) {
    ...
    private void updateForwardItem() {
        ...
        if (z) {
            ...
            this.forwardCloudItem.setBackground(Theme.createSelectorDrawable(Theme.getColor(Theme.key_actionBarActionModeDefaultSelector), 5));
        }
    }
            ...
            if (findFirstVisibleItemPosition >= 0) {
                ...
                if (period != null) {
                    ...
                    calendarActivity.setCallback(new CalendarActivity.Callback() { // from class: org.telegram.ui.Components.SharedMediaLayout.18
                        @Override // org.telegram.p044ui.CalendarActivity.Callback
            ...
            */
            public void onPageScrolled(float r11) {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.C515323.onPageScrolled(float):void");
            }
        });
    ...
    public void hideFloatingDateView(boolean z) {
        ...
        if (z) {
            ...
            this.floatingDateAnimation.playTogether(ObjectAnimator.ofFloat(this.floatingDateView, View.ALPHA, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.floatingDateView, View.TRANSLATION_Y, (-AndroidUtilities.m54dp(48)) + this.additionalFloatingTranslation));
    ...
    public void scrollToTop() {
        ...
        if (i == 0) {
            ...
            if (i != 1 && i != 2) {
                if (i == 3) {
                    itemSize = AndroidUtilities.m54dp(100);
                } else if (i != 4) {
                    if (i == 5) {
                        itemSize = AndroidUtilities.m54dp(60);
                    } else {
                        itemSize = AndroidUtilities.m54dp(58);
                    }
                }
            }
            itemSize = AndroidUtilities.m54dp(56);
        }
    ...
    public void checkLoadMoreScroll(MediaPage mediaPage, final RecyclerListView recyclerListView, LinearLayoutManager linearLayoutManager) {
        ...
        if (recyclerListView.getFastScroll() == null || !recyclerListView.getFastScroll().isPressed() || currentTimeMillis - mediaPage.lastCheckScrollTime >= 300) {
            ...
            if (mediaPage.selectedType == 7) {
                ...
                commonGroupsAdapter.getChats(((TLRPC$Chat) commonGroupsAdapter.chats.get(this.commonGroupsAdapter.chats.size() - 1)).f1433id, 100);
            }
        }
    }
    ...
    public void onActionBarItemClick(View view, int i) {
        ...
        if (i == IdFabric$Menu.TOGGLE_MUSIC_PLAYLIST) {
            ...
            if (this.info != null) {
                TLRPC$Chat chat2 = this.profileActivity.getMessagesController().getChat(Long.valueOf(this.info.f1434id));
                if (this.profileActivity.getMessagesController().isChatNoForwards(chat2)) {
                    HintView hintView = this.fwdRestrictedHint;
                    if (hintView != null) {
                        hintView.setText((!ChatObject.isChannel(chat2) || chat2.megagroup) ? LocaleController.getString("ForwardsRestrictedInfoGroup", C3295R.string.ForwardsRestrictedInfoGroup) : LocaleController.getString("ForwardsRestrictedInfoChannel", C3295R.string.ForwardsRestrictedInfoChannel));
            ...
            if (hasNoforwardsMessage()) {
                ...
                if (hintView2 != null) {
                    hintView2.setText(LocaleController.getString("ForwardsRestrictedInfoBot", C3295R.string.ForwardsRestrictedInfoBot));
                    this.fwdRestrictedHint.showForView(view, true);
                }
                ...
                dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda23
            ...
            int i4 = this.topicId;
            if (i4 != 0) {
                ForumUtilities.applyTopic(chatActivity, MessagesStorage.TopicKey.m46of(dialogId, i4));
                bundle2.putInt("message_id", valueAt.getId());
            }
    ...
    public void setPadding(int i, int i2, int i3, int i4) {
        ...
        this.fragmentContextView.setTranslationY(AndroidUtilities.m54dp(48) + i2);
        this.additionalFloatingTranslation = i2;
        ChatActionCell chatActionCell = this.floatingDateView;
        chatActionCell.setTranslationY((chatActionCell.getTag() == null ? -AndroidUtilities.m54dp(48) : 0) + this.additionalFloatingTranslation);
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r13) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void setVisibleHeight(int i) {
        int max = Math.max(i, AndroidUtilities.m54dp(120));
    ...
    */
    public void didReceivedNotification(int r29, int r30, java.lang.Object... r31) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
    ...
    public void animateItemsEnter(RecyclerListView recyclerListView, int i, SparseBooleanArray sparseBooleanArray) {
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC515828(recyclerListView, sparseBooleanArray, view, i));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Components.SharedMediaLayout$28 */
    /* loaded from: classes6.dex */
    public class ViewTreeObserver$OnPreDrawListenerC515828 implements ViewTreeObserver.OnPreDrawListener {
        ...
        ViewTreeObserver$OnPreDrawListenerC515828(RecyclerListView recyclerListView, SparseBooleanArray sparseBooleanArray, View view, int i) {
                        ...
                        if (messageId != 0 && this.val$addedMesages.get(messageId, false)) {
                            ...
                            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$28$$ExternalSyntheticLambda0
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    SharedMediaLayout.ViewTreeObserver$OnPreDrawListenerC515828.this.lambda$onPreDraw$0(messageId, recyclerListView, valueAnimator);
                                }
                            });
                            ofFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SharedMediaLayout.28.1
                                ...
                                public void onAnimationEnd(Animator animator) {
                                    ...
                                    ViewTreeObserver$OnPreDrawListenerC515828.this.val$finalListView.invalidate();
                                }
                            });
                    ...
                    if (view != null && view.getParent() == null) {
                        ...
                        if (layoutManager != null) {
                            ...
                            ofFloat3.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SharedMediaLayout.28.2
                                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                                public void onAnimationEnd(Animator animator) {
                                    ViewTreeObserver$OnPreDrawListenerC515828.this.val$finalProgressView.setAlpha(1.0f);
                                    layoutManager.stopIgnoringView(ViewTreeObserver$OnPreDrawListenerC515828.this.val$finalProgressView);
                                    ViewTreeObserver$OnPreDrawListenerC515828 viewTreeObserver$OnPreDrawListenerC515828 = ViewTreeObserver$OnPreDrawListenerC515828.this;
                                    viewTreeObserver$OnPreDrawListenerC515828.val$finalListView.removeView(viewTreeObserver$OnPreDrawListenerC515828.val$finalProgressView);
                                }
                            });
                            ofFloat3.start();
                        }
    ...
    */
    private void updateTabs(boolean r13) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.updateTabs(boolean):void");
    }
    ...
    */
    public void switchToCurrentSelectedMode(boolean r27) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.switchToCurrentSelectedMode(boolean):void");
    }
    ...
    private boolean onItemLongClick(MessageObject messageObject, View view, int i) {
        ...
        if (this.addToPlaylistItem != null) {
            if (this.mediaPages[0].selectedType == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
                ...
                this.addToPlaylistItem.setIcon(this.cantAddToPlaylistCount == 0 ? C3295R.C3297drawable.msg_tone_add : C3295R.C3297drawable.msg_tone_off);
    ...
    /* loaded from: classes6.dex */
    public class C516431 implements SharedLinkCell.SharedLinkCellDelegate {
        C516431() {
        }
        ...
        public void onLinkPress(final String str, boolean z) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3295R.string.Open), LocaleController.getString("Copy", C3295R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$31$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    SharedMediaLayout.C516431.this.lambda$onLinkPress$0(str, dialogInterface, i);
                }
            });
    ...
    public static View createEmptyStubView(Context context, int i, long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoMediaSecret", C3295R.string.NoMediaSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoMedia", C3295R.string.NoMedia));
            }
        } else if (i == 1) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedFilesSecret", C3295R.string.NoSharedFilesSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedFiles", C3295R.string.NoSharedFiles));
            }
        } else if (i == 2) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedVoiceSecret", C3295R.string.NoSharedVoiceSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedVoice", C3295R.string.NoSharedVoice));
            }
        } else if (i == 3) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedLinksSecret", C3295R.string.NoSharedLinksSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedLinks", C3295R.string.NoSharedLinks));
            }
        } else if (i == 4 || i == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedAudioSecret", C3295R.string.NoSharedAudioSecret));
            } else if (i == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
                emptyStubView.emptyTextView.setText(LocaleController.getInternalString(C3295R.string.music_playlist_empty_title));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedAudio", C3295R.string.NoSharedAudio));
            }
        } else if (i == 5) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedGifSecret", C3295R.string.NoSharedGifSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoGIFs", C3295R.string.NoGIFs));
            }
        } else if (i == 6) {
            emptyStubView.emptyImageView.setImageDrawable(null);
            emptyStubView.emptyTextView.setText(LocaleController.getString("NoGroupsInCommon", C3295R.string.NoGroupsInCommon));
        } else if (i == 7) {
            emptyStubView.emptyImageView.setImageDrawable(null);
            emptyStubView.emptyTextView.setText("");
            emptyStubView.emptyImageView.setImageResource(C3295R.C3297drawable.fork_members_tip);
            emptyStubView.emptyTextView.setText(LocaleController.getInternalString(C3295R.string.common_empty_state_title));
        }
    ...
    public static class EmptyStubView extends LinearLayout {
        ...
        public EmptyStubView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            textView.setPadding(AndroidUtilities.m54dp(40), 0, AndroidUtilities.m54dp(40), AndroidUtilities.m54dp(128));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (AndroidUtilities.isTablet()) {
                this.emptyTextView.setPadding(AndroidUtilities.m54dp(40), 0, AndroidUtilities.m54dp(40), AndroidUtilities.m54dp(128));
            } else if (rotation == 3 || rotation == 1) {
                this.emptyTextView.setPadding(AndroidUtilities.m54dp(40), 0, AndroidUtilities.m54dp(40), 0);
            } else {
                this.emptyTextView.setPadding(AndroidUtilities.m54dp(40), 0, AndroidUtilities.m54dp(40), AndroidUtilities.m54dp(128));
            }
        ...
        public /* synthetic */ void lambda$queryServerSearch$1(int i, final int i2, final String str, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (tLRPC$TL_error == null) {
                ...
                for (int i3 = 0; i3 < tLRPC$messages_Messages.messages.size(); i3++) {
                    ...
                    if (i == 0 || tLRPC$Message.f1457id <= i) {
                ...
                if (i == this.lastReqId) {
                    ...
                    for (int i2 = 0; i2 < SharedMediaLayout.this.mediaPages.length; i2++) {
                        if (SharedMediaLayout.this.mediaPages[i2].selectedType == this.currentType) {
                            if (this.searchesInProgress == 0 && itemCount2 == 0) {
                                SharedMediaLayout.this.mediaPages[i2].emptyView.title.setText(LocaleController.formatString("NoResultFoundFor", C3295R.string.NoResultFoundFor, str));
        ...
        public /* synthetic */ void lambda$updateSearchResults$4(ArrayList arrayList) {
            if (SharedMediaLayout.this.searching) {
                ...
                for (int i = 0; i < SharedMediaLayout.this.mediaPages.length; i++) {
                    if (SharedMediaLayout.this.mediaPages[i].selectedType == this.currentType) {
                        if (this.searchesInProgress == 0 && itemCount2 == 0) {
                            SharedMediaLayout.this.mediaPages[i].emptyView.title.setText(LocaleController.getString("NoResult", C3295R.string.NoResult));
            ...
            if (view instanceof UserCell) {
                ...
                if (tLRPC$ChatParticipant != null) {
                    ...
                    if (tLRPC$ChatParticipant instanceof TLRPC$TL_chatChannelParticipant) {
                        ...
                        str = LocaleController.getString("ChannelCreator", C3295R.string.ChannelCreator);
                    } else if (tLRPC$ChatParticipant instanceof TLRPC$TL_chatParticipantAdmin) {
                        str = LocaleController.getString("ChannelAdmin", C3295R.string.ChannelAdmin);
                    }
    ...
    public class GroupUsersSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void search(final String str, boolean z) {
            ...
            this.searchAdapterHelper.queryServerSearch(null, true, false, true, false, false, ChatObject.isChannel(this.currentChat) ? this.currentChat.f1433id : 0L, false, 2, 0);
            notifyDataSetChanged();
            for (int i = 0; i < SharedMediaLayout.this.mediaPages.length; i++) {
        ...
        public /* synthetic */ void lambda$processSearch$3(final String str) {
            ...
            this.searchAdapterHelper.queryServerSearch(str, false, false, true, false, false, ChatObject.isChannel(this.currentChat) ? this.currentChat.f1433id : 0L, false, 2, 1);
        }
        ...
        */
        public /* synthetic */ void lambda$processSearch$2(java.lang.String r19, java.util.ArrayList r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.SharedMediaLayout.GroupUsersSearchAdapter.lambda$processSearch$2(java.lang.String, java.util.ArrayList):void");
        }
        ...
        for (final int i8 = 0; i8 < this.mediaPages.length; i8++) {
            ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda19
                ...
                public final void didSetColor() {
                    SharedMediaLayout.this.lambda$getThemeDescriptions$23(i8);
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getThemeDescriptions$23(int i) {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.fragmentContextView) {
            canvas.save();
            canvas.clipRect(0, this.mediaPages[0].getTop(), view.getMeasuredWidth(), this.mediaPages[0].getTop() + view.getMeasuredHeight() + AndroidUtilities.m54dp(12));
