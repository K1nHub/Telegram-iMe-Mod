...
public class BotCommandsMenuView extends View {
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.BotCommandsMenuView.dispatchDraw(android.graphics.Canvas):void");
    }
