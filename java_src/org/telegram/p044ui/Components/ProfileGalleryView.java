...
import org.telegram.p044ui.Components.CircularViewPager;
...
/* renamed from: org.telegram.ui.Components.ProfileGalleryView */
...
public class ProfileGalleryView extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final C3306ActionBar parentActionBar;
    ...
    /* renamed from: org.telegram.ui.Components.ProfileGalleryView$Callback */
    /* loaded from: classes6.dex */
    ...
    /* renamed from: org.telegram.ui.Components.ProfileGalleryView$Item */
    /* loaded from: classes6.dex */
    ...
    public ProfileGalleryView(Context context, C3306ActionBar c3306ActionBar, RecyclerListView recyclerListView, Callback callback) {
        super(context);
        ...
        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getContext(), null, c3306ActionBar);
    ...
    public void checkCustomAvatar(int i, float f) {
        ...
        if (i2 >= 0 || this.fallbackPhotoIndex >= 0) {
            ...
            f3 = Utilities.clamp(f2, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
        }
    ...
    public ProfileGalleryView(Context context, long j, C3306ActionBar c3306ActionBar, RecyclerListView recyclerListView, ProfileActivity.AvatarImageView avatarImageView, int i, Callback callback) {
        super(context);
        this.downPoint = new PointF();
        this.isScrollingListView = true;
        this.isSwipingViewPager = true;
        ...
        this.parentActionBar = c3306ActionBar;
        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getContext(), avatarImageView, c3306ActionBar);
        this.adapter = viewPagerAdapter;
        setAdapter((CircularViewPager.Adapter) viewPagerAdapter);
        this.touchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        this.callback = callback;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.pinchToZoomHelper != null && getCurrentItemView() != null) {
            if (action != 0 && this.isDownReleased && !this.pinchToZoomHelper.isInOverlayMode()) {
                this.pinchToZoomHelper.checkPinchToZoom(MotionEvent.obtain(0L, 0L, 3, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 0), this, getCurrentItemView().getImageReceiver(), null);
    ...
    public void addUploadingImage(ImageLocation imageLocation, ImageLocation imageLocation2) {
        ...
        this.imagesUploadProgress.add(0, Float.valueOf((float) BitmapDescriptorFactory.HUE_RED));
        this.adapter.notifyDataSetChanged();
        resetCurrentItem();
    ...
    */
    public void didReceivedNotification(int r17, int r18, java.lang.Object... r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.ProfileGalleryView.didReceivedNotification(int, int, java.lang.Object[]):void");
    }

    /* renamed from: org.telegram.ui.Components.ProfileGalleryView$ViewPagerAdapter */
    /* loaded from: classes6.dex */
    public class ViewPagerAdapter extends CircularViewPager.Adapter {
        ...
        public ViewPagerAdapter(Context context, ProfileActivity.AvatarImageView avatarImageView, C3306ActionBar c3306ActionBar) {
        ...
        @Override // org.telegram.p044ui.Components.CircularViewPager.Adapter
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.ProfileGalleryView$AvatarImageView */
    /* loaded from: classes6.dex */
    public class AvatarImageView extends BackupImageView {
        ...
        public AvatarImageView(Context context, int i, Paint paint) {
            super(context);
            this.radialProgressSize = AndroidUtilities.m51dp(64.0f);
        ...
        protected void onSizeChanged(int i, int i2, int i3, int i4) {
            ...
            if (this.radialProgress != null) {
                int currentActionBarHeight = (ProfileGalleryView.this.parentActionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + C3306ActionBar.getCurrentActionBarHeight();
        ...
        public /* synthetic */ void lambda$onDraw$0(ValueAnimator valueAnimator) {
            this.radialProgress.setOverrideAlpha(AndroidUtilities.lerp(this.radialProgressHideAnimatorStartValue, (float) BitmapDescriptorFactory.HUE_RED, valueAnimator.getAnimatedFraction()));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.ProfileGalleryView$TextureStubView */
    /* loaded from: classes6.dex */
