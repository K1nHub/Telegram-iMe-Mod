...
public class TranscribeButton {
    ...
    public TranscribeButton(ChatMessageCell chatMessageCell, SeekBarWaveform seekBarWaveform) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C3295R.raw.transcribe_out, "transcribe_out", AndroidUtilities.m54dp(26), AndroidUtilities.m54dp(26));
        ...
        RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C3295R.raw.transcribe_in, "transcribe_in", AndroidUtilities.m54dp(26), AndroidUtilities.m54dp(26));
    ...
    private static class LoadingPointsDrawable extends Drawable {
        ...
        public LoadingPointsDrawable(TextPaint textPaint) {
            ...
            float textSize = textPaint.getTextSize() * 0.89f;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(this, C3295R.raw.dots_loading, "dots_loading", (int) textSize, (int) (textSize * 1.25f)) { // from class: org.telegram.ui.Components.TranscribeButton.LoadingPointsDrawable.1
