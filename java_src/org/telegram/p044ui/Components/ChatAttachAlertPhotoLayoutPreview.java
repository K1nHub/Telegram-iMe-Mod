...
import org.telegram.p044ui.Components.ChatAttachAlertPhotoLayoutPreview;
    ...
    public class GroupCalculator {
        ...
        */
        public void calculate() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.ChatAttachAlertPhotoLayoutPreview.GroupCalculator.calculate():void");
        }
        ...
        public int getWidth() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                int i2 = groupedMessagePosition.f1370pw;
        ...
        public float getHeight() {
            ...
            for (int i = 0; i < size; i++) {
                MessageObject.GroupedMessagePosition groupedMessagePosition = this.posArray.get(i);
                float f = groupedMessagePosition.f1369ph;
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (groupedMessagePosition2 != groupedMessagePosition && groupedMessagePosition2.maxX < i3) {
                    ...
                    for (int max = Math.max(groupedMessagePosition2.minY - i, 0); max <= min; max++) {
                        fArr[max] = fArr[max] + groupedMessagePosition2.f1370pw;
                    }
                }
            }
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (groupedMessagePosition2 != groupedMessagePosition && groupedMessagePosition2.maxY < i) {
                    for (int i4 = groupedMessagePosition2.minX; i4 <= groupedMessagePosition2.maxX; i4++) {
                        fArr[i4] = fArr[i4] + groupedMessagePosition2.f1369ph;
                    }
                }
            }
    ...
    */
    public void onPreMeasure(int r5, int r6) {
        ...
        L74:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.ChatAttachAlertPhotoLayoutPreview.onPreMeasure(int, int):void");
    }
    ...
    public class PreviewGroupsView extends ViewGroup {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                ...
                canvas.translate(dragTranslate.f1693x, dragTranslate.f1694y);
        ...
        Point dragTranslate() {
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                if (!ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding) {
                    ...
                    this.tmpPoint.f1693x = AndroidUtilities.lerp(rect2.left + (rect.width() / 2.0f), ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchX - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellLeft - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromWidth), this.draggingT);
                    this.tmpPoint.f1694y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1628y + rect2.top + (rect.height() / 2.0f), (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellTop - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromHeight)) + ChatAttachAlertPhotoLayoutPreview.this.draggingCellGroupY, this.draggingT);
                } else {
                    ...
                    this.tmpPoint.f1693x = AndroidUtilities.lerp(rect4.left + (rect3.width() / 2.0f), this.savedDragFromX, this.draggingT / this.savedDraggingT);
                    this.tmpPoint.f1694y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1628y + rect4.top + (rect3.height() / 2.0f), this.savedDragFromY, this.draggingT / this.savedDraggingT);
                }
                return this.tmpPoint;
            }
            Point point = this.tmpPoint;
            point.f1693x = BitmapDescriptorFactory.HUE_RED;
            point.f1694y = BitmapDescriptorFactory.HUE_RED;
            return point;
        }
        ...
        void stopDragging() {
            ...
            this.savedDragFromX = dragTranslate.f1693x;
            this.savedDragFromY = dragTranslate.f1694y;
        ...
        void startDragging(PreviewGroupCell.MediaCell mediaCell) {
            ...
            ChatAttachAlertPhotoLayoutPreview chatAttachAlertPhotoLayoutPreview = ChatAttachAlertPhotoLayoutPreview.this;
            chatAttachAlertPhotoLayoutPreview.draggingCellGroupY = chatAttachAlertPhotoLayoutPreview.draggingCell.groupCell.f1628y;
            ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding = false;
            this.draggingT = BitmapDescriptorFactory.HUE_RED;
            invalidate();
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator != null) {
            ...
            public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC$FileLocation tLRPC$FileLocation, int i, boolean z) {
                ...
                if (i >= 0 && i < this.photos.size() && isPhotoChecked(i) && (photoEntry = this.photos.get(i)) != null) {
                    ...
                    if (previewGroupCell != null && mediaCell != null) {
                        ...
                        placeProviderObject.viewY = iArr[1] + ((int) previewGroupCell.f1628y);
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.onTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        public class PreviewGroupCell {
            ...
            private PreviewGroupCell() {
                this.f1628y = BitmapDescriptorFactory.HUE_RED;
                this.indexStart = 0;
            ...
            public class MediaCell {
                ...
                public void layout(GroupCalculator groupCalculator, MessageObject.GroupedMessagePosition groupedMessagePosition, boolean z) {
                    ...
                    float f5 = f3 / f4;
                    float f6 = groupedMessagePosition.f1369ph / f4;
                    this.scale = 1.0f;
                    this.rect.set(f2, f5, (groupedMessagePosition.f1370pw / i) + f2, f6 + f5);
                ...
                */
                public boolean draw(android.graphics.Canvas r20, float r21, boolean r22) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.PreviewGroupCell.MediaCell.draw(android.graphics.Canvas, float, boolean):boolean");
                }
            }
