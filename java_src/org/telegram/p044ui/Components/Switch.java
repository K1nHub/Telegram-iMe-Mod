...
public class Switch extends View {
    ...
    public void setDrawRipple(boolean z) {
        ...
        if (this.rippleDrawable == null) {
            ...
            RippleDrawable rippleDrawable = new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{0}), null, i >= 23 ? null : new Drawable() { // from class: org.telegram.ui.Components.Switch.1
                ...
                public void draw(Canvas canvas) {
                    ...
                    canvas.drawCircle(bounds.centerX(), bounds.centerY(), AndroidUtilities.m50dp(18), Switch.this.ripplePaint);
                }
            });
            this.rippleDrawable = rippleDrawable;
            if (i >= 23) {
                rippleDrawable.setRadius(AndroidUtilities.m50dp(18));
            }
        ...
        if (i >= 28 && z) {
            this.rippleDrawable.setHotspot(this.isChecked ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m50dp(100), AndroidUtilities.m50dp(18));
        }
    ...
    */
    protected void onDraw(android.graphics.Canvas r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.Switch.onDraw(android.graphics.Canvas):void");
    }
