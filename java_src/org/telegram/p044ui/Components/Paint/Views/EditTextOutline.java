...
public class EditTextOutline extends EditTextBoldCursor {
    ...
    @Override // org.telegram.p044ui.Components.EditTextEffects, android.widget.TextView
    ...
    public void setFrameColor(int i) {
        ...
        if (i2 == 0 && i != 0) {
            setPadding(AndroidUtilities.m50dp(19), AndroidUtilities.m50dp(7), AndroidUtilities.m50dp(19), AndroidUtilities.m50dp(7));
            setCursorColor(-16777216);
        } else if (i2 != 0 && i == 0) {
            setPadding(AndroidUtilities.m50dp(7), AndroidUtilities.m50dp(7), AndroidUtilities.m50dp(7), AndroidUtilities.m50dp(7));
            setCursorColor(-1);
        }
        this.mFrameColor = i;
        if (i != 0) {
    ...
    */
    public void onDraw(android.graphics.Canvas r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.Components.Paint.Views.EditTextOutline.onDraw(android.graphics.Canvas):void");
    }
}
