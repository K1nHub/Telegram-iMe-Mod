...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m50dp(33), 0, AndroidUtilities.m50dp(33), 0);
        this.cancelButton.setText(LocaleController.getString("Cancel", C3242R.string.Cancel).toUpperCase());
        ...
        this.doneButton.setPadding(AndroidUtilities.m50dp(33), 0, AndroidUtilities.m50dp(33), 0);
        ...
        this.doneButtonBadgeTextView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m50dp(11), Theme.getColor("picker_badge", resourcesProvider)));
        ...
        this.doneButtonTextView.setCompoundDrawablePadding(AndroidUtilities.m50dp(8));
        this.doneButtonTextView.setText(LocaleController.getString("Send", C3242R.string.Send).toUpperCase());
