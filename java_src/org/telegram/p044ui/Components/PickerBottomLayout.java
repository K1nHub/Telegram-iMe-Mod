...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m54dp(33), 0, AndroidUtilities.m54dp(33), 0);
        this.cancelButton.setText(LocaleController.getString("Cancel", C3295R.string.Cancel).toUpperCase());
        ...
        this.doneButton.setPadding(AndroidUtilities.m54dp(33), 0, AndroidUtilities.m54dp(33), 0);
        ...
        this.doneButtonBadgeTextView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m54dp(11), Theme.getColor(Theme.key_picker_badge, resourcesProvider)));
        this.doneButtonBadgeTextView.setMinWidth(AndroidUtilities.m54dp(23));
        this.doneButtonBadgeTextView.setPadding(AndroidUtilities.m54dp(8), 0, AndroidUtilities.m54dp(8), AndroidUtilities.m54dp(1));
        ...
        this.doneButtonTextView.setCompoundDrawablePadding(AndroidUtilities.m54dp(8));
        this.doneButtonTextView.setText(LocaleController.getString("Send", C3295R.string.Send).toUpperCase());
