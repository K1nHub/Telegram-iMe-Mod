...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.cancelButton.setText(LocaleController.getString("Cancel", C3290R.string.Cancel).toUpperCase());
        ...
        this.doneButtonTextView.setText(LocaleController.getString("Send", C3290R.string.Send).toUpperCase());
