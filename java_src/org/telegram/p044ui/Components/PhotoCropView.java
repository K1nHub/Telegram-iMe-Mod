...
import org.telegram.p044ui.Components.Crop.CropRotationWheel;
import org.telegram.p044ui.Components.Crop.CropTransform;
import org.telegram.p044ui.Components.Crop.CropView;
...
public class PhotoCropView extends FrameLayout {
    ...
    public PhotoCropView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        cropView.setListener(new CropView.CropViewListener() { // from class: org.telegram.ui.Components.PhotoCropView.3
            @Override // org.telegram.p044ui.Components.Crop.CropView.CropViewListener
        ...
        this.cropView.setBottomPadding(AndroidUtilities.m50dp(64));
        ...
        cropRotationWheel.setListener(new CropRotationWheel.RotationWheelListener() { // from class: org.telegram.ui.Components.PhotoCropView.4
            @Override // org.telegram.p044ui.Components.Crop.CropRotationWheel.RotationWheelListener
            public void onStart() {
        ...
        addView(this.wheelView, LayoutHelper.createFrame(-1, -2, 81, 0, 0, 0, 0));
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.thumbImageVisible && view == (cropView = this.cropView)) {
            ...
            int i = m50dp / 2;
            int videoThumbX = (this.delegate.getVideoThumbX() - i) + AndroidUtilities.m50dp(2);
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.m50dp(156);
            ...
            float width = actualRect.width() + ((m50dp - actualRect.width()) * this.thumbAnimationProgress);
            ...
            canvas.drawCircle(videoThumbX + i, measuredHeight + m50dp + AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(3), this.circlePaint);
        }
        return drawChild;
    }
    ...
    public void setVideoThumb(Bitmap bitmap, int i) {
        ...
        animatorSet3.playTogether(ObjectAnimator.ofFloat(this, this.ANIMATION_VALUE, BitmapDescriptorFactory.HUE_RED, 1.0f));
    ...
    public float getRectX() {
        return this.cropView.getCropLeft() - AndroidUtilities.m50dp(14);
    }

    public float getRectY() {
        return (this.cropView.getCropTop() - AndroidUtilities.m50dp(14)) - ((Build.VERSION.SDK_INT < 21 || this.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight);
    }
