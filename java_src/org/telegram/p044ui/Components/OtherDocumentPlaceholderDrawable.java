...
public class OtherDocumentPlaceholderDrawable extends RecyclableDrawable implements DownloadController.FileDownloadProgressListener {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.loaded) {
            string = LocaleController.getString("OpenFile", C3242R.string.OpenFile);
            textPaint = openPaint;
            m50dp = 0;
        } else {
            if (this.loading) {
                string = LocaleController.getString("Cancel", C3242R.string.Cancel).toUpperCase();
            } else {
                string = LocaleController.getString("TapToDownload", C3242R.string.TapToDownload);
            }
    ...
    @Override // org.telegram.p044ui.Components.RecyclableDrawable
    public void recycle() {
