...
public class AvatarConstructorFragment extends BaseFragment {
    ...
    protected C3361ActionBar overlayActionBar;
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("PhotoEditor", C3295R.string.PhotoEditor));
        this.actionBar.setActionBarMenuOnItemClick(new C3361ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.AvatarConstructorFragment.1
        ...
        C3361ActionBar c3361ActionBar2 = new C3361ActionBar(getContext());
        this.overlayActionBar = c3361ActionBar2;
        c3361ActionBar2.setCastShadows(false);
        ...
        if (avatarFor != null && avatarFor.type == 2) {
            string = LocaleController.getString("SuggestPhoto", C3295R.string.SuggestPhoto);
        } else {
        ...
        this.overlayActionBar.setActionBarMenuOnItemClick(new C3361ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.AvatarConstructorFragment.2
            @Override // org.telegram.p044ui.ActionBar.C3361ActionBar.ActionBarMenuOnItemClick
            public void onItemClick(int i2) {
                if (i2 == -1) {
                    AvatarConstructorFragment.this.discardEditor();
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (!avatarConstructorFragment.isLandscapeMode) {
                    if (!avatarConstructorFragment.drawForBlur) {
                        ...
                        float f2 = x + AvatarConstructorFragment.this.previewView.f1617cx;
                        float f3 = lerp + AvatarConstructorFragment.this.previewView.f1618cy;
                        AvatarConstructorFragment avatarConstructorFragment5 = AvatarConstructorFragment.this;
        ...
        PreviewView previewView = new PreviewView(this, getContext()) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.5
            @Override // org.telegram.p044ui.Components.AvatarConstructorFragment.PreviewView, android.view.View
        ...
        textView.setText(LocaleController.getString("ChooseBackground", C3295R.string.ChooseBackground));
        ...
        textView3.setText(LocaleController.getString("ChooseEmojiOrSticker", C3295R.string.ChooseEmojiOrSticker));
        ...
        if (i3 == 1) {
            textView4.setText(LocaleController.getString("SetChannelPhoto", C3295R.string.SetChannelPhoto));
        } else if (i3 == 2) {
            textView4.setText(LocaleController.getString("SetGroupPhoto", C3295R.string.SetGroupPhoto));
        } else {
            ImageUpdater.AvatarFor avatarFor2 = this.avatarFor;
            if (avatarFor2 != null && avatarFor2.type == 2) {
                textView4.setText(LocaleController.getString("SuggestPhoto", C3295R.string.SuggestPhoto));
            } else {
                textView4.setText(LocaleController.getString("SetProfilePhotoAvatarConstructor", C3295R.string.SetProfilePhotoAvatarConstructor));
            }
        }
    ...
    public void discardEditor() {
        ...
        if (this.wasChanged) {
            ...
            builder.setPositiveButton(LocaleController.getString("PassportDiscard", C3295R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.AvatarConstructorFragment$$ExternalSyntheticLambda2
        ...
        if (tLRPC$VideoSize instanceof TLRPC$TL_videoSizeEmojiMarkup) {
            ...
            if (stickerSet != null) {
                for (int i = 0; i < stickerSet.documents.size(); i++) {
                    if (stickerSet.documents.get(i).f1441id == tLRPC$TL_videoSizeStickerMarkup.sticker_id) {
    ...
    public class PreviewView extends FrameLayout {
        ...
        /* renamed from: cx */
        private float f1617cx;

        /* renamed from: cy */
        private float f1618cy;
        ...
        @Override // android.view.ViewGroup, android.view.View
        protected void dispatchDraw(Canvas canvas) {
            this.f1617cx = getMeasuredWidth() / 2.0f;
            this.f1618cy = getMeasuredHeight() / 2.0f;
            ...
            this.f1617cx = AndroidUtilities.lerp(this.f1617cx, (getMeasuredWidth() - AndroidUtilities.m54dp(12)) - AndroidUtilities.m54dp(21), AvatarConstructorFragment.this.keyboardVisibleProgress);
            canvas.save();
            AvatarConstructorFragment avatarConstructorFragment = AvatarConstructorFragment.this;
            ...
            if (backgroundGradient != null) {
                ...
                float f2 = this.f1617cx;
                float f3 = this.size;
                float f4 = this.f1618cy;
                ...
                if (this.changeBackgroundProgress != 1.0f) {
                    ...
                    float f5 = this.f1617cx;
                    float f6 = this.size;
                    float f7 = this.f1618cy;
                    gradientTools2.setBounds(f5 - f6, f7 - f6, f5 + f6, f7 + f6);
                    this.outGradientTools.paint.setAlpha(255);
                    float f8 = measuredWidth;
                    drawBackround(canvas, this.f1617cx, this.f1618cy, f8, this.size, this.outGradientTools.paint);
                    this.gradientTools.paint.setAlpha((int) (this.changeBackgroundProgress * 255.0f));
                    drawBackround(canvas, this.f1617cx, this.f1618cy, f8, this.size, this.gradientTools.paint);
                    ...
                    drawBackround(canvas, this.f1617cx, this.f1618cy, measuredWidth, this.size, this.gradientTools.paint);
                }
            }
            ...
            if (animatedEmojiDrawable != null) {
                ...
                float f10 = this.f1617cx;
                float f11 = this.f1618cy;
            ...
            float f12 = this.f1617cx - lerp2;
            float f13 = this.f1618cy - lerp2;
    ...
    public void showColorPicker() {
        ...
        textView.setText(LocaleController.getString("SetColor", C3295R.string.SetColor));
            ...
            if (this.isCustom) {
                if (this.backgroundGradient == null) {
                    if (this.addIcon == null) {
                        Drawable drawable = ContextCompat.getDrawable(getContext(), C3295R.C3297drawable.msg_filled_plus);
