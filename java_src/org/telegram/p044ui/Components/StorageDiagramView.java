...
public class StorageDiagramView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StorageDiagramView(Context context, long j, boolean z) {
        ...
        if (z) {
            this.dialogText = LocaleController.getString("ArchivedChats", C3295R.string.ArchivedChats);
            CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m54dp(90), Theme.getColor(Theme.key_chats_archiveBackground)), ContextCompat.getDrawable(context, C3295R.C3297drawable.fork_fab_archive));
            ...
            this.dialogText = LocaleController.getString("CacheOtherChats", C3295R.string.CacheOtherChats);
