...
public class ChecksHintView extends FrameLayout {
    ...
    public ChecksHintView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        while (i < 2) {
            ...
            if (i == 0) {
                this.imageView[i].setAnimation(C3295R.raw.ticks_single, 24, 24);
                this.textView[i].setText(LocaleController.getString("HintSent", C3295R.string.HintSent));
            } else {
                this.imageView[i].setAnimation(C3295R.raw.ticks_double, 24, 24);
                this.textView[i].setText(LocaleController.getString("HintRead", C3295R.string.HintRead));
            }
        ...
        imageView.setImageResource(C3295R.C3297drawable.tooltip_arrow);
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, boolean z) {
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C44561());
    ...
    /* loaded from: classes6.dex */
    public class C44561 extends AnimatorListenerAdapter {
        C44561() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(ChecksHintView.this.hideRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChecksHintView$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ChecksHintView.C44561.this.lambda$onAnimationEnd$0();
                }
