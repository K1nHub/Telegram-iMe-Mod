...
/* renamed from: org.telegram.ui.Components.ClippingImageView */
...
public class ClippingImageView extends View {
    ...
    public void setImageBitmap(ImageReceiver.BitmapHolder bitmapHolder) {
        ...
        if (bitmapHolder != null && bitmapHolder.bitmap != null) {
            this.bitmapRect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, bitmapHolder.getWidth(), bitmapHolder.getHeight());
