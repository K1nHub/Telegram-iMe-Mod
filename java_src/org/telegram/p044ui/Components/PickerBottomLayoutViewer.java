...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean z) {
        ...
        this.doneButton.setText(LocaleController.getString("Send", C3242R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C3242R.C3244drawable.photobadge : C3242R.C3244drawable.bluecounter);
