...
import org.telegram.p044ui.Components.FireworksOverlay;
import org.telegram.p044ui.Components.LayoutHelper;
import org.telegram.p044ui.Components.LinkSpanDrawable;
import org.telegram.p044ui.Components.LoadingSpan;
import org.telegram.p044ui.Components.Premium.GLIcon.GLIconRenderer;
import org.telegram.p044ui.Components.Premium.GLIcon.GLIconTextureView;
...
import org.telegram.p044ui.PremiumFeatureCell;
...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC$User tLRPC$User, GiftPremiumBottomSheet.GiftTier giftTier, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumGradientTools.f1704y1 = 1.0f;
        premiumGradientTools.f1703x2 = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1705y2 = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1700cx = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1701cy = BitmapDescriptorFactory.HUE_RED;
        ...
        this.recyclerListView.setPadding(AndroidUtilities.m50dp(6), 0, AndroidUtilities.m50dp(6), 0);
    ...
    public /* synthetic */ void lambda$onViewCreated$2(View view) {
        ...
        PremiumPreviewFragment.buyPremium(this.fragment, Scopes.PROFILE);
    }
    ...
    public void setTitle(boolean z) {
        ...
        if (this.statusStickerSet != null) {
            int i = C3242R.string.TelegramPremiumUserStatusDialogTitle;
            ...
            if (indexOf >= 0) {
                    ...
                    if (stickerSet.set != null) {
                        ...
                        while (true) {
                            if (i2 >= stickerSet.documents.size()) {
                                break;
                            } else if (stickerSet.documents.get(i2).f1435id == stickerSet.set.thumb_document_id) {
                ...
                if (tLRPC$Document != null) {
                    ...
                    spannableStringBuilder.setSpan(new LoadingSpan(this.titleView[0], AndroidUtilities.m50dp(100)), 0, spannableStringBuilder.length(), 33);
                }
                ...
                this.titleView[1].setOnLinkPressListener(new LinkSpanDrawable.LinksTextView.OnLinkPress() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$$ExternalSyntheticLambda6
                    @Override // org.telegram.p044ui.Components.LinkSpanDrawable.LinksTextView.OnLinkPress
            ...
            this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3242R.string.TelegramPremiumUserStatusDialogSubtitle)));
        } else if (this.isEmojiStatus) {
            LinkSpanDrawable.LinksTextView linksTextView = linksTextViewArr[0];
            int i3 = C3242R.string.TelegramPremiumUserStatusDefaultDialogTitle;
            ...
            int i4 = C3242R.string.TelegramPremiumUserStatusDialogSubtitle;
            ...
            if (giftTier != null) {
                if (this.isOutboundGift) {
                    ...
                    int i5 = C3242R.string.TelegramPremiumUserGiftedPremiumOutboundDialogTitleWithPlural;
                    ...
                    int i6 = C3242R.string.TelegramPremiumUserGiftedPremiumOutboundDialogSubtitle;
                ...
                if (tLRPC$User6 != null && !TextUtils.isEmpty(tLRPC$User6.first_name)) {
                    ...
                    if (tLRPC$User7.f1567id != 777000) {
                        this.titleView[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3242R.string.TelegramPremiumUserGiftedPremiumDialogTitleWithPlural, tLRPC$User7.first_name, LocaleController.formatPluralString("GiftMonths", this.giftTier.getMonths(), new Object[0])), "windowBackgroundWhiteBlueButton", 0, null));
                        this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3242R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle)));
                        return;
                    }
                }
                this.titleView[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3242R.string.TelegramPremiumUserGiftedPremiumDialogTitleWithPluralSomeone, LocaleController.formatPluralString("GiftMonths", this.giftTier.getMonths(), new Object[0])), "windowBackgroundWhiteBlueButton", 0, null));
                this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3242R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle)));
                return;
            }
            LinkSpanDrawable.LinksTextView linksTextView3 = linksTextViewArr[0];
            int i7 = C3242R.string.TelegramPremiumUserDialogTitle;
            TLRPC$User tLRPC$User8 = this.user;
            linksTextView3.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(i7, ContactsController.formatName(tLRPC$User8.first_name, tLRPC$User8.last_name)), "windowBackgroundWhiteBlueButton", 0, null));
            this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3242R.string.TelegramPremiumUserDialogSubtitle)));
        }
    }
    ...
    public /* synthetic */ void lambda$setTitle$5(ClickableSpan clickableSpan) {
        ...
        new EmojiPacksAlert(baseFragment, getContext(), this.resourcesProvider, arrayList) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.3
            @Override // org.telegram.p044ui.Components.EmojiPacksAlert
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString("TelegramPremium", C3242R.string.TelegramPremium);
    }
            ...
            if (i == 0) {
                ...
                if (view2 == null) {
                    premiumPreviewBottomSheet.iconTextureView = new GLIconTextureView(this, context, 1) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.2
                        /* JADX INFO: Access modifiers changed from: protected */
                        @Override // org.telegram.p044ui.Components.Premium.GLIcon.GLIconTextureView, android.view.TextureView, android.view.View
                        ...
                        /* JADX INFO: Access modifiers changed from: protected */
                        @Override // org.telegram.p044ui.Components.Premium.GLIcon.GLIconTextureView, android.view.View
                    ...
                    while (i2 < 2) {
                        PremiumPreviewBottomSheet.this.titleView[i2] = new LinkSpanDrawable.LinksTextView(this, context, ((BottomSheet) PremiumPreviewBottomSheet.this).resourcesProvider) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.3
                            ...
                            protected void dispatchDraw(Canvas canvas) {
                                ...
                                AnimatedEmojiSpan.drawAnimatedEmojis(canvas, getLayout(), this.stack, BitmapDescriptorFactory.HUE_RED, null, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 1.0f, porterDuffColorFilter);
                            }
                        ...
                        PremiumPreviewBottomSheet.this.titleViewContainer.addView(PremiumPreviewBottomSheet.this.titleView[i2], LayoutHelper.createFrame(-1, -2));
                        i2++;
                    }
                }
                ...
                PremiumPreviewBottomSheet.this.starParticlesView = new StarParticlesView(this, context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.4
                    /* JADX INFO: Access modifiers changed from: protected */
                    @Override // org.telegram.p044ui.Components.Premium.StarParticlesView, android.view.View
                    public void onMeasure(int i3, int i4) {
                        super.onMeasure(i3, i4);
                        this.drawable.rect2.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m50dp(52));
                    }
                };
                ...
                view = new View(this, context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.7
                    @Override // android.view.View
                    protected void onMeasure(int i3, int i4) {
                        super.onMeasure(i3, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m50dp(68), 1073741824));
                    }
                };
            } else if (i != 4) {
                view = new PremiumFeatureCell(context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.6
                    /* JADX INFO: Access modifiers changed from: protected */
                    @Override // org.telegram.p044ui.PremiumFeatureCell, android.view.ViewGroup, android.view.View
                    public void dispatchDraw(Canvas canvas) {
                        ...
                        canvas.drawRoundRect(rectF, AndroidUtilities.m50dp(8), AndroidUtilities.m50dp(8), PremiumPreviewBottomSheet.this.gradientTools.paint);
                        super.dispatchDraw(canvas);
                    }
                };
            } else {
    ...
    public void mainContainerDispatchDraw(Canvas canvas) {
        ...
        rightDrawable.setAlpha((int) ((1.0f - Utilities.clamp(this.enterTransitionProgress, 1.0f, (float) BitmapDescriptorFactory.HUE_RED)) * 255.0f));
    ...
    public boolean onCustomOpenAnimation() {
        ...
        this.enterAnimator.addListener(new C48874());
    ...
    /* loaded from: classes6.dex */
    public class C48874 extends AnimatorListenerAdapter {
        C48874() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$4$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    PremiumPreviewBottomSheet.C48874.this.lambda$onAnimationEnd$0(rightDrawable, valueAnimator);
                }
            });
            ofInt.start();
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.groupStickersDidLoad && (tLRPC$InputStickerSet = this.statusStickerSet) != null && tLRPC$InputStickerSet.f1450id == ((Long) objArr[0]).longValue()) {
            setTitle(true);
        }
    }
}
