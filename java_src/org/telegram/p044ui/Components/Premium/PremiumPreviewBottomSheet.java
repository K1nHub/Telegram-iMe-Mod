...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC$User tLRPC$User, GiftPremiumBottomSheet.GiftTier giftTier, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumGradientTools.f1711y1 = 1.0f;
        premiumGradientTools.f1710x2 = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1712y2 = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1707cx = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1708cy = BitmapDescriptorFactory.HUE_RED;
                    ...
                    if (stickerSet.set != null) {
                        ...
                        while (true) {
                            if (i2 >= stickerSet.documents.size()) {
                                break;
                            } else if (stickerSet.documents.get(i2).f1441id == stickerSet.set.thumb_document_id) {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.groupStickersDidLoad && (tLRPC$InputStickerSet = this.statusStickerSet) != null && tLRPC$InputStickerSet.f1456id == ((Long) objArr[0]).longValue()) {
            setTitle(true);
        }
    }
}
