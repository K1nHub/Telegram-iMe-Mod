...
public class LimitPreviewView extends LinearLayout {
    ...
    public LimitPreviewView(Context context, int i, int i2, int i3) {
        ...
        textView.setText(LocaleController.getString("LimitFree", C3242R.string.LimitFree));
        ...
        textView3.setText(LocaleController.getString("LimitPremium", C3242R.string.LimitPremium));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for (int i = 0; i < this.animatedLayouts.size(); i++) {
                ...
                if (animatedLayout.direction) {
                    canvas.translate(animatedLayout.f1698x + measuredWidth, (height - ((measuredHeight * 10) * animatedLayout.progress)) + ((10 - animatedLayout.staticLayouts.size()) * measuredHeight));
                    ...
                    canvas.translate(animatedLayout.f1698x + measuredWidth, (((measuredHeight * 10) * animatedLayout.progress) + height) - ((10 - animatedLayout.staticLayouts.size()) * measuredHeight));
        ...
        void createAnimationLayouts() {
            ...
            for (int i2 = 0; i2 < this.text.length(); i2++) {
                if (Character.isDigit(this.text.charAt(i2))) {
                    ...
                    animatedLayout.f1698x = this.textLayout.getSecondaryHorizontal(i2);
