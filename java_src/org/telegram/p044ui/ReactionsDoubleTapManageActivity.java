...
public class ReactionsDoubleTapManageActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        this.actionBar.setTitle(LocaleController.getString("Reactions", C3295R.string.Reactions));
        this.actionBar.setTitle(LocaleController.getString("DoubleTapSetting", C3295R.string.DoubleTapSetting));
        this.actionBar.setBackButtonImage(C3295R.C3297drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setActionBarMenuOnItemClick(new C3361ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ReactionsDoubleTapManageActivity.1
        ...
        RecyclerListView.SelectionAdapter selectionAdapter = new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.ReactionsDoubleTapManageActivity.2
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                if (i == IdFabric$ViewTypes.TEXT_CHECK_CELL) {
                    ...
                    textInfoPrivacyCell.setText(ReactionsDoubleTapManageActivity.this.initInfoText = LocaleController.getString("DoubleTapPreviewRational", C3295R.string.DoubleTapPreviewRational));
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(context, C3295R.C3297drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    ...
                    view.setBackground(Theme.getThemedDrawableByKey(context, C3295R.C3297drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (itemViewType == IdFabric$ViewTypes.TEXT_CHECK_CELL) {
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getString("Enable", C3295R.string.Enable), ReactionsDoubleTapManageActivity.this.getForkCommonController().isQuickReactionEnabled(), false);
                    ...
                    if (i == ReactionsDoubleTapManageActivity.this.enableSectionRow && ReactionsDoubleTapManageActivity.this.getForkCommonController().isQuickReactionEnabled()) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(ReactionsDoubleTapManageActivity.this.getParentActivity(), C3295R.C3297drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        textInfoPrivacyCell.setFixedSize(1);
                        textInfoPrivacyCell.setText(null);
                        return;
                    }
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(ReactionsDoubleTapManageActivity.this.getParentActivity(), C3295R.C3297drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    ...
                    if (i != ReactionsDoubleTapManageActivity.this.enableSectionRow) {
                        ...
                        textInfoPrivacyCell.setText(LocaleController.getInternalString(C3295R.string.quick_reaction_settings_enable_item_hint));
                    }
    ...
    public class SetDefaultReactionCell extends FrameLayout {
        ...
        public SetDefaultReactionCell(Context context) {
            ...
            this.textView.setText(LocaleController.getString("DoubleTapSetting", C3295R.string.DoubleTapSetting));
    ...
    */
    public void showSelectStatusDialog(final org.telegram.p044ui.ReactionsDoubleTapManageActivity.SetDefaultReactionCell r17) {
        /*
            Method dump skipped, instructions count: 244
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p044ui.ReactionsDoubleTapManageActivity.showSelectStatusDialog(org.telegram.ui.ReactionsDoubleTapManageActivity$SetDefaultReactionCell):void");
    }
