...
public class PrivacyUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ContactsActivity.ContactsActivityDelegate {
    ...
    public View createView(Context context) {
        ...
        if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("BlockedUsers", C3295R.string.BlockedUsers));
        } else if (i == 2) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3361ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PrivacyUsersActivity.1
        ...
        if (this.currentType == 1) {
            emptyTextProgressView.setText(LocaleController.getString("NoBlocked", C3295R.string.NoBlocked));
        } else {
            emptyTextProgressView.setText(LocaleController.getString("NoContacts", C3295R.string.NoContacts));
        }
    ...
    public /* synthetic */ void lambda$createView$3(View view, int i) {
        if (i == this.deleteAllRow) {
            AlertDialog create = AlertsCreator.createSimpleAlert(getContext(), LocaleController.getString(C3295R.string.NotificationsDeleteAllExceptionTitle), LocaleController.getString(C3295R.string.NotificationsDeleteAllExceptionAlert), LocaleController.getString(C3295R.string.Delete), new Runnable() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda0
    ...
    public void showUnblockAlert(final Long l, View view) {
        ...
        int i = this.currentType;
        addIf.addIf(i != 1, i == 0 ? C3295R.C3297drawable.msg_user_remove : 0, (CharSequence) LocaleController.getString("Remove", C3295R.string.Remove), true, new Runnable() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (keyAt > 0) {
                    ...
                    if (user == null) {
                        manageChatUserCell.setData(Long.valueOf(keyAt), LocaleController.formatStringInternal(C3295R.string.common_id, Long.valueOf(keyAt)), LocaleController.getString("NumberUnknown", C3295R.string.NumberUnknown), i != PrivacyUsersActivity.this.usersEndRow - 1);
                        return;
                    }
                    if (user.bot) {
                        StringBuilder sb = new StringBuilder();
                        int i2 = C3295R.string.Bot;
                        ...
                        if (str != null && str.length() != 0) {
                            ...
                            string2 = c3212PhoneFormat.format("+" + user.phone);
                        } else {
                            string2 = LocaleController.getString("NumberUnknown", C3295R.string.NumberUnknown);
                        }
                    }
                ...
                if (chat != null) {
                    ...
                    if (i3 != 0) {
                        ...
                        string = LocaleController.getString("MegaLocation", C3295R.string.MegaLocation);
                ...
                if (i == PrivacyUsersActivity.this.blockUserDetailRow) {
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        ...
                        textInfoPrivacyCell.setText(LocaleController.getString("BlockedUsersInfo", C3295R.string.BlockedUsersInfo));
                    } else {
                    ...
                    if (PrivacyUsersActivity.this.usersStartRow == -1) {
                        ...
                        textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3295R.C3297drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    }
                ...
                if (i == PrivacyUsersActivity.this.usersHeaderRow) {
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        ...
                        headerCell.setText(LocaleController.getString("PrivacyExceptions", C3295R.string.PrivacyExceptions));
                    }
                }
            } else {
                ...
                if (!PrivacyUsersActivity.this.isWalletWhitelist) {
                    if (PrivacyUsersActivity.this.currentType != 1) {
                        manageChatTextCell.setText(LocaleController.getString("PrivacyAddAnException", C3295R.string.PrivacyAddAnException), null, C3295R.C3297drawable.msg_contact_add, PrivacyUsersActivity.this.uidArray.size() > 0);
                        return;
                    } else {
                        manageChatTextCell.setText(LocaleController.getString("BlockUser", C3295R.string.BlockUser), null, C3295R.C3297drawable.msg_contact_add, false);
                        return;
                    }
                }
                manageChatTextCell.setText(LocaleController.getString("EmpryUsersPlaceholder", C3295R.string.EmpryUsersPlaceholder), null, C3295R.C3297drawable.msg_contact_add, false);
            }
        }
