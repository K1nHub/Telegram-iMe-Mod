...
public class CacheControlActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public class ListAdapter extends AdapterWithDiffUtils {
        ...
        /* loaded from: classes5.dex */
        class C39281 extends CacheChart {
            /* JADX INFO: Access modifiers changed from: private */
                ...
                if (i2 >= 0) {
                    CacheControlActivity.this.listView.highlightRow(new RecyclerListView.IntReturnCallback() { // from class: org.telegram.ui.CacheControlActivity$ListAdapter$1$$ExternalSyntheticLambda0
                        ...
                        public final int run() {
                            ...
                            lambda$onSectionDown$0 = CacheControlActivity.ListAdapter.C39281.lambda$onSectionDown$0(i2);
            ...
            if (i == 0) {
                ...
                switch (i) {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        flickerLoadingView = CacheControlActivity.this.cacheChart = new C39281(this.mContext);
                        break;
                    case 10:
