...
public class LiteModeSettingsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("PowerUsage", C3634R.string.PowerUsage));
        this.actionBar.setActionBarMenuOnItemClick(new C3706ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.LiteModeSettingsActivity.1
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i, float f, float f2) {
        ...
        if (i2 == 3 || i2 == 4) {
            if (LiteMode.isPowerSaverApplied()) {
                this.restrictBulletin = BulletinFactory.m62of(this).createSimpleBulletin(new BatteryDrawable(0.1f, -1, Theme.getColor(Theme.key_dialogSwipeRemove), 1.3f), LocaleController.getString("LiteBatteryRestricted", C3634R.string.LiteBatteryRestricted)).show();
            } else if (item.viewType == 3 && item.getFlagsCount() > 1 && (!LocaleController.isRTL ? f < view.getMeasuredWidth() - AndroidUtilities.m104dp(75) : f > AndroidUtilities.m104dp(75)) && (expandedIndex = getExpandedIndex(item.flags)) != -1) {
    ...
    public /* synthetic */ int lambda$highlightRow$2(int i) {
        this.layoutManager.scrollToPositionWithOffset(i, AndroidUtilities.m104dp(60));
        return i;
    }
    ...
    private void updateItems() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (LiteMode.getPowerSaverLevel() <= 0) {
                formatString = LocaleController.getString(C3634R.string.LiteBatteryInfoDisabled);
            } else if (LiteMode.getPowerSaverLevel() >= 100) {
                formatString = LocaleController.getString(C3634R.string.LiteBatteryInfoEnabled);
            } else {
                formatString = LocaleController.formatString(C3634R.string.LiteBatteryInfoBelow, String.format("%d%%", Integer.valueOf(LiteMode.getPowerSaverLevel())));
            }
            arrayList.add(Item.asInfo(formatString));
        }
        this.items.add(Item.asHeader(LocaleController.getString("LiteOptionsTitle")));
        this.items.add(Item.asSwitch(C3634R.C3636drawable.msg2_sticker, LocaleController.getString("LiteOptionsStickers", C3634R.string.LiteOptionsStickers), 3));
        if (this.expanded[0]) {
        ...
        this.items.add(Item.asSwitch(C3634R.C3636drawable.msg2_smile_status, LocaleController.getString("LiteOptionsEmoji", C3634R.string.LiteOptionsEmoji), LiteMode.FLAGS_ANIMATED_EMOJI));
        if (this.expanded[1]) {
        ...
        this.items.add(Item.asSwitch(C3634R.C3636drawable.msg2_ask_question, LocaleController.getString("LiteOptionsChat"), this.FLAGS_CHAT));
        if (this.expanded[2]) {
        ...
        this.items.add(Item.asSwitch(C3634R.C3636drawable.msg2_call_earpiece, LocaleController.getString("LiteOptionsCalls"), 512));
        this.items.add(Item.asSwitch(C3634R.C3636drawable.msg2_videocall, LocaleController.getString("LiteOptionsAutoplayVideo"), 1024));
        this.items.add(Item.asSwitch(C3634R.C3636drawable.msg2_gif, LocaleController.getString("LiteOptionsAutoplayGifs"), 2048));
    ...
    public class Adapter extends AdapterWithDiffUtils {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 1) {
                ...
                if (z2 && z) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(LiteModeSettingsActivity.this.getContext(), C3634R.C3636drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                } else if (z2) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(LiteModeSettingsActivity.this.getContext(), C3634R.C3636drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                } else if (z) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(LiteModeSettingsActivity.this.getContext(), C3634R.C3636drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
                } else {
    ...
    public class SwitchCell extends FrameLayout {
        ...
        public SwitchCell(Context context) {
            ...
            TextView textView = new TextView(this, context, LiteModeSettingsActivity.this) { // from class: org.telegram.ui.LiteModeSettingsActivity.SwitchCell.1
                ...
                protected void onMeasure(int i2, int i3) {
                    if (View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
                        i2 = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2) - AndroidUtilities.m104dp(52), Integer.MIN_VALUE);
                    }
            ...
            this.countTextView.setTextSize(AndroidUtilities.m104dp(14));
        ...
        public void set(Item item, boolean z) {
            ...
            if (item.viewType == 3) {
                ...
                this.arrowView.setVisibility(8);
                this.textView.setText(item.text);
                this.textView.setTranslationX(AndroidUtilities.m104dp(41) * (LocaleController.isRTL ? -2.2f : 1.0f));
            ...
            marginLayoutParams.rightMargin = AndroidUtilities.m104dp(i);
            this.needDivider = z;
            if (z || this.needLine) {
                z2 = false;
            }
        ...
        */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (LocaleController.isRTL) {
                if (this.needLine) {
                    float m104dp = AndroidUtilities.m104dp(75);
                    canvas.drawRect(m104dp - AndroidUtilities.m105dp(0.66f), (getMeasuredHeight() - AndroidUtilities.m104dp(20)) / 2.0f, m104dp, (getMeasuredHeight() + AndroidUtilities.m104dp(20)) / 2.0f, Theme.dividerPaint);
                }
                if (this.needDivider) {
                    canvas.drawLine((getMeasuredWidth() - AndroidUtilities.m104dp(64)) + (this.textView.getTranslationX() < BitmapDescriptorFactory.HUE_RED ? AndroidUtilities.m104dp(-32) : 0), getMeasuredHeight() - 1, BitmapDescriptorFactory.HUE_RED, getMeasuredHeight() - 1, Theme.dividerPaint);
                    return;
                }
                return;
            }
            if (this.needLine) {
                float measuredWidth = getMeasuredWidth() - AndroidUtilities.m104dp(75);
                canvas.drawRect(measuredWidth - AndroidUtilities.m105dp(0.66f), (getMeasuredHeight() - AndroidUtilities.m104dp(20)) / 2.0f, measuredWidth, (getMeasuredHeight() + AndroidUtilities.m104dp(20)) / 2.0f, Theme.dividerPaint);
            }
            if (this.needDivider) {
                canvas.drawLine(AndroidUtilities.m104dp(64) + this.textView.getTranslationX(), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (this.containing) {
                sb.append('\n');
                sb.append(LocaleController.formatString("Of", C3634R.string.Of, Integer.valueOf(this.enabled), Integer.valueOf(this.all)));
            }
    ...
    public class PowerSaverSlider extends FrameLayout {
        ...
        public PowerSaverSlider(Context context) {
            ...
            AnimatedTextView animatedTextView = new AnimatedTextView(this, context, true, false, false, LiteModeSettingsActivity.this) { // from class: org.telegram.ui.LiteModeSettingsActivity.PowerSaverSlider.1
                Drawable backgroundDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m104dp(4), Theme.multAlpha(Theme.getColor(Theme.key_windowBackgroundWhiteBlueHeader), 0.15f));
            ...
            this.headerOnView.setPadding(AndroidUtilities.m105dp(5.33f), AndroidUtilities.m104dp(2), AndroidUtilities.m105dp(5.33f), AndroidUtilities.m104dp(2));
            this.headerOnView.setTextSize(AndroidUtilities.m104dp(12));
            ...
            this.leftTextView.setText(LocaleController.getString("LiteBatteryDisabled", C3634R.string.LiteBatteryDisabled));
            ...
            this.middleTextView.setTextSize(AndroidUtilities.m104dp(13));
            ...
            this.batteryIcon.setTranslationY(AndroidUtilities.m105dp(1.5f));
            this.batteryIcon.setBounds(AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(-20), AndroidUtilities.m104dp(23), 0);
            ...
            this.rightTextView.setText(LocaleController.getString("LiteBatteryEnabled", C3634R.string.LiteBatteryEnabled));
            ...
            this.seekBarAccessibilityDelegate = new IntSeekBarAccessibilityDelegate(LiteModeSettingsActivity.this) { // from class: org.telegram.ui.LiteModeSettingsActivity.PowerSaverSlider.4
                ...
                public void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
                    ...
                    StringBuilder sb = new StringBuilder(LocaleController.getString(C3634R.string.LiteBatteryTitle));
                    sb.append(", ");
                    int powerSaverLevel = LiteMode.getPowerSaverLevel();
                    if (powerSaverLevel <= 0) {
                        sb.append(LocaleController.getString(C3634R.string.LiteBatteryAlwaysDisabled));
                    } else if (powerSaverLevel >= 100) {
                        sb.append(LocaleController.getString(C3634R.string.LiteBatteryAlwaysEnabled));
                    } else {
                        sb.append(LocaleController.formatString(C3634R.string.AccDescrLiteBatteryWhenBelow, Integer.valueOf(Math.round(powerSaverLevel))));
                    }
        ...
        public void update() {
            ...
            if (powerSaverLevel <= 0) {
                this.middleTextView.setText(LocaleController.getString("LiteBatteryAlwaysDisabled", C3634R.string.LiteBatteryAlwaysDisabled), !LocaleController.isRTL);
            } else if (powerSaverLevel >= 100) {
                this.middleTextView.setText(LocaleController.getString("LiteBatteryAlwaysEnabled", C3634R.string.LiteBatteryAlwaysEnabled), !LocaleController.isRTL);
            } else {
                float f = powerSaverLevel;
                this.batteryIcon.setFillValue(f / 100.0f, true);
                this.middleTextView.setText(AndroidUtilities.replaceCharSequence("%s", LocaleController.getString("LiteBatteryWhenBelow", C3634R.string.LiteBatteryWhenBelow), TextUtils.concat(String.format("%d%% ", Integer.valueOf(Math.round(f))), this.batteryText)), !LocaleController.isRTL);
            }
            AnimatedTextView animatedTextView = this.headerOnView;
            if (LiteMode.isPowerSaverApplied()) {
                i = C3634R.string.LiteBatteryEnabled;
                str = "LiteBatteryEnabled";
            } else {
                i = C3634R.string.LiteBatteryDisabled;
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(112), 1073741824));
        }
    }
