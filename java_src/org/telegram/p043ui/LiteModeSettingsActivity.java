    ...
    public /* synthetic */ void lambda$createView$0(View view, int i, float f, float f2) {
        ...
        if (i2 == 3 || i2 == 4) {
            if (LiteMode.isPowerSaverApplied()) {
                this.restrictBulletin = BulletinFactory.m62of(this).createSimpleBulletin(new BatteryDrawable(0.1f, -1, Theme.getColor(Theme.key_dialogSwipeRemove), 1.3f), LocaleController.getString("LiteBatteryRestricted", C3632R.string.LiteBatteryRestricted)).show();
