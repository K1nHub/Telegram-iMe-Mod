...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class EmptyTextProgressView extends FrameLayout {
        ...
        public EmptyTextProgressView(Context context, View view) {
            ...
            this.emptyTextView2.setLineSpacing(AndroidUtilities.m107dp(2), 1.0f);
                ...
                while (it.hasNext()) {
                    ...
                    if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionPhoneCall) {
                        ...
                        if (this.calls.size() > 0) {
                            ...
                            if (callLogRow.user.f1751id == j && callLogRow.type == i3) {
    ...
    public class CallCell extends FrameLayout {
        ...
        public CallCell(Context context) {
            ...
            profileSearchCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m107dp(32) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m107dp(32), 0);
            this.profileSearchCell.setSublabelOffset(AndroidUtilities.m107dp(LocaleController.isRTL ? 2 : -2), -AndroidUtilities.m107dp(4));
        ...
        public /* synthetic */ void lambda$new$0(View view) {
            ...
            TLRPC$UserFull userFull = CallLogActivity.this.getMessagesController().getUserFull(callLogRow.user.f1751id);
    ...
    public class GroupCallCell extends FrameLayout {
        ...
        public GroupCallCell(Context context) {
            ...
            ProfileSearchCell profileSearchCell = new ProfileSearchCell(context);
            this.profileSearchCell = profileSearchCell;
            profileSearchCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m107dp(44) + ceil : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m107dp(44) + ceil, 0);
            this.profileSearchCell.setSublabelOffset(0, -AndroidUtilities.m107dp(1));
            addView(this.profileSearchCell, LayoutHelper.createFrame(-1, -1));
            ...
            this.button.setPadding(AndroidUtilities.m107dp(14), 0, AndroidUtilities.m107dp(14), 0);
    ...
    public View createView(Context context) {
        ...
        this.listView.setOnScrollListener(new C39622());
        if (this.loading) {
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i) {
        ...
        bundle2.putLong("user_id", callLogRow.user.f1751id);
    ...
    /* loaded from: classes5.dex */
    public class C39622 extends RecyclerView.OnScrollListener {
        C39622() {
        }
        ...
        */
        public void onScrolled(androidx.recyclerview.widget.RecyclerView r5, int r6, int r7) {
            ...
            Ld1:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.CallLogActivity.C39622.onScrolled(androidx.recyclerview.widget.RecyclerView, int, int):void");
        }
    ...
    public /* synthetic */ void lambda$createView$2(TLRPC$User tLRPC$User, String str, ContactsActivity contactsActivity) {
        TLRPC$UserFull userFull = getMessagesController().getUserFull(tLRPC$User.f1751id);
    ...
    public void showDeleteAlert(final boolean z) {
        ...
        checkBoxCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m107dp(8) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m107dp(8), 0);
    ...
    private void createActionMode() {
        ...
        this.actionModeViews.add(createActionMode.addItemWithWidth(2, C3632R.C3634drawable.msg_delete, AndroidUtilities.m107dp(54), LocaleController.getString("Delete", C3632R.string.Delete)));
    }
    ...
    public void hideFloatingButton(boolean z) {
        ...
        fArr[0] = z ? AndroidUtilities.m107dp(100) : BitmapDescriptorFactory.HUE_RED;
        ...
        if (tLRPC$TL_error == null) {
            ...
            for (int i2 = 0; i2 < tLRPC$messages_Messages.messages.size(); i2++) {
                ...
                if (tLRPC$MessageAction != null && !(tLRPC$MessageAction instanceof TLRPC$TL_messageActionHistoryClear)) {
                    ...
                    if (callLogRow == null || callLogRow.user.f1751id != fromChatId || callLogRow.type != i3) {
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        ...
        if (i == 101 || i == 102 || i == 103) {
            ...
            if (iArr.length <= 0 || !z) {
                ...
                TLRPC$UserFull userFull = this.lastCallUser != null ? getMessagesController().getUserFull(this.lastCallUser.f1751id) : null;
