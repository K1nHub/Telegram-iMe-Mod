...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class EmptyTextProgressView extends FrameLayout {
        ...
        public EmptyTextProgressView(Context context, View view) {
            ...
            rLottieImageView.setAnimation(C3473R.raw.utyan_call, 120, 120);
            ...
            this.emptyTextView1.setText(LocaleController.getString("NoRecentCalls", C3473R.string.NoRecentCalls));
            ...
            String string = LocaleController.getString("NoRecentCallsInfo", C3473R.string.NoRecentCallsInfo);
        ...
        if (i == NotificationCenter.didReceiveNewMessages) {
                ...
                while (it.hasNext()) {
                    ...
                    if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionPhoneCall) {
                        ...
                        if (this.calls.size() > 0) {
                            ...
                            if (callLogRow.user.f1685id == j && callLogRow.type == i3) {
            ...
            if (this.firstLoaded && !((Boolean) objArr[2]).booleanValue()) {
                ...
                while (it2.hasNext()) {
                    ...
                    while (it3.hasNext()) {
                        if (arrayList2.contains(Integer.valueOf(it3.next().f1546id))) {
                            it3.remove();
                            r3 = 1;
                        }
                    }
            ...
            if (l2 == null || ((TLRPC$ChatFull) objArr[0]).f1523id != l2.longValue() || getMessagesController().getGroupCall(this.waitingForCallChatId.longValue(), true) == null) {
                return;
            }
    ...
    public class CallCell extends FrameLayout {
        ...
        public CallCell(Context context) {
            ...
            this.imageView.setContentDescription(LocaleController.getString("Call", C3473R.string.Call));
        ...
        public /* synthetic */ void lambda$new$0(View view) {
            ...
            TLRPC$UserFull userFull = CallLogActivity.this.getMessagesController().getUserFull(callLogRow.user.f1685id);
    ...
    public class GroupCallCell extends FrameLayout {
        ...
        public GroupCallCell(Context context) {
            ...
            String string = LocaleController.getString("VoipChatJoin", C3473R.string.VoipChatJoin);
    ...
    public View createView(Context context) {
        Drawable mutate = getParentActivity().getResources().getDrawable(C3473R.C3475drawable.ic_call_made_green_18dp).mutate();
        ...
        int i2 = C3473R.C3475drawable.ic_call_received_green_18dp;
        ...
        this.actionBar.setTitle(LocaleController.getString("Calls", C3473R.string.Calls));
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.CallLogActivity.1
        ...
        ActionBarMenuItem addItem = this.actionBar.createMenu().addItem(10, C3473R.C3475drawable.ic_ab_other);
        ...
        this.otherItem.addSubItem(1, C3473R.C3475drawable.msg_delete, LocaleController.getString("DeleteAllCalls", C3473R.string.DeleteAllCalls));
        ...
        this.listView.setOnScrollListener(new C37902());
        if (this.loading) {
        ...
        if (i3 < 21) {
            Drawable mutate4 = context.getResources().getDrawable(C3473R.C3475drawable.floating_shadow).mutate();
        ...
        this.floatingButton.setImageResource(C3473R.C3475drawable.ic_call);
        this.floatingButton.setContentDescription(LocaleController.getString("Call", C3473R.string.Call));
        if (i3 >= 21) {
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i) {
        if (!(view instanceof CallCell)) {
            if (view instanceof GroupCallCell) {
                ...
                bundle.putLong("chat_id", ((GroupCallCell) view).currentChat.f1522id);
        ...
        bundle2.putLong("user_id", callLogRow.user.f1685id);
        bundle2.putInt("message_id", callLogRow.calls.get(0).f1546id);
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    /* loaded from: classes3.dex */
    public class C37902 extends RecyclerView.OnScrollListener {
        C37902() {
        }
        ...
        */
        public void onScrolled(androidx.recyclerview.widget.RecyclerView r5, int r6, int r7) {
            ...
            Ld1:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.CallLogActivity.C37902.onScrolled(androidx.recyclerview.widget.RecyclerView, int, int):void");
        }
        ...
        public /* synthetic */ void lambda$onScrolled$0(CallLogRow callLogRow) {
            ...
            callLogActivity.getCalls(arrayList.get(arrayList.size() - 1).f1546id, 100);
        }
    }
    ...
    public /* synthetic */ void lambda$createView$2(TLRPC$User tLRPC$User, String str, ContactsActivity contactsActivity) {
        TLRPC$UserFull userFull = getMessagesController().getUserFull(tLRPC$User.f1685id);
    ...
    public void showDeleteAlert(final boolean z) {
        ...
        if (z) {
            builder.setTitle(LocaleController.getString("DeleteAllCalls", C3473R.string.DeleteAllCalls));
            builder.setMessage(LocaleController.getString("DeleteAllCallsText", C3473R.string.DeleteAllCallsText));
        } else {
            builder.setTitle(LocaleController.getString("DeleteCalls", C3473R.string.DeleteCalls));
            builder.setMessage(LocaleController.getString("DeleteSelectedCallsText", C3473R.string.DeleteSelectedCallsText));
        }
        final boolean[] zArr = {false};
        FrameLayout frameLayout = new FrameLayout(getParentActivity());
        CheckBoxCell checkBoxCell = new CheckBoxCell(getParentActivity(), 1);
        checkBoxCell.setBackgroundDrawable(Theme.getSelectorDrawable(false));
        checkBoxCell.setText(LocaleController.getString("DeleteCallsForEveryone", C3473R.string.DeleteCallsForEveryone), "", false, false);
        ...
        builder.setPositiveButton(LocaleController.getString("Delete", C3473R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda0
    ...
    public boolean isSelected(ArrayList<TLRPC$Message> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.selectedIds.contains(Integer.valueOf(arrayList.get(i).f1546id))) {
                return true;
            }
        }
        return false;
    ...
    private void createActionMode() {
        ...
        this.actionModeViews.add(createActionMode.addItemWithWidth(2, C3473R.C3475drawable.msg_delete, AndroidUtilities.m72dp(54), LocaleController.getString("Delete", C3473R.string.Delete)));
    }
    ...
    private boolean addOrRemoveSelectedDialog(ArrayList<TLRPC$Message> arrayList, CallCell callCell) {
        ...
        if (isSelected(arrayList)) {
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
                this.selectedIds.remove(Integer.valueOf(arrayList.get(i).f1546id));
            }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            Integer valueOf = Integer.valueOf(arrayList.get(i2).f1546id);
    ...
    private void showOrUpdateActionMode() {
        ...
        if (this.actionBar.isActionModeShowed()) {
            ...
            for (int i = 0; i < this.actionModeViews.size(); i++) {
                ...
                view.setPivotY(C3541ActionBar.getCurrentActionBarHeight() / 2);
        ...
        if (tLRPC$TL_error == null) {
            ...
            for (int i2 = 0; i2 < tLRPC$messages_Messages.messages.size(); i2++) {
                ...
                if (tLRPC$MessageAction != null && !(tLRPC$MessageAction instanceof TLRPC$TL_messageActionHistoryClear)) {
                    ...
                    if (callLogRow == null || callLogRow.user.f1685id != fromChatId || callLogRow.type != i3) {
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        ...
        if (i == 101 || i == 102 || i == 103) {
            ...
            if (iArr.length <= 0 || !z) {
                ...
                TLRPC$UserFull userFull = this.lastCallUser != null ? getMessagesController().getUserFull(this.lastCallUser.f1685id) : null;
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                callCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            } else if (i == 3) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                callCell.imageView.setImageResource(callLogRow.video ? C3473R.C3475drawable.profile_video : C3473R.C3475drawable.profile_phone);
                ...
                if (i == this.activeHeaderRow) {
                    headerCell.setText(LocaleController.getString("VoipChatActiveChats", C3473R.string.VoipChatActiveChats));
                } else if (i == this.callsHeaderRow) {
                    headerCell.setText(LocaleController.getString("VoipChatRecentCalls", C3473R.string.VoipChatRecentCalls));
                }
                ...
                groupCallCell.button.setTag(Long.valueOf(chat.f1522id));
