...
public class ReactionsDoubleTapManageActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        this.actionBar.setTitle(LocaleController.getString("Reactions", C3473R.string.Reactions));
        this.actionBar.setTitle(LocaleController.getString("DoubleTapSetting", C3473R.string.DoubleTapSetting));
        this.actionBar.setBackButtonImage(C3473R.C3475drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ReactionsDoubleTapManageActivity.1
        ...
        RecyclerListView.SelectionAdapter selectionAdapter = new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.ReactionsDoubleTapManageActivity.2
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                if (i == IdFabric$ViewTypes.TEXT_CHECK_CELL) {
                    ...
                    textInfoPrivacyCell.setText(ReactionsDoubleTapManageActivity.this.initInfoText = LocaleController.getString("DoubleTapPreviewRational", C3473R.string.DoubleTapPreviewRational));
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(context, C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    ...
                    View view = new View(this, context) { // from class: org.telegram.ui.ReactionsDoubleTapManageActivity.2.1
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(16), 1073741824));
                        }
                    };
                    view.setBackground(Theme.getThemedDrawableByKey(context, C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (itemViewType == IdFabric$ViewTypes.TEXT_CHECK_CELL) {
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getString("Enable", C3473R.string.Enable), ReactionsDoubleTapManageActivity.this.getForkCommonController().isQuickReactionEnabled(), false);
                    ...
                    if (i == ReactionsDoubleTapManageActivity.this.enableSectionRow && ReactionsDoubleTapManageActivity.this.getForkCommonController().isQuickReactionEnabled()) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(ReactionsDoubleTapManageActivity.this.getParentActivity(), C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        textInfoPrivacyCell.setFixedSize(1);
                        textInfoPrivacyCell.setText(null);
                        return;
                    }
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(ReactionsDoubleTapManageActivity.this.getParentActivity(), C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    ...
                    if (i != ReactionsDoubleTapManageActivity.this.enableSectionRow) {
                        ...
                        textInfoPrivacyCell.setText(LocaleController.getInternalString(C3473R.string.quick_reaction_settings_enable_item_hint));
                    }
    ...
    public class SetDefaultReactionCell extends FrameLayout {
        ...
        public SetDefaultReactionCell(Context context) {
            ...
            this.textView.setText(LocaleController.getString("DoubleTapSetting", C3473R.string.DoubleTapSetting));
            addView(this.textView, LayoutHelper.createFrame(-1, -2, 23, 20, 0, 48, 0));
            this.imageDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this, AndroidUtilities.m72dp(24));
        }
        ...
        public void updateImageBounds() {
            this.imageDrawable.setBounds((getWidth() - this.imageDrawable.getIntrinsicWidth()) - AndroidUtilities.m72dp(21), (getHeight() - this.imageDrawable.getIntrinsicHeight()) / 2, getWidth() - AndroidUtilities.m72dp(21), (getHeight() + this.imageDrawable.getIntrinsicHeight()) / 2);
        }
