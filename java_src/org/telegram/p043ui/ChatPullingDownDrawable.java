...
public class ChatPullingDownDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatPullingDownDrawable(int i, View view, long j, int i2, int i3, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textPaint2.setTextSize(AndroidUtilities.m107dp(14));
    ...
    public void setWidth(int i) {
        ...
        int i2;
        if (i != this.lastWidth) {
            this.circleRadius = AndroidUtilities.m107dp(56) / 2.0f;
            this.lastWidth = i;
            TLRPC$Chat tLRPC$Chat = this.nextChat;
            String string3 = tLRPC$Chat != null ? tLRPC$Chat.title : LocaleController.getString("SwipeToGoNextChannelEnd", C3632R.string.SwipeToGoNextChannelEnd);
            if (this.nextUser != null) {
                ContactsController contactsController = ContactsController.getInstance(this.currentAccount);
                if (contactsController.contactsDict.get(Long.valueOf(this.nextUser.f1751id)) == null && ((contactsController.contactsDict.size() != 0 || !contactsController.isLoadingContacts()) && !TextUtils.isEmpty(this.nextUser.phone))) {
                    C3544PhoneFormat c3544PhoneFormat = C3544PhoneFormat.getInstance();
                    string3 = c3544PhoneFormat.format("+" + this.nextUser.phone);
                } else {
            ...
            this.chatNameWidth = Math.min(measureText, this.lastWidth - AndroidUtilities.m107dp(60));
            ...
            if (z && (i2 = this.dialogFolderId) != this.folderId && i2 != 0) {
                string = LocaleController.getString("SwipeToGoNextArchive", C3632R.string.SwipeToGoNextArchive);
                string2 = LocaleController.getString("ReleaseToGoNextArchive", C3632R.string.ReleaseToGoNextArchive);
                ...
                string = LocaleController.getString("SwipeToGoNextFolder", C3632R.string.SwipeToGoNextFolder);
                string2 = LocaleController.getString("ReleaseToGoNextFolder", C3632R.string.ReleaseToGoNextFolder);
            } else {
                string = LocaleController.getString("SwipeToGoNextChannel", C3632R.string.SwipeToGoNextChannel);
                string2 = LocaleController.getString("ReleaseToGoNextChannel", C3632R.string.ReleaseToGoNextChannel);
            ...
            this.layout1Width = Math.min(measureText2, this.lastWidth - AndroidUtilities.m107dp(60));
            ...
            this.layout2Width = Math.min(measureText3, this.lastWidth - AndroidUtilities.m107dp(60));
            ...
            this.imageReceiver.setImageCoords((this.lastWidth / 2.0f) - (AndroidUtilities.m107dp(40) / 2.0f), (AndroidUtilities.m107dp(12) + this.circleRadius) - (AndroidUtilities.m107dp(40) / 2.0f), AndroidUtilities.m107dp(40), AndroidUtilities.m107dp(40));
            this.imageReceiver.setRoundRadius((int) (AndroidUtilities.m107dp(40) / 2.0f));
            this.counterDrawable.setSize(AndroidUtilities.m107dp(28), AndroidUtilities.m107dp(100));
        }
    }
    ...
    public void draw(Canvas canvas, View view, float f, float f2) {
        ...
        float m107dp = AndroidUtilities.m107dp(110) * f;
        if (m107dp < AndroidUtilities.m107dp(8)) {
            return;
        }
        float f4 = f < 0.2f ? 5.0f * f * f2 : f2;
        Theme.applyServiceShaderMatrix(this.lastWidth, view.getMeasuredHeight(), BitmapDescriptorFactory.HUE_RED, view.getMeasuredHeight() - m107dp);
        TextPaint textPaint = this.textPaint;
        ...
        float f6 = this.bounceProgress * (-AndroidUtilities.m107dp(4));
        if (this.emptyStub) {
            m107dp -= f6;
        }
        float f7 = m107dp / 2.0f;
        float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(this.circleRadius, (f7 - (AndroidUtilities.m107dp(16) * f)) - AndroidUtilities.m107dp(4)));
        float max2 = ((Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(this.circleRadius * f, f7 - (AndroidUtilities.m107dp(8) * f))) * 2.0f) - AndroidUtilities.dp2(16.0f)) * (1.0f - this.swipeToReleaseProgress);
        float f8 = this.swipeToReleaseProgress;
        float m107dp2 = max2 + (AndroidUtilities.m107dp(56) * f8);
        if (f8 < 1.0f || this.emptyStub) {
            float f9 = -m107dp;
            i3 = alpha2;
            i4 = alpha;
            float m107dp3 = ((-AndroidUtilities.m107dp(8)) * (1.0f - this.swipeToReleaseProgress)) + ((AndroidUtilities.m107dp(56) + f9) * this.swipeToReleaseProgress);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(f5 - max, f9, max + f5, m107dp3);
            if (this.swipeToReleaseProgress > BitmapDescriptorFactory.HUE_RED && !this.emptyStub) {
                float m107dp4 = AndroidUtilities.m107dp(16) * this.swipeToReleaseProgress;
                rectF.inset(m107dp4, m107dp4);
            }
            drawBackground(canvas, rectF);
            float m107dp5 = ((AndroidUtilities.m107dp(24) + f9) + (AndroidUtilities.m107dp(8) * (1.0f - f))) - (AndroidUtilities.m107dp(36) * this.swipeToReleaseProgress);
            canvas.save();
            ...
            drawArrow(canvas, f5, m107dp5, AndroidUtilities.m107dp(24) * f);
            if (this.emptyStub) {
                i5 = 2;
                float dp2 = ((((-AndroidUtilities.m107dp(8)) - (AndroidUtilities.dp2(8.0f) * f)) - m107dp2) * (1.0f - this.swipeToReleaseProgress)) + ((f9 - AndroidUtilities.m107dp(2)) * this.swipeToReleaseProgress) + f6;
                this.arrowPaint.setAlpha(alpha4);
                canvas.save();
                canvas.scale(f, f, f5, AndroidUtilities.m107dp(28) + dp2);
                drawCheck(canvas, f5, dp2 + AndroidUtilities.m107dp(28));
                canvas.restore();
            } else {
                i5 = 2;
            }
        ...
        if (this.chatNameLayout != null && this.swipeToReleaseProgress > BitmapDescriptorFactory.HUE_RED) {
            ...
            this.textPaint.setAlpha(i8);
            float m107dp6 = ((AndroidUtilities.m107dp(20) * (1.0f - this.swipeToReleaseProgress)) - (AndroidUtilities.m107dp(36) * this.swipeToReleaseProgress)) + f6;
            RectF rectF2 = AndroidUtilities.rectTmp;
            int i10 = this.lastWidth;
            int i11 = this.chatNameWidth;
            rectF2.set((i10 - i11) / 2.0f, m107dp6, i10 - ((i10 - i11) / 2.0f), this.chatNameLayout.getHeight() + m107dp6);
            rectF2.inset(-AndroidUtilities.m107dp(8), -AndroidUtilities.m107dp(4));
            canvas.drawRoundRect(rectF2, AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(15), getThemedPaint("paintChatActionBackground"));
            if (hasGradientService()) {
                canvas.drawRoundRect(rectF2, AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(15), Theme.chat_actionBackgroundGradientDarkenPaint);
            }
            canvas.save();
            canvas.translate((this.lastWidth - this.chatNameWidth) / 2.0f, m107dp6);
            this.chatNameLayout.draw(canvas);
            canvas.restore();
        }
        if (this.emptyStub || m107dp2 <= BitmapDescriptorFactory.HUE_RED) {
            f3 = 1.0f;
        } else {
            f3 = 1.0f;
            float dp22 = ((((-AndroidUtilities.m107dp(8)) - (AndroidUtilities.dp2(8.0f) * f)) - m107dp2) * (1.0f - this.swipeToReleaseProgress)) + (((-m107dp) + AndroidUtilities.m107dp(4)) * this.swipeToReleaseProgress) + f6;
            float f11 = m107dp2 / 2.0f;
            this.imageReceiver.setRoundRadius((int) f11);
            this.imageReceiver.setImageCoords(f5 - f11, dp22, m107dp2, m107dp2);
            if (this.swipeToReleaseProgress > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.scale(f12, f12, f5 + AndroidUtilities.m107dp(12) + this.counterDrawable.getCenterX(), (dp22 - AndroidUtilities.m107dp(6)) + AndroidUtilities.m107dp(14));
                canvas.translate(f5 + AndroidUtilities.m107dp(12), dp22 - AndroidUtilities.m107dp(6));
                this.counterDrawable.updateBackgroundRect();
                this.counterDrawable.rectF.inset(-AndroidUtilities.m107dp(i12), -AndroidUtilities.m107dp(i12));
                ...
                canvas.scale(f13, f13, f5 + AndroidUtilities.m107dp(12) + this.counterDrawable.getCenterX(), (dp22 - AndroidUtilities.m107dp(6)) + AndroidUtilities.m107dp(14));
                canvas.translate(f5 + AndroidUtilities.m107dp(12), dp22 - AndroidUtilities.m107dp(6));
    ...
    private void drawCheck(Canvas canvas, float f, float f2) {
        if (this.animateCheck) {
            ...
            canvas.translate(f - AndroidUtilities.m107dp(24), f2 - AndroidUtilities.m107dp(24));
            float m107dp = AndroidUtilities.m107dp(16);
            float m107dp2 = AndroidUtilities.m107dp(26);
            float m107dp3 = AndroidUtilities.m107dp(22);
            float m107dp4 = AndroidUtilities.m107dp(32);
            float m107dp5 = AndroidUtilities.m107dp(32);
            float m107dp6 = AndroidUtilities.m107dp(20);
            float f8 = 1.0f - f6;
            canvas.drawLine(m107dp, m107dp2, (m107dp * f8) + (m107dp3 * f6), (f8 * m107dp2) + (f6 * m107dp4), this.arrowPaint);
            if (f7 > BitmapDescriptorFactory.HUE_RED) {
                float f9 = 1.0f - f7;
                canvas.drawLine(m107dp3, m107dp4, (m107dp3 * f9) + (m107dp5 * f7), (f9 * m107dp4) + (m107dp6 * f7), this.arrowPaint);
            }
            canvas.restore();
        }
    }
    ...
    private void drawArrow(Canvas canvas, float f, float f2, float f3) {
        ...
        canvas.scale(dpf2, dpf2, f, f2 - AndroidUtilities.m107dp(20));
        canvas.translate(f - AndroidUtilities.dp2(12.0f), f2 - AndroidUtilities.m107dp(12));
