...
public class ProxySettingsActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        this.actionBar.setTitle(LocaleController.getString("ProxyDetails", C3634R.string.ProxyDetails));
        this.actionBar.setBackButtonImage(C3634R.C3636drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(false);
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3706ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ProxySettingsActivity.1
        ...
        while (i < 2) {
            ...
            if (i == 0) {
                this.typeCell[i].setText(LocaleController.getString("UseProxySocks5", C3634R.string.UseProxySocks5), i == this.currentType, true);
            } else {
                this.typeCell[i].setText(LocaleController.getString("UseProxyTelegram", C3634R.string.UseProxyTelegram), i == this.currentType, false);
            }
        ...
        for (int i3 = 5; i2 < i3; i3 = 5) {
            ...
            if (i2 == 0) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxyAddress", C3634R.string.UseProxyAddress));
                this.inputFields[i2].setText(this.currentProxyInfo.address);
            } else if (i2 == 1) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxyPort", C3634R.string.UseProxyPort));
                this.inputFields[i2].setText("" + this.currentProxyInfo.port);
            } else if (i2 == 2) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxyUsername", C3634R.string.UseProxyUsername));
                this.inputFields[i2].setText(this.currentProxyInfo.username);
            } else if (i2 == 3) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxyPassword", C3634R.string.UseProxyPassword));
                this.inputFields[i2].setText(this.currentProxyInfo.password);
            } else if (i2 == 4) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxySecret", C3634R.string.UseProxySecret));
        ...
        for (int i5 = 0; i5 < 2; i5++) {
            ...
            this.bottomCells[i5].setBackground(Theme.getThemedDrawableByKey(context, C3634R.C3636drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            if (i5 == 0) {
                this.bottomCells[i5].setText(LocaleController.getString("UseProxyInfo", C3634R.string.UseProxyInfo));
            } else {
                this.bottomCells[i5].setText(LocaleController.getString("UseProxyTelegramInfo", C3634R.string.UseProxyTelegramInfo) + "\n\n" + LocaleController.getString("UseProxyTelegramInfo2", C3634R.string.UseProxyTelegramInfo2));
        ...
        this.pasteCell.setText(LocaleController.getString("PasteFromClipboard", C3634R.string.PasteFromClipboard), false);
        ...
        int i7 = C3634R.C3636drawable.greydivider_bottom;
        ...
        this.shareCell.setText(LocaleController.getString("ShareFile", C3634R.string.ShareFile), false);
    ...
    public /* synthetic */ void lambda$createView$4(Context context, View view) {
        ...
        try {
            ...
            QRCodeBottomSheet qRCodeBottomSheet = new QRCodeBottomSheet(context, LocaleController.getString("ShareQrCode", C3634R.string.ShareQrCode), str + sb.toString(), LocaleController.getString("QRCodeLinkHelpProxy", C3634R.string.QRCodeLinkHelpProxy), true);
            qRCodeBottomSheet.setCenterImage(SvgHelper.getBitmap(RLottieDrawable.readRes(null, C3634R.raw.qr_dog), AndroidUtilities.m104dp(60), AndroidUtilities.m104dp(60), false));
