...
public class ProxySettingsActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.inputFieldsContainer.setElevation(AndroidUtilities.m108dp(1.0f));
    ...
    public /* synthetic */ void lambda$createView$4(Context context, View view) {
        ...
        try {
            ...
            qRCodeBottomSheet.setCenterImage(SvgHelper.getBitmap(RLottieDrawable.readRes(null, C3632R.raw.qr_dog), AndroidUtilities.m107dp(60), AndroidUtilities.m107dp(60), false));
