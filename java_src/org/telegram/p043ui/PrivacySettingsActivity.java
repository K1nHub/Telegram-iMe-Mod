...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public /* synthetic */ void lambda$createView$17(DialogInterface dialogInterface, int i) {
        ...
        BulletinFactory.m62of(this).createSimpleBulletin(C3632R.raw.chats_infotip, string).show();
    }
            ...
            if (itemViewType == 0) {
                ...
                if (i != PrivacySettingsActivity.this.webSessionsRow) {
                    if (i == PrivacySettingsActivity.this.phoneNumberRow) {
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString(C3632R.string.PrivacyVoiceMessages), str6, false);
