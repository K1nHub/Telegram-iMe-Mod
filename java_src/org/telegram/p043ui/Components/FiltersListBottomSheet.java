...
public class FiltersListBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FiltersListBottomSheet(BaseFragment baseFragment, ArrayList<Long> arrayList, int i) {
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) { // from class: org.telegram.ui.Components.FiltersListBottomSheet.1
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                int m72dp = AndroidUtilities.m72dp(48) + (AndroidUtilities.m72dp(48) * FiltersListBottomSheet.this.adapter.getItemCount()) + ((BottomSheet) FiltersListBottomSheet.this).backgroundPaddingTop + AndroidUtilities.statusBarHeight;
                int i4 = size / 5;
                int i5 = ((double) m72dp) < ((double) i4) * 3.2d ? 0 : i4 * 2;
                if (i5 != 0 && m72dp < size) {
                    i5 -= size - m72dp;
                }
                if (i5 == 0) {
                ...
                if (FiltersListBottomSheet.this.listView.getPaddingTop() != i5) {
                    FiltersListBottomSheet.this.ignoreLayout = true;
                    FiltersListBottomSheet.this.listView.setPadding(AndroidUtilities.m72dp(10), i5, AndroidUtilities.m72dp(10), 0);
                    FiltersListBottomSheet.this.ignoreLayout = false;
                }
            ...
            */
            protected void onDraw(android.graphics.Canvas r13) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.FiltersListBottomSheet.C48391.onDraw(android.graphics.Canvas):void");
            }
        ...
        this.titleTextView.setPadding(AndroidUtilities.m72dp(18), 0, AndroidUtilities.m72dp(18), 0);
        this.titleTextView.setGravity(16);
        this.titleTextView.setText(LocaleController.getString("FilterChoose", C3473R.string.FilterChoose));
    ...
    public static ArrayList<MessagesController.DialogFilter> getCanAddDialogFilters(BaseFragment baseFragment, ArrayList<Long> arrayList, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (dialogFilter.f1459id != i && !getDialogsCount(baseFragment, dialogFilter, arrayList, true, true).isEmpty() && !dialogFilter.isDefault()) {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (i < FiltersListBottomSheet.this.dialogFilters.size()) {
                ...
                if ((MessagesController.DIALOG_FILTER_FLAG_ALL_CHATS & i3) == (MessagesController.DIALOG_FILTER_FLAG_CONTACTS | MessagesController.DIALOG_FILTER_FLAG_NON_CONTACTS)) {
                    ...
                    if ((MessagesController.DIALOG_FILTER_FLAG_ALL_CHATS & i3) == MessagesController.DIALOG_FILTER_FLAG_CHANNELS) {
                        ...
                        i2 = C3473R.C3475drawable.msg_bots;
                    } else {
                        i2 = C3473R.C3475drawable.msg_folders;
                    }
                }
            ...
            Drawable drawable = this.context.getResources().getDrawable(C3473R.C3475drawable.poll_add_circle);
            Drawable drawable2 = this.context.getResources().getDrawable(C3473R.C3475drawable.poll_add_plus);
            ...
            bottomSheetCell.setTextAndIcon(LocaleController.getString("CreateNewFilter", C3473R.string.CreateNewFilter), combinedDrawable);
        }
    }
}
