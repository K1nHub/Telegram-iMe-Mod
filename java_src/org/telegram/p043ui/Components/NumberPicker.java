...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.mTextSize = AndroidUtilities.m104dp(i);
        init();
    }
    ...
    */
    public boolean dispatchKeyEvent(android.view.KeyEvent r6) {
        ...
        L60:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.NumberPicker.dispatchKeyEvent(android.view.KeyEvent):boolean");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (int i4 = 0; i4 < iArr.length; i4++) {
            ...
            if (str != null && (i4 != this.SELECTOR_MIDDLE_ITEM_INDEX || this.mInputText.getVisibility() != 0)) {
                if (this.SELECTOR_WHEEL_ITEM_COUNT > 3) {
                    ...
                    float interpolation = interpolator.getInterpolation(Utilities.clamp(measuredHeight, 1.0f, (float) BitmapDescriptorFactory.HUE_RED));
        ...
        if (this.drawDividers) {
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, this.mTopSelectionDividerTop, getRight(), this.mSelectionDividerHeight + i, this.mSelectionDivider);
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, i2 - this.mSelectionDividerHeight, getRight(), this.mBottomSelectionDividerBottom, this.mSelectionDivider);
        }
    }
