...
public class OutlineTextContainerView extends FrameLayout {
    ...
    public OutlineTextContainerView(Context context) {
        ...
        this.strokeWidthRegular = Math.max(2, AndroidUtilities.m73dp(0.5f));
        this.strokeWidthSelected = AndroidUtilities.m73dp(1.5f);
        ...
        updateColor();
        setPadding(0, AndroidUtilities.m72dp(6), 0, 0);
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float paddingTop = getPaddingTop() + ((this.textPaint.getTextSize() / 2.0f) - AndroidUtilities.m73dp(1.75f));
        ...
        canvas.save();
        this.rect.set(getPaddingLeft() + AndroidUtilities.m72dp(10), getPaddingTop(), (getWidth() - AndroidUtilities.m72dp(18)) - getPaddingRight(), getPaddingTop() + (strokeWidth * 2.0f));
        ...
        canvas.drawRoundRect(this.rect, AndroidUtilities.m72dp(6), AndroidUtilities.m72dp(6), this.outlinePaint);
        canvas.restore();
        float paddingLeft = getPaddingLeft() + AndroidUtilities.m72dp(10);
        float paddingTop2 = getPaddingTop() + strokeWidth;
        float f3 = paddingLeft + (measureText / 2.0f);
        canvas.drawLine(f3 + ((((paddingLeft + measureText) + AndroidUtilities.m72dp(10)) - f3) * (z ? this.selectionProgress : 1.0f)), paddingTop2, ((getWidth() - strokeWidth) - getPaddingRight()) - AndroidUtilities.m72dp(6), paddingTop2, this.outlinePaint);
        float m72dp = f3 + AndroidUtilities.m72dp(4);
        canvas.drawLine(paddingLeft, paddingTop2, m72dp + ((paddingLeft - m72dp) * (z ? this.selectionProgress : 1.0f)), paddingTop2, this.outlinePaint);
        canvas.save();
        canvas.scale(f2, f2, getPaddingLeft() + AndroidUtilities.m72dp(18), f);
        canvas.drawText(this.mText, getPaddingLeft() + AndroidUtilities.m72dp(14), f, this.textPaint);
        canvas.restore();
    }
}
