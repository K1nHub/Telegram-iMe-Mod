...
public class OutlineTextContainerView extends FrameLayout {
    ...
    public OutlineTextContainerView(Context context) {
        ...
        this.strokeWidthRegular = Math.max(2, AndroidUtilities.m105dp(0.5f));
        this.strokeWidthSelected = AndroidUtilities.m105dp(1.5f);
        ...
        updateColor();
        setPadding(0, AndroidUtilities.m104dp(6), 0, 0);
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float paddingTop = getPaddingTop() + ((this.textPaint.getTextSize() / 2.0f) - AndroidUtilities.m105dp(1.75f));
        ...
        canvas.save();
        this.rect.set(getPaddingLeft() + AndroidUtilities.m104dp(10), getPaddingTop(), (getWidth() - AndroidUtilities.m104dp(18)) - getPaddingRight(), getPaddingTop() + (strokeWidth * 2.0f));
        ...
        canvas.drawRoundRect(this.rect, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), this.outlinePaint);
        canvas.restore();
        float paddingLeft = getPaddingLeft() + AndroidUtilities.m104dp(10);
        float paddingTop2 = getPaddingTop() + strokeWidth;
        float f3 = paddingLeft + (measureText / 2.0f);
        canvas.drawLine(f3 + ((((paddingLeft + measureText) + AndroidUtilities.m104dp(10)) - f3) * (z ? this.selectionProgress : 1.0f)), paddingTop2, ((getWidth() - strokeWidth) - getPaddingRight()) - AndroidUtilities.m104dp(6), paddingTop2, this.outlinePaint);
        float m104dp = f3 + AndroidUtilities.m104dp(4);
        canvas.drawLine(paddingLeft, paddingTop2, m104dp + ((paddingLeft - m104dp) * (z ? this.selectionProgress : 1.0f)), paddingTop2, this.outlinePaint);
        canvas.save();
        canvas.scale(f2, f2, getPaddingLeft() + AndroidUtilities.m104dp(18), f);
        canvas.drawText(this.mText, getPaddingLeft() + AndroidUtilities.m104dp(14), f, this.textPaint);
        canvas.restore();
    }
}
