...
public class ZoomControlView extends View {
    ...
    public ZoomControlView(Context context) {
        ...
        this.minusDrawable = context.getResources().getDrawable(C3632R.C3634drawable.zoom_minus);
        this.plusDrawable = context.getResources().getDrawable(C3632R.C3634drawable.zoom_plus);
        this.progressDrawable = context.getResources().getDrawable(C3632R.C3634drawable.zoom_slide);
        this.filledProgressDrawable = context.getResources().getDrawable(C3632R.C3634drawable.zoom_slide_a);
        this.knobDrawable = context.getResources().getDrawable(C3632R.C3634drawable.zoom_round);
        this.pressedKnobDrawable = context.getResources().getDrawable(C3632R.C3634drawable.zoom_round_b);
    }
    ...
    */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (z) {
            this.minusCx = AndroidUtilities.m107dp(41);
            this.minusCy = measuredHeight;
            this.plusCx = getMeasuredWidth() - AndroidUtilities.m107dp(41);
            this.plusCy = measuredHeight;
            this.progressStartX = this.minusCx + AndroidUtilities.m107dp(18);
            this.progressStartY = measuredHeight;
            this.progressEndX = this.plusCx - AndroidUtilities.m107dp(18);
            this.progressEndY = measuredHeight;
        } else {
            this.minusCx = measuredWidth;
            this.minusCy = AndroidUtilities.m107dp(41);
            this.plusCx = measuredWidth;
            this.plusCy = getMeasuredHeight() - AndroidUtilities.m107dp(41);
            this.progressStartX = measuredWidth;
            this.progressStartY = this.minusCy + AndroidUtilities.m107dp(18);
            this.progressEndX = measuredWidth;
            this.progressEndY = this.plusCy - AndroidUtilities.m107dp(18);
        }
        this.minusDrawable.setBounds(this.minusCx - AndroidUtilities.m107dp(7), this.minusCy - AndroidUtilities.m107dp(7), this.minusCx + AndroidUtilities.m107dp(7), this.minusCy + AndroidUtilities.m107dp(7));
        this.minusDrawable.draw(canvas);
        this.plusDrawable.setBounds(this.plusCx - AndroidUtilities.m107dp(7), this.plusCy - AndroidUtilities.m107dp(7), this.plusCx + AndroidUtilities.m107dp(7), this.plusCy + AndroidUtilities.m107dp(7));
        ...
        if (z) {
            this.progressDrawable.setBounds(i2, i4 - AndroidUtilities.m107dp(3), this.progressEndX, this.progressStartY + AndroidUtilities.m107dp(3));
            this.filledProgressDrawable.setBounds(this.progressStartX, this.progressStartY - AndroidUtilities.m107dp(3), i5, this.progressStartY + AndroidUtilities.m107dp(3));
        } else {
            this.progressDrawable.setBounds(i4, 0, i3, AndroidUtilities.m107dp(6));
            this.filledProgressDrawable.setBounds(this.progressStartY, 0, i6, AndroidUtilities.m107dp(6));
            canvas.save();
            canvas.rotate(90.0f);
            canvas.translate(BitmapDescriptorFactory.HUE_RED, (-this.progressStartX) - AndroidUtilities.m107dp(3));
        }
