...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public class TextCheckBoxCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), Math.max(AndroidUtilities.m107dp(64), this.textView.getMeasuredHeight() + this.valueTextView.getMeasuredHeight() + AndroidUtilities.m107dp(20)) + (this.needDivider ? 1 : 0));
        }

        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            super.onLayout(z, i, i2, i3, i4);
            int measuredHeight = this.textView.getMeasuredHeight() + AndroidUtilities.m107dp(13);
    ...
    */
    ...
    public /* synthetic */ boolean lambda$new$3(int i, Theme.ResourcesProvider resourcesProvider, Context context, View view) {
        ...
        if (BulletinFactory.canShowBulletin(this.parentFragment)) {
            if (vcardItem.type == 3) {
                BulletinFactory.m66of((FrameLayout) this.containerView, resourcesProvider).createCopyLinkBulletin().show();
            } else {
        ...
        if (this.isImport) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("CreateNewContact", C3632R.string.CreateNewContact), LocaleController.getString("AddToExistingContact", C3632R.string.AddToExistingContact)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.PhonebookShareAlert.5
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    boolean z;
                    boolean z2;
                    DialogInterface$OnClickListenerC53475 dialogInterface$OnClickListenerC53475 = this;
                    int i3 = 1;
                    if (i == 0) {
                    ...
                    for (int i4 = 0; i4 < PhonebookShareAlert.this.phones.size(); i4++) {
                        ...
                        dialogInterface$OnClickListenerC53475.fillRowWithType(vcardItem.getRawType(false), contentValues);
                    ...
                    while (i5 < PhonebookShareAlert.this.other.size()) {
                        ...
                        if (i6 == i3) {
                            ...
                            dialogInterface$OnClickListenerC53475.fillRowWithType(vcardItem2.getRawType(z3), contentValues2);
                            arrayList.add(contentValues2);
                        } else if (i6 == 3) {
                            ContentValues contentValues3 = new ContentValues();
                            contentValues3.put("mimetype", "vnd.android.cursor.item/website");
                            contentValues3.put("data1", vcardItem2.getValue(z3));
                            dialogInterface$OnClickListenerC53475.fillUrlRowWithType(vcardItem2.getRawType(z3), contentValues3);
                            ...
                            if (i6 == 2) {
                                ...
                                if (i6 == 20) {
                                    ...
                                    dialogInterface$OnClickListenerC53475 = this;
    ...
    public void onStart() {
        ...
        Bulletin.addDelegate((FrameLayout) this.containerView, new Bulletin.Delegate(this) { // from class: org.telegram.ui.Components.PhonebookShareAlert.6
            ...
            public int getBottomOffset(int i) {
                return AndroidUtilities.m107dp(74);
            }
        });
    }
