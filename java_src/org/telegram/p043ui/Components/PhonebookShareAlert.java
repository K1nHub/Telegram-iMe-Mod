...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public class UserCell extends LinearLayout {
        public UserCell(PhonebookShareAlert phonebookShareAlert, Context context) {
            ...
            avatarDrawable.setTextSize(AndroidUtilities.m104dp(30));
            avatarDrawable.setInfo(phonebookShareAlert.currentUser);
            BackupImageView backupImageView = new BackupImageView(context);
            backupImageView.setRoundRadius(AndroidUtilities.m104dp(40));
    ...
    public class TextCheckBoxCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), Math.max(AndroidUtilities.m104dp(64), this.textView.getMeasuredHeight() + this.valueTextView.getMeasuredHeight() + AndroidUtilities.m104dp(20)) + (this.needDivider ? 1 : 0));
        }

        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            super.onLayout(z, i, i2, i3, i4);
            int measuredHeight = this.textView.getMeasuredHeight() + AndroidUtilities.m104dp(13);
    ...
    */
    ...
    public /* synthetic */ boolean lambda$new$3(int i, Theme.ResourcesProvider resourcesProvider, Context context, View view) {
        ...
        if (BulletinFactory.canShowBulletin(this.parentFragment)) {
            if (vcardItem.type == 3) {
                BulletinFactory.m63of((FrameLayout) this.containerView, resourcesProvider).createCopyLinkBulletin().show();
            } else {
