...
public class EditTextEmoji extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate {
    ...
    public EditTextEmoji(Context context, final SizeNotifierFrameLayout sizeNotifierFrameLayout, BaseFragment baseFragment, final int i, boolean z, final Theme.ResourcesProvider resourcesProvider) {
                ...
                if (EditTextEmoji.this.emojiIconDrawable != null) {
                    ...
                    if (EditTextEmoji.this.shownFormatButton != z2) {
                        ...
                        if (z2) {
                            ...
                            EditTextEmoji.this.emojiIconDrawable.setIcon(C3634R.C3636drawable.msg_edit, true);
                            return;
                        }
        ...
        this.editText.setCursorSize(AndroidUtilities.m104dp(20));
        ...
        if (i == 0) {
            ...
            this.editText.setPadding(LocaleController.isRTL ? AndroidUtilities.m104dp(40) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m104dp(40), AndroidUtilities.m104dp(8));
            ...
            this.editText.setPadding(0, AndroidUtilities.m104dp(9), 0, AndroidUtilities.m104dp(9));
            ...
            this.editText.setBackground(null);
            this.editText.setPadding(0, AndroidUtilities.m104dp(11), 0, AndroidUtilities.m104dp(12));
        ...
        if (i == 0) {
            ...
            this.emojiIconDrawable.setIcon(C3634R.C3636drawable.smiles_tab_smiles, false);
            ...
            this.emojiIconDrawable.setIcon(C3634R.C3636drawable.input_smile, false);
        ...
        this.emojiButton.setContentDescription(LocaleController.getString("Emoji", C3634R.string.Emoji));
    }
        ...
        if (adjustPanLayoutHelper == null || !adjustPanLayoutHelper.animationInProgress()) {
            if (this.shownFormatButton) {
                ...
                if (itemOptions == null) {
                    ...
                    makeOptions.setMaxHeight(AndroidUtilities.m104dp(280));
    ...
    public void setEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.editText.setPadding(0, 0, 0, AndroidUtilities.m104dp(8));
        }
    }
    ...
    public void showPopup(int i) {
        if (i == 1) {
            ...
            if (sizeNotifierFrameLayout != null) {
                ...
                this.emojiIconDrawable.setIcon(C3634R.C3636drawable.input_keyboard, true);
                onWindowSizeChanged();
            }
        ...
        if (this.emojiButton != null) {
            if (this.currentStyle == 0) {
                this.emojiIconDrawable.setIcon(C3634R.C3636drawable.smiles_tab_smiles, true);
            } else {
                this.emojiIconDrawable.setIcon(C3634R.C3636drawable.input_smile, true);
            }
        }
    ...
    public void createEmojiView() {
        ...
        this.emojiView.setDelegate(new C49107());
    ...
    /* loaded from: classes6.dex */
    public class C49107 implements EmojiView.EmojiViewDelegate {
        ...
        public void onEmojiSelected(String str) {
            ...
            try {
                try {
                    ...
                    CharSequence replaceEmoji = Emoji.replaceEmoji((CharSequence) str, EditTextEmoji.this.editText.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(20), false);
        ...
        public void onClearEmojiRecent() {
            ...
            builder.setPositiveButton(LocaleController.getString("ClearButton", C3634R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.EditTextEmoji$7$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    EditTextEmoji.C49107.this.lambda$onClearEmojiRecent$0(dialogInterface, i);
                }
            });
    ...
    public void onSizeChanged(int i, boolean z) {
        boolean z2;
        int i2;
        if (i > AndroidUtilities.m104dp(50) && ((this.keyboardVisible || (i2 = this.currentStyle) == 2 || i2 == 3) && !AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet())) {
            if (z) {
