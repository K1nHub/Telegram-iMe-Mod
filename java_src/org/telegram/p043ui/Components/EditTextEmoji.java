...
public class EditTextEmoji extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate {
    ...
    public EditTextEmoji(Context context, SizeNotifierFrameLayout sizeNotifierFrameLayout, BaseFragment baseFragment, final int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            ...
            this.emojiIconDrawable.setIcon(C3473R.C3475drawable.smiles_tab_smiles, false);
    ...
    public void showPopup(int i) {
        ...
        if (this.emojiButton != null) {
            if (this.currentStyle == 0) {
                this.emojiIconDrawable.setIcon(C3473R.C3475drawable.smiles_tab_smiles, true);
            } else {
    ...
    public void createEmojiView() {
        ...
        this.emojiView.setDelegate(new C47166());
    ...
    /* loaded from: classes7.dex */
    public class C47166 implements EmojiView.EmojiViewDelegate {
        ...
        public void onClearEmojiRecent() {
            ...
            builder.setPositiveButton(LocaleController.getString("ClearButton", C3473R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.EditTextEmoji$6$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    EditTextEmoji.C47166.this.lambda$onClearEmojiRecent$0(dialogInterface, i);
                }
            });
