...
public class ChecksHintView extends FrameLayout {
    ...
    public ChecksHintView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(6), getThemedColor(Theme.key_chat_gifSaveHintBackground)));
        frameLayout.setPadding(AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), 0, AndroidUtilities.m107dp(8));
        ...
        while (i < 2) {
            ...
            this.textView[i].setMaxWidth(AndroidUtilities.m107dp(250));
            ...
            if (i == 0) {
                this.imageView[i].setAnimation(C3632R.raw.ticks_single, 24, 24);
                this.textView[i].setText(LocaleController.getString("HintSent", C3632R.string.HintSent));
            } else {
                this.imageView[i].setAnimation(C3632R.raw.ticks_double, 24, 24);
                this.textView[i].setText(LocaleController.getString("HintRead", C3632R.string.HintRead));
            }
        ...
        imageView.setImageResource(C3632R.C3634drawable.tooltip_arrow);
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, boolean z) {
        ...
        final int i3 = 0;
        if (i2 <= getMeasuredHeight() + AndroidUtilities.m107dp(10)) {
            return false;
        }
        int checksY = i2 + chatMessageCell.getChecksY() + AndroidUtilities.m107dp(6);
        int checksX = chatMessageCell.getChecksX() + AndroidUtilities.m107dp(5);
        ...
        int m107dp = AndroidUtilities.m107dp(15);
        if (left > view.getMeasuredWidth() / 2) {
            int measuredWidth2 = (measuredWidth - getMeasuredWidth()) - AndroidUtilities.m107dp(20);
            setTranslationX(measuredWidth2);
            m107dp += measuredWidth2;
        } else {
            setTranslationX(BitmapDescriptorFactory.HUE_RED);
        }
        float left2 = ((chatMessageCell.getLeft() + checksX) - m107dp) - (this.arrowImageView.getMeasuredWidth() / 2);
        this.arrowImageView.setTranslationX(left2);
        if (left > view.getMeasuredWidth() / 2) {
            if (left2 < AndroidUtilities.m107dp(10)) {
                float m107dp2 = left2 - AndroidUtilities.m107dp(10);
                setTranslationX(getTranslationX() + m107dp2);
                this.arrowImageView.setTranslationX(left2 - m107dp2);
            }
        } else if (left2 > getMeasuredWidth() - AndroidUtilities.m107dp(24)) {
            float measuredWidth3 = (left2 - getMeasuredWidth()) + AndroidUtilities.m107dp(24);
            setTranslationX(measuredWidth3);
            this.arrowImageView.setTranslationX(left2 - measuredWidth3);
        } else if (left2 < AndroidUtilities.m107dp(10)) {
            float m107dp3 = left2 - AndroidUtilities.m107dp(10);
            setTranslationX(getTranslationX() + m107dp3);
            this.arrowImageView.setTranslationX(left2 - m107dp3);
        }
        setPivotX(left2);
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C48971());
    ...
    /* loaded from: classes6.dex */
    public class C48971 extends AnimatorListenerAdapter {
        C48971() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(ChecksHintView.this.hideRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChecksHintView$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ChecksHintView.C48971.this.lambda$onAnimationEnd$0();
                }
            }, C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
        }
