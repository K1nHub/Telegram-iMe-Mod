...
public class ChatActivityBotWebViewButton extends FrameLayout {
    ...
    public void draw(Canvas canvas) {
        canvas.save();
        float height = (getHeight() - AndroidUtilities.m107dp(32)) / 2.0f;
        float max = Math.max((getWidth() - this.menuButtonWidth) - AndroidUtilities.m107dp(4), getHeight()) * this.progress;
        float m107dp = AndroidUtilities.m107dp(16) + max;
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(AndroidUtilities.m107dp(14) - max, (AndroidUtilities.m107dp(4) + height) - max, AndroidUtilities.m107dp(6) + this.menuButtonWidth + max, (getHeight() - AndroidUtilities.m107dp(12)) + max);
        this.path.rewind();
        ...
        canvas.translate(AndroidUtilities.m107dp(10), height);
        ...
        canvas.restore();
        canvas.translate((-AndroidUtilities.m107dp(8)) * (1.0f - this.progress), BitmapDescriptorFactory.HUE_RED);
        super.draw(canvas);
        canvas.restore();
    }
