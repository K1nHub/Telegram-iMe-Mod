...
public class RecordStatusDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int i = 2;
        if (paint.getStrokeWidth() != AndroidUtilities.m107dp(2)) {
        ...
        canvas.translate(BitmapDescriptorFactory.HUE_RED, intrinsicHeight + AndroidUtilities.m107dp(i));
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            float m107dp = (AndroidUtilities.m107dp(4) * i2) + (AndroidUtilities.m107dp(4) * this.progress);
            float f = -m107dp;
            this.rect.set(f, f, m107dp, m107dp);
