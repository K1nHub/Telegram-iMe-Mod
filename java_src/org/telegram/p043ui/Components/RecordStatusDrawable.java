...
public class RecordStatusDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int i = 2;
        if (paint.getStrokeWidth() != AndroidUtilities.m72dp(2)) {
        ...
        canvas.translate(BitmapDescriptorFactory.HUE_RED, intrinsicHeight + AndroidUtilities.m72dp(i));
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            float m72dp = (AndroidUtilities.m72dp(4) * i2) + (AndroidUtilities.m72dp(4) * this.progress);
            float f = -m72dp;
            this.rect.set(f, f, m72dp, m72dp);
