...
public class RecordStatusDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int i = 2;
        if (paint.getStrokeWidth() != AndroidUtilities.m104dp(2)) {
        ...
        canvas.translate(BitmapDescriptorFactory.HUE_RED, intrinsicHeight + AndroidUtilities.m104dp(i));
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            float m104dp = (AndroidUtilities.m104dp(4) * i2) + (AndroidUtilities.m104dp(4) * this.progress);
            float f = -m104dp;
            this.rect.set(f, f, m104dp, m104dp);
