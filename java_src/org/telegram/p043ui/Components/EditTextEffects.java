    ...
    */
    public void onTextChanged(java.lang.CharSequence r4, int r5, int r6, int r7) {
        ...
        L31:
            ...
            org.telegram.ui.Components.spoilers.SpoilerEffect r1 = (org.telegram.p043ui.Components.spoilers.SpoilerEffect) r1     // Catch: java.lang.Exception -> L58
        ...
        L5c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.EditTextEffects.onTextChanged(java.lang.CharSequence, int, int, int):void");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.clipToPadding && getScrollY() != 0) {
            canvas.clipRect(-AndroidUtilities.m107dp(3), (getScrollY() - super.getExtendedPaddingTop()) - this.offsetY, getMeasuredWidth(), ((getMeasuredHeight() + getScrollY()) + super.getExtendedPaddingBottom()) - this.offsetY);
        }
        this.path.rewind();
        for (SpoilerEffect spoilerEffect : this.spoilers) {
        ...
        for (int i = 0; i < this.quoteBlocks.size(); i++) {
            this.quoteBlocks.get(i).draw(canvas, BitmapDescriptorFactory.HUE_RED, getWidth(), this.quoteColor, 1.0f);
        }
