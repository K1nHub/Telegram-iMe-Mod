    ...
    */
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.clipToPadding && getScrollY() != 0) {
            canvas.clipRect(-AndroidUtilities.m104dp(3), (getScrollY() - getExtendedPaddingTop()) - this.offsetY, getMeasuredWidth(), ((getMeasuredHeight() + getScrollY()) + getExtendedPaddingBottom()) - this.offsetY);
        }
        this.path.rewind();
        for (SpoilerEffect spoilerEffect : this.spoilers) {
        ...
        canvas.translate(BitmapDescriptorFactory.HUE_RED, getExtendedPaddingTop());
