...
public class MessagePreviewView extends FrameLayout {
    ...
    public class Page extends FrameLayout {
        ...
        */
        ...
        /* loaded from: classes6.dex */
        public class C52367 extends ChatListItemAnimator {
            Runnable finishRunnable;
            int scrollAnimationIndex;

            C52367(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider, MessagePreviewView messagePreviewView) {
            ...
            public void onAllAnimationsDone() {
                ...
                Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.MessagePreviewView$Page$7$$ExternalSyntheticLambda2
                    ...
                    public final void run() {
                        MessagePreviewView.Page.C52367.this.lambda$onAllAnimationsDone$0();
                    }
                };
                ...
                if (page.updateAfterAnimations) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.MessagePreviewView$Page$7$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            MessagePreviewView.Page.C52367.this.lambda$onAllAnimationsDone$1();
                        }
                    });
                }
            }
            ...
            public void endAnimations() {
                ...
                Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.MessagePreviewView$Page$7$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        MessagePreviewView.Page.C52367.this.lambda$endAnimations$2();
                    }
                };
                this.finishRunnable = runnable2;
                AndroidUtilities.runOnUIThread(runnable2);
        ...
        /* loaded from: classes6.dex */
        public class C522510 extends GridLayoutManagerFixed {
            @Override // androidx.recyclerview.widget.GridLayoutManagerFixed
            public boolean shouldLayoutChildFromOpositeSide(View view) {
                return false;
            }

            C522510(Context context, int i, int i2, boolean z, MessagePreviewView messagePreviewView) {
            ...
            public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.MessagePreviewView$Page$10$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            MessagePreviewView.Page.C522510.this.lambda$onLayoutChildren$0();
                        }
                    });
                }
            }
        ...
        public void showQuoteLengthError() {
            MessagePreviewView messagePreviewView = MessagePreviewView.this;
            BulletinFactory.m66of(messagePreviewView, messagePreviewView.resourcesProvider).createSimpleBulletin(C3632R.raw.error, LocaleController.getString(C3632R.string.QuoteMaxError), LocaleController.getString(C3632R.string.QuoteMaxErrorMessage)).show();
        }
        ...
        public void updateSubtitle(boolean z) {
            ...
            C5223ActionBar c5223ActionBar = this.actionBar;
            MessagePreviewParams.Messages messages = MessagePreviewView.this.messagePreviewParams.forwardMessages;
            c5223ActionBar.setTitle(LocaleController.formatPluralString("PreviewForwardMessagesCount", messages == null ? 0 : messages.selectedIds.size(), new Object[0]), z);
            MessagePreviewView messagePreviewView = MessagePreviewView.this;
        ...
        */
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (MessagePreviewView.this.isLandscapeMode) {
                ...
                ((ViewGroup.MarginLayoutParams) this.chatPreviewContainer.getLayoutParams()).topMargin = AndroidUtilities.m107dp(8);
                ((ViewGroup.MarginLayoutParams) this.chatPreviewContainer.getLayoutParams()).bottomMargin = AndroidUtilities.m107dp(8);
                this.chatPreviewContainer.getLayoutParams().width = (int) Math.min(View.MeasureSpec.getSize(i), Math.max(AndroidUtilities.m107dp(340), View.MeasureSpec.getSize(i) * 0.6f));
                ...
                this.chatPreviewContainer.getLayoutParams().height = (View.MeasureSpec.getSize(i2) - AndroidUtilities.m107dp(6)) - this.buttonsHeight;
            ...
            if (this.lastSize != size) {
                for (int i4 = 0; i4 < this.messages.previewMessages.size(); i4++) {
                    if (MessagePreviewView.this.isLandscapeMode) {
                        ...
                        this.messages.previewMessages.get(i4).parentWidth = View.MeasureSpec.getSize(i) - AndroidUtilities.m107dp(16);
                    }
        ...
        public void updatePositions() {
            ...
            if (!MessagePreviewView.this.isLandscapeMode) {
                ...
                if (messages == null || i2 == 0 || i2 > messages.previewMessages.size()) {
                    ...
                    int max = Math.max(0, measuredHeight - AndroidUtilities.m107dp(4));
                    this.chatTopOffset = max;
                    this.chatTopOffset = Math.min((max + (this.chatListView.getMeasuredHeight() - this.chatTopOffset)) - ((int) (((AndroidUtilities.displaySize.y * 0.8f) - this.buttonsHeight) - AndroidUtilities.m107dp(8))), this.chatTopOffset);
                }
                float m107dp = (AndroidUtilities.m107dp(8) + (((getMeasuredHeight() - AndroidUtilities.m107dp(16)) - ((this.buttonsHeight - AndroidUtilities.m107dp(8)) + (this.chatPreviewContainer.getMeasuredHeight() - this.chatTopOffset))) / 2.0f)) - this.chatTopOffset;
                this.yOffset = m107dp;
                if (m107dp > AndroidUtilities.m107dp(8)) {
                    this.yOffset = AndroidUtilities.m107dp(8);
                }
                this.menu.setTranslationX(getMeasuredWidth() - this.menu.getMeasuredWidth());
            } else {
                this.yOffset = BitmapDescriptorFactory.HUE_RED;
                this.chatTopOffset = 0;
                this.menu.setTranslationX(this.chatListView.getMeasuredWidth() + AndroidUtilities.m107dp(8));
            }
        ...
        public void setOffset(float f, int i) {
            if (MessagePreviewView.this.isLandscapeMode) {
                ...
                this.menu.setTranslationY((f + this.chatPreviewContainer.getMeasuredHeight()) - AndroidUtilities.m107dp(2));
                if (MessagePreviewView.this.editorHint != null) {
        ...
        public class Adapter extends RecyclerView.Adapter {
            ...
            private int offset(ChatMessageCell chatMessageCell, int i) {
                ...
                if (!TextUtils.isEmpty(messageObject.caption) && (textLayoutBlocks = chatMessageCell.captionLayout) != null) {
                    m107dp = (int) chatMessageCell.captionY;
                    ...
                    m107dp = chatMessageCell.linkPreviewAbove ? chatMessageCell.linkPreviewHeight + AndroidUtilities.m107dp(10) + i2 : i2;
                    ...
                    for (int i3 = 0; i3 < arrayList.size(); i3++) {
                        ...
                        if (i > i4) {
                            if (i - i4 > charSequence3.length() - 1) {
                                lineTop = m107dp + ((int) (textLayoutBlock.textYOffset + textLayoutBlock.padTop + textLayoutBlock.height));
                            } else {
                                lineTop = m107dp + textLayoutBlock.textYOffset + textLayoutBlock.padTop + staticLayout.getLineTop(staticLayout.getLineForOffset(i - textLayoutBlock.charactersOffset));
                            }
                            return (int) lineTop;
                        }
                    }
    ...
    public MessagePreviewView(final Context context, ChatActivity chatActivity, MessagePreviewParams messagePreviewParams, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, int i, ResourcesDelegate resourcesDelegate, int i2, final boolean z) {
        ...
        this.viewPager.setAdapter(new ViewPagerFixed.Adapter() { // from class: org.telegram.ui.Components.MessagePreviewView.3
            ...
            public int getItemViewType(int i5) {
                return MessagePreviewView.this.tabsView.tabs.get(i5).f1866id;
            }
    ...
    public /* synthetic */ void lambda$new$0(Integer num) {
        if (this.tabsView.tabs.get(this.viewPager.getCurrentPosition()).f1866id == num.intValue()) {
            return;
        }
        int i = 0;
        int i2 = 0;
        while (true) {
            if (i2 >= this.tabsView.tabs.size()) {
                break;
            } else if (this.tabsView.tabs.get(i2).f1866id == num.intValue()) {
                i = i2;
                break;
            } else {
                i2++;
    ...
    public static class TabsView extends View {
        ...
        public TabsView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.bgPaint = paint;
            this.tabInnerPadding = AndroidUtilities.m107dp(12);
            this.marginBetween = AndroidUtilities.m107dp(13);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float m107dp = (measuredHeight - AndroidUtilities.m107dp(26)) / 2.0f;
            float m107dp2 = (measuredHeight + AndroidUtilities.m107dp(26)) / 2.0f;
            ...
            for (int i4 = 0; i4 < this.tabs.size(); i4++) {
                ...
                this.tabs.get(i4).bounds.set(f2, m107dp, f2 + width, m107dp2);
                this.tabs.get(i4).clickBounds.set(this.tabs.get(i4).bounds);
                this.tabs.get(i4).clickBounds.inset((-this.marginBetween) / 2.0f, -m107dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (z2 || z) {
                canvas.drawRoundRect(this.selectRect, AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(13), this.bgPaint);
            }
        ...
        private int getHitTab(float f, float f2) {
            for (int i = 0; i < this.tabs.size(); i++) {
                if (this.tabs.get(i).clickBounds.contains(f, f2)) {
                    return this.tabs.get(i).f1866id;
                }
            }
            return -1;
        }
    ...
    /* loaded from: classes6.dex */
    public class C5223ActionBar extends FrameLayout {
        ...
        public C5223ActionBar(Context context, Theme.ResourcesProvider resourcesProvider) {
            super(context);
            this.resourcesProvider = resourcesProvider;
            ...
            animatedTextDrawable2.setTextSize(AndroidUtilities.m107dp(14));
            ...
            this.editorButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.MessagePreviewView$ActionBar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    MessagePreviewView.C5223ActionBar.this.lambda$new$0(view);
                }
            });
        ...
        protected void onMeasure(int i, int i2) {
            ...
            setPadding(AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(this.editorButton != null ? 5 : 18), 0);
        }
        ...
        private void setBounds(Drawable drawable, float f) {
            int i = (int) f;
            drawable.setBounds(getPaddingLeft(), i - AndroidUtilities.m107dp(32), (getMeasuredWidth() - getPaddingRight()) - (this.editorButton != null ? AndroidUtilities.m107dp(48) : 0), i + AndroidUtilities.m107dp(32));
        }

        @Override // android.view.ViewGroup, android.view.View
        protected void dispatchDraw(Canvas canvas) {
            super.dispatchDraw(canvas);
            setBounds(this.title, AndroidUtilities.lerp(AndroidUtilities.m107dp(29), AndroidUtilities.m108dp(18.83f), this.subtitle.isNotEmpty()));
            this.title.draw(canvas);
            setBounds(this.subtitle, AndroidUtilities.m108dp(39.5f));
    ...
    public class ToggleButton extends View {
        ...
        public ToggleButton(MessagePreviewView messagePreviewView, Context context, int i, String str, int i2, String str2) {
            ...
            this.textDrawable.setTextSize(AndroidUtilities.m107dp(16));
            ...
            int m107dp = (int) (AndroidUtilities.m107dp(77) + Math.max(this.textDrawable.getPaint().measureText(str), this.textDrawable.getPaint().measureText(str2)));
            this.minWidth = m107dp;
            this.textDrawable.setOverrideFullWidth(m107dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            if (LocaleController.isRTL) {
                this.iconDrawable.setBounds(getMeasuredWidth() - AndroidUtilities.m107dp(41), (getMeasuredHeight() - AndroidUtilities.m107dp(24)) / 2, getMeasuredWidth() - AndroidUtilities.m107dp(17), (getMeasuredHeight() + AndroidUtilities.m107dp(24)) / 2);
                this.textDrawable.setBounds(0, 0, getMeasuredWidth() - AndroidUtilities.m107dp(59), getMeasuredHeight());
            } else {
                this.iconDrawable.setBounds(AndroidUtilities.m107dp(17), (getMeasuredHeight() - AndroidUtilities.m107dp(24)) / 2, AndroidUtilities.m107dp(41), (getMeasuredHeight() + AndroidUtilities.m107dp(24)) / 2);
                this.textDrawable.setBounds(AndroidUtilities.m107dp(59), 0, getMeasuredWidth(), getMeasuredHeight());
            }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(min, mode), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(48), 1073741824));
        }
    ...
    public class RLottieToggleDrawable extends Drawable {
        ...
        public RLottieToggleDrawable(MessagePreviewView messagePreviewView, View view, int i, int i2) {
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(24));
            ...
            RLottieDrawable rLottieDrawable2 = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(24));
        ...
        public void draw(Canvas canvas) {
            ...
            rect.set(getBounds().centerX() - AndroidUtilities.m107dp(12), getBounds().centerY() - AndroidUtilities.m107dp(12), getBounds().centerX() + AndroidUtilities.m107dp(12), getBounds().centerY() + AndroidUtilities.m107dp(12));
