...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    public AdminLogFilterAlert(Context context, TLRPC$TL_channelAdminLogEventsFilter tLRPC$TL_channelAdminLogEventsFilter, LongSparseArray<TLRPC$User> longSparseArray, boolean z) {
        ...
        this.saveButton.setTextAndIcon(LocaleController.getString("Save", C3473R.string.Save).toUpperCase(), 0);
        ...
        if (view instanceof TextCell) {
            ...
            if (this.selectedAdmins == null) {
                ...
                for (int i4 = 0; i4 < this.currentAdmins.size(); i4++) {
                    ...
                    this.selectedAdmins.put(user.f1685id, user);
                }
            }
            boolean isChecked2 = checkBoxUserCell.isChecked();
            TLRPC$User currentUser = checkBoxUserCell.getCurrentUser();
            if (isChecked2) {
                this.selectedAdmins.remove(currentUser.f1685id);
            } else {
                this.selectedAdmins.put(currentUser.f1685id, currentUser);
            }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (i == 0) {
                textCell.setTextAndCheck(LocaleController.getString("EventLogFilterAll", C3473R.string.EventLogFilterAll), AdminLogFilterAlert.this.currentFilter == null, true);
                ...
                if (i != AdminLogFilterAlert.this.adminsRow) {
                    if (i != AdminLogFilterAlert.this.membersRow) {
                        if (i == AdminLogFilterAlert.this.infoRow) {
                            if (AdminLogFilterAlert.this.isMegagroup) {
                                String string = LocaleController.getString("EventLogFilterGroupInfo", C3473R.string.EventLogFilterGroupInfo);
                            ...
                            String string2 = LocaleController.getString("EventLogFilterChannelInfo", C3473R.string.EventLogFilterChannelInfo);
                            if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.info) {
                                r1 = true;
                            }
                            ...
                            if (i != AdminLogFilterAlert.this.editRow) {
                                if (i != AdminLogFilterAlert.this.pinnedRow) {
                                    if (i == AdminLogFilterAlert.this.leavingRow) {
                                        textCell.setTextAndCheck(LocaleController.getString("EventLogFilterLeavingMembers", C3473R.string.EventLogFilterLeavingMembers), AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.leave, AdminLogFilterAlert.this.callsRow != -1);
                                        return;
                                        ...
                                        if (i != AdminLogFilterAlert.this.invitesRow) {
                                            if (i == AdminLogFilterAlert.this.allAdminsRow) {
                                                textCell.setTextAndCheck(LocaleController.getString("EventLogAllAdmins", C3473R.string.EventLogAllAdmins), AdminLogFilterAlert.this.selectedAdmins == null, true);
                                                return;
                                            }
                                            return;
                                        }
                                        String string3 = LocaleController.getString("EventLogFilterInvites", C3473R.string.EventLogFilterInvites);
                                        ...
                                        String string4 = LocaleController.getString("EventLogFilterCalls", C3473R.string.EventLogFilterCalls);
                                ...
                                String string5 = LocaleController.getString("EventLogFilterPinnedMessages", C3473R.string.EventLogFilterPinnedMessages);
                            ...
                            String string6 = LocaleController.getString("EventLogFilterEditedMessages", C3473R.string.EventLogFilterEditedMessages);
                            ...
                            String string7 = LocaleController.getString("EventLogFilterDeletedMessages", C3473R.string.EventLogFilterDeletedMessages);
                    ...
                    String string8 = LocaleController.getString("EventLogFilterNewMembers", C3473R.string.EventLogFilterNewMembers);
                ...
                String string9 = LocaleController.getString("EventLogFilterNewAdmins", C3473R.string.EventLogFilterNewAdmins);
                ...
                String string10 = LocaleController.getString("EventLogFilterNewRestrictions", C3473R.string.EventLogFilterNewRestrictions);
