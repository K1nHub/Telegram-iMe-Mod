...
public class OverlayActionBarLayoutDialog extends Dialog implements INavigationLayout.INavigationLayoutDelegate {
    ...
    public void onMeasureOverride(int[] iArr) {
        ...
        iArr[0] = View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m107dp(530), View.MeasureSpec.getSize(iArr[0])), 1073741824);
        iArr[1] = View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m107dp(528), View.MeasureSpec.getSize(iArr[1])), 1073741824);
    }
