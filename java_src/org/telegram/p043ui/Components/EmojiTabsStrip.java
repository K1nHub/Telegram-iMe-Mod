...
public class EmojiTabsStrip extends ScrollableHorizontalScrollView {
    ...
    public EmojiTabsStrip(Context context, Theme.ResourcesProvider resourcesProvider, boolean z, boolean z2, final boolean z3, int i, Runnable runnable, int i2) {
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.Components.EmojiTabsStrip.1
            ...
            /* renamed from: to */
            private RectF f1840to = new RectF();
            ...
            protected void onLayout(boolean z4, int i3, int i4, int i5, int i6) {
                int i7 = (i6 - i4) / 2;
                if (z3) {
                    int paddingLeft = getPaddingLeft() - (!EmojiTabsStrip.this.recentIsShown ? AndroidUtilities.m104dp(33) : 0);
                    for (int i8 = 0; i8 < getChildCount(); i8++) {
                        ...
                        if (childAt != EmojiTabsStrip.this.settingsTab && !EmojiTabsStrip.this.removingViews.containsKey(childAt) && childAt != null) {
                            ...
                            Long m60id = z5 ? ((EmojiTabButton) childAt).m60id() : childAt instanceof EmojiTabsView ? Long.valueOf(((EmojiTabsView) childAt).f1842id) : null;
                            ...
                            if (m60id != null) {
                                Integer num = this.lastX.get(m60id.longValue());
                                if (num != null && num.intValue() != paddingLeft && Math.abs(num.intValue() - paddingLeft) < AndroidUtilities.m104dp(45)) {
                                ...
                                this.lastX.put(m60id.longValue(), Integer.valueOf(paddingLeft));
                            }
                            paddingLeft += childAt.getMeasuredWidth() + AndroidUtilities.m104dp(3);
                        }
                    }
                    if (EmojiTabsStrip.this.settingsTab != null) {
                        int m104dp = paddingLeft + (EmojiTabsStrip.this.recentIsShown ? 0 : AndroidUtilities.m104dp(33));
                        Long l = EmojiTabsStrip.this.settingsTab.f1841id;
                        if (EmojiTabsStrip.this.settingsTab.getMeasuredWidth() + m104dp + getPaddingRight() <= EmojiTabsStrip.this.getMeasuredWidth()) {
                            ...
                            EmojiTabsStrip.this.settingsTab.layout(m104dp, i7 - (EmojiTabsStrip.this.settingsTab.getMeasuredHeight() / 2), EmojiTabsStrip.this.settingsTab.getMeasuredWidth() + m104dp, i7 + (EmojiTabsStrip.this.settingsTab.getMeasuredHeight() / 2));
                        }
                        if (l != null) {
                            if (this.lastX.get(l.longValue()) != null && this.lastX.get(l.longValue()).intValue() != m104dp) {
                                EmojiTabsStrip.this.settingsTab.setTranslationX(this.lastX.get(l.longValue()).intValue() - m104dp);
                                EmojiTabsStrip.this.settingsTab.animate().translationX(BitmapDescriptorFactory.HUE_RED).setDuration(350L).start();
                            }
                            this.lastX.put(l.longValue(), Integer.valueOf(m104dp));
                            return;
                        }
                        return;
                    }
                ...
                int paddingLeft2 = (int) (((((i5 - i3) - getPaddingLeft()) - getPaddingRight()) - (AndroidUtilities.m104dp(30) * childCount)) / Math.max(1, childCount - 1));
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                int paddingLeft = (getPaddingLeft() + getPaddingRight()) - ((int) (EmojiTabsStrip.this.recentIsShown ? BitmapDescriptorFactory.HUE_RED : EmojiTabsStrip.this.recentTab.getAlpha() * AndroidUtilities.m104dp(33)));
                for (int i5 = 0; i5 < getChildCount(); i5++) {
                    View childAt = getChildAt(i5);
                    if (childAt != null) {
                        childAt.measure(makeMeasureSpec, i4);
                        paddingLeft += childAt.getMeasuredWidth() + (i5 + 1 < getChildCount() ? AndroidUtilities.m104dp(3) : 0);
                    }
                }
                if (!z3) {
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                getChildBounds((int) Math.ceil(EmojiTabsStrip.this.selectT), this.f1840to);
                AndroidUtilities.lerp(this.from, this.f1840to, EmojiTabsStrip.this.selectT - floor, this.rect);
                ...
                float m105dp = AndroidUtilities.m105dp(AndroidUtilities.lerp(8.0f, 16.0f, f));
                ...
                this.path.rewind();
                this.path.addRoundRect(this.rect, m105dp, m105dp, Path.Direction.CW);
                ...
                if (EmojiTabsStrip.this.emojiTabs != null) {
                    this.path.addCircle(EmojiTabsStrip.this.emojiTabs.getLeft() + AndroidUtilities.m104dp(15), (EmojiTabsStrip.this.emojiTabs.getTop() + EmojiTabsStrip.this.emojiTabs.getBottom()) / 2.0f, AndroidUtilities.m104dp(15), Path.Direction.CW);
                }
        ...
        if (z) {
            ...
            this.recentTab.f1841id = Long.valueOf(-934918565);
        }
        if (z3) {
            if (z2) {
                ...
                this.emojiTabs.f1842id = 3552126;
            }
            ...
            if (runnable != null) {
                ...
                this.settingsTab.f1841id = Long.valueOf(1434631203);
    ...
    private static class StabDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            this.rectF.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m104dp(30), AndroidUtilities.m104dp(30));
    ...
    protected void onMeasure(int i, int i2) {
        this.contentView.setPadding(AndroidUtilities.m105dp(this.paddingLeftDp), 0, AndroidUtilities.m104dp(11), 0);
    ...
    public void select(int i, boolean z) {
        ...
        if (this.wasIndex != i) {
            ...
            if (emojiTabsView3 != null && this.selected == 1 && i >= 1 && i <= emojiTabsView3.contentView.getChildCount() + 1) {
                int i8 = ((i - 1) * 36) - 6;
                this.emojiTabs.scrollToVisible(AndroidUtilities.m104dp(i8), AndroidUtilities.m104dp(i8 + 30));
            }
            this.wasIndex = i;
        }
    }
    ...
    public class EmojiTabButton extends ViewGroup {
        ...
        public EmojiTabButton(Context context, int i, int i2, boolean z, boolean z2) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(24), false, null);
                this.lottieDrawable = rLottieDrawable;
                rLottieDrawable.setBounds(AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(27), AndroidUtilities.m104dp(27));
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m104dp(30), AndroidUtilities.m104dp(30));
            ImageView imageView = this.imageView;
            if (imageView != null) {
                imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(24), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(24), 1073741824));
            }
            PremiumLockIconView premiumLockIconView = this.lockView;
            if (premiumLockIconView != null) {
                premiumLockIconView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(12), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(12), 1073741824));
            }
        }
    ...
    public class EmojiTabsView extends ScrollableHorizontalScrollView {
        ...
        public EmojiTabsView(Context context) {
            ...
            LinearLayout linearLayout = new LinearLayout(context, EmojiTabsStrip.this) { // from class: org.telegram.ui.Components.EmojiTabsStrip.EmojiTabsView.1
                ...
                protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                    ...
                    for (int i6 = 0; i6 < getChildCount(); i6++) {
                        ...
                        if (childAt != EmojiTabsStrip.this.settingsTab && childAt != null) {
                            ...
                            paddingLeft += childAt.getMeasuredWidth() + AndroidUtilities.m104dp(2);
                        }
                    }
                }
                ...
                @Override // android.widget.LinearLayout, android.view.View
                protected void onMeasure(int i, int i2) {
                    super.onMeasure(Math.max(View.MeasureSpec.getSize(i), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(EmojiTabsView.this.contentView.getChildCount() * 32), 1073741824)), i2);
                }
            };
            this.contentView = linearLayout;
        ...
        @Override // android.widget.HorizontalScrollView, android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.lerp(AndroidUtilities.m104dp(30), maxWidth(), this.showT), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(30), 1073741824));
        }

        public int maxWidth() {
            return AndroidUtilities.m105dp(Math.min(5.7f, this.contentView.getChildCount()) * 32.0f);
        }
