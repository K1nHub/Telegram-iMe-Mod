...
public class GroupedPhotosListView extends View implements GestureDetector.OnGestureListener {
    ...
    public GroupedPhotosListView(Context context, int i) {
        ...
        this.itemWidth = AndroidUtilities.m104dp(42);
        this.itemHeight = AndroidUtilities.m104dp(56);
        this.itemSpacing = AndroidUtilities.m104dp(1);
        this.itemY = i;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.hasPhotos || !this.imagesToDraw.isEmpty()) {
            ...
            for (int i15 = 0; i15 < size; i15++) {
                ...
                imageReceiver.setRoundRadius(AndroidUtilities.m104dp(2));
