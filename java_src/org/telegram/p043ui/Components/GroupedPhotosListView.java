...
public class GroupedPhotosListView extends View implements GestureDetector.OnGestureListener {
    ...
    public GroupedPhotosListView(Context context, int i) {
        ...
        this.itemWidth = AndroidUtilities.m107dp(42);
        this.itemHeight = AndroidUtilities.m107dp(56);
        this.itemSpacing = AndroidUtilities.m107dp(1);
        this.itemY = i;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.hasPhotos || !this.imagesToDraw.isEmpty()) {
            ...
            if (imageLocation != null && (tLRPC$PhotoSize2 = imageLocation.photoSize) != null) {
                i = Math.max(this.itemWidth, (int) (tLRPC$PhotoSize2.f1634w * (this.itemHeight / tLRPC$PhotoSize2.f1633h)));
            } else {
                i = this.itemHeight;
            }
            ...
            if (i11 >= 0 && i11 < this.currentPhotos.size()) {
                ...
                if (imageLocation2 != null && (tLRPC$PhotoSize = imageLocation2.photoSize) != null) {
                    i3 = Math.max(this.itemWidth, (int) (tLRPC$PhotoSize.f1634w * (this.itemHeight / tLRPC$PhotoSize.f1633h)));
                } else {
                    i3 = this.itemHeight;
                }
            } else {
            ...
            for (int i15 = 0; i15 < size; i15++) {
                ...
                imageReceiver.setRoundRadius(AndroidUtilities.m107dp(2));
