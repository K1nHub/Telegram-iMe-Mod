...
public class WallpaperUpdater {
    ...
    public void showAlert(final boolean z) {
        ...
        builder.setTitle(LocaleController.getString("ChoosePhoto", C3417R.string.ChoosePhoto), true);
        if (z) {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3417R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3417R.string.SelectFromGallery), LocaleController.getString("SelectColor", C3417R.string.SelectColor), LocaleController.getString("Default", C3417R.string.Default)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3417R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3417R.string.SelectFromGallery)};
            iArr = new int[]{C3417R.C3419drawable.msg_camera, C3417R.C3419drawable.msg_photos};
        }
