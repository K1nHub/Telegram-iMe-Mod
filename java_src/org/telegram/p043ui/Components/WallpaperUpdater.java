...
public class WallpaperUpdater {
    ...
    public void showAlert(final boolean z) {
        ...
        builder.setTitle(LocaleController.getString("ChoosePhoto", C3473R.string.ChoosePhoto), true);
        if (z) {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3473R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3473R.string.SelectFromGallery), LocaleController.getString("SelectColor", C3473R.string.SelectColor), LocaleController.getString("Default", C3473R.string.Default)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3473R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3473R.string.SelectFromGallery)};
            iArr = new int[]{C3473R.C3475drawable.msg_camera, C3473R.C3475drawable.msg_photos};
        }
