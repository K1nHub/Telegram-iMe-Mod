...
public class WallpaperUpdater {
    ...
    public void showAlert(final boolean z) {
        ...
        builder.setTitle(LocaleController.getString("ChoosePhoto", C3419R.string.ChoosePhoto), true);
        if (z) {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3419R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3419R.string.SelectFromGallery), LocaleController.getString("SelectColor", C3419R.string.SelectColor), LocaleController.getString("Default", C3419R.string.Default)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{LocaleController.getString("ChooseTakePhoto", C3419R.string.ChooseTakePhoto), LocaleController.getString("SelectFromGallery", C3419R.string.SelectFromGallery)};
            iArr = new int[]{C3419R.C3421drawable.msg_camera, C3419R.C3421drawable.msg_photos};
        }
    ...
    */
    public void onActivityResult(int r8, int r9, android.content.Intent r10) {
        ...
        L5f:
            ...
            r9 = r5
        L61:
            org.telegram.messenger.FileLog.m67e(r8)     // Catch: java.lang.Throwable -> L71
            if (r9 == 0) goto L6e
            r9.close()     // Catch: java.lang.Exception -> L6a
            goto L6e
        L6a:
        ...
        L79:
            r9 = move-exception
            org.telegram.messenger.FileLog.m67e(r9)
        L7d:
            throw r8
        L7e:
            r9 = 11
        ...
        Ld6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.WallpaperUpdater.onActivityResult(int, int, android.content.Intent):void");
    }
}
