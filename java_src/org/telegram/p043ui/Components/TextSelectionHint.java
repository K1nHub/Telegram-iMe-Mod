...
public class TextSelectionHint extends View {
    ...
    public TextSelectionHint(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.padding = AndroidUtilities.m107dp(24);
        ...
        setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(6), getThemedColor(Theme.key_undo_background)));
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        int height = this.textLayout.getHeight() + (AndroidUtilities.m107dp(8) * 2);
        if (height < AndroidUtilities.m107dp(56)) {
            height = AndroidUtilities.m107dp(56);
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.currentStart == this.animateToStart) {
            i = lineBottom2;
            f = f3;
            roundedRect(this.path, -AndroidUtilities.m107dp(4), this.textLayout.getLineTop(lineForOffset2), BitmapDescriptorFactory.HUE_RED, this.textLayout.getLineBottom(lineForOffset2), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), true, false);
            canvas.drawPath(this.path, this.selectionPaint);
        } else {
            i = lineBottom2;
            f = f3;
        ...
        canvas.save();
        canvas.translate(((int) ((this.textLayout.getPrimaryHorizontal(this.animateToStart) - (AndroidUtilities.m107dp(4) * (1.0f - this.startOffsetValue))) + ((this.textLayout.getPrimaryHorizontal(this.start) - this.textLayout.getPrimaryHorizontal(this.animateToStart)) * this.startOffsetValue))) - m107dp, i);
        float f4 = f;
