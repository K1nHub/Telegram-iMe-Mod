    ...
    public void setColors(int i, int i2, int i3, int i4) {
        ...
        if (i2 == 0) {
            ...
            if (this.isDiagonal && this.isRotate) {
                ...
                LinearGradient linearGradient2 = new LinearGradient(this.isDiagonal ? 80.0f : BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, 80.0f, new int[]{i, i2}, (float[]) null, Shader.TileMode.CLAMP);
