...
public class BlockingUpdateView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BlockingUpdateView(final Context context) {
        ...
        addView(frameLayout, new FrameLayout.LayoutParams(-1, AndroidUtilities.m104dp(176) + (i2 >= 21 ? AndroidUtilities.statusBarHeight : 0)));
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        rLottieImageView.setAnimation(C3634R.raw.qr_code_logo, 108, 108);
        rLottieImageView.playAnimation();
        rLottieImageView.getAnimatedDrawable().setAutoRepeat(1);
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.setPadding(0, 0, 0, AndroidUtilities.m104dp(14));
        ...
        this.scrollView.setPadding(0, AndroidUtilities.m104dp(16), 0, AndroidUtilities.m104dp(16));
        ...
        textView.setText(LocaleController.getString("UpdateTelegram", C3634R.string.UpdateTelegram));
        ...
        this.textView.setLineSpacing(AndroidUtilities.m104dp(2), 1.0f);
        ...
        FrameLayout frameLayout3 = new FrameLayout(this, context) { // from class: org.telegram.ui.Components.BlockingUpdateView.1
            ...
            protected void onMeasure(int i5, int i6) {
                if (View.MeasureSpec.getSize(i5) > AndroidUtilities.m104dp(260)) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(320), 1073741824), i6);
                } else {
        ...
        frameLayout3.setPadding(AndroidUtilities.m104dp(34), 0, AndroidUtilities.m104dp(34), 0);
        this.acceptButton.setBackgroundDrawable(Theme.AdaptiveRipple.filledRectByKey(Theme.key_featuredStickers_addButton, 4.0f));
        this.acceptButton.setPadding(AndroidUtilities.m104dp(34), 0, AndroidUtilities.m104dp(34), 0);
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.telegram.ui.Components.BlockingUpdateView.2
            ...
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                ...
                int i9 = ((i7 - i5) - m104dp) / 2;
                int i10 = ((i8 - i6) - m104dp) / 2;
                BlockingUpdateView.this.radialProgress.setProgressRect(i9, i10, i9 + m104dp, m104dp + i10);
            }
    ...
    public void show(int i, TLRPC$TL_help_appUpdate tLRPC$TL_help_appUpdate, boolean z) {
        ...
        if (tLRPC$TL_help_appUpdate.document instanceof TLRPC$TL_document) {
            ...
            textView.setText(LocaleController.getString("Update", C3634R.string.Update) + String.format(Locale.US, " (%1$s)", AndroidUtilities.formatFileSize(tLRPC$TL_help_appUpdate.document.size)));
        } else {
            this.acceptTextView.setText(LocaleController.getString("Update", C3634R.string.Update));
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.gradientDrawableTop.setBounds(this.scrollView.getLeft(), this.scrollView.getTop(), this.scrollView.getRight(), this.scrollView.getTop() + AndroidUtilities.m104dp(16));
        this.gradientDrawableTop.draw(canvas);
        this.gradientDrawableBottom.setBounds(this.scrollView.getLeft(), this.scrollView.getBottom() - AndroidUtilities.m104dp(18), this.scrollView.getRight(), this.scrollView.getBottom());
