...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayoutPhoto.SizeNotifierFrameLayoutPhotoDelegate {
    ...
    public PhotoViewerCaptionEnterView(final PhotoViewer photoViewer, Context context, final SizeNotifierFrameLayoutPhoto sizeNotifierFrameLayoutPhoto, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.emojiButton.setContentDescription(LocaleController.getString("Emoji", C3473R.string.Emoji));
        ...
        this.emojiIconDrawable.setIcon(C3473R.C3475drawable.input_smile, false);
        ...
        this.messageEditText.setHint(LocaleController.getString("AddCaption", C3473R.string.AddCaption));
        ...
        this.messageEditText.addTextChangedListener(new C51092(photoViewer, sizeNotifierFrameLayoutPhoto));
        this.doneDrawable = Theme.createCircleDrawable(AndroidUtilities.m72dp(16), -10043398);
        this.checkDrawable = context.getResources().getDrawable(C3473R.C3475drawable.input_done).mutate();
        ...
        imageView3.setContentDescription(LocaleController.getString("Done", C3473R.string.Done));
    ...
    /* loaded from: classes7.dex */
    public class C51092 implements TextWatcher {
        ...
        C51092(PhotoViewer photoViewer, SizeNotifierFrameLayoutPhoto sizeNotifierFrameLayoutPhoto) {
        ...
        */
        public void afterTextChanged(android.text.Editable r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.PhotoViewerCaptionEnterView.C51092.afterTextChanged(android.text.Editable):void");
        }
    ...
    private void createEmojiView() {
        ...
        emojiView2.setDelegate(new EmojiView.EmojiViewDelegate() { // from class: org.telegram.ui.Components.PhotoViewerCaptionEnterView.3
            ...
            /* loaded from: classes7.dex */
            class C51121 extends BaseFragment {
                C51121() {
                }
                ...
                public Dialog getVisibleDialog() {
                    return new Dialog(PhotoViewerCaptionEnterView.this.getContext()) { // from class: org.telegram.ui.Components.PhotoViewerCaptionEnterView.3.1.1
                        ...
                        public void dismiss() {
                            if ((C51121.this.getParentActivity() instanceof LaunchActivity) && ((LaunchActivity) C51121.this.getParentActivity()).getActionBarLayout() != null) {
                                C51121 c51121 = C51121.this;
                                ((BaseFragment) c51121).parentLayout = ((LaunchActivity) c51121.getParentActivity()).getActionBarLayout();
                                if (((BaseFragment) C51121.this).parentLayout != null && ((BaseFragment) C51121.this).parentLayout.getLastFragment() != null && ((BaseFragment) C51121.this).parentLayout.getLastFragment().getVisibleDialog() != null) {
                                    Dialog visibleDialog = ((BaseFragment) C51121.this).parentLayout.getLastFragment().getVisibleDialog();
            ...
            public void onAnimatedEmojiUnlockClick() {
                new PremiumFeatureBottomSheet(new C51121(), 11, false).show();
            }
    ...
    private void showPopup(int i, boolean z) {
        if (i == 1) {
            ...
            if (sizeNotifierFrameLayoutPhoto != null) {
                ...
                this.emojiIconDrawable.setIcon(C3473R.C3475drawable.input_keyboard, true);
                onWindowSizeChanged();
                return;
            }
            return;
        ...
        if (this.emojiButton != null) {
            this.emojiIconDrawable.setIcon(C3473R.C3475drawable.input_smile, true);
        }
