...
public class BottomPagerTabs extends View {
    ...
    public class Tab {
        ...
        public Tab(int i, int i2, CharSequence charSequence) {
            ...
            this.f1820i = i;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m104dp(29), AndroidUtilities.m104dp(29));
            ...
            this.ripple = Theme.createSelectorDrawable(Theme.multAlpha(Theme.getColor(i3, BottomPagerTabs.this.resourcesProvider), 0.1f), 7, AndroidUtilities.m104dp(16));
        }
        ...
        public void setActive(boolean z, boolean z2) {
            ...
            if (!(BottomPagerTabs.this.parentFragment instanceof MediaActivity) || this.f1820i != 2 || !z) {
                if (BottomPagerTabs.this.tabs[this.f1820i].customEndFrameMid != 0) {
                    if (z) {
        ...
        public void setColor(int i) {
            if ((BottomPagerTabs.this.parentFragment instanceof MediaActivity) && this.f1820i != 2 && !MessagesController.getInstance(UserConfig.selectedAccount).storiesEnabled()) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int min = Math.min(AndroidUtilities.m104dp(64), width);
        ...
        if (f2 > BitmapDescriptorFactory.HUE_RED) {
            ...
            float f6 = min / 2.0f;
            rectF.set(paddingLeft2 - f6, AndroidUtilities.m104dp(9), paddingLeft2 + f6, AndroidUtilities.m104dp(41));
            canvas2 = canvas;
            canvas2.drawRoundRect(rectF, AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(16), this.selectPaint);
        } else {
            canvas2 = canvas;
        }
        int i2 = 0;
        while (true) {
            ...
            float f7 = min / f3;
            rect.set((int) (tab.clickRect.centerX() - f7), AndroidUtilities.m104dp(i), (int) (tab.clickRect.centerX() + f7), AndroidUtilities.m104dp(41));
            ...
            if (f2 < 1.0f) {
                ...
                rectF2.set(rect);
                c = 16;
                canvas2.drawRoundRect(rectF2, AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(16), this.selectPaint);
            } else {
                c = 16;
            }
            tab.ripple.setBounds(rect);
            tab.ripple.draw(canvas2);
            float m104dp = AndroidUtilities.m104dp(29) / 2.0f;
            rect.set((int) (tab.clickRect.centerX() - m104dp), (int) (AndroidUtilities.dpf2(24.66f) - m104dp), (int) (tab.clickRect.centerX() + m104dp), (int) (AndroidUtilities.dpf2(24.66f) + m104dp));
            tab.drawable.setBounds(rect);
            tab.drawable.draw(canvas2);
            canvas.save();
            canvas2.translate((tab.clickRect.centerX() - (tab.layoutWidth / 2.0f)) - tab.layoutLeft, AndroidUtilities.m104dp(50) - (tab.layout.getHeight() / 2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m104dp(64) + AndroidUtilities.getShadowHeight());
    }
