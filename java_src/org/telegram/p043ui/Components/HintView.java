...
public class HintView extends FrameLayout {
    ...
    public HintView(Context context, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 7 || i == 8 || i == 9) {
            this.textView.setMaxWidth(AndroidUtilities.m104dp(310));
        } else if (i == 4) {
            this.textView.setMaxWidth(AndroidUtilities.m104dp(280));
        } else {
            this.textView.setMaxWidth(AndroidUtilities.m104dp(250));
        }
        if (this.currentType == 3) {
            this.textView.setGravity(19);
            this.textView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m104dp(5), getThemedColor(Theme.key_chat_gifSaveHintBackground)));
            this.textView.setPadding(AndroidUtilities.m104dp(10), 0, AndroidUtilities.m104dp(10), 0);
            addView(this.textView, LayoutHelper.createFrame(-2, 30, 51, 0, z ? 6 : 0, 0, z ? 0 : 6));
        } else {
            this.textView.setGravity(51);
            this.textView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m104dp(6), getThemedColor(Theme.key_chat_gifSaveHintBackground)));
            this.textView.setPadding(AndroidUtilities.m104dp(this.currentType == 0 ? 54 : 8), AndroidUtilities.m104dp(7), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8));
            addView(this.textView, LayoutHelper.createFrame(-2, -2, 51, 0, z ? 6 : 0, 0, z ? 0 : 6));
        }
        if (i == 0) {
            this.textView.setText(LocaleController.getString("AutoplayVideoInfo", C3634R.string.AutoplayVideoInfo));
            ImageView imageView = new ImageView(context);
            this.imageView = imageView;
            imageView.setImageResource(C3634R.C3636drawable.tooltip_sound);
        ...
        imageView2.setImageResource(z ? C3634R.C3636drawable.tooltip_arrow_up : C3634R.C3636drawable.tooltip_arrow);
    ...
    public void createCloseButton() {
        this.textView.setPadding(AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(7), AndroidUtilities.m104dp(36), AndroidUtilities.m104dp(8));
        this.hasCloseButton = true;
        ImageView imageView = new ImageView(getContext());
        this.imageView = imageView;
        imageView.setImageResource(C3634R.C3636drawable.msg_mini_close_tooltip);
        this.imageView.setScaleType(ImageView.ScaleType.CENTER);
    ...
    public void setBackgroundColor(int i, int i2) {
        ...
        textView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m104dp((i3 == 7 || i3 == 8) ? 6 : 3), i));
    }
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, Object obj, int i, int i2, boolean z) {
        ...
        if (!(i3 == 5 && i2 == this.shownY && this.messageCell == chatMessageCell) && (i3 == 5 || ((i3 != 0 || getTag() == null) && this.messageCell != chatMessageCell))) {
            ...
            if (i6 == 0) {
                ...
                m104dp = (int) (i5 + photoImage.getImageY());
                int imageHeight = (int) photoImage.getImageHeight();
                int i7 = m104dp + imageHeight;
                int measuredHeight = view.getMeasuredHeight();
                if (m104dp <= getMeasuredHeight() + AndroidUtilities.m104dp(10) || i7 > measuredHeight + (imageHeight / 4)) {
                    return false;
                }
                ...
                this.shownY = i2;
                if (num.intValue() == -1) {
                    this.textView.setText(LocaleController.getString("PollSelectOption", C3634R.string.PollSelectOption));
                } else if (chatMessageCell.getMessageObject().isQuiz()) {
                    if (num.intValue() == 0) {
                        this.textView.setText(LocaleController.getString("NoVotesQuiz", C3634R.string.NoVotesQuiz));
                    } else {
                        this.textView.setText(LocaleController.formatPluralString("Answer", num.intValue(), new Object[0]));
                    }
                } else if (num.intValue() == 0) {
                    this.textView.setText(LocaleController.getString("NoVotes", C3634R.string.NoVotes));
                } else {
                ...
                if (str == null) {
                    this.textView.setText(LocaleController.getString("HidAccount", C3634R.string.HidAccount));
                } else {
                    this.textView.setText(str);
                }
                measure(View.MeasureSpec.makeMeasureSpec(1000, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(1000, Integer.MIN_VALUE));
                TLRPC$User currentUser = chatMessageCell.getCurrentUser();
                if (currentUser != null && currentUser.f1749id == 0) {
                    m104dp = i5 + ((chatMessageCell.getMeasuredHeight() - Math.max(0, chatMessageCell.getBottom() - view.getMeasuredHeight())) - AndroidUtilities.m104dp(50));
                } else {
                    m104dp = i5 + AndroidUtilities.m104dp(22);
                    if (!messageObject.isOutOwner() && chatMessageCell.isDrawNameLayout()) {
                        m104dp += AndroidUtilities.m104dp(20);
                    }
                    if (!messageObject.shouldDrawWithoutBackground() && chatMessageCell.isDrawTopic()) {
                        m104dp = (int) (m104dp + AndroidUtilities.m104dp(5) + chatMessageCell.getDrawTopicHeight());
                    }
                }
                if (!this.isTopArrow && m104dp <= getMeasuredHeight() + AndroidUtilities.m104dp(10)) {
                    return false;
                }
            ...
            if (this.isTopArrow) {
                ...
                float m104dp2 = AndroidUtilities.m104dp(44);
                this.translationY = m104dp2;
                setTranslationY(f + m104dp2);
            } else {
                float f2 = this.extraTranslationY;
                float measuredHeight2 = m104dp - getMeasuredHeight();
                this.translationY = measuredHeight2;
                setTranslationY(f2 + measuredHeight2);
            }
            int left = chatMessageCell.getLeft() + forwardNameCenterX;
            int m104dp3 = AndroidUtilities.m104dp(19);
            if (this.currentType == 5) {
                int max = Math.max(0, (forwardNameCenterX - (getMeasuredWidth() / 2)) - AndroidUtilities.m105dp(19.1f));
                setTranslationX(max);
                m104dp3 += max;
            } else if (left > view.getMeasuredWidth() / 2) {
                int measuredWidth2 = (measuredWidth - getMeasuredWidth()) - AndroidUtilities.m104dp(38);
                setTranslationX(measuredWidth2);
                m104dp3 += measuredWidth2;
            } else {
                setTranslationX(BitmapDescriptorFactory.HUE_RED);
            }
            float left2 = ((chatMessageCell.getLeft() + forwardNameCenterX) - m104dp3) - (this.arrowImageView.getMeasuredWidth() / 2);
            this.arrowImageView.setTranslationX(left2);
            if (left > view.getMeasuredWidth() / 2) {
                if (left2 < AndroidUtilities.m104dp(10)) {
                    float m104dp4 = left2 - AndroidUtilities.m104dp(10);
                    setTranslationX(getTranslationX() + m104dp4);
                    this.arrowImageView.setTranslationX(left2 - m104dp4);
                }
                ...
                float m104dp5 = left2 - AndroidUtilities.m104dp(10);
                setTranslationX(getTranslationX() + m104dp5);
                this.arrowImageView.setTranslationX(left2 - m104dp5);
            }
            ...
            if (z) {
                ...
                this.animatorSet.addListener(new C50891());
    ...
    /* loaded from: classes6.dex */
    public class C50891 extends AnimatorListenerAdapter {
        C50891() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(HintView.this.hideRunnable = new Runnable() { // from class: org.telegram.ui.Components.HintView$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    HintView.C50891.this.lambda$onAnimationEnd$0();
                }
    ...
    public boolean showForView(View view, boolean z) {
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C50902());
            this.animatorSet.start();
        } else {
            setAlpha(1.0f);
        }
    ...
    /* loaded from: classes6.dex */
    public class C50902 extends AnimatorListenerAdapter {
        C50902() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(HintView.this.hideRunnable = new Runnable() { // from class: org.telegram.ui.Components.HintView$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    HintView.C50902.this.lambda$onAnimationEnd$0();
                }
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.drawPath) {
            ...
            if (this.isTopArrow) {
                this.path.moveTo(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m104dp(6));
                float f = measuredHeight;
                this.path.lineTo(BitmapDescriptorFactory.HUE_RED, f);
                float f2 = measuredWidth;
                this.path.lineTo(f2, f);
                this.path.lineTo(f2, AndroidUtilities.m104dp(6));
                this.path.lineTo(AndroidUtilities.m104dp(7) + x, AndroidUtilities.m104dp(6));
                this.path.lineTo(x, -AndroidUtilities.m104dp(2));
                this.path.lineTo(x - AndroidUtilities.m104dp(7), AndroidUtilities.m104dp(6));
                this.path.close();
                return;
            }
            this.path.moveTo(BitmapDescriptorFactory.HUE_RED, measuredHeight - AndroidUtilities.m104dp(6));
            ...
            this.path.lineTo(f3, measuredHeight - AndroidUtilities.m104dp(6));
            this.path.lineTo(AndroidUtilities.m104dp(7) + x, measuredHeight - AndroidUtilities.m104dp(6));
            this.path.lineTo(x, AndroidUtilities.m104dp(2) + measuredHeight);
            this.path.lineTo(x - AndroidUtilities.m104dp(7), measuredHeight - AndroidUtilities.m104dp(6));
            this.path.close();
        }
    }
}
