...
public class TextPaintImageReceiverSpan extends ReplacementSpan {
    ...
    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        if (fontMetricsInt != null) {
            if (this.alignTop) {
                int m104dp = (fontMetricsInt.descent - fontMetricsInt.ascent) - AndroidUtilities.m104dp(4);
                int i3 = this.height - m104dp;
                ...
                int m104dp2 = ((-this.height) / 2) - AndroidUtilities.m104dp(4);
                fontMetricsInt.ascent = m104dp2;
                fontMetricsInt.top = m104dp2;
                int i5 = this.height;
                int m104dp3 = (i5 - (i5 / 2)) - AndroidUtilities.m104dp(4);
                fontMetricsInt.descent = m104dp3;
                fontMetricsInt.bottom = m104dp3;
            }
        }
        return this.width;
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (this.alignTop) {
            ...
            int i6 = this.height;
            this.imageReceiver.setImageCoords((int) f, i3 + ((((i5 - AndroidUtilities.m104dp(4)) - i3) - i6) / 2), this.width, i6);
        }
