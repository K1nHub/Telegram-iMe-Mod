...
/* renamed from: org.telegram.ui.Components.CheckBox2 */
...
public class CheckBox2 extends View {
    ...
    protected void onDraw(Canvas canvas) {
        if (this.iconDrawable != null) {
            ...
            paint.setStrokeWidth(AndroidUtilities.m108dp(1.2f));
            paint.setColor(Theme.getColor(Theme.key_switch2Track));
            canvas.drawCircle(measuredWidth, measuredHeight, measuredWidth - AndroidUtilities.m108dp(1.5f), paint);
            return;
        }
