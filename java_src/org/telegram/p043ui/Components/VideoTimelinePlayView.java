...
public class VideoTimelinePlayView extends View {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m104dp(44);
        float f = measuredWidth;
        int m104dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m104dp(22);
        int m104dp2 = ((int) (this.playProgress * f)) + AndroidUtilities.m104dp(22);
        int m104dp3 = ((int) (this.progressRight * f)) + AndroidUtilities.m104dp(22);
        if (motionEvent.getAction() == 0) {
            getParent().requestDisallowInterceptTouchEvent(true);
            if (this.mediaMetadataRetriever == null) {
                return false;
            }
            int m104dp4 = AndroidUtilities.m104dp(16);
            int m104dp5 = AndroidUtilities.m104dp(8);
            if (m104dp3 != m104dp && m104dp2 - m104dp5 <= x && x <= m104dp5 + m104dp2 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                invalidate();
                return true;
            } else if (m104dp - m104dp4 <= x && x <= Math.min(m104dp + m104dp4, m104dp3) && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                invalidate();
                return true;
            } else if (m104dp3 - m104dp4 <= x && x <= m104dp4 + m104dp3 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m104dp3);
                invalidate();
                return true;
            } else if (m104dp <= x && x <= m104dp3 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                this.pressedPlay = true;
                float m104dp6 = (x - AndroidUtilities.m104dp(16)) / f;
                this.playProgress = m104dp6;
                VideoTimelineViewDelegate videoTimelineViewDelegate5 = this.delegate;
                if (videoTimelineViewDelegate5 != null) {
                    videoTimelineViewDelegate5.onPlayProgressChanged(m104dp6);
                }
            ...
            if (this.pressedPlay) {
                float m104dp7 = (((int) (x - this.pressDx)) - AndroidUtilities.m104dp(16)) / f;
                this.playProgress = m104dp7;
                ...
                if (i < AndroidUtilities.m104dp(16)) {
                    m104dp3 = AndroidUtilities.m104dp(16);
                } else if (i <= m104dp3) {
                    m104dp3 = i;
                }
                float m104dp8 = (m104dp3 - AndroidUtilities.m104dp(16)) / f;
                this.progressLeft = m104dp8;
                float f4 = this.progressRight;
                float f5 = this.maxProgressDiff;
                if (f4 - m104dp8 > f5) {
                    this.progressRight = m104dp8 + f5;
                } else {
                    float f6 = this.minProgressDiff;
                    if (f6 != BitmapDescriptorFactory.HUE_RED && f4 - m104dp8 < f6) {
                        float f7 = f4 - f6;
                ...
                float m104dp9 = (m104dp - AndroidUtilities.m104dp(16)) / f;
                this.progressRight = m104dp9;
                float f11 = this.progressLeft;
                float f12 = this.maxProgressDiff;
                if (m104dp9 - f11 > f12) {
                    this.progressLeft = m104dp9 - f12;
                } else {
                    float f13 = this.minProgressDiff;
                    if (f13 != BitmapDescriptorFactory.HUE_RED && m104dp9 - f11 < f13) {
                        float f14 = f11 + f13;
    ...
    public void reloadFrames(int i) {
        ...
        if (i == 0) {
            this.frameHeight = AndroidUtilities.m104dp(38);
            float f = 1.0f;
            int i3 = this.videoWidth;
            if (i3 != 0 && (i2 = this.videoHeight) != 0) {
                f = i3 / i2;
            }
            this.framesToLoad = Math.max(1, (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m104dp(32)) / (this.frameHeight * Utilities.clamp(f, 1.3333334f, 0.5625f))));
            this.frameWidth = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m104dp(32)) / this.framesToLoad);
    ...
    */
    ...
    private void drawProgress(Canvas canvas, float f, float f2) {
        ...
        float m104dp2 = AndroidUtilities.m104dp(46) + m104dp;
        float f3 = ((m104dp2 - m104dp) / 2.0f) * (1.0f - f2);
        float f4 = m104dp + f3;
        float f5 = m104dp2 - f3;
        this.shadowPaint.setAlpha((int) (38.0f * f2));
        this.whitePaint.setAlpha((int) (f2 * 255.0f));
        float m104dp3 = dpf2 + AndroidUtilities.m104dp(10) + (((getMeasuredWidth() - (dpf2 * 2.0f)) - AndroidUtilities.m104dp(20)) * f);
        this.rect3.set(m104dp3 - AndroidUtilities.dpf2(1.5f), f4, AndroidUtilities.dpf2(1.5f) + m104dp3, f5);
        this.rect3.inset(-AndroidUtilities.dpf2(0.66f), -AndroidUtilities.dpf2(0.66f));
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), this.shadowPaint);
        this.rect3.set(m104dp3 - AndroidUtilities.dpf2(1.5f), f4, m104dp3 + AndroidUtilities.dpf2(1.5f), f5);
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), this.whitePaint);
    }
