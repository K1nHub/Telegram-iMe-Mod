...
public class Tooltip extends TextView {
    ...
    public Tooltip(Context context, ViewGroup viewGroup, int i, int i2) {
        ...
        setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(3), i));
        setTextColor(i2);
        setTextSize(1, 14.0f);
        setPadding(AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(7), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(7));
        setGravity(16);
    ...
    private void updateTooltipPosition() {
        ...
        if (width >= 0) {
            i = getMeasuredWidth() + width > view.getMeasuredWidth() ? (view.getMeasuredWidth() - getMeasuredWidth()) - AndroidUtilities.m107dp(16) : width;
        }
        setTranslationX(i);
