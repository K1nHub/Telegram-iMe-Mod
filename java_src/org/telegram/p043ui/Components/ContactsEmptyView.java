...
public class ContactsEmptyView extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ContactsEmptyView(Context context) {
        ...
        LoadingStickerDrawable loadingStickerDrawable = new LoadingStickerDrawable(this.stickerView, "m418 282.6c13.4-21.1 20.2-44.9 20.2-70.8 0-88.3-79.8-175.3-178.9-175.3-100.1 0-178.9 88-178.9 175.3 0 46.6 16.9 73.1 29.1 86.1-19.3 23.4-30.9 52.3-34.6 86.1-2.5 22.7 3.2 41.4 17.4 57.3 14.3 16 51.7 35 148.1 35 41.2 0 119.9-5.3 156.7-18.3 49.5-17.4 59.2-41.1 59.2-76.2 0-41.5-12.9-74.8-38.3-99.2z", AndroidUtilities.m107dp((int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS), AndroidUtilities.m107dp((int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS));
        ...
        this.titleTextView.setText(LocaleController.getString("NoContactsYet", C3632R.string.NoContactsYet));
        this.titleTextView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        this.titleTextView.setMaxWidth(AndroidUtilities.m107dp(260));
        ...
        while (true) {
            ...
            textView2.setMaxWidth(AndroidUtilities.m107dp(260));
            this.textViews.add(textView2);
            textView2.setGravity((LocaleController.isRTL ? 5 : 3) | 16);
            if (i == 0) {
                textView2.setText(LocaleController.getString("NoContactsYetLine1", C3632R.string.NoContactsYetLine1));
            } else if (i == 1) {
                textView2.setText(LocaleController.getString("NoContactsYetLine2", C3632R.string.NoContactsYetLine2));
            } else if (i == 2) {
                textView2.setText(LocaleController.getString("NoContactsYetLine3", C3632R.string.NoContactsYetLine3));
            }
