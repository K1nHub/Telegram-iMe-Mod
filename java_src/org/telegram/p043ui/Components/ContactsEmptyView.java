...
public class ContactsEmptyView extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ContactsEmptyView(Context context) {
        ...
        this.titleTextView.setText(LocaleController.getString("NoContactsYet", C3417R.string.NoContactsYet));
        ...
        while (true) {
            ...
            if (i == 0) {
                textView2.setText(LocaleController.getString("NoContactsYetLine1", C3417R.string.NoContactsYetLine1));
            } else if (i == 1) {
                textView2.setText(LocaleController.getString("NoContactsYetLine2", C3417R.string.NoContactsYetLine2));
            } else if (i == 2) {
                textView2.setText(LocaleController.getString("NoContactsYetLine3", C3417R.string.NoContactsYetLine3));
            }
