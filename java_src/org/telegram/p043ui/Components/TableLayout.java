...
public class TableLayout extends View {
    ...
    public class Child {
        ...
        */
        ...
        public int getTextX() {
            return this.f1863x + this.textX;
        }

        public int getTextY() {
            return this.f1864y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view) {
            ...
            boolean z = false;
            boolean z2 = true;
            boolean z3 = this.f1863x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
            boolean z4 = this.f1864y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
            int m72dp = AndroidUtilities.m72dp(3);
            if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                if (this.f1863x != 0 || this.f1864y != 0) {
                ...
                if (z2) {
                    TableLayout.this.rect.set(this.f1863x, this.f1864y, i5 + this.measuredWidth, i6 + this.measuredHeight);
                    ...
                    canvas.drawRect(this.f1863x, this.f1864y, i3 + this.measuredWidth, i4 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                } else {
                    canvas.drawRect(this.f1863x, this.f1864y, i + this.measuredWidth, i2 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                }
            }
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i10 == 0) {
                    ...
                    canvas.drawLine(i10 - strokeWidth2, this.f1864y, i10 - strokeWidth2, i7 + this.measuredHeight, linePaint2);
                }
                int i13 = this.f1864y;
                if (i13 == 0) {
                    int i14 = this.f1863x;
                    ...
                    canvas.drawLine(this.f1863x, i13 - strokeWidth2, i8 + this.measuredWidth, i13 - strokeWidth2, linePaint2);
                }
                float f12 = (z3 && (i9 = this.f1864y) == 0) ? i9 + m72dp : this.f1864y - strokeWidth;
                if (z3 && z4) {
                    f = (this.f1864y + this.measuredHeight) - m72dp;
                } else {
                    f = (this.f1864y + this.measuredHeight) - strokeWidth;
                }
                float f13 = f;
                int i16 = this.f1863x;
            ...
            if (childAt.cell != null) {
                ...
                if (childAt.fixedHeight != 0 && childAt.fixedHeight != sizeInCell2 && childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min <= 1) {
                    ...
                    while (true) {
                        ...
                        if (point.f1806x <= childAt.layoutParams.rowSpec.span.min && point.f1807y > childAt.layoutParams.rowSpec.span.min) {
                            z2 = true;
                            break;
                        }
                        i17++;
