...
public class TableLayout extends View {
    ...
    public class Child {
        ...
        */
        ...
        public int getTextX() {
            return this.f1970x + this.textX;
        }

        public int getTextY() {
            return this.f1971y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view) {
            ...
            boolean z = false;
            boolean z2 = true;
            boolean z3 = this.f1970x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
            boolean z4 = this.f1971y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
            ...
            if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                if (this.f1970x != 0 || this.f1971y != 0) {
                ...
                if (z2) {
                    TableLayout.this.rect.set(this.f1970x, this.f1971y, i5 + this.measuredWidth, i6 + this.measuredHeight);
                    ...
                    canvas.drawRect(this.f1970x, this.f1971y, i3 + this.measuredWidth, i4 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                } else {
                    canvas.drawRect(this.f1970x, this.f1971y, i + this.measuredWidth, i2 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                }
            }
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i10 == 0) {
                    ...
                    canvas.drawLine(i10 - strokeWidth2, this.f1971y, i10 - strokeWidth2, i7 + this.measuredHeight, linePaint2);
                }
                int i13 = this.f1971y;
                if (i13 == 0) {
                    int i14 = this.f1970x;
                    ...
                    canvas.drawLine(this.f1970x, i13 - strokeWidth2, i8 + this.measuredWidth, i13 - strokeWidth2, linePaint2);
                }
                float f12 = (z3 && (i9 = this.f1971y) == 0) ? i9 + m107dp : this.f1971y - strokeWidth;
                if (z3 && z4) {
                    f = (this.f1971y + this.measuredHeight) - m107dp;
                } else {
                    f = (this.f1971y + this.measuredHeight) - strokeWidth;
                }
                float f13 = f;
                int i16 = this.f1970x;
                ...
                int i18 = this.f1970x;
                float f14 = (i18 == 0 && z4) ? i18 + m107dp : i18 - strokeWidth;
                if (z3 && z4) {
                    f2 = (i18 + this.measuredWidth) - m107dp;
                } else {
    ...
    public TableLayout(Context context, TableLayoutDelegate tableLayoutDelegate, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper) {
        ...
        this.itemPaddingTop = AndroidUtilities.m107dp(7);
        this.itemPaddingLeft = AndroidUtilities.m107dp(8);
            ...
            if (childAt.cell != null) {
                ...
                if (childAt.fixedHeight != 0 && childAt.fixedHeight != sizeInCell2 && childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min <= 1) {
                    ...
                    while (true) {
                        ...
                        if (point.f1899x <= childAt.layoutParams.rowSpec.span.min && point.f1900y > childAt.layoutParams.rowSpec.span.min) {
                            z2 = true;
                            break;
                        }
                        i17++;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        static {
            Interval interval = new Interval(Integer.MIN_VALUE, C0483C.RATE_UNSET_INT);
