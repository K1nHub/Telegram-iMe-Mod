...
public class AttachBotIntroTopView extends View {
    ...
    public AttachBotIntroTopView(Context context) {
        ...
        this.attachDrawable = ContextCompat.getDrawable(context, C3632R.C3634drawable.input_attach).mutate().getConstantState().newDrawable();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        rectF.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), getHeight() + AndroidUtilities.m107dp(10));
        canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(10), AndroidUtilities.m107dp(10), this.backgroundPaint);
        this.imageReceiver.setImageCoords((getWidth() / 2.0f) - AndroidUtilities.m107dp(66), (getHeight() / 2.0f) - (AndroidUtilities.m107dp(42) / 2.0f), AndroidUtilities.m107dp(42), AndroidUtilities.m107dp(42));
        this.imageReceiver.draw(canvas);
        canvas.drawLine((getWidth() / 2.0f) - AndroidUtilities.m107dp(8), getHeight() / 2.0f, (getWidth() / 2.0f) + AndroidUtilities.m107dp(8), getHeight() / 2.0f, this.paint);
        canvas.drawLine(getWidth() / 2.0f, (getHeight() / 2.0f) - AndroidUtilities.m107dp(8), getWidth() / 2.0f, (getHeight() / 2.0f) + AndroidUtilities.m107dp(8), this.paint);
        this.attachDrawable.setBounds((getWidth() / 2) + AndroidUtilities.m107dp(24), (getHeight() / 2) - (AndroidUtilities.m107dp(42) / 2), (getWidth() / 2) + AndroidUtilities.m107dp(66), (getHeight() / 2) + (AndroidUtilities.m107dp(42) / 2));
