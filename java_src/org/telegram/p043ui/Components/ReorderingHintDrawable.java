...
public class ReorderingHintDrawable extends Drawable {
    ...
    private final int intrinsicWidth = AndroidUtilities.m104dp(24);
    private final int intrinsicHeight = AndroidUtilities.m104dp(24);
    ...
    private void drawStage1(Canvas canvas, float f) {
        ...
        this.tempRect.left = (int) (AndroidUtilities.m104dp(2) * this.scaleX);
        this.tempRect.bottom = bounds.bottom - ((int) (AndroidUtilities.m104dp(6) * this.scaleY));
        Rect rect = this.tempRect;
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m104dp(4) * this.scaleY));
        ...
        rect3.bottom = m104dp2;
        rect3.top = m104dp2;
        this.tempRect.inset(-AndroidUtilities.m104dp(AndroidUtilities.lerp(10, 11, interpolation)), -AndroidUtilities.m104dp(AndroidUtilities.lerp(2, 3, interpolation)));
    ...
    private void drawStage2(Canvas canvas, float f) {
        ...
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m104dp(4) * this.scaleY));
        this.tempRect.offset(0, AndroidUtilities.m104dp(AndroidUtilities.lerp(0, -8, interpolation)));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
    ...
    private void drawStage3(Canvas canvas, float f) {
        ...
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m104dp(4) * this.scaleY));
        this.tempRect.offset(0, AndroidUtilities.m104dp(-8));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
