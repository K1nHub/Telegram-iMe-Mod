...
public class EditTextCaption extends EditTextBoldCursor {
    ...
    public void makeSelectedUrl(String str, final FormattingTextController formattingTextController) {
        ...
        if (marginLayoutParams2 != null) {
            ...
            marginLayoutParams2.leftMargin = m107dp2;
            marginLayoutParams2.rightMargin = m107dp2;
            marginLayoutParams2.height = AndroidUtilities.m107dp(36);
    ...
    public void onMeasure(int i, int i2) {
        ...
        try {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(51));
            FileLog.m102e(e);
        }
        ...
        try {
            ...
            this.yOffset = ((getMeasuredHeight() - this.captionLayout.getLineBottom(0)) / 2) + AndroidUtilities.m108dp(0.5f);
        } catch (Exception e2) {
            FileLog.m102e(e2);
        }
    }
