...
public class ChatAttachAlertPhotoLayoutPreview extends ChatAttachAlert.AttachAlertLayout {
    ...
    public ChatAttachAlertPhotoLayoutPreview(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.header.setCompoundDrawablePadding(AndroidUtilities.m104dp(4));
        this.header.setPadding(0, 0, AndroidUtilities.m104dp(10), 0);
        ...
        this.listView.setPadding(0, 0, 0, AndroidUtilities.m104dp(46));
        ...
        undoView.setEnterOffsetMargin(AndroidUtilities.m104dp(32));
    ...
    public /* synthetic */ void lambda$onShow$0(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        ...
        if (currentItemTop > AndroidUtilities.m104dp(7)) {
    ...
    public int getCurrentItemTop() {
        ...
        if (top < AndroidUtilities.m104dp(8) || holder == null || holder.getAdapterPosition() != 0) {
            top = m104dp;
        }
    ...
    */
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (themeDelegate != null && (wallpaperDrawable = themeDelegate.getWallpaperDrawable()) != null) {
            ...
            if (currentItemTop < C3704ActionBar.getCurrentActionBarHeight()) {
                currentItemTop -= AndroidUtilities.m105dp((1.0f - (currentItemTop / C3704ActionBar.getCurrentActionBarHeight())) * i);
            }
    ...
    public class PreviewGroupsView extends ViewGroup {
        ...
        public PreviewGroupsView(Context context) {
            ...
            this.paddingTop = AndroidUtilities.m104dp(16);
            this.paddingBottom = AndroidUtilities.m104dp(64);
            ...
            this.scroller = new Runnable() { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.2
                ...
                public void run() {
                    ...
                    float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - Math.max(0, computeVerticalScrollOffset - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding())) - AndroidUtilities.m104dp(52));
                    float max2 = Math.max((float) BitmapDescriptorFactory.HUE_RED, ((ChatAttachAlertPhotoLayoutPreview.this.listView.getMeasuredHeight() - (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - computeVerticalScrollOffset)) - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) - AndroidUtilities.m104dp(84));
                    float m104dp2 = AndroidUtilities.m104dp(32);
                    if (max < m104dp2 && computeVerticalScrollOffset > ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) {
                        m104dp = (-(1.0f - (max / m104dp2))) * AndroidUtilities.m104dp(6);
                    } else {
                        m104dp = max2 < m104dp2 ? AndroidUtilities.m104dp(6) * (1.0f - (max2 / m104dp2)) : 0.0f;
                    }
                    int i = (int) m104dp;
                    if (Math.abs(i) > 0 && ChatAttachAlertPhotoLayoutPreview.this.listView.canScrollVertically(i) && (m104dp <= BitmapDescriptorFactory.HUE_RED || !z)) {
                        ChatAttachAlertPhotoLayoutPreview.access$1416(ChatAttachAlertPhotoLayoutPreview.this, m104dp);
        ...
        private int measureHeight() {
            return Math.max(measurePureHeight(), (AndroidUtilities.displaySize.y - C3704ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m104dp(45));
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                ...
                canvas.translate(dragTranslate.f1892x, dragTranslate.f1893y);
        ...
        Point dragTranslate() {
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                if (!ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding) {
                    ...
                    this.tmpPoint.f1892x = AndroidUtilities.lerp(rect2.left + (rect.width() / 2.0f), ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchX - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellLeft - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromWidth), this.draggingT);
                    this.tmpPoint.f1893y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1824y + rect2.top + (rect.height() / 2.0f), (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellTop - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromHeight)) + ChatAttachAlertPhotoLayoutPreview.this.draggingCellGroupY, this.draggingT);
                } else {
                    ...
                    this.tmpPoint.f1892x = AndroidUtilities.lerp(rect4.left + (rect3.width() / 2.0f), this.savedDragFromX, this.draggingT / this.savedDraggingT);
                    this.tmpPoint.f1893y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1824y + rect4.top + (rect3.height() / 2.0f), this.savedDragFromY, this.draggingT / this.savedDraggingT);
                }
                return this.tmpPoint;
            }
            Point point = this.tmpPoint;
            point.f1892x = BitmapDescriptorFactory.HUE_RED;
            point.f1893y = BitmapDescriptorFactory.HUE_RED;
            return point;
        }
        ...
        void stopDragging() {
            ...
            this.savedDragFromX = dragTranslate.f1892x;
            this.savedDragFromY = dragTranslate.f1893y;
        ...
        void startDragging(PreviewGroupCell.MediaCell mediaCell) {
            ...
            ChatAttachAlertPhotoLayoutPreview chatAttachAlertPhotoLayoutPreview = ChatAttachAlertPhotoLayoutPreview.this;
            chatAttachAlertPhotoLayoutPreview.draggingCellGroupY = chatAttachAlertPhotoLayoutPreview.draggingCell.groupCell.f1824y;
            ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding = false;
            this.draggingT = BitmapDescriptorFactory.HUE_RED;
            invalidate();
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator != null) {
            ...
            public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC$FileLocation tLRPC$FileLocation, int i, boolean z) {
                ...
                if (i >= 0 && i < this.photos.size() && isPhotoChecked(i) && (photoEntry = this.photos.get(i)) != null) {
                    ...
                    if (previewGroupCell != null && mediaCell != null) {
                        ...
                        placeProviderObject.viewY = iArr[1] + ((int) previewGroupCell.f1824y);
        ...
        */
        ...
        public class PreviewGroupCell {
            ...
            private PreviewGroupCell() {
                this.f1824y = BitmapDescriptorFactory.HUE_RED;
                this.indexStart = 0;
                ...
                this.padding = AndroidUtilities.m104dp(4);
                int m104dp = AndroidUtilities.m104dp(2);
                this.gap = m104dp;
                this.halfGap = m104dp / 2;
            ...
            public class MediaCell {
                ...
                public void layout(GroupCalculator groupCalculator, MessageObject.GroupedMessagePosition groupedMessagePosition, boolean z) {
                    ...
                    float m104dp2 = AndroidUtilities.m104dp(SharedConfig.bubbleRadius - 1);
                    RectF rectF4 = this.roundRadiuses;
                    int i2 = this.positionFlags;
                    float f7 = (i2 & 5) == 5 ? m104dp2 : m104dp;
                    float f8 = (i2 & 6) == 6 ? m104dp2 : m104dp;
                    float f9 = (i2 & 10) == 10 ? m104dp2 : m104dp;
                    if ((i2 & 9) == 9) {
                        m104dp = m104dp2;
                    }
                    rectF4.set(f7, f8, f9, m104dp);
                    if (this.fromRect == null) {
                ...
                private void drawPhotoIndex(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    int m105dp = AndroidUtilities.m105dp(1.2f);
                    int i = (m104dp + m105dp) * 2;
                    int i2 = m105dp * 4;
                    if (str != null && (this.indexBitmap == null || (str2 = this.indexBitmapText) == null || !str2.equals(str))) {
                        ...
                        this.textPaint.setTextSize(AndroidUtilities.m105dp(f5));
                        float f6 = i / 2.0f;
                        ...
                        this.strokePaint.setStrokeWidth(m105dp);
                        canvas2.drawCircle(f7, f7, f8, this.strokePaint);
                        canvas2.drawText(str, f6 - (this.textPaint.measureText(str) / 2.0f), f6 + AndroidUtilities.m104dp(1) + AndroidUtilities.m105dp(f5 / 4.0f), this.textPaint);
                ...
                private void drawDuration(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    if (str != null) {
                        if (this.videoDurationBitmap == null || (str2 = this.videoDurationBitmapText) == null || !str2.equals(str)) {
                            ...
                            this.videoDurationTextPaint.setTextSize(m104dp);
                            float intrinsicWidth = ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + this.videoDurationTextPaint.measureText(str) + AndroidUtilities.m104dp(15);
                            float max = Math.max(m104dp, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + AndroidUtilities.m104dp(4));
                            ...
                            canvas2.drawRoundRect(rectF, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), Theme.chat_timeBackgroundPaint);
                            int m104dp2 = AndroidUtilities.m104dp(5);
                            int intrinsicHeight = (int) ((max - ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight()) / 2.0f);
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.setBounds(m104dp2, intrinsicHeight, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + m104dp2, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + intrinsicHeight);
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.draw(canvas2);
                            canvas2.drawText(str, AndroidUtilities.m104dp(18), m104dp + AndroidUtilities.m105dp(-0.7f), this.videoDurationTextPaint);
