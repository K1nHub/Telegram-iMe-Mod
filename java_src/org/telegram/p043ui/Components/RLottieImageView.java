...
public class RLottieImageView extends ImageView {
    ...
    public void setAnimation(int i, int i2, int i3, int[] iArr) {
        setAnimation(new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(i2), AndroidUtilities.m107dp(i3), false, iArr));
    }
    ...
    public void setAnimation(TLRPC$Document tLRPC$Document, final int i, final int i2) {
        ...
        setImageDrawable(new Drawable() { // from class: org.telegram.ui.Components.RLottieImageView.2
            ...
            public void draw(Canvas canvas) {
                ...
                rect.set(getBounds().centerX() - (AndroidUtilities.m107dp(i) / 2), getBounds().centerY() - (AndroidUtilities.m107dp(i2) / 2), getBounds().centerX() + (AndroidUtilities.m107dp(i) / 2), getBounds().centerY() + (AndroidUtilities.m107dp(i2) / 2));
