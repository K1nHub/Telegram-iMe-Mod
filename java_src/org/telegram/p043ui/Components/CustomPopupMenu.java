...
public abstract class CustomPopupMenu {
    ...
    public CustomPopupMenu(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, C3419R.C3421drawable.popup_fixed_alert2, resourcesProvider, z ? 1 : 0);
        ...
        this.popupWindow.setAnimationStyle(C3419R.style.PopupContextAnimation2);
