...
public class ReactedHeaderView extends FrameLayout {
    ...
    public static class UserSeen {
        ...
        public UserSeen(TLObject tLObject, int i) {
            ...
            if (tLObject instanceof TLRPC$User) {
                this.dialogId = ((TLRPC$User) tLObject).f1751id;
            } else if (tLObject instanceof TLRPC$Chat) {
                this.dialogId = -((TLRPC$Chat) tLObject).f1602id;
            }
        }
    }
    ...
    public /* synthetic */ void lambda$onAttachedToWindow$5(long j, TLRPC$Chat tLRPC$Chat, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject instanceof TLRPC$Vector) {
            ...
            if (ChatObject.isChannel(tLRPC$Chat)) {
                ...
                tLRPC$TL_channels_getParticipants.channel = MessagesController.getInstance(this.currentAccount).getInputChannel(tLRPC$Chat.f1602id);
    ...
    public /* synthetic */ void lambda$onAttachedToWindow$1(TLObject tLObject, List list, List list2, List list3, Runnable runnable) {
        if (tLObject != null) {
            ...
            for (int i = 0; i < tLRPC$TL_channels_channelParticipants.users.size(); i++) {
                ...
                int indexOf = list.indexOf(Long.valueOf(tLRPC$User.f1751id));
    ...
    public /* synthetic */ void lambda$loadReactions$6(int i, TLRPC$TL_messages_messageReactionsList tLRPC$TL_messages_messageReactionsList) {
        ...
        while (it.hasNext()) {
            ...
            TLRPC$Peer tLRPC$Peer = this.message.messageOwner.from_id;
            if (tLRPC$Peer != null && next.f1751id != tLRPC$Peer.user_id) {
                int i2 = 0;
                while (true) {
                    if (i2 >= this.users.size()) {
                        z3 = false;
                        break;
                    } else if (this.users.get(i2).dialogId == next.f1751id) {
                        z3 = true;
                        break;
                    } else {
                        i2++;
        ...
        while (it2.hasNext()) {
            ...
            if (tLRPC$Peer2 != null && next2.f1602id != tLRPC$Peer2.user_id) {
                int i3 = 0;
                while (true) {
                    if (i3 >= this.users.size()) {
                        z2 = false;
                        break;
                    } else if (this.users.get(i3).dialogId == (-next2.f1602id)) {
                        z2 = true;
                        break;
                    } else {
                        i3++;
    ...
    */
    private void updateView() {
        ...
        L39:
            ...
            goto L55
        L49:
            int r0 = org.telegram.messenger.AndroidUtilities.m107dp(r4)
            goto L54
        L4e:
            r0 = 24
        ...
        L60:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.ReactedHeaderView.updateView():void");
    }
