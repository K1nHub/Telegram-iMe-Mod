...
public class SpoilerEffect2 {
    ...
    public class SpoilerThread extends Thread {
        ...
        private void init() {
            ...
            if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
                ...
                if (eglCreateWindowSurface == null) {
                    ...
                    if (iArr[0] == 0) {
                        FileLog.m104e("SpoilerEffect2, compile vertex shader error: " + GLES31.glGetShaderInfoLog(glCreateShader));
                    ...
                    if (iArr[0] == 0) {
                        FileLog.m104e("SpoilerEffect2, compile fragment shader error: " + GLES31.glGetShaderInfoLog(glCreateShader2));
                    ...
                    if (iArr[0] == 0) {
                        FileLog.m104e("SpoilerEffect2, link draw program error: " + GLES31.glGetProgramInfoLog(this.drawProgram));
                        this.running = false;
                        return;
                    }
        ...
        private void drawFrame(float f) {
            ...
            float f2 = 0.65f * f;
            float f3 = this.f1985t + f2;
            this.f1985t = f3;
            if (f3 > 1000.0f) {
                this.f1985t = BitmapDescriptorFactory.HUE_RED;
            }
            ...
            GLES31.glVertexAttribPointer(3, 1, 5126, false, 24, 20);
            GLES31.glEnableVertexAttribArray(3);
            GLES31.glUniform1f(this.timeHandle, this.f1985t);
        ...
        private void checkGlErrors() {
            while (true) {
                ...
                FileLog.m104e("spoiler gles error " + glGetError);
            }
        }
    }
}
