...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, final BaseFragment baseFragment, final TLRPC$ChatFull tLRPC$ChatFull, long j, boolean z2) {
        ...
        int i2 = C3473R.raw.shared_link_enter;
        ...
        textView.setText(LocaleController.getString("InviteLink", C3473R.string.InviteLink));
        ...
        if (z2) {
            i = C3473R.string.LinkInfoChannel;
            str = "LinkInfoChannel";
        } else {
            i = C3473R.string.LinkInfo;
            str = "LinkInfo";
        }
        ...
        textView3.setText(LocaleController.getString("ManageInviteLinks", C3473R.string.ManageInviteLinks));
    ...
    public /* synthetic */ void lambda$new$2(TLRPC$ChatFull tLRPC$ChatFull, BaseFragment baseFragment, View view) {
        ManageLinksActivity manageLinksActivity = new ManageLinksActivity(tLRPC$ChatFull.f1523id, 0L, 0);
    ...
    public /* synthetic */ void lambda$generateLink$3(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, boolean z) {
        if (tLRPC$TL_error == null) {
            ...
            if (z && this.fragment != null) {
                ...
                builder.setMessage(LocaleController.getString("RevokeAlertNewLink", C3473R.string.RevokeAlertNewLink));
