...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, final BaseFragment baseFragment, final TLRPC$ChatFull tLRPC$ChatFull, long j, boolean z2) {
        ...
        int i2 = C3419R.raw.shared_link_enter;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m72dp(90), AndroidUtilities.m72dp(90), false, null);
        ...
        textView.setText(LocaleController.getString("InviteLink", C3419R.string.InviteLink));
        ...
        if (z2) {
            i = C3419R.string.LinkInfoChannel;
            str = "LinkInfoChannel";
        } else {
            i = C3419R.string.LinkInfo;
            str = "LinkInfo";
        }
        ...
        textView3.setText(LocaleController.getString("ManageInviteLinks", C3419R.string.ManageInviteLinks));
        ...
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m72dp(8), 0, ColorUtils.setAlphaComponent(Theme.getColor(i3), 120)));
    ...
    public /* synthetic */ void lambda$new$2(TLRPC$ChatFull tLRPC$ChatFull, BaseFragment baseFragment, View view) {
        ManageLinksActivity manageLinksActivity = new ManageLinksActivity(tLRPC$ChatFull.f1519id, 0L, 0);
    ...
    public /* synthetic */ void lambda$generateLink$3(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, boolean z) {
        if (tLRPC$TL_error == null) {
            ...
            if (z && this.fragment != null) {
                ...
                builder.setMessage(LocaleController.getString("RevokeAlertNewLink", C3419R.string.RevokeAlertNewLink));
    ...
    public void updateColors() {
        ...
        int m72dp = AndroidUtilities.m72dp(90);
        int i = Theme.key_featuredStickers_addButton;
        rLottieImageView.setBackground(Theme.createCircleDrawable(m72dp, Theme.getColor(i)));
        this.manage.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m72dp(8), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), 120)));
