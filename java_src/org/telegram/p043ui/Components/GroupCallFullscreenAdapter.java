...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public void scrollTo(ChatObject.VideoParticipant videoParticipant, RecyclerListView recyclerListView) {
        ...
        for (int i = 0; i < this.videoParticipants.size(); i++) {
            if (this.videoParticipants.get(i).equals(videoParticipant)) {
                linearLayoutManager.scrollToPositionWithOffset(i, AndroidUtilities.m104dp(13));
                return;
            }
        }
    }
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        public GroupCallUserCell(Context context) {
            ...
            this.avatarWavesDrawable = new GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.m104dp(26), AndroidUtilities.m104dp(29));
            this.avatarDrawable.setTextSize((int) (AndroidUtilities.m104dp(18) / 1.15f));
            ...
            this.selectionPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.name != null) {
                int min = (int) Math.min(AndroidUtilities.m104dp(46), this.textPaint.measureText(this.name));
                this.nameWidth = min;
                this.drawingName = TextUtils.ellipsize(this.name, this.textPaint, min, TextUtils.TruncateAt.END).toString();
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(80), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(80), 1073741824));
        }
        ...
        public void setProgressToFullscreen(float f) {
            ...
            float f2 = 1.0f - f;
            float m104dp = ((AndroidUtilities.m104dp(46) / AndroidUtilities.m104dp(40)) * f2) + (1.0f * f);
            this.avatarImageView.setTranslationY((-top) * f2);
            this.avatarImageView.setScaleX(m104dp);
            this.avatarImageView.setScaleY(m104dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.progress > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(13), this.backgroundPaint);
                drawSelection(canvas);
            }
            ...
            float m104dp = AndroidUtilities.m104dp(46) / AndroidUtilities.m104dp(40);
            float f = this.progress;
            float f2 = (m104dp * (1.0f - f)) + (f * 1.0f);
        ...
        */
        ...
        public void drawOverlays(Canvas canvas) {
            if (this.drawingName != null) {
                canvas.save();
                int measuredWidth = ((getMeasuredWidth() - this.nameWidth) - AndroidUtilities.m104dp(24)) / 2;
                this.textPaint.setAlpha((int) (this.progress * 255.0f * getAlpha()));
                canvas.drawText(this.drawingName, AndroidUtilities.m104dp(22) + measuredWidth, AndroidUtilities.m104dp(69), this.textPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(measuredWidth, AndroidUtilities.m104dp(53));
