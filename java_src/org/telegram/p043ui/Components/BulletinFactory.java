...
public final class BulletinFactory {
    ...
    public static final class FileType {
        ...
        static {
            int i = C3419R.string.PhotoSavedHint;
            ...
            PHOTOS = fileType2;
            FileType fileType3 = new FileType("VIDEO", 2, "VideoSavedHint", C3419R.string.VideoSavedHint, icon);
            VIDEO = fileType3;
            FileType fileType4 = new FileType("VIDEOS", 3, "VideosSavedHint", icon);
            VIDEOS = fileType4;
            FileType fileType5 = new FileType("MEDIA", 4, "MediaSavedHint", icon);
            MEDIA = fileType5;
            int i2 = C3419R.string.PhotoSavedToDownloadsHint;
            ...
            FileType fileType7 = new FileType("VIDEO_TO_DOWNLOADS", 6, "VideoSavedToDownloadsHint", C3419R.string.VideoSavedToDownloadsHint, icon2);
            VIDEO_TO_DOWNLOADS = fileType7;
            FileType fileType8 = new FileType("GIF", 7, "GifSavedHint", C3419R.string.GifSavedHint, Icon.SAVED_TO_GIFS);
            GIF = fileType8;
            FileType fileType9 = new FileType("GIF_TO_DOWNLOADS", 8, "GifSavedToDownloadsHint", C3419R.string.GifSavedToDownloadsHint, icon2);
            GIF_TO_DOWNLOADS = fileType9;
            int i3 = C3419R.string.AudioSavedHint;
            ...
            AUDIOS = fileType11;
            FileType fileType12 = new FileType("UNKNOWN", 11, "FileSavedHint", C3419R.string.FileSavedHint, icon2);
            UNKNOWN = fileType12;
        ...
        /* loaded from: classes6.dex */
        public enum Icon {
            SAVED_TO_DOWNLOADS(C3419R.raw.ic_download, 2, "Box", "Arrow"),
            SAVED_TO_GALLERY(C3419R.raw.ic_save_to_gallery, 0, "Box", "Arrow", "Mask", "Arrow 2", "Splash"),
            SAVED_TO_MUSIC(C3419R.raw.ic_save_to_music, 2, "Box", "Arrow"),
            SAVED_TO_GIFS(C3419R.raw.ic_save_to_gifs, 0, "gif");
    ...
    public Bulletin createUndoBulletin(CharSequence charSequence, Runnable runnable, Runnable runnable2) {
        ...
        lottieLayout.setButton(new Bulletin.UndoButton(getContext(), true, this.resourcesProvider).setText(LocaleController.getString("Undo", C3419R.string.Undo)).setUndoAction(runnable).setDelayedAction(runnable2));
    ...
    public Bulletin createUsersBulletin(List<TLRPC$User> list, CharSequence charSequence, CharSequence charSequence2, UndoObject undoObject) {
        ...
        if (undoObject != null) {
            usersLayout.setButton(new Bulletin.UndoButton(getContext(), true, this.resourcesProvider).setText(LocaleController.getString("Undo", C3419R.string.Undo)).setUndoAction(undoObject.onUndo).setDelayedAction(undoObject.onAction));
        }
    ...
    public Bulletin createUsersAddedBulletin(ArrayList<TLRPC$User> arrayList, TLRPC$Chat tLRPC$Chat) {
        ...
        if (arrayList == null || arrayList.size() == 0) {
            ...
            if (ChatObject.isChannelAndNotMegaGroup(tLRPC$Chat)) {
                int i = C3419R.string.HasBeenAddedToChannel;
                ...
                int i2 = C3419R.string.HasBeenAddedToGroup;
    ...
    public Bulletin createContainsEmojiBulletin(TLRPC$Document tLRPC$Document, final int i, final Utilities.Callback<TLRPC$InputStickerSet> callback) {
        ...
        if (stickerSet == null || (tLRPC$StickerSet = stickerSet.set) == null) {
            if (i == 1) {
                spannableStringBuilder = new SpannableStringBuilder(AndroidUtilities.replaceTags(LocaleController.formatString("TopicContainsEmojiPackSingle", C3419R.string.TopicContainsEmojiPackSingle, "<{LOADING}>")));
            } else if (i == 2) {
                spannableStringBuilder = new SpannableStringBuilder(AndroidUtilities.replaceTags(LocaleController.formatString("StoryContainsEmojiPackSingle", C3419R.string.StoryContainsEmojiPackSingle, "<{LOADING}>")));
            } else {
                spannableStringBuilder = new SpannableStringBuilder(AndroidUtilities.replaceTags(LocaleController.formatString("MessageContainsEmojiPackSingle", C3419R.string.MessageContainsEmojiPackSingle, "<{LOADING}>")));
            }
            ...
            final Bulletin createEmojiLoadingBulletin = createEmojiLoadingBulletin(tLRPC$Document, spannableStringBuilder, LocaleController.getString("ViewAction", C3419R.string.ViewAction), new Runnable() { // from class: org.telegram.ui.Components.BulletinFactory$$ExternalSyntheticLambda1
        ...
        return createEmojiBulletin(tLRPC$Document, i == 1 ? AndroidUtilities.replaceTags(LocaleController.formatString("TopicContainsEmojiPackSingle", C3419R.string.TopicContainsEmojiPackSingle, tLRPC$StickerSet.title)) : i == 2 ? AndroidUtilities.replaceTags(LocaleController.formatString("StoryContainsEmojiPackSingle", C3419R.string.StoryContainsEmojiPackSingle, tLRPC$StickerSet.title)) : AndroidUtilities.replaceTags(LocaleController.formatString("MessageContainsEmojiPackSingle", C3419R.string.MessageContainsEmojiPackSingle, tLRPC$StickerSet.title)), LocaleController.getString("ViewAction", C3419R.string.ViewAction), new Runnable() { // from class: org.telegram.ui.Components.BulletinFactory$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Utilities.Callback.this.run(inputStickerSet);
            }
    ...
    public static /* synthetic */ void lambda$createContainsEmojiBulletin$2(int i, final Bulletin bulletin, long j, TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet) {
        ...
        if (tLRPC$TL_messages_stickerSet == null || (tLRPC$StickerSet = tLRPC$TL_messages_stickerSet.set) == null) {
            string = LocaleController.getString("AddEmojiNotFound", C3419R.string.AddEmojiNotFound);
        } else {
            string = i == 1 ? AndroidUtilities.replaceTags(LocaleController.formatString("TopicContainsEmojiPackSingle", C3419R.string.TopicContainsEmojiPackSingle, tLRPC$StickerSet.title)) : i == 2 ? AndroidUtilities.replaceTags(LocaleController.formatString("StoryContainsEmojiPackSingle", C3419R.string.StoryContainsEmojiPackSingle, tLRPC$StickerSet.title)) : AndroidUtilities.replaceTags(LocaleController.formatString("MessageContainsEmojiPackSingle", C3419R.string.MessageContainsEmojiPackSingle, tLRPC$StickerSet.title));
        }
    ...
    public Bulletin createReportSent(Theme.ResourcesProvider resourcesProvider) {
        ...
        lottieLayout.setAnimation(C3419R.raw.chats_infotip, new String[0]);
        lottieLayout.textView.setText(LocaleController.getString("ReportChatSent", C3419R.string.ReportChatSent));
    ...
    public Bulletin createSuccessBulletin(CharSequence charSequence, Theme.ResourcesProvider resourcesProvider) {
        Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(getContext(), resourcesProvider);
        lottieLayout.setAnimation(C3419R.raw.contact_check, new String[0]);
        lottieLayout.textView.setText(charSequence);
        lottieLayout.textView.setSingleLine(false);
        lottieLayout.textView.setMaxLines(2);
        return create(lottieLayout, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    ...
    public Bulletin createCaptionLimitBulletin(int i, final Runnable runnable) {
        ...
        lottieLayout.setAnimation(C3419R.raw.caption_limit, new String[0]);
    ...
    public Bulletin createRestrictVoiceMessagesPremiumBulletin() {
        Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(getContext(), null);
        lottieLayout.setAnimation(C3419R.raw.voip_muted, new String[0]);
        String string = LocaleController.getString(C3419R.string.PrivacyVoiceMessagesPremiumOnly);
    ...
    public Bulletin createErrorBulletinSubtitle(CharSequence charSequence, CharSequence charSequence2, Theme.ResourcesProvider resourcesProvider) {
        ...
        twoLineLottieLayout.setAnimation(C3419R.raw.chats_infotip, new String[0]);
        twoLineLottieLayout.titleTextView.setText(charSequence);
        twoLineLottieLayout.subtitleTextView.setText(charSequence2);
    ...
    public Bulletin createCopyBulletin(String str, Theme.ResourcesProvider resourcesProvider) {
        ...
        Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(getContext(), null);
        lottieLayout.setAnimation(C3419R.raw.copy, 36, 36, "NULL ROTATION", "Back", "Front");
    ...
    public Bulletin createCopyLinkBulletin(boolean z, Theme.ResourcesProvider resourcesProvider) {
        if (AndroidUtilities.shouldShowClipboardToast()) {
            if (z) {
                Bulletin.TwoLineLottieLayout twoLineLottieLayout = new Bulletin.TwoLineLottieLayout(getContext(), resourcesProvider);
                twoLineLottieLayout.setAnimation(C3419R.raw.voip_invite, 36, 36, "Wibe", "Circle");
                twoLineLottieLayout.titleTextView.setText(LocaleController.getString("LinkCopied", C3419R.string.LinkCopied));
                twoLineLottieLayout.subtitleTextView.setText(LocaleController.getString("LinkCopiedPrivateInfo", C3419R.string.LinkCopiedPrivateInfo));
                return create(twoLineLottieLayout, 2750);
            }
            Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(getContext(), resourcesProvider);
            lottieLayout.setAnimation(C3419R.raw.voip_invite, 36, 36, "Wibe", "Circle");
            lottieLayout.textView.setText(LocaleController.getString("LinkCopied", C3419R.string.LinkCopied));
            return create(lottieLayout, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
        }
        return new Bulletin.EmptyBulletin();
    }
    ...
    */
    public static org.telegram.p043ui.Components.Bulletin createMuteBulletin(org.telegram.p043ui.ActionBar.BaseFragment r6, int r7, int r8, org.telegram.p043ui.ActionBar.Theme.ResourcesProvider r9) {
        /*
            ...
            r9 = 5
            if (r7 != r9) goto L2f
            int r7 = org.telegram.messenger.C3419R.string.NotificationsMutedForHint
        ...
        L2f:
            ...
            throw r6
        L35:
            int r7 = org.telegram.messenger.C3419R.string.NotificationsUnmutedHint
            ...
            goto L81
        L40:
            int r7 = org.telegram.messenger.C3419R.string.NotificationsMutedHint
        ...
        L81:
            if (r3 == 0) goto L8b
            int r8 = org.telegram.messenger.C3419R.raw.mute_for
            java.lang.String[] r9 = new java.lang.String[r2]
            r0.setAnimation(r8, r9)
            goto Lb2
        L8b:
            if (r8 == 0) goto La1
            int r8 = org.telegram.messenger.C3419R.raw.ic_mute
            ...
            goto Lb2
        La1:
            int r8 = org.telegram.messenger.C3419R.raw.ic_unmute
    ...
    public static Bulletin createMuteBulletin(BaseFragment baseFragment, boolean z, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z) {
            lottieLayout.setAnimation(C3419R.raw.ic_mute, "Body Main", "Body Top", "Line", "Curve Big", "Curve Small");
        } else {
            lottieLayout.setAnimation(C3419R.raw.ic_unmute, "BODY", "Wibe Big", "Wibe Big 3", "Wibe Small");
        }
    ...
    public static Bulletin createUnpinAllMessagesBulletin(BaseFragment baseFragment, int i, boolean z, Runnable runnable, Runnable runnable2, Theme.ResourcesProvider resourcesProvider) {
        ...
        Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(baseFragment.getParentActivity(), resourcesProvider);
        lottieLayout.setAnimation(C3419R.raw.ic_unpin, 28, 28, "Pin", "Line");
        lottieLayout.textView.setText(LocaleController.formatPluralString("MessagesUnpinned", i, new Object[0]));
        if (z) {
            lottieLayout.textView.setText(LocaleController.getInternalString(C3419R.string.pinned_messages_pin_panel_hidden_bulletin));
            lottieLayout.textView.setSingleLine(false);
            lottieLayout.textView.setMaxLines(2);
        }
    ...
    public static Bulletin createPromoteToAdminBulletin(BaseFragment baseFragment, String str) {
        ...
        lottieLayout.setAnimation(C3419R.raw.ic_admin, "Shield");
        lottieLayout.textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("UserSetAsAdminHint", C3419R.string.UserSetAsAdminHint, str)));
        return Bulletin.make(baseFragment, lottieLayout, (int) ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    }
    ...
    public static Bulletin createAddedAsAdminBulletin(BaseFragment baseFragment, String str) {
        Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(baseFragment.getParentActivity(), baseFragment.getResourceProvider());
        lottieLayout.setAnimation(C3419R.raw.ic_admin, "Shield");
        lottieLayout.textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("UserAddedAsAdminHint", C3419R.string.UserAddedAsAdminHint, str)));
        return Bulletin.make(baseFragment, lottieLayout, (int) ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    }
    ...
    */
    public static org.telegram.p043ui.Components.Bulletin createInviteSentBulletin(android.content.Context r4, android.widget.FrameLayout r5, int r6, long r7, int r9, int r10, int r11) {
        /*
            ...
            if (r6 != 0) goto L30
            int r4 = org.telegram.messenger.C3419R.string.InvLinkToSavedMessages
            ...
            int r6 = org.telegram.messenger.C3419R.raw.saved_messages
        ...
        L30:
            ...
            int r7 = org.telegram.messenger.C3419R.string.InvLinkToGroup
        ...
        L58:
            ...
            int r7 = org.telegram.messenger.C3419R.string.InvLinkToUser
            java.lang.Object[] r8 = new java.lang.Object[r10]
            ...
            android.text.SpannableStringBuilder r6 = org.telegram.messenger.AndroidUtilities.replaceTags(r6)
        L7a:
            int r7 = org.telegram.messenger.C3419R.raw.forward
            java.lang.String[] r8 = new java.lang.String[r0]
            r9.setAnimation(r7, r11, r11, r8)
            goto La1
        L82:
            int r7 = org.telegram.messenger.C3419R.string.InvLinkToChats
            java.lang.Object[] r8 = new java.lang.Object[r10]
    ...
    */
    ...
    public static Bulletin createRemoveFromChatBulletin(BaseFragment baseFragment, TLRPC$User tLRPC$User, String str) {
        String str2;
        Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(baseFragment.getParentActivity(), baseFragment.getResourceProvider());
        lottieLayout.setAnimation(C3419R.raw.ic_ban, "Hand");
        if (tLRPC$User.deleted) {
            str2 = LocaleController.formatString("HiddenName", C3419R.string.HiddenName, new Object[0]);
        } else {
            str2 = tLRPC$User.first_name;
        }
        lottieLayout.textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("UserRemovedFromChatHint", C3419R.string.UserRemovedFromChatHint, str2, str)));
        return Bulletin.make(baseFragment, lottieLayout, (int) ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    }
    ...
    public static Bulletin createBanBulletin(BaseFragment baseFragment, boolean z) {
        ...
        if (z) {
            lottieLayout.setAnimation(C3419R.raw.ic_ban, "Hand");
            string = LocaleController.getString("UserBlocked", C3419R.string.UserBlocked);
        } else {
            lottieLayout.setAnimation(C3419R.raw.ic_unban, "Main", "Finger 1", "Finger 2", "Finger 3", "Finger 4");
            string = LocaleController.getString("UserUnblocked", C3419R.string.UserUnblocked);
        }
    ...
    private static Bulletin createPinMessageBulletin(BaseFragment baseFragment, boolean z, Runnable runnable, Runnable runnable2, Theme.ResourcesProvider resourcesProvider, int i) {
        Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(baseFragment.getParentActivity(), resourcesProvider);
        lottieLayout.setAnimation(z ? C3419R.raw.ic_pin : C3419R.raw.ic_unpin, 28, 28, "Pin", "Line");
        if (z && i > 1) {
            lottieLayout.textView.setText(LocaleController.formatPluralStringInternal(C3419R.string.plural_messages_pinned, i));
        } else {
            lottieLayout.textView.setText(LocaleController.getString(z ? "MessagePinnedHint" : "MessageUnpinnedHint", z ? C3419R.string.MessagePinnedHint : C3419R.string.MessageUnpinnedHint));
        }
        if (!z) {
            lottieLayout.setButton(new Bulletin.UndoButton(baseFragment.getParentActivity(), true, resourcesProvider).setUndoAction(runnable).setDelayedAction(runnable2));
        }
    ...
    public static Bulletin createSoundEnabledBulletin(BaseFragment baseFragment, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        boolean z = true;
        if (i == 0) {
            string = LocaleController.getString("SoundOnHint", C3419R.string.SoundOnHint);
        } else if (i == 1) {
            string = LocaleController.getString("SoundOffHint", C3419R.string.SoundOffHint);
            z = false;
        } else {
            throw new IllegalArgumentException();
        }
        if (z) {
            lottieLayout.setAnimation(C3419R.raw.sound_on, new String[0]);
        } else {
            lottieLayout.setAnimation(C3419R.raw.sound_off, new String[0]);
        }
