...
public class BackgroundGradientDrawable extends GradientDrawable {
    ...
    public static class Sizes {
        ...
        /* renamed from: of */
        public static Sizes m64of(int i, int i2, int... iArr) {
        ...
        public static Sizes ofDeviceScreen(float f, Orientation orientation) {
            ...
            if (i == i2) {
                return m64of(i, i2, new int[0]);
            }
            if (orientation == Orientation.BOTH) {
                return m64of(i, i2, i2, i);
            }
            return (orientation == Orientation.PORTRAIT) == (i < i2) ? m64of(i, i2, new int[0]) : m64of(i2, i, new int[0]);
        }
    }
    ...
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C44972 {

        /* renamed from: $SwitchMap$android$graphics$drawable$GradientDrawable$Orientation */
        static final /* synthetic */ int[] f1813x8f1352bc;
        ...
        static {
            ...
            try {
                f1813x8f1352bc[GradientDrawable.Orientation.TR_BL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1813x8f1352bc[GradientDrawable.Orientation.RIGHT_LEFT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1813x8f1352bc[GradientDrawable.Orientation.BR_TL.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1813x8f1352bc[GradientDrawable.Orientation.BOTTOM_TOP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1813x8f1352bc[GradientDrawable.Orientation.BL_TR.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1813x8f1352bc[GradientDrawable.Orientation.LEFT_RIGHT.ordinal()] = 7;
    ...
    public static Rect getGradientPoints(GradientDrawable.Orientation orientation, int i, int i2) {
        Rect rect = new Rect();
        switch (C44972.f1813x8f1352bc[orientation.ordinal()]) {
            case 1:
                int i3 = i / 2;
                rect.left = i3;
                rect.top = 0;
