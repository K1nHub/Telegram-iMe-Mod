...
public class BotCommandsMenuView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        onTranslationChanged((this.menuTextLayout.getWidth() + AndroidUtilities.m104dp(4)) * this.expandProgress);
        int m104dp = AndroidUtilities.m104dp(40);
        if (this.expanded) {
            m104dp += this.menuTextLayout.getWidth() + AndroidUtilities.m104dp(4);
        }
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(m104dp, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(32), 1073741824));
    }
