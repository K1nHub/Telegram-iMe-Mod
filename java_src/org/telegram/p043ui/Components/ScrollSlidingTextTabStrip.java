...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView {
    ...
    public ScrollSlidingTextTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.tabsContainer.setPadding(AndroidUtilities.m107dp(7), 0, AndroidUtilities.m107dp(7), 0);
    ...
    protected void onMeasure(int i, int i2) {
        int size = View.MeasureSpec.getSize(i) - AndroidUtilities.m107dp(22);
        int childCount = this.tabsContainer.getChildCount();
    ...
    public void scrollToChild(int i, boolean z) {
        ...
        if (left - AndroidUtilities.m107dp(50) < scrollX) {
            if (z) {
                smoothScrollTo(left - AndroidUtilities.m107dp(50), 0);
                return;
            } else {
                scrollTo(left - AndroidUtilities.m107dp(50), 0);
                return;
            }
        }
        int i2 = left + measuredWidth;
        if (AndroidUtilities.m107dp(21) + i2 > scrollX + getWidth()) {
            if (z) {
                smoothScrollTo(i2, 0);
            } else {
                scrollTo(i2, 0);
    ...
    private int getChildWidth(TextView textView) {
        ...
        if (layout != null) {
            return ((int) Math.ceil(layout.getLineWidth(0))) + AndroidUtilities.m107dp(2);
        }
