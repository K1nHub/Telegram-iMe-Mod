...
import com.iMe.p030ui.common.SimpleTextWatcher;
...
public class ReportAlert extends BottomSheet {
    ...
    public ReportAlert(Context context, final int i, Theme.ResourcesProvider resourcesProvider, final boolean z, String str) {
        ...
        if (z) {
            ...
            rLottieImageView.setAnimation(C3632R.raw.fork_template_name_input, 120, 120);
        } else {
            rLottieImageView.setAnimation(C3632R.raw.report_police, 120, 120);
        }
        ...
        if (z) {
            if (str != null) {
                textView.setText(LocaleController.getString("EditName", C3632R.string.EditName));
            } else {
                textView.setText(LocaleController.getInternalString(C3632R.string.create_chat_template));
            }
        } else if (i == 0) {
            textView.setText(LocaleController.getString("ReportTitleSpam", C3632R.string.ReportTitleSpam));
        } else if (i == 6) {
            textView.setText(LocaleController.getString("ReportTitleFake", C3632R.string.ReportTitleFake));
        } else if (i == 1) {
            textView.setText(LocaleController.getString("ReportTitleViolence", C3632R.string.ReportTitleViolence));
        } else if (i == 2) {
            textView.setText(LocaleController.getString("ReportTitleChild", C3632R.string.ReportTitleChild));
        } else if (i == 5) {
            textView.setText(LocaleController.getString("ReportTitlePornography", C3632R.string.ReportTitlePornography));
        } else if (i == 100) {
            textView.setText(LocaleController.getString("ReportChat", C3632R.string.ReportChat));
        }
        ...
        if (z) {
            textView2.setText(LocaleController.getInternalString(C3632R.string.chat_template_name_info));
        } else {
            textView2.setText(LocaleController.getString("ReportInfo", C3632R.string.ReportInfo));
        }
        ...
        if (z) {
            ...
            this.editText.addTextChangedListener(new C55311(this, rLottieImageView));
            this.editText.setHint(LocaleController.getInternalString(C3632R.string.chat_template_name_hint));
        } else {
            this.editText.setHint(LocaleController.getString("ReportHint", C3632R.string.ReportHint));
        }
        ...
        if (z) {
            this.clearButton.setText(LocaleController.getString("Done", C3632R.string.Done));
        } else {
            this.clearButton.setText(LocaleController.getString("ReportSend", C3632R.string.ReportSend));
        }
    ...
    /* loaded from: classes6.dex */
    class C55311 extends SimpleTextWatcher {
        private Runnable playAnimationRunnable;
        final /* synthetic */ RLottieImageView val$imageView;

        C55311(ReportAlert reportAlert, final RLottieImageView rLottieImageView) {
