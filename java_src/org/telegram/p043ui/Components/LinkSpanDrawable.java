...
public class LinkSpanDrawable<S extends CharacterStyle> {
    ...
    public boolean draw(Canvas canvas) {
        float f;
        int m104dp = this.isLite ? 0 : AndroidUtilities.m104dp(4);
        boolean z = this.cornerRadius != m104dp;
        ...
        float f3 = 1.0f - f;
        this.mSelectionPaint.setStrokeWidth(Math.min(1.0f, f3) * AndroidUtilities.m104dp(5));
        ...
        this.mRipplePaint.setStrokeWidth(Math.min(1.0f, f3) * AndroidUtilities.m104dp(5));
    ...
    public static class ClickableSmallTextView extends SimpleTextView {
        ...
        public void onDraw(Canvas canvas) {
            if (isClickable()) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), this.linkBackgroundPaint);
            }
            super.onDraw(canvas);
