...
public class QuoteSpan implements LeadingMarginSpan {
    ...
    public int getLeadingMargin(boolean z) {
        return AndroidUtilities.m107dp(this.adaptLineHeight ? 8 : 10);
    }
    ...
    public static class QuoteStyleSpan extends MetricAffectingSpan implements LineHeightSpan {
        ...
        public void updateDrawState(TextPaint textPaint) {
            ...
            textPaint.setTextSize(AndroidUtilities.m107dp(this.span.edit ? 16 : SharedConfig.fontSize - 2));
        }
        ...
        public void chooseHeight(CharSequence charSequence, int i, int i2, int i3, int i4, Paint.FontMetricsInt fontMetricsInt) {
            ...
            if (quoteSpan.adaptLineHeight) {
                ...
                if (i <= quoteSpan.start) {
                    fontMetricsInt.ascent -= AndroidUtilities.m107dp((quoteSpan.last ? 2 : 0) + i5);
                    fontMetricsInt.top -= AndroidUtilities.m107dp((this.span.last ? 2 : 0) + i5);
                }
                if (i2 >= this.span.end) {
                    fontMetricsInt.descent += AndroidUtilities.m107dp(i5);
                    fontMetricsInt.bottom += AndroidUtilities.m107dp(i5);
                }
            }
        }
    }
    ...
    public static class Block {
        ...
        public Block(Layout layout, Spanned spanned, QuoteSpan quoteSpan) {
            ...
            if (quoteSpan.edit) {
                ...
                this.top = lineTop + AndroidUtilities.m107dp(3 - i);
                ...
                this.bottom = lineBottom - AndroidUtilities.m107dp(2 - i2);
            } else {
                this.top = layout.getLineTop(lineForOffset) + AndroidUtilities.m107dp(3 - (quoteSpan.singleLine ? 1 : 2));
                this.bottom = layout.getLineBottom(lineForOffset2) - AndroidUtilities.m107dp(2 - (quoteSpan.singleLine ? 1 : 2));
            }
            quoteSpan.rtl = false;
            float f = 0.0f;
        ...
        public void draw(Canvas canvas, float f, int i, int i2, float f2) {
            ...
            int m107dp = this.span.edit ? i : this.width + AndroidUtilities.m107dp(32);
            if (m107dp >= i * 0.95d) {
                m107dp = i;
            }
            canvas.save();
            ...
            rectF.set(BitmapDescriptorFactory.HUE_RED, this.top, m107dp, this.bottom);
            ...
            float m107dp2 = AndroidUtilities.m107dp(4);
            fArr7[5] = m107dp2;
            fArr6[4] = m107dp2;
            fArr5[3] = m107dp2;
            fArr4[2] = m107dp2;
            ...
            rectF.set(-AndroidUtilities.m107dp(3), this.top, BitmapDescriptorFactory.HUE_RED, this.bottom);
            ...
            float m107dp3 = AndroidUtilities.m107dp(4);
            fArr11[7] = m107dp3;
            fArr10[6] = m107dp3;
            fArr9[1] = m107dp3;
            fArr8[0] = m107dp3;
            ...
            if (!this.span.rtl) {
                ...
                if (intrinsicHeight > this.top + AndroidUtilities.m107dp(8)) {
                    intrinsicHeight = this.top + AndroidUtilities.m107dp(4);
                }
                this.span.quoteDrawable.setBounds((m107dp - this.span.quoteDrawable.getIntrinsicWidth()) - AndroidUtilities.m107dp(4), intrinsicHeight, m107dp - AndroidUtilities.m107dp(4), this.span.quoteDrawable.getIntrinsicHeight() + intrinsicHeight);
