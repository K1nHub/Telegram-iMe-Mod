...
public class DownloadsInfoBottomSheet extends BottomSheet {
    ...
    public DownloadsInfoBottomSheet(Context context, final BaseFragment baseFragment, boolean z) {
        ...
        textView.setText(LocaleController.getString("DownloadedFiles", C3419R.string.DownloadedFiles));
        ...
        textView2.setText(LocaleController.formatString("DownloadedFilesMessage", C3419R.string.DownloadedFilesMessage, new Object[0]));
        ...
        textView3.setText(LocaleController.getString("ManageDeviceStorage", C3419R.string.ManageDeviceStorage));
        ...
        textView4.setText(LocaleController.getString("ClearDownloadsList", C3419R.string.ClearDownloadsList));
