...
import org.telegram.p043ui.Components.Crop.CropRotationWheel;
...
public class PhotoCropView extends FrameLayout {
    ...
    public PhotoCropView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        cropView.setListener(new CropView.CropViewListener() { // from class: org.telegram.ui.Components.PhotoCropView.3
            @Override // org.telegram.p043ui.Components.Crop.CropView.CropViewListener
        ...
        this.cropView.setBottomPadding(AndroidUtilities.m107dp(64));
        ...
        cropRotationWheel.setListener(new CropRotationWheel.RotationWheelListener() { // from class: org.telegram.ui.Components.PhotoCropView.4
            @Override // org.telegram.p043ui.Components.Crop.CropRotationWheel.RotationWheelListener
            public void onStart() {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.thumbImageVisible && view == (cropView = this.cropView)) {
            ...
            int i = m107dp / 2;
            int videoThumbX = (this.delegate.getVideoThumbX() - i) + AndroidUtilities.m107dp(2);
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.m107dp(156);
            ...
            float width = actualRect.width() + ((m107dp - actualRect.width()) * this.thumbAnimationProgress);
            ...
            canvas.drawCircle(videoThumbX + i, measuredHeight + m107dp + AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(3), this.circlePaint);
        }
        return drawChild;
    }
    ...
    public float getRectX() {
        return this.cropView.getCropLeft() - AndroidUtilities.m107dp(14);
    }

    public float getRectY() {
        return (this.cropView.getCropTop() - AndroidUtilities.m107dp(14)) - ((Build.VERSION.SDK_INT < 21 || this.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight);
    }
