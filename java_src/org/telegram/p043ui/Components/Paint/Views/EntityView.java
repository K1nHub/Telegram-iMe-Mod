...
public class EntityView extends FrameLayout {
    ...
    public boolean onTouchMove(float f, float f2, boolean z, float f3, float f4) {
        ...
        if (((float) Math.hypot(f7, f8)) > (this.hasPanned ? 6.0f : 16.0f) || z) {
            ...
            if (entityViewDelegate5 != null) {
                entityViewDelegate5.onEntityDraggedTop(this.position.f1893y - ((((float) getHeight()) / 2.0f) * scaleX) < ((float) AndroidUtilities.m104dp(66)));
                this.delegate.onEntityDraggedBottom(this.position.f1893y + ((((float) getHeight()) / 2.0f) * scaleX) > ((float) (((View) getParent()).getHeight() - AndroidUtilities.m104dp(114))));
            }
            updateTrash(!z && MathUtils.distance(f5, f6, ((float) ((View) getParent()).getWidth()) / 2.0f, (float) (((View) getParent()).getHeight() - AndroidUtilities.m104dp(76))) < ((float) AndroidUtilities.m104dp(32)));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        this.delegate.getTransformedTouch(motionEvent.getRawX(), motionEvent.getRawY(), this.f1875xy);
        ...
        if (z2) {
            ...
            float[] fArr5 = this.f1875xy;
            fArr4[0] = fArr5[0];
            fArr4[1] = fArr5[1];
        }
        if (this.lastIsMultitouch != z2) {
            float[] fArr6 = this.f1875xy;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x012e, code lost:
        if (java.lang.Math.abs((r9.position.f1893y + (((height() / 2.0f) - getStickyPaddingBottom()) * getScaleY())) - (r10.getMeasuredHeight() - org.telegram.messenger.AndroidUtilities.m105dp(64.0f))) <= org.telegram.messenger.AndroidUtilities.m105dp(12.0f)) goto L21;
     */
    ...
    */
    ...
    public float getPositionX() {
        float measuredWidth;
        float f = this.position.f1892x;
        if (getParent() != null) {
            View view = (View) getParent();
            int i = this.stickyX;
            if (i == 1) {
                measuredWidth = AndroidUtilities.m105dp(8.0f) + (((width() / 2.0f) - getStickyPaddingLeft()) * getScaleX());
            } else if (i == 2) {
                measuredWidth = view.getMeasuredWidth() / 2.0f;
            } else {
                measuredWidth = i == 3 ? (view.getMeasuredWidth() - AndroidUtilities.m105dp(8.0f)) - (((width() / 2.0f) + getStickyPaddingRight()) * getScaleX()) : f;
            }
            ValueAnimator valueAnimator = this.stickyXAnimator;
            if (valueAnimator != null) {
    ...
    public float getPositionY() {
        ...
        float f = this.position.f1893y;
        if (getParent() != null) {
            View view = (View) getParent();
            int i = this.stickyY;
            if (i == 1) {
                measuredHeight = AndroidUtilities.m105dp(64.0f) + (((height() / 2.0f) - getStickyPaddingTop()) * getScaleY());
            } else if (i == 2) {
                measuredHeight = view.getMeasuredHeight() / 2.0f;
            } else {
                measuredHeight = i == 3 ? (view.getMeasuredHeight() - AndroidUtilities.m105dp(64.0f)) - (((height() / 2.0f) + getStickyPaddingBottom()) * getScaleY()) : f;
            }
            ValueAnimator valueAnimator = this.stickyYAnimator;
            if (valueAnimator != null) {
    ...
    public class SelectionView extends FrameLayout {
        ...
        public SelectionView(Context context) {
            ...
            this.paint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10)}, 0.5f));
        ...
        protected void updatePosition() {
            ...
            layoutParams.leftMargin = (int) selectionBounds.f1935x;
            layoutParams.topMargin = (int) selectionBounds.f1936y;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (getParent() instanceof View) {
            ...
            float height = (view.getHeight() - AndroidUtilities.m104dp(76)) - getY();
