    ...
    */
    ...
    public float getPositionX() {
        ...
        if (getParent() != null) {
            ...
            int i = this.stickyX;
            if (i == 1) {
                measuredWidth = AndroidUtilities.m73dp(8.0f) + (((width() / 2.0f) - getStickyPaddingLeft()) * getScaleX());
            } else if (i == 2) {
                measuredWidth = view.getMeasuredWidth() / 2.0f;
            } else {
                measuredWidth = i == 3 ? (view.getMeasuredWidth() - AndroidUtilities.m73dp(8.0f)) - (((width() / 2.0f) + getStickyPaddingRight()) * getScaleX()) : f;
            }
            ValueAnimator valueAnimator = this.stickyXAnimator;
            if (valueAnimator != null) {
    ...
    public float getPositionY() {
        ...
        if (getParent() != null) {
            ...
            int i = this.stickyY;
            if (i == 1) {
                measuredHeight = AndroidUtilities.m73dp(64.0f) + (((height() / 2.0f) - getStickyPaddingTop()) * getScaleY());
            } else if (i == 2) {
                measuredHeight = view.getMeasuredHeight() / 2.0f;
            } else {
                measuredHeight = i == 3 ? (view.getMeasuredHeight() - AndroidUtilities.m73dp(64.0f)) - (((height() / 2.0f) + getStickyPaddingBottom()) * getScaleY()) : f;
            }
            ValueAnimator valueAnimator = this.stickyYAnimator;
            if (valueAnimator != null) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (getParent() instanceof View) {
            ...
            float height = (view.getHeight() - AndroidUtilities.m72dp(76)) - getY();
