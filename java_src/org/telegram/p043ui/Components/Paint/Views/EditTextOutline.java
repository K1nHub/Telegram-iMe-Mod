...
public class EditTextOutline extends EditTextBoldCursor {
    ...
    public EditTextOutline(Context context, boolean z) {
        ...
        setFrameRoundRadius(AndroidUtilities.m104dp(16));
    ...
    public void setFrameColor(int i) {
        ...
        if (i2 == 0 && i != 0) {
            setPadding(AndroidUtilities.m104dp(19), AndroidUtilities.m104dp(7), AndroidUtilities.m104dp(19), AndroidUtilities.m104dp(7));
            setCursorColor(-1);
        } else if (i2 != 0 && i == 0) {
            setPadding(AndroidUtilities.m104dp(7), AndroidUtilities.m104dp(7), AndroidUtilities.m104dp(7), AndroidUtilities.m104dp(7));
            setCursorColor(-1);
        }
        this.mFrameColor = i;
        if (i != 0) {
        ...
        if (this.mFrameColor != 0) {
            ...
            if (this.isFrameDirty) {
                ...
                for (int i2 = 0; i2 < layout.getLineCount(); i2++) {
                    ...
                    if (this.lines[i2].width() > AndroidUtilities.m104dp(1)) {
            ...
            while (true) {
                ...
                if (rectF8.width() >= AndroidUtilities.m104dp(1) && rectF9.width() >= AndroidUtilities.m104dp(1)) {
                    ...
                    if (z) {
                        for (int i6 = i5; i6 >= 1; i6--) {
                            ...
                            if (rectF10.width() >= AndroidUtilities.m104dp(1) && rectF11.width() >= AndroidUtilities.m104dp(1)) {
