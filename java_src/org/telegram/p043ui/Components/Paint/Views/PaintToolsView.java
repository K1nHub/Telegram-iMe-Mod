...
public class PaintToolsView extends LinearLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float min = (Math.min((rLottieImageView.getWidth() - rLottieImageView.getPaddingLeft()) - rLottieImageView.getPaddingRight(), (rLottieImageView.getHeight() - rLottieImageView.getPaddingTop()) - rLottieImageView.getPaddingBottom()) / 2.0f) + AndroidUtilities.m107dp(3) + (AndroidUtilities.m107dp(3) * f3);
    ...
    private float getOffsetForIndex(int i) {
        return i == this.brushesCount + 1 ? AndroidUtilities.m107dp(4) : BitmapDescriptorFactory.HUE_RED;
    }
    ...
    private RLottieImageView createView(boolean z, boolean z2) {
        ...
        rLottieImageView.setPadding(AndroidUtilities.m107dp(z ? 0 : 8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(z2 ? 0 : 8), AndroidUtilities.m107dp(8));
