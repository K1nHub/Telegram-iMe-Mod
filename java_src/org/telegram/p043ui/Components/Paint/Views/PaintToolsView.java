...
public class PaintToolsView extends LinearLayout {
    ...
    public PaintToolsView(Context context, boolean z) {
        ...
        while (i < Brush.BRUSHES_LIST.size() + 2) {
            ...
            if (i == 0) {
                ...
                this.buttons[i2].setImageResource(C3419R.C3421drawable.msg_add);
    ...
    public void setSelectedIndex(int i) {
        ...
        if (this.isShapeSelected) {
            ...
            AndroidUtilities.updateImageViewImageAnimated(this.buttons[this.brushesCount + 1], C3419R.C3421drawable.msg_add);
        }
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float min = (Math.min((rLottieImageView.getWidth() - rLottieImageView.getPaddingLeft()) - rLottieImageView.getPaddingRight(), (rLottieImageView.getHeight() - rLottieImageView.getPaddingTop()) - rLottieImageView.getPaddingBottom()) / 2.0f) + AndroidUtilities.m72dp(3) + (AndroidUtilities.m72dp(3) * f3);
    ...
    private float getOffsetForIndex(int i) {
        return i == this.brushesCount + 1 ? AndroidUtilities.m72dp(4) : BitmapDescriptorFactory.HUE_RED;
    }
    ...
    private RLottieImageView createView(boolean z, boolean z2) {
        ...
        rLottieImageView.setPadding(AndroidUtilities.m72dp(z ? 0 : 8), AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(z2 ? 0 : 8), AndroidUtilities.m72dp(8));
