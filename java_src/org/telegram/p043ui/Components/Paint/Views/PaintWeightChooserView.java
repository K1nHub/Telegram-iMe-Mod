...
public class PaintWeightChooserView extends View {
    ...
    public PaintWeightChooserView(Context context) {
        ...
        this.colorPaint.setShadowLayer(AndroidUtilities.m107dp(4), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(2), 1342177280);
        this.backgroundPaint.setColor(1090519039);
        this.backgroundPaint.setShadowLayer(AndroidUtilities.m107dp(3), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(1), 637534208);
    }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.touchRect.set(BitmapDescriptorFactory.HUE_RED, (getHeight() - height) / 2.0f, AndroidUtilities.m107dp(32), (getHeight() + height) / 2.0f);
    }
    ...
    */
    ...
    private void drawCircleWithShadow(Canvas canvas, float f, float f2, float f3, boolean z) {
        if (z) {
            ...
            rectF.set((f - f3) - AndroidUtilities.m107dp(6), (f2 - f3) - AndroidUtilities.m107dp(6), f + f3 + AndroidUtilities.m107dp(6), f2 + f3 + AndroidUtilities.m107dp(6));
