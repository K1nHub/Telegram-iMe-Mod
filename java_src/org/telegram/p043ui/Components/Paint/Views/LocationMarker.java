...
public class LocationMarker extends View {
    ...
    private void setupLayout() {
        if (this.relayout) {
            ...
            this.f1877w = (f5 * f6) + (this.layoutWidth * this.textScale);
            this.f1876h = ((rectF2.top + rectF2.bottom) * f6) + Math.max(f6 * 21.33f, this.layout.getHeight() * this.textScale);
            this.relayout = false;
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        setupLayout();
        setMeasuredDimension(this.padx + Math.round(this.f1877w) + this.padx, this.pady + Math.round(this.f1876h) + this.pady);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int i = this.padx;
        int i2 = this.pady;
        rectF.set(i, i2, i + this.f1877w, i2 + this.f1876h);
        ...
        if (this.hasFlag) {
            ...
            imageReceiver.setImageCoords(this.padx + ((this.padding.left + 2.25f) * f3), this.pady + ((this.f1876h - (f3 * 21.33f)) / 2.0f), f3 * 21.33f, f3 * 21.33f);
            canvas.save();
        ...
        canvas.translate(f7 + ((f8 + f2 + 21.33f + 3.25f) * this.density), this.pady + (this.f1876h / 2.0f));
