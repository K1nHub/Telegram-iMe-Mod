...
public class ColorPicker extends FrameLayout {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.interacting || y >= (-AndroidUtilities.m104dp(10))) {
            ...
            if (actionMasked == 3 || actionMasked == 1 || actionMasked == 6) {
                ...
                if (y < (-AndroidUtilities.m104dp(10))) {
                    this.changingWeight = true;
                    setWeight(Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(1.0f, ((-y) - AndroidUtilities.m104dp(10)) / AndroidUtilities.m104dp(190))));
                }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int i5 = i3 - i;
        int i6 = i4 - i2;
        this.gradientPaint.setShader(new LinearGradient(AndroidUtilities.m104dp(56), (float) BitmapDescriptorFactory.HUE_RED, i5 - AndroidUtilities.m104dp(56), (float) BitmapDescriptorFactory.HUE_RED, COLORS, LOCATIONS, Shader.TileMode.REPEAT));
        int m104dp = i6 - AndroidUtilities.m104dp(32);
        this.rectF.set(AndroidUtilities.m104dp(56), m104dp, i5 - AndroidUtilities.m104dp(56), m104dp + AndroidUtilities.m104dp(12));
        ImageView imageView = this.settingsButton;
        imageView.layout(i5 - imageView.getMeasuredWidth(), i6 - AndroidUtilities.m104dp(52), i5, i6);
        this.undoButton.layout(0, i6 - AndroidUtilities.m104dp(52), this.settingsButton.getMeasuredWidth(), i6);
    }

    @Override // android.view.View
    protected void onDraw(Canvas canvas) {
        canvas.drawRoundRect(this.rectF, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), this.gradientPaint);
        RectF rectF = this.rectF;
        int width = (int) (rectF.left + (rectF.width() * this.location));
        int centerY = (int) ((this.rectF.centerY() + (this.draggingFactor * (-AndroidUtilities.m104dp(70)))) - (this.changingWeight ? this.weight * AndroidUtilities.m104dp(190) : BitmapDescriptorFactory.HUE_RED));
        int m104dp = (int) (AndroidUtilities.m104dp(24) * (this.draggingFactor + 1.0f) * 0.5f);
        this.shadowDrawable.setBounds(width - m104dp, centerY - m104dp, width + m104dp, m104dp + centerY);
        this.shadowDrawable.draw(canvas);
        float floor = (((int) Math.floor(AndroidUtilities.m104dp(4) + ((AndroidUtilities.m104dp(19) - AndroidUtilities.m104dp(4)) * this.weight))) * (this.draggingFactor + 1.0f)) / 2.0f;
        float f = width;
        float f2 = centerY;
        canvas.drawCircle(f, f2, (AndroidUtilities.m104dp(22) / 2) * (this.draggingFactor + 1.0f), this.backgroundPaint);
        canvas.drawCircle(f, f2, floor, this.swatchPaint);
        canvas.drawCircle(f, f2, floor - AndroidUtilities.m105dp(0.5f), this.swatchStrokePaint);
    }
