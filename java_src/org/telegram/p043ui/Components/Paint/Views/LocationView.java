...
public class LocationView extends EntityView {
    ...
    public class TextViewSelectionView extends EntityView.SelectionView {
        ...
        protected int pointInsideHandle(float f, float f2) {
            ...
            float measuredHeight = ((getMeasuredHeight() - f3) / 2.0f) + m105dp2;
            if (f <= m105dp2 - m105dp || f2 <= measuredHeight - m105dp || f >= m105dp2 + m105dp || f2 >= measuredHeight + m105dp) {
                float f4 = m105dp2 + measuredWidth;
                return (f <= f4 - m105dp || f2 <= measuredHeight - m105dp || f >= f4 + m105dp || f2 >= measuredHeight + m105dp) ? 0 : 2;
            }
            return 1;
        }
