...
public class PaintTextOptionsView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PaintTextOptionsView(Context context) {
        ...
        this.alignView.setPadding(AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2));
        ...
        this.outlineView.setPadding(AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1));
        ...
        this.plusView.setPadding(AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2));
    ...
    private void layoutChild(View view) {
        if (view.getVisibility() != 8) {
            ...
            int i = this.f1884x + layoutParams.leftMargin;
            this.f1884x = i;
            view.layout(i, (getMeasuredHeight() - layoutParams.height) / 2, this.f1884x + layoutParams.width, (getMeasuredHeight() + layoutParams.height) / 2);
            this.f1884x += layoutParams.width + layoutParams.rightMargin;
        }
    }
    ...
    public void getTypefaceCellBounds(RectF rectF) {
        rectF.set(this.typefaceCell.getLeft() + AndroidUtilities.m107dp(8), this.typefaceCell.getTop(), this.typefaceCell.getRight() + AndroidUtilities.m107dp(8), this.typefaceCell.getBottom());
    }
    ...
    public static final class TypefaceCell extends TextView {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.restore();
            if (this.isCurrent) {
                int height = (getHeight() - AndroidUtilities.m107dp(16)) / 2;
                if (LocaleController.isRTL) {
                    this.expandDrawable.setBounds(AndroidUtilities.m107dp(7), height, AndroidUtilities.m107dp(23), AndroidUtilities.m107dp(16) + height);
                } else {
                    this.expandDrawable.setBounds(getWidth() - AndroidUtilities.m107dp(23), height, getWidth() - AndroidUtilities.m107dp(7), AndroidUtilities.m107dp(16) + height);
                }
        ...
        public void setCurrent(boolean z) {
            this.isCurrent = z;
            if (z) {
                setPadding(AndroidUtilities.m107dp(LocaleController.isRTL ? 27 : 12), AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(LocaleController.isRTL ? 12 : 27), AndroidUtilities.m107dp(6));
                setBackground(Theme.AdaptiveRipple.rect(1090519039, AndroidUtilities.m107dp(32)));
            } else {
                setPadding(AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(14), AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(14));
