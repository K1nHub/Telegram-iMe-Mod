...
public class TextPaintView extends EntityView {
    ...
    public TextPaintView(Context context, Point point, int i, CharSequence charSequence, Swatch swatch, int i2) {
        ...
        this.editText.setPadding(AndroidUtilities.m107dp(7), AndroidUtilities.m107dp(7), AndroidUtilities.m107dp(7), AndroidUtilities.m107dp(7));
        this.editText.setClickable(false);
        this.editText.setEnabled(false);
        this.editText.setCursorColor(-1);
        this.editText.setTextSize(0, this.baseFontSize);
        this.editText.setCursorSize(AndroidUtilities.m108dp(this.baseFontSize * 0.4f));
    ...
    public void setBaseFontSize(int i) {
        ...
        this.editText.setCursorSize(AndroidUtilities.m108dp(f * 0.4f));
    ...
    public Rect getSelectionBounds() {
        ...
        float measuredHeight = (getMeasuredHeight() * getScale()) + (AndroidUtilities.m107dp(52) / scaleX);
