...
public class ReactionWidgetEntityView extends EntityView {
    ...
    public int getPadding() {
        return (int) ((this.baseSize.height - AndroidUtilities.m104dp(84)) / 2.0f);
    }

    @Override // org.telegram.p043ui.Components.Paint.Views.EntityView
    protected org.telegram.p043ui.Components.Rect getSelectionBounds() {
    ...
    public class StickerViewSelectionView extends EntityView.SelectionView {
        ...
        protected int pointInsideHandle(float f, float f2) {
            ...
            if (f <= m105dp2 - m105dp || f2 <= measuredHeight - m105dp || f >= m105dp2 + m105dp || f2 >= measuredHeight + m105dp) {
                if (f <= ((getMeasuredWidth() - f3) + m105dp2) - m105dp || f2 <= measuredHeight - m105dp || f >= m105dp2 + (getMeasuredWidth() - f3) + m105dp || f2 >= measuredHeight + m105dp) {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float m105dp = AndroidUtilities.m105dp(1.0f) + dpf2 + AndroidUtilities.m104dp(15);
            float measuredWidth = (getMeasuredWidth() / 2) - m105dp;
            float f = m105dp + (2.0f * measuredWidth);
            this.arcRect.set(m105dp, m105dp, f, f);
            ...
            float f2 = measuredWidth + m105dp;
            canvas.drawCircle(m105dp, f2, dpf2, this.dotStrokePaint);
            canvas.drawCircle(m105dp, f2, dpf2 - AndroidUtilities.m104dp(1), this.dotPaint);
            canvas.drawCircle(f, f2, dpf2, this.dotStrokePaint);
            canvas.drawCircle(f, f2, dpf2 - AndroidUtilities.m104dp(1), this.dotPaint);
