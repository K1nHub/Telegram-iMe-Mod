...
public class ShaderSet {
    ...
    private static Map<String, Map<String, Object>> createMap() {
        ...
        hashMap4.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        ...
        hashMap5.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        ...
        hashMap6.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "blured", TtmlNode.ATTR_TTS_COLOR});
        ...
        hashMap7.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "blured", TtmlNode.ATTR_TTS_COLOR});
        hashMap.put("compositeWithMaskBlurer", Collections.unmodifiableMap(hashMap7));
        HashMap hashMap8 = new HashMap();
        hashMap8.put("vertex", "precision highp float;uniform mat4 mvpMatrix;attribute vec4 inPosition;attribute vec2 inTexcoord;attribute float alpha;varying vec2 varTexcoord;varying float varIntensity;void main (void) {   gl_Position = mvpMatrix * inPosition;   varTexcoord = inTexcoord;   varIntensity = alpha;}");
        hashMap8.put("fragment", "precision highp float;varying vec2 varTexcoord;varying float varIntensity;uniform sampler2D texture;void main (void) {   vec4 f = texture2D(texture, varTexcoord.st, 0.0);   gl_FragColor = vec4(f.r * varIntensity, f.g, f.b, 0.0);}");
        hashMap8.put("attributes", new String[]{"inPosition", "inTexcoord", "alpha"});
        hashMap8.put("uniforms", new String[]{"mvpMatrix", "texture"});
        hashMap.put("brushLight", Collections.unmodifiableMap(hashMap8));
        ...
        hashMap9.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        hashMap.put("blitWithMaskLight", Collections.unmodifiableMap(hashMap9));
        ...
        hashMap10.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        hashMap.put("compositeWithMaskLight", Collections.unmodifiableMap(hashMap10));
        ...
        hashMap11.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        hashMap.put("blitWithMaskEraser", Collections.unmodifiableMap(hashMap11));
        ...
        hashMap12.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        hashMap.put("compositeWithMaskEraser", Collections.unmodifiableMap(hashMap12));
        ...
        hashMap13.put("fragment", "precision highp float;varying vec2 varTexcoord;uniform sampler2D texture;void main (void) {   gl_FragColor = texture2D(texture, varTexcoord.st, 0.0);}");
        hashMap13.put("attributes", new String[]{"inPosition", "inTexcoord"});
        hashMap13.put("uniforms", new String[]{"mvpMatrix", "texture"});
        hashMap.put("nonPremultipliedBlit", Collections.unmodifiableMap(hashMap13));
        ...
        hashMap14.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "clear", TtmlNode.ATTR_TTS_COLOR, SessionDescription.ATTR_TYPE, TtmlNode.ATTR_TTS_COLOR, "resolution", TtmlNode.CENTER, "radius", "thickness", "rounding", "fill", "rotation", "middle", "arrowTriangleLength", "composite"});
        hashMap.put("shape", Collections.unmodifiableMap(hashMap14));
