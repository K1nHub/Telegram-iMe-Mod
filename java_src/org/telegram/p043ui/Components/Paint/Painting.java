...
public class Painting {
    ...
    public /* synthetic */ void lambda$setHelperShape$2(Shape shape) {
        ...
        if (this.helperShown != (shape != null)) {
            ...
            this.helperAnimator.addListener(new C52611());
    ...
    /* loaded from: classes6.dex */
    public class C52611 extends AnimatorListenerAdapter {
        C52611() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            Painting.this.renderView.performInContext(new Runnable() { // from class: org.telegram.ui.Components.Paint.Painting$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Painting.C52611.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    public boolean applyHelperShape() {
        ...
        this.helperApplyAnimator.addListener(new C52622());
    ...
    /* loaded from: classes6.dex */
    public class C52622 extends AnimatorListenerAdapter {
        C52622() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            Painting.this.renderView.performInContext(new Runnable() { // from class: org.telegram.ui.Components.Paint.Painting$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Painting.C52622.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    private void renderBlur() {
        ...
        GLES20.glUniform1f(shader.getUniform("flipy"), BitmapDescriptorFactory.HUE_RED);
        GLES20.glUniform1i(shader.getUniform("texture"), 0);
        GLES20.glActiveTexture(33984);
        ...
        if (this.activePath != null && (this.brush instanceof Brush.Eraser)) {
            ...
            GLES20.glUniform1f(shader.getUniform("eraser"), BitmapDescriptorFactory.HUE_RED);
        }
        GLES20.glBlendFunc(1, 0);
        GLES20.glVertexAttribPointer(0, 2, 5126, false, 8, (Buffer) this.vertexBuffer);
        GLES20.glEnableVertexAttribArray(0);
