...
public class ClearHistoryAlert extends BottomSheet {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(4), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
    ...
    */
    ...
    public void updateLayout() {
        ...
        int max = Math.max(this.location[1] - AndroidUtilities.m104dp(this.autoDeleteOnly ? 6 : 19), 0);
