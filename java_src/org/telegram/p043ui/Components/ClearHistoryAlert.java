...
public class ClearHistoryAlert extends BottomSheet {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(4), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
    ...
    */
    public ClearHistoryAlert(android.content.Context r26, org.telegram.tgnet.TLRPC$User r27, org.telegram.tgnet.TLRPC$Chat r28, boolean r29, org.telegram.p043ui.ActionBar.Theme.ResourcesProvider r30) {
        /*
            Method dump skipped, instructions count: 1185
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.ClearHistoryAlert.<init>(android.content.Context, org.telegram.tgnet.TLRPC$User, org.telegram.tgnet.TLRPC$Chat, boolean, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public void updateLayout() {
        ...
        int max = Math.max(this.location[1] - AndroidUtilities.m107dp(this.autoDeleteOnly ? 6 : 19), 0);
