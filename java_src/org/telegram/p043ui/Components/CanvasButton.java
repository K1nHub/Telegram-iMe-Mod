...
public class CanvasButton {
    ...
    float roundRadius = AndroidUtilities.m107dp(12);
    ...
    public CanvasButton(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            this.maskPaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m107dp(12)));
        ...
        if (!this.pathCreated) {
            ...
            while (true) {
                ...
                if (i8 < i7) {
                    ...
                    if (Math.abs(f - f2) < AndroidUtilities.m107dp(4)) {
