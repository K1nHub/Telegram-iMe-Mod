...
/* renamed from: org.telegram.ui.Components.CanvasButton */
...
public class CanvasButton {
    ...
    Runnable longPressRunnableInner = new Runnable() { // from class: org.telegram.ui.Components.CanvasButton.1
        ...
        public void run() {
            CanvasButton.this.checkTouchEvent(MotionEvent.obtain(0L, 0L, 3, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 0));
    ...
    float roundRadius = AndroidUtilities.m104dp(12);
    ...
    public CanvasButton(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            this.maskPaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m104dp(12)));
    ...
    public void drawInternal(Canvas canvas, Paint paint) {
        ...
        if (i <= 1) {
            if (i == 1) {
                ...
                canvas.drawRoundRect(this.drawingRects.get(0), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, paint);
                return;
            }
            return;
        }
        if (!this.pathCreated) {
            ...
            while (true) {
                ...
                if (i8 < i7) {
                    ...
                    if (Math.abs(f - f2) < AndroidUtilities.m104dp(4)) {
