...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.scrollOffset = AndroidUtilities.m107dp(52);
        this.indicatorHeight = AndroidUtilities.m107dp(8);
        this.underlineHeight = AndroidUtilities.m107dp(2);
        this.dividerPadding = AndroidUtilities.m107dp(12);
        this.tabPadding = AndroidUtilities.m107dp(24);
        this.lastScrollX = 0;
    ...
    private void addIconTab(final int i, Drawable drawable, CharSequence charSequence) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            RippleDrawable rippleDrawable = (RippleDrawable) Theme.createSelectorDrawable(getThemedColor(Theme.key_chat_emojiBottomPanelIcon), 1, AndroidUtilities.m107dp(18));
    ...
    private void addTab(final int i, CharSequence charSequence) {
        ...
        textTab.setPadding(AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(18), 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (childAt != null) {
            ...
            if (this.indicatorHeight != 0) {
                ...
                rectF2.set(f - AndroidUtilities.m107dp(12), AndroidUtilities.m107dp(6), f2 + AndroidUtilities.m107dp(12), height - AndroidUtilities.m107dp(6));
