...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m107dp(33), 0, AndroidUtilities.m107dp(33), 0);
        ...
        this.doneButton.setPadding(AndroidUtilities.m107dp(33), 0, AndroidUtilities.m107dp(33), 0);
        ...
        this.doneButtonBadgeTextView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(11), Theme.getColor(Theme.key_picker_badge, resourcesProvider)));
        ...
        this.doneButtonTextView.setCompoundDrawablePadding(AndroidUtilities.m107dp(8));
