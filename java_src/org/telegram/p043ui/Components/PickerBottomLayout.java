...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m104dp(33), 0, AndroidUtilities.m104dp(33), 0);
        this.cancelButton.setText(LocaleController.getString("Cancel", C3634R.string.Cancel).toUpperCase());
        ...
        this.doneButton.setPadding(AndroidUtilities.m104dp(33), 0, AndroidUtilities.m104dp(33), 0);
        ...
        this.doneButtonBadgeTextView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m104dp(11), Theme.getColor(Theme.key_picker_badge, resourcesProvider)));
        this.doneButtonBadgeTextView.setMinWidth(AndroidUtilities.m104dp(23));
        this.doneButtonBadgeTextView.setPadding(AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(1));
        ...
        this.doneButtonTextView.setCompoundDrawablePadding(AndroidUtilities.m104dp(8));
        this.doneButtonTextView.setText(LocaleController.getString("Send", C3634R.string.Send).toUpperCase());
