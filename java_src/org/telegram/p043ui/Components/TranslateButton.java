...
public class TranslateButton extends FrameLayout {
    ...
    public TranslateButton(Context context, final int i, long j, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setTextSize(AndroidUtilities.m107dp(15));
        ...
        mutate.setBounds(0, AndroidUtilities.m107dp(-8), AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(12));
    ...
    protected void onMenuClick() {
        ...
        actionBarPopupWindow.showAsDropDown(imageView, 0, (-imageView.getMeasuredHeight()) - AndroidUtilities.m107dp(8));
    }
    ...
    public /* synthetic */ void lambda$onMenuClick$9(final TranslateController translateController, ActionBarPopupWindow actionBarPopupWindow, View view) {
        ...
        BulletinFactory.m65of(this.fragment).createSimpleBulletin(C3632R.raw.msg_translate, AndroidUtilities.replaceTags(string), LocaleController.getString("Undo", C3632R.string.Undo), new Runnable() { // from class: org.telegram.ui.Components.TranslateButton$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
