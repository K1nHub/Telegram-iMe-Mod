...
public class TranslateButton extends FrameLayout {
    ...
    public TranslateButton(Context context, final int i, long j, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3417R.C3419drawable.msg_translate).mutate();
        ...
        this.menuView.setImageResource(C3417R.C3419drawable.msg_mini_customize);
    ...
    protected void onMenuClick() {
        ...
        final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(getContext(), C3417R.C3419drawable.popup_fixed_alert2, this.resourcesProvider, 1);
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (f > BitmapDescriptorFactory.HUE_RED) {
                    if (this.topShadowDrawable == null) {
                        this.topShadowDrawable = getContext().getResources().getDrawable(C3417R.C3419drawable.header_shadow);
                    }
        ...
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("TranslateTo", C3417R.string.TranslateTo), C3417R.C3419drawable.msg_translate);
        ...
        actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("Back", C3417R.string.Back), C3417R.C3419drawable.ic_ab_back);
        ...
        if (languageName != null) {
            ...
            if (this.accusative[0]) {
                formatString = LocaleController.formatString("DoNotTranslateLanguage", C3417R.string.DoNotTranslateLanguage, languageName);
            } else {
                formatString = LocaleController.formatString("DoNotTranslateLanguageOther", C3417R.string.DoNotTranslateLanguageOther, languageName);
            }
            actionBarMenuSubItem6.setTextAndIcon(formatString, C3417R.C3419drawable.msg_block2);
        ...
        actionBarMenuSubItem7.setTextAndIcon(LocaleController.getString("Hide", C3417R.string.Hide), C3417R.C3419drawable.msg_cancel);
        ...
        actionBarPopupWindow.setAnimationStyle(C3417R.style.PopupContextAnimation);
    ...
    public /* synthetic */ void lambda$onMenuClick$7(String str, TranslateController translateController, String str2, ActionBarPopupWindow actionBarPopupWindow, View view) {
        ...
        if (this.accusative[0]) {
            formatString = LocaleController.formatString("AddedToDoNotTranslate", C3417R.string.AddedToDoNotTranslate, str2);
        } else {
            formatString = LocaleController.formatString("AddedToDoNotTranslateOther", C3417R.string.AddedToDoNotTranslateOther, str2);
        }
        BulletinFactory.m29of(this.fragment).createSimpleBulletin(C3417R.raw.msg_translate, TranslateAlert2.capitalFirst(AndroidUtilities.replaceTags(formatString)), LocaleController.getString("Settings", C3417R.string.Settings), new Runnable() { // from class: org.telegram.ui.Components.TranslateButton$$ExternalSyntheticLambda8
    ...
    public /* synthetic */ void lambda$onMenuClick$9(final TranslateController translateController, ActionBarPopupWindow actionBarPopupWindow, View view) {
        ...
        if ((chat == null || !ChatObject.isChannelAndNotMegaGroup(chat)) ? false : false) {
            string = LocaleController.getString("TranslationBarHiddenForChannel", C3417R.string.TranslationBarHiddenForChannel);
        } else if (chat != null) {
            string = LocaleController.getString("TranslationBarHiddenForGroup", C3417R.string.TranslationBarHiddenForGroup);
        } else {
            string = LocaleController.getString("TranslationBarHiddenForChat", C3417R.string.TranslationBarHiddenForChat);
        }
        BulletinFactory.m29of(this.fragment).createSimpleBulletin(C3417R.raw.msg_translate, AndroidUtilities.replaceTags(string), LocaleController.getString("Undo", C3417R.string.Undo), new Runnable() { // from class: org.telegram.ui.Components.TranslateButton$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void updateText() {
        ...
        if (translateController.isTranslatingDialog(this.dialogId)) {
            this.textView.setText(TextUtils.concat(this.translateIcon, " ", LocaleController.getString("ShowOriginalButton", C3417R.string.ShowOriginalButton)));
        } else {
            String dialogTranslateTo = translateController.getDialogTranslateTo(this.dialogId);
            ...
            if (this.accusative[0]) {
                formatString = LocaleController.formatString("TranslateToButton", C3417R.string.TranslateToButton, languageName);
            } else {
                formatString = LocaleController.formatString("TranslateToButtonOther", C3417R.string.TranslateToButtonOther, languageName);
            }
            this.textView.setText(TextUtils.concat(this.translateIcon, " ", formatString));
        }
        this.menuView.setImageResource(UserConfig.getInstance(this.currentAccount).isPremium() ? C3417R.C3419drawable.msg_mini_customize : C3417R.C3419drawable.msg_close);
    }
}
