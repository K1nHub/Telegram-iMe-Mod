...
public class GroupCallRenderersContainer extends FrameLayout {
    ...
    public GroupCallRenderersContainer(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList<GroupCallMiniTextureView> arrayList, ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        this.hideUiRunnable = new Runnable() { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.1
            ...
            public void run() {
                if (!GroupCallRenderersContainer.this.canHideUI()) {
                    AndroidUtilities.runOnUIThread(GroupCallRenderersContainer.this.hideUiRunnable, C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                    return;
                }
        ...
        imageView.setPadding(AndroidUtilities.m107dp(16), 0, AndroidUtilities.m107dp(16), 0);
        ...
        final Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(20), 0, ColorUtils.setAlphaComponent(-1, 100));
        View view3 = new View(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.4
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                canvas.save();
                createSimpleSelectorRoundRectDrawable.setBounds(0, 0, AndroidUtilities.m107dp(50) + ((int) measuredWidth), getMeasuredHeight());
        ...
        crossOutDrawable.setOffsets(-AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(1));
        ...
        this.pipView.setPadding(m107dp, m107dp, m107dp, m107dp);
        ...
        final Drawable createRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m107dp(18), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_voipgroup_listViewBackground), 204));
    ...
    public void setIsTablet(boolean z) {
        if (this.isTablet != z) {
            ...
            layoutParams.rightMargin = z ? AndroidUtilities.m107dp(328) : 0;
            layoutParams.bottomMargin = z ? -AndroidUtilities.m107dp(8) : 0;
            if (this.isTablet) {
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        if (GroupCallActivity.isTabletMode) {
            ((ViewGroup.MarginLayoutParams) this.topShadowView.getLayoutParams()).rightMargin = AndroidUtilities.m107dp(328);
        } else if (GroupCallActivity.isLandscapeMode) {
            ((ViewGroup.MarginLayoutParams) this.topShadowView.getLayoutParams()).rightMargin = isRtmpStream() ? 0 : AndroidUtilities.m107dp(90);
        } else {
        ...
        this.pinContainer.getLayoutParams().height = AndroidUtilities.m107dp(40);
        ...
        this.pinContainer.getLayoutParams().width = AndroidUtilities.m107dp(46) + (!this.hasPinnedVideo ? this.pinTextView : this.unpinTextView).getMeasuredWidth();
        ((ViewGroup.MarginLayoutParams) this.speakingMembersToast.getLayoutParams()).rightMargin = GroupCallActivity.isLandscapeMode ? AndroidUtilities.m107dp(45) : 0;
        for (int i3 = 0; i3 < 2; i3++) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.undoView[i3].getLayoutParams();
            if (this.isTablet) {
                marginLayoutParams.rightMargin = AndroidUtilities.m107dp(344);
            } else {
                marginLayoutParams.rightMargin = GroupCallActivity.isLandscapeMode ? AndroidUtilities.m107dp(180) : 0;
            }
        }
    ...
    public void setVisibleParticipant(boolean z) {
        ...
        if (i4 != 0) {
            if (i4 == 1) {
                ...
                i2 = AndroidUtilities.m107dp(64);
            } else {
                i2 = AndroidUtilities.m107dp(88);
            }
        }
        ((FrameLayout.LayoutParams) this.speakingMembersText.getLayoutParams()).leftMargin = i2;
        ((FrameLayout.LayoutParams) this.speakingMembersText.getLayoutParams()).rightMargin = AndroidUtilities.m107dp(16);
        this.showSpeakingMembersToast = z3;
        invalidate();
        while (i4 < 3) {
