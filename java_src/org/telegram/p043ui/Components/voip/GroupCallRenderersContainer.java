...
public class GroupCallRenderersContainer extends FrameLayout {
    ...
    public GroupCallRenderersContainer(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList<GroupCallMiniTextureView> arrayList, ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        this.hideUiRunnable = new Runnable() { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.1
            ...
            public void run() {
                if (!GroupCallRenderersContainer.this.canHideUI()) {
                    AndroidUtilities.runOnUIThread(GroupCallRenderersContainer.this.hideUiRunnable, C0485C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                    return;
                }
        ...
        ImageView imageView = new ImageView(this, context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.2
            ...
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(C3704ActionBar.getCurrentActionBarHeight(), 1073741824));
            }
        };
        ...
        imageView.setPadding(AndroidUtilities.m104dp(16), 0, AndroidUtilities.m104dp(16), 0);
        ...
        final Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(20), 0, ColorUtils.setAlphaComponent(-1, 100));
        View view3 = new View(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.4
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                canvas.save();
                createSimpleSelectorRoundRectDrawable.setBounds(0, 0, AndroidUtilities.m104dp(50) + ((int) measuredWidth), getMeasuredHeight());
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(context, C3632R.C3634drawable.msg_pin_filled, -1);
        this.pinDrawable = crossOutDrawable;
        crossOutDrawable.setOffsets(-AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(1));
        ...
        this.pinTextView.setText(LocaleController.getString("CallVideoPin", C3632R.string.CallVideoPin));
        ...
        this.unpinTextView.setText(LocaleController.getString("CallVideoUnpin", C3632R.string.CallVideoUnpin));
        ...
        this.pipView.setImageResource(C3632R.C3634drawable.ic_goinline);
        this.pipView.setContentDescription(LocaleController.getString(C3632R.string.AccDescrPipMode));
        int m104dp = AndroidUtilities.m104dp(4);
        this.pipView.setPadding(m104dp, m104dp, m104dp, m104dp);
        ...
        final Drawable createRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m104dp(18), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_voipgroup_listViewBackground), 204));
        ...
        for (int i = 0; i < 2; i++) {
            this.undoView[i] = new UndoView(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.6
                @Override // org.telegram.p043ui.Components.UndoView, android.view.View
                public void invalidate() {
                    super.invalidate();
                    GroupCallRenderersContainer.this.invalidate();
                }
    ...
    public void setIsTablet(boolean z) {
        if (this.isTablet != z) {
            ...
            layoutParams.rightMargin = z ? AndroidUtilities.m104dp(328) : 0;
            layoutParams.bottomMargin = z ? -AndroidUtilities.m104dp(8) : 0;
            if (this.isTablet) {
                this.backButton.setImageDrawable(ContextCompat.getDrawable(getContext(), C3632R.C3634drawable.msg_calls_minimize));
                return;
            }
            BackDrawable backDrawable = new BackDrawable(false);
            backDrawable.setColor(-1);
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.voip.GroupCallRenderersContainer.dispatchDraw(android.graphics.Canvas):void");
    }
        ...
        if (this.uiVisible != z) {
            ...
            if (z && this.inFullscreenMode) {
                if (!this.hideUiRunnableIsScheduled) {
                    ...
                    AndroidUtilities.runOnUIThread(this.hideUiRunnable, C0485C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                }
            } else {
                this.hideUiRunnableIsScheduled = false;
                AndroidUtilities.cancelRunOnUIThread(this.hideUiRunnable);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r14) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.voip.GroupCallRenderersContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (GroupCallActivity.isTabletMode) {
            ((ViewGroup.MarginLayoutParams) this.topShadowView.getLayoutParams()).rightMargin = AndroidUtilities.m104dp(328);
        } else if (GroupCallActivity.isLandscapeMode) {
            ((ViewGroup.MarginLayoutParams) this.topShadowView.getLayoutParams()).rightMargin = isRtmpStream() ? 0 : AndroidUtilities.m104dp(90);
        } else {
        ...
        this.pinContainer.getLayoutParams().height = AndroidUtilities.m104dp(40);
        ...
        this.pinContainer.getLayoutParams().width = AndroidUtilities.m104dp(46) + (!this.hasPinnedVideo ? this.pinTextView : this.unpinTextView).getMeasuredWidth();
        ((ViewGroup.MarginLayoutParams) this.speakingMembersToast.getLayoutParams()).rightMargin = GroupCallActivity.isLandscapeMode ? AndroidUtilities.m104dp(45) : 0;
        for (int i3 = 0; i3 < 2; i3++) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.undoView[i3].getLayoutParams();
            if (this.isTablet) {
                marginLayoutParams.rightMargin = AndroidUtilities.m104dp(344);
            } else {
                marginLayoutParams.rightMargin = GroupCallActivity.isLandscapeMode ? AndroidUtilities.m104dp(180) : 0;
            }
        }
    ...
    public void setVisibleParticipant(boolean z) {
        ...
        if (i4 != 0) {
            if (i4 == 1) {
                ...
                i2 = AndroidUtilities.m104dp(64);
            } else {
                i2 = AndroidUtilities.m104dp(88);
            }
        }
        ((FrameLayout.LayoutParams) this.speakingMembersText.getLayoutParams()).leftMargin = i2;
        ((FrameLayout.LayoutParams) this.speakingMembersText.getLayoutParams()).rightMargin = AndroidUtilities.m104dp(16);
        this.showSpeakingMembersToast = z3;
        invalidate();
        while (i4 < 3) {
