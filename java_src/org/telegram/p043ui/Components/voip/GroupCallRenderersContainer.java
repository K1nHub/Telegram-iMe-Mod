...
public class GroupCallRenderersContainer extends FrameLayout {
    ...
    public GroupCallRenderersContainer(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList<GroupCallMiniTextureView> arrayList, ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        ImageView imageView = new ImageView(this, context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.2
            ...
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(C3541ActionBar.getCurrentActionBarHeight(), 1073741824));
            }
        };
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(context, C3473R.C3475drawable.msg_pin_filled, -1);
        ...
        this.pinTextView.setText(LocaleController.getString("CallVideoPin", C3473R.string.CallVideoPin));
        ...
        this.unpinTextView.setText(LocaleController.getString("CallVideoUnpin", C3473R.string.CallVideoUnpin));
        ...
        this.pipView.setImageResource(C3473R.C3475drawable.ic_goinline);
        this.pipView.setContentDescription(LocaleController.getString(C3473R.string.AccDescrPipMode));
    ...
    public void setIsTablet(boolean z) {
        if (this.isTablet != z) {
            ...
            if (this.isTablet) {
                this.backButton.setImageDrawable(ContextCompat.getDrawable(getContext(), C3473R.C3475drawable.msg_calls_minimize));
                return;
            }
            BackDrawable backDrawable = new BackDrawable(false);
            backDrawable.setColor(-1);
