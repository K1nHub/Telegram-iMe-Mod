...
public class GroupCallStatusIcon {
    ...
    public GroupCallStatusIcon() {
        ...
        this.micDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(24), true, null);
        int i2 = C3632R.raw.hand_2;
        this.shakeHandDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(15), true, null);
    }
