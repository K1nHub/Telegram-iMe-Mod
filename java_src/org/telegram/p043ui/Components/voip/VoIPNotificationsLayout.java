...
public class VoIPNotificationsLayout extends LinearLayout {
    ...
    public int getChildsHight() {
        ...
        return (childCount > 0 ? AndroidUtilities.m104dp(16) : 0) + (childCount * AndroidUtilities.m104dp(32));
    }
    ...
    public static class NotificationView extends FrameLayout {
        ...
        public NotificationView(Context context) {
            ...
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m104dp(16), ColorUtils.setAlphaComponent(-16777216, 102)));
