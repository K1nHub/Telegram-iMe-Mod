...
public class FabBackgroundDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float f = min / 2;
        canvas.drawCircle(f, f, i - AndroidUtilities.m72dp(4), this.bgPaint);
    }
    ...
    protected void onBoundsChange(Rect rect) {
        ...
        paint.setShadowLayer(AndroidUtilities.m73dp(3.33333f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m73dp(0.666f), -1);
        float f = min / 2;
        canvas.drawCircle(f, f, i - AndroidUtilities.m72dp(4), paint);
    }
    ...
    public boolean getPadding(Rect rect) {
        ...
        rect.set(m72dp, m72dp, m72dp, m72dp);
        return true;
    }
}
