...
public class FabBackgroundDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float f = min / 2;
        canvas.drawCircle(f, f, i - AndroidUtilities.m107dp(4), this.bgPaint);
    }
    ...
    protected void onBoundsChange(Rect rect) {
        ...
        float f = min / 2;
        new Canvas(this.shadowBitmap).drawCircle(f, f, i - AndroidUtilities.m107dp(4), new Paint(1));
    }
    ...
    public boolean getPadding(Rect rect) {
        ...
        rect.set(m107dp, m107dp, m107dp, m107dp);
        return true;
    }
}
