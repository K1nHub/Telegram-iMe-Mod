...
public class VoIPStatusTextView extends FrameLayout {
    ...
    public VoIPStatusTextView(Context context) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            this.textView[i].setShadowLayer(AndroidUtilities.m72dp(3), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m73dp(0.6666667f), 1275068416);
        ...
        this.reconnectTextView.setShadowLayer(AndroidUtilities.m72dp(3), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m73dp(0.6666667f), 1275068416);
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString("VoipReconnecting", C3558R.string.VoipReconnecting));
    ...
    public void replaceViews(final View view, final View view2, Runnable runnable) {
        ...
        view2.setTranslationY(AndroidUtilities.m72dp(15));
        ...
        this.animator.addListener(new C57561(view, view2, runnable));
    ...
    public static /* synthetic */ void lambda$replaceViews$1(View view, View view2, ValueAnimator valueAnimator) {
        ...
        view.setTranslationY(AndroidUtilities.m72dp(10) * f2);
        view.setAlpha(floatValue);
        view.setScaleX(f);
        view.setScaleY(f);
        view2.setTranslationY((-AndroidUtilities.m72dp(10)) * floatValue);
        view2.setAlpha(f2);
        view2.setScaleX(f3);
        view2.setScaleY(f3);
    }
    ...
    /* loaded from: classes6.dex */
    public class C57561 extends AnimatorListenerAdapter {
        final /* synthetic */ View val$in;
        final /* synthetic */ Runnable val$onEnd;
        final /* synthetic */ View val$out;

        C57561(View view, View view2, Runnable runnable) {
            this.val$out = view;
            this.val$in = view2;
            ...
            if (charSequence != null) {
                if (charSequence.equals("timer")) {
                    ...
                    voIPStatusTextView3.replaceViews(textViewArr[0], textViewArr[1], new Runnable() { // from class: org.telegram.ui.Components.voip.VoIPStatusTextView$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            VoIPStatusTextView.C57561.this.lambda$onAnimationEnd$0();
                        }
                    });
                }
