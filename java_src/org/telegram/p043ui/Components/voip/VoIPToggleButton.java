...
/* renamed from: org.telegram.ui.Components.voip.VoIPToggleButton */
...
public class VoIPToggleButton extends FrameLayout {
    ...
    public VoIPToggleButton(Context context, float f) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            this.textLayoutContainer.addView(textView, LayoutHelper.createFrame(-1, -2.0f, 0, (float) BitmapDescriptorFactory.HUE_RED, 4.0f + f, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED));
            this.textView[i] = textView;
        }
        this.textView[1].setVisibility(8);
        this.xRefPaint.setColor(-16777216);
        this.xRefPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        this.xRefPaint.setStrokeWidth(AndroidUtilities.m104dp(3));
        this.crossPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
    ...
    */
    protected void onDraw(android.graphics.Canvas r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.voip.VoIPToggleButton.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setData(int i, int i2, int i3, float f, boolean z, String str, boolean z2, boolean z3) {
        ...
        if (this.rippleDrawable == null || z) {
            if (Color.alpha(i3) == 255 && AndroidUtilities.computePerceivedBrightness(i3) > 0.5d) {
                Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m105dp(this.radius), 0, ColorUtils.setAlphaComponent(-16777216, (int) (f * 25.5f)));
                this.rippleDrawable = createSimpleSelectorCircleDrawable;
                createSimpleSelectorCircleDrawable.setCallback(this);
            } else {
                Drawable createSimpleSelectorCircleDrawable2 = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m105dp(this.radius), 0, ColorUtils.setAlphaComponent(-1, (int) (f * 76.5f)));
