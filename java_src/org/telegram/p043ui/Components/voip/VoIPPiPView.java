...
public class VoIPPiPView implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    private void setRelativePosition(float f, float f2) {
        ...
        float m104dp3 = AndroidUtilities.m104dp(60);
        float m104dp4 = AndroidUtilities.m104dp(16);
        ...
        layoutParams.x = (int) ((f * (((f3 - m104dp) - m104dp2) - f5)) - (this.xOffset - m104dp));
        layoutParams.y = (int) ((f2 * (((f4 - m104dp3) - m104dp4) - f6)) - (this.yOffset - m104dp3));
    ...
    public VoIPPiPView(final Context context, int i, int i2, boolean z) {
        ...
        final Drawable drawable = ContextCompat.getDrawable(context, C3634R.C3636drawable.calls_pip_outershadow);
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.voip.VoIPPiPView.4
            ...
            protected void onDraw(Canvas canvas) {
                ...
                drawable.setBounds(VoIPPiPView.this.floatingView.getLeft() - AndroidUtilities.m104dp(2), VoIPPiPView.this.floatingView.getTop() - AndroidUtilities.m104dp(2), VoIPPiPView.this.floatingView.getRight() + AndroidUtilities.m104dp(2), VoIPPiPView.this.floatingView.getBottom() + AndroidUtilities.m104dp(2));
        ...
        if (z) {
            ...
            this.floatingView.addView(this.topShadow, -1, AndroidUtilities.m104dp(60));
            ImageView imageView = new ImageView(context);
            this.closeIcon = imageView;
            imageView.setImageResource(C3634R.C3636drawable.pip_close);
            this.closeIcon.setPadding(AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8));
            this.closeIcon.setContentDescription(LocaleController.getString("Close", C3634R.string.Close));
            this.floatingView.addView(this.closeIcon, LayoutHelper.createFrame(40, 40, 53, 4, 4, 4, 0));
            ImageView imageView2 = new ImageView(context);
            this.enlargeIcon = imageView2;
            imageView2.setImageResource(C3634R.C3636drawable.pip_enlarge);
            this.enlargeIcon.setPadding(AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8));
            this.enlargeIcon.setContentDescription(LocaleController.getString("Open", C3634R.string.Open));
    ...
    public class FloatingView extends FrameLayout {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                setOutlineProvider(new ViewOutlineProvider(this, VoIPPiPView.this) { // from class: org.telegram.ui.Components.voip.VoIPPiPView.FloatingView.1
                    ...
                    public void getOutline(View view, Outline outline) {
                        outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), (1.0f / view.getScaleX()) * AndroidUtilities.m104dp(4));
                    }
                });
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.topPadding = AndroidUtilities.m104dp(60);
            this.bottomPadding = AndroidUtilities.m104dp(16);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            VoIPPiPView.this.currentUserTextureView.setTranslationX((-AndroidUtilities.m104dp(4)) * (1.0f / getScaleX()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView.this.currentUserTextureView.setTranslationY((-AndroidUtilities.m104dp(4)) * (1.0f / getScaleY()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView.this.currentUserTextureView.setRoundCorners(AndroidUtilities.m104dp(8) * (1.0f / getScaleY()) * VoIPPiPView.this.progressToCameraMini);
        ...
        */
        ...
        public void expand(boolean z) {
            ...
            if (z) {
                ...
                ofFloat.addListener(new C58853(z));
                ofFloat.start();
        ...
        /* loaded from: classes6.dex */
        public class C58853 extends AnimatorListenerAdapter {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$3$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        VoIPPiPView.FloatingView.C58853.this.lambda$onAnimationEnd$0(z);
                    }
                }, 64L);
            }
            ...
            public /* synthetic */ void lambda$onAnimationEnd$0(boolean z) {
                ...
                VoIPPiPView.this.expandedAnimationInProgress = false;
                if (z) {
                    AndroidUtilities.runOnUIThread(VoIPPiPView.this.collapseRunnable, C0485C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                }
            }
        }
