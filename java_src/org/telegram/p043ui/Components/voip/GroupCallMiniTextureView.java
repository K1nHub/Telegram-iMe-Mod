...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    public GroupCallMiniTextureView(final GroupCallRenderersContainer groupCallRenderersContainer, ArrayList<GroupCallMiniTextureView> arrayList, final ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        this.pausedVideoDrawable.setOffsets(-AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6));
        ...
        VoIPTextureView voIPTextureView = new VoIPTextureView(groupCallRenderersContainer.getContext(), false, false, true, true) { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView.1
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (!this.renderer.isFirstFrameRendered() || ((this.renderer.getAlpha() != 1.0f && this.blurRenderer.getAlpha() != 1.0f) || GroupCallMiniTextureView.this.videoIsPaused)) {
                    ...
                    if (videoParticipant == call.videoNotAvailableParticipant) {
                        if (groupCallMiniTextureView4.showingInFullscreen || !groupCallRenderersContainer.inFullscreenMode) {
                            float m104dp2 = AndroidUtilities.m104dp(48);
                            textPaint.setAlpha(255);
                            canvas.save();
                            canvas.translate((((getMeasuredWidth() - m104dp2) / 2.0f) - (AndroidUtilities.m104dp(400) / 2.0f)) + (m104dp2 / 2.0f), ((getMeasuredHeight() / 2) - m104dp2) + m104dp2 + AndroidUtilities.m104dp(10));
                        ...
                        int m104dp3 = AndroidUtilities.m104dp(33);
                        ...
                        if (groupCallMiniTextureView5.animateToFullscreen || groupCallMiniTextureView5.showingInFullscreen) {
                            f = m104dp3;
                            m104dp = AndroidUtilities.m104dp(10) + (AndroidUtilities.m104dp(39) * groupCallRenderersContainer.progressToFullscreenMode);
                        } else {
                            f = m104dp3;
                            m104dp = AndroidUtilities.m104dp(10) * Math.max(1.0f - groupCallRenderersContainer.progressToFullscreenMode, (GroupCallMiniTextureView.this.showingAsScrimView || GroupCallMiniTextureView.this.animateToScrimView) ? groupCallRenderersContainer.progressToScrimView : 0.0f);
                        }
                        int i2 = (int) (f + m104dp);
                        ...
                        float measuredHeight = ((getMeasuredHeight() - i2) / 2) - AndroidUtilities.m104dp(28);
                        float m104dp4 = AndroidUtilities.m104dp(17);
                        float m104dp5 = AndroidUtilities.m104dp(74);
                        GroupCallMiniTextureView groupCallMiniTextureView7 = GroupCallMiniTextureView.this;
                        int m104dp6 = (int) ((measuredHeight - ((m104dp4 + (m104dp5 * ((groupCallMiniTextureView7.showingInFullscreen || groupCallMiniTextureView7.animateToFullscreen) ? groupCallRenderersContainer.progressToFullscreenMode : 0.0f))) * f6)) + (AndroidUtilities.m104dp(17) * f2));
                        GroupCallMiniTextureView.this.castingScreenDrawable.setBounds(measuredWidth, m104dp6, measuredWidth + i2, m104dp6 + i2);
                        ...
                        if (f8 <= BitmapDescriptorFactory.HUE_RED && f7 <= BitmapDescriptorFactory.HUE_RED) {
                            ...
                            canvas.drawText(string2, (measuredWidth - (measureText2 / 2.0f)) + (i2 / 2.0f), AndroidUtilities.m104dp(32) + i, textPaint2);
                        }
                        GroupCallMiniTextureView.this.stopSharingTextView.setTranslationY(((AndroidUtilities.m104dp(72) + i) + GroupCallMiniTextureView.this.swipeToBackDy) - this.currentClipVertical);
                        ...
                        if (groupCallRenderersContainer.progressToFullscreenMode < 1.0f && f7 < 1.0f) {
                            ...
                            canvas.save();
                            canvas.translate((measuredWidth - (AndroidUtilities.m104dp(400) / 2.0f)) + (i2 / 2.0f), i + AndroidUtilities.m104dp(10));
                ...
                float measuredHeight2 = (getMeasuredHeight() - this.currentClipVertical) - AndroidUtilities.m104dp(80);
                if (GroupCallMiniTextureView.this.participant != call.videoNotAvailableParticipant) {
                    ...
                    if ((groupCallMiniTextureView11.showingInFullscreen || groupCallMiniTextureView11.animateToFullscreen) && !GroupCallActivity.isLandscapeMode && !GroupCallActivity.isTabletMode) {
                        ...
                        measuredHeight2 -= (AndroidUtilities.m104dp(90) * groupCallRenderersContainer2.progressToFullscreenMode) * (1.0f - groupCallRenderersContainer2.progressToHideUi);
                    }
                ...
                if (GroupCallMiniTextureView.this.videoIsPaused || GroupCallMiniTextureView.this.videoIsPausedProgress != BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (f12 > BitmapDescriptorFactory.HUE_RED) {
                        float m104dp7 = AndroidUtilities.m104dp(48);
                        float measuredWidth2 = (getMeasuredWidth() - m104dp7) / 2.0f;
                        float measuredHeight3 = (getMeasuredHeight() - m104dp7) / 2.0f;
                        if (GroupCallMiniTextureView.this.participant == call.videoNotAvailableParticipant) {
                            measuredHeight3 -= m104dp7 / 2.5f;
                        }
                        RectF rectF = AndroidUtilities.rectTmp;
                        float f13 = measuredHeight3 + m104dp7;
                        rectF.set((int) measuredWidth2, (int) measuredHeight3, (int) (measuredWidth2 + m104dp7), (int) f13);
                        if (f12 != 1.0f) {
                        ...
                        canvas.drawText(string, (measuredWidth2 - (measureText / 2.0f)) + (m104dp7 / 2.0f), f13 + AndroidUtilities.m104dp(16), textPaint);
                    }
                }
            }
        ...
        this.speakingPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
        ...
        imageView.setPadding(AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4));
        ...
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(19), 0, ColorUtils.setAlphaComponent(-1, 100));
        ...
        this.stopSharingTextView.setPadding(AndroidUtilities.m104dp(21), 0, AndroidUtilities.m104dp(21), 0);
        ...
        this.noRtmpStreamTextView.setPadding(AndroidUtilities.m104dp(21), 0, AndroidUtilities.m104dp(21), 0);
        ...
        if (this.attached) {
            ...
            if (this.showingAsScrimView || this.animateToScrimView) {
                ...
                if (!GroupCallActivity.isLandscapeMode && !GroupCallActivity.isTabletMode) {
                    ...
                    y -= (AndroidUtilities.m104dp(90) * groupCallRenderersContainer.progressToFullscreenMode) * (1.0f - groupCallRenderersContainer.progressToHideUi);
                }
            ...
            this.micIconView.setTranslationY(y - AndroidUtilities.m104dp(2));
            if (this.screencastIcon.getVisibility() == 0) {
                this.screencastIcon.setTranslationX((this.textureView.getMeasuredWidth() - (this.textureView.currentClipHorizontal * 2.0f)) - AndroidUtilities.m104dp(32));
                this.screencastIcon.setTranslationY(y - AndroidUtilities.m104dp(2));
            ...
            this.infoContainer.setTranslationX(this.drawFirst ? 0.0f : AndroidUtilities.m104dp(6) * this.parentContainer.progressToFullscreenMode);
        }
        super.dispatchDraw(canvas);
        if (this.attached) {
            ...
            if (f5 > BitmapDescriptorFactory.HUE_RED) {
                ...
                float max = (Math.max((float) BitmapDescriptorFactory.HUE_RED, 1.0f - (Math.abs(this.swipeToBackDy) / AndroidUtilities.m104dp(300))) * 0.1f) + 0.9f;
                canvas.save();
                RectF rectF = AndroidUtilities.rectTmp;
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x00c9, code lost:
        ...
        setTranslationY((((r11.getY() + org.telegram.messenger.AndroidUtilities.m104dp(2)) + r9.getY()) - getTop()) - r12.getTop());
        r8.textureView.setRoundCorners(org.telegram.messenger.AndroidUtilities.m104dp(8));
     */
    ...
    */
    ...
    public void updateSize(int i) {
        int measuredWidth = this.parentContainer.getMeasuredWidth() - AndroidUtilities.m104dp(6);
    ...
    public class NoVideoStubLayout extends View {
        ...
        public NoVideoStubLayout(Context context) {
            ...
            this.tinyWaveDrawable.minRadius = AndroidUtilities.m104dp(76);
            this.tinyWaveDrawable.maxRadius = AndroidUtilities.m104dp(92);
            this.tinyWaveDrawable.generateBlob();
            this.bigWaveDrawable.minRadius = AndroidUtilities.m104dp(80);
            this.bigWaveDrawable.maxRadius = AndroidUtilities.m104dp(95);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float m104dp = AndroidUtilities.m104dp(157);
            this.f1972cx = getMeasuredWidth() >> 1;
            this.f1973cy = (getMeasuredHeight() >> 1) + (GroupCallActivity.isLandscapeMode ? BitmapDescriptorFactory.HUE_RED : (-getMeasuredHeight()) * 0.12f);
            float f = m104dp / 2.0f;
            this.avatarImageReceiver.setRoundRadius((int) f);
            this.avatarImageReceiver.setImageCoords(this.f1972cx - f, this.f1973cy - f, m104dp, m104dp);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.scale(f10, f10, this.f1972cx, this.f1973cy);
            GroupCallActivity.WeavingState weavingState3 = this.currentState;
            if (weavingState3 != null) {
                weavingState3.update((int) (this.f1973cy - AndroidUtilities.m104dp(100)), (int) (this.f1972cx - AndroidUtilities.m104dp(100)), AndroidUtilities.m104dp(200), 16L, this.amplitude);
            }
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.bigWaveDrawable.draw(this.f1972cx, this.f1973cy, canvas, this.paint);
                this.tinyWaveDrawable.draw(this.f1972cx, this.f1973cy, canvas, this.paint);
            }
            canvas.restore();
            float f11 = (this.amplitude * 0.2f) + 1.0f;
            canvas.save();
            canvas.scale(f11, f11, this.f1972cx, this.f1973cy);
