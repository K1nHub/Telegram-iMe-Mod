...
import org.telegram.p043ui.Components.CrossOutDrawable;
...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    public GroupCallMiniTextureView(final GroupCallRenderersContainer groupCallRenderersContainer, ArrayList<GroupCallMiniTextureView> arrayList, final ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(groupCallRenderersContainer.getContext(), C3632R.C3634drawable.calls_video, -1);
        this.pausedVideoDrawable = crossOutDrawable;
        crossOutDrawable.setCrossOut(true, false);
        this.pausedVideoDrawable.setOffsets(-AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(6));
        this.pausedVideoDrawable.setStrokeWidth(AndroidUtilities.dpf2(3.4f));
        this.castingScreenDrawable = groupCallRenderersContainer.getContext().getResources().getDrawable(C3632R.C3634drawable.screencast_big).mutate();
        ...
        final String string = LocaleController.getString("VoipVideoOnPause", C3632R.string.VoipVideoOnPause);
        final StaticLayout staticLayout = new StaticLayout(LocaleController.getString("VoipVideoScreenSharingTwoLines", C3632R.string.VoipVideoScreenSharingTwoLines), textPaint, AndroidUtilities.m107dp(400), Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(call.chatId));
        final StaticLayout staticLayout2 = new StaticLayout(LocaleController.formatString("VoipVideoNotAvailable", C3632R.string.VoipVideoNotAvailable, LocaleController.formatPluralString("Participants", MessagesController.getInstance(this.currentAccount).groupCallVideoMaxParticipants, new Object[0])), textPaint, AndroidUtilities.m107dp(400), Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        final String string2 = LocaleController.getString("VoipVideoScreenSharing", C3632R.string.VoipVideoScreenSharing);
        ...
        VoIPTextureView voIPTextureView = new VoIPTextureView(groupCallRenderersContainer.getContext(), false, false, true, true) { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView.1
            ...
            @Override // org.telegram.p043ui.Components.voip.VoIPTextureView
            ...
            @Override // org.telegram.p043ui.Components.voip.VoIPTextureView, android.view.ViewGroup, android.view.View
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (!this.renderer.isFirstFrameRendered() || ((this.renderer.getAlpha() != 1.0f && this.blurRenderer.getAlpha() != 1.0f) || GroupCallMiniTextureView.this.videoIsPaused)) {
                    ...
                    if (videoParticipant == call.videoNotAvailableParticipant) {
                        if (groupCallMiniTextureView4.showingInFullscreen || !groupCallRenderersContainer.inFullscreenMode) {
                            float m107dp2 = AndroidUtilities.m107dp(48);
                            textPaint.setAlpha(255);
                            canvas.save();
                            canvas.translate((((getMeasuredWidth() - m107dp2) / 2.0f) - (AndroidUtilities.m107dp(400) / 2.0f)) + (m107dp2 / 2.0f), ((getMeasuredHeight() / 2) - m107dp2) + m107dp2 + AndroidUtilities.m107dp(10));
                        ...
                        int m107dp3 = AndroidUtilities.m107dp(33);
                        ...
                        if (groupCallMiniTextureView5.animateToFullscreen || groupCallMiniTextureView5.showingInFullscreen) {
                            f = m107dp3;
                            m107dp = AndroidUtilities.m107dp(10) + (AndroidUtilities.m107dp(39) * groupCallRenderersContainer.progressToFullscreenMode);
                        } else {
                            f = m107dp3;
                            m107dp = AndroidUtilities.m107dp(10) * Math.max(1.0f - groupCallRenderersContainer.progressToFullscreenMode, (GroupCallMiniTextureView.this.showingAsScrimView || GroupCallMiniTextureView.this.animateToScrimView) ? groupCallRenderersContainer.progressToScrimView : 0.0f);
                        }
                        int i2 = (int) (f + m107dp);
                        ...
                        float measuredHeight = ((getMeasuredHeight() - i2) / 2) - AndroidUtilities.m107dp(28);
                        float m107dp4 = AndroidUtilities.m107dp(17);
                        float m107dp5 = AndroidUtilities.m107dp(74);
                        GroupCallMiniTextureView groupCallMiniTextureView7 = GroupCallMiniTextureView.this;
                        int m107dp6 = (int) ((measuredHeight - ((m107dp4 + (m107dp5 * ((groupCallMiniTextureView7.showingInFullscreen || groupCallMiniTextureView7.animateToFullscreen) ? groupCallRenderersContainer.progressToFullscreenMode : 0.0f))) * f6)) + (AndroidUtilities.m107dp(17) * f2));
                        GroupCallMiniTextureView.this.castingScreenDrawable.setBounds(measuredWidth, m107dp6, measuredWidth + i2, m107dp6 + i2);
                        ...
                        if (f8 <= BitmapDescriptorFactory.HUE_RED && f7 <= BitmapDescriptorFactory.HUE_RED) {
                            ...
                            canvas.drawText(string2, (measuredWidth - (measureText2 / 2.0f)) + (i2 / 2.0f), AndroidUtilities.m107dp(32) + i, textPaint2);
                        }
                        GroupCallMiniTextureView.this.stopSharingTextView.setTranslationY(((AndroidUtilities.m107dp(72) + i) + GroupCallMiniTextureView.this.swipeToBackDy) - this.currentClipVertical);
                        ...
                        if (groupCallRenderersContainer.progressToFullscreenMode < 1.0f && f7 < 1.0f) {
                            ...
                            canvas.save();
                            canvas.translate((measuredWidth - (AndroidUtilities.m107dp(400) / 2.0f)) + (i2 / 2.0f), i + AndroidUtilities.m107dp(10));
                ...
                float measuredHeight2 = (getMeasuredHeight() - this.currentClipVertical) - AndroidUtilities.m107dp(80);
                if (GroupCallMiniTextureView.this.participant != call.videoNotAvailableParticipant) {
                    ...
                    if ((groupCallMiniTextureView11.showingInFullscreen || groupCallMiniTextureView11.animateToFullscreen) && !GroupCallActivity.isLandscapeMode && !GroupCallActivity.isTabletMode) {
                        ...
                        measuredHeight2 -= (AndroidUtilities.m107dp(90) * groupCallRenderersContainer2.progressToFullscreenMode) * (1.0f - groupCallRenderersContainer2.progressToHideUi);
                    }
                ...
                if (GroupCallMiniTextureView.this.videoIsPaused || GroupCallMiniTextureView.this.videoIsPausedProgress != BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (f12 > BitmapDescriptorFactory.HUE_RED) {
                        float m107dp7 = AndroidUtilities.m107dp(48);
                        float measuredWidth2 = (getMeasuredWidth() - m107dp7) / 2.0f;
                        float measuredHeight3 = (getMeasuredHeight() - m107dp7) / 2.0f;
                        if (GroupCallMiniTextureView.this.participant == call.videoNotAvailableParticipant) {
                            measuredHeight3 -= m107dp7 / 2.5f;
                        }
                        RectF rectF = AndroidUtilities.rectTmp;
                        float f13 = measuredHeight3 + m107dp7;
                        rectF.set((int) measuredWidth2, (int) measuredHeight3, (int) (measuredWidth2 + m107dp7), (int) f13);
                        if (f12 != 1.0f) {
                        ...
                        canvas.drawText(string, (measuredWidth2 - (measureText / 2.0f)) + (m107dp7 / 2.0f), f13 + AndroidUtilities.m107dp(16), textPaint);
                    }
                }
            }
            ...
            @Override // org.telegram.p043ui.Components.voip.VoIPTextureView, android.widget.FrameLayout, android.view.ViewGroup, android.view.View
            ...
            @Override // org.telegram.p043ui.Components.voip.VoIPTextureView, android.view.View, android.view.ViewParent
        ...
        this.speakingPaint.setStrokeWidth(AndroidUtilities.m107dp(2));
        ...
        imageView.setPadding(AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4));
        imageView.setImageDrawable(ContextCompat.getDrawable(groupCallRenderersContainer.getContext(), C3632R.C3634drawable.voicechat_screencast));
        imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.MULTIPLY));
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(19), 0, ColorUtils.setAlphaComponent(-1, 100));
        ...
        textView.setText(LocaleController.getString("VoipVideoScreenStopSharing", C3632R.string.VoipVideoScreenStopSharing));
        ...
        this.stopSharingTextView.setPadding(AndroidUtilities.m107dp(21), 0, AndroidUtilities.m107dp(21), 0);
        ...
        this.noRtmpStreamTextView.setPadding(AndroidUtilities.m107dp(21), 0, AndroidUtilities.m107dp(21), 0);
        ...
        if (ChatObject.canManageCalls(chat)) {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3632R.string.NoRtmpStreamFromAppOwner)));
        } else {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoRtmpStreamFromAppViewer", C3632R.string.NoRtmpStreamFromAppViewer, chat.title)));
        }
        ...
        if (this.attached) {
            ...
            if (this.showingAsScrimView || this.animateToScrimView) {
                ...
                if (!GroupCallActivity.isLandscapeMode && !GroupCallActivity.isTabletMode) {
                    ...
                    y -= (AndroidUtilities.m107dp(90) * groupCallRenderersContainer.progressToFullscreenMode) * (1.0f - groupCallRenderersContainer.progressToHideUi);
                }
            ...
            this.micIconView.setTranslationY(y - AndroidUtilities.m107dp(2));
            if (this.screencastIcon.getVisibility() == 0) {
                this.screencastIcon.setTranslationX((this.textureView.getMeasuredWidth() - (this.textureView.currentClipHorizontal * 2.0f)) - AndroidUtilities.m107dp(32));
                this.screencastIcon.setTranslationY(y - AndroidUtilities.m107dp(2));
            ...
            this.infoContainer.setTranslationX(this.drawFirst ? 0.0f : AndroidUtilities.m107dp(6) * this.parentContainer.progressToFullscreenMode);
        }
        super.dispatchDraw(canvas);
        if (this.attached) {
            ...
            if (f5 > BitmapDescriptorFactory.HUE_RED) {
                ...
                float max = (Math.max((float) BitmapDescriptorFactory.HUE_RED, 1.0f - (Math.abs(this.swipeToBackDy) / AndroidUtilities.m107dp(300))) * 0.1f) + 0.9f;
                canvas.save();
                RectF rectF = AndroidUtilities.rectTmp;
    ...
    */
    protected void onMeasure(int r16, int r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.voip.GroupCallMiniTextureView.onMeasure(int, int):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:274:0x04eb A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:353:0x0665  */
    ...
    */
    public void updateAttachState(boolean r24) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.voip.GroupCallMiniTextureView.updateAttachState(boolean):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x00c9, code lost:
        ...
        setTranslationY((((r11.getY() + org.telegram.messenger.AndroidUtilities.m107dp(2)) + r9.getY()) - getTop()) - r12.getTop());
        r8.textureView.setRoundCorners(org.telegram.messenger.AndroidUtilities.m107dp(8));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:58:0x0113, code lost:
        if (org.telegram.p043ui.GroupCallActivity.isTabletMode != false) goto L57;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void updatePosition(android.view.ViewGroup r9, android.view.ViewGroup r10, org.telegram.p043ui.Components.RecyclerListView r11, org.telegram.p043ui.Components.voip.GroupCallRenderersContainer r12) {
        /*
            Method dump skipped, instructions count: 435
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.voip.GroupCallMiniTextureView.updatePosition(android.view.ViewGroup, android.view.ViewGroup, org.telegram.ui.Components.RecyclerListView, org.telegram.ui.Components.voip.GroupCallRenderersContainer):void");
    }
    ...
    */
    private void updateIconColor(boolean r11) {
        ...
        L74:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.voip.GroupCallMiniTextureView.updateIconColor(boolean):void");
    }
    ...
    public void updateSize(int i) {
        int measuredWidth = this.parentContainer.getMeasuredWidth() - AndroidUtilities.m107dp(6);
    ...
    public class NoVideoStubLayout extends View {
        ...
        public NoVideoStubLayout(Context context) {
            ...
            this.tinyWaveDrawable.minRadius = AndroidUtilities.m107dp(76);
            this.tinyWaveDrawable.maxRadius = AndroidUtilities.m107dp(92);
            this.tinyWaveDrawable.generateBlob();
            this.bigWaveDrawable.minRadius = AndroidUtilities.m107dp(80);
            this.bigWaveDrawable.maxRadius = AndroidUtilities.m107dp(95);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float m107dp = AndroidUtilities.m107dp(157);
            this.f1986cx = getMeasuredWidth() >> 1;
            this.f1987cy = (getMeasuredHeight() >> 1) + (GroupCallActivity.isLandscapeMode ? BitmapDescriptorFactory.HUE_RED : (-getMeasuredHeight()) * 0.12f);
            float f = m107dp / 2.0f;
            this.avatarImageReceiver.setRoundRadius((int) f);
            this.avatarImageReceiver.setImageCoords(this.f1986cx - f, this.f1987cy - f, m107dp, m107dp);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.scale(f10, f10, this.f1986cx, this.f1987cy);
            GroupCallActivity.WeavingState weavingState3 = this.currentState;
            if (weavingState3 != null) {
                weavingState3.update((int) (this.f1987cy - AndroidUtilities.m107dp(100)), (int) (this.f1986cx - AndroidUtilities.m107dp(100)), AndroidUtilities.m107dp(200), 16L, this.amplitude);
            }
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.bigWaveDrawable.draw(this.f1986cx, this.f1987cy, canvas, this.paint);
                this.tinyWaveDrawable.draw(this.f1986cx, this.f1987cy, canvas, this.paint);
            }
            canvas.restore();
            float f11 = (this.amplitude * 0.2f) + 1.0f;
            canvas.save();
            canvas.scale(f11, f11, this.f1986cx, this.f1987cy);
