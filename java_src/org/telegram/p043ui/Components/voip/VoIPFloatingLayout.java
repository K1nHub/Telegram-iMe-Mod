...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public VoIPFloatingLayout(Context context) {
        ...
        this.mutedDrawable = ContextCompat.getDrawable(context, C3419R.C3421drawable.calls_mute_mini);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() != this.lastH && getMeasuredWidth() != this.lastW) {
            ...
            this.path.addRoundRect(this.rectF, AndroidUtilities.m72dp(4), AndroidUtilities.m72dp(4), Path.Direction.CW);
    ...
    private void updatePadding() {
        this.leftPadding = AndroidUtilities.m72dp(16);
        this.rightPadding = AndroidUtilities.m72dp(16);
        this.topPadding = this.uiVisible ? AndroidUtilities.m72dp(60) : AndroidUtilities.m72dp(16);
        this.bottomPadding = AndroidUtilities.m72dp(this.uiVisible ? 100 : 16) + this.bottomOffset;
    }
    ...
    */
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - ((int) ((AndroidUtilities.m72dp(18) * 1.0f) / getScaleY()));
        canvas.save();
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m72dp(14), this.mutedPaint);
