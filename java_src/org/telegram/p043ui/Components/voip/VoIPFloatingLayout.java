...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public VoIPFloatingLayout(Context context) {
        ...
        this.mutedDrawable = ContextCompat.getDrawable(context, C3632R.C3634drawable.calls_mute_mini);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() != this.lastH && getMeasuredWidth() != this.lastW) {
            ...
            this.path.addRoundRect(this.rectF, AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), Path.Direction.CW);
    ...
    private void updatePadding() {
        this.leftPadding = AndroidUtilities.m107dp(16);
        this.rightPadding = AndroidUtilities.m107dp(16);
        this.topPadding = this.uiVisible ? AndroidUtilities.m107dp(60) : AndroidUtilities.m107dp(16);
        this.bottomPadding = AndroidUtilities.m107dp(this.uiVisible ? 100 : 16) + this.bottomOffset;
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.voip.VoIPFloatingLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - ((int) ((AndroidUtilities.m107dp(18) * 1.0f) / getScaleY()));
        canvas.save();
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m107dp(14), this.mutedPaint);
    ...
    public void saveRelativePosition() {
        ...
        if (getMeasuredWidth() > 0 && this.relativePositionToSetX < BitmapDescriptorFactory.HUE_RED) {
            ...
            this.savedRelativePositionX = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(1.0f, this.savedRelativePositionX));
            this.savedRelativePositionY = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(1.0f, this.savedRelativePositionY));
            return;
        }
