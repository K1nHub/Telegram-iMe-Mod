...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() != this.lastH && getMeasuredWidth() != this.lastW) {
            ...
            this.path.addRoundRect(this.rectF, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), Path.Direction.CW);
    ...
    private void updatePadding() {
        this.leftPadding = AndroidUtilities.m104dp(16);
        this.rightPadding = AndroidUtilities.m104dp(16);
        this.topPadding = this.uiVisible ? AndroidUtilities.m104dp(60) : AndroidUtilities.m104dp(16);
        this.bottomPadding = AndroidUtilities.m104dp(this.uiVisible ? 100 : 16) + this.bottomOffset;
    }
    ...
    */
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - ((int) ((AndroidUtilities.m104dp(18) * 1.0f) / getScaleY()));
        canvas.save();
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m104dp(14), this.mutedPaint);
