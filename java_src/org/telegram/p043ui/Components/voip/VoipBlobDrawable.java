...
/* renamed from: org.telegram.ui.Components.voip.VoipBlobDrawable */
...
public class VoipBlobDrawable extends BlobDrawable {
    ...
    protected void generateBlob(float[] fArr, float[] fArr2, int i, float f) {
        ...
        fArr2[i] = ((360.0f / this.f1821N) * i) + ((((this.random.nextInt() * f) % 100.0f) / 100.0f) * (360.0f / this.f1821N) * 0.05f);
