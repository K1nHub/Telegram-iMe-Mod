...
public class LoadingDrawable extends Drawable {
    ...
    public void setRadiiDp(float f) {
        if (this.usePath != null) {
            this.paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m105dp(f)));
            this.strokePaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m105dp(f)));
            return;
        }
        setRadiiDp(f, f, f, f);
    }
    ...
    public void setRadiiDp(float f, float f2, float f3, float f4) {
        setRadii(AndroidUtilities.m105dp(f), AndroidUtilities.m105dp(f2), AndroidUtilities.m105dp(f3), AndroidUtilities.m105dp(f4));
    }
