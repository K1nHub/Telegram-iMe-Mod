...
public class LoadingDrawable extends Drawable {
    ...
    public void setRadiiDp(float f) {
        if (this.usePath != null) {
            this.paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m108dp(f)));
            this.strokePaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m108dp(f)));
            return;
        }
        setRadiiDp(f, f, f, f);
    }
    ...
    public void setRadiiDp(float f, float f2, float f3, float f4) {
        setRadii(AndroidUtilities.m108dp(f), AndroidUtilities.m108dp(f2), AndroidUtilities.m108dp(f3), AndroidUtilities.m108dp(f4));
    }
    ...
    */
    public void draw(android.graphics.Canvas r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.LoadingDrawable.draw(android.graphics.Canvas):void");
    }
