...
public class ChatActivityEnterView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate {
    ...
    static /* synthetic */ float access$9716(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.combineMessagesAnimationScale + f;
        chatActivityEnterView.combineMessagesAnimationScale = f2;
        return f2;
    }

    static /* synthetic */ float access$9724(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.combineMessagesAnimationScale - f;
        chatActivityEnterView.combineMessagesAnimationScale = f2;
        return f2;
    }
    ...
    public void showChooseCameraPopup() {
        ...
        this.videoMessageCameraOptions.setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m72dp(42), this.backgroundColor)).add(C3473R.C3475drawable.fork_ic_front_camera_24, LocaleController.getInternalString(C3473R.string.frontal_camera_popup_text), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda53
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$showChooseCameraPopup$1();
            }
        }).add(C3473R.C3475drawable.fork_ic_back_camera_24, LocaleController.getInternalString(C3473R.string.main_camera_popup_text), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda63
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void updateSmartBotsButtonIcon() {
        if (this.smartBotsButton != null) {
            if (isPopupShowing() && this.currentPopupContentType == 2) {
                ...
                this.smartBotsButton.setImageResource(C3473R.C3475drawable.input_keyboard);
                return;
            }
            ...
            this.smartBotsButton.setImageResource(C3473R.C3475drawable.ic_bots_all);
        }
    }
    ...
    public void updateFormattingButton() {
        ...
        if (this.accountInstance.getFormattingTextController().getFormattingPanelType() == FormattingPanelType.ALTERNATIVE_WEB) {
            ...
            this.formattingIcon.setImageResource(C3473R.C3475drawable.fork_formatting_messages);
        } else if (isPopupShowing() && this.currentPopupContentType == 3) {
            ...
            this.formattingIcon.setImageResource(C3473R.C3475drawable.input_keyboard);
        } else {
            this.formattingIcon.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chat_messagePanelIcons), PorterDuff.Mode.SRC_IN));
            this.formattingIcon.setImageResource(C3473R.C3475drawable.fork_formatting_messages);
        }
    ...
    private void createFormattingMessagesContainer() {
        ...
        this.formattingMessagesKeyboardContainer = new FormattingMessagesKeyboardContainer(getContext(), this.messageEditText, this.accountInstance.getFormattingTextController(), new FormattingMessagesKeyboardContainer.Listener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.1
            ...
            @Override // com.iMe.p031ui.formatting_messages.FormattingMessagesKeyboardContainer.Listener
            ...
            public void onTranslationYChanged(float f) {
                if (ChatActivityEnterView.this.panelAnimation == null || ChatActivityEnterView.this.animatingContentType != 3) {
                    return;
                }
    ...
    private void createSmartBotsView() {
        ...
        this.smartBotsView.setListener(new C43902());
        SizeNotifierFrameLayout sizeNotifierFrameLayout = this.sizeNotifierLayout;
    ...
    /* loaded from: classes7.dex */
    public class C43902 implements SmartBotsView.Listener {
        C43902() {
        ...
        public void onTextAnswerSelected(TabBotAnswerItem tabBotAnswerItem, int i) {
            ...
            NotificationCenter.getInstance(ChatActivityEnterView.this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botAnswerChosen, tabBotAnswerItem.getBotId(), tabBotAnswerItem.getTag(), Integer.valueOf(i - 1), Long.valueOf(user != null ? user.f1685id : 0L));
        }
        ...
        public void onShopClick() {
            SmartBotHelper.runSafeSmartBotAction(ChatActivityEnterView.this.currentAccount, ChatActivityEnterView.this.parentFragment.getParentActivity(), new Function0() { // from class: org.telegram.ui.Components.ChatActivityEnterView$2$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    ...
                    lambda$onShopClick$0 = ChatActivityEnterView.C43902.this.lambda$onShopClick$0();
    ...
    private void openTranslateDialog() {
        ...
        chatActivity2.showDialog(chatActivity2.createTranslateOutgoingDialog(this.messageEditText.getText().toString(), new Callbacks$Callback1() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda40
    ...
    public class RecordDot extends View {
        ...
        public RecordDot(Context context) {
            ...
            int i = C3473R.raw.chat_audio_record_delete;
    ...
    public class RecordCircle extends View {
        ...
        public RecordCircle(Context context) {
            ...
            r5.lockShadowDrawable = getResources().getDrawable(C3473R.C3475drawable.lock_round_shadow);
            ...
            this.tooltipMessage = LocaleController.getString("SlideUpToLock", C3473R.string.SlideUpToLock);
        ...
        private void checkDrawables() {
            ...
            ChatActivityEnterView.this.micDrawable = getResources().getDrawable(C3473R.C3475drawable.input_mic_pressed).mutate();
            ...
            ChatActivityEnterView.this.cameraDrawable = getResources().getDrawable(C3473R.C3475drawable.input_video_pressed).mutate();
            ...
            ChatActivityEnterView.this.sendDrawable = getResources().getDrawable(C3473R.C3475drawable.attach_send).mutate();
            ...
            ChatActivityEnterView.this.micOutline = getResources().getDrawable(C3473R.C3475drawable.input_mic).mutate();
            ...
            ChatActivityEnterView.this.cameraOutline = getResources().getDrawable(C3473R.C3475drawable.input_video).mutate();
        ...
        public class VirtualViewHelper extends ExploreByTouchHelper {
            ...
            protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                if (i == 1) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Send", C3473R.string.Send));
                } else if (i == 2) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Stop", C3473R.string.Stop));
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Cancel", C3473R.string.Cancel));
                }
            }
        }
    }
    ...
    public ChatActivityEnterView(final Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, final ChatActivity chatActivity, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.updateCombineMessagesRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda43
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.EMOJI_BUTTON_SCALE = new Property<View, Float>(Float.class, "emoji_button_scale") { // from class: org.telegram.ui.Components.ChatActivityEnterView.11
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.ATTACH_LAYOUT_ALPHA = new Property<View, Float>(Float.class, "attach_scale") { // from class: org.telegram.ui.Components.ChatActivityEnterView.12
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.EMOJI_BUTTON_ALPHA = new Property<View, Float>(Float.class, "emoji_button_alpha") { // from class: org.telegram.ui.Components.ChatActivityEnterView.13
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.ATTACH_LAYOUT_TRANSLATION_X = new Property<View, Float>(Float.class, "attach_layout_translation_x") { // from class: org.telegram.ui.Components.ChatActivityEnterView.14
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.MESSAGE_TEXT_TRANSLATION_X = new Property<View, Float>(Float.class, "message_text_translation_x") { // from class: org.telegram.ui.Components.ChatActivityEnterView.15
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.topViewUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ChatActivityEnterView.this.lambda$new$46(valueAnimator);
            }
        };
        ...
        FrameLayout frameLayout = new FrameLayout(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.16
            {
                ChatActivityEnterView.this = this;
            }
        ...
        FrameLayout frameLayout2 = new FrameLayout(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.17
            {
                ChatActivityEnterView.this = this;
            }
        ...
        ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView = new ChatActivityEnterViewAnimatedIconView(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.18
            {
                ChatActivityEnterView.this = this;
            }
        ...
        chatActivityEnterViewAnimatedIconView.setContentDescription(LocaleController.getString(C3473R.string.AccDescrEmojiButton));
        ...
        this.emojiButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda26
        ...
        if (z) {
            ...
            imageView.setImageResource(C3473R.C3475drawable.msg_translate);
            ...
            int i7 = C3473R.string.chat_long_action_translate;
            ...
            this.translateButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda17
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.formattingButton.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda36
            ...
            CrossOutDrawable crossOutDrawable = new CrossOutDrawable(activity, C3473R.C3475drawable.input_notify_on, i3);
            ...
            if (this.silent) {
                i = C3473R.string.AccDescrChanSilentOn;
                str = "AccDescrChanSilentOn";
            } else {
                i = C3473R.string.AccDescrChanSilentOff;
            ...
            this.notifyButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.19
                {
                    ChatActivityEnterView.this = this;
                }
                ...
                public void onClick(View view) {
                    ...
                    if (ChatActivityEnterView.this.notifySilentDrawable == null) {
                        ChatActivityEnterView.this.notifySilentDrawable = new CrossOutDrawable(activity, C3473R.C3475drawable.input_notify_on, Theme.key_chat_messagePanelIcons);
                    }
                    ...
                    if (ChatActivityEnterView.this.silent) {
                        i9 = C3473R.string.AccDescrChanSilentOn;
                        str2 = "AccDescrChanSilentOn";
                    } else {
                        i9 = C3473R.string.AccDescrChanSilentOff;
            ...
            this.smartBotsButton = imageView5;
            imageView5.setScaleType(ImageView.ScaleType.CENTER);
            this.smartBotsButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda23
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.attachButton.setImageResource(C3473R.C3475drawable.msg_input_attach2);
            if (i4 >= 21) {
            ...
            this.attachButton.setContentDescription(LocaleController.getString("AccDescrAttachButton", C3473R.string.AccDescrAttachButton));
        }
        if (this.audioToSend != null) {
            createRecordAudioPanel();
        }
        FrameLayout frameLayout7 = new FrameLayout(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.20
            {
                ChatActivityEnterView.this = this;
            }
        ...
        C439221 c439221 = new C439221(activity, resourcesProvider);
        this.audioVideoButtonContainer = c439221;
        c439221.setSoundEffectsEnabled(false);
        ...
        CloseProgressDrawable2 closeProgressDrawable2 = new CloseProgressDrawable2(this) { // from class: org.telegram.ui.Components.ChatActivityEnterView.22
        ...
        this.cancelBotButton.setContentDescription(LocaleController.getString("Cancel", C3473R.string.Cancel));
        ...
        this.cancelBotButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda25
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$new$13(view);
            }
        });
        ChatActivity chatActivity2 = this.parentFragment;
        if (chatActivity2 != null && chatActivity2.isAllowCombineMessages()) {
            Drawable drawable = activity.getResources().getDrawable(C3473R.C3475drawable.poll_add_circle);
            Drawable drawable2 = activity.getResources().getDrawable(C3473R.C3475drawable.poll_add_plus);
        ...
        if (isTemplatesChannel(true, false)) {
            ...
            int i9 = C3473R.C3475drawable.fork_templates;
            ...
            int i10 = C3473R.C3475drawable.input_schedule;
            ...
            int i11 = C3473R.C3475drawable.ic_send;
        ...
        View view = new View(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.23
                ...
                if (ChatActivityEnterView.this.combineMessagesDrawable != null && (ChatActivityEnterView.this.needCombineMessages || ChatActivityEnterView.this.isCombineMessagesInAnimation)) {
                    ...
                    if (ChatActivityEnterView.this.isCombineMessagesInAnimation) {
                        ...
                        if (ChatActivityEnterView.this.needCombineMessages) {
                            ChatActivityEnterView.access$9716(ChatActivityEnterView.this, ((float) j) / 200.0f);
                            ...
                            ChatActivityEnterView.access$9724(ChatActivityEnterView.this, ((float) j) / 200.0f);
        ...
        this.sendButton.setContentDescription(LocaleController.getString("Send", C3473R.string.Send));
        ...
        this.sendButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda24
            @Override // android.view.View.OnClickListener
        ...
        this.slowModeButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda16
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
        ...
        this.slowModeButton.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda34
            ...
            public final boolean onLongClick(View view2) {
                ...
                lambda$new$16 = ChatActivityEnterView.this.lambda$new$16(view2);
        ...
        if (adjustPanLayoutHelper == null || !adjustPanLayoutHelper.animationInProgress()) {
            if (this.emojiButtonRestricted) {
                ...
                if (botWebViewMenuContainer != null) {
                    ...
                    botWebViewMenuContainer.dismiss(new ChatActivityEnterView$$ExternalSyntheticLambda41(view));
                }
            } else {
                boolean z = true;
    ...
    public /* synthetic */ void lambda$new$8(View view) {
        if (this.accountInstance.getFormattingTextController().getFormattingPanelType() == FormattingPanelType.ALTERNATIVE_WEB) {
            ...
            this.delegate.bottomPanelTranslationYChanged(-AndroidUtilities.m72dp(60));
        } else if (isPopupShowing() && this.currentPopupContentType == 3) {
            showPopup(0, 3);
        } else {
    ...
    /* loaded from: classes7.dex */
    public class C439221 extends FrameLayout {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C439221(Context context, Theme.ResourcesProvider resourcesProvider) {
            super(context);
            ChatActivityEnterView.this = r1;
                    ...
                    if (!ChatActivityEnterView.this.hasRecordVideo || ChatActivityEnterView.this.calledRecordRunnable) {
                        ...
                        if (!ChatActivityEnterView.this.hasRecordVideo || !ChatActivityEnterView.this.isInVideoMode()) {
                            if ((ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) || (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isTemplatesChannel(true, true))) {
                                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda4
                                    ...
                                    public final void didSelectDate(boolean z, int i2, String str) {
                                        ChatActivityEnterView.C439221.lambda$onTouchEvent$0(z, i2, str);
                                    }
                                ...
                                }, new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda3
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        ChatActivityEnterView.C439221.lambda$onTouchEvent$1();
                                    }
                        ...
                        AndroidUtilities.runOnUIThread(chatActivityEnterView3.moveToSendStateRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChatActivityEnterView.C439221.this.lambda$onTouchEvent$2();
                            }
                        }, 200L);
                    }
                        ...
                        if ((((motionEvent.getX() + ChatActivityEnterView.this.audioVideoButtonContainer.getX()) - ChatActivityEnterView.this.startedDraggingX) / ChatActivityEnterView.this.distCanMove) + 1.0f < 0.45d) {
                            ...
                            if (!ChatActivityEnterView.this.hasRecordVideo || !ChatActivityEnterView.this.isInVideoMode()) {
                                if (!ChatActivityEnterView.this.sendVoiceEnabled) {
                                    ...
                                    if ((ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) || (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isTemplatesChannel(true, true))) {
                                        AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda5
                                            @Override // org.telegram.p043ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                                            public final void didSelectDate(boolean z, int i2, String str) {
                                                ChatActivityEnterView.C439221.lambda$onTouchEvent$3(z, i2, str);
                                            }
                                            ...
                                            @Override // java.lang.Runnable
                                            public final void run() {
                                                ChatActivityEnterView.C439221.lambda$onTouchEvent$4();
                                            }
                                        }, this.val$resourcesProvider, ChatActivityEnterView.this.parentFragment);
                                    }
                                    ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                            ...
                            AndroidUtilities.runOnUIThread(chatActivityEnterView4.moveToSendStateRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda1
                                @Override // java.lang.Runnable
                                public final void run() {
                                    ChatActivityEnterView.C439221.this.lambda$onTouchEvent$5();
                                }
    ...
    public /* synthetic */ boolean lambda$new$16(View view) {
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption == null || editTextCaption.length() <= 0) {
            return false;
        }
    ...
    private void createScheduledButton() {
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3473R.C3475drawable.input_calendar1).mutate();
        Drawable mutate2 = getContext().getResources().getDrawable(C3473R.C3475drawable.input_calendar2).mutate();
        ...
        this.scheduledButton.setContentDescription(LocaleController.getString("ScheduledMessages", C3473R.string.ScheduledMessages));
        ...
        this.scheduledButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda19
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$createScheduledButton$17(view);
            }
        });
    }

    public /* synthetic */ void lambda$createScheduledButton$17(View view) {
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
        if (chatActivityEnterViewDelegate != null) {
    ...
    private void createGiftButton() {
        ...
        imageView.setImageResource(C3473R.C3475drawable.msg_input_gift);
        ...
        this.giftButton.setContentDescription(LocaleController.getString(C3473R.string.GiftPremium));
        ...
        this.giftButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda28
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$createGiftButton$18(view);
            }
        });
    }

    public /* synthetic */ void lambda$createGiftButton$18(View view) {
    ...
    private void createBotButton() {
        ...
        this.botButtonDrawable.setIcon(C3473R.C3475drawable.input_bot2, false);
        ...
        this.botButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$createBotButton$19(view);
            }
        });
    }

    public /* synthetic */ void lambda$createBotButton$19(View view) {
    ...
    private void createDoneButton() {
        ...
        this.doneButtonContainer.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda21
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$createDoneButton$20(view);
            }
        });
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3473R.C3475drawable.input_done).mutate();
        ...
        this.doneButtonImage.setContentDescription(LocaleController.getString("Done", C3473R.string.Done));
    ...
    public /* synthetic */ void lambda$createDoneButton$20(View view) {
        doneEditingMessage();
    }
    ...
    private void createExpandStickersButton() {
        ...
        ImageView imageView = new ImageView(this, getContext()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.24
            @Override // android.view.View
            public boolean onTouchEvent(MotionEvent motionEvent) {
                if (getAlpha() <= BitmapDescriptorFactory.HUE_RED) {
                    return false;
        ...
        this.expandStickersButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda29
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$createExpandStickersButton$21(view);
            }
        });
        this.expandStickersButton.setContentDescription(LocaleController.getString("AccDescrExpandPanel", C3473R.string.AccDescrExpandPanel));
    }
    ...
    private void createRecordAudioPanel() {
        ...
        FrameLayout frameLayout = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.25
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.recordDeleteImageView.setAnimation(C3473R.raw.chat_audio_record_delete_2, 28, 28);
        this.recordDeleteImageView.getAnimatedDrawable().setInvalidateOnProgressSet(true);
        updateRecordedDeleteIconColors();
        this.recordDeleteImageView.setContentDescription(LocaleController.getString("Delete", C3473R.string.Delete));
        if (Build.VERSION.SDK_INT >= 21) {
        ...
        this.recordDeleteImageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda14
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.videoTimelineView.setDelegate(new VideoTimelineView.VideoTimelineViewDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView.26
            {
                ChatActivityEnterView.this = this;
            }
        ...
        View view = new View(getContext()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.27
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.recordedAudioPlayButton.setContentDescription(LocaleController.getString("AccActionPlay", C3473R.string.AccActionPlay));
        this.recordedAudioPanel.addView(this.recordedAudioPlayButton, LayoutHelper.createFrame(48, 48, 83, 48, 0, 13, 0));
        this.recordedAudioPlayButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda12
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChatActivityEnterView.this.lambda$createRecordAudioPanel$23(view2);
            }
        });
    ...
    public /* synthetic */ void lambda$createRecordAudioPanel$23(View view) {
        if (this.audioToSend == null) {
            return;
        }
        ...
        this.recordedAudioPlayButton.setContentDescription(LocaleController.getString("AccActionPause", C3473R.string.AccActionPause));
    }
    ...
    public void createSenderSelectView() {
        ...
        senderSelectView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$createSenderSelectView$31(view);
            }
        });
    ...
    public /* synthetic */ void lambda$createSenderSelectView$31(View view) {
        int i;
        int i2;
        if (botCommandsMenuIsShowing()) {
            ...
            this.onEmojiSearchClosed = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda62
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (this.delegate.getSendAsPeers() != null) {
                ...
                SenderSelectPopup senderSelectPopup2 = new SenderSelectPopup(getContext(), this.parentFragment, messagesController, chatFull, this.delegate.getSendAsPeers(), new SenderSelectPopup.OnSelectCallback() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda77
                    ...
                    public final void onPeerSelected(RecyclerView recyclerView, SenderSelectPopup.SenderView senderView, TLRPC$Peer tLRPC$Peer) {
                        ChatActivityEnterView.this.lambda$createSenderSelectView$30(chatFull, messagesController, recyclerView, senderView, tLRPC$Peer);
                    }
    ...
    public /* synthetic */ void lambda$createSenderSelectView$30(TLRPC$ChatFull tLRPC$ChatFull, MessagesController messagesController, RecyclerView recyclerView, final SenderSelectPopup.SenderView senderView, TLRPC$Peer tLRPC$Peer) {
        TLRPC$User user;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda71
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$createSenderSelectView$29(simpleAvatarView, iArr, senderView);
            }
        }, isSelected ? 0L : 200L);
    }

    public /* synthetic */ void lambda$createSenderSelectView$29(final SimpleAvatarView simpleAvatarView, int[] iArr, SenderSelectPopup.SenderView senderView) {
        if (this.senderSelectPopupWindow == null) {
            return;
        }
        final Dialog dialog = new Dialog(getContext(), C3473R.style.TransparentDialogNoAnimation);
        FrameLayout frameLayout = new FrameLayout(getContext());
        ...
        if (i >= 21) {
            ...
            dialog.getWindow().clearFlags(C0479C.BUFFER_FLAG_FIRST_SAMPLE);
        ...
        simpleAvatarView.getViewTreeObserver().addOnDrawListener(new ViewTreeObserver$OnDrawListenerC440029(this, simpleAvatarView, senderView));
        dialog.show();
    ...
    /* loaded from: classes7.dex */
    public class ViewTreeObserver$OnDrawListenerC440029 implements ViewTreeObserver.OnDrawListener {
        final /* synthetic */ SimpleAvatarView val$avatar;
        final /* synthetic */ SenderSelectPopup.SenderView val$senderView;

        ViewTreeObserver$OnDrawListenerC440029(ChatActivityEnterView chatActivityEnterView, SimpleAvatarView simpleAvatarView, SenderSelectPopup.SenderView senderView) {
        ...
        public void onDraw() {
            ...
            simpleAvatarView.post(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$29$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.ViewTreeObserver$OnDrawListenerC440029.this.lambda$onDraw$0(simpleAvatarView, senderView);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$createSenderSelectView$28(final Dialog dialog, SimpleAvatarView simpleAvatarView, float f, float f2, DynamicAnimation dynamicAnimation, boolean z, float f3, float f4) {
        if (dialog.isShowing()) {
            simpleAvatarView.setTranslationX(f);
            simpleAvatarView.setTranslationY(f2);
            this.senderSelectView.setProgress(BitmapDescriptorFactory.HUE_RED, false);
    ...
    private void createBotCommandsMenuButton() {
        ...
        botCommandsMenuView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda30
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$createBotCommandsMenuButton$32(view);
            }
        });
    ...
    public /* synthetic */ void lambda$createBotCommandsMenuButton$32(View view) {
        ...
        if (!hasBotWebView()) {
            ...
            if (this.emojiViewVisible || this.botKeyboardViewVisible) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda58
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void showRestrictedHint() {
        if (DialogObject.isChatDialog(this.dialog_id)) {
            BulletinFactory.m32of(this.parentFragment).createSimpleBulletin(C3473R.raw.passcode_lock_close, LocaleController.formatString("SendPlainTextRestrictionHint", C3473R.string.SendPlainTextRestrictionHint, ChatObject.getAllowedSendString(this.accountInstance.getMessagesController().getChat(Long.valueOf(-this.dialog_id)))), 3).show();
        }
    }
    ...
    public boolean onSendLongClick(View view) {
        ...
        this.sendPopupLayout.setDispatchKeyEventListener(new ActionBarPopupWindow.OnDispatchKeyEventListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda73
        ...
        if (z5) {
            ...
            if (SharedConfig.isCombineMessagesEnabled) {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getInternalString(C3473R.string.combine_messages_disable), C3473R.C3475drawable.fork_disable_combine_messages);
            } else {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getInternalString(C3473R.string.combine_messages_enable), C3473R.C3475drawable.fork_enable_combine_messages);
            }
            actionBarMenuSubItem.setMinimumWidth(AndroidUtilities.m72dp(196));
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda31
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        if (z6) {
            ...
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getInternalString(C3473R.string.combine_messages_send_without_combine), C3473R.C3475drawable.fork_disable_combine_messages);
            actionBarMenuSubItem2.setMinimumWidth(AndroidUtilities.m72dp(196));
            actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda33
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        if (z7) {
            ...
            actionBarMenuSubItem3.setTextAndIcon(LocaleController.getInternalString(C3473R.string.sending_settings_send_add_reactions), C3473R.C3475drawable.fork_ic_reactions);
            actionBarMenuSubItem3.setMinimumWidth(AndroidUtilities.m72dp(196));
            actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda18
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        if (z8) {
            ...
            actionBarMenuSubItem4.setTextAndIcon(LocaleController.getInternalString(C3473R.string.sending_settings_translation_enable_item_title), C3473R.C3475drawable.msg_translate);
            actionBarMenuSubItem4.setMinimumWidth(AndroidUtilities.m72dp(196));
            actionBarMenuSubItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda15
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        if (z3) {
            ...
            if (z2) {
                actionBarMenuSubItem5.setTextAndIcon(LocaleController.getString("SetReminder", C3473R.string.SetReminder), C3473R.C3475drawable.msg_calendar2);
            } else {
                actionBarMenuSubItem5.setTextAndIcon(LocaleController.getString("ScheduleMessage", C3473R.string.ScheduleMessage), C3473R.C3475drawable.msg_calendar2);
            }
            actionBarMenuSubItem5.setMinimumWidth(AndroidUtilities.m72dp(196));
            actionBarMenuSubItem5.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda20
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
            ...
            if (!z2 && this.dialog_id > 0) {
                ...
                actionBarMenuSubItem6.setTextAndIcon(LocaleController.getString("SendWhenOnline", C3473R.string.SendWhenOnline), C3473R.C3475drawable.msg_online);
                this.sendWhenOnlineButton.setMinimumWidth(AndroidUtilities.m72dp(196));
                this.sendWhenOnlineButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda32
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
        ...
        if (z4) {
            ...
            if (this.parentFragment != null && ToolsController.getInstance(this.currentAccount).isSilentSendingEnabledForDialog(this.parentFragment.getDialogId())) {
                actionBarMenuSubItem7.setTextAndIcon(LocaleController.getInternalString(C3473R.string.send_with_sound), C3473R.C3475drawable.input_notify_on);
            } else {
                actionBarMenuSubItem7.setTextAndIcon(LocaleController.getString("SendWithoutSound", C3473R.string.SendWithoutSound), C3473R.C3475drawable.input_notify_off);
            }
            actionBarMenuSubItem7.setMinimumWidth(AndroidUtilities.m72dp(196));
            actionBarMenuSubItem7.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda27
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        ActionBarPopupWindow actionBarPopupWindow = new ActionBarPopupWindow(this.sendPopupLayout, -2, -2) { // from class: org.telegram.ui.Components.ChatActivityEnterView.35
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.sendPopupWindow.setAnimationStyle(C3473R.style.PopupContextAnimation2);
    ...
    private void createBotCommandsMenuContainer() {
        ...
        BotCommandsMenuContainer botCommandsMenuContainer = new BotCommandsMenuContainer(getContext()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.36
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.botCommandsMenuContainer.listView.setOnItemClickListener(new C440937());
        this.botCommandsMenuContainer.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.38
            {
                ChatActivityEnterView.this = this;
            }
    ...
    /* loaded from: classes7.dex */
    public class C440937 implements RecyclerListView.OnItemClickListener {
        C440937() {
            ChatActivityEnterView.this = r1;
        }
        ...
        public void onItemClick(View view, int i) {
            if (view instanceof TemplatesHeaderCell) {
                ...
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.dialog_id, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$37$$ExternalSyntheticLambda0
                    @Override // org.telegram.p043ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                    public final void didSelectDate(boolean z, int i2, String str) {
                        ChatActivityEnterView.C440937.this.lambda$onItemClick$0(command, z, i2, str);
                    }
    ...
    private void createBotWebViewMenuContainer() {
        ...
        BotWebViewMenuContainer botWebViewMenuContainer = new BotWebViewMenuContainer(getContext(), this) { // from class: org.telegram.ui.Components.ChatActivityEnterView.39
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.botWebViewMenuContainer.setOnDismissGlobalListener(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda59
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$createBotWebViewMenuContainer$44();
            }
        });
    }

    public /* synthetic */ void lambda$createBotWebViewMenuContainer$44() {
        ...
        public void onSelectionChanged(int i, int i2) {
            ...
            if (ChatActivityEnterView.this.delegate != null) {
                if (ChatActivityEnterView.this.accountInstance.getFormattingTextController().getFormattingPanelType() != FormattingPanelType.DEFAULT) {
                    ...
                    if (ChatActivityEnterView.this.accountInstance.getFormattingTextController().getFormattingPanelType() != FormattingPanelType.ALTERNATIVE_KEYBOARD || ChatActivityEnterView.this.formattingMessagesKeyboardContainer == null) {
                        if (ChatActivityEnterView.this.accountInstance.getFormattingTextController().getFormattingPanelType() == FormattingPanelType.ALTERNATIVE_WEB && ChatActivityEnterView.this.formattingMessagesWeb != null) {
    ...
    private void createMessageEditText() {
        ...
        this.messageEditText.setDelegate(new EditTextCaption.EditTextCaptionDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda76
            ...
            public final void onSpansChanged() {
                ChatActivityEnterView.this.lambda$createMessageEditText$45();
            }
        });
        ...
        this.messageEditText.addTextChangedListener(new C441542());
    ...
    /* loaded from: classes7.dex */
    public class C441542 implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            ...
            if (i3 == 0 && ChatActivityEnterView.this.isFormattingMessagesContainerVisible) {
                ChatActivityEnterView.this.showPopup(0, 3, true);
            }
            if (ChatActivityEnterView.this.emojiView != null) {
        ...
        */
        public void afterTextChanged(android.text.Editable r11) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.ChatActivityEnterView.C441542.afterTextChanged(android.text.Editable):void");
        }
    ...
    public void setRecordVideoButtonVisible(boolean z, boolean z2) {
        ...
        this.audioVideoSendButton.setContentDescription(LocaleController.getString(isInVideoMode() ? C3473R.string.AccDescrVideoMessage : C3473R.string.AccDescrVoiceMessage));
        this.audioVideoButtonContainer.setContentDescription(LocaleController.getString(isInVideoMode() ? C3473R.string.AccDescrVideoMessage : C3473R.string.AccDescrVoiceMessage));
    ...
    public void updateSlowModeText() {
        ...
        if (tLRPC$ChatFull != null && tLRPC$ChatFull.slowmode_seconds != 0 && tLRPC$ChatFull.slowmode_next_send_date <= currentTime && ((isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.currentAccount).isUploadingMessageIdDialog(this.dialog_id)) || SendMessagesHelper.getInstance(this.currentAccount).isSendingMessageIdDialog(this.dialog_id))) {
            if (!ChatObject.hasAdminRights(this.accountInstance.getMessagesController().getChat(Long.valueOf(this.info.f1523id)))) {
            ...
            if (i2 >= 2147483646) {
                if (this.info != null) {
                    this.accountInstance.getMessagesController().loadFullChat(this.info.f1523id, 0, true);
                }
                i = 0;
            } else {
                i = i2 - currentTime;
        ...
        if (this.slowModeTimer != 0 && i > 0) {
            ...
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda54
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$new$46(ValueAnimator valueAnimator) {
    ...
    private void showTopView(boolean z, boolean z2, boolean z3) {
        if (this.topView == null || this.topViewShowed || getVisibility() != 0) {
            ...
            if (frameLayout == null || frameLayout.getVisibility() != 0) {
                if ((this.forceShowSendButton && !z2) || this.smartBotsViewVisible || this.isFormattingMessagesContainerVisible) {
                    return;
                }
                openKeyboard();
                return;
        ...
        if (!z3 && z && z4 && !this.keyboardVisible && !isPopupShowing()) {
            ...
            Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda51
                @Override // java.lang.Runnable
                public final void run() {
        ...
        if (!this.allowShowTopView && this.delegate != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda46
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.this.lambda$showTopView$48();
                }
            }, 300L);
        }
    ...
    public /* synthetic */ void lambda$showTopView$48() {
    ...
    private void onWindowSizeChanged() {
        ...
        if (this.topView != null) {
            if (height < AndroidUtilities.m72dp(72) + C3541ActionBar.getCurrentActionBarHeight()) {
                if (this.allowShowTopView) {
    ...
    public void updateRecordButton(TLRPC$Chat tLRPC$Chat, TLRPC$UserFull tLRPC$UserFull) {
        ...
        if (tLRPC$Chat != null) {
            ...
            if (!this.emojiButtonRestricted && (emojiView = this.emojiView) != null) {
                emojiView.setStickersBanned(!ChatObject.canSendPlain(tLRPC$Chat), !ChatObject.canSendStickers(tLRPC$Chat), tLRPC$Chat.f1522id);
                this.emojiView.setGifsBanned(!ChatObject.canSendGifs(tLRPC$Chat), tLRPC$Chat.f1522id);
            }
    ...
    public void onPause() {
        ...
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda64
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$onPause$49();
            }
        };
    ...
    public /* synthetic */ void lambda$onPause$49() {
        ChatActivity chatActivity = this.parentFragment;
    ...
    public void updateFieldHint(boolean z) {
        ...
        if (!this.sendPlainEnabled && !isEditingMessage()) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(" d " + LocaleController.getString("PlainTextRestrictedHint", C3473R.string.PlainTextRestrictedHint));
            spannableStringBuilder.setSpan(new ColoredImageSpan(C3473R.C3475drawable.msg_mini_lock3), 1, 2, 0);
        ...
        if (messageObject2 != null && (tLRPC$ReplyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(tLRPC$ReplyMarkup2.placeholder)) {
            ...
            this.messageEditText.setHintText(this.editingCaption ? LocaleController.getString("Caption", C3473R.string.Caption) : LocaleController.getString("TypeMessage", C3473R.string.TypeMessage));
            ...
            if (DialogObject.isChatDialog(this.dialog_id)) {
                ...
                if (chat == null || ChatObject.getSendAsPeerId(chat, chatFull) != chat.f1522id) {
                    z3 = false;
                }
            } else {
                z3 = false;
            ...
            if (z3) {
                this.messageEditText.setHintText(LocaleController.getString("SendAnonymously", C3473R.string.SendAnonymously));
                return;
            }
            ChatActivity chatActivity = this.parentFragment;
            if (chatActivity != null && chatActivity.isThreadChat()) {
                ...
                if (!chatActivity2.isTopic) {
                    if (chatActivity2.isReplyChatComment()) {
                        this.messageEditText.setHintText(LocaleController.getString("Comment", C3473R.string.Comment));
                        return;
                    } else {
                        this.messageEditText.setHintText(LocaleController.getString("Reply", C3473R.string.Reply));
                        return;
                    }
                }
            }
            if (z2) {
                if (this.parentFragment != null && isTemplatesChannel(false, false)) {
                    this.messageEditText.setHintText(LocaleController.getInternalString(C3473R.string.chat_template));
                    return;
                }
                ChatActivity chatActivity3 = this.parentFragment;
                if (chatActivity3 != null && chatActivity3.isInAlbumMode()) {
                    this.messageEditText.setHintText(LocaleController.getString("TypeMessage", C3473R.string.TypeMessage));
                    return;
                } else if (this.silent) {
                    this.messageEditText.setHintText(LocaleController.getString("ChannelSilentBroadcast", C3473R.string.ChannelSilentBroadcast), z);
                    return;
                } else {
                    this.messageEditText.setHintText(LocaleController.getString("ChannelBroadcast", C3473R.string.ChannelBroadcast), z);
                    return;
                }
            }
            this.messageEditText.setHintText(LocaleController.getString("TypeMessage", C3473R.string.TypeMessage));
    ...
    public void sendMessageInternal(final boolean z, final int i, boolean z2, final String str, boolean z3) {
        ...
        if (chatActivity2 != null && chatActivity2.isInMultipleFilesSending()) {
            ...
            if (z2 && showConfirmAlert(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda72
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.this.lambda$sendMessageInternal$50(z, i);
                }
            })) {
                return;
            }
            if (this.videoToSendMessageObject != null) {
                ...
                if (chatActivity4 != null && (currentChat = chatActivity4.getCurrentChat()) != null && currentChat.slowmode_enabled && !ChatObject.hasAdminRights(currentChat)) {
                    if (text.length() > this.accountInstance.getMessagesController().maxMessageLength) {
                        AlertsCreator.showSimpleAlert(this.parentFragment, LocaleController.getString("Slowmode", C3473R.string.Slowmode), LocaleController.getString("SlowmodeSendErrorTooLong", C3473R.string.SlowmodeSendErrorTooLong), this.resourcesProvider);
                        return;
                    } else if (this.forceShowSendButton && text.length() > 0) {
                        AlertsCreator.showSimpleAlert(this.parentFragment, LocaleController.getString("Slowmode", C3473R.string.Slowmode), LocaleController.getString("SlowmodeSendError", C3473R.string.SlowmodeSendError), this.resourcesProvider);
                        return;
                    }
                }
                ...
                if (this.needCombineMessages && z3 && text != null && i == 0 && (chatActivity = this.parentFragment) != null) {
                    ...
                    if (this.delegate.hasForwardingMessages() || ((i != 0 && !isInScheduleMode()) || isInScheduleMode())) {
                        ...
                        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda67
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChatActivityEnterView.this.lambda$sendMessageInternal$51(text, z, i, str);
                            }
                        };
    ...
    public /* synthetic */ void lambda$sendMessageInternal$50(boolean z, int i) {
        sendMessageInternal(z, i, false);
    }

    public /* synthetic */ void lambda$sendMessageInternal$51(CharSequence charSequence, boolean z, int i, String str) {
    ...
    */
    ...
    public static /* synthetic */ void lambda$checkPremiumAnimatedEmoji$52(BaseFragment baseFragment) {
    ...
    public void showCaptionLimitBulletin() {
        ...
        BulletinFactory.m32of(this.parentFragment).createCaptionLimitBulletin(MessagesController.getInstance(this.currentAccount).captionLengthLimitPremium, new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda45
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$showCaptionLimitBulletin$53();
            }
        }).show();
    }

    public /* synthetic */ void lambda$showCaptionLimitBulletin$53() {
        ChatActivity chatActivity = this.parentFragment;
        if (chatActivity != null) {
            ...
            while (true) {
                ...
                if (this.delegate.hasForwardingMessages()) {
                    ...
                    if (editTextCaption != null) {
                        ...
                        sendAnimationData2.f1457x = this.location[0] + AndroidUtilities.m72dp(11);
                        sendAnimationData2.f1458y = this.location[1] + AndroidUtilities.m72dp(19);
                    } else {
                        sendAnimationData2.f1457x = AndroidUtilities.m72dp(59);
                        sendAnimationData2.f1458y = AndroidUtilities.displaySize.y - AndroidUtilities.m72dp(19);
                    }
    ...
    */
    ...
    private void createRecordPanel() {
        ...
        this.recordPanel.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda37
            @Override // android.view.View.OnTouchListener
    ...
    */
    ...
    public /* synthetic */ void lambda$setEditingMessageObject$57(CharSequence charSequence) {
        ...
        if (z) {
            ...
            if (botWebViewMenuContainer == null || botWebViewMenuContainer.getVisibility() == 8) {
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda50
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatActivityEnterView.this.lambda$setFieldFocused$58();
                    }
                };
    ...
    public /* synthetic */ void lambda$setFieldFocused$58() {
        EditTextCaption editTextCaption;
    ...
    */
        ...
        if (DialogObject.isChatDialog(this.dialog_id)) {
            ...
            if (this.notifyButton != null) {
                ...
                if (this.notifySilentDrawable == null) {
                    this.notifySilentDrawable = new CrossOutDrawable(getContext(), C3473R.C3475drawable.input_notify_on, Theme.key_chat_messagePanelIcons);
                }
                this.notifySilentDrawable.setCrossOut(this.silent, false);
        ...
        if (tLRPC$Peer != null) {
            if (tLRPC$Peer.channel_id != 0) {
                ...
                if (chat != null && (senderSelectView2 = this.senderSelectView) != null) {
                    ...
                    this.senderSelectView.setContentDescription(LocaleController.formatString(C3473R.string.AccDescrSendAs, chat.title));
                }
            } else {
                ...
                if (user != null && (senderSelectView = this.senderSelectView) != null) {
                    ...
                    this.senderSelectView.setContentDescription(LocaleController.formatString(C3473R.string.AccDescrSendAs, ContactsController.formatName(user.first_name, user.last_name)));
                }
            }
        }
            ...
            if (this.parentFragment.getOtherSameChatsDiff() == 0 && this.parentFragment.fragmentOpened && z) {
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda5
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatActivityEnterView.this.lambda$updateSendAsButton$59(f6, f7, f8, f9, valueAnimator2);
                    }
                });
                final boolean z4 = z3;
                final float f10 = f4;
    ...
    public /* synthetic */ void lambda$updateSendAsButton$59(float f, float f2, float f3, float f4, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    private void updateBotButton(boolean z) {
        ...
        if (this.isChat) {
            ...
            if (hasBotWebView || this.hasBotCommands || this.botReplyMarkup != null) {
                if (this.botReplyMarkup != null) {
                    if (isPopupShowing() && this.currentPopupContentType == 1 && this.botReplyMarkup.is_persistent) {
                        ...
                        this.botButtonDrawable.setIcon(C3473R.C3475drawable.input_bot2, true);
                        this.botButton.setContentDescription(LocaleController.getString("AccDescrBotKeyboard", C3473R.string.AccDescrBotKeyboard));
                    }
                } else if (!z2) {
                    createBotButton();
                    this.botButtonDrawable.setIcon(C3473R.C3475drawable.input_bot1, true);
                    this.botButton.setContentDescription(LocaleController.getString("AccDescrBotCommands", C3473R.string.AccDescrBotCommands));
                    this.botButton.setVisibility(0);
                } else {
            ...
            if (botCommandsMenuView != null) {
                ...
                updateTemplatesButton();
                boolean menuText = this.botCommandsMenuButton.setMenuText(this.botMenuButtonType == BotMenuButtonType.COMMANDS ? LocaleController.getString(C3473R.string.BotsMenuTitle) : this.botMenuWebViewTitle);
    ...
    */
    ...
    public /* synthetic */ void lambda$setButtons$60(TLRPC$KeyboardButton tLRPC$KeyboardButton) {
        ChatActivity chatActivity;
            ...
            if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonRequestPoll) {
                ...
                final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView.65
                    ...
                    public void run() {
                        ...
                        botWebViewSheet.requestWebView(i, j4, j5, str2, str3, z ? 1 : 0, messageObject3 != null ? messageObject3.messageOwner.f1546id : 0, false);
                        botWebViewSheet.show();
                    }
                };
                if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, j3)) {
                    ...
                    AlertsCreator.createBotLaunchAlert(this.parentFragment, MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.dialog_id)), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda69
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatActivityEnterView.this.lambda$didPressedBotButton$61(runnable, j3);
                        }
                    }, null);
                }
            } else if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonRequestGeoLocation) {
                AlertDialog.Builder builder = new AlertDialog.Builder(this.parentActivity);
                builder.setTitle(LocaleController.getString("ShareYouLocationTitle", C3473R.string.ShareYouLocationTitle));
                builder.setMessage(LocaleController.getString("ShareYouLocationInfo", C3473R.string.ShareYouLocationInfo));
                builder.setPositiveButton(LocaleController.getString("OK", C3473R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda8
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        ChatActivityEnterView.this.lambda$didPressedBotButton$62(messageObject2, tLRPC$KeyboardButton, dialogInterface, i);
                    }
                });
                ...
                if (tLRPC$KeyboardButton.same_peer) {
                    ...
                    dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda78
                        ...
                        public final boolean didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, TopicsFragment topicsFragment, Callbacks$Callback1 callbacks$Callback1) {
                            ...
                            lambda$didPressedBotButton$63 = ChatActivityEnterView.this.lambda$didPressedBotButton$63(messageObject2, tLRPC$KeyboardButton, dialogsActivity2, arrayList, charSequence, z, topicsFragment, callbacks$Callback1);
                            return lambda$didPressedBotButton$63;
                        }
                    });
    ...
    public /* synthetic */ void lambda$didPressedBotButton$61(Runnable runnable, long j) {
        runnable.run();
        SharedPrefsHelper.setWebViewConfirmShown(this.currentAccount, j, true);
    }

    public /* synthetic */ void lambda$didPressedBotButton$62(MessageObject messageObject, TLRPC$KeyboardButton tLRPC$KeyboardButton, DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ boolean lambda$didPressedBotButton$63(MessageObject messageObject, TLRPC$KeyboardButton tLRPC$KeyboardButton, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, TopicsFragment topicsFragment, Callbacks$Callback1 callbacks$Callback1) {
        if (callbacks$Callback1 != null) {
            callbacks$Callback1.invoke(null);
            return true;
        }
    ...
    public boolean isPopupView(View view) {
        return view == this.smartBotsView || view == this.formattingMessagesKeyboardContainer || view == this.botKeyboardView || view == this.emojiView;
    }
    ...
    private void createEmojiView() {
        ...
        EmojiView emojiView2 = new EmojiView(this.parentFragment, this.allowAnimatedEmoji, true, true, getContext(), true, this.info, this.sizeNotifierLayout, this.shouldDrawBackground, this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatActivityEnterView.67
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.emojiView.setDelegate(new C444468());
        this.emojiView.setDragListener(new EmojiView.DragListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.69
            ...
            public void onDragStart() {
                if (allowDragging()) {
                    ...
                    ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
                    chatActivityEnterView.stickersExpandedHeight = (((chatActivityEnterView.sizeNotifierLayout.getHeight() - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C3541ActionBar.getCurrentActionBarHeight()) - ChatActivityEnterView.this.getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
    ...
    /* loaded from: classes7.dex */
    public class C444468 implements EmojiView.EmojiViewDelegate {
        C444468() {
            ChatActivityEnterView.this = r1;
        }
            ...
            if ((isInScheduleMode() && i == 0) || (ChatActivityEnterView.this.isTemplatesChannel(true, true) && str2 == null)) {
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$68$$ExternalSyntheticLambda5
                    ...
                    public final void didSelectDate(boolean z4, int i2, String str3) {
                        ChatActivityEnterView.C444468.this.lambda$onKiklikoVideoSelected$0(str, z, z4, i2, str3);
                    }
        ...
        public void showKiklikoReportAlert(String str, final Callbacks$Callback1<String> callbacks$Callback1) {
            ...
            builder.setTitle(LocaleController.getString("ReportChat", C3473R.string.ReportChat), true);
            final CharSequence[] charSequenceArr = {LocaleController.getString("ReportChatViolence", C3473R.string.ReportChatViolence), LocaleController.getString("ReportChatChild", C3473R.string.ReportChatChild), LocaleController.getString("ReportChatPornography", C3473R.string.ReportChatPornography), LocaleController.getString("ReportChatOther", C3473R.string.ReportChatOther)};
            builder.setItems(charSequenceArr, new int[]{C3473R.C3475drawable.msg_report_violence, C3473R.C3475drawable.msg_block2, C3473R.C3475drawable.msg_report_xxx, C3473R.C3475drawable.msg_report_other}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$68$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.C444468.this.lambda$showKiklikoReportAlert$1(charSequenceArr, callbacks$Callback1, dialogInterface, i);
                }
            });
        ...
        public void onCustomEmojiSelected(final long j, final TLRPC$Document tLRPC$Document, final String str, final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$68$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.C444468.this.lambda$onCustomEmojiSelected$2(str, tLRPC$Document, j, z);
                }
            });
        }
        ...
        public void onStickerSelected(View view, TLRPC$Document tLRPC$Document, String str, Object obj, MessageObject.SendAnimationData sendAnimationData, boolean z, int i, String str2) {
            ...
            if (ChatActivityEnterView.this.slowModeTimer <= 0 || isInScheduleMode()) {
                ...
                ChatActivityEnterView.this.lambda$onStickerSelected$64(tLRPC$Document, str, obj, sendAnimationData, false, z, i, str2);
        ...
        public void lambda$onGifSelected$3(final View view, final Object obj, final String str, final Object obj2, final boolean z, final int i, final String str2) {
            if ((!isInScheduleMode() || i != 0) && (!ChatActivityEnterView.this.isTemplatesChannel(true, true) || str2 != null)) {
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$68$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatActivityEnterView.C444468.this.lambda$onGifSelected$4(obj, str, z, i, obj2, str2);
                    }
                };
            ...
            AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$68$$ExternalSyntheticLambda4
                ...
                public final void didSelectDate(boolean z2, int i2, String str3) {
                    ChatActivityEnterView.C444468.this.lambda$onGifSelected$3(view, obj, str, obj2, z2, i2, str3);
                }
        ...
        public /* synthetic */ void lambda$onGifSelected$4(Object obj, String str, boolean z, int i, Object obj2, String str2) {
            ...
            if (obj instanceof TLRPC$Document) {
                ...
                hashMap.put(TtmlNode.ATTR_ID, tLRPC$BotInlineResult.f1520id);
        ...
        public void onClearEmojiRecent() {
            ...
            builder.setPositiveButton(LocaleController.getString("ClearButton", C3473R.string.ClearForAll), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$68$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.C444468.this.lambda$onClearEmojiRecent$5(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
        ...
        public void onShowStickerSet(TLRPC$StickerSet tLRPC$StickerSet, TLRPC$InputStickerSet tLRPC$InputStickerSet) {
            if (ChatActivityEnterView.this.trendingStickersAlert == null || ChatActivityEnterView.this.trendingStickersAlert.isDismissed()) {
                ...
                if (tLRPC$StickerSet != null) {
                    ...
                    tLRPC$InputStickerSet.f1545id = tLRPC$StickerSet.f1556id;
                }
    ...
    public void lambda$onStickerSelected$64(final TLRPC$Document tLRPC$Document, final String str, final Object obj, final MessageObject.SendAnimationData sendAnimationData, final boolean z, final boolean z2, final int i, final String str2) {
        if ((isInScheduleMode() && i == 0) || (isTemplatesChannel(true, true) && str2 == null)) {
            AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda74
                @Override // org.telegram.p043ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                public final void didSelectDate(boolean z3, int i2, String str3) {
                    ChatActivityEnterView.this.lambda$onStickerSelected$64(tLRPC$Document, str, obj, sendAnimationData, z, z3, i2, str3);
                }
        ...
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda70
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$onStickerSelected$65(tLRPC$Document, str, sendAnimationData, z2, i, obj, str2, z);
            }
        };
    ...
    public /* synthetic */ void lambda$onStickerSelected$65(TLRPC$Document tLRPC$Document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z, int i, Object obj, String str2, boolean z2) {
        ...
        setStickersExpanded(false, true, false);
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate2 = this.delegate;
        SendMessagesHelper.getInstance(this.currentAccount).sendSticker(tLRPC$Document, str, this.dialog_id, this.replyingMessageObject, getThreadMessage(), chatActivityEnterViewDelegate2 != null ? chatActivityEnterViewDelegate2.getReplyToStory() : null, sendAnimationData, z, i, obj instanceof TLRPC$TL_messages_stickerSet, obj, str2);
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate3 = this.delegate;
        if (chatActivityEnterViewDelegate3 != null) {
    ...
    public void showPopup(final int i, int i2, boolean z) {
        ...
        if (i == 1) {
            ...
            if (i2 == 2) {
                ...
                if (emojiView4 == null || emojiView4.getVisibility() == 8) {
                    i5 = 0;
                } else {
                    this.sizeNotifierLayout.removeView(this.emojiView);
                    this.emojiView.setVisibility(8);
            ...
            if (sizeNotifierFrameLayout != null) {
                ...
                if (this.smoothKeyboard && !this.keyboardVisible && i6 != i4 && z) {
                    final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda52
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatActivityEnterView.this.lambda$showPopup$66();
                        }
                    };
            ...
            if (emojiView5 != null) {
                if (i != 2 || AndroidUtilities.usingHardwareInput || AndroidUtilities.isInMultiwindow) {
                    if (this.smoothKeyboard && !this.keyboardVisible && !this.stickersExpanded) {
                        this.emojiViewVisible = true;
                        this.animatingContentType = 0;
                        emojiView5.setShowing(false);
                        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda65
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChatActivityEnterView.this.lambda$showPopup$67(i);
                            }
                        };
                        if (!this.overrideKeyboardAnimation) {
                            AnimatorSet animatorSet = new AnimatorSet();
            ...
            if (formattingMessagesKeyboardContainer2 != null && formattingMessagesKeyboardContainer2.getVisibility() == 0) {
                if (this.smoothKeyboard && !this.keyboardVisible) {
                    ...
                    AnimatorSet animatorSet4 = new AnimatorSet();
                    this.panelAnimation = animatorSet4;
                    animatorSet4.playTogether(ObjectAnimator.ofFloat(this.formattingMessagesKeyboardContainer, View.TRANSLATION_Y, formattingMessagesKeyboardContainer.getMeasuredHeight()));
                    this.panelAnimation.setInterpolator(AdjustPanLayoutHelper.keyboardInterpolator);
                    this.panelAnimation.setDuration(250L);
    ...
    public /* synthetic */ void lambda$showPopup$66() {
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
        if (chatActivityEnterViewDelegate != null) {
            chatActivityEnterViewDelegate.bottomPanelTranslationYChanged(BitmapDescriptorFactory.HUE_RED);
        }
    ...
    public /* synthetic */ void lambda$showPopup$67(int i) {
        if (i == 0) {
            this.emojiPadding = 0;
        }
    ...
    public void setSearchingTypeInternal(int i, boolean z) {
        ...
        if (z2 != (this.searchingType != 0)) {
            ...
            if (!z) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda4
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatActivityEnterView.this.lambda$setSearchingTypeInternal$68(valueAnimator2);
                    }
                });
                this.searchAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.75
                    {
                        ChatActivityEnterView.this = this;
                    }
    ...
    public /* synthetic */ void lambda$setSearchingTypeInternal$68(ValueAnimator valueAnimator) {
    ...
    public boolean isPopupShowing() {
        return this.smartBotsViewVisible || this.isFormattingMessagesContainerVisible || this.emojiViewVisible || this.botKeyboardViewVisible;
    }
    ...
    public void onSizeChanged(int i, boolean z) {
        ...
        if (isPopupShowing()) {
            ...
            if (this.currentPopupContentType == 3) {
                i2 = AndroidUtilities.m72dp(280);
            }
            View view = null;
        ...
        if (i == NotificationCenter.templatesDidChanged) {
            ...
            if (i == NotificationCenter.recordProgressChanged) {
                ...
                if (i == NotificationCenter.recordStartError || i == NotificationCenter.recordStopped) {
                    ...
                    ImageView imageView = this.recordedAudioPlayButton;
                    if (imageView != null) {
                        imageView.setContentDescription(LocaleController.getString("AccActionPlay", C3473R.string.AccActionPlay));
                    }
                    SeekBarWaveformView seekBarWaveformView = this.recordedAudioSeekBar;
                    if (seekBarWaveformView != null) {
                    ...
                    if (((Boolean) objArr[6]).booleanValue() || ((Long) objArr[3]).longValue() != this.dialog_id || (tLRPC$ChatFull = this.info) == null || tLRPC$ChatFull.slowmode_seconds == 0 || (chat = this.accountInstance.getMessagesController().getChat(Long.valueOf(this.info.f1523id))) == null || ChatObject.hasAdminRights(chat)) {
                        return;
                    }
    ...
    public void checkStickresExpandHeight() {
        ...
        int currentActionBarHeight = (((this.originalViewHeight - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C3541ActionBar.getCurrentActionBarHeight()) - getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
        ...
        if (i2 > currentActionBarHeight) {
            final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda56
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.this.lambda$checkStickresExpandHeight$69();
                }
            };
            ...
            ((ObjectAnimator) animatorSet.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda3
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.77
                {
                    ChatActivityEnterView.this = this;
                }
        ...
        ((ObjectAnimator) animatorSet2.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ChatActivityEnterView.this.lambda$checkStickresExpandHeight$71(valueAnimator);
            }
        });
        animatorSet2.setDuration(300L);
        animatorSet2.setInterpolator(CubicBezierInterpolator.DEFAULT);
        animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.78
            {
                ChatActivityEnterView.this = this;
            }
    ...
    public /* synthetic */ void lambda$checkStickresExpandHeight$69() {
        EmojiView emojiView = this.emojiView;
        if (emojiView != null) {
    ...
    public /* synthetic */ void lambda$checkStickresExpandHeight$71(ValueAnimator valueAnimator) {
        this.sizeNotifierLayout.invalidate();
    }
    ...
    public void setStickersExpanded(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z3 || this.stickersExpanded != z) {
            ...
            if (this.stickersExpanded) {
                ...
                int currentActionBarHeight = (((height - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C3541ActionBar.getCurrentActionBarHeight()) - getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
                this.stickersExpandedHeight = currentActionBarHeight;
                if (this.searchingType == 2) {
                ...
                if (z2) {
                    ...
                    ((ObjectAnimator) animatorSet2.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda6
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatActivityEnterView.this.lambda$setStickersExpanded$73(i, valueAnimator);
                        }
                    });
            ...
            if (imageView != null) {
                if (this.stickersExpanded) {
                    imageView.setContentDescription(LocaleController.getString("AccDescrCollapsePanel", C3473R.string.AccDescrCollapsePanel));
                } else {
                    imageView.setContentDescription(LocaleController.getString("AccDescrExpandPanel", C3473R.string.AccDescrExpandPanel));
                }
            }
        }
    }
    ...
    public /* synthetic */ void lambda$setStickersExpanded$73(int i, ValueAnimator valueAnimator) {
    ...
    public class SlideTextView extends View {
        ...
        public SlideTextView(Context context) {
            ...
            this.slideToCancelString = LocaleController.getString("SlideToCancel", C3473R.string.SlideToCancel);
            this.slideToCancelString = this.slideToCancelString.charAt(0) + this.slideToCancelString.substring(1).toLowerCase();
            String upperCase = LocaleController.getString("Cancel", C3473R.string.Cancel).toUpperCase();
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.cancelToProgress != 1.0f) {
                ...
                canvas.save();
                int i = (int) m72dp3;
                canvas.translate((i - AndroidUtilities.m72dp(this.smallSize ? 7 : 10)) + translationX, m72dp4);
                canvas.drawPath(this.arrowPath, this.arrowPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(i + translationX, ((getMeasuredHeight() - this.slideToLayout.getHeight()) / 2.0f) + m72dp4);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (botCommandsMenuView != null && botCommandsMenuView.getTag() != null) {
            ...
            if (editTextCaption != null) {
                ...
                int m72dp3 = AndroidUtilities.m72dp(57);
                BotCommandsMenuView botCommandsMenuView4 = this.botCommandsMenuButton;
                marginLayoutParams4.leftMargin = m72dp3 + (botCommandsMenuView4 == null ? 0 : botCommandsMenuView4.getMeasuredWidth() + i3);
            }
        } else {
            SenderSelectView senderSelectView2 = this.senderSelectView;
            if (senderSelectView2 != null && senderSelectView2.getVisibility() == 0) {
                ...
                if (frameLayout2 != null) {
                    ((ViewGroup.MarginLayoutParams) frameLayout2.getLayoutParams()).leftMargin = AndroidUtilities.m72dp(16) + i4;
                }
                ...
                if (frameLayout3 != null) {
                    ((ViewGroup.MarginLayoutParams) frameLayout3.getLayoutParams()).leftMargin = AndroidUtilities.m72dp(3);
                }
