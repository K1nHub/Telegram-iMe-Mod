...
import org.telegram.p043ui.MultiContactsSelectorBottomSheet;
...
public class ChatActivityEnterView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate {
    ...
    static /* synthetic */ float access$11116(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.combineMessagesAnimationScale + f;
        chatActivityEnterView.combineMessagesAnimationScale = f2;
        return f2;
    }

    static /* synthetic */ float access$11124(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.combineMessagesAnimationScale - f;
        chatActivityEnterView.combineMessagesAnimationScale = f2;
        return f2;
    }

    static /* synthetic */ float access$5616(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.tooltipAlpha + f;
        chatActivityEnterView.tooltipAlpha = f2;
        return f2;
    }

    static /* synthetic */ float access$5624(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.tooltipAlpha - f;
        chatActivityEnterView.tooltipAlpha = f2;
        return f2;
    }

    static /* synthetic */ float access$6516(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.slideToCancelLockProgress + f;
        chatActivityEnterView.slideToCancelLockProgress = f2;
        return f2;
    }

    static /* synthetic */ float access$6524(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.slideToCancelLockProgress - f;
        chatActivityEnterView.slideToCancelLockProgress = f2;
        return f2;
    }
    ...
    public int[] getLocationVideoMessagePopup() {
        ...
        if (this.keyboardVisible) {
            ...
            if (measuredHeight > AndroidUtilities.m107dp((view == null || view.getVisibility() != 0) ? 58 : 106)) {
                iArr[1] = iArr[1] + this.audioVideoSendButton.getMeasuredHeight();
                return iArr;
            }
        }
        iArr[1] = iArr[1] - AndroidUtilities.m107dp(2);
        return iArr;
    }
    ...
    public void showChooseCameraPopup() {
        ...
        this.videoMessageCameraOptions.setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m107dp(42), this.backgroundColor)).add(C3632R.C3634drawable.fork_ic_front_camera_24, LocaleController.getInternalString(C3632R.string.frontal_camera_popup_text), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda53
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$showChooseCameraPopup$1();
            }
        }).add(C3632R.C3634drawable.fork_ic_back_camera_24, LocaleController.getInternalString(C3632R.string.main_camera_popup_text), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda65
            @Override // java.lang.Runnable
            public final void run() {
                ChatActivityEnterView.this.lambda$showChooseCameraPopup$3();
            }
        }).translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(5)).show();
    }
    ...
    private void showCamera(boolean z) {
        ...
        if (chatActivityEnterViewDelegate != null) {
            chatActivityEnterViewDelegate.needStartRecordVideo(0, true, 0, 0, z);
        }
    ...
    public interface ChatActivityEnterViewDelegate {
        ...
        void needStartRecordVideo(int i, boolean z, int i2, int i3);

        void needStartRecordVideo(int i, boolean z, int i2, int i3, boolean z2);
        ...
        public final /* synthetic */ class CC {
            ...
            public static void $default$needStartRecordVideo(ChatActivityEnterViewDelegate _this, int i, boolean z, int i2, int i3) {
                _this.needStartRecordVideo(i, z, i2, i3, false);
            }
        }
    }
    ...
    public class RecordDot extends View {
        ...
        public RecordDot(Context context) {
            ...
            int i = C3632R.raw.chat_audio_record_delete_2;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!this.playing || !this.drawable.hasBitmap()) {
                canvas.drawCircle(getMeasuredWidth() >> 1, getMeasuredHeight() >> 1, AndroidUtilities.m107dp(5), ChatActivityEnterView.this.redDotPaint);
            }
            invalidate();
        }
    ...
    /* renamed from: org.telegram.ui.Components.ChatActivityEnterView$ControlsView */
    /* loaded from: classes6.dex */
    public class ControlsView extends FrameLayout {
        ...
        public ControlsView(Context context) {
            super(context);
            ChatActivityEnterView.this = r12;
            ...
            this.periodDrawable.setValue(1, r12.voiceOnce, false);
            ...
            r12.lockShadowDrawable = getResources().getDrawable(C3632R.C3634drawable.lock_round_shadow);
            r12.lockShadowDrawable.setColorFilter(new PorterDuffColorFilter(r12.getThemedColor(Theme.key_chat_messagePanelVoiceLockShadow), PorterDuff.Mode.MULTIPLY));
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m107dp(5), r12.getThemedColor(Theme.key_chat_gifSaveHintBackground));
            this.tooltipPaint.setTextSize(AndroidUtilities.m107dp(14));
            ...
            float m107dp = AndroidUtilities.m107dp(3);
            float[] fArr = {m107dp, m107dp, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, m107dp, m107dp};
            float[] fArr2 = {BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, r13, r13, r13, r13, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED};
            float m107dp2 = AndroidUtilities.m107dp(3);
            this.micDrawable = getResources().getDrawable(C3632R.C3634drawable.input_mic).mutate();
            this.vidDrawable = getResources().getDrawable(C3632R.C3634drawable.input_video).mutate();
        ...
        public void showHintView() {
            ...
            if (ChatActivityEnterView.this.isInVideoMode) {
                i = ChatActivityEnterView.this.voiceOnce ? C3632R.string.VideoSetOnceHintEnabled : C3632R.string.VideoSetOnceHint;
            } else {
                i = ChatActivityEnterView.this.voiceOnce ? C3632R.string.VoiceSetOnceHintEnabled : C3632R.string.VoiceSetOnceHint;
            }
            ...
            if (ChatActivityEnterView.this.voiceOnce) {
                this.hintView.setIcon(C3632R.raw.fire_on);
            } else {
            ...
            addView(this.hintView, LayoutHelper.createFrame(-1, -1, 119, 0, 0, 54, 58));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int m107dp = AndroidUtilities.m107dp(254);
            if (this.lastSize != size) {
                this.lastSize = size;
                StaticLayout staticLayout = new StaticLayout(this.tooltipMessage, this.tooltipPaint, AndroidUtilities.m107dp(220), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, true);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float f8;
            float max;
            float f9 = ChatActivityEnterView.this.scale <= 0.5f ? ChatActivityEnterView.this.scale / 0.5f : ChatActivityEnterView.this.scale <= 0.75f ? 1.0f - (((ChatActivityEnterView.this.scale - 0.5f) / 0.25f) * 0.1f) : 0.9f + (((ChatActivityEnterView.this.scale - 0.75f) / 0.25f) * 0.1f);
            long currentTimeMillis = System.currentTimeMillis() - this.lastUpdateTime;
            this.lastUpdateTime = System.currentTimeMillis();
            if (ChatActivityEnterView.this.lockAnimatedTranslation != 10000.0f) {
                ...
                if (f > AndroidUtilities.m107dp(57)) {
                    f = AndroidUtilities.m107dp(57);
                }
            } else {
                f = 0.0f;
            }
            int measuredWidth = getMeasuredWidth() - AndroidUtilities.dp2(26.0f);
            float m107dp2 = 1.0f - (f / AndroidUtilities.m107dp(57));
            float measuredHeight = getMeasuredHeight() - AndroidUtilities.m107dp(194);
            if (ChatActivityEnterView.this.sendButtonVisible) {
                m107dp = AndroidUtilities.m107dp(36);
                float m107dp3 = (((AndroidUtilities.m107dp(60) + measuredHeight) + (AndroidUtilities.dpf2(30.0f) * (1.0f - f9))) - f) + (AndroidUtilities.dpf2(14.0f) * m107dp2);
                dpf2 = (((m107dp / 2.0f) + m107dp3) - AndroidUtilities.dpf2(8.0f)) + AndroidUtilities.dpf2(2.0f);
                AndroidUtilities.dpf2(16.0f);
                AndroidUtilities.dpf2(2.0f);
                f2 = (((1.0f - m107dp2) * 9.0f) * (1.0f - ChatActivityEnterView.this.snapAnimationProgress)) - ((ChatActivityEnterView.this.snapAnimationProgress * 15.0f) * (1.0f - (m107dp2 > 0.4f ? 1.0f : m107dp2 / 0.4f)));
                f3 = m107dp3;
                f4 = m107dp2;
            } else {
                m107dp = AndroidUtilities.m107dp(36) + ((int) (AndroidUtilities.m107dp(14) * m107dp2));
                float m107dp4 = (((AndroidUtilities.m107dp(60) + measuredHeight) + ((int) (AndroidUtilities.m107dp(30) * (1.0f - f9)))) - ((int) f)) + (ChatActivityEnterView.this.idleProgress * m107dp2 * (-AndroidUtilities.m107dp(8)));
                dpf2 = (((m107dp / 2.0f) + m107dp4) - AndroidUtilities.dpf2(8.0f)) + AndroidUtilities.dpf2(2.0f) + (AndroidUtilities.dpf2(2.0f) * m107dp2);
                AndroidUtilities.dpf2(16.0f);
                AndroidUtilities.dpf2(2.0f);
                AndroidUtilities.dpf2(2.0f);
                f2 = (1.0f - m107dp2) * 9.0f;
            ...
            if ((ChatActivityEnterView.this.showTooltip && System.currentTimeMillis() - ChatActivityEnterView.this.showTooltipStartTime > 200) || ChatActivityEnterView.this.tooltipAlpha != BitmapDescriptorFactory.HUE_RED) {
                if (m107dp2 < 0.8f || ChatActivityEnterView.this.sendButtonVisible || ChatActivityEnterView.this.exitTransition != BitmapDescriptorFactory.HUE_RED || ChatActivityEnterView.this.transformToSeekbar != BitmapDescriptorFactory.HUE_RED) {
                ...
                if (ChatActivityEnterView.this.showTooltip) {
                    if (ChatActivityEnterView.this.tooltipAlpha != 1.0f) {
                        ChatActivityEnterView.access$5616(ChatActivityEnterView.this, ((float) currentTimeMillis) / 150.0f);
                        if (ChatActivityEnterView.this.tooltipAlpha >= 1.0f) {
                    ...
                    ChatActivityEnterView.access$5624(ChatActivityEnterView.this, ((float) currentTimeMillis) / 150.0f);
                ...
                if (this.tooltipLayout != null) {
                    ...
                    canvas.translate((getMeasuredWidth() - this.tooltipWidth) - AndroidUtilities.m107dp(44), AndroidUtilities.dpf2(16.0f) + measuredHeight);
                    this.tooltipBackground.setBounds(-AndroidUtilities.m107dp(8), -AndroidUtilities.m107dp(2), (int) (this.tooltipWidth + AndroidUtilities.m107dp(36)), (int) (this.tooltipLayout.getHeight() + AndroidUtilities.dpf2(4.0f)));
                    this.tooltipBackground.draw(canvas);
                    this.tooltipLayout.draw(canvas);
                    canvas.restore();
                    canvas.save();
                    canvas.translate(getMeasuredWidth() - AndroidUtilities.m107dp(26), ((AndroidUtilities.dpf2(17.0f) + measuredHeight) + (this.tooltipLayout.getHeight() / 2.0f)) - (ChatActivityEnterView.this.idleProgress * AndroidUtilities.dpf2(3.0f)));
                    this.path.reset();
                    ...
                    this.f1827p.setColor(-1);
                    this.f1827p.setAlpha(i);
                    this.f1827p.setStyle(Paint.Style.STROKE);
                    this.f1827p.setStrokeCap(Paint.Cap.ROUND);
                    this.f1827p.setStrokeJoin(Paint.Join.ROUND);
                    this.f1827p.setStrokeWidth(AndroidUtilities.dpf2(1.5f));
                    canvas.drawPath(this.path, this.f1827p);
                    canvas.restore();
                    canvas.save();
            ...
            if (ChatActivityEnterView.this.transformToSeekbar == BitmapDescriptorFactory.HUE_RED || ChatActivityEnterView.this.recordedAudioBackground == null) {
                if (ChatActivityEnterView.this.exitTransition != BitmapDescriptorFactory.HUE_RED) {
                    float f12 = ChatActivityEnterView.this.exitTransition > 0.6f ? 1.0f : ChatActivityEnterView.this.exitTransition / 0.6f;
                    ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
                    float max2 = chatActivityEnterView.messageTransitionIsRunning ? chatActivityEnterView.exitTransition : Math.max((float) BitmapDescriptorFactory.HUE_RED, (chatActivityEnterView.exitTransition - 0.6f) / 0.4f);
                    CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_BOTH;
                    float interpolation = cubicBezierInterpolator.getInterpolation(f12);
                    f5 = cubicBezierInterpolator.getInterpolation(max2);
                    f6 = interpolation;
                } else {
                ...
                if (ChatActivityEnterView.this.transformToSeekbar > 0.63f) {
                    ...
                    f5 = BitmapDescriptorFactory.HUE_RED;
                    max = Math.max((float) BitmapDescriptorFactory.HUE_RED, (ChatActivityEnterView.this.transformToSeekbar - 0.38f) / 0.25f);
                }
                CubicBezierInterpolator cubicBezierInterpolator2 = CubicBezierInterpolator.EASE_BOTH;
                float interpolation2 = cubicBezierInterpolator2.getInterpolation(f13);
                cubicBezierInterpolator2.getInterpolation(max);
                f6 = interpolation2;
            }
            canvas.save();
            canvas.clipRect(0, 0, getMeasuredWidth(), getMeasuredHeight() - ChatActivityEnterView.this.textFieldContainer.getMeasuredHeight());
            if (1.0f - ChatActivityEnterView.this.controlsScale != BitmapDescriptorFactory.HUE_RED) {
                f7 = 1.0f - ChatActivityEnterView.this.controlsScale;
            } else {
                f7 = f5 != BitmapDescriptorFactory.HUE_RED ? f5 : BitmapDescriptorFactory.HUE_RED;
            }
            if (ChatActivityEnterView.this.slideToCancelProgress < 0.7f || ChatActivityEnterView.this.canceledByGesture) {
                ...
                if (ChatActivityEnterView.this.slideToCancelLockProgress != BitmapDescriptorFactory.HUE_RED) {
                    ChatActivityEnterView.access$6524(ChatActivityEnterView.this, 0.12f);
                    if (ChatActivityEnterView.this.slideToCancelLockProgress < BitmapDescriptorFactory.HUE_RED) {
                ...
                ChatActivityEnterView.access$6516(ChatActivityEnterView.this, 0.12f);
            ...
            float f14 = dpf23 > dpf22 ? dpf22 : dpf23;
            float f15 = (1.0f - f11) * ChatActivityEnterView.this.controlsScale * (1.0f - f5) * ChatActivityEnterView.this.slideToCancelLockProgress;
            ...
            float f19 = f3;
            float f20 = f6;
            this.rectF.set(f16 - AndroidUtilities.dpf2(18.0f), f18, f16 + AndroidUtilities.dpf2(18.0f), f18 + m107dp);
            ...
            float f21 = 1.0f - f4;
            this.rectF.set((f16 - AndroidUtilities.dpf2(6.0f)) - (AndroidUtilities.dpf2(2.0f) * f21), f17 - (AndroidUtilities.dpf2(2.0f) * f21), measuredWidth + AndroidUtilities.m107dp(6) + (AndroidUtilities.dpf2(2.0f) * f21), f17 + AndroidUtilities.m107dp(12) + (AndroidUtilities.dpf2(2.0f) * f21));
            RectF rectF = this.rectF;
            float f22 = rectF.bottom;
            float centerX = rectF.centerX();
            float centerY = this.rectF.centerY();
            canvas.save();
            float f23 = 1.0f - m107dp2;
            ...
            if (i2 != 0) {
                ...
                canvas.save();
                canvas.clipRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), f22 + f14 + (AndroidUtilities.dpf2(2.0f) * f23));
                canvas.translate(f16 - AndroidUtilities.dpf2(4.0f), ((this.rectF.top - AndroidUtilities.m107dp(6)) - AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(1.5f) * (1.0f - ChatActivityEnterView.this.idleProgress), m107dp2)) + (AndroidUtilities.dpf2(12.0f) * f4) + (AndroidUtilities.dpf2(2.0f) * ChatActivityEnterView.this.snapAnimationProgress));
                if (f10 > BitmapDescriptorFactory.HUE_RED) {
                    canvas.rotate(f10, AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8));
                }
                f8 = f16;
                ...
                canvas.drawLine(BitmapDescriptorFactory.HUE_RED, dpf24, BitmapDescriptorFactory.HUE_RED, (AndroidUtilities.dpf2(4.0f) * ChatActivityEnterView.this.snapAnimationProgress * f23) + dpf25 + (dpf26 * chatActivityEnterView2.idleProgress * m107dp2 * (!chatActivityEnterView2.sendButtonVisible ? 1 : 0)), this.lockOutlinePaint);
                canvas.restore();
            } else {
                f8 = f16;
            }
            Drawable drawable2 = null;
            float clamp = Utilities.clamp(ChatActivityEnterView.this.transformToSeekbar * 2.0f, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            ...
            if (f4 > BitmapDescriptorFactory.HUE_RED) {
                ...
                rectF3.right = this.rectF.centerX() - (AndroidUtilities.m108dp(1.66f) * f4);
                float[] fArr = this.radiiLeft;
                float lerp = AndroidUtilities.lerp(AndroidUtilities.m107dp(3), AndroidUtilities.m108dp(1.5f), f4);
                fArr[7] = lerp;
                fArr[6] = lerp;
                fArr[1] = lerp;
                fArr[0] = lerp;
                float[] fArr2 = this.radiiLeft;
                float m108dp = AndroidUtilities.m108dp(1.5f) * f4;
                fArr2[5] = m108dp;
                fArr2[4] = m108dp;
                fArr2[3] = m108dp;
                fArr2[2] = m108dp;
                ...
                rectF3.set(this.rectF);
                rectF3.left = this.rectF.centerX() + (AndroidUtilities.m108dp(1.66f) * f4);
                float[] fArr3 = this.radiiRight;
                float lerp2 = AndroidUtilities.lerp(AndroidUtilities.m107dp(3), AndroidUtilities.m108dp(1.5f), f4);
                fArr3[5] = lerp2;
                fArr3[4] = lerp2;
                fArr3[3] = lerp2;
                fArr3[2] = lerp2;
                float[] fArr4 = this.radiiRight;
                float m108dp2 = AndroidUtilities.m108dp(1.5f) * f4;
                fArr4[7] = m108dp2;
                fArr4[6] = m108dp2;
                fArr4[1] = m108dp2;
                fArr4[0] = m108dp2;
            ...
            if (i2 != 0) {
                canvas.drawCircle(centerX, centerY, AndroidUtilities.dpf2(2.0f) * f21, this.lockBackgroundPaint);
            }
            canvas.restore();
            canvas.restore();
            float lerp3 = AndroidUtilities.lerp(f19, getMeasuredHeight() - AndroidUtilities.m107dp(118), Math.max(ChatActivityEnterView.this.exitTransition, Math.min(f20, ChatActivityEnterView.this.slideToCancelLockProgress))) + f14 + (AndroidUtilities.m107dp(38) * f11);
            this.rectF.set(f8 - AndroidUtilities.dpf2(18.0f), lerp3, f8 + AndroidUtilities.dpf2(18.0f), m107dp + lerp3);
            ...
            if (ChatActivityEnterView.this.onceVisible) {
                ...
                rectF4.set(rectF4.left, (rectF4.top - AndroidUtilities.dpf2(36.0f)) - dpf27, rectF5.right, rectF5.top - dpf27);
                ...
                canvas.save();
                float f24 = ChatActivityEnterView.this.controlsScale * (1.0f - ChatActivityEnterView.this.exitTransition) * ChatActivityEnterView.this.slideToCancelLockProgress * ChatActivityEnterView.this.snapAnimationProgress;
                canvas.scale(f24, f24, this.rectF.centerX(), this.rectF.centerY());
                ChatActivityEnterView.this.lockShadowDrawable.setBounds((int) (this.rectF.left - AndroidUtilities.dpf2(3.0f)), (int) (this.rectF.top - AndroidUtilities.dpf2(3.0f)), (int) (this.rectF.right + AndroidUtilities.dpf2(3.0f)), (int) (this.rectF.bottom + AndroidUtilities.dpf2(3.0f)));
                ChatActivityEnterView.this.lockShadowDrawable.draw(canvas);
                canvas.drawRoundRect(this.rectF, AndroidUtilities.dpf2(18.0f), AndroidUtilities.dpf2(18.0f), this.lockBackgroundPaint);
        ...
        public void updateColors() {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(m107dp, chatActivityEnterView3.getThemedColor(i3));
    ...
    public void setSlideToCancelProgress(float f) {
        ...
        if (measuredWidth > AndroidUtilities.m107dp(140)) {
            measuredWidth = AndroidUtilities.m107dp(140);
        }
    ...
    public class RecordCircle extends View {
        ...
        public RecordCircle(Context context) {
            ...
            this.circleRadiusAmplitude = AndroidUtilities.m107dp(30);
            this.rectF = new RectF();
            ...
            this.tinyWaveDrawable.maxRadius = AndroidUtilities.m107dp(55);
            this.tinyWaveDrawable.generateBlob();
            this.bigWaveDrawable.minRadius = AndroidUtilities.m107dp(47);
            this.bigWaveDrawable.maxRadius = AndroidUtilities.m107dp(55);
        ...
        public int setLockTranslation(float f) {
            ...
            invalidate();
            if (ChatActivityEnterView.this.canceledByGesture || ChatActivityEnterView.this.slideToCancelProgress < 0.7f || ChatActivityEnterView.this.startTranslation - ChatActivityEnterView.this.lockAnimatedTranslation < AndroidUtilities.m107dp(57)) {
                return 1;
            }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(194), 1073741824));
            float measuredWidth = getMeasuredWidth() * 0.35f;
            if (measuredWidth > AndroidUtilities.m107dp(140)) {
                measuredWidth = AndroidUtilities.m107dp(140);
            }
        ...
        */
        ...
        public void setMovingCords(float f, float f2) {
            ...
            this.lastMovingY = f2;
            this.lastMovingX = f;
            if (ChatActivityEnterView.this.showTooltip && ChatActivityEnterView.this.tooltipAlpha == BitmapDescriptorFactory.HUE_RED && f6 > this.touchSlop) {
                ChatActivityEnterView.this.showTooltipStartTime = System.currentTimeMillis();
            }
        }
        ...
        public class VirtualViewHelper extends ExploreByTouchHelper {
            ...
            protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                if (i == 1) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString(C3632R.string.Stop));
    ...
    public ChatActivityEnterView(final Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, final ChatActivity chatActivity, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.distCanMove = AndroidUtilities.m107dp(80);
        ...
        this.recordControlsCircleScale = new Property<RecordCircle, Float>(this, Float.class, "controlsScale") { // from class: org.telegram.ui.Components.ChatActivityEnterView.7
            @Override // android.util.Property
            public Float get(RecordCircle recordCircle) {
            ...
            public void run() {
                if (ChatActivityEnterView.this.delegate != null) {
                    if (SharedConfig.selectedVideoVoiceCamera == VideoVoiceCamera.ASK) {
                        ...
                        ChatActivityEnterView.this.delegate.needStartRecordVideo(0, true, 0, 0, true);
                    } else {
                        ChatActivityEnterView.this.delegate.needStartRecordVideo(0, true, 0, 0);
                    }
                }
            }
        };
        ...
        this.textFieldContainer.setPadding(0, AndroidUtilities.m107dp(1), 0, 0);
        ...
        FrameLayout frameLayout2 = new FrameLayout(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.17
            ...
            protected void onLayout(boolean z2, int i3, int i4, int i5, int i6) {
                ...
                if (ChatActivityEnterView.this.scheduledButton != null) {
                    int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m107dp((ChatActivityEnterView.this.botButton == null || ChatActivityEnterView.this.botButton.getVisibility() != 0) ? 48 : 96)) - AndroidUtilities.m107dp(48);
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                ...
                if (view != null && view == (editTextCaption = ChatActivityEnterView.this.messageEditText)) {
                    ...
                    canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(5) + ChatActivityEnterView.this.messageEditText.getX() + ChatActivityEnterView.this.messageEditText.getMeasuredWidth(), AndroidUtilities.m107dp(2) + ChatActivityEnterView.this.messageEditText.getY() + ChatActivityEnterView.this.messageEditText.getMeasuredHeight(), 255, 31);
                    boolean drawChild = super.drawChild(canvas, view, j);
                    canvas.save();
                    if (f > BitmapDescriptorFactory.HUE_RED) {
                        RectF rectF = AndroidUtilities.rectTmp;
                        float x = ChatActivityEnterView.this.messageEditText.getX() - AndroidUtilities.m107dp(5);
                        float y = ChatActivityEnterView.this.messageEditText.getY();
                        ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
                        rectF.set(x, y + chatActivityEnterView.animatedTop, chatActivityEnterView.messageEditText.getX() + ChatActivityEnterView.this.messageEditText.getMeasuredWidth() + AndroidUtilities.m107dp(5), ChatActivityEnterView.this.messageEditText.getY() + ChatActivityEnterView.this.animatedTop + AndroidUtilities.m107dp(13));
                    ...
                    if (f2 > BitmapDescriptorFactory.HUE_RED) {
                        RectF rectF2 = AndroidUtilities.rectTmp;
                        rectF2.set(ChatActivityEnterView.this.messageEditText.getX() - AndroidUtilities.m107dp(5), (ChatActivityEnterView.this.messageEditText.getY() + ChatActivityEnterView.this.messageEditText.getMeasuredHeight()) - AndroidUtilities.m107dp(15), ChatActivityEnterView.this.messageEditText.getX() + ChatActivityEnterView.this.messageEditText.getMeasuredWidth() + AndroidUtilities.m107dp(5), ChatActivityEnterView.this.messageEditText.getY() + ChatActivityEnterView.this.messageEditText.getMeasuredHeight() + AndroidUtilities.m107dp(2));
                        this.clipMatrix.reset();
        ...
        ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView = new ChatActivityEnterViewAnimatedIconView(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.18
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawCircle((getWidth() / 2) + AndroidUtilities.m107dp(9), (getHeight() / 2) - AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(5), ChatActivityEnterView.this.dotPaint);
            }
        };
        ...
        int m108dp = AndroidUtilities.m108dp(9.5f);
        this.emojiButton.setPadding(m108dp, m108dp, m108dp, m108dp);
        ...
        if (z) {
            ...
            this.attachLayout.setPivotX(AndroidUtilities.m107dp(48));
        ...
        C461421 c461421 = new C461421(activity, resourcesProvider);
        this.audioVideoButtonContainer = c461421;
        c461421.setSoundEffectsEnabled(false);
        ...
        int m108dp2 = AndroidUtilities.m108dp(9.5f);
        this.audioVideoSendButton.setPadding(m108dp2, m108dp2, m108dp2, m108dp2);
        ...
        if (chatActivity2 != null && chatActivity2.isAllowCombineMessages()) {
            ...
            this.combineMessagesDrawable.setCustomSize(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(18));
            this.combineMessagesDrawable.setIconSize(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(18));
        }
        ...
        View view = new View(activity) { // from class: org.telegram.ui.Components.ChatActivityEnterView.23
            ...
            protected void onDraw(Canvas canvas) {
                ...
                float f;
                float m107dp2;
                int m107dp3 = AndroidUtilities.m107dp(20);
                ...
                if (!ChatActivityEnterView.this.isTemplatesChannel(true, false)) {
                    if (ChatActivityEnterView.this.isInScheduleMode()) {
                        measuredHeight -= AndroidUtilities.m107dp(1);
                    } else {
                        measuredWidth2 += AndroidUtilities.m107dp(2);
                    }
                }
                ...
                if (ChatActivityEnterView.this.combineMessagesDrawable != null && (ChatActivityEnterView.this.needCombineMessages || ChatActivityEnterView.this.isCombineMessagesInAnimation)) {
                    ...
                    if (ChatActivityEnterView.this.isCombineMessagesInAnimation) {
                        ...
                        if (ChatActivityEnterView.this.needCombineMessages) {
                            ChatActivityEnterView.access$11116(ChatActivityEnterView.this, ((float) j) / 200.0f);
                            ...
                            ChatActivityEnterView.access$11124(ChatActivityEnterView.this, ((float) j) / 200.0f);
                ...
                if (z2 || this.animationProgress != 1.0f) {
                    ...
                    if (z2) {
                        ...
                        if (f3 <= 0.25f) {
                            f = m107dp3;
                            m107dp2 = AndroidUtilities.m107dp(2) * CubicBezierInterpolator.EASE_IN.getInterpolation(f3 / 0.25f);
                        } else {
                            float f4 = f3 - 0.25f;
                            if (f4 <= 0.5f) {
                                f = m107dp3;
                                m107dp2 = AndroidUtilities.m107dp(2) - (AndroidUtilities.m107dp(3) * CubicBezierInterpolator.EASE_IN.getInterpolation(f4 / 0.5f));
                            } else {
                                m107dp = m107dp3 + (-AndroidUtilities.m107dp(1)) + (AndroidUtilities.m107dp(1) * CubicBezierInterpolator.EASE_IN.getInterpolation((f4 - 0.5f) / 0.25f));
                                m107dp3 = (int) m107dp;
                            }
                        }
                        m107dp = f + m107dp2;
                    ...
                    canvas.drawCircle(f5, f5, m107dp3, Theme.dialogs_onlineCirclePaint);
        ...
        this.slowModeButton.setPadding(0, 0, AndroidUtilities.m107dp(13), 0);
        ...
        this.keyboardHeight = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.m107dp(200));
        this.keyboardHeightLand = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.m107dp(200));
    ...
    public /* synthetic */ void lambda$new$8(View view) {
        if (this.accountInstance.getFormattingTextController().getFormattingPanelType() == FormattingPanelType.ALTERNATIVE_WEB) {
            ...
            this.delegate.bottomPanelTranslationYChanged(-AndroidUtilities.m107dp(60));
        } else if (isPopupShowing() && this.currentPopupContentType == 2) {
            showPopup(0, 2);
        } else {
    ...
    /* loaded from: classes6.dex */
    public class C461421 extends FrameLayout {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C461421(Context context, Theme.ResourcesProvider resourcesProvider) {
            super(context);
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
                            ...
                            if ((ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) || (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isTemplatesChannel(true, true))) {
                                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda4
                                    ...
                                    public final void didSelectDate(boolean z, int i, String str) {
                                        ChatActivityEnterView.C461421.lambda$onTouchEvent$0(z, i, str);
                                    }
                                    ...
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        ChatActivityEnterView.C461421.lambda$onTouchEvent$1();
                                    }
                                }, this.val$resourcesProvider, ChatActivityEnterView.this.parentFragment);
                            }
                            MediaController.getInstance().stopRecording((ChatActivityEnterView.this.isInScheduleMode() || ChatActivityEnterView.this.isTemplatesChannel(true, true)) ? 3 : 1, true, 0, ChatActivityEnterView.this.voiceOnce, null);
                            ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                        } else {
                            ChatActivityEnterView.this.delegate.needStartRecordVideo(1, true, 0, ChatActivityEnterView.this.voiceOnce ? Integer.MAX_VALUE : 0);
                        }
                        ChatActivityEnterView.this.recordingAudioVideo = false;
                        ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
                        chatActivityEnterView.messageTransitionIsRunning = false;
                        AndroidUtilities.runOnUIThread(chatActivityEnterView.moveToSendStateRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChatActivityEnterView.C461421.this.lambda$onTouchEvent$2();
                            }
                        }, 200L);
                    }
                ...
                if (motionEvent.getAction() != 3 || !ChatActivityEnterView.this.recordingAudioVideo) {
                    if ((ChatActivityEnterView.this.recordCircle == null || !ChatActivityEnterView.this.recordCircle.isSendButtonVisible()) && ((frameLayout = ChatActivityEnterView.this.recordedAudioPanel) == null || frameLayout.getVisibility() != 0)) {
                        if ((((motionEvent.getX() + ChatActivityEnterView.this.audioVideoButtonContainer.getX()) - ChatActivityEnterView.this.startedDraggingX) / ChatActivityEnterView.this.distCanMove) + 1.0f < 0.45d) {
                            if (!ChatActivityEnterView.this.hasRecordVideo || !ChatActivityEnterView.this.isInVideoMode()) {
                                ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                                MediaController.getInstance().stopRecording(0, false, 0, ChatActivityEnterView.this.voiceOnce, null);
                            } else {
                                CameraController.getInstance().cancelOnInitRunnable(ChatActivityEnterView.this.onFinishInitCameraRunnable);
                                ChatActivityEnterView.this.delegate.needStartRecordVideo(2, true, 0, ChatActivityEnterView.this.voiceOnce ? Integer.MAX_VALUE : 0);
                            }
                            ...
                            if (!ChatActivityEnterView.this.sendVoiceEnabled || !ChatActivityEnterView.this.sendRoundEnabled) {
                                ...
                                ChatActivityEnterView chatActivityEnterView2 = ChatActivityEnterView.this;
                                chatActivityEnterView2.setRecordVideoButtonVisible(!chatActivityEnterView2.isInVideoMode(), true);
                            }
                            performHapticFeedback(3);
                                ...
                                if (!ChatActivityEnterView.this.sendVoiceEnabled) {
                                    ...
                                    if ((ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) || (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isTemplatesChannel(true, true))) {
                                        AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda5
                                            @Override // org.telegram.p043ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                                            public final void didSelectDate(boolean z, int i, String str) {
                                                ChatActivityEnterView.C461421.lambda$onTouchEvent$3(z, i, str);
                                            }
                                            ...
                                            @Override // java.lang.Runnable
                                            public final void run() {
                                                ChatActivityEnterView.C461421.lambda$onTouchEvent$4();
                                            }
                                        }, this.val$resourcesProvider, ChatActivityEnterView.this.parentFragment);
                                    }
                                    ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                            ...
                            AndroidUtilities.runOnUIThread(chatActivityEnterView3.moveToSendStateRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$21$$ExternalSyntheticLambda1
                                @Override // java.lang.Runnable
                                public final void run() {
                                    ChatActivityEnterView.C461421.this.lambda$onTouchEvent$5();
                                }
            ...
            if (motionEvent.getAction() == 2 && ChatActivityEnterView.this.recordingAudioVideo) {
                ...
                if (ChatActivityEnterView.this.startedDraggingX == -1.0f) {
                    ...
                    chatActivityEnterView4.distCanMove = (float) (chatActivityEnterView4.sizeNotifierLayout.getMeasuredWidth() * 0.35d);
                    if (ChatActivityEnterView.this.distCanMove > AndroidUtilities.m107dp(140)) {
                        ChatActivityEnterView.this.distCanMove = AndroidUtilities.m107dp(140);
                    }
                }
        ...
        public static /* synthetic */ void lambda$onTouchEvent$0(boolean z, int i, String str) {
            MediaController.getInstance().stopRecording(1, z, i, false, str);
        }

        public static /* synthetic */ void lambda$onTouchEvent$1() {
            MediaController.getInstance().stopRecording(0, false, 0, false, null);
        }
    ...
    private void createDoneButton() {
        ...
        ShapeDrawable createCircleDrawable = Theme.createCircleDrawable(AndroidUtilities.m107dp(16), getThemedColor(Theme.key_chat_messagePanelSend));
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(createCircleDrawable, this.doneCheckDrawable, 0, AndroidUtilities.m107dp(1));
    ...
    private void createRecordAudioPanel() {
        ...
        view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(18), getThemedColor(Theme.key_chat_recordedVoiceBackground)));
    ...
    private void resetRecordedState() {
        if (this.videoToSendMessageObject != null) {
            ...
            this.delegate.needStartRecordVideo(2, true, 0, this.voiceOnce ? Integer.MAX_VALUE : 0);
        } else {
        ...
        if (this.audioToSendPath != null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("delete file " + this.audioToSendPath);
            }
    ...
    public /* synthetic */ void lambda$createSenderSelectView$30(View view) {
        ...
        if (botCommandsMenuIsShowing()) {
            ...
            this.onEmojiSearchClosed = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda48
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (this.delegate.measureKeyboardHeight() > AndroidUtilities.m107dp(20)) {
                ...
                if (contentViewHeight < AndroidUtilities.m107dp(200)) {
                    this.onKeyboardClosed = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda64
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            if (this.delegate.getSendAsPeers() != null) {
                ...
                this.senderSelectPopupWindow.getContentView().measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(1000), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(1000), Integer.MIN_VALUE));
                ...
                int i3 = -AndroidUtilities.m107dp(4);
                int[] iArr = new int[2];
                ...
                if (measureKeyboardHeight2 <= AndroidUtilities.m107dp(20)) {
                ...
                if (measuredHeight < (((i3 * 2) + contentViewHeight2) - (this.parentFragment.isInBubbleMode() ? 0 : AndroidUtilities.statusBarHeight)) - this.senderSelectPopupWindow.headerText.getMeasuredHeight()) {
                    ...
                    i2 = ((iArr[1] - measuredHeight) - i3) - AndroidUtilities.m107dp(2);
                    overlayContainerView.addView(this.senderSelectPopupWindow.dimView, new FrameLayout.LayoutParams(-1, i3 + i2 + measuredHeight + m107dp + AndroidUtilities.m107dp(2)));
                } else {
                    int i4 = this.parentFragment.isInBubbleMode() ? 0 : AndroidUtilities.statusBarHeight;
                    int m107dp2 = AndroidUtilities.m107dp(14);
                    this.senderSelectPopupWindow.recyclerContainer.getLayoutParams().height = ((contentViewHeight2 - i4) - m107dp2) - getHeightWithTopView();
                    overlayContainerView.addView(this.senderSelectPopupWindow.dimView, new FrameLayout.LayoutParams(-1, m107dp2 + i4 + this.senderSelectPopupWindow.recyclerContainer.getLayoutParams().height + m107dp));
                    i2 = i4;
                }
    ...
    public /* synthetic */ void lambda$createSenderSelectView$29(TLRPC$ChatFull tLRPC$ChatFull, MessagesController messagesController, RecyclerView recyclerView, final SenderSelectPopup.SenderView senderView, TLRPC$Peer tLRPC$Peer) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda72
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$createSenderSelectView$28(final SimpleAvatarView simpleAvatarView, int[] iArr, SenderSelectPopup.SenderView senderView) {
        ...
        if (i >= 21) {
            ...
            dialog.getWindow().clearFlags(C0483C.BUFFER_FLAG_FIRST_SAMPLE);
        ...
        float m107dp2 = iArr[0] + this.popupX + m107dp + AndroidUtilities.m107dp(4) + BitmapDescriptorFactory.HUE_RED;
        float f3 = iArr[1] + this.popupY + m107dp + BitmapDescriptorFactory.HUE_RED;
        simpleAvatarView.setTranslationX(m107dp2);
        simpleAvatarView.setTranslationY(f3);
        float m107dp3 = this.senderSelectView.getLayoutParams().width / AndroidUtilities.m107dp(40);
        ...
        simpleAvatarView.getViewTreeObserver().addOnDrawListener(new ViewTreeObserver$OnDrawListenerC462229(this, simpleAvatarView, senderView));
        dialog.show();
        ...
        }), new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_X).setStartValue(MathUtils.clamp(m107dp2, f - AndroidUtilities.m107dp(6), m107dp2)).setSpring(new SpringForce(f).setStiffness(700.0f).setDampingRatio(0.75f)).setMinValue(f - AndroidUtilities.m107dp(6)), new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_Y).setStartValue(MathUtils.clamp(f3, f3, AndroidUtilities.m107dp(6) + f2)).setSpring(new SpringForce(f2).setStiffness(700.0f).setDampingRatio(0.75f)).setMaxValue(AndroidUtilities.m107dp(6) + f2).addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener(this) { // from class: org.telegram.ui.Components.ChatActivityEnterView.31
        ...
        }), new SpringAnimation(simpleAvatarView, viewProperty).setSpring(new SpringForce(m107dp3).setStiffness(1000.0f).setDampingRatio(1.0f)), new SpringAnimation(simpleAvatarView, viewProperty2).setSpring(new SpringForce(m107dp3).setStiffness(1000.0f).setDampingRatio(1.0f)));
    }

    /* renamed from: org.telegram.ui.Components.ChatActivityEnterView$29 */
    /* loaded from: classes6.dex */
    public class ViewTreeObserver$OnDrawListenerC462229 implements ViewTreeObserver.OnDrawListener {
        final /* synthetic */ SimpleAvatarView val$avatar;
        final /* synthetic */ SenderSelectPopup.SenderView val$senderView;

        ViewTreeObserver$OnDrawListenerC462229(ChatActivityEnterView chatActivityEnterView, SimpleAvatarView simpleAvatarView, SenderSelectPopup.SenderView senderView) {
        ...
        public void onDraw() {
            ...
            simpleAvatarView.post(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$29$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.ViewTreeObserver$OnDrawListenerC462229.this.lambda$onDraw$0(simpleAvatarView, senderView);
                }
            });
        }
    ...
    public void showRestrictedHint() {
        if (DialogObject.isChatDialog(this.dialog_id)) {
            BulletinFactory.m65of(this.parentFragment).createSimpleBulletin(C3632R.raw.passcode_lock_close, LocaleController.formatString("SendPlainTextRestrictionHint", C3632R.string.SendPlainTextRestrictionHint, ChatObject.getAllowedSendString(this.accountInstance.getMessagesController().getChat(Long.valueOf(-this.dialog_id)))), 3).show();
        }
    }
    ...
    public void openWebViewMenu() {
        ...
        if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, this.dialog_id)) {
            ...
            }, new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda49
                @Override // java.lang.Runnable
                public final void run() {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (z) {
            ...
            if (view == this.textFieldContainer) {
                int m107dp = (int) (this.animatedTop + AndroidUtilities.m107dp(2) + this.chatSearchExpandOffset);
                View view2 = this.topView;
                if (view2 != null && view2.getVisibility() == 0) {
                    m107dp += this.topView.getHeight();
                }
                canvas.clipRect(0, m107dp, getMeasuredWidth(), getMeasuredHeight());
            } else {
                canvas.clipRect(0, this.animatedTop, getMeasuredWidth(), this.animatedTop + view.getLayoutParams().height + AndroidUtilities.m107dp(2));
            }
        }
        boolean drawChild = super.drawChild(canvas, view, j);
        if (z) {
    ...
    public boolean onSendLongClick(View view) {
        ...
        if (z7) {
            ...
            actionBarMenuSubItem3.setMinimumWidth(AndroidUtilities.m107dp(196));
        ...
        if (z8) {
            ...
            actionBarMenuSubItem4.setMinimumWidth(AndroidUtilities.m107dp(196));
        ...
        if (z3) {
            ...
            this.actionScheduleButton = actionBarMenuSubItem5;
            if (z2) {
            ...
            this.actionScheduleButton.setMinimumWidth(AndroidUtilities.m107dp(196));
            this.actionScheduleButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda14
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
            ...
            if (!z2 && this.dialog_id > 0) {
                ...
                this.sendWhenOnlineButton.setMinimumWidth(AndroidUtilities.m107dp(196));
        ...
        if (z4) {
            ...
            actionBarMenuSubItem7.setMinimumWidth(AndroidUtilities.m107dp(196));
        ...
        ActionBarMenuSubItem actionBarMenuSubItem8 = this.actionScheduleButton;
        if (actionBarMenuSubItem8 != null) {
            actionBarMenuSubItem8.setVisibility(this.voiceOnce ? 8 : 0);
        }
        ...
        try {
            if (this.keyboardVisible) {
                ...
                View view2 = this.topView;
                if (measuredHeight2 > AndroidUtilities.m107dp((view2 == null || view2.getVisibility() != 0) ? 58 : 106)) {
                    measuredHeight = this.location[1] + view.getMeasuredHeight();
                    this.sendPopupWindow.showAtLocation(view, 51, ((this.location[0] + view.getMeasuredWidth()) - this.sendPopupLayout.getMeasuredWidth()) + AndroidUtilities.m107dp(8), measuredHeight);
        ...
        measuredHeight = (this.location[1] - this.sendPopupLayout.getMeasuredHeight()) - AndroidUtilities.m107dp(2);
        this.sendPopupWindow.showAtLocation(view, 51, ((this.location[0] + view.getMeasuredWidth()) - this.sendPopupLayout.getMeasuredWidth()) + AndroidUtilities.m107dp(8), measuredHeight);
        this.sendPopupWindow.dimBehind();
        this.sendButton.invalidate();
    }
    ...
    private void createBotCommandsMenuContainer() {
        ...
        this.botCommandsMenuContainer.listView.setOnItemClickListener(new C463137());
    ...
    /* loaded from: classes6.dex */
    public class C463137 implements RecyclerListView.OnItemClickListener {
        C463137() {
            ChatActivityEnterView.this = r1;
        }
            ...
            if (view instanceof TemplatesHeaderCell) {
                ...
                if (!ChatActivityEnterView.this.isInScheduleMode()) {
                    if (ChatActivityEnterView.this.parentFragment == null || !ChatActivityEnterView.this.parentFragment.checkSlowMode(view)) {
                        SendMessagesHelper.getInstance(ChatActivityEnterView.this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m94of(command, ChatActivityEnterView.this.dialog_id, ChatActivityEnterView.this.replyingMessageObject, ChatActivityEnterView.this.getThreadMessage(), null, false, null, null, null, true, 0, null, false, null));
                ...
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.dialog_id, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$37$$ExternalSyntheticLambda0
                    ...
                    public final void didSelectDate(boolean z, int i2, String str) {
                        ChatActivityEnterView.C463137.this.lambda$onItemClick$0(command, z, i2, str);
                    }
        ...
        public /* synthetic */ void lambda$onItemClick$0(String str, boolean z, int i, String str2) {
            SendMessagesHelper.getInstance(ChatActivityEnterView.this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m94of(str, ChatActivityEnterView.this.dialog_id, ChatActivityEnterView.this.replyingMessageObject, ChatActivityEnterView.this.getThreadMessage(), null, false, null, null, null, z, i, null, false, str2));
            ChatActivityEnterView.this.setFieldText("");
            ChatActivityEnterView.this.botCommandsMenuContainer.dismiss();
        }
    }
    ...
    public void updateBotCommandsMenuContainerTopPadding() {
        ...
        int i3 = this.botMenuButtonType == BotMenuButtonType.TEMPLATES ? 52 : 36;
        if (i > 0) {
            max = Math.max(0, ((this.sizeNotifierLayout.getMeasuredHeight() - i) - AndroidUtilities.m107dp(8)) - AndroidUtilities.m107dp(childCount > 4 ? 12 : 0));
        } else if (this.botCommandsAdapter.getItemCount() > 4) {
            max = Math.max(0, this.sizeNotifierLayout.getMeasuredHeight() - AndroidUtilities.m108dp((i3 * 4.3f) + 8.0f));
        } else {
            max = Math.max(0, this.sizeNotifierLayout.getMeasuredHeight() - AndroidUtilities.m107dp((i3 * Math.max(1, Math.min(4, this.botCommandsAdapter.getItemCount()))) + 8));
        }
        if (this.botCommandsMenuContainer.listView.getPaddingTop() != max) {
            ...
            this.botCommandsMenuContainer.listView.setPadding(0, max, 0, AndroidUtilities.m107dp(8));
        }
    }
    ...
    private void createBotWebViewMenuContainer() {
        ...
        this.botWebViewMenuContainer.setOnDismissGlobalListener(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda61
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public class ChatActivityEditTextCaption extends EditTextCaption {
        ...
        public boolean requestRectangleOnScreen(Rect rect) {
            rect.bottom += AndroidUtilities.m107dp(1000);
    ...
    private void createMessageEditText() {
        ...
        ChatActivityEditTextCaption chatActivityEditTextCaption = new ChatActivityEditTextCaption(getContext(), this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatActivityEnterView.40
            boolean clickMaybe;
            float touchX;
            float touchY;
        ...
        this.messageEditText.setPadding(0, AndroidUtilities.m107dp(11), 0, AndroidUtilities.m107dp(12));
        ...
        this.messageEditText.setOnKeyListener(new View.OnKeyListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.41
        ...
        this.messageEditText.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.42
            boolean ctrlPressed = false;
        ...
        this.messageEditText.addTextChangedListener(new C463843());
    ...
    /* loaded from: classes6.dex */
    public class C463843 implements TextWatcher {
        ...
        */
        public void afterTextChanged(android.text.Editable r11) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.ChatActivityEnterView.C463843.afterTextChanged(android.text.Editable):void");
        }
    ...
    public void cancelRecordingAudioVideo() {
        if (this.hasRecordVideo && isInVideoMode()) {
            CameraController.getInstance().cancelOnInitRunnable(this.onFinishInitCameraRunnable);
            this.delegate.needStartRecordVideo(5, true, 0, this.voiceOnce ? Integer.MAX_VALUE : 0);
        } else {
    ...
    public void showEditDoneProgress(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.doneButtonAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.45
                {
                    ChatActivityEnterView.this = this;
                }
    ...
    private void onWindowSizeChanged() {
        ...
        if (this.topView != null) {
            if (height < AndroidUtilities.m107dp(72) + C3704ActionBar.getCurrentActionBarHeight()) {
                if (this.allowShowTopView) {
    ...
    public void resizeForTopView(boolean z) {
        ...
        layoutParams.topMargin = AndroidUtilities.m107dp(2) + (z ? this.topView.getLayoutParams().height : 0);
        this.textFieldContainer.setLayoutParams(layoutParams);
        setMinimumHeight(AndroidUtilities.m107dp(51) + (z ? this.topView.getLayoutParams().height : 0));
        if (this.stickersExpanded) {
            if (this.searchingType == 0) {
                setStickersExpanded(false, true, false);
            } else {
    ...
    public void setDialogId(long j, int i) {
        ...
        if (this.currentAccount != i) {
            ...
            int i4 = NotificationCenter.recordPaused;
            ...
            int i5 = NotificationCenter.recordResumed;
            ...
            int i6 = NotificationCenter.recordStartError;
            ...
            int i7 = NotificationCenter.recordStopped;
            ...
            int i8 = NotificationCenter.recordProgressChanged;
            ...
            int i11 = NotificationCenter.audioRouteChanged;
            ...
            int i13 = NotificationCenter.messagePlayingProgressDidChanged;
            ...
            int i14 = NotificationCenter.featuredStickersDidLoad;
            ...
            int i15 = NotificationCenter.messageReceivedByServer;
            notificationCenter14.removeObserver(this, i15);
            NotificationCenter notificationCenter15 = NotificationCenter.getInstance(this.currentAccount);
            int i16 = NotificationCenter.sendingMessagesChanged;
            notificationCenter15.removeObserver(this, i16);
            ...
            NotificationCenter.getInstance(this.currentAccount).addObserver(this, i16);
        }
        boolean z = true;
        this.sendPlainEnabled = true;
        if (DialogObject.isChatDialog(this.dialog_id)) {
        ...
        if (messageObject2 != null && (tLRPC$ReplyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(tLRPC$ReplyMarkup2.placeholder)) {
            ...
            if (chatActivity != null && chatActivity.isForumInViewAsMessagesMode()) {
                ...
                if (messageObject3 != null && (tLRPC$TL_forumTopic = messageObject3.replyToForumTopic) != null && (str2 = tLRPC$TL_forumTopic.title) != null) {
                    this.messageEditText.setHintText(LocaleController.formatString("TypeMessageIn", C3632R.string.TypeMessageIn, str2), z);
                    return;
                }
                TLRPC$TL_forumTopic findTopic = MessagesController.getInstance(this.currentAccount).getTopicsController().findTopic(this.parentFragment.getCurrentChat().f1602id, 1L);
                if (findTopic != null && (str = findTopic.title) != null) {
                    this.messageEditText.setHintText(LocaleController.formatString("TypeMessageIn", C3632R.string.TypeMessageIn, str), z);
                    return;
                } else {
                    this.messageEditText.setHintText(LocaleController.getString("TypeMessage", C3632R.string.TypeMessage), z);
                    return;
                }
            }
            if (DialogObject.isChatDialog(this.dialog_id)) {
                ...
                if (chat == null || ChatObject.getSendAsPeerId(chat, chatFull) != (-this.dialog_id)) {
                    z3 = false;
                }
            } else {
                z3 = false;
            ...
            if (z2) {
                ...
                ChatActivity chatActivity4 = this.parentFragment;
                if (chatActivity4 != null && chatActivity4.isInAlbumMode()) {
    ...
    public void setReplyingMessageObject(MessageObject messageObject, ChatActivity.ReplyQuote replyQuote, Boolean bool) {
        setReplyingMessageObject(messageObject, replyQuote, null, bool);
    }

    public void setReplyingMessageObject(MessageObject messageObject, ChatActivity.ReplyQuote replyQuote, MessageObject messageObject2, Boolean bool) {
    ...
    private void hideRecordedAudioPanel(boolean z) {
        ...
        if (animatorSet2 == null || !animatorSet2.isRunning()) {
            ...
            if (z) {
                ...
                arrayList.add(ObjectAnimator.ofFloat(this.recordDeleteImageView, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                arrayList.add(ObjectAnimator.ofFloat(this.recordDeleteImageView, View.SCALE_X, BitmapDescriptorFactory.HUE_RED));
                arrayList.add(ObjectAnimator.ofFloat(this.recordDeleteImageView, View.SCALE_Y, BitmapDescriptorFactory.HUE_RED));
                arrayList.add(ObjectAnimator.ofFloat(this.recordedAudioPanel, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                arrayList.add(ObjectAnimator.ofFloat(this.attachButton, View.ALPHA, 1.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.attachButton, View.SCALE_X, 1.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.attachButton, View.SCALE_Y, 1.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.messageEditText, View.ALPHA, 1.0f));
                ...
                if (controlsView != null) {
                    arrayList.add(ObjectAnimator.ofFloat(controlsView, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                ...
                ArrayList arrayList2 = new ArrayList();
                if (isInVideoMode()) {
                    arrayList2.add(ObjectAnimator.ofFloat(this.videoTimelineView, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                    arrayList2.add(ObjectAnimator.ofFloat(this.videoTimelineView, View.TRANSLATION_X, -AndroidUtilities.m107dp(20)));
                    ...
                    if (controlsView2 != null) {
                        arrayList2.add(ObjectAnimator.ofFloat(controlsView2, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                        this.controlsView.hideHintView();
                    }
                    animatorSet3.playTogether(arrayList2);
                    if (this.emojiButtonPaddingAlpha == 1.0f) {
                        animatorSet3.playTogether(ObjectAnimator.ofFloat(this.messageEditText, View.ALPHA, 1.0f));
                    } else {
                    ...
                    arrayList2.add(ObjectAnimator.ofFloat(this.recordedAudioSeekBar, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                    arrayList2.add(ObjectAnimator.ofFloat(this.recordedAudioPlayButton, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                    arrayList2.add(ObjectAnimator.ofFloat(this.recordedAudioBackground, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                    arrayList2.add(ObjectAnimator.ofFloat(this.recordedAudioTimeTextView, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                    arrayList2.add(ObjectAnimator.ofFloat(this.recordedAudioSeekBar, View.TRANSLATION_X, -AndroidUtilities.m107dp(20)));
                    arrayList2.add(ObjectAnimator.ofFloat(this.recordedAudioPlayButton, View.TRANSLATION_X, -AndroidUtilities.m107dp(20)));
                    arrayList2.add(ObjectAnimator.ofFloat(this.recordedAudioBackground, View.TRANSLATION_X, -AndroidUtilities.m107dp(20)));
                    arrayList2.add(ObjectAnimator.ofFloat(this.recordedAudioTimeTextView, View.TRANSLATION_X, -AndroidUtilities.m107dp(20)));
                    ControlsView controlsView3 = this.controlsView;
                    if (controlsView3 != null) {
                        arrayList2.add(ObjectAnimator.ofFloat(controlsView3, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                        this.controlsView.hideHintView();
                    }
                    animatorSet3.playTogether(arrayList2);
                }
                ...
                animatorArr[0] = ObjectAnimator.ofFloat(this.recordDeleteImageView, View.ALPHA, BitmapDescriptorFactory.HUE_RED);
                animatorArr[1] = ObjectAnimator.ofFloat(this.recordDeleteImageView, View.SCALE_X, BitmapDescriptorFactory.HUE_RED);
                animatorArr[2] = ObjectAnimator.ofFloat(this.recordDeleteImageView, View.SCALE_Y, BitmapDescriptorFactory.HUE_RED);
                ...
                if (botCommandsMenuView2 != null) {
                    ...
                    this.botCommandsMenuButton.setScaleY(BitmapDescriptorFactory.HUE_RED);
                    this.botCommandsMenuButton.setScaleX(BitmapDescriptorFactory.HUE_RED);
                    animatorSet4.playTogether(ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.ALPHA, 1.0f), ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.SCALE_X, 1.0f), ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.SCALE_Y, 1.0f));
                }
    ...
    public void sendMessageInternal(final boolean z, final int i, boolean z2, final String str, boolean z3) {
        ...
        if (z2 && showConfirmAlert(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda73
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (this.videoToSendMessageObject != null) {
            this.delegate.needStartRecordVideo(4, z, i, this.voiceOnce ? Integer.MAX_VALUE : 0);
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda45
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.this.lambda$sendMessageInternal$50();
                }
            }, 100L);
            ...
            SendMessagesHelper.SendMessageParams m89of = SendMessagesHelper.SendMessageParams.m89of(this.audioToSend, null, this.audioToSendPath, this.dialog_id, this.replyingMessageObject, getThreadMessage(), null, null, null, null, z, i, this.voiceOnce ? Integer.MAX_VALUE : 0, null, null, false, str);
            applyStoryToSendMessageParams(m89of);
            SendMessagesHelper.getInstance(this.currentAccount).sendMessage(m89of);
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda46
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.this.lambda$sendMessageInternal$51();
                }
            }, 100L);
        } else {
            EditTextCaption editTextCaption = this.messageEditText;
            ...
            if (this.needCombineMessages && z3 && text != null && i == 0 && (chatActivity = this.parentFragment) != null) {
                ...
                if (this.delegate.hasForwardingMessages() || ((i != 0 && !isInScheduleMode()) || isInScheduleMode())) {
                    ...
                    Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda68
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public /* synthetic */ void lambda$sendMessageInternal$50() {
        RecordCircle recordCircle = this.recordCircle;
        if (recordCircle != null) {
    ...
    public /* synthetic */ void lambda$sendMessageInternal$51() {
        RecordCircle recordCircle = this.recordCircle;
        if (recordCircle != null) {
            recordCircle.setSendButtonInvisible();
        }
    ...
    */
    ...
    public void showCaptionLimitBulletin() {
        ...
        BulletinFactory.m65of(this.parentFragment).createCaptionLimitBulletin(MessagesController.getInstance(this.currentAccount).captionLengthLimitPremium, new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda57
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean processSendingText(CharSequence charSequence, boolean z, int i, String str) {
        ...
        int i8 = this.accountInstance.getMessagesController().maxMessageLength;
        if (charSequence2.length() != 0) {
            ...
            while (true) {
                ...
                if (charSequence2.length() > i10) {
                    ...
                    i4 = -1;
                    i5 = -1;
                    for (int i12 = i6; i11 > i9 && i12 < 300; i12++) {
                        char charAt = charSequence2.charAt(i11);
                        char charAt2 = i11 > 0 ? charSequence2.charAt(i11 - 1) : ' ';
                        if (charAt == '\n' && charAt2 == '\n') {
                            i2 = i11;
                            break;
                        }
                ...
                int min = Math.min(i10, charSequence2.length());
                if (i2 > 0) {
                    min = i2;
                } else if (i5 > 0) {
                    min = i5;
                ...
                CharSequence subSequence = charSequence2.subSequence(i9, min);
                if (!z2) {
                ...
                if (this.delegate.hasForwardingMessages()) {
                    ...
                    sendAnimationData2.height = m107dp;
                    sendAnimationData2.width = m107dp;
                    EditTextCaption editTextCaption = this.messageEditText;
                    if (editTextCaption != null) {
                        editTextCaption.getLocationInWindow(this.location);
                        sendAnimationData2.f1536x = this.location[0] + AndroidUtilities.m107dp(11);
                        sendAnimationData2.f1537y = this.location[i7] + AndroidUtilities.m107dp(19);
                    } else {
                        sendAnimationData2.f1536x = AndroidUtilities.m107dp(59);
                        sendAnimationData2.f1537y = AndroidUtilities.displaySize.y - AndroidUtilities.m107dp(19);
                    }
                ...
                MessageObject messageObject2 = (threadMessage != null || (messageObject = this.replyingTopMessage) == null) ? threadMessage : messageObject;
                ChatActivity chatActivity3 = this.parentFragment;
                int i13 = (chatActivity3 == null || TextUtils.isEmpty(chatActivity3.savedMultiReplyMessage) || charSequence2.length() == 0 || !charSequence2.toString().contains(AndroidUtilities.getTrimmedString(this.parentFragment.savedMultiReplyMessage))) ? 0 : i7;
                SendMessagesHelper.SendMessageParams m94of = SendMessagesHelper.SendMessageParams.m94of(charSequenceArr[0].toString(), this.dialog_id, this.replyingMessageObject, messageObject2, i13 != 0 ? null : this.messageWebPage, (i13 == 0 && this.messageWebPageSearch) ? i7 : 0, entities, null, null, z, i, sendAnimationData, checkUpdateStickersOrder, str);
                applyStoryToSendMessageParams(m94of);
                ChatActivity chatActivity4 = this.parentFragment;
                m94of.invert_media = (chatActivity4 == null || (messagePreviewParams3 = chatActivity4.messagePreviewParams) == null || !messagePreviewParams3.webpageTop) ? false : true;
                if (chatActivity4 != null && chatActivity4.getCurrentChat() != null && !ChatObject.canSendEmbed(this.parentFragment.getCurrentChat())) {
                    m94of.searchLinks = false;
                    m94of.mediaWebPage = null;
                } else {
                    TLRPC$WebPage tLRPC$WebPage = this.messageWebPage;
                    if (tLRPC$WebPage instanceof TLRPC$TL_webPagePending) {
                        m94of.searchLinks = true;
                        m94of.mediaWebPage = null;
                    } else if (tLRPC$WebPage != null) {
                        TLRPC$TL_messageMediaWebPage tLRPC$TL_messageMediaWebPage = new TLRPC$TL_messageMediaWebPage();
                        m94of.mediaWebPage = tLRPC$TL_messageMediaWebPage;
                ...
                SendMessagesHelper.getInstance(this.currentAccount).sendMessage(m94of);
                i9 = min + 1;
        ...
        if (i4 > 0 && i4 != Integer.MAX_VALUE && !isInScheduleMode()) {
            if (this.slowModeButton.getVisibility() != 0) {
                    ...
                    if (this.attachLayout != null) {
                        ...
                        if (imageView4 != null) {
                            ...
                            if (z3) {
                                ...
                                this.scheduledButton.setPivotX(AndroidUtilities.m107dp(48));
                                ImageView imageView5 = this.scheduledButton;
                                Property property = View.TRANSLATION_X;
                                float[] fArr = new float[1];
                                ImageView imageView6 = this.botButton;
                                int m107dp = AndroidUtilities.m107dp((imageView6 == null || imageView6.getVisibility() != 0) ? 48 : 96);
                                ImageView imageView7 = this.giftButton;
                                fArr[0] = m107dp - AndroidUtilities.m107dp((imageView7 == null || imageView7.getVisibility() != 0) ? 0 : 48);
                                ...
                                int m107dp2 = AndroidUtilities.m107dp((imageView9 == null || imageView9.getVisibility() != 0) ? 48 : 96);
                                ImageView imageView10 = this.giftButton;
                                imageView8.setTranslationX(m107dp2 - AndroidUtilities.m107dp((imageView10 == null || imageView10.getVisibility() != 0) ? 0 : 48));
                ...
                if (imageView13 != null) {
                    ...
                    int m107dp3 = AndroidUtilities.m107dp((imageView15 == null || imageView15.getVisibility() != 0) ? 48 : 96);
                    ImageView imageView16 = this.giftButton;
                    if (imageView16 != null && imageView16.getVisibility() == 0) {
                        i3 = 48;
                    }
                    imageView14.setTranslationX(m107dp3 - AndroidUtilities.m107dp(i3));
                    this.scheduledButton.setAlpha(1.0f);
                    this.scheduledButton.setScaleX(1.0f);
            ...
            if (this.audioVideoButtonContainer.getVisibility() == 0 || this.slowModeButton.getVisibility() == 0 || z5 || z6) {
                        ...
                        if (this.attachLayout != null) {
                            ...
                            if (imageView17 != null) {
                                ...
                                if (z7) {
                                    ...
                                    int m107dp4 = AndroidUtilities.m107dp((imageView19 == null || imageView19.getVisibility() != 0) ? 48 : 96);
                                    ImageView imageView20 = this.giftButton;
                                    fArr2[0] = m107dp4 - AndroidUtilities.m107dp((imageView20 == null || imageView20.getVisibility() != 0) ? 0 : 48);
                                    ...
                                    int m107dp5 = AndroidUtilities.m107dp((imageView22 == null || imageView22.getVisibility() != 0) ? 48 : 96);
                                    ImageView imageView23 = this.giftButton;
                                    imageView21.setTranslationX(m107dp5 - AndroidUtilities.m107dp((imageView23 == null || imageView23.getVisibility() != 0) ? 0 : 48));
                                }
                            }
                ...
                if (this.scheduledButton != null) {
                    ...
                    int m107dp6 = AndroidUtilities.m107dp((imageView27 == null || imageView27.getVisibility() != 0) ? 48 : 96);
                    ImageView imageView28 = this.giftButton;
                    if (imageView28 != null && imageView28.getVisibility() == 0) {
                        i3 = 48;
                    }
                    imageView26.setTranslationX(m107dp6 - AndroidUtilities.m107dp(i3));
                }
            }
            ...
            if (z2) {
                ...
                if (linearLayout4 != null) {
                    ...
                    if (imageView31 != null) {
                        if (z10) {
                            ...
                            fArr3[0] = (imageView33 == null || imageView33.getVisibility() != 0) ? 0.0f : -AndroidUtilities.m107dp(48);
                ...
                this.runningAnimation.setDuration(150L);
                this.runningAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.57
                    {
                        ChatActivityEnterView.this = this;
                    }
    ...
    public void setSlowModeButtonVisible(boolean z) {
        ...
        int m107dp = z ? AndroidUtilities.m107dp(16) : 0;
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption == null || editTextCaption.getPaddingRight() == m107dp) {
            return;
        }
        this.messageEditText.setPadding(0, AndroidUtilities.m107dp(11), m107dp, AndroidUtilities.m107dp(12));
    }
    ...
    private void updateFieldRight(int i) {
        ...
        if (i == 100) {
            layoutParams.rightMargin = AndroidUtilities.m107dp(this.showForwardSettingsButton ? 80 : 30);
        } else if (i == 1) {
            ...
            if (imageView7 != null && imageView7.getVisibility() == 0 && (imageView6 = this.scheduledButton) != null && imageView6.getVisibility() == 0 && (linearLayout2 = this.attachLayout) != null && linearLayout2.getVisibility() == 0) {
                layoutParams.rightMargin = AndroidUtilities.m107dp(146);
            } else {
                ...
                if ((imageView8 != null && imageView8.getVisibility() == 0) || (((imageView4 = this.notifyButton) != null && imageView4.getVisibility() == 0) || (((imageView5 = this.scheduledButton) != null && imageView5.getTag() != null) || this.showForwardSettingsButton))) {
                    layoutParams.rightMargin = AndroidUtilities.m107dp(98);
                } else {
                    layoutParams.rightMargin = AndroidUtilities.m107dp(50);
                }
            }
        } else if (i == 2) {
            if (i2 != AndroidUtilities.m107dp(2)) {
                ImageView imageView9 = this.botButton;
    ...
    /* JADX WARN: Removed duplicated region for block: B:474:0x03ec  */
    /* JADX WARN: Removed duplicated region for block: B:476:0x03ef  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    private void createRecordPanel() {
        ...
        FrameLayout frameLayout = new FrameLayout(this, getContext()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.64
            @Override // android.view.View
            public boolean onTouchEvent(MotionEvent motionEvent) {
                return super.onTouchEvent(motionEvent);
            }
        ...
        this.recordPanel.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda36
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                lambda$createRecordPanel$57 = ChatActivityEnterView.lambda$createRecordPanel$57(view, motionEvent);
                return lambda$createRecordPanel$57;
            }
        });
        ...
        linearLayout.setOrientation(0);
        this.recordTimeContainer.setPadding(AndroidUtilities.m107dp(13), 0, 0, 0);
    ...
    public void setCommand(MessageObject messageObject, String str, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            SendMessagesHelper.SendMessageParams m94of = ((this.botCount != 1 || z2) && tLRPC$User != null && tLRPC$User.bot && !str.contains("@")) ? SendMessagesHelper.SendMessageParams.m94of(String.format(Locale.US, "%s@%s", str, UserObject.getPublicUsername(tLRPC$User)), this.dialog_id, this.replyingMessageObject, getThreadMessage(), null, false, null, null, null, true, 0, null, false, null) : SendMessagesHelper.SendMessageParams.m94of(str, this.dialog_id, this.replyingMessageObject, getThreadMessage(), null, false, null, null, null, true, 0, null, false, null);
            applyStoryToSendMessageParams(m94of);
            SendMessagesHelper.getInstance(this.currentAccount).sendMessage(m94of);
        }
    }
    ...
    */
    public void updateGiftButton(boolean r7) {
        /*
            ...
            boolean r0 = r0.premiumFeaturesBlocked()
            r1 = 1
            r2 = 0
            if (r0 != 0) goto L96
            int r0 = r6.currentAccount
    ...
    public void updateScheduleButton(boolean z) {
                ...
                if (this.notifyButton != null) {
                    ...
                    if (i != this.notifyButton.getVisibility()) {
                        ...
                        if (linearLayout2 != null) {
                            ...
                            linearLayout2.setPivotX(AndroidUtilities.m107dp(i2));
                            return;
                        }
                        return;
                    }
        ...
        if (!z || z2) {
            ...
            if (imageView5 != null) {
                ...
                if (imageView8 != null && imageView8.getVisibility() == 0) {
                    this.scheduledButton.setTranslationX(-AndroidUtilities.m107dp(48));
                }
            }
        } else {
            ...
            if (imageView9 != null) {
                ...
                this.scheduledButton.setPivotX(AndroidUtilities.m107dp(24));
                ...
                this.scheduledButtonAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.65
                    {
                        ChatActivityEnterView.this = this;
                    }
        ...
        if (linearLayout3 != null) {
            ...
            linearLayout3.setPivotX(AndroidUtilities.m107dp(i2));
        }
    }
    ...
    public void updateSendAsButton(boolean z) {
        ...
        if (senderSelectView4 != null) {
            ...
            f = z3 ? ((-this.senderSelectView.getLayoutParams().width) - marginLayoutParams.leftMargin) - m107dp : 0.0f;
            f2 = z3 ? 0.0f : ((-this.senderSelectView.getLayoutParams().width) - marginLayoutParams.leftMargin) - m107dp;
        } else {
            f = 0.0f;
            f2 = 0.0f;
        }
        if (z2 != z3) {
            ...
            if (this.parentFragment.getOtherSameChatsDiff() == 0 && this.parentFragment.fragmentOpened && z) {
                ...
                final float f11 = f;
                final float f12 = f2;
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.66
                    {
                        ChatActivityEnterView.this = this;
                    }
    ...
    private void updateBotButton(boolean z) {
        ...
        if (this.isChat) {
            ...
            LinearLayout linearLayout = this.attachLayout;
            ImageView imageView9 = this.botButton;
            linearLayout.setPivotX(AndroidUtilities.m107dp(((imageView9 == null || imageView9.getVisibility() == 8) && ((imageView = this.notifyButton) == null || imageView.getVisibility() == 8)) ? 48 : 96));
        }
    }
    ...
    */
    ...
    public boolean didPressedBotButton(final TLRPC$KeyboardButton tLRPC$KeyboardButton, final MessageObject messageObject, final MessageObject messageObject2, Browser.Progress progress) {
        ...
        if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonUpdateApp) {
            ...
            SendMessagesHelper.getInstance(this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m94of(tLRPC$KeyboardButton.text, this.dialog_id, messageObject, getThreadMessage(), null, false, null, null, null, true, 0, null, false, null));
            ...
            if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonRequestPoll) {
                ...
                final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView.68
                    {
                        ChatActivityEnterView.this = this;
                    }
                    ...
                    @Override // java.lang.Runnable
                    public void run() {
                        if (ChatActivityEnterView.this.sizeNotifierLayout.measureKeyboardHeight() > AndroidUtilities.m107dp(20)) {
                        ...
                        botWebViewSheet.requestWebView(i2, j4, j5, str2, str3, z ? 1 : 0, messageObject3 != null ? messageObject3.messageOwner.f1626id : 0, false);
                        if (ChatActivityEnterView.this.parentFragment != null) {
                ...
                if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, j3)) {
                    ...
                    AlertsCreator.createBotLaunchAlert(this.parentFragment, MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.dialog_id)), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda70
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatActivityEnterView.this.lambda$didPressedBotButton$62(runnable, j3);
                        }
                    }, (Runnable) null);
                }
                ...
                builder.setPositiveButton(LocaleController.getString("OK", C3632R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda8
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        ChatActivityEnterView.this.lambda$didPressedBotButton$63(messageObject2, tLRPC$KeyboardButton, dialogInterface, i2);
                    }
                });
                ...
                if (tLRPC$KeyboardButton.same_peer) {
                    ...
                    dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda79
                        ...
                        public final boolean didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, TopicsFragment topicsFragment, Callbacks$Callback1 callbacks$Callback1) {
                            ...
                            lambda$didPressedBotButton$64 = ChatActivityEnterView.this.lambda$didPressedBotButton$64(messageObject2, tLRPC$KeyboardButton, dialogsActivity2, arrayList, charSequence, z, topicsFragment, callbacks$Callback1);
                ...
                if (tLRPC$RequestPeerType != null && messageObject2.messageOwner != null) {
                    if ((tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeUser) && (i = tLRPC$TL_keyboardButtonRequestPeer.max_quantity) > 1) {
                        MultiContactsSelectorBottomSheet.open(i, new MultiContactsSelectorBottomSheet.SelectorListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda81
                            @Override // org.telegram.p043ui.MultiContactsSelectorBottomSheet.SelectorListener
                            public final void onUserSelected(List list) {
                                ChatActivityEnterView.this.lambda$didPressedBotButton$65(messageObject2, tLRPC$TL_keyboardButtonRequestPeer, list);
                            }
                        });
                        return false;
                    }
                    ...
                    dialogsActivity2.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda80
                        ...
                        public final boolean didSelectDialogs(DialogsActivity dialogsActivity3, ArrayList arrayList, CharSequence charSequence, boolean z, TopicsFragment topicsFragment, Callbacks$Callback1 callbacks$Callback1) {
                            boolean lambda$didPressedBotButton$66;
                            lambda$didPressedBotButton$66 = ChatActivityEnterView.this.lambda$didPressedBotButton$66(messageObject2, tLRPC$TL_keyboardButtonRequestPeer, dialogsActivity3, arrayList, charSequence, z, topicsFragment, callbacks$Callback1);
                            return lambda$didPressedBotButton$66;
                        }
                    });
                    this.parentFragment.presentFragment(dialogsActivity2);
                    return false;
                }
                FileLog.m104e("button.peer_type is null");
            }
        }
        return true;
    }

    public /* synthetic */ void lambda$didPressedBotButton$62(Runnable runnable, long j) {
        runnable.run();
    ...
    public /* synthetic */ boolean lambda$didPressedBotButton$64(MessageObject messageObject, TLRPC$KeyboardButton tLRPC$KeyboardButton, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, TopicsFragment topicsFragment, Callbacks$Callback1 callbacks$Callback1) {
    ...
    public /* synthetic */ void lambda$didPressedBotButton$65(MessageObject messageObject, TLRPC$TL_keyboardButtonRequestPeer tLRPC$TL_keyboardButtonRequestPeer, List list) {
    ...
    private void createEmojiView() {
        ...
        EmojiView emojiView2 = new EmojiView(this.parentFragment, this.allowAnimatedEmoji, true, true, getContext(), true, this.info, this.sizeNotifierLayout, this.shouldDrawBackground, this.resourcesProvider, this.emojiViewFrozen) { // from class: org.telegram.ui.Components.ChatActivityEnterView.69
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.emojiView.setDelegate(new C466970());
        this.emojiView.setDragListener(new EmojiView.DragListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.71
            int initialOffset;
            boolean wasExpanded;
            ...
            public void onDragStart() {
                if (allowDragging()) {
                    ...
                    if (ChatActivityEnterView.this.searchingType == 2) {
                        ...
                        int m107dp = AndroidUtilities.m107dp(120);
                        Point point = AndroidUtilities.displaySize;
                        chatActivityEnterView2.stickersExpandedHeight = Math.min(i, m107dp + (point.x > point.y ? ChatActivityEnterView.this.keyboardHeightLand : ChatActivityEnterView.this.keyboardHeight));
                    }
            ...
            public void onDragEnd(float f) {
                if (allowDragging()) {
                    ...
                    if ((this.wasExpanded && f >= AndroidUtilities.m107dp(200)) || ((!this.wasExpanded && f <= AndroidUtilities.m107dp(-200)) || ((this.wasExpanded && ChatActivityEnterView.this.stickersExpansionProgress <= 0.6f) || (!this.wasExpanded && ChatActivityEnterView.this.stickersExpansionProgress >= 0.4f)))) {
    ...
    /* renamed from: org.telegram.ui.Components.ChatActivityEnterView$70 */
    /* loaded from: classes6.dex */
    public class C466970 implements EmojiView.EmojiViewDelegate {
        C466970() {
            ChatActivityEnterView.this = r1;
        }
        ...
        public void lambda$onKiklikoVideoSelected$0(final String str, final boolean z, boolean z2, int i, String str2) {
            ...
            if ((isInScheduleMode() && i == 0) || (ChatActivityEnterView.this.isTemplatesChannel(true, true) && str2 == null)) {
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$70$$ExternalSyntheticLambda5
                    @Override // org.telegram.p043ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                    public final void didSelectDate(boolean z4, int i2, String str3) {
                        ChatActivityEnterView.C466970.this.lambda$onKiklikoVideoSelected$0(str, z, z4, i2, str3);
                    }
        ...
        public /* synthetic */ void lambda$showKiklikoReportAlert$1(CharSequence[] charSequenceArr, final Callbacks$Callback1 callbacks$Callback1, DialogInterface dialogInterface, int i) {
            ...
            if (i == charSequenceArr.length - 1) {
                ChatActivityEnterView.this.parentFragment.showDialog(new ReportAlert(ChatActivityEnterView.this.getContext(), 5, ChatActivityEnterView.this.parentFragment.getResourceProvider()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.70.1
                    {
                        C466970.this = this;
                    }
        ...
        public void onCustomEmojiSelected(final long j, final TLRPC$Document tLRPC$Document, final String str, final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$70$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.C466970.this.lambda$onCustomEmojiSelected$2(str, tLRPC$Document, j, z);
                }
            });
        }
        ...
        public void onStickerSelected(View view, TLRPC$Document tLRPC$Document, String str, Object obj, MessageObject.SendAnimationData sendAnimationData, boolean z, int i, String str2) {
            ...
            if (ChatActivityEnterView.this.slowModeTimer <= 0 || isInScheduleMode()) {
                ...
                ChatActivityEnterView.this.lambda$onStickerSelected$67(tLRPC$Document, str, obj, sendAnimationData, false, z, i, str2);
        ...
        public void lambda$onGifSelected$3(final View view, final Object obj, final String str, final Object obj2, final boolean z, final int i, final String str2) {
            ...
            if (ChatActivityEnterView.this.replyingQuote != null && ChatActivityEnterView.this.parentFragment != null && ChatActivityEnterView.this.replyingQuote.outdated) {
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$70$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatActivityEnterView.C466970.this.lambda$onGifSelected$4(obj, str, z, i, obj2, str2);
                    }
                };
                ...
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$70$$ExternalSyntheticLambda4
                    @Override // org.telegram.p043ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                    public final void didSelectDate(boolean z2, int i2, String str3) {
                        ChatActivityEnterView.C466970.this.lambda$onGifSelected$3(view, obj, str, obj2, z2, i2, str3);
                    }
        ...
        public void onClearEmojiRecent() {
            ...
            builder.setTitle(LocaleController.getString(C3632R.string.ClearRecentEmojiTitle));
            builder.setMessage(LocaleController.getString(C3632R.string.ClearRecentEmojiText));
            builder.setPositiveButton(LocaleController.getString(C3632R.string.ClearForAll), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$70$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.C466970.this.lambda$onClearEmojiRecent$5(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C3632R.string.Cancel), null);
        ...
        public void showTrendingStickersAlert(TrendingStickersLayout trendingStickersLayout) {
            ...
            if (baseFragment != null) {
                ChatActivityEnterView.this.trendingStickersAlert = new TrendingStickersAlert(ChatActivityEnterView.this.getContext(), baseFragment, trendingStickersLayout, ChatActivityEnterView.this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatActivityEnterView.70.2
                    {
                        C466970.this = this;
                    }
    ...
    public void lambda$onStickerSelected$67(final TLRPC$Document tLRPC$Document, final String str, final Object obj, final MessageObject.SendAnimationData sendAnimationData, final boolean z, final boolean z2, final int i, final String str2) {
        ChatActivity chatActivity;
        ChatActivity.ReplyQuote replyQuote = this.replyingQuote;
        if (replyQuote != null && (chatActivity = this.parentFragment) != null && replyQuote.outdated) {
            ...
            AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda75
                ...
                public final void didSelectDate(boolean z3, int i2, String str3) {
                    ChatActivityEnterView.this.lambda$onStickerSelected$67(tLRPC$Document, str, obj, sendAnimationData, z, z3, i2, str3);
                }
            ...
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda71
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.this.lambda$onStickerSelected$68(tLRPC$Document, str, sendAnimationData, z2, i, obj, str2, z);
                }
            };
    ...
    public /* synthetic */ void lambda$onStickerSelected$68(TLRPC$Document tLRPC$Document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z, int i, Object obj, String str2, boolean z2) {
    ...
    public void showPopup(final int i, int i2, boolean z) {
        ...
        if (i == 1) {
            ...
            if (i2 == 2) {
                i6 = AndroidUtilities.m107dp(280);
            }
            ...
            if (sizeNotifierFrameLayout != null) {
                ...
                if (this.smoothKeyboard && !this.keyboardVisible && i6 != i4 && z) {
                    final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda59
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatActivityEnterView.this.lambda$showPopup$69();
                        }
                    };
            ...
            if (emojiView4 != null) {
                if (i != 2 || AndroidUtilities.usingHardwareInput || AndroidUtilities.isInMultiwindow) {
                    if (this.smoothKeyboard && !this.keyboardVisible && !this.stickersExpanded) {
                        ...
                        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda66
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChatActivityEnterView.this.lambda$showPopup$70(i);
                            }
                        };
                        if (!this.overrideKeyboardAnimation) {
                            AnimatorSet animatorSet = new AnimatorSet();
    ...
    public /* synthetic */ void lambda$showPopup$69() {
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
        if (chatActivityEnterViewDelegate != null) {
            chatActivityEnterViewDelegate.bottomPanelTranslationYChanged(BitmapDescriptorFactory.HUE_RED);
        }
    ...
    public /* synthetic */ void lambda$showPopup$70(int i) {
        if (i == 0) {
            this.emojiPadding = 0;
        }
        ...
        if (z2 != (this.searchingType != 0)) {
            ...
            if (!z) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda3
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatActivityEnterView.this.lambda$setSearchingTypeInternal$71(valueAnimator2);
                    }
                });
    ...
    public /* synthetic */ void lambda$setSearchingTypeInternal$71(ValueAnimator valueAnimator) {
    ...
    public void onSizeChanged(int i, boolean z) {
        ...
        if (i > AndroidUtilities.m107dp(50) && this.keyboardVisible && !AndroidUtilities.isInMultiwindow) {
            if (z) {
        ...
        if (isPopupShowing()) {
            ...
            if (this.currentPopupContentType == 2) {
                i2 = AndroidUtilities.m107dp(280);
            }
            View view = null;
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.templatesDidChanged) {
            ...
            } else if (i == NotificationCenter.recordPaused) {
                this.recordingAudioVideo = false;
                this.audioToSend = null;
                this.videoToSendMessageObject = null;
            } else if (i == NotificationCenter.recordResumed) {
                this.audioToSend = null;
                this.videoToSendMessageObject = null;
                checkSendButton(true);
                this.recordingAudioVideo = true;
    ...
    public void checkStickresExpandHeight() {
        ...
        if (this.searchingType == 2) {
            currentActionBarHeight = Math.min(currentActionBarHeight, AndroidUtilities.m107dp(120) + i);
        }
        ...
        if (i2 > currentActionBarHeight) {
            final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda56
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.this.lambda$checkStickresExpandHeight$72();
                }
            };
            ...
            ((ObjectAnimator) animatorSet.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ChatActivityEnterView.this.lambda$checkStickresExpandHeight$73(valueAnimator);
                }
            });
    ...
    public /* synthetic */ void lambda$checkStickresExpandHeight$72() {
        EmojiView emojiView = this.emojiView;
        if (emojiView != null) {
    ...
    public /* synthetic */ void lambda$checkStickresExpandHeight$73(ValueAnimator valueAnimator) {
    ...
    public void setStickersExpanded(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z3 || this.stickersExpanded != z) {
            ...
            if (this.stickersExpanded) {
                ...
                this.stickersExpandedHeight = currentActionBarHeight;
                if (this.searchingType == 2) {
                    this.stickersExpandedHeight = Math.min(currentActionBarHeight, AndroidUtilities.m107dp(120) + i);
                }
                this.emojiView.getLayoutParams().height = this.stickersExpandedHeight;
                this.sizeNotifierLayout.requestLayout();
                if (this.shouldDrawBackground) {
                ...
                if (z2) {
                    ...
                    ((ObjectAnimator) animatorSet.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda7
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatActivityEnterView.this.lambda$setStickersExpanded$75(i, valueAnimator);
                        }
                    });
                ...
                if (z2) {
                    ...
                    animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.81
                        {
                            ChatActivityEnterView.this = this;
                        }
    ...
    public /* synthetic */ void lambda$setStickersExpanded$75(int i, ValueAnimator valueAnimator) {
    ...
    public class SlideTextView extends View {
        ...
        public void onCancelButtonPressed() {
            if (!ChatActivityEnterView.this.hasRecordVideo || !ChatActivityEnterView.this.isInVideoMode()) {
                ...
                CameraController.getInstance().cancelOnInitRunnable(ChatActivityEnterView.this.onFinishInitCameraRunnable);
                ChatActivityEnterView.this.delegate.needStartRecordVideo(5, true, 0, ChatActivityEnterView.this.voiceOnce ? Integer.MAX_VALUE : 0);
            }
            ChatActivityEnterView.this.audioToSend = null;
        ...
        public SlideTextView(Context context) {
            ...
            this.smallSize = AndroidUtilities.displaySize.x <= AndroidUtilities.m107dp(320);
            TextPaint textPaint = new TextPaint(1);
            this.grayPaint = textPaint;
            textPaint.setTextSize(AndroidUtilities.m107dp(this.smallSize ? 13 : 15));
            TextPaint textPaint2 = new TextPaint(1);
            this.bluePaint = textPaint2;
            textPaint2.setTextSize(AndroidUtilities.m107dp(15));
            ...
            this.slideToCancelString = LocaleController.getString(C3632R.string.SlideToCancel2);
        ...
        public void updateColors() {
            ...
            Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m107dp(60), 0, ColorUtils.setAlphaComponent(ChatActivityEnterView.this.getThemedColor(i), 26));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int width = this.cancelLayout.getWidth() + AndroidUtilities.m107dp(16);
            this.grayPaint.setColor(ChatActivityEnterView.this.getThemedColor(Theme.key_chat_recordTime));
            ...
            if (this.smallSize) {
                this.xOffset = AndroidUtilities.m107dp(16);
            } else {
                long currentTimeMillis = System.currentTimeMillis() - this.lastUpdateTime;
                this.lastUpdateTime = System.currentTimeMillis();
                if (this.cancelToProgress == BitmapDescriptorFactory.HUE_RED && this.slideProgress > 0.8f) {
                    if (this.moveForward) {
                        float m107dp = this.xOffset + ((AndroidUtilities.m107dp(3) / 250.0f) * ((float) currentTimeMillis));
                        this.xOffset = m107dp;
                        if (m107dp > AndroidUtilities.m107dp(6)) {
                            this.xOffset = AndroidUtilities.m107dp(6);
                            this.moveForward = false;
                        }
                    } else {
                        float m107dp2 = this.xOffset - ((AndroidUtilities.m107dp(3) / 250.0f) * ((float) currentTimeMillis));
                        this.xOffset = m107dp2;
                        if (m107dp2 < (-AndroidUtilities.m107dp(6))) {
                            this.xOffset = -AndroidUtilities.m107dp(6);
            ...
            int measuredWidth = ((int) ((getMeasuredWidth() - this.slideToCancelWidth) / 2.0f)) + AndroidUtilities.m107dp(5);
            ...
            float m107dp3 = ((measuredWidth + ((f2 * (1.0f - f3)) * this.slideProgress)) - (f * f3)) + AndroidUtilities.m107dp(16);
            float m107dp4 = z ? 0.0f : this.cancelToProgress * AndroidUtilities.m107dp(12);
            if (this.cancelToProgress != 1.0f) {
                ...
                canvas.save();
                canvas.clipRect((ChatActivityEnterView.this.recordTimerView == null ? 0.0f : ChatActivityEnterView.this.recordTimerView.getLeftProperty()) + AndroidUtilities.m107dp(4), BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight());
                canvas.save();
                int i = (int) m107dp3;
                canvas.translate((i - AndroidUtilities.m107dp(this.smallSize ? 7 : 10)) + translationX, m107dp4);
                canvas.drawPath(this.arrowPath, this.arrowPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(i + translationX, ((getMeasuredHeight() - this.slideToLayout.getHeight()) / 2.0f) + m107dp4);
            ...
            if (!z) {
                measuredHeight -= AndroidUtilities.m107dp(12) - m107dp4;
            }
            float f4 = z ? m107dp3 + primaryHorizontal : measuredWidth2;
            ...
            this.cancelRect.inset(-AndroidUtilities.m107dp(16), -AndroidUtilities.m107dp(16));
    ...
    public class TimerView extends View {
        ...
        public TimerView(Context context) {
            ...
            this.replaceDistance = AndroidUtilities.m107dp(15);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (ChatActivityEnterView.this.isInVideoMode() && j >= 59500 && !this.stoppedInternal) {
                ChatActivityEnterView.this.startedDraggingX = -1.0f;
                ChatActivityEnterView.this.delegate.needStartRecordVideo(3, true, 0, ChatActivityEnterView.this.voiceOnce ? Integer.MAX_VALUE : 0);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (botCommandsMenuView != null && botCommandsMenuView.getTag() != null) {
            ...
            if (senderSelectView != null && senderSelectView.getVisibility() == 0) {
                ...
                marginLayoutParams.leftMargin = this.initialSenderSelectViewLeftMargin + this.botCommandsMenuButton.getMeasuredWidth() + AndroidUtilities.m107dp(6);
                i3 = marginLayoutParams.width + AndroidUtilities.m107dp(6);
            } else {
                i3 = -AndroidUtilities.m107dp(3);
            }
            ...
            if (frameLayout != null) {
                ...
                BotCommandsMenuView botCommandsMenuView2 = this.botCommandsMenuButton;
                marginLayoutParams2.leftMargin = m107dp + (botCommandsMenuView2 == null ? 0 : botCommandsMenuView2.getMeasuredWidth() + i3);
            }
            ...
            marginLayoutParams3.leftMargin = m107dp2 + (botCommandsMenuView3 == null ? 0 : botCommandsMenuView3.getMeasuredWidth() + i3);
            EditTextCaption editTextCaption = this.messageEditText;
            if (editTextCaption != null) {
                ViewGroup.MarginLayoutParams marginLayoutParams4 = (ViewGroup.MarginLayoutParams) editTextCaption.getLayoutParams();
                int m107dp3 = AndroidUtilities.m107dp(57);
                BotCommandsMenuView botCommandsMenuView4 = this.botCommandsMenuButton;
                marginLayoutParams4.leftMargin = m107dp3 + (botCommandsMenuView4 == null ? 0 : botCommandsMenuView4.getMeasuredWidth() + i3);
            }
        } else {
            SenderSelectView senderSelectView2 = this.senderSelectView;
            if (senderSelectView2 != null && senderSelectView2.getVisibility() == 0) {
                ...
                if (frameLayout2 != null) {
                    ((ViewGroup.MarginLayoutParams) frameLayout2.getLayoutParams()).leftMargin = AndroidUtilities.m107dp(16) + i4;
                }
                ((ViewGroup.MarginLayoutParams) this.emojiButton.getLayoutParams()).leftMargin = AndroidUtilities.m107dp(16) + i4;
                EditTextCaption editTextCaption2 = this.messageEditText;
                if (editTextCaption2 != null) {
                    ((ViewGroup.MarginLayoutParams) editTextCaption2.getLayoutParams()).leftMargin = AndroidUtilities.m107dp(63) + i4;
                }
            } else {
                FrameLayout frameLayout3 = this.formattingButton;
                if (frameLayout3 != null) {
                    ((ViewGroup.MarginLayoutParams) frameLayout3.getLayoutParams()).leftMargin = AndroidUtilities.m107dp(3);
                }
                ((ViewGroup.MarginLayoutParams) this.emojiButton.getLayoutParams()).leftMargin = AndroidUtilities.m107dp(3);
                EditTextCaption editTextCaption3 = this.messageEditText;
                if (editTextCaption3 != null) {
                    ((ViewGroup.MarginLayoutParams) editTextCaption3.getLayoutParams()).leftMargin = AndroidUtilities.m107dp(50);
                }
            }
        }
        updateBotCommandsMenuContainerTopPadding();
        ...
        if (chatActivityBotWebViewButton != null) {
            ...
            this.botWebViewButton.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.m107dp(2);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0, AndroidUtilities.m107dp(2), getMeasuredWidth(), getMeasuredHeight());
    ...
    public void setHorizontalPadding(float f, float f2, boolean z) {
        ...
        float f3 = 1.0f - f2;
        float f4 = (-f) * f3;
        float f5 = (-(AndroidUtilities.m107dp(40) + f)) * f3;
        this.emojiButtonPaddingScale = (f2 * 0.5f) + 0.5f;
        this.emojiButtonPaddingAlpha = f2;
        updateEmojiButtonParams();
        float f6 = -f4;
        this.emojiButton.setTranslationX(f6);
        this.messageTextPaddingTranslationX = f6 - (AndroidUtilities.m107dp(31) * f3);
        RLottieImageView rLottieImageView = this.recordDeleteImageView;
        if (rLottieImageView != null) {
        ...
        if (this.messageEditText != null) {
            ...
            this.messageEditText.setHintRightOffset(AndroidUtilities.lerp(AndroidUtilities.m107dp(30), 0, f2));
        }
    }
