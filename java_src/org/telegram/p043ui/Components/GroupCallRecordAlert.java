...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC$Chat tLRPC$Chat, boolean z) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.GroupCallRecordAlert.1
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (z2) {
                    ...
                    marginLayoutParams.leftMargin = m107dp2;
                    marginLayoutParams.rightMargin = m107dp2;
                }
                int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m107dp(200)) / 2;
                GroupCallRecordAlert.this.viewPager.setPadding(size, 0, size, 0);
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(370), 1073741824));
                measureChildWithMargins(GroupCallRecordAlert.this.titlesLayout, View.MeasureSpec.makeMeasureSpec(0, 0), 0, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(64), 1073741824), 0);
            }
        ...
        TextView textView3 = new TextView(getContext()) { // from class: org.telegram.ui.Components.GroupCallRecordAlert.3
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(6), this.gradientPaint[GroupCallRecordAlert.this.currentPage]);
                if (GroupCallRecordAlert.this.pageOffset > BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (i2 < paintArr.length) {
                        ...
                        canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(6), this.gradientPaint[GroupCallRecordAlert.this.currentPage + 1]);
                    }
                }
                super.onDraw(canvas);
            }
        ...
        textView3.setMinWidth(AndroidUtilities.m107dp(64));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            this.positiveButton.setForeground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(6), 0, ColorUtils.setAlphaComponent(Theme.getColor(i2), 76)));
        }
        ...
        while (true) {
            ...
            this.titles[i3].setPadding(AndroidUtilities.m107dp(10), 0, AndroidUtilities.m107dp(10), 0);
    ...
    public class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) {
            ...
            imageView.setPadding(AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(18), 0);
            imageView.setScaleType(ImageView.ScaleType.FIT_XY);
            imageView.setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m107dp(200), -1));
            if (i == 0) {
