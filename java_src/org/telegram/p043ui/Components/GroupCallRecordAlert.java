...
import org.telegram.p043ui.Components.GroupCallRecordAlert;
...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC$Chat tLRPC$Chat, boolean z) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.GroupCallRecordAlert.1
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (z2) {
                    ...
                    int m104dp2 = AndroidUtilities.m104dp(16);
                    marginLayoutParams.leftMargin = m104dp2;
                    marginLayoutParams.rightMargin = m104dp2;
                }
                int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m104dp(200)) / 2;
                GroupCallRecordAlert.this.viewPager.setPadding(size, 0, size, 0);
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(370), 1073741824));
                measureChildWithMargins(GroupCallRecordAlert.this.titlesLayout, View.MeasureSpec.makeMeasureSpec(0, 0), 0, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(64), 1073741824), 0);
            }
        ...
        if (ChatObject.isChannelOrGiga(tLRPC$Chat)) {
            textView.setText(LocaleController.getString("VoipChannelRecordVoiceChat", C3634R.string.VoipChannelRecordVoiceChat));
        } else {
            textView.setText(LocaleController.getString("VoipRecordVoiceChat", C3634R.string.VoipRecordVoiceChat));
        }
        ...
        textView2.setText(LocaleController.getString("VoipRecordVoiceChatInfo", C3634R.string.VoipRecordVoiceChatInfo));
        ...
        TextView textView3 = new TextView(getContext()) { // from class: org.telegram.ui.Components.GroupCallRecordAlert.3
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), this.gradientPaint[GroupCallRecordAlert.this.currentPage]);
                if (GroupCallRecordAlert.this.pageOffset > BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (i2 < paintArr.length) {
                        ...
                        canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), this.gradientPaint[GroupCallRecordAlert.this.currentPage + 1]);
                    }
                }
                super.onDraw(canvas);
            }
        ...
        textView3.setMinWidth(AndroidUtilities.m104dp(64));
        ...
        this.positiveButton.setText(LocaleController.getString("VoipRecordStart", C3634R.string.VoipRecordStart));
        if (Build.VERSION.SDK_INT >= 23) {
            this.positiveButton.setForeground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(6), 0, ColorUtils.setAlphaComponent(Theme.getColor(i2), 76)));
        }
        this.positiveButton.setPadding(0, AndroidUtilities.m104dp(12), 0, AndroidUtilities.m104dp(12));
        ...
        while (true) {
            ...
            this.titles[i3].setPadding(AndroidUtilities.m104dp(10), 0, AndroidUtilities.m104dp(10), 0);
            ...
            if (i3 == 0) {
                this.titles[i3].setText(LocaleController.getString("VoipRecordAudio", C3634R.string.VoipRecordAudio));
            } else if (i3 == 1) {
                this.titles[i3].setText(LocaleController.getString("VoipRecordPortrait", C3634R.string.VoipRecordPortrait));
            } else {
                this.titles[i3].setText(LocaleController.getString("VoipRecordLandscape", C3634R.string.VoipRecordLandscape));
            }
    ...
    public class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) {
            ...
            imageView.setPadding(AndroidUtilities.m104dp(18), 0, AndroidUtilities.m104dp(18), 0);
            imageView.setScaleType(ImageView.ScaleType.FIT_XY);
            imageView.setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m104dp(200), -1));
            if (i == 0) {
                imageView.setContentDescription(LocaleController.getString("VoipRecordAudio", C3634R.string.VoipRecordAudio));
            } else if (i == 1) {
                imageView.setContentDescription(LocaleController.getString("VoipRecordPortrait", C3634R.string.VoipRecordPortrait));
            } else {
                imageView.setContentDescription(LocaleController.getString("VoipRecordLandscape", C3634R.string.VoipRecordLandscape));
            }
            if (i == 0) {
                i2 = C3634R.raw.record_audio;
            } else if (i == 1) {
                i2 = C3634R.raw.record_video_p;
            } else {
                i2 = C3634R.raw.record_video_l;
            }
