...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC$Chat tLRPC$Chat, boolean z) {
        ...
        if (ChatObject.isChannelOrGiga(tLRPC$Chat)) {
            textView.setText(LocaleController.getString("VoipChannelRecordVoiceChat", C3419R.string.VoipChannelRecordVoiceChat));
        } else {
            textView.setText(LocaleController.getString("VoipRecordVoiceChat", C3419R.string.VoipRecordVoiceChat));
        }
        ...
        textView2.setText(LocaleController.getString("VoipRecordVoiceChatInfo", C3419R.string.VoipRecordVoiceChatInfo));
        ...
        this.positiveButton.setText(LocaleController.getString("VoipRecordStart", C3419R.string.VoipRecordStart));
        ...
        while (true) {
            ...
            if (i3 == 0) {
                this.titles[i3].setText(LocaleController.getString("VoipRecordAudio", C3419R.string.VoipRecordAudio));
            } else if (i3 == 1) {
                this.titles[i3].setText(LocaleController.getString("VoipRecordPortrait", C3419R.string.VoipRecordPortrait));
            } else {
                this.titles[i3].setText(LocaleController.getString("VoipRecordLandscape", C3419R.string.VoipRecordLandscape));
            }
    ...
    public class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) {
            ...
            if (i == 0) {
                imageView.setContentDescription(LocaleController.getString("VoipRecordAudio", C3419R.string.VoipRecordAudio));
            } else if (i == 1) {
                imageView.setContentDescription(LocaleController.getString("VoipRecordPortrait", C3419R.string.VoipRecordPortrait));
            } else {
                imageView.setContentDescription(LocaleController.getString("VoipRecordLandscape", C3419R.string.VoipRecordLandscape));
            }
            if (i == 0) {
                i2 = C3419R.raw.record_audio;
            } else if (i == 1) {
                i2 = C3419R.raw.record_video_p;
            } else {
                i2 = C3419R.raw.record_video_l;
            }
