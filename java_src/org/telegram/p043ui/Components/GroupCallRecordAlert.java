...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC$Chat tLRPC$Chat, boolean z) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.GroupCallRecordAlert.1
            ...
            protected void onMeasure(int i, int i2) {
                ...
                int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m54dp(200)) / 2;
                GroupCallRecordAlert.this.viewPager.setPadding(size, 0, size, 0);
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m54dp(370), 1073741824));
                measureChildWithMargins(GroupCallRecordAlert.this.titlesLayout, View.MeasureSpec.makeMeasureSpec(0, 0), 0, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m54dp(64), 1073741824), 0);
            }
        ...
        if (ChatObject.isChannelOrGiga(tLRPC$Chat)) {
            textView.setText(LocaleController.getString("VoipChannelRecordVoiceChat", C3417R.string.VoipChannelRecordVoiceChat));
        } else {
            textView.setText(LocaleController.getString("VoipRecordVoiceChat", C3417R.string.VoipRecordVoiceChat));
        }
        ...
        textView2.setText(LocaleController.getString("VoipRecordVoiceChatInfo", C3417R.string.VoipRecordVoiceChatInfo));
        ...
        TextView textView3 = new TextView(getContext()) { // from class: org.telegram.ui.Components.GroupCallRecordAlert.3
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m54dp(6), AndroidUtilities.m54dp(6), this.gradientPaint[GroupCallRecordAlert.this.currentPage]);
                if (GroupCallRecordAlert.this.pageOffset > BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (i2 < paintArr.length) {
                        ...
                        canvas.drawRoundRect(rectF, AndroidUtilities.m54dp(6), AndroidUtilities.m54dp(6), this.gradientPaint[GroupCallRecordAlert.this.currentPage + 1]);
                    }
                }
                super.onDraw(canvas);
            }
        ...
        textView3.setMinWidth(AndroidUtilities.m54dp(64));
        ...
        this.positiveButton.setText(LocaleController.getString("VoipRecordStart", C3417R.string.VoipRecordStart));
        ...
        while (true) {
            ...
            this.titles[i3].setPadding(AndroidUtilities.m54dp(10), 0, AndroidUtilities.m54dp(10), 0);
            ...
            if (i3 == 0) {
                this.titles[i3].setText(LocaleController.getString("VoipRecordAudio", C3417R.string.VoipRecordAudio));
            } else if (i3 == 1) {
                this.titles[i3].setText(LocaleController.getString("VoipRecordPortrait", C3417R.string.VoipRecordPortrait));
            } else {
                this.titles[i3].setText(LocaleController.getString("VoipRecordLandscape", C3417R.string.VoipRecordLandscape));
            }
    ...
    public class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) {
            ...
            imageView.setPadding(AndroidUtilities.m54dp(18), 0, AndroidUtilities.m54dp(18), 0);
            imageView.setScaleType(ImageView.ScaleType.FIT_XY);
            imageView.setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m54dp(200), -1));
            if (i == 0) {
                imageView.setContentDescription(LocaleController.getString("VoipRecordAudio", C3417R.string.VoipRecordAudio));
            } else if (i == 1) {
                imageView.setContentDescription(LocaleController.getString("VoipRecordPortrait", C3417R.string.VoipRecordPortrait));
            } else {
                imageView.setContentDescription(LocaleController.getString("VoipRecordLandscape", C3417R.string.VoipRecordLandscape));
            }
            if (i == 0) {
                i2 = C3417R.raw.record_audio;
            } else if (i == 1) {
                i2 = C3417R.raw.record_video_p;
            } else {
                i2 = C3417R.raw.record_video_l;
            }
