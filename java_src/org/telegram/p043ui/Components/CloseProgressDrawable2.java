...
public class CloseProgressDrawable2 extends Drawable {
    ...
    public CloseProgressDrawable2(float f) {
        ...
        this.paint.setStrokeWidth(AndroidUtilities.m108dp(f));
        this.paint.setStrokeCap(Paint.Cap.ROUND);
        this.paint.setStyle(Paint.Style.STROKE);
        this.side = AndroidUtilities.m107dp(8);
    }
    ...
    */
    public void draw(android.graphics.Canvas r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.CloseProgressDrawable2.draw(android.graphics.Canvas):void");
    }
