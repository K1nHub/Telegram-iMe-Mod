...
public class CheckBoxSquare extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.rectF.set(m104dp, m104dp, AndroidUtilities.m104dp(18) - m104dp, AndroidUtilities.m104dp(18) - m104dp);
        this.drawBitmap.eraseColor(0);
        this.drawCanvas.drawRoundRect(this.rectF, AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(2), Theme.checkboxSquare_backgroundPaint);
        if (f2 != 1.0f) {
            float min = Math.min(AndroidUtilities.m104dp(7), (AndroidUtilities.m104dp(7) * f2) + m104dp);
            this.rectF.set(AndroidUtilities.m104dp(2) + min, AndroidUtilities.m104dp(2) + min, AndroidUtilities.m104dp(16) - min, AndroidUtilities.m104dp(16) - min);
        ...
        if (this.progress > 0.5f) {
            ...
            float f4 = 1.0f - f;
            this.drawCanvas.drawLine(AndroidUtilities.m104dp(7), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.m104dp(7) - (AndroidUtilities.m104dp(3) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m104dp(3) * f4)), Theme.checkboxSquare_checkPaint);
            this.drawCanvas.drawLine((int) AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) + (AndroidUtilities.m104dp(7) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m104dp(7) * f4)), Theme.checkboxSquare_checkPaint);
        }
