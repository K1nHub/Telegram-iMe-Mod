...
public class AudioPlayerAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public AudioPlayerAlert(final Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.forwardSeek = new Runnable() { // from class: org.telegram.ui.Components.AudioPlayerAlert.1
            ...
            public void run() {
                ...
                if (duration == 0 || duration == C0479C.TIME_UNSET) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.2
            ...
            protected void onMeasure(int i, int i2) {
                ...
                ((FrameLayout.LayoutParams) AudioPlayerAlert.this.listView.getLayoutParams()).topMargin = C3541ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
                ((FrameLayout.LayoutParams) AudioPlayerAlert.this.actionBarShadow.getLayoutParams()).topMargin = C3541ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
                ((FrameLayout.LayoutParams) AudioPlayerAlert.this.blurredView.getLayoutParams()).topMargin = -getPaddingTop();
                int m72dp2 = AndroidUtilities.m72dp(179);
                if (AudioPlayerAlert.this.playlist.size() > 1) {
                    m72dp2 += ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + (AudioPlayerAlert.this.playlist.size() * AndroidUtilities.m72dp(56));
                }
                if (AudioPlayerAlert.this.searching || ((BottomSheet) AudioPlayerAlert.this).keyboardVisible) {
                    m72dp = AndroidUtilities.m72dp(8);
                } else {
                    if (m72dp2 >= paddingTop) {
                        m72dp2 = (int) ((paddingTop / 5) * 3.5f);
                    }
                    m72dp = (paddingTop - m72dp2) + AndroidUtilities.m72dp(8);
                    if (m72dp > paddingTop - AndroidUtilities.m72dp(329)) {
                        m72dp = paddingTop - AndroidUtilities.m72dp(329);
                    }
                    if (m72dp < 0) {
                        m72dp = 0;
                    }
                }
                if (AudioPlayerAlert.this.listView.getPaddingTop() != m72dp) {
                    AudioPlayerAlert.this.listView.setPadding(0, m72dp, 0, (AudioPlayerAlert.this.searching && ((BottomSheet) AudioPlayerAlert.this).keyboardVisible) ? 0 : AudioPlayerAlert.this.listView.getPaddingBottom());
                }
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0 && AudioPlayerAlert.this.scrollOffsetY != 0 && AudioPlayerAlert.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
                    boolean z = false;
                    if (AudioPlayerAlert.this.listAdapter.getItemCount() <= 0 ? motionEvent.getY() < getMeasuredHeight() - AndroidUtilities.m72dp(191) : motionEvent.getY() < AudioPlayerAlert.this.scrollOffsetY + AndroidUtilities.m72dp(12)) {
                        z = true;
                    }
                    if (z) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i = (AudioPlayerAlert.this.scrollOffsetY - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) - m72dp;
                if (((BottomSheet) AudioPlayerAlert.this).currentSheetAnimationType == 1) {
                    i = (int) (i + AudioPlayerAlert.this.listView.getTranslationY());
                }
                int m72dp2 = AndroidUtilities.m72dp(20) + i;
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m72dp(15) + ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop;
                if (((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i < C3541ActionBar.getCurrentActionBarHeight()) {
                    float m72dp3 = m72dp + AndroidUtilities.m72dp(4);
                    float min = Math.min(1.0f, ((C3541ActionBar.getCurrentActionBarHeight() - i) - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) / m72dp3);
                    int currentActionBarHeight = (int) ((C3541ActionBar.getCurrentActionBarHeight() - m72dp3) * min);
                    i -= currentActionBarHeight;
                    m72dp2 -= currentActionBarHeight;
                ...
                if (f != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) AudioPlayerAlert.this).backgroundPaddingLeft, ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i, getMeasuredWidth() - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingLeft, ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i + AndroidUtilities.m72dp(24));
                ...
                if (f != BitmapDescriptorFactory.HUE_RED) {
                    int m72dp4 = AndroidUtilities.m72dp(36);
                    this.rect.set((getMeasuredWidth() - m72dp4) / 2, m72dp2, (getMeasuredWidth() + m72dp4) / 2, m72dp2 + AndroidUtilities.m72dp(4));
        ...
        C3541ActionBar c3541ActionBar = new C3541ActionBar(context, resourcesProvider) { // from class: org.telegram.ui.Components.AudioPlayerAlert.3
            @Override // android.view.View
        ...
        c3541ActionBar.setBackgroundColor(getThemedColor(Theme.key_dialogBackground));
        this.actionBar.setBackButtonImage(C3473R.C3475drawable.ic_ab_back);
        C3541ActionBar c3541ActionBar2 = this.actionBar;
        int i2 = Theme.key_player_actionBarTitle;
        c3541ActionBar2.setItemsColor(getThemedColor(i2), false);
        ...
        this.actionBar.setTitle(LocaleController.getString("AttachMusic", C3473R.string.AttachMusic));
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C3473R.C3475drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.Components.AudioPlayerAlert.4
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.AudioPlayerAlert.5
        ...
        this.actionBarShadow.setBackgroundResource(C3473R.C3475drawable.header_shadow);
        ...
        this.playerLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.6
            ...
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                ...
                int left = (AudioPlayerAlert.this.durationTextView.getLeft() - AndroidUtilities.m72dp(4)) - AudioPlayerAlert.this.playbackSpeedButton.getMeasuredWidth();
        ...
        if (!SharedConfig.isPlayerPinned) {
            ...
            this.pinPlayerButton.setImageResource(C3473R.C3475drawable.chats_pin);
            ...
            this.pinPlayerButton.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m72dp(24)));
        ...
        C42899 c42899 = new C42899(context, context);
        this.authorTextView = c42899;
        this.playerLayout.addView(c42899, LayoutHelper.createFrame(-1, -2, 51, 14, 47, (SharedConfig.isPlayerPinned ? 0 : 56) + 72, 0));
        ...
        this.playbackSpeedButton.setAdditionalYOffset(-AndroidUtilities.m72dp(224));
        this.playbackSpeedButton.setContentDescription(LocaleController.getString("AccDescrPlayerSpeed", C3473R.string.AccDescrPlayerSpeed));
        ...
        this.speedItems[0] = this.playbackSpeedButton.addSubItem(0, C3473R.C3475drawable.msg_speed_slow, LocaleController.getString("SpeedSlow", C3473R.string.SpeedSlow));
        this.speedItems[1] = this.playbackSpeedButton.addSubItem(1, C3473R.C3475drawable.msg_speed_normal, LocaleController.getString("SpeedNormal", C3473R.string.SpeedNormal));
        this.speedItems[2] = this.playbackSpeedButton.addSubItem(2, C3473R.C3475drawable.msg_speed_medium, LocaleController.getString("SpeedMedium", C3473R.string.SpeedMedium));
        this.speedItems[3] = this.playbackSpeedButton.addSubItem(3, C3473R.C3475drawable.msg_speed_fast, LocaleController.getString("SpeedFast", C3473R.string.SpeedFast));
        this.speedItems[4] = this.playbackSpeedButton.addSubItem(4, C3473R.C3475drawable.msg_speed_veryfast, LocaleController.getString("SpeedVeryFast", C3473R.string.SpeedVeryFast));
        this.speedItems[5] = this.playbackSpeedButton.addSubItem(5, C3473R.C3475drawable.msg_speed_superfast, LocaleController.getString("SpeedSuperFast", C3473R.string.SpeedSuperFast));
        if (AndroidUtilities.density >= 3.0f) {
            this.playbackSpeedButton.setPadding(0, 1, 0, 0);
        }
        this.playbackSpeedButton.setAdditionalXOffset(AndroidUtilities.m72dp(8));
        this.playbackSpeedButton.setAdditionalYOffset(-AndroidUtilities.m72dp(400));
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.12
            @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                int m72dp = ((i7 - i5) - AndroidUtilities.m72dp(248)) / 4;
                for (int i9 = 0; i9 < 5; i9++) {
                    int m72dp2 = AndroidUtilities.m72dp((i9 * 48) + 4) + (m72dp * i9);
                    int m72dp3 = AndroidUtilities.m72dp(9);
                    AudioPlayerAlert.this.buttons[i9].layout(m72dp2, m72dp3, AudioPlayerAlert.this.buttons[i9].getMeasuredWidth() + m72dp2, AudioPlayerAlert.this.buttons[i9].getMeasuredHeight() + m72dp3);
                }
            }
        };
        ...
        this.repeatButton.setAdditionalYOffset(-AndroidUtilities.m72dp(166));
        int i5 = Build.VERSION.SDK_INT;
        if (i5 >= 21) {
            this.repeatButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m72dp(18)));
        }
        ...
        this.repeatSongItem = this.repeatButton.addSubItem(3, C3473R.C3475drawable.player_new_repeatone, LocaleController.getString("RepeatSong", C3473R.string.RepeatSong));
        this.repeatListItem = this.repeatButton.addSubItem(4, C3473R.C3475drawable.player_new_repeatall, LocaleController.getString("RepeatList", C3473R.string.RepeatList));
        this.shuffleListItem = this.repeatButton.addSubItem(2, C3473R.C3475drawable.player_new_shuffle, LocaleController.getString("ShuffleList", C3473R.string.ShuffleList));
        this.reverseOrderItem = this.repeatButton.addSubItem(1, C3473R.C3475drawable.player_new_order, LocaleController.getString("ReverseOrder", C3473R.string.ReverseOrder));
        ...
        C426913 c426913 = new C426913(context, scaledTouchSlop);
        this.prevButton = c426913;
        viewArr2[1] = c426913;
        c426913.setScaleType(ImageView.ScaleType.CENTER);
        RLottieImageView rLottieImageView = this.prevButton;
        int i7 = C3473R.raw.player_prev;
        ...
        if (i5 >= 21) {
            this.prevButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m72dp(22)));
        }
        frameLayout2.addView(this.prevButton, LayoutHelper.createFrame(48, 48, 51));
        this.prevButton.setContentDescription(LocaleController.getString("AccDescrPrevious", C3473R.string.AccDescrPrevious));
        ...
        if (i5 >= 21) {
            this.playButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m72dp(24)));
        }
        ...
        C427214 c427214 = new C427214(context, scaledTouchSlop);
        this.nextButton = c427214;
        viewArr4[3] = c427214;
        c427214.setScaleType(ImageView.ScaleType.CENTER);
        ...
        if (i5 >= 21) {
            this.nextButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m72dp(22)));
        }
        frameLayout2.addView(this.nextButton, LayoutHelper.createFrame(48, 48, 51));
        this.nextButton.setContentDescription(LocaleController.getString("Next", C3473R.string.Next));
        ...
        this.optionsButton.setIcon(C3473R.C3475drawable.ic_ab_other);
        this.optionsButton.setSubMenuOpenSide(2);
        this.optionsButton.setAdditionalYOffset(-AndroidUtilities.m72dp(157));
        if (i5 >= 21) {
            this.optionsButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m72dp(18)));
        }
        frameLayout2.addView(this.optionsButton, LayoutHelper.createFrame(48, 48, 51));
        this.optionsButton.addSubItem(1, C3473R.C3475drawable.msg_forward, LocaleController.getString("Forward", C3473R.string.Forward));
        int m72dp = AndroidUtilities.m72dp(96);
        ActionBarMenuItem actionBarMenuItem5 = this.optionsButton;
        actionBarMenuItem5.setAdditionalYOffset(actionBarMenuItem5.getAdditionalYOffset() - m72dp);
        this.optionsButton.addSubItem(IdFabric$Menu.MESSAGE_SAVE_CLOUD, C3473R.C3475drawable.fork_forward_cloud, LocaleController.getInternalString(C3473R.string.chat_message_popup_option_forward_cloud));
        this.optionsButton.addSubItem(2, C3473R.C3475drawable.msg_shareout, LocaleController.getString("ShareFile", C3473R.string.ShareFile));
        this.optionsButton.addSubItem(5, C3473R.C3475drawable.msg_download, LocaleController.getString("SaveToMusic", C3473R.string.SaveToMusic));
        this.optionsButton.addSubItem(4, C3473R.C3475drawable.msg_message, LocaleController.getString("ShowInChat", C3473R.string.ShowInChat));
        ...
        this.optionsButton.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
        ...
        imageView4.setImageResource(C3473R.C3475drawable.music_empty);
        ...
        this.emptyTitleTextView.setText(LocaleController.getString("NoAudioFound", C3473R.string.NoAudioFound));
        this.emptyTitleTextView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        this.emptyTitleTextView.setTextSize(1, 17.0f);
        this.emptyTitleTextView.setPadding(AndroidUtilities.m72dp(40), 0, AndroidUtilities.m72dp(40), 0);
        ...
        this.emptySubtitleTextView.setPadding(AndroidUtilities.m72dp(40), 0, AndroidUtilities.m72dp(40), 0);
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.AudioPlayerAlert.16
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i9) {
                ...
                if (((AudioPlayerAlert.this.scrollOffsetY - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) - AndroidUtilities.m72dp(13)) + ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop >= C3541ActionBar.getCurrentActionBarHeight() || !AudioPlayerAlert.this.listView.canScrollVertically(1)) {
                    return;
                }
                ...
                if (holder == null || holder.itemView.getTop() <= AndroidUtilities.m72dp(7)) {
                    return;
                }
                AudioPlayerAlert.this.listView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m72dp(7));
            }
        ...
        ((FrameLayout.LayoutParams) this.playerShadow.getLayoutParams()).bottomMargin = AndroidUtilities.m72dp(179);
        ...
        this.bigAlbumConver.setRoundRadius(AndroidUtilities.m72dp(8));
    ...
    public /* synthetic */ void lambda$new$2(View view) {
        ...
        if (lastFragment != null && !SharedConfig.hasPreferenceKey(TelegramPreferenceKeys.Global.isPlayerPinned())) {
            ...
            if (undoView != null) {
                undoView.showInfo(LocaleController.getInternalString(C3473R.string.music_pinned_player_enabled_toast));
            } else {
    ...
    public static /* synthetic */ void lambda$new$1(BaseFragment baseFragment) {
        BulletinFactory.m33of((FrameLayout) baseFragment.getFragmentView(), baseFragment.getResourceProvider()).createSimpleBulletin(C3473R.raw.info, LocaleController.getInternalString(C3473R.string.music_pinned_player_enabled_toast)).show();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Components.AudioPlayerAlert$9 */
    /* loaded from: classes7.dex */
    public class C42899 extends ClippingTextViewSwitcher {
        final /* synthetic */ Context val$context;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C42899(Context context, Context context2) {
            super(context);
        ...
        protected TextView createTextView() {
            ...
            textView.setBackground(Theme.createRadSelectorDrawable(AudioPlayerAlert.this.getThemedColor(Theme.key_listSelector), AndroidUtilities.m72dp(4), AndroidUtilities.m72dp(4)));
            textView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.AudioPlayerAlert$9$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    AudioPlayerAlert.C42899.this.lambda$createTextView$0(textView, view);
                }
            });
            return textView;
        }
    ...
    /* loaded from: classes7.dex */
    class C426913 extends RLottieImageView {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C426913(Context context, float f) {
            super(context);
            ...
            this.pressedRunnable = new Runnable() { // from class: org.telegram.ui.Components.AudioPlayerAlert.13.1
                @Override // java.lang.Runnable
                public void run() {
                    C426913 c426913 = C426913.this;
                    int i = c426913.pressedCount + 1;
                    c426913.pressedCount = i;
                    if (i != 1) {
                        if (i == 2) {
                    ...
                    C426913.this.lastTime = System.currentTimeMillis();
                    AndroidUtilities.runOnUIThread(this, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                    AndroidUtilities.runOnUIThread(C426913.this.backSeek);
                }
            };
            this.backSeek = new Runnable() { // from class: org.telegram.ui.Components.AudioPlayerAlert.13.2
                ...
                public void run() {
                    ...
                    long currentTimeMillis = System.currentTimeMillis();
                    C426913 c426913 = C426913.this;
                    long j = currentTimeMillis - c426913.lastTime;
                    c426913.lastTime = currentTimeMillis;
                    long j2 = currentTimeMillis - c426913.lastUpdateTime;
                    int i = c426913.pressedCount;
                    ...
                    C426913 c4269132 = C426913.this;
                    AudioPlayerAlert audioPlayerAlert = AudioPlayerAlert.this;
                    if (audioPlayerAlert.rewindingState != -1 || c4269132.pressedCount <= 0) {
                        return;
                    }
                    if (j2 > 200 || audioPlayerAlert.rewindingProgress == BitmapDescriptorFactory.HUE_RED) {
                        c4269132.lastUpdateTime = currentTimeMillis;
                    ...
                    C426913 c4269133 = C426913.this;
                    if (c4269133.pressedCount <= 0 || AudioPlayerAlert.this.rewindingProgress <= BitmapDescriptorFactory.HUE_RED) {
                        return;
                    }
                    AndroidUtilities.runOnUIThread(c4269133.backSeek, 16L);
                }
            };
        }
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r10) {
            ...
            Ldd:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.AudioPlayerAlert.C426913.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    /* loaded from: classes7.dex */
    class C427214 extends RLottieImageView {
        boolean pressed;
        private final Runnable pressedRunnable;
        float startX;
        float startY;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C427214(Context context, float f) {
            super(context);
            this.val$touchSlop = f;
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r7) {
            ...
            Lda:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.AudioPlayerAlert.C427214.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    public int getContainerViewHeight() {
        ...
        int m72dp = AndroidUtilities.m72dp(13);
        int i = (this.scrollOffsetY - this.backgroundPaddingTop) - m72dp;
        if (this.currentSheetAnimationType == 1) {
            i = (int) (i + this.listView.getTranslationY());
        }
        if (this.backgroundPaddingTop + i < C3541ActionBar.getCurrentActionBarHeight()) {
            float m72dp2 = m72dp + AndroidUtilities.m72dp(4);
            i -= (int) ((C3541ActionBar.getCurrentActionBarHeight() - m72dp2) * Math.min(1.0f, ((C3541ActionBar.getCurrentActionBarHeight() - i) - this.backgroundPaddingTop) / m72dp2));
        }
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    public void updateEmptyViewPosition() {
        ...
        int m72dp = this.playerLayout.getVisibility() == 0 ? AndroidUtilities.m72dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION) : -AndroidUtilities.m72dp(30);
        LinearLayout linearLayout = this.emptyView;
        linearLayout.setTranslationY(((linearLayout.getMeasuredHeight() - this.containerView.getMeasuredHeight()) - m72dp) / 2);
    }
    ...
    private void showSpeedHint() {
        if (this.containerView != null) {
            ...
            hintView.setExtraTranslationY(AndroidUtilities.m72dp(6));
    ...
    public void updateColors() {
        if (this.playbackSpeedButton != null) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                this.playbackSpeedButton.setBackground(Theme.createSelectorDrawable(themedColor & 436207615, 1, AndroidUtilities.m72dp(14)));
            }
        }
    }
    ...
    */
        ...
        if (arrayList2.size() > 1 || ((MessagesStorage.TopicKey) arrayList2.get(0)).dialogId == UserConfig.getInstance(this.currentAccount).getClientUserId() || charSequence != null || dialogsActivity.isInMultiSelect()) {
            ...
            for (int i = 0; i < arrayList2.size(); i++) {
                ...
                if (charSequence != null) {
                    SendMessagesHelper.getInstance(this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m60of(charSequence.toString(), j, null, null, null, true, null, null, null, dialogsActivity.notify, dialogsActivity.scheduleDate, null, false, null));
                }
    ...
    public /* synthetic */ void lambda$onSubItemClick$15(Uri uri) {
        BulletinFactory.m33of((FrameLayout) this.containerView, this.resourcesProvider).createDownloadBulletin(BulletinFactory.FileType.AUDIO).show();
    }
    ...
    public void updateLayout() {
        ...
        boolean z2 = top <= AndroidUtilities.m72dp(12);
        if ((z2 && this.actionBar.getTag() == null) || (!z2 && this.actionBar.getTag() != null)) {
            ...
            fArr[0] = z2 ? 1.0f : 0.0f;
            animatorArr[0] = ObjectAnimator.ofFloat(c3541ActionBar, property, fArr);
        ...
        int m72dp3 = top + ((layoutParams.topMargin - AndroidUtilities.statusBarHeight) - AndroidUtilities.m72dp(11));
        if (this.scrollOffsetY != m72dp3) {
            RecyclerListView recyclerListView2 = this.listView;
            this.scrollOffsetY = m72dp3;
            recyclerListView2.setTopGlowOffset((m72dp3 - layoutParams.topMargin) - AndroidUtilities.statusBarHeight);
            this.containerView.invalidate();
        }
        int m72dp4 = (this.scrollOffsetY - this.backgroundPaddingTop) - AndroidUtilities.m72dp(13);
        if (this.currentSheetAnimationType == 1) {
            m72dp4 = (int) (m72dp4 + this.listView.getTranslationY());
        }
        if ((this.backgroundPaddingTop + m72dp4 < C3541ActionBar.getCurrentActionBarHeight() ? 1.0f - Math.min(1.0f, ((C3541ActionBar.getCurrentActionBarHeight() - m72dp4) - this.backgroundPaddingTop) / (m72dp + AndroidUtilities.m72dp(4))) : 1.0f) <= 0.5f && ColorUtils.calculateLuminance(getThemedColor(Theme.key_dialogBackground)) > 0.699999988079071d) {
            z = true;
        }
        if (z != this.wasLight) {
    ...
    public void onBackPressed() {
        C3541ActionBar c3541ActionBar = this.actionBar;
        if (c3541ActionBar != null && c3541ActionBar.isSearchFieldVisible()) {
    ...
    private void updateRepeatButton() {
        ...
        if (i != 0 && i != 1) {
            if (i == 2) {
                this.repeatButton.setIcon(C3473R.C3475drawable.player_new_repeatone);
                ...
                this.repeatButton.setContentDescription(LocaleController.getString("AccDescrRepeatOne", C3473R.string.AccDescrRepeatOne));
                return;
            }
            return;
        }
        if (SharedConfig.shuffleMusic) {
            if (i == 0) {
                this.repeatButton.setIcon(C3473R.C3475drawable.player_new_shuffle);
            } else {
                this.repeatButton.setIcon(C3473R.C3475drawable.player_new_repeat_shuffle);
            }
        } else if (!SharedConfig.playOrderReversed) {
            this.repeatButton.setIcon(C3473R.C3475drawable.player_new_repeatall);
        } else if (i == 0) {
            this.repeatButton.setIcon(C3473R.C3475drawable.player_new_order);
        } else {
            this.repeatButton.setIcon(C3473R.C3475drawable.player_new_repeat_reverse);
        }
        if (i == 0 && !SharedConfig.shuffleMusic && !SharedConfig.playOrderReversed) {
            ...
            this.repeatButton.setContentDescription(LocaleController.getString("AccDescrRepeatOff", C3473R.string.AccDescrRepeatOff));
            return;
        }
        ...
        if (i == 0) {
            if (SharedConfig.shuffleMusic) {
                this.repeatButton.setContentDescription(LocaleController.getString("ShuffleList", C3473R.string.ShuffleList));
                return;
            } else {
                this.repeatButton.setContentDescription(LocaleController.getString("ReverseOrder", C3473R.string.ReverseOrder));
                return;
            }
        }
        this.repeatButton.setContentDescription(LocaleController.getString("AccDescrRepeatList", C3473R.string.AccDescrRepeatList));
    }
    ...
    private void updateTitle(boolean z) {
        ...
        if ((playingMessageObject == null && z) || (playingMessageObject != null && !playingMessageObject.isMusic())) {
            ...
            if ((dialogId < 0 && MessagesController.getInstance(this.currentAccount).isChatNoForwards(-dialogId)) || MessagesController.getInstance(this.currentAccount).isChatNoForwards(playingMessageObject.getChatId()) || playingMessageObject.messageOwner.noforwards) {
                ...
                this.optionsButton.setAdditionalYOffset(-AndroidUtilities.m72dp(16));
            } else {
                ...
                actionBarMenuItem.setAdditionalYOffset(actionBarMenuItem.getAdditionalYOffset() - m72dp);
            }
            ...
            if (MediaController.getInstance().isMessagePaused()) {
                ...
                this.playButton.setContentDescription(LocaleController.getString("AccActionPlay", C3473R.string.AccActionPlay));
            } else {
                this.playPauseDrawable.setPause(true);
                this.playButton.setContentDescription(LocaleController.getString("AccActionPause", C3473R.string.AccActionPause));
            }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void notifyDataSetChanged() {
            ...
            if (AudioPlayerAlert.this.playlist.size() > 1) {
                ...
                AudioPlayerAlert.this.listView.setPadding(0, AudioPlayerAlert.this.listView.getPaddingTop(), 0, AndroidUtilities.m72dp(179));
            } else {
        ...
        public /* synthetic */ void lambda$updateSearchResults$3(ArrayList arrayList, String str) {
            if (AudioPlayerAlert.this.searching) {
                ...
                AudioPlayerAlert.this.emptySubtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoAudioFoundPlayerInfo", C3473R.string.NoAudioFoundPlayerInfo, str)));
            }
        }
    }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(c3541ActionBar2, i3, null, null, null, themeDescriptionDelegate, i4));
        ...
        C3541ActionBar c3541ActionBar3 = this.actionBar;
        int i5 = ThemeDescription.FLAG_AB_SEARCHPLACEHOLDER;
        int i6 = Theme.key_player_time;
        arrayList.add(new ThemeDescription(c3541ActionBar3, i5, null, null, null, null, i6));
    ...
    public static abstract class CoverContainer extends FrameLayout {
        ...
        public CoverContainer(Context context) {
            ...
            for (final int i = 0; i < 2; i++) {
                ...
                this.imageViews[i].setRoundRadius(AndroidUtilities.m72dp(4));
                if (i == 1) {
    ...
    public static abstract class ClippingTextViewSwitcher extends FrameLayout {
        ...
        public ClippingTextViewSwitcher(Context context) {
            ...
            this.gradientSize = AndroidUtilities.m72dp(24);
            this.stableOffest = -1;
