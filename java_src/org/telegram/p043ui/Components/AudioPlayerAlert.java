...
public class AudioPlayerAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public AudioPlayerAlert(final Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.2
            ...
            protected void onMeasure(int i, int i2) {
                ...
                int m107dp2 = AndroidUtilities.m107dp(179);
                if (AudioPlayerAlert.this.playlist.size() > 1) {
                    m107dp2 += ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + (AudioPlayerAlert.this.playlist.size() * AndroidUtilities.m107dp(56));
                }
                if (AudioPlayerAlert.this.searching || ((BottomSheet) AudioPlayerAlert.this).keyboardVisible) {
                    m107dp = AndroidUtilities.m107dp(8);
                } else {
                    if (m107dp2 >= paddingTop) {
                        m107dp2 = (int) ((paddingTop / 5) * 3.5f);
                    }
                    m107dp = (paddingTop - m107dp2) + AndroidUtilities.m107dp(8);
                    if (m107dp > paddingTop - AndroidUtilities.m107dp(329)) {
                        m107dp = paddingTop - AndroidUtilities.m107dp(329);
                    }
                    if (m107dp < 0) {
                        m107dp = 0;
                    }
                }
                if (AudioPlayerAlert.this.listView.getPaddingTop() != m107dp) {
                    AudioPlayerAlert.this.listView.setPadding(0, m107dp, 0, (AudioPlayerAlert.this.searching && ((BottomSheet) AudioPlayerAlert.this).keyboardVisible) ? 0 : AudioPlayerAlert.this.listView.getPaddingBottom());
                }
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0 && AudioPlayerAlert.this.scrollOffsetY != 0 && AudioPlayerAlert.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
                    boolean z = false;
                    if (AudioPlayerAlert.this.listAdapter.getItemCount() <= 0 ? motionEvent.getY() < getMeasuredHeight() - AndroidUtilities.m107dp(191) : motionEvent.getY() < AudioPlayerAlert.this.scrollOffsetY + AndroidUtilities.m107dp(12)) {
                        z = true;
                    }
                    if (z) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i = (AudioPlayerAlert.this.scrollOffsetY - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) - m107dp;
                if (((BottomSheet) AudioPlayerAlert.this).currentSheetAnimationType == 1) {
                    i = (int) (i + AudioPlayerAlert.this.listView.getTranslationY());
                }
                int m107dp2 = AndroidUtilities.m107dp(20) + i;
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m107dp(15) + ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop;
                if (((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i < C3704ActionBar.getCurrentActionBarHeight()) {
                    float m107dp3 = m107dp + AndroidUtilities.m107dp(4);
                    float min = Math.min(1.0f, ((C3704ActionBar.getCurrentActionBarHeight() - i) - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) / m107dp3);
                    int currentActionBarHeight = (int) ((C3704ActionBar.getCurrentActionBarHeight() - m107dp3) * min);
                    i -= currentActionBarHeight;
                    m107dp2 -= currentActionBarHeight;
                ...
                if (f != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) AudioPlayerAlert.this).backgroundPaddingLeft, ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i, getMeasuredWidth() - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingLeft, ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop + i + AndroidUtilities.m107dp(24));
                ...
                if (f != BitmapDescriptorFactory.HUE_RED) {
                    int m107dp4 = AndroidUtilities.m107dp(36);
                    this.rect.set((getMeasuredWidth() - m107dp4) / 2, m107dp2, (getMeasuredWidth() + m107dp4) / 2, m107dp2 + AndroidUtilities.m107dp(4));
        ...
        this.playerLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.6
            ...
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                ...
                int left = (AudioPlayerAlert.this.durationTextView.getLeft() - AndroidUtilities.m107dp(4)) - AudioPlayerAlert.this.playbackSpeedButton.getMeasuredWidth();
        ...
        if (!SharedConfig.isPlayerPinned) {
            ...
            this.pinPlayerButton.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m107dp(24)));
        ...
        C45039 c45039 = new C45039(context, context);
        this.authorTextView = c45039;
        this.playerLayout.addView(c45039, LayoutHelper.createFrame(-1, -2, 51, 14, 47, (SharedConfig.isPlayerPinned ? 0 : 56) + 72, 0));
        ...
        this.playbackSpeedButton.setAdditionalYOffset(-AndroidUtilities.m107dp(224));
        ...
        this.playbackSpeedButton.setAdditionalYOffset(-AndroidUtilities.m107dp(400));
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.Components.AudioPlayerAlert.12
            @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                int m107dp = ((i7 - i5) - AndroidUtilities.m107dp(248)) / 4;
                for (int i9 = 0; i9 < 5; i9++) {
                    int m107dp2 = AndroidUtilities.m107dp((i9 * 48) + 4) + (m107dp * i9);
                    int m107dp3 = AndroidUtilities.m107dp(9);
                    AudioPlayerAlert.this.buttons[i9].layout(m107dp2, m107dp3, AudioPlayerAlert.this.buttons[i9].getMeasuredWidth() + m107dp2, AudioPlayerAlert.this.buttons[i9].getMeasuredHeight() + m107dp3);
                }
            }
        };
        ...
        this.repeatButton.setAdditionalYOffset(-AndroidUtilities.m107dp(166));
        int i5 = Build.VERSION.SDK_INT;
        if (i5 >= 21) {
            this.repeatButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m107dp(18)));
        }
        ...
        C448313 c448313 = new C448313(context, scaledTouchSlop);
        this.prevButton = c448313;
        viewArr2[1] = c448313;
        c448313.setScaleType(ImageView.ScaleType.CENTER);
        ...
        if (i5 >= 21) {
            this.prevButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m107dp(22)));
        }
        ...
        if (i5 >= 21) {
            this.playButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m107dp(24)));
        }
        ...
        C448614 c448614 = new C448614(context, scaledTouchSlop);
        this.nextButton = c448614;
        viewArr4[3] = c448614;
        c448614.setScaleType(ImageView.ScaleType.CENTER);
        ...
        if (i5 >= 21) {
            this.nextButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m107dp(22)));
        }
        ...
        this.optionsButton.setAdditionalYOffset(-AndroidUtilities.m107dp(157));
        if (i5 >= 21) {
            this.optionsButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m107dp(18)));
        }
        ...
        int m107dp = AndroidUtilities.m107dp(96);
        ActionBarMenuItem actionBarMenuItem5 = this.optionsButton;
        actionBarMenuItem5.setAdditionalYOffset(actionBarMenuItem5.getAdditionalYOffset() - m107dp);
        ...
        this.emptyTitleTextView.setPadding(AndroidUtilities.m107dp(40), 0, AndroidUtilities.m107dp(40), 0);
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.AudioPlayerAlert.16
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i9) {
                ...
                if (((AudioPlayerAlert.this.scrollOffsetY - ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop) - AndroidUtilities.m107dp(13)) + ((BottomSheet) AudioPlayerAlert.this).backgroundPaddingTop >= C3704ActionBar.getCurrentActionBarHeight() || !AudioPlayerAlert.this.listView.canScrollVertically(1)) {
                    return;
                }
                ...
                if (holder == null || holder.itemView.getTop() <= AndroidUtilities.m107dp(7)) {
                    return;
                }
                AudioPlayerAlert.this.listView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m107dp(7));
            }
        ...
        ((FrameLayout.LayoutParams) this.playerShadow.getLayoutParams()).bottomMargin = AndroidUtilities.m107dp(179);
        ...
        this.bigAlbumConver.setRoundRadius(AndroidUtilities.m107dp(8));
    ...
    public static /* synthetic */ void lambda$new$1(BaseFragment baseFragment) {
        BulletinFactory.m66of((FrameLayout) baseFragment.getFragmentView(), baseFragment.getResourceProvider()).createSimpleBulletin(C3632R.raw.info, LocaleController.getInternalString(C3632R.string.music_pinned_player_enabled_toast)).show();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Components.AudioPlayerAlert$9 */
    /* loaded from: classes6.dex */
    public class C45039 extends ClippingTextViewSwitcher {
        final /* synthetic */ Context val$context;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C45039(Context context, Context context2) {
            super(context);
        ...
        protected TextView createTextView() {
            ...
            textView.setBackground(Theme.createRadSelectorDrawable(AudioPlayerAlert.this.getThemedColor(Theme.key_listSelector), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4)));
            textView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.AudioPlayerAlert$9$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    AudioPlayerAlert.C45039.this.lambda$createTextView$0(textView, view);
                }
            });
            return textView;
        }
    ...
    /* loaded from: classes6.dex */
    class C448313 extends RLottieImageView {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C448313(Context context, float f) {
            super(context);
            ...
            this.pressedRunnable = new Runnable() { // from class: org.telegram.ui.Components.AudioPlayerAlert.13.1
                @Override // java.lang.Runnable
                public void run() {
                    C448313 c448313 = C448313.this;
                    int i = c448313.pressedCount + 1;
                    c448313.pressedCount = i;
                    if (i != 1) {
                        if (i == 2) {
                    ...
                    C448313.this.lastTime = System.currentTimeMillis();
                    AndroidUtilities.runOnUIThread(this, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                    AndroidUtilities.runOnUIThread(C448313.this.backSeek);
                }
            };
            this.backSeek = new Runnable() { // from class: org.telegram.ui.Components.AudioPlayerAlert.13.2
                ...
                public void run() {
                    ...
                    long currentTimeMillis = System.currentTimeMillis();
                    C448313 c448313 = C448313.this;
                    long j = currentTimeMillis - c448313.lastTime;
                    c448313.lastTime = currentTimeMillis;
                    long j2 = currentTimeMillis - c448313.lastUpdateTime;
                    int i = c448313.pressedCount;
                    ...
                    C448313 c4483132 = C448313.this;
                    AudioPlayerAlert audioPlayerAlert = AudioPlayerAlert.this;
                    if (audioPlayerAlert.rewindingState != -1 || c4483132.pressedCount <= 0) {
                        return;
                    }
                    if (j2 > 200 || audioPlayerAlert.rewindingProgress == BitmapDescriptorFactory.HUE_RED) {
                        c4483132.lastUpdateTime = currentTimeMillis;
                    ...
                    C448313 c4483133 = C448313.this;
                    if (c4483133.pressedCount <= 0 || AudioPlayerAlert.this.rewindingProgress <= BitmapDescriptorFactory.HUE_RED) {
                        return;
                    }
                    AndroidUtilities.runOnUIThread(c4483133.backSeek, 16L);
                }
            };
        }
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r10) {
            ...
            Ldd:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.AudioPlayerAlert.C448313.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    /* loaded from: classes6.dex */
    class C448614 extends RLottieImageView {
        boolean pressed;
        private final Runnable pressedRunnable;
        float startX;
        float startY;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C448614(Context context, float f) {
            super(context);
            this.val$touchSlop = f;
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r7) {
            ...
            Lda:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.AudioPlayerAlert.C448614.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    public int getContainerViewHeight() {
        ...
        int m107dp = AndroidUtilities.m107dp(13);
        int i = (this.scrollOffsetY - this.backgroundPaddingTop) - m107dp;
        ...
        if (this.backgroundPaddingTop + i < C3704ActionBar.getCurrentActionBarHeight()) {
            float m107dp2 = m107dp + AndroidUtilities.m107dp(4);
            i -= (int) ((C3704ActionBar.getCurrentActionBarHeight() - m107dp2) * Math.min(1.0f, ((C3704ActionBar.getCurrentActionBarHeight() - i) - this.backgroundPaddingTop) / m107dp2));
        }
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    public void updateEmptyViewPosition() {
        ...
        int m107dp = this.playerLayout.getVisibility() == 0 ? AndroidUtilities.m107dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION) : -AndroidUtilities.m107dp(30);
        LinearLayout linearLayout = this.emptyView;
        linearLayout.setTranslationY(((linearLayout.getMeasuredHeight() - this.containerView.getMeasuredHeight()) - m107dp) / 2);
    }
    ...
    private void showSpeedHint() {
        if (this.containerView != null) {
            ...
            hintView.setExtraTranslationY(AndroidUtilities.m107dp(6));
    ...
    public void updateColors() {
        if (this.playbackSpeedButton != null) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                this.playbackSpeedButton.setBackground(Theme.createSelectorDrawable(themedColor & 436207615, 1, AndroidUtilities.m107dp(14)));
            }
        }
    }
    ...
    */
        ...
        if (arrayList2.size() > 1 || ((MessagesStorage.TopicKey) arrayList2.get(0)).dialogId == UserConfig.getInstance(this.currentAccount).getClientUserId() || charSequence != null || dialogsActivity.isInMultiSelect()) {
            ...
            for (int i = 0; i < arrayList2.size(); i++) {
                ...
                if (charSequence != null) {
                    SendMessagesHelper.getInstance(this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m94of(charSequence.toString(), j, null, null, null, true, null, null, null, dialogsActivity.notify, dialogsActivity.scheduleDate, null, false, null));
                }
    ...
    public /* synthetic */ void lambda$onSubItemClick$15(Uri uri) {
        BulletinFactory.m66of((FrameLayout) this.containerView, this.resourcesProvider).createDownloadBulletin(BulletinFactory.FileType.AUDIO).show();
    }
    ...
    public void updateLayout() {
        ...
        boolean z2 = top <= AndroidUtilities.m107dp(12);
        ...
        int m107dp3 = top + ((layoutParams.topMargin - AndroidUtilities.statusBarHeight) - AndroidUtilities.m107dp(11));
        if (this.scrollOffsetY != m107dp3) {
            RecyclerListView recyclerListView2 = this.listView;
            this.scrollOffsetY = m107dp3;
            recyclerListView2.setTopGlowOffset((m107dp3 - layoutParams.topMargin) - AndroidUtilities.statusBarHeight);
            this.containerView.invalidate();
        }
        int m107dp4 = (this.scrollOffsetY - this.backgroundPaddingTop) - AndroidUtilities.m107dp(13);
        if (this.currentSheetAnimationType == 1) {
            m107dp4 = (int) (m107dp4 + this.listView.getTranslationY());
        }
        if ((this.backgroundPaddingTop + m107dp4 < C3704ActionBar.getCurrentActionBarHeight() ? 1.0f - Math.min(1.0f, ((C3704ActionBar.getCurrentActionBarHeight() - m107dp4) - this.backgroundPaddingTop) / (m107dp + AndroidUtilities.m107dp(4))) : 1.0f) <= 0.5f && ColorUtils.calculateLuminance(getThemedColor(Theme.key_dialogBackground)) > 0.699999988079071d) {
            z = true;
        }
        if (z != this.wasLight) {
    ...
    private void updateTitle(boolean z) {
        ...
        if ((playingMessageObject == null && z) || (playingMessageObject != null && !playingMessageObject.isMusic())) {
            ...
            if ((dialogId < 0 && MessagesController.getInstance(this.currentAccount).isChatNoForwards(-dialogId)) || MessagesController.getInstance(this.currentAccount).isChatNoForwards(playingMessageObject.getChatId()) || playingMessageObject.messageOwner.noforwards) {
                ...
                this.optionsButton.setAdditionalYOffset(-AndroidUtilities.m107dp(16));
            } else {
                ...
                actionBarMenuItem.setAdditionalYOffset(actionBarMenuItem.getAdditionalYOffset() - m107dp);
            }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void notifyDataSetChanged() {
            ...
            if (AudioPlayerAlert.this.playlist.size() > 1) {
                ...
                AudioPlayerAlert.this.listView.setPadding(0, AudioPlayerAlert.this.listView.getPaddingTop(), 0, AndroidUtilities.m107dp(179));
            } else {
    ...
    public static abstract class CoverContainer extends FrameLayout {
        ...
        public CoverContainer(Context context) {
            ...
            for (final int i = 0; i < 2; i++) {
                ...
                this.imageViews[i].setRoundRadius(AndroidUtilities.m107dp(4));
                if (i == 1) {
    ...
    public static abstract class ClippingTextViewSwitcher extends FrameLayout {
        ...
        public ClippingTextViewSwitcher(Context context) {
            ...
            this.gradientSize = AndroidUtilities.m107dp(24);
            this.stableOffest = -1;
