...
public class ProfileGalleryView extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final C3484ActionBar parentActionBar;
    ...
    public ProfileGalleryView(Context context, C3484ActionBar c3484ActionBar, RecyclerListView recyclerListView, Callback callback) {
        super(context);
        ...
        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getContext(), null, c3484ActionBar);
    ...
    public ProfileGalleryView(Context context, long j, C3484ActionBar c3484ActionBar, RecyclerListView recyclerListView, ProfileActivity.AvatarImageView avatarImageView, int i, Callback callback) {
        super(context);
        this.downPoint = new PointF();
        this.isScrollingListView = true;
        this.isSwipingViewPager = true;
        ...
        this.parentActionBar = c3484ActionBar;
        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getContext(), avatarImageView, c3484ActionBar);
        this.adapter = viewPagerAdapter;
        setAdapter((CircularViewPager.Adapter) viewPagerAdapter);
        this.touchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        this.callback = callback;
    ...
    */
    ...
    public class ViewPagerAdapter extends CircularViewPager.Adapter {
        ...
        public ViewPagerAdapter(Context context, ProfileActivity.AvatarImageView avatarImageView, C3484ActionBar c3484ActionBar) {
    ...
    public class AvatarImageView extends BackupImageView {
        ...
        protected void onSizeChanged(int i, int i2, int i3, int i4) {
            ...
            if (this.radialProgress != null) {
                int currentActionBarHeight = (ProfileGalleryView.this.parentActionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + C3484ActionBar.getCurrentActionBarHeight();
