...
public class ProfileGalleryView extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final C3541ActionBar parentActionBar;
    ...
    public ProfileGalleryView(Context context, C3541ActionBar c3541ActionBar, RecyclerListView recyclerListView, Callback callback) {
        super(context);
        ...
        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getContext(), null, c3541ActionBar);
    ...
    public ProfileGalleryView(Context context, long j, C3541ActionBar c3541ActionBar, RecyclerListView recyclerListView, ProfileActivity.AvatarImageView avatarImageView, int i, Callback callback) {
        super(context);
        this.downPoint = new PointF();
        this.isScrollingListView = true;
        this.isSwipingViewPager = true;
        ...
        this.parentActionBar = c3541ActionBar;
        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getContext(), avatarImageView, c3541ActionBar);
        this.adapter = viewPagerAdapter;
        setAdapter((CircularViewPager.Adapter) viewPagerAdapter);
        this.touchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        this.callback = callback;
    ...
    */
    public void didReceivedNotification(int r17, int r18, java.lang.Object... r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.ProfileGalleryView.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
    ...
    public class ViewPagerAdapter extends CircularViewPager.Adapter {
        ...
        public ViewPagerAdapter(Context context, ProfileActivity.AvatarImageView avatarImageView, C3541ActionBar c3541ActionBar) {
    ...
    public class AvatarImageView extends BackupImageView {
        ...
        protected void onSizeChanged(int i, int i2, int i3, int i4) {
            ...
            if (this.radialProgress != null) {
                int currentActionBarHeight = (ProfileGalleryView.this.parentActionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + C3541ActionBar.getCurrentActionBarHeight();
