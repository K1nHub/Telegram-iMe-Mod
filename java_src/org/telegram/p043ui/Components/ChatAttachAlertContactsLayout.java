...
public class ChatAttachAlertContactsLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class UserCell extends FrameLayout {
        ...
        public UserCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            backupImageView.setRoundRadius(AndroidUtilities.m104dp(23));
            ...
            SimpleTextView simpleTextView = new SimpleTextView(this, context) { // from class: org.telegram.ui.Components.ChatAttachAlertContactsLayout.UserCell.1
                ...
                public boolean setText(CharSequence charSequence, boolean z2) {
                    return super.setText(Emoji.replaceEmoji(charSequence, getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(14), false), z2);
                }
            };
        ...
        public void lambda$setData$0(CharSequence charSequence) {
            ...
            if (tLRPC$User != null) {
                if (TextUtils.isEmpty(tLRPC$User.phone)) {
                    this.statusTextView.setText(LocaleController.getString("NumberUnknown", C3634R.string.NumberUnknown));
        ...
        public /* synthetic */ void lambda$setStatus$3() {
            if (this.currentUser != null) {
                ...
                this.formattedPhoneNumber = c3549PhoneFormat.format("+" + this.currentUser.phone);
    ...
    public ChatAttachAlertContactsLayout(ChatAttachAlert chatAttachAlert, Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        SearchField searchField = new SearchField(context, false, resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertContactsLayout.1
            ...
            public void onTextChange(String str) {
                if (str.length() != 0) {
                    if (ChatAttachAlertContactsLayout.this.emptyView != null) {
                        ChatAttachAlertContactsLayout.this.emptyView.setText(LocaleController.getString("NoResult", C3634R.string.NoResult));
                    }
                    ...
                    ChatAttachAlertContactsLayout.this.emptyView.setText(LocaleController.getString("NoContacts", C3634R.string.NoContacts));
            ...
            public void processTouchEvent(MotionEvent motionEvent) {
                ...
                obtain.setLocation(obtain.getRawX(), (obtain.getRawY() - ChatAttachAlertContactsLayout.this.parentAlert.getSheetContainer().getTranslationY()) - AndroidUtilities.m104dp(58));
        ...
        searchField.setHint(LocaleController.getString("SearchFriends", C3634R.string.SearchFriends));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context, resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertContactsLayout.2
            ...
            protected boolean allowSelectChildAtPosition(float f, float f2) {
                return f2 >= ((float) ((ChatAttachAlertContactsLayout.this.parentAlert.scrollOffsetY[0] + AndroidUtilities.m104dp(30)) + ((Build.VERSION.SDK_INT < 21 || ChatAttachAlertContactsLayout.this.parentAlert.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight)));
            }
        };
        this.listView = recyclerListView;
        recyclerListView.setClipToPadding(false);
        RecyclerListView recyclerListView2 = this.listView;
        FillLastLinearLayoutManager fillLastLinearLayoutManager = new FillLastLinearLayoutManager(getContext(), 1, false, AndroidUtilities.m104dp(9), this.listView) { // from class: org.telegram.ui.Components.ChatAttachAlertContactsLayout.3
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.ChatAttachAlertContactsLayout.3.1
                    ...
                    public int calculateDyToMakeVisible(View view, int i2) {
                        return super.calculateDyToMakeVisible(view, i2) - (ChatAttachAlertContactsLayout.this.listView.getPaddingTop() - AndroidUtilities.m104dp(8));
                    }
    ...
    public class ShareAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                userCell.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m104dp(56)));
            } else {
                userCell = new View(this.mContext);
            }
        ...
        public static /* synthetic */ CharSequence lambda$onBindViewHolder$0(ContactsController.Contact contact) {
            return contact.phones.isEmpty() ? "" : C3549PhoneFormat.getInstance().format(contact.phones.get(0));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ CharSequence lambda$onBindViewHolder$1(TLRPC$User tLRPC$User) {
            C3549PhoneFormat c3549PhoneFormat = C3549PhoneFormat.getInstance();
            return c3549PhoneFormat.format("+" + tLRPC$User.phone);
        }
