...
public class MediaActivity extends BaseFragment implements SharedMediaLayout.SharedMediaPreloaderDelegate, FloatingDebugProvider, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    /* loaded from: classes7.dex */
    class C49821 extends C3541ActionBar.ActionBarMenuOnItemClick {
        C49821() {
        }
        ...
        public void onItemClick(int i) {
            ...
            if (i == -1) {
                ...
                if (arrayList.size() > 1) {
                    i2 = C3473R.string.DeleteStoriesTitle;
                    str = "DeleteStoriesTitle";
                } else {
                    i2 = C3473R.string.DeleteStoryTitle;
                ...
                builder.setPositiveButton(LocaleController.getString("Delete", C3473R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.MediaActivity.1.1
                ...
                builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.MediaActivity$1$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void lambda$createView$11(View view) {
        ...
        if (z) {
            show = BulletinFactory.m32of(this).createSimpleBulletin(C3473R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), runnable2).show();
        } else {
            show = BulletinFactory.m32of(this).createSimpleBulletin(C3473R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i, new Object[0]), LocaleController.getString("Undo"), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS, runnable2).show();
        }
    ...
    public class StoriesTabsView extends View {
        ...
        public class Tab {
            ...
            public void setColor(int i) {
                if (this.f1776i != 2 && !MediaActivity.this.getMessagesController().storiesEnabled()) {
        ...
        public StoriesTabsView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            Tab[] tabArr = {new Tab(0, C3473R.raw.msg_stories_saved, LocaleController.getString("ProfileMyStoriesTab", C3473R.string.ProfileMyStoriesTab)), new Tab(1, C3473R.raw.msg_stories_archive, LocaleController.getString("ProfileStoriesArchiveTab", C3473R.string.ProfileStoriesArchiveTab)), new Tab(2, C3473R.raw.fork_stories_settings, LocaleController.getString("Settings", C3473R.string.Settings))};
