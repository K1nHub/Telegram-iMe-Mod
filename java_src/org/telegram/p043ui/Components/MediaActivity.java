...
public class MediaActivity extends BaseFragment implements SharedMediaLayout.SharedMediaPreloaderDelegate, FloatingDebugProvider, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    /* loaded from: classes6.dex */
    class C51981 extends C3704ActionBar.ActionBarMenuOnItemClick {
        C51981() {
        }
    ...
    public /* synthetic */ void lambda$createView$11(View view) {
        ...
        if (z) {
            show = BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), runnable2).show();
        } else {
            show = BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i, new Object[0]), LocaleController.getString("Undo"), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS, runnable2).show();
        }
    ...
    */
    ...
    private void showSubtitle(final int i, final boolean z, boolean z2) {
        ...
        if (zArr[i] != z || this.firstSubtitleCheck[i]) {
            ...
            if (z3) {
                ...
                this.subtitleAnimator[i].addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.MediaActivity.8
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        MediaActivity.this.nameTextView[i].setTranslationY(z ? 0.0f : AndroidUtilities.m107dp(8));
            ...
            this.nameTextView[i].setTranslationY(z ? 0.0f : AndroidUtilities.m107dp(8));
    ...
    public /* synthetic */ void lambda$showSubtitle$16(int i, ValueAnimator valueAnimator) {
        ...
        this.nameTextView[i].setTranslationY(AndroidUtilities.lerp(AndroidUtilities.m107dp(8), 0, this.subtitleT[i]));
