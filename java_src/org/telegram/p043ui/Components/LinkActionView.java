...
public class LinkActionView extends LinearLayout {
    ...
    public LinkActionView(Context context, BaseFragment baseFragment, BottomSheet bottomSheet, long j, boolean z, boolean z2) {
        this(context, baseFragment, bottomSheet, j, z, z2, false, false, true, null);
    }
    ...
    public void setNetworkImage(String str) {
        ...
        materialShapeDrawable.setCornerSize(AndroidUtilities.m107dp(20) / 2.0f);
        ...
        this.networkImageView.setPadding(m107dp, m107dp, m107dp, m107dp);
    ...
    public void addMaxButton(final Callbacks$Callback callbacks$Callback) {
        ...
        EditTextBoldCursor editTextBoldCursor = this.editText;
        editTextBoldCursor.setPadding(editTextBoldCursor.getPaddingLeft(), this.editText.getPaddingTop(), AndroidUtilities.m107dp(60), this.editText.getPaddingBottom());
        updateColors();
    }
    ...
    public void handleClearEditTextButton() {
        ...
        if (obj.isEmpty() || this.frameLayout.indexOfChild(this.clearTextImageView) == -1) {
            ...
            EditTextBoldCursor editTextBoldCursor = this.editText;
            editTextBoldCursor.setPadding(editTextBoldCursor.getPaddingLeft(), this.editText.getPaddingTop(), AndroidUtilities.m107dp(22), this.editText.getPaddingBottom());
        }
    }
    ...
    private void updateInputPadding(Boolean bool) {
        if (bool.booleanValue()) {
            this.linkView.setPadding(AndroidUtilities.m107dp(64), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
            EditTextBoldCursor editTextBoldCursor = this.editText;
            if (editTextBoldCursor != null) {
                editTextBoldCursor.setPadding(AndroidUtilities.m107dp(64), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
                return;
            }
            return;
        }
        this.linkView.setPadding(AndroidUtilities.m107dp(20), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
        EditTextBoldCursor editTextBoldCursor2 = this.editText;
        if (editTextBoldCursor2 != null) {
            editTextBoldCursor2.setPadding(AndroidUtilities.m107dp(20), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
        }
    }
    ...
    public LinkActionView(final Context context, final BaseFragment baseFragment, final BottomSheet bottomSheet, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, AttributeSet attributeSet) {
        ...
        if (z3) {
            ...
            this.editText.setPadding(AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(40), AndroidUtilities.m107dp(18));
        ...
        textView.setPadding(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(40), AndroidUtilities.m107dp(13));
        ...
        spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m107dp(6)), 1, 2, 0);
        ...
        spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m107dp(6)), 1, 2, 0);
        ...
        textView3.setPadding(AndroidUtilities.m107dp(8), 0, AndroidUtilities.m107dp(8), 0);
        ...
        spannableStringBuilder3.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m107dp(8)), 1, 2, 0);
        spannableStringBuilder3.append((CharSequence) LocaleController.getString("DeleteLink", C3632R.string.DeleteLink));
        spannableStringBuilder3.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m107dp(5)), spannableStringBuilder3.length() - 1, spannableStringBuilder3.length(), 0);
        textView4.setText(spannableStringBuilder3);
        textView4.setPadding(AndroidUtilities.m107dp(8), 0, AndroidUtilities.m107dp(8), 0);
        ...
        avatarsContainer.avatarsImageView.setAvatarsTextSize(AndroidUtilities.m107dp(18));
    ...
    public /* synthetic */ void lambda$new$13(final Context context, BottomSheet bottomSheet, BaseFragment baseFragment, View view) {
        ...
        if (container != null) {
            ...
            this.actionBarPopupWindow.showAtLocation(container, 0, (int) (((container.getMeasuredWidth() - actionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.m107dp(16)) + container.getX() + f2), (int) (f + this.frameLayout.getMeasuredHeight() + container.getY()));
        }
    }
    ...
    public void updateColors() {
        ...
        if (textView2 != null) {
            ...
            this.maxView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(6), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
        }
        ...
        textView4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(m107dp, color, Theme.getColor(i4)));
        this.shareView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(8), Theme.getColor(i3), Theme.getColor(i4)));
        this.removeView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(8), Theme.getColor(Theme.key_chat_attachAudioBackground), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhite), 120)));
        this.frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(8), Theme.getColor(Theme.key_graySection), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 76)));
        ...
        this.avatarsContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(6), 0, ColorUtils.setAlphaComponent(Theme.getColor(i5), 76)));
        ...
        public AvatarsContainer(Context context) {
            ...
            this.avatarsImageView = new AvatarsImageView(context, false, LinkActionView.this) { // from class: org.telegram.ui.Components.LinkActionView.AvatarsContainer.1
                ...
                public void onMeasure(int i, int i2) {
                    ...
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(min == 0 ? 0 : ((min - 1) * 20) + 24 + 8), 1073741824), i2);
                }
            };
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(0);
    ...
    public void setUsers(int i, ArrayList<TLRPC$User> arrayList, boolean z) {
        ...
        if (i == 0) {
            this.avatarsContainer.setVisibility(8);
            setPadding(AndroidUtilities.m107dp(19), AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(19), AndroidUtilities.m107dp(18));
        } else {
            this.avatarsContainer.setVisibility(0);
            setPadding(AndroidUtilities.m107dp(19), AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(19), AndroidUtilities.m107dp(10));
