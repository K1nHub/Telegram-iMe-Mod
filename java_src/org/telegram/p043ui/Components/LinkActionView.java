...
public class LinkActionView extends LinearLayout {
    ...
    public void addMaxButton(final Callbacks$Callback callbacks$Callback) {
        ...
        textView.setText(LocaleController.getInternalString(C3632R.string.common_max));
    ...
    public void handleClearEditTextButton() {
        ...
        if (obj.isEmpty() || this.frameLayout.indexOfChild(this.clearTextImageView) == -1) {
            ...
            Drawable drawable = ContextCompat.getDrawable(getContext(), C3632R.C3634drawable.fork_delete_icon);
            if (drawable != null) {
    ...
    public void setErrorState(boolean z) {
        this.editText.setBackgroundResource(z ? C3632R.C3634drawable.fork_bg_error : 0);
        this.linkView.setBackgroundResource(z ? C3632R.C3634drawable.fork_bg_error : 0);
    }
    ...
    public LinkActionView(final Context context, final BaseFragment baseFragment, final BottomSheet bottomSheet, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, AttributeSet attributeSet) {
        ...
        this.optionsView.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3632R.string.AccDescrMoreOptions));
        ...
        spannableStringBuilder.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3632R.C3634drawable.msg_copy_filled)), 0, 1, 0);
        spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m104dp(6)), 1, 2, 0);
        int i = C3632R.string.LinkActionCopy;
        ...
        spannableStringBuilder2.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3632R.C3634drawable.msg_share_filled)), 0, 1, 0);
        spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m104dp(6)), 1, 2, 0);
        int i2 = C3632R.string.LinkActionShare;
        ...
        spannableStringBuilder3.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3632R.C3634drawable.msg_delete_filled)), 0, 1, 0);
        spannableStringBuilder3.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m104dp(8)), 1, 2, 0);
        spannableStringBuilder3.append((CharSequence) LocaleController.getString("DeleteLink", C3632R.string.DeleteLink));
    ...
    public /* synthetic */ void lambda$new$5(BaseFragment baseFragment, View view) {
        try {
            ...
            baseFragment.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C3632R.string.InviteToGroupByLink)), 500);
        } catch (Exception e) {
            FileLog.m99e(e);
        }
    }
    ...
    public /* synthetic */ void lambda$new$7(BaseFragment baseFragment, View view) {
        ...
        builder.setTitle(LocaleController.getString("DeleteLink", C3632R.string.DeleteLink));
        builder.setMessage(LocaleController.getString("DeleteLinkHelp", C3632R.string.DeleteLinkHelp));
        builder.setPositiveButton(LocaleController.getString("Delete", C3632R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$new$11(Context context, ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        if (!this.permanent && this.canEdit) {
            ...
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Edit", C3632R.string.Edit), C3632R.C3634drawable.msg_edit);
            actionBarPopupWindowLayout.addView((View) actionBarMenuSubItem, LayoutHelper.createLinear(-1, 48));
        ...
        actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("GetQRCode", C3632R.string.GetQRCode), C3632R.C3634drawable.msg_qrcode);
        ...
        actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("RevokeLink", C3632R.string.RevokeLink), C3632R.C3634drawable.msg_delete);
    ...
    private void showQrCode() {
        ...
        String string = LocaleController.getString("InviteByQRCode", C3632R.string.InviteByQRCode);
        String str2 = this.link;
        String str3 = this.qrText;
        if (str3 == null) {
            if (this.isChannel) {
                i = C3632R.string.QRCodeLinkHelpChannel;
                str = "QRCodeLinkHelpChannel";
            } else {
                i = C3632R.string.QRCodeLinkHelpGroup;
    ...
    public void setLink(String str) {
        this.link = str;
        if (str == null) {
            this.linkView.setText(LocaleController.getString("Loading", C3632R.string.Loading));
    ...
    public void hideRevokeOption(boolean z) {
        if (this.hideRevokeOption != z) {
            ...
            imageView.setImageDrawable(ContextCompat.getDrawable(imageView.getContext(), C3632R.C3634drawable.ic_ab_other));
        }
    }
    ...
    private void revokeLink() {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3632R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
