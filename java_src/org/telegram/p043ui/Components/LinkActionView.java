...
public class LinkActionView extends LinearLayout {
    ...
    public void setNetworkImage(String str) {
        ...
        materialShapeDrawable.setCornerSize(AndroidUtilities.m104dp(20) / 2.0f);
        ...
        this.networkImageView.setPadding(m104dp, m104dp, m104dp, m104dp);
    ...
    public void addMaxButton(final Callbacks$Callback callbacks$Callback) {
        ...
        textView.setText(LocaleController.getInternalString(C3634R.string.common_max));
        ...
        EditTextBoldCursor editTextBoldCursor = this.editText;
        editTextBoldCursor.setPadding(editTextBoldCursor.getPaddingLeft(), this.editText.getPaddingTop(), AndroidUtilities.m104dp(60), this.editText.getPaddingBottom());
        updateColors();
    }
    ...
    public void handleClearEditTextButton() {
        ...
        if (obj.isEmpty() || this.frameLayout.indexOfChild(this.clearTextImageView) == -1) {
            ...
            Drawable drawable = ContextCompat.getDrawable(getContext(), C3634R.C3636drawable.fork_delete_icon);
            if (drawable != null) {
            ...
            EditTextBoldCursor editTextBoldCursor = this.editText;
            editTextBoldCursor.setPadding(editTextBoldCursor.getPaddingLeft(), this.editText.getPaddingTop(), AndroidUtilities.m104dp(22), this.editText.getPaddingBottom());
        }
    }
    ...
    public void setErrorState(boolean z) {
        this.editText.setBackgroundResource(z ? C3634R.C3636drawable.fork_bg_error : 0);
        this.linkView.setBackgroundResource(z ? C3634R.C3636drawable.fork_bg_error : 0);
    }

    private void updateInputPadding(Boolean bool) {
        if (bool.booleanValue()) {
            this.linkView.setPadding(AndroidUtilities.m104dp(64), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
            EditTextBoldCursor editTextBoldCursor = this.editText;
            if (editTextBoldCursor != null) {
                editTextBoldCursor.setPadding(AndroidUtilities.m104dp(64), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
                return;
            }
            return;
        }
        this.linkView.setPadding(AndroidUtilities.m104dp(20), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
        EditTextBoldCursor editTextBoldCursor2 = this.editText;
        if (editTextBoldCursor2 != null) {
            editTextBoldCursor2.setPadding(AndroidUtilities.m104dp(20), this.linkView.getPaddingTop(), this.linkView.getPaddingRight(), this.linkView.getPaddingBottom());
        }
    }
    ...
    public LinkActionView(final Context context, final BaseFragment baseFragment, final BottomSheet bottomSheet, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, AttributeSet attributeSet) {
        ...
        if (z3) {
            ...
            this.editText.setPadding(AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(40), AndroidUtilities.m104dp(18));
        ...
        textView.setPadding(AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(40), AndroidUtilities.m104dp(13));
        ...
        imageView.setImageDrawable(ContextCompat.getDrawable(context, C3634R.C3636drawable.ic_ab_other));
        this.optionsView.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3634R.string.AccDescrMoreOptions));
        ...
        spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m104dp(6)), 1, 2, 0);
        int i = C3634R.string.LinkActionCopy;
        ...
        textView2.setPadding(AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8), 0);
        ...
        spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m104dp(6)), 1, 2, 0);
        int i2 = C3634R.string.LinkActionShare;
        ...
        textView3.setPadding(AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8), 0);
        ...
        spannableStringBuilder3.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3634R.C3636drawable.msg_delete_filled)), 0, 1, 0);
        spannableStringBuilder3.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m104dp(8)), 1, 2, 0);
        spannableStringBuilder3.append((CharSequence) LocaleController.getString("DeleteLink", C3634R.string.DeleteLink));
        spannableStringBuilder3.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m104dp(5)), spannableStringBuilder3.length() - 1, spannableStringBuilder3.length(), 0);
        textView4.setText(spannableStringBuilder3);
        textView4.setPadding(AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8), 0);
        ...
        avatarsContainer.avatarsImageView.setAvatarsTextSize(AndroidUtilities.m104dp(18));
    ...
    public /* synthetic */ void lambda$new$5(BaseFragment baseFragment, View view) {
        try {
            ...
            baseFragment.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C3634R.string.InviteToGroupByLink)), 500);
        } catch (Exception e) {
            FileLog.m99e(e);
        }
    }
    ...
    public /* synthetic */ void lambda$new$7(BaseFragment baseFragment, View view) {
        ...
        builder.setTitle(LocaleController.getString("DeleteLink", C3634R.string.DeleteLink));
        builder.setMessage(LocaleController.getString("DeleteLinkHelp", C3634R.string.DeleteLinkHelp));
        builder.setPositiveButton(LocaleController.getString("Delete", C3634R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$new$13(final Context context, BottomSheet bottomSheet, BaseFragment baseFragment, View view) {
        ...
        if (container != null) {
            ...
            this.actionBarPopupWindow.showAtLocation(container, 0, (int) (((container.getMeasuredWidth() - actionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.m104dp(16)) + container.getX() + f2), (int) (f + this.frameLayout.getMeasuredHeight() + container.getY()));
        }
    }
    ...
    public /* synthetic */ void lambda$new$11(Context context, ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        if (!this.permanent && this.canEdit) {
            ...
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Edit", C3634R.string.Edit), C3634R.C3636drawable.msg_edit);
            actionBarPopupWindowLayout.addView((View) actionBarMenuSubItem, LayoutHelper.createLinear(-1, 48));
        ...
        actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("RevokeLink", C3634R.string.RevokeLink), C3634R.C3636drawable.msg_delete);
    ...
    private void showQrCode() {
        ...
        String string = LocaleController.getString("InviteByQRCode", C3634R.string.InviteByQRCode);
        String str2 = this.link;
        String str3 = this.qrText;
        if (str3 == null) {
            if (this.isChannel) {
                i = C3634R.string.QRCodeLinkHelpChannel;
                str = "QRCodeLinkHelpChannel";
            } else {
                i = C3634R.string.QRCodeLinkHelpGroup;
    ...
    public void updateColors() {
        ...
        if (textView2 != null) {
            ...
            this.maxView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(6), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
        }
        ...
        textView4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(m104dp, color, Theme.getColor(i4)));
        this.shareView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(8), Theme.getColor(i3), Theme.getColor(i4)));
        this.removeView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(8), Theme.getColor(Theme.key_chat_attachAudioBackground), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhite), 120)));
        this.frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(8), Theme.getColor(Theme.key_graySection), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 76)));
        ...
        this.avatarsContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(6), 0, ColorUtils.setAlphaComponent(Theme.getColor(i5), 76)));
    ...
    public void setLink(String str) {
        this.link = str;
        if (str == null) {
            this.linkView.setText(LocaleController.getString("Loading", C3634R.string.Loading));
    ...
    public void hideRevokeOption(boolean z) {
        if (this.hideRevokeOption != z) {
            ...
            imageView.setImageDrawable(ContextCompat.getDrawable(imageView.getContext(), C3634R.C3636drawable.ic_ab_other));
        }
    }
        ...
        public AvatarsContainer(Context context) {
            ...
            this.avatarsImageView = new AvatarsImageView(context, false, LinkActionView.this) { // from class: org.telegram.ui.Components.LinkActionView.AvatarsContainer.1
                ...
                public void onMeasure(int i, int i2) {
                    ...
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(min == 0 ? 0 : ((min - 1) * 20) + 24 + 8), 1073741824), i2);
                }
            };
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(0);
            ...
            setPadding(0, AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8));
    ...
    private void revokeLink() {
        ...
        builder.setMessage(LocaleController.getString("RevokeAlert", C3634R.string.RevokeAlert));
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3634R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void setUsers(int i, ArrayList<TLRPC$User> arrayList, boolean z) {
        ...
        if (i == 0) {
            this.avatarsContainer.setVisibility(8);
            setPadding(AndroidUtilities.m104dp(19), AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(19), AndroidUtilities.m104dp(18));
        } else {
            this.avatarsContainer.setVisibility(0);
            setPadding(AndroidUtilities.m104dp(19), AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(19), AndroidUtilities.m104dp(10));
