...
public class MessageTopicButton {
    ...
    */
    public int set(org.telegram.p043ui.Cells.ChatMessageCell r29, org.telegram.messenger.MessageObject r30, org.telegram.tgnet.TLRPC$TL_forumTopic r31, int r32) {
        /*
    ...
    public void draw(Canvas canvas, float f, float f2, float f3) {
        ...
        if (this.topicNameLayout != null) {
            canvas.save();
            canvas.translate((AndroidUtilities.m104dp(this.isGeneralTopic ? 13 : 17) + Theme.chat_topicTextPaint.getTextSize()) - this.topicNameLeft, AndroidUtilities.m105dp(4.5f));
