...
public class SeekBarWaveform {
        ...
        if (fArr2 != null && (fArr = this.toHeights) != null) {
            ...
            if (this.heights != null) {
                while (true) {
                    ...
                    float dpf22 = AndroidUtilities.dpf2(3.0f) * f7;
                    float clamp2 = MathUtils.clamp((f4 * dpf2) - f7, (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
                    addBar(this.path, dpf22, (AndroidUtilities.dpf2(this.heights[i2]) * clamp2) - (AndroidUtilities.dpf2(1.0f) * (1.0f - clamp2)));
                    i2++;
                }
            }
            f = 0.0f;
    ...
    private void drawFill(Canvas canvas, float f) {
        ...
        if (f2 > BitmapDescriptorFactory.HUE_RED) {
            if (this.loadingPaint == null || Math.abs(this.loadingPaintWidth - this.width) > AndroidUtilities.m104dp(8) || this.loadingPaintColor1 != this.innerColor || this.loadingPaintColor2 != this.outerColor) {
    ...
    private void addBar(Path path, float f, float f2) {
        float dpf2 = AndroidUtilities.dpf2(2.0f);
        int m104dp = (this.height - AndroidUtilities.m104dp(14)) / 2;
        float f3 = f2 * this.waveScaling;
        RectF rectF = AndroidUtilities.rectTmp;
        float f4 = dpf2 / 2.0f;
        rectF.set((AndroidUtilities.dpf2(1.0f) + f) - f4, AndroidUtilities.m104dp(7) + m104dp + ((-f3) - f4), f + AndroidUtilities.dpf2(1.0f) + f4, m104dp + AndroidUtilities.m104dp(7) + f3 + f4);
