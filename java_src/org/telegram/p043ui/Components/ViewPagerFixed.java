    ...
    */
    ...
    public static class TabsView extends FrameLayout {
        ...
        public void addTabWithIcon(int i, String str, int i2) {
            ...
            this.allTabsWidth += tabWithIcon.getWidth(true, this.textPaint) + AndroidUtilities.m104dp(32);
        ...
        public class TabWithIcon extends Tab {
            ...
            public int getWidth(boolean z, TextPaint textPaint) {
                int ceil = ((int) Math.ceil(textPaint.measureText(this.title))) + this.icon.getIntrinsicWidth() + AndroidUtilities.m104dp(this.iconPadding);
                this.titleWidth = ceil;
                return Math.max(AndroidUtilities.m104dp(40), ceil);
            }
        }
        ...
        public class TabView extends View {
            ...
            @Override // android.view.View
            public int getId() {
                return this.currentTab.f1967id;
            }

            @Override // android.view.View
            protected void onMeasure(int i, int i2) {
                setMeasuredDimension(this.currentTab.getWidth(false, TabsView.this.textPaint) + AndroidUtilities.m104dp(TabsView.this.tabMarginDp * 2) + TabsView.this.additionalTabWidth, View.MeasureSpec.getSize(i2));
            }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i10;
                int i11;
                if (this.currentTab.f1967id != Integer.MAX_VALUE && TabsView.this.editingAnimationProgress != BitmapDescriptorFactory.HUE_RED) {
                    canvas.save();
                    float f = TabsView.this.editingAnimationProgress * (this.currentPosition % 2 == 0 ? 1.0f : -1.0f);
                    canvas.translate(AndroidUtilities.m105dp(0.66f) * f, BitmapDescriptorFactory.HUE_RED);
                ...
                if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToId != -1) && ((i7 = this.currentTab.f1967id) == i || i7 == i2)) {
                ...
                if (i12 > 0) {
                    ...
                    i9 = Math.max(AndroidUtilities.m104dp(10), i8) + AndroidUtilities.m104dp(10);
                } else {
                    str = null;
                    i8 = 0;
                    i9 = 0;
                }
                if (this.currentTab.f1967id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != BitmapDescriptorFactory.HUE_RED)) {
                    i9 = (int) (i9 + ((AndroidUtilities.m104dp(20) - i9) * TabsView.this.editingStartAnimationProgress));
                }
                int i13 = this.currentTab.titleWidth;
                if (i9 != 0) {
                    i10 = AndroidUtilities.m105dp((str != null ? 1.0f : TabsView.this.editingStartAnimationProgress) * 6.0f) + i9;
                } else {
                    i10 = 0;
                }
                ...
                if (tab instanceof TabWithIcon) {
                    ...
                    canvas.restore();
                    measuredWidth = ((tabWithIcon.icon.getIntrinsicWidth() + measuredWidth2) + AndroidUtilities.m104dp(tabWithIcon.iconPadding)) - AndroidUtilities.m104dp(3);
                }
                if (!TextUtils.equals(this.currentTab.title, this.currentText)) {
                    String str2 = this.currentTab.title;
                    this.currentText = str2;
                    StaticLayout staticLayout = new StaticLayout(Emoji.replaceEmoji((CharSequence) str2, TabsView.this.textPaint.getFontMetricsInt(), AndroidUtilities.m104dp(15), false), TabsView.this.textPaint, AndroidUtilities.m104dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                ...
                if (str != null || (this.currentTab.f1967id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != BitmapDescriptorFactory.HUE_RED))) {
                    ...
                    if (!Theme.hasThemeKey(i5) || !Theme.hasThemeKey(i6)) {
                        ...
                        if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToPosition != -1) && ((i11 = this.currentTab.f1967id) == i || i11 == i2)) {
                    ...
                    int m104dp = measuredWidth + this.currentTab.titleWidth + AndroidUtilities.m104dp(6);
                    int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m104dp(20)) / 2;
                    if (this.currentTab.f1967id == Integer.MAX_VALUE || ((!TabsView.this.isEditing && TabsView.this.editingStartAnimationProgress == BitmapDescriptorFactory.HUE_RED) || str != null)) {
                    ...
                    this.rect.set(m104dp, measuredHeight, m104dp + i9, AndroidUtilities.m104dp(20) + measuredHeight);
                    RectF rectF = this.rect;
                    float f2 = AndroidUtilities.density;
                    canvas.drawRoundRect(rectF, f2 * 11.5f, f2 * 11.5f, TabsView.this.counterPaint);
                    if (str != null) {
                        if (this.currentTab.f1967id != Integer.MAX_VALUE) {
                            TabsView.this.textCounterPaint.setAlpha((int) ((1.0f - TabsView.this.editingStartAnimationProgress) * 255.0f));
                        }
                        RectF rectF2 = this.rect;
                        canvas.drawText(str, rectF2.left + ((rectF2.width() - i8) / 2.0f), measuredHeight + AndroidUtilities.m105dp(14.5f), TabsView.this.textCounterPaint);
                    }
                    if (this.currentTab.f1967id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != BitmapDescriptorFactory.HUE_RED)) {
                        ...
                        canvas.drawLine(this.rect.centerX() - m104dp2, this.rect.centerY() - m104dp2, this.rect.centerX() + m104dp2, this.rect.centerY() + m104dp2, TabsView.this.deletePaint);
                        canvas.drawLine(this.rect.centerX() - m104dp2, this.rect.centerY() + m104dp2, this.rect.centerX() + m104dp2, this.rect.centerY() - m104dp2, TabsView.this.deletePaint);
                    }
                }
                if (this.currentTab.f1967id == Integer.MAX_VALUE || TabsView.this.editingAnimationProgress == BitmapDescriptorFactory.HUE_RED) {
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                accessibilityNodeInfo.setSelected((this.currentTab == null || TabsView.this.selectedTabId == -1 || this.currentTab.f1967id != TabsView.this.selectedTabId) ? false : true);
            }
        }
                ...
                public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i2) {
                    LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.ViewPagerFixed.TabsView.3.1
                        ...
                        protected void onTargetFound(View view, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                            ...
                            } else if (calculateDxToMakeVisible < 0 || (calculateDxToMakeVisible == 0 && view.getRight() + AndroidUtilities.m104dp(21) > TabsView.this.getMeasuredWidth())) {
                                calculateDxToMakeVisible -= AndroidUtilities.m104dp(60);
                            }
        ...
        public /* synthetic */ void lambda$new$0(View view, int i, float f, float f2) {
            ...
            if (this.delegate.canPerformActions()) {
                ...
                if (i != this.currentPosition || (tabsViewDelegate = this.delegate) == null) {
                    scrollToTab(tabView.currentTab.f1967id, i);
                } else {
        ...
        public void addTab(int i, String str) {
            ...
            this.allTabsWidth += tab.getWidth(true, this.textPaint) + AndroidUtilities.m104dp(this.tabMarginDp * 2);
            this.tabs.add(tab);
        }
        ...
        private void updateTabsWidths() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                m104dp += width + AndroidUtilities.m104dp(this.tabMarginDp * 2) + this.additionalTabWidth;
            }
        }
        ...
        */
        ...
        public class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            public long getItemId(int i) {
                return ((Tab) TabsView.this.tabs.get(i)).f1967id;
            }
        ...
        while (true) {
            ...
            if (viewArr[i] != null && viewArr[i].getVisibility() == 0 && (findRecyclerView = findRecyclerView(this.viewPages[i])) != null) {
                for (int i2 = 0; i2 < findRecyclerView.getChildCount(); i2++) {
                    ...
                    if (childAt.getY() < AndroidUtilities.m104dp(203) + AndroidUtilities.m104dp(100)) {
