...
public class TrendingStickersLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TrendingStickersLayout(Context context, final Delegate delegate, TLRPC$StickerSetCovered[] tLRPC$StickerSetCoveredArr, LongSparseArray<TLRPC$StickerSetCovered> longSparseArray, LongSparseArray<TLRPC$StickerSetCovered> longSparseArray2, TLRPC$StickerSetCovered tLRPC$StickerSetCovered, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.searchAdapter = new StickersSearchAdapter(context, new StickersSearchAdapter.Delegate() { // from class: org.telegram.ui.Components.TrendingStickersLayout.1
            @Override // org.telegram.p043ui.Adapters.StickersSearchAdapter.Delegate
            ...
            public void setAdapterVisible(boolean z) {
                ...
                TrendingStickersLayout.this.layoutManager.scrollToPositionWithOffset(0, (-TrendingStickersLayout.this.listView.getPaddingTop()) + AndroidUtilities.m72dp(58) + TrendingStickersLayout.this.topOffset, false);
            }
        ...
        searchField.setHint(LocaleController.getString("SearchTrendingStickersHint", C3473R.string.SearchTrendingStickersHint));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.Components.TrendingStickersLayout.3
            ...
            protected boolean allowSelectChildAtPosition(float f, float f2) {
                return f2 >= ((float) (TrendingStickersLayout.this.topOffset + AndroidUtilities.m72dp(58)));
            }
        };
        ...
        FillLastGridLayoutManager fillLastGridLayoutManager = new FillLastGridLayoutManager(context, 5, AndroidUtilities.m72dp(58), recyclerListView) { // from class: org.telegram.ui.Components.TrendingStickersLayout.4
            ...
            @Override // org.telegram.p043ui.Components.FillLastGridLayoutManager
            ...
            public int scrollVerticallyBy(int i2, RecyclerView.Recycler recycler, RecyclerView.State state) {
                ...
                if (trendingStickersLayout.gluedToTop) {
                    ...
                    if (i3 == 0 && (findViewByPosition = TrendingStickersLayout.this.layoutManager.findViewByPosition(i3)) != null && findViewByPosition.getTop() - i2 > AndroidUtilities.m72dp(58)) {
                        i2 = findViewByPosition.getTop() - AndroidUtilities.m72dp(58);
                    }
                }
                return super.scrollVerticallyBy(i2, recycler, state);
            }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.layoutManager.scrollToPositionWithOffset(num.intValue(), (-this.listView.getPaddingTop()) + AndroidUtilities.m72dp(58));
    }
    ...
    private void showStickerSet(final TLRPC$InputStickerSet tLRPC$InputStickerSet) {
        ...
        stickersAlert.setInstallDelegate(new StickersAlert.StickersAlertInstallDelegate() { // from class: org.telegram.ui.Components.TrendingStickersLayout.8
            @Override // org.telegram.p043ui.Components.StickersAlert.StickersAlertInstallDelegate
            ...
            public void onStickerSetInstalled() {
                ...
                for (int i = 0; i < TrendingStickersLayout.this.adapter.sets.size(); i++) {
                    ...
                    if (tLRPC$StickerSetCovered.set.f1556id == tLRPC$InputStickerSet.f1545id) {
    ...
    public void setContentViewPaddingTop(int i) {
        int m72dp = i + AndroidUtilities.m72dp(58);
        if (this.listView.getPaddingTop() != m72dp) {
            this.ignoreLayout = true;
            this.listView.setPadding(0, m72dp, 0, 0);
    ...
    public boolean update() {
        ...
        int top = childAt.getTop() - AndroidUtilities.m72dp(58);
        int i2 = (top <= 0 || holder == null || holder.getAdapterPosition() != 0) ? 0 : top;
        setShadowVisible(top < 0);
        if (this.topOffset != i2) {
            this.topOffset = i2;
            this.listView.setTopGlowOffset(i2 + AndroidUtilities.m72dp(58));
            this.searchLayout.setTranslationY(this.topOffset);
            this.shadowView.setTranslationY(this.topOffset);
            return true;
        }
        ...
        if (z) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.TrendingStickersLayout.9
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    TrendingStickersLayout.this.listView.scrollBy(0, floatValue - this.f1872dy);
                    TrendingStickersLayout.this.scrollFromAnimator = false;
                    this.f1872dy = floatValue;
                }
            });
    ...
    public class TrendingStickersAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0(View view) {
            ...
            if (TrendingStickersLayout.this.installingStickerSets.indexOfKey(stickerSet.set.f1556id) >= 0 || TrendingStickersLayout.this.removingStickerSets.indexOfKey(stickerSet.set.f1556id) >= 0) {
                return;
            }
            if (featuredStickerSetInfoCell.isInstalled()) {
                TrendingStickersLayout.this.removingStickerSets.put(stickerSet.set.f1556id, stickerSet);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (itemViewType != 2) {
                    if (itemViewType == 4) {
                        ((GraySectionCell) viewHolder.itemView).setText(LocaleController.getString("OtherStickers", C3473R.string.OtherStickers));
                        return;
        ...
        */
        private void bindStickerSetCell(android.view.View r12, int r13, boolean r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.TrendingStickersLayout.TrendingStickersAdapter.bindStickerSetCell(android.view.View, int, boolean):void");
        }
        ...
        public void installStickerSet(TLRPC$StickerSetCovered tLRPC$StickerSetCovered, View view) {
            ...
            while (true) {
                ...
                if (TrendingStickersLayout.this.primaryInstallingStickerSets[i] != null) {
                    TLRPC$TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(TrendingStickersLayout.this.currentAccount).getStickerSetById(TrendingStickersLayout.this.primaryInstallingStickerSets[i].set.f1556id);
                    if (stickerSetById == null || stickerSetById.set.archived) {
                        if (TrendingStickersLayout.this.primaryInstallingStickerSets[i].set.f1556id == tLRPC$StickerSetCovered.set.f1556id) {
                            return;
                        }
                    } else {
            ...
            TrendingStickersLayout.this.installingStickerSets.put(tLRPC$StickerSetCovered.set.f1556id, tLRPC$StickerSetCovered);
            if (view != null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (tLRPC$StickerSetCovered2 != null && tLRPC$StickerSetCovered2.set.f1556id == tLRPC$StickerSetCovered.set.f1556id) {
        ...
        public void refreshStickerSets() {
            ...
            if (measuredWidth != 0) {
                this.stickersPerRow = Math.max(5, measuredWidth / AndroidUtilities.m72dp(72));
