...
public class ChatAvatarContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatAvatarContainer(Context context, BaseFragment baseFragment, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.avatarImageView = new C48341(context, baseFragment, z3, resourcesProvider);
        ...
        this.avatarImageView.setContentDescription(LocaleController.getString("AccDescrProfilePicture", C3634R.string.AccDescrProfilePicture));
        this.avatarImageView.setRoundRadius(AndroidUtilities.m104dp(21));
        ...
        this.titleTextView.setLeftDrawableTopPadding(-AndroidUtilities.m105dp(1.3f));
        ...
        if (this.parentFragment != null) {
            ...
            imageView.setPadding(AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(5), AndroidUtilities.m104dp(5));
            ...
            if (this.secretChatTimer) {
                this.timeItem.setContentDescription(LocaleController.getString("SetTimer", C3634R.string.SetTimer));
            } else {
                this.timeItem.setContentDescription(LocaleController.getString("AccAutoDeleteTimer", C3634R.string.AccAutoDeleteTimer));
            }
        }
        ...
        this.emojiStatusDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.titleTextView, AndroidUtilities.m104dp(24));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Components.ChatAvatarContainer$1 */
    /* loaded from: classes6.dex */
    public class C48341 extends BackupImageView {
        ...
        C48341(Context context, BaseFragment baseFragment, boolean z, Theme.ResourcesProvider resourcesProvider) {
            super(context);
            this.val$baseFragment = baseFragment;
            this.val$avatarClickable = z;
            this.val$resourcesProvider = resourcesProvider;
            this.params = new C48351(true);
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: org.telegram.ui.Components.ChatAvatarContainer$1$1 */
        /* loaded from: classes6.dex */
        public class C48351 extends StoriesUtilities.AvatarStoryParams {
            C48351(boolean z) {
                super(z);
            }
            ...
            public void openStory(long j, Runnable runnable) {
                C48341.this.val$baseFragment.getOrCreateStoryViewer().open(C48341.this.getContext(), j, new StoryViewer.PlaceProvider() { // from class: org.telegram.ui.Components.ChatAvatarContainer$1$1$$ExternalSyntheticLambda0
                    ...
                    public final boolean findView(long j2, int i, int i2, int i3, StoryViewer.TransitionViewHolder transitionViewHolder) {
                        ...
                        lambda$openStory$0 = ChatAvatarContainer.C48341.C48351.this.lambda$openStory$0(j2, i, i2, i3, transitionViewHolder);
            ...
            public /* synthetic */ boolean lambda$openStory$0(long j, int i, int i2, int i3, StoryViewer.TransitionViewHolder transitionViewHolder) {
                C48341 c48341 = C48341.this;
                ImageReceiver imageReceiver = c48341.imageReceiver;
                transitionViewHolder.storyImage = imageReceiver;
                transitionViewHolder.crossfadeToAvatarImage = imageReceiver;
                transitionViewHolder.params = c48341.params;
                ...
                transitionViewHolder.clipParent = (View) C48341.this.getParent();
                return true;
            }
        }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (this.val$avatarClickable && getImageReceiver().hasNotThumb()) {
                accessibilityNodeInfo.setText(LocaleController.getString("AccDescrProfilePicture", C3634R.string.AccDescrProfilePicture));
                if (Build.VERSION.SDK_INT >= 21) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("Open", C3634R.string.Open)));
                    return;
                }
                return;
            }
    ...
    public void setTitleExpand(boolean z) {
        int m104dp = z ? AndroidUtilities.m104dp(10) : 0;
        if (this.titleTextView.getPaddingRight() != m104dp) {
            this.titleTextView.setPadding(0, AndroidUtilities.m104dp(6), m104dp, AndroidUtilities.m104dp(12));
            requestLayout();
            invalidate();
        }
    }
    ...
    public boolean openSetTimer() {
        ...
        actionBarPopupWindowArr[0].setAnimationStyle(C3634R.style.PopupContextAnimation);
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int m104dp = size - AndroidUtilities.m104dp((this.avatarImageView.getVisibility() == 0 ? 54 : 0) + 16);
        this.avatarImageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(42), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(42), 1073741824));
        ...
        if (imageView != null) {
            imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(34), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(34), 1073741824));
        }
        ...
        if (simpleTextView != null) {
            simpleTextView.measure(View.MeasureSpec.makeMeasureSpec(this.largerWidth - AndroidUtilities.m104dp((this.avatarImageView.getVisibility() != 0 ? 0 : 54) + 16), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(24), Integer.MIN_VALUE));
        }
        this.lastWidth = size;
    }
    ...
    private void fadeOutToLessWidth(int i) {
        ...
        simpleTextView.setLeftDrawableTopPadding(-AndroidUtilities.m105dp(1.3f));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        backupImageView.layout(i5, i6, AndroidUtilities.m104dp(42) + i5, AndroidUtilities.m104dp(42) + i6);
        int m104dp = this.leftPadding + (this.avatarImageView.getVisibility() == 0 ? AndroidUtilities.m104dp(54) : 0);
        SimpleTextView simpleTextView = this.titleTextLargerCopyView.get();
        if (this.subtitleTextView.getVisibility() != 8) {
            this.titleTextView.layout(m104dp, (AndroidUtilities.m105dp(1.3f) + currentActionBarHeight) - this.titleTextView.getPaddingTop(), this.titleTextView.getMeasuredWidth() + m104dp, (((this.titleTextView.getTextHeight() + currentActionBarHeight) + AndroidUtilities.m105dp(1.3f)) - this.titleTextView.getPaddingTop()) + this.titleTextView.getPaddingBottom());
            if (simpleTextView != null) {
                simpleTextView.layout(m104dp, AndroidUtilities.m105dp(1.3f) + currentActionBarHeight, simpleTextView.getMeasuredWidth() + m104dp, simpleTextView.getTextHeight() + currentActionBarHeight + AndroidUtilities.m105dp(1.3f));
            }
        } else {
            this.titleTextView.layout(m104dp, (AndroidUtilities.m104dp(11) + currentActionBarHeight) - this.titleTextView.getPaddingTop(), this.titleTextView.getMeasuredWidth() + m104dp, (((this.titleTextView.getTextHeight() + currentActionBarHeight) + AndroidUtilities.m104dp(11)) - this.titleTextView.getPaddingTop()) + this.titleTextView.getPaddingBottom());
            if (simpleTextView != null) {
                simpleTextView.layout(m104dp, AndroidUtilities.m104dp(11) + currentActionBarHeight, simpleTextView.getMeasuredWidth() + m104dp, simpleTextView.getTextHeight() + currentActionBarHeight + AndroidUtilities.m104dp(11));
            }
        }
        ImageView imageView = this.timeItem;
        if (imageView != null) {
            imageView.layout(this.leftPadding + AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(15) + currentActionBarHeight, this.leftPadding + AndroidUtilities.m104dp(50), AndroidUtilities.m104dp(49) + currentActionBarHeight);
        }
        this.subtitleTextView.layout(m104dp, AndroidUtilities.m104dp(24) + currentActionBarHeight, this.subtitleTextView.getMeasuredWidth() + m104dp, this.subtitleTextView.getTextHeight() + currentActionBarHeight + AndroidUtilities.m104dp(24));
        SimpleTextView simpleTextView2 = this.subtitleTextLargerCopyView.get();
        if (simpleTextView2 != null) {
            simpleTextView2.layout(m104dp, AndroidUtilities.m104dp(24) + currentActionBarHeight, simpleTextView2.getMeasuredWidth() + m104dp, currentActionBarHeight + simpleTextView2.getTextHeight() + AndroidUtilities.m104dp(24));
        }
    }
    ...
    public void setTitleIcons(Drawable drawable, Drawable drawable2) {
        ...
        if (drawable2 != null) {
            this.rightDrawableContentDescription = LocaleController.getString("NotificationsMuted", C3634R.string.NotificationsMuted);
        } else {
            this.rightDrawableContentDescription = null;
        }
    ...
    public void setTitle(CharSequence charSequence, boolean z, boolean z2, boolean z3, boolean z4, TLRPC$EmojiStatus tLRPC$EmojiStatus, boolean z5) {
        if (charSequence != null) {
            charSequence = Emoji.replaceEmoji(charSequence, this.titleTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(24), false);
        }
        ...
        if (z || z2) {
            ...
            this.rightDrawableContentDescription = LocaleController.getString("ScamMessage", C3634R.string.ScamMessage);
            this.rightDrawableIsScamOrVerified = true;
        } else if (z3) {
            Drawable mutate = getResources().getDrawable(C3634R.C3636drawable.verified_area).mutate();
            ...
            Drawable mutate2 = getResources().getDrawable(C3634R.C3636drawable.verified_check).mutate();
            ...
            this.rightDrawableIsScamOrVerified = true;
            this.rightDrawableContentDescription = LocaleController.getString("AccDescrVerified", C3634R.string.AccDescrVerified);
        } else if (z6) {
            ...
            if (isShowPremiumStatusEnabled && z7) {
                ...
                if (drawable == null) {
                    drawable = ContextCompat.getDrawable(ApplicationLoader.applicationContext, C3634R.C3636drawable.msg_premium_liststar).mutate();
                }
            ...
            this.rightDrawableIsScamOrVerified = true;
            this.rightDrawableContentDescription = LocaleController.getString("AccDescrPremium", C3634R.string.AccDescrPremium);
                ...
                if (printingString == null || printingString.length() == 0 || (ChatObject.isChannel(currentChat) && !currentChat.megagroup)) {
                    if (this.parentFragment.isThreadChat() && !this.parentFragment.isTopic) {
                        ...
                        if (z) {
                            ...
                            animatorSet2.playTogether(ObjectAnimator.ofFloat(this.titleTextView, View.TRANSLATION_Y, AndroidUtilities.m105dp(9.7f)), ObjectAnimator.ofFloat(this.subtitleTextView, View.ALPHA, BitmapDescriptorFactory.HUE_RED));
                        ...
                        this.titleTextView.setTranslationY(AndroidUtilities.m105dp(9.7f));
                    ...
                    if (chatActivity2.isTopic && currentChat != null) {
                        ...
                        string = i > 0 ? LocaleController.formatPluralString("messages", i, Integer.valueOf(i)) : LocaleController.formatString("TopicProfileStatus", C3634R.string.TopicProfileStatus, currentChat.title);
                    } else if (currentChat != null) {
                        TLRPC$ChatFull currentChatInfo = chatActivity2.getCurrentChatInfo();
                        if (!this.parentFragment.isTemplatesChannel(true, false)) {
                            if (this.parentFragment.isInAlbumMode()) {
                                string = LocaleController.getInternalString(C3634R.string.cloud_album).toLowerCase();
                            } else {
                        ...
                        if (currentUser != null) {
                            TLRPC$User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(currentUser.f1749id));
                            if (user != null) {
                                currentUser = user;
                            }
                            if (!UserObject.isReplyUser(currentUser)) {
                                if (currentUser.f1749id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                                    string = LocaleController.getString("ChatYourSelf", C3634R.string.ChatYourSelf);
                                } else {
                                    long j = currentUser.f1749id;
                                    if (j == 333000 || j == 777000 || j == 42777) {
                                        string = LocaleController.getString("ServiceNotifications", C3634R.string.ServiceNotifications);
                                    } else if (MessagesController.isSupportUser(currentUser)) {
                                        string = LocaleController.getString("SupportStatus", C3634R.string.SupportStatus);
                                    } else if (currentUser.bot) {
                                        string = LocaleController.getString("Bot", C3634R.string.Bot);
                                    } else {
                    ...
                    str = MessagesController.getInstance(this.currentAccount).getPrintingStringType(this.parentFragment.getDialogId(), this.parentFragment.getThreadId()).intValue() == 5 ? Emoji.replaceEmoji(printingString, this.subtitleTextView.getTextPaint().getFontMetricsInt(), AndroidUtilities.m104dp(15), false) : printingString;
    ...
    public static CharSequence getChatSubtitle(TLRPC$Chat tLRPC$Chat, TLRPC$ChatFull tLRPC$ChatFull, int i) {
        ...
        if (!ChatObject.isChannel(tLRPC$Chat)) {
            if (ChatObject.isKickedFromChat(tLRPC$Chat)) {
                return LocaleController.getString("YouWereKicked", C3634R.string.YouWereKicked);
            }
            if (ChatObject.isLeftFromChat(tLRPC$Chat)) {
                return LocaleController.getString("YouLeft", C3634R.string.YouLeft);
            }
            ...
            if (ChatObject.isPublic(tLRPC$Chat)) {
                return LocaleController.getString("ChannelPublic", C3634R.string.ChannelPublic).toLowerCase();
            }
            return LocaleController.getString("ChannelPrivate", C3634R.string.ChannelPrivate).toLowerCase();
        } else if (tLRPC$ChatFull == null) {
            return LocaleController.getString("Loading", C3634R.string.Loading).toLowerCase();
        } else {
            if (tLRPC$Chat.has_geo) {
                return LocaleController.getString("MegaLocation", C3634R.string.MegaLocation).toLowerCase();
            }
            if (ChatObject.isPublic(tLRPC$Chat)) {
                return LocaleController.getString("MegaPublic", C3634R.string.MegaPublic).toLowerCase();
            }
            return LocaleController.getString("MegaPrivate", C3634R.string.MegaPrivate).toLowerCase();
        }
    }
    ...
    public void setChatAvatar(TLRPC$Chat tLRPC$Chat) {
        ...
        if (this.avatarImageView != null) {
            ...
            this.avatarImageView.setRoundRadius(AndroidUtilities.m104dp((tLRPC$Chat == null || !tLRPC$Chat.forum) ? 21 : 16));
        }
    }
    ...
    public void checkAndUpdateAvatar() {
        ...
        if (currentUser == null) {
            if (currentChat != null) {
                ...
                this.avatarImageView.setRoundRadius(AndroidUtilities.m104dp(currentChat.forum ? 16 : 21));
                return;
            }
            return;
        }
    ...
    public void updateOnlineCount() {
        ...
        if ((currentChatInfo instanceof TLRPC$TL_chatFull) || (((z = currentChatInfo instanceof TLRPC$TL_channelFull)) && currentChatInfo.participants_count <= 200 && currentChatInfo.participants != null)) {
            for (int i = 0; i < currentChatInfo.participants.participants.size(); i++) {
                ...
                if (user != null && (tLRPC$UserStatus = user.status) != null && ((tLRPC$UserStatus.expires > currentTime || user.f1749id == UserConfig.getInstance(this.currentAccount).getClientUserId()) && user.status.expires > 10000)) {
                    this.onlineCount++;
                }
            }
    ...
    private void updateCurrentConnectionState() {
        ...
        if (i == 2) {
            ...
            string = LocaleController.getString("Connecting", C3634R.string.Connecting);
        } else if (i == 5) {
            string = LocaleController.getString("Updating", C3634R.string.Updating);
        } else {
            string = i == 4 ? LocaleController.getString("ConnectingToProxy", C3634R.string.ConnectingToProxy) : null;
        }
        if (string == null) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("OpenProfile", C3634R.string.OpenProfile)));
    }
