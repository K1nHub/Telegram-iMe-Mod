...
public class LetterDrawable extends Drawable {
    ...
    public LetterDrawable(Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        if (i == 0) {
            ...
            namePaint.setTextSize(AndroidUtilities.m72dp(28));
            ...
            namePaintTopic.setTextSize(AndroidUtilities.m72dp(13));
    ...
    public void setTitle(String str) {
        ...
        if (this.stringBuilder.length() > 0) {
            try {
                StaticLayout staticLayout = new StaticLayout(this.stringBuilder.toString().toUpperCase(), this.textPaint, AndroidUtilities.m72dp(100), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.style == 0) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m72dp(4), AndroidUtilities.m72dp(4), paint);
        }
        canvas.save();
        float f = this.scale;
        if (f != 1.0f) {
