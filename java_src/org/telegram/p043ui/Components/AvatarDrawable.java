...
public class AvatarDrawable extends Drawable {
    ...
    public AvatarDrawable(Theme.ResourcesProvider resourcesProvider) {
        ...
        this.namePaint.setTextSize(AndroidUtilities.m104dp(18));
    }
    ...
    public AvatarDrawable(TLRPC$User tLRPC$User, boolean z) {
        this();
        if (tLRPC$User != null) {
            setInfo(tLRPC$User.f1749id, tLRPC$User.first_name, tLRPC$User.last_name, null);
    ...
    public void setInfo(TLRPC$User tLRPC$User) {
        if (tLRPC$User != null) {
            setInfo(tLRPC$User.f1749id, tLRPC$User.first_name, tLRPC$User.last_name, null, (tLRPC$User.flags2 & 128) != 0 ? Integer.valueOf(tLRPC$User.color) : null);
            this.drawDeleted = UserObject.isDeleted(tLRPC$User);
        }
    }
    ...
    public void setInfo(TLRPC$Chat tLRPC$Chat) {
        if (tLRPC$Chat != null) {
            setInfo(tLRPC$Chat.f1602id, tLRPC$Chat.title, null, null, (tLRPC$Chat.flags2 & 64) != 0 ? Integer.valueOf(tLRPC$Chat.color) : null);
        }
    }
        ...
        if (i2 == 2) {
            ...
            if (this.drawDeleted) {
                ...
                if (drawableArr[1] != null) {
                    ...
                    if (intrinsicWidth3 > width - AndroidUtilities.m104dp(6) || intrinsicHeight3 > width - AndroidUtilities.m104dp(6)) {
                        float m104dp = width / AndroidUtilities.m104dp(50);
                        intrinsicWidth3 = (int) (intrinsicWidth3 * m104dp);
                        intrinsicHeight3 = (int) (intrinsicHeight3 * m104dp);
                    }
            ...
            if (this.invalidateTextLayout) {
                ...
                if (this.stringBuilder.length() > 0) {
                    CharSequence replaceEmoji = Emoji.replaceEmoji((CharSequence) this.stringBuilder.toString().toUpperCase(), this.namePaint.getFontMetricsInt(), AndroidUtilities.m104dp(16), true);
                    StaticLayout staticLayout = this.textLayout;
                    if (staticLayout == null || !TextUtils.equals(replaceEmoji, staticLayout.getText())) {
                        try {
                            StaticLayout staticLayout2 = new StaticLayout(replaceEmoji, this.namePaint, AndroidUtilities.m104dp(100), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            ...
            if (this.textLayout != null) {
                float f4 = width;
                float m104dp2 = f4 / AndroidUtilities.m104dp(50);
                float f5 = f4 / 2.0f;
                canvas.scale(m104dp2, m104dp2, f5, f5);
