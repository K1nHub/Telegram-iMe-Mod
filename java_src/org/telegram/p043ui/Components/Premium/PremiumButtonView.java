...
public class PremiumButtonView extends FrameLayout {
    ...
    public PremiumButtonView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        this(context, AndroidUtilities.m104dp(8), z, resourcesProvider);
    }
    ...
    public PremiumButtonView(Context context, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        AnimatedTextView animatedTextView = new AnimatedTextView(context) { // from class: org.telegram.ui.Components.Premium.PremiumButtonView.1
            ...
            public void onDraw(Canvas canvas) {
                if (PremiumButtonView.this.loadingT > BitmapDescriptorFactory.HUE_RED) {
                    ...
                    int m104dp = (int) ((1.0f - PremiumButtonView.this.loadingT) * AndroidUtilities.m104dp(24));
                    PremiumButtonView.this.loadingDrawable.setBounds(0, m104dp, getWidth(), getHeight() + m104dp);
                ...
                if (PremiumButtonView.this.loadingT < 1.0f) {
                    if (PremiumButtonView.this.loadingT != BitmapDescriptorFactory.HUE_RED) {
                        canvas.save();
                        canvas.translate(BitmapDescriptorFactory.HUE_RED, (int) (PremiumButtonView.this.loadingT * AndroidUtilities.m104dp(-24)));
        ...
        this.buttonTextView.setTextSize(AndroidUtilities.m104dp(14));
        ...
        if (z) {
            ...
            animatedTextView2.setPadding(AndroidUtilities.m104dp(34), 0, AndroidUtilities.m104dp(34), 0);
            ...
            this.overlayTextView.setTextSize(AndroidUtilities.m104dp(14));
            ...
            this.overlayTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(8), 0, ColorUtils.setAlphaComponent(-1, 120)));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (counterView != null) {
            this.counterOffset.set(((counterView.counterDrawable.getWidth() * 0.85f) + AndroidUtilities.m104dp(3)) / 2.0f);
            this.counterOffset2.set((getMeasuredWidth() / 2.0f) + (this.overlayTextView.getDrawable().getWidth() / 2.0f) + AndroidUtilities.m104dp(3));
    ...
    public void updateOverlayProgress() {
        ...
        this.overlayTextView.setTranslationY(AndroidUtilities.m104dp(12) * (1.0f - this.overlayProgress));
        this.buttonLayout.setAlpha(1.0f - this.overlayProgress);
        this.buttonLayout.setTranslationY((-AndroidUtilities.m104dp(12)) * this.overlayProgress);
