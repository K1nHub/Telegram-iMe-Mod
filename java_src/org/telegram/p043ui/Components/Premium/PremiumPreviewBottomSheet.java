...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC$User tLRPC$User, GiftPremiumBottomSheet.GiftTier giftTier, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumGradientTools.f1824y1 = 1.0f;
        premiumGradientTools.f1823x2 = BitmapDescriptorFactory.HUE_RED;
        premiumGradientTools.f1825y2 = BitmapDescriptorFactory.HUE_RED;
    ...
    public void setTitle(boolean z) {
        ...
        if (this.statusStickerSet != null) {
            int i = C3473R.string.TelegramPremiumUserStatusDialogTitle;
                    ...
                    if (stickerSet.set != null) {
                        ...
                        while (true) {
                            if (i2 >= stickerSet.documents.size()) {
                                break;
                            } else if (stickerSet.documents.get(i2).f1530id == stickerSet.set.thumb_document_id) {
            ...
            this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3473R.string.TelegramPremiumUserStatusDialogSubtitle)));
        } else if (this.isEmojiStatus) {
            LinkSpanDrawable.LinksTextView linksTextView = linksTextViewArr[0];
            int i3 = C3473R.string.TelegramPremiumUserStatusDefaultDialogTitle;
            ...
            int i4 = C3473R.string.TelegramPremiumUserStatusDialogSubtitle;
            ...
            if (giftTier != null) {
                if (this.isOutboundGift) {
                    ...
                    int i5 = C3473R.string.TelegramPremiumUserGiftedPremiumOutboundDialogTitleWithPlural;
                    ...
                    int i7 = C3473R.string.TelegramPremiumUserGiftedPremiumOutboundDialogSubtitle;
                ...
                if (tLRPC$User6 != null && !TextUtils.isEmpty(tLRPC$User6.first_name)) {
                    ...
                    if (tLRPC$User7.f1685id != 777000) {
                        this.titleView[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3473R.string.TelegramPremiumUserGiftedPremiumDialogTitleWithPlural, tLRPC$User7.first_name, LocaleController.formatPluralString("GiftMonths", this.giftTier.getMonths(), new Object[0])), Theme.key_windowBackgroundWhiteBlueButton, 0, null));
                        this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3473R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle)));
                        return;
                    }
                }
                this.titleView[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3473R.string.TelegramPremiumUserGiftedPremiumDialogTitleWithPluralSomeone, LocaleController.formatPluralString("GiftMonths", this.giftTier.getMonths(), new Object[0])), Theme.key_windowBackgroundWhiteBlueButton, 0, null));
                this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3473R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle)));
                return;
            }
            LinkSpanDrawable.LinksTextView linksTextView3 = linksTextViewArr[0];
            int i8 = C3473R.string.TelegramPremiumUserDialogTitle;
            ...
            this.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3473R.string.TelegramPremiumUserDialogSubtitle)));
        }
    }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString("TelegramPremium", C3473R.string.TelegramPremium);
    }
    ...
    public boolean onCustomOpenAnimation() {
        ...
        this.enterAnimator.addListener(new C51924());
    ...
    /* loaded from: classes7.dex */
    public class C51924 extends AnimatorListenerAdapter {
        C51924() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$4$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    PremiumPreviewBottomSheet.C51924.this.lambda$onAnimationEnd$0(rightDrawable, valueAnimator);
                }
            });
            ofInt.start();
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.groupStickersDidLoad && (tLRPC$InputStickerSet = this.statusStickerSet) != null && tLRPC$InputStickerSet.f1545id == ((Long) objArr[0]).longValue()) {
            setTitle(true);
        }
    }
}
