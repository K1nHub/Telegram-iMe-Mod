...
public class MatrixParticlesDrawable {
        ...
        while (i8 <= width) {
            ...
            while (i9 < arrayList.size()) {
                ...
                if (currentTimeMillis - particle3.time > 50) {
                    int i11 = particle3.f1905y + 1;
                    particle3.f1905y = i11;
                    ...
                    if (particle3.f1905y > particle3.len && i9 == arrayList.size() - 1 && Math.abs(Utilities.fastRandom.nextInt(4)) == 0) {
                ...
                int i12 = i9;
                int min = Math.min(particle3.f1905y, height + 1);
                int max = Math.max(i4, particle3.f1905y - particle3.len);
                while (max < min) {
                    int i13 = this.size;
                    float f = i13 * i8;
                    float f2 = i13 * max;
                    if (this.excludeRect.contains(f, f2)) {
                        ...
                        i3 = min;
                        particle = particle3;
                        this.matrixTextParticles[i8][max].draw(canvas, f, f2, currentTimeMillis, Utilities.clamp(((1.0f - ((particle3.f1905y - max) / (particle3.len - i10))) * 0.8f) + 0.2f, 1.0f, (float) BitmapDescriptorFactory.HUE_RED));
                    }
                    max = i + 1;
                    min = i3;
                    i10 = i2;
    ...
    private class Particle {
        ...
        public void init(int i, long j) {
            this.f1905y = Math.abs(Utilities.fastRandom.nextInt() % i);
            this.time = j;
