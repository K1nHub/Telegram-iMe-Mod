...
public class PremiumLockIconView extends ImageView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.type == TYPE_REACTIONS) {
            ...
            rectF.set((getMeasuredWidth() / 2.0f) + AndroidUtilities.m105dp(2.5f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dpf2(5.7f), getMeasuredWidth() - AndroidUtilities.dpf2(0.2f), getMeasuredHeight());
            this.path.addRoundRect(rectF, AndroidUtilities.m105dp(2.0f), AndroidUtilities.m105dp(2.0f), Path.Direction.CW);
            this.path.close();
            ...
            this.starParticles.rect.inset(AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6));
            return;
        }
        updateGradient();
    }
        ...
        if (paint != null) {
            if (this.type == TYPE_REACTIONS) {
                if (this.currentColor != 0) {
                    ...
                    PremiumGradient.getInstance().updateMainGradientMatrix(0, 0, getMeasuredWidth(), getMeasuredHeight(), -AndroidUtilities.m104dp(24), BitmapDescriptorFactory.HUE_RED);
