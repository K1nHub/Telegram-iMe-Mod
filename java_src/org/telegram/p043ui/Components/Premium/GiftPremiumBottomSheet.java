...
public class GiftPremiumBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public GiftPremiumBottomSheet(BaseFragment baseFragment, TLRPC$User tLRPC$User) {
        ...
        this.outlineGradient.paint.setStrokeWidth(AndroidUtilities.m105dp(1.5f));
    ...
    public /* synthetic */ void lambda$new$1(Path path, Canvas canvas) {
        ...
        rectF.set(selectorRect.left + AndroidUtilities.m104dp(20), selectorRect.top + AndroidUtilities.m104dp(3), selectorRect.right - AndroidUtilities.m104dp(20), selectorRect.bottom - AndroidUtilities.m104dp(3));
        path.addRoundRect(rectF, AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(12), Path.Direction.CW);
    ...
    private void initData() {
        ...
        this.rowsCount = 0;
        TLRPC$UserFull userFull = MessagesController.getInstance(this.currentAccount).getUserFull(this.user.f1749id);
        if (userFull != null) {
    ...
    private void onGiftSuccess(boolean z) {
        ...
        if (userFull != null) {
            ...
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.userInfoDidLoad, Long.valueOf(this.user.f1749id), userFull);
        }
        if (getBaseFragment() != null) {
            ...
            for (BaseFragment baseFragment : arrayList) {
                if (baseFragment instanceof ChatActivity) {
                    ...
                    if (chatActivity.getDialogId() != this.user.f1749id) {
            ...
            if (chatActivity == null || chatActivity.getDialogId() != this.user.f1749id) {
    ...
    public class C53531 extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                final PremiumGiftTierCell premiumGiftTierCell2 = new PremiumGiftTierCell(GiftPremiumBottomSheet.this.getContext()) { // from class: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet.1.1
                    ...
                    public void dispatchDraw(Canvas canvas) {
                        if (this.discountView.getVisibility() == 0) {
                            ...
                            canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), GiftPremiumBottomSheet.this.gradientTools.paint);
                        }
                        ...
                        rectF2.set(AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(3), getWidth() - AndroidUtilities.m104dp(20), getHeight() - AndroidUtilities.m104dp(3));
                        ...
                        canvas.drawRoundRect(rectF2, AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(12), GiftPremiumBottomSheet.this.outlineGradient.paint);
                ...
                textInfoPrivacyCell.setPadding(AndroidUtilities.m104dp(21), 0, AndroidUtilities.m104dp(21), 0);
                ...
                if (i != 3) {
                    ...
                    view = new View(this, GiftPremiumBottomSheet.this.getContext()) { // from class: org.telegram.ui.Components.Premium.GiftPremiumBottomSheet.1.2
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(68), 1073741824));
                        }
                    };
                }
