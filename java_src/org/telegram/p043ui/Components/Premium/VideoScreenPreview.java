...
public class VideoScreenPreview extends FrameLayout implements PagerHeaderView, NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoScreenPreview(Context context, SvgHelper.SvgDrawable svgDrawable, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i2 == 1) {
            ...
            drawable3.size1 = 6;
            drawable3.size1 = 4;
            drawable3.f1921k3 = 0.98f;
            drawable3.f1920k2 = 0.98f;
            drawable3.f1919k1 = 0.98f;
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(context) { // from class: org.telegram.ui.Components.Premium.VideoScreenPreview.1
            ...
            public void onMeasure(int i4, int i5) {
                ...
                float m104dp = VideoScreenPreview.this.roundRadius - AndroidUtilities.m104dp(3);
                this.clipPath.addRoundRect(AndroidUtilities.rectTmp, m104dp, m104dp, Path.Direction.CW);
            }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.size != measuredWidth) {
            ...
            if (matrixParticlesDrawable != null) {
                ...
                this.matrixParticlesDrawable.excludeRect.inset(AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(16));
            }
            ...
            if (drawable != null) {
                ...
                if (i5 == 6 || i5 == 9 || i5 == 3 || i5 == 7 || i5 == 11 || i5 == 4) {
                    ...
                    this.starDrawable.rect.inset(AndroidUtilities.m104dp(30), AndroidUtilities.m104dp(30));
                } else {
                    RectF rectF = AndroidUtilities.rectTmp;
                ...
                this.starDrawable.excludeRect.inset(AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10));
            }
            ...
            if (speedLineParticles$Drawable != null) {
                ...
                this.speedLinesDrawable.rect.inset(AndroidUtilities.m104dp(100), AndroidUtilities.m104dp(100));
            ...
            if (drawable2 != null) {
                ...
                this.helloParticlesDrawable.rect.inset(AndroidUtilities.m104dp(0), getMeasuredHeight() * 0.1f);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.inset(-AndroidUtilities.m104dp(3), -AndroidUtilities.m104dp(3));
        rectF.inset(-AndroidUtilities.m104dp(3), -AndroidUtilities.m104dp(3));
        canvas.drawRoundRect(rectF, this.roundRadius + AndroidUtilities.m104dp(3), this.roundRadius + AndroidUtilities.m104dp(3), this.phoneFrame2);
        rectF.inset(AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(3));
        ...
        float m104dp = this.roundRadius - AndroidUtilities.m104dp(3);
        this.roundRadius = m104dp;
        RoundedBitmapDrawable roundedBitmapDrawable = this.roundedBitmapDrawable;
        if (roundedBitmapDrawable != null) {
            roundedBitmapDrawable.setCornerRadius(m104dp);
        }
        ...
        canvas.drawCircle(this.imageReceiver.getCenterX(), this.imageReceiver.getImageY() + AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(6), this.phoneFrame1);
    }
