...
public class PremiumGradient {
    ...
    public static class PremiumGradientTools {
        ...
        /* renamed from: cx */
        public float f1913cx;

        /* renamed from: cy */
        public float f1914cy;
        ...
        /* renamed from: x1 */
        public float f1915x1;

        /* renamed from: x2 */
        public float f1916x2;

        /* renamed from: y1 */
        public float f1917y1;

        /* renamed from: y2 */
        public float f1918y2;
        ...
        public PremiumGradientTools(int i, int i2, int i3, int i4, int i5, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.f1915x1 = BitmapDescriptorFactory.HUE_RED;
            this.f1917y1 = 1.0f;
            this.f1916x2 = 1.5f;
            this.f1918y2 = BitmapDescriptorFactory.HUE_RED;
        ...
        public void gradientMatrix(RectF rectF) {
            gradientMatrix((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED);
        }
        ...
        public void gradientMatrix(int i, int i2, int i3, int i4, float f, float f2) {
            ...
            if (this.exactly) {
                this.matrix.reset();
                this.matrix.postScale((i3 - i) / 100.0f, (i4 - i2) / 100.0f, this.f1913cx * 100.0f, this.f1914cy * 100.0f);
        ...
        public void chekColors() {
            ...
            iArr[4] = color5;
            if (color3 == 0) {
                float f = this.f1915x1 * 100.0f;
                float f2 = this.f1917y1 * 100.0f;
                float f3 = this.f1916x2 * 100.0f;
                float f4 = this.f1918y2 * 100.0f;
                ...
                float f5 = this.f1915x1 * 100.0f;
                float f6 = this.f1917y1 * 100.0f;
                float f7 = this.f1916x2 * 100.0f;
                float f8 = this.f1918y2 * 100.0f;
                ...
                float f9 = this.f1915x1 * 100.0f;
                float f10 = this.f1917y1 * 100.0f;
                float f11 = this.f1916x2 * 100.0f;
                float f12 = this.f1918y2 * 100.0f;
                ...
                float f13 = this.f1915x1 * 100.0f;
                float f14 = this.f1917y1 * 100.0f;
                float f15 = this.f1916x2 * 100.0f;
                float f16 = this.f1918y2 * 100.0f;
