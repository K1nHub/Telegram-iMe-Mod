...
public class DoubledLimitsBottomSheet$Adapter extends RecyclerListView.SelectionAdapter {
    ...
    public DoubledLimitsBottomSheet$Adapter(int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C3632R.string.SimilarChannelsLimitTitle), LocaleController.formatString(C3632R.string.SimilarChannelsLimitSubtitle, Integer.valueOf(messagesController.recommendedChannelsLimitPremium)), messagesController.recommendedChannelsLimitDefault, messagesController.recommendedChannelsLimitPremium, null));
        this.rowCount = 0;
        int i2 = 1 + 0;
        this.rowCount = i2;
        this.headerRow = 0;
        ...
        if (i != 1) {
            ...
            FrameLayout frameLayout = new FrameLayout(this, context) { // from class: org.telegram.ui.Components.Premium.DoubledLimitsBottomSheet$Adapter.1
                ...
                protected void onMeasure(int i2, int i3) {
                    super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(86), 1073741824));
                }
            };
