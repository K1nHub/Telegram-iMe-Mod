...
public class StoriesPageView extends BaseListPageView {
    ...
    private class HeaderView extends FrameLayout {
        ...
        public HeaderView(StoriesPageView storiesPageView, Context context) {
            ...
            backupImageView.setRoundRadius((int) (AndroidUtilities.m107dp(65) / 2.0f));
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            rectF.set(rect);
            rectF.inset(-AndroidUtilities.m107dp(5), -AndroidUtilities.m107dp(5));
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION), 1073741824));
        }
    }
