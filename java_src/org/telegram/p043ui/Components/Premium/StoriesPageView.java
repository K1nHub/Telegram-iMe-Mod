...
import org.telegram.p043ui.Components.Premium.StoriesPageView;
...
public class StoriesPageView extends BaseListPageView {
    ...
    public StoriesPageView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        arrayList.add(new Item(this, 1, C3473R.C3475drawable.msg_stories_order, LocaleController.getString("PremiumStoriesPriority", C3473R.string.PremiumStoriesPriority), LocaleController.getString("PremiumStoriesPriorityDescription", C3473R.string.PremiumStoriesPriorityDescription), 20));
        arrayList.add(new Item(this, 1, C3473R.C3475drawable.msg_stories_stealth, LocaleController.getString("PremiumStoriesStealth", C3473R.string.PremiumStoriesStealth), LocaleController.getString("PremiumStoriesStealthDescription", C3473R.string.PremiumStoriesStealthDescription), 15));
        arrayList.add(new Item(this, 1, C3473R.C3475drawable.msg_stories_views, LocaleController.getString("PremiumStoriesViews", C3473R.string.PremiumStoriesViews), LocaleController.getString("PremiumStoriesViewsDescription", C3473R.string.PremiumStoriesViewsDescription), 16));
        arrayList.add(new Item(this, 1, C3473R.C3475drawable.msg_stories_timer, LocaleController.getString("PremiumStoriesExpiration", C3473R.string.PremiumStoriesExpiration), LocaleController.getString("PremiumStoriesExpirationDescription", C3473R.string.PremiumStoriesExpirationDescription), 17));
        arrayList.add(new Item(this, 1, C3473R.C3475drawable.msg_stories_save, LocaleController.getString("PremiumStoriesSaveToGallery", C3473R.string.PremiumStoriesSaveToGallery), LocaleController.getString("PremiumStoriesSaveToGalleryDescription", C3473R.string.PremiumStoriesSaveToGalleryDescription), 18));
        arrayList.add(new Item(this, 1, C3473R.C3475drawable.msg_stories_caption, LocaleController.getString("PremiumStoriesCaption", C3473R.string.PremiumStoriesCaption), LocaleController.getString("PremiumStoriesCaptionDescription", C3473R.string.PremiumStoriesCaptionDescription), 21));
        arrayList.add(new Item(this, 1, C3473R.C3475drawable.msg_stories_link, LocaleController.getString("PremiumStoriesFormatting", C3473R.string.PremiumStoriesFormatting), LocaleController.getString("PremiumStoriesFormattingDescription", C3473R.string.PremiumStoriesFormattingDescription), 19));
    ...
    private class HeaderView extends FrameLayout {
        ...
        public HeaderView(StoriesPageView storiesPageView, Context context) {
            ...
            backupImageView.setRoundRadius((int) (AndroidUtilities.m72dp(65) / 2.0f));
            ...
            textView.setText(LocaleController.getString("UpgradedStories", C3473R.string.UpgradedStories));
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            rectF.set(rect);
            rectF.inset(-AndroidUtilities.m72dp(5), -AndroidUtilities.m72dp(5));
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION), 1073741824));
        }
    }
