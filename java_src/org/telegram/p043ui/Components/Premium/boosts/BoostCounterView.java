...
public class BoostCounterView extends View {
    ...
    public BoostCounterView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m108dp(11.5f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) (AndroidUtilities.m107dp(15) + this.countText.getWidth()), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(26), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.save();
        canvas.translate(AndroidUtilities.m107dp(3), AndroidUtilities.m107dp(3));
        Rect rect = AndroidUtilities.rectTmp2;
        rect.set(0, 0, AndroidUtilities.m107dp(8) + ((int) this.countText.getCurrentWidth()), AndroidUtilities.m107dp(20));
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(10), AndroidUtilities.m107dp(10), this.bgPaint);
        rect.set(0, 0, (int) rectF.width(), AndroidUtilities.m107dp(19));
