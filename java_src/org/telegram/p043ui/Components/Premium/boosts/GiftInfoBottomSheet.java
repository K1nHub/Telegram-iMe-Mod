...
import org.telegram.p043ui.Components.Premium.boosts.adapters.GiftInfoAdapter;
...
/* renamed from: org.telegram.ui.Components.Premium.boosts.GiftInfoBottomSheet */
...
public class GiftInfoBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    /* loaded from: classes6.dex */
    public class C54752 extends GiftInfoAdapter {
        C54752(Theme.ResourcesProvider resourcesProvider) {
        ...
        protected void afterCodeApplied() {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.GiftInfoBottomSheet$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    GiftInfoBottomSheet.C54752.this.lambda$afterCodeApplied$0();
                }
            }, 200L);
        }
        ...
        public void onObjectClicked(TLObject tLObject) {
            ...
            if (tLObject instanceof TLRPC$Chat) {
                GiftInfoBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m68of(-((TLRPC$Chat) tLObject).f1602id));
            } else if (tLObject instanceof TLRPC$User) {
                GiftInfoBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m68of(((TLRPC$User) tLObject).f1751id));
            } else {
        ...
        public void onHiddenLinkClicked() {
            ...
            BulletinFactory.m66of(((BottomSheet) GiftInfoBottomSheet.this).container, ((BottomSheet) GiftInfoBottomSheet.this).resourcesProvider).createSimpleBulletin(C3632R.raw.chats_infotip, string).show(true);
        }
    }

    @Override // org.telegram.p043ui.Components.BottomSheetWithRecyclerListView
    protected RecyclerListView.SelectionAdapter createAdapter() {
        C54752 c54752 = new C54752(this.resourcesProvider);
        this.adapter = c54752;
        return c54752;
    }
}
