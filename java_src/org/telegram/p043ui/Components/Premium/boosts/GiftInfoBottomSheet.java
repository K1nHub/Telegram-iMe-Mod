    ...
    public class C54222 extends GiftInfoAdapter {
        ...
        protected void onObjectClicked(TLObject tLObject) {
            ...
            if (tLObject instanceof TLRPC$Chat) {
                GiftInfoBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m65of(-((TLRPC$Chat) tLObject).f1602id));
            } else if (tLObject instanceof TLRPC$User) {
                GiftInfoBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m65of(((TLRPC$User) tLObject).f1749id));
            } else {
