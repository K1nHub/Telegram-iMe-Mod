...
public class TableCell extends FrameLayout {
    ...
    public TableCell(Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m104dp(12));
        BackupImageView backupImageView2 = new BackupImageView(context);
        this.toImageView = backupImageView2;
        backupImageView2.setRoundRadius(AndroidUtilities.m104dp(12));
        ...
        this.fromFrameLayout.setPadding(0, AndroidUtilities.m104dp(6), 0, AndroidUtilities.m104dp(6));
        ...
        this.toFrameLayout.setPadding(0, AndroidUtilities.m104dp(6), 0, AndroidUtilities.m104dp(6));
        ...
        TableLayout tableLayout = new TableLayout(context) { // from class: org.telegram.ui.Components.Premium.boosts.cells.TableCell.1
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                TableCell.this.roundPath.addRoundRect(TableCell.this.roundRect, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), Path.Direction.CW);
                ...
                TableCell.this.linePaint.setStrokeWidth(AndroidUtilities.m104dp(1));
                ...
                TableCell.this.linePaint.setStrokeWidth(AndroidUtilities.m104dp(2));
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            tableLayout.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.telegram.ui.Components.Premium.boosts.cells.TableCell.2
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), AndroidUtilities.m104dp(6));
                }
            });
            tableLayout.setClipToOutline(z);
        }
        setPaddingRelative(AndroidUtilities.m104dp(14), AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(14), 0);
    }
    ...
    public void setData(final TLRPC$TL_payments_checkedGiftCode tLRPC$TL_payments_checkedGiftCode, final Utilities.Callback<TLObject> callback) {
        ...
        if (chat != null) {
            ...
            textView.setText(Emoji.replaceEmoji((CharSequence) replaceSingleTag, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(12), false));
            ...
            this.fromTextView.setText(Emoji.replaceEmoji((CharSequence) UserObject.getFirstName(user), this.fromTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(12), false));
        ...
        if (tLRPC$TL_payments_checkedGiftCode.to_id == -1 && tLRPC$TL_payments_checkedGiftCode.via_giveaway) {
            ...
            if (user2 != null) {
                ...
                textView2.setText(Emoji.replaceEmoji((CharSequence) replaceSingleTag2, textView2.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(12), false));
    ...
    private TextView createTextView(String str, boolean z) {
        ...
        if (str != null) {
            ...
            textView.setPadding(AndroidUtilities.m104dp(LocaleController.isRTL ? 32 : 12), AndroidUtilities.m104dp(11), AndroidUtilities.m104dp(LocaleController.isRTL ? 12 : 32), AndroidUtilities.m104dp(11));
        } else {
            textView.setSingleLine(true);
            textView.setEllipsize(TextUtils.TruncateAt.END);
            textView.setPadding(AndroidUtilities.m104dp(14), 0, AndroidUtilities.m104dp(14), 0);
        }
        return textView;
    }
}
