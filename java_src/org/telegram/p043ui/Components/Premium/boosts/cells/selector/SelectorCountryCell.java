...
public class SelectorCountryCell extends BaseCell {
    ...
    public void setCountry(TLRPC$TL_help_country tLRPC$TL_help_country, boolean z) {
        ...
        this.titleTextView.setText(Emoji.replaceEmoji(getCountryNameWithFlag(tLRPC$TL_help_country), this.titleTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(20), false));
        setDivider(z);
    }
