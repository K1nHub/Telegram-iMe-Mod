...
public class CounterDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(this.bgRoundRect, AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(12), this.bgPaint);
        this.icon.setBounds(bounds.left + AndroidUtilities.m104dp(2), bounds.top + AndroidUtilities.m104dp(1), bounds.left + AndroidUtilities.m104dp(2) + this.icon.getIntrinsicWidth(), getBounds().top + AndroidUtilities.m104dp(1) + this.icon.getIntrinsicHeight());
        this.icon.draw(canvas);
        String str = this.text;
        if (str != null) {
            canvas.drawText(str, AndroidUtilities.m105dp(16.5f) + bounds.left, bounds.top + AndroidUtilities.m105dp(13.0f), this.textPaint);
        }
    }

    @Override // android.graphics.drawable.Drawable
    public int getIntrinsicWidth() {
        return (int) (AndroidUtilities.m104dp(23) + this.textWith);
    }
