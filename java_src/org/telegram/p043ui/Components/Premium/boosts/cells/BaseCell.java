...
public abstract class BaseCell extends FrameLayout {
    ...
    public BaseCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        SimpleTextView simpleTextView = new SimpleTextView(this, context) { // from class: org.telegram.ui.Components.Premium.boosts.cells.BaseCell.1
            ...
            public boolean setText(CharSequence charSequence) {
                return super.setText(Emoji.replaceEmoji(charSequence, getPaint().getFontMetricsInt(), AndroidUtilities.m107dp(15), false));
            }
        };
    ...
    public void setSubtitle(CharSequence charSequence) {
        ...
        if (this.imageView.getVisibility() == 8) {
            if (LocaleController.isRTL) {
                this.titleTextView.setTranslationX(AndroidUtilities.m107dp(40));
                this.subtitleTextView.setTranslationX(AndroidUtilities.m107dp(40));
                return;
            }
            this.titleTextView.setTranslationX(AndroidUtilities.m107dp(-40));
            this.subtitleTextView.setTranslationX(AndroidUtilities.m107dp(-40));
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(getFullHeight()), 1073741824));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            if (LocaleController.isRTL) {
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, getHeight() - 1, getWidth() - AndroidUtilities.m107dp(dividerPadding), getHeight(), this.dividerPaint);
            } else {
                canvas.drawRect(AndroidUtilities.m107dp(dividerPadding), getHeight() - 1, getWidth(), getHeight(), this.dividerPaint);
            }
        }
    }
}
