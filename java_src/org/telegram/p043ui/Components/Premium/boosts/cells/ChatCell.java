...
public class ChatCell extends BaseCell {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.deleteImageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(48), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(48), 1073741824));
    }
