...
public class AddChannelCell extends FrameLayout {
    ...
    public AddChannelCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(imageView);
        simpleTextView.setText(LocaleController.getString("BoostingAddChannel", C3632R.string.BoostingAddChannel));
        Drawable drawable = getResources().getDrawable(C3632R.C3634drawable.poll_add_circle);
        Drawable drawable2 = getResources().getDrawable(C3632R.C3634drawable.poll_add_plus);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (LocaleController.isRTL) {
            m107dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m107dp(this.imageView.getVisibility() != 0 ? 23 : 68);
        } else {
            m107dp = AndroidUtilities.m107dp(this.imageView.getVisibility() != 0 ? 23 : 68);
        }
        ...
        int m107dp2 = !LocaleController.isRTL ? AndroidUtilities.m107dp(24) : (i5 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m107dp(24);
