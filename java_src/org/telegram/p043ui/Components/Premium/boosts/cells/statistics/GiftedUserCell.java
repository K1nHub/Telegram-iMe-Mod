...
public class GiftedUserCell extends UserCell {
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m107dp(70), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m107dp(70) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    private void init() {
        ...
        this.badgeLayout.setPadding(AndroidUtilities.m107dp(8), 0, AndroidUtilities.m107dp(8), 0);
    ...
    public void setStatus(TL_stories$TL_boost tL_stories$TL_boost) {
        ...
        if (tL_stories$TL_boost.gift || tL_stories$TL_boost.giveaway) {
            ...
            if (tL_stories$TL_boost.gift) {
                ...
                this.badgeTextView.setCompoundDrawablePadding(AndroidUtilities.m107dp(4));
                this.badgeTextView.setText(LocaleController.getString("BoostingGift", C3632R.string.BoostingGift));
                this.badgeLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(12), AndroidUtilities.m107dp(12), Theme.multAlpha(-3240417, 0.2f)));
            }
            if (tL_stories$TL_boost.giveaway) {
                ...
                this.badgeLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(12), AndroidUtilities.m107dp(12), Theme.multAlpha(-13397548, 0.2f)));
            }
        } else {
        ...
        if (this.badgeLayout.getVisibility() == 0) {
            int measureText = ((int) this.badgeTextView.getPaint().measureText(this.badgeTextView.getText().toString())) + AndroidUtilities.m107dp(22);
