    ...
    public void setStatus(TL_stories$TL_boost tL_stories$TL_boost) {
        ...
        if (tL_stories$TL_boost.gift || tL_stories$TL_boost.giveaway) {
            ...
            if (tL_stories$TL_boost.unclaimed) {
                this.nameTextView.setText(LocaleController.getString("BoostingUnclaimed", C3634R.string.BoostingUnclaimed));
                ...
                this.nameTextView.setText(LocaleController.getString("BoostingToBeDistributed", C3634R.string.BoostingToBeDistributed));
            ...
            simpleTextView.setText((((tL_stories$TL_boost.expires - tL_stories$TL_boost.date) / 30) / 86400) + "m • " + LocaleController.formatString("formatDateAtTime", C3634R.string.formatDateAtTime, format, format2));
            if (tL_stories$TL_boost.gift) {
                if (this.giftDrawable == null) {
                    Drawable drawable = getResources().getDrawable(C3634R.C3636drawable.mini_gift);
                ...
                this.badgeTextView.setText(LocaleController.getString("BoostingGift", C3634R.string.BoostingGift));
            ...
            if (tL_stories$TL_boost.giveaway) {
                if (this.giveawayDrawable == null) {
                    Drawable drawable2 = getResources().getDrawable(C3634R.C3636drawable.mini_giveaway);
                ...
                this.badgeTextView.setCompoundDrawablePadding(AndroidUtilities.m104dp(4));
                this.badgeTextView.setText(LocaleController.getString("BoostingGiveaway", C3634R.string.BoostingGiveaway));
