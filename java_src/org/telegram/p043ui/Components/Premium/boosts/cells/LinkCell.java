...
public class LinkCell extends FrameLayout {
    ...
    public LinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        spoilersTextView.setPadding(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(50), AndroidUtilities.m107dp(13));
        ...
        frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(m107dp, color, ColorUtils.setAlphaComponent(Theme.getColor(i, resourcesProvider), 76)));
        ...
        imageView.setImageResource(C3632R.C3634drawable.menu_copy_s);
        this.imageView.setColorFilter(Theme.getColor(Theme.key_dialogTextBlack, resourcesProvider));
        this.imageView.setPadding(AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8));
        this.imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(20), 0, ColorUtils.setAlphaComponent(Theme.getColor(i, resourcesProvider), 76)));
        addView(this.imageView, LayoutHelper.createFrame(40, 40, 21, 15, 0, 17, 0));
    ...
    public void hideSlug(final Runnable runnable) {
        ...
        this.linkView.setPadding(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(14), AndroidUtilities.m107dp(14), AndroidUtilities.m107dp(18));
