...
public class SelectorBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public SelectorBottomSheet(BaseFragment baseFragment, boolean z, long j) {
        ...
        this.listPaddingTop = AndroidUtilities.m104dp((int) TsExtractor.TS_STREAM_TYPE_SPLICE_INFO);
        ...
        SelectorSearchCell selectorSearchCell = new SelectorSearchCell(getContext(), this.resourcesProvider, null) { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet.2
            ...
            protected void onLayout(boolean z2, int i, int i2, int i3, int i4) {
                ...
                SelectorBottomSheet.this.listPaddingTop = getMeasuredHeight() + AndroidUtilities.m104dp(78);
        ...
        selectorSearchCell.setOnSearchTextChange(new Utilities.Callback() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda11
        ...
        selectorBtnCell.setPadding(AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10));
        ...
        recyclerListView.setPadding(i6, 0, i6, AndroidUtilities.m104dp(60));
        ...
        this.recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda15
    ...
    public /* synthetic */ void lambda$new$5(View view, int i, float f, float f2) {
        if (view instanceof SelectorUserCell) {
            ...
            final long j = user != null ? user.f1749id : -chat.f1602id;
            ...
            this.searchField.updateSpans(true, this.selectedIds, new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (chat != null && !ChatObject.isPublic(chat) && this.selectedIds.contains(Long.valueOf(j))) {
                BoostDialogs.showPrivateChannelAlert(getBaseFragment().getContext(), this.resourcesProvider, new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void scrollToTop(boolean z) {
        if (z) {
            ...
            linearSmoothScrollerCustom.setOffset(AndroidUtilities.m104dp(38));
    ...
    public void loadData(int i, final boolean z, String str) {
        if (i == 1) {
            BoostRepository.loadChatParticipants(this.currentChat.f1602id, 0, str, 0, 50, new Utilities.Callback() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda14
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
            ...
            BoostRepository.searchChats(this.currentChat.f1602id, 0, str, 50, new Utilities.Callback() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda12
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
    ...
    public /* synthetic */ void lambda$loadData$9(boolean z, Pair pair) {
        if (z) {
            ...
            Map.EL.forEach(this.countriesMap, new BiConsumer() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda10
    ...
    public boolean hasChanges() {
        ...
        BoostDialogs.showUnsavedChanges(this.type, getContext(), this.resourcesProvider, new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                SelectorBottomSheet.this.lambda$hasChanges$10();
            }
        }, new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void prepare(List<TLObject> list, int i) {
        ...
        if (list != null) {
            for (TLObject tLObject : list) {
                ...
                if (tLObject instanceof TLRPC$Chat) {
                    this.selectedIds.add(Long.valueOf(-((TLRPC$Chat) tLObject).f1602id));
                }
                if (tLObject instanceof TLRPC$User) {
                    this.selectedIds.add(Long.valueOf(((TLRPC$User) tLObject).f1749id));
                }
        ...
        this.searchField.updateSpans(false, this.selectedIds, new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.SelectorBottomSheet$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    protected void onPreDraw(Canvas canvas, int i, float f) {
        this.top = i;
        this.headerView.setTranslationY(Math.max(i, AndroidUtilities.statusBarHeight + (((this.headerView.getMeasuredHeight() - AndroidUtilities.statusBarHeight) - AndroidUtilities.m104dp(40)) / 2.0f)));
        ...
        this.recyclerListView.setTranslationY(((this.headerView.getMeasuredHeight() + this.searchField.getMeasuredHeight()) + this.sectionCell.getMeasuredHeight()) - AndroidUtilities.m104dp(16));
    ...
    private void drawFilledStatusBar(Canvas canvas, int i) {
        ...
        rectF.set(this.backgroundPaddingLeft, lerp, this.containerView.getWidth() - this.backgroundPaddingLeft, this.containerView.getHeight() + AndroidUtilities.m104dp(14));
    ...
    public void updateItems(boolean z, boolean z2) {
        ...
        if (this.items.isEmpty()) {
            ...
            i += AndroidUtilities.m104dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        }
