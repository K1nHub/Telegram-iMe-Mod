...
public class PremiumAppIconsPreviewView extends FrameLayout implements PagerHeaderView {
    ...
    public PremiumAppIconsPreviewView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (this.icons.size() < 3) {
            FileLog.m99e(new IllegalArgumentException("There should be at least 3 premium icons!"));
            this.isEmpty = true;
            return;
        }
    ...
    private AdaptiveIconImageView newIconView(Context context, int i) {
        ...
        adaptiveIconImageView.setPadding(AndroidUtilities.m104dp(8));
        adaptiveIconImageView.setBackgroundOuterPadding(AndroidUtilities.m104dp(32));
    ...
    public void setOffset(float f) {
        ...
        this.bottomRightIcon.setTranslationX(((getRight() - this.bottomRightIcon.getRight()) + (this.bottomRightIcon.getWidth() * 1.5f) + AndroidUtilities.m104dp(32)) * interpolation);
        this.bottomRightIcon.setTranslationY(AndroidUtilities.m104dp(16) * interpolation);
        ...
        this.topIcon.setTranslationY((((getTop() - this.topIcon.getTop()) - (this.topIcon.getHeight() * 1.8f)) - AndroidUtilities.m104dp(32)) * abs);
        this.topIcon.setTranslationX(AndroidUtilities.m104dp(16) * abs);
        ...
        this.bottomLeftIcon.setTranslationX((((getLeft() - this.bottomLeftIcon.getLeft()) - (this.bottomLeftIcon.getWidth() * 2.5f)) + AndroidUtilities.m104dp(32)) * interpolation2);
        this.bottomLeftIcon.setTranslationY(interpolation2 * ((getBottom() - this.bottomLeftIcon.getBottom()) + (this.bottomLeftIcon.getHeight() * 2.5f) + AndroidUtilities.m104dp(32)));
    ...
    public class AdaptiveIconImageView extends AppIconsSelectorCell.AdaptiveIconImageView {
        ...
        public void draw(Canvas canvas) {
            ...
            this.drawable.excludeRect.set(AndroidUtilities.m104dp(5), AndroidUtilities.m104dp(5), getMeasuredWidth() - AndroidUtilities.m104dp(5), getMeasuredHeight() - AndroidUtilities.m104dp(5));
            float f = -m104dp;
            this.drawable.rect.set(f, f, getWidth() + m104dp, getHeight() + m104dp);
            canvas.save();
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m105dp(18.0f), AndroidUtilities.m105dp(18.0f), this.paint);
            super.draw(canvas);
        }
    }
}
