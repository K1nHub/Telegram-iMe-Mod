...
public class StarParticlesView extends View {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.drawable.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m104dp(140), AndroidUtilities.m104dp(140));
    ...
    public static class Drawable {
        ...
        /* renamed from: k1 */
        public float f1919k1 = 0.85f;

        /* renamed from: k2 */
        public float f1920k2 = 0.85f;

        /* renamed from: k3 */
        public float f1921k3 = 0.9f;
        public long minLifeTime = ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS;
        public int randLifeTime = 1000;

        /* renamed from: dt */
        private final float f1918dt = 1000.0f / AndroidUtilities.screenRefreshRate;
        ...
        private void generateBitmaps() {
            ...
            for (int i5 = 0; i5 < 3; i5++) {
                float f = this.f1919k1;
                if (i5 == 0) {
                    m104dp = AndroidUtilities.m104dp(this.size1);
                } else if (i5 == 1) {
                    f = this.f1920k2;
                    m104dp = AndroidUtilities.m104dp(this.size2);
                } else {
                    f = this.f1921k3;
                    m104dp = AndroidUtilities.m104dp(this.size3);
                }
                int i6 = m104dp;
                int i7 = this.type;
                if (i7 == 9) {
                    if (i5 == 0) {
                        i4 = C3634R.raw.premium_object_folder;
                    } else if (i5 == 1) {
                        i4 = C3634R.raw.premium_object_bubble;
                    } else {
                        i4 = C3634R.raw.premium_object_settings;
                    }
                    ...
                    if (i5 == 0) {
                        i = C3634R.raw.premium_object_smile1;
                    } else if (i5 == 1) {
                        i = C3634R.raw.premium_object_smile2;
                    } else {
                        i = C3634R.raw.premium_object_like;
                    }
                    ...
                    if (i5 == 0) {
                        i3 = C3634R.raw.premium_object_adsbubble;
                    } else if (i5 == 1) {
                        i3 = C3634R.raw.premium_object_like;
                    } else {
                        i3 = C3634R.raw.premium_object_noads;
                    }
                    ...
                    if (i5 == 0) {
                        i2 = C3634R.raw.premium_object_video2;
                    } else if (i5 == 1) {
                        i2 = C3634R.raw.premium_object_video;
                    } else {
                        i2 = C3634R.raw.premium_object_user;
                    }
                    ...
                    this.stars[i5] = SvgHelper.getBitmap(C3634R.raw.premium_object_fire, i6, i6, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey, this.resourcesProvider), 30));
                    this.svg = true;
                } else if (i7 == 1002) {
                    this.stars[i5] = SvgHelper.getBitmap(C3634R.raw.premium_object_star2, i6, i6, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey, this.resourcesProvider), 30));
                    this.svg = true;
                } else {
                    ...
                    if (this.type == 6 && (i5 == 1 || i5 == 2)) {
                        android.graphics.drawable.Drawable drawable = ContextCompat.getDrawable(ApplicationLoader.applicationContext, C3634R.C3636drawable.msg_premium_liststar);
                        ...
                        if (this.useGradient) {
                            if (i6 >= AndroidUtilities.m104dp(10)) {
        ...
        public void onDraw(Canvas canvas, float f) {
            ...
            if (this.useRotate) {
                ...
                float f3 = this.f1915a + ((f2 / 40000.0f) * 360.0f);
                this.f1915a = f3;
                this.f1916a1 += (f2 / 50000.0f) * 360.0f;
                this.f1917a2 += (f2 / 60000.0f) * 360.0f;
                this.matrix.setRotate(f3, this.rect.centerX(), this.rect.centerY());
                this.matrix2.setRotate(this.f1916a1, this.rect.centerX(), this.rect.centerY());
                this.matrix3.setRotate(this.f1917a2, this.rect.centerX(), this.rect.centerY());
                this.pointsCount1 = 0;
                this.pointsCount2 = 0;
                this.pointsCount3 = 0;
                for (int i = 0; i < this.particles.size(); i++) {
        ...
        public class Particle {
            ...
            /* renamed from: x */
            private float f1922x;

            /* renamed from: x2 */
            private float f1923x2;

            /* renamed from: y */
            private float f1924y;

            /* renamed from: y2 */
            private float f1925y2;
            ...
            public void draw(Canvas canvas, long j, float f) {
                ...
                if (drawable.useRotate) {
                    ...
                    this.drawingX = this.f1922x;
                    this.drawingY = this.f1924y;
                }
                boolean z = false;
                ...
                float m104dp = AndroidUtilities.m104dp(4) * (Drawable.this.f1918dt / 660.0f);
                Drawable drawable3 = Drawable.this;
                float f5 = m104dp * drawable3.speedScale;
                this.f1922x += this.vecX * f5;
                this.f1924y += this.vecY * f5;
                float f6 = this.inProgress;
                if (f6 != 1.0f) {
                    float f7 = f6 + (drawable3.f1918dt / 200.0f);
                    this.inProgress = f7;
                    if (f7 > 1.0f) {
            ...
            public void genPosition(long j) {
                ...
                if (drawable2.distributionAlgorithm) {
                    ...
                    for (int i2 = 0; i2 < 10; i2++) {
                        ...
                        for (int i3 = 0; i3 < Drawable.this.particles.size(); i3++) {
                            ...
                            if (drawable3.startFromCenter) {
                                f = drawable3.particles.get(i3).f1923x2 - abs3;
                                f2 = Drawable.this.particles.get(i3).f1925y2;
                            } else {
                                f = drawable3.particles.get(i3).f1922x - abs3;
                                f2 = Drawable.this.particles.get(i3).f1924y;
                            }
                            float f5 = f2 - abs4;
                            float f6 = (f * f) + (f5 * f5);
                            if (f6 < f4) {
                    ...
                    this.f1922x = Drawable.this.rect.centerX() + ((float) (Math.sin(Math.toRadians(r4)) * abs5));
                    this.f1924y = Drawable.this.rect.centerY() + ((float) (abs5 * Math.cos(Math.toRadians(r4))));
                } else {
                    this.f1922x = drawable2.rect.left + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.width());
                    this.f1924y = Drawable.this.rect.top + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.height());
                }
                double atan2 = Math.atan2(this.f1922x - Drawable.this.rect.centerX(), this.f1924y - Drawable.this.rect.centerY());
                ...
                if (drawable4.startFromCenter) {
                    this.f1923x2 = this.f1922x;
                    this.f1925y2 = this.f1924y;
                    this.f1922x = drawable4.rect.centerX();
                    this.f1924y = Drawable.this.rect.centerY();
                }
            }
        }
    }
