...
import org.telegram.p043ui.GLIconSettingsView;
...
public class StarParticlesView extends View {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.drawable.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(140), AndroidUtilities.m107dp(140));
    ...
    public static class Drawable {
        ...
        /* renamed from: k1 */
        public float f1926k1 = 0.85f;

        /* renamed from: k2 */
        public float f1927k2 = 0.85f;

        /* renamed from: k3 */
        public float f1928k3 = 0.9f;
        public long minLifeTime = ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS;
        public int randLifeTime = 1000;

        /* renamed from: dt */
        private final float f1925dt = 1000.0f / AndroidUtilities.screenRefreshRate;
        ...
        private void generateBitmaps() {
            ...
            for (int i6 = 0; i6 < 3; i6++) {
                float f = this.f1926k1;
                if (i6 == 0) {
                    m107dp = AndroidUtilities.m107dp(this.size1);
                } else if (i6 == 1) {
                    f = this.f1927k2;
                    m107dp = AndroidUtilities.m107dp(this.size2);
                } else {
                    f = this.f1928k3;
                    m107dp = AndroidUtilities.m107dp(this.size3);
                }
                int i7 = m107dp;
                int i8 = this.type;
                if (i8 == 9) {
                    if (i6 == 0) {
                        i5 = C3632R.raw.premium_object_folder;
                    } else if (i6 == 1) {
                        i5 = C3632R.raw.premium_object_bubble;
                    } else {
                        i5 = C3632R.raw.premium_object_settings;
                    }
                    ...
                    if (i6 == 0) {
                        i = C3632R.raw.premium_object_smile1;
                    } else if (i6 == 1) {
                        i = C3632R.raw.premium_object_smile2;
                    } else {
                        i = C3632R.raw.premium_object_like;
                    }
                    ...
                    if (i6 == 0) {
                        i4 = C3632R.raw.premium_object_user;
                    } else if (i6 == 1) {
                        i4 = C3632R.raw.cache_photos;
                    } else {
                        i4 = C3632R.raw.cache_profile_photos;
                    }
                    ...
                    if (i6 == 0) {
                        i3 = C3632R.raw.premium_object_adsbubble;
                    } else if (i6 == 1) {
                        i3 = C3632R.raw.premium_object_like;
                    } else {
                        i3 = C3632R.raw.premium_object_noads;
                    }
                    ...
                    if (i6 == 0) {
                        i2 = C3632R.raw.premium_object_video2;
                    } else if (i6 == 1) {
                        i2 = C3632R.raw.premium_object_video;
                    } else {
                        i2 = C3632R.raw.premium_object_user;
                    }
                    ...
                    this.stars[i6] = SvgHelper.getBitmap(C3632R.raw.premium_object_fire, i7, i7, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey, this.resourcesProvider), 30));
                    this.svg = true;
                } else if (i8 == 1002) {
                    this.stars[i6] = SvgHelper.getBitmap(C3632R.raw.premium_object_star2, i7, i7, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey, this.resourcesProvider), 30));
                    this.svg = true;
                } else {
                    ...
                    if (this.type == 6 && (i6 == 1 || i6 == 2)) {
                        android.graphics.drawable.Drawable drawable = ContextCompat.getDrawable(ApplicationLoader.applicationContext, C3632R.C3634drawable.msg_premium_liststar);
                        ...
                        if (this.useGradient) {
                            if (i7 >= AndroidUtilities.m107dp(10)) {
                                PremiumGradient.getInstance().updateMainGradientMatrix(0, 0, i7, i7, i7 * (-2), BitmapDescriptorFactory.HUE_RED);
                            } else {
                                PremiumGradient.getInstance().updateMainGradientMatrix(0, 0, i7, i7, i7 * (-4), BitmapDescriptorFactory.HUE_RED);
                            }
        ...
        public void onDraw(Canvas canvas, float f) {
            ...
            if (this.useRotate) {
                ...
                float f3 = this.f1922a + ((f2 / 40000.0f) * 360.0f);
                this.f1922a = f3;
                this.f1923a1 += (f2 / 50000.0f) * 360.0f;
                this.f1924a2 += (f2 / 60000.0f) * 360.0f;
                this.matrix.setRotate(f3, this.rect.centerX(), this.rect.centerY());
                this.matrix2.setRotate(this.f1923a1, this.rect.centerX(), this.rect.centerY());
                this.matrix3.setRotate(this.f1924a2, this.rect.centerX(), this.rect.centerY());
                this.pointsCount1 = 0;
                this.pointsCount2 = 0;
                this.pointsCount3 = 0;
                for (int i = 0; i < this.particles.size(); i++) {
        ...
        public class Particle {
            ...
            /* renamed from: x2 */
            private float f1930x2;

            /* renamed from: y */
            private float f1931y;

            /* renamed from: y2 */
            private float f1932y2;
            ...
            public void draw(Canvas canvas, long j, float f) {
                ...
                if (drawable.useRotate) {
                    ...
                    this.drawingX = this.f1929x;
                    this.drawingY = this.f1931y;
                }
                boolean z = false;
                ...
                float m107dp = AndroidUtilities.m107dp(4) * (Drawable.this.f1925dt / 660.0f);
                Drawable drawable3 = Drawable.this;
                float f5 = m107dp * drawable3.speedScale;
                this.f1929x += this.vecX * f5;
                this.f1931y += this.vecY * f5;
                float f6 = this.inProgress;
                if (f6 != 1.0f) {
                    float f7 = f6 + (drawable3.f1925dt / 200.0f);
                    this.inProgress = f7;
                    if (f7 > 1.0f) {
            ...
            public void genPosition(long j) {
                ...
                if (drawable2.distributionAlgorithm) {
                    ...
                    for (int i2 = 0; i2 < 10; i2++) {
                        ...
                        for (int i3 = 0; i3 < Drawable.this.particles.size(); i3++) {
                            ...
                            if (drawable3.startFromCenter) {
                                f = drawable3.particles.get(i3).f1930x2 - abs3;
                                f2 = Drawable.this.particles.get(i3).f1932y2;
                            } else {
                                f = drawable3.particles.get(i3).f1929x - abs3;
                                f2 = Drawable.this.particles.get(i3).f1931y;
                            }
                            float f5 = f2 - abs4;
                            float f6 = (f * f) + (f5 * f5);
                            if (f6 < f4) {
                    ...
                    this.f1929x = Drawable.this.rect.centerX() + ((float) (Math.sin(Math.toRadians(r4)) * abs5));
                    this.f1931y = Drawable.this.rect.centerY() + ((float) (abs5 * Math.cos(Math.toRadians(r4))));
                } else {
                    this.f1929x = drawable2.rect.left + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.width());
                    this.f1931y = Drawable.this.rect.top + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.height());
                }
                double atan2 = Math.atan2(this.f1929x - Drawable.this.rect.centerX(), this.f1931y - Drawable.this.rect.centerY());
                ...
                if (drawable4.startFromCenter) {
                    this.f1930x2 = this.f1929x;
                    this.f1932y2 = this.f1931y;
                    this.f1929x = drawable4.rect.centerX();
                    this.f1931y = Drawable.this.rect.centerY();
                }
            }
        }
    }
