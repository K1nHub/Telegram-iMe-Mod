...
public class PremiumGiftTierCell extends ViewGroup {
    ...
    public PremiumGiftTierCell(Context context) {
        ...
        setPadding(AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(12), AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(12));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        rect.set(AndroidUtilities.m107dp(8) + getPaddingLeft(), (int) ((getMeasuredHeight() - this.checkBox.getMeasuredHeight()) / 2.0f), 0, 0);
        checkRtlAndLayout(this.checkBox);
        rect.set(((getMeasuredWidth() - this.priceTotalView.getMeasuredWidth()) - AndroidUtilities.m107dp(16)) - getPaddingRight(), (int) ((getMeasuredHeight() - this.priceTotalView.getMeasuredHeight()) / 2.0f), 0, 0);
        checkRtlAndLayout(this.priceTotalView);
        rect.set(AndroidUtilities.m107dp(this.leftPaddingToTextDp + 8) + this.checkBox.getMeasuredWidth() + getPaddingLeft(), getPaddingTop(), 0, 0);
        checkRtlAndLayout(this.titleView);
        if (this.discountView.getVisibility() == 0) {
            rect.set(AndroidUtilities.m107dp(this.leftPaddingToTextDp + 8) + this.checkBox.getMeasuredWidth() + getPaddingLeft(), (getMeasuredHeight() - this.discountView.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
            checkRtlAndLayout(this.discountView);
        }
        rect.set(AndroidUtilities.m107dp(this.leftPaddingToTextDp + 8 + (this.discountView.getVisibility() == 0 ? 6 : 0)) + this.checkBox.getMeasuredWidth() + this.discountView.getMeasuredWidth() + getPaddingLeft(), (getMeasuredHeight() - this.pricePerMonthView.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
    ...
    public void dispatchDraw(Canvas canvas) {
        if (this.isDrawingGradient) {
            ...
            rectF.set(this.priceTotalView.getLeft(), this.priceTotalView.getTop() + AndroidUtilities.m107dp(4), this.priceTotalView.getRight(), this.priceTotalView.getBottom() - AndroidUtilities.m107dp(4));
            canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), paint);
            rectF.set(this.pricePerMonthView.getLeft(), AndroidUtilities.m107dp(42), this.pricePerMonthView.getRight(), AndroidUtilities.m107dp(54));
            canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), paint);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int m107dp = AndroidUtilities.m107dp(68);
        ...
        this.priceTotalView.measure(View.MeasureSpec.makeMeasureSpec(size - this.checkBox.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m107dp, Integer.MIN_VALUE));
        this.titleView.measure(View.MeasureSpec.makeMeasureSpec((size - this.checkBox.getMeasuredWidth()) - this.priceTotalView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m107dp, Integer.MIN_VALUE));
        if (this.discountView.getVisibility() == 0) {
            this.discountView.measure(View.MeasureSpec.makeMeasureSpec((size - this.checkBox.getMeasuredWidth()) - this.priceTotalView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m107dp, Integer.MIN_VALUE));
        } else {
            this.discountView.measure(View.MeasureSpec.makeMeasureSpec(0, 1073741824), View.MeasureSpec.makeMeasureSpec(0, 1073741824));
        }
        this.pricePerMonthView.measure(View.MeasureSpec.makeMeasureSpec(((size - this.checkBox.getMeasuredWidth()) - this.priceTotalView.getMeasuredWidth()) - this.discountView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m107dp, Integer.MIN_VALUE));
