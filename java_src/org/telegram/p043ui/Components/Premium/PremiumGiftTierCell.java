    ...
    public void bind(GiftPremiumBottomSheet.GiftTier giftTier) {
        ...
        if (!z) {
            if (giftTier.getDiscount() <= 0) {
                ...
                this.discountView.setText(LocaleController.formatString(C3632R.string.GiftPremiumOptionDiscount, Integer.valueOf(giftTier.getDiscount())));
                this.discountView.setVisibility(0);
            }
            this.pricePerMonthView.setText(LocaleController.formatString(C3632R.string.PricePerMonth, giftTier.getFormattedPricePerMonth()));
            ...
            this.discountView.setVisibility(0);
            this.pricePerMonthView.setText(LocaleController.formatString(C3632R.string.PricePerMonth, 100));
