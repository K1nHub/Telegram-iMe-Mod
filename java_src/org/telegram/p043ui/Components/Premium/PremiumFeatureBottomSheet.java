...
public class PremiumFeatureBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumFeatureBottomSheet(final BaseFragment baseFragment, Context context, int i, int i2, final boolean z, PremiumPreviewFragment.SubscriptionTier subscriptionTier) {
        ...
        this.svgIcon = SvgHelper.getDrawable(RLottieDrawable.readRes(null, C3473R.raw.star_loader));
        ...
        premiumGradientTools.f1824y1 = 1.1f;
        premiumGradientTools.f1823x2 = 1.5f;
        premiumGradientTools.f1825y2 = -0.2f;
        ...
        this.content = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.2
            ...
            protected void onMeasure(int i4, int i5) {
                super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(PremiumFeatureBottomSheet.this.contentHeight + AndroidUtilities.m72dp(2), 1073741824));
            }
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                rectF.set(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m72dp(2), getMeasuredWidth(), getMeasuredHeight() + AndroidUtilities.m72dp(18));
                canvas.save();
                canvas.clipRect(0, 0, getMeasuredWidth(), getMeasuredHeight());
                premiumGradientTools.paint.setAlpha(PremiumFeatureBottomSheet.this.gradientAlpha);
                canvas.drawRoundRect(rectF, AndroidUtilities.m72dp(12) - 1, AndroidUtilities.m72dp(12) - 1, premiumGradientTools.paint);
                canvas.restore();
        ...
        imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m72dp(12), ColorUtils.setAlphaComponent(-1, 40), ColorUtils.setAlphaComponent(-1, 100)));
        ...
        ViewPager viewPager = new ViewPager(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.3
            ...
            public void onMeasure(int i4, int i5) {
                ...
                if (getChildCount() > 0) {
                    ...
                    m72dp = getChildAt(0).getMeasuredHeight();
                }
                super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(m72dp + PremiumFeatureBottomSheet.this.topGlobalOffset, 1073741824));
            }
        ...
        this.viewPager.addOnPageChangeListener(new C51845(bottomPagesView));
        ...
        if (UserConfig.getInstance(i).isPremium()) {
            this.premiumButtonView.setOverlayText(LocaleController.getString("OK", C3473R.string.OK), false, false);
        }
        ...
        final Drawable mutate = ContextCompat.getDrawable(getContext(), C3473R.C3475drawable.header_shadow).mutate();
        FrameLayout frameLayout3 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.6
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                PremiumFeatureBottomSheet premiumFeatureBottomSheet = PremiumFeatureBottomSheet.this;
                drawable.setBounds(0, ((premiumFeatureBottomSheet.topCurrentOffset + ((BottomSheet) premiumFeatureBottomSheet).backgroundPaddingTop) - AndroidUtilities.m72dp(2)) + 1, getMeasuredWidth(), getMeasuredHeight());
                ((BottomSheet) PremiumFeatureBottomSheet.this).shadowDrawable.draw(canvas);
                super.dispatchDraw(canvas);
                C3541ActionBar c3541ActionBar = PremiumFeatureBottomSheet.this.actionBar;
                if (c3541ActionBar == null || c3541ActionBar.getVisibility() != 0 || PremiumFeatureBottomSheet.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
                    return;
                }
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                if (view == scrollView) {
                    ...
                    this.path.rewind();
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(BitmapDescriptorFactory.HUE_RED, PremiumFeatureBottomSheet.this.topCurrentOffset + AndroidUtilities.m72dp(18), getMeasuredWidth(), getMeasuredHeight());
                    this.path.addRoundRect(rectF, AndroidUtilities.m72dp(18), AndroidUtilities.m72dp(18), Path.Direction.CW);
            ...
            public boolean dispatchTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0) {
                    ...
                    PremiumFeatureBottomSheet premiumFeatureBottomSheet = PremiumFeatureBottomSheet.this;
                    if (y < (premiumFeatureBottomSheet.topCurrentOffset - ((BottomSheet) premiumFeatureBottomSheet).backgroundPaddingTop) + AndroidUtilities.m72dp(2)) {
    ...
    /* loaded from: classes7.dex */
    public class C51845 implements ViewPager.OnPageChangeListener {
        ...
        C51845(BottomPagesView bottomPagesView) {
        ...
        public void onPageSelected(int i) {
            if (PremiumFeatureBottomSheet.this.premiumFeatures.get(i).type == 0) {
                PremiumFeatureBottomSheet.this.actionBar.setTitle(LocaleController.getString("DoubledLimits", C3473R.string.DoubledLimits));
                ...
                PremiumFeatureBottomSheet.this.actionBar.setTitle(LocaleController.getString("UpgradedStories", C3473R.string.UpgradedStories));
                PremiumFeatureBottomSheet.this.actionBar.requestLayout();
            }
            checkPage();
        }
        ...
        */
        private void checkPage() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.Premium.PremiumFeatureBottomSheet.C51845.checkPage():void");
        }
    ...
    private void setButtonText() {
        if (this.forceAbout) {
            this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C3473R.string.AboutTelegramPremium));
        } else if (this.onlySelectedType) {
            int i = this.startType;
            if (i == 4) {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C3473R.string.UnlockPremiumReactions));
                this.premiumButtonView.setIcon(C3473R.raw.unlock_icon);
            } else if (i == 3 || i == 2 || i == 9 || i == 8) {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C3473R.string.AboutTelegramPremium));
            } else if (i == 10) {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C3473R.string.UnlockPremiumIcons));
                this.premiumButtonView.setIcon(C3473R.raw.unlock_icon);
            }
        } else {
    ...
    public void onCreate(Bundle bundle) {
        ...
        C3541ActionBar c3541ActionBar = new C3541ActionBar(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.7
            @Override // android.view.View
        ...
        this.actionBar.setExtraHeight(AndroidUtilities.m72dp(2));
        this.actionBar.setBackButtonImage(C3473R.C3475drawable.ic_ab_back);
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.8
        ...
        ((FrameLayout.LayoutParams) this.actionBar.getLayoutParams()).topMargin = (-this.backgroundPaddingTop) - AndroidUtilities.m72dp(2);
        ...
        if (this.premiumFeatures.get(this.selectedPosition).type == 14) {
            this.actionBar.setTitle(LocaleController.getString("UpgradedStories", C3473R.string.UpgradedStories));
            this.actionBar.requestLayout();
            return;
        }
        this.actionBar.setTitle(LocaleController.getString("DoubledLimits", C3473R.string.DoubledLimits));
        this.actionBar.requestLayout();
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.billingProductDetailsUpdated || i == NotificationCenter.premiumPromoUpdated) {
            ...
            if (UserConfig.getInstance(this.currentAccount).isPremium()) {
                this.premiumButtonView.setOverlayText(LocaleController.getString("OK", C3473R.string.OK), false, true);
            } else {
                this.premiumButtonView.clearOverlayText();
            }
        }
    ...
    public class ViewPage extends LinearLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (((BottomSheet) PremiumFeatureBottomSheet.this).isPortrait) {
                marginLayoutParams.topMargin = AndroidUtilities.m72dp(20);
                marginLayoutParams.bottomMargin = 0;
            } else {
                marginLayoutParams.topMargin = AndroidUtilities.m72dp(10);
                marginLayoutParams.bottomMargin = AndroidUtilities.m72dp(10);
            }
            ((ViewGroup.MarginLayoutParams) this.topView.getLayoutParams()).bottomMargin = 0;
            super.onMeasure(i, i2);
            if (this.topViewOnFullHeight) {
                this.topView.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.m72dp(16);
                ((ViewGroup.MarginLayoutParams) this.topView.getLayoutParams()).bottomMargin = AndroidUtilities.m72dp(16);
                                    ...
                                    if (PremiumFeatureBottomSheet.this.startType != 9) {
                                        if (PremiumFeatureBottomSheet.this.startType != 8) {
                                            if (PremiumFeatureBottomSheet.this.startType == 13) {
                                                this.title.setText(LocaleController.getString(C3473R.string.PremiumPreviewTranslations));
                                                this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3473R.string.PremiumPreviewTranslationsDescription)));
                                            }
                                        } else {
                                            this.title.setText(LocaleController.getString(C3473R.string.PremiumPreviewVoiceToText));
                                            this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3473R.string.PremiumPreviewVoiceToTextDescription2)));
                                        }
                                    } else {
                                        this.title.setText(LocaleController.getString(C3473R.string.PremiumPreviewAdvancedChatManagement));
                                        this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3473R.string.PremiumPreviewAdvancedChatManagementDescription2)));
                                    }
                                } else {
                                    this.title.setText(LocaleController.getString(C3473R.string.PremiumPreviewDownloadSpeed));
                                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C3473R.string.PremiumPreviewDownloadSpeedDescription2)));
                                }
                            } else {
                                this.title.setText(LocaleController.getString("PremiumPreviewAppIcon", C3473R.string.PremiumPreviewAppIcon));
                                this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString("PremiumPreviewAppIconDescription2", C3473R.string.PremiumPreviewAppIconDescription2)));
                            }
                        } else {
                            this.title.setText(LocaleController.getString("PremiumPreviewNoAds", C3473R.string.PremiumPreviewNoAds));
                            this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString("PremiumPreviewNoAdsDescription2", C3473R.string.PremiumPreviewNoAdsDescription2)));
                        }
                    } else {
                        this.title.setText(LocaleController.getString("AdditionalReactions", C3473R.string.AdditionalReactions));
                        this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString("AdditionalReactionsDescription", C3473R.string.AdditionalReactionsDescription)));
                    }
    ...
    void checkTopOffset() {
        ...
        if (i4 != this.topCurrentOffset) {
            ...
            AndroidUtilities.updateViewVisibilityAnimated(this.actionBar, this.topCurrentOffset < AndroidUtilities.m72dp(30), 1.0f, true);
        }
    }
    ...
    public void updateStatusBar() {
        ...
        if (c3541ActionBar != null && c3541ActionBar.getTag() != null) {
