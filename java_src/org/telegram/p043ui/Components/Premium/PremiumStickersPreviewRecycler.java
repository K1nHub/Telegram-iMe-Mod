...
public class PremiumStickersPreviewRecycler extends RecyclerListView implements NotificationCenter.NotificationCenterDelegate, PagerHeaderView {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.isVisible) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                float clamp = Utilities.clamp(top, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
    ...
    /* renamed from: org.telegram.ui.Components.Premium.PremiumStickersPreviewRecycler$Adapter */
    /* loaded from: classes6.dex */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.Premium.PremiumStickersPreviewRecycler$StickerView */
    /* loaded from: classes6.dex */
    public class StickerView extends FrameLayout {
            ...
            this.view = new View(context, PremiumStickersPreviewRecycler.this) { // from class: org.telegram.ui.Components.Premium.PremiumStickersPreviewRecycler.StickerView.1
                ...
                public void draw(Canvas canvas) {
                    ...
                    if (stickerView4.drawEffect) {
                        if (stickerView4.effectProgress == BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (stickerView6.animateImage && stickerView6.animateImageProgress != 1.0f) {
                        ...
                        if (!stickerView7.animateImage && stickerView7.animateImageProgress != BitmapDescriptorFactory.HUE_RED) {
                            StickerView.access$524(StickerView.this, 0.10666667f);
                            invalidate();
                        }
                    }
                    StickerView stickerView8 = StickerView.this;
                    stickerView8.animateImageProgress = Utilities.clamp(stickerView8.animateImageProgress, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
                    ...
                    if (stickerView9.drawEffect && stickerView9.effectProgress != 1.0f) {
                        ...
                        if (!stickerView10.drawEffect && stickerView10.effectProgress != BitmapDescriptorFactory.HUE_RED) {
                            StickerView.access$424(StickerView.this, 0.10666667f);
                            invalidate();
                        }
                    }
                    StickerView stickerView11 = StickerView.this;
                    stickerView11.effectProgress = Utilities.clamp(stickerView11.effectProgress, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int m104dp = i3 - AndroidUtilities.m104dp(16);
