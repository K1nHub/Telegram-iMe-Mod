...
public class HelloParticles {
    ...
    public static class Drawable {
        ...
        /* renamed from: dt */
        private final float f1905dt = 1000.0f / AndroidUtilities.screenRefreshRate;
        ...
        public Drawable(int i) {
            ...
            this.textPaint.setTextSize(AndroidUtilities.m108dp(this.bitmapScale * 24.0f));
        ...
        private class Particle {
            ...
            /* renamed from: x */
            private float f1909x;

            /* renamed from: y */
            private float f1910y;
            ...
            public void draw(Canvas canvas, int i, long j) {
                ...
                if (!drawable.paused) {
                    ...
                    if (f != 1.0f) {
                        float f2 = f + (drawable.f1905dt / ((float) this.duration));
                        this.inProgress = f2;
                        if (f2 > 1.0f) {
                ...
                if (this.bitmap != null) {
                    ...
                    canvas.translate(this.f1909x - (this.f1908w / 2.0f), this.f1910y - (this.f1906h / 2.0f));
                    canvas.scale(f3, f3, this.f1908w / 2.0f, this.f1906h / 2.0f);
            ...
            public void genPosition(long j, int i, boolean z) {
                ...
                if (staticLayout.getLineCount() <= 0) {
                    ...
                    this.f1907l = (int) this.staticLayout.getLineLeft(0);
                    this.f1908w = (int) this.staticLayout.getLineWidth(0);
                    this.f1906h = this.staticLayout.getHeight();
                }
                Bitmap bitmap = (Bitmap) Drawable.this.bitmaps.get(str);
                this.bitmap = bitmap;
                if (bitmap == null) {
                    this.bitmap = Bitmap.createBitmap(Math.max(1, this.f1908w - Math.max(0, this.f1907l)), Math.max(1, this.f1906h), Bitmap.Config.ARGB_8888);
                    Canvas canvas = new Canvas(this.bitmap);
                    canvas.translate(-this.f1907l, BitmapDescriptorFactory.HUE_RED);
                ...
                if (i % 2 == 0) {
                    f3 = rectF.centerX() - (this.f1908w / 2.0f);
                } else {
                    f2 = (this.f1908w / 2.0f) + rectF.centerX();
                }
                float f4 = f3 - f2;
                ...
                while (i4 < 10) {
                    ...
                    for (int i5 = i2; i5 < Drawable.this.particles.size(); i5++) {
                        ...
                        if (particle.set) {
                            float min = Math.min(Math.abs((particle.f1909x + ((particle.f1908w * (this.scale / Drawable.this.bitmapScale)) * 1.1f)) - abs3), Math.abs(particle.f1909x - abs3));
                            float f7 = particle.f1910y - abs4;
                ...
                this.f1909x = abs;
                this.f1910y = abs2;
                double atan2 = Math.atan2(abs - Drawable.this.rect.centerX(), this.f1910y - Drawable.this.rect.centerY());
                Math.sin(atan2);
                Math.cos(atan2);
