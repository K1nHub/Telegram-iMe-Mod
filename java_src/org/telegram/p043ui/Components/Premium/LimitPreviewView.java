...
public class LimitPreviewView extends LinearLayout {
    ...
    public LimitPreviewView(Context context, int i, int i2, int i3, float f, final Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i != 0) {
            setPadding(0, AndroidUtilities.m104dp(16), 0, 0);
            this.limitIcon = new CounterView(context);
            setIconValue(i2, false);
            this.limitIcon.setPadding(AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(14));
        ...
        FrameLayout frameLayout3 = new FrameLayout(context) { // from class: org.telegram.ui.Components.Premium.LimitPreviewView.1
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), this.grayPaint);
                canvas.save();
                if (!LimitPreviewView.this.isBoostsStyle) {
                ...
                canvas.drawRoundRect(AndroidUtilities.rectTmp, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), mainGradientPaint);
                canvas.restore();
            ...
            protected void onMeasure(int i5, int i6) {
                if (getChildCount() == 2) {
                    ...
                    int max = Math.max(frameLayout.getMeasuredWidth(), AndroidUtilities.m104dp(24) + LimitPreviewView.this.defaultText.getMeasuredWidth() + (LimitPreviewView.this.defaultCount.getVisibility() == 0 ? AndroidUtilities.m104dp(24) + LimitPreviewView.this.defaultCount.getMeasuredWidth() : 0));
                    ...
                    if (LimitPreviewView.this.isBoostsStyle) {
                        if (LimitPreviewView.this.percent != BitmapDescriptorFactory.HUE_RED) {
                            if (LimitPreviewView.this.percent < 1.0f) {
                                float measuredWidth = frameLayout.getMeasuredWidth() - AndroidUtilities.m104dp(8);
                                LimitPreviewView limitPreviewView = LimitPreviewView.this;
                                limitPreviewView.width1 = (int) (measuredWidth + (((size - measuredWidth) - (frameLayout2.getMeasuredWidth() - AndroidUtilities.m104dp(8))) * limitPreviewView.percent));
                        ...
                        int max2 = Math.max(frameLayout2.getMeasuredWidth(), AndroidUtilities.m104dp(24) + LimitPreviewView.this.premiumText.getMeasuredWidth() + (LimitPreviewView.this.premiumCount.getVisibility() == 0 ? AndroidUtilities.m104dp(24) + LimitPreviewView.this.premiumCount.getMeasuredWidth() : 0));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.animateIncrease || (!this.wasAnimation && this.limitIcon != null && this.animationCanPlay && !this.premiumLocked)) {
            ...
            float f4 = m104dp2;
            float max = (Math.max(this.width1, (getMeasuredWidth() - (m104dp2 * 2)) * this.position) + f4) - (this.limitIcon.getMeasuredWidth() / 2.0f);
            if (max < f4) {
                f3 = 0.0f;
            } else {
                f4 = max;
            ...
            final float f5 = f3;
            if (f4 > (getMeasuredWidth() - m104dp2) - this.limitIcon.getMeasuredWidth()) {
                f = (getMeasuredWidth() - m104dp2) - this.limitIcon.getMeasuredWidth();
                f2 = 1.0f;
            } else {
                f = f4;
                f2 = f3;
            ...
            float m104dp3 = (AndroidUtilities.m104dp(14) + ((getMeasuredWidth() - (m104dp * 2)) * 0.5f)) - (this.limitIcon.getMeasuredWidth() / 2.0f);
            ...
            this.limitIcon.setTranslationX(m104dp3);
        } else {
    ...
    public void setPremiumLocked() {
        ...
        this.limitIcon.setPadding(AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(3));
    ...
    public class CounterView extends View {
        ...
        public CounterView(Context context) {
            super(context);
            this.path = new Path();
            this.pathEffect = new CornerPathEffect(AndroidUtilities.m104dp(6));
            this.textPaint = new TextPaint(1);
            this.animatedLayouts = new ArrayList<>();
            this.textPaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
            this.textPaint.setTextSize(AndroidUtilities.m104dp(22));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.textLayout = new StaticLayout(this.text, this.textPaint, ((int) this.textWidth) + AndroidUtilities.m104dp(12), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            setMeasuredDimension((int) (this.textWidth + getPaddingRight() + getPaddingLeft()), AndroidUtilities.m104dp(44) + AndroidUtilities.m104dp(8));
            updatePath();
        }

        private void updatePath() {
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.m104dp(8);
            float measuredWidth = getMeasuredWidth() * this.arrowCenter;
            float clamp = Utilities.clamp(AndroidUtilities.m104dp(8) + measuredWidth, getMeasuredWidth(), (float) BitmapDescriptorFactory.HUE_RED);
            float clamp2 = Utilities.clamp(AndroidUtilities.m104dp(10) + measuredWidth, getMeasuredWidth(), AndroidUtilities.m104dp(24));
            float clamp3 = Utilities.clamp(measuredWidth - AndroidUtilities.m104dp(24), getMeasuredWidth(), (float) BitmapDescriptorFactory.HUE_RED);
            float clamp4 = Utilities.clamp(measuredWidth - AndroidUtilities.m104dp(8), getMeasuredWidth(), (float) BitmapDescriptorFactory.HUE_RED);
            this.path.rewind();
            float f = measuredHeight;
            float f2 = f - (f / 2.0f);
            this.path.moveTo(clamp3, f2 - AndroidUtilities.m104dp(2));
            this.path.lineTo(clamp3, f);
            this.path.lineTo(clamp4, f);
            this.path.lineTo(measuredWidth, measuredHeight + AndroidUtilities.m104dp(8));
            if (this.arrowCenter < 0.7f) {
                this.path.lineTo(clamp, f);
            }
            this.path.lineTo(clamp2, f);
            this.path.lineTo(clamp2, f2 - AndroidUtilities.m104dp(2));
            this.path.close();
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (LimitPreviewView.this.premiumLocked) {
                ...
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m104dp(3), getMeasuredWidth(), measuredHeight - AndroidUtilities.m104dp(3));
            ...
            canvas.save();
            canvas.clipRect(0, 0, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m104dp(8));
            ...
            for (int i = 0; i < this.animatedLayouts.size(); i++) {
                ...
                if (animatedLayout.replace) {
                    canvas.translate(animatedLayout.f1904x + measuredWidth, ((measuredHeight * animatedLayout.progress) + height) - ((1 - animatedLayout.staticLayouts.size()) * measuredHeight));
                    ...
                    canvas.translate(animatedLayout.f1904x + measuredWidth, (height - ((measuredHeight * 10) * animatedLayout.progress)) + ((10 - animatedLayout.staticLayouts.size()) * measuredHeight));
                    for (int i3 = 0; i3 < animatedLayout.staticLayouts.size(); i3++) {
                        canvas.translate(BitmapDescriptorFactory.HUE_RED, measuredHeight);
                        animatedLayout.staticLayouts.get(i3).draw(canvas);
                    }
                } else {
                    canvas.translate(animatedLayout.f1904x + measuredWidth, (((measuredHeight * 10) * animatedLayout.progress) + height) - ((10 - animatedLayout.staticLayouts.size()) * measuredHeight));
        ...
        void createAnimationLayouts() {
            ...
            for (int i2 = 0; i2 < this.text.length(); i2++) {
                if (Character.isDigit(this.text.charAt(i2))) {
                    ...
                    animatedLayout.f1904x = this.textLayout.getSecondaryHorizontal(i2);
            ...
            this.animatedStableLayout = new StaticLayout(spannableStringBuilder, this.textPaint, AndroidUtilities.m104dp(12) + ((int) this.textWidth), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        void createAnimationLayoutsDiff(CharSequence charSequence) {
            ...
            while (length >= 0) {
                ...
                if (charAt != this.text.charAt(length) && Character.isDigit(this.text.charAt(length))) {
                    AnimatedLayout animatedLayout = new AnimatedLayout();
                    this.animatedLayouts.add(animatedLayout);
                    animatedLayout.f1904x = this.textLayout.getSecondaryHorizontal(length);
