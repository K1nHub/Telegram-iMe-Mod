...
public class ImportingAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(m104dp, getThemedColor(i), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
            ...
            rLottieImageView.setBackground(Theme.createCircleDrawable(m104dp2, getThemedColor(i2)));
            this.imageView.setScaleType(ImageView.ScaleType.CENTER);
            this.imageView.setColorFilter(new PorterDuffColorFilter(getThemedColor(i), PorterDuff.Mode.MULTIPLY));
            this.imageView.setAnimation(C3634R.raw.import_check, 26, 26);
    ...
    public ImportingAlert(Context context, String str, ChatActivity chatActivity, Theme.ResourcesProvider resourcesProvider) {
        ...
        int i2 = C3634R.raw.import_finish;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m104dp(120), AndroidUtilities.m104dp(120), false, null);
        this.completedDrawable = rLottieDrawable;
        rLottieDrawable.setAllowDecodeSingleFrame(true);
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        this.imageView = rLottieImageView;
        rLottieImageView.setAutoRepeat(true);
        this.imageView.setAnimation(C3634R.raw.import_loop, 120, 120);
        this.imageView.playAnimation();
        ...
        this.cell.setText(LocaleController.getString("ImportDone", C3634R.string.ImportDone));
        ...
        this.cell.background.setPivotY(AndroidUtilities.m104dp(48));
        ...
        for (int i3 = 0; i3 < 2; i3++) {
            ...
            if (i3 == 0) {
                this.infoTextView[i3].setText(LocaleController.getString("ImportImportingInfo", C3634R.string.ImportImportingInfo));
            } else {
                this.infoTextView[i3].setAlpha(BitmapDescriptorFactory.HUE_RED);
                this.infoTextView[i3].setTranslationY(AndroidUtilities.m104dp(10));
                this.importCountTextView[i3].setAlpha(BitmapDescriptorFactory.HUE_RED);
                this.importCountTextView[i3].setTranslationY(AndroidUtilities.m104dp(10));
            }
        }
        if (this.parentFragment != null) {
            textView.setText(LocaleController.getString("ImportImportingTitle", C3634R.string.ImportImportingTitle));
            ...
            this.importCountTextView[0].setText(LocaleController.formatString("ImportCount", C3634R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.infoTextView[1].setText(LocaleController.getString("ImportDoneInfo", C3634R.string.ImportDoneInfo));
            this.importCountTextView[1].setText(LocaleController.getString("ImportDoneTitle", C3634R.string.ImportDoneTitle));
            this.parentFragment.getNotificationCenter().addObserver(this, NotificationCenter.historyImportProgressChanged);
            return;
        }
        textView.setText(LocaleController.getString("ImportStickersImportingTitle", C3634R.string.ImportStickersImportingTitle));
        ...
        this.importCountTextView[0].setText(LocaleController.formatString("ImportCount", C3634R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.infoTextView[1].setText(LocaleController.getString("ImportStickersDoneInfo", C3634R.string.ImportStickersDoneInfo));
        this.importCountTextView[1].setText(LocaleController.getString("ImportStickersDoneTitle", C3634R.string.ImportStickersDoneTitle));
    ...
    public void setCompleted() {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(this.percentTextView, View.ALPHA, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.percentTextView, View.TRANSLATION_Y, -AndroidUtilities.m104dp(10)), ObjectAnimator.ofFloat(this.infoTextView[0], View.ALPHA, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.infoTextView[0], View.TRANSLATION_Y, -AndroidUtilities.m104dp(10)), ObjectAnimator.ofFloat(this.importCountTextView[0], View.ALPHA, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.importCountTextView[0], View.TRANSLATION_Y, -AndroidUtilities.m104dp(10)), ObjectAnimator.ofFloat(this.infoTextView[1], View.ALPHA, 1.0f), ObjectAnimator.ofFloat(this.infoTextView[1], View.TRANSLATION_Y, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.importCountTextView[1], View.ALPHA, 1.0f), ObjectAnimator.ofFloat(this.importCountTextView[1], View.TRANSLATION_Y, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.lineProgressView, View.ALPHA, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.cell.linearLayout, View.TRANSLATION_Y, AndroidUtilities.m104dp(8), BitmapDescriptorFactory.HUE_RED));
