...
public class ItemOptions {
    ...
    public ItemOptions putPremiumLock(final Runnable runnable) {
        if (runnable != null && this.context != null && this.lastLayout.getItemsCount() > 0) {
            ...
            actionBarMenuSubItem.setRightIcon(C3473R.C3475drawable.msg_mini_lock3);
    ...
    public ItemOptions addView(View view) {
        ...
        view.setTag(C3473R.C3476id.fit_width_tag, 1);
    ...
    public ItemOptions show() {
        ...
        if (this.actionBarPopupWindow == null && getItemsCount() > 0) {
            ...
            if (this.context != null && viewGroup2 != null) {
                ...
                viewGroup2.addView(this.dimView, LayoutHelper.createFrame(-1, -1));
                ...
                if (this.scrimView != null) {
                    if (this.layout.getMeasuredHeight() + f2 + AndroidUtilities.m72dp(16) > AndroidUtilities.displaySize.y) {
