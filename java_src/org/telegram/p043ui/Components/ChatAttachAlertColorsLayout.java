...
public class ChatAttachAlertColorsLayout extends ChatAttachAlert.AttachAlertLayout {
    ...
    public ChatAttachAlertColorsLayout(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.itemSize = AndroidUtilities.m104dp(80);
        this.itemsPerRow = 3;
        RecyclerListView recyclerListView = new RecyclerListView(context, resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.1
            ...
            public boolean onTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() != 0 || motionEvent.getY() >= ChatAttachAlertColorsLayout.this.parentAlert.scrollOffsetY[0] - AndroidUtilities.m104dp(80)) {
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.3.1
                    ...
                    public int calculateDyToMakeVisible(View view, int i2) {
                        return super.calculateDyToMakeVisible(view, i2) - (ChatAttachAlertColorsLayout.this.gridView.getPaddingTop() - AndroidUtilities.m104dp(7));
                    }
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.4
            ...
            public int getSpanSize(int i) {
                return ChatAttachAlertColorsLayout.this.itemSize + (i % ChatAttachAlertColorsLayout.this.itemsPerRow != ChatAttachAlertColorsLayout.this.itemsPerRow + (-1) ? AndroidUtilities.m104dp(5) : 0);
            }
        });
    ...
    public int getFirstOffset() {
        return getListTopPadding() + AndroidUtilities.m104dp(56);
    }
    ...
    */
    public void onPreMeasure(int r7, int r8) {
        ...
        L40:
            ...
            int r1 = r1 * r7
            r2 = 5
            int r3 = org.telegram.messenger.AndroidUtilities.m104dp(r2)
        ...
        L9a:
            r8 = 52
            int r8 = org.telegram.messenger.AndroidUtilities.m104dp(r8)
            int r7 = r7 - r8
            if (r7 >= 0) goto La4
            goto La5
        La4:
        ...
        La5:
            ...
            org.telegram.ui.Components.RecyclerListView r7 = r6.gridView
            r8 = 6
            int r1 = org.telegram.messenger.AndroidUtilities.m104dp(r8)
            int r8 = org.telegram.messenger.AndroidUtilities.m104dp(r8)
            r2 = 48
