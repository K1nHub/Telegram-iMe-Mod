...
public class PhotoEditorSeekBar extends View {
    ...
    public PhotoEditorSeekBar(Context context) {
        ...
        this.thumbSize = AndroidUtilities.m104dp(16);
        this.thumbDX = 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(i / 2, (getMeasuredHeight() / 2) - AndroidUtilities.m104dp(1), getMeasuredWidth() - (this.thumbSize / 2), (getMeasuredHeight() / 2) + AndroidUtilities.m104dp(1), this.innerPaint);
        if (this.minValue == 0) {
            canvas.drawRect(this.thumbSize / 2, (getMeasuredHeight() / 2) - AndroidUtilities.m104dp(1), i2, (getMeasuredHeight() / 2) + AndroidUtilities.m104dp(1), this.outerPaint);
        } else if (this.progress > 0.5f) {
            canvas.drawRect((getMeasuredWidth() / 2) - AndroidUtilities.m104dp(1), (getMeasuredHeight() - this.thumbSize) / 2, getMeasuredWidth() / 2, (getMeasuredHeight() + this.thumbSize) / 2, this.outerPaint);
            canvas.drawRect(getMeasuredWidth() / 2, (getMeasuredHeight() / 2) - AndroidUtilities.m104dp(1), i2, (getMeasuredHeight() / 2) + AndroidUtilities.m104dp(1), this.outerPaint);
        } else {
            canvas.drawRect(getMeasuredWidth() / 2, (getMeasuredHeight() - this.thumbSize) / 2, (getMeasuredWidth() / 2) + AndroidUtilities.m104dp(1), (getMeasuredHeight() + this.thumbSize) / 2, this.outerPaint);
            canvas.drawRect(i2, (getMeasuredHeight() / 2) - AndroidUtilities.m104dp(1), getMeasuredWidth() / 2, (getMeasuredHeight() / 2) + AndroidUtilities.m104dp(1), this.outerPaint);
        }
