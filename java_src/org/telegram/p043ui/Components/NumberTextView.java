...
public class NumberTextView extends View {
    ...
    */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float m107dp = this.addNumber ? AndroidUtilities.m107dp(4) : height;
        if (this.center) {
        ...
        while (i < max) {
            ...
            if (f3 > BitmapDescriptorFactory.HUE_RED) {
                if (staticLayout != null) {
                    ...
                    canvas.save();
                    canvas.translate(f2, (this.progress - 1.0f) * m107dp);
                    staticLayout.draw(canvas);
                    canvas.restore();
                    if (staticLayout2 != null) {
                        this.textPaint.setAlpha((int) ((1.0f - this.progress) * 255.0f));
                        canvas.translate(BitmapDescriptorFactory.HUE_RED, this.progress * m107dp);
                    }
                } else {
            ...
            canvas.restore();
            canvas.translate(staticLayout2 != null ? staticLayout2.getLineWidth(0) : staticLayout.getLineWidth(0) + AndroidUtilities.m107dp(1), BitmapDescriptorFactory.HUE_RED);
