...
public class AutoDeletePopupWrapper {
    ...
    public AutoDeletePopupWrapper(final Context context, final PopupSwipeBackLayout popupSwipeBackLayout, final Callback callback, boolean z, final int i, final Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i != 1) {
            ...
            this.textView.setPadding(AndroidUtilities.m107dp(13), 0, AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(8));
    ...
    public void allowExtendedHint(int i) {
        ...
        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceSingleLink(LocaleController.getString(C3632R.string.AutoDeletePopupDescription2), i, new Runnable() { // from class: org.telegram.ui.Components.AutoDeletePopupWrapper$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
