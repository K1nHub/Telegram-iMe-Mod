    ...
    public void update(boolean z) {
        ...
        if (TextUtils.isEmpty(this.searchQuery) || isEmptyDownloads()) {
            ...
            if (this.rowCount == 0) {
                ...
                this.emptyView.title.setText(LocaleController.getString("SearchEmptyViewDownloads", C3473R.string.SearchEmptyViewDownloads));
        ...
        if (z) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.telegram.ui.Components.SearchDownloadsContainer.3
                ...
                public boolean areItemsTheSame(int i8, int i9) {
                    ...
                    return (messageObject2 == null || messageObject == null || messageObject2.getDocument() == null || messageObject.getDocument() == null || messageObject2.getDocument().f1530id != messageObject.getDocument().f1530id) ? false : true;
                }
