...
public class AnimatedFloat {
    ...
    public float set(float f, boolean z) {
        ...
        if (this.transition) {
            ...
            float clamp = MathUtils.clamp(((float) ((elapsedRealtime - this.transitionStart) - this.transitionDelay)) / ((float) this.transitionDuration), (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    public float getTransitionProgress() {
        return !this.transition ? BitmapDescriptorFactory.HUE_RED : MathUtils.clamp(((float) ((SystemClock.elapsedRealtime() - this.transitionStart) - this.transitionDelay)) / ((float) this.transitionDuration), (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
    }
