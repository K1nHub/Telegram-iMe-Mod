...
public class PullForegroundDrawable {
    ...
    public void draw(Canvas canvas, boolean z) {
        ...
        int m107dp = AndroidUtilities.m107dp(z2 ? 15 : 28);
        int m107dp2 = AndroidUtilities.m107dp(8);
        int m107dp3 = AndroidUtilities.m107dp(9);
        int m107dp4 = AndroidUtilities.m107dp(18);
        ...
        checkTextLayouts((this.cell.getWidth() - (m107dp * 4)) - AndroidUtilities.m107dp(16));
        ...
        int i8 = m107dp + m107dp3;
        int measuredHeight = (this.cell.getMeasuredHeight() - m107dp2) - m107dp3;
        if (z) {
            measuredHeight += viewOffset;
        }
        int i9 = m107dp4 + (m107dp2 * 2);
        if (height > i9) {
            i = m107dp3;
            f = 1.0f;
        } else {
        ...
        if (z) {
            ...
            i4 = m107dp2;
            i3 = viewOffset;
            canvas.clipRect(0, -AndroidUtilities.m107dp(4), this.listView.getMeasuredWidth(), viewOffset + 1);
        } else {
            i2 = m107dp4;
            i3 = viewOffset;
            i4 = m107dp2;
        ...
        if (height > i9) {
            ...
            if (z) {
                i6 = i4;
                this.rectF.set(m107dp, i6, m107dp + i2, i6 + i3 + i);
            } else {
                i6 = i4;
                this.rectF.set(m107dp, ((this.cell.getHeight() - height) + i6) - i3, m107dp + i2, this.cell.getHeight() - i6);
            }
            i5 = i;
            float f23 = i5;
        ...
        if (z2) {
            measuredHeight = (int) (measuredHeight - ((this.cell.getMeasuredHeight() - AndroidUtilities.m107dp(41)) * this.outProgress));
        }
        ...
        float height2 = (this.cell.getHeight() - (i9 / 2.0f)) + AndroidUtilities.m107dp(6);
        float width2 = (this.cell.getWidth() + (z2 ? m107dp * 2 : 0)) / 2.0f;
        if (this.pullTooltipLayout != null) {
            ...
            if (f29 > BitmapDescriptorFactory.HUE_RED && f29 < 1.0f) {
                ...
                canvas.scale(f30, f30, width2, (AndroidUtilities.m107dp(16) * (1.0f - this.textSwappingProgress)) + height2);
            }
            i7 = i8;
            f5 = f3;
            ...
            canvas.translate((width2 - this.pullTooltipLayoutLeft) - (this.pullTooltipLayoutWidth / 2.0f), ((AndroidUtilities.m107dp(8) * (1.0f - this.textSwappingProgress)) + height2) - this.pullTooltipLayout.getHeight());
        ...
        if (this.releaseTooltipLayout != null) {
            ...
            if (f33 > BitmapDescriptorFactory.HUE_RED && f33 < 1.0f) {
                ...
                canvas.scale(f34, f34, width2, height2 - (AndroidUtilities.m107dp(8) * this.textSwappingProgress));
            }
            ...
            canvas.translate((width2 - this.releaseTooltipLayoutLeft) - (this.releaseTooltipLayoutWidth / 2.0f), (height2 + (AndroidUtilities.m107dp(8) * this.textSwappingProgress)) - this.releaseTooltipLayout.getHeight());
        ...
        float m107dp5 = AndroidUtilities.m107dp(24) / f37;
        float f38 = this.outProgress;
        float f39 = m107dp5 + ((1.0f - m107dp5) * f38) + f2;
        float f40 = f5;
    ...
    public class ArrowDrawable extends Drawable {
        ...
        private void updatePath() {
            ...
            this.path.lineTo(m107dp - AndroidUtilities.dpf2(4.95f), AndroidUtilities.dpf2(9.0f));
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawRect(AndroidUtilities.dpf2(7.56f), AndroidUtilities.dpf2(8.0f), AndroidUtilities.m107dp(18) - AndroidUtilities.dpf2(7.56f), AndroidUtilities.dpf2(11.1f), this.paint);
            canvas.restore();
        }
    }
}
