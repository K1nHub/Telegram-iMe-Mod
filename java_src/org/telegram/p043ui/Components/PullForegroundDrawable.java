...
public class PullForegroundDrawable {
    ...
    public PullForegroundDrawable(CharSequence charSequence, CharSequence charSequence2) {
        ...
        try {
            this.generalTopicDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(C3417R.C3419drawable.msg_filled_general).mutate();
    ...
    public void draw(Canvas canvas, boolean z) {
        ...
        if (f25 == BitmapDescriptorFactory.HUE_RED || z2) {
            ...
            canvas.translate(BitmapDescriptorFactory.HUE_RED, (AndroidUtilities.dpf2(1.0f) * 1.0f) - f29);
        ...
        float f40 = f37 / 2.0f;
        Theme.dialogs_archiveAvatarDrawable.setBounds((int) (f32 - f40), (int) (f10 - f40), (int) (f32 + f40), (int) (f10 + f40));
