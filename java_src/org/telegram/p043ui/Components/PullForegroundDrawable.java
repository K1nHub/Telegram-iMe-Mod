...
/* renamed from: org.telegram.ui.Components.PullForegroundDrawable */
...
public class PullForegroundDrawable {
    ...
    public PullForegroundDrawable(CharSequence charSequence, CharSequence charSequence2) {
        ...
        try {
            this.generalTopicDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(C3634R.C3636drawable.msg_filled_general).mutate();
    ...
    private void checkTextLayouts(int i) {
        if (i != this.lastWidth) {
            ...
            this.pullTooltipLayout = new StaticLayout(this.pullTooltipText, this.tooltipTextPaint, ceil, Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            ...
            this.releaseTooltipLayout = new StaticLayout(this.releaseTooltipText, this.tooltipTextPaint, ceil2, Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
    ...
    public void draw(Canvas canvas, boolean z) {
        ...
        int m104dp = AndroidUtilities.m104dp(z2 ? 15 : 28);
        int m104dp2 = AndroidUtilities.m104dp(8);
        int m104dp3 = AndroidUtilities.m104dp(9);
        int m104dp4 = AndroidUtilities.m104dp(18);
        ...
        checkTextLayouts((this.cell.getWidth() - (m104dp * 4)) - AndroidUtilities.m104dp(16));
        ...
        int i8 = m104dp + m104dp3;
        int measuredHeight = (this.cell.getMeasuredHeight() - m104dp2) - m104dp3;
        if (z) {
            measuredHeight += viewOffset;
        }
        int i9 = m104dp4 + (m104dp2 * 2);
        if (height > i9) {
            i = m104dp3;
            f = 1.0f;
        } else {
        ...
        if (z) {
            ...
            i4 = m104dp2;
            i3 = viewOffset;
            canvas.clipRect(0, -AndroidUtilities.m104dp(4), this.listView.getMeasuredWidth(), viewOffset + 1);
        } else {
            i2 = m104dp4;
            i3 = viewOffset;
            i4 = m104dp2;
        ...
        if (height > i9) {
            ...
            if (z) {
                i6 = i4;
                this.rectF.set(m104dp, i6, m104dp + i2, i6 + i3 + i);
            } else {
                i6 = i4;
                this.rectF.set(m104dp, ((this.cell.getHeight() - height) + i6) - i3, m104dp + i2, this.cell.getHeight() - i6);
            }
            i5 = i;
            float f23 = i5;
        ...
        if (z2) {
            measuredHeight = (int) (measuredHeight - ((this.cell.getMeasuredHeight() - AndroidUtilities.m104dp(41)) * this.outProgress));
        }
        ...
        float height2 = (this.cell.getHeight() - (i9 / 2.0f)) + AndroidUtilities.m104dp(6);
        float width2 = (this.cell.getWidth() + (z2 ? m104dp * 2 : 0)) / 2.0f;
        if (this.pullTooltipLayout != null) {
            ...
            if (f29 > BitmapDescriptorFactory.HUE_RED && f29 < 1.0f) {
                ...
                canvas.scale(f30, f30, width2, (AndroidUtilities.m104dp(16) * (1.0f - this.textSwappingProgress)) + height2);
            }
            i7 = i8;
            f5 = f3;
            ...
            canvas.translate((width2 - this.pullTooltipLayoutLeft) - (this.pullTooltipLayoutWidth / 2.0f), ((AndroidUtilities.m104dp(8) * (1.0f - this.textSwappingProgress)) + height2) - this.pullTooltipLayout.getHeight());
        ...
        if (this.releaseTooltipLayout != null) {
            ...
            if (f33 > BitmapDescriptorFactory.HUE_RED && f33 < 1.0f) {
                ...
                canvas.scale(f34, f34, width2, height2 - (AndroidUtilities.m104dp(8) * this.textSwappingProgress));
            }
            ...
            canvas.translate((width2 - this.releaseTooltipLayoutLeft) - (this.releaseTooltipLayoutWidth / 2.0f), (height2 + (AndroidUtilities.m104dp(8) * this.textSwappingProgress)) - this.releaseTooltipLayout.getHeight());
        ...
        float m104dp5 = AndroidUtilities.m104dp(24) / f37;
        float f38 = this.outProgress;
        float f39 = m104dp5 + ((1.0f - m104dp5) * f38) + f2;
        float f40 = f5;
        canvas.translate((i7 - f40) * (1.0f - f38), (((this.cell.getHeight() - i6) - i5) - f4) * (1.0f - f38));
        float f41 = f4;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.PullForegroundDrawable$ArrowDrawable */
    /* loaded from: classes6.dex */
    public class ArrowDrawable extends Drawable {
        ...
        private void updatePath() {
            ...
            this.path.lineTo(m104dp - AndroidUtilities.dpf2(4.95f), AndroidUtilities.dpf2(9.0f));
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawRect(AndroidUtilities.dpf2(7.56f), AndroidUtilities.dpf2(8.0f), AndroidUtilities.m104dp(18) - AndroidUtilities.dpf2(7.56f), AndroidUtilities.dpf2(11.1f), this.paint);
            canvas.restore();
        }
    }
}
