...
public class SharedMediaLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setMembersMenuVisible(boolean z, GroupMembersFilter groupMembersFilter) {
        ...
        if (z) {
            ...
            Drawable mutate = ContextCompat.getDrawable(context, groupMembersFilter == groupMembersFilter2 ? C3473R.C3475drawable.ic_ab_other : C3473R.C3475drawable.msg_delete).mutate();
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (viewHolder.getItemViewType() == IdFabric$ViewTypes.TEXT_INFO_PRIVACY_CELL) {
                ...
                if (i == this.enableSectionRow && this.storiesController.isEnabled()) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.context, C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGray));
                    textInfoPrivacyCell.setFixedSize(12);
                    textInfoPrivacyCell.setText(null);
                    return;
                }
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.context, C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGray));
                textInfoPrivacyCell.setFixedSize(0);
                textInfoPrivacyCell.setText(LocaleController.getInternalString(C3473R.string.settings_stories_enable_hint));
            } else if (viewHolder.getItemViewType() == IdFabric$ViewTypes.TEXT_CELL) {
                ((TextCell) viewHolder.itemView).setText(LocaleController.getString("Notifications", C3473R.string.Notifications), isNeedDivider);
            } else if (viewHolder.getItemViewType() == IdFabric$ViewTypes.TEXT_CHECK_CELL) {
                TextCheckCell textCheckCell = (TextCheckCell) viewHolder.itemView;
                if (i == this.enableRow) {
                    textCheckCell.setType(1);
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3473R.string.settings_stories_enable), this.storiesController.isEnabled(), isNeedDivider);
                    return;
                }
                textCheckCell.setType(0);
                if (i == this.storiesBarRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3473R.string.settings_stories_bar), this.storiesController.isBarEnabled(), isNeedDivider);
                } else if (i == this.storiesAvatarsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3473R.string.settings_stories_avatars), this.storiesController.isAvatarsEnabled(), isNeedDivider);
                } else if (i == this.storiesProfileAvatarsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3473R.string.settings_stories_profile_avatar), this.storiesController.isProfileAvatarEnabled(), isNeedDivider);
                }
            }
        }
    ...
    public static class SharedMediaData {
        ...
        public void replaceMid(int i, int i2) {
            ...
            if (messageObject != null) {
                ...
                messageObject.messageOwner.f1546id = i2;
    ...
    public SharedMediaLayout(Context context, long j, SharedMediaPreloader sharedMediaPreloader, int i, ArrayList<Integer> arrayList, TLRPC$ChatFull tLRPC$ChatFull, TLRPC$UserFull tLRPC$UserFull, boolean z, BaseFragment baseFragment, Delegate delegate, int i2, Theme.ResourcesProvider resourcesProvider) {
            ...
            */
            public org.telegram.p043ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r17, org.telegram.tgnet.TLRPC$FileLocation r18, int r19, boolean r20) {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.SharedMediaLayout.C53721.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
        };
        this.shiftDp = -5.0f;
        this.sharedMediaData = new SharedMediaData[6];
        ...
        this.sharedLinkCellDelegate = new C540235();
        if (sharedMediaPreloader.isMusicType()) {
            TLRPC$Chat chat = baseFragment.getMessagesController().getChat(Long.valueOf(-j));
            c = 6;
            r4 = 1;
            ArrayList<MessageObject> loadPinnedMessages = baseFragment.getMediaDataController().loadPinnedMessages(j, ChatObject.isChannel(chat) ? chat.f1522id : 0L, baseFragment.getMusicController().getPlaylistForDialog(j), false, true, true);
        ...
        Drawable drawable = context.getResources().getDrawable(C3473R.C3475drawable.photos_header_shadow);
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = createMenu.addItem(0, C3473R.C3475drawable.ic_ab_search).setIsSearchField(r4).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.Components.SharedMediaLayout.4
        ...
        Drawable mutate = ContextCompat.getDrawable(context, C3473R.C3475drawable.fork_filter_members).mutate();
        ...
        imageView3.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
        this.photoVideoOptionsItem.setTranslationY(AndroidUtilities.m72dp(10));
        this.photoVideoOptionsItem.setVisibility(4);
        Drawable mutate2 = ContextCompat.getDrawable(context, C3473R.C3475drawable.ic_ab_other).mutate();
        ...
        this.photoVideoOptionsItem.setOnClickListener(new View$OnClickListenerC54056(context, resourcesProvider));
        ...
        this.closeButton.setContentDescription(LocaleController.getString("Close", C3473R.string.Close));
        ...
        if (this.sharedMediaPreloader.isMusicType()) {
            r14 = 1;
            ActionBarMenuItem actionBarMenuItem2 = new ActionBarMenuItem(context, (ActionBarMenu) null, Theme.getColor(i12), Theme.getColor(Theme.key_windowBackgroundWhiteGrayText2), false);
            this.addToPlaylistItem = actionBarMenuItem2;
            actionBarMenuItem2.setIcon(C3473R.C3475drawable.msg_tone_add);
        ...
        if (!DialogObject.isEncryptedDialog(this.dialog_id)) {
            ...
            actionBarMenuItem3.setIcon(C3473R.C3475drawable.msg_message);
            this.gotoItem.setContentDescription(LocaleController.getString("AccDescrGoToMessage", C3473R.string.AccDescrGoToMessage));
            ...
            actionBarMenuItem4.setIcon(C3473R.C3475drawable.fork_forward_cloud);
            this.forwardCloudItem.setContentDescription(LocaleController.getInternalString(C3473R.string.chat_message_popup_option_forward_cloud));
            ...
            actionBarMenuItem5.setIcon(C3473R.C3475drawable.msg_forward);
            this.forwardItem.setContentDescription(LocaleController.getString("Forward", C3473R.string.Forward));
        ...
        actionBarMenuItem6.setIcon(C3473R.C3475drawable.msg_delete);
        this.deleteItem.setContentDescription(LocaleController.getString("Delete", C3473R.string.Delete));
        ...
        this.documentsAdapter = new SharedDocumentsAdapter(context, r14);
        ...
        this.documentsSearchAdapter = new MediaSearchAdapter(context, r14);
        ...
        this.archivedStoriesAdapter = new StoriesAdapter(context, r14) { // from class: org.telegram.ui.Components.SharedMediaLayout.9
            @Override // org.telegram.p043ui.Components.SharedMediaLayout.StoriesAdapter, androidx.recyclerview.widget.RecyclerView.Adapter
            public void notifyDataSetChanged() {
                super.notifyDataSetChanged();
        ...
        this.animationSupportingArchivedStoriesAdapter = new StoriesAdapter(context, r14);
        ...
        while (true) {
            ...
            if (i14 == 0 && mediaPageArr[i14] != null && mediaPageArr[i14].layoutManager != null) {
                i16 = this.mediaPages[i14].layoutManager.findFirstVisibleItemPosition();
                if (i16 == this.mediaPages[i14].layoutManager.getItemCount() - r14 || (holder = (RecyclerListView.Holder) this.mediaPages[i14].listView.findViewHolderForAdapterPosition(i16)) == null) {
                    i16 = -1;
                } else {
                ...
                */
                public void setTranslationX(float r9) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.SharedMediaLayout.C537310.setTranslationX(float):void");
                }
            };
            ...
            final ExtendedGridLayoutManager extendedGridLayoutManager = mediaPageArr2[i14].layoutManager = new ExtendedGridLayoutManager(context, 100) { // from class: org.telegram.ui.Components.SharedMediaLayout.11
                ...
                protected Size getSizeForItem(int i17) {
                    ...
                    if (document != null) {
                        ...
                        if (closestPhotoSizeWithSize != null && (i18 = closestPhotoSizeWithSize.f1554w) != 0 && (i19 = closestPhotoSizeWithSize.f1553h) != 0) {
            ...
            extendedGridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Components.SharedMediaLayout.12
                ...
                public int getSpanSize(int i17) {
                    int i18 = SharedMediaLayout.this.mediaColumnsCount[(mediaPage.selectedType == 8 || mediaPage.selectedType == 9) ? (char) 1 : (char) 0];
            ...
            this.mediaPages[i14].listView = new InternalListView(context) { // from class: org.telegram.ui.Components.SharedMediaLayout.13
                ...
                */
                protected void dispatchDraw(android.graphics.Canvas r32) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.SharedMediaLayout.C537613.dispatchDraw(android.graphics.Canvas):void");
                }
            ...
            this.mediaPages[i14].listView.setFastScrollEnabled(r14);
            this.mediaPages[i14].listView.setScrollingTouchSlop(r14);
            this.mediaPages[i14].listView.setPinnedSectionOffsetY(-AndroidUtilities.m72dp(2));
            this.mediaPages[i14].listView.setPadding(0, AndroidUtilities.m72dp(2), 0, 0);
            ...
            mediaPageArr3[i14].addView(mediaPageArr3[i14].listView, LayoutHelper.createFrame(-1, -1));
            this.mediaPages[i14].animationSupportingListView = new InternalListView(context);
            this.mediaPages[i14].animationSupportingListView.setLayoutManager(this.mediaPages[i14].animationSupportingLayoutManager = new GridLayoutManager(context, 3) { // from class: org.telegram.ui.Components.SharedMediaLayout.14
            ...
            mediaPageArr4[i14].addView(mediaPageArr4[i14].animationSupportingListView, LayoutHelper.createFrame(-1, -1));
            this.mediaPages[i14].animationSupportingListView.setVisibility(8);
            this.mediaPages[i14].animationSupportingListView.addItemDecoration(new RecyclerView.ItemDecoration(this) { // from class: org.telegram.ui.Components.SharedMediaLayout.15
            ...
            this.mediaPages[i14].listView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.SharedMediaLayout.16
                @Override // androidx.recyclerview.widget.RecyclerView.ItemDecoration
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    if (mediaPage.listView.getAdapter() == SharedMediaLayout.this.gifAdapter) {
            ...
            this.mediaPages[i14].listView.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda22
                ...
                public final void onItemClick(View view, int i17, float f, float f2) {
                    SharedMediaLayout.this.lambda$new$11(mediaPage, view, i17, f, f2);
                }
            });
            this.mediaPages[i14].listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SharedMediaLayout.17
                ...
                public void onScrolled(RecyclerView recyclerView, int i17, int i18) {
                    ...
                    if (i18 != 0 && (mediaPage.selectedType == 0 || mediaPage.selectedType == 8 || mediaPage.selectedType == 9)) {
            ...
            this.mediaPages[i14].listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda23
                ...
                public final boolean onItemClick(View view, int i17) {
                    ...
                    lambda$new$12 = SharedMediaLayout.this.lambda$new$12(mediaPage, view, i17);
                    return lambda$new$12;
                }
            });
            if (i14 == 0 && i16 != -1) {
                extendedGridLayoutManager.scrollToPositionWithOffset(i16, i15);
            }
            final InternalListView internalListView = this.mediaPages[i14].listView;
            this.mediaPages[i14].animatingImageView = new ClippingImageView(this, context) { // from class: org.telegram.ui.Components.SharedMediaLayout.18
                @Override // android.view.View
            ...
            this.mediaPages[i14].listView.addOverlayView(this.mediaPages[i14].animatingImageView, LayoutHelper.createFrame(-1, -1));
            this.mediaPages[i14].progressView = new FlickerLoadingView(context) { // from class: org.telegram.ui.Components.SharedMediaLayout.19
            ...
            mediaPageArr5[i14].emptyView = new StickerEmptyView(context, mediaPageArr5[i14].progressView, r14);
            this.mediaPages[i14].emptyView.setVisibility(8);
            this.mediaPages[i14].emptyView.setAnimateLayoutChange(r14);
            MediaPage[] mediaPageArr6 = this.mediaPages;
            mediaPageArr6[i14].addView(mediaPageArr6[i14].emptyView, LayoutHelper.createFrame(-1, -1));
            this.mediaPages[i14].emptyView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda9
            ...
            this.mediaPages[i14].emptyView.showProgress(r14, false);
            this.mediaPages[i14].emptyView.title.setText(LocaleController.getString("NoResult", C3473R.string.NoResult));
            this.mediaPages[i14].emptyView.subtitle.setText(LocaleController.getString("SearchEmptyViewFilteredSubtitle2", C3473R.string.SearchEmptyViewFilteredSubtitle2));
            this.mediaPages[i14].emptyView.addView(this.mediaPages[i14].progressView, LayoutHelper.createFrame(-1, -1));
            this.mediaPages[i14].listView.setEmptyView(this.mediaPages[i14].emptyView);
            this.mediaPages[i14].listView.setAnimateEmptyView(r14, 0);
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(i3, (int) r14);
    ...
    /* loaded from: classes7.dex */
    public class View$OnClickListenerC54056 implements View.OnClickListener {
        final /* synthetic */ Context val$context;
        final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;

        View$OnClickListenerC54056(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onClick(View view) {
            ...
            SharedMediaLayout.this.mediaZoomInItem.setTextAndIcon(LocaleController.getString("MediaZoomIn", C3473R.string.MediaZoomIn), C3473R.C3475drawable.msg_zoomin);
            SharedMediaLayout.this.mediaZoomInItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda1
                ...
                public final void onClick(View view2) {
                    SharedMediaLayout.View$OnClickListenerC54056.this.lambda$onClick$0(view2);
                }
            });
            actionBarPopupWindowLayout.addView(SharedMediaLayout.this.mediaZoomInItem);
            SharedMediaLayout.this.mediaZoomOutItem.setTextAndIcon(LocaleController.getString("MediaZoomOut", C3473R.string.MediaZoomOut), C3473R.C3475drawable.msg_zoomout);
            SharedMediaLayout.this.mediaZoomOutItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    SharedMediaLayout.View$OnClickListenerC54056.this.lambda$onClick$1(view2);
                }
            });
            ...
            if (!DialogObject.isEncryptedDialog(SharedMediaLayout.this.dialog_id)) {
                ...
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Calendar", C3473R.string.Calendar), C3473R.C3475drawable.msg_calendar2);
                ...
                if (z2) {
                    ...
                    actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("MediaShowPhotos", C3473R.string.MediaShowPhotos), 0);
                    actionBarPopupWindowLayout.addView(actionBarMenuSubItem2);
                    actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("MediaShowVideos", C3473R.string.MediaShowVideos), 0);
                    ...
                    if (c != 0) {
                        ...
                        actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda2
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view2) {
                                SharedMediaLayout.View$OnClickListenerC54056.this.lambda$onClick$2(actionBarMenuSubItem3, actionBarMenuSubItem2, storiesAdapter, view2);
                            }
                        });
                        actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$6$$ExternalSyntheticLambda3
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view2) {
                                SharedMediaLayout.View$OnClickListenerC54056.this.lambda$onClick$3(actionBarMenuSubItem2, actionBarMenuSubItem3, storiesAdapter, view2);
                            }
                        });
                    } else {
    ...
    public /* synthetic */ void lambda$new$11(MediaPage mediaPage, View view, int i, float f, float f2) {
        ...
        if (mediaPage.selectedType != 10) {
            if (mediaPage.selectedType != 7) {
                ...
                bundle.putLong("chat_id", chat.f1522id);
    ...
    */
            ...
            */
            public void onPageScrolled(float r11) {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.SharedMediaLayout.C539127.onPageScrolled(float):void");
            }
        });
            ...
            if (mediaPage.selectedType == 7) {
                ...
                if (mediaPage.selectedType != 9) {
                    if (mediaPage.selectedType != 6) {
                        ...
                        commonGroupsAdapter.getChats(((TLRPC$Chat) commonGroupsAdapter.chats.get(this.commonGroupsAdapter.chats.size() - 1)).f1522id, 100);
                        return;
                    }
                }
    ...
    public void onActionBarItemClick(View view, int i) {
        ...
        if (i == IdFabric$Menu.TOGGLE_MUSIC_PLAYLIST) {
            ...
            if (this.info != null) {
                TLRPC$Chat chat2 = this.profileActivity.getMessagesController().getChat(Long.valueOf(this.info.f1523id));
                if (this.profileActivity.getMessagesController().isChatNoForwards(chat2)) {
                    HintView hintView = this.fwdRestrictedHint;
                    if (hintView != null) {
                        hintView.setText((!ChatObject.isChannel(chat2) || chat2.megagroup) ? LocaleController.getString("ForwardsRestrictedInfoGroup", C3473R.string.ForwardsRestrictedInfoGroup) : LocaleController.getString("ForwardsRestrictedInfoChannel", C3473R.string.ForwardsRestrictedInfoChannel));
            ...
            if (hasNoforwardsMessage()) {
                ...
                if (hintView2 != null) {
                    hintView2.setText(LocaleController.getString("ForwardsRestrictedInfoBot", C3473R.string.ForwardsRestrictedInfoBot));
                    this.fwdRestrictedHint.showForView(view, true);
                }
    ...
    */
    ...
    public void animateItemsEnter(RecyclerListView recyclerListView, int i, SparseBooleanArray sparseBooleanArray) {
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC539732(recyclerListView, sparseBooleanArray, view, i));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Components.SharedMediaLayout$32 */
    /* loaded from: classes7.dex */
    public class ViewTreeObserver$OnPreDrawListenerC539732 implements ViewTreeObserver.OnPreDrawListener {
        ...
        ViewTreeObserver$OnPreDrawListenerC539732(RecyclerListView recyclerListView, SparseBooleanArray sparseBooleanArray, View view, int i) {
                    ...
                    for (int i = 0; i < childCount; i++) {
                        ...
                        if (messageId != 0 && this.val$addedMesages.get(messageId, false)) {
                            ...
                            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$32$$ExternalSyntheticLambda0
                                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    SharedMediaLayout.ViewTreeObserver$OnPreDrawListenerC539732.this.lambda$onPreDraw$0(messageId, recyclerListView, valueAnimator);
                                }
                            });
                            ofFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SharedMediaLayout.32.1
                                ...
                                public void onAnimationEnd(Animator animator) {
                                    ...
                                    ViewTreeObserver$OnPreDrawListenerC539732.this.val$finalListView.invalidate();
                                }
                            });
                    ...
                    if (view != null && view.getParent() == null) {
                        ...
                        if (layoutManager != null) {
                            ...
                            ofFloat3.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SharedMediaLayout.32.2
                                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                                public void onAnimationEnd(Animator animator) {
                                    ViewTreeObserver$OnPreDrawListenerC539732.this.val$finalProgressView.setAlpha(1.0f);
                                    layoutManager.stopIgnoringView(ViewTreeObserver$OnPreDrawListenerC539732.this.val$finalProgressView);
                                    ViewTreeObserver$OnPreDrawListenerC539732 viewTreeObserver$OnPreDrawListenerC539732 = ViewTreeObserver$OnPreDrawListenerC539732.this;
                                    viewTreeObserver$OnPreDrawListenerC539732.val$finalListView.removeView(viewTreeObserver$OnPreDrawListenerC539732.val$finalProgressView);
                                }
                            });
                            ofFloat3.start();
                        }
    ...
    */
    ...
    private boolean onItemLongClick(MessageObject messageObject, View view, int i) {
        ...
        if (this.addToPlaylistItem != null) {
            if (this.mediaPages[0].selectedType == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
                ...
                this.addToPlaylistItem.setIcon(this.cantAddToPlaylistCount == 0 ? C3473R.C3475drawable.msg_tone_add : C3473R.C3475drawable.msg_tone_off);
    ...
    private void onItemClick(int i, View view, MessageObject messageObject, int i2, int i3) {
        ...
        if (this.isActionModeShowed) {
            ...
            this.profileActivity.getOrCreateStoryViewer().open(getContext(), messageObject.getId(), storiesList, StoriesListPlaceProvider.m24of(this.mediaPages[i2].listView).with(new StoriesListPlaceProvider.LoadNextInterface() { // from class: org.telegram.ui.Components.SharedMediaLayout$$ExternalSyntheticLambda25
    ...
    /* loaded from: classes7.dex */
    public class C540235 implements SharedLinkCell.SharedLinkCellDelegate {
        C540235() {
        }
        ...
        public void onLinkPress(final String str, boolean z) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3473R.string.Open), LocaleController.getString("Copy", C3473R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.SharedMediaLayout$35$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    SharedMediaLayout.C540235.this.lambda$onLinkPress$0(str, dialogInterface, i);
                }
            });
    ...
    public static View createEmptyStubView(Context context, int i, long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoMediaSecret", C3473R.string.NoMediaSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoMedia", C3473R.string.NoMedia));
            }
        } else if (i == 1) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedFilesSecret", C3473R.string.NoSharedFilesSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedFiles", C3473R.string.NoSharedFiles));
            }
        } else if (i == 2) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedVoiceSecret", C3473R.string.NoSharedVoiceSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedVoice", C3473R.string.NoSharedVoice));
            }
        } else if (i == 3) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedLinksSecret", C3473R.string.NoSharedLinksSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedLinks", C3473R.string.NoSharedLinks));
            }
        } else if (i == 4 || i == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedAudioSecret", C3473R.string.NoSharedAudioSecret));
            } else if (i == IdFabric$CustomType.MEDIA_TAB_PLAYLIST) {
                emptyStubView.emptyTextView.setText(LocaleController.getInternalString(C3473R.string.music_playlist_empty_title));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedAudio", C3473R.string.NoSharedAudio));
            }
        } else if (i == 5) {
            if (DialogObject.isEncryptedDialog(j)) {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoSharedGifSecret", C3473R.string.NoSharedGifSecret));
            } else {
                emptyStubView.emptyTextView.setText(LocaleController.getString("NoGIFs", C3473R.string.NoGIFs));
            }
        } else if (i == 6) {
            emptyStubView.emptyImageView.setImageDrawable(null);
            emptyStubView.emptyTextView.setText(LocaleController.getString("NoGroupsInCommon", C3473R.string.NoGroupsInCommon));
        } else if (i == 7) {
            emptyStubView.emptyImageView.setImageDrawable(null);
            emptyStubView.emptyTextView.setText("");
            emptyStubView.emptyImageView.setImageResource(C3473R.C3475drawable.fork_members_tip);
            emptyStubView.emptyTextView.setText(LocaleController.getInternalString(C3473R.string.common_empty_state_title));
        }
        ...
        public /* synthetic */ void lambda$queryServerSearch$1(int i, final int i2, final String str, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (tLRPC$TL_error == null) {
                ...
                for (int i3 = 0; i3 < tLRPC$messages_Messages.messages.size(); i3++) {
                    ...
                    if (i == 0 || tLRPC$Message.f1546id <= i) {
                ...
                if (i == this.lastReqId) {
                    ...
                    for (int i2 = 0; i2 < SharedMediaLayout.this.mediaPages.length; i2++) {
                        if (SharedMediaLayout.this.mediaPages[i2].selectedType == this.currentType) {
                            if (this.searchesInProgress == 0 && itemCount2 == 0) {
                                SharedMediaLayout.this.mediaPages[i2].emptyView.title.setText(LocaleController.formatString("NoResultFoundFor", C3473R.string.NoResultFoundFor, str));
        ...
        public /* synthetic */ void lambda$updateSearchResults$4(ArrayList arrayList) {
            if (SharedMediaLayout.this.searching) {
                ...
                for (int i = 0; i < SharedMediaLayout.this.mediaPages.length; i++) {
                    if (SharedMediaLayout.this.mediaPages[i].selectedType == this.currentType) {
                        if (this.searchesInProgress == 0 && itemCount2 == 0) {
                            SharedMediaLayout.this.mediaPages[i].emptyView.title.setText(LocaleController.getString("NoResult", C3473R.string.NoResult));
    ...
    public class StoriesAdapter extends SharedPhotoVideoAdapter {
        ...
        public void destroy() {
            StoriesController.StoriesList storiesList = this.storiesList;
            if (storiesList != null) {
                storiesList.unlink(this.f1858id);
            }
        }
    ...
    public class GroupUsersSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void search(final String str, boolean z) {
            ...
            this.searchAdapterHelper.queryServerSearch(null, true, false, true, false, false, ChatObject.isChannel(this.currentChat) ? this.currentChat.f1522id : 0L, false, 2, 0);
            notifyDataSetChanged();
            for (int i = 0; i < SharedMediaLayout.this.mediaPages.length; i++) {
        ...
        public /* synthetic */ void lambda$processSearch$3(final String str) {
            ...
            this.searchAdapterHelper.queryServerSearch(str, false, false, true, false, false, ChatObject.isChannel(this.currentChat) ? this.currentChat.f1522id : 0L, false, 2, 1);
        }
