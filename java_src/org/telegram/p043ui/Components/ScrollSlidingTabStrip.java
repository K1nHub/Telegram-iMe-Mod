...
public class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    public void addKiklikoTrendsTab(Drawable drawable) {
        ...
        if (stickerTabView != null) {
            ...
            stickerTabView.textView.setText(LocaleController.getString("FeaturedStickersShort", C3473R.string.FeaturedStickersShort));
            this.tabsContainer.addView(stickerTabView, i);
        }
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3473R.C3476id.index_tag, Integer.valueOf(i));
    ...
    public /* synthetic */ void lambda$addKiklikoTrendsTab$0(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(C3473R.C3476id.index_tag)).intValue());
    }
    ...
    public void addKiklikoTab(TagResponse tagResponse) {
        ...
        stickerTabView.setTag(C3473R.C3476id.index_tag, Integer.valueOf(i));
        stickerTabView.setTag(C3473R.C3476id.object_tag, tagResponse.getMeme().getFile().getWebp());
        stickerTabView.setSelected(i == this.currentPosition);
    ...
    public ScrollSlidingTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.scrollOffset = AndroidUtilities.m72dp(33);
        this.underlineHeight = AndroidUtilities.m72dp(2);
        AndroidUtilities.m72dp(12);
        AndroidUtilities.m72dp(24);
        this.lastScrollX = 0;
        ...
        this.expanded = false;
        this.stickerTabExpandedWidth = AndroidUtilities.m73dp(EXPANDED_WIDTH);
        this.stickerTabWidth = AndroidUtilities.m72dp(33);
            ...
            */
            public void run() {
                ...
                L48:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.ScrollSlidingTabStrip.RunnableC53026.run():void");
            }
        };
        ...
        this.tabsContainer.setPadding(AndroidUtilities.m73dp(9.5f), 0, AndroidUtilities.m73dp(9.5f), 0);
        addView(this.tabsContainer, new FrameLayout.LayoutParams(-1, -1, 16));
        Paint paint = new Paint();
        this.rectPaint = paint;
        paint.setAntiAlias(true);
        this.rectPaint.setStyle(Paint.Style.FILL);
        this.defaultTabLayoutParams = new LinearLayout.LayoutParams(AndroidUtilities.m72dp(33), -1);
    ...
    public void setType(Type type) {
        ...
        this.type = type;
        int i = C53037.$SwitchMap$org$telegram$ui$Components$ScrollSlidingTabStrip$Type[type.ordinal()];
        if (i == 1) {
    ...
    /* loaded from: classes7.dex */
    public static /* synthetic */ class C53037 {
    ...
    public void beginUpdate(boolean z) {
        ...
        autoTransition.addTransition(new C52993());
    ...
    /* loaded from: classes7.dex */
    public class C52993 extends Transition {
        ...
        public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip$3$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ScrollSlidingTabStrip.C52993.this.lambda$createAnimator$0(valueAnimator);
                }
            });
            return ofFloat;
        }
    ...
    public FrameLayout addIconTab(int i, Drawable drawable) {
        ...
        frameLayout.setTag(C3473R.C3476id.index_tag, Integer.valueOf(i2));
    ...
    public StickerTabView addStickerIconTab(int i, Drawable drawable) {
        ...
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3473R.C3476id.index_tag, Integer.valueOf(i2));
    ...
    public void addStickerTab(TLRPC$Chat tLRPC$Chat) {
        String str = "chat" + tLRPC$Chat.f1522id;
        int i = this.tabCount;
        this.tabCount = i + 1;
        StickerTabView stickerTabView = (StickerTabView) this.prevTypes.get(str);
        if (stickerTabView != null) {
            ...
            avatarDrawable.setTextSize(AndroidUtilities.m72dp(14));
    ...
    public View addEmojiTab(int i, Emoji.EmojiDrawable emojiDrawable, TLRPC$Document tLRPC$Document) {
        ...
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C3473R.C3476id.index_tag, Integer.valueOf(i2));
        stickerTabView.setTag(C3473R.C3476id.parent_tag, emojiDrawable);
        stickerTabView.setTag(C3473R.C3476id.object_tag, tLRPC$Document);
        stickerTabView.setSelected(i2 == this.currentPosition);
        this.tabTypes.put(str, stickerTabView);
        return stickerTabView;
    }
    ...
    public View addStickerTab(TLObject tLObject, TLRPC$Document tLRPC$Document, TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet) {
        ...
        sb.append("set");
        sb.append(tLRPC$TL_messages_stickerSet == null ? tLRPC$Document.f1530id : tLRPC$TL_messages_stickerSet.set.f1556id);
        ...
        stickerTabView.setTag(C3473R.C3476id.index_tag, Integer.valueOf(i));
        stickerTabView.setTag(C3473R.C3476id.parent_tag, tLRPC$TL_messages_stickerSet);
        stickerTabView.setTag(C3473R.C3476id.object_tag, tLRPC$Document);
        stickerTabView.setSelected(i == this.currentPosition);
        ...
        if (this.expanded != z) {
            ...
            this.expandStickerAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip.4
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    for (int i2 = 0; i2 < ScrollSlidingTabStrip.this.tabsContainer.getChildCount(); i2++) {
                        ...
                        childAt.getLayoutParams().width = AndroidUtilities.m72dp(33);
                    }
                    ScrollSlidingTabStrip scrollSlidingTabStrip3 = ScrollSlidingTabStrip.this;
                    scrollSlidingTabStrip3.animateToExpanded = false;
                    scrollSlidingTabStrip3.getLayoutParams().height = AndroidUtilities.m72dp(36);
            ...
            if (z) {
                ...
                for (int i = 0; i < this.tabsContainer.getChildCount(); i++) {
                    ...
                    childAt.getLayoutParams().width = AndroidUtilities.m73dp(EXPANDED_WIDTH);
                }
                this.tabsContainer.requestLayout();
                getLayoutParams().height = AndroidUtilities.m72dp(86);
            }
            if (z) {
    ...
    public float getExpandedOffset() {
        return this.animateToExpanded ? AndroidUtilities.m72dp(50) * this.expandProgress : BitmapDescriptorFactory.HUE_RED;
    }
    ...
    public void setImages() {
        ...
        int scrollX = (int) (((getScrollX() - (this.animateToExpanded ? this.expandOffset * (1.0f - f) : BitmapDescriptorFactory.HUE_RED)) - this.tabsContainer.getPaddingLeft()) / (AndroidUtilities.m72dp(33) + (AndroidUtilities.m73dp(EXPANDED_WIDTH - 33.0f) * f)));
        int min = Math.min(this.tabsContainer.getChildCount(), ((int) Math.ceil(getMeasuredWidth() / m72dp)) + scrollX + 1);
        ...
        while (true) {
            ...
            if (childAt instanceof StickerTabView) {
                ...
                if (i2 == 100) {
                    Glide.with(getContext()).load((String) stickerTabView.getTag(C3473R.C3476id.object_tag)).diskCacheStrategy(DiskCacheStrategy.ALL).optionalTransform(WebpDrawable.class, new WebpDrawableTransformation(new CenterCrop())).into(stickerTabView.iconView);
                } else {
                    if (i2 == 2) {
                        Object tag = stickerTabView.getTag(C3473R.C3476id.parent_tag);
                        Object tag2 = stickerTabView.getTag(C3473R.C3476id.object_tag);
                        ...
                        Object tag4 = childAt.getTag(C3473R.C3476id.parent_tag);
                        TLRPC$Document tLRPC$Document = (TLRPC$Document) childAt.getTag(C3473R.C3476id.object_tag);
    ...
    public int getTabSize() {
        return AndroidUtilities.m73dp(this.animateToExpanded ? EXPANDED_WIDTH : 33.0f);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.animateToExpanded) {
            height = getHeight() - (AndroidUtilities.m72dp(50) * (1.0f - this.expandProgress));
        }
        float f4 = height;
        ...
        if (!isInEditMode() && this.tabCount != 0 && this.indicatorHeight >= 0) {
            ...
            if (childAt != null && view != null) {
                float f8 = f6 - floor;
                float lerp = AndroidUtilities.lerp(childAt.getLeft() + childAt.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m72dp(33), AndroidUtilities.m73dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f), view.getLeft() + view.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m72dp(33), AndroidUtilities.m73dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f), f8);
                ...
                f = childAt.getLeft() + childAt.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m72dp(33), AndroidUtilities.m73dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f);
                if (childAt instanceof StickerTabView) {
                ...
                if (view != null) {
                    f = view.getLeft() + view.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m72dp(33), AndroidUtilities.m73dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f);
                    if (view instanceof StickerTabView) {
            ...
            float abs = (1.25f - ((Math.abs(0.5f - this.currentPositionAnimated.getTransitionProgressInterpolated()) * 0.25f) * 2.0f)) * m72dp;
            float interpolation = CubicBezierInterpolator.EASE_IN.getInterpolation(this.expandProgress);
            float lerp2 = f7 + AndroidUtilities.lerp(0, AndroidUtilities.m72dp(26), interpolation);
            float lerp3 = AndroidUtilities.lerp(abs, textWidth + AndroidUtilities.m72dp(10), interpolation) / 2.0f;
            float abs2 = ((m72dp * (((Math.abs(0.5f - this.currentPositionAnimated.getTransitionProgressInterpolated()) * 0.1f) * 2.0f) + 0.9f)) * AndroidUtilities.lerp(1.0f, 0.55f, interpolation)) / 2.0f;
            ...
            canvas.drawRoundRect(this.tabBounds, AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(8), this.selectorPaint);
        }
            ...
            if (this.draggingView != null) {
                ...
                if (i3 != i4) {
                    ...
                    for (int i5 = 0; i5 < this.tabsContainer.getChildCount(); i5++) {
                        this.tabsContainer.getChildAt(i5).setTag(C3473R.C3476id.index_tag, Integer.valueOf(i5));
                    }
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(BitmapDescriptorFactory.HUE_RED, 1.0f);
