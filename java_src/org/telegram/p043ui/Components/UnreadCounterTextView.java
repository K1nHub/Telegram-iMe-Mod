...
public class UnreadCounterTextView extends View {
    ...
    public UnreadCounterTextView(Context context) {
        ...
        this.layoutPaint.setTextSize(AndroidUtilities.m104dp(15));
        ...
        if (motionEvent.getAction() == 0 && (staticLayout = this.textLayout) != null) {
            ...
            if (getMeasuredWidth() == ((View) getParent()).getMeasuredWidth()) {
                if (!this.isOnlyTextClickable) {
                    ceil = getMeasuredWidth() - AndroidUtilities.m104dp(96);
                }
            } else if (isTouchFullWidth()) {
                ceil = getMeasuredWidth();
            } else {
                int i = this.circleWidth;
                ceil = ceil + (i > 0 ? i + AndroidUtilities.m104dp(8) : 0) + AndroidUtilities.m104dp(48);
            }
    ...
    public void setCounter(int i) {
        if (this.currentCounter != i) {
            ...
            if (i == 0) {
                ...
                int max = Math.max(AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(12) + this.textWidth);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getParent() != null) {
            ...
            if (this.rippleColor != Theme.getColor(this.textColorKey, getResourceProvider()) || this.selectableBackground == null) {
                int m104dp = AndroidUtilities.m104dp(60);
                int color4 = Theme.getColor(this.textColorKey, getResourceProvider());
                this.rippleColor = color4;
                Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(m104dp, 0, ColorUtils.setAlphaComponent(color4, 26));
                this.selectableBackground = createSimpleSelectorCircleDrawable;
                createSimpleSelectorCircleDrawable.setCallback(this);
            }
            int m104dp2 = getLeft() + measuredWidth3 <= 0 ? measuredWidth3 - AndroidUtilities.m104dp(20) : measuredWidth3;
            int i = measuredWidth3 + measuredWidth2;
            if (i > ((View) getParent()).getMeasuredWidth()) {
                i += AndroidUtilities.m104dp(20);
            }
            int i2 = measuredWidth2 / 2;
            this.selectableBackground.setBounds(m104dp2, (getMeasuredHeight() / 2) - i2, i, (getMeasuredHeight() / 2) + i2);
        ...
        if (this.textLayout != null) {
            ...
            if (this.replaceProgress != 1.0f && this.textLayoutOut != null) {
                ...
                canvas.translate(this.iconOut != null ? (drawable2.getIntrinsicWidth() / 2) + AndroidUtilities.m104dp(3) : 0, (this.animatedFromBottom ? -1.0f : 1.0f) * AndroidUtilities.m104dp(18) * this.replaceProgress);
                Drawable drawable4 = this.iconOut;
                if (drawable4 != null) {
                    drawable4.setBounds((-drawable4.getIntrinsicWidth()) - AndroidUtilities.m104dp(6), ((this.textLayout.getHeight() - this.iconOut.getIntrinsicHeight()) / 2) + AndroidUtilities.m104dp(1), -AndroidUtilities.m104dp(6), ((this.textLayout.getHeight() + this.iconOut.getIntrinsicHeight()) / 2) + AndroidUtilities.m104dp(1));
                ...
                canvas.translate(this.icon != null ? (drawable3.getIntrinsicWidth() / 2) + AndroidUtilities.m104dp(3) : 0, (this.animatedFromBottom ? 1.0f : -1.0f) * AndroidUtilities.m104dp(18) * (1.0f - this.replaceProgress));
                Drawable drawable5 = this.icon;
                if (drawable5 != null) {
                    drawable5.setBounds((-drawable5.getIntrinsicWidth()) - AndroidUtilities.m104dp(6), ((this.textLayout.getHeight() - this.icon.getIntrinsicHeight()) / 2) + AndroidUtilities.m104dp(1), -AndroidUtilities.m104dp(6), ((this.textLayout.getHeight() + this.icon.getIntrinsicHeight()) / 2) + AndroidUtilities.m104dp(1));
                ...
                canvas.translate(measuredWidth4 + (this.icon != null ? (drawable.getIntrinsicWidth() / 2) + AndroidUtilities.m104dp(3) : 0), ((getMeasuredHeight() - this.textLayout.getHeight()) / 2) + getTopOffset());
                Drawable drawable6 = this.icon;
                if (drawable6 != null) {
                    drawable6.setBounds((-drawable6.getIntrinsicWidth()) - AndroidUtilities.m104dp(6), ((this.textLayout.getHeight() - this.icon.getIntrinsicHeight()) / 2) + AndroidUtilities.m104dp(1), -AndroidUtilities.m104dp(6), ((this.textLayout.getHeight() + this.icon.getIntrinsicHeight()) / 2) + AndroidUtilities.m104dp(1));
        ...
        int ceil = (int) Math.ceil(staticLayout.getLineWidth(0));
        this.rect.set(((((getMeasuredWidth() - ceil) / 2) + ceil) - (this.circleWidth / 2)) + AndroidUtilities.m104dp(6), (getMeasuredHeight() / 2) - AndroidUtilities.m104dp(10), measuredWidth + this.circleWidth, (getMeasuredHeight() / 2) + AndroidUtilities.m104dp(10));
        canvas.drawRoundRect(this.rect, AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10), this.paint);
        canvas.drawText(this.currentCounterString, this.rect.centerX() - (this.textWidth / 2.0f), this.rect.top + AndroidUtilities.m105dp(14.5f), this.textPaint);
    }
