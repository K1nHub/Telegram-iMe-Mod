...
public class RoundVideoPlayingDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        for (int i4 = 0; i4 < 3; i4++) {
            canvas.drawRect(AndroidUtilities.m107dp(2) + i2, AndroidUtilities.m108dp((this.progress1 * 7.0f) + 2.0f) + i3, AndroidUtilities.m107dp(4) + i2, AndroidUtilities.m107dp(10) + i3, this.paint);
            canvas.drawRect(AndroidUtilities.m107dp(5) + i2, AndroidUtilities.m108dp((this.progress2 * 7.0f) + 2.0f) + i3, AndroidUtilities.m107dp(7) + i2, AndroidUtilities.m107dp(10) + i3, this.paint);
            canvas.drawRect(AndroidUtilities.m107dp(8) + i2, AndroidUtilities.m108dp((this.progress3 * 7.0f) + 2.0f) + i3, AndroidUtilities.m107dp(10) + i2, AndroidUtilities.m107dp(10) + i3, this.paint);
        }
        if (this.started) {
            update();
        }
