...
public class FolderBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    private void init() {
        ...
        this.recyclerListView.setPadding(AndroidUtilities.m104dp(6), 0, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(this.button != null ? 68 : 0));
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$11(ArrayList arrayList, BaseFragment baseFragment) {
        ...
        if (this.updates != null || (this.invite instanceof TL_chatlists$TL_chatlists_chatlistInviteAlready)) {
            ...
            m62of.createSimpleBulletin(i, replaceTags, formatPluralString).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
            return;
        }
        BulletinFactory.m62of(baseFragment).createSimpleBulletin(C3632R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkAddedTitle", C3632R.string.FolderLinkAddedTitle, this.escapedTitle)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList.size(), new Object[0])).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
    }
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$17(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, final Utilities.Callback callback) {
        ...
        this.reqId = -1;
        int i2 = 0;
        if (FilterCreateActivity.processErrors(tLRPC$TL_error, getBaseFragment(), BulletinFactory.m62of(getBaseFragment())) && tLObject != null) {
            if (tLObject instanceof TLRPC$Updates) {
                ...
                if (arrayList.isEmpty()) {
                    ...
                    if (tLRPC$Update instanceof TLRPC$TL_updateDialogFilter) {
                        i = ((TLRPC$TL_updateDialogFilter) tLRPC$Update).f1741id;
                    }
                } else {
                    while (true) {
                        if (i2 >= arrayList.size()) {
                            ...
                            i = ((TLRPC$TL_updateDialogFilter) arrayList.get(i2)).f1741id;
                            break;
                        } else {
                            i2++;
                        }
        ...
        if (this.selectedPeers.contains(Long.valueOf(peerDialogId))) {
            if (this.alreadyJoined.contains(Long.valueOf(peerDialogId))) {
                ...
                if (this.lastClickedDialogId != peerDialogId || System.currentTimeMillis() - this.lastClicked > 1500) {
                    ...
                    BulletinFactory.m63of(this.bulletinContainer, null).createChatsBulletin(arrayList, str, null).setDuration(ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED).show();
                    return;
                }
                return;
            }
    ...
    public static class Button extends FrameLayout {
        ...
        public Button(Context context, String str) {
            ...
            setBackground((ShapeDrawable) Theme.createRoundRectDrawable(AndroidUtilities.m104dp(8), Theme.getColor(i)));
            ...
            this.text.setTextSize(AndroidUtilities.m104dp(14));
            ...
            this.countText.setTextSize(AndroidUtilities.m104dp(12));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (f < 1.0f) {
                ...
                float m105dp = ((AndroidUtilities.m105dp(15.66f) + this.countText.getCurrentWidth()) * f2) + currentWidth;
                ...
                rect.set((int) (((getMeasuredWidth() - m105dp) / 2.0f) + currentWidth + AndroidUtilities.m105dp(5.0f)), (int) ((getMeasuredHeight() - AndroidUtilities.m104dp(18)) / 2.0f), (int) (((getMeasuredWidth() - m105dp) / 2.0f) + currentWidth + AndroidUtilities.m105dp(13.0f) + Math.max(AndroidUtilities.m104dp(9), this.countText.getCurrentWidth())), (int) ((getMeasuredHeight() + AndroidUtilities.m104dp(18)) / 2.0f));
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10), this.paint);
        ...
        return new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.Components.FolderBottomSheet.1
            ...
            */
            public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r10, int r11) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.FolderBottomSheet.C50391.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
            }
    ...
    public static class HeaderCell extends FrameLayout {
        ...
        public HeaderCell(Context context) {
            ...
            this.actionTextView.setTextSize(AndroidUtilities.m104dp(15));
    ...
    public class TitleCell extends FrameLayout {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp((int) TsExtractor.TS_STREAM_TYPE_AC4), 1073741824));
        }
        ...
        public class FoldersPreview extends View {
            ...
            public FoldersPreview(TitleCell titleCell, Context context, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, CharSequence charSequence4, CharSequence charSequence5) {
                ...
                this.paint.setTextSize(AndroidUtilities.m105dp(15.33f));
                ...
                this.selectedTextPaint.setTextSize(AndroidUtilities.m104dp(17));
                ...
                this.countText.setCallback(this);
                this.countText.setTextSize(AndroidUtilities.m105dp(11.66f));
                ...
                float m104dp = AndroidUtilities.m104dp(3);
                fArr[3] = m104dp;
                fArr[2] = m104dp;
                fArr[1] = m104dp;
                fArr[0] = m104dp;
                float[] fArr2 = this.radii;
                float m104dp2 = AndroidUtilities.m104dp(1);
                fArr2[7] = m104dp2;
                fArr2[6] = m104dp2;
                fArr2[5] = m104dp2;
                fArr2[4] = m104dp2;
                LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m104dp(80), (float) BitmapDescriptorFactory.HUE_RED, new int[]{-1, 16777215}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP);
                ...
                LinearGradient linearGradient2 = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m104dp(80), (float) BitmapDescriptorFactory.HUE_RED, new int[]{16777215, -1}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP);
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.save();
                float m105dp = this.middleFolderWidth + (isCountEmpty() ? 0.0f : AndroidUtilities.m105dp(15.32f) + this.countText.getCurrentWidth());
                float f2 = m105dp / 2.0f;
                ...
                if (!isCountEmpty()) {
                    Rect rect = AndroidUtilities.rectTmp2;
                    rect.set((int) (this.middleFolderWidth + f3 + AndroidUtilities.m105dp(4.66f)), (int) (measuredHeight - AndroidUtilities.m104dp(9)), (int) (this.middleFolderWidth + f3 + AndroidUtilities.m105dp(15.32f) + this.countText.getCurrentWidth()), (int) (AndroidUtilities.m104dp(9) + measuredHeight));
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(rect);
                    canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(9), AndroidUtilities.m104dp(9), this.selectedPaint);
                    rect.offset(-AndroidUtilities.m105dp(0.33f), -AndroidUtilities.m105dp(0.66f));
                    this.countText.setBounds(rect);
                    this.countText.draw(canvas);
                }
                float m104dp = AndroidUtilities.m104dp(30);
                float f4 = this.leftFolderWidth;
                float f5 = (f3 - m104dp) - f4;
                if (this.leftFolder2 == null || f4 >= AndroidUtilities.m104dp(64)) {
                    f = f5;
                } else {
                    float f6 = f5 - (this.leftFolder2Width + m104dp);
                    canvas.save();
                    canvas.translate(f6, (measuredHeight - (this.leftFolder2.getHeight() / 2.0f)) + AndroidUtilities.m104dp(1));
                ...
                if (this.leftFolder != null) {
                    canvas.save();
                    canvas.translate(f5, (measuredHeight - (this.leftFolder.getHeight() / 2.0f)) + AndroidUtilities.m104dp(1));
                ...
                if (this.rightFolder != null) {
                    canvas.save();
                    canvas.translate(f7 + m104dp, (measuredHeight - (this.rightFolder.getHeight() / 2.0f)) + AndroidUtilities.m104dp(1));
                    this.rightFolder.draw(canvas);
                    canvas.restore();
                    f7 += this.rightFolderWidth + m104dp;
                }
                if (this.rightFolder2 != null && this.rightFolderWidth < AndroidUtilities.m104dp(64)) {
                    canvas.save();
                    canvas.translate(f7 + m104dp, (measuredHeight - (this.rightFolder2.getHeight() / 2.0f)) + AndroidUtilities.m104dp(1));
                    this.rightFolder2.draw(canvas);
                    canvas.restore();
                    f7 += m104dp + this.rightFolder2Width;
                }
                float height = measuredHeight + (this.middleFolder.getHeight() / 2.0f) + AndroidUtilities.m104dp(12);
                ...
                rectF2.set(f3 - AndroidUtilities.m104dp(4), height - AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4) + f8, height);
                this.path.addRoundRect(rectF2, this.radii, Path.Direction.CW);
                canvas.drawPath(this.path, this.selectedPaint);
                canvas.save();
                float max = Math.max(AndroidUtilities.m104dp(8), f);
                this.leftMatrix.reset();
                this.leftMatrix.postTranslate(Math.min(f3, max + AndroidUtilities.m104dp(8)), BitmapDescriptorFactory.HUE_RED);
                this.leftGradient.setLocalMatrix(this.leftMatrix);
                float min = Math.min(getMeasuredWidth() - AndroidUtilities.m104dp(8), f7);
                this.rightMatrix.reset();
                this.rightMatrix.postTranslate(Math.max(f8, min - AndroidUtilities.m104dp(88)), BitmapDescriptorFactory.HUE_RED);
