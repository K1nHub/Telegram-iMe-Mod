...
public class FolderBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public static void showForDeletion(final BaseFragment baseFragment, final int i, final Utilities.Callback<Boolean> callback) {
        ...
        if (dialogFilter != null && dialogFilter.isMyChatlist()) {
            AlertDialog create = new AlertDialog.Builder(baseFragment.getContext()).setTitle(LocaleController.getString("FilterDelete", C3473R.string.FilterDelete)).setMessage(LocaleController.getString("FilterDeleteAlertLinks", C3473R.string.FilterDeleteAlertLinks)).setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    FolderBottomSheet.lambda$showForDeletion$3(Utilities.Callback.this, dialogInterface, i3);
                }
            }).setPositiveButton(LocaleController.getString("Delete", C3473R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    runnable.run();
                }
    ...
    public static /* synthetic */ void lambda$showForDeletion$2(final int i, final BaseFragment baseFragment, final Utilities.Callback callback) {
        ...
        baseFragment.getConnectionsManager().sendRequest(tLRPC$TL_chatlists_getLeaveChatlistSuggestions, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda17
        ...
        if (arrayList != null) {
            ...
            while (true) {
                if (i2 >= arrayList.size()) {
                    break;
                } else if (arrayList.get(i2).f1459id == i) {
                    dialogFilter = arrayList.get(i2);
                    break;
                } else {
                    i2++;
        ...
        if (arrayList2 != null) {
            while (true) {
                if (i2 >= arrayList2.size()) {
                    break;
                } else if (arrayList2.get(i2).f1459id == i) {
            ...
            if (arrayList2 != null) {
                while (true) {
                    if (i >= arrayList2.size()) {
                        break;
                    } else if (arrayList2.get(i).f1459id == this.filterId) {
            ...
            if (arrayList == null) {
                ...
                if (!this.deleting) {
                    if (parentLayout != null) {
                        ...
                        this.reqId = getBaseFragment().getConnectionsManager().sendRequest(tLRPC$TL_chatlists_joinChatlistInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda19
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    ...
                    if (undoView2 == null) {
                        this.button.setLoading(true);
                        this.reqId = getBaseFragment().getConnectionsManager().sendRequest(tLRPC$TL_chatlists_joinChatlistInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda20
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$6(BaseFragment baseFragment, ArrayList arrayList) {
        this.reqId = -1;
        BulletinFactory.m32of(baseFragment).createSimpleBulletin(C3473R.raw.ic_delete, LocaleController.formatString("FolderLinkDeletedTitle", C3473R.string.FolderLinkDeletedTitle, this.title), LocaleController.formatPluralString("FolderLinkDeletedSubtitle", arrayList.size(), new Object[0])).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
        this.success = true;
        dismiss();
        getBaseFragment().getMessagesController().invalidateChatlistFolderUpdate(this.filterId);
    }
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$11(ArrayList arrayList, BaseFragment baseFragment) {
        ...
        if (this.updates != null || (this.invite instanceof TLRPC$TL_chatlists_chatlistInviteAlready)) {
            ...
            int i = C3473R.raw.folder_in;
            SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkUpdatedTitle", C3473R.string.FolderLinkUpdatedTitle, this.escapedTitle));
            if (arrayList.size() <= 0) {
        ...
        BulletinFactory.m32of(baseFragment).createSimpleBulletin(C3473R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkAddedTitle", C3473R.string.FolderLinkAddedTitle, this.escapedTitle)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList.size(), new Object[0])).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
    }
            ...
            if (tLObject instanceof TLRPC$Updates) {
                ...
                if (arrayList.isEmpty()) {
                    ...
                    if (tLRPC$Update instanceof TLRPC$TL_updateDialogFilter) {
                        i = ((TLRPC$TL_updateDialogFilter) tLRPC$Update).f1676id;
                    }
                } else {
                    while (true) {
                        if (i2 >= arrayList.size()) {
                            ...
                            i = ((TLRPC$TL_updateDialogFilter) arrayList.get(i2)).f1676id;
                            break;
                        } else {
                            i2++;
                        }
            ...
            if (this.alreadyJoined.contains(Long.valueOf(peerDialogId))) {
                ...
                if (peerDialogId >= 0) {
                    ...
                    if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                        string = LocaleController.getString("FolderLinkAlreadySubscribed", C3473R.string.FolderLinkAlreadySubscribed);
                    } else {
                        string = LocaleController.getString("FolderLinkAlreadyJoined", C3473R.string.FolderLinkAlreadyJoined);
                    }
                    arrayList.add(chat);
                    str = string;
                }
    ...
    public void updateCount(boolean z) {
        ...
        if (button != null) {
            if (this.deleting) {
                if (size > 0) {
                    i = C3473R.string.FolderLinkButtonRemoveChats;
                    str = "FolderLinkButtonRemoveChats";
                } else {
                    i = C3473R.string.FolderLinkButtonRemove;
                ...
                ArrayList<TLRPC$Peer> arrayList = this.peers;
                if (arrayList == null || arrayList.isEmpty()) {
                    this.button.setText(LocaleController.getString("OK", C3473R.string.OK), z);
                } else if (this.invite instanceof TLRPC$TL_chatlists_chatlistInvite) {
                    this.button.setText(LocaleController.formatString("FolderLinkButtonAdd", C3473R.string.FolderLinkButtonAdd, this.title), z);
                } else {
                    this.button.setText(size > 0 ? LocaleController.formatPluralString("FolderLinkButtonJoinPlural", size, new Object[0]) : LocaleController.getString("FolderLinkButtonNone", C3473R.string.FolderLinkButtonNone), z);
                }
            }
    ...
    protected CharSequence getTitle() {
        if (this.deleting) {
            return LocaleController.getString("FolderLinkTitleRemove", C3473R.string.FolderLinkTitleRemove);
        }
        if (this.invite instanceof TLRPC$TL_chatlists_chatlistInvite) {
            return LocaleController.getString("FolderLinkTitleAdd", C3473R.string.FolderLinkTitleAdd);
        }
        ArrayList<TLRPC$Peer> arrayList = this.peers;
        if (arrayList == null || arrayList.isEmpty()) {
            return LocaleController.getString("FolderLinkTitleAlready", C3473R.string.FolderLinkTitleAlready);
        }
        return LocaleController.getString("FolderLinkTitleAddChats", C3473R.string.FolderLinkTitleAddChats);
    }
        ...
        return new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.Components.FolderBottomSheet.1
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                if (i == 0) {
                    ...
                    if ((FolderBottomSheet.this.invite instanceof TLRPC$TL_chatlists_chatlistInviteAlready) || FolderBottomSheet.this.updates != null) {
                        z = true;
                    }
            ...
            */
            public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r10, int r11) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.FolderBottomSheet.C48501.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
            }
    ...
    public class TitleCell extends FrameLayout {
        ...
        public void setSelectedCount(int i, boolean z) {
            if (FolderBottomSheet.this.deleting) {
                this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitleRemove", C3473R.string.FolderLinkSubtitleRemove, this.title)));
                ...
                if (FolderBottomSheet.this.peers == null || FolderBottomSheet.this.peers.isEmpty()) {
                    this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitleAlready", C3473R.string.FolderLinkSubtitleAlready, this.title)));
                } else {
                ...
                this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitle", C3473R.string.FolderLinkSubtitle, this.title)));
            }
        }
        ...
        public class FoldersPreview extends View {
            ...
            private StaticLayout makeLayout(CharSequence charSequence, boolean z) {
                if (charSequence == null || "ALL_CHATS".equals(charSequence.toString())) {
                    charSequence = LocaleController.getString("FilterAllChats", C3473R.string.FilterAllChats);
                }
    ...
    public void updateHeaderCell(boolean z) {
        ...
        if (arrayList != null && arrayList.size() - this.alreadyJoined.size() > 1) {
            ...
            this.headerCell.setAction(LocaleController.getString(z2 ? C3473R.string.DeselectAll : C3473R.string.SelectAll), new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void deselectAll(final HeaderCell headerCell, final boolean z) {
        ...
        updateCount(true);
        headerCell.setAction(LocaleController.getString(z ? C3473R.string.SelectAll : C3473R.string.DeselectAll), new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
