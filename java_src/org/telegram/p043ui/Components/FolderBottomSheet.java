...
import org.telegram.tgnet.p042tl.TL_chatlists$TL_chatlists_chatlistInvite;
import org.telegram.tgnet.p042tl.TL_chatlists$TL_chatlists_chatlistInviteAlready;
import org.telegram.tgnet.p042tl.TL_chatlists$TL_chatlists_chatlistUpdates;
import org.telegram.tgnet.p042tl.TL_chatlists$TL_chatlists_getLeaveChatlistSuggestions;
import org.telegram.tgnet.p042tl.TL_chatlists$TL_chatlists_hideChatlistUpdates;
import org.telegram.tgnet.p042tl.TL_chatlists$TL_chatlists_joinChatlistInvite;
import org.telegram.tgnet.p042tl.TL_chatlists$TL_chatlists_joinChatlistUpdates;
import org.telegram.tgnet.p042tl.TL_chatlists$TL_chatlists_leaveChatlist;
import org.telegram.tgnet.p042tl.TL_chatlists$TL_inputChatlistDialogFilter;
import org.telegram.tgnet.p042tl.TL_chatlists$chatlist_ChatlistInvite;
/* renamed from: org.telegram.ui.Components.FolderBottomSheet */
...
public class FolderBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public static void showForDeletion(final BaseFragment baseFragment, final int i, final Utilities.Callback<Boolean> callback) {
        ...
        if (dialogFilter != null && dialogFilter.isMyChatlist()) {
            AlertDialog create = new AlertDialog.Builder(baseFragment.getContext()).setTitle(LocaleController.getString("FilterDelete", C3632R.string.FilterDelete)).setMessage(LocaleController.getString("FilterDeleteAlertLinks", C3632R.string.FilterDeleteAlertLinks)).setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    FolderBottomSheet.lambda$showForDeletion$3(Utilities.Callback.this, dialogInterface, i3);
                }
            }).setPositiveButton(LocaleController.getString("Delete", C3632R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    runnable.run();
                }
    ...
    public static /* synthetic */ void lambda$showForDeletion$2(final int i, final BaseFragment baseFragment, final Utilities.Callback callback) {
        ...
        baseFragment.getConnectionsManager().sendRequest(tL_chatlists$TL_chatlists_getLeaveChatlistSuggestions, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda17
        ...
        if (arrayList != null) {
            ...
            while (true) {
                if (i2 >= arrayList.size()) {
                    break;
                } else if (arrayList.get(i2).f1538id == i) {
                    dialogFilter = arrayList.get(i2);
                    break;
                } else {
                    i2++;
        ...
        if (arrayList2 != null) {
            while (true) {
                if (i2 >= arrayList2.size()) {
                    break;
                } else if (arrayList2.get(i2).f1538id == i) {
            ...
            if (arrayList2 != null) {
                while (true) {
                    if (i >= arrayList2.size()) {
                        break;
                    } else if (arrayList2.get(i).f1538id == this.filterId) {
    ...
    private void init() {
        ...
        this.recyclerListView.setPadding(AndroidUtilities.m107dp(6), 0, AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(this.button != null ? 68 : 0));
        ...
        if (button == null || !button.isLoading()) {
            ...
            if (arrayList == null) {
                ...
                if (this.deleting) {
                    ...
                    tL_chatlists$TL_chatlists_leaveChatlist.peers.addAll(arrayList2);
                    ...
                    tL_chatlists$TL_chatlists_joinChatlistUpdates.peers.addAll(arrayList2);
                    tL_chatlists$TL_chatlists_joinChatlistInvite = tL_chatlists$TL_chatlists_joinChatlistUpdates;
                } else if ((this.invite instanceof TL_chatlists$TL_chatlists_chatlistInviteAlready) && arrayList2.isEmpty()) {
                    dismiss();
                    return;
                } else {
                    ...
                    tL_chatlists$TL_chatlists_joinChatlistInvite2.peers.addAll(arrayList2);
                ...
                if (!this.deleting) {
                    if (parentLayout != null) {
                        final Utilities.Callback callback2 = new Utilities.Callback() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda15
                        ...
                        if (this.updates != null) {
                            ...
                            callback = new Utilities.Callback() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda14
                                @Override // org.telegram.messenger.Utilities.Callback
                                public final void run(Object obj) {
                        ...
                        this.reqId = getBaseFragment().getConnectionsManager().sendRequest(tL_chatlists$TL_chatlists_joinChatlistInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda19
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    ...
                    if (undoView2 == null) {
                        this.button.setLoading(true);
                        this.reqId = getBaseFragment().getConnectionsManager().sendRequest(tL_chatlists$TL_chatlists_joinChatlistInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda20
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$7(final BaseFragment baseFragment, final ArrayList arrayList, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$6(BaseFragment baseFragment, ArrayList arrayList) {
        this.reqId = -1;
        BulletinFactory.m65of(baseFragment).createSimpleBulletin(C3632R.raw.ic_delete, LocaleController.formatString("FolderLinkDeletedTitle", C3632R.string.FolderLinkDeletedTitle, this.title), LocaleController.formatPluralString("FolderLinkDeletedSubtitle", arrayList.size(), new Object[0])).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
        this.success = true;
        dismiss();
        getBaseFragment().getMessagesController().invalidateChatlistFolderUpdate(this.filterId);
    }
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$10(TLObject tLObject, final Pair pair) {
        this.reqId = getBaseFragment().getConnectionsManager().sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda18
            @Override // org.telegram.tgnet.RequestDelegate
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$11(ArrayList arrayList, BaseFragment baseFragment) {
        ...
        if (this.updates != null || (this.invite instanceof TL_chatlists$TL_chatlists_chatlistInviteAlready)) {
            ...
            int i = C3632R.raw.folder_in;
            SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkUpdatedTitle", C3632R.string.FolderLinkUpdatedTitle, this.escapedTitle));
            if (arrayList.size() <= 0) {
            ...
            m65of.createSimpleBulletin(i, replaceTags, formatPluralString).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
            return;
        }
        BulletinFactory.m65of(baseFragment).createSimpleBulletin(C3632R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkAddedTitle", C3632R.string.FolderLinkAddedTitle, this.escapedTitle)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList.size(), new Object[0])).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
    }
    ...
    public static /* synthetic */ void lambda$onJoinButtonClicked$15(INavigationLayout iNavigationLayout, final Utilities.Callback callback, final Integer num) {
        ...
        if (baseFragment instanceof DialogsActivity) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$18(final Utilities.Callback callback, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onJoinButtonClicked$17(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, final Utilities.Callback callback) {
        final int i = -1;
        this.reqId = -1;
        int i2 = 0;
        if (FilterCreateActivity.processErrors(tLRPC$TL_error, getBaseFragment(), BulletinFactory.m65of(getBaseFragment())) && tLObject != null) {
            if (tLObject instanceof TLRPC$Updates) {
                ...
                if (arrayList.isEmpty()) {
                    ...
                    if (tLRPC$Update instanceof TLRPC$TL_updateDialogFilter) {
                        i = ((TLRPC$TL_updateDialogFilter) tLRPC$Update).f1742id;
                    }
                } else {
                    while (true) {
                        if (i2 >= arrayList.size()) {
                            ...
                            i = ((TLRPC$TL_updateDialogFilter) arrayList.get(i2)).f1742id;
                            break;
                        } else {
                            i2++;
                        }
            ...
            if (this.invite instanceof TL_chatlists$TL_chatlists_chatlistInvite) {
                getBaseFragment().getMessagesController().loadRemoteFilters(true, new Utilities.Callback() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda16
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
            ...
            if (this.alreadyJoined.contains(Long.valueOf(peerDialogId))) {
                ...
                if (peerDialogId >= 0) {
                    ...
                    if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                        string = LocaleController.getString("FolderLinkAlreadySubscribed", C3632R.string.FolderLinkAlreadySubscribed);
                    } else {
                        string = LocaleController.getString("FolderLinkAlreadyJoined", C3632R.string.FolderLinkAlreadyJoined);
                    }
                    arrayList.add(chat);
                    str = string;
                }
                if (this.lastClickedDialogId != peerDialogId || System.currentTimeMillis() - this.lastClicked > 1500) {
                    ...
                    BulletinFactory.m66of(this.bulletinContainer, null).createChatsBulletin(arrayList, str, null).setDuration(ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED).show();
                    return;
                }
                return;
            }
    ...
    public void updateCount(boolean z) {
        ...
        if (button != null) {
            if (this.deleting) {
                if (size > 0) {
                    i = C3632R.string.FolderLinkButtonRemoveChats;
                    str = "FolderLinkButtonRemoveChats";
                } else {
                    i = C3632R.string.FolderLinkButtonRemove;
                ...
                ArrayList<TLRPC$Peer> arrayList = this.peers;
                if (arrayList == null || arrayList.isEmpty()) {
                    this.button.setText(LocaleController.getString("OK", C3632R.string.OK), z);
                } else if (this.invite instanceof TL_chatlists$TL_chatlists_chatlistInvite) {
                    this.button.setText(LocaleController.formatString("FolderLinkButtonAdd", C3632R.string.FolderLinkButtonAdd, this.title), z);
                } else {
                    this.button.setText(size > 0 ? LocaleController.formatPluralString("FolderLinkButtonJoinPlural", size, new Object[0]) : LocaleController.getString("FolderLinkButtonNone", C3632R.string.FolderLinkButtonNone), z);
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.FolderBottomSheet$Button */
    /* loaded from: classes6.dex */
    public static class Button extends FrameLayout {
        ...
        public Button(Context context, String str) {
            ...
            setBackground((ShapeDrawable) Theme.createRoundRectDrawable(AndroidUtilities.m107dp(8), Theme.getColor(i)));
            ...
            this.text.setTextSize(AndroidUtilities.m107dp(14));
            ...
            this.countText.setTextSize(AndroidUtilities.m107dp(12));
        ...
        public void setEnabled(boolean z) {
            if (this.enabled != z) {
                ...
                this.enabledAnimator.addListener(new AnimatorListenerAdapter(this) { // from class: org.telegram.ui.Components.FolderBottomSheet.Button.3
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                    }
                });
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (f < 1.0f) {
                ...
                float m108dp = ((AndroidUtilities.m108dp(15.66f) + this.countText.getCurrentWidth()) * f2) + currentWidth;
                Rect rect = AndroidUtilities.rectTmp2;
                rect.set((int) (((getMeasuredWidth() - m108dp) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - this.text.getHeight()) / 2.0f) - AndroidUtilities.m107dp(1)), (int) ((((getMeasuredWidth() - m108dp) + getWidth()) / 2.0f) + currentWidth), (int) (((getMeasuredHeight() + this.text.getHeight()) / 2.0f) - AndroidUtilities.m107dp(1)));
                ...
                rect.set((int) (((getMeasuredWidth() - m108dp) / 2.0f) + currentWidth + AndroidUtilities.m108dp(5.0f)), (int) ((getMeasuredHeight() - AndroidUtilities.m107dp(18)) / 2.0f), (int) (((getMeasuredWidth() - m108dp) / 2.0f) + currentWidth + AndroidUtilities.m108dp(13.0f) + Math.max(AndroidUtilities.m107dp(9), this.countText.getCurrentWidth())), (int) ((getMeasuredHeight() + AndroidUtilities.m107dp(18)) / 2.0f));
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(10), AndroidUtilities.m107dp(10), this.paint);
                rect.offset(-AndroidUtilities.m108dp(0.3f), -AndroidUtilities.m108dp(0.4f));
    ...
    protected CharSequence getTitle() {
        if (this.deleting) {
            return LocaleController.getString("FolderLinkTitleRemove", C3632R.string.FolderLinkTitleRemove);
        }
        if (this.invite instanceof TL_chatlists$TL_chatlists_chatlistInvite) {
            return LocaleController.getString("FolderLinkTitleAdd", C3632R.string.FolderLinkTitleAdd);
        }
        ArrayList<TLRPC$Peer> arrayList = this.peers;
        if (arrayList == null || arrayList.isEmpty()) {
            return LocaleController.getString("FolderLinkTitleAlready", C3632R.string.FolderLinkTitleAlready);
        }
        return LocaleController.getString("FolderLinkTitleAddChats", C3632R.string.FolderLinkTitleAddChats);
    }
        ...
        return new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.Components.FolderBottomSheet.1
            ...
            */
            public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r10, int r11) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.FolderBottomSheet.C50821.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
            }
    ...
    /* renamed from: org.telegram.ui.Components.FolderBottomSheet$HeaderCell */
    /* loaded from: classes6.dex */
    public static class HeaderCell extends FrameLayout {
        ...
        public HeaderCell(Context context) {
            ...
            animatedTextView.setTextSize(AndroidUtilities.m107dp(15));
            ...
            addView(this.textView, LayoutHelper.createFrame(-1, 20, (LocaleController.isRTL ? 5 : 3) | 80, 21, 15, 21, 2));
            ...
            this.actionTextView.setTextSize(AndroidUtilities.m107dp(15));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.Components.FolderBottomSheet$TitleCell */
    /* loaded from: classes6.dex */
    public class TitleCell extends FrameLayout {
        ...
        public TitleCell(Context context, boolean z, String str) {
            ...
            addView(foldersPreview, LayoutHelper.createFrame(-1, 44.0f, 55, (float) BitmapDescriptorFactory.HUE_RED, 17.33f, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED));
            ...
            addView(this.titleTextView, LayoutHelper.createFrame(-1, -2.0f, 48, 32.0f, 78.3f, 32.0f, (float) BitmapDescriptorFactory.HUE_RED));
            ...
            addView(this.subtitleTextView, LayoutHelper.createFrame(-1, -2, 48, 32, 113, 32, 0));
            setSelectedCount(0, false);
        }

        public void setSelectedCount(int i, boolean z) {
            if (FolderBottomSheet.this.deleting) {
                this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitleRemove", C3632R.string.FolderLinkSubtitleRemove, this.title)));
                ...
                if (FolderBottomSheet.this.peers == null || FolderBottomSheet.this.peers.isEmpty()) {
                    this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitleAlready", C3632R.string.FolderLinkSubtitleAlready, this.title)));
                } else {
                ...
                this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("FolderLinkSubtitle", C3632R.string.FolderLinkSubtitle, this.title)));
            }
        }

        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp((int) TsExtractor.TS_STREAM_TYPE_AC4), 1073741824));
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: org.telegram.ui.Components.FolderBottomSheet$TitleCell$FoldersPreview */
        /* loaded from: classes6.dex */
        public class FoldersPreview extends View {
            ...
            public FoldersPreview(TitleCell titleCell, Context context, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, CharSequence charSequence4, CharSequence charSequence5) {
                ...
                this.paint.setTextSize(AndroidUtilities.m108dp(15.33f));
                ...
                this.selectedTextPaint.setTextSize(AndroidUtilities.m107dp(17));
                ...
                this.countText.setCallback(this);
                this.countText.setTextSize(AndroidUtilities.m108dp(11.66f));
                ...
                fArr2[5] = m107dp2;
                fArr2[4] = m107dp2;
                LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(80), (float) BitmapDescriptorFactory.HUE_RED, new int[]{-1, 16777215}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP);
                ...
                LinearGradient linearGradient2 = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(80), (float) BitmapDescriptorFactory.HUE_RED, new int[]{16777215, -1}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP);
            ...
            private StaticLayout makeLayout(CharSequence charSequence, boolean z) {
                if (charSequence == null || "ALL_CHATS".equals(charSequence.toString())) {
                    charSequence = LocaleController.getString("FilterAllChats", C3632R.string.FilterAllChats);
                }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.save();
                float m108dp = this.middleFolderWidth + (isCountEmpty() ? 0.0f : AndroidUtilities.m108dp(15.32f) + this.countText.getCurrentWidth());
                float f2 = m108dp / 2.0f;
                ...
                if (!isCountEmpty()) {
                    Rect rect = AndroidUtilities.rectTmp2;
                    rect.set((int) (this.middleFolderWidth + f3 + AndroidUtilities.m108dp(4.66f)), (int) (measuredHeight - AndroidUtilities.m107dp(9)), (int) (this.middleFolderWidth + f3 + AndroidUtilities.m108dp(15.32f) + this.countText.getCurrentWidth()), (int) (AndroidUtilities.m107dp(9) + measuredHeight));
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(rect);
                    canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(9), AndroidUtilities.m107dp(9), this.selectedPaint);
                    rect.offset(-AndroidUtilities.m108dp(0.33f), -AndroidUtilities.m108dp(0.66f));
                    this.countText.setBounds(rect);
                    this.countText.draw(canvas);
                }
                float m107dp = AndroidUtilities.m107dp(30);
                float f4 = this.leftFolderWidth;
                float f5 = (f3 - m107dp) - f4;
                if (this.leftFolder2 == null || f4 >= AndroidUtilities.m107dp(64)) {
                    f = f5;
                } else {
                    float f6 = f5 - (this.leftFolder2Width + m107dp);
                    canvas.save();
                    canvas.translate(f6, (measuredHeight - (this.leftFolder2.getHeight() / 2.0f)) + AndroidUtilities.m107dp(1));
                ...
                if (this.leftFolder != null) {
                    canvas.save();
                    canvas.translate(f5, (measuredHeight - (this.leftFolder.getHeight() / 2.0f)) + AndroidUtilities.m107dp(1));
                ...
                if (this.rightFolder != null) {
                    canvas.save();
                    canvas.translate(f7 + m107dp, (measuredHeight - (this.rightFolder.getHeight() / 2.0f)) + AndroidUtilities.m107dp(1));
                    this.rightFolder.draw(canvas);
                    canvas.restore();
                    f7 += this.rightFolderWidth + m107dp;
                }
                if (this.rightFolder2 != null && this.rightFolderWidth < AndroidUtilities.m107dp(64)) {
                    canvas.save();
                    canvas.translate(f7 + m107dp, (measuredHeight - (this.rightFolder2.getHeight() / 2.0f)) + AndroidUtilities.m107dp(1));
                    this.rightFolder2.draw(canvas);
                    canvas.restore();
                    f7 += m107dp + this.rightFolder2Width;
                }
                float height = measuredHeight + (this.middleFolder.getHeight() / 2.0f) + AndroidUtilities.m107dp(12);
                ...
                rectF2.set(f3 - AndroidUtilities.m107dp(4), height - AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4) + f8, height);
                this.path.addRoundRect(rectF2, this.radii, Path.Direction.CW);
                canvas.drawPath(this.path, this.selectedPaint);
                canvas.save();
                float max = Math.max(AndroidUtilities.m107dp(8), f);
                this.leftMatrix.reset();
                this.leftMatrix.postTranslate(Math.min(f3, max + AndroidUtilities.m107dp(8)), BitmapDescriptorFactory.HUE_RED);
                this.leftGradient.setLocalMatrix(this.leftMatrix);
                float min = Math.min(getMeasuredWidth() - AndroidUtilities.m107dp(8), f7);
                this.rightMatrix.reset();
                this.rightMatrix.postTranslate(Math.max(f8, min - AndroidUtilities.m107dp(88)), BitmapDescriptorFactory.HUE_RED);
    ...
    public void updateHeaderCell(boolean z) {
        ...
        if (arrayList != null && arrayList.size() - this.alreadyJoined.size() > 1) {
            ...
            this.headerCell.setAction(LocaleController.getString(z2 ? C3632R.string.DeselectAll : C3632R.string.SelectAll), new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void deselectAll(final HeaderCell headerCell, final boolean z) {
        ...
        updateCount(true);
        headerCell.setAction(LocaleController.getString(z ? C3632R.string.SelectAll : C3632R.string.DeselectAll), new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
