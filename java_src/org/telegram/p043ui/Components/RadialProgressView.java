...
public class RadialProgressView extends View {
    ...
    public RadialProgressView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.size = AndroidUtilities.m104dp(40);
    ...
    */
    private void updateAnimation(long r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.RadialProgressView.updateAnimation(long):void");
    }
    ...
    public void setStrokeWidth(float f) {
        this.progressPaint.setStrokeWidth(AndroidUtilities.m105dp(f));
    }
