...
public class GroupCallPipButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public GroupCallPipButton(Context context, int i, boolean z) {
        ...
        this.blobDrawable.maxRadius = AndroidUtilities.m107dp(37);
        this.blobDrawable.minRadius = AndroidUtilities.m107dp(32);
        this.blobDrawable2.maxRadius = AndroidUtilities.m107dp(37);
        this.blobDrawable2.minRadius = AndroidUtilities.m107dp(32);
        this.blobDrawable.generateBlob();
        this.blobDrawable2.generateBlob();
        int i3 = C3632R.raw.voice_outlined;
        this.bigMicDrawable = new RLottieDrawable(i3, "" + i3, AndroidUtilities.m107dp(22), AndroidUtilities.m107dp(30), true, null);
        ...
        this.prepareToRemoveShader = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(350), (float) BitmapDescriptorFactory.HUE_RED, new int[]{-2801343, -561538, 0}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.4f, 1.0f}, Shader.TileMode.CLAMP);
        if (z) {
            setState(0);
        }
    }
    ...
    public static class WeavingState {
        ...
        public void update(long j, float f) {
            ...
            int m107dp = AndroidUtilities.m107dp((int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
    ...
    */
    protected void onDraw(android.graphics.Canvas r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.GroupCallPipButton.onDraw(android.graphics.Canvas):void");
    }
