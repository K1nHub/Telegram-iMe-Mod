...
public class OtherDocumentPlaceholderDrawable extends RecyclableDrawable implements DownloadController.FileDownloadProgressListener {
    ...
    public OtherDocumentPlaceholderDrawable(Context context, View view, MessageObject messageObject) {
        docPaint.setTextSize(AndroidUtilities.m104dp(14));
        namePaint.setTextSize(AndroidUtilities.m104dp(19));
        sizePaint.setTextSize(AndroidUtilities.m104dp(15));
        buttonPaint.setTextSize(AndroidUtilities.m104dp(15));
        percentPaint.setTextSize(AndroidUtilities.m104dp(15));
        openPaint.setTextSize(AndroidUtilities.m104dp(15));
        progressPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
        ...
        if (document != null) {
            ...
            this.ext = upperCase;
            if (((int) Math.ceil(docPaint.measureText(upperCase))) > AndroidUtilities.m104dp(40)) {
                this.ext = TextUtils.ellipsize(this.ext, docPaint, AndroidUtilities.m104dp(40), TextUtils.TruncateAt.END).toString();
            }
            ...
            if (((int) Math.ceil(namePaint.measureText(this.fileName))) > AndroidUtilities.m104dp(320)) {
                this.fileName = TextUtils.ellipsize(this.fileName, namePaint, AndroidUtilities.m104dp(320), TextUtils.TruncateAt.END).toString();
            }
        }
        checkFileExist();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        int m104dp2 = (height - AndroidUtilities.m104dp((int) PsExtractor.VIDEO_STREAM_MASK)) / 2;
        int m104dp3 = (width - AndroidUtilities.m104dp(48)) / 2;
        this.thumbDrawable.setBounds(m104dp3, m104dp2, AndroidUtilities.m104dp(48) + m104dp3, AndroidUtilities.m104dp(48) + m104dp2);
        this.thumbDrawable.draw(canvas);
        canvas.drawText(this.ext, (width - ((int) Math.ceil(docPaint.measureText(this.ext)))) / 2, AndroidUtilities.m104dp(31) + m104dp2, docPaint);
        canvas.drawText(this.fileName, (width - ((int) Math.ceil(namePaint.measureText(this.fileName)))) / 2, AndroidUtilities.m104dp(96) + m104dp2, namePaint);
        canvas.drawText(this.fileSize, (width - ((int) Math.ceil(sizePaint.measureText(this.fileSize)))) / 2, AndroidUtilities.m104dp(125) + m104dp2, sizePaint);
        if (this.loaded) {
            string = LocaleController.getString("OpenFile", C3634R.string.OpenFile);
            textPaint = openPaint;
            m104dp = 0;
        } else {
            if (this.loading) {
                string = LocaleController.getString("Cancel", C3634R.string.Cancel).toUpperCase();
            } else {
                string = LocaleController.getString("TapToDownload", C3634R.string.TapToDownload);
            }
            m104dp = AndroidUtilities.m104dp(28);
            textPaint = buttonPaint;
        }
        canvas.drawText(string, (width - ((int) Math.ceil(textPaint.measureText(string)))) / 2, AndroidUtilities.m104dp(235) + m104dp2 + m104dp, textPaint);
        if (this.progressVisible) {
            if (this.progress != null) {
                canvas.drawText(this.progress, (width - ((int) Math.ceil(percentPaint.measureText(str)))) / 2, AndroidUtilities.m104dp(210) + m104dp2, percentPaint);
            }
            int m104dp4 = (width - AndroidUtilities.m104dp((int) PsExtractor.VIDEO_STREAM_MASK)) / 2;
            int m104dp5 = m104dp2 + AndroidUtilities.m104dp(232);
            progressPaint.setColor(-10327179);
            progressPaint.setAlpha((int) (this.animatedAlphaValue * 255.0f));
            float f = m104dp5;
            canvas.drawRect(((int) (AndroidUtilities.m104dp((int) PsExtractor.VIDEO_STREAM_MASK) * this.animatedProgressValue)) + m104dp4, f, AndroidUtilities.m104dp((int) PsExtractor.VIDEO_STREAM_MASK) + m104dp4, AndroidUtilities.m104dp(2) + m104dp5, progressPaint);
            progressPaint.setColor(-1);
            progressPaint.setAlpha((int) (this.animatedAlphaValue * 255.0f));
            float f2 = m104dp4;
            canvas.drawRect(f2, f, f2 + (AndroidUtilities.m104dp((int) PsExtractor.VIDEO_STREAM_MASK) * this.animatedProgressValue), m104dp5 + AndroidUtilities.m104dp(2), progressPaint);
            updateAnimation();
        }
        canvas.restore();
    }
