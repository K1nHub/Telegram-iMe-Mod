...
public class ReactionsContainerLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ReactionsContainerLayout(int i, BaseFragment baseFragment, Context context, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.rect = new RectF();
        this.mPath = new Path();
        this.radius = AndroidUtilities.m104dp(72);
        float m104dp = AndroidUtilities.m104dp(8);
        this.bigCircleRadius = m104dp;
        this.smallCircleRadius = m104dp / 2.0f;
        this.bigCircleOffset = AndroidUtilities.m104dp(36);
        ...
        this.shadow = ContextCompat.getDrawable(context, C3634R.C3636drawable.reactions_bubble_shadow).mutate();
            ...
            public void getItemOffsets(Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (!ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                    ...
                    if (childAdapterPosition == 0) {
                        rect2.left = AndroidUtilities.m104dp(6);
                    }
                    rect2.right = AndroidUtilities.m104dp(4);
                    if (childAdapterPosition == ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                        if (ReactionsContainerLayout.this.showUnlockPremiumButton() || ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                            rect2.right = AndroidUtilities.m104dp(2);
                            return;
                        } else {
                            rect2.right = AndroidUtilities.m104dp(6);
                            return;
                        }
                    }
                    return;
        ...
        C54965 c54965 = new C54965(context, i);
        this.listAdapter = c54965;
        recyclerListView.setAdapter(c54965);
        ...
        recyclerListView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.ReactionsContainerLayout.7
            ...
            public void getItemOffsets(Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                int childAdapterPosition = recyclerView.getChildAdapterPosition(view);
                if (childAdapterPosition == 0) {
                    rect2.left = AndroidUtilities.m104dp(8);
                }
                if (childAdapterPosition == ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                    rect2.right = AndroidUtilities.m104dp(8);
                }
            }
        });
        ...
        this.nextRecentReaction.getLayoutParams().width = paddingTop - AndroidUtilities.m104dp(12);
    ...
    /* loaded from: classes6.dex */
    public class C54965 extends AdapterWithDiffUtils {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                ReactionsContainerLayout.this.premiumLockIconView.setPadding(AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(1));
                ReactionsContainerLayout reactionsContainerLayout = ReactionsContainerLayout.this;
                ...
                ReactionsContainerLayout.this.premiumLockIconView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$5$$ExternalSyntheticLambda1
                    ...
                    public final void onClick(View view2) {
                        ReactionsContainerLayout.C54965.this.lambda$onCreateViewHolder$0(view2);
                    }
                });
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setImageResource(C3634R.C3636drawable.msg_reactions_expand);
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m104dp(28), 0, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 40)));
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setPadding(AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(2));
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setContentDescription(LocaleController.getString(C3634R.string.AccDescrExpandPanel));
                ReactionsContainerLayout reactionsContainerLayout2 = ReactionsContainerLayout.this;
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$5$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        ReactionsContainerLayout.C54965.this.lambda$onCreateViewHolder$1(view2);
                    }
                });
                view = ReactionsContainerLayout.this.customReactionsContainer;
            }
            int m104dp = ((ReactionsContainerLayout.this.getLayoutParams().height - (ReactionsContainerLayout.this.hasHint ? AndroidUtilities.m104dp(20) : 0)) - ReactionsContainerLayout.this.getPaddingTop()) - ReactionsContainerLayout.this.getPaddingBottom();
            view.setLayoutParams(new RecyclerView.LayoutParams(m104dp - AndroidUtilities.m104dp(12), m104dp));
        ...
        public class InnerItem extends AdapterWithDiffUtils.Item {
            ...
            public InnerItem(C54965 c54965, int i, ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
                super(i, false);
    ...
    private void setVisibleReactionsList(List<ReactionsLayoutInBubble.VisibleReaction> list) {
        ...
        if (showCustomEmojiReaction()) {
            int m104dp = (AndroidUtilities.displaySize.x - AndroidUtilities.m104dp(36)) / AndroidUtilities.m104dp(34);
            if (m104dp > 7) {
                m104dp = 7;
            }
            int i = 0;
            ...
            while (i < Math.min(list.size(), m104dp)) {
        ...
        if ((((getLayoutParams().height - (this.hasHint ? AndroidUtilities.m104dp(20) : 0)) - getPaddingTop()) - getPaddingBottom()) * list.size() < AndroidUtilities.m104dp(200)) {
    ...
    */
    ...
    private void drawBubbles(Canvas canvas, float f, float f2, float f3, int i) {
        ...
        if (this.isTop) {
            ...
            canvas.clipRect(BitmapDescriptorFactory.HUE_RED, (AndroidUtilities.lerp(f4, (float) BitmapDescriptorFactory.HUE_RED, cubicBezierInterpolator.getInterpolation(this.flipVerticalProgress)) - ((int) Math.ceil((this.rect.height() / 2.0f) * (1.0f - this.transitionProgress)))) - 1.0f, getMeasuredWidth(), AndroidUtilities.lerp(getMeasuredHeight() + AndroidUtilities.m104dp(8), getPaddingTop() - expandSize(), cubicBezierInterpolator.getInterpolation(this.flipVerticalProgress)));
        }
        ...
        int m104dp = AndroidUtilities.m104dp(3);
        ...
        float lerp = AndroidUtilities.lerp(this.isTop ? (getPaddingTop() - expandSize()) - AndroidUtilities.m104dp(16) : ((getHeight() - this.smallCircleRadius) - f6) + expandSize(), (this.smallCircleRadius + f6) - expandSize(), CubicBezierInterpolator.DEFAULT.getInterpolation(this.flipVerticalProgress));
        float f11 = (-AndroidUtilities.m104dp(1)) * f2;
    ...
    private void checkPressedProgress(Canvas canvas, ReactionHolderView reactionHolderView) {
        ...
        float clamp = this.pullingLeftOffset != BitmapDescriptorFactory.HUE_RED ? Utilities.clamp(reactionHolderView.getLeft() / (getMeasuredWidth() - AndroidUtilities.m104dp(34)), 1.0f, (float) BitmapDescriptorFactory.HUE_RED) * getPullingLeftProgress() * AndroidUtilities.m104dp(46) : 0.0f;
    ...
    public float getPullingLeftProgress() {
        return Utilities.clamp(this.pullingLeftOffset / AndroidUtilities.m104dp(42), 2.0f, (float) BitmapDescriptorFactory.HUE_RED);
    }
    ...
    private void invalidateShaders() {
        ...
        this.leftShadowPaint.setShader(new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, height, m104dp, height, color, 0, Shader.TileMode.CLAMP));
        this.rightShadowPaint.setShader(new LinearGradient(getWidth(), height, getWidth() - m104dp, height, color, 0, Shader.TileMode.CLAMP));
        invalidate();
    }
    ...
    public int getTotalWidth() {
        ...
        if (!showCustomEmojiReaction()) {
            return (AndroidUtilities.m104dp(36) * itemsCount) + (AndroidUtilities.m104dp(2) * (itemsCount - 1)) + AndroidUtilities.m104dp(16);
        }
        return (AndroidUtilities.m104dp(36) * itemsCount) - AndroidUtilities.m104dp(4);
    }
    ...
    public void setCustomEmojiReactionsBackground(boolean z) {
        if (z) {
            this.customEmojiReactionsIconView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m104dp(28), 0, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 40)));
        } else {
    ...
    public void clearRecentReactions() {
        AlertDialog create = new AlertDialog.Builder(getContext()).setTitle(LocaleController.getString(C3634R.string.ClearRecentReactionsAlertTitle)).setMessage(LocaleController.getString(C3634R.string.ClearRecentReactionsAlertMessage)).setPositiveButton(LocaleController.getString(C3634R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$$ExternalSyntheticLambda1
    ...
    public void setHint(String str) {
        ...
        ((FrameLayout.LayoutParams) this.nextRecentReaction.getLayoutParams()).topMargin = AndroidUtilities.m104dp(20);
        ((FrameLayout.LayoutParams) this.recyclerListView.getLayoutParams()).topMargin = AndroidUtilities.m104dp(20);
    }
    ...
    public float getTopOffset() {
        return this.hasHint ? AndroidUtilities.m104dp(20) : BitmapDescriptorFactory.HUE_RED;
    }
    ...
    public final class ReactionHolderView extends FrameLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (visibleReaction != null) {
                ...
                accessibilityNodeInfo.setText(LocaleController.getString(C3634R.string.AccDescrCustomEmoji));
                accessibilityNodeInfo.setEnabled(true);
            }
        }
        ...
        ReactionHolderView(Context context, boolean z) {
            ...
            this.touchable = true;
            this.enterImageView = new C55032(context, r3);
        ...
        /* loaded from: classes6.dex */
        public class C55032 extends BackupImageView {
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C55032(Context context, ReactionsContainerLayout reactionsContainerLayout) {
                super(context);
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (reactionHolderView.shouldSwitchToLoopView && !reactionHolderView.switchedToLoopView && this.imageReceiver.getLottieAnimation() != null && this.imageReceiver.getLottieAnimation().isLastFrame() && ReactionHolderView.this.loopImageView.imageReceiver.getLottieAnimation() != null && ReactionHolderView.this.loopImageView.imageReceiver.getLottieAnimation().hasBitmap()) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$ReactionHolderView$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ReactionsContainerLayout.ReactionHolderView.C55032.this.lambda$dispatchDraw$0();
                        }
                    });
                }
                invalidate();
        ...
        public void setReaction(ReactionsLayoutInBubble.VisibleReaction visibleReaction, int i) {
            ...
            if (this.selected) {
                ...
                int m104dp = AndroidUtilities.m104dp(26);
                layoutParams2.height = m104dp;
                layoutParams.width = m104dp;
                ...
                int m104dp2 = AndroidUtilities.m104dp(26);
                layoutParams4.height = m104dp2;
                layoutParams3.width = m104dp2;
                return;
            }
            ...
            int m104dp3 = AndroidUtilities.m104dp(34);
            layoutParams6.height = m104dp3;
            layoutParams5.width = m104dp3;
            ...
            int m104dp4 = AndroidUtilities.m104dp(34);
            layoutParams8.height = m104dp4;
            layoutParams7.width = m104dp4;
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            if (this.selected && this.drawSelected) {
                canvas.drawCircle(getMeasuredWidth() >> 1, getMeasuredHeight() >> 1, (getMeasuredWidth() >> 1) - AndroidUtilities.m104dp(1), ReactionsContainerLayout.this.selectedPaint);
            }
            AnimatedEmojiDrawable animatedEmojiDrawable = this.loopImageView.animatedEmojiDrawable;
            if (animatedEmojiDrawable != null && animatedEmojiDrawable.getImageReceiver() != null) {
                if (this.position == 0) {
                    this.loopImageView.animatedEmojiDrawable.getImageReceiver().setRoundRadius(AndroidUtilities.m104dp(6), 0, 0, AndroidUtilities.m104dp(6));
                } else {
                    this.loopImageView.animatedEmojiDrawable.getImageReceiver().setRoundRadius(this.selected ? AndroidUtilities.m104dp(6) : 0);
                }
            }
            super.dispatchDraw(canvas);
        }
    ...
    public float expandSize() {
        return (int) (getPullingLeftProgress() * AndroidUtilities.m104dp(6));
    }
