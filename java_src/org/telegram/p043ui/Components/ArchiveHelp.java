...
public class ArchiveHelp extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ArchiveHelp(Context context, int i, Theme.ResourcesProvider resourcesProvider, Runnable runnable, final Runnable runnable2) {
        ...
        imageView.setImageResource(C3419R.C3421drawable.large_archive);
        ...
        textView.setText(LocaleController.getString("ArchiveHintHeader1", C3419R.string.ArchiveHintHeader1));
        ...
        linearLayout.addView(makeHint(C3419R.C3421drawable.msg_archive_archive, LocaleController.getString("ArchiveHintSection1"), LocaleController.getString("ArchiveHintSection1Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        linearLayout.addView(makeHint(C3419R.C3421drawable.msg_archive_hide, LocaleController.getString("ArchiveHintSection2"), LocaleController.getString("ArchiveHintSection2Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        linearLayout.addView(makeHint(C3419R.C3421drawable.msg_archive_stories, LocaleController.getString("ArchiveHintSection3"), LocaleController.getString("ArchiveHintSection3Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        if (runnable2 != null) {
    ...
    private void updateText() {
        ...
        Drawable mutate = getContext().getResources().getDrawable(C3419R.C3421drawable.msg_arrowright).mutate();
