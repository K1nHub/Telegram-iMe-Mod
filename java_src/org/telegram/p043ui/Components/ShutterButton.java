...
public class ShutterButton extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(measuredWidth - AndroidUtilities.m107dp(36), measuredHeight - AndroidUtilities.m107dp(36), AndroidUtilities.m107dp(36) + measuredWidth, AndroidUtilities.m107dp(36) + measuredHeight);
        ...
        if (this.pressed || getScaleX() != 1.0f) {
            ...
            canvas.drawCircle(f, f2, AndroidUtilities.m107dp(26), this.whitePaint);
            if (this.state == State.RECORDING) {
                ...
                canvas.drawCircle(f, f2, AndroidUtilities.m108dp(26.5f) * scaleX * this.redProgress, this.redPaint);
            } else if (this.redProgress != BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(f, f2, AndroidUtilities.m108dp(26.5f) * scaleX, this.redPaint);
            }
        } else if (this.redProgress != BitmapDescriptorFactory.HUE_RED) {
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m107dp(84), AndroidUtilities.m107dp(84));
    }
