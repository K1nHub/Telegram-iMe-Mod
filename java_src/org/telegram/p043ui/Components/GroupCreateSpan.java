...
public class GroupCreateSpan extends View {
    ...
    */
    public GroupCreateSpan(android.content.Context r30, java.lang.Object r31, org.telegram.messenger.ContactsController.Contact r32, boolean r33, org.telegram.p043ui.ActionBar.Theme.ResourcesProvider r34) {
        /*
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m72dp((this.small ? 20 : 32) + 25) + this.textWidth, AndroidUtilities.m72dp(this.small ? 28 : 32));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m72dp(this.small ? 28 : 32));
        ...
        canvas.drawRoundRect(this.rect, AndroidUtilities.m72dp(this.small ? 14 : 16), AndroidUtilities.m72dp(this.small ? 14 : 16), backPaint);
        ...
        if (this.progress != BitmapDescriptorFactory.HUE_RED) {
            ...
            canvas.drawCircle(AndroidUtilities.m72dp(this.small ? 14 : 16), AndroidUtilities.m72dp(this.small ? 14 : 16), AndroidUtilities.m72dp(this.small ? 14 : 16), backPaint);
            canvas.save();
            canvas.rotate((1.0f - this.progress) * 45.0f, AndroidUtilities.m72dp(16), AndroidUtilities.m72dp(16));
            this.deleteDrawable.setBounds(AndroidUtilities.m72dp(this.small ? 9 : 11), AndroidUtilities.m72dp(this.small ? 9 : 11), AndroidUtilities.m72dp(this.small ? 19 : 21), AndroidUtilities.m72dp(this.small ? 19 : 21));
            this.deleteDrawable.setAlpha((int) (this.progress * 255.0f));
            this.deleteDrawable.draw(canvas);
            canvas.restore();
        }
        canvas.translate(this.textX + AndroidUtilities.m72dp((this.small ? 26 : 32) + 9), AndroidUtilities.m72dp(this.small ? 6 : 8));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString("Delete", C3473R.string.Delete)));
    }
}
