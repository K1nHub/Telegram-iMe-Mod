...
public class GroupCreateSpan extends View {
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m107dp((this.small ? 20 : 32) + 25) + this.textWidth, AndroidUtilities.m107dp(this.small ? 28 : 32));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m107dp(this.small ? 28 : 32));
        ...
        canvas.drawRoundRect(this.rect, AndroidUtilities.m107dp(this.small ? 14 : 16), AndroidUtilities.m107dp(this.small ? 14 : 16), backPaint);
        ...
        if (this.progress != BitmapDescriptorFactory.HUE_RED) {
            ...
            canvas.drawCircle(AndroidUtilities.m107dp(this.small ? 14 : 16), AndroidUtilities.m107dp(this.small ? 14 : 16), AndroidUtilities.m107dp(this.small ? 14 : 16), backPaint);
            canvas.save();
            canvas.rotate((1.0f - this.progress) * 45.0f, AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16));
            this.deleteDrawable.setBounds(AndroidUtilities.m107dp(this.small ? 9 : 11), AndroidUtilities.m107dp(this.small ? 9 : 11), AndroidUtilities.m107dp(this.small ? 19 : 21), AndroidUtilities.m107dp(this.small ? 19 : 21));
            this.deleteDrawable.setAlpha((int) (this.progress * 255.0f));
            this.deleteDrawable.draw(canvas);
            canvas.restore();
        }
        canvas.translate(this.textX + AndroidUtilities.m107dp((this.small ? 26 : 32) + 9), AndroidUtilities.m107dp(this.small ? 6 : 8));
