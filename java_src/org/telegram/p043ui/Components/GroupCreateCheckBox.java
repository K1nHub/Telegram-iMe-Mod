...
public class GroupCreateCheckBox extends View {
    ...
    public GroupCreateCheckBox(Context context) {
        ...
        this.innerRadDiff = AndroidUtilities.m104dp(2);
        this.checkPaint.setStrokeWidth(AndroidUtilities.m105dp(1.5f));
        eraser2.setStrokeWidth(AndroidUtilities.m104dp(28));
        this.drawBitmap = Bitmap.createBitmap(AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(24), Bitmap.Config.ARGB_4444);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getVisibility() == 0 && this.progress != BitmapDescriptorFactory.HUE_RED) {
            ...
            eraser2.setStrokeWidth(AndroidUtilities.m104dp(30));
            ...
            if (f < 0.2f) {
                m104dp = (AndroidUtilities.m104dp(2) * f) / 0.2f;
            } else {
                m104dp = f < 0.4f ? AndroidUtilities.m104dp(2) - ((AndroidUtilities.m104dp(2) * (f - 0.2f)) / 0.2f) : 0.0f;
            }
            if (f3 != BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(measuredWidth, measuredHeight, ((measuredWidth - AndroidUtilities.m104dp(2)) + (AndroidUtilities.m104dp(2) * f3)) - m104dp, this.backgroundPaint);
            }
            float f4 = (measuredWidth - this.innerRadDiff) - m104dp;
            ...
            float m104dp2 = AndroidUtilities.m104dp(10) * f3 * this.checkScale;
            float m104dp3 = AndroidUtilities.m104dp(5) * f3 * this.checkScale;
            int m104dp4 = measuredWidth - AndroidUtilities.m104dp(1);
            float sqrt = (float) Math.sqrt((m104dp3 * m104dp3) / 2.0f);
            float f7 = m104dp4;
            float m104dp5 = measuredHeight + AndroidUtilities.m104dp(4);
            canvas.drawLine(f7, m104dp5, f7 - sqrt, m104dp5 - sqrt, this.checkPaint);
            float sqrt2 = (float) Math.sqrt((m104dp2 * m104dp2) / 2.0f);
            float m105dp = m104dp4 - AndroidUtilities.m105dp(1.2f);
            canvas.drawLine(m105dp, m104dp5, m105dp + sqrt2, m104dp5 - sqrt2, this.checkPaint);
        }
    }
}
