...
public class MentionsContainerView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public MentionsContainerView(Context context, long j, long j2, final BaseFragment baseFragment, SizeNotifierFrameLayout sizeNotifierFrameLayout, Theme.ResourcesProvider resourcesProvider) {
            ...
            */
            public org.telegram.p043ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r5, org.telegram.tgnet.TLRPC$FileLocation r6, int r7, boolean r8) {
                ...
                L80:
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.MentionsContainerView.C52135.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
        ...
        this.listViewPadding = (int) Math.min(AndroidUtilities.m108dp(126.0f), AndroidUtilities.displaySize.y * 0.22f);
        MentionsListView mentionsListView = new MentionsListView(context, resourcesProvider);
        this.listView = mentionsListView;
        mentionsListView.setTranslationY(AndroidUtilities.m107dp(6));
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context) { // from class: org.telegram.ui.Components.MentionsContainerView.1
            ...
            public void setReverseLayout(boolean z) {
                ...
                MentionsContainerView.this.listView.setTranslationY((z ? -1 : 1) * AndroidUtilities.m107dp(6));
            }
        };
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.containerPadding = AndroidUtilities.m107dp(((this.adapter.isStickers() || this.adapter.isBotContext()) && this.adapter.isMediaLayout() && this.adapter.getBotContextSwitch() == null && this.adapter.getBotWebViewSwitch() == null ? 2 : 0) + 2);
        ...
        if (isReversed) {
            ...
            min = Math.min(m107dp, Math.abs(getMeasuredHeight() - this.containerBottom));
            if (min > BitmapDescriptorFactory.HUE_RED) {
                this.rect.top -= (int) min;
            }
        } else {
            if (this.listView.getLayoutManager() == this.gridLayoutManager) {
                this.containerPadding += AndroidUtilities.m107dp(2);
            ...
            min = Math.min(m107dp, Math.abs(this.containerTop));
            if (min > BitmapDescriptorFactory.HUE_RED) {
        ...
        if (this.paint == null) {
            ...
            this.paint = paint;
            paint.setShadowLayer(AndroidUtilities.m107dp(4), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 503316480);
        }
        ...
        if (z) {
            ...
            if (!this.shown) {
                ...
                if (getVisibility() == 8) {
                    ...
                    mentionsListView.setTranslationY(isReversed ? -(this.listViewPadding + AndroidUtilities.m107dp(12)) : mentionsListView.computeVerticalScrollOffset() + this.listViewPadding);
                }
            }
            setVisibility(0);
        } else {
    ...
    private void updateListViewTranslation(final boolean z, boolean z2) {
        ...
        if (this.listView == null || this.paddedAdapter == null) {
            ...
            boolean isReversed = isReversed();
            if (z) {
                f = (-this.containerPadding) - AndroidUtilities.m107dp(6);
            } else {
    ...
    public class MentionsListView extends RecyclerListView {
        ...
        public MentionsListView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            addItemDecoration(new RecyclerView.ItemDecoration(r1) { // from class: org.telegram.ui.Components.MentionsContainerView.MentionsListView.2
                ...
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    ...
                    rect.right = MentionsContainerView.this.gridLayoutManager.isLastInRow(i) ? 0 : AndroidUtilities.m107dp(2);
                }
            });
        }
        ...
        public void onMeasure(int i, int i2) {
            ...
            MentionsContainerView.this.listViewPadding = (int) Math.min(AndroidUtilities.m108dp(126.0f), AndroidUtilities.displaySize.y * 0.22f);
