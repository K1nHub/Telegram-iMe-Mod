...
public class PollVotesAlert extends BottomSheet {
    ...
    public class SectionCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(32), 1073741824);
            ...
            measureChildWithMargins(this.textView, i, this.middleTextView.getMeasuredWidth() + this.righTextView.getMeasuredWidth() + AndroidUtilities.m104dp(32), makeMeasureSpec, 0);
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m104dp(32));
        }
        ...
        public void setText(String str, int i, int i2, int i3, boolean z) {
            ...
            textView.setText(Emoji.replaceEmoji((CharSequence) str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(14), false));
            ...
            if (i3 == 0) {
                ...
                this.righTextView.setText(LocaleController.getString("PollExpand", C3632R.string.PollExpand), z);
            } else {
                this.righTextView.setText(LocaleController.getString("PollCollapse", C3632R.string.PollCollapse), z);
            }
        }
    }
    ...
    public class UserCell extends FrameLayout {
        ...
        */
        public void update(int r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.PollVotesAlert.UserCell.update(int):void");
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (z || this.placeholderAlpha != BitmapDescriptorFactory.HUE_RED) {
                ...
                if (this.placeholderNum % 2 == 0) {
                    m104dp = AndroidUtilities.m104dp(65);
                    m104dp2 = AndroidUtilities.m104dp(48);
                } else {
                    m104dp = AndroidUtilities.m104dp(65);
                    m104dp2 = AndroidUtilities.m104dp(60);
                }
                if (LocaleController.isRTL) {
                    m104dp = (getMeasuredWidth() - m104dp) - m104dp2;
                }
                PollVotesAlert.this.rect.set(m104dp, top - AndroidUtilities.m104dp(4), m104dp + m104dp2, AndroidUtilities.m104dp(4) + top);
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), PollVotesAlert.this.placeholderPaint);
                if (this.placeholderNum % 2 == 0) {
                    m104dp3 = AndroidUtilities.m104dp(119);
                    m104dp4 = AndroidUtilities.m104dp(60);
                } else {
                    m104dp3 = AndroidUtilities.m104dp(131);
                    m104dp4 = AndroidUtilities.m104dp(80);
                }
                if (LocaleController.isRTL) {
                    m104dp3 = (getMeasuredWidth() - m104dp3) - m104dp4;
                }
                PollVotesAlert.this.rect.set(m104dp3, top - AndroidUtilities.m104dp(4), m104dp3 + m104dp4, top + AndroidUtilities.m104dp(4));
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), PollVotesAlert.this.placeholderPaint);
            }
            if (this.needDivider) {
                if (!LocaleController.isRTL) {
                    f = AndroidUtilities.m104dp(64);
                }
                canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m104dp(64) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
    }
    ...
    public PollVotesAlert(final ChatActivity chatActivity, MessageObject messageObject) {
        ...
        while (i4 < size) {
            ...
            if (tLRPC$TL_pollAnswerVoters.voters == 0) {
                ...
                tLRPC$TL_messages_getPollVotes.f1701id = this.messageObject.getId();
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) { // from class: org.telegram.ui.Components.PollVotesAlert.3
            ...
            protected void onMeasure(int i10, int i11) {
                ...
                ((FrameLayout.LayoutParams) PollVotesAlert.this.listView.getLayoutParams()).topMargin = C3704ActionBar.getCurrentActionBarHeight();
                ((FrameLayout.LayoutParams) PollVotesAlert.this.actionBarShadow.getLayoutParams()).topMargin = C3704ActionBar.getCurrentActionBarHeight();
                int m104dp = ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + AndroidUtilities.m104dp(15) + AndroidUtilities.statusBarHeight;
                ...
                for (int i12 = 0; i12 < sectionCount; i12++) {
                    if (i12 == 0) {
                        ...
                        m104dp += PollVotesAlert.this.titleTextView.getMeasuredHeight();
                    } else {
                        m104dp += AndroidUtilities.m104dp(32) + (AndroidUtilities.m104dp(50) * (PollVotesAlert.this.listAdapter.getCountForSection(i12) - 1));
                    }
                }
                int m104dp2 = (m104dp < paddingTop ? paddingTop - m104dp : paddingTop - ((paddingTop / 5) * 3)) + AndroidUtilities.m104dp(8);
                if (PollVotesAlert.this.listView.getPaddingTop() != m104dp2) {
                    this.ignoreLayout = true;
                    PollVotesAlert.this.listView.setPinnedSectionOffsetY(-m104dp2);
                    PollVotesAlert.this.listView.setPadding(0, m104dp2, 0, 0);
                    this.ignoreLayout = false;
                }
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0 && PollVotesAlert.this.scrollOffsetY != 0 && motionEvent.getY() < PollVotesAlert.this.scrollOffsetY + AndroidUtilities.m104dp(12) && PollVotesAlert.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i10 = (PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - m104dp;
                if (((BottomSheet) PollVotesAlert.this).currentSheetAnimationType == 1) {
                    i10 = (int) (i10 + PollVotesAlert.this.listView.getTranslationY());
                }
                int m104dp2 = AndroidUtilities.m104dp(20) + i10;
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m104dp(15) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop;
                if (((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10 < C3704ActionBar.getCurrentActionBarHeight()) {
                    float m104dp3 = m104dp + AndroidUtilities.m104dp(4);
                    float min = Math.min(1.0f, ((C3704ActionBar.getCurrentActionBarHeight() - i10) - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) / m104dp3);
                ...
                if (f != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10, getMeasuredWidth() - ((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10 + AndroidUtilities.m104dp(24));
        ...
        this.listView.setLayoutManager(new LinearLayoutManager(this, getContext(), 1, false) { // from class: org.telegram.ui.Components.PollVotesAlert.5
            ...
            protected int getExtraLayoutSpace(RecyclerView.State state) {
                return AndroidUtilities.m104dp((int) WearableStatusCodes.TARGET_NODE_NOT_CONNECTED);
            }
        });
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.PollVotesAlert.6
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i11) {
                if (i11 == 0) {
                    if (((PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - AndroidUtilities.m104dp(13)) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop >= C3704ActionBar.getCurrentActionBarHeight() || !PollVotesAlert.this.listView.canScrollVertically(1)) {
                        return;
                    }
                    ...
                    PollVotesAlert.this.listView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m104dp(7));
                }
            }
        });
        ...
        this.titleTextView.setPadding(AndroidUtilities.m104dp(21), AndroidUtilities.m104dp(5), AndroidUtilities.m104dp(14), AndroidUtilities.m104dp(21));
        ...
        textView3.setText(Emoji.replaceEmoji((CharSequence) this.poll.question, textView3.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(18), false));
        C3704ActionBar c3704ActionBar = new C3704ActionBar(parentActivity) { // from class: org.telegram.ui.Components.PollVotesAlert.7
            @Override // android.view.View
        ...
        c3704ActionBar.setBackgroundColor(Theme.getColor(i9));
        ...
        this.actionBar.setTitle(LocaleController.getString("PollResults", C3632R.string.PollResults));
        if (this.poll.quiz) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3704ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Components.PollVotesAlert.8
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            if (view instanceof TextCell) {
                ...
                if (userCell.currentUser != null) {
                    bundle.putLong("user_id", userCell.currentUser.f1749id);
                } else {
                    bundle.putLong("chat_id", userCell.currentChat.f1602id);
                }
                dismiss();
                ProfileActivity profileActivity = new ProfileActivity(bundle);
                if (userCell.currentUser != null) {
                    TLRPC$User currentUser = chatActivity.getCurrentUser();
                    if (currentUser != null && currentUser.f1749id == userCell.currentUser.f1749id) {
                        i2 = 1;
                    }
                    profileActivity.setPlayProfileAnimation(i2);
                } else {
                    TLRPC$Chat currentChat = chatActivity.getCurrentChat();
                    if (currentChat != null && currentChat.f1602id == userCell.currentChat.f1602id) {
                        i2 = 1;
                    }
                    profileActivity.setPlayProfileAnimation(i2);
                }
    ...
    public void updateLayout(boolean z) {
        ...
        int m104dp2 = top + (layoutParams.topMargin - AndroidUtilities.m104dp(11));
        if (this.scrollOffsetY != m104dp2) {
            RecyclerListView recyclerListView2 = this.listView;
            this.scrollOffsetY = m104dp2;
            recyclerListView2.setTopGlowOffset(m104dp2 - layoutParams.topMargin);
            this.containerView.invalidate();
        }
    }
    ...
    public void updatePlaceholder() {
        ...
        float m104dp = AndroidUtilities.m104dp(500);
        this.gradientWidth = m104dp;
        LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, m104dp, (float) BitmapDescriptorFactory.HUE_RED, new int[]{color2, averageColor, color2}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.18f, 0.36f}, Shader.TileMode.REPEAT);
    ...
    public class Adapter extends RecyclerListView.SectionsAdapter {
        ...
        private SectionCell createSectionCell() {
            return new SectionCell(this.mContext) { // from class: org.telegram.ui.Components.PollVotesAlert.Adapter.1
                ...
                @Override // org.telegram.p043ui.Components.PollVotesAlert.SectionCell
                protected void onCollapseClick() {
                    VotesList votesList = (VotesList) getTag(C3632R.C3635id.object_tag);
            ...
            if (i == 0) {
                ...
                while (true) {
                    ...
                    if (Arrays.equals(tLRPC$TL_pollAnswer.option, votesList.option) && ((Button) PollVotesAlert.this.votesPercents.get(votesList)) != null) {
                        ...
                        sectionCell.setTag(C3632R.C3635id.object_tag, votesList);
                        break;
                    }
                    i2++;
                }
        ...
        public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
            ...
            if (itemViewType != 2) {
                ...
                VotesList votesList = (VotesList) PollVotesAlert.this.voters.get(i - 1);
                ((TextCell) viewHolder.itemView).setTextAndIcon(LocaleController.formatPluralString("ShowVotes", votesList.count - votesList.getCount(), new Object[0]), C3632R.C3634drawable.arrow_more, false);
                return;
            }
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (Arrays.equals(tLRPC$TL_pollAnswer.option, votesList2.option) && ((Button) PollVotesAlert.this.votesPercents.get(votesList2)) != null) {
                    ...
                    sectionCell.setTag(C3632R.C3635id.object_tag, votesList2);
                    return;
                }
            }
        }
    ...
    public void animateSectionUpdates(View view) {
        ...
        while (i < this.listView.getChildCount()) {
            ...
            if (pinnedHeader instanceof SectionCell) {
                int i2 = C3632R.C3635id.object_tag;
