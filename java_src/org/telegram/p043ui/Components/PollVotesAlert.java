...
public class PollVotesAlert extends BottomSheet {
    ...
    public class SectionCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(32), 1073741824);
            ...
            measureChildWithMargins(this.textView, i, this.middleTextView.getMeasuredWidth() + this.righTextView.getMeasuredWidth() + AndroidUtilities.m107dp(32), makeMeasureSpec, 0);
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(32));
        }
        ...
        public void setText(String str, int i, int i2, int i3, boolean z) {
            ...
            textView.setText(Emoji.replaceEmoji((CharSequence) str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m107dp(14), false));
    ...
    public class UserCell extends FrameLayout {
        ...
        public UserCell(Context context) {
            ...
            addView(simpleTextView2, LayoutHelper.createFrame(-1, 24, (z2 ? 5 : 3) | 48, z2 ? 28 : 65, 12, z2 ? 65 : 28, 0));
        ...
        /* JADX WARN: Code restructure failed: missing block: B:52:0x0074, code lost:
            if (android.text.TextUtils.equals(r1, r10.lastName) == false) goto L34;
         */
        /*
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (z || this.placeholderAlpha != BitmapDescriptorFactory.HUE_RED) {
                ...
                if (this.placeholderNum % 2 == 0) {
                    m107dp = AndroidUtilities.m107dp(65);
                    m107dp2 = AndroidUtilities.m107dp(48);
                } else {
                    m107dp = AndroidUtilities.m107dp(65);
                    m107dp2 = AndroidUtilities.m107dp(60);
                }
                if (LocaleController.isRTL) {
                    m107dp = (getMeasuredWidth() - m107dp) - m107dp2;
                }
                PollVotesAlert.this.rect.set(m107dp, top - AndroidUtilities.m107dp(4), m107dp + m107dp2, AndroidUtilities.m107dp(4) + top);
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), PollVotesAlert.this.placeholderPaint);
                if (this.placeholderNum % 2 == 0) {
                    m107dp3 = AndroidUtilities.m107dp(119);
                    m107dp4 = AndroidUtilities.m107dp(60);
                } else {
                    m107dp3 = AndroidUtilities.m107dp(131);
                    m107dp4 = AndroidUtilities.m107dp(80);
                }
                if (LocaleController.isRTL) {
                    m107dp3 = (getMeasuredWidth() - m107dp3) - m107dp4;
                }
                PollVotesAlert.this.rect.set(m107dp3, top - AndroidUtilities.m107dp(4), m107dp3 + m107dp4, top + AndroidUtilities.m107dp(4));
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), PollVotesAlert.this.placeholderPaint);
            }
            if (this.needDivider) {
                if (!LocaleController.isRTL) {
                    f = AndroidUtilities.m107dp(64);
                }
                canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m107dp(64) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
    }
    ...
    public PollVotesAlert(final ChatActivity chatActivity, MessageObject messageObject) {
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) { // from class: org.telegram.ui.Components.PollVotesAlert.3
            ...
            protected void onMeasure(int i10, int i11) {
                ...
                int m107dp = ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + AndroidUtilities.m107dp(15) + AndroidUtilities.statusBarHeight;
                ...
                for (int i12 = 0; i12 < sectionCount; i12++) {
                    if (i12 == 0) {
                        ...
                        m107dp += PollVotesAlert.this.titleTextView.getMeasuredHeight();
                    } else {
                        m107dp += AndroidUtilities.m107dp(32) + (AndroidUtilities.m107dp(50) * (PollVotesAlert.this.listAdapter.getCountForSection(i12) - 1));
                    }
                }
                int m107dp2 = (m107dp < paddingTop ? paddingTop - m107dp : paddingTop - ((paddingTop / 5) * 3)) + AndroidUtilities.m107dp(8);
                if (PollVotesAlert.this.listView.getPaddingTop() != m107dp2) {
                    this.ignoreLayout = true;
                    PollVotesAlert.this.listView.setPinnedSectionOffsetY(-m107dp2);
                    PollVotesAlert.this.listView.setPadding(0, m107dp2, 0, 0);
                    this.ignoreLayout = false;
                }
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0 && PollVotesAlert.this.scrollOffsetY != 0 && motionEvent.getY() < PollVotesAlert.this.scrollOffsetY + AndroidUtilities.m107dp(12) && PollVotesAlert.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i10 = (PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - m107dp;
                if (((BottomSheet) PollVotesAlert.this).currentSheetAnimationType == 1) {
                    i10 = (int) (i10 + PollVotesAlert.this.listView.getTranslationY());
                }
                int m107dp2 = AndroidUtilities.m107dp(20) + i10;
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m107dp(15) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop;
                if (((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10 < C3704ActionBar.getCurrentActionBarHeight()) {
                    ...
                    float min = Math.min(1.0f, ((C3704ActionBar.getCurrentActionBarHeight() - i10) - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) / m107dp3);
                ...
                if (f != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10, getMeasuredWidth() - ((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i10 + AndroidUtilities.m107dp(24));
        ...
        this.listView.setLayoutManager(new LinearLayoutManager(this, getContext(), 1, false) { // from class: org.telegram.ui.Components.PollVotesAlert.5
            ...
            protected int getExtraLayoutSpace(RecyclerView.State state) {
                return AndroidUtilities.m107dp((int) WearableStatusCodes.TARGET_NODE_NOT_CONNECTED);
            }
        });
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.PollVotesAlert.6
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i11) {
                if (i11 == 0) {
                    if (((PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - AndroidUtilities.m107dp(13)) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop >= C3704ActionBar.getCurrentActionBarHeight() || !PollVotesAlert.this.listView.canScrollVertically(1)) {
                        return;
                    }
                    ...
                    PollVotesAlert.this.listView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m107dp(7));
                }
            }
        });
        ...
        this.titleTextView.setPadding(AndroidUtilities.m107dp(21), AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(14), AndroidUtilities.m107dp(21));
        ...
        textView3.setText(Emoji.replaceEmoji((CharSequence) this.poll.question, textView3.getPaint().getFontMetricsInt(), AndroidUtilities.m107dp(18), false));
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            if (view instanceof TextCell) {
                ...
                if (userCell.currentUser != null) {
                    bundle.putLong("user_id", userCell.currentUser.f1751id);
                } else {
                ...
                if (userCell.currentUser != null) {
                    ...
                    if (currentUser != null && currentUser.f1751id == userCell.currentUser.f1751id) {
                        i2 = 1;
                    }
    ...
    public void updateLayout(boolean z) {
        ...
        int m107dp2 = top + (layoutParams.topMargin - AndroidUtilities.m107dp(11));
        if (this.scrollOffsetY != m107dp2) {
            RecyclerListView recyclerListView2 = this.listView;
            this.scrollOffsetY = m107dp2;
            recyclerListView2.setTopGlowOffset(m107dp2 - layoutParams.topMargin);
            this.containerView.invalidate();
        }
    }
    ...
    public class Adapter extends RecyclerListView.SectionsAdapter {
        ...
        public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
            ...
            if (itemViewType != 2) {
                ...
                VotesList votesList = (VotesList) PollVotesAlert.this.voters.get(i - 1);
                ((TextCell) viewHolder.itemView).setTextAndIcon((CharSequence) LocaleController.formatPluralString("ShowVotes", votesList.count - votesList.getCount(), new Object[0]), C3632R.C3634drawable.arrow_more, false);
                return;
            }
