...
public class InviteMembersBottomSheet extends UsersAlertBase implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void filterOwnedChats() {
        if (this.isCryptoboxChatSelection) {
            ...
            while (it.hasNext()) {
                ...
                if (dialogFilter.includesDialog(this.parentFragment.getAccountInstance(), next.f1608id, next)) {
                    arrayList.add(next);
                }
            }
    ...
    public InviteMembersBottomSheet(final Context context, int i, final LongSparseArray<TLObject> longSparseArray, final long j, final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.chatId = j;
        fixNavigationBar();
        this.searchView.searchEditText.setHint(LocaleController.getString("SearchForChats", C3634R.string.SearchForChats));
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.2
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                if (AndroidUtilities.isTablet() || size2 > size) {
                    InviteMembersBottomSheet.this.maxSize = AndroidUtilities.m104dp(144);
                } else {
                    InviteMembersBottomSheet.this.maxSize = AndroidUtilities.m104dp(56);
                }
        ...
        imageView.setImageResource(C3634R.C3636drawable.floating_check);
        if (i3 >= 21) {
            StateListAnimator stateListAnimator = new StateListAnimator();
            stateListAnimator.addState(new int[]{16842919}, ObjectAnimator.ofFloat(imageView, "translationZ", AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(4)).setDuration(200L));
            stateListAnimator.addState(new int[0], ObjectAnimator.ofFloat(imageView, "translationZ", AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(2)).setDuration(200L));
        ...
        imageView.setContentDescription(LocaleController.getString("Next", C3634R.string.Next));
        inviteMembersBottomSheet.containerView.addView(imageView, LayoutHelper.createFrame(i3 >= 21 ? 56 : 60, i3 >= 21 ? 56 : 60, 85, 14, 14, 14, 14));
        ((ViewGroup.MarginLayoutParams) inviteMembersBottomSheet.emptyView.getLayoutParams()).topMargin = AndroidUtilities.m104dp(20);
        ((ViewGroup.MarginLayoutParams) inviteMembersBottomSheet.emptyView.getLayoutParams()).leftMargin = AndroidUtilities.m104dp(4);
        ((ViewGroup.MarginLayoutParams) inviteMembersBottomSheet.emptyView.getLayoutParams()).rightMargin = AndroidUtilities.m104dp(4);
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$new$4(Context context, long j, View view) {
        ...
        if (this.selectedContacts.size() > 5) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", C3634R.string.AddMembersAlertNamesText, sb, chat.title)));
        }
        builder.setPositiveButton(LocaleController.getString("Add", C3634R.string.Add), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda1
    ...
    */
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            if (i == 2) {
                manageChatTextCell = new View(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.ListAdapter.1
                    ...
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(48) + InviteMembersBottomSheet.this.additionalHeight, 1073741824));
                    }
                };
            } else if (i == 3) {
                ...
                manageChatTextCell2.setText(LocaleController.getString("VoipGroupCopyInviteLink", C3634R.string.VoipGroupCopyInviteLink), null, C3634R.C3636drawable.msg_link, 7, true);
                ...
                if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                    stickerEmptyView.title.setText(LocaleController.getString("FilterNoChats", C3634R.string.FilterNoChats));
                } else {
                    stickerEmptyView.title.setText(LocaleController.getString("NoContacts", C3634R.string.NoContacts));
                }
        ...
        public TLObject getObject(int i) {
            if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                ...
                return DialogObject.isUserDialog(tLRPC$Dialog.f1608id) ? MessagesController.getInstance(((BottomSheet) InviteMembersBottomSheet.this).currentAccount).getUser(Long.valueOf(tLRPC$Dialog.f1608id)) : MessagesController.getInstance(((BottomSheet) InviteMembersBottomSheet.this).currentAccount).getChat(Long.valueOf(-tLRPC$Dialog.f1608id));
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 2) {
                ...
                if (object2 instanceof TLRPC$User) {
                    j = ((TLRPC$User) object2).f1749id;
                } else {
                    j = object2 instanceof TLRPC$Chat ? -((TLRPC$Chat) object2).f1602id : 0L;
                }
                boolean z = true;
                groupCreateUserCell.setObject(object, null, null, i != InviteMembersBottomSheet.this.contactsEndRow);
                if (object instanceof TLRPC$User) {
                    j2 = ((TLRPC$User) object).f1749id;
                } else {
                    j2 = object instanceof TLRPC$Chat ? -((TLRPC$Chat) object).f1602id : 0L;
                }
                if (j2 != 0) {
                    if (InviteMembersBottomSheet.this.isCryptoboxChatSelection) {
            ...
            if (InviteMembersBottomSheet.this.isCryptoboxChatSelection) {
                ...
                while (it.hasNext()) {
                    ...
                    if (next instanceof TLRPC$Dialog) {
                        ...
                        if (InviteMembersBottomSheet.this.filter.includesDialog(InviteMembersBottomSheet.this.parentFragment.getAccountInstance(), tLRPC$Dialog.f1608id, tLRPC$Dialog)) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                groupCreateUserCell = new View(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.SearchAdapter.1
                    @Override // android.view.View
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(48) + InviteMembersBottomSheet.this.additionalHeight + InviteMembersBottomSheet.this.searchAdditionalHeight, 1073741824));
                    }
                };
            } else if (i != 4) {
    ...
    protected void onSearchViewTouched(MotionEvent motionEvent, final EditTextBoldCursor editTextBoldCursor) {
        if (motionEvent.getAction() == 0) {
            this.f1858y = this.scrollOffsetY;
        } else if (motionEvent.getAction() != 1 || Math.abs(this.scrollOffsetY - this.f1858y) >= this.touchSlop || this.enterEventSent) {
        } else {
    ...
    public class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int m104dp = size - AndroidUtilities.m104dp(26);
            int m104dp2 = AndroidUtilities.m104dp(10);
            int m104dp3 = AndroidUtilities.m104dp(10);
            int i3 = 0;
            int i4 = 0;
            for (int i5 = 0; i5 < childCount; i5++) {
                View childAt = getChildAt(i5);
                if (childAt instanceof GroupCreateSpan) {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(32), 1073741824));
                    if (childAt != this.removingSpan && childAt.getMeasuredWidth() + i3 > m104dp) {
                        m104dp2 += childAt.getMeasuredHeight() + AndroidUtilities.m104dp(8);
                        i3 = 0;
                    }
                    if (childAt.getMeasuredWidth() + i4 > m104dp) {
                        m104dp3 += childAt.getMeasuredHeight() + AndroidUtilities.m104dp(8);
                        i4 = 0;
                    }
                    int m104dp4 = AndroidUtilities.m104dp(13) + i3;
                    if (!this.animationStarted) {
                        View view = this.removingSpan;
                        if (childAt == view) {
                            childAt.setTranslationX(AndroidUtilities.m104dp(13) + i4);
                            childAt.setTranslationY(m104dp3);
                        } else if (view != null) {
                            float f = m104dp4;
                            ...
                            childAt.setTranslationX(m104dp4);
                            childAt.setTranslationY(m104dp2);
                        }
                    }
                    if (childAt != this.removingSpan) {
                        i3 += childAt.getMeasuredWidth() + AndroidUtilities.m104dp(9);
                    }
                    i4 += childAt.getMeasuredWidth() + AndroidUtilities.m104dp(9);
                }
            }
            int m104dp5 = m104dp3 + AndroidUtilities.m104dp(42);
            final int m104dp6 = m104dp2 + AndroidUtilities.m104dp(42);
            int min = InviteMembersBottomSheet.this.dialogsDelegate != null ? InviteMembersBottomSheet.this.spanEnter ? Math.min(InviteMembersBottomSheet.this.maxSize, m104dp6) : 0 : Math.max(0, Math.min(InviteMembersBottomSheet.this.maxSize, m104dp6) - AndroidUtilities.m104dp(52));
            int i6 = InviteMembersBottomSheet.this.searchAdditionalHeight;
            InviteMembersBottomSheet inviteMembersBottomSheet = InviteMembersBottomSheet.this;
            inviteMembersBottomSheet.searchAdditionalHeight = (inviteMembersBottomSheet.dialogsDelegate != null || InviteMembersBottomSheet.this.selectedContacts.size() <= 0) ? 0 : AndroidUtilities.m104dp(56);
            ...
            int min2 = Math.min(InviteMembersBottomSheet.this.maxSize, m104dp6);
            ...
            if (this.addAnimation && m104dp6 > InviteMembersBottomSheet.this.maxSize) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteMembersBottomSheet.SpansContainer.this.lambda$onMeasure$1(m104dp6);
                    }
                });
            } else if (!this.addAnimation && InviteMembersBottomSheet.this.spansScrollView.getScrollY() + InviteMembersBottomSheet.this.spansScrollView.getMeasuredHeight() > m104dp6) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteMembersBottomSheet.SpansContainer.this.lambda$onMeasure$2(m104dp6);
                    }
                });
            }
            ...
            setMeasuredDimension(size, Math.max(m104dp6, m104dp5));
    ...
    protected UsersAlertBase.ContainerView createContainerView(Context context) {
        return new UsersAlertBase.ContainerView(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.6
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                InviteMembersBottomSheet inviteMembersBottomSheet2 = InviteMembersBottomSheet.this;
                InviteMembersBottomSheet.this.spansScrollView.setTranslationY((inviteMembersBottomSheet2.scrollOffsetY - ((BottomSheet) inviteMembersBottomSheet2).backgroundPaddingTop) + AndroidUtilities.m104dp(6) + AndroidUtilities.m104dp(64));
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                if (view == InviteMembersBottomSheet.this.spansScrollView) {
                    canvas.save();
                    canvas.clipRect(BitmapDescriptorFactory.HUE_RED, view.getY() - AndroidUtilities.m104dp(4), getMeasuredWidth(), view.getY() + InviteMembersBottomSheet.this.scrollViewH + 1.0f);
