...
public class StorageUsageView extends FrameLayout {
    ...
    public StorageUsageView(Context context) {
        ...
        this.paintFill.setStrokeWidth(AndroidUtilities.m107dp(6));
        this.paintCalculcating.setStrokeWidth(AndroidUtilities.m107dp(6));
        this.paintProgress.setStrokeWidth(AndroidUtilities.m107dp(6));
        this.paintProgress2.setStrokeWidth(AndroidUtilities.m107dp(6));
                ...
                for (int i6 = 0; i6 < childCount; i6++) {
                    if (getChildAt(i6).getVisibility() != 8) {
                        if (getChildAt(i6).getMeasuredWidth() + i4 > View.MeasureSpec.getSize(i)) {
                            i5 += getChildAt(i6).getMeasuredHeight() + AndroidUtilities.m107dp(8);
                            i4 = 0;
                        }
                        i4 += getChildAt(i6).getMeasuredWidth() + AndroidUtilities.m107dp(16);
                ...
                for (int i7 = 0; i7 < childCount; i7++) {
                    if (getChildAt(i7).getVisibility() != 8) {
                        if (getChildAt(i7).getMeasuredWidth() + i5 > getMeasuredWidth()) {
                            i6 += getChildAt(i7).getMeasuredHeight() + AndroidUtilities.m107dp(8);
                            i5 = 0;
                        }
                        getChildAt(i7).layout(i5, i6, getChildAt(i7).getMeasuredWidth() + i5, getChildAt(i7).getMeasuredHeight() + i6);
                        i5 += getChildAt(i7).getMeasuredWidth() + AndroidUtilities.m107dp(16);
                    }
                }
            }
        };
        ...
        textView2.setCompoundDrawablePadding(AndroidUtilities.m107dp(6));
        this.telegramCacheTextView.setTextColor(Theme.getColor(i));
        TextView textView3 = new TextView(context);
        this.telegramDatabaseTextView = textView3;
        textView3.setCompoundDrawablePadding(AndroidUtilities.m107dp(6));
        this.telegramDatabaseTextView.setTextColor(Theme.getColor(i));
        TextView textView4 = new TextView(context);
        this.freeSizeTextView = textView4;
        textView4.setCompoundDrawablePadding(AndroidUtilities.m107dp(6));
        this.freeSizeTextView.setTextColor(Theme.getColor(i));
        TextView textView5 = new TextView(context);
        this.totlaSizeTextView = textView5;
        textView5.setCompoundDrawablePadding(AndroidUtilities.m107dp(6));
        this.totlaSizeTextView.setTextColor(Theme.getColor(i));
        this.lastProgressColor = Theme.getColor(Theme.key_player_progress);
        this.telegramCacheTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m107dp(10), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramCacheTextView.setCompoundDrawablePadding(AndroidUtilities.m107dp(6));
        this.freeSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m107dp(10), ColorUtils.setAlphaComponent(this.lastProgressColor, 64)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.freeSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m107dp(6));
        this.totlaSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m107dp(10), ColorUtils.setAlphaComponent(this.lastProgressColor, 127)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.totlaSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m107dp(6));
        this.telegramDatabaseTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m107dp(10), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramDatabaseTextView.setCompoundDrawablePadding(AndroidUtilities.m107dp(6));
    ...
    public class ProgressView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawLine(AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(20), getMeasuredWidth() - AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(20), StorageUsageView.this.paintFill);
            if (StorageUsageView.this.calculating || StorageUsageView.this.calculatingProgress != BitmapDescriptorFactory.HUE_RED) {
                ...
                rectF.set(AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(17), getMeasuredWidth() - AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(23));
                StorageUsageView.this.cellFlickerDrawable.setParentWidth(getMeasuredWidth());
                StorageUsageView.this.cellFlickerDrawable.draw(canvas, rectF, AndroidUtilities.m107dp(3), null);
            }
            int m107dp = AndroidUtilities.m107dp(24);
            if (!StorageUsageView.this.calculating) {
                int measuredWidth = (int) ((getMeasuredWidth() - (AndroidUtilities.m107dp(24) * 2)) * StorageUsageView.this.progress2);
                int m107dp2 = AndroidUtilities.m107dp(24) + measuredWidth;
                canvas.drawLine(m107dp, AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(24) + measuredWidth, AndroidUtilities.m107dp(20), StorageUsageView.this.paintProgress2);
                canvas.drawRect(m107dp2, AndroidUtilities.m107dp(20) - AndroidUtilities.m107dp(3), m107dp2 + AndroidUtilities.m107dp(3), AndroidUtilities.m107dp(20) + AndroidUtilities.m107dp(3), StorageUsageView.this.bgPaint);
            }
            if (StorageUsageView.this.calculating) {
                return;
            }
            int measuredWidth2 = (int) ((getMeasuredWidth() - (AndroidUtilities.m107dp(24) * 2)) * StorageUsageView.this.progress);
            if (measuredWidth2 < AndroidUtilities.m108dp(1.0f)) {
                measuredWidth2 = AndroidUtilities.m108dp(1.0f);
            }
            int m107dp3 = AndroidUtilities.m107dp(24) + measuredWidth2;
            canvas.drawLine(m107dp, AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(24) + measuredWidth2, AndroidUtilities.m107dp(20), StorageUsageView.this.paintProgress);
            canvas.drawRect(m107dp3, AndroidUtilities.m107dp(20) - AndroidUtilities.m107dp(3), m107dp3 + AndroidUtilities.m107dp(3), AndroidUtilities.m107dp(20) + AndroidUtilities.m107dp(3), StorageUsageView.this.bgPaint);
        }
    }
