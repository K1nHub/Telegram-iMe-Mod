...
public class StorageUsageView extends FrameLayout {
    ...
    public StorageUsageView(Context context) {
        ...
        this.paintFill.setStrokeWidth(AndroidUtilities.m104dp(6));
        this.paintCalculcating.setStrokeWidth(AndroidUtilities.m104dp(6));
        this.paintProgress.setStrokeWidth(AndroidUtilities.m104dp(6));
        this.paintProgress2.setStrokeWidth(AndroidUtilities.m104dp(6));
                ...
                for (int i6 = 0; i6 < childCount; i6++) {
                    if (getChildAt(i6).getVisibility() != 8) {
                        if (getChildAt(i6).getMeasuredWidth() + i4 > View.MeasureSpec.getSize(i)) {
                            i5 += getChildAt(i6).getMeasuredHeight() + AndroidUtilities.m104dp(8);
                            i4 = 0;
                        }
                        i4 += getChildAt(i6).getMeasuredWidth() + AndroidUtilities.m104dp(16);
                ...
                for (int i7 = 0; i7 < childCount; i7++) {
                    if (getChildAt(i7).getVisibility() != 8) {
                        if (getChildAt(i7).getMeasuredWidth() + i5 > getMeasuredWidth()) {
                            i6 += getChildAt(i7).getMeasuredHeight() + AndroidUtilities.m104dp(8);
                            i5 = 0;
                        }
                        getChildAt(i7).layout(i5, i6, getChildAt(i7).getMeasuredWidth() + i5, getChildAt(i7).getMeasuredHeight() + i6);
                        i5 += getChildAt(i7).getMeasuredWidth() + AndroidUtilities.m104dp(16);
                    }
                }
            }
        };
        ...
        String string = LocaleController.getString("CalculatingSize", C3634R.string.CalculatingSize);
        ...
        textView2.setCompoundDrawablePadding(AndroidUtilities.m104dp(6));
        this.telegramCacheTextView.setTextColor(Theme.getColor(i));
        TextView textView3 = new TextView(context);
        this.telegramDatabaseTextView = textView3;
        textView3.setCompoundDrawablePadding(AndroidUtilities.m104dp(6));
        this.telegramDatabaseTextView.setTextColor(Theme.getColor(i));
        TextView textView4 = new TextView(context);
        this.freeSizeTextView = textView4;
        textView4.setCompoundDrawablePadding(AndroidUtilities.m104dp(6));
        this.freeSizeTextView.setTextColor(Theme.getColor(i));
        TextView textView5 = new TextView(context);
        this.totlaSizeTextView = textView5;
        textView5.setCompoundDrawablePadding(AndroidUtilities.m104dp(6));
        this.totlaSizeTextView.setTextColor(Theme.getColor(i));
        this.lastProgressColor = Theme.getColor(Theme.key_player_progress);
        this.telegramCacheTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m104dp(10), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramCacheTextView.setCompoundDrawablePadding(AndroidUtilities.m104dp(6));
        this.freeSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m104dp(10), ColorUtils.setAlphaComponent(this.lastProgressColor, 64)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.freeSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m104dp(6));
        this.totlaSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m104dp(10), ColorUtils.setAlphaComponent(this.lastProgressColor, 127)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.totlaSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m104dp(6));
        this.telegramDatabaseTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m104dp(10), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramDatabaseTextView.setCompoundDrawablePadding(AndroidUtilities.m104dp(6));
    ...
    public void setStorageUsage(boolean z, long j, long j2, long j3, long j4) {
        this.calculating = z;
        this.freeSizeTextView.setText(LocaleController.formatString("TotalDeviceFreeSize", C3634R.string.TotalDeviceFreeSize, AndroidUtilities.formatFileSize(j3)));
        long j5 = j4 - j3;
        this.totlaSizeTextView.setText(LocaleController.formatString("TotalDeviceSize", C3634R.string.TotalDeviceSize, AndroidUtilities.formatFileSize(j5)));
        if (z) {
            ...
            if (j2 > 0) {
                ...
                this.telegramDatabaseTextView.setVisibility(8);
                this.textSettingsCell.setTextAndValue(LocaleController.getString("ClearTelegramCache", C3634R.string.ClearTelegramCache), AndroidUtilities.formatFileSize(j2), true);
                this.telegramCacheTextView.setText(LocaleController.formatString("TelegramCacheSize", C3634R.string.TelegramCacheSize, AndroidUtilities.formatFileSize(j2 + j)));
            } else {
                this.telegramCacheTextView.setVisibility(8);
                this.telegramDatabaseTextView.setVisibility(0);
                this.telegramDatabaseTextView.setText(LocaleController.formatString("LocalDatabaseSize", C3634R.string.LocalDatabaseSize, AndroidUtilities.formatFileSize(j)));
                this.divider.setVisibility(8);
                this.textSettingsCell.setVisibility(8);
            }
    ...
    public class ProgressView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawLine(AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(20), getMeasuredWidth() - AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(20), StorageUsageView.this.paintFill);
            if (StorageUsageView.this.calculating || StorageUsageView.this.calculatingProgress != BitmapDescriptorFactory.HUE_RED) {
                ...
                rectF.set(AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(17), getMeasuredWidth() - AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(23));
                StorageUsageView.this.cellFlickerDrawable.setParentWidth(getMeasuredWidth());
                StorageUsageView.this.cellFlickerDrawable.draw(canvas, rectF, AndroidUtilities.m104dp(3), null);
            }
            int m104dp = AndroidUtilities.m104dp(24);
            if (!StorageUsageView.this.calculating) {
                int measuredWidth = (int) ((getMeasuredWidth() - (AndroidUtilities.m104dp(24) * 2)) * StorageUsageView.this.progress2);
                int m104dp2 = AndroidUtilities.m104dp(24) + measuredWidth;
                canvas.drawLine(m104dp, AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(24) + measuredWidth, AndroidUtilities.m104dp(20), StorageUsageView.this.paintProgress2);
                canvas.drawRect(m104dp2, AndroidUtilities.m104dp(20) - AndroidUtilities.m104dp(3), m104dp2 + AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(20) + AndroidUtilities.m104dp(3), StorageUsageView.this.bgPaint);
            }
            if (StorageUsageView.this.calculating) {
                return;
            }
            int measuredWidth2 = (int) ((getMeasuredWidth() - (AndroidUtilities.m104dp(24) * 2)) * StorageUsageView.this.progress);
            if (measuredWidth2 < AndroidUtilities.m105dp(1.0f)) {
                measuredWidth2 = AndroidUtilities.m105dp(1.0f);
            }
            int m104dp3 = AndroidUtilities.m104dp(24) + measuredWidth2;
            canvas.drawLine(m104dp, AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(24) + measuredWidth2, AndroidUtilities.m104dp(20), StorageUsageView.this.paintProgress);
            canvas.drawRect(m104dp3, AndroidUtilities.m104dp(20) - AndroidUtilities.m104dp(3), m104dp3 + AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(20) + AndroidUtilities.m104dp(3), StorageUsageView.this.bgPaint);
        }
    }
