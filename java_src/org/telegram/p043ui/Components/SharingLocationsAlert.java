    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate, Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.SharingLocationsAlert.1
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                getMeasuredWidth();
                int m107dp = AndroidUtilities.m107dp(56) + AndroidUtilities.m107dp(56) + 1 + (LocationController.getLocationsCount() * AndroidUtilities.m107dp(54));
                int i5 = size / 5;
                if (m107dp < i5 * 3) {
                ...
                if (SharingLocationsAlert.this.listView.getPaddingTop() != i4) {
                    ...
                    SharingLocationsAlert.this.listView.setPadding(0, i4, 0, AndroidUtilities.m107dp(8));
        ...
        pickerBottomLayout.cancelButton.setPadding(AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(18), 0);
        ...
        pickerBottomLayout.doneButton.setPadding(AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(18), 0);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                sharingLiveLocationCell = new FrameLayout(this, this.context) { // from class: org.telegram.ui.Components.SharingLocationsAlert.ListAdapter.1
                    @Override // android.widget.FrameLayout, android.view.View
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(48) + 1, 1073741824));
                    }

                    @Override // android.view.View
                    protected void onDraw(Canvas canvas) {
                        canvas.drawLine(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(40), getMeasuredWidth(), AndroidUtilities.m107dp(40), Theme.dividerPaint);
                    }
                };
                ...
                SharingLocationsAlert.this.textView.setPadding(0, 0, 0, AndroidUtilities.m107dp(8));
