...
public class TranscribeButton {
    ...
    private Rect bounds = new Rect(0, 0, AndroidUtilities.m104dp(30), AndroidUtilities.m104dp(30));
    ...
    public void setColor(int i, int i2, boolean z, float f) {
        ...
        if (z2 || this.selectorDrawable == null) {
            Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(8), 0, this.rippleColor);
    ...
    public void setBounds(int i, int i2, int i3, int i4, int i5) {
        if (i3 != this.bounds.width() || i4 != this.bounds.height()) {
            ...
            float f2 = i5;
            float f3 = i4 / 2.0f;
            this.f1963a = (float) ((Math.atan((f - f2) / f3) * 180.0d) / 3.141592653589793d);
            this.f1964b = (float) ((Math.atan(f / (f3 - f2)) * 180.0d) / 3.141592653589793d);
        }
    ...
    public void draw(Canvas canvas, float f) {
        this.pressBounds.set(this.bounds.left - AndroidUtilities.m104dp(8), this.bounds.top - AndroidUtilities.m104dp(8), this.bounds.right + AndroidUtilities.m104dp(8), this.bounds.bottom + AndroidUtilities.m104dp(8));
        ...
        if (f3 > BitmapDescriptorFactory.HUE_RED) {
            ...
            int i2 = rect.top;
            addLine(path4, centerX, i2, rect.right - this.radius, i2, f8, f9, BitmapDescriptorFactory.HUE_RED, this.f1963a);
            Path path5 = this.progressClipPath;
            Rect rect2 = this.bounds;
            addCorner(path5, rect2.right, rect2.top, this.diameter, 1, f8, f9, this.f1963a, this.f1964b);
            Path path6 = this.progressClipPath;
            Rect rect3 = this.bounds;
            int i3 = rect3.right;
            int i4 = rect3.top;
            int i5 = this.radius;
            float f10 = this.f1964b;
            addLine(path6, i3, i4 + i5, i3, rect3.bottom - i5, f8, f9, f10, 180.0f - f10);
            Path path7 = this.progressClipPath;
            Rect rect4 = this.bounds;
            addCorner(path7, rect4.right, rect4.bottom, this.diameter, 2, f8, f9, 180.0f - this.f1964b, 180.0f - this.f1963a);
            ...
            float f11 = this.f1963a;
            addLine(path8, i6 - i7, i8, i9, i8, f8, f9, 180.0f - f11, f11 + 180.0f);
            Path path9 = this.progressClipPath;
            Rect rect6 = this.bounds;
            addCorner(path9, rect6.left, rect6.bottom, this.diameter, 3, f8, f9, this.f1963a + 180.0f, this.f1964b + 180.0f);
            ...
            float f12 = this.f1964b;
            addLine(path10, i10, i11 - i12, i10, i13, f8, f9, f12 + 180.0f, 360.0f - f12);
            Path path11 = this.progressClipPath;
            Rect rect8 = this.bounds;
            addCorner(path11, rect8.left, rect8.top, this.diameter, 4, f8, f9, 360.0f - this.f1964b, 360.0f - this.f1963a);
            Path path12 = this.progressClipPath;
            Rect rect9 = this.bounds;
            addLine(path12, rect9.left + this.radius, rect9.top, rect9.centerX(), this.bounds.top, f8, f9, 360.0f - this.f1963a, 360.0f);
            this.strokePaint.setStrokeWidth(AndroidUtilities.m105dp(1.5f));
        ...
        canvas.save();
        canvas.translate(this.bounds.centerX() + AndroidUtilities.m104dp(-13), this.bounds.centerY() + AndroidUtilities.m104dp(-13));
        if (this.isOpen) {
    ...
    private static void transcribePressed(final MessageObject messageObject, boolean z, ChatMessageCell chatMessageCell) {
        ...
        if (z) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m102d("sending Transcription request, msg_id=" + i2 + " dialog_id=" + peerDialogId);
            }
    ...
    public static /* synthetic */ void lambda$transcribePressed$5(final MessageObject messageObject, long j, int i, long j2, int i2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m102d("Transcription request sent, received final=" + z + " id=" + j3 + " text=" + str);
        }
