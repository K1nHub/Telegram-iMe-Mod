...
public class OptionsSpeedIconDrawable extends Drawable {
    ...
    public void setSpeed(Float f, boolean z) {
        ...
        if (this.textDrawable == null) {
            ...
            this.textDrawable.setTextSize(AndroidUtilities.m107dp(7));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.textDrawable != null) {
            canvas.save();
            int m108dp = centerX - AndroidUtilities.m108dp(11.6f);
            int m107dp = centerY + AndroidUtilities.m107dp(4);
            ...
            canvas.save();
            this.textDrawable.setBounds(m108dp, m107dp, m108dp, m107dp);
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m107dp(45);
    }
