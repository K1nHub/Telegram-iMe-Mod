...
public class OptionsSpeedIconDrawable extends Drawable {
    ...
    public void setSpeed(Float f, boolean z) {
        ...
        if (this.textDrawable == null) {
            ...
            this.textDrawable.setTextSize(AndroidUtilities.m104dp(7));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.textDrawable != null) {
            canvas.save();
            int m105dp = centerX - AndroidUtilities.m105dp(11.6f);
            int m104dp = centerY + AndroidUtilities.m104dp(4);
            ...
            canvas.save();
            this.textDrawable.setBounds(m105dp, m104dp, m105dp, m104dp);
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m104dp(45);
    }
