...
public class OptionsSpeedIconDrawable extends Drawable {
    ...
    public void setSpeed(Float f, boolean z) {
        ...
        if (this.textDrawable == null) {
            ...
            this.textDrawable.setTextSize(AndroidUtilities.m72dp(7));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.textDrawable != null) {
            canvas.save();
            int m73dp = centerX - AndroidUtilities.m73dp(11.6f);
            int m72dp = centerY + AndroidUtilities.m72dp(4);
            ...
            canvas.save();
            this.textDrawable.setBounds(m73dp, m72dp, m73dp, m72dp);
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m72dp(45);
    }
