...
public class SwipeGestureSettingsView extends FrameLayout {
    ...
    public SwipeGestureSettingsView(Context context, int i) {
        ...
        strArr[0] = LocaleController.getString("SwipeSettingsPin", C3473R.string.SwipeSettingsPin);
        this.strings[1] = LocaleController.getString("SwipeSettingsRead", C3473R.string.SwipeSettingsRead);
        this.strings[2] = LocaleController.getString("SwipeSettingsArchive", C3473R.string.SwipeSettingsArchive);
        this.strings[3] = LocaleController.getString("SwipeSettingsMute", C3473R.string.SwipeSettingsMute);
        this.strings[4] = LocaleController.getString("SwipeSettingsDelete", C3473R.string.SwipeSettingsDelete);
        this.strings[5] = LocaleController.getString("SwipeSettingsFolders", C3473R.string.SwipeSettingsFolders);
    ...
    */
    ...
    public RLottieDrawable getIcon(int i) {
        ...
        if (rLottieDrawableArr[i] == null) {
            if (i == 1) {
                i2 = C3473R.raw.swipe_read;
            } else if (i == 2) {
                i2 = C3473R.raw.chats_archive;
            } else if (i == 3) {
                i2 = C3473R.raw.swipe_mute;
            } else if (i == 4) {
                i2 = C3473R.raw.swipe_delete;
            } else if (i != 5) {
                i2 = C3473R.raw.swipe_pin;
            } else {
                i2 = C3473R.raw.swipe_disabled;
            }
            int i3 = i2;
