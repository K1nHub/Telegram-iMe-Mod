...
public class AvatarConstructorFragment extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        final ContainerLayout containerLayout = new ContainerLayout(context) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.4
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                if (avatarConstructorFragment3.isLandscapeMode) {
                    ...
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.button.getLayoutParams()).rightMargin = size + AndroidUtilities.m104dp(16);
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.chooseBackgroundHint.getLayoutParams()).topMargin = 0;
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.chooseEmojiHint.getLayoutParams()).topMargin = AndroidUtilities.m104dp(10);
                } else {
                    ((ViewGroup.MarginLayoutParams) avatarConstructorFragment3.linearLayout.getLayoutParams()).bottomMargin = AndroidUtilities.m104dp(64);
                    ...
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.button.getLayoutParams()).rightMargin = AndroidUtilities.m104dp(16);
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.chooseBackgroundHint.getLayoutParams()).topMargin = AndroidUtilities.m104dp(10);
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.chooseEmojiHint.getLayoutParams()).topMargin = AndroidUtilities.m104dp(18);
                }
                ...
                avatarConstructorFragment4.keyboardVisible = this.keyboardHeight >= AndroidUtilities.m104dp(20);
                if (z2 != AvatarConstructorFragment.this.keyboardVisible) {
                    ...
                    int measuredHeight = avatarConstructorFragment5.keyboardVisible ? (-avatarConstructorFragment5.selectAnimatedEmojiDialog.getTop()) + ((BaseFragment) AvatarConstructorFragment.this).actionBar.getMeasuredHeight() + AndroidUtilities.m104dp(8) : 0;
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (!avatarConstructorFragment.isLandscapeMode) {
                    if (!avatarConstructorFragment.drawForBlur) {
                        ...
                        float f2 = x + AvatarConstructorFragment.this.previewView.f1810cx;
                        float f3 = lerp + AvatarConstructorFragment.this.previewView.f1811cy;
                        AvatarConstructorFragment avatarConstructorFragment5 = AvatarConstructorFragment.this;
        ...
        FrameLayout frameLayout = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.6
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                this.path.rewind();
                this.path.addRoundRect(rectF, AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(12), Path.Direction.CW);
    ...
    public class PreviewView extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            if (AvatarConstructorFragment.this.isLandscapeMode) {
                ...
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(140), 1073741824));
            }
        }

        @Override // android.view.ViewGroup, android.view.View
        protected void dispatchDraw(Canvas canvas) {
            this.f1810cx = getMeasuredWidth() / 2.0f;
            this.f1811cy = getMeasuredHeight() / 2.0f;
            float measuredWidth = AvatarConstructorFragment.this.isLandscapeMode ? getMeasuredWidth() * 0.3f : AndroidUtilities.m104dp(50);
            ...
            this.size = lerp;
            this.size = AndroidUtilities.lerp(lerp, AndroidUtilities.m104dp(21), AvatarConstructorFragment.this.keyboardVisibleProgress);
            this.f1810cx = AndroidUtilities.lerp(this.f1810cx, (getMeasuredWidth() - AndroidUtilities.m104dp(12)) - AndroidUtilities.m104dp(21), AvatarConstructorFragment.this.keyboardVisibleProgress);
            canvas.save();
            AvatarConstructorFragment avatarConstructorFragment = AvatarConstructorFragment.this;
            ...
            if (backgroundGradient != null) {
                ...
                float f2 = this.f1810cx;
                float f3 = this.size;
                float f4 = this.f1811cy;
                ...
                if (this.changeBackgroundProgress != 1.0f) {
                    ...
                    float f5 = this.f1810cx;
                    float f6 = this.size;
                    float f7 = this.f1811cy;
                    gradientTools2.setBounds(f5 - f6, f7 - f6, f5 + f6, f7 + f6);
                    this.outGradientTools.paint.setAlpha(255);
                    float f8 = measuredWidth;
                    drawBackround(canvas, this.f1810cx, this.f1811cy, f8, this.size, this.outGradientTools.paint);
                    this.gradientTools.paint.setAlpha((int) (this.changeBackgroundProgress * 255.0f));
                    drawBackround(canvas, this.f1810cx, this.f1811cy, f8, this.size, this.gradientTools.paint);
                    ...
                    drawBackround(canvas, this.f1810cx, this.f1811cy, measuredWidth, this.size, this.gradientTools.paint);
                }
            }
            float lerp2 = AndroidUtilities.lerp(AndroidUtilities.lerp(AvatarConstructorFragment.this.isLandscapeMode ? (int) ((measuredWidth * 2.0f) * 0.7f) : AndroidUtilities.m104dp(70), (int) (getMeasuredWidth() * 0.7f), this.expandProgress.get()), (int) (AndroidUtilities.m104dp(42) * 0.7f), AvatarConstructorFragment.this.keyboardVisibleProgress) / 2.0f;
            ...
            float f12 = this.f1810cx - lerp2;
            float f13 = this.f1811cy - lerp2;
    ...
    public class BackgroundSelectView extends RecyclerListView {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (AvatarConstructorFragment.this.gradientBackgroundItemWidth >= AndroidUtilities.m104dp(36)) {
                if (AvatarConstructorFragment.this.gradientBackgroundItemWidth > AndroidUtilities.m104dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION)) {
                    AvatarConstructorFragment.this.gradientBackgroundItemWidth = AndroidUtilities.m104dp(48);
                }
            } else {
                AvatarConstructorFragment.this.gradientBackgroundItemWidth = AndroidUtilities.m104dp(36);
            }
            super.onMeasure(i, i2);
        }
    ...
    public void showColorPicker() {
        ...
        ColorPicker colorPicker = new ColorPicker(this, getContext(), false, new ColorPicker.ColorPickerDelegate() { // from class: org.telegram.ui.Components.AvatarConstructorFragment$$ExternalSyntheticLambda6
            ...
            @Override // android.widget.FrameLayout, android.view.View
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(300), 1073741824));
            }
        };
        ...
        linearLayout.setPadding(0, AndroidUtilities.m104dp(8), 0, 0);
    ...
    public class GradientSelectorView extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AvatarConstructorFragment.this.gradientBackgroundItemWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(48), 1073741824));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.progressToSelect.get() == BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m104dp(15), paint);
            } else {
                ...
                canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m104dp(10) + (AndroidUtilities.m104dp(5) * (1.0f - this.progressToSelect.get())), paint);
            }
            if (this.isCustom) {
                ...
                canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m105dp(1.5f), this.optionsPaint);
                canvas.drawCircle(measuredWidth - (AndroidUtilities.m104dp(5) * this.progressToSelect.get()), measuredHeight, AndroidUtilities.m105dp(1.5f), this.optionsPaint);
                canvas.drawCircle(measuredWidth + (AndroidUtilities.m104dp(5) * this.progressToSelect.get()), measuredHeight, AndroidUtilities.m105dp(1.5f), this.optionsPaint);
            }
        }
