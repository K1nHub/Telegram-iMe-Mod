...
public class UpdateAppAlertDialog extends BottomSheet {
    ...
    private final Runnable setChangelogRunnable;
    private final Runnable setStickerRunnable;
    private View shadow;
    private AnimatorSet shadowAnimation;
    private Drawable shadowDrawable;
    private final BackupImageView stickerImageView;
    ...
    public void updateUI() {
        ...
        if (tLRPC$TL_help_appUpdate.sticker != null) {
            ...
            this.setStickerRunnable.run();
        } else {
            this.stickerImageView.setVisibility(8);
        }
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) this.textView.getLayoutParams();
        layoutParams.topMargin = AndroidUtilities.m72dp(this.appUpdate.sticker != null ? 16 : 0);
        this.textView.setLayoutParams(layoutParams);
        TLRPC$TL_help_appUpdate tLRPC$TL_help_appUpdate2 = this.appUpdate;
        int i = tLRPC$TL_help_appUpdate2.document.date;
        if (i != 0) {
            this.messageTextView.setText(LocaleController.formatString("AppUpdateVersionAndSize", C3473R.string.AppUpdateVersionAndSize, tLRPC$TL_help_appUpdate2.version, LocaleController.formatSeenDate(i)));
        } else {
            this.messageTextView.setText(tLRPC$TL_help_appUpdate2.version);
        }
        if (!TextUtils.isEmpty(this.appUpdate.text)) {
            this.changelogTextView.setVisibility(0);
            this.setChangelogRunnable.run();
            return;
        }
        this.changelogTextView.setVisibility(8);
    }

    /* renamed from: org.telegram.ui.Components.UpdateAppAlertDialog$BottomSheetCell */
    /* loaded from: classes7.dex */
    public class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, boolean z) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.textView[i].setPadding(0, 0, 0, this.hasBackground ? 0 : AndroidUtilities.m72dp(13));
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(this.hasBackground ? 80 : 50), 1073741824));
        }
        ...
        public void setText(CharSequence charSequence, boolean z) {
            ...
            animatorSet.playTogether(ObjectAnimator.ofFloat(this.textView[0], View.ALPHA, 1.0f, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.textView[0], View.TRANSLATION_Y, BitmapDescriptorFactory.HUE_RED, -AndroidUtilities.m72dp(10)), ObjectAnimator.ofFloat(this.textView[1], View.ALPHA, BitmapDescriptorFactory.HUE_RED, 1.0f), ObjectAnimator.ofFloat(this.textView[1], View.TRANSLATION_Y, AndroidUtilities.m72dp(10), BitmapDescriptorFactory.HUE_RED));
    ...
    public UpdateAppAlertDialog(Context context, TLRPC$TL_help_appUpdate tLRPC$TL_help_appUpdate, int i, FrameLayout frameLayout) {
        super(context, false);
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.Components.UpdateAppAlertDialog.1
        ...
        NestedScrollView nestedScrollView = new NestedScrollView(context) { // from class: org.telegram.ui.Components.UpdateAppAlertDialog.2
            ...
            public void onMeasure(int i2, int i3) {
                ...
                int i4 = (size / 5) * 2;
                if (measuredHeight - (size - i4) < AndroidUtilities.m72dp(90) || measuredHeight < (size / 2) + AndroidUtilities.m72dp(90)) {
        ...
        frameLayout2.addView(this.scrollView, LayoutHelper.createFrame(-1, -1, 51, 0, 0, 0, (int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS));
        ...
        this.setStickerRunnable = new Runnable() { // from class: org.telegram.ui.Components.UpdateAppAlertDialog$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                UpdateAppAlertDialog.this.lambda$new$0(backupImageView);
            }
        };
        ...
        textView.setText(LocaleController.getString("AppUpdate", C3473R.string.AppUpdate));
        ...
        this.changelogTextView = textView3;
        ...
        this.setChangelogRunnable = new Runnable() { // from class: org.telegram.ui.Components.UpdateAppAlertDialog$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                UpdateAppAlertDialog.this.lambda$new$1(textView3);
            }
        };
        ...
        layoutParams.bottomMargin = AndroidUtilities.m72dp((int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
        View view = new View(context);
        this.shadow = view;
        ...
        frameLayout2.addView(this.shadow, layoutParams);
        BottomSheetCell bottomSheetCell = new BottomSheetCell(context, false);
        bottomSheetCell.setText(LocaleController.formatString("AppUpdateDownloadNow", C3473R.string.AppUpdateDownloadNow, new Object[0]), false);
        bottomSheetCell.background.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.UpdateAppAlertDialog$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                UpdateAppAlertDialog.this.lambda$new$2(view2);
            }
        });
        frameLayout2.addView(bottomSheetCell, LayoutHelper.createFrame(-1, 50, 83, 0, 0, 0, 50));
        BottomSheetCell bottomSheetCell2 = new BottomSheetCell(context, true);
        bottomSheetCell2.setText(LocaleController.getString("AppUpdateRemindMeLater", C3473R.string.AppUpdateRemindMeLater), false);
        bottomSheetCell2.background.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.UpdateAppAlertDialog$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                UpdateAppAlertDialog.this.lambda$new$3(view2);
            }
        });
        frameLayout2.addView(bottomSheetCell2, LayoutHelper.createFrame(-1, 50, 83, 0, 0, 0, 0));
        updateUI();
        if (frameLayout != null) {
            frameLayout2.addView(frameLayout, LayoutHelper.createFrame(-1, 50, 83, 23, 0, 23, 15));
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.scrollView.getLayoutParams();
            int i4 = layoutParams2.bottomMargin - bottomSheetCell.getLayoutParams().height;
            layoutParams2.bottomMargin = i4;
            int i5 = i4 - bottomSheetCell2.getLayoutParams().height;
            layoutParams2.bottomMargin = i5;
            layoutParams2.bottomMargin = i5 + frameLayout.getLayoutParams().height;
            this.scrollView.setLayoutParams(layoutParams2);
            AndroidUtilities.removeFromParent(this.shadow);
            AndroidUtilities.removeFromParent(bottomSheetCell);
            AndroidUtilities.removeFromParent(bottomSheetCell2);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$0(BackupImageView backupImageView) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$1(TextView textView) {
    ...
    public void updateLayout() {
        ...
        int max = Math.max(this.location[1] - AndroidUtilities.m72dp(24), 0);
        if (this.location[1] + this.linearLayout.getMeasuredHeight() <= (this.container.getMeasuredHeight() - AndroidUtilities.m72dp(113)) + this.containerView.getTranslationY()) {
