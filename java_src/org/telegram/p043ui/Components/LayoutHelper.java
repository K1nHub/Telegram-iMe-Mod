...
public class LayoutHelper {
    ...
    public static RecyclerView.LayoutParams createRecycler(int i, int i2, float f, float f2, float f3, float f4) {
        ...
        layoutParams.setMargins(AndroidUtilities.m105dp(f), AndroidUtilities.m105dp(f2), AndroidUtilities.m105dp(f3), AndroidUtilities.m105dp(f4));
        return layoutParams;
    }

    public static void addFrameParams(View view, int i, int i2, float f, float f2, float f3, float f4) {
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
        layoutParams.width += AndroidUtilities.m104dp(i);
        layoutParams.height += AndroidUtilities.m104dp(i2);
        layoutParams.leftMargin += AndroidUtilities.m105dp(f);
        layoutParams.topMargin += AndroidUtilities.m105dp(f2);
        layoutParams.rightMargin += AndroidUtilities.m105dp(f3);
        layoutParams.bottomMargin += AndroidUtilities.m105dp(f4);
    ...
    public static FrameLayout.LayoutParams createFrame(int i, float f, int i2, float f2, float f3, float f4, float f5) {
        ...
        layoutParams.setMargins(AndroidUtilities.m105dp(f2), AndroidUtilities.m105dp(f3), AndroidUtilities.m105dp(f4), AndroidUtilities.m105dp(f5));
        return layoutParams;
    }
    ...
    public static FrameLayout.LayoutParams createFrameRelatively(float f, float f2, int i, float f3, float f4, float f5, float f6) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m105dp(LocaleController.isRTL ? f5 : f3);
        layoutParams.topMargin = AndroidUtilities.m105dp(f4);
        if (!LocaleController.isRTL) {
            f3 = f5;
        }
        layoutParams.rightMargin = AndroidUtilities.m105dp(f3);
        layoutParams.bottomMargin = AndroidUtilities.m105dp(f6);
        return layoutParams;
    }
    ...
    public static RelativeLayout.LayoutParams createRelative(float f, float f2, int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m104dp(i);
        layoutParams.topMargin = AndroidUtilities.m104dp(i2);
        layoutParams.rightMargin = AndroidUtilities.m104dp(i3);
        layoutParams.bottomMargin = AndroidUtilities.m104dp(i4);
        return layoutParams;
    }
    ...
    public static LinearLayout.LayoutParams createLinear(int i, int i2, float f, int i3, int i4, int i5, int i6, int i7) {
        ...
        layoutParams.setMargins(AndroidUtilities.m104dp(i4), AndroidUtilities.m104dp(i5), AndroidUtilities.m104dp(i6), AndroidUtilities.m104dp(i7));
    ...
    public static LinearLayout.LayoutParams createLinear(int i, int i2, float f, int i3, int i4, int i5, int i6) {
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(getSize(i), getSize(i2), f);
        layoutParams.setMargins(AndroidUtilities.m104dp(i3), AndroidUtilities.m104dp(i4), AndroidUtilities.m104dp(i5), AndroidUtilities.m104dp(i6));
        return layoutParams;
    }
