...
public class RadialProgress {
    ...
    private int diff = AndroidUtilities.m104dp(4);
    ...
    public RadialProgress(View view) {
        ...
        this.progressPaint.setStrokeWidth(AndroidUtilities.m104dp(3));
        Paint paint2 = new Paint(1);
        this.miniProgressPaint = paint2;
        paint2.setStyle(Paint.Style.STROKE);
        this.miniProgressPaint.setStrokeCap(Paint.Cap.ROUND);
        this.miniProgressPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
    ...
    private void invalidateParent() {
        ...
        int i = ((int) rectF.left) - m104dp;
        int i2 = ((int) rectF.top) - m104dp;
        int i3 = m104dp * 2;
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.drawMiniProgress && this.currentDrawable != null) {
            ...
            if (Math.abs(this.progressRect.width() - AndroidUtilities.m104dp(44)) < AndroidUtilities.density) {
                i = 20;
                centerX = this.progressRect.centerX() + AndroidUtilities.m104dp(16);
                m104dp = this.progressRect.centerY() + AndroidUtilities.m104dp(16);
                i2 = 0;
            } else {
                i = 22;
                centerX = this.progressRect.centerX() + AndroidUtilities.m104dp(18);
                m104dp = AndroidUtilities.m104dp(18) + this.progressRect.centerY();
                i2 = 2;
            }
            int i3 = i / 2;
            ...
            if (canvas2 != null) {
                int i4 = i + 18 + i2;
                canvas2.drawCircle(AndroidUtilities.m104dp(i4), AndroidUtilities.m104dp(i4), AndroidUtilities.m104dp(i3 + 1) * f, Theme.checkboxSquare_eraserPaint);
            } else {
                ...
                canvas.drawCircle(centerX, m104dp, AndroidUtilities.m104dp(12), this.miniProgressBackgroundPaint);
            }
            if (this.miniDrawCanvas != null) {
            ...
            if (drawable4 != null) {
                ...
                this.previousMiniDrawable.setBounds((int) (centerX - (AndroidUtilities.m104dp(i3) * f)), (int) (m104dp - (AndroidUtilities.m104dp(i3) * f)), (int) ((AndroidUtilities.m104dp(i3) * f) + centerX), (int) ((AndroidUtilities.m104dp(i3) * f) + m104dp));
            ...
            if (!this.hideCurrentDrawable && (drawable2 = this.currentMiniDrawable) != null) {
                ...
                this.currentMiniDrawable.setBounds((int) (centerX - AndroidUtilities.m104dp(i3)), (int) (m104dp - AndroidUtilities.m104dp(i3)), (int) (AndroidUtilities.m104dp(i3) + centerX), (int) (AndroidUtilities.m104dp(i3) + m104dp));
            ...
            if (this.currentMiniWithRound || this.previousMiniWithRound) {
                ...
                int i5 = i3 - 2;
                this.cicleRect.set(centerX - (AndroidUtilities.m104dp(i5) * f), m104dp - (AndroidUtilities.m104dp(i5) * f), centerX + (AndroidUtilities.m104dp(i5) * f), m104dp + (AndroidUtilities.m104dp(i5) * f));
