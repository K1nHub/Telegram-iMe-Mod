...
public class SenderSelectView extends View {
    ...
    public SenderSelectView(Context context) {
        ...
        this.menuPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
        this.menuPaint.setStrokeCap(Paint.Cap.ROUND);
        this.menuPaint.setStyle(Paint.Style.STROKE);
        updateColors();
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C3634R.string.AccDescrSendAsPeer, ""));
    }
    ...
    private void updateColors() {
        ...
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(16), 0, Theme.getColor(Theme.key_windowBackgroundWhite));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float m104dp = AndroidUtilities.m104dp(9) + this.menuPaint.getStrokeWidth();
        canvas.drawLine(m104dp, m104dp, getWidth() - m104dp, getHeight() - m104dp, this.menuPaint);
        canvas.drawLine(m104dp, getHeight() - m104dp, getWidth() - m104dp, m104dp, this.menuPaint);
        canvas.restore();
    ...
    public void setAvatar(TLObject tLObject) {
        ...
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C3634R.string.AccDescrSendAsPeer, str));
