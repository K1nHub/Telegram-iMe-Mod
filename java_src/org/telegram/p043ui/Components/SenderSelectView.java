...
public class SenderSelectView extends View {
    ...
    public SenderSelectView(Context context) {
        ...
        this.menuPaint.setStrokeWidth(AndroidUtilities.m107dp(2));
        this.menuPaint.setStrokeCap(Paint.Cap.ROUND);
        this.menuPaint.setStyle(Paint.Style.STROKE);
        updateColors();
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C3632R.string.AccDescrSendAsPeer, ""));
    }
    ...
    private void updateColors() {
        ...
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(16), 0, Theme.getColor(Theme.key_windowBackgroundWhite));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float m107dp = AndroidUtilities.m107dp(9) + this.menuPaint.getStrokeWidth();
        canvas.drawLine(m107dp, m107dp, getWidth() - m107dp, getHeight() - m107dp, this.menuPaint);
        canvas.drawLine(m107dp, getHeight() - m107dp, getWidth() - m107dp, m107dp, this.menuPaint);
        canvas.restore();
    ...
    public void setAvatar(TLObject tLObject) {
        ...
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C3632R.string.AccDescrSendAsPeer, str));
