...
public class ChatScrimPopupContainerLayout extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (reactionsContainerLayout != null && this.popupWindowLayout != null) {
            ...
            int measuredWidth2 = childAt.getMeasuredWidth() + AndroidUtilities.m104dp(16) + AndroidUtilities.m104dp(16) + AndroidUtilities.m104dp(36);
            if (measuredWidth2 > measuredWidth) {
                measuredWidth2 = measuredWidth;
            }
            this.reactionsLayout.bigCircleOffset = AndroidUtilities.m104dp(36);
            if (this.reactionsLayout.showCustomEmojiReaction()) {
                this.reactionsLayout.getLayoutParams().width = totalWidth;
                this.reactionsLayout.bigCircleOffset = Math.max((totalWidth - childAt.getMeasuredWidth()) - AndroidUtilities.m104dp(36), AndroidUtilities.m104dp(36));
            } else if (totalWidth > measuredWidth2) {
                int m104dp = ((measuredWidth2 - AndroidUtilities.m104dp(16)) / AndroidUtilities.m104dp(36)) + 1;
                int m104dp2 = ((AndroidUtilities.m104dp(36) * m104dp) + AndroidUtilities.m104dp(16)) - AndroidUtilities.m104dp(8);
                if (m104dp2 <= totalWidth && m104dp != this.reactionsLayout.getItemsCount()) {
                    totalWidth = m104dp2;
                }
                this.reactionsLayout.getLayoutParams().width = totalWidth;
            } else {
            ...
            if (this.reactionsLayout.getMeasuredWidth() != measuredWidth || !this.reactionsLayout.showCustomEmojiReaction()) {
                ...
                if (this.reactionsLayout.getLayoutParams().width != -2 && this.reactionsLayout.getLayoutParams().width + measuredWidth3 > measuredWidth) {
                    measuredWidth3 = (measuredWidth - this.reactionsLayout.getLayoutParams().width) + AndroidUtilities.m104dp(8);
                }
                ...
                if (i4 < AndroidUtilities.m104dp(36)) {
                    this.popupLayoutLeftOffset = BitmapDescriptorFactory.HUE_RED;
                    this.reactionsLayout.bigCircleOffset = AndroidUtilities.m104dp(36);
                }
                updatePopupTranslation();
            ...
            if (this.bottomView != null) {
                if (this.reactionsLayout.showCustomEmojiReaction()) {
                    this.bottomView.getLayoutParams().width = childAt.getMeasuredWidth() + AndroidUtilities.m104dp(16);
                    updatePopupTranslation();
                } else {
                    this.bottomView.getLayoutParams().width = -1;
                }
                if (this.popupWindowLayout.getSwipeBack() != null) {
                    ((LinearLayout.LayoutParams) this.bottomView.getLayoutParams()).rightMargin = r2 + AndroidUtilities.m104dp(36);
                } else {
                    ((LinearLayout.LayoutParams) this.bottomView.getLayoutParams()).rightMargin = AndroidUtilities.m104dp(36);
                }
            }
            super.onMeasure(i, i2);
        } else {
    ...
    public void setPopupWindowLayout(final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        ...
        actionBarPopupWindowLayout.setOnSizeChangedListener(new ActionBarPopupWindow.onSizeChangedListener() { // from class: org.telegram.ui.Components.ChatScrimPopupContainerLayout$$ExternalSyntheticLambda0
            @Override // org.telegram.p043ui.ActionBar.ActionBarPopupWindow.onSizeChangedListener
        ...
        if (actionBarPopupWindowLayout.getSwipeBack() != null) {
            actionBarPopupWindowLayout.getSwipeBack().addOnSwipeBackProgressListener(new PopupSwipeBackLayout.OnSwipeBackProgressListener() { // from class: org.telegram.ui.Components.ChatScrimPopupContainerLayout$$ExternalSyntheticLambda1
                @Override // org.telegram.p043ui.Components.PopupSwipeBackLayout.OnSwipeBackProgressListener
