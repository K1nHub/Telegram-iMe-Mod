...
public class ChatScrimPopupContainerLayout extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (reactionsContainerLayout != null && this.popupWindowLayout != null) {
            ...
            int measuredWidth2 = childAt.getMeasuredWidth() + AndroidUtilities.m107dp(16) + AndroidUtilities.m107dp(16) + AndroidUtilities.m107dp(36);
            if (measuredWidth2 > measuredWidth) {
                measuredWidth2 = measuredWidth;
            }
            this.reactionsLayout.bigCircleOffset = AndroidUtilities.m107dp(36);
            if (this.reactionsLayout.showCustomEmojiReaction()) {
                this.reactionsLayout.getLayoutParams().width = totalWidth;
                this.reactionsLayout.bigCircleOffset = Math.max((totalWidth - childAt.getMeasuredWidth()) - AndroidUtilities.m107dp(36), AndroidUtilities.m107dp(36));
            } else if (totalWidth > measuredWidth2) {
                int m107dp = ((measuredWidth2 - AndroidUtilities.m107dp(16)) / AndroidUtilities.m107dp(36)) + 1;
                int m107dp2 = ((AndroidUtilities.m107dp(36) * m107dp) + AndroidUtilities.m107dp(16)) - AndroidUtilities.m107dp(8);
                if (m107dp2 <= totalWidth && m107dp != this.reactionsLayout.getItemsCount()) {
                    totalWidth = m107dp2;
                }
                this.reactionsLayout.getLayoutParams().width = totalWidth;
            } else {
            ...
            if (this.reactionsLayout.getMeasuredWidth() != measuredWidth || !this.reactionsLayout.showCustomEmojiReaction()) {
                ...
                if (this.reactionsLayout.getLayoutParams().width != -2 && this.reactionsLayout.getLayoutParams().width + measuredWidth3 > measuredWidth) {
                    measuredWidth3 = (measuredWidth - this.reactionsLayout.getLayoutParams().width) + AndroidUtilities.m107dp(8);
                }
                ...
                if (i4 < AndroidUtilities.m107dp(36)) {
                    this.popupLayoutLeftOffset = BitmapDescriptorFactory.HUE_RED;
                    this.reactionsLayout.bigCircleOffset = AndroidUtilities.m107dp(36);
                }
                updatePopupTranslation();
            ...
            if (this.bottomView != null) {
                if (this.reactionsLayout.showCustomEmojiReaction()) {
                    this.bottomView.getLayoutParams().width = childAt.getMeasuredWidth() + AndroidUtilities.m107dp(16);
                    updatePopupTranslation();
                } else {
                    this.bottomView.getLayoutParams().width = -1;
                }
                if (this.popupWindowLayout.getSwipeBack() != null) {
                    ((LinearLayout.LayoutParams) this.bottomView.getLayoutParams()).rightMargin = r2 + AndroidUtilities.m107dp(36);
                } else {
                    ((LinearLayout.LayoutParams) this.bottomView.getLayoutParams()).rightMargin = AndroidUtilities.m107dp(36);
                }
            }
            super.onMeasure(i, i2);
        } else {
