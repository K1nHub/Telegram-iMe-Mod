...
public class UndoView extends FrameLayout {
    ...
    public UndoView(Context context, BaseFragment baseFragment, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.enterOffsetMargin = AndroidUtilities.m104dp(8);
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m104dp(15));
        addView(this.avatarImageView, LayoutHelper.createFrame(30, 30, 19, 15, 0, 0, 0));
        LinearLayout linearLayout = new LinearLayout(context);
        this.undoButton = linearLayout;
        linearLayout.setOrientation(0);
        this.undoButton.setBackground(Theme.createRadSelectorDrawable(getThemedColor(i2) & 587202559, AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(2)));
        ...
        this.backgroundDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m104dp(10), getThemedColor(i3));
    ...
    */
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.additionalTranslationY != BitmapDescriptorFactory.HUE_RED) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + AndroidUtilities.m104dp(9);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.additionalTranslationY != BitmapDescriptorFactory.HUE_RED) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + this.enterOffsetMargin + AndroidUtilities.m104dp(1);
            if (measuredHeight > BitmapDescriptorFactory.HUE_RED) {
                canvas.clipRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), measuredHeight);
                super.dispatchDraw(canvas);
            }
        ...
        if (i == 1 || i == 0 || i == 27 || i == 26 || i == 81 || i == 88) {
            ...
            if (this.timeLayoutOut != null) {
                ...
                if (f3 < 1.0f) {
                    ...
                    canvas.save();
                    canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m105dp(17.2f) + (AndroidUtilities.m104dp(10) * this.timeReplaceProgress));
            ...
            if (this.timeLayout != null) {
                ...
                canvas.save();
                canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m105dp(17.2f) - (AndroidUtilities.m104dp(10) * (1.0f - this.timeReplaceProgress)));
    ...
    private void updatePosition() {
        setTranslationY(((this.enterOffset - this.enterOffsetMargin) + AndroidUtilities.m104dp(8)) - this.additionalTranslationY);
        invalidate();
    }
