...
public class UndoView extends FrameLayout {
    ...
    public UndoView(Context context, BaseFragment baseFragment, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.enterOffsetMargin = AndroidUtilities.m107dp(8);
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m107dp(15));
        addView(this.avatarImageView, LayoutHelper.createFrame(30, 30, 19, 15, 0, 0, 0));
        LinearLayout linearLayout = new LinearLayout(context);
        this.undoButton = linearLayout;
        linearLayout.setOrientation(0);
        this.undoButton.setBackground(Theme.createRadSelectorDrawable(getThemedColor(i2) & 587202559, AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2)));
        ...
        this.rect = new RectF(AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(33), AndroidUtilities.m107dp(33));
        ...
        this.backgroundDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m107dp(10), getThemedColor(i3));
    ...
    /* JADX WARN: Removed duplicated region for block: B:836:0x1ba6  */
    /* JADX WARN: Removed duplicated region for block: B:839:0x1bc6  */
    /* JADX WARN: Removed duplicated region for block: B:842:0x1bed  */
    /* JADX WARN: Removed duplicated region for block: B:846:0x1c32  */
    /* JADX WARN: Removed duplicated region for block: B:877:0x1ce5  */
    ...
    */
    ...
    public /* synthetic */ void lambda$showWithAction$6(TLRPC$Message tLRPC$Message, View view) {
        ...
        tLRPC$TL_payments_getPaymentReceipt.msg_id = tLRPC$Message.f1626id;
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.additionalTranslationY != BitmapDescriptorFactory.HUE_RED) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + AndroidUtilities.m107dp(9);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.additionalTranslationY != BitmapDescriptorFactory.HUE_RED) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + this.enterOffsetMargin + AndroidUtilities.m107dp(1);
            if (measuredHeight > BitmapDescriptorFactory.HUE_RED) {
                canvas.clipRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), measuredHeight);
                super.dispatchDraw(canvas);
            }
        ...
        if (i == 1 || i == 0 || i == 27 || i == 26 || i == 81 || i == 88) {
            ...
            if (this.timeLayoutOut != null) {
                ...
                if (f3 < 1.0f) {
                    ...
                    canvas.save();
                    canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m108dp(17.2f) + (AndroidUtilities.m107dp(10) * this.timeReplaceProgress));
            ...
            if (this.timeLayout != null) {
                ...
                canvas.save();
                canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m108dp(17.2f) - (AndroidUtilities.m107dp(10) * (1.0f - this.timeReplaceProgress)));
    ...
    private void updatePosition() {
        setTranslationY(((this.enterOffset - this.enterOffsetMargin) + AndroidUtilities.m107dp(8)) - this.additionalTranslationY);
        invalidate();
    }
