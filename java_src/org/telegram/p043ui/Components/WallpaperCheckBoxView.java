...
public class WallpaperCheckBoxView extends View {
    ...
    public WallpaperCheckBoxView(Context context, boolean z, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.rect = new RectF();
        if (z) {
            this.drawBitmap = Bitmap.createBitmap(AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(18), Bitmap.Config.ARGB_4444);
        ...
        this.checkPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.maxTextSize + AndroidUtilities.m104dp(56), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(32), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int measuredWidth = ((getMeasuredWidth() - this.currentTextSize) - AndroidUtilities.m104dp(28)) / 2;
        canvas.drawText(this.currentText, AndroidUtilities.m104dp(28) + measuredWidth, AndroidUtilities.m104dp(21), this.textPaint);
        canvas.save();
        canvas.translate(measuredWidth, AndroidUtilities.m104dp(7));
        int i2 = 0;
        if (this.drawBitmap != null) {
            ...
            float m104dp = AndroidUtilities.m104dp(1) * f;
            this.rect.set(m104dp, m104dp, AndroidUtilities.m104dp(18) - m104dp, AndroidUtilities.m104dp(18) - m104dp);
            ...
            if (f2 != 1.0f) {
                float min = Math.min(AndroidUtilities.m104dp(7), (AndroidUtilities.m104dp(7) * f2) + m104dp);
                this.rect.set(AndroidUtilities.m104dp(2) + min, AndroidUtilities.m104dp(2) + min, AndroidUtilities.m104dp(16) - min, AndroidUtilities.m104dp(16) - min);
            ...
            if (this.progress > 0.5f) {
                float f4 = 1.0f - f;
                this.drawCanvas.drawLine(AndroidUtilities.m105dp(7.3f), AndroidUtilities.m104dp(13), (int) (AndroidUtilities.m105dp(7.3f) - (AndroidUtilities.m105dp(2.5f) * f4)), (int) (AndroidUtilities.m104dp(13) - (AndroidUtilities.m105dp(2.5f) * f4)), this.checkPaint);
                this.drawCanvas.drawLine(AndroidUtilities.m105dp(7.3f), AndroidUtilities.m104dp(13), (int) (AndroidUtilities.m105dp(7.3f) + (AndroidUtilities.m104dp(6) * f4)), (int) (AndroidUtilities.m104dp(13) - (AndroidUtilities.m104dp(6) * f4)), this.checkPaint);
            }
            canvas.drawBitmap(this.drawBitmap, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (Paint) null);
        } else {
            this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(18));
