...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* renamed from: org.telegram.ui.Components.PipRoundVideoView$PipFrameLayout */
    /* loaded from: classes6.dex */
    ...
    public void show(Activity activity, Runnable runnable) {
        ...
        PipFrameLayout pipFrameLayout = new PipFrameLayout(activity) { // from class: org.telegram.ui.Components.PipRoundVideoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (drawable != null) {
                    ...
                    Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(125), AndroidUtilities.m107dp(125));
                    ...
                    canvas.drawCircle(AndroidUtilities.m107dp(63), AndroidUtilities.m107dp(63), AndroidUtilities.m108dp(59.5f), Theme.chat_docBackPaint);
                }
            }
        };
        this.windowView = pipFrameLayout;
        pipFrameLayout.setWillNotDraw(false);
        this.videoWidth = AndroidUtilities.m107dp(126);
        this.videoHeight = AndroidUtilities.m107dp(126);
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            aspectRatioFrameLayout.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.telegram.ui.Components.PipRoundVideoView.3
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setOval(0, 0, AndroidUtilities.m107dp(120), AndroidUtilities.m107dp(120));
                }
            });
        ...
        this.windowView.addView(this.aspectRatioFrameLayout, LayoutHelper.createFrame(120, 120, 51, 3, 3, 0, 0));
        ...
        this.aspectRatioFrameLayout.addView(this.textureView, LayoutHelper.createFrame(-1, -1));
        ImageView imageView = new ImageView(activity);
        this.imageView = imageView;
        this.aspectRatioFrameLayout.addView(imageView, LayoutHelper.createFrame(-1, -1));
    ...
    private static int getSideCoord(boolean z, int i, float f, int i2) {
        ...
        if (z) {
            ...
            i2 = C3704ActionBar.getCurrentActionBarHeight();
        }
        int i4 = i3 - i2;
        if (i == 0) {
            round = AndroidUtilities.m107dp(10);
        } else if (i == 1) {
            round = i4 - AndroidUtilities.m107dp(10);
        } else {
            round = Math.round((i4 - AndroidUtilities.m107dp(20)) * f) + AndroidUtilities.m107dp(10);
        }
        return !z ? round + C3704ActionBar.getCurrentActionBarHeight() : round;
    }
    ...
    */
    public void animateToBoundsMaybe() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }
