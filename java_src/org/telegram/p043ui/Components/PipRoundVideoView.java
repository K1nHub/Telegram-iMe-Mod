...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
        ...
        FrameLayout frameLayout = new FrameLayout(activity) { // from class: org.telegram.ui.Components.PipRoundVideoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (drawable != null) {
                    ...
                    Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(125), AndroidUtilities.m104dp(125));
                    ...
                    canvas.drawCircle(AndroidUtilities.m104dp(63), AndroidUtilities.m104dp(63), AndroidUtilities.m105dp(59.5f), Theme.chat_docBackPaint);
                }
            }
        };
        this.windowView = frameLayout;
        frameLayout.setWillNotDraw(false);
        this.videoWidth = AndroidUtilities.m104dp(126);
        this.videoHeight = AndroidUtilities.m104dp(126);
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            aspectRatioFrameLayout.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.telegram.ui.Components.PipRoundVideoView.3
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setOval(0, 0, AndroidUtilities.m104dp(120), AndroidUtilities.m104dp(120));
                }
            });
    ...
    private static int getSideCoord(boolean z, int i, float f, int i2) {
        ...
        if (z) {
            ...
            i2 = C3706ActionBar.getCurrentActionBarHeight();
        }
        int i4 = i3 - i2;
        if (i == 0) {
            round = AndroidUtilities.m104dp(10);
        } else if (i == 1) {
            round = i4 - AndroidUtilities.m104dp(10);
        } else {
            round = Math.round((i4 - AndroidUtilities.m104dp(20)) * f) + AndroidUtilities.m104dp(10);
        }
        return !z ? round + C3706ActionBar.getCurrentActionBarHeight() : round;
    }
