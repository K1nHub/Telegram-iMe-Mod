...
public class ClipRoundedDrawable extends Drawable {
    ...
    public void setRadii(float f, float f2, float f3, float f4) {
        ...
        float max2 = Math.max((float) BitmapDescriptorFactory.HUE_RED, f2);
        fArr2[3] = max2;
        fArr2[2] = max2;
        float[] fArr3 = this.radii;
        float max3 = Math.max((float) BitmapDescriptorFactory.HUE_RED, f3);
        fArr3[5] = max3;
        fArr3[4] = max3;
        float[] fArr4 = this.radii;
        float max4 = Math.max((float) BitmapDescriptorFactory.HUE_RED, f4);
        fArr4[7] = max4;
        fArr4[6] = max4;
