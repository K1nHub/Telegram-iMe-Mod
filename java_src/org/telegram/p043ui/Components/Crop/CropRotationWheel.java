...
public class CropRotationWheel extends FrameLayout {
    ...
    public CropRotationWheel(Context context) {
        ...
        imageView.setImageResource(C3473R.C3475drawable.msg_photo_flip);
        ...
        this.mirrorButton.setContentDescription(LocaleController.getString("AccDescrMirror", C3473R.string.AccDescrMirror));
        addView(this.mirrorButton, LayoutHelper.createFrame(70, 64, 19));
        ImageView imageView2 = new ImageView(context);
        this.aspectRatioButton = imageView2;
        imageView2.setImageResource(C3473R.C3475drawable.msg_photo_cropfix);
        ...
        this.aspectRatioButton.setContentDescription(LocaleController.getString("AccDescrAspectRatio", C3473R.string.AccDescrAspectRatio));
        addView(this.aspectRatioButton, LayoutHelper.createFrame(70, 64, 19));
        ImageView imageView3 = new ImageView(context);
        this.rotation90Button = imageView3;
        imageView3.setImageResource(C3473R.C3475drawable.msg_photo_rotate);
        ...
        this.rotation90Button.setContentDescription(LocaleController.getString("AccDescrRotate", C3473R.string.AccDescrRotate));
