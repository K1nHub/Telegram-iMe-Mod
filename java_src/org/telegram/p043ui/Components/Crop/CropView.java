...
public class CropView extends FrameLayout implements CropAreaView.AreaViewListener, CropGestureDetector.CropGestureListener {
    ...
    public class CropState {
        ...
        private CropState(int i, int i2, int i3) {
            this.width = i;
            this.height = i2;
            this.f1834x = BitmapDescriptorFactory.HUE_RED;
            this.f1835y = BitmapDescriptorFactory.HUE_RED;
            this.scale = 1.0f;
        ...
        public boolean hasChanges() {
            return Math.abs(this.f1834x) > 1.0E-5f || Math.abs(this.f1835y) > 1.0E-5f || Math.abs(this.scale - this.minimumScale) > 1.0E-5f || Math.abs(this.rotation) > 1.0E-5f || Math.abs(this.orientation) > 1.0E-5f;
        }
    ...
    public void maximize(boolean z) {
        ...
        if (z) {
            ...
            CropState cropState2 = this.state;
            final float f3 = cropState2.f1834x;
            final float f4 = cropState2.f1835y;
        ...
        cropState3.translate(-cropState3.f1834x, -cropState3.f1835y);
    ...
    public /* synthetic */ void lambda$maximize$2(RectF rectF, RectF rectF2, float f, float f2, float f3, float f4, float f5, ValueAnimator valueAnimator) {
        ...
        float f7 = cropState.f1834x - (f * f6);
        float f8 = cropState.f1835y - (f2 * f6);
    ...
    */
    ...
    public void makeCrop(MediaController.MediaEditState mediaEditState) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m102d("set transformRotation = " + mediaEditState.cropState.transformRotation);
        }
        while (true) {
