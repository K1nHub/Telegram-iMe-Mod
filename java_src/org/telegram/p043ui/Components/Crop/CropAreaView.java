...
public class CropAreaView extends ViewGroup {
    ...
    /* renamed from: tx */
    public float f1738tx;

    /* renamed from: ty */
    public float f1739ty;
    ...
    public CropAreaView(Context context) {
        ...
        this.scale = 1.0f;
        this.f1738tx = BitmapDescriptorFactory.HUE_RED;
        this.f1739ty = BitmapDescriptorFactory.HUE_RED;
        this.inBubbleMode = context instanceof BubbleActivity;
        this.frameVisible = true;
        this.dimVisibile = true;
        this.sidePadding = AndroidUtilities.m72dp(16);
        this.minWidth = AndroidUtilities.m72dp(32);
        ...
        this.shadowPaint.setStrokeWidth(AndroidUtilities.m72dp(2));
    ...
    private void updateSubtitle() {
        if (this.subtitle != null) {
            if (this.subtitlePaint == null) {
                ...
                this.subtitlePaint.setTextSize(AndroidUtilities.m72dp(13));
                this.subtitlePaint.setTextAlign(Paint.Align.CENTER);
            }
            this.subtitleLayout = new StaticLayout(this.subtitle, this.subtitlePaint, getMeasuredWidth() - AndroidUtilities.m72dp(120), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            return;
        }
    ...
    public void setIsVideo(boolean z) {
        this.minWidth = AndroidUtilities.m72dp(z ? 64 : 32);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i6;
        if (this.freeform) {
            int m73dp = AndroidUtilities.m73dp(2.0f / this.scale);
            int m73dp2 = AndroidUtilities.m73dp(16.0f / this.scale);
            int m73dp3 = AndroidUtilities.m73dp(3.0f / this.scale);
            ...
            canvas.save();
            canvas.translate(this.f1738tx, this.f1739ty);
            float f4 = this.scale;
            float f5 = (i10 / 2) + i7;
            float f6 = (i11 / 2) + i8;
            ...
            if (this.dimVisibile) {
                ...
                float f10 = (i + i11) - m73dp;
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f9, i2 + m73dp, f10, this.dimPaint);
                canvas.drawRect((i2 + i10) - m73dp, f9, getWidth(), f10, this.dimPaint);
            ...
            int i16 = i2 + i10;
            float f13 = i16 - i12;
            canvas.drawRect(f11, f12, f13, i4 + m73dp, this.framePaint);
            int i17 = i11 + i;
            float f14 = i17 - i12;
            canvas.drawRect(f11, f12, i3 + m73dp, f14, this.framePaint);
            canvas.drawRect(f11, i6 - m73dp, f13, f14, this.framePaint);
            canvas.drawRect(i5 - m73dp, f12, f13, f14, this.framePaint);
            int i18 = 0;
            while (true) {
                int i19 = 3;
                if (i18 >= 3) {
            ...
            if (this.circleBitmap != null) {
                ...
                if (getMeasuredHeight() > getMeasuredWidth() && this.subtitleLayout != null) {
                    canvas.save();
                    canvas.translate(getMeasuredWidth() / 2.0f, f41 + AndroidUtilities.m72dp(16));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            switch (C46223.$SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control[this.activeControl.ordinal()]) {
                case 1:
