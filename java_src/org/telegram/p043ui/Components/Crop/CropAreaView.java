...
public class CropAreaView extends ViewGroup {
    ...
    /* renamed from: tx */
    public float f1832tx;

    /* renamed from: ty */
    public float f1833ty;
    ...
    public CropAreaView(Context context) {
        ...
        this.scale = 1.0f;
        this.f1832tx = BitmapDescriptorFactory.HUE_RED;
        this.f1833ty = BitmapDescriptorFactory.HUE_RED;
        this.inBubbleMode = context instanceof BubbleActivity;
        this.frameVisible = true;
        this.dimVisibile = true;
        this.sidePadding = AndroidUtilities.m104dp(16);
        this.minWidth = AndroidUtilities.m104dp(32);
        ...
        this.shadowPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
        Paint paint3 = new Paint();
        this.linePaint = paint3;
        paint3.setStyle(Paint.Style.FILL);
        this.linePaint.setColor(-1);
        this.linePaint.setStrokeWidth(AndroidUtilities.m104dp(1));
    ...
    private void updateSubtitle() {
        if (this.subtitle != null) {
            if (this.subtitlePaint == null) {
                ...
                this.subtitlePaint.setTextSize(AndroidUtilities.m104dp(13));
                this.subtitlePaint.setTextAlign(Paint.Align.CENTER);
            }
            this.subtitleLayout = new StaticLayout(this.subtitle, this.subtitlePaint, getMeasuredWidth() - AndroidUtilities.m104dp(120), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            return;
        }
    ...
    public void setIsVideo(boolean z) {
        this.minWidth = AndroidUtilities.m104dp(z ? 64 : 32);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i6;
        if (this.freeform) {
            int m105dp = AndroidUtilities.m105dp(2.0f / this.scale);
            int m105dp2 = AndroidUtilities.m105dp(16.0f / this.scale);
            int m105dp3 = AndroidUtilities.m105dp(3.0f / this.scale);
            RectF rectF = this.actualRect;
            float f2 = rectF.left;
            int i7 = ((int) f2) - m105dp;
            float f3 = rectF.top;
            int i8 = ((int) f3) - m105dp;
            int i9 = m105dp * 2;
            int i10 = ((int) (rectF.right - f2)) + i9;
            int i11 = i9 + ((int) (rectF.bottom - f3));
            canvas.save();
            canvas.translate(this.f1832tx, this.f1833ty);
            float f4 = this.scale;
            float f5 = (i10 / 2) + i7;
            float f6 = (i11 / 2) + i8;
            ...
            if (this.dimVisibile) {
                ...
                float f10 = (i + i11) - m105dp;
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f9, i2 + m105dp, f10, this.dimPaint);
                canvas.drawRect((i2 + i10) - m105dp, f9, getWidth(), f10, this.dimPaint);
            ...
            int i16 = i2 + i10;
            float f13 = i16 - i12;
            canvas.drawRect(f11, f12, f13, i4 + m105dp, this.framePaint);
            int i17 = i11 + i;
            float f14 = i17 - i12;
            canvas.drawRect(f11, f12, i3 + m105dp, f14, this.framePaint);
            canvas.drawRect(f11, i6 - m105dp, f13, f14, this.framePaint);
            canvas.drawRect(i5 - m105dp, f12, f13, f14, this.framePaint);
            int i18 = 0;
            while (true) {
                int i19 = 3;
                if (i18 >= 3) {
            ...
            if (this.circleBitmap != null) {
                ...
                if (getMeasuredHeight() > getMeasuredWidth() && this.subtitleLayout != null) {
                    canvas.save();
                    canvas.translate(getMeasuredWidth() / 2.0f, f41 + AndroidUtilities.m104dp(16));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            switch (C48753.$SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control[this.activeControl.ordinal()]) {
                case 1:
