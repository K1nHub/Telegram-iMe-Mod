...
public class VideoTimelineView extends View {
    ...
    public void setRoundFrames(boolean z) {
        ...
        if (z) {
            this.rect1 = new Rect(AndroidUtilities.m104dp(14), AndroidUtilities.m104dp(14), AndroidUtilities.m104dp(42), AndroidUtilities.m104dp(42));
            this.rect2 = new Rect();
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m104dp(24);
        float f = measuredWidth;
        int m104dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m104dp(12);
        int m104dp2 = ((int) (this.progressRight * f)) + AndroidUtilities.m104dp(12);
        if (motionEvent.getAction() == 0) {
            getParent().requestDisallowInterceptTouchEvent(true);
            if (this.mediaMetadataRetriever == null) {
                return false;
            }
            int m104dp3 = AndroidUtilities.m104dp(24);
            if (m104dp - m104dp3 <= x && x <= m104dp + m104dp3 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m104dp);
                this.timeHintView.setTime((int) ((((float) this.videoLength) / 1000.0f) * this.progressLeft));
                this.timeHintView.setCx(m104dp + getLeft() + AndroidUtilities.m104dp(4));
                this.timeHintView.show(true);
                invalidate();
                return true;
            } else if (m104dp2 - m104dp3 <= x && x <= m104dp3 + m104dp2 && y >= BitmapDescriptorFactory.HUE_RED && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m104dp2);
                this.timeHintView.setTime((int) ((((float) this.videoLength) / 1000.0f) * this.progressRight));
                this.timeHintView.setCx((m104dp2 + getLeft()) - AndroidUtilities.m104dp(4));
                this.timeHintView.show(true);
                invalidate();
                return true;
            } else {
            ...
            if (this.pressedLeft) {
                ...
                if (i < AndroidUtilities.m104dp(16)) {
                    m104dp2 = AndroidUtilities.m104dp(16);
                } else if (i <= m104dp2) {
                    m104dp2 = i;
                }
                float m104dp4 = (m104dp2 - AndroidUtilities.m104dp(16)) / f;
                this.progressLeft = m104dp4;
                float f2 = this.progressRight;
                float f3 = this.maxProgressDiff;
                if (f2 - m104dp4 > f3) {
                    this.progressRight = m104dp4 + f3;
                } else {
                    float f4 = this.minProgressDiff;
                    if (f4 != BitmapDescriptorFactory.HUE_RED && f2 - m104dp4 < f4) {
                        float f5 = f2 - f4;
                ...
                this.timeHintView.setCx((((f * this.progressLeft) + AndroidUtilities.dpf2(12.0f)) + getLeft()) - AndroidUtilities.m104dp(4));
                this.timeHintView.setTime((int) ((((float) this.videoLength) / 1000.0f) * this.progressLeft));
                this.timeHintView.show(true);
                ...
                if (i2 >= m104dp) {
                    m104dp = i2 > AndroidUtilities.m104dp(16) + measuredWidth ? measuredWidth + AndroidUtilities.m104dp(16) : i2;
                }
                float m104dp5 = (m104dp - AndroidUtilities.m104dp(16)) / f;
                this.progressRight = m104dp5;
                float f6 = this.progressLeft;
                float f7 = this.maxProgressDiff;
                if (m104dp5 - f6 > f7) {
                    this.progressLeft = m104dp5 - f7;
                } else {
                    float f8 = this.minProgressDiff;
                    if (f8 != BitmapDescriptorFactory.HUE_RED && m104dp5 - f6 < f8) {
                        float f9 = f6 + f8;
                ...
                this.timeHintView.setCx((f * this.progressRight) + AndroidUtilities.dpf2(12.0f) + getLeft() + AndroidUtilities.m104dp(4));
                this.timeHintView.show(true);
                this.timeHintView.setTime((int) ((((float) this.videoLength) / 1000.0f) * this.progressRight));
    ...
    public void reloadFrames(int i) {
        ...
        if (i == 0) {
            if (this.isRoundFrames) {
                ...
                this.frameWidth = m104dp;
                this.frameHeight = m104dp;
                this.framesToLoad = Math.max(1, (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m104dp(16)) / (this.frameHeight / 2.0f)));
            } else {
                this.frameHeight = AndroidUtilities.m104dp(40);
                this.framesToLoad = Math.max(1, (getMeasuredWidth() - AndroidUtilities.m104dp(16)) / this.frameHeight);
                this.frameWidth = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m104dp(16)) / this.framesToLoad);
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.useClip) {
            ...
            this.path.rewind();
            int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m104dp(32)) >> 1;
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(BitmapDescriptorFactory.HUE_RED, measuredHeight, getMeasuredWidth(), getMeasuredHeight() - measuredHeight);
            this.path.addRoundRect(rectF, AndroidUtilities.m104dp(7), AndroidUtilities.m104dp(7), Path.Direction.CCW);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float measuredWidth = getMeasuredWidth() - AndroidUtilities.m104dp(24);
        int m104dp = ((int) (this.progressLeft * measuredWidth)) + AndroidUtilities.m104dp(12);
        int m104dp2 = ((int) (measuredWidth * this.progressRight)) + AndroidUtilities.m104dp(12);
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m104dp(32)) >> 1;
        ...
        if (!this.frames.isEmpty()) {
            ...
            for (int i2 = 0; i2 < this.frames.size(); i2++) {
                ...
                if (bitmap != null) {
                    ...
                    int i4 = i3 * i;
                    if (z) {
                        this.rect2.set(i4, measuredHeight, AndroidUtilities.m104dp(28) + i4, AndroidUtilities.m104dp(32) + measuredHeight);
            ...
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f, m104dp, getMeasuredHeight() - measuredHeight, this.paint2);
            canvas.drawRect(m104dp2, f, getMeasuredWidth(), getMeasuredHeight() - measuredHeight, this.paint2);
            canvas.drawLine(m104dp - AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(10) + measuredHeight, m104dp - AndroidUtilities.m104dp(4), (getMeasuredHeight() - AndroidUtilities.m104dp(10)) - measuredHeight, this.thumbPaint);
            canvas.drawLine(AndroidUtilities.m104dp(4) + m104dp2, AndroidUtilities.m104dp(10) + measuredHeight, m104dp2 + AndroidUtilities.m104dp(4), (getMeasuredHeight() - AndroidUtilities.m104dp(10)) - measuredHeight, this.thumbPaint);
            if (this.useClip) {
                canvas.restore();
            } else {
    ...
    private void drawCorners(Canvas canvas, int i, int i2, int i3, int i4) {
        int i5;
        int i6;
        if (AndroidUtilities.m104dp(6) != this.roundCornersSize) {
            this.roundCornersSize = AndroidUtilities.m104dp(6);
            this.roundCornerBitmap = Bitmap.createBitmap(AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), Bitmap.Config.ARGB_8888);
    ...
    public static class TimeHintView extends View {
        ...
        public TimeHintView(Context context) {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m104dp(5), Theme.getColor(Theme.key_chat_gifSaveHintBackground));
            updateColors();
            setTime(0);
        }
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(this.tooltipLayout.getHeight() + AndroidUtilities.m104dp(4) + this.tooltipBackgroundArrow.getIntrinsicHeight(), 1073741824));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            float f6 = this.scale;
            canvas.scale(f6, f6, this.f1966cx, getMeasuredHeight());
            canvas.translate(this.f1966cx - (this.tooltipLayout.getWidth() / 2.0f), BitmapDescriptorFactory.HUE_RED);
            this.tooltipBackground.setBounds(-AndroidUtilities.m104dp(8), 0, this.tooltipLayout.getWidth() + AndroidUtilities.m104dp(8), (int) (this.tooltipLayout.getHeight() + AndroidUtilities.dpf2(4.0f)));
        ...
        public void updateColors() {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(m104dp, Theme.getColor(i));
