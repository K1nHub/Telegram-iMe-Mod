...
public class InviteLinkBottomSheet extends BottomSheet {
    ...
    public InviteLinkBottomSheet(Context context, final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, TLRPC$ChatFull tLRPC$ChatFull, final HashMap<Long, TLRPC$User> hashMap, final BaseFragment baseFragment, long j, boolean z, boolean z2) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.1
            ...
            */
            protected void onDraw(android.graphics.Canvas r13) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.InviteLinkBottomSheet.C51091.onDraw(android.graphics.Canvas):void");
            }
        ...
        if (!z) {
            if (tLRPC$TL_chatInviteExported.expired) {
                this.titleTextView.setText(LocaleController.getString("ExpiredLink", C3632R.string.ExpiredLink));
            } else if (tLRPC$TL_chatInviteExported.revoked) {
                this.titleTextView.setText(LocaleController.getString("RevokedLink", C3632R.string.RevokedLink));
            } else {
                this.titleTextView.setText(LocaleController.getString("InviteLink", C3632R.string.InviteLink));
            }
    ...
    private void updateColorForView(View view) {
        if (view instanceof HeaderCell) {
            ...
            CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C3632R.C3634drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
        ...
        if (childViewHolder != null) {
            if (childViewHolder.getItemViewType() == 7) {
                CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C3632R.C3634drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow), 0, 0);
                combinedDrawable2.setFullsize(true);
                view.setBackgroundDrawable(combinedDrawable2);
            } else if (childViewHolder.getItemViewType() == 2) {
                CombinedDrawable combinedDrawable3 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C3632R.C3634drawable.greydivider, Theme.key_windowBackgroundGrayShadow), 0, 0);
    ...
    */
    ...
    public class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 3:
                    ...
                    linkActionView.setDelegate(new C51141());
                ...
                case 4:
                    ...
                    CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(context, C3632R.C3634drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    combinedDrawable.setFullsize(true);
                ...
                case 7:
                    ...
                    CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(context, C3632R.C3634drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow), 0, 0);
                    combinedDrawable2.setFullsize(true);
        ...
        /* loaded from: classes6.dex */
        public class C51141 implements LinkActionView.Delegate {
            ...
            public void revokeLink() {
                ...
                if (baseFragment instanceof ManageLinksActivity) {
                    ...
                    ConnectionsManager.getInstance(((BottomSheet) InviteLinkBottomSheet.this).currentAccount).sendRequest(tLRPC$TL_messages_editExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda2
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            InviteLinkBottomSheet.Adapter.C51141.this.lambda$revokeLink$1(tLObject, tLRPC$TL_error);
                        }
                    });
                }
                InviteLinkBottomSheet.this.dismiss();
            ...
            public /* synthetic */ void lambda$revokeLink$1(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteLinkBottomSheet.Adapter.C51141.this.lambda$revokeLink$0(tLRPC$TL_error, tLObject);
                    }
                });
            }
            ...
            public void removeLink() {
                ...
                if (baseFragment instanceof ManageLinksActivity) {
                    ...
                    ConnectionsManager.getInstance(((BottomSheet) InviteLinkBottomSheet.this).currentAccount).sendRequest(tLRPC$TL_messages_deleteExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda3
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            InviteLinkBottomSheet.Adapter.C51141.this.lambda$removeLink$3(tLObject, tLRPC$TL_error);
                        }
                    });
                }
                InviteLinkBottomSheet.this.dismiss();
            ...
            public /* synthetic */ void lambda$removeLink$3(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        InviteLinkBottomSheet.Adapter.C51141.this.lambda$removeLink$2(tLRPC$TL_error);
                    }
                });
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == inviteLinkBottomSheet.creatorHeaderRow) {
                    headerCell.setText(LocaleController.getString("LinkCreatedeBy", C3632R.string.LinkCreatedeBy));
                    ...
                    if (i5 > 0) {
                        ...
                        headerCell.setText(LocaleController.getString("NoOneJoined", C3632R.string.NoOneJoined));
                    }
                ...
                if (i == inviteLinkBottomSheet2.creatorRow) {
                    ...
                    if (tLRPC$User2 != null) {
                        ...
                        str = LocaleController.formatStringInternal(C3632R.string.invite_link_created_date, LocaleController.formatImportedDate(InviteLinkBottomSheet.this.invite.date));
                    } else {
                        str = null;
                    }
                            ...
                            if (i4 >= InviteLinkBottomSheet.this.info.participants.participants.size()) {
                                ...
                                if (tLRPC$ChatParticipant instanceof TLRPC$TL_chatChannelParticipant) {
                                    ...
                                    if (!TextUtils.isEmpty(tLRPC$ChannelParticipant.rank)) {
                                        ...
                                        str2 = LocaleController.getString("ChannelCreator", C3632R.string.ChannelCreator);
                                    } else if (tLRPC$ChannelParticipant instanceof TLRPC$TL_channelParticipantAdmin) {
                                        str2 = LocaleController.getString("ChannelAdmin", C3632R.string.ChannelAdmin);
                                    }
                                } else {
                    ...
                    formatStringInternal = LocaleController.formatStringInternal(C3632R.string.invite_link_joined_date, LocaleController.formatImportedDate(tLRPC$TL_chatInviteImporter.date));
                ...
                if (tLRPC$TL_chatInviteExported2.revoked) {
                    timerPrivacyCell.setText(LocaleController.getString("LinkIsNoActive", C3632R.string.LinkIsNoActive));
                    ...
                    if (i9 > 0 && i9 == tLRPC$TL_chatInviteExported2.usage) {
                        timerPrivacyCell.setText(LocaleController.getString("LinkIsExpiredLimitReached", C3632R.string.LinkIsExpiredLimitReached));
                        return;
                    }
                    timerPrivacyCell.setText(LocaleController.getString("LinkIsExpired", C3632R.string.LinkIsExpired));
                    ...
                    if (j > 86400000) {
                        timerPrivacyCell.setText(LocaleController.formatString("LinkExpiresIn", C3632R.string.LinkExpiresIn, LocaleController.formatDateAudio(i10, false)));
                        return;
                    }
                    long j2 = j / 1000;
                    int i11 = (int) (j2 % 60);
                    ...
                    timerPrivacyCell.setText(LocaleController.formatString("LinkExpiresInTime", C3632R.string.LinkExpiresInTime, sb2));
                } else {
