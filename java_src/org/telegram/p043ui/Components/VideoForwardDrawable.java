...
public class VideoForwardDrawable extends Drawable {
    ...
    public VideoForwardDrawable(boolean z) {
        ...
        while (true) {
            ...
            if (i == 0) {
                int i2 = i * 2;
                this.path1.moveTo(AndroidUtilities.m72dp(iArr[i2]), AndroidUtilities.m72dp(iArr[i2 + 1]));
            } else {
                int i3 = i * 2;
                this.path1.lineTo(AndroidUtilities.m72dp(iArr[i3]), AndroidUtilities.m72dp(iArr[i3 + 1]));
            }
            i++;
        }
    }
