...
public class VideoForwardDrawable extends Drawable {
    ...
    public VideoForwardDrawable(boolean z) {
        ...
        while (true) {
            ...
            if (i == 0) {
                int i2 = i * 2;
                this.path1.moveTo(AndroidUtilities.m107dp(iArr[i2]), AndroidUtilities.m107dp(iArr[i2 + 1]));
            } else {
                int i3 = i * 2;
                this.path1.lineTo(AndroidUtilities.m107dp(iArr[i3]), AndroidUtilities.m107dp(iArr[i3 + 1]));
            }
            i++;
        }
    }
    ...
    */
    public void draw(android.graphics.Canvas r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.VideoForwardDrawable.draw(android.graphics.Canvas):void");
    }
