...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(Context context, TLObject tLObject, String str, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C3419R.C3421drawable.ic_layer_close);
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m72dp(45));
        ...
        if (tLRPC$ChatInvite != null) {
            ...
            TLRPC$ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.currentChat.f1518id);
        ...
        if (tLRPC$ChatInvite5 == null || tLRPC$ChatInvite5.request_needed) {
            ...
            this.requestProgressView.setSize(AndroidUtilities.m72dp(32));
            ...
            textView4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m72dp(8), getThemedColor(i7), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
            ...
            if (z2) {
                i2 = C3419R.string.RequestToJoinChannel;
                str3 = "RequestToJoinChannel";
            } else {
                i2 = C3419R.string.RequestToJoinGroup;
            ...
            if (z2) {
                i3 = C3419R.string.RequestToJoinChannelDescription;
                str4 = "RequestToJoinChannelDescription";
            } else {
                i3 = C3419R.string.RequestToJoinGroupDescription;
            ...
            if (!tLRPC$ChatInvite5.participants.isEmpty()) {
                ...
                avatarsImageView.setAvatarsTextSize(AndroidUtilities.m72dp(20));
                avatarsImageView.setSize(AndroidUtilities.m72dp(38));
                ...
                if (min == 1) {
                    ...
                    format = LocaleController.formatString("RequestToJoinMembersTwo", C3419R.string.RequestToJoinMembersTwo, ellipsize(textView7, this.chatInvite, 0), ellipsize(textView7, this.chatInvite, 1));
                } else if (i == 3) {
                    format = LocaleController.formatString("RequestToJoinMembersThree", C3419R.string.RequestToJoinMembersThree, ellipsize(textView7, this.chatInvite, 0), ellipsize(textView7, this.chatInvite, 1), ellipsize(textView7, this.chatInvite, 2));
                } else {
            ...
            textView8.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m72dp(8), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
            textView8.setEllipsize(TextUtils.TruncateAt.END);
            textView8.setGravity(17);
            textView8.setSingleLine(true);
            if (z) {
                i4 = C3419R.string.ProfileJoinChannel;
                str5 = "ProfileJoinChannel";
            } else {
                i4 = C3419R.string.ProfileJoinGroup;
            ...
            textView8.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.JoinGroupAlert$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$new$7(final boolean z, View view) {
        ...
        if (this.chatInvite == null && this.currentChat != null) {
            MessagesController.getInstance(this.currentAccount).addUserToChat(this.currentChat.f1518id, UserConfig.getInstance(this.currentAccount).getCurrentUser(), 0, null, null, true, new Runnable() { // from class: org.telegram.ui.Components.JoinGroupAlert$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static void showBulletin(Context context, BaseFragment baseFragment, boolean z) {
        ...
        twoLineLottieLayout.imageView.setAnimation(C3419R.raw.timer_3, 28, 28);
        twoLineLottieLayout.titleTextView.setText(LocaleController.getString("RequestToJoinSent", C3419R.string.RequestToJoinSent));
        if (z) {
            string = LocaleController.getString("RequestToJoinChannelSentDescription", C3419R.string.RequestToJoinChannelSentDescription);
        } else {
            string = LocaleController.getString("RequestToJoinGroupSentDescription", C3419R.string.RequestToJoinGroupSentDescription);
        }
    ...
    private CharSequence ellipsize(TextView textView, TLRPC$ChatInvite tLRPC$ChatInvite, int i) {
        ...
        return TextUtils.ellipsize(str.trim(), textView.getPaint(), AndroidUtilities.m72dp(120), TextUtils.TruncateAt.END);
    }
}
