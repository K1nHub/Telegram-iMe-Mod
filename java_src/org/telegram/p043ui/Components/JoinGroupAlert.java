...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(Context context, TLObject tLObject, String str, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C3473R.C3475drawable.ic_layer_close);
        ...
        if (tLRPC$ChatInvite != null) {
            ...
            TLRPC$ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.currentChat.f1522id);
        ...
        if (tLRPC$ChatInvite5 == null || tLRPC$ChatInvite5.request_needed) {
            ...
            if (z2) {
                i2 = C3473R.string.RequestToJoinChannel;
                str3 = "RequestToJoinChannel";
            } else {
                i2 = C3473R.string.RequestToJoinGroup;
            ...
            if (z2) {
                i3 = C3473R.string.RequestToJoinChannelDescription;
                str4 = "RequestToJoinChannelDescription";
            } else {
                i3 = C3473R.string.RequestToJoinGroupDescription;
            ...
            if (!tLRPC$ChatInvite5.participants.isEmpty()) {
                ...
                if (min == 1) {
                    ...
                    format = LocaleController.formatString("RequestToJoinMembersTwo", C3473R.string.RequestToJoinMembersTwo, ellipsize(textView7, this.chatInvite, 0), ellipsize(textView7, this.chatInvite, 1));
                } else if (i == 3) {
                    format = LocaleController.formatString("RequestToJoinMembersThree", C3473R.string.RequestToJoinMembersThree, ellipsize(textView7, this.chatInvite, 0), ellipsize(textView7, this.chatInvite, 1), ellipsize(textView7, this.chatInvite, 2));
                } else {
            ...
            if (z) {
                i4 = C3473R.string.ProfileJoinChannel;
                str5 = "ProfileJoinChannel";
            } else {
                i4 = C3473R.string.ProfileJoinGroup;
    ...
    public /* synthetic */ void lambda$new$7(final boolean z, View view) {
        ...
        if (this.chatInvite == null && this.currentChat != null) {
            MessagesController.getInstance(this.currentAccount).addUserToChat(this.currentChat.f1522id, UserConfig.getInstance(this.currentAccount).getCurrentUser(), 0, null, null, true, new Runnable() { // from class: org.telegram.ui.Components.JoinGroupAlert$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static void showBulletin(Context context, BaseFragment baseFragment, boolean z) {
        ...
        twoLineLottieLayout.imageView.setAnimation(C3473R.raw.timer_3, 28, 28);
        twoLineLottieLayout.titleTextView.setText(LocaleController.getString("RequestToJoinSent", C3473R.string.RequestToJoinSent));
        if (z) {
            string = LocaleController.getString("RequestToJoinChannelSentDescription", C3473R.string.RequestToJoinChannelSentDescription);
        } else {
            string = LocaleController.getString("RequestToJoinGroupSentDescription", C3473R.string.RequestToJoinGroupSentDescription);
        }
