...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(Context context, TLObject tLObject, String str, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m107dp(45));
        ...
        if (tLRPC$ChatInvite6 == null || tLRPC$ChatInvite6.request_needed) {
            ...
            this.requestProgressView.setSize(AndroidUtilities.m107dp(32));
            ...
            textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(8), getThemedColor(i8), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
            ...
            if (tLRPC$ChatInvite6.participants.isEmpty()) {
                ...
                avatarsImageView.setAvatarsTextSize(AndroidUtilities.m107dp(20));
                avatarsImageView.setSize(AndroidUtilities.m107dp(38));
            ...
            textView7.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(8), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
    ...
    private CharSequence ellipsize(TextView textView, TLRPC$ChatInvite tLRPC$ChatInvite, int i) {
        ...
        return TextUtils.ellipsize(str.trim(), textView.getPaint(), AndroidUtilities.m107dp(120), TextUtils.TruncateAt.END);
    }
