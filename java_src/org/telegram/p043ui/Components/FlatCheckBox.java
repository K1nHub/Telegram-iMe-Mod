...
public class FlatCheckBox extends View {
    ...
    public FlatCheckBox(Context context) {
        ...
        this.HEIGHT = AndroidUtilities.m107dp(37);
        this.INNER_PADDING = AndroidUtilities.m107dp(22);
        this.TRANSLETE_TEXT = AndroidUtilities.m107dp(8);
        this.f1858P = AndroidUtilities.m108dp(2.5f);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension((str == null ? 0 : (int) this.textPaint.measureText(str)) + (this.INNER_PADDING << 1) + (this.f1858P * 2), this.HEIGHT + AndroidUtilities.m107dp(4));
        if (getMeasuredWidth() != this.lastW) {
            ...
            this.rectF.inset(this.f1858P + (this.outLinePaint.getStrokeWidth() / 2.0f), this.f1858P + (this.outLinePaint.getStrokeWidth() / 2.0f));
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(AndroidUtilities.m107dp(12), measuredHeight - AndroidUtilities.m107dp(9));
        if (this.progress > 0.5f) {
            this.checkPaint.setColor(this.colorTextActive);
            float f4 = 1.0f - f3;
            canvas.drawLine(AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) - (AndroidUtilities.m107dp(4) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m107dp(4) * f4)), this.checkPaint);
            canvas.drawLine((int) AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) + (AndroidUtilities.m107dp(8) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m107dp(8) * f4)), this.checkPaint);
        }
        canvas.restore();
    }
