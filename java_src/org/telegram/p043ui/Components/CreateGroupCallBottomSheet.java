...
public class CreateGroupCallBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public CreateGroupCallBottomSheet(BaseFragment baseFragment, ArrayList<TLRPC$Peer> arrayList, long j, JoinCallAlert.JoinCallAlertDelegate joinCallAlertDelegate) {
        ...
        if (isChannelOrGiga) {
            formatString = LocaleController.formatString("VoipChannelStartVoiceChat", C3473R.string.VoipChannelStartVoiceChat, new Object[0]);
        } else {
            formatString = LocaleController.formatString("VoipGroupStartVoiceChat", C3473R.string.VoipGroupStartVoiceChat, new Object[0]);
        }
        ...
        if (isChannelOrGiga) {
            formatString2 = LocaleController.formatString("VoipChannelScheduleVoiceChat", C3473R.string.VoipChannelScheduleVoiceChat, new Object[0]);
        } else {
            formatString2 = LocaleController.formatString("VoipGroupScheduleVoiceChat", C3473R.string.VoipGroupScheduleVoiceChat, new Object[0]);
        }
    ...
    protected CharSequence getTitle() {
        if (this.isChannelOrGiga) {
            return LocaleController.getString("StartVoipChannelTitle", C3473R.string.StartVoipChannelTitle);
        }
        return LocaleController.getString("StartVoipChatTitle", C3473R.string.StartVoipChatTitle);
    }
        ...
        return new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.Components.CreateGroupCallBottomSheet.2
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (viewHolder.getItemViewType() == 3) {
                    ...
                    headerCell.setText(LocaleController.getString("VoipChatDisplayedAs", C3473R.string.VoipChatDisplayedAs).replace(":", ""));
                }
            }
    ...
    private static class TopCell extends LinearLayout {
        public TopCell(Context context, boolean z) {
            ...
            rLottieImageView.setAnimation(C3473R.raw.utyan_schedule, 112, 112);
            rLottieImageView.playAnimation();
            addView(rLottieImageView, LayoutHelper.createLinear(112, 112, 49, 0, 24, 0, 0));
            TextView textView = new TextView(context);
            textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
            if (z) {
                formatString = LocaleController.formatString("StartVoipChannelTitle", C3473R.string.StartVoipChannelTitle, new Object[0]);
            } else {
                formatString = LocaleController.formatString("StartVoipChatTitle", C3473R.string.StartVoipChatTitle, new Object[0]);
            }
            textView.setText(formatString);
            ...
            if (z) {
                formatString2 = LocaleController.formatString("VoipChannelStart2", C3473R.string.VoipChannelStart2, new Object[0]);
            } else {
                formatString2 = LocaleController.formatString("VoipGroupStart2", C3473R.string.VoipGroupStart2, new Object[0]);
            }
            textView2.setText(formatString2);
