...
public class CreateGroupCallBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public CreateGroupCallBottomSheet(BaseFragment baseFragment, ArrayList<TLRPC$Peer> arrayList, long j, JoinCallAlert.JoinCallAlertDelegate joinCallAlertDelegate) {
        ...
        textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(m104dp, Theme.getColor(i), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhite), 120)));
        ...
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(8), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), 120)));
        ...
        recyclerListView.setPadding(i2, 0, i2, AndroidUtilities.m104dp(120));
