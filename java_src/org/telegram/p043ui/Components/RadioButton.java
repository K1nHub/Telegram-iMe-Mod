...
public class RadioButton extends View {
    ...
    public RadioButton(Context context) {
        ...
        if (paint == null) {
            ...
            paint = paint2;
            paint2.setStrokeWidth(AndroidUtilities.m72dp(2));
        ...
        try {
            this.bitmap = Bitmap.createBitmap(AndroidUtilities.m72dp(this.size), AndroidUtilities.m72dp(this.size), Bitmap.Config.ARGB_4444);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (bitmap3 != null) {
            ...
            if (this.progress <= 0.5f) {
                this.bitmapCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, f4 - AndroidUtilities.m72dp(1), checkedPaint);
                this.bitmapCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, (f4 - AndroidUtilities.m72dp(1)) * (1.0f - f), eraser);
            } else {
                this.bitmapCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, (this.size / 4) + (((f4 - AndroidUtilities.m72dp(1)) - (this.size / 4)) * f), checkedPaint);
            }
