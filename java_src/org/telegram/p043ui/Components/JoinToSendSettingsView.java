...
public class JoinToSendSettingsView extends LinearLayout {
    ...
    public JoinToSendSettingsView(Context context, TLRPC$Chat tLRPC$Chat) {
        ...
        headerCell.setText(LocaleController.getString("ChannelSettingsJoinTitle", C3632R.string.ChannelSettingsJoinTitle));
        ...
        String string = LocaleController.getString("ChannelSettingsJoinToSend", C3632R.string.ChannelSettingsJoinToSend);
        ...
        this.joinRequestCell.setTextAndCheck(LocaleController.getString("ChannelSettingsJoinRequest", C3632R.string.ChannelSettingsJoinRequest), this.isJoinRequest, false);
        ...
        textInfoPrivacyCell.setText(LocaleController.getString("ChannelSettingsJoinToSendInfo", C3632R.string.ChannelSettingsJoinToSendInfo));
        addView(this.joinToSendInfoCell);
        TextInfoPrivacyCell textInfoPrivacyCell2 = new TextInfoPrivacyCell(context);
        this.joinRequestInfoCell = textInfoPrivacyCell2;
        textInfoPrivacyCell2.setText(LocaleController.getString("ChannelSettingsJoinRequestInfo", C3632R.string.ChannelSettingsJoinRequestInfo));
    ...
    private void updateToggleValue(float f) {
        ...
        float f2 = 1.0f - f;
        this.joinRequestCell.setTranslationY((-AndroidUtilities.m107dp(16)) * f2);
        this.joinRequestCell.setScaleY(1.0f - (0.1f * f2));
        int m107dp = this.joinRequestCell.getMeasuredHeight() <= 0 ? AndroidUtilities.m107dp(50) : this.joinRequestCell.getMeasuredHeight();
        this.joinToSendInfoCell.setAlpha(f2);
        float f3 = (-m107dp) * f2;
        this.joinToSendInfoCell.setTranslationY(((-AndroidUtilities.m107dp(4)) * f) + f3);
        this.joinRequestInfoCell.setAlpha(f);
        this.joinRequestInfoCell.setTranslationY(f3 + (AndroidUtilities.m107dp(4) * f2));
        requestLayout();
    }
