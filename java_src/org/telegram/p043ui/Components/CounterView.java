...
public class CounterView extends View {
    ...
    public static class CounterDrawable {
        ...
        /* renamed from: cx */
        private float f1829cx;

        /* renamed from: cy */
        private float f1830cy;
        ...
        public CounterDrawable(View view, boolean z, Theme.ResourcesProvider resourcesProvider) {
            ...
            if (this.recentChatsMode) {
                this.textPaint.setTextSize(AndroidUtilities.m104dp(8));
            } else {
        ...
        private void drawInternal(Canvas canvas) {
            ...
            float m105dp = (this.lastH - AndroidUtilities.m105dp(f)) / 2.0f;
            updateX(this.countWidth);
            if (this.recentChatsMode) {
                RectF rectF = this.rectF;
                float f2 = this.f1829cx;
                rectF.set(f2, this.f1830cy, AndroidUtilities.m104dp(20) + f2, this.f1830cy + AndroidUtilities.m104dp(20));
            } else {
                RectF rectF2 = this.rectF;
                float f3 = this.f1831x;
                rectF2.set(f3, m105dp, this.countWidth + f3 + AndroidUtilities.m105dp(this.radius - 0.5f), AndroidUtilities.m105dp(f) + m105dp);
            }
            ...
            if (this.countLayout != null) {
                canvas.save();
                if (this.recentChatsMode) {
                    canvas.translate(this.f1829cx + AndroidUtilities.m104dp(4), this.f1830cy + AndroidUtilities.m105dp(4.5f));
                } else {
                    canvas.translate(this.countLeft, m105dp + AndroidUtilities.m104dp(4));
                }
        ...
        public void setCount(int i, boolean z) {
            ...
            if (!z2) {
                ...
                this.countWidth = Math.max(AndroidUtilities.m104dp(12), (int) Math.ceil(this.textPaint.measureText(stringOfCCount)));
            ...
            if (z2) {
                ...
                if (this.countLayout != null) {
                    ...
                    if (stringOfCCount3.length() == stringOfCCount2.length()) {
                        ...
                        int max = Math.max(AndroidUtilities.m104dp(12), (int) Math.ceil(this.textPaint.measureText(stringOfCCount3)));
            ...
            if (i > 0) {
                this.countWidth = Math.max(AndroidUtilities.m104dp(12), (int) Math.ceil(this.textPaint.measureText(stringOfCCount2)));
        ...
        public void draw(Canvas canvas) {
            ...
            if (f2 != 1.0f) {
                ...
                float m105dp = (this.lastH - AndroidUtilities.m105dp(this.radius * 2.0f)) / 2.0f;
                ...
                RectF rectF = this.rectF;
                float f9 = this.f1831x;
                rectF.set(f9, m105dp, f7 + f9 + AndroidUtilities.m105dp(this.radius - 0.5f), AndroidUtilities.m105dp(this.radius * 2.0f) + m105dp);
                canvas.save();
                ...
                if (this.countAnimationInLayout != null) {
                    ...
                    float m104dp = AndroidUtilities.m104dp(4) + m105dp;
                    int m104dp2 = AndroidUtilities.m104dp(13);
                    if (!z2) {
                        m104dp2 = -m104dp2;
                    }
                    canvas.translate(f15, m104dp + (m104dp2 * (1.0f - f6)));
                    ...
                    float m104dp3 = AndroidUtilities.m104dp(4) + m105dp;
                    int m104dp4 = AndroidUtilities.m104dp(13);
                    if (!z2) {
                        m104dp4 = -m104dp4;
                    }
                    canvas.translate(f16, m104dp3 + (m104dp4 * (1.0f - f6)));
                    this.textPaint.setAlpha((int) (f6 * 255.0f));
                    this.countLayout.draw(canvas);
                    canvas.restore();
                }
                if (this.countOldLayout != null) {
                    canvas.save();
                    canvas.translate(this.countLeft, AndroidUtilities.m104dp(4) + m105dp + ((z2 ? -AndroidUtilities.m104dp(13) : AndroidUtilities.m104dp(13)) * f6));
        ...
        public void updateBackgroundRect() {
            ...
            if (f != 1.0f) {
                ...
                if (i == 0 || i == 1) {
                    ...
                    float m105dp = (this.lastH - AndroidUtilities.m105dp(this.radius * 2.0f)) / 2.0f;
                    RectF rectF = this.rectF;
                    float f2 = this.f1831x;
                    rectF.set(f2, m105dp, this.countWidth + f2 + AndroidUtilities.m104dp(11), AndroidUtilities.m104dp(23) + m105dp);
                    return;
                }
                float f3 = f * 2.0f;
                if (f3 > 1.0f) {
                ...
                float m105dp2 = (this.lastH - AndroidUtilities.m105dp(this.radius * 2.0f)) / 2.0f;
                int i2 = this.countWidth;
                int i3 = this.countWidthOld;
                float f4 = i2 == i3 ? i2 : (i2 * f3) + (i3 * (1.0f - f3));
                updateX(f4);
                RectF rectF2 = this.rectF;
                float f5 = this.f1831x;
                rectF2.set(f5, m105dp2, f4 + f5 + AndroidUtilities.m104dp(11), AndroidUtilities.m104dp(23) + m105dp2);
                return;
            }
            updateX(this.countWidth);
            float m105dp3 = (this.lastH - AndroidUtilities.m105dp(this.radius * 2.0f)) / 2.0f;
            RectF rectF3 = this.rectF;
            float f6 = this.f1831x;
            rectF3.set(f6, m105dp3, this.countWidth + f6 + AndroidUtilities.m104dp(11), AndroidUtilities.m104dp(23) + m105dp3);
        }

        private void updateX(float f) {
            float m105dp = this.drawBackground ? AndroidUtilities.m105dp(5.5f) : 0.0f;
            int i = this.gravity;
            if (i == 5) {
                float f2 = this.width - m105dp;
                this.countLeft = f2;
                ...
                this.countLeft = m105dp;
            } else {
                this.countLeft = (int) ((this.width - f) / 2.0f);
            }
            this.f1831x = this.countLeft - m105dp;
        }
        ...
        public int getWidth() {
            ...
            return this.countWidth + AndroidUtilities.m105dp(this.radius - 0.5f);
        }
    }
