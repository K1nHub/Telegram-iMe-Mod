...
public class MemberRequestsBottomSheet extends UsersAlertBase {
    ...
    public MemberRequestsBottomSheet(BaseFragment baseFragment, long j) {
        ...
        this.searchView.searchEditText.setHint(LocaleController.getString("SearchMemberRequests", C3634R.string.SearchMemberRequests));
    ...
    public void show() {
        if (this.delegate.isNeedRestoreList && this.scrollOffsetY == 0) {
            this.scrollOffsetY = AndroidUtilities.m104dp(8);
        }
        super.show();
    ...
    public void updateLayout() {
        if (this.listView.getChildCount() <= 0) {
            int paddingTop = this.listView.getVisibility() == 0 ? this.listView.getPaddingTop() - AndroidUtilities.m104dp(8) : 0;
