...
public class WallpaperParallaxEffect implements SensorEventListener {
    ...
    public WallpaperParallaxEffect(Context context) {
        this.f1968wm = (WindowManager) context.getSystemService("window");
    ...
    public float getScale(int i, int i2) {
        float f = i;
        float m104dp = AndroidUtilities.m104dp(16) * 2;
        float f2 = (f + m104dp) / f;
        float f3 = i2;
        return Math.max(f2, (m104dp + f3) / f3);
    }
