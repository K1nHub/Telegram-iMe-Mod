...
public class TimerDrawable extends Drawable {
    ...
    public void setTime(int i) {
        ...
        if (this.time != i) {
            ...
            String str2 = str;
            this.timePaint.setTextSize(AndroidUtilities.m107dp(11));
            float measureText = this.timePaint.measureText(str2);
            this.timeWidth = measureText;
            if (measureText > AndroidUtilities.m107dp(13)) {
                this.timePaint.setTextSize(AndroidUtilities.m107dp(9));
                this.timeWidth = this.timePaint.measureText(str2);
            }
            if (this.timeWidth > AndroidUtilities.m107dp(13)) {
                this.timePaint.setTextSize(AndroidUtilities.m107dp(6));
                this.timeWidth = this.timePaint.measureText(str2);
            }
            try {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.currentTtlIcon != null) {
            ...
            if (this.isDialog) {
                ...
                rect.set(getBounds().centerX() - AndroidUtilities.m108dp(10.5f), getBounds().centerY() - AndroidUtilities.m108dp(10.5f), (getBounds().centerX() - AndroidUtilities.m108dp(10.5f)) + this.currentTtlIcon.getIntrinsicWidth(), (getBounds().centerY() - AndroidUtilities.m108dp(10.5f)) + this.currentTtlIcon.getIntrinsicHeight());
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m107dp(23);
    }
