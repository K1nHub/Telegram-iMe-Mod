...
public class AvatarConstructorPreviewCell extends FrameLayout {
    ...
    public AvatarConstructorPreviewCell(Context context, boolean z) {
            ...
            if (stickerSets.isEmpty()) {
                ...
                for (int i2 = 0; i2 < featuredEmojiSets.size(); i2++) {
                    ...
                    if (tLRPC$Document != null) {
                        this.emojiList.document_id.add(Long.valueOf(tLRPC$Document.f1530id));
                        ...
                        if (!tLRPC$TL_stickerSetFullCovered.documents.isEmpty()) {
                            this.emojiList.document_id.add(Long.valueOf(tLRPC$TL_stickerSetFullCovered.documents.get(0).f1530id));
                        }
                    }
                }
            } else {
                for (int i3 = 0; i3 < stickerSets.size(); i3++) {
                    ...
                    if (!tLRPC$TL_messages_stickerSet.documents.isEmpty()) {
                        this.emojiList.document_id.add(Long.valueOf(tLRPC$TL_messages_stickerSet.documents.get(Math.abs(Utilities.fastRandom.nextInt() % tLRPC$TL_messages_stickerSet.documents.size())).f1530id));
                    }
                }
            }
        }
        ...
        this.textView.setText(LocaleController.getString("UseEmoji", C3473R.string.UseEmoji));
