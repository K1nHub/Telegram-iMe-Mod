...
public class FilterShaders {
    ...
    public boolean drawBlurPass() {
        ...
        if (blurType == 1) {
            ...
            GLES20.glUniform2f(this.radialBlurExcludePointHandle, blurExcludePoint.f1892x, blurExcludePoint.f1893y);
            ...
            GLES20.glUniform2f(this.linearBlurExcludePointHandle, blurExcludePoint2.f1892x, blurExcludePoint2.f1893y);
