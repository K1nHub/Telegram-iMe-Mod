...
public class FilterShaders {
    ...
    public boolean drawBlurPass() {
        ...
        if (blurType == 1) {
            ...
            GLES20.glUniform2f(this.radialBlurExcludePointHandle, blurExcludePoint.f1899x, blurExcludePoint.f1900y);
            ...
            GLES20.glUniform2f(this.linearBlurExcludePointHandle, blurExcludePoint2.f1899x, blurExcludePoint2.f1900y);
