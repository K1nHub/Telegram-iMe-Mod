...
public class PlayingGameDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int intrinsicHeight = getBounds().top + ((getIntrinsicHeight() - m104dp) / 2);
        if (!this.isChat) {
            intrinsicHeight += AndroidUtilities.m104dp(1);
        }
        ...
        this.rect.set(BitmapDescriptorFactory.HUE_RED, i, m104dp, i + m104dp);
        float f = this.progress;
        int i2 = (int) (f < 0.5f ? (1.0f - (f / 0.5f)) * 35.0f : ((f - 0.5f) * 35.0f) / 0.5f);
        for (int i3 = 0; i3 < 3; i3++) {
            float f2 = this.progress;
            float m104dp2 = ((AndroidUtilities.m104dp(5) * i3) + AndroidUtilities.m105dp(9.2f)) - (AndroidUtilities.m104dp(5) * f2);
            if (i3 == 2) {
            ...
            canvas.drawCircle(m104dp2, (m104dp / 2) + i, AndroidUtilities.m105dp(1.2f), this.paint);
        }
        this.paint.setAlpha(255);
        ...
        canvas.drawCircle(AndroidUtilities.m104dp(4), (i + (m104dp / 2)) - AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(1), this.paint);
        checkUpdate();
    }
