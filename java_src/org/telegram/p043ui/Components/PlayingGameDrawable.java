...
public class PlayingGameDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int intrinsicHeight = getBounds().top + ((getIntrinsicHeight() - m107dp) / 2);
        if (!this.isChat) {
            intrinsicHeight += AndroidUtilities.m107dp(1);
        }
        ...
        this.rect.set(BitmapDescriptorFactory.HUE_RED, i, m107dp, i + m107dp);
        float f = this.progress;
        int i2 = (int) (f < 0.5f ? (1.0f - (f / 0.5f)) * 35.0f : ((f - 0.5f) * 35.0f) / 0.5f);
        for (int i3 = 0; i3 < 3; i3++) {
            float f2 = this.progress;
            float m107dp2 = ((AndroidUtilities.m107dp(5) * i3) + AndroidUtilities.m108dp(9.2f)) - (AndroidUtilities.m107dp(5) * f2);
            if (i3 == 2) {
            ...
            canvas.drawCircle(m107dp2, (m107dp / 2) + i, AndroidUtilities.m108dp(1.2f), this.paint);
        }
        this.paint.setAlpha(255);
        ...
        canvas.drawCircle(AndroidUtilities.m107dp(4), (i + (m107dp / 2)) - AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(1), this.paint);
        checkUpdate();
    }
