...
import org.telegram.p043ui.Components.AvatarsDrawable;
...
public class ReactionsLayoutInBubble {
    ...
    static {
        ...
        pointer = 1;
        usersComparator = new Comparator() { // from class: org.telegram.ui.Components.Reactions.ReactionsLayoutInBubble$$ExternalSyntheticLambda1
    ...
    /* JADX WARN: Type inference failed for: r11v13, types: [org.telegram.ui.Components.CounterView$CounterDrawable] */
    ...
    */
    public void setMessage(org.telegram.messenger.MessageObject r18, boolean r19, org.telegram.p043ui.ActionBar.Theme.ResourcesProvider r20) {
        /*
            Method dump skipped, instructions count: 559
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.Reactions.ReactionsLayoutInBubble.setMessage(org.telegram.messenger.MessageObject, boolean, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public void measure(int i, int i2) {
        ...
        for (int i6 = 0; i6 < this.reactionButtons.size(); i6++) {
            ...
            if (reactionButton.isSmall) {
                reactionButton.width = AndroidUtilities.m107dp(14);
                reactionButton.height = AndroidUtilities.m107dp(14);
            } else {
                reactionButton.width = AndroidUtilities.m107dp(8) + AndroidUtilities.m107dp(20) + AndroidUtilities.m107dp(4);
                if (reactionButton.avatarsDrawable != null && reactionButton.users.size() > 0) {
                    reactionButton.users.size();
                    reactionButton.width = (int) (reactionButton.width + AndroidUtilities.m107dp(2) + (AndroidUtilities.m107dp(20) * 1) + ((reactionButton.users.size() > 1 ? reactionButton.users.size() - 1 : 0) * AndroidUtilities.m107dp(20) * 0.8f) + AndroidUtilities.m107dp(1));
                    reactionButton.avatarsDrawable.height = AndroidUtilities.m107dp(26);
                } else {
                    reactionButton.width = (int) (reactionButton.width + reactionButton.counterDrawable.textPaint.measureText(reactionButton.countText) + AndroidUtilities.m107dp(8));
                }
                reactionButton.height = AndroidUtilities.m107dp(26);
            }
            if (reactionButton.width + i3 > i) {
                i4 += reactionButton.height + AndroidUtilities.m107dp(4);
                i3 = 0;
            }
            reactionButton.f1940x = i3;
            reactionButton.f1941y = i4;
            i3 += reactionButton.width + AndroidUtilities.m107dp(4);
            if (i3 > i5) {
                i5 = i3;
            }
        }
        if (i2 == 5 && !this.reactionButtons.isEmpty()) {
            int i7 = this.reactionButtons.get(0).f1941y;
            int i8 = 0;
            for (int i9 = 0; i9 < this.reactionButtons.size(); i9++) {
                if (this.reactionButtons.get(i9).f1941y != i7) {
                    int i10 = i9 - 1;
                    int i11 = i - (this.reactionButtons.get(i10).f1940x + this.reactionButtons.get(i10).width);
                    while (i8 < i9) {
                        this.reactionButtons.get(i8).f1940x += i11;
                        i8++;
                    }
                    i8 = i9;
                }
            ...
            int i12 = i - (this.reactionButtons.get(size).f1940x + this.reactionButtons.get(size).width);
            while (i8 <= size) {
                this.reactionButtons.get(i8).f1940x += i12;
                i8++;
            }
        }
        this.lastLineX = i3;
        ...
        this.height = i4 + (this.reactionButtons.size() != 0 ? AndroidUtilities.m107dp(26) : 0);
    ...
    public void draw(Canvas canvas, float f, String str) {
        ...
        float f3 = this.f1938x;
        float f4 = this.f1939y;
        if (this.isEmpty) {
            f3 = this.lastDrawnX;
            f4 = this.lastDrawnY;
        ...
        for (int i = 0; i < this.reactionButtons.size(); i++) {
            ...
            if (!reactionButton.reaction.equals(this.scrimViewReaction) && (str == null || reactionButton.reaction.equals(str))) {
                canvas.save();
                int i2 = reactionButton.f1940x;
                float f8 = i2;
                int i3 = reactionButton.f1941y;
                float f9 = i3;
                ...
                if (i4 == 0 || reactionButton.animationType != 1) {
                    f2 = 1.0f;
                } else {
        ...
        for (int i5 = 0; i5 < this.outButtons.size(); i5++) {
            ...
            canvas.save();
            canvas.scale(f13, f13, reactionButton2.f1940x + f6 + (reactionButton2.width / 2.0f), reactionButton2.f1941y + f7 + (reactionButton2.height / 2.0f));
            this.outButtons.get(i5).draw(canvas, reactionButton2.f1940x + f6, f7 + reactionButton2.f1941y, 1.0f, f12, false);
            canvas.restore();
        }
    }
    ...
    public void recordDrawingState() {
        ...
        this.lastDrawnX = this.f1938x;
        this.lastDrawnY = this.f1939y;
    ...
    public boolean animateChange() {
        ...
        for (int i2 = 0; i2 < this.reactionButtons.size(); i2++) {
            ...
            if (reactionButton2 != null) {
                ...
                int i3 = reactionButton.f1940x;
                int i4 = reactionButton2.f1940x;
                if (i3 != i4 || reactionButton.f1941y != reactionButton2.f1941y || reactionButton.width != reactionButton2.width || reactionButton.count != reactionButton2.count || reactionButton.choosen != reactionButton2.choosen || reactionButton.avatarsDrawable != null || reactionButton2.avatarsDrawable != null) {
                    reactionButton.animateFromX = i4;
                    reactionButton.animateFromY = reactionButton2.f1941y;
        ...
        if (this.wasDrawn) {
            ...
            if (f != this.f1938x || this.lastDrawnY != this.f1939y) {
    ...
    /* renamed from: org.telegram.ui.Components.Reactions.ReactionsLayoutInBubble$ReactionLayoutButton */
    /* loaded from: classes6.dex */
    ...
    public static class ReactionButton {
        ...
        public ReactionButton(ReactionButton reactionButton, int i, View view, TLRPC$ReactionCount tLRPC$ReactionCount, boolean z, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.counterDrawable.setSize(AndroidUtilities.m107dp(26), AndroidUtilities.m107dp(100));
        ...
        public void draw(Canvas canvas, float f, float f2, float f3, float f4, boolean z) {
            ...
            if (this.isSmall && imageReceiver != null) {
                ...
                this.drawingImageRect.set((int) f, (int) f2, AndroidUtilities.m107dp(14), AndroidUtilities.m107dp(14));
            ...
            if (this.counterDrawable != null && drawCounter()) {
                canvas.save();
                canvas.translate(AndroidUtilities.m107dp(8) + f + AndroidUtilities.m107dp(20) + AndroidUtilities.m107dp(2), f2);
                this.counterDrawable.draw(canvas);
                canvas.restore();
            }
            if (this.avatarsDrawable != null) {
                canvas.save();
                canvas.translate(f + AndroidUtilities.m107dp(10) + AndroidUtilities.m107dp(20) + AndroidUtilities.m107dp(2), f2);
        ...
        public void setUsers(ArrayList<TLObject> arrayList) {
            ...
            if (arrayList != null) {
                ...
                if (this.avatarsDrawable == null) {
                    ...
                    avatarsDrawable.setSize(AndroidUtilities.m107dp(20));
                    this.avatarsDrawable.width = AndroidUtilities.m107dp(100);
                    AvatarsDrawable avatarsDrawable2 = this.avatarsDrawable;
                    avatarsDrawable2.height = this.height;
                    avatarsDrawable2.setAvatarsTextSize(AndroidUtilities.m107dp(22));
                }
                if (this.attached) {
    ...
    public boolean chekTouchEvent(MotionEvent motionEvent) {
        ...
        float x = motionEvent.getX() - this.f1938x;
        float y = motionEvent.getY() - this.f1939y;
        if (motionEvent.getAction() == 0) {
            int size = this.reactionButtons.size();
            while (true) {
                if (i >= size) {
                    break;
                } else if (x <= this.reactionButtons.get(i).f1940x || x >= this.reactionButtons.get(i).f1940x + this.reactionButtons.get(i).width || y <= this.reactionButtons.get(i).f1941y || y >= this.reactionButtons.get(i).f1941y + this.reactionButtons.get(i).height) {
                    i++;
                } else {
