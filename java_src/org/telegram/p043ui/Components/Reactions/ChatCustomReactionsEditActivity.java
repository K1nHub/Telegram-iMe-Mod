...
/* renamed from: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity */
...
public class ChatCustomReactionsEditActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x026d A[EDGE_INSN: B:51:0x026d->B:31:0x026d ?: BREAK  , SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:54:0x021b A[SYNTHETIC] */
    @Override // org.telegram.p043ui.ActionBar.BaseFragment
    /*
    ...
    */
    public android.view.View createView(android.content.Context r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.Reactions.ChatCustomReactionsEditActivity.createView(android.content.Context):android.view.View");
    }
    ...
    public /* synthetic */ void lambda$createView$3() {
        presentFragment(ChatActivity.m68of(429000L));
    }
    ...
    public /* synthetic */ void lambda$createView$4(TLRPC$TL_error tLRPC$TL_error) {
        ...
        BulletinFactory.m65of(this).createErrorBulletin(str).show();
    }
    ...
    private void initSelectAnimatedEmojiDialog() {
        ...
        C55454 c55454 = new C55454(this, getContext(), false, null, 6, false, getResourceProvider(), 16, Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, getResourceProvider()));
        this.selectAnimatedEmojiDialog = c55454;
        c55454.setAnimationsEnabled(false);
        ...
        this.bottomDialogLayout.addView(this.backSpaceButtonView, LayoutHelper.createFrame(-1, -2, 85, 0, 0, 8, 8));
    ...
    /* renamed from: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$4 */
    /* loaded from: classes6.dex */
    public class C55454 extends SelectAnimatedEmojiDialog {
        private boolean firstLayout;

        C55454(BaseFragment baseFragment, Context context, boolean z, Integer num, int i, boolean z2, Theme.ResourcesProvider resourcesProvider, int i2, int i3) {
        ...
        protected void onEmojiSelected(View view, Long l, TLRPC$Document tLRPC$Document, Integer num) {
            if (ChatCustomReactionsEditActivity.this.selectedEmojisMap.containsKey(l)) {
                ...
                animatedEmojiSpan.setRemoved(new Runnable() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$4$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatCustomReactionsEditActivity.C55454.this.lambda$onEmojiSelected$0(animatedEmojiSpan);
                    }
                });
                ...
                BulletinFactory.m65of(ChatCustomReactionsEditActivity.this).createErrorBulletin(LocaleController.formatPluralString("ReactionMaxCountError", ChatCustomReactionsEditActivity.this.maxReactionsCount, new Object[0])).show();
            } else {
                try {
    ...
    private void setCheckedEnableReactionCell(int i, boolean z) {
        ...
        if (i != 1 && i != 0) {
            if (z) {
                ...
                ViewPropertyAnimator duration = this.actionButton.animate().alpha(BitmapDescriptorFactory.HUE_RED).setDuration(350L);
                ...
                this.switchLayout.animate().alpha(BitmapDescriptorFactory.HUE_RED).setDuration(350L).setInterpolator(cubicBezierInterpolator).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity.7
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
    ...
    public boolean checkChangesBeforeExit() {
        ...
        if (z2) {
            ...
            builder.setMessage(LocaleController.getString("ReactionApplyChangesDialog", C3632R.string.ReactionApplyChangesDialog));
            builder.setPositiveButton(LocaleController.getString("ApplyTheme", C3632R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$$ExternalSyntheticLambda3
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatCustomReactionsEditActivity.this.lambda$checkChangesBeforeExit$11(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Discard", C3632R.string.Discard), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$$ExternalSyntheticLambda2
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void checkMaxCustomReactions(boolean z) {
        ...
        if (this.boostsStatus.level < size) {
            if (z) {
                BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.chats_infotip, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ReactionReachLvlForReactionShort", size, Integer.valueOf(size)))).show();
            }
    ...
    private List<TLRPC$Reaction> grabReactions(boolean z) {
        ...
        for (Long l : this.selectedEmojisIds) {
            ...
            while (true) {
                ...
                if (l.longValue() == next.activate_animation.f1610id) {
    ...
    public void showKeyboard() {
        ...
        this.bottomDialogLayout.animate().translationY(BitmapDescriptorFactory.HUE_RED).withLayer().setDuration(350L).setInterpolator(CubicBezierInterpolator.DEFAULT).setUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$$ExternalSyntheticLambda0
            ...
            public void onAnimationEnd(Animator animator) {
                NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.startAllHeavyOperations, 512);
                ChatCustomReactionsEditActivity.this.scrollView.fullScroll(TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
            }
        }).start();
    }
