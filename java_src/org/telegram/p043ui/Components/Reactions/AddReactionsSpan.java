...
/* renamed from: org.telegram.ui.Components.Reactions.AddReactionsSpan */
...
public class AddReactionsSpan extends ReplacementSpan {
    ...
    public void makeLayout() {
        if (this.layout == null) {
            StaticLayout staticLayout = new StaticLayout(LocaleController.getString("ReactionAddReactionsHint", C3632R.string.ReactionAddReactionsHint), this.textPaint, AndroidUtilities.displaySize.x, LocaleController.isRTL ? Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
    ...
    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        makeLayout();
        return (int) (AndroidUtilities.m107dp(8) + this.width);
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        canvas.translate(f + AndroidUtilities.m107dp(4), (i3 + ((i5 - i3) / 2.0f)) - (this.height / 2.0f));
