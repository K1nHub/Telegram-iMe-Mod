...
public class ChatSelectionReactionMenuOverlay extends FrameLayout {
    ...
    private void checkCreateReactionsLayout() {
        if (this.reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout.setPadding(AndroidUtilities.m107dp(4) + (LocaleController.isRTL ? 0 : this.mSidePadding), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4) + (LocaleController.isRTL ? this.mSidePadding : 0), AndroidUtilities.m107dp(this.mPadding));
            this.reactionsContainerLayout.setDelegate(new C55533());
    ...
    /* loaded from: classes6.dex */
    public class C55533 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        ...
        public void onReactionClicked(View view, ReactionsLayoutInBubble.VisibleReaction visibleReaction, boolean z, boolean z2) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Reactions.ChatSelectionReactionMenuOverlay$3$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ChatSelectionReactionMenuOverlay.C55533.this.lambda$onReactionClicked$0();
                }
            });
        }
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                if (messageObject.getId() == this.currentPrimaryObject.getId()) {
                    ...
                    if (reactionsContainerLayout != null) {
                        ...
                        this.reactionsContainerLayout.setPadding(AndroidUtilities.m107dp(4) + ((LocaleController.isRTL || isOutOwner) ? 0 : this.mSidePadding), AndroidUtilities.m107dp(this.mPadding), AndroidUtilities.m107dp(4) + ((LocaleController.isRTL || isOutOwner) ? this.mSidePadding : 0), AndroidUtilities.m107dp(this.mPadding));
                    }
                    ...
                    float y = (chatMessageCell.getY() + pullingDownOffset) - AndroidUtilities.m107dp(74);
                    float m107dp = AndroidUtilities.m107dp(14);
                    float m107dp2 = height2 - AndroidUtilities.m107dp(218);
                    FragmentContextView fragmentContextView = this.parentFragment.getFragmentContextView();
                    if (fragmentContextView != null && fragmentContextView.getVisibility() == 0) {
                        m107dp += fragmentContextView.getHeight();
                    }
                    float f4 = height;
                    if (y > m107dp - (f4 / 2.0f) && y < m107dp2) {
                        this.toOffsetY = BitmapDescriptorFactory.HUE_RED;
                        z2 = false;
                        z3 = true;
                    } else {
                        if (y < (m107dp - f4) - AndroidUtilities.m107dp(92) || y > m107dp2) {
                            z2 = false;
                        } else {
                            this.translationOffsetY = height + AndroidUtilities.m107dp(56);
                            this.toOffsetY = 1.0f;
                            z2 = true;
                        }
                        z3 = z2;
                    ...
                    this.reactionsContainerLayout.setTranslationY(MathUtils.clamp(interpolation, m107dp, m107dp2));
                    ...
                    int max = Math.max(0, chatMessageCell.getBackgroundDrawableLeft() - AndroidUtilities.m107dp(32));
                    int max2 = Math.max((int) chatMessageCell.getNonAnimationTranslationX(true), (chatMessageCell.getWidth() - chatMessageCell.getBackgroundDrawableRight()) - AndroidUtilities.m107dp(32));
                    int m107dp3 = AndroidUtilities.m107dp(40) * 8;
                    if ((getWidth() - max2) - max < m107dp3) {
                        if (isOutOwner) {
                            max = Math.min(max, (getWidth() - 0) - m107dp3);
                            max2 = 0;
                        } else {
                            max2 = Math.min(max2, (getWidth() - 0) - m107dp3);
                            max = 0;
                        }
                    }
