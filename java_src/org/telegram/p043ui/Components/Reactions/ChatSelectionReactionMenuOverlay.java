            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                if (messageObject.getId() == this.currentPrimaryObject.getId()) {
                    ...
                    if (reactionsContainerLayout != null) {
                        ...
                        this.reactionsContainerLayout.setPadding(AndroidUtilities.m104dp(4) + ((LocaleController.isRTL || isOutOwner) ? 0 : this.mSidePadding), AndroidUtilities.m104dp(this.mPadding), AndroidUtilities.m104dp(4) + ((LocaleController.isRTL || isOutOwner) ? this.mSidePadding : 0), AndroidUtilities.m104dp(this.mPadding));
                    }
                    ...
                    float y = (chatMessageCell.getY() + pullingDownOffset) - AndroidUtilities.m104dp(74);
                    float m104dp = AndroidUtilities.m104dp(14);
                    float m104dp2 = height2 - AndroidUtilities.m104dp(218);
                    FragmentContextView fragmentContextView = this.parentFragment.getFragmentContextView();
                    if (fragmentContextView != null && fragmentContextView.getVisibility() == 0) {
                        m104dp += fragmentContextView.getHeight();
                    }
                    float f4 = height;
                    if (y > m104dp - (f4 / 2.0f) && y < m104dp2) {
                        this.toOffsetY = BitmapDescriptorFactory.HUE_RED;
                        z2 = false;
                        z3 = true;
                    } else {
                        if (y < (m104dp - f4) - AndroidUtilities.m104dp(92) || y > m104dp2) {
                            z2 = false;
                        } else {
                            this.translationOffsetY = height + AndroidUtilities.m104dp(56);
                            this.toOffsetY = 1.0f;
                            z2 = true;
                        }
                        z3 = z2;
                    ...
                    this.reactionsContainerLayout.setTranslationY(MathUtils.clamp(interpolation, m104dp, m104dp2));
                    ...
                    int max = Math.max(0, chatMessageCell.getBackgroundDrawableLeft() - AndroidUtilities.m104dp(32));
                    int max2 = Math.max((int) chatMessageCell.getNonAnimationTranslationX(true), (chatMessageCell.getWidth() - chatMessageCell.getBackgroundDrawableRight()) - AndroidUtilities.m104dp(32));
                    int m104dp3 = AndroidUtilities.m104dp(40) * 8;
                    if ((getWidth() - max2) - max < m104dp3) {
                        if (isOutOwner) {
                            max = Math.min(max, (getWidth() - 0) - m104dp3);
                            max2 = 0;
                        } else {
                            max2 = Math.min(max2, (getWidth() - 0) - m104dp3);
                            max = 0;
                        }
                    }
