...
public class ReactionsEffectOverlay {
    ...
    */
    ...
    /* loaded from: classes7.dex */
    public class C52501 extends FrameLayout {
        ...
        C52501(Context context, BaseFragment baseFragment, ChatMessageCell chatMessageCell, boolean z, ChatActivity chatActivity, int i, int i2, boolean z2, float f, float f2, float f3, ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
            super(context);
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Components.Reactions.ReactionsEffectOverlay.C52501.dispatchDraw(android.graphics.Canvas):void");
        }
    ...
    */
    ...
    private class AvatarParticle {
        ...
        /* synthetic */ AvatarParticle(ReactionsEffectOverlay reactionsEffectOverlay, C52501 c52501) {
