...
public class CustomEmojiReactionsWindow {
    ...
    public CustomEmojiReactionsWindow(int i, BaseFragment baseFragment, List<ReactionsLayoutInBubble.VisibleReaction> list, HashSet<ReactionsLayoutInBubble.VisibleReaction> hashSet, final ReactionsContainerLayout reactionsContainerLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        C54802 c54802 = new C54802(baseFragment, context, false, null, 1, i != 1, resourcesProvider, 16, reactionsContainerLayout, baseFragment);
        this.selectAnimatedEmojiDialog = c54802;
        if (Build.VERSION.SDK_INT >= 21) {
            c54802.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow.3
                ...
                public void getOutline(View view, Outline outline) {
                    float lerp = AndroidUtilities.lerp(CustomEmojiReactionsWindow.this.fromRadius, AndroidUtilities.m104dp(8), CustomEmojiReactionsWindow.this.enterTransitionProgress);
    ...
    /* loaded from: classes6.dex */
    public class C54802 extends SelectAnimatedEmojiDialog {
        ...
        C54802(BaseFragment baseFragment, Context context, boolean z, Integer num, int i, boolean z2, Theme.ResourcesProvider resourcesProvider, int i2, ReactionsContainerLayout reactionsContainerLayout, BaseFragment baseFragment2) {
        ...
        protected void onEmojiSelected(View view, Long l, TLRPC$Document tLRPC$Document, Integer num) {
            if (!UserConfig.getInstance(this.val$baseFragment.getCurrentAccount()).isPremium()) {
                ...
                BulletinFactory.m63of(CustomEmojiReactionsWindow.this.windowView, null).createEmojiBulletin(tLRPC$Document, AndroidUtilities.replaceTags(LocaleController.getString("UnlockPremiumEmojiReaction", C3634R.string.UnlockPremiumEmojiReaction)), LocaleController.getString("PremiumMore", C3634R.string.PremiumMore), new Runnable() { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        CustomEmojiReactionsWindow.C54802.this.lambda$onEmojiSelected$0();
                    }
                }).show();
                return;
            }
    ...
    public void updateWindowPosition() {
        ...
        int i = this.type;
        if (i == 1 || i == 2) {
            m104dp = AndroidUtilities.m104dp(24);
        }
        float f2 = m104dp;
    ...
    private void createTransition(final boolean z) {
        ...
        float m104dp = ((((this.location[1] - iArr[1]) - AndroidUtilities.m104dp(44)) - AndroidUtilities.m104dp(52)) - (this.selectAnimatedEmojiDialog.includeHint ? AndroidUtilities.m104dp(26) : 0)) + this.reactionsContainerLayout.getTopOffset();
        if (this.containerView.getMeasuredHeight() + m104dp > this.windowView.getMeasuredHeight() - AndroidUtilities.m104dp(32)) {
            m104dp = (this.windowView.getMeasuredHeight() - AndroidUtilities.m104dp(32)) - this.containerView.getMeasuredHeight();
        }
        if (m104dp < AndroidUtilities.m104dp(16)) {
            m104dp = AndroidUtilities.m104dp(16);
        }
        int i = this.type;
        if (i == 1) {
            this.containerView.setTranslationX(((this.windowView.getMeasuredWidth() - this.containerView.getMeasuredWidth()) / 2.0f) - AndroidUtilities.m104dp(16));
        } else if (i == 2) {
            this.containerView.setTranslationX((this.location[0] - iArr[0]) - AndroidUtilities.m104dp(18));
        } else {
            this.containerView.setTranslationX((this.location[0] - iArr[0]) - AndroidUtilities.m104dp(2));
        }
        if (!z) {
            this.yTranslation = this.containerView.getTranslationY();
        } else {
            this.yTranslation = m104dp;
            this.containerView.setTranslationY(m104dp);
        }
    ...
    public class ContainerView extends FrameLayout {
        ...
        public ContainerView(Context context) {
            ...
            int m104dp = AndroidUtilities.m104dp(7);
            rect.bottom = m104dp;
            rect.right = m104dp;
            rect.top = m104dp;
            rect.left = m104dp;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (CustomEmojiReactionsWindow.this.type == 1 || CustomEmojiReactionsWindow.this.type == 2) {
                ...
                int m104dp = (AndroidUtilities.m104dp(36) * 8) + AndroidUtilities.m104dp(12);
                if (m104dp < measuredWidth) {
                    measuredWidth = m104dp;
                }
            }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (customEmojiReactionsWindow2.isShowing) {
                char c2 = 0;
                boolean z4 = false;
                float clamp = Utilities.clamp(customEmojiReactionsWindow2.enterTransitionProgress, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
                RectF rectF = AndroidUtilities.rectTmp;
                ...
                if (CustomEmojiReactionsWindow.this.reactionsContainerLayout != null) {
                    ...
                    canvas.clipRect((int) (CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.getY() + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getY()), x + (AndroidUtilities.m104dp(36) * CustomEmojiReactionsWindow.this.enterTransitionProgress), y + customEmojiReactionsWindow.selectAnimatedEmojiDialog.emojiGridView.getMeasuredHeight(), x + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getMeasuredWidth());
                    int i11 = -1;
                    int i12 = -1;
                        ...
                        if (view.getLeft() < 0 || view.getVisibility() == i9) {
                            ...
                            if (view instanceof ReactionsContainerLayout.ReactionHolderView) {
                                ...
                                if (imageViewEmoji2 != null) {
                                    ...
                                    float x3 = (((imageViewEmoji2.getX() + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.getX()) + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getX()) - reactionHolderView.loopImageView.getX()) - AndroidUtilities.m104dp(i);
                                    ...
                                    if (reactionHolderView.position == 0) {
                                        ...
                                        if (this.enterTransitionOffsetX == BitmapDescriptorFactory.HUE_RED && this.enterTransitionOffsetY == BitmapDescriptorFactory.HUE_RED) {
                                            ...
                                            this.enterTransitionOffsetX = AndroidUtilities.lerp((customEmojiReactionsWindow8.fromRect.left + x2) - x3, (float) BitmapDescriptorFactory.HUE_RED, customEmojiReactionsWindow8.enterTransitionProgress);
                                            CustomEmojiReactionsWindow customEmojiReactionsWindow9 = CustomEmojiReactionsWindow.this;
                                            this.enterTransitionOffsetY = AndroidUtilities.lerp((customEmojiReactionsWindow9.fromRect.top + y2) - y3, (float) BitmapDescriptorFactory.HUE_RED, customEmojiReactionsWindow9.enterTransitionProgress);
                                    ...
                                    if (this.enterTransitionOffsetX == BitmapDescriptorFactory.HUE_RED) {
                                        ...
                                        this.enterTransitionOffsetX = AndroidUtilities.lerp((customEmojiReactionsWindow82.fromRect.left + x2) - x3, (float) BitmapDescriptorFactory.HUE_RED, customEmojiReactionsWindow82.enterTransitionProgress);
                                        CustomEmojiReactionsWindow customEmojiReactionsWindow92 = CustomEmojiReactionsWindow.this;
                                        this.enterTransitionOffsetY = AndroidUtilities.lerp((customEmojiReactionsWindow92.fromRect.top + y2) - y3, (float) BitmapDescriptorFactory.HUE_RED, customEmojiReactionsWindow92.enterTransitionProgress);
                                        this.enterTransitionScale = AndroidUtilities.lerp(1.0f / measuredWidth2, 1.0f, CustomEmojiReactionsWindow.this.enterTransitionProgress);
                                        this.enterTransitionScalePx = x3;
                                        this.enterTransitionScalePy = y3;
                                    }
                                ...
                                if (imageViewEmoji2 != null) {
                                    if (imageViewEmoji2.selected) {
                                        ...
                                        float measuredWidth4 = reactionHolderView.getMeasuredWidth() - AndroidUtilities.m104dp(2);
                                        float lerp4 = AndroidUtilities.lerp(measuredWidth4, (imageViewEmoji2.getMeasuredWidth() - AndroidUtilities.m104dp(2)) / f7, CustomEmojiReactionsWindow.this.enterTransitionProgress);
                                        RectF rectF7 = AndroidUtilities.rectTmp;
                                        float f13 = lerp4 / 2.0f;
                                        f2 = lerp;
                                        i2 = save;
                                        rectF7.set(measuredWidth3 - f13, measuredHeight - f13, measuredWidth3 + f13, measuredHeight + f13);
                                        float lerp5 = AndroidUtilities.lerp(measuredWidth4 / 2.0f, AndroidUtilities.m104dp(4), CustomEmojiReactionsWindow.this.enterTransitionProgress);
