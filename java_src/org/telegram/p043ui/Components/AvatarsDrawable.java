...
public class AvatarsDrawable {
    ...
    public void commitTransition(boolean z, boolean z2) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (drawingStateArr2[i].f1812id != this.animatingStates[i].f1812id) {
                z4 = true;
            } else {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            while (true) {
                if (i3 >= 3) {
                    z3 = false;
                    break;
                } else if (this.currentStates[i3].f1812id == this.animatingStates[i2].f1812id) {
    ...
    public AvatarsDrawable(View view, boolean z) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            this.currentStates[i].imageReceiver.setRoundRadius(AndroidUtilities.m104dp(12));
            this.currentStates[i].avatarDrawable = new AvatarDrawable();
            this.currentStates[i].avatarDrawable.setTextSize(AndroidUtilities.m104dp(12));
            this.animatingStates[i] = new DrawingState();
            this.animatingStates[i].imageReceiver = new ImageReceiver(view);
            this.animatingStates[i].imageReceiver.setRoundRadius(AndroidUtilities.m104dp(12));
            this.animatingStates[i].avatarDrawable = new AvatarDrawable();
            this.animatingStates[i].avatarDrawable.setTextSize(AndroidUtilities.m104dp(12));
        }
        this.isInCall = z;
    ...
    public void setObject(int i, int i2, TLObject tLObject) {
        ...
        TLRPC$Chat chat;
        this.animatingStates[i].f1812id = 0L;
        ...
        if (tLObject instanceof TLRPC$TL_groupCallParticipant) {
            ...
            this.animatingStates[i].f1812id = peerId;
            tLRPC$Chat = chat;
            ...
            this.animatingStates[i].f1812id = tLRPC$User2.f1749id;
            ...
            this.animatingStates[i].f1812id = -tLRPC$Chat.f1602id;
        }
        if (tLRPC$User == null) {
    ...
    */
    ...
    public int getSize() {
        ...
        return AndroidUtilities.m104dp(i2 == 4 || i2 == 10 ? 32 : 24);
    }
