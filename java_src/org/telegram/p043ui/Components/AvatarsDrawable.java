...
public class AvatarsDrawable {
    ...
    public void commitTransition(boolean z, boolean z2) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (drawingStateArr2[i].f1818id != this.animatingStates[i].f1818id) {
                z4 = true;
            } else {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            while (true) {
                if (i3 >= 3) {
                    z3 = false;
                    break;
                } else if (this.currentStates[i3].f1818id == this.animatingStates[i2].f1818id) {
    ...
    public AvatarsDrawable(View view, boolean z) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            this.currentStates[i].imageReceiver.setRoundRadius(AndroidUtilities.m107dp(12));
            this.currentStates[i].avatarDrawable = new AvatarDrawable();
            this.currentStates[i].avatarDrawable.setTextSize(AndroidUtilities.m107dp(12));
            this.animatingStates[i] = new DrawingState();
            this.animatingStates[i].imageReceiver = new ImageReceiver(view);
            this.animatingStates[i].imageReceiver.setRoundRadius(AndroidUtilities.m107dp(12));
            this.animatingStates[i].avatarDrawable = new AvatarDrawable();
            this.animatingStates[i].avatarDrawable.setTextSize(AndroidUtilities.m107dp(12));
        }
        this.isInCall = z;
    ...
    public void setObject(int i, int i2, TLObject tLObject) {
        ...
        TLRPC$Chat chat;
        this.animatingStates[i].f1818id = 0L;
        ...
        if (tLObject instanceof TLRPC$TL_groupCallParticipant) {
            ...
            this.animatingStates[i].f1818id = peerId;
            tLRPC$Chat = chat;
            ...
            this.animatingStates[i].f1818id = tLRPC$User2.f1751id;
            ...
            this.animatingStates[i].f1818id = -tLRPC$Chat.f1602id;
        }
        if (tLRPC$User == null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:309:0x0648  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:340:0x02ad A[SYNTHETIC] */
    ...
    */
    ...
    public int getSize() {
        ...
        return AndroidUtilities.m107dp(i2 == 4 || i2 == 10 ? 32 : 24);
    }
