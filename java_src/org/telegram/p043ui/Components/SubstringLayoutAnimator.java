...
public class SubstringLayoutAnimator {
    ...
    public void create(StaticLayout staticLayout, CharSequence charSequence, CharSequence charSequence2, TextPaint textPaint) {
        ...
        if (indexOf >= 0) {
            ...
            this.animateInLayout = new StaticLayout(spannableStringBuilder, textPaint, AndroidUtilities.m72dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            StaticLayout staticLayout2 = new StaticLayout(spannableStringBuilder2, textPaint, AndroidUtilities.m72dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            ...
            this.animateInLayout = new StaticLayout(charSequence2, textPaint, AndroidUtilities.m72dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            this.animateOutLayout = new StaticLayout(charSequence, textPaint, AndroidUtilities.m72dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
