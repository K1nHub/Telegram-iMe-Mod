...
public class CaptionPhotoViewer extends CaptionContainerView {
    ...
    public CaptionPhotoViewer(Context context, final FrameLayout frameLayout, SizeNotifierFrameLayout sizeNotifierFrameLayout, FrameLayout frameLayout2, Theme.ResourcesProvider resourcesProvider, BlurringShader.BlurManager blurManager, Runnable runnable) {
        ...
        imageView.setBackground(Theme.createSelectorDrawable(1090519039, 1, AndroidUtilities.m107dp(18)));
        ...
        imageView2.setBackground(Theme.createSelectorDrawable(1090519039, 1, AndroidUtilities.m107dp(18)));
        ...
        hintView2.setPadding(AndroidUtilities.m107dp(12), 0, AndroidUtilities.m107dp(12), AndroidUtilities.m107dp(8));
    ...
    public void setAddPhotoVisible(final boolean z, boolean z2) {
        ...
        marginLayoutParams.rightMargin = AndroidUtilities.m107dp(12 + i);
    ...
    protected int getEditTextLeft() {
        if (this.addPhotoVisible) {
            return AndroidUtilities.m107dp(31);
        }
        return 0;
    }
    ...
    public void lambda$new$0(int i) {
        ...
        if (i == 0) {
            ...
            this.hint.setIconTranslate(BitmapDescriptorFactory.HUE_RED, -AndroidUtilities.m107dp(1));
        } else if (i == Integer.MAX_VALUE) {
        ...
        this.hint.setTranslationY((-Math.min(AndroidUtilities.m107dp(34), getEditTextHeight())) - AndroidUtilities.m107dp(14));
        this.hint.setText(replaceTags);
        int i2 = i > 0 ? C3632R.raw.fire_on : C3632R.raw.fire_off;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m107dp(34), AndroidUtilities.m107dp(34));
    ...
    protected void onEditHeightChange(int i) {
        this.hint.setTranslationY((-Math.min(AndroidUtilities.m107dp(34), i)) - AndroidUtilities.m107dp(10));
    }
