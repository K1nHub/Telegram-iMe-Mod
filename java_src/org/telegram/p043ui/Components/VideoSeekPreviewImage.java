...
public class VideoSeekPreviewImage extends View {
    ...
    public /* synthetic */ void lambda$new$0(ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
        ...
        if (getVisibility() == 0 && layoutParams.width == m104dp && layoutParams.height == i) {
            return;
        }
    ...
    public /* synthetic */ void lambda$setProgress$2(float f, long j) {
        ...
        int max = Math.max(200, AndroidUtilities.m104dp(100));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.bitmapToDraw != null && this.bitmapShader != null) {
            ...
            canvas.drawRoundRect(this.bitmapRect, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), this.bitmapPaint);
            this.frameDrawable.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            this.frameDrawable.draw(canvas);
            canvas.drawText(this.frameTime, (getMeasuredWidth() - this.timeWidth) / 2.0f, getMeasuredHeight() - AndroidUtilities.m104dp(9), this.textPaint);
        } else if (this.isYoutube) {
            canvas.save();
            this.ytPath.rewind();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight());
            this.ytPath.addRoundRect(rectF, AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), Path.Direction.CW);
