            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                switch (i) {
                    ...
                    case 3:
                        ...
                        linkActionView.setPadding(AndroidUtilities.m104dp(11), 0, AndroidUtilities.m104dp(11), AndroidUtilities.m104dp(24));
                    ...
                    case 8:
                        FrameLayout frameLayout2 = new FrameLayout(this, ChannelBoostLayout.this.getContext()) { // from class: org.telegram.ui.ChannelBoostLayout.1.3
                            ...
                            protected void onMeasure(int i2, int i3) {
                                super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(50), 1073741824));
                            }
                        };
                    ...
                    case 12:
                        ...
                        fixedHeightEmptyCell.setPadding(fixedHeightEmptyCell.getPaddingLeft(), AndroidUtilities.m104dp(16), fixedHeightEmptyCell.getRight(), AndroidUtilities.m104dp(8));
                        frameLayout = fixedHeightEmptyCell;
                        break;
                    case 13:
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (viewHolder.getItemViewType() == 1 || viewHolder.getItemViewType() == 12) {
                    ...
                    if (viewHolder.getItemViewType() == 12) {
                        chartHeaderView.setPadding(AndroidUtilities.m104dp(3), chartHeaderView.getPaddingTop(), chartHeaderView.getPaddingRight(), chartHeaderView.getPaddingBottom());
                    }
    ...
    public class ItemInternal extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            if (tL_stories$TL_prepaidGiveaway2 != null && (tL_stories$TL_prepaidGiveaway = itemInternal.prepaidGiveaway) != null) {
                return tL_stories$TL_prepaidGiveaway2.f1767id == tL_stories$TL_prepaidGiveaway.f1767id && this.isLast == itemInternal.isLast;
            }
            TL_stories$TL_boost tL_stories$TL_boost = this.booster;
            if (tL_stories$TL_boost == null || itemInternal.booster == null) {
                return true;
            }
            return tL_stories$TL_boost.f1762id.hashCode() == itemInternal.booster.f1762id.hashCode() && this.isLast == itemInternal.isLast && this.tab == itemInternal.tab;
        }
