...
public class DataUsage2Activity extends BaseFragment {
    ...
    private static int[] particles = {C3417R.C3419drawable.msg_filled_data_videos, C3417R.C3419drawable.msg_filled_data_files, C3417R.C3419drawable.msg_filled_data_photos, C3417R.C3419drawable.msg_filled_data_messages, C3417R.C3419drawable.msg_filled_data_music, C3417R.C3419drawable.msg_filled_data_voice, C3417R.C3419drawable.msg_filled_data_calls};
    private static int[] titles = {C3417R.string.LocalVideoCache, C3417R.string.LocalDocumentCache, C3417R.string.LocalPhotoCache, C3417R.string.MessagesSettings, C3417R.string.LocalMusicCache, C3417R.string.LocalAudioCache, C3417R.string.CallsDataUsage};
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("NetworkUsage", C3417R.string.NetworkUsage));
        ...
        c3484ActionBar2.setTitleColor(getThemedColor(i2));
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3484ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.DataUsage2Activity.1
    ...
    private class PageAdapter extends ViewPagerFixed.Adapter {
        ...
        public View createView(int i) {
            ...
            return new C5609ListView(dataUsage2Activity.getContext());
        }

        @Override // org.telegram.p043ui.Components.ViewPagerFixed.Adapter
        public void bindView(View view, int i, int i2) {
            C5609ListView c5609ListView = (C5609ListView) view;
            c5609ListView.setType(i);
            c5609ListView.scrollToPosition(0);
        }
        ...
        public String getItemTitle(int i) {
            if (i != 0) {
                if (i != 1) {
                    if (i != 2) {
                        return i != 3 ? "" : LocaleController.getString("NetworkUsageRoamingTab", C3417R.string.NetworkUsageRoamingTab);
                    }
                    return LocaleController.getString("NetworkUsageWiFiTab", C3417R.string.NetworkUsageWiFiTab);
                }
                return LocaleController.getString("NetworkUsageMobileTab", C3417R.string.NetworkUsageMobileTab);
            }
            return LocaleController.getString("NetworkUsageAllTab", C3417R.string.NetworkUsageAllTab);
        }
    }
    ...
    /* loaded from: classes5.dex */
    public class C5609ListView extends RecyclerListView {
        Adapter adapter;
        ...
        public C5609ListView(Context context) {
            super(context);
            ...
            setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.DataUsage2Activity$ListView$$ExternalSyntheticLambda2
                ...
                public final void onItemClick(View view, int i) {
                    DataUsage2Activity.C5609ListView.this.lambda$new$1(view, i);
                }
            });
        ...
        public /* synthetic */ void lambda$new$1(View view, int i) {
            if ((view instanceof Cell) && i >= 0 && i < this.itemInners.size()) {
                ...
                builder.setTitle(LocaleController.getString("ResetStatisticsAlertTitle", C3417R.string.ResetStatisticsAlertTitle));
                builder.setMessage(LocaleController.getString("ResetStatisticsAlert", C3417R.string.ResetStatisticsAlert));
                builder.setPositiveButton(LocaleController.getString("Reset", C3417R.string.Reset), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DataUsage2Activity$ListView$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i3) {
                        DataUsage2Activity.C5609ListView.this.lambda$new$0(dialogInterface, i3);
                    }
                });
        ...
        public class Size extends CacheChart.SegmentSize {
            ...
            public Size(C5609ListView c5609ListView, int i, long j, long j2, long j3, int i2, int i3) {
                this.index = i;
                this.size = j;
                this.selected = true;
                this.inSize = j2;
        ...
        private void updateRows(boolean z) {
            ...
            long j = 0;
            if (this.totalSize > 0) {
                formatString = LocaleController.formatString("YourNetworkUsageSince", C3417R.string.YourNetworkUsageSince, LocaleController.getInstance().formatterStats.format(getResetStatsDate()));
            } else {
                formatString = LocaleController.formatString("NoNetworkUsageSince", C3417R.string.NoNetworkUsageSince, LocaleController.getInstance().formatterStats.format(getResetStatsDate()));
            }
            ...
            if (!arrayList.isEmpty()) {
                ...
                Drawable mutate = getContext().getResources().getDrawable(C3417R.C3419drawable.msg_mini_upload).mutate();
                ...
                Drawable mutate2 = getContext().getResources().getDrawable(C3417R.C3419drawable.msg_mini_download).mutate();
                    ...
                    if (i6 >= 0 && !this.collapsed[i6]) {
                        ...
                        if (DataUsage2Activity.stats[size.index] != 0) {
                            if (DataUsage2Activity.stats[size.index] != 1) {
                                ...
                                if (size.outSize > 0 || size.outCount > 0) {
                                    i5++;
                                    arrayList.add(i5, ItemInner.asCell(-1, 0, 0, TextUtils.concat(spannableString2, " ", LocaleController.getString("BytesSent", C3417R.string.BytesSent)), AndroidUtilities.formatFileSize(size.outSize)));
                                }
                                if (size.inSize > 0 || size.inCount > 0) {
                                    i5++;
                                    arrayList.add(i5, ItemInner.asCell(-1, 0, 0, TextUtils.concat(spannableString3, " ", LocaleController.getString("BytesReceived", C3417R.string.BytesReceived)), AndroidUtilities.formatFileSize(size.inSize)));
                                }
                                i5++;
                            }
                        } else {
                ...
                if (!this.empty) {
                    this.itemInners.add(ItemInner.asSeparator(LocaleController.getString("DataUsageSectionsInfo", C3417R.string.DataUsageSectionsInfo)));
                }
            }
            if (!this.empty) {
                this.itemInners.add(ItemInner.asHeader(LocaleController.getString("TotalNetworkUsage", C3417R.string.TotalNetworkUsage)));
                this.itemInners.add(ItemInner.asCell(-1, C3417R.C3419drawable.msg_filled_data_sent, getThemedColor(Theme.key_statisticChartLine_lightblue), LocaleController.getString("BytesSent", C3417R.string.BytesSent), AndroidUtilities.formatFileSize(this.totalSizeOut)));
                this.itemInners.add(ItemInner.asCell(-1, C3417R.C3419drawable.msg_filled_data_received, getThemedColor(Theme.key_statisticChartLine_green), LocaleController.getString("BytesReceived", C3417R.string.BytesReceived), AndroidUtilities.formatFileSize(this.totalSizeIn)));
            }
            if (!arrayList.isEmpty()) {
            ...
            if (this.currentType != 0) {
                ...
                this.itemInners.add(ItemInner.asCell(-2, C3417R.C3419drawable.msg_download_settings, getThemedColor(Theme.key_statisticChartLine_lightblue), LocaleController.getString("AutomaticDownloadSettings", C3417R.string.AutomaticDownloadSettings), null));
                int i7 = this.currentType;
                if (i7 == 1) {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoMobile", C3417R.string.AutomaticDownloadSettingsInfoMobile);
                } else if (i7 == 3) {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoRoaming", C3417R.string.AutomaticDownloadSettingsInfoRoaming);
                } else {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoWiFi", C3417R.string.AutomaticDownloadSettingsInfoWiFi);
                }
                this.itemInners.add(ItemInner.asSeparator(string));
            }
            if (!arrayList.isEmpty()) {
                this.itemInners.add(new ItemInner(5, LocaleController.getString("ResetStatistics", C3417R.string.ResetStatistics)));
            }
            this.itemInners.add(ItemInner.asSeparator());
        ...
        public class Adapter extends AdapterWithDiffUtils {
            ...
            /* loaded from: classes5.dex */
            class C56101 extends CacheChart {
                /* JADX INFO: Access modifiers changed from: private */
                ...
                C56101(Context context, int i, int[] iArr, int i2, int[] iArr2) {
                ...
                protected void onSectionDown(int i, boolean z) {
                    final int i2;
                    if (z) {
                        if (i < 0 || i >= C5609ListView.this.segments.length) {
                            return;
                        }
                        int i3 = 0;
                        while (true) {
                            i2 = -1;
                            if (i3 >= C5609ListView.this.segments.length) {
                                i3 = -1;
                                break;
                            } else if (C5609ListView.this.segments[i3].index == i) {
                                break;
                            } else {
                                i3++;
                            }
                        ...
                        int i4 = 0;
                        while (true) {
                            if (i4 < C5609ListView.this.itemInners.size()) {
                                ItemInner itemInner = (ItemInner) C5609ListView.this.itemInners.get(i4);
                        ...
                        if (i2 >= 0) {
                            C5609ListView.this.highlightRow(new RecyclerListView.IntReturnCallback() { // from class: org.telegram.ui.DataUsage2Activity$ListView$Adapter$1$$ExternalSyntheticLambda0
                                @Override // org.telegram.p043ui.Components.RecyclerListView.IntReturnCallback
                                public final int run() {
                                    int lambda$onSectionDown$0;
                                    lambda$onSectionDown$0 = DataUsage2Activity.C5609ListView.Adapter.C56101.lambda$onSectionDown$0(i2);
                                    return lambda$onSectionDown$0;
                                }
                            }, 0);
                            return;
                        } else {
                            C5609ListView.this.removeHighlightRow();
                            return;
                        }
                    }
                    C5609ListView.this.removeHighlightRow();
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                TextCell textCell;
                if (i == 0) {
                    C5609ListView.this.chart = new C56101(C5609ListView.this.getContext(), DataUsage2Activity.colors.length, DataUsage2Activity.colors, 1, DataUsage2Activity.particles);
                    C5609ListView.this.chart.setInterceptTouch(false);
                    textCell = C5609ListView.this.chart;
                } else if (i == 1) {
                    C5609ListView c5609ListView = C5609ListView.this;
                    textCell = new SubtitleCell(DataUsage2Activity.this, c5609ListView.getContext());
                } else if (i == 3) {
                    textCell = new TextInfoPrivacyCell(C5609ListView.this.getContext());
                } else if (i == 4) {
                    View headerCell = new HeaderCell(C5609ListView.this.getContext());
                    headerCell.setBackgroundColor(C5609ListView.this.getThemedColor(Theme.key_windowBackgroundWhite));
                    textCell = headerCell;
                } else if (i == 5) {
                    TextCell textCell2 = new TextCell(C5609ListView.this.getContext());
                    textCell2.setTextColor(C5609ListView.this.getThemedColor(Theme.key_text_RedRegular));
                    textCell2.setBackgroundColor(C5609ListView.this.getThemedColor(Theme.key_windowBackgroundWhite));
                    textCell = textCell2;
                } else if (i == 6) {
                    textCell = new RoundingCell(C5609ListView.this.getContext());
                } else if (i == 7) {
                    textCell = new View(C5609ListView.this.getContext()) { // from class: org.telegram.ui.DataUsage2Activity.ListView.Adapter.2
                        {
                            setBackgroundColor(C5609ListView.this.getThemedColor(Theme.key_windowBackgroundWhite));
                        }
                    ...
                    C5609ListView c5609ListView2 = C5609ListView.this;
                    textCell = new Cell(DataUsage2Activity.this, c5609ListView2.getContext());
                }
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                int i2;
                int i3;
                ItemInner itemInner = (ItemInner) C5609ListView.this.itemInners.get(viewHolder.getAdapterPosition());
                int itemViewType = viewHolder.getItemViewType();
                boolean z = false;
                if (itemViewType == 0) {
                    CacheChart cacheChart = (CacheChart) viewHolder.itemView;
                    if (C5609ListView.this.segments != null) {
                        cacheChart.setSegments(C5609ListView.this.totalSize, C5609ListView.this.animateChart, C5609ListView.this.chartSegments);
                    }
                    C5609ListView.this.animateChart = false;
                    return;
                }
                Boolean bool = null;
                if (itemViewType == 1) {
                    ...
                    int i4 = i + 1;
                    if (i4 < C5609ListView.this.itemInners.size() && (i3 = ((ItemInner) C5609ListView.this.itemInners.get(i4)).viewType) != itemInner.viewType && i3 != 3 && i3 != 6) {
                        z = true;
                    }
                    if (z) {
                        subtitleCell.setBackground(Theme.getThemedDrawableByKey(C5609ListView.this.getContext(), C3417R.C3419drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
                    } else {
                    ...
                    int i5 = i + 1;
                    cell.set(itemInner.imageColor, itemInner.imageResId, itemInner.text, itemInner.valueText, i5 < getItemCount() && ((ItemInner) C5609ListView.this.itemInners.get(i5)).viewType == itemViewType);
                    if (!itemInner.pad && (i2 = itemInner.index) >= 0 && (i2 >= C5609ListView.this.segments.length || C5609ListView.this.segments[itemInner.index].size > 0)) {
                        bool = Boolean.valueOf(C5609ListView.this.collapsed[itemInner.index]);
                    }
                    cell.setArrow(bool);
                    ...
                    boolean z2 = i > 0 && itemInner.viewType != ((ItemInner) C5609ListView.this.itemInners.get(i + (-1))).viewType;
                    int i6 = i + 1;
                    if (i6 < C5609ListView.this.itemInners.size() && ((ItemInner) C5609ListView.this.itemInners.get(i6)).viewType != itemInner.viewType) {
                        z = true;
                    }
                    if (z2 && z) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(C5609ListView.this.getContext(), C3417R.C3419drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    } else if (z2) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(C5609ListView.this.getContext(), C3417R.C3419drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    } else if (z) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(C5609ListView.this.getContext(), C3417R.C3419drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
                    } else {
            ...
            @Override // androidx.recyclerview.widget.RecyclerView.Adapter
            public int getItemCount() {
                return C5609ListView.this.itemInners.size();
            }

            @Override // androidx.recyclerview.widget.RecyclerView.Adapter
            public int getItemViewType(int i) {
                return ((ItemInner) C5609ListView.this.itemInners.get(i)).viewType;
            }
    ...
    public class Cell extends FrameLayout {
        ...
        public Cell(DataUsage2Activity dataUsage2Activity, Context context) {
            ...
            this.arrowView.setImageResource(C3417R.C3419drawable.arrow_more);
    ...
    public boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        return motionEvent.getY() <= ((float) (C3484ActionBar.getCurrentActionBarHeight() + AndroidUtilities.m54dp(48))) || this.pager.getCurrentPosition() == 0;
    }
}
