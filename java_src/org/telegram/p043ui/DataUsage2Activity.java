...
public class DataUsage2Activity extends BaseFragment {
    ...
    private static int[] particles = {C3473R.C3475drawable.msg_filled_data_videos, C3473R.C3475drawable.msg_filled_data_files, C3473R.C3475drawable.msg_filled_data_photos, C3473R.C3475drawable.msg_filled_data_messages, C3473R.C3475drawable.msg_filled_data_music, C3473R.C3475drawable.msg_filled_data_voice, C3473R.C3475drawable.msg_filled_data_calls};
    private static int[] titles = {C3473R.string.LocalVideoCache, C3473R.string.LocalDocumentCache, C3473R.string.LocalPhotoCache, C3473R.string.MessagesSettings, C3473R.string.LocalMusicCache, C3473R.string.LocalAudioCache, C3473R.string.CallsDataUsage};
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("NetworkUsage", C3473R.string.NetworkUsage));
        ...
        c3541ActionBar2.setTitleColor(getThemedColor(i2));
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.DataUsage2Activity.1
    ...
    private class PageAdapter extends ViewPagerFixed.Adapter {
        ...
        public View createView(int i) {
            ...
            return new C5727ListView(dataUsage2Activity.getContext());
        }

        @Override // org.telegram.p043ui.Components.ViewPagerFixed.Adapter
        public void bindView(View view, int i, int i2) {
            C5727ListView c5727ListView = (C5727ListView) view;
            c5727ListView.setType(i);
            c5727ListView.scrollToPosition(0);
        }
        ...
        public String getItemTitle(int i) {
            if (i != 0) {
                if (i != 1) {
                    if (i != 2) {
                        return i != 3 ? "" : LocaleController.getString("NetworkUsageRoamingTab", C3473R.string.NetworkUsageRoamingTab);
                    }
                    return LocaleController.getString("NetworkUsageWiFiTab", C3473R.string.NetworkUsageWiFiTab);
                }
                return LocaleController.getString("NetworkUsageMobileTab", C3473R.string.NetworkUsageMobileTab);
            }
            return LocaleController.getString("NetworkUsageAllTab", C3473R.string.NetworkUsageAllTab);
        }
    }
    ...
    /* loaded from: classes3.dex */
    public class C5727ListView extends RecyclerListView {
        Adapter adapter;
        ...
        public C5727ListView(Context context) {
            super(context);
            ...
            setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.DataUsage2Activity$ListView$$ExternalSyntheticLambda2
                ...
                public final void onItemClick(View view, int i) {
                    DataUsage2Activity.C5727ListView.this.lambda$new$1(view, i);
                }
            });
        ...
        public /* synthetic */ void lambda$new$1(View view, int i) {
            if ((view instanceof Cell) && i >= 0 && i < this.itemInners.size()) {
                ...
                builder.setTitle(LocaleController.getString("ResetStatisticsAlertTitle", C3473R.string.ResetStatisticsAlertTitle));
                builder.setMessage(LocaleController.getString("ResetStatisticsAlert", C3473R.string.ResetStatisticsAlert));
                builder.setPositiveButton(LocaleController.getString("Reset", C3473R.string.Reset), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DataUsage2Activity$ListView$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i3) {
                        DataUsage2Activity.C5727ListView.this.lambda$new$0(dialogInterface, i3);
                    }
                });
        ...
        private void setup() {
            ...
            Arrays.sort(this.segments, new Comparator() { // from class: org.telegram.ui.DataUsage2Activity$ListView$$ExternalSyntheticLambda1
                ...
                public final int compare(Object obj, Object obj2) {
                    int lambda$setup$2;
                    lambda$setup$2 = DataUsage2Activity.C5727ListView.lambda$setup$2((DataUsage2Activity.C5727ListView.Size) obj, (DataUsage2Activity.C5727ListView.Size) obj2);
        ...
        public class Size extends CacheChart.SegmentSize {
            ...
            public Size(C5727ListView c5727ListView, int i, long j, long j2, long j3, int i2, int i3) {
                this.index = i;
                this.size = j;
                this.selected = true;
                this.inSize = j2;
        ...
        private void updateRows(boolean z) {
            ...
            long j = 0;
            if (this.totalSize > 0) {
                formatString = LocaleController.formatString("YourNetworkUsageSince", C3473R.string.YourNetworkUsageSince, LocaleController.getInstance().formatterStats.format(getResetStatsDate()));
            } else {
                formatString = LocaleController.formatString("NoNetworkUsageSince", C3473R.string.NoNetworkUsageSince, LocaleController.getInstance().formatterStats.format(getResetStatsDate()));
            }
            ...
            if (!arrayList.isEmpty()) {
                ...
                Drawable mutate = getContext().getResources().getDrawable(C3473R.C3475drawable.msg_mini_upload).mutate();
                ...
                Drawable mutate2 = getContext().getResources().getDrawable(C3473R.C3475drawable.msg_mini_download).mutate();
                    ...
                    if (i6 >= 0 && !this.collapsed[i6]) {
                        ...
                        if (DataUsage2Activity.stats[size.index] != 0) {
                            if (DataUsage2Activity.stats[size.index] != 1) {
                                ...
                                if (size.outSize > 0 || size.outCount > 0) {
                                    i5++;
                                    arrayList.add(i5, ItemInner.asCell(-1, 0, 0, TextUtils.concat(spannableString2, " ", LocaleController.getString("BytesSent", C3473R.string.BytesSent)), AndroidUtilities.formatFileSize(size.outSize)));
                                }
                                if (size.inSize > 0 || size.inCount > 0) {
                                    i5++;
                                    arrayList.add(i5, ItemInner.asCell(-1, 0, 0, TextUtils.concat(spannableString3, " ", LocaleController.getString("BytesReceived", C3473R.string.BytesReceived)), AndroidUtilities.formatFileSize(size.inSize)));
                                }
                                i5++;
                            }
                        } else {
                ...
                if (!this.empty) {
                    this.itemInners.add(ItemInner.asSeparator(LocaleController.getString("DataUsageSectionsInfo", C3473R.string.DataUsageSectionsInfo)));
                }
            }
            if (!this.empty) {
                this.itemInners.add(ItemInner.asHeader(LocaleController.getString("TotalNetworkUsage", C3473R.string.TotalNetworkUsage)));
                this.itemInners.add(ItemInner.asCell(-1, C3473R.C3475drawable.msg_filled_data_sent, getThemedColor(Theme.key_statisticChartLine_lightblue), LocaleController.getString("BytesSent", C3473R.string.BytesSent), AndroidUtilities.formatFileSize(this.totalSizeOut)));
                this.itemInners.add(ItemInner.asCell(-1, C3473R.C3475drawable.msg_filled_data_received, getThemedColor(Theme.key_statisticChartLine_green), LocaleController.getString("BytesReceived", C3473R.string.BytesReceived), AndroidUtilities.formatFileSize(this.totalSizeIn)));
            }
            if (!arrayList.isEmpty()) {
            ...
            if (this.currentType != 0) {
                ...
                this.itemInners.add(ItemInner.asCell(-2, C3473R.C3475drawable.msg_download_settings, getThemedColor(Theme.key_statisticChartLine_lightblue), LocaleController.getString("AutomaticDownloadSettings", C3473R.string.AutomaticDownloadSettings), null));
                int i7 = this.currentType;
                if (i7 == 1) {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoMobile", C3473R.string.AutomaticDownloadSettingsInfoMobile);
                } else if (i7 == 3) {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoRoaming", C3473R.string.AutomaticDownloadSettingsInfoRoaming);
                } else {
                    string = LocaleController.getString("AutomaticDownloadSettingsInfoWiFi", C3473R.string.AutomaticDownloadSettingsInfoWiFi);
                }
                this.itemInners.add(ItemInner.asSeparator(string));
            }
            if (!arrayList.isEmpty()) {
                this.itemInners.add(new ItemInner(5, LocaleController.getString("ResetStatistics", C3473R.string.ResetStatistics)));
            }
            this.itemInners.add(ItemInner.asSeparator());
        ...
        public class Adapter extends AdapterWithDiffUtils {
            ...
            /* loaded from: classes3.dex */
            class C57281 extends CacheChart {
                /* JADX INFO: Access modifiers changed from: private */
                ...
                C57281(Context context, int i, int[] iArr, int i2, int[] iArr2) {
                ...
                protected void onSectionDown(int i, boolean z) {
                    final int i2;
                    if (z) {
                        if (i < 0 || i >= C5727ListView.this.segments.length) {
                            return;
                        }
                        int i3 = 0;
                        while (true) {
                            i2 = -1;
                            if (i3 >= C5727ListView.this.segments.length) {
                                i3 = -1;
                                break;
                            } else if (C5727ListView.this.segments[i3].index == i) {
                                break;
                            } else {
                                i3++;
                            }
                        ...
                        int i4 = 0;
                        while (true) {
                            if (i4 < C5727ListView.this.itemInners.size()) {
                                ItemInner itemInner = (ItemInner) C5727ListView.this.itemInners.get(i4);
                        ...
                        if (i2 >= 0) {
                            C5727ListView.this.highlightRow(new RecyclerListView.IntReturnCallback() { // from class: org.telegram.ui.DataUsage2Activity$ListView$Adapter$1$$ExternalSyntheticLambda0
                                @Override // org.telegram.p043ui.Components.RecyclerListView.IntReturnCallback
                                public final int run() {
                                    int lambda$onSectionDown$0;
                                    lambda$onSectionDown$0 = DataUsage2Activity.C5727ListView.Adapter.C57281.lambda$onSectionDown$0(i2);
                                    return lambda$onSectionDown$0;
                                }
                            }, 0);
                            return;
                        } else {
                            C5727ListView.this.removeHighlightRow();
                            return;
                        }
                    }
                    C5727ListView.this.removeHighlightRow();
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                TextCell textCell;
                if (i == 0) {
                    C5727ListView.this.chart = new C57281(C5727ListView.this.getContext(), DataUsage2Activity.colors.length, DataUsage2Activity.colors, 1, DataUsage2Activity.particles);
                    C5727ListView.this.chart.setInterceptTouch(false);
                    textCell = C5727ListView.this.chart;
                } else if (i == 1) {
                    C5727ListView c5727ListView = C5727ListView.this;
                    textCell = new SubtitleCell(DataUsage2Activity.this, c5727ListView.getContext());
                } else if (i == 3) {
                    textCell = new TextInfoPrivacyCell(C5727ListView.this.getContext());
                } else if (i == 4) {
                    View headerCell = new HeaderCell(C5727ListView.this.getContext());
                    headerCell.setBackgroundColor(C5727ListView.this.getThemedColor(Theme.key_windowBackgroundWhite));
                    textCell = headerCell;
                } else if (i == 5) {
                    TextCell textCell2 = new TextCell(C5727ListView.this.getContext());
                    textCell2.setTextColor(C5727ListView.this.getThemedColor(Theme.key_text_RedRegular));
                    textCell2.setBackgroundColor(C5727ListView.this.getThemedColor(Theme.key_windowBackgroundWhite));
                    textCell = textCell2;
                } else if (i == 6) {
                    textCell = new RoundingCell(C5727ListView.this.getContext());
                } else if (i == 7) {
                    textCell = new View(C5727ListView.this.getContext()) { // from class: org.telegram.ui.DataUsage2Activity.ListView.Adapter.2
                        {
                            setBackgroundColor(C5727ListView.this.getThemedColor(Theme.key_windowBackgroundWhite));
                        }
                    ...
                    C5727ListView c5727ListView2 = C5727ListView.this;
                    textCell = new Cell(DataUsage2Activity.this, c5727ListView2.getContext());
                }
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                int i2;
                int i3;
                ItemInner itemInner = (ItemInner) C5727ListView.this.itemInners.get(viewHolder.getAdapterPosition());
                int itemViewType = viewHolder.getItemViewType();
                boolean z = false;
                if (itemViewType == 0) {
                    CacheChart cacheChart = (CacheChart) viewHolder.itemView;
                    if (C5727ListView.this.segments != null) {
                        cacheChart.setSegments(C5727ListView.this.totalSize, C5727ListView.this.animateChart, C5727ListView.this.chartSegments);
                    }
                    C5727ListView.this.animateChart = false;
                    return;
                }
                Boolean bool = null;
                if (itemViewType == 1) {
                    ...
                    int i4 = i + 1;
                    if (i4 < C5727ListView.this.itemInners.size() && (i3 = ((ItemInner) C5727ListView.this.itemInners.get(i4)).viewType) != itemInner.viewType && i3 != 3 && i3 != 6) {
                        z = true;
                    }
                    if (z) {
                        subtitleCell.setBackground(Theme.getThemedDrawableByKey(C5727ListView.this.getContext(), C3473R.C3475drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
                    } else {
                    ...
                    int i5 = i + 1;
                    cell.set(itemInner.imageColor, itemInner.imageResId, itemInner.text, itemInner.valueText, i5 < getItemCount() && ((ItemInner) C5727ListView.this.itemInners.get(i5)).viewType == itemViewType);
                    if (!itemInner.pad && (i2 = itemInner.index) >= 0 && (i2 >= C5727ListView.this.segments.length || C5727ListView.this.segments[itemInner.index].size > 0)) {
                        bool = Boolean.valueOf(C5727ListView.this.collapsed[itemInner.index]);
                    }
                    cell.setArrow(bool);
                    ...
                    boolean z2 = i > 0 && itemInner.viewType != ((ItemInner) C5727ListView.this.itemInners.get(i + (-1))).viewType;
                    int i6 = i + 1;
                    if (i6 < C5727ListView.this.itemInners.size() && ((ItemInner) C5727ListView.this.itemInners.get(i6)).viewType != itemInner.viewType) {
                        z = true;
                    }
                    if (z2 && z) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(C5727ListView.this.getContext(), C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    } else if (z2) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(C5727ListView.this.getContext(), C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    } else if (z) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(C5727ListView.this.getContext(), C3473R.C3475drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
                    } else {
            ...
            @Override // androidx.recyclerview.widget.RecyclerView.Adapter
            public int getItemCount() {
                return C5727ListView.this.itemInners.size();
            }

            @Override // androidx.recyclerview.widget.RecyclerView.Adapter
            public int getItemViewType(int i) {
                return ((ItemInner) C5727ListView.this.itemInners.get(i)).viewType;
            }
    ...
    public class Cell extends FrameLayout {
        ...
        public Cell(DataUsage2Activity dataUsage2Activity, Context context) {
            ...
            this.arrowView.setImageResource(C3473R.C3475drawable.arrow_more);
    ...
    public boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        return motionEvent.getY() <= ((float) (C3541ActionBar.getCurrentActionBarHeight() + AndroidUtilities.m72dp(48))) || this.pager.getCurrentPosition() == 0;
    }
}
