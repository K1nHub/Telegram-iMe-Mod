...
import com.iMe.fork.p024ui.view.PollEditTextCellWrapper;
...
public class FilterCreateActivity extends JavaMvpFragment {
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(FilterCreateActivity filterCreateActivity, Context context) {
            ...
            if (filterActivityType == filterActivityType2) {
                this.imageView.setAnimation(C3473R.raw.fork_topic_new, 125, 125);
            } else {
                this.imageView.setAnimation(C3473R.raw.filter_new, 100, 100);
            }
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(156), 1073741824));
        }
    }
    ...
    public FilterCreateActivity(MessagesController.DialogFilter dialogFilter, ArrayList<Long> arrayList, TopicModel topicModel, Set<Long> set, FilterActivityType filterActivityType) {
        ...
        if (dialogFilter == null) {
            ...
            dialogFilter3.f1459id = 2;
            while (getMessagesController().dialogFiltersById.get(this.filter.f1459id) != null) {
                this.filter.f1459id++;
            }
            this.filter.name = "";
            this.creatingNew = true;
        }
        this.newFilterSettings = getFiltersController().getSettings(this.filter.f1459id).getCopy();
    ...
    public void loadInvites() {
        ...
        tLRPC$TL_inputChatlistDialogFilter.filter_id = this.filter.f1459id;
        this.requestingInvitesReqId = getConnectionsManager().sendRequest(tLRPC$TL_chatlists_getExportedInvites, new RequestDelegate() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda28
    ...
    private void updateRows(boolean z) {
        ...
        if (this.type == FilterActivityType.FILTER) {
            ...
            this.items.add(ItemInner.asShadow(LocaleController.getInternalString(C3473R.string.create_folder_change_fab_section_description)));
        }
        this.items.add(ItemInner.asHeader(this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3473R.string.topic_main_chats) : LocaleController.getString("FilterInclude", C3473R.string.FilterInclude)));
        this.items.add(ItemInner.asButton(C3473R.C3475drawable.msg2_chats_add, LocaleController.getString("FilterAddChats", C3473R.string.FilterAddChats), false).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_CONTACTS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterContacts", C3473R.string.FilterContacts), "contacts", MessagesController.DIALOG_FILTER_FLAG_CONTACTS));
        }
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_NON_CONTACTS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterNonContacts", C3473R.string.FilterNonContacts), "non_contacts", MessagesController.DIALOG_FILTER_FLAG_NON_CONTACTS));
        }
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_GROUPS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterGroups", C3473R.string.FilterGroups), "groups", MessagesController.DIALOG_FILTER_FLAG_GROUPS));
        }
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_CHANNELS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterChannels", C3473R.string.FilterChannels), "channels", MessagesController.DIALOG_FILTER_FLAG_CHANNELS));
        }
        if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_BOTS) != 0) {
            this.items.add(ItemInner.asChat(true, LocaleController.getString("FilterBots", C3473R.string.FilterBots), "bots", MessagesController.DIALOG_FILTER_FLAG_BOTS));
        }
        if (!this.newAlwaysShow.isEmpty()) {
            ...
            if (size != this.newAlwaysShow.size()) {
                this.items.add(ItemInner.asButton(C3473R.C3475drawable.arrow_more, LocaleController.formatPluralString("FilterShowMoreChats", this.newAlwaysShow.size() - 5, new Object[0]), false).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
        ...
        FilterActivityType filterActivityType = this.type;
        FilterActivityType filterActivityType2 = FilterActivityType.TOPIC;
        arrayList.add(ItemInner.asShadow(filterActivityType == filterActivityType2 ? LocaleController.getInternalString(C3473R.string.topic_add_main_chats_hint) : LocaleController.getString("FilterIncludeInfo", C3473R.string.FilterIncludeInfo)));
        if (!this.filter.isChatlist()) {
            ArrayList<ItemInner> arrayList2 = this.items;
            if (this.type == filterActivityType2) {
                i = C3473R.string.ArchivedChats;
                str = "ArchivedChats";
            } else {
                i = C3473R.string.FilterExclude;
                str = "FilterExclude";
            }
            arrayList2.add(ItemInner.asHeader(LocaleController.getString(str, i)));
            this.items.add(ItemInner.asButton(C3473R.C3475drawable.msg2_chats_add, this.type == filterActivityType2 ? LocaleController.getString("FilterAddChats", C3473R.string.FilterAddChats) : LocaleController.getString("FilterRemoveChats", C3473R.string.FilterRemoveChats), false).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED) != 0) {
                this.items.add(ItemInner.asChat(false, LocaleController.getString("FilterMuted", C3473R.string.FilterMuted), "muted", MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED));
            }
            if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_READ) != 0) {
                this.items.add(ItemInner.asChat(false, LocaleController.getString("FilterRead", C3473R.string.FilterRead), "read", MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_READ));
            }
            if ((this.newFilterFlags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED) != 0) {
                this.items.add(ItemInner.asChat(false, LocaleController.getString("FilterArchived", C3473R.string.FilterArchived), "archived", MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED));
            }
            if (!this.newNeverShow.isEmpty()) {
                ...
                if (size2 != this.newNeverShow.size()) {
                    this.items.add(ItemInner.asButton(C3473R.C3475drawable.arrow_more, LocaleController.formatPluralString("FilterShowMoreChats", this.newNeverShow.size() - 5, new Object[0]), false).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda8
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
            ...
            this.items.add(ItemInner.asShadow(this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3473R.string.topic_add_archived_chats_hint) : LocaleController.getString("FilterExcludeInfo", C3473R.string.FilterExcludeInfo)));
        }
        if (this.type == FilterActivityType.FILTER) {
            if (this.invites.isEmpty()) {
                this.items.add(ItemInner.asHeader(LocaleController.getString("FilterShareFolder", C3473R.string.FilterShareFolder), true));
                this.items.add(ItemInner.asButton(C3473R.C3475drawable.msg2_link2, LocaleController.getString("FilterShareFolderButton", C3473R.string.FilterShareFolderButton), false));
                this.items.add(ItemInner.asShadow(LocaleController.getString("FilterInviteLinksHintNew", C3473R.string.FilterInviteLinksHintNew)));
            } else {
                this.items.add(ItemInner.asHeader(LocaleController.getString("FilterInviteLinks", C3473R.string.FilterInviteLinks), true));
                ...
                if (dialogFilter != null && dialogFilter.isChatlist()) {
                    string = LocaleController.getString("FilterInviteLinksHintNew", C3473R.string.FilterInviteLinksHintNew);
                } else {
                    string = LocaleController.getString("FilterInviteLinksHint", C3473R.string.FilterInviteLinksHint);
                }
                arrayList3.add(ItemInner.asShadow(string));
            }
        }
        if (!this.creatingNew) {
            this.items.add(ItemInner.asButton(0, this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3473R.string.topics_remove) : LocaleController.getString("FilterDelete", C3473R.string.FilterDelete), true).whenClicked(new View.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda10
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public View createView(Context context) {
        ...
        if (this.creatingNew) {
            if (this.type == FilterActivityType.TOPIC) {
                this.actionBar.setTitle(LocaleController.getInternalString(C3473R.string.topic_new));
            } else {
                this.actionBar.setTitle(LocaleController.getString("FilterNew", C3473R.string.FilterNew));
            }
        } else {
            TextPaint textPaint = new TextPaint(1);
            textPaint.setTextSize(AndroidUtilities.m72dp(20));
            if (this.type == FilterActivityType.TOPIC) {
                if (this.topic.isUserTopic()) {
                    this.actionBar.setTitle(Emoji.replaceEmoji(this.topic.getName(), textPaint.getFontMetricsInt(), AndroidUtilities.m72dp(20), false));
                ...
                this.actionBar.setTitle(Emoji.replaceEmoji(this.filter.name, textPaint.getFontMetricsInt(), AndroidUtilities.m72dp(20), false));
            }
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.FilterCreateActivity.1
            {
        ...
        this.doneItem = createMenu.addItem(1, LocaleController.getString("Save", C3473R.string.Save).toUpperCase());
    ...
    public /* synthetic */ void lambda$createView$10(View view, int i, float f, float f2) {
        ...
        if (itemInner.onClickListener == null) {
            ...
            } else if (i2 == 8 || (i2 == 4 && itemInner.iconResId == C3473R.C3475drawable.msg2_link2)) {
    ...
    public /* synthetic */ void lambda$createView$9(ItemInner itemInner) {
        ...
        filterChatlistActivity.setOnEdit(new FilterCreateActivity$$ExternalSyntheticLambda26(this));
    ...
    private void onClickCreateLink(View view) {
        if (this.creatingNew && this.doneItem.getAlpha() > BitmapDescriptorFactory.HUE_RED) {
            ...
            if (TextUtils.isEmpty(this.newFilterName) && TextUtils.isEmpty(this.filter.name)) {
                BulletinFactory.m32of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorEmptyName", C3473R.string.FilterInviteErrorEmptyName)).show();
                ...
                if (!this.newNeverShow.isEmpty()) {
                    BulletinFactory.m32of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorTypesExcluded", C3473R.string.FilterInviteErrorTypesExcluded)).show();
                } else {
                    BulletinFactory.m32of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorTypes", C3473R.string.FilterInviteErrorTypes)).show();
                }
            } else if (this.newAlwaysShow.isEmpty()) {
                BulletinFactory.m32of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorEmpty", C3473R.string.FilterInviteErrorEmpty)).show();
            } else {
                BulletinFactory.m32of(this).createErrorBulletin(LocaleController.getString("FilterInviteErrorExcluded", C3473R.string.FilterInviteErrorExcluded)).show();
            }
        } else {
    ...
    public /* synthetic */ void lambda$onClickCreateLink$15() {
        ...
        if (arrayList.size() > (getUserConfig().isPremium() ? getMessagesController().dialogFiltersChatsLimitPremium : getMessagesController().dialogFiltersChatsLimitDefault)) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_chatlists_exportChatlistInvite, new RequestDelegate() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda27
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$onClickCreateLink$13(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        if (processErrors(tLRPC$TL_error, this, BulletinFactory.m32of(this)) && (tLObject instanceof TLRPC$TL_chatlists_exportedChatlistInvite)) {
            hideNew(0);
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda17
                @Override // java.lang.Runnable
                public final void run() {
                    FilterCreateActivity.this.lambda$onClickCreateLink$12(tLRPC$TL_chatlists_exportedChatlistInvite);
                }
            }, 200L);
        }
    }

    public /* synthetic */ void lambda$onClickCreateLink$12(TLRPC$TL_chatlists_exportedChatlistInvite tLRPC$TL_chatlists_exportedChatlistInvite) {
    ...
    private void showSaveHint() {
        ...
        if (hintView == null || hintView.getVisibility() != 0) {
            ...
            this.saveHintView.setExtraTranslationY(AndroidUtilities.m72dp(-16));
            this.saveHintView.setText(LocaleController.getString("FilterFinishCreating", C3473R.string.FilterFinishCreating));
            ViewGroup.MarginLayoutParams marginLayoutParams = new ViewGroup.MarginLayoutParams(-2, -2);
            marginLayoutParams.rightMargin = AndroidUtilities.m72dp(3);
    ...
    public void deleteFolder(View view) {
        MessagesController.DialogFilter dialogFilter = this.filter;
        if (dialogFilter != null && dialogFilter.isChatlist()) {
            FolderBottomSheet.showForDeletion(this, this.filter.f1459id, new Utilities.Callback() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda24
        ...
        FilterActivityType filterActivityType = this.type;
        FilterActivityType filterActivityType2 = FilterActivityType.TOPIC;
        builder.setTitle(filterActivityType == filterActivityType2 ? LocaleController.getInternalString(C3473R.string.topics_remove) : LocaleController.getString("FilterDelete", C3473R.string.FilterDelete));
        builder.setMessage(this.type == filterActivityType2 ? LocaleController.getInternalString(C3473R.string.topics_remove_alert) : LocaleController.getString("FilterDeleteAlert", C3473R.string.FilterDeleteAlert));
        builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("Delete", C3473R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda3
    ...
    public /* synthetic */ void lambda$deleteFolder$19(DialogInterface dialogInterface, int i) {
        ...
        tLRPC$TL_messages_updateDialogFilter.f1644id = this.filter.f1459id;
            ...
            if (TextUtils.isEmpty(this.newFilterName) || !this.nameChangedManually) {
                ...
                if ((i3 & i2) == i2) {
                    if ((MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_READ & i) != 0) {
                        string = LocaleController.getString("FilterNameUnread", C3473R.string.FilterNameUnread);
                    } else {
                        if ((i & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED) != 0) {
                            string = LocaleController.getString("FilterNameNonMuted", C3473R.string.FilterNameNonMuted);
                        }
                        string = "";
                    }
                } else {
                    ...
                    if ((i3 & i4) != 0) {
                        if (((~i4) & i3) == 0) {
                            string = LocaleController.getString("FilterContacts", C3473R.string.FilterContacts);
                        }
                        string = "";
                    } else {
                        ...
                        if ((i3 & i5) != 0) {
                            if (((~i5) & i3) == 0) {
                                string = LocaleController.getString("FilterNonContacts", C3473R.string.FilterNonContacts);
                            }
                            string = "";
                        } else {
                            ...
                            if ((i3 & i6) != 0) {
                                if (((~i6) & i3) == 0) {
                                    string = LocaleController.getString("FilterGroups", C3473R.string.FilterGroups);
                                }
                                string = "";
                            } else {
                                ...
                                if ((i3 & i7) != 0) {
                                    if (((~i7) & i3) == 0) {
                                        string = LocaleController.getString("FilterBots", C3473R.string.FilterBots);
                                    }
                                    string = "";
                                } else {
                                    int i8 = MessagesController.DIALOG_FILTER_FLAG_CHANNELS;
                                    if ((i3 & i8) != 0 && ((~i8) & i3) == 0) {
                                        string = LocaleController.getString("FilterChannels", C3473R.string.FilterChannels);
                                    }
                                    string = "";
                                }
                            }
    ...
    public boolean checkDiscard() {
        if (this.doneItem.getAlpha() == 1.0f) {
            ...
            if (this.creatingNew) {
                FilterActivityType filterActivityType = this.type;
                FilterActivityType filterActivityType2 = FilterActivityType.TOPIC;
                builder.setTitle(filterActivityType == filterActivityType2 ? LocaleController.getInternalString(C3473R.string.topic_create_discard_title) : LocaleController.getString("FilterDiscardNewTitle", C3473R.string.FilterDiscardNewTitle));
                builder.setMessage(this.type == filterActivityType2 ? LocaleController.getInternalString(C3473R.string.topic_create_discard_message) : LocaleController.getString("FilterDiscardNewAlert", C3473R.string.FilterDiscardNewAlert));
                builder.setPositiveButton(LocaleController.getString("FilterDiscardNewSave", C3473R.string.FilterDiscardNewSave), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder.setTitle(LocaleController.getString("FilterDiscardTitle", C3473R.string.FilterDiscardTitle));
                builder.setMessage(this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3473R.string.topic_edit_discard_message) : LocaleController.getString("FilterDiscardAlert", C3473R.string.FilterDiscardAlert));
                builder.setPositiveButton(LocaleController.getString("ApplyTheme", C3473R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder.setNegativeButton(LocaleController.getString("PassportDiscard", C3473R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showRemoveAlert(final ItemInner itemInner, CharSequence charSequence, Object obj, final boolean z) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        if (this.type == FilterActivityType.TOPIC) {
            builder.setTitle(LocaleController.getInternalString(C3473R.string.topic_remove_chat_title));
            builder.setMessage(LocaleController.formatStringInternal(C3473R.string.topic_remove_chat_message, charSequence));
        } else if (z) {
            builder.setTitle(LocaleController.getString("FilterRemoveInclusionTitle", C3473R.string.FilterRemoveInclusionTitle));
            if (obj instanceof String) {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionText", C3473R.string.FilterRemoveInclusionText, charSequence));
            } else if (obj instanceof TLRPC$User) {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionUserText", C3473R.string.FilterRemoveInclusionUserText, charSequence));
            } else {
                builder.setMessage(LocaleController.formatString("FilterRemoveInclusionChatText", C3473R.string.FilterRemoveInclusionChatText, charSequence));
            }
        } else {
            builder.setTitle(LocaleController.getString("FilterRemoveExclusionTitle", C3473R.string.FilterRemoveExclusionTitle));
            if (obj instanceof String) {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionText", C3473R.string.FilterRemoveExclusionText, charSequence));
            } else if (obj instanceof TLRPC$User) {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionUserText", C3473R.string.FilterRemoveExclusionUserText, charSequence));
            } else {
                builder.setMessage(LocaleController.formatString("FilterRemoveExclusionChatText", C3473R.string.FilterRemoveExclusionChatText, charSequence));
            }
        }
        builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("StickersRemove", C3473R.string.StickersRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterCreateActivity$$ExternalSyntheticLambda4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void lambda$processDone$25() {
        ...
        if (this.doNotCloseWhenSave) {
            ...
            TextPaint textPaint = new TextPaint(1);
            textPaint.setTextSize(AndroidUtilities.m72dp(20));
            this.actionBar.setTitleAnimated(Emoji.replaceEmoji(this.filter.name, textPaint.getFontMetricsInt(), AndroidUtilities.m72dp(20), false), true, 220L);
            return;
        }
        finishFragment();
    }
    ...
    private static void processAddFilter(MessagesController.DialogFilter dialogFilter, int i, String str, ArrayList<Long> arrayList, ArrayList<Long> arrayList2, boolean z, boolean z2, boolean z3, boolean z4, BaseFragment baseFragment, Runnable runnable) {
        ...
        if (z2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                tLRPC$TL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(dialogFilters.get(i2).f1459id));
            }
    ...
    public static void saveFilterToServer(final MessagesController.DialogFilter dialogFilter, final int i, final String str, final ArrayList<Long> arrayList, final ArrayList<Long> arrayList2, final LongSparseIntArray longSparseIntArray, final boolean z, final boolean z2, final boolean z3, final boolean z4, final boolean z5, final BaseFragment baseFragment, final Runnable runnable) {
        ...
        TLRPC$TL_messages_updateDialogFilter tLRPC$TL_messages_updateDialogFilter = new TLRPC$TL_messages_updateDialogFilter();
        tLRPC$TL_messages_updateDialogFilter.f1644id = dialogFilter.f1459id;
        int i4 = 1;
        ...
        tLRPC$TL_dialogFilter.f1529id = dialogFilter.f1459id;
    ...
    private boolean hasChanges() {
        ...
        if (filterActivityType == FilterActivityType.TOPIC) {
            ...
            FilterSettingsModel copy = getFiltersController().getSettings(this.filter.f1459id).getCopy();
    ...
    public class ListAdapter extends AdapterWithDiffUtils {
            ...
            if (i == IdFabric$ViewTypes.FLOATING_ACTION_BUTTON) {
                ...
                switch (i) {
                    ...
                    case 7:
                        ...
                        headerCell = new LinkCell(context, filterCreateActivity3, ((BaseFragment) filterCreateActivity3).currentAccount, FilterCreateActivity.this.filter.f1459id) { // from class: org.telegram.ui.FilterCreateActivity.ListAdapter.2
                            {
                                ListAdapter.this = this;
                            }
        ...
        public void onViewAttachedToWindow(RecyclerView.ViewHolder viewHolder) {
            if (viewHolder.getItemViewType() == 2) {
                ...
                pollEditTextCell.setTag(1);
                pollEditTextCell.setTextAndHint(FilterCreateActivity.this.newFilterName != null ? FilterCreateActivity.this.newFilterName : "", FilterCreateActivity.this.type == FilterActivityType.TOPIC ? LocaleController.getInternalString(C3473R.string.topic_name_hint) : LocaleController.getString("FilterNameHint", C3473R.string.FilterNameHint), false);
                pollEditTextCell.setTag(null);
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (itemViewType == 3) {
                    viewHolder.itemView.setBackground(Theme.getThemedDrawableByKey(this.mContext, z ? C3473R.C3475drawable.greydivider : C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                ...
                if (j > 0) {
                    ...
                    if (user != null) {
                        if (user.bot) {
                            string2 = LocaleController.getString("Bot", C3473R.string.Bot);
                        } else if (user.contact) {
                            string2 = LocaleController.getString("FilterContact", C3473R.string.FilterContact);
                        } else {
                            string2 = LocaleController.getString("FilterNonContact", C3473R.string.FilterNonContact);
                        }
                ...
                if (chat != null) {
                    if (chat.participants_count != 0) {
                        ...
                        if (ChatObject.isChannel(chat) && !chat.megagroup) {
                            string = LocaleController.getString("ChannelPrivate", C3473R.string.ChannelPrivate);
                        } else {
                            string = LocaleController.getString("MegaPrivate", C3473R.string.MegaPrivate);
                        }
                    } else if (ChatObject.isChannel(chat) && !chat.megagroup) {
                        string = LocaleController.getString("ChannelPublic", C3473R.string.ChannelPublic);
                    } else {
                        string = LocaleController.getString("MegaPublic", C3473R.string.MegaPublic);
                    }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(c3541ActionBar, i3, null, null, null, null, i4));
    ...
    private static class ButtonCell extends FrameLayout {
        ...
        public void set(int i, CharSequence charSequence, boolean z) {
            ...
            if (LocaleController.isRTL) {
                ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).rightMargin = AndroidUtilities.m72dp(i != 0 ? 72 : 24);
            } else {
                ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).leftMargin = AndroidUtilities.m72dp(i != 0 ? 72 : 24);
            }
    ...
    private static class CreateLinkCell extends FrameLayout {
        ...
        public CreateLinkCell(Context context) {
            ...
            this.textView.setText(LocaleController.getString("CreateNewLink", C3473R.string.CreateNewLink));
            this.textView.setGravity(LocaleController.isRTL ? 5 : 3);
            TextView textView2 = this.textView;
            boolean z = LocaleController.isRTL;
            ...
            Drawable drawable = context.getResources().getDrawable(C3473R.C3475drawable.poll_add_circle);
            Drawable drawable2 = context.getResources().getDrawable(C3473R.C3475drawable.poll_add_plus);
    ...
    public static class LinkCell extends FrameLayout {
        ...
        public LinkCell(Context context, BaseFragment baseFragment, int i, int i2) {
            ...
            animatedTextView.setTextSize(AndroidUtilities.m73dp(15.66f));
            ...
            animatedTextView3.setTextSize(AndroidUtilities.m72dp(13));
            ...
            imageView.setImageDrawable(getContext().getResources().getDrawable(C3473R.C3475drawable.ic_ab_other));
            ...
            this.optionsIcon.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
            ...
            Drawable mutate = getContext().getResources().getDrawable(C3473R.C3475drawable.msg_link_1).mutate();
            this.linkIcon = mutate;
            mutate.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
            Drawable mutate2 = getContext().getResources().getDrawable(C3473R.C3475drawable.msg_link_2).mutate();
        ...
        protected void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            int measuredWidth = LocaleController.isRTL ? getMeasuredWidth() - AndroidUtilities.m72dp(32) : AndroidUtilities.m72dp(32);
            float f = measuredWidth;
            canvas.drawCircle(f, getMeasuredHeight() / 2.0f, AndroidUtilities.m72dp(16), this.paint);
            float f2 = this.revokeT;
            float f3 = BitmapDescriptorFactory.HUE_RED;
            if (f2 > BitmapDescriptorFactory.HUE_RED) {
                canvas.drawCircle(f, getMeasuredHeight() / 2.0f, AndroidUtilities.m72dp(16) * this.revokeT, this.revokedPaint);
            }
            float f4 = this.revokeT;
            if (f4 < 1.0f) {
                this.linkIcon.setAlpha((int) ((1.0f - f4) * 255.0f));
                this.linkIcon.setBounds(measuredWidth - AndroidUtilities.m72dp(14), (getMeasuredHeight() / 2) - AndroidUtilities.m72dp(14), AndroidUtilities.m72dp(14) + measuredWidth, (getMeasuredHeight() / 2) + AndroidUtilities.m72dp(14));
                this.linkIcon.draw(canvas);
            }
            float f5 = this.revokeT;
            if (f5 > BitmapDescriptorFactory.HUE_RED) {
                this.revokedLinkIcon.setAlpha((int) (f5 * 255.0f));
                this.revokedLinkIcon.setBounds(measuredWidth - AndroidUtilities.m72dp(14), (getMeasuredHeight() / 2) - AndroidUtilities.m72dp(14), measuredWidth + AndroidUtilities.m72dp(14), (getMeasuredHeight() / 2) + AndroidUtilities.m72dp(14));
                this.revokedLinkIcon.draw(canvas);
            }
            if (this.needDivider) {
                if (!LocaleController.isRTL) {
                    f3 = AndroidUtilities.m72dp(64);
                }
                canvas.drawRect(f3, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m72dp(64) : 0), getMeasuredHeight(), Theme.dividerPaint);
            }
        }
        ...
        public void options() {
            ...
            makeOptions.add(C3473R.C3475drawable.msg_qrcode, LocaleController.getString("GetQRCode", C3473R.string.GetQRCode), new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$LinkCell$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    FilterCreateActivity.LinkCell.this.qrcode();
                }
            });
            makeOptions.add(C3473R.C3475drawable.msg_delete, (CharSequence) LocaleController.getString("DeleteLink", C3473R.string.DeleteLink), true, new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$LinkCell$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void deleteLink() {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_chatlists_deleteExportedInvite, new RequestDelegate() { // from class: org.telegram.ui.FilterCreateActivity$LinkCell$$ExternalSyntheticLambda6
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        public /* synthetic */ void lambda$deleteLink$5(TLRPC$TL_error tLRPC$TL_error, Runnable runnable) {
            if (tLRPC$TL_error != null) {
                BulletinFactory.m32of(this.fragment).createErrorBulletin(LocaleController.getString("UnknownError", C3473R.string.UnknownError)).show();
        ...
        public void qrcode() {
            ...
            QRCodeBottomSheet qRCodeBottomSheet = new QRCodeBottomSheet(getContext(), LocaleController.getString("InviteByQRCode", C3473R.string.InviteByQRCode), this.lastUrl, LocaleController.getString("QRCodeLinkHelpFolder", C3473R.string.QRCodeLinkHelpFolder), false);
            qRCodeBottomSheet.setCenterAnimation(C3473R.raw.qr_code_logo);
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            sb.append(str);
            sb.append(LocaleController.getString("InviteLink", C3473R.string.InviteLink));
            sb.append(", ");
    ...
    public static CharSequence withNew(int i, CharSequence charSequence, boolean z) {
        ...
        if (i >= 0) {
            ...
            if (z) {
                Drawable mutate = context.getResources().getDrawable(C3473R.C3475drawable.msg_other_new_outline).mutate();
                mutate.setBounds(0, -AndroidUtilities.m72dp(8), mutate.getIntrinsicWidth(), mutate.getIntrinsicHeight() - AndroidUtilities.m72dp(8));
                spannableString.setSpan(new ColorImageSpan(mutate, 0), 0, spannableString.length(), 33);
            } else {
                Drawable mutate2 = context.getResources().getDrawable(C3473R.C3475drawable.msg_other_new_filled).mutate();
                Drawable mutate3 = context.getResources().getDrawable(C3473R.C3475drawable.msg_other_new_filled_text).mutate();
    ...
    public static class NewSpan extends ReplacementSpan {
        ...
        public NewSpan(boolean z) {
            ...
            if (z) {
                ...
                this.textPaint.setTextSize(AndroidUtilities.m72dp(10));
        ...
        public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
            makeLayout();
            return (int) (AndroidUtilities.m72dp(10) + this.width);
        }
        ...
        public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
            ...
            float m72dp = f + AndroidUtilities.m72dp(2);
            float m72dp2 = (i4 - this.height) + AndroidUtilities.m72dp(1);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(m72dp, m72dp2, this.width + m72dp, this.height + m72dp2);
            if (this.outline) {
                m73dp = AndroidUtilities.m73dp(3.66f);
                rectF.left -= AndroidUtilities.m72dp(4);
                rectF.top -= AndroidUtilities.m73dp(2.33f);
                rectF.right += AndroidUtilities.m73dp(3.66f);
                rectF.bottom += AndroidUtilities.m73dp(1.33f);
            } else {
                m73dp = AndroidUtilities.m73dp(4.4f);
                rectF.inset(AndroidUtilities.m72dp(-4), AndroidUtilities.m73dp(-2.33f));
            }
            canvas.drawRoundRect(rectF, m73dp, m73dp, this.bgPaint);
            canvas.save();
            canvas.translate(m72dp, m72dp2);
    ...
    public /* synthetic */ void lambda$onUpdate$31(boolean z, int i) {
        ...
        BulletinFactory m32of = BulletinFactory.m32of(this);
        int i2 = z ? C3473R.raw.folder_in : C3473R.raw.folder_out;
        if (z) {
        ...
        m32of.createSimpleBulletin(i2, formatPluralString, LocaleController.getString("FolderLinkChatlistUpdate", C3473R.string.FolderLinkChatlistUpdate)).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
    }
    ...
    public static class FilterInvitesBottomSheet extends BottomSheetWithRecyclerListView {
        ...
        public static void show(final BaseFragment baseFragment, final MessagesController.DialogFilter dialogFilter, final Runnable runnable) {
            ...
            TLRPC$TL_inputChatlistDialogFilter tLRPC$TL_inputChatlistDialogFilter = new TLRPC$TL_inputChatlistDialogFilter();
            tLRPC$TL_chatlists_getExportedInvites.chatlist = tLRPC$TL_inputChatlistDialogFilter;
            tLRPC$TL_inputChatlistDialogFilter.filter_id = dialogFilter.f1459id;
            baseFragment.getConnectionsManager().sendRequest(tLRPC$TL_chatlists_getExportedInvites, new RequestDelegate() { // from class: org.telegram.ui.FilterCreateActivity$FilterInvitesBottomSheet$$ExternalSyntheticLambda3
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        public static /* synthetic */ void lambda$show$0(BaseFragment baseFragment, TLObject tLObject, MessagesController.DialogFilter dialogFilter, TLRPC$TL_error tLRPC$TL_error, Runnable runnable, long j) {
            ...
            if (tLObject instanceof TLRPC$TL_chatlists_exportedInvites) {
                ...
                BulletinFactory.m32of(baseFragment).createErrorBulletin(LocaleController.getString("UnknownError", C3473R.string.UnknownError)).show();
            }
            if (runnable != null) {
        ...
        public FilterInvitesBottomSheet(BaseFragment baseFragment, MessagesController.DialogFilter dialogFilter, ArrayList<TLRPC$TL_exportedChatlistInvite> arrayList) {
            ...
            this.button.setText(LocaleController.getString("FolderLinkShareButton", C3473R.string.FolderLinkShareButton));
        ...
        public void updateCreateInviteButton() {
            ...
            this.recyclerListView.setPadding(AndroidUtilities.m72dp(6), 0, AndroidUtilities.m72dp(6), this.invites.isEmpty() ? AndroidUtilities.m72dp(68) : 0);
        }

        @Override // org.telegram.p043ui.Components.BottomSheetWithRecyclerListView
        protected CharSequence getTitle() {
            int i = C3473R.string.FolderLinkShareTitle;
            ...
            AdapterWithDiffUtils adapterWithDiffUtils = new AdapterWithDiffUtils() { // from class: org.telegram.ui.FilterCreateActivity.FilterInvitesBottomSheet.1
                ...
                public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                    ...
                    if (i == 8) {
                        ...
                        textInfoPrivacyCell = new C58721(FilterInvitesBottomSheet.this.getContext(), null, ((BottomSheet) FilterInvitesBottomSheet.this).currentAccount, FilterInvitesBottomSheet.this.filter.f1459id);
                        textInfoPrivacyCell.setBackgroundColor(Theme.getColor(Theme.key_dialogBackground));
                    } else if (i == 6 || i == 3) {
                ...
                /* loaded from: classes3.dex */
                public class C58721 extends LinkCell {
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C58721(Context context, BaseFragment baseFragment, int i, int i2) {
                    ...
                    public void options() {
                        ...
                        makeOptions.add(C3473R.C3475drawable.msg_copy, LocaleController.getString("CopyLink", C3473R.string.CopyLink), new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$FilterInvitesBottomSheet$1$1$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                FilterCreateActivity.FilterInvitesBottomSheet.C58711.C58721.this.copy();
                            }
                        });
                        makeOptions.add(C3473R.C3475drawable.msg_qrcode, LocaleController.getString("GetQRCode", C3473R.string.GetQRCode), new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$FilterInvitesBottomSheet$1$1$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                FilterCreateActivity.FilterInvitesBottomSheet.C58711.C58721.this.qrcode();
                            }
                        });
                        makeOptions.add(C3473R.C3475drawable.msg_delete, (CharSequence) LocaleController.getString("DeleteLink", C3473R.string.DeleteLink), true, new Runnable() { // from class: org.telegram.ui.FilterCreateActivity$FilterInvitesBottomSheet$1$1$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                FilterCreateActivity.FilterInvitesBottomSheet.C58711.C58721.this.deleteLink();
                            }
                        });
                        if (LocaleController.isRTL) {
                            makeOptions.setGravity(3);
                    ...
                    public void copy() {
                        ...
                        if (str != null && AndroidUtilities.addToClipboard(str)) {
                            BulletinFactory.m33of(FilterInvitesBottomSheet.this.bulletinContainer, null).createCopyLinkBulletin().show();
                        }
                    }
                ...
                public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    if (itemViewType == 7) {
                        ...
                        if (itemViewType != 0 && itemViewType == 8) {
                            ...
                            createLinkCell.setText(LocaleController.getString("CreateNewInviteLink", C3473R.string.CreateNewInviteLink));
                        ...
                        textInfoPrivacyCell.setForeground(Theme.getThemedDrawableByKey(FilterInvitesBottomSheet.this.getContext(), z ? C3473R.C3475drawable.greydivider : C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    }
                }
        ...
        public class HeaderView extends FrameLayout {
            ...
            public HeaderView(Context context) {
                ...
                this.imageView = imageView;
                imageView.setScaleType(ImageView.ScaleType.CENTER);
                imageView.setImageResource(C3473R.C3475drawable.msg_limit_links);
                imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
                imageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m72dp(22), Theme.getColor(Theme.key_featuredStickers_addButton)));
                ...
                if (r12.invites.isEmpty()) {
                    string = LocaleController.getString("FolderLinkShareSubtitleEmpty", C3473R.string.FolderLinkShareSubtitleEmpty);
                } else {
                    string = LocaleController.getString("FolderLinkShareSubtitle", C3473R.string.FolderLinkShareSubtitle);
                }
                ...
                imageView2.setImageResource(C3473R.C3475drawable.msg_close);
            ...
            @Override // android.widget.FrameLayout, android.view.View
            protected void onMeasure(int i, int i2) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(171), 1073741824));
            }
        }
        ...
        private void createLink() {
            ...
            tLRPC$TL_chatlists_exportChatlistInvite.peers = arrayList;
            tLRPC$TL_chatlists_exportChatlistInvite.title = "";
            getBaseFragment().getConnectionsManager().sendRequest(tLRPC$TL_chatlists_exportChatlistInvite, new RequestDelegate() { // from class: org.telegram.ui.FilterCreateActivity$FilterInvitesBottomSheet$$ExternalSyntheticLambda4
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        public /* synthetic */ void lambda$createLink$3(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
            if (FilterCreateActivity.processErrors(tLRPC$TL_error, getBaseFragment(), BulletinFactory.m33of(this.bulletinContainer, null)) && (tLObject instanceof TLRPC$TL_chatlists_exportedChatlistInvite)) {
    ...
    public static boolean processErrors(TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, BulletinFactory bulletinFactory) {
        if (tLRPC$TL_error != null && !TextUtils.isEmpty(tLRPC$TL_error.text)) {
            if ("INVITE_PEERS_TOO_MUCH".equals(tLRPC$TL_error.text)) {
                ...
                bulletinFactory.createErrorBulletin(LocaleController.getString("FolderLinkNoChatsError", C3473R.string.FolderLinkNoChatsError)).show();
            } else if ("USER_CHANNELS_TOO_MUCH".equals(tLRPC$TL_error.text)) {
                bulletinFactory.createErrorBulletin(LocaleController.getString("FolderLinkOtherAdminLimitError", C3473R.string.FolderLinkOtherAdminLimitError)).show();
                ...
                bulletinFactory.createErrorBulletin(LocaleController.getString("NoFolderFound", C3473R.string.NoFolderFound)).show();
                ...
                bulletinFactory.createErrorBulletin(LocaleController.getString("UnknownError", C3473R.string.UnknownError)).show();
            }
        }
        return true;
    }
