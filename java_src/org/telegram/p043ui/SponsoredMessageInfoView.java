...
public class SponsoredMessageInfoView extends FrameLayout {
    public SponsoredMessageInfoView(final Activity activity, Theme.ResourcesProvider resourcesProvider) {
        ...
        linksTextView.setLineSpacing(AndroidUtilities.m104dp(2), 1.0f);
        ...
        linksTextView2.setLineSpacing(AndroidUtilities.m104dp(2), 1.0f);
        ...
        linksTextView3.setLineSpacing(AndroidUtilities.m104dp(2), 1.0f);
        ...
        TextView textView2 = new TextView(this, activity) { // from class: org.telegram.ui.SponsoredMessageInfoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                rectF.set(AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(1), getMeasuredWidth() - AndroidUtilities.m104dp(1), getMeasuredHeight() - AndroidUtilities.m104dp(1));
        ...
        linksTextView4.setLineSpacing(AndroidUtilities.m104dp(2), 1.0f);
        linksTextView4.setTextColor(Theme.getColor(i, resourcesProvider));
        linksTextView4.setTextSize(1, 14.0f);
        textView.setPadding(AndroidUtilities.m104dp(22), 0, AndroidUtilities.m104dp(22), 0);
        linearLayout.addView(textView);
        linksTextView.setPadding(AndroidUtilities.m104dp(22), 0, AndroidUtilities.m104dp(22), 0);
        linearLayout.addView(linksTextView, LayoutHelper.createLinear(-1, -2, 0, 0, 18, 0, 0));
        linksTextView2.setPadding(AndroidUtilities.m104dp(22), 0, AndroidUtilities.m104dp(22), 0);
        linearLayout.addView(linksTextView2, LayoutHelper.createLinear(-1, -2, 0, 0, 24, 0, 0));
        linksTextView3.setPadding(AndroidUtilities.m104dp(22), 0, AndroidUtilities.m104dp(22), 0);
        ...
        linksTextView4.setPadding(AndroidUtilities.m104dp(22), 0, AndroidUtilities.m104dp(22), 0);
