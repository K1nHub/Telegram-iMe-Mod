...
public class VoiceMessageEnterTransition implements MessageEnterTransitionContainer.Transition {
    ...
    public void onDraw(final Canvas canvas) {
        ...
        if (recordCircle2 != null) {
            f3 = (recordCircle2.drawingCy + recordCircle2.getY()) - this.container.getY();
        }
        final float f4 = f3;
        ...
        final float f5 = ((1.0f - interpolation2) * x) + (centerX * interpolation2);
        float f6 = 1.0f - interpolation;
        final float f7 = (f4 * f6) + (centerY * interpolation);
        ...
        if (recordCircle3 != null) {
            recordCircle3.drawWaves(canvas, f5, f7, 1.0f - f2);
        }
        canvas.drawCircle(f5, f7, f8, this.circlePaint);
        canvas.save();
        final float f9 = f8 / height;
        canvas.scale(f9, f9, f5, f7);
        final float centerX2 = f5 - this.messageView.getRadialProgress().getProgressRect().centerX();
        final float centerY2 = f7 - this.messageView.getRadialProgress().getProgressRect().centerY();
        ...
        this.messageView.drawVoiceOnce(canvas, interpolation, new Runnable() { // from class: org.telegram.ui.VoiceMessageEnterTransition$$ExternalSyntheticLambda1
            ...
            public final void run() {
                VoiceMessageEnterTransition.this.lambda$onDraw$1(canvas, centerX2, centerY2, f9, f5, f7, x, f4, f);
            }
        });
