...
public class DefaultThemesPreviewCell extends LinearLayout {
    ...
    public DefaultThemesPreviewCell(Context context, final BaseFragment baseFragment, int i) {
        ...
        if (this.currentType == 0) {
            ...
            textCell3.setTextAndIcon(LocaleController.getString("SettingsBrowseThemes", C3632R.string.SettingsBrowseThemes), C3632R.C3634drawable.msg_colors, false);
            addView(this.browseThemesCell, LayoutHelper.createFrame(-1, -2));
            this.dayNightCell.setOnClickListener(new View$OnClickListenerC59421(context, baseFragment));
    ...
    /* loaded from: classes5.dex */
    public class View$OnClickListenerC59421 implements View.OnClickListener {
        final /* synthetic */ Context val$context;
        final /* synthetic */ BaseFragment val$parentFragment;

        View$OnClickListenerC59421(Context context, BaseFragment baseFragment) {
        ...
        */
        public void onClick(android.view.View r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DefaultThemesPreviewCell.View$OnClickListenerC59421.onClick(android.view.View):void");
        }
