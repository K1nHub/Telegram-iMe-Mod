...
public class FilteredSearchView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FilteredSearchView(BaseFragment baseFragment) {
                ...
                for (int i2 = 0; i2 < childCount; i2++) {
                    ...
                    if (photoImage != null) {
                        ...
                        if (PhotoViewer.isShowingImage(messageObject) && (pinnedHeader = recyclerListView.getPinnedHeader()) != null) {
                            int m108dp = (childAt instanceof SharedDocumentCell ? AndroidUtilities.m108dp(8.0f) + 0 : 0) - placeProviderObject.viewY;
                            if (m108dp > childAt.getHeight()) {
                                recyclerListView.scrollBy(0, -(m108dp + pinnedHeader.getHeight()));
                            } else {
                                int height = placeProviderObject.viewY - recyclerListView.getHeight();
                                if (childAt instanceof SharedDocumentCell) {
                                    height -= AndroidUtilities.m108dp(8.0f);
                                }
                                if (height >= 0) {
                ...
                if (getAdapter() == FilteredSearchView.this.sharedPhotoVideoAdapter) {
                    for (int i = 0; i < getChildCount(); i++) {
                        if (getChildViewHolder(getChildAt(i)).getItemViewType() == 1) {
                            canvas.save();
                            canvas.translate(getChildAt(i).getX(), (getChildAt(i).getY() - getChildAt(i).getMeasuredHeight()) + AndroidUtilities.m107dp(2));
        ...
        this.recyclerListView.setPadding(0, 0, 0, AndroidUtilities.m107dp(3));
        ...
        this.recyclerListView.setOnScrollListener(new C62336());
        ...
        chatActionCell.setTranslationY(-AndroidUtilities.m107dp(48));
    ...
    /* loaded from: classes5.dex */
    public class C62336 extends RecyclerView.OnScrollListener {
        C62336() {
        }
            ...
            if (recyclerView.getAdapter() != null) {
                ...
                if (!FilteredSearchView.this.isLoading && abs > 0 && findLastVisibleItemPosition >= itemCount - 10 && !FilteredSearchView.this.endReached) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilteredSearchView$6$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            FilteredSearchView.C62336.this.lambda$onScrolled$0();
                        }
                    });
                }
    ...
    public static CharSequence createFromInfoString(MessageObject messageObject, boolean z, int i, TextPaint textPaint) {
        ...
        if (spannableStringBuilderArr[i] == null) {
            ...
            if (i == 0) {
                i2 = C3632R.C3634drawable.attach_arrow_right;
            } else if (i == 1) {
                i2 = C3632R.C3634drawable.msg_mini_arrow_mediathin;
            } else if (i != 2) {
                return "";
            } else {
                i2 = C3632R.C3634drawable.msg_mini_arrow_mediabold;
            }
        ...
        if (tLRPC$User != null && chat2 != null) {
            ...
            if (ChatObject.isForum(chat2) && (findTopic2 = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chat2.f1602id, MessageObject.getTopicId(messageObject.currentAccount, messageObject.messageOwner, true))) != null) {
            ...
            if (ChatObject.isForum(chat) && (findTopic = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chat.f1602id, MessageObject.getTopicId(messageObject.currentAccount, messageObject.messageOwner, true))) != null) {
    ...
    public /* synthetic */ void lambda$search$2(int i, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, int i2, boolean z, String str, ArrayList arrayList, FiltersView.MediaFilterData mediaFilterData, long j, long j2, ArrayList arrayList2, ArrayList arrayList3) {
        ...
        if (this.messages.isEmpty()) {
            if (mediaFilterData != null) {
                if (TextUtils.isEmpty(this.currentDataQuery) && j == 0 && j2 == 0) {
                    this.emptyView.title.setText(LocaleController.getString("SearchEmptyViewTitle", C3632R.string.SearchEmptyViewTitle));
                    int i4 = mediaFilterData.filterType;
                    if (i4 == 1) {
                        string = LocaleController.getString("SearchEmptyViewFilteredSubtitleFiles", C3632R.string.SearchEmptyViewFilteredSubtitleFiles);
                    } else if (i4 == 0) {
                        string = LocaleController.getString("SearchEmptyViewFilteredSubtitleMedia", C3632R.string.SearchEmptyViewFilteredSubtitleMedia);
                    } else if (i4 == 2) {
                        string = LocaleController.getString("SearchEmptyViewFilteredSubtitleLinks", C3632R.string.SearchEmptyViewFilteredSubtitleLinks);
                    } else if (i4 == 3) {
                        string = LocaleController.getString("SearchEmptyViewFilteredSubtitleMusic", C3632R.string.SearchEmptyViewFilteredSubtitleMusic);
                    } else {
                        string = LocaleController.getString("SearchEmptyViewFilteredSubtitleVoice", C3632R.string.SearchEmptyViewFilteredSubtitleVoice);
                    }
                    this.emptyView.subtitle.setVisibility(0);
        ...
        if (!z) {
            ...
            if (str != null && str.length() >= 3 && (LocaleController.getString("SavedMessages", C3632R.string.SavedMessages).toLowerCase().startsWith(str) || "saved messages".startsWith(str))) {
                int i6 = 0;
                while (true) {
                    if (i6 >= this.localTipChats.size()) {
                        z2 = false;
                        break;
                    } else if ((this.localTipChats.get(i6) instanceof TLRPC$User) && UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f1751id == ((TLRPC$User) this.localTipChats.get(i6)).f1751id) {
                        z2 = true;
                        break;
                    } else {
                        i6++;
            ...
            if (str != null && str.length() >= 3 && (LocaleController.getString("ArchiveSearchFilter", C3632R.string.ArchiveSearchFilter).toLowerCase().startsWith(str) || "archive".startsWith(str))) {
                        ...
                        if (layoutManager != null) {
                            ...
                            ofFloat2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.FilteredSearchView.7.2
                                ...
                                public void onAnimationEnd(Animator animator) {
                                    ...
                                    ViewTreeObserver$OnPreDrawListenerC62347 viewTreeObserver$OnPreDrawListenerC62347 = ViewTreeObserver$OnPreDrawListenerC62347.this;
    ...
    */
    ...
    public class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        private Context mContext;
        private final SharedLinkCell.SharedLinkCellDelegate sharedLinkCellDelegate = new C62441();
        ...
        /* loaded from: classes5.dex */
        public class C62441 implements SharedLinkCell.SharedLinkCellDelegate {
            C62441() {
            }
            ...
            public void onLinkPress(final String str, boolean z) {
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3632R.string.Open), LocaleController.getString("Copy", C3632R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilteredSearchView$SharedLinksAdapter$1$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        FilteredSearchView.SharedLinksAdapter.C62441.this.lambda$onLinkPress$0(str, dialogInterface, i);
                    }
                });
    ...
    public class OnlyUserFiltersAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                graySectionCell.setText(LocaleController.getString("SearchMessages", C3632R.string.SearchMessages));
    ...
    private void hideFloatingDateView(boolean z) {
        ...
        if (z) {
            ...
            this.floatingDateAnimation = animatorSet2;
            animatorSet2.setDuration(180L);
            this.floatingDateAnimation.playTogether(ObjectAnimator.ofFloat(this.floatingDateView, View.ALPHA, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.floatingDateView, View.TRANSLATION_Y, -AndroidUtilities.m107dp(48)));
            this.floatingDateAnimation.setInterpolator(CubicBezierInterpolator.EASE_OUT);
