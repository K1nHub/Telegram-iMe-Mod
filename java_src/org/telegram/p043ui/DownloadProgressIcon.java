...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C3632R.raw.download_progress, "download_progress", AndroidUtilities.m107dp(28), AndroidUtilities.m107dp(28), true, null);
        ...
        RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C3632R.raw.download_finish, "download_finish", AndroidUtilities.m107dp(28), AndroidUtilities.m107dp(28), true, null);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float m108dp = AndroidUtilities.m108dp(1.0f);
        float m107dp = AndroidUtilities.m107dp(16);
        RectF rectF = AndroidUtilities.rectTmp;
        float measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m107dp(8);
        float f5 = measuredHeight - m108dp;
        float f6 = measuredHeight + m108dp;
        rectF.set(m107dp, f5, getMeasuredWidth() - m107dp, f6);
        canvas.drawRoundRect(rectF, m108dp, m108dp, this.paint2);
        rectF.set(m107dp, f5, ((getMeasuredWidth() - (2.0f * m107dp)) * this.currentProgress) + m107dp, f6);
        canvas.drawRoundRect(rectF, m108dp, m108dp, this.paint);
        canvas.save();
