...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C3632R.raw.download_progress, "download_progress", AndroidUtilities.m104dp(28), AndroidUtilities.m104dp(28), true, null);
        ...
        RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C3632R.raw.download_finish, "download_finish", AndroidUtilities.m104dp(28), AndroidUtilities.m104dp(28), true, null);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float m105dp = AndroidUtilities.m105dp(1.0f);
        float m104dp = AndroidUtilities.m104dp(16);
        RectF rectF = AndroidUtilities.rectTmp;
        float measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m104dp(8);
        float f5 = measuredHeight - m105dp;
        float f6 = measuredHeight + m105dp;
        rectF.set(m104dp, f5, getMeasuredWidth() - m104dp, f6);
        canvas.drawRoundRect(rectF, m105dp, m105dp, this.paint2);
        rectF.set(m104dp, f5, ((getMeasuredWidth() - (2.0f * m104dp)) * this.currentProgress) + m104dp, f6);
        canvas.drawRoundRect(rectF, m105dp, m105dp, this.paint);
        canvas.save();
