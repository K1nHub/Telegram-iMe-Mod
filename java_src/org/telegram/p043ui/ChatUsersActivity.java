...
public class ChatUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    private void updateRows() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChatUsersActivity.updateRows():void");
    }
    ...
    public View createView(Context context) {
        ...
        int i2 = this.type;
        if (i2 == 3) {
            this.actionBar.setTitle(LocaleController.getString("ChannelPermissions", C3634R.string.ChannelPermissions));
        } else if (i2 == 0) {
            this.actionBar.setTitle(LocaleController.getString("ChannelBlacklist", C3634R.string.ChannelBlacklist));
        } else if (i2 == 1) {
            this.actionBar.setTitle(LocaleController.getString("ChannelAdministrators", C3634R.string.ChannelAdministrators));
        } else if (i2 == 2) {
            int i3 = this.selectType;
            if (i3 == 0) {
                if (this.isChannel) {
                    this.actionBar.setTitle(LocaleController.getString("ChannelSubscribers", C3634R.string.ChannelSubscribers));
                } else {
                    this.actionBar.setTitle(LocaleController.getString("ChannelMembers", C3634R.string.ChannelMembers));
                }
            } else if (i3 == 1) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddAdmin", C3634R.string.ChannelAddAdmin));
            } else if (i3 == 2) {
                this.actionBar.setTitle(LocaleController.getString("ChannelBlockUser", C3634R.string.ChannelBlockUser));
            } else if (i3 == 3) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddException", C3634R.string.ChannelAddException));
            }
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3706ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ChatUsersActivity.1
        ...
        if (this.selectType != 0 || (i = this.type) == 2 || i == 0 || i == 3) {
            ...
            ActionBarMenuItem actionBarMenuItemSearchListener = createMenu.addItem(0, C3634R.C3636drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.ChatUsersActivity.2
            ...
            if (this.type == 3) {
                this.searchItem.setSearchFieldHint(LocaleController.getString("ChannelSearchException", C3634R.string.ChannelSearchException));
            } else {
            ...
            if (this.type == 3) {
                this.doneItem = createMenu.addItemWithWidth(1, C3634R.C3636drawable.ic_ab_done, AndroidUtilities.m104dp(56), LocaleController.getString("Done", C3634R.string.Done));
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:330:0x06c4 A[RETURN] */
    ...
    */
    public /* synthetic */ void lambda$createView$5(android.view.View r30, int r31, float r32, float r33) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChatUsersActivity.lambda$createView$5(android.view.View, int, float, float):void");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.ChatUsersActivity$8 */
    /* loaded from: classes5.dex */
    public class C43668 implements ChatUsersActivityDelegate {
        ...
        public void didSelectUser(long j) {
            ...
            if (user != null) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$8$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ChatUsersActivity.C43668.this.lambda$didSelectUser$0(user);
                    }
                }, 200L);
            }
            if (ChatUsersActivity.this.participantsMap.get(j) == null) {
                ...
                tLRPC$TL_peerUser.user_id = user.f1749id;
                ...
                ChatUsersActivity.this.participantsMap.put(user.f1749id, tLRPC$TL_channelParticipantAdmin);
                ChatUsersActivity chatUsersActivity = ChatUsersActivity.this;
                chatUsersActivity.sortAdmins(chatUsersActivity.participants);
                ChatUsersActivity.this.updateListAnimated(saveState);
            }
    ...
    /* loaded from: classes5.dex */
    public class C43679 implements GroupCreateActivity.ContactsAddActivityDelegate {
        ...
        C43679(GroupCreateActivity groupCreateActivity) {
        ...
        public void didSelectUsers(ArrayList<TLRPC$User> arrayList, int i) {
            ...
            ChatUsersActivity.this.getMessagesController().addUsersToChat(ChatUsersActivity.this.currentChat, ChatUsersActivity.this, arrayList, i, new Consumer() { // from class: org.telegram.ui.ChatUsersActivity$9$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    ChatUsersActivity.C43679.this.lambda$didSelectUsers$0((TLRPC$User) obj);
                }
            }, new Consumer() { // from class: org.telegram.ui.ChatUsersActivity$9$$ExternalSyntheticLambda1
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    ChatUsersActivity.C43679.lambda$didSelectUsers$1((TLRPC$User) obj);
                }
            }, null);
        }
        ...
        public /* synthetic */ void lambda$didSelectUsers$0(TLRPC$User tLRPC$User) {
            ...
            if (longSparseArray.get(tLRPC$User.f1749id) == null) {
                if (ChatObject.isChannel(ChatUsersActivity.this.currentChat)) {
                    ...
                    tLRPC$TL_peerUser.user_id = tLRPC$User.f1749id;
                    ...
                    longSparseArray.put(tLRPC$User.f1749id, tLRPC$TL_channelParticipant);
                } else {
                    ...
                    longSparseArray.put(tLRPC$User.f1749id, tLRPC$TL_chatParticipant);
                }
            }
        ...
        public void needAddBot(TLRPC$User tLRPC$User) {
            ChatUsersActivity.this.openRightsEdit(tLRPC$User.f1749id, null, null, null, "", true, 0, false);
        }
    }
    ...
    public /* synthetic */ void lambda$createView$0(TextCell textCell, boolean z) {
        ...
        textCell.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(this.currentChat, 13) || ((tLRPC$ChatFull = this.info) != null && tLRPC$ChatFull.antispam && getParticipantsCount() < getMessagesController().telegramAntispamGroupSizeMin)) ? C3634R.C3636drawable.permission_locked : 0);
    ...
    public /* synthetic */ void lambda$createView$2(TextCell textCell, boolean z) {
        ...
        textCell.setChecked(z);
        textCell.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(this.currentChat, 2) || ((tLRPC$ChatFull = this.info) != null && tLRPC$ChatFull.participants_hidden && getParticipantsCount() < getMessagesController().hiddenMembersGroupSizeMin)) ? C3634R.C3636drawable.permission_locked : 0);
        BulletinFactory.m62of(this).createSimpleBulletin(C3634R.raw.error, LocaleController.getString("UnknownError", C3634R.string.UnknownError)).show();
    }
    ...
    /* loaded from: classes5.dex */
    public class DialogC435010 extends GigagroupConvertAlert {
        @Override // org.telegram.p043ui.Components.GigagroupConvertAlert
        protected void onCancel() {
        }

        DialogC435010(Context context, BaseFragment baseFragment) {
        ...
        protected void onCovert() {
            ChatUsersActivity.this.getMessagesController().convertToGigaGroup(ChatUsersActivity.this.getParentActivity(), ChatUsersActivity.this.currentChat, ChatUsersActivity.this, new MessagesStorage.BooleanCallback() { // from class: org.telegram.ui.ChatUsersActivity$10$$ExternalSyntheticLambda0
                ...
                public final void run(boolean z) {
                    ChatUsersActivity.DialogC435010.this.lambda$onCovert$0(z);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$createView$4(TLRPC$User tLRPC$User, TLObject tLObject, TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights, String str, boolean z, DialogInterface dialogInterface, int i) {
        openRightsEdit(tLRPC$User.f1749id, tLObject, tLRPC$TL_chatAdminRights, tLRPC$TL_chatBannedRights, str, z, this.selectType == 1 ? 0 : 1, false);
    }
    ...
    public void onOwnerChaged(TLRPC$User tLRPC$User) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            TLObject tLObject = longSparseArray.get(tLRPC$User.f1749id);
    ...
    public boolean createMenuForParticipant(final TLObject tLObject, boolean z, View view) {
        ...
        if (this.type == 2) {
            ...
            ItemOptions addIf = ItemOptions.makeOptions(this, view).setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundWhite))).addIf(z8, C3634R.C3636drawable.msg_admins, z6 ? LocaleController.getString("EditAdminRights", C3634R.string.EditAdminRights) : LocaleController.getString("SetAsAdmin", C3634R.string.SetAsAdmin), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    ChatUsersActivity.lambda$createMenuForParticipant$10(Utilities.Callback.this);
                }
            }).addIf(z10, C3634R.C3636drawable.msg_permissions, LocaleController.getString("ChangePermissions", C3634R.string.ChangePermissions), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda14
                @Override // java.lang.Runnable
                public final void run() {
            ...
            int i6 = C3634R.C3636drawable.msg_remove;
            if (this.isChannel) {
                i3 = C3634R.string.ChannelRemoveUser;
                str3 = "ChannelRemoveUser";
            } else {
                i3 = C3634R.string.KickFromGroup;
                str3 = "KickFromGroup";
            }
        ...
        if (this.type == 3 && ChatObject.canBlockUsers(this.currentChat)) {
            ...
            makeOptions.add(C3634R.C3636drawable.msg_permissions, LocaleController.getString("ChannelEditPermissions", C3634R.string.ChannelEditPermissions), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                    ChatUsersActivity.this.lambda$createMenuForParticipant$14(j5, tLRPC$TL_chatBannedRights3, str4, tLObject);
                }
            });
            makeOptions.add(C3634R.C3636drawable.msg_delete, (CharSequence) LocaleController.getString("ChannelDeleteFromList", C3634R.string.ChannelDeleteFromList), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (ChatObject.canAddUsers(this.currentChat) && i5 > 0) {
                int i7 = C3634R.C3636drawable.msg_contact_add;
                if (this.isChannel) {
                    i2 = C3634R.string.ChannelAddToChannel;
                    str2 = "ChannelAddToChannel";
                } else {
                    i2 = C3634R.string.ChannelAddToGroup;
            ...
            makeOptions.add(C3634R.C3636drawable.msg_delete, (CharSequence) LocaleController.getString("ChannelDeleteFromList", C3634R.string.ChannelDeleteFromList), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (this.currentChat.creator || !(tLObject instanceof TLRPC$TL_channelParticipantCreator)) {
                ...
                makeOptions.add(C3634R.C3636drawable.msg_admins, LocaleController.getString("EditAdminRights", C3634R.string.EditAdminRights), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda11
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            makeOptions.add(C3634R.C3636drawable.msg_remove, (CharSequence) LocaleController.getString("ChannelRemoveUserAdmin", C3634R.string.ChannelRemoveUserAdmin), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$createMenuForParticipant$12(TLObject tLObject, TLRPC$User tLRPC$User, final Utilities.Callback callback) {
        if ((tLObject instanceof TLRPC$TL_channelParticipantAdmin) || (tLObject instanceof TLRPC$TL_chatParticipantAdmin)) {
            showDialog(new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString("AppName", C3634R.string.AppName)).setMessage(LocaleController.formatString("AdminWillBeRemoved", C3634R.string.AdminWillBeRemoved, UserObject.getUserName(tLRPC$User))).setPositiveButton(LocaleController.getString("OK", C3634R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ void lambda$deletePeer$20(TLRPC$Updates tLRPC$Updates) {
        getMessagesController().loadFullChat(tLRPC$Updates.chats.get(0).f1602id, 0, true);
    }
    ...
    public boolean checkDiscard() {
        ...
        builder.setPositiveButton(LocaleController.getString("ApplyTheme", C3634R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                ChatUsersActivity.this.lambda$checkDiscard$23(dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("PassportDiscard", C3634R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public String formatUserPermissions(TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights) {
        ...
        if (z && this.defaultBannedRights.view_messages != z) {
            sb.append(LocaleController.getString("UserRestrictionsNoRead", C3634R.string.UserRestrictionsNoRead));
        }
        if (tLRPC$TL_chatBannedRights.send_messages && this.defaultBannedRights.send_plain != tLRPC$TL_chatBannedRights.send_plain) {
            if (sb.length() != 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("UserRestrictionsNoSendText", C3634R.string.UserRestrictionsNoSendText));
        }
        boolean z2 = tLRPC$TL_chatBannedRights.send_media;
        if (z2 && this.defaultBannedRights.send_media != z2) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendMedia", C3634R.string.UserRestrictionsNoSendMedia));
        } else {
            boolean z3 = tLRPC$TL_chatBannedRights.send_photos;
            if (z3 && this.defaultBannedRights.send_photos != z3) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendPhotos", C3634R.string.UserRestrictionsNoSendPhotos));
            }
            boolean z4 = tLRPC$TL_chatBannedRights.send_videos;
            if (z4 && this.defaultBannedRights.send_videos != z4) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendVideos", C3634R.string.UserRestrictionsNoSendVideos));
            }
            ...
            if (z5 && this.defaultBannedRights.send_audios != z5) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendMusic", C3634R.string.UserRestrictionsNoSendMusic));
            }
            ...
            if (z6 && this.defaultBannedRights.send_docs != z6) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendDocs", C3634R.string.UserRestrictionsNoSendDocs));
            }
            boolean z7 = tLRPC$TL_chatBannedRights.send_voices;
            if (z7 && this.defaultBannedRights.send_voices != z7) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendVoice", C3634R.string.UserRestrictionsNoSendVoice));
            }
            ...
            if (z8 && this.defaultBannedRights.send_roundvideos != z8) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendRound", C3634R.string.UserRestrictionsNoSendRound));
            }
        }
        ...
        if (z9 && this.defaultBannedRights.send_stickers != z9) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendStickers", C3634R.string.UserRestrictionsNoSendStickers));
        }
        ...
        if (z10 && this.defaultBannedRights.send_polls != z10) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendPolls", C3634R.string.UserRestrictionsNoSendPolls));
        }
        ...
        if (z11 && !tLRPC$TL_chatBannedRights.send_plain && this.defaultBannedRights.embed_links != z11) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoEmbedLinks", C3634R.string.UserRestrictionsNoEmbedLinks));
        }
        ...
        if (z12 && this.defaultBannedRights.invite_users != z12) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoInviteUsers", C3634R.string.UserRestrictionsNoInviteUsers));
        }
        ...
        if (z13 && this.defaultBannedRights.pin_messages != z13) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoPinMessages", C3634R.string.UserRestrictionsNoPinMessages));
        }
        ...
        if (z14 && this.defaultBannedRights.change_info != z14) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoChangeInfo", C3634R.string.UserRestrictionsNoChangeInfo));
        }
        if (sb.length() != 0) {
    ...
    private ArrayList<TLRPC$TL_channels_getParticipants> loadChatParticipantsRequests(int i, int i2, boolean z) {
        ...
        tLRPC$TL_channels_getParticipants.filter.f1601q = "";
        ...
        */
        public /* synthetic */ void lambda$processSearch$2(java.lang.String r24, java.util.ArrayList r25, java.util.ArrayList r26) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChatUsersActivity.SearchAdapter.lambda$processSearch$2(java.lang.String, java.util.ArrayList, java.util.ArrayList):void");
        }
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r14, int r15) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChatUsersActivity.SearchAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
            ...
            switch (i) {
                ...
                case 4:
                    ...
                    if (ChatUsersActivity.this.isChannel) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C3634R.string.NoBlockedChannel2));
                    } else {
                        textInfoPrivacyCell.setText(LocaleController.getString(C3634R.string.NoBlockedGroup2));
                    }
                ...
                default:
                    ...
                    int i5 = C3634R.string.SlowmodeSeconds;
                    int i6 = C3634R.string.SlowmodeMinutes;
                    slideChooseView2.setOptions(i4, LocaleController.getString("SlowmodeOff", C3634R.string.SlowmodeOff), LocaleController.formatString("SlowmodeSeconds", i5, 10), LocaleController.formatString("SlowmodeSeconds", i5, 30), LocaleController.formatString("SlowmodeMinutes", i6, 1), LocaleController.formatString("SlowmodeMinutes", i6, 5), LocaleController.formatString("SlowmodeMinutes", i6, 15), LocaleController.formatString("SlowmodeHours", C3634R.string.SlowmodeHours, 1));
                    ...
                    break;
                case 10:
                    slideChooseView = new LoadingCell(this.mContext, AndroidUtilities.m104dp(40), AndroidUtilities.m104dp(120));
                    break;
                case 11:
                    ...
                    flickerLoadingView.setPaddingLeft(AndroidUtilities.m104dp(5));
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r21, int r22) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChatUsersActivity.ListAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
