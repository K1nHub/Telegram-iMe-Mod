...
public class ChatUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public View createView(Context context) {
        ...
        int i2 = this.type;
        if (i2 == 3) {
            this.actionBar.setTitle(LocaleController.getString("ChannelPermissions", C3632R.string.ChannelPermissions));
        } else if (i2 == 0) {
            this.actionBar.setTitle(LocaleController.getString("ChannelBlacklist", C3632R.string.ChannelBlacklist));
        } else if (i2 == 1) {
            this.actionBar.setTitle(LocaleController.getString("ChannelAdministrators", C3632R.string.ChannelAdministrators));
        } else if (i2 == 2) {
            int i3 = this.selectType;
            if (i3 == 0) {
                if (this.isChannel) {
                    this.actionBar.setTitle(LocaleController.getString("ChannelSubscribers", C3632R.string.ChannelSubscribers));
                } else {
                    this.actionBar.setTitle(LocaleController.getString("ChannelMembers", C3632R.string.ChannelMembers));
                }
            } else if (i3 == 1) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddAdmin", C3632R.string.ChannelAddAdmin));
            } else if (i3 == 2) {
                this.actionBar.setTitle(LocaleController.getString("ChannelBlockUser", C3632R.string.ChannelBlockUser));
            } else if (i3 == 3) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddException", C3632R.string.ChannelAddException));
            }
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3704ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ChatUsersActivity.1
        ...
        if (this.selectType != 0 || (i = this.type) == 2 || i == 0 || i == 3) {
            ...
            ActionBarMenuItem actionBarMenuItemSearchListener = createMenu.addItem(0, C3632R.C3634drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.ChatUsersActivity.2
            ...
            if (this.type == 3) {
                this.searchItem.setSearchFieldHint(LocaleController.getString("ChannelSearchException", C3632R.string.ChannelSearchException));
            } else {
            ...
            if (this.type == 3) {
                this.doneItem = createMenu.addItemWithWidth(1, C3632R.C3634drawable.ic_ab_done, AndroidUtilities.m104dp(56), LocaleController.getString("Done", C3632R.string.Done));
            }
        }
    ...
    */
    ...
    /* loaded from: classes5.dex */
    public class C43638 implements ChatUsersActivityDelegate {
            ...
            if (user != null) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$8$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ChatUsersActivity.C43638.this.lambda$didSelectUser$0(user);
                    }
                }, 200L);
            }
    ...
    /* loaded from: classes5.dex */
    public class C43649 implements GroupCreateActivity.ContactsAddActivityDelegate {
        ...
        C43649(GroupCreateActivity groupCreateActivity) {
        ...
        public void didSelectUsers(ArrayList<TLRPC$User> arrayList, int i) {
            ...
            ChatUsersActivity.this.getMessagesController().addUsersToChat(ChatUsersActivity.this.currentChat, ChatUsersActivity.this, arrayList, i, new Consumer() { // from class: org.telegram.ui.ChatUsersActivity$9$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    ChatUsersActivity.C43649.this.lambda$didSelectUsers$0((TLRPC$User) obj);
                }
            }, new Consumer() { // from class: org.telegram.ui.ChatUsersActivity$9$$ExternalSyntheticLambda1
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    ChatUsersActivity.C43649.lambda$didSelectUsers$1((TLRPC$User) obj);
                }
            }, null);
        }
    ...
    public /* synthetic */ void lambda$createView$0(TextCell textCell, boolean z) {
        ...
        textCell.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(this.currentChat, 13) || ((tLRPC$ChatFull = this.info) != null && tLRPC$ChatFull.antispam && getParticipantsCount() < getMessagesController().telegramAntispamGroupSizeMin)) ? C3632R.C3634drawable.permission_locked : 0);
    ...
    public /* synthetic */ void lambda$createView$2(TextCell textCell, boolean z) {
        ...
        textCell.setChecked(z);
        textCell.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(this.currentChat, 2) || ((tLRPC$ChatFull = this.info) != null && tLRPC$ChatFull.participants_hidden && getParticipantsCount() < getMessagesController().hiddenMembersGroupSizeMin)) ? C3632R.C3634drawable.permission_locked : 0);
        BulletinFactory.m62of(this).createSimpleBulletin(C3632R.raw.error, LocaleController.getString("UnknownError", C3632R.string.UnknownError)).show();
    }
    ...
    /* loaded from: classes5.dex */
    public class DialogC434710 extends GigagroupConvertAlert {
        @Override // org.telegram.p043ui.Components.GigagroupConvertAlert
        protected void onCancel() {
        }

        DialogC434710(Context context, BaseFragment baseFragment) {
        ...
        protected void onCovert() {
            ChatUsersActivity.this.getMessagesController().convertToGigaGroup(ChatUsersActivity.this.getParentActivity(), ChatUsersActivity.this.currentChat, ChatUsersActivity.this, new MessagesStorage.BooleanCallback() { // from class: org.telegram.ui.ChatUsersActivity$10$$ExternalSyntheticLambda0
                ...
                public final void run(boolean z) {
                    ChatUsersActivity.DialogC434710.this.lambda$onCovert$0(z);
                }
            });
        }
    ...
    public boolean createMenuForParticipant(final TLObject tLObject, boolean z, View view) {
        ...
        if (this.type == 2) {
            ...
            ItemOptions addIf = ItemOptions.makeOptions(this, view).setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundWhite))).addIf(z8, C3632R.C3634drawable.msg_admins, z6 ? LocaleController.getString("EditAdminRights", C3632R.string.EditAdminRights) : LocaleController.getString("SetAsAdmin", C3632R.string.SetAsAdmin), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    ChatUsersActivity.lambda$createMenuForParticipant$10(Utilities.Callback.this);
                }
            }).addIf(z10, C3632R.C3634drawable.msg_permissions, LocaleController.getString("ChangePermissions", C3632R.string.ChangePermissions), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda14
                @Override // java.lang.Runnable
                public final void run() {
            ...
            int i6 = C3632R.C3634drawable.msg_remove;
            if (this.isChannel) {
                i3 = C3632R.string.ChannelRemoveUser;
                str3 = "ChannelRemoveUser";
            } else {
                i3 = C3632R.string.KickFromGroup;
                str3 = "KickFromGroup";
            }
        ...
        if (this.type == 3 && ChatObject.canBlockUsers(this.currentChat)) {
            ...
            makeOptions.add(C3632R.C3634drawable.msg_permissions, LocaleController.getString("ChannelEditPermissions", C3632R.string.ChannelEditPermissions), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                    ChatUsersActivity.this.lambda$createMenuForParticipant$14(j5, tLRPC$TL_chatBannedRights3, str4, tLObject);
                }
            });
            makeOptions.add(C3632R.C3634drawable.msg_delete, (CharSequence) LocaleController.getString("ChannelDeleteFromList", C3632R.string.ChannelDeleteFromList), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (ChatObject.canAddUsers(this.currentChat) && i5 > 0) {
                int i7 = C3632R.C3634drawable.msg_contact_add;
                if (this.isChannel) {
                    i2 = C3632R.string.ChannelAddToChannel;
                    str2 = "ChannelAddToChannel";
                } else {
                    i2 = C3632R.string.ChannelAddToGroup;
            ...
            makeOptions.add(C3632R.C3634drawable.msg_delete, (CharSequence) LocaleController.getString("ChannelDeleteFromList", C3632R.string.ChannelDeleteFromList), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (this.currentChat.creator || !(tLObject instanceof TLRPC$TL_channelParticipantCreator)) {
                ...
                makeOptions.add(C3632R.C3634drawable.msg_admins, LocaleController.getString("EditAdminRights", C3632R.string.EditAdminRights), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda11
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            makeOptions.add(C3632R.C3634drawable.msg_remove, (CharSequence) LocaleController.getString("ChannelRemoveUserAdmin", C3632R.string.ChannelRemoveUserAdmin), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$createMenuForParticipant$12(TLObject tLObject, TLRPC$User tLRPC$User, final Utilities.Callback callback) {
        if ((tLObject instanceof TLRPC$TL_channelParticipantAdmin) || (tLObject instanceof TLRPC$TL_chatParticipantAdmin)) {
            showDialog(new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString("AppName", C3632R.string.AppName)).setMessage(LocaleController.formatString("AdminWillBeRemoved", C3632R.string.AdminWillBeRemoved, UserObject.getUserName(tLRPC$User))).setPositiveButton(LocaleController.getString("OK", C3632R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda0
    ...
    public boolean checkDiscard() {
        ...
        builder.setPositiveButton(LocaleController.getString("ApplyTheme", C3632R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                ChatUsersActivity.this.lambda$checkDiscard$23(dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("PassportDiscard", C3632R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public String formatUserPermissions(TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights) {
        ...
        if (z && this.defaultBannedRights.view_messages != z) {
            sb.append(LocaleController.getString("UserRestrictionsNoRead", C3632R.string.UserRestrictionsNoRead));
        }
        if (tLRPC$TL_chatBannedRights.send_messages && this.defaultBannedRights.send_plain != tLRPC$TL_chatBannedRights.send_plain) {
            if (sb.length() != 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("UserRestrictionsNoSendText", C3632R.string.UserRestrictionsNoSendText));
        }
        boolean z2 = tLRPC$TL_chatBannedRights.send_media;
        if (z2 && this.defaultBannedRights.send_media != z2) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendMedia", C3632R.string.UserRestrictionsNoSendMedia));
        } else {
            boolean z3 = tLRPC$TL_chatBannedRights.send_photos;
            if (z3 && this.defaultBannedRights.send_photos != z3) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendPhotos", C3632R.string.UserRestrictionsNoSendPhotos));
            }
            boolean z4 = tLRPC$TL_chatBannedRights.send_videos;
            if (z4 && this.defaultBannedRights.send_videos != z4) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendVideos", C3632R.string.UserRestrictionsNoSendVideos));
            }
            ...
            if (z5 && this.defaultBannedRights.send_audios != z5) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendMusic", C3632R.string.UserRestrictionsNoSendMusic));
            }
            ...
            if (z6 && this.defaultBannedRights.send_docs != z6) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendDocs", C3632R.string.UserRestrictionsNoSendDocs));
            }
            boolean z7 = tLRPC$TL_chatBannedRights.send_voices;
            if (z7 && this.defaultBannedRights.send_voices != z7) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendVoice", C3632R.string.UserRestrictionsNoSendVoice));
            }
            ...
            if (z8 && this.defaultBannedRights.send_roundvideos != z8) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendRound", C3632R.string.UserRestrictionsNoSendRound));
            }
        }
        ...
        if (z9 && this.defaultBannedRights.send_stickers != z9) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendStickers", C3632R.string.UserRestrictionsNoSendStickers));
        }
        ...
        if (z10 && this.defaultBannedRights.send_polls != z10) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendPolls", C3632R.string.UserRestrictionsNoSendPolls));
        }
        ...
        if (z11 && !tLRPC$TL_chatBannedRights.send_plain && this.defaultBannedRights.embed_links != z11) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoEmbedLinks", C3632R.string.UserRestrictionsNoEmbedLinks));
        }
        ...
        if (z12 && this.defaultBannedRights.invite_users != z12) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoInviteUsers", C3632R.string.UserRestrictionsNoInviteUsers));
        }
        ...
        if (z13 && this.defaultBannedRights.pin_messages != z13) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoPinMessages", C3632R.string.UserRestrictionsNoPinMessages));
        }
        ...
        if (z14 && this.defaultBannedRights.change_info != z14) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoChangeInfo", C3632R.string.UserRestrictionsNoChangeInfo));
        }
        if (sb.length() != 0) {
            ...
            switch (i) {
                ...
                case 4:
                    ...
                    if (ChatUsersActivity.this.isChannel) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C3632R.string.NoBlockedChannel2));
                    } else {
                        textInfoPrivacyCell.setText(LocaleController.getString(C3632R.string.NoBlockedGroup2));
                    }
                ...
                default:
                    ...
                    int i5 = C3632R.string.SlowmodeSeconds;
                    int i6 = C3632R.string.SlowmodeMinutes;
                    slideChooseView2.setOptions(i4, LocaleController.getString("SlowmodeOff", C3632R.string.SlowmodeOff), LocaleController.formatString("SlowmodeSeconds", i5, 10), LocaleController.formatString("SlowmodeSeconds", i5, 30), LocaleController.formatString("SlowmodeMinutes", i6, 1), LocaleController.formatString("SlowmodeMinutes", i6, 5), LocaleController.formatString("SlowmodeMinutes", i6, 15), LocaleController.formatString("SlowmodeHours", C3632R.string.SlowmodeHours, 1));
