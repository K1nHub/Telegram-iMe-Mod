...
public class ChatUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public View createView(Context context) {
        ...
        if (this.selectType != 0 || (i = this.type) == 2 || i == 0 || i == 3) {
            ...
            if (this.type == 3) {
                this.doneItem = createMenu.addItemWithWidth(1, C3632R.C3634drawable.ic_ab_done, AndroidUtilities.m107dp(56), LocaleController.getString("Done", C3632R.string.Done));
            }
        }
    ...
    */
    ...
    /* loaded from: classes5.dex */
    public class C43948 implements ChatUsersActivityDelegate {
        ...
        public void didSelectUser(long j) {
            ...
            if (user != null) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$8$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ChatUsersActivity.C43948.this.lambda$didSelectUser$0(user);
                    }
                }, 200L);
            }
            if (ChatUsersActivity.this.participantsMap.get(j) == null) {
                ...
                tLRPC$TL_peerUser.user_id = user.f1751id;
                ...
                ChatUsersActivity.this.participantsMap.put(user.f1751id, tLRPC$TL_channelParticipantAdmin);
                ChatUsersActivity chatUsersActivity = ChatUsersActivity.this;
                chatUsersActivity.sortAdmins(chatUsersActivity.participants);
                ChatUsersActivity.this.updateListAnimated(saveState);
            }
    ...
    /* loaded from: classes5.dex */
    public class C43959 implements GroupCreateActivity.ContactsAddActivityDelegate {
        ...
        C43959(GroupCreateActivity groupCreateActivity) {
        ...
        public void didSelectUsers(ArrayList<TLRPC$User> arrayList, int i) {
            ...
            ChatUsersActivity.this.getMessagesController().addUsersToChat(ChatUsersActivity.this.currentChat, ChatUsersActivity.this, arrayList, i, new Consumer() { // from class: org.telegram.ui.ChatUsersActivity$9$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    ChatUsersActivity.C43959.this.lambda$didSelectUsers$0((TLRPC$User) obj);
                }
            }, new Consumer() { // from class: org.telegram.ui.ChatUsersActivity$9$$ExternalSyntheticLambda1
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    ChatUsersActivity.C43959.lambda$didSelectUsers$1((TLRPC$User) obj);
                }
            }, null);
        }
        ...
        public /* synthetic */ void lambda$didSelectUsers$0(TLRPC$User tLRPC$User) {
            ...
            if (longSparseArray.get(tLRPC$User.f1751id) == null) {
                if (ChatObject.isChannel(ChatUsersActivity.this.currentChat)) {
                    ...
                    tLRPC$TL_peerUser.user_id = tLRPC$User.f1751id;
                    ...
                    longSparseArray.put(tLRPC$User.f1751id, tLRPC$TL_channelParticipant);
                } else {
                    ...
                    longSparseArray.put(tLRPC$User.f1751id, tLRPC$TL_chatParticipant);
                }
            }
        ...
        public void needAddBot(TLRPC$User tLRPC$User) {
            ChatUsersActivity.this.openRightsEdit(tLRPC$User.f1751id, null, null, null, "", true, 0, false);
        }
    }
    ...
    /* loaded from: classes5.dex */
    public class DialogC437810 extends GigagroupConvertAlert {
        @Override // org.telegram.p043ui.Components.GigagroupConvertAlert
        protected void onCancel() {
        }

        DialogC437810(Context context, BaseFragment baseFragment) {
        ...
        protected void onCovert() {
            ChatUsersActivity.this.getMessagesController().convertToGigaGroup(ChatUsersActivity.this.getParentActivity(), ChatUsersActivity.this.currentChat, ChatUsersActivity.this, new MessagesStorage.BooleanCallback() { // from class: org.telegram.ui.ChatUsersActivity$10$$ExternalSyntheticLambda0
                ...
                public final void run(boolean z) {
                    ChatUsersActivity.DialogC437810.this.lambda$onCovert$0(z);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$createView$4(TLRPC$User tLRPC$User, TLObject tLObject, TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights, String str, boolean z, DialogInterface dialogInterface, int i) {
        openRightsEdit(tLRPC$User.f1751id, tLObject, tLRPC$TL_chatAdminRights, tLRPC$TL_chatBannedRights, str, z, this.selectType == 1 ? 0 : 1, false);
    }
    ...
    public void onOwnerChaged(TLRPC$User tLRPC$User) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            TLObject tLObject = longSparseArray.get(tLRPC$User.f1751id);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                default:
                    ...
                    break;
                case 10:
                    slideChooseView = new LoadingCell(this.mContext, AndroidUtilities.m107dp(40), AndroidUtilities.m107dp(120));
                    break;
                case 11:
                    ...
                    flickerLoadingView.setPaddingLeft(AndroidUtilities.m107dp(5));
