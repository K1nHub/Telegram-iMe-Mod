...
public class ChartPickerDelegate {
    ...
    public class CapturesData {
        ...
        public void captured() {
            ...
            this.f1799a.setInterpolator(BaseChartView.INTERPOLATOR);
            this.f1799a.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.ChartPickerDelegate$CapturesData$$ExternalSyntheticLambda0
        ...
        public void uncapture() {
            ValueAnimator valueAnimator = this.f1799a;
    ...
    public boolean uncapture(MotionEvent motionEvent, int i) {
        ...
        if (i == 0) {
            if (this.tryMoveTo) {
                ...
                if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.startTapTime < 300 && Math.sqrt((x * x) + (y * y)) < AndroidUtilities.m104dp(10)) {
