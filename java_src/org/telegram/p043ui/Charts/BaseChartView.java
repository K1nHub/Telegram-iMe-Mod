...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    public static final int SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m105dp(18.0f);
    private static final int BOTTOM_SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m105dp(14.0f);
    public static final int BOTTOM_SIGNATURE_START_ALPHA = AndroidUtilities.m105dp(10.0f);
    protected static final int PICKER_PADDING = AndroidUtilities.m105dp(16.0f);
    private static final int PICKER_CAPTURE_WIDTH = AndroidUtilities.m104dp(24);
    private static final int LANDSCAPE_END_PADDING = AndroidUtilities.m104dp(16);
    private static final int BOTTOM_SIGNATURE_OFFSET = AndroidUtilities.m104dp(10);
    private static final int DP_12 = AndroidUtilities.m104dp(12);
    private static final int DP_6 = AndroidUtilities.m104dp(6);
    private static final int DP_5 = AndroidUtilities.m104dp(5);
    private static final int DP_2 = AndroidUtilities.m104dp(2);
    private static final int DP_1 = AndroidUtilities.m104dp(1);
    ...
    public BaseChartView(Context context) {
        ...
        this.pikerHeight = AndroidUtilities.m104dp(46);
    ...
    public void updateColors() {
        ...
        if (this.legendShowing) {
            ...
            long[] jArr = this.chartData.f1800x;
            if (i < jArr.length) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.landscape) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.displaySize.y - AndroidUtilities.m104dp(56));
        }
    ...
    private void measureSizes() {
        ...
        updateLineSignature();
        this.chartBottom = AndroidUtilities.m105dp(100.0f);
        ...
        if (this.chartData != null) {
            this.bottomSignatureOffset = (int) (AndroidUtilities.m104dp(20) / (this.pickerWidth / this.chartData.f1800x.length));
        }
    ...
    public void drawBottomSignature(Canvas canvas) {
        ...
        while (true) {
            ...
            while (true) {
                if (i6 % i4 == 0 && i6 >= this.chartData.f1800x.length - 1) {
                    break;
                }
                i6++;
                c = 0;
                    ...
                    if (i8 < jArr.length - 1) {
                        ...
                        if (f4 > BitmapDescriptorFactory.HUE_RED) {
                            ...
                            if (f4 <= f5 + f6) {
                                ...
                                canvas.drawText(this.chartData.getDayString(i8), f3, (getMeasuredHeight() - this.chartBottom) + BOTTOM_SIGNATURE_TEXT_HEIGHT + AndroidUtilities.m104dp(3), this.bottomSignaturePaint);
                                i8 += i4;
                                c = 0;
                            }
                        }
    ...
    public void drawSelection(Canvas canvas) {
        ...
        while (true) {
            ...
            if (l.enabled || l.alpha != BitmapDescriptorFactory.HUE_RED) {
                ...
                float measuredHeight = (getMeasuredHeight() - this.chartBottom) - (((l.line.f1802y[this.selectedIndex] - f7) / (this.currentMaxHeight - f7)) * ((getMeasuredHeight() - this.chartBottom) - SIGNATURE_TEXT_HEIGHT));
    ...
    */
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        if (f3 < BitmapDescriptorFactory.HUE_RED) {
            ...
            this.selectedIndex = t.f1800x.length - 1;
        } else {
    ...
    public void moveLegend(float f) {
        ...
        this.legendSignatureView.setData(i, t.f1800x[i], this.lines, false);
    ...
    public void onCheckChanged() {
        ...
        if (this.legendShowing) {
            ...
            int i3 = this.selectedIndex;
            legendSignatureView.setData(i3, this.chartData.f1800x[i3], this.lines, true);
        }
    }
    ...
    public long getSelectedDate() {
        ...
        return this.chartData.f1800x[i];
    }
    ...
    public void selectDate(long j) {
        this.selectedIndex = Arrays.binarySearch(this.chartData.f1800x, j);
        this.legendShowing = true;
        this.legendSignatureView.setVisibility(0);
    ...
    public long getStartDate() {
        return this.chartData.f1800x[this.startXIndex];
    }

    public long getEndDate() {
        return this.chartData.f1800x[this.endXIndex];
    }
    ...
    public static class SharedUiComponents {
        ...
        Bitmap getPickerMaskBitmap(int i, int i2) {
            int i3 = (i + i2) << 10;
            if (i3 != this.f1798k || this.invalidate) {
                ...
                this.canvas.drawRoundRect(this.rectF, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), this.xRefP);
            }
