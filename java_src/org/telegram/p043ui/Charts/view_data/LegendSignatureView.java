...
public class LegendSignatureView extends FrameLayout {
    ...
    public LegendSignatureView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        setPadding(AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8));
        ...
        imageView.setImageResource(C3632R.C3634drawable.ic_chevron_right_black_18dp);
        RadialProgressView radialProgressView = new RadialProgressView(context);
        this.progressView = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.m107dp(12));
        this.progressView.setStrokeWidth(AndroidUtilities.m108dp(0.5f));
        ...
        addView(this.hourTime, LayoutHelper.createFrame(-2, -2, 8388613, 4, 0, 4, 0));
        addView(this.chevron, LayoutHelper.createFrame(18, 18, 8388661, 0, 2, 0, 0));
        addView(this.progressView, LayoutHelper.createFrame(18, 18, 8388661, 0, 2, 0, 0));
        recolor();
    }
    ...
    public void recolor() {
        ...
        this.shadowDrawable = getContext().getResources().getDrawable(C3632R.C3634drawable.stats_tooltip).mutate();
        this.backgroundDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(4), Theme.getColor(Theme.key_dialogBackground, this.resourcesProvider), Theme.getColor(Theme.key_listSelector, this.resourcesProvider), -16777216);
        CombinedDrawable combinedDrawable = new CombinedDrawable(this.shadowDrawable, this.backgroundDrawable, AndroidUtilities.m107dp(3), AndroidUtilities.m107dp(3));
    ...
    public void setData(int i, long j, ArrayList<LineViewData> arrayList, boolean z) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            if (arrayList.get(i3).enabled) {
                i2 += arrayList.get(i3).line.f1808y[i];
            }
        }
        for (int i4 = 0; i4 < length; i4++) {
            ...
            if (!arrayList.get(i4).enabled) {
                ...
                holder.value.setText(formatWholeNumber(line.f1808y[i]));
                ...
                if (this.showPercentage && (textView = holder.percentage) != null) {
                    ...
                    float f = arrayList.get(i4).line.f1808y[i] / i2;
    ...
    public class Holder {
        ...
        Holder(LegendSignatureView legendSignatureView) {
            ...
            linearLayout.setPadding(AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(2));
            if (legendSignatureView.showPercentage) {
                ...
                this.percentage.getLayoutParams().width = AndroidUtilities.m107dp(36);
            ...
            textView2.getLayoutParams().width = AndroidUtilities.m107dp(legendSignatureView.showPercentage ? 80 : 96);
