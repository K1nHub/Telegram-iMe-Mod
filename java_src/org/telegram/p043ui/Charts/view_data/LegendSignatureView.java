...
public class LegendSignatureView extends FrameLayout {
    ...
    public LegendSignatureView(Context context) {
        ...
        imageView.setImageResource(C3634R.C3636drawable.ic_chevron_right_black_18dp);
        RadialProgressView radialProgressView = new RadialProgressView(context);
        this.progressView = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.m104dp(12));
        this.progressView.setStrokeWidth(AndroidUtilities.m105dp(0.5f));
    ...
    public void recolor() {
        ...
        this.shadowDrawable = getContext().getResources().getDrawable(C3634R.C3636drawable.stats_tooltip).mutate();
        this.backgroundDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(4), Theme.getColor(Theme.key_dialogBackground), Theme.getColor(Theme.key_listSelector), -16777216);
        CombinedDrawable combinedDrawable = new CombinedDrawable(this.shadowDrawable, this.backgroundDrawable, AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(3));
    ...
    public void setData(int i, long j, ArrayList<LineViewData> arrayList, boolean z) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            if (arrayList.get(i3).enabled) {
                i2 += arrayList.get(i3).line.f1802y[i];
            }
        }
        for (int i4 = 0; i4 < length; i4++) {
            ...
            if (!arrayList.get(i4).enabled) {
                ...
                holder.value.setText(formatWholeNumber(line.f1802y[i]));
                ...
                if (this.showPercentage && (textView = holder.percentage) != null) {
                    ...
                    float f = arrayList.get(i4).line.f1802y[i] / i2;
    ...
    public class Holder {
        ...
        Holder(LegendSignatureView legendSignatureView) {
            ...
            linearLayout.setPadding(AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(2));
            if (legendSignatureView.showPercentage) {
                ...
                this.percentage.getLayoutParams().width = AndroidUtilities.m104dp(36);
            ...
            textView2.getLayoutParams().width = AndroidUtilities.m104dp(legendSignatureView.showPercentage ? 80 : 96);
