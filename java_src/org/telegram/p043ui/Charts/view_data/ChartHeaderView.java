...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C3634R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3634R.C3636drawable.msg_zoomout_stats);
        ...
        this.back.setCompoundDrawablePadding(AndroidUtilities.m104dp(4));
        this.back.setPadding(AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(4));
    ...
    public void zoomTo(BaseChartView baseChartView, long j, boolean z) {
        ...
        if (z) {
            ...
            this.back.setPivotY(AndroidUtilities.m104dp(40));
