...
public class PieChartView extends StackLinearChartView<PieChartViewData> {
    ...
    public PieChartView(Context context) {
        ...
        this.MIN_TEXT_SIZE = AndroidUtilities.m107dp(9);
        this.MAX_TEXT_SIZE = AndroidUtilities.m107dp(13);
    ...
    protected void drawChart(Canvas canvas) {
        ...
        this.rectF.set(this.chartArea.centerX() - height, (this.chartArea.centerY() + AndroidUtilities.m107dp(16)) - height, this.chartArea.centerX() + height, this.chartArea.centerY() + AndroidUtilities.m107dp(16) + height);
                ...
                if (f17 != f7) {
                    ...
                    if (((PieChartViewData) this.lines.get(i8)).selectionA > f7) {
                        ...
                        if (canvas3 != null) {
                            ...
                            i4 = i6;
                            canvas3.translate((float) (Math.cos(Math.toRadians(d)) * AndroidUtilities.m107dp(8) * d2), (float) (Math.sin(Math.toRadians(d)) * AndroidUtilities.m107dp(8) * d2));
            ...
            while (i10 < size) {
                if (((PieChartViewData) this.lines.get(i10)).alpha > BitmapDescriptorFactory.HUE_RED || ((PieChartViewData) this.lines.get(i10)).enabled) {
                    ...
                    if (((PieChartViewData) this.lines.get(i10)).selectionA > BitmapDescriptorFactory.HUE_RED) {
                        ...
                        canvas3.translate((float) (Math.cos(Math.toRadians(d3)) * AndroidUtilities.m107dp(i2) * interpolation2), (float) (Math.sin(Math.toRadians(d3)) * AndroidUtilities.m107dp(i2) * interpolation2));
                    }
            ...
            while (i4 < length) {
                ...
                while (i6 < size) {
                    ...
                    if (z || lineViewData.alpha != BitmapDescriptorFactory.HUE_RED) {
                        float f6 = lineViewData.line.f1808y[i4] * lineViewData.alpha;
                        f5 += f6;
                ...
                while (i9 < size) {
                    ...
                    if (lineViewData2.enabled || lineViewData2.alpha != f4) {
                        int[] iArr = lineViewData2.line.f1808y;
                        if (i7 == i5) {
                            if (iArr[i4] != 0) {
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        float degrees = (float) (Math.toDegrees(Math.atan2((this.chartArea.centerY() + AndroidUtilities.m107dp(16)) - i2, this.chartArea.centerX() - i)) - 90.0d);
        ...
        if (this.currentSelection != i3 && i3 >= 0) {
            ...
            if (this.pieLegendView.getMeasuredWidth() + min > getMeasuredWidth() - AndroidUtilities.m107dp(16)) {
                min -= (this.pieLegendView.getMeasuredWidth() + min) - (getMeasuredWidth() - AndroidUtilities.m107dp(16));
            }
            int min2 = ((int) Math.min(this.rectF.centerY(), (int) Math.min(this.rectF.centerY() + (Math.sin(Math.toRadians(d2)) * width), this.rectF.centerY() + (width * Math.sin(Math.toRadians(d)))))) - AndroidUtilities.m107dp(50);
    ...
    public void updatePicker(ChartData chartData, long j) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (j2 >= chartData.f1806x[i2]) {
                i = i2;
            }
        }
        float length2 = chartData.xPercentage.length < 2 ? 0.5f : 1.0f / chartData.f1806x.length;
        if (i == 0) {
            ChartPickerDelegate chartPickerDelegate = this.pickerDelegate;
            chartPickerDelegate.pickerStart = BitmapDescriptorFactory.HUE_RED;
            chartPickerDelegate.pickerEnd = length2;
        } else if (i >= chartData.f1806x.length - 1) {
    ...
    private void updateCharValues(float f, float f2, boolean z) {
        ...
        while (i3 <= i2) {
            for (int i6 = 0; i6 < size; i6++) {
                ...
                fArr[i6] = fArr[i6] + ((StackLinearChartData) this.chartData).lines.get(i6).f1808y[i3];
                this.sum += ((StackLinearChartData) this.chartData).lines.get(i6).f1808y[i3];
                if (this.isEmpty && ((PieChartViewData) this.lines.get(i6)).enabled && ((StackLinearChartData) this.chartData).lines.get(i6).f1808y[i3] > 0) {
                    this.isEmpty = false;
                }
            }
            i3++;
