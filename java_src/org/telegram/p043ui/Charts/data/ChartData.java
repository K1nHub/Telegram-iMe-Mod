    ...
    public ChartData(JSONObject jSONObject) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONArray2.getString(0).equals("x")) {
                ...
                this.f1689x = new long[length];
                int i2 = 0;
                while (i2 < length) {
                    int i3 = i2 + 1;
                    this.f1689x[i2] = jSONArray2.getLong(i3);
                    i2 = i3;
                }
            } else {
                ...
                line.f1690id = jSONArray2.getString(0);
                line.f1691y = new int[length2];
                int i4 = 0;
                while (i4 < length2) {
                    int i5 = i4 + 1;
                    line.f1691y[i4] = jSONArray2.getInt(i5);
                    int[] iArr = line.f1691y;
        ...
        for (int i6 = 0; i6 < this.lines.size(); i6++) {
            ...
            if (optJSONObject != null) {
                Matcher matcher = compile.matcher(optJSONObject.getString(line2.f1690id));
                if (matcher.matches()) {
            ...
            if (optJSONObject2 != null) {
                line2.name = optJSONObject2.getString(line2.f1690id);
            }
        }
    }
    ...
    public void measure() {
        ...
        if (length == 1) {
            ...
            for (int i = 0; i < length; i++) {
                this.xPercentage[i] = ((float) (this.f1689x[i] - j)) / ((float) (j2 - j));
            }
        }
        for (int i2 = 0; i2 < this.lines.size(); i2++) {
            ...
            this.lines.get(i2).segmentTree = new SegmentTree(this.lines.get(i2).f1691y);
        }
