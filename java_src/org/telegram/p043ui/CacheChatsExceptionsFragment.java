...
/* renamed from: org.telegram.ui.CacheChatsExceptionsFragment */
...
public class CacheChatsExceptionsFragment extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.CacheChatsExceptionsFragment.1
        ...
        this.actionBar.setTitle(LocaleController.getString(C3473R.string.NotificationsExceptions));
    ...
    public /* synthetic */ void lambda$createView$3(View view, int i, float f, float f2) {
        if (this.items.get(i).viewType == 1) {
            ...
            AlertDialog create = AlertsCreator.createSimpleAlert(getContext(), LocaleController.getString("NotificationsDeleteAllExceptionTitle", C3473R.string.NotificationsDeleteAllExceptionTitle), LocaleController.getString("NotificationsDeleteAllExceptionAlert", C3473R.string.NotificationsDeleteAllExceptionAlert), LocaleController.getString("Delete", C3473R.string.Delete), new Runnable() { // from class: org.telegram.ui.CacheChatsExceptionsFragment$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ void lambda$showPopupFor$5(final CacheByChatsController.KeepMediaException keepMediaException) {
        ...
        if (findViewHolderForAdapterPosition != null) {
            ...
            keepMediaPopupView.setParentWindow(AlertsCreator.createSimplePopup(this, keepMediaPopupView, findViewHolderForAdapterPosition.itemView, view.getMeasuredWidth() / 2.0f, findViewHolderForAdapterPosition.itemView.getMeasuredHeight() / 2.0f));
    ...
    public boolean onFragmentCreate() {
        this.currentType = getArguments().getInt(SessionDescription.ATTR_TYPE);
        updateRows();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.CacheChatsExceptionsFragment$Adapter */
    /* loaded from: classes3.dex */
    public class Adapter extends AdapterWithDiffUtils {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                textCell.setTextAndIcon(LocaleController.getString("NotificationsAddAnException", C3473R.string.NotificationsAddAnException), C3473R.C3475drawable.msg_contact_add, true);
                ...
                textCell2.setText(LocaleController.getString("NotificationsDeleteAllException", C3473R.string.NotificationsDeleteAllException), false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            if (CacheChatsExceptionsFragment.this.items.get(i).viewType == 2) {
                ...
                if (userOrChat instanceof TLRPC$User) {
                    ...
                    if (tLRPC$User.self) {
                        str = LocaleController.getString("SavedMessages", C3473R.string.SavedMessages);
                    } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.CacheChatsExceptionsFragment$Item */
    /* loaded from: classes3.dex */
