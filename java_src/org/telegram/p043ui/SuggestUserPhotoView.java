...
public class SuggestUserPhotoView extends View {
    ...
    public void draw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - AndroidUtilities.m104dp(30);
        int m104dp = AndroidUtilities.m104dp(46) + measuredWidth;
        setImageCoords(this.currentPhoto, measuredWidth - AndroidUtilities.m104dp(46), measuredHeight);
        setImageCoords(this.newPhoto, m104dp, measuredHeight);
        ...
        this.path.reset();
        this.path.addCircle(m104dp, measuredHeight, AndroidUtilities.m104dp(30), Path.Direction.CW);
        ...
        if (this.containterView != null) {
            ...
            float m104dp2 = AndroidUtilities.m104dp(60) / cropAreaView.size;
            float f = left - cropAreaView.left;
            canvas.save();
            canvas.clipPath(this.path);
            canvas.scale(m104dp2, m104dp2, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED);
            canvas.translate(f, top - cropAreaView.top);
            canvas.translate((m104dp - AndroidUtilities.m104dp(30)) / m104dp2, (measuredHeight - AndroidUtilities.m104dp(30)) / m104dp2);
    ...
    private void setImageCoords(ImageReceiver imageReceiver, int i, int i2) {
        imageReceiver.setImageCoords(i - AndroidUtilities.m104dp(30), i2 - AndroidUtilities.m104dp(30), AndroidUtilities.m104dp(60), AndroidUtilities.m104dp(60));
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        this.currentPhoto.setRoundRadius(AndroidUtilities.m104dp(30));
        this.newPhoto.setRoundRadius(AndroidUtilities.m104dp(30));
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(86), 1073741824));
    }
