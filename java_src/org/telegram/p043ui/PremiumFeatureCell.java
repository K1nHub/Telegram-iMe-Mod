...
public class PremiumFeatureCell extends FrameLayout {
    ...
    public void setCheckBoxVisible(boolean z) {
        ((ViewGroup.MarginLayoutParams) this.titleSubtitleContainer.getLayoutParams()).rightMargin = this.initialTitleSubtitleContainerLeftMargin + (z ? AndroidUtilities.m104dp(22) : 0);
    ...
    public PremiumFeatureCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView2.setImageResource(C3634R.C3636drawable.msg_arrowright);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.drawDivider) {
            canvas.drawRect(AndroidUtilities.m104dp(62), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), Theme.dividerPaint);
        }
    }
}
