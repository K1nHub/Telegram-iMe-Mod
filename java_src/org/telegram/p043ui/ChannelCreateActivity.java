...
public class ChannelCreateActivity extends JavaMvpFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C41691());
        ...
        if (i4 == 0) {
                ...
                */
                public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                    ...
                    Lcf:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChannelCreateActivity.C41712.onLayout(boolean, int, int, int, int):void");
                }
            ...
            this.cameraDrawable = new RLottieDrawable(i6, "" + i6, AndroidUtilities.m107dp(60), AndroidUtilities.m107dp(60), false, null);
            ...
            this.descriptionTextView.setPadding(0, 0, 0, AndroidUtilities.m107dp(6));
            ...
            this.descriptionTextView.setCursorSize(AndroidUtilities.m107dp(20));
            ...
            this.checkTextView.setPadding(AndroidUtilities.m107dp(3), 0, AndroidUtilities.m107dp(3), 0);
    ...
    /* loaded from: classes5.dex */
    public class C41691 extends C3704ActionBar.ActionBarMenuOnItemClick {
        C41691() {
        }
                            ...
                            if (ChannelCreateActivity.this.descriptionTextView.length() != 0) {
                                if (ChannelCreateActivity.this.lastNameAvailable) {
                                    ...
                                    messagesController.updateChannelUserName(channelCreateActivity, channelCreateActivity.chatId, ChannelCreateActivity.this.lastCheckName, new Runnable() { // from class: org.telegram.ui.ChannelCreateActivity$1$$ExternalSyntheticLambda0
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            ChannelCreateActivity.C41691.this.lambda$onItemClick$0();
                                        }
                                    }, new Runnable() { // from class: org.telegram.ui.ChannelCreateActivity$1$$ExternalSyntheticLambda1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            ChannelCreateActivity.C41691.this.lambda$onItemClick$1();
                                        }
                                    });
                                } else {
