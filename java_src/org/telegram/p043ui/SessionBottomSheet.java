...
public class SessionBottomSheet extends BottomSheet {
    ...
    public SessionBottomSheet(BaseFragment baseFragment, final TLRPC$TL_authorization tLRPC$TL_authorization, boolean z, Callback callback) {
        ...
        if (!z) {
            ...
            textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(6), Theme.getColor(Theme.key_chat_attachAudioBackground), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhite), 120)));
            linearLayout.addView(textView3, LayoutHelper.createFrame(-1, 48, 0, 16, 15, 16, 16));
            textView3.setOnClickListener(new View$OnClickListenerC71618(callback, tLRPC$TL_authorization, baseFragment));
        }
    ...
    /* loaded from: classes5.dex */
    public class View$OnClickListenerC71618 implements View.OnClickListener {
        final /* synthetic */ Callback val$callback;
        final /* synthetic */ BaseFragment val$fragment;
        final /* synthetic */ TLRPC$TL_authorization val$session;

        View$OnClickListenerC71618(Callback callback, TLRPC$TL_authorization tLRPC$TL_authorization, BaseFragment baseFragment) {
        ...
        public void onClick(View view) {
            ...
            builder.setPositiveButton(string, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.SessionBottomSheet$8$$ExternalSyntheticLambda0
                ...
                public final void onClick(DialogInterface dialogInterface, int i) {
                    SessionBottomSheet.View$OnClickListenerC71618.this.lambda$onClick$0(callback, tLRPC$TL_authorization, dialogInterface, i);
                }
            });
    ...
    public /* synthetic */ void lambda$copyText$1(String str, DialogInterface dialogInterface, int i) {
        ...
        BulletinFactory.m66of(getContainer(), null).createCopyBulletin(LocaleController.getString("TextCopied", C3632R.string.TextCopied)).show();
    }
    ...
    */
    ...
    private static class ItemView extends FrameLayout {
        ...
        public ItemView(Context context, boolean z) {
            ...
            setPadding(0, AndroidUtilities.m107dp(4), 0, AndroidUtilities.m107dp(4));
            if (z) {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.needDivider) {
                canvas.drawRect(AndroidUtilities.m107dp(64), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), Theme.dividerPaint);
            }
        }
