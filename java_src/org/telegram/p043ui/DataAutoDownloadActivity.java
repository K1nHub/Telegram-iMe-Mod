...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnMobileData", C3473R.string.AutoDownloadOnMobileData));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnWiFiData", C3473R.string.AutoDownloadOnWiFiData));
        } else if (i == 2) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnRoamingData", C3473R.string.AutoDownloadOnRoamingData));
        }
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.DataAutoDownloadActivity.1
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == DataAutoDownloadActivity.this.autoDownloadRow) {
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getString("AutoDownloadMedia", C3473R.string.AutoDownloadMedia), DataAutoDownloadActivity.this.typePreset.enabled, false);
                ...
                if (i != DataAutoDownloadActivity.this.usageHeaderRow) {
                    if (i == DataAutoDownloadActivity.this.typeHeaderRow) {
                        headerCell.setText(LocaleController.getString("AutoDownloadTypes", C3473R.string.AutoDownloadTypes));
                        return;
                    }
                    return;
                }
                headerCell.setText(LocaleController.getString("AutoDownloadDataUsage", C3473R.string.AutoDownloadDataUsage));
                ...
                if (itemViewType != 4) {
                                ...
                                if (DataAutoDownloadActivity.this.currentType != 0) {
                                    if (DataAutoDownloadActivity.this.currentType != 1) {
                                        if (DataAutoDownloadActivity.this.currentType == 2) {
                                            textInfoPrivacyCell.setText(LocaleController.getString("AutoDownloadOnRoamingDataInfo", C3473R.string.AutoDownloadOnRoamingDataInfo));
                                        }
                                    } else {
                                        textInfoPrivacyCell.setText(LocaleController.getString("AutoDownloadOnWiFiDataInfo", C3473R.string.AutoDownloadOnWiFiDataInfo));
                                    }
                                } else {
                                    textInfoPrivacyCell.setText(LocaleController.getString("AutoDownloadOnMobileDataInfo", C3473R.string.AutoDownloadOnMobileDataInfo));
                                }
                    ...
                    textInfoPrivacyCell.setText(LocaleController.getString("AutoDownloadAudioInfo", C3473R.string.AutoDownloadAudioInfo));
                    textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                ...
                if (i != DataAutoDownloadActivity.this.photosRow) {
                    if (i != DataAutoDownloadActivity.this.videosRow) {
                        if (i == DataAutoDownloadActivity.this.storiesRow) {
                            string = LocaleController.getString("AutoDownloadStories", C3473R.string.AutoDownloadStories);
                            notificationsCheckCell.setDrawLine(false);
                        } else {
                            string = LocaleController.getString("AutoDownloadFiles", C3473R.string.AutoDownloadFiles);
                            i3 = 8;
                        }
                        str = string;
                    } else {
                        str = LocaleController.getString("AutoDownloadVideos", C3473R.string.AutoDownloadVideos);
                        i3 = 4;
                    }
                } else {
                    str = LocaleController.getString("AutoDownloadPhotos", C3473R.string.AutoDownloadPhotos);
                    i3 = 1;
                }
                ...
                if (i != DataAutoDownloadActivity.this.storiesRow) {
                    ...
                    while (true) {
                        ...
                        if ((iArr[i4] & i3) != 0) {
                            ...
                            if (i4 == 0) {
                                sb3.append(LocaleController.getString("AutoDownloadContacts", C3473R.string.AutoDownloadContacts));
                            } else if (i4 == 1) {
                                sb3.append(LocaleController.getString("AutoDownloadPm", C3473R.string.AutoDownloadPm));
                            } else if (i4 == 2) {
                                sb3.append(LocaleController.getString("AutoDownloadGroups", C3473R.string.AutoDownloadGroups));
                            } else if (i4 == 3) {
                                sb3.append(LocaleController.getString("AutoDownloadChannels", C3473R.string.AutoDownloadChannels));
                            }
                            i2++;
                        }
                        i4++;
                    ...
                    if (i2 == 4) {
                        sb3.setLength(0);
                        if (i == DataAutoDownloadActivity.this.photosRow) {
                            sb3.append(LocaleController.getString("AutoDownloadOnAllChats", C3473R.string.AutoDownloadOnAllChats));
                        } else {
                            sb3.append(LocaleController.formatString("AutoDownloadUpToOnAllChats", C3473R.string.AutoDownloadUpToOnAllChats, AndroidUtilities.formatFileSize(j)));
                        }
                    } else if (i2 != 0) {
                        if (i == DataAutoDownloadActivity.this.photosRow) {
                            sb = new StringBuilder(LocaleController.formatString("AutoDownloadOnFor", C3473R.string.AutoDownloadOnFor, sb3.toString()));
                        } else {
                            sb = new StringBuilder(LocaleController.formatString("AutoDownloadOnUpToFor", C3473R.string.AutoDownloadOnUpToFor, AndroidUtilities.formatFileSize(j), sb3.toString()));
                        }
                        sb2 = sb;
                    } else {
                        sb3.append(LocaleController.getString("AutoDownloadOff", C3473R.string.AutoDownloadOff));
                    }
                    sb2 = sb3;
                } else if (currentMobilePreset.preloadStories) {
                    sb2 = new StringBuilder(LocaleController.formatString("AutoDownloadOn", C3473R.string.AutoDownloadOn, sb3.toString()));
                    i2 = 1;
                } else {
                    sb = new StringBuilder(LocaleController.formatString("AutoDownloadOff", C3473R.string.AutoDownloadOff, sb3.toString()));
                    sb2 = sb;
                }
    ...
    public void updatePresetChoseView(SlideChooseView slideChooseView) {
        ...
        for (int i = 0; i < this.presets.size(); i++) {
            ...
            if (preset == this.lowPreset) {
                strArr[i] = LocaleController.getString("AutoDownloadLow", C3473R.string.AutoDownloadLow);
            } else if (preset == this.mediumPreset) {
                strArr[i] = LocaleController.getString("AutoDownloadMedium", C3473R.string.AutoDownloadMedium);
            } else if (preset == this.highPreset) {
                strArr[i] = LocaleController.getString("AutoDownloadHigh", C3473R.string.AutoDownloadHigh);
            } else {
                strArr[i] = LocaleController.getString("AutoDownloadCustom", C3473R.string.AutoDownloadCustom);
            }
        }
