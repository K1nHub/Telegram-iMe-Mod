...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, final PopupSwipeBackLayout popupSwipeBackLayout, final Callback callback) {
        ...
        ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3473R.C3475drawable.msg_arrow_back, LocaleController.getString("Back", C3473R.string.Back), false, null);
        ...
        ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3473R.C3475drawable.msg_speed_0_2, LocaleController.getString("SpeedVerySlow", C3473R.string.SpeedVerySlow), false, null);
        ...
        ActionBarMenuSubItem addItem3 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3473R.C3475drawable.msg_speed_slow, LocaleController.getString("SpeedSlow", C3473R.string.SpeedSlow), false, null);
        ...
        ActionBarMenuSubItem addItem4 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3473R.C3475drawable.msg_speed_normal, LocaleController.getString("SpeedNormal", C3473R.string.SpeedNormal), false, null);
        ...
        ActionBarMenuSubItem addItem5 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3473R.C3475drawable.msg_speed_fast, LocaleController.getString("SpeedFast", C3473R.string.SpeedFast), false, null);
        ...
        ActionBarMenuSubItem addItem6 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C3473R.C3475drawable.msg_speed_superfast, LocaleController.getString("SpeedVeryFast", C3473R.string.SpeedVeryFast), false, null);
