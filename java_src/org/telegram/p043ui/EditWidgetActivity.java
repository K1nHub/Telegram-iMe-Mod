...
public class EditWidgetActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        ...
        this.listView.setOnItemLongClickListener(new C60622());
    ...
    /* loaded from: classes5.dex */
    public class C60622 implements RecyclerListView.OnItemLongClickListenerExtended {
                ...
                if (!this.rect.contains((int) f, (int) f2)) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString("Delete", C3632R.string.Delete)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.EditWidgetActivity$2$$ExternalSyntheticLambda0
                        ...
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                            EditWidgetActivity.C60622.this.lambda$onItemClick$0(i, dialogInterface, i2);
                        }
                    });
