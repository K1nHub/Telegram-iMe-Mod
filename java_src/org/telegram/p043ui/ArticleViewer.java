...
public class ArticleViewer implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class DrawingText implements TextSelectionHelper.TextLayoutBlock {
        ...
        public void draw(Canvas canvas, View view) {
            ...
            if (ArticleViewer.this.pressedLinkOwnerLayout == this && ArticleViewer.this.pressedLink == null && ArticleViewer.this.drawBlockSelection) {
                ...
                canvas.drawRect((-AndroidUtilities.m107dp(2)) + f, BitmapDescriptorFactory.HUE_RED, f + width + AndroidUtilities.m107dp(2), getHeight(), ArticleViewer.urlPaint);
            }
    ...
    public class TextSizeCell extends FrameLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText("" + SharedConfig.ivFontSize, getMeasuredWidth() - AndroidUtilities.m107dp(39), AndroidUtilities.m107dp(28), this.textPaint);
        }
    ...
    public class WindowView extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            ArticleViewer.this.menuButton.setAdditionalYOffset(((-(ArticleViewer.this.currentHeaderHeight - AndroidUtilities.m107dp(56))) / 2) + (i3 < 21 ? AndroidUtilities.statusBarHeight : 0));
            ArticleViewer.this.keyboardVisible = size2 < AndroidUtilities.displaySize.y - AndroidUtilities.m107dp(100);
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (Build.VERSION.SDK_INT < 21 || ArticleViewer.this.lastInsets == null) {
                ...
                if (windowInsets.getSystemWindowInsetRight() != 0) {
                    ...
                    this.f1792bX = 0;
                    this.f1793bY = (i4 - i2) - this.bHeight;
                }
        ...
        protected boolean drawChild(Canvas canvas, View view, long j) {
            ...
            if (i != 0 && view == ArticleViewer.this.containerView) {
                ...
                float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(f / AndroidUtilities.m107dp(20), 1.0f));
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            int i2 = this.f1792bX;
            if (i2 == 0 && (i = this.f1793bY) == 0) {
                canvas.drawRect(i2, i, i2 + this.bWidth, i + this.bHeight, this.blackPaint);
            } else {
                canvas.drawRect(i2 - getTranslationX(), this.f1793bY, (this.f1792bX + this.bWidth) - getTranslationX(), this.f1793bY + this.bHeight, this.blackPaint);
            }
        }
    ...
    public class CheckForLongPress implements Runnable {
        ...
        public void run() {
            ...
            int m107dp = (iArr[1] + ArticleViewer.this.pressedLayoutY) - AndroidUtilities.m107dp(54);
            if (m107dp < 0) {
                m107dp = 0;
            }
            ArticleViewer.this.pressedLinkOwnerView.invalidate();
            ...
            articleViewer5.showPopup(articleViewer5.pressedLinkOwnerView, 48, 0, m107dp);
    ...
    private void createPaint(boolean z) {
        if (quoteLinePaint == null) {
            ...
            tableLinePaint.setStrokeWidth(AndroidUtilities.m107dp(1));
            Paint paint2 = new Paint();
            tableHalfLinePaint = paint2;
            paint2.setStyle(Paint.Style.STROKE);
            tableHalfLinePaint.setStrokeWidth(AndroidUtilities.m107dp(1) / 2.0f);
    ...
    public void showPopup(View view, int i, int i2, int i3) {
        ...
        if (this.popupLayout == null) {
            ...
            actionBarPopupWindowLayout.setPadding(AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1));
            ...
            this.deleteView.setPadding(AndroidUtilities.m107dp(20), 0, AndroidUtilities.m107dp(20), 0);
            ...
            this.popupTranslateButton.setPadding(AndroidUtilities.m107dp(20), 0, AndroidUtilities.m107dp(20), 0);
    ...
    public void updateInterfaceForCurrentPage(TLRPC$WebPage tLRPC$WebPage, boolean z, int i) {
        ...
        if (!z && i != 0) {
            ...
            if (i == 1) {
                this.pageSwitchAnimation.playTogether(ObjectAnimator.ofFloat(this.listView[0], View.TRANSLATION_X, AndroidUtilities.m107dp(56), BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.listView[0], View.ALPHA, BitmapDescriptorFactory.HUE_RED, 1.0f));
            } else if (i == -1) {
                this.listView[0].setAlpha(1.0f);
                this.listView[0].setTranslationX(BitmapDescriptorFactory.HUE_RED);
                this.pageSwitchAnimation.playTogether(ObjectAnimator.ofFloat(this.listView[1], View.TRANSLATION_X, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(56)), ObjectAnimator.ofFloat(this.listView[1], View.ALPHA, 1.0f, BitmapDescriptorFactory.HUE_RED));
            }
        ...
        if (this.pagesStack.size() == 1 || i == -1) {
            ...
            String str2 = "article" + tLRPC$WebPage2.f1760id;
            int i4 = sharedPreferences.getInt(str2, -1);
            boolean z2 = sharedPreferences.getBoolean(str2 + "r", true);
            Point point = AndroidUtilities.displaySize;
            if (z2 == (point.x > point.y)) {
                m107dp = sharedPreferences.getInt(str2 + "o", 0) - this.listView[z ? 1 : 0].getPaddingTop();
            } else {
                m107dp = AndroidUtilities.m107dp(10);
            }
            if (i4 != -1) {
                this.layoutManager[z ? 1 : 0].scrollToPositionWithOffset(i4, m107dp);
            }
        } else {
    ...
    private boolean scrollToAnchor(String str) {
        ...
        if (num2 != null) {
            ...
            if (tLRPC$TL_textAnchor != null) {
                ...
                linearLayout.addView(textView, new LinearLayout.LayoutParams(-1, AndroidUtilities.m107dp(48) + 1));
                ...
                FrameLayout frameLayout = new FrameLayout(this.parentActivity) { // from class: org.telegram.ui.ArticleViewer.5
                    ...
                    protected void onMeasure(int i, int i2) {
                        super.onMeasure(i, i2);
                        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(linearLayout.getMeasuredHeight() + AndroidUtilities.m107dp(8), 1073741824));
                    }
                };
                ...
                this.layoutManager[0].scrollToPositionWithOffset(num2.intValue(), (this.currentHeaderHeight - AndroidUtilities.m107dp(56)) - num.intValue());
            }
            return true;
        }
        return false;
            ...
            if (tLRPC$RichText2 instanceof TLRPC$TL_textConcat) {
                ...
                if (tLRPC$RichText2 instanceof TLRPC$TL_textMarked) {
                    ...
                    if (documentWithId != null) {
                        ...
                        int m107dp = AndroidUtilities.m107dp(tLRPC$TL_textImage.f1738w);
                        int m107dp2 = AndroidUtilities.m107dp(tLRPC$TL_textImage.f1737h);
                        int abs = Math.abs(i);
                        if (m107dp > abs) {
                            i2 = (int) (m107dp2 * (abs / m107dp));
                            i3 = abs;
                        } else {
                            i2 = m107dp2;
                            i3 = m107dp;
    ...
    private TextPaint getTextPaint(TLRPC$RichText tLRPC$RichText, TLRPC$RichText tLRPC$RichText2, TLRPC$PageBlock tLRPC$PageBlock) {
        ...
        int m107dp8 = AndroidUtilities.m107dp(14);
        int m107dp9 = AndroidUtilities.m107dp(SharedConfig.ivFontSize - 16);
        ...
        if (tLRPC$PageBlock instanceof TLRPC$TL_pageBlockPhoto) {
            ...
            if (tLRPC$RichText3 == tLRPC$RichText2 || tLRPC$RichText3 == tLRPC$RichText) {
                ...
                m107dp7 = AndroidUtilities.m107dp(14);
            } else {
                sparseArray7 = photoCreditTextPaints;
                m107dp7 = AndroidUtilities.m107dp(12);
            }
            ...
            if (tLRPC$RichText4 == tLRPC$RichText2 || tLRPC$RichText4 == tLRPC$RichText) {
                ...
                m107dp6 = AndroidUtilities.m107dp(14);
            } else {
                sparseArray6 = photoCreditTextPaints;
                m107dp6 = AndroidUtilities.m107dp(12);
            }
            ...
            m107dp8 = AndroidUtilities.m107dp(20);
            textColor = getTextColor();
            ...
            m107dp8 = AndroidUtilities.m107dp(17);
            textColor = getTextColor();
        } else if (tLRPC$PageBlock instanceof TLRPC$TL_pageBlockBlockquote) {
            ...
            if (tLRPC$TL_pageBlockBlockquote.text == tLRPC$RichText) {
                ...
                m107dp8 = AndroidUtilities.m107dp(15);
                textColor = getTextColor();
            } else {
            ...
            m107dp8 = AndroidUtilities.m107dp(16);
            textColor = getTextColor();
            ...
            if (tLRPC$RichText5 == tLRPC$RichText2 || tLRPC$RichText5 == tLRPC$RichText) {
                ...
                m107dp5 = AndroidUtilities.m107dp(14);
            } else {
                sparseArray5 = photoCreditTextPaints;
                m107dp5 = AndroidUtilities.m107dp(12);
            }
            ...
            if (tLRPC$RichText6 == tLRPC$RichText2 || tLRPC$RichText6 == tLRPC$RichText) {
                ...
                m107dp4 = AndroidUtilities.m107dp(14);
            } else {
                sparseArray4 = photoCreditTextPaints;
                m107dp4 = AndroidUtilities.m107dp(12);
            }
            ...
            if (tLRPC$RichText7 == tLRPC$RichText2 || tLRPC$RichText7 == tLRPC$RichText) {
                ...
                m107dp3 = AndroidUtilities.m107dp(14);
            } else {
                sparseArray3 = photoCreditTextPaints;
                m107dp3 = AndroidUtilities.m107dp(12);
            }
            ...
            if (tLRPC$RichText2 == tLRPC$TL_pageCaption.text) {
                ...
                m107dp8 = AndroidUtilities.m107dp(12);
                textColor = getGrayTextColor();
            } else {
                if (tLRPC$RichText2 != null) {
            ...
            if (tLRPC$RichText2 == ((TLRPC$TL_pageBlockVideo) tLRPC$PageBlock).caption.text) {
                ...
                m107dp2 = AndroidUtilities.m107dp(14);
            } else {
            ...
            if (tLRPC$RichText2 == ((TLRPC$TL_pageBlockAudio) tLRPC$PageBlock).caption.text) {
                ...
                m107dp = AndroidUtilities.m107dp(14);
            } else {
                sparseArray = mediaCreditTextPaints;
                m107dp = AndroidUtilities.m107dp(12);
            }
        ...
        if (i != 0 || (textFlags & 128) != 0) {
            m107dp8 -= AndroidUtilities.m107dp(4);
        }
        if (sparseArray8 == null) {
            ...
            errorTextPaint.setTextSize(AndroidUtilities.m107dp(14));
        ...
        if (textPaint2 == null) {
            ...
            if ((textFlags & 4) != 0) {
                ...
                if (i3 != 0 && (textFlags & 2) != 0) {
                    textPaint2.setTypeface(Typeface.create(C0483C.SERIF_NAME, 3));
                } else if (i3 != 0) {
                    textPaint2.setTypeface(Typeface.create(C0483C.SERIF_NAME, 1));
                } else if ((textFlags & 2) != 0) {
                    textPaint2.setTypeface(Typeface.create(C0483C.SERIF_NAME, 2));
                } else {
                    textPaint2.setTypeface(Typeface.create(C0483C.SERIF_NAME, 0));
                }
            }
            if ((textFlags & 32) != 0) {
            ...
            if (i != 0) {
                textPaint2.baselineShift -= AndroidUtilities.m108dp(6.0f);
            } else if ((textFlags & 128) != 0) {
                textPaint2.baselineShift += AndroidUtilities.m108dp(2.0f);
            }
            textPaint2.setColor(textColor);
            sparseArray8.put(textFlags, textPaint2);
        }
        textPaint2.setTextSize(m107dp8 + m107dp9);
        return textPaint2;
    }
    ...
    */
    ...
    private void updatePaintFonts() {
        ...
        Typeface typeface2 = i == 0 ? AndroidUtilities.getTypeface("fonts/ritalic.ttf") : Typeface.create(C0483C.SERIF_NAME, 2);
        Typeface typeface3 = this.selectedFont == 0 ? AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM) : Typeface.create(C0483C.SERIF_NAME, 1);
        Typeface typeface4 = this.selectedFont == 0 ? AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM_ITALIC) : Typeface.create(C0483C.SERIF_NAME, 3);
    ...
    public void setParentActivity(Activity activity, BaseFragment baseFragment) {
            ...
            */
            protected boolean drawChild(android.graphics.Canvas r11, android.view.View r12, long r13) {
                ...
                Lde:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ArticleViewer.C38817.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
            }
        ...
        while (i3 < this.listView.length) {
            ...
            this.listView[i3] = new RecyclerListView(activity) { // from class: org.telegram.ui.ArticleViewer.8
                ...
                public void setTranslationX(float f) {
                    ...
                    if (ArticleViewer.this.windowView.movingPage) {
                        ...
                        ArticleViewer articleViewer = ArticleViewer.this;
                        articleViewer.setCurrentHeaderHeight((int) (articleViewer.windowView.startMovingHeaderHeight + ((AndroidUtilities.m107dp(56) - ArticleViewer.this.windowView.startMovingHeaderHeight) * measuredWidth)));
                    }
                }
            ...
            this.listView[i3].setPadding(0, AndroidUtilities.m107dp(56), 0, 0);
            this.listView[i3].setTopGlowOffset(AndroidUtilities.m107dp(56));
        ...
        this.titleTextView.setPivotY(AndroidUtilities.m107dp(28));
        ...
        this.lineProgressView.setPivotY(AndroidUtilities.m107dp(2));
        ...
        this.searchField.addTextChangedListener(new C386413());
        ...
        this.searchPanel.setPadding(0, AndroidUtilities.m107dp(3), 0, 0);
        ...
        articleTextSelectionHelper2.setCallback(new TextSelectionHelper.Callback() { // from class: org.telegram.ui.ArticleViewer.18
            ...
            public void onTextCopied() {
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    BulletinFactory.m66of(ArticleViewer.this.containerView, null).createCopyBulletin(LocaleController.getString("TextCopied", C3632R.string.TextCopied)).show();
                }
            }
        });
            ...
            if (this.previewsReqId == 0) {
                if (!reportCell.hasViews || f >= view.getMeasuredWidth() / 2) {
                    ...
                    if (!(userOrChat instanceof TLRPC$TL_user)) {
                        ...
                        final long j = webpageAdapter.currentPage.f1760id;
                        showProgressView(true, true);
                    ...
                    openPreviewsChat((TLRPC$User) userOrChat, webpageAdapter.currentPage.f1760id);
                }
            }
    ...
    /* loaded from: classes5.dex */
    public class C386413 implements TextWatcher {
                    ...
                    if (ArticleViewer.this.clearButton.getTag() != null) {
                        ...
                        if (ArticleViewer.this.animateClear) {
                            ArticleViewer.this.clearButton.animate().setInterpolator(new DecelerateInterpolator()).alpha(BitmapDescriptorFactory.HUE_RED).setDuration(180L).scaleY(BitmapDescriptorFactory.HUE_RED).scaleX(BitmapDescriptorFactory.HUE_RED).rotation(45.0f).withEndAction(new Runnable() { // from class: org.telegram.ui.ArticleViewer$13$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    ArticleViewer.C386413.this.lambda$onTextChanged$0();
                                }
                            }).start();
                            return;
                        }
    ...
    public /* synthetic */ void lambda$setParentActivity$22(int i) {
        ...
        if (i == 1) {
            ...
            builder.setApplyTopPadding(false);
            LinearLayout linearLayout = new LinearLayout(this.parentActivity);
            linearLayout.setPadding(0, 0, 0, AndroidUtilities.m107dp(4));
            linearLayout.setOrientation(1);
    ...
    */
    ...
    public void checkScrollAnimated() {
        if (this.currentHeaderHeight == AndroidUtilities.m107dp(56)) {
            return;
        }
        ValueAnimator duration = ValueAnimator.ofObject(new IntEvaluator(), Integer.valueOf(this.currentHeaderHeight), Integer.valueOf(AndroidUtilities.m107dp(56))).setDuration(180L);
    ...
    public void setCurrentHeaderHeight(int i) {
        ...
        float f = m107dp - m107dp2;
        if (f == BitmapDescriptorFactory.HUE_RED) {
            f = 1.0f;
        }
        this.currentHeaderHeight = i;
        float f2 = (((i - m107dp2) / f) * 0.2f) + 0.8f;
        this.backButton.setScaleX(f2);
        this.backButton.setScaleY(f2);
        this.backButton.setTranslationY((m107dp - this.currentHeaderHeight) / 2);
        ...
        this.lineProgressView.setScaleY((((i - m107dp2) / f) * 0.5f) + 0.5f);
        this.menuContainer.setTranslationY((m107dp - this.currentHeaderHeight) / 2);
        this.titleTextView.setTranslationY((m107dp - this.currentHeaderHeight) / 2);
        this.headerView.setTranslationY(this.currentHeaderHeight - m107dp);
        this.searchShadow.setTranslationY(this.currentHeaderHeight - m107dp);
        int i2 = 0;
        this.menuButton.setAdditionalYOffset(((-(this.currentHeaderHeight - m107dp)) / 2) + (Build.VERSION.SDK_INT < 21 ? AndroidUtilities.statusBarHeight : 0));
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$open$34(final int i, final TLRPC$WebPage tLRPC$WebPage, final MessageObject messageObject, final String str, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda32
            @Override // java.lang.Runnable
            public final void run() {
                ArticleViewer.this.lambda$open$33(tLObject, i, tLRPC$WebPage, messageObject, str);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$open$33(TLObject tLObject, int i, TLRPC$WebPage tLRPC$WebPage, MessageObject messageObject, String str) {
        ...
        if (tLObject2 instanceof TLRPC$TL_webPage) {
            ...
            if (!this.pagesStack.isEmpty() && this.pagesStack.get(0) == tLRPC$WebPage) {
                ...
                if (this.pagesStack.size() == 1) {
                    ApplicationLoader.applicationContext.getSharedPreferences("articles", 0).edit().remove("article" + tLRPC$TL_webPage.f1760id).commit();
            ...
            longSparseArray.put(tLRPC$TL_webPage.f1760id, tLRPC$TL_webPage);
    ...
    /* loaded from: classes5.dex */
    public class C387422 extends AnimatorListenerAdapter {
        C387422() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ArticleViewer$22$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ArticleViewer.C387422.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    public void saveCurrentPagePosition() {
        ...
        String str = "article" + this.adapter[0].currentPage.f1760id;
    ...
    public /* synthetic */ void lambda$joinChannel$46(final BlockChannelCell blockChannelCell, final int i, final TLRPC$TL_channels_joinChannel tLRPC$TL_channels_joinChannel, final TLRPC$Chat tLRPC$Chat, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (!z) {
            MessagesController.getInstance(i).generateJoinMessage(tLRPC$Chat.f1602id, true);
        }
    ...
    public static /* synthetic */ void lambda$joinChannel$45(int i, TLRPC$Chat tLRPC$Chat) {
        MessagesController.getInstance(i).loadFullChat(tLRPC$Chat.f1602id, 0, true);
    }
    ...
    public class BlockVideoCell extends FrameLayout implements DownloadController.FileDownloadProgressListener, TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockVideoCell(Context context, WebpageAdapter webpageAdapter, int i) {
            ...
            addView(this.aspectRationContainer, LayoutHelper.createFrame(-1, -2));
        ...
        /* JADX WARN: Code restructure failed: missing block: B:30:0x00ab, code lost:
            if (r2 <= (r0 + org.telegram.messenger.AndroidUtilities.m107dp(48))) goto L31;
         */
        @Override // android.view.View
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.currentBlock.level > 0) {
                canvas.drawRect(AndroidUtilities.m107dp(18), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(20), getMeasuredHeight() - (this.currentBlock.bottom ? AndroidUtilities.m107dp(6) : 0), ArticleViewer.quoteLinePaint);
            }
            super.onDraw(canvas);
            ...
            if (this.currentDocument != null) {
                ...
                for (int i = 0; i < tLRPC$Document.attributes.size(); i++) {
                    if (tLRPC$Document.attributes.get(i) instanceof TLRPC$TL_documentAttributeVideo) {
                        ...
                        this.aspectRatioFrameLayout.setAspectRatio(tLRPC$TL_documentAttributeVideo.f1613w / tLRPC$TL_documentAttributeVideo.f1612h, 0);
                    }
                }
    ...
    public class BlockAudioCell extends View implements DownloadController.FileDownloadProgressListener, TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockAudioCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.textY = AndroidUtilities.m107dp(58);
            this.parentAdapter = webpageAdapter;
            RadialProgress2 radialProgress2 = new RadialProgress2(this);
            this.radialProgress = radialProgress2;
            radialProgress2.setCircleRadius(AndroidUtilities.m107dp(24));
            this.TAG = DownloadController.getInstance(ArticleViewer.this.currentAccount).generateObserverTag();
        ...
        /* JADX WARN: Code restructure failed: missing block: B:20:0x0064, code lost:
            if (r1 <= (r0 + org.telegram.messenger.AndroidUtilities.m107dp(48))) goto L21;
         */
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r13) {
            ...
            L36:
                ...
                if (r5 < 0) goto L66
                r5 = 48
                int r6 = org.telegram.messenger.AndroidUtilities.m107dp(r5)
                int r2 = r2 + r6
                float r2 = (float) r2
                ...
                if (r2 < 0) goto L66
                int r2 = org.telegram.messenger.AndroidUtilities.m107dp(r5)
                int r0 = r0 + r2
                float r0 = (float) r0
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int size = View.MeasureSpec.getSize(i);
            int m107dp = AndroidUtilities.m107dp(54);
            ...
            if (tLRPC$TL_pageBlockAudio != null) {
                ...
                if (i4 > 0) {
                    this.textX = AndroidUtilities.m107dp(i4 * 14) + AndroidUtilities.m107dp(18);
                } else {
                    this.textX = AndroidUtilities.m107dp(18);
                }
                int m107dp2 = (size - this.textX) - AndroidUtilities.m107dp(18);
                int m107dp3 = AndroidUtilities.m107dp(44);
                this.buttonX = AndroidUtilities.m107dp(16);
                int m107dp4 = AndroidUtilities.m107dp(5);
                this.buttonY = m107dp4;
                RadialProgress2 radialProgress2 = this.radialProgress;
                int i5 = this.buttonX;
                radialProgress2.setProgressRect(i5, m107dp4, i5 + m107dp3, m107dp4 + m107dp3);
                ArticleViewer articleViewer = ArticleViewer.this;
                TLRPC$TL_pageBlockAudio tLRPC$TL_pageBlockAudio2 = this.currentBlock;
                DrawingText createLayoutForText = articleViewer.createLayoutForText(this, null, tLRPC$TL_pageBlockAudio2.caption.text, m107dp2, this.textY, tLRPC$TL_pageBlockAudio2, this.parentAdapter);
                this.captionLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    int m107dp5 = AndroidUtilities.m107dp(8) + this.captionLayout.getHeight();
                    this.creditOffset = m107dp5;
                    m107dp += m107dp5 + AndroidUtilities.m107dp(8);
                }
                int i6 = m107dp;
                ArticleViewer articleViewer2 = ArticleViewer.this;
                TLRPC$TL_pageBlockAudio tLRPC$TL_pageBlockAudio3 = this.currentBlock;
                DrawingText createLayoutForText2 = articleViewer2.createLayoutForText(this, null, tLRPC$TL_pageBlockAudio3.caption.credit, m107dp2, this.textY + this.creditOffset, tLRPC$TL_pageBlockAudio3, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.creditLayout = createLayoutForText2;
                if (createLayoutForText2 != null) {
                    i6 += AndroidUtilities.m107dp(4) + this.creditLayout.getHeight();
                }
                if (!this.isFirst && this.currentBlock.level <= 0) {
                    i6 += AndroidUtilities.m107dp(8);
                }
                ...
                int m107dp6 = this.buttonX + AndroidUtilities.m107dp(50) + m107dp3;
                this.seekBarX = m107dp6;
                int m107dp7 = (size - m107dp6) - AndroidUtilities.m107dp(18);
                if (!TextUtils.isEmpty(musicTitle) || !TextUtils.isEmpty(musicAuthor)) {
                    ...
                    CharSequence ellipsize = TextUtils.ellipsize(spannableStringBuilder, Theme.chat_audioTitlePaint, m107dp7, TextUtils.TruncateAt.END);
                    DrawingText drawingText = new DrawingText();
                    this.titleLayout = drawingText;
                    drawingText.textLayout = new StaticLayout(ellipsize, ArticleViewer.audioTimePaint, m107dp7, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                    this.titleLayout.parentBlock = this.currentBlock;
                    this.seekBarY = this.buttonY + ((m107dp3 - AndroidUtilities.m107dp(30)) / 2) + AndroidUtilities.m107dp(11);
                } else {
                    this.titleLayout = null;
                    this.seekBarY = this.buttonY + ((m107dp3 - AndroidUtilities.m107dp(30)) / 2);
                }
                this.seekBar.setSize(m107dp7, AndroidUtilities.m107dp(30));
                i3 = i6;
            }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.durationLayout != null) {
                canvas.save();
                canvas.translate(this.buttonX + AndroidUtilities.m107dp(54), this.seekBarY + AndroidUtilities.m107dp(6));
                this.durationLayout.draw(canvas);
                canvas.restore();
            }
            if (this.titleLayout != null) {
                canvas.save();
                this.titleLayout.f1790x = this.buttonX + AndroidUtilities.m107dp(54);
                this.titleLayout.f1791y = this.seekBarY - AndroidUtilities.m107dp(16);
                DrawingText drawingText = this.titleLayout;
                canvas.translate(drawingText.f1790x, drawingText.f1791y);
                ArticleViewer.this.drawTextSelection(canvas, this, 0);
            ...
            if (this.captionLayout != null) {
                ...
                int i4 = this.textX;
                drawingText2.f1790x = i4;
                int i5 = this.textY;
                drawingText2.f1791y = i5;
            ...
            if (this.creditLayout != null) {
                ...
                int i6 = this.textX;
                drawingText3.f1790x = i6;
                drawingText3.f1791y = this.textY + this.creditOffset;
        ...
        public void updatePlayingMessageProgress() {
            ...
            if (str == null || (str != null && !str.equals(formatShortDuration))) {
                ...
                ArticleViewer.audioTimePaint.setTextSize(AndroidUtilities.m107dp(16));
    ...
    public class BlockEmbedPostCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockEmbedPostCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            imageReceiver.setRoundRadius(AndroidUtilities.m107dp(20));
            this.avatarImageView.setImageCoords(AndroidUtilities.m107dp(32), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(40), AndroidUtilities.m107dp(40));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockEmbedPost != null) {
                if (tLRPC$TL_pageBlockEmbedPost instanceof TL_pageBlockEmbedPostCaption) {
                    this.textX = AndroidUtilities.m107dp(18);
                    this.textY = AndroidUtilities.m107dp(4);
                    int m107dp = size - AndroidUtilities.m107dp(50);
                    ArticleViewer articleViewer = ArticleViewer.this;
                    TLRPC$TL_pageBlockEmbedPost tLRPC$TL_pageBlockEmbedPost2 = this.currentBlock;
                    DrawingText createLayoutForText = articleViewer.createLayoutForText(this, null, tLRPC$TL_pageBlockEmbedPost2.caption.text, m107dp, this.textY, tLRPC$TL_pageBlockEmbedPost2, this.parentAdapter);
                    this.captionLayout = createLayoutForText;
                    if (createLayoutForText != null) {
                        int m107dp2 = AndroidUtilities.m107dp(4) + this.captionLayout.getHeight();
                        this.creditOffset = m107dp2;
                        r13 = 0 + m107dp2 + AndroidUtilities.m107dp(4);
                    }
                    ArticleViewer articleViewer2 = ArticleViewer.this;
                    TLRPC$TL_pageBlockEmbedPost tLRPC$TL_pageBlockEmbedPost3 = this.currentBlock;
                    DrawingText createLayoutForText2 = articleViewer2.createLayoutForText(this, null, tLRPC$TL_pageBlockEmbedPost3.caption.credit, m107dp, this.textY + this.creditOffset, tLRPC$TL_pageBlockEmbedPost3, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                    this.creditLayout = createLayoutForText2;
                    if (createLayoutForText2 != null) {
                        r13 += AndroidUtilities.m107dp(4) + this.creditLayout.getHeight();
                    }
                    i3 = r13;
                } else {
                    ...
                    if (z) {
                        ...
                        if (z2) {
                            ...
                            this.avatarImageView.setImage(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(photoWithId.sizes, AndroidUtilities.m107dp(40), true), photoWithId), "40_40", this.avatarDrawable, 0L, (String) null, this.parentAdapter.currentPage, 1);
                        }
                    }
                    DrawingText createLayoutForText3 = ArticleViewer.this.createLayoutForText(this, this.currentBlock.author, null, size - AndroidUtilities.m107dp((this.avatarVisible ? 54 : 0) + 50), 0, this.currentBlock, Layout.Alignment.ALIGN_NORMAL, 1, this.parentAdapter);
                    this.nameLayout = createLayoutForText3;
                    if (createLayoutForText3 != null) {
                        createLayoutForText3.f1790x = AndroidUtilities.m107dp((this.avatarVisible ? 54 : 0) + 32);
                        this.nameLayout.f1791y = AndroidUtilities.m107dp(this.dateLayout != null ? 10 : 19);
                    }
                    if (this.currentBlock.date != 0) {
                        this.dateLayout = ArticleViewer.this.createLayoutForText(this, LocaleController.getInstance().chatFullDate.format(this.currentBlock.date * 1000), null, size - AndroidUtilities.m107dp((this.avatarVisible ? 54 : 0) + 50), AndroidUtilities.m107dp(29), this.currentBlock, this.parentAdapter);
                    } else {
                        this.dateLayout = null;
                    }
                    int m107dp3 = AndroidUtilities.m107dp(56);
                    if (this.currentBlock.blocks.isEmpty()) {
                        this.textX = AndroidUtilities.m107dp(32);
                        this.textY = AndroidUtilities.m107dp(56);
                        int m107dp4 = size - AndroidUtilities.m107dp(50);
                        ArticleViewer articleViewer3 = ArticleViewer.this;
                        TLRPC$TL_pageBlockEmbedPost tLRPC$TL_pageBlockEmbedPost4 = this.currentBlock;
                        DrawingText createLayoutForText4 = articleViewer3.createLayoutForText(this, null, tLRPC$TL_pageBlockEmbedPost4.caption.text, m107dp4, this.textY, tLRPC$TL_pageBlockEmbedPost4, this.parentAdapter);
                        this.captionLayout = createLayoutForText4;
                        if (createLayoutForText4 != null) {
                            int m107dp5 = AndroidUtilities.m107dp(4) + this.captionLayout.getHeight();
                            this.creditOffset = m107dp5;
                            m107dp3 += m107dp5 + AndroidUtilities.m107dp(4);
                        }
                        int i4 = m107dp3;
                        ArticleViewer articleViewer4 = ArticleViewer.this;
                        TLRPC$TL_pageBlockEmbedPost tLRPC$TL_pageBlockEmbedPost5 = this.currentBlock;
                        DrawingText createLayoutForText5 = articleViewer4.createLayoutForText(this, null, tLRPC$TL_pageBlockEmbedPost5.caption.credit, m107dp4, this.textY + this.creditOffset, tLRPC$TL_pageBlockEmbedPost5, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                        this.creditLayout = createLayoutForText5;
                        if (createLayoutForText5 != null) {
                            i4 += AndroidUtilities.m107dp(4) + this.creditLayout.getHeight();
                        }
                        m107dp3 = i4;
                    } else {
                    ...
                    if (drawingText != null) {
                        drawingText.f1790x = AndroidUtilities.m107dp((this.avatarVisible ? 54 : 0) + 32);
                        this.dateLayout.f1791y = AndroidUtilities.m107dp(29);
                    }
                    DrawingText drawingText2 = this.captionLayout;
                    if (drawingText2 != null) {
                        drawingText2.f1790x = this.textX;
                        drawingText2.f1791y = this.textY;
                    }
                    DrawingText drawingText3 = this.creditLayout;
                    if (drawingText3 != null) {
                        drawingText3.f1790x = this.textX;
                        drawingText3.f1791y = this.textY;
                    }
                    i3 = m107dp3;
                }
                this.lineHeight = i3;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!(tLRPC$TL_pageBlockEmbedPost instanceof TL_pageBlockEmbedPostCaption)) {
                ...
                if (this.nameLayout != null) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m107dp((this.avatarVisible ? 54 : 0) + 32), AndroidUtilities.m107dp(this.dateLayout != null ? 10 : 19));
                    ArticleViewer.this.drawTextSelection(canvas, this, 0);
                ...
                if (this.dateLayout != null) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m107dp((this.avatarVisible ? 54 : 0) + 32), AndroidUtilities.m107dp(29));
                    ArticleViewer.this.drawTextSelection(canvas, this, i);
                    this.dateLayout.draw(canvas, this);
                    canvas.restore();
                    i++;
                }
                canvas.drawRect(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(20), this.lineHeight - (this.currentBlock.level == 0 ? AndroidUtilities.m107dp(6) : 0), ArticleViewer.quoteLinePaint);
                r1 = i;
            }
            if (this.captionLayout != null) {
                canvas.save();
    ...
    public class BlockParagraphCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockParagraph != null) {
                ...
                if (i4 == 0) {
                    this.textY = AndroidUtilities.m107dp(8);
                    this.textX = AndroidUtilities.m107dp(18);
                } else {
                    this.textY = 0;
                    this.textX = AndroidUtilities.m107dp((i4 * 14) + 18);
                }
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.text, (size - AndroidUtilities.m107dp(18)) - this.textX, this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, 0, this.parentAdapter);
                ...
                if (createLayoutForText != null) {
                    ...
                    drawingText.f1790x = this.textX;
                    drawingText.f1791y = this.textY;
                }
            } else {
                i3 = 1;
            }
    ...
    public class BlockEmbedCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockEmbedCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            this.webView.setWebChromeClient(new C38902(ArticleViewer.this));
        ...
        /* loaded from: classes5.dex */
        public class C38902 extends WebChromeClient {
            C38902(ArticleViewer articleViewer) {
            }
            ...
            public void onShowCustomView(View view, WebChromeClient.CustomViewCallback customViewCallback) {
                if (ArticleViewer.this.customView == null) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ArticleViewer$BlockEmbedCell$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ArticleViewer.BlockEmbedCell.C38902.this.lambda$onShowCustomView$0();
                        }
                    }, 100L);
                    return;
                }
    ...
    public class BlockTableCell extends FrameLayout implements TableLayout.TableLayoutDelegate, TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockTableCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context, ArticleViewer.this) { // from class: org.telegram.ui.ArticleViewer.BlockTableCell.1
                ...
                public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                    ...
                    if (BlockTableCell.this.tableLayout.getMeasuredWidth() > getMeasuredWidth() - AndroidUtilities.m107dp(36) && onInterceptTouchEvent) {
                        ArticleViewer.this.windowView.requestDisallowInterceptTouchEvent(true);
                    }
                ...
                public boolean onTouchEvent(MotionEvent motionEvent) {
                    if (BlockTableCell.this.tableLayout.getMeasuredWidth() <= getMeasuredWidth() - AndroidUtilities.m107dp(36)) {
                        return false;
                    }
                    return super.onTouchEvent(motionEvent);
                }
            ...
            horizontalScrollView.setPadding(AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(18), 0);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockTable != null) {
                ...
                if (i5 > 0) {
                    int m107dp2 = AndroidUtilities.m107dp(i5 * 14);
                    this.listX = m107dp2;
                    m107dp = m107dp2 + AndroidUtilities.m107dp(18);
                    this.textX = m107dp;
                } else {
                    this.listX = 0;
                    this.textX = AndroidUtilities.m107dp(18);
                ...
                DrawingText createLayoutForText = articleViewer.createLayoutForText(this, null, tLRPC$TL_pageBlockTable2.title, size - m107dp, 0, tLRPC$TL_pageBlockTable2, Layout.Alignment.ALIGN_CENTER, 0, this.parentAdapter);
                this.titleLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    this.textY = 0;
                    i4 = createLayoutForText.getHeight() + AndroidUtilities.m107dp(8) + 0;
                    this.listY = i4;
                    DrawingText drawingText = this.titleLayout;
                    drawingText.f1790x = this.textX;
                    drawingText.f1791y = this.textY;
                } else {
                    this.listY = AndroidUtilities.m107dp(8);
                    i4 = 0;
                }
                this.scrollView.measure(View.MeasureSpec.makeMeasureSpec(size - this.listX, 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
                i3 = i4 + this.scrollView.getMeasuredHeight() + AndroidUtilities.m107dp(8);
        ...
        public void updateChildTextPositions() {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (drawingText != null) {
                    drawingText.f1790x = ((childAt.getTextX() + this.listX) + AndroidUtilities.m107dp(18)) - this.scrollView.getScrollX();
                    childAt.textLayout.f1791y = childAt.getTextY() + this.listY;
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (this.firstLayout) {
                if (this.parentAdapter.isRtl) {
                    this.scrollView.setScrollX((this.tableLayout.getMeasuredWidth() - this.scrollView.getMeasuredWidth()) + AndroidUtilities.m107dp(36));
                } else {
    ...
    public class BlockCollageCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
                    ...
                    while (true) {
                        if (i < size) {
                            ...
                            if (b == b2 && ((groupedMessagePosition2.minX != groupedMessagePosition.minX || groupedMessagePosition2.maxX != groupedMessagePosition.maxX || b != b2 || groupedMessagePosition2.maxY != groupedMessagePosition.maxY) && b == b2)) {
                                dp2 -= ((int) Math.ceil(max * groupedMessagePosition2.f1534ph)) - AndroidUtilities.m107dp(4);
                                break;
                            }
                            i++;
                        } else {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockCollage != null) {
                ...
                if (i5 > 0) {
                    int m107dp2 = AndroidUtilities.m107dp(i5 * 14) + AndroidUtilities.m107dp(18);
                    this.listX = m107dp2;
                    this.textX = m107dp2;
                    i3 = size - (m107dp2 + AndroidUtilities.m107dp(18));
                    m107dp = i3;
                } else {
                    this.listX = 0;
                    this.textX = AndroidUtilities.m107dp(18);
                    m107dp = size - AndroidUtilities.m107dp(36);
                    i3 = size;
                }
                ...
                int m107dp3 = measuredHeight + AndroidUtilities.m107dp(8);
                this.textY = m107dp3;
                ArticleViewer articleViewer = ArticleViewer.this;
                TLRPC$TL_pageBlockCollage tLRPC$TL_pageBlockCollage2 = this.currentBlock;
                DrawingText createLayoutForText = articleViewer.createLayoutForText(this, null, tLRPC$TL_pageBlockCollage2.caption.text, m107dp, m107dp3, tLRPC$TL_pageBlockCollage2, this.parentAdapter);
                this.captionLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    int m107dp4 = AndroidUtilities.m107dp(4) + this.captionLayout.getHeight();
                    this.creditOffset = m107dp4;
                    measuredHeight += m107dp4 + AndroidUtilities.m107dp(4);
                    DrawingText drawingText = this.captionLayout;
                    drawingText.f1790x = this.textX;
                    drawingText.f1791y = this.textY;
                } else {
                ...
                DrawingText createLayoutForText2 = articleViewer2.createLayoutForText(this, null, tLRPC$TL_pageBlockCollage3.caption.credit, m107dp, this.textY + this.creditOffset, tLRPC$TL_pageBlockCollage3, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.creditLayout = createLayoutForText2;
                if (createLayoutForText2 != null) {
                    measuredHeight += AndroidUtilities.m107dp(4) + this.creditLayout.getHeight();
                    DrawingText drawingText2 = this.creditLayout;
                    drawingText2.f1790x = this.textX;
                    drawingText2.f1791y = this.textY + this.creditOffset;
                }
                i4 = measuredHeight + AndroidUtilities.m107dp(16);
        ...
        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            this.innerListView.layout(this.listX, AndroidUtilities.m107dp(8), this.listX + this.innerListView.getMeasuredWidth(), this.innerListView.getMeasuredHeight() + AndroidUtilities.m107dp(8));
        }
    ...
    public class BlockSlideshowCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockSlideshowCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            View view = new View(context, ArticleViewer.this) { // from class: org.telegram.ui.ArticleViewer.BlockSlideshowCell.4
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    int m107dp = (AndroidUtilities.m107dp(7) * count) + ((count - 1) * AndroidUtilities.m107dp(6)) + AndroidUtilities.m107dp(4);
                    if (m107dp < getMeasuredWidth()) {
                        i = (getMeasuredWidth() - m107dp) / 2;
                    } else {
                        int m107dp2 = AndroidUtilities.m107dp(4);
                        int m107dp3 = AndroidUtilities.m107dp(13);
                        int measuredWidth = ((getMeasuredWidth() - AndroidUtilities.m107dp(8)) / 2) / m107dp3;
                        ...
                        if (BlockSlideshowCell.this.currentPage != i3 || BlockSlideshowCell.this.pageOffset >= BitmapDescriptorFactory.HUE_RED) {
                            if (BlockSlideshowCell.this.currentPage >= i3) {
                                i2 = ((count - (measuredWidth * 2)) - 1) * m107dp3;
                            } else if (BlockSlideshowCell.this.currentPage > measuredWidth) {
                                i2 = ((int) (BlockSlideshowCell.this.pageOffset * m107dp3)) + ((BlockSlideshowCell.this.currentPage - measuredWidth) * m107dp3);
                                ...
                                i2 = (int) (BlockSlideshowCell.this.pageOffset * m107dp3);
                            }
                            i = m107dp2 - i2;
                        } else {
                            i = m107dp2 - (((int) (BlockSlideshowCell.this.pageOffset * m107dp3)) + (((count - (measuredWidth * 2)) - 1) * m107dp3));
                        }
                    }
                    int i4 = 0;
                    while (i4 < BlockSlideshowCell.this.currentBlock.items.size()) {
                        int m107dp4 = AndroidUtilities.m107dp(4) + i + (AndroidUtilities.m107dp(13) * i4);
                        ...
                        drawable.setBounds(m107dp4 - AndroidUtilities.m107dp(5), 0, m107dp4 + AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(10));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int size = View.MeasureSpec.getSize(i);
            if (this.currentBlock != null) {
                int m107dp = AndroidUtilities.m107dp(310);
                this.innerListView.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(m107dp, 1073741824));
                this.currentBlock.items.size();
                this.dotsContainer.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(10), 1073741824));
                int m107dp2 = size - AndroidUtilities.m107dp(36);
                int m107dp3 = m107dp + AndroidUtilities.m107dp(16);
                this.textY = m107dp3;
                ArticleViewer articleViewer = ArticleViewer.this;
                TLRPC$TL_pageBlockSlideshow tLRPC$TL_pageBlockSlideshow = this.currentBlock;
                DrawingText createLayoutForText = articleViewer.createLayoutForText(this, null, tLRPC$TL_pageBlockSlideshow.caption.text, m107dp2, m107dp3, tLRPC$TL_pageBlockSlideshow, this.parentAdapter);
                this.captionLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    int m107dp4 = AndroidUtilities.m107dp(4) + this.captionLayout.getHeight();
                    this.creditOffset = m107dp4;
                    m107dp += m107dp4 + AndroidUtilities.m107dp(4);
                    DrawingText drawingText = this.captionLayout;
                    drawingText.f1790x = this.textX;
                    drawingText.f1791y = this.textY;
                } else {
                ...
                DrawingText createLayoutForText2 = articleViewer2.createLayoutForText(this, null, tLRPC$TL_pageBlockSlideshow2.caption.credit, m107dp2, this.textY + this.creditOffset, tLRPC$TL_pageBlockSlideshow2, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.creditLayout = createLayoutForText2;
                if (createLayoutForText2 != null) {
                    m107dp += AndroidUtilities.m107dp(4) + this.creditLayout.getHeight();
                    DrawingText drawingText2 = this.creditLayout;
                    drawingText2.f1790x = this.textX;
                    drawingText2.f1791y = this.textY + this.creditOffset;
                }
                i3 = m107dp + AndroidUtilities.m107dp(16);
            } else {
                i3 = 1;
            }
            setMeasuredDimension(size, i3);
        ...
        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            this.innerListView.layout(0, AndroidUtilities.m107dp(8), this.innerListView.getMeasuredWidth(), AndroidUtilities.m107dp(8) + this.innerListView.getMeasuredHeight());
            int bottom = this.innerListView.getBottom() - AndroidUtilities.m107dp(23);
        ...
        */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.currentBlock.numLayout != null) {
                canvas.save();
                if (this.parentAdapter.isRtl) {
                    canvas.translate(((measuredWidth - AndroidUtilities.m107dp(15)) - this.currentBlock.parent.maxNumWidth) - (this.currentBlock.parent.level * AndroidUtilities.m107dp(12)), (this.textY + this.numOffsetY) - (this.drawDot ? AndroidUtilities.m107dp(1) : 0));
                } else {
                    canvas.translate(((AndroidUtilities.m107dp(15) + this.currentBlock.parent.maxNumWidth) - ((int) Math.ceil(this.currentBlock.numLayout.getLineWidth(0)))) + (this.currentBlock.parent.level * AndroidUtilities.m107dp(12)), (this.textY + this.numOffsetY) - (this.drawDot ? AndroidUtilities.m107dp(1) : 0));
                }
        ...
        */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.currentBlock.numLayout != null) {
                canvas.save();
                if (this.parentAdapter.isRtl) {
                    canvas.translate(((measuredWidth - AndroidUtilities.m107dp(18)) - this.currentBlock.parent.maxNumWidth) - (this.currentBlock.parent.level * AndroidUtilities.m107dp(20)), this.textY + this.numOffsetY);
                } else {
                    canvas.translate(((AndroidUtilities.m107dp(18) + this.currentBlock.parent.maxNumWidth) - ((int) Math.ceil(this.currentBlock.numLayout.getLineWidth(0)))) + (this.currentBlock.parent.level * AndroidUtilities.m107dp(20)), this.textY + this.numOffsetY);
                }
                this.currentBlock.numLayout.draw(canvas, this);
                canvas.restore();
            }
    ...
    public class BlockDetailsCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockDetailsCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.textX = AndroidUtilities.m107dp(50);
            this.textY = AndroidUtilities.m107dp(11) + 1;
            this.parentAdapter = webpageAdapter;
        ...
        protected void onMeasure(int i, int i2) {
            int size = View.MeasureSpec.getSize(i);
            int m107dp = AndroidUtilities.m107dp(39);
            TLRPC$TL_pageBlockDetails tLRPC$TL_pageBlockDetails = this.currentBlock;
            if (tLRPC$TL_pageBlockDetails != null) {
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tLRPC$TL_pageBlockDetails.title, size - AndroidUtilities.m107dp(52), 0, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    m107dp = Math.max(m107dp, AndroidUtilities.m107dp(21) + this.textLayout.getHeight());
                    int height = ((this.textLayout.getHeight() + AndroidUtilities.m107dp(21)) - this.textLayout.getHeight()) / 2;
                    this.textY = height;
                    DrawingText drawingText = this.textLayout;
                    drawingText.f1790x = this.textX;
                    drawingText.f1791y = height;
                }
            }
            setMeasuredDimension(size, m107dp + 1);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.translate(AndroidUtilities.m107dp(18), ((getMeasuredHeight() - AndroidUtilities.m107dp(13)) - 1) / 2);
    ...
    public static class BlockDetailsBottomCell extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(4) + 1);
        }
    ...
    public static class BlockRelatedArticlesShadowCell extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(12));
    ...
    public class BlockRelatedArticlesHeaderCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockRelatedArticles != null) {
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tLRPC$TL_pageBlockRelatedArticles.title, size - AndroidUtilities.m107dp(52), 0, this.currentBlock, Layout.Alignment.ALIGN_NORMAL, 1, this.parentAdapter);
                this.textLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    this.textY = AndroidUtilities.m107dp(6) + ((AndroidUtilities.m107dp(32) - this.textLayout.getHeight()) / 2);
                }
            }
            if (this.textLayout != null) {
                setMeasuredDimension(size, AndroidUtilities.m107dp(38));
                DrawingText drawingText = this.textLayout;
                drawingText.f1790x = this.textX;
                drawingText.f1791y = this.textY;
                return;
    ...
    public class BlockRelatedArticlesCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockRelatedArticlesCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.textX = AndroidUtilities.m107dp(18);
            this.textY = AndroidUtilities.m107dp(10);
            this.parentAdapter = webpageAdapter;
            ImageReceiver imageReceiver = new ImageReceiver(this);
            this.imageView = imageReceiver;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int m107dp2 = AndroidUtilities.m107dp(SharedConfig.ivFontSize - 16);
            ...
            int m107dp3 = AndroidUtilities.m107dp(60);
            int m107dp4 = size - AndroidUtilities.m107dp(36);
            if (this.drawImage) {
                float m107dp5 = AndroidUtilities.m107dp(44);
                this.imageView.setImageCoords((size - m107dp) - AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), m107dp5, m107dp5);
                m107dp4 = (int) (m107dp4 - (this.imageView.getImageWidth() + AndroidUtilities.m107dp(6)));
            }
            int i5 = m107dp4;
            int m107dp6 = AndroidUtilities.m107dp(18);
            ...
            if (drawingText != null) {
                ...
                int i6 = 4 - lineCount;
                this.textOffset = this.textLayout.getHeight() + AndroidUtilities.m107dp(6) + m107dp2;
                m107dp6 += this.textLayout.getHeight();
                int i7 = 0;
                while (true) {
                    if (i7 >= lineCount) {
                        z2 = false;
            ...
            if (createLayoutForText != null) {
                m107dp6 += createLayoutForText.getHeight();
                if (this.textLayout != null) {
                    m107dp6 += AndroidUtilities.m107dp(6) + m107dp2;
                }
                DrawingText drawingText3 = this.textLayout2;
                drawingText3.f1790x = this.textX;
                drawingText3.f1791y = this.textY + this.textOffset;
            }
            setMeasuredDimension(size, Math.max(i3, m107dp6) + (this.divider ? 1 : 0));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.translate(this.textX, AndroidUtilities.m107dp(10));
            if (this.textLayout != null) {
                ArticleViewer.this.drawTextSelection(canvas, this, 0);
                this.textLayout.draw(canvas, this);
                i = 1;
            ...
            if (this.divider) {
                if (!this.parentAdapter.isRtl) {
                    f = AndroidUtilities.m107dp(17);
                }
                canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (this.parentAdapter.isRtl ? AndroidUtilities.m107dp(17) : 0), getMeasuredHeight() - 1, ArticleViewer.dividerPaint);
            }
        }
    ...
    public class BlockHeaderCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockHeader != null) {
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tLRPC$TL_pageBlockHeader.text, size - AndroidUtilities.m107dp(36), this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    i3 = 0 + AndroidUtilities.m107dp(16) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
                    drawingText.f1790x = this.textX;
                    drawingText.f1791y = this.textY;
                }
    ...
    public static class BlockDividerCell extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(18));
        }

        @Override // android.view.View
        protected void onDraw(Canvas canvas) {
            int measuredWidth = getMeasuredWidth() / 3;
            this.rect.set(measuredWidth, AndroidUtilities.m107dp(8), measuredWidth * 2, AndroidUtilities.m107dp(10));
            canvas.drawRoundRect(this.rect, AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1), ArticleViewer.dividerPaint);
        }
    }
    ...
    public class BlockSubtitleCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockSubtitle != null) {
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tLRPC$TL_pageBlockSubtitle.text, size - AndroidUtilities.m107dp(36), this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    i3 = 0 + AndroidUtilities.m107dp(16) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
    ...
    public class BlockPullquoteCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockPullquote != null) {
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tLRPC$TL_pageBlockPullquote.text, size - AndroidUtilities.m107dp(36), this.textY, this.currentBlock, this.parentAdapter);
                this.textLayout = createLayoutForText;
                i3 = 0;
                if (createLayoutForText != null) {
                    i3 = 0 + AndroidUtilities.m107dp(8) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
                    drawingText.f1790x = this.textX;
                    drawingText.f1791y = this.textY;
                }
                this.textY2 = AndroidUtilities.m107dp(2) + i3;
                DrawingText createLayoutForText2 = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.caption, size - AndroidUtilities.m107dp(36), this.textY2, this.currentBlock, this.parentAdapter);
                this.textLayout2 = createLayoutForText2;
                if (createLayoutForText2 != null) {
                    i3 += AndroidUtilities.m107dp(8) + this.textLayout2.getHeight();
                    DrawingText drawingText2 = this.textLayout2;
                    drawingText2.f1790x = this.textX;
                    drawingText2.f1791y = this.textY2;
                }
                if (i3 != 0) {
                    i3 += AndroidUtilities.m107dp(8);
                }
    ...
    public class BlockBlockquoteCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.currentBlock != null) {
                ...
                if (i4 > 0) {
                    m107dp -= AndroidUtilities.m107dp(i4 * 14);
                }
                ArticleViewer articleViewer = ArticleViewer.this;
                TLRPC$TL_pageBlockBlockquote tLRPC$TL_pageBlockBlockquote = this.currentBlock;
                DrawingText createLayoutForText = articleViewer.createLayoutForText(this, null, tLRPC$TL_pageBlockBlockquote.text, m107dp, this.textY, tLRPC$TL_pageBlockBlockquote, this.parentAdapter);
                this.textLayout = createLayoutForText;
                i3 = createLayoutForText != null ? 0 + AndroidUtilities.m107dp(8) + this.textLayout.getHeight() : 0;
                if (this.currentBlock.level > 0) {
                    if (this.parentAdapter.isRtl) {
                        this.textX = AndroidUtilities.m107dp((this.currentBlock.level * 14) + 14);
                    } else {
                        this.textX = AndroidUtilities.m107dp(this.currentBlock.level * 14) + AndroidUtilities.m107dp(32);
                    }
                } else if (this.parentAdapter.isRtl) {
                    this.textX = AndroidUtilities.m107dp(14);
                } else {
                    this.textX = AndroidUtilities.m107dp(32);
                }
                int m107dp2 = i3 + AndroidUtilities.m107dp(8);
                this.textY2 = m107dp2;
                ArticleViewer articleViewer2 = ArticleViewer.this;
                TLRPC$TL_pageBlockBlockquote tLRPC$TL_pageBlockBlockquote2 = this.currentBlock;
                DrawingText createLayoutForText2 = articleViewer2.createLayoutForText(this, null, tLRPC$TL_pageBlockBlockquote2.caption, m107dp, m107dp2, tLRPC$TL_pageBlockBlockquote2, this.parentAdapter);
                this.textLayout2 = createLayoutForText2;
                if (createLayoutForText2 != null) {
                    i3 += AndroidUtilities.m107dp(8) + this.textLayout2.getHeight();
                }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!this.parentAdapter.isRtl) {
                canvas.drawRect(AndroidUtilities.m107dp((this.currentBlock.level * 14) + 18), AndroidUtilities.m107dp(6), AndroidUtilities.m107dp((this.currentBlock.level * 14) + 20), getMeasuredHeight() - AndroidUtilities.m107dp(6), ArticleViewer.quoteLinePaint);
            } else {
                canvas.drawRect(getMeasuredWidth() - AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(6), measuredWidth + AndroidUtilities.m107dp(2), getMeasuredHeight() - AndroidUtilities.m107dp(6), ArticleViewer.quoteLinePaint);
            }
            if (this.currentBlock.level > 0) {
                canvas.drawRect(AndroidUtilities.m107dp(18), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(20), getMeasuredHeight() - (this.currentBlock.bottom ? AndroidUtilities.m107dp(6) : 0), ArticleViewer.quoteLinePaint);
            }
    ...
    public class BlockPhotoCell extends FrameLayout implements DownloadController.FileDownloadProgressListener, TextSelectionHelper.ArticleSelectableView {
        ...
        */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!TextUtils.isEmpty(this.currentBlock.url)) {
                int measuredWidth = getMeasuredWidth() - AndroidUtilities.m107dp(35);
                int imageY = (int) (this.imageView.getImageY() + AndroidUtilities.m107dp(11));
                this.linkDrawable.setBounds(measuredWidth, imageY, AndroidUtilities.m107dp(24) + measuredWidth, AndroidUtilities.m107dp(24) + imageY);
    ...
    public class BlockChannelCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockChannelCell(Context context, WebpageAdapter webpageAdapter, int i) {
            super(context);
            this.textX = AndroidUtilities.m107dp(18);
            this.textY = AndroidUtilities.m107dp(11);
            this.parentAdapter = webpageAdapter;
            setWillNotDraw(false);
            this.backgroundPaint = new Paint();
            this.currentType = i;
        ...
        public void setBlock(TLRPC$TL_pageBlockChannel tLRPC$TL_pageBlockChannel) {
            ...
            TLRPC$Chat chat = MessagesController.getInstance(ArticleViewer.this.currentAccount).getChat(Long.valueOf(tLRPC$TL_pageBlockChannel.channel.f1602id));
        ...
        protected void onMeasure(int i, int i2) {
            int size = View.MeasureSpec.getSize(i);
            setMeasuredDimension(size, AndroidUtilities.m107dp(48));
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(39), 1073741824));
            this.buttonWidth = this.textView.getMeasuredWidth();
            this.progressView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(39), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(39), 1073741824));
            this.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(39), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(39), 1073741824));
            TLRPC$TL_pageBlockChannel tLRPC$TL_pageBlockChannel = this.currentBlock;
            if (tLRPC$TL_pageBlockChannel != null) {
                this.textLayout = ArticleViewer.this.createLayoutForText(this, tLRPC$TL_pageBlockChannel.channel.title, null, (size - AndroidUtilities.m107dp(52)) - this.buttonWidth, this.textY, this.currentBlock, StaticLayoutEx.ALIGN_LEFT(), 1, this.parentAdapter);
                if (this.parentAdapter.isRtl) {
        ...
        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            this.imageView.layout((this.textX2 + (this.buttonWidth / 2)) - AndroidUtilities.m107dp(19), 0, this.textX2 + (this.buttonWidth / 2) + AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(39));
            this.progressView.layout((this.textX2 + (this.buttonWidth / 2)) - AndroidUtilities.m107dp(19), 0, this.textX2 + (this.buttonWidth / 2) + AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(39));
            TextView textView = this.textView;
            int i5 = this.textX2;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m107dp(39), this.backgroundPaint);
            DrawingText drawingText = this.textLayout;
    ...
    public class BlockAuthorDateCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockAuthorDate != null) {
                ...
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, r15, null, size - AndroidUtilities.m107dp(36), this.textY, this.currentBlock, this.parentAdapter);
                this.textLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    int m107dp = AndroidUtilities.m107dp(16) + this.textLayout.getHeight() + 0;
                    if (this.parentAdapter.isRtl) {
                        this.textX = (int) Math.floor(((size - this.textLayout.getLineLeft(0)) - this.textLayout.getLineWidth(0)) - AndroidUtilities.m107dp(16));
                    } else {
                        this.textX = AndroidUtilities.m107dp(18);
                    }
                    DrawingText drawingText = this.textLayout;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockTitle != null) {
                ...
                if (tLRPC$TL_pageBlockTitle.first) {
                    i3 = 0 + AndroidUtilities.m107dp(8);
                    this.textY = AndroidUtilities.m107dp(16);
                } else {
                    this.textY = AndroidUtilities.m107dp(8);
                }
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.text, size - AndroidUtilities.m107dp(36), this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    i3 += AndroidUtilities.m107dp(16) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
                    drawingText.f1790x = this.textX;
                    drawingText.f1791y = this.textY;
                }
    ...
    public class BlockFooterCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockFooter != null) {
                ...
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.text, (size - AndroidUtilities.m107dp(18)) - this.textX, this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    int height = createLayoutForText.getHeight();
                    if (this.currentBlock.level > 0) {
    ...
    public class BlockPreformattedCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockPreformattedCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            this.scrollView = horizontalScrollView;
            horizontalScrollView.setPadding(0, AndroidUtilities.m107dp(8), 0, AndroidUtilities.m107dp(8));
            addView(this.scrollView, LayoutHelper.createFrame(-1, -2));
            this.textContainer = new View(context, ArticleViewer.this) { // from class: org.telegram.ui.ArticleViewer.BlockPreformattedCell.2
                ...
                protected void onMeasure(int i, int i2) {
                    ...
                    if (BlockPreformattedCell.this.currentBlock != null) {
                        ...
                        blockPreformattedCell.textLayout = ArticleViewer.this.createLayoutForText(this, null, blockPreformattedCell.currentBlock.text, AndroidUtilities.m107dp((int) DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS), 0, BlockPreformattedCell.this.currentBlock, BlockPreformattedCell.this.parentAdapter);
                    ...
                    setMeasuredDimension(i4 + AndroidUtilities.m107dp(32), i3);
                }
                ...
                protected void onDraw(Canvas canvas) {
                    if (BlockPreformattedCell.this.textLayout != null) {
                        ...
                        canvas.restore();
                        BlockPreformattedCell.this.textLayout.f1790x = (int) getX();
                        BlockPreformattedCell.this.textLayout.f1791y = (int) getY();
                    }
                }
            };
            ...
            layoutParams.bottomMargin = m107dp2;
            layoutParams.topMargin = m107dp2;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(8), getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m107dp(8), ArticleViewer.preformattedBackgroundPaint);
        }
    ...
    public class BlockSubheaderCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockSubheader != null) {
                DrawingText createLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tLRPC$TL_pageBlockSubheader.text, size - AndroidUtilities.m107dp(36), this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = createLayoutForText;
                if (createLayoutForText != null) {
                    i3 = 0 + AndroidUtilities.m107dp(16) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
    ...
    public static class ReportCell extends FrameLayout {
        ...
        public ReportCell(Context context) {
            ...
            this.textView.setPadding(AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(18), 0);
            ...
            this.viewsTextView.setPadding(AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(18), 0);
            addView(this.viewsTextView, LayoutHelper.createFrame(-1, 34, 51, 0, 10, 0, 0));
        }

        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(44), 1073741824));
        }
        ...
        */
        public java.lang.CharSequence getCaption(int r9) {
            ...
            L29:
                ...
                r2 = 0
                r9 = 100
                int r9 = org.telegram.messenger.AndroidUtilities.m107dp(r9)
                int r6 = -r9
                r3 = r4
