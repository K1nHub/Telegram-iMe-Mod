...
public class GroupCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    public class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (AndroidUtilities.isTablet()) {
                min = AndroidUtilities.m72dp(372) / 3;
            } else {
                Point point = AndroidUtilities.displaySize;
                min = (Math.min(point.x, point.y) - AndroidUtilities.m72dp(158)) / 3;
            }
            if (m72dp - i3 < min) {
                m72dp2 += AndroidUtilities.m72dp(40);
                i3 = 0;
            }
            if (m72dp - i4 < min) {
                m72dp3 += AndroidUtilities.m72dp(40);
            }
            GroupCreateActivity.this.editText.measure(View.MeasureSpec.makeMeasureSpec(m72dp - i3, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(32), 1073741824));
            if (this.animationStarted) {
                ...
                int m72dp6 = i3 + AndroidUtilities.m72dp(16);
                GroupCreateActivity.this.fieldY = m72dp2;
                if (GroupCreateActivity.this.currentAnimation != null) {
                    int m72dp7 = m72dp2 + AndroidUtilities.m72dp(42);
                    if (GroupCreateActivity.this.containerHeight != m72dp7) {
                        this.animators.add(ObjectAnimator.ofInt(GroupCreateActivity.this, "containerHeight", m72dp7));
                    }
                    GroupCreateActivity groupCreateActivity = GroupCreateActivity.this;
                    groupCreateActivity.measuredContainerHeight = Math.max(groupCreateActivity.containerHeight, m72dp7);
                    float f3 = m72dp6;
                    ...
                    groupCreateActivity2.measuredContainerHeight = groupCreateActivity2.containerHeight = m72dp5;
                    GroupCreateActivity.this.editText.setTranslationX(m72dp6);
    ...
    public View createView(final Context context) {
        ...
        if (i2 == 2) {
            this.actionBar.setTitle(LocaleController.getString("ChannelAddSubscribers", C3473R.string.ChannelAddSubscribers));
        } else if (this.addToGroup) {
            if (this.channelId != 0) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddSubscribers", C3473R.string.ChannelAddSubscribers));
            } else {
                this.actionBar.setTitle(LocaleController.getString("GroupAddMembers", C3473R.string.GroupAddMembers));
            }
        } else if (this.isAlwaysShare) {
            int i3 = this.chatAddType;
            if (i3 == 2) {
                this.actionBar.setTitle(LocaleController.getString("FilterAlwaysShow", C3473R.string.FilterAlwaysShow));
            } else if (i3 == 1) {
                this.actionBar.setTitle(LocaleController.getString("AlwaysAllow", C3473R.string.AlwaysAllow));
            } else {
                this.actionBar.setTitle(LocaleController.getString("AlwaysShareWithTitle", C3473R.string.AlwaysShareWithTitle));
            }
        } else if (this.isNeverShare) {
            int i4 = this.chatAddType;
            if (i4 == 2) {
                this.actionBar.setTitle(LocaleController.getString("FilterNeverShow", C3473R.string.FilterNeverShow));
            } else if (i4 == 1) {
                this.actionBar.setTitle(LocaleController.getString("NeverAllow", C3473R.string.NeverAllow));
            } else {
                this.actionBar.setTitle(LocaleController.getString("NeverShareWithTitle", C3473R.string.NeverShareWithTitle));
            }
        } else {
            C3541ActionBar c3541ActionBar = this.actionBar;
            if (i2 == 0) {
                i = C3473R.string.NewGroup;
                str = "NewGroup";
            } else {
                i = C3473R.string.NewBroadcastList;
                str = "NewBroadcastList";
            }
            c3541ActionBar.setTitle(LocaleController.getString(str, i));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.GroupCreateActivity.1
        ...
        ViewGroup viewGroup = new ViewGroup(context) { // from class: org.telegram.ui.GroupCreateActivity.2
            ...
            protected void onMeasure(int i5, int i6) {
                ...
                if (AndroidUtilities.isTablet() || size2 > size) {
                    GroupCreateActivity.this.maxSize = AndroidUtilities.m72dp(144);
                } else {
                    GroupCreateActivity.this.maxSize = AndroidUtilities.m72dp(56);
                }
                ...
                if (GroupCreateActivity.this.floatingButton != null) {
                    int m72dp = AndroidUtilities.m72dp(Build.VERSION.SDK_INT < 21 ? 60 : 56);
                    GroupCreateActivity.this.floatingButton.measure(View.MeasureSpec.makeMeasureSpec(m72dp, 1073741824), View.MeasureSpec.makeMeasureSpec(m72dp, 1073741824));
                }
            }
            ...
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                ...
                if (GroupCreateActivity.this.floatingButton != null) {
                    int m72dp = LocaleController.isRTL ? AndroidUtilities.m72dp(14) : ((i7 - i5) - AndroidUtilities.m72dp(14)) - GroupCreateActivity.this.floatingButton.getMeasuredWidth();
                    int m72dp2 = ((i8 - i6) - AndroidUtilities.m72dp(14)) - GroupCreateActivity.this.floatingButton.getMeasuredHeight();
                    GroupCreateActivity.this.floatingButton.layout(m72dp, m72dp2, GroupCreateActivity.this.floatingButton.getMeasuredWidth() + m72dp, GroupCreateActivity.this.floatingButton.getMeasuredHeight() + m72dp2);
                }
            }
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: org.telegram.ui.GroupCreateActivity.3
            ...
            public boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z) {
                ...
                rect.top += GroupCreateActivity.this.fieldY + AndroidUtilities.m72dp(20);
                rect.bottom += GroupCreateActivity.this.fieldY + AndroidUtilities.m72dp(50);
        ...
        if (this.isNeverShare || this.isAlwaysShare || this.addToGroup) {
            this.floatingButton.setImageResource(C3473R.C3475drawable.floating_check);
        } else {
        ...
        this.floatingButton.setContentDescription(LocaleController.getString("Next", C3473R.string.Next));
        updateHint();
    ...
    public /* synthetic */ void lambda$createView$3(Context context, View view, int i) {
        ...
        if (i == 0 && this.adapter.inviteViaLink != 0 && !this.adapter.searching) {
            ...
            if (z) {
                j = ((TLRPC$User) object).f1685id;
            } else if (!(object instanceof TLRPC$Chat)) {
                return;
            } else {
                j = -((TLRPC$Chat) object).f1522id;
            }
            ...
            if (longSparseArray == null || longSparseArray.indexOfKey(j) < 0) {
                ...
                if (z2) {
                    ...
                    if (this.chatType == 0 && this.selectedContacts.size() == getMessagesController().maxGroupCount) {
                        ...
                        builder.setMessage(LocaleController.getString("SoftUserLimitAlert", C3473R.string.SoftUserLimitAlert));
                        ...
                        if (this.addToGroup && tLRPC$User.bot) {
                            ...
                            if (j2 == 0 && tLRPC$User.bot_nochats) {
                                ...
                                if (ChatObject.canAddAdmins(chat)) {
                                    builder2.setTitle(LocaleController.getString("AddBotAdminAlert", C3473R.string.AddBotAdminAlert));
                                    builder2.setMessage(LocaleController.getString("AddBotAsAdmin", C3473R.string.AddBotAsAdmin));
                                    builder2.setPositiveButton(LocaleController.getString("AddAsAdmin", C3473R.string.AddAsAdmin), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda0
                                    ...
                                    builder2.setMessage(LocaleController.getString("CantAddBotAsAdmin", C3473R.string.CantAddBotAsAdmin));
                                    builder2.setPositiveButton(LocaleController.getString("OK", C3473R.string.OK), null);
                                }
    ...
    public void updateEditTextHint() {
        ...
        if (this.chatType == 2) {
            editTextBoldCursor.setHintText(LocaleController.getString("AddMutual", C3473R.string.AddMutual));
        } else if (this.addToGroup || (((groupCreateAdapter = this.adapter) != null && groupCreateAdapter.noContactsStubRow == 0) || this.isOnlyUsers)) {
            this.editText.setHintText(LocaleController.getString("SearchForPeople", C3473R.string.SearchForPeople));
        } else if (this.isAlwaysShare || this.isNeverShare) {
            this.editText.setHintText(LocaleController.getString("SearchForPeopleAndGroups", C3473R.string.SearchForPeopleAndGroups));
        } else {
            this.editText.setHintText(LocaleController.getString("SendMessageTo", C3473R.string.SendMessageTo));
        }
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt instanceof GroupCreateUserCell) {
                ...
                if (object instanceof TLRPC$User) {
                    ...
                    j = object instanceof TLRPC$Chat ? -((TLRPC$Chat) object).f1522id : 0L;
                }
                if (j != 0) {
                    LongSparseArray<TLObject> longSparseArray = this.ignoreUsers;
                    if (longSparseArray != null && longSparseArray.indexOfKey(j) >= 0) {
    ...
    public boolean onDonePressed(boolean z) {
        ...
        if (z && this.addToGroup) {
            ...
            if (this.selectedContacts.size() > 5) {
                ...
                int i2 = C3473R.string.AddMembersAlertNamesText;
            ...
            if (!ChatObject.isChannel(chat)) {
                ...
                if (this.selectedContacts.size() == 1) {
                    checkBoxCellArr[0].setText(AndroidUtilities.replaceTags(LocaleController.formatString("AddOneMemberForwardMessages", C3473R.string.AddOneMemberForwardMessages, UserObject.getFirstName(getMessagesController().getUser(Long.valueOf(this.selectedContacts.keyAt(0)))))), "", true, false);
                } else {
                    checkBoxCellArr[0].setText(LocaleController.getString("AddMembersForwardMessages", C3473R.string.AddMembersForwardMessages), "", true, false);
                }
                checkBoxCellArr[0].setPadding(LocaleController.isRTL ? AndroidUtilities.m72dp(16) : AndroidUtilities.m72dp(8), 0, LocaleController.isRTL ? AndroidUtilities.m72dp(8) : AndroidUtilities.m72dp(16), 0);
            ...
            builder.setPositiveButton(LocaleController.getString("Add", C3473R.string.Add), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
    ...
    public void updateHint() {
        if (!this.isAlwaysShare && !this.isNeverShare && !this.addToGroup) {
            if (this.chatType == 2) {
                ...
                this.actionBar.setSubtitle(LocaleController.formatString("MembersCountZero", C3473R.string.MembersCountZero, LocaleController.formatPluralString("Members", this.maxCount, new Object[0])));
            } else {
    ...
    public class GroupCreateAdapter extends RecyclerListView.FastScrollAdapter {
        ...
        public GroupCreateAdapter(Context context) {
            ...
            if (!GroupCreateActivity.this.isOnlyUsers && (GroupCreateActivity.this.isNeverShare || GroupCreateActivity.this.isAlwaysShare)) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (DialogObject.isChatDialog(tLRPC$Dialog.f1528id) && (chat = GroupCreateActivity.this.getMessagesController().getChat(Long.valueOf(-tLRPC$Dialog.f1528id))) != null && chat.migrated_to == null && ((!ChatObject.isChannel(chat) || chat.megagroup) && !GroupCreateActivity.this.getAlbumsController().isDialogAlbum(tLRPC$Dialog.f1528id))) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (this.searching) {
                    groupCreateSectionCell.setText(LocaleController.getString("GlobalSearch", C3473R.string.GlobalSearch));
                }
                ...
                if (this.inviteViaLink == 2) {
                    textCell.setTextAndIcon(LocaleController.getString("ChannelInviteViaLink", C3473R.string.ChannelInviteViaLink), C3473R.C3475drawable.msg_link2, false);
                } else {
                    textCell.setTextAndIcon(LocaleController.getString("InviteToGroupByLink", C3473R.string.InviteToGroupByLink), C3473R.C3475drawable.msg_link2, false);
                }
            } else {
                ...
                if (tLObject instanceof TLRPC$User) {
                    j = ((TLRPC$User) tLObject).f1685id;
                } else {
                    j = tLObject instanceof TLRPC$Chat ? -((TLRPC$Chat) tLObject).f1522id : 0L;
                }
                if (j != 0) {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder viewHolder) {
            if (GroupCreateActivity.this.ignoreUsers != null) {
                ...
                if (view instanceof GroupCreateUserCell) {
                    ...
                    return !(object instanceof TLRPC$User) || GroupCreateActivity.this.ignoreUsers.indexOfKey(((TLRPC$User) object).f1685id) < 0;
                }
                return true;
            }
            return true;
