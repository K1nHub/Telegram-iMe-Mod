...
public class PasscodeActivity extends JavaWalletCreationBaseFragment implements CreateWalletPinView, EnterWalletPasswordView, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public /* synthetic */ void lambda$createView$11(int i, boolean z) {
        Runnable runnable;
        if (i < AndroidUtilities.m107dp(20) || (runnable = this.onShowKeyboardCallback) == null) {
            return;
        }
        runnable.run();
    ...
    /* loaded from: classes5.dex */
    public class C66705 extends C3704ActionBar.ActionBarMenuOnItemClick {
        final /* synthetic */ ActionBarMenuSubItem val$switchItem;

        C66705(ActionBarMenuSubItem actionBarMenuSubItem) {
        ...
        public void onItemClick(int i) {
            ...
            if (i == 1) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.PasscodeActivity$5$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        PasscodeActivity.C66705.this.lambda$onItemClick$0(actionBarMenuSubItem);
                    }
                }, 150L);
    ...
    /* loaded from: classes5.dex */
    public class C66749 extends CodeFieldContainer {
        C66749(Context context) {
            super(context);
        }
        ...
        protected void processNextPressed() {
            ...
            postDelayed(new Runnable() { // from class: org.telegram.ui.PasscodeActivity$9$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    PasscodeActivity.C66749.this.lambda$processNextPressed$0();
                }
            }, 260L);
        }
    ...
    public /* synthetic */ void lambda$setCustomKeyboardVisible$24(ValueAnimator valueAnimator) {
        ...
        this.keyboardView.setTranslationY((1.0f - floatValue) * AndroidUtilities.m107dp(230) * 0.75f);
    ...
    private void setFloatingButtonVisible(final boolean z, boolean z2) {
        ...
        if (!z2) {
            this.floatingAutoAnimator.setOffsetY(z ? 0.0f : AndroidUtilities.m107dp(70));
    ...
    public /* synthetic */ void lambda$setFloatingButtonVisible$25(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        this.floatingAutoAnimator.setOffsetY(AndroidUtilities.m107dp(70) * (1.0f - floatValue));
    ...
    public /* synthetic */ void lambda$processDone$29() {
        this.codeFieldContainer.postDelayed(this.hidePasscodesDoNotMatch, C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
    ...
    public static final class RLottieImageHolderView extends FrameLayout {
        ...
        private RLottieImageHolderView(Context context) {
            ...
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(m107dp, m107dp);
            layoutParams.gravity = 1;
            addView(this.imageView, layoutParams);
            setPadding(0, AndroidUtilities.m107dp(32), 0, 0);
