...
public class PasscodeActivity extends JavaWalletCreationBaseFragment implements CreateWalletPinView, EnterWalletPasswordView, NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$onWalletPinCodeChangeSuccess$5() {
        showToast(LocaleController.getInternalString(C3634R.string.wallet_pin_code_change_success));
    ...
    */
    ...
    public /* synthetic */ void lambda$createView$11(int i, boolean z) {
        Runnable runnable;
        if (i < AndroidUtilities.m104dp(20) || (runnable = this.onShowKeyboardCallback) == null) {
            return;
        }
        runnable.run();
    ...
    public /* synthetic */ void lambda$createView$15(View view, final int i) {
        if (view.isEnabled()) {
            if (i == this.disablePasscodeRow) {
                AlertDialog create = new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString(C3634R.string.DisablePasscode)).setMessage(LocaleController.getString(C3634R.string.DisablePasscodeConfirmMessage)).setNegativeButton(LocaleController.getString(C3634R.string.Cancel), null).setPositiveButton(LocaleController.getString(C3634R.string.DisablePasscodeTurnOff), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PasscodeActivity$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                ...
                builder.setTitle(LocaleController.getString("AutoLock", C3634R.string.AutoLock));
                ...
                builder.setNegativeButton(LocaleController.getString("Done", C3634R.string.Done), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PasscodeActivity$$ExternalSyntheticLambda4
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                ...
                AlertsCreator.showSimpleAlert(this, LocaleController.getString("ScreenCaptureAlert", C3634R.string.ScreenCaptureAlert));
            }
        }
    }
    ...
    public static /* synthetic */ String lambda$createView$13(int i) {
        if (i == 0) {
            return LocaleController.getString("AutoLockDisabled", C3634R.string.AutoLockDisabled);
        }
        return i == 1 ? LocaleController.formatString("AutoLockInTime", C3634R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 1, new Object[0])) : i == 2 ? LocaleController.formatString("AutoLockInTime", C3634R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 5, new Object[0])) : i == 3 ? LocaleController.formatString("AutoLockInTime", C3634R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 1, new Object[0])) : i == 4 ? LocaleController.formatString("AutoLockInTime", C3634R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 5, new Object[0])) : "";
    }
    ...
    /* loaded from: classes5.dex */
    public class C65375 extends C3706ActionBar.ActionBarMenuOnItemClick {
        final /* synthetic */ ActionBarMenuSubItem val$switchItem;

        C65375(ActionBarMenuSubItem actionBarMenuSubItem) {
        ...
        public void onItemClick(int i) {
            ...
            if (i == 1) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.PasscodeActivity$5$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        PasscodeActivity.C65375.this.lambda$onItemClick$0(actionBarMenuSubItem);
                    }
                }, 150L);
        ...
        public /* synthetic */ void lambda$onItemClick$0(ActionBarMenuSubItem actionBarMenuSubItem) {
            actionBarMenuSubItem.setText(LocaleController.getString(PasscodeActivity.this.currentPasswordType == 0 ? C3634R.string.PasscodeSwitchToPassword : C3634R.string.PasscodeSwitchToPIN));
            actionBarMenuSubItem.setIcon(PasscodeActivity.this.currentPasswordType == 0 ? C3634R.C3636drawable.msg_permissions : C3634R.C3636drawable.msg_pin_code);
    ...
    public static /* synthetic */ View lambda$createView$16(Context context) {
        ...
        textView.setLineSpacing(AndroidUtilities.m104dp(2), 1.0f);
    ...
    /* loaded from: classes5.dex */
    public class C65419 extends CodeFieldContainer {
        C65419(Context context) {
            super(context);
        }
        ...
        protected void processNextPressed() {
            ...
            postDelayed(new Runnable() { // from class: org.telegram.ui.PasscodeActivity$9$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    PasscodeActivity.C65419.this.lambda$processNextPressed$0();
                }
            }, 260L);
        }
    ...
    public /* synthetic */ void lambda$setCustomKeyboardVisible$24(ValueAnimator valueAnimator) {
        ...
        this.keyboardView.setTranslationY((1.0f - floatValue) * AndroidUtilities.m104dp(230) * 0.75f);
    ...
    private void setFloatingButtonVisible(final boolean z, boolean z2) {
        ...
        if (!z2) {
            this.floatingAutoAnimator.setOffsetY(z ? 0.0f : AndroidUtilities.m104dp(70));
    ...
    public /* synthetic */ void lambda$setFloatingButtonVisible$25(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        this.floatingAutoAnimator.setOffsetY(AndroidUtilities.m104dp(70) * (1.0f - floatValue));
    ...
    public void updateFields() {
        String charSequence;
        if (this.type == 2) {
            charSequence = LocaleController.getString(C3634R.string.EnterYourPasscodeInfo);
        } else if (this.passcodeSetStep == 0) {
            int i = this.screenType;
            if (i == 0) {
                charSequence = LocaleController.getInternalString(C3634R.string.wallet_create_eth_pin_code_description);
            } else if (i == 2) {
                charSequence = LocaleController.getInternalString(C3634R.string.wallet_enter_eth_password_description);
            } else {
                charSequence = LocaleController.getString(this.currentPasswordType == 0 ? C3634R.string.CreatePasscodeInfoPIN : C3634R.string.CreatePasscodeInfoPassword);
            }
        } else {
        ...
        if (this.type == 2) {
            this.descriptionTextSwitcher.setText(LocaleController.getString(C3634R.string.EnterYourPasscodeInfo), z);
        } else if (this.passcodeSetStep == 0) {
            if (isWalletScreen()) {
                this.descriptionTextSwitcher.setText(charSequence, z);
            } else {
                this.descriptionTextSwitcher.setText(LocaleController.getString(this.currentPasswordType == 0 ? C3634R.string.CreatePasscodeInfoPIN : C3634R.string.CreatePasscodeInfoPassword), z);
            }
        }
        if (isPinCode()) {
    ...
    public void processNext() {
        ...
        if (this.screenType == 0) {
            this.titleTextView.setText(LocaleController.getInternalString(C3634R.string.wallet_confirm_eth_pin_code_title));
        } else {
            this.titleTextView.setText(LocaleController.getString("ConfirmCreatePasscode", C3634R.string.ConfirmCreatePasscode));
        }
        if (this.screenType == 0) {
            this.descriptionTextSwitcher.setText(LocaleController.getInternalString(C3634R.string.wallet_confirm_eth_pin_code_description));
        } else {
            this.descriptionTextSwitcher.setText(AndroidUtilities.replaceTags(LocaleController.getString("PasscodeReinstallNotice", C3634R.string.PasscodeReinstallNotice)));
        }
    ...
    public /* synthetic */ void lambda$processDone$29() {
        this.codeFieldContainer.postDelayed(this.hidePasscodesDoNotMatch, C0485C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
            ...
            if (itemViewType == 0) {
                ...
                if (i == PasscodeActivity.this.fingerprintRow) {
                    if (PasscodeActivity.this.sectionPasscodeData != null) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", C3634R.string.UnlockFingerprint), PasscodeActivity.this.sectionPasscodeData.isUseFingerprint(), true);
                    } else if (PasscodeActivity.this.screenType == 1) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", C3634R.string.UnlockFingerprint), PasscodeActivity.this.getWalletFingerprintController().isWalletFingerprintUnlockEnabled(), true);
                    } else {
                        textCheckCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", C3634R.string.UnlockFingerprint), SharedConfig.useFingerprint, true);
                    }
                } else if (i == PasscodeActivity.this.captureRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString(C3634R.string.ScreenCaptureShowContent), SharedConfig.allowScreenCapture, false);
                }
                ...
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        ...
                        rLottieImageHolderView.imageView.setAnimation(C3634R.raw.utyan_passcode, 100, 100);
                    ...
                    if (i == PasscodeActivity.this.captureHeaderRow) {
                        headerCell.setText(LocaleController.getString(C3634R.string.ScreenCaptureHeader));
                        return;
                    }
                    return;
                }
                ...
                if (i != PasscodeActivity.this.hintRow || PasscodeActivity.this.screenType == 1) {
                    if (i != PasscodeActivity.this.autoLockDetailRow) {
                        if (i == PasscodeActivity.this.captureDetailRow) {
                            textInfoPrivacyCell.setText(LocaleController.getString(C3634R.string.ScreenCaptureInfo));
                            textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.mContext, C3634R.C3636drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                            textInfoPrivacyCell.getTextView().setGravity(LocaleController.isRTL ? 5 : 3);
                            return;
                        }
                        return;
                    }
                    textInfoPrivacyCell.setText(LocaleController.getString(C3634R.string.AutoLockInfo));
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.mContext, C3634R.C3636drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    textInfoPrivacyCell.getTextView().setGravity(LocaleController.isRTL ? 5 : 3);
                    return;
                }
                textInfoPrivacyCell.setText(LocaleController.getString(C3634R.string.PasscodeScreenHint));
                textInfoPrivacyCell.setBackground(null);
                textInfoPrivacyCell.getTextView().setGravity(1);
            } else {
                TextSettingsCell textSettingsCell = (TextSettingsCell) viewHolder.itemView;
                if (i == PasscodeActivity.this.changePasscodeRow) {
                    textSettingsCell.setText(PasscodeActivity.this.screenType == 1 ? LocaleController.getInternalString(C3634R.string.wallet_settings_pin_code_change) : LocaleController.getString("ChangePasscode", C3634R.string.ChangePasscode), true);
                    ...
                    if (timeout == 0) {
                        formatString = LocaleController.formatString("AutoLockDisabled", C3634R.string.AutoLockDisabled, new Object[0]);
                    } else if (timeout < 3600) {
                        formatString = LocaleController.formatString("AutoLockInTime", C3634R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", timeout / 60, new Object[0]));
                    } else if (timeout < 86400) {
                        formatString = LocaleController.formatString("AutoLockInTime", C3634R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", (int) Math.ceil((timeout / 60.0f) / 60.0f), new Object[0]));
                    } else {
                        formatString = LocaleController.formatString("AutoLockInTime", C3634R.string.AutoLockInTime, LocaleController.formatPluralString("Days", (int) Math.ceil(((timeout / 60.0f) / 60.0f) / 24.0f), new Object[0]));
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("AutoLock", C3634R.string.AutoLock), formatString, true);
                    ...
                    textSettingsCell.setText(LocaleController.getString(C3634R.string.DisablePasscode), false);
    ...
    public static final class RLottieImageHolderView extends FrameLayout {
        ...
        private RLottieImageHolderView(Context context) {
            ...
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(m104dp, m104dp);
            layoutParams.gravity = 1;
            addView(this.imageView, layoutParams);
            setPadding(0, AndroidUtilities.m104dp(32), 0, 0);
