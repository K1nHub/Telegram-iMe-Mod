...
public class UnlockPremiumView extends FrameLayout {
    ...
    public UnlockPremiumView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            textView.setText(LocaleController.getString("UnlockPremiumStickersDescription", C3417R.string.UnlockPremiumStickersDescription));
        } else if (i == 1) {
            textView.setText(LocaleController.getString("UnlockPremiumReactionsDescription", C3417R.string.UnlockPremiumReactionsDescription));
        }
        ...
        if (i == 0) {
            string = LocaleController.getString("UnlockPremiumStickers", C3417R.string.UnlockPremiumStickers);
        } else {
            string = LocaleController.getString("UnlockPremiumReactions", C3417R.string.UnlockPremiumReactions);
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) "d ").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3417R.C3419drawable.msg_premium_normal)), 0, 1, 0);
