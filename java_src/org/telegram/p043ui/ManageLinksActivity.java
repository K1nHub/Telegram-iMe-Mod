...
public class ManageLinksActivity extends JavaWalletAuthBaseFragment implements WalletReceiveBinancePayView, WalletDonationsView, StakingCalculatorView, NotificationCenter.NotificationCenterDelegate {
    ...
    /* loaded from: classes5.dex */
    public class C66083 implements ChatRightsEditActivity.ChatRightsEditActivityDelegate {
            ...
            if (user != null) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$3$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ManageLinksActivity.C66083.this.lambda$didSetRights$0(user);
                    }
                }, 200L);
            }
        }
    ...
    public void openAddAdminScreen() {
        ...
        chatRightsEditActivity.setDelegate(new C66083());
    ...
    private class EmptyView extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public EmptyView(Context context) {
            ...
            setPadding(0, AndroidUtilities.m107dp(12), 0, AndroidUtilities.m107dp(12));
            setOrientation(1);
    ...
    public ManageLinksActivity(long j, long j2, int i) {
        ...
        this.linkEditActivityCallback = new C66149();
    ...
    public /* synthetic */ void lambda$loadLinks$12(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (tLRPC$TL_error == null) {
            ...
            for (int i2 = 0; i2 < tLRPC$TL_messages_chatAdminsWithInvites.users.size(); i2++) {
                ...
                this.users.put(Long.valueOf(tLRPC$User.f1751id), tLRPC$User);
            }
        }
    ...
    */
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == IdFabric$ViewTypes.STAKING_PROGNOSIS) {
                ...
                stakingPercentageView.setPadding(AndroidUtilities.m107dp(25), 0, AndroidUtilities.m107dp(23), AndroidUtilities.m107dp(12));
                ...
                transactionActionButtonsView.setPadding(AndroidUtilities.m107dp(25), 0, AndroidUtilities.m107dp(23), 0);
                ...
                stakingSafeWithdrawalView.setPadding(AndroidUtilities.m107dp(25), 0, AndroidUtilities.m107dp(23), 0);
                ...
                stakingWithdrawalFeeView.setPadding(AndroidUtilities.m107dp(25), 0, AndroidUtilities.m107dp(23), ManageLinksActivity.this.feeRow == -1 ? AndroidUtilities.m107dp(12) : 0);
                ...
                feeView.setPadding(AndroidUtilities.m107dp(25), 0, AndroidUtilities.m107dp(23), AndroidUtilities.m107dp(12));
                ...
                if (i == IdFabric$ViewTypes.HEADER_CELL_WITH_NETWORK) {
                    ...
                    donationBalanceView.setPadding(AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(15));
                    ...
                    donationSeeMoreButton.setPadding(AndroidUtilities.m107dp(23), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(23), AndroidUtilities.m107dp(15));
    ...
    public /* synthetic */ void lambda$revokePermanent$23(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported) {
        if (tLRPC$TL_error == null) {
            ...
            updateRecyclerViewAnimated(saveListState);
            BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.linkbroken, LocaleController.getString("InviteRevokedHint", C3632R.string.InviteRevokedHint)).show();
        }
    }
    ...
    public class LinkCell extends FrameLayout {
        ...
        */
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(64), 1073741824));
            this.paint2.setStrokeWidth(AndroidUtilities.m107dp(2));
        }
        ...
        */
        ...
        public void setLink(TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, int i) {
            ...
            if (tLRPC$TL_chatInviteExported.permanent && !tLRPC$TL_chatInviteExported.revoked) {
                ...
                dotDividerSpan.setTopPadding(AndroidUtilities.m108dp(1.5f));
                ...
                dotDividerSpan2.setTopPadding(AndroidUtilities.m108dp(1.5f));
                ...
                dotDividerSpan3.setTopPadding(AndroidUtilities.m108dp(1.5f));
    ...
    /* loaded from: classes5.dex */
    public class C66149 implements LinkEditActivity.Callback {
        C66149() {
        }
        ...
        public void onLinkCreated(final TLObject tLObject) {
            if (tLObject instanceof TLRPC$TL_chatInviteExported) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$9$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ManageLinksActivity.C66149.this.lambda$onLinkCreated$0(tLObject);
                    }
                }, 200L);
            }
        }
