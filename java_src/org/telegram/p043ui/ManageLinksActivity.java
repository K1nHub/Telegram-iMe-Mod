...
import com.iMe.p031ui.base.wallet_auth.JavaWalletAuthBaseFragment;
...
import com.iMe.p031ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda4;
...
import com.iMe.p031ui.wallet.home.tabs.binancepay.receive.WalletReceiveBinancePayView;
...
public class ManageLinksActivity extends JavaWalletAuthBaseFragment implements WalletReceiveBinancePayView, WalletSendAmountView, WalletDonationsView, StakingTransactionView, StakingCalculatorView, NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void access$9000(ManageLinksActivity manageLinksActivity) {
    ...
    public WalletReceiveBinancePayPresenter provideBinanceReceivePresenter() {
        return (WalletReceiveBinancePayPresenter) KoinJavaComponent.get(WalletReceiveBinancePayPresenter.class, null, new Function0() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda26
    ...
    public WalletSendAmountPresenter provideSendPresenter() {
        return (WalletSendAmountPresenter) KoinJavaComponent.get(WalletSendAmountPresenter.class, null, new Function0() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda25
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public StakingTransactionPresenter provideStakingTransactionPresenter() {
        return (StakingTransactionPresenter) KoinJavaComponent.get(StakingTransactionPresenter.class, null, new Function0() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda28
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public WalletDonationsPresenter provideDonationsPresenter() {
        return (WalletDonationsPresenter) KoinJavaComponent.get(WalletDonationsPresenter.class, null, new Function0() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda24
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public StakingCalculatorPresenter provideStakingCalculatorPresenter() {
        return (StakingCalculatorPresenter) KoinJavaComponent.get(StakingCalculatorPresenter.class, null, new Function0() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda27
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    @Override // com.iMe.p031ui.wallet.home.tabs.binancepay.receive.WalletReceiveBinancePayView
    ...
    public void showSuccessSend(String str) {
        showActionSuccess(this.resourceManager.getValue().getString(C3473R.string.wallet_amount_success_send_title), str);
    }
    ...
    public void showActionSuccess(String str, String str2) {
        DialogsFactoryKt.showSuccessAlert(this, str, str2, this.resourceManager.getValue().getString(C3473R.string.common_ok), new ManageLinksActivity$$ExternalSyntheticLambda12(this));
    }

    @Override // com.iMe.p031ui.wallet.staking.transaction.StakingTransactionView
    public void showActionError(String str, String str2) {
        DialogsFactoryKt.showErrorAlert(this, str, str2, this.resourceManager.getValue().getString(C3473R.string.common_ok), new ManageLinksActivity$$ExternalSyntheticLambda12(this));
    }
    ...
    public void showRecipientNotFoundError() {
        DialogsFactoryKt.showErrorAlert(this, this.resourceManager.getValue().getString(C3473R.string.wallet_amount_error_invalid_user_title), this.resourceManager.getValue().getString(C3473R.string.wallet_amount_error_invalid_user_description), this.resourceManager.getValue().getString(C3473R.string.wallet_amount_error_invalid_user_btn_txt), new ManageLinksActivity$$ExternalSyntheticLambda12(this));
    }

    @Override // com.iMe.p031ui.wallet.actions.send.amount.WalletSendAmountView
    public void showRecipientWalletNotActivatedError() {
        DialogsFactoryKt.showErrorAlert(this, this.resourceManager.getValue().getString(C3473R.string.wallet_amount_error_invalid_user_title), this.resourceManager.getValue().getString(C3473R.string.wallet_amount_error_user_wallet_not_activated_description), this.resourceManager.getValue().getString(C3473R.string.wallet_amount_error_invalid_user_btn_txt), new ManageLinksActivity$$ExternalSyntheticLambda12(this));
    }
    ...
    public void onSuccessValidation(DialogModel dialogModel, boolean z) {
        ...
        if (z) {
            ...
            checkBoxCell.setText(this.resourceManager.getValue().getString(C3473R.string.wallet_amount_send_message_checkbox_title), "", true, false);
    ...
    public void showLevelRequiredDialog(AccountLevel accountLevel, final TokenDetailed tokenDetailed) {
        DialogsFactoryKt.showStakingLevelRequiredDialog(this, this.resourceManager.getValue(), accountLevel, new Callbacks$Callback() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda13
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                ManageLinksActivity.this.lambda$showLevelRequiredDialog$8(tokenDetailed);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showLevelRequiredDialog$8(TokenDetailed tokenDetailed) {
    ...
    public void showChooseNetworkDialog(List<? extends NetworkItem> list, NetworkItem networkItem, Callbacks$Callback1<NetworkItem.Crypto> callbacks$Callback1) {
        showDialog(SelectNetworkBottomSheet.newInstance(getParentActivity(), networkItem, list, callbacks$Callback1));
    }
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        if (i == 34) {
            ...
            builder.setNegativeButton(LocaleController.getString("PermissionOpenSettings", C3473R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda2
                @Override // android.content.DialogInterface.OnClickListener
    ...
    public ArrayList<ActionBarMenuSubItem> getInputOptionsMenuItems(final LinkActionView linkActionView) {
        ...
        if (walletDonationsPresenter != null) {
            if (!walletDonationsPresenter.getCurrentDonationsAddress().isEmpty()) {
                ...
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("GetQRCode", C3473R.string.GetQRCode), C3473R.C3475drawable.msg_qrcode);
                ...
                actionBarMenuSubItem2.setTextAndIcon(this.resourceManager.getValue().getString(C3473R.string.channel_donations_unlink_address_dialog_title), C3473R.C3475drawable.msg_delete);
                ...
                if (this.donationsPresenter.isCryptoAddressCreated()) {
                    ...
                    actionBarMenuSubItem3.setTextAndIcon(this.resourceManager.getValue().getString(C3473R.string.channel_donations_link_non_castodial_wallet_address_dialog_title), C3473R.C3475drawable.msg_link2);
                ...
                actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("AuthAnotherClientScan", C3473R.string.AuthAnotherClientScan), C3473R.C3475drawable.msg_qrcode);
    ...
    public void openTwitterSearchScreen() {
        WalletSendAmountPresenter walletSendAmountPresenter = this.sendPresenter;
        if (walletSendAmountPresenter != null) {
            presentFragment(TwitterSearchFragment.newInstance(walletSendAmountPresenter.getSelectedNetwork().getBlockchainType(), new Callbacks$Callback2() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda10
    ...
    private void showDonationAddressQrCode() {
        ...
        qRCodeBottomSheet.setupWalletTypeReceive(this.resourceManager.getValue().getString(C3473R.string.wallet_receive_dialog_title), this.resourceManager.getValue().getString(C3473R.string.wallet_receive_dialog_btn_text), currentDonationsAddress);
    ...
    /* loaded from: classes3.dex */
    public class C62673 implements ChatRightsEditActivity.ChatRightsEditActivityDelegate {
        ...
        public void didSetRights(int i, TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights, String str) {
            ...
            if (user != null) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$3$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ManageLinksActivity.C62673.this.lambda$didSetRights$0(user);
                    }
                }, 200L);
            }
        }
    ...
    public void openAddAdminScreen() {
        ...
        chatRightsEditActivity.setDelegate(new C62673());
    ...
    public void openSelectToken(final LinkActionView linkActionView) {
        ...
        if (this.isWalletTransferType || this.isBinanceReplenishType) {
            WalletSendAmountPresenter walletSendAmountPresenter = this.sendPresenter;
            if (walletSendAmountPresenter != null) {
                walletSendAmountPresenter.startSelectTokenFlow(new Callbacks$Callback1() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda8
                    @Override // com.iMe.fork.utils.Callbacks$Callback1
                    public final void invoke(Object obj) {
                        ManageLinksActivity.this.lambda$openSelectToken$15(linkActionView, (TokenDetailed) obj);
                    }
                });
            }
            ...
            walletReceiveBinancePayPresenter.startSelectTokenFlow(new Callbacks$Callback1() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda9
                @Override // com.iMe.fork.utils.Callbacks$Callback1
                public final void invoke(Object obj) {
                    ManageLinksActivity.this.lambda$openSelectToken$16(linkActionView, (TokenDetailed) obj);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$openSelectToken$15(LinkActionView linkActionView, TokenDetailed tokenDetailed) {
        if (!this.sendPresenter.getSelectedAmount().isEmpty()) {
            this.sendPresenter.resetStateIfNeed();
        }
        linkActionView.setText(this.resourceManager.getValue().getString(C3473R.string.wallet_common_token_name_with_ticker, tokenDetailed.getName(), tokenDetailed.getTicker()));
        if (this.isWalletTransferType) {
            GlideHelper.loadImageAsBitmap(getParentActivity(), tokenDetailed.getAvatarUrl(), new CreateCryptoBoxFragment$$ExternalSyntheticLambda4(linkActionView), true);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$openSelectToken$16(LinkActionView linkActionView, TokenDetailed tokenDetailed) {
        linkActionView.setText(this.resourceManager.getValue().getString(C3473R.string.wallet_common_token_name_with_ticker, tokenDetailed.getName(), tokenDetailed.getTicker()));
        GlideHelper.loadBinanceImageAsBitmap(getParentActivity(), tokenDetailed.getAvatarUrl(), new CreateCryptoBoxFragment$$ExternalSyntheticLambda4(linkActionView));
    }
    ...
    public void openChooseContact() {
        ...
        if (this.isBinanceReplenishType) {
            ...
            if (walletSendAmountPresenter != null) {
                if (TextUtils.isEmpty(walletSendAmountPresenter.getSelectedAddress())) {
                    string = this.resourceManager.getValue().getString(C3473R.string.binance_replenish_token_choose_token_first_error);
                } else {
                    string = this.resourceManager.getValue().getString(C3473R.string.binance_replenish_token_choose_token_cant_change_error);
                }
        ...
        if (this.isWalletTransferType) {
            ...
            if (walletSendAmountPresenter2 != null) {
                bundle.putString("network_type", walletSendAmountPresenter2.getSelectedNetwork().getId());
            }
        ...
        if (this.isWalletTransferType) {
            contactsActivity.setUserWithCryptoAddressDelegate(new Callbacks$Callback2() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda11
                @Override // com.iMe.fork.utils.Callbacks$Callback2
                public final void invoke(Object obj, Object obj2) {
            ...
            contactsActivity.setDelegate(new ContactsActivity.ContactsActivityDelegate() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda38
    ...
    public void showCommonInfoAlert(String str, String str2) {
        showDialog(DialogsFactoryKt.createInfoBottomSheetDialog(this, str, str2, LocaleController.getString("OK", C3473R.string.OK), new Callbacks$Callback() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda14
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                ManageLinksActivity.lambda$showCommonInfoAlert$19();
            }
        }));
    }

    private void setupStakingReplenishmentInfoMenu() {
        ActionBarMenuItem addItem = this.actionBar.createMenu().addItem(IdFabric$Menu.OPTIONS, C3473R.C3475drawable.ic_ab_other);
        addItem.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
        addItem.addSubItem(IdFabric$Menu.SMART_CONTRACT, C3473R.C3475drawable.fork_ic_web_26, this.resourceManager.getValue().getString(C3473R.string.staking_details_contract_action));
        addItem.addSubItem(IdFabric$Menu.STAKING_CONDITIONS, C3473R.C3475drawable.fork_ic_description_26, this.resourceManager.getValue().getString(C3473R.string.staking_deposit_conditions));
    }
    ...
    private class EmptyView extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public EmptyView(Context context) {
            ...
            setPadding(0, AndroidUtilities.m72dp(12), 0, AndroidUtilities.m72dp(12));
            setOrientation(1);
                                ...
                                if (!ManageLinksActivity.this.isStakingProfitType) {
                                    if (!ManageLinksActivity.this.isStakingWithdrawType) {
                                        if (ManageLinksActivity.this.isStakingCalculatorType) {
                                            i = C3473R.raw.fork_staking_calculator;
                                        }
                                    } else {
                                        i = C3473R.raw.fork_staking_withdraw;
                                    }
                                } else {
                                    i = C3473R.raw.fork_staking_profit;
                                }
                            } else {
                                i = C3473R.raw.fork_staking_replenish;
                            }
                        } else {
                            i = C3473R.raw.fork_donations;
                        }
                    } else {
                        i = C3473R.raw.fork_crypto_transfers;
                    }
                } else {
                    i = C3473R.raw.fork_binance_pay_create_collection;
                }
    ...
    public ManageLinksActivity(long j, long j2, int i) {
        ...
        this.linkEditActivityCallback = new C62739();
    ...
    public void loadLinks(boolean z) {
        if (this.loadAdmins && !this.adminsLoaded) {
            ...
            getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_messages_getAdminsWithInvites, new RequestDelegate() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda30
            ...
            getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_messages_getExportedChatInvites, new RequestDelegate() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda34
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadLinks$21(final TLRPC$TL_error tLRPC$TL_error, final TLObject tLObject) {
        getNotificationCenter().doOnIdle(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$loadLinks$22(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda20
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$loadLinks$20(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (tLRPC$TL_error == null) {
            ...
            for (int i2 = 0; i2 < tLRPC$TL_messages_chatAdminsWithInvites.users.size(); i2++) {
                ...
                this.users.put(Long.valueOf(tLRPC$User.f1685id), tLRPC$User);
            }
        }
    ...
    public /* synthetic */ void lambda$loadLinks$24(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, final TLRPC$TL_error tLRPC$TL_error, final TLObject tLObject, final boolean z) {
        getNotificationCenter().doOnIdle(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    public /* synthetic */ void lambda$loadLinks$23(org.telegram.tgnet.TLRPC$TL_chatInviteExported r7, org.telegram.tgnet.TLRPC$TL_error r8, org.telegram.tgnet.TLObject r9, boolean r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ManageLinksActivity.lambda$loadLinks$23(org.telegram.tgnet.TLRPC$TL_chatInviteExported, org.telegram.tgnet.TLRPC$TL_error, org.telegram.tgnet.TLObject, boolean):void");
    }
    ...
    public View createView(final Context context) {
        ...
        if (this.isStakingCalculatorType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.staking_calculator_title));
            this.actionBar.createMenu().addItem(IdFabric$Menu.STAKING_HELP, C3473R.C3475drawable.msg_info);
        } else if (this.isStakingDepositType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.staking_replenishment_title));
            setupStakingReplenishmentInfoMenu();
        } else if (this.isStakingProfitType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.staking_profit_title));
            this.actionBar.createMenu().addItem(IdFabric$Menu.STAKING_HELP, C3473R.C3475drawable.msg_info);
        } else if (this.isStakingWithdrawType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.staking_withdraw_title));
            this.actionBar.createMenu().addItem(IdFabric$Menu.STAKING_HELP, C3473R.C3475drawable.msg_info);
        } else if (this.isBinancePayCreateCollectionType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.wallet_binance_pay_action_receive));
        } else if (this.isWalletTransferType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.profile_user_id_action_transfer));
        } else if (this.isBinanceReplenishType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.binance_replenish_token_toolbar_title));
        } else if (this.isDonationsType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.channel_donations_toolbar_title));
        } else if (this.isDonationsTransferType) {
            this.actionBar.setTitle(this.resourceManager.getValue().getString(C3473R.string.transfer_donations_toolbar_title));
        } else {
            this.actionBar.setTitle(LocaleController.getString("InviteLinks", C3473R.string.InviteLinks));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ManageLinksActivity.5
            ...
            public void onItemClick(int i) {
                ...
                if (i == IdFabric$Menu.STAKING_CONDITIONS && (stakingTransactionPresenter = ManageLinksActivity.this.stakingTransactionPresenter) != null) {
                    ...
                    if (!ManageLinksActivity.this.isStakingProfitType) {
                        if (ManageLinksActivity.this.isStakingWithdrawType) {
                            ...
                            if (manageLinksActivity2.stakingTransactionPresenter != null) {
                                manageLinksActivity2.showCommonInfoAlert(((ResourceManager) manageLinksActivity2.resourceManager.getValue()).getString(C3473R.string.wallet_crypto_buy_information_dialog_title), ManageLinksActivity.this.stakingTransactionPresenter.getWithdrawalHelpAlertText());
                                return;
                            }
                            return;
                        }
                    ...
                    manageLinksActivity3.showCommonInfoAlert(((ResourceManager) manageLinksActivity3.resourceManager.getValue()).getString(C3473R.string.wallet_crypto_buy_information_dialog_title), ((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3473R.string.staking_profit_help_alert));
                } else {
                    ManageLinksActivity manageLinksActivity4 = ManageLinksActivity.this;
                    manageLinksActivity4.showCommonInfoAlert(((ResourceManager) manageLinksActivity4.resourceManager.getValue()).getString(C3473R.string.staking_calculator_help_alert_title), ((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3473R.string.staking_calculator_help_alert_description));
                }
            }
        });
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda36
            @Override // org.telegram.p043ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i2) {
                ManageLinksActivity.this.lambda$createView$29(context, view, i2);
            }
        });
        this.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda37
        ...
        this.linkIcon = ContextCompat.getDrawable(context, C3473R.C3475drawable.msg_link_1);
        this.linkIconRevoked = ContextCompat.getDrawable(context, C3473R.C3475drawable.msg_link_2);
    ...
    public /* synthetic */ void lambda$createView$29(Context context, View view, int i) {
        ...
        if (i >= i2 && i < this.donationTransactionsEndRow) {
            ...
            if (i >= i4 && i < this.revokedLinksEndRow) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString("DeleteAllRevokedLinks", C3473R.string.DeleteAllRevokedLinks));
                builder.setMessage(LocaleController.getString("DeleteAllRevokedLinkHelp", C3473R.string.DeleteAllRevokedLinkHelp));
                builder.setPositiveButton(LocaleController.getString("Delete", C3473R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void lambda$createView$28(DialogInterface dialogInterface, int i) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_deleteRevokedExportedChatInvites, new RequestDelegate() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda29
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$createView$27(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(ManageLinksActivity manageLinksActivity, Context context) {
            ...
            if (manageLinksActivity.isStakingCalculatorType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.staking_calculator_description));
            } else if (manageLinksActivity.isStakingDepositType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.staking_replenishment_description));
            } else if (manageLinksActivity.isStakingProfitType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.staking_profit_description));
            } else if (manageLinksActivity.isStakingWithdrawType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.staking_withdraw_description));
            } else if (manageLinksActivity.isBinancePayCreateCollectionType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.wallet_binance_receive_description));
            } else if (manageLinksActivity.isWalletTransferType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.wallet_banner_slide_crypto_transfers_long_description));
            } else if (manageLinksActivity.isBinanceReplenishType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.binance_replenish_token_description));
            } else if (manageLinksActivity.isDonationsType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.channel_donations_description));
            } else if (manageLinksActivity.isDonationsTransferType) {
                this.messageTextView.setText(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.transfer_donations_description));
            } else {
                TextView textView2 = this.messageTextView;
                if (manageLinksActivity.isChannel) {
                    i = C3473R.string.PrimaryLinkHelpChannel;
                    str = "PrimaryLinkHelpChannel";
                } else {
                    i = C3473R.string.PrimaryLinkHelp;
                    str = "PrimaryLinkHelp";
                }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == IdFabric$ViewTypes.CHOOSE_RECIPIENT_OPTIONS) {
                ...
                Callbacks$Callback callbacks$Callback = new Callbacks$Callback() { // from class: org.telegram.ui.ManageLinksActivity$ListAdapter$$ExternalSyntheticLambda25
                    @Override // com.iMe.fork.utils.Callbacks$Callback
                    public final void invoke() {
                ...
                Callbacks$Callback callbacks$Callback2 = new Callbacks$Callback() { // from class: org.telegram.ui.ManageLinksActivity$ListAdapter$$ExternalSyntheticLambda26
                    @Override // com.iMe.fork.utils.Callbacks$Callback
                    public final void invoke() {
                ...
                chooseRecipientOptionsView.setPadding(AndroidUtilities.m72dp(25), 0, AndroidUtilities.m72dp(23), AndroidUtilities.m72dp(12));
                ...
                stakingPercentageView.setPadding(AndroidUtilities.m72dp(25), 0, AndroidUtilities.m72dp(23), AndroidUtilities.m72dp(12));
                ...
                transactionActionButtonsView.setPadding(AndroidUtilities.m72dp(25), 0, AndroidUtilities.m72dp(23), 0);
                ...
                stakingSafeWithdrawalView.setPadding(AndroidUtilities.m72dp(25), 0, AndroidUtilities.m72dp(23), 0);
                ...
                stakingWithdrawalFeeView.setPadding(AndroidUtilities.m72dp(25), 0, AndroidUtilities.m72dp(23), ManageLinksActivity.this.feeRow == -1 ? AndroidUtilities.m72dp(12) : 0);
                ...
                feeView.setPadding(AndroidUtilities.m72dp(25), 0, AndroidUtilities.m72dp(ManageLinksActivity.this.isStakingWithdrawType ? 2 : 23), AndroidUtilities.m72dp(12));
                ...
                if (i == IdFabric$ViewTypes.HEADER_CELL_WITH_NETWORK) {
                    ...
                    headerCellWithImageViewButtonWrapper2.getImageView().setImageResource(C3473R.C3475drawable.msg_info);
                    ...
                    donationBalanceView.setPadding(AndroidUtilities.m72dp(15), AndroidUtilities.m72dp(6), AndroidUtilities.m72dp(15), AndroidUtilities.m72dp(15));
                    ...
                    switch (i) {
                        ...
                        case 7:
                            ...
                            shadowSectionCell.setBackground(Theme.getThemedDrawableByKey(this.mContext, C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                            linkActionView = shadowSectionCell;
                            break;
                        case 8:
                            TextSettingsCell textSettingsCell = new TextSettingsCell(this.mContext);
                            textSettingsCell.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                            textSettingsCell.setText(LocaleController.getString("DeleteAllRevokedLinks", C3473R.string.DeleteAllRevokedLinks), false);
                        ...
                        case 9:
                            ...
                            if (ManageLinksActivity.this.isDonationsType) {
                                textInfoPrivacyCell.setText(((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3473R.string.channel_donations_admin_bot_information, AppConfiguration$Wallet.getWalletBotUsernameWithAT()));
                                ViewExtKt.setSubstringClickListener(textInfoPrivacyCell.getTextView(), AppConfiguration$Wallet.getWalletBotUsernameWithAT(), false, new Callbacks$Callback() { // from class: org.telegram.ui.ManageLinksActivity$ListAdapter$$ExternalSyntheticLambda15
                                    @Override // com.iMe.fork.utils.Callbacks$Callback
                                    public final void invoke() {
                                ...
                                String string = ((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3473R.string.channel_donations_admin_bot_link_key);
                                final ManageLinksActivity manageLinksActivity5 = ManageLinksActivity.this;
                                ViewExtKt.setSubstringClickListener(textView, string, false, new Callbacks$Callback() { // from class: org.telegram.ui.ManageLinksActivity$ListAdapter$$ExternalSyntheticLambda27
                                    @Override // com.iMe.fork.utils.Callbacks$Callback
                                    public final void invoke() {
                                        ManageLinksActivity.access$9000(ManageLinksActivity.this);
                                    }
                                });
                            } else {
                                textInfoPrivacyCell.setText(LocaleController.getString("CreateNewLinkHelp", C3473R.string.CreateNewLinkHelp));
                            }
                            textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.mContext, C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                        ...
                        default:
                            ...
                            hintInnerCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundWhite));
                            linkActionView = hintInnerCell;
                            break;
                    }
                } else {
                    View donationSeeMoreButton = new DonationSeeMoreButton(this.mContext);
                    donationSeeMoreButton.setPadding(AndroidUtilities.m72dp(23), AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(23), AndroidUtilities.m72dp(15));
        ...
        /* JADX WARN: Code restructure failed: missing block: B:145:0x0480, code lost:
            if (r17 == (r15.this$0.linksEndRow - 1)) goto L180;
         */
        /* JADX WARN: Code restructure failed: missing block: B:152:0x04af, code lost:
            if (r17 == (r15.this$0.revokedLinksEndRow - 1)) goto L180;
         */
        ...
        */
        ...
        public /* synthetic */ void lambda$onBindViewHolder$5() {
            ManageLinksActivity manageLinksActivity = ManageLinksActivity.this;
            manageLinksActivity.showCommonInfoAlert(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.wallet_crypto_buy_information_dialog_title), ((ResourceManager) ManageLinksActivity.this.resourceManager.getValue()).getString(C3473R.string.staking_replenishment_percentage_info_alert));
        }
        ...
        public /* synthetic */ void lambda$onBindViewHolder$9() {
            ManageLinksActivity manageLinksActivity = ManageLinksActivity.this;
            manageLinksActivity.showCommonInfoAlert(((ResourceManager) manageLinksActivity.resourceManager.getValue()).getString(C3473R.string.staking_withdraw_safe_withdrawal_help_alert_title), ManageLinksActivity.this.stakingTransactionPresenter.getSafeWithdrawalHelpAlertText());
        }
        ...
        public /* synthetic */ void lambda$onBindViewHolder$16(View view) {
            ...
            manageLinksActivity.presentFragment(StakingCalculatorProgrammesFragment.newInstance(new Callbacks$Callback1() { // from class: org.telegram.ui.ManageLinksActivity$ListAdapter$$ExternalSyntheticLambda7
                @Override // com.iMe.fork.utils.Callbacks$Callback1
                public final void invoke(Object obj) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onBindViewHolder$18(LinkActionView linkActionView) {
            ManageLinksActivity.this.transferAmount(linkActionView.getEditText().getText().toString());
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onBindViewHolder$20(LinkActionView linkActionView) {
            ManageLinksActivity.this.createCollection(linkActionView.getEditText().getText().toString());
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onBindViewHolder$22(LinkActionView linkActionView) {
            ManageLinksActivity.this.saveDonationsAddress(linkActionView.getEditText().getText().toString());
        }
    ...
    public void revokePermanent() {
        if (this.adminId == getAccountInstance().getUserConfig().clientUserId) {
            ...
            int sendRequest = getConnectionsManager().sendRequest(tLRPC$TL_messages_exportChatInvite, new RequestDelegate() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda31
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$revokePermanent$31(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported) {
        if (tLRPC$TL_error == null) {
            ...
            updateRecyclerViewAnimated(saveListState);
            BulletinFactory.m32of(this).createSimpleBulletin(C3473R.raw.linkbroken, LocaleController.getString("InviteRevokedHint", C3473R.string.InviteRevokedHint)).show();
        }
    }
    ...
    public class LinkCell extends FrameLayout {
        ...
        public LinkCell(Context context) {
            ...
            imageView.setImageDrawable(ContextCompat.getDrawable(context, C3473R.C3475drawable.ic_ab_other));
        ...
        public /* synthetic */ void lambda$new$2(ArrayList arrayList, DialogInterface dialogInterface, int i) {
            ...
            if (intValue == 0) {
                ...
                try {
                    ...
                    ManageLinksActivity.this.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C3473R.string.InviteToGroupByLink)), 500);
                } catch (Exception e2) {
                    FileLog.m67e(e2);
                }
            } else if (intValue == 2) {
                ...
                builder.setMessage(LocaleController.getString("RevokeAlert", C3473R.string.RevokeAlert));
                builder.setTitle(LocaleController.getString("RevokeLink", C3473R.string.RevokeLink));
                builder.setPositiveButton(LocaleController.getString("RevokeButton", C3473R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                ...
                builder2.setTitle(LocaleController.getString("DeleteLink", C3473R.string.DeleteLink));
                builder2.setMessage(LocaleController.getString("DeleteLinkHelp", C3473R.string.DeleteLinkHelp));
                builder2.setPositiveButton(LocaleController.getString("Delete", C3473R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface2, int i2) {
        ...
        */
        ...
        public void setLink(TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, int i) {
            ...
            if (i4 == 0 && tLRPC$TL_chatInviteExported.usage_limit == 0 && tLRPC$TL_chatInviteExported.requested == 0) {
                formatPluralString = LocaleController.getString("NoOneJoinedYet", C3473R.string.NoOneJoinedYet);
            } else {
            ...
            if (tLRPC$TL_chatInviteExported.permanent && !tLRPC$TL_chatInviteExported.revoked) {
                ...
                spannableStringBuilder2.append((CharSequence) LocaleController.getString("Permanent", C3473R.string.Permanent));
                ...
                if (tLRPC$TL_chatInviteExported.revoked && tLRPC$TL_chatInviteExported.usage == 0) {
                    formatPluralString = LocaleController.getString("NoOneJoined", C3473R.string.NoOneJoined);
                }
                ...
                dotDividerSpan2.setTopPadding(AndroidUtilities.m73dp(1.5f));
                ...
                if (z || (i3 = tLRPC$TL_chatInviteExported.usage_limit) <= 0 || tLRPC$TL_chatInviteExported.usage < i3) {
                    if (z) {
                        i2 = C3473R.string.Revoked;
                        str = "Revoked";
                    } else {
                        i2 = C3473R.string.Expired;
                        str = "Expired";
                    }
                    spannableStringBuilder3.append((CharSequence) LocaleController.getString(str, i2));
                } else {
                    spannableStringBuilder3.append((CharSequence) LocaleController.getString("LinkLimitReached", C3473R.string.LinkLimitReached));
                }
                ...
                dotDividerSpan3.setTopPadding(AndroidUtilities.m73dp(1.5f));
    ...
    public void deleteLink(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_deleteExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda33
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void revokeLink(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_editExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda32
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* loaded from: classes3.dex */
    public class C62739 implements LinkEditActivity.Callback {
        C62739() {
        }
        ...
        public void onLinkCreated(final TLObject tLObject) {
            if (tLObject instanceof TLRPC$TL_chatInviteExported) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$9$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ManageLinksActivity.C62739.this.lambda$onLinkCreated$0(tLObject);
                    }
                }, 200L);
            }
        }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda35
