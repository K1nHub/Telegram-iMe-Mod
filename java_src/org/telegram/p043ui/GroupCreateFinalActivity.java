    ...
    public View createView(Context context) {
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout2 = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.GroupCreateFinalActivity.2
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                if (measureKeyboardHeight() > AndroidUtilities.m107dp(20) && !GroupCreateFinalActivity.this.editText.isPopupShowing()) {
                        ...
                        if (GroupCreateFinalActivity.this.editText != null && GroupCreateFinalActivity.this.editText.isPopupView(childAt)) {
                            if (AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) {
                                if (AndroidUtilities.isTablet()) {
                                    childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m107dp(AndroidUtilities.isTablet() ? 200 : 320), (paddingTop - AndroidUtilities.statusBarHeight) + getPaddingTop()), 1073741824));
                                } else {
            ...
            */
            public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                ...
                Lcf:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.GroupCreateFinalActivity.C63612.onLayout(boolean, int, int, int, int):void");
            }
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m107dp(this.chatType == 5 ? 16 : 32));
        ...
        this.cameraDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m107dp(60), AndroidUtilities.m107dp(60), false, null);
        ...
        this.avatarEditor.setPadding(AndroidUtilities.m107dp(0), 0, 0, AndroidUtilities.m107dp(1));
        ...
        this.floatingButtonIcon.setPadding(0, AndroidUtilities.m107dp(2), 0, 0);
