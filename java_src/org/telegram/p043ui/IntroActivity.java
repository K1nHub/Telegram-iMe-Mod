...
public class IntroActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean onFragmentCreate() {
        ...
        this.titles = new String[]{LocaleController.getString("Page1Title", C3473R.string.Page1Title), LocaleController.getString("Page2Title", C3473R.string.Page2Title), LocaleController.getString("Page3Title", C3473R.string.Page3Title), LocaleController.getString("Page5Title", C3473R.string.Page5Title), LocaleController.getString("Page4Title", C3473R.string.Page4Title), LocaleController.getString("Page6Title", C3473R.string.Page6Title)};
        this.messages = new String[]{LocaleController.getString("Page1Message", C3473R.string.Page1Message), LocaleController.getString("Page2Message", C3473R.string.Page2Message), LocaleController.getString("Page3Message", C3473R.string.Page3Message), LocaleController.getString("Page5Message", C3473R.string.Page5Message), LocaleController.getString("Page4Message", C3473R.string.Page4Message), LocaleController.getString("Page6Message", C3473R.string.Page6Message)};
        return true;
    }
    ...
    public View createView(Context context) {
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.IntroActivity.1
            ...
            protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                int i5 = (i4 - i2) / 4;
                int i6 = i5 * 3;
                int m72dp = (i6 - AndroidUtilities.m72dp(275)) / 2;
                IntroActivity.this.frameLayout2.layout(0, m72dp, IntroActivity.this.frameLayout2.getMeasuredWidth(), IntroActivity.this.frameLayout2.getMeasuredHeight() + m72dp);
                int m72dp2 = m72dp + AndroidUtilities.m72dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION) + AndroidUtilities.m72dp(122);
                int measuredWidth = (getMeasuredWidth() - IntroActivity.this.bottomPages.getMeasuredWidth()) / 2;
                IntroActivity.this.bottomPages.layout(measuredWidth, m72dp2, IntroActivity.this.bottomPages.getMeasuredWidth() + measuredWidth, IntroActivity.this.bottomPages.getMeasuredHeight() + m72dp2);
                ...
                int m72dp3 = measuredHeight - AndroidUtilities.m72dp(30);
                int measuredWidth3 = (getMeasuredWidth() - IntroActivity.this.switchLanguageTextView.getMeasuredWidth()) / 2;
                IntroActivity.this.switchLanguageTextView.layout(measuredWidth3, m72dp3 - IntroActivity.this.switchLanguageTextView.getMeasuredHeight(), IntroActivity.this.switchLanguageTextView.getMeasuredWidth() + measuredWidth3, m72dp3);
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) frameLayout.getLayoutParams();
                int m72dp4 = AndroidUtilities.m72dp(r4) + (AndroidUtilities.isTablet() ? 0 : AndroidUtilities.statusBarHeight);
                if (marginLayoutParams.topMargin != m72dp4) {
                    marginLayoutParams.topMargin = m72dp4;
        ...
        int i = C3473R.raw.sun;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i, String.valueOf(i), AndroidUtilities.m72dp(28), AndroidUtilities.m72dp(28), true, null);
        ...
        rLottieImageView.setContentDescription(LocaleController.getString(C3473R.string.AccDescrSwitchToDayTheme));
        ...
        textureView.setSurfaceTextureListener(new TextureView$SurfaceTextureListenerC60382());
        ...
        TextView textView = new TextView(this, context) { // from class: org.telegram.ui.IntroActivity.4
            ...
            protected void onMeasure(int i2, int i3) {
                if (View.MeasureSpec.getSize(i2) > AndroidUtilities.m72dp(260)) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(320), 1073741824), i3);
                } else {
        ...
        textView.setText(LocaleController.getString("StartMessaging", C3473R.string.StartMessaging));
        ...
        this.startMessagingButton.setPadding(AndroidUtilities.m72dp(34), 0, AndroidUtilities.m72dp(34), 0);
    ...
    /* loaded from: classes3.dex */
    public class TextureView$SurfaceTextureListenerC60382 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        }

        TextureView$SurfaceTextureListenerC60382() {
        }
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
            ...
            IntroActivity.this.eglThread.postRunnable(new Runnable() { // from class: org.telegram.ui.IntroActivity$2$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    IntroActivity.TextureView$SurfaceTextureListenerC60382.this.lambda$onSurfaceTextureAvailable$0();
                }
            });
    ...
    public /* synthetic */ void lambda$createView$2(View view) {
        ...
        NotificationCenter.getGlobalInstance().addObserver(new C60415(alertDialog), NotificationCenter.reloadInterface);
    ...
    /* loaded from: classes3.dex */
    public class C60415 implements NotificationCenter.NotificationCenterDelegate {
        final /* synthetic */ AlertDialog val$loaderDialog;

        C60415(AlertDialog alertDialog) {
        ...
        public void didReceivedNotification(int i, int i2, Object... objArr) {
            if (i == NotificationCenter.reloadInterface) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.IntroActivity$5$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        IntroActivity.C60415.this.lambda$didReceivedNotification$0();
                    }
                }, 100L);
            }
        }
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            FrameLayout frameLayout = new FrameLayout(this, viewGroup.getContext()) { // from class: org.telegram.ui.IntroActivity.IntroAdapter.1
                ...
                protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                    int m72dp = (((((i5 - i3) / 4) * 3) - AndroidUtilities.m72dp(275)) / 2) + AndroidUtilities.m72dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION) + AndroidUtilities.m72dp(16);
                    int m72dp2 = AndroidUtilities.m72dp(18);
                    TextView textView3 = textView;
                    textView3.layout(m72dp2, m72dp, textView3.getMeasuredWidth() + m72dp2, textView.getMeasuredHeight() + m72dp);
                    int textSize = ((int) (m72dp + textView.getTextSize())) + AndroidUtilities.m72dp(16);
                    int m72dp3 = AndroidUtilities.m72dp(16);
                    TextView textView4 = textView2;
                    textView4.layout(m72dp3, textSize, textView4.getMeasuredWidth() + m72dp3, textView2.getMeasuredHeight() + textSize);
                }
            };
    ...
    public class EGLThread extends DispatchQueue {
        ...
        public static /* synthetic */ Bitmap lambda$new$0(Void r6) {
            int m72dp = AndroidUtilities.m72dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION);
            Bitmap createBitmap = Bitmap.createBitmap(AndroidUtilities.m72dp(200), m72dp, Bitmap.Config.ARGB_8888);
            Canvas canvas = new Canvas(createBitmap);
            canvas.drawColor(Theme.getColor(Theme.key_windowBackgroundWhite));
            Paint paint = new Paint(1);
            paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
            canvas.drawCircle(createBitmap.getWidth() / 2.0f, createBitmap.getHeight() / 2.0f, m72dp / 2.0f, paint);
            return createBitmap;
        }
                ...
                public void run() {
                    ...
                    if (EGLThread.this.initied) {
                        ...
                        if ((EGLThread.this.eglContext.equals(EGLThread.this.egl10.eglGetCurrentContext()) && EGLThread.this.eglSurface.equals(EGLThread.this.egl10.eglGetCurrentSurface(12377))) || EGLThread.this.egl10.eglMakeCurrent(EGLThread.this.eglDisplay, EGLThread.this.eglSurface, EGLThread.this.eglSurface, EGLThread.this.eglContext)) {
                            ...
                            FileLog.m69e("eglMakeCurrent failed " + GLUtils.getEGLErrorString(EGLThread.this.egl10.eglGetError()));
                        }
                    }
                }
            };
            ...
            if (!this.egl10.eglChooseConfig(this.eglDisplay, EmuDetector.with(IntroActivity.this.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                ...
                if (surfaceTexture instanceof SurfaceTexture) {
                    ...
                    if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                        ...
                        loadTexture(C3473R.C3475drawable.intro_fast_arrow_shadow, 0);
                        loadTexture(C3473R.C3475drawable.intro_fast_arrow, 1);
                        loadTexture(C3473R.C3475drawable.intro_fast_body, 2);
                        loadTexture(C3473R.C3475drawable.intro_fast_spiral, 3);
                        loadTexture(C3473R.C3475drawable.intro_ic_bubble_dot, 4);
                        loadTexture(C3473R.C3475drawable.intro_ic_bubble, 5);
                        loadTexture(C3473R.C3475drawable.intro_ic_cam_lens, 6);
                        loadTexture(C3473R.C3475drawable.intro_ic_cam, 7);
                        loadTexture(C3473R.C3475drawable.intro_ic_pencil, 8);
                        loadTexture(C3473R.C3475drawable.intro_ic_pin, 9);
                        loadTexture(C3473R.C3475drawable.intro_ic_smile_eye, 10);
                        loadTexture(C3473R.C3475drawable.intro_ic_smile, 11);
                        loadTexture(C3473R.C3475drawable.intro_ic_videocam, 12);
                        loadTexture(C3473R.C3475drawable.intro_knot_down, 13);
                        loadTexture(C3473R.C3475drawable.intro_knot_up, 14);
                        loadTexture(C3473R.C3475drawable.intro_powerful_infinity_white, 15);
                        loadTexture(C3473R.C3475drawable.intro_powerful_infinity, 16);
                        loadTexture(C3473R.C3475drawable.intro_powerful_mask, 17, Theme.getColor(Theme.key_windowBackgroundWhite), false);
                        loadTexture(C3473R.C3475drawable.intro_powerful_star, 18);
                        loadTexture(C3473R.C3475drawable.intro_private_door, 19);
                        loadTexture(C3473R.C3475drawable.intro_private_screw, 20);
                        loadTexture(C3473R.C3475drawable.fork_intro_plane, 21);
        ...
        public static /* synthetic */ Bitmap lambda$initGL$1(Void r4) {
            ...
            paint.setColor(ContextCompat.getColor(ApplicationLoader.applicationContext, C3473R.C3474color.fork_color));
            int m72dp = AndroidUtilities.m72dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION);
    ...
    private void updateColors(boolean z) {
        ...
        textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(m72dp, Theme.getColor(i2), Theme.getColor(Theme.key_chats_actionPressedBackground)));
    ...
    public /* synthetic */ void lambda$updateColors$6() {
        EGLThread eGLThread = this.eglThread;
        int i = C3473R.C3475drawable.intro_powerful_mask;
