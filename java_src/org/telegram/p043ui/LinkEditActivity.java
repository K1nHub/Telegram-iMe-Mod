...
public class LinkEditActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        ...
        int i = this.type;
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString("NewLink", C3632R.string.NewLink));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("EditLink", C3632R.string.EditLink));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C3704ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.LinkEditActivity.1
        ...
        int i2 = this.type;
        if (i2 == 0) {
            this.createTextView.setText(LocaleController.getString("CreateLinkHeader", C3632R.string.CreateLinkHeader));
        } else if (i2 == 1) {
            this.createTextView.setText(LocaleController.getString("SaveLinkHeader", C3632R.string.SaveLinkHeader));
        }
        ...
        this.createTextView.setPadding(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(8));
        this.actionBar.addView(this.createTextView, LayoutHelper.createFrame(-2, -2, 8388629, 0, this.actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight / AndroidUtilities.m107dp(2) : 0, 0, 0));
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.LinkEditActivity.2
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                if (i5 == i6 || i6 <= AndroidUtilities.m107dp(20) || !z2) {
                ...
                if (i7 != 0 && i7 < AndroidUtilities.m107dp(20)) {
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.LinkEditActivity.3
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                int m107dp2 = size - ((AndroidUtilities.m107dp(48) + AndroidUtilities.m107dp(24)) + AndroidUtilities.m107dp(16));
                if (i5 >= m107dp2) {
                    m107dp = AndroidUtilities.m107dp(24);
                } else {
                    m107dp = (AndroidUtilities.m107dp(24) + m107dp2) - i5;
                }
                if (((LinearLayout.LayoutParams) LinkEditActivity.this.buttonTextView.getLayoutParams()).topMargin != m107dp) {
                    int i7 = ((LinearLayout.LayoutParams) LinkEditActivity.this.buttonTextView.getLayoutParams()).topMargin;
                    ((LinearLayout.LayoutParams) LinkEditActivity.this.buttonTextView.getLayoutParams()).topMargin = m107dp;
                    if (!LinkEditActivity.this.firstLayout) {
                        LinkEditActivity.this.buttonTextView.setTranslationY(i7 - m107dp);
        ...
        int i3 = this.type;
        if (i3 == 0) {
            this.buttonTextView.setText(LocaleController.getString("CreateLink", C3632R.string.CreateLink));
        } else if (i3 == 1) {
            this.buttonTextView.setText(LocaleController.getString("SaveLink", C3632R.string.SaveLink));
        }
        ...
        if (chat == null || chat.username == null) {
            ...
            this.approveCell.setTextAndCheck(LocaleController.getString("ApproveNewMembers", C3632R.string.ApproveNewMembers), false, false);
        ...
        int i5 = C3632R.C3634drawable.greydivider;
        int i6 = Theme.key_windowBackgroundGrayShadow;
        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(context, i5, i6));
        if (z) {
            textInfoPrivacyCell.setText(LocaleController.getString("ApproveNewMembersDescription", C3632R.string.ApproveNewMembersDescription));
        }
        linearLayout.addView(textInfoPrivacyCell);
        HeaderCell headerCell = new HeaderCell(context);
        this.timeHeaderCell = headerCell;
        headerCell.setText(LocaleController.getString("LimitByPeriod", C3632R.string.LimitByPeriod));
        ...
        textView3.setPadding(AndroidUtilities.m107dp(22), 0, AndroidUtilities.m107dp(22), 0);
        this.timeEditText.setGravity(16);
        this.timeEditText.setTextSize(1, 16.0f);
        this.timeEditText.setHint(LocaleController.getString("TimeLimitHint", C3632R.string.TimeLimitHint));
        ...
        textInfoPrivacyCell2.setText(LocaleController.getString("TimeLimitHelp", C3632R.string.TimeLimitHelp));
        linearLayout.addView(this.divider);
        HeaderCell headerCell2 = new HeaderCell(context);
        this.usesHeaderCell = headerCell2;
        headerCell2.setText(LocaleController.getString("LimitNumberOfUses", C3632R.string.LimitNumberOfUses));
        ...
        editText.setPadding(AndroidUtilities.m107dp(22), 0, AndroidUtilities.m107dp(22), 0);
        this.usesEditText.setGravity(16);
        this.usesEditText.setTextSize(1, 16.0f);
        this.usesEditText.setHint(LocaleController.getString("UsesLimitHint", C3632R.string.UsesLimitHint));
        ...
        textInfoPrivacyCell3.setText(LocaleController.getString("UsesLimitHelp", C3632R.string.UsesLimitHelp));
        ...
        this.nameEditText.setHint(LocaleController.getString("LinkNameHint", C3632R.string.LinkNameHint));
        ...
        this.nameEditText.setPadding(AndroidUtilities.m107dp(22), 0, AndroidUtilities.m107dp(22), 0);
        ...
        int i9 = C3632R.C3634drawable.greydivider_bottom;
        textInfoPrivacyCell4.setBackground(Theme.getThemedDrawableByKey(context, i9, i6));
        this.dividerName.setText(LocaleController.getString("LinkNameHelp", C3632R.string.LinkNameHelp));
        linearLayout.addView(this.dividerName);
        if (this.type == 1) {
            TextSettingsCell textSettingsCell = new TextSettingsCell(context);
            this.revokeLink = textSettingsCell;
            textSettingsCell.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
            this.revokeLink.setText(LocaleController.getString("RevokeLink", C3632R.string.RevokeLink), false);
        ...
        this.buttonTextView.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(6), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
    ...
    public /* synthetic */ void lambda$createView$6(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C3632R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.LinkEditActivity$$ExternalSyntheticLambda0
    ...
    */
    ...
    public void chooseUses(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (i4 == size - 1) {
                strArr[i4] = LocaleController.getString("NoLimit", C3632R.string.NoLimit);
            } else {
    ...
    private void chooseDate(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (i4 == size - 1) {
                ...
                long j2 = currentTime;
                if (j2 < 86400) {
                    strArr[i4] = LocaleController.getString("MessageScheduleToday", C3632R.string.MessageScheduleToday);
                } else if (j2 < 31449600) {
    ...
    private void resetDates() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                this.timeChooseView.setOptions(3, LocaleController.formatPluralString("Hours", 1, new Object[0]), LocaleController.formatPluralString("Days", 1, new Object[0]), LocaleController.formatPluralString("Weeks", 1, new Object[0]), LocaleController.getString("NoLimit", C3632R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public void resetUses() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                this.usesChooseView.setOptions(3, IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, "10", "100", LocaleController.getString("NoLimit", C3632R.string.NoLimit));
                return;
            }
        }
    }
    ...
    private void setUsesVisible(boolean z) {
        ...
        this.divider.setBackground(Theme.getThemedDrawableByKey(getParentActivity(), z ? C3632R.C3634drawable.greydivider : C3632R.C3634drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    }
    ...
    public /* synthetic */ void lambda$getThemeDescriptions$11() {
        ...
        if (textInfoPrivacyCell != null) {
            ...
            int i = C3632R.C3634drawable.greydivider_bottom;
            ...
            this.divider.setBackgroundDrawable(Theme.getThemedDrawableByKey(context, C3632R.C3634drawable.greydivider, i2));
            this.buttonTextView.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(6), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
