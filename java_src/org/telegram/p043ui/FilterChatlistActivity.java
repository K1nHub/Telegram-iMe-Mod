...
public class FilterChatlistActivity extends BaseFragment {
    ...
    public void updateActionBarTitle(boolean z) {
        ...
        String string = TextUtils.isEmpty(tLRPC$TL_exportedChatlistInvite == null ? null : tLRPC$TL_exportedChatlistInvite.title) ? LocaleController.getString("FilterShare", C3473R.string.FilterShare) : this.invite.title;
        if (z) {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.FilterChatlistActivity.1
        ...
        this.doneButton = createMenu.addItemWithWidth(1, crossfadeDrawable, AndroidUtilities.m72dp(56), LocaleController.getString("Done", C3473R.string.Done));
        checkDoneButton();
        ...
        for (int i3 = 0; i3 < this.filter.dialogs.size(); i3++) {
            ...
            if (tLRPC$Dialog != null && !DialogObject.isEncryptedDialog(tLRPC$Dialog.f1528id) && !this.peers.contains(Long.valueOf(tLRPC$Dialog.f1528id))) {
                long j = tLRPC$Dialog.f1528id;
                boolean z = j < 0;
                if (j < 0) {
                    z = FilterCreateActivity.canAddToFolder(getMessagesController().getChat(Long.valueOf(-tLRPC$Dialog.f1528id)));
                }
                if (z) {
                    this.peers.add(Long.valueOf(tLRPC$Dialog.f1528id));
                    this.allowedPeers.add(Long.valueOf(tLRPC$Dialog.f1528id));
                }
            }
        }
        for (int i4 = 0; i4 < this.filter.dialogs.size(); i4++) {
            TLRPC$Dialog tLRPC$Dialog2 = this.filter.dialogs.get(i4);
            if (tLRPC$Dialog2 != null && !DialogObject.isEncryptedDialog(tLRPC$Dialog2.f1528id) && !this.peers.contains(Long.valueOf(tLRPC$Dialog2.f1528id)) && !this.allowedPeers.contains(Long.valueOf(tLRPC$Dialog2.f1528id))) {
                this.peers.add(Long.valueOf(tLRPC$Dialog2.f1528id));
            }
        }
        updateRows();
            ...
            if (this.selectedPeers.contains(Long.valueOf(longValue))) {
                ...
                if (longValue >= 0) {
                    ...
                    if (user != null && user.bot) {
                        str = LocaleController.getString("FilterInviteBotToast", C3473R.string.FilterInviteBotToast);
                    } else {
                        str = LocaleController.getString("FilterInviteUserToast", C3473R.string.FilterInviteUserToast);
                    }
                } else {
                    TLRPC$Chat chat = getMessagesController().getChat(Long.valueOf(-longValue));
                    if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                        if (ChatObject.isPublic(chat)) {
                            string = LocaleController.getString("FilterInviteChannelToast", C3473R.string.FilterInviteChannelToast);
                        } else {
                            string = LocaleController.getString("FilterInvitePrivateChannelToast", C3473R.string.FilterInvitePrivateChannelToast);
                        }
                    } else if (ChatObject.isPublic(chat)) {
                        string = LocaleController.getString("FilterInviteGroupToast", C3473R.string.FilterInviteGroupToast);
                    } else {
                        string = LocaleController.getString("FilterInvitePrivateGroupToast", C3473R.string.FilterInvitePrivateGroupToast);
                    }
                    arrayList.add(chat);
                    str = string;
                }
    ...
    public /* synthetic */ void lambda$saveTitle$3(TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (tLRPC$TL_error == null) {
            BulletinFactory.m32of(this).createSimpleBulletin(C3473R.raw.contact_check, LocaleController.getString("FilterInviteNameEdited", C3473R.string.FilterInviteNameEdited)).show();
        }
    }
    ...
    public void updateHintCell(boolean z) {
        ...
        if (this.invite == null) {
            hintInnerCell.setText(LocaleController.getString("FilterInviteHeaderNo", C3473R.string.FilterInviteHeaderNo), z);
        } else {
    ...
    public void updateHeaderCell(boolean z) {
        ...
        if (this.allowedPeers.size() > 1) {
            ...
            this.headerCountCell.setAction(LocaleController.getString(!z2 ? C3473R.string.SelectAll : C3473R.string.DeselectAll), new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                frameLayout = new HintInnerCell(FilterChatlistActivity.this.getContext(), C3473R.raw.folder_share);
            } else if (i == 2) {
                frameLayout = new TextInfoPrivacyCell(FilterChatlistActivity.this.getContext());
            } else if (i == 3) {
                frameLayout = new C58661(FilterChatlistActivity.this.getContext(), FilterChatlistActivity.this);
        ...
        /* loaded from: classes3.dex */
        public class C58661 extends InviteLinkCell {
            C58661(Context context, BaseFragment baseFragment) {
            ...
            protected void deleteLink() {
                ...
                tLRPC$TL_inputChatlistDialogFilter.filter_id = filterChatlistActivity.filter.f1459id;
                ...
                FilterChatlistActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_chatlists_deleteExportedInvite, new RequestDelegate() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda7
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                        FilterChatlistActivity.ListAdapter.C58661.this.lambda$deleteLink$3(alertDialog, tLObject, tLRPC$TL_error);
                    }
                });
            }
            ...
            public /* synthetic */ void lambda$deleteLink$3(final AlertDialog alertDialog, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        FilterChatlistActivity.ListAdapter.C58661.this.lambda$deleteLink$2(alertDialog);
                    }
                });
            }
            ...
            public void editname() {
                ...
                builder.setTitle(LocaleController.getString("FilterInviteEditName", C3473R.string.FilterInviteEditName));
                builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda0
                ...
                editTextBoldCursor.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda4
                    ...
                    public final boolean onEditorAction(TextView textView, int i2, KeyEvent keyEvent) {
                        ...
                        lambda$editname$5 = FilterChatlistActivity.ListAdapter.C58661.lambda$editname$5(AlertDialog.Builder.this, textView, i2, keyEvent);
                ...
                builder.setPositiveButton(LocaleController.getString("Save", C3473R.string.Save), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        FilterChatlistActivity.ListAdapter.C58661.this.lambda$editname$6(editTextBoldCursor, builder, dialogInterface, i2);
                    }
                });
                ...
                create.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda3
                    ...
                    public final void onShow(DialogInterface dialogInterface) {
                        FilterChatlistActivity.ListAdapter.C58661.lambda$editname$8(EditTextBoldCursor.this, dialogInterface);
                    }
                });
            ...
            public static /* synthetic */ void lambda$editname$8(final EditTextBoldCursor editTextBoldCursor, DialogInterface dialogInterface) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        FilterChatlistActivity.ListAdapter.C58661.lambda$editname$7(EditTextBoldCursor.this);
                    }
                });
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(FilterChatlistActivity.this.getContext(), i == FilterChatlistActivity.this.chatsSectionRow ? C3473R.C3475drawable.greydivider_bottom : C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                if (i == FilterChatlistActivity.this.chatsSectionRow) {
                    ...
                    if (filterChatlistActivity.invite == null || filterChatlistActivity.allowedPeers.isEmpty()) {
                        textInfoPrivacyCell.setText(LocaleController.getString("FilterInviteHintNo", C3473R.string.FilterInviteHintNo));
                        return;
                    } else {
                        textInfoPrivacyCell.setText(LocaleController.getString("FilterInviteHint", C3473R.string.FilterInviteHint));
                        return;
                    }
                }
                ...
                if (itemViewType == 3) {
                    ...
                    if (itemViewType == 5) {
                        ...
                        if (i != FilterChatlistActivity.this.linkHeaderRow) {
                            ...
                            headerCell.setText(LocaleController.getString("FilterInviteHeaderChatsNo", C3473R.string.FilterInviteHeaderChatsNo), false);
                            headerCell.setAction("", null);
                            return;
                        }
                        headerCell.setText(LocaleController.getString("InviteLink", C3473R.string.InviteLink), false);
                        headerCell.setAction("", null);
                    }
                } else {
                    ...
                    if (FilterChatlistActivity.this.allowedPeers.contains(Long.valueOf(longValue))) {
                        ...
                        if (tLRPC$User instanceof TLRPC$User) {
                            if (((TLRPC$User) tLRPC$User).bot) {
                                r3 = LocaleController.getString("FilterInviteBot", C3473R.string.FilterInviteBot);
                            } else {
                                r3 = LocaleController.getString("FilterInviteUser", C3473R.string.FilterInviteUser);
                            }
                        } else if (tLRPC$User instanceof TLRPC$Chat) {
                            if (ChatObject.isChannelAndNotMegaGroup(tLRPC$User)) {
                                r3 = LocaleController.getString("FilterInviteChannel", C3473R.string.FilterInviteChannel);
                            } else {
                                r3 = LocaleController.getString("FilterInviteGroup", C3473R.string.FilterInviteGroup);
                            }
                        }
                    }
    ...
    private void deselectAll(final FolderBottomSheet.HeaderCell headerCell, final boolean z) {
        ...
        headerCell.setAction(LocaleController.getString(!(this.selectedPeers.size() >= Math.min(getMaxChats(), this.allowedPeers.size())) ? C3473R.string.SelectAll : C3473R.string.DeselectAll), new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean checkDiscard() {
        if (!this.selectedPeers.isEmpty() && this.peersChanged) {
            ...
            builder.setTitle(LocaleController.getString("UnsavedChanges", C3473R.string.UnsavedChanges));
            builder.setMessage(LocaleController.getString("UnsavedChangesMessage", C3473R.string.UnsavedChangesMessage));
            builder.setPositiveButton(LocaleController.getString("ApplyTheme", C3473R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda2
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    FilterChatlistActivity.this.lambda$checkDiscard$9(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("PassportDiscard", C3473R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public static class InviteLinkCell extends FrameLayout {
        ...
        public class ButtonsBox extends FrameLayout {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                rectF.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, measuredWidth - AndroidUtilities.lerp(0, AndroidUtilities.m72dp(4), this.f1880t), getMeasuredHeight());
                setRadii(AndroidUtilities.m72dp(8), AndroidUtilities.lerp(0, AndroidUtilities.m72dp(8), this.f1880t));
                this.path.addRoundRect(rectF, this.radii, Path.Direction.CW);
                canvas.drawPath(this.path, this.paint);
                this.path.rewind();
                rectF.set(measuredWidth + AndroidUtilities.lerp(0, AndroidUtilities.m72dp(4), this.f1880t), BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight());
                setRadii(AndroidUtilities.lerp(0, AndroidUtilities.m72dp(8), this.f1880t), AndroidUtilities.m72dp(8));
                this.path.addRoundRect(rectF, this.radii, Path.Direction.CW);
                canvas.drawPath(this.path, this.paint);
            }
        }
        ...
        public InviteLinkCell(Context context, BaseFragment baseFragment) {
            ...
            spannableStringBuilder.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3473R.C3475drawable.msg_copy_filled)), 0, 1, 0);
            spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m72dp(8)), 1, 2, 0);
            spannableStringBuilder.append((CharSequence) LocaleController.getString("LinkActionCopy", C3473R.string.LinkActionCopy));
            ...
            spannableStringBuilder2.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C3473R.C3475drawable.msg_share_filled)), 0, 1, 0);
            spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m72dp(8)), 1, 2, 0);
            spannableStringBuilder2.append((CharSequence) LocaleController.getString("LinkActionShare", C3473R.string.LinkActionShare));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(127), 1073741824));
        }
        ...
        public void options() {
            ...
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("EditName", C3473R.string.EditName), C3473R.C3475drawable.msg_edit);
            ...
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("GetQRCode", C3473R.string.GetQRCode), C3473R.C3475drawable.msg_qrcode);
            ...
            actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("DeleteLink", C3473R.string.DeleteLink), C3473R.C3475drawable.msg_delete);
            ...
            if (overlayContainerView != null) {
                ...
                this.actionBarPopupWindow.setAnimationStyle(C3473R.style.PopupContextAnimation);
        ...
        public void copy() {
            ...
            BulletinFactory.m32of(this.parentFragment).createCopyBulletin(LocaleController.getString("LinkCopied", C3473R.string.LinkCopied)).show();
        }
        ...
        protected void share() {
            ...
            try {
                ...
                this.parentFragment.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C3473R.string.InviteToGroupByLink)), 500);
            } catch (Exception e) {
                FileLog.m67e(e);
            }
        }
