...
public class ActionBarMenuSlider extends FrameLayout {
    ...
    public void setDrawShadow(boolean z) {
        this.drawShadow = z;
        int m107dp = z ? AndroidUtilities.m107dp(8) : 0;
        setPadding(m107dp, m107dp, m107dp, m107dp);
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawShadow) {
            canvas.drawRoundRect(rectF, AndroidUtilities.m108dp(this.roundRadiusDp), AndroidUtilities.m108dp(this.roundRadiusDp), this.shadowPaint);
        }
        if (this.drawBlur) {
            ...
            if (f < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m108dp(this.roundRadiusDp), AndroidUtilities.m108dp(this.roundRadiusDp), this.pseudoBlurPaint);
            }
            if (this.blurBitmap != null && this.value < 1.0f && f > BitmapDescriptorFactory.HUE_RED) {
                this.blurPaint.setAlpha((int) (f * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.m108dp(this.roundRadiusDp), AndroidUtilities.m108dp(this.roundRadiusDp), this.blurPaint);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.m108dp(this.roundRadiusDp), AndroidUtilities.m108dp(this.roundRadiusDp), this.brightenBlurPaint);
            canvas.drawRoundRect(rectF, AndroidUtilities.m108dp(this.roundRadiusDp), AndroidUtilities.m108dp(this.roundRadiusDp), this.darkenBlurPaint);
            this.fillPaint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.m108dp(this.roundRadiusDp), AndroidUtilities.m108dp(this.roundRadiusDp), this.backgroundPaint);
        }
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.m108dp(this.roundRadiusDp), AndroidUtilities.m108dp(this.roundRadiusDp), this.fillPaint);
        if (!this.backgroundDark) {
    ...
    private void drawText(Canvas canvas, boolean z) {
        ...
        this.textDrawable.setBounds(getPaddingLeft() + AndroidUtilities.m107dp(20), getMeasuredHeight() / 2, (getMeasuredWidth() - getPaddingRight()) - AndroidUtilities.m107dp(20), getMeasuredHeight() / 2);
