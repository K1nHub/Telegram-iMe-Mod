...
public class BackDrawable extends Drawable {
    ...
    public BackDrawable(boolean z) {
        ...
        this.prevPaint.setStrokeWidth(AndroidUtilities.m107dp(2));
    ...
    public void draw(Canvas canvas) {
        ...
        float f3 = 1.0f - f2;
        canvas.drawLine(AndroidUtilities.m108dp(AndroidUtilities.lerp(-6.75f, -8.0f, f2)), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(8) - ((this.paint.getStrokeWidth() / 2.0f) * f3), BitmapDescriptorFactory.HUE_RED, this.paint);
        float m108dp = AndroidUtilities.m108dp(-0.25f);
        float m108dp2 = AndroidUtilities.m108dp(AndroidUtilities.lerp(7.0f, 8.0f, f2)) - ((this.paint.getStrokeWidth() / 4.0f) * f3);
        float m108dp3 = AndroidUtilities.m108dp(AndroidUtilities.lerp(-7.25f, (float) BitmapDescriptorFactory.HUE_RED, f2));
        canvas.drawLine(m108dp3, -m108dp, BitmapDescriptorFactory.HUE_RED, -m108dp2, this.paint);
        canvas.drawLine(m108dp3, m108dp, BitmapDescriptorFactory.HUE_RED, m108dp2, this.paint);
        canvas.restore();
    }
