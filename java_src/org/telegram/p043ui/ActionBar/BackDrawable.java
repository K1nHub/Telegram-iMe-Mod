...
public class BackDrawable extends Drawable {
    ...
    public BackDrawable(boolean z) {
        ...
        this.prevPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
    ...
    public void draw(Canvas canvas) {
        ...
        float m105dp = AndroidUtilities.m105dp(-0.25f);
        float m105dp2 = AndroidUtilities.m105dp(AndroidUtilities.lerp(7.0f, 8.0f, f2)) - ((this.paint.getStrokeWidth() / 4.0f) * f3);
        float m105dp3 = AndroidUtilities.m105dp(AndroidUtilities.lerp(-7.25f, (float) BitmapDescriptorFactory.HUE_RED, f2));
        canvas.drawLine(m105dp3, -m105dp, BitmapDescriptorFactory.HUE_RED, -m105dp2, this.paint);
        canvas.drawLine(m105dp3, m105dp, BitmapDescriptorFactory.HUE_RED, m105dp2, this.paint);
        canvas.restore();
    }
