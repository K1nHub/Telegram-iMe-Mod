...
public class AlertDialog extends Dialog implements Drawable.Callback, NotificationCenter.NotificationCenterDelegate {
    ...
    public static class AlertDialogCell extends FrameLayout {
        ...
        public AlertDialogCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            setPadding(AndroidUtilities.m104dp(23), 0, AndroidUtilities.m104dp(23), 0);
        ...
        public void setTextAndIcon(CharSequence charSequence, int i) {
            ...
            if (i != 0) {
                ...
                this.textView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m104dp(56), 0, LocaleController.isRTL ? AndroidUtilities.m104dp(56) : 0, 0);
                return;
            }
    ...
    /* loaded from: classes5.dex */
    public class C37551 extends LinearLayout {
        ...
        */
        protected void onMeasure(int r13, int r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ActionBar.AlertDialog.C37551.onMeasure(int, int):void");
        }
        ...
        public /* synthetic */ void lambda$onMeasure$0() {
            ...
            int m104dp2 = AndroidUtilities.displaySize.x - AndroidUtilities.m104dp(56);
            if (AndroidUtilities.isTablet()) {
                if (AndroidUtilities.isSmallTablet()) {
                    m104dp = AndroidUtilities.m104dp(446);
                } else {
                    m104dp = AndroidUtilities.m104dp(496);
                }
            } else {
                m104dp = AndroidUtilities.m104dp(356);
            }
            Window window = AlertDialog.this.getWindow();
            WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams();
            layoutParams.copyFrom(window.getAttributes());
            layoutParams.width = Math.min(m104dp, m104dp2) + AlertDialog.this.backgroundPaddings.left + AlertDialog.this.backgroundPaddings.right;
            try {
                ...
                if (AlertDialog.this.onScrollChangedListener == null) {
                    AlertDialog.this.onScrollChangedListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$1$$ExternalSyntheticLambda0
                        ...
                        public final void onScrollChanged() {
                            AlertDialog.C37551.this.lambda$onLayout$1();
                        }
                    };
        ...
        public void draw(Canvas canvas) {
            ...
            if (AlertDialog.this.blurredBackground && !AlertDialog.this.blurredNativeBackground) {
                ...
                if (AlertDialog.this.blurPaint != null) {
                    ...
                    canvas.drawRoundRect(AndroidUtilities.rectTmp, m104dp, m104dp, AlertDialog.this.blurPaint);
                }
                ...
                canvas.drawRoundRect(rectF, m104dp, m104dp, AlertDialog.this.dimBlurPaint);
    ...
    public View inflateContent(boolean z) {
        int i;
        int m104dp;
        final C37551 c37551 = new C37551(getContext());
        c37551.setOrientation(1);
        if ((this.blurredBackground || this.progressViewStyle == 3) && this.progressViewStyle != 2) {
            c37551.setBackgroundDrawable(null);
            c37551.setPadding(0, 0, 0, 0);
            if (this.blurredBackground && !this.blurredNativeBackground) {
                c37551.setWillNotDraw(false);
            }
            this.drawBackground = false;
        } else if (this.notDrawBackgroundOnTopView) {
            Rect rect = new Rect();
            this.shadowDrawable.getPadding(rect);
            c37551.setPadding(rect.left, rect.top, rect.right, rect.bottom);
            this.drawBackground = true;
        } else {
            c37551.setBackgroundDrawable(null);
            c37551.setPadding(0, 0, 0, 0);
            c37551.setBackgroundDrawable(this.shadowDrawable);
            this.drawBackground = false;
        }
        c37551.setFitsSystemWindows(Build.VERSION.SDK_INT >= 21);
        if (z) {
            setContentView(c37551);
        }
        ...
        if (this.topResId != 0 || this.topAnimationId != 0 || this.topDrawable != null) {
            ...
            if (this.topAnimationIsNew) {
                ...
                gradientDrawable.setCornerRadius(AndroidUtilities.m104dp(128));
                this.topImageView.setBackground(new Drawable() { // from class: org.telegram.ui.ActionBar.AlertDialog.2
                    int size;

                    {
                        this.size = AlertDialog.this.topAnimationSize + AndroidUtilities.m104dp(52);
                    }
                ...
                this.topImageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m104dp(10), 0, this.topBackgroundColor));
            }
            if (this.topAnimationIsNew) {
                this.topImageView.setTranslationY(AndroidUtilities.m104dp(16));
            } else {
            ...
            c37551.addView(this.topImageView, LayoutHelper.createLinear(-1, this.topHeight, 51, 0, 0, 0, 0));
        } else {
            View view = this.topView;
            if (view != null) {
                view.setPadding(0, 0, 0, 0);
                c37551.addView(this.topView, LayoutHelper.createLinear(-1, this.topHeight, 51, 0, 0, 0, 0));
            }
        }
        if (this.title != null) {
            FrameLayout frameLayout = new FrameLayout(getContext());
            this.titleContainer = frameLayout;
            c37551.addView(frameLayout, LayoutHelper.createLinear(-2, -2, this.topAnimationIsNew ? 1 : 0, 24, 0, 24, 0));
        ...
        if (this.subtitle != null) {
            ...
            c37551.addView(this.subtitleTextView, LayoutHelper.createLinear(-2, -2, (LocaleController.isRTL ? 5 : 3) | 48, 24, 0, 24, this.items != null ? 14 : 10));
        }
        if (this.progressViewStyle == 0) {
            ...
            ScrollView scrollView = new ScrollView(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.3
                ...
                protected boolean drawChild(Canvas canvas, View view2, long j) {
                    ...
                    if (AlertDialog.this.shadow[0].getPaint().getAlpha() != 0) {
                        AlertDialog.this.shadow[0].setBounds(0, getScrollY(), getMeasuredWidth(), getScrollY() + AndroidUtilities.m104dp(3));
                        AlertDialog.this.shadow[0].draw(canvas);
                    }
                    if (AlertDialog.this.shadow[1].getPaint().getAlpha() != 0) {
                        AlertDialog.this.shadow[1].setBounds(0, (getScrollY() + getMeasuredHeight()) - AndroidUtilities.m104dp(3), getMeasuredWidth(), getScrollY() + getMeasuredHeight());
            ...
            c37551.addView(this.contentScrollView, LayoutHelper.createLinear(-1, -2, 0, 0, 0, 0));
        ...
        if (i5 == 2) {
            c37551.addView(this.messageTextView, LayoutHelper.createLinear(-2, -2, (LocaleController.isRTL ? 5 : 3) | 48, 24, this.title == null ? 19 : 0, 24, 20));
            ...
            c37551.addView(this.lineProgressView, LayoutHelper.createLinear(-1, 4, 19, 24, 0, 24, 0));
            ...
            c37551.addView(this.lineProgressViewPercent, LayoutHelper.createLinear(-2, -2, (LocaleController.isRTL ? 5 : 3) | 48, 23, 4, 23, 24));
            ...
            if (!this.blurredBackground || this.blurredNativeBackground) {
                this.progressViewContainer.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m104dp(18), this.backgroundColor));
            }
            c37551.addView(this.progressViewContainer, LayoutHelper.createLinear(86, 86, 17));
            RadialProgressView radialProgressView = new RadialProgressView(getContext(), this.resourcesProvider);
            radialProgressView.setSize(AndroidUtilities.m104dp(32));
            ...
            if (view2 != null) {
                this.scrollContainer.addView(view2, LayoutHelper.createLinear(-1, -2, 24, -24, 24, 0));
            }
        }
        ...
        if (objArr != null) {
            if (!this.verticalButtons) {
                ...
                int measureText = charSequence2 != null ? (int) (0 + textPaint.measureText(charSequence2, 0, charSequence2.length()) + AndroidUtilities.m104dp(10)) : 0;
                CharSequence charSequence3 = this.negativeButtonText;
                if (charSequence3 != null) {
                    measureText = (int) (measureText + textPaint.measureText(charSequence3, 0, charSequence3.length()) + AndroidUtilities.m104dp(10));
                }
                CharSequence charSequence4 = this.neutralButtonText;
                if (charSequence4 != null) {
                    measureText = (int) (measureText + textPaint.measureText(charSequence4, 0, charSequence4.length()) + AndroidUtilities.m104dp(10));
                }
                if (measureText > AndroidUtilities.displaySize.x - AndroidUtilities.m104dp(110)) {
                            ...
                            if (num != null) {
                                if (num.intValue() == -1) {
                                    ...
                                    if (LocaleController.isRTL) {
                                        ...
                                        if (view4 != null) {
                                            paddingLeft += view4.getMeasuredWidth() + AndroidUtilities.m104dp(8);
                                        }
                                        childAt.layout(paddingLeft, getPaddingTop(), childAt.getMeasuredWidth() + paddingLeft, getPaddingTop() + childAt.getMeasuredHeight());
                                    } else {
                                        int paddingRight = (i13 - getPaddingRight()) - childAt.getMeasuredWidth();
                                        if (view4 != null) {
                                            paddingRight -= view4.getMeasuredWidth() + AndroidUtilities.m104dp(8);
                                        }
                                ...
                                if (view4 != null) {
                                    i11 = view4.getLeft() + ((view4.getMeasuredWidth() - measuredWidth) / 2);
                                    i12 = view4.getTop() + ((view4.getMeasuredHeight() - measuredHeight) / 2);
                                } else {
                                    i11 = 0;
                                    i12 = 0;
                                }
            ...
            if (this.bottomView != null) {
                this.buttonsLayout.setPadding(AndroidUtilities.m104dp(16), 0, AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(4));
                this.buttonsLayout.setTranslationY(-AndroidUtilities.m104dp(6));
            } else {
                this.buttonsLayout.setPadding(AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8));
            }
            c37551.addView(this.buttonsLayout, LayoutHelper.createLinear(-1, 52));
            if (this.topAnimationIsNew) {
                this.buttonsLayout.setTranslationY(-AndroidUtilities.m104dp(8));
            }
            if (this.positiveButtonText != null) {
                TextView textView5 = new TextView(this, getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.5
                    ...
                    public void setTextColor(int i7) {
                        ...
                        setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m104dp(6), i7));
                    }
                };
                textView5.setMinWidth(AndroidUtilities.m104dp(64));
                textView5.setTag(-1);
                ...
                textView5.setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m104dp(6), getThemedColor(this.dialogButtonColorKey)));
                textView5.setPadding(AndroidUtilities.m104dp(12), 0, AndroidUtilities.m104dp(12), 0);
                if (this.verticalButtons) {
            ...
            if (this.negativeButtonText != null) {
                ...
                textView6.setMinWidth(AndroidUtilities.m104dp(64));
                textView6.setTag(-2);
                ...
                textView6.setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m104dp(6), getThemedColor(this.dialogButtonColorKey)));
                textView6.setPadding(AndroidUtilities.m104dp(12), 0, AndroidUtilities.m104dp(12), 0);
                if (this.verticalButtons) {
            ...
            if (this.neutralButtonText != null) {
                ...
                textView7.setMinWidth(AndroidUtilities.m104dp(64));
                textView7.setTag(-3);
                ...
                textView7.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m104dp(6), getThemedColor(this.dialogButtonColorKey)));
                textView7.setPadding(AndroidUtilities.m104dp(12), 0, AndroidUtilities.m104dp(12), 0);
                if (this.verticalButtons) {
            ...
            if (this.verticalButtons) {
                for (int i7 = 1; i7 < this.buttonsLayout.getChildCount(); i7++) {
                    ((ViewGroup.MarginLayoutParams) this.buttonsLayout.getChildAt(i7).getLayoutParams()).topMargin = AndroidUtilities.m104dp(6);
                }
            }
        }
        ...
        if (this.progressViewStyle == 3) {
            ...
            int m104dp2 = (i8 - AndroidUtilities.m104dp(48)) - (this.additioanalHorizontalPadding * i);
            if (AndroidUtilities.isTablet()) {
                if (AndroidUtilities.isSmallTablet()) {
                    m104dp = AndroidUtilities.m104dp(446);
                } else {
            ...
            int min = Math.min(m104dp, m104dp2);
        ...
        if (this.blurredBackground) {
            if (supportsNativeBlur()) {
                if (this.progressViewStyle == 0) {
                    ...
                    float m104dp3 = AndroidUtilities.m104dp(12);
                    ShapeDrawable shapeDrawable = new ShapeDrawable(new RoundRectShape(new float[]{m104dp3, m104dp3, m104dp3, m104dp3, m104dp3, m104dp3, m104dp3, m104dp3}, null, null));
                ...
                AndroidUtilities.makeGlobalBlurBitmap(new Utilities.Callback() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda8
                    ...
                    public final void run(Object obj) {
                        AlertDialog.this.lambda$inflateContent$5(c37551, (Bitmap) obj);
                    }
                }, 8.0f);
            }
        }
