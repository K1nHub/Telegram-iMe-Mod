...
public class ActionBarLayout extends FrameLayout implements INavigationLayout, FloatingDebugProvider {
    ...
    private C3706ActionBar currentActionBar;
            ...
            if (baseFragment.isAllowPinnedPlayer()) {
                ...
                if ((view instanceof FrameLayout) && baseFragment.pinnedPlayerView != null) {
                    ...
                    if (isPinnedPlayerVisible()) {
                        layoutParams.bottomMargin = AndroidUtilities.m104dp(PinnedPlayerView.getPlayerHeight());
    ...
    public class LayoutContainer extends FrameLayout {
        ...
        protected boolean drawChild(Canvas canvas, View view, long j) {
            ...
            if ((view instanceof C3706ActionBar) || (view instanceof PinnedPlayerView) || (view instanceof PasscodeView)) {
            ...
            while (true) {
                ...
                if (childAt == view || !(childAt instanceof C3706ActionBar) || childAt.getVisibility() != 0) {
                    i3++;
                } else if (((C3706ActionBar) childAt).getCastShadows()) {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (int i6 = 0; i6 < childCount; i6++) {
                ...
                if (!(childAt3 instanceof C3706ActionBar) && !(childAt3 instanceof PinnedPlayerView) && !(childAt3 instanceof PasscodeView)) {
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            for (int i7 = 0; i7 < childCount; i7++) {
                ...
                if (childAt2 instanceof PinnedPlayerView) {
                    childAt2.layout(0, i4 - AndroidUtilities.m104dp(PinnedPlayerView.getPlayerHeight()), childAt2.getMeasuredWidth(), i4);
                } else if (childAt2 instanceof PasscodeView) {
        ...
        */
        ...
        public void processMenuButtonsTouch(MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (!this.allowToPressByHover && Math.sqrt(Math.pow(this.pressX - motionEvent.getX(), 2.0d) + Math.pow(this.pressY - motionEvent.getY(), 2.0d)) > AndroidUtilities.m104dp(30)) {
    ...
    public ActionBarLayout(Context context) {
        ...
        if (layerShadowDrawable == null) {
            layerShadowDrawable = getResources().getDrawable(C3634R.C3636drawable.layer_shadow);
            headerShadowDrawable = getResources().getDrawable(C3634R.C3636drawable.header_shadow).mutate();
    ...
    public void updateTitleOverlay() {
        ...
        if (lastFragment == null || (c3706ActionBar = lastFragment.actionBar) == null) {
            return;
        }
        c3706ActionBar.setTitleOverlayText(this.titleOverlayText, this.titleOverlayTextId, this.overlayAction);
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.containerViewBack) {
            paddingLeft2 = AndroidUtilities.m104dp(1) + paddingRight;
        ...
        if (paddingRight != 0 || this.overrideWidthOffset != -1) {
            ...
            if (view == this.containerView) {
                float clamp = MathUtils.clamp(i / AndroidUtilities.m104dp(20), (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    private void drawPreviewDrawables(Canvas canvas, ViewGroup viewGroup) {
        ...
        if (childAt != null) {
            ...
            if (this.previewMenu == null) {
                ...
                int i = m104dp / 2;
                int measuredWidth = (getMeasuredWidth() - m104dp) / 2;
                int top = (int) ((childAt.getTop() + viewGroup.getTranslationY()) - AndroidUtilities.m104dp((Build.VERSION.SDK_INT < 21 ? 20 : 0) + 12));
                Theme.moveUpDrawable.setBounds(measuredWidth, top, m104dp + measuredWidth, i + top);
    ...
    public void onSlideAnimationEnd(boolean z) {
        ...
        if (!z) {
            ...
            C3706ActionBar c3706ActionBar = baseFragment3.actionBar;
            if (c3706ActionBar != null && c3706ActionBar.shouldAddToContainer() && (viewGroup3 = (ViewGroup) baseFragment3.actionBar.getParent()) != null) {
    ...
    private void prepareForMoving(MotionEvent motionEvent) {
        ...
        C3706ActionBar c3706ActionBar = baseFragment.actionBar;
        if (c3706ActionBar != null && c3706ActionBar.shouldAddToContainer()) {
    ...
    public void onBackPressed() {
        ...
        if (!storyViewerAttached() && (c3706ActionBar = this.currentActionBar) != null && !c3706ActionBar.isActionModeShowed()) {
            C3706ActionBar c3706ActionBar2 = this.currentActionBar;
            if (c3706ActionBar2.isSearchFieldVisible) {
                c3706ActionBar2.closeSearchField();
                return;
            }
        }
        List<BaseFragment> list = this.fragmentsStack;
    ...
    private void presentFragmentInternalRemoveOld(boolean z, BaseFragment baseFragment) {
        ...
        if (z) {
            ...
            C3706ActionBar c3706ActionBar = baseFragment.actionBar;
            if (c3706ActionBar != null && c3706ActionBar.shouldAddToContainer() && (viewGroup3 = (ViewGroup) baseFragment.actionBar.getParent()) != null) {
                ...
                if (z) {
                    ...
                    if (z3) {
                        ...
                        if (ActionBarLayout.this.previewMenu != null) {
                            ...
                            ActionBarLayout.this.containerView.setTranslationY(AndroidUtilities.m104dp(40) * f2);
                            ActionBarLayout.this.previewMenu.setTranslationY((-AndroidUtilities.m104dp(70)) * f2);
                        ...
                        ActionBarLayout.this.containerView.setTranslationX(AndroidUtilities.m104dp(48) * (1.0f - interpolation));
                    }
                } else {
                    ...
                    if (z3) {
                        ...
                        ActionBarLayout.this.containerViewBack.setTranslationX(AndroidUtilities.m104dp(48) * interpolation);
                    }
                }
                if (ActionBarLayout.this.animationProgress < 1.0f) {
    ...
    public boolean presentFragment(INavigationLayout.NavigationParams navigationParams) {
        ...
        if ((baseFragment2 instanceof ActionIntroActivity) && ((ActionIntroActivity) baseFragment2).getType() == 3) {
            ...
            if (lastFragment != null) {
                lastFragment.showDialog(AlertsCreator.createOpenTelegramDialog(getParentActivity(), LocaleController.getInternalString(C3634R.string.open_telegram_alert_change_phone_number)));
            }
            return false;
        }
        ...
        if (lastFragment2 != null && lastFragment2.getVisibleDialog() != null && shouldOpenFragmentOverlay(lastFragment2.getVisibleDialog())) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m102d("present fragment " + baseFragment2.getClass().getSimpleName() + " args=" + baseFragment2.getArguments());
        }
        ...
        if (actionBarPopupWindowLayout != null) {
            ...
            i = actionBarPopupWindowLayout.getMeasuredHeight() + AndroidUtilities.m104dp(24);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) actionBarPopupWindowLayout.getLayoutParams();
            layoutParams.width = -2;
            layoutParams.height = -2;
            layoutParams.topMargin = (getMeasuredHeight() - i) - AndroidUtilities.m104dp(6);
        ...
        if (z4) {
            ...
            if (previewHeight > 0 && previewHeight < getMeasuredHeight() - i2) {
                ...
                int m104dp = AndroidUtilities.m104dp(actionBarPopupWindowLayout != null ? 0 : 24);
                layoutParams2.bottomMargin = m104dp;
                layoutParams2.topMargin = m104dp;
                layoutParams2.topMargin = m104dp + AndroidUtilities.statusBarHeight;
            }
            if (actionBarPopupWindowLayout != null) {
                layoutParams2.bottomMargin += i + AndroidUtilities.m104dp(8);
            }
            ...
            if (baseFragment2.isAllowPinnedPlayer() && isPinnedPlayerVisible()) {
                layoutParams2.bottomMargin = AndroidUtilities.m104dp(PinnedPlayerView.getPlayerHeight());
            }
        }
        view.setLayoutParams(layoutParams2);
        C3706ActionBar c3706ActionBar = baseFragment2.actionBar;
        if (c3706ActionBar != null && c3706ActionBar.shouldAddToContainer()) {
            if (this.removeActionBarExtraHeight) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                view.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.telegram.ui.ActionBar.ActionBarLayout.3
                    ...
                    public void getOutline(View view2, Outline outline) {
                        outline.setRoundRect(0, AndroidUtilities.statusBarHeight, view2.getMeasuredWidth(), view2.getMeasuredHeight(), AndroidUtilities.m104dp(6));
                    }
                });
                view.setClipToOutline(true);
                view.setElevation(AndroidUtilities.m104dp(4));
            }
        ...
        if ((iNavigationLayoutDelegate == null || iNavigationLayoutDelegate.needAddFragmentToStack(baseFragment, this)) && baseFragment.onFragmentCreate() && !this.fragmentsStack.contains(baseFragment)) {
            ...
            if (i == -1 || i == -2) {
                if (!this.fragmentsStack.isEmpty()) {
                    ...
                    C3706ActionBar c3706ActionBar = baseFragment2.actionBar;
                    if (c3706ActionBar != null && c3706ActionBar.shouldAddToContainer() && (viewGroup4 = (ViewGroup) baseFragment2.actionBar.getParent()) != null) {
    ...
    public void bringToFront(int i) {
        ...
        if (this.fragmentsStack.isEmpty() || this.fragmentsStack.size() - 1 != i || this.fragmentsStack.get(i).fragmentView == null) {
            for (int i2 = 0; i2 < i; i2++) {
                ...
                C3706ActionBar c3706ActionBar = baseFragment.actionBar;
                if (c3706ActionBar != null && c3706ActionBar.shouldAddToContainer() && (viewGroup4 = (ViewGroup) baseFragment.actionBar.getParent()) != null) {
            ...
            C3706ActionBar c3706ActionBar2 = baseFragment2.actionBar;
            if (c3706ActionBar2 != null && c3706ActionBar2.shouldAddToContainer()) {
                if (this.removeActionBarExtraHeight) {
                    baseFragment2.actionBar.setOccupyStatusBar(false);
                }
                AndroidUtilities.removeFromParent(baseFragment2.actionBar);
    ...
    */
    ...
    public boolean onKeyUp(int i, KeyEvent keyEvent) {
        C3706ActionBar c3706ActionBar;
        if (i == 82 && !checkTransitionAnimation() && !this.startedTracking && (c3706ActionBar = this.currentActionBar) != null) {
            c3706ActionBar.onMenuButtonPressed();
        }
    ...
    public void onActionModeStarted(Object obj) {
        C3706ActionBar c3706ActionBar = this.currentActionBar;
    ...
    public void onActionModeFinished(Object obj) {
        C3706ActionBar c3706ActionBar = this.currentActionBar;
        if (c3706ActionBar != null) {
            c3706ActionBar.setVisibility(0);
        }
    ...
    public void setTitleOverlayText(String str, int i, Runnable runnable) {
        ...
        for (int i2 = 0; i2 < this.fragmentsStack.size(); i2++) {
            C3706ActionBar c3706ActionBar = this.fragmentsStack.get(i2).actionBar;
            if (c3706ActionBar != null) {
                c3706ActionBar.setTitleOverlayText(this.titleOverlayText, this.titleOverlayTextId, runnable);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$new$8() {
        if (this.attached && getLastFragment() != null && this.containerView.getChildCount() == 0) {
            if (BuildVars.DEBUG_VERSION) {
                FileLog.m99e(new RuntimeException(TextUtils.join(", ", this.lastActions)));
            }
