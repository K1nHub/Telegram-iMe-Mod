...
public final class FloatingToolbar {
    ...
    public final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View view) {
            ...
            this.mMarginHorizontal = AndroidUtilities.m104dp(16);
            this.mMarginVertical = AndroidUtilities.m104dp(8);
            this.mLineHeight = AndroidUtilities.m104dp(48);
            int m104dp = AndroidUtilities.m104dp(8);
            this.mIconTextSpacing = m104dp;
            ...
            imageButton.setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m104dp(56), AndroidUtilities.m104dp(48)));
            imageButton.setPaddingRelative(AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(12));
            ...
            this.mOverflowPanelViewHelper = new OverflowPanelViewHelper(context, m104dp);
        ...
        private int getAdjustedToolbarWidth(int i) {
            refreshViewPort();
            int width = this.mViewPortOnScreen.width() - (AndroidUtilities.m104dp(16) * 2);
            if (i <= 0) {
                i = AndroidUtilities.m104dp(400);
            }
        ...
        public final class OverflowPanelViewHelper {
            private final Context mContext;
            private final int mIconTextSpacing;
            private final int mSidePadding = AndroidUtilities.m104dp(18);
    ...
    public View createMenuItemButton(Context context, MenuItem menuItem, int i, boolean z, boolean z2) {
        ...
        linearLayout.setMinimumWidth(AndroidUtilities.m104dp(48));
        linearLayout.setMinimumHeight(AndroidUtilities.m104dp(48));
        linearLayout.setPaddingRelative(AndroidUtilities.m104dp(16), 0, AndroidUtilities.m104dp(16), 0);
        TextView textView = new TextView(context);
        ...
        textView.setPaddingRelative(AndroidUtilities.m104dp(11), 0, 0, 0);
    ...
    public ViewGroup createContentContainer(Context context) {
        ...
        relativeLayout.setElevation(AndroidUtilities.m104dp(2));
        relativeLayout.setFocusable(true);
        relativeLayout.setFocusableInTouchMode(true);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(0);
        float m104dp2 = AndroidUtilities.m104dp(6);
        gradientDrawable.setCornerRadii(new float[]{m104dp2, m104dp2, m104dp2, m104dp2, m104dp2, m104dp2, m104dp2, m104dp2});
