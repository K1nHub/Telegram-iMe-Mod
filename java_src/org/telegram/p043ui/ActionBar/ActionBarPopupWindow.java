...
public class ActionBarPopupWindow extends PopupWindow {
    ...
    public static class ActionBarPopupWindowLayout extends FrameLayout {
                            ...
                            if (childAt.getVisibility() != 8) {
                                ...
                                if (tag3 == null) {
                                    ...
                                    if (!z && tag2 == null) {
                                        ...
                                        actionBarPopupWindowLayout.gapEndY = actionBarPopupWindowLayout.gapStartY + AndroidUtilities.m104dp(6);
                                        i6 = max;
                                    }
                                }
                                if (arrayList == null) {
        ...
        public void setBackScaleY(float f) {
            ...
            if (this.backScaleY != f) {
                ...
                if (this.animationEnabled && this.updateAnimation) {
                    int measuredHeight = getMeasuredHeight() - AndroidUtilities.m104dp(16);
                    if (this.shownFromBottom) {
                        for (int i = this.lastStartedChild; i >= 0; i--) {
                            ...
                            if (itemAt != null && itemAt.getVisibility() == 0 && !(itemAt instanceof GapView)) {
                                if (this.positions.get(itemAt) != null && measuredHeight - ((num.intValue() * AndroidUtilities.m104dp(48)) + AndroidUtilities.m104dp(32)) > measuredHeight * f) {
                                    break;
                                }
                        ...
                        for (int i3 = 0; i3 < itemsCount; i3++) {
                            ...
                            if (itemAt2.getVisibility() == 0) {
                                ...
                                if (i3 < this.lastStartedChild) {
                                    continue;
                                } else if (this.positions.get(itemAt2) != null && i2 - AndroidUtilities.m104dp(24) > measuredHeight * f) {
                                    break;
                                } else {
        ...
        private void startChildAnimation(final View view) {
            if (this.animationEnabled) {
                ...
                fArr2[0] = AndroidUtilities.m104dp(this.shownFromBottom ? 6 : -6);
                fArr2[1] = 0.0f;
    ...
    public static /* synthetic */ void lambda$startAnimation$2(ActionBarPopupWindowLayout actionBarPopupWindowLayout, ValueAnimator valueAnimator) {
        ...
        for (int i = 0; i < itemsCount; i++) {
            ...
            if (!(itemAt instanceof GapView)) {
                itemAt.setTranslationY((1.0f - AndroidUtilities.cascade(floatValue, actionBarPopupWindowLayout.shownFromBottom ? (itemsCount - 1) - i : i, itemsCount, 4.0f)) * AndroidUtilities.m104dp(-6));
            }
        }
    }
    ...
    public void dismiss(boolean z) {
        ...
        if (this.animationEnabled && z) {
            ...
            if (this.outEmptyTime > 0) {
                ...
                fArr[0] = AndroidUtilities.m104dp((actionBarPopupWindowLayout == null || !actionBarPopupWindowLayout.shownFromBottom) ? -5 : 5);
