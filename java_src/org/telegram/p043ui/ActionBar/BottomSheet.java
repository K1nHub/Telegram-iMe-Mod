...
public class BottomSheet extends Dialog {
    ...
    public class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        public ContainerView(Context context) {
            ...
            this.f1781y = BitmapDescriptorFactory.HUE_RED;
        ...
        public boolean processTouchEvent(MotionEvent motionEvent, boolean z) {
            ...
            if (BottomSheet.this.canSwipeToBack()) {
                ...
                BottomSheet.this.onScrollUpBegin(this.f1781y);
                this.startedTrackingPointerId = motionEvent.getPointerId(0);
                this.maybeStartTracking = true;
                cancelCurrentAnimation();
                ...
                boolean onScrollUp = BottomSheet.this.onScrollUp(this.f1781y + y3);
                this.velocityTracker.addMovement(motionEvent);
                if (!BottomSheet.this.disableScroll && this.maybeStartTracking && !this.startedTracking && y3 > BitmapDescriptorFactory.HUE_RED && y3 / 3.0f > Math.abs(abs) && Math.abs(y3) >= BottomSheet.this.touchSlop) {
                    ...
                    float f2 = this.f1781y + y3;
                    this.f1781y = f2;
                    if (!onScrollUp) {
                        this.f1781y = Math.max(f2, (float) BitmapDescriptorFactory.HUE_RED);
                    }
                    BottomSheet.this.containerView.setTranslationY(Math.max(this.f1781y, (float) BitmapDescriptorFactory.HUE_RED));
                    this.startedTrackingY = (int) motionEvent.getY();
                    BottomSheet.this.container.invalidate();
                }
            } else if (motionEvent == null || (motionEvent.getPointerId(0) == this.startedTrackingPointerId && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6))) {
                ...
                BottomSheet.this.onScrollUpEnd(this.f1781y);
                if (this.startedTracking || this.f1781y > BitmapDescriptorFactory.HUE_RED) {
    ...
    protected int getBottomSheetWidth(boolean z, int i, int i2) {
        return z ? i : (int) Math.max(i * 0.8f, Math.min(AndroidUtilities.m104dp(480), i));
    }
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(i4), 1073741824));
        }
        ...
        public void setTextAndIcon(CharSequence charSequence, int i, Drawable drawable, boolean z) {
            ...
            if (i != 0 || drawable != null) {
                ...
                if (z) {
                    this.textView.setPadding(AndroidUtilities.m104dp(LocaleController.isRTL ? 21 : 72), 0, AndroidUtilities.m104dp(LocaleController.isRTL ? 72 : 21), 0);
                    this.imageView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m104dp(5), 0, LocaleController.isRTL ? AndroidUtilities.m104dp(5) : 5, 0);
                    return;
                }
                this.textView.setPadding(AndroidUtilities.m104dp(LocaleController.isRTL ? 16 : 72), 0, AndroidUtilities.m104dp(LocaleController.isRTL ? 72 : 16), 0);
                this.imageView.setPadding(0, 0, 0, 0);
                return;
            }
            this.imageView.setVisibility(4);
            this.textView.setPadding(AndroidUtilities.m104dp(z ? 21 : 16), 0, AndroidUtilities.m104dp(z ? 21 : 16), 0);
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.containerView == null) {
            ...
            this.containerView.setPadding(this.backgroundPaddingLeft, ((this.applyTopPadding ? AndroidUtilities.m104dp(8) : 0) + this.backgroundPaddingTop) - 1, this.backgroundPaddingLeft, this.applyBottomPadding ? AndroidUtilities.m104dp(8) : 0);
        }
        ...
        if (this.title != null) {
                        ...
                        if (BottomSheet.this.customView != null) {
                            ...
                            for (int i4 = 1; i4 < BottomSheet.this.containerView.getChildCount(); i4++) {
                                ...
                                if (childAt instanceof BottomSheetCell) {
                                    ...
                                    measuredHeight += AndroidUtilities.m104dp(48);
                                }
                            }
                        }
                    }
            ...
            if (this.bigTitle) {
                ...
                this.titleView.setPadding(AndroidUtilities.m104dp(21), AndroidUtilities.m104dp(this.multipleLinesTitle ? 14 : 6), AndroidUtilities.m104dp(21), AndroidUtilities.m104dp(8));
            } else {
                this.titleView.setTextColor(getThemedColor(Theme.key_dialogTextGray2));
                this.titleView.setTextSize(1, 16.0f);
                this.titleView.setPadding(AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(this.multipleLinesTitle ? 8 : 0), AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(8));
            }
        ...
        if (this.description != null) {
            ...
            this.descriptionView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.x - AndroidUtilities.m104dp(42), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(0, 0));
            this.descriptionView.setPadding(AndroidUtilities.m104dp(21), AndroidUtilities.m104dp(44), AndroidUtilities.m104dp(21), AndroidUtilities.m104dp(8));
            this.containerView.addView(this.descriptionView, LayoutHelper.createFrame(-1, -2));
            i += AndroidUtilities.m103px(this.descriptionView.getMeasuredHeight()) + 8;
        }
        ...
        if (view != null) {
            ...
            if (!this.useBackgroundTopPadding) {
                ...
                ((ViewGroup.MarginLayoutParams) this.customView.getLayoutParams()).topMargin = (-this.backgroundPaddingTop) + AndroidUtilities.m104dp(i);
            } else {
                this.containerView.addView(this.customView, LayoutHelper.createFrame(-1, -2, this.customViewGravity, 0, i, 0, 0));
            }
    ...
    public void startOpenAnimation() {
        ...
        if (this.transitionFromRight) {
            this.containerView.setTranslationX(AndroidUtilities.m104dp(48));
            this.containerView.setAlpha(BitmapDescriptorFactory.HUE_RED);
            this.containerView.setTranslationY(BitmapDescriptorFactory.HUE_RED);
        } else {
            this.containerView.setTranslationY(getContainerViewHeight() + this.keyboardHeight + AndroidUtilities.m104dp(10) + (this.scrollNavBar ? getBottomInset() : 0));
        }
    ...
    public void dismissWithButtonClick(int i) {
        ...
        fArr[0] = getContainerViewHeight() + this.keyboardHeight + AndroidUtilities.m104dp(10) + (this.scrollNavBar ? getBottomInset() : 0);
