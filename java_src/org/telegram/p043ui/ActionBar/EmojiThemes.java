...
public class EmojiThemes {
    ...
    public SparseIntArray getPreviewColors(int i, int i2) {
        ...
        if (themeInfo == null) {
            ...
            if (themeAccent != null) {
                themeInfo2.setCurrentAccentId(themeAccent.f1782id);
            }
    ...
    public void loadWallpaper(int i, ResultCallback<Pair<Long, Bitmap>> resultCallback) {
        ...
        if (wallpaper != null) {
            loadWallpaperImage(this.currentAccount, getTlTheme(i).f1738id, wallpaper, resultCallback);
    ...
    public static /* synthetic */ void lambda$loadWallpaperImage$1(final ResultCallback resultCallback, final long j, TLRPC$WallPaper tLRPC$WallPaper, final int i, Bitmap bitmap) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$loadWallpaperImage$0(ResultCallback resultCallback, long j, int i, ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
    ...
    public void loadWallpaperThumb(int i, final ResultCallback<Pair<Long, Bitmap>> resultCallback) {
        ...
        final long j = getTlTheme(i).f1738id;
