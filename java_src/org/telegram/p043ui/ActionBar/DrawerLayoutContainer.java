    ...
    */
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.allowDrawContent) {
            ...
            if (z) {
                ...
                if (i != 0) {
                    canvas.clipRect(i - AndroidUtilities.m104dp(1), 0, width, getHeight());
                }
                i2 = i3;
            } else {
                i = 0;
            ...
            if (this.scrimOpacity > BitmapDescriptorFactory.HUE_RED && z) {
                ...
                float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, Math.min(this.drawerPosition / AndroidUtilities.m104dp(20), 1.0f));
    ...
    public static class PreviewForegroundDrawable extends Drawable {
        ...
        public PreviewForegroundDrawable() {
            ...
            gradientDrawable.setStroke(AndroidUtilities.m104dp(1), Theme.getColor(Theme.key_actionBarDefault));
            ...
            gradientDrawable2.setCornerRadius(AndroidUtilities.m104dp(6));
        }
