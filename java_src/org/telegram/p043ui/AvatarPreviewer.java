...
public class AvatarPreviewer {
    ...
    public static final class MenuItem {
        ...
        static {
            MenuItem menuItem = new MenuItem("OPEN_PROFILE", 0, "OpenProfile", C3634R.string.OpenProfile, C3634R.C3636drawable.msg_openprofile);
            OPEN_PROFILE = menuItem;
            MenuItem menuItem2 = new MenuItem("OPEN_CHANNEL", 1, "OpenChannel2", C3634R.string.OpenChannel2, C3634R.C3636drawable.msg_channel);
            OPEN_CHANNEL = menuItem2;
            int i = C3634R.string.OpenGroup2;
            int i2 = C3634R.C3636drawable.msg_discussion;
            MenuItem menuItem3 = new MenuItem("OPEN_GROUP", 2, "OpenGroup2", i, i2);
            OPEN_GROUP = menuItem3;
            MenuItem menuItem4 = new MenuItem("SEND_MESSAGE", 3, "SendMessage", C3634R.string.SendMessage, i2);
            SEND_MESSAGE = menuItem4;
            MenuItem menuItem5 = new MenuItem("MENTION", 4, "Mention", C3634R.string.Mention, C3634R.C3636drawable.msg_mention);
            MENTION = menuItem5;
    ...
    public static class Data {
        ...
        /* renamed from: of */
        public static Data m67of(TLRPC$User tLRPC$User, int i, MenuItem... menuItemArr) {
        ...
        /* renamed from: of */
        public static Data m66of(TLRPC$UserFull tLRPC$UserFull, MenuItem... menuItemArr) {
        ...
        /* renamed from: of */
        public static Data m69of(TLRPC$Chat tLRPC$Chat, int i, MenuItem... menuItemArr) {
        ...
        /* renamed from: of */
        public static Data m68of(TLRPC$Chat tLRPC$Chat, TLRPC$ChatFull tLRPC$ChatFull, MenuItem... menuItemArr) {
            ImageLocation imageLocation;
            String str;
            ImageLocation forUserOrChat = ImageLocation.getForUserOrChat(tLRPC$Chat, 0);
            ImageLocation forUserOrChat2 = ImageLocation.getForUserOrChat(tLRPC$Chat, 1);
    ...
    public static class UserInfoLoadTask extends InfoLoadTask<TLRPC$User, TLRPC$UserFull> {
        ...
        protected void onReceiveNotification(Object... objArr) {
            if (((Long) objArr[0]).longValue() == ((TLRPC$User) this.argument).f1749id) {
    ...
    public static abstract class Layout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public Layout(Context context, Callback callback) {
            super(context);
            this.radialProgressSize = AndroidUtilities.m105dp(64.0f);
            new Rect();
            ...
            this.arrowDrawable = ContextCompat.getDrawable(context, C3634R.C3636drawable.preview_arrow);
        }
                ...
                if (this.moveAnimator == null) {
                    if (motionEvent.getActionMasked() == 1) {
                        ...
                        if (this.downY < BitmapDescriptorFactory.HUE_RED) {
                            ...
                            float max = Math.max(-1.0f, Math.min((float) BitmapDescriptorFactory.HUE_RED, (motionEvent.getY() - this.downY) / AndroidUtilities.m104dp(56)));
        ...
        public void invalidateSize() {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                int stableInsetLeft = this.insets.getStableInsetLeft() + m104dp;
                i2 = this.insets.getStableInsetRight() + m104dp;
                i = m104dp + Math.max(this.insets.getStableInsetTop(), this.insets.getStableInsetBottom());
                m104dp = stableInsetLeft;
            } else {
                i = m104dp;
                i2 = i;
            }
            ...
            int i3 = width - (i2 + m104dp);
            int i4 = height - (i * 2);
            int min = Math.min(i3, i4);
            int i5 = intrinsicHeight / 2;
            int i6 = m104dp2 + i5;
            int i7 = ((i3 - min) / 2) + m104dp;
        ...
        */
        ...
        public /* synthetic */ void lambda$setData$5(Data data, Object obj) {
            ...
            if (obj instanceof TLRPC$UserFull) {
                setData(Data.m66of((TLRPC$UserFull) obj, data.menuItems));
            } else if (obj instanceof TLRPC$ChatFull) {
                setData(Data.m68of((TLRPC$Chat) data.infoLoadTask.argument, (TLRPC$ChatFull) obj, data.menuItems));
            }
        }
