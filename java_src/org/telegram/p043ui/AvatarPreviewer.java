...
public class AvatarPreviewer {
    ...
    public static final class MenuItem {
        ...
        static {
            MenuItem menuItem = new MenuItem("OPEN_PROFILE", 0, "OpenProfile", C3473R.string.OpenProfile, C3473R.C3475drawable.msg_openprofile);
            OPEN_PROFILE = menuItem;
            MenuItem menuItem2 = new MenuItem("OPEN_CHANNEL", 1, "OpenChannel2", C3473R.string.OpenChannel2, C3473R.C3475drawable.msg_channel);
            OPEN_CHANNEL = menuItem2;
            int i = C3473R.string.OpenGroup2;
            int i2 = C3473R.C3475drawable.msg_discussion;
            MenuItem menuItem3 = new MenuItem("OPEN_GROUP", 2, "OpenGroup2", i, i2);
            OPEN_GROUP = menuItem3;
            MenuItem menuItem4 = new MenuItem("SEND_MESSAGE", 3, "SendMessage", C3473R.string.SendMessage, i2);
            SEND_MESSAGE = menuItem4;
            MenuItem menuItem5 = new MenuItem("MENTION", 4, "Mention", C3473R.string.Mention, C3473R.C3475drawable.msg_mention);
            MENTION = menuItem5;
    ...
    public static class UserInfoLoadTask extends InfoLoadTask<TLRPC$User, TLRPC$UserFull> {
        ...
        protected void onReceiveNotification(Object... objArr) {
            if (((Long) objArr[0]).longValue() == ((TLRPC$User) this.argument).f1685id) {
    ...
    public static class ChatInfoLoadTask extends InfoLoadTask<TLRPC$Chat, TLRPC$ChatFull> {
        ...
        @Override // org.telegram.p043ui.AvatarPreviewer.InfoLoadTask
        protected void load() {
            MessagesController.getInstance(UserConfig.selectedAccount).loadFullChat(((TLRPC$Chat) this.argument).f1522id, this.classGuid, false);
        }

        @Override // org.telegram.p043ui.AvatarPreviewer.InfoLoadTask
        protected void onReceiveNotification(Object... objArr) {
            TLRPC$ChatFull tLRPC$ChatFull = (TLRPC$ChatFull) objArr[0];
            if (tLRPC$ChatFull == null || tLRPC$ChatFull.f1523id != ((TLRPC$Chat) this.argument).f1522id) {
                return;
            }
    ...
    public static abstract class Layout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public Layout(Context context, Callback callback) {
            ...
            this.arrowDrawable = ContextCompat.getDrawable(context, C3473R.C3475drawable.preview_arrow);
        }
