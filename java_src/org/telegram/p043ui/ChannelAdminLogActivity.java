...
public class ChannelAdminLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateEmptyPlaceholder() {
        ...
        if (!TextUtils.isEmpty(this.searchQuery)) {
            this.emptyView.setPadding(AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(5));
            ...
            this.emptyView.setPadding(AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16));
    ...
    public View createView(Context context) {
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.5
                ...
                for (int i4 = 0; i4 < childCount; i4++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && childAt != ((BaseFragment) ChannelAdminLogActivity.this).actionBar) {
                        if (childAt != ChannelAdminLogActivity.this.chatListView && childAt != ChannelAdminLogActivity.this.progressView) {
                            ...
                            childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m107dp(10), paddingTop - AndroidUtilities.m107dp(50)), 1073741824));
                        }
                    }
                }
            }
            ...
            */
            public void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChannelAdminLogActivity.C41355.onLayout(boolean, int, int, int, int):void");
            }
        ...
        this.emptyView.setBackground(Theme.createServiceDrawable(AndroidUtilities.m107dp(6), this.emptyView, this.contentView));
        this.emptyView.setPadding(AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.6
            ...
            public boolean drawChild(Canvas canvas, View view, long j) {
                ...
                if ((view instanceof ChatMessageCell) && (avatarImage = (chatMessageCell = (ChatMessageCell) view).getAvatarImage()) != null) {
                    ...
                    if (y3 - AndroidUtilities.m107dp(48) < y2) {
                        y3 = y2 + AndroidUtilities.m107dp(48);
                    }
                    ...
                    avatarImage.setImageY(y3 - AndroidUtilities.m107dp(44));
        ...
        this.chatListView.setPadding(0, AndroidUtilities.m107dp(4), 0, AndroidUtilities.m107dp(3));
        RecyclerListView recyclerListView3 = this.chatListView;
        C41388 c41388 = new C41388(null, this.chatListView, null);
        this.chatListItemAnimator = c41388;
        recyclerListView3.setItemAnimator(c41388);
        ...
        view.setBackground(Theme.createServiceDrawable(AndroidUtilities.m107dp(18), this.progressView2, this.contentView));
        ...
        this.bottomOverlayChat.setPadding(0, AndroidUtilities.m107dp(3), 0, 0);
    ...
    /* loaded from: classes5.dex */
    public class C41388 extends ChatListItemAnimator {
        Runnable finishRunnable;
        int scrollAnimationIndex;

        C41388(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onAnimationStart() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("admin logs chatItemAnimator disable notifications");
            }
        }
        ...
        public void onAllAnimationsDone() {
            ...
            Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.ChannelAdminLogActivity$8$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ChannelAdminLogActivity.C41388.this.lambda$onAllAnimationsDone$0();
                }
            };
        ...
        public /* synthetic */ void lambda$onAllAnimationsDone$0() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("admin logs chatItemAnimator enable notifications");
            }
        }
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$createMenu$9(final ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, View view, float f, float f2) {
        ...
        chatScrimPopupContainerLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(1000), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(1000), Integer.MIN_VALUE));
        ...
        int left = (((view.getLeft() + ((int) f)) - chatScrimPopupContainerLayout.getMeasuredWidth()) + rect.left) - AndroidUtilities.m107dp(28);
        if (left < AndroidUtilities.m107dp(6)) {
            left = AndroidUtilities.m107dp(6);
        } else if (left > (this.chatListView.getMeasuredWidth() - AndroidUtilities.m107dp(6)) - chatScrimPopupContainerLayout.getMeasuredWidth()) {
            left = (this.chatListView.getMeasuredWidth() - AndroidUtilities.m107dp(6)) - chatScrimPopupContainerLayout.getMeasuredWidth();
        }
        ...
        int measuredHeight = chatScrimPopupContainerLayout.getMeasuredHeight() + AndroidUtilities.m107dp(48);
        ...
        if (measuredHeight < height) {
            ...
            if ((measuredHeight - rect.top) - rect.bottom > AndroidUtilities.m107dp((int) PsExtractor.VIDEO_STREAM_MASK)) {
                i2 += AndroidUtilities.m107dp((int) PsExtractor.VIDEO_STREAM_MASK) - measuredHeight;
            }
            if (i2 < this.chatListView.getY() + AndroidUtilities.m107dp(24)) {
                i2 = (int) (this.chatListView.getY() + AndroidUtilities.m107dp(24));
            } else {
                int i4 = height - measuredHeight;
                if (i2 > i4 - AndroidUtilities.m107dp(8)) {
                    i2 = i4 - AndroidUtilities.m107dp(8);
                }
            }
    ...
    */
    ...
    public /* synthetic */ void lambda$processSelectedOption$11(TLObject tLObject) {
        if (tLObject instanceof TLRPC$TL_boolTrue) {
            BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.msg_antispam, LocaleController.getString("ChannelAntiSpamFalsePositiveReported", C3632R.string.ChannelAntiSpamFalsePositiveReported)).show();
        } else if (tLObject instanceof TLRPC$TL_boolFalse) {
            BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.error, LocaleController.getString("UnknownError", C3632R.string.UnknownError)).show();
        } else {
            BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.error, LocaleController.getString("UnknownError", C3632R.string.UnknownError)).show();
        }
    }
    ...
    private void loadAntispamUser(long j) {
        ...
        tLRPC$TL_users_getUsers.f1747id.add(tLRPC$TL_inputUser);
    ...
    public void updateMessagesVisiblePart() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                chatMessageCell2.setVisiblePart(i4, measuredHeight2 - i4, (this.contentView.getHeightWithKeyboard() - AndroidUtilities.m107dp(48)) - this.chatListView.getTop(), BitmapDescriptorFactory.HUE_RED, (childAt.getY() + this.actionBar.getMeasuredHeight()) - this.contentView.getBackgroundTranslationY(), this.contentView.getMeasuredWidth(), this.contentView.getBackgroundSizeY(), 0, 0);
                ...
                chatActionCell2.setVisiblePart((childAt.getY() + this.actionBar.getMeasuredHeight()) - this.contentView.getBackgroundTranslationY(), this.contentView.getBackgroundSizeY());
                if (chatActionCell2.hasGradientService()) {
                    chatActionCell2.invalidate();
                }
            }
    ...
    public class ChatActivityAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                chatMessageCell.setDelegate(new C41401());
                ...
                chatActionCell2.setDelegate(new C41423());
        ...
        /* loaded from: classes5.dex */
        public class C41401 implements ChatMessageCell.ChatMessageCellDelegate {
            ...
            public void didPressUserAvatar(ChatMessageCell chatMessageCell, TLRPC$User tLRPC$User, float f, float f2) {
                if (tLRPC$User == null || tLRPC$User.f1751id == UserConfig.getInstance(((BaseFragment) ChannelAdminLogActivity.this).currentAccount).getClientUserId()) {
                    return;
                }
            ...
            public boolean didLongPressUserAvatar(final ChatMessageCell chatMessageCell, final TLRPC$User tLRPC$User, float f, float f2, boolean z) {
                AvatarPreviewer.Data m70of;
                if (tLRPC$User != null && tLRPC$User.f1751id != UserConfig.getInstance(((BaseFragment) ChannelAdminLogActivity.this).currentAccount).getClientUserId()) {
                    AvatarPreviewer.MenuItem[] menuItemArr = {AvatarPreviewer.MenuItem.OPEN_PROFILE, AvatarPreviewer.MenuItem.SEND_MESSAGE};
                    TLRPC$UserFull userFull = ChannelAdminLogActivity.this.getMessagesController().getUserFull(tLRPC$User.f1751id);
                    if (userFull == null) {
                        m70of = AvatarPreviewer.Data.m70of(tLRPC$User, ((BaseFragment) ChannelAdminLogActivity.this).classGuid, menuItemArr);
                    } else {
                        m70of = AvatarPreviewer.Data.m69of(userFull, menuItemArr);
                    }
                    if (AvatarPreviewer.canPreview(m70of)) {
                        AvatarPreviewer.getInstance().show((ViewGroup) ChannelAdminLogActivity.this.fragmentView, m70of, new AvatarPreviewer.Callback() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$1$$ExternalSyntheticLambda1
                            @Override // org.telegram.p043ui.AvatarPreviewer.Callback
                            public final void onMenuClick(AvatarPreviewer.MenuItem menuItem) {
                                ChannelAdminLogActivity.ChatActivityAdapter.C41401.this.lambda$didLongPressUserAvatar$0(chatMessageCell, tLRPC$User, menuItem);
                            }
                        });
                        return true;
                    }
            ...
            public /* synthetic */ void lambda$didLongPressUserAvatar$0(ChatMessageCell chatMessageCell, TLRPC$User tLRPC$User, AvatarPreviewer.MenuItem menuItem) {
                int i = C413223.$SwitchMap$org$telegram$ui$AvatarPreviewer$MenuItem[menuItem.ordinal()];
                if (i == 1) {
            ...
            private void openProfile(TLRPC$User tLRPC$User) {
                ...
                ChannelAdminLogActivity.this.addCanBanUser(bundle, tLRPC$User.f1751id);
                ...
                if (characterStyle instanceof URLSpanMono) {
                    ...
                    if (z) {
                        ...
                        builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3632R.string.Open), LocaleController.getString("Copy", C3632R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$1$$ExternalSyntheticLambda0
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i) {
                                ChannelAdminLogActivity.ChatActivityAdapter.C41401.this.lambda$didPressUrl$1(url2, dialogInterface, i);
                            }
                        });
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public void didPressImage(org.telegram.p043ui.Cells.ChatMessageCell r11, float r12, float r13) {
                /*
                    Method dump skipped, instructions count: 501
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChannelAdminLogActivity.ChatActivityAdapter.C41401.didPressImage(org.telegram.ui.Cells.ChatMessageCell, float, float):void");
            }
        ...
        /* loaded from: classes5.dex */
        public class C41423 implements ChatActionCell.ChatActionCellDelegate {
                ...
                if (obj == null) {
                    ...
                    alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda0
                        ...
                        public final void onCancel(DialogInterface dialogInterface) {
                            ChannelAdminLogActivity.ChatActivityAdapter.C41423.this.lambda$needOpenInviteLink$0(zArr, dialogInterface);
                        }
                    });
                    ...
                    ChannelAdminLogActivity.this.getConnectionsManager().bindRequestToGuid(ChannelAdminLogActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_messages_getExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda2
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            ChannelAdminLogActivity.ChatActivityAdapter.C41423.this.lambda$needOpenInviteLink$2(tLRPC$TL_chatInviteExported, zArr, alertDialog, tLObject, tLRPC$TL_error);
                        }
                    ...
                    BulletinFactory.m65of(ChannelAdminLogActivity.this).createSimpleBulletin(C3632R.raw.linkbroken, LocaleController.getString("LinkHashExpired", C3632R.string.LinkHashExpired)).show();
                }
            }
            ...
            public /* synthetic */ void lambda$needOpenInviteLink$2(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, final boolean[] zArr, final AlertDialog alertDialog, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                ...
                if (tLRPC$TL_error == null) {
                    ...
                    for (int i = 0; i < tLRPC$TL_messages_exportedChatInvite.users.size(); i++) {
                        ...
                        ChannelAdminLogActivity.this.usersMap.put(Long.valueOf(tLRPC$User.f1751id), tLRPC$User);
                    }
                } else {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChannelAdminLogActivity.ChatActivityAdapter.C41423.this.lambda$needOpenInviteLink$1(tLRPC$TL_chatInviteExported, tLRPC$TL_messages_exportedChatInvite2, zArr, alertDialog);
                    }
                });
            }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C413223 {
