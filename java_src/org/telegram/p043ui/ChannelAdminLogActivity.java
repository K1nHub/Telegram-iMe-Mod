...
public class ChannelAdminLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateEmptyPlaceholder() {
        ...
        if (!TextUtils.isEmpty(this.searchQuery)) {
            this.emptyView.setPadding(AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(5), AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(5));
            this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("EventLogEmptyTextSearch", C3473R.string.EventLogEmptyTextSearch, this.searchQuery)));
        } else if (this.selectedAdmins != null || this.currentFilter != null) {
            this.emptyView.setPadding(AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(5), AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(5));
            this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmptySearch", C3473R.string.EventLogEmptySearch)));
        } else {
            this.emptyView.setPadding(AndroidUtilities.m72dp(16), AndroidUtilities.m72dp(16), AndroidUtilities.m72dp(16), AndroidUtilities.m72dp(16));
            if (this.currentChat.megagroup) {
                this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmpty", C3473R.string.EventLogEmpty)));
            } else {
                this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmptyChannel", C3473R.string.EventLogEmptyChannel)));
            }
        }
    }
    ...
    public void loadMessages(boolean z) {
        ...
        tLRPC$TL_channels_getAdminLog.f1563q = this.searchQuery;
    ...
    public /* synthetic */ void lambda$loadMessages$0(TLRPC$TL_channels_adminLogResults tLRPC$TL_channels_adminLogResults) {
        ...
        for (int i2 = 0; i2 < tLRPC$TL_channels_adminLogResults.events.size(); i2++) {
            ...
            if (this.messagesDict.indexOfKey(tLRPC$TL_channelAdminLogEvent.f1560id) < 0) {
                ...
                this.minEventId = Math.min(this.minEventId, tLRPC$TL_channelAdminLogEvent.f1560id);
                ...
                if (messageObject.contentType >= 0) {
                    this.messagesDict.put(tLRPC$TL_channelAdminLogEvent.f1560id, messageObject);
                }
                z = true;
            }
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ChannelAdminLogActivity.3
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C3473R.C3475drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.ChannelAdminLogActivity.4
        ...
        this.avatarContainer.setSubtitle(LocaleController.getString("EventLogAllEvents", C3473R.string.EventLogAllEvents));
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.5
            ...
            public void onAttachedToWindow() {
                ...
                MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                if (playingMessageObject == null || !playingMessageObject.isRoundVideo() || playingMessageObject.eventId == 0 || playingMessageObject.getDialogId() != (-ChannelAdminLogActivity.this.currentChat.f1522id)) {
                    return;
                }
                ...
                for (int i4 = 0; i4 < childCount; i4++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && childAt != ((BaseFragment) ChannelAdminLogActivity.this).actionBar) {
                        if (childAt != ChannelAdminLogActivity.this.chatListView && childAt != ChannelAdminLogActivity.this.progressView) {
                            ...
                            childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m72dp(10), paddingTop - AndroidUtilities.m72dp(50)), 1073741824));
                        }
                    }
                }
            }
            ...
            */
            public void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChannelAdminLogActivity.C39555.onLayout(boolean, int, int, int, int):void");
            }
        ...
        this.emptyView.setBackground(Theme.createServiceDrawable(AndroidUtilities.m72dp(6), this.emptyView, this.contentView));
        this.emptyView.setPadding(AndroidUtilities.m72dp(16), AndroidUtilities.m72dp(16), AndroidUtilities.m72dp(16), AndroidUtilities.m72dp(16));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.6
            ...
            public boolean drawChild(Canvas canvas, View view, long j) {
                ...
                if ((view instanceof ChatMessageCell) && (avatarImage = (chatMessageCell = (ChatMessageCell) view).getAvatarImage()) != null) {
                    ...
                    if (y3 - AndroidUtilities.m72dp(48) < y2) {
                        y3 = y2 + AndroidUtilities.m72dp(48);
                    }
                    ...
                    avatarImage.setImageY(y3 - AndroidUtilities.m72dp(44));
        ...
        this.chatListView.setPadding(0, AndroidUtilities.m72dp(4), 0, AndroidUtilities.m72dp(3));
        RecyclerListView recyclerListView3 = this.chatListView;
        C39588 c39588 = new C39588(null, this.chatListView, null);
        this.chatListItemAnimator = c39588;
        recyclerListView3.setItemAnimator(c39588);
        ...
        view.setBackground(Theme.createServiceDrawable(AndroidUtilities.m72dp(18), this.progressView2, this.contentView));
        ...
        this.bottomOverlayChat.setPadding(0, AndroidUtilities.m72dp(3), 0, 0);
        ...
        this.bottomOverlayChatText.setText(LocaleController.getString("SETTINGS", C3473R.string.SETTINGS).toUpperCase());
        ...
        imageView.setImageResource(C3473R.C3475drawable.msg_help);
        ...
        this.bottomOverlayImage.setContentDescription(LocaleController.getString("BotHelp", C3473R.string.BotHelp));
        ...
        this.searchContainer.setPadding(0, AndroidUtilities.m72dp(3), 0, 0);
        ...
        this.searchCalendarButton.setImageResource(C3473R.C3475drawable.msg_calendar);
        ...
        undoView.setAdditionalTranslationY(AndroidUtilities.m72dp(51));
    ...
    /* loaded from: classes3.dex */
    public class C39588 extends ChatListItemAnimator {
        Runnable finishRunnable;
        int scrollAnimationIndex;

        C39588(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onAnimationStart() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m70d("admin logs chatItemAnimator disable notifications");
            }
        }
        ...
        public void onAllAnimationsDone() {
            ...
            Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.ChannelAdminLogActivity$8$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ChannelAdminLogActivity.C39588.this.lambda$onAllAnimationsDone$0();
                }
            };
        ...
        public /* synthetic */ void lambda$onAllAnimationsDone$0() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m70d("admin logs chatItemAnimator enable notifications");
            }
        }
    }
    ...
    public /* synthetic */ void lambda$createView$3(TLRPC$TL_channelAdminLogEventsFilter tLRPC$TL_channelAdminLogEventsFilter, LongSparseArray longSparseArray) {
        ...
        if (tLRPC$TL_channelAdminLogEventsFilter != null || longSparseArray != null) {
            this.avatarContainer.setSubtitle(LocaleController.getString("EventLogSelectedEvents", C3473R.string.EventLogSelectedEvents));
        } else {
            this.avatarContainer.setSubtitle(LocaleController.getString("EventLogAllEvents", C3473R.string.EventLogAllEvents));
        }
        loadMessages(true);
    ...
    public /* synthetic */ void lambda$createView$5(View view) {
        ...
        if (this.currentChat.megagroup) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("EventLogInfoDetail", C3473R.string.EventLogInfoDetail)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("EventLogInfoDetailChannel", C3473R.string.EventLogInfoDetailChannel)));
        }
        builder.setPositiveButton(LocaleController.getString("OK", C3473R.string.OK), null);
        builder.setTitle(LocaleController.getString("EventLogInfoTitle", C3473R.string.EventLogInfoTitle));
    ...
    */
    ...
    public /* synthetic */ void lambda$createMenu$9(final ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, View view, float f, float f2) {
        ...
        int i = C3473R.C3475drawable.popup_fixed_alert;
        int i2 = 0;
        ...
        actionBarPopupWindowLayout.setMinimumWidth(AndroidUtilities.m72dp(200));
        Rect rect = new Rect();
        ...
        this.scrimPopupWindow.setAnimationStyle(C3473R.style.PopupContextAnimation);
        this.scrimPopupWindow.setFocusable(true);
        chatScrimPopupContainerLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(1000), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(1000), Integer.MIN_VALUE));
        ...
        int left = (((view.getLeft() + ((int) f)) - chatScrimPopupContainerLayout.getMeasuredWidth()) + rect.left) - AndroidUtilities.m72dp(28);
        if (left < AndroidUtilities.m72dp(6)) {
            left = AndroidUtilities.m72dp(6);
        } else if (left > (this.chatListView.getMeasuredWidth() - AndroidUtilities.m72dp(6)) - chatScrimPopupContainerLayout.getMeasuredWidth()) {
            left = (this.chatListView.getMeasuredWidth() - AndroidUtilities.m72dp(6)) - chatScrimPopupContainerLayout.getMeasuredWidth();
        }
        ...
        int measuredHeight = chatScrimPopupContainerLayout.getMeasuredHeight() + AndroidUtilities.m72dp(48);
        ...
        if (measuredHeight < height) {
            ...
            if ((measuredHeight - rect.top) - rect.bottom > AndroidUtilities.m72dp((int) PsExtractor.VIDEO_STREAM_MASK)) {
                i2 += AndroidUtilities.m72dp((int) PsExtractor.VIDEO_STREAM_MASK) - measuredHeight;
            }
            if (i2 < this.chatListView.getY() + AndroidUtilities.m72dp(24)) {
                i2 = (int) (this.chatListView.getY() + AndroidUtilities.m72dp(24));
            } else {
                int i4 = height - measuredHeight;
                if (i2 > i4 - AndroidUtilities.m72dp(8)) {
                    i2 = i4 - AndroidUtilities.m72dp(8);
                }
            }
    ...
    public static /* synthetic */ void lambda$createMenu$10(ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, Runnable runnable, boolean z, TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, String str) {
        if (z) {
            arrayList.add(LocaleController.getString("BanUser", C3473R.string.BanUser));
            arrayList2.add(Integer.valueOf(C3473R.C3475drawable.msg_block2));
            arrayList3.add(33);
        }
    ...
    */
    ...
    public /* synthetic */ void lambda$processSelectedOption$11(TLObject tLObject) {
        if (tLObject instanceof TLRPC$TL_boolTrue) {
            BulletinFactory.m32of(this).createSimpleBulletin(C3473R.raw.msg_antispam, LocaleController.getString("ChannelAntiSpamFalsePositiveReported", C3473R.string.ChannelAntiSpamFalsePositiveReported)).show();
        } else if (tLObject instanceof TLRPC$TL_boolFalse) {
            BulletinFactory.m32of(this).createSimpleBulletin(C3473R.raw.error, LocaleController.getString("UnknownError", C3473R.string.UnknownError)).show();
        } else {
            BulletinFactory.m32of(this).createSimpleBulletin(C3473R.raw.error, LocaleController.getString("UnknownError", C3473R.string.UnknownError)).show();
        }
    }
        ...
        if (i == 10 || i == 11 || i == 16) {
            ...
            if (messageObject.isSticker() || messageObject.isAnimatedSticker()) {
                ...
                if (inputStickerSet instanceof TLRPC$TL_inputStickerSetID) {
                    if (!MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(inputStickerSet.f1545id)) {
                        return 7;
                    }
    ...
    public /* synthetic */ void lambda$loadAdmins$13(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (tLRPC$TL_error == null) {
            ...
            if (this.currentChat != null && (chatFull = getMessagesController().getChatFull(this.currentChat.f1522id)) != null && chatFull.antispam) {
    ...
    private void loadAntispamUser(long j) {
        ...
        tLRPC$TL_users_getUsers.f1681id.add(tLRPC$TL_inputUser);
    ...
    public void updateMessagesVisiblePart() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                chatMessageCell2.setVisiblePart(i4, measuredHeight2 - i4, (this.contentView.getHeightWithKeyboard() - AndroidUtilities.m72dp(48)) - this.chatListView.getTop(), BitmapDescriptorFactory.HUE_RED, (childAt.getY() + this.actionBar.getMeasuredHeight()) - this.contentView.getBackgroundTranslationY(), this.contentView.getMeasuredWidth(), this.contentView.getBackgroundSizeY(), 0, 0);
    ...
    public void alertUserOpenError(MessageObject messageObject) {
        ...
        if (messageObject.type == 3) {
            builder.setMessage(LocaleController.getString("NoPlayerInstalled", C3473R.string.NoPlayerInstalled));
        } else {
            builder.setMessage(LocaleController.formatString("NoHandleAppInstalled", C3473R.string.NoHandleAppInstalled, messageObject.getDocument().mime_type));
        }
        showDialog(builder.create());
    }
    ...
    public void addCanBanUser(Bundle bundle, long j) {
        ...
        if (tLRPC$Chat.megagroup && this.admins != null && ChatObject.canBlockUsers(tLRPC$Chat)) {
            ...
            bundle.putLong("ban_chat_id", this.currentChat.f1522id);
        }
    }
    ...
    public void showOpenUrlAlert(final String str, boolean z) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setTitle(LocaleController.getString("OpenUrlTitle", C3473R.string.OpenUrlTitle));
        builder.setMessage(LocaleController.formatString("OpenUrlAlert2", C3473R.string.OpenUrlAlert2, str));
        builder.setPositiveButton(LocaleController.getString("Open", C3473R.string.Open), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda0
    ...
    public class ChatActivityAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                chatMessageCell.setDelegate(new C39601());
                ...
                chatActionCell2.setDelegate(new C39623());
        ...
        /* loaded from: classes3.dex */
        public class C39601 implements ChatMessageCell.ChatMessageCellDelegate {
            ...
            public void didPressUserAvatar(ChatMessageCell chatMessageCell, TLRPC$User tLRPC$User, float f, float f2) {
                if (tLRPC$User == null || tLRPC$User.f1685id == UserConfig.getInstance(((BaseFragment) ChannelAdminLogActivity.this).currentAccount).getClientUserId()) {
                    return;
                }
            ...
            public boolean didLongPressUserAvatar(final ChatMessageCell chatMessageCell, final TLRPC$User tLRPC$User, float f, float f2, boolean z) {
                AvatarPreviewer.Data m37of;
                if (tLRPC$User != null && tLRPC$User.f1685id != UserConfig.getInstance(((BaseFragment) ChannelAdminLogActivity.this).currentAccount).getClientUserId()) {
                    AvatarPreviewer.MenuItem[] menuItemArr = {AvatarPreviewer.MenuItem.OPEN_PROFILE, AvatarPreviewer.MenuItem.SEND_MESSAGE};
                    TLRPC$UserFull userFull = ChannelAdminLogActivity.this.getMessagesController().getUserFull(tLRPC$User.f1685id);
                    if (userFull == null) {
                        m37of = AvatarPreviewer.Data.m37of(tLRPC$User, ((BaseFragment) ChannelAdminLogActivity.this).classGuid, menuItemArr);
                    } else {
                        m37of = AvatarPreviewer.Data.m36of(userFull, menuItemArr);
                    }
                    if (AvatarPreviewer.canPreview(m37of)) {
                        AvatarPreviewer.getInstance().show((ViewGroup) ((BaseFragment) ChannelAdminLogActivity.this).fragmentView, m37of, new AvatarPreviewer.Callback() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$1$$ExternalSyntheticLambda1
                            @Override // org.telegram.p043ui.AvatarPreviewer.Callback
                            public final void onMenuClick(AvatarPreviewer.MenuItem menuItem) {
                                ChannelAdminLogActivity.ChatActivityAdapter.C39601.this.lambda$didLongPressUserAvatar$0(chatMessageCell, tLRPC$User, menuItem);
                            }
                        });
                        return true;
                    }
            ...
            public /* synthetic */ void lambda$didLongPressUserAvatar$0(ChatMessageCell chatMessageCell, TLRPC$User tLRPC$User, AvatarPreviewer.MenuItem menuItem) {
                int i = C395223.$SwitchMap$org$telegram$ui$AvatarPreviewer$MenuItem[menuItem.ordinal()];
                if (i == 1) {
            ...
            private void openProfile(TLRPC$User tLRPC$User) {
                ...
                ChannelAdminLogActivity.this.addCanBanUser(bundle, tLRPC$User.f1685id);
            ...
            public void didPressUrl(ChatMessageCell chatMessageCell, CharacterStyle characterStyle, boolean z) {
                ...
                if (characterStyle instanceof URLSpanMono) {
                    ...
                    if (AndroidUtilities.shouldShowClipboardToast()) {
                        Toast.makeText(ChannelAdminLogActivity.this.getParentActivity(), LocaleController.getString("TextCopied", C3473R.string.TextCopied), 0).show();
                    }
                    ...
                    if (z) {
                        ...
                        builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3473R.string.Open), LocaleController.getString("Copy", C3473R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$1$$ExternalSyntheticLambda0
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i) {
                                ChannelAdminLogActivity.ChatActivityAdapter.C39601.this.lambda$didPressUrl$1(url2, dialogInterface, i);
                            }
                        });
            ...
            */
            public void didPressImage(org.telegram.p043ui.Cells.ChatMessageCell r10, float r11, float r12) {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.ChannelAdminLogActivity.ChatActivityAdapter.C39601.didPressImage(org.telegram.ui.Cells.ChatMessageCell, float, float):void");
            }
        ...
        /* loaded from: classes3.dex */
        public class C39623 implements ChatActionCell.ChatActionCellDelegate {
            ...
            public void needOpenInviteLink(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported) {
                ...
                if (obj == null) {
                    ...
                    tLRPC$TL_messages_getExportedChatInvite.peer = ChannelAdminLogActivity.this.getMessagesController().getInputPeer(-ChannelAdminLogActivity.this.currentChat.f1522id);
                    ...
                    alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda0
                        ...
                        public final void onCancel(DialogInterface dialogInterface) {
                            ChannelAdminLogActivity.ChatActivityAdapter.C39623.this.lambda$needOpenInviteLink$0(zArr, dialogInterface);
                        }
                    });
                    ...
                    ChannelAdminLogActivity.this.getConnectionsManager().bindRequestToGuid(ChannelAdminLogActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_messages_getExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda2
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            ChannelAdminLogActivity.ChatActivityAdapter.C39623.this.lambda$needOpenInviteLink$2(tLRPC$TL_chatInviteExported, zArr, alertDialog, tLObject, tLRPC$TL_error);
                        }
                    ...
                    BulletinFactory.m32of(ChannelAdminLogActivity.this).createSimpleBulletin(C3473R.raw.linkbroken, LocaleController.getString("LinkHashExpired", C3473R.string.LinkHashExpired)).show();
                }
            }
            ...
            public /* synthetic */ void lambda$needOpenInviteLink$2(final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, final boolean[] zArr, final AlertDialog alertDialog, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                ...
                if (tLRPC$TL_error == null) {
                    ...
                    for (int i = 0; i < tLRPC$TL_messages_exportedChatInvite.users.size(); i++) {
                        ...
                        ChannelAdminLogActivity.this.usersMap.put(Long.valueOf(tLRPC$User.f1685id), tLRPC$User);
                    }
                } else {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$3$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChannelAdminLogActivity.ChatActivityAdapter.C39623.this.lambda$needOpenInviteLink$1(tLRPC$TL_chatInviteExported, tLRPC$TL_messages_exportedChatInvite2, zArr, alertDialog);
                    }
                });
            }
            ...
            public long getDialogId() {
                return -ChannelAdminLogActivity.this.currentChat.f1522id;
            }
        }
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C395223 {
    ...
    public void showInviteLinkBottomSheet(TLRPC$TL_messages_exportedChatInvite tLRPC$TL_messages_exportedChatInvite, HashMap<Long, TLRPC$User> hashMap) {
        TLRPC$ChatFull chatFull = getMessagesController().getChatFull(this.currentChat.f1522id);
        InviteLinkBottomSheet inviteLinkBottomSheet = new InviteLinkBottomSheet(this.contentView.getContext(), (TLRPC$TL_chatInviteExported) tLRPC$TL_messages_exportedChatInvite.invite, chatFull, hashMap, this, chatFull.f1523id, false, ChatObject.isChannel(this.currentChat));
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(c3541ActionBar2, i3, null, null, null, null, i4));
