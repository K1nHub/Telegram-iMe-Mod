...
public abstract class RightSlidingDialogContainer extends FrameLayout {
    ...
    C3541ActionBar currentActionBarView;
    ...
    public void presentFragment(INavigationLayout iNavigationLayout, final BaseFragment baseFragment) {
        ...
        if (baseFragment.onFragmentCreate()) {
            ...
            if (baseFragment.getActionBar() != null) {
                C3541ActionBar actionBar = baseFragment.getActionBar();
    ...
    protected void updateOpenAnimationProgress() {
        ...
        if ((!(baseFragment instanceof DialogsActivity) || (((DialogsActivity) baseFragment).isMainNoFolderDialogList() && !SharedConfig.isMainActionBarMenuEnabled)) && (c3541ActionBar = this.currentActionBarView) != null) {
            c3541ActionBar.setTranslationX(AndroidUtilities.m72dp(48) * (1.0f - this.openedProgress));
        }
        BaseFragment baseFragment2 = this.currentFragment;
        if (baseFragment2 != null) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (view != null) {
            ...
            layoutParams.topMargin = C3541ActionBar.getCurrentActionBarHeight() + i3 + this.fragmentViewPadding;
        }
        C3541ActionBar c3541ActionBar = this.currentActionBarView;
        if (c3541ActionBar != null) {
            ((FrameLayout.LayoutParams) c3541ActionBar.getLayoutParams()).topMargin = i3;
        }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        C3541ActionBar c3541ActionBar = this.currentActionBarView;
        if (view == c3541ActionBar && c3541ActionBar.getActionMode() != null && this.currentActionBarView.getActionMode().getAlpha() == 1.0f) {
            return true;
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        C3541ActionBar c3541ActionBar = this.currentActionBarView;
        float alpha = (c3541ActionBar == null || c3541ActionBar.getActionMode() == null) ? 0.0f : this.currentActionBarView.getActionMode().getAlpha();
        C3541ActionBar c3541ActionBar2 = this.currentActionBarView;
        float max = f * Math.max(alpha, c3541ActionBar2 == null ? 0.0f : c3541ActionBar2.searchFieldVisibleAlpha);
