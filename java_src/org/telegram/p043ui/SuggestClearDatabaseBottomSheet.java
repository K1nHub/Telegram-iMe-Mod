...
public class SuggestClearDatabaseBottomSheet extends BottomSheet {
    ...
    private SuggestClearDatabaseBottomSheet(final BaseFragment baseFragment) {
        ...
        textView.setText(LocaleController.getString("SuggestClearDatabaseTitle", C3473R.string.SuggestClearDatabaseTitle));
        linearLayout.addView(textView, LayoutHelper.createFrame(-1, -2, 0, 21, 30, 21, 0));
        TextView textView2 = new TextView(parentActivity);
        textView2.setGravity(8388611);
        textView2.setTextSize(1, 15.0f);
        textView2.setTextColor(Theme.getColor(i));
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString("SuggestClearDatabaseMessage", C3473R.string.SuggestClearDatabaseMessage, AndroidUtilities.formatFileSize(baseFragment.getMessagesStorage().getDatabaseSize()))));
        ...
        textView3.setText(LocaleController.getString("ClearLocalDatabase", C3473R.string.ClearLocalDatabase));
    ...
    public /* synthetic */ void lambda$new$1(final BaseFragment baseFragment, View view) {
        ...
        builder.setMessage(LocaleController.getString("LocalDatabaseClearText", C3473R.string.LocalDatabaseClearText));
        builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("CacheClear", C3473R.string.CacheClear), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.SuggestClearDatabaseBottomSheet$$ExternalSyntheticLambda0
