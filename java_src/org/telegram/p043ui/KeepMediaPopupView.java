...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public void update(int i) {
        ...
        if (keepMediaExceptions.isEmpty()) {
            ...
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m107dp(8));
            ...
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m107dp((Math.max(0, min - 1) * 12) + 64));
    ...
    public class ExceptionsView extends FrameLayout {
        ...
        public ExceptionsView(Context context) {
            ...
            this.titleView.setRightPadding(AndroidUtilities.m107dp(68));
            ...
            this.avatarsImageView.setAvatarsTextSize(AndroidUtilities.m107dp(22));
    ...
    public void updateAvatarsPosition() {
        if (this.exceptions != null) {
            this.exceptionsView.avatarsImageView.setTranslationX(AndroidUtilities.m107dp(12) * (3 - Math.min(3, this.exceptions.size())));
        }
    }
