...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int i) {
        ...
        rLottieImageView.setAnimation(C3632R.raw.db_migration_placeholder, ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        ...
        this.title.setText(LocaleController.getString("OptimizingTelegram", C3632R.string.OptimizingTelegram));
        ...
        textView3.setLineSpacing(AndroidUtilities.m104dp(2), 1.0f);
        this.description1.setTextSize(1, 14.0f);
        this.description1.setText(LocaleController.getString("OptimizingTelegramDescription1", C3632R.string.OptimizingTelegramDescription1));
        ...
        this.description2.setText(LocaleController.getString("OptimizingTelegramDescription2", C3632R.string.OptimizingTelegramDescription2));
