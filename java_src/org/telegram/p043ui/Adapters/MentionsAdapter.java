...
public class MentionsAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void addStickerToResult(TLRPC$Document tLRPC$Document, Object obj) {
        ...
        String str = tLRPC$Document.dc_id + "_" + tLRPC$Document.f1610id;
    ...
    private boolean itemsEqual(Object obj, Object obj2) {
        ...
        if ((obj instanceof TLRPC$User) && (obj2 instanceof TLRPC$User) && ((TLRPC$User) obj).f1751id == ((TLRPC$User) obj2).f1751id) {
            return true;
        }
        if ((obj instanceof TLRPC$Chat) && (obj2 instanceof TLRPC$Chat) && ((TLRPC$Chat) obj).f1602id == ((TLRPC$Chat) obj2).f1602id) {
            return true;
        }
    ...
    public void processFoundUser(TLRPC$User tLRPC$User) {
        ...
        if (tLRPC$User != null && tLRPC$User.bot && tLRPC$User.bot_inline_placeholder != null) {
            ...
            if (this.foundContextBot.bot_inline_geo) {
                ...
                if (!notificationsSettings.getBoolean("inlinegeo_" + this.foundContextBot.f1751id, false) && (chatActivity = this.parentFragment) != null && chatActivity.getParentActivity() != null) {
    ...
    public /* synthetic */ void lambda$processFoundUser$2(boolean[] zArr, TLRPC$User tLRPC$User, DialogInterface dialogInterface, int i) {
        ...
        if (tLRPC$User != null) {
            ...
            edit.putBoolean("inlinegeo_" + tLRPC$User.f1751id, true).commit();
            checkLocationPermissionsOrStart();
        }
    }
    ...
    private void searchForContextBot(String str, String str2) {
        ...
        if (tLRPC$User == null || (str4 = tLRPC$User.username) == null || !str4.equals(str) || (str5 = this.searchingContextQuery) == null || !str5.equals(str2)) {
            ...
            RunnableC38444 runnableC38444 = new RunnableC38444(str2, str, messagesController, messagesStorage);
            this.contextQueryRunnable = runnableC38444;
            AndroidUtilities.runOnUIThread(runnableC38444, 400L);
        }
    }
    ...
    /* loaded from: classes5.dex */
    public class RunnableC38444 implements Runnable {
        ...
        RunnableC38444(String str, String str2, MessagesController messagesController, MessagesStorage messagesStorage) {
            this.val$query = str;
        ...
        public void run() {
            ...
            mentionsAdapter2.contextUsernameReqid = connectionsManager.sendRequest(tLRPC$TL_contacts_resolveUsername, new RequestDelegate() { // from class: org.telegram.ui.Adapters.MentionsAdapter$4$$ExternalSyntheticLambda1
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    MentionsAdapter.RunnableC38444.this.lambda$run$1(str, messagesController, messagesStorage, tLObject, tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$run$1(final String str, final MessagesController messagesController, final MessagesStorage messagesStorage, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.MentionsAdapter$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    MentionsAdapter.RunnableC38444.this.lambda$run$0(str, tLRPC$TL_error, tLObject, messagesController, messagesStorage);
                }
            });
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:345:0x05f7, code lost:
        if (r4.user_id == r12.f1751id) goto L303;
     */
    ...
    */
    public void lambda$searchUsernameOrHashtag$7(final java.lang.CharSequence r23, final int r24, final java.util.ArrayList<org.telegram.messenger.MessageObject> r25, final boolean r26, final boolean r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Adapters.MentionsAdapter.lambda$searchUsernameOrHashtag$7(java.lang.CharSequence, int, java.util.ArrayList, boolean, boolean):void");
    }
    ...
    /* loaded from: classes5.dex */
    public class RunnableC38477 implements Runnable {
        ...
        RunnableC38477(TLRPC$Chat tLRPC$Chat, String str, long j, ArrayList arrayList, LongSparseArray longSparseArray, MessagesController messagesController) {
        ...
        public void run() {
            ...
            tLRPC$TL_channelParticipantsMentions.f1601q = this.val$usernameString;
            ...
            mentionsAdapter.channelReqId = connectionsManager.sendRequest(tLRPC$TL_channels_getParticipants, new RequestDelegate() { // from class: org.telegram.ui.Adapters.MentionsAdapter$7$$ExternalSyntheticLambda1
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    MentionsAdapter.RunnableC38477.this.lambda$run$1(access$1704, arrayList, longSparseArray, messagesController, tLObject, tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$run$1(final int i, final ArrayList arrayList, final LongSparseArray longSparseArray, final MessagesController messagesController, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.MentionsAdapter$7$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    MentionsAdapter.RunnableC38477.this.lambda$run$0(i, arrayList, longSparseArray, tLRPC$TL_error, tLObject, messagesController);
                }
            });
        }
        ...
        if ((!this.allowBots || !this.allowChats) && arrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                if ((next instanceof TLRPC$Chat) && !this.allowChats) {
                    ...
                    if (tLRPC$User.bot || UserObject.isService(tLRPC$User.f1751id)) {
                        it.remove();
                    }
                }
            }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            textView.setPadding(AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8));
