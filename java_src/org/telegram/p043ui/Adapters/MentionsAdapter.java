...
public class MentionsAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    private boolean itemsEqual(Object obj, Object obj2) {
        ...
        if ((obj instanceof TLRPC$User) && (obj2 instanceof TLRPC$User) && ((TLRPC$User) obj).f1749id == ((TLRPC$User) obj2).f1749id) {
            return true;
        }
    ...
    public /* synthetic */ void lambda$processFoundUser$2(boolean[] zArr, TLRPC$User tLRPC$User, DialogInterface dialogInterface, int i) {
        ...
        if (tLRPC$User != null) {
            ...
            edit.putBoolean("inlinegeo_" + tLRPC$User.f1749id, true).commit();
            checkLocationPermissionsOrStart();
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:343:0x05f3, code lost:
        if (r9.user_id == r5.f1749id) goto L230;
     */
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:375:0x0675, code lost:
    ...
    /* JADX WARN: Removed duplicated region for block: B:374:0x0669  */
    ...
    */
        ...
        if ((!this.allowBots || !this.allowChats) && arrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                if ((next instanceof TLRPC$Chat) && !this.allowChats) {
                    ...
                    if (tLRPC$User.bot || UserObject.isService(tLRPC$User.f1749id)) {
                        it.remove();
                    }
                }
            }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            textView.setPadding(AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8));
