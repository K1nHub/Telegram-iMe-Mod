    ...
    public /* synthetic */ void lambda$processSearch$0(String str, int i, ArrayList arrayList, int i2) {
        ...
        if (this.allUnregistredContacts == null) {
            ...
            while (it.hasNext()) {
                ...
                contactEntry.f1788q1 = (next.first_name + " " + next.last_name).toLowerCase();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (itemViewType != 0) {
            if (itemViewType == 1) {
                ...
                textCell.setText(LocaleController.formatString("AddContactByPhone", C3632R.string.AddContactByPhone, C3544PhoneFormat.getInstance().format("+" + ((String) getItem(i)))), false);
                return;
                ...
                profileSearchCell.setData(contact, null, ContactsController.formatName(contact.first_name, contact.last_name), C3544PhoneFormat.getInstance().format("+" + contact.shortPhones.get(0)), false, false);
                return;
            }
        }
