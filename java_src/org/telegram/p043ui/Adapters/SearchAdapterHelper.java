        ...
        if (this.delegate.canApplySearchResults(i)) {
            ...
            if (tLRPC$TL_error == null) {
                ...
                for (int i4 = 0; i4 < tLRPC$TL_contacts_found.users.size(); i4++) {
                    ...
                    longSparseArray2.put(tLRPC$User3.f1751id, tLRPC$User3);
                }
                int i5 = 0;
                while (true) {
                    long j2 = 0;
                    ...
                    while (i6 < arrayList.size()) {
                        ...
                        if (this.topicMode) {
                            if (tLRPC$Chat2 != null) {
                                ...
                                i2 = i6;
                                tLRPC$Dialog2 = MessagesController.getInstance(this.currentAccount).dialogs_dict.get(tLRPC$User2.f1751id);
                            }
                        ...
                        } else if (tLRPC$User2 != null && !hiddenChatsController.isChatHidden(tLRPC$User2.f1751id) && !z2 && ((z3 || !tLRPC$User2.bot) && ((z4 || !tLRPC$User2.self) && ((this.allowGlobalResults || i5 != 1 || tLRPC$User2.contact) && filter(tLRPC$User2))))) {
                            if (this.filter == null) {
                                this.globalSearch.add(tLRPC$User2);
                            }
                            this.globalSearchMap.put(tLRPC$User2.f1751id, tLRPC$User2);
                        }
                        i6 = i2 + 1;
                        j2 = 0;
                    }
                ...
                if (!this.allResultsAreGlobal) {
                    for (int i7 = 0; i7 < tLRPC$TL_contacts_found.my_results.size(); i7++) {
                        ...
                        if (this.topicMode) {
                            if (tLRPC$Chat != null) {
                                ...
                                if (!UserObject.isUserSelf(tLRPC$User) && !UserObject.isReplyUser(tLRPC$User) && !MessagesController.isSupportUser(tLRPC$User)) {
                                    tLRPC$Dialog = MessagesController.getInstance(this.currentAccount).dialogs_dict.get(tLRPC$User.f1751id);
                                }
                            } else {
                                tLRPC$Dialog = null;
                            }
                        ...
                        } else if (tLRPC$User != null && !hiddenChatsController.isChatHidden(tLRPC$User.f1751id) && !z2 && ((z3 || !tLRPC$User.bot) && ((z4 || !tLRPC$User.self) && tLRPC$User.f1751id != j && filter(tLRPC$User)))) {
                            if (this.filter == null) {
                                this.localServerSearch.add(tLRPC$User);
                            }
                            this.globalSearchMap.put(tLRPC$User.f1751id, tLRPC$User);
                        }
                    }
                }
    ...
    private void removeGroupSearchFromGlobal() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (tLRPC$User != null) {
                ...
                this.globalSearchMap.remove(tLRPC$User.f1751id);
            }
        }
    }
        ...
        if (this.globalSearchMap.size() != 0) {
            ...
            while (i < size2) {
                ...
                if (obj instanceof TLRPC$User) {
                    ...
                    TLRPC$User tLRPC$User2 = (TLRPC$User) this.globalSearchMap.get(tLRPC$User.f1751id);
                    if (tLRPC$User2 != null) {
                        this.globalSearch.remove(tLRPC$User2);
                        this.localServerSearch.remove(tLRPC$User2);
                        this.globalSearchMap.remove(tLRPC$User2.f1751id);
                    }
                    TLObject tLObject = this.groupSearchMap.get(tLRPC$User.f1751id);
                    if (tLObject != null) {
                        this.groupSearch.remove(tLObject);
                        this.groupSearchMap.remove(tLRPC$User.f1751id);
                    }
                    TLObject tLObject2 = this.phoneSearchMap.get(tLRPC$User.f1751id);
                    if (tLObject2 != null) {
                        this.phonesSearch.remove(tLObject2);
                        this.phoneSearchMap.remove(tLRPC$User.f1751id);
                    }
