...
public class FiltersView extends RecyclerListView {
    ...
    public FiltersView(Context context, Theme.ResourcesProvider resourcesProvider) {
                    ...
                    if (i3 == 4) {
                        ...
                        if (tLObject instanceof TLRPC$User) {
                            ...
                            if (tLObject2 instanceof TLRPC$User) {
                                return ((TLRPC$User) tLObject).f1751id == ((TLRPC$User) tLObject2).f1751id;
                            }
                        }
        ...
        addItemDecoration(new RecyclerView.ItemDecoration(this) { // from class: org.telegram.ui.Adapters.FiltersView.2
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                rect.left = AndroidUtilities.m107dp(8);
                if (childAdapterPosition == state.getItemCount() - 1) {
                    rect.right = AndroidUtilities.m107dp(10);
                }
                if (childAdapterPosition == 0) {
                    rect.left = AndroidUtilities.m107dp(10);
                }
            }
        });
            ...
            public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                animate.alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C38373.this).mAddAnimations.remove(viewHolder);
            ...
            public void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                animate.setDuration(getRemoveDuration()).alpha(BitmapDescriptorFactory.HUE_RED).scaleX(BitmapDescriptorFactory.HUE_RED).scaleY(BitmapDescriptorFactory.HUE_RED).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.2
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C38373.this).mRemoveAnimations.remove(viewHolder);
                        dispatchFinishedWhenDone();
                    }
                }).start();
            }
        ...
        setSelectorRadius(AndroidUtilities.m107dp(28));
    ...
    private class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            RecyclerView.LayoutParams layoutParams = new RecyclerView.LayoutParams(-2, AndroidUtilities.m107dp(32));
            ((ViewGroup.MarginLayoutParams) layoutParams).topMargin = AndroidUtilities.m107dp(6);
    ...
    public static class FilterView extends FrameLayout {
        ...
        public void updateColors() {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(28), getThemedColor(Theme.key_groupcreate_spanBackground)));
        ...
        public void setData(MediaFilterData mediaFilterData) {
            ...
            if (mediaFilterData.filterType == 7) {
                CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m107dp(32), C3632R.C3634drawable.chats_archive);
                this.thumbDrawable = createCircleDrawableWithIcon;
                createCircleDrawableWithIcon.setIconSize(AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16));
            ...
            CombinedDrawable createCircleDrawableWithIcon2 = Theme.createCircleDrawableWithIcon(AndroidUtilities.m107dp(32), mediaFilterData.iconResFilled);
