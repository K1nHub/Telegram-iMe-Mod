...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter implements DialogCell.DialogCellDelegate {
    ...
    public int fixScrollGap(RecyclerListView recyclerListView, int i, int i2, boolean z, boolean z2, boolean z3, boolean z4) {
        getItemCount();
        int m107dp = AndroidUtilities.m107dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : SharedConfig.useThreeLinesLayout ? 78 : 72);
        recyclerListView.getPaddingTop();
        int paddingTop = ((recyclerListView.getPaddingTop() + i2) - (i * m107dp)) - i;
        if (z2) {
            AndroidUtilities.m107dp(81);
        } else if (z3) {
            AndroidUtilities.m107dp(44);
        }
        if (z) {
            paddingTop += m107dp;
        }
    ...
    */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 13:
                ...
                if (i == 13) {
                    flickerLoadingView.setItemsCount((int) ((AndroidUtilities.displaySize.y * 0.5f) / AndroidUtilities.m107dp(64)));
                    break;
                }
                break;
            case 2:
                flickerLoadingView = new HeaderCell(this.mContext);
                flickerLoadingView.setText(LocaleController.getString("RecentlyViewed", C3632R.string.RecentlyViewed));
                TextView textView = new TextView(this.mContext);
                textView.setTextSize(1, 15.0f);
                textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
                textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueHeader));
                textView.setText(LocaleController.getString("RecentlyViewedHide", C3632R.string.RecentlyViewedHide));
            ...
            case 3:
                flickerLoadingView = new FrameLayout(this, this.mContext) { // from class: org.telegram.ui.Adapters.DialogsAdapter.2
                    ...
                    protected void onMeasure(int i4, int i5) {
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i4), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(12), 1073741824));
                    }
                };
                flickerLoadingView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
                View view3 = new View(this.mContext);
                view3.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C3632R.C3634drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            ...
            case 7:
                flickerLoadingView = new HeaderCell(this.mContext);
                flickerLoadingView.setPadding(0, 0, 0, AndroidUtilities.m107dp(12));
                break;
            case 8:
            ...
            case 11:
                flickerLoadingView = new TextInfoPrivacyCell(this.mContext) { // from class: org.telegram.ui.Adapters.DialogsAdapter.4
                    ...
                    protected void onTextDraw() {
                        if (DialogsAdapter.this.arrowDrawable != null) {
                            Rect bounds = DialogsAdapter.this.arrowDrawable.getBounds();
                            int m107dp = (int) (this.moveProgress * AndroidUtilities.m107dp(3));
                            this.originalX = bounds.left;
                            this.originalY = bounds.top;
                            DialogsAdapter.this.arrowDrawable.setBounds(this.originalX + m107dp, this.originalY + AndroidUtilities.m107dp(1), this.originalX + m107dp + bounds.width(), this.originalY + AndroidUtilities.m107dp(1) + bounds.height());
                ...
                CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(this.mContext, C3632R.C3634drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            ...
            case 18:
                flickerLoadingView = new View(this, this.mContext) { // from class: org.telegram.ui.Adapters.DialogsAdapter.5
                    ...
                    protected void onMeasure(int i4, int i5) {
                        super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(81), 1073741824));
                    }
                };
                break;
            case 19:
    ...
    public int dialogsEmptyType() {
        if (DialogsActivity.isAlbumsDialogsType(this.dialogsType)) {
            return (isArchive() ? EmptyCellType.ARCHIVE_ALBUMS : EmptyCellType.ALBUMS).m1012id();
        }
        int i = this.dialogsType;
        if (i == DialogsActivity.DIALOGS_TYPE_DRAFTS) {
            return EmptyCellType.DRAFTS.m1012id();
        }
        if (this.folderId == 2) {
            return EmptyCellType.HIDDEN_CHATS.m1012id();
        }
        if (i == 7 || i == 8 || (i == 0 && ForkTopicsController.getInstance(this.currentAccount).hasSelectedTopic(isArchive()))) {
            ...
            return EmptyCellType.ARCHIVE.m1012id();
        } else {
            return 2;
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (itemViewType == 0) {
            ...
            if (i2 == 2 || i2 == 15 || DialogsActivity.isAlbumsDialogsType(this.initialDialogsType)) {
                ...
                if (tLRPC$Chat != null) {
                    ...
                    if (DialogsActivity.isAlbumsDialogsType(this.initialDialogsType)) {
                        lowerCase = LocaleController.getInternalString(C3632R.string.cloud_album).toLowerCase();
                    ...
                    if (user != null) {
                        ...
                        if (UserObject.isReplyUser(user)) {
                            ...
                            if (user.bot) {
                                formatUserStatus = LocaleController.getString("Bot", C3632R.string.Bot);
                            } else {
            ...
            if (i7 != 11 && i7 != 12 && i7 != 13) {
                headerCell.setText(LocaleController.getString((this.dialogsCount == 0 && this.forceUpdatingContacts) ? C3632R.string.ConnectingYourContacts : C3632R.string.YourContacts));
            } else if (i == 0) {
                headerCell.setText(LocaleController.getString("ImportHeader", C3632R.string.ImportHeader));
            } else {
                headerCell.setText(LocaleController.getString("ImportHeaderContacts", C3632R.string.ImportHeaderContacts));
            }
        } else if (itemViewType == 11) {
            TextInfoPrivacyCell textInfoPrivacyCell = (TextInfoPrivacyCell) viewHolder.itemView;
            textInfoPrivacyCell.setText(LocaleController.getString("TapOnThePencil", C3632R.string.TapOnThePencil));
            if (this.arrowDrawable == null) {
                Drawable drawable = this.mContext.getResources().getDrawable(C3632R.C3634drawable.arrow_newchat);
            ...
            switch (itemViewType) {
                case 14:
                    ...
                    if (i8 == 0) {
                        headerCell2.setText(LocaleController.getString("MyChannels", C3632R.string.MyChannels));
                        break;
                    } else if (i8 == 1) {
                        headerCell2.setText(LocaleController.getString("MyGroups", C3632R.string.MyGroups));
                        break;
                    } else if (i8 == 2) {
                        headerCell2.setText(LocaleController.getString("FilterGroups", C3632R.string.FilterGroups));
                        break;
                    }
                    break;
                case 15:
            ...
            if (tLRPC$RequestPeerType != null) {
                if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeBroadcast) {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString("CreateChannelForThis", C3632R.string.CreateChannelForThis), C3632R.C3634drawable.msg_channel_create, true);
                } else {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString("CreateGroupForThis", C3632R.string.CreateGroupForThis), C3632R.C3634drawable.msg_groups_create, true);
                }
            } else {
                textCell.setTextAndIcon(LocaleController.getString("CreateGroupForImport", C3632R.string.CreateGroupForImport), C3632R.C3634drawable.msg_groups_create, this.dialogsCount != 0);
            }
    ...
    public static class DialogsPreloader {
        ...
        public void start() {
            ...
            MessagesController.getInstance(UserConfig.selectedAccount).ensureMessagesLoaded(longValue, 0, new C38281(longValue));
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: org.telegram.ui.Adapters.DialogsAdapter$DialogsPreloader$1 */
        /* loaded from: classes5.dex */
        public class C38281 implements MessagesController.MessagesLoadedCallback {
            ...
            public void onMessagesLoaded(final boolean z) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.DialogsAdapter$DialogsPreloader$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsAdapter.DialogsPreloader.C38281.this.lambda$onMessagesLoaded$0(z, j);
                    }
                });
            }
            ...
            public void onError() {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.DialogsAdapter$DialogsPreloader$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsAdapter.DialogsPreloader.C38281.this.lambda$onError$1(j);
                    }
                });
            }
    ...
    */
    ...
    public int getItemHeight(int i) {
        ...
        if (this.itemInternals.get(i).viewType == 0) {
            ...
            return AndroidUtilities.m107dp(SharedConfig.useThreeLinesLayout ? 86 : 91);
        }
        return 0;
    }
}
