...
public class ContactsAdapter extends RecyclerListView.SectionsAdapter {
    ...
    private String getHint() {
        return LocaleController.formatStringInternal(C3473R.string.wallet_recipient_address_hint, this.networkShortName);
    }
    ...
    private void bindFilterModel(TextCellWithRightImage textCellWithRightImage, ContactsFilter contactsFilter) {
        boolean z = false;
        textCellWithRightImage.setTextAndIcon(contactsFilter.getTitle(), contactsFilter.getIcon(), false);
        ...
        textCellWithRightImage.setRightIcon(contactsFilter == ContactsFilter.BLOCKED ? C3473R.C3475drawable.msg_actions : C3473R.C3475drawable.msg_delete, Theme.getColor(Theme.key_windowBackgroundWhiteGrayIcon));
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C36554 {
    ...
    private CollectionsFilteredContacts getCollectionsModel() {
        ...
        if (this.needPhonebook) {
            int i = C36554.$SwitchMap$com$iMe$model$contacts$ContactsFilter[this.filterRowModel.ordinal()];
            if (i == 1) {
    ...
    */
        ...
        if (i == IdFabric$ViewTypes.TEXT_CELL_WITH_RIGHT_IMAGE) {
            ...
            FrameLayout frameLayout = new FrameLayout(this.mContext) { // from class: org.telegram.ui.Adapters.ContactsAdapter.2
                ...
                protected void onMeasure(int i2, int i3) {
                    ...
                    if (size == 0) {
                        size = (AndroidUtilities.displaySize.y - C3541ActionBar.getCurrentActionBarHeight()) - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
                    }
    ...
    public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.getItemViewType() == IdFabric$ViewTypes.TEXT_CELL_WITH_RIGHT_IMAGE) {
            ...
            editTextSettingsCell.getTextView().setCompoundDrawablesWithIntrinsicBounds(0, 0, C3473R.C3475drawable.msg_qrcode, 0);
            ...
            if (z && i == 1) {
                ...
                if (itemViewType != 0) {
                    ...
                    if (i4 == 0) {
                        graySectionCell.setText(LocaleController.getString("Contacts", C3473R.string.Contacts));
                        return;
                    } else if (i4 == 1) {
                        graySectionCell.setText(LocaleController.getString("SortedByName", C3473R.string.SortedByName));
                        return;
                    } else {
                        graySectionCell.setText(LocaleController.getString("SortedByLastSeen", C3473R.string.SortedByLastSeen));
                        return;
                    }
                }
                ...
                if (storiesController.hasUnreadStories(user.f1685id)) {
                    int unreadStoriesCount = storiesController.getUnreadStoriesCount(user.f1685id);
        ...
        if (itemViewType2 == 0) {
            ...
            if (longSparseArray != null) {
                userCell2.setChecked(longSparseArray.indexOfKey(user2.f1685id) >= 0, !this.scrolling);
            }
            LongSparseArray<TLRPC$User> longSparseArray2 = this.ignoreUsers;
            if (longSparseArray2 != null) {
                if (longSparseArray2.indexOfKey(user2.f1685id) >= 0) {
            ...
            if (this.isChooseWalletTransferRecipient) {
                graySectionCell2.setText(LocaleController.getInternalString(C3473R.string.wallet_recipient_or_choose_title));
            } else if (this.hasStories) {
                graySectionCell2.setText(LocaleController.getString("HiddenStories", C3473R.string.HiddenStories));
            } else {
                int i5 = this.sortType;
                if (i5 == 0) {
                    graySectionCell2.setText(LocaleController.getString("Contacts", C3473R.string.Contacts));
                } else if (i5 == 1) {
                    graySectionCell2.setText(LocaleController.getString("SortedByName", C3473R.string.SortedByName));
                } else {
                    graySectionCell2.setText(LocaleController.getString("SortedByLastSeen", C3473R.string.SortedByLastSeen));
                }
            }
        } else {
            ...
            if (i == 0) {
                if (this.needPhonebook) {
                    if (i2 == 0) {
                        textCell.setTextAndIcon(LocaleController.getString("InviteFriends", C3473R.string.InviteFriends), C3473R.C3475drawable.msg_invite, false);
                        textCell.showDivider(!this.hasGps);
                    } else if (i2 == 1) {
                        textCell.setTextAndIcon(LocaleController.getString("AddPeopleNearby", C3473R.string.AddPeopleNearby), C3473R.C3475drawable.msg_location, false);
                        textCell.showDivider(this.hasGps);
                    }
                    ...
                    textCell.setTextAndIcon(LocaleController.getString("NewGroup", C3473R.string.NewGroup), C3473R.C3475drawable.msg_groups, false);
                } else if (i2 == 1) {
                    textCell.setTextAndIcon(LocaleController.getString("NewSecretChat", C3473R.string.NewSecretChat), C3473R.C3475drawable.msg_secret, false);
                } else if (i2 == 2) {
                    textCell.setTextAndIcon(LocaleController.getString("NewChannel", C3473R.string.NewChannel), C3473R.C3475drawable.msg_channel, false);
                }
