...
public class StickersSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private Runnable searchRunnable = new RunnableC38551();
    ...
    /* loaded from: classes5.dex */
    public class RunnableC38551 implements Runnable {
        RunnableC38551() {
        }
        ...
        */
        public void run() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Adapters.StickersSearchAdapter.RunnableC38551.run():void");
        }
            ...
            if (tLObject instanceof TLRPC$TL_messages_foundStickerSets) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.StickersSearchAdapter$1$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        StickersSearchAdapter.RunnableC38551.this.lambda$run$1(tLRPC$TL_messages_searchStickerSets, tLObject);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void lambda$run$4(final TLRPC$TL_messages_getStickers tLRPC$TL_messages_getStickers, final ArrayList arrayList, final LongSparseArray longSparseArray, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.StickersSearchAdapter$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    StickersSearchAdapter.RunnableC38551.this.lambda$run$3(tLRPC$TL_messages_getStickers, tLObject, arrayList, longSparseArray);
                }
            });
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            if (i == 1) {
                ...
                this.emptyImageView.setImageResource(C3634R.C3636drawable.stickers_empty);
                ...
                linearLayout2.setMinimumHeight(AndroidUtilities.m104dp(112));
