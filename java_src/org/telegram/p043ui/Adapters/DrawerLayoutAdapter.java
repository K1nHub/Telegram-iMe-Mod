...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 201) {
            ...
            drawerProfileCell = new EmptyCell(this.mContext, AndroidUtilities.m107dp(8));
        }
    ...
    public int getId(int i) {
        ...
        if (i2 >= this.prefixItems.size()) {
            ...
            if (this.isCreateGroupExpanded) {
                if (i3 < this.createGroupItems.size()) {
                    return this.createGroupItems.get(i3).f1787id;
                }
                i3 -= this.createGroupItems.size();
            }
            i2 = i3 + 1 + this.prefixItems.size();
    ...
    public static class Item {
        ...
        public Item(TLRPC$TL_attachMenuBot tLRPC$TL_attachMenuBot) {
            ...
            this.f1787id = (int) ((tLRPC$TL_attachMenuBot.bot_id >> 16) + 100);
        }
        ...
        public void bind(DrawerActionCell drawerActionCell) {
            ...
            if (tLRPC$TL_attachMenuBot != null) {
                ...
                drawerActionCell.setTextAndIcon(this.f1787id, this.text, this.icon, this.rectIcon != null);
            }
        }
    }
}
