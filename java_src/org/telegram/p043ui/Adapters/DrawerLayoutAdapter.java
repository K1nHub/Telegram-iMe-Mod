...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private void resetItems() {
        ...
        if (UserConfig.getInstance(UserConfig.selectedAccount).isClientActivated()) {
            ...
            if (eventType == 0) {
                i = C3473R.C3475drawable.msg_groups_ny;
                i2 = C3473R.C3475drawable.msg_contacts_ny;
                i3 = C3473R.C3475drawable.msg_calls_ny;
                i12 = C3473R.C3475drawable.msg_saved_ny;
                i4 = C3473R.C3475drawable.msg_settings_ny;
                i5 = C3473R.C3475drawable.msg_nearby_ny;
                i6 = C3473R.C3475drawable.fork_drawer_wallet_ny;
                i7 = C3473R.C3475drawable.fork_drawer_catalog_ny;
                i8 = C3473R.C3475drawable.fork_drawer_music_ny;
                i9 = C3473R.C3475drawable.fork_drawer_create_expandable_ny;
                i10 = C3473R.C3475drawable.msg_secret_ny;
                i11 = C3473R.C3475drawable.fork_drawer_channel_ny;
                i13 = C3473R.C3475drawable.fork_drawer_albums_ny;
            } else {
                if (eventType == 1) {
                    i = C3473R.C3475drawable.msg_groups_14;
                    i2 = C3473R.C3475drawable.msg_contacts_14;
                    i3 = C3473R.C3475drawable.msg_calls_14;
                    i12 = C3473R.C3475drawable.msg_saved_14;
                    i4 = C3473R.C3475drawable.msg_settings_14;
                    i5 = C3473R.C3475drawable.msg_secret_14;
                    i6 = C3473R.C3475drawable.fork_drawer_wallet_14;
                    i7 = C3473R.C3475drawable.fork_drawer_catalog_14;
                    i8 = C3473R.C3475drawable.fork_drawer_music_14;
                    i9 = C3473R.C3475drawable.fork_drawer_create_expandable_14;
                    i11 = C3473R.C3475drawable.fork_drawer_channel_14;
                    i13 = C3473R.C3475drawable.fork_drawer_albums_14;
                } else if (eventType == 2) {
                    i = C3473R.C3475drawable.msg_groups_hw;
                    i2 = C3473R.C3475drawable.msg_contacts_hw;
                    i3 = C3473R.C3475drawable.msg_calls_hw;
                    i12 = C3473R.C3475drawable.msg_saved_hw;
                    i4 = C3473R.C3475drawable.msg_settings_hw;
                    i5 = C3473R.C3475drawable.msg_secret_hw;
                    i6 = C3473R.C3475drawable.fork_drawer_wallet_hw;
                    i7 = C3473R.C3475drawable.fork_drawer_catalog_hw;
                    i8 = C3473R.C3475drawable.fork_drawer_music_hw;
                    i9 = C3473R.C3475drawable.fork_drawer_create_expandable_hw;
                    i11 = C3473R.C3475drawable.fork_drawer_channel_hw;
                    i13 = C3473R.C3475drawable.fork_drawer_albums_hw;
                } else {
                    i = C3473R.C3475drawable.msg_groups;
                    i2 = C3473R.C3475drawable.msg_contacts;
                    i3 = C3473R.C3475drawable.msg_calls;
                    i4 = C3473R.C3475drawable.msg_settings_old;
                    i5 = C3473R.C3475drawable.msg_nearby;
                    i6 = C3473R.C3475drawable.fork_drawer_wallet;
                    i7 = C3473R.C3475drawable.fork_drawer_catalog;
                    i8 = C3473R.C3475drawable.files_music;
                    i9 = C3473R.C3475drawable.fork_drawer_create_expandable;
                    i10 = C3473R.C3475drawable.msg_secret;
                    i11 = C3473R.C3475drawable.msg_channel;
                    i12 = C3473R.C3475drawable.fork_drawer_cloud;
                    i13 = C3473R.C3475drawable.fork_drawer_albums;
                }
                i10 = i5;
            }
            ...
            if (userConfig == null || !userConfig.isPremium() || (!ForkCommonController.getInstance(UserConfig.selectedAccount).isShowPremiumBadgeEnabled() && !ForkCommonController.getInstance(UserConfig.selectedAccount).isShowPremiumStatusEnabled())) {
                ...
                i14 = i12;
                i16 = i5;
                this.items.add(new Item(15, LocaleController.getString("ChangeEmojiStatus", C3473R.string.ChangeEmojiStatus), C3473R.C3475drawable.msg_status_edit));
            } else {
                i14 = i12;
                i15 = i4;
                i16 = i5;
                i17 = i13;
                this.items.add(new Item(15, LocaleController.getString("SetEmojiStatus", C3473R.string.SetEmojiStatus), C3473R.C3475drawable.msg_status_set));
            }
            if (!"disabled".equals(MessagesController.getInstance(UserConfig.selectedAccount).storiesPosting)) {
                this.items.add(new Item(16, LocaleController.getString("ProfileMyStories", C3473R.string.ProfileMyStories), C3473R.C3475drawable.msg_menu_stories));
                this.items.add(null);
            ...
            DrawerSwitchableItem drawerSwitchableItem3 = DrawerSwitchableItem.MUSIC;
            if (set3.contains(drawerSwitchableItem3)) {
                this.rectIconItems.add(new Item(IdFabric$ViewTypes.DRAWER_MUSIC, i8, drawerSwitchableItem3));
            }
            if (!this.rectIconItems.isEmpty()) {
                this.rectIconItems.add(null);
            }
            this.createGroupItems.add(new Item(2, LocaleController.getString("NewGroup", C3473R.string.NewGroup), i));
            this.createGroupItems.add(new Item(3, LocaleController.getString("NewSecretChat", C3473R.string.NewSecretChat), i10));
            this.createGroupItems.add(new Item(4, LocaleController.getString("NewChannel", C3473R.string.NewChannel), i11));
            this.items.add(new Item(IdFabric$ViewTypes.DRAWER_GROUP_CREATE, LocaleController.getInternalString(C3473R.string.drawer_create_expandable_section), i9));
            this.items.add(null);
            if (SharedConfig.selectedDrawerItems.contains(DrawerSwitchableItem.CONTACTS)) {
                this.items.add(new Item(6, LocaleController.getString("Contacts", C3473R.string.Contacts), i2));
            }
            if (SharedConfig.selectedDrawerItems.contains(DrawerSwitchableItem.CALLS)) {
                this.items.add(new Item(10, LocaleController.getString("Calls", C3473R.string.Calls), i3));
            }
            if (SharedConfig.selectedDrawerItems.contains(DrawerSwitchableItem.PEOPLE_NEARBY) && this.hasGps) {
                this.items.add(new Item(12, LocaleController.getString("PeopleNearby", C3473R.string.PeopleNearby), i16));
            }
            if (SharedConfig.selectedDrawerItems.contains(DrawerSwitchableItem.CLOUD)) {
                this.items.add(new Item(11, LocaleController.getString("SavedMessages", C3473R.string.SavedMessages), i14));
            }
            if (SharedConfig.selectedDrawerItems.contains(DrawerSwitchableItem.ALBUMS)) {
                this.items.add(new Item(IdFabric$ViewTypes.DRAWER_ALBUMS, LocaleController.getInternalString(C3473R.string.cloud_albums_toolbar_title), i17));
            }
            this.items.add(new Item(8, LocaleController.getString("Settings", C3473R.string.Settings), i15));
        }
    }
    ...
    public int getId(int i) {
        ...
        if (i2 >= this.prefixItems.size()) {
            ...
            if (this.isCreateGroupExpanded) {
                if (i3 < this.createGroupItems.size()) {
                    return this.createGroupItems.get(i3).f1702id;
                }
                i3 -= this.createGroupItems.size();
            }
            i2 = i3 + 1 + this.prefixItems.size();
    ...
    public static class Item {
        ...
        public void bind(DrawerActionCell drawerActionCell) {
            drawerActionCell.setTextAndIcon(this.f1702id, this.text, this.icon, this.rectIcon != null);
        }
    }
}
