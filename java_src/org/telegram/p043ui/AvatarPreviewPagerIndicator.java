...
public class AvatarPreviewPagerIndicator extends View implements ProfileGalleryView.Callback {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.path.addRoundRect(this.rectF, new float[]{AndroidUtilities.m72dp(13), AndroidUtilities.m72dp(13), AndroidUtilities.m72dp(13), AndroidUtilities.m72dp(13), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED}, Path.Direction.CCW);
    }

    @Override // android.view.View
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        int currentActionBarHeight = C3626ActionBar.getCurrentActionBarHeight() + 0;
        this.topOverlayRect.set(0, 0, i, (int) (currentActionBarHeight * 0.5f));
        this.bottomOverlayRect.set(0, (int) (i2 - (AndroidUtilities.m73dp(72.0f) * 0.5f)), i, i2);
        this.topOverlayGradient.setBounds(0, this.topOverlayRect.bottom, i, currentActionBarHeight + AndroidUtilities.m73dp(16.0f));
        this.bottomOverlayGradient.setBounds(0, (i2 - AndroidUtilities.m73dp(72.0f)) - AndroidUtilities.m73dp(24.0f), i, this.bottomOverlayRect.top);
        int i5 = i / 5;
