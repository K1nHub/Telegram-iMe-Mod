...
public class AvatarPreviewPagerIndicator extends View implements ProfileGalleryView.Callback {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.path.addRoundRect(this.rectF, new float[]{AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(13), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED}, Path.Direction.CCW);
    }
