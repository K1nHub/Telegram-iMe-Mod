...
public class AvatarPreviewPagerIndicator extends View implements ProfileGalleryView.Callback {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.path.addRoundRect(this.rectF, new float[]{AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(13), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED}, Path.Direction.CCW);
    }

    @Override // android.view.View
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        int currentActionBarHeight = C3706ActionBar.getCurrentActionBarHeight() + 0;
        this.topOverlayRect.set(0, 0, i, (int) (currentActionBarHeight * 0.5f));
        this.bottomOverlayRect.set(0, (int) (i2 - (AndroidUtilities.m105dp(72.0f) * 0.5f)), i, i2);
        this.topOverlayGradient.setBounds(0, this.topOverlayRect.bottom, i, currentActionBarHeight + AndroidUtilities.m105dp(16.0f));
        this.bottomOverlayGradient.setBounds(0, (i2 - AndroidUtilities.m105dp(72.0f)) - AndroidUtilities.m105dp(24.0f), i, this.bottomOverlayRect.top);
        int i5 = i / 5;
    ...
    */
    public void onDraw(android.graphics.Canvas r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.AvatarPreviewPagerIndicator.onDraw(android.graphics.Canvas):void");
    }
