...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class StoryCircle {
        ...
        public StoryCircle(TLRPC$StoryItem tLRPC$StoryItem) {
            ...
            this.storyId = tLRPC$StoryItem.f1553id;
            this.imageReceiver.setRoundRadius(AndroidUtilities.m72dp(200));
    ...
    public ProfileStoriesView(Context context, int i, long j, View view, ProfileActivity.AvatarImageView avatarImageView, Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m72dp(18));
    ...
    public void updateStories(boolean z, boolean z2) {
        ...
        boolean z4 = this.userId == UserConfig.getInstance(this.currentAccount).getClientUserId();
        TLRPC$UserFull tLRPC$UserFull = this.userFull;
        TLRPC$TL_userStories tLRPC$TL_userStories = (tLRPC$UserFull == null || z4) ? null : tLRPC$UserFull.stories;
        ...
        if (arrayList != null) {
            ...
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                ...
                if (!(tLRPC$StoryItem2 instanceof TLRPC$TL_storyItemDeleted)) {
                    if (tLRPC$StoryItem2.f1553id > max) {
                        this.unreadCount++;
                    }
                    i++;
                }
            ...
            for (int i4 = 0; i4 < arrayList.size(); i4++) {
                ...
                if (!(tLRPC$StoryItem3 instanceof TLRPC$TL_storyItemDeleted)) {
                    if (tLRPC$StoryItem3 instanceof TLRPC$TL_storyItemSkipped) {
                        int i5 = tLRPC$StoryItem3.f1553id;
                        if (stories != null) {
                            int i6 = 0;
                            while (true) {
                                if (i6 >= stories.stories.size()) {
                                    break;
                                } else if (stories.stories.get(i6).f1553id == i5) {
                        ...
                        boolean z5 = tLRPC$StoryItem3 instanceof TLRPC$TL_storyItemSkipped;
                        if (z5) {
                            if (tLRPC$TL_userStories != null) {
                                ...
                                while (true) {
                                    if (i7 >= tLRPC$TL_userStories.stories.size()) {
                                        break;
                                    } else if (tLRPC$TL_userStories.stories.get(i7).f1553id == i5) {
                    ...
                    if (z4 || tLRPC$StoryItem3.f1553id > max) {
        ...
        if (arrayList2.size() < 3) {
            for (int i8 = 0; i8 < arrayList.size(); i8++) {
                ...
                if (tLRPC$StoryItem4 instanceof TLRPC$TL_storyItemSkipped) {
                    int i9 = tLRPC$StoryItem4.f1553id;
                    if (stories != null) {
                        int i10 = 0;
                        while (true) {
                            if (i10 >= stories.stories.size()) {
                                break;
                            } else if (stories.stories.get(i10).f1553id == i9) {
                    ...
                    boolean z6 = tLRPC$StoryItem4 instanceof TLRPC$TL_storyItemSkipped;
                    if (z6) {
                        if (tLRPC$TL_userStories != null) {
                            int i11 = 0;
                            while (true) {
                                if (i11 >= tLRPC$TL_userStories.stories.size()) {
                                    break;
                                } else if (tLRPC$TL_userStories.stories.get(i11).f1553id == i9) {
        ...
        for (int i12 = 0; i12 < this.circles.size(); i12++) {
            ...
            while (true) {
                ...
                if (tLRPC$StoryItem.f1553id == storyCircle.storyId) {
                    break;
                }
                i13++;
            }
            if (i13 == -1) {
                ...
                storyCircle.read = z4 || !(tLRPC$TL_userStories2 == null || tLRPC$StoryItem == null || tLRPC$StoryItem.f1553id > tLRPC$TL_userStories2.max_read_id);
            }
            if (!z) {
                storyCircle.apply();
            }
        ...
        for (int i14 = 0; i14 < arrayList2.size(); i14++) {
            ...
            while (true) {
                if (i15 >= this.circles.size()) {
                    i15 = -1;
                    break;
                } else if (this.circles.get(i15).storyId == tLRPC$StoryItem5.f1553id) {
                    break;
                } else {
                    i15++;
                }
            ...
            if (i15 == -1) {
                ...
                storyCircle2.read = z4 || (tLRPC$TL_userStories2 != null && tLRPC$StoryItem5.f1553id <= tLRPC$TL_userStories2.max_read_id);
                if (!z) {
                    storyCircle2.apply();
                }
    ...
    public void vibrateNewStory() {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.ProfileStoriesView$$ExternalSyntheticLambda1
    ...
    public void animateNewStory() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.ProfileStoriesView$$ExternalSyntheticLambda0
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (f6 <= BitmapDescriptorFactory.HUE_RED && storyCircle.scale <= BitmapDescriptorFactory.HUE_RED) {
                storyCircle.destroy();
        ...
        if (z) {
            Collections.sort(this.circles, new Comparator() { // from class: org.telegram.ui.Stories.ProfileStoriesView$$ExternalSyntheticLambda2
        ...
        float clamp = Utilities.clamp(1.0f - (this.expandProgress / 0.2f), 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
        ...
        this.storiesGradientTools.setBounds(this.left, lerp - AndroidUtilities.m72dp(24), this.right, AndroidUtilities.m72dp(24) + lerp);
        if (this.expandProgress <= BitmapDescriptorFactory.HUE_RED || clamp >= 1.0f) {
            f = f7;
            f2 = 1.0f;
            f3 = 0.0f;
            i = 1526726655;
        } else {
            this.f1881w = BitmapDescriptorFactory.HUE_RED;
            for (int i3 = 0; i3 < this.circles.size(); i3++) {
                this.f1881w += AndroidUtilities.m72dp(14) * this.circles.get(i3).cachedScale;
            }
            float f9 = 0.0f;
            for (int i4 = 0; i4 < this.circles.size(); i4++) {
                ...
                float m72dp = (AndroidUtilities.m72dp(28) / 2.0f) * f10;
                float f12 = (this.expandRight - this.f1881w) + m72dp + f9;
                f9 += AndroidUtilities.m72dp(18) * f10;
                float f13 = f12 + m72dp;
                f5 = Math.max(f5, f13);
                this.rect2.set(f12 - m72dp, lerp - m72dp, f13, m72dp + lerp);
            ...
            f2 = 1.0f;
            f3 = 0.0f;
            canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), getHeight(), (int) (this.expandProgress * 255.0f * (1.0f - clamp)), 31);
        ...
        if (this.mainCircle == null || clamp <= f3) {
            return;
        }
        ...
        float lerp2 = AndroidUtilities.lerp(f3, (float) ((AndroidUtilities.dpf2(4.23f) / (this.rect1.width() * 3.141592653589793d)) * 360.0d), Utilities.clamp(f - f2, f2, f3) * clamp);
        int min = Math.min(this.count, 50);
        float min2 = Math.min(f, 50.0f);
        float max = (360.0f - (Math.max(f3, min2) * lerp2)) / Math.max(f2, min2);
        ...
        while (i13 < min) {
            float f18 = i13;
            float clamp2 = f2 - Utilities.clamp(f8 - f18, f2, f3);
            float clamp3 = f2 - Utilities.clamp((min - min2) - f18, f2, f3);
            if (clamp3 < f3) {
                f4 = f3;
            } else {
                float f19 = i13 == 0 ? ((this.newStoryBounceT - f2) / 2.5f) + f2 : f2;
                int i14 = (f19 > f2 ? 1 : (f19 == f2 ? 0 : -1));
                if (i14 != 0) {
                    canvas.save();
    ...
    public void setBounds(float f, float f2, float f3, boolean z) {
        boolean z2 = Math.abs(f - this.left) > 0.1f || Math.abs(f2 - this.right) > 0.1f || Math.abs(f3 - this.f1880cy) > 0.1f;
        this.left = f;
        this.right = f2;
        if (!z) {
    ...
    /* loaded from: classes6.dex */
    public class C67832 implements StoryViewer.PlaceProvider {
        C67832() {
        }
            ...
            if (storyCircle != null && storyCircle2 != null) {
                ...
                transitionViewHolder.drawClip = new StoryViewer.HolderClip() { // from class: org.telegram.ui.Stories.ProfileStoriesView$2$$ExternalSyntheticLambda0
                    ...
                    public final void clip(Canvas canvas, RectF rectF3, float f) {
                        ProfileStoriesView.C67832.this.lambda$findView$0(rectF, storyCircle, rectF2, storyCircle2, canvas, rectF3, f);
                    }
                };
            } else {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.expandProgress < 0.9f) {
            ...
            z = motionEvent.getX() >= (this.expandRight - this.f1881w) - ((float) AndroidUtilities.m72dp(32)) && motionEvent.getX() <= this.expandRight + ((float) AndroidUtilities.m72dp(32)) && Math.abs(motionEvent.getY() - this.expandY) < ((float) AndroidUtilities.m72dp(32));
        }
        ...
        if (motionEvent.getAction() == 1) {
            if (z && System.currentTimeMillis() - this.tapTime <= ViewConfiguration.getTapTimeout() && MathUtils.distance(this.tapX, this.tapY, motionEvent.getX(), motionEvent.getY()) <= AndroidUtilities.m72dp(12) && !this.circles.isEmpty()) {
                onTap(this.provider);
                return true;
            }
