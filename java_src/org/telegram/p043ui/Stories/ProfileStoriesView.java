...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void updateStories(boolean z, boolean z2) {
        ...
        if (arrayList != null) {
            ...
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                ...
                if (!(tLRPC$StoryItem2 instanceof TLRPC$TL_storyItemDeleted)) {
                    if (tLRPC$StoryItem2.f1557id > max) {
                        this.unreadCount++;
                    }
                    i++;
                }
            ...
            for (int i4 = 0; i4 < arrayList.size(); i4++) {
                ...
                if (!(tLRPC$StoryItem3 instanceof TLRPC$TL_storyItemDeleted)) {
                    if (tLRPC$StoryItem3 instanceof TLRPC$TL_storyItemSkipped) {
                        int i5 = tLRPC$StoryItem3.f1557id;
                        if (stories != null) {
                            int i6 = 0;
                            while (true) {
                                if (i6 >= stories.stories.size()) {
                                    break;
                                } else if (stories.stories.get(i6).f1557id == i5) {
                            ...
                            if (tLRPC$TL_userStories != null) {
                                ...
                                while (true) {
                                    if (i7 >= tLRPC$TL_userStories.stories.size()) {
                                        break;
                                    } else if (tLRPC$TL_userStories.stories.get(i7).f1557id == i5) {
                    ...
                    if (z4 || tLRPC$StoryItem3.f1557id > max) {
        ...
        if (arrayList2.size() < 3) {
            for (int i8 = 0; i8 < arrayList.size(); i8++) {
                ...
                if (tLRPC$StoryItem4 instanceof TLRPC$TL_storyItemSkipped) {
                    int i9 = tLRPC$StoryItem4.f1557id;
                    if (stories != null) {
                        int i10 = 0;
                        while (true) {
                            if (i10 >= stories.stories.size()) {
                                break;
                            } else if (stories.stories.get(i10).f1557id == i9) {
                        ...
                        if (tLRPC$TL_userStories != null) {
                            ...
                            while (true) {
                                if (i11 >= tLRPC$TL_userStories.stories.size()) {
                                    break;
                                } else if (tLRPC$TL_userStories.stories.get(i11).f1557id == i9) {
        ...
        for (int i12 = 0; i12 < this.circles.size(); i12++) {
            ...
            while (true) {
                ...
                if (tLRPC$StoryItem.f1557id == storyCircle.storyId) {
                    break;
                }
                i13++;
            }
            if (i13 == -1) {
                ...
                storyCircle.read = z4 || !(tLRPC$TL_userStories2 == null || tLRPC$StoryItem == null || tLRPC$StoryItem.f1557id > tLRPC$TL_userStories2.max_read_id);
            }
            if (!z) {
                storyCircle.apply();
            }
        ...
        for (int i14 = 0; i14 < arrayList2.size(); i14++) {
            ...
            while (true) {
                if (i15 >= this.circles.size()) {
                    i15 = -1;
                    break;
                } else if (this.circles.get(i15).storyId == tLRPC$StoryItem5.f1557id) {
                    break;
                } else {
                    i15++;
                }
            ...
            if (i15 == -1) {
                ...
                storyCircle2.read = z4 || (tLRPC$TL_userStories2 != null && tLRPC$StoryItem5.f1557id <= tLRPC$TL_userStories2.max_read_id);
                if (!z) {
                    storyCircle2.apply();
                }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.expandProgress <= BitmapDescriptorFactory.HUE_RED || clamp >= 1.0f) {
            ...
            this.f1890w = BitmapDescriptorFactory.HUE_RED;
            for (int i3 = 0; i3 < this.circles.size(); i3++) {
                this.f1890w += AndroidUtilities.m72dp(14) * this.circles.get(i3).cachedScale;
            }
            float f9 = 0.0f;
            for (int i4 = 0; i4 < this.circles.size(); i4++) {
                ...
                float f12 = (this.expandRight - this.f1890w) + m72dp + f9;
    ...
    public void setBounds(float f, float f2, float f3, boolean z) {
        boolean z2 = Math.abs(f - this.left) > 0.1f || Math.abs(f2 - this.right) > 0.1f || Math.abs(f3 - this.f1889cy) > 0.1f;
        this.left = f;
        this.right = f2;
        if (!z) {
    ...
    /* loaded from: classes7.dex */
    public class C68682 implements StoryViewer.PlaceProvider {
            ...
            if (storyCircle != null && storyCircle2 != null) {
                ...
                transitionViewHolder.drawClip = new StoryViewer.HolderClip() { // from class: org.telegram.ui.Stories.ProfileStoriesView$2$$ExternalSyntheticLambda0
                    ...
                    public final void clip(Canvas canvas, RectF rectF3, float f, boolean z) {
                        ProfileStoriesView.C68682.this.lambda$findView$0(rectF, storyCircle, rectF2, storyCircle2, canvas, rectF3, f, z);
                    }
                };
            } else {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.expandProgress < 0.9f) {
            ...
            z = motionEvent.getX() >= (this.expandRight - this.f1890w) - ((float) AndroidUtilities.m72dp(32)) && motionEvent.getX() <= this.expandRight + ((float) AndroidUtilities.m72dp(32)) && Math.abs(motionEvent.getY() - this.expandY) < ((float) AndroidUtilities.m72dp(32));
        }
