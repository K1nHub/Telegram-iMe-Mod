...
public class StoryEntry extends IStoryPart {
    ...
    public static StoryEntry fromStoryItem(File file, TLRPC$StoryItem tLRPC$StoryItem) {
        ...
        storyEntry.editStoryId = tLRPC$StoryItem.f1553id;
            ...
            if (tLRPC$Document != null && tLRPC$Document.attributes != null) {
                ...
                while (true) {
                    ...
                    if (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeVideo) {
                        storyEntry.width = tLRPC$DocumentAttribute.f1529w;
                        storyEntry.height = tLRPC$DocumentAttribute.f1528h;
    ...
    public static class HDRInfo {
        ...
        public int getHDRType() {
            if ((this.maxlum > BitmapDescriptorFactory.HUE_RED || this.minlum > BitmapDescriptorFactory.HUE_RED) && this.colorStandard == 6) {
