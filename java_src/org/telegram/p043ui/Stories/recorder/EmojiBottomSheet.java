...
public class EmojiBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class GifPage extends IPage {
        ...
        public GifPage(Context context) {
            ...
            this.listView.addItemDecoration(new RecyclerView.ItemDecoration(EmojiBottomSheet.this) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.GifPage.2
                ...
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    rect.right = GifPage.this.layoutManager.isLastInRow(recyclerView.getChildAdapterPosition(view) + (-1)) ? 0 : AndroidUtilities.m107dp(4);
                    rect.bottom = AndroidUtilities.m107dp(4);
                }
            });
        ...
        @Override // org.telegram.p043ui.Stories.recorder.EmojiBottomSheet.IPage
        public void updateTops() {
            this.searchField.setTranslationY(AndroidUtilities.m107dp(10) + Math.max((float) BitmapDescriptorFactory.HUE_RED, top()));
        }
    ...
    public class Page extends IPage {
        ...
        public Page(Context context) {
            ...
            EmojiTabsStrip emojiTabsStrip = new EmojiTabsStrip(context, ((BottomSheet) EmojiBottomSheet.this).resourcesProvider, false, false, true, 0, null, EmojiBottomSheet.this) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.Page.3
                ...
                protected boolean onTabClick(int i) {
                    ...
                    if (i3 >= 0) {
                        Page page = Page.this;
                        page.listView.scrollToPosition(i3, ((int) page.lockTop()) - AndroidUtilities.m107dp(102));
                        return true;
                    }
                    return true;
                }
        ...
        public float top() {
            ...
            for (int i = 0; i < this.listView.getChildCount(); i++) {
                Object tag = this.listView.getChildAt(i).getTag();
                if ((tag instanceof Integer) && ((Integer) tag).intValue() == 34) {
                    return Math.max(0, childAt.getBottom() - AndroidUtilities.m107dp(102));
                }
            }
            return BitmapDescriptorFactory.HUE_RED;
        }
        ...
        public void updateTops() {
            ...
            this.tabsStrip.setTranslationY(AndroidUtilities.m107dp(16) + max);
            this.searchField.setTranslationY(AndroidUtilities.m107dp(52) + max);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.tabsStrip.setTranslationY(AndroidUtilities.m107dp(16));
            this.searchField.setTranslationY(AndroidUtilities.m107dp(52));
            this.listView.setPadding(AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(102), AndroidUtilities.m107dp(5), AndroidUtilities.navigationBarHeight + AndroidUtilities.m107dp(40));
            super.onMeasure(i, i2);
        }
    ...
    public void showPremiumBulletin(String str) {
        ...
        BulletinFactory.m66of(this.container, this.resourcesProvider).createSimpleBulletin(C3632R.raw.star_premium_2, LocaleController.getString(C3632R.string.IncreaseLimit), premiumText(str)).show(true);
    }
    ...
    private class ContainerView extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            EmojiBottomSheet.this.maxPadding = Math.min(size2 * 0.45f, (AndroidUtilities.m107dp(350) / 0.55f) * 0.45f);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float paddingTop = (EmojiBottomSheet.this.top + EmojiBottomSheet.this.viewPager.getPaddingTop()) - AndroidUtilities.lerp(AndroidUtilities.m107dp(8), EmojiBottomSheet.this.viewPager.getPaddingTop(), f);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(((BottomSheet) EmojiBottomSheet.this).backgroundPaddingLeft, paddingTop, getWidth() - ((BottomSheet) EmojiBottomSheet.this).backgroundPaddingLeft, getHeight() + AndroidUtilities.m107dp(8));
            if (this.blurBitmap != null) {
                this.blurBitmapMatrix.reset();
                this.blurBitmapMatrix.postScale(16.0f, 16.0f);
                this.blurBitmapMatrix.postTranslate(BitmapDescriptorFactory.HUE_RED, -getY());
                this.blurBitmapShader.setLocalMatrix(this.blurBitmapMatrix);
                canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(14), AndroidUtilities.m107dp(14), this.backgroundBlurPaint);
            }
            float f2 = 1.0f - f;
            canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(14) * f2, AndroidUtilities.m107dp(14) * f2, this.backgroundPaint);
            this.handleRect.set((getWidth() - AndroidUtilities.m107dp(36)) / 2.0f, AndroidUtilities.m108dp(9.66f) + paddingTop, (getWidth() + AndroidUtilities.m107dp(36)) / 2.0f, paddingTop + AndroidUtilities.m108dp(13.66f));
            this.handlePaint.setColor(1367573379);
            this.handlePaint.setAlpha((int) (f2 * 81.0f));
            canvas.drawRoundRect(this.handleRect, AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), this.handlePaint);
            canvas.save();
    ...
    public static class SearchField extends FrameLayout {
        ...
        public SearchField(Context context, final Theme.ResourcesProvider resourcesProvider) {
            ...
            frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(18), Theme.getColor(Theme.key_chat_emojiSearchBackground, resourcesProvider)));
            ...
            editTextBoldCursor.setTranslationY(AndroidUtilities.m107dp(-2));
            frameLayout2.addView(editTextBoldCursor, LayoutHelper.createFrame(-1, 40, 51, 0, 0, 28, 0));
            editTextBoldCursor.addTextChangedListener(new C73563());
            ...
            stickerCategoriesListView.setDontOccupyWidth(((int) paint.measureText(((Object) editTextBoldCursor.getHint()) + "")) + AndroidUtilities.m107dp(16));
            ...
            imageView2.setBackground(Theme.createSelectorDrawable(Theme.getColor(Theme.key_listSelector, resourcesProvider), 1, AndroidUtilities.m107dp(15)));
        ...
        /* loaded from: classes6.dex */
        public class C73563 implements TextWatcher {
            ...
            public void afterTextChanged(Editable editable) {
                ...
                if (SearchField.this.editText != null) {
                    ...
                    scaleY.alpha(f).withEndAction(new Runnable() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$SearchField$3$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            EmojiBottomSheet.SearchField.C73563.this.lambda$afterTextChanged$0();
                        }
    ...
    public static class TabsView extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(40) + AndroidUtilities.navigationBarHeight);
        ...
        private void updateLayouts() {
            ...
            float m107dp = AndroidUtilities.m107dp(12) + this.emojiLayoutWidth + AndroidUtilities.m107dp(36) + this.stickersLayoutWidth + AndroidUtilities.m107dp(36) + this.gifsLayoutWidth + AndroidUtilities.m107dp(12);
            float m107dp2 = AndroidUtilities.m107dp(14) / 2.0f;
            float m107dp3 = AndroidUtilities.m107dp(66) / 2.0f;
            float measuredWidth = (getMeasuredWidth() - m107dp) / 2.0f;
            this.emojiRect.set(measuredWidth, m107dp2, this.emojiLayoutWidth + measuredWidth + AndroidUtilities.m107dp(24), m107dp3);
            float m107dp4 = measuredWidth + this.emojiLayoutWidth + AndroidUtilities.m107dp(36);
            this.stickersRect.set(m107dp4, m107dp2, this.stickersLayoutWidth + m107dp4 + AndroidUtilities.m107dp(24), m107dp3);
            float m107dp5 = m107dp4 + this.stickersLayoutWidth + AndroidUtilities.m107dp(36);
            this.gifsRect.set(m107dp5, m107dp2, this.gifsLayoutWidth + m107dp5 + AndroidUtilities.m107dp(24), m107dp3);
            AndroidUtilities.m107dp(36);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.selectRect, AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(20), this.selectPaint);
            if (this.emojiLayout != null) {
                canvas.save();
                float m107dp = (this.emojiRect.left + AndroidUtilities.m107dp(12)) - this.emojiLayoutLeft;
                RectF rectF = this.emojiRect;
                canvas.translate(m107dp, rectF.top + ((rectF.height() - this.emojiLayout.getHeight()) / 2.0f));
            ...
            if (this.stickersLayout != null) {
                canvas.save();
                float m107dp2 = (this.stickersRect.left + AndroidUtilities.m107dp(12)) - this.stickersLayoutLeft;
                RectF rectF2 = this.stickersRect;
                canvas.translate(m107dp2, rectF2.top + ((rectF2.height() - this.stickersLayout.getHeight()) / 2.0f));
            ...
            if (this.gifsLayout != null) {
                canvas.save();
                float m107dp3 = (this.gifsRect.left + AndroidUtilities.m107dp(12)) - this.gifsLayoutLeft;
                RectF rectF3 = this.gifsRect;
                canvas.translate(m107dp3, rectF3.top + ((rectF3.height() - this.gifsLayout.getHeight()) / 2.0f));
    ...
    private static class NoEmojiView extends FrameLayout {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec((int) Math.max(AndroidUtilities.m107dp(170), (AndroidUtilities.displaySize.y * 0.34999996f) - AndroidUtilities.m107dp(142)), 1073741824));
        }
    }
    ...
    public class StoryWidgetsCell extends View {
        ...
        private class Button extends BaseWidget {
            ...
            public void draw(Canvas canvas, float f, float f2) {
                ...
                canvas.drawRoundRect(this.bounds, AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), StoryWidgetsCell.this.bgPaint);
                this.drawable.setBounds((int) (this.bounds.left + AndroidUtilities.m107dp(6)), (int) ((this.bounds.top + (this.height / 2.0f)) - (AndroidUtilities.m107dp(24) / 2)), (int) (this.bounds.left + AndroidUtilities.m107dp(30)), (int) (this.bounds.top + (this.height / 2.0f) + (AndroidUtilities.m107dp(24) / 2)));
                this.drawable.draw(canvas);
                canvas.translate((this.bounds.left + AndroidUtilities.m107dp(34)) - this.textLeft, (this.bounds.top + (this.height / 2.0f)) - (this.layout.getHeight() / 2.0f));
        ...
        public class ReactionWidget extends BaseWidget {
            ...
            ReactionWidget() {
                ...
                this.f2011id = 3;
                this.width = AndroidUtilities.m107dp(44);
                this.height = AndroidUtilities.m107dp(36);
            ...
            void draw(Canvas canvas, float f, float f2) {
                float m107dp = f2 - AndroidUtilities.m107dp(4);
                float f3 = this.width;
                this.bounds.set((int) f, (int) m107dp, (int) (f + f3), (int) (m107dp + f3));
                float scale = this.bounce.getScale(0.05f);
                canvas.save();
                canvas.scale(scale, scale, this.bounds.centerX(), this.bounds.centerY());
                ...
                Rect rect = AndroidUtilities.rectTmp2;
                float m107dp2 = AndroidUtilities.m107dp(30) / 2.0f;
                rect.set((int) (this.bounds.centerX() - m107dp2), (int) (this.bounds.centerY() - m107dp2), (int) (this.bounds.centerX() + m107dp2), (int) (this.bounds.centerY() + m107dp2));
            ...
            public void onAttachToWindow(boolean z) {
                ...
                if (z) {
                    ...
                    timer2.schedule(new C73591(), ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                }
            }
            ...
            /* loaded from: classes6.dex */
            public class C73591 extends TimerTask {
                C73591() {
                }
                ...
                public void run() {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$StoryWidgetsCell$ReactionWidget$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            EmojiBottomSheet.StoryWidgetsCell.ReactionWidget.C73591.this.lambda$run$0();
                        }
                    });
                }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (BaseWidget baseWidget : this.widgets) {
                ...
                f += baseWidget.width + AndroidUtilities.m107dp(10);
                if (f > paddingLeft) {
                    i3++;
                    baseWidget.layoutX = BitmapDescriptorFactory.HUE_RED;
                    f = baseWidget.width + AndroidUtilities.m107dp(10) + BitmapDescriptorFactory.HUE_RED;
                }
            ...
            for (BaseWidget baseWidget2 : this.widgets) {
                ...
                if (fArr2[i4] > BitmapDescriptorFactory.HUE_RED) {
                    fArr2[i4] = fArr2[i4] + AndroidUtilities.m107dp(10);
                }
                float[] fArr3 = this.lineWidths;
                fArr3[i4] = fArr3[i4] + baseWidget2.width;
            }
            setMeasuredDimension(size, AndroidUtilities.m107dp(24) + (AndroidUtilities.m107dp(36) * i3) + ((i3 - 1) * AndroidUtilities.m107dp(12)));
        }

        @Override // android.view.View
        protected void dispatchDraw(Canvas canvas) {
            for (BaseWidget baseWidget : this.widgets) {
                baseWidget.draw(canvas, getPaddingLeft() + ((((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - this.lineWidths[baseWidget.layoutLine - 1]) / 2.0f) + baseWidget.layoutX, AndroidUtilities.m107dp(12) + ((baseWidget.layoutLine - 1) * AndroidUtilities.m107dp(48)));
            }
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == 1 && baseWidget != null && (callback = this.onClickListener) != null) {
                callback.run(Integer.valueOf(baseWidget.f2011id));
            }
