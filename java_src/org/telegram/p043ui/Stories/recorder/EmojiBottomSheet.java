...
public class EmojiBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    static /* synthetic */ float access$3616(EmojiBottomSheet emojiBottomSheet, float f) {
    ...
    public EmojiBottomSheet(final Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        ViewPagerFixed viewPagerFixed = new ViewPagerFixed(context) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.1
        ...
        viewPagerFixed.setAdapter(new ViewPagerFixed.Adapter() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.2
        ...
        imageView.setImageResource(C3419R.C3421drawable.msg_tabs_media);
    ...
    private class ContainerView extends FrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (viewPages[0] instanceof Page) {
                EmojiBottomSheet.access$3616(EmojiBottomSheet.this, ((Page) viewPages[0]).top() * Utilities.clamp(1.0f - Math.abs(viewPages[0].getTranslationX() / viewPages[0].getMeasuredWidth()), 1.0f, (float) BitmapDescriptorFactory.HUE_RED));
                if (viewPages[0].getVisibility() == 0) {
                    ((Page) viewPages[0]).updateTops();
                }
            }
            if (viewPages[1] instanceof Page) {
                EmojiBottomSheet.access$3616(EmojiBottomSheet.this, ((Page) viewPages[1]).top() * Utilities.clamp(1.0f - Math.abs(viewPages[1].getTranslationX() / viewPages[1].getMeasuredWidth()), 1.0f, (float) BitmapDescriptorFactory.HUE_RED));
    ...
    public static class EmojiListView extends RecyclerListView {
        ...
        public static class EmojiImageView extends View {
            ...
            public void setEmoji(TLRPC$Document tLRPC$Document) {
                if (this.documentId == (tLRPC$Document == null ? 0L : tLRPC$Document.f1526id)) {
                    return;
                }
                ...
                if (tLRPC$Document != null) {
                    this.documentId = tLRPC$Document.f1526id;
            ...
            public void setSticker(TLRPC$Document tLRPC$Document) {
                if (tLRPC$Document != null) {
                    ...
                    long j2 = tLRPC$Document.f1526id;
                    if (j == j2) {
                        return;
                    }
                    this.documentId = j2;
    ...
    public static class SearchField extends FrameLayout {
        ...
        public SearchField(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            editTextBoldCursor.setHint(LocaleController.getString("Search", C3419R.string.Search));
            ...
            editTextBoldCursor.addTextChangedListener(new TextWatcher() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.SearchField.3
                ...
                public void afterTextChanged(Editable editable) {
                    ...
                    if (SearchField.this.editText != null) {
                        ...
                        SearchField.this.editText.animate().translationX(BitmapDescriptorFactory.HUE_RED).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).start();
                    }
                }
            });
            ...
            stickerCategoriesListView.setOnScrollIntoOccupiedWidth(new Utilities.Callback() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$SearchField$$ExternalSyntheticLambda1
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    EmojiBottomSheet.SearchField.this.lambda$new$0((Integer) obj);
                }
            });
            stickerCategoriesListView.setOnCategoryClick(new Utilities.Callback() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$SearchField$$ExternalSyntheticLambda2
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$SearchField$$ExternalSyntheticLambda0
    ...
    public static class TabsView extends View {
        ...
        private void updateLayouts() {
            ...
            if (this.stickersLayout.getLineCount() >= 1) {
                f = this.stickersLayout.getLineLeft(0);
            }
            this.stickersLayoutLeft = f;
            float m72dp = AndroidUtilities.m72dp(12) + this.emojiLayoutWidth + AndroidUtilities.m72dp(36) + this.stickersLayoutWidth + AndroidUtilities.m72dp(12);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.masksLayout != null) {
                canvas.save();
                float m72dp3 = (this.masksRect.left + AndroidUtilities.m72dp(12)) - this.masksLayoutLeft;
                RectF rectF3 = this.masksRect;
                canvas.translate(m72dp3, rectF3.top + ((rectF3.height() - this.masksLayout.getHeight()) / 2.0f));
    ...
    private static class NoEmojiView extends FrameLayout {
        ...
        public NoEmojiView(Context context, boolean z) {
            ...
            if (z) {
                i = C3419R.string.NoEmojiFound;
                str = "NoEmojiFound";
            } else {
                i = C3419R.string.NoStickersFound;
                str = "NoStickersFound";
            }
