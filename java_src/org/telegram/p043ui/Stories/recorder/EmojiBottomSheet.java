...
public class EmojiBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    static /* synthetic */ float access$5916(EmojiBottomSheet emojiBottomSheet, float f) {
    ...
    public class GifPage extends IPage {
        ...
        public GifPage(Context context) {
            ...
            this.listView.addItemDecoration(new RecyclerView.ItemDecoration(EmojiBottomSheet.this) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.GifPage.2
                ...
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    rect.right = GifPage.this.layoutManager.isLastInRow(recyclerView.getChildAdapterPosition(view) + (-1)) ? 0 : AndroidUtilities.m72dp(4);
                    rect.bottom = AndroidUtilities.m72dp(4);
                }
            });
        ...
        @Override // org.telegram.p043ui.Stories.recorder.EmojiBottomSheet.IPage
        public void updateTops() {
            this.searchField.setTranslationY(AndroidUtilities.m72dp(10) + Math.max((float) BitmapDescriptorFactory.HUE_RED, top()));
        }
    ...
    public class Page extends IPage {
        ...
        public Page(Context context) {
            ...
            EmojiTabsStrip emojiTabsStrip = new EmojiTabsStrip(context, ((BottomSheet) EmojiBottomSheet.this).resourcesProvider, false, false, true, 0, null, EmojiBottomSheet.this) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.Page.3
                ...
                protected boolean onTabClick(int i) {
                    ...
                    if (i3 >= 0) {
                        Page page = Page.this;
                        page.listView.scrollToPosition(i3, ((int) page.lockTop()) - AndroidUtilities.m72dp(102));
                        return true;
                    }
                    return true;
                }
        ...
        public float top() {
            ...
            for (int i = 0; i < this.listView.getChildCount(); i++) {
                Object tag = this.listView.getChildAt(i).getTag();
                if ((tag instanceof Integer) && ((Integer) tag).intValue() == 34) {
                    return Math.max(0, childAt.getBottom() - AndroidUtilities.m72dp(102));
                }
            }
            return BitmapDescriptorFactory.HUE_RED;
        }
        ...
        public void updateTops() {
            ...
            this.tabsStrip.setTranslationY(AndroidUtilities.m72dp(16) + max);
            this.searchField.setTranslationY(AndroidUtilities.m72dp(52) + max);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.tabsStrip.setTranslationY(AndroidUtilities.m72dp(16));
            this.searchField.setTranslationY(AndroidUtilities.m72dp(52));
            this.listView.setPadding(AndroidUtilities.m72dp(5), AndroidUtilities.m72dp(102), AndroidUtilities.m72dp(5), AndroidUtilities.navigationBarHeight + AndroidUtilities.m72dp(40));
            super.onMeasure(i, i2);
        }
        ...
        public class Adapter extends RecyclerView.Adapter {
            ...
            private Adapter() {
                ...
                this.searchRunnable = new Runnable() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$Page$Adapter$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            /* JADX WARN: Multi-variable type inference failed */
            /* JADX WARN: Removed duplicated region for block: B:134:0x02d9 A[SYNTHETIC] */
    ...
    public EmojiBottomSheet(final Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.locationSticker = new TLRPC$Document(this) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.1
        };
        ...
        ViewPagerFixed viewPagerFixed = new ViewPagerFixed(context) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.2
        ...
        viewPagerFixed.setAdapter(new ViewPagerFixed.Adapter() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.3
        ...
        new KeyboardNotifier(this.containerView, new Utilities.Callback() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$$ExternalSyntheticLambda0
        ...
        tabsView.setOnTypeSelected(new Utilities.Callback() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$$ExternalSyntheticLambda1
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
        ...
        imageView.setImageResource(C3473R.C3475drawable.msg_tabs_media);
        imageView.setColorFilter(new PorterDuffColorFilter(1895825407, PorterDuff.Mode.SRC_IN));
        ScaleStateListAnimator.apply(imageView);
        this.containerView.addView(imageView, LayoutHelper.createFrame(40, 40, 83, 8, 0, 0, 0));
    ...
    private class ContainerView extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            EmojiBottomSheet.this.maxPadding = Math.min(size2 * 0.45f, (AndroidUtilities.m72dp(350) / 0.55f) * 0.45f);
            ...
            EmojiBottomSheet.this.galleryButton.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(40), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(40), 1073741824));
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            for (View view : viewPages) {
                if (view instanceof IPage) {
                    ...
                    EmojiBottomSheet.access$5916(EmojiBottomSheet.this, iPage.top() * Utilities.clamp(1.0f - Math.abs(iPage.getTranslationX() / iPage.getMeasuredWidth()), 1.0f, (float) BitmapDescriptorFactory.HUE_RED));
            ...
            float paddingTop = (EmojiBottomSheet.this.top + EmojiBottomSheet.this.viewPager.getPaddingTop()) - AndroidUtilities.lerp(AndroidUtilities.m72dp(8), EmojiBottomSheet.this.viewPager.getPaddingTop(), f);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(((BottomSheet) EmojiBottomSheet.this).backgroundPaddingLeft, paddingTop, getWidth() - ((BottomSheet) EmojiBottomSheet.this).backgroundPaddingLeft, getHeight() + AndroidUtilities.m72dp(8));
            if (this.blurBitmap != null) {
                this.blurBitmapMatrix.reset();
                this.blurBitmapMatrix.postScale(16.0f, 16.0f);
                this.blurBitmapMatrix.postTranslate(BitmapDescriptorFactory.HUE_RED, -getY());
                this.blurBitmapShader.setLocalMatrix(this.blurBitmapMatrix);
                canvas.drawRoundRect(rectF, AndroidUtilities.m72dp(14), AndroidUtilities.m72dp(14), this.backgroundBlurPaint);
            }
            float f2 = 1.0f - f;
            canvas.drawRoundRect(rectF, AndroidUtilities.m72dp(14) * f2, AndroidUtilities.m72dp(14) * f2, this.backgroundPaint);
            this.handleRect.set((getWidth() - AndroidUtilities.m72dp(36)) / 2.0f, AndroidUtilities.m73dp(9.66f) + paddingTop, (getWidth() + AndroidUtilities.m72dp(36)) / 2.0f, paddingTop + AndroidUtilities.m73dp(13.66f));
            this.handlePaint.setColor(1367573379);
            this.handlePaint.setAlpha((int) (f2 * 81.0f));
            canvas.drawRoundRect(this.handleRect, AndroidUtilities.m72dp(4), AndroidUtilities.m72dp(4), this.handlePaint);
            canvas.save();
    ...
    public static class EmojiListView extends RecyclerListView {
        ...
        public static class EmojiImageView extends View {
            ...
            public void setEmoji(TLRPC$Document tLRPC$Document) {
                if (this.documentId == (tLRPC$Document == null ? 0L : tLRPC$Document.f1530id)) {
                    return;
                }
                ...
                if (tLRPC$Document != null) {
                    this.documentId = tLRPC$Document.f1530id;
            ...
            public void setSticker(TLRPC$Document tLRPC$Document) {
                if (tLRPC$Document != null) {
                    ...
                    long j2 = tLRPC$Document.f1530id;
                    if (j == j2) {
                        return;
                    }
                    this.documentId = j2;
    ...
    public static class SearchField extends FrameLayout {
        ...
        public SearchField(Context context, final Theme.ResourcesProvider resourcesProvider) {
            ...
            frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m72dp(18), Theme.getColor(Theme.key_chat_emojiSearchBackground, resourcesProvider)));
            ...
            editTextBoldCursor.setHint(LocaleController.getString("Search", C3473R.string.Search));
            ...
            editTextBoldCursor.setTranslationY(AndroidUtilities.m72dp(-2));
            frameLayout2.addView(editTextBoldCursor, LayoutHelper.createFrame(-1, 40, 51, 0, 0, 28, 0));
            editTextBoldCursor.addTextChangedListener(new C69483());
            ...
            stickerCategoriesListView.setDontOccupyWidth(((int) paint.measureText(((Object) editTextBoldCursor.getHint()) + "")) + AndroidUtilities.m72dp(16));
            ...
            imageView2.setBackground(Theme.createSelectorDrawable(Theme.getColor(Theme.key_listSelector, resourcesProvider), 1, AndroidUtilities.m72dp(15)));
        ...
        /* loaded from: classes7.dex */
        public class C69483 implements TextWatcher {
            ...
            public void afterTextChanged(Editable editable) {
                ...
                if (SearchField.this.editText != null) {
                    ...
                    scaleY.alpha(f).withEndAction(new Runnable() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$SearchField$3$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            EmojiBottomSheet.SearchField.C69483.this.lambda$afterTextChanged$0();
                        }
    ...
    public static class TabsView extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m72dp(40) + AndroidUtilities.navigationBarHeight);
        ...
        private void updateLayouts() {
            ...
            StaticLayout staticLayout3 = new StaticLayout(LocaleController.getString("AccDescrGIFs", C3473R.string.AccDescrGIFs), this.textPaint, getMeasuredWidth(), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            ...
            float m72dp = AndroidUtilities.m72dp(12) + this.emojiLayoutWidth + AndroidUtilities.m72dp(36) + this.stickersLayoutWidth + AndroidUtilities.m72dp(36) + this.gifsLayoutWidth + AndroidUtilities.m72dp(12);
            float m72dp2 = AndroidUtilities.m72dp(14) / 2.0f;
            float m72dp3 = AndroidUtilities.m72dp(66) / 2.0f;
            float measuredWidth = (getMeasuredWidth() - m72dp) / 2.0f;
            this.emojiRect.set(measuredWidth, m72dp2, this.emojiLayoutWidth + measuredWidth + AndroidUtilities.m72dp(24), m72dp3);
            float m72dp4 = measuredWidth + this.emojiLayoutWidth + AndroidUtilities.m72dp(36);
            this.stickersRect.set(m72dp4, m72dp2, this.stickersLayoutWidth + m72dp4 + AndroidUtilities.m72dp(24), m72dp3);
            float m72dp5 = m72dp4 + this.stickersLayoutWidth + AndroidUtilities.m72dp(36);
            this.gifsRect.set(m72dp5, m72dp2, this.gifsLayoutWidth + m72dp5 + AndroidUtilities.m72dp(24), m72dp3);
            AndroidUtilities.m72dp(36);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.selectRect, AndroidUtilities.m72dp(20), AndroidUtilities.m72dp(20), this.selectPaint);
            if (this.emojiLayout != null) {
                canvas.save();
                float m72dp = (this.emojiRect.left + AndroidUtilities.m72dp(12)) - this.emojiLayoutLeft;
                RectF rectF = this.emojiRect;
                canvas.translate(m72dp, rectF.top + ((rectF.height() - this.emojiLayout.getHeight()) / 2.0f));
            ...
            if (this.stickersLayout != null) {
                canvas.save();
                float m72dp2 = (this.stickersRect.left + AndroidUtilities.m72dp(12)) - this.stickersLayoutLeft;
                RectF rectF2 = this.stickersRect;
                canvas.translate(m72dp2, rectF2.top + ((rectF2.height() - this.stickersLayout.getHeight()) / 2.0f));
            ...
            if (this.gifsLayout != null) {
                canvas.save();
                float m72dp3 = (this.gifsRect.left + AndroidUtilities.m72dp(12)) - this.gifsLayoutLeft;
                RectF rectF3 = this.gifsRect;
                canvas.translate(m72dp3, rectF3.top + ((rectF3.height() - this.gifsLayout.getHeight()) / 2.0f));
    ...
    private static class NoEmojiView extends FrameLayout {
        ...
        public NoEmojiView(Context context, boolean z) {
            ...
            if (z) {
                i = C3473R.string.NoEmojiFound;
                str = "NoEmojiFound";
            } else {
                i = C3473R.string.NoStickersFound;
                str = "NoStickersFound";
            }
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec((int) Math.max(AndroidUtilities.m72dp(170), (AndroidUtilities.displaySize.y * 0.34999996f) - AndroidUtilities.m72dp(142)), 1073741824));
        }
    }

    /* renamed from: org.telegram.ui.Stories.recorder.EmojiBottomSheet$StoryLocationComponentCell */
    /* loaded from: classes7.dex */
    private static class StoryLocationComponentCell extends View {
        ...
        public StoryLocationComponentCell(Context context) {
            ...
            textPaint.setTextSize(AndroidUtilities.m73dp(21.3f));
            textPaint.setColor(-1);
            Drawable mutate = context.getResources().getDrawable(C3473R.C3475drawable.map_pin3).mutate();
            this.pin = mutate;
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(60), 1073741824));
            if (this.lastWidth != getMeasuredWidth()) {
                StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(LocaleController.getString("AddLocation", C3473R.string.AddLocation), this.textPaint, getMeasuredWidth(), TextUtils.TruncateAt.END), this.textPaint, getMeasuredWidth(), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                this.layout = staticLayout;
                int lineCount = staticLayout.getLineCount();
                float f = BitmapDescriptorFactory.HUE_RED;
                this.layoutLeft = lineCount <= 0 ? 0.0f : this.layout.getLineLeft(0);
                if (this.layout.getLineCount() > 0) {
                    f = this.layout.getLineWidth(0);
                }
                this.layoutWidth = f;
                this.lastWidth = getMeasuredWidth();
                float m73dp = AndroidUtilities.m73dp(45.6f) + this.layoutWidth;
                float m72dp = AndroidUtilities.m72dp(11) + this.layout.getHeight();
                this.bounds.set((getMeasuredWidth() - m73dp) / 2.0f, (getMeasuredHeight() - m72dp) / 2.0f, (getMeasuredWidth() + m73dp) / 2.0f, (getMeasuredHeight() + m72dp) / 2.0f);
                this.pin.setBounds((int) (this.bounds.left + AndroidUtilities.m72dp(6)), (int) (this.bounds.centerY() - AndroidUtilities.m72dp(12)), (int) (this.bounds.left + AndroidUtilities.m72dp(30)), (int) (this.bounds.centerY() + AndroidUtilities.m72dp(12)));
            }
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.bounds, AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(8), this.bgPaint);
            this.pin.draw(canvas);
            canvas.save();
            canvas.translate((this.bounds.left + AndroidUtilities.m72dp(34)) - this.layoutLeft, this.bounds.top + AndroidUtilities.m72dp(6));
