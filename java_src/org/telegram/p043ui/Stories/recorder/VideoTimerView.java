...
public class VideoTimerView extends View implements FlashViews.Invertable {
    ...
    public void onDraw(Canvas canvas) {
        ...
        float m108dp = AndroidUtilities.m108dp(12.66f) * f;
        float currentWidth = this.textDrawable.getCurrentWidth() + m108dp;
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(((getWidth() - currentWidth) / 2.0f) - AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(18), ((getWidth() + currentWidth) / 2.0f) + AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(40));
        canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(18), this.backgroundPaint);
        if (f > BitmapDescriptorFactory.HUE_RED) {
            ...
            invalidate();
            canvas.drawCircle(rectF.left + AndroidUtilities.m108dp(10.66f), rectF.centerY(), AndroidUtilities.m107dp(4) * f, this.recordPaint);
        }
        this.textDrawable.setBounds((int) (rectF.left + m108dp), ((int) rectF.top) - AndroidUtilities.m107dp(1), (int) rectF.right, (int) rectF.bottom);
