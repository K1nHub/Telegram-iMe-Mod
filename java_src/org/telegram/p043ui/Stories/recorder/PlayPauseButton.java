...
public class PlayPauseButton extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, AndroidUtilities.m72dp(10), this.circlePaint);
        this.drawable.setBounds(0, 0, AndroidUtilities.m72dp(10), AndroidUtilities.m72dp(10));
        canvas.save();
        canvas.translate((getWidth() - AndroidUtilities.m72dp(10)) / 2.0f, (getHeight() - AndroidUtilities.m72dp(10)) / 2.0f);
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(56), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(56), 1073741824));
    }
}
