...
public class PreviewHighlightView extends FrameLayout {
    ...
    public PreviewHighlightView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        peerHeaderView.setSubtitle(LocaleController.getString("RightNow", C3473R.string.RightNow), false);
        frameLayout.addView(peerHeaderView, LayoutHelper.createFrame(-1, -2, 55, 0, 17, 0, 0));
        ImageView imageView = new ImageView(context);
        imageView.setImageDrawable(getContext().getResources().getDrawable(C3473R.C3475drawable.ic_close_white).mutate());
        ...
        imageView2.setImageResource(C3473R.C3475drawable.msg_share);
        ...
        textView.setText(LocaleController.getString("ReplyPrivately", C3473R.string.ReplyPrivately));
        frameLayout3.addView(textView, LayoutHelper.createFrame(-2, -2, 19, 24, 0, 24, 0));
        ImageView imageView3 = new ImageView(context);
        imageView3.setImageResource(C3473R.C3475drawable.input_attach);
