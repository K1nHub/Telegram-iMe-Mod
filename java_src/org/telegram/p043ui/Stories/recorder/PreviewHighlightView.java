...
public class PreviewHighlightView extends FrameLayout {
    ...
    public PreviewHighlightView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        storyCaptionView.setTranslationY(AndroidUtilities.m107dp(8));
        ...
        frameLayout3.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(22), ColorUtils.setAlphaComponent(-16777216, 122)));
