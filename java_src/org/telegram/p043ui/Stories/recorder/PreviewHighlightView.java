...
public class PreviewHighlightView extends FrameLayout {
    ...
    public PreviewHighlightView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        peerHeaderView.setSubtitle(LocaleController.getString("RightNow", C3634R.string.RightNow), false);
        frameLayout.addView(peerHeaderView, LayoutHelper.createFrame(-1, -2, 55, 0, 17, 0, 0));
        ImageView imageView = new ImageView(context);
        imageView.setImageDrawable(getContext().getResources().getDrawable(C3634R.C3636drawable.ic_close_white).mutate());
        ...
        storyCaptionView.setTranslationY(AndroidUtilities.m104dp(8));
        frameLayout2.addView(storyCaptionView, LayoutHelper.createFrame(-1, -1, 87, 0, 0, 0, 64));
        ImageView imageView2 = new ImageView(context);
        imageView2.setImageResource(C3634R.C3636drawable.msg_share);
        ...
        frameLayout3.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m104dp(22), ColorUtils.setAlphaComponent(-16777216, 122)));
        TextView textView = new TextView(context);
        textView.setTextSize(1, 18.0f);
        textView.setTextColor(1694498815);
        textView.setText(LocaleController.getString("ReplyPrivately", C3634R.string.ReplyPrivately));
        frameLayout3.addView(textView, LayoutHelper.createFrame(-2, -2, 19, 24, 0, 24, 0));
        ImageView imageView3 = new ImageView(context);
        imageView3.setImageResource(C3634R.C3636drawable.input_attach);
