...
public class HintView2 extends View {
    ...
    public HintView2(Context context, int i) {
        ...
        this.useAlpha = true;
        this.textMaxWidth = -1;
        this.rounding = AndroidUtilities.m72dp(8);
        this.innerPadding = new RectF(AndroidUtilities.m72dp(11), AndroidUtilities.m72dp(6), AndroidUtilities.m72dp(11), AndroidUtilities.m72dp(7));
        this.closeButtonMargin = AndroidUtilities.m72dp(2);
        this.arrowHalfWidth = AndroidUtilities.m72dp(7);
        this.arrowHeight = AndroidUtilities.m72dp(6);
    ...
    public HintView2 setRounding(float f) {
        this.rounding = AndroidUtilities.m73dp(f);
    ...
    public HintView2 setMultilineText(boolean z) {
        this.multiline = z;
        if (z) {
            this.innerPadding.set(AndroidUtilities.m72dp(15), AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(15), AndroidUtilities.m72dp(8));
            this.closeButtonMargin = AndroidUtilities.m72dp(6);
        } else {
            this.innerPadding.set(AndroidUtilities.m72dp(11), AndroidUtilities.m72dp(6), AndroidUtilities.m72dp(this.closeButton ? 15 : 11), AndroidUtilities.m72dp(7));
            this.closeButtonMargin = AndroidUtilities.m72dp(2);
        }
        return this;
    }
    ...
    public HintView2 setTextSize(int i) {
        this.textDrawable.setTextSize(AndroidUtilities.m72dp(i));
    ...
    public HintView2 setMaxWidth(float f) {
        this.textMaxWidth = AndroidUtilities.m73dp(f);
        return this;
    }
    ...
    private static int getTextWidth(CharSequence charSequence, TextPaint textPaint) {
        if (charSequence instanceof Spannable) {
            StaticLayout staticLayout = new StaticLayout(charSequence, textPaint, 99999, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
    ...
    public HintView2 setInnerPadding(int i, int i2, int i3, int i4) {
        this.innerPadding.set(AndroidUtilities.m72dp(i), AndroidUtilities.m72dp(i2), AndroidUtilities.m72dp(i3), AndroidUtilities.m72dp(i4));
        return this;
    }
    ...
    public HintView2 setJoint(float f, float f2) {
        if (Math.abs(this.joint - f) >= 1.0f || Math.abs(this.jointTranslate - AndroidUtilities.m73dp(f2)) >= 1.0f) {
            this.pathSet = false;
            invalidate();
        }
        this.joint = f;
        this.jointTranslate = AndroidUtilities.m73dp(f2);
        return this;
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.closeButton) {
            if (this.closeButtonDrawable == null) {
                Drawable mutate = getContext().getResources().getDrawable(C3419R.C3421drawable.msg_mini_close_tooltip).mutate();
        ...
        if (this.bounceT != 1.0f) {
            ...
            if (i == 3 || i == 1) {
                canvas.translate(BitmapDescriptorFactory.HUE_RED, (this.bounceT - 1.0f) * Math.max(i == 3 ? getPaddingBottom() : getPaddingTop(), AndroidUtilities.m72dp(24)) * (this.direction == 1 ? -1 : 1));
            } else {
                canvas.translate((this.bounceT - 1.0f) * Math.max(i == 0 ? getPaddingLeft() : getPaddingRight(), AndroidUtilities.m72dp(24)) * (this.direction == 0 ? -1 : 1), BitmapDescriptorFactory.HUE_RED);
            }
        }
        ...
        if (this.multiline) {
            canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), Math.max(getHeight(), f3), (int) (f4 * 255.0f), 31);
        ...
        if (this.closeButton) {
            if (this.closeButtonDrawable == null) {
                Drawable mutate2 = getContext().getResources().getDrawable(C3419R.C3421drawable.msg_mini_close_tooltip).mutate();
    ...
    private void rewindPath(float f, float f2) {
        ...
        if (this.direction == 0) {
            this.path.lineTo(this.bounds.left, this.arrowHalfWidth + clamp + AndroidUtilities.m72dp(2));
            this.path.lineTo(this.bounds.left, this.arrowHalfWidth + clamp);
            this.path.lineTo(this.bounds.left - this.arrowHeight, AndroidUtilities.m72dp(1) + clamp);
            float f9 = this.bounds.left;
            float f10 = this.arrowHeight;
            this.arrowX = f9 - f10;
            this.arrowY = clamp;
            this.path.lineTo(f9 - f10, clamp - AndroidUtilities.m72dp(1));
            this.path.lineTo(this.bounds.left, clamp - this.arrowHalfWidth);
            this.path.lineTo(this.bounds.left, (clamp - this.arrowHalfWidth) - AndroidUtilities.m72dp(2));
        }
        Path path2 = this.path;
        RectF rectF2 = this.bounds;
        path2.lineTo(rectF2.left, rectF2.top);
        if (this.direction == 1) {
            this.path.lineTo((clamp - this.arrowHalfWidth) - AndroidUtilities.m72dp(2), this.bounds.top);
            this.path.lineTo(clamp - this.arrowHalfWidth, this.bounds.top);
            this.path.lineTo(clamp - AndroidUtilities.m72dp(1), this.bounds.top - this.arrowHeight);
            this.arrowX = clamp;
            this.arrowY = this.bounds.top - this.arrowHeight;
            this.path.lineTo(AndroidUtilities.m72dp(1) + clamp, this.bounds.top - this.arrowHeight);
            this.path.lineTo(this.arrowHalfWidth + clamp, this.bounds.top);
            this.path.lineTo(this.arrowHalfWidth + clamp + AndroidUtilities.m72dp(2), this.bounds.top);
        }
        Path path3 = this.path;
        RectF rectF3 = this.bounds;
        path3.lineTo(rectF3.right, rectF3.top);
        if (this.direction == 2) {
            this.path.lineTo(this.bounds.right, (clamp - this.arrowHalfWidth) - AndroidUtilities.m72dp(2));
            this.path.lineTo(this.bounds.right, clamp - this.arrowHalfWidth);
            this.path.lineTo(this.bounds.right + this.arrowHeight, clamp - AndroidUtilities.m72dp(1));
            float f11 = this.bounds.right;
            float f12 = this.arrowHeight;
            this.arrowX = f11 + f12;
            this.arrowY = clamp;
            this.path.lineTo(f11 + f12, AndroidUtilities.m72dp(1) + clamp);
            this.path.lineTo(this.bounds.right, this.arrowHalfWidth + clamp);
            this.path.lineTo(this.bounds.right, this.arrowHalfWidth + clamp + AndroidUtilities.m72dp(2));
        }
        Path path4 = this.path;
        RectF rectF4 = this.bounds;
        path4.lineTo(rectF4.right, rectF4.bottom);
        if (this.direction == 3) {
            this.path.lineTo(this.arrowHalfWidth + clamp + AndroidUtilities.m72dp(2), this.bounds.bottom);
            this.path.lineTo(this.arrowHalfWidth + clamp, this.bounds.bottom);
            this.path.lineTo(AndroidUtilities.m72dp(1) + clamp, this.bounds.bottom + this.arrowHeight);
            this.arrowX = clamp;
            this.arrowY = this.bounds.bottom + this.arrowHeight;
            this.path.lineTo(clamp - AndroidUtilities.m72dp(1), this.bounds.bottom + this.arrowHeight);
            this.path.lineTo(clamp - this.arrowHalfWidth, this.bounds.bottom);
            this.path.lineTo((clamp - this.arrowHalfWidth) - AndroidUtilities.m72dp(2), this.bounds.bottom);
        }
        this.path.close();
        this.pathSet = true;
    }
