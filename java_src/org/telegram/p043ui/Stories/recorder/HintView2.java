...
public class HintView2 extends View {
    ...
    public HintView2(Context context, int i) {
        ...
        this.useAlpha = true;
        this.textMaxWidth = -1;
        this.rounding = AndroidUtilities.m107dp(8);
        this.innerPadding = new RectF(AndroidUtilities.m107dp(11), AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(11), AndroidUtilities.m107dp(7));
        this.closeButtonMargin = AndroidUtilities.m107dp(2);
        this.arrowHalfWidth = AndroidUtilities.m107dp(7);
        this.arrowHeight = AndroidUtilities.m107dp(6);
        ...
        this.iconMargin = AndroidUtilities.m107dp(2);
        this.hideRunnable = new Runnable() { // from class: org.telegram.ui.Stories.recorder.HintView2$$ExternalSyntheticLambda1
    ...
    public HintView2 setRounding(float f) {
        this.rounding = AndroidUtilities.m108dp(f);
    ...
    public HintView2 setMultilineText(boolean z) {
        this.multiline = z;
        if (z) {
            this.innerPadding.set(AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(8));
            this.closeButtonMargin = AndroidUtilities.m107dp(6);
        } else {
            this.innerPadding.set(AndroidUtilities.m107dp(11), AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(this.closeButton ? 15 : 11), AndroidUtilities.m107dp(7));
            this.closeButtonMargin = AndroidUtilities.m107dp(2);
        }
        return this;
    }
    ...
    public HintView2 setTextSize(int i) {
        this.textDrawable.setTextSize(AndroidUtilities.m107dp(i));
        this.textPaint.setTextSize(AndroidUtilities.m107dp(i));
        return this;
    }
    ...
    public HintView2 setMaxWidth(float f) {
        this.textMaxWidth = AndroidUtilities.m108dp(f);
        return this;
    }
    ...
    public HintView2 setIcon(int i) {
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(34), AndroidUtilities.m107dp(34));
    ...
    public static int cutInFancyHalf(CharSequence charSequence, TextPaint textPaint) {
        ...
        while (i < 10) {
            ...
            f4 = measureCorrectly(charSequence.subSequence(0, length), textPaint);
            f2 = measureCorrectly(AndroidUtilities.getTrimmedString(charSequence.subSequence(length, charSequence.length())), textPaint);
            if (f4 != f || f2 != f3) {
                if (f4 < f2) {
                    length++;
                    i2 = 1;
        ...
        return (int) Math.ceil(Math.max(f4, f2));
    }
    ...
    public HintView2 setInnerPadding(int i, int i2, int i3, int i4) {
        this.innerPadding.set(AndroidUtilities.m107dp(i), AndroidUtilities.m107dp(i2), AndroidUtilities.m107dp(i3), AndroidUtilities.m107dp(i4));
        return this;
    }

    public HintView2 setIconMargin(int i) {
        this.iconMargin = AndroidUtilities.m107dp(i);
        return this;
    }
    ...
    public HintView2 setJoint(float f, float f2) {
        if (Math.abs(this.joint - f) >= 1.0f || Math.abs(this.jointTranslate - AndroidUtilities.m108dp(f2)) >= 1.0f) {
            this.pathSet = false;
            invalidate();
        }
        this.joint = f;
        this.jointTranslate = AndroidUtilities.m108dp(f2);
        return this;
    }
    ...
    private void bounceShow() {
        if (this.repeatedBounce) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.recorder.HintView2$$ExternalSyntheticLambda0
    ...
    private void makeLayout(CharSequence charSequence, int i) {
        ...
        this.textLayoutWidth = Math.max((float) BitmapDescriptorFactory.HUE_RED, f2 - f);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.bounceT != 1.0f) {
            ...
            if (i == 3 || i == 1) {
                canvas.translate(BitmapDescriptorFactory.HUE_RED, (this.bounceT - 1.0f) * Math.max(i == 3 ? getPaddingBottom() : getPaddingTop(), AndroidUtilities.m107dp(24)) * (this.direction == 1 ? -1 : 1));
            } else {
                canvas.translate((this.bounceT - 1.0f) * Math.max(i == 0 ? getPaddingLeft() : getPaddingRight(), AndroidUtilities.m107dp(24)) * (this.direction == 0 ? -1 : 1), BitmapDescriptorFactory.HUE_RED);
            }
        }
        ...
        if (drawable2 != null) {
            if (this.iconLeft) {
                ...
                f2 = BitmapDescriptorFactory.HUE_RED + this.iconWidth + this.iconMargin;
            } else {
        ...
        if (this.multiline) {
            canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), Math.max(getHeight(), f5), (int) (f6 * 255.0f), 31);
    ...
    private void rewindPath(float f, float f2) {
        ...
        if (this.direction == 0) {
            this.path.lineTo(this.bounds.left, this.arrowHalfWidth + clamp + AndroidUtilities.m107dp(2));
            this.path.lineTo(this.bounds.left, this.arrowHalfWidth + clamp);
            this.path.lineTo(this.bounds.left - this.arrowHeight, AndroidUtilities.m107dp(1) + clamp);
            float f9 = this.bounds.left;
            float f10 = this.arrowHeight;
            this.arrowX = f9 - f10;
            this.arrowY = clamp;
            this.path.lineTo(f9 - f10, clamp - AndroidUtilities.m107dp(1));
            this.path.lineTo(this.bounds.left, clamp - this.arrowHalfWidth);
            this.path.lineTo(this.bounds.left, (clamp - this.arrowHalfWidth) - AndroidUtilities.m107dp(2));
        ...
        if (this.direction == 1) {
            this.path.lineTo((clamp - this.arrowHalfWidth) - AndroidUtilities.m107dp(2), this.bounds.top);
            this.path.lineTo(clamp - this.arrowHalfWidth, this.bounds.top);
            this.path.lineTo(clamp - AndroidUtilities.m107dp(1), this.bounds.top - this.arrowHeight);
            this.arrowX = clamp;
            this.arrowY = this.bounds.top - this.arrowHeight;
            this.path.lineTo(AndroidUtilities.m107dp(1) + clamp, this.bounds.top - this.arrowHeight);
            this.path.lineTo(this.arrowHalfWidth + clamp, this.bounds.top);
            this.path.lineTo(this.arrowHalfWidth + clamp + AndroidUtilities.m107dp(2), this.bounds.top);
        ...
        if (this.direction == 2) {
            this.path.lineTo(this.bounds.right, (clamp - this.arrowHalfWidth) - AndroidUtilities.m107dp(2));
            this.path.lineTo(this.bounds.right, clamp - this.arrowHalfWidth);
            this.path.lineTo(this.bounds.right + this.arrowHeight, clamp - AndroidUtilities.m107dp(1));
            float f11 = this.bounds.right;
            float f12 = this.arrowHeight;
            this.arrowX = f11 + f12;
            this.arrowY = clamp;
            this.path.lineTo(f11 + f12, AndroidUtilities.m107dp(1) + clamp);
            this.path.lineTo(this.bounds.right, this.arrowHalfWidth + clamp);
            this.path.lineTo(this.bounds.right, this.arrowHalfWidth + clamp + AndroidUtilities.m107dp(2));
        ...
        if (this.direction == 3) {
            this.path.lineTo(this.arrowHalfWidth + clamp + AndroidUtilities.m107dp(2), this.bounds.bottom);
            this.path.lineTo(this.arrowHalfWidth + clamp, this.bounds.bottom);
            this.path.lineTo(AndroidUtilities.m107dp(1) + clamp, this.bounds.bottom + this.arrowHeight);
            this.arrowX = clamp;
            this.arrowY = this.bounds.bottom + this.arrowHeight;
            this.path.lineTo(clamp - AndroidUtilities.m107dp(1), this.bounds.bottom + this.arrowHeight);
            this.path.lineTo(clamp - this.arrowHalfWidth, this.bounds.bottom);
            this.path.lineTo((clamp - this.arrowHalfWidth) - AndroidUtilities.m107dp(2), this.bounds.bottom);
    ...
    private boolean checkTouchLinks(MotionEvent motionEvent) {
        if (this.textLayout != null) {
            ...
            if (hitLink != null && motionEvent.getAction() == 0) {
                ...
                obtainNewPath.setCurrentLayout(this.textLayout, spanStart, BitmapDescriptorFactory.HUE_RED);
