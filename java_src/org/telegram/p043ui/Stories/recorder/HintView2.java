...
public class HintView2 extends View {
    ...
    public static int cutInFancyHalf(CharSequence charSequence, TextPaint textPaint) {
        ...
        while (i < 10) {
            ...
            f4 = textPaint.measureText(charSequence.subSequence(0, length).toString());
            f2 = textPaint.measureText(charSequence.subSequence(length, charSequence.length()).toString().trim());
            if (f4 != f || f2 != f3) {
