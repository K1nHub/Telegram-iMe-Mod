...
public class HintView2 extends View {
    ...
    public HintView2(Context context, int i) {
        ...
        this.useAlpha = true;
        this.textMaxWidth = -1;
        this.rounding = AndroidUtilities.m104dp(8);
        this.innerPadding = new RectF(AndroidUtilities.m104dp(11), AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(11), AndroidUtilities.m104dp(7));
        this.closeButtonMargin = AndroidUtilities.m104dp(2);
        this.arrowHalfWidth = AndroidUtilities.m104dp(7);
        this.arrowHeight = AndroidUtilities.m104dp(6);
        ...
        this.iconMargin = AndroidUtilities.m104dp(2);
    ...
    public HintView2 setRounding(float f) {
        this.rounding = AndroidUtilities.m105dp(f);
    ...
    public HintView2 setMultilineText(boolean z) {
        this.multiline = z;
        if (z) {
            this.innerPadding.set(AndroidUtilities.m104dp(15), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(15), AndroidUtilities.m104dp(8));
            this.closeButtonMargin = AndroidUtilities.m104dp(6);
        } else {
            this.innerPadding.set(AndroidUtilities.m104dp(11), AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(this.closeButton ? 15 : 11), AndroidUtilities.m104dp(7));
            this.closeButtonMargin = AndroidUtilities.m104dp(2);
        }
        return this;
    }
    ...
    public HintView2 setTextSize(int i) {
        this.textDrawable.setTextSize(AndroidUtilities.m104dp(i));
        this.textPaint.setTextSize(AndroidUtilities.m104dp(i));
        return this;
    }
    ...
    public HintView2 setMaxWidth(float f) {
        this.textMaxWidth = AndroidUtilities.m105dp(f);
        return this;
    }
    ...
    public static int cutInFancyHalf(CharSequence charSequence, TextPaint textPaint) {
        ...
        while (i < 10) {
            ...
            f4 = measureCorrectly(charSequence.subSequence(0, length).toString(), textPaint);
            f2 = measureCorrectly(charSequence.subSequence(length, charSequence.length()).toString().trim(), textPaint);
            if (f4 != f || f2 != f3) {
                length = f4 < f2 ? length + 1 : length - 1;
    ...
    public HintView2 setInnerPadding(int i, int i2, int i3, int i4) {
        this.innerPadding.set(AndroidUtilities.m104dp(i), AndroidUtilities.m104dp(i2), AndroidUtilities.m104dp(i3), AndroidUtilities.m104dp(i4));
        return this;
    }

    public HintView2 setIconMargin(int i) {
        this.iconMargin = AndroidUtilities.m104dp(i);
        return this;
    }
    ...
    public HintView2 setJoint(float f, float f2) {
        if (Math.abs(this.joint - f) >= 1.0f || Math.abs(this.jointTranslate - AndroidUtilities.m105dp(f2)) >= 1.0f) {
            this.pathSet = false;
            invalidate();
        }
        this.joint = f;
        this.jointTranslate = AndroidUtilities.m105dp(f2);
        return this;
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.bounceT != 1.0f) {
            ...
            if (i == 3 || i == 1) {
                canvas.translate(BitmapDescriptorFactory.HUE_RED, (this.bounceT - 1.0f) * Math.max(i == 3 ? getPaddingBottom() : getPaddingTop(), AndroidUtilities.m104dp(24)) * (this.direction == 1 ? -1 : 1));
            } else {
                canvas.translate((this.bounceT - 1.0f) * Math.max(i == 0 ? getPaddingLeft() : getPaddingRight(), AndroidUtilities.m104dp(24)) * (this.direction == 0 ? -1 : 1), BitmapDescriptorFactory.HUE_RED);
            }
        }
    ...
    private void rewindPath(float f, float f2) {
        ...
        if (this.direction == 0) {
            this.path.lineTo(this.bounds.left, this.arrowHalfWidth + clamp + AndroidUtilities.m104dp(2));
            this.path.lineTo(this.bounds.left, this.arrowHalfWidth + clamp);
            this.path.lineTo(this.bounds.left - this.arrowHeight, AndroidUtilities.m104dp(1) + clamp);
            float f9 = this.bounds.left;
            float f10 = this.arrowHeight;
            this.arrowX = f9 - f10;
            this.arrowY = clamp;
            this.path.lineTo(f9 - f10, clamp - AndroidUtilities.m104dp(1));
            this.path.lineTo(this.bounds.left, clamp - this.arrowHalfWidth);
            this.path.lineTo(this.bounds.left, (clamp - this.arrowHalfWidth) - AndroidUtilities.m104dp(2));
        ...
        if (this.direction == 1) {
            this.path.lineTo((clamp - this.arrowHalfWidth) - AndroidUtilities.m104dp(2), this.bounds.top);
            this.path.lineTo(clamp - this.arrowHalfWidth, this.bounds.top);
            this.path.lineTo(clamp - AndroidUtilities.m104dp(1), this.bounds.top - this.arrowHeight);
            this.arrowX = clamp;
            this.arrowY = this.bounds.top - this.arrowHeight;
            this.path.lineTo(AndroidUtilities.m104dp(1) + clamp, this.bounds.top - this.arrowHeight);
            this.path.lineTo(this.arrowHalfWidth + clamp, this.bounds.top);
            this.path.lineTo(this.arrowHalfWidth + clamp + AndroidUtilities.m104dp(2), this.bounds.top);
        ...
        if (this.direction == 2) {
            this.path.lineTo(this.bounds.right, (clamp - this.arrowHalfWidth) - AndroidUtilities.m104dp(2));
            this.path.lineTo(this.bounds.right, clamp - this.arrowHalfWidth);
            this.path.lineTo(this.bounds.right + this.arrowHeight, clamp - AndroidUtilities.m104dp(1));
            float f11 = this.bounds.right;
            float f12 = this.arrowHeight;
            this.arrowX = f11 + f12;
            this.arrowY = clamp;
            this.path.lineTo(f11 + f12, AndroidUtilities.m104dp(1) + clamp);
            this.path.lineTo(this.bounds.right, this.arrowHalfWidth + clamp);
            this.path.lineTo(this.bounds.right, this.arrowHalfWidth + clamp + AndroidUtilities.m104dp(2));
        ...
        if (this.direction == 3) {
            this.path.lineTo(this.arrowHalfWidth + clamp + AndroidUtilities.m104dp(2), this.bounds.bottom);
            this.path.lineTo(this.arrowHalfWidth + clamp, this.bounds.bottom);
            this.path.lineTo(AndroidUtilities.m104dp(1) + clamp, this.bounds.bottom + this.arrowHeight);
            this.arrowX = clamp;
            this.arrowY = this.bounds.bottom + this.arrowHeight;
            this.path.lineTo(clamp - AndroidUtilities.m104dp(1), this.bounds.bottom + this.arrowHeight);
            this.path.lineTo(clamp - this.arrowHalfWidth, this.bounds.bottom);
            this.path.lineTo((clamp - this.arrowHalfWidth) - AndroidUtilities.m104dp(2), this.bounds.bottom);
