...
public class PhotoVideoSwitcherView extends View implements FlashViews.Invertable {
    ...
    public PhotoVideoSwitcherView(Context context) {
        ...
        this.scrollWidth = AndroidUtilities.m104dp(32) + (this.photoTextWidth / 2.0f) + (this.videoTextWidth / 2.0f);
    ...
    private float getScrollCx() {
        return (getWidth() / 2.0f) + AndroidUtilities.lerp(AndroidUtilities.m104dp(16) + (this.photoTextWidth / 2.0f), -(AndroidUtilities.m104dp(16) + (this.videoTextWidth / 2.0f)), this.mode);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        float m104dp2 = (scrollCx - AndroidUtilities.m104dp(28)) - this.photoTextWidth;
        float f = m104dp / 2.0f;
        float f2 = -AndroidUtilities.m104dp(1);
        float f3 = (height - f) + f2;
        float f4 = height + f + f2;
        rectF.set(m104dp2, f3, scrollCx - AndroidUtilities.m104dp(4), f4);
        this.videoRect.set(AndroidUtilities.m104dp(4) + scrollCx, f3, AndroidUtilities.m104dp(28) + scrollCx + this.videoTextWidth, f4);
        ...
        canvas.save();
        canvas.translate(((scrollCx - AndroidUtilities.m104dp(16)) - this.photoTextWidth) - this.photoTextLeft, (height - (this.photoTextHeight / 2.0f)) + f2);
        this.photoText.draw(canvas);
        canvas.restore();
        canvas.save();
        canvas.translate((scrollCx + AndroidUtilities.m104dp(16)) - this.videoTextLeft, (height - (this.videoTextHeight / 2.0f)) + f2);
