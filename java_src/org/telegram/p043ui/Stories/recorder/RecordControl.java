...
public class RecordControl extends View {
    ...
    /* renamed from: cx */
    private float f1907cx;

    /* renamed from: cy */
    private float f1908cy;
    ...
    /* renamed from: h1 */
    private final Point f1909h1;

    /* renamed from: h2 */
    private final Point f1910h2;

    /* renamed from: h3 */
    private final Point f1911h3;

    /* renamed from: h4 */
    private final Point f1912h4;
    ...
    /* renamed from: p1 */
    private final Point f1913p1;

    /* renamed from: p2 */
    private final Point f1914p2;

    /* renamed from: p3 */
    private final Point f1915p3;

    /* renamed from: p4 */
    private final Point f1916p4;
    ...
    public RecordControl(Context context) {
        ...
        this.f1913p1 = new Point();
        this.f1914p2 = new Point();
        this.f1915p3 = new Point();
        this.f1916p4 = new Point();
        this.f1909h1 = new Point();
        this.f1910h2 = new Point();
        this.f1911h3 = new Point();
        this.f1912h4 = new Point();
        ...
        int i = C3473R.C3475drawable.msg_photo_switch2;
        ...
        Drawable mutate4 = context.getResources().getDrawable(C3473R.C3475drawable.msg_filled_unlockedrecord).mutate();
        this.unlockDrawable = mutate4;
        mutate4.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.MULTIPLY));
        Drawable mutate5 = context.getResources().getDrawable(C3473R.C3475drawable.msg_filled_lockedrecord).mutate();
        this.lockDrawable = mutate5;
        mutate5.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        Drawable mutate6 = context.getResources().getDrawable(C3473R.C3475drawable.msg_round_pause_m).mutate();
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float f = size;
        this.f1907cx = f / 2.0f;
        this.f1908cy = m72dp / 2.0f;
        float min = Math.min(AndroidUtilities.m72dp((int) TsExtractor.TS_STREAM_TYPE_E_AC3), f * 0.35f);
        float f2 = this.f1907cx;
        this.leftCx = f2 - min;
        float f3 = f2 + min;
        this.rightCx = f3;
        setDrawableBounds(this.flipDrawableWhite, f3, this.f1908cy, AndroidUtilities.m72dp(14));
        setDrawableBounds(this.flipDrawableBlack, this.rightCx, this.f1908cy, AndroidUtilities.m72dp(14));
        setDrawableBounds(this.unlockDrawable, this.leftCx, this.f1908cy);
        setDrawableBounds(this.lockDrawable, this.leftCx, this.f1908cy);
        setDrawableBounds(this.pauseDrawable, this.leftCx, this.f1908cy);
        this.galleryImage.setImageCoords(this.leftCx - AndroidUtilities.m72dp(20), this.f1908cy - AndroidUtilities.m72dp(20), AndroidUtilities.m72dp(40), AndroidUtilities.m72dp(40));
        this.redMatrix.reset();
        this.redMatrix.postTranslate(this.f1907cx, this.f1908cy);
    ...
    */
    ...
    private void getVector(float f, float f2, double d, float f3, Point point) {
        double d2 = f3;
        point.f1806x = (float) (f + (Math.cos(d) * d2));
        point.f1807y = (float) (f2 + (Math.sin(d) * d2));
    }

    private float dist(Point point, Point point2) {
        return MathUtils.distance(point.f1806x, point.f1807y, point2.f1806x, point2.f1807y);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean isPressed = isPressed(clamp, y, this.rightCx, this.f1908cy, AndroidUtilities.m72dp(7), true);
        boolean z = false;
        if (this.recordingLoading) {
            ...
            this.recordButton.setPressed(isPressed(clamp, y, this.f1907cx, this.f1908cy, AndroidUtilities.m72dp(60), false));
            this.flipButton.setPressed(isPressed(clamp, y, this.rightCx, this.f1908cy, AndroidUtilities.m72dp(30), true));
            this.lockButton.setPressed(isPressed(clamp, y, this.leftCx, this.f1908cy, AndroidUtilities.m72dp(30), false));
        }
        if (action == 0) {
            this.touch = true;
            ...
            this.touchX = clamp;
            if (Math.abs(clamp - this.f1907cx) < AndroidUtilities.m72dp(50)) {
            ...
            if (this.recording && this.longpressRecording) {
                this.delegate.onZoom(Utilities.clamp(((this.f1908cy - AndroidUtilities.m72dp(48)) - y) / (AndroidUtilities.displaySize.y / 2.0f), 1.0f, (float) BitmapDescriptorFactory.HUE_RED));
            }
        } else {
