...
public class RecordControl extends View implements FlashViews.Invertable {
    ...
    /* renamed from: cx */
    private float f2021cx;

    /* renamed from: cy */
    private float f2022cy;
    ...
    /* renamed from: h1 */
    private final Point f2023h1;

    /* renamed from: h2 */
    private final Point f2024h2;

    /* renamed from: h3 */
    private final Point f2025h3;

    /* renamed from: h4 */
    private final Point f2026h4;
    ...
    /* renamed from: p1 */
    private final Point f2027p1;

    /* renamed from: p2 */
    private final Point f2028p2;

    /* renamed from: p3 */
    private final Point f2029p3;

    /* renamed from: p4 */
    private final Point f2030p4;
    ...
    public RecordControl(Context context) {
        ...
        this.f2027p1 = new Point();
        this.f2028p2 = new Point();
        this.f2029p3 = new Point();
        this.f2030p4 = new Point();
        this.f2023h1 = new Point();
        this.f2024h2 = new Point();
        this.f2025h3 = new Point();
        this.f2026h4 = new Point();
        setWillNotDraw(false);
        RadialGradient radialGradient = new RadialGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(48), new int[]{-577231, -577231, -1}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.64f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(6), -13750737), mutate);
    ...
    public void setInvert(float f) {
        ...
        this.hintLinePaintBlack.setColor(ColorUtils.blendARGB(402653184, C0483C.ENCODING_PCM_32BIT, f));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float f = size;
        this.f2021cx = f / 2.0f;
        this.f2022cy = m107dp / 2.0f;
        float min = Math.min(AndroidUtilities.m107dp((int) TsExtractor.TS_STREAM_TYPE_E_AC3), f * 0.35f);
        float f2 = this.f2021cx;
        this.leftCx = f2 - min;
        float f3 = f2 + min;
        this.rightCx = f3;
        setDrawableBounds(this.flipDrawableWhite, f3, this.f2022cy, AndroidUtilities.m107dp(14));
        setDrawableBounds(this.flipDrawableBlack, this.rightCx, this.f2022cy, AndroidUtilities.m107dp(14));
        setDrawableBounds(this.unlockDrawable, this.leftCx, this.f2022cy);
        setDrawableBounds(this.lockDrawable, this.leftCx, this.f2022cy);
        setDrawableBounds(this.pauseDrawable, this.leftCx, this.f2022cy);
        this.galleryImage.setImageCoords(this.leftCx - AndroidUtilities.m107dp(20), this.f2022cy - AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(40), AndroidUtilities.m107dp(40));
        this.redMatrix.reset();
        this.redMatrix.postTranslate(this.f2021cx, this.f2022cy);
    ...
    /* JADX WARN: Removed duplicated region for block: B:121:0x067e  */
    ...
    */
    ...
    private void getVector(float f, float f2, double d, float f3, Point point) {
        double d2 = f3;
        point.f1899x = (float) (f + (Math.cos(d) * d2));
        point.f1900y = (float) (f2 + (Math.sin(d) * d2));
    }

    private float dist(Point point, Point point2) {
        return MathUtils.distance(point.f1899x, point.f1900y, point2.f1899x, point2.f1900y);
    }
    ...
    private boolean isPressed(float f, float f2, float f3, float f4, float f5, boolean z) {
        return this.recording ? (!z || f4 - f2 <= ((float) AndroidUtilities.m107dp(100))) && Math.abs(f3 - f) <= f5 : MathUtils.distance(f, f2, f3, f4) <= f5;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean isPressed = isPressed(clamp, y, this.rightCx, this.f2022cy, AndroidUtilities.m107dp(7), true);
        boolean z = false;
        if (this.recordingLoading) {
            ...
            this.recordButton.setPressed(isPressed(clamp, y, this.f2021cx, this.f2022cy, AndroidUtilities.m107dp(60), false));
            this.flipButton.setPressed(isPressed(clamp, y, this.rightCx, this.f2022cy, AndroidUtilities.m107dp(30), true));
            this.lockButton.setPressed(isPressed(clamp, y, this.leftCx, this.f2022cy, AndroidUtilities.m107dp(30), false));
        }
        if (action == 0) {
            this.touch = true;
            ...
            this.touchX = clamp;
            if (Math.abs(clamp - this.f2021cx) < AndroidUtilities.m107dp(50)) {
            ...
            if (this.recording && this.longpressRecording) {
                this.delegate.onZoom(Utilities.clamp(((this.f2022cy - AndroidUtilities.m107dp(48)) - y) / (AndroidUtilities.displaySize.y / 2.0f), 1.0f, (float) BitmapDescriptorFactory.HUE_RED));
            }
        } else {
