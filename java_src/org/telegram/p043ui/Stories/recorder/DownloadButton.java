...
public class DownloadButton extends ImageView {
        ...
        if (this.preparing) {
            ...
            if (this.currentEntry.wouldBeVideo()) {
                ...
                if (generatePicturePath == null) {
                    this.toast.setDone(C3419R.raw.error, LocaleController.getString("UnknownError"), 3500);
                    this.downloading = false;
                    updateImage();
                    return;
                }
    ...
    public /* synthetic */ void lambda$onClickInternal$2(Uri uri) {
        ...
        this.toast.setDone(C3419R.raw.ic_save_to_gallery, LocaleController.getString("VideoSavedHint"), 3500);
        this.downloading = false;
        updateImage();
    ...
    public /* synthetic */ void lambda$onClickInternal$5() {
        ...
        this.toast.setDone(C3419R.raw.error, LocaleController.getString("VideoConvertFail"), 3500);
        this.downloading = false;
        updateImage();
    }
    ...
    public /* synthetic */ void lambda$onClickInternal$6(Uri uri) {
        ...
        PreparingVideoToast preparingVideoToast2 = new PreparingVideoToast(getContext());
        this.toast = preparingVideoToast2;
        preparingVideoToast2.setDone(C3419R.raw.ic_save_to_gallery, LocaleController.getString("PhotoSavedHint"), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_MS);
        this.container.addView(this.toast);
        this.savedToGalleryUri = uri;
    }
    ...
    private void updateImage() {
        ...
        if (z != (z2 && !this.downloadingVideo)) {
            ...
            if (z4) {
                ...
                AndroidUtilities.updateImageViewImageAnimated(this, C3419R.C3421drawable.media_download);
            }
        }
    ...
    public void showFailedVideo() {
        showToast(C3419R.raw.error, LocaleController.getString("VideoConvertFail"));
    }
    ...
    public static class PreparingVideoToast extends View {
        ...
        /* renamed from: t */
        private final AnimatedFloat f1882t;
        ...
        public PreparingVideoToast(Context context) {
            ...
            this.f1882t = new AnimatedFloat(this);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float f2 = this.f1882t.set(this.preparing ? 0.0f : 1.0f);
            float f3 = 1.0f - f2;
