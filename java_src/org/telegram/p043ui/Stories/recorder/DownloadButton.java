...
public class DownloadButton extends ImageView {
    ...
    public DownloadButton(Context context, Utilities.Callback<Runnable> callback, int i, FrameLayout frameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.progressDrawable = new CircularProgressDrawable(AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(2), -1);
        updateImage();
    }
    ...
    public static class PreparingVideoToast extends View {
        ...
        public PreparingVideoToast(Context context) {
            ...
            paint3.setStrokeWidth(AndroidUtilities.m104dp(4));
            paint4.setStyle(Paint.Style.STROKE);
            paint4.setStrokeCap(Paint.Cap.ROUND);
            paint4.setStrokeWidth(AndroidUtilities.m104dp(4));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float max = Math.max(this.preparingLayoutWidth, AndroidUtilities.m104dp(54)) + AndroidUtilities.m104dp(42);
            float m104dp = AndroidUtilities.m104dp(111) + this.preparingLayout.getHeight();
            this.prepareRect.set((getWidth() - max) / 2.0f, (getHeight() - m104dp) / 2.0f, (getWidth() + max) / 2.0f, (getHeight() + m104dp) / 2.0f);
            float m104dp2 = AndroidUtilities.m104dp(74) + this.doneLayoutWidth;
            float m104dp3 = AndroidUtilities.m104dp(48);
            this.toastRect.set((getWidth() - m104dp2) / 2.0f, (getHeight() - m104dp3) / 2.0f, (getWidth() + m104dp2) / 2.0f, (getHeight() + m104dp3) / 2.0f);
            ...
            canvas.drawRoundRect(this.currentRect, AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10), this.backgroundPaint);
            canvas.save();
        ...
        private void drawPreparing(Canvas canvas, float f) {
            ...
            float m104dp = this.prepareRect.top + AndroidUtilities.m104dp(48);
            float m104dp2 = AndroidUtilities.m104dp(25);
            this.greyPaint.setAlpha((int) (51.0f * f));
            canvas.drawCircle(centerX, m104dp, m104dp2, this.greyPaint);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(centerX - m104dp2, m104dp - m104dp2, centerX + m104dp2, m104dp2 + m104dp);
            int i = (int) (f * 255.0f);
            this.whitePaint.setAlpha(i);
            this.whitePaint.setStrokeWidth(AndroidUtilities.m104dp(4));
            canvas.drawArc(rectF, -90.0f, f2 * 360.0f, false, this.whitePaint);
            float scale = this.cancelButton.getScale(0.15f);
            canvas.save();
            canvas.scale(scale, scale, centerX, m104dp);
            this.whitePaint.setStrokeWidth(AndroidUtilities.m105dp(3.4f));
            canvas.drawLine(centerX - AndroidUtilities.m104dp(7), m104dp - AndroidUtilities.m104dp(7), centerX + AndroidUtilities.m104dp(7), m104dp + AndroidUtilities.m104dp(7), this.whitePaint);
            canvas.drawLine(centerX - AndroidUtilities.m104dp(7), m104dp + AndroidUtilities.m104dp(7), centerX + AndroidUtilities.m104dp(7), m104dp - AndroidUtilities.m104dp(7), this.whitePaint);
            canvas.restore();
            canvas.save();
            canvas.translate((this.prepareRect.left + AndroidUtilities.m104dp(21)) - this.preparingLayoutLeft, (this.prepareRect.bottom - AndroidUtilities.m104dp(18)) - this.preparingLayout.getHeight());
        ...
        private void drawToast(Canvas canvas, float f) {
            ...
            if (rLottieDrawable != null) {
                ...
                this.lottieDrawable.setBounds((int) (this.toastRect.left + AndroidUtilities.m104dp(9)), (int) (this.toastRect.top + AndroidUtilities.m104dp(6)), (int) (this.toastRect.left + AndroidUtilities.m104dp(45)), (int) (this.toastRect.top + AndroidUtilities.m104dp(42)));
                this.lottieDrawable.draw(canvas);
            }
            if (this.doneLayout != null) {
                canvas.save();
                canvas.translate((this.toastRect.left + AndroidUtilities.m104dp(52)) - this.doneLayoutLeft, this.toastRect.centerY() - (this.doneLayout.getHeight() / 2.0f));
        ...
        public void setDone(int i, CharSequence charSequence, int i2) {
            ...
            RLottieDrawable rLottieDrawable2 = new RLottieDrawable(i, "" + i, AndroidUtilities.m104dp(36), AndroidUtilities.m104dp(36));
