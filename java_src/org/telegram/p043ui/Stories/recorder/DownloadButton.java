...
public class DownloadButton extends ImageView {
    ...
    public DownloadButton(Context context, Utilities.Callback<Runnable> callback, int i, FrameLayout frameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.progressDrawable = new CircularProgressDrawable(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(2), -1);
        updateImage();
    }
    ...
    public static class PreparingVideoToast extends View {
        ...
        /* renamed from: t */
        private final AnimatedFloat f2005t;
        ...
        public PreparingVideoToast(Context context) {
            ...
            this.f2005t = new AnimatedFloat(this);
            ...
            paint3.setStrokeWidth(AndroidUtilities.m107dp(4));
            paint4.setStyle(Paint.Style.STROKE);
            paint4.setStrokeCap(Paint.Cap.ROUND);
            paint4.setStrokeWidth(AndroidUtilities.m107dp(4));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float f2 = this.f2005t.set(this.preparing ? 0.0f : 1.0f);
            float f3 = 1.0f - f2;
            ...
            float max = Math.max(this.preparingLayoutWidth, AndroidUtilities.m107dp(54)) + AndroidUtilities.m107dp(42);
            float m107dp = AndroidUtilities.m107dp(111) + this.preparingLayout.getHeight();
            this.prepareRect.set((getWidth() - max) / 2.0f, (getHeight() - m107dp) / 2.0f, (getWidth() + max) / 2.0f, (getHeight() + m107dp) / 2.0f);
            float m107dp2 = AndroidUtilities.m107dp(74) + this.doneLayoutWidth;
            float m107dp3 = AndroidUtilities.m107dp(48);
            this.toastRect.set((getWidth() - m107dp2) / 2.0f, (getHeight() - m107dp3) / 2.0f, (getWidth() + m107dp2) / 2.0f, (getHeight() + m107dp3) / 2.0f);
            ...
            canvas.drawRoundRect(this.currentRect, AndroidUtilities.m107dp(10), AndroidUtilities.m107dp(10), this.backgroundPaint);
            canvas.save();
        ...
        private void drawPreparing(Canvas canvas, float f) {
            ...
            float m107dp = this.prepareRect.top + AndroidUtilities.m107dp(48);
            float m107dp2 = AndroidUtilities.m107dp(25);
            this.greyPaint.setAlpha((int) (51.0f * f));
            canvas.drawCircle(centerX, m107dp, m107dp2, this.greyPaint);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(centerX - m107dp2, m107dp - m107dp2, centerX + m107dp2, m107dp2 + m107dp);
            int i = (int) (f * 255.0f);
            this.whitePaint.setAlpha(i);
            this.whitePaint.setStrokeWidth(AndroidUtilities.m107dp(4));
            canvas.drawArc(rectF, -90.0f, f2 * 360.0f, false, this.whitePaint);
            float scale = this.cancelButton.getScale(0.15f);
            canvas.save();
            canvas.scale(scale, scale, centerX, m107dp);
            this.whitePaint.setStrokeWidth(AndroidUtilities.m108dp(3.4f));
            canvas.drawLine(centerX - AndroidUtilities.m107dp(7), m107dp - AndroidUtilities.m107dp(7), centerX + AndroidUtilities.m107dp(7), m107dp + AndroidUtilities.m107dp(7), this.whitePaint);
            canvas.drawLine(centerX - AndroidUtilities.m107dp(7), m107dp + AndroidUtilities.m107dp(7), centerX + AndroidUtilities.m107dp(7), m107dp - AndroidUtilities.m107dp(7), this.whitePaint);
            canvas.restore();
            canvas.save();
            canvas.translate((this.prepareRect.left + AndroidUtilities.m107dp(21)) - this.preparingLayoutLeft, (this.prepareRect.bottom - AndroidUtilities.m107dp(18)) - this.preparingLayout.getHeight());
        ...
        private void drawToast(Canvas canvas, float f) {
            ...
            if (rLottieDrawable != null) {
                ...
                this.lottieDrawable.setBounds((int) (this.toastRect.left + AndroidUtilities.m107dp(9)), (int) (this.toastRect.top + AndroidUtilities.m107dp(6)), (int) (this.toastRect.left + AndroidUtilities.m107dp(45)), (int) (this.toastRect.top + AndroidUtilities.m107dp(42)));
                this.lottieDrawable.draw(canvas);
            }
            if (this.doneLayout != null) {
                canvas.save();
                canvas.translate((this.toastRect.left + AndroidUtilities.m107dp(52)) - this.doneLayoutLeft, this.toastRect.centerY() - (this.doneLayout.getHeight() / 2.0f));
        ...
        public void setDone(int i, CharSequence charSequence, int i2) {
            ...
            RLottieDrawable rLottieDrawable2 = new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(36), AndroidUtilities.m107dp(36));
