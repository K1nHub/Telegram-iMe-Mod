...
public class VideoTimeView extends View {
    ...
    public VideoTimeView(Context context) {
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m107dp(13));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(25), 1073741824));
    }
    ...
    public void show(boolean z, boolean z2) {
        ...
        if (z2) {
            ViewPropertyAnimator translationY = animate().translationY(z ? 0.0f : AndroidUtilities.m107dp(6));
            if (z) {
                f = 1.0f;
            }
        ...
        setTranslationY(z ? 0.0f : AndroidUtilities.m107dp(6));
    ...
    public void onDraw(Canvas canvas) {
        ...
        rectF.set(((getWidth() - currentWidth) / 2.0f) - AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(2), ((getWidth() + currentWidth) / 2.0f) + AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(23));
        canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(5), this.backgroundPaint);
        this.textDrawable.setBounds((int) rectF.left, ((int) rectF.top) - AndroidUtilities.m107dp(1), (int) rectF.right, (int) rectF.bottom);
