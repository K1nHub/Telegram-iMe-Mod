...
public class DraftSavedHint extends View {
    ...
    public DraftSavedHint(Context context) {
        ...
        paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m107dp(6)));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(BitmapDescriptorFactory.HUE_RED, (this.shown ? CubicBezierInterpolator.EASE_OUT_BACK.getInterpolation(f) : 1.0f) * AndroidUtilities.m107dp(12));
        float interpolation = CubicBezierInterpolator.EASE_OUT_QUINT.getInterpolation(f);
        float measuredWidth = getMeasuredWidth();
        float measuredHeight = getMeasuredHeight();
        float m107dp = AndroidUtilities.m107dp(22) + this.layoutWidth;
        float min = (measuredWidth / 2.0f) - Math.min(AndroidUtilities.m107dp((int) TsExtractor.TS_STREAM_TYPE_E_AC3), 0.35f * measuredWidth);
        float max = Math.max(AndroidUtilities.m107dp(8), min - (m107dp / 2.0f));
        this.path.rewind();
        this.path.moveTo(max, BitmapDescriptorFactory.HUE_RED);
        float f2 = m107dp + max;
        this.path.lineTo(f2, BitmapDescriptorFactory.HUE_RED);
        this.path.lineTo(f2, measuredHeight - AndroidUtilities.m107dp(18));
        this.path.lineTo(AndroidUtilities.m107dp(7) + min, measuredHeight - AndroidUtilities.m107dp(18));
        this.path.lineTo(AndroidUtilities.m107dp(1) + min, measuredHeight - AndroidUtilities.m107dp(12));
        this.path.lineTo(min - AndroidUtilities.m107dp(1), measuredHeight - AndroidUtilities.m107dp(12));
        this.path.lineTo(min - AndroidUtilities.m107dp(7), measuredHeight - AndroidUtilities.m107dp(18));
        this.path.lineTo(max, measuredHeight - AndroidUtilities.m107dp(18));
        this.path.close();
        this.backgroundPaint.setAlpha((int) (204.0f * interpolation));
        canvas.drawPath(this.path, this.backgroundPaint);
        canvas.save();
        canvas.translate((max + AndroidUtilities.m107dp(11)) - this.layoutLeft, ((measuredHeight - AndroidUtilities.m107dp(18)) - this.layout.getHeight()) / 2.0f);
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(50));
    }
}
