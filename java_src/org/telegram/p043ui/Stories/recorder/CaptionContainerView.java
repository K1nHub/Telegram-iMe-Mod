...
public class CaptionContainerView extends FrameLayout {
    ...
    public static final int[] periodDrawables = {C3419R.C3421drawable.msg_story_6h, C3419R.C3421drawable.msg_story_12h, C3419R.C3421drawable.msg_story_24h, C3419R.C3421drawable.msg_story_48h};
    ...
    public CaptionContainerView(Context context, final int i, final StoryRecorder.WindowView windowView, FrameLayout frameLayout, final Theme.ResourcesProvider resourcesProvider) {
        ...
        editTextEmoji.setHint(LocaleController.getString("StoryAddCaption", C3419R.string.StoryAddCaption));
        ...
        editTextEmoji.getEditText().addTextChangedListener(new TextWatcher() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.2
            ...
            public void afterTextChanged(Editable editable) {
                ...
                if (editText != null && editText.getLayout() != null) {
                    editText.ignoreClipTop = editText.getLayout().getHeight() > (AndroidUtilities.m72dp(180) - editText.getPaddingTop()) - editText.getPaddingBottom();
                }
                try {
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m72dp(16), -10043398), context.getResources().getDrawable(C3419R.C3421drawable.input_done).mutate(), 0, AndroidUtilities.m72dp(1));
        ...
        addView(this.limitTextView, LayoutHelper.createFrame(52, 16, 85, 0, 0, 0, 44));
