...
public class PreviewButtons extends FrameLayout {
    ...
    public PreviewButtons(Context context) {
        ...
        addButton(0, C3419R.C3421drawable.msg_draw_pen, LocaleController.getString("AccDescrPaint", C3419R.string.AccDescrPaint));
        addButton(2, C3419R.C3421drawable.msg_photo_sticker, LocaleController.getString("AccDescrStickers", C3419R.string.AccDescrStickers));
        addButton(1, C3419R.C3421drawable.msg_photo_text2, LocaleController.getString("AccDescrPlaceText", C3419R.string.AccDescrPlaceText));
        addButton(3, C3419R.C3421drawable.msg_photo_settings, LocaleController.getString("AccDescrPhotoAdjust", C3419R.string.AccDescrPhotoAdjust));
        int i = C3419R.string.Send;
    ...
    public class ShareButtonView extends View {
        ...
        public ShareButtonView(Context context, String str) {
            ...
            Drawable mutate = getResources().getDrawable(C3419R.C3421drawable.attach_arrow_right).mutate();
            ...
            this.width = f;
            this.f1892w = ((int) f) + AndroidUtilities.m72dp(48);
            this.f1891h = AndroidUtilities.m72dp(40);
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f1892w, 1073741824), View.MeasureSpec.makeMeasureSpec(this.f1891h, 1073741824));
        }
