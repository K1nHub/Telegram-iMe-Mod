...
public class PreviewButtons extends FrameLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int min = Math.min(AndroidUtilities.m104dp(20), this.buttons.size() < 2 ? 0 : (((i5 - AndroidUtilities.m105dp(32.33f)) - this.shareButton.getMeasuredWidth()) - (this.buttons.size() * AndroidUtilities.m104dp(40))) / (this.buttons.size() - 1));
        int m104dp = (i6 - AndroidUtilities.m104dp(40)) / 2;
        int m104dp2 = (i6 + AndroidUtilities.m104dp(40)) / 2;
        int m105dp = AndroidUtilities.m105dp(12.33f);
        for (int i7 = 0; i7 < this.buttons.size(); i7++) {
            this.buttons.get(i7).layout(m105dp, m104dp, AndroidUtilities.m104dp(40) + m105dp, m104dp2);
            m105dp += AndroidUtilities.m104dp(40) + min;
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(52), 1073741824));
    }
    ...
    private void updateAppearT() {
        ...
        this.shadowView.setTranslationY((1.0f - this.appearT) * AndroidUtilities.m104dp(16));
        for (int i = 1; i < getChildCount(); i++) {
            ...
            childAt.setAlpha(f);
            childAt.setTranslationY((1.0f - f) * AndroidUtilities.m104dp(24));
        }
    }
    ...
    public class ShareButtonView extends View {
        ...
        public ShareButtonView(Context context, String str) {
            ...
            StaticLayout staticLayout = new StaticLayout(append, textPaint, AndroidUtilities.m104dp(180), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(AndroidUtilities.m104dp(25), AndroidUtilities.m104dp(4), getWidth() - AndroidUtilities.m104dp(25), getHeight() - AndroidUtilities.m104dp(4), this.darkenPaint);
            canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), getHeight(), 255, 31);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(4), getWidth() - AndroidUtilities.m104dp(10), getHeight() - AndroidUtilities.m104dp(4));
            canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(20), this.buttonPaint);
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(26) - this.left, (getHeight() - this.staticLayout.getHeight()) / 2.0f);
    ...
    public class ButtonView extends ImageView {
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m104dp(40), AndroidUtilities.m104dp(40));
        }
