...
public class PreviewButtons extends FrameLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int m108dp = (i5 - AndroidUtilities.m108dp(32.33f)) - this.shareButton.getMeasuredWidth();
        int i7 = 0;
        ...
        int min = Math.min(AndroidUtilities.m107dp(isFiltersVisible() ? 20 : 30), i7 < 2 ? 0 : (m108dp - (AndroidUtilities.m107dp(40) * i7)) / (i7 - 1));
        int m107dp = (i6 - AndroidUtilities.m107dp(40)) / 2;
        int m107dp2 = (i6 + AndroidUtilities.m107dp(40)) / 2;
        int m108dp2 = AndroidUtilities.m108dp(12.33f) + (!isFiltersVisible() ? ((m108dp - (AndroidUtilities.m107dp(40) * i7)) - ((i7 - 1) * min)) / 2 : 0);
        for (int i9 = 0; i9 < this.buttons.size(); i9++) {
            if (this.buttons.get(i9).getVisibility() == 0) {
                this.buttons.get(i9).layout(m108dp2, m107dp, AndroidUtilities.m107dp(40) + m108dp2, m107dp2);
                m108dp2 += AndroidUtilities.m107dp(40) + min;
            }
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(52), 1073741824));
    }
    ...
    private void updateAppearT() {
        ...
        this.shadowView.setTranslationY((1.0f - this.appearT) * AndroidUtilities.m107dp(16));
        for (int i = 1; i < getChildCount(); i++) {
            ...
            childAt.setAlpha(f);
            childAt.setTranslationY((1.0f - f) * AndroidUtilities.m107dp(24));
        }
    }
    ...
    public class ShareButtonView extends View {
        ...
        public ShareButtonView(Context context, String str) {
            ...
            mutate.setBounds(0, 0, AndroidUtilities.m107dp(12), AndroidUtilities.m107dp(12));
            ...
            StaticLayout staticLayout = new StaticLayout(append, textPaint, AndroidUtilities.m107dp(180), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            ...
            this.width = f;
            this.f2018w = ((int) f) + AndroidUtilities.m107dp(48);
            this.f2017h = AndroidUtilities.m107dp(40);
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f2018w, 1073741824), View.MeasureSpec.makeMeasureSpec(this.f2017h, 1073741824));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(AndroidUtilities.m107dp(25), AndroidUtilities.m107dp(4), getWidth() - AndroidUtilities.m107dp(25), getHeight() - AndroidUtilities.m107dp(4), this.darkenPaint);
            canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), getHeight(), 255, 31);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(AndroidUtilities.m107dp(10), AndroidUtilities.m107dp(4), getWidth() - AndroidUtilities.m107dp(10), getHeight() - AndroidUtilities.m107dp(4));
            canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(20), AndroidUtilities.m107dp(20), this.buttonPaint);
            canvas.save();
            canvas.translate(AndroidUtilities.m107dp(26) - this.left, (getHeight() - this.staticLayout.getHeight()) / 2.0f);
    ...
    public class ButtonView extends ImageView {
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m107dp(40), AndroidUtilities.m107dp(40));
        }
