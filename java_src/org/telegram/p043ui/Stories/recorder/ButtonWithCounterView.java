...
public class ButtonWithCounterView extends FrameLayout {
    ...
    public ButtonWithCounterView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z) {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m72dp(8), Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider)));
        }
        ...
        animatedTextDrawable2.setTextSize(AndroidUtilities.m72dp(12));
