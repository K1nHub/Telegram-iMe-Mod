...
public class StoryPrivacySelector extends View {
    ...
    protected void dispatchDraw(Canvas canvas) {
        float currentWidth = this.textDrawable.getCurrentWidth() + AndroidUtilities.m72dp(26);
        this.rect.set((getWidth() - currentWidth) / 2.0f, AndroidUtilities.m72dp(13), (getWidth() + currentWidth) / 2.0f, AndroidUtilities.m72dp(43));
        this.clickRect.set(this.rect);
        this.clickRect.inset(-AndroidUtilities.m72dp(28), -AndroidUtilities.m72dp(14));
        canvas.drawRoundRect(this.rect, AndroidUtilities.m72dp(15), AndroidUtilities.m72dp(15), this.backgroundPaint);
        ...
        this.textDrawable.setBounds(0, -AndroidUtilities.m72dp(1), getWidth(), getHeight() - AndroidUtilities.m72dp(1));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (contains) {
                Drawable createRadSelectorDrawable = Theme.createRadSelectorDrawable(234881023, AndroidUtilities.m72dp(15), AndroidUtilities.m72dp(15));
    ...
    public /* synthetic */ void lambda$open$3() {
        ...
        storyPrivacyBottomSheet.whenSelectedRules(new Utilities.Callback4() { // from class: org.telegram.ui.Stories.recorder.StoryPrivacySelector$$ExternalSyntheticLambda5
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$open$1(StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy, Boolean bool, Boolean bool2, Runnable runnable) {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(56), 1073741824));
    }
