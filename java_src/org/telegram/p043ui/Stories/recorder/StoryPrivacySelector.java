...
public class StoryPrivacySelector extends View {
    ...
    protected void dispatchDraw(Canvas canvas) {
        float currentWidth = this.textDrawable.getCurrentWidth() + AndroidUtilities.m104dp(26);
        this.rect.set((getWidth() - currentWidth) / 2.0f, AndroidUtilities.m104dp(13), (getWidth() + currentWidth) / 2.0f, AndroidUtilities.m104dp(43));
        this.clickRect.set(this.rect);
        this.clickRect.inset(-AndroidUtilities.m104dp(28), -AndroidUtilities.m104dp(14));
        canvas.drawRoundRect(this.rect, AndroidUtilities.m104dp(15), AndroidUtilities.m104dp(15), this.backgroundPaint);
        ...
        this.textDrawable.setBounds(0, -AndroidUtilities.m104dp(1), getWidth(), getHeight() - AndroidUtilities.m104dp(1));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (contains) {
                Drawable createRadSelectorDrawable = Theme.createRadSelectorDrawable(234881023, AndroidUtilities.m104dp(15), AndroidUtilities.m104dp(15));
