...
public class TrashView extends View {
    ...
    public TrashView(Context context) {
        ...
        paint.setShadowLayer(AndroidUtilities.dpf2(3.0f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m73dp(1.66f), C0480C.ENCODING_PCM_32BIT);
        paint2.setColor(AndroidUtilities.DARK_STATUS_BAR_OVERLAY);
        int i = C3419R.raw.group_pip_delete_icon;
        ...
        animatedTextDrawable.setText(LocaleController.getString("TrashHintDrag", C3419R.string.TrashHintDrag));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        float m72dp2 = (AndroidUtilities.m72dp(3) * this.draggedT.set(this.dragged)) + m72dp;
        canvas.drawCircle(width, height, m72dp2, this.greyPaint);
        canvas.drawCircle(width, height, m72dp2, this.circlePaint);
        float m72dp3 = AndroidUtilities.m72dp(48) / 2.0f;
        this.drawable.setBounds((int) (width - m72dp3), (int) (height - m72dp3), (int) (width + m72dp3), (int) (m72dp3 + height));
        this.drawable.draw(canvas);
        this.textDrawable.setBounds(0, (int) (height + m72dp + AndroidUtilities.m72dp(7)), getWidth(), getHeight());
        this.textDrawable.draw(canvas);
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(i, AndroidUtilities.m72dp(120));
    }
    ...
    public void onDragInfo(boolean z, boolean z2) {
        ...
        if (z || z2) {
            i = C3419R.string.TrashHintRelease;
            str = "TrashHintRelease";
        } else {
            i = C3419R.string.TrashHintDrag;
            str = "TrashHintDrag";
        }
