...
public class TrashView extends View {
    ...
    public TrashView(Context context) {
        ...
        paint.setShadowLayer(AndroidUtilities.dpf2(3.0f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m108dp(1.66f), C0483C.ENCODING_PCM_32BIT);
        paint2.setColor(AndroidUtilities.DARK_STATUS_BAR_OVERLAY);
        int i = C3632R.raw.group_pip_delete_icon;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(48), AndroidUtilities.m107dp(48), true, null);
        ...
        animatedTextDrawable.setShadowLayer(AndroidUtilities.dpf2(1.33f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(1), 1073741824);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        float m107dp2 = (AndroidUtilities.m107dp(3) * this.draggedT.set(this.dragged)) + m107dp;
        canvas.drawCircle(width, height, m107dp2, this.greyPaint);
        canvas.drawCircle(width, height, m107dp2, this.circlePaint);
        float m107dp3 = AndroidUtilities.m107dp(48) / 2.0f;
        this.drawable.setBounds((int) (width - m107dp3), (int) (height - m107dp3), (int) (width + m107dp3), (int) (m107dp3 + height));
        this.drawable.draw(canvas);
        this.textDrawable.setBounds(0, (int) (height + m107dp + AndroidUtilities.m107dp(7)), getWidth(), getHeight());
        this.textDrawable.draw(canvas);
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(i, AndroidUtilities.m107dp(120));
    }
