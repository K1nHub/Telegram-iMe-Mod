...
public class SliderView extends View {
    ...
    public SliderView(Context context, int i) {
        ...
        if (i == 0) {
            ...
            if (i == 1) {
                ...
                animatedTextDrawable2.setText(LocaleController.getString(C3632R.string.WallpaperDimming));
            }
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        rectF.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.f2033w, this.f2031h);
        ...
        canvas.saveLayerAlpha(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.f2033w, this.f2031h, 255, 31);
        if (this.currentType == 0) {
            this.text.setBounds(AndroidUtilities.m107dp(42), -AndroidUtilities.m107dp(1), this.f2033w, this.f2031h - AndroidUtilities.m107dp(1));
            this.text.draw(canvas);
        } else {
            this.text2.setBounds(AndroidUtilities.m108dp(12.33f), -AndroidUtilities.m107dp(1), (this.f2033w - ((int) this.text.getCurrentWidth())) - AndroidUtilities.m107dp(6), this.f2031h - AndroidUtilities.m107dp(1));
            this.text2.draw(canvas);
            this.text.setBounds(this.f2033w - AndroidUtilities.m107dp(111), -AndroidUtilities.m107dp(1), this.f2033w - AndroidUtilities.m107dp(11), this.f2031h - AndroidUtilities.m107dp(1));
            this.text.draw(canvas);
        }
        if (this.currentType == 0) {
        ...
        canvas.save();
        canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.f2033w * f2, this.f2031h, this.whitePaint);
        canvas.restore();
        canvas.restore();
        canvas.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.pressTime < ViewConfiguration.getTapTimeout()) {
                ...
                this.value = x / this.f2033w;
                this.valueIsAnimated = true;
            } else {
                this.value = Utilities.clamp(this.value + ((x - this.lastTouchX) / this.f2033w), 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
                this.valueIsAnimated = false;
                z = true;
            }
    ...
    protected void onMeasure(int i, int i2) {
        if (this.currentType == 3) {
            this.f2032r = AndroidUtilities.dpf2(8.0f);
        } else {
            this.f2032r = AndroidUtilities.dpf2(6.33f);
        }
        this.textPaint.setTextSize(AndroidUtilities.m107dp(16));
        this.text.setTextSize(AndroidUtilities.m107dp(15));
        if (this.currentType == 0) {
            this.f2033w = (int) Math.min(this.textPaint.measureText(LocaleController.getString(C3632R.string.StoryAudioRemove)) + AndroidUtilities.m107dp(88), View.MeasureSpec.getSize(i));
            this.f2031h = AndroidUtilities.m107dp(48);
        } else {
            this.f2033w = AndroidUtilities.m107dp(190);
            this.f2031h = AndroidUtilities.m107dp(44);
        }
        setMeasuredDimension(this.f2033w, this.f2031h);
        if (this.currentType == 0) {
            float m107dp = AndroidUtilities.m107dp(25);
            float f = this.f2031h / 2.0f;
            this.speaker1Paint.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(1.33f)));
            this.speaker1Path.rewind();
            this.speaker1Path.moveTo(m107dp - AndroidUtilities.dpf2(8.66f), f - AndroidUtilities.dpf2(2.9f));
            this.speaker1Path.lineTo(m107dp - AndroidUtilities.dpf2(3.0f), f - AndroidUtilities.dpf2(2.9f));
            this.speaker1Path.lineTo(m107dp - AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(2.9f) + f);
            this.speaker1Path.lineTo(m107dp - AndroidUtilities.dpf2(8.66f), AndroidUtilities.dpf2(2.9f) + f);
            ...
            this.speaker2Path.moveTo(m107dp - AndroidUtilities.dpf2(7.5f), f);
            this.speaker2Path.lineTo(m107dp, f - AndroidUtilities.dpf2(7.33f));
            this.speaker2Path.lineTo(m107dp, AndroidUtilities.dpf2(7.33f) + f);
            this.speaker2Path.close();
            this.speakerWave1Path.rewind();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set((m107dp - AndroidUtilities.dpf2(0.33f)) - AndroidUtilities.m108dp(4.33f), f - AndroidUtilities.m108dp(4.33f), (m107dp - AndroidUtilities.dpf2(0.33f)) + AndroidUtilities.m108dp(4.33f), AndroidUtilities.m108dp(4.33f) + f);
            ...
            this.speakerWave2Paint.setStrokeWidth(AndroidUtilities.m107dp(2));
            this.speakerWave2Path.rewind();
            rectF.set((m107dp - AndroidUtilities.dpf2(0.33f)) - AndroidUtilities.m107dp(8), f - AndroidUtilities.m107dp(8), (m107dp - AndroidUtilities.dpf2(0.33f)) + AndroidUtilities.m107dp(8), f + AndroidUtilities.m107dp(8));
