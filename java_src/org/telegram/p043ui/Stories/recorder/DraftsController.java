    ...
    */
    public static /* synthetic */ void lambda$loadInternal$1(org.telegram.messenger.MessagesStorage r8, boolean r9, final org.telegram.messenger.Utilities.Callback r10) {
        ...
        L36:
            ...
            r7.f2006id = r4     // Catch: java.lang.Exception -> L52 java.lang.Throwable -> L93
            r0.add(r7)     // Catch: java.lang.Exception -> L52 java.lang.Throwable -> L93
            goto L5d
        L52:
            r9 = move-exception
            org.telegram.messenger.FileLog.m102e(r9)     // Catch: java.lang.Throwable -> L93 java.lang.Exception -> L95
        ...
        L95:
            r8 = move-exception
            org.telegram.messenger.FileLog.m102e(r8)     // Catch: java.lang.Throwable -> L93
            if (r1 == 0) goto L9e
        L9b:
            r1.dispose()
        L9e:
    ...
    */
    ...
    public static /* synthetic */ void lambda$edit$4(MessagesStorage messagesStorage, StoryDraft storyDraft) {
        ...
        try {
            ...
            int i = 1;
            sQLitePreparedStatement.bindLong(1, storyDraft.f2006id);
    ...
    public void saveForEdit(StoryEntry storyEntry, long j, TL_stories$StoryItem tL_stories$StoryItem) {
        ...
        while (it.hasNext()) {
            ...
            if (next.isEdit && next.editStoryId == tL_stories$StoryItem.f1763id) {
                arrayList.add(next);
            }
        }
        delete(arrayList);
        ...
        int i = tL_stories$StoryItem.f1763id;
    ...
    public StoryEntry getForEdit(long j, TL_stories$StoryItem tL_stories$StoryItem) {
        ...
        while (it.hasNext()) {
            StoryEntry next = it.next();
            if (next.isEdit && tL_stories$StoryItem.f1763id == next.editStoryId && j == next.editStoryPeerId && ((tLRPC$Document = (tLRPC$MessageMedia = tL_stories$StoryItem.media).document) == null || tLRPC$Document.f1610id == next.editDocumentId)) {
                TLRPC$Photo tLRPC$Photo = tLRPC$MessageMedia.photo;
    ...
    public static class StoryDraft {
        ...
        public StoryDraft(StoryEntry storyEntry) {
            ...
            this.f2006id = storyEntry.draftId;
        ...
        public StoryEntry toEntry() {
            ...
            storyEntry.draftId = this.f2006id;
            storyEntry.isDraft = true;
