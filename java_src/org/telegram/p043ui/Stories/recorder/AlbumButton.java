...
public class AlbumButton extends View {
    ...
    public AlbumButton(Context context, MediaController.PhotoEntry photoEntry, CharSequence charSequence, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        combinedDrawable.setIconSize(AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(18));
    ...
    protected void onMeasure(int i, int i2) {
        updateLayouts((((View.MeasureSpec.getSize(i) - AndroidUtilities.m108dp(30.0f)) - AndroidUtilities.m107dp(12)) - getPaddingLeft()) - getPaddingRight());
        if (View.MeasureSpec.getMode(i) == Integer.MIN_VALUE) {
            setMeasuredDimension((int) Math.min(getPaddingLeft() + AndroidUtilities.m108dp(30.0f) + AndroidUtilities.m107dp(12) + this.nameLayoutWidth + AndroidUtilities.m107dp(8) + this.countLayoutWidth + getPaddingRight(), View.MeasureSpec.getSize(i)), AndroidUtilities.m107dp(48));
        } else if (View.MeasureSpec.getMode(i) == 1073741824) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(48));
        }
    }
    ...
    private void updateLayouts(int i) {
        ...
        if (staticLayout == null || staticLayout.getWidth() != i) {
            ...
            int m107dp = i - ((int) (lineWidth + AndroidUtilities.m107dp(8)));
            StaticLayout staticLayout3 = new StaticLayout(TextUtils.ellipsize(this.subtitle, this.countPaintLayout, m107dp, TextUtils.TruncateAt.END), this.countPaintLayout, Math.max(0, m107dp), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.imageReceiver.setImageCoords(paddingLeft, (getMeasuredHeight() - AndroidUtilities.m108dp(30.0f)) / 2.0f, AndroidUtilities.m108dp(30.0f), AndroidUtilities.m108dp(30.0f));
        this.imageReceiver.draw(canvas);
        float m108dp = paddingLeft + AndroidUtilities.m108dp(30.0f) + AndroidUtilities.m107dp(12);
        if (this.nameLayout != null) {
            canvas.save();
            canvas.translate(m108dp - this.nameLayoutLeft, (getMeasuredHeight() - this.nameLayout.getHeight()) / 2.0f);
            this.nameLayout.draw(canvas);
            m108dp = m108dp + this.nameLayoutWidth + AndroidUtilities.m107dp(6);
            canvas.restore();
        }
        if (this.countLayout != null) {
            canvas.save();
            canvas.translate(m108dp - this.countLayoutLeft, ((getMeasuredHeight() - this.countLayout.getHeight()) / 2.0f) + AndroidUtilities.dpf2(1.6f));
