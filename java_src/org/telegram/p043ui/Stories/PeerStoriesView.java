...
public class PeerStoriesView extends SizeNotifierFrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PeerStoriesView(final Context context, final StoryViewer storyViewer, final SharedResources sharedResources, final Theme.ResourcesProvider resourcesProvider) {
        ...
        C70904 c70904 = new C70904(context, sharedResources, storyViewer);
        this.storyContainer = c70904;
        c70904.setClipChildren(false);
        ...
        C70925 c70925 = new C70925(getContext(), storyViewer.resourcesProvider, storyViewer, resourcesProvider);
        this.storyCaptionView = c70925;
        c70925.captionTextview.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda13
        ...
        frameLayout.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda14
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        storiesLikeButton.setPadding(m104dp, m104dp, m104dp, m104dp);
        ...
        peerHeaderView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda18
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        imageView2.setPadding(AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8));
        ...
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda17
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        rLottieImageView.setPadding(AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6));
        frameLayout2.addView(rLottieImageView);
        ImageView imageView3 = new ImageView(context);
        this.noSoundIconView = imageView3;
        imageView3.setPadding(AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6), AndroidUtilities.m104dp(6));
        ...
        frameLayout2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda19
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.storyContainer.addView(c70925, LayoutHelper.createFrame(-1, -1, 0, 0, 64, 0, 0));
        frameLayout2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(20), 0, ColorUtils.setAlphaComponent(-1, 100)));
        imageView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(20), 0, ColorUtils.setAlphaComponent(-1, 100)));
        imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(20), 0, ColorUtils.setAlphaComponent(-1, 100)));
        frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(20), 0, ColorUtils.setAlphaComponent(-1, 100)));
        View overlayView = c70925.textSelectionHelper.getOverlayView(context);
        if (overlayView != null) {
            AndroidUtilities.removeFromParent(overlayView);
            addView(overlayView);
        }
        c70925.textSelectionHelper.setCallback(new TextSelectionHelper.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView.7
        ...
        c70925.textSelectionHelper.setParentView(this);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Stories.PeerStoriesView$4 */
    /* loaded from: classes6.dex */
    public class C70904 extends HwFrameLayout {
        ...
        C70904(Context context, SharedResources sharedResources, StoryViewer storyViewer) {
            super(context);
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r17) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Stories.PeerStoriesView.C70904.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        */
        private void drawLines(android.graphics.Canvas r22) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Stories.PeerStoriesView.C70904.drawLines(android.graphics.Canvas):void");
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (PeerStoriesView.this.drawLinesAsCounter()) {
                ...
                layoutParams.topMargin = AndroidUtilities.m104dp(55);
            } else {
                layoutParams.rightMargin = AndroidUtilities.m104dp(42);
                layoutParams.topMargin = AndroidUtilities.m104dp(15);
            }
    ...
    /* loaded from: classes6.dex */
    public class C70925 extends StoryCaptionView {
        final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;
        final /* synthetic */ StoryViewer val$storyViewer;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C70925(Context context, Theme.ResourcesProvider resourcesProvider, StoryViewer storyViewer, Theme.ResourcesProvider resourcesProvider2) {
        ...
        public void onLinkClick(CharacterStyle characterStyle, View view) {
            if (characterStyle instanceof URLSpanUserMention) {
                ...
                BulletinFactory.m63of(PeerStoriesView.this.storyContainer, this.val$resourcesProvider).createCopyBulletin(LocaleController.getString("TextCopied", C3634R.string.TextCopied)).show();
        ...
        public void onLinkLongPress(final URLSpan uRLSpan, final View view, final Runnable runnable) {
            ...
            CharSequence[] charSequenceArr = (storyItemHolder == null || storyItemHolder.allowScreenshots()) ? new CharSequence[]{LocaleController.getString("Open", C3634R.string.Open), LocaleController.getString("Copy", C3634R.string.Copy)} : new CharSequence[]{LocaleController.getString("Open", C3634R.string.Open)};
            ...
            builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$5$$ExternalSyntheticLambda0
                ...
                public final void onClick(DialogInterface dialogInterface, int i) {
                    PeerStoriesView.C70925.this.lambda$onLinkLongPress$0(uRLSpan, view, url, resourcesProvider, dialogInterface, i);
                }
            });
        ...
        public /* synthetic */ void lambda$onLinkLongPress$0(URLSpan uRLSpan, View view, String str, Theme.ResourcesProvider resourcesProvider, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                BulletinFactory.m63of(PeerStoriesView.this.storyContainer, resourcesProvider).createCopyLinkBulletin().show();
            }
        }
        ...
        public void onEmojiClick(AnimatedEmojiSpan animatedEmojiSpan) {
            if (animatedEmojiSpan != null) {
                ...
                BulletinFactory m63of = BulletinFactory.m63of(PeerStoriesView.this.storyContainer, this.val$resourcesProvider);
                final StoryViewer storyViewer = this.val$storyViewer;
                final Theme.ResourcesProvider resourcesProvider = this.val$resourcesProvider;
                Bulletin createContainsEmojiBulletin = m63of.createContainsEmojiBulletin(tLRPC$Document, 2, new Utilities.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView$5$$ExternalSyntheticLambda2
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        PeerStoriesView.C70925.this.lambda$onEmojiClick$2(storyViewer, resourcesProvider, (TLRPC$InputStickerSet) obj);
                    }
                });
    ...
    public /* synthetic */ void lambda$new$5(StoryViewer storyViewer, View view) {
        ...
        if (j == j2) {
            ...
            storyViewer.presentFragment(ChatActivity.m65of(j2));
        }
    }
    ...
    public /* synthetic */ void lambda$new$6(Theme.ResourcesProvider resourcesProvider, Context context, StoryViewer storyViewer, SharedResources sharedResources, View view) {
        ...
        C70936 c70936 = new C70936(getContext(), resourcesProvider, this.isSelf, resourcesProvider, context, storyViewer, sharedResources, zArr);
        this.popupMenu = c70936;
        c70936.show(this.optionsIconView, 0, (-C3706ActionBar.getCurrentActionBarHeight()) + AndroidUtilities.m104dp(6));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Stories.PeerStoriesView$6 */
    /* loaded from: classes6.dex */
    public class C70936 extends CustomPopupMenu {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C70936(Context context, Theme.ResourcesProvider resourcesProvider, boolean z, Theme.ResourcesProvider resourcesProvider2, Context context2, StoryViewer storyViewer, SharedResources sharedResources, boolean[] zArr) {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        protected void onCreate(org.telegram.p043ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout r31) {
            /*
                Method dump skipped, instructions count: 1463
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Stories.PeerStoriesView.C70936.onCreate(org.telegram.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout):void");
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$1(StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy, TL_stories$StoryItem tL_stories$StoryItem, View view) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$7(Theme.ResourcesProvider resourcesProvider, Context context, final StoryViewer storyViewer, final SharedResources sharedResources, View view) {
            if (view.getAlpha() < 1.0f) {
                PeerStoriesView peerStoriesView = PeerStoriesView.this;
                AndroidUtilities.shakeViewSpring(view, peerStoriesView.shiftDp = -peerStoriesView.shiftDp);
                BulletinFactory.m63of(PeerStoriesView.this.storyContainer, resourcesProvider).createErrorBulletin("Wait until current upload is complete").show();
                return;
            }
            ...
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda26
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70936.this.lambda$onCreate$6(findActivity, storyViewer, sharedResources);
                }
            };
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$6(Activity activity, StoryViewer storyViewer, final SharedResources sharedResources) {
            File file;
            ...
            storyRecorder.setOnFullyOpenListener(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda24
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70936.this.lambda$onCreate$2();
                }
            });
            storyRecorder.setOnPrepareCloseListener(new Utilities.Callback3() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda28
                @Override // org.telegram.messenger.Utilities.Callback3
                public final void run(Object obj, Object obj2, Object obj3) {
                    PeerStoriesView.C70936.this.lambda$onCreate$5(sharedResources, (Long) obj, (Runnable) obj2, (Boolean) obj3);
                }
            });
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$5(SharedResources sharedResources, Long l, final Runnable runnable, Boolean bool) {
            ...
            if (videoPlayerHolder == null) {
                ...
                peerStoriesView2.onImageReceiverThumbLoaded = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda20
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C70936.lambda$onCreate$3(runnable);
                    }
                };
            ...
            videoPlayerHolder.setOnReadyListener(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda21
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70936.lambda$onCreate$4(runnable, currentTimeMillis);
                }
            });
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ void lambda$onCreate$3(Runnable runnable) {
            AndroidUtilities.cancelRunOnUIThread(runnable);
            AndroidUtilities.runOnUIThread(runnable);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ void lambda$onCreate$4(Runnable runnable, long j) {
            AndroidUtilities.cancelRunOnUIThread(runnable);
            AndroidUtilities.runOnUIThread(runnable, Math.max(0L, 32 - (System.currentTimeMillis() - j)));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$9(final TL_stories$StoryItem tL_stories$StoryItem, final boolean z, final Theme.ResourcesProvider resourcesProvider, View view) {
            ArrayList<TL_stories$StoryItem> arrayList = new ArrayList<>();
            arrayList.add(tL_stories$StoryItem);
            MessagesController.getInstance(PeerStoriesView.this.currentAccount).getStoriesController().updateStoriesPinned(PeerStoriesView.this.dialogId, arrayList, z, new Utilities.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda29
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    PeerStoriesView.C70936.this.lambda$onCreate$8(tL_stories$StoryItem, z, resourcesProvider, (Boolean) obj);
                }
            });
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$8(TL_stories$StoryItem tL_stories$StoryItem, boolean z, Theme.ResourcesProvider resourcesProvider, Boolean bool) {
            int i;
            String str;
            if (bool.booleanValue()) {
                ...
                if (!peerStoriesView.isSelf) {
                    if (z) {
                        BulletinFactory.m63of(peerStoriesView.storyContainer, resourcesProvider).createSimpleBulletin(C3634R.raw.contact_check, LocaleController.getString("StoryPinnedToPosts", C3634R.string.StoryPinnedToPosts), LocaleController.getString("StoryPinnedToPostsDescription", C3634R.string.StoryPinnedToPostsDescription)).show();
                        return;
                    } else {
                        BulletinFactory.m63of(peerStoriesView.storyContainer, resourcesProvider).createSimpleBulletin(C3634R.raw.chats_archived, LocaleController.getString("StoryUnpinnedFromPosts", C3634R.string.StoryUnpinnedFromPosts)).show();
                        return;
                    }
                }
                BulletinFactory m63of = BulletinFactory.m63of(peerStoriesView.storyContainer, resourcesProvider);
                int i2 = z ? C3634R.raw.contact_check : C3634R.raw.chats_archived;
                if (z) {
                    i = C3634R.string.StoryPinnedToProfile;
                    str = "StoryPinnedToProfile";
                } else {
                    i = C3634R.string.StoryArchivedFromProfile;
                    str = "StoryArchivedFromProfile";
                }
                m63of.createSimpleBulletin(i2, LocaleController.getString(str, i)).show();
                return;
            }
            BulletinFactory.m63of(PeerStoriesView.this.storyContainer, resourcesProvider).createSimpleBulletin(C3634R.raw.error, LocaleController.getString("UnknownError", C3634R.string.UnknownError)).show();
        }
        ...
        public /* synthetic */ void lambda$onCreate$14(String str, Theme.ResourcesProvider resourcesProvider, TLObject tLObject, String str2, View view) {
            ...
            BulletinFactory.m63of(PeerStoriesView.this.storyContainer, resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", C3634R.string.NotificationsStoryMutedHint, str2))).setTag(2).show();
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        public /* synthetic */ void lambda$onCreate$15(String str, Theme.ResourcesProvider resourcesProvider, TLObject tLObject, String str2, View view) {
            ...
            NotificationsController.getInstance(PeerStoriesView.this.currentAccount).updateServerNotificationsSettings(PeerStoriesView.this.dialogId, 0);
            BulletinFactory.m63of(PeerStoriesView.this.storyContainer, resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", C3634R.string.NotificationsStoryUnmutedHint, str2))).setTag(2).show();
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$20(ActionBarMenuSubItem actionBarMenuSubItem, final StoryViewer storyViewer, View view) {
            actionBarMenuSubItem.performHapticFeedback(3);
            BulletinFactory global = BulletinFactory.global();
            if (global != null) {
                global.createSimpleBulletin(C3634R.raw.ic_save_to_gallery, AndroidUtilities.replaceSingleTag(LocaleController.getString("SaveStoryToGalleryPremiumHint", C3634R.string.SaveStoryToGalleryPremiumHint), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda27
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C70936.this.lambda$onCreate$19(storyViewer);
                    }
                })).show();
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$19(StoryViewer storyViewer) {
        ...
        public /* synthetic */ void lambda$onCreate$26(View view) {
            ...
            final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda23
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70936.this.lambda$onCreate$24();
                }
            };
            MessagesController.getInstance(PeerStoriesView.this.currentAccount).getTranslateController().translateStory(PeerStoriesView.this.currentStory.storyItem, new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda22
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C70936.lambda$onCreate$25(runnable, currentTimeMillis);
                }
            });
            PeerStoriesView.this.updatePosition();
            PeerStoriesView peerStoriesView2 = PeerStoriesView.this;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ void lambda$onCreate$25(Runnable runnable, long j) {
            AndroidUtilities.runOnUIThread(runnable, Math.max(0L, 500 - (System.currentTimeMillis() - j)));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$27(StoryViewer storyViewer, Theme.ResourcesProvider resourcesProvider, View view) {
            AlertsCreator.createReportAlert(PeerStoriesView.this.getContext(), PeerStoriesView.this.dialogId, 0, PeerStoriesView.this.currentStory.storyItem.f1761id, storyViewer.fragment, resourcesProvider, null);
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreate$28(StoryContainsEmojiButton storyContainsEmojiButton, View view) {
            Delegate delegate;
        ...
        protected void onDismissed() {
            if (!this.edit && !this.val$popupStillVisible[0]) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$6$$ExternalSyntheticLambda25
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C70936.this.lambda$onDismissed$29();
                    }
                });
            }
            PeerStoriesView peerStoriesView = PeerStoriesView.this;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onDismissed$29() {
            PeerStoriesView.this.delegate.setPopupIsVisible(false);
        }
    }
    ...
    */
    ...
    public void createStealthModeItem(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        if (UserConfig.getInstance(this.currentAccount).isPremium()) {
            ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3634R.C3636drawable.msg_stories_stealth2, LocaleController.getString(C3634R.string.StealthModeButton), false, this.resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda16
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        Drawable drawable = ContextCompat.getDrawable(getContext(), C3634R.C3636drawable.msg_gallery_locked2);
        drawable.setColorFilter(new PorterDuffColorFilter(ColorUtils.blendARGB(-1, -16777216, 0.5f), PorterDuff.Mode.MULTIPLY));
        CombinedDrawable combinedDrawable = new CombinedDrawable(this, ContextCompat.getDrawable(getContext(), C3634R.C3636drawable.msg_stealth_locked), drawable) { // from class: org.telegram.ui.Stories.PeerStoriesView.8
            @Override // org.telegram.p043ui.Components.CombinedDrawable, android.graphics.drawable.Drawable
            public void setColorFilter(ColorFilter colorFilter) {
            }
        };
        ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3634R.C3636drawable.msg_stories_stealth2, LocaleController.getString(C3634R.string.StealthModeButton), false, this.resourcesProvider);
    ...
    private void animateLikeButton() {
        ...
        storiesLikeButton2.setPadding(m104dp, m104dp, m104dp, m104dp);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$toggleArchiveForStory$15(final MessagesController messagesController, final long j, final boolean z, String str, TLObject tLObject) {
        ...
        BulletinFactory.m63of(this.storyContainer, this.resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), !z ? AndroidUtilities.replaceTags(LocaleController.formatString("StoriesMovedToDialogs", C3634R.string.StoriesMovedToDialogs, ContactsController.formatName(str, null, 10))) : AndroidUtilities.replaceTags(LocaleController.formatString("StoriesMovedToContacts", C3634R.string.StoriesMovedToContacts, ContactsController.formatName(str, null, 10))), null, undoObject).setTag(2).show();
    }
    ...
    private void createFailView() {
        ...
        storyFailView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda15
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void createEnterView() {
        C706013 c706013 = new C706013(AndroidUtilities.findActivity(getContext()), this, null, true, new WrappedResourceProvider(this, this.resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.12
        ...
        this.chatActivityEnterView = c706013;
        c706013.getEditField().useAnimatedTextDrawable();
        this.chatActivityEnterView.setOverrideKeyboardAnimation(true);
        this.chatActivityEnterView.setClipChildren(false);
        this.chatActivityEnterView.setDelegate(new C706214());
    ...
    /* loaded from: classes6.dex */
    public class C706013 extends ChatActivityEnterView {
        private int chatActivityEnterViewAnimateFromTop;
        private Animator messageEditTextAnimator;
        int messageEditTextPredrawHeigth;
        int messageEditTextPredrawScrollY;

        C706013(Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, ChatActivity chatActivity, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void checkAnimation() {
            ...
            if (i != 0 && backgroundTop != i) {
                ...
                PeerStoriesView.this.changeBoundAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$13$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        PeerStoriesView.C706013.this.lambda$checkAnimation$0(valueAnimator);
                    }
                });
                PeerStoriesView.this.changeBoundAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.13.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        PeerStoriesView.this.invalidate();
                        ((ChatActivityEnterView) C706013.this).animatedTop = 0;
                        C706013 c706013 = C706013.this;
                        PeerStoriesView.this.forceUpdateOffsets = true;
                        if (((ChatActivityEnterView) c706013).topView != null && ((ChatActivityEnterView) C706013.this).topView.getVisibility() == 0) {
                            ((ChatActivityEnterView) C706013.this).topView.setTranslationY(((ChatActivityEnterView) C706013.this).animatedTop + ((1.0f - ((ChatActivityEnterView) C706013.this).topViewEnterProgress) * ((ChatActivityEnterView) C706013.this).topView.getLayoutParams().height));
                            if (((ChatActivityEnterView) C706013.this).topLineView != null) {
                                ((ChatActivityEnterView) C706013.this).topLineView.setTranslationY(((ChatActivityEnterView) C706013.this).animatedTop);
                            }
                        }
            ...
            if (this.shouldAnimateEditTextWithBounds) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$13$$ExternalSyntheticLambda1
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        PeerStoriesView.C706013.this.lambda$checkAnimation$1(valueAnimator);
                    }
                });
    ...
    /* loaded from: classes6.dex */
    public class C706214 implements ChatActivityEnterView.ChatActivityEnterViewDelegate {
        ...
        public void onMessageSend(CharSequence charSequence, boolean z, int i, String str) {
            if (!PeerStoriesView.this.isRecording) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$14$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C706214.this.lambda$onMessageSend$0();
                    }
                }, 200L);
            }
        }
        ...
        public void needShowMediaBanHint() {
            ...
            PeerStoriesView.this.mediaBanTooltip.setText(AndroidUtilities.replaceTags(LocaleController.formatString(PeerStoriesView.this.chatActivityEnterView.isInVideoMode() ? C3634R.string.VideoMessagesRestrictedByPrivacy : C3634R.string.VoiceMessagesRestrictedByPrivacy, MessagesController.getInstance(PeerStoriesView.this.currentAccount).getUser(Long.valueOf(PeerStoriesView.this.dialogId)).first_name)));
    ...
    public boolean applyMessageToChat(final Runnable runnable) {
        ...
        if (i > 0 && this.stealthModeIsActive) {
            ...
            alertDialog.setTitle(LocaleController.getString("StealthModeConfirmTitle", C3634R.string.StealthModeConfirmTitle));
            alertDialog.setMessage(LocaleController.getString("StealthModeConfirmMessage", C3634R.string.StealthModeConfirmMessage));
            alertDialog.setPositiveButton(LocaleController.getString("Proceed", C3634R.string.Proceed), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda3
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    runnable.run();
                }
            });
            alertDialog.setNegativeButton(LocaleController.getString("Cancel", C3634R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda7
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
    ...
    private void showDownloadAlert() {
        ...
        builder.setMessage(LocaleController.getString("PleaseDownload", C3634R.string.PleaseDownload));
    ...
    public void shareStory(boolean z) {
        ...
        if (z) {
            if (this.storyViewer.fragment.getContext() != null) {
                return;
            }
            ShareAlert shareAlert = new ShareAlert(this.storyViewer.fragment.getContext(), null, createLink, false, createLink, false, new WrappedResourceProvider(this, this.resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.20
                ...
                public void onSend(LongSparseArray<TLRPC$Dialog> longSparseArray, int i, TLRPC$TL_forumTopic tLRPC$TL_forumTopic) {
                    ...
                    PeerStoriesView peerStoriesView = PeerStoriesView.this;
                    BulletinFactory m63of = BulletinFactory.m63of(peerStoriesView.storyContainer, peerStoriesView.resourcesProvider);
                    if (m63of != null) {
                        if (longSparseArray.size() == 1) {
                            long keyAt = longSparseArray.keyAt(0);
                            if (keyAt == UserConfig.getInstance(this.currentAccount).clientUserId) {
                                m63of.createSimpleBulletin(C3634R.raw.saved_messages, AndroidUtilities.replaceTags(LocaleController.formatString("StorySharedToSavedMessages", C3634R.string.StorySharedToSavedMessages, new Object[0])), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).hideAfterBottomSheet(false).show();
                            } else if (keyAt < 0) {
                                TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-keyAt));
                                int i2 = C3634R.raw.forward;
                                int i3 = C3634R.string.StorySharedTo;
                                Object[] objArr = new Object[1];
                                objArr[0] = tLRPC$TL_forumTopic != null ? tLRPC$TL_forumTopic.title : chat.title;
                                m63of.createSimpleBulletin(i2, AndroidUtilities.replaceTags(LocaleController.formatString("StorySharedTo", i3, objArr)), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).hideAfterBottomSheet(false).show();
                            } else {
                                m63of.createSimpleBulletin(C3634R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatString("StorySharedTo", C3634R.string.StorySharedTo, MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(keyAt)).first_name)), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).hideAfterBottomSheet(false).show();
                            }
                        } else {
                            m63of.createSimpleBulletin(C3634R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatPluralString("StorySharedToManyChats", longSparseArray.size(), Integer.valueOf(longSparseArray.size())))).hideAfterBottomSheet(false).show();
                        }
        ...
        LaunchActivity.instance.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("StickersShare", C3634R.string.StickersShare)), 500);
    }
    ...
    public void onLickCopied() {
        ...
        tL_stories$TL_stories_exportStoryLink.f1770id = this.currentStory.storyItem.f1761id;
        tL_stories$TL_stories_exportStoryLink.peer = MessagesController.getInstance(this.currentAccount).getInputPeer(this.dialogId);
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_stories$TL_stories_exportStoryLink, new RequestDelegate(this) { // from class: org.telegram.ui.Stories.PeerStoriesView.23
    ...
    private void bindInternal(int i) {
        ...
        if (j >= 0) {
            ...
            if (this.isSelf) {
                this.headerView.titleView.setText(LocaleController.getString("SelfStoryTitle", C3634R.string.SelfStoryTitle));
                this.headerView.titleView.setRightDrawable((Drawable) null);
            } else {
                if (user != null && user.verified) {
                    Drawable mutate = ContextCompat.getDrawable(getContext(), C3634R.C3636drawable.verified_profile).mutate();
                    mutate.setAlpha(255);
                    CombinedDrawable combinedDrawable = new CombinedDrawable(mutate, null);
                    combinedDrawable.setFullsize(true);
                    combinedDrawable.setCustomSize(AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(16));
        ...
        if (this.isChannel) {
            ...
            if (this.reactionsCounter == null) {
                ...
                this.reactionsCounter.setTextSize(AndroidUtilities.m104dp(14));
            ...
            if (i == -1) {
                ...
                if (arrayList != null) {
                    ...
                    for (int i3 = 0; i3 < this.storyItems.size(); i3++) {
                        if (this.storyItems.get(i3).justUploaded || this.storyItems.get(i3).f1761id > this.storiesController.dialogIdToMaxReadId.get(this.dialogId)) {
    ...
    private void createUnsupportedContainer() {
        ...
        textView.setText(LocaleController.getString("StoryUnsupported", C3634R.string.StoryUnsupported));
        textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, this.resourcesProvider));
        TextView textView2 = new TextView(getContext());
        ScaleStateListAnimator.apply(textView2);
        textView2.setText(LocaleController.getString("AppUpdate", C3634R.string.AppUpdate));
        int i = Theme.key_featuredStickers_buttonText;
        textView2.setTextColor(Theme.getColor(i, this.resourcesProvider));
        textView2.setPadding(AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(12));
        textView2.setGravity(17);
        textView2.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView2.setTextSize(1, 15.0f);
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(8), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider), ColorUtils.setAlphaComponent(Theme.getColor(i, this.resourcesProvider), 30)));
        textView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PeerStoriesView.this.lambda$createUnsupportedContainer$20(view);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createUnsupportedContainer$20(View view) {
            ...
            if (i == -1 && !this.storyViewer.isSingleStory && (tL_stories$PeerStories = this.userStories) != null && tL_stories$PeerStories.max_read_id > 0) {
                ...
                while (true) {
                    if (i2 >= this.storyItems.size()) {
                        break;
                    } else if (this.storyItems.get(i2).f1761id > this.userStories.max_read_id) {
    ...
    private void createSelfPeerView() {
        ...
        FrameLayout frameLayout = new FrameLayout(getContext()) { // from class: org.telegram.ui.Stories.PeerStoriesView.25
            ...
            protected void dispatchDraw(Canvas canvas) {
                int x;
                if (PeerStoriesView.this.selfAvatarsContainer.getVisibility() == 0 && PeerStoriesView.this.selfAvatarsContainer.getLayoutParams().width != (x = (int) (((PeerStoriesView.this.selfStatusView.getX() + PeerStoriesView.this.selfStatusView.getMeasuredWidth()) - PeerStoriesView.this.selfAvatarsContainer.getX()) + AndroidUtilities.m104dp(10)))) {
        ...
        hwAvatarsImageView.setAvatarsTextSize(AndroidUtilities.m104dp(18));
        ...
        this.selfAvatarsContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m104dp(15), 0, ColorUtils.setAlphaComponent(-1, 120)));
        imageView.setBackground(Theme.createCircleSelectorDrawable(ColorUtils.setAlphaComponent(-1, 120), -AndroidUtilities.m104dp(2), -AndroidUtilities.m104dp(2)));
    }
    ...
    public void deleteStory() {
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext(), this.resourcesProvider);
        builder.setTitle(LocaleController.getString("DeleteStoryTitle", C3634R.string.DeleteStoryTitle));
        builder.setMessage(LocaleController.getString("DeleteStorySubtitle", C3634R.string.DeleteStorySubtitle));
        builder.setPositiveButton(LocaleController.getString("Delete", C3634R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                PeerStoriesView.this.lambda$deleteStory$22(dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Cancel", C3634R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda6
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
            }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.sharedResources.topOverlayGradient.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m104dp(72));
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.isChannel && (animatedTextDrawable = this.reactionsCounter) != null) {
            animatedTextDrawable.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m104dp(40));
        }
        super.dispatchDraw(canvas);
        boolean z = this.isChannel;
        float f = BitmapDescriptorFactory.HUE_RED;
        if (z && this.reactionsCounter != null) {
            canvas.save();
            canvas.translate((getMeasuredWidth() - this.reactionsCounter.getCurrentWidth()) - AndroidUtilities.m104dp(12), this.likeButtonContainer.getY());
            AnimatedFloat animatedFloat = this.reactionsCounterProgress;
            if (this.reactionsCounterVisible) {
                f = 1.0f;
            }
            f = animatedFloat.set(f);
            canvas.scale(f, f, this.reactionsCounter.getCurrentWidth() / 2.0f, AndroidUtilities.m104dp(20));
            this.reactionsCounter.setAlpha((int) (this.likeButtonContainer.getAlpha() * 255.0f));
            this.reactionsCounter.draw(canvas);
            canvas.restore();
        }
        updateButtonsOffsets(f);
        if (this.movingReaction) {
            ...
            float f2 = m104dp / 2.0f;
            float lerp = AndroidUtilities.lerp(this.movingReactionFromX, x - f2, CubicBezierInterpolator.EASE_OUT.getInterpolation(this.movingReactionProgress));
            float lerp2 = AndroidUtilities.lerp(this.movingReactionFromY, y - f2, this.movingReactionProgress);
            int lerp3 = AndroidUtilities.lerp(this.movingReactionFromSize, m104dp, this.movingReactionProgress);
            if (this.drawAnimatedEmojiAsMovingReaction) {
                AnimatedEmojiDrawable animatedEmojiDrawable = this.reactionMoveDrawable;
                if (animatedEmojiDrawable != null) {
                    float f3 = lerp3;
                    animatedEmojiDrawable.setBounds((int) lerp, (int) lerp2, (int) (lerp + f3), (int) (lerp2 + f3));
                    this.reactionMoveDrawable.draw(canvas);
                }
            } else {
                float f4 = lerp3;
                this.reactionMoveImageReceiver.setImageCoords(lerp, lerp2, f4, f4);
        ...
        if (this.drawReactionEffect) {
            ...
            int m104dp2 = AndroidUtilities.m104dp(120);
            if (!this.drawAnimatedEmojiAsMovingReaction) {
                float f5 = m104dp2;
                float f6 = f5 / 2.0f;
                ...
                if (animatedEmojiEffect != null) {
                    float f7 = m104dp2 / 2.0f;
                    animatedEmojiEffect.setBounds((int) (x2 - f7), (int) (y2 - f7), (int) (x2 + f7), (int) (y2 + f7));
    ...
    private void updateButtonsOffsets(float f) {
        if (this.isChannel) {
            float m104dp = ((-this.reactionsCounter.getCurrentWidth()) - AndroidUtilities.m104dp(4)) * f;
            this.shareButton.setTranslationX(m104dp);
            this.likeButtonContainer.setTranslationX(m104dp);
        } else if (this.isSelf) {
            this.shareButton.setTranslationX(AndroidUtilities.m104dp(40));
            this.likeButtonContainer.setTranslationX(BitmapDescriptorFactory.HUE_RED);
        } else {
            this.shareButton.setTranslationX(BitmapDescriptorFactory.HUE_RED);
            this.likeButtonContainer.setTranslationX(BitmapDescriptorFactory.HUE_RED);
        }
    }
        ...
        if (this.chatActivityEnterView != null && this.isVisible && this.attachedToWindow) {
            ...
            if (stealthMode != null) {
                ...
                if (currentTime < i) {
                    ...
                    int i4 = C3634R.string.StealthModeActiveHintShort;
                    ...
                    if (((int) this.chatActivityEnterView.getEditField().getPaint().measureText(LocaleController.formatString("StealthModeActiveHint", i4, String.format(locale, "%02d:%02d", 99, 99)))) * 1.2f >= this.chatActivityEnterView.getEditField().getMeasuredWidth()) {
                        ...
                        this.chatActivityEnterView.setOverrideHint(LocaleController.formatString("StealthModeActiveHint", C3634R.string.StealthModeActiveHint, String.format(locale, "%02d:%02d", Integer.valueOf(i2), Integer.valueOf(i3))), z);
                    }
            ...
            this.chatActivityEnterView.setOverrideHint(LocaleController.getString("ReplyPrivately", C3634R.string.ReplyPrivately), z);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:253:0x0622, code lost:
        if (r1.captionTranslated != (r8 != null && r8.translated && r8.translatedText != null && android.text.TextUtils.equals(r8.translatedLng, org.telegram.p043ui.Components.TranslateAlert2.getToLanguage()))) goto L300;
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:291:0x0697  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:409:0x0857  */
    /* JADX WARN: Removed duplicated region for block: B:428:0x08c5  */
    /* JADX WARN: Removed duplicated region for block: B:443:0x0945  */
    ...
    */
    ...
    public /* synthetic */ void lambda$updatePosition$26() {
        if (this.storyViewer.isShown()) {
            ...
            if (this.reactionsLongpressTooltip == null) {
                ...
                this.reactionsLongpressTooltip.setText(LocaleController.getString("ReactionLongTapHint", C3634R.string.ReactionLongTapHint));
                this.reactionsLongpressTooltip.setPadding(AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(1));
    ...
    private void createReplyDisabledView() {
        ...
        this.replyDisabledTextView.setText(LocaleController.getString("StoryReplyDisabled", C3634R.string.StoryReplyDisabled));
    ...
    public void updateUserViews(boolean z) {
        ...
        if (z2 || this.isSelf) {
            if (tL_stories$StoryItem == null) {
                ...
                int i = tL_stories$StoryViews.reactions_count;
                if (i > 0) {
                ...
                if (tL_stories$StoryItem.views.views_count > 0) {
                    this.selfStatusView.setText(this.storyViewer.storiesList == null ? LocaleController.getString("NobodyViews", C3634R.string.NobodyViews) : LocaleController.getString("NobodyViewsArchived", C3634R.string.NobodyViewsArchived));
                    this.selfStatusView.setTranslationX(AndroidUtilities.m104dp(16));
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                    spannableStringBuilder.append((CharSequence) "d  ");
                    spannableStringBuilder.setSpan(new ColoredImageSpan(C3634R.C3636drawable.filled_views), spannableStringBuilder.length() - 3, spannableStringBuilder.length() - 2, 0);
                ...
                if (this.reactionsCounterVisible) {
                    this.likeButtonContainer.getLayoutParams().width = (int) (AndroidUtilities.m104dp(40) + this.reactionsCounter.getAnimateToWidth() + AndroidUtilities.m104dp(4));
                    ((FrameLayout.LayoutParams) this.likeButtonContainer.getLayoutParams()).rightMargin = (AndroidUtilities.m104dp(10) + AndroidUtilities.m104dp(40)) - this.likeButtonContainer.getLayoutParams().width;
                } else {
                    this.likeButtonContainer.getLayoutParams().width = AndroidUtilities.m104dp(40);
                    ((FrameLayout.LayoutParams) this.likeButtonContainer.getLayoutParams()).rightMargin = AndroidUtilities.m104dp(10);
                }
                ...
                if (tL_stories$StoryViews2 != null && tL_stories$StoryViews2.views_count > 0) {
                    ...
                    for (int i3 = 0; i3 < tL_stories$StoryItem.views.recent_viewers.size(); i3++) {
                        TLObject userOrChat = MessagesController.getInstance(this.currentAccount).getUserOrChat(tL_stories$StoryItem.views.recent_viewers.get(i3).longValue());
                        if (userOrChat != null) {
                    ...
                    if (tL_stories$StoryItem.views.reactions_count > 0) {
                        ...
                        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C3634R.C3636drawable.mini_views_likes);
                        coloredImageSpan.setOverrideColor(-53704);
                        coloredImageSpan.setTopOffset(AndroidUtilities.m105dp(0.2f));
                    ...
                    if (i2 == 0) {
                        ...
                        this.selfStatusView.setTranslationX(AndroidUtilities.m104dp(13) + AndroidUtilities.m104dp(24) + (AndroidUtilities.m104dp(20) * (i2 - 1)) + AndroidUtilities.m104dp(10));
                    }
        ...
        if (captionContainerView == null || !captionContainerView.onBackPressed()) {
            ...
            if (customPopupMenu != null && customPopupMenu.isShowing()) {
                ...
                if (chatActivityEnterView != null && chatActivityEnterView.isPopupShowing()) {
                    ...
                    return true;
                } else if (getKeyboardHeight() >= AndroidUtilities.m104dp(20)) {
                    ChatActivityEnterView chatActivityEnterView2 = this.chatActivityEnterView;
                    if (chatActivityEnterView2 != null) {
            ...
            if (hintView22 == null || !hintView22.shown()) {
                for (int i = 0; i < viewGroup.getChildCount(); i++) {
                    ...
                    if (childAt.getVisibility() == 0) {
                        ...
                        StoryMediaAreasView storyMediaAreasView = this.storyAreasView;
                        if (childAt == storyMediaAreasView && !storyMediaAreasView.hasSelected() && (f < AndroidUtilities.m104dp(60) || f > viewGroup.getMeasuredWidth() - AndroidUtilities.m104dp(60))) {
    ...
    public void setActive(long j, boolean z) {
        if (this.isActive != z) {
            ...
            if (z) {
                ...
                if (this.currentStory.storyItem != null) {
                    FileLog.m102d("StoryViewer displayed story dialogId=" + this.dialogId + " storyId=" + this.currentStory.storyItem.f1761id);
                }
            } else {
                cancelTextSelection();
    ...
    */
    ...
    private void showAttachmentError() {
        BulletinFactory.m63of(this.storyContainer, this.resourcesProvider).createErrorBulletin(LocaleController.getString("UnsupportedAttachment", C3634R.string.UnsupportedAttachment), this.resourcesProvider).show();
    }
    ...
    public void showNoSoundHint(boolean z) {
        if (this.soundTooltip == null) {
            ...
            joint.setPadding(AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8), 0);
            this.storyContainer.addView(this.soundTooltip, LayoutHelper.createFrame(-1, -2, 55, 0, 52, 0, 0));
        }
        this.soundTooltip.setText(LocaleController.getString(z ? C3634R.string.StoryNoSound : C3634R.string.StoryTapToSound));
    ...
    public static class PeerHeaderView extends FrameLayout {
        ...
        public PeerHeaderView(Context context, StoryItemHolder storyItemHolder) {
            ...
            backupImageView.setRoundRadius(AndroidUtilities.m104dp(16));
            ...
            this.titleView.setEllipsizeByGradient(AndroidUtilities.m104dp(4));
        ...
        public void setSubtitle(CharSequence charSequence, boolean z) {
            ...
            if (z) {
                ...
                this.subtitleView[0].setTranslationY(-AndroidUtilities.m104dp(4));
        ...
        public /* synthetic */ void lambda$setSubtitle$0(ValueAnimator valueAnimator) {
            ...
            this.subtitleView[0].setTranslationY((-AndroidUtilities.m104dp(4)) * f);
            this.subtitleView[1].setAlpha(f);
            this.subtitleView[1].setTranslationY(floatValue * AndroidUtilities.m104dp(4));
        }
        ...
        public void drawUploadingProgress(Canvas canvas, RectF rectF, boolean z, float f) {
            ...
            float m104dp = AndroidUtilities.m104dp(3) - (AndroidUtilities.m104dp(6) * (1.0f - this.progressToUploading));
            this.radialProgress.setProgressRect((int) (rectF.left - m104dp), (int) (rectF.top - m104dp), (int) (rectF.right + m104dp), (int) (rectF.bottom + m104dp));
            ...
            if (z) {
                ...
                if (this.radialProgressPaint == null) {
                    ...
                    paint.setColor(-1);
                    this.radialProgressPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
    ...
    public class StoryItemHolder {
        ...
        public void updateCaption() {
            ...
            if (uploadingStory != null) {
                ...
                CharSequence replaceEmoji = Emoji.replaceEmoji(charSequence, peerStoriesView.storyCaptionView.captionTextview.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(20), false);
            ...
            if (tL_stories$StoryItem != null) {
                if (tL_stories$StoryItem.translated && tL_stories$StoryItem.translatedText != null && TextUtils.equals(tL_stories$StoryItem.translatedLng, TranslateAlert2.getToLanguage())) {
                    ...
                    this.caption = str;
                    CharSequence replaceEmoji2 = Emoji.replaceEmoji((CharSequence) str, peerStoriesView2.storyCaptionView.captionTextview.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(20), false);
                ...
                this.caption = str2;
                CharSequence replaceEmoji3 = Emoji.replaceEmoji((CharSequence) str2, peerStoriesView3.storyCaptionView.captionTextview.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(20), false);
        ...
        */
        public void checkSendView() {
            /*
                ...
                long r2 = org.telegram.p043ui.Stories.PeerStoriesView.access$5500(r0)
                ...
                long r2 = org.telegram.p043ui.Stories.PeerStoriesView.access$5500(r2)
            ...
            L2a:
                ...
                long r3 = org.telegram.p043ui.Stories.PeerStoriesView.access$5500(r1)
                r1 = 0
                int r1 = r2.get(r3, r1)
                if (r0 > r1) goto L5b
            L55:
            ...
            L5b:
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p043ui.Stories.PeerStoriesView.this
                org.telegram.ui.Stories.StoryViewer r0 = org.telegram.p043ui.Stories.PeerStoriesView.access$6600(r0)
            ...
            L81:
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p043ui.Stories.PeerStoriesView.this
                org.telegram.ui.Stories.StoriesController r2 = r0.storiesController
                long r3 = org.telegram.p043ui.Stories.PeerStoriesView.access$5500(r0)
                org.telegram.tgnet.tl.TL_stories$StoryItem r0 = r5.storyItem
        ...
        public String createLink() {
            ...
            if (peerStoriesView.dialogId > 0) {
                ...
                return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", UserObject.getPublicUsername(user), Integer.valueOf(PeerStoriesView.this.currentStory.storyItem.f1761id));
            }
            ...
            return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", ChatObject.getPublicUsername(chat), Integer.valueOf(PeerStoriesView.this.currentStory.storyItem.f1761id));
        }
    ...
    public static int getStoryId(TL_stories$StoryItem tL_stories$StoryItem, StoriesController.UploadingStory uploadingStory) {
        StoryEntry storyEntry;
        if (tL_stories$StoryItem != null) {
            return tL_stories$StoryItem.f1761id;
        }
        if (uploadingStory == null || (storyEntry = uploadingStory.entry) == null) {
            return 0;
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.realKeyboardHeight < AndroidUtilities.m104dp(20)) {
            this.realKeyboardHeight = 0;
        }
        ...
        boolean z3 = size - size2 > AndroidUtilities.m104dp(64);
        this.BIG_SCREEN = z3;
        int m104dp = (size - ((z3 ? AndroidUtilities.m104dp(64) : 0) + size2)) >> 1;
        layoutParams.topMargin = m104dp;
        if (this.BIG_SCREEN) {
            this.enterViewBottomOffset = (((-m104dp) + size) - size2) - AndroidUtilities.m104dp(64);
        } else {
            this.enterViewBottomOffset = ((-m104dp) + size) - size2;
        }
        FrameLayout frameLayout = this.selfView;
        if (frameLayout != null) {
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) frameLayout.getLayoutParams();
            if (this.BIG_SCREEN) {
                layoutParams2.topMargin = m104dp + size2 + AndroidUtilities.m104dp(8);
            } else {
                layoutParams2.topMargin = (m104dp + size2) - AndroidUtilities.m104dp(48);
            }
        }
        ...
        if (textView != null) {
            ...
            if (!this.BIG_SCREEN) {
                ...
                layoutParams3.topMargin = ((m104dp + size2) - AndroidUtilities.m104dp(12)) - AndroidUtilities.m104dp(40);
            } else {
                this.replyDisabledTextView.setTextColor(ColorUtils.blendARGB(-16777216, -1, 0.5f));
                layoutParams3.topMargin = m104dp + size2 + AndroidUtilities.m104dp(12);
            }
        }
        InstantCameraView instantCameraView = this.instantCameraView;
        if (instantCameraView != null) {
            ...
            if (i3 == 0) {
                layoutParams4.bottomMargin = size - ((m104dp + size2) - AndroidUtilities.m104dp(64));
            } else {
                layoutParams4.bottomMargin = i3 + AndroidUtilities.m104dp(64);
            }
        }
        if (!this.BIG_SCREEN) {
            int i4 = m104dp + size2;
            ((FrameLayout.LayoutParams) this.shareButton.getLayoutParams()).topMargin = (i4 - AndroidUtilities.m104dp(12)) - AndroidUtilities.m104dp(40);
            ((FrameLayout.LayoutParams) this.likeButtonContainer.getLayoutParams()).topMargin = (i4 - AndroidUtilities.m104dp(12)) - AndroidUtilities.m104dp(40);
            int m104dp2 = this.isSelf ? AndroidUtilities.m104dp(40) : AndroidUtilities.m104dp(56);
            ((FrameLayout.LayoutParams) this.storyCaptionView.getLayoutParams()).bottomMargin = m104dp2;
            this.storyCaptionView.blackoutBottomOffset = m104dp2;
        } else {
            int i5 = m104dp + size2;
            ((FrameLayout.LayoutParams) this.shareButton.getLayoutParams()).topMargin = AndroidUtilities.m104dp(12) + i5;
            ((FrameLayout.LayoutParams) this.likeButtonContainer.getLayoutParams()).topMargin = i5 + AndroidUtilities.m104dp(12);
            ((FrameLayout.LayoutParams) this.storyCaptionView.getLayoutParams()).bottomMargin = AndroidUtilities.m104dp(8);
            this.storyCaptionView.blackoutBottomOffset = AndroidUtilities.m104dp(8);
        }
        this.forceUpdateOffsets = true;
        float m104dp3 = AndroidUtilities.m104dp(8) + AndroidUtilities.m104dp(40);
        if (this.privacyButton.getVisibility() == 0) {
            m104dp3 += AndroidUtilities.m104dp(60);
        }
        if (this.muteIconContainer.getVisibility() == 0) {
            m104dp3 += AndroidUtilities.m104dp(40);
        }
        FrameLayout.LayoutParams layoutParams5 = (FrameLayout.LayoutParams) this.headerView.titleView.getLayoutParams();
        if (layoutParams5.rightMargin != m104dp3) {
            int i6 = (int) m104dp3;
    ...
    private void updateViewOffsets() {
        ...
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            ...
            if (childAt.getVisibility() != 0 || childAt == this.selfView || childAt.getTag(C3634R.C3637id.parent_tag) != null || childAt == this.storyCaptionView.textSelectionHelper.getOverlayView(getContext())) {
                ...
                if (chatActivityEnterView5 != null && childAt == chatActivityEnterView5.getEmojiView()) {
                    ...
                    float m104dp = ((((-this.enterViewBottomOffset) * (1.0f - this.progressToKeyboard)) - this.animatingKeyboardHeight) - (AndroidUtilities.m104dp(8) * (1.0f - this.progressToKeyboard))) - (AndroidUtilities.m104dp(20) * this.storyViewer.swipeToReplyProgress);
                    ...
                    if (childAt == this.replyDisabledTextView) {
                        m104dp = (-AndroidUtilities.m104dp(20)) * this.storyViewer.swipeToReplyProgress;
                    }
                    if (childAt == this.mentionContainer) {
                        m104dp -= this.chatActivityEnterView.getMeasuredHeight() - this.chatActivityEnterView.getAnimatedTop();
                    ...
                    if (childAt == this.reactionsContainerLayout) {
                        ...
                        childAt.setTranslationY(m104dp);
                        childAt.setAlpha(f5);
                    }
                }
            }
        ...
        if (chatActivityEnterView6 != null) {
            chatActivityEnterView6.setHorizontalPadding(AndroidUtilities.m104dp(10), this.progressToKeyboard, this.allowShare);
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == chatActivityEnterView) {
            this.sharedResources.rect1.set(BitmapDescriptorFactory.HUE_RED, this.chatActivityEnterView.getY() + this.chatActivityEnterView.getAnimatedTop(), getMeasuredWidth() + AndroidUtilities.m104dp(20), getMeasuredHeight());
            this.sharedResources.rect2.set(AndroidUtilities.m104dp(10), (this.chatActivityEnterView.getBottom() - AndroidUtilities.m104dp(48)) + this.chatActivityEnterView.getTranslationY() + AndroidUtilities.m104dp(2), (getMeasuredWidth() - AndroidUtilities.m104dp(10)) - ((this.allowShare ? AndroidUtilities.m105dp(46.0f) : 0) + AndroidUtilities.m104dp(40)), (this.chatActivityEnterView.getY() + this.chatActivityEnterView.getMeasuredHeight()) - AndroidUtilities.m104dp(2));
            if (this.chatActivityEnterView.getMeasuredHeight() > AndroidUtilities.m104dp(50)) {
                this.chatActivityEnterView.getEditField().setTranslationY((1.0f - this.progressToKeyboard) * (this.chatActivityEnterView.getMeasuredHeight() - AndroidUtilities.m104dp(50)));
            } else {
                this.chatActivityEnterView.getEditField().setTranslationY(BitmapDescriptorFactory.HUE_RED);
            }
            float m104dp = (AndroidUtilities.m104dp(50) / 2.0f) * (1.0f - this.progressToKeyboard);
            ...
            if (f > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.drawRoundRect(this.sharedResources.finalRect, m104dp, m104dp, this.bitmapShaderTools.paint);
            }
            canvas.drawRoundRect(this.sharedResources.finalRect, m104dp, m104dp, this.inputBackgroundPaint);
            ...
            if (view == reactionsContainerLayout && this.chatActivityEnterView != null) {
                view.setTranslationY(((-reactionsContainerLayout.getMeasuredHeight()) + (this.chatActivityEnterView.getY() + this.chatActivityEnterView.getAnimatedTop())) - AndroidUtilities.m104dp(18));
                ...
                if (view == reactionsContainerLayout2) {
                    view.setTranslationY(((-(reactionsContainerLayout2.getMeasuredHeight() - this.likesReactionLayout.getPaddingBottom())) + this.likeButtonContainer.getY()) - AndroidUtilities.m104dp(18));
                }
            }
        }
        return super.drawChild(canvas, view, j);
    ...
    public void afterMessageSend() {
        ...
        BulletinFactory m63of = BulletinFactory.m63of(this.storyContainer, this.resourcesProvider);
        if (m63of != null) {
            m63of.createSimpleBulletin(C3634R.raw.forward, LocaleController.getString("MessageSent", C3634R.string.MessageSent), LocaleController.getString("ViewInChat", C3634R.string.ViewInChat), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS, new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda30
                @Override // java.lang.Runnable
                public final void run() {
    ...
    void checkReactionsLayout() {
        if (this.reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout.setHint(LocaleController.getString("StoryReactionsHint", C3634R.string.StoryReactionsHint));
            ReactionsContainerLayout reactionsContainerLayout2 = this.reactionsContainerLayout;
            ...
            this.reactionsContainerLayout.setDelegate(new C708433());
            this.reactionsContainerLayout.setMessage(null, null);
        }
    ...
    /* loaded from: classes6.dex */
    public class C708433 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        ...
        void onReactionClickedInternal(final View view, final ReactionsLayoutInBubble.VisibleReaction visibleReaction, final boolean z, final boolean z2, boolean z3) {
            ...
            if (z3 && PeerStoriesView.this.applyMessageToChat(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$33$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C708433.this.lambda$onReactionClickedInternal$0(view, visibleReaction, z, z2);
                }
            })) {
                return;
            }
            ...
            reactionsEffectOverlay.windowView.setTag(C3634R.C3637id.parent_tag, 1);
            ...
            if (visibleReaction2.emojicon != null) {
                ...
                SendMessagesHelper.SendMessageParams m92of = SendMessagesHelper.SendMessageParams.m92of(visibleReaction2.emojicon, PeerStoriesView.this.dialogId, null);
                PeerStoriesView peerStoriesView3 = PeerStoriesView.this;
                m92of.replyToStoryItem = peerStoriesView3.currentStory.storyItem;
                SendMessagesHelper.getInstance(peerStoriesView3.currentAccount).sendMessage(m92of);
            } else {
                ...
                SendMessagesHelper.SendMessageParams m92of2 = SendMessagesHelper.SendMessageParams.m92of(findAnimatedEmojiEmoticon, PeerStoriesView.this.dialogId, null);
                m92of2.entities = new ArrayList<>();
                ...
                m92of2.entities.add(tLRPC$TL_messageEntityCustomEmoji);
                PeerStoriesView peerStoriesView4 = PeerStoriesView.this;
                m92of2.replyToStoryItem = peerStoriesView4.currentStory.storyItem;
                SendMessagesHelper.getInstance(peerStoriesView4.currentAccount).sendMessage(m92of2);
                tLRPC$Document = findDocument;
            }
            PeerStoriesView peerStoriesView5 = PeerStoriesView.this;
            BulletinFactory.m63of(peerStoriesView5.storyContainer, peerStoriesView5.resourcesProvider).createEmojiBulletin(tLRPC$Document, LocaleController.getString("ReactionSent", C3634R.string.ReactionSent), LocaleController.getString("ViewInChat", C3634R.string.ViewInChat), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$33$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C708433.this.lambda$onReactionClickedInternal$1();
                }
    ...
    void checkReactionsLayoutForLike() {
        ...
        if (reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout2.setPadding(0, 0, 0, AndroidUtilities.m104dp(22));
            ...
            this.likesReactionLayout.setDelegate(new C708635());
    ...
    /* loaded from: classes6.dex */
    public class C708635 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        @Override // org.telegram.p043ui.Components.ReactionsContainerLayout.ReactionsContainerDelegate
        public /* synthetic */ boolean drawBackground() {
            return ReactionsContainerLayout.ReactionsContainerDelegate.CC.$default$drawBackground(this);
        }
        ...
        public void onReactionClicked(final View view, final ReactionsLayoutInBubble.VisibleReaction visibleReaction, boolean z, boolean z2) {
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$35$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C708635.this.lambda$onReactionClicked$1(visibleReaction, view);
                }
            };
            if (!z) {
        ...
        public /* synthetic */ void lambda$onReactionClicked$1(ReactionsLayoutInBubble.VisibleReaction visibleReaction, View view) {
            ...
            PeerStoriesView.this.storiesLikeButton.setPadding(m104dp, m104dp, m104dp, m104dp);
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$35$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    PeerStoriesView.C708635.this.lambda$onReactionClicked$0(ofFloat, zArr, valueAnimator);
                }
            });
    ...
    public static class SharedResources {
        ...
        public SharedResources(Context context) {
            this.shareDrawable = ContextCompat.getDrawable(context, C3634R.C3636drawable.media_share);
            this.likeDrawable = ContextCompat.getDrawable(context, C3634R.C3636drawable.media_like);
            Drawable drawable = ContextCompat.getDrawable(context, C3634R.C3636drawable.media_like_active);
            this.likeDrawableFilled = drawable;
            drawable.setColorFilter(new PorterDuffColorFilter(-53704, PorterDuff.Mode.MULTIPLY));
            this.optionsDrawable = ContextCompat.getDrawable(context, C3634R.C3636drawable.media_more);
            this.deleteDrawable = ContextCompat.getDrawable(context, C3634R.C3636drawable.msg_delete);
            int i = C3634R.raw.media_mute_unmute;
            this.muteDrawable = new RLottieDrawable(i, "media_mute_unmute", AndroidUtilities.m104dp(28), AndroidUtilities.m104dp(28), true, null);
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "media_mute_unmute", AndroidUtilities.m104dp(28), AndroidUtilities.m104dp(28), true, null);
            ...
            this.topOverlayGradient = ContextCompat.getDrawable(context, C3634R.C3636drawable.shadow_story_top);
            this.bottomOverlayGradient = ContextCompat.getDrawable(context, C3634R.C3636drawable.shadow_story_bottom);
    ...
    public void editPrivacy(StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy, final TL_stories$StoryItem tL_stories$StoryItem) {
        this.delegate.showDialog(new StoryPrivacyBottomSheet(getContext(), tL_stories$StoryItem.pinned ? Integer.MAX_VALUE : tL_stories$StoryItem.expire_date - tL_stories$StoryItem.date, this.resourcesProvider).setValue(storyPrivacy).enableSharing(false).isEdit(true).whenSelectedRules(new StoryPrivacyBottomSheet.DoneCallback() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda35
            ...
            public final void done(StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy2, boolean z, boolean z2, TLRPC$InputPeer tLRPC$InputPeer, Runnable runnable) {
                PeerStoriesView.this.lambda$editPrivacy$32(tL_stories$StoryItem, storyPrivacy2, z, z2, tLRPC$InputPeer, runnable);
            }
        }, false));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$editPrivacy$32(final TL_stories$StoryItem tL_stories$StoryItem, final StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy, boolean z, boolean z2, TLRPC$InputPeer tLRPC$InputPeer, final Runnable runnable) {
        ...
        tL_stories$TL_stories_editStory.f1769id = tL_stories$StoryItem.f1761id;
        tL_stories$TL_stories_editStory.flags |= 4;
        tL_stories$TL_stories_editStory.privacy_rules = storyPrivacy.rules;
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_stories$TL_stories_editStory, new RequestDelegate() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda34
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                PeerStoriesView.this.lambda$editPrivacy$31(runnable, tL_stories$StoryItem, storyPrivacy, tLObject, tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$editPrivacy$31(final Runnable runnable, final TL_stories$StoryItem tL_stories$StoryItem, final StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda31
            @Override // java.lang.Runnable
            public final void run() {
                PeerStoriesView.this.lambda$editPrivacy$30(runnable, tLRPC$TL_error, tL_stories$StoryItem, storyPrivacy);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$editPrivacy$30(Runnable runnable, TLRPC$TL_error tLRPC$TL_error, TL_stories$StoryItem tL_stories$StoryItem, StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy) {
        if (runnable != null) {
            runnable.run();
        }
        if (tLRPC$TL_error == null || "STORY_NOT_MODIFIED".equals(tLRPC$TL_error.text)) {
            ...
            if (i2 == 4) {
                BulletinFactory.m63of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3634R.raw.contact_check, LocaleController.getString("StorySharedToEveryone")).show();
            } else if (i2 == 1) {
                BulletinFactory.m63of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3634R.raw.contact_check, LocaleController.getString("StorySharedToCloseFriends")).show();
            } else if (i2 == 2) {
                if (storyPrivacy.selectedUserIds.isEmpty()) {
                    BulletinFactory.m63of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3634R.raw.contact_check, LocaleController.getString("StorySharedToAllContacts")).show();
                } else {
                    BulletinFactory.m63of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3634R.raw.contact_check, LocaleController.formatPluralString("StorySharedToAllContactsExcluded", storyPrivacy.selectedUserIds.size(), new Object[0])).show();
                }
            } else if (i2 == 3) {
                HashSet hashSet = new HashSet();
                ...
                BulletinFactory.m63of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3634R.raw.contact_check, LocaleController.formatPluralString("StorySharedToContacts", hashSet.size(), new Object[0])).show();
            }
        } else {
            BulletinFactory.m63of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C3634R.raw.error, LocaleController.getString("UnknownError", C3634R.string.UnknownError)).show();
        }
        updatePosition();
    }
    ...
    public boolean checkRecordLocked(final boolean z) {
        ...
        if (this.chatActivityEnterView.isInVideoMode()) {
            builder.setTitle(LocaleController.getString("DiscardVideoMessageTitle", C3634R.string.DiscardVideoMessageTitle));
            builder.setMessage(LocaleController.getString("DiscardVideoMessageDescription", C3634R.string.DiscardVideoMessageDescription));
        } else {
            builder.setTitle(LocaleController.getString("DiscardVoiceMessageTitle", C3634R.string.DiscardVoiceMessageTitle));
            builder.setMessage(LocaleController.getString("DiscardVoiceMessageDescription", C3634R.string.DiscardVoiceMessageDescription));
        }
        builder.setPositiveButton(LocaleController.getString("DiscardVoiceMessageAction", C3634R.string.DiscardVoiceMessageAction), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda5
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                PeerStoriesView.this.lambda$checkRecordLocked$33(z, dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Continue", C3634R.string.Continue), null);
        this.delegate.showDialog(builder.create());
        return true;
    }
    ...
    public void animateOut(final boolean z) {
        ...
        this.outAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.36
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                PeerStoriesView.this.headerView.setTranslationY((-AndroidUtilities.m104dp(8)) * PeerStoriesView.this.outT);
                PeerStoriesView peerStoriesView = PeerStoriesView.this;
                peerStoriesView.headerView.setAlpha(1.0f - peerStoriesView.outT);
                PeerStoriesView.this.optionsIconView.setTranslationY((-AndroidUtilities.m104dp(8)) * PeerStoriesView.this.outT);
                PeerStoriesView.this.optionsIconView.setAlpha(1.0f - PeerStoriesView.this.outT);
                PeerStoriesView.this.muteIconContainer.setTranslationY((-AndroidUtilities.m104dp(8)) * PeerStoriesView.this.outT);
                ...
                if (PeerStoriesView.this.selfView != null) {
                    PeerStoriesView.this.selfView.setTranslationY(AndroidUtilities.m104dp(8) * PeerStoriesView.this.outT);
                    PeerStoriesView.this.selfView.setAlpha(1.0f - PeerStoriesView.this.outT);
                }
                if (PeerStoriesView.this.privacyButton != null) {
                    PeerStoriesView.this.privacyButton.setTranslationY((-AndroidUtilities.m104dp(8)) * PeerStoriesView.this.outT);
    ...
    public /* synthetic */ void lambda$animateOut$34(ValueAnimator valueAnimator) {
        ...
        this.headerView.setTranslationY((-AndroidUtilities.m104dp(8)) * this.outT);
        this.headerView.setAlpha(1.0f - this.outT);
        this.optionsIconView.setTranslationY((-AndroidUtilities.m104dp(8)) * this.outT);
        this.optionsIconView.setAlpha(1.0f - this.outT);
        this.muteIconContainer.setTranslationY((-AndroidUtilities.m104dp(8)) * this.outT);
        this.muteIconContainer.setAlpha(this.muteIconViewAlpha * (1.0f - this.outT));
        FrameLayout frameLayout = this.selfView;
        if (frameLayout != null) {
            frameLayout.setTranslationY(AndroidUtilities.m104dp(8) * this.outT);
            this.selfView.setAlpha(1.0f - this.outT);
        }
        StoryPrivacyButton storyPrivacyButton = this.privacyButton;
        if (storyPrivacyButton != null) {
            storyPrivacyButton.setTranslationY((-AndroidUtilities.m104dp(8)) * this.outT);
