...
public class StoryLinesDrawable {
    ...
    public StoryLinesDrawable(View view, PeerStoriesView.SharedResources sharedResources) {
        ...
        textPaint.setShadowLayer(AndroidUtilities.m107dp(3), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(1), C0483C.ENCODING_PCM_32BIT);
    ...
    public void draw(Canvas canvas, int i, int i2, float f, int i3, float f2, float f3, boolean z, boolean z2, float f4) {
        ...
        float m107dp2 = ((i - AndroidUtilities.m107dp(10)) - ((i7 - 1) * m107dp)) / i7;
        AndroidUtilities.m107dp(5);
        float min = Math.min(m107dp2 / 2.0f, AndroidUtilities.m107dp(1));
        ...
        if (i8 > 0) {
            ...
            paint = paint5;
            i4 = i8;
            storyLinesDrawable.zoomHintPaint.setShadowLayer(AndroidUtilities.m107dp(3), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(1), Theme.multAlpha(C0483C.ENCODING_PCM_32BIT, f8));
            canvas.translate(((i - storyLinesDrawable.zoomHintLayoutWidth) / 2.0f) - storyLinesDrawable.zoomHintLayoutLeft, AndroidUtilities.lerp(AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(16), f8));
        ...
        int i9 = 0;
        while (i9 < i7) {
            float m107dp3 = AndroidUtilities.m107dp(5) + (-0.0f) + (m107dp * i9) + (i9 * m107dp2);
            if (m107dp3 <= i) {
                float f10 = m107dp3 + m107dp2;
                if (f10 >= BitmapDescriptorFactory.HUE_RED && f3 > BitmapDescriptorFactory.HUE_RED) {
                    ...
                    if (i9 > i2 || i9 != i2) {
                        ...
                        i5 = m107dp;
                        f6 = m107dp2;
                        rectF.set(m107dp3, BitmapDescriptorFactory.HUE_RED, f10, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i9 ? 1 : 0) * f8));
                        if (z3) {
                        ...
                        if (i4 > 0) {
                            int i10 = i9 - i2;
                            rectF.left = Utilities.clamp(AndroidUtilities.lerp(rectF.left, (i10 * i) + AndroidUtilities.m107dp(5), f8), i - AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(5));
                            rectF.right = Utilities.clamp(AndroidUtilities.lerp(rectF.right, ((i10 + 1) * i) - AndroidUtilities.m107dp(5), f8), i - AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(5));
                        }
                        canvas.drawRoundRect(rectF, lerp2, lerp2, paint4);
                        f7 = f9;
                    }
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    rectF2.set(m107dp3, BitmapDescriptorFactory.HUE_RED, f10, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i9 ? 1 : 0) * f8));
                    if (i4 > 0) {
                        int i11 = i9 - i2;
                        rectF2.left = Utilities.clamp(AndroidUtilities.lerp(rectF2.left, (i11 * i) + AndroidUtilities.m107dp(5), f8), i - AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(5));
                        rectF2.right = Utilities.clamp(AndroidUtilities.lerp(rectF2.right, ((i11 + 1) * i) - AndroidUtilities.m107dp(5), f8), i - AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(5));
                    }
