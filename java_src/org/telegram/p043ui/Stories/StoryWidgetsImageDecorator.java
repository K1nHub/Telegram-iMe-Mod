...
public class StoryWidgetsImageDecorator extends ImageReceiver.Decorator {
    ...
    public class ReactionWidget extends DrawingObject {
        ...
        public void draw(Canvas canvas, ImageReceiver imageReceiver, float f) {
            ...
            float f3 = (float) (storyWidgetsImageDecorator.imageX + ((f2 * tL_stories$TL_mediaAreaCoordinates.f1765x) / 100.0d));
            float f4 = storyWidgetsImageDecorator.imageH;
            float f5 = (float) (storyWidgetsImageDecorator.imageY + ((f4 * tL_stories$TL_mediaAreaCoordinates.f1766y) / 100.0d));
            float f6 = (float) ((f4 * tL_stories$TL_mediaAreaCoordinates.f1763h) / 100.0d);
            float f7 = ((float) ((f2 * tL_stories$TL_mediaAreaCoordinates.f1764w) / 100.0d)) / 2.0f;
            float f8 = f6 / 2.0f;
