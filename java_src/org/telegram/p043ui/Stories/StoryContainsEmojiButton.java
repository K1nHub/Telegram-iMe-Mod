...
public class StoryContainsEmojiButton extends View {
    ...
    public StoryContainsEmojiButton(Context context, int i, TLObject tLObject, Object obj, boolean z, ArrayList<TLRPC$InputStickerSet> arrayList, Theme.ResourcesProvider resourcesProvider) {
        ...
        setMinimumWidth(AndroidUtilities.m104dp(196));
        setPadding(AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(8));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int m104dp = AndroidUtilities.m104dp(29);
        StaticLayout staticLayout = this.layout;
        setMeasuredDimension(z ? View.MeasureSpec.getSize(i) : getMinimumWidth(), paddingTop + AndroidUtilities.lerp(m104dp, staticLayout == null ? AndroidUtilities.m104dp(29) : staticLayout.getHeight(), this.loadT) + getPaddingBottom());
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (f < 1.0f) {
            ...
            this.loadingPath.addRect(getPaddingLeft(), getPaddingTop(), getMeasuredWidth() - getPaddingRight(), getPaddingTop() + AndroidUtilities.m104dp(12), Path.Direction.CW);
            this.loadingPath.addRect(getPaddingLeft(), getPaddingTop() + AndroidUtilities.m104dp(16), getPaddingLeft() + (((getMeasuredWidth() - getPaddingRight()) - getPaddingLeft()) * 0.46f), getPaddingTop() + AndroidUtilities.m104dp(28), Path.Direction.CW);
    ...
    private void animateLoad(boolean z) {
        ...
        if (z) {
            ...
            if (this.layout == null || Math.abs(getMeasuredHeight() - ((getPaddingTop() + this.layout.getHeight()) + getPaddingBottom())) > AndroidUtilities.m104dp(3)) {
                z2 = true;
            }
