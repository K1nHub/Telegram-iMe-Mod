...
public class StoryViewer implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void open(Context context, TL_stories$StoryItem tL_stories$StoryItem, ArrayList<Long> arrayList, int i, StoriesController.StoriesList storiesList, TL_stories$PeerStories tL_stories$PeerStories, PlaceProvider placeProvider, boolean z) {
        ...
        if (this.windowView == null) {
            ...
            this.windowView = new C73152(context, lastFragment);
        }
        if (this.containerView == null) {
            this.containerView = new HwFrameLayout(context) { // from class: org.telegram.ui.Stories.StoryViewer.3
                ...
                protected void dispatchDraw(Canvas canvas) {
                    ...
                    if (currentPeerView != null) {
                        StoryViewer.this.volumeControl.setTranslationY(currentPeerView.storyContainer.getY() - AndroidUtilities.m107dp(4));
                    }
            ...
            hwStoriesViewPager.setDelegate(new C73215(storiesList, arrayList));
    ...
    /* loaded from: classes6.dex */
    public class C73152 extends SizeNotifierFrameLayout {
        float lastTouchX;
        ...
        C73152(Context context, BaseFragment baseFragment) {
            super(context);
        ...
        */
        public void dispatchDraw(android.graphics.Canvas r18) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Stories.StoryViewer.C73152.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        public boolean dispatchTouchEvent(MotionEvent motionEvent) {
            ...
            if (currentPeerView == null || !currentPeerView.checkTextSelectionEvent(motionEvent)) {
                    ...
                    if (f != BitmapDescriptorFactory.HUE_RED) {
                        ...
                        StoryViewer.this.swipeToDissmissBackAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.StoryViewer$2$$ExternalSyntheticLambda0
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                StoryViewer.C73152.this.lambda$dispatchTouchEvent$0(valueAnimator);
                            }
                        });
                ...
                if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                    ...
                    if (storyViewer10.selfStoriesViewsOffset != BitmapDescriptorFactory.HUE_RED && !storyViewer10.flingCalled && StoryViewer.this.realKeyboardHeight < AndroidUtilities.m107dp(20)) {
        ...
        */
        public boolean onInterceptTouchEvent(android.view.MotionEvent r15) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Stories.StoryViewer.C73152.onInterceptTouchEvent(android.view.MotionEvent):boolean");
        }
                ...
                if (storyViewer2.progressToDismiss < 1.0f) {
                    if (!storyViewer2.isClosed) {
                        ...
                        StoryViewer.this.swipeToDissmissBackAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.StoryViewer$2$$ExternalSyntheticLambda1
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                StoryViewer.C73152.this.lambda$onTouchEvent$2(valueAnimator);
                            }
                        });
        ...
        public void onAttachedToWindow() {
            ...
            Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.Stories.StoryViewer.2.3
                ...
                public int getBottomOffset(int i) {
                    ...
                    return (int) (C73152.this.getMeasuredHeight() - (this.position[1] + currentPeerView.storyContainer.getMeasuredHeight()));
                }
            });
        ...
        protected void onMeasure(int i, int i2) {
            ((FrameLayout.LayoutParams) StoryViewer.this.volumeControl.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight - AndroidUtilities.m107dp(2);
            StoryViewer.this.volumeControl.getLayoutParams().height = AndroidUtilities.m107dp(2);
    ...
    /* loaded from: classes6.dex */
    public class C73215 implements PeerStoriesView.Delegate {
        final /* synthetic */ ArrayList val$peerIds;
        final /* synthetic */ StoriesController.StoriesList val$storiesList;

        C73215(StoriesController.StoriesList storiesList, ArrayList arrayList) {
            ...
            if (this.val$storiesList != null) {
                ...
                if (indexOf >= 0) {
                    ...
                    storiesViewPager.onNextIdle(new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$5$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            StoryViewer.C73215.this.lambda$switchToNextAndRemoveCurrentPeer$0(storiesList, arrayList);
                        }
                    });
                    return;
                }
            ...
            if (indexOf2 >= 0) {
                ...
                if (!StoryViewer.this.storiesViewPager.switchToNext(true)) {
                    ...
                    StoryViewer.this.storiesViewPager.onNextIdle(new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$5$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            StoryViewer.C73215.this.lambda$switchToNextAndRemoveCurrentPeer$1(arrayList2, indexOf2);
                        }
                    });
                    return;
                }
            ...
            if (SharedConfig.deviceIsHigh() && SharedConfig.allowPreparingHevcPlayers() && !StoryViewer.this.isClosed) {
                ...
                for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                    ...
                    videoPlayerHolder.setOnSeekUpdate(new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$5$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            StoryViewer.C73215.this.lambda$preparePlayer$2(videoPlayerHolder);
                        }
                    });
    ...
    public /* synthetic */ void lambda$cancelSwipeToReply$3(ValueAnimator valueAnimator) {
        ...
        this.swipeToReplyProgress = Utilities.clamp(this.swipeToReplyOffset / AndroidUtilities.m107dp(200), 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
        StoriesViewPager storiesViewPager = this.storiesViewPager;
    ...
    private void updateTransitionParams() {
        if (this.placeProvider != null) {
            ...
            int i = (currentPeerView == null || selectedPosition < 0 || selectedPosition >= currentPeerView.storyItems.size()) ? 0 : currentPeerView.storyItems.get(selectedPosition).f1763id;
    ...
    public void updateProgressToDismiss() {
        ...
        if (f != BitmapDescriptorFactory.HUE_RED) {
            clamp = MathUtils.clamp(Math.abs(f / AndroidUtilities.m107dp(80)), (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
        } else {
            clamp = MathUtils.clamp(Math.abs(this.swipeToDismissOffset / AndroidUtilities.m107dp(80)), (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
        }
    ...
    public void startOpenAnimation() {
        ...
        this.openCloseAnimator.addListener(new C731110());
    ...
    /* loaded from: classes6.dex */
    public class C731110 extends AnimatorListenerAdapter {
        C731110() {
        }
            ...
            if (!SharedConfig.storiesIntroShown) {
                ...
                StoryViewer.this.storiesIntro.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.StoryViewer$10$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        StoryViewer.C731110.this.lambda$onAnimationEnd$0(view);
                    }
                });
    ...
    public /* synthetic */ void lambda$startCloseAnimation$7() {
        ...
        this.containerView.enableHwAcceleration();
        this.openCloseAnimator.addListener(new C731411());
    ...
    /* loaded from: classes6.dex */
    public class C731411 extends AnimatorListenerAdapter {
        C731411() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            try {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$11$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        StoryViewer.C731411.this.lambda$onAnimationEnd$0();
                    }
                });
            } catch (Exception unused) {
            }
            ...
            if (this.storiesList == ((StoriesController.StoriesList) objArr[0])) {
                ...
                if (selfStoryViewsView != null) {
                    ...
                    while (i3 < this.storiesList.messageObjects.size()) {
                        if (selectedStory != null && selectedStory.f1763id == this.storiesList.messageObjects.get(i3).storyItem.f1763id) {
                            i4 = i3;
                        }
    ...
    private long draftHash(long j, TL_stories$StoryItem tL_stories$StoryItem) {
        return j + (j >> 16) + (tL_stories$StoryItem.f1763id << 16);
    }
    ...
    public class VideoPlayerHolder extends VideoPlayerHolderBase {
        ...
        public /* synthetic */ void lambda$onStateChanged$0() {
            ...
            FileLog.m105d("StoryViewer displayed story buffering dialogId=" + currentPeerView.getCurrentPeer() + " storyId=" + currentPeerView.currentStory.storyItem.f1763id);
        }
        ...
        public /* synthetic */ void lambda$onStateChanged$1() {
            ...
            FileLog.m105d("StoryViewer displayed story playing dialogId=" + currentPeerView.getCurrentPeer() + " storyId=" + currentPeerView.currentStory.storyItem.f1763id);
        }
    }
}
