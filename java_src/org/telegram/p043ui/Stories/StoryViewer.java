        ...
        */
        ...
        public boolean dispatchTouchEvent(MotionEvent motionEvent) {
            ...
            if (currentPeerView == null || !currentPeerView.checkTextSelectionEvent(motionEvent)) {
                ...
                if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                    ...
                    if (storyViewer10.selfStoriesViewsOffset != BitmapDescriptorFactory.HUE_RED && !storyViewer10.flingCalled && StoryViewer.this.realKeyboardHeight < AndroidUtilities.m72dp(20)) {
        ...
        public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
            if (motionEvent.getAction() == 0 && StoryViewer.this.progressToOpen == 1.0f) {
                ...
                int i = (abs > Math.abs(this.startX - motionEvent.getX()) ? 1 : (abs == Math.abs(this.startX - motionEvent.getX()) ? 0 : -1));
                if (i > 0) {
                    StoryViewer storyViewer6 = StoryViewer.this;
                ...
                if (!storyViewer7.inSwipeToDissmissMode && !storyViewer7.keyboardVisible && storyViewer7.allowSwipeToDissmiss) {
                    if (i > 0 && abs > AndroidUtilities.touchSlop * 2.0f) {
                        ...
                        StoryViewer storyViewer9 = StoryViewer.this;
                        storyViewer9.swipeToReplyOffset = BitmapDescriptorFactory.HUE_RED;
