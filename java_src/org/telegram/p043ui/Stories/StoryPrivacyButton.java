...
public class StoryPrivacyButton extends View {
    ...
    private void setupGradient(int i, int i2) {
        ...
        this.topColor = i;
        this.bottomColor = i2;
        LinearGradient linearGradient = new LinearGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(23), new int[]{i, i2}, new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f}, Shader.TileMode.CLAMP);
        this.gradientMatrix.reset();
        this.gradientMatrix.postTranslate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(8));
    ...
    protected void onDraw(Canvas canvas) {
        if (this.draw) {
            ...
            if (f > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(12), AndroidUtilities.m107dp(12), this.backgroundPaint[1]);
            }
            if (f < 1.0f) {
                this.backgroundPaint[0].setAlpha((int) ((1.0f - f) * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(12), AndroidUtilities.m107dp(12), this.backgroundPaint[0]);
            }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(60), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(40), 1073741824));
    }

    public float getCenterX() {
        return getX() + (getWidth() / 2.0f) + (this.drawArrow ? 0 : AndroidUtilities.m107dp(14));
    }
}
