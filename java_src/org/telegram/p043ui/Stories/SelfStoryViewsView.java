...
public class SelfStoryViewsView extends FrameLayout {
    ...
    public SelfStoryViewsView(Context context, final StoryViewer storyViewer) {
        ...
        ViewPagerInner viewPagerInner = new ViewPagerInner(context) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.2
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (!checkTopOffset(motionEvent) && Math.abs(SelfStoryViewsView.this.getCurrentTopOffset() - SelfStoryViewsView.this.bottomPadding) <= AndroidUtilities.m72dp(1)) {
    ...
    public void setKeyboardHeight(int i) {
        ...
        boolean z = this.keyboardHeight >= AndroidUtilities.m72dp(20);
        boolean z2 = i >= AndroidUtilities.m72dp(20);
        if (z2 != z) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float m72dp = (((i3 + AndroidUtilities.m72dp(20)) + this.toHeight) + AndroidUtilities.m72dp(24)) - AndroidUtilities.statusBarHeight;
