...
public class SelfStoryViewsView extends FrameLayout {
    ...
    public SelfStoryViewsView(final Context context, final StoryViewer storyViewer) {
        ...
        viewPagerInner.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: org.telegram.ui.Stories.SelfStoryViewsView.2
        ...
        PagerAdapter pagerAdapter = new PagerAdapter() { // from class: org.telegram.ui.Stories.SelfStoryViewsView.3
            ...
            public Object instantiateItem(ViewGroup viewGroup, int i) {
                SelfStoryViewsPage selfStoryViewsPage = new SelfStoryViewsPage(storyViewer, context) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.3.1
                    @Override // android.view.ViewGroup, android.view.View
                    protected void dispatchDraw(Canvas canvas) {
                        SelfStoryViewsView.this.shadowDrawable.setBounds(-AndroidUtilities.m72dp(6), 0, getMeasuredWidth() + AndroidUtilities.m72dp(6), getMeasuredHeight());
                        SelfStoryViewsView.this.shadowDrawable.draw(canvas);
                        super.dispatchDraw(canvas);
                    }
                };
                selfStoryViewsPage.setPadding(0, AndroidUtilities.m72dp(16), 0, 0);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.toY = AndroidUtilities.m72dp(20) + i3;
        float m72dp = i3 + AndroidUtilities.m72dp(20) + this.toHeight + AndroidUtilities.m72dp(24);
        this.bottomPadding = m72dp;
        this.maxSelfStoriesViewsOffset = size - m72dp;
    ...
    public void setItems(ArrayList<TLRPC$StoryItem> arrayList, int i) {
        ...
        ArrayList<StoriesController.UploadingStory> uploadingStories = MessagesController.getInstance(this.storyViewer.currentAccount).getStoriesController().getUploadingStories();
