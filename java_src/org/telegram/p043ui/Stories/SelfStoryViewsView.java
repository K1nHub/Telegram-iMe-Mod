...
public class SelfStoryViewsView extends FrameLayout {
    ...
    public SelfStoryViewsView(Context context, final StoryViewer storyViewer) {
        ...
        ViewPagerInner viewPagerInner = new ViewPagerInner(context) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.2
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (!checkTopOffset(motionEvent) && Math.abs(SelfStoryViewsView.this.getCurrentTopOffset() - SelfStoryViewsView.this.bottomPadding) <= AndroidUtilities.m104dp(1)) {
    ...
    public class C71224 extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            selfStoryViewsPage.setPadding(0, AndroidUtilities.m104dp(16), 0, 0);
    ...
    public void setKeyboardHeight(int i) {
        ...
        boolean z = this.keyboardHeight >= AndroidUtilities.m104dp(20);
        boolean z2 = i >= AndroidUtilities.m104dp(20);
        if (z2 != z) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.toY = AndroidUtilities.m104dp(20) + i3;
        ((FrameLayout.LayoutParams) this.viewPagerContainer.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight;
        float m104dp = (((i3 + AndroidUtilities.m104dp(20)) + this.toHeight) + AndroidUtilities.m104dp(24)) - AndroidUtilities.statusBarHeight;
        this.bottomPadding = m104dp;
        this.maxSelfStoriesViewsOffset = size - m104dp;
    ...
    public void setOffset(float f) {
        ...
        if (f2 == 1.0f && this.progressToOpen != 1.0f) {
            if (this.storyViewer.storiesList != null) {
                ...
                this.storyViewer.storiesViewPager.setCurrentDate(day, messageObject.storyItem.f1761id);
