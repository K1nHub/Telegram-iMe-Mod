...
public class DialogStoriesCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DialogStoriesCell(Context context, BaseFragment baseFragment, int i, int i2) {
        ...
        recyclerListView.setPadding(AndroidUtilities.m104dp(3), 0, AndroidUtilities.m104dp(3), 0);
        ...
        this.titleView.setPadding(0, AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8));
        this.titleView.setTextSize(AndroidUtilities.m104dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20 : 18));
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                for (int i4 = 0; i4 < DialogStoriesCell.this.viewsDrawInParent.size(); i4++) {
                    ...
                    if (storyCell2.getAlpha() != 1.0f) {
                        canvas.saveLayerAlpha(-AndroidUtilities.m104dp(4), -AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(50), AndroidUtilities.m104dp(50), (int) (storyCell2.getAlpha() * 255.0f), 31);
                    }
                    canvas.scale(storyCell2.getScaleX(), storyCell2.getScaleY(), AndroidUtilities.m104dp(14), storyCell2.getCy());
        ...
        this.listViewMini.addItemDecoration(new RecyclerView.ItemDecoration(this) { // from class: org.telegram.ui.Stories.DialogStoriesCell.4
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (childLayoutPosition == 1) {
                    rect.left = (-AndroidUtilities.m104dp(85)) + AndroidUtilities.m105dp(33.0f);
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        this.titleView.setTextSize(AndroidUtilities.m104dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20 : 18));
        this.currentCellWidth = AndroidUtilities.m105dp(70.0f);
        ...
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(89), 1073741824));
    }
    ...
    public void setOverscoll(float f) {
        this.overscrollPrgoress = f / AndroidUtilities.m104dp(90);
        invalidate();
    ...
    public class StoryCell extends FrameLayout {
        ...
        public StoryCell(Context context) {
            ...
            this.avatarImage.setRoundRadius(AndroidUtilities.m104dp(48) / 2);
            this.crossfageToAvatarImage.setRoundRadius(AndroidUtilities.m104dp(48) / 2);
        }
                ...
                if (z && this.isUploadingState && !this.mini) {
                    ...
                    DialogStoriesCell.this.textAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.DialogStoriesCell.StoryCell.1
                        ...
                        public void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ...
                            simpleTextView.setTranslationY((-AndroidUtilities.m104dp(5)) * floatValue);
                            StoryCell.this.textView.setAlpha(floatValue);
                            StoryCell.this.textView.setTranslationY(AndroidUtilities.m104dp(5) * f);
                        }
                    });
                    ...
                    this.textView.setTranslationY(AndroidUtilities.m104dp(5));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.mini ? AndroidUtilities.m105dp(70.0f) : DialogStoriesCell.this.currentCellWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(81), 1073741824));
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float m104dp = AndroidUtilities.m104dp(48);
            float m104dp2 = AndroidUtilities.m104dp(28);
            float m104dp3 = AndroidUtilities.m104dp(8) * Utilities.clamp(DialogStoriesCell.this.overscrollPrgoress / 0.5f, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            if (this.selectedForOverscroll) {
                m104dp3 += AndroidUtilities.m104dp(16) * Utilities.clamp((DialogStoriesCell.this.overscrollPrgoress - 0.5f) / 0.5f, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            }
            float lerp = AndroidUtilities.lerp(m104dp + m104dp3, m104dp2, this.progressToCollapsed);
            float f6 = lerp / 2.0f;
            ...
            if (z2 || (this.progressWasDrawn && (radialProgress = this.radialProgress) != null && radialProgress.getAnimatedProgress() < 0.98f)) {
                ...
                this.radialProgress.setProgressRect((int) (this.avatarImage.getImageX() - AndroidUtilities.m104dp(3)), (int) (this.avatarImage.getImageY() - AndroidUtilities.m104dp(3)), (int) (this.avatarImage.getImageX2() + AndroidUtilities.m104dp(3)), (int) (this.avatarImage.getImageY2() + AndroidUtilities.m104dp(3)));
                ...
                if (this.drawAvatar) {
                    ...
                    if (f13 > BitmapDescriptorFactory.HUE_RED) {
                        ...
                        errorPaint.setStrokeWidth(AndroidUtilities.m104dp(i));
                        errorPaint.setAlpha((int) (255.0f * f13));
                        canvas.drawCircle(f5, f4, (f6 + AndroidUtilities.m104dp(4)) * this.params.getScale(), errorPaint);
                    }
                    f12 = f13;
                    z = false;
                } else {
            ...
            this.textViewContainer.setTranslationY(f + (AndroidUtilities.m104dp(7) * (1.0f - this.progressToCollapsed)));
        ...
        private float getArcProgress(float f, float f2) {
            ...
            if (!this.isLast && DialogStoriesCell.this.overscrollPrgoress <= BitmapDescriptorFactory.HUE_RED) {
                if (AndroidUtilities.lerp(getMeasuredWidth(), AndroidUtilities.m105dp(18.0f), CubicBezierInterpolator.EASE_OUT.getInterpolation(this.progressToCollapsed)) < (f2 + AndroidUtilities.dpf2(3.5f)) * 2.0f) {
        ...
        public void drawPlus(Canvas canvas, float f, float f2, float f3) {
            if (this.isSelf && !DialogStoriesCell.this.storiesController.hasStories(this.dialogId) && Utilities.isNullOrEmpty(DialogStoriesCell.this.storiesController.getUploadingStories(this.dialogId))) {
                float m104dp = f + AndroidUtilities.m104dp(16);
                float m104dp2 = f2 + AndroidUtilities.m104dp(16);
                DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
                ...
                canvas.drawCircle(m104dp, m104dp2, AndroidUtilities.m104dp(11), DialogStoriesCell.this.backgroundPaint);
                canvas.drawCircle(m104dp, m104dp2, AndroidUtilities.m104dp(9), DialogStoriesCell.this.addCirclePaint);
                ...
                DialogStoriesCell.this.addNewStoryDrawable.setBounds((int) (m104dp - (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicWidth() / 2.0f)), (int) (m104dp2 - (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicHeight() / 2.0f)), (int) (m104dp + (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicWidth() / 2.0f)), (int) (m104dp2 + (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicHeight() / 2.0f)));
        ...
        public void drawFail(Canvas canvas, float f, float f2, float f3) {
            ...
            float m104dp = f + AndroidUtilities.m104dp(17);
            float m104dp2 = f2 + AndroidUtilities.m104dp(17);
            ...
            float m104dp3 = AndroidUtilities.m104dp(9) * CubicBezierInterpolator.EASE_OUT_BACK.getInterpolation(f3);
            canvas.drawCircle(m104dp, m104dp2, AndroidUtilities.m104dp(2) + m104dp3, DialogStoriesCell.this.backgroundPaint);
            canvas.drawCircle(m104dp, m104dp2, m104dp3, DialogStoriesCell.this.addCirclePaint);
            DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
            dialogStoriesCell.addCirclePaint.setColor(Theme.multAlpha(dialogStoriesCell.getTextColor(), f3));
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(m104dp - AndroidUtilities.m104dp(1), m104dp2 - AndroidUtilities.dpf2(4.6f), AndroidUtilities.m104dp(1) + m104dp, AndroidUtilities.dpf2(1.6f) + m104dp2);
            canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(3), DialogStoriesCell.this.addCirclePaint);
            rectF.set(m104dp - AndroidUtilities.m104dp(1), AndroidUtilities.dpf2(2.6f) + m104dp2, m104dp + AndroidUtilities.m104dp(1), m104dp2 + AndroidUtilities.dpf2(4.6f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(3), DialogStoriesCell.this.addCirclePaint);
        }
    ...
    static float getAvatarRight(int i, float f) {
        float lerp = AndroidUtilities.lerp(AndroidUtilities.m104dp(48), AndroidUtilities.m104dp(28), f) / 2.0f;
    ...
    private HintView2 makePremiumHint() {
        ...
        this.premiumHint.setPadding(AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(8), 0);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.currentState == 2) {
            ...
            this.miniItemsClickArea.setRect((int) this.listViewMini.getX(), (int) this.listViewMini.getY(), (int) (this.listViewMini.getX() + AndroidUtilities.m105dp((size * 28) - (Math.max(0, size - 1) * 18.0f))), (int) (this.listViewMini.getY() + this.listViewMini.getHeight()));
