...
public class StoriesListPlaceProvider implements StoryViewer.PlaceProvider {
    ...
    public static /* synthetic */ void lambda$findView$0(Path path, Canvas canvas, RectF rectF, float f, boolean z) {
        ...
        path.addCircle((rectF.right + AndroidUtilities.m72dp(7)) - (AndroidUtilities.m72dp(14) * pow), (rectF.bottom + AndroidUtilities.m72dp(7)) - (AndroidUtilities.m72dp(14) * pow), AndroidUtilities.m72dp(11), Path.Direction.CW);
