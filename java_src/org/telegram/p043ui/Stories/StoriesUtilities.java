...
public class StoriesUtilities {
    ...
    */
    public static void drawAvatarWithStory(long r29, android.graphics.Canvas r31, org.telegram.messenger.ImageReceiver r32, boolean r33, org.telegram.p043ui.Stories.StoriesUtilities.AvatarStoryParams r34) {
        /*
    ...
    public static Paint getCloseFriendsPaint(ImageReceiver imageReceiver) {
        if (closeFriendsGradientTools == null) {
            ...
            closeFriendsGradientTools.paint.setStrokeWidth(AndroidUtilities.m73dp(2.3f));
    ...
    public static CharSequence getUploadingStr(TextView textView, boolean z, boolean z2) {
        String string;
        if (z2) {
            string = LocaleController.getString("StoryEditing", C3419R.string.StoryEditing);
        } else {
            string = LocaleController.getString("UploadingStory", C3419R.string.UploadingStory);
        }
        if (string.indexOf("…") > 0) {
    ...
    public static CharSequence createExpiredStoryString() {
        return createExpiredStoryString(false, "ExpiredStory", C3419R.string.ExpiredStory, new Object[0]);
    }
    ...
    public static CharSequence createExpiredStoryString(boolean z, String str, int i, Object... objArr) {
        ...
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C3419R.C3421drawable.msg_mini_bomb);
        if (z) {
    ...
    public static CharSequence createReplyStoryString() {
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) "d ").append((CharSequence) LocaleController.getString("Story", C3419R.string.Story));
        spannableStringBuilder.setSpan(new ColoredImageSpan(C3419R.C3421drawable.msg_mini_replystory2), 0, 1, 0);
        return spannableStringBuilder;
    }
    ...
    public static void applyViewedUser(TLRPC$StoryItem tLRPC$StoryItem, TLRPC$User tLRPC$User) {
        ...
        if (tLRPC$TL_storyViews.views_count == 0) {
            ...
            tLRPC$TL_storyViews.recent_viewers.add(Long.valueOf(tLRPC$User.f1675id));
        }
    }
    ...
    public static class AvatarStoryParams {
        ...
        public float progressToArc = BitmapDescriptorFactory.HUE_RED;
        ...
        */
        public /* synthetic */ void lambda$load$2(org.telegram.tgnet.TLObject r10, final long r11, final android.view.View r13, final org.telegram.p043ui.Stories.StoriesUtilities.AvatarStoryParams r14, org.telegram.messenger.MessagesController r15) {
            /*
                ...
                r8 = r14
                r3.<init>()
                r9.ensureStoryFileLoaded(r10, r2)
                r10 = r1
                goto L38
            L37:
                r10 = r0
        ...
        private void ensureStoryFileLoaded(TLRPC$TL_userStories tLRPC$TL_userStories, final Runnable runnable) {
            ...
            int i = MessagesController.getInstance(this.currentAccount).getStoriesController().dialogIdToMaxReadId.get(tLRPC$TL_userStories.user_id);
            int i2 = 0;
            while (true) {
                if (i2 >= tLRPC$TL_userStories.stories.size()) {
                    tLRPC$StoryItem = null;
                    break;
                } else if (tLRPC$TL_userStories.stories.get(i2).f1553id > i) {
            ...
            TLRPC$Photo tLRPC$Photo = tLRPC$MessageMedia != null ? tLRPC$MessageMedia.photo : null;
            if (tLRPC$Photo != null && (arrayList = tLRPC$Photo.sizes) != null) {
                imageReceiver.setImage(null, null, ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(arrayList, Integer.MAX_VALUE), tLRPC$Photo), storyImageFilter, null, null, null, 0L, null, tLRPC$StoryItem, 0);
            } else {
                runnable.run();
            }
        }
