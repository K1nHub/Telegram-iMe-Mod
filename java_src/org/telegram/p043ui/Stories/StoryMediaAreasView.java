    ...
    public void set(ArrayList<TLRPC$MediaArea> arrayList) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            if (tLRPC$MediaArea != null && tLRPC$MediaArea.coordinates != null) {
                ...
                d += (tLRPC$TL_mediaAreaCoordinates.f1609w / 100.0d) * 1080.0d * (tLRPC$TL_mediaAreaCoordinates.f1608h / 100.0d) * 1920.0d;
            }
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            ...
            if (childAt == frameLayout) {
                ...
                areaView.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((areaView.mediaArea.coordinates.f1609w / 100.0d) * size), 1073741824), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((areaView.mediaArea.coordinates.f1608h / 100.0d) * size2), 1073741824));
            }
        }
    ...
    public void onClick(View view) {
        if (view instanceof AreaView) {
            ...
            if (areaView == view) {
                ...
                boolean z = this.selectedArea.getTranslationY() < ((float) AndroidUtilities.m72dp(100));
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString("StoryViewLocation", C3473R.string.StoryViewLocation));
                SpannableString spannableString = new SpannableString(">");
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C3473R.C3475drawable.photos_arrow);
                coloredImageSpan.translate(AndroidUtilities.m72dp(2), AndroidUtilities.m72dp(1));
                spannableString.setSpan(coloredImageSpan, 0, spannableString.length(), 33);
                SpannableString spannableString2 = new SpannableString("<");
                ColoredImageSpan coloredImageSpan2 = new ColoredImageSpan(C3473R.C3475drawable.attach_arrow_right);
                coloredImageSpan2.translate(AndroidUtilities.m72dp(-2), AndroidUtilities.m72dp(1));
                ...
                final HintView2 duration = new HintView2(getContext(), z ? 1 : 3).setText(spannableStringBuilder).setSelectorColor(687865855).setJointPx(BitmapDescriptorFactory.HUE_RED, this.selectedArea.getTranslationX() - AndroidUtilities.m72dp(8)).setDuration(5000L);
                ...
                if (z) {
                    ...
                    this.hintView.setTranslationY((this.selectedArea.getTranslationY() - (this.selectedArea.getMeasuredHeight() / 2.0f)) - AndroidUtilities.m72dp(50));
                }
                ...
                this.hintView.setPadding(AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(8));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        for (int i5 = 0; i5 < getChildCount(); i5++) {
            ...
            if (childAt == this.hintsContainer) {
                ...
                areaView.setTranslationX((float) ((areaView.mediaArea.coordinates.f1610x / 100.0d) * getMeasuredWidth()));
                areaView.setTranslationY((float) ((areaView.mediaArea.coordinates.f1611y / 100.0d) * getMeasuredHeight()));
