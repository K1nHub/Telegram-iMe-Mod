...
public class SelfStoryViewsPage extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public SelfStoryViewsPage(final StoryViewer storyViewer, Context context) {
        ...
        addView(textView);
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.1
        ...
        this.recyclerListView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.2
            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                SelfStoryViewsPage.this.checkLoadMore();
            }
        });
        this.recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$$ExternalSyntheticLambda1
        ...
        addView(view, LayoutHelper.createFrame(-1, 8, 0, 0, 38, 0, 0));
        View view2 = new View(getContext());
        view2.setBackgroundColor(Theme.getColor(i, this.resourcesProvider));
        addView(view2, LayoutHelper.createFrame(-1, 8, 0, 0, 30, 0, 0));
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.recyclerListView) {
            canvas.clipRect(0, AndroidUtilities.m72dp(46), getMeasuredWidth(), getMeasuredHeight());
    ...
    public void setStoryItem(SelfStoryViewsView.StoryItemInternal storyItemInternal) {
        ...
        if (tLRPC$StoryItem != null) {
            ViewsModel viewsModel = MessagesController.getInstance(this.currentAccount).getStoriesController().selfViewsModel.get(tLRPC$StoryItem.f1553id);
            ...
            if (viewsModel == null || viewsModel.totalCount != i2) {
                ...
                MessagesController.getInstance(this.currentAccount).getStoriesController().selfViewsModel.put(tLRPC$StoryItem.f1553id, this.model);
            }
            ...
            if (tLRPC$TL_storyViews2 == null || (i = tLRPC$TL_storyViews2.views_count) == 0) {
                this.titleView.setText(LocaleController.getString("NobodyViewsTitle", C3419R.string.NobodyViewsTitle));
                return;
            } else {
        ...
        this.titleView.setText(LocaleController.getString("UploadingStory", C3419R.string.UploadingStory));
    }
    ...
    public static void preload(int i, TLRPC$StoryItem tLRPC$StoryItem) {
        ...
        ViewsModel viewsModel = MessagesController.getInstance(i).getStoriesController().selfViewsModel.get(tLRPC$StoryItem.f1553id);
        TLRPC$TL_storyViews tLRPC$TL_storyViews = tLRPC$StoryItem.views;
        int i2 = tLRPC$TL_storyViews == null ? 0 : tLRPC$TL_storyViews.views_count;
        if (viewsModel == null || viewsModel.totalCount != i2) {
            if (viewsModel != null) {
            ...
            viewsModel2.loadNext();
            MessagesController.getInstance(i).getStoriesController().selfViewsModel.put(tLRPC$StoryItem.f1553id, viewsModel2);
        }
    }
    ...
    public void onDataRecieved() {
        NotificationCenter.getInstance(this.currentAccount).doOnIdle(new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$$ExternalSyntheticLambda0
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onDataRecieved$1() {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i != NotificationCenter.storiesUpdated || this.storyItem.uploadingStory == null || (stories = MessagesController.getInstance(this.currentAccount).getStoriesController().getStories(UserConfig.getInstance(this.currentAccount).clientUserId)) == null) {
            return;
        }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                stickerEmptyView = new View(this, SelfStoryViewsPage.this.getContext()) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.ListAdapter.1
                    @Override // android.view.View
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(46), 1073741824));
                    }
                };
            } else if (i == 1) {
                int i2 = ReactedUserHolderView.STYLE_STORY;
                SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
                stickerEmptyView = new ReactedUserHolderView(i2, selfStoryViewsPage.currentAccount, selfStoryViewsPage.getContext(), SelfStoryViewsPage.this.resourcesProvider) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.ListAdapter.2
                    @Override // org.telegram.p043ui.Cells.ReactedUserHolderView
                    public void openStory(long j, Runnable runnable) {
                        LaunchActivity.getLastFragment().getOrCreateOverlayStoryViewer().doOnAnimationReady(runnable);
                        LaunchActivity.getLastFragment().getOrCreateOverlayStoryViewer().open(getContext(), j, StoriesListPlaceProvider.m24of(SelfStoryViewsPage.this.recyclerListView));
                    }
                };
            } else if (i == 3) {
                ...
                stickerEmptyView = new View(this, SelfStoryViewsPage.this.getContext()) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.ListAdapter.3
                    @Override // android.view.View
                ...
                StickerEmptyView stickerEmptyView2 = new StickerEmptyView(context, null, selfStoryViewsPage2.model.isExpiredViews ? 12 : 0, selfStoryViewsPage2.resourcesProvider) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.ListAdapter.4
                ...
                if (SelfStoryViewsPage.this.model.isExpiredViews) {
                    stickerEmptyView2.subtitle.setText(AndroidUtilities.replaceTags(LocaleController.getString("ExpiredViewsStub", C3419R.string.ExpiredViewsStub)));
                } else {
                    stickerEmptyView2.subtitle.setText(LocaleController.getString("NoViewsStub", C3419R.string.NoViewsStub));
                }
    ...
    public static class ViewsModel {
        ...
        public void loadNext() {
            ...
            tLRPC$TL_stories_getStoryViewsList.f1658id = this.storyItem.f1553id;
            ...
            this.loading = true;
            this.reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_stories_getStoryViewsList, new RequestDelegate() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$ViewsModel$$ExternalSyntheticLambda1
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$loadNext$1(final TLRPC$TL_stories_getStoryViewsList tLRPC$TL_stories_getStoryViewsList, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$loadNext$0(TLObject tLObject, TLRPC$TL_stories_getStoryViewsList tLRPC$TL_stories_getStoryViewsList) {
            this.loading = false;
            this.reqId = -1;
            if (tLObject != null) {
                ...
                if (i2 > tLRPC$TL_storyViews.views_count) {
                    ...
                    for (int i3 = 0; i3 < Math.min(3, tLRPC$TL_stories_storyViewsList.users.size()); i3++) {
                        this.storyItem.views.recent_viewers.add(Long.valueOf(tLRPC$TL_stories_storyViewsList.users.get(i3).f1675id));
                    }
