...
public class SelfStoryViewsPage extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public SelfStoryViewsPage(final StoryViewer storyViewer, Context context, FiltersState filtersState, Consumer<SelfStoryViewsPage> consumer) {
        ...
        this.recyclerListView.setOnItemLongClickListener(new C68754(storyViewer));
        ...
        C68775 c68775 = new C68775(getContext(), true, 13.0f, this.resourcesProvider);
        this.searchField = c68775;
        c68775.setHint(LocaleController.getString("Search", C3473R.string.Search));
    ...
    public /* synthetic */ void lambda$new$0(StoryViewer storyViewer, View view, int i) {
        ...
        storyViewer.presentFragment(ProfileActivity.m26of(tLRPC$TL_storyView.user_id));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.Stories.SelfStoryViewsPage$4 */
    /* loaded from: classes7.dex */
    public class C68754 implements RecyclerListView.OnItemLongClickListener {
        final /* synthetic */ StoryViewer val$storyViewer;

        C68754(StoryViewer storyViewer) {
        ...
        public boolean onItemClick(View view, int i) {
            ...
            if (view instanceof ReactedUserHolderView) {
                ...
                boolean z = messagesController.blockePeers.indexOfKey(user.f1685id) >= 0;
                boolean z2 = user.contact || ContactsController.getInstance(SelfStoryViewsPage.this.currentAccount).contactsDict.get(Long.valueOf(user.f1685id)) != null;
                ...
                ItemOptions cutTextInFancyHalf = ItemOptions.makeOptions(this.val$storyViewer.containerView, SelfStoryViewsPage.this.resourcesProvider, view).setGravity(3).ignoreX().setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_dialogBackground, SelfStoryViewsPage.this.resourcesProvider))).setDimAlpha(133).addIf((!isStoryShownToUser || isBlocked || z) ? false : true, C3473R.C3475drawable.msg_stories_myhide, LocaleController.formatString(C3473R.string.StoryHideFrom, str2), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.C68754.this.lambda$onItemClick$0(messagesController, user, str2, reactedUserHolderView, tLRPC$TL_storyView);
                    }
                }).makeMultiline(false).cutTextInFancyHalf().addIf(isBlocked && !z, C3473R.C3475drawable.msg_menu_stories, LocaleController.formatString(C3473R.string.StoryShowBackTo, str2), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.C68754.this.lambda$onItemClick$1(messagesController, user, str2, reactedUserHolderView, tLRPC$TL_storyView);
                    }
                }).makeMultiline(false).cutTextInFancyHalf();
                boolean z3 = (z2 || z) ? false : true;
                int i2 = C3473R.C3475drawable.msg_user_remove;
                final ItemOptions addIf = cutTextInFancyHalf.addIf(z3, i2, (CharSequence) LocaleController.getString(C3473R.string.BlockUser), true, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.C68754.this.lambda$onItemClick$2(messagesController, user, reactedUserHolderView, tLRPC$TL_storyView);
                    }
                }).addIf(!z2 && z, C3473R.C3475drawable.msg_block, LocaleController.getString(C3473R.string.Unblock), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.C68754.this.lambda$onItemClick$3(messagesController, user, reactedUserHolderView, tLRPC$TL_storyView);
                    }
                }).addIf(z2, i2, (CharSequence) LocaleController.getString(C3473R.string.StoryDeleteContact), true, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.C68754.this.lambda$onItemClick$4(user, str2, reactedUserHolderView, tLRPC$TL_storyView);
                    }
                });
                    ...
                    if (findStickerSet != null) {
                        ...
                        messageContainsEmojiButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda0
                            ...
                            public final void onClick(View view2) {
                                SelfStoryViewsPage.C68754.this.lambda$onItemClick$5(arrayList, addIf, view2);
                            }
                        });
        ...
        public /* synthetic */ void lambda$onItemClick$0(MessagesController messagesController, TLRPC$User tLRPC$User, String str, ReactedUserHolderView reactedUserHolderView, TLRPC$TL_storyView tLRPC$TL_storyView) {
            messagesController.getStoriesController().updateBlockUser(tLRPC$User.f1685id, true);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m33of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C3473R.raw.ic_ban, LocaleController.formatString(C3473R.string.StoryHidFromToast, str)).show();
        ...
        public /* synthetic */ void lambda$onItemClick$1(MessagesController messagesController, TLRPC$User tLRPC$User, String str, ReactedUserHolderView reactedUserHolderView, TLRPC$TL_storyView tLRPC$TL_storyView) {
            messagesController.getStoriesController().updateBlockUser(tLRPC$User.f1685id, false);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m33of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C3473R.raw.contact_check, LocaleController.formatString(C3473R.string.StoryShownBackToToast, str)).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(tLRPC$TL_storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$2(MessagesController messagesController, TLRPC$User tLRPC$User, ReactedUserHolderView reactedUserHolderView, TLRPC$TL_storyView tLRPC$TL_storyView) {
            messagesController.blockPeer(tLRPC$User.f1685id);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m33of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createBanBulletin(true).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(tLRPC$TL_storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$3(MessagesController messagesController, TLRPC$User tLRPC$User, ReactedUserHolderView reactedUserHolderView, TLRPC$TL_storyView tLRPC$TL_storyView) {
            messagesController.getStoriesController().updateBlockUser(tLRPC$User.f1685id, false);
            messagesController.unblockPeer(tLRPC$User.f1685id);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m33of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createBanBulletin(false).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(tLRPC$TL_storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$4(TLRPC$User tLRPC$User, String str, ReactedUserHolderView reactedUserHolderView, TLRPC$TL_storyView tLRPC$TL_storyView) {
            ...
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m33of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C3473R.raw.ic_ban, LocaleController.formatString(C3473R.string.DeletedFromYourContacts, str)).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(tLRPC$TL_storyView) ? 1.0f : 0.5f, true);
        }
    ...
    /* loaded from: classes7.dex */
    public class C68775 extends SearchField {
        Runnable runnable;

        C68775(Context context, boolean z, float f, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onTextChange(final String str) {
            ...
            this.runnable = new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$5$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SelfStoryViewsPage.C68775.this.lambda$onTextChange$0(str);
                }
            };
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(-AndroidUtilities.m72dp(6), paddingTop, getMeasuredWidth() + AndroidUtilities.m72dp(6), getMeasuredHeight());
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.recyclerListView) {
            canvas.save();
            canvas.clipRect(0, AndroidUtilities.m72dp(this.TOP_PADDING), getMeasuredWidth(), getMeasuredHeight());
    ...
    private void updateViewsVisibility() {
        ...
        if (tLRPC$StoryItem != null) {
            ...
            ViewsModel viewsModel = MessagesController.getInstance(this.currentAccount).getStoriesController().selfViewsModel.get(tLRPC$StoryItem.f1557id);
            ...
            if (viewsModel == null || viewsModel.totalCount != i2) {
                ...
                MessagesController.getInstance(this.currentAccount).getStoriesController().selfViewsModel.put(tLRPC$StoryItem.f1557id, this.defaultModel);
            } else {
            ...
            if (!this.currentModel.isExpiredViews || UserConfig.getInstance(this.currentAccount).isPremium()) {
                ...
                if (viewsModel5.loading || viewsModel5.hasNext || !viewsModel5.views.isEmpty() || !TextUtils.isEmpty(this.currentModel.state.searchQuery)) {
                    ...
                    if (tLRPC$StoryViews3 == null || tLRPC$StoryViews3.views_count == 0) {
                        ...
                        this.showReactionsSort = false;
                        this.showContactsFilter = false;
                        this.titleView.setText(LocaleController.getString("Viewers", C3473R.string.Viewers));
            ...
            this.TOP_PADDING = 46;
            this.titleView.setText(LocaleController.getString("UploadingStory", C3473R.string.UploadingStory));
            this.searchField.setVisibility(8);
            this.headerView.setVisibility(8);
        }
        ...
        ((ViewGroup.MarginLayoutParams) this.shadowView.getLayoutParams()).topMargin = AndroidUtilities.m72dp(this.TOP_PADDING - 8);
        ((ViewGroup.MarginLayoutParams) this.shadowView2.getLayoutParams()).topMargin = AndroidUtilities.m72dp(this.TOP_PADDING - 17);
    }
    ...
    public static void preload(int i, TLRPC$StoryItem tLRPC$StoryItem) {
        ...
        ViewsModel viewsModel = MessagesController.getInstance(i).getStoriesController().selfViewsModel.get(tLRPC$StoryItem.f1557id);
        TLRPC$StoryViews tLRPC$StoryViews = tLRPC$StoryItem.views;
        ...
        if (viewsModel == null || viewsModel.totalCount != i2) {
            ...
            MessagesController.getInstance(i).getStoriesController().selfViewsModel.put(tLRPC$StoryItem.f1557id, viewsModel2);
        }
    }
    ...
    public boolean onBackPressed() {
        if (Math.abs(this.topViewsContainer.getTranslationY() - this.recyclerListView.getPaddingTop()) > AndroidUtilities.m72dp(2)) {
            this.recyclerListView.dispatchTouchEvent(AndroidUtilities.emptyMotionEvent());
    ...
    public static class ViewsModel {
        ...
        public void loadNext() {
            ...
            tLRPC$TL_stories_getStoryViewsList.f1667id = this.storyItem.f1557id;
            if (this.useLocalFilters) {
                tLRPC$TL_stories_getStoryViewsList.f1668q = "";
                ...
                tLRPC$TL_stories_getStoryViewsList.f1668q = str;
                if (!TextUtils.isEmpty(str)) {
            ...
            this.loading = true;
            FileLog.m70d("SelfStoryViewsPage load next " + this.storyItem.f1557id + " " + this.initial + " offset=" + tLRPC$TL_stories_getStoryViewsList.offset + " q" + tLRPC$TL_stories_getStoryViewsList.f1668q + " " + tLRPC$TL_stories_getStoryViewsList.just_contacts + " " + tLRPC$TL_stories_getStoryViewsList.reactions_first);
        ...
        public /* synthetic */ void lambda$loadNext$0(int[] iArr, TLObject tLObject) {
            if (iArr[0] != this.reqId) {
                FileLog.m70d("SelfStoryViewsPage " + this.storyItem.f1557id + " localId != reqId");
                return;
            }
            this.loading = false;
            this.reqId = -1;
            if (tLObject != null) {
                ...
                if (i2 > tLRPC$StoryViews.views_count) {
                    ...
                    for (int i3 = 0; i3 < Math.min(3, tLRPC$TL_stories_storyViewsList.users.size()); i3++) {
                        this.storyItem.views.recent_viewers.add(Long.valueOf(tLRPC$TL_stories_storyViewsList.users.get(i3).f1685id));
                    }
            ...
            FileLog.m70d("SelfStoryViewsPage " + this.storyItem.f1557id + " response  totalItems " + this.views.size() + " has next " + this.hasNext);
    ...
    public class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            textView.setText(LocaleController.getString("AllViewers", C3473R.string.AllViewers));
            ...
            this.allViewersView.setPadding(AndroidUtilities.m72dp(12), AndroidUtilities.m72dp(4), AndroidUtilities.m72dp(12), AndroidUtilities.m72dp(4));
            TextView textView3 = new TextView(context);
            this.contactsViewersView = textView3;
            textView3.setText(LocaleController.getString("Contacts", C3473R.string.Contacts));
            ...
            this.contactsViewersView.setPadding(AndroidUtilities.m72dp(12), AndroidUtilities.m72dp(4), AndroidUtilities.m72dp(12), AndroidUtilities.m72dp(4));
            linearLayout.setPadding(0, AndroidUtilities.m72dp(6), 0, AndroidUtilities.m72dp(6));
            ...
            linearLayout2.setPadding(AndroidUtilities.m72dp(6), 0, AndroidUtilities.m72dp(6), 0);
            linearLayout2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m72dp(26), Theme.getColor(i, SelfStoryViewsPage.this.resourcesProvider)));
            ...
            replaceableIconDrawable.setIcon(C3473R.C3475drawable.menu_views_reactions3, false);
            ...
            imageView2.setImageResource(C3473R.C3475drawable.arrow_more);
        ...
        /* loaded from: classes7.dex */
        public class C68791 extends CustomPopupMenu {
            @Override // org.telegram.p043ui.Components.CustomPopupMenu
            protected void onDismissed() {
            }

            C68791(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
            ...
            protected void onCreate(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
                ...
                ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, SelfStoryViewsPage.this.state.sortByReactions ? C3473R.C3475drawable.menu_views_reactions2 : C3473R.C3475drawable.menu_views_reactions, LocaleController.getString("SortByReactions", C3473R.string.SortByReactions), false, SelfStoryViewsPage.this.resourcesProvider);
                ...
                addItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$HeaderView$1$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        SelfStoryViewsPage.HeaderView.C68791.this.lambda$onCreate$0(view);
                    }
                });
                ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, !SelfStoryViewsPage.this.state.sortByReactions ? C3473R.C3475drawable.menu_views_recent2 : C3473R.C3475drawable.menu_views_recent, LocaleController.getString("SortByTime", C3473R.string.SortByTime), false, SelfStoryViewsPage.this.resourcesProvider);
                if (SelfStoryViewsPage.this.state.sortByReactions) {
                ...
                addItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$HeaderView$1$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        SelfStoryViewsPage.HeaderView.C68791.this.lambda$onCreate$1(view);
                    }
                });
                ...
                ActionBarMenuItem.addText(actionBarPopupWindowLayout, LocaleController.getString("StoryViewsSortDescription", C3473R.string.StoryViewsSortDescription), SelfStoryViewsPage.this.resourcesProvider);
            }
        ...
        public /* synthetic */ void lambda$new$2(View view) {
            SelfStoryViewsPage.this.popupMenu = new C68791(getContext(), SelfStoryViewsPage.this.resourcesProvider, false);
            CustomPopupMenu customPopupMenu = SelfStoryViewsPage.this.popupMenu;
            LinearLayout linearLayout = this.buttonContainer;
            customPopupMenu.show(linearLayout, 0, (-linearLayout.getMeasuredHeight()) - AndroidUtilities.m72dp(8));
        }
    ...
    public void updateViewState(boolean z) {
        ...
        if (z2 != z3) {
            ...
            headerView.replacableDrawable.setIcon(z3 ? C3473R.C3475drawable.menu_views_reactions3 : C3473R.C3475drawable.menu_views_recent3, z);
        }
    }
    ...
    private class RecyclerListViewInner extends RecyclerListView implements StoriesListPlaceProvider.ClippedView {
        ...
        public void updateClip(int[] iArr) {
            iArr[0] = AndroidUtilities.m72dp(SelfStoryViewsPage.this.TOP_PADDING);
