...
public class StoryReactionWidgetView extends StoryMediaAreasView.AreaView {
    ...
    public StoryReactionWidgetView(Context context, View view, TL_stories$TL_mediaAreaSuggestedReaction tL_stories$TL_mediaAreaSuggestedReaction, EmojiAnimationsOverlay emojiAnimationsOverlay) {
        ...
        this.animatedTextDrawable.setTextSize(AndroidUtilities.m104dp(18));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.animatedTextDrawable.setTextSize(Math.min(AndroidUtilities.m104dp(18), getMeasuredHeight() * 0.156f));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.animatedTextDrawable.setBounds(this.storyReactionWidgetBackground.getBounds().left, (int) (height2 - AndroidUtilities.m104dp(10)), this.storyReactionWidgetBackground.getBounds().right, (int) (AndroidUtilities.m104dp(10) + height2));
        canvas.save();
