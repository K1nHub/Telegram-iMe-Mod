...
public class StoriesIntro extends FrameLayout {
    ...
    public StoriesIntro(Context context, final View view) {
        ...
        linearLayout.setPadding(0, AndroidUtilities.m107dp(48), 0, AndroidUtilities.m107dp(48));
        linearLayout.setGravity(1);
        TextView textView = new TextView(context);
        textView.setTextColor(-1);
        textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView.setText(LocaleController.getString("StoriesIntroHeader", C3632R.string.StoriesIntroHeader));
        textView.setTextSize(1, 20.0f);
        linearLayout.addView(textView, LayoutHelper.createLinear(-2, -2));
        final TextView textView2 = new TextView(context);
        textView2.setTextColor(-1761607681);
        textView2.setText(LocaleController.getString("StoriesIntroSubHeader", C3632R.string.StoriesIntroSubHeader));
        ...
        arrayList.add(new StoriesIntroItemView(context, C3632R.raw.stories_intro_go_forward, LocaleController.getString("StoriesIntroGoForwardHeader", C3632R.string.StoriesIntroGoForwardHeader), LocaleController.getString("StoriesIntroGoForwardSubHeader", C3632R.string.StoriesIntroGoForwardSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C3632R.raw.stories_intro_pause, LocaleController.getString("StoriesIntroPauseAndSeekHeader", C3632R.string.StoriesIntroPauseAndSeekHeader), LocaleController.getString("StoriesIntroPauseAndSeekSubHeader", C3632R.string.StoriesIntroPauseAndSeekSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C3632R.raw.stories_intro_go_back, LocaleController.getString("StoriesIntroGoBackHeader", C3632R.string.StoriesIntroGoBackHeader), LocaleController.getString("StoriesIntroGoBackSubHeader", C3632R.string.StoriesIntroGoBackSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C3632R.raw.stories_intro_go_to_next, LocaleController.getString("StoriesIntroGoToNextAuthorHeader", C3632R.string.StoriesIntroGoToNextAuthorHeader), LocaleController.getString("StoriesIntroGoToNextAuthorSubHeader", C3632R.string.StoriesIntroGoToNextAuthorSubHeader)));
        int measuredWidth = view.getMeasuredWidth() - AndroidUtilities.m107dp(100);
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(AndroidUtilities.m107dp(8) + measuredWidth > view.getMeasuredWidth() ? view.getMeasuredWidth() - AndroidUtilities.m107dp(8) : measuredWidth, AndroidUtilities.m107dp(64));
        layoutParams.setMargins(0, AndroidUtilities.m107dp(5), 0, AndroidUtilities.m107dp(5));
        ...
        textView3.setText(LocaleController.getString("StoriesIntroDismiss", C3632R.string.StoriesIntroDismiss));
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: org.telegram.ui.Stories.StoriesIntro.1
            ...
            public void onGlobalLayout() {
                ...
                if (iArr[1] + AndroidUtilities.m107dp(24) > view.getMeasuredHeight()) {
    ...
    public static class StoriesIntroItemView extends View {
        ...
        public StoriesIntroItemView(Context context, int i, String str, String str2) {
            ...
            this.header = str;
            this.subHeader = str2;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(36), AndroidUtilities.m107dp(36), true, null);
        ...
        public int getRequiredWidth() {
            ...
            return AndroidUtilities.m107dp(88) + AndroidUtilities.m107dp(8) + Math.max(width, this.textBounds.width());
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.lottieDrawable.setBounds(i4, measuredHeight, i4 + m107dp2, m107dp2 + measuredHeight);
        }
        ...
        protected void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            int m107dp = AndroidUtilities.m107dp(40);
            int m107dp2 = (int) (AndroidUtilities.m107dp(36) + (AndroidUtilities.m107dp(8) * this.progress));
            int i = m107dp2 / 2;
            int i2 = m107dp - i;
            int measuredHeight = (getMeasuredHeight() / 2) - i;
            this.lottieDrawable.setBounds(i2, measuredHeight, i2 + m107dp2, m107dp2 + measuredHeight);
