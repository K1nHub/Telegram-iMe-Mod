...
public class StoryReactionWidgetBackground extends Drawable {
    ...
    public void updateShadowLayer(float f) {
        this.shadowPaint.setShadowLayer(AndroidUtilities.m104dp(2) / f, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dpf2(0.7f) / f, ColorUtils.setAlphaComponent(-16777216, 45));
    }
