...
public class StoryFailView extends FrameLayout {
    ...
    public StoryFailView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView2.setTranslationY(AndroidUtilities.m104dp(9));
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float m104dp = AndroidUtilities.m104dp(23);
        float height = getHeight() / 2.0f;
        canvas.drawCircle(m104dp, height, AndroidUtilities.m104dp(10), this.redPaint);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(m104dp - AndroidUtilities.m104dp(1), height - AndroidUtilities.dpf2(4.6f), AndroidUtilities.m104dp(1) + m104dp, AndroidUtilities.dpf2(1.6f) + height);
        canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(3), this.whitePaint);
        rectF.set(m104dp - AndroidUtilities.m104dp(1), AndroidUtilities.dpf2(2.6f) + height, m104dp + AndroidUtilities.m104dp(1), height + AndroidUtilities.dpf2(4.6f));
        canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(3), AndroidUtilities.m104dp(3), this.whitePaint);
    }
}
