...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            this.afterDeleteProgressPaint.setStrokeWidth(AndroidUtilities.m107dp(2));
            Paint paint3 = new Paint(1);
            this.circlePaint = paint3;
            paint3.setColor(2130706432);
            int i = C3632R.raw.fire_on;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16));
        ...
        public void setOnce() {
            this.once = true;
            this.oncePaint.setTextSize(AndroidUtilities.m107dp(13));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float measuredWidth = getMeasuredWidth() - AndroidUtilities.m107dp(35);
                ...
                if (SecretMediaViewer.this.currentMessageObject.messageOwner.destroyTime != 0 || SecretMediaViewer.this.currentMessageObject.messageOwner.ttl == Integer.MAX_VALUE) {
                    ...
                    if (this.useVideoProgress) {
                        if (SecretMediaViewer.this.videoPlayer != null) {
                            ...
                            if (duration != C0483C.TIME_UNSET && currentPosition != C0483C.TIME_UNSET) {
                    ...
                    if (this.once) {
                        ...
                        float centerY = this.deleteProgressRect.centerY() - AndroidUtilities.m107dp(1);
                        float m107dp = AndroidUtilities.m107dp(8);
                        this.drawable.setBounds((int) (centerX - m107dp), (int) (centerY - m107dp), (int) (centerX + m107dp), (int) (centerY + m107dp));
    ...
    public void preparePlayer(File file) {
        ...
        if (this.videoPlayer == null) {
            ...
            this.videoPlayer.setDelegate(new C70682(file));
        }
    ...
    /* loaded from: classes5.dex */
    public class C70682 implements VideoPlayer.VideoPlayerDelegate {
        ...
        public void onError(VideoPlayer videoPlayer, Exception exc) {
            if (SecretMediaViewer.this.playerRetryPlayCount > 0) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        SecretMediaViewer.C70682.this.lambda$onError$0(file);
                    }
                }, 100L);
                return;
            }
    ...
    public void setParentActivity(final Activity activity) {
        ...
        this.containerView = new FrameLayoutDrawer(activity) { // from class: org.telegram.ui.SecretMediaViewer.4
            ...
            protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                if (SecretMediaViewer.this.secretHint != null && SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight2 = ((((C3704ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) + SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) - AndroidUtilities.m107dp(10);
        ...
        this.actionBar.setTitleRightMargin(AndroidUtilities.m107dp(70));
        ...
        this.secretHint.setPadding(AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8));
        ...
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m107dp(64), 1711276032));
        ...
        this.playButton.setPivotX(AndroidUtilities.m107dp(32));
        this.playButton.setPivotY(AndroidUtilities.m107dp(32));
    ...
    private void setCurrentCaption(MessageObject messageObject, CharSequence charSequence, boolean z, boolean z2) {
        ...
        if (this.captionScrollView == null) {
            ...
            PhotoViewer.CaptionScrollView captionScrollView = new PhotoViewer.CaptionScrollView(this.containerView.getContext(), this.captionTextViewSwitcher, this.captionContainer) { // from class: org.telegram.ui.SecretMediaViewer.10
                ...
                protected void onScrollEnd() {
                    ...
                    AndroidUtilities.runOnUIThread(SecretMediaViewer.this.hideActionBarRunnable, C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                }
            };
        ...
        if (z2 && (i = Build.VERSION.SDK_INT) >= 19) {
            ...
            TransitionSet duration = new TransitionSet().addTransition(new C705812(2, isEmpty2, isEmpty)).addTransition(new C705611(1, isEmpty2, isEmpty)).setDuration(200L);
            if (!isEmpty2) {
                this.captionScrollView.dontChangeTopMargin = true;
                duration.addTransition(new C706013());
            }
            if (isEmpty2 && !isEmpty) {
            ...
            if (!this.val$isCurrentCaptionEmpty && this.val$isCaptionEmpty && view == SecretMediaViewer.this.captionTextViewSwitcher) {
                ...
                ((ObjectAnimator) onDisappear).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.SecretMediaViewer$12$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        SecretMediaViewer.C705812.this.lambda$onDisappear$0(valueAnimator);
                    }
                });
            }
            return onDisappear;
    ...
    /* loaded from: classes5.dex */
    public class C705611 extends Fade {
        final /* synthetic */ boolean val$isCaptionEmpty;
        final /* synthetic */ boolean val$isCurrentCaptionEmpty;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C705611(int i, boolean z, boolean z2) {
            super(i);
            this.val$isCurrentCaptionEmpty = z;
            this.val$isCaptionEmpty = z2;
        }
        ...
        public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            if (this.val$isCurrentCaptionEmpty && !this.val$isCaptionEmpty && view == SecretMediaViewer.this.captionTextViewSwitcher) {
                ...
                ((ObjectAnimator) onAppear).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.SecretMediaViewer$11$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        SecretMediaViewer.C705611.this.lambda$onAppear$0(valueAnimator);
                    }
                });
            }
            return onAppear;
    ...
    /* loaded from: classes5.dex */
    public class C706013 extends Transition {
        C706013() {
        }
        ...
        public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.SecretMediaViewer$13$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    SecretMediaViewer.C706013.this.lambda$createAnimator$0(valueAnimator);
                }
            });
            return ofInt;
        }
    ...
    private void showSecretHint() {
        ...
        this.secretHint.setIcon(C3632R.raw.fire_on);
    ...
    private void toggleActionBar(boolean z, boolean z2) {
        ...
        if (z && this.isVideo) {
            AndroidUtilities.runOnUIThread(this.hideActionBarRunnable, C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
        }
        if (z) {
    ...
    */
    ...
    /* loaded from: classes5.dex */
    public class C706516 extends AnimatorListenerAdapter {
        final /* synthetic */ PhotoViewer.PlaceProviderObject val$object;

        C706516(PhotoViewer.PlaceProviderObject placeProviderObject) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$16$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SecretMediaViewer.C706516.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    */
    ...
    public class VideoPlayerControlFrameLayout extends FrameLayout {
        ...
        public /* synthetic */ void lambda$new$0(DynamicAnimation dynamicAnimation, float f, float f2) {
            SecretMediaViewer.this.seekbar.setSize((int) (((getMeasuredWidth() - AndroidUtilities.m107dp(16)) - f) - (this.parentWidth > this.parentHeight ? AndroidUtilities.m107dp(48) : 0)), getMeasuredHeight());
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (SecretMediaViewer.this.seekbar.onTouch(motionEvent.getAction(), motionEvent.getX() - AndroidUtilities.m107dp(2), motionEvent.getY())) {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            SecretMediaViewer.this.seekbar.setSize(((getMeasuredWidth() - AndroidUtilities.m107dp(16)) - ceil) - i3, getMeasuredHeight());
