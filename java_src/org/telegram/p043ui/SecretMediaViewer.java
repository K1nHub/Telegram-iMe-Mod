...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            this.afterDeleteProgressPaint.setStrokeWidth(AndroidUtilities.m72dp(2));
            Paint paint3 = new Paint(1);
            this.circlePaint = paint3;
            paint3.setColor(2130706432);
            this.drawable = context.getResources().getDrawable(C3473R.C3475drawable.flame_small);
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int measuredHeight = (getMeasuredHeight() / 2) - (AndroidUtilities.m72dp(28) / 2);
            this.deleteProgressRect.set(getMeasuredWidth() - AndroidUtilities.m72dp(49), measuredHeight, getMeasuredWidth() - AndroidUtilities.m72dp(21), measuredHeight + AndroidUtilities.m72dp(28));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawCircle(getMeasuredWidth() - AndroidUtilities.m72dp(35), getMeasuredHeight() / 2, AndroidUtilities.m72dp(16), this.circlePaint);
            float f = 1.0f;
            ...
            int measuredWidth = getMeasuredWidth() - AndroidUtilities.m72dp(40);
            int measuredHeight = ((getMeasuredHeight() - AndroidUtilities.m72dp(14)) / 2) - AndroidUtilities.m73dp(0.5f);
            this.drawable.setBounds(measuredWidth, measuredHeight, AndroidUtilities.m72dp(10) + measuredWidth, AndroidUtilities.m72dp(14) + measuredHeight);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        } else if (i == NotificationCenter.updateMessageMedia && this.currentMessageObject.getId() == ((TLRPC$Message) objArr[0]).f1546id) {
            if (this.isVideo && !this.videoWatchedOneTime) {
                this.closeVideoAfterWatch = true;
            } else if (!closePhoto(true, true)) {
                this.closeAfterAnimation = true;
    ...
    public void preparePlayer(File file) {
        ...
        if (this.videoPlayer == null) {
            ...
            this.videoPlayer.setDelegate(new C66911(file));
        }
    ...
    /* loaded from: classes3.dex */
    public class C66911 implements VideoPlayer.VideoPlayerDelegate {
            ...
            if (SecretMediaViewer.this.playerRetryPlayCount > 0) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        SecretMediaViewer.C66911.this.lambda$onError$0(file);
                    }
                }, 100L);
                return;
            }
    ...
    public void setParentActivity(Activity activity) {
        ...
        FrameLayoutDrawer frameLayoutDrawer = new FrameLayoutDrawer(activity) { // from class: org.telegram.ui.SecretMediaViewer.3
            ...
            protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                if (SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight = ((C3541ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
        ...
        C3541ActionBar c3541ActionBar = new C3541ActionBar(activity);
        ...
        this.actionBar.setTitleRightMargin(AndroidUtilities.m72dp(70));
        this.containerView.addView(this.actionBar, LayoutHelper.createFrame(-1, -2));
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.SecretMediaViewer.4
    ...
    public void openMedia(MessageObject messageObject, PhotoViewer.PhotoViewerProvider photoViewerProvider, final Runnable runnable) {
        ...
        if (document != null) {
            if (MessageObject.isGifDocument(document)) {
                this.actionBar.setTitle(LocaleController.getString("DisappearingGif", C3473R.string.DisappearingGif));
                ...
                this.actionBar.setTitle(LocaleController.getString("DisappearingVideo", C3473R.string.DisappearingVideo));
            ...
            i2 = 21;
            c = 4;
            this.actionBar.setTitle(LocaleController.getString("DisappearingPhoto", C3473R.string.DisappearingPhoto));
    ...
    */
    ...
    /* loaded from: classes3.dex */
    public class C66977 extends AnimatorListenerAdapter {
        final /* synthetic */ PhotoViewer.PlaceProviderObject val$object;

        C66977(PhotoViewer.PlaceProviderObject placeProviderObject) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.SecretMediaViewer$7$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SecretMediaViewer.C66977.this.lambda$onAnimationEnd$0();
                }
            });
        }
