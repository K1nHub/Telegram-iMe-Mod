...
public class CodeFieldContainer extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float m105dp = AndroidUtilities.m105dp(1.5f);
        this.strokeWidth = m105dp;
        paint.setStrokeWidth(m105dp);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt instanceof CodeNumberField) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), this.paint);
            }
        }
    ...
    public String getCode() {
        ...
        while (true) {
            ...
            if (i < codeNumberFieldArr.length) {
                sb.append(C3549PhoneFormat.stripExceptNumbers(codeNumberFieldArr[i].getText().toString()));
                i++;
            } else {
                return sb.toString();
            }
