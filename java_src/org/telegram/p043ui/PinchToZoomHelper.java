    ...
    public void startZoom(View view, ImageReceiver imageReceiver, TextureView textureView, MessageObject messageObject) {
        ...
        if (!this.isSimple) {
            ...
            if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                ...
                this.overlayView.videoPlayerContainer.setTag(C3473R.C3476id.parent_tag, imageReceiver);
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                frameLayout.setOutlineProvider(new ViewOutlineProvider(this, r5) { // from class: org.telegram.ui.PinchToZoomHelper.ZoomOverlayView.1
                    ...
                    public void getOutline(View view, Outline outline) {
                        ImageReceiver imageReceiver = (ImageReceiver) view.getTag(C3473R.C3476id.parent_tag);
                        if (imageReceiver != null) {
                ...
                this.videoPlayerContainer = new FrameLayout(context, r5) { // from class: org.telegram.ui.PinchToZoomHelper.ZoomOverlayView.2
                    ...
                    protected void onSizeChanged(int i, int i2, int i3, int i4) {
                        ...
                        ImageReceiver imageReceiver = (ImageReceiver) getTag(C3473R.C3476id.parent_tag);
                        if (imageReceiver == null) {
                            float f = i / 2;
