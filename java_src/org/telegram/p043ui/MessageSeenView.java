...
public class MessageSeenView extends FrameLayout {
    ...
    public MessageSeenView(Context context, final int i, MessageObject messageObject, final TLRPC$Chat tLRPC$Chat) {
        ...
        this.titleView.setRightPadding(AndroidUtilities.m104dp(62));
    ...
    public /* synthetic */ void lambda$new$0(TLObject tLObject, int i, HashMap hashMap, ArrayList arrayList) {
        if (tLObject != null) {
            ...
            for (int i2 = 0; i2 < tLRPC$TL_channels_channelParticipants.users.size(); i2++) {
                ...
                hashMap.put(Long.valueOf(tLRPC$User.f1749id), tLRPC$User);
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.titleView.getLayoutParams().width = getMeasuredWidth() - AndroidUtilities.m104dp(40);
    ...
    private void updateView() {
        ...
        if (this.users.size() == 1) {
            this.avatarsImageView.setTranslationX(AndroidUtilities.m104dp(24));
        } else if (this.users.size() == 2) {
            this.avatarsImageView.setTranslationX(AndroidUtilities.m104dp(12));
        } else {
            this.avatarsImageView.setTranslationX(BitmapDescriptorFactory.HUE_RED);
        }
        this.titleView.setRightPadding(AndroidUtilities.m104dp((Math.min(2, this.users.size() - 1) * 12) + 32 + 6));
    ...
    public RecyclerListView createListView() {
        ...
        RecyclerListView recyclerListView2 = new RecyclerListView(this, getContext()) { // from class: org.telegram.ui.MessageSeenView.1
            ...
            public void onMeasure(int i, int i2) {
                ...
                int m104dp = AndroidUtilities.m104dp(4) + (AndroidUtilities.m104dp(50) * getAdapter().getItemCount());
                if (m104dp <= size) {
                    size = m104dp;
                }
        ...
        this.listView.setAdapter(new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.MessageSeenView.3
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                userCell.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m104dp(50)));
    ...
    private static class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public UserCell(Context context) {
            ...
            this.nameView.setDrawablePadding(AndroidUtilities.m104dp(3));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(50), 1073741824));
        }
        ...
        public void setUser(TLObject tLObject, int i) {
            ...
            if (i <= 0) {
                ...
                this.nameView.setTranslationY(AndroidUtilities.m104dp(9));
                return;
            }
        ...
        public void didReceivedNotification(int i, int i2, Object... objArr) {
            if (i == NotificationCenter.userEmojiStatusUpdated) {
                ...
                if (tLRPC$User2 == null || tLRPC$User == null || tLRPC$User2.f1749id != tLRPC$User.f1749id) {
                    return;
                }
