...
public class MessageSeenView extends FrameLayout {
    ...
    public MessageSeenView(Context context, final int i, MessageObject messageObject, final TLRPC$Chat tLRPC$Chat) {
        ...
        this.titleView.setRightPadding(AndroidUtilities.m72dp(62));
        ...
        Drawable mutate = ContextCompat.getDrawable(context, this.isVoice ? C3473R.C3475drawable.msg_played : C3473R.C3475drawable.msg_seen).mutate();
    ...
    public /* synthetic */ void lambda$new$4(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, long j, final int i, TLRPC$Chat tLRPC$Chat) {
        if (tLRPC$TL_error == null) {
            ...
            if (arrayList.isEmpty()) {
                ...
                tLRPC$TL_channels_getParticipants.channel = MessagesController.getInstance(i).getInputChannel(tLRPC$Chat.f1522id);
                ...
                tLRPC$TL_messages_getFullChat.chat_id = tLRPC$Chat.f1522id;
    ...
    public /* synthetic */ void lambda$new$0(TLObject tLObject, int i, HashMap hashMap, ArrayList arrayList) {
        if (tLObject != null) {
            ...
            for (int i2 = 0; i2 < tLRPC$TL_channels_channelParticipants.users.size(); i2++) {
                ...
                hashMap.put(Long.valueOf(tLRPC$User.f1685id), tLRPC$User);
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.titleView.getLayoutParams().width = getMeasuredWidth() - AndroidUtilities.m72dp(40);
    ...
    private void updateView() {
        ...
        if (this.users.size() == 1) {
            this.avatarsImageView.setTranslationX(AndroidUtilities.m72dp(24));
        } else if (this.users.size() == 2) {
            this.avatarsImageView.setTranslationX(AndroidUtilities.m72dp(12));
        } else {
            this.avatarsImageView.setTranslationX(BitmapDescriptorFactory.HUE_RED);
        }
        this.titleView.setRightPadding(AndroidUtilities.m72dp((Math.min(2, this.users.size() - 1) * 12) + 32 + 6));
        ...
        if (this.peerIds.size() == 1 && this.users.get(0) != null) {
            ...
            this.titleView.setText(LocaleController.getString("NobodyViewed", C3473R.string.NobodyViewed));
        } else {
    ...
    public RecyclerListView createListView() {
        ...
        RecyclerListView recyclerListView2 = new RecyclerListView(this, getContext()) { // from class: org.telegram.ui.MessageSeenView.1
            ...
            public void onMeasure(int i, int i2) {
                ...
                int m72dp = AndroidUtilities.m72dp(4) + (AndroidUtilities.m72dp(50) * getAdapter().getItemCount());
                if (m72dp <= size) {
                    size = m72dp;
                }
        ...
        this.listView.setAdapter(new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.MessageSeenView.3
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                userCell.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m72dp(50)));
    ...
    private static class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        private static MessageSeenCheckDrawable seenDrawable = new MessageSeenCheckDrawable(C3473R.C3475drawable.msg_mini_checks, Theme.key_windowBackgroundWhiteGrayText);
        ...
        public UserCell(Context context) {
            ...
            this.nameView.setDrawablePadding(AndroidUtilities.m72dp(3));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(50), 1073741824));
        }
        ...
        public void setUser(TLObject tLObject, int i) {
            ...
            if (i <= 0) {
                ...
                this.nameView.setTranslationY(AndroidUtilities.m72dp(9));
                return;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            String formatString = LocaleController.formatString("AccDescrPersonHasSeen", C3473R.string.AccDescrPersonHasSeen, this.nameView.getText());
        ...
        public void didReceivedNotification(int i, int i2, Object... objArr) {
            if (i == NotificationCenter.userEmojiStatusUpdated) {
                ...
                if (tLRPC$User2 == null || tLRPC$User == null || tLRPC$User2.f1685id != tLRPC$User.f1685id) {
                    return;
                }
