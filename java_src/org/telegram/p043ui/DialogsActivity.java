...
import org.telegram.p043ui.Components.DialogsItemAnimator;
...
import org.telegram.p043ui.Components.PacmanAnimation;
...
import org.telegram.p043ui.GroupCreateFinalActivity;
...
public class DialogsActivity extends JavaMvpFragment implements NotificationCenter.NotificationCenterDelegate, FloatingDebugProvider, WalletAirdropView {
    ...
    private static final Interpolator interpolator = new Interpolator() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda61
        ...
        public final float getInterpolation(float f) {
            float lambda$static$22;
            lambda$static$22 = DialogsActivity.lambda$static$22(f);
    ...
    public static /* synthetic */ boolean lambda$createActionMode$85(View view, MotionEvent motionEvent) {
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ float lambda$static$22(float f) {
        float f2 = f - 1.0f;
    ...
    static /* synthetic */ float access$9124(DialogsActivity dialogsActivity, float f) {
    ...
    public static DialogsActivity newInstanceInAlbumsMode() {
        ...
        dialogsActivity.setDelegate(new DialogsActivityDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda166
    ...
    public void processQr(String str) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_auth_acceptLoginToken, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda155
    ...
    public /* synthetic */ void lambda$processQr$1(TLRPC$TL_error tLRPC$TL_error) {
        ...
        AlertsCreator.showSimpleAlert(this, LocaleController.getString("AuthAnotherClient", C3473R.string.AuthAnotherClient), str);
    }
    ...
    private void hideOrUnhideChats(final List<Long> list) {
        ...
        getUndoView().showWithAction(0L, i2, Boolean.TRUE, null, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda119
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void showReadAllDialog(final Runnable runnable) {
        ...
        builder.setTitle(LocaleController.getInternalString(C3473R.string.dialogs_mark_folder_dialogs_as_read_alert_title));
        final CheckBoxCell checkBoxCell = new CheckBoxCell(getParentActivity(), 1);
        checkBoxCell.setText(LocaleController.getInternalString(C3473R.string.dialogs_mark_all_folder_dialogs_as_read_alert_not_show_again_check_box), "", false, false);
        ...
        builder.setPositiveButton(LocaleController.getInternalString(C3473R.string.common_ok), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda14
    ...
    private void readAllCurrentFolderDialogs() {
        showReadAllDialog(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda105
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void expandMultiFab(final boolean z) {
        ...
        this.floatingButton.animate().rotation(33.0f).scaleX(0.4f).scaleY(0.4f).withEndAction(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda128
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$expandMultiFab$8(boolean z) {
        ...
        if (rLottieImageView != null) {
            rLottieImageView.setImageResource(z ? C3473R.C3475drawable.ic_close_white : C3473R.C3475drawable.ic_ab_other);
    ...
    private void checkAndRunNeurobots() {
        if (isMainNoFolderDialogList() && getNeuroBotsController().isNeuroBotsEnabled() && !this.neuroBotDataAlreadyFetched) {
            ...
            ApplicationLoader.smartBotsManager.listenForRemoteBotUpdates(new AiBotsManager.FirebaseSnapshotCallback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda64
                @Override // com.iMe.bots.usecase.AiBotsManager.FirebaseSnapshotCallback
                public final void onSuccess() {
                    DialogsActivity.lambda$checkAndRunNeurobots$10();
                }
            });
            ApplicationLoader.smartBotsManager.setBotDisableCallback(new AiBotsManager.BotsListChangedCallback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda63
                ...
                public final void onSuccess() {
                    DialogsActivity.this.lambda$checkAndRunNeurobots$11();
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$checkAndRunNeurobots$10() {
        ApplicationLoader.purchaseHelper.preloadPurchasesInfo();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkAndRunNeurobots$11() {
        NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botsListChanged, new Object[0]);
    }
    ...
    public List<FilterFab> getFabsForPage(ViewPage viewPage) {
        ...
        if (isAlbums() || isAlbumsDialogsType(viewPage.selectedType)) {
            ...
            singletonList = (viewPage.selectedType < 0 || viewPage.selectedType >= getMessagesController().dialogFilters.size()) ? null : getFiltersController().getSettings(getMessagesController().dialogFilters.get(viewPage.selectedType).f1459id).getFabs();
        }
    ...
    public void updateTopicsBar() {
        ...
        if (this.isTopicsBarVisible != z2) {
            ...
            if (rightSlidingDialogContainer != null && rightSlidingDialogContainer.hasFragment()) {
                ...
                layoutParams.topMargin = z2 ? 0 : AndroidUtilities.m72dp(-36);
            ...
            this.topicsBarTranslationYAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda8
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    DialogsActivity.this.lambda$updateTopicsBar$12(z2, valueAnimator2);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateTopicsBar$12(boolean z, ValueAnimator valueAnimator) {
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.topicsBar.getLayoutParams();
        layoutParams.topMargin = AndroidUtilities.m72dp(((Integer) valueAnimator.getAnimatedValue()).intValue());
        this.topicsBar.setLayoutParams(layoutParams);
    ...
    public void updateRecentChatsBar() {
        ...
        if (this.isRecentChatsBarVisible != z) {
            ...
            if (rightSlidingDialogContainer != null && rightSlidingDialogContainer.hasFragment()) {
                ...
                if (!z) {
                    i = AndroidUtilities.m72dp(SharedConfig.isDialogsCompactModeEnabled ? -48 : -60);
                }
            ...
            this.recentChatsBarTranslationYAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda7
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    DialogsActivity.this.lambda$updateRecentChatsBar$13(z, valueAnimator2);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateRecentChatsBar$13(boolean z, ValueAnimator valueAnimator) {
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.recentChatsBar.getLayoutParams();
        layoutParams.topMargin = AndroidUtilities.m72dp(((Integer) valueAnimator.getAnimatedValue()).intValue());
        this.recentChatsBar.setLayoutParams(layoutParams);
        float animatedFraction = valueAnimator.getAnimatedFraction();
    ...
    public void moveToFolder() {
        ...
        if (filterById.neverShow.size() + dialogsCount.size() > 100) {
            showDialog(AlertsCreator.createSimpleAlert(getParentActivity(), LocaleController.getString("FilterAddToAlertFullTitle", C3473R.string.FilterAddToAlertFullTitle), LocaleController.getString("FilterAddToAlertFullText", C3473R.string.FilterAddToAlertFullText)).create());
            return;
        }
        FiltersListBottomSheet filtersListBottomSheet = new FiltersListBottomSheet(this, this.selectedDialogs, filterById.f1459id);
        filtersListBottomSheet.setDelegate(new FiltersListBottomSheet.FiltersListBottomSheetDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda162
            ...
            public final void didSelectFilter(MessagesController.DialogFilter dialogFilter) {
                DialogsActivity.this.lambda$moveToFolder$16(dialogsCount, filterById, dialogFilter);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$moveToFolder$16(final ArrayList arrayList, final MessagesController.DialogFilter dialogFilter, MessagesController.DialogFilter dialogFilter2) {
        boolean z;
        char c;
        long j;
        ...
        final Callbacks$Callback callbacks$Callback = new Callbacks$Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda74
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                DialogsActivity.this.lambda$moveToFolder$14(arrayList, dialogFilter);
            }
        };
        if (dialogFilter2 != null) {
            ...
            if ((getMessagesController().dialogFilters.size() - 1 >= getMessagesController().dialogFiltersLimitDefault && !getUserConfig().isPremium()) || getMessagesController().dialogFilters.size() >= getMessagesController().dialogFiltersLimitPremium) {
                ...
                filterCreateActivity.setDoneCallback(new Callbacks$Callback2() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda72
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$moveToFolder$14(ArrayList arrayList, MessagesController.DialogFilter dialogFilter) {
    ...
    public int getRecentChatsBarHeight() {
        ...
        return AndroidUtilities.m72dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : 60) + ((FrameLayout.LayoutParams) this.recentChatsBar.getLayoutParams()).topMargin;
    }
    ...
    public int getTopicsBarHeight(boolean z) {
        ...
        return AndroidUtilities.m72dp(36) + ((FrameLayout.LayoutParams) this.topicsBar.getLayoutParams()).topMargin;
    }
    ...
    private void updateAccountSwitchItems() {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda137
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int lambda$updateAccountSwitchItems$17;
                lambda$updateAccountSwitchItems$17 = DialogsActivity.lambda$updateAccountSwitchItems$17((Integer) obj, (Integer) obj2);
                return lambda$updateAccountSwitchItems$17;
            }
        });
        ...
        while (it.hasNext()) {
            ...
            if (UserConfig.getInstance(intValue).getCurrentUser() != null) {
                if (isMainNoFolderDialogList()) {
                    ...
                    drawerUserCell.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda58
                        ...
                        public final boolean onLongClick(View view) {
                            boolean lambda$updateAccountSwitchItems$18;
                            lambda$updateAccountSwitchItems$18 = DialogsActivity.this.lambda$updateAccountSwitchItems$18(intValue, view);
                            return lambda$updateAccountSwitchItems$18;
                        }
                    });
                ...
                this.switchItem.addSubItem(intValue + 10, accountSelectCell, AndroidUtilities.m72dp(230), AndroidUtilities.m72dp(56));
            }
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ int lambda$updateAccountSwitchItems$17(Integer num, Integer num2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$updateAccountSwitchItems$18(int i, View view) {
        ...
        C57884 c57884 = new C57884(null, (LaunchActivity) getParentActivity(), i);
        c57884.setCurrentAccount(i);
        presentFragmentAsPreviewWithMenu(c57884, new FragmentPreviewMenu(this.parentLayout, c57884, null));
        return true;
    }
    ...
    /* loaded from: classes3.dex */
    public class C57884 extends DialogsActivity {
        ...
        C57884(Bundle bundle, LaunchActivity launchActivity, int i) {
            super(bundle);
        ...
        public void onTransitionAnimationEnd(boolean z, boolean z2) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C57884.this.lambda$onTransitionAnimationEnd$0(launchActivity, i);
                }
            }, 150L);
        }
    ...
    public void updateAlbumsMenu() {
        ...
        if (actionBarMenuSubItem2 != null) {
            if (SharedConfig.isSortCloudAlbumsByNameEnabled) {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getInternalString(C3473R.string.dialogs_albums_sort_date), C3473R.C3475drawable.msg_contacts_time);
            } else {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getInternalString(C3473R.string.dialogs_albums_sort_alphabetically), C3473R.C3475drawable.msg_contacts_name);
            }
        }
    }
    ...
    public void crossAccountsForward() {
        ...
        if (accountInstance.getMessagesController().blockePeers.indexOfKey(clientUserId2) >= 0) {
            accountInstance.getMessagesController().unblockPeer(clientUserId2, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda91
                @Override // java.lang.Runnable
                public final void run() {
            ...
            accountInstance2.getMessagesController().unblockPeer(clientUserId, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda91
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.crossAccountsForward();
                }
            ...
            accountInstance2.getNotificationsController().setDialogNotificationsSettings(clientUserId, 0, 3, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda91
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.crossAccountsForward();
                }
            }, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda93
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void animateSwitchArchive(boolean z) {
        ...
        fArr4[0] = z ? -AndroidUtilities.m72dp(44) : 0.0f;
        ...
        fArr6[0] = z ? -AndroidUtilities.m72dp(44) : 0.0f;
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda4
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                DialogsActivity.this.lambda$animateSwitchArchive$19(valueAnimator);
            }
        });
        ...
        if (z) {
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.5
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    DialogsActivity.this.forwardSwitchArchiveButton.setImageResource(DialogsActivity.this.isForwardToArchive ? C3473R.C3475drawable.msg_list : C3473R.C3475drawable.msg_archive);
                    ...
                    DialogsActivity.this.forwardSpansScrollView.setTranslationY(-AndroidUtilities.m72dp(44));
                    DialogsActivity.this.filterTabsView.setTranslationY(-AndroidUtilities.m72dp(44));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$animateSwitchArchive$19(ValueAnimator valueAnimator) {
    ...
    private void showEnableSortingByDefaultAlert() {
        ...
        Dialog createTopAnimationDialog = AlertsCreator.createTopAnimationDialog(getParentActivity(), C3473R.raw.fork_dialogs_sorting, 300, LocaleController.getInternalString(C3473R.string.sorting_enable_alert_message), LocaleController.getString("Enable", C3473R.string.Enable), new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda66
            @Override // com.iMe.fork.utils.Callbacks$Callback1
            public final void invoke(Object obj) {
                DialogsActivity.this.lambda$showEnableSortingByDefaultAlert$20((Boolean) obj);
            }
        });
        ...
        this.enableSortingByDefaultAlert.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda27
            @Override // android.content.DialogInterface.OnDismissListener
            public final void onDismiss(DialogInterface dialogInterface) {
                DialogsActivity.this.lambda$showEnableSortingByDefaultAlert$21(dialogInterface);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showEnableSortingByDefaultAlert$20(Boolean bool) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            filtersController.setIconInsteadAllChatsTabTitleEnabled(true);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showEnableSortingByDefaultAlert$21(DialogInterface dialogInterface) {
    ...
    public void openForwardingPreview() {
        ...
        C58136 c58136 = new C58136(getParentActivity(), this.forwardingParams, null, null, this.currentAccount, null, editField);
        this.forwardingPreviewView = c58136;
        ((ContentView) this.fragmentView).addView(c58136);
        if (editField != null) {
    ...
    /* loaded from: classes3.dex */
    public class C58136 extends ForwardingPreviewView {
        final /* synthetic */ EditText val$focusedEditText;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C58136(Context context, ForwardingMessagesParams forwardingMessagesParams, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, int i, ForwardingPreviewView.ResourcesDelegate resourcesDelegate, EditText editText) {
        ...
        protected void onDismiss(boolean z) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$6$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C58136.lambda$onDismiss$0(editText);
                }
            }, 50L);
        }
        ...
        protected void didOpenEditorPressed() {
            ...
            dialogsActivity.presentFragment(ChatActivity.newInstanceInForwardingEditor(((Long) dialogsActivity.selectedDialogs.get(0)).longValue(), DialogsActivity.this.forwardingParams, new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$6$$ExternalSyntheticLambda0
                @Override // com.iMe.fork.utils.Callbacks$Callback1
                public final void invoke(Object obj) {
                    DialogsActivity.C58136.this.lambda$didOpenEditorPressed$1((ForwardingMessagesParams) obj);
                }
            }));
            dismiss(false);
        }
    ...
    public void showForwardingOptionsHint(boolean z) {
        ...
        if (z) {
            if (this.forwardingOptionsHintView == null) {
                ...
                hintView.setText(LocaleController.getString("TapForForwardingOptions", C3473R.string.TapForForwardingOptions));
    ...
    public class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            DialogsActivity.this.forwardSearchEditText.measure(View.MeasureSpec.makeMeasureSpec(m72dp - i3, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(32), 1073741824));
            if (!this.animationStarted) {
                int m72dp5 = m72dp3 + AndroidUtilities.m72dp(42);
                int m72dp6 = i3 + AndroidUtilities.m72dp(16);
                DialogsActivity.this.forwardSearchEditTextTranslationY = m72dp2;
                if (this.currentAnimation == null) {
                    DialogsActivity.this.forwardSpansContainerHeight = m72dp5;
                    DialogsActivity.this.forwardSearchEditText.setTranslationX(m72dp6);
                    ...
                    if (DialogsActivity.this.forwardSpansContainerHeight != m72dp7) {
                        this.animators.add(ObjectAnimator.ofInt(DialogsActivity.this, "forwardSpansContainerHeight", m72dp7));
                    }
                    float f3 = m72dp6;
    ...
    public class ViewPage extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.animateStoriesView) {
                layoutParams.bottomMargin = -AndroidUtilities.m72dp(85);
            } else {
    ...
    public class ContentView extends SizeNotifierFrameLayout {
        ...
        public int getActionBarFullHeight() {
            ...
            if (DialogsActivity.this.hasStories) {
                measuredHeight += AndroidUtilities.m72dp(81) * (1.0f - DialogsActivity.this.searchAnimationProgress) * (1.0f - f) * (1.0f - DialogsActivity.this.progressToActionMode);
            }
            ...
            if (view != scrollView) {
                if (view != DialogsActivity.this.viewPages[0] && ((DialogsActivity.this.viewPages.length <= 1 || view != DialogsActivity.this.viewPages[1]) && view != DialogsActivity.this.fragmentContextView && view != DialogsActivity.this.fragmentLocationContextView && view != DialogsActivity.this.dialogsHintCell && view != DialogsActivity.this.topicsBar && view != DialogsActivity.this.recentChatsBar)) {
                    if (view == ((BaseFragment) DialogsActivity.this).actionBar && DialogsActivity.this.slideFragmentProgress != 1.0f) {
                        ...
                        if (dialogsActivity.slideFragmentLite) {
                            canvas.translate((dialogsActivity.isDrawerTransition ? 1 : -1) * AndroidUtilities.m72dp(40) * (1.0f - DialogsActivity.this.slideFragmentProgress), BitmapDescriptorFactory.HUE_RED);
                        } else {
                            float f2 = 1.0f - ((1.0f - dialogsActivity.slideFragmentProgress) * 0.05f);
                            canvas.translate((dialogsActivity.isDrawerTransition ? AndroidUtilities.m72dp(4) : -AndroidUtilities.m72dp(4)) * (1.0f - DialogsActivity.this.slideFragmentProgress), BitmapDescriptorFactory.HUE_RED);
                            if (DialogsActivity.this.isDrawerTransition) {
                                f = getMeasuredWidth();
                            }
                            canvas.scale(f2, f2, f, (((BaseFragment) DialogsActivity.this).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + (C3541ActionBar.getCurrentActionBarHeight() / 2.0f));
                        }
                ...
                if (dialogsActivity2.slideFragmentProgress != 1.0f && view != dialogsActivity2.topicsBar && view != DialogsActivity.this.recentChatsBar) {
                    ...
                    if (dialogsActivity3.slideFragmentLite) {
                        canvas.translate((dialogsActivity3.isDrawerTransition ? 1 : -1) * AndroidUtilities.m72dp(40) * (1.0f - DialogsActivity.this.slideFragmentProgress), BitmapDescriptorFactory.HUE_RED);
                    } else {
                        float f3 = 1.0f - ((1.0f - dialogsActivity3.slideFragmentProgress) * 0.05f);
                        canvas.translate((dialogsActivity3.isDrawerTransition ? AndroidUtilities.m72dp(4) : -AndroidUtilities.m72dp(4)) * (1.0f - DialogsActivity.this.slideFragmentProgress), BitmapDescriptorFactory.HUE_RED);
                        if (DialogsActivity.this.isDrawerTransition) {
                            f = getMeasuredWidth();
                        }
        ...
        */
        public void dispatchDraw(android.graphics.Canvas r19) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.ContentView.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        */
        protected void onMeasure(int r20, int r21) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.ContentView.onMeasure(int, int):void");
        }
        ...
        */
        public void onLayout(boolean r17, int r18, int r19, int r20, int r21) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.ContentView.onLayout(boolean, int, int, int, int):void");
        }
            ...
            for (int i = 0; i < DialogsActivity.this.viewPages.length; i++) {
                if (DialogsActivity.this.viewPages[i] != null && DialogsActivity.this.viewPages[i].getVisibility() == 0) {
                    for (int i2 = 0; i2 < DialogsActivity.this.viewPages[i].listView.getChildCount(); i2++) {
                        ...
                        if (childAt.getY() < DialogsActivity.this.viewPages[i].listView.blurTopPadding + AndroidUtilities.m72dp(100)) {
    ...
    public void updateStoriesViewAlpha(float f) {
        ...
        if (this.hasStories || this.animateToHasStories) {
            float clamp = Utilities.clamp((-this.scrollYOffset) / AndroidUtilities.m72dp(81), 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            float clamp2 = Utilities.clamp(clamp / 0.5f, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            this.dialogStoriesCell.setClipTop(0);
            if (!this.hasStories && this.animateToHasStories) {
                this.dialogStoriesCell.setTranslationY((-AndroidUtilities.m72dp(81)) - AndroidUtilities.m72dp(8));
                this.dialogStoriesCell.setProgressToCollapse(1.0f);
                f3 = this.progressToDialogStoriesCell;
            } else {
                this.dialogStoriesCell.setTranslationY(((this.scrollYOffset + this.storiesYOffset) + (this.storiesOverscroll / 2.0f)) - AndroidUtilities.m72dp(8));
            ...
            if (this.hasOnlySlefStories) {
                this.dialogStoriesCell.setTranslationY((-AndroidUtilities.m72dp(81)) + this.scrollYOffset);
                this.dialogStoriesCell.setProgressToCollapse(1.0f);
        ...
        if (f2 != 1.0f) {
            this.actionBar.getTitlesContainer().setPivotY(AndroidUtilities.statusBarHeight + (C3541ActionBar.getCurrentActionBarHeight() / 2.0f));
            this.actionBar.getTitlesContainer().setPivotX(AndroidUtilities.m72dp(72));
    ...
    public class DialogsRecyclerView extends BlurredRecyclerView implements StoriesListPlaceProvider.ClippedView {
        ...
        public DialogsRecyclerView(Context context, ViewPage viewPage) {
            ...
            this.additionalClipBottom = AndroidUtilities.m72dp(200);
        }
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r24) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.DialogsRecyclerView.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        @Override // org.telegram.p043ui.Components.RecyclerListView, androidx.recyclerview.widget.RecyclerView
        public void setAdapter(RecyclerView.Adapter adapter) {
            super.setAdapter(adapter);
            this.firstLayout = true;
        }

        @Override // org.telegram.p043ui.Components.BlurredRecyclerView, org.telegram.p043ui.Components.RecyclerListView, androidx.recyclerview.widget.RecyclerView, android.view.View
        protected void onMeasure(int i, int i2) {
            ...
            if (!DialogsActivity.this.onlySelect || DialogsActivity.this.initialDialogsType == 3) {
                this.ignoreLayout = true;
                DialogsActivity dialogsActivity = DialogsActivity.this;
                if (dialogsActivity.hasStories || (dialogsActivity.filterTabsView != null && DialogsActivity.this.filterTabsView.getVisibility() == 0 && !DialogsActivity.this.isFilterTabsAtBottom())) {
                    currentActionBarHeight = C3541ActionBar.getCurrentActionBarHeight() + (((BaseFragment) DialogsActivity.this).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0);
                } else {
                ...
                if (dialogsActivity2.hasStories && !dialogsActivity2.actionModeFullyShowed) {
                    currentActionBarHeight += AndroidUtilities.m72dp(81);
                }
                setTopGlowOffset(currentActionBarHeight);
                setPadding(0, currentActionBarHeight, 0, 0);
                if (DialogsActivity.this.hasStories) {
                    this.parentPage.progressView.setPaddingTop(currentActionBarHeight - AndroidUtilities.m72dp(81));
                } else {
        ...
        @Override // org.telegram.p043ui.Components.BlurredRecyclerView, org.telegram.p043ui.Components.RecyclerListView, androidx.recyclerview.widget.RecyclerView, android.view.View, android.view.ViewParent
        ...
        public void toggleArchiveHidden(boolean z, DialogCell dialogCell) {
            ...
            if (dialogCell != null) {
                ...
                if (dialogsActivity.hasStories && !dialogsActivity.dialogStoriesCell.isExpanded()) {
                    ...
                    measuredHeight += AndroidUtilities.m72dp(81);
                }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.parentPage.dialogsType == 0 && ((action == 1 || action == 3) && this.parentPage.archivePullViewState == 2 && DialogsActivity.this.hasHiddenArchive() && ((LinearLayoutManager) getLayoutManager()).findFirstVisibleItemPosition() == 0)) {
                ...
                if (findArchiveDialogCell != null) {
                    int m72dp = (int) (AndroidUtilities.m72dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : SharedConfig.useThreeLinesLayout ? 78 : 72) * 0.85f);
                    ...
                    if (top < m72dp || currentTimeMillis < 200) {
                        DialogsActivity.this.disableActionBarScrolling = true;
                        ...
                        if (AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
                            AndroidUtilities.makeAccessibilityAnnouncement(LocaleController.getString(C3473R.string.AccDescrArchivedChatsShown));
                        }
                    }
                    if (getViewOffset() != BitmapDescriptorFactory.HUE_RED) {
        ...
        public void setAnimationSupportView(RecyclerListView recyclerListView, float f, boolean z, boolean z2) {
            ...
            DialogCell dialogCell5 = (dialogCell == null || getAdapter().getItemCount() * AndroidUtilities.m72dp(70) <= getMeasuredHeight() || ((float) (dialogCell2.getTop() - getPaddingTop())) <= ((float) (getMeasuredHeight() - getPaddingTop())) / 2.0f) ? dialogCell2 : dialogCell;
            this.animationSupportListView = recyclerListView;
            if (dialogCell5 != null) {
                ...
                if (z2 && DialogsActivity.this.hasStories) {
                    top2 += AndroidUtilities.m72dp(81);
                }
        ...
        */
        public int getMovementFlags(androidx.recyclerview.widget.RecyclerView r12, androidx.recyclerview.widget.RecyclerView.ViewHolder r13) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.SwipeController.getMovementFlags(androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView$ViewHolder):int");
        }
        ...
        public /* synthetic */ void lambda$onSwiped$3(final TLRPC$Dialog tLRPC$Dialog, int i, int i2) {
            ...
            boolean z = false;
            if (!DialogsActivity.this.getMessagesController().isPromoDialog(tLRPC$Dialog.f1528id, false)) {
                if (!DialogsActivity.this.isHiddenChats()) {
                    int addDialogToFolder = DialogsActivity.this.getMessagesController().addDialogToFolder(tLRPC$Dialog.f1528id, DialogsActivity.this.folderId == 0 ? 1 : 0, -1, 0L);
                    int i4 = 2;
                            ...
                            if (i2 == 0) {
                                ...
                                if (!DialogsActivity.this.isArchive() ? !SharedConfig.archiveHidden : !DialogsActivity.this.getHiddenChatsController().isHiddenChatsHidden()) {
                                    if (this.parentPage.layoutManager.findFirstVisibleItemPosition() == 0) {
                                        DialogsActivity.this.disableActionBarScrolling = true;
                                        this.parentPage.listView.smoothScrollBy(0, -AndroidUtilities.m72dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : SharedConfig.useThreeLinesLayout ? 78 : 72));
                                    }
                                }
                            }
                            DialogsActivity dialogsActivity = DialogsActivity.this;
                    ...
                    return;
                } else if (DialogsActivity.this.getHiddenChatsController().hideChats(tLRPC$Dialog.f1528id, false)) {
                    return;
                } else {
        ...
        public /* synthetic */ void lambda$onSwiped$0(TLRPC$Dialog tLRPC$Dialog) {
            DialogsActivity.this.getHiddenChatsController().hideChats(tLRPC$Dialog.f1528id, true);
            DialogsActivity.this.setDialogsListFrozen(true);
            this.parentPage.dialogsItemAnimator.prepareForRemove();
            this.parentPage.updateList(true);
            DialogsActivity.this.checkAnimationFinished();
        ...
        public /* synthetic */ void lambda$onSwiped$2(TLRPC$Dialog tLRPC$Dialog, int i) {
            ...
            DialogsActivity.this.getMessagesController().addDialogToFolder(tLRPC$Dialog.f1528id, DialogsActivity.this.isArchive() ? 1 : 0, i, 0L);
    ...
    public static void loadDialogs(final AccountInstance accountInstance) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda76
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.lambda$loadDialogs$23(AccountInstance.this);
            }
        }, 200L);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$loadDialogs$23(AccountInstance accountInstance) {
    ...
    public void updateStatus(TLRPC$User tLRPC$User, boolean z) {
        ...
        if (isShowPremiumStatusEnabled && emojiStatusDocumentId != null) {
            ...
            this.actionBar.setRightDrawableOnClick(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda38
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$updateStatus$24(view);
                }
            });
            ...
            if (this.premiumStar == null) {
                this.premiumStar = getContext().getResources().getDrawable(C3473R.C3475drawable.msg_premium_liststar).mutate();
                this.premiumStar = new AnimatedEmojiDrawable.WrapSizeDrawable(this, this.premiumStar, AndroidUtilities.m72dp(18), AndroidUtilities.m72dp(18)) { // from class: org.telegram.ui.DialogsActivity.9
                    @Override // org.telegram.p043ui.Components.AnimatedEmojiDrawable.WrapSizeDrawable, android.graphics.drawable.Drawable
                    public void draw(Canvas canvas) {
                        canvas.save();
                        canvas.translate(AndroidUtilities.m72dp(-2), AndroidUtilities.m72dp(1));
                        super.draw(canvas);
                        canvas.restore();
                    }
                };
            ...
            this.actionBar.setRightDrawableOnClick(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda31
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$updateStatus$25(view);
                }
            });
            SelectAnimatedEmojiDialog.preload(this.currentAccount);
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateStatus$24(View view) {
        showSelectStatusDialog();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateStatus$25(View view) {
        showSelectStatusDialog();
    }
    ...
    public C3541ActionBar createActionBar(Context context) {
        C3541ActionBar c3541ActionBar = new C3541ActionBar(context) { // from class: org.telegram.ui.DialogsActivity.10
            ...
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // org.telegram.p043ui.ActionBar.C3541ActionBar, android.view.ViewGroup
            public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        c3541ActionBar.setUseContainerForTitles();
        c3541ActionBar.setItemsBackgroundColor(Theme.getColor(Theme.key_actionBarDefaultSelector), false);
        c3541ActionBar.setItemsBackgroundColor(Theme.getColor(Theme.key_actionBarActionModeDefaultSelector), true);
        c3541ActionBar.setItemsColor(Theme.getColor(Theme.key_actionBarDefaultIcon), false);
        c3541ActionBar.setItemsColor(Theme.getColor(Theme.key_actionBarActionModeDefaultIcon), true);
     ...
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:187:0x06fe  */
    /* JADX WARN: Removed duplicated region for block: B:241:0x0962  */
    /* JADX WARN: Removed duplicated region for block: B:246:0x0a47  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:257:0x0ada  */
    /* JADX WARN: Removed duplicated region for block: B:260:0x0ae7  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:282:0x0b2c  */
    /* JADX WARN: Removed duplicated region for block: B:285:0x0b32  */
    /* JADX WARN: Removed duplicated region for block: B:286:0x0b35  */
    /* JADX WARN: Removed duplicated region for block: B:289:0x0b3b  */
    /* JADX WARN: Removed duplicated region for block: B:290:0x0b3e  */
    /* JADX WARN: Removed duplicated region for block: B:293:0x0b44  */
    /* JADX WARN: Removed duplicated region for block: B:294:0x0b47  */
    /* JADX WARN: Removed duplicated region for block: B:297:0x0b58  */
    /* JADX WARN: Removed duplicated region for block: B:308:0x0c11  */
    /* JADX WARN: Removed duplicated region for block: B:311:0x0c8a  */
    /* JADX WARN: Removed duplicated region for block: B:312:0x0cb7  */
    /* JADX WARN: Removed duplicated region for block: B:315:0x0ccb  */
    /* JADX WARN: Removed duplicated region for block: B:341:0x0e04  */
    /* JADX WARN: Removed duplicated region for block: B:385:0x10c0  */
    /* JADX WARN: Removed duplicated region for block: B:388:0x10c9  */
    /* JADX WARN: Removed duplicated region for block: B:401:0x1123  */
    /* JADX WARN: Removed duplicated region for block: B:408:0x115f  */
    /* JADX WARN: Removed duplicated region for block: B:412:0x11fd  */
    /* JADX WARN: Removed duplicated region for block: B:413:0x1206  */
    /* JADX WARN: Removed duplicated region for block: B:419:0x1225  */
    /* JADX WARN: Removed duplicated region for block: B:430:0x128e  */
    /* JADX WARN: Removed duplicated region for block: B:433:0x12be  */
    /* JADX WARN: Removed duplicated region for block: B:436:0x12d1  */
    /* JADX WARN: Removed duplicated region for block: B:439:0x12e0  */
    /* JADX WARN: Removed duplicated region for block: B:440:0x12e3  */
    /* JADX WARN: Removed duplicated region for block: B:443:0x12f0  */
    /* JADX WARN: Removed duplicated region for block: B:451:0x137c  */
    /* JADX WARN: Removed duplicated region for block: B:452:0x1387  */
    /* JADX WARN: Removed duplicated region for block: B:460:0x13b1  */
    ...
    */
    public android.view.View createView(final android.content.Context r42) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.createView(android.content.Context):android.view.View");
    }
    ...
    public /* synthetic */ boolean lambda$createView$30(View view) {
        this.filterOptions = ItemOptions.makeOptions(this, this.proxyItem).setViewAdditionalOffsets(-AndroidUtilities.m72dp(5), -AndroidUtilities.m72dp(9), -AndroidUtilities.m72dp(5), -AndroidUtilities.m72dp(9)).setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m72dp(48), Theme.getColor(isArchive() ? Theme.key_actionBarDefaultArchived : Theme.key_actionBarDefault))).add(C3473R.C3475drawable.msg_disable, LocaleController.getString("Disable", C3473R.string.Disable), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda97
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createView$29();
            }
        }).translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m72dp(-8)).show();
        return true;
    }
    ...
    /* loaded from: classes3.dex */
    public class C575611 extends ActionBarMenuItem.ActionBarMenuItemSearchListener {
        boolean isSpeedItemCreated = false;
        final /* synthetic */ Context val$context;
        final /* synthetic */ ActionBarMenu val$menu;

        C575611(Context context, ActionBarMenu actionBarMenu) {
        ...
        public void onPreToggleSearch() {
            ...
            DialogsActivity.this.speedItem.setIcon(C3473R.C3475drawable.avd_speed);
            ...
            DialogsActivity.this.speedItem.setTranslationX(AndroidUtilities.m72dp(32));
            ...
            DialogsActivity.this.speedItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$11$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.C575611.this.lambda$onPreToggleSearch$0(view);
                }
            });
            DialogsActivity.this.speedItem.setClickable(false);
            DialogsActivity.this.speedItem.setFixBackground(true);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(AndroidUtilities.m72dp(42), -1);
            int m72dp = AndroidUtilities.m72dp(38);
        ...
        public void onSearchExpand() {
            ...
            ((BaseFragment) DialogsActivity.this).actionBar.setBackButtonContentDescription(LocaleController.getString("AccDescrGoBack", C3473R.string.AccDescrGoBack));
        ...
        public void onSearchCollapse() {
            ...
            if (DialogsActivity.this.viewPages[0] != null) {
                ...
                if (!DialogsActivity.this.onlySelect || DialogsActivity.this.isAlbums()) {
                    ...
                    DialogsActivity.this.floatingButtonTranslation = AndroidUtilities.m72dp(100);
            ...
            if (DialogsActivity.this.menuDrawable != null) {
                ...
                ((BaseFragment) DialogsActivity.this).actionBar.setBackButtonContentDescription(LocaleController.getString("AccDescrOpenMenu", C3473R.string.AccDescrOpenMenu));
            }
        ...
        */
        public void onTextChanged(android.widget.EditText r4) {
            /*
                ...
                int r0 = r4.length()
                if (r0 != 0) goto L38
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                org.telegram.ui.Components.SearchViewPager r0 = org.telegram.p043ui.DialogsActivity.access$5700(r0)
            ...
            L26:
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                boolean r0 = org.telegram.p043ui.DialogsActivity.access$24800(r0)
                if (r0 != 0) goto L38
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
            ...
            L38:
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                r1 = 1
                org.telegram.p043ui.DialogsActivity.access$23702(r0, r1)
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                boolean r0 = org.telegram.p043ui.DialogsActivity.access$8300(r0)
                if (r0 != 0) goto L4c
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                r2 = 0
                org.telegram.p043ui.DialogsActivity.access$24200(r0, r1, r2, r1)
            L4c:
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                org.telegram.ui.Components.SearchViewPager r0 = org.telegram.p043ui.DialogsActivity.access$5700(r0)
                r0.onTextChanged(r4)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.C575611.onTextChanged(android.widget.EditText):void");
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createView$33(View view) {
        this.filterOptions = ItemOptions.makeOptions(this, this.optionsItem).setViewAdditionalOffsets(-AndroidUtilities.m72dp(5), -AndroidUtilities.m72dp(9), -AndroidUtilities.m72dp(5), -AndroidUtilities.m72dp(9)).setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m72dp(48), Theme.getColor(Theme.key_actionBarDefault))).add(C3473R.C3475drawable.msg_disable, LocaleController.getString("Disable", C3473R.string.Disable), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda89
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createView$32();
            }
        }).translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m72dp(-8)).show();
        return true;
    }
    ...
    /* loaded from: classes3.dex */
    public class C575712 extends FilterTabsView {
        C575712(Context context, FilterTabsView.TabMode tabMode, SizeNotifierFrameLayout sizeNotifierFrameLayout) {
        ...
        @Override // org.telegram.p043ui.Components.FilterTabsView
        protected void onDefaultTabMoved() {
            ...
            DialogsActivity dialogsActivity = DialogsActivity.this;
            dialogsActivity.topBulletin = BulletinFactory.m32of(dialogsActivity).createSimpleBulletin(C3473R.raw.filter_reorder, AndroidUtilities.replaceTags(LocaleController.formatString("LimitReachedReorderFolder", C3473R.string.LimitReachedReorderFolder, LocaleController.getString(C3473R.string.FilterAllChats))), LocaleController.getString("PremiumMore", C3473R.string.PremiumMore), DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS, new Runnable() { // from class: org.telegram.ui.DialogsActivity$12$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C575712.this.lambda$onDefaultTabMoved$0();
                }
            }).show(true);
        }
    ...
    /* loaded from: classes3.dex */
    public class C575813 implements FilterTabsView.FilterTabsViewDelegate {
        final /* synthetic */ Context val$context;

        C575813(Context context) {
            this.val$context = context;
        }

        @Override // org.telegram.p043ui.Components.FilterTabsView.FilterTabsViewDelegate
        public void onTabSelected(int i) {
            ...
            if (DialogsActivity.this.miniFabsContainer == null || fabsForPage.size() <= 1) {
                ...
                DialogsActivity.this.floatingButton.setImageResource(C3473R.C3475drawable.ic_ab_other);
            ...
            if (DialogsActivity.this.isMainNoFolderDialogList()) {
                if (SortingFilter.isSortingFilter(false, i)) {
                    ...
                    DialogsActivity.this.getForkCommonController().setLastFilterTab(DialogsActivity.this.getMessagesController().dialogFilters.get(i).f1459id);
                }
        ...
        public void lambda$didSelectTab$8(final MessagesController.DialogFilter dialogFilter) {
            ...
            if (dialogFilter.isChatlist()) {
                FolderBottomSheet.showForDeletion(DialogsActivity.this, dialogFilter.f1459id, null);
                return;
            }
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            builder.setTitle(LocaleController.getString("FilterDelete", C3473R.string.FilterDelete));
            builder.setMessage(LocaleController.getString("FilterDeleteAlert", C3473R.string.FilterDeleteAlert));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString("Delete", C3473R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.C575813.this.lambda$showDeleteAlert$0(dialogFilter, dialogInterface, i);
                }
            });
        ...
        public void onPageSelected(FilterTabsView.Tab tab, boolean z) {
            int i;
            if (DialogsActivity.this.viewPages[0].selectedType == tab.f1761id) {
                return;
            }
            if (tab.isLocked) {
                DialogsActivity.this.filterTabsView.shakeLock(tab.f1761id);
                DialogsActivity dialogsActivity = DialogsActivity.this;
                DialogsActivity dialogsActivity2 = DialogsActivity.this;
            ...
            if (SortingFilter.isSortingFilter(false, tab.f1761id)) {
                if (SortingFilter.removeExtraFromId(false, tab.f1761id) >= DialogsActivity.this.getMessagesController().sortingDialogFilters.size()) {
                    return;
                }
            } else if (SortingFilter.isSortingFilter(true, tab.f1761id)) {
                if (SortingFilter.removeExtraFromId(true, tab.f1761id) >= DialogsActivity.this.getMessagesController().archiveSortingDialogFilters.size()) {
                    return;
                }
            } else if (!tab.isDefault && (((i = tab.f1761id) < 0 || i >= dialogFilters.size()) && !DialogsActivity.isAlbumsDialogsType(tab.f1761id) && !DialogsActivity.this.isArchive())) {
                return;
            }
            DialogsActivity dialogsActivity3 = DialogsActivity.this;
            dialogsActivity3.isFirstTab = tab.f1761id == dialogsActivity3.filterTabsView.getFirstTabId();
            DialogsActivity.this.updateDrawerSwipeEnabled();
            DialogsActivity.this.viewPages[1].selectedType = tab.f1761id;
            DialogsActivity.this.viewPages[1].setVisibility(0);
            DialogsActivity.this.viewPages[1].setTranslationX(DialogsActivity.this.viewPages[0].getMeasuredWidth());
            DialogsActivity.this.showScrollbars(false);
            DialogsActivity.this.switchToCurrentSelectedMode(true);
        ...
        public boolean didSelectTab(final FilterTabsView.TabView tabView, boolean z) {
            ...
            if (DialogsActivity.this.initialDialogsType == 0 && AndroidUtilities.isActivityRunning(DialogsActivity.this.getParentActivity()) && tabView != null) {
                ...
                if (DialogsActivity.this.filterOptions == null || !DialogsActivity.this.filterOptions.isShown()) {
                    ...
                    if (filterById != null) {
                        ...
                        if (dialogFilter != null) {
                            while (i3 < arrayList.size()) {
                                if (!dialogFilter.includesDialog(DialogsActivity.this.getAccountInstance(), ((TLRPC$Dialog) arrayList.get(i3)).f1528id)) {
                                    arrayList.remove(i3);
                                    i3--;
                                }
                                i3++;
                        ...
                        if (arrayList.isEmpty()) {
                            ...
                            while (true) {
                                ...
                                z3 = i3;
                                if (!DialogsActivity.this.getMessagesController().isDialogMuted(((TLRPC$Dialog) arrayList.get(i5)).f1528id, 0)) {
                                    z4 = false;
                                    break;
                                }
                                i5++;
                    ...
                    DialogsActivity dialogsActivity = DialogsActivity.this;
                    boolean z8 = z3;
                    ItemOptions addIf = ItemOptions.makeOptions(dialogsActivity, tabView).setScrimViewBackground(Theme.createRoundRectDrawable(AndroidUtilities.m72dp(6), 0, Theme.getColor(DialogsActivity.this.isArchive() ? Theme.key_actionBarDefaultArchived : Theme.key_actionBarDefault))).addFuturePlacement().addIf(!(z5 && DialogsActivity.this.isArchive()) && (!isSortingFilter || DialogsActivity.this.getFiltersController().getActiveSortingTabsCount(DialogsActivity.this.isArchive()) > 1) && !DialogsActivity.this.getFiltersController().isFoldersHidden() && DialogsActivity.this.getMessagesController().getDialogFilters().size() > 1, C3473R.C3475drawable.tabs_reorder, LocaleController.getString("FilterReorder", C3473R.string.FilterReorder), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda7
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$1(isSortingFilter);
                        }
                    }).addIf(!DialogsActivity.this.isArchive() && DialogsActivity.this.getMessagesController().dialogFilters.size() < DialogsActivity.this.getMessagesController().dialogFiltersLimitPremium, C3473R.C3475drawable.fork_create_folder, LocaleController.getInternalString(C3473R.string.dialogs_tab_popup_create_folder), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$2();
                        }
                    }).addIf(!z6, C3473R.C3475drawable.msg_settings, LocaleController.getInternalString(C3473R.string.dialogs_tab_popup_sorting_settings), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$3();
                        }
                    });
                    int i7 = C3473R.C3475drawable.msg_edit;
                    if (z5) {
                        i = C3473R.string.FilterEditAll;
                        str = "FilterEditAll";
                    } else {
                        i = C3473R.string.FilterEdit;
                        str = "FilterEdit";
                    }
                    ItemOptions add = addIf.add(i7, (CharSequence) LocaleController.getString(str, i), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda8
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$4(z5, filterById);
                        }
                    }, z6, false);
                    boolean z9 = (isAlbumsDialogsType || filterById == null || arrayList.isEmpty()) ? false : true;
                    int i8 = z2 ? C3473R.C3475drawable.msg_mute : C3473R.C3475drawable.msg_unmute;
                    if (z2) {
                        i2 = C3473R.string.FilterMuteAll;
                        str2 = "FilterMuteAll";
                    } else {
                        i2 = C3473R.string.FilterUnmuteAll;
                    ...
                    dialogsActivity.filterOptions = add.addIf(z9, i8, LocaleController.getString(str2, i2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$5(arrayList, z2);
                        }
                    }).addIf(z7, C3473R.C3475drawable.msg_markread, (CharSequence) LocaleController.getString("MarkAllAsRead", C3473R.string.MarkAllAsRead), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$6(arrayList);
                        }
                    }, true).addIf(z8, C3473R.C3475drawable.msg_share, FilterCreateActivity.withNew((dialogFilter == null || !dialogFilter.isMyChatlist()) ? 0 : -1, LocaleController.getString("LinkActionShare", C3473R.string.LinkActionShare), true), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda10
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$7(zArr, dialogFilter);
                        }
                    }).addIf((z5 || isSortingFilter) ? false : true, C3473R.C3475drawable.msg_delete, (CharSequence) LocaleController.getString("FilterDeleteItem", C3473R.string.FilterDeleteItem), true, new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda6
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$8(filterById);
                        }
                    }).addIf((z6 || (z5 && (DialogsActivity.this.isArchive() || !DialogsActivity.this.getFiltersController().isAllChatsTabEnabled() || DialogsActivity.this.filterTabsView == null || DialogsActivity.this.filterTabsView.getTabsCount() == 2))) ? false : true, C3473R.C3475drawable.msg_disable, LocaleController.getInternalString(C3473R.string.dialogs_tab_popup_disable), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda9
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C575813.this.lambda$didSelectTab$10(z5, isSortingFilter, tabView);
                        }
                    }).setGravity(3).translate(AndroidUtilities.m72dp(-8), AndroidUtilities.m72dp(DialogsActivity.this.isFilterTabsAtBottom() ? 10 : -10)).show();
                    return true;
                }
        ...
        public /* synthetic */ void lambda$didSelectTab$5(ArrayList arrayList, boolean z) {
            ...
            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                ...
                if (tLRPC$Dialog != null) {
                    DialogsActivity.this.getNotificationsController().setDialogNotificationsSettings(tLRPC$Dialog.f1528id, 0, z ? 3 : 4);
                    i++;
                }
            }
        ...
        public /* synthetic */ void lambda$didSelectTab$10(boolean z, boolean z2, FilterTabsView.TabView tabView) {
            ...
            UndoView undoView = DialogsActivity.this.getUndoView();
            if (undoView != null) {
                undoView.showInfo(AndroidUtilities.replaceTags(LocaleController.getInternalString(C3473R.string.undo_all_chats_tab_disabled)), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C575813.this.lambda$didSelectTab$9();
                    }
                });
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createView$38(View view) {
        this.filterOptions = ItemOptions.makeOptions(this, this.switchItem).setViewAdditionalOffsets(-AndroidUtilities.m72dp(5), -AndroidUtilities.m72dp(5), -AndroidUtilities.m72dp(5), -AndroidUtilities.m72dp(5)).setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m72dp(46), Theme.getColor(Theme.key_actionBarDefault))).add(C3473R.C3475drawable.msg_disable, LocaleController.getString("Disable", C3473R.string.Disable), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda92
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createView$37();
            }
        }).translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m72dp(-4)).show();
        return true;
    }
    ...
    /* loaded from: classes3.dex */
    public class C576116 extends LinearLayoutManager {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C576116(Context context, ViewPage viewPage) {
            super(context);
        ...
        public void onScrollStateChanged(int i) {
            ...
            if (this.val$viewPage.listView.getScrollState() != 1) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$16$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        DialogsActivity.C576116.this.lambda$onScrollStateChanged$0(viewPage, valueAnimator2);
                    }
                });
                this.storiesOverscrollAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.16.1
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        C576116 c576116 = C576116.this;
                        DialogsActivity.this.setStoriesOvercroll(c576116.val$viewPage, BitmapDescriptorFactory.HUE_RED);
                    }
                });
        ...
        */
        public int scrollVerticallyBy(int r19, androidx.recyclerview.widget.RecyclerView.Recycler r20, androidx.recyclerview.widget.RecyclerView.State r21) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.C576116.scrollVerticallyBy(int, androidx.recyclerview.widget.RecyclerView$Recycler, androidx.recyclerview.widget.RecyclerView$State):int");
        }
        ...
        public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$16$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C576116.lambda$onLayoutChildren$1(DialogsActivity.ViewPage.this);
                    }
                });
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$39(ViewPage viewPage, View view, int i, float f, float f2) {
        ...
        if (i2 == 15 && (view instanceof TextCell)) {
            ...
            groupCreateFinalActivity.setDelegate(new GroupCreateFinalActivity.GroupCreateFinalActivityDelegate() { // from class: org.telegram.ui.DialogsActivity.17
                @Override // org.telegram.p043ui.GroupCreateFinalActivity.GroupCreateFinalActivityDelegate
                ...
                public void didFinishChatCreation(GroupCreateFinalActivity groupCreateFinalActivity2, long j) {
                    ...
                    arrayList.add(MessagesStorage.TopicKey.m64of(-j, 0));
            ...
            if ((view instanceof DialogsHintCell) && (viewPage.dialogsType == 7 || viewPage.dialogsType == 8)) {
                ...
                if (chatlistUpdate != null) {
                    ...
                    if (dialogFilter != null) {
                        showDialog(new FolderBottomSheet(this, dialogFilter.f1459id, chatlistUpdate));
                        return;
                    }
                    return;
                }
    ...
    /* loaded from: classes3.dex */
    public class C577830 implements DialogsSearchAdapter.DialogsSearchAdapterDelegate {
        /* JADX INFO: Access modifiers changed from: private */
        ...
        @Override // org.telegram.p043ui.Adapters.DialogsSearchAdapter.DialogsSearchAdapterDelegate
        public void clearTopPeers() {
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            builder.setTitle(LocaleController.getString("ChatHintsDeleteAlertTitle", C3473R.string.ChatHintsDeleteAlertTitle));
            builder.setMessage(LocaleController.getString("SuggestContactsAlert", C3473R.string.SuggestContactsAlert));
            builder.setPositiveButton(LocaleController.getString("MuteDisable", C3473R.string.MuteDisable), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda2
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.C577830.this.lambda$clearTopPeers$2(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
            AlertDialog create = builder.create();
        ...
        public /* synthetic */ void lambda$clearTopPeers$2(DialogInterface dialogInterface, int i) {
            ...
            DialogsActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_contacts_toggleTopPeers, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda4
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    DialogsActivity.C577830.this.lambda$clearTopPeers$1(tLObject, tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$clearTopPeers$1(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            DialogsActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_contacts_toggleTopPeers, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda5
                ...
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error2) {
                    DialogsActivity.C577830.lambda$clearTopPeers$0(tLObject2, tLRPC$TL_error2);
                }
            });
        }
        ...
        public void needRemoveHint(final long j) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            builder.setTitle(LocaleController.getString("ChatHintsDeleteAlertTitle", C3473R.string.ChatHintsDeleteAlertTitle));
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("ChatHintsDeleteAlert", C3473R.string.ChatHintsDeleteAlert, ContactsController.formatName(user.first_name, user.last_name))));
            builder.setPositiveButton(LocaleController.getString("StickersRemove", C3473R.string.StickersRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda3
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.C577830.this.lambda$needRemoveHint$3(j, dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
            AlertDialog create = builder.create();
        ...
        public void needClearList() {
            ...
            if (DialogsActivity.this.searchViewPager.dialogsSearchAdapter.isSearchWas() && DialogsActivity.this.searchViewPager.dialogsSearchAdapter.isRecentSearchDisplayed()) {
                builder.setTitle(LocaleController.getString("ClearSearchAlertPartialTitle", C3473R.string.ClearSearchAlertPartialTitle));
                ...
                builder.setPositiveButton(LocaleController.getString("Clear", C3473R.string.Clear), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        DialogsActivity.C577830.this.lambda$needClearList$4(dialogInterface, i);
                    }
                });
            } else {
                ...
                builder.setPositiveButton(LocaleController.getString("ClearButton", C3473R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        DialogsActivity.C577830.this.lambda$needClearList$5(dialogInterface, i);
                    }
                });
            }
            builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$42(boolean z, ArrayList arrayList, ArrayList arrayList2, boolean z2) {
        updateFiltersView(z, arrayList, arrayList2, z2, true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$43(View view, int i) {
    ...
    public /* synthetic */ boolean lambda$createView$46(View view) {
        ...
        if (filterByIdWithExtra == null || filterByIdWithExtra.isFabEditable()) {
            showDialog(new SelectFabsBottomSheet(getParentActivity(), new HashSet(getFabsForPage(this.viewPages[0])), new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda71
                @Override // com.iMe.fork.utils.Callbacks$Callback1
                public final void invoke(Object obj) {
                    DialogsActivity.this.lambda$createView$45(viewPage, filterByIdWithExtra, (Set) obj);
                }
            }));
            return true;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$45(ViewPage viewPage, SortingFilter sortingFilter, Set set) {
        if (getParentActivity() == null) {
            return;
        }
        if (viewPage.selectedType == this.filterTabsView.getDefaultTabId()) {
            ...
            FilterSettingsModel settings = getFiltersController().getSettings(getMessagesController().dialogFilters.get(viewPage.selectedType).f1459id);
    ...
    public /* synthetic */ void lambda$createView$51(View view) {
        ...
        if (this.initialDialogsType == 10) {
            ...
            for (int i = 0; i < this.selectedDialogs.size(); i++) {
                arrayList.add(MessagesStorage.TopicKey.m64of(this.selectedDialogs.get(i).longValue(), 0));
            }
            ...
            if (filterFab != filterFab2 && filterFab != FilterFab.CREATE_STORY) {
                if (filterFab == FilterFab.ARCHIVE) {
                    ...
                    if (getTopicsController().hasSelectedTopic(isArchive())) {
                        showReadAllDialog(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda99
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.this.lambda$createView$47();
                            }
                        });
                        return;
                    }
                    ...
                    if (filterTabsView == null || filterTabsView.getVisibility() != 0 || this.filterTabsView.currentTabIsDefault()) {
                        ...
                        showReadAllDialog(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda106
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.this.lambda$createView$48();
                            }
                        });
                    }
                } else if (filterFab == FilterFab.WALLET) {
                    WalletHelper.safeRunWithActivationCheck(this, new Callbacks$Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda73
                        @Override // com.iMe.fork.utils.Callbacks$Callback
                        public final void invoke() {
                    ...
                    if (SharedConfig.isAlbumsIntroShown) {
                        presentFragment(ChannelCreateActivity.newInstanceInAlbumMode(new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda68
                            @Override // com.iMe.fork.utils.Callbacks$Callback1
                            public final void invoke(Object obj) {
                                DialogsActivity.this.lambda$createView$50((Long) obj);
                            }
                        }));
                    } else {
                ...
                if (!getMessagesController().storiesEnabled()) {
                    UndoView undoView = getUndoView();
                    if (undoView != null) {
                        undoView.showError(LocaleController.getString("DialogNotAvailable", C3473R.string.DialogNotAvailable));
                        return;
                    }
                    return;
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$48() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$50(Long l) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$53(FilterFab filterFab) {
        expandMultiFab(false);
    ...
    public /* synthetic */ boolean lambda$createView$56(View view) {
        ...
        this.filterOptions = ItemOptions.makeOptions(this, this.dialogsHintCell).setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundWhite))).add(C3473R.C3475drawable.fork_wallet_crypto_cipher_eye, LocaleController.getString("Hide", C3473R.string.Hide), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda83
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createView$55();
            }
        }).show();
        return true;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$55() {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda82
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createView$54();
            }
        }, 150L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$54() {
        SharedConfig.setDialogsPremiumHintEnabled(false);
        updateDialogsHint();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$57(Long l) {
        this.cacheSize = l;
        updateDialogsHint();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$58(Long l, Long l2) {
        this.deviceSize = l;
        updateDialogsHint();
    }
    ...
    /* loaded from: classes3.dex */
    public class C578537 implements RecentChatsBar.Delegate {
        C578537() {
        }
        ...
        public void onRecentChatLongClick(HistoryDialogModel historyDialogModel, View view) {
            ...
            if (dialogId == DialogsActivity.this.getUserConfig().getClientUserId() && sectionsPasscodeData != null && !sectionsPasscodeData.getPasscodeHash().isEmpty()) {
                DialogsActivity.this.showToast(LocaleController.getInternalString(C3473R.string.section_is_locked));
                return;
            }
            ActionBarPopupWindow.ActionBarPopupWindowLayout[] actionBarPopupWindowLayoutArr = {new ActionBarPopupWindow.ActionBarPopupWindowLayout(DialogsActivity.this.getParentActivity(), C3473R.C3475drawable.popup_fixed_alert, DialogsActivity.this.getResourceProvider(), 2)};
            ...
            if (historyDialogModel.isPinned()) {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("UnpinMessage", C3473R.string.UnpinMessage), C3473R.C3475drawable.msg_unpin);
            } else {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("PinMessage", C3473R.string.PinMessage), C3473R.C3475drawable.msg_pin);
            }
            ...
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda6
                ...
                public final void onClick(View view2) {
                    DialogsActivity.C578537.this.lambda$onRecentChatLongClick$0(dialogId, view2);
                }
            });
            ...
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("DeleteFromRecent", C3473R.string.DeleteFromRecent), C3473R.C3475drawable.msg_delete);
            ...
            actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.C578537.this.lambda$onRecentChatLongClick$2(dialogId, view2);
                }
            });
            ...
            actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("ClearRecentHistory", C3473R.string.ClearRecentHistory), C3473R.C3475drawable.msg_clear);
            ...
            actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.C578537.this.lambda$onRecentChatLongClick$3(view2);
                }
            });
            ...
            actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("Settings", C3473R.string.Settings), C3473R.C3475drawable.msg_settings);
            ...
            actionBarMenuSubItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.C578537.this.lambda$onRecentChatLongClick$5(view2);
                }
            });
            ...
            actionBarMenuSubItem5.setTextAndIcon(LocaleController.getString("Disable", C3473R.string.Disable), C3473R.C3475drawable.msg_disable);
            ...
            actionBarMenuSubItem5.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.C578537.this.lambda$onRecentChatLongClick$8(view2);
                }
            });
        ...
        public /* synthetic */ void lambda$onRecentChatLongClick$2(long j, View view) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578537.this.lambda$onRecentChatLongClick$1();
                }
            }, 150L);
        }
        ...
        public /* synthetic */ void lambda$onRecentChatLongClick$5(View view) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda10
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578537.this.lambda$onRecentChatLongClick$4();
                }
            }, 300L);
        }
        ...
        public /* synthetic */ void lambda$onRecentChatLongClick$8(View view) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578537.this.lambda$onRecentChatLongClick$7();
                }
            }, 150L);
        }
        ...
        public /* synthetic */ void lambda$onRecentChatLongClick$7() {
            ...
            UndoView undoView = DialogsActivity.this.getUndoView();
            if (undoView != null) {
                undoView.showInfo(LocaleController.getInternalString(C3473R.string.undo_recent_chats_disabled), new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C578537.this.lambda$onRecentChatLongClick$6();
                    }
                });
            }
        }
        ...
        private void showDeleteAlert() {
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            int i = C3473R.string.ClearHistory;
            builder.setTitle(LocaleController.getString("ClearHistory", i));
            builder.setMessage(LocaleController.getInternalString(C3473R.string.recent_chats_clear_history));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    DialogsActivity.C578537.this.lambda$showDeleteAlert$9(dialogInterface, i2);
                }
            });
            builder.setPositiveButton(LocaleController.getString("ClearHistory", i), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    DialogsActivity.C578537.this.lambda$showDeleteAlert$11(dialogInterface, i2);
                }
            });
            AlertDialog create = builder.create();
            DialogsActivity.this.showDialog(create);
        ...
        public /* synthetic */ void lambda$showDeleteAlert$11(DialogInterface dialogInterface, int i) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578537.this.lambda$showDeleteAlert$10();
                }
            }, 150L);
        }
    ...
    /* loaded from: classes3.dex */
    public class C578638 implements TopicsBar.Delegate {
        C578638() {
        }
        ...
        public boolean onTopicLongClick(TopicView topicView) {
            ...
            DialogsActivity dialogsActivity = DialogsActivity.this;
            ItemOptions scrimViewBackground = ItemOptions.makeOptions(dialogsActivity, topicView).setScrimViewBackground(Theme.createRoundRectDrawable(AndroidUtilities.m72dp(4), Theme.getColor(Theme.key_windowBackgroundWhite)));
            if (DialogsActivity.this.topicsBar.allowReorder() && !z2) {
                z = true;
            }
            int i = C3473R.C3475drawable.tabs_reorder;
            ItemOptions addIf = scrimViewBackground.addIf(z, i, LocaleController.getString("FilterReorder", C3473R.string.FilterReorder), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578638.this.lambda$onTopicLongClick$0();
                }
            }).add(C3473R.C3475drawable.msg_settings, LocaleController.getString("Settings", C3473R.string.Settings), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578638.this.lambda$onTopicLongClick$1();
                }
            }).addIf(!z2, C3473R.C3475drawable.msg_edit, LocaleController.getInternalString(C3473R.string.topic_edit), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578638.this.lambda$onTopicLongClick$2(topic);
                }
            }).addIf(!z2, C3473R.C3475drawable.msg_delete, LocaleController.getString("Delete", C3473R.string.Delete), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578638.this.lambda$onTopicLongClick$3(topic);
                }
            });
            if (!DialogsActivity.this.getTopicsController().isNoTopicFirstEnabled()) {
                i = C3473R.C3475drawable.fork_move_to_beginning;
            }
            dialogsActivity.filterOptions = addIf.addIf(z2, i, LocaleController.getInternalString(DialogsActivity.this.getTopicsController().isNoTopicFirstEnabled() ? C3473R.string.topics_move_no_topic_to_end : C3473R.string.topics_move_no_topic_to_beginning), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578638.this.lambda$onTopicLongClick$5();
                }
            }).setGravity(3).translate(AndroidUtilities.m72dp(-8), AndroidUtilities.m72dp(DialogsActivity.this.getTopicsController().isTopicsBarAtBottomEnabled() ? 10 : -10)).show();
            return true;
        }
        ...
        public /* synthetic */ void lambda$onTopicLongClick$5() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C578638.this.lambda$onTopicLongClick$4();
                }
            }, 300L);
        }
            ...
            if (j != -1) {
                ...
                if (DialogsActivity.this.selectedFilterIdToRestore == -1) {
                    ...
                    if (SortingFilter.isSortingFilter(DialogsActivity.this.isArchive(), currentTabId)) {
                        ...
                        DialogsActivity dialogsActivity = DialogsActivity.this;
                        dialogsActivity.selectedFilterIdToRestore = dialogsActivity.getMessagesController().dialogFilters.get(currentTabId).f1459id;
                    }
                }
            } else {
                DialogsActivity.this.hideFloatingButton(false);
        ...
        public void lambda$onTopicLongClick$3(final TopicModel topicModel) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            builder.setTitle(LocaleController.getInternalString(C3473R.string.topics_remove));
            builder.setMessage(LocaleController.getInternalString(C3473R.string.topics_remove_alert));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString("Delete", C3473R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.C578638.this.lambda$showDeleteAlert$6(topicModel, dialogInterface, i);
                }
            });
            AlertDialog create = builder.create();
            DialogsActivity.this.showDialog(create);
    ...
    public /* synthetic */ void lambda$createView$59(View view) {
        ...
        if (this.isCrossForward) {
            ...
            if (fieldText != null) {
                SendMessagesHelper.getInstance(UserConfig.selectedAccount).sendMessage(SendMessagesHelper.SendMessageParams.m60of(fieldText.toString(), getUserConfig().getClientUserId(), null, null, null, true, null, null, null, false, 0, null, false, null));
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createView$60(FrameLayout frameLayout, View view) {
    ...
    /* loaded from: classes3.dex */
    public class C579545 extends DialogStoriesCell {
        C579545(Context context, BaseFragment baseFragment, int i, int i2) {
        ...
        public void onUserLongPressed(View view, final long j) {
            DialogsActivity dialogsActivity = DialogsActivity.this;
            dialogsActivity.filterOptions = ItemOptions.makeOptions(dialogsActivity, view).setViewAdditionalOffsets(0, AndroidUtilities.m72dp(8), 0, 0).setScrimViewBackground(Theme.createRoundRectDrawable(AndroidUtilities.m72dp(6), DialogsActivity.this.canShowFilterTabsView ? AndroidUtilities.m72dp(6) : 0, Theme.getColor(DialogsActivity.this.isArchive() ? Theme.key_actionBarDefaultArchived : Theme.key_actionBarDefault)));
            ...
            if (j == UserConfig.getInstance(((BaseFragment) DialogsActivity.this).currentAccount).getClientUserId()) {
                ...
                if (dialogsActivity2.storiesEnabled) {
                    ...
                    int i = C3473R.C3475drawable.msg_stories_add;
                    String string = LocaleController.getString("AddStory", C3473R.string.AddStory);
                    int i2 = Theme.key_actionBarDefaultSubmenuItemIcon;
                    int i3 = Theme.key_actionBarDefaultSubmenuItem;
                    itemOptions.add(i, string, i2, i3, new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C579545.this.lambda$onUserLongPressed$0();
                        }
                    });
                    DialogsActivity.this.filterOptions.add(C3473R.C3475drawable.msg_stories_archive, LocaleController.getString("ArchivedStories", C3473R.string.ArchivedStories), i2, i3, new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C579545.this.lambda$onUserLongPressed$1();
                        }
                    });
                    DialogsActivity.this.filterOptions.add(C3473R.C3475drawable.msg_stories_saved, LocaleController.getString("SavedStories", C3473R.string.SavedStories), i2, i3, new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C579545.this.lambda$onUserLongPressed$2();
                        }
                    });
                    DialogsActivity.this.filterOptions.addGap().add(C3473R.C3475drawable.msg_settings, LocaleController.getString("Settings", C3473R.string.Settings), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C579545.this.lambda$onUserLongPressed$3();
                        }
                    });
                } else {
                ...
                DialogsActivity.this.filterOptions.add(C3473R.C3475drawable.msg_discussion, LocaleController.getString("SendMessage", C3473R.string.SendMessage), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C579545.this.lambda$onUserLongPressed$4(j);
                    }
                }).add(C3473R.C3475drawable.msg_openprofile, LocaleController.getString("OpenProfile", C3473R.string.OpenProfile), Theme.key_actionBarDefaultSubmenuItemIcon, Theme.key_actionBarDefaultSubmenuItem, new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C579545.this.lambda$onUserLongPressed$5(j);
                    }
                }).addIf(!z, C3473R.C3475drawable.msg_mute, LocaleController.getString("NotificationsStoryMute2", C3473R.string.NotificationsStoryMute2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C579545.this.lambda$onUserLongPressed$6(sharedPrefKey, j);
                    }
                }).makeMultiline(false).addIf(z, C3473R.C3475drawable.msg_unmute, LocaleController.getString("NotificationsStoryUnmute2", C3473R.string.NotificationsStoryUnmute2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda10
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C579545.this.lambda$onUserLongPressed$7(sharedPrefKey, j);
                    }
                }).makeMultiline(false).addIf(!DialogsActivity.this.isArchive(), C3473R.C3475drawable.msg_archive, LocaleController.getString("ArchivePeerStories", C3473R.string.ArchivePeerStories), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C579545.this.lambda$onUserLongPressed$8(j);
                    }
                }).makeMultiline(false).addIf(DialogsActivity.this.isArchive(), C3473R.C3475drawable.msg_unarchive, LocaleController.getString("UnarchiveStories", C3473R.string.UnarchiveStories), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C579545.this.lambda$onUserLongPressed$9(j);
                    }
                }).makeMultiline(false).addGap().add(C3473R.C3475drawable.msg_settings, LocaleController.getString("Settings", C3473R.string.Settings), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C579545.this.lambda$onUserLongPressed$10();
                    }
                });
            }
            DialogsActivity.this.filterOptions.setGravity(3).translate(AndroidUtilities.m72dp(-8), AndroidUtilities.m72dp(-10)).show();
        }
        ...
        public /* synthetic */ void lambda$onUserLongPressed$4(long j) {
            DialogsActivity.this.presentFragment(ChatActivity.m35of(j));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onUserLongPressed$5(long j) {
            DialogsActivity.this.presentFragment(ProfileActivity.m26of(j));
        }
        ...
        public /* synthetic */ void lambda$onUserLongPressed$6(String str, long j) {
            ...
            BulletinFactory.m32of(DialogsActivity.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", C3473R.string.NotificationsStoryMutedHint, trim))).show();
        }
        ...
        public /* synthetic */ void lambda$onUserLongPressed$7(String str, long j) {
            ...
            BulletinFactory.m32of(DialogsActivity.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", C3473R.string.NotificationsStoryUnmutedHint, trim))).show();
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onUserLongPressed$10() {
            DialogsActivity.this.openStoriesSettings();
        }
    ...
    public void setStoriesOvercroll(ViewPage viewPage, float f) {
        ...
        if (f <= AndroidUtilities.m72dp(90) || this.storiesOverscrollCalled) {
            return;
        }
        this.storiesOverscrollCalled = true;
        getOrCreateStoryViewer().doOnAnimationReady(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda96
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$setStoriesOvercroll$64();
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setStoriesOvercroll$64() {
    ...
    public void toggleArciveForStory(final long j) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda113
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$toggleArciveForStory$67(j, z);
            }
        }, 200L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$toggleArciveForStory$67(final long j, final boolean z) {
        getMessagesController().getStoriesController().toggleHidden(j, z, false, true);
        TLRPC$User user = getMessagesController().getUser(Long.valueOf(j));
        BulletinFactory.UndoObject undoObject = new BulletinFactory.UndoObject();
        undoObject.onUndo = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda114
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$toggleArciveForStory$65(j, z);
            }
        };
        undoObject.onAction = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda115
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$toggleArciveForStory$66(j, z);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$toggleArciveForStory$65(long j, boolean z) {
        getMessagesController().getStoriesController().toggleHidden(j, !z, false, true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$toggleArciveForStory$66(long j, boolean z) {
    ...
    public float getActionBarMoveFrom(boolean z) {
        ...
        float f = BitmapDescriptorFactory.HUE_RED;
        if (z2) {
            f = BitmapDescriptorFactory.HUE_RED + AndroidUtilities.m72dp(81);
        }
        if (z) {
            f += AndroidUtilities.m72dp(44);
        }
        ...
        return (dialogsHintCell == null || dialogsHintCell.getVisibility() != 0) ? topicsBarHeight : topicsBarHeight + this.dialogsHintCell.getMeasuredHeight();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public int getMaxScrollYOffset() {
        if (this.hasStories) {
            return AndroidUtilities.m72dp(81);
        }
        return C3541ActionBar.getCurrentActionBarHeight();
    }
    ...
    public void showSelectStatusDialog() {
        ...
        if (titleTextView == null || titleTextView.getRightDrawable() == null) {
            ...
            int m72dp = (-(this.actionBar.getHeight() - rect.centerY())) - AndroidUtilities.m72dp(16);
            i = rect.centerX() - AndroidUtilities.m72dp(16);
            DrawerProfileCell.AnimatedStatusView animatedStatusView = this.animatedStatusView;
            if (animatedStatusView != null) {
        ...
        selectAnimatedEmojiDialogWindowArr[0].showAsDropDown(this.actionBar, AndroidUtilities.m72dp(16), i3, 48);
    ...
    private void updateDialogsHint() {
        ...
        if (isPremiumRestoreHintVisible()) {
            ...
            this.dialogsHintCell.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda41
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$updateDialogsHint$70(view);
                }
            });
            this.dialogsHintCell.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3473R.string.RestorePremiumHintTitle, MediaDataController.getInstance(this.currentAccount).getPremiumHintAnnualDiscount(false)), Theme.key_windowBackgroundWhiteValueText, 0, null), LocaleController.getString(C3473R.string.RestorePremiumHintMessage));
            ...
            this.dialogsHintCell.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda37
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$updateDialogsHint$72(view);
                }
            });
            this.dialogsHintCell.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(this.isPremiumHintUpgrade ? C3473R.string.SaveOnAnnualPremiumTitle : C3473R.string.UpgradePremiumTitle, MediaDataController.getInstance(this.currentAccount).getPremiumHintAnnualDiscount(false)), Theme.key_windowBackgroundWhiteValueText, 0, null), LocaleController.getString(this.isPremiumHintUpgrade ? C3473R.string.UpgradePremiumMessage : C3473R.string.SaveOnAnnualPremiumMessage));
            ...
            this.dialogsHintCell.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda40
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$updateDialogsHint$74(view);
                }
            });
            this.dialogsHintCell.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3473R.string.ClearStorageHintTitle, AndroidUtilities.formatFileSize(this.cacheSize.longValue())), Theme.key_windowBackgroundWhiteValueText, 0, null), LocaleController.getString(C3473R.string.ClearStorageHintMessage));
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$70(View view) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda94
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$updateDialogsHint$69();
            }
        }, 250L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$69() {
        MessagesController.getInstance(this.currentAccount).removeSuggestion(0L, "PREMIUM_RESTORE");
        updateDialogsHint();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$72(View view) {
        if (this.dialogStoriesCell.getAlpha() == BitmapDescriptorFactory.HUE_RED) {
            return;
        }
        presentFragment(new PremiumPreviewFragment("dialogs_hint").setSelectAnnualByDefault());
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda104
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$updateDialogsHint$71();
            }
        }, 250L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$71() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$74(View view) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda100
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$updateDialogsHint$73();
            }
        }, 250L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$73() {
        ...
        if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeBroadcast) {
            ...
            channelCreateActivity.setOnFinishListener(new Utilities.Callback2() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda146
                ...
                public final void run(Object obj, Object obj2) {
                    DialogsActivity.this.lambda$createGroupForThis$84(channelCreateActivity, alertDialog, (BaseFragment) obj, (Long) obj2);
                }
            });
            ...
            groupCreateFinalActivity.setDelegate(new C580451(alertDialog));
            presentFragment(groupCreateFinalActivity);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$84(final ChannelCreateActivity channelCreateActivity, final AlertDialog alertDialog, final BaseFragment baseFragment, final Long l) {
        Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda152
            ...
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$76(l, channelCreateActivity, baseFragment, (Runnable) obj);
            }
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda153
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$78(alertDialog, l, (Runnable) obj);
            }
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda150
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$80(l, (Runnable) obj);
            }
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda151
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$82(l, (Runnable) obj);
            }
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda154
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$83(alertDialog, l, channelCreateActivity, baseFragment, (Runnable) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$76(Long l, final ChannelCreateActivity channelCreateActivity, final BaseFragment baseFragment, Runnable runnable) {
        showSendToBotAlert(getMessagesController().getChat(l), runnable, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda126
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createGroupForThis$75(channelCreateActivity, baseFragment);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$75(ChannelCreateActivity channelCreateActivity, BaseFragment baseFragment) {
        removeSelfFromStack();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$78(AlertDialog alertDialog, Long l, final Runnable runnable) {
        alertDialog.showDelayed(150L);
        Boolean bool = this.requestPeerType.bot_participant;
        if (bool != null && bool.booleanValue()) {
            getMessagesController().addUserToChat(l.longValue(), getMessagesController().getUser(Long.valueOf(this.requestPeerBotId)), 0, null, this, false, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda138
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$createGroupForThis$77;
                    lambda$createGroupForThis$77 = DialogsActivity.lambda$createGroupForThis$77(runnable, tLRPC$TL_error);
                    return lambda$createGroupForThis$77;
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$createGroupForThis$77(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$80(Long l, final Runnable runnable) {
        if (this.requestPeerType.bot_admin_rights != null) {
            ...
            messagesController.setUserAdminRole(longValue, user, tLRPC$TL_chatAdminRights, null, false, this, bool == null || !bool.booleanValue(), true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda139
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$createGroupForThis$79;
                    lambda$createGroupForThis$79 = DialogsActivity.lambda$createGroupForThis$79(runnable, tLRPC$TL_error);
                    return lambda$createGroupForThis$79;
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$createGroupForThis$79(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$82(Long l, final Runnable runnable) {
        if (this.requestPeerType.user_admin_rights != null) {
            getMessagesController().setUserAdminRole(l.longValue(), getAccountInstance().getUserConfig().getCurrentUser(), ChatRightsEditActivity.rightsOR(getMessagesController().getChat(l).admin_rights, this.requestPeerType.user_admin_rights), null, true, this, false, true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda141
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$createGroupForThis$81;
                    lambda$createGroupForThis$81 = DialogsActivity.lambda$createGroupForThis$81(runnable, tLRPC$TL_error);
                    return lambda$createGroupForThis$81;
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$createGroupForThis$81(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$83(AlertDialog alertDialog, Long l, ChannelCreateActivity channelCreateActivity, BaseFragment baseFragment, Runnable runnable) {
        alertDialog.dismiss();
        ...
        if (dialogsActivityDelegate != null) {
            ArrayList<MessagesStorage.TopicKey> arrayList = new ArrayList<>();
            arrayList.add(MessagesStorage.TopicKey.m64of(-l.longValue(), 0));
    ...
    /* loaded from: classes3.dex */
    public class C580451 implements GroupCreateFinalActivity.GroupCreateFinalActivityDelegate {
        ...
        C580451(AlertDialog alertDialog) {
        ...
        public void didFinishChatCreation(GroupCreateFinalActivity groupCreateFinalActivity, final long j) {
            ...
            Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$51$$ExternalSyntheticLambda8
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C580451.this.lambda$didFinishChatCreation$1(j, baseFragmentArr, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$51$$ExternalSyntheticLambda7
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C580451.this.lambda$didFinishChatCreation$3(j, baseFragmentArr, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$51$$ExternalSyntheticLambda9
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C580451.this.lambda$didFinishChatCreation$5(alertDialog, j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$51$$ExternalSyntheticLambda6
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C580451.this.lambda$didFinishChatCreation$7(j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$51$$ExternalSyntheticLambda5
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C580451.this.lambda$didFinishChatCreation$9(j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$51$$ExternalSyntheticLambda10
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C580451.this.lambda$didFinishChatCreation$10(alertDialog2, j, baseFragmentArr, (Runnable) obj);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$didFinishChatCreation$1(long j, BaseFragment[] baseFragmentArr, final Runnable runnable) {
            if (DialogsActivity.this.requestPeerType.has_username != null && DialogsActivity.this.requestPeerType.has_username.booleanValue()) {
                ...
                channelCreateActivity.setOnFinishListener(new Utilities.Callback2() { // from class: org.telegram.ui.DialogsActivity$51$$ExternalSyntheticLambda4
                    @Override // org.telegram.messenger.Utilities.Callback2
                    public final void run(Object obj, Object obj2) {
        ...
        public /* synthetic */ void lambda$didFinishChatCreation$3(long j, final BaseFragment[] baseFragmentArr, Runnable runnable) {
            DialogsActivity.this.showSendToBotAlert(DialogsActivity.this.getMessagesController().getChat(Long.valueOf(j)), runnable, new Runnable() { // from class: org.telegram.ui.DialogsActivity$51$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C580451.this.lambda$didFinishChatCreation$2(baseFragmentArr);
                }
            });
        }
    ...
    private void updateAppUpdateViews(boolean z) {
        ...
        if (z2) {
            ...
            if (z) {
                ...
                this.updateLayoutAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.52
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
            ...
            if (z) {
                ...
                this.updateLayoutAnimator.setInterpolator(CubicBezierInterpolator.EASE_OUT);
                this.updateLayoutAnimator.playTogether(ObjectAnimator.ofFloat(this.updateLayout, View.TRANSLATION_Y, AndroidUtilities.m72dp(48)));
            ...
            this.updateLayout.setTranslationY(AndroidUtilities.m72dp(48));
    ...
    public void updateContextViewPosition() {
        ...
        float m72dp = this.hasStories ? AndroidUtilities.m72dp(81) : 0.0f;
        if (this.hasStories) {
            float f3 = this.scrollYOffset;
            float f4 = this.searchAnimationProgress;
            f = (f3 * (1.0f - f4)) + (m72dp * (1.0f - f4)) + (measuredHeight * (1.0f - f4)) + (measuredHeight2 * f4) + this.tabsYOffset;
        } else {
        ...
        if (this.fragmentContextView != null) {
            ...
            float m72dp2 = (fragmentContextView == null || fragmentContextView.getVisibility() != 0) ? 0.0f : AndroidUtilities.m72dp(36) + BitmapDescriptorFactory.HUE_RED;
            FragmentContextView fragmentContextView2 = this.fragmentContextView;
            fragmentContextView2.setTranslationY(m72dp2 + fragmentContextView2.getTopPadding() + f7);
        }
        if (this.fragmentLocationContextView != null) {
            ...
            if (fragmentContextView3 != null && fragmentContextView3.getVisibility() == 0) {
                f2 = BitmapDescriptorFactory.HUE_RED + AndroidUtilities.m72dp(this.fragmentContextView.getStyleHeight()) + this.fragmentContextView.getTopPadding();
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void updateFiltersView(boolean r11, java.util.ArrayList<java.lang.Object> r12, java.util.ArrayList<org.telegram.p043ui.Adapters.FiltersView.DateData> r13, boolean r14, boolean r15) {
        /*
            r10 = this;
        ...
        L16:
            ...
            org.telegram.ui.Adapters.FiltersView$MediaFilterData r7 = (org.telegram.p043ui.Adapters.FiltersView.MediaFilterData) r7
        ...
        Lbf:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.updateFiltersView(boolean, java.util.ArrayList, java.util.ArrayList, boolean, boolean):void");
    }
    ...
    public void updateSpeedItem(boolean z) {
        ...
        if (z3 != (this.speedItem.getTag() != null)) {
            ...
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.54
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    private void createActionMode(String str) {
        ...
        this.selectedDialogsCountTextView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda60
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                lambda$createActionMode$85 = DialogsActivity.lambda$createActionMode$85(view, motionEvent);
                return lambda$createActionMode$85;
            }
        });
        int i = C3473R.C3475drawable.msg_pin;
        this.pinItem = createActionMode.addItemWithWidth(100, i, AndroidUtilities.m72dp(54));
        this.muteItem = createActionMode.addItemWithWidth(104, C3473R.C3475drawable.msg_mute, AndroidUtilities.m72dp(54));
        int i2 = C3473R.C3475drawable.msg_archive;
        this.archive2Item = createActionMode.addItemWithWidth(107, i2, AndroidUtilities.m72dp(54));
        this.deleteItem = createActionMode.addItemWithWidth(102, C3473R.C3475drawable.msg_delete, AndroidUtilities.m72dp(54), LocaleController.getString("Delete", C3473R.string.Delete));
        ActionBarMenuItem addItemWithWidth = createActionMode.addItemWithWidth(0, C3473R.C3475drawable.ic_ab_other, AndroidUtilities.m72dp(54), LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
        this.archiveItem = addItemWithWidth.addSubItem(105, i2, LocaleController.getString("Archive", C3473R.string.Archive));
        this.pin2Item = addItemWithWidth.addSubItem(108, i, LocaleController.getString("DialogPin", C3473R.string.DialogPin));
        this.addToFolderItem = addItemWithWidth.addSubItem(109, C3473R.C3475drawable.msg_addfolder, LocaleController.getString("FilterAddTo", C3473R.string.FilterAddTo));
        this.removeFromFolderItem = addItemWithWidth.addSubItem(110, C3473R.C3475drawable.msg_removefolder, LocaleController.getString("FilterRemoveFrom", C3473R.string.FilterRemoveFrom));
        this.moveToFolderItem = addItemWithWidth.addSubItem(IdFabric$Menu.DIALOGS_MOVE_TO_FOLDER, C3473R.C3475drawable.fork_ic_replace_24, LocaleController.getInternalString(C3473R.string.dialogs_activity_move_to_folder));
        this.readItem = addItemWithWidth.addSubItem(101, C3473R.C3475drawable.msg_markread, LocaleController.getString("MarkAsRead", C3473R.string.MarkAsRead));
        this.clearItem = addItemWithWidth.addSubItem(103, C3473R.C3475drawable.msg_clear, LocaleController.getString("ClearHistory", C3473R.string.ClearHistory));
        this.blockItem = addItemWithWidth.addSubItem(106, C3473R.C3475drawable.msg_block, LocaleController.getString("BlockUser", C3473R.string.BlockUser));
        this.actionModeMenuGap = addItemWithWidth.addColoredGap();
        this.hiddenChatsItem = addItemWithWidth.addSubItem(IdFabric$Menu.TOGGLE_HIDDEN_CHATS, C3473R.C3475drawable.fork_filter_icon_mask, LocaleController.getInternalString(isHiddenChats() ? C3473R.string.hidden_chats_unhide_chats : C3473R.string.hidden_chats_hide_chats));
        this.selectTopicItem = addItemWithWidth.addSubItem(IdFabric$Menu.DIALOGS_SELECT_TOPIC, C3473R.C3475drawable.fork_topic_select_26, LocaleController.getInternalString(C3473R.string.topics_select));
        if (isHiddenChats()) {
        ...
        this.muteItem.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda54
            @Override // android.view.View.OnLongClickListener
            public final boolean onLongClick(View view) {
                boolean lambda$createActionMode$86;
                lambda$createActionMode$86 = DialogsActivity.this.lambda$createActionMode$86(view);
                return lambda$createActionMode$86;
            }
        });
        ...
        if (str == null) {
            this.actionBar.setActionBarMenuOnItemClick(new C580855());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createActionMode$86(View view) {
    ...
    /* loaded from: classes3.dex */
    public class C580855 extends C3541ActionBar.ActionBarMenuOnItemClick {
        C580855() {
        }
            ...
            if (i == IdFabric$Menu.MESSAGE_SAVE_CLOUD) {
                ...
                if (i == i2 || i == IdFabric$Menu.DIALOGS_SCAN_LOGIN_QR_CODE) {
                    ...
                    if (i == IdFabric$Menu.DIALOGS_CHAT_SETTINGS) {
                        ...
                        DialogsActivity dialogsActivity2 = DialogsActivity.this;
                        DialogsActivity dialogsActivity3 = DialogsActivity.this;
                        dialogsActivity2.showDialog(new TopicsAlert(dialogsActivity3, dialogsActivity3.selectedDialogs, new Callbacks$Callback2() { // from class: org.telegram.ui.DialogsActivity$55$$ExternalSyntheticLambda0
                            @Override // com.iMe.fork.utils.Callbacks$Callback2
                            public final void invoke(Object obj, Object obj2) {
                                DialogsActivity.C580855.this.lambda$onItemClick$0((Boolean) obj, (TopicModel) obj2);
                            }
                        }));
                        ...
                        ((LaunchActivity) DialogsActivity.this.getParentActivity()).showPasscodeActivity(false, true, iArr[0] + (DialogsActivity.this.passcodeItem.getMeasuredWidth() / 2), iArr[1] + (DialogsActivity.this.passcodeItem.getMeasuredHeight() / 2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$55$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.C580855.this.lambda$onItemClick$1();
                            }
                        }, new Runnable() { // from class: org.telegram.ui.DialogsActivity$55$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.C580855.this.lambda$onItemClick$2();
                            }
                        });
                            ...
                            if (!DialogsActivity.this.isMainNoFolderDialogList()) {
                                if (DialogsActivity.this.isForward()) {
                                    if (i3 == UserConfig.selectedAccount) {
                                        ...
                                        ((BaseFragment) DialogsActivity.this).arguments.putString("selectAlertString", LocaleController.getString("SendMessagesToText", C3473R.string.SendMessagesToText));
                                        ((BaseFragment) DialogsActivity.this).arguments.putString("selectAlertStringGroup", LocaleController.getString("SendMessagesToGroupText", C3473R.string.SendMessagesToGroupText));
                                    }
                                    DialogsActivity dialogsActivity4 = new DialogsActivity(((BaseFragment) DialogsActivity.this).arguments);
                                    dialogsActivity4.setCurrentAccount(i3);
                                    dialogsActivity4.setDelegate(dialogsActivityDelegate);
                                    launchActivity.presentFragment(dialogsActivity4, true, true);
                                    return;
                                }
                        ...
                        DialogsActivity dialogsActivity6 = DialogsActivity.this;
                        FiltersListBottomSheet filtersListBottomSheet = new FiltersListBottomSheet(dialogsActivity6, dialogsActivity6.selectedDialogs);
                        filtersListBottomSheet.setDelegate(new FiltersListBottomSheet.FiltersListBottomSheetDelegate() { // from class: org.telegram.ui.DialogsActivity$55$$ExternalSyntheticLambda3
                            @Override // org.telegram.p043ui.Components.FiltersListBottomSheet.FiltersListBottomSheetDelegate
                            public final void didSelectFilter(MessagesController.DialogFilter dialogFilter) {
                                DialogsActivity.C580855.this.lambda$onItemClick$3(dialogFilter);
                            }
                        });
                        DialogsActivity.this.showDialog(filtersListBottomSheet);
                    } else if (i == 110) {
                        DialogsActivity dialogsActivity7 = DialogsActivity.this;
                        MessagesController.DialogFilter filterById = dialogsActivity7.getFilterById(dialogsActivity7.viewPages[0].selectedType);
                        if (filterById == null) {
                            return;
                        }
                        DialogsActivity dialogsActivity8 = DialogsActivity.this;
                        ArrayList<Long> dialogsCount = FiltersListBottomSheet.getDialogsCount(dialogsActivity8, filterById, dialogsActivity8.selectedDialogs, false, false);
                        if (filterById.neverShow.size() + dialogsCount.size() > 100) {
                            DialogsActivity dialogsActivity9 = DialogsActivity.this;
                            dialogsActivity9.showDialog(AlertsCreator.createSimpleAlert(dialogsActivity9.getParentActivity(), LocaleController.getString("FilterAddToAlertFullTitle", C3473R.string.FilterAddToAlertFullTitle), LocaleController.getString("FilterAddToAlertFullText", C3473R.string.FilterAddToAlertFullText)).create());
                            return;
                        }
                        if (!dialogsCount.isEmpty()) {
    ...
    public void scrollToFolder(int i) {
        ...
        while (true) {
            if (i2 >= dialogFilters.size()) {
                break;
            } else if (dialogFilters.get(i2).f1459id == i) {
                tabsCount = i2;
                break;
            } else {
                i2++;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:120:0x0281, code lost:
        if (((getFiltersController().isFoldersHidden() ? 0 : r2.size() - r6) + r3.size()) == r6) goto L172;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void updateFilterTabs(boolean r25, boolean r26) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.updateFilterTabs(boolean, boolean):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateFilterTabs$87(int i) {
    ...
    public void onResume() {
        ...
        if ((this.afterSignup || getUserConfig().unacceptedTermsOfService == null) && this.checkPermission && !this.onlySelect && (i = Build.VERSION.SDK_INT) >= 23) {
            ...
            if (parentActivity != null) {
                ...
                final boolean z4 = z3;
                final boolean z5 = z;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda130
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.this.lambda$onResume$90(z4, z5, z2, parentActivity);
                    }
            ...
            showDialog(new AlertDialog.Builder(getParentActivity()).setTopAnimation(C3473R.raw.permission_request_apk, 72, false, Theme.getColor(Theme.key_dialogTopBackground)).setMessage(LocaleController.getString("PermissionXiaomiLockscreen", C3473R.string.PermissionXiaomiLockscreen)).setPositiveButton(LocaleController.getString("PermissionOpenSettings", C3473R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda15
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    DialogsActivity.this.lambda$onResume$91(dialogInterface, i3);
                }
            }).setNegativeButton(LocaleController.getString("ContactsPermissionAlertNotNow", C3473R.string.ContactsPermissionAlertNotNow), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda24
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    DialogsActivity.lambda$onResume$92(dialogInterface, i3);
                }
            }).create());
        }
        ...
        Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.DialogsActivity.56
            ...
            public int getTopOffset(int i4) {
                int i5 = 0;
                int topicsBarHeight = DialogsActivity.this.getTopicsBarHeight(true) + DialogsActivity.this.getRecentChatsBarHeight() + (((BaseFragment) DialogsActivity.this).actionBar != null ? ((BaseFragment) DialogsActivity.this).actionBar.getMeasuredHeight() : 0) + ((DialogsActivity.this.filterTabsView == null || DialogsActivity.this.filterTabsView.getVisibility() != 0 || DialogsActivity.this.isFilterTabsAtBottom()) ? 0 : DialogsActivity.this.filterTabsView.getMeasuredHeight()) + ((DialogsActivity.this.fragmentContextView == null || !DialogsActivity.this.fragmentContextView.isCallTypeVisible()) ? 0 : AndroidUtilities.m72dp(DialogsActivity.this.fragmentContextView.getStyleHeight())) + ((DialogsActivity.this.dialogsHintCell == null || DialogsActivity.this.dialogsHintCell.getVisibility() != 0) ? 0 : DialogsActivity.this.dialogsHintCell.getHeight());
                DialogsActivity dialogsActivity = DialogsActivity.this;
                ...
                if (dialogStoriesCell2 != null && dialogsActivity.dialogStoriesCellVisible) {
                    i5 = (int) ((1.0f - dialogStoriesCell2.getCollapsedProgress()) * AndroidUtilities.m72dp(81));
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onResume$90(boolean z, boolean z2, boolean z3, final Activity activity) {
        if (getParentActivity() == null) {
            return;
        }
        ...
        if (z || z2 || z3) {
            ...
            if (z && NotificationPermissionDialog.shouldAsk(activity)) {
                Dialog notificationPermissionDialog = new NotificationPermissionDialog(activity, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda147
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        DialogsActivity.lambda$onResume$88(activity, (Boolean) obj);
                    }
                });
                ...
                AlertDialog create = AlertsCreator.createContactsPermissionDialog(activity, new MessagesStorage.IntCallback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda144
                    @Override // org.telegram.messenger.MessagesStorage.IntCallback
                    public final void run(int i) {
                        DialogsActivity.this.lambda$onResume$89(i);
                    }
                }).create();
                ...
                if (activity instanceof BasePermissionsActivity) {
                    AlertDialog createPermissionErrorAlert = ((BasePermissionsActivity) activity).createPermissionErrorAlert(C3473R.raw.permission_request_folder, LocaleController.getString(C3473R.string.PermissionStorageWithHint));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$onResume$88(Activity activity, Boolean bool) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onResume$89(int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onResume$91(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$onResume$92(DialogInterface dialogInterface, int i) {
    ...
    public void showArchiveHelp() {
        getContactsController().loadGlobalPrivacySetting();
        final BottomSheet[] bottomSheetArr = {new BottomSheet.Builder(getContext(), false, getResourceProvider()).setCustomView(new ArchiveHelp(getContext(), this.currentAccount, getResourceProvider(), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda133
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$showArchiveHelp$94(bottomSheetArr);
            }
        }, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda135
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.lambda$showArchiveHelp$95(bottomSheetArr);
            }
        }), 49).show()};
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showArchiveHelp$94(BottomSheet[] bottomSheetArr) {
        if (bottomSheetArr[0] != null) {
            bottomSheetArr[0].dismiss();
            bottomSheetArr[0] = null;
        }
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda107
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$showArchiveHelp$93();
            }
        }, 300L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showArchiveHelp$93() {
        presentFragment(new ArchiveSettingsActivity());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showArchiveHelp$95(BottomSheet[] bottomSheetArr) {
        if (bottomSheetArr[0] != null) {
            bottomSheetArr[0].dismiss();
            bottomSheetArr[0] = null;
        }
    ...
    public boolean addOrRemoveSelectedDialog(long j, View view) {
        ...
        if (isForward()) {
            if (this.forwardSpansByDialogIds.indexOfKey(j) >= 0) {
                ...
                groupCreateSpan.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda33
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        DialogsActivity.this.lambda$addOrRemoveSelectedDialog$96(view2);
                    }
                });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addOrRemoveSelectedDialog$96(View view) {
    ...
    public void showSearch(final boolean z, boolean z2, boolean z3) {
        ...
        if (z) {
            ...
            if (this.folderId != 0 && ((rightSlidingDialogContainer = this.rightSlidingDialogContainer) == null || !rightSlidingDialogContainer.hasFragment())) {
                addSearchFilter(new FiltersView.MediaFilterData(C3473R.C3475drawable.chats_archive, C3473R.string.ArchiveSearchFilter, (TLRPC$MessagesFilter) null, 7));
            }
        } else {
            updateDrawerSwipeEnabled();
        }
        ...
        if (z4) {
            ...
            if (this.hasStories) {
                float m72dp = AndroidUtilities.m72dp(81) + this.scrollYOffset;
            ...
            if (topicsBar2 != null && topicsBar2.getVisibility() == 0) {
                ...
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.57
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            ...
            if (recentChatsBar2 != null && recentChatsBar2.getVisibility() == 0) {
                ...
                duration2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.58
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator4) {
            ...
            if (filterTabsView2 != null && filterTabsView2.getVisibility() == 0) {
                if (isForward()) {
                    ...
                    fArr12[0] = z ? -AndroidUtilities.m72dp(44) : 0.0f;
                    ...
                    fArr13[0] = z ? -AndroidUtilities.m72dp(44) : 0.0f;
                    ...
                    fArr16[0] = z ? AndroidUtilities.m72dp(44) : 0.0f;
                ...
                duration3.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.59
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator4) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    DialogsActivity.this.lambda$showSearch$97(valueAnimator);
                }
            });
            arrayList.add(ofFloat);
            ...
            this.searchAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.60
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            ...
            if (filterTabsView5 != null && filterTabsView5.getVisibility() == 0) {
                if (isFilterTabsAtBottom()) {
                    this.filterTabsView.setTranslationY(z ? AndroidUtilities.m72dp(44) : 0.0f);
                } else {
                    this.filterTabsView.setTranslationY(z ? -AndroidUtilities.m72dp(44) : 0.0f);
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSearch$97(ValueAnimator valueAnimator) {
    ...
    private void updateFilterTabsVisibility(boolean z) {
        ...
        if (this.filterTabsViewIsVisible != z3) {
            ...
            if (z) {
                ...
                this.filtersTabAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.61
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        ViewPage[] viewPageArr;
                ...
                this.filtersTabAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda9
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                        DialogsActivity.this.lambda$updateFilterTabsVisibility$98(z3, f, valueAnimator3);
                    }
                });
            ...
            if (z3) {
                ...
                int m72dp = AndroidUtilities.m72dp(44);
                if (translationY < (-m72dp)) {
                    translationY = m72dp;
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateFilterTabsVisibility$98(boolean z, float f, ValueAnimator valueAnimator) {
    ...
    public void setSearchAnimationProgress(float f, boolean z) {
        ...
        if (this.whiteActionBar) {
            ...
            C3541ActionBar c3541ActionBar = this.actionBar;
            int i = Theme.key_actionBarActionModeDefaultIcon;
            c3541ActionBar.setItemsColor(ColorUtils.blendARGB(color, Theme.getColor(i), this.searchAnimationProgress), false);
        ...
        if (viewPage.dialogsType == 7 || viewPage.dialogsType == 8 || (isForward() && !this.isForwardToArchive)) {
            ...
            if ((viewPage.selectedType >= 0 && viewPage.selectedType < dialogFilters.size()) || SortingFilter.isSortingFilter(false, viewPage.selectedType)) {
                ...
                if (dialogFilter != null && (dialogFilter.flags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED) == 0 && ((abs > 0 && i2 >= getDialogsArray(this.currentAccount, viewPage.dialogsType, 1, this.dialogsListFrozen).size() - 10) || !getMessagesController().isDialogsEndReached(1))) {
                    ...
                    if (!z3 || z) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda131
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.this.lambda$checkListLoad$99(z3, z4, z, z2);
                            }
                        });
                    }
                    return;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkListLoad$99(boolean z, boolean z2, boolean z3, boolean z4) {
        if (z) {
    ...
    */
    public void onItemClick(android.view.View r17, int r18, androidx.recyclerview.widget.RecyclerView.Adapter r19) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.onItemClick(android.view.View, int, androidx.recyclerview.widget.RecyclerView$Adapter):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemClick$100(Long l) {
        presentFragment(ProfileActivity.newInstanceForDialogId(l.longValue()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemClick$101(String str) {
    ...
    public boolean onItemLongClick(RecyclerListView recyclerListView, View view, int i, float f, float f2, final int i2, final RecyclerView.Adapter adapter) {
        ...
        if (getParentActivity() != null && !(view instanceof DialogsHintCell) && !this.inPreviewMode) {
            ...
            if (rightSlidingDialogContainer == null || !rightSlidingDialogContainer.hasFragment()) {
                ...
                if (adapter == dialogsSearchAdapter) {
                    ...
                    if (isForward()) {
                        if (item instanceof TLRPC$Chat) {
                            ...
                            makeEncryptedDialogId2 = -tLRPC$Chat.f1522id;
                        } else if (item instanceof TLRPC$User) {
                            makeEncryptedDialogId2 = ((TLRPC$User) item).f1685id;
                        } else {
                            if (item instanceof TLRPC$EncryptedChat) {
                                makeEncryptedDialogId2 = DialogObject.makeEncryptedDialogId(((TLRPC$EncryptedChat) item).f1534id);
                            }
                            return false;
                        }
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                        builder.setTitle(LocaleController.getString("ClearSearchSingleAlertTitle", C3473R.string.ClearSearchSingleAlertTitle));
                        if (item instanceof TLRPC$Chat) {
                            TLRPC$Chat tLRPC$Chat2 = (TLRPC$Chat) item;
                            builder.setMessage(LocaleController.formatString("ClearSearchSingleChatAlertText", C3473R.string.ClearSearchSingleChatAlertText, tLRPC$Chat2.title));
                            makeEncryptedDialogId = -tLRPC$Chat2.f1522id;
                        } else if (item instanceof TLRPC$User) {
                            TLRPC$User tLRPC$User = (TLRPC$User) item;
                            if (tLRPC$User.f1685id == getUserConfig().clientUserId) {
                                builder.setMessage(LocaleController.formatString("ClearSearchSingleChatAlertText", C3473R.string.ClearSearchSingleChatAlertText, LocaleController.getString("SavedMessages", C3473R.string.SavedMessages)));
                            } else {
                                builder.setMessage(LocaleController.formatString("ClearSearchSingleUserAlertText", C3473R.string.ClearSearchSingleUserAlertText, ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name)));
                            }
                            makeEncryptedDialogId = tLRPC$User.f1685id;
                            ...
                            builder.setMessage(LocaleController.formatString("ClearSearchSingleUserAlertText", C3473R.string.ClearSearchSingleUserAlertText, ContactsController.formatName(user.first_name, user.last_name)));
                            makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(tLRPC$EncryptedChat.f1534id);
                        }
                        builder.setPositiveButton(LocaleController.getString("ClearSearchRemove", C3473R.string.ClearSearchRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda19
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i3) {
                                DialogsActivity.this.lambda$onItemLongClick$102(makeEncryptedDialogId, dialogInterface, i3);
                            }
                        });
                        builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
                        AlertDialog create = builder.create();
                ...
                if (this.onlySelect) {
                    if (getMessagesController().isForum(tLRPC$Dialog.f1528id)) {
                        return false;
                    }
                    int i3 = this.initialDialogsType;
                    if ((i3 == 3 || i3 == 10) && validateSlowModeDialog(tLRPC$Dialog.f1528id)) {
                        addOrRemoveSelectedDialog(tLRPC$Dialog.f1528id, view);
                        updateSelectedCount();
                        return true;
                    }
                    return false;
                    ...
                    showOrUpdateActionMode(tLRPC$Dialog.f1528id, view);
                    if (this.viewPages != null && (adapter instanceof DialogsAdapter) && (view instanceof DialogCell) && !isDialogPinned(tLRPC$Dialog) && (currentViewPage = getCurrentViewPage()) != null && currentViewPage.listView != null) {
                        final boolean z2 = !this.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog.f1528id));
                        final ArrayList arrayList = new ArrayList(this.selectedDialogs);
                        currentViewPage.listView.hideSelector(true);
                        currentViewPage.listView.startMultiselect(fixPosition, false, new RecyclerListView.onMultiSelectionChanged() { // from class: org.telegram.ui.DialogsActivity.62
                            ...
                            public void onSelectionChanged(int i4, boolean z3, float f3, float f4) {
                                ...
                                if (z3 && DialogsActivity.this.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog2.f1528id))) {
                                    return;
                                }
                                if (z3 || DialogsActivity.this.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog2.f1528id))) {
                                    DialogsActivity.this.showOrUpdateActionMode(tLRPC$Dialog2.f1528id, null);
                                    DialogsActivity dialogsActivity2 = DialogsActivity.this;
                                    dialogsActivity2.findAndUpdateCheckBox(tLRPC$Dialog2.f1528id, dialogsActivity2.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog2.f1528id)));
                                }
                            }
                            ...
                            public boolean canSelect(int i4) {
                                ...
                                if (z2 || arrayList.contains(Long.valueOf(tLRPC$Dialog2.f1528id))) {
                                    return z2 && arrayList.contains(Long.valueOf(tLRPC$Dialog2.f1528id));
                                }
                                return true;
                            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemLongClick$102(long j, DialogInterface dialogInterface, int i) {
    ...
    private void onArchiveLongPress(View view) {
        ...
        int[] iArr = new int[3];
        iArr[0] = z ? C3473R.C3475drawable.msg_markread : 0;
        iArr[1] = (!isArchive() ? SharedConfig.archiveHidden : getHiddenChatsController().isHiddenChatsHidden()) ? C3473R.C3475drawable.chats_unpin : C3473R.C3475drawable.chats_pin;
        iArr[2] = (SharedConfig.isShowDrawerHeaderArchiveEnabled || isArchive()) ? 0 : C3473R.C3475drawable.attach_arrow_left;
        CharSequence[] charSequenceArr = new CharSequence[3];
        String str2 = null;
        charSequenceArr[0] = z ? LocaleController.getString("MarkAllAsRead", C3473R.string.MarkAllAsRead) : null;
        if (!isArchive() ? SharedConfig.archiveHidden : getHiddenChatsController().isHiddenChatsHidden()) {
            i = C3473R.string.HideAboveTheList;
            str = "HideAboveTheList";
        } else {
            i = C3473R.string.PinInTheList;
            str = "PinInTheList";
        }
        charSequenceArr[1] = LocaleController.getString(str, i);
        if (!SharedConfig.isShowDrawerHeaderArchiveEnabled && !isArchive()) {
            str2 = LocaleController.getInternalString(C3473R.string.drawer_enable_archive_button);
        }
        ...
        builder.setItems(charSequenceArr, iArr, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda17
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
                DialogsActivity.this.lambda$onArchiveLongPress$103(dialogInterface, i2);
            }
        });
        showDialog(builder.create());
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onArchiveLongPress$103(DialogInterface dialogInterface, int i) {
        int i2 = 0;
        if (i == 2) {
            SharedConfig.setShowDrawerHeaderArchiveEnabled(true);
    ...
    public boolean showChatPreview(final DialogCell dialogCell, ProfileSearchCell profileSearchCell) {
        ...
        if (DialogObject.isUserDialog(dialogId)) {
            ...
            if (UserObject.isUserSelf(getMessagesController().getUser(Long.valueOf(dialogId))) && sectionsPasscodeData != null && !sectionsPasscodeData.getPasscodeHash().isEmpty()) {
                showToast(LocaleController.getInternalString(C3473R.string.section_is_locked));
                return false;
            }
        ...
        final ActionBarPopupWindow.ActionBarPopupWindowLayout[] actionBarPopupWindowLayoutArr = {new ActionBarPopupWindow.ActionBarPopupWindowLayout(getParentActivity(), C3473R.C3475drawable.popup_fixed_alert2, getResourceProvider(), 2)};
        ...
        if (dialogCell != null && dialogCell.getHasUnread()) {
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("MarkAsRead", C3473R.string.MarkAsRead), C3473R.C3475drawable.msg_markread);
        } else {
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("MarkAsUnread", C3473R.string.MarkAsUnread), C3473R.C3475drawable.msg_markunread);
        }
        actionBarMenuSubItem.setMinimumWidth(160);
        actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda49
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DialogsActivity.this.lambda$showChatPreview$104(dialogCell, dialogId, view);
            }
        });
        ...
        if (isDialogPinned(tLRPC$Dialog)) {
            ...
            while (true) {
                ...
                if (tLRPC$Dialog2 instanceof TLRPC$TL_dialogFolder) {
                    ...
                    arrayList = dialogs;
                    i5 = size;
                    if (DialogObject.isEncryptedDialog(tLRPC$Dialog2.f1528id)) {
                        i8++;
                    } else {
                        i7++;
                    }
                    ...
                    i5 = size;
                    chatActivityArr = chatActivityArr2;
                    if (!getMessagesController().isPromoDialog(tLRPC$Dialog2.f1528id, false)) {
                        break;
                    }
                    i6++;
                    dialogs = arrayList;
        ...
        if (zArr[r1]) {
            ...
            if (isDialogPinned(tLRPC$Dialog)) {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("UnpinMessage", C3473R.string.UnpinMessage), C3473R.C3475drawable.msg_unpin);
            } else {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("PinMessage", C3473R.string.PinMessage), C3473R.C3475drawable.msg_pin);
            }
            actionBarMenuSubItem2.setMinimumWidth(160);
            bundle = null;
            actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda48
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$showChatPreview$106(dialogFilter, tLRPC$Dialog, dialogId, view);
                }
            });
            actionBarPopupWindowLayoutArr[0].addView(actionBarMenuSubItem2);
        } else {
        ...
        if (DialogObject.isUserDialog(dialogId) && UserObject.isUserSelf(getMessagesController().getUser(Long.valueOf(dialogId)))) {
            ...
            if (!getMessagesController().isDialogMuted(dialogId, 0)) {
                actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("Mute", C3473R.string.Mute), C3473R.C3475drawable.msg_mute);
            } else {
                actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("Unmute", C3473R.string.Unmute), C3473R.C3475drawable.msg_unmute);
            }
            actionBarMenuSubItem3.setMinimumWidth(160);
            actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda45
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$showChatPreview$107(dialogId, view);
                }
            });
            z = false;
            actionBarPopupWindowLayoutArr[0].addView(actionBarMenuSubItem3);
        ...
        actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("Delete", C3473R.string.Delete), C3473R.C3475drawable.msg_delete);
        actionBarMenuSubItem4.setMinimumWidth(160);
        actionBarMenuSubItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda47
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DialogsActivity.this.lambda$showChatPreview$108(arrayList2, view);
            }
        });
        actionBarPopupWindowLayoutArr[0].addView(actionBarMenuSubItem4);
        if (getMessagesController().checkCanOpenChat(bundle2, this)) {
            ...
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda134
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$showChatPreview$109(chatActivityArr3, bundle2, actionBarPopupWindowLayoutArr);
                }
            };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$104(DialogCell dialogCell, long j, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$106(final MessagesController.DialogFilter dialogFilter, final TLRPC$Dialog tLRPC$Dialog, final long j, View view) {
        finishPreviewFragment();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda120
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$showChatPreview$105(dialogFilter, tLRPC$Dialog, j);
            }
        }, 100L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$105(MessagesController.DialogFilter dialogFilter, TLRPC$Dialog tLRPC$Dialog, long j) {
        boolean z;
        int i = Integer.MAX_VALUE;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$107(long j, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$108(ArrayList arrayList, View view) {
        performSelectedDialogsAction(arrayList, 102, false, false);
        finishPreviewFragment();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$109(ChatActivity[] chatActivityArr, Bundle bundle, ActionBarPopupWindow.ActionBarPopupWindowLayout[] actionBarPopupWindowLayoutArr) {
        ChatActivity chatActivity = new ChatActivity(bundle);
        chatActivityArr[0] = chatActivity;
        FragmentPreviewMenu fragmentPreviewMenu = new FragmentPreviewMenu(this.parentLayout, chatActivityArr[0], null);
    ...
    public void updateFloatingButtonOffset() {
        ...
        if (frameLayout != null) {
            ...
            float f2 = BitmapDescriptorFactory.HUE_RED;
            frameLayout.setTranslationZ(f == BitmapDescriptorFactory.HUE_RED ? AndroidUtilities.m72dp(2) : 0.0f);
            if (isMainDialogList()) {
                FilterTabsView filterTabsView = this.filterTabsView;
                if (filterTabsView != null && filterTabsView.getVisibility() == 0 && isFilterTabsAtBottom()) {
                    f2 = (AndroidUtilities.m72dp(44) - this.filterTabsView.getTranslationY()) + BitmapDescriptorFactory.HUE_RED;
                }
        ...
        if (frameLayout2 != null) {
            frameLayout2.setTranslationY(((this.floatingButtonTranslation - this.floatingButtonPanOffset) - (Math.max(this.additionalFloatingTranslation, this.additionalFloatingTranslation2) * (1.0f - this.floatingButtonHideProgress))) + (AndroidUtilities.m72dp(44) * this.floatingButtonHideProgress));
        }
    }
    ...
    private void checkAnimationFinished(final boolean z) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda129
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$checkAnimationFinished$110(z);
            }
        }, 300L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkAnimationFinished$110(boolean z) {
        ArrayList<TLRPC$Dialog> arrayList;
    ...
    public void setScrollY(float f) {
        ...
        if (animatedStatusView != null) {
            ...
            this.animatedStatusView.setAlpha(1.0f - ((-f) / C3541ActionBar.getCurrentActionBarHeight()));
        }
        View view = this.fragmentView;
        if (view != null) {
            view.invalidate();
    ...
    public void prepareBlurBitmap() {
        ...
        int m72dp = (getPinnedPlayerView() == null || getPinnedPlayerView().getVisibility() != 0) ? 0 : AndroidUtilities.m72dp(PinnedPlayerView.getPlayerHeight());
        int measuredWidth = (int) (this.fragmentView.getMeasuredWidth() / 6.0f);
        int measuredHeight = (int) ((m72dp + this.fragmentView.getMeasuredHeight()) / 6.0f);
    ...
    public void hideActionMode(boolean z) {
        ...
        if (this.menuDrawable != null) {
            this.actionBar.setBackButtonContentDescription(LocaleController.getString("AccDescrOpenMenu", C3473R.string.AccDescrOpenMenu));
        }
        ...
        if (this.hasStories) {
            ...
            f = Math.max((float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m72dp(81) + this.scrollYOffset);
        } else {
            f = 0.0f;
        }
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda6
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DialogsActivity.this.lambda$hideActionMode$111(f, valueAnimator2);
            }
        });
        this.actionBarColorAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.63
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                super.onAnimationEnd(animator);
                ...
                DialogsActivity dialogsActivity = DialogsActivity.this;
                if (dialogsActivity.hasStories) {
                    dialogsActivity.scrollAdditionalOffset = -(AndroidUtilities.m72dp(81) - f);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$hideActionMode$111(float f, ValueAnimator valueAnimator) {
        if (this.hasStories) {
    ...
    private int getPinnedCount() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (!(tLRPC$Dialog instanceof TLRPC$TL_dialogFolder)) {
                if (isDialogPinned(tLRPC$Dialog)) {
                    i++;
                } else if (!getMessagesController().isPromoDialog(tLRPC$Dialog.f1528id, false)) {
                    break;
                }
            }
        }
    ...
    public boolean isDialogPinned(TLRPC$Dialog tLRPC$Dialog) {
        if (tLRPC$Dialog == null || getHiddenChatsController().isChatHidden(tLRPC$Dialog.f1528id)) {
            return false;
        }
        MessagesController.DialogFilter dialogFilter = null;
        if ((this.viewPages[0].dialogsType == 7 || this.viewPages[0].dialogsType == 8) && (!this.actionBar.isActionModeShowed() || this.actionBar.isActionModeShowed(null))) {
        ...
        if (dialogFilter != null) {
            return dialogFilter.pinnedDialogs.indexOfKey(tLRPC$Dialog.f1528id) >= 0;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:487:0x029a A[SYNTHETIC] */
    ...
    */
    private void performSelectedDialogsAction(final java.util.ArrayList<java.lang.Long> r35, final int r36, boolean r37, boolean r38, boolean r39) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.performSelectedDialogsAction(java.util.ArrayList, int, boolean, boolean, boolean):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$112(List list, DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$114(ArrayList arrayList) {
        getMessagesController().addDialogToFolder(arrayList, 1, -1, null, 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$performSelectedDialogsAction$115(boolean[] zArr, CheckBoxCell checkBoxCell, CheckBoxCell checkBoxCell2, View view) {
        zArr[0] = !zArr[0];
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$performSelectedDialogsAction$116(boolean[] zArr, CheckBoxCell checkBoxCell, View view) {
        zArr[0] = !zArr[0];
        checkBoxCell.toggle(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$118(ArrayList arrayList, final boolean[] zArr, boolean[] zArr2, final int i, DialogInterface dialogInterface, int i2) {
        if (arrayList.isEmpty()) {
            return;
        }
        ...
        UndoView undoView = getUndoView();
        if (undoView != null) {
            undoView.showWithAction(arrayList2, i == 102 ? 27 : 26, (Object) null, (Object) null, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda110
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$performSelectedDialogsAction$117(i, arrayList2, zArr);
                }
            }, (Runnable) null);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$117(int i, ArrayList arrayList, boolean[] zArr) {
        if (i == 102) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$119(AlertDialog alertDialog) {
        showDialog(alertDialog);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$120(ArrayList arrayList, boolean z, boolean z2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$121(DialogInterface dialogInterface, int i) {
        getMessagesController().hidePromoDialog();
        hideActionMode(false);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$123(final int i, final TLRPC$Chat tLRPC$Chat, final long j, final boolean z, final boolean z2) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if (i == 102) {
            ...
            if (this.frozenDialogsList != null) {
                ...
                while (i6 < this.frozenDialogsList.size()) {
                    if (this.frozenDialogsList.get(i6).f1528id == j) {
                        break;
                    }
                    i6++;
                }
        ...
        if (undoView != null) {
            i3 = i2;
            undoView.showWithAction(j, i == 103 ? 0 : 1, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda109
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$performSelectedDialogsAction$122(i, j, tLRPC$Chat, z, z2);
                }
            });
        } else {
            i3 = i2;
        ...
        while (true) {
            if (i7 >= arrayList2.size()) {
                ...
                i5 = -1;
                break;
            } else if (((TLRPC$Dialog) arrayList2.get(i7)).f1528id == j) {
                i5 = i7;
                i4 = 102;
                break;
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$125(DialogInterface dialogInterface) {
        hideActionMode(true);
    }
            ...
            if (this.frozenDialogsList != null) {
                ...
                while (true) {
                    if (i2 >= this.frozenDialogsList.size()) {
                        break;
                    } else if (this.frozenDialogsList.get(i2).f1528id == j) {
                        i = i2;
                        break;
                    } else {
                        i2++;
    ...
    public void markDialogsAsRead(ArrayList<TLRPC$Dialog> arrayList) {
        ...
        checkAnimationFinished();
        for (int i = 0; i < arrayList.size(); i++) {
            long j = arrayList.get(i).f1528id;
    ...
    public void lambda$performSelectedDialogsAction$122(int i, long j, TLRPC$Chat tLRPC$Chat, boolean z, boolean z2) {
        if (i == 103) {
    ...
    */
    private void pinDialog(long r17, boolean r19, org.telegram.messenger.MessagesController.DialogFilter r20, int r21, boolean r22) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.pinDialog(long, boolean, org.telegram.messenger.MessagesController$DialogFilter, int, boolean):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$pinDialog$126() {
        setDialogsListFrozen(false);
    }
    ...
    public void scrollToTop(boolean z, boolean z2, boolean z3) {
        ...
        int i2 = (z3 || !this.hasStories || z2 || this.dialogStoriesCell.isExpanded()) ? 0 : -AndroidUtilities.m72dp(81);
        if (z) {
    ...
    */
    public void updateCounters(boolean r23) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.updateCounters(boolean):void");
    }
    ...
    public boolean validateSlowModeDialog(long j) {
        ...
        if ((this.messagesCount > 1 || !((chatActivityEnterView = this.commentView) == null || chatActivityEnterView.getVisibility() != 0 || TextUtils.isEmpty(this.commentView.getFieldText()))) && DialogObject.isChatDialog(j) && (chat = getMessagesController().getChat(Long.valueOf(-j))) != null && !ChatObject.hasAdminRights(chat) && chat.slowmode_enabled) {
            AlertsCreator.showSimpleAlert(this, LocaleController.getString("Slowmode", C3473R.string.Slowmode), LocaleController.getString("SlowmodeSendError", C3473R.string.SlowmodeSendError));
            return false;
        }
        return true;
    }
    ...
    public void showOrUpdateActionMode(long j, View view) {
        ...
        if (this.actionBar.isActionModeShowed()) {
            ...
            if (this.menuDrawable != null) {
                this.actionBar.setBackButtonContentDescription(LocaleController.getString("AccDescrGoBack", C3473R.string.AccDescrGoBack));
            }
            if (getPinnedCount() > 1) {
                if (this.viewPages != null) {
                    int i = 0;
            ...
            if (!this.searchIsShowed) {
                ...
                for (int i2 = 0; i2 < this.actionModeViews.size(); i2++) {
                    ...
                    view2.setPivotY(C3541ActionBar.getCurrentActionBarHeight() / 2);
            ...
            if (z2) {
                ...
                float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m72dp(81) + this.scrollYOffset);
            ...
            this.actionBarColorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda5
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    DialogsActivity.this.lambda$showOrUpdateActionMode$127(f, valueAnimator2);
                }
            });
            this.actionBarColorAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.66
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    super.onAnimationEnd(animator);
                    DialogsActivity.this.actionBarColorAnimator = null;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showOrUpdateActionMode$127(float f, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    public void createUndoView() {
        ...
        if (this.undoView[0] == null && (context = getContext()) != null) {
            for (int i = 0; i < 2; i++) {
                this.undoView[i] = new C582167(context);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.telegram.ui.DialogsActivity$67 */
    /* loaded from: classes3.dex */
    public class C582167 extends UndoView {
        C582167(Context context) {
            super(context);
        }
        ...
        public void setTranslationY(float f) {
            ...
            if (this == DialogsActivity.this.undoView[0]) {
                if (DialogsActivity.this.undoView[1] == null || DialogsActivity.this.undoView[1].getVisibility() != 0) {
                    DialogsActivity.this.additionalFloatingTranslation = (getMeasuredHeight() + AndroidUtilities.m72dp(8)) - f;
                    if (DialogsActivity.this.additionalFloatingTranslation < BitmapDescriptorFactory.HUE_RED) {
                        DialogsActivity.this.additionalFloatingTranslation = BitmapDescriptorFactory.HUE_RED;
                    }
                    if (DialogsActivity.this.floatingHidden) {
                ...
                if (DialogsActivity.this.frozenDialogsList != null) {
                    ...
                    while (true) {
                        if (i3 >= DialogsActivity.this.frozenDialogsList.size()) {
                            break;
                        } else if (((TLRPC$Dialog) DialogsActivity.this.frozenDialogsList.get(i3)).f1528id == j) {
                            i2 = i3;
                            break;
                        } else {
                            i3++;
                    ...
                    if (i2 >= 0) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$67$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.C582167.this.lambda$onRemoveDialogAction$0(i2, tLRPC$Dialog);
                            }
                        });
                    } else {
                        DialogsActivity.this.setDialogsListFrozen(false);
    ...
    public void showDoneItem(final boolean z) {
        ...
        this.doneItemAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.68
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
        ...
        if (this.commentView != null) {
            if (this.selectedDialogs.isEmpty()) {
                ...
                if ((this.initialDialogsType == 3 && this.selectAlertString == null) || isForward()) {
                    this.actionBar.setTitle(LocaleController.getString("ForwardTo", C3473R.string.ForwardTo));
                } else {
                    this.actionBar.setTitle(LocaleController.getString("SelectChat", C3473R.string.SelectChat));
                }
                if (this.commentView.getTag() != null) {
                    ...
                    this.commentViewAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.69
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
                ...
                if (this.forwardingOptionsButton != null && this.showForwardingOptionsButton != (checkSelectedSecrets = checkSelectedSecrets())) {
                    ...
                    animatorSet3.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.70
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
                ...
                if (this.commentView.getTag() == null) {
                    ...
                    this.commentViewAnimator.setDuration(180L);
                    this.commentViewAnimator.setInterpolator(new DecelerateInterpolator());
                    this.commentViewAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.71
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
    ...
    private void askForPermissons(boolean z) {
        ...
        if (i >= 33 && NotificationPermissionDialog.shouldAsk(parentActivity)) {
            if (z) {
                showDialog(new NotificationPermissionDialog(parentActivity, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda148
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        DialogsActivity.lambda$askForPermissons$128(parentActivity, (Boolean) obj);
                    }
                }));
                return;
            }
        ...
        if (getUserConfig().syncContacts && this.askAboutContacts && parentActivity.checkSelfPermission("android.permission.READ_CONTACTS") != 0) {
            if (z) {
                AlertDialog create = AlertsCreator.createContactsPermissionDialog(parentActivity, new MessagesStorage.IntCallback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda143
                    @Override // org.telegram.messenger.MessagesStorage.IntCallback
                    public final void run(int i2) {
                        DialogsActivity.this.lambda$askForPermissons$129(i2);
                    }
                }).create();
                this.permissionDialog = create;
                showDialog(create);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$askForPermissons$128(Activity activity, Boolean bool) {
        if (bool.booleanValue()) {
            activity.requestPermissions(new String[]{"android.permission.POST_NOTIFICATIONS"}, 1);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$askForPermissons$129(int i) {
        this.askAboutContacts = i != 0;
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.floatingButtonContainer.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: org.telegram.ui.DialogsActivity.72
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public void onGlobalLayout() {
                DialogsActivity dialogsActivity = DialogsActivity.this;
                dialogsActivity.floatingButtonTranslation = dialogsActivity.floatingHidden ? AndroidUtilities.m72dp(100) : BitmapDescriptorFactory.HUE_RED;
                DialogsActivity.this.updateFloatingButtonOffset();
                    ...
                    case 2:
                        if (iArr[i3] == 0) {
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda81
                                @Override // java.lang.Runnable
                                public final void run() {
                                    DialogsActivity.this.lambda$onRequestPermissionsResultFragment$130();
                                }
                            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onRequestPermissionsResultFragment$130() {
    ...
    public void didReceivedNotification(int i, int i2, final Object... objArr) {
        ...
        if (i == NotificationCenter.updateWalletDialogVisibility) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda132
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$didReceivedNotification$131(objArr);
                }
            });
            return;
        }
        ...
        if (i == NotificationCenter.topicsSettingsChanged) {
            ...
            if (objArr.length > 0) {
                this.recentChatsBar.getLayoutParams().height = AndroidUtilities.m72dp(SharedConfig.isDialogsCompactModeEnabled ? 60 : 48);
            ...
            if (i == i5) {
                ...
                while (true) {
                    ...
                    if (this.slowedReloadAfterDialogClick && z2) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda127
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.this.lambda$didReceivedNotification$132(viewPage, objArr);
                            }
                        }, 160L);
                    } else {
                ...
                TLRPC$Message tLRPC$Message = (TLRPC$Message) objArr[2];
                Long l = (Long) objArr[3];
                if (tLRPC$Message == null || tLRPC$Message.from_id.user_id != getUserConfig().getClientUserId() || this.crossForwardCounter.indexOfKey(l.longValue()) < 0) {
                    return;
                }
                ...
                if (this.crossForwardCounter.size() == 0) {
                    ...
                    Runnable runnable = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda103
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.this.lambda$didReceivedNotification$134();
                        }
                    };
                ...
                Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda121
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.this.lambda$didReceivedNotification$135(tLRPC$Chat, longValue3, booleanValue, tLRPC$User, z);
                    }
                };
                createUndoView();
                ...
                if (i == i14) {
                    ...
                    if (this.fragmentView != null) {
                        ...
                        view4.animate().setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.73
                            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                            public void onAnimationEnd(Animator animator) {
                    ...
                    while (true) {
                        ...
                        if (viewPage5 != null && ((viewPage5.dialogsType == 7 || viewPage5.dialogsType == 8) && (dialogFilter = getMessagesController().getSelectedDialogFilter(isForward(), isArchive())[viewPage5.dialogsType - 7]) != null && intValue4 == dialogFilter.f1459id)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didReceivedNotification$131(Object[] objArr) {
        ViewPage[] viewPageArr = this.viewPages;
        if (viewPageArr != null) {
            viewPageArr[0].dialogsAdapter.setWalletBotHidden(((Boolean) objArr[0]).booleanValue());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didReceivedNotification$132(ViewPage viewPage, Object[] objArr) {
        reloadViewPageDialogs(viewPage, objArr.length > 0);
        FilterTabsView filterTabsView = this.filterTabsView;
        if (filterTabsView == null || filterTabsView.getVisibility() != 0) {
            return;
    ...
    public /* synthetic */ void lambda$didReceivedNotification$134() {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda87
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$didReceivedNotification$133();
            }
        });
    }
    ...
    public /* synthetic */ void lambda$didReceivedNotification$133() {
        if (getParentActivity() instanceof LaunchActivity) {
            ...
            if (this.crossForwardSelectedDialogs != 0) {
                ...
                launchActivity.lambda$runLinkRequest$87(new ChatActivity(bundle));
            }
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didReceivedNotification$135(TLRPC$Chat tLRPC$Chat, long j, boolean z, TLRPC$User tLRPC$User, boolean z2) {
        if (tLRPC$Chat != null) {
            if (ChatObject.isNotInChat(tLRPC$Chat)) {
    ...
    private boolean showSuggestion(String str) {
        if ("AUTOARCHIVE_POPULAR".equals(str)) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString("HideNewChatsAlertTitle", C3473R.string.HideNewChatsAlertTitle));
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("HideNewChatsAlertText", C3473R.string.HideNewChatsAlertText)));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString("GoToSettings", C3473R.string.GoToSettings), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda16
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.this.lambda$showSuggestion$136(dialogInterface, i);
                }
            });
            showDialog(builder.create(), new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda28
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    DialogsActivity.this.lambda$showSuggestion$137(dialogInterface);
                }
            });
            return true;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSuggestion$136(DialogInterface dialogInterface, int i) {
        presentFragment(new PrivacySettingsActivity());
        AndroidUtilities.scrollToFragmentRow(this.parentLayout, "newChatsRow");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSuggestion$137(DialogInterface dialogInterface) {
        onSuggestionDismiss();
    }
    ...
    private void showFiltersHint() {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda80
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$showFiltersHint$139();
            }
        }, 1000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showFiltersHint$139() {
        UndoView undoView = getUndoView();
        if (undoView != null) {
            undoView.showWithAction(0L, 15, null, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda102
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showFiltersHint$138() {
    ...
    private void setDialogsListFrozen(boolean z, boolean z2) {
        ...
        if (!this.viewPages[0].listView.isComputingLayout()) {
            ...
            this.viewPages[0].listView.post(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda88
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$setDialogsListFrozen$140();
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setDialogsListFrozen$140() {
        this.viewPages[0].dialogsAdapter.notifyDataSetChanged();
    }
    ...
    public ArrayList<TLRPC$Dialog> getDialogsArray(int i, int i2, int i3, boolean z) {
        ...
        if (!z || (arrayList = this.frozenDialogsList) == null) {
            ...
            if (isAlbumsDialogsType(i2)) {
                Collections.sort(messagesController.dialogsAlbumsOnly, new Comparator() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda136
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        int lambda$getDialogsArray$141;
                        lambda$getDialogsArray$141 = DialogsActivity.this.lambda$getDialogsArray$141(messagesController, (TLRPC$Dialog) obj, (TLRPC$Dialog) obj2);
                        return lambda$getDialogsArray$141;
                    }
                });
                ...
                if (i2 == 2) {
                    ...
                    if (messagesController.dialogsCanAddUsers.size() > 0) {
                        ...
                        for (int i4 = 0; i4 < size; i4++) {
                            ...
                            if ((this.allowChannels && ChatObject.isChannelAndNotMegaGroup(-tLRPC$Dialog.f1528id, i)) || (this.allowGroups && (ChatObject.isMegagroup(i, -tLRPC$Dialog.f1528id) || !ChatObject.isChannel(-tLRPC$Dialog.f1528id, i)))) {
                                if (z3) {
                        ...
                        if (i2 == 1 || i2 == 14) {
                            ...
                            if (this.allowUsers || this.allowBots) {
                                ...
                                while (it.hasNext()) {
                                    ...
                                    TLRPC$User user = messagesController.getUser(Long.valueOf(next.f1528id));
                            ...
                            if (this.allowGroups || ((z2 = this.allowLegacyGroups) && this.allowMegagroups)) {
                                ...
                                while (it2.hasNext()) {
                                    ...
                                    TLRPC$Chat chat = messagesController.getChat(Long.valueOf(-next2.f1528id));
                                ...
                                while (it3.hasNext()) {
                                    ...
                                    TLRPC$Chat chat2 = messagesController.getChat(Long.valueOf(-next3.f1528id));
                            ...
                            if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeUser) {
                                ...
                                while (it5.hasNext()) {
                                    ...
                                    if (meetRequestPeerRequirements(getMessagesController().getUser(Long.valueOf(next5.f1528id)))) {
                                        arrayList4.add(next5);
                                    }
                                }
                                for (TLRPC$User tLRPC$User : users.values()) {
                                    if (tLRPC$User != null && !messagesController.dialogs_dict.containsKey(tLRPC$User.f1685id) && meetRequestPeerRequirements(tLRPC$User)) {
                                ...
                                while (it6.hasNext()) {
                                    ...
                                    if (meetRequestPeerRequirements(user2, getMessagesController().getChat(Long.valueOf(-next6.f1528id)))) {
                                        arrayList4.add(next6);
                                    }
                                }
                                for (TLRPC$Chat tLRPC$Chat : chats.values()) {
                                    if (tLRPC$Chat != null && !messagesController.dialogs_dict.containsKey(-tLRPC$Chat.f1522id) && meetRequestPeerRequirements(user2, tLRPC$Chat)) {
                                        TLRPC$TL_dialog tLRPC$TL_dialog2 = new TLRPC$TL_dialog();
                                        if (ChatObject.isChannel(tLRPC$Chat)) {
                                            TLRPC$TL_peerChannel tLRPC$TL_peerChannel = new TLRPC$TL_peerChannel();
                                            tLRPC$TL_dialog2.peer = tLRPC$TL_peerChannel;
                                            tLRPC$TL_peerChannel.channel_id = tLRPC$Chat.f1522id;
                                        } else {
                                            TLRPC$TL_peerChat tLRPC$TL_peerChat = new TLRPC$TL_peerChat();
                                            tLRPC$TL_dialog2.peer = tLRPC$TL_peerChat;
                                            tLRPC$TL_peerChat.chat_id = tLRPC$Chat.f1522id;
                                        }
                                        tLRPC$TL_dialog2.f1528id = -tLRPC$Chat.f1522id;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ int lambda$getDialogsArray$141(MessagesController messagesController, TLRPC$Dialog tLRPC$Dialog, TLRPC$Dialog tLRPC$Dialog2) {
        TLRPC$Chat chat = messagesController.getChat(Long.valueOf(-tLRPC$Dialog.f1528id));
        TLRPC$Chat chat2 = messagesController.getChat(Long.valueOf(-tLRPC$Dialog2.f1528id));
    ...
    */
    private boolean meetRequestPeerRequirements(org.telegram.tgnet.TLRPC$User r6, org.telegram.tgnet.TLRPC$Chat r7) {
        ...
        L95:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.meetRequestPeerRequirements(org.telegram.tgnet.TLRPC$User, org.telegram.tgnet.TLRPC$Chat):boolean");
    }
    ...
    private void setFloatingProgressVisible(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            animatorSet2.playTogether(animatorArr);
            this.floatingProgressAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.74
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    public void hideFloatingButton(boolean z) {
        ...
        if (this.floatingHidden != z) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    DialogsActivity.this.lambda$hideFloatingButton$142(valueAnimator);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$hideFloatingButton$142(ValueAnimator valueAnimator) {
    ...
    public void animateContactsAlpha(float f) {
        ...
        this.contactsAlphaAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DialogsActivity.this.lambda$animateContactsAlpha$143(valueAnimator2);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$animateContactsAlpha$143(ValueAnimator valueAnimator) {
    ...
    public void setDelegate(DialogsActivityDelegate dialogsActivityDelegate) {
        ...
        if (dialogsActivityDelegate != null) {
            dialogsActivityDelegate.didSelectDialogs(null, null, null, false, null, new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda70
                @Override // com.iMe.fork.utils.Callbacks$Callback1
                public final void invoke(Object obj) {
                    DialogsActivity.this.lambda$setDelegate$144((ArrayList) obj);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setDelegate$144(ArrayList arrayList) {
    ...
    public void didSelectResult(final long j, final int i, boolean z, final boolean z2, final TopicsFragment topicsFragment) {
        ...
        if (checkCanWrite(j)) {
            ...
            if (i2 == 11 || i2 == 12 || i2 == 13) {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_messages_checkHistoryImportPeer, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda156
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                        DialogsActivity.this.lambda$didSelectResult$147(alertDialog, tLRPC$User, tLRPC$Chat, j, z2, tLRPC$TL_messages_checkHistoryImportPeer, tLObject, tLRPC$TL_error);
                    }
                });
                try {
                ...
                if (i2 == 15) {
                    final Runnable runnable = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda111
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.this.lambda$didSelectResult$150(j, i, z2, topicsFragment);
                        }
                    };
                    Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda112
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.this.lambda$didSelectResult$152(j, runnable);
                        }
                    };
                    if (j < 0) {
                    ...
                    ArrayList<MessagesStorage.TopicKey> arrayList = new ArrayList<>();
                    arrayList.add(MessagesStorage.TopicKey.m64of(j, i));
                ...
                if (DialogObject.isEncryptedDialog(j)) {
                    ...
                    string = LocaleController.getString("SendMessageTitle", C3473R.string.SendMessageTitle);
                    formatStringSimple = LocaleController.formatStringSimple(this.selectAlertString, UserObject.getUserName(user2));
                    string2 = LocaleController.getString("Send", C3473R.string.Send);
                } else if (DialogObject.isUserDialog(j)) {
                    if (j == getUserConfig().getClientUserId()) {
                        string = LocaleController.getString("SendMessageTitle", C3473R.string.SendMessageTitle);
                        formatStringSimple = LocaleController.formatStringSimple(this.selectAlertStringGroup, LocaleController.getString("SavedMessages", C3473R.string.SavedMessages));
                        string2 = LocaleController.getString("Send", C3473R.string.Send);
                    } else {
                    ...
                    if (i != 0 && (findTopic = getMessagesController().getTopicsController().findTopic(chat2.f1522id, i)) != null) {
                        str = ((Object) str) + " " + findTopic.title;
                    }
                    if (this.addToGroupAlertString != null) {
                        string = LocaleController.getString("AddToTheGroupAlertTitle", C3473R.string.AddToTheGroupAlertTitle);
                        formatStringSimple = LocaleController.formatStringSimple(this.addToGroupAlertString, str);
                        string2 = LocaleController.getString("Add", C3473R.string.Add);
                    } else {
                        string = LocaleController.getString("SendMessageTitle", C3473R.string.SendMessageTitle);
                ...
                builder.setPositiveButton(str2, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda21
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i3) {
                        DialogsActivity.this.lambda$didSelectResult$148(j, i, topicsFragment, dialogInterface, i3);
                    }
                });
                builder.setNegativeButton(LocaleController.getString("Cancel", C3473R.string.Cancel), null);
                if (this.sharePhotoVideo) {
                    builder.setNeutralButton(LocaleController.getString("Edit", C3473R.string.Edit), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda20
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i3) {
                            DialogsActivity.this.lambda$didSelectResult$149(j, dialogInterface, i3);
                        }
                    });
                }
                AlertDialog create = builder.create();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$147(final AlertDialog alertDialog, final TLRPC$User tLRPC$User, final TLRPC$Chat tLRPC$Chat, final long j, final boolean z, final TLRPC$TL_messages_checkHistoryImportPeer tLRPC$TL_messages_checkHistoryImportPeer, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda125
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$didSelectResult$146(alertDialog, tLObject, tLRPC$User, tLRPC$Chat, j, z, tLRPC$TL_error, tLRPC$TL_messages_checkHistoryImportPeer);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$146(AlertDialog alertDialog, TLObject tLObject, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, final long j, final boolean z, TLRPC$TL_error tLRPC$TL_error, TLRPC$TL_messages_checkHistoryImportPeer tLRPC$TL_messages_checkHistoryImportPeer) {
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
            FileLog.m67e(e);
        ...
        if (tLObject != null) {
            AlertsCreator.createImportDialogAlert(this, this.arguments.getString("importTitle"), ((TLRPC$TL_messages_checkedHistoryImportPeer) tLObject).confirm_text, tLRPC$User, tLRPC$Chat, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda116
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$didSelectResult$145(j, z);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$145(long j, boolean z) {
        setDialogsListFrozen(true);
        ArrayList<MessagesStorage.TopicKey> arrayList = new ArrayList<>();
        arrayList.add(MessagesStorage.TopicKey.m64of(j, 0));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$148(long j, int i, TopicsFragment topicsFragment, DialogInterface dialogInterface, int i2) {
        didSelectResult(j, i, false, false, topicsFragment);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$149(long j, DialogInterface dialogInterface, int i) {
        didSelectResult(j, 0, false, true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$150(long j, int i, boolean z, TopicsFragment topicsFragment) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$152(long j, final Runnable runnable) {
        if (this.requestPeerType.bot_admin_rights != null) {
            getMessagesController().setUserAdminRole(-j, getMessagesController().getUser(Long.valueOf(this.requestPeerBotId)), this.requestPeerType.bot_admin_rights, null, false, this, true, true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda140
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$didSelectResult$151;
                    lambda$didSelectResult$151 = DialogsActivity.lambda$didSelectResult$151(runnable, tLRPC$TL_error);
                    return lambda$didSelectResult$151;
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$didSelectResult$151(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }
    ...
    private void showSendToBotAlert(TLRPC$User tLRPC$User, final Runnable runnable, final Runnable runnable2) {
        TLRPC$User user = getMessagesController().getUser(Long.valueOf(this.requestPeerBotId));
        showDialog(new AlertDialog.Builder(getContext()).setTitle(LocaleController.formatString(C3473R.string.AreYouSureSendChatToBotTitle, UserObject.getFirstName(tLRPC$User), UserObject.getFirstName(user))).setMessage(TextUtils.concat(AndroidUtilities.replaceTags(LocaleController.formatString(C3473R.string.AreYouSureSendChatToBotMessage, UserObject.getFirstName(tLRPC$User), UserObject.getFirstName(user))))).setPositiveButton(LocaleController.formatString("Send", C3473R.string.Send, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda12
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                runnable.run();
            }
        }).setNegativeButton(LocaleController.formatString("Cancel", C3473R.string.Cancel, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda11
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DialogsActivity.lambda$showSendToBotAlert$154(runnable2, dialogInterface, i);
            }
        }).create());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showSendToBotAlert$154(Runnable runnable, DialogInterface dialogInterface, int i) {
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public void showSendToBotAlert(TLRPC$Chat tLRPC$Chat, final Runnable runnable, final Runnable runnable2) {
        ...
        AlertDialog.Builder title = new AlertDialog.Builder(getContext()).setTitle(LocaleController.formatString(C3473R.string.AreYouSureSendChatToBotTitle, tLRPC$Chat.title, UserObject.getFirstName(user)));
        CharSequence[] charSequenceArr = new CharSequence[2];
        charSequenceArr[0] = AndroidUtilities.replaceTags(LocaleController.formatString(C3473R.string.AreYouSureSendChatToBotMessage, tLRPC$Chat.title, UserObject.getFirstName(user)));
        Boolean bool = this.requestPeerType.bot_participant;
        if ((bool == null || !bool.booleanValue() || getMessagesController().isInChatCached(tLRPC$Chat, user)) && this.requestPeerType.bot_admin_rights == null) {
            ...
            charSequenceArr2[0] = "\n\n";
            if (this.requestPeerType.bot_admin_rights == null) {
                formatString = LocaleController.formatString(C3473R.string.AreYouSureSendChatToBotAdd, UserObject.getFirstName(user), tLRPC$Chat.title);
            } else {
                formatString = LocaleController.formatString(C3473R.string.AreYouSureSendChatToBotAddRights, UserObject.getFirstName(user), tLRPC$Chat.title, RequestPeerRequirementsCell.rightsToString(this.requestPeerType.bot_admin_rights, isChannelAndNotMegaGroup));
            }
            charSequenceArr2[1] = AndroidUtilities.replaceTags(formatString);
            charSequence = TextUtils.concat(charSequenceArr2);
        }
        charSequenceArr[1] = charSequence;
        showDialog(title.setMessage(TextUtils.concat(charSequenceArr)).setPositiveButton(LocaleController.formatString("Send", C3473R.string.Send, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda13
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                runnable.run();
            }
        }).setNegativeButton(LocaleController.formatString("Cancel", C3473R.string.Cancel, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda10
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DialogsActivity.lambda$showSendToBotAlert$156(runnable2, dialogInterface, i);
            }
        }).create());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showSendToBotAlert$156(Runnable runnable, DialogInterface dialogInterface, int i) {
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    private boolean onSendLongClick(View view) {
        ...
        actionBarPopupWindowLayout.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.DialogsActivity.75
        ...
        actionBarPopupWindowLayout.setDispatchKeyEventListener(new ActionBarPopupWindow.OnDispatchKeyEventListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda157
            @Override // org.telegram.p043ui.ActionBar.ActionBarPopupWindow.OnDispatchKeyEventListener
            public final void onDispatchKeyEvent(KeyEvent keyEvent) {
                DialogsActivity.this.lambda$onSendLongClick$157(keyEvent);
            }
        });
        ...
        if (z || !this.selectedDialogs.contains(Long.valueOf(clientUserId))) {
            ...
            if (z) {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("SetReminder", C3473R.string.SetReminder), C3473R.C3475drawable.msg_calendar2);
            } else {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("ScheduleMessage", C3473R.string.ScheduleMessage), C3473R.C3475drawable.msg_calendar2);
            }
            ...
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda46
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.this.lambda$onSendLongClick$158(parentActivity, view2);
                }
            });
        }
        ...
        if (getToolsController().isSilentSendingEnabled()) {
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getInternalString(C3473R.string.send_with_sound), C3473R.C3475drawable.input_notify_on);
        } else {
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("SendWithoutSound", C3473R.string.SendWithoutSound), C3473R.C3475drawable.input_notify_off);
        }
        ...
        actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda34
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                DialogsActivity.this.lambda$onSendLongClick$159(view2);
            }
        });
        ...
        this.sendPopupWindow.showAtLocation(view, 51, ((iArr[0] + view.getMeasuredWidth()) - linearLayout.getMeasuredWidth()) + AndroidUtilities.m72dp(8), (iArr[1] - linearLayout.getMeasuredHeight()) - AndroidUtilities.m72dp(2));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSendLongClick$157(KeyEvent keyEvent) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSendLongClick$158(Activity activity, View view) {
        ActionBarPopupWindow actionBarPopupWindow = this.sendPopupWindow;
        if (actionBarPopupWindow != null && actionBarPopupWindow.isShowing()) {
            this.sendPopupWindow.dismiss();
        }
        AlertsCreator.createScheduleDatePickerDialog(activity, 0L, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.DialogsActivity.76
            ...
            public void didSelectDate(boolean z, int i, String str) {
                ...
                for (int i2 = 0; i2 < DialogsActivity.this.selectedDialogs.size(); i2++) {
                    arrayList.add(MessagesStorage.TopicKey.m64of(((Long) DialogsActivity.this.selectedDialogs.get(i2)).longValue(), 0));
                }
                DialogsActivityDelegate dialogsActivityDelegate = DialogsActivity.this.delegate;
                DialogsActivity dialogsActivity2 = DialogsActivity.this;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSendLongClick$159(View view) {
        ActionBarPopupWindow actionBarPopupWindow = this.sendPopupWindow;
        if (actionBarPopupWindow != null && actionBarPopupWindow.isShowing()) {
            this.sendPopupWindow.dismiss();
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:144:0x0aa3 A[SYNTHETIC] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.util.ArrayList<org.telegram.p043ui.ActionBar.ThemeDescription> getThemeDescriptions() {
        /*
            Method dump skipped, instructions count: 7383
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.getThemeDescriptions():java.util.ArrayList");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$getThemeDescriptions$160() {
        /*
            Method dump skipped, instructions count: 463
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.lambda$getThemeDescriptions$160():void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getThemeDescriptions$161() {
        SearchViewPager searchViewPager = this.searchViewPager;
        if (searchViewPager != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getThemeDescriptions$162() {
    ...
    private void updateFloatingButtonColor() {
        ...
        if (this.floatingButtonContainer != null) {
            ...
            if (Build.VERSION.SDK_INT < 21) {
                Drawable mutate = ContextCompat.getDrawable(getParentActivity(), C3473R.C3475drawable.floating_shadow).mutate();
        ...
        if (this.floatingButton2Container != null) {
            ...
            Drawable createSimpleSelectorCircleDrawable2 = Theme.createSimpleSelectorCircleDrawable(m72dp, ColorUtils.blendARGB(Theme.getColor(i), -1, 0.1f), Theme.blendOver(Theme.getColor(i), Theme.getColor(Theme.key_listSelector)));
            if (Build.VERSION.SDK_INT < 21) {
                Drawable mutate2 = ContextCompat.getDrawable(getParentActivity(), C3473R.C3475drawable.floating_shadow).mutate();
                mutate2.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
                CombinedDrawable combinedDrawable2 = new CombinedDrawable(mutate2, createSimpleSelectorCircleDrawable2, 0, 0);
                combinedDrawable2.setIconSize(AndroidUtilities.m72dp(36), AndroidUtilities.m72dp(36));
    ...
    public Animator getCustomSlideTransition(boolean z, boolean z2, float f) {
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                DialogsActivity.this.lambda$getCustomSlideTransition$163(valueAnimator);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getCustomSlideTransition$163(ValueAnimator valueAnimator) {
    ...
    private void setFragmentIsSliding(boolean z) {
        ...
        if (z) {
            ...
            C3541ActionBar c3541ActionBar = this.actionBar;
            if (c3541ActionBar != null) {
                c3541ActionBar.setLayerType(2, null);
            }
            FilterTabsView filterTabsView = this.filterTabsView;
            if (filterTabsView != null) {
        ...
        if (c3541ActionBar2 != null) {
            c3541ActionBar2.setLayerType(0, null);
        }
        FilterTabsView filterTabsView2 = this.filterTabsView;
    ...
    private void setSlideTransitionProgress(float f) {
        ...
        if (this.slideFragmentLite) {
            FilterTabsView filterTabsView = this.filterTabsView;
            if (filterTabsView != null) {
                filterTabsView.getListView().setTranslationX((this.isDrawerTransition ? 1 : -1) * AndroidUtilities.m72dp(40) * (1.0f - this.slideFragmentProgress));
                this.filterTabsView.invalidate();
                while (i < 3) {
                    if (i == 0) {
                        TopicsBar topicsBar = this.topicsBar;
            ...
            DialogStoriesCell dialogStoriesCell2 = this.dialogStoriesCell;
            if (dialogStoriesCell2 != null) {
                dialogStoriesCell2.setTranslationX((this.isDrawerTransition ? 1 : -1) * AndroidUtilities.m72dp(40) * (1.0f - this.slideFragmentProgress));
            }
            RightSlidingDialogContainer rightSlidingDialogContainer = this.rightSlidingDialogContainer;
            ...
            this.rightSlidingDialogContainer.getFragmentView().setTranslationX((this.isDrawerTransition ? 1 : -1) * AndroidUtilities.m72dp(40) * (1.0f - this.slideFragmentProgress));
            return;
        }
        ...
        if (filterTabsView2 != null) {
            ...
            this.filterTabsView.getListView().setTranslationX((this.isDrawerTransition ? AndroidUtilities.m72dp(4) : -AndroidUtilities.m72dp(4)) * (1.0f - this.slideFragmentProgress));
        ...
        if (dialogStoriesCell3 != null) {
            ...
            this.dialogStoriesCell.setTranslationX((this.isDrawerTransition ? AndroidUtilities.m72dp(4) : -AndroidUtilities.m72dp(4)) * (1.0f - this.slideFragmentProgress));
        ...
        if (!this.rightFragmentTransitionInProgress) {
            ...
            this.rightSlidingDialogContainer.getFragmentView().setTranslationX((this.isDrawerTransition ? AndroidUtilities.m72dp(4) : -AndroidUtilities.m72dp(4)) * (1.0f - this.slideFragmentProgress));
        }
    ...
    public List<FloatingDebugController.DebugItem> onGetDebugItems() {
        return Arrays.asList(new FloatingDebugController.DebugItem(LocaleController.getString(C3473R.string.DebugDialogsActivity)), new FloatingDebugController.DebugItem(LocaleController.getString(C3473R.string.ClearLocalDatabase), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda78
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$onGetDebugItems$164();
            }
        }), new FloatingDebugController.DebugItem(LocaleController.getString(C3473R.string.DebugClearSendMessageAsPeers), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda84
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$onGetDebugItems$165();
            }
        }));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onGetDebugItems$164() {
        getMessagesStorage().clearLocalDatabase();
        Toast.makeText(getContext(), LocaleController.getString(C3473R.string.DebugClearLocalDatabaseSuccess), 0).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onGetDebugItems$165() {
    ...
    public void updateStoriesVisibility(boolean z) {
        ...
        if (!getStoriesController().isBarEnabled()) {
            z3 = false;
            z2 = false;
        } else if (isArchive()) {
        ...
        if (z6 != z4) {
            if (z) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity.77
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                ...
                this.storiesVisibilityAnimator2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.78
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        DialogsActivity dialogsActivity = DialogsActivity.this;
        ...
        if (z) {
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(f2, z2, f) { // from class: org.telegram.ui.DialogsActivity.79
                int currentValue;
            ...
            this.storiesVisibilityAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.80
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    DialogsActivity dialogsActivity = DialogsActivity.this;
                    ...
                    if (!z2) {
                        ...
                        DialogsActivity.this.scrollAdditionalOffset = AndroidUtilities.m72dp(81);
                    } else {
                        DialogsActivity.this.scrollAdditionalOffset = -AndroidUtilities.m72dp(81);
                        DialogsActivity dialogsActivity2 = DialogsActivity.this;
        ...
        if (!z2) {
            ...
            this.scrollAdditionalOffset = -AndroidUtilities.m72dp(81);
            setScrollY(-getMaxScrollYOffset());
        }
        while (true) {
            ViewPage[] viewPageArr = this.viewPages;
