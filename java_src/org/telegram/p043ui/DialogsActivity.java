...
import org.telegram.p043ui.Cells.UnconfirmedAuthHintCell;
...
import org.telegram.p043ui.Components.Premium.boosts.UserSelectorBottomSheet;
...
public class DialogsActivity extends JavaMvpFragment implements WalletAirdropView, NotificationCenter.NotificationCenterDelegate, FloatingDebugProvider {
    ...
    private static final Interpolator interpolator = new Interpolator() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda63
    ...
    public static /* synthetic */ boolean lambda$createActionMode$87(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    static /* synthetic */ float access$8624(DialogsActivity dialogsActivity, float f) {
    ...
    public /* synthetic */ void lambda$processQr$1(TLRPC$TL_error tLRPC$TL_error) {
        ...
        AlertsCreator.showSimpleAlert(this, LocaleController.getString("AuthAnotherClient", C3632R.string.AuthAnotherClient), str);
    }
    ...
    public MessagePreviewParams getForwardingParams() {
    ...
    public void filterSelectedForwardingMessages(ArrayList<MessageObject> arrayList) {
        MessagePreviewParams messagePreviewParams = this.forwardingParams;
        if (messagePreviewParams == null || this.forwardingMessages == null) {
            return;
        }
        messagePreviewParams.forwardMessages.getSelectedMessages(arrayList);
    }
    ...
    private void hideOrUnhideChats(final List<Long> list) {
        ...
        getUndoView().showWithAction(0L, i2, Boolean.TRUE, null, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda116
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void showReadAllDialog(final Runnable runnable) {
        ...
        builder.setTitle(LocaleController.getInternalString(C3632R.string.dialogs_mark_folder_dialogs_as_read_alert_title));
        final CheckBoxCell checkBoxCell = new CheckBoxCell(getParentActivity(), 1);
        checkBoxCell.setText(LocaleController.getInternalString(C3632R.string.dialogs_mark_all_folder_dialogs_as_read_alert_not_show_again_check_box), "", false, false);
        ...
        builder.setPositiveButton(LocaleController.getInternalString(C3632R.string.common_ok), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda15
    ...
    public void expandMultiFab(final boolean z) {
        ...
        this.floatingButton.animate().rotation(33.0f).scaleX(0.4f).scaleY(0.4f).withEndAction(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda126
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$expandMultiFab$8(boolean z) {
        ...
        if (rLottieImageView != null) {
            rLottieImageView.setImageResource(z ? C3632R.C3634drawable.ic_close_white : C3632R.C3634drawable.ic_ab_other);
    ...
    public List<FilterFab> getFabsForPage(ViewPage viewPage) {
        ...
        if (isAlbums() || isAlbumsDialogsType(viewPage.selectedType)) {
            ...
            singletonList = (viewPage.selectedType < 0 || viewPage.selectedType >= getMessagesController().dialogFilters.size()) ? null : getFiltersController().getSettings(getMessagesController().dialogFilters.get(viewPage.selectedType).f1538id).getFabs();
        }
    ...
    public void updateTopicsBar() {
        ...
        if (this.isTopicsBarVisible != z2) {
            ...
            if (rightSlidingDialogContainer != null && rightSlidingDialogContainer.hasFragment()) {
                ...
                layoutParams.topMargin = z2 ? 0 : AndroidUtilities.m107dp(-36);
    ...
    public /* synthetic */ void lambda$updateTopicsBar$9(boolean z, ValueAnimator valueAnimator) {
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.topicsBar.getLayoutParams();
        layoutParams.topMargin = AndroidUtilities.m107dp(((Integer) valueAnimator.getAnimatedValue()).intValue());
        this.topicsBar.setLayoutParams(layoutParams);
    ...
    public void updateRecentChatsBar() {
        ...
        if (this.isRecentChatsBarVisible != z) {
            ...
            if (rightSlidingDialogContainer != null && rightSlidingDialogContainer.hasFragment()) {
                ...
                if (!z) {
                    i = AndroidUtilities.m107dp(SharedConfig.isDialogsCompactModeEnabled ? -48 : -60);
                }
    ...
    public void moveToFolder() {
        ...
        if (filterById.neverShow.size() + dialogsCount.size() > 100) {
            showDialog(AlertsCreator.createSimpleAlert(getParentActivity(), LocaleController.getString("FilterAddToAlertFullTitle", C3632R.string.FilterAddToAlertFullTitle), LocaleController.getString("FilterAddToAlertFullText", C3632R.string.FilterAddToAlertFullText)).create());
            return;
        }
        FiltersListBottomSheet filtersListBottomSheet = new FiltersListBottomSheet(this, this.selectedDialogs, filterById.f1538id);
    ...
    public int getRecentChatsBarHeight() {
        ...
        return AndroidUtilities.m107dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : 60) + ((FrameLayout.LayoutParams) this.recentChatsBar.getLayoutParams()).topMargin;
    }
    ...
    public int getTopicsBarHeight(boolean z) {
        ...
        return AndroidUtilities.m107dp(36) + ((FrameLayout.LayoutParams) this.topicsBar.getLayoutParams()).topMargin;
    }
    ...
    private void updateAccountSwitchItems() {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda134
        ...
        while (it.hasNext()) {
            ...
            if (UserConfig.getInstance(intValue).getCurrentUser() != null) {
                if (isMainNoFolderDialogList()) {
                    ...
                    drawerUserCell.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda60
                ...
                this.switchItem.addSubItem(intValue + 10, accountSelectCell, AndroidUtilities.m107dp(230), AndroidUtilities.m107dp(56));
            }
        }
    }
    ...
    public /* synthetic */ boolean lambda$updateAccountSwitchItems$15(int i, View view) {
        ...
        C61294 c61294 = new C61294(null, (LaunchActivity) getParentActivity(), i);
        c61294.setCurrentAccount(i);
        presentFragmentAsPreviewWithMenu(c61294, new FragmentPreviewMenu(this, c61294, null));
        return true;
    }
    ...
    /* loaded from: classes5.dex */
    public class C61294 extends DialogsActivity {
        ...
        C61294(Bundle bundle, LaunchActivity launchActivity, int i) {
            super(bundle);
        ...
        public void onTransitionAnimationEnd(boolean z, boolean z2) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C61294.this.lambda$onTransitionAnimationEnd$0(launchActivity, i);
                }
            }, 150L);
        }
    ...
    public void updateAlbumsMenu() {
        ...
        if (actionBarMenuSubItem2 != null) {
            if (SharedConfig.isSortCloudAlbumsByNameEnabled) {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getInternalString(C3632R.string.dialogs_albums_sort_date), C3632R.C3634drawable.msg_contacts_time);
            } else {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getInternalString(C3632R.string.dialogs_albums_sort_alphabetically), C3632R.C3634drawable.msg_contacts_name);
            }
        }
    }
    ...
    public void animateSwitchArchive(boolean z) {
        ...
        fArr4[0] = z ? -AndroidUtilities.m107dp(44) : 0.0f;
        ...
        fArr6[0] = z ? -AndroidUtilities.m107dp(44) : 0.0f;
        ...
        if (z) {
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.5
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    DialogsActivity.this.forwardSwitchArchiveButton.setImageResource(DialogsActivity.this.isForwardToArchive ? C3632R.C3634drawable.msg_list : C3632R.C3634drawable.msg_archive);
                    ...
                    DialogsActivity.this.forwardSpansScrollView.setTranslationY(-AndroidUtilities.m107dp(44));
                    DialogsActivity.this.filterTabsView.setTranslationY(-AndroidUtilities.m107dp(44));
    ...
    private void showEnableSortingByDefaultAlert() {
        ...
        Dialog createTopAnimationDialog = AlertsCreator.createTopAnimationDialog(getParentActivity(), C3632R.raw.fork_dialogs_sorting, 300, LocaleController.getInternalString(C3632R.string.sorting_enable_alert_message), LocaleController.getString("Enable", C3632R.string.Enable), new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda65
    ...
    public void openForwardingPreview() {
        ...
        if (!DialogObject.isAllDialogsOfSameSecret(this.selectedDialogs)) {
        ...
        if (this.forwardingParams == null) {
            long longValue = this.selectedDialogs.get(0).longValue();
            MessagePreviewParams messagePreviewParams = new MessagePreviewParams(DialogObject.isEncryptedDialog(longValue), false);
            this.forwardingParams = messagePreviewParams;
            messagePreviewParams.updateForward(this.forwardingMessages, longValue);
            if (this.needForceHideForwardAuthor) {
                MessagePreviewParams messagePreviewParams2 = this.forwardingParams;
                messagePreviewParams2.hideForwardSendersName = true;
                messagePreviewParams2.isAuthorHiddenForce = true;
            }
        }
        EditTextBoldCursor editTextBoldCursor = this.forwardSearchEditText;
        if (editTextBoldCursor != null && editTextBoldCursor.isFocused()) {
            editText = this.forwardSearchEditText;
        } else {
            ChatActivityEnterView chatActivityEnterView = this.commentView;
            if (chatActivityEnterView != null && chatActivityEnterView.isKeyboardVisible()) {
                editText = this.commentView.getEditField();
            }
        }
        C61546 c61546 = new C61546(getParentActivity(), null, this.forwardingParams, null, null, this.currentAccount, null, 1, false, editText);
        this.forwardingPreviewView = c61546;
        this.forwardingParams.attach(c61546);
        ((ContentView) this.fragmentView).addView(this.forwardingPreviewView);
        if (editText != null) {
    ...
    /* loaded from: classes5.dex */
    public class C61546 extends MessagePreviewView {
        final /* synthetic */ EditText val$focusedEditText;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C61546(Context context, ChatActivity chatActivity, MessagePreviewParams messagePreviewParams, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, int i, MessagePreviewView.ResourcesDelegate resourcesDelegate, int i2, boolean z, EditText editText) {
        ...
        protected void onFullDismiss(boolean z) {
            if (DialogsActivity.this.forwardingParams != null) {
                DialogsActivity.this.forwardingParams.attach(null);
            }
            if (z) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$6$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C61546.this.lambda$onFullDismiss$0();
                    }
                }, 15L);
            }
        }
        ...
        public /* synthetic */ void lambda$onFullDismiss$0() {
            if (DialogsActivity.this.commentView != null) {
                DialogsActivity.this.commentView.freezeEmojiView(false);
            }
        }

        @Override // org.telegram.p043ui.Components.MessagePreviewView
        protected void onDismiss(boolean z) {
            DialogsActivity.this.forwardingPreviewView = null;
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$6$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C61546.lambda$onDismiss$1(editText);
                }
            }, 50L);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ void lambda$onDismiss$1(EditText editText) {
        ...
        protected void didOpenEditorPressed() {
            ...
            dialogsActivity.presentFragment(ChatActivity.newInstanceInForwardingEditor(((Long) dialogsActivity.selectedDialogs.get(0)).longValue(), DialogsActivity.this.forwardingParams, new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$6$$ExternalSyntheticLambda0
                @Override // com.iMe.fork.utils.Callbacks$Callback1
                public final void invoke(Object obj) {
                    DialogsActivity.C61546.this.lambda$didOpenEditorPressed$2((MessagePreviewParams) obj);
                }
            }));
            dismiss(false);
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$didOpenEditorPressed$2(MessagePreviewParams messagePreviewParams) {
            DialogsActivity.this.forwardingParams = messagePreviewParams;
    ...
    public class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            DialogsActivity.this.forwardSearchEditText.measure(View.MeasureSpec.makeMeasureSpec(m107dp - i3, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(32), 1073741824));
            if (!this.animationStarted) {
                int m107dp5 = m107dp3 + AndroidUtilities.m107dp(42);
                int m107dp6 = i3 + AndroidUtilities.m107dp(16);
                DialogsActivity.this.forwardSearchEditTextTranslationY = m107dp2;
                if (this.currentAnimation == null) {
                    DialogsActivity.this.forwardSpansContainerHeight = m107dp5;
                    DialogsActivity.this.forwardSearchEditText.setTranslationX(m107dp6);
                    ...
                    if (DialogsActivity.this.forwardSpansContainerHeight != m107dp7) {
                        this.animators.add(ObjectAnimator.ofInt(DialogsActivity.this, "forwardSpansContainerHeight", m107dp7));
                    }
                    float f3 = m107dp6;
    ...
    public class ViewPage extends FrameLayout {
        ...
        public /* synthetic */ void lambda$new$0() {
            ...
            if (view != null) {
                ...
                if (this.listView.getScrollState() != 1) {
                    if (z && i3 == 0 && ((this.listView.getPaddingTop() - view.getTop()) - view.getMeasuredHeight()) + f < BitmapDescriptorFactory.HUE_RED) {
                        top = f;
                    } else {
                        i = i3;
                    }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.animateStoriesView) {
                layoutParams.bottomMargin = -AndroidUtilities.m107dp(85);
            } else {
    ...
    public class ContentView extends SizeNotifierFrameLayout {
        ...
        public int getActionBarFullHeight() {
            ...
            if (DialogsActivity.this.hasStories) {
                measuredHeight += AndroidUtilities.m107dp(81) * (1.0f - DialogsActivity.this.searchAnimationProgress) * (1.0f - f) * (1.0f - DialogsActivity.this.progressToActionMode);
            }
            ...
            if (view != scrollView) {
                if (view != DialogsActivity.this.viewPages[0] && ((DialogsActivity.this.viewPages.length <= 1 || view != DialogsActivity.this.viewPages[1]) && view != DialogsActivity.this.fragmentContextView && view != DialogsActivity.this.fragmentLocationContextView && view != DialogsActivity.this.dialogsHintCell && view != DialogsActivity.this.authHintCell && view != DialogsActivity.this.topicsBar && view != DialogsActivity.this.recentChatsBar)) {
                    if (view == ((BaseFragment) DialogsActivity.this).actionBar && DialogsActivity.this.slideFragmentProgress != 1.0f) {
                        ...
                        if (dialogsActivity.slideFragmentLite) {
                            canvas.translate((dialogsActivity.isDrawerTransition ? 1 : -1) * AndroidUtilities.m107dp(40) * (1.0f - DialogsActivity.this.slideFragmentProgress), BitmapDescriptorFactory.HUE_RED);
                        } else {
                            float f2 = 1.0f - ((1.0f - dialogsActivity.slideFragmentProgress) * 0.05f);
                            canvas.translate((dialogsActivity.isDrawerTransition ? AndroidUtilities.m107dp(4) : -AndroidUtilities.m107dp(4)) * (1.0f - DialogsActivity.this.slideFragmentProgress), BitmapDescriptorFactory.HUE_RED);
                            if (DialogsActivity.this.isDrawerTransition) {
                                f = getMeasuredWidth();
                            }
                            canvas.scale(f2, f2, f, (((BaseFragment) DialogsActivity.this).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + (C3704ActionBar.getCurrentActionBarHeight() / 2.0f));
                        }
                ...
                if (dialogsActivity2.slideFragmentProgress != 1.0f && view != dialogsActivity2.topicsBar && view != DialogsActivity.this.recentChatsBar) {
                    ...
                    if (dialogsActivity3.slideFragmentLite) {
                        canvas.translate((dialogsActivity3.isDrawerTransition ? 1 : -1) * AndroidUtilities.m107dp(40) * (1.0f - DialogsActivity.this.slideFragmentProgress), BitmapDescriptorFactory.HUE_RED);
                    } else {
                        float f3 = 1.0f - ((1.0f - dialogsActivity3.slideFragmentProgress) * 0.05f);
                        canvas.translate((dialogsActivity3.isDrawerTransition ? AndroidUtilities.m107dp(4) : -AndroidUtilities.m107dp(4)) * (1.0f - DialogsActivity.this.slideFragmentProgress), BitmapDescriptorFactory.HUE_RED);
                        if (DialogsActivity.this.isDrawerTransition) {
                            f = getMeasuredWidth();
                        }
            ...
            for (int i = 0; i < DialogsActivity.this.viewPages.length; i++) {
                if (DialogsActivity.this.viewPages[i] != null && DialogsActivity.this.viewPages[i].getVisibility() == 0) {
                    for (int i2 = 0; i2 < DialogsActivity.this.viewPages[i].listView.getChildCount(); i2++) {
                        ...
                        if (childAt.getY() < DialogsActivity.this.viewPages[i].listView.blurTopPadding + AndroidUtilities.m107dp(100)) {
    ...
    public void updateStoriesViewAlpha(float f) {
        ...
        if (this.hasStories || this.animateToHasStories) {
            float clamp = Utilities.clamp((-this.scrollYOffset) / AndroidUtilities.m107dp(81), 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            ...
            if (!this.hasStories && this.animateToHasStories) {
                this.dialogStoriesCell.setTranslationY((-AndroidUtilities.m107dp(81)) - AndroidUtilities.m107dp(8));
                this.dialogStoriesCell.setProgressToCollapse(1.0f);
                f3 = this.progressToDialogStoriesCell;
            } else {
                this.dialogStoriesCell.setTranslationY(((this.scrollYOffset + this.storiesYOffset) + (this.storiesOverscroll / 2.0f)) - AndroidUtilities.m107dp(8));
            ...
            if (this.hasOnlySlefStories) {
                this.dialogStoriesCell.setTranslationY(((-AndroidUtilities.m107dp(81)) + this.scrollYOffset) - AndroidUtilities.m107dp(8));
                this.dialogStoriesCell.setProgressToCollapse(1.0f);
        ...
        if (f2 != 1.0f) {
            this.actionBar.getTitlesContainer().setPivotY(AndroidUtilities.statusBarHeight + (C3704ActionBar.getCurrentActionBarHeight() / 2.0f));
            this.actionBar.getTitlesContainer().setPivotX(AndroidUtilities.m107dp(72));
    ...
    public class DialogsRecyclerView extends BlurredRecyclerView implements StoriesListPlaceProvider.ClippedView {
        ...
        public DialogsRecyclerView(Context context, ViewPage viewPage) {
            ...
            this.additionalClipBottom = AndroidUtilities.m107dp(200);
        }
        ...
        */
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (!DialogsActivity.this.onlySelect || DialogsActivity.this.initialDialogsType == 3) {
                ...
                if (currentActionBarHeight != getPaddingTop()) {
                    ...
                    if (DialogsActivity.this.hasStories) {
                        this.parentPage.progressView.setPaddingTop(currentActionBarHeight - AndroidUtilities.m107dp(81));
                    } else {
        ...
        public void toggleArchiveHidden(boolean z, DialogCell dialogCell) {
            ...
            if (dialogCell != null) {
                ...
                if (dialogsActivity.hasStories && !dialogsActivity.dialogStoriesCell.isExpanded()) {
                    ...
                    measuredHeight += AndroidUtilities.m107dp(81);
                }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.parentPage.dialogsType == 0 && ((action == 1 || action == 3) && this.parentPage.archivePullViewState == 2 && DialogsActivity.this.hasHiddenArchive() && ((LinearLayoutManager) getLayoutManager()).findFirstVisibleItemPosition() == 0)) {
                ...
                if (findArchiveDialogCell != null) {
                    int m107dp = (int) (AndroidUtilities.m107dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : SharedConfig.useThreeLinesLayout ? 78 : 72) * 0.85f);
                    ...
                    if (top < m107dp || currentTimeMillis < 200) {
                        DialogsActivity.this.disableActionBarScrolling = true;
                        ...
                        if (AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
                            AndroidUtilities.makeAccessibilityAnnouncement(LocaleController.getString(C3632R.string.AccDescrArchivedChatsShown));
                        }
                    }
                    if (getViewOffset() != BitmapDescriptorFactory.HUE_RED) {
        ...
        public void setAnimationSupportView(RecyclerListView recyclerListView, float f, boolean z, boolean z2) {
            ...
            DialogCell dialogCell5 = (dialogCell == null || getAdapter().getItemCount() * AndroidUtilities.m107dp(70) <= getMeasuredHeight() || ((float) (dialogCell2.getTop() - getPaddingTop())) <= ((float) (getMeasuredHeight() - getPaddingTop())) / 2.0f) ? dialogCell2 : dialogCell;
            this.animationSupportListView = recyclerListView;
            if (dialogCell5 != null) {
                ...
                if (z2 && DialogsActivity.this.hasStories) {
                    top2 += AndroidUtilities.m107dp(81);
                }
    ...
    public class SwipeController extends ItemTouchHelper.Callback {
        ...
        */
        ...
        public /* synthetic */ void lambda$onSwiped$3(final TLRPC$Dialog tLRPC$Dialog, int i, int i2) {
            ...
            boolean z = false;
            if (!DialogsActivity.this.getMessagesController().isPromoDialog(tLRPC$Dialog.f1608id, false)) {
                if (!DialogsActivity.this.isHiddenChats()) {
                    int addDialogToFolder = DialogsActivity.this.getMessagesController().addDialogToFolder(tLRPC$Dialog.f1608id, DialogsActivity.this.folderId == 0 ? 1 : 0, -1, 0L);
                    int i4 = 2;
                            ...
                            if (i2 == 0) {
                                ...
                                if (!DialogsActivity.this.isArchive() ? !SharedConfig.archiveHidden : !DialogsActivity.this.getHiddenChatsController().isHiddenChatsHidden()) {
                                    if (this.parentPage.layoutManager.findFirstVisibleItemPosition() == 0) {
                                        DialogsActivity.this.disableActionBarScrolling = true;
                                        this.parentPage.listView.smoothScrollBy(0, -AndroidUtilities.m107dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : SharedConfig.useThreeLinesLayout ? 78 : 72));
                                    }
                                }
                            }
                            DialogsActivity dialogsActivity = DialogsActivity.this;
                    ...
                    return;
                } else if (DialogsActivity.this.getHiddenChatsController().hideChats(tLRPC$Dialog.f1608id, false)) {
                    return;
                } else {
        ...
        public /* synthetic */ void lambda$onSwiped$0(TLRPC$Dialog tLRPC$Dialog) {
            DialogsActivity.this.getHiddenChatsController().hideChats(tLRPC$Dialog.f1608id, true);
            DialogsActivity.this.setDialogsListFrozen(true);
            this.parentPage.dialogsItemAnimator.prepareForRemove();
            this.parentPage.updateList(true);
            DialogsActivity.this.checkAnimationFinished();
        ...
        public /* synthetic */ void lambda$onSwiped$2(TLRPC$Dialog tLRPC$Dialog, int i) {
            ...
            DialogsActivity.this.getMessagesController().addDialogToFolder(tLRPC$Dialog.f1608id, DialogsActivity.this.isArchive() ? 1 : 0, i, 0L);
    ...
    public void updateStatus(TLRPC$User tLRPC$User, boolean z) {
        ...
        if (isShowPremiumStatusEnabled && emojiStatusDocumentId != null) {
            ...
            this.actionBar.setRightDrawableOnClick(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda34
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            if (this.premiumStar == null) {
                this.premiumStar = getContext().getResources().getDrawable(C3632R.C3634drawable.msg_premium_liststar).mutate();
                this.premiumStar = new AnimatedEmojiDrawable.WrapSizeDrawable(this, this.premiumStar, AndroidUtilities.m107dp(18), AndroidUtilities.m107dp(18)) { // from class: org.telegram.ui.DialogsActivity.9
                    @Override // org.telegram.p043ui.Components.AnimatedEmojiDrawable.WrapSizeDrawable, android.graphics.drawable.Drawable
                    public void draw(Canvas canvas) {
                        canvas.save();
                        canvas.translate(AndroidUtilities.m107dp(-2), AndroidUtilities.m107dp(1));
                        super.draw(canvas);
                        canvas.restore();
                    }
                };
    ...
    public C3704ActionBar createActionBar(Context context) {
        C3704ActionBar c3704ActionBar = new C3704ActionBar(context) { // from class: org.telegram.ui.DialogsActivity.10
            ...
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // org.telegram.p043ui.ActionBar.C3704ActionBar, android.view.ViewGroup
            public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        c3704ActionBar.setUseContainerForTitles();
        c3704ActionBar.setItemsBackgroundColor(Theme.getColor(Theme.key_actionBarDefaultSelector), false);
        c3704ActionBar.setItemsBackgroundColor(Theme.getColor(Theme.key_actionBarActionModeDefaultSelector), true);
        c3704ActionBar.setItemsColor(Theme.getColor(Theme.key_actionBarDefaultIcon), false);
        c3704ActionBar.setItemsColor(Theme.getColor(Theme.key_actionBarActionModeDefaultIcon), true);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:189:0x0729, code lost:
        if (r0 == 3) goto L373;
     */
    /* JADX WARN: Code restructure failed: missing block: B:281:0x0b45, code lost:
    ...
    /* JADX WARN: Removed duplicated region for block: B:261:0x0a8f  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:272:0x0b26  */
    /* JADX WARN: Removed duplicated region for block: B:273:0x0b2e  */
    /* JADX WARN: Removed duplicated region for block: B:292:0x0b65  */
    /* JADX WARN: Removed duplicated region for block: B:293:0x0b68  */
    /* JADX WARN: Removed duplicated region for block: B:295:0x0b6c  */
    /* JADX WARN: Removed duplicated region for block: B:296:0x0b6f  */
    /* JADX WARN: Removed duplicated region for block: B:299:0x0b75  */
    /* JADX WARN: Removed duplicated region for block: B:300:0x0b78  */
    /* JADX WARN: Removed duplicated region for block: B:303:0x0b7e  */
    /* JADX WARN: Removed duplicated region for block: B:304:0x0b81  */
    /* JADX WARN: Removed duplicated region for block: B:307:0x0b87  */
    /* JADX WARN: Removed duplicated region for block: B:308:0x0b8a  */
    /* JADX WARN: Removed duplicated region for block: B:311:0x0b9b  */
    /* JADX WARN: Removed duplicated region for block: B:321:0x0c52  */
    /* JADX WARN: Removed duplicated region for block: B:324:0x0cca  */
    /* JADX WARN: Removed duplicated region for block: B:325:0x0cf7  */
    /* JADX WARN: Removed duplicated region for block: B:328:0x0d0c  */
    /* JADX WARN: Removed duplicated region for block: B:347:0x0e39  */
    /* JADX WARN: Removed duplicated region for block: B:387:0x10da  */
    /* JADX WARN: Removed duplicated region for block: B:390:0x10e4  */
    /* JADX WARN: Removed duplicated region for block: B:403:0x113a  */
    /* JADX WARN: Removed duplicated region for block: B:410:0x1174  */
    /* JADX WARN: Removed duplicated region for block: B:414:0x1214  */
    /* JADX WARN: Removed duplicated region for block: B:415:0x121d  */
    /* JADX WARN: Removed duplicated region for block: B:421:0x123c  */
    /* JADX WARN: Removed duplicated region for block: B:432:0x12a5  */
    /* JADX WARN: Removed duplicated region for block: B:435:0x12d5  */
    /* JADX WARN: Removed duplicated region for block: B:438:0x12e8  */
    /* JADX WARN: Removed duplicated region for block: B:441:0x12f8  */
    /* JADX WARN: Removed duplicated region for block: B:442:0x12fb  */
    /* JADX WARN: Removed duplicated region for block: B:445:0x1308  */
    /* JADX WARN: Removed duplicated region for block: B:453:0x1392  */
    /* JADX WARN: Removed duplicated region for block: B:454:0x139d  */
    /* JADX WARN: Removed duplicated region for block: B:462:0x13c7  */
    ...
    */
    ...
    public /* synthetic */ boolean lambda$createView$27(View view) {
        this.filterOptions = ItemOptions.makeOptions(this, this.proxyItem).setViewAdditionalOffsets(-AndroidUtilities.m107dp(5), -AndroidUtilities.m107dp(9), -AndroidUtilities.m107dp(5), -AndroidUtilities.m107dp(9)).setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m107dp(48), Theme.getColor(isArchive() ? Theme.key_actionBarDefaultArchived : Theme.key_actionBarDefault))).add(C3632R.C3634drawable.msg_disable, LocaleController.getString("Disable", C3632R.string.Disable), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda85
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createView$26();
            }
        }).translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(-8)).show();
        return true;
    }
    ...
    /* loaded from: classes5.dex */
    public class C609711 extends ActionBarMenuItem.ActionBarMenuItemSearchListener {
        boolean isSpeedItemCreated = false;
        final /* synthetic */ Context val$context;
        final /* synthetic */ ActionBarMenu val$menu;

        C609711(Context context, ActionBarMenu actionBarMenu) {
        ...
        public void onPreToggleSearch() {
            ...
            DialogsActivity.this.speedItem.setIcon(C3632R.C3634drawable.avd_speed);
            ...
            DialogsActivity.this.speedItem.setTranslationX(AndroidUtilities.m107dp(32));
            ...
            DialogsActivity.this.speedItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$11$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.C609711.this.lambda$onPreToggleSearch$0(view);
                }
            });
            DialogsActivity.this.speedItem.setClickable(false);
            DialogsActivity.this.speedItem.setFixBackground(true);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(AndroidUtilities.m107dp(42), -1);
        ...
        public void onSearchExpand() {
            ...
            ((BaseFragment) DialogsActivity.this).actionBar.setBackButtonContentDescription(LocaleController.getString("AccDescrGoBack", C3632R.string.AccDescrGoBack));
        ...
        public void onSearchCollapse() {
            ...
            if (DialogsActivity.this.viewPages[0] != null) {
                ...
                if (!DialogsActivity.this.onlySelect || DialogsActivity.this.isAlbums()) {
                    ...
                    DialogsActivity.this.floatingButtonTranslation = AndroidUtilities.m107dp(100);
            ...
            if (DialogsActivity.this.menuDrawable != null) {
                ...
                ((BaseFragment) DialogsActivity.this).actionBar.setBackButtonContentDescription(LocaleController.getString("AccDescrOpenMenu", C3632R.string.AccDescrOpenMenu));
            }
        ...
        */
        public void onTextChanged(android.widget.EditText r4) {
            /*
                ...
                org.telegram.ui.Components.SearchViewPager r0 = org.telegram.p043ui.DialogsActivity.access$11100(r0)
            ...
            L26:
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                boolean r0 = org.telegram.p043ui.DialogsActivity.access$24900(r0)
                if (r0 != 0) goto L38
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
            ...
            L38:
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                r1 = 1
                org.telegram.p043ui.DialogsActivity.access$23902(r0, r1)
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                boolean r0 = org.telegram.p043ui.DialogsActivity.access$7800(r0)
                if (r0 != 0) goto L4c
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                r2 = 0
                org.telegram.p043ui.DialogsActivity.access$24400(r0, r1, r2, r1)
            L4c:
                org.telegram.ui.DialogsActivity r0 = org.telegram.p043ui.DialogsActivity.this
                org.telegram.ui.Components.SearchViewPager r0 = org.telegram.p043ui.DialogsActivity.access$11100(r0)
                r0.onTextChanged(r4)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.C609711.onTextChanged(android.widget.EditText):void");
        }
    ...
    public /* synthetic */ boolean lambda$createView$30(View view) {
        this.filterOptions = ItemOptions.makeOptions(this, this.optionsItem).setViewAdditionalOffsets(-AndroidUtilities.m107dp(5), -AndroidUtilities.m107dp(9), -AndroidUtilities.m107dp(5), -AndroidUtilities.m107dp(9)).setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m107dp(48), Theme.getColor(Theme.key_actionBarDefault))).add(C3632R.C3634drawable.msg_disable, LocaleController.getString("Disable", C3632R.string.Disable), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda92
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* loaded from: classes5.dex */
    public class C609812 extends FilterTabsView {
        C609812(Context context, FilterTabsView.TabMode tabMode, SizeNotifierFrameLayout sizeNotifierFrameLayout) {
    ...
    /* loaded from: classes5.dex */
    public class C609913 implements FilterTabsView.FilterTabsViewDelegate {
        final /* synthetic */ Context val$context;

        C609913(Context context) {
            this.val$context = context;
        }
        ...
        public void onTabSelected(int i) {
            ...
            if (DialogsActivity.this.miniFabsContainer == null || fabsForPage.size() <= 1) {
                ...
                DialogsActivity.this.floatingButton.setImageResource(C3632R.C3634drawable.ic_ab_other);
            ...
            if (DialogsActivity.this.isMainNoFolderDialogList()) {
                if (SortingFilter.isSortingFilter(false, i)) {
                    ...
                    DialogsActivity.this.getForkCommonController().setLastFilterTab(DialogsActivity.this.getMessagesController().dialogFilters.get(i).f1538id);
                }
        ...
        public void lambda$didSelectTab$10(final MessagesController.DialogFilter dialogFilter) {
            ...
            if (dialogFilter.isChatlist()) {
                FolderBottomSheet.showForDeletion(DialogsActivity.this, dialogFilter.f1538id, null);
                return;
            }
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            builder.setTitle(LocaleController.getString("FilterDelete", C3632R.string.FilterDelete));
            builder.setMessage(LocaleController.getString("FilterDeleteAlert", C3632R.string.FilterDeleteAlert));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString("Delete", C3632R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.C609913.this.lambda$showDeleteAlert$0(dialogFilter, dialogInterface, i);
                }
            });
        ...
        public void onPageSelected(FilterTabsView.Tab tab, boolean z) {
            int i;
            if (DialogsActivity.this.viewPages[0].selectedType == tab.f1851id) {
                return;
            }
            if (tab.isLocked) {
                DialogsActivity.this.filterTabsView.shakeLock(tab.f1851id);
                DialogsActivity dialogsActivity = DialogsActivity.this;
                DialogsActivity dialogsActivity2 = DialogsActivity.this;
            ...
            if (SortingFilter.isSortingFilter(false, tab.f1851id)) {
                if (SortingFilter.removeExtraFromId(false, tab.f1851id) >= DialogsActivity.this.getMessagesController().sortingDialogFilters.size()) {
                    return;
                }
            } else if (SortingFilter.isSortingFilter(true, tab.f1851id)) {
                if (SortingFilter.removeExtraFromId(true, tab.f1851id) >= DialogsActivity.this.getMessagesController().archiveSortingDialogFilters.size()) {
                    return;
                }
            } else if (!tab.isDefault && (((i = tab.f1851id) < 0 || i >= dialogFilters.size()) && !DialogsActivity.isAlbumsDialogsType(tab.f1851id) && !DialogsActivity.this.isArchive())) {
                return;
            }
            DialogsActivity dialogsActivity3 = DialogsActivity.this;
            dialogsActivity3.isFirstTab = tab.f1851id == dialogsActivity3.filterTabsView.getFirstTabId();
            DialogsActivity.this.updateDrawerSwipeEnabled();
            DialogsActivity.this.viewPages[1].selectedType = tab.f1851id;
            DialogsActivity.this.viewPages[1].setVisibility(0);
            DialogsActivity.this.viewPages[1].setTranslationX(DialogsActivity.this.viewPages[0].getMeasuredWidth());
            DialogsActivity.this.showScrollbars(false);
            DialogsActivity.this.switchToCurrentSelectedMode(true);
        ...
        public boolean didSelectTab(final FilterTabsView.TabView tabView, boolean z) {
            ...
            if (DialogsActivity.this.initialDialogsType == 0 && AndroidUtilities.isActivityRunning(DialogsActivity.this.getParentActivity()) && tabView != null) {
                ...
                if (DialogsActivity.this.filterOptions == null || !DialogsActivity.this.filterOptions.isShown()) {
                    ...
                    final ArrayList arrayList = new ArrayList(z8 ? messagesController.getDialogs(DialogsActivity.this.folderId) : messagesController.getAllDialogs());
                    if (filterById != null) {
                        dialogFilter2 = DialogsActivity.this.getFilterById(tabView.getId());
                        if (dialogFilter2 != null) {
                            int i3 = 0;
                            while (i3 < arrayList.size()) {
                                if (!dialogFilter2.includesDialog(DialogsActivity.this.getAccountInstance(), ((TLRPC$Dialog) arrayList.get(i3)).f1608id)) {
                                    arrayList.remove(i3);
                                    i3--;
                                }
                                i3++;
                            }
                            z5 = !isSortingFilter && (dialogFilter2.isChatlist() || (dialogFilter2.neverShow.isEmpty() && (dialogFilter2.flags & (~(MessagesController.DIALOG_FILTER_FLAG_CHATLIST | MessagesController.DIALOG_FILTER_FLAG_CHATLIST_ADMIN))) == 0));
                            if (z5) {
                                int i4 = 0;
                                while (true) {
                        ...
                        if (arrayList.isEmpty()) {
                            ...
                            while (true) {
                                ...
                                z6 = z5;
                                dialogFilter = dialogFilter2;
                                if (!DialogsActivity.this.getMessagesController().isDialogMuted(((TLRPC$Dialog) arrayList.get(i5)).f1608id, 0L)) {
                                    z7 = false;
                                    break;
                                }
                                i5++;
                    ...
                    DialogsActivity dialogsActivity = DialogsActivity.this;
                    ItemOptions addIf = ItemOptions.makeOptions(dialogsActivity, tabView).setScrimViewBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(6), 0, Theme.getColor(DialogsActivity.this.isArchive() ? Theme.key_actionBarDefaultArchived : Theme.key_actionBarDefault))).addFuturePlacement().addIf(!(z2 && DialogsActivity.this.isArchive()) && (!isSortingFilter || DialogsActivity.this.getFiltersController().getActiveSortingTabsCount(DialogsActivity.this.isArchive()) > 1) && !DialogsActivity.this.getFiltersController().isFoldersHidden() && DialogsActivity.this.getMessagesController().getDialogFilters().size() > 1, C3632R.C3634drawable.tabs_reorder, LocaleController.getString("FilterReorder", C3632R.string.FilterReorder), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda9
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$1(isSortingFilter);
                        }
                    }).addIf(!DialogsActivity.this.isArchive() && DialogsActivity.this.getMessagesController().dialogFilters.size() < DialogsActivity.this.getMessagesController().dialogFiltersLimitPremium, C3632R.C3634drawable.fork_create_folder, LocaleController.getInternalString(C3632R.string.dialogs_tab_popup_create_folder), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$2();
                        }
                    }).addIf(!z9, C3632R.C3634drawable.msg_settings, LocaleController.getInternalString(C3632R.string.dialogs_tab_popup_sorting_settings), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$3();
                        }
                    });
                    int i7 = C3632R.C3634drawable.msg_edit;
                    if (z2) {
                        i = C3632R.string.FilterEditAll;
                        str = "FilterEditAll";
                    } else {
                        i = C3632R.string.FilterEdit;
                        str = "FilterEdit";
                    }
                    ...
                    ItemOptions add = addIf.add(i7, (CharSequence) LocaleController.getString(str, i), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda10
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$4(z11, filterById);
                        }
                    }, z9, false);
                    boolean z12 = (isAlbumsDialogsType || filterById == null || arrayList.isEmpty()) ? false : true;
                    int i8 = z3 ? C3632R.C3634drawable.msg_mute : C3632R.C3634drawable.msg_unmute;
                    if (z3) {
                        i2 = C3632R.string.FilterMuteAll;
                        str2 = "FilterMuteAll";
                    } else {
                        i2 = C3632R.string.FilterUnmuteAll;
                        str2 = "FilterUnmuteAll";
                    }
                    dialogsActivity.filterOptions = add.addIf(z12, i8, LocaleController.getString(str2, i2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$5(arrayList, z3);
                        }
                    }).addIf(z10, C3632R.C3634drawable.msg_markread, (CharSequence) LocaleController.getString("MarkAllAsRead", C3632R.string.MarkAllAsRead), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$6(arrayList);
                        }
                    }, true).addIf(z4, C3632R.C3634drawable.msg_share, FilterCreateActivity.withNew((dialogFilter2 == null || !dialogFilter2.isMyChatlist()) ? 0 : -1, LocaleController.getString("LinkActionShare", C3632R.string.LinkActionShare), true), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda12
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$7(zArr, dialogFilter2);
                        }
                    }).addIf(z9, C3632R.C3634drawable.msg_stories_stealth, LocaleController.getString("HideOnTop", C3632R.string.HideOnTop), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda8
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$9(filterById);
                        }
                    }).addIf((z11 || isSortingFilter) ? false : true, C3632R.C3634drawable.msg_delete, (CharSequence) LocaleController.getString("FilterDeleteItem", C3632R.string.FilterDeleteItem), true, new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda7
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$10(filterById);
                        }
                    }).addIf((z9 || (z11 && (DialogsActivity.this.isArchive() || !DialogsActivity.this.getFiltersController().isAllChatsTabEnabled() || DialogsActivity.this.filterTabsView == null || DialogsActivity.this.filterTabsView.getTabsCount() == 2))) ? false : true, C3632R.C3634drawable.msg_disable, LocaleController.getInternalString(C3632R.string.dialogs_tab_popup_disable), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda11
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C609913.this.lambda$didSelectTab$12(z11, isSortingFilter, tabView);
                        }
                    }).setGravity(3).translate(AndroidUtilities.m107dp(-8), AndroidUtilities.m107dp(DialogsActivity.this.isFilterTabsAtBottom() ? 10 : -10)).show();
                    return true;
                }
        ...
        public /* synthetic */ void lambda$didSelectTab$5(ArrayList arrayList, boolean z) {
            ...
            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                ...
                if (tLRPC$Dialog != null) {
                    DialogsActivity.this.getNotificationsController().setDialogNotificationsSettings(tLRPC$Dialog.f1608id, 0L, z ? 3 : 4);
                    i++;
                }
            }
        ...
        public /* synthetic */ void lambda$didSelectTab$9(final MessagesController.DialogFilter dialogFilter) {
            DialogsActivity.this.getFiltersController().setHidden(dialogFilter.f1538id, true);
            UndoView undoView = DialogsActivity.this.getUndoView();
            if (undoView != null) {
                undoView.showInfo(LocaleController.getInternalString(C3632R.string.undo_folder_tabs_settings_hide_folder_info), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C609913.this.lambda$didSelectTab$8(dialogFilter);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void lambda$didSelectTab$8(MessagesController.DialogFilter dialogFilter) {
            DialogsActivity.this.getFiltersController().setHidden(dialogFilter.f1538id, false);
        }
        ...
        public /* synthetic */ void lambda$didSelectTab$12(boolean z, boolean z2, FilterTabsView.TabView tabView) {
            ...
            UndoView undoView = DialogsActivity.this.getUndoView();
            if (undoView != null) {
                undoView.showInfo(AndroidUtilities.replaceTags(LocaleController.getInternalString(C3632R.string.undo_all_chats_tab_disabled)), new Runnable() { // from class: org.telegram.ui.DialogsActivity$13$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C609913.this.lambda$didSelectTab$11();
                    }
                });
            }
        }
    ...
    public /* synthetic */ boolean lambda$createView$35(View view) {
        this.filterOptions = ItemOptions.makeOptions(this, this.switchItem).setViewAdditionalOffsets(-AndroidUtilities.m107dp(5), -AndroidUtilities.m107dp(5), -AndroidUtilities.m107dp(5), -AndroidUtilities.m107dp(5)).setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m107dp(46), Theme.getColor(Theme.key_actionBarDefault))).add(C3632R.C3634drawable.msg_disable, LocaleController.getString("Disable", C3632R.string.Disable), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda104
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createView$34();
            }
        }).translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(-4)).show();
        return true;
    }
    ...
    /* loaded from: classes5.dex */
    public class C610216 extends LinearLayoutManager {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C610216(Context context, ViewPage viewPage) {
            super(context);
        ...
        public void onScrollStateChanged(int i) {
            ...
            if (this.val$viewPage.listView.getScrollState() != 1) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$16$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        DialogsActivity.C610216.this.lambda$onScrollStateChanged$0(viewPage, valueAnimator2);
                    }
                });
                this.storiesOverscrollAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.16.1
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        C610216 c610216 = C610216.this;
                        DialogsActivity.this.setStoriesOvercroll(c610216.val$viewPage, BitmapDescriptorFactory.HUE_RED);
                    }
                });
        ...
        */
        public int scrollVerticallyBy(int r19, androidx.recyclerview.widget.RecyclerView.Recycler r20, androidx.recyclerview.widget.RecyclerView.State r21) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.C610216.scrollVerticallyBy(int, androidx.recyclerview.widget.RecyclerView$Recycler, androidx.recyclerview.widget.RecyclerView$State):int");
        }
        ...
        public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$16$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C610216.lambda$onLayoutChildren$1(DialogsActivity.ViewPage.this);
                    }
                });
            }
        }
        ...
        if (i2 == 15 && (view instanceof TextCell)) {
            ...
            if ((view instanceof DialogsHintCell) && (viewPage.dialogsType == 7 || viewPage.dialogsType == 8)) {
                ...
                if (chatlistUpdate != null) {
                    ...
                    if (dialogFilter != null) {
                        showDialog(new FolderBottomSheet(this, dialogFilter.f1538id, chatlistUpdate));
                        return;
                    }
                    return;
                }
    ...
    /* loaded from: classes5.dex */
    public class C611930 implements DialogsSearchAdapter.DialogsSearchAdapterDelegate {
        /* JADX INFO: Access modifiers changed from: private */
        ...
        public void clearTopPeers() {
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            builder.setTitle(LocaleController.getString("ChatHintsDeleteAlertTitle", C3632R.string.ChatHintsDeleteAlertTitle));
            builder.setMessage(LocaleController.getString("SuggestContactsAlert", C3632R.string.SuggestContactsAlert));
            builder.setPositiveButton(LocaleController.getString("MuteDisable", C3632R.string.MuteDisable), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda2
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.C611930.this.lambda$clearTopPeers$2(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), null);
            AlertDialog create = builder.create();
        ...
        public /* synthetic */ void lambda$clearTopPeers$2(DialogInterface dialogInterface, int i) {
            ...
            DialogsActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_contacts_toggleTopPeers, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda4
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    DialogsActivity.C611930.this.lambda$clearTopPeers$1(tLObject, tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$clearTopPeers$1(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            DialogsActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_contacts_toggleTopPeers, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda5
                ...
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error2) {
                    DialogsActivity.C611930.lambda$clearTopPeers$0(tLObject2, tLRPC$TL_error2);
                }
            });
        }
        ...
        public void needRemoveHint(final long j) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            builder.setTitle(LocaleController.getString("ChatHintsDeleteAlertTitle", C3632R.string.ChatHintsDeleteAlertTitle));
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("ChatHintsDeleteAlert", C3632R.string.ChatHintsDeleteAlert, ContactsController.formatName(user.first_name, user.last_name))));
            builder.setPositiveButton(LocaleController.getString("StickersRemove", C3632R.string.StickersRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda3
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.C611930.this.lambda$needRemoveHint$3(j, dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), null);
            AlertDialog create = builder.create();
        ...
        public void needClearList() {
            ...
            if (DialogsActivity.this.searchViewPager.dialogsSearchAdapter.isSearchWas() && DialogsActivity.this.searchViewPager.dialogsSearchAdapter.isRecentSearchDisplayed()) {
                builder.setTitle(LocaleController.getString("ClearSearchAlertPartialTitle", C3632R.string.ClearSearchAlertPartialTitle));
                ...
                builder.setPositiveButton(LocaleController.getString("Clear", C3632R.string.Clear), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        DialogsActivity.C611930.this.lambda$needClearList$4(dialogInterface, i);
                    }
                });
            } else {
                ...
                builder.setPositiveButton(LocaleController.getString("ClearButton", C3632R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$30$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        DialogsActivity.C611930.this.lambda$needClearList$5(dialogInterface, i);
                    }
                });
            }
            builder.setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$38(View view, int i, float f, float f2) {
    ...
    public /* synthetic */ void lambda$createView$42(ViewPage viewPage, SortingFilter sortingFilter, Set set) {
        ...
        if (viewPage.selectedType == this.filterTabsView.getDefaultTabId()) {
            ...
            FilterSettingsModel settings = getFiltersController().getSettings(getMessagesController().dialogFilters.get(viewPage.selectedType).f1538id);
    ...
    public /* synthetic */ void lambda$createView$48(View view) {
        ...
        if (this.initialDialogsType == 10) {
            ...
            for (int i = 0; i < this.selectedDialogs.size(); i++) {
                arrayList.add(MessagesStorage.TopicKey.m98of(this.selectedDialogs.get(i).longValue(), 0L));
            }
            ...
            if (filterFab != filterFab2 && filterFab != FilterFab.CREATE_STORY) {
                if (filterFab == FilterFab.ARCHIVE) {
                    ...
                    if (getTopicsController().hasSelectedTopic(isArchive())) {
                        showReadAllDialog(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda103
                            @Override // java.lang.Runnable
                            public final void run() {
                ...
                if (!getMessagesController().storiesEnabled()) {
                    UndoView undoView = getUndoView();
                    if (undoView != null) {
                        undoView.showError(LocaleController.getString("DialogNotAvailable", C3632R.string.DialogNotAvailable));
                        return;
                    }
                    return;
                }
    ...
    public /* synthetic */ boolean lambda$createView$53(View view) {
        ...
        this.filterOptions = ItemOptions.makeOptions(this, this.dialogsHintCell).setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundWhite))).add(C3632R.C3634drawable.fork_wallet_crypto_cipher_eye, LocaleController.getString("Hide", C3632R.string.Hide), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda89
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* loaded from: classes5.dex */
    public class C612637 implements RecentChatsBar.Delegate {
        C612637() {
        }
        ...
        public void onRecentChatLongClick(HistoryDialogModel historyDialogModel, View view) {
            ...
            if (dialogId == DialogsActivity.this.getUserConfig().getClientUserId() && sectionsPasscodeData != null && !sectionsPasscodeData.getPasscodeHash().isEmpty()) {
                DialogsActivity.this.showToast(LocaleController.getInternalString(C3632R.string.section_is_locked));
                return;
            }
            ActionBarPopupWindow.ActionBarPopupWindowLayout[] actionBarPopupWindowLayoutArr = {new ActionBarPopupWindow.ActionBarPopupWindowLayout(DialogsActivity.this.getParentActivity(), C3632R.C3634drawable.popup_fixed_alert, DialogsActivity.this.getResourceProvider(), 2)};
            ...
            if (historyDialogModel.isPinned()) {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("UnpinMessage", C3632R.string.UnpinMessage), C3632R.C3634drawable.msg_unpin);
            } else {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("PinMessage", C3632R.string.PinMessage), C3632R.C3634drawable.msg_pin);
            }
            ...
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda6
                ...
                public final void onClick(View view2) {
                    DialogsActivity.C612637.this.lambda$onRecentChatLongClick$0(dialogId, view2);
                }
            });
            ...
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("DeleteFromRecent", C3632R.string.DeleteFromRecent), C3632R.C3634drawable.msg_delete);
            ...
            actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.C612637.this.lambda$onRecentChatLongClick$2(dialogId, view2);
                }
            });
            ...
            actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("ClearRecentHistory", C3632R.string.ClearRecentHistory), C3632R.C3634drawable.msg_clear);
            ...
            actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.C612637.this.lambda$onRecentChatLongClick$3(view2);
                }
            });
            ...
            actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("Settings", C3632R.string.Settings), C3632R.C3634drawable.msg_settings);
            ...
            actionBarMenuSubItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.C612637.this.lambda$onRecentChatLongClick$5(view2);
                }
            });
            ...
            actionBarMenuSubItem5.setTextAndIcon(LocaleController.getString("Disable", C3632R.string.Disable), C3632R.C3634drawable.msg_disable);
            ...
            actionBarMenuSubItem5.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.C612637.this.lambda$onRecentChatLongClick$8(view2);
                }
            });
        ...
        public /* synthetic */ void lambda$onRecentChatLongClick$2(long j, View view) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612637.this.lambda$onRecentChatLongClick$1();
                }
            }, 150L);
        }
        ...
        public /* synthetic */ void lambda$onRecentChatLongClick$5(View view) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda10
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612637.this.lambda$onRecentChatLongClick$4();
                }
            }, 300L);
        }
        ...
        public /* synthetic */ void lambda$onRecentChatLongClick$8(View view) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612637.this.lambda$onRecentChatLongClick$7();
                }
            }, 150L);
        }
        ...
        public /* synthetic */ void lambda$onRecentChatLongClick$7() {
            ...
            UndoView undoView = DialogsActivity.this.getUndoView();
            if (undoView != null) {
                undoView.showInfo(LocaleController.getInternalString(C3632R.string.undo_recent_chats_disabled), new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C612637.this.lambda$onRecentChatLongClick$6();
                    }
                });
            }
        }
        ...
        private void showDeleteAlert() {
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            int i = C3632R.string.ClearHistory;
            builder.setTitle(LocaleController.getString("ClearHistory", i));
            builder.setMessage(LocaleController.getInternalString(C3632R.string.recent_chats_clear_history));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    DialogsActivity.C612637.this.lambda$showDeleteAlert$9(dialogInterface, i2);
                }
            });
            builder.setPositiveButton(LocaleController.getString("ClearHistory", i), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    DialogsActivity.C612637.this.lambda$showDeleteAlert$11(dialogInterface, i2);
                }
            });
            AlertDialog create = builder.create();
            DialogsActivity.this.showDialog(create);
        ...
        public /* synthetic */ void lambda$showDeleteAlert$11(DialogInterface dialogInterface, int i) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$37$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612637.this.lambda$showDeleteAlert$10();
                }
            }, 150L);
        }
    ...
    /* loaded from: classes5.dex */
    public class C612738 implements TopicsBar.Delegate {
        C612738() {
        }
        ...
        public boolean onTopicLongClick(TopicView topicView) {
            ...
            DialogsActivity dialogsActivity = DialogsActivity.this;
            ItemOptions scrimViewBackground = ItemOptions.makeOptions(dialogsActivity, topicView).setScrimViewBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(4), Theme.getColor(Theme.key_windowBackgroundWhite)));
            if (DialogsActivity.this.topicsBar.allowReorder() && !z2) {
                z = true;
            }
            int i = C3632R.C3634drawable.tabs_reorder;
            ItemOptions addIf = scrimViewBackground.addIf(z, i, LocaleController.getString("FilterReorder", C3632R.string.FilterReorder), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612738.this.lambda$onTopicLongClick$0();
                }
            }).add(C3632R.C3634drawable.msg_settings, LocaleController.getString("Settings", C3632R.string.Settings), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612738.this.lambda$onTopicLongClick$1();
                }
            }).addIf(!z2, C3632R.C3634drawable.msg_edit, LocaleController.getInternalString(C3632R.string.topic_edit), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612738.this.lambda$onTopicLongClick$2(topic);
                }
            }).addIf(!z2, C3632R.C3634drawable.msg_stories_stealth, LocaleController.getString("HideOnTop", C3632R.string.HideOnTop), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612738.this.lambda$onTopicLongClick$4(topic);
                }
            }).addIf(!z2, C3632R.C3634drawable.msg_delete, LocaleController.getString("Delete", C3632R.string.Delete), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612738.this.lambda$onTopicLongClick$5(topic);
                }
            });
            if (!DialogsActivity.this.getTopicsController().isNoTopicFirstEnabled()) {
                i = C3632R.C3634drawable.fork_move_to_beginning;
            }
            dialogsActivity.filterOptions = addIf.addIf(z2, i, LocaleController.getInternalString(DialogsActivity.this.getTopicsController().isNoTopicFirstEnabled() ? C3632R.string.topics_move_no_topic_to_end : C3632R.string.topics_move_no_topic_to_beginning), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612738.this.lambda$onTopicLongClick$7();
                }
            }).setGravity(3).translate(AndroidUtilities.m107dp(-8), AndroidUtilities.m107dp(DialogsActivity.this.getTopicsController().isTopicsBarAtBottomEnabled() ? 10 : -10)).show();
            return true;
        }
        ...
        public /* synthetic */ void lambda$onTopicLongClick$4(final TopicModel topicModel) {
            ...
            UndoView undoView = DialogsActivity.this.getUndoView();
            if (undoView != null) {
                undoView.showInfo(LocaleController.getInternalString(C3632R.string.undo_topic_hide_info), new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C612738.this.lambda$onTopicLongClick$3(topicModel);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void lambda$onTopicLongClick$7() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C612738.this.lambda$onTopicLongClick$6();
                }
            }, 300L);
        }
            ...
            if (j != -1) {
                ...
                if (DialogsActivity.this.selectedFilterIdToRestore == -1) {
                    ...
                    if (SortingFilter.isSortingFilter(DialogsActivity.this.isArchive(), currentTabId)) {
                        ...
                        DialogsActivity dialogsActivity = DialogsActivity.this;
                        dialogsActivity.selectedFilterIdToRestore = dialogsActivity.getMessagesController().dialogFilters.get(currentTabId).f1538id;
                    }
                }
            } else {
                DialogsActivity.this.hideFloatingButton(false);
        ...
        public void lambda$onTopicLongClick$5(final TopicModel topicModel) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DialogsActivity.this.getParentActivity());
            builder.setTitle(LocaleController.getInternalString(C3632R.string.topics_remove));
            builder.setMessage(LocaleController.getInternalString(C3632R.string.topics_remove_alert));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString("Delete", C3632R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$38$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.C612738.this.lambda$showDeleteAlert$8(topicModel, dialogInterface, i);
                }
            });
            AlertDialog create = builder.create();
            DialogsActivity.this.showDialog(create);
    ...
    /* loaded from: classes5.dex */
    public class C613645 extends DialogStoriesCell {
        C613645(Context context, BaseFragment baseFragment, int i, int i2) {
        ...
        public void onUserLongPressed(View view, final long j) {
            DialogsActivity dialogsActivity = DialogsActivity.this;
            dialogsActivity.filterOptions = ItemOptions.makeOptions(dialogsActivity, view).setViewAdditionalOffsets(0, AndroidUtilities.m107dp(8), 0, 0).setScrimViewBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(6), DialogsActivity.this.canShowFilterTabsView ? AndroidUtilities.m107dp(6) : 0, Theme.getColor(DialogsActivity.this.isArchive() ? Theme.key_actionBarDefaultArchived : Theme.key_actionBarDefault)));
            ...
            if (j == UserConfig.getInstance(((BaseFragment) DialogsActivity.this).currentAccount).getClientUserId()) {
                ...
                if (dialogsActivity2.storiesEnabled) {
                    ...
                    int i = C3632R.C3634drawable.msg_stories_add;
                    String string = LocaleController.getString("AddStory", C3632R.string.AddStory);
                    ...
                    itemOptions.add(i, string, i2, i3, new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C613645.this.lambda$onUserLongPressed$0();
                        }
                    });
                    DialogsActivity.this.filterOptions.add(C3632R.C3634drawable.msg_stories_archive, LocaleController.getString("ArchivedStories", C3632R.string.ArchivedStories), i2, i3, new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C613645.this.lambda$onUserLongPressed$1();
                        }
                    });
                    DialogsActivity.this.filterOptions.add(C3632R.C3634drawable.msg_stories_saved, LocaleController.getString("SavedStories", C3632R.string.SavedStories), i2, i3, new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C613645.this.lambda$onUserLongPressed$2();
                        }
                    });
                    DialogsActivity.this.filterOptions.addGap().add(C3632R.C3634drawable.msg_settings, LocaleController.getString("Settings", C3632R.string.Settings), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.C613645.this.lambda$onUserLongPressed$3();
                        }
                    });
                } else {
                ...
                DialogsActivity.this.filterOptions.addIf(i4 > 0, C3632R.C3634drawable.msg_discussion, LocaleController.getString("SendMessage", C3632R.string.SendMessage), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C613645.this.lambda$onUserLongPressed$4(j);
                    }
                }).addIf(i4 > 0, C3632R.C3634drawable.msg_openprofile, LocaleController.getString("OpenProfile", C3632R.string.OpenProfile), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C613645.this.lambda$onUserLongPressed$5(j);
                    }
                }).addIf(i4 < 0, C3632R.C3634drawable.msg_channel, LocaleController.getString("OpenChannel2", C3632R.string.OpenChannel2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C613645.this.lambda$onUserLongPressed$6(j);
                    }
                }).addIf(!z && i4 > 0, C3632R.C3634drawable.msg_mute, LocaleController.getString("NotificationsStoryMute2", C3632R.string.NotificationsStoryMute2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda11
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C613645.this.lambda$onUserLongPressed$7(sharedPrefKey, j);
                    }
                }).makeMultiline(false).addIf(z && i4 > 0, C3632R.C3634drawable.msg_unmute, LocaleController.getString("NotificationsStoryUnmute2", C3632R.string.NotificationsStoryUnmute2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda10
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C613645.this.lambda$onUserLongPressed$8(sharedPrefKey, j);
                    }
                }).makeMultiline(false).addIf(!DialogsActivity.this.isArchive(), C3632R.C3634drawable.msg_archive, LocaleController.getString("ArchivePeerStories", C3632R.string.ArchivePeerStories), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C613645.this.lambda$onUserLongPressed$9(j);
                    }
                }).makeMultiline(false).addIf(DialogsActivity.this.isArchive(), C3632R.C3634drawable.msg_unarchive, LocaleController.getString("UnarchiveStories", C3632R.string.UnarchiveStories), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C613645.this.lambda$onUserLongPressed$10(j);
                    }
                }).makeMultiline(false).addGap().add(C3632R.C3634drawable.msg_settings, LocaleController.getString("Settings", C3632R.string.Settings), new Runnable() { // from class: org.telegram.ui.DialogsActivity$45$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.C613645.this.lambda$onUserLongPressed$11();
                    }
                });
            }
            DialogsActivity.this.filterOptions.setGravity(3).translate(AndroidUtilities.m107dp(-8), AndroidUtilities.m107dp(-10)).show();
        }
        ...
        public /* synthetic */ void lambda$onUserLongPressed$4(long j) {
            DialogsActivity.this.presentFragment(ChatActivity.m68of(j));
        }
        ...
        public /* synthetic */ void lambda$onUserLongPressed$7(String str, long j) {
            ...
            BulletinFactory.m65of(DialogsActivity.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", C3632R.string.NotificationsStoryMutedHint, trim))).show();
        }
        ...
        public /* synthetic */ void lambda$onUserLongPressed$8(String str, long j) {
            ...
            BulletinFactory.m65of(DialogsActivity.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", C3632R.string.NotificationsStoryUnmutedHint, trim))).show();
        }
    ...
    public void setStoriesOvercroll(ViewPage viewPage, float f) {
        ...
        if (f <= AndroidUtilities.m107dp(90) || this.storiesOverscrollCalled) {
            return;
        }
        this.storiesOverscrollCalled = true;
        getOrCreateStoryViewer().doOnAnimationReady(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda81
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$toggleArciveForStory$64(final long j, final boolean z) {
        ...
        undoObject.onUndo = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda111
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$toggleArciveForStory$62(j, z);
            }
        };
        undoObject.onAction = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda110
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public float getActionBarMoveFrom(boolean z) {
        ...
        float f = BitmapDescriptorFactory.HUE_RED;
        if (z2) {
            f = BitmapDescriptorFactory.HUE_RED + AndroidUtilities.m107dp(81);
        }
        if (z) {
            f += AndroidUtilities.m107dp(44);
        }
    ...
    public int getMaxScrollYOffset() {
        if (this.hasStories) {
            return AndroidUtilities.m107dp(81);
        }
        return C3704ActionBar.getCurrentActionBarHeight();
    }
    ...
    public void showSelectStatusDialog() {
        ...
        if (titleTextView == null || titleTextView.getRightDrawable() == null) {
            ...
            int m107dp = (-(this.actionBar.getHeight() - rect.centerY())) - AndroidUtilities.m107dp(16);
            i = rect.centerX() - AndroidUtilities.m107dp(16);
            DrawerProfileCell.AnimatedStatusView animatedStatusView = this.animatedStatusView;
            if (animatedStatusView != null) {
        ...
        selectAnimatedEmojiDialogWindowArr[0].showAsDropDown(this.actionBar, AndroidUtilities.m107dp(16), i3, 48);
    ...
    public void showPremiumBlockedToast(View view, long j) {
        ...
        if (getMessagesController().premiumFeaturesBlocked()) {
            ...
            createSimpleBulletin = BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(C3632R.string.UserBlockedNonPremium, userName)), LocaleController.getString(C3632R.string.UserBlockedNonPremiumButton), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda95
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$showPremiumBlockedToast$65();
                }
            });
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showPremiumBlockedToast$65() {
    ...
    private void updateAuthHintCellVisibility(final boolean z) {
        if (this.authHintCellVisible != z) {
            ...
            final int i = r0;
            AndroidUtilities.doOnLayout(this.fragmentView, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda127
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$updateAuthHintCellVisibility$68(z, findFirstVisibleItemPosition, i, ofFloat);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateAuthHintCellVisibility$68(final boolean z, int i, int i2, ValueAnimator valueAnimator) {
        View findViewByPosition;
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda7
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DialogsActivity.this.lambda$updateAuthHintCellVisibility$67(measuredHeight, valueAnimator2);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateAuthHintCellVisibility$67(float f, ValueAnimator valueAnimator) {
    ...
    private void updateDialogsHint() {
        ...
        if (isInPreviewMode()) {
            ...
            this.dialogsHintCell.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString("BoostingPremiumChristmasTitle", C3632R.string.BoostingPremiumChristmasTitle), Theme.key_windowBackgroundWhiteValueText, 2, null), LocaleController.formatString("BoostingPremiumChristmasSubTitle", C3632R.string.BoostingPremiumChristmasSubTitle, new Object[0]));
            this.dialogsHintCell.setChristmasStyle(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda41
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.dialogsHintCell.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3632R.string.RestorePremiumHintTitle, MediaDataController.getInstance(this.currentAccount).getPremiumHintAnnualDiscount(false)), Theme.key_windowBackgroundWhiteValueText, 2, null), LocaleController.getString(C3632R.string.RestorePremiumHintMessage));
            updateAuthHintCellVisibility(false);
            ...
            this.dialogsHintCell.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(this.isPremiumHintUpgrade ? C3632R.string.SaveOnAnnualPremiumTitle : C3632R.string.UpgradePremiumTitle, MediaDataController.getInstance(this.currentAccount).getPremiumHintAnnualDiscount(false)), Theme.key_windowBackgroundWhiteValueText, 2, null), LocaleController.getString(this.isPremiumHintUpgrade ? C3632R.string.UpgradePremiumMessage : C3632R.string.SaveOnAnnualPremiumMessage));
            updateAuthHintCellVisibility(false);
            ...
            this.dialogsHintCell.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda33
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$updateDialogsHint$76(view);
                }
            });
            this.dialogsHintCell.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C3632R.string.ClearStorageHintTitle, AndroidUtilities.formatFileSize(this.cacheSize.longValue())), Theme.key_windowBackgroundWhiteValueText, 2, null), LocaleController.getString(C3632R.string.ClearStorageHintMessage));
            updateAuthHintCellVisibility(false);
        } else {
            this.dialogsHintCellVisible = false;
            this.dialogsHintCell.setVisibility(8);
    ...
    public /* synthetic */ void lambda$updateDialogsHint$70(View view) {
        ...
        updateDialogsHint();
        BulletinFactory.m65of(this).createSimpleBulletin(C3632R.raw.chats_infotip, LocaleController.getString("BoostingPremiumChristmasToast", C3632R.string.BoostingPremiumChristmasToast), 4).setDuration(DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS).show();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$76(View view) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda102
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$updateDialogsHint$75();
            }
        }, 250L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$75() {
    ...
    public void createGroupForThis() {
        ...
        if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeBroadcast) {
            ...
            channelCreateActivity.setOnFinishListener(new Utilities.Callback2() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda143
                @Override // org.telegram.messenger.Utilities.Callback2
                public final void run(Object obj, Object obj2) {
                    DialogsActivity.this.lambda$createGroupForThis$86(channelCreateActivity, alertDialog, (BaseFragment) obj, (Long) obj2);
                }
            });
            ...
            groupCreateFinalActivity.setDelegate(new C614652(alertDialog));
            presentFragment(groupCreateFinalActivity);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$86(final ChannelCreateActivity channelCreateActivity, final AlertDialog alertDialog, final BaseFragment baseFragment, final Long l) {
        Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda149
            ...
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$78(l, channelCreateActivity, baseFragment, (Runnable) obj);
            }
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda150
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$80(alertDialog, l, (Runnable) obj);
            }
            ...
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$84(l, (Runnable) obj);
            }
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda151
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$85(alertDialog, l, channelCreateActivity, baseFragment, (Runnable) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$78(Long l, final ChannelCreateActivity channelCreateActivity, final BaseFragment baseFragment, Runnable runnable) {
        showSendToBotAlert(getMessagesController().getChat(l), runnable, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda123
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$createGroupForThis$77(channelCreateActivity, baseFragment);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$77(ChannelCreateActivity channelCreateActivity, BaseFragment baseFragment) {
        removeSelfFromStack();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$80(AlertDialog alertDialog, Long l, final Runnable runnable) {
        alertDialog.showDelayed(150L);
        Boolean bool = this.requestPeerType.bot_participant;
        if (bool != null && bool.booleanValue()) {
            getMessagesController().addUserToChat(l.longValue(), getMessagesController().getUser(Long.valueOf(this.requestPeerBotId)), 0, null, this, false, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda136
    ...
    public /* synthetic */ void lambda$createGroupForThis$82(Long l, final Runnable runnable) {
        if (this.requestPeerType.bot_admin_rights != null) {
            ...
            messagesController.setUserAdminRole(longValue, user, tLRPC$TL_chatAdminRights, null, false, this, bool == null || !bool.booleanValue(), true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda138
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$createGroupForThis$83(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$85(AlertDialog alertDialog, Long l, ChannelCreateActivity channelCreateActivity, BaseFragment baseFragment, Runnable runnable) {
        alertDialog.dismiss();
        ...
        if (dialogsActivityDelegate != null) {
            ArrayList<MessagesStorage.TopicKey> arrayList = new ArrayList<>();
            arrayList.add(MessagesStorage.TopicKey.m98of(-l.longValue(), 0L));
    ...
    /* loaded from: classes5.dex */
    public class C614652 implements GroupCreateFinalActivity.GroupCreateFinalActivityDelegate {
        ...
        C614652(AlertDialog alertDialog) {
        ...
        public void didFinishChatCreation(GroupCreateFinalActivity groupCreateFinalActivity, final long j) {
            ...
            Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda8
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C614652.this.lambda$didFinishChatCreation$1(j, baseFragmentArr, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda7
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C614652.this.lambda$didFinishChatCreation$3(j, baseFragmentArr, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda9
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C614652.this.lambda$didFinishChatCreation$5(alertDialog, j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda6
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C614652.this.lambda$didFinishChatCreation$7(j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda5
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C614652.this.lambda$didFinishChatCreation$9(j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda10
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.C614652.this.lambda$didFinishChatCreation$10(alertDialog2, j, baseFragmentArr, (Runnable) obj);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$didFinishChatCreation$3(long j, final BaseFragment[] baseFragmentArr, Runnable runnable) {
            DialogsActivity.this.showSendToBotAlert(DialogsActivity.this.getMessagesController().getChat(Long.valueOf(j)), runnable, new Runnable() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.C614652.this.lambda$didFinishChatCreation$2(baseFragmentArr);
                }
            });
        }
            ...
            if (DialogsActivity.this.requestPeerType.bot_participant != null && DialogsActivity.this.requestPeerType.bot_participant.booleanValue()) {
                DialogsActivity.this.getMessagesController().addUserToChat(j, DialogsActivity.this.getMessagesController().getUser(Long.valueOf(DialogsActivity.this.requestPeerBotId)), 0, null, DialogsActivity.this, false, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda1
                    ...
                    public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                        ...
                        lambda$didFinishChatCreation$4 = DialogsActivity.C614652.lambda$didFinishChatCreation$4(runnable, tLRPC$TL_error);
            ...
            if (DialogsActivity.this.requestPeerType.bot_admin_rights != null) {
                ...
                messagesController.setUserAdminRole(j, user, tLRPC$TL_chatAdminRights, null, false, dialogsActivity, dialogsActivity.requestPeerType.bot_participant == null || !DialogsActivity.this.requestPeerType.bot_participant.booleanValue(), true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda2
                    ...
                    public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                        ...
                        lambda$didFinishChatCreation$6 = DialogsActivity.C614652.lambda$didFinishChatCreation$6(runnable, tLRPC$TL_error);
            ...
            if (DialogsActivity.this.requestPeerType.user_admin_rights != null) {
                DialogsActivity.this.getMessagesController().setUserAdminRole(j, DialogsActivity.this.getAccountInstance().getUserConfig().getCurrentUser(), ChatRightsEditActivity.rightsOR(DialogsActivity.this.getMessagesController().getChat(Long.valueOf(j)).admin_rights, DialogsActivity.this.requestPeerType.user_admin_rights), null, false, DialogsActivity.this, false, true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda3
                    ...
                    public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                        ...
                        lambda$didFinishChatCreation$8 = DialogsActivity.C614652.lambda$didFinishChatCreation$8(runnable, tLRPC$TL_error);
    ...
    private void updateAppUpdateViews(boolean z) {
        ...
        if (z2) {
            ...
            if (z) {
                ...
                this.updateLayoutAnimator.setInterpolator(CubicBezierInterpolator.EASE_OUT);
                this.updateLayoutAnimator.playTogether(ObjectAnimator.ofFloat(this.updateLayout, View.TRANSLATION_Y, AndroidUtilities.m107dp(48)));
            ...
            this.updateLayout.setTranslationY(AndroidUtilities.m107dp(48));
    ...
    public void updateContextViewPosition() {
        ...
        float m107dp = this.hasStories ? AndroidUtilities.m107dp(81) : 0.0f;
        if (this.hasStories) {
            float f3 = this.scrollYOffset;
            float f4 = this.searchAnimationProgress;
            f = (f3 * (1.0f - f4)) + (m107dp * (1.0f - f4)) + (measuredHeight * (1.0f - f4)) + (measuredHeight2 * f4) + this.tabsYOffset;
        } else {
        ...
        if (this.fragmentContextView != null) {
            ...
            float m107dp2 = (fragmentContextView == null || fragmentContextView.getVisibility() != 0) ? 0.0f : AndroidUtilities.m107dp(36) + BitmapDescriptorFactory.HUE_RED;
            FragmentContextView fragmentContextView2 = this.fragmentContextView;
            fragmentContextView2.setTranslationY(m107dp2 + fragmentContextView2.getTopPadding() + f7);
        }
        if (this.fragmentLocationContextView != null) {
            ...
            if (fragmentContextView3 != null && fragmentContextView3.getVisibility() == 0) {
                f2 = BitmapDescriptorFactory.HUE_RED + AndroidUtilities.m107dp(this.fragmentContextView.getStyleHeight()) + this.fragmentContextView.getTopPadding();
            }
    ...
    */
    ...
    private void createActionMode(String str) {
        ...
        this.selectedDialogsCountTextView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda62
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                boolean lambda$createActionMode$87;
                lambda$createActionMode$87 = DialogsActivity.lambda$createActionMode$87(view, motionEvent);
                return lambda$createActionMode$87;
            }
        });
        int i = C3632R.C3634drawable.msg_pin;
        this.pinItem = createActionMode.addItemWithWidth(100, i, AndroidUtilities.m107dp(54));
        this.muteItem = createActionMode.addItemWithWidth(104, C3632R.C3634drawable.msg_mute, AndroidUtilities.m107dp(54));
        int i2 = C3632R.C3634drawable.msg_archive;
        this.archive2Item = createActionMode.addItemWithWidth(107, i2, AndroidUtilities.m107dp(54));
        this.deleteItem = createActionMode.addItemWithWidth(102, C3632R.C3634drawable.msg_delete, AndroidUtilities.m107dp(54), LocaleController.getString("Delete", C3632R.string.Delete));
        ActionBarMenuItem addItemWithWidth = createActionMode.addItemWithWidth(0, C3632R.C3634drawable.ic_ab_other, AndroidUtilities.m107dp(54), LocaleController.getString("AccDescrMoreOptions", C3632R.string.AccDescrMoreOptions));
        this.archiveItem = addItemWithWidth.addSubItem(105, i2, LocaleController.getString("Archive", C3632R.string.Archive));
        this.pin2Item = addItemWithWidth.addSubItem(108, i, LocaleController.getString("DialogPin", C3632R.string.DialogPin));
        this.addToFolderItem = addItemWithWidth.addSubItem(109, C3632R.C3634drawable.msg_addfolder, LocaleController.getString("FilterAddTo", C3632R.string.FilterAddTo));
        this.removeFromFolderItem = addItemWithWidth.addSubItem(110, C3632R.C3634drawable.msg_removefolder, LocaleController.getString("FilterRemoveFrom", C3632R.string.FilterRemoveFrom));
        this.moveToFolderItem = addItemWithWidth.addSubItem(IdFabric$Menu.DIALOGS_MOVE_TO_FOLDER, C3632R.C3634drawable.fork_ic_replace_24, LocaleController.getInternalString(C3632R.string.dialogs_activity_move_to_folder));
        this.readItem = addItemWithWidth.addSubItem(101, C3632R.C3634drawable.msg_markread, LocaleController.getString("MarkAsRead", C3632R.string.MarkAsRead));
        this.clearItem = addItemWithWidth.addSubItem(103, C3632R.C3634drawable.msg_clear, LocaleController.getString("ClearHistory", C3632R.string.ClearHistory));
        this.blockItem = addItemWithWidth.addSubItem(106, C3632R.C3634drawable.msg_block, LocaleController.getString("BlockUser", C3632R.string.BlockUser));
        this.actionModeMenuGap = addItemWithWidth.addColoredGap();
        this.hiddenChatsItem = addItemWithWidth.addSubItem(IdFabric$Menu.TOGGLE_HIDDEN_CHATS, C3632R.C3634drawable.fork_filter_icon_mask, LocaleController.getInternalString(isHiddenChats() ? C3632R.string.hidden_chats_unhide_chats : C3632R.string.hidden_chats_hide_chats));
        this.selectTopicItem = addItemWithWidth.addSubItem(IdFabric$Menu.DIALOGS_SELECT_TOPIC, C3632R.C3634drawable.fork_topic_select_26, LocaleController.getInternalString(C3632R.string.topics_select));
        if (isHiddenChats()) {
        ...
        this.muteItem.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda55
            @Override // android.view.View.OnLongClickListener
            public final boolean onLongClick(View view) {
                boolean lambda$createActionMode$88;
                lambda$createActionMode$88 = DialogsActivity.this.lambda$createActionMode$88(view);
                return lambda$createActionMode$88;
            }
        });
        ...
        if (str == null) {
            this.actionBar.setActionBarMenuOnItemClick(new C615056());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createActionMode$88(View view) {
    ...
    /* loaded from: classes5.dex */
    public class C615056 extends C3704ActionBar.ActionBarMenuOnItemClick {
        C615056() {
        }
                ...
                if (i == i2 || i == IdFabric$Menu.DIALOGS_SCAN_LOGIN_QR_CODE) {
                    ...
                    if (i == IdFabric$Menu.DIALOGS_CHAT_SETTINGS) {
                        ...
                        dialogsActivity2.showDialog(new TopicsAlert(dialogsActivity3, dialogsActivity3.selectedDialogs, new Callbacks$Callback2() { // from class: org.telegram.ui.DialogsActivity$56$$ExternalSyntheticLambda0
                            @Override // com.iMe.fork.utils.Callbacks$Callback2
                            public final void invoke(Object obj, Object obj2) {
                                DialogsActivity.C615056.this.lambda$onItemClick$0((Boolean) obj, (TopicModel) obj2);
                            }
                        }));
                        ...
                        ((LaunchActivity) DialogsActivity.this.getParentActivity()).showPasscodeActivity(false, true, iArr[0] + (DialogsActivity.this.passcodeItem.getMeasuredWidth() / 2), iArr[1] + (DialogsActivity.this.passcodeItem.getMeasuredHeight() / 2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$56$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.C615056.this.lambda$onItemClick$1();
                            }
                        }, new Runnable() { // from class: org.telegram.ui.DialogsActivity$56$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.C615056.this.lambda$onItemClick$2();
                            }
                        });
                        ...
                        filtersListBottomSheet.setDelegate(new FiltersListBottomSheet.FiltersListBottomSheetDelegate() { // from class: org.telegram.ui.DialogsActivity$56$$ExternalSyntheticLambda3
                            @Override // org.telegram.p043ui.Components.FiltersListBottomSheet.FiltersListBottomSheetDelegate
                            public final void didSelectFilter(MessagesController.DialogFilter dialogFilter) {
                                DialogsActivity.C615056.this.lambda$onItemClick$3(dialogFilter);
                            }
                        });
                        ...
                        if (filterById.neverShow.size() + dialogsCount.size() > 100) {
                            DialogsActivity dialogsActivity8 = DialogsActivity.this;
                            dialogsActivity8.showDialog(AlertsCreator.createSimpleAlert(dialogsActivity8.getParentActivity(), LocaleController.getString("FilterAddToAlertFullTitle", C3632R.string.FilterAddToAlertFullTitle), LocaleController.getString("FilterAddToAlertFullText", C3632R.string.FilterAddToAlertFullText)).create());
                            return;
                        }
                        if (!dialogsCount.isEmpty()) {
        ...
        public /* synthetic */ void lambda$onItemClick$3(MessagesController.DialogFilter dialogFilter) {
            ...
            DialogsActivity dialogsActivity4 = DialogsActivity.this;
            DialogsActivity dialogsActivity5 = DialogsActivity.this;
            dialogsActivity4.showDialog(new LimitReachedBottomSheet(dialogsActivity5, dialogsActivity5.fragmentView.getContext(), 4, ((BaseFragment) DialogsActivity.this).currentAccount, null));
        }
    }
    ...
    public void scrollToFolder(int i) {
        ...
        while (true) {
            if (i2 >= dialogFilters.size()) {
                break;
            } else if (dialogFilters.get(i2).f1538id == i) {
                tabsCount = i2;
                break;
            } else {
                i2++;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:123:0x02a5, code lost:
        if (((getFiltersController().isFoldersHidden() ? 0 : (r2.size() - r6) - getFiltersController().getHiddenFiltersCount()) + r3.size()) == r6) goto L175;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateFilterTabs$89(int i) {
    ...
    public void onResume() {
        ...
        if ((this.afterSignup || getUserConfig().unacceptedTermsOfService == null) && this.checkPermission && !this.onlySelect && (i = Build.VERSION.SDK_INT) >= 23) {
            ...
            if (parentActivity != null) {
                ...
                final boolean z4 = z3;
                final boolean z5 = z;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda128
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.this.lambda$onResume$92(z4, z5, z2, parentActivity);
                    }
            ...
            showDialog(new AlertDialog.Builder(getParentActivity()).setTopAnimation(C3632R.raw.permission_request_apk, 72, false, Theme.getColor(Theme.key_dialogTopBackground)).setMessage(LocaleController.getString("PermissionXiaomiLockscreen", C3632R.string.PermissionXiaomiLockscreen)).setPositiveButton(LocaleController.getString("PermissionOpenSettings", C3632R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda19
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    DialogsActivity.this.lambda$onResume$93(dialogInterface, i3);
                }
            }).setNegativeButton(LocaleController.getString("ContactsPermissionAlertNotNow", C3632R.string.ContactsPermissionAlertNotNow), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda24
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    DialogsActivity.lambda$onResume$94(dialogInterface, i3);
                }
            }).create());
        }
        ...
        Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.DialogsActivity.57
            ...
            public int getTopOffset(int i4) {
                int i5 = 0;
                int topicsBarHeight = DialogsActivity.this.getTopicsBarHeight(true) + DialogsActivity.this.getRecentChatsBarHeight() + (((BaseFragment) DialogsActivity.this).actionBar != null ? ((BaseFragment) DialogsActivity.this).actionBar.getMeasuredHeight() : 0) + ((DialogsActivity.this.filterTabsView == null || DialogsActivity.this.filterTabsView.getVisibility() != 0 || DialogsActivity.this.isFilterTabsAtBottom()) ? 0 : DialogsActivity.this.filterTabsView.getMeasuredHeight()) + ((DialogsActivity.this.fragmentContextView == null || !DialogsActivity.this.fragmentContextView.isCallTypeVisible()) ? 0 : AndroidUtilities.m107dp(DialogsActivity.this.fragmentContextView.getStyleHeight())) + ((DialogsActivity.this.dialogsHintCell == null || DialogsActivity.this.dialogsHintCell.getVisibility() != 0) ? 0 : DialogsActivity.this.dialogsHintCell.getHeight()) + ((DialogsActivity.this.authHintCell == null || !DialogsActivity.this.authHintCellVisible) ? 0 : DialogsActivity.this.authHintCell.getHeight());
                DialogsActivity dialogsActivity = DialogsActivity.this;
                ...
                if (dialogStoriesCell2 != null && dialogsActivity.dialogStoriesCellVisible) {
                    i5 = (int) ((1.0f - dialogStoriesCell2.getCollapsedProgress()) * AndroidUtilities.m107dp(81));
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onResume$92(boolean z, boolean z2, boolean z3, final Activity activity) {
        if (getParentActivity() == null) {
            return;
        }
        ...
        if (z || z2 || z3) {
            ...
            if (z && NotificationPermissionDialog.shouldAsk(activity)) {
                Dialog notificationPermissionDialog = new NotificationPermissionDialog(activity, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda145
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        DialogsActivity.lambda$onResume$90(activity, (Boolean) obj);
                    }
                });
                ...
                AlertDialog create = AlertsCreator.createContactsPermissionDialog(activity, new MessagesStorage.IntCallback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda141
                    @Override // org.telegram.messenger.MessagesStorage.IntCallback
                    public final void run(int i) {
                        DialogsActivity.this.lambda$onResume$91(i);
                    }
                }).create();
                ...
                if (activity instanceof BasePermissionsActivity) {
                    AlertDialog createPermissionErrorAlert = ((BasePermissionsActivity) activity).createPermissionErrorAlert(C3632R.raw.permission_request_folder, LocaleController.getString(C3632R.string.PermissionStorageWithHint));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$onResume$90(Activity activity, Boolean bool) {
        if (bool.booleanValue()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onResume$91(int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onResume$93(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$onResume$94(DialogInterface dialogInterface, int i) {
    ...
    public void showArchiveHelp() {
        getContactsController().loadGlobalPrivacySetting();
        final BottomSheet[] bottomSheetArr = {new BottomSheet.Builder(getContext(), false, getResourceProvider()).setCustomView(new ArchiveHelp(getContext(), this.currentAccount, getResourceProvider(), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda130
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$showArchiveHelp$96(bottomSheetArr);
            }
        }, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda132
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.lambda$showArchiveHelp$97(bottomSheetArr);
            }
        }), 49).show()};
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showArchiveHelp$96(BottomSheet[] bottomSheetArr) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda87
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$showArchiveHelp$95();
            }
        }, 300L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showArchiveHelp$95() {
        presentFragment(new ArchiveSettingsActivity());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showArchiveHelp$97(BottomSheet[] bottomSheetArr) {
        if (bottomSheetArr[0] != null) {
            bottomSheetArr[0].dismiss();
            bottomSheetArr[0] = null;
        }
        ...
        if (isForward()) {
            if (this.forwardSpansByDialogIds.indexOfKey(j) >= 0) {
                ...
                groupCreateSpan.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda39
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        DialogsActivity.this.lambda$addOrRemoveSelectedDialog$98(view2);
                    }
                });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addOrRemoveSelectedDialog$98(View view) {
    ...
    private void showSearch(final boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z) {
            ...
            if (this.folderId != 0 && ((rightSlidingDialogContainer = this.rightSlidingDialogContainer) == null || !rightSlidingDialogContainer.hasFragment())) {
                addSearchFilter(new FiltersView.MediaFilterData(C3632R.C3634drawable.chats_archive, C3632R.string.ArchiveSearchFilter, (TLRPC$MessagesFilter) null, 7));
            }
        } else {
            updateDrawerSwipeEnabled();
        }
        ...
        if (z5) {
            ...
            if (this.hasStories) {
                float m107dp = AndroidUtilities.m107dp(81) + this.scrollYOffset;
            ...
            if (filterTabsView2 != null && filterTabsView2.getVisibility() == 0) {
                if (isForward()) {
                    ...
                    fArr12[0] = z ? -AndroidUtilities.m107dp(44) : 0.0f;
                    ...
                    fArr13[0] = z ? -AndroidUtilities.m107dp(44) : 0.0f;
                    ...
                    fArr16[0] = z ? AndroidUtilities.m107dp(44) : 0.0f;
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda3
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    DialogsActivity.this.lambda$showSearch$99(valueAnimator);
                }
            });
            arrayList.add(ofFloat);
            ...
            if (filterTabsView5 != null && filterTabsView5.getVisibility() == 0) {
                if (isFilterTabsAtBottom()) {
                    this.filterTabsView.setTranslationY(z ? AndroidUtilities.m107dp(44) : 0.0f);
                } else {
                    this.filterTabsView.setTranslationY(z ? -AndroidUtilities.m107dp(44) : 0.0f);
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSearch$99(ValueAnimator valueAnimator) {
    ...
    private void updateFilterTabsVisibility(boolean z) {
        ...
        if (this.filterTabsViewIsVisible != z3) {
            ...
            if (z) {
                ...
                this.filtersTabAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda10
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                        DialogsActivity.this.lambda$updateFilterTabsVisibility$100(z3, f, valueAnimator3);
                    }
                });
            ...
            if (z3) {
                ...
                int m107dp = AndroidUtilities.m107dp(44);
                if (translationY < (-m107dp)) {
                    translationY = m107dp;
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateFilterTabsVisibility$100(boolean z, float f, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    public void setSearchAnimationProgress(float f, boolean z) {
        ...
        if (this.whiteActionBar) {
            ...
            C3704ActionBar c3704ActionBar = this.actionBar;
            int i = Theme.key_actionBarActionModeDefaultIcon;
            c3704ActionBar.setItemsColor(ColorUtils.blendARGB(color, Theme.getColor(i), this.searchAnimationProgress), false);
                ...
                if (dialogFilter != null && (dialogFilter.flags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED) == 0 && ((abs > 0 && i2 >= getDialogsArray(this.currentAccount, viewPage.dialogsType, 1, this.dialogsListFrozen).size() - 10) || !getMessagesController().isDialogsEndReached(1))) {
                    ...
                    if (!z3 || z) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda129
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.this.lambda$checkListLoad$101(z3, z4, z, z2);
                            }
                        });
                    }
                    return;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkListLoad$101(boolean z, boolean z2, boolean z3, boolean z4) {
        if (z) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void onItemClick(View view, int i, RecyclerView.Adapter adapter, float f, float f2) {
        boolean z;
        int i2;
        int i3;
        int i4;
        ...
        if (z2) {
            ...
            if (dialogsType == 7 || dialogsType == 8) {
                i6 = getMessagesController().getSelectedDialogFilter(isForward(), isArchive())[dialogsType == 7 ? (char) 0 : (char) 1].f1538id;
            } else {
                i6 = 0;
            }
            TLObject item = dialogsAdapter.getItem(i);
            if (item instanceof TLRPC$User) {
                j6 = ((TLRPC$User) item).f1751id;
            } else if (item instanceof TLRPC$Dialog) {
                TLRPC$Dialog tLRPC$Dialog = (TLRPC$Dialog) item;
                i2 = tLRPC$Dialog.folder_id;
                if (tLRPC$Dialog instanceof TLRPC$TL_dialogFolder) {
                    if (this.actionBar.isActionModeShowed(null) || this.inPreviewMode) {
                        return;
                    }
                    Bundle bundle = new Bundle();
                    bundle.putInt("folderId", ((TLRPC$TL_dialogFolder) tLRPC$Dialog).folder.f1657id);
                    presentFragment(new DialogsActivity(bundle));
                    return;
                }
                j6 = tLRPC$Dialog.f1608id;
            ...
            if (adapter == dialogsSearchAdapter) {
                ...
                if (item2 instanceof TLRPC$User) {
                    ...
                    j2 = DialogObject.makeEncryptedDialogId(tLRPC$EncryptedChat.f1614id);
                    if (!this.onlySelect) {
                        this.searchDialogId = j2;
                        this.searchObject = tLRPC$EncryptedChat;
                    }
                } else {
                    if (item2 instanceof MessageObject) {
                        ...
                        if (item2 instanceof String) {
                            ...
                            if (this.searchViewPager.dialogsSearchAdapter.isHashtagSearch()) {
                                ...
                                if (str2.startsWith("searchByTel")) {
                                    getContactsController().searchAccountByTel(this, str2.replace("searchByTel", ""), new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda67
                                        @Override // com.iMe.fork.utils.Callbacks$Callback1
                                        public final void invoke(Object obj) {
                                            DialogsActivity.this.lambda$onItemClick$102((Long) obj);
                                        }
                                    }, new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda68
                                        @Override // com.iMe.fork.utils.Callbacks$Callback1
                                        public final void invoke(Object obj) {
                                            DialogsActivity.this.lambda$onItemClick$103((String) obj);
                                        }
                                    });
                                    return;
                                }
                            ...
                            j = ((TLRPC$TL_forumTopic) item2).f1658id;
                            i5 = 0;
                        }
                        i5 = 0;
                        j = 0;
                    ...
                    if (j2 == 0 && this.actionBar.isActionModeShowed()) {
                        if (this.actionBar.isActionModeShowed("search_dialogs_action_mode") && i5 == 0 && !z) {
        ...
        if (this.onlySelect) {
            if (validateSlowModeDialog(j2)) {
                if (!getMessagesController().isForum(j2) && (!this.selectedDialogs.isEmpty() || (this.initialDialogsType == 3 && this.selectAlertString != null))) {
                    ...
                    return;
                } else if (getMessagesController().isForum(j2) && !this.selectedDialogs.isEmpty()) {
                    Toast.makeText(getContext(), LocaleController.getInternalString(C3632R.string.forward_not_clicked_forum_toast), 0).show();
                    return;
        ...
        if (DialogObject.isEncryptedDialog(j2)) {
            ...
            if (i4 == 0 && j2 == getUserConfig().getClientUserId() && SharedConfig.isCloudAlbumsEnabled && getAlbumsController().isOpenAlbumsInsteadCloudEnabled()) {
                presentFragment(newInstanceInAlbumsMode());
                return;
            }
        ...
        boolean z4 = (LocaleController.isRTL || this.searching || (AndroidUtilities.isTablet() && i2 != 0) || !LiteMode.isEnabled(64)) ? false : true;
        bundle3.putInt("dialog_folder_id", i2);
        bundle3.putInt("dialog_filter_id", i3);
        if (AndroidUtilities.isTablet() && ((!getMessagesController().isForum(j2) || !z4) && this.openedDialogId.dialogId == j2 && adapter != this.searchViewPager.dialogsSearchAdapter)) {
        ...
        if (getMessagesController().checkCanOpenChat(bundle3, this)) {
            ...
            if (chat2 != null && chat2.forum && j == 0) {
                ...
                onPreviewChatOpened(bundle3);
            } else {
                ChatActivity chatActivity = new ChatActivity(bundle3);
                if (j != 0) {
                    ForumUtilities.applyTopic(chatActivity, MessagesStorage.TopicKey.m98of(j2, j));
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemClick$102(Long l) {
        presentFragment(ProfileActivity.newInstanceForDialogId(l.longValue()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemClick$103(String str) {
    ...
    public boolean onItemLongClick(RecyclerListView recyclerListView, View view, int i, float f, float f2, final int i2, final RecyclerView.Adapter adapter) {
        ...
        if (getParentActivity() != null && !(view instanceof DialogsHintCell) && !this.inPreviewMode) {
            ...
            if (rightSlidingDialogContainer == null || !rightSlidingDialogContainer.hasFragment()) {
                ...
                if (adapter == dialogsSearchAdapter) {
                    ...
                    if (isForward()) {
                        if (item instanceof TLRPC$Chat) {
                            ...
                            makeEncryptedDialogId2 = -tLRPC$Chat.f1602id;
                        } else if (item instanceof TLRPC$User) {
                            makeEncryptedDialogId2 = ((TLRPC$User) item).f1751id;
                        } else {
                            if (item instanceof TLRPC$EncryptedChat) {
                                makeEncryptedDialogId2 = DialogObject.makeEncryptedDialogId(((TLRPC$EncryptedChat) item).f1614id);
                            }
                            return false;
                        }
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                        builder.setTitle(LocaleController.getString("ClearSearchSingleAlertTitle", C3632R.string.ClearSearchSingleAlertTitle));
                        if (item instanceof TLRPC$Chat) {
                            TLRPC$Chat tLRPC$Chat2 = (TLRPC$Chat) item;
                            builder.setMessage(LocaleController.formatString("ClearSearchSingleChatAlertText", C3632R.string.ClearSearchSingleChatAlertText, tLRPC$Chat2.title));
                            makeEncryptedDialogId = -tLRPC$Chat2.f1602id;
                        } else if (item instanceof TLRPC$User) {
                            TLRPC$User tLRPC$User = (TLRPC$User) item;
                            if (tLRPC$User.f1751id == getUserConfig().clientUserId) {
                                builder.setMessage(LocaleController.formatString("ClearSearchSingleChatAlertText", C3632R.string.ClearSearchSingleChatAlertText, LocaleController.getString("SavedMessages", C3632R.string.SavedMessages)));
                            } else {
                                builder.setMessage(LocaleController.formatString("ClearSearchSingleUserAlertText", C3632R.string.ClearSearchSingleUserAlertText, ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name)));
                            }
                            makeEncryptedDialogId = tLRPC$User.f1751id;
                            ...
                            builder.setMessage(LocaleController.formatString("ClearSearchSingleUserAlertText", C3632R.string.ClearSearchSingleUserAlertText, ContactsController.formatName(user.first_name, user.last_name)));
                            makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(tLRPC$EncryptedChat.f1614id);
                        }
                        builder.setPositiveButton(LocaleController.getString("ClearSearchRemove", C3632R.string.ClearSearchRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda20
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i3) {
                                DialogsActivity.this.lambda$onItemLongClick$104(makeEncryptedDialogId, dialogInterface, i3);
                            }
                        });
                        builder.setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), null);
                        AlertDialog create = builder.create();
                ...
                if (this.onlySelect) {
                    if (getMessagesController().isForum(tLRPC$Dialog.f1608id)) {
                        return false;
                    }
                    int i3 = this.initialDialogsType;
                    if ((i3 == 3 || i3 == 10) && validateSlowModeDialog(tLRPC$Dialog.f1608id)) {
                        addOrRemoveSelectedDialog(tLRPC$Dialog.f1608id, view);
                        updateSelectedCount();
                        return true;
                    }
                    return false;
                    ...
                    showOrUpdateActionMode(tLRPC$Dialog.f1608id, view);
                    if (this.viewPages != null && (adapter instanceof DialogsAdapter) && (view instanceof DialogCell) && !isDialogPinned(tLRPC$Dialog) && (currentViewPage = getCurrentViewPage()) != null && currentViewPage.listView != null) {
                        final boolean z2 = !this.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog.f1608id));
                        ...
                        currentViewPage.listView.startMultiselect(fixPosition, false, new RecyclerListView.onMultiSelectionChanged() { // from class: org.telegram.ui.DialogsActivity.63
                            ...
                            public void onSelectionChanged(int i4, boolean z3, float f3, float f4) {
                                ...
                                if (z3 && DialogsActivity.this.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog2.f1608id))) {
                                    return;
                                }
                                if (z3 || DialogsActivity.this.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog2.f1608id))) {
                                    DialogsActivity.this.showOrUpdateActionMode(tLRPC$Dialog2.f1608id, null);
                                    DialogsActivity dialogsActivity2 = DialogsActivity.this;
                                    dialogsActivity2.findAndUpdateCheckBox(tLRPC$Dialog2.f1608id, dialogsActivity2.selectedDialogs.contains(Long.valueOf(tLRPC$Dialog2.f1608id)));
                                }
                            }
                            ...
                            public boolean canSelect(int i4) {
                                ...
                                if (z2 || arrayList.contains(Long.valueOf(tLRPC$Dialog2.f1608id))) {
                                    return z2 && arrayList.contains(Long.valueOf(tLRPC$Dialog2.f1608id));
                                }
                                return true;
                            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemLongClick$104(long j, DialogInterface dialogInterface, int i) {
    ...
    private void onArchiveLongPress(View view) {
        ...
        int[] iArr = new int[3];
        iArr[0] = z ? C3632R.C3634drawable.msg_markread : 0;
        iArr[1] = (!isArchive() ? SharedConfig.archiveHidden : getHiddenChatsController().isHiddenChatsHidden()) ? C3632R.C3634drawable.chats_unpin : C3632R.C3634drawable.chats_pin;
        iArr[2] = (SharedConfig.isShowDrawerHeaderArchiveEnabled || isArchive()) ? 0 : C3632R.C3634drawable.attach_arrow_left;
        CharSequence[] charSequenceArr = new CharSequence[3];
        String str2 = null;
        charSequenceArr[0] = z ? LocaleController.getString("MarkAllAsRead", C3632R.string.MarkAllAsRead) : null;
        if (!isArchive() ? SharedConfig.archiveHidden : getHiddenChatsController().isHiddenChatsHidden()) {
            i = C3632R.string.HideAboveTheList;
            str = "HideAboveTheList";
        } else {
            i = C3632R.string.PinInTheList;
            str = "PinInTheList";
        }
        charSequenceArr[1] = LocaleController.getString(str, i);
        if (!SharedConfig.isShowDrawerHeaderArchiveEnabled && !isArchive()) {
            str2 = LocaleController.getInternalString(C3632R.string.drawer_enable_archive_button);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onArchiveLongPress$105(DialogInterface dialogInterface, int i) {
        int i2 = 0;
        if (i == 2) {
            SharedConfig.setShowDrawerHeaderArchiveEnabled(true);
    ...
    public boolean showChatPreview(final DialogCell dialogCell, ProfileSearchCell profileSearchCell) {
        ...
        if (DialogObject.isUserDialog(dialogId)) {
            ...
            if (UserObject.isUserSelf(getMessagesController().getUser(Long.valueOf(dialogId))) && sectionsPasscodeData != null && !sectionsPasscodeData.getPasscodeHash().isEmpty()) {
                showToast(LocaleController.getInternalString(C3632R.string.section_is_locked));
                return false;
            }
        ...
        final ActionBarPopupWindow.ActionBarPopupWindowLayout[] actionBarPopupWindowLayoutArr = {new ActionBarPopupWindow.ActionBarPopupWindowLayout(getParentActivity(), C3632R.C3634drawable.popup_fixed_alert2, getResourceProvider(), 2)};
        ...
        if (dialogCell != null && dialogCell.getHasUnread()) {
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("MarkAsRead", C3632R.string.MarkAsRead), C3632R.C3634drawable.msg_markread);
        } else {
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("MarkAsUnread", C3632R.string.MarkAsUnread), C3632R.C3634drawable.msg_markunread);
        }
        actionBarMenuSubItem.setMinimumWidth(160);
        actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda50
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DialogsActivity.this.lambda$showChatPreview$106(dialogCell, dialogId, view);
            }
        });
        ...
        if (isDialogPinned(tLRPC$Dialog)) {
            ...
            while (true) {
                ...
                if (tLRPC$Dialog2 instanceof TLRPC$TL_dialogFolder) {
                    ...
                    arrayList = dialogs;
                    i5 = size;
                    if (DialogObject.isEncryptedDialog(tLRPC$Dialog2.f1608id)) {
                        i8++;
                    } else {
                        i7++;
                    }
                    ...
                    i5 = size;
                    chatActivityArr = chatActivityArr2;
                    if (!getMessagesController().isPromoDialog(tLRPC$Dialog2.f1608id, false)) {
                        break;
                    }
                    i6++;
                    dialogs = arrayList;
        ...
        if (zArr[r1]) {
            ...
            if (isDialogPinned(tLRPC$Dialog)) {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("UnpinMessage", C3632R.string.UnpinMessage), C3632R.C3634drawable.msg_unpin);
            } else {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("PinMessage", C3632R.string.PinMessage), C3632R.C3634drawable.msg_pin);
            }
            actionBarMenuSubItem2.setMinimumWidth(160);
            bundle = null;
            actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda49
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$showChatPreview$108(dialogFilter, tLRPC$Dialog, dialogId, view);
                }
            });
            actionBarPopupWindowLayoutArr[0].addView(actionBarMenuSubItem2);
        } else {
        ...
        if (DialogObject.isUserDialog(dialogId) && UserObject.isUserSelf(getMessagesController().getUser(Long.valueOf(dialogId)))) {
            ...
            if (!getMessagesController().isDialogMuted(dialogId, 0L)) {
                actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("Mute", C3632R.string.Mute), C3632R.C3634drawable.msg_mute);
            } else {
                actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString("Unmute", C3632R.string.Unmute), C3632R.C3634drawable.msg_unmute);
            }
            actionBarMenuSubItem3.setMinimumWidth(160);
            actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda46
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    DialogsActivity.this.lambda$showChatPreview$109(dialogId, view);
                }
            });
            z = false;
            actionBarPopupWindowLayoutArr[0].addView(actionBarMenuSubItem3);
        ...
        actionBarMenuSubItem4.setTextAndIcon(LocaleController.getString("Delete", C3632R.string.Delete), C3632R.C3634drawable.msg_delete);
        actionBarMenuSubItem4.setMinimumWidth(160);
        actionBarMenuSubItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda48
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DialogsActivity.this.lambda$showChatPreview$110(arrayList2, view);
            }
        });
        actionBarPopupWindowLayoutArr[0].addView(actionBarMenuSubItem4);
        if (getMessagesController().checkCanOpenChat(bundle2, this)) {
            ...
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda131
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$showChatPreview$111(chatActivityArr3, bundle2, actionBarPopupWindowLayoutArr);
                }
            };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$106(DialogCell dialogCell, long j, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$108(final MessagesController.DialogFilter dialogFilter, final TLRPC$Dialog tLRPC$Dialog, final long j, View view) {
        finishPreviewFragment();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda117
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$showChatPreview$107(dialogFilter, tLRPC$Dialog, j);
            }
        }, 100L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$107(MessagesController.DialogFilter dialogFilter, TLRPC$Dialog tLRPC$Dialog, long j) {
        boolean z;
        int i = Integer.MAX_VALUE;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$109(long j, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$110(ArrayList arrayList, View view) {
        performSelectedDialogsAction(arrayList, 102, false, false);
        finishPreviewFragment();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$111(ChatActivity[] chatActivityArr, Bundle bundle, ActionBarPopupWindow.ActionBarPopupWindowLayout[] actionBarPopupWindowLayoutArr) {
    ...
    public void updateFloatingButtonOffset() {
        ...
        if (frameLayout != null) {
            ...
            float f2 = BitmapDescriptorFactory.HUE_RED;
            frameLayout.setTranslationZ(f == BitmapDescriptorFactory.HUE_RED ? AndroidUtilities.m107dp(2) : 0.0f);
            if (isMainDialogList()) {
                FilterTabsView filterTabsView = this.filterTabsView;
                if (filterTabsView != null && filterTabsView.getVisibility() == 0 && isFilterTabsAtBottom()) {
                    f2 = (AndroidUtilities.m107dp(44) - this.filterTabsView.getTranslationY()) + BitmapDescriptorFactory.HUE_RED;
                }
        ...
        FrameLayout frameLayout2 = this.floatingButton2Container;
        if (frameLayout2 != null) {
            frameLayout2.setTranslationY(((this.floatingButtonTranslation - this.floatingButtonPanOffset) - (Math.max(this.additionalFloatingTranslation, this.additionalFloatingTranslation2) * (1.0f - this.floatingButtonHideProgress))) + (AndroidUtilities.m107dp(44) * this.floatingButtonHideProgress));
        }
    }
    ...
    private void checkAnimationFinished(final boolean z) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda125
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$checkAnimationFinished$112(z);
            }
        }, 300L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkAnimationFinished$112(boolean z) {
        ArrayList<TLRPC$Dialog> arrayList;
    ...
    public void setScrollY(float f) {
        ...
        if (animatedStatusView != null) {
            ...
            this.animatedStatusView.setAlpha(1.0f - ((-f) / C3704ActionBar.getCurrentActionBarHeight()));
        }
        View view = this.fragmentView;
        if (view != null) {
            view.invalidate();
    ...
    public void prepareBlurBitmap() {
        ...
        int m107dp = (getPinnedPlayerView() == null || getPinnedPlayerView().getVisibility() != 0) ? 0 : AndroidUtilities.m107dp(PinnedPlayerView.getPlayerHeight());
        int measuredWidth = (int) (this.fragmentView.getMeasuredWidth() / 6.0f);
        int measuredHeight = (int) ((m107dp + this.fragmentView.getMeasuredHeight()) / 6.0f);
    ...
    public void hideActionMode(boolean z) {
        ...
        if (this.menuDrawable != null) {
            this.actionBar.setBackButtonContentDescription(LocaleController.getString("AccDescrOpenMenu", C3632R.string.AccDescrOpenMenu));
        }
        ...
        if (this.hasStories) {
            ...
            f = Math.max((float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(81) + this.scrollYOffset);
        } else {
            f = 0.0f;
        }
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda5
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DialogsActivity.this.lambda$hideActionMode$113(f, valueAnimator2);
            }
        });
        this.actionBarColorAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.64
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (dialogsActivity.hasStories) {
                    ...
                    DialogsActivity.this.fixScrollYAfterArchiveOpened = true;
                    DialogsActivity.this.fragmentView.invalidate();
                    DialogsActivity.this.scrollAdditionalOffset = -(AndroidUtilities.m107dp(81) - f);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$hideActionMode$113(float f, ValueAnimator valueAnimator) {
        if (this.hasStories) {
    ...
    private int getPinnedCount() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (!(tLRPC$Dialog instanceof TLRPC$TL_dialogFolder)) {
                if (isDialogPinned(tLRPC$Dialog)) {
                    i++;
                } else if (!getMessagesController().isPromoDialog(tLRPC$Dialog.f1608id, false)) {
                    break;
                }
            }
        }
    ...
    public boolean isDialogPinned(TLRPC$Dialog tLRPC$Dialog) {
        if (tLRPC$Dialog == null || getHiddenChatsController().isChatHidden(tLRPC$Dialog.f1608id)) {
            return false;
        }
        MessagesController.DialogFilter dialogFilter = null;
        if ((this.viewPages[0].dialogsType == 7 || this.viewPages[0].dialogsType == 8) && (!this.actionBar.isActionModeShowed() || this.actionBar.isActionModeShowed(null))) {
        ...
        if (dialogFilter != null) {
            return dialogFilter.pinnedDialogs.indexOfKey(tLRPC$Dialog.f1608id) >= 0;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:485:0x029e A[SYNTHETIC] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void performSelectedDialogsAction(final java.util.ArrayList<java.lang.Long> r33, final int r34, boolean r35, boolean r36, boolean r37) {
        /*
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$114(List list, DialogInterface dialogInterface, int i) {
        hideOrUnhideChats(list);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$115(ArrayList arrayList) {
        getMessagesController().addDialogToFolder(arrayList, this.folderId == 0 ? 0 : 1, -1, null, 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$116(ArrayList arrayList) {
        getMessagesController().addDialogToFolder(arrayList, 1, -1, null, 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$performSelectedDialogsAction$117(boolean[] zArr, CheckBoxCell checkBoxCell, CheckBoxCell checkBoxCell2, View view) {
        zArr[0] = !zArr[0];
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$performSelectedDialogsAction$118(boolean[] zArr, CheckBoxCell checkBoxCell, View view) {
        zArr[0] = !zArr[0];
        checkBoxCell.toggle(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$120(ArrayList arrayList, final boolean[] zArr, boolean[] zArr2, final int i, DialogInterface dialogInterface, int i2) {
        if (arrayList.isEmpty()) {
            return;
        }
        ...
        UndoView undoView = getUndoView();
        if (undoView != null) {
            undoView.showWithAction(arrayList2, i == 102 ? 27 : 26, (Object) null, (Object) null, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda107
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$performSelectedDialogsAction$119(i, arrayList2, zArr);
                }
            }, (Runnable) null);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$119(int i, ArrayList arrayList, boolean[] zArr) {
        if (i == 102) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$121(AlertDialog alertDialog) {
        showDialog(alertDialog);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$122(ArrayList arrayList, boolean z, boolean z2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$123(DialogInterface dialogInterface, int i) {
        getMessagesController().hidePromoDialog();
        hideActionMode(false);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$125(final int i, final TLRPC$Chat tLRPC$Chat, final long j, final boolean z, final boolean z2) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if (i == 102) {
            ...
            if (this.frozenDialogsList != null) {
                ...
                while (i6 < this.frozenDialogsList.size()) {
                    if (this.frozenDialogsList.get(i6).f1608id == j) {
                        break;
                    }
                    i6++;
                }
        ...
        if (undoView != null) {
            i3 = i2;
            undoView.showWithAction(j, i == 103 ? 0 : 1, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda106
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$performSelectedDialogsAction$124(i, j, tLRPC$Chat, z, z2);
                }
            });
        } else {
            i3 = i2;
        ...
        while (true) {
            if (i7 >= arrayList2.size()) {
                ...
                i5 = -1;
                break;
            } else if (((TLRPC$Dialog) arrayList2.get(i7)).f1608id == j) {
                i5 = i7;
                i4 = 102;
                break;
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$126(DialogInterface dialogInterface) {
        hideActionMode(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$127(DialogInterface dialogInterface) {
        hideActionMode(true);
    }
            ...
            if (this.frozenDialogsList != null) {
                ...
                while (true) {
                    if (i2 >= this.frozenDialogsList.size()) {
                        break;
                    } else if (this.frozenDialogsList.get(i2).f1608id == j) {
                        i = i2;
                        break;
                    } else {
                        i2++;
    ...
    public void markDialogsAsRead(ArrayList<TLRPC$Dialog> arrayList) {
        ...
        checkAnimationFinished();
        for (int i = 0; i < arrayList.size(); i++) {
            long j = arrayList.get(i).f1608id;
    ...
    public void lambda$performSelectedDialogsAction$124(int i, long j, TLRPC$Chat tLRPC$Chat, boolean z, boolean z2) {
        if (i == 103) {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$pinDialog$128() {
        setDialogsListFrozen(false);
    }
    ...
    public void scrollToTop(boolean z, boolean z2, boolean z3) {
        ...
        int i2 = (z3 || !this.hasStories || z2 || this.dialogStoriesCell.isExpanded()) ? 0 : -AndroidUtilities.m107dp(81);
        if (z) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void updateCounters(boolean r24) {
        /*
    ...
    public boolean validateSlowModeDialog(long j) {
        ...
        if ((this.messagesCount > 1 || !((chatActivityEnterView = this.commentView) == null || chatActivityEnterView.getVisibility() != 0 || TextUtils.isEmpty(this.commentView.getFieldText()))) && DialogObject.isChatDialog(j) && (chat = getMessagesController().getChat(Long.valueOf(-j))) != null && !ChatObject.hasAdminRights(chat) && chat.slowmode_enabled) {
            AlertsCreator.showSimpleAlert(this, LocaleController.getString("Slowmode", C3632R.string.Slowmode), LocaleController.getString("SlowmodeSendError", C3632R.string.SlowmodeSendError));
            return false;
        }
        return true;
    }
    ...
    public void showOrUpdateActionMode(long j, View view) {
        ...
        if (this.actionBar.isActionModeShowed()) {
            ...
            if (this.menuDrawable != null) {
                this.actionBar.setBackButtonContentDescription(LocaleController.getString("AccDescrGoBack", C3632R.string.AccDescrGoBack));
            }
            if (getPinnedCount() > 1) {
                if (this.viewPages != null) {
                    int i = 0;
            ...
            if (!this.searchIsShowed) {
                ...
                for (int i2 = 0; i2 < this.actionModeViews.size(); i2++) {
                    ...
                    view2.setPivotY(C3704ActionBar.getCurrentActionBarHeight() / 2);
            ...
            if (z2) {
                ...
                float max = Math.max((float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(81) + this.scrollYOffset);
            ...
            this.actionBarColorAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.67
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    DialogsActivity dialogsActivity = DialogsActivity.this;
                    if (dialogsActivity.hasStories) {
                        dialogsActivity.scrollAdditionalOffset = AndroidUtilities.m107dp(81) - f;
                        DialogsActivity.this.viewPages[0].setTranslationY(BitmapDescriptorFactory.HUE_RED);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showOrUpdateActionMode$129(float f, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    public void createUndoView() {
        ...
        if (this.undoView[0] == null && (context = getContext()) != null) {
            for (int i = 0; i < 2; i++) {
                this.undoView[i] = new C616368(context);
    ...
    /* loaded from: classes5.dex */
    public class C616368 extends UndoView {
        C616368(Context context) {
            super(context);
        }
        ...
        public void setTranslationY(float f) {
            ...
            if (this == DialogsActivity.this.undoView[0]) {
                if (DialogsActivity.this.undoView[1] == null || DialogsActivity.this.undoView[1].getVisibility() != 0) {
                    DialogsActivity.this.additionalFloatingTranslation = (getMeasuredHeight() + AndroidUtilities.m107dp(8)) - f;
                    if (DialogsActivity.this.additionalFloatingTranslation < BitmapDescriptorFactory.HUE_RED) {
                        DialogsActivity.this.additionalFloatingTranslation = BitmapDescriptorFactory.HUE_RED;
                    }
                    if (DialogsActivity.this.floatingHidden) {
                ...
                if (DialogsActivity.this.frozenDialogsList != null) {
                    ...
                    while (true) {
                        if (i3 >= DialogsActivity.this.frozenDialogsList.size()) {
                            break;
                        } else if (((TLRPC$Dialog) DialogsActivity.this.frozenDialogsList.get(i3)).f1608id == j) {
                            i2 = i3;
                            break;
                        } else {
                            i3++;
                    ...
                    if (i2 >= 0) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$68$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.C616368.this.lambda$onRemoveDialogAction$0(i2, tLRPC$Dialog);
                            }
                        });
                    } else {
                        DialogsActivity.this.setDialogsListFrozen(false);
        ...
        if (this.commentView != null) {
            if (this.selectedDialogs.isEmpty()) {
                ...
                if ((this.initialDialogsType == 3 && this.selectAlertString == null) || isForward()) {
                    this.actionBar.setTitle(LocaleController.getString("ForwardTo", C3632R.string.ForwardTo));
                } else {
                    this.actionBar.setTitle(LocaleController.getString("SelectChat", C3632R.string.SelectChat));
                }
                ...
                if (this.forwardingOptionsButton != null) {
                    boolean isAllDialogsOfSameSecret = DialogObject.isAllDialogsOfSameSecret(this.selectedDialogs);
                    if (!isAllDialogsOfSameSecret) {
                        this.forwardingParams = null;
                    }
                    if (this.showForwardingOptionsButton != isAllDialogsOfSameSecret) {
                        this.showForwardingOptionsButton = isAllDialogsOfSameSecret;
                        this.commentView.setShowForwardSettingsButton(isAllDialogsOfSameSecret);
    ...
    private void askForPermissons(boolean z) {
        ...
        if (i >= 33 && NotificationPermissionDialog.shouldAsk(parentActivity)) {
            if (z) {
                showDialog(new NotificationPermissionDialog(parentActivity, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda144
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
        ...
        if (getUserConfig().syncContacts && this.askAboutContacts && parentActivity.checkSelfPermission("android.permission.READ_CONTACTS") != 0) {
            if (z) {
                AlertDialog create = AlertsCreator.createContactsPermissionDialog(parentActivity, new MessagesStorage.IntCallback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda140
                    @Override // org.telegram.messenger.MessagesStorage.IntCallback
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$askForPermissons$130(Activity activity, Boolean bool) {
        if (bool.booleanValue()) {
            activity.requestPermissions(new String[]{"android.permission.POST_NOTIFICATIONS"}, 1);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$askForPermissons$131(int i) {
        this.askAboutContacts = i != 0;
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.floatingButtonContainer.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: org.telegram.ui.DialogsActivity.73
            ...
            public void onGlobalLayout() {
                DialogsActivity dialogsActivity = DialogsActivity.this;
                dialogsActivity.floatingButtonTranslation = dialogsActivity.floatingHidden ? AndroidUtilities.m107dp(100) : BitmapDescriptorFactory.HUE_RED;
                DialogsActivity.this.updateFloatingButtonOffset();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onRequestPermissionsResultFragment$132() {
    ...
    public void didReceivedNotification(int i, int i2, final Object... objArr) {
        ...
        if (i == NotificationCenter.topicsSettingsChanged) {
            ...
            if (recentChatsBar != null && z2) {
                recentChatsBar.getLayoutParams().height = AndroidUtilities.m107dp(SharedConfig.isDialogsCompactModeEnabled ? 48 : 60);
            ...
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda118
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$didReceivedNotification$134(tLRPC$Chat, longValue3, booleanValue, tLRPC$User, z);
                }
            };
            createUndoView();
            ...
            if (i == i13) {
                ...
                while (true) {
                    ...
                    if (viewPage5 != null && ((viewPage5.dialogsType == 7 || viewPage5.dialogsType == 8) && (dialogFilter = getMessagesController().getSelectedDialogFilter(isForward(), isArchive())[viewPage5.dialogsType - 7]) != null && intValue2 == dialogFilter.f1538id)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didReceivedNotification$133(ViewPage viewPage, Object[] objArr) {
        reloadViewPageDialogs(viewPage, objArr.length > 0);
        FilterTabsView filterTabsView = this.filterTabsView;
        if (filterTabsView == null || filterTabsView.getVisibility() != 0) {
            return;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didReceivedNotification$134(TLRPC$Chat tLRPC$Chat, long j, boolean z, TLRPC$User tLRPC$User, boolean z2) {
        if (tLRPC$Chat != null) {
            if (ChatObject.isNotInChat(tLRPC$Chat)) {
    ...
    private boolean showSuggestion(String str) {
        if ("AUTOARCHIVE_POPULAR".equals(str)) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString("HideNewChatsAlertTitle", C3632R.string.HideNewChatsAlertTitle));
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("HideNewChatsAlertText", C3632R.string.HideNewChatsAlertText)));
            builder.setNegativeButton(LocaleController.getString("Cancel", C3632R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString("GoToSettings", C3632R.string.GoToSettings), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda16
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSuggestion$135(DialogInterface dialogInterface, int i) {
        presentFragment(new PrivacySettingsActivity());
        AndroidUtilities.scrollToFragmentRow(this.parentLayout, "newChatsRow");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSuggestion$136(DialogInterface dialogInterface) {
        onSuggestionDismiss();
    }
    ...
    public /* synthetic */ void lambda$showFiltersHint$138() {
        UndoView undoView = getUndoView();
        if (undoView != null) {
            undoView.showWithAction(0L, 15, null, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda91
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showFiltersHint$137() {
    ...
    private void setDialogsListFrozen(boolean z, boolean z2) {
        ...
        if (!this.viewPages[0].listView.isComputingLayout()) {
            ...
            this.viewPages[0].listView.post(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda79
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setDialogsListFrozen$139() {
        this.viewPages[0].dialogsAdapter.notifyDataSetChanged();
    }
    ...
    public ArrayList<TLRPC$Dialog> getDialogsArray(int i, int i2, int i3, boolean z) {
        ...
        if (!z || (arrayList = this.frozenDialogsList) == null) {
            ...
            if (isAlbumsDialogsType(i2)) {
                Collections.sort(messagesController.dialogsAlbumsOnly, new Comparator() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda133
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        int lambda$getDialogsArray$140;
                        lambda$getDialogsArray$140 = DialogsActivity.this.lambda$getDialogsArray$140(messagesController, (TLRPC$Dialog) obj, (TLRPC$Dialog) obj2);
                        return lambda$getDialogsArray$140;
                    }
                });
                ...
                if (i2 == 2) {
                    ...
                    if (messagesController.dialogsCanAddUsers.size() > 0) {
                        ...
                        for (int i4 = 0; i4 < size; i4++) {
                            ...
                            if ((this.allowChannels && ChatObject.isChannelAndNotMegaGroup(-tLRPC$Dialog.f1608id, i)) || (this.allowGroups && (ChatObject.isMegagroup(i, -tLRPC$Dialog.f1608id) || !ChatObject.isChannel(-tLRPC$Dialog.f1608id, i)))) {
                                if (z3) {
                        ...
                        if (i2 == 1 || i2 == 14) {
                            ...
                            if (this.allowUsers || this.allowBots) {
                                ...
                                while (it.hasNext()) {
                                    ...
                                    TLRPC$User user = messagesController.getUser(Long.valueOf(next.f1608id));
                            ...
                            if (this.allowGroups || ((z2 = this.allowLegacyGroups) && this.allowMegagroups)) {
                                ...
                                while (it2.hasNext()) {
                                    ...
                                    TLRPC$Chat chat = messagesController.getChat(Long.valueOf(-next2.f1608id));
                                ...
                                while (it3.hasNext()) {
                                    ...
                                    TLRPC$Chat chat2 = messagesController.getChat(Long.valueOf(-next3.f1608id));
                            ...
                            if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeUser) {
                                ...
                                while (it5.hasNext()) {
                                    ...
                                    if (meetRequestPeerRequirements(getMessagesController().getUser(Long.valueOf(next5.f1608id)))) {
                                        arrayList4.add(next5);
                                    }
                                }
                                for (TLRPC$User tLRPC$User : users.values()) {
                                    if (tLRPC$User != null && !messagesController.dialogs_dict.containsKey(tLRPC$User.f1751id) && meetRequestPeerRequirements(tLRPC$User)) {
                                ...
                                while (it6.hasNext()) {
                                    ...
                                    if (meetRequestPeerRequirements(user2, getMessagesController().getChat(Long.valueOf(-next6.f1608id)))) {
                                        arrayList4.add(next6);
                                    }
                                }
                                for (TLRPC$Chat tLRPC$Chat : chats.values()) {
                                    if (tLRPC$Chat != null && !messagesController.dialogs_dict.containsKey(-tLRPC$Chat.f1602id) && meetRequestPeerRequirements(user2, tLRPC$Chat)) {
                                        TLRPC$TL_dialog tLRPC$TL_dialog2 = new TLRPC$TL_dialog();
                                        if (ChatObject.isChannel(tLRPC$Chat)) {
                                            TLRPC$TL_peerChannel tLRPC$TL_peerChannel = new TLRPC$TL_peerChannel();
                                            tLRPC$TL_dialog2.peer = tLRPC$TL_peerChannel;
                                            tLRPC$TL_peerChannel.channel_id = tLRPC$Chat.f1602id;
                                        } else {
                                            TLRPC$TL_peerChat tLRPC$TL_peerChat = new TLRPC$TL_peerChat();
                                            tLRPC$TL_dialog2.peer = tLRPC$TL_peerChat;
                                            tLRPC$TL_peerChat.chat_id = tLRPC$Chat.f1602id;
                                        }
                                        tLRPC$TL_dialog2.f1608id = -tLRPC$Chat.f1602id;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ int lambda$getDialogsArray$140(MessagesController messagesController, TLRPC$Dialog tLRPC$Dialog, TLRPC$Dialog tLRPC$Dialog2) {
        TLRPC$Chat chat = messagesController.getChat(Long.valueOf(-tLRPC$Dialog.f1608id));
        TLRPC$Chat chat2 = messagesController.getChat(Long.valueOf(-tLRPC$Dialog2.f1608id));
    ...
    */
    ...
    public void hideFloatingButton(boolean z) {
        ...
        if (this.floatingHidden != z) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    DialogsActivity.this.lambda$hideFloatingButton$141(valueAnimator);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$hideFloatingButton$141(ValueAnimator valueAnimator) {
        this.floatingButtonHideProgress = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        this.floatingButtonTranslation = AndroidUtilities.m107dp(100) * this.floatingButtonHideProgress;
        updateFloatingButtonOffset();
    }
    ...
    public void animateContactsAlpha(float f) {
        ...
        this.contactsAlphaAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DialogsActivity.this.lambda$animateContactsAlpha$142(valueAnimator2);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$animateContactsAlpha$142(ValueAnimator valueAnimator) {
    ...
    public void setDelegate(DialogsActivityDelegate dialogsActivityDelegate) {
        ...
        if (dialogsActivityDelegate != null) {
            dialogsActivityDelegate.didSelectDialogs(null, null, null, false, null, new Callbacks$Callback1() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda69
                @Override // com.iMe.fork.utils.Callbacks$Callback1
                public final void invoke(Object obj) {
                    DialogsActivity.this.lambda$setDelegate$143((ArrayList) obj);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setDelegate$143(ArrayList arrayList) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void didSelectResult(final long r16, final int r18, boolean r19, final boolean r20, final org.telegram.p043ui.TopicsFragment r21) {
        /*
            Method dump skipped, instructions count: 648
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.didSelectResult(long, int, boolean, boolean, org.telegram.ui.TopicsFragment):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$146(final AlertDialog alertDialog, final TLRPC$User tLRPC$User, final TLRPC$Chat tLRPC$Chat, final long j, final boolean z, final TLRPC$TL_messages_checkHistoryImportPeer tLRPC$TL_messages_checkHistoryImportPeer, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda122
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$didSelectResult$145(alertDialog, tLObject, tLRPC$User, tLRPC$Chat, j, z, tLRPC$TL_error, tLRPC$TL_messages_checkHistoryImportPeer);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$145(AlertDialog alertDialog, TLObject tLObject, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, final long j, final boolean z, TLRPC$TL_error tLRPC$TL_error, TLRPC$TL_messages_checkHistoryImportPeer tLRPC$TL_messages_checkHistoryImportPeer) {
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
            FileLog.m102e(e);
        ...
        if (tLObject != null) {
            AlertsCreator.createImportDialogAlert(this, this.arguments.getString("importTitle"), ((TLRPC$TL_messages_checkedHistoryImportPeer) tLObject).confirm_text, tLRPC$User, tLRPC$Chat, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda112
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.this.lambda$didSelectResult$144(j, z);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$144(long j, boolean z) {
        setDialogsListFrozen(true);
        ArrayList<MessagesStorage.TopicKey> arrayList = new ArrayList<>();
        arrayList.add(MessagesStorage.TopicKey.m98of(j, 0L));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$147(long j, int i, TopicsFragment topicsFragment, DialogInterface dialogInterface, int i2) {
        didSelectResult(j, i, false, false, topicsFragment);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$148(long j, int i, boolean z, TopicsFragment topicsFragment) {
        if (this.delegate != null) {
            ArrayList<MessagesStorage.TopicKey> arrayList = new ArrayList<>();
            arrayList.add(MessagesStorage.TopicKey.m98of(j, i));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$150(long j, final Runnable runnable) {
        if (this.requestPeerType.bot_admin_rights != null) {
            getMessagesController().setUserAdminRole(-j, getMessagesController().getUser(Long.valueOf(this.requestPeerBotId)), this.requestPeerType.bot_admin_rights, null, false, this, true, true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda137
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$didSelectResult$149;
                    lambda$didSelectResult$149 = DialogsActivity.lambda$didSelectResult$149(runnable, tLRPC$TL_error);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$didSelectResult$149(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }
    ...
    private void showSendToBotAlert(TLRPC$User tLRPC$User, final Runnable runnable, final Runnable runnable2) {
        TLRPC$User user = getMessagesController().getUser(Long.valueOf(this.requestPeerBotId));
        showDialog(new AlertDialog.Builder(getContext()).setTitle(LocaleController.formatString(C3632R.string.AreYouSureSendChatToBotTitle, UserObject.getFirstName(tLRPC$User), UserObject.getFirstName(user))).setMessage(TextUtils.concat(AndroidUtilities.replaceTags(LocaleController.formatString(C3632R.string.AreYouSureSendChatToBotMessage, UserObject.getFirstName(tLRPC$User), UserObject.getFirstName(user))))).setPositiveButton(LocaleController.formatString("Send", C3632R.string.Send, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda14
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                runnable.run();
            }
        }).setNegativeButton(LocaleController.formatString("Cancel", C3632R.string.Cancel, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda12
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DialogsActivity.lambda$showSendToBotAlert$152(runnable2, dialogInterface, i);
            }
        }).create());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showSendToBotAlert$152(Runnable runnable, DialogInterface dialogInterface, int i) {
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public void showSendToBotAlert(TLRPC$Chat tLRPC$Chat, final Runnable runnable, final Runnable runnable2) {
        ...
        AlertDialog.Builder title = new AlertDialog.Builder(getContext()).setTitle(LocaleController.formatString(C3632R.string.AreYouSureSendChatToBotTitle, tLRPC$Chat.title, UserObject.getFirstName(user)));
        CharSequence[] charSequenceArr = new CharSequence[2];
        charSequenceArr[0] = AndroidUtilities.replaceTags(LocaleController.formatString(C3632R.string.AreYouSureSendChatToBotMessage, tLRPC$Chat.title, UserObject.getFirstName(user)));
        Boolean bool = this.requestPeerType.bot_participant;
        if ((bool == null || !bool.booleanValue() || getMessagesController().isInChatCached(tLRPC$Chat, user)) && this.requestPeerType.bot_admin_rights == null) {
            ...
            charSequenceArr2[0] = "\n\n";
            if (this.requestPeerType.bot_admin_rights == null) {
                formatString = LocaleController.formatString(C3632R.string.AreYouSureSendChatToBotAdd, UserObject.getFirstName(user), tLRPC$Chat.title);
            } else {
                formatString = LocaleController.formatString(C3632R.string.AreYouSureSendChatToBotAddRights, UserObject.getFirstName(user), tLRPC$Chat.title, RequestPeerRequirementsCell.rightsToString(this.requestPeerType.bot_admin_rights, isChannelAndNotMegaGroup));
            }
            charSequenceArr2[1] = AndroidUtilities.replaceTags(formatString);
            charSequence = TextUtils.concat(charSequenceArr2);
        }
        charSequenceArr[1] = charSequence;
        showDialog(title.setMessage(TextUtils.concat(charSequenceArr)).setPositiveButton(LocaleController.formatString("Send", C3632R.string.Send, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda13
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                runnable.run();
            }
        }).setNegativeButton(LocaleController.formatString("Cancel", C3632R.string.Cancel, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda11
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private boolean onSendLongClick(View view) {
        ...
        if (z || !this.selectedDialogs.contains(Long.valueOf(clientUserId))) {
            ...
            if (z) {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("SetReminder", C3632R.string.SetReminder), C3632R.C3634drawable.msg_calendar2);
            } else {
                actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("ScheduleMessage", C3632R.string.ScheduleMessage), C3632R.C3634drawable.msg_calendar2);
            }
            ...
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda47
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    DialogsActivity.this.lambda$onSendLongClick$156(parentActivity, view2);
                }
            });
        }
        ...
        if (getToolsController().isSilentSendingEnabled()) {
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getInternalString(C3632R.string.send_with_sound), C3632R.C3634drawable.input_notify_on);
        } else {
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString("SendWithoutSound", C3632R.string.SendWithoutSound), C3632R.C3634drawable.input_notify_off);
        }
        ...
        actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda31
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                DialogsActivity.this.lambda$onSendLongClick$157(view2);
            }
        });
        ...
        this.sendPopupWindow.showAtLocation(view, 51, ((iArr[0] + view.getMeasuredWidth()) - linearLayout.getMeasuredWidth()) + AndroidUtilities.m107dp(8), (iArr[1] - linearLayout.getMeasuredHeight()) - AndroidUtilities.m107dp(2));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSendLongClick$155(KeyEvent keyEvent) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSendLongClick$156(Activity activity, View view) {
        ...
        AlertsCreator.createScheduleDatePickerDialog(activity, 0L, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.DialogsActivity.77
            ...
            public void didSelectDate(boolean z, int i, String str) {
                ...
                for (int i2 = 0; i2 < DialogsActivity.this.selectedDialogs.size(); i2++) {
                    arrayList.add(MessagesStorage.TopicKey.m98of(((Long) DialogsActivity.this.selectedDialogs.get(i2)).longValue(), 0L));
                }
                DialogsActivityDelegate dialogsActivityDelegate = DialogsActivity.this.delegate;
                DialogsActivity dialogsActivity2 = DialogsActivity.this;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSendLongClick$157(View view) {
        ActionBarPopupWindow actionBarPopupWindow = this.sendPopupWindow;
        if (actionBarPopupWindow != null && actionBarPopupWindow.isShowing()) {
            this.sendPopupWindow.dismiss();
        }
    ...
    */
    public /* synthetic */ void lambda$getThemeDescriptions$158() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.DialogsActivity.lambda$getThemeDescriptions$158():void");
    }
    ...
    private void updateFloatingButtonColor() {
        ...
        if (this.floatingButton2Container != null) {
            ...
            Drawable createSimpleSelectorCircleDrawable2 = Theme.createSimpleSelectorCircleDrawable(m107dp, ColorUtils.blendARGB(Theme.getColor(i), -1, 0.1f), Theme.blendOver(Theme.getColor(i), Theme.getColor(Theme.key_listSelector)));
            if (Build.VERSION.SDK_INT < 21) {
                Drawable mutate2 = ContextCompat.getDrawable(getParentActivity(), C3632R.C3634drawable.floating_shadow).mutate();
                mutate2.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
                CombinedDrawable combinedDrawable2 = new CombinedDrawable(mutate2, createSimpleSelectorCircleDrawable2, 0, 0);
                combinedDrawable2.setIconSize(AndroidUtilities.m107dp(36), AndroidUtilities.m107dp(36));
    ...
    public Animator getCustomSlideTransition(boolean z, boolean z2, float f) {
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                DialogsActivity.this.lambda$getCustomSlideTransition$161(valueAnimator);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getCustomSlideTransition$161(ValueAnimator valueAnimator) {
    ...
    private void setFragmentIsSliding(boolean z) {
        ...
        if (z) {
            ...
            C3704ActionBar c3704ActionBar = this.actionBar;
            if (c3704ActionBar != null) {
                c3704ActionBar.setLayerType(2, null);
            }
            FilterTabsView filterTabsView = this.filterTabsView;
            if (filterTabsView != null) {
        ...
        if (c3704ActionBar2 != null) {
            c3704ActionBar2.setLayerType(0, null);
        }
        FilterTabsView filterTabsView2 = this.filterTabsView;
    ...
    private void setSlideTransitionProgress(float f) {
        ...
        if (this.slideFragmentLite) {
            FilterTabsView filterTabsView = this.filterTabsView;
            if (filterTabsView != null) {
                filterTabsView.getListView().setTranslationX((this.isDrawerTransition ? 1 : -1) * AndroidUtilities.m107dp(40) * (1.0f - this.slideFragmentProgress));
                this.filterTabsView.invalidate();
                while (i < 3) {
                    if (i == 0) {
                        TopicsBar topicsBar = this.topicsBar;
            ...
            if (dialogStoriesCell2 != null) {
                dialogStoriesCell2.setTranslationX((this.isDrawerTransition ? 1 : -1) * AndroidUtilities.m107dp(40) * (1.0f - this.slideFragmentProgress));
            }
            RightSlidingDialogContainer rightSlidingDialogContainer = this.rightSlidingDialogContainer;
            ...
            this.rightSlidingDialogContainer.getFragmentView().setTranslationX((this.isDrawerTransition ? 1 : -1) * AndroidUtilities.m107dp(40) * (1.0f - this.slideFragmentProgress));
            return;
        }
        ...
        if (filterTabsView2 != null) {
            ...
            this.filterTabsView.getListView().setTranslationX((this.isDrawerTransition ? AndroidUtilities.m107dp(4) : -AndroidUtilities.m107dp(4)) * (1.0f - this.slideFragmentProgress));
        ...
        if (dialogStoriesCell3 != null) {
            ...
            this.dialogStoriesCell.setTranslationX((this.isDrawerTransition ? AndroidUtilities.m107dp(4) : -AndroidUtilities.m107dp(4)) * (1.0f - this.slideFragmentProgress));
        ...
        if (!this.rightFragmentTransitionInProgress) {
            ...
            this.rightSlidingDialogContainer.getFragmentView().setTranslationX((this.isDrawerTransition ? AndroidUtilities.m107dp(4) : -AndroidUtilities.m107dp(4)) * (1.0f - this.slideFragmentProgress));
        }
    ...
    public List<FloatingDebugController.DebugItem> onGetDebugItems() {
        return Arrays.asList(new FloatingDebugController.DebugItem(LocaleController.getString(C3632R.string.DebugDialogsActivity)), new FloatingDebugController.DebugItem(LocaleController.getString(C3632R.string.ClearLocalDatabase), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda100
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$onGetDebugItems$162();
            }
        }), new FloatingDebugController.DebugItem(LocaleController.getString(C3632R.string.DebugClearSendMessageAsPeers), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda88
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$onGetDebugItems$162() {
        ...
        Toast.makeText(getContext(), LocaleController.getString(C3632R.string.DebugClearLocalDatabaseSuccess), 0).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onGetDebugItems$163() {
    ...
    public void updateStoriesVisibility(boolean z) {
            ...
            this.storiesVisibilityAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.81
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (!z2) {
                        ...
                        DialogsActivity.this.scrollAdditionalOffset = AndroidUtilities.m107dp(81);
                    } else {
                        DialogsActivity.this.scrollAdditionalOffset = -AndroidUtilities.m107dp(81);
                        DialogsActivity dialogsActivity2 = DialogsActivity.this;
        ...
        if (!z2) {
            ...
            this.scrollAdditionalOffset = -AndroidUtilities.m107dp(81);
            setScrollY(-getMaxScrollYOffset());
        }
        while (true) {
            ViewPage[] viewPageArr = this.viewPages;
