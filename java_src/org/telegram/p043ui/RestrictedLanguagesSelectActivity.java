...
import org.telegram.p043ui.Cells.TextCheckbox2Cell;
...
public class RestrictedLanguagesSelectActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("DoNotTranslate", C3473R.string.DoNotTranslate));
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.RestrictedLanguagesSelectActivity.1
        ...
        this.actionBar.createMenu().addItem(0, C3473R.C3475drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.RestrictedLanguagesSelectActivity.2
        ...
        emptyTextProgressView.setText(LocaleController.getString("NoResult", C3473R.string.NoResult));
    ...
    private void fillLanguages() {
        ...
        for (int i2 = 0; i2 < arrayList2.size(); i2++) {
            ...
            language3.f1494q = language3.code.toLowerCase();
    ...
    private void processSearch(String str) {
        ...
        for (int i = 0; i < this.allLanguages.size(); i++) {
            ...
            if (language.f1494q.startsWith(lowerCase)) {
                this.searchResult.add(0, language);
            } else if (language.f1494q.contains(lowerCase)) {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                headerCell2.setText(LocaleController.getString("ChooseLanguages", C3473R.string.ChooseLanguages));
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r6, int r7) {
            ...
            Lb:
                ...
                int r0 = org.telegram.messenger.C3473R.C3475drawable.greydivider
            ...
            L1e:
                android.view.View r6 = r6.itemView
                org.telegram.ui.Cells.TextCheckbox2Cell r6 = (org.telegram.p043ui.Cells.TextCheckbox2Cell) r6
                r0 = 0
                boolean r2 = r5.search
                r3 = 0
                if (r2 == 0) goto L51
                if (r7 < 0) goto L42
                org.telegram.ui.RestrictedLanguagesSelectActivity r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.access$400(r2)
                int r2 = r2.size()
                if (r7 >= r2) goto L42
                org.telegram.ui.RestrictedLanguagesSelectActivity r0 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r0 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.access$400(r0)
            ...
            L51:
                org.telegram.ui.RestrictedLanguagesSelectActivity r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.this
                int r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.access$500(r2)
                if (r2 < 0) goto L63
                org.telegram.ui.RestrictedLanguagesSelectActivity r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.this
                int r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.access$500(r2)
                if (r7 <= r2) goto L63
            ...
            L63:
                if (r7 < 0) goto L8b
                org.telegram.ui.RestrictedLanguagesSelectActivity r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.access$600(r2)
                int r2 = r2.size()
                if (r7 >= r2) goto L8b
                org.telegram.ui.RestrictedLanguagesSelectActivity r0 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r0 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.access$600(r0)
                java.lang.Object r0 = r0.get(r7)
                org.telegram.messenger.TranslateController$Language r0 = (org.telegram.messenger.TranslateController.Language) r0
                org.telegram.ui.RestrictedLanguagesSelectActivity r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r2 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.access$600(r2)
            ...
            L95:
                ...
                org.telegram.ui.RestrictedLanguagesSelectActivity r7 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.this
                java.util.HashSet r7 = org.telegram.p043ui.RestrictedLanguagesSelectActivity.access$700(r7)
            ...
            Laa:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.RestrictedLanguagesSelectActivity.ListAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
