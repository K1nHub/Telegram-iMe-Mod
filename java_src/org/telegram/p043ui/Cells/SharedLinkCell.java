...
public class SharedLinkCell extends FrameLayout {
    ...
    public SharedLinkCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.titleY = AndroidUtilities.m104dp(10);
        this.descriptionY = AndroidUtilities.m104dp(30);
        this.patchedDescriptionLayout = new AtomicReference<>();
        this.description2Y = AndroidUtilities.m104dp(30);
        this.patchedDescriptionLayout2 = new AtomicReference<>();
        this.captionY = AndroidUtilities.m104dp(30);
        this.fromInfoLayoutY = AndroidUtilities.m104dp(30);
        ...
        this.titleTextPaint.setTextSize(AndroidUtilities.m104dp(14));
        this.descriptionTextPaint.setTextSize(AndroidUtilities.m104dp(14));
        ...
        textPaint3.setTextSize(AndroidUtilities.m104dp(13));
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r17) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Cells.SharedLinkCell.onTouchEvent(android.view.MotionEvent):boolean");
    }

    private void startSpoilerRipples(int i, int i2, int i3) {
        int m104dp = AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline);
        resetPressedLink();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.dateLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? 0 : this.dateLayoutX), this.titleY);
            this.dateLayout.draw(canvas);
            canvas.restore();
        }
        if (this.titleLayout != null) {
            canvas.save();
            float m104dp = AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline);
            if (LocaleController.isRTL) {
                m104dp += this.dateLayout == null ? BitmapDescriptorFactory.HUE_RED : staticLayout.getWidth() + AndroidUtilities.m104dp(4);
            }
            canvas.translate(m104dp, this.titleY);
        ...
        if (this.captionLayout != null) {
            ...
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline), this.captionY);
        ...
        if (this.descriptionLayout != null) {
            ...
            SpoilerEffect.renderWithRipple(this, false, this.descriptionTextPaint.getColor(), -AndroidUtilities.m104dp(2), this.patchedDescriptionLayout, this.descriptionLayout, this.descriptionLayoutSpoilers, canvas, false);
            canvas.restore();
        }
        if (this.descriptionLayout2 != null) {
            this.descriptionTextPaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, this.resourcesProvider));
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline), this.description2Y);
            SpoilerEffect.renderWithRipple(this, false, this.descriptionTextPaint.getColor(), -AndroidUtilities.m104dp(2), this.patchedDescriptionLayout2, this.descriptionLayout2, this.descriptionLayout2Spoilers, canvas, false);
            canvas.restore();
        }
        if (!this.linkLayout.isEmpty()) {
            ...
            for (int i2 = 0; i2 < this.linkLayout.size(); i2++) {
                ...
                if (staticLayout2.getLineCount() > 0) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline), this.linkY + i);
                    this.path.rewind();
                    if (list != null) {
        ...
        if (this.fromInfoLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline), this.fromInfoLayoutY);
