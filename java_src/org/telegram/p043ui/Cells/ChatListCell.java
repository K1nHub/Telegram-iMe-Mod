...
public class ChatListCell extends LinearLayout {
    ...
    public class C3984ListView extends FrameLayout {
        ...
        public C3984ListView(ChatListCell chatListCell, Context context, boolean z, boolean z2) {
            ...
            layoutParams.bottomMargin = AndroidUtilities.m104dp(49);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            this.rect.set(AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(1), getMeasuredWidth() - AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(73));
            this.rect.bottom += AndroidUtilities.m104dp(32);
            ...
            this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m104dp(74));
            this.rect.bottom += AndroidUtilities.m104dp(30);
            ...
            if (this.isCompactMode) {
                int i4 = 0;
                while (i4 < 3) {
                    int m105dp = AndroidUtilities.m105dp(i4 != 0 ? 17.5f + (i4 * 19) : 17.5f);
                    Theme.dialogs_onlineCirclePaint.setColor(Color.argb((i4 == 0 || i4 == 2) ? 204 : 90, red, green, blue));
                    canvas.drawCircle(AndroidUtilities.m104dp(22), m105dp, AndroidUtilities.m105dp(7.5f), Theme.dialogs_onlineCirclePaint);
                    Theme.dialogs_onlineCirclePaint.setColor(Color.argb(204, red, green, blue));
                    this.rect.set(AndroidUtilities.m105dp(37.5f), m105dp - AndroidUtilities.m104dp(2), getMeasuredWidth() - AndroidUtilities.m105dp(14.5f), m105dp + AndroidUtilities.m104dp(2));
            ...
            int i5 = 0;
            while (i5 < 2) {
                int m104dp = AndroidUtilities.m104dp(i5 == 0 ? 21 : 53);
                Theme.dialogs_onlineCirclePaint.setColor(Color.argb(i5 == 0 ? i3 : 90, red, green, blue));
                canvas.drawCircle(AndroidUtilities.m104dp(i2), m104dp, AndroidUtilities.m104dp(11), Theme.dialogs_onlineCirclePaint);
                int i6 = 0;
                while (true) {
                    if (i6 < (this.isThreeLines ? 3 : 2)) {
                        ...
                        if (this.isThreeLines) {
                            float f = i6 * 7;
                            this.rect.set(AndroidUtilities.m104dp(41), m104dp - AndroidUtilities.m105dp(8.3f - f), getMeasuredWidth() - AndroidUtilities.m104dp(i6 != 0 ? 48 : 72), m104dp - AndroidUtilities.m105dp(5.3f - f));
                            this.rect.right = getMeasuredWidth() - AndroidUtilities.m104dp(i6 == 0 ? 22 : 11);
                            canvas.drawRoundRect(this.rect, AndroidUtilities.dpf2(1.5f), AndroidUtilities.dpf2(1.5f), Theme.dialogs_onlineCirclePaint);
                        } else {
                            int i7 = i6 * 10;
                            this.rect.set(AndroidUtilities.m104dp(41), m104dp - AndroidUtilities.m104dp(7 - i7), getMeasuredWidth() - AndroidUtilities.m104dp(i6 != 0 ? 48 : 72), m104dp - AndroidUtilities.m104dp(3 - i7));
                            this.rect.right = getMeasuredWidth() - AndroidUtilities.m104dp(i6 == 0 ? 22 : 11);
                            canvas.drawRoundRect(this.rect, AndroidUtilities.m104dp(2), AndroidUtilities.m104dp(2), Theme.dialogs_onlineCirclePaint);
                        }
                        i6++;
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(155), 1073741824));
    }
}
