...
public class ChatListCell extends LinearLayout {
    private C3989ListView[] listView;
    ...
    /* loaded from: classes5.dex */
    public class C3989ListView extends FrameLayout {
        ...
        public C3989ListView(ChatListCell chatListCell, Context context, boolean z, boolean z2) {
            super(context);
            int i;
            String str;
            this.rect = new RectF();
            ...
            layoutParams.bottomMargin = AndroidUtilities.m107dp(49);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            this.rect.set(AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1), getMeasuredWidth() - AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(73));
            this.rect.bottom += AndroidUtilities.m107dp(32);
            ...
            this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m107dp(74));
            this.rect.bottom += AndroidUtilities.m107dp(30);
            Theme.dialogs_onlineCirclePaint.setColor(Color.argb((int) ((1.0f - this.button.getProgress()) * 31.0f), red, green, blue));
            canvas.drawRoundRect(this.rect, AndroidUtilities.m107dp(6), AndroidUtilities.m107dp(6), Theme.dialogs_onlineCirclePaint);
            ...
            canvas.drawText(string, (getMeasuredWidth() - ((int) Math.ceil(this.textPaint.measureText(string)))) / 2, AndroidUtilities.m107dp(128), this.textPaint);
            int i2 = 22;
            int i3 = 204;
            if (this.isCompactMode) {
                int i4 = 0;
                while (i4 < 3) {
                    int m108dp = AndroidUtilities.m108dp(i4 != 0 ? 17.5f + (i4 * 19) : 17.5f);
                    Theme.dialogs_onlineCirclePaint.setColor(Color.argb((i4 == 0 || i4 == 2) ? 204 : 90, red, green, blue));
                    canvas.drawCircle(AndroidUtilities.m107dp(22), m108dp, AndroidUtilities.m108dp(7.5f), Theme.dialogs_onlineCirclePaint);
                    Theme.dialogs_onlineCirclePaint.setColor(Color.argb(204, red, green, blue));
                    this.rect.set(AndroidUtilities.m108dp(37.5f), m108dp - AndroidUtilities.m107dp(2), getMeasuredWidth() - AndroidUtilities.m108dp(14.5f), m108dp + AndroidUtilities.m107dp(2));
            ...
            int i5 = 0;
            while (i5 < 2) {
                int m107dp = AndroidUtilities.m107dp(i5 == 0 ? 21 : 53);
                Theme.dialogs_onlineCirclePaint.setColor(Color.argb(i5 == 0 ? i3 : 90, red, green, blue));
                canvas.drawCircle(AndroidUtilities.m107dp(i2), m107dp, AndroidUtilities.m107dp(11), Theme.dialogs_onlineCirclePaint);
                int i6 = 0;
                while (true) {
                    if (i6 < (this.isThreeLines ? 3 : 2)) {
                        ...
                        if (this.isThreeLines) {
                            float f = i6 * 7;
                            this.rect.set(AndroidUtilities.m107dp(41), m107dp - AndroidUtilities.m108dp(8.3f - f), getMeasuredWidth() - AndroidUtilities.m107dp(i6 != 0 ? 48 : 72), m107dp - AndroidUtilities.m108dp(5.3f - f));
                            this.rect.right = getMeasuredWidth() - AndroidUtilities.m107dp(i6 == 0 ? 22 : 11);
                            canvas.drawRoundRect(this.rect, AndroidUtilities.dpf2(1.5f), AndroidUtilities.dpf2(1.5f), Theme.dialogs_onlineCirclePaint);
                        } else {
                            int i7 = i6 * 10;
                            this.rect.set(AndroidUtilities.m107dp(41), m107dp - AndroidUtilities.m107dp(7 - i7), getMeasuredWidth() - AndroidUtilities.m107dp(i6 != 0 ? 48 : 72), m107dp - AndroidUtilities.m107dp(3 - i7));
                            this.rect.right = getMeasuredWidth() - AndroidUtilities.m107dp(i6 == 0 ? 22 : 11);
                            canvas.drawRoundRect(this.rect, AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2), Theme.dialogs_onlineCirclePaint);
                        }
                        i6++;
    ...
    public ChatListCell(Context context) {
        super(context);
        this.listView = new C3989ListView[3];
        setOrientation(0);
        setPadding(AndroidUtilities.m107dp(21), AndroidUtilities.m107dp(10), AndroidUtilities.m107dp(21), 0);
        int i = 0;
        while (true) {
            C3989ListView[] c3989ListViewArr = this.listView;
            if (i >= c3989ListViewArr.length) {
                return;
            }
            final boolean z = i == 0;
            final boolean z2 = i == 2;
            c3989ListViewArr[i] = new C3989ListView(this, context, z2, z);
    ...
    public /* synthetic */ void lambda$new$0(boolean z, boolean z2, View view) {
        ...
        while (true) {
            C3989ListView[] c3989ListViewArr = this.listView;
            if (i < c3989ListViewArr.length) {
                c3989ListViewArr[i].button.setChecked(this.listView[i] == view, true);
                i++;
            } else {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(155), 1073741824));
    }
}
