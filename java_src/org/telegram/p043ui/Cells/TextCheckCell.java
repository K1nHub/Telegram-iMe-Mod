...
public class TextCheckCell extends FrameLayout {
    ...
    public void setAnimationProgress(float f) {
        ...
        this.checkBox.setOverrideColorProgress(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.m107dp(40)) * this.animationProgress);
    }
    ...
    private float getLastTouchX() {
        if (this.isAnimatingToThumbInsteadOfTouch) {
            return LocaleController.isRTL ? AndroidUtilities.m107dp(22) : getMeasuredWidth() - AndroidUtilities.m107dp(42);
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.drawSwitchDivider) {
            int m107dp = AndroidUtilities.m107dp(this.height / 3);
            canvas.drawRect(getSwitchDividerX(), (getMeasuredHeight() - m107dp) / 2, switchDividerX + 2, measuredHeight + m107dp, Theme.dividerPaint);
        }
        if (this.animatedColorBackground != 0) {
            float lastTouchX = getLastTouchX();
            canvas.drawCircle(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.m107dp(40)) * this.animationProgress, this.animationPaint);
        }
        if (this.needDivider) {
            ...
            if (paint != null) {
                ...
                if (imageView != null) {
                    ...
                    canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? this.padding : 0), getMeasuredHeight() - 1, paint);
                    return;
                }
                if (!LocaleController.isRTL) {
                    f = AndroidUtilities.m107dp(20);
                }
                canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m107dp(20) : 0), getMeasuredHeight() - 1, paint);
            }
        }
    }
    ...
    public void setColorfullIcon(int i, int i2) {
        if (this.imageView == null) {
            ...
            this.padding = AndroidUtilities.m107dp(65);
