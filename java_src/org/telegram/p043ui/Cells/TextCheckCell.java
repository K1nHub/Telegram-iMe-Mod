...
public class TextCheckCell extends FrameLayout {
    ...
    public void setAnimationProgress(float f) {
        ...
        this.checkBox.setOverrideColorProgress(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.m104dp(40)) * this.animationProgress);
    }
    ...
    private float getLastTouchX() {
        if (this.isAnimatingToThumbInsteadOfTouch) {
            return LocaleController.isRTL ? AndroidUtilities.m104dp(22) : getMeasuredWidth() - AndroidUtilities.m104dp(42);
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.drawSwitchDivider) {
            int m104dp = AndroidUtilities.m104dp(this.height / 3);
            canvas.drawRect(getSwitchDividerX(), (getMeasuredHeight() - m104dp) / 2, switchDividerX + 2, measuredHeight + m104dp, Theme.dividerPaint);
        }
        if (this.animatedColorBackground != 0) {
            float lastTouchX = getLastTouchX();
            canvas.drawCircle(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.m104dp(40)) * this.animationProgress, this.animationPaint);
        }
        if (this.needDivider) {
            ...
            if (!LocaleController.isRTL) {
                f = AndroidUtilities.m104dp(20);
            }
            canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m104dp(20) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public void setColorfullIcon(int i, int i2) {
        if (this.imageView == null) {
            ...
            this.padding = AndroidUtilities.m104dp(65);
