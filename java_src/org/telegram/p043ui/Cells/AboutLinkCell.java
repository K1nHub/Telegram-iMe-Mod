...
public class AboutLinkCell extends FrameLayout {
    ...
    public AboutLinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.longPressedRunnable = new RunnableC38032();
        ...
        Drawable mutate = context.getResources().getDrawable(C3473R.C3475drawable.gradient_bottom).mutate();
        int i = Theme.key_windowBackgroundWhite;
        ...
        this.showMoreTextView.setText(LocaleController.getString("DescriptionMore", C3473R.string.DescriptionMore));
        ...
        Drawable mutate2 = context.getResources().getDrawable(C3473R.C3475drawable.gradient_left).mutate();
    ...
    /* loaded from: classes3.dex */
    public class RunnableC38032 implements Runnable {
        RunnableC38032() {
        }
        ...
        public void run() {
            if (AboutLinkCell.this.pressedLink != null) {
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3473R.string.Open), LocaleController.getString("Copy", C3473R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        AboutLinkCell.RunnableC38032.this.lambda$run$0(clickableSpan, layout, f, url, dialogInterface, i);
                    }
                });
                builder.setOnPreDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda1
                    ...
                    public final void onDismiss(DialogInterface dialogInterface) {
                        AboutLinkCell.RunnableC38032.this.lambda$run$1(dialogInterface);
                    }
                });
                builder.show();
        ...
        public /* synthetic */ void lambda$run$0(ClickableSpan clickableSpan, Layout layout, float f, String str, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    if (str.startsWith("@")) {
                        BulletinFactory.m32of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3473R.raw.copy, LocaleController.getString("UsernameCopied", C3473R.string.UsernameCopied)).show();
                    } else if (str.startsWith("#") || str.startsWith("$")) {
                        BulletinFactory.m32of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3473R.raw.copy, LocaleController.getString("HashtagCopied", C3473R.string.HashtagCopied)).show();
                    } else {
                        BulletinFactory.m32of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3473R.raw.copy, LocaleController.getString("LinkCopied", C3473R.string.LinkCopied)).show();
                    }
                }
            }
        }
    ...
    public void onLinkClick(ClickableSpan clickableSpan, Layout layout, float f) {
        ...
        if (layout != null && clickableSpan != null) {
            c38043 = new C38043(layout, clickableSpan, f);
        }
        this.currentProgress = c38043;
    ...
    /* loaded from: classes3.dex */
    public class C38043 extends Browser.Progress {
        ...
        C38043(Layout layout, ClickableSpan clickableSpan, float f) {
        ...
        public void end(boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.AboutLinkCell$3$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AboutLinkCell.C38043.this.lambda$end$0();
                }
            }, z ? 0L : 350L);
        }
