...
public class AboutLinkCell extends FrameLayout {
    private static final int COLLAPSED_HEIGHT = AndroidUtilities.m107dp(76);
    ...
    public AboutLinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.SPACE = AndroidUtilities.m108dp(3.0f);
        this.longPressedRunnable = new RunnableC39752();
        ...
        TextView textView2 = new TextView(this, context) { // from class: org.telegram.ui.Cells.AboutLinkCell.1
            ...
            protected void onDraw(Canvas canvas) {
                if (this.pressed) {
                    ...
                    canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), Theme.chat_urlPaint);
                }
                super.onDraw(canvas);
            }
        };
        ...
        this.showMoreTextView.setPadding(AndroidUtilities.m107dp(2), 0, AndroidUtilities.m107dp(2), 0);
        ...
        frameLayout2.setPadding(frameLayout2.getPaddingLeft() + AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(1), 0, AndroidUtilities.m107dp(3));
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(AndroidUtilities.m107dp(15), AndroidUtilities.m107dp(8), getWidth() - AndroidUtilities.m107dp(23), getHeight());
        ...
        this.textY = m107dp2;
        canvas.translate(BitmapDescriptorFactory.HUE_RED, m107dp2);
        try {
    ...
    public void setTextAndValue(String str, String str2, boolean z) {
        ...
        Emoji.replaceEmoji((CharSequence) this.stringBuilder, Theme.profile_aboutTextPaint.getFontMetricsInt(), AndroidUtilities.m107dp(20), false);
        if (this.lastMaxWidth <= 0) {
            this.lastMaxWidth = AndroidUtilities.displaySize.x - AndroidUtilities.m107dp(46);
        }
    ...
    /* loaded from: classes5.dex */
    public class RunnableC39752 implements Runnable {
        RunnableC39752() {
        }
            ...
            if (AboutLinkCell.this.pressedLink != null) {
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString("Open", C3632R.string.Open), LocaleController.getString("Copy", C3632R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        AboutLinkCell.RunnableC39752.this.lambda$run$0(clickableSpan, layout, f, url, dialogInterface, i);
                    }
                });
                builder.setOnPreDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda1
                    ...
                    public final void onDismiss(DialogInterface dialogInterface) {
                        AboutLinkCell.RunnableC39752.this.lambda$run$1(dialogInterface);
                    }
                });
                builder.show();
        ...
        public /* synthetic */ void lambda$run$0(ClickableSpan clickableSpan, Layout layout, float f, String str, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    if (str.startsWith("@")) {
                        BulletinFactory.m65of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3632R.raw.copy, LocaleController.getString("UsernameCopied", C3632R.string.UsernameCopied)).show();
                    } else if (str.startsWith("#") || str.startsWith("$")) {
                        BulletinFactory.m65of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3632R.raw.copy, LocaleController.getString("HashtagCopied", C3632R.string.HashtagCopied)).show();
                    } else {
                        BulletinFactory.m65of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C3632R.raw.copy, LocaleController.getString("LinkCopied", C3632R.string.LinkCopied)).show();
                    }
                }
            }
        }
    ...
    private LinkSpanDrawable hitLink(int i, int i2) {
        if (i < this.showMoreTextView.getLeft() || i > this.showMoreTextView.getRight() || i2 < this.showMoreTextView.getTop() || i2 > this.showMoreTextView.getBottom()) {
            if (getMeasuredWidth() <= 0 || i <= getMeasuredWidth() - AndroidUtilities.m107dp(23)) {
    ...
    public void onLinkClick(ClickableSpan clickableSpan, Layout layout, float f) {
        ...
        if (layout != null && clickableSpan != null) {
            c39763 = new C39763(layout, clickableSpan, f);
        }
        this.currentProgress = c39763;
    ...
    /* loaded from: classes5.dex */
    public class C39763 extends Browser.Progress {
        ...
        C39763(Layout layout, ClickableSpan clickableSpan, float f) {
        ...
        public void end(boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.AboutLinkCell$3$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AboutLinkCell.C39763.this.lambda$end$0();
                }
            }, z ? 0L : 350L);
        }
    ...
    private int fromHeight() {
        return Math.min(COLLAPSED_HEIGHT + (this.valueTextView.getVisibility() == 0 ? AndroidUtilities.m107dp(20) : 0), textHeight());
    }
    ...
    protected void onMeasure(int i, int i2) {
        checkTextLayout(View.MeasureSpec.getSize(i) - AndroidUtilities.m107dp(46), false);
    ...
    private void checkTextLayout(int i, boolean z) {
        ...
        if (spannableStringBuilder != null && (i != this.lastMaxWidth || z)) {
            ...
            if (this.shouldExpand && this.firstThreeLinesLayout != null) {
                int fromHeight = fromHeight() - AndroidUtilities.m107dp(8);
                StaticLayout staticLayout = this.firstThreeLinesLayout;
    ...
    private int textHeight() {
        ...
        int height = (staticLayout != null ? staticLayout.getHeight() : AndroidUtilities.m107dp(20)) + AndroidUtilities.m107dp(16);
        return this.valueTextView.getVisibility() == 0 ? height + AndroidUtilities.m107dp(23) : height;
    }
