...
public class AboutLinkCell extends FrameLayout {
    private static final int COLLAPSED_HEIGHT = AndroidUtilities.m104dp(76);
    ...
    public AboutLinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        TextView textView2 = new TextView(this, context) { // from class: org.telegram.ui.Cells.AboutLinkCell.1
            ...
            protected void onDraw(Canvas canvas) {
                if (this.pressed) {
                    ...
                    canvas.drawRoundRect(rectF, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), Theme.chat_urlPaint);
                }
                super.onDraw(canvas);
            }
        };
        ...
        frameLayout2.setPadding(frameLayout2.getPaddingLeft() + AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(1), 0, AndroidUtilities.m104dp(3));
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(AndroidUtilities.m104dp(15), AndroidUtilities.m104dp(8), getWidth() - AndroidUtilities.m104dp(23), getHeight());
        ...
        this.textY = m104dp2;
        canvas.translate(BitmapDescriptorFactory.HUE_RED, m104dp2);
        try {
    ...
    public void setTextAndValue(String str, String str2, boolean z) {
        ...
        Emoji.replaceEmoji((CharSequence) this.stringBuilder, Theme.profile_aboutTextPaint.getFontMetricsInt(), AndroidUtilities.m104dp(20), false);
        if (this.lastMaxWidth <= 0) {
            this.lastMaxWidth = AndroidUtilities.displaySize.x - AndroidUtilities.m104dp(46);
        }
    ...
    private LinkSpanDrawable hitLink(int i, int i2) {
        if (i < this.showMoreTextView.getLeft() || i > this.showMoreTextView.getRight() || i2 < this.showMoreTextView.getTop() || i2 > this.showMoreTextView.getBottom()) {
            if (getMeasuredWidth() <= 0 || i <= getMeasuredWidth() - AndroidUtilities.m104dp(23)) {
    ...
    private int fromHeight() {
        return Math.min(COLLAPSED_HEIGHT + (this.valueTextView.getVisibility() == 0 ? AndroidUtilities.m104dp(20) : 0), textHeight());
    }
    ...
    protected void onMeasure(int i, int i2) {
        checkTextLayout(View.MeasureSpec.getSize(i) - AndroidUtilities.m104dp(46), false);
    ...
    private void checkTextLayout(int i, boolean z) {
        ...
        if (spannableStringBuilder != null && (i != this.lastMaxWidth || z)) {
            ...
            if (this.shouldExpand && this.firstThreeLinesLayout != null) {
                int fromHeight = fromHeight() - AndroidUtilities.m104dp(8);
                StaticLayout staticLayout = this.firstThreeLinesLayout;
    ...
    private int textHeight() {
        ...
        int height = (staticLayout != null ? staticLayout.getHeight() : AndroidUtilities.m104dp(20)) + AndroidUtilities.m104dp(16);
        return this.valueTextView.getVisibility() == 0 ? height + AndroidUtilities.m104dp(23) : height;
    }
