...
public class StickerEmojiCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, RecyclerListViewWithOverlayDraw.OverlayView {
        ...
        if (importingSticker != null) {
            ...
            if (tLRPC$Document != null) {
                ...
                if (str != null) {
                    ...
                    z3 = false;
                    if (!z3) {
                        this.emojiTextView.setText(Emoji.replaceEmoji(MediaDataController.getInstance(this.currentAccount).getEmojiForSticker(this.sticker.f1530id), this.emojiTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m72dp(16), false));
                    }
                    this.emojiTextView.setVisibility(0);
                } else {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        String string = LocaleController.getString("AttachSticker", C3473R.string.AttachSticker);
