...
public class StickerEmojiCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, RecyclerListViewWithOverlayDraw.OverlayView {
    ...
    public void setSticker(TLRPC$Document tLRPC$Document, SendMessagesHelper.ImportingSticker importingSticker, Object obj, String str, boolean z) {
        ...
        if (importingSticker != null) {
            ...
            if (str != null) {
                ...
                textView.setText(Emoji.replaceEmoji((CharSequence) str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(16), false));
            ...
            if (tLRPC$Document != null) {
                ...
                if (str != null) {
                    ...
                    textView2.setText(Emoji.replaceEmoji((CharSequence) str, textView2.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(16), false));
                    this.emojiTextView.setVisibility(0);
                } else if (z) {
                    int i2 = 0;
                    while (true) {
                        ...
                        if (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeSticker) {
                            ...
                            if (str3 != null && str3.length() > 0) {
                                ...
                                textView3.setText(Emoji.replaceEmoji((CharSequence) tLRPC$DocumentAttribute.alt, textView3.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(16), false));
                                z3 = true;
                            }
                        } else {
                            i2++;
                    ...
                    z3 = false;
                    if (!z3) {
                        this.emojiTextView.setText(Emoji.replaceEmoji((CharSequence) MediaDataController.getInstance(this.currentAccount).getEmojiForSticker(this.sticker.f1610id), this.emojiTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(16), false));
                    }
                    this.emojiTextView.setVisibility(0);
                } else {
            ...
            while (true) {
                ...
                if (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeSticker) {
                    ...
                    if (str != null && str.length() > 0) {
                        TextView textView = this.emojiTextView;
                        textView.setText(Emoji.replaceEmoji((CharSequence) tLRPC$DocumentAttribute.alt, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(16), false));
    ...
    @Override // org.telegram.p043ui.Components.ListView.RecyclerListViewWithOverlayDraw.OverlayView
    ...
    private void drawInternal(View view, Canvas canvas) {
        ...
        int min = Math.min(AndroidUtilities.m104dp(66), Math.min(getMeasuredHeight(), getMeasuredWidth()));
