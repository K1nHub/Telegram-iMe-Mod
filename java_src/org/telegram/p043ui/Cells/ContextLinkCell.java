    ...
    */
        ...
        if (!this.mediaWebpage) {
            ...
            if (i2 == 3 || i2 == 5) {
                ...
                if (tLRPC$BotInlineResult != null && tLRPC$BotInlineResult.type.equals("file")) {
                    ...
                    canvas.drawRect(this.linkImageView.getImageX(), this.linkImageView.getImageY(), AndroidUtilities.m72dp(52) + this.linkImageView.getImageX(), this.linkImageView.getImageY() + AndroidUtilities.m72dp(52), LetterDrawable.paint);
    ...
    public void updateButtonState(boolean z, boolean z2) {
        ...
        if (str == null && !this.resolvingFileName) {
            ...
            Utilities.searchQueue.postRunnable(new RunnableC37741(i, z));
    ...
    /* loaded from: classes5.dex */
    public class RunnableC37741 implements Runnable {
        final /* synthetic */ boolean val$ifSame;
        final /* synthetic */ int val$localId;

        RunnableC37741(int i, boolean z) {
            this.val$localId = i;
            this.val$ifSame = z;
        }
        ...
        */
        public void run() {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Cells.ContextLinkCell.RunnableC37741.run():void");
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        switch (this.documentAttachType) {
            case 1:
                sb.append(LocaleController.getString("AttachDocument", C3419R.string.AttachDocument));
                break;
            case 2:
                sb.append(LocaleController.getString("AttachGif", C3419R.string.AttachGif));
                break;
            case 3:
                sb.append(LocaleController.getString("AttachAudio", C3419R.string.AttachAudio));
                break;
            case 4:
                sb.append(LocaleController.getString("AttachVideo", C3419R.string.AttachVideo));
                break;
            case 5:
                sb.append(LocaleController.getString("AttachMusic", C3419R.string.AttachMusic));
                break;
            case 6:
                sb.append(LocaleController.getString("AttachSticker", C3419R.string.AttachSticker));
                break;
            case 7:
                sb.append(LocaleController.getString("AttachPhoto", C3419R.string.AttachPhoto));
                break;
            case 8:
                sb.append(LocaleController.getString("AttachLocation", C3419R.string.AttachLocation));
                break;
        }
        ...
        if (this.documentAttachType == 5 && z && z2) {
            sb.append(", ");
            sb.append(LocaleController.formatString("AccDescrMusicInfo", C3419R.string.AccDescrMusicInfo, this.descriptionLayout.getText(), this.titleLayout.getText()));
        } else {
            if (z) {
                if (sb.length() > 0) {
                    sb.append(", ");
