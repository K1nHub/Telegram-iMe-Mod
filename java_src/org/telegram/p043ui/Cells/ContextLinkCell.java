...
public class ContextLinkCell extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public ContextLinkCell(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.titleY = AndroidUtilities.m104dp(7);
        this.descriptionY = AndroidUtilities.m104dp(27);
    ...
    */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.titleLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline), this.titleY);
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline), this.descriptionY);
        ...
        if (this.linkLayout != null) {
            ...
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 8 : AndroidUtilities.leftBaseline), this.linkY);
        ...
        if (!this.mediaWebpage) {
            ...
            if (i2 == 3 || i2 == 5) {
                ...
                if (tLRPC$BotInlineResult != null && tLRPC$BotInlineResult.type.equals("file")) {
                    ...
                    int imageX = (int) (this.linkImageView.getImageX() + ((AndroidUtilities.m104dp(52) - intrinsicWidth) / 2));
                    int imageY = (int) (this.linkImageView.getImageY() + ((AndroidUtilities.m104dp(52) - intrinsicHeight) / 2));
                    canvas.drawRect(this.linkImageView.getImageX(), this.linkImageView.getImageY(), this.linkImageView.getImageX() + AndroidUtilities.m104dp(52), this.linkImageView.getImageY() + AndroidUtilities.m104dp(52), LetterDrawable.paint);
                    ...
                    if (tLRPC$BotInlineResult2 != null && (tLRPC$BotInlineResult2.type.equals("audio") || this.inlineResult.type.equals("voice"))) {
                        ...
                        int imageX2 = (int) (this.linkImageView.getImageX() + ((AndroidUtilities.m104dp(52) - intrinsicWidth2) / 2));
                        int imageY2 = (int) (this.linkImageView.getImageY() + ((AndroidUtilities.m104dp(52) - intrinsicHeight2) / 2));
                        canvas.drawRect(this.linkImageView.getImageX(), this.linkImageView.getImageY(), this.linkImageView.getImageX() + AndroidUtilities.m104dp(52), this.linkImageView.getImageY() + AndroidUtilities.m104dp(52), LetterDrawable.paint);
                        ...
                        if (tLRPC$BotInlineResult3 != null && (tLRPC$BotInlineResult3.type.equals("venue") || this.inlineResult.type.equals("geo"))) {
                            ...
                            int imageX3 = (int) (this.linkImageView.getImageX() + ((AndroidUtilities.m104dp(52) - intrinsicWidth3) / 2));
                            int imageY3 = (int) (this.linkImageView.getImageY() + ((AndroidUtilities.m104dp(52) - intrinsicHeight3) / 2));
                            canvas.drawRect(this.linkImageView.getImageX(), this.linkImageView.getImageY(), this.linkImageView.getImageX() + AndroidUtilities.m104dp(52), this.linkImageView.getImageY() + AndroidUtilities.m104dp(52), LetterDrawable.paint);
        ...
        if (this.needShadow) {
            Theme.chat_contextResult_shadowUnderSwitchDrawable.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m104dp(3));
    ...
    public void updateButtonState(boolean z, boolean z2) {
        ...
        if (str == null && !this.resolvingFileName) {
            ...
            Utilities.searchQueue.postRunnable(new RunnableC40041(i, z));
    ...
    /* loaded from: classes5.dex */
    public class RunnableC40041 implements Runnable {
        final /* synthetic */ boolean val$ifSame;
        final /* synthetic */ int val$localId;

        RunnableC40041(int i, boolean z) {
            this.val$localId = i;
            this.val$ifSame = z;
        }
        ...
        */
        public void run() {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Cells.ContextLinkCell.RunnableC40041.run():void");
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        switch (this.documentAttachType) {
            case 1:
                sb.append(LocaleController.getString("AttachDocument", C3634R.string.AttachDocument));
                break;
            case 2:
                sb.append(LocaleController.getString("AttachGif", C3634R.string.AttachGif));
                break;
            case 3:
                sb.append(LocaleController.getString("AttachAudio", C3634R.string.AttachAudio));
                break;
            case 4:
                sb.append(LocaleController.getString("AttachVideo", C3634R.string.AttachVideo));
                break;
            case 5:
                sb.append(LocaleController.getString("AttachMusic", C3634R.string.AttachMusic));
                break;
            case 6:
                sb.append(LocaleController.getString("AttachSticker", C3634R.string.AttachSticker));
                break;
            case 7:
                sb.append(LocaleController.getString("AttachPhoto", C3634R.string.AttachPhoto));
                break;
            case 8:
                sb.append(LocaleController.getString("AttachLocation", C3634R.string.AttachLocation));
                break;
        }
        ...
        if (this.documentAttachType == 5 && z && z2) {
            sb.append(", ");
            sb.append(LocaleController.formatString("AccDescrMusicInfo", C3634R.string.AccDescrMusicInfo, this.descriptionLayout.getText(), this.titleLayout.getText()));
        } else {
            if (z) {
                if (sb.length() > 0) {
                    sb.append(", ");
