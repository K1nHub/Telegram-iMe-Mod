...
public class LocationCell extends FrameLayout {
    ...
    public LocationCell(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        ShapeDrawable createCircleDrawable = Theme.createCircleDrawable(AndroidUtilities.m107dp(42), -1);
        this.circleDrawable = createCircleDrawable;
        backupImageView.setBackground(createCircleDrawable);
        this.imageView.setSize(AndroidUtilities.m107dp(30), AndroidUtilities.m107dp(30));
        ...
        this.nameTextView.setTextSize(AndroidUtilities.m107dp(16));
        ...
        this.addressTextView.setTextSize(AndroidUtilities.m107dp(14));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.wrapContent) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(64) + (this.needDivider ? 1 : 0), 1073741824));
        } else {
    ...
    public void setLocation(TLRPC$TL_messageMediaVenue tLRPC$TL_messageMediaVenue, String str, int i, boolean z, boolean z2) {
        ...
        if (tLRPC$TL_messageMediaVenue != null && (str2 = tLRPC$TL_messageMediaVenue.icon) != null) {
            if ("pin".equals(str2) || tLRPC$TL_messageMediaVenue.icon.startsWith("emoji")) {
                ...
                CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m107dp(42), 0), mutate);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        globalGradientView.setParentSize(getMeasuredWidth(), getMeasuredHeight(), (-(getParent() instanceof ViewGroup ? ((ViewGroup) getParent()).indexOfChild(this) : 0)) * AndroidUtilities.m107dp(56));
        ...
        canvas.translate(AndroidUtilities.m107dp(2), (getMeasuredHeight() - AndroidUtilities.m107dp(56)) / 2);
        ...
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m107dp(72), getHeight() - 1, LocaleController.isRTL ? getWidth() - AndroidUtilities.m107dp(72) : getWidth(), getHeight() - 1, paint);
        }
    }
