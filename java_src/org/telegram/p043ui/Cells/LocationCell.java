...
public class LocationCell extends FrameLayout {
    ...
    public LocationCell(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        ShapeDrawable createCircleDrawable = Theme.createCircleDrawable(AndroidUtilities.m72dp(42), -1);
        this.circleDrawable = createCircleDrawable;
        backupImageView.setBackground(createCircleDrawable);
        this.imageView.setSize(AndroidUtilities.m72dp(30), AndroidUtilities.m72dp(30));
        ...
        this.nameTextView.setTextSize(AndroidUtilities.m72dp(16));
        ...
        this.addressTextView.setTextSize(AndroidUtilities.m72dp(14));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.wrapContent) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(64) + (this.needDivider ? 1 : 0), 1073741824));
        } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        globalGradientView.setParentSize(getMeasuredWidth(), getMeasuredHeight(), (-(getParent() instanceof ViewGroup ? ((ViewGroup) getParent()).indexOfChild(this) : 0)) * AndroidUtilities.m72dp(56));
        ...
        canvas.translate(AndroidUtilities.m72dp(2), (getMeasuredHeight() - AndroidUtilities.m72dp(56)) / 2);
        ...
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m72dp(72), getHeight() - 1, LocaleController.isRTL ? getWidth() - AndroidUtilities.m72dp(72) : getWidth(), getHeight() - 1, paint);
        }
    }
