...
public class LocationCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m72dp(72), getHeight() - 1, LocaleController.isRTL ? getWidth() - AndroidUtilities.m72dp(72) : getWidth(), getHeight() - 1, Theme.dividerPaint);
        }
    }
