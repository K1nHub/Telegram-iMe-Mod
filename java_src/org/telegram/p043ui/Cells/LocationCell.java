...
public class LocationCell extends FrameLayout {
    ...
    public LocationCell(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        ShapeDrawable createCircleDrawable = Theme.createCircleDrawable(AndroidUtilities.m104dp(42), -1);
        this.circleDrawable = createCircleDrawable;
        backupImageView.setBackground(createCircleDrawable);
        this.imageView.setSize(AndroidUtilities.m104dp(30), AndroidUtilities.m104dp(30));
        ...
        this.nameTextView.setTextSize(AndroidUtilities.m104dp(16));
        ...
        this.addressTextView.setTextSize(AndroidUtilities.m104dp(14));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.wrapContent) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(64) + (this.needDivider ? 1 : 0), 1073741824));
        } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        globalGradientView.setParentSize(getMeasuredWidth(), getMeasuredHeight(), (-(getParent() instanceof ViewGroup ? ((ViewGroup) getParent()).indexOfChild(this) : 0)) * AndroidUtilities.m104dp(56));
        ...
        canvas.translate(AndroidUtilities.m104dp(2), (getMeasuredHeight() - AndroidUtilities.m104dp(56)) / 2);
        ...
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m104dp(72), getHeight() - 1, LocaleController.isRTL ? getWidth() - AndroidUtilities.m104dp(72) : getWidth(), getHeight() - 1, paint);
        }
    }
