...
public class SendLocationCell extends FrameLayout {
    ...
    public SendLocationCell(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m104dp(42), getThemedColor(z ? Theme.key_location_sendLiveLocationBackground : Theme.key_location_sendLocationBackground), getThemedColor(z ? Theme.key_location_sendLiveLocationBackground : Theme.key_location_sendLocationBackground));
        if (z) {
            this.rect = new RectF();
            ...
            combinedDrawable2.setCustomSize(AndroidUtilities.m104dp(42), AndroidUtilities.m104dp(42));
            combinedDrawable2.setIconSize(AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(24));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(66), 1073741824));
    }
    ...
    public void checkText() {
        ...
        if (sharingLocationInfo != null) {
            String string = LocaleController.getString("StopLiveLocation", C3634R.string.StopLiveLocation);
        ...
        setText(LocaleController.getString("SendLiveLocation", C3634R.string.SendLiveLocation), LocaleController.getString("SendLiveLocationInfo", C3634R.string.SendLiveLocationInfo));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (sharingLocationInfo != null && (i = sharingLocationInfo.stopTime) >= (currentTime = ConnectionsManager.getInstance(this.currentAccount).getCurrentTime())) {
            ...
            if (LocaleController.isRTL) {
                this.rect.set(AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(18), AndroidUtilities.m104dp(43), AndroidUtilities.m104dp(48));
            } else {
                this.rect.set(getMeasuredWidth() - AndroidUtilities.m104dp(43), AndroidUtilities.m104dp(18), getMeasuredWidth() - AndroidUtilities.m104dp(13), AndroidUtilities.m104dp(48));
            }
            ...
            canvas.drawText(formatLocationLeftTime, this.rect.centerX() - (Theme.chat_livePaint.measureText(formatLocationLeftTime) / 2.0f), AndroidUtilities.m104dp(37), Theme.chat_livePaint);
        }
    }
