...
public class SendLocationCell extends FrameLayout {
    ...
    public void checkText() {
        ...
        if (sharingLocationInfo != null) {
            String string = LocaleController.getString("StopLiveLocation", C3473R.string.StopLiveLocation);
        ...
        setText(LocaleController.getString("SendLiveLocation", C3473R.string.SendLiveLocation), LocaleController.getString("SendLiveLocationInfo", C3473R.string.SendLiveLocationInfo));
    }
