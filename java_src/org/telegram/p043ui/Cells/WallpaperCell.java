...
public class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
            ...
            BackupImageView backupImageView = new BackupImageView(context, WallpaperCell.this) { // from class: org.telegram.ui.Cells.WallpaperCell.WallpaperView.1
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    if (WallpaperView.this.isSelected) {
                        ...
                        canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m107dp(20), WallpaperCell.this.circlePaint);
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            if (obj instanceof TLRPC$TL_wallPaper) {
                ...
                TLRPC$PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(tLRPC$TL_wallPaper.document.thumbs, AndroidUtilities.m107dp(100));
                TLRPC$PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tLRPC$TL_wallPaper.document.thumbs, AndroidUtilities.m107dp(180));
                ...
                if (tLRPC$Photo != null) {
                    TLRPC$PhotoSize closestPhotoSizeWithSize4 = FileLoader.getClosestPhotoSizeWithSize(tLRPC$Photo.sizes, AndroidUtilities.m107dp(100));
                    TLRPC$PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.m107dp(180));
    ...
    protected void onMeasure(int i, int i2) {
        int i3 = 0;
        if (this.spanCount == 1) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.size, 1073741824), View.MeasureSpec.makeMeasureSpec(this.size + AndroidUtilities.m107dp(6), 1073741824));
            setPadding(0, 0, 0, AndroidUtilities.m107dp(6));
            return;
        }
        int size = View.MeasureSpec.getSize(i);
        int m107dp = size - AndroidUtilities.m107dp(((this.spanCount - 1) * 6) + 28);
        int i4 = m107dp / this.spanCount;
        int i5 = this.currentType;
        int m107dp2 = (i5 == 0 || i5 == 2 || i5 == 3) ? AndroidUtilities.m107dp(180) : i4;
        setMeasuredDimension(size, (this.isTop ? AndroidUtilities.m107dp(14) : 0) + m107dp2 + AndroidUtilities.m107dp(this.isBottom ? 14 : 6));
        while (true) {
            int i6 = this.spanCount;
            if (i3 >= i6) {
                return;
            }
            this.wallpaperViews[i3].measure(View.MeasureSpec.makeMeasureSpec(i3 == i6 + (-1) ? m107dp : i4, 1073741824), View.MeasureSpec.makeMeasureSpec(m107dp2, 1073741824));
            m107dp -= i4;
            i3++;
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int m107dp2 = this.isTop ? AndroidUtilities.m107dp(14) : 0;
        for (int i5 = 0; i5 < this.spanCount; i5++) {
            int measuredWidth = this.wallpaperViews[i5].getMeasuredWidth();
            WallpaperView[] wallpaperViewArr = this.wallpaperViews;
            wallpaperViewArr[i5].layout(m107dp, m107dp2, m107dp + measuredWidth, wallpaperViewArr[i5].getMeasuredHeight() + m107dp2);
            m107dp += measuredWidth + AndroidUtilities.m107dp(6);
        }
    }
