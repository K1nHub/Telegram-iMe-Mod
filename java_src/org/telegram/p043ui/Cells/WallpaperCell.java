...
public class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
        ...
        public WallpaperView(Context context) {
            ...
            BackupImageView backupImageView = new BackupImageView(context, WallpaperCell.this) { // from class: org.telegram.ui.Cells.WallpaperCell.WallpaperView.1
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    if (WallpaperView.this.isSelected) {
                        ...
                        canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m104dp(20), WallpaperCell.this.circlePaint);
            ...
            imageView.setImageResource(C3632R.C3634drawable.ic_gallery_background);
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            if (obj instanceof TLRPC$TL_wallPaper) {
                ...
                TLRPC$PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(tLRPC$TL_wallPaper.document.thumbs, AndroidUtilities.m104dp(100));
                TLRPC$PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tLRPC$TL_wallPaper.document.thumbs, AndroidUtilities.m104dp(180));
                ...
                if (colorWallpaper.path != null || colorWallpaper.pattern != null || "d".equals(colorWallpaper.slug)) {
                    ...
                    if ("d".equals(colorWallpaper.slug)) {
                        if (colorWallpaper.defaultCache == null) {
                            colorWallpaper.defaultCache = SvgHelper.getBitmap(C3632R.raw.default_pattern, 100, 180, -16777216);
                        }
                ...
                if (tLRPC$Photo != null) {
                    TLRPC$PhotoSize closestPhotoSizeWithSize4 = FileLoader.getClosestPhotoSizeWithSize(tLRPC$Photo.sizes, AndroidUtilities.m104dp(100));
                    TLRPC$PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.m104dp(180));
    ...
    public WallpaperCell(Context context, int i) {
        ...
        while (true) {
            ...
            if (i2 < wallpaperViewArr.length) {
                ...
                this.checkDrawable = context.getResources().getDrawable(C3632R.C3634drawable.background_selected).mutate();
    ...
    protected void onMeasure(int i, int i2) {
        int i3 = 0;
        if (this.spanCount == 1) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.size, 1073741824), View.MeasureSpec.makeMeasureSpec(this.size + AndroidUtilities.m104dp(6), 1073741824));
            setPadding(0, 0, 0, AndroidUtilities.m104dp(6));
            return;
        }
        int size = View.MeasureSpec.getSize(i);
        int m104dp = size - AndroidUtilities.m104dp(((this.spanCount - 1) * 6) + 28);
        int i4 = m104dp / this.spanCount;
        int m104dp2 = this.currentType == 0 ? AndroidUtilities.m104dp(180) : i4;
        setMeasuredDimension(size, (this.isTop ? AndroidUtilities.m104dp(14) : 0) + m104dp2 + AndroidUtilities.m104dp(this.isBottom ? 14 : 6));
        while (true) {
            int i5 = this.spanCount;
            if (i3 >= i5) {
                return;
            }
            this.wallpaperViews[i3].measure(View.MeasureSpec.makeMeasureSpec(i3 == i5 + (-1) ? m104dp : i4, 1073741824), View.MeasureSpec.makeMeasureSpec(m104dp2, 1073741824));
            m104dp -= i4;
            i3++;
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int m104dp2 = this.isTop ? AndroidUtilities.m104dp(14) : 0;
        for (int i5 = 0; i5 < this.spanCount; i5++) {
            int measuredWidth = this.wallpaperViews[i5].getMeasuredWidth();
            WallpaperView[] wallpaperViewArr = this.wallpaperViews;
            wallpaperViewArr[i5].layout(m104dp, m104dp2, m104dp + measuredWidth, wallpaperViewArr[i5].getMeasuredHeight() + m104dp2);
            m104dp += measuredWidth + AndroidUtilities.m104dp(6);
        }
    }
