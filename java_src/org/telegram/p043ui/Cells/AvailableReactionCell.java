...
public class AvailableReactionCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec((int) (AndroidUtilities.m107dp(58) + Theme.dividerPaint.getStrokeWidth()), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m107dp = AndroidUtilities.m107dp(81);
        int i = 0;
        if (LocaleController.isRTL) {
            i = m107dp;
            m107dp = 0;
        }
        canvas.drawLine(getPaddingLeft() + m107dp, getHeight() - strokeWidth, (getWidth() - getPaddingRight()) - i, getHeight() - strokeWidth, Theme.dividerPaint);
    }
