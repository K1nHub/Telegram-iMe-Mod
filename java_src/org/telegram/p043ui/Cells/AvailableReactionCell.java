...
public class AvailableReactionCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec((int) (AndroidUtilities.m104dp(58) + Theme.dividerPaint.getStrokeWidth()), 1073741824));
    }
    ...
    public void bind(TLRPC$TL_availableReaction tLRPC$TL_availableReaction, boolean z, int i) {
        ...
        this.locked = z2;
        if (z2) {
            Drawable drawable = ContextCompat.getDrawable(getContext(), C3634R.C3636drawable.other_lockedfolders2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m104dp = AndroidUtilities.m104dp(81);
        int i = 0;
        if (LocaleController.isRTL) {
            i = m104dp;
            m104dp = 0;
        }
        canvas.drawLine(getPaddingLeft() + m104dp, getHeight() - strokeWidth, (getWidth() - getPaddingRight()) - i, getHeight() - strokeWidth, Theme.dividerPaint);
    }
