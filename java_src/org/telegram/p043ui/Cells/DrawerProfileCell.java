...
public class DrawerProfileCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
            ...
            if (z2) {
                ...
                if (drawerAccountData3 == DrawerAccountData.PHONE) {
                    ...
                    if (TextUtils.isEmpty(this.currentUser.username)) {
                        str2 = LocaleController.getInternalString(C3473R.string.drawer_profile_cell_alert_username);
                    } else {
                        str2 = LocaleController.formatStringInternal(C3473R.string.common_username, this.currentUser.username);
                    }
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    ...
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = LocaleController.formatStringInternal(C3473R.string.common_id, Long.valueOf(this.currentUser.f1685id));
                } else {
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = null;
    ...
    private void createEditButton(Context context) {
        ...
        this.editButton.setImageResource(C3473R.C3475drawable.fork_filter_icon_eye);
    ...
    private void createArchiveButton(Context context) {
        ...
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.archiveButton.setImageResource(C3473R.C3475drawable.msg_archive);
    ...
    public DrawerProfileCell(Context context, final DrawerLayoutContainer drawerLayoutContainer, final boolean z) {
        ...
        this.shadowView.setImageResource(C3473R.C3475drawable.bottom_shadow);
        ...
        this.arrowView.setImageResource(C3473R.C3475drawable.msg_expand);
    ...
    */
    ...
    public static class AnimatedStatusView extends View {
        ...
        /* renamed from: y1 */
        private float f1715y1;

        /* renamed from: y2 */
        private float f1716y2;
        ...
        public void translate(float f, float f2) {
            ...
            this.f1715y1 = measuredHeight;
            setTranslationY(measuredHeight + this.f1716y2);
        }

        public void translateY2(float f) {
            float f2 = this.f1715y1;
            this.f1716y2 = f;
    ...
    */
    ...
    public void setUser(TLRPC$User tLRPC$User, boolean z, DrawerHeaderSettings drawerHeaderSettings) {
        ...
        if (z3 && emojiStatusDocumentId != null) {
            ...
            if (this.premiumStar == null) {
                this.premiumStar = getResources().getDrawable(C3473R.C3475drawable.msg_premium_liststar).mutate();
            }
        ...
        textView.setText(c3389PhoneFormat.format("+" + tLRPC$User.phone));
    ...
    private void setArrowState(boolean z) {
        ...
        if (this.accountsShown) {
            i = C3473R.string.AccDescrHideAccounts;
            str = "AccDescrHideAccounts";
        } else {
            i = C3473R.string.AccDescrShowAccounts;
