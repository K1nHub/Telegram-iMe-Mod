...
public class DrawerProfileCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        while (i2 < 2) {
            ...
            if (z2) {
                ...
                if (drawerAccountData3 == DrawerAccountData.PHONE) {
                    ...
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = LocaleController.formatStringInternal(C3632R.string.common_id, Long.valueOf(this.currentUser.f1751id));
                } else {
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = null;
                ...
                layoutParams.height = AndroidUtilities.m107dp(z ? 14 : 12);
                view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(10), -16777216));
                view.setAlpha(0.3f);
                str = "";
            }
            if (z) {
                this.nameTextView.setPadding(z2 ? 0 : AndroidUtilities.m107dp(32), AndroidUtilities.m107dp(4), 0, AndroidUtilities.m107dp(4));
                this.nameTextView.setMinWidth(z2 ? 0 : AndroidUtilities.m107dp(64));
    ...
    public DrawerProfileCell(Context context, final DrawerLayoutContainer drawerLayoutContainer, final boolean z) {
        ...
        backupImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m107dp(32));
        ...
        this.nameTextView.setPadding(0, AndroidUtilities.m107dp(4), 0, AndroidUtilities.m107dp(4));
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.darkThemeView.setBackgroundDrawable(Theme.createSelectorDrawable(Theme.getColor(Theme.key_listSelector), 1, AndroidUtilities.m107dp(17)));
    ...
    */
    ...
    public static class AnimatedStatusView extends View {
        ...
        public void dispatchDraw(Canvas canvas) {
            int m107dp = AndroidUtilities.m107dp(this.renderedEffectsSize);
            int m107dp2 = AndroidUtilities.m107dp(this.effectsSize);
            for (int i = 0; i < this.animations.size(); i++) {
                Object obj = this.animations.get(i);
                if (obj instanceof ImageReceiver) {
                    ImageReceiver imageReceiver = (ImageReceiver) obj;
                    float f = m107dp2;
                    imageReceiver.setImageCoords((getMeasuredWidth() - m107dp2) / 2.0f, (getMeasuredHeight() - m107dp2) / 2.0f, f, f);
                    imageReceiver.draw(canvas);
                } else if (obj instanceof AnimatedEmojiEffect) {
                    AnimatedEmojiEffect animatedEmojiEffect = (AnimatedEmojiEffect) obj;
                    animatedEmojiEffect.setBounds((int) ((getMeasuredWidth() - m107dp) / 2.0f), (int) ((getMeasuredHeight() - m107dp) / 2.0f), (int) ((getMeasuredWidth() + m107dp) / 2.0f), (int) ((getMeasuredHeight() + m107dp) / 2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        if (Build.VERSION.SDK_INT >= 21 && !this.previewMode) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(148) + AndroidUtilities.statusBarHeight, 1073741824));
            return;
        }
        try {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(148), 1073741824));
        } catch (Exception e) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(148));
            FileLog.m102e(e);
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.drawPremium) {
            if (this.starParticlesDrawable == null) {
                ...
                drawable2.minLifeTime = C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
            }
            ...
            this.starParticlesDrawable.rect.inset(-AndroidUtilities.m107dp(20), -AndroidUtilities.m107dp(20));
    ...
    */
    ...
    public void setUser(TLRPC$User tLRPC$User, boolean z, DrawerHeaderSettings drawerHeaderSettings) {
        ...
        try {
            userName = Emoji.replaceEmoji(userName, this.nameTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m107dp(22), false);
        ...
        if (z3 && emojiStatusDocumentId != null) {
            ...
            this.nameTextView.setDrawablePadding(AndroidUtilities.m107dp(4));
        ...
        textView.setText(c3544PhoneFormat.format("+" + tLRPC$User.phone));
