...
public class DrawerProfileCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
            ...
            if (z2) {
                ...
                if (drawerAccountData3 == DrawerAccountData.PHONE) {
                    ...
                    if (TextUtils.isEmpty(this.currentUser.username)) {
                        str2 = LocaleController.getInternalString(C3419R.string.drawer_profile_cell_alert_username);
                    } else {
                        str2 = LocaleController.formatStringInternal(C3419R.string.common_username, this.currentUser.username);
                    }
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    ...
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = LocaleController.formatStringInternal(C3419R.string.common_id, Long.valueOf(this.currentUser.f1675id));
                } else {
                    drawerAccountData = title;
                    drawerAccountData2 = subtitle;
                    str2 = null;
                ...
                layoutParams.height = AndroidUtilities.m72dp(z ? 14 : 12);
                view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m72dp(10), -16777216));
                view.setAlpha(0.3f);
                str = "";
            }
            if (z) {
                this.nameTextView.setPadding(z2 ? 0 : AndroidUtilities.m72dp(32), AndroidUtilities.m72dp(4), 0, AndroidUtilities.m72dp(4));
                this.nameTextView.setMinWidth(z2 ? 0 : AndroidUtilities.m72dp(64));
    ...
    private void createEditButton(Context context) {
        ...
        this.editButton.setImageResource(C3419R.C3421drawable.fork_filter_icon_eye);
    ...
    private void createArchiveButton(Context context) {
        ...
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.archiveButton.setImageResource(C3419R.C3421drawable.msg_archive);
    ...
    public DrawerProfileCell(Context context, final DrawerLayoutContainer drawerLayoutContainer, final boolean z) {
        ...
        this.shadowView.setImageResource(C3419R.C3421drawable.bottom_shadow);
        addView(this.shadowView, LayoutHelper.createFrame(-1, 70, 83));
        BackupImageView backupImageView = new BackupImageView(context);
        this.avatarImageView = backupImageView;
        backupImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m72dp(32));
        ...
        this.nameTextView.setPadding(0, AndroidUtilities.m72dp(4), 0, AndroidUtilities.m72dp(4));
        ...
        this.arrowView.setImageResource(C3419R.C3421drawable.msg_expand);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.darkThemeView.setBackgroundDrawable(Theme.createSelectorDrawable(Theme.getColor(Theme.key_listSelector), 1, AndroidUtilities.m72dp(17)));
    ...
    */
    ...
    public static class AnimatedStatusView extends View {
        ...
        /* renamed from: y1 */
        private float f1705y1;

        /* renamed from: y2 */
        private float f1706y2;
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(Math.max(this.renderedEffectsSize, Math.max(this.stateSize, this.effectsSize))), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(Math.max(this.renderedEffectsSize, Math.max(this.stateSize, this.effectsSize))), 1073741824));
        }

        public void translate(float f, float f2) {
            setTranslationX(f - (getMeasuredWidth() / 2.0f));
            float measuredHeight = f2 - (getMeasuredHeight() / 2.0f);
            this.f1705y1 = measuredHeight;
            setTranslationY(measuredHeight + this.f1706y2);
        }

        public void translateY2(float f) {
            float f2 = this.f1705y1;
            this.f1706y2 = f;
        ...
        public void dispatchDraw(Canvas canvas) {
            int m72dp = AndroidUtilities.m72dp(this.renderedEffectsSize);
            int m72dp2 = AndroidUtilities.m72dp(this.effectsSize);
            for (int i = 0; i < this.animations.size(); i++) {
                Object obj = this.animations.get(i);
                if (obj instanceof ImageReceiver) {
                    ImageReceiver imageReceiver = (ImageReceiver) obj;
                    float f = m72dp2;
                    imageReceiver.setImageCoords((getMeasuredWidth() - m72dp2) / 2.0f, (getMeasuredHeight() - m72dp2) / 2.0f, f, f);
                    imageReceiver.draw(canvas);
                } else if (obj instanceof AnimatedEmojiEffect) {
                    AnimatedEmojiEffect animatedEmojiEffect = (AnimatedEmojiEffect) obj;
                    animatedEmojiEffect.setBounds((int) ((getMeasuredWidth() - m72dp) / 2.0f), (int) ((getMeasuredHeight() - m72dp) / 2.0f), (int) ((getMeasuredWidth() + m72dp) / 2.0f), (int) ((getMeasuredHeight() + m72dp) / 2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        if (Build.VERSION.SDK_INT >= 21 && !this.previewMode) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(148) + AndroidUtilities.statusBarHeight, 1073741824));
            return;
        }
        try {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(148), 1073741824));
        } catch (Exception e) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m72dp(148));
            FileLog.m67e(e);
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.drawPremium) {
            if (this.starParticlesDrawable == null) {
                ...
                drawable2.minLifeTime = C0480C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
            }
            ...
            this.starParticlesDrawable.rect.inset(-AndroidUtilities.m72dp(20), -AndroidUtilities.m72dp(20));
    ...
    */
    ...
    public void setUser(TLRPC$User tLRPC$User, boolean z, DrawerHeaderSettings drawerHeaderSettings) {
        ...
        try {
            userName = Emoji.replaceEmoji(userName, this.nameTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m72dp(22), false);
        ...
        if (z3 && emojiStatusDocumentId != null) {
            ...
            this.nameTextView.setDrawablePadding(AndroidUtilities.m72dp(4));
            ...
            if (this.premiumStar == null) {
                this.premiumStar = getResources().getDrawable(C3419R.C3421drawable.msg_premium_liststar).mutate();
            }
        ...
        textView.setText(c3334PhoneFormat.format("+" + tLRPC$User.phone));
    ...
    private void setArrowState(boolean z) {
        ...
        if (this.accountsShown) {
            i = C3419R.string.AccDescrHideAccounts;
            str = "AccDescrHideAccounts";
        } else {
            i = C3419R.string.AccDescrShowAccounts;
