...
public class GroupCallUserCell extends FrameLayout {
    ...
    public void setProgressToAvatarPreview(float f) {
        ...
        this.nameTextView.setTranslationX((LocaleController.isRTL ? AndroidUtilities.m104dp(53) : -AndroidUtilities.m104dp(53)) * f);
        boolean isSelfUser = isSelfUser();
        boolean z = true;
        float f2 = BitmapDescriptorFactory.HUE_RED;
        if (isSelfUser && f > BitmapDescriptorFactory.HUE_RED) {
            float f3 = 1.0f - f;
            this.fullAboutTextView.setTranslationX((LocaleController.isRTL ? -AndroidUtilities.m104dp(53) : AndroidUtilities.m104dp(53)) * f3);
            ...
            int m104dp = AndroidUtilities.m104dp(53);
            if (!z2) {
                m104dp = -m104dp;
            }
            simpleTextView.setTranslationX(m104dp * f);
        } else {
            ...
            while (true) {
                ...
                if (!TextUtils.isEmpty(simpleTextViewArr[4].getText()) && this.statusTextView[4].getLineCount() > 1) {
                    this.statusTextView[i].setFullLayoutAdditionalWidth(AndroidUtilities.m104dp(92), LocaleController.isRTL ? AndroidUtilities.m104dp(48) : AndroidUtilities.m104dp(53));
                    ...
                    this.statusTextView[i].setTranslationX((LocaleController.isRTL ? AndroidUtilities.m104dp(53) : -AndroidUtilities.m104dp(53)) * f);
    ...
    public GroupCallUserCell(Context context) {
        ...
        radialProgressView.setSize(AndroidUtilities.m104dp(26));
        ...
        this.nameTextView.setDrawablePadding(AndroidUtilities.m104dp(6));
        this.nameTextView.setGravity((LocaleController.isRTL ? 5 : 3) | 48);
        SimpleTextView simpleTextView2 = this.nameTextView;
        boolean z3 = LocaleController.isRTL;
        addView(simpleTextView2, LayoutHelper.createFrame(-1, 20, (z3 ? 5 : 3) | 48, z3 ? 54 : 67, 10, z3 ? 67 : 54, 0));
        this.rightDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.nameTextView, AndroidUtilities.m104dp(20), 9);
        ...
        while (true) {
            ...
            if (i == 4) {
                ...
                if (i == 0) {
                    ...
                    this.statusTextView[i].setDrawablePadding(AndroidUtilities.m104dp(2));
                } else if (i == 2) {
        ...
        this.muteDrawable = new RLottieDrawable(i2, "" + i2, AndroidUtilities.m104dp(34), AndroidUtilities.m104dp(32), true, null);
        int i3 = C3632R.raw.hand_1;
        this.shakeHandDrawable = new RLottieDrawable(i3, "" + i3, AndroidUtilities.m104dp(34), AndroidUtilities.m104dp(32), true, null);
        ...
        this.avatarWavesDrawable = new AvatarWavesDrawable(AndroidUtilities.m104dp(26), AndroidUtilities.m104dp(29));
    ...
    public int getClipHeight() {
        ...
        if (simpleTextView.getLineCount() > 1) {
            return simpleTextView.getTop() + simpleTextView.getTextHeight() + AndroidUtilities.m104dp(8);
        }
    ...
    public boolean isSelfUser() {
        ...
        if (j > 0) {
            ...
            return tLRPC$User != null && tLRPC$User.f1749id == j;
        }
            ...
            if (tLRPC$User2 == null || !tLRPC$User2.verified) {
                ...
                if (isShowPremiumBadgeEnabled && (tLRPC$User = this.currentUser) != null && tLRPC$User.premium) {
                    if (this.premiumDrawable == null) {
                        ...
                        this.premiumDrawable = new AnimatedEmojiDrawable.WrapSizeDrawable(this, this.premiumDrawable, AndroidUtilities.m104dp(14), AndroidUtilities.m104dp(14)) { // from class: org.telegram.ui.Cells.GroupCallUserCell.3
                            @Override // org.telegram.p043ui.Components.AnimatedEmojiDrawable.WrapSizeDrawable, android.graphics.drawable.Drawable
                            public void draw(Canvas canvas) {
                                canvas.save();
                                canvas.translate(AndroidUtilities.m104dp(-2), AndroidUtilities.m104dp(0));
                                super.draw(canvas);
                                canvas.restore();
                            }
                        };
    ...
    */
    ...
    public void applyStatus(int i) {
        ...
        if (i == 0) {
            while (true) {
                ...
                simpleTextViewArr[i2].setTranslationY(i2 == i ? 0.0f : AndroidUtilities.m104dp(-2));
            ...
            while (true) {
                ...
                if (i2 == i) {
                    ...
                    m104dp = AndroidUtilities.m104dp(i2 == 0 ? 2 : -2);
                }
                simpleTextView.setTranslationY(m104dp);
                this.statusTextView[i2].setAlpha(i2 == i ? 1.0f : 0.0f);
                i2++;
            }
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m104dp(68), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m104dp(68) : 0), getMeasuredHeight() - 1, this.dividerPaint);
        }
