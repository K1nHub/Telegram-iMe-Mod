...
public class TextCheckCell2 extends FrameLayout {
        ...
        if (this.collapseViewContainer == null) {
            ...
            View view = new View(this, getContext()) { // from class: org.telegram.ui.Cells.TextCheckCell2.1
                ...
                protected void onDraw(Canvas canvas) {
                    super.onDraw(canvas);
                    canvas.drawLine(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(14), 2.0f, getMeasuredHeight() - AndroidUtilities.m107dp(14), Theme.dividerPaint);
                }
            };
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(this.valueTextView.getVisibility() == 0 ? 64 : 50) + (this.needDivider ? 1 : 0), 1073741824));
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (linearLayout != null) {
            if (LocaleController.isRTL) {
                linearLayout.setTranslationX((this.textView.getLeft() - this.collapseViewContainer.getMeasuredWidth()) - AndroidUtilities.m107dp(4));
            } else {
                linearLayout.setTranslationX(this.textView.getRight() + AndroidUtilities.m107dp(4));
            }
        }
    }
