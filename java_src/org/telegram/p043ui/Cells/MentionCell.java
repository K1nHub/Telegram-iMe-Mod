...
public class MentionCell extends LinearLayout {
    ...
    public MentionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        avatarDrawable.setTextSize(AndroidUtilities.m104dp(18));
        BackupImageView backupImageView = new BackupImageView(context);
        this.imageView = backupImageView;
        backupImageView.setRoundRadius(AndroidUtilities.m104dp(14));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(36), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needsDivider) {
            canvas.drawLine(AndroidUtilities.m104dp(52), getHeight() - 1, getWidth() - AndroidUtilities.m104dp(8), getHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public void setEmojiSuggestion(MediaDataController.KeywordResult keywordResult) {
        ...
        this.nameTextView.setPadding(AndroidUtilities.m104dp(22), 0, 0, 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        Drawable drawable = this.emojiDrawable;
        if (drawable != null) {
            int m104dp = AndroidUtilities.m104dp(drawable instanceof AnimatedEmojiDrawable ? 24 : 20);
            int m104dp2 = AndroidUtilities.m104dp(this.emojiDrawable instanceof AnimatedEmojiDrawable ? -2 : 0);
            this.emojiDrawable.setBounds(this.nameTextView.getLeft() + m104dp2, ((this.nameTextView.getTop() + this.nameTextView.getBottom()) - m104dp) / 2, this.nameTextView.getLeft() + m104dp2 + m104dp, ((this.nameTextView.getTop() + this.nameTextView.getBottom()) + m104dp) / 2);
    ...
    public void setBotCommand(String str, String str2, TLRPC$User tLRPC$User) {
        ...
        this.nameTextView.setText(str);
        TextView textView = this.usernameTextView;
        textView.setText(Emoji.replaceEmoji((CharSequence) str2, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(20), false));
    }
