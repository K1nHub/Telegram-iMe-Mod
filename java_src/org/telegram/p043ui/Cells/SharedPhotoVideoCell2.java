...
public class SharedPhotoVideoCell2 extends FrameLayout {
    ...
    public SharedPhotoVideoCell2(Context context, SharedResources sharedResources, int i) {
        ...
        this.viewsText.setTextSize(AndroidUtilities.m104dp(12));
    ...
    public void setStyle(int i) {
        ...
        if (i == 1) {
            ...
            this.checkBoxBase.setBounds(0, 0, AndroidUtilities.m104dp(24), AndroidUtilities.m104dp(24));
            if (this.attached) {
    ...
    */
        ...
        if (this.showVideoLayout) {
            ...
            if (imageReceiver == null || imageReceiver.getVisible()) {
                ...
                if (this.videoInfoLayot == null) {
                    ...
                    m104dp = AndroidUtilities.m104dp(4) + this.videoInfoLayot.getWidth() + AndroidUtilities.m104dp(4);
                }
                if (this.drawVideoIcon) {
                    m104dp += AndroidUtilities.m104dp(10);
                }
                canvas.translate(AndroidUtilities.m104dp(5), ((AndroidUtilities.m104dp(1) + rectF.height()) - AndroidUtilities.m104dp(17)) - AndroidUtilities.m104dp(4));
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, m104dp, AndroidUtilities.m104dp(17));
                int alpha = Theme.chat_timeBackgroundPaint.getAlpha();
                Theme.chat_timeBackgroundPaint.setAlpha((int) (alpha * f));
                canvas.drawRoundRect(rectF2, AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), Theme.chat_timeBackgroundPaint);
                Theme.chat_timeBackgroundPaint.setAlpha(alpha);
                if (this.drawVideoIcon) {
                    canvas.save();
                    canvas.translate(this.videoInfoLayot == null ? AndroidUtilities.m104dp(5) : AndroidUtilities.m104dp(4), (AndroidUtilities.m104dp(17) - this.sharedResources.playDrawable.getIntrinsicHeight()) / 2.0f);
                    this.sharedResources.playDrawable.setAlpha((int) (this.imageAlpha * 255.0f * f));
                    this.sharedResources.playDrawable.draw(canvas);
                    canvas.restore();
                }
                if (this.videoInfoLayot != null) {
                    canvas.translate(AndroidUtilities.m104dp((this.drawVideoIcon ? 10 : 0) + 4), (AndroidUtilities.m104dp(17) - this.videoInfoLayot.getHeight()) / 2.0f);
    ...
    public void drawViews(Canvas canvas, RectF rectF, float f) {
        if (this.isStory) {
            ...
            if ((imageReceiver == null || imageReceiver.getVisible()) && this.currentParentColumnsCount < 5) {
                ...
                canvas.translate(rectF.left, rectF.top);
                canvas.clipRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, rectF.width(), rectF.height());
                float m104dp = AndroidUtilities.m104dp(26) + this.viewsText.getCurrentWidth();
                canvas.translate((rectF.width() - AndroidUtilities.m104dp(5)) - m104dp, ((AndroidUtilities.m104dp(1) + rectF.height()) - AndroidUtilities.m104dp(17)) - AndroidUtilities.m104dp(4));
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, m104dp, AndroidUtilities.m104dp(17));
                int alpha = Theme.chat_timeBackgroundPaint.getAlpha();
                ...
                Theme.chat_timeBackgroundPaint.setAlpha(alpha);
                canvas.save();
                canvas.translate(AndroidUtilities.m104dp(3), (AndroidUtilities.m104dp(17) - this.sharedResources.viewDrawable.getBounds().height()) / 2.0f);
                this.sharedResources.viewDrawable.setAlpha((int) (this.imageAlpha * 255.0f * f3));
                this.sharedResources.viewDrawable.draw(canvas);
                canvas.restore();
                canvas.translate(AndroidUtilities.m104dp(22), BitmapDescriptorFactory.HUE_RED);
                this.viewsText.setBounds(0, 0, (int) m104dp, AndroidUtilities.m104dp(17));
    ...
    public void drawCrossafadeImage(Canvas canvas) {
        if (this.crossfadeView != null) {
            ...
            this.crossfadeView.setImageScale(((getMeasuredWidth() - AndroidUtilities.m104dp(2)) * this.imageScale) / (this.crossfadeView.getMeasuredWidth() - AndroidUtilities.m104dp(2)), false);
