...
public class PhotoAttachCameraCell extends FrameLayout {
    ...
    public PhotoAttachCameraCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        setFocusable(true);
        this.itemSize = AndroidUtilities.m107dp(0);
    }

    @Override // android.widget.FrameLayout, android.view.View
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m107dp(5), 1073741824), View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m107dp(5), 1073741824));
    }
