...
public class PhotoAttachCameraCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m104dp(5), 1073741824), View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m104dp(5), 1073741824));
    }
