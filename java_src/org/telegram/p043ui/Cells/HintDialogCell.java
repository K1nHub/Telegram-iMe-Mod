...
public class HintDialogCell extends FrameLayout {
    ...
    public HintDialogCell(Context context, boolean z) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m104dp(27));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(86), 1073741824));
        this.counterView.counterDrawable.horizontalPadding = AndroidUtilities.m104dp(13);
    }

    public void update(int i) {
        int i2;
        if ((MessagesController.UPDATE_MASK_STATUS & i) != 0 && this.currentUser != null) {
            this.currentUser = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.currentUser.f1749id));
    ...
    */
    protected boolean drawChild(android.graphics.Canvas r6, android.view.View r7, long r8) {
        ...
        L76:
            ...
            if (r7 == 0) goto Lc1
            r7 = 53
            int r7 = org.telegram.messenger.AndroidUtilities.m104dp(r7)
            r0 = 59
    ...
    protected void onDraw(Canvas canvas) {
        if (this.drawCheckbox) {
            ...
            canvas.drawCircle(left, top, AndroidUtilities.m104dp(28), Theme.checkboxSquare_checkPaint);
        }
    }
