...
public class TextCell extends FrameLayout {
    ...
    public TextCell(Context context, int i, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider, AttributeSet attributeSet) {
        ...
        animatedTextView.setPadding(0, AndroidUtilities.m107dp(18), 0, AndroidUtilities.m107dp(18));
        animatedTextView.setTextSize(AndroidUtilities.m107dp(16));
        animatedTextView.setGravity(LocaleController.isRTL ? 3 : 5);
        animatedTextView.setImportantForAccessibility(2);
        animatedTextView.setTranslationY(AndroidUtilities.m107dp(-2));
    ...
    public void onMeasure(int i, int i2) {
        ...
        int m107dp = AndroidUtilities.m107dp(this.heightDp);
        ...
        if (this.prioritizeTitleOverValue) {
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m107dp(this.leftPadding + 71), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
            this.subtitleView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m107dp(this.leftPadding + 71), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
            this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.m107dp(this.leftPadding + 103)) - this.textView.getTextWidth(), LocaleController.isRTL ? Integer.MIN_VALUE : 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
            this.valueSpoilersTextView.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.m107dp(this.leftPadding + 103)) - this.textView.getTextWidth(), LocaleController.isRTL ? Integer.MIN_VALUE : 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
        } else {
            this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m107dp(this.leftPadding), LocaleController.isRTL ? Integer.MIN_VALUE : 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
            this.valueSpoilersTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m107dp(this.leftPadding), LocaleController.isRTL ? Integer.MIN_VALUE : 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
            int max = Math.max(this.valueTextView.width(), this.valueSpoilersTextView.getTextWidth());
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.m107dp(this.leftPadding + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
            this.subtitleView.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.m107dp(this.leftPadding + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
        }
        ...
        if (this.valueImageView.getVisibility() == 0) {
            this.valueImageView.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(m107dp, Integer.MIN_VALUE));
        }
        Switch r0 = this.checkBox;
        if (r0 != null) {
            r0.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(37), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(20), 1073741824));
        }
        setMeasuredDimension(size, m107dp + (this.needDivider ? 1 : 0));
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int m107dp2 = LocaleController.isRTL ? AndroidUtilities.m107dp(this.leftPadding) : (i6 - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m107dp(this.leftPadding);
        if (this.prioritizeTitleOverValue && !LocaleController.isRTL) {
            m107dp2 = (i6 - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m107dp(this.leftPadding);
        }
        AnimatedTextView animatedTextView = this.valueTextView;
        animatedTextView.layout(m107dp2, max, animatedTextView.getMeasuredWidth() + m107dp2, this.valueTextView.getMeasuredHeight() + max);
        int m107dp3 = LocaleController.isRTL ? AndroidUtilities.m107dp(this.leftPadding) : (i6 - this.valueSpoilersTextView.getMeasuredWidth()) - AndroidUtilities.m107dp(this.leftPadding);
        SimpleTextView simpleTextView = this.valueSpoilersTextView;
        simpleTextView.layout(m107dp3, max, simpleTextView.getMeasuredWidth() + m107dp3, this.valueSpoilersTextView.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            m107dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m107dp(this.imageView.getVisibility() == 0 ? this.offsetFromImage : this.leftPadding);
        } else {
            m107dp = AndroidUtilities.m107dp(this.imageView.getVisibility() == 0 ? this.offsetFromImage : this.leftPadding);
        }
        if (this.subtitleView.getVisibility() == 0) {
            int i7 = this.heightDp > 50 ? 4 : 2;
            int textHeight = (((i5 - this.textView.getTextHeight()) - this.subtitleView.getTextHeight()) - AndroidUtilities.m107dp(i7)) / 2;
            SimpleTextView simpleTextView2 = this.textView;
            simpleTextView2.layout(m107dp, textHeight, simpleTextView2.getMeasuredWidth() + m107dp, this.textView.getMeasuredHeight() + textHeight);
            int textHeight2 = textHeight + this.textView.getTextHeight() + AndroidUtilities.m107dp(i7);
            SimpleTextView simpleTextView3 = this.subtitleView;
            simpleTextView3.layout(m107dp, textHeight2, simpleTextView3.getMeasuredWidth() + m107dp, this.subtitleView.getMeasuredHeight() + textHeight2);
        } else {
            int textHeight3 = (i5 - this.textView.getTextHeight()) / 2;
            SimpleTextView simpleTextView4 = this.textView;
            simpleTextView4.layout(m107dp, textHeight3, simpleTextView4.getMeasuredWidth() + m107dp, this.textView.getMeasuredHeight() + textHeight3);
        }
        if (this.imageView.getVisibility() == 0) {
            int m107dp4 = (AndroidUtilities.m107dp(this.heightDp > 50 ? 0 : 2) + ((i5 - this.imageView.getMeasuredHeight()) / 2)) - this.imageView.getPaddingTop();
            int m107dp5 = !LocaleController.isRTL ? AndroidUtilities.m107dp(this.imageLeft) : (i6 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m107dp(this.imageLeft);
            RLottieImageView rLottieImageView = this.imageView;
            rLottieImageView.layout(m107dp5, m107dp4, rLottieImageView.getMeasuredWidth() + m107dp5, this.imageView.getMeasuredHeight() + m107dp4);
        }
        if (this.valueImageView.getVisibility() == 0) {
            int measuredHeight = (i5 - this.valueImageView.getMeasuredHeight()) / 2;
            int m107dp6 = LocaleController.isRTL ? AndroidUtilities.m107dp(23) : (i6 - this.valueImageView.getMeasuredWidth()) - AndroidUtilities.m107dp(23);
            ImageView imageView = this.valueImageView;
            imageView.layout(m107dp6, measuredHeight, imageView.getMeasuredWidth() + m107dp6, this.valueImageView.getMeasuredHeight() + measuredHeight);
        }
        ...
        int m107dp7 = LocaleController.isRTL ? AndroidUtilities.m107dp(22) : (i6 - this.checkBox.getMeasuredWidth()) - AndroidUtilities.m107dp(22);
        Switch r7 = this.checkBox;
        r7.layout(m107dp7, measuredHeight2, r7.getMeasuredWidth() + m107dp7, this.checkBox.getMeasuredHeight() + measuredHeight2);
    }
    ...
    public void setTextAndIcon(CharSequence charSequence, int i, boolean z) {
        ...
        this.valueSpoilersTextView.setVisibility(8);
        this.valueImageView.setVisibility(8);
        this.imageView.setPadding(0, AndroidUtilities.m107dp(7), 0, 0);
        this.needDivider = z;
        setWillNotDraw(!z);
    }
    ...
    public void setTextAndIcon(String str, Drawable drawable, boolean z) {
        ...
        this.valueTextView.setVisibility(8);
        this.valueImageView.setVisibility(8);
        this.imageView.setPadding(0, AndroidUtilities.m107dp(6), 0, 0);
        this.needDivider = z;
        setWillNotDraw(!z);
    }
    ...
    public void setColorfulIcon(int i, int i2) {
        ...
        this.imageView.setVisibility(0);
        this.imageView.setPadding(AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(2));
        this.imageView.setTranslationX(AndroidUtilities.m107dp(LocaleController.isRTL ? 0 : -3));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            if (this.needFullDivider || LocaleController.isRTL) {
                ...
                f = AndroidUtilities.m107dp(this.imageView.getVisibility() == 0 ? this.inDialogs ? 72 : 68 : 20);
            }
    ...
    public void dispatchDraw(Canvas canvas) {
        if (this.drawLoading || this.drawLoadingProgress != BitmapDescriptorFactory.HUE_RED) {
            ...
            rectF.set((getMeasuredWidth() - AndroidUtilities.m107dp(21)) - AndroidUtilities.m107dp(this.loadingSize), measuredHeight - AndroidUtilities.m107dp(3), getMeasuredWidth() - AndroidUtilities.m107dp(21), measuredHeight + AndroidUtilities.m107dp(3));
            if (LocaleController.isRTL) {
                rectF.left = getMeasuredWidth() - rectF.left;
                rectF.right = getMeasuredWidth() - rectF.right;
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.m107dp(3), AndroidUtilities.m107dp(3), this.paint);
            invalidate();
        }
