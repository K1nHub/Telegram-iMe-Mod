...
public class DrawerUserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void addMuteButton() {
        ...
        imageView.setImageResource(C3632R.C3634drawable.msg_unmute);
    ...
    public /* synthetic */ void lambda$addMuteButton$0(View view) {
        ...
        if (getForkCommonController().isAccountMuted()) {
            string = LocaleController.getString("NotificationsMutedHint", C3632R.string.NotificationsMutedHint);
        } else {
            string = LocaleController.getString("NotificationsUnmutedHint", C3632R.string.NotificationsUnmutedHint);
        }
    ...
    private void updateMuteButtonIcon() {
        ...
        if (imageView != null) {
            imageView.setImageResource(getForkCommonController().isAccountMuted() ? C3632R.C3634drawable.msg_mute : C3632R.C3634drawable.msg_unmute);
        }
    }
    ...
    public DrawerUserCell(Context context, int i) {
        ...
        avatarDrawable.setTextSize(AndroidUtilities.m107dp(20));
        ...
        simpleTextView.setPadding(0, AndroidUtilities.m107dp(4), 0, AndroidUtilities.m107dp(4));
        ...
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.textView, AndroidUtilities.m107dp(20));
        ...
        this.checkBox.setInnerRadDiff(AndroidUtilities.m108dp(1.5f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(isActionBarAccountSwitchType() ? 56 : 48), 1073741824));
    }
    ...
    public void setAccount(int i) {
        ...
        try {
            formatName = Emoji.replaceEmoji(formatName, this.textView.getPaint().getFontMetricsInt(), AndroidUtilities.m107dp(20), false);
        ...
        if (isShowPremiumStatusEnabled && emojiStatusDocumentId != null) {
            this.textView.setDrawablePadding(AndroidUtilities.m107dp(4));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m108dp = AndroidUtilities.m108dp(isActionBarAccountSwitchType() ? 16.5f : 12.5f);
        int ceil = (int) Math.ceil(Theme.dialogs_countTextPaint.measureText(format));
        int max = Math.max(AndroidUtilities.m107dp(10), ceil);
        int measuredWidth = (getMeasuredWidth() - max) - AndroidUtilities.m107dp(25);
        if (this.muteButton != null) {
            measuredWidth -= AndroidUtilities.m107dp(42);
        }
        int m108dp2 = measuredWidth - AndroidUtilities.m108dp(5.5f);
        this.rect.set(m108dp2, m108dp, m108dp2 + max + AndroidUtilities.m107dp(14), AndroidUtilities.m107dp(23) + m108dp);
        RectF rectF = this.rect;
        float f = AndroidUtilities.density;
        canvas.drawRoundRect(rectF, f * 11.5f, f * 11.5f, Theme.dialogs_countPaint);
        RectF rectF2 = this.rect;
        canvas.drawText(format, rectF2.left + ((rectF2.width() - ceil) / 2.0f), m108dp + AndroidUtilities.m107dp(16), Theme.dialogs_countTextPaint);
        this.textView.setRightPadding(max + AndroidUtilities.m107dp(26));
    }
