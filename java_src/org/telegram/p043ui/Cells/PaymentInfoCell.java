...
public class PaymentInfoCell extends FrameLayout {
    ...
    public PaymentInfoCell(Context context) {
        ...
        backupImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m107dp(8));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.imageView.getVisibility() != 8) {
            i3 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(120), 1073741824);
        } else {
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
            measureChildWithMargins(this.detailTextView, i, 0, i2, 0);
            ((FrameLayout.LayoutParams) this.detailExTextView.getLayoutParams()).topMargin = AndroidUtilities.m107dp(33) + this.detailTextView.getMeasuredHeight() + AndroidUtilities.m107dp(3);
            i3 = makeMeasureSpec;
        }
    ...
    public void setInfo(String str, String str2, TLRPC$WebDocument tLRPC$WebDocument, String str3, Object obj) {
        ...
        float f = 640;
        float m107dp = f / (((int) (min * 0.7f)) - AndroidUtilities.m107dp(2));
        int i = (int) (f / m107dp);
        int i2 = (int) (360 / m107dp);
