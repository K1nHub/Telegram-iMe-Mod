...
public class AccountSelectCell extends FrameLayout {
    ...
    public AccountSelectCell(Context context, boolean z) {
        ...
        avatarDrawable.setTextSize(AndroidUtilities.m104dp(12));
        ...
        if (z) {
            ...
            this.textView.setText(LocaleController.getString("VoipGroupDisplayAs", C3634R.string.VoipGroupDisplayAs));
            ...
            this.infoTextView.setMaxWidth(AndroidUtilities.m104dp(320));
        ...
        imageView.setImageResource(C3634R.C3636drawable.account_check);
    ...
    protected void onMeasure(int i, int i2) {
        if (this.checkImageView != null || (this.infoTextView != null && getLayoutParams().width != -2)) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(56), 1073741824));
        }
    }
