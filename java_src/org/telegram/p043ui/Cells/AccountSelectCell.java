...
public class AccountSelectCell extends FrameLayout {
    ...
    public AccountSelectCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            this.textView.setText(LocaleController.getString("VoipGroupDisplayAs", C3632R.string.VoipGroupDisplayAs));
            ...
            this.infoTextView.setMaxWidth(AndroidUtilities.m107dp(320));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.checkImageView != null || (this.infoTextView != null && getLayoutParams().width != -2)) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(56), 1073741824));
        }
    }
