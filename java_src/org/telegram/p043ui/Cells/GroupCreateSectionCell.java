...
public class GroupCreateSectionCell extends FrameLayout {
    ...
    public GroupCreateSectionCell(Context context) {
        ...
        Drawable drawable = getResources().getDrawable(C3634R.C3636drawable.shadowdown);
    ...
    protected void onDraw(Canvas canvas) {
        this.drawable.setBounds(0, getMeasuredHeight() - AndroidUtilities.m104dp(3), getMeasuredWidth(), getMeasuredHeight());
