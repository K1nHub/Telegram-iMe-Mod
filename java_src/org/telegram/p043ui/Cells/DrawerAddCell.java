...
public class DrawerAddCell extends FrameLayout {
    ...
    public DrawerAddCell(Context context) {
        ...
        this.textView.setCompoundDrawablePadding(AndroidUtilities.m104dp(29));
    ...
    protected void onAttachedToWindow() {
        ...
        this.textView.setText(LocaleController.getString("AddAccount", C3634R.string.AddAccount));
        Drawable drawable = getResources().getDrawable(C3634R.C3636drawable.msg_add);
        if (drawable != null) {
