...
public class MemberRequestCell extends FrameLayout {
    ...
    public MemberRequestCell(Context context, final OnClickListener onClickListener, boolean z) {
        ...
        int m107dp = AndroidUtilities.m107dp(17);
        ...
        textView.setPadding(m107dp, 0, m107dp, 0);
        if (z) {
        ...
        float measureText = textView.getPaint().measureText(textView.getText().toString()) + (m107dp * 2);
        TextView textView2 = new TextView(getContext());
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(4), 0, Theme.getColor(Theme.key_listSelector), -16777216));
        textView2.setGravity((LocaleController.isRTL ? 5 : 3) | 16);
        textView2.setMaxLines(1);
        textView2.setPadding(m107dp, 0, m107dp, 0);
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, AndroidUtilities.m107dp(32), LocaleController.isRTL ? 5 : 3);
        layoutParams.topMargin = AndroidUtilities.m107dp(62);
        layoutParams.leftMargin = LocaleController.isRTL ? 0 : (int) (AndroidUtilities.m107dp(79) + measureText);
        layoutParams.rightMargin = LocaleController.isRTL ? (int) (measureText + AndroidUtilities.m107dp(79)) : 0;
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(107), 1073741824));
    }
