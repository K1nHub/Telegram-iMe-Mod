...
public class CheckBoxCell extends FrameLayout {
    ...
    public CheckBoxCell(Context context, int i, int i2, Theme.ResourcesProvider resourcesProvider, AttributeSet attributeSet) {
        ...
        if (i == i3) {
            ...
            linksTextView.setPadding(AndroidUtilities.m104dp(16), 0, 0, 0);
        }
        if (i == 3) {
            linksTextView.setGravity(19);
            addView(linksTextView, LayoutHelper.createFrame(-1, -2, 19, 29, 0, 0, 0));
            linksTextView.setPadding(0, 0, 0, AndroidUtilities.m104dp(3));
        } else {
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (this.collapsedArrow == null) {
            ...
            Drawable mutate = getContext().getResources().getDrawable(C3634R.C3636drawable.arrow_more).mutate();
    ...
    public void updateCollapseArrowTranslation() {
        ...
        if (LocaleController.isRTL) {
            left = (this.textView.getRight() - f) - AndroidUtilities.m104dp(20);
        } else {
            left = this.textView.getLeft() + f + AndroidUtilities.m104dp(4);
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 == IdFabric$ViewTypes.TON_ADDRESS_VERSION) {
            ...
            this.textView.measure(View.MeasureSpec.makeMeasureSpec((measuredWidth - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m104dp(8), 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
            this.checkBox.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.checkBoxSize), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.checkBoxSize), 1073741824));
        } else if (i3 == 3) {
            this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(10), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(50), 1073741824));
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m104dp(34), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(50), Integer.MIN_VALUE));
            this.checkBox.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.checkBoxSize), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.checkBoxSize), 1073741824));
            setMeasuredDimension(this.textView.getMeasuredWidth() + AndroidUtilities.m104dp(29), AndroidUtilities.m104dp(50));
        } else if (this.isMultiline) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
        } else {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m104dp(50) + (this.needDivider ? 1 : 0));
            int measuredWidth2 = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m104dp(this.currentType == 4 ? 60 : 34);
            ...
            if (this.textView.getLayoutParams().width == -1) {
                LinkSpanDrawable.LinksTextView linksTextView = this.textView;
                linksTextView.measure(View.MeasureSpec.makeMeasureSpec(((measuredWidth2 - ((int) Math.abs(linksTextView.getTranslationX()))) - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m104dp(8), 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            } else {
                LinkSpanDrawable.LinksTextView linksTextView2 = this.textView;
                linksTextView2.measure(View.MeasureSpec.makeMeasureSpec(((measuredWidth2 - ((int) Math.abs(linksTextView2.getTranslationX()))) - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m104dp(8), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            }
            this.checkBox.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.checkBoxSize), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.checkBoxSize), 1073741824));
        }
        View view = this.click1Container;
        if (view != null) {
            ...
            this.click1Container.measure(View.MeasureSpec.makeMeasureSpec((size - marginLayoutParams.leftMargin) - marginLayoutParams.rightMargin, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(50), 1073741824));
        }
        View view2 = this.click2Container;
        if (view2 != null) {
            view2.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(56), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(50), 1073741824));
        }
        View view3 = this.collapsedArrow;
        if (view3 != null) {
            view3.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(16), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(16), 1073741824));
        }
    }
    ...
    public void setPad(int i) {
        int m104dp = AndroidUtilities.m104dp(i * 40 * (LocaleController.isRTL ? -1 : 1));
        View view = this.checkBox;
        if (view != null) {
            view.setTranslationX(m104dp);
        }
        float f = m104dp;
    ...
    public void setMultiline(boolean z) {
        ...
        if (this.isMultiline) {
            ...
            this.textView.setPadding(0, AndroidUtilities.m104dp(8), 0, AndroidUtilities.m104dp(8));
            if (this.currentType != 5) {
                layoutParams2.topMargin = AndroidUtilities.m104dp(10);
            }
        } else {
            ...
            layoutParams2.topMargin = AndroidUtilities.m104dp(15);
        }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            int m104dp = AndroidUtilities.m104dp(this.currentType == 4 ? 60 : 20) + ((int) Math.abs(this.textView.getTranslationX()));
            float f = LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : m104dp;
            float measuredHeight = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (!LocaleController.isRTL) {
                m104dp = 0;
            }
            canvas.drawLine(f, measuredHeight, measuredWidth - m104dp, getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
