...
public class ManageChatUserCell extends FrameLayout {
    ...
    public ManageChatUserCell(Context context, int i, int i2, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z) {
            ...
            this.optionsButton.setImageResource(C3473R.C3475drawable.ic_ab_other);
            ...
            this.optionsButton.setContentDescription(LocaleController.getString("AccDescrUserOptions", C3473R.string.AccDescrUserOptions));
        }
    }
