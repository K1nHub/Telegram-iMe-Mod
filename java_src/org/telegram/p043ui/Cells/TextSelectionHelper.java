...
public abstract class TextSelectionHelper<Cell extends SelectableView> {
    ...
    public void showMagnifier(int i) {
        ...
        int lineTop = (int) (((((layout.getLineTop(lineForOffset) + this.textY) + coordsInParent[1]) - lineBottom) - AndroidUtilities.m72dp(8)) + this.layoutBlock.yOffset);
            ...
            public void onGetContentRect(ActionMode actionMode, View view, Rect rect) {
                ...
                if (TextSelectionHelper.this.isInSelectionMode()) {
                    ...
                    if (textSelectionHelper.selectedView != null) {
                        ...
                        int m72dp = (((offsetToCord[1] + textSelectionHelper3.textY) + coordsInParent[1]) + ((-textSelectionHelper.getLineHeight()) / 2)) - AndroidUtilities.m72dp(4);
                        if (m72dp >= 1) {
                            i2 = m72dp;
                        }
                    } else {
