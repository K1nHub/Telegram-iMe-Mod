...
public class ArchivedStickerSetCell extends FrameLayout implements Checkable {
    ...
    public ArchivedStickerSetCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            progressButton2.setMinWidth(m104dp);
            progressButton2.setMinimumWidth(m104dp);
            ...
            progressButton2.setText(LocaleController.getString("StickersRemove", C3634R.string.StickersRemove));
        ...
        if (tLRPC$StickerSetCovered instanceof TLRPC$TL_stickerSetFullCovered) {
            ...
            while (true) {
                if (i < arrayList.size()) {
                    ...
                    if (tLRPC$Document2 != null && tLRPC$Document2.f1610id == j) {
