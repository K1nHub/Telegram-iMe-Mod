...
public class RadioColorCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        if (this.text2View.getVisibility() == 0) {
            this.text2View.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i) - AndroidUtilities.m107dp(72), 1073741824), i2);
        }
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(50) + (this.text2View.getVisibility() == 0 ? AndroidUtilities.m107dp(4) + this.text2View.getMeasuredHeight() : 0), 1073741824));
    }
