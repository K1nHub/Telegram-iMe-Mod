...
public class SharedDocumentCell extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public SharedDocumentCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.statusDrawable = new RLottieDrawable(C3473R.raw.download_arrow, "download_arrow", AndroidUtilities.m72dp(14), AndroidUtilities.m72dp(14), true, null);
    ...
    public void setTextAndValueAndTypeAndThumb(String str, String str2, String str3, String str4, int i, boolean z) {
        ...
        if (str4 != null || i != 0) {
            if (str4 != null) {
                ...
                CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m72dp(42), i);
                if (i == C3473R.C3475drawable.files_storage) {
                    i2 = Theme.key_chat_attachLocationBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C3473R.C3475drawable.files_gallery) {
                    i2 = Theme.key_chat_attachContactBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C3473R.C3475drawable.files_music) {
                    i2 = Theme.key_chat_attachAudioBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C3473R.C3475drawable.files_internal) {
    ...
    public void setDocument(MessageObject messageObject, boolean z) {
        ...
        if (document != null) {
            ...
            if (TextUtils.isEmpty(documentFileName) && (str = document.mime_type) != null) {
                documentFileName = str.startsWith("video") ? MessageObject.isGifDocument(document) ? LocaleController.getString("AttachGif", C3473R.string.AttachGif) : LocaleController.getString("AttachVideo", C3473R.string.AttachVideo) : document.mime_type.startsWith("image") ? MessageObject.isGifDocument(document) ? LocaleController.getString("AttachGif", C3473R.string.AttachGif) : LocaleController.getString("AttachPhoto", C3473R.string.AttachPhoto) : document.mime_type.startsWith("audio") ? LocaleController.getString("AttachAudio", C3473R.string.AttachAudio) : LocaleController.getString("AttachDocument", C3473R.string.AttachDocument);
            }
            if (str4 == null) {
    ...
    private void updateDateView() {
        ...
        this.dateTextView.setText(String.format("%s, %s", format, LocaleController.formatString("formatDateAtTime", C3473R.string.formatDateAtTime, LocaleController.getInstance().formatterYear.format(new Date(j)), LocaleController.getInstance().formatterDay.format(new Date(j)))));
    }
    ...
    public void updateFileExistIcon(boolean z) {
        ...
        if (messageObject != null && messageObject.messageOwner.media != null) {
            ...
            if (messageObject.attachPathExists || messageObject.mediaExists || !this.drawDownloadIcon) {
                ...
                if (layoutParams != null) {
                    layoutParams.leftMargin = AndroidUtilities.m72dp(LocaleController.isRTL ? 8 : 72);
                    layoutParams.rightMargin = AndroidUtilities.m72dp(LocaleController.isRTL ? 72 : 8);
            ...
            if (layoutParams2 != null) {
                layoutParams2.leftMargin = AndroidUtilities.m72dp(LocaleController.isRTL ? 8 : 86);
                layoutParams2.rightMargin = AndroidUtilities.m72dp(LocaleController.isRTL ? 86 : 8);
                this.dateTextView.requestLayout();
            }
            if (this.loading) {
        ...
        if (layoutParams3 != null) {
            layoutParams3.leftMargin = AndroidUtilities.m72dp(LocaleController.isRTL ? 8 : 72);
            layoutParams3.rightMargin = AndroidUtilities.m72dp(LocaleController.isRTL ? 72 : 8);
            this.dateTextView.requestLayout();
        }
        DownloadController.getInstance(this.currentAccount).removeLoadingFileObserver(this);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 == 1) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(56), 1073741824));
            int m72dp = AndroidUtilities.m72dp(34) + this.nameTextView.getMeasuredHeight() + (this.needDivider ? 1 : 0);
            if (this.caption != null && this.captionTextView != null && this.message.hasHighlightedWords()) {
                ...
                m72dp += this.captionTextView.getMeasuredHeight() + AndroidUtilities.m72dp(3);
            }
            setMeasuredDimension(getMeasuredWidth(), m72dp);
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.viewType != 1) {
            if (this.nameTextView.getLineCount() > 1 || ((textView = this.captionTextView) != null && textView.getVisibility() == 0)) {
                int measuredHeight = this.nameTextView.getMeasuredHeight() - AndroidUtilities.m72dp(22);
                TextView textView2 = this.captionTextView;
                if (textView2 != null && textView2.getVisibility() == 0) {
                    ...
                    measuredHeight += this.captionTextView.getMeasuredHeight() + AndroidUtilities.m72dp(3);
                }
