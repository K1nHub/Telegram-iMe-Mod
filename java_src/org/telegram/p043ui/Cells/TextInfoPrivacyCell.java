...
public class TextInfoPrivacyCell extends FrameLayout {
    ...
    public TextInfoPrivacyCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setPadding(0, AndroidUtilities.m104dp(10), 0, AndroidUtilities.m104dp(17));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.fixedSize != 0) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.fixedSize), 1073741824));
        } else {
    ...
    public void setText(CharSequence charSequence) {
        ...
        if (charSequence == null) {
            this.textView.setPadding(0, AndroidUtilities.m104dp(2), 0, 0);
        } else {
            this.textView.setPadding(0, AndroidUtilities.m104dp(this.topPadding), 0, AndroidUtilities.m104dp(this.bottomPadding));
        }
