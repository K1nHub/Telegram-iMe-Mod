...
public class TextRadioCell extends FrameLayout {
    ...
    public void updateRTL() {
        ...
        layoutParams.leftMargin = AndroidUtilities.m104dp(z3 ? this.padding : 64);
        layoutParams.rightMargin = AndroidUtilities.m104dp(LocaleController.isRTL ? 64 : this.padding);
        ...
        layoutParams2.leftMargin = AndroidUtilities.m104dp(z4 ? this.padding : 64);
        layoutParams2.rightMargin = AndroidUtilities.m104dp(LocaleController.isRTL ? 64 : this.padding);
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.valueTextView.getVisibility() == 0 ? 64 : this.height) + (this.needDivider ? 1 : 0), 1073741824));
        }
    }
    ...
    public void setTextAndValueAndCheck(String str, String str2, boolean z, boolean z2, boolean z3) {
        ...
        if (z2) {
            ...
            this.valueTextView.setPadding(0, 0, 0, AndroidUtilities.m104dp(11));
        } else {
            this.valueTextView.setLines(1);
            this.valueTextView.setMaxLines(1);
            this.valueTextView.setSingleLine(true);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.animatedColorBackground != 0) {
            canvas.drawCircle(this.lastTouchX, getMeasuredHeight() / 2, (Math.max(this.lastTouchX, getMeasuredWidth() - this.lastTouchX) + AndroidUtilities.m104dp(40)) * this.animationProgress, this.animationPaint);
        }
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m104dp(64), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m104dp(64) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
