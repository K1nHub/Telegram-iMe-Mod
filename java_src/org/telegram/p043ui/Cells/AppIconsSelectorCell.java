...
public class AppIconsSelectorCell extends RecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public AppIconsSelectorCell(final Context context, final BaseFragment baseFragment, int i) {
        ...
        setAdapter(new RecyclerView.Adapter() { // from class: org.telegram.ui.Cells.AppIconsSelectorCell.1
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
                ...
                iconHolderView.iconView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m105dp(18.0f), 0, Theme.getColor(Theme.key_listSelector), -16777216));
        ...
        addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Cells.AppIconsSelectorCell.2
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (adapterPosition == 0) {
                    rect.left = AndroidUtilities.m104dp(18);
                }
                if (adapterPosition == AppIconsSelectorCell.this.getAdapter().getItemCount() - 1) {
                    rect.right = AndroidUtilities.m104dp(18);
                    return;
                }
                int itemCount = AppIconsSelectorCell.this.getAdapter().getItemCount();
                if (itemCount == 4) {
                    rect.right = ((AppIconsSelectorCell.this.getWidth() - AndroidUtilities.m104dp(36)) - (AndroidUtilities.m104dp(58) * itemCount)) / (itemCount - 1);
                } else {
                    rect.right = AndroidUtilities.m104dp(24);
                }
            }
        });
        ...
        if (launcherIcon.premium && !UserConfig.hasPremiumOnAccounts()) {
            ...
            LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(this, context) { // from class: org.telegram.ui.Cells.AppIconsSelectorCell.3
                ...
                public int calculateDtToFit(int i2, int i3, int i4, int i5, int i6) {
                    return (i4 - i2) + AndroidUtilities.m104dp(16);
                }
    ...
    private void updateIconsVisibility() {
        ...
        if (ApplicationLoader.isStandaloneBuild()) {
            Collections.swap(this.availableIcons, this.availableIcons.indexOf(LauncherIconController.LauncherIcon.DEFAULT), this.availableIcons.indexOf(LauncherIconController.LauncherIcon.ROCKET));
        }
        getAdapter().notifyDataSetChanged();
        invalidateItemDecorations();
        for (int i2 = 0; i2 < this.availableIcons.size(); i2++) {
            if (LauncherIconController.isEnabled(this.availableIcons.get(i2))) {
                this.linearLayoutManager.scrollToPositionWithOffset(i2, AndroidUtilities.m104dp(16));
                return;
            }
        }
    }
    ...
    public static final class IconHolderView extends LinearLayout {
        ...
        private IconHolderView(Context context) {
            ...
            adaptiveIconImageView.setPadding(AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8), AndroidUtilities.m104dp(8));
            ...
            this.outlinePaint.setStrokeWidth(Math.max(2, AndroidUtilities.m105dp(0.5f)));
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m105dp(18.0f), AndroidUtilities.m105dp(18.0f), this.fillPaint);
            super.draw(canvas);
            canvas.drawRoundRect(rectF, AndroidUtilities.m105dp(18.0f), AndroidUtilities.m105dp(18.0f), this.outlinePaint);
        }
        ...
        private void setProgress(float f) {
            ...
            this.outlinePaint.setStrokeWidth(Math.max(2, AndroidUtilities.m105dp(AndroidUtilities.lerp(0.5f, 2.0f, f))));
            invalidate();
        }
        ...
        public void bind(LauncherIconController.LauncherIcon launcherIcon) {
            ...
            if (launcherIcon.premium && !UserConfig.hasPremiumOnAccounts()) {
                ...
                coloredImageSpan.setSize(AndroidUtilities.m104dp(13));
                spannableString.setSpan(coloredImageSpan, 0, 1, 33);
                marginLayoutParams.rightMargin = AndroidUtilities.m104dp(4);
    ...
    public static class AdaptiveIconImageView extends ImageView {
        ...
        public AdaptiveIconImageView(Context context) {
            super(context);
            this.path = new Path();
            this.outerPadding = AndroidUtilities.m104dp(5);
            this.backgroundOuterPadding = AndroidUtilities.m104dp(42);
        }
