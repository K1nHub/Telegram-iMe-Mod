...
public class StickerCell extends FrameLayout {
    ...
    public MessageObject.SendAnimationData getSendAnimationData() {
        ...
        if (imageReceiver.hasNotThumb()) {
            ...
            sendAnimationData.f1457x = imageReceiver.getCenterX() + iArr[0];
            sendAnimationData.f1458y = imageReceiver.getCenterY() + iArr[1];
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (str != null) {
            accessibilityNodeInfo.setText(str + " " + LocaleController.getString("AttachSticker", C3473R.string.AttachSticker));
        } else {
            accessibilityNodeInfo.setText(LocaleController.getString("AttachSticker", C3473R.string.AttachSticker));
        }
