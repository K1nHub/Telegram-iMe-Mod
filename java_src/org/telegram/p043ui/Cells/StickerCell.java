...
public class StickerCell extends FrameLayout {
    ...
    public StickerCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumLockIconView.setPadding(AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(76) + getPaddingLeft() + getPaddingRight(), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(78), 1073741824));
    }
    ...
    private void updatePremiumStatus(boolean z) {
        ...
        if (!UserConfig.getInstance(UserConfig.selectedAccount).isPremium()) {
            ...
            this.premiumIconView.setPadding(AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(4));
        } else {
            int m107dp2 = AndroidUtilities.m107dp(16);
            layoutParams.width = m107dp2;
            layoutParams.height = m107dp2;
            layoutParams.gravity = 85;
            layoutParams.bottomMargin = AndroidUtilities.m107dp(8);
            layoutParams.rightMargin = AndroidUtilities.m107dp(8);
            this.premiumIconView.setPadding(AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1), AndroidUtilities.m107dp(1));
        }
