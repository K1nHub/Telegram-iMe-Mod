...
public class StickerCell extends FrameLayout {
    ...
    public StickerCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumLockIconView.setPadding(AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(76) + getPaddingLeft() + getPaddingRight(), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(78), 1073741824));
    }
    ...
    public MessageObject.SendAnimationData getSendAnimationData() {
        ...
        if (imageReceiver.hasNotThumb()) {
            ...
            sendAnimationData.f1536x = imageReceiver.getCenterX() + iArr[0];
            sendAnimationData.f1537y = imageReceiver.getCenterY() + iArr[1];
    ...
    private void updatePremiumStatus(boolean z) {
        ...
        if (!UserConfig.getInstance(UserConfig.selectedAccount).isPremium()) {
            ...
            this.premiumIconView.setPadding(AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4), AndroidUtilities.m104dp(4));
        } else {
            int m104dp2 = AndroidUtilities.m104dp(16);
            layoutParams.width = m104dp2;
            layoutParams.height = m104dp2;
            layoutParams.gravity = 85;
            layoutParams.bottomMargin = AndroidUtilities.m104dp(8);
            layoutParams.rightMargin = AndroidUtilities.m104dp(8);
            this.premiumIconView.setPadding(AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(1), AndroidUtilities.m104dp(1));
        }
