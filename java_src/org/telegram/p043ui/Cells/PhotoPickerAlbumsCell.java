...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    private class AlbumView extends FrameLayout {
        ...
        public AlbumView(Context context) {
            ...
            linearLayout.setBackgroundResource(C3634R.C3636drawable.album_shadow);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (AndroidUtilities.isTablet()) {
            m104dp = ((AndroidUtilities.m104dp(490) - AndroidUtilities.m104dp(12)) - ((this.albumsCount - 1) * AndroidUtilities.m104dp(4))) / this.albumsCount;
        } else {
            m104dp = ((AndroidUtilities.displaySize.x - AndroidUtilities.m104dp(12)) - ((this.albumsCount - 1) * AndroidUtilities.m104dp(4))) / this.albumsCount;
        }
        for (int i3 = 0; i3 < this.albumsCount; i3++) {
            ...
            layoutParams.topMargin = AndroidUtilities.m104dp(4);
            layoutParams.leftMargin = (AndroidUtilities.m104dp(4) + m104dp) * i3;
            layoutParams.width = m104dp;
            layoutParams.height = m104dp;
            layoutParams.gravity = 51;
            this.albumViews[i3].setLayoutParams(layoutParams);
        }
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(4) + m104dp, 1073741824));
    }
}
