...
public class BotHelpCell extends View {
    ...
    public BotHelpCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.imagePadding = AndroidUtilities.m104dp(4);
    ...
    public void setText(boolean z, String str, TLObject tLObject, TLRPC$BotInfo tLRPC$BotInfo) {
        ...
        if (z2) {
            ...
            if (!Objects.equals(this.currentPhotoKey, keyForParentObject)) {
                ...
                int m104dp = AndroidUtilities.m104dp(SharedConfig.bubbleRadius) - AndroidUtilities.m104dp(2);
                int m104dp2 = AndroidUtilities.m104dp(4);
                if (!this.isTextVisible) {
                    m104dp2 = m104dp;
                }
                this.imageReceiver.setRoundRadius(m104dp, m104dp, m104dp2, m104dp2);
            }
        }
        ...
        if (this.isTextVisible) {
            ...
            String string = LocaleController.getString(C3634R.string.BotInfoTitle);
            if (z) {
            ...
            Emoji.replaceEmoji((CharSequence) spannableStringBuilder, Theme.chat_msgTextPaint.getFontMetricsInt(), AndroidUtilities.m104dp(20), false);
            try {
                StaticLayout staticLayout = new StaticLayout(spannableStringBuilder, Theme.chat_msgTextPaint, i - (this.isPhotoVisible ? AndroidUtilities.m104dp(5) : 0), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                this.textLayout = staticLayout;
                this.width = 0;
                this.height = staticLayout.getHeight() + AndroidUtilities.m104dp(22);
        ...
        int m104dp3 = this.width + AndroidUtilities.m104dp(22);
        this.width = m104dp3;
        if (this.isPhotoVisible) {
            int i4 = this.height;
            int i5 = (int) (m104dp3 * 0.5625d);
            this.photoHeight = i5;
            this.height = i4 + i5 + AndroidUtilities.m104dp(4);
        }
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.Cells.BotHelpCell.onTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), this.height + AndroidUtilities.m104dp(8));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m104dp = this.photoHeight + AndroidUtilities.m104dp(2);
        Drawable shadowDrawable = Theme.chat_msgInMediaDrawable.getShadowDrawable();
        if (shadowDrawable != null) {
            shadowDrawable.setBounds(width, m104dp, this.width + width, this.height + m104dp);
        ...
        if (drawable != null) {
            ...
            this.selectorDrawable.setBounds(AndroidUtilities.m104dp(2) + width, AndroidUtilities.m104dp(2), (this.width + width) - AndroidUtilities.m104dp(2), this.height - AndroidUtilities.m104dp(2));
        ...
        canvas.save();
        int m104dp2 = AndroidUtilities.m104dp(this.isPhotoVisible ? 14 : 11) + width;
        this.textX = m104dp2;
        float f = m104dp2;
        int m104dp3 = AndroidUtilities.m104dp(11) + m104dp;
        this.textY = m104dp3;
        canvas.translate(f, m104dp3);
