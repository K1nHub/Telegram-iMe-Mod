...
public class BotHelpCell extends View {
    ...
    public BotHelpCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.imagePadding = AndroidUtilities.m107dp(4);
    ...
    public void setText(boolean z, String str, TLObject tLObject, TLRPC$BotInfo tLRPC$BotInfo) {
        ...
        if (z2) {
            ...
            if (!Objects.equals(this.currentPhotoKey, keyForParentObject)) {
                ...
                int m107dp = AndroidUtilities.m107dp(SharedConfig.bubbleRadius) - AndroidUtilities.m107dp(2);
                int m107dp2 = AndroidUtilities.m107dp(4);
                if (!this.isTextVisible) {
                    m107dp2 = m107dp;
                }
                this.imageReceiver.setRoundRadius(m107dp, m107dp, m107dp2, m107dp2);
            }
        }
        ...
        if (this.isTextVisible) {
            ...
            String string = LocaleController.getString(C3632R.string.BotInfoTitle);
            if (z) {
            ...
            Emoji.replaceEmoji((CharSequence) spannableStringBuilder, Theme.chat_msgTextPaint.getFontMetricsInt(), AndroidUtilities.m107dp(20), false);
            try {
                StaticLayout staticLayout = new StaticLayout(spannableStringBuilder, Theme.chat_msgTextPaint, i - (this.isPhotoVisible ? AndroidUtilities.m107dp(5) : 0), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
                this.textLayout = staticLayout;
                this.width = 0;
                this.height = staticLayout.getHeight() + AndroidUtilities.m107dp(22);
        ...
        int m107dp3 = this.width + AndroidUtilities.m107dp(22);
        this.width = m107dp3;
        if (this.isPhotoVisible) {
            int i4 = this.height;
            int i5 = (int) (m107dp3 * 0.5625d);
            this.photoHeight = i5;
            this.height = i4 + i5 + AndroidUtilities.m107dp(4);
        }
    }
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), this.height + AndroidUtilities.m107dp(8));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int m107dp = this.photoHeight + AndroidUtilities.m107dp(2);
        Drawable shadowDrawable = Theme.chat_msgInMediaDrawable.getShadowDrawable();
        if (shadowDrawable != null) {
            shadowDrawable.setBounds(width, m107dp, this.width + width, this.height + m107dp);
        ...
        if (drawable != null) {
            ...
            this.selectorDrawable.setBounds(AndroidUtilities.m107dp(2) + width, AndroidUtilities.m107dp(2), (this.width + width) - AndroidUtilities.m107dp(2), this.height - AndroidUtilities.m107dp(2));
        ...
        canvas.save();
        int m107dp2 = AndroidUtilities.m107dp(this.isPhotoVisible ? 14 : 11) + width;
        this.textX = m107dp2;
        float f = m107dp2;
        int m107dp3 = AndroidUtilities.m107dp(11) + m107dp;
        this.textY = m107dp3;
        canvas.translate(f, m107dp3);
