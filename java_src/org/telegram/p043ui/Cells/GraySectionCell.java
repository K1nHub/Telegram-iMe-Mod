...
public class GraySectionCell extends FrameLayout {
    ...
    public GraySectionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextView.setPadding(AndroidUtilities.m107dp(2), 0, AndroidUtilities.m107dp(2), 0);
        this.rightTextView.setAnimationProperties(1.0f, 0L, 400L, CubicBezierInterpolator.EASE_OUT_QUINT);
        this.rightTextView.setTextSize(AndroidUtilities.m107dp(14));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(this.layerHeight), 1073741824));
    }
