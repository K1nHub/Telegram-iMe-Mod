...
public class FeaturedStickerSetCell2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FeaturedStickerSetCell2(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        try {
            ...
            ((ViewGroup.MarginLayoutParams) premiumButtonView.getTextView().getLayoutParams()).leftMargin = AndroidUtilities.m107dp(3);
            premiumButtonView.getChildAt(0).setPadding(AndroidUtilities.m107dp(8), 0, AndroidUtilities.m107dp(8), 0);
        ...
        if (z2) {
            Drawable drawable = new Drawable(this) { // from class: org.telegram.ui.Cells.FeaturedStickerSetCell2.1
                ...
                public void draw(Canvas canvas) {
                    ...
                    canvas.drawCircle(AndroidUtilities.m107dp(4), AndroidUtilities.m107dp(5), AndroidUtilities.m107dp(3), this.paint);
                }
                ...
                public int getIntrinsicHeight() {
                    return AndroidUtilities.m107dp(8);
                }
            };
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m107dp(71), getHeight() - 1, getWidth() - (LocaleController.isRTL ? AndroidUtilities.m107dp(71) : 0), getHeight() - 1, Theme.dividerPaint);
        }
    }
