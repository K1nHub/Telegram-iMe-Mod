...
public class FeaturedStickerSetCell2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FeaturedStickerSetCell2(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView3.setText(LocaleController.getString("StickersRemove", C3632R.string.StickersRemove));
        ...
        premiumButtonView.setButton(LocaleController.getString("Unlock", C3632R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.FeaturedStickerSetCell2$$ExternalSyntheticLambda0
