...
public class StickerSetGroupInfoCell extends LinearLayout {
    ...
    public StickerSetGroupInfoCell(Context context) {
        ...
        textView.setText(LocaleController.getString("GroupStickersInfo", C3558R.string.GroupStickersInfo));
        ...
        this.addButton.setText(LocaleController.getString("ChooseStickerSet", C3558R.string.ChooseStickerSet).toUpperCase());
