...
public class DrawerActionCell extends FrameLayout {
    ...
    private void toggleRectIcon() {
        boolean z = this.wasRectIconType;
        boolean z2 = this.isRectIconType;
        if (z != z2) {
            this.wasRectIconType = z2;
            removeAllViews();
            ImageView imageView = this.imageView;
            boolean z3 = LocaleController.isRTL;
            addView(imageView, LayoutHelper.createFrame(24, 24, (z3 ? 5 : 3) | 48, z3 ? 0 : 19, 12, z3 ? 19 : 0, 0));
            TextView textView = this.textView;
            boolean z4 = LocaleController.isRTL;
            addView(textView, LayoutHelper.createFrame(-1, -1, (z4 ? 5 : 3) | 48, z4 ? 16 : 72, 0, z4 ? 72 : 16, 0));
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.currentId == 8) {
            ...
            if (set.contains("VALIDATE_PHONE_NUMBER") || set.contains("VALIDATE_PASSWORD")) {
                ...
                this.rect.set(((getMeasuredWidth() - AndroidUtilities.m72dp(9)) - AndroidUtilities.m72dp(25)) - AndroidUtilities.m73dp(5.5f), m73dp, measuredWidth + m72dp + AndroidUtilities.m72dp(14), m73dp + AndroidUtilities.m72dp(23));
