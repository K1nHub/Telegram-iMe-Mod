...
public class DrawerActionCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.isRectIconType) {
            ...
            this.rect.set(x - m107dp2, y - m107dp2, x + m107dp2, y + m107dp2);
        ...
        if (this.currentId == 8) {
            ...
            if (set.contains("VALIDATE_PHONE_NUMBER") || set.contains("VALIDATE_PASSWORD")) {
                int m108dp = AndroidUtilities.m108dp(12.5f);
                this.rect.set(((getMeasuredWidth() - AndroidUtilities.m107dp(9)) - AndroidUtilities.m107dp(25)) - AndroidUtilities.m108dp(5.5f), m108dp, measuredWidth + m107dp + AndroidUtilities.m107dp(14), m108dp + AndroidUtilities.m107dp(23));
