...
public class ChatUnreadCell extends FrameLayout {
    ...
    public ChatUnreadCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.setBackgroundResource(C3417R.C3419drawable.newmsg_divider);
        ...
        imageView.setImageResource(C3417R.C3419drawable.ic_ab_new);
        ...
        textView.setPadding(0, 0, 0, AndroidUtilities.m54dp(1));
