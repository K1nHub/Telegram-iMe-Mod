...
public class ChatUnreadCell extends FrameLayout {
    ...
    public ChatUnreadCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.setBackgroundResource(C3632R.C3634drawable.newmsg_divider);
        ...
        imageView.setImageResource(C3632R.C3634drawable.ic_ab_new);
        ...
        this.imageView.setPadding(0, AndroidUtilities.m104dp(2), 0, 0);
        this.backgroundLayout.addView(this.imageView, LayoutHelper.createFrame(-2, -2, 21, 0, 0, 10, 0));
        TextView textView = new TextView(context);
        this.textView = textView;
        textView.setPadding(0, 0, 0, AndroidUtilities.m104dp(1));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(40), 1073741824));
    }
