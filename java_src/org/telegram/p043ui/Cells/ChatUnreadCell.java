...
public class ChatUnreadCell extends FrameLayout {
    ...
    public ChatUnreadCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setPadding(0, 0, 0, AndroidUtilities.m107dp(1));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(40), 1073741824));
    }
