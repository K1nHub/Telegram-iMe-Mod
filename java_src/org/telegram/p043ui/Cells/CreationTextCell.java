...
public class CreationTextCell extends FrameLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (LocaleController.isRTL) {
            m104dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m104dp(this.imageView.getVisibility() == 0 ? this.startPadding : 25);
        } else {
            m104dp = AndroidUtilities.m104dp(this.imageView.getVisibility() == 0 ? this.startPadding : 25);
        }
        ...
        int m104dp2 = !LocaleController.isRTL ? (AndroidUtilities.m104dp(this.startPadding) - this.imageView.getMeasuredWidth()) / 2 : (i5 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m104dp(25);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.divider) {
            canvas.drawLine(AndroidUtilities.m104dp(this.startPadding), getMeasuredHeight() - 1, getMeasuredWidth() + AndroidUtilities.m104dp(23), getMeasuredHeight(), Theme.dividerPaint);
        }
    }
