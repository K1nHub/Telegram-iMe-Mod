...
public class CreationTextCell extends FrameLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (LocaleController.isRTL) {
            m107dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m107dp(this.imageView.getVisibility() == 0 ? this.startPadding : 25);
        } else {
            m107dp = AndroidUtilities.m107dp(this.imageView.getVisibility() == 0 ? this.startPadding : 25);
        }
        ...
        int m107dp2 = !LocaleController.isRTL ? (AndroidUtilities.m107dp(this.startPadding) - this.imageView.getMeasuredWidth()) / 2 : (i5 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m107dp(25);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.divider) {
            canvas.drawLine(AndroidUtilities.m107dp(this.startPadding), getMeasuredHeight() - 1, getMeasuredWidth() + AndroidUtilities.m107dp(23), getMeasuredHeight(), Theme.dividerPaint);
        }
    }
