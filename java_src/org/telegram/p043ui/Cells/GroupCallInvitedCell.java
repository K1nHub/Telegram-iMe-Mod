...
public class GroupCallInvitedCell extends FrameLayout {
    ...
    public GroupCallInvitedCell(Context context) {
        ...
        this.muteButton.setPadding(0, 0, AndroidUtilities.m107dp(4), 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m107dp(68), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m107dp(68) : 0), getMeasuredHeight() - 1, this.dividerPaint);
        }
