        ...
        if (strArr != null) {
            ...
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (i2 != 0) {
                    ...
                    Drawable mutate = getContext().getResources().getDrawable(C3558R.C3560drawable.settings_arrow).mutate();
            ...
            if (strArr != null) {
                ...
                for (int i2 = 0; i2 < strArr.length; i2++) {
                    if (i2 != 0) {
                        ...
                        Drawable mutate2 = getContext().getResources().getDrawable(C3558R.C3560drawable.settings_arrow).mutate();
