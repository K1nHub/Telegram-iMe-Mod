...
public class SettingsSearchCell extends FrameLayout {
    ...
    public void setTextAndValueAndIcon(CharSequence charSequence, String[] strArr, int i, boolean z) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m104dp(LocaleController.isRTL ? 16 : 71);
        layoutParams.rightMargin = AndroidUtilities.m104dp(LocaleController.isRTL ? 71 : 16);
        if (strArr != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (i2 != 0) {
                    spannableStringBuilder.append((CharSequence) " > ");
                    Drawable mutate = getContext().getResources().getDrawable(C3634R.C3636drawable.settings_arrow).mutate();
            ...
            layoutParams.topMargin = AndroidUtilities.m104dp(10);
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.valueTextView.getLayoutParams();
            layoutParams2.leftMargin = AndroidUtilities.m104dp(LocaleController.isRTL ? 16 : 71);
            layoutParams2.rightMargin = AndroidUtilities.m104dp(LocaleController.isRTL ? 71 : 16);
        } else {
            layoutParams.topMargin = AndroidUtilities.m104dp(21);
    ...
    public void setTextAndValue(CharSequence charSequence, String[] strArr, boolean z, boolean z2) {
            ...
            if (strArr != null) {
                ...
                for (int i2 = 0; i2 < strArr.length; i2++) {
                    if (i2 != 0) {
                        ...
                        Drawable mutate2 = getContext().getResources().getDrawable(C3634R.C3636drawable.settings_arrow).mutate();
        ...
        layoutParams2.rightMargin = m104dp2;
        layoutParams2.leftMargin = m104dp2;
        this.imageView.setVisibility(8);
        this.needDivider = z2;
        setWillNotDraw(!z2);
        this.left = 16;
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m104dp(this.left), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m104dp(this.left) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
}
