...
public class FeaturedStickerSetInfoCell extends FrameLayout {
    ...
    public FeaturedStickerSetInfoCell(Context context, int i, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z2) {
            ...
            this.delButton.setText(LocaleController.getString("StickersRemove", C3634R.string.StickersRemove));
            if (z) {
        ...
        if (z || this.unreadProgress != BitmapDescriptorFactory.HUE_RED) {
            if (z) {
                ...
                if (f != 1.0f) {
                    ...
                    canvas.drawCircle(this.nameTextView.getRight() + AndroidUtilities.m104dp(12), AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(4) * this.unreadProgress, this.paint);
                }
            }
            if (!z) {
