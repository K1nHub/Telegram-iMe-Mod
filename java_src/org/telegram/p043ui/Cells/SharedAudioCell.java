...
public class SharedAudioCell extends FrameLayout implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public /* synthetic */ void lambda$onSubItemClick$2(Uri uri) {
        BulletinFactory.m66of(this, null).createDownloadBulletin(BulletinFactory.FileType.AUDIO).show();
    }
    ...
    public SharedAudioCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        this.titleY = AndroidUtilities.m107dp(9);
        this.descriptionY = AndroidUtilities.m107dp(29);
        this.captionY = AndroidUtilities.m107dp(29);
        ...
        textPaint2.setTextSize(AndroidUtilities.m107dp(13));
        if (resourcesProvider != null) {
            ...
            this.titlePaint.setTextSize(AndroidUtilities.m107dp(15));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m107dp(AndroidUtilities.leftBaseline)) - AndroidUtilities.m107dp(28);
        if (this.optionsButton != null) {
            size -= AndroidUtilities.m107dp(48);
        }
        int i4 = size;
        if (this.viewType == 1) {
            ...
            this.dateLayoutX = ((i4 - ceil) - AndroidUtilities.m107dp(8)) + AndroidUtilities.m107dp(20);
            i3 = ceil + AndroidUtilities.m107dp(12);
        } else {
            i3 = 0;
        }
        float f = BitmapDescriptorFactory.HUE_RED;
        try {
            ...
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(replace, textPaint, i4 - i3, TextUtils.TruncateAt.END), textPaint, (AndroidUtilities.m107dp(4) + i4) - i3, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        try {
            if (this.viewType == 1 && (this.currentMessageObject.isVoice() || this.currentMessageObject.isRoundVideo())) {
                ...
                this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(formatDuration, textPaint2, i4, TextUtils.TruncateAt.END), textPaint2, i4 + AndroidUtilities.m107dp(4), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            } else {
                ...
                this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(spannableStringBuilder, textPaint3, i4, TextUtils.TruncateAt.END), textPaint3, i4 + AndroidUtilities.m107dp(4), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            }
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(56) + (this.captionLayout != null ? AndroidUtilities.m107dp(18) : 0) + (this.needDivider ? 1 : 0));
        int size2 = LocaleController.isRTL ? (View.MeasureSpec.getSize(i) - AndroidUtilities.m107dp(8)) - AndroidUtilities.m107dp(52) : AndroidUtilities.m107dp(8);
        RadialProgress2 radialProgress2 = this.radialProgress;
        int m107dp = AndroidUtilities.m107dp(4) + size2;
        this.buttonX = m107dp;
        int m107dp2 = AndroidUtilities.m107dp(6);
        this.buttonY = m107dp2;
        radialProgress2.setProgressRect(m107dp, m107dp2, size2 + AndroidUtilities.m107dp(48), AndroidUtilities.m107dp(50));
        ...
        if (this.captionLayout != null) {
            this.captionY = AndroidUtilities.m107dp(29);
            this.descriptionY = AndroidUtilities.m107dp(29) + AndroidUtilities.m107dp(18);
            return;
        }
        this.descriptionY = AndroidUtilities.m107dp(29);
    }
    ...
    */
    ...
    private void drawInternal(Canvas canvas) {
        ...
        if (this.dateLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m107dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? 0 : this.dateLayoutX), this.titleY);
        ...
        if (this.titleLayout != null) {
            ...
            canvas.save();
            int m107dp = AndroidUtilities.m107dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline);
            if (!LocaleController.isRTL || (staticLayout = this.dateLayout) == null) {
                i = 0;
            } else {
                i = staticLayout.getWidth() + AndroidUtilities.m107dp(LocaleController.isRTL ? 12 : 4);
            }
            canvas.translate(((m107dp + i) + (LocaleController.isRTL ? this.titleLayout.getWidth() - this.titleLayoutWidth : 0.0f)) - this.titleLayoutLeft, this.titleY);
        ...
        if (this.captionLayout != null) {
            ...
            canvas.save();
            canvas.translate((AndroidUtilities.m107dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? this.captionLayout.getWidth() - this.captionLayoutWidth : 0.0f)) - this.captionLayoutLeft, this.captionY);
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            canvas.translate((AndroidUtilities.m107dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? this.descriptionLayout.getWidth() - this.descriptionLayoutWidth : 0.0f)) - this.descriptionLayoutLeft, this.descriptionY);
            if (this.isInPlaylist) {
                this.isInPlaylistMarkDrawable.setBounds(0, 0, AndroidUtilities.m107dp(16), AndroidUtilities.m107dp(16));
                ...
                canvas.translate(AndroidUtilities.m107dp(20), BitmapDescriptorFactory.HUE_RED);
            }
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                canvas.drawLine(BitmapDescriptorFactory.HUE_RED, getHeight() - 1, (getWidth() - AndroidUtilities.m107dp(72)) - getPaddingRight(), getHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            } else {
