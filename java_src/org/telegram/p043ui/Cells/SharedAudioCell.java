...
public class SharedAudioCell extends FrameLayout implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    private boolean isChatNoForwards;
    ...
    */
    ...
    public /* synthetic */ void lambda$onSubItemClick$0(BaseFragment baseFragment, long j) {
        UndoView undoView;
    ...
    public /* synthetic */ boolean lambda$onSubItemClick$1(ArrayList arrayList, LaunchActivity launchActivity, DialogsActivity dialogsActivity, ArrayList arrayList2, CharSequence charSequence, boolean z, TopicsFragment topicsFragment, Callbacks$Callback1 callbacks$Callback1) {
        ...
        List<BaseFragment> fragmentStack = launchActivity.getActionBarLayout().getFragmentStack();
        if (fragmentStack.size() > 2) {
            BaseFragment baseFragment = fragmentStack.get(fragmentStack.size() - 2);
            if ((baseFragment instanceof MediaActivity) && (undoView = ((MediaActivity) baseFragment).getUndoView()) != null) {
    ...
    public /* synthetic */ void lambda$onSubItemClick$2(Uri uri) {
        BulletinFactory.m63of(this, null).createDownloadBulletin(BulletinFactory.FileType.AUDIO).show();
    }
    ...
    public SharedAudioCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        this.titleY = AndroidUtilities.m104dp(9);
        this.descriptionY = AndroidUtilities.m104dp(29);
        this.captionY = AndroidUtilities.m104dp(29);
        ...
        if (i == IdFabric$CustomType.SHARED_AUDIO_CELL_MUSIC) {
            ...
            this.optionsButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Cells.SharedAudioCell$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    SharedAudioCell.this.lambda$new$9(view);
                }
            });
        ...
        if (resourcesProvider != null) {
            ...
            this.titlePaint.setTextSize(AndroidUtilities.m104dp(15));
    ...
    public /* synthetic */ void lambda$new$3() {
        onSubItemClick(IdFabric$Menu.TOGGLE_MUSIC_PLAYLIST);
    }
    ...
    public /* synthetic */ void lambda$new$5() {
        onSubItemClick(IdFabric$Menu.MESSAGE_SAVE_CLOUD);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m104dp(AndroidUtilities.leftBaseline)) - AndroidUtilities.m104dp(28);
        if (this.optionsButton != null) {
            size -= AndroidUtilities.m104dp(48);
        }
        int i4 = size;
        if (this.viewType == 1) {
            ...
            this.dateLayoutX = ((i4 - ceil) - AndroidUtilities.m104dp(8)) + AndroidUtilities.m104dp(20);
            i3 = ceil + AndroidUtilities.m104dp(12);
        } else {
            i3 = 0;
        }
        float f = BitmapDescriptorFactory.HUE_RED;
        try {
            ...
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(replace, textPaint, i4 - i3, TextUtils.TruncateAt.END), textPaint, (AndroidUtilities.m104dp(4) + i4) - i3, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        try {
            if (this.viewType == 1 && (this.currentMessageObject.isVoice() || this.currentMessageObject.isRoundVideo())) {
                ...
                this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(formatDuration, textPaint2, i4, TextUtils.TruncateAt.END), textPaint2, i4 + AndroidUtilities.m104dp(4), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            } else {
                ...
                this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(spannableStringBuilder, textPaint3, i4, TextUtils.TruncateAt.END), textPaint3, i4 + AndroidUtilities.m104dp(4), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            }
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m104dp(56) + (this.captionLayout != null ? AndroidUtilities.m104dp(18) : 0) + (this.needDivider ? 1 : 0));
        int size2 = LocaleController.isRTL ? (View.MeasureSpec.getSize(i) - AndroidUtilities.m104dp(8)) - AndroidUtilities.m104dp(52) : AndroidUtilities.m104dp(8);
        RadialProgress2 radialProgress2 = this.radialProgress;
        int m104dp = AndroidUtilities.m104dp(4) + size2;
        this.buttonX = m104dp;
        int m104dp2 = AndroidUtilities.m104dp(6);
        this.buttonY = m104dp2;
        radialProgress2.setProgressRect(m104dp, m104dp2, size2 + AndroidUtilities.m104dp(48), AndroidUtilities.m104dp(50));
        ...
        if (this.captionLayout != null) {
            this.captionY = AndroidUtilities.m104dp(29);
            this.descriptionY = AndroidUtilities.m104dp(29) + AndroidUtilities.m104dp(18);
            return;
        }
        this.descriptionY = AndroidUtilities.m104dp(29);
    }
    ...
    public void setMessageObject(MessageObject messageObject, boolean z) {
        ...
        this.isChatNoForwards = MessagesController.getInstance(this.currentAccount).isChatNoForwards(messageObject.getChatId());
    ...
    */
        ...
        if (z || this.showReorderIconProgress != BitmapDescriptorFactory.HUE_RED) {
            if (z) {
                ...
                if (f != 1.0f) {
                    ...
                    int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m104dp(12)) - Theme.dialogs_reorderDrawable.getIntrinsicWidth();
            ...
            this.showReorderIconProgress = Utilities.clamp(this.showReorderIconProgress, 1.0f, (float) BitmapDescriptorFactory.HUE_RED);
            int measuredWidth2 = (getMeasuredWidth() - AndroidUtilities.m104dp(12)) - Theme.dialogs_reorderDrawable.getIntrinsicWidth();
    ...
    private void drawInternal(Canvas canvas) {
        ...
        if (this.dateLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m104dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? 0 : this.dateLayoutX), this.titleY);
        ...
        if (this.titleLayout != null) {
            ...
            canvas.save();
            int m104dp = AndroidUtilities.m104dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline);
            if (!LocaleController.isRTL || (staticLayout = this.dateLayout) == null) {
                i = 0;
            } else {
                i = staticLayout.getWidth() + AndroidUtilities.m104dp(LocaleController.isRTL ? 12 : 4);
            }
            canvas.translate(((m104dp + i) + (LocaleController.isRTL ? this.titleLayout.getWidth() - this.titleLayoutWidth : 0.0f)) - this.titleLayoutLeft, this.titleY);
        ...
        if (this.captionLayout != null) {
            ...
            canvas.save();
            canvas.translate((AndroidUtilities.m104dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? this.captionLayout.getWidth() - this.captionLayoutWidth : 0.0f)) - this.captionLayoutLeft, this.captionY);
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            canvas.translate((AndroidUtilities.m104dp(LocaleController.isRTL ? 24 : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? this.descriptionLayout.getWidth() - this.descriptionLayoutWidth : 0.0f)) - this.descriptionLayoutLeft, this.descriptionY);
            if (this.isInPlaylist) {
                this.isInPlaylistMarkDrawable.setBounds(0, 0, AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(16));
                ...
                canvas.translate(AndroidUtilities.m104dp(20), BitmapDescriptorFactory.HUE_RED);
            }
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                canvas.drawLine(BitmapDescriptorFactory.HUE_RED, getHeight() - 1, (getWidth() - AndroidUtilities.m104dp(72)) - getPaddingRight(), getHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            } else {
                canvas.drawLine(AndroidUtilities.m104dp(72), getHeight() - 1, getWidth() - getPaddingRight(), getHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            }
        }
    }
