...
public class MaxFileSizeCell extends FrameLayout {
    ...
    public MaxFileSizeCell(Context context) {
        ...
        this.seekBarView.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.telegram.ui.Cells.MaxFileSizeCell.2
            ...
            public void onSeekBarDrag(boolean z, float f) {
                ...
                if (f <= 0.25f) {
                    ...
                    if (f < 0.25f) {
                        ...
                        if (f > 0.25f) {
                            ...
                            long j = i;
                            MaxFileSizeCell.this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C3558R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j)));
                ...
                i = (int) (f2 + ((f / 0.25f) * f3));
                long j2 = i;
                MaxFileSizeCell.this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C3558R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j2)));
    ...
    public void setSize(long j) {
        ...
        float f;
        this.currentSize = j;
        this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C3558R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j)));
        long j2 = j - 512000;
        if (j2 < 536576) {
