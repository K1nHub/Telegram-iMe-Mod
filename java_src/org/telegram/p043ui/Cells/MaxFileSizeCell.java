...
public class MaxFileSizeCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(80), 1073741824));
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(80));
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m107dp(42);
        this.sizeTextView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(30), 1073741824));
        this.textView.measure(View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m107dp(10), (measuredWidth - this.sizeTextView.getMeasuredWidth()) - AndroidUtilities.m107dp(8)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(30), 1073741824));
        this.seekBarView.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth() - AndroidUtilities.m107dp(20), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(30), 1073741824));
    }
