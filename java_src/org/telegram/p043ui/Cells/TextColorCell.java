...
public class TextColorCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            ...
            canvas.drawCircle(LocaleController.isRTL ? AndroidUtilities.m107dp(33) : getMeasuredWidth() - AndroidUtilities.m107dp(33), getMeasuredHeight() / 2, AndroidUtilities.m107dp(10), colorPaint);
        }
    }
}
