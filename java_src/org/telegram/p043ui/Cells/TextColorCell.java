...
public class TextColorCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            ...
            canvas.drawCircle(LocaleController.isRTL ? AndroidUtilities.m104dp(33) : getMeasuredWidth() - AndroidUtilities.m104dp(33), getMeasuredHeight() / 2, AndroidUtilities.m104dp(10), colorPaint);
        }
    }
}
