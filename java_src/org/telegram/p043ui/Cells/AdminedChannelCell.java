...
public class AdminedChannelCell extends FrameLayout {
    ...
    public AdminedChannelCell(Context context, View.OnClickListener onClickListener, boolean z, int i) {
        ...
        if (onClickListener != null) {
            ...
            this.deleteButton.setImageResource(C3473R.C3475drawable.msg_panel_clear);
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp((this.isLast ? 12 : 0) + 60), 1073741824));
    }
