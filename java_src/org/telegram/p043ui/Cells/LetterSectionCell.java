...
public class LetterSectionCell extends FrameLayout {
    ...
    public LetterSectionCell(Context context) {
        super(context);
        setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m104dp(54), AndroidUtilities.m104dp(64)));
    ...
    public void setCellHeight(int i) {
        setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m104dp(54), i));
    }
}
