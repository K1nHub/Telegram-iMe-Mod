...
public class BrightnessControlCell extends FrameLayout {
    ...
    public BrightnessControlCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        SeekBarView seekBarView = new SeekBarView(this, context, true, resourcesProvider) { // from class: org.telegram.ui.Cells.BrightnessControlCell.1
            @Override // org.telegram.p043ui.Components.SeekBarView, android.view.View
        ...
        if (i == 0) {
            this.leftImageView.setImageResource(C3632R.C3634drawable.msg_brightness_low);
            this.rightImageView.setImageResource(C3632R.C3634drawable.msg_brightness_high);
            this.size = 48;
            return;
        }
        this.leftImageView.setImageResource(C3632R.C3634drawable.msg_brightness_high);
        this.rightImageView.setImageResource(C3632R.C3634drawable.msg_brightness_low);
        this.size = 43;
    }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.size), 1073741824));
    }
