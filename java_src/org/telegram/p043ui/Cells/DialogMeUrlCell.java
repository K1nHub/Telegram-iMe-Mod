...
public class DialogMeUrlCell extends BaseCell {
    ...
    public DialogMeUrlCell(Context context) {
        ...
        this.messageTop = AndroidUtilities.m107dp(40);
        this.avatarTop = AndroidUtilities.m107dp(10);
        this.currentAccount = UserConfig.selectedAccount;
        Theme.createDialogsResources(context);
        this.avatarImage.setRoundRadius(AndroidUtilities.m107dp(26));
    }
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m107dp(72) + (this.useSeparator ? 1 : 0));
    }
    ...
    public void buildLayout() {
        ...
        if (tLRPC$RecentMeUrl instanceof TLRPC$TL_recentMeUrlChat) {
            ...
            if (!LocaleController.isRTL) {
                ...
                this.nameLeft = AndroidUtilities.m107dp(AndroidUtilities.leftBaseline + 4);
            } else {
                this.nameLockLeft = getMeasuredWidth() - AndroidUtilities.m107dp(AndroidUtilities.leftBaseline);
                this.nameLeft = AndroidUtilities.m107dp(14);
            }
            str = chat.title;
            ...
            if (user != null) {
                if (user.bot) {
                    this.nameLockTop = AndroidUtilities.m108dp(16.5f);
                    if (!LocaleController.isRTL) {
                        this.nameLockLeft = AndroidUtilities.m107dp(AndroidUtilities.leftBaseline);
                        this.nameLeft = AndroidUtilities.m107dp(AndroidUtilities.leftBaseline + 4);
                    } else {
        ...
        if (!LocaleController.isRTL) {
            ...
            measuredWidth = getMeasuredWidth() - this.nameLeft;
            m107dp = AndroidUtilities.m107dp(AndroidUtilities.leftBaseline);
        }
        int i = measuredWidth - m107dp;
        if (this.drawNameLock) {
            i -= AndroidUtilities.m107dp(4) + Theme.dialogs_lockDrawable.getIntrinsicWidth();
        }
        if (this.drawVerified) {
            int m107dp2 = AndroidUtilities.m107dp(6) + Theme.dialogs_verifiedDrawable.getIntrinsicWidth();
            i -= m107dp2;
            if (LocaleController.isRTL) {
                this.nameLeft += m107dp2;
            }
        }
        int max = Math.max(AndroidUtilities.m107dp(12), i);
        try {
            this.nameLayout = new StaticLayout(TextUtils.ellipsize(str.replace('\n', ' '), textPaint, max - AndroidUtilities.m107dp(12), TextUtils.TruncateAt.END), textPaint, max, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        } catch (Exception e) {
            FileLog.m102e(e);
        }
        int measuredWidth3 = getMeasuredWidth() - AndroidUtilities.m107dp(AndroidUtilities.leftBaseline + 16);
        if (!LocaleController.isRTL) {
            this.messageLeft = AndroidUtilities.m107dp(AndroidUtilities.leftBaseline);
            measuredWidth2 = AndroidUtilities.m107dp(AndroidUtilities.isTablet() ? 13 : 9);
        } else {
            this.messageLeft = AndroidUtilities.m107dp(16);
            measuredWidth2 = getMeasuredWidth() - AndroidUtilities.m107dp(AndroidUtilities.isTablet() ? 65 : 61);
        }
        this.avatarImage.setImageCoords(measuredWidth2, this.avatarTop, AndroidUtilities.m107dp(52), AndroidUtilities.m107dp(52));
        int max2 = Math.max(AndroidUtilities.m107dp(12), measuredWidth3);
        try {
            this.messageLayout = new StaticLayout(TextUtils.ellipsize(str4, textPaint2, max2 - AndroidUtilities.m107dp(12), TextUtils.TruncateAt.END), textPaint2, max2, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        } catch (Exception e2) {
            FileLog.m102e(e2);
        }
        if (LocaleController.isRTL) {
            ...
            if (staticLayout != null && staticLayout.getLineCount() > 0) {
                ...
                if (this.drawVerified) {
                    this.nameMuteLeft = (int) (((this.nameLeft + (max - ceil)) - AndroidUtilities.m107dp(6)) - Theme.dialogs_verifiedDrawable.getIntrinsicWidth());
                }
        ...
        if (staticLayout3 != null && staticLayout3.getLineCount() > 0) {
            ...
            if (this.drawVerified) {
                this.nameMuteLeft = (int) (this.nameLeft + lineRight + AndroidUtilities.m107dp(6));
            }
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.nameLayout != null) {
            canvas.save();
            canvas.translate(this.nameLeft, AndroidUtilities.m107dp(13));
        ...
        if (this.drawVerified) {
            BaseCell.setDrawableBounds(Theme.dialogs_verifiedDrawable, this.nameMuteLeft, AndroidUtilities.m108dp(16.5f));
            BaseCell.setDrawableBounds(Theme.dialogs_verifiedCheckDrawable, this.nameMuteLeft, AndroidUtilities.m108dp(16.5f));
