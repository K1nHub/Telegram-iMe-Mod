...
public class UnconfirmedAuthHintCell extends FrameLayout {
    ...
    public void updateColors() {
        ...
        this.yesButton.setBackground(Theme.createSelectorDrawable(Theme.multAlpha(Theme.getColor(i), Theme.isCurrentThemeDark() ? 0.3f : 0.15f), 7, AndroidUtilities.m104dp(8)));
        ...
        this.noButton.setBackground(Theme.createSelectorDrawable(Theme.multAlpha(Theme.getColor(i2), Theme.isCurrentThemeDark() ? 0.3f : 0.15f), 7, AndroidUtilities.m104dp(8)));
    }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (f > BitmapDescriptorFactory.HUE_RED) {
                if (f < 1.0f) {
                    ...
                    canvas.translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m104dp(-12) * f);
                    super.onDraw(canvas);
                    canvas.restore();
                }
                if (this.progressDrawable == null) {
                    CircularProgressDrawable circularProgressDrawable = new CircularProgressDrawable(AndroidUtilities.m104dp(16), AndroidUtilities.m104dp(2), getCurrentTextColor());
                ...
                float f3 = 1.0f - f;
                this.progressDrawable.setBounds(getWidth() / 2, (getHeight() / 2) + ((int) (AndroidUtilities.m104dp(12) * f3)), getWidth() / 2, (getHeight() / 2) + ((int) (f3 * AndroidUtilities.m104dp(12))));
    ...
    public void showLoginPreventedSheet(ArrayList<UnconfirmedAuthController.UnconfirmedAuth> arrayList) {
        ...
        frameLayout.setPadding(AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10), AndroidUtilities.m104dp(10));
        int m104dp = AndroidUtilities.m104dp(8);
        int i2 = Theme.key_text_RedBold;
        frameLayout.setBackground(Theme.createRoundRectDrawable(m104dp, Theme.multAlpha(Theme.getColor(i2), Theme.isCurrentThemeDark() ? 0.2f : 0.15f)));
