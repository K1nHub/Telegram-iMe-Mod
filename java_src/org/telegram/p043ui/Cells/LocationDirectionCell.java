...
public class LocationDirectionCell extends FrameLayout {
    ...
    public LocationDirectionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        simpleTextView.setPadding(AndroidUtilities.m107dp(34), 0, AndroidUtilities.m107dp(34), 0);
        this.buttonTextView.setGravity(17);
        this.buttonTextView.setDrawablePadding(AndroidUtilities.m107dp(8));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(73), 1073741824));
    }
