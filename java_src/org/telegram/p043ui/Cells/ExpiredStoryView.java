...
public class ExpiredStoryView {
    ...
    public void measure(ChatMessageCell chatMessageCell) {
        ...
        this.titleLayout = new StaticLayout(createExpiredStoryString, textPaint2, ((int) (textPaint2.measureText(createExpiredStoryString, 0, createExpiredStoryString.length()) + 1.0f)) + AndroidUtilities.m107dp(10), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        this.subtitleLayout = new StaticLayout(str2, textPaint2, ((int) (textPaint2.measureText((CharSequence) str2, 0, str2.length()) + 1.0f)) + AndroidUtilities.m107dp(10), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        this.height = 0;
        this.verticalPadding = AndroidUtilities.m107dp(4);
        this.horizontalPadding = AndroidUtilities.m107dp(12);
        this.height = (int) (this.height + AndroidUtilities.m107dp(4) + this.titleLayout.getHeight() + AndroidUtilities.m107dp(2) + this.subtitleLayout.getHeight() + AndroidUtilities.m107dp(4) + (this.verticalPadding * 2.0f));
        this.width = Math.max(this.titleLayout.getWidth(), this.subtitleLayout.getWidth()) + AndroidUtilities.m107dp(12) + AndroidUtilities.m107dp(20) + chatMessageCell.getExtraTextX();
    }

    public void draw(Canvas canvas, ChatMessageCell chatMessageCell) {
        float m107dp = AndroidUtilities.m107dp(8) + this.verticalPadding;
        this.textY = m107dp;
        if (chatMessageCell.pinnedTop) {
            this.textY = m107dp - AndroidUtilities.m107dp(2);
        }
        RectF rectF = AndroidUtilities.rectTmp;
        if (chatMessageCell.getMessageObject().isOutOwner()) {
            this.textX = (((((-(chatMessageCell.timeWidth + AndroidUtilities.m107dp(12))) + chatMessageCell.getExtraTextX()) + chatMessageCell.getMeasuredWidth()) - this.width) + AndroidUtilities.m107dp(24)) - this.horizontalPadding;
            ...
            float m107dp2 = chatMessageCell.isAvatarVisible ? AndroidUtilities.m107dp(48) : 0.0f;
            this.textX = this.horizontalPadding + m107dp2 + AndroidUtilities.m107dp(12);
            float f = this.horizontalPadding;
            rectF.set(m107dp2 + f, this.verticalPadding, m107dp2 + f + this.width, chatMessageCell.getMeasuredHeight() - this.verticalPadding);
        }
        if (chatMessageCell.getMessageObject().isOutOwner()) {
        ...
        canvas.translate(BitmapDescriptorFactory.HUE_RED, this.titleLayout.getHeight() + AndroidUtilities.m107dp(2));
