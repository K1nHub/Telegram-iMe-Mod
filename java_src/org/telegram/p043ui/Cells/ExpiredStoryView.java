...
public class ExpiredStoryView {
    ...
    public void measure(ChatMessageCell chatMessageCell) {
        ...
        String string = LocaleController.getString("From", C3419R.string.From);
        ...
        String string2 = LocaleController.getString("FromFormatted", C3419R.string.FromFormatted);
        ...
        this.subtitleLayout = new StaticLayout(str, textPaint2, ((int) (textPaint2.measureText((CharSequence) str, 0, str.length()) + 1.0f)) + AndroidUtilities.m72dp(10), Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        this.height = 0;
