    ...
    public TooManyCommunitiesHintCell(Context context) {
        ...
        FrameLayout frameLayout = new FrameLayout(this, context) { // from class: org.telegram.ui.Cells.TooManyCommunitiesHintCell.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.save();
                canvas.translate((getMeasuredWidth() - textPaint.measureText(r5)) - AndroidUtilities.m107dp(8), AndroidUtilities.dpf2(7.0f));
                ...
                this.rect.inset(-AndroidUtilities.m107dp(6), -AndroidUtilities.m107dp(3));
                float textSize = (textPaint.getTextSize() / 2.0f) + AndroidUtilities.m107dp(3);
        ...
        this.headerTextView.setText(LocaleController.getString("TooManyCommunities", C3632R.string.TooManyCommunities));
        this.imageView.setImageResource(C3632R.C3634drawable.groups_limit1);
    }
