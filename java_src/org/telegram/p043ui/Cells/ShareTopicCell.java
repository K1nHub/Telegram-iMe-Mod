...
public class ShareTopicCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(103), 1073741824));
    }
    ...
    public void setTopic(TLRPC$Dialog tLRPC$Dialog, TLRPC$TL_forumTopic tLRPC$TL_forumTopic, boolean z, CharSequence charSequence) {
        ...
        this.imageView.setRoundRadius(AndroidUtilities.m104dp((chat == null || !chat.forum || z) ? 28 : 16));
