...
public class TextSettingsCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.imageView.getVisibility() == 0) {
            if (this.imageViewIsColorful) {
                this.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(28), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(28), 1073741824));
            } else {
        ...
        if (this.valueTextView.getVisibility() == 0) {
            ...
            if (this.valueImageView.getVisibility() == 0) {
                ...
                if (LocaleController.isRTL) {
                    marginLayoutParams.leftMargin = AndroidUtilities.m107dp(this.padding + 4) + this.valueTextView.getMeasuredWidth();
                } else {
                    marginLayoutParams.rightMargin = AndroidUtilities.m107dp(this.padding + 4) + this.valueTextView.getMeasuredWidth();
                }
            }
        }
    ...
    public void setIcon(int i) {
        ...
        if (i == 0) {
            this.imageView.setVisibility(8);
            if (LocaleController.isRTL) {
                marginLayoutParams.rightMargin = AndroidUtilities.m107dp(this.padding);
                return;
            } else {
                marginLayoutParams.leftMargin = AndroidUtilities.m107dp(this.padding);
                return;
            }
        }
        ...
        if (LocaleController.isRTL) {
            marginLayoutParams.rightMargin = AndroidUtilities.m107dp(71);
        } else {
            marginLayoutParams.leftMargin = AndroidUtilities.m107dp(71);
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (z || this.drawLoadingProgress != BitmapDescriptorFactory.HUE_RED) {
            ...
            rectF.set((getMeasuredWidth() - AndroidUtilities.m107dp(this.padding)) - AndroidUtilities.m107dp(this.loadingSize), measuredHeight - AndroidUtilities.m107dp(3), getMeasuredWidth() - AndroidUtilities.m107dp(this.padding), measuredHeight + AndroidUtilities.m107dp(3));
            if (LocaleController.isRTL) {
        ...
        if (this.needDivider) {
            int m107dp = AndroidUtilities.m107dp(this.imageView.getVisibility() == 0 ? 71 : 20);
            if (!LocaleController.isRTL) {
                f = m107dp;
            }
            canvas.drawLine(f, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? m107dp : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
