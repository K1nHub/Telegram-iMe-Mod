...
public class NotificationsCheckCell extends FrameLayout {
    ...
    public boolean isInSwitch(float f) {
        int m104dp = AndroidUtilities.m104dp(76);
        boolean z = LocaleController.isRTL;
        return (z && f <= ((float) m104dp)) || (!z && f >= ((float) (getMeasuredWidth() - m104dp)));
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(this.currentHeight), 1073741824));
        }
    }
    ...
    public void setTextAndValueAndIconAndCheck(String str, CharSequence charSequence, int i, boolean z, int i2, boolean z2, boolean z3) {
        ...
        if (z2) {
            ...
            this.valueTextView.setPadding(0, 0, 0, AndroidUtilities.m104dp(14));
        } else {
            this.valueTextView.setLines(1);
            this.valueTextView.setMaxLines(1);
            this.valueTextView.setSingleLine(true);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                ...
                m104dp = AndroidUtilities.m104dp(this.imageView != null ? 64 : 20);
            }
            float f = m104dp;
            float measuredHeight2 = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (LocaleController.isRTL) {
                i = AndroidUtilities.m104dp(this.imageView == null ? 20 : 64);
            } else {
                i = 0;
            }
        ...
        if (this.drawLine) {
            int m104dp2 = LocaleController.isRTL ? AndroidUtilities.m104dp(76) : (getMeasuredWidth() - AndroidUtilities.m104dp(76)) - 1;
            canvas.drawRect(m104dp2, (getMeasuredHeight() - AndroidUtilities.m104dp(22)) / 2, m104dp2 + 2, measuredHeight + AndroidUtilities.m104dp(22), Theme.dividerPaint);
        }
    }
