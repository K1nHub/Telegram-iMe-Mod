...
public class HeaderCell extends FrameLayout {
    ...
    public HeaderCell(Context context, int i, int i2, int i3, int i4, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setMinHeight(AndroidUtilities.m107dp(this.height - i3));
    ...
    public void setHeight(int i) {
        ...
        this.height = i;
        textView.setMinHeight(AndroidUtilities.m107dp(i) - ((FrameLayout.LayoutParams) this.textView.getLayoutParams()).topMargin);
    }

    public void setTopMargin(int i, boolean z) {
        ((FrameLayout.LayoutParams) this.textView.getLayoutParams()).topMargin = AndroidUtilities.m107dp(i);
        if (z) {
    ...
    public void setBottomMargin(int i) {
        ((FrameLayout.LayoutParams) this.textView.getLayoutParams()).bottomMargin = AndroidUtilities.m107dp(i);
        SimpleTextView simpleTextView = this.textView2;
        if (simpleTextView != null) {
            ((FrameLayout.LayoutParams) simpleTextView.getLayoutParams()).bottomMargin = AndroidUtilities.m107dp(i);
        }
    }
