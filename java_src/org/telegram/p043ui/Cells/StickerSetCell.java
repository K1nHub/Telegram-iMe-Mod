...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        if (i != 0) {
            ...
            if (i == 1) {
                ...
                this.optionsButton.setImageResource(C3558R.C3560drawable.msg_actions);
                this.optionsButton.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3558R.string.AccDescrMoreOptions));
                ...
                this.reorderButton.setImageResource(C3558R.C3560drawable.list_reorder);
                ...
                this.optionsButton.setImageResource(C3558R.C3560drawable.floating_check);
        ...
        this.premiumButtonView.setButton(LocaleController.getString("Unlock", C3558R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        try {
            ...
            ((ViewGroup.MarginLayoutParams) this.premiumButtonView.getTextView().getLayoutParams()).leftMargin = AndroidUtilities.m72dp(3);
        ...
        this.sideButtons.setPadding(AndroidUtilities.m72dp(10), 0, AndroidUtilities.m72dp(10), 0);
    ...
    public void setText(String str, String str2, int i, boolean z) {
        ...
        if (TextUtils.isEmpty(str2)) {
            this.textView.setTranslationY(AndroidUtilities.m72dp(10));
        } else {
    ...
    public void setStickersSet(TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, boolean z, boolean z2) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                if (tLRPC$Document != null && tLRPC$Document.f1539id == tLRPC$TL_messages_stickerSet.set.thumb_document_id) {
                    break;
                }
                i++;
            }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m72dp(71), getHeight() - 1, (getWidth() - getPaddingRight()) - (LocaleController.isRTL ? AndroidUtilities.m72dp(71) : 0), getHeight() - 1, Theme.dividerPaint);
        }
    }

    public void updateRightMargin() {
        this.sideButtons.measure(View.MeasureSpec.makeMeasureSpec(999999, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m72dp(58), 1073741824));
        int m72dp = AndroidUtilities.m72dp(26) + this.sideButtons.getMeasuredWidth();
        if (LocaleController.isRTL) {
            ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).leftMargin = m72dp;
            ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).leftMargin = m72dp;
            return;
        }
        ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).rightMargin = m72dp;
        ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).rightMargin = m72dp;
    }
    ...
    public void updateButtonState(final int i, boolean z) {
        ...
        if (i == 1) {
            this.premiumButtonView.setButton(LocaleController.getString("Unlock", C3558R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.premiumButtonView.setButton(LocaleController.getString("Restore", C3558R.string.Restore), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
