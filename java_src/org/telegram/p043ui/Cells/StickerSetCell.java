...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        if (i != 0) {
            ...
            if (i == 1) {
                ...
                this.optionsButton.setImageResource(C3419R.C3421drawable.msg_actions);
                ...
                this.reorderButton.setImageResource(C3419R.C3421drawable.list_reorder);
                ...
                this.optionsButton.setImageResource(C3419R.C3421drawable.floating_check);
        ...
        this.premiumButtonView.setButton(LocaleController.getString("Unlock", C3419R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public void setStickersSet(TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, boolean z, boolean z2) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                if (tLRPC$Document != null && tLRPC$Document.f1526id == tLRPC$TL_messages_stickerSet.set.thumb_document_id) {
                    break;
                }
                i++;
            }
    ...
    public void updateButtonState(final int i, boolean z) {
        ...
        if (i == 1) {
            this.premiumButtonView.setButton(LocaleController.getString("Unlock", C3419R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.premiumButtonView.setButton(LocaleController.getString("Restore", C3419R.string.Restore), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
