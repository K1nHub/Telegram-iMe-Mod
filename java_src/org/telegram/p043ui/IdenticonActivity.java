...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        frameLayout3.setPadding(AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(20), AndroidUtilities.m104dp(20));
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.telegram.ui.IdenticonActivity.2
            ...
            protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (IdenticonActivity.this.codeTextView != null) {
                    ...
                    int measuredHeight = (((IdenticonActivity.this.codeTextView.getMeasuredHeight() - IdenticonActivity.this.emojiTextView.getMeasuredHeight()) / 2) + IdenticonActivity.this.linearLayout1.getTop()) - AndroidUtilities.m104dp(16);
        ...
        this.linearLayout1.setPadding(AndroidUtilities.m104dp(10), 0, AndroidUtilities.m104dp(10), 0);
    ...
    public void onTransitionAnimationEnd(boolean z, boolean z2) {
        ...
        TextView textView = this.emojiTextView;
        textView.setText(Emoji.replaceEmoji((CharSequence) str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(32), false));
    }
