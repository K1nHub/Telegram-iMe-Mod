...
public class GroupCallActivity extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public static class SmallRecordCallDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            if (this.parentView instanceof SimpleTextView) {
                m107dp = centerY + AndroidUtilities.m107dp(1);
                centerX -= AndroidUtilities.m107dp(3);
            } else {
                m107dp = centerY + AndroidUtilities.m107dp(2);
            }
            this.paint2.setColor(-1147527);
            this.paint2.setAlpha((int) (this.alpha * 255.0f));
            canvas.drawCircle(centerX, m107dp, AndroidUtilities.m107dp(4), this.paint2);
    ...
    public static class RecordCallDrawable extends Drawable {
        ...
        public RecordCallDrawable() {
            ...
            this.paint.setStrokeWidth(AndroidUtilities.m108dp(1.5f));
        }
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawCircle(centerX, centerY, AndroidUtilities.m107dp(10), this.paint);
            this.paint2.setColor(this.recording ? -1147527 : -1);
            this.paint2.setAlpha((int) (this.alpha * 255.0f));
            canvas.drawCircle(centerX, centerY, AndroidUtilities.m107dp(5), this.paint2);
            if (this.recording) {
                long elapsedRealtime = SystemClock.elapsedRealtime();
                long j = elapsedRealtime - this.lastUpdateTime;
                if (j > 17) {
    ...
    public class VolumeSlider extends FrameLayout {
        ...
        /* renamed from: sx */
        private float f1989sx;

        /* renamed from: sy */
        private float f1990sy;
        ...
        public VolumeSlider(Context context, TLRPC$TL_groupCallParticipant tLRPC$TL_groupCallParticipant) {
            ...
            this.speakerDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(24), true, null);
            ...
            this.paint2.setStrokeWidth(AndroidUtilities.m108dp(1.5f));
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(48), 1073741824));
        ...
        boolean onTouch(MotionEvent motionEvent) {
            if (motionEvent.getAction() == 0) {
                this.f1989sx = motionEvent.getX();
                this.f1990sy = motionEvent.getY();
                return true;
            }
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                this.captured = false;
                if (motionEvent.getAction() == 1) {
                    if (Math.abs(motionEvent.getY() - this.f1990sy) < ViewConfiguration.get(getContext()).getScaledTouchSlop()) {
                ...
                if (!this.captured) {
                    ...
                    if (Math.abs(motionEvent.getY() - this.f1990sy) <= viewConfiguration.getScaledTouchSlop() && Math.abs(motionEvent.getX() - this.f1989sx) > viewConfiguration.getScaledTouchSlop()) {
                        this.captured = true;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int i7 = 0;
            fArr[0] = m107dp2;
            float max = this.thumbX < AndroidUtilities.m107dp(12) ? Math.max((float) BitmapDescriptorFactory.HUE_RED, (this.thumbX - AndroidUtilities.m107dp(6)) / AndroidUtilities.m107dp(6)) : 1.0f;
            float[] fArr2 = this.radii;
            float m107dp3 = AndroidUtilities.m107dp(6) * max;
            fArr2[5] = m107dp3;
            fArr2[4] = m107dp3;
            fArr2[3] = m107dp3;
            int i8 = 2;
            ...
            int left = this.imageView.getLeft() + (this.imageView.getMeasuredWidth() / 2) + AndroidUtilities.m107dp(5);
            int top = this.imageView.getTop() + (this.imageView.getMeasuredHeight() / 2);
            int i9 = 0;
            while (i9 < this.volumeAlphas.length) {
                if (i9 == 0) {
                    f = AndroidUtilities.m107dp(i5);
                    i3 = i7;
                } else {
                    if (i9 == i6) {
                        i2 = 50;
                ...
                float m107dp4 = AndroidUtilities.m107dp(i8) * (f3 - fArr3[i9]);
                this.paint2.setAlpha((int) (fArr3[i9] * 255.0f));
                float f7 = left;
                float f8 = top;
                this.rect.set((f7 - f) + m107dp4, (f8 - f) + m107dp4, (f7 + f) - m107dp4, (f8 + f) - m107dp4);
                int i10 = i3;
                int i11 = i9;
    ...
    public static class WeavingState {
        ...
        public void update(int i, int i2, int i3, long j, float f) {
            ...
            float m107dp = (AndroidUtilities.m107dp(122) / 400.0f) * f2;
            this.matrix.reset();
            this.matrix.postTranslate(f9, f11);
            this.matrix.postScale(m107dp, m107dp, f9 + 200.0f, f11 + 200.0f);
    ...
    */
    ...
    private GroupCallActivity(final Context context, final AccountInstance accountInstance, ChatObject.Call call, final TLRPC$Chat tLRPC$Chat, TLRPC$InputPeer tLRPC$InputPeer, boolean z, String str) {
        ...
        C3704ActionBar c3704ActionBar = new C3704ActionBar(context) { // from class: org.telegram.ui.GroupCallActivity.5
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (getAdditionalSubtitleTextView().getVisibility() == 0) {
                    canvas.save();
                    canvas.translate(getSubtitleTextView().getLeft(), getSubtitleTextView().getY() - AndroidUtilities.m107dp(1));
        ...
        this.actionBar.getAdditionalSubtitleTextView().setPadding(AndroidUtilities.m107dp(24), 0, 0, 0);
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C63226(context));
        ...
        this.bigMicDrawable = new RLottieDrawable(i6, "" + i6, AndroidUtilities.m107dp(72), AndroidUtilities.m107dp(72), true, null);
        int i7 = C3632R.raw.hand_2;
        this.handDrawables = new RLottieDrawable(i7, "" + i7, AndroidUtilities.m107dp(72), AndroidUtilities.m107dp(72), true, null);
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.GroupCallActivity.7
            ...
            protected void onMeasure(int i8, int i9) {
                ...
                if (GroupCallActivity.isLandscapeMode != z2) {
                    ...
                    float m107dp = AndroidUtilities.m107dp(52) / (measuredWidth - AndroidUtilities.m107dp(8));
                    ...
                    imageView.setScaleX(m107dp);
                    imageView.setScaleY(m107dp);
                ...
                int paddingTop = (size - getPaddingTop()) - AndroidUtilities.m107dp(245);
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    ...
                    if (GroupCallActivity.isTabletMode) {
                        layoutParams2.rightMargin = AndroidUtilities.m107dp(328);
                    } else {
                        layoutParams2.rightMargin = AndroidUtilities.m107dp(8);
                    }
                }
                ...
                int m107dp2 = AndroidUtilities.m107dp((int) ImageReceiver.DEFAULT_CROSSFADE_DURATION);
                ...
                if (GroupCallActivity.isTabletMode) {
                    ...
                    layoutParams3.width = AndroidUtilities.m107dp(320);
                    int m107dp3 = AndroidUtilities.m107dp(4);
                    layoutParams3.leftMargin = m107dp3;
                    layoutParams3.rightMargin = m107dp3;
                    layoutParams3.bottomMargin = m107dp2;
                    layoutParams3.topMargin = C3704ActionBar.getCurrentActionBarHeight();
                    i10 = AndroidUtilities.m107dp(60);
                } else if (GroupCallActivity.isLandscapeMode) {
                    layoutParams3.gravity = 51;
                    layoutParams3.width = -1;
                    layoutParams3.topMargin = C3704ActionBar.getCurrentActionBarHeight();
                    layoutParams3.bottomMargin = AndroidUtilities.m107dp(14);
                    layoutParams3.rightMargin = AndroidUtilities.m107dp(90);
                    layoutParams3.leftMargin = AndroidUtilities.m107dp(14);
                    i10 = 0;
                } else {
                    layoutParams3.gravity = 51;
                    layoutParams3.width = -1;
                    int m107dp4 = AndroidUtilities.m107dp(60);
                    layoutParams3.bottomMargin = m107dp2;
                    layoutParams3.topMargin = C3704ActionBar.getCurrentActionBarHeight() + AndroidUtilities.m107dp(14);
                    int m107dp5 = AndroidUtilities.m107dp(14);
                    layoutParams3.leftMargin = m107dp5;
                    layoutParams3.rightMargin = m107dp5;
                    i10 = m107dp4;
                }
                if (!GroupCallActivity.isLandscapeMode || GroupCallActivity.isTabletMode) {
                    ...
                    layoutParams4.bottomMargin = m107dp2;
                    if (GroupCallActivity.isTabletMode) {
                        layoutParams4.gravity = GroupCallActivity.this.hasVideo ? 85 : 81;
                        layoutParams4.width = AndroidUtilities.m107dp(328);
                    } else {
                    ...
                    layoutParams5.height = m107dp2;
                    if (GroupCallActivity.isTabletMode) {
                        layoutParams5.gravity = GroupCallActivity.this.hasVideo ? 85 : 81;
                        layoutParams5.width = AndroidUtilities.m107dp(328);
                    } else {
                ...
                if (GroupCallActivity.isLandscapeMode) {
                    GroupCallActivity.this.fullscreenUsersListView.setPadding(0, AndroidUtilities.m107dp(9), 0, AndroidUtilities.m107dp(9));
                } else {
                    GroupCallActivity.this.fullscreenUsersListView.setPadding(AndroidUtilities.m107dp(9), 0, AndroidUtilities.m107dp(9), 0);
                }
                FrameLayout.LayoutParams layoutParams6 = (FrameLayout.LayoutParams) GroupCallActivity.this.buttonsContainer.getLayoutParams();
                if (GroupCallActivity.isTabletMode) {
                    layoutParams6.width = AndroidUtilities.m107dp(320);
                    layoutParams6.height = AndroidUtilities.m107dp(200);
                    layoutParams6.gravity = GroupCallActivity.this.hasVideo ? 85 : 81;
                    layoutParams6.rightMargin = 0;
                } else if (GroupCallActivity.isLandscapeMode) {
                    layoutParams6.width = AndroidUtilities.m107dp(90);
                ...
                if (GroupCallActivity.isLandscapeMode && !GroupCallActivity.isTabletMode) {
                    ((FrameLayout.LayoutParams) GroupCallActivity.this.actionBar.getLayoutParams()).rightMargin = AndroidUtilities.m107dp(90);
                    ((FrameLayout.LayoutParams) GroupCallActivity.this.menuItemsContainer.getLayoutParams()).rightMargin = AndroidUtilities.m107dp(90);
                    ((FrameLayout.LayoutParams) GroupCallActivity.this.actionBarBackground.getLayoutParams()).rightMargin = AndroidUtilities.m107dp(90);
                    ((FrameLayout.LayoutParams) GroupCallActivity.this.actionBarShadow.getLayoutParams()).rightMargin = AndroidUtilities.m107dp(90);
                } else {
                ...
                if (GroupCallActivity.isLandscapeMode) {
                    ...
                    layoutParams7.width = AndroidUtilities.m107dp(80);
                    layoutParams7.gravity = 53;
                    layoutParams7.rightMargin = AndroidUtilities.m107dp(100);
                    ...
                    layoutParams7.height = AndroidUtilities.m107dp(80);
                    layoutParams7.width = -1;
                    layoutParams7.gravity = 80;
                    layoutParams7.rightMargin = 0;
                    layoutParams7.bottomMargin = AndroidUtilities.m107dp(100);
                }
                ...
                int max = GroupCallActivity.isTabletMode ? 0 : Math.max(0, (paddingTop - Math.max(AndroidUtilities.m108dp(259.0f), (paddingTop / 5) * 3)) + AndroidUtilities.m107dp(8));
                ...
                if (GroupCallActivity.this.scheduleStartAtTextView != null) {
                    int m107dp6 = max + (((paddingTop - max) + AndroidUtilities.m107dp(60)) / 2);
                    ...
                    layoutParams8.topMargin = m107dp6 - AndroidUtilities.m107dp(30);
                    ...
                    layoutParams9.topMargin = AndroidUtilities.m107dp(80) + m107dp6;
                    ...
                    if (layoutParams8.topMargin < C3704ActionBar.getCurrentActionBarHeight() || layoutParams9.topMargin + AndroidUtilities.m107dp(20) > size - AndroidUtilities.m107dp(231)) {
                        ...
                        layoutParams10.topMargin = m107dp6 - AndroidUtilities.m107dp(20);
                    } else {
                        ...
                        layoutParams10.topMargin = m107dp6;
                    }
                }
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == 0 && GroupCallActivity.this.scrollOffsetY != BitmapDescriptorFactory.HUE_RED && motionEvent.getY() < GroupCallActivity.this.scrollOffsetY - AndroidUtilities.m107dp(37) && GroupCallActivity.this.actionBar.getAlpha() == BitmapDescriptorFactory.HUE_RED && !GroupCallActivity.this.avatarsPreviewShowed) {
                    GroupCallActivity groupCallActivity = GroupCallActivity.this;
            ...
            protected void onDraw(Canvas canvas) {
                float f;
                int m107dp;
                int m107dp2 = AndroidUtilities.m107dp(74);
                float f2 = GroupCallActivity.this.scrollOffsetY - m107dp2;
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m107dp(15) + ((BottomSheet) GroupCallActivity.this).backgroundPaddingTop;
                if (((BottomSheet) GroupCallActivity.this).backgroundPaddingTop + f2 < C3704ActionBar.getCurrentActionBarHeight()) {
                    float min = Math.min(1.0f, ((C3704ActionBar.getCurrentActionBarHeight() - f2) - ((BottomSheet) GroupCallActivity.this).backgroundPaddingTop) / ((m107dp2 - ((BottomSheet) GroupCallActivity.this).backgroundPaddingTop) - AndroidUtilities.m107dp(14)));
                    int currentActionBarHeight = (int) ((C3704ActionBar.getCurrentActionBarHeight() - m107dp) * min);
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (GroupCallActivity.isTabletMode) {
                    ...
                    GroupCallActivity.this.buttonsContainer.setTranslationY(BitmapDescriptorFactory.HUE_RED);
                    GroupCallActivity.this.fullscreenUsersListView.setTranslationY(BitmapDescriptorFactory.HUE_RED);
                    GroupCallActivity.this.buttonsContainer.setTranslationX(GroupCallActivity.this.progressToHideUi * AndroidUtilities.m107dp(94));
                    GroupCallActivity groupCallActivity = GroupCallActivity.this;
                    groupCallActivity.fullscreenUsersListView.setTranslationX(groupCallActivity.progressToHideUi * AndroidUtilities.m107dp(94));
                } else {
                    GroupCallActivity.this.buttonsContainer.setTranslationX(BitmapDescriptorFactory.HUE_RED);
                    GroupCallActivity.this.fullscreenUsersListView.setTranslationX(BitmapDescriptorFactory.HUE_RED);
                    GroupCallActivity.this.buttonsContainer.setTranslationY(GroupCallActivity.this.progressToHideUi * AndroidUtilities.m107dp(94));
                    GroupCallActivity groupCallActivity2 = GroupCallActivity.this;
                    groupCallActivity2.fullscreenUsersListView.setTranslationY(groupCallActivity2.progressToHideUi * AndroidUtilities.m107dp(94));
                }
                    ...
                    if (GroupCallActivity.this.scrimView != null) {
                        ...
                        if (groupCallUserCell6 != null && y2 < y3) {
                            ...
                            for (int i14 = 0; i14 < 4; i14++) {
                                fArr[i14] = AndroidUtilities.m107dp(13) * (1.0f - GroupCallActivity.this.progressToAvatarPreview);
                                fArr[i14 + 4] = AndroidUtilities.m107dp(13);
                            }
                            path.reset();
                            Path path3 = path;
                            ...
                            if (GroupCallActivity.this.scrimPopupLayout != null) {
                                ...
                                float measuredWidth = (getMeasuredWidth() - GroupCallActivity.this.scrimPopupLayout.getMeasuredWidth()) - AndroidUtilities.m107dp(14);
                        ...
                        while (i16 < childCount2) {
                            ...
                            if (childAt3 == GroupCallActivity.this.scrimView) {
                                ...
                                if (max2 < min2) {
                                    ...
                                    c = '\r';
                                    canvas.drawRoundRect(this.rect, AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(13), GroupCallActivity.this.listViewBackgroundPaint);
                                    view.draw(canvas);
                                    canvas.restore();
                                    i16++;
                                    c2 = c;
                ...
                */
                public void onDraw(android.graphics.Canvas r8) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.GroupCallActivity.C63268.onDraw(android.graphics.Canvas):void");
                }
            };
            ...
            */
            public void dispatchDraw(android.graphics.Canvas r18) {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.GroupCallActivity.C63279.dispatchDraw(android.graphics.Canvas):void");
            }
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.GroupCallActivity.10
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i9) {
                ...
                if ((GroupCallActivity.this.scrollOffsetY - AndroidUtilities.m107dp(74)) + ((BottomSheet) GroupCallActivity.this).backgroundPaddingTop >= C3704ActionBar.getCurrentActionBarHeight() || !GroupCallActivity.this.listView.canScrollVertically(1)) {
                    return;
                }
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (childAdapterPosition >= 0) {
                    ...
                    if (i11 == 0) {
                        ...
                        rect.left = AndroidUtilities.m107dp(2);
                    } else {
                        rect.left = AndroidUtilities.m108dp(1.0f);
                    }
                }
            }
        });
        ...
        this.buttonsContainer = new C627217(context);
        int color = Theme.getColor(Theme.key_voipgroup_unmuteButton2);
        int red = Color.red(color);
        int green = Color.green(color);
        int blue = Color.blue(color);
        this.radialMatrix = new Matrix();
        this.radialGradient = new RadialGradient((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED, AndroidUtilities.m107dp(160), new int[]{Color.argb(50, red, green, blue), Color.argb(0, red, green, blue)}, (float[]) null, Shader.TileMode.CLAMP);
        ...
        blobDrawable.minRadius = AndroidUtilities.m107dp(62);
        blobDrawable.maxRadius = AndroidUtilities.m107dp(72);
        blobDrawable.generateBlob();
        blobDrawable2.minRadius = AndroidUtilities.m107dp(65);
        blobDrawable2.maxRadius = AndroidUtilities.m107dp(75);
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i10, "" + i10, AndroidUtilities.m107dp(24), AndroidUtilities.m107dp(24), true, null);
        ...
        this.muteButton.setOnClickListener(new View$OnClickListenerC627519());
        ...
        this.expandButton.setPadding(m107dp, m107dp, m107dp, m107dp);
        ...
        this.minimizeButton.setPadding(m107dp, m107dp, m107dp, m107dp);
        ...
        radialProgressView.setSize(AndroidUtilities.m107dp(110));
        ...
        this.actionBar.getBackButton().setTranslationX(-AndroidUtilities.m107dp(14));
        this.actionBar.getTitleTextView().setTranslationY(AndroidUtilities.m107dp(23));
        this.actionBar.getSubtitleTextView().setTranslationY(AndroidUtilities.m107dp(20));
        this.actionBar.getAdditionalSubtitleTextView().setTranslationY(AndroidUtilities.m107dp(20));
        ...
        this.titleTextView = new C627820(context, context);
        ...
        for (int i15 = 0; i15 < 2; i15++) {
            ...
            this.undoView[i15].setAdditionalTranslationY(AndroidUtilities.m107dp(10));
            if (Build.VERSION.SDK_INT >= 21) {
                this.undoView[i15].setTranslationZ(AndroidUtilities.m107dp(5));
            }
        ...
        this.otherItem.addSubItem(8, this.accountSelectCell, -2, AndroidUtilities.m107dp(48));
        ...
        paint3.setStrokeWidth(AndroidUtilities.m108dp(1.5f));
        ...
        this.fullscreenUsersListView.addItemDecoration(new RecyclerView.ItemDecoration(this) { // from class: org.telegram.ui.GroupCallActivity.26
            ...
            public void getItemOffsets(Rect rect, View view3, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (!GroupCallActivity.isLandscapeMode) {
                    rect.set(AndroidUtilities.m107dp(4), 0, AndroidUtilities.m107dp(4), 0);
                } else {
                    rect.set(0, AndroidUtilities.m107dp(4), 0, AndroidUtilities.m107dp(4));
                }
            }
        });
        C628527 c628527 = new C628527(context, this.listView, this.fullscreenUsersListView, this.attachedRenderers, this.call, this);
        this.renderersContainer = c628527;
        c628527.setClipChildren(false);
                ...
                if (GroupCallActivity.this.progressToAvatarPreview != 1.0f) {
                    if (GroupCallActivity.this.scrimView == null || !GroupCallActivity.this.hasScrimAnchorView) {
                        if (GroupCallActivity.this.scrimFullscreenView != null && GroupCallActivity.this.scrimRenderer == null && GroupCallActivity.this.previewTextureTransitionEnabled) {
                            ...
                            int m107dp2 = (int) (((1.0f - GroupCallActivity.this.progressToAvatarPreview) * measuredHeight) + (AndroidUtilities.m107dp(13) * GroupCallActivity.this.progressToAvatarPreview));
                            ...
                            GroupCallActivity.this.scrimFullscreenView.getAvatarImageView().setRoundRadius(m107dp2, m107dp2, i22, i22);
                        ...
                        int m107dp3 = (int) (((1.0f - GroupCallActivity.this.progressToAvatarPreview) * measuredHeight2) + (AndroidUtilities.m107dp(13) * GroupCallActivity.this.progressToAvatarPreview));
                        ...
                        GroupCallActivity.this.scrimView.getAvatarImageView().setRoundRadius(m107dp3, m107dp3, i23, i23);
        ...
        if (tLRPC$InputPeer != null) {
            ...
            this.scheduleButtonTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(8), 0, 1056964608));
            ...
            LinearLayout linearLayout2 = new LinearLayout(this, context) { // from class: org.telegram.ui.GroupCallActivity.35
                ...
                protected void onMeasure(int i22, int i23) {
                    ...
                    numberPicker2.setItemCount(5);
                    numberPicker3.setItemCount(5);
                    numberPicker.getLayoutParams().height = AndroidUtilities.m107dp(54) * 5;
                    numberPicker2.getLayoutParams().height = AndroidUtilities.m107dp(54) * 5;
                    numberPicker3.getLayoutParams().height = AndroidUtilities.m107dp(54) * 5;
                    this.ignoreLayout = false;
        ...
        pinchToZoomHelper.setCallback(new PinchToZoomHelper.Callback() { // from class: org.telegram.ui.GroupCallActivity.37
            ...
            public void onZoomStarted(MessageObject messageObject) {
                ...
                GroupCallActivity.this.pinchToZoomHelper.getPhotoImage().setRoundRadius(AndroidUtilities.m107dp(13), AndroidUtilities.m107dp(13), 0, 0);
                ((BottomSheet) GroupCallActivity.this).containerView.invalidate();
            }
    ...
    /* loaded from: classes5.dex */
    public class C63226 extends C3704ActionBar.ActionBarMenuOnItemClick {
            ...
            if (i == 1) {
                ...
                builder.setPositiveButton(LocaleController.getString("VoipGroupEnd", C3632R.string.VoipGroupEnd), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda2
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i4) {
                        GroupCallActivity.C63226.this.lambda$onItemClick$1(dialogInterface, i4);
                    }
                });
                ...
                if (call.recording) {
                    ...
                    builder2.setPositiveButton(LocaleController.getString("Stop", C3632R.string.Stop), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda4
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i4) {
                            GroupCallActivity.C63226.this.lambda$onItemClick$2(z, dialogInterface, i4);
                        }
                    });
                ...
                GroupCallActivity groupCallActivity4 = GroupCallActivity.this;
                DialogC63231 dialogC63231 = new DialogC63231(context, groupCallActivity4.currentChat, groupCallActivity4.hasVideo);
                if (GroupCallActivity.this.isRtmpStream()) {
                    dialogC63231.onStartRecord(2);
                } else {
                    dialogC63231.show();
                }
            } else if (i == 7) {
                ...
                editTextBoldCursor.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda7
                    ...
                    public final boolean onEditorAction(TextView textView2, int i5, KeyEvent keyEvent) {
                        ...
                        lambda$onItemClick$4 = GroupCallActivity.C63226.lambda$onItemClick$4(AlertDialog.Builder.this, textView2, i5, keyEvent);
                ...
                builder3.setPositiveButton(LocaleController.getString("Save", C3632R.string.Save), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda3
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i5) {
                        GroupCallActivity.C63226.this.lambda$onItemClick$5(editTextBoldCursor, builder3, dialogInterface, i5);
                    }
                });
                ...
                create3.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda6
                    ...
                    public final void onShow(DialogInterface dialogInterface) {
                        GroupCallActivity.C63226.this.lambda$onItemClick$6(create3, editTextBoldCursor, dialogInterface);
                    }
                });
                ...
                JoinCallAlert.open(context2, -groupCallActivity5.currentChat.f1602id, groupCallActivity5.accountInstance, null, 2, GroupCallActivity.this.selfPeer, new JoinCallAlert.JoinCallAlertDelegate() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda10
                    ...
                    public final void didSelectChat(TLRPC$InputPeer tLRPC$InputPeer, boolean z2, boolean z3) {
                        GroupCallActivity.C63226.this.lambda$onItemClick$9(tLRPC$InputPeer, z2, z3);
                    }
                });
            } else if (i == 11) {
                ...
                BottomSheet.Builder items = new BottomSheet.Builder(this.val$context).setTitle(LocaleController.getString("VoipSelectAudioOutput", C3632R.string.VoipSelectAudioOutput), true).setItems(charSequenceArr, iArr, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i6) {
                        GroupCallActivity.C63226.lambda$onItemClick$10(VoIPService.this, arrayList3, dialogInterface, i6);
                    }
                });
            ...
            if (GroupCallActivity.this.call.isScheduled()) {
                ...
                GroupCallActivity.this.accountInstance.getConnectionsManager().sendRequest(tLRPC$TL_phone_discardGroupCall, new RequestDelegate() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda8
                    ...
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                        GroupCallActivity.C63226.this.lambda$onItemClick$0(tLObject, tLRPC$TL_error);
                    }
                });
        ...
        /* loaded from: classes5.dex */
        public class DialogC63231 extends GroupCallRecordAlert {
            DialogC63231(Context context, TLRPC$Chat tLRPC$Chat, boolean z) {
            ...
            public void onStartRecord(final int i) {
                ...
                editTextBoldCursor.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.GroupCallActivity$6$1$$ExternalSyntheticLambda4
                    ...
                    public final boolean onEditorAction(TextView textView, int i3, KeyEvent keyEvent) {
                        ...
                        lambda$onStartRecord$0 = GroupCallActivity.C63226.DialogC63231.lambda$onStartRecord$0(AlertDialog.Builder.this, textView, i3, keyEvent);
                ...
                create.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.GroupCallActivity$6$1$$ExternalSyntheticLambda3
                    @Override // android.content.DialogInterface.OnShowListener
                    public final void onShow(DialogInterface dialogInterface) {
                        GroupCallActivity.C63226.DialogC63231.this.lambda$onStartRecord$1(create, editTextBoldCursor, dialogInterface);
                    }
                });
                ...
                builder.setPositiveButton(LocaleController.getString("Start", C3632R.string.Start), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$6$1$$ExternalSyntheticLambda1
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i3) {
                        GroupCallActivity.C63226.DialogC63231.this.lambda$onStartRecord$3(editTextBoldCursor, i, dialogInterface, i3);
                    }
                });
            ...
            if (GroupCallActivity.this.call.isScheduled()) {
                ...
                GroupCallActivity.this.accountInstance.getConnectionsManager().sendRequest(tLRPC$TL_phone_saveDefaultGroupCallJoinAs, new RequestDelegate() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda9
                    ...
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        GroupCallActivity.C63226.lambda$onItemClick$8(tLObject2, tLRPC$TL_error);
                    }
                });
    ...
    public /* synthetic */ void lambda$new$13(View view, int i, float f, float f2) {
        if (view instanceof GroupCallGridCell) {
            ...
            bundle.putLong("user_id", groupCallInvitedCell.getUser().f1751id);
    ...
    class C627217 extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            if (!GroupCallActivity.isLandscapeMode) {
                i = View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m107dp(460), View.MeasureSpec.getSize(i)), 1073741824);
            }
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m107dp(122)) / 2;
            ...
            if (!GroupCallActivity.isLandscapeMode || GroupCallActivity.isTabletMode) {
                if (GroupCallActivity.this.renderersContainer.inFullscreenMode && !GroupCallActivity.isTabletMode) {
                    ...
                    int measuredHeight7 = (getMeasuredHeight() - GroupCallActivity.this.leaveButton.getMeasuredHeight()) - ((GroupCallActivity.this.muteButton.getMeasuredWidth() - AndroidUtilities.m107dp(52)) / 2);
                    ...
                    float m107dp = AndroidUtilities.m107dp(52) / (GroupCallActivity.this.muteButton.getMeasuredWidth() - AndroidUtilities.m107dp(8));
                    GroupCallActivity.this.muteButton.animate().scaleX(m107dp).scaleY(m107dp).setDuration(350L).setInterpolator(CubicBezierInterpolator.DEFAULT).start();
                    for (int i9 = 0; i9 < 2; i9++) {
                        ...
                        int m107dp2 = measuredHeight - AndroidUtilities.m107dp(27);
                        GroupCallActivity.this.muteLabel[i9].layout(measuredWidth9, m107dp2, GroupCallActivity.this.muteLabel[i9].getMeasuredWidth() + measuredWidth9, GroupCallActivity.this.muteLabel[i9].getMeasuredHeight() + m107dp2);
                    ...
                    int m107dp3 = AndroidUtilities.m107dp(0);
                    if (GroupCallActivity.this.soundButton.getVisibility() == 0) {
                        ...
                        int m107dp4 = GroupCallActivity.this.flipButton.getVisibility() == 0 ? AndroidUtilities.m107dp(28) : 0;
                        int measuredWidth13 = (measuredWidth - GroupCallActivity.this.flipButton.getMeasuredWidth()) / 2;
                        int measuredHeight11 = (((measuredHeight - GroupCallActivity.this.flipButton.getMeasuredHeight()) / 2) + m107dp3) - m107dp4;
                        ...
                        int measuredHeight12 = ((measuredHeight - GroupCallActivity.this.cameraButton.getMeasuredHeight()) / 2) + m107dp3 + m107dp4;
                    ...
                    int measuredHeight13 = ((measuredHeight - GroupCallActivity.this.leaveButton.getMeasuredHeight()) / 2) + m107dp3;
                    ...
                    int measuredHeight14 = ((measuredHeight - GroupCallActivity.this.muteButton.getMeasuredHeight()) / 2) - AndroidUtilities.m107dp(9);
                    ...
                    for (int i10 = 0; i10 < 2; i10++) {
                        ...
                        int m107dp5 = (measuredHeight - AndroidUtilities.m107dp(12)) - GroupCallActivity.this.muteLabel[i10].getMeasuredHeight();
                        GroupCallActivity.this.muteLabel[i10].layout(measuredWidth17, m107dp5, GroupCallActivity.this.muteLabel[i10].getMeasuredWidth() + measuredWidth17, GroupCallActivity.this.muteLabel[i10].getMeasuredHeight() + m107dp5);
                ...
                int measuredWidth23 = (((i5 == 4 ? measuredHeight15 * 2 : measuredHeight15) + i13) - (GroupCallActivity.this.muteButton.getMeasuredWidth() / 2)) - AndroidUtilities.m107dp(4);
                int measuredWidth24 = (getMeasuredWidth() - GroupCallActivity.this.muteButton.getMeasuredWidth()) >> 1;
                if (i5 == 3) {
                    measuredWidth23 -= AndroidUtilities.m107dp(6);
                }
                ...
                float m107dp6 = AndroidUtilities.m107dp(52) / (GroupCallActivity.this.muteButton.getMeasuredWidth() - AndroidUtilities.m107dp(8));
                GroupCallActivity.this.muteButton.animate().cancel();
                GroupCallActivity.this.muteButton.setScaleX(m107dp6);
                GroupCallActivity.this.muteButton.setScaleY(m107dp6);
                for (int i14 = 0; i14 < 2; i14++) {
                    ...
                    int measuredWidth26 = ((i13 + i15) - (GroupCallActivity.this.muteButton.getMeasuredWidth() / 2)) - AndroidUtilities.m107dp(4);
                    if (i5 == 3) {
                        measuredWidth26 -= AndroidUtilities.m107dp(6);
                    }
                    int measuredWidth27 = (int) (measuredWidth26 + (GroupCallActivity.this.muteButton.getMeasuredWidth() * 0.687f) + AndroidUtilities.m107dp(4));
                    if (GroupCallActivity.this.muteLabel[i14].getMeasuredHeight() + measuredWidth27 > i15 + measuredHeight15) {
                        measuredWidth27 -= AndroidUtilities.m107dp(4);
                    }
                ...
                if (z2) {
                    ...
                    animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.GroupCallActivity.17.1
                        ...
                        public void onAnimationEnd(Animator animator) {
                            C627217.this.currentButtonsAnimation = null;
                            for (int i17 = 0; i17 < C627217.this.getChildCount(); i17++) {
                                View childAt2 = C627217.this.getChildAt(i17);
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r27) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.GroupCallActivity.C627217.dispatchDraw(android.graphics.Canvas):void");
        }
    ...
    /* loaded from: classes5.dex */
    public class View$OnClickListenerC627519 implements View.OnClickListener {
            ...
            if (!GroupCallActivity.this.isRtmpStream() || GroupCallActivity.this.call.isScheduled()) {
                if (GroupCallActivity.this.muteButtonState == 5) {
                    ...
                    GroupCallActivity.this.accountInstance.getConnectionsManager().sendRequest(tLRPC$TL_phone_startScheduledGroupCall, new RequestDelegate() { // from class: org.telegram.ui.GroupCallActivity$19$$ExternalSyntheticLambda1
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            GroupCallActivity.View$OnClickListenerC627519.this.lambda$onClick$1(tLObject, tLRPC$TL_error);
                        }
                    });
                    return;
                    ...
                    groupCallActivity2.accountInstance.getConnectionsManager().sendRequest(tLRPC$TL_phone_toggleGroupCallStartSubscription, new RequestDelegate() { // from class: org.telegram.ui.GroupCallActivity$19$$ExternalSyntheticLambda2
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            GroupCallActivity.View$OnClickListenerC627519.this.lambda$onClick$2(tLObject, tLRPC$TL_error);
                        }
                    });
                    GroupCallActivity groupCallActivity3 = GroupCallActivity.this;
            ...
            if (GroupCallActivity.this.renderersContainer != null && GroupCallActivity.this.renderersContainer.inFullscreenMode && (AndroidUtilities.isTablet() || GroupCallActivity.isLandscapeMode == GroupCallActivity.this.isRtmpLandscapeMode())) {
                ...
                if (GroupCallActivity.isLandscapeMode) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.GroupCallActivity$19$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            GroupCallActivity.View$OnClickListenerC627519.this.lambda$onClick$0();
                        }
                    }, 200L);
                }
    ...
    /* loaded from: classes5.dex */
    public class C627820 extends AudioPlayerAlert.ClippingTextViewSwitcher {
        final /* synthetic */ Context val$context;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C627820(Context context, Context context2) {
            super(context);
        ...
        protected TextView createTextView() {
            ...
            textView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$20$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    GroupCallActivity.C627820.this.lambda$createTextView$0(textView, view);
                }
            });
            return textView;
        }
    ...
    /* loaded from: classes5.dex */
    public class C628527 extends GroupCallRenderersContainer {
        ValueAnimator uiVisibilityAnimator;

        C628527(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList arrayList, ChatObject.Call call, GroupCallActivity groupCallActivity) {
        ...
        public void onUiVisibilityChanged() {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.GroupCallActivity$27$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    GroupCallActivity.C628527.this.lambda$onUiVisibilityChanged$0(valueAnimator2);
                }
            });
            ...
            this.uiVisibilityAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.GroupCallActivity.27.1
                ...
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    C628527 c628527 = C628527.this;
                    c628527.uiVisibilityAnimator = null;
                    GroupCallActivity groupCallActivity = GroupCallActivity.this;
    ...
    private void updateScheduleUI(boolean z) {
        ...
        float m107dp = isLandscapeMode ? (AndroidUtilities.m107dp(52) * interpolation) / (this.muteButton.getMeasuredWidth() - AndroidUtilities.m107dp(8)) : interpolation;
        float f3 = 1.0f - f;
        ...
        this.muteButton.setScaleX(m107dp);
        this.muteButton.setScaleY(m107dp);
    ...
    private void initCreatedGroupCall() {
        ...
        this.actionBar.setTitleRightMargin(AndroidUtilities.m107dp(48) * 2);
    ...
    */
    ...
    public void inviteUserToCall(final long j, final boolean z) {
        ...
        tLRPC$TL_inputUser.user_id = user.f1751id;
    ...
    public void updateLayout(boolean z) {
        ...
        final boolean z3 = f <= ((float) (C3704ActionBar.getCurrentActionBarHeight() - AndroidUtilities.m107dp(14)));
        float currentActionBarHeight = f + C3704ActionBar.getCurrentActionBarHeight() + AndroidUtilities.m107dp(14);
        if ((z3 && this.actionBar.getTag() == null) || (!z3 && this.actionBar.getTag() != null)) {
            ...
            ViewPropertyAnimator duration = this.actionBar.getBackButton().animate().scaleX(z3 ? 1.0f : 0.9f).scaleY(z3 ? 1.0f : 0.9f).translationX(z3 ? 0.0f : -AndroidUtilities.m107dp(14)).setDuration(300L);
            CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.DEFAULT;
            duration.setInterpolator(cubicBezierInterpolator).start();
            this.actionBar.getTitleTextView().animate().translationY(z3 ? 0.0f : AndroidUtilities.m107dp(23)).setDuration(300L).setInterpolator(cubicBezierInterpolator).start();
            ...
            fArr[1] = z3 ? 0.0f : AndroidUtilities.m107dp(20);
            ...
            this.subtitleYAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.GroupCallActivity.48
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    groupCallActivity.actionBar.getSubtitleTextView().setTranslationY(z3 ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.m107dp(20));
                }
            });
            ...
            fArr2[0] = z3 ? 0.0f : AndroidUtilities.m107dp(20);
    ...
    private void setScrollOffsetY(float f) {
        ...
        float m107dp2 = f - AndroidUtilities.m107dp(74);
        if (this.backgroundPaddingTop + m107dp2 < C3704ActionBar.getCurrentActionBarHeight() * 2) {
            float min = Math.min(1.0f, (((C3704ActionBar.getCurrentActionBarHeight() * 2) - m107dp2) - this.backgroundPaddingTop) / (((m107dp - this.backgroundPaddingTop) - AndroidUtilities.m107dp(14)) + C3704ActionBar.getCurrentActionBarHeight()));
            i = (int) (AndroidUtilities.m107dp(AndroidUtilities.isTablet() ? 17 : 13) * min);
        ...
        float f3 = i;
        this.menuItemsContainer.setTranslationY(Math.max(AndroidUtilities.m107dp(4), (f - AndroidUtilities.m107dp(53)) - f3));
        this.titleTextView.setTranslationY(Math.max(AndroidUtilities.m107dp(4), (f - AndroidUtilities.m107dp(44)) - f3));
        LinearLayout linearLayout = this.scheduleTimerContainer;
        if (linearLayout != null) {
            linearLayout.setTranslationY(Math.max(AndroidUtilities.m107dp(4), (f - AndroidUtilities.m107dp(44)) - f3));
        }
        this.containerView.invalidate();
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$updateMuteButton$52(ValueAnimator valueAnimator) {
        ...
        this.muteLabel[0].setTranslationY(AndroidUtilities.m107dp(5) * floatValue);
        this.muteLabel[1].setAlpha(floatValue);
        this.muteLabel[1].setTranslationY(AndroidUtilities.m108dp((floatValue * 5.0f) - 5.0f));
    }
    ...
    public void showRecordHint(View view) {
        if (this.recordHintView == null) {
            ...
            this.recordHintView.setShowingDuration(C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
    ...
    */
    ...
    public void clearScrimView() {
        ...
        if (groupCallMiniTextureView != null) {
            groupCallMiniTextureView.textureView.setRoundCorners(AndroidUtilities.m107dp(8));
    ...
    */
    ...
    public /* synthetic */ void lambda$runAvatarPreviewTransition$62(float f, float f2, float f3, int i, ValueAnimator valueAnimator) {
        ...
        GroupCallMiniTextureView groupCallMiniTextureView = this.scrimRenderer;
        if (groupCallMiniTextureView != null) {
            groupCallMiniTextureView.textureView.setRoundCorners(AndroidUtilities.m107dp(8) * (1.0f - this.progressToAvatarPreview));
        }
            ...
            if (i == 0) {
                view = new GroupCallTextCell(this, this.mContext) { // from class: org.telegram.ui.GroupCallActivity.ListAdapter.1
                    ...
                    protected void onMeasure(int i2, int i3) {
                        if (AndroidUtilities.isTablet()) {
                            super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m107dp(420), View.MeasureSpec.getSize(i2)), 1073741824), i3);
                        } else {
                ...
                view = new View(this, this.mContext) { // from class: org.telegram.ui.GroupCallActivity.ListAdapter.5
                    @Override // android.view.View
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(GroupCallActivity.isLandscapeMode ? 0 : 8), 1073741824));
                    }
                };
            } else if (i == 6) {
                ...
                textView.setPadding(0, 0, 0, AndroidUtilities.m107dp(10));
                if (ChatObject.isChannelOrGiga(GroupCallActivity.this.currentChat)) {
    ...
    public class AvatarUpdaterDelegate implements ImageUpdater.ImageUpdaterDelegate {
        ...
        public /* synthetic */ void lambda$didUploadPhoto$0(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, String str) {
            ...
            if (tLRPC$TL_error == null) {
                ...
                GroupCallActivity.this.accountInstance.getMessagesController().getDialogPhotos(user.f1751id).reset();
                ArrayList arrayList2 = new ArrayList();
                arrayList2.add(user);
