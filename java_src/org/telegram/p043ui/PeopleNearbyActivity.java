    ...
    public View createView(Context context) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.PeopleNearbyActivity.3
            ...
            protected void onMeasure(int i2, int i3) {
                ((FrameLayout.LayoutParams) PeopleNearbyActivity.this.actionBarBackground.getLayoutParams()).height = C3704ActionBar.getCurrentActionBarHeight() + (((BaseFragment) PeopleNearbyActivity.this).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + AndroidUtilities.m107dp(3);
    ...
    public void sendRequest(boolean z, final int i) {
        ...
        if (!z && (location = this.lastLoadedLocation) != null) {
            ...
            if (BuildVars.DEBUG_VERSION) {
                FileLog.m105d("located distance = " + distanceTo);
            }
            if (i == 0 && (SystemClock.elapsedRealtime() - this.lastLoadedLocationTime < C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS || this.lastLoadedLocation.distanceTo(lastKnownLocation) <= 20.0f)) {
                return;
            }
            if (this.reqId != 0) {
    ...
    */
    ...
    public static class HeaderCellProgress extends HeaderCell {
        ...
        public HeaderCellProgress(Context context) {
            ...
            radialProgressView.setSize(AndroidUtilities.m107dp(14));
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(PeopleNearbyActivity peopleNearbyActivity, Context context) {
            ...
            imageView.setBackgroundDrawable(Theme.createCircleDrawable(AndroidUtilities.m107dp(74), Theme.getColor(Theme.key_chats_archiveBackground)));
            ...
            if (i == 0) {
                ...
                if (i == 1) {
                    ...
                    TextView textView = new TextView(this, this.mContext) { // from class: org.telegram.ui.PeopleNearbyActivity.ListAdapter.1
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(67), 1073741824));
                        }
                    };
                    textView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                    textView.setPadding(0, 0, AndroidUtilities.m107dp(3), 0);
