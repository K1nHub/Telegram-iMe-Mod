...
/* renamed from: org.telegram.ui.PeopleNearbyActivity */
...
public class PeopleNearbyActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, LocationController.LocationFetchCallback {
    ...
    private void updateRows(final DiffCallback diffCallback) {
        int min;
        this.rowCount = 0;
        ...
        if (this.listViewAdapter != null) {
            ...
            this.listView.post(new Runnable() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    PeopleNearbyActivity.this.lambda$updateRows$0(diffCallback);
                }
            });
        }
    }
    ...
    public /* synthetic */ void lambda$updateRows$0(DiffCallback diffCallback) {
        DiffUtil.calculateDiff(diffCallback).dispatchUpdatesTo(this.listViewAdapter);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.PeopleNearbyActivity$DiffCallback */
    /* loaded from: classes5.dex */
        ...
        public boolean areItemsTheSame(int i, int i2) {
            ...
            if (i2 < PeopleNearbyActivity.this.usersStartRow || i2 >= PeopleNearbyActivity.this.usersEndRow || i < (i4 = this.oldUsersStartRow) || i >= this.oldUsersEndRow) {
                if (i2 >= PeopleNearbyActivity.this.chatsStartRow && i2 < PeopleNearbyActivity.this.chatsEndRow && i >= (i3 = this.oldChatsStartRow) && i < this.oldChatsEndRow) {
                    int i5 = i - i3;
                    int i6 = i2 - PeopleNearbyActivity.this.chatsStartRow;
                    return i5 >= 0 && i5 < this.oldChats.size() && i6 >= 0 && i6 < PeopleNearbyActivity.this.chats.size() && MessageObject.getPeerId(this.oldChats.get(i - this.oldChatsStartRow).peer) == MessageObject.getPeerId(((TLRPC$TL_peerLocated) PeopleNearbyActivity.this.chats.get(i2 - PeopleNearbyActivity.this.chatsStartRow)).peer);
                }
                int i7 = this.oldPositionToItem.get(i, -1);
                return i7 == this.newPositionToItem.get(i2, -1) && i7 >= 0;
            }
            int i8 = i - i4;
            int i9 = i2 - PeopleNearbyActivity.this.usersStartRow;
            return i8 >= 0 && i8 < this.oldUsers.size() && i9 >= 0 && i9 < PeopleNearbyActivity.this.users.size() && MessageObject.getPeerId(this.oldUsers.get(i - this.oldUsersStartRow).peer) == MessageObject.getPeerId(((TLRPC$TL_peerLocated) PeopleNearbyActivity.this.users.get(i2 - PeopleNearbyActivity.this.usersStartRow)).peer);
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("PeopleNearby", C3634R.string.PeopleNearby));
        this.actionBar.getTitleTextView().setAlpha(BitmapDescriptorFactory.HUE_RED);
        this.actionBar.setActionBarMenuOnItemClick(new C3706ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PeopleNearbyActivity.2
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.PeopleNearbyActivity.3
            ...
            protected void onMeasure(int i2, int i3) {
                ((FrameLayout.LayoutParams) PeopleNearbyActivity.this.actionBarBackground.getLayoutParams()).height = C3706ActionBar.getCurrentActionBarHeight() + (((BaseFragment) PeopleNearbyActivity.this).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + AndroidUtilities.m104dp(3);
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda12
            @Override // org.telegram.p043ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i3) {
                PeopleNearbyActivity.this.lambda$createView$3(view, i3);
            }
        });
        ...
        View view = new View(context) { // from class: org.telegram.ui.PeopleNearbyActivity.6
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int measuredHeight = getMeasuredHeight() - AndroidUtilities.m104dp(3);
        ...
        frameLayout2.addView(this.actionBarBackground, LayoutHelper.createFrame(-1, -2));
        frameLayout2.addView(this.actionBar, LayoutHelper.createFrame(-1, -2));
    ...
    public /* synthetic */ void lambda$createView$3(View view, int i) {
        ...
        if (i >= i3 && i < this.chatsEndRow) {
            ...
            if (this.checkingCanCreate || this.currentGroupCreateAddress == null) {
                ...
                alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda0
                    ...
                    public final void onCancel(DialogInterface dialogInterface) {
                        PeopleNearbyActivity.this.lambda$createView$1(dialogInterface);
                    }
                });
            ...
            if (this.showingMe) {
                ...
                builder.setTitle(LocaleController.getString("MakeMyselfVisibleTitle", C3634R.string.MakeMyselfVisibleTitle));
                builder.setMessage(LocaleController.getString("MakeMyselfVisibleInfo", C3634R.string.MakeMyselfVisibleInfo));
                builder.setPositiveButton(LocaleController.getString("OK", C3634R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i4) {
                        PeopleNearbyActivity.this.lambda$createView$2(userConfig, dialogInterface, i4);
                    }
                });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$1(DialogInterface dialogInterface) {
        this.loadingDialog = null;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$2(UserConfig userConfig, DialogInterface dialogInterface, int i) {
    ...
    */
    public void checkScroll(boolean r11) {
        ...
        L15:
            ...
            org.telegram.ui.PeopleNearbyActivity$HintInnerCell r0 = (org.telegram.p043ui.PeopleNearbyActivity.HintInnerCell) r0
            android.widget.TextView r3 = org.telegram.p043ui.PeopleNearbyActivity.HintInnerCell.access$2200(r0)
            int[] r4 = r10.location
            r3.getLocationOnScreen(r4)
            int[] r3 = r10.location
            r3 = r3[r2]
            android.widget.TextView r0 = org.telegram.p043ui.PeopleNearbyActivity.HintInnerCell.access$2200(r0)
        ...
        Lc6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.PeopleNearbyActivity.checkScroll(boolean):void");
    }

    private void openGroupCreate() {
        if (!this.canCreateGroup) {
            AlertsCreator.showSimpleAlert(this, LocaleController.getString("YourLocatedChannelsTooMuch", C3634R.string.YourLocatedChannelsTooMuch));
            return;
        }
    ...
    private void checkCanCreateGroup() {
        ...
        getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_channels_getAdminedPublicChannels, new RequestDelegate() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda9
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                PeopleNearbyActivity.this.lambda$checkCanCreateGroup$5(tLObject, tLRPC$TL_error);
            }
        }), this.classGuid);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkCanCreateGroup$5(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                PeopleNearbyActivity.this.lambda$checkCanCreateGroup$4(tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkCanCreateGroup$4(TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void sendRequest(boolean z, final int i) {
        ...
        if (!this.firstLoaded) {
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    PeopleNearbyActivity.this.lambda$sendRequest$6();
                }
            };
        ...
        if (!z && (location = this.lastLoadedLocation) != null) {
            ...
            if (BuildVars.DEBUG_VERSION) {
                FileLog.m102d("located distance = " + distanceTo);
            }
            if (i == 0 && (SystemClock.elapsedRealtime() - this.lastLoadedLocationTime < C0485C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS || this.lastLoadedLocation.distanceTo(lastKnownLocation) <= 20.0f)) {
                return;
            }
            if (this.reqId != 0) {
        ...
        this.reqId = getConnectionsManager().sendRequest(tLRPC$TL_contacts_getLocated, new RequestDelegate() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda10
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                PeopleNearbyActivity.this.lambda$sendRequest$8(i, tLObject, tLRPC$TL_error);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sendRequest$6() {
        showLoadingProgress(true);
        this.showProgressRunnable = null;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sendRequest$8(final int i, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                PeopleNearbyActivity.this.lambda$sendRequest$7(i, tLRPC$TL_error, tLObject);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sendRequest$7(int i, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        boolean z;
        this.reqId = 0;
    ...
    public void onResume() {
        ...
        super.onResume();
        if (this.listViewAdapter != null && (recyclerListView = this.listView) != null) {
            recyclerListView.post(new Runnable() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    PeopleNearbyActivity.this.lambda$onResume$9();
                }
            });
        }
    ...
    */
    public void didReceivedNotification(int r19, int r20, java.lang.Object... r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.PeopleNearbyActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didReceivedNotification$10(TLRPC$Chat tLRPC$Chat, long j, boolean z) {
        if (tLRPC$Chat != null) {
    ...
    private void checkForExpiredLocations(boolean z) {
        ...
        if (i != Integer.MAX_VALUE) {
            Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    PeopleNearbyActivity.this.lambda$checkForExpiredLocations$11();
                }
            };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkForExpiredLocations$11() {
        this.checkExpiredRunnable = null;
        checkForExpiredLocations(false);
    }

    /* renamed from: org.telegram.ui.PeopleNearbyActivity$HeaderCellProgress */
    /* loaded from: classes5.dex */
    public static class HeaderCellProgress extends HeaderCell {
        ...
        public HeaderCellProgress(Context context) {
            ...
            radialProgressView.setSize(AndroidUtilities.m104dp(14));
            ...
            addView(radialProgressView2, LayoutHelper.createFrame(50, 40, (z ? 3 : 5) | 48, z ? 2 : 0, 3, z ? 0 : 2, 0));
        }
    }

    /* renamed from: org.telegram.ui.PeopleNearbyActivity$HintInnerCell */
    /* loaded from: classes5.dex */
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(PeopleNearbyActivity peopleNearbyActivity, Context context) {
            super(context);
            int currentActionBarHeight = ((int) ((C3706ActionBar.getCurrentActionBarHeight() + (((BaseFragment) peopleNearbyActivity).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0)) / AndroidUtilities.density)) - 44;
            ImageView imageView = new ImageView(context);
            this.imageView = imageView;
            imageView.setBackgroundDrawable(Theme.createCircleDrawable(AndroidUtilities.m104dp(74), Theme.getColor(Theme.key_chats_archiveBackground)));
            this.imageView.setImageDrawable(new ShareLocationDrawable(context, 2));
            this.imageView.setScaleType(ImageView.ScaleType.CENTER);
            addView(this.imageView, LayoutHelper.createFrame(74, 74, 49, 0, currentActionBarHeight + 27, 0, 0));
            TextView textView = new TextView(context);
            this.titleTextView = textView;
            textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            this.titleTextView.setTextSize(1, 24.0f);
            this.titleTextView.setGravity(17);
            this.titleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("PeopleNearby", C3634R.string.PeopleNearby, new Object[0])));
            addView(this.titleTextView, LayoutHelper.createFrame(-1, -2, 51, 17, currentActionBarHeight + 120, 17, 27));
            TextView textView2 = new TextView(context);
            this.messageTextView = textView2;
            textView2.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText));
            this.messageTextView.setTextSize(1, 15.0f);
            this.messageTextView.setGravity(17);
            this.messageTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("PeopleNearbyInfo2", C3634R.string.PeopleNearbyInfo2, new Object[0])));
            addView(this.messageTextView, LayoutHelper.createFrame(-1, -2, 51, 40, currentActionBarHeight + 161, 40, 27));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.PeopleNearbyActivity$ListAdapter */
    /* loaded from: classes5.dex */
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            if (i == 0) {
                ...
                if (i == 1) {
                    ...
                    TextView textView = new TextView(this, this.mContext) { // from class: org.telegram.ui.PeopleNearbyActivity.ListAdapter.1
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m104dp(67), 1073741824));
                        }
                    };
                    textView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                    textView.setPadding(0, 0, AndroidUtilities.m104dp(3), 0);
                    textView.setTextSize(1, 14.0f);
                    textView.setGravity(17);
                    textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText3));
                    manageChatUserCell = textView;
                } else {
                    view = new HintInnerCell(PeopleNearbyActivity.this, this.mContext);
                    view.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                }
        ...
        public void onViewAttachedToWindow(RecyclerView.ViewHolder viewHolder) {
            ...
            ((HeaderCellProgress) viewHolder.itemView).progressView.setAlpha(PeopleNearbyActivity.this.showingLoadingProgress ? 1.0f : BitmapDescriptorFactory.HUE_RED);
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (user != null) {
                    ...
                    manageChatUserCell.setData(user, null, formatDistance2, r4);
                }
                ...
                if (i != PeopleNearbyActivity.this.usersHeaderRow) {
                    if (i == PeopleNearbyActivity.this.chatsHeaderRow) {
                        headerCellProgress.setText(LocaleController.getString("ChatsNearbyHeader", C3634R.string.ChatsNearbyHeader));
                        return;
                    }
                    return;
                }
                headerCellProgress.setText(LocaleController.getString("PeopleNearbyHeader", C3634R.string.PeopleNearbyHeader));
            } else {
                ManageChatTextCell manageChatTextCell = (ManageChatTextCell) viewHolder.itemView;
                manageChatTextCell.setColors(Theme.key_windowBackgroundWhiteBlueIcon, Theme.key_windowBackgroundWhiteBlueButton);
                if (i == PeopleNearbyActivity.this.chatsCreateRow) {
                    manageChatTextCell.setText(LocaleController.getString("NearbyCreateGroup", C3634R.string.NearbyCreateGroup), null, C3634R.C3636drawable.msg_groups_create, PeopleNearbyActivity.this.chatsStartRow != -1);
                } else if (i != PeopleNearbyActivity.this.showMeRow) {
                    if (i == PeopleNearbyActivity.this.showMoreRow) {
                        manageChatTextCell.setText(LocaleController.formatPluralString("ShowVotes", PeopleNearbyActivity.this.users.size() - 5, new Object[0]), null, C3634R.C3636drawable.arrow_more, false);
                    }
                } else {
                    ...
                    if (peopleNearbyActivity.showingMe = peopleNearbyActivity.getUserConfig().sharingMyLocationUntil > PeopleNearbyActivity.this.getConnectionsManager().getCurrentTime()) {
                        manageChatTextCell.setText(LocaleController.getString("StopShowingMe", C3634R.string.StopShowingMe), null, C3634R.C3636drawable.msg_nearby_off, PeopleNearbyActivity.this.usersStartRow != -1);
                        int i4 = Theme.key_text_RedRegular;
                        manageChatTextCell.setColors(i4, i4);
                        return;
                    }
                    manageChatTextCell.setText(LocaleController.getString("MakeMyselfVisible", C3634R.string.MakeMyselfVisible), null, C3634R.C3636drawable.msg_nearby, PeopleNearbyActivity.this.usersStartRow != -1);
                }
            }
        }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda11
            @Override // org.telegram.p043ui.ActionBar.ThemeDescription.ThemeDescriptionDelegate
            public final void didSetColor() {
                PeopleNearbyActivity.this.lambda$getThemeDescriptions$12();
            }
        ...
        arrayList.add(new ThemeDescription(c3706ActionBar2, i4, null, null, null, null, i5));
