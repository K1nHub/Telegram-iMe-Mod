...
public class PeopleNearbyActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, LocationController.LocationFetchCallback {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("PeopleNearby", C3632R.string.PeopleNearby));
        this.actionBar.getTitleTextView().setAlpha(BitmapDescriptorFactory.HUE_RED);
        this.actionBar.setActionBarMenuOnItemClick(new C3704ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PeopleNearbyActivity.2
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.PeopleNearbyActivity.3
            ...
            protected void onMeasure(int i2, int i3) {
                ((FrameLayout.LayoutParams) PeopleNearbyActivity.this.actionBarBackground.getLayoutParams()).height = C3704ActionBar.getCurrentActionBarHeight() + (((BaseFragment) PeopleNearbyActivity.this).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0) + AndroidUtilities.m104dp(3);
    ...
    public /* synthetic */ void lambda$createView$3(View view, int i) {
        ...
        if (i >= i3 && i < this.chatsEndRow) {
            ...
            if (this.showingMe) {
                ...
                builder.setTitle(LocaleController.getString("MakeMyselfVisibleTitle", C3632R.string.MakeMyselfVisibleTitle));
                builder.setMessage(LocaleController.getString("MakeMyselfVisibleInfo", C3632R.string.MakeMyselfVisibleInfo));
                builder.setPositiveButton(LocaleController.getString("OK", C3632R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.PeopleNearbyActivity$$ExternalSyntheticLambda1
    ...
    */
    ...
    private void openGroupCreate() {
        if (!this.canCreateGroup) {
            AlertsCreator.showSimpleAlert(this, LocaleController.getString("YourLocatedChannelsTooMuch", C3632R.string.YourLocatedChannelsTooMuch));
            return;
        }
    ...
    */
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(PeopleNearbyActivity peopleNearbyActivity, Context context) {
            super(context);
            int currentActionBarHeight = ((int) ((C3704ActionBar.getCurrentActionBarHeight() + (((BaseFragment) peopleNearbyActivity).actionBar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0)) / AndroidUtilities.density)) - 44;
            ...
            this.titleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("PeopleNearby", C3632R.string.PeopleNearby, new Object[0])));
            ...
            this.messageTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("PeopleNearbyInfo2", C3632R.string.PeopleNearbyInfo2, new Object[0])));
            ...
            if (itemViewType == 0) {
                ...
                if (i != PeopleNearbyActivity.this.usersHeaderRow) {
                    if (i == PeopleNearbyActivity.this.chatsHeaderRow) {
                        headerCellProgress.setText(LocaleController.getString("ChatsNearbyHeader", C3632R.string.ChatsNearbyHeader));
                        return;
                    }
                    return;
                }
                headerCellProgress.setText(LocaleController.getString("PeopleNearbyHeader", C3632R.string.PeopleNearbyHeader));
            } else {
                ManageChatTextCell manageChatTextCell = (ManageChatTextCell) viewHolder.itemView;
                manageChatTextCell.setColors(Theme.key_windowBackgroundWhiteBlueIcon, Theme.key_windowBackgroundWhiteBlueButton);
                if (i == PeopleNearbyActivity.this.chatsCreateRow) {
                    manageChatTextCell.setText(LocaleController.getString("NearbyCreateGroup", C3632R.string.NearbyCreateGroup), null, C3632R.C3634drawable.msg_groups_create, PeopleNearbyActivity.this.chatsStartRow != -1);
                } else if (i != PeopleNearbyActivity.this.showMeRow) {
                    if (i == PeopleNearbyActivity.this.showMoreRow) {
                        manageChatTextCell.setText(LocaleController.formatPluralString("ShowVotes", PeopleNearbyActivity.this.users.size() - 5, new Object[0]), null, C3632R.C3634drawable.arrow_more, false);
                    }
                } else {
                    ...
                    if (peopleNearbyActivity.showingMe = peopleNearbyActivity.getUserConfig().sharingMyLocationUntil > PeopleNearbyActivity.this.getConnectionsManager().getCurrentTime()) {
                        manageChatTextCell.setText(LocaleController.getString("StopShowingMe", C3632R.string.StopShowingMe), null, C3632R.C3634drawable.msg_nearby_off, PeopleNearbyActivity.this.usersStartRow != -1);
                        int i4 = Theme.key_text_RedRegular;
                        manageChatTextCell.setColors(i4, i4);
                        return;
                    }
                    manageChatTextCell.setText(LocaleController.getString("MakeMyselfVisible", C3632R.string.MakeMyselfVisible), null, C3632R.C3634drawable.msg_nearby, PeopleNearbyActivity.this.usersStartRow != -1);
                }
            }
        }
