...
public class ChatActivityMemberRequestsDelegate {
    ...
    public View getView() {
        if (this.root == null) {
            ...
            frameLayout.setBackgroundResource(C3473R.C3475drawable.blockpanel);
            ...
            this.closeView.setContentDescription(LocaleController.getString("Close", C3473R.string.Close));
            this.closeView.setImageResource(C3473R.C3475drawable.miniplayer_close);
    ...
    public /* synthetic */ void lambda$getView$1(View view) {
        this.fragment.getMessagesController().setChatPendingRequestsOnClose(this.currentChat.f1522id, this.pendingRequestsCount);
    ...
    private void showBottomSheet() {
        if (this.bottomSheet == null) {
            this.bottomSheet = new MemberRequestsBottomSheet(this.fragment, this.currentChat.f1522id) { // from class: org.telegram.ui.Delegates.ChatActivityMemberRequestsDelegate.2
    ...
    private void setPendingRequests(int i, List<Long> list, boolean z) {
        ...
        if (i <= 0) {
            if (this.currentChat != null) {
                this.fragment.getMessagesController().setChatPendingRequestsOnClose(this.currentChat.f1522id, 0);
    ...
    private void animatePendingRequests(final boolean z, boolean z2) {
        ...
        if (z) {
            if (this.closePendingRequestsCount == -1 && this.currentChat != null) {
                this.closePendingRequestsCount = this.fragment.getMessagesController().getChatPendingRequestsOnClosed(this.currentChat.f1522id);
            }
