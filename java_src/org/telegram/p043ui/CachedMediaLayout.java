    ...
    public CachedMediaLayout(Context context, BaseFragment baseFragment) {
        ...
        while (true) {
            ...
            if (i < pageArr2.length) {
                ...
                animatedTextView.setTextSize(AndroidUtilities.m104dp(18));
    ...
    */
    ...
    public class DialogsAdapter extends BaseAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            userCell.getImageView().setRoundRadius(AndroidUtilities.m104dp(((userOrChat instanceof TLRPC$Chat) && ((TLRPC$Chat) userOrChat).forum) ? 12 : 19));
    ...
    public class DocumentsAdapter extends BaseFilesAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            sharedDocumentCell.getImageView().setRoundRadius(AndroidUtilities.m104dp(fileInfo.messageType == 5 ? 20 : 4));
    ...
    */
    public /* synthetic */ void lambda$checkMessageObjectForAudio$3(final org.telegram.p043ui.Storage.CacheModel.FileInfo r12, final org.telegram.tgnet.TLRPC$TL_documentAttributeAudio r13) {
        ...
        L33:
            r2 = r0
        L34:
            org.telegram.messenger.FileLog.m99e(r3)     // Catch: java.lang.Throwable -> L30
            if (r1 == 0) goto L3c
    ...
    public class CacheCell extends FrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.drawDivider) {
                if (LocaleController.isRTL) {
                    canvas.drawLine(BitmapDescriptorFactory.HUE_RED, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.m104dp(48), getMeasuredHeight() - 1, Theme.dividerPaint);
                } else {
                    canvas.drawLine(getMeasuredWidth() - AndroidUtilities.m104dp(90), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
                }
            }
        }
    }
