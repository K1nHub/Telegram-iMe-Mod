...
public class CachedMediaLayout extends FrameLayout implements NestedSizeNotifierLayout.ChildLayout {
    ...
    public CachedMediaLayout(Context context, BaseFragment baseFragment) {
        ...
        pageArr[0] = new Page(this, LocaleController.getString("FilterChats", C3473R.string.FilterChats), 0, new DialogsAdapter(this, null), null);
        this.allPages[1] = new Page(this, LocaleController.getString("MediaTab", C3473R.string.MediaTab), 1, new MediaAdapter(this, false, null), null);
        this.allPages[2] = new Page(this, LocaleController.getString("SharedFilesTab2", C3473R.string.SharedFilesTab2), 2, new DocumentsAdapter(this, null), null);
        this.allPages[3] = new Page(this, LocaleController.getString("Music", C3473R.string.Music), 3, new MusicAdapter(this, null), null);
        int i = 0;
        while (true) {
            ...
            if (i < pageArr2.length) {
                ...
                this.viewPagerFixed.setAdapter(new C37681(context, baseFragment));
                ...
                imageView.setContentDescription(LocaleController.getString("Close", C3473R.string.Close));
                ...
                actionBarMenuItem.setIcon(C3473R.C3475drawable.msg_clear);
                actionBarMenuItem.setContentDescription(LocaleController.getString("Delete", C3473R.string.Delete));
    ...
    /* loaded from: classes3.dex */
    public class C37681 extends ViewPagerFixed.Adapter {
        ...
        C37681(Context context, BaseFragment baseFragment) {
        ...
        public View createView(int i) {
            ...
            recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.CachedMediaLayout.1.1
                ...
                public void onItemClick(View view, int i2) {
                    ...
                    if (view instanceof SharedPhotoVideoCell2) {
                        ...
                        tLRPC$TL_storyItem.f1557id = Objects.hash(fileInfo.file.getAbsolutePath());
                        tLRPC$TL_storyItem.attachPath = itemInner.file.file.getAbsolutePath();
                        tLRPC$TL_storyItem.date = -1;
                        C37681.this.val$parentFragment.getOrCreateStoryViewer().open(C37681.this.val$context, tLRPC$TL_storyItem, StoriesListPlaceProvider.m24of(recyclerListView));
                        return;
                    }
            ...
            recyclerListView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListenerExtended() { // from class: org.telegram.ui.CachedMediaLayout$1$$ExternalSyntheticLambda5
                ...
                public final boolean onItemClick(View view, int i2, float f, float f2) {
                    ...
                    lambda$createView$5 = CachedMediaLayout.C37681.this.lambda$createView$5(recyclerListView, baseFragment, view, i2, f, f2);
        ...
        public /* synthetic */ boolean lambda$createView$5(final RecyclerListView recyclerListView, final BaseFragment baseFragment, final View view, int i, float f, float f2) {
            ...
            if ((view instanceof CacheCell) || (view instanceof SharedPhotoVideoCell2)) {
                ...
                if (view instanceof SharedPhotoVideoCell2) {
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3473R.C3475drawable.msg_view_file, LocaleController.getString("CacheOpenFile", C3473R.string.CacheOpenFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$1$$ExternalSyntheticLambda4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            CachedMediaLayout.C37681.this.lambda$createView$0(itemInner, baseAdapter, recyclerListView, view, view2);
                        }
                    });
                } else if (((CacheCell) view).container.getChildAt(0) instanceof SharedAudioCell) {
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3473R.C3475drawable.msg_played, LocaleController.getString("PlayFile", C3473R.string.PlayFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$1$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            CachedMediaLayout.C37681.this.lambda$createView$1(itemInner, view, view2);
                        }
                    });
                } else {
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3473R.C3475drawable.msg_view_file, LocaleController.getString("CacheOpenFile", C3473R.string.CacheOpenFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$1$$ExternalSyntheticLambda2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            CachedMediaLayout.C37681.this.lambda$createView$2(itemInner, view, view2);
                        }
                    });
                }
                CacheModel.FileInfo fileInfo = itemInner.file;
                if (fileInfo.dialogId != 0 && fileInfo.messageId != 0) {
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C3473R.C3475drawable.msg_viewintopic, LocaleController.getString("ViewInChat", C3473R.string.ViewInChat), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$1$$ExternalSyntheticLambda3
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            CachedMediaLayout.C37681.this.lambda$createView$3(itemInner, baseFragment, view2);
                        }
                    });
                }
                int i3 = C3473R.C3475drawable.msg_select;
                if (CachedMediaLayout.this.cacheModel.selectedFiles.contains(itemInner.file)) {
                    i2 = C3473R.string.Deselect;
                    str = "Deselect";
                } else {
                    i2 = C3473R.string.Select;
                    str = "Select";
                }
                ActionBarMenuItem.addItem(actionBarPopupWindowLayout, i3, LocaleController.getString(str, i2), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$1$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        CachedMediaLayout.C37681.this.lambda$createView$4(itemInner, view2);
                    }
                });
    ...
    */
    ...
    public class Page {
        ...
        /* synthetic */ Page(CachedMediaLayout cachedMediaLayout, String str, int i, BaseAdapter baseAdapter, C37681 c37681) {
    ...
    public class DialogsAdapter extends BaseAdapter {
        ...
        /* synthetic */ DialogsAdapter(CachedMediaLayout cachedMediaLayout, C37681 c37681) {
            this();
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (dialogFileEntities.dialogId == Long.MAX_VALUE) {
                dialogPhotoTitle = LocaleController.getString("CacheOtherChats", C3473R.string.CacheOtherChats);
    ...
    public class MediaAdapter extends BaseFilesAdapter {
        ...
        /* synthetic */ MediaAdapter(CachedMediaLayout cachedMediaLayout, boolean z, C37681 c37681) {
            this(z);
        }
    ...
    public class DocumentsAdapter extends BaseFilesAdapter {
        ...
        /* synthetic */ DocumentsAdapter(CachedMediaLayout cachedMediaLayout, C37681 c37681) {
            this();
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            sharedDocumentCell.setTextAndValueAndTypeAndThumb(fileInfo.messageType == 5 ? LocaleController.getString("AttachRound", C3473R.string.AttachRound) : fileInfo.file.getName(), LocaleController.formatDateAudio(fileInfo.file.lastModified() / 1000, true), Utilities.getExtension(fileInfo.file.getName()), null, 0, z2);
            if (!z) {
    ...
    public class MusicAdapter extends BaseFilesAdapter {
        /* synthetic */ MusicAdapter(CachedMediaLayout cachedMediaLayout, C37681 c37681) {
            this();
        }
    ...
    */
    ...
    public class BasePlaceProvider extends PhotoViewer.EmptyPhotoViewerProvider {
        ...
        /* synthetic */ BasePlaceProvider(CachedMediaLayout cachedMediaLayout, C37681 c37681) {
            this();
        }
