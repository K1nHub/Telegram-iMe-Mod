...
public class ChatRightsEditActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        ...
        if (this.canEdit || (!this.isChannel && this.currentChat.creator && UserObject.isUserSelf(this.currentUser))) {
            ...
            createMenu.addItemWithWidth(1, 0, AndroidUtilities.m107dp(56), LocaleController.getString("Done", C3632R.string.Done));
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.ChatRightsEditActivity.2
            ...
            protected void onLayout(boolean z, int i3, int i4, int i5, int i6) {
                ...
                if (i8 != -1 && Math.abs(i8 - i7) > AndroidUtilities.m107dp(20)) {
        ...
        if (this.canEdit || (this.currentChat.creator && this.currentType == 0 && i == this.anonymousRow)) {
            ...
            if (i == i3) {
                ...
                for (int i6 = 5; i5 < i6; i6 = 5) {
                    ...
                    bottomSheetCellArr[i5].setPadding(AndroidUtilities.m107dp(7), 0, AndroidUtilities.m107dp(7), 0);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 8:
                    ...
                    ChatRightsEditActivity.this.addBotButtonText.setTextSize(AndroidUtilities.m107dp(14));
