...
public class NotificationPermissionDialog extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public NotificationPermissionDialog(Context context, Utilities.Callback<Boolean> callback) {
        ...
        this.rLottieImageView.setAnimation(C3473R.raw.silent_unmute, 46, 46);
        ...
        rLottieImageView2.setBackground(Theme.createCircleDrawable(m72dp, Theme.getColor(i)));
        ...
        textView.setPadding(AndroidUtilities.m72dp(30), 0, AndroidUtilities.m72dp(30), 0);
        ...
        textView2.setPadding(AndroidUtilities.m72dp(30), AndroidUtilities.m72dp(10), AndroidUtilities.m72dp(30), AndroidUtilities.m72dp(21));
        linearLayout.addView(textView2, LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C3473R.C3475drawable.msg_message_s, LocaleController.getString("NotificationsPermissionAlert1")), LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C3473R.C3475drawable.msg_members_list2, LocaleController.getString("NotificationsPermissionAlert2")), LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C3473R.C3475drawable.msg_customize_s, LocaleController.getString("NotificationsPermissionAlert3")), LayoutHelper.createLinear(-1, -2));
    ...
    public static class CounterView extends View {
        ...
        public CounterView(Context context) {
            ...
            paint2.setStrokeWidth(AndroidUtilities.m72dp(4));
            ...
            this.textDrawable.getPaint().setStrokeWidth(AndroidUtilities.m73dp(0.24f));
            this.textDrawable.getPaint().setStrokeJoin(Paint.Join.ROUND);
            this.textDrawable.setTextSize(AndroidUtilities.m73dp(13.3f));
            this.textDrawable.setTextColor(Theme.getColor(Theme.key_featuredStickers_buttonText));
            this.textDrawable.setOverrideFullWidth(AndroidUtilities.m72dp(64));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m72dp(30), AndroidUtilities.m72dp(30), this.strokePaint);
            this.fillPaint.setAlpha(i);
            canvas.drawRoundRect(rectF, AndroidUtilities.m72dp(30), AndroidUtilities.m72dp(30), this.fillPaint);
            canvas.save();
    ...
    private static class SectionView extends FrameLayout {
        public SectionView(Context context, int i, CharSequence charSequence) {
            super(context);
            setPadding(0, AndroidUtilities.m72dp(7), 0, AndroidUtilities.m72dp(7));
