...
public class PhotoCropActivity extends BaseFragment {
    ...
    public class PhotoCropView extends FrameLayout {
        ...
        private void init() {
            ...
            this.rectPaint.setStrokeWidth(AndroidUtilities.m104dp(2));
        ...
        */
        ...
        private void updateBitmapSize() {
            ...
            this.bitmapX = ((this.viewWidth - this.bitmapWidth) / 2) + AndroidUtilities.m104dp(14);
            int m104dp = ((this.viewHeight - this.bitmapHeight) / 2) + AndroidUtilities.m104dp(14);
            this.bitmapY = m104dp;
            if (this.rectX == -1.0f && this.rectY == -1.0f) {
                if (this.freeform) {
                    ...
                    if (this.bitmapWidth > this.bitmapHeight) {
                        this.rectY = m104dp;
                        this.rectX = ((this.viewWidth - i2) / 2) + AndroidUtilities.m104dp(14);
                        int i7 = this.bitmapHeight;
                        this.rectSizeX = i7;
                        this.rectSizeY = i7;
                    } else {
                        this.rectX = this.bitmapX;
                        this.rectY = ((this.viewHeight - i) / 2) + AndroidUtilities.m104dp(14);
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            this.viewWidth = (i3 - i) - AndroidUtilities.m104dp(28);
            this.viewHeight = (i4 - i2) - AndroidUtilities.m104dp(28);
            updateBitmapSize();
        }
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.imageToCrop == null) {
            ...
            if (AndroidUtilities.isTablet()) {
                max = AndroidUtilities.m104dp(520);
            } else {
