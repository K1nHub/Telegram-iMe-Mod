...
public class PhotoCropActivity extends BaseFragment {
    ...
    public class PhotoCropView extends FrameLayout {
        ...
        private void init() {
            ...
            this.rectPaint.setStrokeWidth(AndroidUtilities.m107dp(2));
        ...
        */
        public /* synthetic */ boolean lambda$init$0(android.view.View r13, android.view.MotionEvent r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.PhotoCropActivity.PhotoCropView.lambda$init$0(android.view.View, android.view.MotionEvent):boolean");
        }
        ...
        private void updateBitmapSize() {
            ...
            this.bitmapX = ((this.viewWidth - this.bitmapWidth) / 2) + AndroidUtilities.m107dp(14);
            int m107dp = ((this.viewHeight - this.bitmapHeight) / 2) + AndroidUtilities.m107dp(14);
            this.bitmapY = m107dp;
            if (this.rectX == -1.0f && this.rectY == -1.0f) {
                if (this.freeform) {
                    ...
                    if (this.bitmapWidth > this.bitmapHeight) {
                        this.rectY = m107dp;
                        this.rectX = ((this.viewWidth - i2) / 2) + AndroidUtilities.m107dp(14);
                        int i7 = this.bitmapHeight;
                        this.rectSizeX = i7;
                        this.rectSizeY = i7;
                    } else {
                        this.rectX = this.bitmapX;
                        this.rectY = ((this.viewHeight - i) / 2) + AndroidUtilities.m107dp(14);
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            this.viewWidth = (i3 - i) - AndroidUtilities.m107dp(28);
            this.viewHeight = (i4 - i2) - AndroidUtilities.m107dp(28);
            updateBitmapSize();
        }
        ...
        */
        protected void onDraw(android.graphics.Canvas r16) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.PhotoCropActivity.PhotoCropView.onDraw(android.graphics.Canvas):void");
        }
    }
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.imageToCrop == null) {
            ...
            if (AndroidUtilities.isTablet()) {
                max = AndroidUtilities.m107dp(520);
            } else {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.createMenu().addItemWithWidth(1, C3632R.C3634drawable.ic_ab_done, AndroidUtilities.m107dp(56), LocaleController.getString("Done", C3632R.string.Done));
