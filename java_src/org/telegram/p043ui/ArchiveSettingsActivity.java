...
public class ArchiveSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C3485ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ArchiveSettingsActivity.1
    ...
    public /* synthetic */ void lambda$createView$1(View view, int i) {
        ...
        int i2 = this.items.get(i).f1694id;
        if (i2 == 1) {
            ...
            if (!getUserConfig().isPremium() && !getMessagesController().autoarchiveAvailable && !this.settings.archive_and_mute_new_noncontact_peers) {
                ...
                simpleLayout.textView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(C3419R.string.UnlockPremium), Theme.key_undo_cancelColor, 0, new Runnable() { // from class: org.telegram.ui.ArchiveSettingsActivity$$ExternalSyntheticLambda0
                ...
                simpleLayout.textView.setPadding(0, AndroidUtilities.m72dp(4), 0, AndroidUtilities.m72dp(4));
    ...
    public static class ItemInner extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f1694id == itemInner.f1694id && Objects.equals(this.text, itemInner.text);
        }
    }
    ...
    public class ListAdapter extends AdapterWithDiffUtils {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (viewHolder.getItemViewType() == 0) {
                ...
                if (z2) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(ArchiveSettingsActivity.this.getContext(), C3419R.C3421drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                } else {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(ArchiveSettingsActivity.this.getContext(), C3419R.C3421drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                }
            } else if (viewHolder.getItemViewType() == 1) {
                TextCheckCell textCheckCell = (TextCheckCell) viewHolder.itemView;
                int i4 = itemInner.f1694id;
                if (i4 == 1) {
                    ...
                    if (!ArchiveSettingsActivity.this.getUserConfig().isPremium() && !ArchiveSettingsActivity.this.getMessagesController().autoarchiveAvailable) {
                        i3 = C3419R.C3421drawable.permission_locked;
                    }
            ...
            if (this.listView != null) {
                for (int i3 = 0; i3 < this.listView.getChildCount(); i3++) {
                    ...
                    if (childAdapterPosition >= 0 && childAdapterPosition < this.items.size()) {
                        int i4 = this.items.get(childAdapterPosition).f1694id;
                        if (i4 == 1) {
