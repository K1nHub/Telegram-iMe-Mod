...
/* renamed from: org.telegram.ui.PhotoPickerSearchActivity */
...
public class PhotoPickerSearchActivity extends BaseFragment {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: org.telegram.ui.PhotoPickerSearchActivity$ViewPage */
    /* loaded from: classes3.dex */
    ...
    public View createView(Context context) {
        ...
        c3541ActionBar2.setItemsBackgroundColor(Theme.getColor(i2), false);
        this.actionBar.setBackButtonImage(C3473R.C3475drawable.ic_ab_back);
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setExtraHeight(AndroidUtilities.m72dp(44));
        this.actionBar.setAllowOverlayTitle(false);
        this.actionBar.setAddToContainer(false);
        this.actionBar.setClipContent(true);
        this.actionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.PhotoPickerSearchActivity.1
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C3473R.C3475drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.PhotoPickerSearchActivity.2
        ...
        actionBarMenuItemSearchListener.setSearchFieldHint(LocaleController.getString("SearchImagesTitle", C3473R.string.SearchImagesTitle));
        ...
        this.scrollSlidingTextTabStrip.setDelegate(new ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate() { // from class: org.telegram.ui.PhotoPickerSearchActivity.3
            ...
            @Override // org.telegram.p043ui.Components.ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate
            public /* synthetic */ void onTabSelected(int i4) {
                ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate.CC.$default$onTabSelected(this, i4);
            }
            ...
            public void onPageSelected(int i4, boolean z) {
                ...
                if (i4 == 0) {
                    PhotoPickerSearchActivity.this.searchItem.setSearchFieldHint(LocaleController.getString("SearchImagesTitle", C3473R.string.SearchImagesTitle));
                } else {
                    PhotoPickerSearchActivity.this.searchItem.setSearchFieldHint(LocaleController.getString("SearchGifsTitle", C3473R.string.SearchGifsTitle));
                }
            }
            ...
            public void onPageScrolled(float f) {
                ...
                if (i4 != 0 || PhotoPickerSearchActivity.this.viewPages[1].getVisibility() == 0) {
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.PhotoPickerSearchActivity.4
            ...
            protected void onMeasure(int i4, int i5) {
                ...
                for (int i6 = 0; i6 < PhotoPickerSearchActivity.this.viewPages.length; i6++) {
                    if (PhotoPickerSearchActivity.this.viewPages[i6] != null && PhotoPickerSearchActivity.this.viewPages[i6].listView != null) {
                        PhotoPickerSearchActivity.this.viewPages[i6].listView.setPadding(AndroidUtilities.m72dp(4), AndroidUtilities.m72dp(4) + measuredHeight, AndroidUtilities.m72dp(4), AndroidUtilities.m72dp(4));
                    }
                }
                this.globalIgnoreLayout = false;
            ...
            */
            public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p043ui.PhotoPickerSearchActivity.C64384.onLayout(boolean, int, int, int, int):void");
            }
                ...
                if (PhotoPickerSearchActivity.this.tabsAnimationInProgress) {
                    ...
                    if (PhotoPickerSearchActivity.this.backAnimation) {
                        if (Math.abs(PhotoPickerSearchActivity.this.viewPages[0].getTranslationX()) < 1.0f) {
                            PhotoPickerSearchActivity.this.viewPages[0].setTranslationX(BitmapDescriptorFactory.HUE_RED);
                        ...
                        if (Math.abs(PhotoPickerSearchActivity.this.viewPages[1].getTranslationX()) < 1.0f) {
                            ...
                            PhotoPickerSearchActivity.this.viewPages[1].setTranslationX(BitmapDescriptorFactory.HUE_RED);
                        }
                        z = false;
                    }
                    if (z) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, ((BaseFragment) PhotoPickerSearchActivity.this).actionBar.getMeasuredHeight() + ((BaseFragment) PhotoPickerSearchActivity.this).actionBar.getTranslationY(), getMeasuredWidth(), getMeasuredHeight(), PhotoPickerSearchActivity.this.backgroundPaint);
            }
                ...
                if (motionEvent != null && motionEvent.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
                    ...
                    if (this.startedTracking && ((PhotoPickerSearchActivity.this.animatingForward && x > 0) || (!PhotoPickerSearchActivity.this.animatingForward && x < 0))) {
                        if (!prepareForMoving(motionEvent, x < 0)) {
                            ...
                            PhotoPickerSearchActivity.this.scrollSlidingTextTabStrip.selectTabWithId(PhotoPickerSearchActivity.this.viewPages[1].selectedType, BitmapDescriptorFactory.HUE_RED);
                        }
                    }
                    ...
                    if (this.startedTracking) {
                        ...
                        if (!PhotoPickerSearchActivity.this.backAnimation) {
                            ...
                            if (PhotoPickerSearchActivity.this.animatingForward) {
                                PhotoPickerSearchActivity.this.tabsAnimation.playTogether(ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[0], View.TRANSLATION_X, -PhotoPickerSearchActivity.this.viewPages[0].getMeasuredWidth()), ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[1], View.TRANSLATION_X, BitmapDescriptorFactory.HUE_RED));
                            } else {
                                PhotoPickerSearchActivity.this.tabsAnimation.playTogether(ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[0], View.TRANSLATION_X, PhotoPickerSearchActivity.this.viewPages[0].getMeasuredWidth()), ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[1], View.TRANSLATION_X, BitmapDescriptorFactory.HUE_RED));
                            }
                        } else {
                            ...
                            if (PhotoPickerSearchActivity.this.animatingForward) {
                                PhotoPickerSearchActivity.this.tabsAnimation.playTogether(ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[0], View.TRANSLATION_X, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[1], View.TRANSLATION_X, PhotoPickerSearchActivity.this.viewPages[1].getMeasuredWidth()));
                            } else {
                                PhotoPickerSearchActivity.this.tabsAnimation.playTogether(ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[0], View.TRANSLATION_X, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[1], View.TRANSLATION_X, -PhotoPickerSearchActivity.this.viewPages[1].getMeasuredWidth()));
                            }
                        }
                        ...
                        PhotoPickerSearchActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.PhotoPickerSearchActivity.4.1
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                PhotoPickerSearchActivity.this.tabsAnimationInProgress = false;
                                C64384.this.maybeStartTracking = false;
                                C64384.this.startedTracking = false;
        ...
        while (true) {
            ...
            sizeNotifierFrameLayout.addView(this.viewPages[i5], LayoutHelper.createFrame(-1, -1));
            if (i5 == 0) {
            ...
            viewPageArr4[i5].addView(viewPageArr4[i5].fragmentView, LayoutHelper.createFrame(-1, -1));
            ViewPage[] viewPageArr5 = this.viewPages;
            viewPageArr5[i5].addView(viewPageArr5[i5].actionBar, LayoutHelper.createFrame(-1, -2));
            ...
            this.viewPages[i5].listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.PhotoPickerSearchActivity.6
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int i6) {
                    ...
                    if (i6 != 1) {
                        ...
                        int currentActionBarHeight = C3541ActionBar.getCurrentActionBarHeight();
                ...
                public void onScrolled(RecyclerView recyclerView, int i6, int i7) {
                    ...
                    if (recyclerView == PhotoPickerSearchActivity.this.viewPages[0].listView) {
                        ...
                        if (f < (-C3541ActionBar.getCurrentActionBarHeight())) {
                            f = -C3541ActionBar.getCurrentActionBarHeight();
        ...
        sizeNotifierFrameLayout.addView(this.actionBar, LayoutHelper.createFrame(-1, -2));
        sizeNotifierFrameLayout.addView(this.imagesSearch.frameLayout2, LayoutHelper.createFrame(-1, 48, 83));
        sizeNotifierFrameLayout.addView(this.imagesSearch.writeButtonContainer, LayoutHelper.createFrame(60, 60, 85, 0, 0, 12, 10));
        sizeNotifierFrameLayout.addView(this.imagesSearch.selectedCountView, LayoutHelper.createFrame(42, 24, 85, 0, 0, -2, 9));
        updateTabs();
    ...
    public void setDelegate(PhotoPickerActivity.PhotoPickerActivityDelegate photoPickerActivityDelegate) {
        ...
        this.imagesSearch.setSearchDelegate(new PhotoPickerActivity.PhotoPickerActivitySearchDelegate() { // from class: org.telegram.ui.PhotoPickerSearchActivity.7
            @Override // org.telegram.p043ui.PhotoPickerActivity.PhotoPickerActivitySearchDelegate
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString("ImagesTab2", C3473R.string.ImagesTab2));
        this.scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString("GifsTab2", C3473R.string.GifsTab2));
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(c3541ActionBar2, i5, null, null, null, null, i6));
