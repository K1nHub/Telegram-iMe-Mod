    ...
    public static TLRPC$Chat TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z, boolean z2) {
        ...
        switch (i) {
            case -2107528095:
                tLRPC$Chat = new TLRPC$TL_channel() { // from class: org.telegram.tgnet.TLRPC$TL_channel_layer147
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        this.flags = i17;
                        int i18 = this.noforwards ? i17 | C0485C.BUFFER_FLAG_FIRST_SAMPLE : i17 & (-134217729);
                        this.flags = i18;
            ...
            case -2059962289:
                ...
                break;
            case -1795845413:
                tLRPC$Chat = new TLRPC$TL_channel() { // from class: org.telegram.tgnet.TLRPC$TL_channel_layer165_2
                    @Override // org.telegram.tgnet.TLRPC$TL_channel, org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z3) {
                        int readInt32 = abstractSerializedData2.readInt32(z3);
                        this.flags = readInt32;
            ...
            case 609791884:
                tLRPC$Chat = new TLRPC$TL_channel() { // from class: org.telegram.tgnet.TLRPC$TL_channel_layer165
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z3) {
                        ...
                        this.color = abstractSerializedData2.readInt32(z3);
                        if ((this.flags2 & 32) != 0) {
                            this.background_emoji_id = abstractSerializedData2.readInt64(z3);
                        }
                    }

                    @Override // org.telegram.tgnet.TLRPC$TL_channel, org.telegram.tgnet.TLObject
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        abstractSerializedData2.writeInt32(609791884);
                        int i2 = this.creator ? this.flags | 1 : this.flags & (-2);
                        this.flags = i2;
                        int i3 = this.left ? i2 | 4 : i2 & (-5);
                        this.flags = i3;
                        ...
                        if ((this.flags2 & 32) != 0) {
                            abstractSerializedData2.writeInt64(this.background_emoji_id);
                        }
                    }
                };
                break;
