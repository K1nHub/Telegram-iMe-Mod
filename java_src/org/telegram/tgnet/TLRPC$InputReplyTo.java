...
public abstract class TLRPC$InputReplyTo extends TLObject {
    ...
    public static TLRPC$InputReplyTo TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$InputReplyTo tLRPC$TL_inputReplyToMessage = i != 121554949 ? i != 363917955 ? i != 583071445 ? null : new TLRPC$TL_inputReplyToMessage() : new TLRPC$TL_inputReplyToStory() : new TLRPC$TL_inputReplyToMessage() { // from class: org.telegram.tgnet.TLRPC$TL_inputReplyToMessage_layer166
