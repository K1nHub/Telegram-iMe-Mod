...
public class TLRPC$TL_decryptedMessageMediaVideo extends TLRPC$DecryptedMessageMedia {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1605w = abstractSerializedData.readInt32(z);
        this.f1602h = abstractSerializedData.readInt32(z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1605w);
        abstractSerializedData.writeInt32(this.f1602h);
