        ...
        if (i == -1665063993) {
            tLRPC$PhoneConnection = new TLRPC$PhoneConnection() { // from class: org.telegram.tgnet.TLRPC$TL_phoneConnection
                ...
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    ...
                    this.f1559id = abstractSerializedData2.readInt64(z2);
                    this.f1560ip = abstractSerializedData2.readString(z2);
                ...
                public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                    ...
                    abstractSerializedData2.writeInt64(this.f1559id);
                    abstractSerializedData2.writeString(this.f1560ip);
