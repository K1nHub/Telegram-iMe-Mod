...
public class TLRPC$TL_maskCoords extends TLObject {
    ...
    /* renamed from: x */
    public double f1606x;

    /* renamed from: y */
    public double f1607y;
    public double zoom;
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        this.f1605n = abstractSerializedData.readInt32(z);
        this.f1606x = abstractSerializedData.readDouble(z);
        this.f1607y = abstractSerializedData.readDouble(z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1605n);
        abstractSerializedData.writeDouble(this.f1606x);
        abstractSerializedData.writeDouble(this.f1607y);
