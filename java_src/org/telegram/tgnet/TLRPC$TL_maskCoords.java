...
public class TLRPC$TL_maskCoords extends TLObject {
    ...
    /* renamed from: x */
    public double f1571x;

    /* renamed from: y */
    public double f1572y;
    public double zoom;
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        this.f1570n = abstractSerializedData.readInt32(z);
        this.f1571x = abstractSerializedData.readDouble(z);
        this.f1572y = abstractSerializedData.readDouble(z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1570n);
        abstractSerializedData.writeDouble(this.f1571x);
        abstractSerializedData.writeDouble(this.f1572y);
