...
public class SerializedData extends AbstractSerializedData {
    ...
    /* renamed from: in */
    private DataInputStream f1596in;
    ...
    public SerializedData(byte[] bArr) {
        ...
        this.f1596in = new DataInputStream(this.inbuf);
        this.len = 0;
    }
    ...
    public void cleanup() {
        ...
        try {
            DataInputStream dataInputStream = this.f1596in;
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m101e("write int32 error");
                    FileLog.m99e(e);
                    return;
                }
                return;
    ...
    private void writeInt64(long j, DataOutputStream dataOutputStream) {
        for (int i = 0; i < 8; i++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m101e("write int64 error");
                    FileLog.m99e(e);
                    return;
                }
                return;
    ...
    public void writeBytes(byte[] bArr, int i, int i2) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("write bytes error");
                FileLog.m99e(e);
            }
        }
    }
    ...
    public void writeByte(int i) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("write byte error");
                FileLog.m99e(e);
            }
        }
    }
    ...
    public void writeByteArray(byte[] bArr) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("write byte array error");
                FileLog.m99e(e);
            }
        }
    }
    ...
    public void writeString(String str) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("write string error");
                FileLog.m99e(e);
            }
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("write double error");
                FileLog.m99e(e);
            }
        }
    }
    ...
    public void writeFloat(float f) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("write float error");
                FileLog.m99e(e);
            }
        }
    }
    ...
    public byte readByte(boolean z) {
        try {
            byte readByte = this.f1596in.readByte();
            this.len++;
            return readByte;
        } catch (Exception e) {
            if (z) {
    ...
    public void readBytes(byte[] bArr, boolean z) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("read bytes error");
                FileLog.m99e(e);
            }
        }
    }
    ...
    public String readString(boolean z) {
        int i;
        try {
            int read = this.f1596in.read();
            this.len++;
            if (read >= 254) {
                read = this.f1596in.read() | (this.f1596in.read() << 8) | (this.f1596in.read() << 16);
                this.len += 3;
                i = 4;
            } else {
                i = 1;
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("read string error");
                FileLog.m99e(e);
                return null;
            }
            return null;
    ...
    public byte[] readByteArray(boolean z) {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("read byte array error");
                FileLog.m99e(e);
                return null;
            }
            return null;
    ...
    public double readDouble(boolean z) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("read double error");
                FileLog.m99e(e);
                return 0.0d;
            }
            return 0.0d;
    ...
    public float readFloat(boolean z) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m101e("read float error");
                FileLog.m99e(e);
    ...
    public int readInt32(boolean z) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m101e("read int32 error");
                    FileLog.m99e(e);
                }
                return 0;
            }
    ...
    public long readInt64(boolean z) {
        ...
        for (int i = 0; i < 8; i++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m101e("read int64 error");
                    FileLog.m99e(e);
                }
                return 0L;
            }
