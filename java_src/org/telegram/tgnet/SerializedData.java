...
public class SerializedData extends AbstractSerializedData {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m104e("write int32 error");
                    FileLog.m102e(e);
                    return;
                }
                return;
    ...
    private void writeInt64(long j, DataOutputStream dataOutputStream) {
        for (int i = 0; i < 8; i++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m104e("write int64 error");
                    FileLog.m102e(e);
                    return;
                }
                return;
    ...
    public void writeBytes(byte[] bArr, int i, int i2) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("write bytes error");
                FileLog.m102e(e);
            }
        }
    }
    ...
    public void writeByte(int i) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("write byte error");
                FileLog.m102e(e);
            }
        }
    }
    ...
    public void writeByteArray(byte[] bArr) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("write byte array error");
                FileLog.m102e(e);
            }
        }
    }
    ...
    public void writeString(String str) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("write string error");
                FileLog.m102e(e);
            }
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("write double error");
                FileLog.m102e(e);
            }
        }
    }
    ...
    public void writeFloat(float f) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("write float error");
                FileLog.m102e(e);
            }
        }
    }
    ...
    public void readBytes(byte[] bArr, boolean z) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("read bytes error");
                FileLog.m102e(e);
            }
        }
    }
    ...
    public String readString(boolean z) {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("read string error");
                FileLog.m102e(e);
                return null;
            }
            return null;
    ...
    public byte[] readByteArray(boolean z) {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("read byte array error");
                FileLog.m102e(e);
                return null;
            }
            return null;
    ...
    public double readDouble(boolean z) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("read double error");
                FileLog.m102e(e);
                return 0.0d;
            }
            return 0.0d;
    ...
    public float readFloat(boolean z) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m104e("read float error");
                FileLog.m102e(e);
    ...
    public int readInt32(boolean z) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m104e("read int32 error");
                    FileLog.m102e(e);
                }
                return 0;
            }
    ...
    public long readInt64(boolean z) {
        ...
        for (int i = 0; i < 8; i++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m104e("read int64 error");
                    FileLog.m102e(e);
                }
                return 0L;
            }
