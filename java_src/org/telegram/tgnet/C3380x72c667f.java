...
public class C3380x72c667f extends TLRPC$PasswordKdfAlgo {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1622g = abstractSerializedData.readInt32(z);
        this.f1623p = abstractSerializedData.readByteArray(z);
    }
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1622g);
        abstractSerializedData.writeByteArray(this.f1623p);
    }
}
