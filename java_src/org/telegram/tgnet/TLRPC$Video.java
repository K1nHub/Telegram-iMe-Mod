            ...
            case -1056548696:
                tLRPC$Video = new TLRPC$Video() { // from class: org.telegram.tgnet.TLRPC$TL_videoEmpty_layer45
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.f1645id = abstractSerializedData2.readInt64(z2);
                    }

                    @Override // org.telegram.tgnet.TLObject
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        abstractSerializedData2.writeInt32(constructor);
                        abstractSerializedData2.writeInt64(this.f1645id);
                    }
                };
                break;
            case -291550643:
                tLRPC$Video = new TLRPC$TL_video_layer45() { // from class: org.telegram.tgnet.TLRPC$TL_video_old3
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1647w = abstractSerializedData2.readInt32(z2);
                        this.f1644h = abstractSerializedData2.readInt32(z2);
                    }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32(this.f1647w);
                        abstractSerializedData2.writeInt32(this.f1644h);
                    }
                };
                break;
            case -148338733:
            ...
            case 1431655763:
                tLRPC$Video = new TLRPC$TL_video_layer45() { // from class: org.telegram.tgnet.TLRPC$TL_videoEncrypted
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1646iv = abstractSerializedData2.readByteArray(z2);
                    }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeByteArray(this.f1646iv);
                    }
                };
                break;
            case 1510253727:
