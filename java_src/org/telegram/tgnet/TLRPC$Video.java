            ...
            case -291550643:
                tLRPC$Video = new TLRPC$TL_video_layer45() { // from class: org.telegram.tgnet.TLRPC$TL_video_old3
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1754w = abstractSerializedData2.readInt32(z2);
                        this.f1751h = abstractSerializedData2.readInt32(z2);
                    }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32(this.f1754w);
                        abstractSerializedData2.writeInt32(this.f1751h);
                    }
                };
                break;
            case -148338733:
            ...
            case 1431655763:
                tLRPC$Video = new TLRPC$TL_video_layer45() { // from class: org.telegram.tgnet.TLRPC$TL_videoEncrypted
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1753iv = abstractSerializedData2.readByteArray(z2);
                    }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeByteArray(this.f1753iv);
                    }
                };
                break;
            case 1510253727:
