...
/* renamed from: org.telegram.tgnet.tl.TL_stories$StoryView */
...
public class TL_stories$StoryView extends TLObject {
    ...
    public static TL_stories$StoryView TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -1870436597) {
            tL_stories$StoryView = new TL_stories$StoryView() { // from class: org.telegram.tgnet.tl.TL_stories$TL_storyViewPublicForward
            ...
            tL_stories$StoryView = i != -1116418231 ? null : new TL_stories$StoryView() { // from class: org.telegram.tgnet.tl.TL_stories$TL_storyViewPublicRepost
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    int readInt32 = abstractSerializedData2.readInt32(z2);
                    this.flags = readInt32;
