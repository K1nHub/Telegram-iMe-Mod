...
/* renamed from: org.telegram.tgnet.tl.TL_stories$StoryViews */
...
public abstract class TL_stories$StoryViews extends TLObject {
    ...
    public static TL_stories$StoryViews TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -1923523370) {
            ...
            tL_stories$TL_storyViews = i != -748199729 ? null : new TL_stories$StoryViews() { // from class: org.telegram.tgnet.tl.TL_stories$TL_storyViews_layer160
            ...
            tL_stories$TL_storyViews = new TL_stories$StoryViews() { // from class: org.telegram.tgnet.tl.TL_stories$TL_storyViews_layer161
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    this.flags = abstractSerializedData2.readInt32(z2);
                    this.views_count = abstractSerializedData2.readInt32(z2);
