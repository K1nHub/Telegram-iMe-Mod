...
/* renamed from: org.telegram.tgnet.tl.TL_stories$TL_stories_deleteStories */
/* loaded from: classes5.dex */
public class TL_stories$TL_stories_deleteStories extends TLObject {

    /* renamed from: id */
    public ArrayList<Integer> f1768id = new ArrayList<>();
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        int size = this.f1768id.size();
        abstractSerializedData.writeInt32(size);
        for (int i = 0; i < size; i++) {
            abstractSerializedData.writeInt32(this.f1768id.get(i).intValue());
        }
    }
}
