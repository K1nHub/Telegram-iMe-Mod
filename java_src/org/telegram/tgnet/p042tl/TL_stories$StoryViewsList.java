...
/* renamed from: org.telegram.tgnet.tl.TL_stories$StoryViewsList */
...
public class TL_stories$StoryViewsList extends TLObject {
    ...
    public static TL_stories$StoryViewsList TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i != 1189722604) {
            tL_stories$StoryViewsList = i != 1507299269 ? null : new TL_stories$StoryViewsList() { // from class: org.telegram.tgnet.tl.TL_stories$TL_storyViewsList
            ...
            tL_stories$StoryViewsList = new TL_stories$StoryViewsList() { // from class: org.telegram.tgnet.tl.TL_stories$TL_storyViewsList_layer167
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    this.flags = abstractSerializedData2.readInt32(z2);
                    this.count = abstractSerializedData2.readInt32(z2);
