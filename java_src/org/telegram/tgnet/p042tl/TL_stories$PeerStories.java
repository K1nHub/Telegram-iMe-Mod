...
/* renamed from: org.telegram.tgnet.tl.TL_stories$PeerStories */
...
public abstract class TL_stories$PeerStories extends TLObject {
    ...
    public static TL_stories$PeerStories TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i != -2045664768) {
            ...
            tL_stories$TL_peerStories = new TL_stories$TL_peerStories() { // from class: org.telegram.tgnet.tl.TL_stories$TL_peerStories_layer162
                @Override // org.telegram.tgnet.p042tl.TL_stories$TL_peerStories, org.telegram.tgnet.TLObject
