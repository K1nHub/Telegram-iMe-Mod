...
/* renamed from: org.telegram.tgnet.tl.TL_stories$StoryReaction */
...
public class TL_stories$StoryReaction extends TLObject {
    ...
    public static TL_stories$StoryReaction TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -1146411453) {
            tL_stories$StoryReaction = new TL_stories$StoryReaction() { // from class: org.telegram.tgnet.tl.TL_stories$TL_storyReactionPublicForward
            ...
            tL_stories$StoryReaction = new TL_stories$StoryReaction() { // from class: org.telegram.tgnet.tl.TL_stories$TL_storyReactionPublicRepost
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
