            ...
            case -1820043071:
                tLRPC$TL_user = new TLRPC$TL_user() { // from class: org.telegram.tgnet.TLRPC$TL_user_layer131
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1574id = abstractSerializedData2.readInt32(z2);
                        if ((this.flags & 1) != 0) {
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        this.flags = i10;
                        int i11 = this.min ? i10 | ProgressiveMediaSource.DEFAULT_LOADING_CHECK_INTERVAL_BYTES : i10 & (-1048577);
                        this.flags = i11;
                        ...
                        abstractSerializedData2.writeInt32((int) this.f1574id);
                        if ((this.flags & 1) != 0) {
            ...
            case 1073147056:
                tLRPC$TL_user = new TLRPC$User() { // from class: org.telegram.tgnet.TLRPC$TL_user_layer144
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1574id = abstractSerializedData2.readInt64(z2);
                        if ((this.flags & 1) != 0) {
                            this.access_hash = abstractSerializedData2.readInt64(z2);
                        }
                        if ((this.flags & 2) != 0) {
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        int i16 = this.fake ? i15 | ConnectionsManager.FileTypeFile : i15 & (-67108865);
                        this.flags = i16;
                        int i17 = this.bot_attach_menu ? i16 | C0475C.BUFFER_FLAG_FIRST_SAMPLE : i16 & (-134217729);
                        this.flags = i17;
                        int i18 = this.premium ? i17 | 268435456 : i17 & (-268435457);
                        this.flags = i18;
                        abstractSerializedData2.writeInt32(i18);
                        abstractSerializedData2.writeInt64(this.f1574id);
                        if ((this.flags & 1) != 0) {
                            abstractSerializedData2.writeInt64(this.access_hash);
                        }
                        if ((this.flags & 2) != 0) {
