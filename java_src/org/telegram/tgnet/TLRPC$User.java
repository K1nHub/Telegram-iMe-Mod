    ...
    public static TLRPC$User TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1885878744:
                tLRPC$User = new TLRPC$User() { // from class: org.telegram.tgnet.TLRPC$TL_user_layer159
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1749id = abstractSerializedData2.readInt64(z2);
                        if ((this.flags & 1) != 0) {
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        this.flags = i16;
                        int i17 = this.bot_attach_menu ? i16 | C0485C.BUFFER_FLAG_FIRST_SAMPLE : i16 & (-134217729);
                        this.flags = i17;
                        ...
                        abstractSerializedData2.writeInt64(this.f1749id);
                        if ((this.flags & 1) != 0) {
            ...
            case -1820043071:
                tLRPC$User = new TLRPC$TL_user() { // from class: org.telegram.tgnet.TLRPC$TL_user_layer131
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32((int) this.f1749id);
                        if ((this.flags & 1) != 0) {
                            abstractSerializedData2.writeInt64(this.access_hash);
                        }
                        if ((this.flags & 2) != 0) {
            ...
            case 1570352622:
                ...
                break;
            case 1876877535:
                tLRPC$User = new TLRPC$User() { // from class: org.telegram.tgnet.TLRPC$TL_user_layer165_2
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
                        ...
                        if ((this.flags2 & 64) != 0) {
                            this.background_emoji_id = abstractSerializedData2.readInt64(z2);
                        }
                    }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32(1876877535);
                        int i2 = this.self ? this.flags | 1024 : this.flags & (-1025);
                        this.flags = i2;
                        int i3 = this.contact ? i2 | 2048 : i2 & (-2049);
                        this.flags = i3;
