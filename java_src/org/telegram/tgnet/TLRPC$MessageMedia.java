        ...
        if (tLRPC$MessageMedia != null) {
            ...
            if (tLRPC$MessageMedia.video_unused != null) {
                ...
                if (tLRPC$MessageMedia.video_unused instanceof TLRPC$TL_videoEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted.f1508iv = tLRPC$Video.f1643iv;
                } else {
                ...
                tLRPC$Document.f1507id = tLRPC$Video2.f1642id;
                ...
                tLRPC$TL_documentAttributeVideo.f1510w = tLRPC$Video3.f1644w;
                tLRPC$TL_documentAttributeVideo.f1509h = tLRPC$Video3.f1641h;
                ...
                if (tLRPC$MessageMedia.audio_unused instanceof TLRPC$TL_audioEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted2.f1508iv = tLRPC$Audio.f1495iv;
                } else {
                    tLRPC$TL_messageMediaDocument.document = new TLRPC$TL_document();
                }
                tLRPC$TL_messageMediaDocument.flags = 3;
                ...
                tLRPC$Document2.f1507id = tLRPC$Audio2.f1494id;
