        ...
        if (tLRPC$MessageMedia != null) {
            ...
            if (tLRPC$MessageMedia.video_unused != null) {
                ...
                if (tLRPC$MessageMedia.video_unused instanceof TLRPC$TL_videoEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted.f1503iv = tLRPC$Video.f1637iv;
                } else {
                ...
                tLRPC$Document.f1502id = tLRPC$Video2.f1636id;
                ...
                tLRPC$TL_documentAttributeVideo.f1505w = tLRPC$Video3.f1638w;
                tLRPC$TL_documentAttributeVideo.f1504h = tLRPC$Video3.f1635h;
                ...
                if (tLRPC$MessageMedia.audio_unused instanceof TLRPC$TL_audioEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted2.f1503iv = tLRPC$Audio.f1491iv;
                } else {
                    tLRPC$TL_messageMediaDocument.document = new TLRPC$TL_document();
                }
                tLRPC$TL_messageMediaDocument.flags = 3;
                ...
                tLRPC$Document2.f1502id = tLRPC$Audio2.f1490id;
