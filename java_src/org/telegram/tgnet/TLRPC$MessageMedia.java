        ...
        if (tLRPC$MessageMedia != null) {
            ...
            if (tLRPC$MessageMedia.video_unused != null) {
                ...
                if (tLRPC$MessageMedia.video_unused instanceof TLRPC$TL_videoEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted.f1436iv = tLRPC$Video.f1571iv;
                } else {
                ...
                tLRPC$Document.f1435id = tLRPC$Video2.f1570id;
                ...
                tLRPC$TL_documentAttributeVideo.f1438w = tLRPC$Video3.f1572w;
                tLRPC$TL_documentAttributeVideo.f1437h = tLRPC$Video3.f1569h;
                ...
                if (tLRPC$MessageMedia.audio_unused instanceof TLRPC$TL_audioEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted2.f1436iv = tLRPC$Audio.f1423iv;
                } else {
                    tLRPC$TL_messageMediaDocument.document = new TLRPC$TL_document();
                }
                tLRPC$TL_messageMediaDocument.flags = 3;
                ...
                tLRPC$Document2.f1435id = tLRPC$Audio2.f1422id;
