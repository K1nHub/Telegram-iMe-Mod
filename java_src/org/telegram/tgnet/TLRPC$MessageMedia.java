        ...
        if (tLRPC$MessageMedia != null) {
            ...
            if (tLRPC$MessageMedia.video_unused != null) {
                ...
                if (tLRPC$MessageMedia.video_unused instanceof TLRPC$TL_videoEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted.f1509iv = tLRPC$Video.f1644iv;
                } else {
                ...
                tLRPC$Document.f1508id = tLRPC$Video2.f1643id;
                ...
                tLRPC$TL_documentAttributeVideo.f1511w = tLRPC$Video3.f1645w;
                tLRPC$TL_documentAttributeVideo.f1510h = tLRPC$Video3.f1642h;
                ...
                if (tLRPC$MessageMedia.audio_unused instanceof TLRPC$TL_audioEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted2.f1509iv = tLRPC$Audio.f1496iv;
                } else {
                    tLRPC$TL_messageMediaDocument.document = new TLRPC$TL_document();
                }
                tLRPC$TL_messageMediaDocument.flags = 3;
                ...
                tLRPC$Document2.f1508id = tLRPC$Audio2.f1495id;
