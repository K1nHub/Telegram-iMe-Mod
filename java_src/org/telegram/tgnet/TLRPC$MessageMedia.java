    ...
    public static TLRPC$MessageMedia TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case 1457575028:
                ...
                break;
            case 1478887012:
                tLRPC$MessageMedia = new TLRPC$TL_messageMediaGiveaway() { // from class: org.telegram.tgnet.TLRPC$TL_messageMediaGiveaway_layer167
        ...
        if (tLRPC$MessageMedia != null) {
            ...
            if (tLRPC$MessageMedia.video_unused != null) {
                ...
                if (tLRPC$MessageMedia.video_unused instanceof TLRPC$TL_videoEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted.f1611iv = tLRPC$Video.f1755iv;
                } else {
                ...
                tLRPC$Document.f1610id = tLRPC$Video2.f1754id;
                ...
                tLRPC$TL_documentAttributeVideo.f1613w = tLRPC$Video3.f1756w;
                tLRPC$TL_documentAttributeVideo.f1612h = tLRPC$Video3.f1753h;
                ...
                if (tLRPC$MessageMedia.audio_unused instanceof TLRPC$TL_audioEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted2.f1611iv = tLRPC$Audio.f1598iv;
                } else {
                    tLRPC$TL_messageMediaDocument.document = new TLRPC$TL_document();
                }
                tLRPC$TL_messageMediaDocument.flags = 3;
                ...
                tLRPC$Document2.f1610id = tLRPC$Audio2.f1597id;
