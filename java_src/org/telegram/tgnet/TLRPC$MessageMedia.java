        ...
        if (tLRPC$MessageMedia != null) {
            ...
            if (tLRPC$MessageMedia.video_unused != null) {
                ...
                if (tLRPC$MessageMedia.video_unused instanceof TLRPC$TL_videoEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted.f1442iv = tLRPC$Video.f1578iv;
                } else {
                ...
                tLRPC$Document.f1441id = tLRPC$Video2.f1577id;
                ...
                tLRPC$TL_documentAttributeVideo.f1444w = tLRPC$Video3.f1579w;
                tLRPC$TL_documentAttributeVideo.f1443h = tLRPC$Video3.f1576h;
                ...
                if (tLRPC$MessageMedia.audio_unused instanceof TLRPC$TL_audioEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted2.f1442iv = tLRPC$Audio.f1429iv;
                } else {
                    tLRPC$TL_messageMediaDocument.document = new TLRPC$TL_document();
                }
                tLRPC$TL_messageMediaDocument.flags = 3;
                ...
                tLRPC$Document2.f1441id = tLRPC$Audio2.f1428id;
