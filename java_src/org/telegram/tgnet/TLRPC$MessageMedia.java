        ...
        if (tLRPC$MessageMedia != null) {
            ...
            if (tLRPC$MessageMedia.video_unused != null) {
                ...
                if (tLRPC$MessageMedia.video_unused instanceof TLRPC$TL_videoEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted.f1511iv = tLRPC$Video.f1646iv;
                } else {
                ...
                tLRPC$Document.f1510id = tLRPC$Video2.f1645id;
                ...
                tLRPC$TL_documentAttributeVideo.f1513w = tLRPC$Video3.f1647w;
                tLRPC$TL_documentAttributeVideo.f1512h = tLRPC$Video3.f1644h;
                ...
                if (tLRPC$MessageMedia.audio_unused instanceof TLRPC$TL_audioEncrypted) {
                    ...
                    tLRPC$TL_documentEncrypted2.f1511iv = tLRPC$Audio.f1498iv;
                } else {
                    tLRPC$TL_messageMediaDocument.document = new TLRPC$TL_document();
                }
                tLRPC$TL_messageMediaDocument.flags = 3;
                ...
                tLRPC$Document2.f1510id = tLRPC$Audio2.f1497id;
