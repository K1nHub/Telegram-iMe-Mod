...
public class TLRPC$TL_videoSize extends TLRPC$VideoSize {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1663w = abstractSerializedData.readInt32(z);
        this.f1662h = abstractSerializedData.readInt32(z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1663w);
        abstractSerializedData.writeInt32(this.f1662h);
