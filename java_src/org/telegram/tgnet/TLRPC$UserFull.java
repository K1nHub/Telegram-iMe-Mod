    ...
    public static TLRPC$UserFull TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1938625919:
                tLRPC$UserFull = new TLRPC$TL_userFull() { // from class: org.telegram.tgnet.TLRPC$TL_userFull_layer143
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1752id = abstractSerializedData2.readInt64(z2);
                        if ((this.flags & 2) != 0) {
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt64(this.f1752id);
                        if ((this.flags & 2) != 0) {
            ...
            case -694681851:
                ...
                break;
            case -328384029:
                tLRPC$UserFull = new TLRPC$UserFull() { // from class: org.telegram.tgnet.TLRPC$TL_userFull_layer150_rev2
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
            ...
            case -302941166:
                ...
                break;
            case -120378643:
                tLRPC$UserFull = new TLRPC$UserFull() { // from class: org.telegram.tgnet.TLRPC$TL_userFull_layer156
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
            ...
            case 328899191:
                ...
                break;
            case 1340198022:
                tLRPC$UserFull = new TLRPC$UserFull() { // from class: org.telegram.tgnet.TLRPC$TL_userFull_layer162
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
                        ...
                        this.blocked_my_stories_from = (readInt32 & C0483C.BUFFER_FLAG_FIRST_SAMPLE) != 0;
                        this.f1752id = abstractSerializedData2.readInt64(z2);
                        if ((this.flags & 2) != 0) {
                            this.about = abstractSerializedData2.readString(z2);
                        }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        int i9 = this.translations_disabled ? i8 | 8388608 : i8 & (-8388609);
                        this.flags = i9;
                        int i10 = this.stories_pinned_available ? i9 | ConnectionsManager.FileTypeFile : i9 & (-67108865);
                        this.flags = i10;
                        int i11 = this.blocked_my_stories_from ? i10 | C0483C.BUFFER_FLAG_FIRST_SAMPLE : i10 & (-134217729);
                        this.flags = i11;
