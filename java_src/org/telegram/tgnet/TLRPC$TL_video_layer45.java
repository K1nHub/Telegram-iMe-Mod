...
public class TLRPC$TL_video_layer45 extends TLRPC$Video {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        this.f1659id = abstractSerializedData.readInt64(z);
        ...
        this.f1658h = abstractSerializedData.readInt32(z);
    }

    @Override // org.telegram.tgnet.TLObject
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        abstractSerializedData.writeInt32(constructor);
        abstractSerializedData.writeInt64(this.f1659id);
        ...
        abstractSerializedData.writeInt32(this.f1658h);
    }
}
