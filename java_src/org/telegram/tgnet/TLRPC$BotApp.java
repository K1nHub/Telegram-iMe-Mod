...
public abstract class TLRPC$BotApp extends TLObject {
    ...
    public static TLRPC$BotApp TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i != -1778593322) {
            tLRPC$BotApp = i != 1571189943 ? null : new TLRPC$BotApp() { // from class: org.telegram.tgnet.TLRPC$TL_botAppNotModified
            ...
            tLRPC$BotApp = new TLRPC$BotApp() { // from class: org.telegram.tgnet.TLRPC$TL_botApp
                public static int constructor = -1778593322;

                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    this.flags = abstractSerializedData2.readInt32(z2);
                    this.f1424id = abstractSerializedData2.readInt64(z2);
                ...
                public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                    ...
                    abstractSerializedData2.writeInt64(this.f1424id);
