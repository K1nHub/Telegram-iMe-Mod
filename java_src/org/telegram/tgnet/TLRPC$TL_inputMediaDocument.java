...
public class TLRPC$TL_inputMediaDocument extends TLRPC$InputMedia {
    ...
    /* renamed from: id */
    public TLRPC$InputDocument f1586id;
    public String query;
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1586id = TLRPC$InputDocument.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
        if ((this.flags & 1) != 0) {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        this.f1586id.serializeToStream(abstractSerializedData);
        if ((this.flags & 1) != 0) {
