...
public class C3484x72c667f extends TLRPC$PasswordKdfAlgo {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1644g = abstractSerializedData.readInt32(z);
        this.f1645p = abstractSerializedData.readByteArray(z);
    }
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1644g);
        abstractSerializedData.writeByteArray(this.f1645p);
    }
}
