...
public class TLRPC$TL_message extends TLRPC$Message {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.topic_start = (readInt32 & C0482C.BUFFER_FLAG_FIRST_SAMPLE) != 0;
        this.f1526id = abstractSerializedData.readInt32(z);
        if ((this.flags & 256) != 0) {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        this.flags = i10;
        int i11 = this.topic_start ? i10 | C0482C.BUFFER_FLAG_FIRST_SAMPLE : i10 & (-134217729);
        this.flags = i11;
        abstractSerializedData.writeInt32(i11);
        abstractSerializedData.writeInt32(this.f1526id);
        if ((this.flags & 256) != 0) {
