...
public class TLRPC$TL_textImage extends TLRPC$RichText {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1557w = abstractSerializedData.readInt32(z);
        this.f1556h = abstractSerializedData.readInt32(z);
    }
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1557w);
        abstractSerializedData.writeInt32(this.f1556h);
    }
}
