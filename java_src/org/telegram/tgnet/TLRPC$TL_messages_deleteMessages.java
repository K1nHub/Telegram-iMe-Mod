...
public class TLRPC$TL_messages_deleteMessages extends TLObject {
    ...
    /* renamed from: id */
    public ArrayList<Integer> f1581id = new ArrayList<>();
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        for (int i = 0; i < readInt323; i++) {
            this.f1581id.add(Integer.valueOf(abstractSerializedData.readInt32(z)));
        }
    }
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        int size = this.f1581id.size();
        abstractSerializedData.writeInt32(size);
        for (int i2 = 0; i2 < size; i2++) {
            abstractSerializedData.writeInt32(this.f1581id.get(i2).intValue());
        }
    }
}
