...
public class TLRPC$TL_document extends TLRPC$Document {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        if ((this.flags & 1) != 0) {
            ...
            while (i < readInt322) {
                int i2 = i;
                TLRPC$PhotoSize TLdeserialize = TLRPC$PhotoSize.TLdeserialize(0L, this.f1510id, 0L, abstractSerializedData, abstractSerializedData.readInt32(z), z);
        ...
        if ((this.flags & 2) != 0) {
            ...
            for (int i3 = 0; i3 < readInt324; i3++) {
                TLRPC$VideoSize TLdeserialize2 = TLRPC$VideoSize.TLdeserialize(0L, this.f1510id, abstractSerializedData, abstractSerializedData.readInt32(z), z);
