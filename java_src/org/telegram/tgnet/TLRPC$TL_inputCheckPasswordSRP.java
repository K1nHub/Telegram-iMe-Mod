...
public class TLRPC$TL_inputCheckPasswordSRP extends TLRPC$InputCheckPasswordSRP {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1560A = abstractSerializedData.readByteArray(z);
        this.f1561M1 = abstractSerializedData.readByteArray(z);
    }
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeByteArray(this.f1560A);
        abstractSerializedData.writeByteArray(this.f1561M1);
    }
}
