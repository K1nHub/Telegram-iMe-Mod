...
public class TLRPC$TL_stories_stories extends TLObject {
    public static int constructor = 1340440049;
    public int count;
    public ArrayList<TLRPC$StoryItem> stories = new ArrayList<>();
    public ArrayList<TLRPC$User> users = new ArrayList<>();

    public static TLRPC$TL_stories_stories TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        if (constructor != i) {
            if (z) {
        ...
        TLRPC$TL_stories_stories tLRPC$TL_stories_stories = new TLRPC$TL_stories_stories();
        tLRPC$TL_stories_stories.readParams(abstractSerializedData, z);
        return tLRPC$TL_stories_stories;
    }
