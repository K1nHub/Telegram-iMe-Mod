...
public class ConnectionsManager extends BaseController {
    ...
    static {
        ...
        lastClassGuid = 1;
        Instance = new ConnectionsManager[5];
    }
    ...
    public ConnectionsManager(int i) {
        ...
        init(SharedConfig.buildVersion(), TsExtractor.TS_STREAM_TYPE_AC4, BuildVars.APP_ID, str9, str10, str2, str4, str8, file2, FileLog.getNetworkLogPath(), regId, certificateSHA256Fingerprint, rawOffset, getUserConfig().getClientUserId(), getUserConfig().getCurrentUser() != null ? getUserConfig().getCurrentUser().premium : false, isPushConnectionEnabled);
    }
    ...
    public void lambda$sendRequest$2(final TLObject tLObject, final RequestDelegate requestDelegate, final RequestDelegateTimestamp requestDelegateTimestamp, final QuickAckDelegate quickAckDelegate, final WriteToSocketDelegate writeToSocketDelegate, final int i, final int i2, final int i3, final boolean z, final int i4) {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m105d("send request " + tLObject + " with token = " + i4);
        }
        try {
        ...
        try {
            if (j2 != 0) {
                ...
                if (BuildVars.LOGS_ENABLED && i5 != -2000) {
                    FileLog.m104e(tLObject + " got error " + tLRPC$TL_error2.code + " " + tLRPC$TL_error2.text);
                }
            ...
            if (BuildVars.DEBUG_PRIVATE_VERSION && !getUserConfig().isClientActivated() && tLRPC$TL_error != null && tLRPC$TL_error.code == 400 && Objects.equals(tLRPC$TL_error.text, "CONNECTION_NOT_INITED")) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m105d("Cleanup keys for " + this.currentAccount + " because of CONNECTION_NOT_INITED");
                }
                cleanup(true);
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("java received " + tLObject2 + " error = " + tLRPC$TL_error + " messageId = " + j4);
            }
    ...
    public void checkConnection() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m105d("selected ip strategy " + ((int) ipStrategy));
        }
    ...
    public void setAppPaused(boolean z, boolean z2) {
        if (!z2) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("app resume count " + this.appResumeCount);
            }
        ...
        if (this.appResumeCount == 0) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("reset app pause time");
            }
    ...
    public static void onUnparsedMessageReceived(long j, final int i, long j2) {
        try {
            ...
            if (TLdeserialize instanceof TLRPC$Updates) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m105d("java received " + TLdeserialize);
                }
                ...
                FileLog.m105d(String.format("java received unknown constructor 0x%x", Integer.valueOf(readInt32)));
            }
        } catch (Exception e) {
            FileLog.m102e(e);
        }
    ...
    public static /* synthetic */ void lambda$onRequestNewServerIpAndPort$12(int i, boolean z, int i2) {
        if (currentTask != null || ((i == 0 && Math.abs(lastDnsRequestTime - System.currentTimeMillis()) < 10000) || !z)) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("don't start task, current task = " + currentTask + " next task = " + i + " time diff = " + Math.abs(lastDnsRequestTime - System.currentTimeMillis()) + " network = " + ApplicationLoader.isNetworkOnline());
                return;
            }
            return;
        }
        ...
        if (i == 3) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("start mozilla txt task");
            }
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("start google txt task");
            }
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("start dns txt task");
            }
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("start firebase task");
            }
    ...
    public static class DnsTxtLoadTask extends AsyncTask<Void, Void, NativeByteBuffer> {
        ...
        public NativeByteBuffer doInBackground(Void... voidArr) {
            ...
            while (i < 3) {
                ...
                try {
                    ...
                    openConnection.addRequestProperty(RtspHeaders.USER_AGENT, "Mozilla/5.0 (iPhone; CPU iPhone OS 10_0 like Mac OS X) AppleWebKit/602.1.38 (KHTML, like Gecko) Version/10.0 Mobile/14A5297c Safari/602.1");
        ...
        public /* synthetic */ void lambda$onPostExecute$1(NativeByteBuffer nativeByteBuffer) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("failed to get dns txt result");
                FileLog.m105d("start google task");
            }
    ...
    public static class GoogleDnsLoadTask extends AsyncTask<Void, Void, NativeByteBuffer> {
        ...
        public /* synthetic */ void lambda$onPostExecute$1(NativeByteBuffer nativeByteBuffer) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("failed to get google result");
                FileLog.m105d("start mozilla task");
            }
    ...
    public static class MozillaDnsLoadTask extends AsyncTask<Void, Void, NativeByteBuffer> {
        ...
        public /* synthetic */ void lambda$onPostExecute$1(NativeByteBuffer nativeByteBuffer) {
            ...
            if (nativeByteBuffer != null) {
                ...
                FileLog.m105d("failed to get mozilla txt result");
            }
        }
    }
    ...
    public static class FirebaseTask extends AsyncTask<Void, Void, NativeByteBuffer> {
        ...
        public NativeByteBuffer doInBackground(Void... voidArr) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m105d("current firebase value = " + string);
                }
        ...
        public /* synthetic */ void lambda$doInBackground$0(Task task) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("failed to get firebase result");
                FileLog.m105d("start dns txt task");
            }
