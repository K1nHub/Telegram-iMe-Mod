...
public abstract class TLRPC$PeerStories extends TLObject {
    ...
    public static TLRPC$PeerStories TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_peerStories tLRPC$TL_peerStories = i != -2045664768 ? i != -1707742823 ? null : new TLRPC$TL_peerStories() : new TLRPC$TL_peerStories() { // from class: org.telegram.tgnet.TLRPC$TL_peerStories_layer162
            public static int constructor = -2045664768;

            @Override // org.telegram.tgnet.TLRPC$TL_peerStories, org.telegram.tgnet.TLObject
