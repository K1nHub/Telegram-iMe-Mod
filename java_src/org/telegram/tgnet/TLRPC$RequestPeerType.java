...
public class TLRPC$RequestPeerType extends TLObject {
    ...
    public static TLRPC$RequestPeerType TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$RequestPeerType tLRPC$TL_requestPeerTypeUser = i != -906990053 ? i != 865857388 ? i != 1597737472 ? null : new TLRPC$TL_requestPeerTypeUser() : new TLRPC$RequestPeerType() { // from class: org.telegram.tgnet.TLRPC$TL_requestPeerTypeBroadcast
        ...
        } : new TLRPC$RequestPeerType() { // from class: org.telegram.tgnet.TLRPC$TL_requestPeerTypeChat
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                this.flags = readInt32;
