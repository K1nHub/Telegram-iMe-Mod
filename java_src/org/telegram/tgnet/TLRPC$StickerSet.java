            ...
            case -1482409193:
                tLRPC$TL_stickerSet = new TLRPC$TL_stickerSet() { // from class: org.telegram.tgnet.TLRPC$TL_stickerSet_old
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.f1460id = abstractSerializedData2.readInt64(z2);
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt64(this.f1460id);
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        if ((this.flags & 16) != 0) {
                            ...
                            for (int i2 = 0; i2 < readInt323; i2++) {
                                TLRPC$PhotoSize TLdeserialize = TLRPC$PhotoSize.TLdeserialize(0L, 0L, this.f1460id, abstractSerializedData2, abstractSerializedData2.readInt32(z2), z2);
