...
public class TLRPC$TL_messageExtendedMediaPreview extends TLRPC$MessageExtendedMedia {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        if ((readInt32 & 1) != 0) {
            this.f1622w = abstractSerializedData.readInt32(z);
        }
        if ((this.flags & 1) != 0) {
            this.f1621h = abstractSerializedData.readInt32(z);
        }
        if ((this.flags & 2) != 0) {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        if ((this.flags & 1) != 0) {
            abstractSerializedData.writeInt32(this.f1622w);
        }
        if ((this.flags & 1) != 0) {
            abstractSerializedData.writeInt32(this.f1621h);
        }
        if ((this.flags & 2) != 0) {
