...
public class TLRPC$TL_stickerSet extends TLRPC$StickerSet {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1466id = abstractSerializedData.readInt64(z);
        ...
        if ((this.flags & 16) != 0) {
            ...
            for (int i = 0; i < readInt323; i++) {
                TLRPC$PhotoSize TLdeserialize = TLRPC$PhotoSize.TLdeserialize(0L, 0L, this.f1466id, abstractSerializedData, abstractSerializedData.readInt32(z), z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt64(this.f1466id);
