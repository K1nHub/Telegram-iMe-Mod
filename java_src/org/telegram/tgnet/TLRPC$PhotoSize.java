            ...
            case -374917894:
                tLRPC$TL_photoPathSize = new TLRPC$TL_photoCachedSize() { // from class: org.telegram.tgnet.TLRPC$TL_photoCachedSize_layer127
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f1554w = abstractSerializedData2.readInt32(z2);
                        this.f1553h = abstractSerializedData2.readInt32(z2);
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32(this.f1554w);
                        abstractSerializedData2.writeInt32(this.f1553h);
                ...
                tLRPC$TL_photoPathSize = new TLRPC$TL_photoSizeProgressive() { // from class: org.telegram.tgnet.TLRPC$TL_photoSizeProgressive_layer127
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        for (int i3 = 0; i3 < size; i3++) {
                            abstractSerializedData2.writeInt32(this.sizes.get(i3).intValue());
                        }
                    }
                };
                break;
