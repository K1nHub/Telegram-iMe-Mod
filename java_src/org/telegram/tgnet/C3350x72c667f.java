...
public class C3350x72c667f extends TLRPC$PasswordKdfAlgo {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1619g = abstractSerializedData.readInt32(z);
        this.f1620p = abstractSerializedData.readByteArray(z);
    }
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1619g);
        abstractSerializedData.writeByteArray(this.f1620p);
    }
}
