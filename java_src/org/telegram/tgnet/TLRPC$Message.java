    ...
    */
    ...
    public void writeAttachPath(AbstractSerializedData abstractSerializedData) {
        ...
        if (this.legacy) {
            ...
            this.layer = TsExtractor.TS_STREAM_TYPE_AC4;
            this.params.put("legacy_layer", "172");
        }
        if ((this.f1626id < 0 || this.send_state == 3 || this.legacy) && (hashMap2 = this.params) != null && hashMap2.size() > 0) {
        ...
        if ((this.flags & 4) == 0 || this.f1626id >= 0) {
            return;
        }
    ...
    public static TLRPC$Message TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
            ...
            case -2082087340:
                tLRPC$Message = new TLRPC$TL_messageEmpty() { // from class: org.telegram.tgnet.TLRPC$TL_messageEmpty_layer122
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.f1626id = abstractSerializedData2.readInt32(z2);
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32(this.f1626id);
                    }
                };
                break;
            case -2049520670:
            ...
            case 940666592:
                tLRPC$Message = new TLRPC$TL_message() { // from class: org.telegram.tgnet.TLRPC$TL_message_layer169
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.invert_media = (readInt32 & C0483C.BUFFER_FLAG_FIRST_SAMPLE) != 0;
                        this.f1626id = abstractSerializedData2.readInt32(z2);
                        if ((this.flags & 256) != 0) {
                            this.from_id = TLRPC$Peer.TLdeserialize(abstractSerializedData2, abstractSerializedData2.readInt32(z2), z2);
                        }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        int i11 = this.noforwards ? i10 | ConnectionsManager.FileTypeFile : i10 & (-67108865);
                        this.flags = i11;
                        int i12 = this.invert_media ? i11 | C0483C.BUFFER_FLAG_FIRST_SAMPLE : i11 & (-134217729);
                        this.flags = i12;
        ...
        if (tLRPC$Message != null) {
            ...
            if (tLRPC$Message.from_id == null) {
                tLRPC$Message.from_id = (tLRPC$Message.f1626id >= 0 || tLRPC$Message.random_id != 0) ? tLRPC$Message.peer_id : new TLRPC$TL_peerUser();
            }
        }
