    ...
    public static TLRPC$Message TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
            ...
            case -2082087340:
                tLRPC$Message = new TLRPC$TL_messageEmpty() { // from class: org.telegram.tgnet.TLRPC$TL_messageEmpty_layer122
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.f1451id = abstractSerializedData2.readInt32(z2);
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32(this.f1451id);
                    }
                };
                break;
            case -2049520670:
        ...
        if (tLRPC$Message != null) {
            ...
            if (tLRPC$Message.from_id == null) {
                if (tLRPC$Message.f1451id < 0 && tLRPC$Message.random_id == 0) {
    ...
    */
    ...
    public void writeAttachPath(AbstractSerializedData abstractSerializedData) {
        ...
        if (this.legacy) {
            ...
            this.layer = 157;
            this.params.put("legacy_layer", "157");
        }
        if ((this.f1451id < 0 || this.send_state == 3 || this.legacy) && (hashMap2 = this.params) != null && hashMap2.size() > 0) {
        ...
        if ((this.flags & 4) == 0 || this.f1451id >= 0) {
            return;
        }
