...
public class TLRPC$TL_chatlists_chatlistUpdates extends TLObject {
    public static int constructor = -1816295539;
    public ArrayList<TLRPC$Peer> missing_peers = new ArrayList<>();
    public ArrayList<TLRPC$Chat> chats = new ArrayList<>();
    public ArrayList<TLRPC$User> users = new ArrayList<>();

    public static TLRPC$TL_chatlists_chatlistUpdates TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        if (constructor != i) {
            if (z) {
        ...
        TLRPC$TL_chatlists_chatlistUpdates tLRPC$TL_chatlists_chatlistUpdates = new TLRPC$TL_chatlists_chatlistUpdates();
        tLRPC$TL_chatlists_chatlistUpdates.readParams(abstractSerializedData, z);
        return tLRPC$TL_chatlists_chatlistUpdates;
    }
