...
public abstract class TLRPC$StoryViews extends TLObject {
    ...
    public static TLRPC$StoryViews TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$StoryViews tLRPC$TL_storyViews = i != -1923523370 ? i != -968094825 ? i != -748199729 ? null : new TLRPC$StoryViews() { // from class: org.telegram.tgnet.TLRPC$TL_storyViews_layer160
        ...
        } : new TLRPC$StoryViews() { // from class: org.telegram.tgnet.TLRPC$TL_storyViews_layer161
