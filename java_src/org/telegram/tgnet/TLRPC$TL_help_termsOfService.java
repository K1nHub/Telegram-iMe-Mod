...
public class TLRPC$TL_help_termsOfService extends TLObject {
    ...
    /* renamed from: id */
    public TLRPC$TL_dataJSON f1580id;
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1580id = TLRPC$TL_dataJSON.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        this.f1580id.serializeToStream(abstractSerializedData);
