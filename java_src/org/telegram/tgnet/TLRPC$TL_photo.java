...
public class TLRPC$TL_photo extends TLRPC$Photo {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        for (int i = 0; i < readInt323; i++) {
            TLRPC$PhotoSize TLdeserialize = TLRPC$PhotoSize.TLdeserialize(this.f1561id, 0L, 0L, abstractSerializedData, abstractSerializedData.readInt32(z), z);
        ...
        if ((this.flags & 2) != 0) {
            ...
            for (int i2 = 0; i2 < readInt325; i2++) {
                TLRPC$VideoSize TLdeserialize2 = TLRPC$VideoSize.TLdeserialize(this.f1561id, 0L, abstractSerializedData, abstractSerializedData.readInt32(z), z);
