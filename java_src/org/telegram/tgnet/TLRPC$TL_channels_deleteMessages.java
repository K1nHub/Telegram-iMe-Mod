...
public class TLRPC$TL_channels_deleteMessages extends TLObject {
    ...
    /* renamed from: id */
    public ArrayList<Integer> f1464id = new ArrayList<>();
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        for (int i = 0; i < readInt322; i++) {
            this.f1464id.add(Integer.valueOf(abstractSerializedData.readInt32(z)));
        }
    }
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        int size = this.f1464id.size();
        abstractSerializedData.writeInt32(size);
        for (int i = 0; i < size; i++) {
            abstractSerializedData.writeInt32(this.f1464id.get(i).intValue());
        }
    }
}
