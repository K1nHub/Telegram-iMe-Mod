...
public class TLRPC$TL_pageBlockMap extends TLRPC$PageBlock {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1635w = abstractSerializedData.readInt32(z);
        this.f1634h = abstractSerializedData.readInt32(z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1635w);
        abstractSerializedData.writeInt32(this.f1634h);
