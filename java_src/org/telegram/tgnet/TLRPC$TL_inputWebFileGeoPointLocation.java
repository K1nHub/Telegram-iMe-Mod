...
public class TLRPC$TL_inputWebFileGeoPointLocation extends TLRPC$InputWebFileLocation {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.f1576w = abstractSerializedData.readInt32(z);
        this.f1575h = abstractSerializedData.readInt32(z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32(this.f1576w);
        abstractSerializedData.writeInt32(this.f1575h);
