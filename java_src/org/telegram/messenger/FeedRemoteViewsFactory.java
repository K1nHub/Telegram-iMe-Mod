...
public class FeedRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory, NotificationCenter.NotificationCenterDelegate {
    ...
    public RemoteViews getViewAt(int i) {
        ...
        RemoteViews remoteViews = new RemoteViews(this.mContext.getPackageName(), C3295R.layout.feed_widget_item);
        if (messageObject.type == 0) {
            int i2 = C3295R.C3298id.feed_widget_item_text;
            remoteViews.setTextViewText(i2, messageObject.messageText);
            remoteViews.setViewVisibility(i2, 0);
        } else if (TextUtils.isEmpty(messageObject.caption)) {
            remoteViews.setViewVisibility(C3295R.C3298id.feed_widget_item_text, 8);
        } else {
            int i3 = C3295R.C3298id.feed_widget_item_text;
            remoteViews.setTextViewText(i3, messageObject.caption);
            remoteViews.setViewVisibility(i3, 0);
        }
        ArrayList<TLRPC$PhotoSize> arrayList = messageObject.photoThumbs;
        if (arrayList == null || arrayList.isEmpty()) {
            remoteViews.setViewVisibility(C3295R.C3298id.feed_widget_item_image, 8);
        } else {
            ...
            if (pathToAttach.exists()) {
                int i4 = C3295R.C3298id.feed_widget_item_image;
        ...
        remoteViews.setOnClickFillInIntent(C3295R.C3298id.shortcut_widget_item, intent);
        return remoteViews;
    }
