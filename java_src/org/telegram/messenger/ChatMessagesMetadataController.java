...
public class ChatMessagesMetadataController {
    ...
    public void checkMessages(ChatActivity.ChatActivityAdapter chatActivityAdapter, int i, int i2, long j) {
        ...
        while (i4 < i5) {
            ...
            if (this.chatActivity.getThreadMessage() != messageObject && messageObject.getId() > 0 && messageObject.messageOwner.action == null && j - messageObject.reactionsLastCheckTime > C0483C.DEFAULT_SEEK_FORWARD_INCREMENT_MS) {
    ...
    private void loadStoriesForMessages(long j, ArrayList<MessageObject> arrayList) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            final int i3 = tL_stories$StoryItem.f1763id;
    ...
    public /* synthetic */ void lambda$loadStoriesForMessages$2(int i, final MessageObject messageObject, final long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            ...
            tL_stories$StoryItem2.f1763id = i;
