...
import com.smedialink.storage.data.locale.prefs.migration.PreferencesMigrationManager$Crypto;
...
public class UserConfig extends BaseController {
    ...
    private void updateUserId() {
        if (this.clientUserId == this.currentUser.f1633id) {
            return;
        }
        synchronized (this.sync) {
            this.clientUserId = this.currentUser.f1633id;
    ...
    public long getClientUserId() {
        ...
        synchronized (this.sync) {
            ...
            j = tLRPC$User != null ? tLRPC$User.f1633id : 0L;
        }
        return j;
    }
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:36:0x01d9 A[Catch: all -> 0x024f, TryCatch #1 {, blocks: (B:4:0x0003, B:6:0x0007, B:8:0x0009, B:10:0x0012, B:11:0x001a, B:13:0x012a, B:18:0x0136, B:20:0x016a, B:22:0x0172, B:24:0x0178, B:25:0x018a, B:26:0x01aa, B:28:0x01b2, B:30:0x01b8, B:34:0x01cf, B:36:0x01d9, B:37:0x0201, B:39:0x0209, B:41:0x020f, B:42:0x0221, B:44:0x0229, B:46:0x022f, B:47:0x0241, B:49:0x0245, B:50:0x024b, B:51:0x024d, B:33:0x01cc), top: B:58:0x0003, inners: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:49:0x0245 A[Catch: all -> 0x024f, TryCatch #1 {, blocks: (B:4:0x0003, B:6:0x0007, B:8:0x0009, B:10:0x0012, B:11:0x001a, B:13:0x012a, B:18:0x0136, B:20:0x016a, B:22:0x0172, B:24:0x0178, B:25:0x018a, B:26:0x01aa, B:28:0x01b2, B:30:0x01b8, B:34:0x01cf, B:36:0x01d9, B:37:0x0201, B:39:0x0209, B:41:0x020f, B:42:0x0221, B:44:0x0229, B:46:0x022f, B:47:0x0241, B:49:0x0245, B:50:0x024b, B:51:0x024d, B:33:0x01cc), top: B:58:0x0003, inners: #0 }] */
    /*
