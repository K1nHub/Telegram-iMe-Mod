...
public class FileRefController extends BaseController {
    ...
    public static String getKeyForParentObject(Object obj) {
        if (obj instanceof TL_stories$StoryItem) {
            ...
            if (tL_stories$StoryItem.dialogId == 0) {
                FileLog.m105d("failed request reference can't find dialogId");
                return null;
            }
            return "story_" + tL_stories$StoryItem.dialogId + "_" + tL_stories$StoryItem.f1763id;
            ...
            if (obj instanceof TLRPC$TL_availableReaction) {
                ...
                return "webpage" + ((TLRPC$WebPage) obj).f1760id;
            } else if (obj instanceof TLRPC$User) {
                return "user" + ((TLRPC$User) obj).f1751id;
                ...
                return "wallpaper" + ((TLRPC$TL_wallPaper) obj).f1759id;
            } else if (obj instanceof TLRPC$TL_theme) {
                return "theme" + ((TLRPC$TL_theme) obj).f1739id;
            } else if (obj != null) {
                return "" + obj;
            } else {
                return null;
    ...
    */
    ...
    private String getObjectString(Object obj) {
        ...
        if (obj instanceof TL_stories$StoryItem) {
            TL_stories$StoryItem tL_stories$StoryItem = (TL_stories$StoryItem) obj;
            return "story(dialogId=" + tL_stories$StoryItem.dialogId + " id=" + tL_stories$StoryItem.f1763id + ")";
        } else if (!(obj instanceof MessageObject)) {
            if (obj == null) {
                return null;
            }
    ...
    private void requestReferenceFromServer(Object obj, final String str, final String str2, Object[] objArr) {
        if (obj instanceof TL_stories$StoryItem) {
            ...
            tL_stories$TL_stories_getStoriesByID.f1776id.add(Integer.valueOf(tL_stories$StoryItem.f1763id));
            ...
            tLRPC$TL_users_getFullUser.f1745id = getMessagesController().getInputUser(((TLRPC$BotInfo) obj).user_id);
            ...
            tLRPC$TL_inputWallPaper.f1679id = tLRPC$TL_wallPaper.f1759id;
            ...
            tLRPC$TL_users_getUsers.f1747id.add(getMessagesController().getInputUser((TLRPC$User) obj));
    ...
    private boolean onUpdateObjectReference(final Requester requester, byte[] bArr, TLRPC$InputFileLocation tLRPC$InputFileLocation, boolean z) {
        ...
        if (BuildVars.DEBUG_VERSION) {
            FileLog.m105d("fileref updated for " + requester.args[0] + " " + requester.locationKey);
        }
            ...
            if (requester.args[0] instanceof TLRPC$TL_inputSingleMedia) {
                ...
                if (!(requester.args[0] instanceof TLRPC$TL_messages_editMessage)) {
                    if (requester.args[0] instanceof TLRPC$TL_messages_saveGif) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m105d("debug_loading: " + fileLoadOperation.getCacheFileFinal().getName() + " " + str + " " + r4 + " reference updated resume download");
                        }
    ...
    private void sendErrorToObject(final Object[] objArr, int i) {
        if (objArr[0] instanceof TLRPC$TL_inputSingleMedia) {
            ...
            fileLoadOperation.requestingReference = false;
            FileLog.m104e("debug_loading: " + fileLoadOperation.getCacheFileFinal().getName() + " reference can't update: fail operation ");
    ...
    /* JADX WARN: Removed duplicated region for block: B:342:0x0783  */
    ...
    */
    ...
    private boolean getPeerReferenceReplacement(TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, boolean z, TLRPC$InputFileLocation tLRPC$InputFileLocation, TLRPC$InputFileLocation[] tLRPC$InputFileLocationArr, boolean[] zArr) {
        ...
        if (tLRPC$User != null) {
            ...
            tLRPC$InputPeer.user_id = tLRPC$User.f1751id;
