...
public class FileRefController extends BaseController {
    ...
    public static String getKeyForParentObject(Object obj) {
        ...
        if (obj instanceof TLRPC$TL_availableReaction) {
            ...
            return "message" + tLRPC$Message.f1451id + "_" + j2 + "_" + tLRPC$Message.from_scheduled;
        } else if (obj instanceof TLRPC$WebPage) {
            return "webpage" + ((TLRPC$WebPage) obj).f1576id;
        } else if (obj instanceof TLRPC$User) {
            return "user" + ((TLRPC$User) obj).f1567id;
        } else if (obj instanceof TLRPC$Chat) {
            return "chat" + ((TLRPC$Chat) obj).f1427id;
        } else if (obj instanceof String) {
            return "str" + ((String) obj);
        } else if (obj instanceof TLRPC$TL_messages_stickerSet) {
            return "set" + ((TLRPC$TL_messages_stickerSet) obj).set.f1460id;
        } else if (obj instanceof TLRPC$StickerSetCovered) {
            return "set" + ((TLRPC$StickerSetCovered) obj).set.f1460id;
        } else if (obj instanceof TLRPC$InputStickerSet) {
            return "set" + ((TLRPC$InputStickerSet) obj).f1450id;
        } else if (obj instanceof TLRPC$TL_wallPaper) {
            return "wallpaper" + ((TLRPC$TL_wallPaper) obj).f1575id;
        } else if (obj instanceof TLRPC$TL_theme) {
            return "theme" + ((TLRPC$TL_theme) obj).f1558id;
        } else if (obj != null) {
            return "" + obj;
        } else {
            return null;
    ...
    */
    ...
    private void requestReferenceFromServer(Object obj, final String str, final String str2, Object[] objArr) {
        if (obj instanceof TLRPC$TL_help_premiumPromo) {
            ...
            tLRPC$TL_users_getFullUser.f1563id = getMessagesController().getInputUser(((TLRPC$BotInfo) obj).user_id);
            ...
            if (messageObject.scheduled) {
                ...
                tLRPC$TL_messages_getScheduledMessages.f1523id.add(Integer.valueOf(messageObject.getRealId()));
                ...
                tLRPC$TL_channels_getMessages.f1469id.add(Integer.valueOf(messageObject.getRealId()));
                ...
                tLRPC$TL_messages_getMessages.f1519id.add(Integer.valueOf(messageObject.getRealId()));
            ...
            tLRPC$TL_inputWallPaper.f1500id = tLRPC$TL_wallPaper.f1575id;
            ...
            tLRPC$TL_users_getUsers.f1564id.add(getMessagesController().getInputUser((TLRPC$User) obj));
            ...
            if (tLRPC$Chat instanceof TLRPC$TL_chat) {
                ...
                tLRPC$TL_messages_getChats.f1515id.add(Long.valueOf(tLRPC$Chat.f1427id));
                ...
                tLRPC$TL_channels_getChannels.f1467id.add(MessagesController.getInputChannel(tLRPC$Chat));
            ...
            if ("wallpaper".equals(str3)) {
                ...
                if (split.length >= 3) {
                    ...
                    if (longValue2 != 0) {
                        ...
                        tLRPC$TL_channels_getMessages2.f1469id.add(Utilities.parseInt((CharSequence) split[2]));
                    ...
                    tLRPC$TL_messages_getMessages2.f1519id.add(Utilities.parseInt((CharSequence) split[2]));
    ...
    private boolean onUpdateObjectReference(final Requester requester, byte[] bArr, TLRPC$InputFileLocation tLRPC$InputFileLocation, boolean z) {
        ...
        if (BuildVars.DEBUG_VERSION) {
            FileLog.m48d("fileref updated for " + requester.args[0] + " " + requester.locationKey);
        }
        if (requester.args[0] instanceof TLRPC$TL_inputSingleMedia) {
            ...
            if (tLRPC$InputMedia instanceof TLRPC$TL_inputMediaDocument) {
                ...
                if (z && isSameReference(tLRPC$TL_inputMediaDocument.f1491id.file_reference, bArr)) {
                    return false;
                }
                tLRPC$TL_inputMediaDocument.f1491id.file_reference = bArr;
                ...
                if (z && isSameReference(tLRPC$TL_inputMediaPhoto.f1493id.file_reference, bArr)) {
                    return false;
                }
                tLRPC$TL_inputMediaPhoto.f1493id.file_reference = bArr;
            }
            ...
            if (!(requester.args[0] instanceof TLRPC$TL_messages_editMessage)) {
                if (requester.args[0] instanceof TLRPC$TL_messages_saveGif) {
                    ...
                    if (z && isSameReference(tLRPC$TL_messages_saveGif.f1530id.file_reference, bArr)) {
                        return false;
                    }
                    tLRPC$TL_messages_saveGif.f1530id.file_reference = bArr;
                    ...
                    if (z && isSameReference(tLRPC$TL_messages_saveRecentSticker.f1531id.file_reference, bArr)) {
                        return false;
                    }
                    tLRPC$TL_messages_saveRecentSticker.f1531id.file_reference = bArr;
                    ...
                    if (z && isSameReference(tLRPC$TL_messages_faveSticker.f1512id.file_reference, bArr)) {
                        return false;
                    }
                    tLRPC$TL_messages_faveSticker.f1512id.file_reference = bArr;
                    ...
                    if (tLRPC$InputStickeredMedia instanceof TLRPC$TL_inputStickeredMediaDocument) {
                        ...
                        if (z && isSameReference(tLRPC$TL_inputStickeredMediaDocument.f1497id.file_reference, bArr)) {
                            return false;
                        }
                        tLRPC$TL_inputStickeredMediaDocument.f1497id.file_reference = bArr;
                        ...
                        if (z && isSameReference(tLRPC$TL_inputStickeredMediaPhoto.f1498id.file_reference, bArr)) {
                            return false;
                        }
                        tLRPC$TL_inputStickeredMediaPhoto.f1498id.file_reference = bArr;
                    }
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m48d("debug_loading: " + fileLoadOperation.getCacheFileFinal().getName() + " " + str + " " + r3 + " reference updated resume download");
                    }
                ...
                if (tLRPC$InputMedia2 instanceof TLRPC$TL_inputMediaDocument) {
                    ...
                    if (z && isSameReference(tLRPC$TL_inputMediaDocument2.f1491id.file_reference, bArr)) {
                        return false;
                    }
                    tLRPC$TL_inputMediaDocument2.f1491id.file_reference = bArr;
                    ...
                    if (z && isSameReference(tLRPC$TL_inputMediaPhoto2.f1493id.file_reference, bArr)) {
                        return false;
                    }
                    tLRPC$TL_inputMediaPhoto2.f1493id.file_reference = bArr;
                }
            ...
            if (tLRPC$InputMedia3 instanceof TLRPC$TL_inputMediaDocument) {
                ...
                if (z && isSameReference(tLRPC$TL_inputMediaDocument3.f1491id.file_reference, bArr)) {
                    return false;
                }
                tLRPC$TL_inputMediaDocument3.f1491id.file_reference = bArr;
                ...
                if (z && isSameReference(tLRPC$TL_inputMediaPhoto3.f1493id.file_reference, bArr)) {
                    return false;
                }
                tLRPC$TL_inputMediaPhoto3.f1493id.file_reference = bArr;
            }
    ...
    private void sendErrorToObject(final Object[] objArr, int i) {
        if (objArr[0] instanceof TLRPC$TL_inputSingleMedia) {
            ...
            fileLoadOperation.requestingReference = false;
            FileLog.m47e("debug_loading: " + fileLoadOperation.getCacheFileFinal().getName() + "reference can't update: fail operation ");
    ...
    /* JADX WARN: Removed duplicated region for block: B:301:0x01a8 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:43:0x009e A[RETURN] */
    /* JADX WARN: Removed duplicated region for block: B:44:0x009f  */
    /* JADX WARN: Removed duplicated region for block: B:94:0x01ba A[LOOP:2: B:66:0x0137->B:94:0x01ba, LOOP_END] */
    ...
    */
    ...
    private byte[] getFileReference(TLRPC$Document tLRPC$Document, TLRPC$InputFileLocation tLRPC$InputFileLocation, boolean[] zArr, TLRPC$InputFileLocation[] tLRPC$InputFileLocationArr) {
        if (tLRPC$Document != null && tLRPC$InputFileLocation != null) {
            if (tLRPC$InputFileLocation instanceof TLRPC$TL_inputDocumentFileLocation) {
                if (tLRPC$Document.f1435id == tLRPC$InputFileLocation.f1446id) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (zArr != null && zArr[0]) {
                        ...
                        tLRPC$InputFileLocationArr[0].f1446id = tLRPC$Document.f1435id;
    ...
    private boolean getPeerReferenceReplacement(TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, boolean z, TLRPC$InputFileLocation tLRPC$InputFileLocation, TLRPC$InputFileLocation[] tLRPC$InputFileLocationArr, boolean[] zArr) {
        ...
        tLRPC$TL_inputPeerPhotoFileLocation.f1446id = j;
        ...
        if (tLRPC$User != null) {
            ...
            tLRPC$InputPeer.user_id = tLRPC$User.f1567id;
    ...
    private byte[] getFileReference(TLRPC$Photo tLRPC$Photo, TLRPC$InputFileLocation tLRPC$InputFileLocation, boolean[] zArr, TLRPC$InputFileLocation[] tLRPC$InputFileLocationArr) {
        ...
        if (tLRPC$InputFileLocation instanceof TLRPC$TL_inputPhotoFileLocation) {
            if (tLRPC$Photo.f1456id == tLRPC$InputFileLocation.f1446id) {
        ...
        if (tLRPC$InputFileLocation instanceof TLRPC$TL_inputFileLocation) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (zArr != null && zArr[0]) {
                    ...
                    tLRPC$InputFileLocationArr[0].f1446id = tLRPC$Photo.f1456id;
                    tLRPC$InputFileLocationArr[0].volume_id = tLRPC$InputFileLocation.volume_id;
                    tLRPC$InputFileLocationArr[0].local_id = tLRPC$InputFileLocation.local_id;
