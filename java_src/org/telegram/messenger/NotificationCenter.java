...
public class NotificationCenter {
    ...
    static {
        ...
        int i195 = i194 + 1;
        totalEvents = i195;
        stopEncodingService = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        wallpapersDidLoad = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        wallpapersNeedReload = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        didReceiveSmsCode = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        didReceiveCall = i198;
        int i200 = i199 + 1;
        ...
        int i201 = i200 + 1;
        totalEvents = i201;
        invalidateMotionBackground = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        closeOtherAppActivities = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        cameraInitied = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        didReplacedPhotoInMemCache = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        didSetNewTheme = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        themeListUpdated = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        didApplyNewTheme = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        themeAccentListUpdated = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        needCheckSystemBarColors = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        needShareTheme = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        needSetDayNightTheme = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        goingToPreviewTheme = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        locationPermissionGranted = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        locationPermissionDenied = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        reloadInterface = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        suggestedLangpack = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        didSetNewWallpapper = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        proxySettingsChanged = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        proxyCheckDone = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        proxyChangedByRotation = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        liveLocationsChanged = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        newLocationAvailable = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        liveLocationsCacheChanged = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        notificationsCountUpdated = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        playerDidStartPlaying = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        closeSearchByActiveAction = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        messagePlayingSpeedChanged = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        screenStateChanged = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        didClearDatabase = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        voipServiceCreated = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        webRtcMicAmplitudeEvent = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        webRtcSpeakerAmplitudeEvent = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        showBulletin = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        appUpdateAvailable = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        onDatabaseMigration = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        onEmojiInteractionsReceived = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        emojiPreviewThemesChanged = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        reactionsDidLoad = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        attachMenuBotsDidLoad = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        chatAvailableReactionsUpdated = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        dialogsUnreadReactionsCounterChanged = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        onDatabaseOpened = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        onDownloadingFilesChanged = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        onActivityResultReceived = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        onRequestPermissionResultReceived = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        onUserRingtonesUpdated = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        currentUserPremiumStatusChanged = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        premiumPromoUpdated = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        premiumStatusChangedGlobal = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        currentUserShowLimitReachedDialog = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        billingProductDetailsUpdated = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
    ...
    public void addObserver(NotificationCenterDelegate notificationCenterDelegate, int i) {
        ...
        alreadyLogged = true;
        FileLog.m48e((Throwable) new RuntimeException("Total observers more than 1000, need check for memory leak. " + i), true);
    }
