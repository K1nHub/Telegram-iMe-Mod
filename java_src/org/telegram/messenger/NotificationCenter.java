...
public class NotificationCenter {
    ...
    static {
        ...
        int i253 = i252 + 1;
        totalEvents = i253;
        premiumStickersPreviewLoaded = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        userEmojiStatusUpdated = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        requestPermissions = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        permissionsGranted = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
        topicsDidLoaded = i256;
        int i258 = i257 + 1;
        totalEvents = i258;
        chatSwithcedToForum = i257;
        int i259 = i258 + 1;
        totalEvents = i259;
        didUpdateGlobalAutoDeleteTimer = i258;
        totalEvents = i259 + 1;
        onDatabaseReset = i259;
    }
    ...
    public void runDelayedNotifications() {
        if (!this.delayedPosts.isEmpty()) {
            ...
            for (int i = 0; i < this.delayedPostsTmp.size(); i++) {
                ...
                postNotificationNameInternal(delayedPost.f1436id, true, delayedPost.args);
            }
            this.delayedPostsTmp.clear();
        }
