...
public class NotificationCenter {
    ...
    static {
        ...
        int i189 = i188 + 1;
        totalEvents = i189;
        boostedChannelByUser = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        boostByChannelCreated = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        didUpdatePremiumGiftStickers = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        didUpdatePremiumGiftFieldIcon = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        storiesEnabledUpdate = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        storiesBlocklistUpdate = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        storiesLimitUpdate = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        storiesSendAsUpdate = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        unconfirmedAuthUpdate = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        dialogPhotosUpdate = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        pushMessagesUpdated = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
    ...
    public void addObserver(NotificationCenterDelegate notificationCenterDelegate, int i) {
        ...
        alreadyLogged = true;
        FileLog.m98e((Throwable) new RuntimeException("Total observers more than 1000, need check for memory leak. " + i), true);
    }
