...
public class NotificationCenter {
    ...
    static {
        ...
        int i111 = i110 + 1;
        totalEvents = i111;
        updateMentionsCount = i110;
        int i112 = i111 + 1;
        totalEvents = i112;
        didUpdatePollResults = i111;
        int i113 = i112 + 1;
        totalEvents = i113;
        chatOnlineCountDidLoad = i112;
        int i114 = i113 + 1;
        totalEvents = i114;
        videoLoadingStateChanged = i113;
        int i115 = i114 + 1;
        totalEvents = i115;
        newPeopleNearbyAvailable = i114;
        int i116 = i115 + 1;
        totalEvents = i116;
        stopAllHeavyOperations = i115;
        int i117 = i116 + 1;
        totalEvents = i117;
        startAllHeavyOperations = i116;
        int i118 = i117 + 1;
        totalEvents = i118;
        stopSpoilers = i117;
        int i119 = i118 + 1;
        ...
        int i120 = i119 + 1;
        totalEvents = i120;
        sendingMessagesChanged = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        didUpdateReactions = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        didUpdateExtendedMedia = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        didVerifyMessagesStickers = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        scheduledMessagesUpdated = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        newSuggestionsAvailable = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        didLoadChatInviter = i125;
        int i127 = i126 + 1;
        totalEvents = i127;
        didLoadChatAdmins = i126;
        int i128 = i127 + 1;
        totalEvents = i128;
        historyImportProgressChanged = i127;
        int i129 = i128 + 1;
        totalEvents = i129;
        stickersImportProgressChanged = i128;
        int i130 = i129 + 1;
        totalEvents = i130;
        stickersImportComplete = i129;
        int i131 = i130 + 1;
        totalEvents = i131;
        dialogDeleted = i130;
        int i132 = i131 + 1;
        totalEvents = i132;
        webViewResultSent = i131;
        int i133 = i132 + 1;
        totalEvents = i133;
        voiceTranscriptionUpdate = i132;
        int i134 = i133 + 1;
        totalEvents = i134;
        animatedEmojiDocumentLoaded = i133;
        int i135 = i134 + 1;
        totalEvents = i135;
        recentEmojiStatusesUpdate = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        updateSearchSettings = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        messageTranslated = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        messageTranslating = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        dialogIsTranslatable = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        dialogTranslate = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        didGenerateFingerprintKeyPair = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        walletPendingTransactionsChanged = i141;
        int i143 = i142 + 1;
        totalEvents = i143;
        walletSyncProgressChanged = i142;
        int i144 = i143 + 1;
        totalEvents = i144;
        httpFileDidLoad = i143;
        int i145 = i144 + 1;
        totalEvents = i145;
        httpFileDidFailedLoad = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        didUpdateConnectionState = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        fileUploaded = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        fileUploadFailed = i147;
        int i149 = i148 + 1;
        totalEvents = i149;
        fileUploadProgressChanged = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        fileLoadProgressChanged = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        fileLoaded = i150;
        int i152 = i151 + 1;
        ...
        int i153 = i152 + 1;
        totalEvents = i153;
        filePreparingStarted = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        fileNewChunkAvailable = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        filePreparingFailed = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        dialogsUnreadCounterChanged = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        messagePlayingProgressDidChanged = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        messagePlayingDidReset = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        messagePlayingPlayStateChanged = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        messagePlayingDidStart = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        messagePlayingDidSeek = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        messagePlayingGoingToStop = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        recordProgressChanged = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        recordStarted = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        recordStartError = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        recordStopped = i165;
        int i167 = i166 + 1;
        ...
        int i192 = i191 + 1;
        totalEvents = i192;
        didUpdatePremiumGiftStickers = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        didUpdatePremiumGiftFieldIcon = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        storiesEnabledUpdate = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        pushMessagesUpdated = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        stopEncodingService = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        wallpapersDidLoad = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        wallpapersNeedReload = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        didReceiveSmsCode = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        didReceiveCall = i199;
        int i201 = i200 + 1;
        ...
        int i202 = i201 + 1;
        totalEvents = i202;
        invalidateMotionBackground = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        closeOtherAppActivities = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        cameraInitied = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        didReplacedPhotoInMemCache = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        didSetNewTheme = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        themeListUpdated = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        didApplyNewTheme = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        themeAccentListUpdated = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        needCheckSystemBarColors = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        needShareTheme = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        needSetDayNightTheme = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        goingToPreviewTheme = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        locationPermissionGranted = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        locationPermissionDenied = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        reloadInterface = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        suggestedLangpack = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        didSetNewWallpapper = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        proxySettingsChanged = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        proxyCheckDone = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        proxyChangedByRotation = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        liveLocationsChanged = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        newLocationAvailable = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        liveLocationsCacheChanged = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        notificationsCountUpdated = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        playerDidStartPlaying = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        closeSearchByActiveAction = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        messagePlayingSpeedChanged = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        screenStateChanged = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        didClearDatabase = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        voipServiceCreated = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        webRtcMicAmplitudeEvent = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        webRtcSpeakerAmplitudeEvent = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        showBulletin = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        appUpdateAvailable = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        onDatabaseMigration = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        onEmojiInteractionsReceived = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        emojiPreviewThemesChanged = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        reactionsDidLoad = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        attachMenuBotsDidLoad = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        chatAvailableReactionsUpdated = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        dialogsUnreadReactionsCounterChanged = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        onDatabaseOpened = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        onDownloadingFilesChanged = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        onActivityResultReceived = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        onRequestPermissionResultReceived = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        onUserRingtonesUpdated = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        currentUserPremiumStatusChanged = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        premiumPromoUpdated = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        premiumStatusChangedGlobal = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        currentUserShowLimitReachedDialog = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        billingProductDetailsUpdated = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        billingConfirmPurchaseError = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        ...
        int i262 = i261 + 1;
        totalEvents = i262;
        wallpaperSettedToUser = i261;
        int i263 = i262 + 1;
        totalEvents = i263;
        storiesUpdated = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        storiesListUpdated = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        storiesDraftsUpdated = i264;
        int i266 = i265 + 1;
        totalEvents = i266;
        chatlistFolderUpdate = i265;
        int i267 = i266 + 1;
        totalEvents = i267;
        uploadStoryProgress = i266;
        int i268 = i267 + 1;
        totalEvents = i268;
        uploadStoryEnd = i267;
        totalEvents = i268 + 1;
        customTypefacesLoaded = i268;
    }
    ...
    public void runDelayedNotifications() {
        if (!this.delayedPosts.isEmpty()) {
            ...
            for (int i = 0; i < this.delayedPostsTmp.size(); i++) {
                ...
                postNotificationNameInternal(delayedPost.f1460id, true, delayedPost.args);
            }
            this.delayedPostsTmp.clear();
        }
