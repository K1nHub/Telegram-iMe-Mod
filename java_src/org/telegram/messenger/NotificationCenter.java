...
public class NotificationCenter {
    ...
    static {
        ...
        int i134 = i133 + 1;
        totalEvents = i134;
        messageTranslated = i133;
        int i135 = i134 + 1;
        totalEvents = i135;
        messageTranslating = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        dialogIsTranslatable = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        dialogTranslate = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        didGenerateFingerprintKeyPair = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        walletPendingTransactionsChanged = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        walletSyncProgressChanged = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        httpFileDidLoad = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        httpFileDidFailedLoad = i141;
        int i143 = i142 + 1;
        totalEvents = i143;
        didUpdateConnectionState = i142;
        int i144 = i143 + 1;
        totalEvents = i144;
        fileUploaded = i143;
        int i145 = i144 + 1;
        totalEvents = i145;
        fileUploadFailed = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        fileUploadProgressChanged = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        fileLoadProgressChanged = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        fileLoaded = i147;
        int i149 = i148 + 1;
        ...
        int i150 = i149 + 1;
        totalEvents = i150;
        filePreparingStarted = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        fileNewChunkAvailable = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        filePreparingFailed = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        dialogsUnreadCounterChanged = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        messagePlayingProgressDidChanged = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        messagePlayingDidReset = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        messagePlayingPlayStateChanged = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        messagePlayingDidStart = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        messagePlayingDidSeek = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        messagePlayingGoingToStop = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        recordProgressChanged = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        recordStarted = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        recordStartError = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        recordStopped = i162;
        int i164 = i163 + 1;
        ...
        int i167 = i166 + 1;
        totalEvents = i167;
        audioRecordTooShort = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        audioRouteChanged = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        didStartedCall = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        groupCallUpdated = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        groupCallSpeakingUsersUpdated = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        groupCallScreencastStateChanged = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        activeGroupCallsUpdated = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        applyGroupCallVisibleParticipants = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        groupCallTypingsUpdated = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        didEndCall = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        closeInCallActivity = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        groupCallVisibilityChanged = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        appDidLogout = i178;
        int i180 = i179 + 1;
        ...
        int i181 = i180 + 1;
        totalEvents = i181;
        needDeleteDialog = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        newEmojiSuggestionsAvailable = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        themeUploadedToServer = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        themeUploadError = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        dialogFiltersUpdated = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        filterSettingsUpdated = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        suggestedFiltersLoaded = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        updateBotMenuButton = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        didUpdatePremiumGiftStickers = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        didUpdatePremiumGiftFieldIcon = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        storiesEnabledUpdate = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        storiesBlocklistUpdate = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        storiesLimitUpdate = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        storiesSendAsUpdate = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        unconfirmedAuthUpdate = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        ...
        int i254 = i253 + 1;
        totalEvents = i254;
        billingConfirmPurchaseError = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        ...
        int i263 = i262 + 1;
        totalEvents = i263;
        wallpaperSettedToUser = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        storiesUpdated = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        storiesListUpdated = i264;
        int i266 = i265 + 1;
        totalEvents = i266;
        storiesDraftsUpdated = i265;
        int i267 = i266 + 1;
        totalEvents = i267;
        chatlistFolderUpdate = i266;
        int i268 = i267 + 1;
        totalEvents = i268;
        uploadStoryProgress = i267;
        int i269 = i268 + 1;
        totalEvents = i269;
        uploadStoryEnd = i268;
        int i270 = i269 + 1;
        totalEvents = i270;
        customTypefacesLoaded = i269;
        int i271 = i270 + 1;
        totalEvents = i271;
        stealthModeChanged = i270;
        totalEvents = i271 + 1;
        onReceivedChannelDifference = i271;
    }
    ...
    public void runDelayedNotifications() {
        if (!this.delayedPosts.isEmpty()) {
            ...
            for (int i = 0; i < this.delayedPostsTmp.size(); i++) {
                ...
                postNotificationNameInternal(delayedPost.f1539id, true, delayedPost.args);
            }
            this.delayedPostsTmp.clear();
        }
    ...
    public void addObserver(NotificationCenterDelegate notificationCenterDelegate, int i) {
        ...
        alreadyLogged = true;
        FileLog.m96e((Throwable) new RuntimeException("Total observers more than 1000, need check for memory leak. " + i), true);
    }
