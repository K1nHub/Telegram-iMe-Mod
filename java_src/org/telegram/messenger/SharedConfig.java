...
public class SharedConfig {
    ...
    /* JADX WARN: Removed duplicated region for block: B:38:0x0185 A[Catch: Exception -> 0x01a3, all -> 0x0846, TryCatch #4 {Exception -> 0x01a3, blocks: (B:22:0x0134, B:24:0x013c, B:26:0x014e, B:27:0x0162, B:38:0x0185, B:40:0x018b, B:41:0x018d, B:43:0x0191, B:45:0x0197, B:47:0x019b, B:36:0x017f), top: B:92:0x0134, outer: #3 }] */
    /* JADX WARN: Removed duplicated region for block: B:40:0x018b A[Catch: Exception -> 0x01a3, all -> 0x0846, TryCatch #4 {Exception -> 0x01a3, blocks: (B:22:0x0134, B:24:0x013c, B:26:0x014e, B:27:0x0162, B:38:0x0185, B:40:0x018b, B:41:0x018d, B:43:0x0191, B:45:0x0197, B:47:0x019b, B:36:0x017f), top: B:92:0x0134, outer: #3 }] */
    /* JADX WARN: Removed duplicated region for block: B:59:0x05e2  */
    /* JADX WARN: Removed duplicated region for block: B:60:0x05e5  */
    /* JADX WARN: Removed duplicated region for block: B:63:0x05f5  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:85:0x0836 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
    ...
    */
    ...
    public static void increaseBadPasscodeTries(int i, LockedSection lockedSection) {
        ...
        if (badPasscodeTries2 >= 3) {
            long j = badPasscodeTries2 != 3 ? badPasscodeTries2 != 4 ? badPasscodeTries2 != 5 ? badPasscodeTries2 != 6 ? badPasscodeTries2 != 7 ? 30000L : 25000L : SilenceSkippingAudioProcessor.DEFAULT_PADDING_SILENCE_US : C0483C.DEFAULT_SEEK_FORWARD_INCREMENT_MS : 10000L : 5000L;
            if (sectionPasscodeData != null) {
    ...
    */
        ...
        if (!TextUtils.isEmpty(string5)) {
            ...
            if (readInt32 == -1) {
                if (serializedData.readByte(false) == 2) {
                    ...
                    FileLog.m104e("Unknown proxy schema version: " + ((int) readByte));
                }
            } else {
    ...
    public static int measureDevicePerformanceClass() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m105d("device performance info selected_class = " + i3 + " (cpu_count = " + i2 + ", freq = " + ceil + ", memoryClass = " + memoryClass + ", android version " + i + ", manufacture " + Build.MANUFACTURER + ", screenRefreshRate=" + AndroidUtilities.screenRefreshRate + ")");
        }
        return i3;
    }
