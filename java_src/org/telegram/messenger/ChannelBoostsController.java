...
public class ChannelBoostsController {
        ...
        if (tLObject != null) {
            ...
            if (tLObject instanceof TLRPC$TL_stories_canApplyBoostReplace) {
                ...
                if (peerDialogId == 0 && tLRPC$TL_stories_canApplyBoostReplace.chats.size() > 0) {
                    canApplyBoost.replaceDialogId = -tLRPC$TL_stories_canApplyBoostReplace.chats.get(0).f1600id;
                }
            }
    ...
    public void applyBoost(long j) {
        ...
        this.connectionsManager.sendRequest(tLRPC$TL_stories_applyBoost, new RequestDelegate() { // from class: org.telegram.messenger.ChannelBoostsController$$ExternalSyntheticLambda4
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
