...
public class ImageLocation {
    ...
    public static ImageLocation getForDocument(TLRPC$Document tLRPC$Document) {
        ...
        imageLocation.f1530iv = tLRPC$Document.f1609iv;
    ...
    public static ImageLocation getForUser(TLRPC$User tLRPC$User, int i) {
        ...
        if (tLRPC$User != null && tLRPC$User.access_hash != 0 && (tLRPC$UserProfilePhoto = tLRPC$User.photo) != null) {
            ...
            if (MessagesController.getInstance(i3).isPremiumUser(tLRPC$User) && tLRPC$User.photo.has_video && ForkCommonController.getInstance(i3).isPremiumAnimateAvatars() && (userFull = MessagesController.getInstance(i3).getUserFull(tLRPC$User.f1762id)) != null && (tLRPC$Photo = userFull.profile_photo) != null && (arrayList = tLRPC$Photo.video_sizes) != null && !arrayList.isEmpty()) {
                if (i == 4) {
        ...
        if (tLRPC$FileLocation != null) {
            ...
            if (tLRPC$FileLocation instanceof TLRPC$TL_fileLocationToBeDeprecated) {
                ...
                if (tLRPC$Photo != null) {
                    ...
                    imageLocation.photoId = tLRPC$Photo.f1630id;
                    ...
                    imageLocation.documentId = tLRPC$Document.f1608id;
                    imageLocation.thumbSize = str;
                }
            } else {
                TLRPC$TL_fileLocationToBeDeprecated tLRPC$TL_fileLocationToBeDeprecated = new TLRPC$TL_fileLocationToBeDeprecated();
                ...
                imageLocation.f1530iv = tLRPC$FileLocation.f1614iv;
    ...
    public static String getStrippedKey(Object obj, Object obj2, Object obj3) {
        if (obj instanceof TLRPC$WebPage) {
            ...
            if (obj2 == null) {
                ...
                return "stripped" + FileRefController.getKeyForParentObject(obj) + "_" + ((TLRPC$Document) obj2).f1608id;
            } else if (obj2 instanceof TLRPC$Photo) {
                return "stripped" + FileRefController.getKeyForParentObject(obj) + "_" + ((TLRPC$Photo) obj2).f1630id;
    ...
    public String getKey(Object obj, Object obj2, boolean z) {
        if (this.secureDocument != null) {
            return this.secureDocument.secureFile.dc_id + "_" + this.secureDocument.secureFile.f1736id;
        }
        ...
        if ((tLRPC$PhotoSize instanceof TLRPC$TL_photoStrippedSize) || (tLRPC$PhotoSize instanceof TLRPC$TL_photoPathSize)) {
            ...
            if (tLRPC$Document != null) {
                if (!z && (tLRPC$Document instanceof DocumentObject.ThemeDocument)) {
                    ...
                    sb.append("_");
                    sb.append(this.document.f1608id);
                    sb.append("_");
                    ...
                    return sb.toString();
                } else if (tLRPC$Document.f1608id == 0 || tLRPC$Document.dc_id == 0) {
                    return null;
                } else {
                    return this.document.dc_id + "_" + this.document.f1608id;
                }
            }
