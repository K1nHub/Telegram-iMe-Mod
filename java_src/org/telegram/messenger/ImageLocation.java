...
public class ImageLocation {
    ...
    public static ImageLocation getForDocument(TLRPC$Document tLRPC$Document) {
        ...
        imageLocation.f1448iv = tLRPC$Document.f1524iv;
    ...
    public static ImageLocation getForUser(TLRPC$User tLRPC$User, int i) {
        ...
        if (tLRPC$User != null && tLRPC$User.access_hash != 0 && (tLRPC$UserProfilePhoto = tLRPC$User.photo) != null) {
            if (i != 4 && i != 3) {
                ...
                tLRPC$TL_inputPeerUser.user_id = tLRPC$User.f1656id;
            ...
            if (MessagesController.getInstance(i3).isPremiumUser(tLRPC$User) && tLRPC$User.photo.has_video && ForkCommonController.getInstance(i3).isPremiumAnimateAvatars() && (userFull = MessagesController.getInstance(i3).getUserFull(tLRPC$User.f1656id)) != null && (tLRPC$Photo = userFull.profile_photo) != null && (arrayList = tLRPC$Photo.video_sizes) != null && !arrayList.isEmpty()) {
                if (i == 4) {
        ...
        if (tLRPC$FileLocation != null) {
            ...
            if (tLRPC$FileLocation instanceof TLRPC$TL_fileLocationToBeDeprecated) {
                ...
                if (tLRPC$Photo != null) {
                    ...
                    imageLocation.photoId = tLRPC$Photo.f1544id;
                    ...
                    imageLocation.documentId = tLRPC$Document.f1523id;
                    imageLocation.thumbSize = str;
                }
            } else {
                TLRPC$TL_fileLocationToBeDeprecated tLRPC$TL_fileLocationToBeDeprecated = new TLRPC$TL_fileLocationToBeDeprecated();
                ...
                imageLocation.f1448iv = tLRPC$FileLocation.f1529iv;
    ...
    public static String getStrippedKey(Object obj, Object obj2, Object obj3) {
        if (obj instanceof TLRPC$WebPage) {
            ...
            if (obj2 == null) {
                ...
                return "stripped" + FileRefController.getKeyForParentObject(obj) + "_" + ((TLRPC$Document) obj2).f1523id;
            } else if (obj2 instanceof TLRPC$Photo) {
                return "stripped" + FileRefController.getKeyForParentObject(obj) + "_" + ((TLRPC$Photo) obj2).f1544id;
    ...
    public String getKey(Object obj, Object obj2, boolean z) {
        if (this.secureDocument != null) {
            return this.secureDocument.secureFile.dc_id + "_" + this.secureDocument.secureFile.f1642id;
        }
        ...
        if ((tLRPC$PhotoSize instanceof TLRPC$TL_photoStrippedSize) || (tLRPC$PhotoSize instanceof TLRPC$TL_photoPathSize)) {
            ...
            if (tLRPC$Document != null) {
                if (!z && (tLRPC$Document instanceof DocumentObject.ThemeDocument)) {
                    ...
                    return sb.toString();
                } else if (tLRPC$Document.f1523id == 0 || tLRPC$Document.dc_id == 0) {
                    return null;
                } else {
                    return this.document.dc_id + "_" + this.document.f1523id;
                }
            }
