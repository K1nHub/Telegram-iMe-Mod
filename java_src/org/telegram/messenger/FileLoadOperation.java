...
public class FileLoadOperation {
        ...
        if (imageLocation.isEncrypted()) {
            TLRPC$InputFileLocation tLRPC$InputFileLocation = new TLRPC$InputFileLocation() { // from class: org.telegram.tgnet.TLRPC$TL_inputEncryptedFileLocation
                ...
                public void readParams(AbstractSerializedData abstractSerializedData, boolean z2) {
                    this.f1621id = abstractSerializedData.readInt64(z2);
            ...
            tLRPC$InputFileLocation.f1621id = j2;
            ...
            this.f1526iv = bArr;
            System.arraycopy(imageLocation.f1531iv, 0, bArr, 0, bArr.length);
            ...
            tLRPC$TL_inputPeerPhotoFileLocation.f1621id = j3;
            ...
            tLRPC$TL_inputStickerSetThumb.f1621id = j4;
            ...
            if (imageLocation.photoId != 0) {
                ...
                tLRPC$TL_inputPhotoFileLocation.f1621id = imageLocation.photoId;
                ...
                tLRPC$TL_inputDocumentFileLocation.f1621id = imageLocation.documentId;
    ...
    public FileLoadOperation(SecureDocument secureDocument) {
        ...
        tLRPC$InputFileLocation.f1621id = tLRPC$TL_secureFile.f1733id;
    ...
    */
    ...
    private void addPart(ArrayList<Range> arrayList, long j, long j2, boolean z) {
        ...
        if (z) {
            if (z2) {
                ...
                FileLog.m104e(this.cacheFileFinal + " downloaded duplicate file part " + j + " - " + j2);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$pause$6() {
        if (this.isStory) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("debug_loading:" + this.cacheFileFinal.getName() + " pause operation, clear requests");
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:296:0x0800  */
    /* JADX WARN: Removed duplicated region for block: B:301:0x0849  */
    /* JADX WARN: Removed duplicated region for block: B:329:0x08b7  */
    /* JADX WARN: Removed duplicated region for block: B:337:0x08dc A[Catch: Exception -> 0x08e2, TRY_LEAVE, TryCatch #14 {Exception -> 0x08e2, blocks: (B:335:0x08cb, B:337:0x08dc), top: B:400:0x08cb }] */
    /* JADX WARN: Removed duplicated region for block: B:350:0x090e  */
    /* JADX WARN: Removed duplicated region for block: B:352:0x0912  */
    /* JADX WARN: Removed duplicated region for block: B:353:0x0922  */
    /* JADX WARN: Removed duplicated region for block: B:381:0x0681 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    */
        ...
        if (z) {
            ...
            if (requestInfo != null && requestInfo.offset != j2) {
                ...
                if (BuildVars.DEBUG_VERSION) {
                    FileLog.m105d("frame get cancel request at offset " + this.priorityRequestInfo.offset);
                }
    ...
    private void onFinishLoadingFile(final boolean z, int i, boolean z2) {
        ...
        if (this.isPreloadVideoOperation || z2) {
            ...
            if (BuildVars.DEBUG_VERSION) {
                if (i == 1) {
                    FileLog.m105d("file already exist " + this.cacheFileTemp);
                } else {
                    FileLog.m105d("finished preloading file to " + this.cacheFileTemp + " loaded " + this.downloadedBytes + " of " + this.totalBytesCount + " prefSize=" + this.preloadPrefixSize);
                }
            }
    ...
    */
    ...
    public /* synthetic */ void lambda$onFinishLoadingFile$14(boolean z) {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m105d("finished downloading file to " + this.cacheFileFinal + " time = " + (System.currentTimeMillis() - this.startTime) + " dc = " + this.datacenterId + " size = " + AndroidUtilities.formatFileSize(this.totalBytesCount));
        }
        if (z) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:196:0x0536 A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:206:0x056a A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:224:0x05d0 A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:225:0x05d7 A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:35:0x00a1 A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:44:0x00de A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:45:0x0112  */
    /* JADX WARN: Removed duplicated region for block: B:48:0x0118 A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:80:0x0225 A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:81:0x0231 A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /* JADX WARN: Removed duplicated region for block: B:84:0x023f A[Catch: Exception -> 0x05e9, TryCatch #1 {Exception -> 0x05e9, blocks: (B:12:0x0054, B:14:0x0058, B:16:0x0062, B:18:0x0066, B:20:0x006c, B:30:0x0091, B:33:0x0099, B:35:0x00a1, B:37:0x00b1, B:40:0x00bf, B:42:0x00c6, B:44:0x00de, B:46:0x0114, B:48:0x0118, B:50:0x013c, B:51:0x0165, B:53:0x0169, B:54:0x0170, B:56:0x019b, B:58:0x01ae, B:60:0x01c2, B:62:0x01d6, B:64:0x01e3, B:66:0x01e8, B:68:0x0209, B:70:0x020d, B:72:0x0213, B:74:0x0219, B:80:0x0225, B:204:0x0562, B:206:0x056a, B:208:0x0576, B:211:0x0581, B:212:0x0584, B:214:0x0590, B:216:0x0596, B:217:0x05a5, B:219:0x05ab, B:220:0x05ba, B:222:0x05c0, B:224:0x05d0, B:225:0x05d7, B:227:0x05dc, B:81:0x0231, B:83:0x0235, B:61:0x01cd, B:63:0x01db, B:84:0x023f, B:88:0x0251, B:90:0x0255, B:92:0x025a, B:94:0x0260, B:99:0x026c, B:117:0x0294, B:119:0x029a, B:121:0x02b3, B:123:0x02b9, B:128:0x02cd, B:129:0x02e3, B:130:0x02e4, B:131:0x02e8, B:133:0x02ec, B:134:0x031e, B:136:0x0322, B:138:0x032f, B:139:0x0366, B:141:0x038d, B:143:0x039f, B:145:0x03af, B:151:0x03bf, B:153:0x03d8, B:155:0x03df, B:157:0x03e5, B:166:0x03f9, B:168:0x0409, B:169:0x041b, B:174:0x042c, B:175:0x0433, B:176:0x0434, B:178:0x0441, B:180:0x047f, B:182:0x048e, B:184:0x0492, B:186:0x0496, B:187:0x04e8, B:189:0x04ee, B:190:0x050d, B:192:0x0517, B:194:0x0532, B:196:0x0536, B:197:0x0542, B:199:0x054a, B:201:0x054f, B:148:0x03b9, B:103:0x0277, B:107:0x027f, B:228:0x05e3, B:22:0x0074, B:24:0x007a, B:25:0x0081, B:27:0x0087), top: B:291:0x0054 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    public void onFail(boolean z, final int i) {
        ...
        if (this.delegate != null && BuildVars.LOGS_ENABLED) {
            ...
            if (i == 1) {
                FileLog.m105d("cancel downloading file to " + this.cacheFileFinal + " time = " + currentTimeMillis + " dc = " + this.datacenterId + " size = " + AndroidUtilities.formatFileSize(this.totalBytesCount));
            } else {
                FileLog.m105d("failed downloading file to " + this.cacheFileFinal + " reason = " + i + " time = " + currentTimeMillis + " dc = " + this.datacenterId + " size = " + AndroidUtilities.formatFileSize(this.totalBytesCount));
            }
        }
        if (z) {
    ...
    private void requestReference(RequestInfo requestInfo) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m105d("debug_loading: " + this.cacheFileFinal.getName() + " file reference expired ");
        }
    ...
    */
    ...
    public /* synthetic */ void lambda$startDownloadRequest$20(final RequestInfo requestInfo, int i, final int i2, TLObject tLObject, TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (this.requestInfos.contains(requestInfo)) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("debug_loading: " + this.cacheFileFinal.getName() + " time=" + (System.currentTimeMillis() - requestInfo.requestStartTime) + " dcId=" + i + " cdn=" + this.isCdn + " conType=" + i2 + " reqId" + requestInfo.requestToken);
            }
            if (requestInfo == this.priorityRequestInfo) {
                if (BuildVars.DEBUG_VERSION) {
                    FileLog.m105d("frame get request completed " + this.priorityRequestInfo.offset);
                }
                this.priorityRequestInfo = null;
            }
            if (tLRPC$TL_error != null) {
