...
public class ChatObject {
    ...
    public static String getAllowedSendString(TLRPC$Chat tLRPC$Chat) {
        ...
        if (canSendPhoto(tLRPC$Chat)) {
            sb.append(LocaleController.getString("SendMediaPermissionPhotos", C3316R.string.SendMediaPermissionPhotos));
        }
        if (canSendVideo(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("SendMediaPermissionVideos", C3316R.string.SendMediaPermissionVideos));
        }
        if (canSendStickers(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("SendMediaPermissionStickersGifs", C3316R.string.SendMediaPermissionStickersGifs));
        }
        if (canSendGifs(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getInternalString(C3316R.string.user_restrictions_send_gifs));
        }
        if (canSendGames(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getInternalString(C3316R.string.user_restrictions_send_games));
        }
        if (canSendInline(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getInternalString(C3316R.string.user_restrictions_send_inline));
        }
        if (canSendMusic(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("SendMediaPermissionMusic", C3316R.string.SendMediaPermissionMusic));
        }
        if (canSendDocument(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("SendMediaPermissionFiles", C3316R.string.SendMediaPermissionFiles));
        }
        if (canSendVoice(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("SendMediaPermissionVoice", C3316R.string.SendMediaPermissionVoice));
        }
        if (canSendRoundVideo(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("SendMediaPermissionRound", C3316R.string.SendMediaPermissionRound));
        }
        if (canSendEmbed(tLRPC$Chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("SendMediaEmbededLinks", C3316R.string.SendMediaEmbededLinks));
        }
        return sb.toString();
    }
    ...
    public static class Call {
        ...
        private final Runnable updateCurrentSpeakingRunnable = new Runnable() { // from class: org.telegram.messenger.ChatObject.Call.1
            ...
            public void run() {
                ...
                while (i < Call.this.currentSpeakingPeers.size()) {
                    ...
                    if (uptimeMillis - Call.this.currentSpeakingPeers.get(keyAt).lastSpeakTime >= 500) {
                        ...
                        if (keyAt > 0) {
                            ...
                            Log.m812d("GroupCall", sb.toString());
                        } else {
                            ...
                            Log.m812d("GroupCall", sb2.toString());
                        }
                        i--;
                        z = true;
                    }
                ...
                if (z) {
                    Call.this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(Call.this.chatId), Long.valueOf(Call.this.call.f1517id), Boolean.FALSE);
                }
            }
        };
        ...
        public /* synthetic */ void lambda$createRtmpStreamParticipant$1() {
            this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1517id), Boolean.FALSE);
        }
        ...
        public void migrateToChat(TLRPC$Chat tLRPC$Chat) {
            this.chatId = tLRPC$Chat.f1502id;
            VoIPService sharedInstance = VoIPService.getSharedInstance();
            if (sharedInstance == null || sharedInstance.getAccount() != this.currentAccount.getCurrentAccount() || sharedInstance.getChat() == null || sharedInstance.getChat().f1502id != (-this.chatId)) {
                return;
            }
        ...
        public void processVoiceLevelsUpdate(int[] iArr, float[] fArr, boolean[] zArr) {
                    ...
                    if (fArr[i3] > 0.1f) {
                        ...
                        if (uptimeMillis - tLRPC$TL_groupCallParticipant.lastSpeakTime < 500 || this.currentSpeakingPeers.get(peerId, null) == null) {
                            ...
                            if (peerId > 0) {
                                ...
                                Log.m812d("GroupCall", sb3.toString());
                            } else {
                                ...
                                Log.m812d("GroupCall", sb4.toString());
                            }
                            z4 = true;
                        }
            ...
            if (z6) {
                ...
                this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1517id), Boolean.FALSE);
            }
        }

        public void updateVisibleParticipants() {
            sortParticipants();
            this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1517id), Boolean.FALSE, 0L);
        }
        ...
        */
        ...
        public TLRPC$TL_inputGroupCall getInputGroupCall() {
            ...
            TLRPC$GroupCall tLRPC$GroupCall = this.call;
            tLRPC$TL_inputGroupCall.f1565id = tLRPC$GroupCall.f1517id;
    ...
    public static boolean canDeleteTopic(int i, TLRPC$Chat tLRPC$Chat, int i2) {
        return (i2 == 1 || tLRPC$Chat == null || !canDeleteTopic(i, tLRPC$Chat, MessagesController.getInstance(i).getTopicsController().findTopic(tLRPC$Chat.f1502id, i2))) ? false : true;
    }
    ...
    public static boolean canDeleteTopic(int i, TLRPC$Chat tLRPC$Chat, TLRPC$TL_forumTopic tLRPC$TL_forumTopic) {
        ...
        if (tLRPC$TL_forumTopic == null || tLRPC$TL_forumTopic.f1555id != 1) {
            if (!canUserDoAction(tLRPC$Chat, 13)) {
                ...
                int i2 = tLRPC$Message.f1526id - tLRPC$Message2.f1526id;
    ...
    public static boolean isMyTopic(int i, TLRPC$TL_forumTopic tLRPC$TL_forumTopic) {
        if (tLRPC$TL_forumTopic != null) {
            if (!tLRPC$TL_forumTopic.f1556my) {
    ...
    public static boolean isMyTopic(int i, TLRPC$Chat tLRPC$Chat, int i2) {
        return tLRPC$Chat != null && tLRPC$Chat.forum && isMyTopic(i, tLRPC$Chat.f1502id, i2);
    }
    ...
    public static String getRestrictedErrorText(TLRPC$Chat tLRPC$Chat, int i) {
        if (i == 23) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachGifRestricted", C3316R.string.GlobalAttachGifRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachGifRestrictedForever", C3316R.string.AttachGifRestrictedForever, new Object[0]) : LocaleController.formatString("AttachGifRestricted", C3316R.string.AttachGifRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 8) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachStickersRestricted", C3316R.string.GlobalAttachStickersRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachStickersRestrictedForever", C3316R.string.AttachStickersRestrictedForever, new Object[0]) : LocaleController.formatString("AttachStickersRestricted", C3316R.string.AttachStickersRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 16) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachPhotoRestricted", C3316R.string.GlobalAttachPhotoRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachPhotoRestrictedForever", C3316R.string.AttachPhotoRestrictedForever, new Object[0]) : LocaleController.formatString("AttachPhotoRestricted", C3316R.string.AttachPhotoRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 17) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachVideoRestricted", C3316R.string.GlobalAttachVideoRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachVideoRestrictedForever", C3316R.string.AttachVideoRestrictedForever, new Object[0]) : LocaleController.formatString("AttachVideoRestricted", C3316R.string.AttachVideoRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 19) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachDocumentsRestricted", C3316R.string.GlobalAttachDocumentsRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachDocumentsRestrictedForever", C3316R.string.AttachDocumentsRestrictedForever, new Object[0]) : LocaleController.formatString("AttachDocumentsRestricted", C3316R.string.AttachDocumentsRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 7) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachMediaRestricted", C3316R.string.GlobalAttachMediaRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachMediaRestrictedForever", C3316R.string.AttachMediaRestrictedForever, new Object[0]) : LocaleController.formatString("AttachMediaRestricted", C3316R.string.AttachMediaRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 18) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachAudioRestricted", C3316R.string.GlobalAttachAudioRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachAudioRestrictedForever", C3316R.string.AttachAudioRestrictedForever, new Object[0]) : LocaleController.formatString("AttachAudioRestricted", C3316R.string.AttachAudioRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 22) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachPlainRestricted", C3316R.string.GlobalAttachPlainRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachPlainRestrictedForever", C3316R.string.AttachPlainRestrictedForever, new Object[0]) : LocaleController.formatString("AttachPlainRestricted", C3316R.string.AttachPlainRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 21) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachRoundRestricted", C3316R.string.GlobalAttachRoundRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachRoundRestrictedForever", C3316R.string.AttachRoundRestrictedForever, new Object[0]) : LocaleController.formatString("AttachRoundRestricted", C3316R.string.AttachRoundRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else if (i == 20) {
            if (tLRPC$Chat == null || isActionBannedByDefault(tLRPC$Chat, i)) {
                return LocaleController.getString("GlobalAttachVoiceRestricted", C3316R.string.GlobalAttachVoiceRestricted);
            }
            return AndroidUtilities.isBannedForever(tLRPC$Chat.banned_rights) ? LocaleController.formatString("AttachVoiceRestrictedForever", C3316R.string.AttachVoiceRestrictedForever, new Object[0]) : LocaleController.formatString("AttachVoiceRestricted", C3316R.string.AttachVoiceRestricted, LocaleController.formatDateForBan(tLRPC$Chat.banned_rights.until_date));
        } else {
            return "";
        }
    }
