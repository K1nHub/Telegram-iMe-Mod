...
public class UserNameResolver {
    ...
    public void resolve(final String str, Consumer<Long> consumer) {
        ...
        if (cachedPeer != null) {
            if (System.currentTimeMillis() - cachedPeer.time < CACHE_TIME) {
                ...
                FileLog.m105d("resolve username from cache " + str + " " + cachedPeer.peerId);
                return;
            }
    ...
    public /* synthetic */ void lambda$resolve$0(String str, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (tLRPC$TL_error != null) {
            ...
            BulletinFactory.m65of(lastFragment).createErrorBulletin(LocaleController.getString("FloodWait", C3632R.string.FloodWait)).show();
            return;
        }
    ...
    public void update(TLRPC$User tLRPC$User, TLRPC$User tLRPC$User2) {
        ...
        if (str2 != null) {
            this.resolvedCache.put(str2, new CachedPeer(tLRPC$User2.f1751id));
        }
    }
