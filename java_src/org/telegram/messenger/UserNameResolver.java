...
public class UserNameResolver {
    ...
    public /* synthetic */ void lambda$resolve$0(String str, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (tLRPC$TL_error != null) {
            ...
            BulletinFactory.m32of(lastFragment).createErrorBulletin(LocaleController.getString("FloodWait", C3419R.string.FloodWait)).show();
            return;
        }
    ...
    public void update(TLRPC$User tLRPC$User, TLRPC$User tLRPC$User2) {
        ...
        if (str2 != null) {
            this.resolvedCache.put(str2, new CachedPeer(tLRPC$User2.f1675id));
        }
    }
    ...
    public void update(TLRPC$Chat tLRPC$Chat, TLRPC$Chat tLRPC$Chat2) {
        ...
        if (str2 != null) {
            this.resolvedCache.put(str2, new CachedPeer(-tLRPC$Chat2.f1518id));
        }
    }
