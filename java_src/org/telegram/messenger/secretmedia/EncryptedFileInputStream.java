...
public class EncryptedFileInputStream extends FileInputStream {
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (this.currentMode == 1 && this.fileOffset == 0) {
            ...
            Utilities.aesCbcEncryptionByteArraySafe(bArr, this.key, this.f1498iv, i, i2, this.fileOffset, 0);
            this.fileOffset += 32;
            skip((bArr2[0] & 255) - 32);
        }
        ...
        if (i3 == 1) {
            ...
            Utilities.aesCtrDecryptionByteArray(bArr, this.key, this.f1498iv, i, i2, this.fileOffset);
        }
        this.fileOffset += i2;
        return read;
    }
