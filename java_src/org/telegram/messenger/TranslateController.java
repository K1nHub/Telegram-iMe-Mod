...
public class TranslateController extends BaseController {
    ...
    public static ArrayList<Language> getLanguages() {
        ...
        for (int i = 0; i < allLanguages.size(); i++) {
            ...
            if (language.displayName != null) {
                ...
                sb.append(str2);
                language.f1469q = sb.toString().toLowerCase();
        ...
        while (it.hasNext()) {
            ...
            if (!TextUtils.equals(next, str) && (!"no".equals(str) || !"nb".equals(next))) {
                if (!"nb".equals(str) || !"no".equals(next)) {
                    ...
                    language.ownDisplayName = TranslateAlert2.capitalFirst(TranslateAlert2.systemLanguageName(language.code, true));
                    if (language.displayName != null) {
                        language.f1469q = (language.displayName + " " + language.ownDisplayName).toLowerCase();
                        arrayList.add(language);
                    }
                }
            }
        ...
        if (isTranslatable(messageObject)) {
            ...
            if (z && isTranslatingDialog(dialogId)) {
                ...
                if (tLRPC$Message4.translatedText == null || !dialogTranslateTo.equals(tLRPC$Message4.translatedToLanguage)) {
                    ...
                    pushToTranslate(messageObject, dialogTranslateTo, new Utilities.Callback2() { // from class: org.telegram.messenger.TranslateController$$ExternalSyntheticLambda16
    ...
    public /* synthetic */ void lambda$checkLanguage$12(final MessageObject messageObject, final long j, final int i) {
        LanguageDetector.detectLanguage(messageObject.messageOwner.message, new LanguageDetector.StringCallback() { // from class: org.telegram.messenger.TranslateController$$ExternalSyntheticLambda15
            @Override // org.telegram.messenger.LanguageDetector.StringCallback
            public final void run(String str) {
                TranslateController.this.lambda$checkLanguage$9(messageObject, j, i, str);
            }
        }, new LanguageDetector.ExceptionCallback() { // from class: org.telegram.messenger.TranslateController$$ExternalSyntheticLambda14
    ...
    private void checkDialogTranslatable(MessageObject messageObject) {
        ...
        z = (!isTranslatable(messageObject) || (str = messageObject.messageOwner.originalLanguage) == null || "und".equals(str) || RestrictedLanguagesSelectActivity.getRestrictedLanguages().contains(messageObject.messageOwner.originalLanguage) || TextUtils.equals(getDialogTranslateTo(dialogId), messageObject.messageOwner.originalLanguage)) ? false : false;
        if (z2) {
    ...
    public /* synthetic */ void lambda$pushToTranslate$16(final long j, final PendingTranslation pendingTranslation) {
        ...
        tLRPC$TL_messages_translateText.f1603id = pendingTranslation.messageIds;
    ...
    public /* synthetic */ void lambda$pushToTranslate$14(PendingTranslation pendingTranslation, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error, long j) {
        ...
        if (tLObject instanceof TLRPC$TL_messages_translateResult) {
            ...
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.showBulletin, 1, LocaleController.getString("TranslationFailedAlert2", C3158R.string.TranslationFailedAlert2));
        } else {
