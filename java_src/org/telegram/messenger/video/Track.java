...
public class Track {
    ...
    static {
        ...
        samplingFrequencyIndexMap.put(Integer.valueOf((int) OpusUtil.SAMPLE_RATE), 3);
        samplingFrequencyIndexMap.put(44100, 4);
        samplingFrequencyIndexMap.put(32000, 5);
        samplingFrequencyIndexMap.put(24000, 6);
        samplingFrequencyIndexMap.put(22050, 7);
        samplingFrequencyIndexMap.put(Integer.valueOf((int) AacUtil.AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND), 8);
    ...
    public Track(int i, MediaFormat mediaFormat, boolean z) {
        ...
        if (MimeTypes.AUDIO_MPEG.equals(string2)) {
        ...
        if (mediaFormat.containsKey(MediaFormatUtil.KEY_MAX_BIT_RATE)) {
            decoderConfigDescriptor.setMaxBitRate(mediaFormat.getInteger(MediaFormatUtil.KEY_MAX_BIT_RATE));
        } else {
    ...
    public void prepare() {
        ...
        for (i = 1; i < arrayList.size(); i++) {
            ((SamplePresentationTime) arrayList.get(i)).f1484dt = this.sampleDurations[i] + ((SamplePresentationTime) arrayList.get(i - 1)).f1484dt;
        }
        if (z) {
            ...
            for (int i3 = 0; i3 < this.samplePresentationTimes.size(); i3++) {
                ...
                this.sampleCompositions[samplePresentationTime2.index] = (int) (samplePresentationTime2.presentationTime - samplePresentationTime2.f1484dt);
            }
        }
    }
