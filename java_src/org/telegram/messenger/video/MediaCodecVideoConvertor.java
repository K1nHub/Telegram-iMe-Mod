...
public class MediaCodecVideoConvertor {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Unreachable block: B:432:0x08b8
        	at jadx.core.dex.visitors.blocks.BlockProcessor.checkForUnreachableBlocks(BlockProcessor.java:81)
        	at jadx.core.dex.visitors.blocks.BlockProcessor.processBlocksTree(BlockProcessor.java:47)
        	at jadx.core.dex.visitors.blocks.BlockProcessor.visit(BlockProcessor.java:39)
        */
    private boolean convertVideoInternal(java.lang.String r74, java.io.File r75, int r76, boolean r77, int r78, int r79, int r80, int r81, int r82, int r83, int r84, long r85, long r87, long r89, long r91, boolean r93, boolean r94, org.telegram.messenger.MediaController.SavedFilterState r95, java.lang.String r96, java.util.ArrayList<org.telegram.messenger.VideoEditedInfo.MediaEntity> r97, boolean r98, org.telegram.messenger.MediaController.CropState r99, boolean r100, java.lang.Integer r101, java.lang.Integer r102, boolean r103, boolean r104, org.telegram.p043ui.Stories.recorder.StoryEntry.HDRInfo r105, java.util.ArrayList<org.telegram.p043ui.Stories.recorder.StoryEntry.Part> r106, int r107) {
        /*
    ...
    */
    ...
    private static String hdrFragmentShader(int i, int i2, int i3, int i4, boolean z, StoryEntry.HDRInfo hDRInfo) {
        ...
        if (z) {
            if (hDRInfo.getHDRType() == 1) {
                ...
                readRes = RLottieDrawable.readRes(null, C3419R.raw.yuv_pq2rgb);
            }
    ...
    private static String createFragmentShader(int i, int i2, int i3, int i4, boolean z, int i5) {
        ...
        FileLog.m70d("source size " + i + "x" + i2 + "    dest size " + i3 + i4 + "   kernelRadius " + min);
        if (z) {
