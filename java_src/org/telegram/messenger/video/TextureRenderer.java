        ...
        if (this.stickerTexture != null) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                ...
                if (j != 0) {
                    ...
                    drawTexture(false, this.stickerTexture[0], mediaEntity.f1492x, mediaEntity.f1493y, mediaEntity.width, mediaEntity.height, mediaEntity.rotation, (mediaEntity.subType & 2) != 0);
