...
public class TextureRenderer {
        ...
        if (this.stickerTexture != null) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                ...
                if (j != 0) {
                    ...
                    drawTexture(false, this.stickerTexture[0], mediaEntity.f1471x, mediaEntity.f1472y, mediaEntity.width, mediaEntity.height, mediaEntity.rotation, (mediaEntity.subType & 2) != 0);
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:170:0x0204 A[SYNTHETIC] */
