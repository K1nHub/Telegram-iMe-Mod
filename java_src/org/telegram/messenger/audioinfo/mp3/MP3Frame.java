...
public class MP3Frame {
    ...
    public static class Header {
        ...
        private static final int[][] FREQUENCIES = {new int[]{11025, -1, 22050, 44100}, new int[]{12000, -1, 24000, OpusUtil.SAMPLE_RATE}, new int[]{8000, -1, AacUtil.AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND, 32000}, new int[]{-1, -1, -1, -1}};
        private static final int[][] BITRATES = {new int[]{0, 0, 0, 0, 0}, new int[]{32000, 32000, 32000, 32000, 8000}, new int[]{64000, OpusUtil.SAMPLE_RATE, 40000, OpusUtil.SAMPLE_RATE, AacUtil.AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND}, new int[]{96000, 56000, OpusUtil.SAMPLE_RATE, 56000, 24000}, new int[]{128000, 64000, 56000, 64000, 32000}, new int[]{160000, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND, 64000, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND, 40000}, new int[]{DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 96000, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND, 96000, OpusUtil.SAMPLE_RATE}, new int[]{224000, 112000, 96000, 112000, 56000}, new int[]{AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 128000, 112000, 128000, 64000}, new int[]{288000, 160000, 128000, 144000, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND}, new int[]{320000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 160000, 160000, 96000}, new int[]{352000, 224000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 176000, 112000}, new int[]{384000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 224000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 128000}, new int[]{416000, 320000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 224000, 144000}, new int[]{448000, 384000, 320000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 160000}, new int[]{-1, -1, -1, -1, -1}};
