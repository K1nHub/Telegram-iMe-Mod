    ...
    */
    ...
    void parseFrame(ID3v2FrameBody iD3v2FrameBody) throws IOException, ID3v2Exception {
        ...
        switch (frameId.hashCode()) {
            ...
            case 84125:
                ...
                break;
            case 2015625:
                if (frameId.equals(ApicFrame.f112ID)) {
                    c = 16;
                    break;
                }
                break;
            case 2074380:
                if (frameId.equals(CommentFrame.f115ID)) {
                    c = 17;
                    break;
                }
                break;
        ...
        switch (c) {
            ...
            case 5:
            case 19:
                this.compilation = IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(parseTextFrame(iD3v2FrameBody));
                return;
            case 6:
            case 22:
    ...
    AttachedPicture parseAttachedPictureFrame(ID3v2FrameBody iD3v2FrameBody) throws IOException, ID3v2Exception {
        ...
        if (iD3v2FrameBody.getTagHeader().getVersion() == 2) {
            ...
            upperCase.hashCode();
            readZeroTerminatedString = !upperCase.equals("JPG") ? !upperCase.equals("PNG") ? "image/unknown" : "image/png" : MimeTypes.IMAGE_JPEG;
        } else {
