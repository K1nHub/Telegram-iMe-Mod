...
public final class ForkRecycleItemWalletAccountSettingsBinding implements ViewBinding {
    ...
    public static ForkRecycleItemWalletAccountSettingsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3558R.layout.fork_recycle_item_wallet_account_settings, viewGroup, false);
        if (z) {
    ...
    public static ForkRecycleItemWalletAccountSettingsBinding bind(View view) {
        int i = C3558R.C3561id.frame_image_container;
        FrameLayout frameLayout = (FrameLayout) ViewBindings.findChildViewById(view, i);
        if (frameLayout != null) {
            i = C3558R.C3561id.image_backup_status;
            AppCompatImageView appCompatImageView = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
            if (appCompatImageView != null) {
                i = C3558R.C3561id.image_icon;
                AppCompatImageView appCompatImageView2 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                if (appCompatImageView2 != null) {
                    LinearLayout linearLayout = (LinearLayout) view;
                    i = C3558R.C3561id.text_setting_description;
                    AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                    if (appCompatTextView != null) {
                        i = C3558R.C3561id.text_setting_title;
