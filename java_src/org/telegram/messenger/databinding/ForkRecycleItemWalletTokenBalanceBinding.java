...
public final class ForkRecycleItemWalletTokenBalanceBinding implements ViewBinding {
    ...
    public static ForkRecycleItemWalletTokenBalanceBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3301R.layout.fork_recycle_item_wallet_token_balance, viewGroup, false);
        if (z) {
                                                    ...
                                                    if (appCompatTextView6 != null) {
                                                        ...
                                                        if (appCompatTextView7 != null) {
                                                            ...
                                                            if (coinTickerView != null) {
                                                                i = C3301R.C3304id.text_staking_end_title;
                                                                AppCompatTextView appCompatTextView8 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                if (appCompatTextView8 != null) {
                                                                    i = C3301R.C3304id.text_staking_end_value;
                                                                    AppCompatTextView appCompatTextView9 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                    if (appCompatTextView9 != null) {
                                                                        i = C3301R.C3304id.text_trade_pair;
                                                                        AppCompatTextView appCompatTextView10 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                        if (appCompatTextView10 != null) {
                                                                            i = C3301R.C3304id.text_trade_percent;
                                                                            AppCompatTextView appCompatTextView11 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                            if (appCompatTextView11 != null) {
                                                                                i = C3301R.C3304id.text_trade_price;
