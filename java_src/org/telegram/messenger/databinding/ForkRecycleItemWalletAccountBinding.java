...
public final class ForkRecycleItemWalletAccountBinding implements ViewBinding {
    ...
    private ForkRecycleItemWalletAccountBinding(FrameLayout frameLayout, CardView cardView, FrameLayout frameLayout2, HorizontalActionButtonsView horizontalActionButtonsView, BackupImageView backupImageView, AppCompatImageView appCompatImageView, ActionBarMenuItem actionBarMenuItem, AppCompatTextView appCompatTextView, AppCompatTextView appCompatTextView2, DividerView dividerView) {
    ...
    public static ForkRecycleItemWalletAccountBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3558R.layout.fork_recycle_item_wallet_account, viewGroup, false);
        if (z) {
    ...
    public static ForkRecycleItemWalletAccountBinding bind(View view) {
        int i = C3558R.C3561id.card_crypto_account;
        ...
        if (cardView != null) {
            ...
            if (horizontalActionButtonsView != null) {
                i = C3558R.C3561id.image_account_avatar;
                ...
                if (backupImageView != null) {
                    ...
                    if (appCompatImageView != null) {
                        ...
                        if (actionBarMenuItem != null) {
                            i = C3558R.C3561id.text_account_id;
                            AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                            if (appCompatTextView != null) {
                                i = C3558R.C3561id.text_account_name;
                                AppCompatTextView appCompatTextView2 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                if (appCompatTextView2 != null) {
                                    i = C3558R.C3561id.view_divider;
                                    DividerView dividerView = (DividerView) ViewBindings.findChildViewById(view, i);
                                    if (dividerView != null) {
                                        return new ForkRecycleItemWalletAccountBinding(frameLayout, cardView, frameLayout, horizontalActionButtonsView, backupImageView, appCompatImageView, actionBarMenuItem, appCompatTextView, appCompatTextView2, dividerView);
                                    }
                                }
                            }
                        }
