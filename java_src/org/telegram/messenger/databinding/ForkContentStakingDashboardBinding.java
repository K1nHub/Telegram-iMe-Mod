...
public final class ForkContentStakingDashboardBinding implements ViewBinding {
    ...
    public static ForkContentStakingDashboardBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3301R.layout.fork_content_staking_dashboard, viewGroup, false);
        if (z) {
    ...
    public static ForkContentStakingDashboardBinding bind(View view) {
        ...
        int i = C3301R.C3304id.card_staking_dashboard;
        CardView cardView = (CardView) ViewBindings.findChildViewById(view, i);
        if (cardView != null) {
            i = C3301R.C3304id.divider;
            ...
            if (dividerView != null) {
                ...
                if (horizontalActionButtonsView != null) {
                    i = C3301R.C3304id.linear_profit;
                    LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(view, i);
                    if (linearLayout != null) {
                        i = C3301R.C3304id.linear_staked;
                        LinearLayout linearLayout2 = (LinearLayout) ViewBindings.findChildViewById(view, i);
                        if (linearLayout2 != null) {
                            i = C3301R.C3304id.text_header;
                            AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                            if (appCompatTextView != null) {
                                i = C3301R.C3304id.text_profit_title;
                                TextView textView = (TextView) ViewBindings.findChildViewById(view, i);
                                if (textView != null) {
                                    i = C3301R.C3304id.text_profit_value;
                                    TextView textView2 = (TextView) ViewBindings.findChildViewById(view, i);
                                    if (textView2 != null) {
                                        i = C3301R.C3304id.text_staked_title;
                                        TextView textView3 = (TextView) ViewBindings.findChildViewById(view, i);
                                        if (textView3 != null) {
                                            i = C3301R.C3304id.text_staked_value;
                                            TextView textView4 = (TextView) ViewBindings.findChildViewById(view, i);
                                            if (textView4 != null) {
                                                i = C3301R.C3304id.view_diagram;
                                                StorageDiagramView storageDiagramView = (StorageDiagramView) ViewBindings.findChildViewById(view, i);
                                                if (storageDiagramView != null && (findChildViewById = ViewBindings.findChildViewById(view, (i = C3301R.C3304id.view_profit_dot))) != null && (findChildViewById2 = ViewBindings.findChildViewById(view, (i = C3301R.C3304id.view_staked_dot))) != null) {
