...
public final class ForkFragmentBlockchainsManagementBinding implements ViewBinding {
    ...
    public static ForkFragmentBlockchainsManagementBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3419R.layout.fork_fragment_blockchains_management, viewGroup, false);
        if (z) {
    ...
    public static ForkFragmentBlockchainsManagementBinding bind(View view) {
        int i = C3419R.C3422id.button_reset_all;
            ...
            if (rLottieImageView != null) {
                ...
                if (linearLayout != null) {
                    ...
                    if (linearLayout2 != null) {
                        i = C3419R.C3422id.linear_wallets;
                        LinearLayout linearLayout3 = (LinearLayout) ViewBindings.findChildViewById(view, i);
                        if (linearLayout3 != null) {
                            i = C3419R.C3422id.recycle_wallets;
                            RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(view, i);
                            if (recyclerView != null) {
                                i = C3419R.C3422id.text_description;
                                AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                if (appCompatTextView != null) {
                                    i = C3419R.C3422id.text_wallets_title;
