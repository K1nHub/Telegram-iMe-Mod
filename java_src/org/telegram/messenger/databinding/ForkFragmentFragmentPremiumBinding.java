...
public final class ForkFragmentFragmentPremiumBinding implements ViewBinding {
    ...
    public static ForkFragmentFragmentPremiumBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3630R.layout.fork_fragment_fragment_premium, viewGroup, false);
        if (z) {
    ...
    public static ForkFragmentFragmentPremiumBinding bind(View view) {
        int i = C3630R.C3633id.button_back;
        ActionBarMenuItem actionBarMenuItem = (ActionBarMenuItem) ViewBindings.findChildViewById(view, i);
        if (actionBarMenuItem != null) {
            i = C3630R.C3633id.card_view;
            CardView cardView = (CardView) ViewBindings.findChildViewById(view, i);
            if (cardView != null) {
                i = C3630R.C3633id.frame_button_container;
                FrameLayout frameLayout = (FrameLayout) ViewBindings.findChildViewById(view, i);
                if (frameLayout != null) {
                    i = C3630R.C3633id.frame_premium_star_container;
                    FrameLayout frameLayout2 = (FrameLayout) ViewBindings.findChildViewById(view, i);
                    if (frameLayout2 != null) {
                        i = C3630R.C3633id.image_recipient_icon;
                        ...
                        if (appCompatImageView != null) {
                            ...
                            if (backupImageView != null) {
                                ...
                                if (nestedScrollView != null) {
                                    i = C3630R.C3633id.recycler_products;
                                    RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(view, i);
                                    if (recyclerView != null) {
                                        i = C3630R.C3633id.text_balance;
                                        TextView textView = (TextView) ViewBindings.findChildViewById(view, i);
                                        if (textView != null) {
                                            i = C3630R.C3633id.text_duration_title;
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            ...
                                                            if (textView6 != null) {
                                                                i = C3630R.C3633id.view_recipient;
