...
public final class ForkRecycleItemCatalogChannelBinding implements ViewBinding {
    ...
    public static ForkRecycleItemCatalogChannelBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3558R.layout.fork_recycle_item_catalog_channel, viewGroup, false);
        if (z) {
    ...
    public static ForkRecycleItemCatalogChannelBinding bind(View view) {
        ...
        if (cardView != null) {
            i = C3558R.C3561id.constraint_info;
            ConstraintLayout constraintLayout = (ConstraintLayout) ViewBindings.findChildViewById(view, i);
            if (constraintLayout != null) {
                FrameLayout frameLayout = (FrameLayout) view;
                i = C3558R.C3561id.image_avatar;
                AppCompatImageView appCompatImageView = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                if (appCompatImageView != null) {
                    i = C3558R.C3561id.image_verified;
                    ...
                    if (appCompatImageView2 != null) {
                        ...
                        if (appCompatTextView != null) {
                            ...
                            if (appCompatTextView2 != null) {
                                i = C3558R.C3561id.text_subscribers_count;
                                AppCompatTextView appCompatTextView3 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                if (appCompatTextView3 != null) {
                                    i = C3558R.C3561id.topic;
