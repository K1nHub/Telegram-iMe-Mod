...
public final class ForkWalletBackupPdfTemplateBinding implements ViewBinding {
    ...
    public static ForkWalletBackupPdfTemplateBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3473R.layout.fork_wallet_backup_pdf_template, viewGroup, false);
        if (z) {
    ...
    public static ForkWalletBackupPdfTemplateBinding bind(View view) {
        int i = C3473R.C3476id.image_qr;
        AppCompatImageView appCompatImageView = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
        if (appCompatImageView != null) {
            i = C3473R.C3476id.text_column_left;
            TextView textView = (TextView) ViewBindings.findChildViewById(view, i);
            if (textView != null) {
                i = C3473R.C3476id.text_column_right;
                TextView textView2 = (TextView) ViewBindings.findChildViewById(view, i);
                if (textView2 != null) {
                    i = C3473R.C3476id.text_wallet_address;
