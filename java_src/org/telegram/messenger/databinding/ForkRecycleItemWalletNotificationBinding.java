...
public final class ForkRecycleItemWalletNotificationBinding implements ViewBinding {
    ...
    public static ForkRecycleItemWalletNotificationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3630R.layout.fork_recycle_item_wallet_notification, viewGroup, false);
        if (z) {
    ...
    public static ForkRecycleItemWalletNotificationBinding bind(View view) {
        ...
        if (dividerView != null) {
            ...
            i = C3630R.C3633id.text_notification_category;
            AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
            if (appCompatTextView != null) {
                i = C3630R.C3633id.text_notification_date;
                AppCompatTextView appCompatTextView2 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                if (appCompatTextView2 != null) {
                    i = C3630R.C3633id.text_notification_message;
                    AppCompatTextView appCompatTextView3 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                    if (appCompatTextView3 != null && (findChildViewById = ViewBindings.findChildViewById(view, (i = C3630R.C3633id.view_read_mark))) != null) {
