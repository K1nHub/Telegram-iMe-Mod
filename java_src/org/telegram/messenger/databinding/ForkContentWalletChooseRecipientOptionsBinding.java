...
public final class ForkContentWalletChooseRecipientOptionsBinding implements ViewBinding {
    ...
    public static ForkContentWalletChooseRecipientOptionsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3242R.layout.fork_content_wallet_choose_recipient_options, viewGroup, false);
        if (z) {
    ...
    public static ForkContentWalletChooseRecipientOptionsBinding bind(View view) {
        int i = C3242R.C3245id.frame_contacts;
        FrameLayout frameLayout = (FrameLayout) ViewBindings.findChildViewById(view, i);
        if (frameLayout != null) {
            i = C3242R.C3245id.frame_qr;
            FrameLayout frameLayout2 = (FrameLayout) ViewBindings.findChildViewById(view, i);
            if (frameLayout2 != null) {
                i = C3242R.C3245id.frame_twitter;
                FrameLayout frameLayout3 = (FrameLayout) ViewBindings.findChildViewById(view, i);
                if (frameLayout3 != null) {
                    i = C3242R.C3245id.text_contacts;
                    TextView textView = (TextView) ViewBindings.findChildViewById(view, i);
                    if (textView != null) {
                        i = C3242R.C3245id.text_qr;
                        TextView textView2 = (TextView) ViewBindings.findChildViewById(view, i);
                        if (textView2 != null) {
                            i = C3242R.C3245id.text_twitter;
