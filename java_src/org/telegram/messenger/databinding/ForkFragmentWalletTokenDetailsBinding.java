...
public final class ForkFragmentWalletTokenDetailsBinding implements ViewBinding {
    ...
    public static ForkFragmentWalletTokenDetailsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3630R.layout.fork_fragment_wallet_token_details, viewGroup, false);
        if (z) {
    ...
    public static ForkFragmentWalletTokenDetailsBinding bind(View view) {
        ...
        int i = C3630R.C3633id.account_rank_badge;
        ...
        if (accountLevelBadgeView != null) {
            i = C3630R.C3633id.appbar;
            AppBarLayout appBarLayout = (AppBarLayout) ViewBindings.findChildViewById(view, i);
            if (appBarLayout != null) {
                i = C3630R.C3633id.constraint_layout_header;
                ConstraintLayout constraintLayout = (ConstraintLayout) ViewBindings.findChildViewById(view, i);
                if (constraintLayout != null) {
                    i = C3630R.C3633id.coordinator;
                    CoordinatorLayout coordinatorLayout = (CoordinatorLayout) ViewBindings.findChildViewById(view, i);
                    if (coordinatorLayout != null && (findChildViewById = ViewBindings.findChildViewById(view, (i = C3630R.C3633id.divider_action_buttons))) != null && (findChildViewById2 = ViewBindings.findChildViewById(view, (i = C3630R.C3633id.divider_crypto))) != null && (findChildViewById3 = ViewBindings.findChildViewById(view, (i = C3630R.C3633id.divider_cryptobox_description))) != null && (findChildViewById4 = ViewBindings.findChildViewById(view, (i = C3630R.C3633id.divider_cryptobox_info))) != null && (findChildViewById5 = ViewBindings.findChildViewById(view, (i = C3630R.C3633id.divider_staking))) != null && (findChildViewById6 = ViewBindings.findChildViewById(view, (i = C3630R.C3633id.header_underlay))) != null) {
                        i = C3630R.C3633id.horizontal_action_buttons;
                        ...
                        if (horizontalActionButtonsView != null) {
                            i = C3630R.C3633id.image_cryptobox_info;
                            AppCompatImageView appCompatImageView = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                            if (appCompatImageView != null) {
                                i = C3630R.C3633id.image_logo;
                                AppCompatImageView appCompatImageView2 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                                if (appCompatImageView2 != null) {
                                    i = C3630R.C3633id.image_staking_info;
                                    AppCompatImageView appCompatImageView3 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                                    if (appCompatImageView3 != null) {
                                        i = C3630R.C3633id.item_back;
                                        ...
                                        if (actionBarMenuItem != null) {
                                            ...
                                            if (actionBarMenuItem2 != null) {
                                                ...
                                                if (linearLayout != null) {
                                                    i = C3630R.C3633id.linear_crypto_info;
                                                    LinearLayoutCompat linearLayoutCompat = (LinearLayoutCompat) ViewBindings.findChildViewById(view, i);
                                                    if (linearLayoutCompat != null) {
                                                        i = C3630R.C3633id.linear_cryptobox_description;
                                                        LinearLayoutCompat linearLayoutCompat2 = (LinearLayoutCompat) ViewBindings.findChildViewById(view, i);
                                                        if (linearLayoutCompat2 != null) {
                                                            i = C3630R.C3633id.linear_cryptobox_info;
                                                            LinearLayoutCompat linearLayoutCompat3 = (LinearLayoutCompat) ViewBindings.findChildViewById(view, i);
                                                            if (linearLayoutCompat3 != null) {
                                                                i = C3630R.C3633id.linear_header;
                                                                LinearLayout linearLayout2 = (LinearLayout) ViewBindings.findChildViewById(view, i);
                                                                if (linearLayout2 != null) {
                                                                    i = C3630R.C3633id.linear_staking_info;
                                                                    LinearLayoutCompat linearLayoutCompat4 = (LinearLayoutCompat) ViewBindings.findChildViewById(view, i);
                                                                    if (linearLayoutCompat4 != null) {
                                                                        i = C3630R.C3633id.text_crypto_wallet_address_title;
                                                                        AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                        if (appCompatTextView != null) {
                                                                            i = C3630R.C3633id.text_crypto_wallet_address_value;
                                                                            AppCompatTextView appCompatTextView2 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                            if (appCompatTextView2 != null) {
                                                                                i = C3630R.C3633id.text_cryptobox_description;
                                                                                AppCompatTextView appCompatTextView3 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                                if (appCompatTextView3 != null) {
                                                                                    i = C3630R.C3633id.text_cryptobox_description_title;
                                                                                    AppCompatTextView appCompatTextView4 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                                    if (appCompatTextView4 != null) {
                                                                                        i = C3630R.C3633id.text_cryptobox_info;
                                                                                        AppCompatTextView appCompatTextView5 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                                        if (appCompatTextView5 != null) {
                                                                                            i = C3630R.C3633id.text_staking_info;
