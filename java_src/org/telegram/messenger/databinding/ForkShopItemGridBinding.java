...
public final class ForkShopItemGridBinding implements ViewBinding {
    ...
    public static ForkShopItemGridBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3316R.layout.fork_shop_item_grid, viewGroup, false);
        if (z) {
    ...
    public static ForkShopItemGridBinding bind(View view) {
        int i = C3316R.C3319id.bot_avatar;
        ImageView imageView = (ImageView) ViewBindings.findChildViewById(view, i);
        if (imageView != null) {
            i = C3316R.C3319id.bot_installed_icon;
            ImageView imageView2 = (ImageView) ViewBindings.findChildViewById(view, i);
            if (imageView2 != null) {
                i = C3316R.C3319id.bot_name;
                TextView textView = (TextView) ViewBindings.findChildViewById(view, i);
                if (textView != null) {
                    i = C3316R.C3319id.bot_new_label;
                    TextView textView2 = (TextView) ViewBindings.findChildViewById(view, i);
                    if (textView2 != null) {
                        i = C3316R.C3319id.bot_status;
                        TextView textView3 = (TextView) ViewBindings.findChildViewById(view, i);
                        if (textView3 != null) {
                            i = C3316R.C3319id.layoutLabel;
