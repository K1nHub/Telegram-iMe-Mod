...
public final class ForkRecycleItemWalletTokensHeaderBinding implements ViewBinding {
    ...
    public static ForkRecycleItemWalletTokensHeaderBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3632R.layout.fork_recycle_item_wallet_tokens_header, viewGroup, false);
        if (z) {
    ...
    public static ForkRecycleItemWalletTokensHeaderBinding bind(View view) {
        int i = C3632R.C3635id.image_add_token;
        AppCompatImageView appCompatImageView = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
        if (appCompatImageView != null) {
            i = C3632R.C3635id.image_network;
            AppCompatImageView appCompatImageView2 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
            if (appCompatImageView2 != null) {
                i = C3632R.C3635id.linear_add_token;
                LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(view, i);
                if (linearLayout != null) {
                    i = C3632R.C3635id.linear_network;
                    ...
                    if (linearLayout2 != null) {
                        ...
                        if (networkTypeView != null) {
                            i = C3632R.C3635id.text_add_token;
                            AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                            if (appCompatTextView != null) {
                                i = C3632R.C3635id.text_network;
                                AppCompatTextView appCompatTextView2 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                if (appCompatTextView2 != null) {
                                    i = C3632R.C3635id.text_title_displayed_tokens;
