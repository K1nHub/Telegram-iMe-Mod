...
public final class ForkRecycleItemFoundTokenBinding implements ViewBinding {
    ...
    public static ForkRecycleItemFoundTokenBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3419R.layout.fork_recycle_item_found_token, viewGroup, false);
        if (z) {
    ...
    public static ForkRecycleItemFoundTokenBinding bind(View view) {
        ...
        int i = C3419R.C3422id.divider_horizontal;
        DividerView dividerView = (DividerView) ViewBindings.findChildViewById(view, i);
        if (dividerView != null && (findChildViewById = ViewBindings.findChildViewById(view, (i = C3419R.C3422id.divider_vertical))) != null) {
            i = C3419R.C3422id.image_network_icon;
            AppCompatImageView appCompatImageView = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
            if (appCompatImageView != null) {
                i = C3419R.C3422id.image_token_icon;
