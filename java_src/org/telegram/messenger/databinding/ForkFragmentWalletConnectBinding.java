...
public final class ForkFragmentWalletConnectBinding implements ViewBinding {
    ...
    public static ForkFragmentWalletConnectBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3286R.layout.fork_fragment_wallet_connect, viewGroup, false);
        if (z) {
                ...
                if (rLottieImageView != null) {
                    ...
                    if (linearLayout != null) {
                        ...
                        if (linearLayout2 != null) {
                            i = C3286R.C3289id.linear_sessions;
                            LinearLayout linearLayout3 = (LinearLayout) ViewBindings.findChildViewById(view, i);
                            if (linearLayout3 != null) {
                                i = C3286R.C3289id.recycle_sessions;
                                RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(view, i);
                                if (recyclerView != null) {
                                    i = C3286R.C3289id.text_description;
                                    AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                    if (appCompatTextView != null) {
                                        i = C3286R.C3289id.text_sessions_title;
