...
public final class ForkRecycleItemWalletCryptoTotalBalanceBinding implements ViewBinding {
    ...
    public static ForkRecycleItemWalletCryptoTotalBalanceBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3419R.layout.fork_recycle_item_wallet_crypto_total_balance, viewGroup, false);
        if (z) {
    ...
    public static ForkRecycleItemWalletCryptoTotalBalanceBinding bind(View view) {
        ...
        int i = C3419R.C3422id.image_wallet_crypto_eye;
        AppCompatImageView appCompatImageView = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
        if (appCompatImageView != null) {
            i = C3419R.C3422id.image_wallet_crypto_tokens_settings;
            AppCompatImageView appCompatImageView2 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
            if (appCompatImageView2 != null) {
                i = C3419R.C3422id.image_wallet_order_tokens;
                AppCompatImageView appCompatImageView3 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                if (appCompatImageView3 != null) {
                    i = C3419R.C3422id.text_wallet_crypto_total_balance;
