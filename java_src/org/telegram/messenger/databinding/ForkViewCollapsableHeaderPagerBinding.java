...
public final class ForkViewCollapsableHeaderPagerBinding implements ViewBinding {
    ...
    public static ForkViewCollapsableHeaderPagerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3634R.layout.fork_view_collapsable_header_pager, viewGroup, false);
        if (z) {
    ...
    public static ForkViewCollapsableHeaderPagerBinding bind(View view) {
        int i = C3634R.C3637id.appbar;
        AppBarLayout appBarLayout = (AppBarLayout) ViewBindings.findChildViewById(view, i);
        if (appBarLayout != null) {
            CoordinatorLayout coordinatorLayout = (CoordinatorLayout) view;
            i = C3634R.C3637id.frame_collapsing_content_container;
            FrameLayout frameLayout = (FrameLayout) ViewBindings.findChildViewById(view, i);
            if (frameLayout != null) {
                i = C3634R.C3637id.frame_pages_container;
                FrameLayout frameLayout2 = (FrameLayout) ViewBindings.findChildViewById(view, i);
                if (frameLayout2 != null) {
                    i = C3634R.C3637id.frame_tabs_container;
