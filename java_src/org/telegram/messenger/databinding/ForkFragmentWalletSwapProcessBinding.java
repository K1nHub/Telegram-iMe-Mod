...
public final class ForkFragmentWalletSwapProcessBinding implements ViewBinding {
    ...
    public static ForkFragmentWalletSwapProcessBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3473R.layout.fork_fragment_wallet_swap_process, viewGroup, false);
        if (z) {
    ...
    public static ForkFragmentWalletSwapProcessBinding bind(View view) {
        ...
        int i = C3473R.C3476id.constraint_input;
        ConstraintLayout constraintLayout = (ConstraintLayout) ViewBindings.findChildViewById(view, i);
        if (constraintLayout != null) {
            i = C3473R.C3476id.constraint_output;
            ConstraintLayout constraintLayout2 = (ConstraintLayout) ViewBindings.findChildViewById(view, i);
            if (constraintLayout2 != null) {
                i = C3473R.C3476id.edit_input_amount;
                AppCompatEditText appCompatEditText = (AppCompatEditText) ViewBindings.findChildViewById(view, i);
                if (appCompatEditText != null) {
                    i = C3473R.C3476id.edit_output_amount;
                    AppCompatEditText appCompatEditText2 = (AppCompatEditText) ViewBindings.findChildViewById(view, i);
                    if (appCompatEditText2 != null) {
                        i = C3473R.C3476id.fee_view;
                        FeeView feeView = (FeeView) ViewBindings.findChildViewById(view, i);
                        if (feeView != null) {
                            i = C3473R.C3476id.image_input_arrow;
                            AppCompatImageView appCompatImageView = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                            if (appCompatImageView != null) {
                                i = C3473R.C3476id.image_input_token;
                                AppCompatImageView appCompatImageView2 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                                if (appCompatImageView2 != null) {
                                    i = C3473R.C3476id.image_output_arrow;
                                    AppCompatImageView appCompatImageView3 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                                    if (appCompatImageView3 != null) {
                                        i = C3473R.C3476id.image_output_token;
                                        AppCompatImageView appCompatImageView4 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                                        if (appCompatImageView4 != null) {
                                            i = C3473R.C3476id.image_swap_protocol_logo;
                                            AppCompatImageView appCompatImageView5 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                                            if (appCompatImageView5 != null) {
                                                i = C3473R.C3476id.image_swap_tokens_positions;
                                                AppCompatImageView appCompatImageView6 = (AppCompatImageView) ViewBindings.findChildViewById(view, i);
                                                if (appCompatImageView6 != null) {
                                                    i = C3473R.C3476id.linear_content;
                                                    LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(view, i);
                                                    if (linearLayout != null) {
                                                        i = C3473R.C3476id.linear_input_token;
                                                        LinearLayout linearLayout2 = (LinearLayout) ViewBindings.findChildViewById(view, i);
                                                        if (linearLayout2 != null) {
                                                            i = C3473R.C3476id.linear_output_token;
                                                            LinearLayout linearLayout3 = (LinearLayout) ViewBindings.findChildViewById(view, i);
                                                            if (linearLayout3 != null) {
                                                                i = C3473R.C3476id.text_balance;
                                                                AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                if (appCompatTextView != null) {
                                                                    i = C3473R.C3476id.text_input_additional_description;
                                                                    AppCompatTextView appCompatTextView2 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                    if (appCompatTextView2 != null) {
                                                                        i = C3473R.C3476id.text_input_fiat;
                                                                        AppCompatTextView appCompatTextView3 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                        if (appCompatTextView3 != null) {
                                                                            i = C3473R.C3476id.text_input_title;
                                                                            AppCompatTextView appCompatTextView4 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                            if (appCompatTextView4 != null) {
                                                                                i = C3473R.C3476id.text_input_token;
                                                                                AppCompatTextView appCompatTextView5 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                                if (appCompatTextView5 != null) {
                                                                                    i = C3473R.C3476id.text_output_fiat;
                                                                                    AppCompatTextView appCompatTextView6 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                                    if (appCompatTextView6 != null) {
                                                                                        i = C3473R.C3476id.text_output_rate;
                                                                                        AppCompatTextView appCompatTextView7 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                                        if (appCompatTextView7 != null) {
                                                                                            i = C3473R.C3476id.text_output_title;
                                                                                            AppCompatTextView appCompatTextView8 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                                            if (appCompatTextView8 != null) {
                                                                                                i = C3473R.C3476id.text_output_token;
                                                                                                AppCompatTextView appCompatTextView9 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                                                                if (appCompatTextView9 != null) {
                                                                                                    i = C3473R.C3476id.text_swap_protocol_description;
                                                                                                    ...
                                                                                                    if (appCompatTextView10 != null) {
                                                                                                        ...
                                                                                                        if (transactionActionButtonsView != null && (findChildViewById = ViewBindings.findChildViewById(view, (i = C3473R.C3476id.view_divider_left))) != null && (findChildViewById2 = ViewBindings.findChildViewById(view, (i = C3473R.C3476id.view_divider_right))) != null) {
                                                                                                            i = C3473R.C3476id.view_input_network;
                                                                                                            NetworkTypeView networkTypeView = (NetworkTypeView) ViewBindings.findChildViewById(view, i);
                                                                                                            if (networkTypeView != null) {
                                                                                                                i = C3473R.C3476id.view_output_network;
