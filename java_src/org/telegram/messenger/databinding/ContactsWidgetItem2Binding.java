...
public final class ContactsWidgetItem2Binding implements ViewBinding {
    ...
    public static ContactsWidgetItem2Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3417R.layout.contacts_widget_item_2, viewGroup, false);
        if (z) {
    ...
    public static ContactsWidgetItem2Binding bind(View view) {
        ...
        int i = C3417R.C3420id.contacts_widget_item_avatar2;
        ImageView imageView = (ImageView) ViewBindings.findChildViewById(view, i);
        if (imageView != null) {
            i = C3417R.C3420id.contacts_widget_item_badge2;
            TextView textView = (TextView) ViewBindings.findChildViewById(view, i);
            if (textView != null) {
                i = C3417R.C3420id.contacts_widget_item_badge_bg2;
                FrameLayout frameLayout2 = (FrameLayout) ViewBindings.findChildViewById(view, i);
                if (frameLayout2 != null) {
                    i = C3417R.C3420id.contacts_widget_item_text2;
