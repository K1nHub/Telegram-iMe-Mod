...
public final class ForkBotsContentPageItemNormalBinding implements ViewBinding {
    ...
    public static ForkBotsContentPageItemNormalBinding inflate(LayoutInflater layoutInflater) {
    ...
    public static ForkBotsContentPageItemNormalBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C3419R.layout.fork_bots_content_page_item_normal, viewGroup, false);
        if (z) {
    ...
    public static ForkBotsContentPageItemNormalBinding bind(View view) {
        int i = C3419R.C3422id.normal_phrase;
        TextView textView = (TextView) ViewBindings.findChildViewById(view, i);
        if (textView != null) {
            i = C3419R.C3422id.normalPhraseLayout;
