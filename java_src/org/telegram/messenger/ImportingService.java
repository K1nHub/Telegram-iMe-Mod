...
public class ImportingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onDestroy() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m105d("destroy import service");
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m105d("start import service");
        }
        if (this.builder == null) {
            ...
            if (hasImportingHistory()) {
                ...
                int i3 = C3632R.string.ImporImportingService;
                ...
                int i4 = C3632R.string.ImporImportingStickersService;
