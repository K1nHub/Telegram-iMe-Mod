...
public class ImportingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onDestroy() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m52d("destroy import service");
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m52d("start import service");
        }
        if (this.builder == null) {
            ...
            if (hasImportingHistory()) {
                ...
                int i3 = C3295R.string.ImporImportingService;
                ...
                int i4 = C3295R.string.ImporImportingStickersService;
