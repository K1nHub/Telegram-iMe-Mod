    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        if (!sharedPreferences.getBoolean("deleted" + i, false)) {
            ...
            if (cellsForSize == 1 || ceil <= 1) {
                i2 = C3290R.layout.contacts_widget_layout_1;
            } else if (cellsForSize == 2 || ceil <= 2) {
                i2 = C3290R.layout.contacts_widget_layout_2;
            } else if (cellsForSize == 3 || ceil <= 3) {
                i2 = C3290R.layout.contacts_widget_layout_3;
            } else {
                i2 = C3290R.layout.contacts_widget_layout_4;
            }
        } else {
            i2 = C3290R.layout.contacts_widget_layout_1;
        }
