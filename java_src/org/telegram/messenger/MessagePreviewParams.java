...
public class MessagePreviewParams {
    ...
    public boolean isAuthorHiddenForce;
    ...
    public boolean wasMediaHidden;
    public boolean wasPreviewHidden;
    ...
    public class Messages {
        ...
        public ArrayList<MessageObject> copyForForwardingEditor() {
            ArrayList<MessageObject> arrayList = new ArrayList<>();
            getSelectedMessages(arrayList, true);
            return arrayList;
        }
        ...
        public Messages(Boolean bool, int i, ArrayList<MessageObject> arrayList, long j, SparseBooleanArray sparseBooleanArray) {
            ...
            while (i3 < arrayList.size()) {
                ...
                MessageObject previewMessage = MessagePreviewParams.this.toPreviewMessage(messageObject2, bool, i);
                if (!this.hasSpoilers) {
            ...
            if (longSparseArray != null && longSparseArray.size() > 0) {
                ...
                if (i7 == 0 || i7 == 19) {
                    this.hasText = !TextUtils.isEmpty(messageObject.messageText);
                } else {
                    this.hasText = !TextUtils.isEmpty(messageObject.caption);
                }
            }
        }
            ...
            for (int i = 0; i < arrayList2.size(); i++) {
                ...
                if (messageObject != null) {
                    if (this.selectedIds.get(messageObject.getId(), false)) {
                        if (z) {
                            arrayList.add(MessagePreviewParams.this.toPreviewMessage(messageObject, Boolean.TRUE, 0));
                        } else {
                            arrayList.add(messageObject);
                        }
                    }
    ...
    public MessageObject toPreviewMessage(MessageObject messageObject, Boolean bool, final int i) {
        ...
        messageObject3.attachPathExists = messageObject.attachPathExists;
        messageObject3.mediaExists = messageObject.mediaExists;
        messageObject3.hasPreview = messageObject.isWebpage();
