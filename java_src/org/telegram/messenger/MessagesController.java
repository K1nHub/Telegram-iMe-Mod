...
public class MessagesController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void lambda$completeReadTask$208(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }

    public static /* synthetic */ void lambda$deleteParticipantFromChat$263(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }

    public static /* synthetic */ void lambda$deleteParticipantFromChat$266(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }
    ...
    public static /* synthetic */ void lambda$hidePromoDialog$118(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }
    ...
    public static /* synthetic */ void lambda$markMentionMessageAsRead$202(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }

    public static /* synthetic */ void lambda$markMentionsAsRead$210(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }

    public static /* synthetic */ void lambda$markMessageContentAsRead$200(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }

    public static /* synthetic */ void lambda$markReactionsAsRead$359(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }

    public static /* synthetic */ void lambda$processUpdates$326(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }
    ...
    public static /* synthetic */ void lambda$unregistedPush$272(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }
    ...
    public void loadManagementBookmarks() {
        ...
        for (final BookmarksModel bookmarksModel : hashMap.values()) {
            ...
            if (chat == null) {
                ...
                ArrayList<MessageObject> loadPinnedMessages = getMediaDataController().loadPinnedMessages(-chat.f1427id, ChatObject.isChannel(chat) ? chat.f1427id : 0L, bookmarksModel.getMessageIds(), false, true, false, true);
                if (loadPinnedMessages != null && !loadPinnedMessages.isEmpty() && !chat.forum) {
                    Collections.sort(loadPinnedMessages, new Comparator() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda239
    ...
    public void readDialogs(ArrayList<TLRPC$Dialog> arrayList) {
        ...
        while (it.hasNext()) {
            ...
            if (next != null) {
                if (isForum(next.f1433id)) {
                    markAllTopicsAsRead(next.f1433id);
                }
                markMentionsAsRead(next.f1433id, 0);
                long j = next.f1433id;
    ...
    /* loaded from: classes4.dex */
    public class C32291 extends Fetcher<Integer, TLRPC$TL_help_appConfig> {
        ...
        public void getRemote(int i, Integer num, long j, final Utilities.Callback3<Boolean, TLRPC$TL_help_appConfig, Long> callback3) {
            ...
            MessagesController.this.getConnectionsManager().sendRequest(tLRPC$TL_help_getAppConfig, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$1$$ExternalSyntheticLambda2
                ...
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    MessagesController.C32291.lambda$getRemote$0(Utilities.Callback3.this, tLObject, tLRPC$TL_error);
                }
            });
        }
        ...
        public void getLocal(final int i, Integer num, final Utilities.Callback2<Long, TLRPC$TL_help_appConfig> callback2) {
            MessagesController.this.getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    MessagesController.C32291.lambda$getLocal$1(i, callback2);
                }
            });
        }
        ...
        */
        public static /* synthetic */ void lambda$getLocal$1(int r7, org.telegram.messenger.Utilities.Callback2 r8) {
            ...
            L6d:
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.MessagesController.C32291.lambda$getLocal$1(int, org.telegram.messenger.Utilities$Callback2):void");
        }
        ...
        public void setLocal(final int i, Integer num, final TLRPC$TL_help_appConfig tLRPC$TL_help_appConfig, long j) {
            MessagesStorage.getInstance(i).getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$1$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    MessagesController.C32291.lambda$setLocal$2(i, tLRPC$TL_help_appConfig);
                }
            });
        }
    ...
    public void getNextReactionMention(final long j, final int i, final int i2, final Consumer<Integer> consumer) {
        getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda55
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    public /* synthetic */ void lambda$getNextReactionMention$6(int r10, long r11, final androidx.core.util.Consumer r13, int r14) {
        ...
        L77:
            ...
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda253 r12 = new org.telegram.messenger.MessagesController$$ExternalSyntheticLambda253
            r12.<init>()
    ...
    public static /* synthetic */ void lambda$getNextReactionMention$4(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error, final Consumer consumer) {
        ...
        if (tLRPC$TL_error != null && tLRPC$messages_Messages != null && (arrayList = tLRPC$messages_Messages.messages) != null && !arrayList.isEmpty()) {
            i = tLRPC$messages_Messages.messages.get(0).f1451id;
        }
    ...
    public void markAllTopicsAsRead(final long j) {
        getMessagesStorage().loadTopics(j, new p034j$.util.function.Consumer() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda248
    ...
    public /* synthetic */ void lambda$markAllTopicsAsRead$9(ArrayList arrayList, long j) {
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                messagesController.markDialogAsRead(j, i2, 0, tLRPC$Message != null ? tLRPC$Message.date : 0, false, tLRPC$TL_forumTopic.f1480id, 0, true, 0);
                getMessagesStorage().updateRepliesMaxReadId(-j, tLRPC$TL_forumTopic.f1480id, tLRPC$TL_forumTopic.top_message, 0, true);
            }
        }
        getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda20
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public class SendAsPeersInfo {
        ...
        /* synthetic */ SendAsPeersInfo(MessagesController messagesController, C32291 c32291) {
            this();
        }
    }
    ...
    public static class EmojiSound {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof EmojiSound) {
                ...
                return this.f1368id == emojiSound.f1368id && this.accessHash == emojiSound.accessHash && Arrays.equals(this.fileReference, emojiSound.fileReference);
            }
            return false;
        }
    }
    ...
    public static class UserActionUpdatesSeq extends TLRPC$Updates {
        ...
        /* synthetic */ UserActionUpdatesSeq(C32291 c32291) {
            this();
        }
    }
    ...
    public static class UserActionUpdatesPts extends TLRPC$Updates {
        ...
        /* synthetic */ UserActionUpdatesPts(C32291 c32291) {
            this();
        }
    }
    ...
    public static class ReadTask {
        ...
        /* synthetic */ ReadTask(C32291 c32291) {
            this();
        }
    }
    ...
    public static class DialogFilter {
        ...
        public boolean includesDialog(AccountInstance accountInstance, long j, TLRPC$Dialog tLRPC$Dialog) {
            ...
            if (tLRPC$Dialog.folder_id == 0 || (this.flags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED) == 0) {
                ...
                if (!((this.flags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED) != 0 && messagesController.isDialogMuted(tLRPC$Dialog.f1433id, 0) && tLRPC$Dialog.unread_mentions_count == 0) && ((this.flags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_READ) == 0 || messagesController.getDialogUnreadCount(tLRPC$Dialog) != 0 || tLRPC$Dialog.unread_mark || tLRPC$Dialog.unread_mentions_count != 0)) {
        ...
        public boolean isDefault() {
            return this.f1367id == 0;
        }
    }

    public /* synthetic */ int lambda$new$11(TLRPC$Dialog tLRPC$Dialog, TLRPC$Dialog tLRPC$Dialog2) {
        int i = this.sortingDialogFilter.pinnedDialogs.get(tLRPC$Dialog.f1433id, Integer.MIN_VALUE);
        int i2 = this.sortingDialogFilter.pinnedDialogs.get(tLRPC$Dialog2.f1433id, Integer.MIN_VALUE);
            ...
            if (z || !(tLRPC$Dialog2 instanceof TLRPC$TL_dialogFolder)) {
                if (i != Integer.MIN_VALUE || i2 == Integer.MIN_VALUE) {
                    if (i == Integer.MIN_VALUE || i2 != Integer.MIN_VALUE) {
                        ...
                        int i3 = (DialogObject.getLastMessageOrDraftDate(tLRPC$Dialog, mediaDataController.getDraft(tLRPC$Dialog.f1433id, 0)) > DialogObject.getLastMessageOrDraftDate(tLRPC$Dialog2, mediaDataController.getDraft(tLRPC$Dialog2.f1433id, 0)) ? 1 : (DialogObject.getLastMessageOrDraftDate(tLRPC$Dialog, mediaDataController.getDraft(tLRPC$Dialog.f1433id, 0)) == DialogObject.getLastMessageOrDraftDate(tLRPC$Dialog2, mediaDataController.getDraft(tLRPC$Dialog2.f1433id, 0)) ? 0 : -1));
                        if (i3 < 0) {
                            return 1;
                        }
                        return i3 > 0 ? -1 : 0;
    ...
    public MessagesController(int i) {
        ...
        this.passwordCheckRunnable = new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda39
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.appConfigFetcher = new C32291();
        ...
        this.dialogDateComparator = new Comparator() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda240
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int lambda$new$11;
        ...
        this.dialogComparator = new Comparator() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda241
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int lambda$new$12;
        ...
        this.updatesComparator = new Comparator() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda242
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int lambda$new$13;
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda44
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void sendLoadPeersRequest(final TLObject tLObject, final ArrayList<TLObject> arrayList, final TLRPC$messages_Dialogs tLRPC$messages_Dialogs, final TLRPC$messages_Dialogs tLRPC$messages_Dialogs2, final ArrayList<TLRPC$User> arrayList2, final ArrayList<TLRPC$Chat> arrayList3, final ArrayList<DialogFilter> arrayList4, final SparseArray<DialogFilter> sparseArray, final ArrayList<Integer> arrayList5, final HashMap<Integer, HashSet<Long>> hashMap, final HashSet<Integer> hashSet) {
        getConnectionsManager().sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda342
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                MessagesController.this.lambda$sendLoadPeersRequest$16(arrayList3, arrayList2, tLRPC$messages_Dialogs, tLRPC$messages_Dialogs2, arrayList, tLObject, arrayList4, sparseArray, arrayList5, hashMap, hashSet, tLObject2, tLRPC$TL_error);
            }
        });
    }
    ...
    public void loadFilterPeers(final HashMap<Long, TLRPC$InputPeer> hashMap, final HashMap<Long, TLRPC$InputPeer> hashMap2, final HashMap<Long, TLRPC$InputPeer> hashMap3, final TLRPC$messages_Dialogs tLRPC$messages_Dialogs, final TLRPC$messages_Dialogs tLRPC$messages_Dialogs2, final ArrayList<TLRPC$User> arrayList, final ArrayList<TLRPC$Chat> arrayList2, final ArrayList<DialogFilter> arrayList3, final SparseArray<DialogFilter> sparseArray, final ArrayList<Integer> arrayList4, final HashMap<Integer, HashSet<Long>> hashMap4, final HashSet<Integer> hashSet) {
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda139
            @Override // java.lang.Runnable
            public final void run() {
                MessagesController.this.lambda$loadFilterPeers$17(hashMap2, tLRPC$messages_Dialogs, tLRPC$messages_Dialogs2, arrayList, arrayList2, arrayList3, sparseArray, arrayList4, hashMap4, hashSet, hashMap3, hashMap);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$loadFilterPeers$17(HashMap hashMap, TLRPC$messages_Dialogs tLRPC$messages_Dialogs, TLRPC$messages_Dialogs tLRPC$messages_Dialogs2, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, SparseArray sparseArray, ArrayList arrayList4, HashMap hashMap2, HashSet hashSet, HashMap hashMap3, HashMap hashMap4) {
        ...
        loop0: while (true) {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                tLRPC$TL_users_getUsers.f1564id.add(getInputUser((TLRPC$InputPeer) entry.getValue()));
                if (tLRPC$TL_users_getUsers.f1564id.size() == 100) {
                    break;
                }
            }
        ...
        for (Map.Entry entry2 : hashMap3.entrySet()) {
            ...
            if (tLRPC$InputPeer.chat_id != 0) {
                ...
                tLRPC$TL_messages_getChats.f1515id.add((Long) entry2.getKey());
                if (tLRPC$TL_messages_getChats.f1515id.size() == 100) {
                ...
                tLRPC$TL_channels_getChannels.f1467id.add(getInputChannel(tLRPC$InputPeer));
                if (tLRPC$TL_channels_getChannels.f1467id.size() == 100) {
    ...
    */
    ...
    public /* synthetic */ void lambda$processLoadedDialogFilters$19(int i, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, ArrayList arrayList5, TLRPC$messages_Dialogs tLRPC$messages_Dialogs, ArrayList arrayList6, LongSparseArray longSparseArray, LongSparseArray longSparseArray2) {
        ...
        if (i != 2) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                this.dialogFiltersById.put(dialogFilter.f1367id, dialogFilter);
            }
            Collections.sort(this.dialogFilters, MessagesController$$ExternalSyntheticLambda244.INSTANCE);
            if (i == 0) {
                ...
                while (it.hasNext()) {
                    ...
                    this.sortingDialogFiltersById.put(next.f1367id, next);
                }
                ...
                while (it2.hasNext()) {
                    ...
                    this.archiveSortingDialogFiltersById.put(next2.f1367id, next2);
                }
            }
            ...
            while (i6 < longSparseArray.size()) {
                ...
                if (tLRPC$messages_Dialogs != null && tLRPC$messages_Dialogs.dialogs.contains(tLRPC$Dialog)) {
                    if (tLRPC$Dialog.draft instanceof TLRPC$TL_draftMessage) {
                        getMediaDataController().saveDraft(tLRPC$Dialog.f1433id, 0, tLRPC$Dialog.draft, null, false);
                    }
                    if (tLRPC$Dialog2 != null) {
                        tLRPC$Dialog2.notify_settings = tLRPC$Dialog.notify_settings;
                    }
                }
                ArrayList<MessageObject> arrayList7 = (ArrayList) longSparseArray2.get(tLRPC$Dialog.f1433id);
                long j2 = 0;
                if (tLRPC$Dialog2 == null) {
            ...
            for (int i15 = 0; i15 < size2; i15++) {
                ...
                if (this.deletingDialogs.indexOfKey(valueAt.f1433id) < 0) {
    ...
    public void logStorageDir() {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_help_saveAppLog, MessagesController$$ExternalSyntheticLambda368.INSTANCE);
    ...
    public void updateEmojiStatus(TLRPC$EmojiStatus tLRPC$EmojiStatus) {
        ...
        if (currentUser != null) {
            ...
            getMessagesController().updateEmojiStatusUntilUpdate(currentUser.f1567id, currentUser.emoji_status);
        }
        getConnectionsManager().sendRequest(tLRPC$TL_account_updateEmojiStatus, MessagesController$$ExternalSyntheticLambda384.INSTANCE);
    }
    ...
    public void removeFilter(DialogFilter dialogFilter) {
        ...
        this.dialogFiltersById.remove(dialogFilter.f1367id);
        getNotificationCenter().postNotificationName(NotificationCenter.dialogFiltersUpdated, new Object[0]);
    }
    ...
    public void loadAppConfig() {
        ...
        this.appConfigFetcher.fetch(this.currentAccount, 0, new Utilities.Callback() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda252
            ...
            switch (c) {
                ...
                case 4:
                    ...
                    if (tLRPC$JSONValue5 instanceof TLRPC$TL_jsonBool) {
                        boolean z11 = ((TLRPC$TL_jsonBool) tLRPC$JSONValue5).value;
                ...
                case '\f':
                    ...
                    if ((tLRPC$JSONValue14 instanceof TLRPC$TL_jsonBool) && this.giftTextFieldIcon != ((TLRPC$TL_jsonBool) tLRPC$JSONValue14).value) {
                        boolean z12 = ((TLRPC$TL_jsonBool) tLRPC$JSONValue14).value;
                ...
                case '6':
                    ...
                    if ((tLRPC$JSONValue63 instanceof TLRPC$TL_jsonBool) && this.premiumLocked != ((TLRPC$TL_jsonBool) tLRPC$JSONValue63).value) {
                        boolean z13 = ((TLRPC$TL_jsonBool) tLRPC$JSONValue63).value;
                ...
                case '7':
                    ...
                    if ((tLRPC$JSONValue64 instanceof TLRPC$TL_jsonBool) && this.giftAttachMenuIcon != ((TLRPC$TL_jsonBool) tLRPC$JSONValue64).value) {
                        boolean z14 = ((TLRPC$TL_jsonBool) tLRPC$JSONValue64).value;
                ...
                case ';':
                    ...
                    if ((tLRPC$JSONValue71 instanceof TLRPC$TL_jsonBool) && this.uploadMarkupVideo != ((TLRPC$TL_jsonBool) tLRPC$JSONValue71).value) {
                        boolean z15 = ((TLRPC$TL_jsonBool) tLRPC$JSONValue71).value;
                    ...
                    try {
                        ...
                        if (!this.emojiSounds.equals(hashMap2)) {
                            ...
                            for (Map.Entry<String, EmojiSound> entry2 : this.emojiSounds.entrySet()) {
                                ...
                                serializedData3.writeInt64(value2.f1368id);
                ...
                case 'G':
                    ...
                    if ((tLRPC$JSONValue85 instanceof TLRPC$TL_jsonBool) && (z10 = ((TLRPC$TL_jsonBool) tLRPC$JSONValue85).value) != this.filtersEnabled) {
    ...
    public void removeSuggestion(long j, String str) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_help_dismissSuggestion, MessagesController$$ExternalSyntheticLambda366.INSTANCE);
    }
    ...
    public void addSupportUser() {
        ...
        tLRPC$TL_userForeign_old2.f1567id = 333000L;
        ...
        tLRPC$TL_userForeign_old22.f1567id = 777000L;
    ...
    public TLRPC$InputUser getInputUser(TLRPC$User tLRPC$User) {
        ...
        if (tLRPC$User.f1567id == getUserConfig().getClientUserId()) {
            return new TLRPC$TL_inputUserSelf();
        }
        TLRPC$TL_inputUser tLRPC$TL_inputUser = new TLRPC$TL_inputUser();
        tLRPC$TL_inputUser.user_id = tLRPC$User.f1567id;
    ...
    public static TLRPC$InputPeer getInputPeer(TLRPC$Chat tLRPC$Chat) {
        if (ChatObject.isChannel(tLRPC$Chat)) {
            TLRPC$TL_inputPeerChannel tLRPC$TL_inputPeerChannel = new TLRPC$TL_inputPeerChannel();
            tLRPC$TL_inputPeerChannel.channel_id = tLRPC$Chat.f1427id;
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.fileUploaded) {
            ...
            if (str2 != null && str2.equals(str)) {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_photos_uploadProfilePhoto, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda256
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (str3 != null && str3.equals(str)) {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_account_uploadWallPaper, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda358
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (themeAccent != null) {
                ...
                if (!TextUtils.isEmpty(themeAccent.patternSlug)) {
                    ...
                    tLRPC$TL_inputWallPaperNoFile.f1501id = 0L;
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_account_uploadTheme, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda353
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            for (int i8 = 0; arrayList != null && i8 < arrayList.size(); i8++) {
                ...
                if (messageObject2 != null && (messageObject2.getId() == num.intValue() || messageObject2.messageOwner.local_id == num.intValue())) {
                    messageObject2.messageOwner.f1451id = num2.intValue();
            ...
            if (tLRPC$Message.peer_id.channel_id != 0 || (messageObject = this.dialogMessagesByIds.get(tLRPC$Message.f1451id)) == null) {
                return;
            }
    ...
    public /* synthetic */ void lambda$didReceivedNotification$32(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            ...
            getMessagesStorage().clearUserPhotos(user.f1567id);
    ...
    public /* synthetic */ void lambda$didReceivedNotification$34(final Theme.OverrideWallpaperInfo overrideWallpaperInfo, final TLRPC$TL_wallPaperSettings tLRPC$TL_wallPaperSettings, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$didReceivedNotification$33(TLRPC$WallPaper tLRPC$WallPaper, TLRPC$TL_wallPaperSettings tLRPC$TL_wallPaperSettings, Theme.OverrideWallpaperInfo overrideWallpaperInfo, File file) {
    ...
    public /* synthetic */ void lambda$didReceivedNotification$40(TLRPC$TL_theme tLRPC$TL_theme, final Theme.ThemeInfo themeInfo, TLRPC$TL_inputThemeSettings tLRPC$TL_inputThemeSettings, final Theme.ThemeAccent themeAccent, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (tLObject != null) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_account_updateTheme, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda360
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error2) {
    ...
    public void cleanup() {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda24
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setLastCreatedDialogId(final long j, final boolean z, final boolean z2) {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda231
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    ...
    public void putChat(final TLRPC$Chat tLRPC$Chat, boolean z) {
        ...
        if (tLRPC$Chat == null || (tLRPC$Chat2 = this.chats.get(Long.valueOf(tLRPC$Chat.f1427id))) == tLRPC$Chat) {
            return;
        }
        ...
        if (!tLRPC$Chat.min) {
            if (!z) {
                if (tLRPC$Chat2 != null) {
                    if (tLRPC$Chat.version != tLRPC$Chat2.version) {
                        this.loadedFullChats.delete(tLRPC$Chat.f1427id);
                    }
                ...
                this.chats.put(Long.valueOf(tLRPC$Chat.f1427id), tLRPC$Chat);
            ...
            if (z2 != z3) {
                ...
                getNotificationCenter().postNotificationName(NotificationCenter.chatSwithcedToForum, Long.valueOf(tLRPC$Chat.f1427id));
            }
        }
    ...
    public void lambda$addOrRemoveActiveVoiceChat$48(TLRPC$Chat tLRPC$Chat) {
        TLRPC$Chat tLRPC$Chat2 = this.activeVoiceChatsMap.get(Long.valueOf(tLRPC$Chat.f1427id));
        if (tLRPC$Chat.call_active && tLRPC$Chat.call_not_empty && tLRPC$Chat.migrated_to == null && !ChatObject.isNotInChat(tLRPC$Chat)) {
            if (tLRPC$Chat2 != null) {
                return;
            }
            this.activeVoiceChatsMap.put(Long.valueOf(tLRPC$Chat.f1427id), tLRPC$Chat);
            getNotificationCenter().postNotificationName(NotificationCenter.activeGroupCallsUpdated, new Object[0]);
        } else if (tLRPC$Chat2 == null) {
        } else {
            this.activeVoiceChatsMap.remove(Long.valueOf(tLRPC$Chat.f1427id));
            getNotificationCenter().postNotificationName(NotificationCenter.activeGroupCallsUpdated, new Object[0]);
        }
    }
    ...
    public void putEncryptedChat(TLRPC$EncryptedChat tLRPC$EncryptedChat, boolean z) {
        ...
        if (z) {
            this.encryptedChats.putIfAbsent(Integer.valueOf(tLRPC$EncryptedChat.f1439id), tLRPC$EncryptedChat);
        } else {
            this.encryptedChats.put(Integer.valueOf(tLRPC$EncryptedChat.f1439id), tLRPC$EncryptedChat);
        }
    }
    ...
    public void putGroupCall(long j, ChatObject.Call call) {
        this.groupCalls.put(call.call.f1442id, call);
        this.groupCallsByChatId.put(j, call);
        TLRPC$ChatFull chatFull = getChatFull(j);
        if (chatFull != null) {
            chatFull.call = call.getInputGroupCall();
        }
        getNotificationCenter().postNotificationName(NotificationCenter.groupCallUpdated, Long.valueOf(j), Long.valueOf(call.call.f1442id), Boolean.FALSE);
    ...
    public ChatObject.Call getGroupCall(final long j, boolean z, final Runnable runnable) {
        ...
        ChatObject.Call call = this.groupCalls.get(tLRPC$TL_inputGroupCall.f1490id);
        if (call == null && z && !this.loadingGroupCalls.contains(Long.valueOf(j))) {
            ...
            if (chatFull.call != null) {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_phone_getGroupCall, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda320
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$getGroupCall$49(TLObject tLObject, long j, Runnable runnable) {
        if (tLObject != null) {
            ...
            this.groupCalls.put(tLRPC$TL_phone_groupCall.call.f1442id, call);
            this.groupCallsByChatId.put(j, call);
            getNotificationCenter().postNotificationName(NotificationCenter.groupCallUpdated, Long.valueOf(j), Long.valueOf(tLRPC$TL_phone_groupCall.call.f1442id), Boolean.FALSE);
            if (runnable != null) {
                runnable.run();
            }
        }
    ...
    private void reloadDialogsReadValue(ArrayList<TLRPC$Dialog> arrayList, long j) {
        ...
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                TLRPC$InputPeer inputPeer = getInputPeer(arrayList.get(i).f1433id);
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_getPeerDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda273
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$reloadDialogsReadValue$51(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            ...
            for (int i = 0; i < tLRPC$TL_messages_peerDialogs.dialogs.size(); i++) {
                ...
                Integer num = this.dialogs_read_inbox_max.get(Long.valueOf(tLRPC$Dialog.f1433id));
                if (num == null) {
                    num = 0;
                }
                this.dialogs_read_inbox_max.put(Long.valueOf(tLRPC$Dialog.f1433id), Integer.valueOf(Math.max(tLRPC$Dialog.read_inbox_max_id, num.intValue())));
                if (num.intValue() == 0) {
                ...
                Integer num2 = this.dialogs_read_outbox_max.get(Long.valueOf(tLRPC$Dialog.f1433id));
                if (num2 == null) {
                    num2 = 0;
                }
                this.dialogs_read_outbox_max.put(Long.valueOf(tLRPC$Dialog.f1433id), Integer.valueOf(Math.max(tLRPC$Dialog.read_outbox_max_id, num2.intValue())));
    ...
    */
    public void loadFullChat(final long r12, final int r14, boolean r15) {
        ...
        L6c:
            ...
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda345 r1 = new org.telegram.messenger.MessagesController$$ExternalSyntheticLambda345
            r3 = r1
            r4 = r11
            r8 = r12
            r10 = r14
    ...
    public void loadFullUser(final TLRPC$User tLRPC$User, final int i, boolean z) {
        if (tLRPC$User == null || this.loadingFullUsers.contains(Long.valueOf(tLRPC$User.f1567id))) {
            return;
        }
        if (z || this.loadedFullUsers.get(tLRPC$User.f1567id) <= 0) {
            this.loadingFullUsers.add(Long.valueOf(tLRPC$User.f1567id));
            TLRPC$TL_users_getFullUser tLRPC$TL_users_getFullUser = new TLRPC$TL_users_getFullUser();
            tLRPC$TL_users_getFullUser.f1563id = getInputUser(tLRPC$User);
            ...
            getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_users_getFullUser, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda354
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadFullUser$59(final TLRPC$User tLRPC$User, final int i, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            ...
            tLRPC$UserFull2.user = getUser(Long.valueOf(tLRPC$UserFull2.f1568id));
    ...
    public /* synthetic */ void lambda$loadFullUser$57(TLRPC$UserFull tLRPC$UserFull, TLRPC$User tLRPC$User, int i) {
        savePeerSettings(tLRPC$UserFull.user.f1567id, tLRPC$UserFull.settings, false);
        applyDialogNotificationsSettings(tLRPC$User.f1567id, 0, tLRPC$UserFull.notify_settings);
        TLRPC$BotInfo tLRPC$BotInfo = tLRPC$UserFull.bot_info;
        if (tLRPC$BotInfo instanceof TLRPC$TL_botInfo) {
            tLRPC$BotInfo.user_id = tLRPC$User.f1567id;
            getMediaDataController().putBotInfo(tLRPC$User.f1567id, tLRPC$UserFull.bot_info);
        }
        int indexOfKey = this.blockePeers.indexOfKey(tLRPC$User.f1567id);
        if (tLRPC$UserFull.blocked) {
            if (indexOfKey < 0) {
                this.blockePeers.put(tLRPC$User.f1567id, 1);
                getNotificationCenter().postNotificationName(NotificationCenter.blockedUsersDidLoad, new Object[0]);
            }
        } else if (indexOfKey >= 0) {
            this.blockePeers.removeAt(indexOfKey);
        ...
        this.fullUsers.put(tLRPC$User.f1567id, tLRPC$UserFull);
        getTranslateController().updateDialogFull(tLRPC$User.f1567id);
        this.loadingFullUsers.remove(Long.valueOf(tLRPC$User.f1567id));
        this.loadedFullUsers.put(tLRPC$User.f1567id, System.currentTimeMillis());
        ...
        if (tLRPC$BotInfo2 instanceof TLRPC$TL_botInfo) {
            tLRPC$BotInfo2.user_id = tLRPC$UserFull.f1568id;
            getNotificationCenter().postNotificationName(NotificationCenter.botInfoDidLoad, tLRPC$UserFull.bot_info, Integer.valueOf(i));
        }
        getNotificationCenter().postNotificationName(NotificationCenter.userInfoDidLoad, Long.valueOf(tLRPC$User.f1567id), tLRPC$UserFull);
        TLRPC$Dialog tLRPC$Dialog = this.dialogs_dict.get(tLRPC$User.f1567id);
        if (tLRPC$Dialog != null) {
    ...
    private void reloadMessages(ArrayList<Integer> arrayList, final long j, final boolean z) {
        ...
        if (ChatObject.isChannel(chat)) {
            ...
            tLRPC$TL_channels_getMessages.f1469id = arrayList2;
            ...
            tLRPC$TL_messages_getMessages2.f1519id = arrayList2;
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_getMessages3, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda332
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$reloadMessages$61(final long j, boolean z, final ArrayList arrayList, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            ...
            while (i3 < tLRPC$messages_Messages.messages.size()) {
                ...
                if (!z) {
                    tLRPC$Message.unread = (tLRPC$Message.out ? num2 : num).intValue() < tLRPC$Message.f1451id ? z3 : z2;
                }
                Integer num3 = num;
    ...
    public void hidePeerSettingsBar(long j, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat) {
        ...
        if (tLRPC$User != null) {
            tLRPC$TL_messages_hidePeerSettingsBar.peer = getInputPeer(tLRPC$User.f1567id);
        } else {
            tLRPC$TL_messages_hidePeerSettingsBar.peer = getInputPeer(-tLRPC$Chat.f1427id);
        }
        getConnectionsManager().sendRequest(tLRPC$TL_messages_hidePeerSettingsBar, MessagesController$$ExternalSyntheticLambda379.INSTANCE);
    }
    ...
    public void reportSpam(long j, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, TLRPC$EncryptedChat tLRPC$EncryptedChat, boolean z) {
        ...
        if (DialogObject.isEncryptedDialog(j)) {
            ...
            tLRPC$TL_inputEncryptedChat.chat_id = tLRPC$EncryptedChat.f1439id;
            tLRPC$TL_inputEncryptedChat.access_hash = tLRPC$EncryptedChat.access_hash;
            getConnectionsManager().sendRequest(tLRPC$TL_messages_reportEncryptedSpam, MessagesController$$ExternalSyntheticLambda375.INSTANCE, 2);
        } else if (z) {
            TLRPC$TL_account_reportPeer tLRPC$TL_account_reportPeer = new TLRPC$TL_account_reportPeer();
            if (tLRPC$Chat != null) {
                tLRPC$TL_account_reportPeer.peer = getInputPeer(-tLRPC$Chat.f1427id);
            } else if (tLRPC$User != null) {
                tLRPC$TL_account_reportPeer.peer = getInputPeer(tLRPC$User.f1567id);
            }
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_account_reportPeer, MessagesController$$ExternalSyntheticLambda369.INSTANCE, 2);
        } else {
            TLRPC$TL_messages_reportSpam tLRPC$TL_messages_reportSpam = new TLRPC$TL_messages_reportSpam();
            if (tLRPC$Chat != null) {
                tLRPC$TL_messages_reportSpam.peer = getInputPeer(-tLRPC$Chat.f1427id);
            } else if (tLRPC$User != null) {
                tLRPC$TL_messages_reportSpam.peer = getInputPeer(tLRPC$User.f1567id);
            }
            getConnectionsManager().sendRequest(tLRPC$TL_messages_reportSpam, MessagesController$$ExternalSyntheticLambda378.INSTANCE, 2);
        }
    }
    ...
    public void loadPeerSettings(TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat) {
        ...
        if (tLRPC$User != null) {
            tLRPC$TL_messages_getPeerSettings.peer = getInputPeer(tLRPC$User.f1567id);
        } else {
            tLRPC$TL_messages_getPeerSettings.peer = getInputPeer(-tLRPC$Chat.f1427id);
        }
        getConnectionsManager().sendRequest(tLRPC$TL_messages_getPeerSettings, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda298
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    private boolean checkDeletingTask(boolean z) {
        ...
        if (!(this.currentDeletingTaskMids == null && this.currentDeletingTaskMediaMids == null) && (z || ((i = this.currentDeletingTaskTime) != 0 && i <= currentTime))) {
            ...
            final LongSparseArray<ArrayList<Integer>> m848clone = longSparseArray != null ? longSparseArray.m848clone() : null;
            LongSparseArray<ArrayList<Integer>> longSparseArray2 = this.currentDeletingTaskMediaMids;
            final LongSparseArray<ArrayList<Integer>> m848clone2 = longSparseArray2 != null ? longSparseArray2.m848clone() : null;
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda108
                @Override // java.lang.Runnable
                public final void run() {
                    MessagesController.this.lambda$checkDeletingTask$72(m848clone, m848clone2);
                }
            });
            return true;
        }
    ...
    public void loadDialogPhotos(final long j, final int i, final int i2, boolean z, final int i3) {
        ...
        if (i4 > 0) {
            ...
            getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_photos_getUserPhotos, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda309
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_messages_search, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda310
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void blockPeer(long j) {
        ...
        if (tLRPC$User != null) {
            tLRPC$TL_contacts_block.f1474id = getInputPeer(tLRPC$User);
        } else {
            tLRPC$TL_contacts_block.f1474id = getInputPeer(chat);
        }
        getConnectionsManager().sendRequest(tLRPC$TL_contacts_block, MessagesController$$ExternalSyntheticLambda365.INSTANCE);
    }
    ...
    public void setParticipantBannedRole(final long j, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights, final boolean z, final BaseFragment baseFragment) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_editBanned, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda330
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void setChannelSlowMode(final long j, int i) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_toggleSlowMode, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda300
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void setDefaultBannedRole(final long j, TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights, final boolean z, final BaseFragment baseFragment) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_editChatDefaultBannedRights, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda331
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void setUserAdminRole(final long j, final TLRPC$User tLRPC$User, TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, String str, final boolean z, final BaseFragment baseFragment, boolean z2, boolean z3, String str2, final Runnable runnable, final ErrorDelegate errorDelegate) {
        ...
        if (ChatObject.isChannel(chat)) {
            ...
            final RequestDelegate requestDelegate = new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda322
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if ((!tLRPC$User.bot || !ChatObject.isChannelAndNotMegaGroup(chat)) && z2) {
                addUserToChat(j, tLRPC$User, 0, str2, baseFragment, true, new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda176
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        final RequestDelegate requestDelegate2 = new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda323
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (tLRPC$TL_messages_editChatAdmin.is_admin || z2 || !TextUtils.isEmpty(str2)) {
            addUserToChat(j, tLRPC$User, 0, str2, baseFragment, true, new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda192
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void unblockPeer(long j, final Runnable runnable) {
        ...
        if (tLRPC$User != null) {
            tLRPC$TL_contacts_unblock.f1477id = getInputPeer(tLRPC$User);
        } else {
            tLRPC$TL_contacts_unblock.f1477id = getInputPeer(chat);
        }
        getNotificationCenter().postNotificationName(NotificationCenter.blockedUsersDidLoad, new Object[0]);
        getConnectionsManager().sendRequest(tLRPC$TL_contacts_unblock, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda254
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void getBlockedPeers(final boolean z) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_contacts_getBlocked, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda363
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void deleteUserPhoto(TLRPC$InputPhoto tLRPC$InputPhoto) {
        if (tLRPC$InputPhoto == null) {
            ...
            tLRPC$TL_photos_updateProfilePhoto.f1552id = new TLRPC$TL_inputPhotoEmpty();
            TLRPC$User user = getUser(Long.valueOf(getUserConfig().getClientUserId()));
            if (user == null) {
                user = getUserConfig().getCurrentUser();
            }
            ...
            if (user.photo != null) {
                getMessagesStorage().clearUserPhoto(user.f1567id, user.photo.photo_id);
            }
            getNotificationCenter().postNotificationName(NotificationCenter.mainUserInfoChanged, new Object[0]);
        ...
        tLRPC$TL_photos_deletePhotos.f1551id.add(tLRPC$InputPhoto);
        getConnectionsManager().sendRequest(tLRPC$TL_photos_deletePhotos, MessagesController$$ExternalSyntheticLambda381.INSTANCE);
    }
    ...
    public /* synthetic */ void lambda$deleteUserPhoto$101(TLObject tLObject) {
        ...
        if (tLRPC$TL_photos_photo.photo instanceof TLRPC$TL_photo) {
            ...
            tLRPC$UserProfilePhoto.photo_id = tLRPC$Photo.f1456id;
    ...
    public void saveTheme(Theme.ThemeInfo themeInfo, Theme.ThemeAccent themeAccent, boolean z, boolean z2) {
        ...
        if (tLRPC$TL_theme != null) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_account_saveTheme, MessagesController$$ExternalSyntheticLambda380.INSTANCE);
    ...
    public void installTheme(Theme.ThemeInfo themeInfo, Theme.ThemeAccent themeAccent, boolean z) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_account_installTheme, MessagesController$$ExternalSyntheticLambda376.INSTANCE);
        if (TextUtils.isEmpty(str)) {
            return;
        }
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_account_installWallPaper, MessagesController$$ExternalSyntheticLambda387.INSTANCE);
    }
    ...
    public void saveThemeToServer(final Theme.ThemeInfo themeInfo, final Theme.ThemeAccent themeAccent) {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda115
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$saveThemeToServer$109(final String str, File file, final Theme.ThemeAccent themeAccent, final Theme.ThemeInfo themeInfo) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public /* synthetic */ void lambda$saveThemeToServer$108(String str, String str2, Theme.ThemeAccent themeAccent, Theme.ThemeInfo themeInfo) {
        if (str == null) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void saveWallpaperToServer(java.io.File r10, org.telegram.p044ui.ActionBar.Theme.OverrideWallpaperInfo r11, boolean r12, final long r13) {
        /*
    ...
    public /* synthetic */ void lambda$saveWallpaperToServer$110(long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void deleteMessages(ArrayList<Integer> arrayList, ArrayList<Long> arrayList2, TLRPC$EncryptedChat tLRPC$EncryptedChat, long j, boolean z, boolean z2, boolean z3, long j2, TLObject tLObject, final Runnable runnable, final Runnable runnable2) {
        ...
        if (j2 == 0) {
            if (j == 0 || !DialogObject.isChatDialog(j)) {
                ...
                TLRPC$Chat chat = getChat(Long.valueOf(-j));
                j4 = ChatObject.isChannel(chat) ? chat.f1427id : 0L;
            }
            if (z3) {
                arrayList4 = null;
            } else {
        ...
        if (z2) {
            if (tLObject instanceof TLRPC$TL_messages_deleteScheduledMessages) {
                ...
                tLRPC$TL_messages_deleteScheduledMessages2.f1510id = arrayList3;
                ...
                try {
                    ...
                    try {
                        ...
                        getConnectionsManager().sendRequest(tLRPC$TL_messages_deleteScheduledMessages, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda301
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (tLObject != null) {
                ...
                tLRPC$TL_channels_deleteMessages2.f1464id = arrayList3;
                ...
                try {
                    ...
                    getConnectionsManager().sendRequest(tLRPC$TL_channels_deleteMessages, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda317
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (tLObject instanceof TLRPC$TL_messages_deleteMessages) {
                ...
                tLRPC$TL_messages_deleteMessages2.f1509id = arrayList3;
                ...
                try {
                    ...
                    try {
                        ...
                        getConnectionsManager().sendRequest(tLRPC$TL_messages_deleteMessages, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda321
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                MessagesController.this.lambda$deleteMessages$113(j7, runnable, runnable2, tLObject2, tLRPC$TL_error);
                            }
                        });
                    }
                } catch (Exception e6) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_messages_deleteMessages, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda321
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    MessagesController.this.lambda$deleteMessages$113(j72, runnable, runnable2, tLObject2, tLRPC$TL_error);
                }
            });
        }
    }

    public /* synthetic */ void lambda$deleteMessages$111(long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            processUpdates((TLRPC$Updates) tLObject, false);
        }
        if (j != 0) {
    ...
    public /* synthetic */ void lambda$deleteMessages$112(long j, long j2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
    ...
    public /* synthetic */ void lambda$deleteMessages$113(long j, Runnable runnable, Runnable runnable2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            TLRPC$TL_messages_affectedMessages tLRPC$TL_messages_affectedMessages = (TLRPC$TL_messages_affectedMessages) tLObject;
    ...
    public void unpinAllMessages(final TLRPC$Chat tLRPC$Chat, final TLRPC$User tLRPC$User) {
        ...
        tLRPC$TL_messages_unpinAllMessages.peer = getInputPeer(tLRPC$Chat != null ? -tLRPC$Chat.f1427id : tLRPC$User.f1567id);
        getConnectionsManager().sendRequest(tLRPC$TL_messages_unpinAllMessages, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda346
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$unpinAllMessages$114(TLRPC$Chat tLRPC$Chat, TLRPC$User tLRPC$User, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            TLRPC$TL_messages_affectedHistory tLRPC$TL_messages_affectedHistory = (TLRPC$TL_messages_affectedHistory) tLObject;
            if (ChatObject.isChannel(tLRPC$Chat)) {
                processNewChannelDifferenceParams(tLRPC$TL_messages_affectedHistory.pts, tLRPC$TL_messages_affectedHistory.pts_count, tLRPC$Chat.f1427id);
            } else {
                processNewDifferenceParams(-1, tLRPC$TL_messages_affectedHistory.pts, -1, tLRPC$TL_messages_affectedHistory.pts_count);
            }
            new ArrayList();
            getMessagesStorage().updatePinnedMessages(tLRPC$Chat != null ? -tLRPC$Chat.f1427id : tLRPC$User.f1567id, null, false, 0, 0, false, null);
        }
    }
    ...
    public void pinMessage(final TLRPC$Chat tLRPC$Chat, final TLRPC$User tLRPC$User, final int i, final boolean z, boolean z2, boolean z3) {
        ...
        tLRPC$TL_messages_updatePinnedMessage.peer = getInputPeer(tLRPC$Chat != null ? -tLRPC$Chat.f1427id : tLRPC$User.f1567id);
        tLRPC$TL_messages_updatePinnedMessage.f1539id = i;
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_updatePinnedMessage, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda293
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$pinMessage$115(int i, TLRPC$Chat tLRPC$Chat, TLRPC$User tLRPC$User, boolean z, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            ArrayList<Integer> arrayList = new ArrayList<>();
            arrayList.add(Integer.valueOf(i));
            getMessagesStorage().updatePinnedMessages(tLRPC$Chat != null ? -tLRPC$Chat.f1427id : tLRPC$User.f1567id, arrayList, !z, -1, 0, false, null);
            processUpdates((TLRPC$Updates) tLObject, false);
        }
    }
    ...
    public void deleteUserChannelHistory(final TLRPC$Chat tLRPC$Chat, final TLRPC$User tLRPC$User, final TLRPC$Chat tLRPC$Chat2, int i) {
        ...
        if (tLRPC$User != null) {
            ...
            j = tLRPC$Chat2 != null ? tLRPC$Chat2.f1427id : 0L;
        }
        if (i == 0) {
            getMessagesStorage().deleteUserChatHistory(-tLRPC$Chat.f1427id, j);
        }
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_deleteParticipantHistory, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda347
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$deleteUserChannelHistory$116(TLRPC$Chat tLRPC$Chat, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            TLRPC$TL_messages_affectedHistory tLRPC$TL_messages_affectedHistory = (TLRPC$TL_messages_affectedHistory) tLObject;
    ...
    public void putDraftDialogIfNeed(long j, TLRPC$DraftMessage tLRPC$DraftMessage) {
        if (this.dialogs_dict.indexOfKey(j) < 0) {
            ...
            if (size > 0) {
                ...
                if (tLRPC$DraftMessage.date < DialogObject.getLastMessageOrDraftDate(tLRPC$Dialog, mediaDataController.getDraft(tLRPC$Dialog.f1433id, 0))) {
                    return;
                }
            }
            TLRPC$TL_dialog tLRPC$TL_dialog = new TLRPC$TL_dialog();
            tLRPC$TL_dialog.f1433id = j;
    ...
    public void removeDraftDialogIfNeed(long j) {
        ...
        this.dialogs_dict.remove(tLRPC$Dialog.f1433id);
    ...
    private void removeDialog(TLRPC$Dialog tLRPC$Dialog) {
        ...
        final long j = tLRPC$Dialog.f1433id;
    ...
    public /* synthetic */ void lambda$removeDialog$117(long j) {
        long j2 = -j;
    ...
    public void hidePromoDialog() {
        ...
        tLRPC$TL_help_hidePromoData.peer = getInputPeer(this.promoDialog.f1433id);
        getConnectionsManager().sendRequest(tLRPC$TL_help_hidePromoData, MessagesController$$ExternalSyntheticLambda386.INSTANCE);
    ...
    public /* synthetic */ void lambda$hidePromoDialog$119() {
    ...
    public void setDialogHistoryTTL(long j, int i) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_setHistoryTTL, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda271
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$setDialogHistoryTTL$120(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
        }
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$deleteDialog$121(long j, int i, boolean z, TLRPC$InputPeer tLRPC$InputPeer, long j2, int i2) {
        deleteDialog(j, 2, i, Math.max(0, i2), z, tLRPC$InputPeer, j2);
        checkIfFolderEmpty(1);
    }

    public /* synthetic */ void lambda$deleteDialog$122(long j) {
        getNotificationsController().removeNotificationsForDialog(j);
    }

    public /* synthetic */ void lambda$deleteDialog$123(final long j) {
    ...
    public /* synthetic */ void lambda$deleteDialog$124(long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (j != 0) {
            getMessagesStorage().removePendingTask(j);
        }
        if (tLObject != null) {
    ...
    public /* synthetic */ void lambda$deleteDialog$125(long j, long j2, int i, int i2, boolean z, TLRPC$InputPeer tLRPC$InputPeer, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (j != 0) {
            getMessagesStorage().removePendingTask(j);
        }
        if (tLRPC$TL_error == null) {
    ...
    public void saveGif(final Object obj, TLRPC$Document tLRPC$Document) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_saveGif, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda337
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$saveGif$126(Object obj, TLRPC$TL_messages_saveGif tLRPC$TL_messages_saveGif, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void saveRecentSticker(final Object obj, TLRPC$Document tLRPC$Document, boolean z) {
        ...
        TLRPC$TL_inputDocument tLRPC$TL_inputDocument = new TLRPC$TL_inputDocument();
        tLRPC$TL_messages_saveRecentSticker.f1531id = tLRPC$TL_inputDocument;
        tLRPC$TL_inputDocument.f1443id = tLRPC$Document.f1435id;
        tLRPC$TL_inputDocument.access_hash = tLRPC$Document.access_hash;
        byte[] bArr = tLRPC$Document.file_reference;
        tLRPC$TL_inputDocument.file_reference = bArr;
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_saveRecentSticker, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda338
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$saveRecentSticker$127(Object obj, TLRPC$TL_messages_saveRecentSticker tLRPC$TL_messages_saveRecentSticker, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null || !FileRefController.isFileRefError(tLRPC$TL_error.text)) {
            return;
        }
    ...
    public void loadChannelParticipants(final Long l) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_getParticipants, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda336
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadChannelParticipants$129(final Long l, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadChannelParticipants$128(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, Long l) {
        if (tLRPC$TL_error == null) {
    ...
    public void putChatFull(TLRPC$ChatFull tLRPC$ChatFull) {
        this.fullChats.put(tLRPC$ChatFull.f1428id, tLRPC$ChatFull);
        getTranslateController().updateDialogFull(-tLRPC$ChatFull.f1428id);
    }
    ...
    public void processChatInfo(final long j, final TLRPC$ChatFull tLRPC$ChatFull, final ArrayList<TLRPC$User> arrayList, final boolean z, final boolean z2, final boolean z3, final ArrayList<Integer> arrayList2, final HashMap<Integer, MessageObject> hashMap, final int i, final boolean z4, final ArrayList<Integer> arrayList3, final HashMap<Integer, MessageObject> hashMap2) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda228
            @Override // java.lang.Runnable
            public final void run() {
                MessagesController.this.lambda$processChatInfo$130(z, j, z3, z2, tLRPC$ChatFull, arrayList, arrayList2, hashMap, i, z4, arrayList3, hashMap2);
            }
        });
    }

    public /* synthetic */ void lambda$processChatInfo$130(boolean z, long j, boolean z2, boolean z3, TLRPC$ChatFull tLRPC$ChatFull, ArrayList arrayList, ArrayList arrayList2, HashMap hashMap, int i, boolean z4, ArrayList arrayList3, HashMap hashMap2) {
    ...
    public /* synthetic */ void lambda$processUserInfo$131(boolean z, TLRPC$User tLRPC$User, int i, boolean z2, TLRPC$UserFull tLRPC$UserFull, ArrayList arrayList, HashMap hashMap, int i2, boolean z3) {
        if (z && System.currentTimeMillis() - this.loadedFullUsers.get(tLRPC$User.f1567id, 0L) > 60000) {
            loadFullUser(tLRPC$User, i, z2);
        }
        if (tLRPC$UserFull != null) {
            if (this.fullUsers.get(tLRPC$User.f1567id) == null) {
                this.fullUsers.put(tLRPC$User.f1567id, tLRPC$UserFull);
                getTranslateController().updateDialogFull(tLRPC$User.f1567id);
                int indexOfKey = this.blockePeers.indexOfKey(tLRPC$User.f1567id);
                if (tLRPC$UserFull.blocked) {
        ...
        if (arrayList != null) {
            getNotificationCenter().postNotificationName(NotificationCenter.pinnedInfoDidLoad, Long.valueOf(tLRPC$User.f1567id), arrayList, hashMap, Integer.valueOf(i2), Boolean.valueOf(z3));
        }
    }
        ...
        if (getUserConfig().isClientActivated()) {
            if (!this.ignoreSetOnline && getConnectionsManager().getPauseTime() == 0 && ApplicationLoader.isScreenOn && !ApplicationLoader.mainInterfacePausedStageQueue) {
                if (ApplicationLoader.mainInterfacePausedStageQueueTime != 0 && Math.abs(ApplicationLoader.mainInterfacePausedStageQueueTime - System.currentTimeMillis()) > 1000 && this.statusSettingState != 1 && (this.lastStatusUpdateTime == 0 || Math.abs(System.currentTimeMillis() - this.lastStatusUpdateTime) >= 55000 || this.offlineSent)) {
                    ...
                    this.statusRequest = getConnectionsManager().sendRequest(tLRPC$TL_account_updateStatus, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda277
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                ...
                this.statusRequest = getConnectionsManager().sendRequest(tLRPC$TL_account_updateStatus2, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda264
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            for (int i7 = 0; i7 < 3; i7++) {
                if (getUpdatesStartTime(i7) != 0 && Math.abs(currentTimeMillis - getUpdatesStartTime(i7)) >= 1500) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m48d(i7 + " QUEUE UPDATES WAIT TIMEOUT - CHECK QUEUE");
                    }
        ...
        if (Math.abs(System.currentTimeMillis() - this.lastViewsCheckTime) >= 5000) {
            ...
            if (this.channelViewsToSend.size() != 0) {
                ...
                while (i8 < this.channelViewsToSend.size()) {
                    ...
                    tLRPC$TL_messages_getMessagesViews.f1521id = this.channelViewsToSend.valueAt(i8);
                    tLRPC$TL_messages_getMessagesViews.increment = i8 == 0;
                    getConnectionsManager().sendRequest(tLRPC$TL_messages_getMessagesViews, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda328
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (this.shortPollOnlines.size() != 0) {
            ...
            while (i10 < this.shortPollOnlines.size()) {
                ...
                if (this.shortPollOnlines.valueAt(i10) < elapsedRealtime) {
                    ...
                    getConnectionsManager().sendRequest(tLRPC$TL_messages_getOnlines, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda296
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$updateTimerProc$135(long j, TLRPC$TL_messages_getMessagesViews tLRPC$TL_messages_getMessagesViews, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            ...
            for (int i = 0; i < tLRPC$TL_messages_getMessagesViews.f1521id.size() && i < tLRPC$TL_messages_messageViews.views.size(); i++) {
                ...
                if ((1 & tLRPC$TL_messageViews.flags) != 0) {
                    ...
                    sparseIntArray.put(tLRPC$TL_messages_getMessagesViews.f1521id.get(i).intValue(), tLRPC$TL_messageViews.views);
                }
                if ((tLRPC$TL_messageViews.flags & 2) != 0) {
                    ...
                    sparseIntArray2.put(tLRPC$TL_messages_getMessagesViews.f1521id.get(i).intValue(), tLRPC$TL_messageViews.forwards);
                }
                if ((tLRPC$TL_messageViews.flags & 4) != 0) {
                    ...
                    sparseArray.put(tLRPC$TL_messages_getMessagesViews.f1521id.get(i).intValue(), tLRPC$TL_messageViews.replies);
                }
            }
    ...
    public /* synthetic */ void lambda$updateTimerProc$134(TLRPC$TL_messages_messageViews tLRPC$TL_messages_messageViews, LongSparseArray longSparseArray, LongSparseArray longSparseArray2, LongSparseArray longSparseArray3) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$updateTimerProc$137(int r18) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L73:
            ...
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda361 r9 = new org.telegram.messenger.MessagesController$$ExternalSyntheticLambda361
            r9.<init>()
    ...
    public /* synthetic */ void lambda$updateTimerProc$136(boolean z, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$updateTimerProc$140(final long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
    ...
    public /* synthetic */ void lambda$updateTimerProc$139(long j, TLRPC$TL_chatOnlines tLRPC$TL_chatOnlines) {
    ...
    public /* synthetic */ void lambda$updateTimerProc$141() {
    ...
    public /* synthetic */ void lambda$checkTosUpdate$143(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.checkingTosUpdate = false;
    ...
    public /* synthetic */ void lambda$checkTosUpdate$142(TLRPC$TL_help_termsOfServiceUpdate tLRPC$TL_help_termsOfServiceUpdate) {
    ...
    public void checkPromoInfo(final boolean z) {
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda225
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void lambda$checkPromoInfo$144(boolean z) {
        ...
        if ((z || this.nextPromoInfoCheckTime <= getConnectionsManager().getCurrentTime()) && !this.checkingPromoInfo) {
            ...
            }, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda292
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$checkPromoInfoInternal$149(final int r17, java.lang.String r18, java.lang.String r19, org.telegram.tgnet.TLObject r20, org.telegram.tgnet.TLRPC$TL_error r21) {
        /*
    ...
    public /* synthetic */ void lambda$checkPromoInfoInternal$148(final long j, final TLRPC$TL_help_promoData tLRPC$TL_help_promoData, final int i) {
        TLRPC$Dialog tLRPC$Dialog = this.promoDialog;
        if (tLRPC$Dialog != null && j != tLRPC$Dialog.f1433id) {
            removePromoDialog();
        }
        ...
        tLRPC$TL_messages_getPeerDialogs.peers.add(tLRPC$TL_inputDialogPeer);
        this.checkingPromoInfoRequestId = getConnectionsManager().sendRequest(tLRPC$TL_messages_getPeerDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda294
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$checkPromoInfoInternal$147(int i, final TLRPC$TL_help_promoData tLRPC$TL_help_promoData, final long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$checkPromoInfoInternal$145(TLRPC$TL_help_promoData tLRPC$TL_help_promoData, TLRPC$TL_messages_peerDialogs tLRPC$TL_messages_peerDialogs, long j) {
        ...
        if (DialogObject.isChannel(tLRPC$Dialog2)) {
            ...
            longSparseIntArray.put(-tLRPC$Dialog3.f1433id, tLRPC$Dialog3.pts);
        }
        Integer num = this.dialogs_read_inbox_max.get(Long.valueOf(this.promoDialog.f1433id));
        if (num == null) {
            num = r2;
        }
        this.dialogs_read_inbox_max.put(Long.valueOf(this.promoDialog.f1433id), Integer.valueOf(Math.max(num.intValue(), this.promoDialog.read_inbox_max_id)));
        Integer num2 = this.dialogs_read_outbox_max.get(Long.valueOf(this.promoDialog.f1433id));
        this.dialogs_read_outbox_max.put(Long.valueOf(this.promoDialog.f1433id), Integer.valueOf(Math.max((num2 != null ? num2 : 0).intValue(), this.promoDialog.read_outbox_max_id)));
    ...
    public /* synthetic */ void lambda$checkPromoInfoInternal$146() {
        TLRPC$Dialog tLRPC$Dialog = this.promoDialog;
        if (tLRPC$Dialog != null) {
            long j = tLRPC$Dialog.f1433id;
            if (j < 0) {
    ...
    public boolean isPromoDialog(long j, boolean z) {
        TLRPC$Dialog tLRPC$Dialog = this.promoDialog;
        return tLRPC$Dialog != null && tLRPC$Dialog.f1433id == j && (!z || this.isLeftPromoChannel);
    }
                ...
                if (key.longValue() > 0 || isEncryptedDialog || value.size() == 1) {
                    ...
                    if (user != null) {
                        ...
                        if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageRecordAudioAction) {
                            if (z) {
                                string3 = LocaleController.formatString("IsRecordingAudio", C3242R.string.IsRecordingAudio, getUserNameForTyping(user));
                            } else {
                                string3 = LocaleController.getString("RecordingAudio", C3242R.string.RecordingAudio);
                            }
                            it = it2;
                            string = string3;
                            i = 1;
                            ...
                            if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageRecordRoundAction) {
                                if (z) {
                                    string2 = LocaleController.formatString("IsRecordingRound", C3242R.string.IsRecordingRound, getUserNameForTyping(user));
                                } else {
                                    string2 = LocaleController.getString("RecordingRound", C3242R.string.RecordingRound);
                                }
                                it = it2;
                                string = string2;
                            } else {
                                ...
                                if (!(tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageUploadRoundAction)) {
                                    if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageUploadAudioAction) {
                                        if (z) {
                                            string = LocaleController.formatString("IsSendingAudio", C3242R.string.IsSendingAudio, getUserNameForTyping(user));
                                        } else {
                                            string = LocaleController.getString("SendingAudio", C3242R.string.SendingAudio);
                                        }
                                    } else if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageUploadVideoAction) {
                                        if (z) {
                                            string = LocaleController.formatString("IsSendingVideo", C3242R.string.IsSendingVideo, getUserNameForTyping(user));
                                        } else {
                                            string = LocaleController.getString("SendingVideoStatus", C3242R.string.SendingVideoStatus);
                                        }
                                    } else if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageRecordVideoAction) {
                                        if (z) {
                                            string = LocaleController.formatString("IsRecordingVideo", C3242R.string.IsRecordingVideo, getUserNameForTyping(user));
                                        } else {
                                            string = LocaleController.getString("RecordingVideoStatus", C3242R.string.RecordingVideoStatus);
                                        }
                                    } else if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageUploadDocumentAction) {
                                        if (z) {
                                            string = LocaleController.formatString("IsSendingFile", C3242R.string.IsSendingFile, getUserNameForTyping(user));
                                        } else {
                                            string = LocaleController.getString("SendingFile", C3242R.string.SendingFile);
                                        }
                                    } else if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageUploadPhotoAction) {
                                        if (z) {
                                            string = LocaleController.formatString("IsSendingPhoto", C3242R.string.IsSendingPhoto, getUserNameForTyping(user));
                                        } else {
                                            string = LocaleController.getString("SendingPhoto", C3242R.string.SendingPhoto);
                                        }
                                    } else if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageGamePlayAction) {
                                        if (z) {
                                            string = LocaleController.formatString("IsSendingGame", C3242R.string.IsSendingGame, getUserNameForTyping(user));
                                        } else {
                                            string = LocaleController.getString("SendingGame", C3242R.string.SendingGame);
                                        }
                                        i = 3;
                                    } else {
                                        if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageGeoLocationAction) {
                                            if (z) {
                                                string = LocaleController.formatString("IsSelectingLocation", C3242R.string.IsSelectingLocation, getUserNameForTyping(user));
                                            } else {
                                                string = LocaleController.getString("SelectingLocation", C3242R.string.SelectingLocation);
                                            }
                                            ...
                                            if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageEmojiInteractionSeen) {
                                                ...
                                                if (z) {
                                                    string = LocaleController.formatString("IsEnjoyngAnimations", C3242R.string.IsEnjoyngAnimations, getUserNameForTyping(user), str3);
                                                } else {
                                                    string = LocaleController.formatString("EnjoyngAnimations", C3242R.string.EnjoyngAnimations, str3);
                                                }
                                            } else if (tLRPC$SendMessageAction instanceof TLRPC$TL_sendMessageChooseStickerAction) {
                                                if (z) {
                                                    string = LocaleController.formatString("IsChoosingSticker", C3242R.string.IsChoosingSticker, getUserNameForTyping(user));
                                                } else {
                                                    string = LocaleController.getString("ChoosingSticker", C3242R.string.ChoosingSticker);
                                                }
                                            } else if (z) {
                                                string = LocaleController.formatString("IsTypingGroup", C3242R.string.IsTypingGroup, getUserNameForTyping(user));
                                            } else {
                                                string = LocaleController.getString("Typing", C3242R.string.Typing);
                                            }
                                            i = 5;
                                        } else if (z) {
                                            string = LocaleController.formatString("IsSelectingContact", C3242R.string.IsSelectingContact, getUserNameForTyping(user));
                                        } else {
                                            string = LocaleController.getString("SelectingContact", C3242R.string.SelectingContact);
                                        }
                                        i = 0;
                                    }
                                    i = 2;
                    ...
                    if (sb.length() != 0) {
                        if (i3 == 1) {
                            str2 = LocaleController.formatString("IsTypingGroup", C3242R.string.IsTypingGroup, sb.toString());
                            ...
                            i2 = 0;
                            str = LocaleController.formatString("AreTypingGroup", C3242R.string.AreTypingGroup, sb.toString());
                            it = it2;
                        }
                        str = str2;
                        i2 = 0;
    ...
    public /* synthetic */ void lambda$updatePrintingStrings$150(LongSparseArray longSparseArray, LongSparseArray longSparseArray2) {
    ...
    public boolean sendTyping(final long j, final int i, final int i2, String str, int i3) {
        ...
        if (i4 < 0) {
            ...
            TLRPC$User user = getUser(Long.valueOf(j));
            if (user != null) {
                if (user.f1567id == getUserConfig().getClientUserId()) {
                    return false;
                }
                TLRPC$UserStatus tLRPC$UserStatus = user.status;
                if (tLRPC$UserStatus != null && tLRPC$UserStatus.expires != -100 && !this.onlinePrivacy.containsKey(Long.valueOf(user.f1567id))) {
        ...
        if (!DialogObject.isEncryptedDialog(j)) {
            ...
            int sendRequest = getConnectionsManager().sendRequest(tLRPC$TL_messages_setTyping, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda290
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (bArr != null && bArr.length > 1 && (encryptedChat instanceof TLRPC$TL_encryptedChat)) {
                ...
                tLRPC$TL_inputEncryptedChat.chat_id = encryptedChat.f1439id;
                tLRPC$TL_inputEncryptedChat.access_hash = encryptedChat.access_hash;
                tLRPC$TL_messages_setEncryptedTyping.typing = true;
                sparseArray.put(i, Boolean.TRUE);
                int sendRequest2 = getConnectionsManager().sendRequest(tLRPC$TL_messages_setEncryptedTyping, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda289
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$sendTyping$154(final int i, final long j, final int i2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if ((i9 == 0 || z6) && i8 != 2 && (z2 || DialogObject.isEncryptedDialog(j))) {
            ...
            if (z4 && z6 && i6 == 2 && i7 == 0 && (findTopic = this.topicsController.findTopic(-j, i9)) != null) {
                ...
                if (i6 == 4) {
                    ...
                    getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_messages_getReplies, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda286
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            if (i8 == 1) {
                ...
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_messages_getScheduledHistory, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda287
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                ...
                tLRPC$TL_inputDialogPeer.peer = inputPeer;
                tLRPC$TL_messages_getPeerDialogs.peers.add(tLRPC$TL_inputDialogPeer);
                getConnectionsManager().sendRequest(tLRPC$TL_messages_getPeerDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda319
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                ...
                if (i6 == 4) {
                    ...
                    getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_messages_getHistory, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda311
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadMessagesInternal$156(int i, int i2, int i3, int i4, int i5, long j, long j2, final int i6, int i7, int i8, int i9, int i10, int i11, boolean z, int i12, boolean z2, boolean z3, final TLRPC$TL_messages_getReplies tLRPC$TL_messages_getReplies, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (tLObject != null) {
            ...
            if (!tLRPC$messages_Messages.messages.isEmpty()) {
                if (i3 != 0) {
                    int i15 = tLRPC$messages_Messages.messages.get(arrayList.size() - 1).f1451id;
                    ...
                    if (i5 == 2 && i2 > 0) {
                        for (int size2 = tLRPC$messages_Messages.messages.size() - 1; size2 >= 0; size2--) {
                            ...
                            int i16 = tLRPC$Message2.f1451id;
    ...
    public /* synthetic */ void lambda$loadMessagesInternal$155(int i, TLRPC$TL_messages_getReplies tLRPC$TL_messages_getReplies, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadMessagesInternal$157(int i, int i2, long j, long j2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, boolean z, int i13, boolean z2, boolean z3, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        int i14;
        ArrayList<TLRPC$Message> arrayList;
        if (tLObject != null) {
            TLRPC$messages_Messages tLRPC$messages_Messages = (TLRPC$messages_Messages) tLObject;
    ...
    public /* synthetic */ void lambda$loadMessagesInternal$159(long j, long j2, boolean z, int i, int i2, int i3, int i4, final int i5, int i6, int i7, int i8, int i9, int i10, boolean z2, boolean z3, boolean z4, final TLRPC$TL_messages_getPeerDialogs tLRPC$TL_messages_getPeerDialogs, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            TLRPC$TL_messages_peerDialogs tLRPC$TL_messages_peerDialogs = (TLRPC$TL_messages_peerDialogs) tLObject;
    ...
    public /* synthetic */ void lambda$loadMessagesInternal$158(int i, TLRPC$TL_messages_getPeerDialogs tLRPC$TL_messages_getPeerDialogs, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadMessagesInternal$161(long j, int i, int i2, int i3, long j2, final int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, boolean z, int i12, boolean z2, boolean z3, final TLRPC$TL_messages_getHistory tLRPC$TL_messages_getHistory, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        int i13;
        ArrayList<TLRPC$Message> arrayList;
        if (tLObject != null) {
            TLRPC$messages_Messages tLRPC$messages_Messages = (TLRPC$messages_Messages) tLObject;
            ...
            if (i3 == 0 || tLRPC$messages_Messages.messages.isEmpty()) {
                ...
                int i14 = tLRPC$messages_Messages.messages.get(arrayList.size() - 1).f1451id;
                int size = tLRPC$messages_Messages.messages.size() - 1;
                while (true) {
                    if (size < 0) {
                        break;
    ...
    public /* synthetic */ void lambda$loadMessagesInternal$160(int i, TLRPC$TL_messages_getHistory tLRPC$TL_messages_getHistory, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void reloadWebPages(final long j, HashMap<String, ArrayList<MessageObject>> hashMap, final boolean z) {
        ...
        for (Map.Entry<String, ArrayList<MessageObject>> entry : hashMap.entrySet()) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_messages_getWebPagePreview, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda343
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$reloadWebPages$163(final HashMap hashMap, final String str, final LongSparseArray longSparseArray, final long j, final boolean z, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$reloadWebPages$162(HashMap hashMap, String str, TLObject tLObject, LongSparseArray longSparseArray, long j, boolean z) {
        ...
        if (!(tLObject instanceof TLRPC$TL_messageMediaWebPage)) {
            ...
            if ((tLRPC$WebPage instanceof TLRPC$TL_webPage) || (tLRPC$WebPage instanceof TLRPC$TL_webPageEmpty)) {
                ...
                longSparseArray.put(tLRPC$WebPage.f1576id, arrayList);
            }
        }
    ...
    */
    ...
    public /* synthetic */ void lambda$processLoadedMessages$164(long j, long j2, int i, int i2, boolean z, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, boolean z2, boolean z3) {
        loadMessagesInternal(j, j2, false, i, (i2 == 2 && z) ? i3 : i4, i5, false, i6, i7, i2, i8, i9, i10, i11, i3, i12, i13, z, i14, true, z2, z3);
    }

    public /* synthetic */ void lambda$processLoadedMessages$165(int i, TLRPC$messages_Messages tLRPC$messages_Messages, boolean z, boolean z2, int i2) {
    ...
    public /* synthetic */ void lambda$processLoadedMessages$167(TLRPC$messages_Messages tLRPC$messages_Messages, final boolean z, final boolean z2, final int i, boolean z3, final int i2, int i3, final int i4, final long j, final ArrayList arrayList, int i5, final int i6, final int i7, final boolean z4, final int i8, final int i9, final int i10, final int i11, final int i12, final int i13, ArrayList arrayList2, HashMap hashMap) {
        int i14;
        int i15;
        int i16;
        int i17;
        ...
        if (i == 1) {
            ...
            if (z3 && i2 == 2) {
                ...
                for (int i19 = 0; i19 < tLRPC$messages_Messages.messages.size(); i19++) {
                    ...
                    if ((!tLRPC$Message.out || tLRPC$Message.from_scheduled) && (i17 = tLRPC$Message.f1451id) > i3 && i17 < i15) {
                        i15 = i17;
                    }
                }
                i14 = i3;
        ...
        if (!DialogObject.isEncryptedDialog(j)) {
            final int i20 = i16;
            getMediaDataController().loadReplyMessagesForMessages(arrayList, j, i == 1, i5, new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda226
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$processLoadedMessages$166(boolean z, int i, int i2, boolean z2, boolean z3, int i3, long j, int i4, ArrayList arrayList, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12) {
        if (!z) {
    ...
    public void loadHintDialogs() {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_help_getRecentMeUrls, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda272
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadHintDialogs$169(final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
    ...
    public /* synthetic */ void lambda$loadHintDialogs$168(TLObject tLObject) {
    ...
    private TLRPC$TL_dialogFolder ensureFolderDialogExists(int i, boolean[] zArr) {
        ...
        tLRPC$TL_dialogFolder.f1433id = makeFolderDialogId;
        ...
        tLRPC$TL_folder.f1479id = i;
        tLRPC$TL_folder.title = LocaleController.getString("ArchivedChats", C3242R.string.ArchivedChats);
        ...
        for (int i3 = 0; i3 < this.allDialogs.size(); i3++) {
            ...
            if (!tLRPC$Dialog2.pinned) {
                if (tLRPC$Dialog2.f1433id != this.promoDialogId) {
                    break;
                }
            } else {
    ...
    */
    ...
    public /* synthetic */ void lambda$addDialogToFolder$171(long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            processUpdates((TLRPC$Updates) tLObject, false);
        }
        if (j != 0) {
    ...
    public void loadDialogs(final int i, int i2, final int i3, boolean z, final Runnable runnable) {
        ...
        if (dialogLoadOffsets[0] != -1) {
            ...
            while (true) {
                ...
                if (!tLRPC$Dialog.pinned && !DialogObject.isEncryptedDialog(tLRPC$Dialog.f1433id) && tLRPC$Dialog.top_message > 0) {
                    ArrayList<MessageObject> arrayList = this.dialogMessage.get(tLRPC$Dialog.f1433id);
                    ...
                    if (messageObject != null && messageObject.getId() > 0) {
                        ...
                        tLRPC$TL_messages_getDialogs.offset_id = tLRPC$Message.f1451id;
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_getDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda288
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadDialogs$172(int i, int i2, Runnable runnable, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
    ...
    public void loadGlobalNotificationsSettings() {
        if (this.loadingNotificationSettings == 0 && !getUserConfig().notificationsSettingsLoaded) {
            ...
            for (final int i = 0; i < 3; i++) {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_account_getNotifySettings, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda282
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadGlobalNotificationsSettings$174(final int i, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadGlobalNotificationsSettings$173(TLObject tLObject, int i) {
        if (tLObject != null) {
    ...
    public void loadSignUpNotificationsSettings() {
        ...
        }, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda266
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadSignUpNotificationsSettings$176(final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadSignUpNotificationsSettings$175(TLObject tLObject) {
    ...
    public void loadUnknownDialog(TLRPC$InputPeer tLRPC$InputPeer, long j) {
        ...
        if (j == 0) {
            ...
            try {
                ...
                final long j2 = j;
                getConnectionsManager().sendRequest(tLRPC$TL_messages_getPeerDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda316
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadUnknownDialog$177(long j, long j2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            TLRPC$TL_messages_peerDialogs tLRPC$TL_messages_peerDialogs = (TLRPC$TL_messages_peerDialogs) tLObject;
            if (!tLRPC$TL_messages_peerDialogs.dialogs.isEmpty()) {
                TLRPC$TL_messages_dialogs tLRPC$TL_messages_dialogs = new TLRPC$TL_messages_dialogs();
            ...
            if (tLRPC$Dialog instanceof TLRPC$TL_dialogFolder) {
                ...
                if (tLRPC$TL_dialogFolder.top_message == 0 || peerDialogId == 0) {
                    ...
                    for (int i3 = 0; i3 < size2; i3++) {
                        ...
                        if (peerDialogId == MessageObject.getDialogId(tLRPC$Message) && tLRPC$Dialog.top_message == tLRPC$Message.f1451id) {
                            TLRPC$TL_dialog tLRPC$TL_dialog = new TLRPC$TL_dialog();
                            tLRPC$TL_dialog.peer = tLRPC$Dialog.peer;
                            tLRPC$TL_dialog.top_message = tLRPC$Dialog.top_message;
                            tLRPC$TL_dialog.folder_id = tLRPC$TL_dialogFolder.folder.f1479id;
                            ...
                            if (tLRPC$Peer instanceof TLRPC$TL_peerChannel) {
                                ...
                                while (true) {
                                    ...
                                    if (tLRPC$Chat.f1427id == tLRPC$TL_inputPeerUser.channel_id) {
                                ...
                                while (true) {
                                    ...
                                    TLRPC$User tLRPC$User = tLRPC$TL_messages_peerDialogs.users.get(i);
                                    if (tLRPC$User.f1567id == tLRPC$TL_inputPeerUser.user_id) {
                                        tLRPC$TL_inputPeerUser.access_hash = tLRPC$User.access_hash;
                                        break;
                                    }
                                    i++;
    ...
    */
    ...
    public /* synthetic */ void lambda$completeDialogsReset$181(int i, int i2, int i3, final TLRPC$messages_Dialogs tLRPC$messages_Dialogs, final LongSparseArray longSparseArray, final LongSparseArray longSparseArray2) {
        this.gettingDifference = false;
    ...
    public /* synthetic */ void lambda$completeDialogsReset$180(TLRPC$messages_Dialogs tLRPC$messages_Dialogs, LongSparseArray longSparseArray, LongSparseArray longSparseArray2) {
        ...
        for (int i = 0; i < this.allDialogs.size(); i++) {
            ...
            if (!DialogObject.isEncryptedDialog(tLRPC$Dialog2.f1433id)) {
                this.dialogs_dict.remove(tLRPC$Dialog2.f1433id);
                ArrayList<MessageObject> arrayList = this.dialogMessage.get(tLRPC$Dialog2.f1433id);
                this.dialogMessage.remove(tLRPC$Dialog2.f1433id);
                if (arrayList != null) {
                    for (int i2 = 0; i2 < arrayList.size(); i2++) {
        ...
        for (int i3 = 0; i3 < longSparseArray.size(); i3++) {
            ...
            if (tLRPC$DraftMessage instanceof TLRPC$TL_draftMessage) {
                ...
                mediaDataController.saveDraft(tLRPC$Dialog3.f1433id, 0, tLRPC$DraftMessage, null, false);
            } else {
                tLRPC$Dialog = tLRPC$Dialog3;
            }
            this.dialogs_dict.put(keyAt, tLRPC$Dialog);
            ArrayList<MessageObject> arrayList2 = (ArrayList) longSparseArray2.get(tLRPC$Dialog.f1433id);
    ...
    private void migrateDialogs(final int i, int i2, long j, long j2, long j3, long j4) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_getDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda280
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$migrateDialogs$185(final int i, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$migrateDialogs$183(org.telegram.tgnet.TLRPC$messages_Dialogs r36, int r37) {
        /*
    ...
    public /* synthetic */ void lambda$migrateDialogs$184() {
        this.migratingDialogs = false;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$processLoadedDialogs$189(final int r32, final int r33, final org.telegram.tgnet.TLRPC$messages_Dialogs r34, final java.util.ArrayList r35, final boolean r36, final int r37, final java.util.ArrayList r38, final int r39, final boolean r40, final boolean r41) {
        /*
    ...
    public /* synthetic */ void lambda$processLoadedDialogs$186(TLRPC$messages_Dialogs tLRPC$messages_Dialogs, ArrayList arrayList, int i, boolean z, long[] jArr, int i2) {
        putUsers(tLRPC$messages_Dialogs.users, true);
        if (arrayList != null) {
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                long j = ((TLRPC$UserFull) arrayList.get(i3)).f1568id;
    ...
    public /* synthetic */ void lambda$processLoadedDialogs$187(TLRPC$Chat tLRPC$Chat) {
        checkChatInviter(tLRPC$Chat.f1427id, true);
    }
    ...
    */
    ...
    public void reloadMentionsCountForChannel(final TLRPC$InputPeer tLRPC$InputPeer, final long j) {
        ...
        if (j == 0) {
            ...
            try {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_messages_getUnreadMentions, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda351
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_getUnreadMentions2, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda351
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                MessagesController.this.lambda$reloadMentionsCountForChannel$190(tLRPC$InputPeer, j, tLObject, tLRPC$TL_error);
            }
    ...
    public /* synthetic */ void lambda$reloadMentionsCountForChannel$190(TLRPC$InputPeer tLRPC$InputPeer, long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        TLRPC$messages_Messages tLRPC$messages_Messages = (TLRPC$messages_Messages) tLObject;
    ...
    public /* synthetic */ void lambda$reloadMentionsCountForChannels$191(ArrayList arrayList) {
        for (int i = 0; i < arrayList.size(); i++) {
    ...
    public /* synthetic */ void lambda$processDialogsUpdateRead$192(LongSparseIntArray longSparseIntArray, LongSparseIntArray longSparseIntArray2) {
        boolean z;
                ...
                if (tLRPC$Dialog == null) {
                    ...
                    while (true) {
                        if (i2 >= this.allDialogs.size()) {
                            break;
                        } else if (this.allDialogs.get(i2).f1433id == keyAt) {
        ...
        if (longSparseIntArray2 != null) {
            for (int i6 = 0; i6 < longSparseIntArray2.size(); i6++) {
                ...
                if (tLRPC$Dialog2 != null) {
                    ...
                    if (this.createdDialogMainThreadIds.contains(Long.valueOf(tLRPC$Dialog2.f1433id))) {
                        getNotificationCenter().postNotificationName(NotificationCenter.updateMentionsCount, Long.valueOf(tLRPC$Dialog2.f1433id), 0, Integer.valueOf(tLRPC$Dialog2.unread_mentions_count));
                    }
                    if (!z) {
    ...
    public void checkLastDialogMessage(final TLRPC$Dialog tLRPC$Dialog, TLRPC$InputPeer tLRPC$InputPeer, final long j) {
        NativeByteBuffer nativeByteBuffer;
        Exception e;
        if (DialogObject.isEncryptedDialog(tLRPC$Dialog.f1433id) || this.checkingLastMessagesDialogs.indexOfKey(tLRPC$Dialog.f1433id) >= 0) {
            return;
        }
        TLRPC$TL_messages_getHistory tLRPC$TL_messages_getHistory = new TLRPC$TL_messages_getHistory();
        if (tLRPC$InputPeer == null) {
            tLRPC$InputPeer = getInputPeer(tLRPC$Dialog.f1433id);
        }
        ...
        this.checkingLastMessagesDialogs.put(tLRPC$Dialog.f1433id, Boolean.TRUE);
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m48d("checkLastDialogMessage for " + tLRPC$Dialog.f1433id);
        }
        if (j == 0) {
            try {
            ...
            try {
                ...
                nativeByteBuffer.writeInt64(tLRPC$Dialog.f1433id);
                ...
                FileLog.m45e(e);
                j = getMessagesStorage().createPendingTask(nativeByteBuffer);
                getConnectionsManager().sendRequest(tLRPC$TL_messages_getHistory, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda350
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$checkLastDialogMessage$196(final TLRPC$Dialog tLRPC$Dialog, long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            TLRPC$messages_Messages tLRPC$messages_Messages = (TLRPC$messages_Messages) tLObject;
            removeDeletedMessagesFromArray(tLRPC$Dialog.f1433id, tLRPC$messages_Messages.messages);
            if (!tLRPC$messages_Messages.messages.isEmpty()) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m48d("checkLastDialogMessage for " + tLRPC$Dialog.f1433id + " has message");
                }
                TLRPC$TL_messages_dialogs tLRPC$TL_messages_dialogs = new TLRPC$TL_messages_dialogs();
                TLRPC$Message tLRPC$Message = tLRPC$messages_Messages.messages.get(0);
                TLRPC$TL_dialog tLRPC$TL_dialog = new TLRPC$TL_dialog();
                tLRPC$TL_dialog.flags = tLRPC$Dialog.flags;
                tLRPC$TL_dialog.top_message = tLRPC$Message.f1451id;
                ...
                long j2 = tLRPC$Dialog.f1433id;
                tLRPC$TL_dialog.f1433id = j2;
                tLRPC$Message.dialog_id = j2;
                if (getAlbumsController().isDialogAlbum(tLRPC$Dialog.f1433id)) {
    ...
    public /* synthetic */ void lambda$checkLastDialogMessage$194(final TLRPC$Dialog tLRPC$Dialog) {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m48d("checkLastDialogMessage for " + tLRPC$Dialog.f1433id + " has not message");
        }
        if (getMediaDataController().getDraft(tLRPC$Dialog.f1433id, 0) == null) {
            TLRPC$Dialog tLRPC$Dialog2 = this.dialogs_dict.get(tLRPC$Dialog.f1433id);
            if (tLRPC$Dialog2 == null) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m48d("checkLastDialogMessage for " + tLRPC$Dialog.f1433id + " current dialog not found");
                }
                getMessagesStorage().isDialogHasTopMessage(tLRPC$Dialog.f1433id, new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda171
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m48d("checkLastDialogMessage for " + tLRPC$Dialog.f1433id + " current dialog top message " + tLRPC$Dialog2.top_message);
            }
            if (tLRPC$Dialog2.top_message == 0) {
                deleteDialog(tLRPC$Dialog.f1433id, 3);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$checkLastDialogMessage$195(TLRPC$Dialog tLRPC$Dialog) {
        this.checkingLastMessagesDialogs.delete(tLRPC$Dialog.f1433id);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$processDialogsUpdate$198(final org.telegram.tgnet.TLRPC$messages_Dialogs r20, final boolean r21) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$processDialogsUpdate$197(org.telegram.tgnet.TLRPC$messages_Dialogs r21, androidx.collection.LongSparseArray r22, androidx.collection.LongSparseArray r23, boolean r24, org.telegram.messenger.support.LongSparseIntArray r25) {
        /*
    ...
    public /* synthetic */ void lambda$addToViewsQueue$199(MessageObject messageObject) {
    ...
    public void markMessageContentAsRead(MessageObject messageObject) {
        ...
        if (messageObject.getId() < 0) {
            ...
            tLRPC$TL_channels_readMessageContents.f1470id.add(Integer.valueOf(messageObject.getId()));
            getConnectionsManager().sendRequest(tLRPC$TL_channels_readMessageContents, MessagesController$$ExternalSyntheticLambda383.INSTANCE);
        } else {
            TLRPC$TL_messages_readMessageContents tLRPC$TL_messages_readMessageContents = new TLRPC$TL_messages_readMessageContents();
            tLRPC$TL_messages_readMessageContents.f1527id.add(Integer.valueOf(messageObject.getId()));
            getConnectionsManager().sendRequest(tLRPC$TL_messages_readMessageContents, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda274
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$markMessageContentAsRead$201(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            TLRPC$TL_messages_affectedMessages tLRPC$TL_messages_affectedMessages = (TLRPC$TL_messages_affectedMessages) tLObject;
            processNewDifferenceParams(-1, tLRPC$TL_messages_affectedMessages.pts, -1, tLRPC$TL_messages_affectedMessages.pts_count);
        }
    ...
    public void markMentionMessageAsRead(int i, long j, long j2) {
        ...
        if (j != 0) {
            ...
            tLRPC$TL_channels_readMessageContents.f1470id.add(Integer.valueOf(i));
            getConnectionsManager().sendRequest(tLRPC$TL_channels_readMessageContents, MessagesController$$ExternalSyntheticLambda372.INSTANCE);
            return;
        }
        TLRPC$TL_messages_readMessageContents tLRPC$TL_messages_readMessageContents = new TLRPC$TL_messages_readMessageContents();
        tLRPC$TL_messages_readMessageContents.f1527id.add(Integer.valueOf(i));
    ...
    public /* synthetic */ void lambda$markMentionMessageAsRead$203(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            TLRPC$TL_messages_affectedMessages tLRPC$TL_messages_affectedMessages = (TLRPC$TL_messages_affectedMessages) tLObject;
            processNewDifferenceParams(-1, tLRPC$TL_messages_affectedMessages.pts, -1, tLRPC$TL_messages_affectedMessages.pts_count);
        }
    ...
    */
    public void markMessageAsRead2(long r15, int r17, org.telegram.tgnet.TLRPC$InputChannel r18, int r19, long r20) {
        ...
        L63:
            ...
            r0.<init>()
            r0.channel = r11
            java.util.ArrayList<java.lang.Integer> r2 = r0.f1470id
            java.lang.Integer r3 = java.lang.Integer.valueOf(r17)
            r2.add(r3)
            org.telegram.tgnet.ConnectionsManager r2 = r14.getConnectionsManager()
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda305 r3 = new org.telegram.messenger.MessagesController$$ExternalSyntheticLambda305
            r3.<init>()
        ...
        L98:
            ...
            r0.<init>()
            java.util.ArrayList<java.lang.Integer> r2 = r0.f1527id
            java.lang.Integer r3 = java.lang.Integer.valueOf(r17)
            r2.add(r3)
            org.telegram.tgnet.ConnectionsManager r2 = r14.getConnectionsManager()
    ...
    public void markMessageAsRead(long j, long j2, int i) {
        ...
        if ((i > 0 || i == Integer.MIN_VALUE) && DialogObject.isEncryptedDialog(j) && (encryptedChat = getEncryptedChat(Integer.valueOf(DialogObject.getEncryptedChatId(j)))) != null) {
            ...
            if (i > 0) {
                int currentTime = getConnectionsManager().getCurrentTime();
                getMessagesStorage().createTaskForSecretChat(encryptedChat.f1439id, currentTime, currentTime, 0, arrayList);
            }
        }
    }
    ...
    private void completeReadTask(ReadTask readTask) {
        ...
        if (readTask.replyId != 0) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_messages_readDiscussion, MessagesController$$ExternalSyntheticLambda374.INSTANCE);
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_messages_readHistory, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda276
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_messages_readEncryptedHistory, MessagesController$$ExternalSyntheticLambda382.INSTANCE);
        }
    }

    public /* synthetic */ void lambda$completeReadTask$207(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$markDialogAsReadNow$209(int i, long j) {
        if (i != 0) {
            String str = j + "_" + i;
    ...
    */
    public void markDialogAsRead(final long r16, final int r18, final int r19, final int r20, final boolean r21, final int r22, final int r23, final boolean r24, int r25) {
        ...
        Lce:
            ...
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda56 r12 = new org.telegram.messenger.MessagesController$$ExternalSyntheticLambda56
            r0 = r12
            r1 = r15
            r2 = r22
            r3 = r16
    ...
    public /* synthetic */ void lambda$markDialogAsRead$212(final long j, final int i, final int i2, final boolean z) {
    ...
    public /* synthetic */ void lambda$markDialogAsRead$211(long j, int i, int i2, boolean z) {
        TLRPC$Dialog tLRPC$Dialog = this.dialogs_dict.get(j);
        if (tLRPC$Dialog != null) {
            int i3 = tLRPC$Dialog.unread_count;
            ...
            if (z2) {
                ...
                getMessagesStorage().setDialogUnread(tLRPC$Dialog.f1433id, false);
            }
    ...
    public /* synthetic */ void lambda$markDialogAsRead$214(final long j, final int i, final boolean z, final int i2, final int i3) {
    ...
    public /* synthetic */ void lambda$markDialogAsRead$213(long j, int i, boolean z, int i2, int i3) {
    ...
    public /* synthetic */ void lambda$markDialogAsRead$215(int i, long j, boolean z, int i2, int i3) {
        ReadTask readTask;
        if (i != 0) {
    ...
    public int createChat(String str, ArrayList<Long> arrayList, String str2, int i, boolean z, Location location, String str3, int i2, final BaseFragment baseFragment, final Callbacks$Callback1<Long> callbacks$Callback1) {
        if (i == 0 && !z) {
            ...
            return getConnectionsManager().sendRequest(tLRPC$TL_messages_createChat, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda357
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            return getConnectionsManager().sendRequest(tLRPC$TL_channels_createChannel, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda335
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    MessagesController.this.lambda$createChat$221(callbacks$Callback1, baseFragment, tLRPC$TL_channels_createChannel, tLObject, tLRPC$TL_error);
                }
            }, 2);
        } else {
            return 0;
    ...
    public /* synthetic */ void lambda$createChat$218(final BaseFragment baseFragment, final TLRPC$TL_messages_createChat tLRPC$TL_messages_createChat, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error != null) {
    ...
    public /* synthetic */ void lambda$createChat$216(TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLRPC$TL_messages_createChat tLRPC$TL_messages_createChat) {
    ...
    public /* synthetic */ void lambda$createChat$217(TLRPC$Updates tLRPC$Updates) {
        putUsers(tLRPC$Updates.users, false);
        putChats(tLRPC$Updates.chats, false);
        ArrayList<TLRPC$Chat> arrayList = tLRPC$Updates.chats;
        if (arrayList != null && !arrayList.isEmpty()) {
            getNotificationCenter().postNotificationName(NotificationCenter.chatDidCreated, Long.valueOf(tLRPC$Updates.chats.get(0).f1427id));
    ...
    public /* synthetic */ void lambda$createChat$221(final Callbacks$Callback1 callbacks$Callback1, final BaseFragment baseFragment, final TLRPC$TL_channels_createChannel tLRPC$TL_channels_createChannel, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda113
                @Override // java.lang.Runnable
                public final void run() {
                    MessagesController.this.lambda$createChat$219(callbacks$Callback1, tLRPC$TL_error, baseFragment, tLRPC$TL_channels_createChannel);
                }
            });
            return;
        }
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda202
            @Override // java.lang.Runnable
            public final void run() {
                MessagesController.this.lambda$createChat$220(tLRPC$Updates, callbacks$Callback1);
            }
        });
    }

    public /* synthetic */ void lambda$createChat$219(Callbacks$Callback1 callbacks$Callback1, TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLRPC$TL_channels_createChannel tLRPC$TL_channels_createChannel) {
    ...
    public /* synthetic */ void lambda$createChat$220(TLRPC$Updates tLRPC$Updates, Callbacks$Callback1 callbacks$Callback1) {
        putUsers(tLRPC$Updates.users, false);
        putChats(tLRPC$Updates.chats, false);
        ArrayList<TLRPC$Chat> arrayList = tLRPC$Updates.chats;
        if (arrayList != null && !arrayList.isEmpty()) {
            if (callbacks$Callback1 != null) {
                callbacks$Callback1.invoke(Long.valueOf(tLRPC$Updates.chats.get(0).f1427id));
            }
            getNotificationCenter().postNotificationName(NotificationCenter.chatDidCreated, Long.valueOf(tLRPC$Updates.chats.get(0).f1427id));
            return;
        }
    ...
    public void convertToMegaGroup(final Context context, long j, final BaseFragment baseFragment, final MessagesStorage.LongCallback longCallback, final Runnable runnable) {
        ...
        final int sendRequest = getConnectionsManager().sendRequest(tLRPC$TL_messages_migrateChat, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda334
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public static /* synthetic */ void lambda$convertToMegaGroup$222(Context context, AlertDialog alertDialog) {
    ...
    public static /* synthetic */ void lambda$convertToMegaGroup$223(MessagesStorage.LongCallback longCallback, TLRPC$Updates tLRPC$Updates) {
        if (longCallback != null) {
            for (int i = 0; i < tLRPC$Updates.chats.size(); i++) {
                TLRPC$Chat tLRPC$Chat = tLRPC$Updates.chats.get(i);
                if (ChatObject.isChannel(tLRPC$Chat)) {
                    longCallback.run(tLRPC$Chat.f1427id);
                    return;
                }
            }
        }
    ...
    public /* synthetic */ void lambda$convertToMegaGroup$224(MessagesStorage.LongCallback longCallback, Context context, AlertDialog alertDialog, TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLRPC$TL_messages_migrateChat tLRPC$TL_messages_migrateChat) {
        if (longCallback != null) {
            longCallback.run(0L);
        }
    ...
    public /* synthetic */ void lambda$convertToMegaGroup$226(int i, DialogInterface dialogInterface) {
    ...
    public void convertToGigaGroup(final Context context, TLRPC$Chat tLRPC$Chat, final BaseFragment baseFragment, final MessagesStorage.BooleanCallback booleanCallback) {
        ...
        final int sendRequest = getConnectionsManager().sendRequest(tLRPC$TL_channels_convertToGigagroup, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda333
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public static /* synthetic */ void lambda$convertToGigaGroup$227(Context context, AlertDialog alertDialog) {
        if (((Activity) context).isFinishing()) {
            return;
        }
        try {
    ...
    public static /* synthetic */ void lambda$convertToGigaGroup$228(MessagesStorage.BooleanCallback booleanCallback) {
        if (booleanCallback != null) {
            booleanCallback.run(true);
        }
    }

    public /* synthetic */ void lambda$convertToGigaGroup$229(MessagesStorage.BooleanCallback booleanCallback, Context context, AlertDialog alertDialog, TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLRPC$TL_channels_convertToGigagroup tLRPC$TL_channels_convertToGigagroup) {
        if (booleanCallback != null) {
    ...
    public /* synthetic */ void lambda$convertToGigaGroup$231(int i, DialogInterface dialogInterface) {
        getConnectionsManager().cancelRequest(i, true);
    }
    ...
    public void addUsersToChannel(final long j, ArrayList<TLRPC$InputUser> arrayList, final BaseFragment baseFragment) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_inviteToChannel, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda356
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$addUsersToChannel$232(TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLRPC$TL_channels_inviteToChannel tLRPC$TL_channels_inviteToChannel) {
    ...
    public /* synthetic */ void lambda$addUsersToChannel$234(final BaseFragment baseFragment, final TLRPC$TL_channels_inviteToChannel tLRPC$TL_channels_inviteToChannel, final long j, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error != null) {
    ...
    public /* synthetic */ void lambda$addUsersToChannel$233(long j, TLObject tLObject) {
    ...
    public void setDefaultSendAs(final long j, long j2) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_saveDefaultSendAs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda295
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$setDefaultSendAs$235(long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void toggleChatNoForwards(long j, boolean z) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_toggleNoForwards, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda270
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$toggleChatNoForwards$237(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public /* synthetic */ void lambda$toggleChatNoForwards$236() {
    ...
    public void toggleChatJoinToSend(long j, boolean z, final Runnable runnable, final Runnable runnable2) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_toggleJoinToSend, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda339
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$toggleChatJoinToSend$239(Runnable runnable, Runnable runnable2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public /* synthetic */ void lambda$toggleChatJoinToSend$238() {
        getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_CHAT));
    }
    ...
    public void toggleChatJoinRequest(long j, boolean z, final Runnable runnable, final Runnable runnable2) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_toggleJoinRequest, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda340
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$toggleChatJoinRequest$241(Runnable runnable, Runnable runnable2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public /* synthetic */ void lambda$toggleChatJoinRequest$240() {
        getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_CHAT));
    }
    ...
    public void toggleChannelSignatures(long j, boolean z) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_toggleSignatures, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda279
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$toggleChannelSignatures$243(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public /* synthetic */ void lambda$toggleChannelSignatures$242() {
        getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_CHAT));
    }
    ...
    public void toggleChannelForum(long j, boolean z) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_toggleForum, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda259
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$toggleChannelForum$245(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public /* synthetic */ void lambda$toggleChannelForum$244() {
        getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_CHAT));
    }
    ...
    public void toggleChannelInvitesHistory(long j, boolean z) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_togglePreHistoryHidden, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda260
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$toggleChannelInvitesHistory$247(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public /* synthetic */ void lambda$toggleChannelInvitesHistory$246() {
        getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_CHAT));
    }
    ...
    public void updateChatAbout(long j, final String str, final TLRPC$ChatFull tLRPC$ChatFull) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_editChatAbout, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda349
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$updateChatAbout$249(final TLRPC$ChatFull tLRPC$ChatFull, final String str, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$updateChatAbout$248(TLRPC$ChatFull tLRPC$ChatFull, String str) {
    ...
    public void updateChannelUserName(final BaseFragment baseFragment, final long j, final String str, final Runnable runnable, final Runnable runnable2) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_updateUsername, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda324
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$updateChannelUserName$251(final long j, final String str, final Runnable runnable, BaseFragment baseFragment, TLRPC$TL_channels_updateUsername tLRPC$TL_channels_updateUsername, Runnable runnable2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$updateChannelUserName$250(long j, String str, Runnable runnable) {
        boolean z;
        TLRPC$Chat chat = getChat(Long.valueOf(j));
    ...
    public void sendBotStart(TLRPC$User tLRPC$User, String str) {
        ...
        tLRPC$TL_messages_startBot.peer = getInputPeer(tLRPC$User.f1567id);
        tLRPC$TL_messages_startBot.start_param = str;
        tLRPC$TL_messages_startBot.random_id = Utilities.random.nextLong();
        getConnectionsManager().sendRequest(tLRPC$TL_messages_startBot, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda269
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$sendBotStart$252(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error != null) {
            return;
        }
        processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public void addUsersToChat(final TLRPC$Chat tLRPC$Chat, BaseFragment baseFragment, ArrayList<TLRPC$User> arrayList, int i, final Consumer<TLRPC$User> consumer, final Consumer<TLRPC$User> consumer2, final Runnable runnable) {
        ...
        final int[] iArr = {0};
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda167
            @Override // java.lang.Runnable
            public final void run() {
        ...
        while (i2 < size) {
            ...
            }, new ErrorDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda249
    ...
    public /* synthetic */ void lambda$addUsersToChat$254(final TLRPC$Chat tLRPC$Chat, final ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$addUsersToChat$253(TLRPC$Chat tLRPC$Chat, ArrayList arrayList) {
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
        if (lastFragment == null || lastFragment.getParentActivity() == null) {
            return;
        }
    ...
    public static /* synthetic */ void lambda$addUsersToChat$255(Consumer consumer, TLRPC$User tLRPC$User, int[] iArr, int i, ArrayList arrayList, Runnable runnable, Runnable runnable2) {
        if (consumer != null) {
    ...
    public static /* synthetic */ boolean lambda$addUsersToChat$256(int[] iArr, ArrayList arrayList, TLRPC$User tLRPC$User, int i, Runnable runnable, Consumer consumer, TLRPC$TL_error tLRPC$TL_error) {
        iArr[0] = iArr[0] + 1;
    ...
    public void addUserToChat(final long j, TLRPC$User tLRPC$User, int i, String str, final BaseFragment baseFragment, final boolean z, final Runnable runnable, final ErrorDelegate errorDelegate) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_addChatUser3, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda362
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$addUserToChat$262(final boolean z, final TLRPC$InputUser tLRPC$InputUser, final long j, boolean z2, Runnable runnable, final ErrorDelegate errorDelegate, final BaseFragment baseFragment, final TLObject tLObject, final boolean z3, final TLObject tLObject2, final TLRPC$TL_error tLRPC$TL_error) {
        boolean z4;
    ...
    public /* synthetic */ void lambda$addUserToChat$257(long j) {
        this.joiningToChannels.remove(Long.valueOf(j));
    }

    public /* synthetic */ void lambda$addUserToChat$258(ErrorDelegate errorDelegate, TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLObject tLObject, boolean z, boolean z2) {
    ...
    public /* synthetic */ void lambda$addUserToChat$259(ErrorDelegate errorDelegate, TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLObject tLObject, boolean z, boolean z2, TLRPC$InputUser tLRPC$InputUser) {
        if (errorDelegate == null) {
            int i = this.currentAccount;
            Object[] objArr = new Object[1];
    ...
    public /* synthetic */ void lambda$addUserToChat$260(long j, TLObject tLObject) {
        AlertsCreator.checkRestrictedInviteUsers(this.currentAccount, getChat(Long.valueOf(j)), (TLRPC$Updates) tLObject);
    }

    public /* synthetic */ void lambda$addUserToChat$261(long j) {
        loadFullChat(j, 0, true);
    }
    ...
    */
    public void deleteParticipantFromChat(final long r11, org.telegram.tgnet.TLRPC$InputPeer r13, boolean r14, boolean r15) {
        ...
        L7b:
            ...
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda377 r12 = org.telegram.messenger.MessagesController$$ExternalSyntheticLambda377.INSTANCE
        ...
        La4:
            ...
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda364 r15 = new org.telegram.messenger.MessagesController$$ExternalSyntheticLambda364
            r4 = r15
            r5 = r10
            r8 = r11
            r4.<init>()
    ...
    public /* synthetic */ void lambda$deleteParticipantFromChat$265(boolean z, boolean z2, final long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error != null) {
            return;
        }
        processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public /* synthetic */ void lambda$deleteParticipantFromChat$264(long j) {
        loadFullChat(j, 0, true);
    }
    ...
    */
    public void deleteParticipantFromChat(final long r13, final org.telegram.tgnet.TLRPC$User r15, org.telegram.tgnet.TLRPC$Chat r16, boolean r17, boolean r18, final java.lang.Runnable r19, final java.lang.Runnable r20) {
        ...
        L74:
            ...
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda367 r2 = org.telegram.messenger.MessagesController$$ExternalSyntheticLambda367.INSTANCE
        ...
        La4:
            ...
            org.telegram.messenger.MessagesController$$ExternalSyntheticLambda341 r11 = new org.telegram.messenger.MessagesController$$ExternalSyntheticLambda341
            r0 = r11
            r1 = r12
            r2 = r20
            r4 = r15
    ...
    public /* synthetic */ void lambda$deleteParticipantFromChat$268(Runnable runnable, boolean z, TLRPC$User tLRPC$User, final long j, Runnable runnable2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error != null) {
            if (runnable != null) {
                AndroidUtilities.runOnUIThread(runnable);
                return;
    ...
    public /* synthetic */ void lambda$deleteParticipantFromChat$267(long j) {
        loadFullChat(j, 0, true);
    }
    ...
    public /* synthetic */ void lambda$changeChatTitle$269(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error != null) {
            return;
        }
        processUpdates((TLRPC$Updates) tLObject, false);
    ...
    public void changeChatAvatar(final long j, final TLRPC$TL_inputChatPhoto tLRPC$TL_inputChatPhoto, TLRPC$InputFile tLRPC$InputFile, TLRPC$InputFile tLRPC$InputFile2, TLRPC$VideoSize tLRPC$VideoSize, double d, final String str, final TLRPC$FileLocation tLRPC$FileLocation, final TLRPC$FileLocation tLRPC$FileLocation2, final Runnable runnable) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_editChatPhoto, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda352
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$changeChatAvatar$271(TLRPC$TL_inputChatPhoto tLRPC$TL_inputChatPhoto, TLRPC$FileLocation tLRPC$FileLocation, TLRPC$FileLocation tLRPC$FileLocation2, String str, long j, final Runnable runnable, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        TLRPC$Photo tLRPC$Photo;
        if (tLRPC$TL_error != null) {
            return;
        }
    ...
    public /* synthetic */ void lambda$changeChatAvatar$270(Runnable runnable) {
        if (runnable != null) {
            runnable.run();
        }
        getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_AVATAR));
    ...
    public void unregistedPush() {
        if (getUserConfig().registeredForPush && SharedConfig.pushString.length() == 0) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_account_unregisterDevice, MessagesController$$ExternalSyntheticLambda371.INSTANCE);
        }
    }
    ...
    public /* synthetic */ void lambda$performLogout$274(final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public static /* synthetic */ void lambda$performLogout$273(TLObject tLObject) {
    ...
    public void generateUpdateMessage() {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_help_getAppChangelog, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda267
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$generateUpdateMessage$275(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
    ...
    public void registerForPush(final int i, final String str) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_account_registerDevice, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda291
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$registerForPush$277(int i, String str, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject instanceof TLRPC$TL_boolTrue) {
            if (BuildVars.LOGS_ENABLED) {
    ...
    public /* synthetic */ void lambda$registerForPush$276() {
        this.registeringForPush = false;
    }
    ...
    public /* synthetic */ void lambda$loadCurrentState$278(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.updatingState = false;
        if (tLRPC$TL_error == null) {
    ...
    private void processChannelsUpdatesQueue(long j, int i) {
        ...
        Collections.sort(arrayList, MessagesController$$ExternalSyntheticLambda247.INSTANCE);
        if (i == 2) {
    ...
    public static /* synthetic */ int lambda$processChannelsUpdatesQueue$279(TLRPC$Updates tLRPC$Updates, TLRPC$Updates tLRPC$Updates2) {
    ...
    private void processUpdatesQueue(int i, int i2) {
        ...
        if (i == 0) {
            ...
            Collections.sort(arrayList, new Comparator() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda243
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
    ...
    public /* synthetic */ int lambda$processUpdatesQueue$280(TLRPC$Updates tLRPC$Updates, TLRPC$Updates tLRPC$Updates2) {
    ...
    public void loadUnknownChannel(final TLRPC$Chat tLRPC$Chat, final long j) {
        NativeByteBuffer nativeByteBuffer;
        Exception e;
        if (!(tLRPC$Chat instanceof TLRPC$TL_channel) || this.gettingUnknownChannels.indexOfKey(tLRPC$Chat.f1427id) >= 0) {
            return;
        }
        ...
        if (j == 0) {
            try {
                ...
                try {
                    ...
                    FileLog.m45e(e);
                    j = getMessagesStorage().createPendingTask(nativeByteBuffer);
                    getConnectionsManager().sendRequest(tLRPC$TL_messages_getPeerDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda327
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadUnknownChannel$283(long j, TLRPC$Chat tLRPC$Chat, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            TLRPC$TL_messages_peerDialogs tLRPC$TL_messages_peerDialogs = (TLRPC$TL_messages_peerDialogs) tLObject;
        ...
        this.gettingUnknownChannels.delete(tLRPC$Chat.f1427id);
    }
    ...
    public void startShortPoll(final TLRPC$Chat tLRPC$Chat, final int i, final boolean z) {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda168
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$startShortPoll$284(TLRPC$Chat tLRPC$Chat, boolean z, int i) {
        ArrayList<Integer> arrayList = this.needShortPollChannels.get(tLRPC$Chat.f1427id);
        ArrayList<Integer> arrayList2 = this.needShortPollOnlines.get(tLRPC$Chat.f1427id);
        if (z) {
            if (arrayList != null) {
                arrayList.remove(Integer.valueOf(i));
            }
            if (arrayList == null || arrayList.isEmpty()) {
                this.needShortPollChannels.delete(tLRPC$Chat.f1427id);
            }
            if (tLRPC$Chat.megagroup) {
                ...
                if (arrayList2 == null || arrayList2.isEmpty()) {
                    this.needShortPollOnlines.delete(tLRPC$Chat.f1427id);
                    return;
                }
                return;
            }
        ...
        if (arrayList == null) {
            arrayList = new ArrayList<>();
            this.needShortPollChannels.put(tLRPC$Chat.f1427id, arrayList);
        }
        if (!arrayList.contains(Integer.valueOf(i))) {
            arrayList.add(Integer.valueOf(i));
        }
        if (this.shortPollChannels.indexOfKey(tLRPC$Chat.f1427id) < 0) {
            getChannelDifference(tLRPC$Chat.f1427id, 3, 0L, null);
        }
        if (tLRPC$Chat.megagroup) {
            if (arrayList2 == null) {
                arrayList2 = new ArrayList<>();
                this.needShortPollOnlines.put(tLRPC$Chat.f1427id, arrayList2);
            }
            if (!arrayList2.contains(Integer.valueOf(i))) {
                arrayList2.add(Integer.valueOf(i));
            }
            if (this.shortPollOnlines.indexOfKey(tLRPC$Chat.f1427id) < 0) {
                this.shortPollOnlines.put(tLRPC$Chat.f1427id, 0);
            }
        }
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$getChannelDifference$293(final long j, final int i, final long j2, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        ...
        getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda132
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$getChannelDifference$285(TLRPC$updates_ChannelDifference tLRPC$updates_ChannelDifference) {
        putUsers(tLRPC$updates_ChannelDifference.users, false);
        putChats(tLRPC$updates_ChannelDifference.chats, false);
    }

    public /* synthetic */ void lambda$getChannelDifference$291(ArrayList arrayList, final long j, final TLRPC$updates_ChannelDifference tLRPC$updates_ChannelDifference, final TLRPC$Chat tLRPC$Chat, final LongSparseArray longSparseArray, final int i, final long j2) {
        if (!arrayList.isEmpty()) {
            final SparseArray sparseArray = new SparseArray();
            Iterator it = arrayList.iterator();
            while (it.hasNext()) {
                TLRPC$TL_updateMessageID tLRPC$TL_updateMessageID = (TLRPC$TL_updateMessageID) it.next();
                long[] updateMessageStateAndId = getMessagesStorage().updateMessageStateAndId(tLRPC$TL_updateMessageID.random_id, -j, null, tLRPC$TL_updateMessageID.f1562id, 0, false, -1);
                if (updateMessageStateAndId != null) {
                    sparseArray.put(tLRPC$TL_updateMessageID.f1562id, updateMessageStateAndId);
                }
            }
            if (sparseArray.size() != 0) {
    ...
    public /* synthetic */ void lambda$getChannelDifference$286(SparseArray sparseArray) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$getChannelDifference$290(final org.telegram.tgnet.TLRPC$updates_ChannelDifference r23, long r24, org.telegram.tgnet.TLRPC$Chat r26, androidx.collection.LongSparseArray r27, int r28, long r29) {
        /*
    ...
    public /* synthetic */ void lambda$getChannelDifference$287(LongSparseArray longSparseArray) {
    ...
    public /* synthetic */ void lambda$getChannelDifference$289(final ArrayList arrayList, TLRPC$updates_ChannelDifference tLRPC$updates_ChannelDifference) {
        if (!arrayList.isEmpty()) {
    ...
    public /* synthetic */ void lambda$getChannelDifference$288(ArrayList arrayList) {
        getNotificationsController().processNewMessages(arrayList, true, false, null);
    }

    public /* synthetic */ void lambda$getChannelDifference$292(TLRPC$TL_error tLRPC$TL_error, long j) {
        checkChannelError(tLRPC$TL_error.text, j);
    }
    ...
    public void getDifference(int i, final int i2, final int i3, boolean z) {
        ...
        if (getMessagesStorage().getLastPtsValue() == 0) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_updates_getDifference, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda283
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$getDifference$303(final int i, final int i2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        int i3 = 0;
        if (tLRPC$TL_error == null) {
            ...
            getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda222
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$getDifference$294(TLRPC$updates_Difference tLRPC$updates_Difference, int i, int i2) {
        this.loadedFullUsers.clear();
        this.loadedFullChats.clear();
        resetDialogs(true, getMessagesStorage().getLastSeqValue(), tLRPC$updates_Difference.pts, i, i2);
    }

    public /* synthetic */ void lambda$getDifference$295(TLRPC$updates_Difference tLRPC$updates_Difference) {
        this.loadedFullUsers.clear();
        this.loadedFullChats.clear();
    ...
    public /* synthetic */ void lambda$getDifference$302(final TLRPC$updates_Difference tLRPC$updates_Difference, ArrayList arrayList, final LongSparseArray longSparseArray, final LongSparseArray longSparseArray2) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                long[] updateMessageStateAndId = getMessagesStorage().updateMessageStateAndId(tLRPC$TL_updateMessageID.random_id, 0L, null, tLRPC$TL_updateMessageID.f1562id, 0, false, -1);
                if (updateMessageStateAndId != null) {
                    sparseArray.put(tLRPC$TL_updateMessageID.f1562id, updateMessageStateAndId);
                }
            }
    ...
    public /* synthetic */ void lambda$getDifference$296(SparseArray sparseArray) {
        for (int i = 0; i < sparseArray.size(); i++) {
            int keyAt = sparseArray.keyAt(i);
            long[] jArr = (long[]) sparseArray.valueAt(i);
            getSendMessagesHelper().processSentMessage((int) jArr[1]);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$getDifference$301(final org.telegram.tgnet.TLRPC$updates_Difference r19, androidx.collection.LongSparseArray r20, androidx.collection.LongSparseArray r21) {
        /*
    ...
    public /* synthetic */ void lambda$getDifference$300(final ArrayList arrayList, final TLRPC$updates_Difference tLRPC$updates_Difference, LongSparseArray longSparseArray) {
        if (!arrayList.isEmpty()) {
    ...
    public /* synthetic */ void lambda$getDifference$297(ArrayList arrayList, TLRPC$updates_Difference tLRPC$updates_Difference) {
    ...
    public /* synthetic */ void lambda$getDifference$299(final long j, final ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$getDifference$298(long j, ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$markDialogAsUnread$304(long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (j != 0) {
            getMessagesStorage().removePendingTask(j);
        }
    }
    ...
    public /* synthetic */ void lambda$loadUnreadDialogs$306(final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadUnreadDialogs$305(TLObject tLObject) {
        if (tLObject != null) {
            TLRPC$Vector tLRPC$Vector = (TLRPC$Vector) tLObject;
            int size = tLRPC$Vector.objects.size();
            for (int i = 0; i < size; i++) {
        ...
        if (j == 0) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (!(tLRPC$Dialog instanceof TLRPC$TL_dialogFolder)) {
                    if (!tLRPC$Dialog.pinned) {
                        if (tLRPC$Dialog.f1433id != this.promoDialogId) {
                            break;
                        }
                    } else {
                        arrayList2.add(Long.valueOf(tLRPC$Dialog.f1433id));
                        arrayList3.add(Integer.valueOf(tLRPC$Dialog.pinnedNum));
                        if (!DialogObject.isEncryptedDialog(tLRPC$Dialog.f1433id)) {
                            TLRPC$InputPeer inputPeer = getInputPeer(tLRPC$Dialog.f1433id);
                            TLRPC$TL_inputDialogPeer tLRPC$TL_inputDialogPeer = new TLRPC$TL_inputDialogPeer();
                            tLRPC$TL_inputDialogPeer.peer = inputPeer;
            ...
            try {
                ...
                try {
                    ...
                    nativeByteBuffer = nativeByteBuffer2;
                    j = getMessagesStorage().createPendingTask(nativeByteBuffer);
                    getConnectionsManager().sendRequest(tLRPC$TL_messages_reorderPinnedDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda299
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$reorderPinnedDialogs$307(long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (j != 0) {
            getMessagesStorage().removePendingTask(j);
        }
    }
        ...
        if (!DialogObject.isEncryptedDialog(j) && j2 != -1) {
            ...
            if (j2 == 0) {
                ...
                try {
                    ...
                    getConnectionsManager().sendRequest(tLRPC$TL_messages_toggleDialogPin, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda303
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$pinDialog$308(long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (j != 0) {
            getMessagesStorage().removePendingTask(j);
        }
    }
    ...
    public void loadPinnedDialogs(final int i, long j, ArrayList<Long> arrayList) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_getPinnedDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda281
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$loadPinnedDialogs$311(final int r19, org.telegram.tgnet.TLObject r20, org.telegram.tgnet.TLRPC$TL_error r21) {
        /*
    ...
    public /* synthetic */ void lambda$loadPinnedDialogs$310(final int i, final ArrayList arrayList, final boolean z, final TLRPC$TL_messages_peerDialogs tLRPC$TL_messages_peerDialogs, final LongSparseArray longSparseArray, final TLRPC$TL_messages_dialogs tLRPC$TL_messages_dialogs) {
    ...
    public /* synthetic */ void lambda$loadPinnedDialogs$309(int i, ArrayList arrayList, boolean z, TLRPC$TL_messages_peerDialogs tLRPC$TL_messages_peerDialogs, LongSparseArray longSparseArray, TLRPC$TL_messages_dialogs tLRPC$TL_messages_dialogs) {
        boolean z2;
        boolean z3;
        boolean z4;
        ...
        if (arrayList.isEmpty()) {
            ...
            while (i5 < size) {
                ...
                arrayList4.add(Long.valueOf(tLRPC$Dialog2.f1433id));
                TLRPC$Dialog tLRPC$Dialog3 = this.dialogs_dict.get(tLRPC$Dialog2.f1433id);
                if (tLRPC$Dialog3 != null) {
                    tLRPC$Dialog3.pinned = z2;
                    tLRPC$Dialog3.pinnedNum = tLRPC$Dialog2.pinnedNum;
                    arrayList5.add(Long.valueOf(tLRPC$Dialog2.f1433id));
                    arrayList6.add(Integer.valueOf(tLRPC$Dialog2.pinnedNum));
                    arrayList2 = arrayList6;
                } else {
                    this.dialogs_dict.put(tLRPC$Dialog2.f1433id, tLRPC$Dialog2);
                    ArrayList<MessageObject> arrayList7 = (ArrayList) longSparseArray.get(tLRPC$Dialog2.f1433id);
                    arrayList2 = arrayList6;
                    this.dialogMessage.put(tLRPC$Dialog2.f1433id, arrayList7);
                    if (arrayList7 != null) {
                        int i6 = 0;
                    ...
                    getTranslateController().checkDialogMessages(tLRPC$Dialog2.f1433id);
                    z3 = true;
                }
                i5++;
    ...
    public /* synthetic */ void lambda$generateJoinMessage$312(ArrayList arrayList) {
        getNotificationsController().processNewMessages(arrayList, true, false, null);
    }

    public /* synthetic */ void lambda$generateJoinMessage$313(final ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$generateJoinMessage$314(long j, ArrayList arrayList) {
        updateInterfaceWithMessages(-j, arrayList, false);
        getNotificationCenter().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
    }
    ...
    public /* synthetic */ void lambda$deleteMessagesByPush$316(final ArrayList arrayList, final long j, long j2) {
    ...
    public /* synthetic */ void lambda$deleteMessagesByPush$315(ArrayList arrayList, long j) {
    ...
    public void checkChatInviter(final long j, final boolean z) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_getParticipant, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda348
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$checkChatInviter$321(TLRPC$Chat tLRPC$Chat, boolean z, final long j, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (tLRPC$TL_channels_channelParticipant != null) {
            ...
            if (tLRPC$ChannelParticipant instanceof TLRPC$TL_channelParticipantSelf) {
                ...
                if (tLRPC$TL_channelParticipantSelf.inviter_id != getUserConfig().getClientUserId() || tLRPC$TL_channelParticipantSelf.via_invite) {
                    if (tLRPC$Chat.megagroup && getMessagesStorage().isMigratedChat(tLRPC$Chat.f1427id)) {
                        return;
                    }
                    ...
                    if (!z || Math.abs(getConnectionsManager().getCurrentTime() - tLRPC$TL_channels_channelParticipant.participant.date) >= 86400 || getMessagesStorage().hasInviteMeMessage(j)) {
                        ...
                        for (int i = 0; i < tLRPC$TL_channels_channelParticipant.users.size(); i++) {
                            ...
                            concurrentHashMap.put(Long.valueOf(tLRPC$User.f1567id), tLRPC$User);
                        }
                        arrayList2.add(tLRPC$TL_messageService);
    ...
    public /* synthetic */ void lambda$checkChatInviter$317(TLRPC$TL_channels_channelParticipant tLRPC$TL_channels_channelParticipant) {
        putUsers(tLRPC$TL_channels_channelParticipant.users, false);
        putChats(tLRPC$TL_channels_channelParticipant.chats, false);
    }

    public /* synthetic */ void lambda$checkChatInviter$318(ArrayList arrayList) {
        getNotificationsController().processNewMessages(arrayList, true, false, null);
    }

    public /* synthetic */ void lambda$checkChatInviter$319(final ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$checkChatInviter$320(long j, ArrayList arrayList, TLRPC$TL_channels_channelParticipant tLRPC$TL_channels_channelParticipant) {
    ...
    */
    ...
    public /* synthetic */ void lambda$processUpdates$322(boolean z, long j, ArrayList arrayList) {
        if (z) {
            getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_USER_PRINT));
        }
        updateInterfaceWithMessages(j, arrayList, false);
    ...
    public /* synthetic */ void lambda$processUpdates$323(boolean z, TLRPC$Updates tLRPC$Updates, ArrayList arrayList) {
        if (z) {
            getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_USER_PRINT));
        }
    ...
    public /* synthetic */ void lambda$processUpdates$324(ArrayList arrayList) {
        getNotificationsController().processNewMessages(arrayList, true, false, null);
    }

    public /* synthetic */ void lambda$processUpdates$325(final ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$processUpdates$327() {
        getNotificationCenter().postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(UPDATE_MASK_STATUS));
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$processUpdateArray$330(TLRPC$TL_updateUserTyping tLRPC$TL_updateUserTyping) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$331(TLRPC$TL_updateChatUserTyping tLRPC$TL_updateChatUserTyping) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$333(final TLRPC$TL_updatePeerBlocked tLRPC$TL_updatePeerBlocked) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$332(TLRPC$TL_updatePeerBlocked tLRPC$TL_updatePeerBlocked) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$334(TLRPC$TL_updateServiceNotification tLRPC$TL_updateServiceNotification) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$335(TLRPC$Message tLRPC$Message) {
        getSendMessagesHelper().onMessageEdited(tLRPC$Message);
    }

    public /* synthetic */ void lambda$processUpdateArray$336(TLRPC$TL_updateLangPack tLRPC$TL_updateLangPack) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$337(ArrayList arrayList) {
        getNotificationsController().processNewMessages(arrayList, true, false, null);
    }

    public /* synthetic */ void lambda$processUpdateArray$338(final ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$340(final LongSparseArray longSparseArray) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$339(LongSparseArray longSparseArray) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$341(TLRPC$User tLRPC$User) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$345(TLRPC$TL_updateChannel tLRPC$TL_updateChannel) {
        getChannelDifference(tLRPC$TL_updateChannel.channel_id, 1, 0L, null);
    }

    public /* synthetic */ void lambda$processUpdateArray$346(TLRPC$Chat tLRPC$Chat) {
        getNotificationCenter().postNotificationName(NotificationCenter.channelRightsUpdated, tLRPC$Chat);
    }

    public /* synthetic */ void lambda$processUpdateArray$347(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
        }
    }

    /* JADX WARN: Code restructure failed: missing block: B:1292:0x097b, code lost:
        if (r7.getCallStateForSubscription() == 0) goto L471;
     */
    /* JADX WARN: Code restructure failed: missing block: B:1294:0x097e, code lost:
        r0 = false;
     */
    /* JADX WARN: Code restructure failed: missing block: B:1296:0x0984, code lost:
        if (r7.getCallState() == 0) goto L471;
     */
    /* JADX WARN: Removed duplicated region for block: B:1564:0x1029  */
    /* JADX WARN: Removed duplicated region for block: B:1569:0x1045  */
    /* JADX WARN: Removed duplicated region for block: B:1615:0x1157  */
    /* JADX WARN: Removed duplicated region for block: B:1617:0x1165  */
    /* JADX WARN: Removed duplicated region for block: B:1619:0x116b  */
    /* JADX WARN: Removed duplicated region for block: B:1622:0x1177  */
    /* JADX WARN: Removed duplicated region for block: B:1632:0x11b3  */
    /* JADX WARN: Removed duplicated region for block: B:1635:0x11c9  */
    /* JADX WARN: Removed duplicated region for block: B:1715:? A[RETURN, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$processUpdateArray$348(int r44, java.util.ArrayList r45, java.util.ArrayList r46, androidx.collection.LongSparseArray r47, int r48, org.telegram.messenger.support.LongSparseIntArray r49, androidx.collection.LongSparseArray r50, androidx.collection.LongSparseArray r51, java.util.ArrayList r52, androidx.collection.LongSparseArray r53, androidx.collection.LongSparseArray r54, boolean r55, java.util.ArrayList r56, java.util.ArrayList r57, androidx.collection.LongSparseArray r58, androidx.collection.LongSparseArray r59, androidx.collection.LongSparseArray r60, java.util.ArrayList r61) {
        /*
    ...
    */
    ...
    public /* synthetic */ void lambda$processUpdateArray$351(long j, ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$processUpdateArray$352(long j, int i) {
    ...
    public void checkUnreadReactions(final long j, final int i, final SparseBooleanArray sparseBooleanArray) {
        getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda104
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$checkUnreadReactions$358(SparseBooleanArray sparseBooleanArray, final int i, final long j) {
        int i2;
        char c;
        ...
        if (!z) {
            ...
            tLRPC$TL_messages_getPeerDialogs.peers.add(tLRPC$TL_inputDialogPeer);
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_messages_getPeerDialogs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda314
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_channels_getForumTopicsByID, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda315
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$checkUnreadReactions$356(final long j, final int i, final ArrayList arrayList, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
    ...
    public /* synthetic */ void lambda$checkUnreadReactions$355(long j, int i, int i2, ArrayList arrayList) {
    ...
    public /* synthetic */ void lambda$checkUnreadReactions$357(int i, long j, int i2) {
        if (i == 0) {
            TLRPC$Dialog tLRPC$Dialog = this.dialogs_dict.get(j);
            if (tLRPC$Dialog == null) {
    ...
    public void markReactionsAsRead(long j, int i) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_readReactions, MessagesController$$ExternalSyntheticLambda385.INSTANCE);
    ...
    public SponsoredMessagesInfo getSponsoredMessages(final long j) {
        ...
        if (sponsoredMessagesInfo == null || (!sponsoredMessagesInfo.loading && Math.abs(SystemClock.elapsedRealtime() - sponsoredMessagesInfo.loadTime) > 300000)) {
            ...
            if (ChatObject.isChannel(chat)) {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_channels_getSponsoredMessages, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda326
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$getSponsoredMessages$362(final long j, final SponsoredMessagesInfo sponsoredMessagesInfo, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        final ?? r6;
        ArrayList arrayList;
    ...
    public /* synthetic */ void lambda$getSponsoredMessages$360(TLRPC$messages_SponsoredMessages tLRPC$messages_SponsoredMessages) {
        putUsers(tLRPC$messages_SponsoredMessages.users, false);
        putChats(tLRPC$messages_SponsoredMessages.chats, false);
    }

    public /* synthetic */ void lambda$getSponsoredMessages$361(ArrayList arrayList, long j, SponsoredMessagesInfo sponsoredMessagesInfo, Integer num) {
        if (arrayList == null) {
    ...
    public TLRPC$TL_channels_sendAsPeers getSendAsPeers(final long j) {
        ...
        if (chat != null && ChatObject.canSendAsPeers(chat)) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_channels_getSendAs, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda325
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$getSendAsPeers$365(final long j, final SendAsPeersInfo sendAsPeersInfo, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$getSendAsPeers$363(TLRPC$TL_channels_sendAsPeers tLRPC$TL_channels_sendAsPeers) {
        putUsers(tLRPC$TL_channels_sendAsPeers.users, false);
        putChats(tLRPC$TL_channels_sendAsPeers.chats, false);
    }

    public /* synthetic */ void lambda$getSendAsPeers$364(TLRPC$TL_channels_sendAsPeers tLRPC$TL_channels_sendAsPeers, long j, SendAsPeersInfo sendAsPeersInfo) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:486:0x04bf  */
    ...
    */
    ...
    public /* synthetic */ void lambda$updateInterfaceWithMessages$366(TLRPC$Dialog tLRPC$Dialog, int i, long j, int i2) {
        if (i2 == -1) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:513:0x02dc, code lost:
        if (org.telegram.messenger.ChatObject.hasAdminRights(r9) == false) goto L117;
     */
    /* JADX WARN: Code restructure failed: missing block: B:519:0x02f2, code lost:
        if (org.telegram.messenger.ChatObject.canPost(r9) != false) goto L189;
     */
    /* JADX WARN: Removed duplicated region for block: B:418:0x018b  */
    /* JADX WARN: Removed duplicated region for block: B:422:0x01a2  */
    /* JADX WARN: Removed duplicated region for block: B:423:0x01a6  */
    /* JADX WARN: Removed duplicated region for block: B:426:0x01b4  */
    /* JADX WARN: Removed duplicated region for block: B:567:0x039e  */
    /* JADX WARN: Removed duplicated region for block: B:568:0x03ab  */
    /* JADX WARN: Removed duplicated region for block: B:642:0x01ba A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    private void addDialogToItsFolder(int i, TLRPC$Dialog tLRPC$Dialog) {
        int i2;
        if (tLRPC$Dialog instanceof TLRPC$TL_dialogFolder) {
            boolean z = ((TLRPC$TL_dialogFolder) tLRPC$Dialog).folder.f1479id == 2;
            boolean hasSelectedTopic = getForkTopicsController().hasSelectedTopic(z);
            i2 = z;
            if (hasSelectedTopic) {
                return;
            }
        } else if (getAlbumsController().isDialogAlbum(tLRPC$Dialog.f1433id) || getHiddenChatsController().isChatHidden(tLRPC$Dialog.f1433id)) {
            return;
        } else {
            ...
            if (selectedTopicId != -1) {
                ...
                if (selectedTopicId == -2) {
                    if (getForkTopicsController().getTopicForDialog(tLRPC$Dialog.f1433id) != null) {
                        return;
                    }
                } else {
                    TopicModel topic = getForkTopicsController().getTopic(selectedTopicId);
                    if (!(z2 ? topic.getFilterArchivedDialogs() : topic.getFilterDialogs()).contains(Long.valueOf(tLRPC$Dialog.f1433id))) {
                        return;
                    }
                }
            }
    ...
    public static void showCantOpenAlert(BaseFragment baseFragment, String str) {
        ...
        builder.setTitle(LocaleController.getString(C3242R.string.DialogNotAvailable));
        ...
        builder.setTopAnimation(C3242R.raw.not_available, 52, false, baseFragment.getThemedColor("dialogTopBackground"), hashMap);
            ...
            if (restrictionReason != null) {
                ...
                if (!DialogObject.isEncryptedDialog(dialogId)) {
                    ...
                    if (i2 > 0 || !ChatObject.isChannel(chat)) {
                        TLRPC$TL_messages_getMessages tLRPC$TL_messages_getMessages2 = new TLRPC$TL_messages_getMessages();
                        tLRPC$TL_messages_getMessages2.f1519id.add(Integer.valueOf(messageObject.getId()));
                        tLRPC$TL_messages_getMessages = tLRPC$TL_messages_getMessages2;
                    } else {
                        TLRPC$Chat chat2 = getChat(Long.valueOf(-dialogId));
                        TLRPC$TL_channels_getMessages tLRPC$TL_channels_getMessages = new TLRPC$TL_channels_getMessages();
                        tLRPC$TL_channels_getMessages.channel = getInputChannel(chat2);
                        tLRPC$TL_channels_getMessages.f1469id.add(Integer.valueOf(messageObject.getId()));
                        tLRPC$TL_messages_getMessages = tLRPC$TL_channels_getMessages;
                    }
                    final int sendRequest = getConnectionsManager().sendRequest(tLRPC$TL_messages_getMessages, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda355
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$checkCanOpenChat$368(final AlertDialog alertDialog, final BaseFragment baseFragment, final Bundle bundle, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
    ...
    public /* synthetic */ void lambda$checkCanOpenChat$367(AlertDialog alertDialog, TLObject tLObject, BaseFragment baseFragment, Bundle bundle) {
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
            FileLog.m45e(e);
    ...
    public /* synthetic */ void lambda$checkCanOpenChat$369(int i, BaseFragment baseFragment, DialogInterface dialogInterface) {
        getConnectionsManager().cancelRequest(i, true);
    ...
    public void openByUserName(String str, final BaseFragment baseFragment, final int i, final Browser.Progress progress) {
        ...
        if (tLRPC$User != null) {
            ...
            if (progress != null) {
                progress.onCancel(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda237
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ void lambda$openByUserName$370(Browser.Progress progress, AlertDialog[] alertDialogArr, BaseFragment baseFragment, boolean[] zArr, int i, Long l) {
        try {
            if (progress != null) {
                progress.end();
            } else {
        ...
        if (l != null) {
            ...
            try {
                ...
                BulletinFactory.m27of(baseFragment).createErrorBulletin(LocaleController.getString("NoUsernameFound", C3242R.string.NoUsernameFound)).show();
            } catch (Exception e) {
                FileLog.m45e(e);
            }
        }
    ...
    public static /* synthetic */ void lambda$openByUserName$371(boolean[] zArr) {
        zArr[0] = true;
    }

    public static /* synthetic */ void lambda$openByUserName$373(AlertDialog[] alertDialogArr, final boolean[] zArr, BaseFragment baseFragment) {
    ...
    public static /* synthetic */ void lambda$openByUserName$372(boolean[] zArr, DialogInterface dialogInterface) {
        zArr[0] = true;
    }
    ...
    public void ensureMessagesLoaded(final long j, int i, final MessagesLoadedCallback messagesLoadedCallback) {
        ...
        if (j2 != 0 && getMessagesController().getChat(Long.valueOf(j2)) == null) {
            ...
            final int i3 = i2;
            messagesStorage.getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda145
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$ensureMessagesLoaded$375(MessagesStorage messagesStorage, long j, final long j2, final int i, final MessagesLoadedCallback messagesLoadedCallback) {
    ...
    public /* synthetic */ void lambda$ensureMessagesLoaded$374(TLRPC$Chat tLRPC$Chat, long j, int i, MessagesLoadedCallback messagesLoadedCallback) {
        if (tLRPC$Chat != null) {
    ...
    public void deleteMessagesRange(final long j, final long j2, final int i, final int i2, boolean z, final Runnable runnable) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_deleteHistory, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda312
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$deleteMessagesRange$379(final long j, final int i, final int i2, final long j2, final Runnable runnable, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
            TLRPC$TL_messages_affectedHistory tLRPC$TL_messages_affectedHistory = (TLRPC$TL_messages_affectedHistory) tLObject;
            processNewDifferenceParams(-1, tLRPC$TL_messages_affectedHistory.pts, -1, tLRPC$TL_messages_affectedHistory.pts_count);
    ...
    public /* synthetic */ void lambda$deleteMessagesRange$377(long j, int i, int i2, final long j2, final Runnable runnable) {
    ...
    public /* synthetic */ void lambda$deleteMessagesRange$376(ArrayList arrayList, long j, Runnable runnable) {
        getNotificationCenter().postNotificationName(NotificationCenter.messagesDeleted, arrayList, Long.valueOf(j), Boolean.FALSE);
        runnable.run();
    }
    ...
    public void setChatReactions(final long j, int i, List<String> list) {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_messages_setChatAvailableReactions, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda329
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$setChatReactions$381(final long j, TLRPC$TL_messages_setChatAvailableReactions tLRPC$TL_messages_setChatAvailableReactions, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject != null) {
            processUpdates((TLRPC$Updates) tLObject, false);
            TLRPC$ChatFull chatFull = getChatFull(j);
            if (chatFull != null) {
    ...
    public /* synthetic */ void lambda$setChatReactions$380(long j) {
    ...
    public TLRPC$TL_chatAdminRights getChatAdminRightsCached(TLRPC$Chat tLRPC$Chat, TLRPC$User tLRPC$User) {
        ...
        if (tLRPC$Chat != null && tLRPC$User != null) {
            ...
            TLRPC$ChatFull chatFull = getChatFull(tLRPC$Chat.f1427id);
            if (chatFull != null && (tLRPC$ChatParticipants = chatFull.participants) != null && (arrayList = tLRPC$ChatParticipants.participants) != null) {
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    if (tLRPC$ChatParticipant != null && tLRPC$ChatParticipant.user_id == tLRPC$User.f1567id) {
    ...
    public void checkIsInChat(boolean z, TLRPC$Chat tLRPC$Chat, TLRPC$User tLRPC$User, final IsInChatCheckedCallback isInChatCheckedCallback) {
        ...
        if (tLRPC$Chat == null || tLRPC$User == null) {
            ...
            if (z && (chatFull = getChatFull(tLRPC$Chat.f1427id)) != null) {
                ...
                if (isInChatCheckedCallback != null && tLRPC$ChatParticipant != null) {
                    ...
                    isInChatCheckedCallback.run(true, (tLRPC$ChatParticipants2 == null || tLRPC$ChatParticipants2.admin_id != tLRPC$User.f1567id) ? null : ChatRightsEditActivity.emptyAdminRights(true), null);
                    return;
                }
            }
            TLRPC$TL_channels_getParticipant tLRPC$TL_channels_getParticipant = new TLRPC$TL_channels_getParticipant();
            tLRPC$TL_channels_getParticipant.channel = getInputChannel(tLRPC$Chat.f1427id);
            tLRPC$TL_channels_getParticipant.participant = getInputPeer(tLRPC$User);
            getConnectionsManager().sendRequest(tLRPC$TL_channels_getParticipant, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda255
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            TLRPC$ChatFull chatFull2 = getChatFull(tLRPC$Chat.f1427id);
            if (chatFull2 == null) {
                if (isInChatCheckedCallback != null) {
                    isInChatCheckedCallback.run(false, null, null);
                    return;
            ...
            if (tLRPC$ChatParticipants3 != null && (arrayList2 = tLRPC$ChatParticipants3.participants) != null) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (tLRPC$ChatParticipant2 != null && tLRPC$ChatParticipant2.user_id == tLRPC$User.f1567id) {
                        break;
                    }
                }
            }
            ...
            if (isInChatCheckedCallback != null) {
                ...
                isInChatCheckedCallback.run(z2, (tLRPC$ChatParticipants4 == null || tLRPC$ChatParticipants4.admin_id != tLRPC$User.f1567id) ? null : ChatRightsEditActivity.emptyAdminRights(true), null);
            }
        }
    }

    public static /* synthetic */ void lambda$checkIsInChat$382(IsInChatCheckedCallback isInChatCheckedCallback, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (isInChatCheckedCallback != null) {
    ...
    public void updateEmojiStatusUntil() {
        ...
        if (l != null) {
            ...
            if (valueOf.longValue() + j != this.recentEmojiStatusUpdateRunnableTime + this.recentEmojiStatusUpdateRunnableTimeout) {
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda30
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ void lambda$updateEmojiStatusUntil$383() {
    ...
    public String getMutedString(long j, int i) {
        if (getMessagesController().isDialogMuted(j, i)) {
            ...
            return i2 >= getConnectionsManager().getCurrentTime() ? LocaleController.formatString("NotificationsMutedForHint", C3242R.string.NotificationsMutedForHint, LocaleController.formatTTLString(i2)) : LocaleController.getString(C3242R.string.NotificationsMuted);
        }
        return LocaleController.getString(C3242R.string.NotificationsUnmuted);
    }
    ...
    public int getDialogUnreadCount(TLRPC$Dialog tLRPC$Dialog) {
        ...
        TLRPC$Chat chat = getChat(Long.valueOf(-tLRPC$Dialog.f1433id));
        return (chat == null || !chat.forum) ? i : this.topicsController.getForumUnreadCount(-tLRPC$Dialog.f1433id)[0];
    }
    ...
    public void requestContactToken(final long j, final Utilities.Callback<TLRPC$TL_exportedContactToken> callback) {
        ...
        }, new RequestDelegate() { // from class: org.telegram.messenger.MessagesController$$ExternalSyntheticLambda344
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$requestContactToken$385(final Utilities.Callback callback, long j, long j2, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$requestContactToken$384(Utilities.Callback callback) {
        callback.run(this.cachedContactToken);
        this.requestingContactToken = false;
    }
