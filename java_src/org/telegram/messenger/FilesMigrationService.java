...
public class FilesMigrationService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        Notification build = new Notification.Builder(this, NotificationsController.OTHER_NOTIFICATIONS_CHANNEL).setContentTitle(getText(C3473R.string.MigratingFiles)).setAutoCancel(false).setSmallIcon(C3473R.C3475drawable.notification).setSmallIcon(C3473R.C3475drawable.fork_notification).build();
        isRunning = true;
        new C34181().start();
    ...
    /* loaded from: classes6.dex */
    public class C34181 extends Thread {
        C34181() {
        }
        ...
        public void run() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.FilesMigrationService$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    FilesMigrationService.C34181.this.lambda$run$0();
                }
            });
        }
    ...
    public static class FilesMigrationBottomSheet extends BottomSheet {
        ...
        public FilesMigrationBottomSheet(BaseFragment baseFragment) {
            ...
            textView.setText(LocaleController.getString("MigrateOldFolderTitle", C3473R.string.MigrateOldFolderTitle));
            linearLayout.addView(textView, LayoutHelper.createFrame(-1, -2, 0, 21, 30, 21, 0));
            TextView textView2 = new TextView(parentActivity);
            textView2.setGravity(8388611);
            textView2.setTextSize(1, 15.0f);
            textView2.setTextColor(Theme.getColor(i));
            textView2.setText(AndroidUtilities.replaceTags(LocaleController.getString("MigrateOldFolderDescription", C3473R.string.MigrateOldFolderDescription)));
            ...
            textView3.setText(LocaleController.getString("MigrateOldFolderButton", C3473R.string.MigrateOldFolderButton));
