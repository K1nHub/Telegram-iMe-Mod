...
public class FilesMigrationService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        Notification build = new Notification.Builder(this, NotificationsController.OTHER_NOTIFICATIONS_CHANNEL).setContentTitle(getText(C3158R.string.MigratingFiles)).setAutoCancel(false).setSmallIcon(C3158R.C3160drawable.notification).setSmallIcon(C3158R.C3160drawable.fork_notification).build();
        isRunning = true;
        new C31041().start();
    ...
    /* loaded from: classes4.dex */
    public class C31041 extends Thread {
        C31041() {
        }
        ...
        public void run() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.FilesMigrationService$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    FilesMigrationService.C31041.this.lambda$run$0();
                }
            });
        }
    ...
    public static class FilesMigrationBottomSheet extends BottomSheet {
        ...
        public FilesMigrationBottomSheet(BaseFragment baseFragment) {
            ...
            textView.setText(LocaleController.getString("MigrateOldFolderTitle", C3158R.string.MigrateOldFolderTitle));
            ...
            textView2.setText(AndroidUtilities.replaceTags(LocaleController.getString("MigrateOldFolderDescription", C3158R.string.MigrateOldFolderDescription)));
            ...
            textView3.setText(LocaleController.getString("MigrateOldFolderButton", C3158R.string.MigrateOldFolderButton));
