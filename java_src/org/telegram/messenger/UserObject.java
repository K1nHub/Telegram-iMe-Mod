...
public class UserObject {
    ...
    public static boolean isLive(TLRPC$User tLRPC$User) {
        return (tLRPC$User == null || isDeleted(tLRPC$User) || MessagesController.isSupportUser(tLRPC$User) || tLRPC$User.f1751id == 42777) ? false : true;
    }
    ...
    public static boolean isAnonymous(TLRPC$User tLRPC$User) {
        return tLRPC$User != null && tLRPC$User.f1751id == ANONYMOUS;
    }
    ...
    public static String getFirstName(TLRPC$User tLRPC$User, boolean z) {
        ...
        return !TextUtils.isEmpty(str) ? str : LocaleController.getString("HiddenName", C3632R.string.HiddenName);
    }
    ...
    public static int getColorId(TLRPC$User tLRPC$User) {
        ...
        return (tLRPC$TL_peerColor == null || (tLRPC$TL_peerColor.flags & 1) == 0) ? (int) (tLRPC$User.f1751id % 7) : tLRPC$TL_peerColor.color;
    }
