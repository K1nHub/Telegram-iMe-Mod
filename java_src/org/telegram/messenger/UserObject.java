...
public class UserObject {
    ...
    public static boolean isLive(TLRPC$User tLRPC$User) {
        return (tLRPC$User == null || isDeleted(tLRPC$User) || MessagesController.isSupportUser(tLRPC$User) || tLRPC$User.f1694id == 42777) ? false : true;
    }
    ...
    public static String getUserName(TLRPC$User tLRPC$User) {
        ...
        C3473PhoneFormat c3473PhoneFormat = C3473PhoneFormat.getInstance();
        return c3473PhoneFormat.format("+" + tLRPC$User.phone);
    }
    ...
    public static String getFirstName(TLRPC$User tLRPC$User, boolean z) {
        ...
        return !TextUtils.isEmpty(str) ? str : LocaleController.getString("HiddenName", C3558R.string.HiddenName);
    }
