...
public class UserObject {
    ...
    public static boolean isLive(TLRPC$User tLRPC$User) {
        return (tLRPC$User == null || isDeleted(tLRPC$User) || MessagesController.isSupportUser(tLRPC$User) || tLRPC$User.f1762id == 42777) ? false : true;
    }
    ...
    public static String getFirstName(TLRPC$User tLRPC$User, boolean z) {
        ...
        return !TextUtils.isEmpty(str) ? str : LocaleController.getString("HiddenName", C3630R.string.HiddenName);
    }
