...
public class FilePathDatabase {
        ...
        try {
            ...
            if (z2) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m105d("current files db version = " + intValue);
                }
                if (intValue == 0) {
            ...
            FileLog.m105d("files db created from_backup= " + z);
        } catch (Exception e) {
            if (i < 4) {
                if (!z && restoreBackup()) {
    ...
    private void createBackup() {
        ...
        try {
            ...
            FileLog.m105d("file db backup created " + file2.getAbsolutePath());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public String getPath(final long j, final int i, final int i2, boolean z) {
        ...
        try {
            if (queryFinalized.next()) {
                ...
                if (BuildVars.DEBUG_VERSION) {
                    FileLog.m105d("get file path id=" + j + " dc=" + i + " type=" + i2 + " path=" + str2);
                }
            }
        ...
        if (sQLiteDatabase != null) {
            ...
            try {
                ...
                if (sQLiteCursor.next()) {
                    ...
                    if (BuildVars.DEBUG_VERSION) {
                        FileLog.m105d("get file path id=" + j + " dc=" + i + " type=" + i2 + " path=" + strArr[0]);
                    }
                }
            } catch (Throwable th) {
                try {
    ...
    */
    public /* synthetic */ void lambda$putPath$1(long r6, int r8, int r9, java.lang.String r10, int r11) {
        ...
        Lb3:
            ...
            r7 = r1
        Lb5:
            org.telegram.messenger.FileLog.m102e(r6)     // Catch: java.lang.Throwable -> Lc3
            if (r1 == 0) goto Lbd
            r1.dispose()
        Lbd:
            if (r7 == 0) goto Lc2
    ...
    public void checkMediaExistance(ArrayList<MessageObject> arrayList) {
        ...
        FileLog.m105d("checkMediaExistance size=" + arrayList.size() + " time=" + (System.currentTimeMillis() - currentTimeMillis) + " thread_time=" + jArr[0]);
        if (BuildVars.DEBUG_VERSION && Thread.currentThread() == Looper.getMainLooper().getThread()) {
            FileLog.m102e(new Exception("warning, not allowed in main thread"));
        }
    }
