...
public class ApplicationLoader extends Application {
    ...
    public static void postInitApplication() {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("screen state = " + isScreenOn);
            }
        } catch (Exception e4) {
            e4.printStackTrace();
        }
    ...
    public void onCreate() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            ...
            try {
                FileLog.m105d("buildVersion = " + applicationContext.getPackageManager().getPackageInfo(applicationContext.getPackageName(), 0).versionCode);
            } catch (Exception e) {
                FileLog.m102e(e);
            }
        }
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m105d("load libs time = " + (SystemClock.elapsedRealtime() - startTime));
            }
    ...
    public static /* synthetic */ void lambda$initPushServices$0() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m105d("No valid " + getPushProvider().getLogTitle() + " APK found.");
        }
    ...
    public static boolean isNetworkOnline() {
        ...
        if (BuildVars.DEBUG_PRIVATE_VERSION && isNetworkOnlineRealtime != isNetworkOnlineFast()) {
            FileLog.m105d("network online mismatch");
        }
