...
public class CodeHighlighting {
    ...
    public static class Span extends CharacterStyle {
        ...
        public void updateDrawState(TextPaint textPaint) {
            if (this.smallerSize) {
                textPaint.setTextSize(AndroidUtilities.m108dp(SharedConfig.fontSize - this.decrementSize));
            }
    ...
    public static /* synthetic */ void lambda$highlight$2(final Spannable spannable, int i, int i2, String str) {
        ...
        FileLog.m105d("[CodeHighlighter] tokenize took " + (System.currentTimeMillis() - currentTimeMillis) + "ms");
        long currentTimeMillis2 = System.currentTimeMillis();
        final ArrayList arrayList = new ArrayList();
        colorize(spannable, i, i2, stringTokenArr[0], -1, arrayList);
        FileLog.m105d("[CodeHighlighter] colorize took " + (System.currentTimeMillis() - currentTimeMillis2) + "ms");
        ...
        if (spannable instanceof LockedSpannableString) {
            ...
            FileLog.m105d("[CodeHighlighter] applying " + arrayList.size() + " colorize spans took " + (System.currentTimeMillis() - currentTimeMillis3) + "ms in another thread");
    ...
    public static /* synthetic */ void lambda$highlight$1(ArrayList arrayList, Spannable spannable) {
        ...
        FileLog.m105d("[CodeHighlighter] applying " + arrayList.size() + " colorize spans took " + (System.currentTimeMillis() - currentTimeMillis) + "ms");
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.emojiLoaded, new Object[0]);
    }
        ...
        while (i7 < length) {
            ...
            while (node2 != linkedList.tail) {
                ...
                if (linkedList.length > str.length()) {
                    FileLog.m104e("[CodeHighlighter] Something went terribly wrong, ABORT, ABORT!");
                    return;
                }
    ...
    /* JADX WARN: Removed duplicated region for block: B:74:0x013c A[Catch: Exception -> 0x0138, TryCatch #5 {Exception -> 0x0138, blocks: (B:70:0x0134, B:74:0x013c, B:76:0x0141), top: B:83:0x0134 }] */
    /* JADX WARN: Removed duplicated region for block: B:76:0x0141 A[Catch: Exception -> 0x0138, TRY_LEAVE, TryCatch #5 {Exception -> 0x0138, blocks: (B:70:0x0134, B:74:0x013c, B:76:0x0141), top: B:83:0x0134 }] */
    ...
    */
    ...
    public static class StreamReader {
        ...
        /* renamed from: is */
        private final InputStream f1521is;

        public StreamReader(InputStream inputStream) {
            this.f1521is = inputStream;
        }

        public int readUint8() throws IOException {
            return this.f1521is.read() & 255;
        }

        public int readUint16() throws IOException {
            return (this.f1521is.read() & 255) | ((this.f1521is.read() & 255) << 8);
        }

        public String readString() throws IOException {
            int read = this.f1521is.read();
            if (read >= 254) {
                read = this.f1521is.read() | (this.f1521is.read() << 8) | (this.f1521is.read() << 16);
            }
            byte[] bArr = new byte[read];
            for (int i = 0; i < read; i++) {
                bArr[i] = (byte) this.f1521is.read();
            }
