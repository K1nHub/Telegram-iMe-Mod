...
public class CodeHighlighting {
    ...
    public static class Span extends MetricAffectingSpan {
        ...
        public void updateMeasureState(TextPaint textPaint) {
            if (this.smallerSize) {
                textPaint.setTextSize(AndroidUtilities.m105dp(SharedConfig.fontSize - this.decrementSize));
            }
    ...
    public static /* synthetic */ void lambda$highlight$2(final Spannable spannable, int i, int i2, String str) {
        ...
        FileLog.m102d("[CodeHighlighter] tokenize took " + (System.currentTimeMillis() - currentTimeMillis) + "ms");
        long currentTimeMillis2 = System.currentTimeMillis();
        final ArrayList arrayList = new ArrayList();
        colorize(spannable, i, i2, stringTokenArr[0], -1, arrayList);
        FileLog.m102d("[CodeHighlighter] colorize took " + (System.currentTimeMillis() - currentTimeMillis2) + "ms");
        ...
        if (spannable instanceof LockedSpannableString) {
            ...
            FileLog.m102d("[CodeHighlighter] applying " + arrayList.size() + " colorize spans took " + (System.currentTimeMillis() - currentTimeMillis3) + "ms in another thread");
    ...
    public static /* synthetic */ void lambda$highlight$1(ArrayList arrayList, Spannable spannable) {
        ...
        FileLog.m102d("[CodeHighlighter] applying " + arrayList.size() + " colorize spans took " + (System.currentTimeMillis() - currentTimeMillis) + "ms");
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.emojiLoaded, new Object[0]);
    }
