...
public class FeedWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), C3558R.layout.feed_widget_layout);
        int i2 = C3558R.C3561id.list_view;
        remoteViews.setRemoteAdapter(i2, intent);
        remoteViews.setEmptyView(i2, C3558R.C3561id.empty_view);
