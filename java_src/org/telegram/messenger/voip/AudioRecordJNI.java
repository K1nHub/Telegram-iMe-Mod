...
public class AudioRecordJNI {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                try {
                    if (AutomaticGainControl.isAvailable()) {
                        ...
                        VLog.m71w("AutomaticGainControl is not available on this device :(");
                    }
                } catch (Throwable th) {
                    VLog.m75e("error creating AutomaticGainControl", th);
                }
                try {
                    if (NoiseSuppressor.isAvailable()) {
                        ...
                        VLog.m71w("NoiseSuppressor is not available on this device :(");
                    }
                } catch (Throwable th2) {
                    VLog.m75e("error creating NoiseSuppressor", th2);
                }
                try {
                    if (AcousticEchoCanceler.isAvailable()) {
                        ...
                        VLog.m71w("AcousticEchoCanceler is not available on this device");
                    }
                } catch (Throwable th3) {
                    VLog.m75e("error creating AcousticEchoCanceler", th3);
                }
            }
    ...
    private boolean tryInit(int i, int i2) {
        ...
        VLog.m73i("Trying to initialize AudioRecord with source=" + i + " and sample rate=" + i2);
        try {
            this.audioRecord = new AudioRecord(i, i2, 16, 2, getBufferSize(this.bufferSize, OpusUtil.SAMPLE_RATE));
        } catch (Exception e) {
            VLog.m75e("AudioRecord init failed!", e);
        }
    ...
    public boolean start() {
        ...
        if (audioRecord != null && audioRecord.getState() == 1) {
            try {
                ...
                VLog.m75e("Error initializing AudioRecord", e);
            }
        }
        return false;
    }
    ...
    public /* synthetic */ void lambda$startThread$0(ByteBuffer byteBuffer) {
        ...
        VLog.m73i("audiorecord thread exits");
    }
    ...
    private static boolean isGoodAudioEffect(AudioEffect audioEffect) {
        ...
        VLog.m77d(audioEffect.getClass().getSimpleName() + ": implementor=" + descriptor.implementor + ", name=" + descriptor.name);
