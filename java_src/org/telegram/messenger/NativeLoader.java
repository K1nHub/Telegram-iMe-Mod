    ...
    */
    public static synchronized void initNativeLibs(android.content.Context r8) {
        ...
        L9:
            ...
            org.telegram.messenger.FileLog.m105d(r2)     // Catch: java.lang.Throwable -> L1e java.lang.Error -> L21
        L1c:
            monitor-exit(r0)
            return
        L1e:
        ...
        L21:
            r2 = move-exception
            org.telegram.messenger.FileLog.m102e(r2)     // Catch: java.lang.Throwable -> L1e
            ...
            org.telegram.messenger.FileLog.m105d(r5)     // Catch: java.lang.Throwable -> L1e java.lang.Error -> L69
        L5e:
        ...
        L69:
            ...
            org.telegram.messenger.FileLog.m102e(r5)     // Catch: java.lang.Throwable -> L1e
        ...
        L7a:
            ...
            org.telegram.messenger.FileLog.m104e(r5)     // Catch: java.lang.Throwable -> L1e
        ...
        Ld0:
            r8 = move-exception
            org.telegram.messenger.FileLog.m102e(r8)     // Catch: java.lang.Throwable -> Le5
                ...
                if (str3.equalsIgnoreCase("arm64-v8a")) {
                    ...
                    if (!str3.equalsIgnoreCase("armeabi")) {
                        if (str3.equalsIgnoreCase("x86")) {
                            ...
                            FileLog.m104e("Unsupported arch: " + str3);
                        }
                    }
                    str = "armeabi";
                }
