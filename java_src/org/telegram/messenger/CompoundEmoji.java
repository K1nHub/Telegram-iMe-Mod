        ...
        public void draw(Canvas canvas) {
            ...
            if (this.newLeft != null) {
                if (this.leftUpdateT == null) {
                    this.leftUpdateT = new AnimatedFloat((float) BitmapDescriptorFactory.HUE_RED, new Runnable() { // from class: org.telegram.messenger.CompoundEmoji$CompoundEmojiDrawable$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            if (this.newRight != null) {
                if (this.rightUpdateT == null) {
                    this.rightUpdateT = new AnimatedFloat((float) BitmapDescriptorFactory.HUE_RED, new Runnable() { // from class: org.telegram.messenger.CompoundEmoji$CompoundEmojiDrawable$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CompoundEmoji.CompoundEmojiDrawable.this.invalidate();
                        }
        ...
        public void update(int i, int i2) {
            ...
            if (this.right.skin != i2) {
                ...
                if (animatedFloat2 != null) {
                    animatedFloat2.set(BitmapDescriptorFactory.HUE_RED, true);
                }
            }
            invalidate();
        }
