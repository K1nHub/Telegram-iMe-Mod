...
public class C3212PhoneFormat {
    private static volatile C3212PhoneFormat Instance;
    ...
    public static C3212PhoneFormat getInstance() {
        C3212PhoneFormat c3212PhoneFormat = Instance;
        if (c3212PhoneFormat == null) {
            synchronized (C3212PhoneFormat.class) {
                c3212PhoneFormat = Instance;
                if (c3212PhoneFormat == null) {
                    c3212PhoneFormat = new C3212PhoneFormat();
                    Instance = c3212PhoneFormat;
                }
            }
        }
        return c3212PhoneFormat;
    }
    ...
    */
    public java.lang.String valueString(int r5) {
        ...
        L1a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.PhoneFormat.C3212PhoneFormat.valueString(int):java.lang.String");
    }
    ...
    public CallingCodeInfo callingCodeInfo(String str) {
        ...
        int i;
        boolean z2;
        C3212PhoneFormat c3212PhoneFormat = this;
        CallingCodeInfo callingCodeInfo = c3212PhoneFormat.callingCodeData.get(str);
        if (callingCodeInfo != null || (num = c3212PhoneFormat.callingCodeOffsets.get(str)) == null) {
            return callingCodeInfo;
        }
        byte[] bArr2 = c3212PhoneFormat.data;
        int intValue = num.intValue();
        CallingCodeInfo callingCodeInfo2 = new CallingCodeInfo();
        callingCodeInfo2.callingCode = str;
        c3212PhoneFormat.callingCodeCountries.get(str);
        c3212PhoneFormat.callingCodeData.put(str, callingCodeInfo2);
        short value16 = c3212PhoneFormat.value16(intValue);
        int i2 = 2;
        int i3 = intValue + 2 + 2;
        short value162 = c3212PhoneFormat.value16(i3);
        int i4 = i3 + 2 + 2;
        short value163 = c3212PhoneFormat.value16(i4);
        int i5 = i4 + 2 + 2;
        ArrayList<String> arrayList = new ArrayList<>(5);
        while (true) {
            String valueString = c3212PhoneFormat.valueString(i5);
            z = true;
        ...
        while (true) {
            String valueString2 = c3212PhoneFormat.valueString(i6);
        ...
        while (i9 < value163) {
            ...
            ruleSet.matchLen = c3212PhoneFormat.value16(i8);
            int i10 = i8 + i2;
            short value164 = c3212PhoneFormat.value16(i10);
            i8 = i10 + i2;
            ArrayList<PhoneRule> arrayList4 = new ArrayList<>(value164);
            int i11 = 0;
            while (i11 < value164) {
                PhoneRule phoneRule = new PhoneRule();
                phoneRule.minVal = c3212PhoneFormat.value32(i8);
                int i12 = i8 + 4;
                phoneRule.maxVal = c3212PhoneFormat.value32(i12);
                int i13 = i12 + 4;
                int i14 = i13 + 1;
                byte b = bArr2[i13];
                int i15 = i14 + 1;
                ...
                int i19 = i18 + 1;
                byte b4 = bArr2[i18];
                short value165 = c3212PhoneFormat.value16(i19);
                i8 = i19 + i2;
                String valueString3 = c3212PhoneFormat.valueString(i7 + value162 + value165);
