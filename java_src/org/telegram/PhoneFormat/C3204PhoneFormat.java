...
public class C3204PhoneFormat {
    private static volatile C3204PhoneFormat Instance;
    ...
    public static C3204PhoneFormat getInstance() {
        C3204PhoneFormat c3204PhoneFormat = Instance;
        if (c3204PhoneFormat == null) {
            synchronized (C3204PhoneFormat.class) {
                c3204PhoneFormat = Instance;
                if (c3204PhoneFormat == null) {
                    c3204PhoneFormat = new C3204PhoneFormat();
                    Instance = c3204PhoneFormat;
                }
            }
        }
        return c3204PhoneFormat;
    }
    ...
    */
    public java.lang.String valueString(int r5) {
        ...
        L1a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.PhoneFormat.C3204PhoneFormat.valueString(int):java.lang.String");
    }
    ...
    public CallingCodeInfo callingCodeInfo(String str) {
        ...
        byte[] bArr;
        int i;
        C3204PhoneFormat c3204PhoneFormat = this;
        CallingCodeInfo callingCodeInfo = c3204PhoneFormat.callingCodeData.get(str);
        if (callingCodeInfo != null || (num = c3204PhoneFormat.callingCodeOffsets.get(str)) == null) {
            return callingCodeInfo;
        }
        byte[] bArr2 = c3204PhoneFormat.data;
        int intValue = num.intValue();
        CallingCodeInfo callingCodeInfo2 = new CallingCodeInfo();
        callingCodeInfo2.callingCode = str;
        c3204PhoneFormat.callingCodeCountries.get(str);
        c3204PhoneFormat.callingCodeData.put(str, callingCodeInfo2);
        short value16 = c3204PhoneFormat.value16(intValue);
        int i2 = 2;
        int i3 = intValue + 2 + 2;
        short value162 = c3204PhoneFormat.value16(i3);
        int i4 = i3 + 2 + 2;
        short value163 = c3204PhoneFormat.value16(i4);
        int i5 = i4 + 2 + 2;
        ArrayList<String> arrayList = new ArrayList<>(5);
        while (true) {
            String valueString = c3204PhoneFormat.valueString(i5);
        ...
        while (true) {
            String valueString2 = c3204PhoneFormat.valueString(i6);
        ...
        while (i9 < value163) {
            ...
            ruleSet.matchLen = c3204PhoneFormat.value16(i8);
            int i10 = i8 + i2;
            short value164 = c3204PhoneFormat.value16(i10);
            i8 = i10 + i2;
            ArrayList<PhoneRule> arrayList4 = new ArrayList<>(value164);
            int i11 = 0;
            while (i11 < value164) {
                PhoneRule phoneRule = new PhoneRule();
                phoneRule.minVal = c3204PhoneFormat.value32(i8);
                int i12 = i8 + 4;
                phoneRule.maxVal = c3204PhoneFormat.value32(i12);
                int i13 = i12 + 4;
                int i14 = i13 + 1;
                byte b = bArr2[i13];
                int i15 = i14 + 1;
                ...
                int i19 = i18 + 1;
                byte b4 = bArr2[i18];
                short value165 = c3204PhoneFormat.value16(i19);
                i8 = i19 + i2;
                String valueString3 = c3204PhoneFormat.valueString(i7 + value162 + value165);
