...
public class X9FieldID extends ASN1Object implements X9ObjectIdentifiers {
    ...
    /* renamed from: id */
    private ASN1ObjectIdentifier f1246id;
    ...
    public X9FieldID(int i, int i2, int i3, int i4) {
        this.f1246id = X9ObjectIdentifiers.characteristic_two_field;
    ...
    public X9FieldID(BigInteger bigInteger) {
        this.f1246id = X9ObjectIdentifiers.prime_field;
    ...
    public ASN1Primitive toASN1Primitive() {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector();
        aSN1EncodableVector.add(this.f1246id);
