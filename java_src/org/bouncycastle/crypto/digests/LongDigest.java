...
public abstract class LongDigest implements ExtendedDigest, Memoable {
    ...
    public void copyIn(LongDigest longDigest) {
        ...
        this.f1242H1 = longDigest.f1242H1;
        this.f1243H2 = longDigest.f1243H2;
        this.f1244H3 = longDigest.f1244H3;
        this.f1245H4 = longDigest.f1245H4;
        this.f1246H5 = longDigest.f1246H5;
        this.f1247H6 = longDigest.f1247H6;
        this.f1248H7 = longDigest.f1248H7;
        this.f1249H8 = longDigest.f1249H8;
        long[] jArr = longDigest.f1250W;
        System.arraycopy(jArr, 0, this.f1250W, 0, jArr.length);
    ...
    protected void processBlock() {
        adjustByteCounts();
        for (int i = 16; i <= 79; i++) {
            long[] jArr = this.f1250W;
            long Sigma1 = Sigma1(jArr[i - 2]);
            long[] jArr2 = this.f1250W;
            jArr[i] = Sigma1 + jArr2[i - 7] + Sigma0(jArr2[i - 15]) + this.f1250W[i - 16];
        }
        long j = this.f1242H1;
        long j2 = this.f1243H2;
        long j3 = this.f1244H3;
        long j4 = this.f1245H4;
        long j5 = this.f1246H5;
        long j6 = this.f1247H6;
        long j7 = this.f1248H7;
        long j8 = j6;
        long j9 = j4;
        int i2 = 0;
        long j10 = j2;
        ...
        while (i3 < 10) {
            ...
            long[] jArr3 = f1241K;
            int i4 = i2 + 1;
            long Sum1 = j13 + Sum1(j12) + m85Ch(j12, j8, j15) + jArr3[i2] + this.f1250W[i2];
            long j17 = j9 + Sum1;
            long Sum0 = Sum1 + Sum0(j14) + Maj(j14, j10, j11);
            int i5 = i4 + 1;
            long Sum12 = j15 + Sum1(j17) + m85Ch(j17, j16, j8) + jArr3[i4] + this.f1250W[i4];
            long j18 = j11 + Sum12;
            long Sum02 = Sum12 + Sum0(Sum0) + Maj(Sum0, j14, j10);
            int i6 = i5 + 1;
            long Sum13 = j8 + Sum1(j18) + m85Ch(j18, j17, j16) + jArr3[i5] + this.f1250W[i5];
            long j19 = j10 + Sum13;
            long Sum03 = Sum13 + Sum0(Sum02) + Maj(Sum02, Sum0, j14);
            int i7 = i6 + 1;
            long Sum14 = j16 + Sum1(j19) + m85Ch(j19, j18, j17) + jArr3[i6] + this.f1250W[i6];
            long j20 = j14 + Sum14;
            long Sum04 = Sum14 + Sum0(Sum03) + Maj(Sum03, Sum02, Sum0);
            int i8 = i7 + 1;
            long Sum15 = j17 + Sum1(j20) + m85Ch(j20, j19, j18) + jArr3[i7] + this.f1250W[i7];
            long j21 = Sum0 + Sum15;
            long Sum05 = Sum15 + Sum0(Sum04) + Maj(Sum04, Sum03, Sum02);
            int i9 = i8 + 1;
            long Sum16 = j18 + Sum1(j21) + m85Ch(j21, j20, j19) + jArr3[i8] + this.f1250W[i8];
            long j22 = Sum02 + Sum16;
            long Sum06 = Sum16 + Sum0(Sum05) + Maj(Sum05, Sum04, Sum03);
            j15 = j22;
            int i10 = i9 + 1;
            long Sum17 = j19 + Sum1(j22) + m85Ch(j22, j21, j20) + jArr3[i9] + this.f1250W[i9];
            long j23 = Sum03 + Sum17;
            j8 = j23;
            j10 = Sum17 + Sum0(Sum06) + Maj(Sum06, Sum05, Sum04);
            long Sum18 = j20 + Sum1(j23) + m85Ch(j23, j15, j21) + jArr3[i10] + this.f1250W[i10];
    ...
    protected void processWord(byte[] bArr, int i) {
        this.f1250W[this.wOff] = Pack.bigEndianToLong(bArr, i);
        int i2 = this.wOff + 1;
        this.wOff = i2;
        if (i2 == 16) {
            processBlock();
