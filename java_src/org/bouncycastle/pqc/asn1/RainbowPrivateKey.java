...
public class RainbowPrivateKey extends ASN1Object {
    ...
    /* renamed from: b1 */
    private byte[] f1472b1;

    /* renamed from: b2 */
    private byte[] f1473b2;
    private byte[][] invA1;
    private byte[][] invA2;
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f1472b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f1473b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f1474vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f1474vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            byte[] bArr5 = this.f1474vi;
            int i11 = i10 + 1;
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f1472b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f1473b2 = RainbowUtil.convertArray(sArr4);
        this.f1474vi = RainbowUtil.convertIntArray(iArr);
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f1472b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f1473b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f1474vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f1472b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f1473b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f1474vi));
