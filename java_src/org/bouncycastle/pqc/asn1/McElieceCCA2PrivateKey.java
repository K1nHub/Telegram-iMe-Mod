...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f1291n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f1290k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f1291n));
        aSN1EncodableVector.add(new ASN1Integer(this.f1290k));
