...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f1375n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().intValue();
        this.f1374k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f1375n));
        aSN1EncodableVector.add(new ASN1Integer(this.f1374k));
