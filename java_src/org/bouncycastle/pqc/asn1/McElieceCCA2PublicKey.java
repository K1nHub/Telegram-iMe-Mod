...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    /* renamed from: g */
    private final GF2Matrix f1376g;

    /* renamed from: n */
    private final int f1377n;

    /* renamed from: t */
    private final int f1378t;

    public McElieceCCA2PublicKey(int i, int i2, GF2Matrix gF2Matrix, AlgorithmIdentifier algorithmIdentifier) {
        this.f1377n = i;
        this.f1378t = i2;
        this.f1376g = new GF2Matrix(gF2Matrix.getEncoded());
        this.digest = algorithmIdentifier;
    }

    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        this.f1377n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().intValue();
        this.f1378t = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f1376g = new GF2Matrix(((ASN1OctetString) aSN1Sequence.getObjectAt(2)).getOctets());
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f1377n));
        aSN1EncodableVector.add(new ASN1Integer(this.f1378t));
        aSN1EncodableVector.add(new DEROctetString(this.f1376g.getEncoded()));
