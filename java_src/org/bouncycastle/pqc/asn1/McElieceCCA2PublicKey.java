...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    /* renamed from: g */
    private final GF2Matrix f1379g;
    ...
    public McElieceCCA2PublicKey(int i, int i2, GF2Matrix gF2Matrix, AlgorithmIdentifier algorithmIdentifier) {
        this.f1380n = i;
        this.f1381t = i2;
        this.f1379g = new GF2Matrix(gF2Matrix.getEncoded());
        this.digest = algorithmIdentifier;
    }

    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        this.f1380n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f1381t = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
        this.f1379g = new GF2Matrix(((ASN1OctetString) aSN1Sequence.getObjectAt(2)).getOctets());
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f1380n));
        aSN1EncodableVector.add(new ASN1Integer(this.f1381t));
        aSN1EncodableVector.add(new DEROctetString(this.f1379g.getEncoded()));
