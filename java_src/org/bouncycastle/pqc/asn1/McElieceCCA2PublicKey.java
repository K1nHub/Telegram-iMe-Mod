...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    /* renamed from: g */
    private final GF2Matrix f1382g;

    /* renamed from: n */
    private final int f1383n;
    ...
    public McElieceCCA2PublicKey(int i, int i2, GF2Matrix gF2Matrix, AlgorithmIdentifier algorithmIdentifier) {
        this.f1383n = i;
        this.f1384t = i2;
        this.f1382g = new GF2Matrix(gF2Matrix.getEncoded());
        this.digest = algorithmIdentifier;
    }

    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        this.f1383n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().intValue();
        this.f1384t = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f1382g = new GF2Matrix(((ASN1OctetString) aSN1Sequence.getObjectAt(2)).getOctets());
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f1383n));
        aSN1EncodableVector.add(new ASN1Integer(this.f1384t));
        aSN1EncodableVector.add(new DEROctetString(this.f1382g.getEncoded()));
