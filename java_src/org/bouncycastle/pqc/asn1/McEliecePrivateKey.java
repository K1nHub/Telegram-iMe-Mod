...
public class McEliecePrivateKey extends ASN1Object {
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f1468n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f1467k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f1468n));
        aSN1EncodableVector.add(new ASN1Integer(this.f1467k));
