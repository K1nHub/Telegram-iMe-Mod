...
public class HSSPrivateKeyParameters extends LMSKeyParameters {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f1393l == hSSPrivateKeyParameters.f1393l && this.isShard == hSSPrivateKeyParameters.isShard && this.indexLimit == hSSPrivateKeyParameters.indexLimit && this.index == hSSPrivateKeyParameters.index && this.keys.equals(hSSPrivateKeyParameters.keys)) {
    ...
    public synchronized byte[] getEncoded() throws IOException {
        Composer bool;
        bool = Composer.compose().u32str(0).u32str(this.f1393l).u64str(this.index).u64str(this.indexLimit).bool(this.isShard);
    ...
    public synchronized HSSPublicKeyParameters getPublicKey() {
        return new HSSPublicKeyParameters(this.f1393l, getRootKey().getPublicKey());
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.index;
        return (((((((((this.f1393l * 31) + (this.isShard ? 1 : 0)) * 31) + this.keys.hashCode()) * 31) + this.sig.hashCode()) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + ((int) (j2 ^ (j2 >>> 32)));
    }
}
