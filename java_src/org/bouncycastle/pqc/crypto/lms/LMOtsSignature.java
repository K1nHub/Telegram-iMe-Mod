...
class LMOtsSignature implements Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        if (lMOtsParameters == null ? lMOtsSignature.type == null : lMOtsParameters.equals(lMOtsSignature.type)) {
            if (Arrays.equals(this.f1480C, lMOtsSignature.f1480C)) {
                return Arrays.equals(this.f1481y, lMOtsSignature.f1481y);
            }
            return false;
        }
        return false;
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.type.getType()).bytes(this.f1480C).bytes(this.f1481y).build();
    }

    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return ((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f1480C)) * 31) + Arrays.hashCode(this.f1481y);
    }
}
