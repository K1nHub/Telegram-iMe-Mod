...
class LMSSignature implements Encodable {
    ...
    /* renamed from: q */
    private final int f1315q;

    /* renamed from: y */
    private final byte[][] f1316y;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f1315q != lMSSignature.f1315q) {
            return false;
        }
        ...
        if (lMOtsSignature == null ? lMSSignature.otsSignature == null : lMOtsSignature.equals(lMSSignature.otsSignature)) {
            ...
            if (lMSigParameters == null ? lMSSignature.parameter == null : lMSigParameters.equals(lMSSignature.parameter)) {
                return Arrays.deepEquals(this.f1316y, lMSSignature.f1316y);
            }
            return false;
        }
        return false;
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.f1315q).bytes(this.otsSignature.getEncoded()).u32str(this.parameter.getType()).bytes(this.f1316y).build();
    }

    public int hashCode() {
        int i = this.f1315q * 31;
        LMOtsSignature lMOtsSignature = this.otsSignature;
        int hashCode = (i + (lMOtsSignature != null ? lMOtsSignature.hashCode() : 0)) * 31;
        LMSigParameters lMSigParameters = this.parameter;
        return ((hashCode + (lMSigParameters != null ? lMSigParameters.hashCode() : 0)) * 31) + Arrays.deepHashCode(this.f1316y);
    }
}
