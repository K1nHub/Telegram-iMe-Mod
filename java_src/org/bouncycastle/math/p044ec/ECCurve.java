...
import org.bouncycastle.math.p044ec.endo.ECEndomorphism;
...
public abstract class ECCurve {
    ...
    /* renamed from: a */
    protected ECFieldElement f1313a;

    /* renamed from: b */
    protected ECFieldElement f1314b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public synchronized BigInteger[] getSi() {
            if (this.f1315si == null) {
                this.f1315si = Tnaf.getSi(this);
            }
            return this.f1315si;
        }

        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f1314b.isOne() && (this.f1313a.isZero() || this.f1313a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        protected ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement fromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement sqrt = fromBigInteger.square().add(this.f1313a).multiply(fromBigInteger).add(this.f1314b).sqrt();
            if (sqrt != null) {
