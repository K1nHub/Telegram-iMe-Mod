...
public class Tnaf {
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger subtract;
        BigInteger bigInteger = zTauElement.f1319u;
        BigInteger multiply = bigInteger.multiply(bigInteger);
        BigInteger multiply2 = zTauElement.f1319u.multiply(zTauElement.f1320v);
        BigInteger bigInteger2 = zTauElement.f1320v;
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(add.multiply(round.f1319u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(round.f1320v)), bigIntegerArr[1].multiply(round.f1319u).subtract(bigIntegerArr[0].multiply(round.f1320v)));
    }

    /* JADX WARN: Code restructure failed: missing block: B:21:0x0066, code lost:
        if (r5.compareTo(org.bouncycastle.math.p044ec.Tnaf.MINUS_ONE) < 0) goto L29;
     */
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0081, code lost:
        if (r5.compareTo(r9) >= 0) goto L25;
     */
    /* JADX WARN: Code restructure failed: missing block: B:33:0x008a, code lost:
        if (r8.compareTo(org.bouncycastle.math.p044ec.Tnaf.MINUS_TWO) < 0) goto L25;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static org.bouncycastle.math.p044ec.ZTauElement round(org.bouncycastle.math.p044ec.SimpleBigDecimal r8, org.bouncycastle.math.p044ec.SimpleBigDecimal r9, byte r10) {
        /*
            int r0 = r8.getScale()
            int r1 = r9.getScale()
            if (r1 != r0) goto La7
        ...
        L57:
            java.math.BigInteger r9 = org.bouncycastle.math.p044ec.ECConstants.ONE
            int r6 = r4.compareTo(r9)
            r7 = 0
            if (r6 < 0) goto L69
            java.math.BigInteger r6 = org.bouncycastle.math.p044ec.Tnaf.MINUS_ONE
            int r6 = r5.compareTo(r6)
            if (r6 >= 0) goto L75
            goto L71
        L69:
            java.math.BigInteger r1 = org.bouncycastle.math.p044ec.ECConstants.TWO
        ...
        L75:
            ...
            goto L8c
        L84:
            java.math.BigInteger r9 = org.bouncycastle.math.p044ec.Tnaf.MINUS_TWO
        ...
        La7:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p044ec.Tnaf.round(org.bouncycastle.math.ec.SimpleBigDecimal, org.bouncycastle.math.ec.SimpleBigDecimal, byte):org.bouncycastle.math.ec.ZTauElement");
    }
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        BigInteger bigInteger3 = zTauElement.f1319u;
        BigInteger bigInteger4 = zTauElement.f1320v;
        int i = 0;
        while (true) {
            ...
            if (bigInteger3.testBit(0)) {
                ...
                if (z) {
                    bigInteger3 = bigInteger3.subtract(zTauElementArr[intValue].f1319u);
                    bigInteger4 = bigInteger4.subtract(zTauElementArr[intValue].f1320v);
                } else {
                    bigInteger3 = bigInteger3.add(zTauElementArr[intValue].f1319u);
                    bigInteger4 = bigInteger4.add(zTauElementArr[intValue].f1320v);
                }
            } else {
                bArr[i] = 0;
            }
