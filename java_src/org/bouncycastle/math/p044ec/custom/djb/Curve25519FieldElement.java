...
public class Curve25519FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: x */
    protected int[] f1324x;

    /* renamed from: Q */
    public static final BigInteger f1323Q = Curve25519.f1321q;
    ...
    public Curve25519FieldElement() {
        this.f1324x = Nat256.create();
    }

    public Curve25519FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1323Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for Curve25519FieldElement");
        }
        this.f1324x = Curve25519Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        Curve25519Field.add(this.f1324x, ((Curve25519FieldElement) eCFieldElement).f1324x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        Curve25519Field.addOne(this.f1324x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Mod.invert(Curve25519Field.f1322P, ((Curve25519FieldElement) eCFieldElement).f1324x, create);
        Curve25519Field.multiply(create, this.f1324x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Curve25519FieldElement) {
            return Nat256.m59eq(this.f1324x, ((Curve25519FieldElement) obj).f1324x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1323Q.hashCode() ^ Arrays.hashCode(this.f1324x, 0, 8);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat256.create();
        Mod.invert(Curve25519Field.f1322P, this.f1324x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isOne() {
        return Nat256.isOne(this.f1324x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isZero() {
        return Nat256.isZero(this.f1324x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.multiply(this.f1324x, ((Curve25519FieldElement) eCFieldElement).f1324x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat256.create();
        Curve25519Field.negate(this.f1324x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f1324x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        Curve25519Field.square(this.f1324x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean testBitZero() {
        return Nat256.getBit(this.f1324x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f1324x);
    }
}
