...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1321q = Nat256.toBigInteger(Curve25519Field.f1322P);
    protected Curve25519Point infinity;

    public Curve25519() {
        super(f1321q);
        this.infinity = new Curve25519Point(this, null, null);
        this.f1313a = fromBigInteger(new BigInteger(1, Hex.decode("2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA984914A144")));
        this.f1314b = fromBigInteger(new BigInteger(1, Hex.decode("7B425ED097B425ED097B425ED097B425ED097B425ED097B4260B5E9C7710C864")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawXCoord()).f1324x, 0, iArr, i3);
            int i5 = i3 + 8;
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawYCoord()).f1324x, 0, iArr, i5);
            i3 = i5 + 8;
        }
