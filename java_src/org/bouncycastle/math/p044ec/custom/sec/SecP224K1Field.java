...
public class SecP224K1Field {
    ...
    /* renamed from: P */
    static final int[] f1351P = {-6803, -2, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat224.add(iArr, iArr2, iArr3) != 0 || (iArr3[6] == -1 && Nat224.gte(iArr3, f1351P))) {
            Nat.add33To(7, 6803, iArr3);
        }
    }

    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(7, iArr, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f1351P))) {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[6] == -1 && Nat224.gte(fromBigInteger, f1351P)) {
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat224.isZero(iArr)) {
            ...
            Nat224.sub(f1351P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat224.mul33DWordAdd(6803, Nat224.mul33Add(6803, iArr, 7, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f1351P))) {
            Nat.add33To(7, 6803, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat224.mul33WordAdd(6803, i, iArr, 0) == 0) && !(iArr[6] == -1 && Nat224.gte(iArr, f1351P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(7, iArr, 0, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f1351P))) {
            Nat.add33To(7, 6803, iArr2);
        }
    }
}
