...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f1316x;
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f1317y;
        ...
        SecP521R1FieldElement secP521R1FieldElement5 = (SecP521R1FieldElement) this.f1318zs[0];
        ...
        if (isOne) {
            iArr = secP521R1FieldElement3.f1373x;
            iArr2 = secP521R1FieldElement4.f1373x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement5.f1373x, create3);
            SecP521R1Field.multiply(create3, secP521R1FieldElement3.f1373x, create2);
            SecP521R1Field.multiply(create3, secP521R1FieldElement5.f1373x, create3);
            SecP521R1Field.multiply(create3, secP521R1FieldElement4.f1373x, create3);
            iArr = create2;
            iArr2 = create3;
        }
        boolean isOne2 = secP521R1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP521R1FieldElement.f1373x;
            iArr4 = secP521R1FieldElement2.f1373x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement6.f1373x, create4);
            SecP521R1Field.multiply(create4, secP521R1FieldElement.f1373x, create);
            SecP521R1Field.multiply(create4, secP521R1FieldElement6.f1373x, create4);
            SecP521R1Field.multiply(create4, secP521R1FieldElement2.f1373x, create4);
            iArr3 = create;
            iArr4 = create4;
        }
        ...
        SecP521R1Field.square(create2, secP521R1FieldElement7.f1373x);
        int[] iArr5 = secP521R1FieldElement7.f1373x;
        SecP521R1Field.add(iArr5, create6, iArr5);
        int[] iArr6 = secP521R1FieldElement7.f1373x;
        SecP521R1Field.subtract(iArr6, create3, iArr6);
        int[] iArr7 = secP521R1FieldElement7.f1373x;
        ...
        SecP521R1Field.subtract(create3, secP521R1FieldElement7.f1373x, secP521R1FieldElement8.f1373x);
        SecP521R1Field.multiply(secP521R1FieldElement8.f1373x, create2, create2);
        SecP521R1Field.subtract(create2, create, secP521R1FieldElement8.f1373x);
        SecP521R1FieldElement secP521R1FieldElement9 = new SecP521R1FieldElement(create5);
        if (!isOne) {
            int[] iArr8 = secP521R1FieldElement9.f1373x;
            SecP521R1Field.multiply(iArr8, secP521R1FieldElement5.f1373x, iArr8);
        }
        if (!isOne2) {
            int[] iArr9 = secP521R1FieldElement9.f1373x;
            SecP521R1Field.multiply(iArr9, secP521R1FieldElement6.f1373x, iArr9);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP521R1Point(this.curve, this.f1316x, this.f1317y.negate(), this.f1318zs, this.withCompression);
    }

    @Override // org.bouncycastle.math.p044ec.ECPoint
    public ECPoint threeTimes() {
        return (isInfinity() || this.f1317y.isZero()) ? this : twice().add(this);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f1317y;
        if (secP521R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f1316x;
        SecP521R1FieldElement secP521R1FieldElement3 = (SecP521R1FieldElement) this.f1318zs[0];
        int[] create = Nat.create(17);
        int[] create2 = Nat.create(17);
        int[] create3 = Nat.create(17);
        SecP521R1Field.square(secP521R1FieldElement.f1373x, create3);
        int[] create4 = Nat.create(17);
        SecP521R1Field.square(create3, create4);
        boolean isOne = secP521R1FieldElement3.isOne();
        int[] iArr = secP521R1FieldElement3.f1373x;
        if (!isOne) {
            SecP521R1Field.square(iArr, create2);
            iArr = create2;
        }
        SecP521R1Field.subtract(secP521R1FieldElement2.f1373x, iArr, create);
        SecP521R1Field.add(secP521R1FieldElement2.f1373x, iArr, create2);
        SecP521R1Field.multiply(create2, create, create2);
        Nat.addBothTo(17, create2, create2, create2);
        SecP521R1Field.reduce23(create2);
        SecP521R1Field.multiply(create3, secP521R1FieldElement2.f1373x, create3);
        ...
        SecP521R1Field.square(create2, secP521R1FieldElement4.f1373x);
        int[] iArr2 = secP521R1FieldElement4.f1373x;
        SecP521R1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP521R1FieldElement4.f1373x;
        ...
        SecP521R1Field.subtract(create3, secP521R1FieldElement4.f1373x, secP521R1FieldElement5.f1373x);
        int[] iArr4 = secP521R1FieldElement5.f1373x;
        SecP521R1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP521R1FieldElement5.f1373x;
        SecP521R1Field.subtract(iArr5, create, iArr5);
        SecP521R1FieldElement secP521R1FieldElement6 = new SecP521R1FieldElement(create2);
        SecP521R1Field.twice(secP521R1FieldElement.f1373x, secP521R1FieldElement6.f1373x);
        if (!isOne) {
            int[] iArr6 = secP521R1FieldElement6.f1373x;
            SecP521R1Field.multiply(iArr6, secP521R1FieldElement3.f1373x, iArr6);
        }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        return this == eCPoint ? threeTimes() : isInfinity() ? eCPoint : eCPoint.isInfinity() ? twice() : this.f1317y.isZero() ? eCPoint : twice().add(eCPoint);
    }
}
