...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f1356Q = SecP224R1Curve.f1354q;

    /* renamed from: x */
    protected int[] f1357x;

    public SecP224R1FieldElement() {
        this.f1357x = Nat224.create();
    }

    public SecP224R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1356Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224R1FieldElement");
        }
        this.f1357x = SecP224R1Field.fromBigInteger(bigInteger);
    }
    ...
    /* renamed from: RM */
    private static void m67RM(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5, int[] iArr6, int[] iArr7) {
    ...
    /* renamed from: RP */
    private static void m66RP(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            while (true) {
                i2--;
                if (i2 >= 0) {
                    m65RS(iArr2, iArr3, iArr4, iArr5);
                }
            }
            m67RM(iArr, create, create2, iArr2, iArr3, iArr4, iArr5);
        }
    }

    /* renamed from: RS */
    private static void m65RS(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
    ...
    private static boolean trySqrt(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        m66RP(iArr, create, create2, create3, iArr3);
        int[] create4 = Nat224.create();
        int[] create5 = Nat224.create();
        for (int i = 1; i < 96; i++) {
            Nat224.copy(create, create4);
            Nat224.copy(create2, create5);
            m65RS(create, create2, create3, iArr3);
            if (Nat224.isZero(create)) {
                Mod.invert(SecP224R1Field.f1355P, create5, iArr3);
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.add(this.f1357x, ((SecP224R1FieldElement) eCFieldElement).f1357x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224R1Field.addOne(this.f1357x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        Mod.invert(SecP224R1Field.f1355P, ((SecP224R1FieldElement) eCFieldElement).f1357x, create);
        SecP224R1Field.multiply(create, this.f1357x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224R1FieldElement) {
            return Nat224.m60eq(this.f1357x, ((SecP224R1FieldElement) obj).f1357x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1356Q.hashCode() ^ Arrays.hashCode(this.f1357x, 0, 7);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat224.create();
        Mod.invert(SecP224R1Field.f1355P, this.f1357x, create);
        return new SecP224R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f1357x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f1357x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.multiply(this.f1357x, ((SecP224R1FieldElement) eCFieldElement).f1357x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224R1Field.negate(this.f1357x, create);
        return new SecP224R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f1357x;
        if (Nat224.isZero(iArr) || Nat224.isOne(iArr)) {
            return this;
        }
        int[] create = Nat224.create();
        SecP224R1Field.negate(iArr, create);
        int[] random = Mod.random(SecP224R1Field.f1355P);
        int[] create2 = Nat224.create();
        if (isSquare(iArr)) {
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224R1Field.square(this.f1357x, create);
        return new SecP224R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f1357x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f1357x);
    }
}
