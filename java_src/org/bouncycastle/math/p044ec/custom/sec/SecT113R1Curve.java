...
public class SecT113R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT113R1Curve() {
        ...
        this.f1313a = fromBigInteger(new BigInteger(1, Hex.decode("003088250CA6E7C7FE649CE85820F7")));
        this.f1314b = fromBigInteger(new BigInteger(1, Hex.decode("00E8BEE4D3E2260744188BE0E9C723")));
