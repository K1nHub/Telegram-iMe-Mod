...
public class SecP256K1Field {
    ...
    /* renamed from: P */
    static final int[] f1359P = {-977, -2, -1, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f1359P))) {
            Nat.add33To(8, 977, iArr3);
        }
    }

    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1359P))) {
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat256.isZero(iArr)) {
            ...
            Nat256.sub(f1359P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat256.mul33DWordAdd(977, Nat256.mul33Add(977, iArr, 8, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1359P))) {
            Nat.add33To(8, 977, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat256.mul33WordAdd(977, i, iArr, 0) == 0) && !(iArr[7] == -1 && Nat256.gte(iArr, f1359P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1359P))) {
            Nat.add33To(8, 977, iArr2);
        }
    }
}
