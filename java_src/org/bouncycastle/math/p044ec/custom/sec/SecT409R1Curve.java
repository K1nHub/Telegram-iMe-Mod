...
public class SecT409R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT409R1Curve() {
        ...
        this.f1314b = fromBigInteger(new BigInteger(1, Hex.decode("0021A5C2C8EE9FEB5C4B9A753B7B476B7FD6422EF1F3DD674761FA99D6AC27C8A9A197B272822F6CD57A55AA4F50AE317B13545F")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat448.copy64(((SecT409FieldElement) eCPoint.getRawXCoord()).f1381x, 0, jArr, i3);
            int i5 = i3 + 7;
            Nat448.copy64(((SecT409FieldElement) eCPoint.getRawYCoord()).f1381x, 0, jArr, i5);
            i3 = i5 + 7;
        }
