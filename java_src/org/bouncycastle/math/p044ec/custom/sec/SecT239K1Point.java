...
public class SecT239K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply3.isZero()) {
                return new SecT239K1Point(curve, multiply3, curve.getB(), this.withCompression);
            }
        ...
        return new SecT239K1Point(curve, eCFieldElement4, eCFieldElement5, new ECFieldElement[]{eCFieldElement6}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        if (add.isZero()) {
            return new SecT239K1Point(curve, add, curve.getB(), this.withCompression);
        }
        ...
        return new SecT239K1Point(curve, square2, square3.add(add).add(square).multiply(square3).add(eCFieldElement3).add(square2).add(multiply), new ECFieldElement[]{multiply}, this.withCompression);
    }
