...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1342q = new BigInteger(1, Hex.decode("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFEE37"));
    ...
    public SecP192K1Curve() {
        ...
        this.f1314b = fromBigInteger(BigInteger.valueOf(3L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawXCoord()).f1345x, 0, iArr, i3);
            int i5 = i3 + 6;
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawYCoord()).f1345x, 0, iArr, i5);
            i3 = i5 + 6;
        }
