...
public class SecP192K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f1316x;
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f1317y;
        ...
        SecP192K1FieldElement secP192K1FieldElement5 = (SecP192K1FieldElement) this.f1318zs[0];
        ...
        if (isOne) {
            iArr = secP192K1FieldElement3.f1345x;
            iArr2 = secP192K1FieldElement4.f1345x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement5.f1345x, create2);
            SecP192K1Field.multiply(create2, secP192K1FieldElement3.f1345x, create);
            SecP192K1Field.multiply(create2, secP192K1FieldElement5.f1345x, create2);
            SecP192K1Field.multiply(create2, secP192K1FieldElement4.f1345x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP192K1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP192K1FieldElement.f1345x;
            iArr4 = secP192K1FieldElement2.f1345x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement6.f1345x, create3);
            SecP192K1Field.multiply(create3, secP192K1FieldElement.f1345x, createExt);
            SecP192K1Field.multiply(create3, secP192K1FieldElement6.f1345x, create3);
            SecP192K1Field.multiply(create3, secP192K1FieldElement2.f1345x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP192K1Field.square(create, secP192K1FieldElement7.f1345x);
        int[] iArr5 = secP192K1FieldElement7.f1345x;
        ...
        SecP192K1Field.subtract(create2, secP192K1FieldElement7.f1345x, secP192K1FieldElement8.f1345x);
        SecP192K1Field.multiplyAddToExt(secP192K1FieldElement8.f1345x, create, createExt);
        SecP192K1Field.reduce(createExt, secP192K1FieldElement8.f1345x);
        SecP192K1FieldElement secP192K1FieldElement9 = new SecP192K1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP192K1FieldElement9.f1345x;
            SecP192K1Field.multiply(iArr6, secP192K1FieldElement5.f1345x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP192K1FieldElement9.f1345x;
            SecP192K1Field.multiply(iArr7, secP192K1FieldElement6.f1345x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192K1Point(this.curve, this.f1316x, this.f1317y.negate(), this.f1318zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f1317y;
        if (secP192K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f1316x;
        SecP192K1FieldElement secP192K1FieldElement3 = (SecP192K1FieldElement) this.f1318zs[0];
        int[] create = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement.f1345x, create);
        int[] create2 = Nat192.create();
        SecP192K1Field.square(create, create2);
        int[] create3 = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement2.f1345x, create3);
        SecP192K1Field.reduce32(Nat192.addBothTo(create3, create3, create3), create3);
        SecP192K1Field.multiply(create, secP192K1FieldElement2.f1345x, create);
        ...
        SecP192K1Field.square(create3, secP192K1FieldElement4.f1345x);
        int[] iArr = secP192K1FieldElement4.f1345x;
        SecP192K1Field.subtract(iArr, create, iArr);
        int[] iArr2 = secP192K1FieldElement4.f1345x;
        SecP192K1Field.subtract(iArr2, create, iArr2);
        SecP192K1FieldElement secP192K1FieldElement5 = new SecP192K1FieldElement(create);
        SecP192K1Field.subtract(create, secP192K1FieldElement4.f1345x, secP192K1FieldElement5.f1345x);
        int[] iArr3 = secP192K1FieldElement5.f1345x;
        SecP192K1Field.multiply(iArr3, create3, iArr3);
        int[] iArr4 = secP192K1FieldElement5.f1345x;
        ...
        SecP192K1Field.twice(secP192K1FieldElement.f1345x, secP192K1FieldElement6.f1345x);
        if (!secP192K1FieldElement3.isOne()) {
            int[] iArr5 = secP192K1FieldElement6.f1345x;
            SecP192K1Field.multiply(iArr5, secP192K1FieldElement3.f1345x, iArr5);
        }
