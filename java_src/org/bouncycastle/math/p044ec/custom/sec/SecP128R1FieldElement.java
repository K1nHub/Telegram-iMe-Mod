...
public class SecP128R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f1331Q = SecP128R1Curve.f1329q;

    /* renamed from: x */
    protected int[] f1332x;

    public SecP128R1FieldElement() {
        this.f1332x = Nat128.create();
    }
    ...
    public SecP128R1FieldElement(BigInteger bigInteger) {
        ...
        this.f1332x = SecP128R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP128R1Field.add(this.f1332x, ((SecP128R1FieldElement) eCFieldElement).f1332x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat128.create();
        SecP128R1Field.addOne(this.f1332x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        Mod.invert(SecP128R1Field.f1330P, ((SecP128R1FieldElement) eCFieldElement).f1332x, create);
        SecP128R1Field.multiply(create, this.f1332x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP128R1FieldElement) {
            return Nat128.m63eq(this.f1332x, ((SecP128R1FieldElement) obj).f1332x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1331Q.hashCode() ^ Arrays.hashCode(this.f1332x, 0, 4);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat128.create();
        Mod.invert(SecP128R1Field.f1330P, this.f1332x, create);
        return new SecP128R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isOne() {
        return Nat128.isOne(this.f1332x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isZero() {
        return Nat128.isZero(this.f1332x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.multiply(this.f1332x, ((SecP128R1FieldElement) eCFieldElement).f1332x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat128.create();
        SecP128R1Field.negate(this.f1332x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat128.create();
        SecP128R1Field.square(this.f1332x, create);
        return new SecP128R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean testBitZero() {
        return Nat128.getBit(this.f1332x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat128.toBigInteger(this.f1332x);
    }
}
