...
public class SecT283R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT283R1Curve() {
        ...
        this.f1314b = fromBigInteger(new BigInteger(1, Hex.decode("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat320.copy64(((SecT283FieldElement) eCPoint.getRawXCoord()).f1380x, 0, jArr, i3);
            int i5 = i3 + 5;
            Nat320.copy64(((SecT283FieldElement) eCPoint.getRawYCoord()).f1380x, 0, jArr, i5);
            i3 = i5 + 5;
        }
