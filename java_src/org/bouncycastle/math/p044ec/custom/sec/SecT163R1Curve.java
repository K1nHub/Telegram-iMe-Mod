...
public class SecT163R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163R1Curve() {
        ...
        this.f1313a = fromBigInteger(new BigInteger(1, Hex.decode("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
        this.f1314b = fromBigInteger(new BigInteger(1, Hex.decode("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9")));
