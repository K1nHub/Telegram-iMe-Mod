...
public class SecP160R2Field {
    ...
    /* renamed from: P */
    static final int[] f1339P = {-21389, -2, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f1339P))) {
            Nat.add33To(5, 21389, iArr3);
        }
    }

    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1339P))) {
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat160.isZero(iArr)) {
            ...
            Nat160.sub(f1339P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat160.mul33DWordAdd(21389, Nat160.mul33Add(21389, iArr, 5, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1339P))) {
            Nat.add33To(5, 21389, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat160.mul33WordAdd(21389, i, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f1339P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1339P))) {
            Nat.add33To(5, 21389, iArr2);
        }
    }
}
