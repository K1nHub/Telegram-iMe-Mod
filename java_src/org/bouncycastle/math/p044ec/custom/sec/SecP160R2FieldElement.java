...
public class SecP160R2FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f1340Q = SecP160R2Curve.f1338q;

    /* renamed from: x */
    protected int[] f1341x;

    public SecP160R2FieldElement() {
        this.f1341x = Nat160.create();
    }

    public SecP160R2FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1340Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP160R2FieldElement");
        }
        this.f1341x = SecP160R2Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP160R2Field.add(this.f1341x, ((SecP160R2FieldElement) eCFieldElement).f1341x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat160.create();
        SecP160R2Field.addOne(this.f1341x, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        Mod.invert(SecP160R2Field.f1339P, ((SecP160R2FieldElement) eCFieldElement).f1341x, create);
        SecP160R2Field.multiply(create, this.f1341x, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP160R2FieldElement) {
            return Nat160.m62eq(this.f1341x, ((SecP160R2FieldElement) obj).f1341x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1340Q.hashCode() ^ Arrays.hashCode(this.f1341x, 0, 5);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat160.create();
        Mod.invert(SecP160R2Field.f1339P, this.f1341x, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isOne() {
        return Nat160.isOne(this.f1341x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isZero() {
        return Nat160.isZero(this.f1341x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        SecP160R2Field.multiply(this.f1341x, ((SecP160R2FieldElement) eCFieldElement).f1341x, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat160.create();
        SecP160R2Field.negate(this.f1341x, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f1341x;
    ...
    public ECFieldElement square() {
        int[] create = Nat160.create();
        SecP160R2Field.square(this.f1341x, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean testBitZero() {
        return Nat160.getBit(this.f1341x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat160.toBigInteger(this.f1341x);
    }
}
