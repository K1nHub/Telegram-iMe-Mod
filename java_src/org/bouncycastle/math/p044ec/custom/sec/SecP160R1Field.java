...
public class SecP160R1Field {
    ...
    /* renamed from: P */
    static final int[] f1335P = {Integer.MAX_VALUE, -1, -1, -1, -1};
    static final int[] PExt = {1, 1073741825, 0, 0, 0, -2, -2, -1, -1, -1};
    private static final int[] PExtInv = {-1, -1073741826, -1, -1, -1, 1, 1};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f1335P))) {
            Nat.addWordTo(5, C0482C.RATE_UNSET_INT, iArr3);
        }
    }

    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1335P))) {
            Nat.addWordTo(5, C0482C.RATE_UNSET_INT, iArr2);
        }
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat160.mulWordsAdd(C0482C.RATE_UNSET_INT, i, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f1335P))) {
            return;
        }
        Nat.addWordTo(5, C0482C.RATE_UNSET_INT, iArr);
    }
    ...
    public static void subtract(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.sub(iArr, iArr2, iArr3) != 0) {
            Nat.subWordFrom(5, C0482C.RATE_UNSET_INT, iArr3);
        }
    }

    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1335P))) {
            Nat.addWordTo(5, C0482C.RATE_UNSET_INT, iArr2);
        }
    }
}
