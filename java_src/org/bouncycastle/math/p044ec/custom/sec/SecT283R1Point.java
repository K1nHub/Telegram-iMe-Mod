...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public SecT283R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT283R1Point(curve, eCFieldElement4, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT283R1Point(curve, eCFieldElement4, eCFieldElement5, new ECFieldElement[]{eCFieldElement6}, this.withCompression);
    }
    ...
    public ECPoint negate() {
        ...
        ECFieldElement eCFieldElement2 = this.f1317y;
        ECFieldElement eCFieldElement3 = this.f1318zs[0];
        return new SecT283R1Point(this.curve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (square4.isZero()) {
            ...
            return new SecT283R1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, rawYCoord.addOne(), multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
        }
    }
}
