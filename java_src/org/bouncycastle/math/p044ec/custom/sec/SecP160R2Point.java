...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R2FieldElement secP160R2FieldElement = (SecP160R2FieldElement) this.f1316x;
        SecP160R2FieldElement secP160R2FieldElement2 = (SecP160R2FieldElement) this.f1317y;
        ...
        SecP160R2FieldElement secP160R2FieldElement5 = (SecP160R2FieldElement) this.f1318zs[0];
        ...
        if (isOne) {
            iArr = secP160R2FieldElement3.f1341x;
            iArr2 = secP160R2FieldElement4.f1341x;
        } else {
            SecP160R2Field.square(secP160R2FieldElement5.f1341x, create2);
            SecP160R2Field.multiply(create2, secP160R2FieldElement3.f1341x, create);
            SecP160R2Field.multiply(create2, secP160R2FieldElement5.f1341x, create2);
            SecP160R2Field.multiply(create2, secP160R2FieldElement4.f1341x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP160R2FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP160R2FieldElement.f1341x;
            iArr4 = secP160R2FieldElement2.f1341x;
        } else {
            SecP160R2Field.square(secP160R2FieldElement6.f1341x, create3);
            SecP160R2Field.multiply(create3, secP160R2FieldElement.f1341x, createExt);
            SecP160R2Field.multiply(create3, secP160R2FieldElement6.f1341x, create3);
            SecP160R2Field.multiply(create3, secP160R2FieldElement2.f1341x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP160R2Field.square(create, secP160R2FieldElement7.f1341x);
        int[] iArr5 = secP160R2FieldElement7.f1341x;
        ...
        SecP160R2Field.subtract(create2, secP160R2FieldElement7.f1341x, secP160R2FieldElement8.f1341x);
        SecP160R2Field.multiplyAddToExt(secP160R2FieldElement8.f1341x, create, createExt);
        SecP160R2Field.reduce(createExt, secP160R2FieldElement8.f1341x);
        SecP160R2FieldElement secP160R2FieldElement9 = new SecP160R2FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP160R2FieldElement9.f1341x;
            SecP160R2Field.multiply(iArr6, secP160R2FieldElement5.f1341x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP160R2FieldElement9.f1341x;
            SecP160R2Field.multiply(iArr7, secP160R2FieldElement6.f1341x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R2Point(this.curve, this.f1316x, this.f1317y.negate(), this.f1318zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R2FieldElement secP160R2FieldElement = (SecP160R2FieldElement) this.f1317y;
        if (secP160R2FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R2FieldElement secP160R2FieldElement2 = (SecP160R2FieldElement) this.f1316x;
        SecP160R2FieldElement secP160R2FieldElement3 = (SecP160R2FieldElement) this.f1318zs[0];
        int[] create = Nat160.create();
        int[] create2 = Nat160.create();
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f1341x, create3);
        int[] create4 = Nat160.create();
        SecP160R2Field.square(create3, create4);
        boolean isOne = secP160R2FieldElement3.isOne();
        int[] iArr = secP160R2FieldElement3.f1341x;
        if (!isOne) {
            SecP160R2Field.square(iArr, create2);
            iArr = create2;
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.f1341x, iArr, create);
        SecP160R2Field.add(secP160R2FieldElement2.f1341x, iArr, create2);
        ...
        SecP160R2Field.square(create2, secP160R2FieldElement4.f1341x);
        int[] iArr2 = secP160R2FieldElement4.f1341x;
        SecP160R2Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP160R2FieldElement4.f1341x;
        ...
        SecP160R2Field.subtract(create3, secP160R2FieldElement4.f1341x, secP160R2FieldElement5.f1341x);
        int[] iArr4 = secP160R2FieldElement5.f1341x;
        SecP160R2Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP160R2FieldElement5.f1341x;
        SecP160R2Field.subtract(iArr5, create, iArr5);
        SecP160R2FieldElement secP160R2FieldElement6 = new SecP160R2FieldElement(create2);
        SecP160R2Field.twice(secP160R2FieldElement.f1341x, secP160R2FieldElement6.f1341x);
        if (!isOne) {
            int[] iArr6 = secP160R2FieldElement6.f1341x;
            SecP160R2Field.multiply(iArr6, secP160R2FieldElement3.f1341x, iArr6);
        }
