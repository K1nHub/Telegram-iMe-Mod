...
public class SecP224K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: x */
    protected int[] f1353x;

    /* renamed from: Q */
    public static final BigInteger f1352Q = SecP224K1Curve.f1350q;
    private static final int[] PRECOMP_POW2 = {868209154, -587542221, 579297866, -1014948952, -1470801668, 514782679, -1897982644};

    public SecP224K1FieldElement() {
        this.f1353x = Nat224.create();
    }

    public SecP224K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1352Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224K1FieldElement");
        }
        this.f1353x = SecP224K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP224K1Field.add(this.f1353x, ((SecP224K1FieldElement) eCFieldElement).f1353x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224K1Field.addOne(this.f1353x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        Mod.invert(SecP224K1Field.f1351P, ((SecP224K1FieldElement) eCFieldElement).f1353x, create);
        SecP224K1Field.multiply(create, this.f1353x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224K1FieldElement) {
            return Nat224.m60eq(this.f1353x, ((SecP224K1FieldElement) obj).f1353x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1352Q.hashCode() ^ Arrays.hashCode(this.f1353x, 0, 7);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat224.create();
        Mod.invert(SecP224K1Field.f1351P, this.f1353x, create);
        return new SecP224K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f1353x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f1353x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.multiply(this.f1353x, ((SecP224K1FieldElement) eCFieldElement).f1353x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224K1Field.negate(this.f1353x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224K1Field.square(this.f1353x, create);
        return new SecP224K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f1353x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f1353x);
    }
}
