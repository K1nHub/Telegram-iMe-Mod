...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.curve, this.f1316x, this.f1317y.negate(), this.f1318zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        int[] create = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f1341x, create);
        int[] create2 = Nat160.create();
        SecP160R2Field.square(create, create2);
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f1341x, create3);
        SecP160R2Field.reduce32(Nat160.addBothTo(create3, create3, create3), create3);
        SecP160R2Field.multiply(create, secP160R2FieldElement2.f1341x, create);
        ...
        SecP160R2Field.square(create3, secP160R2FieldElement4.f1341x);
        int[] iArr = secP160R2FieldElement4.f1341x;
        ...
        SecP160R2Field.subtract(create, secP160R2FieldElement4.f1341x, secP160R2FieldElement5.f1341x);
        int[] iArr3 = secP160R2FieldElement5.f1341x;
        ...
        if (!secP160R2FieldElement3.isOne()) {
            int[] iArr5 = secP160R2FieldElement6.f1341x;
            SecP160R2Field.multiply(iArr5, secP160R2FieldElement3.f1341x, iArr5);
        }
