...
public class SecP192K1Field {
    ...
    /* renamed from: P */
    static final int[] f1343P = {-4553, -2, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat192.add(iArr, iArr2, iArr3) != 0 || (iArr3[5] == -1 && Nat192.gte(iArr3, f1343P))) {
            Nat.add33To(6, 4553, iArr3);
        }
    }

    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(6, iArr, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f1343P))) {
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat192.isZero(iArr)) {
            ...
            Nat192.sub(f1343P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat192.mul33DWordAdd(4553, Nat192.mul33Add(4553, iArr, 6, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f1343P))) {
            Nat.add33To(6, 4553, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat192.mul33WordAdd(4553, i, iArr, 0) == 0) && !(iArr[5] == -1 && Nat192.gte(iArr, f1343P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(6, iArr, 0, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f1343P))) {
            Nat.add33To(6, 4553, iArr2);
        }
    }
}
