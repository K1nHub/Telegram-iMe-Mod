...
public class SM2P256V1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f1327Q = SM2P256V1Curve.f1325q;

    /* renamed from: x */
    protected int[] f1328x;

    public SM2P256V1FieldElement() {
        this.f1328x = Nat256.create();
    }

    public SM2P256V1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1327Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SM2P256V1FieldElement");
        }
        this.f1328x = SM2P256V1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SM2P256V1Field.add(this.f1328x, ((SM2P256V1FieldElement) eCFieldElement).f1328x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        SM2P256V1Field.addOne(this.f1328x, create);
        return new SM2P256V1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Mod.invert(SM2P256V1Field.f1326P, ((SM2P256V1FieldElement) eCFieldElement).f1328x, create);
        SM2P256V1Field.multiply(create, this.f1328x, create);
        return new SM2P256V1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SM2P256V1FieldElement) {
            return Nat256.m59eq(this.f1328x, ((SM2P256V1FieldElement) obj).f1328x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1327Q.hashCode() ^ Arrays.hashCode(this.f1328x, 0, 8);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat256.create();
        Mod.invert(SM2P256V1Field.f1326P, this.f1328x, create);
        return new SM2P256V1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isOne() {
        return Nat256.isOne(this.f1328x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean isZero() {
        return Nat256.isZero(this.f1328x);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SM2P256V1Field.multiply(this.f1328x, ((SM2P256V1FieldElement) eCFieldElement).f1328x, create);
        return new SM2P256V1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat256.create();
        SM2P256V1Field.negate(this.f1328x, create);
        return new SM2P256V1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f1328x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        SM2P256V1Field.square(this.f1328x, create);
        return new SM2P256V1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public boolean testBitZero() {
        return Nat256.getBit(this.f1328x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p044ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f1328x);
    }
}
