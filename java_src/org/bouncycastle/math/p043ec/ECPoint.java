...
public abstract class ECPoint {
    ...
    /* renamed from: x */
    protected ECFieldElement f1305x;

    /* renamed from: y */
    protected ECFieldElement f1306y;

    /* renamed from: zs */
    protected ECFieldElement[] f1307zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement4 = this.f1307zs[0];
            boolean isOne = eCFieldElement4.isOne();
            if (eCFieldElement.isZero()) {
                ECFieldElement square = this.f1306y.square();
                if (!isOne) {
                    b = b.multiply(eCFieldElement4.square());
                }
                return square.equals(b);
            }
            ECFieldElement eCFieldElement5 = this.f1306y;
        ...
        public AbstractF2m tauPow(int i) {
            ...
            if (coordinateSystem != 0) {
                ...
                createRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f1306y.squarePow(i), new ECFieldElement[]{this.f1307zs[0].squarePow(i)}, this.withCompression);
                return (AbstractF2m) createRawPoint;
            }
            createRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f1306y.squarePow(i), this.withCompression);
            return (AbstractF2m) createRawPoint;
        }
    }
    ...
    protected ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f1305x = eCFieldElement;
        this.f1306y = eCFieldElement2;
        this.f1307zs = eCFieldElementArr;
    }
    ...
    public ECFieldElement getZCoord(int i) {
        if (i >= 0) {
            ECFieldElement[] eCFieldElementArr = this.f1307zs;
    ...
    public boolean isInfinity() {
        if (this.f1305x != null && this.f1306y != null) {
            ECFieldElement[] eCFieldElementArr = this.f1307zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f1307zs[0].isOne();
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.f1307zs.length; i++) {
            stringBuffer.append(',');
            stringBuffer.append(this.f1307zs[i]);
        }
        stringBuffer.append(')');
