...
public class SM2P256V1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SM2P256V1FieldElement sM2P256V1FieldElement = (SM2P256V1FieldElement) this.f1305x;
        SM2P256V1FieldElement sM2P256V1FieldElement2 = (SM2P256V1FieldElement) this.f1306y;
        ...
        SM2P256V1FieldElement sM2P256V1FieldElement5 = (SM2P256V1FieldElement) this.f1307zs[0];
        ...
        if (isOne) {
            iArr = sM2P256V1FieldElement3.f1317x;
            iArr2 = sM2P256V1FieldElement4.f1317x;
        } else {
            SM2P256V1Field.square(sM2P256V1FieldElement5.f1317x, create2);
            SM2P256V1Field.multiply(create2, sM2P256V1FieldElement3.f1317x, create);
            SM2P256V1Field.multiply(create2, sM2P256V1FieldElement5.f1317x, create2);
            SM2P256V1Field.multiply(create2, sM2P256V1FieldElement4.f1317x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = sM2P256V1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = sM2P256V1FieldElement.f1317x;
            iArr4 = sM2P256V1FieldElement2.f1317x;
        } else {
            SM2P256V1Field.square(sM2P256V1FieldElement6.f1317x, create3);
            SM2P256V1Field.multiply(create3, sM2P256V1FieldElement.f1317x, createExt);
            SM2P256V1Field.multiply(create3, sM2P256V1FieldElement6.f1317x, create3);
            SM2P256V1Field.multiply(create3, sM2P256V1FieldElement2.f1317x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SM2P256V1Field.square(create, sM2P256V1FieldElement7.f1317x);
        int[] iArr5 = sM2P256V1FieldElement7.f1317x;
        ...
        SM2P256V1Field.subtract(create2, sM2P256V1FieldElement7.f1317x, sM2P256V1FieldElement8.f1317x);
        SM2P256V1Field.multiplyAddToExt(sM2P256V1FieldElement8.f1317x, create, createExt);
        SM2P256V1Field.reduce(createExt, sM2P256V1FieldElement8.f1317x);
        SM2P256V1FieldElement sM2P256V1FieldElement9 = new SM2P256V1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = sM2P256V1FieldElement9.f1317x;
            SM2P256V1Field.multiply(iArr6, sM2P256V1FieldElement5.f1317x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = sM2P256V1FieldElement9.f1317x;
            SM2P256V1Field.multiply(iArr7, sM2P256V1FieldElement6.f1317x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SM2P256V1Point(this.curve, this.f1305x, this.f1306y.negate(), this.f1307zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SM2P256V1FieldElement sM2P256V1FieldElement = (SM2P256V1FieldElement) this.f1306y;
        if (sM2P256V1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SM2P256V1FieldElement sM2P256V1FieldElement2 = (SM2P256V1FieldElement) this.f1305x;
        SM2P256V1FieldElement sM2P256V1FieldElement3 = (SM2P256V1FieldElement) this.f1307zs[0];
        int[] create = Nat256.create();
        int[] create2 = Nat256.create();
        int[] create3 = Nat256.create();
        SM2P256V1Field.square(sM2P256V1FieldElement.f1317x, create3);
        int[] create4 = Nat256.create();
        SM2P256V1Field.square(create3, create4);
        boolean isOne = sM2P256V1FieldElement3.isOne();
        int[] iArr = sM2P256V1FieldElement3.f1317x;
        if (!isOne) {
            SM2P256V1Field.square(iArr, create2);
            iArr = create2;
        }
        SM2P256V1Field.subtract(sM2P256V1FieldElement2.f1317x, iArr, create);
        SM2P256V1Field.add(sM2P256V1FieldElement2.f1317x, iArr, create2);
        ...
        SM2P256V1Field.square(create2, sM2P256V1FieldElement4.f1317x);
        int[] iArr2 = sM2P256V1FieldElement4.f1317x;
        SM2P256V1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = sM2P256V1FieldElement4.f1317x;
        ...
        SM2P256V1Field.subtract(create3, sM2P256V1FieldElement4.f1317x, sM2P256V1FieldElement5.f1317x);
        int[] iArr4 = sM2P256V1FieldElement5.f1317x;
        SM2P256V1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = sM2P256V1FieldElement5.f1317x;
        SM2P256V1Field.subtract(iArr5, create, iArr5);
        SM2P256V1FieldElement sM2P256V1FieldElement6 = new SM2P256V1FieldElement(create2);
        SM2P256V1Field.twice(sM2P256V1FieldElement.f1317x, sM2P256V1FieldElement6.f1317x);
        if (!isOne) {
            int[] iArr6 = sM2P256V1FieldElement6.f1317x;
            SM2P256V1Field.multiply(iArr6, sM2P256V1FieldElement3.f1317x, iArr6);
        }
