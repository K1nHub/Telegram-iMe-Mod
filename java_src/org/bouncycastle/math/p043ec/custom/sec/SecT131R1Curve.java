...
public class SecT131R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R1Curve() {
        ...
        this.f1308a = fromBigInteger(new BigInteger(1, Hex.decode("07A11B09A76B562144418FF3FF8C2570B8")));
        this.f1309b = fromBigInteger(new BigInteger(1, Hex.decode("0217C05610884B63B9C6C7291678F9D341")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawXCoord()).f1370x, 0, jArr, i3);
            int i5 = i3 + 3;
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawYCoord()).f1370x, 0, jArr, i5);
            i3 = i5 + 3;
        }
        return new ECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT131R1Curve.1
