...
public class SecT131R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R1Curve() {
        ...
        this.f1302a = fromBigInteger(new BigInteger(1, Hex.decode("07A11B09A76B562144418FF3FF8C2570B8")));
        this.f1303b = fromBigInteger(new BigInteger(1, Hex.decode("0217C05610884B63B9C6C7291678F9D341")));
