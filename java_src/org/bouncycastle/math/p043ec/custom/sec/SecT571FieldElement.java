...
public class SecT571FieldElement extends ECFieldElement.AbstractF2m {
    ...
    public SecT571FieldElement(BigInteger bigInteger) {
        ...
        this.f1376x = SecT571Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecT571Field.add(this.f1376x, ((SecT571FieldElement) eCFieldElement).f1376x, create64);
    ...
    public ECFieldElement addOne() {
        long[] create64 = Nat576.create64();
        SecT571Field.addOne(this.f1376x, create64);
        return new SecT571FieldElement(create64);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecT571FieldElement) {
            return Nat576.eq64(this.f1376x, ((SecT571FieldElement) obj).f1376x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.hashCode(this.f1376x, 0, 9) ^ 5711052;
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement invert() {
        long[] create64 = Nat576.create64();
        SecT571Field.invert(this.f1376x, create64);
        return new SecT571FieldElement(create64);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isOne() {
        return Nat576.isOne64(this.f1376x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isZero() {
        return Nat576.isZero64(this.f1376x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        long[] create64 = Nat576.create64();
        SecT571Field.multiply(this.f1376x, ((SecT571FieldElement) eCFieldElement).f1376x, create64);
        return new SecT571FieldElement(create64);
    }
    ...
    public ECFieldElement multiplyPlusProduct(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement eCFieldElement3) {
        ...
        long[] jArr2 = ((SecT571FieldElement) eCFieldElement).f1376x;
        long[] jArr3 = ((SecT571FieldElement) eCFieldElement2).f1376x;
        long[] jArr4 = ((SecT571FieldElement) eCFieldElement3).f1376x;
    ...
    public ECFieldElement sqrt() {
        long[] create64 = Nat576.create64();
        SecT571Field.sqrt(this.f1376x, create64);
        return new SecT571FieldElement(create64);
    }
    ...
    public ECFieldElement square() {
        long[] create64 = Nat576.create64();
        SecT571Field.square(this.f1376x, create64);
        return new SecT571FieldElement(create64);
    }
    ...
    public ECFieldElement squarePow(int i) {
        ...
        long[] create64 = Nat576.create64();
        SecT571Field.squareN(this.f1376x, i, create64);
        return new SecT571FieldElement(create64);
    }
    ...
    public BigInteger toBigInteger() {
        return Nat576.toBigInteger64(this.f1376x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement.AbstractF2m
    public int trace() {
        return SecT571Field.trace(this.f1376x);
    }
}
