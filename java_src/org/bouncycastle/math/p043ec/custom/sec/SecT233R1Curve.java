...
public class SecT233R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT233R1Curve() {
        ...
        this.f1308a = fromBigInteger(BigInteger.valueOf(1L));
        this.f1309b = fromBigInteger(new BigInteger(1, Hex.decode("0066647EDE6C332C7F8C0923BB58213B333B20E9CE4281FE115F7D8F90AD")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy64(((SecT233FieldElement) eCPoint.getRawXCoord()).f1373x, 0, jArr, i3);
            int i5 = i3 + 4;
            Nat256.copy64(((SecT233FieldElement) eCPoint.getRawYCoord()).f1373x, 0, jArr, i5);
            i3 = i5 + 4;
        }
