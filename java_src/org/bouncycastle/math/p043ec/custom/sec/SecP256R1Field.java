...
public class SecP256R1Field {
    ...
    /* renamed from: P */
    static final int[] f1352P = {-1, -1, -1, 0, 0, 0, 1, -1};
    static final int[] PExt = {1, 0, 0, -2, -1, -1, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f1352P))) {
            addPInvTo(iArr3);
        }
    }

    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1352P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (j != 0 || (iArr[7] == -1 && Nat256.gte(iArr, f1352P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1352P))) {
            addPInvTo(iArr2);
        }
    }
}
