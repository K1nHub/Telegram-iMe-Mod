...
public class SecP160R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1323q = new BigInteger(1, Hex.decode("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF"));
    protected SecP160R1Point infinity;

    public SecP160R1Curve() {
        super(f1323q);
        this.infinity = new SecP160R1Point(this, null, null);
        this.f1302a = fromBigInteger(new BigInteger(1, Hex.decode("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC")));
        this.f1303b = fromBigInteger(new BigInteger(1, Hex.decode("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawXCoord()).f1326x, 0, iArr, i3);
            int i5 = i3 + 5;
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawYCoord()).f1326x, 0, iArr, i5);
            i3 = i5 + 5;
        }
