...
public class SecP384R1Field {
    ...
    /* renamed from: P */
    static final int[] f1356P = {-1, 0, 0, -1, -2, -1, -1, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat.add(12, iArr, iArr2, iArr3) != 0 || (iArr3[11] == -1 && Nat.gte(12, iArr3, f1356P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(12, iArr, iArr2) != 0 || (iArr2[11] == -1 && Nat.gte(12, iArr2, f1356P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if ((j == 0 || Nat.incAt(12, iArr, 5) == 0) && !(iArr[11] == -1 && Nat.gte(12, iArr, f1356P))) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(12, iArr, 0, iArr2) != 0 || (iArr2[11] == -1 && Nat.gte(12, iArr2, f1356P))) {
            addPInvTo(iArr2);
        }
    }
}
