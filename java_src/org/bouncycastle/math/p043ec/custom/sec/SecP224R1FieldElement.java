...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f1345Q = SecP224R1Curve.f1343q;

    /* renamed from: x */
    protected int[] f1346x;

    public SecP224R1FieldElement() {
        this.f1346x = Nat224.create();
    }

    public SecP224R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1345Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224R1FieldElement");
        }
        this.f1346x = SecP224R1Field.fromBigInteger(bigInteger);
    }
    ...
    private static boolean trySqrt(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i = 1; i < 96; i++) {
            ...
            if (Nat224.isZero(create)) {
                Mod.invert(SecP224R1Field.f1344P, create5, iArr3);
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.add(this.f1346x, ((SecP224R1FieldElement) eCFieldElement).f1346x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224R1Field.addOne(this.f1346x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        Mod.invert(SecP224R1Field.f1344P, ((SecP224R1FieldElement) eCFieldElement).f1346x, create);
        SecP224R1Field.multiply(create, this.f1346x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224R1FieldElement) {
            return Nat224.m65eq(this.f1346x, ((SecP224R1FieldElement) obj).f1346x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1345Q.hashCode() ^ Arrays.hashCode(this.f1346x, 0, 7);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat224.create();
        Mod.invert(SecP224R1Field.f1344P, this.f1346x, create);
        return new SecP224R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f1346x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f1346x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.multiply(this.f1346x, ((SecP224R1FieldElement) eCFieldElement).f1346x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224R1Field.negate(this.f1346x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public ECFieldElement sqrt() {
        ...
        int[] random = Mod.random(SecP224R1Field.f1344P);
        int[] create2 = Nat224.create();
        if (isSquare(iArr)) {
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224R1Field.square(this.f1346x, create);
        return new SecP224R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f1346x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f1346x);
    }
}
