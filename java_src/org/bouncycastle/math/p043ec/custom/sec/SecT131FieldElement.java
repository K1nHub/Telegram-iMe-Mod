...
public class SecT131FieldElement extends ECFieldElement.AbstractF2m {
    ...
    public SecT131FieldElement(BigInteger bigInteger) {
        ...
        this.f1369x = SecT131Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecT131Field.add(this.f1369x, ((SecT131FieldElement) eCFieldElement).f1369x, create64);
    ...
    public ECFieldElement addOne() {
        long[] create64 = Nat192.create64();
        SecT131Field.addOne(this.f1369x, create64);
        return new SecT131FieldElement(create64);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecT131FieldElement) {
            return Nat192.eq64(this.f1369x, ((SecT131FieldElement) obj).f1369x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.hashCode(this.f1369x, 0, 3) ^ 131832;
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement invert() {
        long[] create64 = Nat192.create64();
        SecT131Field.invert(this.f1369x, create64);
        return new SecT131FieldElement(create64);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isOne() {
        return Nat192.isOne64(this.f1369x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isZero() {
        return Nat192.isZero64(this.f1369x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        long[] create64 = Nat192.create64();
        SecT131Field.multiply(this.f1369x, ((SecT131FieldElement) eCFieldElement).f1369x, create64);
        return new SecT131FieldElement(create64);
    }
    ...
    public ECFieldElement multiplyPlusProduct(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement eCFieldElement3) {
        ...
        long[] jArr2 = ((SecT131FieldElement) eCFieldElement).f1369x;
        long[] jArr3 = ((SecT131FieldElement) eCFieldElement2).f1369x;
        long[] jArr4 = ((SecT131FieldElement) eCFieldElement3).f1369x;
    ...
    public ECFieldElement sqrt() {
        long[] create64 = Nat192.create64();
        SecT131Field.sqrt(this.f1369x, create64);
        return new SecT131FieldElement(create64);
    }
    ...
    public ECFieldElement square() {
        long[] create64 = Nat192.create64();
        SecT131Field.square(this.f1369x, create64);
        return new SecT131FieldElement(create64);
    }
    ...
    public ECFieldElement squarePow(int i) {
        ...
        long[] create64 = Nat192.create64();
        SecT131Field.squareN(this.f1369x, i, create64);
        return new SecT131FieldElement(create64);
    }
    ...
    public BigInteger toBigInteger() {
        return Nat192.toBigInteger64(this.f1369x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement.AbstractF2m
    public int trace() {
        return SecT131Field.trace(this.f1369x);
    }
}
