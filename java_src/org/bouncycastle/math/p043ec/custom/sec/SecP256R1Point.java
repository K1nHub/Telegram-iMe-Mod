...
public class SecP256R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP256R1FieldElement secP256R1FieldElement = (SecP256R1FieldElement) this.f1311x;
        SecP256R1FieldElement secP256R1FieldElement2 = (SecP256R1FieldElement) this.f1312y;
        ...
        SecP256R1FieldElement secP256R1FieldElement5 = (SecP256R1FieldElement) this.f1313zs[0];
        ...
        if (isOne) {
            iArr = secP256R1FieldElement3.f1360x;
            iArr2 = secP256R1FieldElement4.f1360x;
        } else {
            SecP256R1Field.square(secP256R1FieldElement5.f1360x, create2);
            SecP256R1Field.multiply(create2, secP256R1FieldElement3.f1360x, create);
            SecP256R1Field.multiply(create2, secP256R1FieldElement5.f1360x, create2);
            SecP256R1Field.multiply(create2, secP256R1FieldElement4.f1360x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP256R1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP256R1FieldElement.f1360x;
            iArr4 = secP256R1FieldElement2.f1360x;
        } else {
            SecP256R1Field.square(secP256R1FieldElement6.f1360x, create3);
            SecP256R1Field.multiply(create3, secP256R1FieldElement.f1360x, createExt);
            SecP256R1Field.multiply(create3, secP256R1FieldElement6.f1360x, create3);
            SecP256R1Field.multiply(create3, secP256R1FieldElement2.f1360x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP256R1Field.square(create, secP256R1FieldElement7.f1360x);
        int[] iArr5 = secP256R1FieldElement7.f1360x;
        ...
        SecP256R1Field.subtract(create2, secP256R1FieldElement7.f1360x, secP256R1FieldElement8.f1360x);
        SecP256R1Field.multiplyAddToExt(secP256R1FieldElement8.f1360x, create, createExt);
        SecP256R1Field.reduce(createExt, secP256R1FieldElement8.f1360x);
        SecP256R1FieldElement secP256R1FieldElement9 = new SecP256R1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP256R1FieldElement9.f1360x;
            SecP256R1Field.multiply(iArr6, secP256R1FieldElement5.f1360x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP256R1FieldElement9.f1360x;
            SecP256R1Field.multiply(iArr7, secP256R1FieldElement6.f1360x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP256R1Point(this.curve, this.f1311x, this.f1312y.negate(), this.f1313zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP256R1FieldElement secP256R1FieldElement = (SecP256R1FieldElement) this.f1312y;
        if (secP256R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP256R1FieldElement secP256R1FieldElement2 = (SecP256R1FieldElement) this.f1311x;
        SecP256R1FieldElement secP256R1FieldElement3 = (SecP256R1FieldElement) this.f1313zs[0];
        int[] create = Nat256.create();
        int[] create2 = Nat256.create();
        int[] create3 = Nat256.create();
        SecP256R1Field.square(secP256R1FieldElement.f1360x, create3);
        int[] create4 = Nat256.create();
        SecP256R1Field.square(create3, create4);
        boolean isOne = secP256R1FieldElement3.isOne();
        int[] iArr = secP256R1FieldElement3.f1360x;
        if (!isOne) {
            SecP256R1Field.square(iArr, create2);
            iArr = create2;
        }
        SecP256R1Field.subtract(secP256R1FieldElement2.f1360x, iArr, create);
        SecP256R1Field.add(secP256R1FieldElement2.f1360x, iArr, create2);
        ...
        SecP256R1Field.square(create2, secP256R1FieldElement4.f1360x);
        int[] iArr2 = secP256R1FieldElement4.f1360x;
        SecP256R1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP256R1FieldElement4.f1360x;
        ...
        SecP256R1Field.subtract(create3, secP256R1FieldElement4.f1360x, secP256R1FieldElement5.f1360x);
        int[] iArr4 = secP256R1FieldElement5.f1360x;
        SecP256R1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP256R1FieldElement5.f1360x;
        SecP256R1Field.subtract(iArr5, create, iArr5);
        SecP256R1FieldElement secP256R1FieldElement6 = new SecP256R1FieldElement(create2);
        SecP256R1Field.twice(secP256R1FieldElement.f1360x, secP256R1FieldElement6.f1360x);
        if (!isOne) {
            int[] iArr6 = secP256R1FieldElement6.f1360x;
            SecP256R1Field.multiply(iArr6, secP256R1FieldElement3.f1360x, iArr6);
        }
