...
public class SecP256K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP256K1FieldElement secP256K1FieldElement = (SecP256K1FieldElement) this.f1305x;
        SecP256K1FieldElement secP256K1FieldElement2 = (SecP256K1FieldElement) this.f1306y;
        ...
        SecP256K1FieldElement secP256K1FieldElement5 = (SecP256K1FieldElement) this.f1307zs[0];
        ...
        if (isOne) {
            iArr = secP256K1FieldElement3.f1350x;
            iArr2 = secP256K1FieldElement4.f1350x;
        } else {
            SecP256K1Field.square(secP256K1FieldElement5.f1350x, create2);
            SecP256K1Field.multiply(create2, secP256K1FieldElement3.f1350x, create);
            SecP256K1Field.multiply(create2, secP256K1FieldElement5.f1350x, create2);
            SecP256K1Field.multiply(create2, secP256K1FieldElement4.f1350x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP256K1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP256K1FieldElement.f1350x;
            iArr4 = secP256K1FieldElement2.f1350x;
        } else {
            SecP256K1Field.square(secP256K1FieldElement6.f1350x, create3);
            SecP256K1Field.multiply(create3, secP256K1FieldElement.f1350x, createExt);
            SecP256K1Field.multiply(create3, secP256K1FieldElement6.f1350x, create3);
            SecP256K1Field.multiply(create3, secP256K1FieldElement2.f1350x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP256K1Field.square(create, secP256K1FieldElement7.f1350x);
        int[] iArr5 = secP256K1FieldElement7.f1350x;
        ...
        SecP256K1Field.subtract(create2, secP256K1FieldElement7.f1350x, secP256K1FieldElement8.f1350x);
        SecP256K1Field.multiplyAddToExt(secP256K1FieldElement8.f1350x, create, createExt);
        SecP256K1Field.reduce(createExt, secP256K1FieldElement8.f1350x);
        SecP256K1FieldElement secP256K1FieldElement9 = new SecP256K1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP256K1FieldElement9.f1350x;
            SecP256K1Field.multiply(iArr6, secP256K1FieldElement5.f1350x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP256K1FieldElement9.f1350x;
            SecP256K1Field.multiply(iArr7, secP256K1FieldElement6.f1350x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP256K1Point(this.curve, this.f1305x, this.f1306y.negate(), this.f1307zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP256K1FieldElement secP256K1FieldElement = (SecP256K1FieldElement) this.f1306y;
        if (secP256K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP256K1FieldElement secP256K1FieldElement2 = (SecP256K1FieldElement) this.f1305x;
        SecP256K1FieldElement secP256K1FieldElement3 = (SecP256K1FieldElement) this.f1307zs[0];
        int[] create = Nat256.create();
        SecP256K1Field.square(secP256K1FieldElement.f1350x, create);
        int[] create2 = Nat256.create();
        SecP256K1Field.square(create, create2);
        int[] create3 = Nat256.create();
        SecP256K1Field.square(secP256K1FieldElement2.f1350x, create3);
        SecP256K1Field.reduce32(Nat256.addBothTo(create3, create3, create3), create3);
        SecP256K1Field.multiply(create, secP256K1FieldElement2.f1350x, create);
        ...
        SecP256K1Field.square(create3, secP256K1FieldElement4.f1350x);
        int[] iArr = secP256K1FieldElement4.f1350x;
        SecP256K1Field.subtract(iArr, create, iArr);
        int[] iArr2 = secP256K1FieldElement4.f1350x;
        SecP256K1Field.subtract(iArr2, create, iArr2);
        SecP256K1FieldElement secP256K1FieldElement5 = new SecP256K1FieldElement(create);
        SecP256K1Field.subtract(create, secP256K1FieldElement4.f1350x, secP256K1FieldElement5.f1350x);
        int[] iArr3 = secP256K1FieldElement5.f1350x;
        SecP256K1Field.multiply(iArr3, create3, iArr3);
        int[] iArr4 = secP256K1FieldElement5.f1350x;
        ...
        SecP256K1Field.twice(secP256K1FieldElement.f1350x, secP256K1FieldElement6.f1350x);
        if (!secP256K1FieldElement3.isOne()) {
            int[] iArr5 = secP256K1FieldElement6.f1350x;
            SecP256K1Field.multiply(iArr5, secP256K1FieldElement3.f1350x, iArr5);
        }
