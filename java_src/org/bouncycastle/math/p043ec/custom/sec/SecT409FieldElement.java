...
public class SecT409FieldElement extends ECFieldElement.AbstractF2m {
    ...
    public SecT409FieldElement(BigInteger bigInteger) {
        ...
        this.f1376x = SecT409Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecT409Field.add(this.f1376x, ((SecT409FieldElement) eCFieldElement).f1376x, create64);
    ...
    public ECFieldElement addOne() {
        long[] create64 = Nat448.create64();
        SecT409Field.addOne(this.f1376x, create64);
        return new SecT409FieldElement(create64);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecT409FieldElement) {
            return Nat448.eq64(this.f1376x, ((SecT409FieldElement) obj).f1376x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.hashCode(this.f1376x, 0, 7) ^ 4090087;
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement invert() {
        long[] create64 = Nat448.create64();
        SecT409Field.invert(this.f1376x, create64);
        return new SecT409FieldElement(create64);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isOne() {
        return Nat448.isOne64(this.f1376x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isZero() {
        return Nat448.isZero64(this.f1376x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        long[] create64 = Nat448.create64();
        SecT409Field.multiply(this.f1376x, ((SecT409FieldElement) eCFieldElement).f1376x, create64);
        return new SecT409FieldElement(create64);
    }
    ...
    public ECFieldElement multiplyPlusProduct(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement eCFieldElement3) {
        ...
        long[] jArr2 = ((SecT409FieldElement) eCFieldElement).f1376x;
        long[] jArr3 = ((SecT409FieldElement) eCFieldElement2).f1376x;
        long[] jArr4 = ((SecT409FieldElement) eCFieldElement3).f1376x;
    ...
    public ECFieldElement sqrt() {
        long[] create64 = Nat448.create64();
        SecT409Field.sqrt(this.f1376x, create64);
        return new SecT409FieldElement(create64);
    }
    ...
    public ECFieldElement square() {
        long[] create64 = Nat448.create64();
        SecT409Field.square(this.f1376x, create64);
        return new SecT409FieldElement(create64);
    }
    ...
    public ECFieldElement squarePow(int i) {
        ...
        long[] create64 = Nat448.create64();
        SecT409Field.squareN(this.f1376x, i, create64);
        return new SecT409FieldElement(create64);
    }
    ...
    public BigInteger toBigInteger() {
        return Nat448.toBigInteger64(this.f1376x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement.AbstractF2m
    public int trace() {
        return SecT409Field.trace(this.f1376x);
    }
}
