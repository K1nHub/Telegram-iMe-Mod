...
public class SecP224K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f1311x;
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f1312y;
        ...
        SecP224K1FieldElement secP224K1FieldElement5 = (SecP224K1FieldElement) this.f1313zs[0];
        ...
        if (isOne) {
            iArr = secP224K1FieldElement3.f1348x;
            iArr2 = secP224K1FieldElement4.f1348x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement5.f1348x, create2);
            SecP224K1Field.multiply(create2, secP224K1FieldElement3.f1348x, create);
            SecP224K1Field.multiply(create2, secP224K1FieldElement5.f1348x, create2);
            SecP224K1Field.multiply(create2, secP224K1FieldElement4.f1348x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP224K1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP224K1FieldElement.f1348x;
            iArr4 = secP224K1FieldElement2.f1348x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement6.f1348x, create3);
            SecP224K1Field.multiply(create3, secP224K1FieldElement.f1348x, createExt);
            SecP224K1Field.multiply(create3, secP224K1FieldElement6.f1348x, create3);
            SecP224K1Field.multiply(create3, secP224K1FieldElement2.f1348x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP224K1Field.square(create, secP224K1FieldElement7.f1348x);
        int[] iArr5 = secP224K1FieldElement7.f1348x;
        ...
        SecP224K1Field.subtract(create2, secP224K1FieldElement7.f1348x, secP224K1FieldElement8.f1348x);
        SecP224K1Field.multiplyAddToExt(secP224K1FieldElement8.f1348x, create, createExt);
        SecP224K1Field.reduce(createExt, secP224K1FieldElement8.f1348x);
        SecP224K1FieldElement secP224K1FieldElement9 = new SecP224K1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP224K1FieldElement9.f1348x;
            SecP224K1Field.multiply(iArr6, secP224K1FieldElement5.f1348x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP224K1FieldElement9.f1348x;
            SecP224K1Field.multiply(iArr7, secP224K1FieldElement6.f1348x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224K1Point(this.curve, this.f1311x, this.f1312y.negate(), this.f1313zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f1312y;
        if (secP224K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f1311x;
        SecP224K1FieldElement secP224K1FieldElement3 = (SecP224K1FieldElement) this.f1313zs[0];
        int[] create = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement.f1348x, create);
        int[] create2 = Nat224.create();
        SecP224K1Field.square(create, create2);
        int[] create3 = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement2.f1348x, create3);
        SecP224K1Field.reduce32(Nat224.addBothTo(create3, create3, create3), create3);
        SecP224K1Field.multiply(create, secP224K1FieldElement2.f1348x, create);
        ...
        SecP224K1Field.square(create3, secP224K1FieldElement4.f1348x);
        int[] iArr = secP224K1FieldElement4.f1348x;
        SecP224K1Field.subtract(iArr, create, iArr);
        int[] iArr2 = secP224K1FieldElement4.f1348x;
        SecP224K1Field.subtract(iArr2, create, iArr2);
        SecP224K1FieldElement secP224K1FieldElement5 = new SecP224K1FieldElement(create);
        SecP224K1Field.subtract(create, secP224K1FieldElement4.f1348x, secP224K1FieldElement5.f1348x);
        int[] iArr3 = secP224K1FieldElement5.f1348x;
        SecP224K1Field.multiply(iArr3, create3, iArr3);
        int[] iArr4 = secP224K1FieldElement5.f1348x;
        ...
        SecP224K1Field.twice(secP224K1FieldElement.f1348x, secP224K1FieldElement6.f1348x);
        if (!secP224K1FieldElement3.isOne()) {
            int[] iArr5 = secP224K1FieldElement6.f1348x;
            SecP224K1Field.multiply(iArr5, secP224K1FieldElement3.f1348x, iArr5);
        }
