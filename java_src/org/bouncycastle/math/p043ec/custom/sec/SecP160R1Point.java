...
public class SecP160R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f1305x;
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f1306y;
        ...
        SecP160R1FieldElement secP160R1FieldElement5 = (SecP160R1FieldElement) this.f1307zs[0];
        ...
        if (isOne) {
            iArr = secP160R1FieldElement3.f1326x;
            iArr2 = secP160R1FieldElement4.f1326x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement5.f1326x, create2);
            SecP160R1Field.multiply(create2, secP160R1FieldElement3.f1326x, create);
            SecP160R1Field.multiply(create2, secP160R1FieldElement5.f1326x, create2);
            SecP160R1Field.multiply(create2, secP160R1FieldElement4.f1326x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP160R1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP160R1FieldElement.f1326x;
            iArr4 = secP160R1FieldElement2.f1326x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement6.f1326x, create3);
            SecP160R1Field.multiply(create3, secP160R1FieldElement.f1326x, createExt);
            SecP160R1Field.multiply(create3, secP160R1FieldElement6.f1326x, create3);
            SecP160R1Field.multiply(create3, secP160R1FieldElement2.f1326x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP160R1Field.square(create, secP160R1FieldElement7.f1326x);
        int[] iArr5 = secP160R1FieldElement7.f1326x;
        ...
        SecP160R1Field.subtract(create2, secP160R1FieldElement7.f1326x, secP160R1FieldElement8.f1326x);
        SecP160R1Field.multiplyAddToExt(secP160R1FieldElement8.f1326x, create, createExt);
        SecP160R1Field.reduce(createExt, secP160R1FieldElement8.f1326x);
        SecP160R1FieldElement secP160R1FieldElement9 = new SecP160R1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP160R1FieldElement9.f1326x;
            SecP160R1Field.multiply(iArr6, secP160R1FieldElement5.f1326x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP160R1FieldElement9.f1326x;
            SecP160R1Field.multiply(iArr7, secP160R1FieldElement6.f1326x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R1Point(this.curve, this.f1305x, this.f1306y.negate(), this.f1307zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f1306y;
        if (secP160R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f1305x;
        SecP160R1FieldElement secP160R1FieldElement3 = (SecP160R1FieldElement) this.f1307zs[0];
        int[] create = Nat160.create();
        int[] create2 = Nat160.create();
        int[] create3 = Nat160.create();
        SecP160R1Field.square(secP160R1FieldElement.f1326x, create3);
        int[] create4 = Nat160.create();
        SecP160R1Field.square(create3, create4);
        boolean isOne = secP160R1FieldElement3.isOne();
        int[] iArr = secP160R1FieldElement3.f1326x;
        if (!isOne) {
            SecP160R1Field.square(iArr, create2);
            iArr = create2;
        }
        SecP160R1Field.subtract(secP160R1FieldElement2.f1326x, iArr, create);
        SecP160R1Field.add(secP160R1FieldElement2.f1326x, iArr, create2);
        ...
        SecP160R1Field.square(create2, secP160R1FieldElement4.f1326x);
        int[] iArr2 = secP160R1FieldElement4.f1326x;
        SecP160R1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP160R1FieldElement4.f1326x;
        ...
        SecP160R1Field.subtract(create3, secP160R1FieldElement4.f1326x, secP160R1FieldElement5.f1326x);
        int[] iArr4 = secP160R1FieldElement5.f1326x;
        SecP160R1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP160R1FieldElement5.f1326x;
        SecP160R1Field.subtract(iArr5, create, iArr5);
        SecP160R1FieldElement secP160R1FieldElement6 = new SecP160R1FieldElement(create2);
        SecP160R1Field.twice(secP160R1FieldElement.f1326x, secP160R1FieldElement6.f1326x);
        if (!isOne) {
            int[] iArr6 = secP160R1FieldElement6.f1326x;
            SecP160R1Field.multiply(iArr6, secP160R1FieldElement3.f1326x, iArr6);
        }
