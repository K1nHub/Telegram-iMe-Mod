...
public class SecP128R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f1320Q = SecP128R1Curve.f1318q;

    /* renamed from: x */
    protected int[] f1321x;

    public SecP128R1FieldElement() {
        this.f1321x = Nat128.create();
    }

    public SecP128R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1320Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP128R1FieldElement");
        }
        this.f1321x = SecP128R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP128R1Field.add(this.f1321x, ((SecP128R1FieldElement) eCFieldElement).f1321x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat128.create();
        SecP128R1Field.addOne(this.f1321x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        Mod.invert(SecP128R1Field.f1319P, ((SecP128R1FieldElement) eCFieldElement).f1321x, create);
        SecP128R1Field.multiply(create, this.f1321x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP128R1FieldElement) {
            return Nat128.m68eq(this.f1321x, ((SecP128R1FieldElement) obj).f1321x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1320Q.hashCode() ^ Arrays.hashCode(this.f1321x, 0, 4);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat128.create();
        Mod.invert(SecP128R1Field.f1319P, this.f1321x, create);
        return new SecP128R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isOne() {
        return Nat128.isOne(this.f1321x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isZero() {
        return Nat128.isZero(this.f1321x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.multiply(this.f1321x, ((SecP128R1FieldElement) eCFieldElement).f1321x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat128.create();
        SecP128R1Field.negate(this.f1321x, create);
        return new SecP128R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f1321x;
    ...
    public ECFieldElement square() {
        int[] create = Nat128.create();
        SecP128R1Field.square(this.f1321x, create);
        return new SecP128R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean testBitZero() {
        return Nat128.getBit(this.f1321x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat128.toBigInteger(this.f1321x);
    }
}
