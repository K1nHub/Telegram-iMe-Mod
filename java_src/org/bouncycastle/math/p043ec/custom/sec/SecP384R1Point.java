...
public class SecP384R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP384R1FieldElement secP384R1FieldElement = (SecP384R1FieldElement) this.f1311x;
        SecP384R1FieldElement secP384R1FieldElement2 = (SecP384R1FieldElement) this.f1312y;
        ...
        SecP384R1FieldElement secP384R1FieldElement5 = (SecP384R1FieldElement) this.f1313zs[0];
        ...
        if (isOne) {
            iArr = secP384R1FieldElement3.f1364x;
            iArr2 = secP384R1FieldElement4.f1364x;
        } else {
            SecP384R1Field.square(secP384R1FieldElement5.f1364x, create3);
            SecP384R1Field.multiply(create3, secP384R1FieldElement3.f1364x, create2);
            SecP384R1Field.multiply(create3, secP384R1FieldElement5.f1364x, create3);
            SecP384R1Field.multiply(create3, secP384R1FieldElement4.f1364x, create3);
            iArr = create2;
            iArr2 = create3;
        }
        boolean isOne2 = secP384R1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP384R1FieldElement.f1364x;
            iArr4 = secP384R1FieldElement2.f1364x;
        } else {
            SecP384R1Field.square(secP384R1FieldElement6.f1364x, create4);
            SecP384R1Field.multiply(create4, secP384R1FieldElement.f1364x, create);
            SecP384R1Field.multiply(create4, secP384R1FieldElement6.f1364x, create4);
            SecP384R1Field.multiply(create4, secP384R1FieldElement2.f1364x, create4);
            iArr3 = create;
            iArr4 = create4;
        }
        ...
        SecP384R1Field.square(create6, secP384R1FieldElement7.f1364x);
        int[] iArr5 = secP384R1FieldElement7.f1364x;
        ...
        SecP384R1Field.subtract(create3, secP384R1FieldElement7.f1364x, secP384R1FieldElement8.f1364x);
        Nat384.mul(secP384R1FieldElement8.f1364x, create6, create2);
        SecP384R1Field.addExt(create, create2, create);
        SecP384R1Field.reduce(create, secP384R1FieldElement8.f1364x);
        SecP384R1FieldElement secP384R1FieldElement9 = new SecP384R1FieldElement(create5);
        if (!isOne) {
            int[] iArr6 = secP384R1FieldElement9.f1364x;
            SecP384R1Field.multiply(iArr6, secP384R1FieldElement5.f1364x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP384R1FieldElement9.f1364x;
            SecP384R1Field.multiply(iArr7, secP384R1FieldElement6.f1364x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP384R1Point(this.curve, this.f1311x, this.f1312y.negate(), this.f1313zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP384R1FieldElement secP384R1FieldElement = (SecP384R1FieldElement) this.f1312y;
        if (secP384R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP384R1FieldElement secP384R1FieldElement2 = (SecP384R1FieldElement) this.f1311x;
        SecP384R1FieldElement secP384R1FieldElement3 = (SecP384R1FieldElement) this.f1313zs[0];
        int[] create = Nat.create(12);
        int[] create2 = Nat.create(12);
        int[] create3 = Nat.create(12);
        SecP384R1Field.square(secP384R1FieldElement.f1364x, create3);
        int[] create4 = Nat.create(12);
        SecP384R1Field.square(create3, create4);
        boolean isOne = secP384R1FieldElement3.isOne();
        int[] iArr = secP384R1FieldElement3.f1364x;
        if (!isOne) {
            SecP384R1Field.square(iArr, create2);
            iArr = create2;
        }
        SecP384R1Field.subtract(secP384R1FieldElement2.f1364x, iArr, create);
        SecP384R1Field.add(secP384R1FieldElement2.f1364x, iArr, create2);
        SecP384R1Field.multiply(create2, create, create2);
        SecP384R1Field.reduce32(Nat.addBothTo(12, create2, create2, create2), create2);
        SecP384R1Field.multiply(create3, secP384R1FieldElement2.f1364x, create3);
        ...
        SecP384R1Field.square(create2, secP384R1FieldElement4.f1364x);
        int[] iArr2 = secP384R1FieldElement4.f1364x;
        SecP384R1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP384R1FieldElement4.f1364x;
        ...
        SecP384R1Field.subtract(create3, secP384R1FieldElement4.f1364x, secP384R1FieldElement5.f1364x);
        int[] iArr4 = secP384R1FieldElement5.f1364x;
        SecP384R1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP384R1FieldElement5.f1364x;
        SecP384R1Field.subtract(iArr5, create, iArr5);
        SecP384R1FieldElement secP384R1FieldElement6 = new SecP384R1FieldElement(create2);
        SecP384R1Field.twice(secP384R1FieldElement.f1364x, secP384R1FieldElement6.f1364x);
        if (!isOne) {
            int[] iArr6 = secP384R1FieldElement6.f1364x;
            SecP384R1Field.multiply(iArr6, secP384R1FieldElement3.f1364x, iArr6);
        }
