...
public class SecT283FieldElement extends ECFieldElement.AbstractF2m {
    ...
    public SecT283FieldElement(BigInteger bigInteger) {
        ...
        this.f1375x = SecT283Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecT283Field.add(this.f1375x, ((SecT283FieldElement) eCFieldElement).f1375x, create64);
    ...
    public ECFieldElement addOne() {
        long[] create64 = Nat320.create64();
        SecT283Field.addOne(this.f1375x, create64);
        return new SecT283FieldElement(create64);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecT283FieldElement) {
            return Nat320.eq64(this.f1375x, ((SecT283FieldElement) obj).f1375x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.hashCode(this.f1375x, 0, 5) ^ 2831275;
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement invert() {
        long[] create64 = Nat320.create64();
        SecT283Field.invert(this.f1375x, create64);
        return new SecT283FieldElement(create64);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isOne() {
        return Nat320.isOne64(this.f1375x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isZero() {
        return Nat320.isZero64(this.f1375x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        long[] create64 = Nat320.create64();
        SecT283Field.multiply(this.f1375x, ((SecT283FieldElement) eCFieldElement).f1375x, create64);
        return new SecT283FieldElement(create64);
    }
    ...
    public ECFieldElement multiplyPlusProduct(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement eCFieldElement3) {
        ...
        long[] jArr2 = ((SecT283FieldElement) eCFieldElement).f1375x;
        long[] jArr3 = ((SecT283FieldElement) eCFieldElement2).f1375x;
        long[] jArr4 = ((SecT283FieldElement) eCFieldElement3).f1375x;
    ...
    public ECFieldElement sqrt() {
        long[] create64 = Nat320.create64();
        SecT283Field.sqrt(this.f1375x, create64);
        return new SecT283FieldElement(create64);
    }
    ...
    public ECFieldElement square() {
        long[] create64 = Nat320.create64();
        SecT283Field.square(this.f1375x, create64);
        return new SecT283FieldElement(create64);
    }
    ...
    public ECFieldElement squarePow(int i) {
        ...
        long[] create64 = Nat320.create64();
        SecT283Field.squareN(this.f1375x, i, create64);
        return new SecT283FieldElement(create64);
    }
    ...
    public BigInteger toBigInteger() {
        return Nat320.toBigInteger64(this.f1375x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement.AbstractF2m
    public int trace() {
        return SecT283Field.trace(this.f1375x);
    }
}
