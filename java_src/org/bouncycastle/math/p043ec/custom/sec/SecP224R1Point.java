...
public class SecP224R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f1311x;
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f1312y;
        ...
        SecP224R1FieldElement secP224R1FieldElement5 = (SecP224R1FieldElement) this.f1313zs[0];
        ...
        if (isOne) {
            iArr = secP224R1FieldElement3.f1352x;
            iArr2 = secP224R1FieldElement4.f1352x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement5.f1352x, create2);
            SecP224R1Field.multiply(create2, secP224R1FieldElement3.f1352x, create);
            SecP224R1Field.multiply(create2, secP224R1FieldElement5.f1352x, create2);
            SecP224R1Field.multiply(create2, secP224R1FieldElement4.f1352x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP224R1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP224R1FieldElement.f1352x;
            iArr4 = secP224R1FieldElement2.f1352x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement6.f1352x, create3);
            SecP224R1Field.multiply(create3, secP224R1FieldElement.f1352x, createExt);
            SecP224R1Field.multiply(create3, secP224R1FieldElement6.f1352x, create3);
            SecP224R1Field.multiply(create3, secP224R1FieldElement2.f1352x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP224R1Field.square(create, secP224R1FieldElement7.f1352x);
        int[] iArr5 = secP224R1FieldElement7.f1352x;
        ...
        SecP224R1Field.subtract(create2, secP224R1FieldElement7.f1352x, secP224R1FieldElement8.f1352x);
        SecP224R1Field.multiplyAddToExt(secP224R1FieldElement8.f1352x, create, createExt);
        SecP224R1Field.reduce(createExt, secP224R1FieldElement8.f1352x);
        SecP224R1FieldElement secP224R1FieldElement9 = new SecP224R1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP224R1FieldElement9.f1352x;
            SecP224R1Field.multiply(iArr6, secP224R1FieldElement5.f1352x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP224R1FieldElement9.f1352x;
            SecP224R1Field.multiply(iArr7, secP224R1FieldElement6.f1352x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224R1Point(this.curve, this.f1311x, this.f1312y.negate(), this.f1313zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f1312y;
        if (secP224R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f1311x;
        SecP224R1FieldElement secP224R1FieldElement3 = (SecP224R1FieldElement) this.f1313zs[0];
        int[] create = Nat224.create();
        int[] create2 = Nat224.create();
        int[] create3 = Nat224.create();
        SecP224R1Field.square(secP224R1FieldElement.f1352x, create3);
        int[] create4 = Nat224.create();
        SecP224R1Field.square(create3, create4);
        boolean isOne = secP224R1FieldElement3.isOne();
        int[] iArr = secP224R1FieldElement3.f1352x;
        if (!isOne) {
            SecP224R1Field.square(iArr, create2);
            iArr = create2;
        }
        SecP224R1Field.subtract(secP224R1FieldElement2.f1352x, iArr, create);
        SecP224R1Field.add(secP224R1FieldElement2.f1352x, iArr, create2);
        ...
        SecP224R1Field.square(create2, secP224R1FieldElement4.f1352x);
        int[] iArr2 = secP224R1FieldElement4.f1352x;
        SecP224R1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP224R1FieldElement4.f1352x;
        ...
        SecP224R1Field.subtract(create3, secP224R1FieldElement4.f1352x, secP224R1FieldElement5.f1352x);
        int[] iArr4 = secP224R1FieldElement5.f1352x;
        SecP224R1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP224R1FieldElement5.f1352x;
        SecP224R1Field.subtract(iArr5, create, iArr5);
        SecP224R1FieldElement secP224R1FieldElement6 = new SecP224R1FieldElement(create2);
        SecP224R1Field.twice(secP224R1FieldElement.f1352x, secP224R1FieldElement6.f1352x);
        if (!isOne) {
            int[] iArr6 = secP224R1FieldElement6.f1352x;
            SecP224R1Field.multiply(iArr6, secP224R1FieldElement3.f1352x, iArr6);
        }
