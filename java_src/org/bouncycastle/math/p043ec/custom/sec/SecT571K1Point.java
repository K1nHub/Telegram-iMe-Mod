...
public class SecT571K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f1311x;
        ...
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) this.f1312y;
        SecT571FieldElement secT571FieldElement7 = (SecT571FieldElement) this.f1313zs[0];
        ...
        long[] precompMultiplicand = secT571FieldElement7.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement7.f1377x);
        if (precompMultiplicand == null) {
            jArr = secT571FieldElement5.f1377x;
            jArr2 = secT571FieldElement8.f1377x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement5.f1377x, precompMultiplicand, create642);
            SecT571Field.multiplyPrecomp(secT571FieldElement8.f1377x, precompMultiplicand, create644);
            jArr = create642;
            jArr2 = create644;
        }
        long[] precompMultiplicand2 = secT571FieldElement9.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement9.f1377x);
        long[] jArr4 = secT571FieldElement4.f1377x;
        if (precompMultiplicand2 == null) {
            jArr3 = secT571FieldElement6.f1377x;
        } else {
            SecT571Field.multiplyPrecomp(jArr4, precompMultiplicand2, create64);
            SecT571Field.multiplyPrecomp(secT571FieldElement6.f1377x, precompMultiplicand2, create643);
            jArr4 = create64;
            jArr3 = create643;
        }
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            SecT571Field.multiply(create64, create642, secT571FieldElement11.f1377x);
            ...
            SecT571Field.multiplyPrecomp(create644, precompMultiplicand3, secT571FieldElement12.f1377x);
            if (precompMultiplicand2 != null) {
                long[] jArr5 = secT571FieldElement12.f1377x;
            ...
            SecT571Field.add(secT571FieldElement6.f1377x, secT571FieldElement7.f1377x, create644);
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement12.f1377x, createExt64);
            SecT571FieldElement secT571FieldElement13 = new SecT571FieldElement(create644);
            SecT571Field.reduce(createExt64, secT571FieldElement13.f1377x);
            if (precompMultiplicand != null) {
                long[] jArr6 = secT571FieldElement12.f1377x;
