...
public class SecP192R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f1305x;
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f1306y;
        ...
        SecP192R1FieldElement secP192R1FieldElement5 = (SecP192R1FieldElement) this.f1307zs[0];
        ...
        if (isOne) {
            iArr = secP192R1FieldElement3.f1338x;
            iArr2 = secP192R1FieldElement4.f1338x;
        } else {
            SecP192R1Field.square(secP192R1FieldElement5.f1338x, create2);
            SecP192R1Field.multiply(create2, secP192R1FieldElement3.f1338x, create);
            SecP192R1Field.multiply(create2, secP192R1FieldElement5.f1338x, create2);
            SecP192R1Field.multiply(create2, secP192R1FieldElement4.f1338x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP192R1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP192R1FieldElement.f1338x;
            iArr4 = secP192R1FieldElement2.f1338x;
        } else {
            SecP192R1Field.square(secP192R1FieldElement6.f1338x, create3);
            SecP192R1Field.multiply(create3, secP192R1FieldElement.f1338x, createExt);
            SecP192R1Field.multiply(create3, secP192R1FieldElement6.f1338x, create3);
            SecP192R1Field.multiply(create3, secP192R1FieldElement2.f1338x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP192R1Field.square(create, secP192R1FieldElement7.f1338x);
        int[] iArr5 = secP192R1FieldElement7.f1338x;
        ...
        SecP192R1Field.subtract(create2, secP192R1FieldElement7.f1338x, secP192R1FieldElement8.f1338x);
        SecP192R1Field.multiplyAddToExt(secP192R1FieldElement8.f1338x, create, createExt);
        SecP192R1Field.reduce(createExt, secP192R1FieldElement8.f1338x);
        SecP192R1FieldElement secP192R1FieldElement9 = new SecP192R1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP192R1FieldElement9.f1338x;
            SecP192R1Field.multiply(iArr6, secP192R1FieldElement5.f1338x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP192R1FieldElement9.f1338x;
            SecP192R1Field.multiply(iArr7, secP192R1FieldElement6.f1338x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192R1Point(this.curve, this.f1305x, this.f1306y.negate(), this.f1307zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f1306y;
        if (secP192R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f1305x;
        SecP192R1FieldElement secP192R1FieldElement3 = (SecP192R1FieldElement) this.f1307zs[0];
        int[] create = Nat192.create();
        int[] create2 = Nat192.create();
        int[] create3 = Nat192.create();
        SecP192R1Field.square(secP192R1FieldElement.f1338x, create3);
        int[] create4 = Nat192.create();
        SecP192R1Field.square(create3, create4);
        boolean isOne = secP192R1FieldElement3.isOne();
        int[] iArr = secP192R1FieldElement3.f1338x;
        if (!isOne) {
            SecP192R1Field.square(iArr, create2);
            iArr = create2;
        }
        SecP192R1Field.subtract(secP192R1FieldElement2.f1338x, iArr, create);
        SecP192R1Field.add(secP192R1FieldElement2.f1338x, iArr, create2);
        ...
        SecP192R1Field.square(create2, secP192R1FieldElement4.f1338x);
        int[] iArr2 = secP192R1FieldElement4.f1338x;
        SecP192R1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP192R1FieldElement4.f1338x;
        ...
        SecP192R1Field.subtract(create3, secP192R1FieldElement4.f1338x, secP192R1FieldElement5.f1338x);
        int[] iArr4 = secP192R1FieldElement5.f1338x;
        SecP192R1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP192R1FieldElement5.f1338x;
        SecP192R1Field.subtract(iArr5, create, iArr5);
        SecP192R1FieldElement secP192R1FieldElement6 = new SecP192R1FieldElement(create2);
        SecP192R1Field.twice(secP192R1FieldElement.f1338x, secP192R1FieldElement6.f1338x);
        if (!isOne) {
            int[] iArr6 = secP192R1FieldElement6.f1338x;
            SecP192R1Field.multiply(iArr6, secP192R1FieldElement3.f1338x, iArr6);
        }
