...
public class SecP192K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f1305x;
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f1306y;
        ...
        SecP192K1FieldElement secP192K1FieldElement5 = (SecP192K1FieldElement) this.f1307zs[0];
        ...
        if (isOne) {
            iArr = secP192K1FieldElement3.f1334x;
            iArr2 = secP192K1FieldElement4.f1334x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement5.f1334x, create2);
            SecP192K1Field.multiply(create2, secP192K1FieldElement3.f1334x, create);
            SecP192K1Field.multiply(create2, secP192K1FieldElement5.f1334x, create2);
            SecP192K1Field.multiply(create2, secP192K1FieldElement4.f1334x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP192K1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP192K1FieldElement.f1334x;
            iArr4 = secP192K1FieldElement2.f1334x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement6.f1334x, create3);
            SecP192K1Field.multiply(create3, secP192K1FieldElement.f1334x, createExt);
            SecP192K1Field.multiply(create3, secP192K1FieldElement6.f1334x, create3);
            SecP192K1Field.multiply(create3, secP192K1FieldElement2.f1334x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP192K1Field.square(create, secP192K1FieldElement7.f1334x);
        int[] iArr5 = secP192K1FieldElement7.f1334x;
        ...
        SecP192K1Field.subtract(create2, secP192K1FieldElement7.f1334x, secP192K1FieldElement8.f1334x);
        SecP192K1Field.multiplyAddToExt(secP192K1FieldElement8.f1334x, create, createExt);
        SecP192K1Field.reduce(createExt, secP192K1FieldElement8.f1334x);
        SecP192K1FieldElement secP192K1FieldElement9 = new SecP192K1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP192K1FieldElement9.f1334x;
            SecP192K1Field.multiply(iArr6, secP192K1FieldElement5.f1334x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP192K1FieldElement9.f1334x;
            SecP192K1Field.multiply(iArr7, secP192K1FieldElement6.f1334x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192K1Point(this.curve, this.f1305x, this.f1306y.negate(), this.f1307zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f1306y;
        if (secP192K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f1305x;
        SecP192K1FieldElement secP192K1FieldElement3 = (SecP192K1FieldElement) this.f1307zs[0];
        int[] create = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement.f1334x, create);
        int[] create2 = Nat192.create();
        SecP192K1Field.square(create, create2);
        int[] create3 = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement2.f1334x, create3);
        SecP192K1Field.reduce32(Nat192.addBothTo(create3, create3, create3), create3);
        SecP192K1Field.multiply(create, secP192K1FieldElement2.f1334x, create);
        ...
        SecP192K1Field.square(create3, secP192K1FieldElement4.f1334x);
        int[] iArr = secP192K1FieldElement4.f1334x;
        SecP192K1Field.subtract(iArr, create, iArr);
        int[] iArr2 = secP192K1FieldElement4.f1334x;
        SecP192K1Field.subtract(iArr2, create, iArr2);
        SecP192K1FieldElement secP192K1FieldElement5 = new SecP192K1FieldElement(create);
        SecP192K1Field.subtract(create, secP192K1FieldElement4.f1334x, secP192K1FieldElement5.f1334x);
        int[] iArr3 = secP192K1FieldElement5.f1334x;
        SecP192K1Field.multiply(iArr3, create3, iArr3);
        int[] iArr4 = secP192K1FieldElement5.f1334x;
        ...
        SecP192K1Field.twice(secP192K1FieldElement.f1334x, secP192K1FieldElement6.f1334x);
        if (!secP192K1FieldElement3.isOne()) {
            int[] iArr5 = secP192K1FieldElement6.f1334x;
            SecP192K1Field.multiply(iArr5, secP192K1FieldElement3.f1334x, iArr5);
        }
