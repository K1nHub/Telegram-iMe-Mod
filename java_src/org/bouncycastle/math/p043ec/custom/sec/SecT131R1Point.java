...
public class SecT131R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT131R1Point(curve, eCFieldElement4, curve.getB().sqrt(), this.withCompression);
            }
            ...
            if (multiply3.isZero()) {
                return new SecT131R1Point(curve, multiply3, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT131R1Point(curve, eCFieldElement4, eCFieldElement5, new ECFieldElement[]{eCFieldElement6}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        if (add.isZero()) {
            return new SecT131R1Point(curve, add, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT131R1Point(curve, square2, eCFieldElement.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (square4.isZero()) {
            ...
            return new SecT131R1Point(curve, multiplyPlusProduct, curve.getB().sqrt(), this.withCompression);
        } else {
            ECFieldElement multiply2 = multiplyPlusProduct.square().multiply(multiply);
            ECFieldElement multiply3 = multiplyPlusProduct.multiply(square4).multiply(square3);
            return new SecT131R1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
        }
    }
}
