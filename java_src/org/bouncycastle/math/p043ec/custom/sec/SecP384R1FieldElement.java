...
public class SecP384R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f1357Q = SecP384R1Curve.f1355q;

    /* renamed from: x */
    protected int[] f1358x;

    public SecP384R1FieldElement() {
        this.f1358x = Nat.create(12);
    }

    public SecP384R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f1357Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP384R1FieldElement");
        }
        this.f1358x = SecP384R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP384R1Field.add(this.f1358x, ((SecP384R1FieldElement) eCFieldElement).f1358x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat.create(12);
        SecP384R1Field.addOne(this.f1358x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        Mod.invert(SecP384R1Field.f1356P, ((SecP384R1FieldElement) eCFieldElement).f1358x, create);
        SecP384R1Field.multiply(create, this.f1358x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP384R1FieldElement) {
            return Nat.m69eq(12, this.f1358x, ((SecP384R1FieldElement) obj).f1358x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return f1357Q.hashCode() ^ Arrays.hashCode(this.f1358x, 0, 12);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat.create(12);
        Mod.invert(SecP384R1Field.f1356P, this.f1358x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isOne() {
        return Nat.isOne(12, this.f1358x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean isZero() {
        return Nat.isZero(12, this.f1358x);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.multiply(this.f1358x, ((SecP384R1FieldElement) eCFieldElement).f1358x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat.create(12);
        SecP384R1Field.negate(this.f1358x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f1358x;
    ...
    public ECFieldElement square() {
        int[] create = Nat.create(12);
        SecP384R1Field.square(this.f1358x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public boolean testBitZero() {
        return Nat.getBit(this.f1358x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p043ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat.toBigInteger(12, this.f1358x);
    }
}
