...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecT571FieldElement secT571FieldElement = (SecT571FieldElement) this.f1311x;
        if (secT571FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecT571FieldElement secT571FieldElement2 = (SecT571FieldElement) this.f1312y;
        SecT571FieldElement secT571FieldElement3 = (SecT571FieldElement) this.f1313zs[0];
        long[] create64 = Nat576.create64();
        long[] create642 = Nat576.create64();
        long[] precompMultiplicand = secT571FieldElement3.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement3.f1377x);
        long[] jArr2 = secT571FieldElement2.f1377x;
        if (precompMultiplicand == null) {
            jArr = secT571FieldElement3.f1377x;
        } else {
            SecT571Field.multiplyPrecomp(jArr2, precompMultiplicand, create64);
            SecT571Field.square(secT571FieldElement3.f1377x, create642);
            jArr2 = create64;
            jArr = create642;
        }
        long[] create643 = Nat576.create64();
        SecT571Field.square(secT571FieldElement2.f1377x, create643);
        ...
        SecT571Field.square(create643, secT571FieldElement4.f1377x);
        SecT571FieldElement secT571FieldElement5 = new SecT571FieldElement(create643);
        if (precompMultiplicand != null) {
            long[] jArr3 = secT571FieldElement5.f1377x;
            SecT571Field.multiply(jArr3, jArr, jArr3);
        }
        long[] jArr4 = secT571FieldElement.f1377x;
        if (precompMultiplicand != null) {
        ...
        SecT571Field.addBothTo(secT571FieldElement4.f1377x, secT571FieldElement5.f1377x, create642);
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f1312y;
        SecT571FieldElement secT571FieldElement5 = (SecT571FieldElement) this.f1313zs[0];
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) eCPoint.getRawYCoord();
        long[] create64 = Nat576.create64();
        long[] create642 = Nat576.create64();
        long[] create643 = Nat576.create64();
        long[] create644 = Nat576.create64();
        SecT571Field.square(secT571FieldElement.f1377x, create64);
        SecT571Field.square(secT571FieldElement4.f1377x, create642);
        SecT571Field.square(secT571FieldElement5.f1377x, create643);
        SecT571Field.multiply(secT571FieldElement4.f1377x, secT571FieldElement5.f1377x, create644);
        SecT571Field.addBothTo(create643, create642, create644);
        long[] precompMultiplicand = SecT571Field.precompMultiplicand(create643);
        SecT571Field.multiplyPrecomp(secT571FieldElement6.f1377x, precompMultiplicand, create643);
        ...
        SecT571Field.multiplyPrecomp(secT571FieldElement2.f1377x, precompMultiplicand, create64);
        ...
        if (Nat576.isZero64(create642)) {
            ...
            SecT571Field.square(create643, secT571FieldElement7.f1377x);
            long[] jArr = secT571FieldElement7.f1377x;
            SecT571Field.multiply(jArr, create64, jArr);
            SecT571FieldElement secT571FieldElement8 = new SecT571FieldElement(create64);
            SecT571Field.multiply(create643, create642, secT571FieldElement8.f1377x);
            long[] jArr2 = secT571FieldElement8.f1377x;
            ...
            SecT571Field.add(create643, create642, secT571FieldElement9.f1377x);
            long[] jArr3 = secT571FieldElement9.f1377x;
            SecT571Field.square(jArr3, jArr3);
            Nat.zero64(18, createExt64);
            SecT571Field.multiplyAddToExt(secT571FieldElement9.f1377x, create644, createExt64);
            SecT571Field.addOne(secT571FieldElement6.f1377x, create644);
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement8.f1377x, createExt64);
            SecT571Field.reduce(createExt64, secT571FieldElement9.f1377x);
