...
public class Curve25519FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f1312Q = Curve25519.f1310q;
    ...
    public Curve25519FieldElement(BigInteger bigInteger) {
        ...
        this.f1313x = Curve25519Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        Curve25519Field.add(this.f1313x, ((Curve25519FieldElement) eCFieldElement).f1313x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        Curve25519Field.addOne(this.f1313x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Mod.invert(Curve25519Field.f1311P, ((Curve25519FieldElement) eCFieldElement).f1313x, create);
        Curve25519Field.multiply(create, this.f1313x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Curve25519FieldElement) {
            return Nat256.m64eq(this.f1313x, ((Curve25519FieldElement) obj).f1313x);
        }
        return false;
    }
    ...
    public ECFieldElement invert() {
        int[] create = Nat256.create();
        Mod.invert(Curve25519Field.f1311P, this.f1313x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.multiply(this.f1313x, ((Curve25519FieldElement) eCFieldElement).f1313x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat256.create();
        Curve25519Field.negate(this.f1313x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        Curve25519Field.square(this.f1313x, create);
        return new Curve25519FieldElement(create);
    }
