...
public class Curve25519Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        Curve25519FieldElement curve25519FieldElement = (Curve25519FieldElement) this.f1305x;
        Curve25519FieldElement curve25519FieldElement2 = (Curve25519FieldElement) this.f1306y;
        Curve25519FieldElement curve25519FieldElement3 = (Curve25519FieldElement) this.f1307zs[0];
        ...
        if (isOne) {
            iArr = curve25519FieldElement4.f1313x;
            iArr2 = curve25519FieldElement5.f1313x;
        } else {
            Curve25519Field.square(curve25519FieldElement3.f1313x, create2);
            Curve25519Field.multiply(create2, curve25519FieldElement4.f1313x, create);
            Curve25519Field.multiply(create2, curve25519FieldElement3.f1313x, create2);
            Curve25519Field.multiply(create2, curve25519FieldElement5.f1313x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = curve25519FieldElement6.isOne();
        if (isOne2) {
            iArr3 = curve25519FieldElement.f1313x;
            iArr4 = curve25519FieldElement2.f1313x;
        } else {
            Curve25519Field.square(curve25519FieldElement6.f1313x, create3);
            Curve25519Field.multiply(create3, curve25519FieldElement.f1313x, createExt);
            Curve25519Field.multiply(create3, curve25519FieldElement6.f1313x, create3);
            Curve25519Field.multiply(create3, curve25519FieldElement2.f1313x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        Curve25519Field.square(create, curve25519FieldElement7.f1313x);
        int[] iArr5 = curve25519FieldElement7.f1313x;
        ...
        Curve25519Field.subtract(create2, curve25519FieldElement7.f1313x, curve25519FieldElement8.f1313x);
        Curve25519Field.multiplyAddToExt(curve25519FieldElement8.f1313x, create, createExt);
        Curve25519Field.reduce(createExt, curve25519FieldElement8.f1313x);
        Curve25519FieldElement curve25519FieldElement9 = new Curve25519FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = curve25519FieldElement9.f1313x;
            Curve25519Field.multiply(iArr6, curve25519FieldElement3.f1313x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = curve25519FieldElement9.f1313x;
            Curve25519Field.multiply(iArr7, curve25519FieldElement6.f1313x, iArr7);
        }
    ...
    protected Curve25519FieldElement calculateJacobianModifiedW(Curve25519FieldElement curve25519FieldElement, int[] iArr) {
        ...
        if (iArr == null) {
            iArr = curve25519FieldElement3.f1313x;
            Curve25519Field.square(curve25519FieldElement.f1313x, iArr);
        }
        Curve25519Field.square(iArr, curve25519FieldElement3.f1313x);
        int[] iArr2 = curve25519FieldElement3.f1313x;
        Curve25519Field.multiply(iArr2, curve25519FieldElement2.f1313x, iArr2);
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new Curve25519Point(getCurve(), this.f1305x, this.f1306y.negate(), this.f1307zs, this.withCompression);
    }

    @Override // org.bouncycastle.math.p043ec.ECPoint
    public ECPoint threeTimes() {
        return (isInfinity() || this.f1306y.isZero()) ? this : twiceJacobianModified(false).add(this);
    }
    ...
    public ECPoint twice() {
        ...
        return this.f1306y.isZero() ? getCurve().getInfinity() : twiceJacobianModified(true);
    }
    ...
    protected Curve25519Point twiceJacobianModified(boolean z) {
        ...
        int[] create = Nat256.create();
        Curve25519Field.square(curve25519FieldElement.f1313x, create);
        Curve25519Field.reduce27(Nat256.addBothTo(create, create, create) + Nat256.addTo(jacobianModifiedW.f1313x, create), create);
        int[] create2 = Nat256.create();
        Curve25519Field.twice(curve25519FieldElement2.f1313x, create2);
        int[] create3 = Nat256.create();
        Curve25519Field.multiply(create2, curve25519FieldElement2.f1313x, create3);
        int[] create4 = Nat256.create();
        Curve25519Field.multiply(create3, curve25519FieldElement.f1313x, create4);
        ...
        Curve25519Field.square(create, curve25519FieldElement4.f1313x);
        int[] iArr = curve25519FieldElement4.f1313x;
        Curve25519Field.subtract(iArr, create4, iArr);
        int[] iArr2 = curve25519FieldElement4.f1313x;
        ...
        Curve25519Field.subtract(create4, curve25519FieldElement4.f1313x, curve25519FieldElement5.f1313x);
        int[] iArr3 = curve25519FieldElement5.f1313x;
        Curve25519Field.multiply(iArr3, create, iArr3);
        int[] iArr4 = curve25519FieldElement5.f1313x;
        ...
        if (!Nat256.isOne(curve25519FieldElement3.f1313x)) {
            int[] iArr5 = curve25519FieldElement6.f1313x;
            Curve25519Field.multiply(iArr5, curve25519FieldElement3.f1313x, iArr5);
        }
        Curve25519FieldElement curve25519FieldElement7 = null;
        if (z) {
            curve25519FieldElement7 = new Curve25519FieldElement(create5);
            int[] iArr6 = curve25519FieldElement7.f1313x;
            Curve25519Field.multiply(iArr6, jacobianModifiedW.f1313x, iArr6);
            int[] iArr7 = curve25519FieldElement7.f1313x;
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        return this == eCPoint ? threeTimes() : isInfinity() ? eCPoint : eCPoint.isInfinity() ? twice() : this.f1306y.isZero() ? eCPoint : twiceJacobianModified(false).add(eCPoint);
    }
}
