...
public abstract class Nat160 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 5; i < i3; i3 = 5) {
            ...
            int i5 = i + 1;
            long j14 = j2;
            long j15 = (j13 >>> 32) + (j12 * j2) + (iArr3[i5] & 4294967295L);
            iArr3[i5] = (int) j15;
            int i6 = i + 2;
            long j16 = j5;
            long j17 = (j15 >>> 32) + (j12 * j3) + (iArr3[i6] & 4294967295L);
            iArr3[i6] = (int) j17;
            int i7 = i + 3;
            long j18 = (j17 >>> 32) + (j12 * j4) + (iArr3[i7] & 4294967295L);
            iArr3[i7] = (int) j18;
            int i8 = i + 4;
            long j19 = (j18 >>> 32) + (j12 * j16) + (iArr3[i8] & 4294967295L);
            iArr3[i8] = (int) j19;
