...
public abstract class Nat256 {
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i6 < 8) {
            i5 += i4;
            long j19 = iArr[i + i6] & 4294967295L;
            int i7 = i5 + 0;
            long j20 = (j19 * j) + (iArr3[i7] & 4294967295L) + 0;
            iArr3[i7] = (int) j20;
            int i8 = i5 + 1;
            long j21 = j17;
            long j22 = (j20 >>> 32) + (j19 * j2) + (iArr3[i8] & 4294967295L);
            iArr3[i8] = (int) j22;
            int i9 = i5 + 2;
            long j23 = j3;
            ...
            iArr3[i10] = (int) j25;
            int i11 = i5 + 4;
            long j26 = (j25 >>> 32) + (j19 * j5) + (iArr3[i11] & 4294967295L);
            iArr3[i11] = (int) j26;
            int i12 = i5 + 5;
            long j27 = (j26 >>> 32) + (j19 * j6) + (iArr3[i12] & 4294967295L);
            iArr3[i12] = (int) j27;
            int i13 = i5 + 6;
            long j28 = (j27 >>> 32) + (j19 * j7) + (iArr3[i13] & 4294967295L);
            iArr3[i13] = (int) j28;
            int i14 = i5 + 7;
            long j29 = (j28 >>> 32) + (j19 * j21) + (iArr3[i14] & 4294967295L);
            iArr3[i14] = (int) j29;
