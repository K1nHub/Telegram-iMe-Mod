...
public class InflaterInputStream extends PartInputStream {
    ...
    @Override // net.lingala.zip4j.p035io.PartInputStream, net.lingala.zip4j.p035io.BaseInputStream, java.io.InputStream
    ...
    @Override // net.lingala.zip4j.p035io.PartInputStream, java.io.InputStream
    ...
    @Override // net.lingala.zip4j.p035io.PartInputStream, java.io.InputStream, java.io.Closeable, java.lang.AutoCloseable
    public void close() throws IOException {
        this.inflater.end();
        super.close();
    }

    @Override // net.lingala.zip4j.p035io.PartInputStream, net.lingala.zip4j.p035io.BaseInputStream
