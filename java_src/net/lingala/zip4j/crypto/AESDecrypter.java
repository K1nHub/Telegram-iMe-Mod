    ...
    public int decryptData(byte[] bArr, int i, int i2) throws ZipException {
        ...
        while (true) {
            ...
            try {
                ...
                Raw.prepareBuffAESIVBytes(this.f1223iv, this.nonce, 16);
                this.aesEngine.processBlock(this.f1223iv, this.counterBlock);
