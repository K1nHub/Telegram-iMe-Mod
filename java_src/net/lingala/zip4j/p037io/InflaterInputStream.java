...
public class InflaterInputStream extends PartInputStream {
    ...
    @Override // net.lingala.zip4j.p037io.PartInputStream, net.lingala.zip4j.p037io.BaseInputStream, java.io.InputStream
    ...
    @Override // net.lingala.zip4j.p037io.PartInputStream, java.io.InputStream
    ...
    @Override // net.lingala.zip4j.p037io.PartInputStream, java.io.InputStream, java.io.Closeable, java.lang.AutoCloseable
    public void close() throws IOException {
        this.inflater.end();
        super.close();
    }

    @Override // net.lingala.zip4j.p037io.PartInputStream, net.lingala.zip4j.p037io.BaseInputStream
