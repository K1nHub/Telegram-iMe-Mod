...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    /* renamed from: of */
    public static final Headers m123of(String... strArr) {
        return Companion.m122of(strArr);
    }
    ...
    public Iterator<Pair<? extends String, ? extends String>> iterator() {
        ...
        for (int i = 0; i < size; i++) {
            pairArr[i] = TuplesKt.m149to(name(i), value(i));
        }
    ...
    public static final class Companion {
        ...
        */
        ...
        /* renamed from: of */
        public final Headers m122of(String... namesAndValues) {
            IntRange indices;
            IntProgression step;
            CharSequence trim;
