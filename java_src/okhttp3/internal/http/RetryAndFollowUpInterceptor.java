...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private final Request buildRedirectRequest(Response response, String str) {
        ...
        HttpUrl resolve;
        if (!this.client.followRedirects() || (header$default = Response.header$default(response, RtspHeaders.LOCATION, null, 2, null)) == null || (resolve = response.request().url().resolve(header$default)) == null) {
            return null;
        }
