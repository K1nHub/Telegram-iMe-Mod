    ...
    public static final class Companion {
        ...
        public final boolean isCacheable(Response response, Request request) {
            ...
            if (code != 200 && code != 410 && code != 414 && code != 501 && code != 203 && code != 204) {
                ...
                if (Response.header$default(response, RtspHeaders.EXPIRES, null, 2, null) == null && response.cacheControl().maxAgeSeconds() == -1 && !response.cacheControl().isPublic() && !response.cacheControl().isPrivate()) {
                    return false;
                }
            }
