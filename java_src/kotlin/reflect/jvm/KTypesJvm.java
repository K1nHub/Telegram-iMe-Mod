    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo2053getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo2053getDeclarationDescriptor();
                classDescriptor = mo2053getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo2053getDeclarationDescriptor : null;
