...
public final class ReflectJvmMapping {
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        Object mo2046getMember = (asKCallableImpl == null || (caller = asKCallableImpl.getCaller()) == null) ? null : caller.mo2046getMember();
        if (mo2046getMember instanceof Method) {
            return (Method) mo2046getMember;
        }
        return null;
    }
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        KCallableImpl<?> asKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Object mo2046getMember = (asKCallableImpl == null || (caller = asKCallableImpl.getCaller()) == null) ? null : caller.mo2046getMember();
        if (mo2046getMember instanceof Constructor) {
            return (Constructor) mo2046getMember;
        }
        return null;
    }
