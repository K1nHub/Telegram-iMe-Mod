        ...
        public Data() {
            ...
            ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    boolean z;
                    Collection<KotlinType> mo2055getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo2055getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(mo2055getSupertypes, "descriptor.typeConstructor.supertypes");
                    ArrayList<KTypeImpl> arrayList = new ArrayList(mo2055getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = r2;
                    for (final KotlinType kotlinType : mo2055getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                int indexOf;
                                ClassifierDescriptor mo2054getDeclarationDescriptor = KotlinType.this.getConstructor().mo2054getDeclarationDescriptor();
                                if (!(mo2054getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + mo2054getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) mo2054getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo2054getDeclarationDescriptor);
                                    ...
                                    if (indexOf < 0) {
                                        throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo2054getDeclarationDescriptor);
                                    }
