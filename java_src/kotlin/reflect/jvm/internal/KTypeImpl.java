...
public final class KTypeImpl implements KTypeBase {
    ...
    public final KClassifier convert(KotlinType kotlinType) {
        ...
        if (mo2054getDeclarationDescriptor instanceof ClassDescriptor) {
            ...
            return new KTypeParameterImpl(null, (TypeParameterDescriptor) mo2054getDeclarationDescriptor);
        } else {
            if (mo2054getDeclarationDescriptor instanceof TypeAliasDescriptor) {
