...
public final class DescriptorUtilKt {
    public static final ClassDescriptor resolveClassByFqName(ModuleDescriptor moduleDescriptor, FqName fqName, LookupLocation lookupLocation) {
        ...
        ClassifierDescriptor mo2056getContributedClassifier = memberScope.mo2056getContributedClassifier(shortName, lookupLocation);
        ClassDescriptor classDescriptor = mo2056getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) mo2056getContributedClassifier : null;
        ...
        if (resolveClassByFqName == null || (unsubstitutedInnerClassesScope = resolveClassByFqName.getUnsubstitutedInnerClassesScope()) == null) {
            ...
            classifierDescriptor = unsubstitutedInnerClassesScope.mo2056getContributedClassifier(shortName2, lookupLocation);
        }
