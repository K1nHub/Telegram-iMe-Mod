...
public final class DescriptorUtilKt {
    public static final ClassDescriptor resolveClassByFqName(ModuleDescriptor moduleDescriptor, FqName fqName, LookupLocation lookupLocation) {
        ...
        ClassifierDescriptor mo2055getContributedClassifier = memberScope.mo2055getContributedClassifier(shortName, lookupLocation);
        ClassDescriptor classDescriptor = mo2055getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) mo2055getContributedClassifier : null;
        ...
        if (resolveClassByFqName == null || (unsubstitutedInnerClassesScope = resolveClassByFqName.getUnsubstitutedInnerClassesScope()) == null) {
            ...
            classifierDescriptor = unsubstitutedInnerClassesScope.mo2055getContributedClassifier(shortName2, lookupLocation);
        }
