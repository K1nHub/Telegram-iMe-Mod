...
public enum KotlinTarget {
    ...
    static {
        ...
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.m149to(annotationUseSiteTarget, kotlinTarget10), TuplesKt.m149to(AnnotationUseSiteTarget.FIELD, kotlinTarget6), TuplesKt.m149to(AnnotationUseSiteTarget.PROPERTY, kotlinTarget5), TuplesKt.m149to(AnnotationUseSiteTarget.FILE, kotlinTarget9), TuplesKt.m149to(AnnotationUseSiteTarget.PROPERTY_GETTER, kotlinTarget8), TuplesKt.m149to(AnnotationUseSiteTarget.PROPERTY_SETTER, kotlinTarget7), TuplesKt.m149to(AnnotationUseSiteTarget.RECEIVER, kotlinTarget10), TuplesKt.m149to(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget10), TuplesKt.m149to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget6));
