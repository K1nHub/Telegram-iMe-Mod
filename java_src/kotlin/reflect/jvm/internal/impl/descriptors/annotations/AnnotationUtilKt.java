...
public final class AnnotationUtilKt {
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(final KotlinBuiltIns kotlinBuiltIns, String message, String replaceWith, String level) {
        ...
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.m149to(REPLACE_WITH_EXPRESSION_NAME, new StringValue(replaceWith)), TuplesKt.m149to(name, new ArrayValue(emptyList, new Function1<ModuleDescriptor, KotlinType>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationUtilKt$createDeprecatedAnnotation$replaceWithAnnotation$1
        ...
        mapOf2 = MapsKt__MapsKt.mapOf(TuplesKt.m149to(DEPRECATED_MESSAGE_NAME, new StringValue(message)), TuplesKt.m149to(DEPRECATED_REPLACE_WITH_NAME, new AnnotationValue(builtInAnnotationDescriptor)), TuplesKt.m149to(name2, new EnumValue(classId, identifier)));
