...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public FunctionDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        FunctionDescriptorImpl createSubstitutedCopy = createSubstitutedCopy(declarationDescriptor, functionDescriptor, copyConfiguration.kind, copyConfiguration.name, annotations, getSourceToUseForCopy(copyConfiguration.preserveSourceElement, functionDescriptor));
