...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo2054getDeclarationDescriptor() {
            ...
            public Collection<KotlinType> mo2055getSupertypes() {
                Collection<KotlinType> mo2055getSupertypes = mo2054getDeclarationDescriptor().getUnderlyingType().getConstructor().mo2055getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo2055getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
                return mo2055getSupertypes;
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo2054getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo2054getDeclarationDescriptor().getName().asString() + ']';
            }
        };
    }
            ...
            */
            public final java.lang.Boolean invoke(kotlin.reflect.jvm.internal.impl.types.UnwrappedType r5) {
                /*
                    ...
                    kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r5 = r5.mo2054getDeclarationDescriptor()
