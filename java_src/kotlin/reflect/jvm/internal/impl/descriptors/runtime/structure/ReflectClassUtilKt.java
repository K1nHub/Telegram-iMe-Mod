...
public final class ReflectClassUtilKt {
    ...
    static {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(TuplesKt.m149to(JvmClassMappingKt.getJavaObjectType(kClass), JvmClassMappingKt.getJavaPrimitiveType(kClass)));
        }
        ...
        while (it2.hasNext()) {
            ...
            arrayList2.add(TuplesKt.m149to(JvmClassMappingKt.getJavaPrimitiveType(kClass2), JvmClassMappingKt.getJavaObjectType(kClass2)));
        }
        ...
        for (Object obj : listOf2) {
            ...
            arrayList3.add(TuplesKt.m149to((Class) obj, Integer.valueOf(i)));
            i = i2;
        }
    ...
    public static final List<Type> getParameterizedTypeArguments(Type type) {
        ...
        generateSequence = SequencesKt__SequencesKt.generateSequence(type, new Function1<ParameterizedType, ParameterizedType>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.ReflectClassUtilKt$parameterizedTypeArguments$1
