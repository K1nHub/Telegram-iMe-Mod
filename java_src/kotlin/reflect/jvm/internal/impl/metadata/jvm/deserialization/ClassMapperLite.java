...
public final class ClassMapperLite {
    ...
    private static final String f2203kotlin;
    ...
    static {
        ...
        f2203kotlin = joinToString$default;
        ...
        linkedHashMap.put(f2203kotlin + "/Unit", "V");
        ...
        for (String str5 : listOf5) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f2203kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f2203kotlin + '/' + str, 'L' + str2 + ';');
    }
