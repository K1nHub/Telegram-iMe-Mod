...
public final class ClassMapperLite {
    ...
    private static final String f2172kotlin;
    ...
    static {
        ...
        f2172kotlin = joinToString$default;
        ...
        linkedHashMap.put(f2172kotlin + "/Unit", "V");
        ...
        for (String str5 : listOf5) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f2172kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f2172kotlin + '/' + str, 'L' + str2 + ';');
    }
