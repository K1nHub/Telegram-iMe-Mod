...
public final class BuiltInsProtoBuf {
    ...
    static {
        ...
        classAnnotation = GeneratedMessageLite.newRepeatedGeneratedExtension(defaultInstance, defaultInstance2, null, ImageReceiver.DEFAULT_CROSSFADE_DURATION, fieldType, false, ProtoBuf$Annotation.class);
        constructorAnnotation = GeneratedMessageLite.newRepeatedGeneratedExtension(ProtoBuf$Constructor.getDefaultInstance(), ProtoBuf$Annotation.getDefaultInstance(), null, ImageReceiver.DEFAULT_CROSSFADE_DURATION, fieldType, false, ProtoBuf$Annotation.class);
        functionAnnotation = GeneratedMessageLite.newRepeatedGeneratedExtension(ProtoBuf$Function.getDefaultInstance(), ProtoBuf$Annotation.getDefaultInstance(), null, ImageReceiver.DEFAULT_CROSSFADE_DURATION, fieldType, false, ProtoBuf$Annotation.class);
        propertyAnnotation = GeneratedMessageLite.newRepeatedGeneratedExtension(ProtoBuf$Property.getDefaultInstance(), ProtoBuf$Annotation.getDefaultInstance(), null, ImageReceiver.DEFAULT_CROSSFADE_DURATION, fieldType, false, ProtoBuf$Annotation.class);
        ...
        enumEntryAnnotation = GeneratedMessageLite.newRepeatedGeneratedExtension(ProtoBuf$EnumEntry.getDefaultInstance(), ProtoBuf$Annotation.getDefaultInstance(), null, ImageReceiver.DEFAULT_CROSSFADE_DURATION, fieldType, false, ProtoBuf$Annotation.class);
        parameterAnnotation = GeneratedMessageLite.newRepeatedGeneratedExtension(ProtoBuf$ValueParameter.getDefaultInstance(), ProtoBuf$Annotation.getDefaultInstance(), null, ImageReceiver.DEFAULT_CROSSFADE_DURATION, fieldType, false, ProtoBuf$Annotation.class);
        typeAnnotation = GeneratedMessageLite.newRepeatedGeneratedExtension(ProtoBuf$Type.getDefaultInstance(), ProtoBuf$Annotation.getDefaultInstance(), null, ImageReceiver.DEFAULT_CROSSFADE_DURATION, fieldType, false, ProtoBuf$Annotation.class);
        typeParameterAnnotation = GeneratedMessageLite.newRepeatedGeneratedExtension(ProtoBuf$TypeParameter.getDefaultInstance(), ProtoBuf$Annotation.getDefaultInstance(), null, ImageReceiver.DEFAULT_CROSSFADE_DURATION, fieldType, false, ProtoBuf$Annotation.class);
    }
}
