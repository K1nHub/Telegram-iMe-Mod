...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    /* renamed from: c */
    private final LazyJavaResolverContext f1369c;
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext outerContext, JavaPackage jPackage) {
        ...
        this.f1369c = childForClassOrPackage$default;
        ...
        this.binaryClasses$delegate = childForClassOrPackage$default.getStorageManager().createLazyValue(new Function0<Map<String, ? extends KotlinJvmBinaryClass>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaPackageFragment$binaryClasses$2
            ...
            public final Map<String, ? extends KotlinJvmBinaryClass> invoke() {
                ...
                lazyJavaResolverContext = LazyJavaPackageFragment.this.f1369c;
                ...
                for (String str : findPackageParts) {
                    ...
                    lazyJavaResolverContext2 = lazyJavaPackageFragment.f1369c;
                    ...
                    Pair m149to = findKotlinClass != null ? TuplesKt.m149to(str, findKotlinClass) : null;
                    if (m149to != null) {
        ...
        childForClassOrPackage$default.getStorageManager().createLazyValue(new Function0<HashMap<JvmClassName, JvmClassName>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaPackageFragment$partToFacade$2
    ...
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f1369c.getComponents().getModule();
    }
