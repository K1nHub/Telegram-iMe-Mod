    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        ...
        if (this.modality == Modality.SEALED) {
            ...
            for (JavaClassifierType javaClassifierType : permittedTypes) {
                ClassifierDescriptor mo2054getDeclarationDescriptor = this.f1365c.getTypeResolver().transformJavaType(javaClassifierType, attributes$default).getConstructor().mo2054getDeclarationDescriptor();
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (enhanceSuperType.getConstructor().mo2054getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor mo2054getDeclarationDescriptor = mo2054getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(mo2054getDeclarationDescriptor, arrayList3);
            }
        ...
        */
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo2049findAnnotation = annotations.mo2049findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (mo2049findAnnotation == null) {
                return null;
            }
            Object singleOrNull = kotlin.collections.CollectionsKt.singleOrNull(mo2049findAnnotation.getAllValueArguments().values());
        ...
        public ClassDescriptor mo2054getDeclarationDescriptor() {
