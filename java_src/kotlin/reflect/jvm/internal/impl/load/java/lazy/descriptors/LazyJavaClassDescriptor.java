    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        ...
        if (this.modality == Modality.SEALED) {
            ...
            for (JavaClassifierType javaClassifierType : permittedTypes) {
                ClassifierDescriptor mo2053getDeclarationDescriptor = this.f1365c.getTypeResolver().transformJavaType(javaClassifierType, attributes$default).getConstructor().mo2053getDeclarationDescriptor();
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (enhanceSuperType.getConstructor().mo2053getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor mo2053getDeclarationDescriptor = mo2053getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(mo2053getDeclarationDescriptor, arrayList3);
            }
        ...
        */
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo2048findAnnotation = annotations.mo2048findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (mo2048findAnnotation == null) {
                return null;
            }
            Object singleOrNull = kotlin.collections.CollectionsKt.singleOrNull(mo2048findAnnotation.getAllValueArguments().values());
