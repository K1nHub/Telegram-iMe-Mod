...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor mo2054getDeclarationDescriptor = getConstructor().mo2054getDeclarationDescriptor();
        ...
        if (classDescriptor == null) {
            throw new IllegalStateException(("Incorrect classifier: " + getConstructor().mo2054getDeclarationDescriptor()).toString());
        }
