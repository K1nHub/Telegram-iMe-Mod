...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2056getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor mo2056getContributedClassifier = this.javaScope.mo2056getContributedClassifier(name, location);
        ...
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor mo2056getContributedClassifier2 = memberScope.mo2056getContributedClassifier(name, location);
            if (mo2056getContributedClassifier2 != null) {
                if (!(mo2056getContributedClassifier2 instanceof ClassifierDescriptorWithTypeParameters) || !((ClassifierDescriptorWithTypeParameters) mo2056getContributedClassifier2).isExpect()) {
                    return mo2056getContributedClassifier2;
                }
                if (classifierDescriptor == null) {
                    classifierDescriptor = mo2056getContributedClassifier2;
                }
            }
        }
