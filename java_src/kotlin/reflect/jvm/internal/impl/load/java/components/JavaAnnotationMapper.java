...
public final class JavaAnnotationMapper {
    ...
    static {
        ...
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.m149to(StandardNames.FqNames.target, JvmAnnotationNames.TARGET_ANNOTATION), TuplesKt.m149to(StandardNames.FqNames.retention, JvmAnnotationNames.RETENTION_ANNOTATION), TuplesKt.m149to(StandardNames.FqNames.mustBeDocumented, JvmAnnotationNames.DOCUMENTED_ANNOTATION));
