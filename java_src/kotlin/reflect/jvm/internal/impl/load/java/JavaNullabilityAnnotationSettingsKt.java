...
public final class JavaNullabilityAnnotationSettingsKt {
    ...
    static {
        ...
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.m146to(fqName5, companion.getDEFAULT()), TuplesKt.m146to(new FqName("androidx.annotation"), companion.getDEFAULT()), TuplesKt.m146to(new FqName("android.support.annotation"), companion.getDEFAULT()), TuplesKt.m146to(new FqName("android.annotation"), companion.getDEFAULT()), TuplesKt.m146to(new FqName("com.android.annotations"), companion.getDEFAULT()), TuplesKt.m146to(new FqName("org.eclipse.jdt.annotation"), companion.getDEFAULT()), TuplesKt.m146to(new FqName("org.checkerframework.checker.nullness.qual"), companion.getDEFAULT()), TuplesKt.m146to(fqName4, companion.getDEFAULT()), TuplesKt.m146to(new FqName("javax.annotation"), companion.getDEFAULT()), TuplesKt.m146to(new FqName("edu.umd.cs.findbugs.annotations"), companion.getDEFAULT()), TuplesKt.m146to(new FqName("io.reactivex.annotations"), companion.getDEFAULT()), TuplesKt.m146to(fqName6, new JavaNullabilityAnnotationsStatus(reportLevel, null, null, 4, null)), TuplesKt.m146to(new FqName("androidx.annotation.RecentlyNonNull"), new JavaNullabilityAnnotationsStatus(reportLevel, null, null, 4, null)), TuplesKt.m146to(new FqName("lombok"), companion.getDEFAULT()), TuplesKt.m146to(fqName, new JavaNullabilityAnnotationsStatus(reportLevel, kotlinVersion, reportLevel2)), TuplesKt.m146to(fqName2, new JavaNullabilityAnnotationsStatus(reportLevel, new KotlinVersion(1, 9), reportLevel2)), TuplesKt.m146to(fqName3, new JavaNullabilityAnnotationsStatus(reportLevel, new KotlinVersion(1, 8), reportLevel2)));
