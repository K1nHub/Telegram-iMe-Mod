...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    /* renamed from: lt */
    private final String m142lt() {
        return escape("<");
    }

    /* renamed from: gt */
    private final String m143gt() {
        return escape(">");
    }
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if (mo2054getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : mo2054getDeclarationDescriptor instanceof ClassDescriptor ? true : mo2054getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(mo2054getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + mo2054getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo2054getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ...
        List plus;
        List<String> sorted;
        ClassConstructorDescriptor mo2048getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (mo2048getUnsubstitutedPrimaryConstructor = annotationClass.mo2048getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo2048getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ...
        if (!getIncludePropertyConstant() || (mo2050getCompileTimeInitializer = variableDescriptor.mo2050getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(mo2050getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo2048getUnsubstitutedPrimaryConstructor = classDescriptor.mo2048getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo2048getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo2048getUnsubstitutedPrimaryConstructor.getVisibility();
            ...
            renderValueParameters(valueParameters, mo2048getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Intrinsics.checkNotNullExpressionValue(mo2055getSupertypes, "klass.typeConstructor.supertypes");
        if (mo2055getSupertypes.isEmpty()) {
            return;
        }
        if (mo2055getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo2055getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt___CollectionsKt.joinTo$default(mo2055getSupertypes, sb, ", ", null, null, 0, null, new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
