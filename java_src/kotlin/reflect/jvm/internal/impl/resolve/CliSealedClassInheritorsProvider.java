        ...
        for (DeclarationDescriptor declarationDescriptor : ResolutionScope.DefaultImpls.getContributedDescriptors$default(memberScope, DescriptorKindFilter.CLASSIFIERS, null, 2, null)) {
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2.isExpect()) {
                    ...
                    ClassifierDescriptor mo2056getContributedClassifier = memberScope.mo2056getContributedClassifier(name, NoLookupLocation.WHEN_GET_ALL_DESCRIPTORS);
                    if (mo2056getContributedClassifier instanceof ClassDescriptor) {
                        classDescriptor2 = (ClassDescriptor) mo2056getContributedClassifier;
                    } else {
                        classDescriptor2 = mo2056getContributedClassifier instanceof TypeAliasDescriptor ? ((TypeAliasDescriptor) mo2056getContributedClassifier).getClassDescriptor() : null;
                    }
                }
