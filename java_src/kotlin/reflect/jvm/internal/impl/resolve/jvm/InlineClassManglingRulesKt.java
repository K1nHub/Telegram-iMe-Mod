...
public final class InlineClassManglingRulesKt {
    ...
    public static final boolean isInlineClassThatRequiresMangling(KotlinType kotlinType) {
        ...
        return mo2054getDeclarationDescriptor != null && isInlineClassThatRequiresMangling(mo2054getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeParameterWithUpperBoundThatRequiresMangling(KotlinType kotlinType) {
        ClassifierDescriptor mo2054getDeclarationDescriptor = kotlinType.getConstructor().mo2054getDeclarationDescriptor();
        TypeParameterDescriptor typeParameterDescriptor = mo2054getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo2054getDeclarationDescriptor : null;
