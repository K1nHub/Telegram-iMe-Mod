...
public final class SubstitutingScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2056getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor mo2056getContributedClassifier = this.workerScope.mo2056getContributedClassifier(name, location);
        if (mo2056getContributedClassifier != null) {
            return (ClassifierDescriptor) substitute((SubstitutingScope) mo2056getContributedClassifier);
        }
        return null;
    }
