...
public final class ChainedMemberScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2056getContributedClassifier(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.scopes) {
            ClassifierDescriptor mo2056getContributedClassifier = memberScope.mo2056getContributedClassifier(name, location);
            if (mo2056getContributedClassifier != null) {
                if (!(mo2056getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((ClassifierDescriptorWithTypeParameters) mo2056getContributedClassifier).isExpect()) {
                    return mo2056getContributedClassifier;
                }
                if (classifierDescriptor == null) {
                    classifierDescriptor = mo2056getContributedClassifier;
                }
            }
        }
