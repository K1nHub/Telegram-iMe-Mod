...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(final TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt$wrapWithCapturingSubstitution$2
            ...
            /* renamed from: get */
            public TypeProjection mo2059get(KotlinType key) {
                TypeProjection createCapturedIfNeeded;
                Intrinsics.checkNotNullParameter(key, "key");
                TypeProjection mo2059get = super.mo2059get(key);
                if (mo2059get != null) {
                    ClassifierDescriptor mo2054getDeclarationDescriptor = key.getConstructor().mo2054getDeclarationDescriptor();
                    createCapturedIfNeeded = CapturedTypeConstructorKt.createCapturedIfNeeded(mo2059get, mo2054getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo2054getDeclarationDescriptor : null);
