...
public class DescriptorUtils {
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(mo2054getDeclarationDescriptor);
    }
    ...
    public static boolean isDirectSubclass(ClassDescriptor classDescriptor, ClassDescriptor classDescriptor2) {
        ...
        for (KotlinType kotlinType : classDescriptor.getTypeConstructor().mo2055getSupertypes()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        ClassifierDescriptor mo2054getDeclarationDescriptor = kotlinType.getConstructor().mo2054getDeclarationDescriptor();
        if (mo2054getDeclarationDescriptor != null) {
            DeclarationDescriptor original = mo2054getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        for (KotlinType kotlinType2 : kotlinType.getConstructor().mo2055getSupertypes()) {
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo2054getDeclarationDescriptor();
        if (classDescriptor == null) {
            $$$reportNull$$$0(47);
        }
