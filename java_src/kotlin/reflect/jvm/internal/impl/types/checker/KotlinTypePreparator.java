    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo2054getSupertypes = capturedTypeConstructorImpl.mo2054getSupertypes();
                collectionSizeOrDefault3 = CollectionsKt__IterablesKt.collectionSizeOrDefault(mo2054getSupertypes, 10);
            ...
            Collection<KotlinType> mo2054getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2054getSupertypes();
            collectionSizeOrDefault2 = CollectionsKt__IterablesKt.collectionSizeOrDefault(mo2054getSupertypes2, 10);
            ArrayList arrayList2 = new ArrayList(collectionSizeOrDefault2);
            for (KotlinType kotlinType2 : mo2054getSupertypes2) {
            ...
            Collection<KotlinType> mo2054getSupertypes3 = intersectionTypeConstructor3.mo2054getSupertypes();
            collectionSizeOrDefault = CollectionsKt__IterablesKt.collectionSizeOrDefault(mo2054getSupertypes3, 10);
            ArrayList arrayList3 = new ArrayList(collectionSizeOrDefault);
            for (KotlinType kotlinType3 : mo2054getSupertypes3) {
