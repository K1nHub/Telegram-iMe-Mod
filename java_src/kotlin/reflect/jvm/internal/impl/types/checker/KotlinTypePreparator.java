    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo2055getSupertypes = capturedTypeConstructorImpl.mo2055getSupertypes();
                collectionSizeOrDefault3 = CollectionsKt__IterablesKt.collectionSizeOrDefault(mo2055getSupertypes, 10);
            ...
            Collection<KotlinType> mo2055getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2055getSupertypes();
            collectionSizeOrDefault2 = CollectionsKt__IterablesKt.collectionSizeOrDefault(mo2055getSupertypes2, 10);
            ArrayList arrayList2 = new ArrayList(collectionSizeOrDefault2);
            for (KotlinType kotlinType2 : mo2055getSupertypes2) {
            ...
            Collection<KotlinType> mo2055getSupertypes3 = intersectionTypeConstructor3.mo2055getSupertypes();
            collectionSizeOrDefault = CollectionsKt__IterablesKt.collectionSizeOrDefault(mo2055getSupertypes3, 10);
            ArrayList arrayList3 = new ArrayList(collectionSizeOrDefault);
            for (KotlinType kotlinType3 : mo2055getSupertypes3) {
