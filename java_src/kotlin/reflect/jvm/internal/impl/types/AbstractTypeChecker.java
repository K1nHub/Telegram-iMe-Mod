...
public final class AbstractTypeChecker {
    ...
    private final Boolean checkSubtypeForIntegerLiteralType(TypeCheckerState typeCheckerState, SimpleTypeMarker simpleTypeMarker, SimpleTypeMarker simpleTypeMarker2) {
        ...
        if (typeSystemContext.isIntegerLiteralType(simpleTypeMarker) || typeSystemContext.isIntegerLiteralType(simpleTypeMarker2)) {
            if (m139xdf0fda08(typeSystemContext, simpleTypeMarker) && m139xdf0fda08(typeSystemContext, simpleTypeMarker2)) {
                return Boolean.TRUE;
            }
            if (typeSystemContext.isIntegerLiteralType(simpleTypeMarker)) {
                if (m138x5f8d759c(typeSystemContext, typeCheckerState, simpleTypeMarker, simpleTypeMarker2, false)) {
                    return Boolean.TRUE;
                }
            } else if (typeSystemContext.isIntegerLiteralType(simpleTypeMarker2) && (m140x8a873de1(typeSystemContext, simpleTypeMarker) || m138x5f8d759c(typeSystemContext, typeCheckerState, simpleTypeMarker2, simpleTypeMarker, true))) {
                return Boolean.TRUE;
            }
            return null;
        }
    ...
    private static final boolean m138x5f8d759c(TypeSystemContext typeSystemContext, TypeCheckerState typeCheckerState, SimpleTypeMarker simpleTypeMarker, SimpleTypeMarker simpleTypeMarker2, boolean z) {
        boolean z2;
    ...
    private static final boolean m140x8a873de1(TypeSystemContext typeSystemContext, SimpleTypeMarker simpleTypeMarker) {
        boolean z;
        boolean z2;
    ...
    private static final boolean m141xef0f5f3b(TypeSystemContext typeSystemContext, SimpleTypeMarker simpleTypeMarker) {
    ...
    private static final boolean m139xdf0fda08(TypeSystemContext typeSystemContext, SimpleTypeMarker simpleTypeMarker) {
        return typeSystemContext.isIntegerLiteralType(simpleTypeMarker) || m141xef0f5f3b(typeSystemContext, simpleTypeMarker);
    }
            ...
            if (supertypesSet.add(current)) {
                ...
                if (supertypesPolicy == null) {
                    ...
                    for (KotlinTypeMarker kotlinTypeMarker : typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current))) {
                        SimpleTypeMarker mo2058transformType = supertypesPolicy.mo2058transformType(typeCheckerState, kotlinTypeMarker);
                        if (typeSystemContext.isNothingConstructor(typeSystemContext.typeConstructor(mo2058transformType))) {
            ...
            while (!supertypesDeque.isEmpty()) {
                ...
                if (supertypesSet.add(current)) {
                    ...
                    if (substitutionSupertypePolicy != null) {
                        TypeSystemContext typeSystemContext2 = typeCheckerState.getTypeSystemContext();
                        for (KotlinTypeMarker kotlinTypeMarker : typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current))) {
                            supertypesDeque.add(substitutionSupertypePolicy.mo2058transformType(typeCheckerState, kotlinTypeMarker));
                        }
                    }
                }
            }
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(current)) {
                ...
                if (supertypesPolicy != null) {
                    ...
                    for (KotlinTypeMarker kotlinTypeMarker : typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current))) {
                        supertypesDeque.add(supertypesPolicy.mo2058transformType(state, kotlinTypeMarker));
                    }
                }
            }
        }
