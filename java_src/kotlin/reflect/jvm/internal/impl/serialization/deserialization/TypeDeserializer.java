...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf$Type proto, boolean z) {
        ...
        boolean z2 = true;
        if (ErrorUtils.isError(typeConstructor.mo2054getDeclarationDescriptor())) {
        ...
        if (z && (mo2054getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType computeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) mo2054getDeclarationDescriptor, list);
    ...
    private static final ClassDescriptor typeConstructor$notFoundClass(final TypeDeserializer typeDeserializer, ProtoBuf$Type protoBuf$Type, int i) {
        ...
        generateSequence2 = SequencesKt__SequencesKt.generateSequence(classId, C3448x1c22db09.INSTANCE);
    ...
    */
    private final kotlin.reflect.jvm.internal.impl.types.SimpleType transformRuntimeFunctionTypeToSuspendFunction(kotlin.reflect.jvm.internal.impl.types.KotlinType r6) {
        ...
        L14:
            ...
            kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r2 = r2.mo2054getDeclarationDescriptor()
            if (r2 == 0) goto L23
