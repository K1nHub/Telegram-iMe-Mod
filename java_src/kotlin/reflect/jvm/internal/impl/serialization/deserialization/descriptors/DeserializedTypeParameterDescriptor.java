...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: c */
    private final DeserializationContext f1388c;
    ...
    */
    ...
    protected List<KotlinType> resolveUpperBounds() {
        ...
        List<ProtoBuf$Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.proto, this.f1388c.getTypeTable());
        if (upperBounds.isEmpty()) {
            listOf = CollectionsKt__CollectionsJVMKt.listOf(DescriptorUtilsKt.getBuiltIns(this).getDefaultBound());
            return listOf;
        }
        TypeDeserializer typeDeserializer = this.f1388c.getTypeDeserializer();
    ...
    public Void mo2057reportSupertypeLoopError(KotlinType type) {
