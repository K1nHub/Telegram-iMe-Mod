...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor mo2056getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo2056getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                if (mo2056getContributedClassifier == null) {
                    throw new AssertionError("Built-in class " + StandardNames.BUILT_INS_PACKAGE_FQ_NAME.child(name) + " is not found");
                } else if (!(mo2056getContributedClassifier instanceof ClassDescriptor)) {
                    throw new AssertionError("Must be a class descriptor " + name + ", but was " + mo2056getContributedClassifier);
                } else {
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(mo2054getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(mo2054getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo2054getDeclarationDescriptor = kotlinType.getConstructor().mo2054getDeclarationDescriptor();
        return (mo2054getDeclarationDescriptor == null || getPrimitiveArrayType(mo2054getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(mo2054getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo2054getDeclarationDescriptor = kotlinType.getConstructor().mo2054getDeclarationDescriptor();
        return (mo2054getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo2054getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (mo2054getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo2054getDeclarationDescriptor, fqNameUnsafe);
    }
