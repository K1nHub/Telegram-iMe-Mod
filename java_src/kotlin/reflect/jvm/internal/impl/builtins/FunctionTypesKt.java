...
public final class FunctionTypesKt {
    public static final boolean isFunctionType(KotlinType kotlinType) {
        ...
        return (mo2054getDeclarationDescriptor != null ? getFunctionalClassKind(mo2054getDeclarationDescriptor) : null) == FunctionClassKind.Function;
    }

    public static final boolean isSuspendFunctionType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo2054getDeclarationDescriptor = kotlinType.getConstructor().mo2054getDeclarationDescriptor();
        return (mo2054getDeclarationDescriptor != null ? getFunctionalClassKind(mo2054getDeclarationDescriptor) : null) == FunctionClassKind.SuspendFunction;
    }

    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo2054getDeclarationDescriptor = kotlinType.getConstructor().mo2054getDeclarationDescriptor();
        return mo2054getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(mo2054getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo2049findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo2049findAnnotation = kotlinType.getAnnotations().mo2049findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (mo2049findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(mo2049findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo2049findAnnotation = kotlinType.getAnnotations().mo2049findAnnotation(StandardNames.FqNames.parameterName);
        if (mo2049findAnnotation == null) {
            return null;
        }
        Object singleOrNull = CollectionsKt.singleOrNull(mo2049findAnnotation.getAllValueArguments().values());
    ...
    public static final List<TypeProjection> getFunctionTypeArgumentProjections(KotlinType kotlinType, List<? extends KotlinType> contextReceiverTypes, List<? extends KotlinType> parameterTypes, List<Name> list, KotlinType returnType, KotlinBuiltIns builtIns) {
        ...
        for (Object obj : parameterTypes) {
            ...
            if (name != null) {
                ...
                mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.m149to(identifier, new StringValue(asString)));
    ...
    public static final Annotations withContextReceiversFunctionAnnotation(Annotations annotations, KotlinBuiltIns builtIns, int i) {
        ...
        Annotations.Companion companion = Annotations.Companion;
        mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.m149to(StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME, new IntValue(i)));
