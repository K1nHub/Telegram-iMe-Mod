...
public final class StandardNames {
    ...
    static {
        List<String> listOf;
        Set<FqName> of;
        Intrinsics.checkNotNullExpressionValue(Name.identifier("field"), "identifier(\"field\")");
        Intrinsics.checkNotNullExpressionValue(Name.identifier(AppMeasurementSdk.ConditionalUserProperty.VALUE), "identifier(\"value\")");
        ...
        Name identifier2 = Name.identifier("entries");
        Intrinsics.checkNotNullExpressionValue(identifier2, "identifier(\"entries\")");
        ENUM_ENTRIES = identifier2;
        Name identifier3 = Name.identifier("valueOf");
        Intrinsics.checkNotNullExpressionValue(identifier3, "identifier(\"valueOf\")");
        ENUM_VALUE_OF = identifier3;
        Intrinsics.checkNotNullExpressionValue(Name.identifier("copy"), "identifier(\"copy\")");
        Intrinsics.checkNotNullExpressionValue(Name.identifier("hashCode"), "identifier(\"hashCode\")");
        Intrinsics.checkNotNullExpressionValue(Name.identifier("code"), "identifier(\"code\")");
        Intrinsics.checkNotNullExpressionValue(Name.identifier("nextChar"), "identifier(\"nextChar\")");
        Name identifier4 = Name.identifier(NotificationBadge.NewHtcHomeBadger.COUNT);
        Intrinsics.checkNotNullExpressionValue(identifier4, "identifier(\"count\")");
        CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME = identifier4;
        new FqName("<dynamic>");
        ...
        PREFIXES = listOf;
        Name identifier5 = Name.identifier("kotlin");
        Intrinsics.checkNotNullExpressionValue(identifier5, "identifier(\"kotlin\")");
        BUILT_INS_PACKAGE_NAME = identifier5;
        FqName fqName3 = FqName.topLevel(identifier5);
        ...
        Intrinsics.checkNotNullExpressionValue(fqName3.child(Name.identifier("text")), "BUILT_INS_PACKAGE_FQ_NAM…(Name.identifier(\"text\"))");
        FqName child5 = fqName3.child(Name.identifier("internal"));
        Intrinsics.checkNotNullExpressionValue(child5, "BUILT_INS_PACKAGE_FQ_NAM…e.identifier(\"internal\"))");
        KOTLIN_INTERNAL_FQ_NAME = child5;
        new FqName("error.NonExistentClass");
        of = SetsKt__SetsKt.setOf((Object[]) new FqName[]{fqName3, child3, child4, child2, fqName2, child5, fqName});
    ...
    public static final class FqNames {
        ...
        static {
            ...
            fqNames.rangesFqName("IntRange");
            fqNames.rangesFqName("LongRange");
            ...
            Intrinsics.checkNotNullExpressionValue(ClassId.topLevel(fqName), "topLevel(parameterName)");
            annotation = fqNames.fqName("Annotation");
            FqName annotationName = fqNames.annotationName("Target");
            target = annotationName;
            Intrinsics.checkNotNullExpressionValue(ClassId.topLevel(annotationName), "topLevel(target)");
            ...
            Intrinsics.checkNotNullExpressionValue(ClassId.topLevel(annotationName2), "topLevel(retention)");
            FqName annotationName3 = fqNames.annotationName("Repeatable");
            repeatable = annotationName3;
            Intrinsics.checkNotNullExpressionValue(ClassId.topLevel(annotationName3), "topLevel(repeatable)");
            ...
            fqNames.internalName("AccessibleLateinitPropertyLiteral");
