...
public final class ReflectionTypes {
    ...
    public ReflectionTypes(final ModuleDescriptor module, NotFoundClasses notFoundClasses) {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0<MemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.ReflectionTypes$kotlinReflectScope$2
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor mo2055getContributedClassifier = getKotlinReflectScope().mo2055getContributedClassifier(identifier, NoLookupLocation.FROM_REFLECTION);
