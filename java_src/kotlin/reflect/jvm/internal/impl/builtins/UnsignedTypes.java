...
public final class UnsignedTypes {
    ...
    static {
        ...
        MapsKt__MapsKt.hashMapOf(TuplesKt.m149to(UnsignedArrayType.UBYTEARRAY, Name.identifier("ubyteArrayOf")), TuplesKt.m149to(UnsignedArrayType.USHORTARRAY, Name.identifier("ushortArrayOf")), TuplesKt.m149to(UnsignedArrayType.UINTARRAY, Name.identifier("uintArrayOf")), TuplesKt.m149to(UnsignedArrayType.ULONGARRAY, Name.identifier("ulongArrayOf")));
    ...
    public static final boolean isUnsignedType(KotlinType type) {
        ...
        if (TypeUtils.noExpectedType(type) || (mo2054getDeclarationDescriptor = type.getConstructor().mo2054getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(mo2054getDeclarationDescriptor);
    }
