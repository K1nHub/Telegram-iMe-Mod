        ...
        lazy2 = LazyKt__LazyJVMKt.lazy(lazyThreadSafetyMode, new Function0<Caller<? extends Executable>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (mapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Intrinsics.checkNotNull(KFunctionImpl.this.getCaller().mo2046getMember());
                    genericDeclaration = container.findDefaultMethod(methodName, methodDesc, !Modifier.isStatic(mo2046getMember.getModifiers()));
                ...
                if (genericDeclaration instanceof Constructor) {
                    ...
                    if (KFunctionImpl.this.getDescriptor().getAnnotations().mo2049findAnnotation(UtilKt.getJVM_STATIC()) != null) {
