    ...
    */
    ...
    public final PropertyDescriptor findPropertyDescriptor(String name, String signature) {
        ...
        if (arrayList.isEmpty()) {
            ...
            final C3258x62283bb c3258x62283bb = new Function2<DescriptorVisibility, DescriptorVisibility, Integer>() { // from class: kotlin.reflect.jvm.internal.KDeclarationContainerImpl$findPropertyDescriptor$mostVisibleProperties$2
            ...
            sortedMap = MapsKt__MapsJVMKt.toSortedMap(linkedHashMap, new Comparator(c3258x62283bb) { // from class: kotlin.reflect.jvm.internal.KDeclarationContainerImpl$$Lambda$0
                private final Function2 arg$0;

                {
                    this.arg$0 = c3258x62283bb;
                }
