...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (Object obj : listOf) {
            ...
            arrayList.add(TuplesKt.m94to((Class) obj, Integer.valueOf(i)));
            i = i2;
        }
        ...
        for (String kotlinName : values) {
            ...
            Pair m94to = TuplesKt.m94to(sb.toString(), kotlinName + ".Companion");
            hashMap3.put(m94to.getFirst(), m94to.getSecond());
        }
