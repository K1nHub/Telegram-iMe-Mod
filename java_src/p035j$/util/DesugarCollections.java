...
import p035j$.util.concurrent.InterfaceC2657b;
...
public class DesugarCollections {
    ...
    /* renamed from: a */
    public static final Class f540a;

    /* renamed from: b */
    static final Class f541b;

    /* renamed from: c */
    private static final Field f542c;

    /* renamed from: d */
    private static final Field f543d;

    /* renamed from: e */
    private static final Constructor f544e;

    /* renamed from: f */
    private static final Constructor f545f;
    ...
    static {
        ...
        f540a = cls;
        f541b = Collections.synchronizedList(new LinkedList()).getClass();
    ...
    /* renamed from: c */
    public static boolean m639c(Collection collection, Predicate predicate) {
        boolean removeIf;
        Field field = f542c;
        if (field == null) {
            try {
                return Collection$EL.removeIf((Collection) f543d.get(collection), predicate);
        ...
        try {
            synchronized (field.get(collection)) {
                removeIf = Collection$EL.removeIf((Collection) f543d.get(collection), predicate);
            }
            return removeIf;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: d */
    public static void m638d(List list, Comparator comparator) {
        Field field = f542c;
        if (field == null) {
            try {
                AbstractC2628a.m599v((List) f543d.get(list), comparator);
                return;
            } catch (IllegalAccessException e) {
    ...
    public static <K, V> Map<K, V> synchronizedMap(Map<K, V> map) {
        return new C2620a(map);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: j$.util.DesugarCollections$a */
    /* loaded from: classes2.dex */
    public static class C2620a implements Map, Serializable, Map {
        ...
        /* renamed from: c */
        private transient Set f548c;

        /* renamed from: d */
        private transient Set f549d;

        /* renamed from: e */
        private transient Collection f550e;
        ...
        /* renamed from: a */
        private Set m637a(Set set, Object obj) {
            if (DesugarCollections.f545f == null) {
                return Collections.synchronizedSet(set);
            }
            try {
                return (Set) DesugarCollections.f545f.newInstance(set, obj);
        ...
        public Object computeIfAbsent(Object obj, Function function) {
            ...
            synchronized (this.f547b) {
                try {
                    java.util.Map map = this.f546a;
                    computeIfAbsent = map instanceof Map ? ((Map) map).computeIfAbsent(obj, function) : map instanceof ConcurrentMap ? AbstractC2574d.m687a((ConcurrentMap) map, obj, function) : Map.CC.$default$computeIfAbsent(map, obj, function);
                } catch (Throwable th) {
                    throw th;
                }
            }
        ...
        public boolean containsKey(Object obj) {
            boolean containsKey;
            synchronized (this.f547b) {
                containsKey = this.f546a.containsKey(obj);
            }
            return containsKey;
        }
        ...
        public boolean containsValue(Object obj) {
            ...
            synchronized (this.f547b) {
                containsValue = this.f546a.containsValue(obj);
            }
        ...
        public Set entrySet() {
            ...
            synchronized (this.f547b) {
                if (this.f549d == null) {
                    this.f549d = m637a(this.f546a.entrySet(), this.f547b);
                }
                set = this.f549d;
            }
            return set;
            ...
            synchronized (this.f547b) {
                try {
                    ...
                    if (map instanceof Map) {
                        ...
                        AbstractC2574d.m686b((ConcurrentMap) map, biConsumer);
                    } else {
        ...
        public Object getOrDefault(Object obj, Object obj2) {
            Object orDefault;
            synchronized (this.f547b) {
                orDefault = Map.EL.getOrDefault(this.f546a, obj, obj2);
            }
            return orDefault;
        }
        ...
        public Set keySet() {
            ...
            synchronized (this.f547b) {
                if (this.f548c == null) {
                    this.f548c = m637a(this.f546a.keySet(), this.f547b);
                }
                set = this.f548c;
            }
            return set;
        ...
        */
        public java.lang.Object merge(java.lang.Object r5, java.lang.Object r6, p035j$.util.function.BiFunction r7) {
            /*
                r4 = this;
                java.lang.Object r0 = r4.f547b
                monitor-enter(r0)
                java.util.Map r1 = r4.f546a     // Catch: java.lang.Throwable -> L30
                boolean r2 = r1 instanceof p035j$.util.Map     // Catch: java.lang.Throwable -> L30
                if (r2 == 0) goto L10
                j$.util.Map r1 = (p035j$.util.Map) r1     // Catch: java.lang.Throwable -> L30
            ...
            L40:
                ...
                goto L46
            L42:
                java.lang.Object r5 = p035j$.util.Map.CC.$default$merge(r1, r5, r6, r7)     // Catch: java.lang.Throwable -> L30
            L46:
            ...
            L48:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p035j$.util.DesugarCollections.C2620a.merge(java.lang.Object, java.lang.Object, j$.util.function.BiFunction):java.lang.Object");
        }
        ...
        public Object putIfAbsent(Object obj, Object obj2) {
            Object putIfAbsent;
            synchronized (this.f547b) {
                putIfAbsent = Map.EL.putIfAbsent(this.f546a, obj, obj2);
            }
            return putIfAbsent;
        }
            ...
            synchronized (this.f547b) {
                try {
                    ...
                    if (map instanceof Map) {
                        ...
                        ConcurrentMap concurrentMap = (ConcurrentMap) map;
                        Objects.requireNonNull(biFunction);
                        C2656a c2656a = new C2656a(concurrentMap, biFunction);
                        if (concurrentMap instanceof InterfaceC2657b) {
                            ((InterfaceC2657b) concurrentMap).forEach(c2656a);
                        } else {
                            AbstractC2574d.m686b(concurrentMap, c2656a);
                        }
                    } else {
        ...
        public Collection values() {
            ...
            synchronized (this.f547b) {
                try {
                    if (this.f550e == null) {
                        Collection values = this.f546a.values();
                        Object obj = this.f547b;
                        if (DesugarCollections.f544e == null) {
                            collection2 = Collections.synchronizedCollection(values);
                        } else {
                            try {
                                collection2 = (Collection) DesugarCollections.f544e.newInstance(values, obj);
                            } catch (IllegalAccessException e) {
                                e = e;
                                throw new Error("Unable to instantiate a synchronized list.", e);
                        ...
                        this.f550e = collection2;
                    }
                    collection = this.f550e;
                } finally {
                }
            }
            return collection;
