...
public class UpdateLayout extends IUpdateLayout {
    ...
    public void createUpdateUI(int i, final boolean z) {
        ...
        FrameLayout frameLayout = new FrameLayout(this.activity) { // from class: Components.UpdateLayout.1
            ...
            public void draw(Canvas canvas) {
                if (this.updateGradient != null) {
                    ...
                    if (z) {
                        this.path.reset();
                        this.path.addRoundRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight(), AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8), Path.Direction.CW);
        ...
        if (!z) {
            this.updateLayout.setTranslationY(AndroidUtilities.m107dp(44));
        }
        ...
        this.updateLayoutIcon.setProgressRect(AndroidUtilities.m107dp(22), AndroidUtilities.m107dp(11), AndroidUtilities.m107dp(44), AndroidUtilities.m107dp(33));
        if (z) {
            this.updateLayoutIcon.getProgressRect().offset(AndroidUtilities.m107dp(3), AndroidUtilities.m107dp(3));
        }
        this.updateLayoutIcon.setCircleRadius(AndroidUtilities.m107dp(11));
