...
public class UpdateAppAlertDialog extends BottomSheet {
    ...
    public void updateUI() {
        ...
        layoutParams.topMargin = AndroidUtilities.m107dp(this.appUpdate.sticker != null ? 16 : 0);
    ...
    public class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, boolean z) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.textView[i].setPadding(0, 0, 0, this.hasBackground ? 0 : AndroidUtilities.m107dp(13));
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(this.hasBackground ? 80 : 50), 1073741824));
        }
        ...
        public void setText(CharSequence charSequence, boolean z) {
            ...
            animatorSet.playTogether(ObjectAnimator.ofFloat(this.textView[0], View.ALPHA, 1.0f, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(this.textView[0], View.TRANSLATION_Y, BitmapDescriptorFactory.HUE_RED, -AndroidUtilities.m107dp(10)), ObjectAnimator.ofFloat(this.textView[1], View.ALPHA, BitmapDescriptorFactory.HUE_RED, 1.0f), ObjectAnimator.ofFloat(this.textView[1], View.TRANSLATION_Y, AndroidUtilities.m107dp(10), BitmapDescriptorFactory.HUE_RED));
    ...
    public UpdateAppAlertDialog(Context context, TLRPC$TL_help_appUpdate tLRPC$TL_help_appUpdate, int i) {
        ...
        NestedScrollView nestedScrollView = new NestedScrollView(context) { // from class: Components.UpdateAppAlertDialog.2
            ...
            public void onMeasure(int i2, int i3) {
                ...
                int i4 = (size / 5) * 2;
                if (measuredHeight - (size - i4) < AndroidUtilities.m107dp(90) || measuredHeight < (size / 2) + AndroidUtilities.m107dp(90)) {
        ...
        layoutParams.bottomMargin = AndroidUtilities.m107dp((int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
        View view = new View(context);
        this.shadow = view;
        ...
        layoutParams2.bottomMargin = i5 + AndroidUtilities.m107dp(50);
    ...
    public void updateLayout() {
        ...
        int max = Math.max(this.location[1] - AndroidUtilities.m107dp(24), 0);
        if (this.location[1] + this.linearLayout.getMeasuredHeight() <= (this.container.getMeasuredHeight() - AndroidUtilities.m107dp(113)) + this.containerView.getTranslationY()) {
