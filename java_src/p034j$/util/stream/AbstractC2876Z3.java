...
public abstract class AbstractC2876Z3 extends AbstractC2902e implements Iterable, InterfaceC2601e {
    ...
    /* loaded from: classes2.dex */
    abstract class AbstractC2877a implements InterfaceC3034t {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public AbstractC2877a(int i, int i2, int i3, int i4) {
            this.f870a = i;
            this.f871b = i2;
            this.f872c = i3;
            this.f873d = i4;
            Object[] objArr = AbstractC2876Z3.this.f869f;
            this.f874e = objArr == null ? AbstractC2876Z3.this.f868e : objArr[i];
        }
        ...
        public long estimateSize() {
            ...
            long[] jArr = AbstractC2876Z3.this.f934d;
            return ((jArr[i2] + this.f873d) - jArr[i]) - this.f872c;
        }

        /* renamed from: f */
        abstract InterfaceC3034t mo451f(Object obj, int i, int i2);
        ...
        public void m452e(Object obj) {
            ...
            if (i2 < i3 || (i2 == i3 && this.f872c < this.f873d)) {
                ...
                while (true) {
                    ...
                    AbstractC2876Z3 abstractC2876Z3 = AbstractC2876Z3.this;
                    Object obj2 = abstractC2876Z3.f869f[i2];
                    abstractC2876Z3.mo462t(obj2, i4, abstractC2876Z3.mo461u(obj2), obj);
                    i4 = 0;
                    i2++;
                }
                AbstractC2876Z3.this.mo462t(this.f870a == i ? this.f874e : AbstractC2876Z3.this.f869f[i], i4, this.f873d, obj);
        ...
        /* renamed from: h */
        abstract InterfaceC3034t mo449h(int i, int i2, int i3, int i4);
        ...
        public boolean m447k(Object obj) {
            ...
            if (i < i2 || (i == i2 && this.f872c < this.f873d)) {
                ...
                this.f872c = i3 + 1;
                mo455a(obj2, i3, obj);
                if (this.f872c == AbstractC2876Z3.this.mo461u(this.f874e)) {
                    this.f872c = 0;
                    int i4 = this.f870a + 1;
                    this.f870a = i4;
                    Object[] objArr = AbstractC2876Z3.this.f869f;
        ...
        @Override // p034j$.util.InterfaceC2727s
        public InterfaceC3034t trySplit() {
            int i = this.f870a;
            int i2 = this.f871b;
            if (i < i2) {
                int i3 = this.f872c;
                AbstractC2876Z3 abstractC2876Z3 = AbstractC2876Z3.this;
                InterfaceC3034t mo449h = mo449h(i, i2 - 1, i3, abstractC2876Z3.mo461u(abstractC2876Z3.f869f[i2 - 1]));
                int i4 = this.f871b;
                this.f870a = i4;
                this.f872c = 0;
                this.f874e = AbstractC2876Z3.this.f869f[i4];
                return mo449h;
            } else if (i == i2) {
                int i5 = this.f873d;
                int i6 = this.f872c;
                ...
                InterfaceC3034t mo451f = mo451f(this.f874e, i6, i7);
                this.f872c += i7;
                return mo451f;
            } else {
                return null;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractC2876Z3() {
        this.f868e = mo463c(16);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractC2876Z3(int i) {
        super(i);
    ...
    @Override // p034j$.util.stream.AbstractC2902e
    public void clear() {
        Object[] objArr = this.f869f;
        if (objArr != null) {
            this.f868e = objArr[0];
    ...
    public abstract InterfaceC2727s spliterator();
