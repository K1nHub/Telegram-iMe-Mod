...
public class C2893c2 implements InterfaceC3012w1 {
    ...
    public void mo276g(Object obj) {
        ...
        for (int i = 0; i < this.f899b; i++) {
            interfaceC2700l.accept(this.f898a[i]);
        }
    }
    ...
    public InterfaceC3034t spliterator() {
        return AbstractC2651I.m616k(this.f898a, 0, this.f899b, 1040);
    }
