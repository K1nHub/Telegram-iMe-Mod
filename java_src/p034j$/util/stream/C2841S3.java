...
public class C2841S3 implements InterfaceC2727s {
    ...
    /* renamed from: f */
    final /* synthetic */ C2883a4 f841f;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2841S3(C2883a4 c2883a4, int i, int i2, int i3, int i4) {
        this.f841f = c2883a4;
        this.f836a = i;
        this.f837b = i2;
        this.f838c = i3;
        ...
        this.f840e = objArr == null ? c2883a4.f880e : objArr[i];
    }
    ...
    public InterfaceC2727s trySplit() {
        ...
        int i2 = this.f837b;
        if (i < i2) {
            C2883a4 c2883a4 = this.f841f;
            int i3 = i2 - 1;
            C2841S3 c2841s3 = new C2841S3(c2883a4, i, i3, this.f838c, c2883a4.f881f[i3].length);
            int i4 = this.f837b;
            this.f836a = i4;
            this.f838c = 0;
            ...
            InterfaceC2727s m614m = AbstractC2651I.m614m(this.f840e, i6, i6 + i7, 1040);
            this.f838c += i7;
            return m614m;
        } else {
            return null;
