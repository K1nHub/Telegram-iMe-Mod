...
public final /* synthetic */ class C2650a implements InterfaceC2651b, Predicate {
    ...
    public /* synthetic */ C2650a(Predicate predicate) {
        this.f650a = 2;
    ...
    public /* synthetic */ C2650a(Comparator comparator, int i) {
        this.f650a = i;
        if (i != 1) {
