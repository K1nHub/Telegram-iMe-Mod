...
public final /* synthetic */ class C2689a implements InterfaceC2690b, Predicate {
    ...
    public /* synthetic */ C2689a(Predicate predicate) {
        this.f653a = 2;
    ...
    public /* synthetic */ C2689a(Comparator comparator, int i) {
        this.f653a = i;
        if (i != 1) {
