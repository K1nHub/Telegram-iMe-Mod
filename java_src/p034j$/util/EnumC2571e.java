...
import p034j$.wrappers.C2926A0;
import p034j$.wrappers.C2930C0;
import p034j$.wrappers.C2934E0;
import p034j$.wrappers.C2947L;
/* JADX INFO: Access modifiers changed from: package-private */
/* renamed from: j$.util.e */
/* loaded from: classes2.dex */
public enum EnumC2571e implements Comparator, Comparator {
    INSTANCE;
    ...
    public /* synthetic */ java.util.Comparator thenComparing(java.util.function.Function function) {
        java.util.Comparator m604w;
        m604w = AbstractC2538a.m604w(this, Comparator.CC.comparing(C2947L.m204a(function)));
        return m604w;
    }
    ...
    public /* synthetic */ java.util.Comparator thenComparingDouble(java.util.function.ToDoubleFunction toDoubleFunction) {
        return Objects.requireNonNull(C2926A0.m246a(toDoubleFunction));
    }
    ...
    public /* synthetic */ java.util.Comparator thenComparingInt(java.util.function.ToIntFunction toIntFunction) {
        java.util.Comparator m604w;
        m604w = AbstractC2538a.m604w(this, Comparator.CC.comparingInt(C2930C0.m242a(toIntFunction)));
        return m604w;
    }
    ...
    public /* synthetic */ java.util.Comparator thenComparingLong(java.util.function.ToLongFunction toLongFunction) {
        return Objects.requireNonNull(C2934E0.m237a(toLongFunction));
    }

    @Override // java.util.Comparator
    public /* synthetic */ java.util.Comparator thenComparing(java.util.function.Function function, java.util.Comparator comparator) {
        return Comparator.CC.$default$thenComparing(this, C2947L.m204a(function), comparator);
    }
}
