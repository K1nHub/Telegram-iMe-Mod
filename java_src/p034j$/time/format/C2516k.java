...
final class C2516k implements InterfaceC2512g {

    /* renamed from: c */
    static final String[] f503c = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS"};

    /* renamed from: d */
    static final C2516k f504d = new C2516k("+HH:MM:ss", "Z");
    ...
    static {
        new C2516k("+HH:MM:ss", SessionDescription.SUPPORTED_SDP_VERSION);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2516k(String str, String str2) {
