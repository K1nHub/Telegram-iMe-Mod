...
final class C2618k implements InterfaceC2614g {

    /* renamed from: c */
    static final String[] f506c = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS"};

    /* renamed from: d */
    static final C2618k f507d = new C2618k("+HH:MM:ss", "Z");
    ...
    static {
        new C2618k("+HH:MM:ss", SessionDescription.SUPPORTED_SDP_VERSION);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2618k(String str, String str2) {
