...
import p034j$.time.C2607a;
/* renamed from: j$.time.temporal.m */
/* loaded from: classes2.dex */
public final class C2646m implements Serializable {
    ...
    private C2646m(long j, long j2, long j3, long j4) {
        this.f534a = j;
        this.f535b = j2;
        this.f536c = j3;
        this.f537d = j4;
    ...
    /* renamed from: c */
    public static C2646m m637c(long j, long j2) {
        if (j <= j2) {
            return new C2646m(j, j, j2, j2);
        }
        throw new IllegalArgumentException("Minimum value must be less than maximum value");
    }

    /* renamed from: d */
    public static C2646m m636d(long j, long j2, long j3) {
        if (j <= j) {
            if (j2 <= j3) {
                if (j <= j3) {
                    return new C2646m(j, j, j2, j3);
                }
                throw new IllegalArgumentException("Minimum value must be less than maximum value");
            }
    ...
    /* renamed from: a */
    public long m639a(long j, InterfaceC2643j interfaceC2643j) {
        if (j >= this.f534a && j <= this.f537d) {
            return j;
        }
        throw new C2607a("Invalid value for " + interfaceC2643j + " (valid values " + this + "): " + j);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof C2646m) {
            ...
            return this.f534a == c2646m.f534a && this.f535b == c2646m.f535b && this.f536c == c2646m.f536c && this.f537d == c2646m.f537d;
        }
        return false;
    }
