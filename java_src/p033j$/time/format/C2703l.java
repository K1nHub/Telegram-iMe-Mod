...
public final class C2703l implements InterfaceC2699h {

    /* renamed from: c */
    static final String[] f542c = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS"};

    /* renamed from: d */
    static final C2703l f543d = new C2703l("+HH:MM:ss", "Z");

    /* renamed from: e */
    static final C2703l f544e = new C2703l("+HH:MM:ss", SessionDescription.SUPPORTED_SDP_VERSION);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C2703l(String str, String str2) {
    ...
    public boolean mo883a(C2713v c2713v, StringBuilder sb) {
        Long m836e = c2713v.m836e(EnumC2731a.OFFSET_SECONDS);
        if (m836e == null) {
            return false;
        }
    ...
    */
    public int mo882b(p033j$.time.format.C2711t r16, java.lang.CharSequence r17, int r18) {
        /*
            r15 = this;
            r0 = r15
            r7 = r17
            ...
            if (r9 != 0) goto L22
            if (r8 != r1) goto L41
            j$.time.temporal.a r2 = p033j$.time.temporal.EnumC2731a.OFFSET_SECONDS
            r3 = 0
            r1 = r16
            r5 = r18
            r6 = r18
        ...
        L9d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p033j$.time.format.C2703l.mo882b(j$.time.format.t, java.lang.CharSequence, int):int");
    }

    public String toString() {
        String replace = this.f545a.replace("'", "''");
        StringBuilder m961a = AbstractC2676a.m961a("Offset(");
