...
public final class C2730A implements Serializable {
    ...
    private C2730A(long j, long j2, long j3, long j4) {
        this.f621a = j;
        this.f622b = j2;
        this.f623c = j3;
        this.f624d = j4;
    ...
    /* renamed from: c */
    private String m763c(InterfaceC2745o interfaceC2745o, long j) {
        if (interfaceC2745o == null) {
            return "Invalid value (valid values " + this + "): " + j;
        }
        return "Invalid value for " + interfaceC2745o + " (valid values " + this + "): " + j;
    }

    /* renamed from: i */
    public static C2730A m757i(long j, long j2) {
        if (j <= j2) {
            return new C2730A(j, j, j2, j2);
        }
        throw new IllegalArgumentException("Minimum value must be less than maximum value");
    }

    /* renamed from: j */
    public static C2730A m756j(long j, long j2, long j3) {
        if (j <= j) {
            if (j2 <= j3) {
                if (j <= j3) {
                    return new C2730A(j, j, j2, j3);
                }
                throw new IllegalArgumentException("Minimum value must be less than maximum value");
            }
    ...
    /* renamed from: a */
    public int m765a(long j, InterfaceC2745o interfaceC2745o) {
        if (m759g() && m758h(j)) {
            return (int) j;
        }
        throw new DateTimeException(m763c(interfaceC2745o, j));
    }

    /* renamed from: b */
    public long m764b(long j, InterfaceC2745o interfaceC2745o) {
        if (m758h(j)) {
            return j;
        }
        throw new DateTimeException(m763c(interfaceC2745o, j));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof C2730A) {
            ...
            return this.f621a == c2730a.f621a && this.f622b == c2730a.f622b && this.f623c == c2730a.f623c && this.f624d == c2730a.f624d;
        }
        return false;
    }
