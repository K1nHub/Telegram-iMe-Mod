...
public class C2813e implements InterfaceC2826l {
    private long count;
    private long sum;
    ...
    /* renamed from: b */
    public void m619b(C2813e c2813e) {
        this.count += c2813e.count;
        this.sum += c2813e.sum;
        this.min = Math.min(this.min, c2813e.min);
        this.max = Math.max(this.max, c2813e.max);
    }
    ...
    public String toString() {
        ...
        objArr[0] = C2813e.class.getSimpleName();
