...
import p033j$.util.concurrent.InterfaceC2804b;
...
public class DesugarCollections {
    ...
    /* loaded from: classes2.dex */
    public static class C2766a implements Map, Serializable, Map {
        ...
        /* renamed from: a */
        private Set m689a(Set set, Object obj) {
        ...
        public Object computeIfAbsent(Object obj, Function function) {
            ...
            synchronized (this.f683b) {
                try {
                    ...
                    computeIfAbsent = map instanceof Map ? ((Map) map).computeIfAbsent(obj, function) : map instanceof ConcurrentMap ? AbstractC2668d.m995a((ConcurrentMap) map, obj, function) : Map.CC.$default$computeIfAbsent(map, obj, function);
                } catch (Throwable th) {
                    throw th;
                }
            }
        ...
        public Set entrySet() {
            ...
            synchronized (this.f683b) {
                if (this.f685d == null) {
                    this.f685d = m689a(this.f682a.entrySet(), this.f683b);
                }
                set = this.f685d;
            }
            return set;
        ...
        public void forEach(java.util.function.BiConsumer biConsumer) {
            BiConsumer m178a = C3227q.m178a(biConsumer);
            synchronized (this.f683b) {
                Map.EL.forEach(this.f682a, m178a);
            }
        }
        ...
        public Set keySet() {
            ...
            synchronized (this.f683b) {
                if (this.f684c == null) {
                    this.f684c = m689a(this.f682a.keySet(), this.f683b);
                }
                set = this.f684c;
            }
            return set;
        ...
        */
        public java.lang.Object merge(java.lang.Object r5, java.lang.Object r6, p033j$.util.function.BiFunction r7) {
            ...
            L48:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p033j$.util.DesugarCollections.C2766a.merge(java.lang.Object, java.lang.Object, j$.util.function.BiFunction):java.lang.Object");
        }
            ...
            synchronized (this.f683b) {
                try {
                    ...
                    if (map instanceof Map) {
                        ...
                        ConcurrentMap concurrentMap = (ConcurrentMap) map;
                        Objects.requireNonNull(biFunction);
                        C2803a c2803a = new C2803a(concurrentMap, biFunction);
                        if (concurrentMap instanceof InterfaceC2804b) {
                            ((InterfaceC2804b) concurrentMap).forEach(c2803a);
                        } else {
                            AbstractC2668d.m994b(concurrentMap, c2803a);
                        }
                    } else {
    ...
    /* renamed from: c */
    public static void m693c(Iterable iterable, Consumer consumer) {
        Field field = f678c;
        if (field == null) {
            try {
                Collection.EL.m699a((java.util.Collection) f679d.get(iterable), consumer);
                return;
            } catch (IllegalAccessException e) {
    ...
    /* renamed from: d */
    public static boolean m692d(java.util.Collection collection, Predicate predicate) {
        boolean removeIf;
        Field field = f678c;
        if (field == null) {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: e */
    public static void m691e(List list, UnaryOperator unaryOperator) {
        Field field = f678c;
        if (field == null) {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: f */
    public static void m690f(java.util.List list, Comparator comparator) {
        Field field = f678c;
        if (field == null) {
            try {
                AbstractC2838k.m591r((java.util.List) f679d.get(list), comparator);
                return;
            } catch (IllegalAccessException e) {
