...
public class C2963T1 implements InterfaceC3119u1 {
    ...
    public void mo340g(Object obj) {
        ...
        for (int i = 0; i < this.f979b; i++) {
            interfaceC2817f.accept(this.f978a[i]);
        }
    }
    ...
    public Spliterator.InterfaceC2776d spliterator() {
        return AbstractC2770F.m676j(this.f978a, 0, this.f979b, 1040);
    }
