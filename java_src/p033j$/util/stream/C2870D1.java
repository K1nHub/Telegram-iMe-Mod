...
public class C2870D1 implements InterfaceC2852A1 {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C2870D1(long j, IntFunction intFunction) {
        if (j >= 2147483639) {
    ...
    public Spliterator spliterator() {
        return AbstractC2770F.m673m(this.f849a, 0, this.f850b, 1040);
    }
