...
final class C3172s4 extends AbstractC3094f4 implements InterfaceC2908s.InterfaceC2911c {
    /* JADX INFO: Access modifiers changed from: package-private */
    public C3172s4(AbstractC3206y2 abstractC3206y2, InterfaceC2894y interfaceC2894y, boolean z) {
        super(abstractC3206y2, interfaceC2894y, z);
    }

    C3172s4(AbstractC3206y2 abstractC3206y2, InterfaceC2908s interfaceC2908s, boolean z) {
    ...
    public void forEachRemaining(InterfaceC2886q interfaceC2886q) {
        if (this.f1039h != null || this.f1040i) {
            do {
            } while (tryAdvance(interfaceC2886q));
            return;
        }
        Objects.requireNonNull(interfaceC2886q);
        m416h();
        this.f1033b.mo306u0(new C3166r4(interfaceC2886q), this.f1035d);
        this.f1040i = true;
    }
    ...
    public boolean tryAdvance(InterfaceC2886q interfaceC2886q) {
        ...
        boolean m418a = m418a();
        if (m418a) {
            C3052Y3 c3052y3 = (C3052Y3) this.f1039h;
            long j = this.f1038g;
            int m477w = c3052y3.m477w(j);
            interfaceC2886q.accept((c3052y3.f1019c == 0 && m477w == 0) ? ((long[]) c3052y3.f954e)[(int) j] : ((long[][]) c3052y3.f955f)[m477w][(int) (j - c3052y3.f1020d[m477w])]);
        }
        return m418a;
    }
    ...
    /* renamed from: j */
    void mo343j() {
        C3052Y3 c3052y3 = new C3052Y3();
        this.f1039h = c3052y3;
        this.f1036e = this.f1033b.mo305v0(new C3166r4(c3052y3));
