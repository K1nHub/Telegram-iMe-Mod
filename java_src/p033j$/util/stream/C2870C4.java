...
final class C2870C4 extends AbstractC2876D4 implements Spliterator {
    /* JADX INFO: Access modifiers changed from: package-private */
    public C2870C4(Spliterator spliterator, long j, long j2) {
        super(spliterator, j, j2, 0L, Math.min(spliterator.estimateSize(), j2));
    }

    private C2870C4(Spliterator spliterator, long j, long j2, long j3, long j4) {
    ...
    protected Spliterator mo345a(Spliterator spliterator, long j, long j2, long j3, long j4) {
        return new C2870C4(spliterator, j, j2, j3, j4);
    }
    ...
    public boolean mo179b(Consumer consumer) {
        ...
        while (true) {
            ...
            this.f856c.mo179b(new Consumer() { // from class: j$.util.stream.B4
        ...
        this.f857d = j + 1;
        return this.f856c.mo179b(consumer);
    }
    ...
    public void forEachRemaining(Consumer consumer) {
        ...
        while (this.f854a > this.f857d) {
            this.f856c.mo179b(new Consumer() { // from class: j$.util.stream.A4
                @Override // p033j$.util.function.Consumer
                public final void accept(Object obj) {
                }
