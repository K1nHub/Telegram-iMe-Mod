...
final class C3110s4 extends AbstractC3032f4 implements Spliterator.InterfaceC2775c {
    C3110s4(AbstractC3144y2 abstractC3144y2, Spliterator spliterator, boolean z) {
        super(abstractC3144y2, spliterator, z);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C3110s4(AbstractC3144y2 abstractC3144y2, InterfaceC2835x interfaceC2835x, boolean z) {
    ...
    public void forEachRemaining(InterfaceC2827p interfaceC2827p) {
        if (this.f1088h != null || this.f1089i) {
            do {
            } while (tryAdvance(interfaceC2827p));
            return;
        }
        Objects.requireNonNull(interfaceC2827p);
        m462h();
        this.f1082b.mo352t0(new C3104r4(interfaceC2827p), this.f1084d);
        this.f1089i = true;
    }
    ...
    public boolean tryAdvance(InterfaceC2827p interfaceC2827p) {
        ...
        boolean m464a = m464a();
        if (m464a) {
            C2990Y3 c2990y3 = (C2990Y3) this.f1088h;
            long j = this.f1087g;
            int m524v = c2990y3.m524v(j);
            interfaceC2827p.accept((c2990y3.f1068c == 0 && m524v == 0) ? ((long[]) c2990y3.f1003e)[(int) j] : ((long[][]) c2990y3.f1004f)[m524v][(int) (j - c2990y3.f1069d[m524v])]);
        }
        return m464a;
    }
    ...
    /* renamed from: j */
    void mo389j() {
        C2990Y3 c2990y3 = new C2990Y3();
        this.f1088h = c2990y3;
        this.f1085e = this.f1082b.mo351u0(new C3104r4(c2990y3));
