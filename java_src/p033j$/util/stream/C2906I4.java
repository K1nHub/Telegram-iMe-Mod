...
final class C2906I4 extends AbstractC2912J4 implements Spliterator, Consumer {

    /* renamed from: e */
    Object f899e;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2906I4(Spliterator spliterator, long j, long j2) {
        super(spliterator, j, j2);
    }

    C2906I4(Spliterator spliterator, C2906I4 c2906i4) {
        super(spliterator, c2906i4);
    }
    ...
    public void forEachRemaining(Consumer consumer) {
        ...
        while (true) {
            ...
            if (m562r == 2) {
                if (c3065k4 == null) {
                    c3065k4 = new C3065k4(128);
                } else {
                    c3065k4.f1128a = 0;
                }
                long j = 0;
                while (this.f906a.mo179b(c3065k4)) {
                    j++;
                    if (j >= 128) {
                        break;
                    }
                ...
                for (int i = 0; i < m564p; i++) {
                    consumer.accept(c3065k4.f1121b[i]);
                }
            } else {
    ...
    protected Spliterator mo563q(Spliterator spliterator) {
        return new C2906I4(spliterator, this);
    }
}
