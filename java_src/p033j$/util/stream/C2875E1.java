...
final class C2875E1 implements InterfaceC2851A1 {

    /* renamed from: a */
    private final Collection f861a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2875E1(Collection collection) {
    ...
    public void forEach(Consumer consumer) {
        Collection.EL.m695a(this.f861a, consumer);
    }
    ...
    public Spliterator spliterator() {
        java.util.Collection collection = this.f861a;
        return (collection instanceof p033j$.util.Collection ? ((p033j$.util.Collection) collection).stream() : AbstractC3082o1.m398y(Collection.EL.m694b(collection), false)).spliterator();
    }
