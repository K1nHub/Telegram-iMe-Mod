...
public class C2960S3 implements Spliterator {
    ...
    /* renamed from: f */
    final /* synthetic */ C3002a4 f976f;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2960S3(C3002a4 c3002a4, int i, int i2, int i3, int i4) {
        this.f976f = c3002a4;
        this.f971a = i;
        this.f972b = i2;
        this.f973c = i3;
        ...
        this.f975e = objArr == null ? c3002a4.f1015e : objArr[i];
    }
    ...
    public Spliterator trySplit() {
        ...
        int i2 = this.f972b;
        if (i < i2) {
            C3002a4 c3002a4 = this.f976f;
            int i3 = i2 - 1;
            C2960S3 c2960s3 = new C2960S3(c3002a4, i, i3, this.f973c, c3002a4.f1016f[i3].length);
            int i4 = this.f972b;
            this.f971a = i4;
            this.f973c = 0;
            ...
            Spliterator m673m = AbstractC2770F.m673m(this.f975e, i6, i6 + i7, 1040);
            this.f973c += i7;
            return m673m;
        } else {
            return null;
