...
final class C2866C4 extends AbstractC2872D4 implements Spliterator {
    /* JADX INFO: Access modifiers changed from: package-private */
    public C2866C4(Spliterator spliterator, long j, long j2) {
        super(spliterator, j, j2, 0L, Math.min(spliterator.estimateSize(), j2));
    }

    private C2866C4(Spliterator spliterator, long j, long j2, long j3, long j4) {
    ...
    protected Spliterator mo344a(Spliterator spliterator, long j, long j2, long j3, long j4) {
        return new C2866C4(spliterator, j, j2, j3, j4);
    }
    ...
    public boolean mo178b(Consumer consumer) {
        ...
        while (true) {
            ...
            this.f856c.mo178b(new Consumer() { // from class: j$.util.stream.B4
        ...
        this.f857d = j + 1;
        return this.f856c.mo178b(consumer);
    }
    ...
    public void forEachRemaining(Consumer consumer) {
        ...
        while (this.f854a > this.f857d) {
            this.f856c.mo178b(new Consumer() { // from class: j$.util.stream.A4
                @Override // p033j$.util.function.Consumer
                public final void accept(Object obj) {
                }
