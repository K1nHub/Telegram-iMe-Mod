...
public class C3066l2 implements InterfaceC3143y1 {
    ...
    public void mo340g(Object obj) {
        ...
        for (int i = 0; i < this.f1127b; i++) {
            interfaceC2827p.accept(this.f1126a[i]);
        }
    }
    ...
    public Spliterator.InterfaceC2776d spliterator() {
        return AbstractC2770F.m674l(this.f1126a, 0, this.f1127b, 1040);
    }
