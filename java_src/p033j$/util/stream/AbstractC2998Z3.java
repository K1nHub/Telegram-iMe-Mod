...
public abstract class AbstractC2998Z3 extends AbstractC3024e implements Iterable, InterfaceC2674e {
    ...
    /* loaded from: classes2.dex */
    abstract class AbstractC2999a implements Spliterator.InterfaceC2779d {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public AbstractC2999a(int i, int i2, int i3, int i4) {
            this.f1005a = i;
            this.f1006b = i2;
            this.f1007c = i3;
            this.f1008d = i4;
            Object[] objArr = AbstractC2998Z3.this.f1004f;
            this.f1009e = objArr == null ? AbstractC2998Z3.this.f1003e : objArr[i];
        }
        ...
        public long estimateSize() {
            ...
            long[] jArr = AbstractC2998Z3.this.f1069d;
            return ((jArr[i2] + this.f1008d) - jArr[i]) - this.f1007c;
        }

        /* renamed from: f */
        abstract Spliterator.InterfaceC2779d mo515f(Object obj, int i, int i2);
        ...
        public void m516e(Object obj) {
            ...
            if (i2 < i3 || (i2 == i3 && this.f1007c < this.f1008d)) {
                ...
                while (true) {
                    ...
                    AbstractC2998Z3 abstractC2998Z3 = AbstractC2998Z3.this;
                    Object obj2 = abstractC2998Z3.f1004f[i2];
                    abstractC2998Z3.mo527s(obj2, i4, abstractC2998Z3.mo526t(obj2), obj);
                    i4 = 0;
                    i2++;
                }
                AbstractC2998Z3.this.mo527s(this.f1005a == i ? this.f1009e : AbstractC2998Z3.this.f1004f[i], i4, this.f1008d, obj);
        ...
        /* renamed from: h */
        abstract Spliterator.InterfaceC2779d mo513h(int i, int i2, int i3, int i4);
        ...
        public boolean m511n(Object obj) {
            ...
            if (i < i2 || (i == i2 && this.f1007c < this.f1008d)) {
                ...
                this.f1007c = i3 + 1;
                mo519a(obj2, i3, obj);
                if (this.f1007c == AbstractC2998Z3.this.mo526t(this.f1009e)) {
                    this.f1007c = 0;
        ...
        @Override // p033j$.util.Spliterator
        public Spliterator.InterfaceC2779d trySplit() {
            int i = this.f1005a;
            int i2 = this.f1006b;
            if (i < i2) {
                int i3 = this.f1007c;
                AbstractC2998Z3 abstractC2998Z3 = AbstractC2998Z3.this;
                Spliterator.InterfaceC2779d mo513h = mo513h(i, i2 - 1, i3, abstractC2998Z3.mo526t(abstractC2998Z3.f1004f[i2 - 1]));
                int i4 = this.f1006b;
                this.f1005a = i4;
                this.f1007c = 0;
                this.f1009e = AbstractC2998Z3.this.f1004f[i4];
                return mo513h;
            } else if (i == i2) {
                int i5 = this.f1008d;
                int i6 = this.f1007c;
                ...
                Spliterator.InterfaceC2779d mo515f = mo515f(this.f1009e, i6, i7);
                this.f1007c += i7;
                return mo515f;
            } else {
                return null;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractC2998Z3() {
        this.f1003e = mo528c(16);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractC2998Z3(int i) {
        super(i);
    ...
    @Override // p033j$.util.stream.AbstractC3024e
    public void clear() {
