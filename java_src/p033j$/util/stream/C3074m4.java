...
final class C3074m4 implements Spliterator, Consumer {
    ...
    public C3074m4(Spliterator spliterator) {
        ConcurrentHashMap concurrentHashMap = new ConcurrentHashMap();
        this.f1133a = spliterator;
        this.f1134b = concurrentHashMap;
    }

    private C3074m4(Spliterator spliterator, ConcurrentHashMap concurrentHashMap) {
        this.f1133a = spliterator;
        this.f1134b = concurrentHashMap;
    }
    ...
    public void forEachRemaining(Consumer consumer) {
        this.f1133a.forEachRemaining(new C3081o(this, consumer));
    }
    ...
    public Spliterator trySplit() {
        ...
        if (trySplit != null) {
            return new C3074m4(trySplit, this.f1134b);
        }
        return null;
    }
}
