...
final class C3077m4 implements Spliterator, Consumer {
    ...
    public C3077m4(Spliterator spliterator) {
        ConcurrentHashMap concurrentHashMap = new ConcurrentHashMap();
        this.f1133a = spliterator;
        this.f1134b = concurrentHashMap;
    }

    private C3077m4(Spliterator spliterator, ConcurrentHashMap concurrentHashMap) {
        this.f1133a = spliterator;
        this.f1134b = concurrentHashMap;
    }
    ...
    /* renamed from: f */
    public void m432f(Consumer consumer, Object obj) {
    ...
    public void forEachRemaining(Consumer consumer) {
        this.f1133a.forEachRemaining(new C3084o(this, consumer));
    }
    ...
    public Spliterator trySplit() {
        ...
        if (trySplit != null) {
            return new C3077m4(trySplit, this.f1134b);
        }
        return null;
    }
}
