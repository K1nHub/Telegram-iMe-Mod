...
public class C3015c2 implements InterfaceC3134w1 {
    ...
    public void mo340g(Object obj) {
        ...
        for (int i = 0; i < this.f1034b; i++) {
            interfaceC2826l.accept(this.f1033a[i]);
        }
    }
    ...
    public Spliterator.InterfaceC2779d spliterator() {
        return AbstractC2773F.m675k(this.f1033a, 0, this.f1034b, 1040);
    }
