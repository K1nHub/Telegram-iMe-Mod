...
final class C3098q4 extends AbstractC3032f4 implements Spliterator.InterfaceC2774b {
    C3098q4(AbstractC3144y2 abstractC3144y2, Spliterator spliterator, boolean z) {
        super(abstractC3144y2, spliterator, z);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C3098q4(AbstractC3144y2 abstractC3144y2, InterfaceC2835x interfaceC2835x, boolean z) {
    ...
    public void forEachRemaining(InterfaceC2823l interfaceC2823l) {
        if (this.f1088h != null || this.f1089i) {
            do {
            } while (tryAdvance(interfaceC2823l));
            return;
        }
        Objects.requireNonNull(interfaceC2823l);
        m462h();
        this.f1082b.mo352t0(new C3092p4(interfaceC2823l), this.f1084d);
        this.f1089i = true;
    }
    ...
    public boolean tryAdvance(InterfaceC2823l interfaceC2823l) {
        ...
        boolean m464a = m464a();
        if (m464a) {
            C2980W3 c2980w3 = (C2980W3) this.f1088h;
            long j = this.f1087g;
            int m524v = c2980w3.m524v(j);
            interfaceC2823l.accept((c2980w3.f1068c == 0 && m524v == 0) ? ((int[]) c2980w3.f1003e)[(int) j] : ((int[][]) c2980w3.f1004f)[m524v][(int) (j - c2980w3.f1069d[m524v])]);
        }
        return m464a;
    }
    ...
    /* renamed from: j */
    void mo389j() {
        C2980W3 c2980w3 = new C2980W3();
        this.f1088h = c2980w3;
        this.f1085e = this.f1082b.mo351u0(new C3092p4(c2980w3));
