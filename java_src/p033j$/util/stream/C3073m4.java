...
final class C3073m4 implements Spliterator, Consumer {
    ...
    public C3073m4(Spliterator spliterator) {
        ConcurrentHashMap concurrentHashMap = new ConcurrentHashMap();
        this.f1133a = spliterator;
        this.f1134b = concurrentHashMap;
    }

    private C3073m4(Spliterator spliterator, ConcurrentHashMap concurrentHashMap) {
        this.f1133a = spliterator;
        this.f1134b = concurrentHashMap;
    }
    ...
    /* renamed from: f */
    public void m431f(Consumer consumer, Object obj) {
    ...
    public void forEachRemaining(Consumer consumer) {
        this.f1133a.forEachRemaining(new C3080o(this, consumer));
    }
    ...
    public Spliterator trySplit() {
        ...
        if (trySplit != null) {
            return new C3073m4(trySplit, this.f1134b);
        }
        return null;
    }
}
