...
public class C2997Y3 extends AbstractC3002Z3 implements InterfaceC2831q {
    ...
    public InterfaceC2853s.InterfaceC2856c spliterator() {
        return new C2992X3(this, 0, this.f1018c, 0, this.f1017b);
    }
    ...
    public void forEach(Consumer consumer) {
        if (consumer instanceof InterfaceC2831q) {
            mo294g((InterfaceC2831q) consumer);
        } else if (AbstractC2958Q4.f913a) {
            AbstractC2958Q4.m500a(getClass(), "{0} calling SpinedBuffer.OfLong.forEach(Consumer)");
            throw null;
        } else {
    ...
    public String toString() {
        ...
        return jArr.length < 200 ? String.format("%s[length=%d, chunks=%d]%s", getClass().getSimpleName(), Integer.valueOf(jArr.length), Integer.valueOf(this.f1018c), Arrays.toString(jArr)) : String.format("%s[length=%d, chunks=%d]%s...", getClass().getSimpleName(), Integer.valueOf(jArr.length), Integer.valueOf(this.f1018c), Arrays.toString(Arrays.copyOf(jArr, 200)));
    }
