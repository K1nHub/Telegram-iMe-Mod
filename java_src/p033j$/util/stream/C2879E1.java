...
final class C2879E1 implements InterfaceC2855A1 {

    /* renamed from: a */
    private final Collection f861a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C2879E1(Collection collection) {
    ...
    public Spliterator spliterator() {
        java.util.Collection collection = this.f861a;
        return (collection instanceof p033j$.util.Collection ? ((p033j$.util.Collection) collection).stream() : AbstractC3086o1.m399y(Collection.EL.m695b(collection), false)).spliterator();
    }
