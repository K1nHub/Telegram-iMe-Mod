...
public final /* synthetic */ class C2811a implements InterfaceC2812b, Predicate {
    ...
    public /* synthetic */ C2811a(Predicate predicate) {
        this.f782a = 2;
    ...
    public /* synthetic */ C2811a(Comparator comparator, int i) {
        this.f782a = i;
        if (i != 1) {
