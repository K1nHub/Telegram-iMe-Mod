...
public final /* synthetic */ class C2812a implements InterfaceC2813b, Predicate {
    ...
    public /* synthetic */ C2812a(Predicate predicate) {
        this.f782a = 2;
    ...
    public /* synthetic */ C2812a(Comparator comparator, int i) {
        this.f782a = i;
        if (i != 1) {
