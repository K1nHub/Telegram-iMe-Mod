...
public class C2895g implements InterfaceC2881l {
    private long count;
    private long sum;
    ...
    /* renamed from: b */
    public void m555b(C2895g c2895g) {
        this.count += c2895g.count;
        this.sum += c2895g.sum;
        this.min = Math.min(this.min, c2895g.min);
        this.max = Math.max(this.max, c2895g.max);
    }
    ...
    public String toString() {
        ...
        objArr[0] = C2895g.class.getSimpleName();
