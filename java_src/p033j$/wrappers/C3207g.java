...
public final /* synthetic */ class C3207g implements Spliterator {

    /* renamed from: a */
    final /* synthetic */ java.util.Spliterator f1311a;

    private /* synthetic */ C3207g(java.util.Spliterator spliterator) {
        this.f1311a = spliterator;
    }

    /* renamed from: a */
    public static /* synthetic */ Spliterator m208a(java.util.Spliterator spliterator) {
        if (spliterator == null) {
            return null;
        }
        return spliterator instanceof C3209h ? ((C3209h) spliterator).f1313a : new C3207g(spliterator);
    }
    ...
    public /* synthetic */ Spliterator trySplit() {
        return m208a(this.f1311a.trySplit());
    }
}
