...
public final /* synthetic */ class C$r8$wrapper$java$util$function$Function$VWRP implements Function {
    ...
    public static /* synthetic */ Function convert(java.util.function.Function function) {
        ...
        return function instanceof C3178K ? ((C3178K) function).f1282a : new C$r8$wrapper$java$util$function$Function$VWRP(function);
    }

    @Override // p033j$.util.function.Function
    public /* synthetic */ Function andThen(Function function) {
        return convert(this.f1256a.andThen(C3178K.m244a(function)));
    }
    ...
    public /* synthetic */ Function compose(Function function) {
        return convert(this.f1256a.compose(C3178K.m244a(function)));
    }
}
