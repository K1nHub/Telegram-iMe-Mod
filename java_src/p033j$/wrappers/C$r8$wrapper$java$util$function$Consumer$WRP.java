...
public final /* synthetic */ class C$r8$wrapper$java$util$function$Consumer$WRP implements Consumer {
    ...
    public static /* synthetic */ Consumer convert(p033j$.util.function.Consumer consumer) {
        ...
        return consumer instanceof C3251w ? ((C3251w) consumer).f1295a : new C$r8$wrapper$java$util$function$Consumer$WRP(consumer);
    }

    @Override // java.util.function.Consumer
    public /* synthetic */ void accept(Object obj) {
        this.f1207a.accept(obj);
    }

    @Override // java.util.function.Consumer
    public /* synthetic */ Consumer andThen(Consumer consumer) {
        return convert(this.f1207a.andThen(C3251w.m94b(consumer)));
    }
}
