...
public final /* synthetic */ class C3208g implements Spliterator {

    /* renamed from: a */
    final /* synthetic */ java.util.Spliterator f1311a;

    private /* synthetic */ C3208g(java.util.Spliterator spliterator) {
        this.f1311a = spliterator;
    }

    /* renamed from: a */
    public static /* synthetic */ Spliterator m204a(java.util.Spliterator spliterator) {
        if (spliterator == null) {
            return null;
        }
        return spliterator instanceof C3210h ? ((C3210h) spliterator).f1313a : new C3208g(spliterator);
    }
    ...
    public /* synthetic */ Spliterator trySplit() {
        return m204a(this.f1311a.trySplit());
    }
}
