...
public final /* synthetic */ class C3186L0 implements Stream {

    /* renamed from: a */
    final /* synthetic */ p033j$.util.stream.Stream f1285a;

    private /* synthetic */ C3186L0(p033j$.util.stream.Stream stream) {
        this.f1285a = stream;
    }
    ...
    public static /* synthetic */ Stream m238m0(p033j$.util.stream.Stream stream) {
        ...
        return stream instanceof C$r8$wrapper$java$util$stream$Stream$VWRP ? ((C$r8$wrapper$java$util$stream$Stream$VWRP) stream).f1261a : new C3186L0(stream);
    }
    ...
    public /* synthetic */ Object collect(Supplier supplier, BiConsumer biConsumer, BiConsumer biConsumer2) {
        return this.f1285a.mo304i(C3243v0.m164a(supplier), C3232q.m175a(biConsumer), C3232q.m175a(biConsumer2));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ Object collect(Collector collector) {
        return this.f1285a.mo309a0(C3174F0.m282d(collector));
    }
    ...
    public /* synthetic */ Optional findAny() {
        return AbstractC2843k.m593m(this.f1285a.findAny());
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ Optional findFirst() {
        return AbstractC2843k.m593m(this.f1285a.findFirst());
    }
    ...
    public /* synthetic */ DoubleStream flatMapToDouble(Function function) {
        return C3180I0.m259m0(this.f1285a.mo315D(C$r8$wrapper$java$util$function$Function$VWRP.convert(function)));
    }
    ...
    public /* synthetic */ LongStream flatMapToLong(Function function) {
        return C3184K0.m240m0(this.f1285a.mo311W(C$r8$wrapper$java$util$function$Function$VWRP.convert(function)));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ void forEach(Consumer consumer) {
        this.f1285a.forEach(C3242v.m165b(consumer));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ void forEachOrdered(Consumer consumer) {
        this.f1285a.mo306e(C3242v.m165b(consumer));
    }
    ...
    public /* synthetic */ DoubleStream mapToDouble(ToDoubleFunction toDoubleFunction) {
        return C3180I0.m259m0(this.f1285a.mo303i0(C3247x0.m160a(toDoubleFunction)));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ IntStream mapToInt(ToIntFunction toIntFunction) {
        return C$r8$wrapper$java$util$stream$IntStream$WRP.convert(this.f1285a.mo302l(C3251z0.m155a(toIntFunction)));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ LongStream mapToLong(ToLongFunction toLongFunction) {
        return C3184K0.m240m0(this.f1285a.mo305f0(C3166B0.m294a(toLongFunction)));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ Optional max(Comparator comparator) {
        return AbstractC2843k.m593m(this.f1285a.max(comparator));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ Optional min(Comparator comparator) {
        return AbstractC2843k.m593m(this.f1285a.min(comparator));
    }
    ...
    public /* synthetic */ BaseStream onClose(Runnable runnable) {
        return C3172E0.m286m0(this.f1285a.onClose(runnable));
    }

    @Override // java.util.stream.BaseStream
    public /* synthetic */ BaseStream parallel() {
        return C3172E0.m286m0(this.f1285a.parallel());
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ Stream peek(Consumer consumer) {
        return m238m0(this.f1285a.mo313U(C3242v.m165b(consumer)));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ Object reduce(Object obj, BiFunction biFunction, BinaryOperator binaryOperator) {
        return this.f1285a.mo316A(obj, C$r8$wrapper$java$util$function$BiFunction$VWRP.convert(biFunction), C3238t.m169a(binaryOperator));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ Object reduce(Object obj, BinaryOperator binaryOperator) {
        return this.f1285a.mo301l0(obj, C3238t.m169a(binaryOperator));
    }

    @Override // java.util.stream.Stream
    public /* synthetic */ Optional reduce(BinaryOperator binaryOperator) {
        return AbstractC2843k.m593m(this.f1285a.mo298s(C3238t.m169a(binaryOperator)));
    }

    @Override // java.util.stream.BaseStream
    public /* synthetic */ BaseStream sequential() {
        return C3172E0.m286m0(this.f1285a.sequential());
    }
    ...
    public /* synthetic */ Spliterator spliterator() {
        return C3214h.m202a(this.f1285a.spliterator());
    }
    ...
    public /* synthetic */ Object[] toArray(IntFunction intFunction) {
        return this.f1285a.toArray(C3190P.m233a(intFunction));
    }

    @Override // java.util.stream.BaseStream
    public /* synthetic */ BaseStream unordered() {
        return C3172E0.m286m0(this.f1285a.unordered());
    }
}
