...
public final /* synthetic */ class C$r8$wrapper$java$util$function$UnaryOperator$VWRP implements UnaryOperator {
    ...
    public /* synthetic */ Function andThen(Function function) {
        return C$r8$wrapper$java$util$function$Function$VWRP.convert(this.f1258a.andThen(C3178K.m244a(function)));
    }
    ...
    public /* synthetic */ Function compose(Function function) {
        return C$r8$wrapper$java$util$function$Function$VWRP.convert(this.f1258a.compose(C3178K.m244a(function)));
    }
}
