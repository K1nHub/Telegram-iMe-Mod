...
public final /* synthetic */ class C3252w0 implements Predicate {
    ...
    /* renamed from: a */
    final /* synthetic */ java.util.function.Predicate f1299a;

    private /* synthetic */ C3252w0(java.util.function.Predicate predicate) {
        this.f1299a = predicate;
    }
    ...
    public static /* synthetic */ Predicate m111a(java.util.function.Predicate predicate) {
        ...
        return predicate instanceof C3254x0 ? ((C3254x0) predicate).f1301a : new C3252w0(predicate);
    }

    @Override // p033j$.util.function.Predicate
    public /* synthetic */ Predicate and(Predicate predicate) {
        return m111a(this.f1299a.and(C3254x0.m109a(predicate)));
    }

    @Override // p033j$.util.function.Predicate
    public /* synthetic */ Predicate negate() {
        return m111a(this.f1299a.negate());
    }

    @Override // p033j$.util.function.Predicate
    /* renamed from: or */
    public /* synthetic */ Predicate mo25or(Predicate predicate) {
        return m111a(this.f1299a.or(C3254x0.m109a(predicate)));
    }

    @Override // p033j$.util.function.Predicate
    public /* synthetic */ boolean test(Object obj) {
        return this.f1299a.test(obj);
    }
}
