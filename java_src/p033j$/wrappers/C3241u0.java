...
public final /* synthetic */ class C3241u0 implements Predicate {

    /* renamed from: a */
    final /* synthetic */ p033j$.util.function.Predicate f1340a;

    private /* synthetic */ C3241u0(p033j$.util.function.Predicate predicate) {
    ...
    public static /* synthetic */ Predicate m166a(p033j$.util.function.Predicate predicate) {
        ...
        return predicate instanceof C$r8$wrapper$java$util$function$Predicate$VWRP ? ((C$r8$wrapper$java$util$function$Predicate$VWRP) predicate).f1257a : new C3241u0(predicate);
    }
