...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(ComponentDiscovery.forContext(context, ComponentDiscoveryService.class).discoverLazy()).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m740of(context, Context.class, new Class[0])).addComponent(Component.m740of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m740of(firebaseOptions, FirebaseOptions.class, new Class[0])).build();
