...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(ComponentDiscovery.forContext(context, ComponentDiscoveryService.class).discoverLazy()).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m1043of(context, Context.class, new Class[0])).addComponent(Component.m1043of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m1043of(firebaseOptions, FirebaseOptions.class, new Class[0])).build();
