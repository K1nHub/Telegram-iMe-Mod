package com.google.firebase.p021ml.common.modeldownload;
...
public class FirebaseModelManager {
    ...
    public synchronized boolean registerLocalModel(FirebaseLocalModel firebaseLocalModel) {
        ...
        if (this.zzawr.containsKey(firebaseLocalModel.getModelName())) {
            ...
            gmsLogger.m791w("FirebaseModelManager", valueOf.length() != 0 ? "The local model name is already registered: ".concat(valueOf) : new String("The local model name is already registered: "));
            return false;
        }
