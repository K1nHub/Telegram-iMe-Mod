...
public class NotificationParams {
    ...
    public static boolean isNotification(Bundle bundle) {
        return IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(bundle.getString("gcm.n.e")) || IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(bundle.getString(keyWithOldPrefix("gcm.n.e")));
    }
}
