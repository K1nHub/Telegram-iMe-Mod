...
public class FirebaseCrashlytics {
    ...
    public static FirebaseCrashlytics init(FirebaseApp firebaseApp, FirebaseInstallationsApi firebaseInstallationsApi, Deferred<CrashlyticsNativeComponent> deferred, Deferred<AnalyticsConnector> deferred2) {
        ...
        logger.m720i("Initializing Firebase Crashlytics " + CrashlyticsCore.getVersion() + " for " + packageName);
        ...
        logger2.m724d("Mapping file ID is: " + mappingFileId);
        try {
            ...
            logger3.m718v("Installer package name is: " + create.installerPackageName);
            ...
            create2.loadSettingsData(buildSingleThreadExecutorService).continueWith(buildSingleThreadExecutorService, new Continuation<Void, Object>() { // from class: com.google.firebase.crashlytics.FirebaseCrashlytics.1
                ...
                public Object then(Task<Void> task) throws Exception {
                    ...
                    Logger.getLogger().m721e("Error fetching settings.", task.getException());
                    return null;
                }
            });
            ...
            Logger.getLogger().m721e("Error retrieving app package info.", e);
            return null;
        }
    }
    ...
    public void recordException(Throwable th) {
        if (th == null) {
            Logger.getLogger().m716w("A null value was passed to recordException. Ignoring.");
        } else {
