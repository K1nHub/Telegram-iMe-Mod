...
public class AnalyticsDeferredProxy {
    ...
    public /* synthetic */ void lambda$init$2(Provider provider) {
        Logger.getLogger().m1041d("AnalyticsConnector now available.");
        ...
        if (subscribeToAnalyticsEvents(analyticsConnector, crashlyticsAnalyticsListener) != null) {
            Logger.getLogger().m1041d("Registered Firebase Analytics listener.");
        ...
        Logger.getLogger().m1033w("Could not register Firebase Analytics listener; a listener is already registered.");
    }
    ...
    private static AnalyticsConnector.AnalyticsConnectorHandle subscribeToAnalyticsEvents(AnalyticsConnector analyticsConnector, CrashlyticsAnalyticsListener crashlyticsAnalyticsListener) {
        ...
        if (registerAnalyticsConnectorListener == null) {
            Logger.getLogger().m1041d("Could not register AnalyticsConnectorListener with Crashlytics origin.");
            ...
            if (registerAnalyticsConnectorListener != null) {
                Logger.getLogger().m1033w("A new version of the Google Analytics for Firebase SDK is now available. For improved performance and compatibility with Crashlytics, please update to the latest version.");
            }
        }
