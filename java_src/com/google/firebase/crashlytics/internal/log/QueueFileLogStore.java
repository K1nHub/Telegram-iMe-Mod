...
class QueueFileLogStore implements FileLogStore {
    ...
    private LogBytes getLogBytes() {
        if (this.workingFile.exists()) {
            ...
            try {
                this.logFile.forEach(new QueueFile.ElementReader(this) { // from class: com.google.firebase.crashlytics.internal.log.QueueFileLogStore.1
                ...
                Logger.getLogger().m1036e("A problem occurred while reading the Crashlytics log file.", e);
            }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                logger.m1036e("Could not open log file: " + this.workingFile, e);
            }
        }
    }
    ...
    private void doWriteToLog(long j, String str) {
        ...
        try {
            ...
            Logger.getLogger().m1036e("There was a problem writing to the Crashlytics log.", e);
        }
    }
}
