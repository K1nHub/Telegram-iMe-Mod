...
final class C0988xce3d994b extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    private final String file;
    private final int importance;
    private final long offset;

    /* renamed from: pc */
    private final long f244pc;
    private final String symbol;

    private C0988xce3d994b(long j, String str, String str2, long j2, int i) {
        this.f244pc = j;
        this.symbol = str;
        this.file = str2;
        this.offset = j2;
    ...
    public String toString() {
        return "Frame{pc=" + this.f244pc + ", symbol=" + this.symbol + ", file=" + this.file + ", offset=" + this.offset + ", importance=" + this.importance + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame) {
            ...
            return this.f244pc == frame.getPc() && this.symbol.equals(frame.getSymbol()) && ((str = this.file) != null ? str.equals(frame.getFile()) : frame.getFile() == null) && this.offset == frame.getOffset() && this.importance == frame.getImportance();
        }
        return false;
    }
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame build() {
            ...
            return new C0988xce3d994b(this.f245pc.longValue(), this.symbol, this.file, this.offset.longValue(), this.importance.intValue());
        }
    }
}
