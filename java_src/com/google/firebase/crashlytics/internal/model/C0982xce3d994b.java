...
final class C0982xce3d994b extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    ...
    private C0982xce3d994b(long j, String str, String str2, long j2, int i) {
        this.f244pc = j;
        this.symbol = str;
        this.file = str2;
        this.offset = j2;
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame build() {
            ...
            return new C0982xce3d994b(this.f245pc.longValue(), this.symbol, this.file, this.offset.longValue(), this.importance.intValue());
        }
    }
}
