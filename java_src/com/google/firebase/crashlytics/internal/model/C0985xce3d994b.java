...
final class C0985xce3d994b extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    ...
    private C0985xce3d994b(long j, String str, String str2, long j2, int i) {
        this.f161pc = j;
        this.symbol = str;
        this.file = str2;
        this.offset = j2;
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame build() {
            ...
            return new C0985xce3d994b(this.f162pc.longValue(), this.symbol, this.file, this.offset.longValue(), this.importance.intValue());
        }
    }
}
