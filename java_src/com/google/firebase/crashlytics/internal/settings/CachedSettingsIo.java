...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Logger.getLogger().m738d("Checking for cached settings...");
            ...
            try {
                ...
                if (settingsFile.exists()) {
                    ...
                    try {
                        ...
                        e = e;
                        Logger.getLogger().m735e("Failed to fetch cached settings", e);
                        CommonUtils.closeOrLog(fileInputStream, "Error while closing settings cache file.");
                        return null;
                    }
                } else {
                    Logger.getLogger().m732v("Settings file does not exist.");
                    jSONObject = null;
                }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        ...
        Logger.getLogger().m732v("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                Logger.getLogger().m735e("Failed to cache settings", e);
