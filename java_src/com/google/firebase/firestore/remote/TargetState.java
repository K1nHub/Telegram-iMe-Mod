...
final class TargetState {
    ...
    public TargetChange toTargetChange() {
        ...
        for (Map.Entry<DocumentKey, DocumentViewChange.Type> entry : this.documentChanges.entrySet()) {
            ...
            int i = C10341.f277x33862af7[value.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C10341 {
        ...
        static final /* synthetic */ int[] f277x33862af7;
        ...
        static {
            ...
            try {
                f277x33862af7[DocumentViewChange.Type.MODIFIED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f277x33862af7[DocumentViewChange.Type.REMOVED.ordinal()] = 3;
