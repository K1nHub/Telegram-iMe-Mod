...
public class FirebaseClientGrpcMetadataProvider implements GrpcMetadataProvider {
    ...
    static {
        ...
        Metadata.Key.m1001of("x-firebase-client-log-type", asciiMarshaller);
        Metadata.Key.m1001of("x-firebase-client", asciiMarshaller);
        Metadata.Key.m1001of("x-firebase-gmpid", asciiMarshaller);
    }
