...
public class FirebaseClientGrpcMetadataProvider implements GrpcMetadataProvider {
    ...
    static {
        ...
        HEART_BEAT_HEADER = Metadata.Key.m680of("x-firebase-client-log-type", asciiMarshaller);
        USER_AGENT_HEADER = Metadata.Key.m680of("x-firebase-client", asciiMarshaller);
        GMP_APP_ID_HEADER = Metadata.Key.m680of("x-firebase-gmpid", asciiMarshaller);
    }
