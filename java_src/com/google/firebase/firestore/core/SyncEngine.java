...
public class SyncEngine implements RemoteStore.RemoteStoreCallback {
    ...
    public static /* synthetic */ class C10031 {
        ...
        static final /* synthetic */ int[] f165x84ba890d;
        ...
        static {
            ...
            try {
                f165x84ba890d[LimboDocumentChange.Type.REMOVED.ordinal()] = 2;
    ...
    private void updateTrackedLimboDocuments(List<LimboDocumentChange> list, int i) {
        for (LimboDocumentChange limboDocumentChange : list) {
            int i2 = C10031.f165x84ba890d[limboDocumentChange.getType().ordinal()];
            if (i2 == 1) {
