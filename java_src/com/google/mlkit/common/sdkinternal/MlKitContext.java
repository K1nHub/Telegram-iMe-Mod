...
public class MlKitContext {
    ...
    public static MlKitContext zza(Context context) {
        ...
        synchronized (zza) {
            ...
            ComponentRuntime build = ComponentRuntime.builder(TaskExecutors.MAIN_THREAD).addLazyComponentRegistrars(ComponentDiscovery.forContext(zzb2, MlKitComponentDiscoveryService.class).discoverLazy()).addComponent(Component.m1043of(zzb2, Context.class, new Class[0])).addComponent(Component.m1043of(mlKitContext2, MlKitContext.class, new Class[0])).build();
