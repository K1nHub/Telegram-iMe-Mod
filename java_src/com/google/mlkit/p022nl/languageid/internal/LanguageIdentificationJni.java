package com.google.mlkit.p022nl.languageid.internal;
...
import com.google.mlkit.p022nl.languageid.IdentifiedLanguage;
...
public class LanguageIdentificationJni extends ModelResource {
    ...
    public final String zza(String str, float f) {
        ...
        return nativeIdentifyLanguage(this.zze, str.getBytes(zzb.zza), f);
    }

    public final List<IdentifiedLanguage> zzb(String str, float f) {
        Preconditions.checkState(this.zze != 0);
        return Arrays.asList(nativeIdentifyPossibleLanguages(this.zze, str.getBytes(zzb.zza), f));
    }
