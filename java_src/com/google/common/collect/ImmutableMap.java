...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable, p035j$.util.Map {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m747of() {
        return (ImmutableMap<K, V>) RegularImmutableMap.EMPTY;
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m746of(K k, V v) {
