    ...
    private void setMeasuredDimensionForFlex(int flexDirection, int widthMeasureSpec, int heightMeasureSpec, int childState) {
        ...
        if (mode == Integer.MIN_VALUE) {
            if (size < largestMainSize) {
                childState = View.combineMeasuredStates(childState, ConnectionsManager.FileTypePhoto);
            } else {
    ...
    */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams implements FlexItem {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.mFlexGrow = obtainStyledAttributes.getFloat(R$styleable.FlexboxLayout_Layout_layout_flexGrow, BitmapDescriptorFactory.HUE_RED);
