...
public final class CollapsingTextHelper {
    ...
    private float lineSpacingAdd = BitmapDescriptorFactory.HUE_RED;
    ...
    private void calculateOffsets(float f) {
        ...
        setCollapsedTextBlend(1.0f - lerp(BitmapDescriptorFactory.HUE_RED, 1.0f, 1.0f - f, timeInterpolator));
        setExpandedTextBlend(lerp(1.0f, BitmapDescriptorFactory.HUE_RED, f, timeInterpolator));
    ...
    private float calculateFadeModeTextAlpha(float f) {
        ...
        if (f <= f2) {
            return AnimationUtils.lerp(1.0f, BitmapDescriptorFactory.HUE_RED, this.fadeModeStartFraction, f2, f);
        }
        return AnimationUtils.lerp(BitmapDescriptorFactory.HUE_RED, 1.0f, f2, 1.0f, f);
    }
    ...
    private void drawMultilineTransition(Canvas canvas, float f, float f2) {
        ...
        canvas.drawText(charSequence, 0, charSequence.length(), BitmapDescriptorFactory.HUE_RED, f4, this.textPaint);
        if (this.fadeModeEnabled) {
            return;
        }
        ...
        canvas.drawText(str, 0, Math.min(this.textLayout.getLineEnd(0), str.length()), BitmapDescriptorFactory.HUE_RED, f4, (Paint) this.textPaint);
    }
