...
final class StaticLayoutBuilderCompat {
    ...
    public StaticLayout build() throws StaticLayoutBuilderCompatException {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (f != BitmapDescriptorFactory.HUE_RED || this.lineSpacingMultiplier != 1.0f) {
        ...
        try {
            return (StaticLayout) ((Constructor) Preconditions.checkNotNull(constructor)).newInstance(charSequence, Integer.valueOf(this.start), Integer.valueOf(this.end), this.paint, Integer.valueOf(max), this.alignment, Preconditions.checkNotNull(textDirection), Float.valueOf(1.0f), Float.valueOf((float) BitmapDescriptorFactory.HUE_RED), Boolean.valueOf(this.includePad), null, Integer.valueOf(max), Integer.valueOf(this.maxLines));
        } catch (Exception e) {
