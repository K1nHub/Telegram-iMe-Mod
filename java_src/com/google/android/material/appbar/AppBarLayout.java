    ...
    */
    ...
    public void draw(Canvas canvas) {
        ...
        if (shouldDrawStatusBarForeground()) {
            ...
            canvas.translate(BitmapDescriptorFactory.HUE_RED, -this.currentOffset);
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, t, MathUtils.clamp(i, -t.getTotalScrollRange(), 0), BitmapDescriptorFactory.HUE_RED);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                ...
                if ((pendingAction & 2) != 0) {
                    ...
                    if (z) {
                        animateOffsetTo(coordinatorLayout, t, i4, BitmapDescriptorFactory.HUE_RED);
                    } else {
