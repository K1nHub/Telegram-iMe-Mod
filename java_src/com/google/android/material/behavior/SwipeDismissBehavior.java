...
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.behavior.SwipeDismissBehavior.1
        ...
        public void onViewPositionChanged(View view, int i, int i2, int i3, int i4) {
            ...
            if (f <= width) {
                ...
                view.setAlpha(SwipeDismissBehavior.clamp((float) BitmapDescriptorFactory.HUE_RED, 1.0f - SwipeDismissBehavior.fraction(width, width2, f), 1.0f));
            }
        }
    };
    ...
    public void setStartAlphaSwipeDistance(float f) {
        this.alphaStartSwipeDistance = clamp((float) BitmapDescriptorFactory.HUE_RED, f, 1.0f);
    }

    public void setEndAlphaSwipeDistance(float f) {
        this.alphaEndSwipeDistance = clamp((float) BitmapDescriptorFactory.HUE_RED, f, 1.0f);
    }
