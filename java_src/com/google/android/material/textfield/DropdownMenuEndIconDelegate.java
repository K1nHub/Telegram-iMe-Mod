...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        ...
        MaterialShapeDrawable popUpMaterialShapeDrawable2 = getPopUpMaterialShapeDrawable(BitmapDescriptorFactory.HUE_RED, dimensionPixelOffset, dimensionPixelOffset2, dimensionPixelOffset3);
    ...
    private void initAnimators() {
        this.fadeInAnim = getAlphaAnimator(67, BitmapDescriptorFactory.HUE_RED, 1.0f);
        ValueAnimator alphaAnimator = getAlphaAnimator(50, 1.0f, BitmapDescriptorFactory.HUE_RED);
