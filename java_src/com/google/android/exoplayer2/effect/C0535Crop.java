...
public final class C0535Crop implements MatrixTransformation {
    ...
    public /* synthetic */ SingleFrameGlTextureProcessor toGlTextureProcessor(Context context, boolean z) {
        ...
        create = MatrixTextureProcessor.create(context, ImmutableList.m753of(this), ImmutableList.m754of(), z);
        return create;
    }

    public C0535Crop(float f, float f2, float f3, float f4) {
        boolean z = f2 > f;
