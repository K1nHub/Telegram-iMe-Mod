...
public final class MatrixTextureProcessor extends SingleFrameGlTextureProcessor implements ExternalTextureProcessor {
    ...
    private static final ImmutableList<float[]> NDC_SQUARE = ImmutableList.m750of(new float[]{-1.0f, -1.0f, BitmapDescriptorFactory.HUE_RED, 1.0f}, new float[]{-1.0f, 1.0f, BitmapDescriptorFactory.HUE_RED, 1.0f}, new float[]{1.0f, 1.0f, BitmapDescriptorFactory.HUE_RED, 1.0f}, new float[]{1.0f, -1.0f, BitmapDescriptorFactory.HUE_RED, 1.0f});
