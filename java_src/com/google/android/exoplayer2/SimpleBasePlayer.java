...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    public static final class State {
        ...
        public static final class Builder {
            ...
            public Builder() {
                ...
                this.seekForwardIncrementMs = C0480C.DEFAULT_SEEK_FORWARD_INCREMENT_MS;
                this.maxSeekToPreviousPositionMs = C0480C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
                ...
                this.contentPositionMsSupplier = PositionSupplier.CC.getConstant(C0480C.TIME_UNSET);
                this.adPositionMs = null;
                PositionSupplier positionSupplier = PositionSupplier.ZERO;
                this.adPositionMsSupplier = positionSupplier;
                this.contentBufferedPositionMsSupplier = PositionSupplier.CC.getConstant(C0480C.TIME_UNSET);
        ...
        private State(Builder builder) {
            ...
            PositionSupplier extrapolating = builder.contentPositionMs != null ? (builder.currentAdGroupIndex == -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0 && builder.contentPositionMs.longValue() != C0480C.TIME_UNSET) ? PositionSupplier.CC.getExtrapolating(builder.contentPositionMs.longValue(), builder.playbackParameters.speed) : PositionSupplier.CC.getConstant(builder.contentPositionMs.longValue()) : builder.contentPositionMsSupplier;
    ...
    public static final class MediaItemData {
        ...
        public static final class Builder {
            ...
            public Builder(Object obj) {
                ...
                this.presentationStartTimeMs = C0480C.TIME_UNSET;
                this.windowStartTimeMs = C0480C.TIME_UNSET;
                this.elapsedRealtimeEpochOffsetMs = C0480C.TIME_UNSET;
            ...
            public Builder setDurationUs(long j) {
                Assertions.checkArgument(j == C0480C.TIME_UNSET || j >= 0);
                this.durationUs = j;
                return this;
            }
            ...
            public Builder setPeriods(List<PeriodData> list) {
                ...
                int i = 0;
                while (i < size - 1) {
                    Assertions.checkArgument(list.get(i).durationUs != C0480C.TIME_UNSET, "Periods other than last need a duration");
                    int i2 = i + 1;
        ...
        private MediaItemData(Builder builder) {
            ...
            if (builder.liveConfiguration != null) {
                if (builder.presentationStartTimeMs != C0480C.TIME_UNSET && builder.windowStartTimeMs != C0480C.TIME_UNSET) {
                ...
                Assertions.checkArgument(builder.presentationStartTimeMs == C0480C.TIME_UNSET, "presentationStartTimeMs can only be set if liveConfiguration != null");
                Assertions.checkArgument(builder.windowStartTimeMs == C0480C.TIME_UNSET, "windowStartTimeMs can only be set if liveConfiguration != null");
                Assertions.checkArgument(builder.elapsedRealtimeEpochOffsetMs == C0480C.TIME_UNSET, "elapsedRealtimeEpochOffsetMs can only be set if liveConfiguration != null");
            }
            int size = builder.periods.size();
            if (builder.durationUs != C0480C.TIME_UNSET) {
    ...
    public final void setMediaItems(List<MediaItem> list, boolean z) {
        verifyApplicationThreadAndInitState();
        setMediaItemsInternal(list, z ? -1 : this.state.currentMediaItemIndex, z ? C0480C.TIME_UNSET : this.state.contentPositionMsSupplier.get());
    }
    ...
    private void updateStateAndInformListeners(final State state, boolean z, boolean z2) {
        ...
        if (!state2.timedMetadata.equals(state.timedMetadata) && state.timedMetadata.presentationTimeUs != C0480C.TIME_UNSET) {
    ...
    private static int getPositionDiscontinuityReason(State state, State state2, boolean z, Timeline.Window window, Timeline.Period period) {
        ...
        if (!(uidOfPeriod instanceof PlaceholderUid) || (uidOfPeriod2 instanceof PlaceholderUid)) {
            if (!uidOfPeriod2.equals(uidOfPeriod) || state.currentAdGroupIndex != state2.currentAdGroupIndex || state.currentAdIndexInAdGroup != state2.currentAdIndexInAdGroup) {
                ...
                return (periodOrAdDurationMs == C0480C.TIME_UNSET || currentPeriodOrAdPositionMs < periodOrAdDurationMs) ? 3 : 0;
            }
            ...
            return (periodOrAdDurationMs2 == C0480C.TIME_UNSET || currentPeriodOrAdPositionMs2 < periodOrAdDurationMs2) ? 5 : 0;
        }
        return -1;
    }
    ...
    private static State getStateWithNewPlaylist(State state, List<MediaItemData> list, Timeline.Period period) {
        ...
        long j2 = mediaItemIndexInNewPlaylist == -1 ? C0480C.TIME_UNSET : j;
    ...
    private static State buildStateForNewPosition(State.Builder builder, State state, long j, List<MediaItemData> list, int i, long j2, boolean z) {
        ...
        if (!list.isEmpty() && j2 == C0480C.TIME_UNSET) {
