    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            while (true) {
                ...
                if (uuid.equals(C0483C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add(C0483C.CENC_TYPE_cenc);
                } else if (uuid.equals(C0483C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C0483C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C0483C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C0483C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            Joiner.m1061on(',').appendTo(sb, linkedHashSet);
            sb.append(']');
        }
        ...
        if (format.selectionFlags != 0) {
            ...
            Joiner.m1061on(',').appendTo(sb, arrayList);
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            ...
            sb.append(", roleFlags=[");
            Joiner.m1061on(',').appendTo(sb, arrayList2);
            sb.append("]");
        }
        return sb.toString();
    }
