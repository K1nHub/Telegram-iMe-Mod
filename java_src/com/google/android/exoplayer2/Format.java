...
public final class Format implements Bundleable {
    ...
    public static final class Builder {
        ...
        public Builder setId(int i) {
            this.f101id = Integer.toString(i);
            return this;
        }
    ...
    public String toString() {
        return "Format(" + this.f100id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            while (true) {
                ...
                if (uuid.equals(C0482C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add(C0482C.CENC_TYPE_cenc);
                } else if (uuid.equals(C0482C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C0482C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C0482C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C0482C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            Joiner.m758on(',').appendTo(sb, linkedHashSet);
            sb.append(']');
        }
        ...
        if (format.selectionFlags != 0) {
            ...
            Joiner.m758on(',').appendTo(sb, arrayList);
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            ...
            sb.append(", roleFlags=[");
            Joiner.m758on(',').appendTo(sb, arrayList2);
            sb.append("]");
        }
        return sb.toString();
    }
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f100id);
