        ...
        switch (c) {
            case 0:
                ...
                if (downloadRequest == null) {
                    Log.m818e(TAG, "Ignored ADD_DOWNLOAD: Missing download_request extra");
                    break;
                } else {
            ...
            case 4:
                ...
                if (requirements == null) {
                    Log.m818e(TAG, "Ignored SET_REQUIREMENTS: Missing requirements extra");
                    break;
                } else {
            ...
            case 6:
                if (!((Intent) Assertions.checkNotNull(intent)).hasExtra(KEY_STOP_REASON)) {
                    Log.m818e(TAG, "Ignored SET_STOP_REASON: Missing stop_reason extra");
                    break;
                } else {
            ...
            case '\b':
                if (str == null) {
                    Log.m818e(TAG, "Ignored REMOVE_DOWNLOAD: Missing content_id extra");
                    break;
                } else {
            ...
            default:
                Log.m818e(TAG, "Ignored unrecognized action: " + str2);
                break;
        }
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public boolean updateScheduler() {
            ...
            if (!this.scheduler.getSupportedRequirements(requirements).equals(requirements)) {
                ...
                Log.m814w(DownloadService.TAG, "Failed to schedule restart");
                cancelScheduler();
                return false;
            } else {
                return true;
        ...
        public void onDownloadChanged(DownloadManager downloadManager, Download download, Exception exc) {
            ...
            if (serviceMayNeedRestart() && DownloadService.needsStartedService(download.state)) {
                Log.m814w(DownloadService.TAG, "DownloadService wasn't running. Restarting.");
                restartService();
            }
        }
        ...
        private void restartService() {
            if (this.foregroundAllowed) {
                try {
                    ...
                    Log.m814w(DownloadService.TAG, "Failed to restart (foreground launch restriction)");
                    return;
                }
            }
            try {
                ...
                Log.m814w(DownloadService.TAG, "Failed to restart (process is idle)");
            }
        }
    }
}
