...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public TextRenderer(TextOutput textOutput, Looper looper, SubtitleDecoderFactory subtitleDecoderFactory) {
        ...
        this.finalStreamEndPositionUs = C0468C.TIME_UNSET;
        this.outputStreamOffsetUs = C0468C.TIME_UNSET;
        this.lastRendererPositionUs = C0468C.TIME_UNSET;
    }
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(ImmutableList.m754of(), getPresentationTimeUs(this.lastRendererPositionUs)));
    }
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        Log.m809e(TAG, "Subtitle decoding failed. streamFormat=" + this.streamFormat, subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
