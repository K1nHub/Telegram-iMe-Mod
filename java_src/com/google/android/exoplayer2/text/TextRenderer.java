...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public TextRenderer(TextOutput textOutput, Looper looper, SubtitleDecoderFactory subtitleDecoderFactory) {
        ...
        this.finalStreamEndPositionUs = C0483C.TIME_UNSET;
        this.outputStreamOffsetUs = C0483C.TIME_UNSET;
        this.lastRendererPositionUs = C0483C.TIME_UNSET;
    }
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(ImmutableList.m1057of(), getPresentationTimeUs(this.lastRendererPositionUs)));
    }
