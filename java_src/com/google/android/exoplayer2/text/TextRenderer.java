...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public TextRenderer(TextOutput textOutput, Looper looper, SubtitleDecoderFactory subtitleDecoderFactory) {
        ...
        this.finalStreamEndPositionUs = C0470C.TIME_UNSET;
        this.outputStreamOffsetUs = C0470C.TIME_UNSET;
        this.lastRendererPositionUs = C0470C.TIME_UNSET;
    }
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(ImmutableList.m740of(), getPresentationTimeUs(this.lastRendererPositionUs)));
    }
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        Log.m795e(TAG, "Subtitle decoding failed. streamFormat=" + this.streamFormat, subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
