...
public final class Cea608Decoder extends CeaDecoder {
    ...
    public Cea608Decoder(String str, int i, long j) {
        ...
        if (i == 1) {
            ...
            Log.m806w(TAG, "Invalid channel. Defaulting to CC1.");
            this.selectedChannel = 0;
            this.selectedField = 0;
        }
        setCaptionMode(0);
        ...
        this.lastCueUpdateUs = C0468C.TIME_UNSET;
    }
    ...
    */
    ...
    private boolean shouldClearStuckCaptions() {
        return (this.validDataChannelTimeoutUs == C0468C.TIME_UNSET || this.lastCueUpdateUs == C0468C.TIME_UNSET || getPositionUs() - this.lastCueUpdateUs < this.validDataChannelTimeoutUs) ? false : true;
    }
}
