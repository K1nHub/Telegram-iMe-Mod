...
public final class SsaStyle {
    ...
    public static SsaStyle fromStyleLine(String str, Format format) {
        ...
        int i = format.length;
        if (length != i) {
            Log.m1107w(TAG, Util.formatInvariant("Skipping malformed 'Style:' line (expected %s values, found %s): '%s'", Integer.valueOf(i), Integer.valueOf(split.length), str));
            return null;
        }
        try {
            ...
            Log.m1106w(TAG, "Skipping malformed 'Style:' line: '" + str + "'", e);
            return null;
        }
    }
    ...
    public static int parseAlignment(String str) {
        ...
        Log.m1107w(TAG, "Ignoring unknown alignment: " + str);
        return -1;
    }
    ...
    private static int parseBorderStyle(String str) {
        ...
        Log.m1107w(TAG, "Ignoring unknown BorderStyle: " + str);
        return -1;
    }
    ...
    public static Integer parseColor(String str) {
        ...
        try {
            ...
            Log.m1106w(TAG, "Failed to parse color expression: '" + str + "'", e);
            return null;
        }
    }
    ...
    private static float parseFontSize(String str) {
        try {
            ...
            Log.m1106w(TAG, "Failed to parse font size: '" + str + "'", e);
    ...
    private static boolean parseBooleanValue(String str) {
        try {
            ...
            Log.m1106w(TAG, "Failed to parse boolean value: '" + str + "'", e);
            return false;
        }
    }
    ...
    static final class Overrides {
        ...
        private static PointF parsePosition(String str) {
            ...
            if (find) {
                if (find2) {
                    Log.m1109i(TAG, "Override has both \\pos(x,y) and \\move(x1,y1,x2,y2); using \\pos values. override='" + str + "'");
                }
