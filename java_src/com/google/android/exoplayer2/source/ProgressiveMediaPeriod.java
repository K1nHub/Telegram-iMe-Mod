...
public final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private long pendingResetPositionUs = C0480C.TIME_UNSET;
    ...
    public void onLoadCompleted(ExtractingLoadable extractingLoadable, long j, long j2) {
        SeekMap seekMap;
        if (this.durationUs == C0480C.TIME_UNSET && (seekMap = this.seekMap) != null) {
    ...
    public void lambda$seekMap$1(SeekMap seekMap) {
        this.seekMap = this.icyHeaders == null ? seekMap : new SeekMap.Unseekable(C0480C.TIME_UNSET);
        this.durationUs = seekMap.getDurationUs();
        boolean z = !this.isLengthKnown && seekMap.getDurationUs() == C0480C.TIME_UNSET;
        this.isLive = z;
        this.dataType = z ? 7 : 1;
    ...
    private void startLoading() {
        ...
        if (this.prepared) {
            ...
            if (j != C0480C.TIME_UNSET && this.pendingResetPositionUs > j) {
                this.loadingFinished = true;
                this.pendingResetPositionUs = C0480C.TIME_UNSET;
                return;
            }
    ...
    private boolean configureRetry(ExtractingLoadable extractingLoadable, int i) {
        SeekMap seekMap;
        if (this.isLengthKnown || ((seekMap = this.seekMap) != null && seekMap.getDurationUs() != C0480C.TIME_UNSET)) {
    ...
    private boolean isPendingReset() {
        return this.pendingResetPositionUs != C0480C.TIME_UNSET;
    }
