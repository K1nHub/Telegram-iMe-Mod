...
public final class MaskingMediaSource extends WrappingMediaSource {
    ...
    */
    ...
    public static final class PlaceholderTimeline extends Timeline {
        ...
        @Override // com.google.android.exoplayer2.Timeline
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            window.set(Timeline.Window.SINGLE_WINDOW_UID, this.mediaItem, null, C0485C.TIME_UNSET, C0485C.TIME_UNSET, C0485C.TIME_UNSET, false, true, null, 0L, C0485C.TIME_UNSET, 0, 0, 0L);
        ...
        @Override // com.google.android.exoplayer2.Timeline
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            period.set(z ? 0 : null, z ? MaskingTimeline.MASKING_EXTERNAL_PERIOD_UID : null, 0, C0485C.TIME_UNSET, 0L, AdPlaybackState.NONE, true);
            return period;
        }
