...
public final class MaskingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    private long preparePositionOverrideUs = C0474C.TIME_UNSET;
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        if (j3 == C0474C.TIME_UNSET || j != this.preparePositionUs) {
            j2 = j;
        } else {
            this.preparePositionOverrideUs = C0474C.TIME_UNSET;
            j2 = j3;
        }
    ...
    private long getPreparePositionWithOverride(long j) {
        ...
        return j2 != C0474C.TIME_UNSET ? j2 : j;
    }
}
