    ...
    private void processManifest() {
        ...
        if (j2 == Long.MAX_VALUE) {
            ...
            if (ssManifest2.isLive) {
                ...
                singlePeriodTimeline = new SinglePeriodTimeline((long) C0483C.TIME_UNSET, j6, j5, msToUs, true, true, true, (Object) this.manifest, this.mediaItem);
            } else {
                long j7 = ssManifest2.durationUs;
                long j8 = j7 != C0483C.TIME_UNSET ? j7 : j - j2;
