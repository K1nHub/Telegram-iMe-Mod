...
public class DefaultSsChunkSource implements SsChunkSource {
    ...
    public DefaultSsChunkSource(LoaderErrorThrower loaderErrorThrower, SsManifest ssManifest, int i, ExoTrackSelection exoTrackSelection, DataSource dataSource) {
        ...
        while (i2 < this.chunkExtractors.length) {
            ...
            int i4 = i2;
            this.chunkExtractors[i4] = new BundledChunkExtractor(new FragmentedMp4Extractor(3, null, new Track(indexInTrackGroup, i3, streamElement.timescale, C0483C.TIME_UNSET, ssManifest.durationUs, format, 0, trackEncryptionBoxArr, i3 == 2 ? 4 : 0, null, null)), streamElement.type, format);
            i2 = i4 + 1;
        }
    }
    ...
    private static MediaChunk newMediaChunk(Format format, DataSource dataSource, Uri uri, int i, long j, long j2, long j3, int i2, Object obj, ChunkExtractor chunkExtractor) {
        return new ContainerMediaChunk(dataSource, new DataSpec(uri), format, i2, obj, j, j2, j3, C0483C.TIME_UNSET, i, 1, j, chunkExtractor);
    }
