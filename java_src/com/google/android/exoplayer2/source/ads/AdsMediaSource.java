...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i2 < adMediaSourceHolderArr2[i].length) {
                    ...
                    jArr[i][i2] = adMediaSourceHolder == null ? C0483C.TIME_UNSET : adMediaSourceHolder.getDurationUs();
                    i2++;
                }
            }
            i++;
    ...
    public final class AdMediaSourceHolder {
        ...
        public long getDurationUs() {
            Timeline timeline = this.timeline;
            return timeline == null ? C0483C.TIME_UNSET : timeline.getPeriod(0, AdsMediaSource.this.period).getDurationUs();
        }
