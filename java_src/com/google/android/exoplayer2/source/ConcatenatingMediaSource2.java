...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    public static final class Builder {
        ...
        public Builder add(MediaItem mediaItem) {
            return add(mediaItem, C0479C.TIME_UNSET);
        }
        ...
        public Builder add(MediaSource mediaSource) {
            return add(mediaSource, C0479C.TIME_UNSET);
        }

        public Builder add(MediaSource mediaSource, long j) {
            Assertions.checkNotNull(mediaSource);
            Assertions.checkState(((mediaSource instanceof ProgressiveMediaSource) && j == C0479C.TIME_UNSET) ? false : true, "Progressive media source must define an initial placeholder duration.");
    ...
    public static final class ConcatenatedTimeline extends Timeline {
        ...
        public final Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            return window.set(Timeline.Window.SINGLE_WINDOW_UID, this.mediaItem, this.manifest, C0479C.TIME_UNSET, C0479C.TIME_UNSET, C0479C.TIME_UNSET, this.isSeekable, this.isDynamic, null, this.defaultPositionUs, this.durationUs, 0, getPeriodCount() - 1, -this.periodOffsetsInWindowUs.get(0).longValue());
        }
