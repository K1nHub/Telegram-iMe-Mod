...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    private SinglePeriodTimeline createTimelineForLive(HlsMediaPlaylist hlsMediaPlaylist, long j, long j2, HlsManifest hlsManifest) {
        ...
        return new SinglePeriodTimeline(j, j2, C0480C.TIME_UNSET, j3, hlsMediaPlaylist.durationUs, initialStartTimeUs, getLiveWindowDefaultStartPositionUs(hlsMediaPlaylist, liveEdgeOffsetUs), true, !hlsMediaPlaylist.hasEndTag, hlsMediaPlaylist.playlistType == 2 && hlsMediaPlaylist.hasPositiveStartOffset, hlsManifest, this.mediaItem, this.liveConfiguration);
    }
    ...
    private SinglePeriodTimeline createTimelineForOnDemand(HlsMediaPlaylist hlsMediaPlaylist, long j, long j2, HlsManifest hlsManifest) {
        long j3;
        if (hlsMediaPlaylist.startOffsetUs == C0480C.TIME_UNSET || hlsMediaPlaylist.segments.isEmpty()) {
            j3 = 0;
        } else {
        ...
        return new SinglePeriodTimeline(j, j2, C0480C.TIME_UNSET, j5, j5, 0L, j3, true, false, true, hlsManifest, this.mediaItem, null);
    }
    ...
    */
    ...
    private static long getTargetLiveOffsetUs(HlsMediaPlaylist hlsMediaPlaylist, long j) {
        ...
        if (j3 != C0480C.TIME_UNSET) {
            ...
            if (j4 == C0480C.TIME_UNSET || hlsMediaPlaylist.partTargetDurationUs == C0480C.TIME_UNSET) {
                long j5 = serverControl.holdBackUs;
                j2 = j5 != C0480C.TIME_UNSET ? j5 : hlsMediaPlaylist.targetDurationUs * 3;
            } else {
                j2 = j4;
            }
        }
