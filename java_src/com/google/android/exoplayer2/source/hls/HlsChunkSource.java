...
class HlsChunkSource {
    ...
    private long liveEdgeInPeriodTimeUs = C0485C.TIME_UNSET;
    ...
    public void getNextChunk(long j, long j2, List<HlsMediaChunk> list, boolean z, HlsChunkHolder hlsChunkHolder) {
        ...
        if (hlsMediaChunk != null && !this.independentSegments) {
            ...
            if (resolveTimeToLiveEdgeUs != C0485C.TIME_UNSET) {
    ...
    public boolean onPlaylistError(Uri uri, long j) {
        ...
        this.seenExpectedPlaylistError |= uri.equals(this.expectedPlaylistUrl);
        return j == C0485C.TIME_UNSET || (this.trackSelection.blacklist(indexOf, j) && this.playlistTracker.excludeMediaPlaylist(uri, j));
    }
    ...
    static List<HlsMediaPlaylist.SegmentBase> getSegmentBaseList(HlsMediaPlaylist hlsMediaPlaylist, long j, int i) {
        ...
        if (hlsMediaPlaylist.partTargetDurationUs != C0485C.TIME_UNSET) {
            int i3 = i != -1 ? i : 0;
    ...
    private long resolveTimeToLiveEdgeUs(long j) {
        ...
        return (j2 > C0485C.TIME_UNSET ? 1 : (j2 == C0485C.TIME_UNSET ? 0 : -1)) != 0 ? j2 - j : C0485C.TIME_UNSET;
    }

    private void updateLiveEdgeTimeUs(HlsMediaPlaylist hlsMediaPlaylist) {
        this.liveEdgeInPeriodTimeUs = hlsMediaPlaylist.hasEndTag ? C0485C.TIME_UNSET : hlsMediaPlaylist.getEndTimeUs() - this.playlistTracker.getInitialStartTimeUs();
    }
