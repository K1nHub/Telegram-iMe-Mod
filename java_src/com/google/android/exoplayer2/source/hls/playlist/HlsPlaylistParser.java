...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMultivariantPlaylist hlsMultivariantPlaylist, HlsMediaPlaylist hlsMediaPlaylist, LineIterator lineIterator, String str) throws IOException {
        ...
        HlsMediaPlaylist.ServerControl serverControl = new HlsMediaPlaylist.ServerControl(C0485C.TIME_UNSET, false, C0485C.TIME_UNSET, C0485C.TIME_UNSET, false);
        ...
        int i6 = 1;
        long j14 = C0485C.TIME_UNSET;
        long j15 = C0485C.TIME_UNSET;
        ...
        for (int i16 = i15; i16 < arrayList17.size(); i16++) {
            ...
            if (i17 == -1 && j15 != C0485C.TIME_UNSET) {
    ...
    private static DrmInitData.SchemeData parseDrmSchemeData(String str, String str2, Map<String, String> map) throws ParserException {
        ...
        if (KEYFORMAT_WIDEVINE_PSSH_BINARY.equals(str2)) {
            ...
            return new DrmInitData.SchemeData(C0485C.WIDEVINE_UUID, MimeTypes.VIDEO_MP4, Base64.decode(parseStringAttr.substring(parseStringAttr.indexOf(44)), 0));
        } else if (KEYFORMAT_WIDEVINE_PSSH_JSON.equals(str2)) {
            return new DrmInitData.SchemeData(C0485C.WIDEVINE_UUID, "hls", Util.getUtf8Bytes(str));
        } else {
    ...
    private static String parseEncryptionScheme(String str) {
        return (METHOD_SAMPLE_AES_CENC.equals(str) || METHOD_SAMPLE_AES_CTR.equals(str)) ? C0485C.CENC_TYPE_cenc : C0485C.CENC_TYPE_cbcs;
    }
