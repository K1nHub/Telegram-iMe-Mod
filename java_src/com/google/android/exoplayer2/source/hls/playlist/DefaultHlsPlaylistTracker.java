...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    public DefaultHlsPlaylistTracker(HlsDataSourceFactory hlsDataSourceFactory, LoadErrorHandlingPolicy loadErrorHandlingPolicy, HlsPlaylistParserFactory hlsPlaylistParserFactory, double d) {
        ...
        this.initialStartTimeUs = C0474C.TIME_UNSET;
    }
    ...
    public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2, IOException iOException, int i) {
        ...
        boolean z = retryDelayMsFor == C0474C.TIME_UNSET;
    ...
    public final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (latestPlaylistSnapshot != hlsMediaPlaylist2) {
                ...
                if (hlsMediaPlaylist.mediaSequence + hlsMediaPlaylist.segments.size() < hlsMediaPlaylist3.mediaSequence) {
                    ...
                    playlistStuckException = ((double) (elapsedRealtime - this.lastSnapshotChangeMs)) > ((double) Util.usToMs(hlsMediaPlaylist3.targetDurationUs)) * DefaultHlsPlaylistTracker.this.playlistStuckTargetDurationCoefficient ? new HlsPlaylistTracker.PlaylistStuckException(this.playlistUrl) : null;
                    z = false;
                }
            ...
            if (!((this.playlistSnapshot.partTargetDurationUs != C0474C.TIME_UNSET || this.playlistUrl.equals(DefaultHlsPlaylistTracker.this.primaryMediaPlaylistUrl)) ? true : true) || this.playlistSnapshot.hasEndTag) {
                return;
            }
        ...
        private Uri getMediaPlaylistUriForReload() {
            ...
            if (hlsMediaPlaylist != null) {
                ...
                if (serverControl.skipUntilUs != C0474C.TIME_UNSET || serverControl.canBlockReload) {
                    ...
                    if (hlsMediaPlaylist2.serverControl.canBlockReload) {
                        ...
                        HlsMediaPlaylist hlsMediaPlaylist3 = this.playlistSnapshot;
                        if (hlsMediaPlaylist3.partTargetDurationUs != C0474C.TIME_UNSET) {
                    ...
                    if (serverControl2.skipUntilUs != C0474C.TIME_UNSET) {
