...
public final class RtspClient implements Closeable {
    ...
    private long pendingSeekPositionUs = C0470C.TIME_UNSET;
    ...
    public final class MessageSender {
        ...
        public void sendOptionsRequest(Uri uri, String str) {
            sendRequest(getRequestWithCommonHeaders(4, str, ImmutableMap.m733of(), uri));
        }

        public void sendDescribeRequest(Uri uri, String str) {
            sendRequest(getRequestWithCommonHeaders(2, str, ImmutableMap.m733of(), uri));
        }

        public void sendSetupRequest(Uri uri, String str, String str2) {
            RtspClient.this.rtspState = 0;
            sendRequest(getRequestWithCommonHeaders(10, str2, ImmutableMap.m732of(RtspHeaders.TRANSPORT, str), uri));
        }
        ...
        public void sendPlayRequest(Uri uri, long j, String str) {
            ...
            sendRequest(getRequestWithCommonHeaders(6, str, ImmutableMap.m732of(RtspHeaders.RANGE, RtspSessionTiming.getOffsetStartTimeTiming(j)), uri));
        }
        ...
        public void sendTeardownRequest(Uri uri, String str) {
            ...
            RtspClient.this.rtspState = 0;
            sendRequest(getRequestWithCommonHeaders(12, str, ImmutableMap.m733of(), uri));
        }

        public void sendPauseRequest(Uri uri, String str) {
            Assertions.checkState(RtspClient.this.rtspState == 2);
            sendRequest(getRequestWithCommonHeaders(5, str, ImmutableMap.m733of(), uri));
    ...
    public final class MessageListener implements RtspMessageChannel.MessageListener {
        ...
        private void handleRtspResponse(List<String> list) {
            ...
            ImmutableList<RtspTrackTiming> m740of;
                ...
                switch (i) {
                    ...
                    case 6:
                        ...
                        try {
                            ...
                            if (str3 != null) {
                                m740of = RtspTrackTiming.parseTrackTiming(str3, RtspClient.this.uri);
                            } else {
                        ...
                        onPlayResponseReceived(new RtspPlayResponse(parseResponse.status, parseTiming, m740of));
                        return;
                    case 10:
        ...
        private void onPlayResponseReceived(RtspPlayResponse rtspPlayResponse) {
            ...
            RtspClient.this.pendingSeekPositionUs = C0470C.TIME_UNSET;
        ...
        private void onPauseResponseReceived() {
            ...
            if (RtspClient.this.pendingSeekPositionUs != C0470C.TIME_UNSET) {
                RtspClient rtspClient = RtspClient.this;
