...
public final class RtspClient implements Closeable {
    ...
    public final class MessageSender {
        ...
        public void sendOptionsRequest(Uri uri, String str) {
            sendRequest(getRequestWithCommonHeaders(4, str, ImmutableMap.m737of(), uri));
        }

        public void sendDescribeRequest(Uri uri, String str) {
            sendRequest(getRequestWithCommonHeaders(2, str, ImmutableMap.m737of(), uri));
        }

        public void sendSetupRequest(Uri uri, String str, String str2) {
            RtspClient.this.rtspState = 0;
            sendRequest(getRequestWithCommonHeaders(10, str2, ImmutableMap.m736of(RtspHeaders.TRANSPORT, str), uri));
        }
        ...
        public void sendPlayRequest(Uri uri, long j, String str) {
            ...
            sendRequest(getRequestWithCommonHeaders(6, str, ImmutableMap.m736of(RtspHeaders.RANGE, RtspSessionTiming.getOffsetStartTimeTiming(j)), uri));
        }
        ...
        public void sendTeardownRequest(Uri uri, String str) {
            ...
            RtspClient.this.rtspState = 0;
            sendRequest(getRequestWithCommonHeaders(12, str, ImmutableMap.m737of(), uri));
        }

        public void sendPauseRequest(Uri uri, String str) {
            Assertions.checkState(RtspClient.this.rtspState == 2);
            sendRequest(getRequestWithCommonHeaders(5, str, ImmutableMap.m737of(), uri));
    ...
    public final class MessageListener implements RtspMessageChannel.MessageListener {
        ...
        private void handleRtspResponse(List<String> list) {
            ...
            ImmutableList<RtspTrackTiming> m744of;
                ...
                switch (i) {
                    ...
                    case 6:
                        ...
                        try {
                            ...
                            if (str3 != null) {
                                m744of = RtspTrackTiming.parseTrackTiming(str3, RtspClient.this.uri);
                            } else {
                        ...
                        onPlayResponseReceived(new RtspPlayResponse(parseResponse.status, parseTiming, m744of));
                        return;
                    case 10:
