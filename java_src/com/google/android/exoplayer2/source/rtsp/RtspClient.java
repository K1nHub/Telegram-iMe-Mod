...
public final class RtspClient implements Closeable {
    ...
    private long pendingSeekPositionUs = C0483C.TIME_UNSET;
    ...
    public final class MessageSender {
        ...
        public void sendOptionsRequest(Uri uri, String str) {
            sendRequest(getRequestWithCommonHeaders(4, str, ImmutableMap.m1050of(), uri));
        }

        public void sendDescribeRequest(Uri uri, String str) {
            sendRequest(getRequestWithCommonHeaders(2, str, ImmutableMap.m1050of(), uri));
        }

        public void sendSetupRequest(Uri uri, String str, String str2) {
            RtspClient.this.rtspState = 0;
            sendRequest(getRequestWithCommonHeaders(10, str2, ImmutableMap.m1049of(RtspHeaders.TRANSPORT, str), uri));
        }
        ...
        public void sendPlayRequest(Uri uri, long j, String str) {
            ...
            sendRequest(getRequestWithCommonHeaders(6, str, ImmutableMap.m1049of(RtspHeaders.RANGE, RtspSessionTiming.getOffsetStartTimeTiming(j)), uri));
        }
        ...
        public void sendTeardownRequest(Uri uri, String str) {
            ...
            RtspClient.this.rtspState = 0;
            sendRequest(getRequestWithCommonHeaders(12, str, ImmutableMap.m1050of(), uri));
        }

        public void sendPauseRequest(Uri uri, String str) {
            Assertions.checkState(RtspClient.this.rtspState == 2);
            sendRequest(getRequestWithCommonHeaders(5, str, ImmutableMap.m1050of(), uri));
    ...
    public final class MessageListener implements RtspMessageChannel.MessageListener {
        ...
        private void handleRtspResponse(List<String> list) {
            ...
            ImmutableList<RtspTrackTiming> m1057of;
            ...
            try {
                ...
                if (i2 != 200) {
                    if (i2 != 401) {
                        if (i2 == 301 || i2 == 302) {
                            ...
                            String str = parseResponse.headers.get(RtspHeaders.LOCATION);
                            if (str == null) {
                        ...
                        ImmutableList<String> values = parseResponse.headers.values(RtspHeaders.WWW_AUTHENTICATE);
                        if (values.isEmpty()) {
                ...
                switch (i) {
                    ...
                    case 5:
                        ...
                        return;
                    case 6:
                        String str2 = parseResponse.headers.get(RtspHeaders.RANGE);
                        if (str2 == null) {
                        ...
                        try {
                            ...
                            if (str3 != null) {
                                m1057of = RtspTrackTiming.parseTrackTiming(str3, RtspClient.this.uri);
                            } else {
                        ...
                        onPlayResponseReceived(new RtspPlayResponse(parseResponse.status, parseTiming, m1057of));
                        return;
                    case 10:
        ...
        private void onPlayResponseReceived(RtspPlayResponse rtspPlayResponse) {
            ...
            RtspClient.this.pendingSeekPositionUs = C0483C.TIME_UNSET;
        ...
        private void onPauseResponseReceived() {
            ...
            if (RtspClient.this.pendingSeekPositionUs != C0483C.TIME_UNSET) {
                RtspClient rtspClient = RtspClient.this;
