...
public final class RtspMediaPeriod implements MediaPeriod {
    ...
    public RtspMediaPeriod(Allocator allocator, RtpDataChannel.Factory factory, Uri uri, Listener listener, String str, SocketFactory socketFactory, boolean z) {
        ...
        this.pendingSeekPositionUs = C0480C.TIME_UNSET;
        this.requestedSeekPositionUs = C0480C.TIME_UNSET;
        this.pendingSeekPositionUsForTcpRetry = C0480C.TIME_UNSET;
    }
    ...
    public boolean isSeekPending() {
        return this.pendingSeekPositionUs != C0480C.TIME_UNSET;
    }
    ...
    public final class InternalListener implements ExtractorOutput, Loader.Callback<RtpDataLoadable>, SampleQueue.UpstreamFormatChangedListener, RtspClient.SessionInfoListener, RtspClient.PlaybackEventListener {
        ...
        public void onRtspSetupCompleted() {
            RtspMediaPeriod.this.rtspClient.startPlayback(RtspMediaPeriod.this.pendingSeekPositionUs != C0480C.TIME_UNSET ? Util.usToMs(RtspMediaPeriod.this.pendingSeekPositionUs) : RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry != C0480C.TIME_UNSET ? Util.usToMs(RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry) : 0L);
        }
        ...
        public void onPlaybackStarted(long j, ImmutableList<RtspTrackTiming> immutableList) {
            ...
            for (int i2 = 0; i2 < RtspMediaPeriod.this.selectedLoadInfos.size(); i2++) {
                if (!arrayList.contains(((RtpLoadInfo) RtspMediaPeriod.this.selectedLoadInfos.get(i2)).getTrackUri().getPath())) {
                    ...
                    if (RtspMediaPeriod.this.isSeekPending()) {
                        ...
                        RtspMediaPeriod.this.pendingSeekPositionUs = C0480C.TIME_UNSET;
                        RtspMediaPeriod.this.requestedSeekPositionUs = C0480C.TIME_UNSET;
                        RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry = C0480C.TIME_UNSET;
                    }
                }
            }
            ...
            } else if (RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry != C0480C.TIME_UNSET && RtspMediaPeriod.this.isUsingRtpTcp) {
