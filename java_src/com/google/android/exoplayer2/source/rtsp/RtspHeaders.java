...
public final class RtspHeaders {
    ...
    public static String convertToStandardHeaderName(String str) {
        return Ascii.equalsIgnoreCase(str, ACCEPT) ? ACCEPT : Ascii.equalsIgnoreCase(str, ALLOW) ? ALLOW : Ascii.equalsIgnoreCase(str, AUTHORIZATION) ? AUTHORIZATION : Ascii.equalsIgnoreCase(str, BANDWIDTH) ? BANDWIDTH : Ascii.equalsIgnoreCase(str, BLOCKSIZE) ? BLOCKSIZE : Ascii.equalsIgnoreCase(str, CACHE_CONTROL) ? CACHE_CONTROL : Ascii.equalsIgnoreCase(str, CONNECTION) ? CONNECTION : Ascii.equalsIgnoreCase(str, CONTENT_BASE) ? CONTENT_BASE : Ascii.equalsIgnoreCase(str, CONTENT_ENCODING) ? CONTENT_ENCODING : Ascii.equalsIgnoreCase(str, CONTENT_LANGUAGE) ? CONTENT_LANGUAGE : Ascii.equalsIgnoreCase(str, CONTENT_LENGTH) ? CONTENT_LENGTH : Ascii.equalsIgnoreCase(str, CONTENT_LOCATION) ? CONTENT_LOCATION : Ascii.equalsIgnoreCase(str, CONTENT_TYPE) ? CONTENT_TYPE : Ascii.equalsIgnoreCase(str, CSEQ) ? CSEQ : Ascii.equalsIgnoreCase(str, DATE) ? DATE : Ascii.equalsIgnoreCase(str, EXPIRES) ? EXPIRES : Ascii.equalsIgnoreCase(str, LOCATION) ? LOCATION : Ascii.equalsIgnoreCase(str, PROXY_AUTHENTICATE) ? PROXY_AUTHENTICATE : Ascii.equalsIgnoreCase(str, PROXY_REQUIRE) ? PROXY_REQUIRE : Ascii.equalsIgnoreCase(str, PUBLIC) ? PUBLIC : Ascii.equalsIgnoreCase(str, RANGE) ? RANGE : Ascii.equalsIgnoreCase(str, RTP_INFO) ? RTP_INFO : Ascii.equalsIgnoreCase(str, RTCP_INTERVAL) ? RTCP_INTERVAL : Ascii.equalsIgnoreCase(str, SCALE) ? SCALE : Ascii.equalsIgnoreCase(str, SESSION) ? SESSION : Ascii.equalsIgnoreCase(str, SPEED) ? SPEED : Ascii.equalsIgnoreCase(str, SUPPORTED) ? SUPPORTED : Ascii.equalsIgnoreCase(str, TIMESTAMP) ? TIMESTAMP : Ascii.equalsIgnoreCase(str, TRANSPORT) ? TRANSPORT : Ascii.equalsIgnoreCase(str, USER_AGENT) ? USER_AGENT : Ascii.equalsIgnoreCase(str, VIA) ? VIA : Ascii.equalsIgnoreCase(str, WWW_AUTHENTICATE) ? WWW_AUTHENTICATE : str;
    }
}
