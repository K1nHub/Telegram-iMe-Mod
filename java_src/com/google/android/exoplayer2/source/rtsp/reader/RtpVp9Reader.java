...
final class RtpVp9Reader implements RtpPayloadReader {
    ...
    private long fragmentedSampleTimeUs = C0470C.TIME_UNSET;
    ...
    private boolean validateVp9Descriptor(ParsableByteArray parsableByteArray, int i) {
        ...
        if ((readUnsignedByte & 8) == 8) {
            ...
            Log.m792w(TAG, "First payload octet of the RTP packet is not the beginning of a new VP9 partition, Dropping current packet.");
            return false;
        }
