...
final class RtspSessionTiming {
    ...
    public static final RtspSessionTiming DEFAULT = new RtspSessionTiming(LIVE_START_TIME, C0483C.TIME_UNSET);
    ...
    public boolean isLive() {
        return this.stopTimeMs == C0483C.TIME_UNSET;
    }
