...
public final class RtpDataLoadable implements Loader.Loadable {
    ...
    private volatile long pendingSeekPositionUs = C0483C.TIME_UNSET;
    ...
    public void setTimestamp(long j) {
        if (j == C0483C.TIME_UNSET || ((RtpExtractor) Assertions.checkNotNull(this.extractor)).hasReadFirstRtpPacket()) {
            return;
        }
    ...
    public void load() throws IOException {
        ...
        try {
            ...
            while (!this.loadCancelled) {
                if (this.pendingSeekPositionUs != C0483C.TIME_UNSET) {
