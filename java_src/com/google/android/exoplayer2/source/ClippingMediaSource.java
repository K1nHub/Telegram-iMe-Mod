...
public final class ClippingMediaSource extends WrappingMediaSource {
    ...
    public static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public ClippingTimeline(Timeline timeline, long j, long j2) throws IllegalClippingException {
            ...
            this.startUs = max;
            this.endUs = max2;
            int i = (max2 > C0483C.TIME_UNSET ? 1 : (max2 == C0483C.TIME_UNSET ? 0 : -1));
            this.durationUs = i == 0 ? -9223372036854775807L : max2 - max;
            if (window.isDynamic && (i == 0 || (j3 != C0483C.TIME_UNSET && max2 == j3))) {
                z = true;
            }
            this.isDynamic = z;
        }
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f190id, period.uid, 0, j == C0483C.TIME_UNSET ? -9223372036854775807L : j - positionInWindowUs, positionInWindowUs);
        }
    }
}
