...
public abstract class BasePlayer implements Player {
    ...
    public final void setMediaItem(MediaItem mediaItem) {
        setMediaItems(ImmutableList.m1056of(mediaItem));
    }

    @Override // com.google.android.exoplayer2.Player
    public final void setMediaItem(MediaItem mediaItem, long j) {
        setMediaItems(ImmutableList.m1056of(mediaItem), 0, j);
    }

    @Override // com.google.android.exoplayer2.Player
    public final void setMediaItem(MediaItem mediaItem, boolean z) {
        setMediaItems(ImmutableList.m1056of(mediaItem), z);
    }
    ...
    public final void addMediaItem(int i, MediaItem mediaItem) {
        addMediaItems(i, ImmutableList.m1056of(mediaItem));
    }

    @Override // com.google.android.exoplayer2.Player
    public final void addMediaItem(MediaItem mediaItem) {
        addMediaItems(ImmutableList.m1056of(mediaItem));
    }
    ...
    public final int getBufferedPercentage() {
        ...
        if (bufferedPosition == C0483C.TIME_UNSET || duration == C0483C.TIME_UNSET) {
            return 0;
        }
        if (duration == 0) {
            return 100;
    ...
    public final long getCurrentLiveOffset() {
        Timeline currentTimeline = getCurrentTimeline();
        return (currentTimeline.isEmpty() || currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).windowStartTimeMs == C0483C.TIME_UNSET) ? C0483C.TIME_UNSET : (this.window.getCurrentUnixTimeMs() - this.window.windowStartTimeMs) - getContentPosition();
    }
    ...
    public final long getContentDuration() {
        Timeline currentTimeline = getCurrentTimeline();
        return currentTimeline.isEmpty() ? C0483C.TIME_UNSET : currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).getDurationMs();
    }
    ...
    private void seekToDefaultPositionInternal(int i, int i2) {
        seekTo(i, C0483C.TIME_UNSET, i2, false);
    }
    ...
    private void repeatCurrentMediaItem(int i) {
        seekTo(getCurrentMediaItemIndex(), C0483C.TIME_UNSET, i, true);
    }
}
