...
public abstract class BasePlayer implements Player {
    ...
    public final int getBufferedPercentage() {
        ...
        if (bufferedPosition == C0479C.TIME_UNSET || duration == C0479C.TIME_UNSET) {
            return 0;
        }
        if (duration == 0) {
            return 100;
    ...
    public final long getCurrentLiveOffset() {
        Timeline currentTimeline = getCurrentTimeline();
        return (currentTimeline.isEmpty() || currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).windowStartTimeMs == C0479C.TIME_UNSET) ? C0479C.TIME_UNSET : (this.window.getCurrentUnixTimeMs() - this.window.windowStartTimeMs) - getContentPosition();
    }
    ...
    public final long getContentDuration() {
        Timeline currentTimeline = getCurrentTimeline();
        return currentTimeline.isEmpty() ? C0479C.TIME_UNSET : currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).getDurationMs();
    }
    ...
    private void seekToDefaultPositionInternal(int i, int i2) {
        seekTo(i, C0479C.TIME_UNSET, i2, false);
    }
    ...
    private void repeatCurrentMediaItem(int i) {
        seekTo(getCurrentMediaItemIndex(), C0479C.TIME_UNSET, i, true);
    }
}
