...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    public static final class Builder {
        ...
        public Builder setFallbackMinPlaybackSpeed(float f) {
            Assertions.checkArgument(BitmapDescriptorFactory.HUE_RED < f && f <= 1.0f);
    ...
    private DefaultLivePlaybackSpeedControl(float f, float f2, long j, float f3, long j2, long j3, float f4) {
        ...
        this.mediaConfigurationTargetLiveOffsetUs = C0482C.TIME_UNSET;
        this.targetLiveOffsetOverrideUs = C0482C.TIME_UNSET;
        this.minTargetLiveOffsetUs = C0482C.TIME_UNSET;
        this.maxTargetLiveOffsetUs = C0482C.TIME_UNSET;
        this.minPlaybackSpeed = f;
        this.maxPlaybackSpeed = f2;
        this.adjustedPlaybackSpeed = 1.0f;
        this.lastPlaybackSpeedUpdateMs = C0482C.TIME_UNSET;
        this.idealTargetLiveOffsetUs = C0482C.TIME_UNSET;
        this.currentTargetLiveOffsetUs = C0482C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetUs = C0482C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetDeviationUs = C0482C.TIME_UNSET;
    }
    ...
    public float getAdjustedPlaybackSpeed(long j, long j2) {
        if (this.mediaConfigurationTargetLiveOffsetUs == C0482C.TIME_UNSET) {
            return 1.0f;
        }
        updateSmoothedMinPossibleLiveOffsetUs(j, j2);
        if (this.lastPlaybackSpeedUpdateMs != C0482C.TIME_UNSET && SystemClock.elapsedRealtime() - this.lastPlaybackSpeedUpdateMs < this.minUpdateIntervalMs) {
    ...
    private void maybeResetTargetLiveOffsetUs() {
        ...
        if (j != C0482C.TIME_UNSET) {
            ...
            if (j3 != C0482C.TIME_UNSET && j < j3) {
                j = j3;
            }
            long j4 = this.maxTargetLiveOffsetUs;
            if (j4 != C0482C.TIME_UNSET && j > j4) {
                j = j4;
            }
        } else {
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        long j3 = this.maxTargetLiveOffsetUs;
        if (j3 == C0482C.TIME_UNSET || constrainValue <= j3) {
            return;
        }
        this.currentTargetLiveOffsetUs = j3;
    }
