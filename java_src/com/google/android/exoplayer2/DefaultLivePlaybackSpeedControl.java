...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    private DefaultLivePlaybackSpeedControl(float f, float f2, long j, float f3, long j2, long j3, float f4) {
        ...
        this.mediaConfigurationTargetLiveOffsetUs = C0479C.TIME_UNSET;
        this.targetLiveOffsetOverrideUs = C0479C.TIME_UNSET;
        this.minTargetLiveOffsetUs = C0479C.TIME_UNSET;
        this.maxTargetLiveOffsetUs = C0479C.TIME_UNSET;
        this.minPlaybackSpeed = f;
        this.maxPlaybackSpeed = f2;
        this.adjustedPlaybackSpeed = 1.0f;
        this.lastPlaybackSpeedUpdateMs = C0479C.TIME_UNSET;
        this.idealTargetLiveOffsetUs = C0479C.TIME_UNSET;
        this.currentTargetLiveOffsetUs = C0479C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetUs = C0479C.TIME_UNSET;
        this.smoothedMinPossibleLiveOffsetDeviationUs = C0479C.TIME_UNSET;
    }
    ...
    public float getAdjustedPlaybackSpeed(long j, long j2) {
        if (this.mediaConfigurationTargetLiveOffsetUs == C0479C.TIME_UNSET) {
            return 1.0f;
        }
        updateSmoothedMinPossibleLiveOffsetUs(j, j2);
        if (this.lastPlaybackSpeedUpdateMs != C0479C.TIME_UNSET && SystemClock.elapsedRealtime() - this.lastPlaybackSpeedUpdateMs < this.minUpdateIntervalMs) {
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        long j3 = this.maxTargetLiveOffsetUs;
        if (j3 == C0479C.TIME_UNSET || constrainValue <= j3) {
            return;
        }
        this.currentTargetLiveOffsetUs = j3;
    }
