...
public class StandaloneDatabaseProvider extends SQLiteOpenHelper implements DatabaseProvider {
    ...
    private static void wipeDatabase(SQLiteDatabase sQLiteDatabase) {
        Cursor query = sQLiteDatabase.query("sqlite_master", new String[]{SessionDescription.ATTR_TYPE, AppMeasurementSdk.ConditionalUserProperty.NAME}, null, null, null, null, null);
            ...
            try {
                ...
                if (!"sqlite_sequence".equals(string2)) {
                    ...
                    try {
                        ...
                        Log.m1110e(TAG, "Error executing " + str, e);
                    }
                }
            } catch (Throwable th) {
                if (query != null) {
