...
public class MatroskaExtractor implements Extractor {
    ...
    MatroskaExtractor(EbmlReader ebmlReader, int i) {
        ...
        this.timecodeScale = C0480C.TIME_UNSET;
        this.durationTimecode = C0480C.TIME_UNSET;
        this.durationUs = C0480C.TIME_UNSET;
        this.cuesContentPosition = -1L;
        this.seekPositionAfterBuildingCues = -1L;
        this.clusterTimecodeUs = C0480C.TIME_UNSET;
    ...
    protected void endMasterElement(int i) throws ParserException {
        ...
        if (i == ID_BLOCK_GROUP) {
            ...
            if (track3.hasContentEncryption) {
                ...
                track3.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C0480C.UUID_NIL, MimeTypes.VIDEO_WEBM, this.currentTrack.cryptoData.encryptionKey));
            }
            ...
            if (this.timecodeScale == C0480C.TIME_UNSET) {
    ...
    */
    ...
    private static byte[] formatSubtitleTimecode(long j, String str, long j2) {
        Assertions.checkArgument(j != C0480C.TIME_UNSET);
    ...
    private SeekMap buildSeekMap(LongArray longArray, LongArray longArray2) {
        int i;
        if (this.segmentContentPosition == -1 || this.durationUs == C0480C.TIME_UNSET || longArray == null || longArray.size() == 0 || longArray2 == null || longArray2.size() != longArray.size()) {
