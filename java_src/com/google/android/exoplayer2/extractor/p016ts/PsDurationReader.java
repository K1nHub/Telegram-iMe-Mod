...
public final class PsDurationReader {
    ...
    private long firstScrValue = C0482C.TIME_UNSET;
    private long lastScrValue = C0482C.TIME_UNSET;
    private long durationUs = C0482C.TIME_UNSET;
    ...
    public int readDuration(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (this.lastScrValue == C0482C.TIME_UNSET) {
    ...
    public static long readScrValueFromPack(ParsableByteArray parsableByteArray) {
        ...
        return !checkMarkerBits(bArr) ? C0482C.TIME_UNSET : readScrValueFromPackHeader(bArr);
    }
