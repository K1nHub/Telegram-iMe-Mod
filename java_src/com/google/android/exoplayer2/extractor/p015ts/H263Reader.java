...
public final class H263Reader implements ElementaryStreamReader {
    ...
    private static Format parseCsdBuffer(CsdBuffer csdBuffer, int i, String str) {
        ...
        if (readBits == 15) {
            ...
            if (readBits3 == 0) {
                Log.m1106w(TAG, "Invalid aspect ratio");
            } else {
        ...
        if (parsableBitArray.readBits(2) != 0) {
            Log.m1106w(TAG, "Unhandled video object layer shape");
        }
        parsableBitArray.skipBit();
        ...
        if (parsableBitArray.readBit()) {
            if (readBits4 == 0) {
                Log.m1106w(TAG, "Invalid vop_increment_time_resolution");
            } else {
                int i2 = 0;
                ...
                if (i3 != 1) {
                    if (i3 != 2) {
                        if (i3 != 3) {
                            ...
                            Log.m1106w(H263Reader.TAG, "Unexpected start code value");
                            reset();
                        } else {
