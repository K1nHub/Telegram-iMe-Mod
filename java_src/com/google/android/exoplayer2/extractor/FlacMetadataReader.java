    ...
    public static boolean readMetadataBlock(ExtractorInput extractorInput, FlacStreamMetadataHolder flacStreamMetadataHolder) throws IOException {
        ...
        if (readBits == 0) {
            ...
            if (readBits == 3) {
                ...
                flacStreamMetadataHolder.flacStreamMetadata = flacStreamMetadata.copyWithPictureFrames(ImmutableList.m1053of(PictureFrame.fromPictureBlock(parsableByteArray)));
            } else {
