...
public final class VorbisUtil {
    ...
    public static Metadata parseVorbisComments(List<String> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (splitAtFirst.length != 2) {
                Log.m1107w(TAG, "Failed to parse Vorbis comment: " + str);
                ...
                try {
                    ...
                    Log.m1106w(TAG, "Failed to parse vorbis picture", e);
                }
            } else {
    ...
    private static void readMappings(int i, VorbisBitArray vorbisBitArray) throws ParserException {
        ...
        for (int i2 = 0; i2 < readBits; i2++) {
            ...
            if (readBits2 != 0) {
                Log.m1111e(TAG, "mapping type other than 0 not supported: " + readBits2);
            } else {
