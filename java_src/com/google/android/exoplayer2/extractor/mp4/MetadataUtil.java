    ...
    */
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        ...
        try {
            ...
            Log.m1113d(TAG, "Skipped unknown metadata entry: " + Atom.getAtomTypeString(readInt));
            return null;
        } finally {
    ...
    private static TextInformationFrame parseTextAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385) {
            ...
            return new TextInformationFrame(str, (String) null, ImmutableList.m1056of(parsableByteArray.readNullTerminatedString(readInt - 16)));
        }
        Log.m1107w(TAG, "Failed to parse text attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static CommentFrame parseCommentAttribute(int i, ParsableByteArray parsableByteArray) {
        ...
        Log.m1107w(TAG, "Failed to parse comment attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static Id3Frame parseUint8Attribute(int i, String str, ParsableByteArray parsableByteArray, boolean z, boolean z2) {
        ...
        if (parseUint8AttributeValue >= 0) {
            if (z) {
                return new TextInformationFrame(str, (String) null, ImmutableList.m1056of(Integer.toString(parseUint8AttributeValue)));
            }
            return new CommentFrame("und", str, Integer.toString(parseUint8AttributeValue));
        }
        Log.m1107w(TAG, "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385 && readInt >= 22) {
            ...
            if (readUnsignedShort > 0) {
                ...
                return new TextInformationFrame(str, (String) null, ImmutableList.m1056of(str2));
            }
        }
        Log.m1107w(TAG, "Failed to parse index/count attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    */
    private static com.google.android.exoplayer2.metadata.id3.TextInformationFrame parseStandardGenreAttribute(com.google.android.exoplayer2.util.ParsableByteArray r3) {
        ...
        L12:
            ...
            com.google.common.collect.ImmutableList r3 = com.google.common.collect.ImmutableList.m1056of(r3)
        ...
        L20:
            ...
            com.google.android.exoplayer2.util.Log.m1107w(r3, r1)
            return r0
        */
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385) {
            ...
            if (str == null) {
                Log.m1107w(TAG, "Unrecognized cover art flags: " + parseFullAtomFlags);
                return null;
            }
        ...
        Log.m1107w(TAG, "Failed to parse cover art attribute");
        return null;
    }
    ...
    private static int parseUint8AttributeValue(ParsableByteArray parsableByteArray) {
        ...
        Log.m1107w(TAG, "Failed to parse uint8 attribute value");
        return -1;
    }
}
