...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public FragmentedMp4Extractor(int i, TimestampAdjuster timestampAdjuster, Track track, List<Format> list, TrackOutput trackOutput) {
        ...
        this.pendingSeekTimeUs = C0483C.TIME_UNSET;
        this.segmentIndexEarliestPresentationTimeUs = C0483C.TIME_UNSET;
    ...
    private void onMoofContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.pendingSeekTimeUs != C0483C.TIME_UNSET) {
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (parseFullAtomVersion == 0) {
            ...
            long j3 = j2 != C0483C.TIME_UNSET ? j2 + scaleLargeTimestamp : -9223372036854775807L;
            str = str3;
