...
public final class AtomParsers {
    ...
    public static Metadata parseMdtaFromMeta(Atom.ContainerAtom containerAtom) {
        ...
        while (parsableByteArray2.bytesLeft() > 8) {
            ...
            if (readInt4 >= 0 && readInt4 < readInt) {
                ...
                Log.m792w(TAG, "Skipped metadata with unknown key index: " + readInt4);
            }
    ...
    private static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
        ...
        StsdData parseStsd = parseStsd(leafAtomOfType.data, parseTkhd.f105id, parseTkhd.rotationDegrees, (String) parseMdhd.second, drmInitData, z2);
        ...
        return new Track(parseTkhd.f105id, trackTypeForHdlr, ((Long) parseMdhd.first).longValue(), parseMvhd, j4, parseStsd.format, parseStsd.requiredSampleTransformation, parseStsd.trackEncryptionBoxes, parseStsd.nalUnitLengthFieldLength, jArr, jArr2);
    }
    ...
    private static void parseTextSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, String str, StsdData stsdData) {
        ...
        if (i != 1414810956) {
            if (i == 1954034535) {
                ...
                immutableList = ImmutableList.m739of(bArr);
            ...
            if (readInt2 == 1635148611) {
                ...
                if (readInt2 == 1685480259 || readInt2 == 1685485123) {
                    ...
                    if (readInt2 == 1681012275) {
                        ...
                        list2 = bArr4 != null ? ImmutableList.m739of(bArr4) : list;
                        str3 = str6;
                        bArr2 = bArr;
                        f2 = f;
                        position += readInt;
                        ...
                        if (readInt3 == TYPE_nclx || readInt3 == TYPE_nclc) {
                            ...
                            Log.m792w(TAG, "Unsupported color type: " + Atom.getAtomTypeString(readInt3));
                        }
                    }
                }
                list2 = list;
    ...
    */
    ...
    static Pair<Integer, TrackEncryptionBox> parseCommonEncryptionSinfFromParent(ParsableByteArray parsableByteArray, int i, int i2) throws ParserException {
        ...
        if (C0470C.CENC_TYPE_cenc.equals(str) || C0470C.CENC_TYPE_cbc1.equals(str) || C0470C.CENC_TYPE_cens.equals(str) || C0470C.CENC_TYPE_cbcs.equals(str)) {
        ...
        public StszSampleSizeBox(Atom.LeafAtom leafAtom, Format format) {
            ...
            if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
                ...
                if (readUnsignedIntToInt == 0 || readUnsignedIntToInt % pcmFrameSize != 0) {
                    Log.m792w(AtomParsers.TAG, "Audio sample size mismatch. stsd sample size: " + pcmFrameSize + ", stsz sample size: " + readUnsignedIntToInt);
