...
public final class AtomParsers {
    ...
    private static void parseTextSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, String str, StsdData stsdData) {
        ...
        if (i != 1414810956) {
            if (i == 1954034535) {
                ...
                immutableList = ImmutableList.m1056of(bArr);
            ...
            if (readInt2 == 1635148611) {
                ...
                if (readInt2 == 1685480259 || readInt2 == 1685485123) {
                    ...
                    if (readInt2 == 1681012275) {
                        ...
                        list2 = bArr4 != null ? ImmutableList.m1056of(bArr4) : list;
                        str3 = str6;
                        bArr2 = bArr;
                        f2 = f;
                        position += readInt;
    ...
    */
    ...
    static Pair<Integer, TrackEncryptionBox> parseCommonEncryptionSinfFromParent(ParsableByteArray parsableByteArray, int i, int i2) throws ParserException {
        ...
        if (C0483C.CENC_TYPE_cenc.equals(str) || C0483C.CENC_TYPE_cbc1.equals(str) || C0483C.CENC_TYPE_cens.equals(str) || C0483C.CENC_TYPE_cbcs.equals(str)) {
