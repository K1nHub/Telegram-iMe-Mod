...
public final class TrackEncryptionBox {
    ...
    private static int schemeToCryptoMode(String str) {
        ...
        switch (str.hashCode()) {
            case 3046605:
                if (str.equals(C0483C.CENC_TYPE_cbc1)) {
                    c = 0;
                    break;
                }
                break;
            case 3046671:
                if (str.equals(C0483C.CENC_TYPE_cbcs)) {
                    c = 1;
                    break;
                }
                break;
            case 3049879:
                if (str.equals(C0483C.CENC_TYPE_cenc)) {
                    c = 2;
                    break;
                }
                break;
            case 3049895:
                if (str.equals(C0483C.CENC_TYPE_cens)) {
                    c = 3;
                    break;
                }
                break;
        ...
        switch (c) {
            ...
            case 3:
                break;
            default:
                Log.m1107w(TAG, "Unsupported protection scheme type '" + str + "'. Assuming AES-CTR crypto mode.");
                break;
        }
        return 1;
    }
