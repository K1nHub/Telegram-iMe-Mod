...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    */
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, C0483C.TIME_UNSET, null, z2, z, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda1
        ...
        while (i4 < size) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                MetadataUtil.setFormatMetadata(i6, metadata2, metadata5, buildUpon, metadataArr);
    ...
    private int readSample(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        } else if (j2 < RELOAD_MINIMUM_SEEK_DISTANCE) {
    ...
    private void processEndOfStreamReadingAtomHeader() {
        ...
        this.extractorOutput.endTracks();
        this.extractorOutput.seekMap(new SeekMap.Unseekable(C0483C.TIME_UNSET));
    }
    ...
    private void processUnparsedAtom(long j) {
        if (this.atomType == 1836086884) {
            int i = this.atomHeaderBytesRead;
            this.motionPhotoMetadata = new MotionPhotoMetadata(0L, j, C0483C.TIME_UNSET, j + i, this.atomSize - i);
        }
    }
