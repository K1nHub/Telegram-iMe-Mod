...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    */
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, C0474C.TIME_UNSET, null, z2, z, Mp4Extractor$$ExternalSyntheticLambda1.INSTANCE);
    ...
    private void processUnparsedAtom(long j) {
        if (this.atomType == 1836086884) {
            int i = this.atomHeaderBytesRead;
            this.motionPhotoMetadata = new MotionPhotoMetadata(0L, j, C0474C.TIME_UNSET, j + i, this.atomSize - i);
        }
    }
