...
public final class MediaCodecInfo {
    ...
    private void logNoSupport(String str) {
        Log.m1112d(TAG, "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }

    private void logAssumedSupport(String str) {
        Log.m1112d(TAG, "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.m1106w(TAG, "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + "]");
        return i2;
    }
