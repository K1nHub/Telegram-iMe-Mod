...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public MediaCodecRenderer(int i, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, boolean z, float f) {
        ...
        this.renderTimeLimitMs = C0483C.TIME_UNSET;
        this.pendingOutputStreamStartPositionsUs = new long[10];
        this.pendingOutputStreamOffsetsUs = new long[10];
        this.pendingOutputStreamSwitchTimesUs = new long[10];
        this.outputStreamStartPositionUs = C0483C.TIME_UNSET;
        setOutputStreamOffsetUs(C0483C.TIME_UNSET);
        ...
        this.inputIndex = -1;
        this.outputIndex = -1;
        this.codecHotswapDeadlineMs = C0483C.TIME_UNSET;
        this.largestQueuedPresentationTimeUs = C0483C.TIME_UNSET;
        this.lastBufferInStreamPresentationTimeUs = C0483C.TIME_UNSET;
    ...
    public void onStreamChanged(Format[] formatArr, long j, long j2) throws ExoPlaybackException {
        if (this.outputStreamOffsetUs == C0483C.TIME_UNSET) {
            Assertions.checkState(this.outputStreamStartPositionUs == C0483C.TIME_UNSET);
    ...
    */
    ...
    private boolean shouldContinueRendering(long j) {
        return this.renderTimeLimitMs == C0483C.TIME_UNSET || SystemClock.elapsedRealtime() - j < this.renderTimeLimitMs;
    }
    ...
    */
    ...
    public boolean isReady() {
        return this.inputFormat != null && (isSourceReady() || hasOutputBuffer() || (this.codecHotswapDeadlineMs != C0483C.TIME_UNSET && SystemClock.elapsedRealtime() < this.codecHotswapDeadlineMs));
    }
    ...
    private boolean drmNeedsCodecReinitialization(MediaCodecInfo mediaCodecInfo, Format format, DrmSession drmSession, DrmSession drmSession2) throws ExoPlaybackException {
        ...
        UUID uuid = C0483C.PLAYREADY_UUID;
