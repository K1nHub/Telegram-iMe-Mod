...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public MediaCodecRenderer(int i, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, boolean z, float f) {
        ...
        this.renderTimeLimitMs = C0470C.TIME_UNSET;
        this.pendingOutputStreamStartPositionsUs = new long[10];
        this.pendingOutputStreamOffsetsUs = new long[10];
        this.pendingOutputStreamSwitchTimesUs = new long[10];
        this.outputStreamStartPositionUs = C0470C.TIME_UNSET;
        ...
        this.inputIndex = -1;
        this.outputIndex = -1;
        this.codecHotswapDeadlineMs = C0470C.TIME_UNSET;
        this.largestQueuedPresentationTimeUs = C0470C.TIME_UNSET;
        this.lastBufferInStreamPresentationTimeUs = C0470C.TIME_UNSET;
    ...
    public void onStreamChanged(Format[] formatArr, long j, long j2) throws ExoPlaybackException {
        if (this.outputStreamOffsetUs == C0470C.TIME_UNSET) {
            Assertions.checkState(this.outputStreamStartPositionUs == C0470C.TIME_UNSET);
        ...
        if (i == 2) {
            ...
            if (i2 >= 23) {
                try {
                    ...
                    Log.m791w(TAG, "Failed to update the DRM session, releasing the codec instead.", e);
                    releaseCodec();
                    return true;
                }
            }
    ...
    */
    private void maybeInitCodecWithFallback(android.media.MediaCrypto r8, boolean r9) throws com.google.android.exoplayer2.mediacodec.MediaCodecRenderer.DecoderInitializationException {
        ...
        L60:
            ...
            com.google.android.exoplayer2.util.Log.m792w(r4, r3)     // Catch: java.lang.Exception -> L74
            r5 = 50
        ...
        L74:
            ...
            com.google.android.exoplayer2.util.Log.m791w(r4, r5, r3)
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (decoderInfos.isEmpty() && z) {
            ...
            if (!decoderInfos.isEmpty()) {
                Log.m792w(TAG, "Drm session requires secure decoder for " + this.inputFormat.sampleMimeType + ", but no secure decoder available. Trying to proceed with " + decoderInfos + ".");
            }
        }
        return decoderInfos;
    }
    ...
    private void initCodec(MediaCodecInfo mediaCodecInfo, MediaCrypto mediaCrypto) throws Exception {
        ...
        try {
            ...
            if (!mediaCodecInfo.isFormatSupported(this.inputFormat)) {
                Log.m792w(TAG, Util.formatInvariant("Format exceeds selected codec's capabilities [%s, %s]", Format.toLogString(this.inputFormat), str));
            }
            this.codecInfo = mediaCodecInfo;
    ...
    private boolean shouldContinueRendering(long j) {
        return this.renderTimeLimitMs == C0470C.TIME_UNSET || SystemClock.elapsedRealtime() - j < this.renderTimeLimitMs;
    }
    ...
    */
    ...
    public boolean isReady() {
        return this.inputFormat != null && (isSourceReady() || hasOutputBuffer() || (this.codecHotswapDeadlineMs != C0470C.TIME_UNSET && SystemClock.elapsedRealtime() < this.codecHotswapDeadlineMs));
    }
    ...
    private boolean drmNeedsCodecReinitialization(MediaCodecInfo mediaCodecInfo, Format format, DrmSession drmSession, DrmSession drmSession2) throws ExoPlaybackException {
        ...
        UUID uuid = C0470C.PLAYREADY_UUID;
