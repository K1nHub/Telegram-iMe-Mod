...
public final class MediaCodecUtil {
    ...
    public static void warmDecoderInfoCache(String str, boolean z, boolean z2) {
        try {
            ...
            Log.m809e(TAG, "Codec warming failed", e);
        }
    }
        ...
        synchronized (MediaCodecUtil.class) {
            ...
            if (z && decoderInfosInternal.isEmpty() && 21 <= i && i <= 23) {
                ...
                if (!decoderInfosInternal.isEmpty()) {
                    Log.m806w(TAG, "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + decoderInfosInternal.get(0).name);
                }
            }
    ...
    */
    ...
    private static Pair<Integer, Integer> getDolbyVisionProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m806w(TAG, "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        ...
        if (dolbyVisionStringToProfile == null) {
            Log.m806w(TAG, "Unknown Dolby Vision profile string: " + group);
            return null;
        }
        String str2 = strArr[2];
        Integer dolbyVisionStringToLevel = dolbyVisionStringToLevel(str2);
        if (dolbyVisionStringToLevel == null) {
            Log.m806w(TAG, "Unknown Dolby Vision level string: " + str2);
            return null;
        }
    ...
    private static Pair<Integer, Integer> getHevcProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 4) {
            Log.m806w(TAG, "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        int i = 1;
        Matcher matcher = PROFILE_PATTERN.matcher(strArr[1]);
        ...
        if (!IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(group)) {
            if (!"2".equals(group)) {
                Log.m806w(TAG, "Unknown HEVC profile string: " + group);
                return null;
            }
            i = 2;
        }
        ...
        if (hevcCodecStringToProfileLevel == null) {
            Log.m806w(TAG, "Unknown HEVC level string: " + str2);
            return null;
        }
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        int i;
        if (strArr.length < 2) {
            Log.m806w(TAG, "Ignoring malformed AVC codec string: " + str);
            return null;
        }
        try {
    ...
    private static Pair<Integer, Integer> getVp9ProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m806w(TAG, "Ignoring malformed VP9 codec string: " + str);
            return null;
        }
        try {
            ...
            if (vp9ProfileNumberToConst == -1) {
                Log.m806w(TAG, "Unknown VP9 profile: " + parseInt);
                return null;
            }
            int vp9LevelNumberToConst = vp9LevelNumberToConst(parseInt2);
            if (vp9LevelNumberToConst == -1) {
                Log.m806w(TAG, "Unknown VP9 level: " + parseInt2);
                return null;
            }
    ...
    private static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        int i;
        if (strArr.length < 4) {
            Log.m806w(TAG, "Ignoring malformed AV1 codec string: " + str);
            return null;
        }
        int i2 = 1;
        try {
            ...
            if (parseInt != 0) {
                Log.m806w(TAG, "Unknown AV1 profile: " + parseInt);
                return null;
            } else if (parseInt3 != 8 && parseInt3 != 10) {
                Log.m806w(TAG, "Unknown AV1 bit depth: " + parseInt3);
                return null;
            } else {
                if (parseInt3 != 8) {
                ...
                if (av1LevelNumberToConst == -1) {
                    Log.m806w(TAG, "Unknown AV1 level: " + parseInt2);
                    return null;
                }
    ...
    private static Pair<Integer, Integer> getAacCodecProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length != 3) {
            Log.m806w(TAG, "Ignoring malformed MP4A codec string: " + str);
            return null;
        }
        try {
