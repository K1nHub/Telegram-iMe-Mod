...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f117id.equals(urlLinkFrame.f117id) && Util.areEqual(this.description, urlLinkFrame.description) && Util.areEqual(this.url, urlLinkFrame.url);
    }
    ...
    public String toString() {
        return this.f117id + ": url=" + this.url;
    }
