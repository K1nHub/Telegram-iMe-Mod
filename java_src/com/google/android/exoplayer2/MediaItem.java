...
public final class MediaItem implements Bundleable {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            this.subtitleConfigurations = ImmutableList.m1057of();
        ...
        public Builder setSubtitles(List<Subtitle> list) {
            this.subtitleConfigurations = list != null ? ImmutableList.copyOf((Collection) list) : ImmutableList.m1057of();
            return this;
        }
    ...
    public static final class DrmConfiguration {
        ...
        public static final class Builder {
            ...
            public Builder(UUID uuid) {
                this.scheme = uuid;
                this.licenseRequestHeaders = ImmutableMap.m1050of();
                this.forcedSessionTrackTypes = ImmutableList.m1057of();
            }
            ...
            public Builder setForceSessionsForAudioAndVideoTracks(boolean z) {
                ImmutableList m1057of;
                if (z) {
                    m1057of = ImmutableList.m1055of(2, 1);
                } else {
                    m1057of = ImmutableList.m1057of();
                }
                setForcedSessionTrackTypes(m1057of);
                return this;
            }
    ...
    public static final class LiveConfiguration implements Bundleable {
        ...
        public static final class Builder {
            ...
            public Builder() {
                this.targetOffsetMs = C0483C.TIME_UNSET;
                this.minOffsetMs = C0483C.TIME_UNSET;
                this.maxOffsetMs = C0483C.TIME_UNSET;
