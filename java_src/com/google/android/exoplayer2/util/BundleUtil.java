    ...
    private static IBinder getBinderByReflection(Bundle bundle, String str) {
        ...
        if (method == null) {
            try {
                ...
                Log.m1107i(TAG, "Failed to retrieve getIBinder method", e);
                return null;
            }
        }
        try {
            ...
            Log.m1107i(TAG, "Failed to invoke getIBinder via reflection", e2);
            return null;
        }
    }
    ...
    private static void putBinderByReflection(Bundle bundle, String str, IBinder iBinder) {
        ...
        if (method == null) {
            try {
                ...
                Log.m1107i(TAG, "Failed to retrieve putIBinder method", e);
                return;
            }
        }
        try {
            ...
            Log.m1107i(TAG, "Failed to invoke putIBinder via reflection", e2);
        }
    }
