...
public final class PlaybackStatsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public void onSessionFinished(AnalyticsListener.EventTime eventTime, String str, boolean z) {
        ...
        playbackStatsTracker.onFinished(eventTime, z, str.equals(this.discontinuityFromSession) ? this.discontinuityFromPositionMs : C0483C.TIME_UNSET);
    ...
    public void onEvents(Player player, AnalyticsListener.Events events) {
        ...
        for (String str : this.playbackStatsTrackers.keySet()) {
            ...
            playbackStatsTracker.onEvents(player, (AnalyticsListener.EventTime) findBestEventTime.first, ((Boolean) findBestEventTime.second).booleanValue(), str.equals(this.discontinuityFromSession) ? this.discontinuityFromPositionMs : C0483C.TIME_UNSET, hasEvent, hasEvent2 ? this.droppedFrames : 0, hasEvent3, hasEvent4, hasEvent5 ? player.getPlayerError() : null, z ? this.nonFatalException : null, hasEvent6 ? this.bandwidthTimeMs : 0L, hasEvent6 ? this.bandwidthBytes : 0L, hasEvent7 ? this.videoFormat : null, hasEvent7 ? this.audioFormat : null, hasEvent(events, str, 25) ? this.videoSize : null);
        }
    ...
    private static final class PlaybackStatsTracker {
        ...
        public PlaybackStatsTracker(boolean z, AnalyticsListener.EventTime eventTime) {
            ...
            this.firstReportedTimeMs = C0483C.TIME_UNSET;
            this.maxRebufferTimeMs = C0483C.TIME_UNSET;
        ...
        public PlaybackStats build(boolean z) {
            ...
            long j = i2 != 0 ? C0483C.TIME_UNSET : jArr[2];
            int i3 = jArr[1] > 0 ? 1 : 0;
        ...
        private void updatePlaybackState(int i, AnalyticsListener.EventTime eventTime) {
            ...
            if (this.firstReportedTimeMs == C0483C.TIME_UNSET) {
