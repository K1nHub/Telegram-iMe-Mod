...
public final class Loader implements LoaderErrorThrower {
    ...
    public static final LoadErrorAction RETRY = createRetryAction(false, C0480C.TIME_UNSET);
    public static final LoadErrorAction RETRY_RESET_ERROR_COUNT = createRetryAction(true, C0480C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY = new LoadErrorAction(2, C0480C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY_FATAL = new LoadErrorAction(3, C0480C.TIME_UNSET);
                ...
                if (i2 == 1) {
                    ...
                    if (onLoadError.type != 3) {
                        if (onLoadError.type != 2) {
                            ...
                            if (onLoadError.retryDelayMillis != C0480C.TIME_UNSET) {
