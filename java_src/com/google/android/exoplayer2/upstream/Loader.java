...
public final class Loader implements LoaderErrorThrower {
    ...
    public static final LoadErrorAction RETRY = createRetryAction(false, C0482C.TIME_UNSET);
    public static final LoadErrorAction RETRY_RESET_ERROR_COUNT = createRetryAction(true, C0482C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY = new LoadErrorAction(2, C0482C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY_FATAL = new LoadErrorAction(3, C0482C.TIME_UNSET);
    ...
    public final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (!this.released) {
                    Log.m809e(TAG, "Unexpected error loading stream", e2);
                ...
                Log.m809e(TAG, "Unexpected exception loading stream", e3);
                obtainMessage(2, new UnexpectedLoaderException(e3)).sendToTarget();
            } catch (OutOfMemoryError e4) {
                if (this.released) {
                    return;
                }
                Log.m809e(TAG, "OutOfMemory error loading stream", e4);
            ...
            if (i == 0) {
                ...
                if (i2 == 1) {
                    try {
                        ...
                        Log.m809e(TAG, "Unexpected exception handling load completed", e);
                    ...
                    if (onLoadError.type != 3) {
                        if (onLoadError.type != 2) {
                            ...
                            if (onLoadError.retryDelayMillis != C0482C.TIME_UNSET) {
