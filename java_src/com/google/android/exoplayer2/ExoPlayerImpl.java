...
public final class ExoPlayerImpl extends BasePlayer implements ExoPlayer, ExoPlayer.AudioComponent, ExoPlayer.VideoComponent, ExoPlayer.TextComponent, ExoPlayer.DeviceComponent {
    ...
    public ExoPlayerImpl(ExoPlayer.Builder builder, Player player) {
        ...
        try {
            Log.m808i(TAG, "Init " + Integer.toHexString(System.identityHashCode(this)) + " [" + ExoPlayerLibraryInfo.VERSION_SLASHY + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    ...
    public void prepare() {
        ...
        updatePlaybackInfo(copyWithPlaybackState, 1, 1, false, false, 5, C0474C.TIME_UNSET, -1, false);
    }
    ...
    public void setMediaSources(List<MediaSource> list, boolean z) {
        verifyApplicationThread();
        setMediaSourcesInternal(list, -1, C0474C.TIME_UNSET, z);
    }
    ...
    public void addMediaSources(int i, List<MediaSource> list) {
        ...
        updatePlaybackInfo(maskTimelineAndPosition, 0, 1, false, false, 5, C0474C.TIME_UNSET, -1, false);
    }
    ...
    public void seekTo(int i, long j, int i2, boolean z) {
        ...
        if (timeline.isEmpty() || i < timeline.getWindowCount()) {
            this.pendingOperationAcks++;
            if (isPlayingAd()) {
                Log.m806w(TAG, "seekTo ignored because an ad is playing");
    ...
    public long getMaxSeekToPreviousPosition() {
        verifyApplicationThread();
        return C0474C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
    }
    ...
    public void setPlaybackParameters(PlaybackParameters playbackParameters) {
        ...
        updatePlaybackInfo(copyWithPlaybackParameters, 0, 1, false, false, 5, C0474C.TIME_UNSET, -1, false);
    }
    ...
    public void stop(boolean z) {
        ...
        stopInternal(z, null);
        this.currentCueGroup = new CueGroup(ImmutableList.m754of(), this.playbackInfo.positionUs);
    }

    @Override // com.google.android.exoplayer2.Player
    public void release() {
        AudioTrack audioTrack;
        Log.m808i(TAG, "Release " + Integer.toHexString(System.identityHashCode(this)) + " [" + ExoPlayerLibraryInfo.VERSION_SLASHY + "] [" + Util.DEVICE_DEBUG_INFO + "] [" + ExoPlayerLibraryInfo.registeredModules() + "]");
        verifyApplicationThread();
    ...
    public long getContentPosition() {
        ...
        if (isPlayingAd()) {
            ...
            if (playbackInfo2.requestedContentPositionUs == C0474C.TIME_UNSET) {
    ...
    public void setVideoTextureView(TextureView textureView) {
        ...
        if (textureView.getSurfaceTextureListener() != null) {
            Log.m806w(TAG, "Replacing existing SurfaceTextureListener.");
        }
    ...
    public void setAudioSessionId(final int i) {
        ...
        this.listeners.sendEvent(21, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda2
            @Override // com.google.android.exoplayer2.util.ListenerSet.Event
            public final void invoke(Object obj) {
    ...
    public void setVolume(float f) {
        verifyApplicationThread();
        final float constrainValue = Util.constrainValue(f, (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    private static long getRequestedContentPositionUs(PlaybackInfo playbackInfo) {
        ...
        if (playbackInfo.requestedContentPositionUs == C0474C.TIME_UNSET) {
    ...
    private PlaybackInfo maskTimelineAndPosition(PlaybackInfo playbackInfo, Timeline timeline, Pair<Object, Long> pair) {
        ...
        if (timeline.isEmpty()) {
            ...
            PlaybackInfo copyWithLoadingMediaPeriodId = copyWithTimeline.copyWithNewPosition(dummyPeriodForEmptyTimeline, msToUs, msToUs, msToUs, 0L, TrackGroupArray.EMPTY, this.emptyTrackSelectorResult, ImmutableList.m754of()).copyWithLoadingMediaPeriodId(dummyPeriodForEmptyTimeline);
            copyWithLoadingMediaPeriodId.bufferedPositionUs = copyWithLoadingMediaPeriodId.positionUs;
        ...
        if (z || longValue < msToUs2) {
            ...
            PlaybackInfo copyWithLoadingMediaPeriodId2 = copyWithTimeline.copyWithNewPosition(mediaPeriodId, longValue, longValue, longValue, 0L, z ? TrackGroupArray.EMPTY : copyWithTimeline.trackGroups, z ? this.emptyTrackSelectorResult : copyWithTimeline.trackSelectorResult, z ? ImmutableList.m754of() : copyWithTimeline.staticMetadata).copyWithLoadingMediaPeriodId(mediaPeriodId);
    ...
    private Pair<Object, Long> getPeriodPositionUsAfterTimelineChanged(Timeline timeline, Timeline timeline2) {
        ...
        return maskWindowPositionMsOrGetPeriodPositionUs(timeline2, -1, C0474C.TIME_UNSET);
    }
    ...
    private void removeSurfaceCallbacks() {
        ...
        if (textureView != null) {
            if (textureView.getSurfaceTextureListener() != this.componentListener) {
                Log.m806w(TAG, "SurfaceTextureListener already unset or replaced.");
            } else {
    ...
    public void updatePlayWhenReady(boolean z, int i, int i2) {
        ...
        updatePlaybackInfo(copyWithPlayWhenReady, 0, i2, false, false, 5, C0474C.TIME_UNSET, -1, false);
    }
    ...
    private void verifyApplicationThread() {
        ...
        if (Thread.currentThread() != getApplicationLooper().getThread()) {
            ...
            Log.m805w(TAG, formatInvariant, this.hasNotifiedFullWrongThreadWarning ? null : new IllegalStateException());
    ...
    private int initializeKeepSessionIdAudioTrack(int i) {
        ...
        if (this.keepSessionIdAudioTrack == null) {
            this.keepSessionIdAudioTrack = new AudioTrack(3, WearableStatusCodes.TARGET_NODE_NOT_CONNECTED, 4, 2, 2, 0, i);
        }
    ...
    private static final class Api31 {
        ...
        public static PlayerId registerMediaMetricsListener(Context context, ExoPlayerImpl exoPlayerImpl, boolean z) {
            ...
            if (create == null) {
                Log.m806w(ExoPlayerImpl.TAG, "MediaMetricsService unavailable.");
