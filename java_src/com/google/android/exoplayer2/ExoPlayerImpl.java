...
public final class ExoPlayerImpl extends BasePlayer implements ExoPlayer, ExoPlayer.AudioComponent, ExoPlayer.VideoComponent, ExoPlayer.TextComponent, ExoPlayer.DeviceComponent {
    ...
    public void prepare() {
        ...
        updatePlaybackInfo(copyWithPlaybackState, 1, 1, false, false, 5, C0483C.TIME_UNSET, -1, false);
    }
    ...
    public void setMediaSources(List<MediaSource> list, boolean z) {
        verifyApplicationThread();
        setMediaSourcesInternal(list, -1, C0483C.TIME_UNSET, z);
    }
    ...
    public void addMediaSources(int i, List<MediaSource> list) {
        ...
        updatePlaybackInfo(maskTimelineAndPosition, 0, 1, false, false, 5, C0483C.TIME_UNSET, -1, false);
    }
    ...
    public long getMaxSeekToPreviousPosition() {
        verifyApplicationThread();
        return C0483C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
    }
    ...
    public void setPlaybackParameters(PlaybackParameters playbackParameters) {
        ...
        updatePlaybackInfo(copyWithPlaybackParameters, 0, 1, false, false, 5, C0483C.TIME_UNSET, -1, false);
    }
    ...
    public void stop(boolean z) {
        ...
        stopInternal(z, null);
        this.currentCueGroup = new CueGroup(ImmutableList.m1057of(), this.playbackInfo.positionUs);
    }
    ...
    public long getContentPosition() {
        ...
        if (isPlayingAd()) {
            ...
            if (playbackInfo2.requestedContentPositionUs == C0483C.TIME_UNSET) {
    ...
    private static long getRequestedContentPositionUs(PlaybackInfo playbackInfo) {
        ...
        if (playbackInfo.requestedContentPositionUs == C0483C.TIME_UNSET) {
    ...
    private PlaybackInfo maskTimelineAndPosition(PlaybackInfo playbackInfo, Timeline timeline, Pair<Object, Long> pair) {
        ...
        if (timeline.isEmpty()) {
            ...
            PlaybackInfo copyWithLoadingMediaPeriodId = copyWithTimeline.copyWithNewPosition(dummyPeriodForEmptyTimeline, msToUs, msToUs, msToUs, 0L, TrackGroupArray.EMPTY, this.emptyTrackSelectorResult, ImmutableList.m1057of()).copyWithLoadingMediaPeriodId(dummyPeriodForEmptyTimeline);
            copyWithLoadingMediaPeriodId.bufferedPositionUs = copyWithLoadingMediaPeriodId.positionUs;
        ...
        if (z || longValue < msToUs2) {
            ...
            PlaybackInfo copyWithLoadingMediaPeriodId2 = copyWithTimeline.copyWithNewPosition(mediaPeriodId, longValue, longValue, longValue, 0L, z ? TrackGroupArray.EMPTY : copyWithTimeline.trackGroups, z ? this.emptyTrackSelectorResult : copyWithTimeline.trackSelectorResult, z ? ImmutableList.m1057of() : copyWithTimeline.staticMetadata).copyWithLoadingMediaPeriodId(mediaPeriodId);
    ...
    private Pair<Object, Long> getPeriodPositionUsAfterTimelineChanged(Timeline timeline, Timeline timeline2) {
        ...
        return maskWindowPositionMsOrGetPeriodPositionUs(timeline2, -1, C0483C.TIME_UNSET);
    }
    ...
    public void updatePlayWhenReady(boolean z, int i, int i2) {
        ...
        updatePlaybackInfo(copyWithPlayWhenReady, 0, i2, false, false, 5, C0483C.TIME_UNSET, -1, false);
    }
