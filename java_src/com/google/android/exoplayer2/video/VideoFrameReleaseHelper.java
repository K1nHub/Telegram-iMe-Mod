...
public final class VideoFrameReleaseHelper {
    ...
    public VideoFrameReleaseHelper(Context context) {
        ...
        this.vsyncDurationNs = C0479C.TIME_UNSET;
        this.vsyncOffsetNs = C0479C.TIME_UNSET;
    ...
    public long adjustReleaseTime(long j) {
        ...
        if (this.lastAdjustedFrameIndex != -1 && this.frameRateEstimator.isSynced()) {
            ...
            if (!adjustmentAllowed(j, frameDurationNs)) {
                ...
                if (vSyncSampler != null || this.vsyncDurationNs == C0479C.TIME_UNSET) {
                    return j2;
                }
                long j3 = vSyncSampler.sampledVsyncTimeNs;
                return j3 == C0479C.TIME_UNSET ? j2 : closestVsync(j2, j3, this.vsyncDurationNs) - this.vsyncOffsetNs;
            }
        }
        j2 = j;
        this.pendingLastAdjustedFrameIndex = this.frameIndex;
    ...
    */
    ...
    public void updateDefaultDisplayRefreshRateParams(Display display) {
        ...
        Log.m1106w(TAG, "Unable to query display refresh rate");
        this.vsyncDurationNs = C0479C.TIME_UNSET;
        this.vsyncOffsetNs = C0479C.TIME_UNSET;
    }
    ...
    public static final class Api30 {
        ...
        public static void setSurfaceFrameRate(Surface surface, float f) {
            try {
                ...
                Log.m1109e(VideoFrameReleaseHelper.TAG, "Failed to call Surface.setFrameRate", e);
            }
        }
    }
    ...
    private static final class VSyncSampler implements Choreographer.FrameCallback, Handler.Callback {
        ...
        public volatile long sampledVsyncTimeNs = C0479C.TIME_UNSET;
        ...
        private void createChoreographerInstanceInternal() {
            try {
                ...
                Log.m1105w(VideoFrameReleaseHelper.TAG, "Vsync sampling disabled due to platform error", e);
            }
        }
        ...
        private void removeObserverInternal() {
            ...
            if (choreographer != null) {
                ...
                if (i == 0) {
                    ...
                    this.sampledVsyncTimeNs = C0479C.TIME_UNSET;
                }
            }
        }
    }
