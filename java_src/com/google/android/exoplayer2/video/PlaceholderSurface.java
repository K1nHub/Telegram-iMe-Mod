        ...
        public boolean handleMessage(Message message) {
            ...
            try {
                ...
                try {
                    ...
                    Log.m799e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e);
                    this.initException = new IllegalStateException(e);
                    synchronized (this) {
                        notify();
                    }
                } catch (Error e2) {
                    Log.m799e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e2);
                    this.initError = e2;
                    synchronized (this) {
                        notify();
                    }
                } catch (RuntimeException e3) {
                    Log.m799e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e3);
