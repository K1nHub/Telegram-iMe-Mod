...
public final class StreamVolumeManager {
    ...
    public StreamVolumeManager(Context context, Handler handler, Listener listener) {
        ...
        try {
            ...
            Log.m1106w(TAG, "Error registering stream volume receiver", e);
        }
    }
    ...
    public void release() {
        ...
        if (volumeChangeReceiver != null) {
            try {
                ...
                Log.m1106w(TAG, "Error unregistering stream volume receiver", e);
            }
            this.receiver = null;
        }
    }
    ...
    private static int getVolumeFromManager(AudioManager audioManager, int i) {
        try {
            ...
            Log.m1106w(TAG, "Could not retrieve stream volume for stream type " + i, e);
