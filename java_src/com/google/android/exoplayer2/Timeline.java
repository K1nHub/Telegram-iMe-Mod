...
public abstract class Timeline implements Bundleable {
    ...
    public static final class Window implements Bundleable {
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(FIELD_PRESENTATION_START_TIME_MS, C0480C.TIME_UNSET);
            long j2 = bundle.getLong(FIELD_WINDOW_START_TIME_MS, C0480C.TIME_UNSET);
            long j3 = bundle.getLong(FIELD_ELAPSED_REALTIME_EPOCH_OFFSET_MS, C0480C.TIME_UNSET);
            ...
            long j5 = bundle.getLong(FIELD_DURATION_US, C0480C.TIME_UNSET);
    ...
    public static final class Period implements Bundleable {
        ...
        public long getAdDurationUs(int i, int i2) {
            ...
            return adGroup.count != -1 ? adGroup.durationsUs[i2] : C0480C.TIME_UNSET;
        }
        ...
        public static Period fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(FIELD_DURATION_US, C0480C.TIME_UNSET);
