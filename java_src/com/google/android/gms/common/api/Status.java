...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    final int zzb;
    @SafeParcelable.Field(getter = "getStatusCode", m1090id = 1)
    private final int zzc;
    @SafeParcelable.Field(getter = "getStatusMessage", m1090id = 2)
    private final String zzd;
    @SafeParcelable.Field(getter = "getPendingIntent", m1090id = 3)
    private final PendingIntent zze;
    @SafeParcelable.Field(getter = "getConnectionResult", m1090id = 4)
    ...
    public Status(@SafeParcelable.Param(m1089id = 1000) int i, @SafeParcelable.Param(m1089id = 1) int i2, @SafeParcelable.Param(m1089id = 2) String str, @SafeParcelable.Param(m1089id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m1089id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
