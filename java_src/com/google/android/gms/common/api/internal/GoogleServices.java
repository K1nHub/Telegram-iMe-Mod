...
import com.google.android.gms.common.C0703R;
...
public final class GoogleServices {
    ...
    GoogleServices(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C0703R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
