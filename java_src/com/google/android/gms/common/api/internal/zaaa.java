...
public final class zaaa implements zaca {
    ...
    private final PendingIntent zaz() {
        ...
        return PendingIntent.getActivity(this.zaa, System.identityHashCode(this.zab), this.zah.getSignInIntent(), com.google.android.gms.internal.base.zap.zaa | C0475C.BUFFER_FLAG_FIRST_SAMPLE);
    }
