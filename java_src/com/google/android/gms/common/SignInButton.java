...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zad = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0702R.styleable.SignInButton, 0, 0);
        try {
            this.zaa = obtainStyledAttributes.getInt(C0702R.styleable.SignInButton_buttonSize, 0);
            this.zab = obtainStyledAttributes.getInt(C0702R.styleable.SignInButton_colorScheme, 2);
