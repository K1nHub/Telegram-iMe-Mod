...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getApiFeatures", m1090id = 1)
    private final List zab;
    @SafeParcelable.Field(getter = "getIsUrgent", m1090id = 2)
    private final boolean zac;
    @SafeParcelable.Field(getter = "getFeatureRequestSessionId", m1090id = 3)
    private final String zad;
    @SafeParcelable.Field(getter = "getCallingPackage", m1090id = 4)
    private final String zae;

    @SafeParcelable.Constructor
    public ApiFeatureRequest(@SafeParcelable.Param(m1089id = 1) List list, @SafeParcelable.Param(m1089id = 2) boolean z, @SafeParcelable.Param(m1089id = 3) String str, @SafeParcelable.Param(m1089id = 4) String str2) {
