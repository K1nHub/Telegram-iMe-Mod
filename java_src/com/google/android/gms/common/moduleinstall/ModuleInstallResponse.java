...
public class ModuleInstallResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "false", getter = "getShouldUnregisterListener", m789id = 2)
    ...
    public ModuleInstallResponse(@SafeParcelable.Param(m788id = 1) int i, @SafeParcelable.Param(m788id = 2) boolean z) {
        this.zaa = i;
        this.zab = z;
    }
}
