...
public class ModuleInstallResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "false", getter = "getShouldUnregisterListener", m775id = 2)
    ...
    public ModuleInstallResponse(@SafeParcelable.Param(m774id = 1) int i, @SafeParcelable.Param(m774id = 2) boolean z) {
        this.zaa = i;
        this.zab = z;
    }
}
