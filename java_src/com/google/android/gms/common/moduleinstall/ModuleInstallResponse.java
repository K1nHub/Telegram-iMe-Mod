...
public class ModuleInstallResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "false", getter = "getShouldUnregisterListener", m1090id = 2)
    ...
    public ModuleInstallResponse(@SafeParcelable.Param(m1089id = 1) int i, @SafeParcelable.Param(m1089id = 2) boolean z) {
        this.zaa = i;
        this.zab = z;
    }
}
