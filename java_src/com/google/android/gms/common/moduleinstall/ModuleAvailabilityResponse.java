...
public class ModuleAvailabilityResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "areModulesAvailable", m779id = 1)
    private final boolean zaa;
    @SafeParcelable.Field(getter = "getAvailabilityStatus", m779id = 2)
    ...
    @KeepForSdk
    public ModuleAvailabilityResponse(@SafeParcelable.Param(m778id = 1) boolean z, @SafeParcelable.Param(m778id = 2) int i) {
        this.zaa = z;
        this.zab = i;
    }
