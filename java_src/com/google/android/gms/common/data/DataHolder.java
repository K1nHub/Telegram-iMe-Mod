...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    int zad;
    boolean zae;
    @SafeParcelable.Field(getter = "getColumns", m1090id = 1)
    private final String[] zag;
    @SafeParcelable.Field(getter = "getWindows", m1090id = 2)
    private final CursorWindow[] zah;
    @SafeParcelable.Field(getter = "getStatusCode", m1090id = 3)
    private final int zai;
    @SafeParcelable.Field(getter = "getMetadata", m1090id = 4)
    ...
    public DataHolder(@SafeParcelable.Param(m1089id = 1000) int i, @SafeParcelable.Param(m1089id = 1) String[] strArr, @SafeParcelable.Param(m1089id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(m1089id = 3) int i2, @SafeParcelable.Param(m1089id = 4) Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = i;
        this.zag = strArr;
