...
public final class zzc extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "false", m789id = 1)
    ...
    public zzc(@SafeParcelable.Param(m788id = 1) boolean z, @SafeParcelable.Param(m788id = 3) long j, @SafeParcelable.Param(m788id = 2) long j2) {
        this.zzad = z;
        this.zzae = j;
        this.zzaf = j2;
    }
