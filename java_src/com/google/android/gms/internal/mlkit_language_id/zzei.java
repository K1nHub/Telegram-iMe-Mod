...
final /* synthetic */ class zzei {
    ...
    static {
        ...
        zza = iArr2;
        try {
            iArr2[zzhy.INT.ordinal()] = 1;
        } catch (NoSuchFieldError unused19) {
        }
        try {
            zza[zzhy.LONG.ordinal()] = 2;
        } catch (NoSuchFieldError unused20) {
        }
        try {
            zza[zzhy.FLOAT.ordinal()] = 3;
        } catch (NoSuchFieldError unused21) {
        }
        try {
            zza[zzhy.DOUBLE.ordinal()] = 4;
        } catch (NoSuchFieldError unused22) {
        }
        try {
            zza[zzhy.BOOLEAN.ordinal()] = 5;
        } catch (NoSuchFieldError unused23) {
        }
        try {
            zza[zzhy.STRING.ordinal()] = 6;
        } catch (NoSuchFieldError unused24) {
        }
        try {
            zza[zzhy.BYTE_STRING.ordinal()] = 7;
        } catch (NoSuchFieldError unused25) {
        }
        try {
            zza[zzhy.ENUM.ordinal()] = 8;
        } catch (NoSuchFieldError unused26) {
        }
        try {
            zza[zzhy.MESSAGE.ordinal()] = 9;
