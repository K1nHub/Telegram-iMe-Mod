        ...
        if (this.zzj) {
            ...
            while (i5 < this.zzc.length) {
                ...
                switch (i7) {
                    ...
                    case 1:
                        if (zza((zzgd<T>) t, i5)) {
                            zzb3 = zzea.zzb(i8, (float) BitmapDescriptorFactory.HUE_RED);
                            break;
                        } else {
                            continue;
                            i5 += 3;
        ...
        while (i10 < this.zzc.length) {
            ...
            switch (i15) {
                ...
                case 1:
                    j = 0;
                    if ((i13 & i) != 0) {
                        i11 += zzea.zzb(i14, (float) BitmapDescriptorFactory.HUE_RED);
                        break;
                    }
                    break;
                case 2:
                ...
                case 52:
                    if (zza((zzgd<T>) t, i14, i10)) {
                        zzj = zzea.zzb(i14, (float) BitmapDescriptorFactory.HUE_RED);
                        i11 += zzj;
                    }
                    j = 0;
                    i10 += 3;
