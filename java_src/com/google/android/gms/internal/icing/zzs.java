...
public final class zzs extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, m789id = 4)
    ...
    public zzs(@SafeParcelable.Param(m788id = 1) String str, @SafeParcelable.Param(m788id = 2) String str2, @SafeParcelable.Param(m788id = 3) boolean z, @SafeParcelable.Param(m788id = 4) int i, @SafeParcelable.Param(m788id = 5) boolean z2, @SafeParcelable.Param(m788id = 6) String str3, @SafeParcelable.Param(m788id = 7) zzm[] zzmVarArr, @SafeParcelable.Param(m788id = 11) String str4, @SafeParcelable.Param(m788id = 12) zzu zzuVar) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = z;
        this.zzd = i;
