...
public final class zzx extends AbstractSafeParcelable {
    ...
    final zzg zze;
    @SafeParcelable.Field(defaultValue = "false", m797id = 6)
    final boolean zzf;
    ...
    public zzx(@SafeParcelable.Param(m796id = 1) zzi zziVar, @SafeParcelable.Param(m796id = 2) long j, @SafeParcelable.Param(m796id = 3) int i, @SafeParcelable.Param(m796id = 4) String str, @SafeParcelable.Param(m796id = 5) zzg zzgVar, @SafeParcelable.Param(m796id = 6) boolean z, @SafeParcelable.Param(m796id = 7) int i2, @SafeParcelable.Param(m796id = 8) int i3, @SafeParcelable.Param(m796id = 9) String str2) {
        this.zza = zziVar;
        this.zzb = j;
        this.zzc = i;
        this.zzd = str;
