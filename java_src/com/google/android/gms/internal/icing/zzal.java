...
public final class zzal implements AppIndexApi, zzz {
    ...
    private static void zzc(String str, Uri uri) {
        if (uri == null || !zzd(uri)) {
            if (uri == null || !zze(uri)) {
                ...
                if (pathSegments.isEmpty() || pathSegments.get(0).isEmpty()) {
                    String valueOf2 = String.valueOf(uri);
                    StringBuilder sb2 = new StringBuilder(valueOf2.length() + 128);
                ...
                StringBuilder sb3 = new StringBuilder(valueOf3.length() + ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        ...
        StringBuilder sb4 = new StringBuilder(valueOf4.length() + 98);
