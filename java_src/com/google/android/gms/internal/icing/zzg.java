...
public final class zzg extends AbstractSafeParcelable {
    ...
    public zzg(@SafeParcelable.Param(m774id = 1) zzk[] zzkVarArr, @SafeParcelable.Param(m774id = 2) String str, @SafeParcelable.Param(m774id = 3) boolean z, @SafeParcelable.Param(m774id = 4) Account account) {
        this.zza = zzkVarArr;
        this.zzb = str;
        this.zzc = z;
        this.zzd = account;
