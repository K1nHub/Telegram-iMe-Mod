    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzA2 == zzA) {
                int i2 = i + zzA2;
                this.zzd = i2;
                int zzb = zzmx.zzb(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzq((zzb - i) - zzA2);
                this.zzd = zzb;
                return;
            ...
            byte[] bArr = this.zzb;
            int i3 = this.zzd;
            this.zzd = zzmx.zzb(str, bArr, i3, this.zzc - i3);
        } catch (zzmw e) {
            this.zzd = i;
            zzE(str, e);
    ...
    public final void zzs(long j) throws IOException {
        ...
        if (z && this.zzc - this.zzd >= 10) {
            while ((j & (-128)) != 0) {
                ...
                int i = this.zzd;
                this.zzd = i + 1;
                zzms.zzn(bArr, i, (byte) ((((int) j) & MessagesStorage.LAST_DB_VERSION) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zzb;
            int i2 = this.zzd;
            this.zzd = i2 + 1;
            zzms.zzn(bArr2, i2, (byte) j);
            return;
        }
        while ((j & (-128)) != 0) {
            try {
