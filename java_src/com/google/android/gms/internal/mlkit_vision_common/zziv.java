...
public enum zziv implements zzag {
    ...
    OPTIONAL_MODULE_NLCLASSIFIER_INFERENCE(WalletConstants.ERROR_CODE_ILLEGAL_CALLER),
    OPTIONAL_MODULE_NLCLASSIFIER_RELEASE(WalletConstants.ERROR_CODE_APP_LABEL_UNAVAILABLE),
