...
public final class zzab extends AbstractSafeParcelable {
    ...
    public zzab(@SafeParcelable.Param(m788id = 2) int i, @SafeParcelable.Param(m788id = 3) int i2, @SafeParcelable.Param(m788id = 4) int i3, @SafeParcelable.Param(m788id = 5) int i4, @SafeParcelable.Param(m788id = 6) float f) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = i3;
        this.zzd = i4;
