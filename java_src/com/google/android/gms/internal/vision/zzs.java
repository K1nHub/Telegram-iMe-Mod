...
public final class zzs extends AbstractSafeParcelable {
    ...
    public zzs(@SafeParcelable.Param(m778id = 2) int i, @SafeParcelable.Param(m778id = 3) int i2, @SafeParcelable.Param(m778id = 4) int i3, @SafeParcelable.Param(m778id = 5) long j, @SafeParcelable.Param(m778id = 6) int i4) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = i3;
        this.zzd = j;
