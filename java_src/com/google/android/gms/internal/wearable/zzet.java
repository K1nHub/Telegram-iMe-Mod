...
public final class zzet {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String zzd(byte[] bArr, int i, int i2) throws zzcf {
        ...
        while (i < i3) {
            ...
            if (zzep.zzd(b2)) {
                ...
                if (i5 < i3 - 1) {
                    int i7 = i5 + 1;
                    zzep.zzb(b2, bArr[i5], bArr[i7], cArr, i4);
                    i = i7 + 1;
                    i4++;
                } else {
                    throw zzcf.zzc();
                ...
                int i8 = i5 + 1;
                int i9 = i8 + 1;
                zzep.zza(b2, bArr[i5], bArr[i8], bArr[i9], cArr, i4);
                i4 += 2;
                i = i9 + 1;
            } else {
                throw zzcf.zzc();
