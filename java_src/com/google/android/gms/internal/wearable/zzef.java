...
public final class zzef {
    ...
    public static zzef zzd(zzef zzefVar, zzef zzefVar2) {
        int i = zzefVar.zzb + zzefVar2.zzb;
        int[] copyOf = Arrays.copyOf(zzefVar.zzc, i);
        System.arraycopy(zzefVar2.zzc, 0, copyOf, zzefVar.zzb, zzefVar2.zzb);
        Object[] copyOf2 = Arrays.copyOf(zzefVar.zzd, i);
            ...
            for (int i4 = 0; i4 < this.zzb; i4++) {
                ...
                if (i7 != 0) {
                    if (i7 == 1) {
                        ...
                        int zzA2 = zzbe.zzA(i6 << 3);
                        int zzd = ((zzaw) this.zzd[i4]).zzd();
                        i3 += zzA2 + zzbe.zzA(zzd) + zzd;
                    } else if (i7 == 3) {
                        int zzz = zzbe.zzz(i6);
                        zzA = zzz + zzz;
                        zzB = ((zzef) this.zzd[i4]).zza();
                    } else if (i7 == 5) {
    ...
    public final int zzb() {
        ...
        if (i == -1) {
            ...
            for (int i3 = 0; i3 < this.zzb; i3++) {
                int i4 = this.zzc[i3];
                int zzA = zzbe.zzA(8);
                int zzd = ((zzaw) this.zzd[i3]).zzd();
                i2 += zzA + zzA + zzbe.zzA(16) + zzbe.zzA(i4 >>> 3) + zzbe.zzA(24) + zzbe.zzA(zzd) + zzd;
            }
            this.zze = i2;
            return i2;
        }
    ...
    public final void zzg(StringBuilder sb, int i) {
        for (int i2 = 0; i2 < this.zzb; i2++) {
            zzde.zzb(sb, i, String.valueOf(this.zzc[i2] >>> 3), this.zzd[i2]);
        }
    }
    ...
    public final void zzi(zzew zzewVar) throws IOException {
        if (this.zzb != 0) {
            for (int i = 0; i < this.zzb; i++) {
                ...
                int i4 = i2 & 7;
                if (i4 == 0) {
                    zzewVar.zzt(i3, ((Long) obj).longValue());
                } else if (i4 == 1) {
                    zzewVar.zzm(i3, ((Long) obj).longValue());
                } else if (i4 == 2) {
                    zzewVar.zzd(i3, (zzaw) obj);
                } else if (i4 == 3) {
                    zzewVar.zzE(i3);
                    ((zzef) obj).zzi(zzewVar);
                    zzewVar.zzh(i3);
                } else if (i4 == 5) {
                    zzewVar.zzk(i3, ((Integer) obj).intValue());
                } else {
