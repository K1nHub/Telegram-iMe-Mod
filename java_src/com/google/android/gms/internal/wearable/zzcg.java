...
public final class zzcg {
    ...
    static {
        ...
        zzc = zzcgVar3;
        zzcg zzcgVar4 = new zzcg("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf((float) BitmapDescriptorFactory.HUE_RED));
        zzd = zzcgVar4;
        zzcg zzcgVar5 = new zzcg("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(0.0d));
        zze = zzcgVar5;
    ...
    private zzcg(String str, int i, Class cls, Class cls2, Object obj) {
        this.zzl = cls;
        this.zzm = cls2;
        this.zzn = obj;
    }
