...
public final class zzom {
    ...
    public final void zza(String str, zzor zzorVar) throws FirebaseMLException {
        ...
        gmsLogger.m1098e("ModelFileHelper", valueOf.length() != 0 ? "Failed to delete the temp labels file directory: ".concat(valueOf) : new String("Failed to delete the temp labels file directory: "));
    }
    ...
    private final File zza(String str, zzor zzorVar, boolean z) throws FirebaseMLException {
        ...
        if (!zzb.exists()) {
            ...
            gmsLogger.m1100d("ModelFileHelper", valueOf.length() != 0 ? "model folder does not exist, creating one: ".concat(valueOf) : new String("model folder does not exist, creating one: "));
            zzb.mkdirs();
    ...
    public static int zzb(File file) {
        ...
        for (File file2 : listFiles) {
            try {
                ...
                gmsLogger.m1100d("ModelFileHelper", valueOf.length() != 0 ? "Contains non-integer file name ".concat(valueOf) : new String("Contains non-integer file name "));
            }
        }
        return i;
    }
