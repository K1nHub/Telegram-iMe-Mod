...
public class zzon {
        ...
        if (zzpkVar != null) {
            try {
                ...
                if (load != null) {
                    try {
                        zzoqVar.zza(load);
                        zzass.m789d("ModelLoader", "Remote model source is loaded successfully");
                        return true;
                ...
                zzass.m789d("ModelLoader", "Remote model source can NOT be loaded, try local model.");
    ...
    private final synchronized boolean zzb(zzoq zzoqVar, List<zzmc> list) throws FirebaseMLException {
        ...
        try {
            zzoqVar.zza(load);
            zzass.m789d("ModelLoader", "Local model source is loaded successfully");
            return true;
        } catch (RuntimeException e) {
