    ...
    public final int zzaa(T t) {
        ...
        if (this.zzbvm) {
            ...
            while (i8 < this.zzbvf.length) {
                ...
                int i12 = (i10 < zzur.zzbrj.m1077id() || i10 > zzur.zzbrw.m1077id()) ? 0 : this.zzbvf[i8 + 2] & 1048575;
                switch (i10) {
                    case 0:
                        if (zza((zzwi<T>) t, i8)) {
        ...
        while (i14 < this.zzbvf.length) {
            ...
            if (i18 <= 17) {
                ...
                i = (!this.zzbvn || i18 < zzur.zzbrj.m1077id() || i18 > zzur.zzbrw.m1077id()) ? 0 : this.zzbvf[i14 + 2] & 1048575;
                i2 = 0;
            }
