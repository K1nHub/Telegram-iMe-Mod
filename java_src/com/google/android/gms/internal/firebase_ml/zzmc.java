...
public enum zzmc implements zzuz {
    NO_ERROR(0),
    ...
    private static final zzuy<zzmc> zzj = new zzuy<zzmc>() { // from class: com.google.android.gms.internal.firebase_ml.zzmb
    };
