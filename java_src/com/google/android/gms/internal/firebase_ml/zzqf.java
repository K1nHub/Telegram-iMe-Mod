...
public final class zzqf implements zzno<zzit, zzqe> {
    ...
    private static String zzd(FirebaseApp firebaseApp) {
        ...
        try {
            ...
            gmsLogger.m786e("ImageAnnotatorTask", valueOf.length() != 0 ? "No such package: ".concat(valueOf) : new String("No such package: "), e);
            return apiKey;
        }
    }
    ...
    public static String zzb(Context context, String str) {
        try {
            ...
            if (packageCertificateHashBytes == null) {
                ...
                gmsLogger.m787e("ImageAnnotatorTask", valueOf.length() != 0 ? "Could not get fingerprint hash: ".concat(valueOf) : new String("Could not get fingerprint hash: "));
                return null;
            }
            ...
            gmsLogger2.m786e("ImageAnnotatorTask", valueOf2.length() != 0 ? "No such package: ".concat(valueOf2) : new String("No such package: "), e);
            return null;
        }
    }
        ...
        try {
            ...
            if (this.zzbal) {
                ...
                if (TextUtils.isEmpty(spatulaHeader)) {
                    zzass.m787e("ImageAnnotatorTask", "Failed to contact Google Play services for certificate fingerprint matching. Please ensure you have latest Google Play services installed");
            ...
            sb.append(valueOf);
            gmsLogger.m787e("ImageAnnotatorTask", sb.toString());
            if (this.zzbal) {
            ...
            zzass.m786e("ImageAnnotatorTask", "batchAnnotateImages call failed with exception: ", e2);
