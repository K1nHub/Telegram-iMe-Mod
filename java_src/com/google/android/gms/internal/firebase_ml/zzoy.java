...
public final class zzoy {
    ...
    public static zzpe zza(FirebaseApp firebaseApp, FirebaseRemoteModel firebaseRemoteModel, zzpa zzpaVar) throws FirebaseMLException {
        ...
        gmsLogger.m789d("ModelInfoRetriever", valueOf.length() != 0 ? "Received download URL: ".concat(valueOf) : new String("Received download URL: "));
        if (headerField == null) {
            return null;
        }
    ...
    private static String zza(FirebaseApp firebaseApp, String str, zzpa zzpaVar) throws FirebaseMLException {
        ...
        if (firebaseInstanceId == null) {
            zzass.m781w("ModelInfoRetriever", "Cannot get a valid instance of FirebaseInstanceId. Cannot retrieve model info.");
            return null;
        }
        String id = firebaseInstanceId.getId();
        if (id == null) {
            zzass.m781w("ModelInfoRetriever", "Firebase instance id is null. Cannot retrieve model info.");
            return null;
        }
        try {
            String token = firebaseInstanceId.getToken(gcmSenderId, "*");
            if (token == null) {
                zzass.m781w("ModelInfoRetriever", "Firebase instance token is null. Cannot retrieve model info.");
                return null;
            }
