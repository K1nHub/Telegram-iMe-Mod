...
public final class zzod implements zzoo {
    ...
    public final File zza(File file) throws FirebaseMLException {
        ...
        if (file.renameTo(file2) && zza.renameTo(file3)) {
            zzass.m1100d("AutoMLModelFileManager", "Rename to serving model successfully");
        ...
        gmsLogger.m1100d("AutoMLModelFileManager", "Rename to serving model failed, remove the temp file.");
        if (!file.delete()) {
            String valueOf2 = String.valueOf(file.getAbsolutePath());
            gmsLogger.m1100d("AutoMLModelFileManager", valueOf2.length() != 0 ? "Failed to delete the temp model file: ".concat(valueOf2) : new String("Failed to delete the temp model file: "));
        }
        if (zza.delete()) {
            return null;
        }
        String valueOf3 = String.valueOf(zza.getAbsolutePath());
        gmsLogger.m1100d("AutoMLModelFileManager", valueOf3.length() != 0 ? "Failed to delete the temp labels file: ".concat(valueOf3) : new String("Failed to delete the temp labels file: "));
        return null;
    }
    ...
    public static File zza(FirebaseApp firebaseApp, String str) throws FirebaseMLException {
        ...
        if (!zzd.exists()) {
            ...
            gmsLogger.m1100d("AutoMLModelFileManager", valueOf2.length() != 0 ? "Temp labels folder does not exist, creating one: ".concat(valueOf2) : new String("Temp labels folder does not exist, creating one: "));
            if (!zzd.mkdirs()) {
