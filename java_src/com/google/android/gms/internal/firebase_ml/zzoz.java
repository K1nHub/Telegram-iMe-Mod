...
public final class zzoz {
    ...
    private zzoz(FirebaseApp firebaseApp, FirebaseRemoteModel firebaseRemoteModel, zzok zzokVar, zzpa zzpaVar) {
        ...
        if (downloadManager == null) {
            zzass.m1100d("ModelDownloadManager", "Download manager service is not available in the service.");
        }
        this.zzavq = zzokVar;
        this.zzavp = zzpaVar;
    ...
    public final synchronized Long zzmb() throws FirebaseMLException {
        ...
        if (zzmh == null) {
            ...
            gmsLogger.m1100d("ModelDownloadManager", valueOf.length() != 0 ? "No model updates for model: ".concat(valueOf) : new String("No model updates for model: "));
            return null;
        }
        return zzb(zzmh);
    }
    ...
    public final synchronized void zzme() throws FirebaseMLException {
        ...
        if (this.zzavn != null && zzmc != null) {
            ...
            sb.append(valueOf);
            gmsLogger.m1100d("ModelDownloadManager", sb.toString());
    ...
    */
    ...
    public final synchronized ParcelFileDescriptor zzmg() {
        ...
        try {
            ...
            zzass.m1098e("ModelDownloadManager", "Downloaded file is not found");
        }
    ...
    private final synchronized zzpe zzmh() throws FirebaseMLException {
        ...
        if (str.equals(zzc.zze(firebaseRemoteModel)) && zznm.zza(firebaseApp.getApplicationContext()).equals(zzc.zzlt())) {
            zzass.m1098e("ModelDownloadManager", "The model is incompatible with TFLite and the app is not upgraded, do not download");
        } else {
            z = true;
        }
        if (!zzmj) {
    ...
    private final synchronized Long zzb(zzpe zzpeVar) throws FirebaseMLException {
        ...
        if (zzb != null) {
            ...
            if (zzb.equals(str) && zzmf != null) {
                ...
                zzass.m1100d("ModelDownloadManager", "New model is already in downloading, do nothing.");
                return null;
            }
        }
        GmsLogger gmsLogger = zzass;
        gmsLogger.m1100d("ModelDownloadManager", "Need to download a new model.");
        zzme();
        uri = zzpeVar.zzavz;
        ...
        if (this.zzavq.zza(zzpeVar)) {
            if (!this.zzavo.isModelUpdatesEnabled()) {
                gmsLogger.m1100d("ModelDownloadManager", "Model update is disabled and have a previous downloaded model, skip downloading");
                return null;
            }
            gmsLogger.m1100d("ModelDownloadManager", "Model update is enabled and have a previous downloaded model, use download condition");
        ...
        gmsLogger.m1100d("ModelDownloadManager", "Use initial download conditions.");
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x0095, code lost:
        com.google.android.gms.internal.firebase_ml.zzoz.zzass.m1096i("ModelDownloadManager", "Didn't schedule download for the updated model");
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.google.android.gms.tasks.Task<java.lang.Void> zzmi() {
        ...
        L95:
            ...
            r1.m1096i(r2, r4)     // Catch: com.google.firebase.p020ml.common.FirebaseMLException -> Lb9
        L9e:
            if (r5 == 0) goto Lb4
