...
interface zzyj {
    ...
    void zza(int i, zztn zztnVar) throws IOException;

    <K, V> void zza(int i, zzvz<K, V> zzvzVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzwu zzwuVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzwu zzwuVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzwu zzwuVar) throws IOException;

    void zzb(int i, String str) throws IOException;

    void zzb(int i, List<zztn> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzwu zzwuVar) throws IOException;
    ...
    @Deprecated
    void zzdg(int i) throws IOException;
    ...
    void zzl(int i, int i2) throws IOException;
    ...
    void zzt(int i, int i2) throws IOException;
}
