    ...
    */
    private static java.lang.String zzh(java.io.File r8) throws java.io.IOException {
        ...
        L4f:
            ...
            r8.m797e(r0, r2)     // Catch: java.lang.Throwable -> L78
            if (r3 == 0) goto L77
            r3.close()
            goto L77
        L5c:
    ...
    public static boolean zza(File file, String str) {
        ...
        try {
            ...
            gmsLogger.m799d("RemoteModelUtils", valueOf.length() != 0 ? "Failed to close the tmp FileInputStream: ".concat(valueOf) : new String("Failed to close the tmp FileInputStream: "));
            str2 = "";
        }
        GmsLogger gmsLogger2 = zzass;
        String valueOf2 = String.valueOf(str2);
        gmsLogger2.m799d("RemoteModelUtils", valueOf2.length() != 0 ? "Calculated hash value is: ".concat(valueOf2) : new String("Calculated hash value is: "));
