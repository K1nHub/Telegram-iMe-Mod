...
public final class zzq extends AbstractSafeParcelable {
    ...
    public zzq(@SafeParcelable.Param(m778id = 1) String[] strArr, @SafeParcelable.Param(m778id = 2) int[] iArr, @SafeParcelable.Param(m778id = 3) RemoteViews remoteViews, @SafeParcelable.Param(m778id = 4) byte[] bArr) {
        this.zza = strArr;
        this.zzb = iArr;
