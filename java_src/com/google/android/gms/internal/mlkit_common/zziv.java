        ...
        while (i4 < length) {
            ...
            if (charAt3 >= c || j4 >= j5) {
                if (charAt3 < 2048 && j4 <= j5 - 2) {
                    ...
                    zzip.zza(bArr, j6, (byte) ((charAt3 & '?') | 128));
                    j2 = j6 + j;
                    j3 = j;
                    ...
                    if (j4 <= j5 - 4) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt3, charAt4)) {
                                ...
                                long j8 = j7 + 1;
                                zzip.zza(bArr, j7, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j9 = j8 + 1;
                                zzip.zza(bArr, j8, (byte) (((codePoint >>> 6) & 63) | 128));
                                j3 = 1;
                                j2 = j9 + 1;
                                zzip.zza(bArr, j9, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                            } else {
                                i4 = i5;
                            }
                    ...
                    long j10 = j4 + j;
                    zzip.zza(bArr, j4, (byte) ((charAt3 >>> '\f') | LiteMode.FLAGS_CHAT));
                    long j11 = j10 + j;
                    zzip.zza(bArr, j10, (byte) (((charAt3 >>> 6) & 63) | 128));
                    zzip.zza(bArr, j11, (byte) ((charAt3 & '?') | 128));
                    j2 = j11 + 1;
                    j3 = 1;
                }
                i4++;
