...
public final class zzao extends AbstractSafeParcelable implements CapabilityInfo {
    ...
    @SafeParcelable.Field(getter = "getNodeParcelables", m1090id = 3)
    private final List zzc;
    private final Object zza = new Object();
    private Set zzd = null;

    @SafeParcelable.Constructor
    public zzao(@SafeParcelable.Param(m1089id = 2) String str, @SafeParcelable.Param(m1089id = 3) List list) {
        this.zzb = str;
        this.zzc = list;
