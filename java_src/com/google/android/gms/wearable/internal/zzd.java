...
public final class zzd extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getListenerAsBinder", m1090id = 2, type = "android.os.IBinder")
    ...
    public zzd(@SafeParcelable.Param(m1089id = 2) IBinder iBinder, @SafeParcelable.Param(m1089id = 3) IntentFilter[] intentFilterArr, @SafeParcelable.Param(m1089id = 4) String str, @SafeParcelable.Param(m1089id = 5) String str2) {
        if (iBinder != null) {
