...
public final class zzdi extends AbstractSafeParcelable implements DataItem {
    ...
    @SafeParcelable.Field(getter = "getAssetsInternal", m789id = 4, type = "android.os.Bundle")
    ...
    public zzdi(@SafeParcelable.Param(m788id = 2) Uri uri, @SafeParcelable.Param(m788id = 4) Bundle bundle, @SafeParcelable.Param(m788id = 5) byte[] bArr) {
        this.zza = uri;
