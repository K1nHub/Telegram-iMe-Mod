...
public final class zzbq extends AbstractSafeParcelable implements Channel, ChannelClient.Channel {
    ...
    @SafeParcelable.Field(getter = "getNodeId", m1090id = 3)
    private final String zzb;
    @SafeParcelable.Field(getter = "getPath", m1090id = 4)
    private final String zzc;

    @SafeParcelable.Constructor
    public zzbq(@SafeParcelable.Param(m1089id = 2) String str, @SafeParcelable.Param(m1089id = 3) String str2, @SafeParcelable.Param(m1089id = 4) String str3) {
