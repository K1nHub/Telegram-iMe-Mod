...
public class VisionClearcutLogger {
    ...
    public final void zza(int i, zzfi.zzo zzoVar) {
        byte[] zzh = zzoVar.zzh();
        if (i < 0 || i > 3) {
            C0714L.m754i("Illegal event code: %d", Integer.valueOf(i));
            return;
        }
        try {
            if (this.zzb) {
            ...
            try {
                ...
                C0714L.m756e("Would have logged:\n%s", zza.toString());
            } catch (Exception e) {
                C0714L.m755e(e, "Parsing error", new Object[0]);
            }
        } catch (Exception e2) {
            zzfe.zza(e2);
            C0714L.m755e(e2, "Failed to log", new Object[0]);
        }
    }
}
