...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getLocationSettingsStates", m1090id = 2)
    private final LocationSettingsStates zzb;

    @SafeParcelable.Constructor
    public LocationSettingsResult(@SafeParcelable.Param(m1089id = 1) Status status, @SafeParcelable.Param(m1089id = 2) LocationSettingsStates locationSettingsStates) {
        this.zza = status;
