...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", m775id = 1)
    private final List zza;
    @SafeParcelable.Field(getter = "getExtras", m775id = 2)
    private Bundle zzb;

    public ActivityTransitionResult(@SafeParcelable.Param(m774id = 1) List<ActivityTransitionEvent> list) {
        this.zzb = null;
    ...
    public ActivityTransitionResult(@SafeParcelable.Param(m774id = 1) List list, @SafeParcelable.Param(m774id = 2) Bundle bundle) {
        this(list);
        this.zzb = bundle;
    }
}
