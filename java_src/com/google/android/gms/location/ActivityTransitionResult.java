...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", m789id = 1)
    private final List zza;
    @SafeParcelable.Field(getter = "getExtras", m789id = 2)
    private Bundle zzb;

    public ActivityTransitionResult(@SafeParcelable.Param(m788id = 1) List<ActivityTransitionEvent> list) {
        this.zzb = null;
    ...
    public ActivityTransitionResult(@SafeParcelable.Param(m788id = 1) List list, @SafeParcelable.Param(m788id = 2) Bundle bundle) {
        this(list);
        this.zzb = bundle;
    }
}
