...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getElapsedRealTimeNanos", m779id = 3)
    private final long zzc;

    @SafeParcelable.Constructor
    public ActivityTransitionEvent(@SafeParcelable.Param(m778id = 1) int i, @SafeParcelable.Param(m778id = 2) int i2, @SafeParcelable.Param(m778id = 3) long j) {
