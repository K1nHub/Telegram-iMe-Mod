...
public final class zzaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStartHour", m789id = 1)
    private final int zza;
    @SafeParcelable.Field(getter = "getStartMinute", m789id = 2)
    private final int zzb;
    @SafeParcelable.Field(getter = "getEndHour", m789id = 3)
    private final int zzc;
    @SafeParcelable.Field(getter = "getEndMinute", m789id = 4)
    private final int zzd;

    @SafeParcelable.Constructor
    public zzaj(@SafeParcelable.Param(m788id = 1) int i, @SafeParcelable.Param(m788id = 2) int i2, @SafeParcelable.Param(m788id = 3) int i3, @SafeParcelable.Param(m788id = 4) int i4) {
