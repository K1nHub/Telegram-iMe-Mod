...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    */
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(m1089id = 1) List list, @SafeParcelable.Param(m1089id = 2) long j, @SafeParcelable.Param(m1089id = 3) long j2, @SafeParcelable.Param(m1089id = 4) int i, @SafeParcelable.Param(m1089id = 5) Bundle bundle) {
        boolean z = true;
