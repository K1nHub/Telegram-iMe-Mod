...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "Priority.PRIORITY_BALANCED_POWER_ACCURACY", getter = "getPriority", m789id = 1)
    private int zza;
    @SafeParcelable.Field(defaultValue = "3600000", getter = "getIntervalMillis", m789id = 2)
    private long zzb;
    @SafeParcelable.Field(defaultValue = "600000", getter = "getMinUpdateIntervalMillis", m789id = 3)
    private long zzc;
    @SafeParcelable.Field(defaultValue = SessionDescription.SUPPORTED_SDP_VERSION, getter = "getMaxUpdateDelayMillis", m789id = 8)
    private long zzd;
    @SafeParcelable.Field(defaultValueUnchecked = "Long.MAX_VALUE", getter = "getDurationMillis", m789id = 10)
    private long zze;
    @SafeParcelable.Field(defaultValueUnchecked = "Integer.MAX_VALUE", getter = "getMaxUpdates", m789id = 6)
    private int zzf;
    @SafeParcelable.Field(defaultValue = SessionDescription.SUPPORTED_SDP_VERSION, getter = "getMinUpdateDistanceMeters", m789id = 7)
    private float zzg;
    @SafeParcelable.Field(defaultValue = "false", getter = "isWaitForAccurateLocation", m789id = 9)
    private boolean zzh;
    @SafeParcelable.Field(defaultValueUnchecked = "-1", getter = "getMaxUpdateAgeMillis", m789id = 11)
    private long zzi;
    @SafeParcelable.Field(defaultValueUnchecked = "Granularity.GRANULARITY_PERMISSION_LEVEL", getter = "getGranularity", m789id = 12)
    private final int zzj;
    @SafeParcelable.Field(defaultValueUnchecked = "ThrottleBehavior.THROTTLE_BACKGROUND", getter = "getThrottleBehavior", m789id = 13)
    private final int zzk;
    @SafeParcelable.Field(getter = "getModuleId", m789id = 14)
    private final String zzl;
    @SafeParcelable.Field(defaultValue = "false", getter = "isBypass", m789id = 15)
    private final boolean zzm;
    @SafeParcelable.Field(defaultValueUnchecked = "new android.os.WorkSource()", getter = "getWorkSource", m789id = 16)
    private final WorkSource zzn;
    @SafeParcelable.Field(getter = "getImpersonation", m789id = 17)
    ...
    public LocationRequest(@SafeParcelable.Param(m788id = 1) int i, @SafeParcelable.Param(m788id = 2) long j, @SafeParcelable.Param(m788id = 3) long j2, @SafeParcelable.Param(m788id = 8) long j3, @SafeParcelable.RemovedParam(defaultValueUnchecked = "Long.MAX_VALUE", m787id = 5) long j4, @SafeParcelable.Param(m788id = 10) long j5, @SafeParcelable.Param(m788id = 6) int i2, @SafeParcelable.Param(m788id = 7) float f, @SafeParcelable.Param(m788id = 9) boolean z, @SafeParcelable.Param(m788id = 11) long j6, @SafeParcelable.Param(m788id = 12) int i3, @SafeParcelable.Param(m788id = 13) int i4, @SafeParcelable.Param(m788id = 14) String str, @SafeParcelable.Param(m788id = 15) boolean z2, @SafeParcelable.Param(m788id = 16) WorkSource workSource, @SafeParcelable.Param(m788id = 17) com.google.android.gms.internal.location.zzd zzdVar) {
        this.zza = i;
        long j7 = j;
        this.zzb = j7;
        this.zzc = j2;
