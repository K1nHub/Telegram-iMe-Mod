...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLocationRequests", m789id = 1)
    private final List zza;
    @SafeParcelable.Field(defaultValue = "false", getter = "alwaysShow", m789id = 2)
    private final boolean zzb;
    @SafeParcelable.Field(getter = "needBle", m789id = 3)
    ...
    public LocationSettingsRequest(@SafeParcelable.Param(m788id = 1) List list, @SafeParcelable.Param(m788id = 2) boolean z, @SafeParcelable.Param(m788id = 3) boolean z2) {
        this.zza = list;
        this.zzb = z;
        this.zzc = z2;
    }
