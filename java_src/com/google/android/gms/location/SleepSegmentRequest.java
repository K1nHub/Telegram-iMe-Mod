...
public class SleepSegmentRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUserPreferredSleepWindow", m789id = 1)
    private final List zza;
    @SafeParcelable.Field(defaultValue = SessionDescription.SUPPORTED_SDP_VERSION, getter = "getRequestedDataType", m789id = 2)
    ...
    public SleepSegmentRequest(@SafeParcelable.Param(m788id = 1) List list, @SafeParcelable.Param(m788id = 2) int i) {
        this.zza = list;
        this.zzb = i;
    }
}
