...
public final class PaymentData extends AbstractSafeParcelable implements AutoResolvableResult {
    ...
    public PaymentData(@SafeParcelable.Param(m1089id = 1) String str, @SafeParcelable.Param(m1089id = 2) CardInfo cardInfo, @SafeParcelable.Param(m1089id = 3) UserAddress userAddress, @SafeParcelable.Param(m1089id = 4) PaymentMethodToken paymentMethodToken, @SafeParcelable.Param(m1089id = 5) String str2, @SafeParcelable.Param(m1089id = 6) Bundle bundle, @SafeParcelable.Param(m1089id = 7) String str3, @SafeParcelable.Param(m1089id = 8) Bundle bundle2) {
        this.zza = str;
        this.zzb = cardInfo;
