...
public final class CreateWalletObjectsRequest extends AbstractSafeParcelable {
    ...
    public CreateWalletObjectsRequest(@SafeParcelable.Param(m774id = 2) LoyaltyWalletObject loyaltyWalletObject, @SafeParcelable.Param(m774id = 3) OfferWalletObject offerWalletObject, @SafeParcelable.Param(m774id = 4) GiftCardWalletObject giftCardWalletObject, @SafeParcelable.Param(m774id = 5) int i) {
        this.zza = loyaltyWalletObject;
