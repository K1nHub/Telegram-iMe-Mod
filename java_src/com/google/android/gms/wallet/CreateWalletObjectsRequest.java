...
public final class CreateWalletObjectsRequest extends AbstractSafeParcelable {
    ...
    public CreateWalletObjectsRequest(@SafeParcelable.Param(m788id = 2) LoyaltyWalletObject loyaltyWalletObject, @SafeParcelable.Param(m788id = 3) OfferWalletObject offerWalletObject, @SafeParcelable.Param(m788id = 4) GiftCardWalletObject giftCardWalletObject, @SafeParcelable.Param(m788id = 5) int i) {
        this.zza = loyaltyWalletObject;
