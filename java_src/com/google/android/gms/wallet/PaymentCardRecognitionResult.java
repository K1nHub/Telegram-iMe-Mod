...
public final class PaymentCardRecognitionResult extends AbstractSafeParcelable {
    ...
    public PaymentCardRecognitionResult(@SafeParcelable.Param(m788id = 1) String str, @SafeParcelable.Param(m788id = 2) CreditCardExpirationDate creditCardExpirationDate) {
        this.zza = str;
