...
public final class PaymentCardRecognitionResult extends AbstractSafeParcelable {
    ...
    public PaymentCardRecognitionResult(@SafeParcelable.Param(m774id = 1) String str, @SafeParcelable.Param(m774id = 2) CreditCardExpirationDate creditCardExpirationDate) {
        this.zza = str;
