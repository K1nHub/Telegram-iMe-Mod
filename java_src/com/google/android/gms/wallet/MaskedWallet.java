...
public final class MaskedWallet extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public MaskedWallet(@SafeParcelable.Param(m778id = 2) String str, @SafeParcelable.Param(m778id = 3) String str2, @SafeParcelable.Param(m778id = 4) String[] strArr, @SafeParcelable.Param(m778id = 5) String str3, @SafeParcelable.Param(m778id = 6) zza zzaVar, @SafeParcelable.Param(m778id = 7) zza zzaVar2, @SafeParcelable.Param(m778id = 8) LoyaltyWalletObject[] loyaltyWalletObjectArr, @SafeParcelable.Param(m778id = 9) OfferWalletObject[] offerWalletObjectArr, @SafeParcelable.Param(m778id = 10) UserAddress userAddress, @SafeParcelable.Param(m778id = 11) UserAddress userAddress2, @SafeParcelable.Param(m778id = 12) InstrumentInfo[] instrumentInfoArr) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = strArr;
        this.zzd = str3;
