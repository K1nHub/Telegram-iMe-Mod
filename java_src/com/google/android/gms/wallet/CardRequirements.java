...
public final class CardRequirements extends AbstractSafeParcelable {
    ...
    ArrayList zza;
    @SafeParcelable.Field(defaultValue = "true", m789id = 2)
    boolean zzb;
    ...
    public CardRequirements(@SafeParcelable.Param(m788id = 1) ArrayList arrayList, @SafeParcelable.Param(m788id = 2) boolean z, @SafeParcelable.Param(m788id = 3) boolean z2, @SafeParcelable.Param(m788id = 4) int i) {
        this.zza = arrayList;
        this.zzb = z;
        this.zzc = z2;
        this.zzd = i;
