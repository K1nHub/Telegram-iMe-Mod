...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static CameraPosition zza(Context context, AttributeSet attributeSet) {
        ...
        int i4 = C0701R.styleable.MapAttrs_cameraBearing;
        if (obtainAttributes.hasValue(i4)) {
            builder.bearing(obtainAttributes.getFloat(i4, BitmapDescriptorFactory.HUE_RED));
        }
        int i5 = C0701R.styleable.MapAttrs_cameraTilt;
        if (obtainAttributes.hasValue(i5)) {
    ...
    public static LatLngBounds zzb(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0701R.styleable.MapAttrs);
        int i = C0701R.styleable.MapAttrs_latLngBoundsSouthWestLatitude;
        Float valueOf = obtainAttributes.hasValue(i) ? Float.valueOf(obtainAttributes.getFloat(i, BitmapDescriptorFactory.HUE_RED)) : null;
        int i2 = C0701R.styleable.MapAttrs_latLngBoundsSouthWestLongitude;
        ...
        int i3 = C0701R.styleable.MapAttrs_latLngBoundsNorthEastLatitude;
        ...
        int i4 = C0701R.styleable.MapAttrs_latLngBoundsNorthEastLongitude;
