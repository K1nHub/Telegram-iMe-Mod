...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "-1", getter = "getZOrderOnTopForParcel", m789id = 2, type = "byte")
    private Boolean zzb;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getUseViewLifecycleInFragmentForParcel", m789id = 3, type = "byte")
    private Boolean zzc;
    @SafeParcelable.Field(getter = "getMapType", m789id = 4)
    private int zzd;
    @SafeParcelable.Field(getter = "getCamera", m789id = 5)
    private CameraPosition zze;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getZoomControlsEnabledForParcel", m789id = 6, type = "byte")
    private Boolean zzf;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getCompassEnabledForParcel", m789id = 7, type = "byte")
    private Boolean zzg;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getScrollGesturesEnabledForParcel", m789id = 8, type = "byte")
    private Boolean zzh;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getZoomGesturesEnabledForParcel", m789id = 9, type = "byte")
    private Boolean zzi;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getTiltGesturesEnabledForParcel", m789id = 10, type = "byte")
    private Boolean zzj;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getRotateGesturesEnabledForParcel", m789id = 11, type = "byte")
    private Boolean zzk;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getLiteModeForParcel", m789id = 12, type = "byte")
    private Boolean zzl;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getMapToolbarEnabledForParcel", m789id = 14, type = "byte")
    private Boolean zzm;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getAmbientEnabledForParcel", m789id = 15, type = "byte")
    private Boolean zzn;
    @SafeParcelable.Field(getter = "getMinZoomPreference", m789id = 16)
    private Float zzo;
    @SafeParcelable.Field(getter = "getMaxZoomPreference", m789id = 17)
    private Float zzp;
    @SafeParcelable.Field(getter = "getLatLngBoundsForCameraTarget", m789id = 18)
    private LatLngBounds zzq;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getScrollGesturesEnabledDuringRotateOrZoomForParcel", m789id = 19, type = "byte")
    private Boolean zzr;
    @SafeParcelable.Field(getter = "getBackgroundColor", m789id = 20)
    private Integer zzs;
    @SafeParcelable.Field(getter = "getMapId", m789id = 21)
    private String zzt;
    ...
    public static LatLngBounds zzb(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0715R.styleable.MapAttrs);
        int i = C0715R.styleable.MapAttrs_latLngBoundsSouthWestLatitude;
        Float valueOf = obtainAttributes.hasValue(i) ? Float.valueOf(obtainAttributes.getFloat(i, BitmapDescriptorFactory.HUE_RED)) : null;
        int i2 = C0715R.styleable.MapAttrs_latLngBoundsSouthWestLongitude;
        ...
        int i3 = C0715R.styleable.MapAttrs_latLngBoundsNorthEastLatitude;
        ...
        int i4 = C0715R.styleable.MapAttrs_latLngBoundsNorthEastLongitude;
    ...
    public GoogleMapOptions(@SafeParcelable.Param(m788id = 2) byte b, @SafeParcelable.Param(m788id = 3) byte b2, @SafeParcelable.Param(m788id = 4) int i, @SafeParcelable.Param(m788id = 5) CameraPosition cameraPosition, @SafeParcelable.Param(m788id = 6) byte b3, @SafeParcelable.Param(m788id = 7) byte b4, @SafeParcelable.Param(m788id = 8) byte b5, @SafeParcelable.Param(m788id = 9) byte b6, @SafeParcelable.Param(m788id = 10) byte b7, @SafeParcelable.Param(m788id = 11) byte b8, @SafeParcelable.Param(m788id = 12) byte b9, @SafeParcelable.Param(m788id = 14) byte b10, @SafeParcelable.Param(m788id = 15) byte b11, @SafeParcelable.Param(m788id = 16) Float f, @SafeParcelable.Param(m788id = 17) Float f2, @SafeParcelable.Param(m788id = 18) LatLngBounds latLngBounds, @SafeParcelable.Param(m788id = 19) byte b12, @SafeParcelable.Param(m788id = 20) Integer num, @SafeParcelable.Param(m788id = 21) String str) {
        this.zzd = -1;
        this.zzo = null;
        this.zzp = null;
        this.zzq = null;
