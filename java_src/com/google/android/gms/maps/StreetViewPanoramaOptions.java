...
public final class StreetViewPanoramaOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStreetViewPanoramaCamera", m789id = 2)
    private StreetViewPanoramaCamera zza;
    @SafeParcelable.Field(getter = "getPanoramaId", m789id = 3)
    private String zzb;
    @SafeParcelable.Field(getter = "getPosition", m789id = 4)
    private LatLng zzc;
    @SafeParcelable.Field(getter = "getRadius", m789id = 5)
    private Integer zzd;
    @SafeParcelable.Field(getter = "getUserNavigationEnabledForParcel", m789id = 6, type = "byte")
    private Boolean zze;
    @SafeParcelable.Field(getter = "getZoomGesturesEnabledForParcel", m789id = 7, type = "byte")
    private Boolean zzf;
    @SafeParcelable.Field(getter = "getPanningGesturesEnabledForParcel", m789id = 8, type = "byte")
    private Boolean zzg;
    @SafeParcelable.Field(getter = "getStreetNamesEnabledForParcel", m789id = 9, type = "byte")
    private Boolean zzh;
    @SafeParcelable.Field(getter = "getUseViewLifecycleInFragmentForParcel", m789id = 10, type = "byte")
    private Boolean zzi;
    @SafeParcelable.Field(getter = "getSource", m789id = 11)
    ...
    public StreetViewPanoramaOptions(@SafeParcelable.Param(m788id = 2) StreetViewPanoramaCamera streetViewPanoramaCamera, @SafeParcelable.Param(m788id = 3) String str, @SafeParcelable.Param(m788id = 4) LatLng latLng, @SafeParcelable.Param(m788id = 5) Integer num, @SafeParcelable.Param(m788id = 6) byte b, @SafeParcelable.Param(m788id = 7) byte b2, @SafeParcelable.Param(m788id = 8) byte b3, @SafeParcelable.Param(m788id = 9) byte b4, @SafeParcelable.Param(m788id = 10) byte b5, @SafeParcelable.Param(m788id = 11) StreetViewSource streetViewSource) {
        Boolean bool = Boolean.TRUE;
        this.zze = bool;
        this.zzf = bool;
        this.zzg = bool;
