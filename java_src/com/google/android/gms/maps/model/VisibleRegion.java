...
public final class VisibleRegion extends AbstractSafeParcelable {
    ...
    public VisibleRegion(@SafeParcelable.Param(m778id = 2) LatLng latLng, @SafeParcelable.Param(m778id = 3) LatLng latLng2, @SafeParcelable.Param(m778id = 4) LatLng latLng3, @SafeParcelable.Param(m778id = 5) LatLng latLng4, @SafeParcelable.Param(m778id = 6) LatLngBounds latLngBounds) {
