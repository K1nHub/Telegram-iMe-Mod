...
public final class PolylineOptions extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getPoints", m789id = 2)
    private final List zza;
    @SafeParcelable.Field(getter = "getWidth", m789id = 3)
    private float zzb;
    @SafeParcelable.Field(getter = "getColor", m789id = 4)
    private int zzc;
    @SafeParcelable.Field(getter = "getZIndex", m789id = 5)
    private float zzd;
    @SafeParcelable.Field(getter = "isVisible", m789id = 6)
    private boolean zze;
    @SafeParcelable.Field(getter = "isGeodesic", m789id = 7)
    private boolean zzf;
    @SafeParcelable.Field(getter = "isClickable", m789id = 8)
    private boolean zzg;
    @SafeParcelable.Field(getter = "getStartCap", m789id = 9)
    private Cap zzh;
    @SafeParcelable.Field(getter = "getEndCap", m789id = 10)
    private Cap zzi;
    @SafeParcelable.Field(getter = "getJointType", m789id = 11)
    private int zzj;
    @SafeParcelable.Field(getter = "getPattern", m789id = 12)
    private List zzk;
    @SafeParcelable.Field(getter = "getSpans", m789id = 13)
    private List zzl;
    ...
    public PolylineOptions(@SafeParcelable.Param(m788id = 2) List list, @SafeParcelable.Param(m788id = 3) float f, @SafeParcelable.Param(m788id = 4) int i, @SafeParcelable.Param(m788id = 5) float f2, @SafeParcelable.Param(m788id = 6) boolean z, @SafeParcelable.Param(m788id = 7) boolean z2, @SafeParcelable.Param(m788id = 8) boolean z3, @SafeParcelable.Param(m788id = 9) Cap cap, @SafeParcelable.Param(m788id = 10) Cap cap2, @SafeParcelable.Param(m788id = 11) int i2, @SafeParcelable.Param(m788id = 12) List list2, @SafeParcelable.Param(m788id = 13) List list3) {
        this.zzb = 10.0f;
        this.zzc = -16777216;
        this.zzd = BitmapDescriptorFactory.HUE_RED;
        this.zze = true;
