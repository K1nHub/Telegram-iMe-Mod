...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWrappedImageDescriptorImplBinder", m775id = 2, type = "android.os.IBinder")
    private BitmapDescriptor zza;
    @SafeParcelable.Field(getter = "getLocation", m775id = 3)
    private LatLng zzb;
    @SafeParcelable.Field(getter = "getWidth", m775id = 4)
    private float zzc;
    @SafeParcelable.Field(getter = "getHeight", m775id = 5)
    private float zzd;
    @SafeParcelable.Field(getter = "getBounds", m775id = 6)
    private LatLngBounds zze;
    @SafeParcelable.Field(getter = "getBearing", m775id = 7)
    private float zzf;
    @SafeParcelable.Field(getter = "getZIndex", m775id = 8)
    private float zzg;
    @SafeParcelable.Field(getter = "isVisible", m775id = 9)
    private boolean zzh;
    @SafeParcelable.Field(getter = "getTransparency", m775id = 10)
    private float zzi;
    @SafeParcelable.Field(getter = "getAnchorU", m775id = 11)
    private float zzj;
    @SafeParcelable.Field(getter = "getAnchorV", m775id = 12)
    private float zzk;
    @SafeParcelable.Field(getter = "isClickable", m775id = 13)
    private boolean zzl;
    ...
    public GroundOverlayOptions(@SafeParcelable.Param(m774id = 2) IBinder iBinder, @SafeParcelable.Param(m774id = 3) LatLng latLng, @SafeParcelable.Param(m774id = 4) float f, @SafeParcelable.Param(m774id = 5) float f2, @SafeParcelable.Param(m774id = 6) LatLngBounds latLngBounds, @SafeParcelable.Param(m774id = 7) float f3, @SafeParcelable.Param(m774id = 8) float f4, @SafeParcelable.Param(m774id = 9) boolean z, @SafeParcelable.Param(m774id = 10) float f5, @SafeParcelable.Param(m774id = 11) float f6, @SafeParcelable.Param(m774id = 12) float f7, @SafeParcelable.Param(m774id = 13) boolean z2) {
        this.zzh = true;
        this.zzi = BitmapDescriptorFactory.HUE_RED;
        this.zzj = 0.5f;
        this.zzk = 0.5f;
