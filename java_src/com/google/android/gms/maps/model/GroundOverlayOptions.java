...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWrappedImageDescriptorImplBinder", m789id = 2, type = "android.os.IBinder")
    private BitmapDescriptor zza;
    @SafeParcelable.Field(getter = "getLocation", m789id = 3)
    private LatLng zzb;
    @SafeParcelable.Field(getter = "getWidth", m789id = 4)
    private float zzc;
    @SafeParcelable.Field(getter = "getHeight", m789id = 5)
    private float zzd;
    @SafeParcelable.Field(getter = "getBounds", m789id = 6)
    private LatLngBounds zze;
    @SafeParcelable.Field(getter = "getBearing", m789id = 7)
    private float zzf;
    @SafeParcelable.Field(getter = "getZIndex", m789id = 8)
    private float zzg;
    @SafeParcelable.Field(getter = "isVisible", m789id = 9)
    private boolean zzh;
    @SafeParcelable.Field(getter = "getTransparency", m789id = 10)
    private float zzi;
    @SafeParcelable.Field(getter = "getAnchorU", m789id = 11)
    private float zzj;
    @SafeParcelable.Field(getter = "getAnchorV", m789id = 12)
    private float zzk;
    @SafeParcelable.Field(getter = "isClickable", m789id = 13)
    private boolean zzl;
    ...
    public GroundOverlayOptions(@SafeParcelable.Param(m788id = 2) IBinder iBinder, @SafeParcelable.Param(m788id = 3) LatLng latLng, @SafeParcelable.Param(m788id = 4) float f, @SafeParcelable.Param(m788id = 5) float f2, @SafeParcelable.Param(m788id = 6) LatLngBounds latLngBounds, @SafeParcelable.Param(m788id = 7) float f3, @SafeParcelable.Param(m788id = 8) float f4, @SafeParcelable.Param(m788id = 9) boolean z, @SafeParcelable.Param(m788id = 10) float f5, @SafeParcelable.Param(m788id = 11) float f6, @SafeParcelable.Param(m788id = 12) float f7, @SafeParcelable.Param(m788id = 13) boolean z2) {
        this.zzh = true;
        this.zzi = BitmapDescriptorFactory.HUE_RED;
        this.zzj = 0.5f;
        this.zzk = 0.5f;
