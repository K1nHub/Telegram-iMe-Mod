...
public class StreetViewPanoramaLocation extends AbstractSafeParcelable {
    ...
    public StreetViewPanoramaLocation(@SafeParcelable.Param(m788id = 2) StreetViewPanoramaLink[] streetViewPanoramaLinkArr, @SafeParcelable.Param(m788id = 3) LatLng latLng, @SafeParcelable.Param(m788id = 4) String str) {
