...
public class StreetViewPanoramaLocation extends AbstractSafeParcelable {
    ...
    public StreetViewPanoramaLocation(@SafeParcelable.Param(m1089id = 2) StreetViewPanoramaLink[] streetViewPanoramaLinkArr, @SafeParcelable.Param(m1089id = 3) LatLng latLng, @SafeParcelable.Param(m1089id = 4) String str) {
