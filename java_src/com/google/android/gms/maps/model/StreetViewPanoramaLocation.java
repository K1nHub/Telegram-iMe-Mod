...
public class StreetViewPanoramaLocation extends AbstractSafeParcelable {
    ...
    public StreetViewPanoramaLocation(@SafeParcelable.Param(m774id = 2) StreetViewPanoramaLink[] streetViewPanoramaLinkArr, @SafeParcelable.Param(m774id = 3) LatLng latLng, @SafeParcelable.Param(m774id = 4) String str) {
