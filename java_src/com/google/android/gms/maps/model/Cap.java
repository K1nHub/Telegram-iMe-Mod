...
public class Cap extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWrappedBitmapDescriptorImplBinder", m797id = 3, type = "android.os.IBinder")
    private final BitmapDescriptor zzc;
    @SafeParcelable.Field(getter = "getBitmapRefWidth", m797id = 4)
    ...
    public Cap(@SafeParcelable.Param(m796id = 2) int i, @SafeParcelable.Param(m796id = 3) IBinder iBinder, @SafeParcelable.Param(m796id = 4) Float f) {
