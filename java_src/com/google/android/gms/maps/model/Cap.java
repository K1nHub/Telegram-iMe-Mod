...
public class Cap extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWrappedBitmapDescriptorImplBinder", m779id = 3, type = "android.os.IBinder")
    private final BitmapDescriptor zzc;
    @SafeParcelable.Field(getter = "getBitmapRefWidth", m779id = 4)
    ...
    public Cap(@SafeParcelable.Param(m778id = 2) int i, @SafeParcelable.Param(m778id = 3) IBinder iBinder, @SafeParcelable.Param(m778id = 4) Float f) {
