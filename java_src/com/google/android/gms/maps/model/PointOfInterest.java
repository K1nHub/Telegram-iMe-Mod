...
public final class PointOfInterest extends AbstractSafeParcelable {
    ...
    public PointOfInterest(@SafeParcelable.Param(m1089id = 2) LatLng latLng, @SafeParcelable.Param(m1089id = 3) String str, @SafeParcelable.Param(m1089id = 4) String str2) {
        this.latLng = latLng;
        this.placeId = str;
        this.name = str2;
    }
