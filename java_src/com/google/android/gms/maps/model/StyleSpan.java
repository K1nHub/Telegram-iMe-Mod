...
public final class StyleSpan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStyle", m789id = 2)
    private final StrokeStyle zza;
    @SafeParcelable.Field(getter = "getSegments", m789id = 3)
    ...
    public StyleSpan(@SafeParcelable.Param(m788id = 2) StrokeStyle strokeStyle, @SafeParcelable.Param(m788id = 3) double d) {
        if (d > 0.0d) {
            this.zza = strokeStyle;
            this.zzb = d;
            return;
