...
public final class StyleSpan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStyle", m1089id = 2)
    private final StrokeStyle zza;
    @SafeParcelable.Field(getter = "getSegments", m1089id = 3)
    ...
    public StyleSpan(@SafeParcelable.Param(m1088id = 2) StrokeStyle strokeStyle, @SafeParcelable.Param(m1088id = 3) double d) {
        if (d > 0.0d) {
            this.zza = strokeStyle;
            this.zzb = d;
            return;
