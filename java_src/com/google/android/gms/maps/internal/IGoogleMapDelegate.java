...
public interface IGoogleMapDelegate extends IInterface {
    ...
    void setOnMapClickListener(zzam zzamVar) throws RemoteException;

    void setOnMapLoadedCallback(zzao zzaoVar) throws RemoteException;

    void setOnMapLongClickListener(zzaq zzaqVar) throws RemoteException;

    void setOnMarkerClickListener(zzau zzauVar) throws RemoteException;

    void setOnMarkerDragListener(zzaw zzawVar) throws RemoteException;

    void setOnMyLocationButtonClickListener(zzay zzayVar) throws RemoteException;

    void setOnMyLocationChangeListener(zzba zzbaVar) throws RemoteException;

    void setOnMyLocationClickListener(zzbc zzbcVar) throws RemoteException;

    void setOnPoiClickListener(zzbe zzbeVar) throws RemoteException;

    void setOnPolygonClickListener(zzbg zzbgVar) throws RemoteException;

    void setOnPolylineClickListener(zzbi zzbiVar) throws RemoteException;
    ...
    void snapshot(zzbv zzbvVar, IObjectWrapper iObjectWrapper) throws RemoteException;
