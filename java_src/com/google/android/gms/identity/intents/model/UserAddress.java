...
public final class UserAddress extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    String zzk;
    @SafeParcelable.Field(m779id = 13)
    String zzl;
    @SafeParcelable.Field(m779id = 14)
    boolean zzm;
    @SafeParcelable.Field(m779id = 15)
    String zzn;
    @SafeParcelable.Field(m779id = 16)
    String zzo;
    ...
    public UserAddress(@SafeParcelable.Param(m778id = 2) String str, @SafeParcelable.Param(m778id = 3) String str2, @SafeParcelable.Param(m778id = 4) String str3, @SafeParcelable.Param(m778id = 5) String str4, @SafeParcelable.Param(m778id = 6) String str5, @SafeParcelable.Param(m778id = 7) String str6, @SafeParcelable.Param(m778id = 8) String str7, @SafeParcelable.Param(m778id = 9) String str8, @SafeParcelable.Param(m778id = 10) String str9, @SafeParcelable.Param(m778id = 11) String str10, @SafeParcelable.Param(m778id = 12) String str11, @SafeParcelable.Param(m778id = 13) String str12, @SafeParcelable.Param(m778id = 14) boolean z, @SafeParcelable.Param(m778id = 15) String str13, @SafeParcelable.Param(m778id = 16) String str14) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzd = str4;
