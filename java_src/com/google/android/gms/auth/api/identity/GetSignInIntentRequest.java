...
public class GetSignInIntentRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getServerClientId", m1090id = 1)
    private final String zba;
    @SafeParcelable.Field(getter = "getHostedDomainFilter", m1090id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "getSessionId", m1090id = 3)
    private String zbc;
    @SafeParcelable.Field(getter = "getNonce", m1090id = 4)
    private final String zbd;
    @SafeParcelable.Field(getter = "requestVerifiedPhoneNumber", m1090id = 5)
    private final boolean zbe;
    @SafeParcelable.Field(getter = "getTheme", m1090id = 6)
    ...
    public GetSignInIntentRequest(@SafeParcelable.Param(m1089id = 1) String str, @SafeParcelable.Param(m1089id = 2) String str2, @SafeParcelable.Param(m1089id = 3) String str3, @SafeParcelable.Param(m1089id = 4) String str4, @SafeParcelable.Param(m1089id = 5) boolean z, @SafeParcelable.Param(m1089id = 6) int i) {
        Preconditions.checkNotNull(str);
        this.zba = str;
        this.zbb = str2;
        this.zbc = str3;
