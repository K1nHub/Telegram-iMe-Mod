...
public class SavePasswordRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSignInPassword", m789id = 1)
    private final SignInPassword zba;
    @SafeParcelable.Field(getter = "getSessionId", m789id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "getTheme", m789id = 3)
    ...
    public SavePasswordRequest(@SafeParcelable.Param(m788id = 1) SignInPassword signInPassword, @SafeParcelable.Param(m788id = 2) String str, @SafeParcelable.Param(m788id = 3) int i) {
