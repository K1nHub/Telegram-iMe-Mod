...
public class SavePasswordRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSignInPassword", m775id = 1)
    private final SignInPassword zba;
    @SafeParcelable.Field(getter = "getSessionId", m775id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "getTheme", m775id = 3)
    ...
    public SavePasswordRequest(@SafeParcelable.Param(m774id = 1) SignInPassword signInPassword, @SafeParcelable.Param(m774id = 2) String str, @SafeParcelable.Param(m774id = 3) int i) {
