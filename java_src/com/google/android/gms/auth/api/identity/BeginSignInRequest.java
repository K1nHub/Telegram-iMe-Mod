...
public final class BeginSignInRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getPasswordRequestOptions", m789id = 1)
    private final PasswordRequestOptions zba;
    @SafeParcelable.Field(getter = "getGoogleIdTokenRequestOptions", m789id = 2)
    private final GoogleIdTokenRequestOptions zbb;
    @SafeParcelable.Field(getter = "getSessionId", m789id = 3)
    private final String zbc;
    @SafeParcelable.Field(getter = "isAutoSelectEnabled", m789id = 4)
    private final boolean zbd;
    @SafeParcelable.Field(getter = "getTheme", m789id = 5)
    private final int zbe;
    @SafeParcelable.Field(getter = "getPasskeysRequestOptions", m789id = 6)
    ...
    public static final class GoogleIdTokenRequestOptions extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "isSupported", m789id = 1)
        private final boolean zba;
        @SafeParcelable.Field(getter = "getServerClientId", m789id = 2)
        private final String zbb;
        @SafeParcelable.Field(getter = "getNonce", m789id = 3)
        private final String zbc;
        @SafeParcelable.Field(getter = "filterByAuthorizedAccounts", m789id = 4)
        private final boolean zbd;
        @SafeParcelable.Field(getter = "getLinkedServiceId", m789id = 5)
        private final String zbe;
        @SafeParcelable.Field(getter = "getIdTokenDepositionScopes", m789id = 6)
        private final List zbf;
        @SafeParcelable.Field(getter = "requestVerifiedPhoneNumber", m789id = 7)
        ...
        public GoogleIdTokenRequestOptions(@SafeParcelable.Param(m788id = 1) boolean z, @SafeParcelable.Param(m788id = 2) String str, @SafeParcelable.Param(m788id = 3) String str2, @SafeParcelable.Param(m788id = 4) boolean z2, @SafeParcelable.Param(m788id = 5) String str3, @SafeParcelable.Param(m788id = 6) List list, @SafeParcelable.Param(m788id = 7) boolean z3) {
            boolean z4 = true;
            if (z2 && z3) {
                z4 = false;
            }
    ...
    public static final class PasskeysRequestOptions extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "isSupported", m789id = 1)
        private final boolean zba;
        @SafeParcelable.Field(getter = "getChallenge", m789id = 2)
        private final byte[] zbb;
        @SafeParcelable.Field(getter = "getRpId", m789id = 3)
        private final String zbc;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @SafeParcelable.Constructor
        public PasskeysRequestOptions(@SafeParcelable.Param(m788id = 1) boolean z, @SafeParcelable.Param(m788id = 2) byte[] bArr, @SafeParcelable.Param(m788id = 3) String str) {
            if (z) {
    ...
    public static final class PasswordRequestOptions extends AbstractSafeParcelable {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @SafeParcelable.Constructor
        public PasswordRequestOptions(@SafeParcelable.Param(m788id = 1) boolean z) {
            this.zba = z;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public BeginSignInRequest(@SafeParcelable.Param(m788id = 1) PasswordRequestOptions passwordRequestOptions, @SafeParcelable.Param(m788id = 2) GoogleIdTokenRequestOptions googleIdTokenRequestOptions, @SafeParcelable.Param(m788id = 3) String str, @SafeParcelable.Param(m788id = 4) boolean z, @SafeParcelable.Param(m788id = 5) int i, @SafeParcelable.Param(m788id = 6) PasskeysRequestOptions passkeysRequestOptions) {
        this.zba = (PasswordRequestOptions) Preconditions.checkNotNull(passwordRequestOptions);
        this.zbb = (GoogleIdTokenRequestOptions) Preconditions.checkNotNull(googleIdTokenRequestOptions);
        this.zbc = str;
        this.zbd = z;
