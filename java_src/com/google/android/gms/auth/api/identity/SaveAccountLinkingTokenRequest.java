...
public class SaveAccountLinkingTokenRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsentPendingIntent", m789id = 1)
    private final PendingIntent zba;
    @SafeParcelable.Field(getter = "getTokenType", m789id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "getServiceId", m789id = 3)
    private final String zbc;
    @SafeParcelable.Field(getter = "getScopes", m789id = 4)
    private final List zbd;
    @SafeParcelable.Field(getter = "getSessionId", m789id = 5)
    ...
    public SaveAccountLinkingTokenRequest(@SafeParcelable.Param(m788id = 1) PendingIntent pendingIntent, @SafeParcelable.Param(m788id = 2) String str, @SafeParcelable.Param(m788id = 3) String str2, @SafeParcelable.Param(m788id = 4) List list, @SafeParcelable.Param(m788id = 5) String str3, @SafeParcelable.Param(m788id = 6) int i) {
        this.zba = pendingIntent;
        this.zbb = str;
        this.zbc = str2;
        this.zbd = list;
