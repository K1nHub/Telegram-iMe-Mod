...
public class SignInPassword extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getPassword", m789id = 2)
    private final String zbb;

    @SafeParcelable.Constructor
    public SignInPassword(@SafeParcelable.Param(m788id = 1) String str, @SafeParcelable.Param(m788id = 2) String str2) {
