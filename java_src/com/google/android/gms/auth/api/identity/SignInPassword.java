...
public class SignInPassword extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getPassword", m779id = 2)
    private final String zbb;

    @SafeParcelable.Constructor
    public SignInPassword(@SafeParcelable.Param(m778id = 1) String str, @SafeParcelable.Param(m778id = 2) String str2) {
