...
public class SignInPassword extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getPassword", m775id = 2)
    private final String zbb;

    @SafeParcelable.Constructor
    public SignInPassword(@SafeParcelable.Param(m774id = 1) String str, @SafeParcelable.Param(m774id = 2) String str2) {
