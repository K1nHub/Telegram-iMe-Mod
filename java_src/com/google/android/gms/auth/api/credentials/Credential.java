...
public class Credential extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getProfilePictureUri", m797id = 3)
    private final Uri zbc;
    @SafeParcelable.Field(getter = "getIdTokens", m797id = 4)
    private final List zbd;
    @SafeParcelable.Field(getter = "getPassword", m797id = 5)
    private final String zbe;
    @SafeParcelable.Field(getter = "getAccountType", m797id = 6)
    private final String zbf;
    @SafeParcelable.Field(getter = "getGivenName", m797id = 9)
    private final String zbg;
    @SafeParcelable.Field(getter = "getFamilyName", m797id = 10)
    ...
    public Credential(@SafeParcelable.Param(m796id = 1) String str, @SafeParcelable.Param(m796id = 2) String str2, @SafeParcelable.Param(m796id = 3) Uri uri, @SafeParcelable.Param(m796id = 4) List list, @SafeParcelable.Param(m796id = 5) String str3, @SafeParcelable.Param(m796id = 6) String str4, @SafeParcelable.Param(m796id = 9) String str5, @SafeParcelable.Param(m796id = 10) String str6) {
