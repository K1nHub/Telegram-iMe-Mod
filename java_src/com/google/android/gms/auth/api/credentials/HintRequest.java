...
public final class HintRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    final int zba;
    @SafeParcelable.Field(getter = "getHintPickerConfig", m1090id = 1)
    private final CredentialPickerConfig zbb;
    @SafeParcelable.Field(getter = "isEmailAddressIdentifierSupported", m1090id = 2)
    private final boolean zbc;
    @SafeParcelable.Field(getter = "isPhoneNumberIdentifierSupported", m1090id = 3)
    private final boolean zbd;
    @SafeParcelable.Field(getter = "getAccountTypes", m1090id = 4)
    ...
    public HintRequest(@SafeParcelable.Param(m1089id = 1000) int i, @SafeParcelable.Param(m1089id = 1) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(m1089id = 2) boolean z, @SafeParcelable.Param(m1089id = 3) boolean z2, @SafeParcelable.Param(m1089id = 4) String[] strArr, @SafeParcelable.Param(m1089id = 5) boolean z3, @SafeParcelable.Param(m1089id = 6) String str, @SafeParcelable.Param(m1089id = 7) String str2) {
        this.zba = i;
