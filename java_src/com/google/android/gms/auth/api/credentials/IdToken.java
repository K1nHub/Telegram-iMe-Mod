...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountType", m775id = 1)
    private final String zba;
    @SafeParcelable.Field(getter = "getIdToken", m775id = 2)
    private final String zbb;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(m774id = 1) String str, @SafeParcelable.Param(m774id = 2) String str2) {
