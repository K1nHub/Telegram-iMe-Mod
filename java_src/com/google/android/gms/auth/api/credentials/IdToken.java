...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountType", m789id = 1)
    private final String zba;
    @SafeParcelable.Field(getter = "getIdToken", m789id = 2)
    private final String zbb;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(m788id = 1) String str, @SafeParcelable.Param(m788id = 2) String str2) {
