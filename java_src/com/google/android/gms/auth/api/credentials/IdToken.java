...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountType", m1090id = 1)
    private final String zba;
    @SafeParcelable.Field(getter = "getIdToken", m1090id = 2)
    private final String zbb;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(m1089id = 1) String str, @SafeParcelable.Param(m1089id = 2) String str2) {
