...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        private long zzc = C0474C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
    ...
    public ProxyRequest(@SafeParcelable.Param(m788id = 1000) int i, @SafeParcelable.Param(m788id = 1) String str, @SafeParcelable.Param(m788id = 2) int i2, @SafeParcelable.Param(m788id = 3) long j, @SafeParcelable.Param(m788id = 4) byte[] bArr, @SafeParcelable.Param(m788id = 5) Bundle bundle) {
        this.zza = i;
        this.url = str;
        this.httpMethod = i2;
