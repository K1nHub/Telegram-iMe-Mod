...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    public ProxyResponse(@SafeParcelable.Param(m1089id = 1000) int i, @SafeParcelable.Param(m1089id = 1) int i2, @SafeParcelable.Param(m1089id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(m1089id = 3) int i3, @SafeParcelable.Param(m1089id = 4) Bundle bundle, @SafeParcelable.Param(m1089id = 5) byte[] bArr) {
        this.zza = i;
