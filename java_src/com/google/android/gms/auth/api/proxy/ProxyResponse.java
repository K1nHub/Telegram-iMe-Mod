...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    public ProxyResponse(@SafeParcelable.Param(m1088id = 1000) int i, @SafeParcelable.Param(m1088id = 1) int i2, @SafeParcelable.Param(m1088id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(m1088id = 3) int i3, @SafeParcelable.Param(m1088id = 4) Bundle bundle, @SafeParcelable.Param(m1088id = 5) byte[] bArr) {
        this.zza = i;
