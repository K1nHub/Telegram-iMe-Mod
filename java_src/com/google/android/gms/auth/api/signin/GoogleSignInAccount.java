...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private String zad;
    @SafeParcelable.Field(getter = "getIdToken", m797id = 3)
    private String zae;
    @SafeParcelable.Field(getter = "getEmail", m797id = 4)
    private String zaf;
    @SafeParcelable.Field(getter = "getDisplayName", m797id = 5)
    private String zag;
    @SafeParcelable.Field(getter = "getPhotoUrl", m797id = 6)
    private Uri zah;
    @SafeParcelable.Field(getter = "getServerAuthCode", m797id = 7)
    private String zai;
    @SafeParcelable.Field(getter = "getExpirationTimeSecs", m797id = 8)
    private long zaj;
    @SafeParcelable.Field(getter = "getObfuscatedIdentifier", m797id = 9)
    private String zak;
    @SafeParcelable.Field(getter = "getGivenName", m797id = 11)
    private String zal;
    @SafeParcelable.Field(getter = "getFamilyName", m797id = 12)
    private String zam;
    private Set zan = new HashSet();

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public GoogleSignInAccount(@SafeParcelable.Param(m796id = 1) int i, @SafeParcelable.Param(m796id = 2) String str, @SafeParcelable.Param(m796id = 3) String str2, @SafeParcelable.Param(m796id = 4) String str3, @SafeParcelable.Param(m796id = 5) String str4, @SafeParcelable.Param(m796id = 6) Uri uri, @SafeParcelable.Param(m796id = 7) String str5, @SafeParcelable.Param(m796id = 8) long j, @SafeParcelable.Param(m796id = 9) String str6, @SafeParcelable.Param(m796id = 10) List list, @SafeParcelable.Param(m796id = 11) String str7, @SafeParcelable.Param(m796id = 12) String str8) {
        this.zab = i;
        this.zad = str;
        this.zae = str2;
        this.zaf = str3;
