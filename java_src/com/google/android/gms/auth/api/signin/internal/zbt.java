...
public final class zbt extends zbo {
    ...
    public final void zbc() {
        zbd();
        C0701Storage c0701Storage = C0701Storage.getInstance(this.zba);
        GoogleSignInAccount savedDefaultGoogleSignInAccount = c0701Storage.getSavedDefaultGoogleSignInAccount();
        GoogleSignInOptions googleSignInOptions = GoogleSignInOptions.DEFAULT_SIGN_IN;
        if (savedDefaultGoogleSignInAccount != null) {
            googleSignInOptions = c0701Storage.getSavedDefaultGoogleSignInOptions();
        }
