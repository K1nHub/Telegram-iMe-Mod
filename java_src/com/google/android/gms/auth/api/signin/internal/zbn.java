...
public final class zbn {
    ...
    private zbn(Context context) {
        C0701Storage c0701Storage = C0701Storage.getInstance(context);
        this.zba = c0701Storage;
        this.zbb = c0701Storage.getSavedDefaultGoogleSignInAccount();
        this.zbc = c0701Storage.getSavedDefaultGoogleSignInOptions();
    }
