...
public class SignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "", m775id = 4)
    @Deprecated
    String zba;
    @SafeParcelable.Field(defaultValue = "", m775id = 8)
    @Deprecated
    String zbb;
    @SafeParcelable.Field(getter = "getGoogleSignInAccount", m775id = 7)
    private GoogleSignInAccount zbc;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public SignInAccount(@SafeParcelable.Param(m774id = 4) String str, @SafeParcelable.Param(m774id = 7) GoogleSignInAccount googleSignInAccount, @SafeParcelable.Param(m774id = 8) String str2) {
