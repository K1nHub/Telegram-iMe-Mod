...
public final class SignInConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsumerPkgName", m1089id = 2)
    private final String zba;
    @SafeParcelable.Field(getter = "getGoogleConfig", m1089id = 5)
    private GoogleSignInOptions zbb;

    @SafeParcelable.Constructor
    public SignInConfiguration(@SafeParcelable.Param(m1088id = 2) String str, @SafeParcelable.Param(m1088id = 5) GoogleSignInOptions googleSignInOptions) {
