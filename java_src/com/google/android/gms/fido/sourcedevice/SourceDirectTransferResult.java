...
public class SourceDirectTransferResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getAuthorizationType", m797id = 2)
    ...
    public SourceDirectTransferResult(@SafeParcelable.Param(m796id = 1) Status status, @SafeParcelable.Param(m796id = 2) int i) {
        this.zza = status;
        this.zzb = i;
    }
}
