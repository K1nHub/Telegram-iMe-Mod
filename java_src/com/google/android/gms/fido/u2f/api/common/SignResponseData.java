...
public class SignResponseData extends ResponseData {
    ...
    @SafeParcelable.Field(getter = "getClientDataString", m779id = 3)
    private final String zzb;
    @SafeParcelable.Field(getter = "getSignatureData", m779id = 4)
    private final byte[] zzc;
    @SafeParcelable.Field(getter = "getApplication", m779id = 5)
    ...
    public SignResponseData(@SafeParcelable.Param(m778id = 2) byte[] bArr, @SafeParcelable.Param(m778id = 3) String str, @SafeParcelable.Param(m778id = 4) byte[] bArr2, @SafeParcelable.Param(m778id = 5) byte[] bArr3) {
