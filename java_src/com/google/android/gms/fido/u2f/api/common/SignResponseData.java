...
public class SignResponseData extends ResponseData {
    ...
    @SafeParcelable.Field(getter = "getClientDataString", m1090id = 3)
    private final String zzb;
    @SafeParcelable.Field(getter = "getSignatureData", m1090id = 4)
    private final byte[] zzc;
    @SafeParcelable.Field(getter = "getApplication", m1090id = 5)
    ...
    public SignResponseData(@SafeParcelable.Param(m1089id = 2) byte[] bArr, @SafeParcelable.Param(m1089id = 3) String str, @SafeParcelable.Param(m1089id = 4) byte[] bArr2, @SafeParcelable.Param(m1089id = 5) byte[] bArr3) {
