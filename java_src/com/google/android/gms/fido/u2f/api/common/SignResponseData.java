...
public class SignResponseData extends ResponseData {
    ...
    @SafeParcelable.Field(getter = "getClientDataString", m775id = 3)
    private final String zzb;
    @SafeParcelable.Field(getter = "getSignatureData", m775id = 4)
    private final byte[] zzc;
    @SafeParcelable.Field(getter = "getApplication", m775id = 5)
    ...
    public SignResponseData(@SafeParcelable.Param(m774id = 2) byte[] bArr, @SafeParcelable.Param(m774id = 3) String str, @SafeParcelable.Param(m774id = 4) byte[] bArr2, @SafeParcelable.Param(m774id = 5) byte[] bArr3) {
