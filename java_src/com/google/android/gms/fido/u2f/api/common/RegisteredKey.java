...
public class RegisteredKey extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getChallengeValue", m779id = 3)
    String zza;
    ...
    public RegisteredKey(@SafeParcelable.Param(m778id = 2) KeyHandle keyHandle, @SafeParcelable.Param(m778id = 3) String str, @SafeParcelable.Param(m778id = 4) String str2) {
