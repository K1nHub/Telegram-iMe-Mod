...
public class ChannelIdValue extends AbstractSafeParcelable {
    @SafeParcelable.Field(getter = "getTypeAsInt", m1089id = 2, type = "int")
    private final ChannelIdValueType zza;
    @SafeParcelable.Field(getter = "getStringValue", m1089id = 3)
    private final String zzb;
    @SafeParcelable.Field(getter = "getObjectValueAsString", m1089id = 4)
    ...
    public ChannelIdValue(@SafeParcelable.Param(m1088id = 2) int i, @SafeParcelable.Param(m1088id = 3) String str, @SafeParcelable.Param(m1088id = 4) String str2) {
        try {
