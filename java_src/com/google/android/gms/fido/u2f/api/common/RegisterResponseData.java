...
public class RegisterResponseData extends ResponseData {
    ...
    @SafeParcelable.Field(getter = "getRegisterData", m1090id = 2)
    ...
    @SafeParcelable.Field(getter = "getClientDataString", m1090id = 4)
    ...
    public RegisterResponseData(@SafeParcelable.Param(m1089id = 2) byte[] bArr, @SafeParcelable.Param(m1089id = 3) String str, @SafeParcelable.Param(m1089id = 4) String str2) {
        this.zza = bArr;
        try {
