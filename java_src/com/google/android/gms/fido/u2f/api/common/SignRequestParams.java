...
public class SignRequestParams extends RequestParams {
    ...
    @SafeParcelable.Field(getter = "getDefaultSignChallenge", m1090id = 5)
    ...
    public SignRequestParams(@SafeParcelable.Param(m1089id = 2) Integer num, @SafeParcelable.Param(m1089id = 3) Double d, @SafeParcelable.Param(m1089id = 4) Uri uri, @SafeParcelable.Param(m1089id = 5) byte[] bArr, @SafeParcelable.Param(m1089id = 6) List list, @SafeParcelable.Param(m1089id = 7) ChannelIdValue channelIdValue, @SafeParcelable.Param(m1089id = 8) String str) {
        this.zza = num;
        this.zzb = d;
        this.zzc = uri;
        this.zzd = bArr;
