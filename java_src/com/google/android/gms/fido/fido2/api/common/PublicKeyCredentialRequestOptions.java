...
public class PublicKeyCredentialRequestOptions extends RequestOptions {
    ...
    @SafeParcelable.Field(getter = "getRpId", m1090id = 4)
    private final String zzc;
    @SafeParcelable.Field(getter = "getAllowList", m1090id = 5)
    private final List zzd;
    @SafeParcelable.Field(getter = "getRequestId", m1090id = 6)
    private final Integer zze;
    @SafeParcelable.Field(getter = "getTokenBinding", m1090id = 7)
    private final TokenBinding zzf;
    @SafeParcelable.Field(getter = "getUserVerificationAsString", m1090id = 8, type = "java.lang.String")
    private final zzat zzg;
    @SafeParcelable.Field(getter = "getAuthenticationExtensions", m1090id = 9)
    private final AuthenticationExtensions zzh;
    @SafeParcelable.Field(getter = "getLongRequestId", m1090id = 10)
    ...
    public PublicKeyCredentialRequestOptions(@SafeParcelable.Param(m1089id = 2) byte[] bArr, @SafeParcelable.Param(m1089id = 3) Double d, @SafeParcelable.Param(m1089id = 4) String str, @SafeParcelable.Param(m1089id = 5) List list, @SafeParcelable.Param(m1089id = 6) Integer num, @SafeParcelable.Param(m1089id = 7) TokenBinding tokenBinding, @SafeParcelable.Param(m1089id = 8) String str2, @SafeParcelable.Param(m1089id = 9) AuthenticationExtensions authenticationExtensions, @SafeParcelable.Param(m1089id = 10) Long l) {
        this.zza = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzb = d;
        this.zzc = (String) Preconditions.checkNotNull(str);
        this.zzd = list;
