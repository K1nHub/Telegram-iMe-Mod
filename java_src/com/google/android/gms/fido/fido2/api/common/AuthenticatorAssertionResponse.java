...
public class AuthenticatorAssertionResponse extends AuthenticatorResponse {
    ...
    @SafeParcelable.Field(getter = "getClientDataJSON", m797id = 3)
    private final byte[] zzb;
    @SafeParcelable.Field(getter = "getAuthenticatorData", m797id = 4)
    private final byte[] zzc;
    @SafeParcelable.Field(getter = "getSignature", m797id = 5)
    private final byte[] zzd;
    @SafeParcelable.Field(getter = "getUserHandle", m797id = 6)
    private final byte[] zze;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public AuthenticatorAssertionResponse(@SafeParcelable.Param(m796id = 2) byte[] bArr, @SafeParcelable.Param(m796id = 3) byte[] bArr2, @SafeParcelable.Param(m796id = 4) byte[] bArr3, @SafeParcelable.Param(m796id = 5) byte[] bArr4, @SafeParcelable.Param(m796id = 6) byte[] bArr5) {
