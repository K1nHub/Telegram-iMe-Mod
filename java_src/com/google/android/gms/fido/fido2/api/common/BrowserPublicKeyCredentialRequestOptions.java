...
public class BrowserPublicKeyCredentialRequestOptions extends BrowserRequestOptions {
    ...
    @SafeParcelable.Field(getter = "getPublicKeyCredentialRequestOptions", m779id = 2)
    private final PublicKeyCredentialRequestOptions zza;
    @SafeParcelable.Field(getter = "getOrigin", m779id = 3)
    private final Uri zzb;
    @SafeParcelable.Field(getter = "getClientDataHash", m779id = 4)
    ...
    public BrowserPublicKeyCredentialRequestOptions(@SafeParcelable.Param(m778id = 2) PublicKeyCredentialRequestOptions publicKeyCredentialRequestOptions, @SafeParcelable.Param(m778id = 3) Uri uri, @SafeParcelable.Param(m778id = 4) byte[] bArr) {
        this.zza = (PublicKeyCredentialRequestOptions) Preconditions.checkNotNull(publicKeyCredentialRequestOptions);
        zzc(uri);
        this.zzb = uri;
        zzd(bArr);
