...
public class FidoCredentialDetails extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUserName", m1090id = 1)
    private final String zza;
    @SafeParcelable.Field(getter = "getUserDisplayName", m1090id = 2)
    private final String zzb;
    @SafeParcelable.Field(getter = "getUserId", m1090id = 3)
    private final byte[] zzc;
    @SafeParcelable.Field(getter = "getCredentialId", m1090id = 4)
    private final byte[] zzd;
    @SafeParcelable.Field(getter = "getIsDiscoverable", m1090id = 5)
    private final boolean zze;
    @SafeParcelable.Field(getter = "getIsPaymentCredential", m1090id = 6)
    private final boolean zzf;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public FidoCredentialDetails(@SafeParcelable.Param(m1089id = 1) String str, @SafeParcelable.Param(m1089id = 2) String str2, @SafeParcelable.Param(m1089id = 3) byte[] bArr, @SafeParcelable.Param(m1089id = 4) byte[] bArr2, @SafeParcelable.Param(m1089id = 5) boolean z, @SafeParcelable.Param(m1089id = 6) boolean z2) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = bArr;
        this.zzd = bArr2;
