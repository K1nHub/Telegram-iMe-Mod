...
public final class zzn extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getVersion", m1090id = 1)
    private final long zza;
    @SafeParcelable.Field(getter = "getClientEid", m1090id = 2)
    private final byte[] zzb;
    @SafeParcelable.Field(getter = "getAuthenticatorEid", m1090id = 3)
    private final byte[] zzc;
    @SafeParcelable.Field(getter = "getSessionPreKey", m1090id = 4)
    private final byte[] zzd;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public zzn(@SafeParcelable.Param(m1089id = 1) long j, @SafeParcelable.Param(m1089id = 2) byte[] bArr, @SafeParcelable.Param(m1089id = 3) byte[] bArr2, @SafeParcelable.Param(m1089id = 4) byte[] bArr3) {
        this.zza = j;
