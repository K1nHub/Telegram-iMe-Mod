...
public class UvmEntry extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUserVerificationMethod", m779id = 1)
    private int zza;
    @SafeParcelable.Field(getter = "getKeyProtectionType", m779id = 2)
    private short zzb;
    @SafeParcelable.Field(getter = "getMatcherProtectionType", m779id = 3)
    private short zzc;
    ...
    public UvmEntry(@SafeParcelable.Param(m778id = 1) int i, @SafeParcelable.Param(m778id = 2) short s, @SafeParcelable.Param(m778id = 3) short s2) {
        this.zza = i;
        this.zzb = s;
        this.zzc = s2;
    }
