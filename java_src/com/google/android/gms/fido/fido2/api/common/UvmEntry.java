...
public class UvmEntry extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUserVerificationMethod", m797id = 1)
    private int zza;
    @SafeParcelable.Field(getter = "getKeyProtectionType", m797id = 2)
    private short zzb;
    @SafeParcelable.Field(getter = "getMatcherProtectionType", m797id = 3)
    private short zzc;
    ...
    public UvmEntry(@SafeParcelable.Param(m796id = 1) int i, @SafeParcelable.Param(m796id = 2) short s, @SafeParcelable.Param(m796id = 3) short s2) {
        this.zza = i;
        this.zzb = s;
        this.zzc = s2;
    }
