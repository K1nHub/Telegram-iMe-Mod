...
public class AuthenticatorErrorResponse extends AuthenticatorResponse {
    ...
    @SafeParcelable.Field(getter = "getErrorCodeAsInt", m1090id = 2, type = "int")
    private final ErrorCode zza;
    @SafeParcelable.Field(getter = "getErrorMessage", m1090id = 3)
    private final String zzb;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public AuthenticatorErrorResponse(@SafeParcelable.Param(m1089id = 2) int i, @SafeParcelable.Param(m1089id = 3) String str) {
        try {
