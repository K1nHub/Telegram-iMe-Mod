...
public class PublicKeyCredentialUserEntity extends AbstractSafeParcelable {
    ...
    public PublicKeyCredentialUserEntity(@SafeParcelable.Param(m1089id = 2) byte[] bArr, @SafeParcelable.Param(m1089id = 3) String str, @SafeParcelable.Param(m1089id = 4) String str2, @SafeParcelable.Param(m1089id = 5) String str3) {
