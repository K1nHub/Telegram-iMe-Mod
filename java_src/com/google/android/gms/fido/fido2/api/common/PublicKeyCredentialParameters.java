...
public class PublicKeyCredentialParameters extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAlgorithmIdAsInteger", m789id = 3, type = "java.lang.Integer")
    private final COSEAlgorithmIdentifier zzb;

    @SafeParcelable.Constructor
    public PublicKeyCredentialParameters(@SafeParcelable.Param(m788id = 2) String str, @SafeParcelable.Param(m788id = 3) int i) {
