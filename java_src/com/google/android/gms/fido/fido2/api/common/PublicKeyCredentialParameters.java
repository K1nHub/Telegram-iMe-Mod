...
public class PublicKeyCredentialParameters extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAlgorithmIdAsInteger", m775id = 3, type = "java.lang.Integer")
    private final COSEAlgorithmIdentifier zzb;

    @SafeParcelable.Constructor
    public PublicKeyCredentialParameters(@SafeParcelable.Param(m774id = 2) String str, @SafeParcelable.Param(m774id = 3) int i) {
