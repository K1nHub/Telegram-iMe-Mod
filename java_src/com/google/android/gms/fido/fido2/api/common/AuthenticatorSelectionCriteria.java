...
public class AuthenticatorSelectionCriteria extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAttachmentAsString", m779id = 2, type = "java.lang.String")
    private final Attachment zza;
    @SafeParcelable.Field(getter = "getRequireResidentKey", m779id = 3)
    private final Boolean zzb;
    @SafeParcelable.Field(getter = "getRequireUserVerificationAsString", m779id = 4, type = "java.lang.String")
    private final zzat zzc;
    @SafeParcelable.Field(getter = "getResidentKeyRequirementAsString", m779id = 5, type = "java.lang.String")
    ...
    public AuthenticatorSelectionCriteria(@SafeParcelable.Param(m778id = 2) String str, @SafeParcelable.Param(m778id = 3) Boolean bool, @SafeParcelable.Param(m778id = 4) String str2, @SafeParcelable.Param(m778id = 5) String str3) {
