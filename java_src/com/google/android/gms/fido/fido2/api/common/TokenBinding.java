...
public class TokenBinding extends AbstractSafeParcelable {
    @SafeParcelable.Field(getter = "getTokenBindingStatusAsString", m797id = 2, type = "java.lang.String")
    private final TokenBindingStatus zza;
    @SafeParcelable.Field(getter = "getTokenBindingId", m797id = 3)
    ...
    public TokenBinding(@SafeParcelable.Param(m796id = 2) String str, @SafeParcelable.Param(m796id = 3) String str2) {
