...
public class TokenBinding extends AbstractSafeParcelable {
    @SafeParcelable.Field(getter = "getTokenBindingStatusAsString", m779id = 2, type = "java.lang.String")
    private final TokenBindingStatus zza;
    @SafeParcelable.Field(getter = "getTokenBindingId", m779id = 3)
    ...
    public TokenBinding(@SafeParcelable.Param(m778id = 2) String str, @SafeParcelable.Param(m778id = 3) String str2) {
