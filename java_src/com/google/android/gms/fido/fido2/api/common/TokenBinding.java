...
public class TokenBinding extends AbstractSafeParcelable {
    @SafeParcelable.Field(getter = "getTokenBindingStatusAsString", m1089id = 2, type = "java.lang.String")
    private final TokenBindingStatus zza;
    @SafeParcelable.Field(getter = "getTokenBindingId", m1089id = 3)
    ...
    public TokenBinding(@SafeParcelable.Param(m1088id = 2) String str, @SafeParcelable.Param(m1088id = 3) String str2) {
