...
public final class zzio extends zzf {
    ...
    public final void zzB(zzih zzihVar, zzih zzihVar2, long j, boolean z, Bundle bundle) {
        ...
        if (z3) {
            ...
            String str3 = true != zzihVar.zze ? TtmlNode.TEXT_EMPHASIS_AUTO : "app";
    ...
    public final void zzr(Activity activity, Bundle bundle) {
        ...
        this.zzd.put(activity, new zzih(bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.NAME), bundle2.getString("referrer_name"), bundle2.getLong(TtmlNode.ATTR_ID)));
    }
    ...
    public final void zzv(Activity activity, Bundle bundle) {
        ...
        bundle2.putLong(TtmlNode.ATTR_ID, zzihVar.zzc);
