                ...
                if (zzj == null) {
                    ...
                    try {
                        ...
                        if (zzkxVar == null || zzkxVar.zze == null) {
                            zzkx zzkxVar2 = new zzkx(zzt, TtmlNode.TEXT_EMPHASIS_AUTO, "_lte", zzr.zzs.zzav().currentTimeMillis(), 0L);
                            zzu2.add(zzkxVar2);
                        ...
                        if (zzu3.zzs.zzg().zze()) {
                            ...
                            if (zzj.zzai() && zzu3.zzf.zzo().zzk(zzt2)) {
                                ...
                                zzu2.add(new zzkx(zzt2, TtmlNode.TEXT_EMPHASIS_AUTO, "_npa", zzu3.zzs.zzav().currentTimeMillis(), 1L));
                            }
                        }
