...
public final class MessageSchema<T> implements Schema<T> {
    ...
    */
    ...
    private int getSerializedSizeProto2(T t) {
        ...
        while (i5 < this.buffer.length) {
            ...
            if (type <= 17) {
                ...
                i = (!this.useCachedSizeField || type < FieldType.DOUBLE_LIST_PACKED.m703id() || type > FieldType.SINT64_LIST_PACKED.m703id()) ? 0 : this.buffer[i5 + 2] & i3;
                i2 = 0;
            }
            long offset = offset(typeAndOffsetAt);
            switch (type) {
    ...
    private int getSerializedSizeProto3(T t) {
        ...
        for (int i2 = 0; i2 < this.buffer.length; i2 += 3) {
            ...
            long offset = offset(typeAndOffsetAt);
            int i3 = (type < FieldType.DOUBLE_LIST_PACKED.m703id() || type > FieldType.SINT64_LIST_PACKED.m703id()) ? 0 : this.buffer[i2 + 2] & 1048575;
            switch (type) {
                case 0:
    ...
    */
    ...
    private int decodeMapEntryValue(byte[] bArr, int i, int i2, WireFormat.FieldType fieldType, Class<?> cls, ArrayDecoders.Registers registers) throws IOException {
        switch (C11971.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
