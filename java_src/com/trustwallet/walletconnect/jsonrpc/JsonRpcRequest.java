...
public final class JsonRpcRequest<T> {
    ...
    public int hashCode() {
        int m1020m = ((ProfileData$$ExternalSyntheticBackport0.m1020m(this.f413id) * 31) + this.jsonrpc.hashCode()) * 31;
        WCMethod wCMethod = this.method;
        int hashCode = (m1020m + (wCMethod == null ? 0 : wCMethod.hashCode())) * 31;
        T t = this.params;
