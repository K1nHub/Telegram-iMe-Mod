...
public final class JsonRpcErrorResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JsonRpcErrorResponse) {
            ...
            return Intrinsics.areEqual(this.jsonrpc, jsonRpcErrorResponse.jsonrpc) && this.f378id == jsonRpcErrorResponse.f378id && Intrinsics.areEqual(this.error, jsonRpcErrorResponse.error);
        }
        return false;
    }

    public int hashCode() {
        return (((this.jsonrpc.hashCode() * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.f378id)) * 31) + this.error.hashCode();
    }

    public String toString() {
        return "JsonRpcErrorResponse(jsonrpc=" + this.jsonrpc + ", id=" + this.f378id + ", error=" + this.error + ')';
    }
