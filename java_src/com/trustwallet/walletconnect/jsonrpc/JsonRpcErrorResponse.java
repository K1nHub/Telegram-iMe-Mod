...
public final class JsonRpcErrorResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JsonRpcErrorResponse) {
            ...
            return Intrinsics.areEqual(this.jsonrpc, jsonRpcErrorResponse.jsonrpc) && this.f383id == jsonRpcErrorResponse.f383id && Intrinsics.areEqual(this.error, jsonRpcErrorResponse.error);
        }
        return false;
    }

    public int hashCode() {
        return (((this.jsonrpc.hashCode() * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.f383id)) * 31) + this.error.hashCode();
    }

    public String toString() {
        return "JsonRpcErrorResponse(jsonrpc=" + this.jsonrpc + ", id=" + this.f383id + ", error=" + this.error + ')';
    }
