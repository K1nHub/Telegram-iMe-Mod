...
public final class WCBinanceTradeOrder extends WCBinanceOrder<Message> {
    ...
    public static final class Message {
        ...
        public int hashCode() {
            return (((((((((((((this.f416id.hashCode() * 31) + this.orderType) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.price)) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.quantity)) * 31) + this.sender.hashCode()) * 31) + this.side) * 31) + this.symbol.hashCode()) * 31) + this.timeInforce;
        }
