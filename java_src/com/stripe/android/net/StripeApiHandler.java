...
public class StripeApiHandler {
    ...
    static Map<String, String> getHeaders(RequestOptions requestOptions) {
        ...
        hashMap.put(RtspHeaders.USER_AGENT, String.format("Stripe/v1 JavaBindings/%s", VERSION));
        hashMap.put(RtspHeaders.AUTHORIZATION, String.format("Bearer %s", requestOptions.getPublishableApiKey()));
    ...
    private static HttpURLConnection createPostConnection(String str, String str2, RequestOptions requestOptions) throws IOException {
        ...
        createStripeConnection.setRequestProperty(RtspHeaders.CONTENT_TYPE, String.format("application/x-www-form-urlencoded;charset=%s", "UTF-8"));
        try {
