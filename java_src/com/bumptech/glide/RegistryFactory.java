...
public final class RegistryFactory {
    ...
    private static void initializeDefaults(Context context, Registry registry, BitmapPool bitmapPool, ArrayPool arrayPool, GlideExperiments glideExperiments) {
        ...
        Object obj2 = obj;
        registry.append(cls, InputStream.class, inputStreamFactory).append((Class) obj2, InputStream.class, (ModelLoaderFactory) inputStreamFactory).append(cls, AssetFileDescriptor.class, assetFileDescriptorFactory).append((Class) obj2, AssetFileDescriptor.class, (ModelLoaderFactory) assetFileDescriptorFactory).append(cls, Drawable.class, drawableFactory).append((Class) obj2, Drawable.class, (ModelLoaderFactory) drawableFactory).append(Uri.class, InputStream.class, ResourceUriLoader.newStreamFactory(context)).append(Uri.class, AssetFileDescriptor.class, ResourceUriLoader.newAssetFileDescriptorFactory(context));
        ...
        registry.append((Class) obj2, Uri.class, (ModelLoaderFactory) uriFactory).append(cls, Uri.class, uriFactory).append((Class) obj2, AssetFileDescriptor.class, (ModelLoaderFactory) assetFileDescriptorFactory2).append(cls, AssetFileDescriptor.class, assetFileDescriptorFactory2).append((Class) obj2, InputStream.class, (ModelLoaderFactory) streamFactory).append(cls, InputStream.class, streamFactory);
