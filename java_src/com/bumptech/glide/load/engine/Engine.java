...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    public class LoadStatus {
        ...
        public void cancel() {
            synchronized (Engine.this) {
                this.engineJob.removeCallback(this.f87cb);
            }
        }
    }
    ...
    public static class DecodeJobFactory {
        ...
        final Pools$Pool<DecodeJob<?>> pool = FactoryPools.threadSafe(ImageReceiver.DEFAULT_CROSSFADE_DURATION, new FactoryPools.Factory<DecodeJob<?>>() { // from class: com.bumptech.glide.load.engine.Engine.DecodeJobFactory.1
    ...
    public static class EngineJobFactory {
        ...
        final Pools$Pool<EngineJob<?>> pool = FactoryPools.threadSafe(ImageReceiver.DEFAULT_CROSSFADE_DURATION, new FactoryPools.Factory<EngineJob<?>>() { // from class: com.bumptech.glide.load.engine.Engine.EngineJobFactory.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.bumptech.glide.util.pool.FactoryPools.Factory
