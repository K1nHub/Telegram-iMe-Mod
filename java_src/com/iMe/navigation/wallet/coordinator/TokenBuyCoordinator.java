...
public final class TokenBuyCoordinator {
    ...
    public final void start(INavigationLayout actionBarLayout, TokenBuyCoordinatorArgs args, boolean z) {
        ...
        if (args.getToken() != null && FeatureAvailableManager$Token.INSTANCE.isPurchaseAvailable(networkId)) {
            ...
            actionBarLayout.presentFragment(companion.newInstance(new WalletSwapScreenType.Crypto(swapProtocol, null, args.getToken(), args.getNetworkId())), z);
            return;
        }
        ContextExtKt.toast(this.resourceManager.getString(C3558R.string.common_unexpected_error_title));
    }
    ...
    public final void showNoEnoughMoneyDialog(final INavigationLayout actionBarLayout, final TokenBuyCoordinatorArgs args) {
        ...
        if (args.getToken() != null && FeatureAvailableManager$Token.INSTANCE.isPurchaseAvailable(this.cryptoPreferenceHelper.getNetworkId())) {
            ...
            DialogsFactoryKt.showErrorAlert(lastFragment, this.resourceManager.getString(C3558R.string.wallet_common_error_not_enough_money_title), this.resourceManager.getString(C3558R.string.wallet_common_error_not_enough_money_description), this.resourceManager.getString(C3558R.string.wallet_common_error_not_enough_money_btn_txt), new Callbacks$Callback() { // from class: com.iMe.navigation.wallet.coordinator.TokenBuyCoordinator$$ExternalSyntheticLambda0
        ...
        DialogsFactoryKt.showErrorAlert$default(lastFragment2, this.resourceManager.getString(C3558R.string.wallet_common_error_not_enough_money_title), this.resourceManager.getString(C3558R.string.wallet_common_error_not_enough_money_simple_description), this.resourceManager.getString(C3558R.string.common_ok), null, 8, null);
    }
