...
import com.iMe.storage.data.utils.p029rx.AppSchedulers;
...
final class UtilsModuleKt$dataUtilsModule$1 extends Lambda implements Function1<Module, Unit> {
    ...
    /* loaded from: classes3.dex */
    public static final class C16771 extends Lambda implements Function2<Scope, ParametersHolder, ResourceManager> {
        public static final C16771 INSTANCE = new C16771();
    ...
    /* loaded from: classes3.dex */
    public static final class C16782 extends Lambda implements Function2<Scope, ParametersHolder, SchedulersProvider> {
    ...
    public final void invoke2(Module module) {
        ...
        C16771 c16771 = C16771.INSTANCE;
        ScopeRegistry.Companion companion = ScopeRegistry.Companion;
        StringQualifier rootScopeQualifier = companion.getRootScopeQualifier();
        Kind kind = Kind.Singleton;
        emptyList = CollectionsKt__CollectionsKt.emptyList();
        SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(ResourceManager.class), null, c16771, kind, emptyList));
        module.indexPrimaryType(singleInstanceFactory);
        if (module.get_createdAtStart()) {
            module.prepareForCreationAtStart(singleInstanceFactory);
        }
        new Pair(module, singleInstanceFactory);
        C16782 c16782 = C16782.INSTANCE;
        StringQualifier rootScopeQualifier2 = companion.getRootScopeQualifier();
        Kind kind2 = Kind.Factory;
        emptyList2 = CollectionsKt__CollectionsKt.emptyList();
        InstanceFactory<?> factoryInstanceFactory = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(SchedulersProvider.class), null, c16782, kind2, emptyList2));
