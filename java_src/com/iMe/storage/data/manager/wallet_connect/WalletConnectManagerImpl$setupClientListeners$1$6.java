...
public final class WalletConnectManagerImpl$setupClientListeners$1$6 extends Lambda implements Function2<Long, WCEthereumTransaction, Unit> {
    final /* synthetic */ WCSessionStoreItem $sessionStoreItem;
    final /* synthetic */ WalletConnectManagerImpl this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WalletConnectManagerImpl$setupClientListeners$1$6(WalletConnectManagerImpl walletConnectManagerImpl, WCSessionStoreItem wCSessionStoreItem) {
        super(2);
    ...
    public final void invoke(long j, WCEthereumTransaction transaction) {
        ...
        this.this$0.onTransactionProcessing(j, this.$sessionStoreItem, transaction, false);
    }
}
