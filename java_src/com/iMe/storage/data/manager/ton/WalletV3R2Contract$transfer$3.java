...
@DebugMetadata(m143c = "com.iMe.storage.data.manager.ton.WalletV3R2Contract$transfer$3", m142f = "WalletV3R2Contract.kt", m141l = {105}, m140m = "invokeSuspend")
...
public final class WalletV3R2Contract$transfer$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WalletV3R2Contract$transfer$3(WalletV3R2Contract walletV3R2Contract, PrivateKeyEd25519 privateKeyEd25519, Instant instant, WalletTransfer[] walletTransferArr, LiteApi liteApi, Continuation<? super WalletV3R2Contract$transfer$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletV3R2Contract$transfer$3(this.this$0, this.$privateKey, this.$validUntil, this.$transfers, this.$liteApi, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            int seqno = !(this.this$0.getState() instanceof AccountActive) ? 0 : this.this$0.getSeqno();
            ...
            Message<Cell> createTransferMessage = companion.createTransferMessage(address, createStateInit$default, this.$privateKey, subWalletId, epochSeconds, seqno, (WalletTransfer[]) Arrays.copyOf(walletTransferArr, walletTransferArr.length));
