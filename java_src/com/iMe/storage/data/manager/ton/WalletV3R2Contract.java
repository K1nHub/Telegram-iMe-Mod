...
public final class WalletV3R2Contract implements WalletContract<Cell> {
    ...
    public final Object transfer(LiteApi liteApi, PrivateKeyEd25519 privateKeyEd25519, Integer num, WalletTransfer[] walletTransferArr, Continuation<? super Unit> continuation) {
        ...
        Object transfer = transfer(liteApi, privateKeyEd25519, now.m2129plusLRDsOJo(DurationKt.toDuration(60, DurationUnit.SECONDS)), num, (WalletTransfer[]) Arrays.copyOf(walletTransferArr, walletTransferArr.length), continuation);
