...
public final class C1754xcf4b3e2d extends Lambda implements Function1<Result<? extends Wallet>, Result<? extends String>> {
    public C1754xcf4b3e2d() {
        super(1);
    }
    ...
    public final Result<? extends String> invoke(Result<? extends Wallet> result) {
        ...
        Wallet wallet2 = (Wallet) result.getData();
