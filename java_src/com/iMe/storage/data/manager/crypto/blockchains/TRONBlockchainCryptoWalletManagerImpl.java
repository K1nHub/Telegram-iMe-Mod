...
public final class TRONBlockchainCryptoWalletManagerImpl extends BlockchainCryptoWalletManager {
    ...
    public Observable<Result<Wallet>> createWallet() {
        Observable<Result<Wallet>> just = Observable.just(Result.Companion.success(new Wallet.TRON("", new HDWallet(256, ""))));
    ...
    public Observable<Result<String>> generateAddressByMnemonic(final String mnemonic) {
        ...
        final C1872x29f55e4 c1872x29f55e4 = new Function1<Throwable, Result<? extends String>>() { // from class: com.iMe.storage.data.manager.crypto.blockchains.TRONBlockchainCryptoWalletManagerImpl$generateAddressByMnemonic$2
