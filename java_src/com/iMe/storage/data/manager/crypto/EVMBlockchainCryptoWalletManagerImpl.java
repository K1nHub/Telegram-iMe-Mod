...
public final class EVMBlockchainCryptoWalletManagerImpl extends BlockchainCryptoWalletManager {
    ...
    public Observable<Result<Wallet>> createWallet(String guid, String password) {
        ...
        Observable flatMap = generateMnemonic(guid, password).flatMap(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1753x67d25efc(this, guid, password)));
    ...
    public Observable<Result<String>> generateAddressByMnemonic(final String mnemonic) {
        Intrinsics.checkNotNullParameter(mnemonic, "mnemonic");
        Observable fromCallable = Observable.fromCallable(new Callable() { // from class: com.iMe.storage.data.manager.crypto.EVMBlockchainCryptoWalletManagerImpl$$ExternalSyntheticLambda2
    ...
    public Observable<Result<String>> generateMnemonic(String guid, String password) {
        ...
        Observable<Result<String>> onErrorReturn = fromCallable.onErrorReturn(new Function() { // from class: com.iMe.storage.data.manager.crypto.EVMBlockchainCryptoWalletManagerImpl$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
