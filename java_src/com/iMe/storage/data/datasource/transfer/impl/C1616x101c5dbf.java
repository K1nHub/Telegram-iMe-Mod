...
public final class C1616x101c5dbf extends Lambda implements Function1<ApiBaseResponse<CryptoTransferDataResponse.TRON>, Result<? extends CryptoTransferMetadata>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1616x101c5dbf(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
