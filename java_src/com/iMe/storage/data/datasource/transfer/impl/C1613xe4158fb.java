...
/* renamed from: com.iMe.storage.data.datasource.transfer.impl.BTCWalletTransferDataSourceImpl$transfer$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1613xe4158fb extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends Boolean>>> {
    final /* synthetic */ BTCWalletTransferDataSourceImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1613xe4158fb(BTCWalletTransferDataSourceImpl bTCWalletTransferDataSourceImpl) {
        super(1);
        this.this$0 = bTCWalletTransferDataSourceImpl;
    }
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends String> result) {
        ...
        ObservableSource map = sendCryptoTransferTransaction.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(new C1614x9a4eb291(firebaseFunctionsErrorHandler)));
