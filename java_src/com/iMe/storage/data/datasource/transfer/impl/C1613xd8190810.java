...
/* renamed from: com.iMe.storage.data.datasource.transfer.impl.EVMWalletTransferDataSourceImpl$transfer$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1613xd8190810 extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends Boolean>>> {
    final /* synthetic */ EVMWalletTransferDataSourceImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1613xd8190810(EVMWalletTransferDataSourceImpl eVMWalletTransferDataSourceImpl) {
        super(1);
        this.this$0 = eVMWalletTransferDataSourceImpl;
    }
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends String> result) {
        ...
        ObservableSource map = sendCryptoTransferTransaction.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(new C1614x22c2289c(firebaseFunctionsErrorHandler)));
