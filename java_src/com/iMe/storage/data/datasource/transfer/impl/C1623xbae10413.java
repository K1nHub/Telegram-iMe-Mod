...
/* renamed from: com.iMe.storage.data.datasource.transfer.impl.BTCWalletTransferDataSourceImpl$getTransferMetadata$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1623xbae10413 extends Lambda implements Function1<ApiBaseResponse<CryptoTransferDataResponse.BTC>, Result<? extends CryptoTransferMetadata>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1623xbae10413(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
