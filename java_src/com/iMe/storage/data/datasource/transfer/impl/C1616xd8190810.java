...
public final class C1616xd8190810 extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends Boolean>>> {
    final /* synthetic */ EVMWalletTransferDataSourceImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1616xd8190810(EVMWalletTransferDataSourceImpl eVMWalletTransferDataSourceImpl) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends String> result) {
        ...
        ObservableSource map = sendCryptoTransferTransaction.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(new C1617x22c2289c(firebaseFunctionsErrorHandler)));
