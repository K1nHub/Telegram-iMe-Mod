...
public final class C1633x2f0ca7ae extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends String>>> {
    final /* synthetic */ WalletConnectDataSourceImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1633x2f0ca7ae(WalletConnectDataSourceImpl walletConnectDataSourceImpl) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends String>> invoke(Result<? extends String> result) {
        ...
        ObservableSource map = sendWalletConnectCryptoTransaction.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(new C1634x41a6027d(firebaseFunctionsErrorHandler)));
