...
/* renamed from: com.iMe.storage.data.repository.twitter.TwitterRepositoryImpl$searchUsersByUsername$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1866x2fcdcf3 extends Lambda implements Function1<ApiBaseResponse<List<? extends TwitterUserResponse>>, Result<? extends List<? extends TwitterUserInfo>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1866x2fcdcf3(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
