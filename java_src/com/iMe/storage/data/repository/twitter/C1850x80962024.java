...
public final class C1850x80962024 extends Lambda implements Function1<Throwable, Result<? extends TwitterProfileInfo>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1850x80962024(ErrorHandler errorHandler) {
        super(1);
