...
public final class SessionRepositoryImpl implements SessionRepository {
    ...
    public SessionRepositoryImpl(WalletApi walletApi, ApiErrorHandler errorHandler, AuthManager authManager, FirebaseFunctionsErrorHandler firebaseErrorHandler) {
    ...
    @Override // com.iMe.storage.domain.repository.wallet.SessionRepository
    ...
    public Completable logout() {
        ...
        Completable fromAction = Completable.fromAction(new Action() { // from class: com.iMe.storage.data.repository.wallet.SessionRepositoryImpl$$ExternalSyntheticLambda0
    ...
    public Observable<Result<SessionTokens>> refreshToken() {
        ...
        Observable<R> map = refreshToken2.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(new Function1<ApiBaseResponse<SessionTokensResponse>, Result<? extends SessionTokens>>() { // from class: com.iMe.storage.data.repository.wallet.SessionRepositoryImpl$refreshToken$$inlined$mapSuccess$1
        ...
        Observable<Result<SessionTokens>> onErrorReturn = map.onErrorReturn(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new Function1<Throwable, Result<? extends SessionTokens>>() { // from class: com.iMe.storage.data.repository.wallet.SessionRepositoryImpl$refreshToken$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<SessionTokens>> login(String url) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = authTokensByTelegramLoginData.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(new Function1<ApiBaseResponse<SessionTokensResponse>, Result<? extends SessionTokens>>() { // from class: com.iMe.storage.data.repository.wallet.SessionRepositoryImpl$login$$inlined$mapSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<SessionTokens>> onErrorReturn = map.onErrorReturn(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new Function1<Throwable, Result<? extends SessionTokens>>() { // from class: com.iMe.storage.data.repository.wallet.SessionRepositoryImpl$login$$inlined$handleError$1
            {
                super(1);
            }
