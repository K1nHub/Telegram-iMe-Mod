...
public final class GoogleServicesRepositoryImpl implements GoogleServicesRepository {
    ...
    private final Pair<MultipartBody.Part, File> convertBitmapToMultipart(Bitmap bitmap) {
        ...
        return TuplesKt.m149to(MultipartBody.Part.Companion.createFormData("image", tempFile$default.getName(), RequestBody.Companion.create(tempFile$default, MediaType.Companion.parse(MimeTypes.IMAGE_JPEG))), tempFile$default);
    }
