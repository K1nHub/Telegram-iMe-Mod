...
public final class KiklikoRepositoryImpl implements KiklikoRepository {
    ...
    public Observable<Result<Boolean>> report(String id, String reason) {
        ...
        Observable<R> map = this.api.report(id, new ReportRequest(this.preferenceHelper.getKiklikoUUID(), reason)).map(KiklikoRepositoryImpl$$ExternalSyntheticLambda4.INSTANCE);
