...
public final class C1852x268554b6 extends Lambda implements Function1<Throwable, Result<? extends CampaignsCursored>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1852x268554b6(ErrorHandler errorHandler) {
        super(1);
