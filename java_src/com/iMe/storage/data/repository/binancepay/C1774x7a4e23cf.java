...
public final class C1774x7a4e23cf extends Lambda implements Function1<ApiBaseResponse<List<? extends BinanceTokenBalanceResponse>>, Result<? extends List<? extends BinanceTokenBalanceInfo>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1774x7a4e23cf(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
