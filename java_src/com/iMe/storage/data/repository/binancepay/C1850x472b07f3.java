...
public final class C1850x472b07f3 extends Lambda implements Function1<ApiBaseResponse<List<? extends BinancePayGetAvailablePaymentTokensResponse>>, Result<? extends List<? extends BinanceTokenInfo>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1850x472b07f3(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
