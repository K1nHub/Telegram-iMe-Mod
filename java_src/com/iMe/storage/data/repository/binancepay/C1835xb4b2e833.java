...
public final class C1835xb4b2e833 extends Lambda implements Function1<Throwable, Result<? extends BinanceCollectionOrder>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1835xb4b2e833(ErrorHandler errorHandler) {
        super(1);
