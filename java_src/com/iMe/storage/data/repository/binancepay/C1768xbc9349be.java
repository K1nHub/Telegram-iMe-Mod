...
public final class C1768xbc9349be extends Lambda implements Function1<ApiBaseResponse<BinanceGetTokenReplenishAddressResponse>, Result<? extends String>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1768xbc9349be(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
