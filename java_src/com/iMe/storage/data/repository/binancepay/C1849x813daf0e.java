...
public final class C1849x813daf0e extends Lambda implements Function1<Throwable, Result<? extends List<? extends BinanceTokenInfo>>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1849x813daf0e(ErrorHandler errorHandler) {
        super(1);
