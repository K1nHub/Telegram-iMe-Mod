...
public final class C1853x606f348c extends Lambda implements Function1<Throwable, Result<? extends List<? extends OutputConvertToken>>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1853x606f348c(ErrorHandler errorHandler) {
        super(1);
