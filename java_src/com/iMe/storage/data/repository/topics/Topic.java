...
public final class Topic {
    ...
    /* renamed from: IT */
    public static final Topic f313IT;
    ...
    /* renamed from: TV */
    public static final Topic f314TV;
    ...
    private static final /* synthetic */ Topic[] $values() {
        return new Topic[]{ANIMALS, ART, ASTROLOGY, AUTO, BLOGS, BOOKS, BUSINESS, CRYPTO, DESIGN, DEVELOP, ECONOMY, EDUCATION, FAMILY, FASHION, FILMS, FINANCE, FOOD, FRIENDS, GAMES, HOBBIES, HOME, HUMOR, f313IT, JOB, LAWS, LIFEHACK, MARKETING, MEDICINE, MUSIC, NEWS, POLITICS, QUOTES, RELIGION, SALES, SCIENCE, SPORT, TECHNOLOGY, TELEGRAM, TRAVEL, f314TV, ADULTHOOD, BOT, CALCULATOR, BEARD, CHEF, CHESS, CLOCHE, COFFEE, COLOSSEUM, CUBES, FLOWER, FUNDS, SHOE, PALM, WAND, MEDAL, MISSION, PAGODA, PILL, PINGPONG, PIZZA, ROCKET, UFO, DUCK, SCISSORS, MELON, SUN, DARTS, TROPHY, UMBRELLA, GLASSES, OTHER};
    }
    ...
    static {
        ...
        f313IT = new Topic("IT", 22, listOf18);
        ...
        f314TV = new Topic("TV", 39, emptyList6);
