...
/* renamed from: com.iMe.storage.data.repository.crypto.simplex.SimplexRepositoryImpl$createBuyingCryptoPayment$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1901xab3d1946 extends Lambda implements Function1<ApiBaseResponse<CreateBuyingCryptoPaymentResponse>, Result<? extends BuyingCryptoPayment>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;
    final /* synthetic */ CreateBuyingCryptoPaymentRequest $request$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1901xab3d1946(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler, CreateBuyingCryptoPaymentRequest createBuyingCryptoPaymentRequest) {
        super(1);
