...
public final class C1904xd64aae2f extends Lambda implements Function1<ApiBaseResponse<AvailableSwapTokensResponse>, Result<? extends List<? extends TokenInfo>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1904xd64aae2f(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
