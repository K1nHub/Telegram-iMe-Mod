...
/* renamed from: com.iMe.storage.data.repository.crypto.CryptoLocalWalletRepositoryImpl$isValidRestoredAddress$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1864x41e0c8d0 extends Lambda implements Function1<Result<? extends String>, Result<? extends Boolean>> {
    final /* synthetic */ String $linkedAddress$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1864x41e0c8d0(String str) {
        super(1);
