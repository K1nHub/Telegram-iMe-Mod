...
public final class C1807xde86f9b2 extends Lambda implements Function1<ApiBaseResponse<WalletTransactionsResponse>, Result<? extends List<? extends Transaction>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1807xde86f9b2(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
