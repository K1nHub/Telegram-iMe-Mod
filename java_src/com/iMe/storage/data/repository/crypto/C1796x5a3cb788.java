...
/* renamed from: com.iMe.storage.data.repository.crypto.CryptoLocalWalletRepositoryImpl$isValidRestoredAddress$lambda$10$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1796x5a3cb788 extends Lambda implements Function1<Result<? extends String>, Result<? extends Boolean>> {
    final /* synthetic */ String $linkedAddress$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1796x5a3cb788(String str) {
        super(1);
