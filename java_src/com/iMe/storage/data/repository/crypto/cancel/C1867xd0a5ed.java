...
public final class C1867xd0a5ed extends Lambda implements Function1<ApiBaseResponse<GetCancelTransactionDataResponse>, Result<? extends CryptoCancelMetadata>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1867xd0a5ed(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
