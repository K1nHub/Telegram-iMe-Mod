...
public final class C1824x1243a0b6 extends Lambda implements Function1<Throwable, Result<? extends WalletConnectProcessedTransaction>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1824x1243a0b6(ErrorHandler errorHandler) {
        super(1);
