...
public final class WalletConnectRepositoryImpl implements WalletConnectRepository {
    ...
    public Observable<Result<String>> sendWalletConnectCryptoTransaction(WalletConnectTransactionArgs args) {
        ...
        Observable<Result<String>> onErrorReturn = this.walletConnectDataSource.sendTransaction(args).onErrorReturn(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new C1905xc1db6217(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Flowable<Result<List<WCSessionStoreItem>>> getWalletConnectSavedSessions() {
        ...
        Flowable<Result<List<WCSessionStoreItem>>> handleError = map.onErrorReturn(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new C1903x8b365d34(this.errorHandler)));
