...
/* renamed from: com.iMe.storage.data.repository.crypto.level.AccountLevelRepositoryImpl$getLevelVisibility$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1895x717ec450 extends Lambda implements Function1<ApiBaseResponse<GetAccountLevelVisibilityResponse>, Result<? extends Boolean>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;
    final /* synthetic */ AccountLevelRepositoryImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1895x717ec450(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler, AccountLevelRepositoryImpl accountLevelRepositoryImpl) {
        super(1);
