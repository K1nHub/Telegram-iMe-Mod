...
public final class C1820x4a2c931c extends Lambda implements Function1<ApiBaseResponse<AccountInfoResponse>, Result<? extends AccountInfo>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1820x4a2c931c(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
