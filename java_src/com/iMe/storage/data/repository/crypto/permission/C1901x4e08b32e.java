...
public final class C1901x4e08b32e extends Lambda implements Function1<ApiBaseResponse<Object>, Result<? extends Boolean>> {
    ...
    public C1901x4e08b32e(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler, CryptoPermissionRepositoryImpl cryptoPermissionRepositoryImpl, boolean z, List list) {
        super(1);
    ...
    public final Result<Boolean> invoke(ApiBaseResponse<Object> response) {
        ...
        CryptoWalletsInfo copy$default = walletInfo != null ? CryptoWalletsInfo.copy$default(walletInfo, null, this.$isAllowForEveryone$inlined, this.$whitelistUsers$inlined, 1, null) : null;
