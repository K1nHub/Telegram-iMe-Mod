...
public final class C1827x9951f988 extends Lambda implements Function1<ApiBaseResponse<PasswordByPinCodeRequest>, ObservableSource<? extends Result<? extends String>>> {
    ...
    public C1827x9951f988(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler, PinCodeRepositoryImpl pinCodeRepositoryImpl, boolean z, String str) {
        super(1);
    ...
    /* loaded from: classes3.dex */
    public static final class C18281 extends Lambda implements Function1<String, Result<? extends String>> {
        public static final C18281 INSTANCE = new C18281();
    ...
    public final ObservableSource<? extends Result<String>> invoke(ApiBaseResponse<PasswordByPinCodeRequest> response) {
        ...
        if (this.$shouldUnlockWallet$inlined) {
            ...
            Observable<R> map = cryptoLocalWalletRepository.unlockAllWallets(str, str, aesDecrypt).map(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1830x713d6224(aesDecrypt)));
        ...
        return just.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(C18281.INSTANCE));
    }
}
