...
public final class C1814x9951f988 extends Lambda implements Function1<ApiBaseResponse<PasswordByPinCodeRequest>, ObservableSource<? extends Result<? extends String>>> {
    ...
    public C1814x9951f988(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler, PinCodeRepositoryImpl pinCodeRepositoryImpl, boolean z, String str) {
        super(1);
    ...
    /* loaded from: classes3.dex */
    public static final class C18151 extends Lambda implements Function1<String, Result<? extends String>> {
        public static final C18151 INSTANCE = new C18151();
    ...
    public final ObservableSource<? extends Result<String>> invoke(ApiBaseResponse<PasswordByPinCodeRequest> response) {
        ...
        if (this.$shouldUnlockWallet$inlined) {
            ...
            Observable<R> map = cryptoLocalWalletRepository.unlockAllWallets(str, str, aesDecrypt).map(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1817x713d6224(aesDecrypt)));
            Intrinsics.checkNotNullExpressionValue(map, "crossinline body: (T) ->…ult as? R\n        }\n    }");
            schedulersProvider = this.this$0.schedulersProvider;
            just = map.subscribeOn(schedulersProvider.mo694io());
            Intrinsics.checkNotNullExpressionValue(just, "{\n                      …                        }");
        } else {
            just = Observable.just(aesDecrypt);
            Intrinsics.checkNotNullExpressionValue(just, "just(this)");
        }
        return just.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(C18151.INSTANCE));
    }
}
