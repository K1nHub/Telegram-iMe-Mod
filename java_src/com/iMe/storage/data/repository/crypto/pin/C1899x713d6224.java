...
/* renamed from: com.iMe.storage.data.repository.crypto.pin.PinCodeRepositoryImpl$readPasswordByPinCode$lambda$2$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1899x713d6224 extends Lambda implements Function1<Result<? extends List<? extends Wallet>>, String> {
    final /* synthetic */ String $password$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1899x713d6224(String str) {
        super(1);
        this.$password$inlined = str;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r4v4, types: [com.iMe.storage.domain.model.Result, java.lang.Object, java.lang.String] */
