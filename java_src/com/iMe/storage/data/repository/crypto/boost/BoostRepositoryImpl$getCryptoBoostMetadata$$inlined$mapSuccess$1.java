...
public final class BoostRepositoryImpl$getCryptoBoostMetadata$$inlined$mapSuccess$1 extends Lambda implements Function1<ApiBaseResponse<SpeedUpTransactionDataResponse>, Result<? extends TransactionArgs>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BoostRepositoryImpl$getCryptoBoostMetadata$$inlined$mapSuccess$1(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
