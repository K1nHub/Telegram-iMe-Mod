...
public final class BoostRepositoryImpl implements BoostRepository {
    ...
    public Observable<Result<TransactionArgs>> getCryptoBoostMetadata(String txHash) {
        ...
        Observable<Result<TransactionArgs>> onErrorReturn = map.onErrorReturn(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new C1865xe2766782(this.errorHandler)));
