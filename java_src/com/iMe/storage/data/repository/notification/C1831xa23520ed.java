...
public final class C1831xa23520ed extends Lambda implements Function1<Throwable, Result<? extends List<? extends Notification>>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1831xa23520ed(ErrorHandler errorHandler) {
        super(1);
