    ...
    public static final Notification mapToDomain(NotificationResponse notificationResponse) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[map.ordinal()]) {
            case 1:
                ...
                c1958In = new Notification.CryptoTransfer.C1958In(id, read, map, date, userId, str4, str3, str, str2, bigDecimal);
                break;
            case 2:
                ...
                c1958In = new Notification.CryptoTransfer.Out(map2, id2, read2, map, date2, userId2, str8, str7, str5, str6, bigDecimal2);
                break;
            case 3:
                ...
                c1958In = new Notification.Donation.C1959In(id3, read3, map, date3, userId3, str12, str11, str9, str10, bigDecimal3);
                break;
            case 4:
                ...
                c1958In = new Notification.Donation.Out(map3, id4, read4, map, date4, userId4, str16, str15, str13, str14, bigDecimal4);
                break;
            case 5:
                ...
                c1958In = new Notification.Simplex(id5, read5, map, date5, userId5, str19, str18, str17, bigDecimal5, map4, bigDecimal6, fiatCode);
                break;
            case 6:
                ...
                c1958In = new Notification.BinancePayRequestCreated(id6, read6, map, date6, userId6, str23, bigDecimal7, str20, str21, str22);
                break;
            case 7:
                ...
                c1958In = new Notification.BinancePayRequestStatusUpdated(id7, read7, map, date7, userId7, str27, bigDecimal8, str24, str25, str26, map5);
                break;
            case 8:
                ...
                c1958In = new Notification.Cancel(id8, read8, map, date8, userId8, networkType8 == null ? "" : networkType8, str28, map6);
                break;
            case 9:
                ...
                c1958In = new Notification.Approve(id9, read9, map, date9, userId9, networkType9 == null ? "" : networkType9, str30, str29, map7);
                break;
            case 10:
                ...
                c1958In = new Notification.StakingSafeWithdrawalStarted(id10, read10, map, date10, userId10, str31, stakingId, stakingName, stakingToken, bigDecimal9, str32);
                break;
            case 11:
                ...
                c1958In = new Notification.StakingSafeWithdrawalFinished(id11, read11, map, date11, userId11, str33, stakingId2, stakingName2, stakingToken2, bigDecimal10);
                break;
            case 12:
                ...
                c1958In = new Notification.StakingStarted(id12, read12, map, date12, userId12, networkType12 == null ? "" : networkType12, notificationResponse.getStakingId(), notificationResponse.getStakingName(), notificationResponse.getStakingAuthor(), notificationResponse.getStakingWebsite(), notificationResponse.getStakingAPY(), notificationResponse.getStakingAPR(), notificationResponse.getStakingEndsAt(), notificationResponse.getStakingToken());
                break;
            case 13:
                ...
                c1958In = new Notification.StakingFinished(id13, read13, map, date13, userId13, networkType13 == null ? "" : networkType13, notificationResponse.getStakingId(), notificationResponse.getStakingName(), notificationResponse.getStakingToken(), notificationResponse.getDebtAsToken(), notificationResponse.getDebtAsUsd(), notificationResponse.getProfitAsToken(), notificationResponse.getProfitAsUsd());
                break;
            case 14:
