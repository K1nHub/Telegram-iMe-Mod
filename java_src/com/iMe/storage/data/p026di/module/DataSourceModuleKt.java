...
public final class DataSourceModuleKt {
    ...
    private static Module dataSourceModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C16641 c16641 = new Function2<Scope, ParametersHolder, WalletTransferDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.1
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(WalletTransferDataSourceFactory.class), null, c16641, kind, emptyList));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C16702 c16702 = new Function2<Scope, ParametersHolder, WalletSwapDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(WalletSwapDataSourceFactory.class), null, c16702, kind, emptyList2));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C16713 c16713 = new Function2<Scope, ParametersHolder, WalletApproveDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(WalletApproveDataSourceFactory.class), null, c16713, kind, emptyList3));
            module.indexPrimaryType(singleInstanceFactory3);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory3);
            }
            new KoinDefinition(module, singleInstanceFactory3);
            C16724 c16724 = new Function2<Scope, ParametersHolder, WalletCancelDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory4 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(WalletCancelDataSourceFactory.class), null, c16724, kind, emptyList4));
            module.indexPrimaryType(singleInstanceFactory4);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory4);
            }
            new KoinDefinition(module, singleInstanceFactory4);
            C16735 c16735 = new Function2<Scope, ParametersHolder, WalletBoostDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory5 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(WalletBoostDataSourceFactory.class), null, c16735, kind, emptyList5));
            ...
            C16746 c16746 = new Function2<Scope, ParametersHolder, WalletTransferDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory6 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(WalletTransferDataSource.class), evm_crypto_transfer_data_source, c16746, kind, emptyList6));
            ...
            C16757 c16757 = new Function2<Scope, ParametersHolder, WalletTransferDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.7
                @Override // kotlin.jvm.functions.Function2
                public final WalletTransferDataSource invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
            ...
            SingleInstanceFactory<?> singleInstanceFactory7 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier7, Reflection.getOrCreateKotlinClass(WalletTransferDataSource.class), ton_crypto_transfer_data_source, c16757, kind, emptyList7));
            ...
            C16768 c16768 = new Function2<Scope, ParametersHolder, WalletTransferDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.8
                @Override // kotlin.jvm.functions.Function2
                public final WalletTransferDataSource invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
            ...
            SingleInstanceFactory<?> singleInstanceFactory8 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier8, Reflection.getOrCreateKotlinClass(WalletTransferDataSource.class), tron_crypto_transfer_data_source, c16768, kind, emptyList8));
            ...
            C16779 c16779 = new Function2<Scope, ParametersHolder, WalletTransferDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.9
                @Override // kotlin.jvm.functions.Function2
                public final WalletTransferDataSource invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
            ...
            SingleInstanceFactory<?> singleInstanceFactory9 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier9, Reflection.getOrCreateKotlinClass(WalletTransferDataSource.class), btc_crypto_transfer_data_source, c16779, kind, emptyList9));
            ...
            C166510 c166510 = new Function2<Scope, ParametersHolder, WalletSwapDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.10
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory10 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier10, Reflection.getOrCreateKotlinClass(WalletSwapDataSource.class), dex_swap_data_source, c166510, kind, emptyList10));
            ...
            StringQualifier eth_approve_data_source = DataSourceModuleKt.getETH_APPROVE_DATA_SOURCE();
            C166611 c166611 = new Function2<Scope, ParametersHolder, WalletApproveDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.11
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory11 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier11, Reflection.getOrCreateKotlinClass(WalletApproveDataSource.class), eth_approve_data_source, c166611, kind, emptyList11));
            ...
            C166712 c166712 = new Function2<Scope, ParametersHolder, WalletCancelDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.12
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory12 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier12, Reflection.getOrCreateKotlinClass(WalletCancelDataSource.class), eth_cancel_data_source, c166712, kind, emptyList12));
            module.indexPrimaryType(singleInstanceFactory12);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory12);
            }
            new KoinDefinition(module, singleInstanceFactory12);
            C166813 c166813 = new Function2<Scope, ParametersHolder, WalletConnectDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.13
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory13 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier13, Reflection.getOrCreateKotlinClass(WalletConnectDataSource.class), null, c166813, kind, emptyList13));
            module.indexPrimaryType(singleInstanceFactory13);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory13);
            }
            new KoinDefinition(module, singleInstanceFactory13);
            C166914 c166914 = new Function2<Scope, ParametersHolder, CryptoBoxDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.14
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory14 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier14, Reflection.getOrCreateKotlinClass(CryptoBoxDataSource.class), null, c166914, kind, emptyList14));
