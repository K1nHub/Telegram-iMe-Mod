...
public final class ManagerModuleKt {
    ...
    private static Module dataManagerModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C16971 c16971 = new Function2<Scope, ParametersHolder, TonController>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.1
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(TonController.class), null, c16971, kind, emptyList));
            ...
            C17012 c17012 = new Function2<Scope, ParametersHolder, BlockchainCryptoWalletManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(BlockchainCryptoWalletManager.class), evm_blockchain_crypto_wallet_manager, c17012, kind, emptyList2));
            ...
            C17023 c17023 = new Function2<Scope, ParametersHolder, BlockchainCryptoWalletManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.3
                @Override // kotlin.jvm.functions.Function2
                public final BlockchainCryptoWalletManager invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(BlockchainCryptoWalletManager.class), ton_blockchain_crypto_wallet_manager, c17023, kind, emptyList3));
            ...
            C17034 c17034 = new Function2<Scope, ParametersHolder, BlockchainCryptoWalletManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.4
                @Override // kotlin.jvm.functions.Function2
                public final BlockchainCryptoWalletManager invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
            ...
            SingleInstanceFactory<?> singleInstanceFactory4 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(BlockchainCryptoWalletManager.class), tron_blockchain_crypto_wallet_manager, c17034, kind, emptyList4));
            ...
            C17045 c17045 = new Function2<Scope, ParametersHolder, BlockchainCryptoWalletManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.5
                @Override // kotlin.jvm.functions.Function2
                public final BlockchainCryptoWalletManager invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
            ...
            SingleInstanceFactory<?> singleInstanceFactory5 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(BlockchainCryptoWalletManager.class), btc_blockchain_crypto_wallet_manager, c17045, kind, emptyList5));
            module.indexPrimaryType(singleInstanceFactory5);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory5);
            }
            new KoinDefinition(module, singleInstanceFactory5);
            C17056 c17056 = new Function2<Scope, ParametersHolder, CryptoWalletsManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory6 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(CryptoWalletsManager.class), null, c17056, kind, emptyList6));
            module.indexPrimaryType(singleInstanceFactory6);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory6);
            }
            new KoinDefinition(module, singleInstanceFactory6);
            C17067 c17067 = new Function2<Scope, ParametersHolder, CryptoAccessManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.7
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory7 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier7, Reflection.getOrCreateKotlinClass(CryptoAccessManager.class), null, c17067, kind, emptyList7));
            module.indexPrimaryType(singleInstanceFactory7);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory7);
            }
            new KoinDefinition(module, singleInstanceFactory7);
            C17078 c17078 = new Function2<Scope, ParametersHolder, BinancePayManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.8
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory8 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier8, Reflection.getOrCreateKotlinClass(BinancePayManager.class), null, c17078, kind, emptyList8));
            module.indexPrimaryType(singleInstanceFactory8);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory8);
            }
            new KoinDefinition(module, singleInstanceFactory8);
            C17089 c17089 = new Function2<Scope, ParametersHolder, AuthManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.9
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory9 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier9, Reflection.getOrCreateKotlinClass(AuthManager.class), null, c17089, kind, emptyList9));
            module.indexPrimaryType(singleInstanceFactory9);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory9);
            }
            new KoinDefinition(module, singleInstanceFactory9);
            C169810 c169810 = new Function2<Scope, ParametersHolder, WalletConnectManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.10
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory10 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier10, Reflection.getOrCreateKotlinClass(WalletConnectManager.class), null, c169810, kind, emptyList10));
            module.indexPrimaryType(singleInstanceFactory10);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory10);
            }
            new KoinDefinition(module, singleInstanceFactory10);
            C169911 c169911 = new Function2<Scope, ParametersHolder, UpdateManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.11
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory11 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier11, Reflection.getOrCreateKotlinClass(UpdateManager.class), null, c169911, kind, emptyList11));
            module.indexPrimaryType(singleInstanceFactory11);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory11);
            }
            new KoinDefinition(module, singleInstanceFactory11);
            C170012 c170012 = new Function2<Scope, ParametersHolder, AppReviewManager>() { // from class: com.iMe.storage.data.di.module.ManagerModuleKt$dataManagerModule$1.12
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory12 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier12, Reflection.getOrCreateKotlinClass(AppReviewManager.class), null, c170012, kind, emptyList12));
