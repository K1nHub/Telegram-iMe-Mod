...
import com.iMe.storage.data.utils.p027rx.AppSchedulers;
...
public final class UtilsModuleKt {
    private static Module dataUtilsModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.storage.data.di.module.UtilsModuleKt$dataUtilsModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C16851 c16851 = new Function2<Scope, ParametersHolder, ResourceManager>() { // from class: com.iMe.storage.data.di.module.UtilsModuleKt$dataUtilsModule$1.1
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(ResourceManager.class), null, c16851, kind, emptyList));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C16862 c16862 = new Function2<Scope, ParametersHolder, SchedulersProvider>() { // from class: com.iMe.storage.data.di.module.UtilsModuleKt$dataUtilsModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            InstanceFactory<?> factoryInstanceFactory = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(SchedulersProvider.class), null, c16862, kind2, emptyList2));
