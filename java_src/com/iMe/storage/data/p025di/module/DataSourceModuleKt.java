...
public final class DataSourceModuleKt {
    ...
    private static Module dataSourceModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C15651 c15651 = new Function2<Scope, ParametersHolder, WalletTransferDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.1
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(WalletTransferDataSourceFactory.class), null, c15651, kind, emptyList));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C15712 c15712 = new Function2<Scope, ParametersHolder, WalletSwapDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(WalletSwapDataSourceFactory.class), null, c15712, kind, emptyList2));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C15723 c15723 = new Function2<Scope, ParametersHolder, WalletApproveDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(WalletApproveDataSourceFactory.class), null, c15723, kind, emptyList3));
            module.indexPrimaryType(singleInstanceFactory3);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory3);
            }
            new KoinDefinition(module, singleInstanceFactory3);
            C15734 c15734 = new Function2<Scope, ParametersHolder, WalletCancelDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory4 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(WalletCancelDataSourceFactory.class), null, c15734, kind, emptyList4));
            module.indexPrimaryType(singleInstanceFactory4);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory4);
            }
            new KoinDefinition(module, singleInstanceFactory4);
            C15745 c15745 = new Function2<Scope, ParametersHolder, WalletBoostDataSourceFactory>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory5 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(WalletBoostDataSourceFactory.class), null, c15745, kind, emptyList5));
            ...
            C15756 c15756 = new Function2<Scope, ParametersHolder, WalletTransferDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory6 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(WalletTransferDataSource.class), evm_crypto_transfer_data_source, c15756, kind, emptyList6));
            ...
            C15767 c15767 = new Function2<Scope, ParametersHolder, WalletTransferDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.7
                @Override // kotlin.jvm.functions.Function2
                public final WalletTransferDataSource invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
                    return new TONWalletTransferDataSourceImpl((FirebaseFunctionsErrorHandler) single.get(Reflection.getOrCreateKotlinClass(FirebaseFunctionsErrorHandler.class), null, null), (CryptoWalletApi) single.get(Reflection.getOrCreateKotlinClass(CryptoWalletApi.class), null, null), (TonController) single.get(Reflection.getOrCreateKotlinClass(TonController.class), null, null));
                }
            };
            StringQualifier rootScopeQualifier7 = companion.getRootScopeQualifier();
            emptyList7 = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory7 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier7, Reflection.getOrCreateKotlinClass(WalletTransferDataSource.class), ton_crypto_transfer_data_source, c15767, kind, emptyList7));
            ...
            C15778 c15778 = new Function2<Scope, ParametersHolder, WalletTransferDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.8
                @Override // kotlin.jvm.functions.Function2
                public final WalletTransferDataSource invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
            ...
            SingleInstanceFactory<?> singleInstanceFactory8 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier8, Reflection.getOrCreateKotlinClass(WalletTransferDataSource.class), tron_crypto_transfer_data_source, c15778, kind, emptyList8));
            ...
            C15789 c15789 = new Function2<Scope, ParametersHolder, WalletTransferDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.9
                @Override // kotlin.jvm.functions.Function2
                public final WalletTransferDataSource invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
            ...
            SingleInstanceFactory<?> singleInstanceFactory9 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier9, Reflection.getOrCreateKotlinClass(WalletTransferDataSource.class), btc_crypto_transfer_data_source, c15789, kind, emptyList9));
            ...
            C156610 c156610 = new Function2<Scope, ParametersHolder, WalletSwapDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.10
                @Override // kotlin.jvm.functions.Function2
                public final WalletSwapDataSource invoke(Scope single, ParametersHolder it) {
                    Intrinsics.checkNotNullParameter(single, "$this$single");
                    Intrinsics.checkNotNullParameter(it, "it");
                    return new DexWalletSwapDataSourceImpl((CryptoAccessManager) single.get(Reflection.getOrCreateKotlinClass(CryptoAccessManager.class), null, null), (FirebaseFunctionsErrorHandler) single.get(Reflection.getOrCreateKotlinClass(FirebaseFunctionsErrorHandler.class), null, null), (Gson) single.get(Reflection.getOrCreateKotlinClass(Gson.class), null, null), (SwapApi) single.get(Reflection.getOrCreateKotlinClass(SwapApi.class), null, null));
                }
            };
            StringQualifier rootScopeQualifier10 = companion.getRootScopeQualifier();
            emptyList10 = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory10 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier10, Reflection.getOrCreateKotlinClass(WalletSwapDataSource.class), dex_swap_data_source, c156610, kind, emptyList10));
            ...
            StringQualifier eth_approve_data_source = DataSourceModuleKt.getETH_APPROVE_DATA_SOURCE();
            C156711 c156711 = new Function2<Scope, ParametersHolder, WalletApproveDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.11
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory11 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier11, Reflection.getOrCreateKotlinClass(WalletApproveDataSource.class), eth_approve_data_source, c156711, kind, emptyList11));
            ...
            C156812 c156812 = new Function2<Scope, ParametersHolder, WalletCancelDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.12
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory12 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier12, Reflection.getOrCreateKotlinClass(WalletCancelDataSource.class), eth_cancel_data_source, c156812, kind, emptyList12));
            module.indexPrimaryType(singleInstanceFactory12);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory12);
            }
            new KoinDefinition(module, singleInstanceFactory12);
            C156913 c156913 = new Function2<Scope, ParametersHolder, WalletConnectDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.13
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory13 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier13, Reflection.getOrCreateKotlinClass(WalletConnectDataSource.class), null, c156913, kind, emptyList13));
            module.indexPrimaryType(singleInstanceFactory13);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory13);
            }
            new KoinDefinition(module, singleInstanceFactory13);
            C157014 c157014 = new Function2<Scope, ParametersHolder, CryptoBoxDataSource>() { // from class: com.iMe.storage.data.di.module.DataSourceModuleKt$dataSourceModule$1.14
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory14 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier14, Reflection.getOrCreateKotlinClass(CryptoBoxDataSource.class), null, c157014, kind, emptyList14));
