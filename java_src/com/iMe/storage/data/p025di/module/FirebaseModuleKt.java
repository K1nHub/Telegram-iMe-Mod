...
public final class FirebaseModuleKt {
    private static Module firebaseModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.storage.data.di.module.FirebaseModuleKt$firebaseModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C15951 c15951 = new Function2<Scope, ParametersHolder, FirebaseDynamicLinks>() { // from class: com.iMe.storage.data.di.module.FirebaseModuleKt$firebaseModule$1.1
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(FirebaseDynamicLinks.class), null, c15951, kind, emptyList));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C15962 c15962 = new Function2<Scope, ParametersHolder, FirebaseRemoteConfig>() { // from class: com.iMe.storage.data.di.module.FirebaseModuleKt$firebaseModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(FirebaseRemoteConfig.class), null, c15962, kind, emptyList2));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C15973 c15973 = new Function2<Scope, ParametersHolder, FirebaseAnalytics>() { // from class: com.iMe.storage.data.di.module.FirebaseModuleKt$firebaseModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(FirebaseAnalytics.class), null, c15973, kind, emptyList3));
            module.indexPrimaryType(singleInstanceFactory3);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory3);
            }
            new KoinDefinition(module, singleInstanceFactory3);
            C15984 c15984 = new Function2<Scope, ParametersHolder, FirebaseApp>() { // from class: com.iMe.storage.data.di.module.FirebaseModuleKt$firebaseModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory4 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(FirebaseApp.class), null, c15984, kind, emptyList4));
