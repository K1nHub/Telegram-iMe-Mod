...
public interface WalletApi {
    ...
    @POST("getMultiChainBalance")
    Observable<ApiBaseResponse<WalletBalancesResponse>> getWalletMultiChainBalance(@Body MultiChainBalanceRequest multiChainBalanceRequest);
    ...
    Observable<ApiBaseResponse<WalletTransactionsResponse>> getWalletTransactions(@Body WalletTransactionsRequest walletTransactionsRequest);
