...
public final class GetParamsForTonCryptoTransferRequest {
    ...
    public static /* synthetic */ GetParamsForTonCryptoTransferRequest copy$default(GetParamsForTonCryptoTransferRequest getParamsForTonCryptoTransferRequest, String str, String str2, String str3, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            str2 = getParamsForTonCryptoTransferRequest.f294to;
        }
        if ((i & 4) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetParamsForTonCryptoTransferRequest) {
            ...
            return Intrinsics.areEqual(this.type, getParamsForTonCryptoTransferRequest.type) && Intrinsics.areEqual(this.f294to, getParamsForTonCryptoTransferRequest.f294to) && Intrinsics.areEqual(this.value, getParamsForTonCryptoTransferRequest.value);
        }
        return false;
    }

    public int hashCode() {
        return (((this.type.hashCode() * 31) + this.f294to.hashCode()) * 31) + this.value.hashCode();
    }

    public String toString() {
        return "GetParamsForTonCryptoTransferRequest(type=" + this.type + ", to=" + this.f294to + ", value=" + this.value + ')';
    }
