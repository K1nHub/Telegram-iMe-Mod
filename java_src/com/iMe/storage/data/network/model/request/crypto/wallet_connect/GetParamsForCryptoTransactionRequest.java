...
public final class GetParamsForCryptoTransactionRequest {
    ...
    public String toString() {
        return "GetParamsForCryptoTransactionRequest(from=" + this.from + ", to=" + this.f378to + ", value=" + this.value + ", data=" + this.data + ", gas=" + this.gas + ", gasPrice=" + this.gasPrice + ", nonce=" + this.nonce + ", networkType=" + this.networkType + ')';
    }
