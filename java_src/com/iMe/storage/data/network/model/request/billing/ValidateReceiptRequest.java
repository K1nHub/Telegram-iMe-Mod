...
public final class ValidateReceiptRequest {
    ...
    public int hashCode() {
        return (((((((((this.orderId.hashCode() * 31) + this.packageName.hashCode()) * 31) + this.productId.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1018m(this.purchaseTime)) * 31) + this.purchaseState) * 31) + this.purchaseToken.hashCode();
    }
