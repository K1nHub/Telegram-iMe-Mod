...
public final class GetDataForCryptoTransferRequest {
    ...
    public static /* synthetic */ GetDataForCryptoTransferRequest copy$default(GetDataForCryptoTransferRequest getDataForCryptoTransferRequest, String str, String str2, String str3, String str4, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            str2 = getDataForCryptoTransferRequest.f295to;
        }
        if ((i & 4) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDataForCryptoTransferRequest) {
            ...
            return Intrinsics.areEqual(this.type, getDataForCryptoTransferRequest.type) && Intrinsics.areEqual(this.f295to, getDataForCryptoTransferRequest.f295to) && Intrinsics.areEqual(this.value, getDataForCryptoTransferRequest.value) && Intrinsics.areEqual(this.networkType, getDataForCryptoTransferRequest.networkType);
        }
        return false;
    }
    ...
    public String toString() {
        return "GetDataForCryptoTransferRequest(type=" + this.type + ", to=" + this.f295to + ", value=" + this.value + ", networkType=" + this.networkType + ')';
    }
