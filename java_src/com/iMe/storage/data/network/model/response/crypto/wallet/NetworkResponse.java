    ...
    public static final class ExplorerResponse {
        ...
        public static final class PathTemplateResponse {
            ...
            public static /* synthetic */ PathTemplateResponse copy$default(PathTemplateResponse pathTemplateResponse, String str, String str2, String str3, int i, Object obj) {
                ...
                if ((i & 4) != 0) {
                    str3 = pathTemplateResponse.f396tx;
                }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof PathTemplateResponse) {
                    ...
                    return Intrinsics.areEqual(this.address, pathTemplateResponse.address) && Intrinsics.areEqual(this.token, pathTemplateResponse.token) && Intrinsics.areEqual(this.f396tx, pathTemplateResponse.f396tx);
                }
                return false;
            }

            public int hashCode() {
                return (((this.address.hashCode() * 31) + this.token.hashCode()) * 31) + this.f396tx.hashCode();
            }

            public String toString() {
                return "PathTemplateResponse(address=" + this.address + ", token=" + this.token + ", tx=" + this.f396tx + ')';
            }
