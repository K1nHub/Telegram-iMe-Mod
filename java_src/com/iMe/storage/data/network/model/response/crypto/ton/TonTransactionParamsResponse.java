...
public final class TonTransactionParamsResponse {
    ...
    public static /* synthetic */ TonTransactionParamsResponse copy$default(TonTransactionParamsResponse tonTransactionParamsResponse, int i, String str, int i2, int i3, int i4, Object obj) {
        ...
        if ((i4 & 8) != 0) {
            i3 = tonTransactionParamsResponse.f308wc;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TonTransactionParamsResponse) {
            ...
            return this.sendMode == tonTransactionParamsResponse.sendMode && Intrinsics.areEqual(this.toWalletAddressFixed, tonTransactionParamsResponse.toWalletAddressFixed) && this.walletSeqno == tonTransactionParamsResponse.walletSeqno && this.f308wc == tonTransactionParamsResponse.f308wc;
        }
        return false;
    }

    public int hashCode() {
        return (((((this.sendMode * 31) + this.toWalletAddressFixed.hashCode()) * 31) + this.walletSeqno) * 31) + this.f308wc;
    }

    public String toString() {
        return "TonTransactionParamsResponse(sendMode=" + this.sendMode + ", toWalletAddressFixed=" + this.toWalletAddressFixed + ", walletSeqno=" + this.walletSeqno + ", wc=" + this.f308wc + ')';
    }
