...
public final class TonFeesResponse {
    ...
    public int hashCode() {
        return (((Float.floatToIntBits(this.duration) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.fee)) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.feeInDollars);
    }
