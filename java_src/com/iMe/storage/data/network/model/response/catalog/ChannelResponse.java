...
public final class ChannelResponse {
    ...
    public int hashCode() {
        int hashCode = ((((((((this.chatType.hashCode() * 31) + this.createdAt.hashCode()) * 31) + this.description.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.f319id)) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.membersCount)) * 31;
        String str = this.photo;
        int hashCode2 = (((((((((hashCode + (str == null ? 0 : str.hashCode())) * 31) + this.shortname.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.telegramId)) * 31) + this.title.hashCode()) * 31) + this.updatedAt.hashCode()) * 31;
    ...
    public String toString() {
        return "ChannelResponse(chatType=" + this.chatType + ", createdAt=" + this.createdAt + ", description=" + this.description + ", id=" + this.f319id + ", membersCount=" + this.membersCount + ", photo=" + this.photo + ", shortname=" + this.shortname + ", telegramId=" + this.telegramId + ", title=" + this.title + ", updatedAt=" + this.updatedAt + ", verified=" + this.verified + ')';
    }
