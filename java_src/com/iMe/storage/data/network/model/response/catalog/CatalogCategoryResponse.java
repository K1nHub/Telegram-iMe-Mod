...
public final class CatalogCategoryResponse {
    ...
    public static /* synthetic */ CatalogCategoryResponse copy$default(CatalogCategoryResponse catalogCategoryResponse, long j, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            j = catalogCategoryResponse.f301id;
        }
        if ((i & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CatalogCategoryResponse) {
            ...
            return this.f301id == catalogCategoryResponse.f301id && Intrinsics.areEqual(this.title, catalogCategoryResponse.title);
        }
        return false;
    }

    public int hashCode() {
        return (BotsDbModel$$ExternalSyntheticBackport0.m716m(this.f301id) * 31) + this.title.hashCode();
    }

    public String toString() {
        return "CatalogCategoryResponse(id=" + this.f301id + ", title=" + this.title + ')';
    }
