...
public final class TronBlockHeaderResponse {
    ...
    public int hashCode() {
        return (((((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.number) * 31) + this.txTrieRoot.hashCode()) * 31) + this.witnessAddress.hashCode()) * 31) + this.parentHash.hashCode()) * 31) + this.version) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.timestamp);
    }
