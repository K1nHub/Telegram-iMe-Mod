...
public final class NftAvatarResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NftAvatarResponse) {
            ...
            return this.f393id == nftAvatarResponse.f393id && Intrinsics.areEqual(this.tokenId, nftAvatarResponse.tokenId) && Intrinsics.areEqual(this.owner, nftAvatarResponse.owner) && Intrinsics.areEqual(this.image, nftAvatarResponse.image) && Intrinsics.areEqual(this.meta, nftAvatarResponse.meta) && Intrinsics.areEqual(this.title, nftAvatarResponse.title) && Intrinsics.areEqual(this.description, nftAvatarResponse.description) && Intrinsics.areEqual(this.collection, nftAvatarResponse.collection);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((BotsDbModel$$ExternalSyntheticBackport0.m724m(this.f393id) * 31) + this.tokenId.hashCode()) * 31) + this.owner.hashCode()) * 31) + this.image.hashCode()) * 31) + this.meta.hashCode()) * 31) + this.title.hashCode()) * 31) + this.description.hashCode()) * 31) + this.collection.hashCode();
    }

    public String toString() {
        return "NftAvatarResponse(id=" + this.f393id + ", tokenId=" + this.tokenId + ", owner=" + this.owner + ", image=" + this.image + ", meta=" + this.meta + ", title=" + this.title + ", description=" + this.description + ", collection=" + this.collection + ')';
    }
