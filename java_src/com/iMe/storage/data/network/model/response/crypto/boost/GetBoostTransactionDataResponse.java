    ...
    public static final class TransactionMethodParamsResponse {
        ...
        public static final class TransferMethodParamsResponse {
            ...
            public static /* synthetic */ TransferMethodParamsResponse copy$default(TransferMethodParamsResponse transferMethodParamsResponse, String str, String str2, String str3, String str4, int i, Object obj) {
                ...
                if ((i & 2) != 0) {
                    str2 = transferMethodParamsResponse.f306to;
                }
                if ((i & 4) != 0) {
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof TransferMethodParamsResponse) {
                    ...
                    return Intrinsics.areEqual(this.from, transferMethodParamsResponse.from) && Intrinsics.areEqual(this.f306to, transferMethodParamsResponse.f306to) && Intrinsics.areEqual(this.value, transferMethodParamsResponse.value) && Intrinsics.areEqual(this.contractAddress, transferMethodParamsResponse.contractAddress);
                }
                return false;
            }

            public int hashCode() {
                int hashCode = ((((this.from.hashCode() * 31) + this.f306to.hashCode()) * 31) + this.value.hashCode()) * 31;
                String str = this.contractAddress;
                return hashCode + (str == null ? 0 : str.hashCode());
            }

            public String toString() {
                return "TransferMethodParamsResponse(from=" + this.from + ", to=" + this.f306to + ", value=" + this.value + ", contractAddress=" + this.contractAddress + ')';
            }
