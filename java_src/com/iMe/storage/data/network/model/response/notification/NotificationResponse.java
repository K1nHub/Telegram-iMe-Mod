...
public final class NotificationResponse {
    ...
    public int hashCode() {
        int hashCode = ((((this.f311id.hashCode() * 31) + this.userId.hashCode()) * 31) + this.amount.hashCode()) * 31;
        boolean z = this.read;
        int i = z;
        if (z != 0) {
            i = 1;
