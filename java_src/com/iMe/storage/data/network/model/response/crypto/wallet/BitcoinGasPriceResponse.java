...
public final class BitcoinGasPriceResponse {
    ...
    public int hashCode() {
        return (((((this.byteFee.hashCode() * 31) + Float.floatToIntBits(this.duration)) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.fee)) * 31) + this.feeInFiat.hashCode();
    }
