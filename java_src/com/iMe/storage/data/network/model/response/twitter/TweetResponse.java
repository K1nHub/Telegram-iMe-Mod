...
public final class TweetResponse {
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((((this.f333id.hashCode() * 31) + this.likes) * 31) + this.quotes) * 31) + this.retweets) * 31) + this.userName.hashCode()) * 31) + this.userFullName.hashCode()) * 31) + this.userId.hashCode()) * 31) + this.avatarUrl.hashCode()) * 31) + this.text.hashCode()) * 31;
        boolean z = this.likedByMe;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((((hashCode + i) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.createdAt)) * 31) + this.mediaInfo.hashCode();
    }

    public String toString() {
        return "TweetResponse(id=" + this.f333id + ", likes=" + this.likes + ", quotes=" + this.quotes + ", retweets=" + this.retweets + ", userName=" + this.userName + ", userFullName=" + this.userFullName + ", userId=" + this.userId + ", avatarUrl=" + this.avatarUrl + ", text=" + this.text + ", likedByMe=" + this.likedByMe + ", createdAt=" + this.createdAt + ", mediaInfo=" + this.mediaInfo + ')';
    }
