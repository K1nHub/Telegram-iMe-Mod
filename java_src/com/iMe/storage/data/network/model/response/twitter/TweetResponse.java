...
public final class TweetResponse {
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((((this.f400id.hashCode() * 31) + this.likes) * 31) + this.quotes) * 31) + this.retweets) * 31) + this.userName.hashCode()) * 31) + this.userFullName.hashCode()) * 31) + this.userId.hashCode()) * 31) + this.avatarUrl.hashCode()) * 31) + this.text.hashCode()) * 31;
    ...
    public String toString() {
        return "TweetResponse(id=" + this.f400id + ", likes=" + this.likes + ", quotes=" + this.quotes + ", retweets=" + this.retweets + ", userName=" + this.userName + ", userFullName=" + this.userFullName + ", userId=" + this.userId + ", avatarUrl=" + this.avatarUrl + ", text=" + this.text + ", likedByMe=" + this.likedByMe + ", createdAt=" + this.createdAt + ", mediaInfo=" + this.mediaInfo + ')';
    }
