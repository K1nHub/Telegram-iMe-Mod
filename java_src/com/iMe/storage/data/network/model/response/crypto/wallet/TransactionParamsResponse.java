...
public abstract class TransactionParamsResponse {
    ...
    public static final class EVM extends TransactionParamsResponse {
        ...
        public int hashCode() {
            ...
            return ((((hashCode + (gasPriceResponse2 != null ? gasPriceResponse2.hashCode() : 0)) * 31) + this.nonce.hashCode()) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.chainId);
        }
