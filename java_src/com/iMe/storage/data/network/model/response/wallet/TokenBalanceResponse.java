...
public final class TokenBalanceResponse {
    ...
    public int hashCode() {
        int m1015m = ((((StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.total) * 31) + this.totalInFiat.hashCode()) * 31) + this.rateToFiat.hashCode()) * 31;
        Double d = this.ratePercentageChange24h;
        return ((m1015m + (d == null ? 0 : d.hashCode())) * 31) + this.token.hashCode();
    }
