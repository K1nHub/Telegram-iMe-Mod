...
public final class BinancePayGetUserInfoResponse {
    ...
    public static /* synthetic */ BinancePayGetUserInfoResponse copy$default(BinancePayGetUserInfoResponse binancePayGetUserInfoResponse, String str, String str2, VerificationDetails verificationDetails, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            str2 = binancePayGetUserInfoResponse.f298id;
        }
        if ((i & 4) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BinancePayGetUserInfoResponse) {
            ...
            return Intrinsics.areEqual(this.email, binancePayGetUserInfoResponse.email) && Intrinsics.areEqual(this.f298id, binancePayGetUserInfoResponse.f298id) && Intrinsics.areEqual(this.verificationDetails, binancePayGetUserInfoResponse.verificationDetails);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((str == null ? 0 : str.hashCode()) * 31) + this.f298id.hashCode()) * 31) + this.verificationDetails.hashCode();
    }

    public String toString() {
        return "BinancePayGetUserInfoResponse(email=" + this.email + ", id=" + this.f298id + ", verificationDetails=" + this.verificationDetails + ')';
    }
