...
public final class NetworksHelper implements KoinComponent {
    ...
    private static final List<String> binanceSupportedNetworksIds;
    ...
    static {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(koinPlatformTools.defaultLazyMode(), new Function0<CryptoAccessManager>() { // from class: com.iMe.storage.data.utils.crypto.NetworksHelper$special$$inlined$inject$default$1
        ...
        lazy2 = LazyKt__LazyJVMKt.lazy(koinPlatformTools.defaultLazyMode(), new Function0<CryptoPreferenceHelper>() { // from class: com.iMe.storage.data.utils.crypto.NetworksHelper$special$$inlined$inject$default$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        cryptoPreferenceHelper$delegate = lazy2;
        lazy3 = LazyKt__LazyJVMKt.lazy(koinPlatformTools.defaultLazyMode(), new Function0<ResourceManager>() { // from class: com.iMe.storage.data.utils.crypto.NetworksHelper$special$$inlined$inject$default$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        resourceManager$delegate = lazy3;
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new String[]{NetworkType.BSC, NetworkType.BTC, NetworkType.ETH, NetworkType.FTM, NetworkType.POLY, NetworkType.TRON});
        binanceSupportedNetworksIds = listOf;
        lazy4 = LazyKt__LazyJVMKt.lazy(new Function0<Network>() { // from class: com.iMe.storage.data.utils.crypto.NetworksHelper$default$2
    ...
    public final List<Network> getBinanceNetworks() {
        List<Network> supportedNetworks = getSupportedNetworks();
        ArrayList arrayList = new ArrayList();
        for (Object obj : supportedNetworks) {
            if (binanceSupportedNetworksIds.contains(((Network) obj).getId())) {
                arrayList.add(obj);
            }
        }
        return arrayList;
