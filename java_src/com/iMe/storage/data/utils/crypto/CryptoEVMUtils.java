...
/* compiled from: CryptoEVMUtils.kt */
/* loaded from: classes3.dex */
public final class CryptoEVMUtils {
    public static final CryptoEVMUtils INSTANCE = new CryptoEVMUtils();
    ...
    private CryptoEVMUtils() {
    }

    public static /* synthetic */ byte[] generateNewEntropy$default(CryptoEVMUtils cryptoEVMUtils, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = 32;
        }
        return cryptoEVMUtils.generateNewEntropy(i);
    }
    ...
    public final String signMessage(Wallet.EVM wallet2, String message, WCEthereumSignMessage.WCSignType signType) {
        ...
        if (i == 1) {
            signMessage = Sign.signMessage(hexStringToByteArray, wallet2.getCredentials().getEcKeyPair(), false);
        } else if (i != 2) {
            if (i == 3) {
                return "";
            }
            ...
            signMessage = Sign.signPrefixedMessage(hexStringToByteArray, wallet2.getCredentials().getEcKeyPair());
        }
