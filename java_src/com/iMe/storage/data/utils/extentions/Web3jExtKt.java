...
public final class Web3jExtKt {
    ...
    public static /* synthetic */ String createSmartFunctionDataFor$default(String str, List list, List list2, int i, Object obj) {
        if ((i & 4) != 0) {
            list2 = CollectionsKt__CollectionsJVMKt.listOf(new TypeReference<Bool>() { // from class: com.iMe.storage.data.utils.extentions.Web3jExtKt$createSmartFunctionDataFor$1
            });
        }
