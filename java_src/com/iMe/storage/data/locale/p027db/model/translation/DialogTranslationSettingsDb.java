package com.iMe.storage.data.locale.p027db.model.translation;
...
public final class DialogTranslationSettingsDb {
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.outTextTranslateTargetLangCode.hashCode()) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.dialogId)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.userId);
    }
