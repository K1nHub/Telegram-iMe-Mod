...
public final class CatalogCategoryDb {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CatalogCategoryDb) {
            ...
            return this.f374id == catalogCategoryDb.f374id && Intrinsics.areEqual(this.title, catalogCategoryDb.title) && this.total == catalogCategoryDb.total;
        }
        return false;
    }

    public int hashCode() {
        return (((BotsDbModel$$ExternalSyntheticBackport0.m724m(this.f374id) * 31) + this.title.hashCode()) * 31) + this.total;
    }

    public String toString() {
        return "CatalogCategoryDb(id=" + this.f374id + ", title=" + this.title + ", total=" + this.total + ')';
    }
