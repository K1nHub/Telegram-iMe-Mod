...
public final class PlaylistsDb {
    ...
    public int hashCode() {
        return (((this.messageIds.hashCode() * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.dialogId)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.userId);
    }
