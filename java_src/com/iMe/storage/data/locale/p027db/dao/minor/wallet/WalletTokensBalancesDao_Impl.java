...
public final class WalletTokensBalancesDao_Impl extends WalletTokensBalancesDao {
    ...
    public WalletTokensBalancesDao_Impl(RoomDatabase __db) {
        ...
        this.__preparedStmtOfRxDeleteByNetwork = new SharedSQLiteStatement(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokensBalancesDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    public Completable rxDeleteByNetwork(final long userId, final String networkId) {
    ...
    @Override // com.iMe.storage.data.locale.p027db.dao.minor.wallet.WalletTokensBalancesDao
    public Single<List<WalletTokenBalanceDb>> getBalancesByNetwork(final long userId, final String networkId) {
    ...
    @Override // com.iMe.storage.data.locale.p027db.dao.minor.wallet.WalletTokensBalancesDao
    public Single<List<WalletTokenBalanceDb>> getBalancesByMultipleNetworks(final long userId, final List<String> networksIds) {
    ...
    @Override // com.iMe.storage.data.locale.p027db.dao.minor.wallet.WalletTokensBalancesDao
    public Completable rxDeleteByMultipleNetworks(final long userId, final List<String> networksIds) {
