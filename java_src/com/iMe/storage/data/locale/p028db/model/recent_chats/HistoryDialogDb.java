package com.iMe.storage.data.locale.p028db.model.recent_chats;
...
public final class HistoryDialogDb {
    ...
    public int hashCode() {
        int m716m = ((((BotsDbModel$$ExternalSyntheticBackport0.m716m(this.userId) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.dialogId)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.creationDate)) * 31;
