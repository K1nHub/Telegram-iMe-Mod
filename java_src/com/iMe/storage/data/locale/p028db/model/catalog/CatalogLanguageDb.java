package com.iMe.storage.data.locale.p028db.model.catalog;
...
public final class CatalogLanguageDb {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CatalogLanguageDb) {
            ...
            return this.f293id == catalogLanguageDb.f293id && Intrinsics.areEqual(this.nativeTitle, catalogLanguageDb.nativeTitle) && Intrinsics.areEqual(this.title, catalogLanguageDb.title);
        }
        return false;
    }

    public int hashCode() {
        return (((BotsDbModel$$ExternalSyntheticBackport0.m716m(this.f293id) * 31) + this.nativeTitle.hashCode()) * 31) + this.title.hashCode();
    }

    public String toString() {
        return "CatalogLanguageDb(id=" + this.f293id + ", nativeTitle=" + this.nativeTitle + ", title=" + this.title + ')';
    }
