package com.iMe.storage.data.locale.p028db.model.filter;
...
public final class FilterSettingsDb {
    ...
    public int hashCode() {
        ...
        return ((hashCode + (str == null ? 0 : str.hashCode())) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.userId);
    }
