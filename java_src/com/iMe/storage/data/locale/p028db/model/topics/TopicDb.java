package com.iMe.storage.data.locale.p028db.model.topics;
...
public final class TopicDb {
    ...
    public int hashCode() {
        ...
        return ((((((((hashCode + (str2 != null ? str2.hashCode() : 0)) * 31) + this.order) * 31) + this.presets.hashCode()) * 31) + this.dialogs.hashCode()) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.userId);
    }
