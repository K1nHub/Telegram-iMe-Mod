package com.iMe.storage.data.locale.p028db.model.bookmarks;
...
public final class BookmarksDb {
    ...
    public int hashCode() {
        return (((this.messageIds.hashCode() * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.dialogId)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.userId);
    }
