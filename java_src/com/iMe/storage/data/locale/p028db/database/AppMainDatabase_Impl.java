...
import com.iMe.storage.data.locale.p028db.dao.main.BookmarksDao_Impl;
import com.iMe.storage.data.locale.p028db.dao.main.DialogTranslationSettingsDao;
import com.iMe.storage.data.locale.p028db.dao.main.DialogTranslationSettingsDao_Impl;
import com.iMe.storage.data.locale.p028db.dao.main.FiltersDao;
import com.iMe.storage.data.locale.p028db.dao.main.FiltersDao_Impl;
import com.iMe.storage.data.locale.p028db.dao.main.HistoryDialogDao;
import com.iMe.storage.data.locale.p028db.dao.main.HistoryDialogDao_Impl;
import com.iMe.storage.data.locale.p028db.dao.main.PlaylistsDao;
import com.iMe.storage.data.locale.p028db.dao.main.PlaylistsDao_Impl;
import com.iMe.storage.data.locale.p028db.dao.main.TemplatesDao;
import com.iMe.storage.data.locale.p028db.dao.main.TemplatesDao_Impl;
import com.iMe.storage.data.locale.p028db.dao.main.TopicsDao;
import com.iMe.storage.data.locale.p028db.dao.main.TopicsDao_Impl;
import com.iMe.storage.data.locale.p028db.dao.minor.wallet.WalletConnectSessionsDao;
import com.iMe.storage.data.locale.p028db.dao.minor.wallet.WalletConnectSessionsDao_Impl;
...
public final class AppMainDatabase_Impl extends AppMainDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(15) { // from class: com.iMe.storage.data.locale.db.database.AppMainDatabase_Impl.1
    ...
    @Override // com.iMe.storage.data.locale.p028db.database.AppMainDatabase
