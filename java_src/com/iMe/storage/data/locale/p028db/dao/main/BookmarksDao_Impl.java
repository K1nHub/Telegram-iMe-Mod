...
/* renamed from: com.iMe.storage.data.locale.db.dao.main.BookmarksDao_Impl */
...
public final class BookmarksDao_Impl extends BookmarksDao {
    ...
    public BookmarksDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfBookmarksDb = new EntityInsertionAdapter<BookmarksDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.main.BookmarksDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<BookmarksDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.main.BookmarksDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<BookmarksDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.main.BookmarksDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfDeleteAllBookmarksByUserId = new SharedSQLiteStatement(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.main.BookmarksDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.iMe.storage.data.locale.p028db.dao.main.BookmarksDao
