...
/* renamed from: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl */
...
public final class WalletTokenBalanceDao_Impl extends WalletTokenBalanceDao {
    ...
    public WalletTokenBalanceDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfWalletTokenBalanceDb = new EntityInsertionAdapter<WalletTokenBalanceDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<WalletTokenBalanceDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<WalletTokenBalanceDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfRxDeleteAllWalletBalances = new SharedSQLiteStatement(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    public Completable rxInsert(final List<? extends WalletTokenBalanceDb> obj) {
        return Completable.fromCallable(new Callable<Void>() { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.7
    ...
    @Override // com.iMe.storage.data.locale.p028db.dao.minor.wallet.WalletTokenBalanceDao
    public Completable rxDeleteAllWalletBalances(final long userId, final String networkType) {
        return Completable.fromCallable(new Callable<Void>() { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.10
            @Override // java.util.concurrent.Callable
            public Void call() throws Exception {
    ...
    public Single<List<WalletTokenBalanceDb>> getAllWalletBalances(final long userId, final String networkType) {
        ...
        return RxRoom.createSingle(new Callable<List<WalletTokenBalanceDb>>() { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.11
            @Override // java.util.concurrent.Callable
    ...
    public Single<List<WalletTokenBalanceDb>> getTokensBalances(final long userId, final String networkType, final List<String> codes) {
        ...
        return RxRoom.createSingle(new Callable<List<WalletTokenBalanceDb>>() { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.12
            @Override // java.util.concurrent.Callable
            public List<WalletTokenBalanceDb> call() throws Exception {
                Cursor query = DBUtil.query(WalletTokenBalanceDao_Impl.this.__db, acquire, false, null);
                try {
    ...
    public Completable rxDeleteByCodes(final long userId, final List<String> codes) {
        return Completable.fromCallable(new Callable<Void>() { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletTokenBalanceDao_Impl.14
            @Override // java.util.concurrent.Callable
            public Void call() throws Exception {
                StringBuilder newStringBuilder = StringUtil.newStringBuilder();
