...
public final class AppMainDatabaseMigrations implements KoinComponent {
    ...
    private static final AppMainDatabaseMigrations$MIGRATION_17_18$1 MIGRATION_17_18;
    private static final AppMainDatabaseMigrations$MIGRATION_18_19$1 MIGRATION_18_19;
    ...
    /* JADX WARN: Type inference failed for: r16v0, types: [com.iMe.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_17_18$1] */
    /* JADX WARN: Type inference failed for: r17v0, types: [com.iMe.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_18_19$1] */
    ...
    static {
                ...
                if (query != null) {
                    while (true) {
                        try {
                            ...
                            sb.append(i);
                            sb.append(", ");
                            collectionSizeOrDefault = CollectionsKt__IterablesKt.collectionSizeOrDefault(mapEnumsToNames, 10);
                            ArrayList arrayList = new ArrayList(collectionSizeOrDefault);
        ...
        MIGRATION_16_17 = r15;
        ?? r16 = new Migration() { // from class: com.iMe.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_17_18$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
                database.execSQL("ALTER TABLE TopicDb ADD COLUMN isHidden INTEGER NOT NULL DEFAULT \"{}\"");
                database.execSQL("ALTER TABLE FilterSettingsDb ADD COLUMN isHidden INTEGER NOT NULL DEFAULT \"{}\"");
            }
        };
        MIGRATION_17_18 = r16;
        ?? r17 = new Migration() { // from class: com.iMe.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_18_19$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Scope rootScope;
                Intrinsics.checkNotNullParameter(database, "database");
                AppMainDatabaseMigrations appMainDatabaseMigrations = AppMainDatabaseMigrations.INSTANCE;
                if (appMainDatabaseMigrations instanceof KoinScopeComponent) {
                    rootScope = ((KoinScopeComponent) appMainDatabaseMigrations).getScope();
                } else {
                    rootScope = appMainDatabaseMigrations.getKoin().getScopeRegistry().getRootScope();
                }
                List<CloudAlbumDb> allData = ((AppCacheDatabase) rootScope.get(Reflection.getOrCreateKotlinClass(AppCacheDatabase.class), null, null)).cloudAlbumDao().getAllData();
                database.execSQL("CREATE TABLE AlbumsDb (userId INTEGER NOT NULL, dialogId INTEGER NOT NULL, PRIMARY KEY(userId, dialogId))");
                for (CloudAlbumDb cloudAlbumDb : allData) {
                    database.execSQL("INSERT INTO AlbumsDb (userId, dialogId) VALUES(" + cloudAlbumDb.getUserId() + ", " + cloudAlbumDb.getAlbumId() + ')');
                }
            }
        };
        MIGRATION_18_19 = r17;
        migrations = new Migration[]{r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17};
    }
