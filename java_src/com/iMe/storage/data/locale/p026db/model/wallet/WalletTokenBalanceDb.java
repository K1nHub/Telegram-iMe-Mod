...
public final class WalletTokenBalanceDb {
    ...
    public int hashCode() {
        int m1020m = ((((((((((((((((((((((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.tgUserId) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.total)) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.totalInFiatValue)) * 31) + this.totalInFiatSymbol.hashCode()) * 31) + this.totalInFiatTicker.hashCode()) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.rateToFiatValue)) * 31) + this.rateToFiatSymbol.hashCode()) * 31) + this.rateToFiatTicker.hashCode()) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.ratePercentageChange24h)) * 31) + this.address.hashCode()) * 31) + this.networkId.hashCode()) * 31) + this.avatarUrl.hashCode()) * 31) + this.decimals) * 31) + this.ticker.hashCode()) * 31;
        boolean z = this.isCoin;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((((m1020m + i) * 31) + this.name.hashCode()) * 31) + this.website.hashCode();
    }
