package com.iMe.storage.data.locale.p026db.model.templates;
...
public final class TemplatesDb {
    ...
    public int hashCode() {
        int m1018m = ((((((((((ProfileData$$ExternalSyntheticBackport0.m1018m(this.userId) * 31) + ProfileData$$ExternalSyntheticBackport0.m1018m(this.messageId)) * 31) + ProfileData$$ExternalSyntheticBackport0.m1018m(this.groupId)) * 31) + this.templateName.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1018m(this.creationDate)) * 31) + this.usageRating) * 31;
        boolean z = this.sent;
        int i = z;
        if (z != 0) {
            i = 1;
