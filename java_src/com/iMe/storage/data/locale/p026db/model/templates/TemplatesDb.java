...
public final class TemplatesDb {
    ...
    public int hashCode() {
        int m1017m = ((((((((((ProfileData$$ExternalSyntheticBackport0.m1017m(this.userId) * 31) + ProfileData$$ExternalSyntheticBackport0.m1017m(this.messageId)) * 31) + ProfileData$$ExternalSyntheticBackport0.m1017m(this.groupId)) * 31) + this.templateName.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1017m(this.creationDate)) * 31) + this.usageRating) * 31;
        boolean z = this.sent;
        int i = z;
        if (z != 0) {
            i = 1;
