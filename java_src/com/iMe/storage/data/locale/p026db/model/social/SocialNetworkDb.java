package com.iMe.storage.data.locale.p026db.model.social;
...
public final class SocialNetworkDb {
    ...
    public int hashCode() {
        int m1020m = ((((((((((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.profileId) * 31) + this.social.hashCode()) * 31) + this.iconUrl.hashCode()) * 31) + this.socialPosition) * 31) + this.socialElementId.hashCode()) * 31) + this.socialElementAvatarUrl.hashCode()) * 31) + this.socialUserName.hashCode()) * 31) + this.socialWebUrl.hashCode()) * 31;
        boolean z = this.isActive;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((m1020m + i) * 31) + this.beforeConnectMessage.hashCode();
    }
