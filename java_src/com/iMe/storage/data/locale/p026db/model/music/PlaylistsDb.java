...
public final class PlaylistsDb {
    ...
    public int hashCode() {
        return (((this.messageIds.hashCode() * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.dialogId)) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.userId);
    }
