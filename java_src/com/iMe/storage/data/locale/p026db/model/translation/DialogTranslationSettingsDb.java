...
public final class DialogTranslationSettingsDb {
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.outTextTranslateTargetLangCode.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.dialogId)) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.userId);
    }
