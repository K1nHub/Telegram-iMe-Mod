package com.iMe.storage.data.locale.p026db.dao.minor.wallet;
...
public final class WalletConnectSessionsDao_Impl extends WalletConnectSessionsDao {
    ...
    public WalletConnectSessionsDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfWalletConnectSessionDb = new EntityInsertionAdapter<WalletConnectSessionDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletConnectSessionsDao_Impl.1
            ...
            public void bind(SupportSQLiteStatement stmt, WalletConnectSessionDb value) {
                ...
                String convertStringListToString = AppMainConverter.convertStringListToString(value.getRemotePeerMetaIcons());
                if (convertStringListToString == null) {
                    stmt.bindNull(12);
                } else {
                    stmt.bindString(12, convertStringListToString);
                }
                stmt.bindLong(13, value.isAutoSign() ? 1L : 0L);
                Long convertDateToLong = AppMainConverter.convertDateToLong(value.getDate());
                if (convertDateToLong == null) {
                    stmt.bindNull(14);
                } else {
                    stmt.bindLong(14, convertDateToLong.longValue());
                }
            }
        };
        new EntityDeletionOrUpdateAdapter<WalletConnectSessionDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletConnectSessionsDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM `WalletConnectSessionDb` WHERE `tgUserId` = ? AND `sessionKey` = ?";
            }
        };
        new EntityDeletionOrUpdateAdapter<WalletConnectSessionDb>(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletConnectSessionsDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfRxDeleteBySessionKey = new SharedSQLiteStatement(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletConnectSessionsDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM WalletConnectSessionDb WHERE tgUserId = ? AND sessionKey = ?";
            }
        };
        this.__preparedStmtOfRxDeleteAllSession = new SharedSQLiteStatement(this, __db) { // from class: com.iMe.storage.data.locale.db.dao.minor.wallet.WalletConnectSessionsDao_Impl.5
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.iMe.storage.data.locale.p026db.dao.minor.wallet.WalletConnectSessionsDao
            ...
            public List<WalletConnectSessionDb> call() throws Exception {
                ...
                try {
                    ...
                    while (query.moveToNext()) {
                        ...
                        List<String> convertStringToStringList = AppMainConverter.convertStringToStringList(query.isNull(columnIndexOrThrow12) ? null : query.getString(columnIndexOrThrow12));
                        ...
                        arrayList.add(new WalletConnectSessionDb(j, string, string2, string3, string4, i2, string5, string6, string7, string8, string9, convertStringToStringList, z, AppMainConverter.convertLongToDate(query.isNull(i) ? null : Long.valueOf(query.getLong(i)))));
