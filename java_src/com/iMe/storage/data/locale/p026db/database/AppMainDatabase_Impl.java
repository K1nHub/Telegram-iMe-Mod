...
import com.iMe.storage.data.locale.p026db.dao.main.AlbumsDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.main.DialogTranslationSettingsDao;
import com.iMe.storage.data.locale.p026db.dao.main.DialogTranslationSettingsDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.main.FiltersDao;
import com.iMe.storage.data.locale.p026db.dao.main.FiltersDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.main.HiddenChatsDao;
import com.iMe.storage.data.locale.p026db.dao.main.HiddenChatsDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.main.HistoryDialogDao;
import com.iMe.storage.data.locale.p026db.dao.main.HistoryDialogDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.main.PlaylistsDao;
import com.iMe.storage.data.locale.p026db.dao.main.PlaylistsDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.main.TemplatesDao;
import com.iMe.storage.data.locale.p026db.dao.main.TemplatesDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.main.TopicsDao;
import com.iMe.storage.data.locale.p026db.dao.main.TopicsDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.minor.wallet.WalletConnectSessionsDao;
import com.iMe.storage.data.locale.p026db.dao.minor.wallet.WalletConnectSessionsDao_Impl;
...
public final class AppMainDatabase_Impl extends AppMainDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(19) { // from class: com.iMe.storage.data.locale.db.database.AppMainDatabase_Impl.1
            ...
            public void createAllTables(SupportSQLiteDatabase _db) {
                _db.execSQL("CREATE TABLE IF NOT EXISTS `FilterSettingsDb` (`filterId` INTEGER NOT NULL, `fabs` TEXT NOT NULL, `icon` TEXT, `isHidden` INTEGER NOT NULL, `userId` INTEGER NOT NULL, PRIMARY KEY(`filterId`, `userId`))");
                ...
                _db.execSQL("CREATE TABLE IF NOT EXISTS `TopicDb` (`topicId` INTEGER NOT NULL, `name` TEXT, `icon` TEXT, `order` INTEGER NOT NULL, `isHidden` INTEGER NOT NULL, `presets` TEXT NOT NULL, `dialogs` TEXT NOT NULL, `userId` INTEGER NOT NULL, PRIMARY KEY(`userId`, `topicId`))");
                ...
                _db.execSQL("CREATE TABLE IF NOT EXISTS `AlbumsDb` (`userId` INTEGER NOT NULL, `dialogId` INTEGER NOT NULL, PRIMARY KEY(`userId`, `dialogId`))");
                _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
                _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '0d5959f37b3f7393ab67a7298be3e10d')");
            }
            ...
            public void dropAllTables(SupportSQLiteDatabase _db) {
                ...
                _db.execSQL("DROP TABLE IF EXISTS `AlbumsDb`");
            ...
            protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                TableInfo tableInfo9 = new TableInfo("AlbumsDb", hashMap9, new HashSet(0), new HashSet(0));
                TableInfo read9 = TableInfo.read(_db, "AlbumsDb");
                if (!tableInfo9.equals(read9)) {
                    return new RoomOpenHelper.ValidationResult(false, "AlbumsDb(com.iMe.storage.data.locale.db.model.cloud.AlbumsDb).\n Expected:\n" + tableInfo9 + "\n Found:\n" + read9);
                }
                return new RoomOpenHelper.ValidationResult(true, null);
            }
        }, "0d5959f37b3f7393ab67a7298be3e10d", "edd3a672e9b184d9126b212f5aa7fc9d")).build());
    }

    @Override // androidx.room.RoomDatabase
    protected InvalidationTracker createInvalidationTracker() {
        return new InvalidationTracker(this, new HashMap(0), new HashMap(0), "FilterSettingsDb", "DialogTranslationSettingsDb", "TopicDb", "WalletConnectSessionDb", "TemplatesDb", "PlaylistsDb", "HistoryDialogDb", "HiddenChatsDb", "AlbumsDb");
    }
    ...
    @Override // com.iMe.storage.data.locale.p026db.database.AppMainDatabase
