...
import com.iMe.storage.data.locale.p026db.dao.minor.catalog.CatalogCategoryDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.minor.catalog.CatalogLanguageDao;
import com.iMe.storage.data.locale.p026db.dao.minor.catalog.CatalogLanguageDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.minor.cloud.CloudAlbumsDao;
import com.iMe.storage.data.locale.p026db.dao.minor.cloud.CloudAlbumsDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.minor.social.SocialNetworkDao;
import com.iMe.storage.data.locale.p026db.dao.minor.social.SocialNetworkDao_Impl;
import com.iMe.storage.data.locale.p026db.dao.minor.wallet.WalletTokensBalancesDao;
import com.iMe.storage.data.locale.p026db.dao.minor.wallet.WalletTokensBalancesDao_Impl;
...
public final class AppCacheDatabase_Impl extends AppCacheDatabase {
    ...
    private volatile CloudAlbumsDao _cloudAlbumsDao;
    ...
    protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
        ...
        hashMap.put(CloudAlbumsDao.class, CloudAlbumsDao_Impl.getRequiredConverters());
    ...
    @Override // com.iMe.storage.data.locale.p026db.database.AppCacheDatabase
    ...
    @Override // com.iMe.storage.data.locale.p026db.database.AppCacheDatabase
    public CloudAlbumsDao cloudAlbumDao() {
        CloudAlbumsDao cloudAlbumsDao;
        if (this._cloudAlbumsDao != null) {
            return this._cloudAlbumsDao;
        }
        synchronized (this) {
            if (this._cloudAlbumsDao == null) {
                this._cloudAlbumsDao = new CloudAlbumsDao_Impl(this);
            }
            cloudAlbumsDao = this._cloudAlbumsDao;
        }
        return cloudAlbumsDao;
    }
