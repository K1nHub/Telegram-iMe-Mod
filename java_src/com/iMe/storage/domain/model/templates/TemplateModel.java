...
public final class TemplateModel {
    ...
    public int hashCode() {
        int m1020m = ((((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.messageId) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.groupId)) * 31) + this.name.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.creationDate)) * 31) + this.usageRating) * 31;
        boolean z = this.sent;
        int i = z;
        if (z != 0) {
            i = 1;
