...
public final class TokenBalance {
    ...
    public int hashCode() {
        return (((((((StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.total) * 31) + this.totalInFiat.hashCode()) * 31) + this.rateToFiat.hashCode()) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.ratePercentageChange24h)) * 31) + this.token.hashCode();
    }
