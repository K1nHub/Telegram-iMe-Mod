...
public final class BinanceAuthTokens {
    ...
    public int hashCode() {
        return (((((this.accessToken.hashCode() * 31) + this.refreshToken.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.accessTokenExpiresIn)) * 31) + this.authType.hashCode();
    }
