...
public final class BinanceAuthTokens {
    ...
    public int hashCode() {
        return (((((this.accessToken.hashCode() * 31) + this.refreshToken.hashCode()) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.accessTokenExpiresIn)) * 31) + this.authType.hashCode();
    }
