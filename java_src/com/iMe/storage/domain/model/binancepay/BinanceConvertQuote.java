...
public final class BinanceConvertQuote {
    ...
    public int hashCode() {
        return (((((((((((this.quoteId.hashCode() * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.inputAmount)) * 31) + this.inputToken.hashCode()) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.outputAmount)) * 31) + this.outputToken.hashCode()) * 31) + this.inputTokenShortName.hashCode()) * 31) + this.outputTokenShortName.hashCode();
    }
