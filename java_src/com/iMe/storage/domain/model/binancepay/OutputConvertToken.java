...
public final class OutputConvertToken {
    ...
    public int hashCode() {
        return (((this.tokenInfo.hashCode() * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.minLimit)) * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.maxLimit);
    }
