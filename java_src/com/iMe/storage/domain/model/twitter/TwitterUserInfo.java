...
public final class TwitterUserInfo {
    ...
    public int hashCode() {
        int m1020m = ((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.twitterUserId) * 31) + this.twitterUsername.hashCode()) * 31) + this.twitterName.hashCode()) * 31) + this.twitterAvatarUrl.hashCode()) * 31;
        Long l = this.telegramUserId;
        return m1020m + (l == null ? 0 : l.hashCode());
    }
