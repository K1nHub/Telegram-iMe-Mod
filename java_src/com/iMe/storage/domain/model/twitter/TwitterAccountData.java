...
public final class TwitterAccountData {
    ...
    public int hashCode() {
        return (((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.twitterId) * 31) + this.twitterUsername.hashCode()) * 31) + this.accessToken.hashCode()) * 31) + this.refreshToken.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.tokenValidUntil);
    }
