...
public final class TwitterProfileInfo {
    ...
    public int hashCode() {
        int m1020m = ((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.twitterUserId) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.twitterUserIdInDatabase)) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.telegramUserId)) * 31) + this.twitterUserName.hashCode()) * 31;
