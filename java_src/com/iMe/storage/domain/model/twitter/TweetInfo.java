...
public final class TweetInfo {
    ...
    public int hashCode() {
        int m1020m = ((((((((((((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.f376id) * 31) + this.authorName.hashCode()) * 31) + this.authorNickname.hashCode()) * 31) + this.avatarUrl.hashCode()) * 31) + this.likesCount) * 31) + this.quotesCount) * 31) + this.retweetsCount) * 31) + this.text.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.createdAt)) * 31;
        boolean z = this.isLiked;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((m1020m + i) * 31) + this.mediaInfo.hashCode();
    }

    public String toString() {
        return "TweetInfo(id=" + this.f376id + ", authorName=" + this.authorName + ", authorNickname=" + this.authorNickname + ", avatarUrl=" + this.avatarUrl + ", likesCount=" + this.likesCount + ", quotesCount=" + this.quotesCount + ", retweetsCount=" + this.retweetsCount + ", text=" + this.text + ", createdAt=" + this.createdAt + ", isLiked=" + this.isLiked + ", mediaInfo=" + this.mediaInfo + ')';
    }
