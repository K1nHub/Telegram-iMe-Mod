...
public abstract class Notification {
    ...
    public static abstract class CryptoTransfer extends Notification {
        ...
        /* loaded from: classes3.dex */
        public static final class C1960In extends CryptoTransfer {
            private final String amount;
            private final String date;
            private final String fromAddress;
    ...
    public static abstract class Donation extends CryptoTransfer {
        ...
        /* loaded from: classes3.dex */
        public static final class C1961In extends Donation {
            private final String amount;
            private final String date;
            private final String fromAddress;
            ...
            public final C1961In copy(String id, boolean z, NotificationType type, String date, String userId, String networkId, String tokenCode, String fromAddress, String toAddress, String amount) {
                Intrinsics.checkNotNullParameter(id, "id");
                Intrinsics.checkNotNullParameter(type, "type");
                Intrinsics.checkNotNullParameter(date, "date");
                Intrinsics.checkNotNullParameter(userId, "userId");
                ...
                Intrinsics.checkNotNullParameter(toAddress, "toAddress");
                Intrinsics.checkNotNullParameter(amount, "amount");
                return new C1961In(id, z, type, date, userId, networkId, tokenCode, fromAddress, toAddress, amount);
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof C1961In) {
                    C1961In c1961In = (C1961In) obj;
                    return Intrinsics.areEqual(getId(), c1961In.getId()) && isRead() == c1961In.isRead() && getType() == c1961In.getType() && Intrinsics.areEqual(getDate(), c1961In.getDate()) && Intrinsics.areEqual(getUserId(), c1961In.getUserId()) && Intrinsics.areEqual(getNetworkId(), c1961In.getNetworkId()) && Intrinsics.areEqual(getTokenCode(), c1961In.getTokenCode()) && Intrinsics.areEqual(getFromAddress(), c1961In.getFromAddress()) && Intrinsics.areEqual(getToAddress(), c1961In.getToAddress()) && Intrinsics.areEqual(getAmount(), c1961In.getAmount());
                }
                return false;
            }
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C1961In(String id, boolean z, NotificationType type, String date, String userId, String networkId, String tokenCode, String fromAddress, String toAddress, String amount) {
                super(id, z, type, date, userId, networkId, tokenCode, fromAddress, toAddress, amount, null);
                Intrinsics.checkNotNullParameter(id, "id");
                Intrinsics.checkNotNullParameter(type, "type");
                Intrinsics.checkNotNullParameter(date, "date");
