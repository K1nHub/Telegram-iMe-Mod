...
public abstract class Notification {
    ...
    public static abstract class CryptoTransfer extends Notification {
        ...
        /* loaded from: classes3.dex */
        public static final class C1958In extends CryptoTransfer {
            private final String amount;
            private final String date;
            private final String fromAddress;
            ...
            public final C1958In copy(String id, boolean z, NotificationType type, String date, String userId, String networkId, String tokenCode, String fromAddress, String toAddress, String amount) {
                Intrinsics.checkNotNullParameter(id, "id");
                Intrinsics.checkNotNullParameter(type, "type");
                Intrinsics.checkNotNullParameter(date, "date");
                Intrinsics.checkNotNullParameter(userId, "userId");
                ...
                Intrinsics.checkNotNullParameter(toAddress, "toAddress");
                Intrinsics.checkNotNullParameter(amount, "amount");
                return new C1958In(id, z, type, date, userId, networkId, tokenCode, fromAddress, toAddress, amount);
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof C1958In) {
                    C1958In c1958In = (C1958In) obj;
                    return Intrinsics.areEqual(getId(), c1958In.getId()) && isRead() == c1958In.isRead() && getType() == c1958In.getType() && Intrinsics.areEqual(getDate(), c1958In.getDate()) && Intrinsics.areEqual(getUserId(), c1958In.getUserId()) && Intrinsics.areEqual(getNetworkId(), c1958In.getNetworkId()) && Intrinsics.areEqual(getTokenCode(), c1958In.getTokenCode()) && Intrinsics.areEqual(getFromAddress(), c1958In.getFromAddress()) && Intrinsics.areEqual(getToAddress(), c1958In.getToAddress()) && Intrinsics.areEqual(getAmount(), c1958In.getAmount());
                }
                return false;
            }
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C1958In(String id, boolean z, NotificationType type, String date, String userId, String networkId, String tokenCode, String fromAddress, String toAddress, String amount) {
    ...
    public static abstract class Donation extends CryptoTransfer {
        ...
        /* loaded from: classes3.dex */
        public static final class C1959In extends Donation {
            private final String amount;
            private final String date;
            private final String fromAddress;
