...
public final class PreferenceBlockchainMappedData<V> {
    ...
    public final Map<String, V> getData() {
        ...
        return (Map) gson.fromJson(string, new TypeToken<Map<String, ? extends V>>() { // from class: com.iMe.storage.domain.model.PreferenceBlockchainMappedData$special$$inlined$fromJsonTokenType$1
        }.getType());
    }
