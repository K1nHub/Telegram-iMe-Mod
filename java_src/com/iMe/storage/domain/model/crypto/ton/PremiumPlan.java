...
public final class PremiumPlan {
    ...
    public int hashCode() {
        return (((((this.months * 31) + StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.price)) * 31) + this.discount.hashCode()) * 31) + this.fiatPrice.hashCode();
    }
