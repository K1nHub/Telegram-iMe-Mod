...
public abstract class ApproveArgs implements TransactionArgs {
    ...
    public static final class Dex extends ApproveArgs {
        ...
        public int hashCode() {
            return (((((((((((((((((getBlockchainType().hashCode() * 31) + getValue().hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.chainId)) * 31) + this.nonce.hashCode()) * 31) + this.gasPrice.hashCode()) * 31) + this.gasLimit.hashCode()) * 31) + this.tokenContractAddress.hashCode()) * 31) + this.exchangeContractAddress.hashCode()) * 31) + this.networkId.hashCode()) * 31) + this.protocol.hashCode();
        }
