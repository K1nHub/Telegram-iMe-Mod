...
public abstract class TransferArgs implements TransactionArgs {
    ...
    public static final class EVM extends TransferArgs {
        ...
        public int hashCode() {
            int m1015m = ((((((((((((StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(getAmount()) * 31) + getDecimals()) * 31) + this.recipientAddress.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.chainId)) * 31) + this.nonce.hashCode()) * 31) + this.gasPrice.hashCode()) * 31) + this.gasLimit.hashCode()) * 31;
            String str = this.contractAddress;
            return m1015m + (str == null ? 0 : str.hashCode());
        }
    ...
    public static final class TON extends TransferArgs {
        ...
        public int hashCode() {
            int m1015m = ((((StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(getAmount()) * 31) + getDecimals()) * 31) + this.recipientAddress.hashCode()) * 31;
            String str = this.message;
            int hashCode = (((((m1015m + (str == null ? 0 : str.hashCode())) * 31) + this.sendMode) * 31) + this.seqno) * 31;
    ...
    public static final class TRON extends TransferArgs {
        ...
        public int hashCode() {
            int m1015m = ((((((StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(getAmount()) * 31) + getDecimals()) * 31) + this.recipientAddress.hashCode()) * 31) + this.feeLimit.hashCode()) * 31;
            String str = this.contractAddress;
            return ((m1015m + (str == null ? 0 : str.hashCode())) * 31) + this.blockHeader.hashCode();
        }
    ...
    public static final class BTC extends TransferArgs {
        ...
        public int hashCode() {
            return (((((((((StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(getAmount()) * 31) + getDecimals()) * 31) + this.recipientAddress.hashCode()) * 31) + this.utxos.hashCode()) * 31) + this.changeAddress.hashCode()) * 31) + this.byteFee.hashCode();
        }
