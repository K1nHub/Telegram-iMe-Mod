...
public abstract class TransactionParams {
    ...
    public static final class Ether extends TransactionParams {
        ...
        public int hashCode() {
            return (((((((getMedium().hashCode() * 31) + (getFastest() == null ? 0 : getFastest().hashCode())) * 31) + (getLow() != null ? getLow().hashCode() : 0)) * 31) + this.nonce.hashCode()) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.chainId);
        }
