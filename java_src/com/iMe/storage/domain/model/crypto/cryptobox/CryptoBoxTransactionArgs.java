...
public final class CryptoBoxTransactionArgs implements TransactionArgs {
    ...
    public int hashCode() {
        int m1020m = ((((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.chainId) * 31) + this.f350to.hashCode()) * 31) + this.nonce.hashCode()) * 31) + this.gasLimit.hashCode()) * 31) + this.gasPrice.hashCode()) * 31;
