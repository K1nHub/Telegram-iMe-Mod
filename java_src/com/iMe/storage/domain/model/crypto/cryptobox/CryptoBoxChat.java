...
public final class CryptoBoxChat {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CryptoBoxChat) {
            ...
            return this.f415id == cryptoBoxChat.f415id && Intrinsics.areEqual(this.name, cryptoBoxChat.name) && Intrinsics.areEqual(this.avatarUrl, cryptoBoxChat.avatarUrl);
        }
        return false;
    }

    public int hashCode() {
        return (((BotsDbModel$$ExternalSyntheticBackport0.m724m(this.f415id) * 31) + this.name.hashCode()) * 31) + this.avatarUrl.hashCode();
    }

    public String toString() {
        return "CryptoBoxChat(id=" + this.f415id + ", name=" + this.name + ", avatarUrl=" + this.avatarUrl + ')';
    }
