...
public final class ReactionInteractor {
    ...
    public final Observable<Result<ReactionMessageResult>> prepareLikeMessage(ReactionRequestData data) {
        ...
        Observable<Result<ReactionMessageResult>> subscribeOn = this.repository.prepareLikeMessage(data).startWith((Observable<Result<ReactionMessageResult>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo1011io());
