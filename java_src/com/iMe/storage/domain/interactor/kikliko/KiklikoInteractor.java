...
public final class KiklikoInteractor {
    ...
    public final Observable<Result<List<TagResponse>>> getTags() {
        Observable<Result<List<TagResponse>>> subscribeOn = this.kiklikoRepository.getTags().subscribeOn(this.schedulersProvider.mo1010io());
    ...
    public final Observable<Result<SearchResponse>> searchByKeyword(String keyword, String offset) {
        ...
        Observable<Result<SearchResponse>> subscribeOn = this.kiklikoRepository.searchByKeyword(keyword, offset.length() == 0 ? 0 : Integer.parseInt(offset)).subscribeOn(this.schedulersProvider.mo1010io());
    ...
    public final Observable<Result<SearchResponse>> searchByTag(String tag, String offset) {
        ...
        Intrinsics.checkNotNullParameter(offset, "offset");
        Observable<Result<SearchResponse>> subscribeOn = this.kiklikoRepository.searchByTag(tag, offset.length() == 0 ? 0 : Integer.parseInt(offset)).subscribeOn(this.schedulersProvider.mo1010io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "kiklikoRepository.search…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<SearchResponse>> getTrending(String offset) {
        Intrinsics.checkNotNullParameter(offset, "offset");
        Observable<Result<SearchResponse>> subscribeOn = this.kiklikoRepository.getTrending(offset.length() == 0 ? 0 : Integer.parseInt(offset)).subscribeOn(this.schedulersProvider.mo1010io());
    ...
    public final Observable<Result<Boolean>> share(String slug) {
        ...
        Observable<Result<Boolean>> subscribeOn = this.kiklikoRepository.share(slug).subscribeOn(this.schedulersProvider.mo1010io());
    ...
    public final Observable<Result<Boolean>> view(String slug) {
        Intrinsics.checkNotNullParameter(slug, "slug");
        Observable<Result<Boolean>> subscribeOn = this.kiklikoRepository.view(slug).subscribeOn(this.schedulersProvider.mo1010io());
    ...
    public final Observable<Result<Boolean>> report(String slug, String reason) {
        ...
        Observable<Result<Boolean>> subscribeOn = this.kiklikoRepository.report(slug, reason).subscribeOn(this.schedulersProvider.mo1010io());
