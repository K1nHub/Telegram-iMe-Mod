...
public final class BinanceInternalInteractor {
    ...
    public final Observable<Result<BinanceAuthTokens>> getAuthTokens(BinancePayAuthType type, String value) {
        ...
        Observable<Result<BinanceAuthTokens>> startWith = this.binanceInternalRepository.getAuthTokens(type, value).subscribeOn(this.schedulersProvider.mo717io()).startWith((Observable<Result<BinanceAuthTokens>>) Result.Companion.loading$default(Result.Companion, null, 1, null));
    ...
    public final Observable<Result<Boolean>> logout(String accessToken) {
        ...
        Observable<Result<Boolean>> startWith = this.binanceInternalRepository.logout(accessToken).subscribeOn(this.schedulersProvider.mo717io()).startWith((Observable<Result<Boolean>>) Result.Companion.loading$default(Result.Companion, null, 1, null));
        Intrinsics.checkNotNullExpressionValue(startWith, "binanceInternalRepositor…artWith(Result.loading())");
        return startWith;
    }

    public final Observable<Result<BinanceUserInfo>> getUserInfo(boolean z) {
        Observable<Result<BinanceUserInfo>> startWith = this.binanceInternalRepository.getUserInfo(z).subscribeOn(this.schedulersProvider.mo717io()).startWith((Observable<Result<BinanceUserInfo>>) Result.Companion.loading$default(Result.Companion, null, 1, null));
        Intrinsics.checkNotNullExpressionValue(startWith, "binanceInternalRepositor…artWith(Result.loading())");
        return startWith;
    }
    ...
    public final Observable<Result<List<BinanceTransaction>>> getTransactionHistory(int i, String str, String str2) {
        ...
        Observable<Result<List<BinanceTransaction>>> startWith = this.binanceInternalRepository.getTransactionHistory(i, str, str2).subscribeOn(this.schedulersProvider.mo717io()).startWith((Observable<Result<List<BinanceTransaction>>>) Result.Companion.loading$default(Result.Companion, null, 1, null));
        Intrinsics.checkNotNullExpressionValue(startWith, "binanceInternalRepositor…artWith(Result.loading())");
        return startWith;
    }
    ...
    public final Observable<Result<BinanceTransaction>> getTransaction(String id) {
        ...
        Observable<Result<BinanceTransaction>> startWith = this.binanceInternalRepository.getTransaction(id).subscribeOn(this.schedulersProvider.mo717io()).startWith((Observable<Result<BinanceTransaction>>) Result.Companion.loading$default(Result.Companion, null, 1, null));
        Intrinsics.checkNotNullExpressionValue(startWith, "binanceInternalRepositor…artWith(Result.loading())");
        return startWith;
    }

    public final Observable<Result<List<BinanceTokenBalanceInfo>>> getUserBalance() {
        Observable<Result<List<BinanceTokenBalanceInfo>>> startWith = this.binanceInternalRepository.getUserBalance().subscribeOn(this.schedulersProvider.mo717io()).startWith((Observable<Result<List<BinanceTokenBalanceInfo>>>) Result.Companion.loading$default(Result.Companion, null, 1, null));
        Intrinsics.checkNotNullExpressionValue(startWith, "binanceInternalRepositor…artWith(Result.loading())");
        return startWith;
    }

    public final Observable<Result<List<BinanceTokenInfo>>> getAvailablePaymentTokens() {
        Observable<Result<List<BinanceTokenInfo>>> startWith = this.binanceInternalRepository.getAvailablePaymentTokens().subscribeOn(this.schedulersProvider.mo717io()).startWith((Observable<Result<List<BinanceTokenInfo>>>) Result.Companion.loading$default(Result.Companion, null, 1, null));
        Intrinsics.checkNotNullExpressionValue(startWith, "binanceInternalRepositor…artWith(Result.loading())");
        return startWith;
    }
    ...
    public final Observable<Result<BinanceCollectionOrder>> createCollection(long j, double d, String currency) {
        ...
        Observable<Result<BinanceCollectionOrder>> subscribeOn = this.binanceInternalRepository.createCollection(j, d, currency).subscribeOn(this.schedulersProvider.mo717io());
    ...
    public final Observable<Result<String>> getAddressForTokenReplenish(String tokenTicker, String networkId) {
        ...
        Observable<Result<String>> subscribeOn = this.binanceInternalRepository.getAddressForTokenReplenish(tokenTicker, networkId).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "binanceInternalRepositor…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<List<BinanceTokenInfo>>> getTokensForReplenish(String networkId) {
        Intrinsics.checkNotNullParameter(networkId, "networkId");
        Observable<Result<List<BinanceTokenInfo>>> subscribeOn = this.binanceInternalRepository.getTokensForReplenish(networkId).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "binanceInternalRepositor…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Boolean>> confirmConvertQuote(String id) {
        Intrinsics.checkNotNullParameter(id, "id");
        Observable<Result<Boolean>> subscribeOn = this.binanceInternalRepository.confirmConvertQuote(id).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "binanceInternalRepositor…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<BinanceConvertQuote>> getConvertQuote(String inputToken, String outputToken, String amount) {
        ...
        Observable<Result<BinanceConvertQuote>> subscribeOn = this.binanceInternalRepository.getConvertQuote(inputToken, outputToken, amount).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "binanceInternalRepositor…(schedulersProvider.io())");
        return subscribeOn;
    }

    public final Observable<Result<List<BinanceTokenInfo>>> getTokensForConvert() {
        Observable<Result<List<BinanceTokenInfo>>> subscribeOn = this.binanceInternalRepository.getTokensForConvert().subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "binanceInternalRepositor…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<List<OutputConvertToken>>> getOppositeTokensForConvertByToken(String token) {
        ...
        Observable<Result<List<OutputConvertToken>>> subscribeOn = this.binanceInternalRepository.getOppositeTokensForConvertByToken(token).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "binanceInternalRepositor…(schedulersProvider.io())");
        return subscribeOn;
    }
}
