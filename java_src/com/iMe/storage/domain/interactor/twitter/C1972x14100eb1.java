...
/* renamed from: com.iMe.storage.domain.interactor.twitter.TwitterInteractor$handleTokenError$lambda$3$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1972x14100eb1 extends Lambda implements Function1<Result<? extends TwitterRefreshTokenData>, ObservableSource<? extends Result<? extends T>>> {
    ...
    public C1972x14100eb1(Observable observable, TwitterInteractor twitterInteractor, long j) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends T>> invoke(Result<? extends TwitterRefreshTokenData> result) {
        ...
        Observable subscribeOn = observable.subscribeOn(schedulersProvider.mo699io());
