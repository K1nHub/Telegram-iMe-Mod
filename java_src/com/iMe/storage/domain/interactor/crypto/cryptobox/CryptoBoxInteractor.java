...
public final class CryptoBoxInteractor {
    ...
    public final Observable<Result<CryptoBoxCreationRules>> getCreationRules(String networkId) {
        ...
        Observable<Result<CryptoBoxCreationRules>> subscribeOn = this.cryptoBoxRepository.getCreationRules(networkId).subscribeOn(this.schedulersProvider.mo1014io());
    ...
    public final Observable<Result<CryptoBoxTransactionAction>> getCreationPrepareData(String networkId, String tokenAddress, BigDecimal amount, int i) {
        ...
        Observable<Result<CryptoBoxTransactionAction>> subscribeOn = this.cryptoBoxRepository.getCreationPrepareData(networkId, tokenAddress, amount, i).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<String>> sendCreationExecute(long j, String description, CryptoBoxTransactionArgs args) {
        ...
        Observable<Result<String>> subscribeOn = this.cryptoBoxRepository.sendCreationExecute(j, description, args).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<CryptoBoxTokenApprovalInfo>> getApprovalInfo(String networkId, String tokenAddress) {
        Intrinsics.checkNotNullParameter(networkId, "networkId");
        Intrinsics.checkNotNullParameter(tokenAddress, "tokenAddress");
        Observable<Result<CryptoBoxTokenApprovalInfo>> subscribeOn = this.cryptoBoxRepository.getApprovalInfo(networkId, tokenAddress).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<CryptoBoxTransactionAction>> getApprovalPrepareData(String networkId, String tokenAddress) {
        Intrinsics.checkNotNullParameter(networkId, "networkId");
        Intrinsics.checkNotNullParameter(tokenAddress, "tokenAddress");
        Observable<Result<CryptoBoxTransactionAction>> subscribeOn = this.cryptoBoxRepository.getApprovalPrepareData(networkId, tokenAddress).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<String>> sendApprovalExecute(CryptoBoxTransactionArgs args) {
        Intrinsics.checkNotNullParameter(args, "args");
        Observable<Result<String>> subscribeOn = this.cryptoBoxRepository.sendApprovalExecute(args).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<List<CryptoBoxInfo>>> getCryptoBoxesList(Long l, String networkId, CryptoBoxOrderType orderStrategy) {
        ...
        Observable<Result<List<CryptoBoxInfo>>> subscribeOn = this.cryptoBoxRepository.getCryptoBoxesList(l, networkId, orderStrategy).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<CryptoBoxInfo>> getCryptoBoxInfo(String boxId) {
        ...
        Observable<Result<CryptoBoxInfo>> subscribeOn = this.cryptoBoxRepository.getCryptoBoxInfo(boxId).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<List<CryptoBoxAction>>> getCryptoBoxActions(String boxId) {
        Intrinsics.checkNotNullParameter(boxId, "boxId");
        Observable<Result<List<CryptoBoxAction>>> subscribeOn = this.cryptoBoxRepository.getCryptoBoxActions(boxId).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<CryptoBoxTransactionAction>> getSuspensionPrepareData(String boxId) {
        Intrinsics.checkNotNullParameter(boxId, "boxId");
        Observable<Result<CryptoBoxTransactionAction>> subscribeOn = this.cryptoBoxRepository.getSuspensionPrepareData(boxId).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<String>> sendSuspensionExecute(CryptoBoxTransactionArgs args) {
        Intrinsics.checkNotNullParameter(args, "args");
        Observable<Result<String>> subscribeOn = this.cryptoBoxRepository.sendSuspensionExecute(args).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Boolean>> sendMessageRefresh(String boxId) {
        Intrinsics.checkNotNullParameter(boxId, "boxId");
        Observable<Result<Boolean>> subscribeOn = this.cryptoBoxRepository.sendMessageRefresh(boxId).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<CryptoBoxParticipationData>> getParticipationData(String boxId) {
        Intrinsics.checkNotNullParameter(boxId, "boxId");
        Observable<Result<CryptoBoxParticipationData>> subscribeOn = this.cryptoBoxRepository.getParticipationData(boxId).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<CryptoBoxParticipationResult>> participate(String boxId) {
        Intrinsics.checkNotNullParameter(boxId, "boxId");
        Observable<Result<CryptoBoxParticipationResult>> subscribeOn = this.cryptoBoxRepository.participate(boxId).subscribeOn(this.schedulersProvider.mo1014io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoBoxRepository\n    …(schedulersProvider.io())");
        return subscribeOn;
    }
}
