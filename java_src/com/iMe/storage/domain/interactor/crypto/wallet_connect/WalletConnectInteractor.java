...
public final class WalletConnectInteractor {
    ...
    public final Observable<Result<WalletConnectProcessedTransaction>> getWalletConnectParamsForCryptoTransaction(WalletConnectTransaction transaction) {
        ...
        Observable<Result<WalletConnectProcessedTransaction>> subscribeOn = this.walletConnectRepository.getWalletConnectParamsForCryptoTransaction(transaction).startWith((Observable<Result<WalletConnectProcessedTransaction>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo717io());
    ...
    public final Observable<Result<String>> sendWalletConnectCryptoTransaction(WalletConnectTransactionArgs args) {
        ...
        Observable<Result<String>> subscribeOn = this.walletConnectRepository.sendWalletConnectCryptoTransaction(args).startWith((Observable<Result<String>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "walletConnectRepository\n…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<String>> signWalletConnectCryptoTransaction(WalletConnectTransactionArgs args) {
        Intrinsics.checkNotNullParameter(args, "args");
        Observable<Result<String>> subscribeOn = this.walletConnectRepository.signWalletConnectCryptoTransaction(args).startWith((Observable<Result<String>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "walletConnectRepository\n…(schedulersProvider.io())");
        return subscribeOn;
    }

    public final Flowable<Result<List<WCSessionStoreItem>>> getWalletConnectSavedSessions() {
        Flowable<Result<List<WCSessionStoreItem>>> subscribeOn = this.walletConnectRepository.getWalletConnectSavedSessions().subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "walletConnectRepository\n…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Completable insertWalletConnectSession(WCSessionStoreItem session) {
        ...
        Completable subscribeOn = this.walletConnectRepository.insertWalletConnectSession(session).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "walletConnectRepository\n…(schedulersProvider.io())");
        return subscribeOn;
    }

    public final Completable deleteAllWalletConnectSessions() {
        Completable subscribeOn = this.walletConnectRepository.deleteAllWalletConnectSessions().subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "walletConnectRepository\n…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Completable deleteWalletConnectSession(String sessionKey) {
        ...
        Completable subscribeOn = this.walletConnectRepository.deleteWalletConnectSession(sessionKey).subscribeOn(this.schedulersProvider.mo717io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "walletConnectRepository\n…(schedulersProvider.io())");
        return subscribeOn;
    }
}
