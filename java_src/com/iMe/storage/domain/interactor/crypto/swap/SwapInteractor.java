...
public final class SwapInteractor {
    ...
    public final Observable<Result<CursoredData<TokenDetailedWithRate>>> getAvailableTokensToSwap(SwapProtocol protocol, TransactionDirection direction, String networkId, String str, String str2, Integer num) {
        ...
        Observable<Result<CursoredData<TokenDetailedWithRate>>> subscribeOn = this.swapRepository.getAvailableTokensToSwap(protocol, direction, networkId, str, str2, num).subscribeOn(this.schedulersProvider.mo717io());
    ...
    public final Observable<Result<List<TokenApproveData>>> getApproveTokensInfo(String networkId, SwapProtocol protocol, List<Token> tokens) {
        ...
        Observable<Result<List<TokenApproveData>>> startWith = this.swapRepository.getApproveTokensInfo(protocol, networkId, tokens).subscribeOn(this.schedulersProvider.mo717io()).startWith((Observable<Result<List<TokenApproveData>>>) Result.Companion.loading$default(Result.Companion, null, 1, null));
