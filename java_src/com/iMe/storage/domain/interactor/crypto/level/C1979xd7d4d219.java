...
public final class C1979xd7d4d219 extends Lambda implements Function1<Result<? extends AccountLevel>, ObservableSource<? extends Result<? extends AccountLevelInformation>>> {
    final /* synthetic */ long $userId$inlined;
    final /* synthetic */ AccountLevelInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1979xd7d4d219(long j, AccountLevelInteractor accountLevelInteractor) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends AccountLevelInformation>> invoke(Result<? extends AccountLevel> result) {
        ...
        if (j == telegramGateway.getSelectedAccountId()) {
            ObservableSource map = this.this$0.getLevelVisibility().map(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1980x37fea2f2(result, this.$userId$inlined, this.this$0)));
