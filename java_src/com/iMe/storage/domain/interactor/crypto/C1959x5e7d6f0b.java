...
public final class C1959x5e7d6f0b extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ CryptoWalletInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1959x5e7d6f0b(CryptoWalletInteractor cryptoWalletInteractor) {
        super(1);
