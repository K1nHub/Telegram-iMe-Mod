...
public final class C1908xc8c5d4ec extends Lambda implements Function1<Result<? extends Wallet>, ObservableSource<? extends Result<? extends Wallet>>> {
    final /* synthetic */ BlockchainType $blockchainType$inlined;
    final /* synthetic */ CryptoWalletInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1908xc8c5d4ec(BlockchainType blockchainType, CryptoWalletInteractor cryptoWalletInteractor) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Wallet>> invoke(Result<? extends Wallet> result) {
        ...
        if (!(result instanceof Result.Success)) {
            ...
            Observable flatMap = activateAllBip39BasedWallets.flatMap(new CryptoWalletInteractor$sam$io_reactivex_functions_Function$0(new C1909xa72bc840(result)));
