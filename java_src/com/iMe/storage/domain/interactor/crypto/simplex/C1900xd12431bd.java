...
public final class C1900xd12431bd extends Lambda implements Function1<Result<? extends List<? extends BuyingCryptoQuote>>, Result<? extends List<BuyingCryptoQuote>>> {
    final /* synthetic */ SimplexInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1900xd12431bd(SimplexInteractor simplexInteractor) {
        super(1);
