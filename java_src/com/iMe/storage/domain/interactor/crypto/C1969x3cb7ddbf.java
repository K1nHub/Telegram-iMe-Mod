...
public final class C1969x3cb7ddbf extends Lambda implements Function1<Result<? extends Boolean>, Result<? extends Wallet>> {
    final /* synthetic */ Wallet $newWallet$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1969x3cb7ddbf(Wallet wallet2) {
        super(1);
