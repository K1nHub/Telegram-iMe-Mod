...
public final class C1978x5d896fde extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends String>>> {
    final /* synthetic */ String $txHash$inlined;
    final /* synthetic */ BoostInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1978x5d896fde(BoostInteractor boostInteractor, String str) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends String>> invoke(Result<? extends String> result) {
        ...
        if (result instanceof Result.Success) {
            ...
            Observable<Result<String>> subscribeOn = boost.subscribeOn(schedulersProvider.mo699io());
