...
/* renamed from: com.iMe.storage.domain.interactor.crypto.CryptoWalletInteractor$deleteWallet$4$invoke$$inlined$doOnSuccessNext$1 */
/* loaded from: classes3.dex */
public final class C1969x7263a409 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ boolean $shouldSendRxEvent$inlined;
    final /* synthetic */ CryptoWalletInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1969x7263a409(boolean z, CryptoWalletInteractor cryptoWalletInteractor) {
        super(1);
    ...
    public final void invoke2(Result<? extends Boolean> result) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (this.$shouldSendRxEvent$inlined) {
