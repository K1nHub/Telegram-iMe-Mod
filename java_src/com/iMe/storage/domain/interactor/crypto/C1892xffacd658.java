...
public final class C1892xffacd658 extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends Boolean>>> {
    final /* synthetic */ Wallet $newWallet$inlined;
    final /* synthetic */ CryptoWalletInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1892xffacd658(CryptoWalletInteractor cryptoWalletInteractor, Wallet wallet2) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends String> result) {
        ...
        if (isAddressChanged) {
            ...
            Observable flatMap = unlinkWalletIfNeed.flatMap(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1894xa10c0270(this.this$0, this.$newWallet$inlined, networkType)));
