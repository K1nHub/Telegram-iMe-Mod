...
public final class C1894xa10c0270 extends Lambda implements Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C1894xa10c0270(CryptoWalletInteractor cryptoWalletInteractor, Wallet wallet2, NetworkType networkType) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends Boolean> result) {
        ...
        Observable<Result<Boolean>> subscribeOn = linkWallet.subscribeOn(schedulersProvider.mo694io());
