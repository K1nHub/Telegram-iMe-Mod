...
final class CryptoWalletInteractor$importWallet$4$1 extends Lambda implements Function1<Result<? extends List<? extends Wallet>>, ObservableSource<? extends Result<? extends Wallet>>> {
    final /* synthetic */ Result<Wallet> $result;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public CryptoWalletInteractor$importWallet$4$1(Result<? extends Wallet> result) {
        super(1);
        this.$result = result;
    }
