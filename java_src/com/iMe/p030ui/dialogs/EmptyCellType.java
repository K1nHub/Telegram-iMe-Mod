...
public final class EmptyCellType {
    ...
    static {
        int i = C3630R.raw.filter_no_chats;
        int i2 = C3630R.string.cloud_albums_empty_title;
        ARCHIVE_ALBUMS = new EmptyCellType("ARCHIVE_ALBUMS", 0, i, i2, C3630R.string.cloud_albums_empty_subtitle_archibe);
        ARCHIVE = new EmptyCellType("ARCHIVE", 1, i, C3630R.string.archive_empty_title, C3630R.string.archive_empty_subtitle);
        ALBUMS = new EmptyCellType("ALBUMS", 2, i, i2, C3630R.string.cloud_albums_empty_subtitle);
        MUSIC_ALBUMS = new EmptyCellType("MUSIC_ALBUMS", 3, i, C3630R.string.music_albums_empty_title, C3630R.string.music_albums_empty_subtitle);
        MUSIC_CHANNELS = new EmptyCellType("MUSIC_CHANNELS", 4, i, C3630R.string.music_channels_empty_title, C3630R.string.music_channels_empty_subtitle);
        MUSIC_BOTS = new EmptyCellType("MUSIC_BOTS", 5, i, C3630R.string.music_bots_empty_title, C3630R.string.music_bots_empty_subtitle);
        MUSIC_DEVICE = new EmptyCellType("MUSIC_DEVICE", 6, i, C3630R.string.music_device_empty_title, C3630R.string.music_device_empty_subtitle);
        DRAFTS = new EmptyCellType("DRAFTS", 7, i, C3630R.string.chat_drafts_empty, C3630R.string.chat_drafts_empty_subtitle);
        HIDDEN_CHATS = new EmptyCellType("HIDDEN_CHATS", 8, i, C3630R.string.hidden_chats_empty, C3630R.string.hidden_chats_empty_title);
        $VALUES = $values();
        Companion = new Companion(null);
    }

    /* renamed from: id */
    public final int m1008id() {
        return ordinal() + 100;
    }
