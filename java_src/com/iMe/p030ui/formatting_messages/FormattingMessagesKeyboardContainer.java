...
public final class FormattingMessagesKeyboardContainer extends FrameLayout {
    ...
    public FormattingMessagesKeyboardContainer(Context context, EditTextCaption messageEditText, FormattingTextController formattingTextController, Listener listener) {
        ...
        this.view = view;
        updateView();
        addView(view, LayoutHelper.createFrame(-1, AndroidUtilities.m107dp(1), 48));
        addView(getTitleLink(), LayoutHelper.createFrame(-2, -2));
        addView(getLinkContainer(), LayoutHelper.createFrame(-1, -2, 0, AndroidUtilities.m107dp(8), 0, AndroidUtilities.m107dp(8), 0));
    ...
    public final void updateView() {
        ...
        if (this.formattingTextController.getListSpansFlags().size() == 1) {
            if ((this.formattingTextController.getListSpansFlags().get(0).getUrl().length() > 0) && linkText.isEnabled()) {
                ...
                getLinkContainer().setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m108dp(8.0f), Theme.getColor(this.buttonDefaultColor), Theme.getColor(this.buttonPressedColor)));
            }
        }
    ...
    */
    ...
    public final FormattingMessagesKeyboardContainer$initLinkText$1 initLinkText() {
        ...
        r1.setCursorSize(AndroidUtilities.m107dp(20));
        return r1;
    }
    ...
    public final TextView initPastLink() {
        ...
        textView.setPadding(0, 0, AndroidUtilities.m107dp(8), 0);
    ...
    public final LinearLayout initLinkContainer() {
        ...
        linearLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m108dp(8.0f), Theme.getColor(this.buttonDefaultColor), Theme.getColor(this.buttonPressedColor)));
    ...
    public final LinearLayout initSmallButtons() {
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setOrientation(0);
        linearLayout.addView(getBoldButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m107dp(8), 0, 0, 0));
        linearLayout.addView(getItalicButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m107dp(1), 0, 0, 0));
        linearLayout.addView(getUnderlineButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m107dp(1), 0, 0, 0));
        linearLayout.addView(getStrikeButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m107dp(1), 0, AndroidUtilities.m107dp(8), 0));
        return linearLayout;
    }
    ...
    public final LinearLayout initBigButtons() {
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setOrientation(0);
        linearLayout.addView(getMonoButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m107dp(8), 0, AndroidUtilities.m107dp(2), AndroidUtilities.m107dp(8)));
        linearLayout.addView(getSpoilerButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m107dp(2), 0, AndroidUtilities.m107dp(8), AndroidUtilities.m107dp(8)));
        return linearLayout;
    }
    ...
    protected void onMeasure(int i, int i2) {
        ViewExtKt.setMargins(getTitleLink(), AndroidUtilities.m107dp(50), AndroidUtilities.m107dp(20), 0, 0);
        ...
        ViewExtKt.setMargins(linkContainer, i3, m107dp, marginLayoutParams2 != null ? marginLayoutParams2.rightMargin : 0, 0);
        ViewExtKt.setMargins(getTitleFormat(), AndroidUtilities.m107dp(50), 0, 0, AndroidUtilities.m107dp(163));
        ViewExtKt.setMargins(getSmallButtons(), 0, 0, 0, AndroidUtilities.m107dp(90));
        ViewExtKt.setMargins(getBigButtons(), 0, 0, 0, AndroidUtilities.m107dp(20));
