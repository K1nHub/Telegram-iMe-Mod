...
public final class FormattingMessagesWeb extends LinearLayout {
    ...
    */
    ...
    public final LinearLayout initContainerButton() {
        ...
        linearLayout.addView(getCloseButton(), LayoutHelper.createLinear(-2, -2, AndroidUtilities.m107dp(1), 0, 0, 0));
        linearLayout.addView(getBoldButton(), LayoutHelper.createLinear(0, 48, 0.5f, AndroidUtilities.m107dp(1), 0, AndroidUtilities.m107dp(1), 0));
        LinearLayout.LayoutParams createLinear = LayoutHelper.createLinear(0, 48, 0.5f, 0, 0, AndroidUtilities.m107dp(1), 0);
