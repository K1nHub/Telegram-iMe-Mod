...
public final class FullscreenContentDialog extends AlertDialog.Builder {
    ...
    public FullscreenContentDialog(Context context, Integer num, Integer num2, int i, CharSequence title, SpannableStringBuilder description, int i2, CharSequence buttonText) {
        super(context);
    ...
    public static final class Companion {
        ...
        public final AlertDialog newInstance(Context context, int i, int i2, CharSequence title, CharSequence description, int i3, CharSequence buttonText, Callbacks$Callback callbacks$Callback) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(title, "title");
            Intrinsics.checkNotNullParameter(description, "description");
            Intrinsics.checkNotNullParameter(buttonText, "buttonText");
            return createDialog(new FullscreenContentDialog(context, null, Integer.valueOf(i), i2, title, new SpannableStringBuilder(description), i3, buttonText), callbacks$Callback);
        }

        public final AlertDialog newInstance(Context context, int i, CharSequence title, SpannableStringBuilder description, int i2, CharSequence buttonText, Callbacks$Callback callbacks$Callback) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(title, "title");
            Intrinsics.checkNotNullParameter(description, "description");
            Intrinsics.checkNotNullParameter(buttonText, "buttonText");
            return createDialog(new FullscreenContentDialog(context, Integer.valueOf(i), null, -1, title, description, i2, buttonText), callbacks$Callback);
        }
