...
public final class TonFragmentPremiumProvider extends BaseNodeProvider<TonFragmentItem.C1529Premium> {
    ...
    public /* bridge */ /* synthetic */ void convert(BaseViewHolder baseViewHolder, Object obj, List list) {
        convert(baseViewHolder, (TonFragmentItem.C1529Premium) obj, (List<? extends Object>) list);
    }
    ...
    @Override // com.chad.library.adapter.base.provider.BaseItemProvider
    public void convert(BaseViewHolder helper, final TonFragmentItem.C1529Premium item) {
        boolean isBlank;
        Intrinsics.checkNotNullParameter(helper, "helper");
        Intrinsics.checkNotNullParameter(item, "item");
        BaseViewHolder rippleBackground = BaseQuickAdapterExtKt.setRippleBackground(helper, C3630R.C3633id.constraint_root, false);
        int i = Theme.key_windowBackgroundWhiteBlackText;
        int i2 = C3630R.C3633id.text_title;
        int i3 = C3630R.C3633id.text_price;
        BaseViewHolder themedTextColor = BaseQuickAdapterExtKt.setThemedTextColor(rippleBackground, i, i2, i3);
        int i4 = Theme.key_windowBackgroundWhiteGrayText2;
        int i5 = C3630R.C3633id.text_fiat_price;
        BaseViewHolder themedTextColor2 = BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i4, C3630R.C3633id.text_subtitle, i5);
        int i6 = C3630R.C3633id.text_discount;
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(text, i6, !isBlank), C3630R.C3633id.frame_icon_container, new Function1<FrameLayout, Unit>() { // from class: com.iMe.ui.adapter.provider.TonFragmentPremiumProvider$convert$1$1
            ...
            public final void invoke2(FrameLayout applyForView) {
                ...
                TonFragmentItem.C1529Premium c1529Premium = TonFragmentItem.C1529Premium.this;
                checkBox2.setDrawBackgroundAsArc(10);
                checkBox2.setColor(Theme.key_radioBackgroundChecked, Theme.key_radioBackground, Theme.key_checkboxCheck);
                checkBox2.setChecked(c1529Premium.isChecked(), false);
    ...
    public void convert(BaseViewHolder helper, final TonFragmentItem.C1529Premium item, List<? extends Object> payloads) {
        boolean isBlank;
        Intrinsics.checkNotNullParameter(helper, "helper");
        Intrinsics.checkNotNullParameter(item, "item");
        ...
        int i = C3630R.C3633id.text_discount;
        BaseViewHolder text2 = text.setText(i, item.getDiscount());
        isBlank = StringsKt__StringsJVMKt.isBlank(item.getDiscount());
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(text2, i, !isBlank), C3630R.C3633id.frame_icon_container, new Function1<FrameLayout, Unit>() { // from class: com.iMe.ui.adapter.provider.TonFragmentPremiumProvider$convert$2$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(FrameLayout applyForView) {
                ...
                if (checkBox2 != null) {
                    checkBox2.setChecked(TonFragmentItem.C1529Premium.this.isChecked(), true);
                }
            }
        });
    }
