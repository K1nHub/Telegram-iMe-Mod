...
public final class CryptoBoxActionProvider extends BaseNodeProvider<CryptoBoxActionItem> {
    ...
    public void convert(BaseViewHolder helper, final CryptoBoxActionItem item) {
        ...
        BaseViewHolder imageResource = BaseQuickAdapterExtKt.setVisibleElseGone(themedTextColor4, i5, !RecycleViewExtKt.isLastItem(helper, adapter)).setImageResource(C3634R.C3637id.image_transaction_type_icon, item.getIcon());
