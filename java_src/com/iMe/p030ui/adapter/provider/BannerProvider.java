...
public final class BannerProvider extends BaseNodeProvider<BannerItem> {
    ...
    public BannerProvider(BannersRecycleAdapter bannersRecycleAdapter) {
        ...
        this.layoutId = C3632R.layout.fork_recycle_item_wallet_banners;
    ...
    public final void onViewRecycled(BaseViewHolder holder) {
        ...
        if (BaseQuickAdapterExtKt.isViewType(holder, getItemViewType())) {
            RecyclerView.LayoutManager layoutManager = ((RecyclerView) holder.getView(C3632R.C3635id.recycle_banners)).getLayoutManager();
    ...
    public void convert(final BaseViewHolder helper, final BannerItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(helper, C3632R.C3635id.recycle_banners, new Function1<RecyclerView, Unit>() { // from class: com.iMe.ui.adapter.provider.BannerProvider$convert$1
        ...
        }), C3632R.C3635id.banner_slide_indicator, new Function1<ScrollingPagerIndicator, Unit>() { // from class: com.iMe.ui.adapter.provider.BannerProvider$convert$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(ScrollingPagerIndicator applyForView) {
                Intrinsics.checkNotNullParameter(applyForView, "$this$applyForView");
                applyForView.attachToRecyclerView((RecyclerView) BaseViewHolder.this.getView(C3632R.C3635id.recycle_banners));
