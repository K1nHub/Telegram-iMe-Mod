...
public final class BinanceTokenBalanceProvider extends BaseNodeProvider<BinanceBalanceItem> {
    ...
    private final int layoutId = C3632R.layout.fork_recycle_item_wallet_dashboard_account_balance;
