...
public final class CreateCampaignProvider extends BaseNodeProvider<CreateCampaignItem> {
    ...
    public CreateCampaignProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3630R.layout.fork_recycle_item_wallet_single_create_action;
    }
    ...
    public void convert(BaseViewHolder helper, CreateCampaignItem item) {
        ...
        int i2 = C3630R.C3633id.text_empty_title;
        BaseQuickAdapterExtKt.setThemedTextColor(foreground, i2, Theme.key_chats_actionBackground).setText(i2, this.resourceManager.getString(item.getTitleResId())).setImageResource(C3630R.C3633id.image_empty_icon, item.getIcon());
    }
}
