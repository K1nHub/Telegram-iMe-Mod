...
public final class TonFragmentProductProvider extends BaseNodeProvider<TonFragmentItem.Product> {
    ...
    private final int layoutId = C3630R.layout.fork_recycle_item_ton_fragment_product;
    ...
    public TonFragmentProductProvider() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<Float>() { // from class: com.iMe.ui.adapter.provider.TonFragmentProductProvider$itemElevation$2
            ...
            public final Float invoke() {
                return Float.valueOf(TonFragmentProductProvider.this.getContext().getResources().getDimension(C3630R.dimen.wallet_card_elevation));
            }
        });
    ...
    public void convert(BaseViewHolder helper, final TonFragmentItem.Product item) {
        ...
        }), C3630R.C3633id.frame_icon_container, new Function1<FrameLayout, Unit>() { // from class: com.iMe.ui.adapter.provider.TonFragmentProductProvider$convert$1$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public void convert(BaseViewHolder helper, final TonFragmentItem.Product item, List<? extends Object> payloads) {
        ...
        BaseViewHolder text = helper.setText(C3630R.C3633id.text_title, item.getTitle()).setText(C3630R.C3633id.text_price, item.getPriceText()).setText(C3630R.C3633id.text_fiat_price, item.getFiatPrice());
        int i = C3630R.C3633id.text_subtitle;
        BaseViewHolder text2 = text.setText(i, item.getSubtitle());
        isBlank = StringsKt__StringsJVMKt.isBlank(item.getSubtitle());
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(text2, i, !isBlank), C3630R.C3633id.frame_icon_container, new Function1<FrameLayout, Unit>() { // from class: com.iMe.ui.adapter.provider.TonFragmentProductProvider$convert$2$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
