...
public final class SimplexProductProvider extends BaseNodeProvider<CryptoBuyItem> {
    ...
    public SimplexProductProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3630R.layout.fork_recycle_item_wallet_buy_token;
    }
    ...
    public void convert(BaseViewHolder helper, CryptoBuyItem item) {
        ...
        int i4 = C3630R.C3633id.text_price_value;
        ...
        int i6 = C3630R.C3633id.text_price_title;
        BaseViewHolder text = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor3, i6, i5), i2), i4).setText(i2, this.resourceManager.getString(C3630R.string.wallet_crypto_buy_amount_title)).setText(i3, item.getAmount(this.resourceManager)).setText(i4, item.getPrice(this.resourceManager)).setText(i6, this.resourceManager.getString(C3630R.string.wallet_buy_tokens_purchase_slide_price_title));
        int i7 = C3630R.C3633id.image_logo;
