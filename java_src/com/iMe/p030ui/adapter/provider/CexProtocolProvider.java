...
public final class CexProtocolProvider extends BaseNodeProvider<CexProtocolItem> {
    ...
    public void convert(BaseViewHolder helper, CexProtocolItem item) {
        ...
        BaseViewHolder themedCardBackground = BaseQuickAdapterExtKt.setThemedCardBackground(helper, C3630R.C3633id.card_root, Theme.key_windowBackgroundWhite);
        ...
        int i2 = C3630R.C3633id.text_subtitle;
        BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i2, Theme.key_windowBackgroundWhiteGrayText2).setImageResource(C3630R.C3633id.image_icon, item.getInfo().getLogo()), i).setText(i, this.resourceManager.getString(item.getInfo().getName())).setText(i2, this.resourceManager.getString(item.getInfo().getDescription()));
    }
}
