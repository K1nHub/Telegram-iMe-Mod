...
public final class CexProtocolProvider extends BaseNodeProvider<CexProtocolItem> {
    ...
    public void convert(BaseViewHolder helper, CexProtocolItem item) {
        ...
        BaseViewHolder themedCardBackground = BaseQuickAdapterExtKt.setThemedCardBackground(helper, C3632R.C3635id.card_root, Theme.key_windowBackgroundWhite);
        ...
        int i2 = C3632R.C3635id.text_subtitle;
        BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i2, Theme.key_windowBackgroundWhiteGrayText2).setImageResource(C3632R.C3635id.image_icon, item.getInfo().getLogo()), i).setText(i, this.resourceManager.getString(item.getInfo().getName())).setText(i2, this.resourceManager.getString(item.getInfo().getDescription()));
    }
}
