...
public final class StakingDashboardProvider extends BaseNodeProvider<StakingDashboardItem> {
    ...
    private final int layoutId = C3632R.layout.fork_recycle_item_staking_dashboard;
    ...
    public void convert(BaseViewHolder helper, final StakingDashboardItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper, C3632R.C3635id.view_staking_dashboard, new Function1<StakingDashboardView, Unit>() { // from class: com.iMe.ui.adapter.provider.StakingDashboardProvider$convert$1
    ...
    public void convert(BaseViewHolder helper, final StakingDashboardItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper, C3632R.C3635id.view_staking_dashboard, new Function1<StakingDashboardView, Unit>() { // from class: com.iMe.ui.adapter.provider.StakingDashboardProvider$convert$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
