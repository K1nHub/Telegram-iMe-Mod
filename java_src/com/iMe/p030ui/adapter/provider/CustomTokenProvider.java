...
public final class CustomTokenProvider extends BaseNodeProvider<TokenItem> {
    ...
    public CustomTokenProvider(final ResourceManager resourceManager) {
        ...
        this.layoutId = C3630R.layout.fork_recycle_item_custom_token;
    ...
    public void convert(BaseViewHolder helper, TokenItem item) {
        ...
        int i2 = C3630R.C3633id.text_address;
        BaseViewHolder loadImage$default = BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i2, Theme.key_windowBackgroundWhiteGrayText), C3630R.C3633id.image_token_icon, item.getAvatarUrl(), null, false, 12, null);
        int i3 = C3630R.C3633id.image_network_icon;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.loadImage$default(loadImage$default, i3, NetworksHelper.getNetworkById(item.getNetworkId()).getLogoUrl(), null, false, 12, null).setText(i, item.getName()).setText(i2, StringExtKt.shortened$default(item.getAddress(), 0, 1, null)).setText(C3630R.C3633id.text_ticker, item.getTicker()), i3, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.CustomTokenProvider$convert$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public void convert(BaseViewHolder helper, TokenItem item, List<? extends Object> payloads) {
        ...
        helper.setText(C3630R.C3633id.text_name, item.getName()).setText(C3630R.C3633id.text_ticker, item.getTicker());
    }
}
