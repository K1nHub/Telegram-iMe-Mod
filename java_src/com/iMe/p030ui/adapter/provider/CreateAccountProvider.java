...
public final class CreateAccountProvider extends BaseNodeProvider<AccountItem.Create> {
    ...
    private final int layoutId = C3630R.layout.fork_recycle_item_wallet_dashboard_account_empty;
    ...
    public void convert(BaseViewHolder helper, final AccountItem.Create item) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setAlpha(BaseQuickAdapterExtKt.setThemedCardBackground(helper, C3630R.C3633id.card_empty_account, Theme.key_windowBackgroundWhite), C3630R.C3633id.frame_root, 1.0f), C3630R.C3633id.horizontal_action_buttons, new Function1<HorizontalActionButtonsView, Unit>() { // from class: com.iMe.ui.adapter.provider.CreateAccountProvider$convert$1
    ...
    public void convert(BaseViewHolder helper, final AccountItem.Create item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper, C3630R.C3633id.horizontal_action_buttons, new Function1<HorizontalActionButtonsView, Unit>() { // from class: com.iMe.ui.adapter.provider.CreateAccountProvider$convert$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
