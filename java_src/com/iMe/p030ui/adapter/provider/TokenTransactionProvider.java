...
public final class TokenTransactionProvider extends BaseNodeProvider<TransactionItem> {
    ...
    public void convert(BaseViewHolder helper, final TransactionItem item) {
        ...
        BaseViewHolder mediumTypeface = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setVisibleElseGone(themedTextColor4, i6, !RecycleViewExtKt.isLastItem(helper, adapter)).setImageResource(C3630R.C3633id.image_transaction_type_icon, item.getTransactionIcon()), i3);
