...
public final class FoundTokenProvider extends BaseNodeProvider<FoundTokenItem> {
    ...
    public FoundTokenProvider(final ResourceManager resourceManager) {
        ...
        this.layoutId = C3632R.layout.fork_recycle_item_found_token;
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<Float>() { // from class: com.iMe.ui.adapter.provider.FoundTokenProvider$networkIconCornerSize$2
            ...
            public final Float invoke() {
                return Float.valueOf(ResourceManager.this.getDimens(C3632R.dimen.icon_size_small_upper) / 2);
            }
        });
    ...
    */
    public void convert(com.chad.library.adapter.base.viewholder.BaseViewHolder r23, final com.iMe.model.wallet.home.FoundTokenItem r24) {
        /*
            ...
            int r3 = org.telegram.messenger.C3632R.C3635id.constraint_root
            r4 = 0
            ...
            int r5 = org.telegram.messenger.C3632R.C3635id.text_name
            ...
            int r6 = org.telegram.messenger.C3632R.C3635id.text_address
            ...
            int r9 = org.telegram.messenger.C3632R.C3635id.image_token_icon
            ...
            int r3 = org.telegram.messenger.C3632R.C3635id.image_network_icon
            ...
            int r7 = org.telegram.messenger.C3632R.C3635id.text_ticker
            ...
            int r6 = org.telegram.messenger.C3632R.C3635id.view_switch
            ...
            int r7 = org.telegram.messenger.C3632R.C3635id.divider_horizontal
    ...
    public void convert(BaseViewHolder helper, final FoundTokenItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.loadImage$default(helper.setText(C3632R.C3635id.text_name, item.getName()).setText(C3632R.C3635id.text_ticker, item.getTicker()), C3632R.C3635id.image_token_icon, item.getTokenLogoUrl(), null, false, 12, null), C3632R.C3635id.image_network_icon, item.getNetworkLogoUrl(), null, false, 12, null), C3632R.C3635id.view_switch, new Function1<Switch, Unit>() { // from class: com.iMe.ui.adapter.provider.FoundTokenProvider$convert$3
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
