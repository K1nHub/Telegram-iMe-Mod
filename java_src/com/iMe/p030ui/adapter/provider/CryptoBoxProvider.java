...
public final class CryptoBoxProvider extends BaseNodeProvider<CryptoBoxItem> {
    ...
    public CryptoBoxProvider(final ResourceManager resourceManager) {
        ...
        this.layoutId = C3630R.layout.fork_recycle_item_cryptobox;
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<Float>() { // from class: com.iMe.ui.adapter.provider.CryptoBoxProvider$networkIconCornerSize$2
            ...
            public final Float invoke() {
                return Float.valueOf(ResourceManager.this.getDimens(C3630R.dimen.icon_size_default) / 2);
            }
        });
    ...
    public void convert(BaseViewHolder helper, final CryptoBoxItem item) {
        ...
        BaseViewHolder rippleBackground = BaseQuickAdapterExtKt.setRippleBackground(helper, C3630R.C3633id.constraint_root, true);
        int i = Theme.key_windowBackgroundWhiteBlackText;
        int i2 = C3630R.C3633id.text_name;
        int i3 = C3630R.C3633id.text_description;
        BaseViewHolder themedTextColor = BaseQuickAdapterExtKt.setThemedTextColor(rippleBackground, i, i2, i3);
        int i4 = C3630R.C3633id.text_creation_time;
        ...
        int i5 = C3630R.C3633id.text_status;
        ...
        int i6 = C3630R.C3633id.image_token_logo;
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(text, i3, true ^ isBlank), C3630R.C3633id.image_logo, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.CryptoBoxProvider$convert$1$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public void convert(BaseViewHolder helper, final CryptoBoxItem item, List<? extends Object> payloads) {
        ...
        int i = C3630R.C3633id.text_status;
        BaseViewHolder textColor = helper.setTextColor(i, getContext().getColor(item.getStatusColorResId()));
        int i2 = C3630R.C3633id.image_logo;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.loadImage$default(textColor, i2, item.getChatAvatarUrl(), null, false, 12, null).setText(C3630R.C3633id.text_name, item.getName()).setText(C3630R.C3633id.text_description, item.getDescription()).setText(C3630R.C3633id.text_creation_time, item.getCreationTimeText()).setText(i, item.getStatusText()), i2, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.CryptoBoxProvider$convert$2$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
