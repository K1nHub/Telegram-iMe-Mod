...
public final class CardButtonProvider extends BaseNodeProvider<CardButtonItem> {
    ...
    public CardButtonProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3634R.layout.fork_recycle_item_wallet_single_create_action;
    }
    ...
    public void convert(BaseViewHolder helper, CardButtonItem item) {
        ...
        int i2 = C3634R.C3637id.text_empty_title;
        BaseQuickAdapterExtKt.setThemedTextColor(foreground, i2, Theme.key_chats_actionBackground).setText(i2, this.resourceManager.getString(item.getTitleResId())).setImageResource(C3634R.C3637id.image_empty_icon, item.getIcon());
    }
}
