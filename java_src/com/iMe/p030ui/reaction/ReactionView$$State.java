...
public class ReactionView$$State extends MvpViewState<ReactionView> implements ReactionView {
    ...
    public class ShowErrorToastCommand<T> extends ViewCommand<ReactionView> {
        ...
        ShowErrorToastCommand(ReactionView$$State reactionView$$State, Result.Error<? extends T> error, ResourceManager resourceManager) {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(ReactionView reactionView) {
            reactionView.showErrorToast(this.result, this.resourceManager);
        }
    }
}
