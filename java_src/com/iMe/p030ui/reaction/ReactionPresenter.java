...
public final class ReactionPresenter extends BasePresenter<ReactionView> {
    ...
    public final void prepareTextMessage(List<String> emojiList, List<UrlButton> buttonList, String messageText, int i, String str, final MessageObject messageObject) {
        ...
        Observable<R> flatMap = this.interactor.prepareLikeMessage(reactionRequestData).flatMap(new C2035x5210a4c3(new Function1<Result<? extends ReactionMessageResult>, ObservableSource<? extends Result<? extends TLRPC$messages_BotResults>>>() { // from class: com.iMe.ui.reaction.ReactionPresenter$prepareTextMessage$$inlined$flatMapSuccess$1
            {
                super(1);
            }
            ...
            public final ObservableSource<? extends Result<? extends TLRPC$messages_BotResults>> invoke(Result<? extends ReactionMessageResult> result) {
                ...
                Observable wrapAsResult = telegramApi.getInlineBot(id, j, AppConfiguration$Reaction.getBotId()).map(new C2035x5210a4c3(new Function1<TLRPC$messages_BotResults, Result<? extends TLRPC$messages_BotResults>>() { // from class: com.iMe.ui.reaction.ReactionPresenter$prepareTextMessage$lambda$0$$inlined$wrapAsResult$1
                    @Override // kotlin.jvm.functions.Function1
                ...
                })).onErrorReturn(new C2035x5210a4c3(new Function1<Throwable, Result<? extends TLRPC$messages_BotResults>>() { // from class: com.iMe.ui.reaction.ReactionPresenter$prepareTextMessage$lambda$0$$inlined$wrapAsResult$2
                    @Override // kotlin.jvm.functions.Function1
                ...
                Intrinsics.checkNotNullExpressionValue(wrapAsResult, "wrapAsResult");
                return wrapAsResult;
            }
        }));
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends TLRPC$messages_BotResults>, Unit>() { // from class: com.iMe.ui.reaction.ReactionPresenter$prepareTextMessage$$inlined$subscribeWithErrorHandle$default$1
            ...
            public final void m1609invoke(Result<? extends TLRPC$messages_BotResults> it) {
                ...
                if (result instanceof Result.Success) {
                    ...
                    j = ReactionPresenter.this.dialogId;
                    SendMessagesHelper.prepareSendingBotContextResult(null, accountInstance, tLRPC$BotInlineResult, formatBotRequestParams, j, messageObject, null, null, null, true, 0, null);
    ...
    public final HashMap<String, String> formatBotRequestParams(TLRPC$messages_BotResults tLRPC$messages_BotResults) {
        ...
        hashMapOf = MapsKt__MapsKt.hashMapOf(TuplesKt.m149to(TtmlNode.ATTR_ID, this.messageId), TuplesKt.m149to("query_id", String.valueOf(tLRPC$messages_BotResults.query_id)), TuplesKt.m149to("bot", String.valueOf(AppConfiguration$Reaction.getBotId())), TuplesKt.m149to("bot_name", AppConfiguration$Reaction.getBotName()));
        return hashMapOf;
    }
}
