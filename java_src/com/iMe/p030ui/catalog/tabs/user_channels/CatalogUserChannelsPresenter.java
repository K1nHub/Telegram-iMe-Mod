...
public final class CatalogUserChannelsPresenter extends BasePresenter<CatalogUserChannelsView> {
    ...
    private final void showItems() {
        ...
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new CreateCampaignItem(C3634R.C3636drawable.fork_ic_add_account_40, C3634R.string.catalog_user_channels_create));
