...
public final class MiniFabsContainer extends LinearLayout {
    ...
    private final RLottieImageView createFab(final FilterFab filterFab) {
        ...
        float f = 2 * m107dp;
        stateListAnimator.addState(new int[]{16842919}, ObjectAnimator.ofFloat(rLottieImageView, property, m107dp, f).setDuration(200L));
        stateListAnimator.addState(new int[0], ObjectAnimator.ofFloat(rLottieImageView, property, f, m107dp).setDuration(200L));
        ...
        rLottieImageView.setOutlineProvider(new ViewOutlineProvider() { // from class: com.iMe.ui.multifab.MiniFabsContainer$createFab$1$2
            ...
            public void getOutline(View view, Outline outline) {
                ...
                outline.setOval(0, 0, AndroidUtilities.m107dp(36), AndroidUtilities.m107dp(36));
            }
        });
    ...
    public final void updateColors() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt instanceof RLottieImageView) {
                ...
                rLottieImageView.setBackground(Theme.createSimpleSelectorCircleDrawable(m107dp, ColorUtils.blendARGB(Theme.getColor(i2), -1, 0.1f), Theme.blendOver(Theme.getColor(i2), Theme.getColor(Theme.key_listSelector))));
