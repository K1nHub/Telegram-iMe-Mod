...
public final class StakingWithdrawalFeeView extends FrameLayout {
    ...
    private final void setupTexts() {
        ForkContentStakingWithdrawalFeeBinding forkContentStakingWithdrawalFeeBinding = this.binding;
        forkContentStakingWithdrawalFeeBinding.textFeeTitle.setText(LocaleController.getInternalString(C3632R.string.staking_withdraw_fee_title));
        forkContentStakingWithdrawalFeeBinding.textTimeTitle.setText(LocaleController.getInternalString(C3632R.string.staking_withdraw_time_title));
    }
}
