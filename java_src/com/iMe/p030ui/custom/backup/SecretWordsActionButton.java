...
public final class SecretWordsActionButton extends TextView {
    ...
    public SecretWordsActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewExtKt.setPaddingHorizontal(this, AndroidUtilities.m107dp(10));
        setGravity(17);
        ...
        setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(4), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
    }
