...
public final class TickerView extends AppCompatTextView {
    ...
    private final void setupView() {
        ...
        gradientDrawable.setStroke(AndroidUtilities.m108dp(1.0f), Theme.getColor(Theme.key_windowBackgroundWhiteGrayText2));
        setBackground(gradientDrawable);
        setTextSize(9.0f);
        setPadding(AndroidUtilities.m108dp(6.0f), AndroidUtilities.m108dp(2.0f), AndroidUtilities.m108dp(6.0f), AndroidUtilities.m108dp(2.0f));
    }
}
