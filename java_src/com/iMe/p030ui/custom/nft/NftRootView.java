package com.iMe.p030ui.custom.nft;
...
public final class NftRootView extends FrameLayout {
    ...
    public final NftType getNftTokenType() {
        return this.nftTokenType;
    }

    public final void setNftTokenType(NftType nftType) {
        this.nftTokenType = nftType;
    }
}
