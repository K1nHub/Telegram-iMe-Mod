...
public final class StakingSafeWithdrawalView extends FrameLayout {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public StakingSafeWithdrawalView(Context context, AttributeSet attributeSet) {
    ...
    private final void setupView() {
        setupColors();
        this.binding.textSafeWithdrawal.setText(LocaleController.getInternalString(C3630R.string.staking_withdraw_safe_withdrawal));
