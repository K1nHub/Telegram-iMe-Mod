...
public final class TitledInputFieldView extends FrameLayout {
    ...
    public final void setupInputLayoutParams(int i, int i2) {
        this.binding.viewInput.setupContainerCustomSize(i, i2);
    }
    ...
    private final void setupView() {
        ...
        ViewExtKt.setMargins$default(inputView, m107dp, 0, m107dp, 0, 10, null);
