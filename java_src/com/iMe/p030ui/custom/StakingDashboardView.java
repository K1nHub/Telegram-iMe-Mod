...
public final class StakingDashboardView extends FrameLayout implements KoinComponent {
    ...
    public final void setupColors() {
        ...
        forkContentStakingDashboardBinding.viewStakedDot.setBackground(Theme.createCircleDrawable(AndroidUtilities.m107dp(6), Theme.getColor(Theme.key_statisticChartLine_blue)));
        forkContentStakingDashboardBinding.viewProfitDot.setBackground(Theme.createCircleDrawable(AndroidUtilities.m107dp(6), Theme.getColor(Theme.key_statisticChartLine_green)));
    ...
    private final void setupViewData(float f, float f2) {
        ...
        if (NumberExtKt.isZero(Float.valueOf(f3))) {
            ...
            for (int i = 0; i < 16; i++) {
                ...
                clearViewData.setStrokeWidth(AndroidUtilities.m108dp(1.5f));
            ...
            if (f2 > BitmapDescriptorFactory.HUE_RED) {
                ...
                clearViewData2.setStrokeWidth(AndroidUtilities.m107dp(3));
            ...
            if (f > BitmapDescriptorFactory.HUE_RED) {
                ...
                clearViewData3.setStrokeWidth(AndroidUtilities.m107dp(3));
    ...
    private final void setupViews() {
        ...
        forkContentStakingDashboardBinding.viewDiagram.setCustomSize(AndroidUtilities.m107dp(75));
