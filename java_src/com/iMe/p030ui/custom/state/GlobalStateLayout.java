...
public final class GlobalStateLayout extends StatefulLayout implements KoinComponent {
    ...
    private final View configureProgressState(View view) {
        RLottieImageView rLottieImageView = (RLottieImageView) view.findViewById(C3630R.C3633id.image_state_animation);
        ...
        AppCompatTextView appCompatTextView = (AppCompatTextView) view.findViewById(C3630R.C3633id.text_state_title);
        ...
        AppCompatTextView appCompatTextView2 = (AppCompatTextView) view.findViewById(C3630R.C3633id.text_state_description);
    ...
    private final View getStateView(final GlobalState globalState) {
        View inflate = LayoutInflater.from(getContext()).inflate(C3630R.layout.fork_content_global_state_layout, (ViewGroup) null);
        RLottieImageView rLottieImageView = (RLottieImageView) inflate.findViewById(C3630R.C3633id.image_state_animation);
        ...
        AppCompatTextView appCompatTextView = (AppCompatTextView) inflate.findViewById(C3630R.C3633id.text_state_title);
        if (appCompatTextView != null) {
            appCompatTextView.setText(getResourceManager().getString(globalState.getTitle()));
        }
        AppCompatTextView appCompatTextView2 = (AppCompatTextView) inflate.findViewById(C3630R.C3633id.text_state_description);
        if (appCompatTextView2 != null) {
            appCompatTextView2.setText(getResourceManager().getString(globalState.getDescription()));
        }
        AppCompatButton getStateView$lambda$5$lambda$4 = (AppCompatButton) inflate.findViewById(C3630R.C3633id.button_retry);
        getStateView$lambda$5$lambda$4.setText(getResourceManager().getString(Intrinsics.areEqual(globalState, GlobalState.Empty.TokenSearchResult.INSTANCE) ? true : Intrinsics.areEqual(globalState, GlobalState.Empty.CustomTokens.INSTANCE) ? C3630R.string.token_search_empty_result_add_token : C3630R.string.common_retry));
    ...
    private final void setupColors(View view) {
        ...
        AppCompatButton appCompatButton = (AppCompatButton) view.findViewById(C3630R.C3633id.button_retry);
    ...
    private final void startAnimation(String str) {
        ...
        if (Intrinsics.areEqual(str, GlobalState.Content.INSTANCE.getState()) || (stateView = getStateView(str)) == null || (rLottieImageView = (RLottieImageView) stateView.findViewById(C3630R.C3633id.image_state_animation)) == null) {
            return;
        }
