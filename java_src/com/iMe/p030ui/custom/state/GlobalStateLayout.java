...
public final class GlobalStateLayout extends StatefulLayout implements KoinComponent {
    ...
    private final View configureProgressState(View view) {
        RLottieImageView rLottieImageView = (RLottieImageView) view.findViewById(C3632R.C3635id.image_state_animation);
        ...
        AppCompatTextView appCompatTextView = (AppCompatTextView) view.findViewById(C3632R.C3635id.text_state_title);
        ...
        AppCompatTextView appCompatTextView2 = (AppCompatTextView) view.findViewById(C3632R.C3635id.text_state_description);
    ...
    private final View getStateView(final GlobalState globalState) {
        View inflate = LayoutInflater.from(getContext()).inflate(C3632R.layout.fork_content_global_state_layout, (ViewGroup) null);
        RLottieImageView rLottieImageView = (RLottieImageView) inflate.findViewById(C3632R.C3635id.image_state_animation);
        ...
        AppCompatTextView appCompatTextView = (AppCompatTextView) inflate.findViewById(C3632R.C3635id.text_state_title);
        if (appCompatTextView != null) {
            appCompatTextView.setText(getResourceManager().getString(globalState.getTitle()));
        }
        AppCompatTextView appCompatTextView2 = (AppCompatTextView) inflate.findViewById(C3632R.C3635id.text_state_description);
        if (appCompatTextView2 != null) {
            appCompatTextView2.setText(getResourceManager().getString(globalState.getDescription()));
        }
        AppCompatButton getStateView$lambda$5$lambda$4 = (AppCompatButton) inflate.findViewById(C3632R.C3635id.button_retry);
        getStateView$lambda$5$lambda$4.setText(getResourceManager().getString(Intrinsics.areEqual(globalState, GlobalState.Empty.TokenSearchResult.INSTANCE) ? true : Intrinsics.areEqual(globalState, GlobalState.Empty.CustomTokens.INSTANCE) ? C3632R.string.token_search_empty_result_add_token : C3632R.string.common_retry));
    ...
    private final void setupColors(View view) {
        ...
        AppCompatButton appCompatButton = (AppCompatButton) view.findViewById(C3632R.C3635id.button_retry);
    ...
    private final void startAnimation(String str) {
        ...
        if (Intrinsics.areEqual(str, GlobalState.Content.INSTANCE.getState()) || (stateView = getStateView(str)) == null || (rLottieImageView = (RLottieImageView) stateView.findViewById(C3632R.C3635id.image_state_animation)) == null) {
            return;
        }
