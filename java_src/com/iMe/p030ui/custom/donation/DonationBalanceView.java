...
public final class DonationBalanceView extends FrameLayout {
    ...
    public final void setBalance(TokenBalance balance) {
        ...
        forkRecycleItemWalletTokenBalanceBinding.textTitle.setText(TokenBalanceExtKt.getTotalBalance(balance));
        AppCompatImageView imageLogo = forkRecycleItemWalletTokenBalanceBinding.imageLogo;
        Intrinsics.checkNotNullExpressionValue(imageLogo, "imageLogo");
        ImageViewExtKt.loadFrom$default(imageLogo, balance.getToken().getAvatarUrl(), null, false, 6, null);
        forkRecycleItemWalletTokenBalanceBinding.textSubtitle.setText(balance.getToken().getName());
    ...
    public final void setupColors() {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new AppCompatTextView[]{forkRecycleItemWalletTokenBalanceBinding.textSubtitle, forkRecycleItemWalletTokenBalanceBinding.textAccountBalanceInDollars});
        ...
        forkRecycleItemWalletTokenBalanceBinding.textSubtitle.setTextColor(Theme.getColor(Theme.key_chats_actionBackground));
        forkRecycleItemWalletTokenBalanceBinding.textSubtitle.setTextColor(Theme.getColor(Theme.key_chat_messagePanelText));
