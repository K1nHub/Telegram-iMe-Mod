...
public abstract class MvpBottomSheet extends BottomSheet implements MvpDelegateHolder, KoinComponent, BaseView {
    ...
    public MvpBottomSheet(Context context, boolean z) {
        ...
        this.mvpBaseDelegate = new MvpBaseDelegate<MvpBottomSheet>() { // from class: com.iMe.ui.base.mvp.MvpBottomSheet$mvpBaseDelegate$1
            ...
            {
                Lazy lazy;
                lazy = LazyKt__LazyJVMKt.lazy(new Function0<Context>() { // from class: com.iMe.ui.base.mvp.MvpBottomSheet$mvpBaseDelegate$1$context$2
                    /* JADX INFO: Access modifiers changed from: package-private */
                    {
                        super(0);
                    }
                    ...
                    public final Context invoke() {
                        Context context2 = MvpBottomSheet.this.getContext();
                        Intrinsics.checkNotNullExpressionValue(context2, "this@MvpBottomSheet.context");
                        return context2;
                    }
                });
