...
public final class PopupOptionsAdapter extends ArrayAdapter<String> {
    ...
    public PopupOptionsAdapter(Context mContext, List<String> options) {
        super(mContext, C3630R.layout.fork_item_adapter_popup_option, options);
    ...
    public static final class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            this.view = view;
            View findViewById = view.findViewById(C3630R.C3633id.text_title);
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(this.mContext).inflate(C3630R.layout.fork_item_adapter_popup_option, (ViewGroup) null, true);
