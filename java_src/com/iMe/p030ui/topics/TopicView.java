...
public class TopicView extends FrameLayout {
    ...
    public final void setTopic(TopicModel topic, boolean z) {
        ...
        if (topic.getTopicId() == -2) {
            ...
            String internalString = LocaleController.getInternalString(C3630R.string.topics_title_notopic);
            ...
            getNameTextView().setText(Emoji.replaceEmoji(topic.getName(), getNameTextView().getPaint().getFontMetricsInt(), AndroidUtilities.m102dp(15), false));
    ...
    public final void setArchive(boolean z, boolean z2) {
        ...
        TextView nameTextView = getNameTextView();
        if (z) {
            i = C3630R.string.folder_fab_settings_fab_archive;
        } else {
            i = C3630R.string.main_list;
        }
        ...
        ImageView iconView = getIconView();
        if (z) {
            i2 = C3630R.C3632drawable.fork_custom_forward_switch_archive;
        } else {
            i2 = C3630R.C3632drawable.fork_custom_forward_switch_main;
        }
    ...
    public final void setMessagesContextMenu(boolean z, boolean z2) {
        int i;
        this.isActive = z2;
        String title = z ? LocaleController.getInternalString(C3630R.string.settings_interface_message_header) : LocaleController.getString(C3630R.string.MediaTab);
        TextView nameTextView = getNameTextView();
        ...
        ImageView iconView = getIconView();
        if (z) {
            i = C3630R.C3632drawable.fork_settings_chat;
        } else {
            i = C3630R.C3632drawable.fork_cloud_filter_image;
        }
    ...
    public final void updateColors() {
        ...
        Drawable createRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m102dp(24), this.isActive ? Theme.getColor(Theme.key_chats_actionBackground) : Theme.getColor(Theme.key_chats_unreadCounterMuted));
    ...
    private final void init() {
        ...
        getOvalLayout().setPadding(AndroidUtilities.m102dp(10), 0, AndroidUtilities.m102dp(14), 0);
        LinearLayout ovalLayout = getOvalLayout();
        ImageView iconView = getIconView();
        int i = this.iconSize;
