...
public class TopicView extends FrameLayout {
    ...
    public final void setTopic(TopicModel topic, boolean z) {
        ...
        if (topic.getTopicId() == -2) {
            ...
            getNameTextView().setText(Emoji.replaceEmoji((CharSequence) topic.getName(), getNameTextView().getPaint().getFontMetricsInt(), AndroidUtilities.m104dp(15), false));
    ...
    public final void updateColors() {
        ...
        Drawable createRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m104dp(24), this.isActive ? Theme.getColor(Theme.key_chats_actionBackground) : Theme.getColor(Theme.key_chats_unreadCounterMuted));
    ...
    private final void init() {
        ...
        getOvalLayout().setPadding(AndroidUtilities.m104dp(10), 0, AndroidUtilities.m104dp(14), 0);
        LinearLayout ovalLayout = getOvalLayout();
        ImageView iconView = getIconView();
        int i = this.iconSize;
