    ...
    */
    public boolean drawChild(android.graphics.Canvas r7, android.view.View r8, long r9) {
        ...
        L8c:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p030ui.topics.TopicsBar.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                ...
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(context2) { // from class: com.iMe.ui.topics.TopicsBar$initListView$1$1$smoothScrollToPosition$linearSmoothScroller$1
                    ...
                    protected void onTargetFound(View targetView, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                        ...
                        if (calculateDxToMakeVisible > 0 || (calculateDxToMakeVisible == 0 && targetView.getLeft() - AndroidUtilities.m107dp(21) < 0)) {
                            calculateDxToMakeVisible += AndroidUtilities.m107dp(60);
                        } else if (calculateDxToMakeVisible < 0 || targetView.getRight() + AndroidUtilities.m107dp(21) > RecyclerListView.this.getMeasuredWidth()) {
                            calculateDxToMakeVisible -= AndroidUtilities.m107dp(60);
                        }
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    if (!(topic != null && topic.getTopicId() == -2)) {
                        ...
                        if (!(f == BitmapDescriptorFactory.HUE_RED)) {
                            ...
                            canvas.translate(AndroidUtilities.m108dp(0.66f) * f3, BitmapDescriptorFactory.HUE_RED);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            topicView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m107dp(4), Theme.getColor(Theme.key_windowBackgroundWhite)));
        }
    }
}
