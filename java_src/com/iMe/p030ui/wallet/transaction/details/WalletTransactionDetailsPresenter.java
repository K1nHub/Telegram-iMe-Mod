...
public final class WalletTransactionDetailsPresenter extends BasePresenter<WalletTransactionDetailsView> {
    ...
    private final List<Pair<TransactionActionItem, Function0<Unit>>> resolveTransactionAction() {
        ...
        if (canAskSupport()) {
            arrayList.add(TuplesKt.m149to(TransactionActionItem.Support.INSTANCE, new Function0<Unit>() { // from class: com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsPresenter$resolveTransactionAction$1$1
        ...
        if (canOpenProfile()) {
            arrayList.add(TuplesKt.m149to(TransactionActionItem.Profile.INSTANCE, new Function0<Unit>() { // from class: com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsPresenter$resolveTransactionAction$1$2
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
        ...
        if (canCopy()) {
            arrayList.add(TuplesKt.m149to(new TransactionActionItem.Copy(getCopyTitle()), new Function0<Unit>() { // from class: com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsPresenter$resolveTransactionAction$1$4
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
        ...
        if (canCancelOrBoost()) {
            arrayList.add(TuplesKt.m149to(TransactionActionItem.Cancel.INSTANCE, new Function0<Unit>() { // from class: com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsPresenter$resolveTransactionAction$1$5
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
        ...
        if (canCancelOrBoost()) {
            arrayList.add(TuplesKt.m149to(TransactionActionItem.Boost.INSTANCE, new Function0<Unit>() { // from class: com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsPresenter$resolveTransactionAction$1$6
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
    ...
    public final void cancelTransaction(final String str) {
        ...
        if (walletTransactionDetailsScreenType instanceof WalletTransactionDetailsScreenType.TransactionDetails) {
            Observable<Result<String>> observeOn = this.cancelInteractor.cancelEthTransaction(((WalletTransactionDetailsScreenType.TransactionDetails) walletTransactionDetailsScreenType).getItem().getTransaction().getToken().getTicker(), str).observeOn(this.schedulersProvider.mo1013ui());
            ...
            Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends String>, Unit>() { // from class: com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsPresenter$cancelTransaction$$inlined$subscribeWithErrorHandle$default$1
                ...
                public final void m1867invoke(Result<? extends String> it) {
    ...
    public final void boostTransaction(final String str) {
        Observable<Result<String>> observeOn = this.boostInteractor.boostEthTransaction(str).observeOn(this.schedulersProvider.mo1013ui());
