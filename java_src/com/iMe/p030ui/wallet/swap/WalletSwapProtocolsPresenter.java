...
public final class WalletSwapProtocolsPresenter extends BasePresenter<WalletSwapProtocolsView> {
    ...
    public final void startSwapScreenFlow(SwapProtocolInfo swapProtocolInfo, TokenDetailed tokenDetailed) {
        ...
        if (tokenDetailed != null) {
            ...
            str = str;
            if (str == null) {
                str = (String) CollectionsKt.firstOrNull((List<? extends Object>) supportedNetworksIds);
            }
        }
    ...
    private final void loadExchanges() {
        ...
        spreadBuilder.add(new HeaderItem(this.resourceManager.getString(C3632R.string.wallet_swap_protocols_header_title)));
        spreadBuilder.addSpread(dexProtocolItemArr);
        spreadBuilder.add(new HeaderItem(this.resourceManager.getString(C3632R.string.wallet_swap_protocols_cross_chain_header_title)));
        spreadBuilder.addSpread(dexProtocolItemArr2);
        spreadBuilder.add(new HeaderItem(this.resourceManager.getString(C3632R.string.wallet_swap_centralized_exchanges_header_title)));
