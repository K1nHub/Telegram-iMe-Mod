...
public final class WalletSwapProcessPresenter extends BasePresenter<WalletSwapProcessView> {
    ...
    public static final void loadAvailableOppositeSwapTokensBinance$lambda$23() {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void loadAvailableSwapTokensBinance$lambda$19() {
    }
    ...
    public final void onMaxClick() {
        Double valueOf;
        BinanceTokenBalanceInfo.Balance spot;
        ...
        if (walletSwapScreenType instanceof WalletSwapScreenType.Binance) {
            ...
            if (binanceTokenBalanceInfo != null && (spot = binanceTokenBalanceInfo.getSpot()) != null) {
                valueOf = Double.valueOf(spot.getTotal());
            }
            valueOf = null;
            ...
            if (tokenBalance != null) {
                valueOf = Double.valueOf(tokenBalance.getTotal());
            }
            valueOf = null;
        }
        String plainString = NumberExtKt.orZero(valueOf != null ? new BigDecimal(String.valueOf(valueOf.doubleValue())) : null).toPlainString();
        Intrinsics.checkNotNullExpressionValue(plainString, "when (screenType) {\n    ….orZero().toPlainString()");
        ((WalletSwapProcessView) getViewState()).setAmount(SwapSide.INPUT, StringExtKt.stripZeros$default(plainString, (char) 0, 1, null));
    }
    ...
    public final void approve() {
        ...
        if (isValidForApprove() && (resolveApproveArgs = resolveApproveArgs()) != null) {
            Observable<Result<String>> observeOn = this.swapInteractor.approveToken(resolveApproveArgs).observeOn(this.schedulersProvider.mo1009ui());
            ...
            Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends String>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$approve$$inlined$subscribeWithErrorHandle$default$1
                ...
                public final void m1840invoke(Result<? extends String> it) {
    ...
    public final void onApprovalInfoClick() {
        ((WalletSwapProcessView) getViewState()).showApprovalInfoDialog(this.resourceManager.getString(C3630R.string.wallet_swap_process_what_is_approve), this.resourceManager.getString(C3630R.string.wallet_swap_process_what_is_approve_dialog_description));
    }

    public final void onApproveClick() {
        WalletSwapProcessView walletSwapProcessView = (WalletSwapProcessView) getViewState();
        String string = this.resourceManager.getString(C3630R.string.wallet_swap_process_confirm_approve_alert_title);
        ResourceManager resourceManager = this.resourceManager;
        int i = C3630R.string.wallet_swap_process_confirm_approve_alert_description;
        ...
        objArr[0] = ticker;
        walletSwapProcessView.showApprovalConfirmationDialog(new DialogModel(string, resourceManager.getString(i, objArr), this.resourceManager.getString(C3630R.string.common_cancel), this.resourceManager.getString(C3630R.string.wallet_swap_process_confirm_approve_alert_action)));
    }
        ...
        if (walletSwapScreenType instanceof WalletSwapScreenType.Binance) {
            ...
            if (i == 1) {
                ...
                if (this.inputToken == null) {
                    ((WalletSwapProcessView) getViewState()).showToast(this.resourceManager.getString(C3630R.string.wallet_swap_process_give_token_validation));
                    return;
                }
            ...
            if (i3 == 1) {
                ...
                transactionDirection = TransactionDirection.f392IN;
            }
    ...
    private final void setupSwapInformation() {
        WalletSwapScreenType walletSwapScreenType = this.screenType;
        if (walletSwapScreenType instanceof WalletSwapScreenType.Binance) {
            ((WalletSwapProcessView) getViewState()).setupScreenForSwap(this.resourceManager.getString(C3630R.string.binance_convert_toolbar_title), this.resourceManager.getString(C3630R.string.binance_convert_description), C3630R.C3632drawable.fork_ic_bnb_logo, false, true);
        } else if (walletSwapScreenType instanceof WalletSwapScreenType.Crypto) {
    ...
    private final Pair<Boolean, Boolean> getNetworkSwitchState() {
        return TuplesKt.m144to(Boolean.valueOf(this.swapProtocol.isCrossChain()), Boolean.valueOf(this.swapProtocol != SwapProtocol.UNKNOWN));
    }
    ...
    private final void swapCrypto() {
        ...
        Observable<Result<String>> observeOn = this.swapInteractor.swap(resolveSwapArgs).observeOn(this.schedulersProvider.mo1009ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "swapInteractor\n         …(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Observable withLoadingDialog$default = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null);
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends String>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$swapCrypto$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1848invoke(Result<? extends String> it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
                Result<? extends String> result = it;
                if (result instanceof Result.Success) {
    ...
    private final void swapBinance() {
        ...
        Observable<Result<Boolean>> observeOn = binanceInternalInteractor.confirmConvertQuote(quoteId).observeOn(this.schedulersProvider.mo1009ui());
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$swapBinance$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1847invoke(Result<? extends Boolean> it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    private final void loadBalanceBinance(final TokenDetailed tokenDetailed) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends List<? extends BinanceTokenBalanceInfo>>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$loadBalanceBinance$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1844invoke(Result<? extends List<? extends BinanceTokenBalanceInfo>> it) {
                ...
                BinanceTokenBalanceInfo binanceTokenBalanceInfo = null;
                if (result instanceof Result.Success) {
                    WalletSwapProcessPresenter walletSwapProcessPresenter = WalletSwapProcessPresenter.this;
                    ...
                    while (true) {
                        ...
                        obj = it2.next();
                        if (Intrinsics.areEqual(((BinanceTokenBalanceInfo) obj).getAssetCode(), tokenDetailed.getTicker())) {
                            break;
                        }
                    }
                    BinanceTokenBalanceInfo binanceTokenBalanceInfo2 = (BinanceTokenBalanceInfo) obj;
                    if (binanceTokenBalanceInfo2 != null) {
                        ...
                        ((WalletSwapProcessView) WalletSwapProcessPresenter.this.getViewState()).showTokenBalance(formatBinanceBalance2, resourceManager2.getString(C3630R.string.common_max));
                    ...
                    formatBinanceBalance = WalletSwapProcessPresenter.this.formatBinanceBalance(null);
    ...
    private final void loadBalanceCrypto(TokenDetailed tokenDetailed) {
        Observable observeOn = WalletInteractor.getTokenBalance$default(this.walletInteractor, TokenExtKt.toIndexedToken(tokenDetailed), false, getNetworkIdBySwapSide$default(this, null, 1, null), 2, null).observeOn(this.schedulersProvider.mo1009ui());
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends TokenBalance>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$loadBalanceCrypto$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1845invoke(Result<? extends TokenBalance> it) {
                ResourceManager resourceManager;
                ResourceManager resourceManager2;
                ...
                if (result instanceof Result.Success) {
                    ...
                    String string = resourceManager3.getString(C3630R.string.wallet_swap_process_max);
                    ...
                    resourceManager2 = WalletSwapProcessPresenter.this.resourceManager;
                    ((WalletSwapProcessView) WalletSwapProcessPresenter.this.getViewState()).showTokenBalance(resourceManager2.getString(C3630R.string.common_progress_state_title), "");
                } else if (result instanceof Result.Error) {
                    resourceManager = WalletSwapProcessPresenter.this.resourceManager;
                    ((WalletSwapProcessView) WalletSwapProcessPresenter.this.getViewState()).showErrorToast((Result.Error) result, resourceManager);
                }
    ...
    static /* synthetic */ void loadAvailableSwapTokensBinance$default(WalletSwapProcessPresenter walletSwapProcessPresenter, boolean z, Callbacks$Callback callbacks$Callback, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            callbacks$Callback = new Callbacks$Callback() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda5
                @Override // com.iMe.fork.utils.Callbacks$Callback
                public final void invoke() {
                    WalletSwapProcessPresenter.loadAvailableSwapTokensBinance$lambda$19();
                }
            };
        }
    ...
    private final void loadAvailableSwapTokensBinance(final boolean z, final Callbacks$Callback callbacks$Callback) {
        if (this.screenType instanceof WalletSwapScreenType.Binance) {
            Observable<Result<List<BinanceTokenInfo>>> observeOn = this.binanceInternalInteractor.getTokensForConvert().observeOn(this.schedulersProvider.mo1009ui());
            ...
            Observable<R> compose = observeOn.compose(new ObservableTransformer() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda6
                ...
                public final ObservableSource apply(Observable observable) {
                    ObservableSource loadAvailableSwapTokensBinance$lambda$20;
                    loadAvailableSwapTokensBinance$lambda$20 = WalletSwapProcessPresenter.loadAvailableSwapTokensBinance$lambda$20(Function1.this, observable);
                    return loadAvailableSwapTokensBinance$lambda$20;
                }
            });
            ...
            Disposable subscribe = compose.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends List<? extends BinanceTokenInfo>>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$loadAvailableSwapTokensBinance$$inlined$subscribeWithErrorHandle$default$1
                ...
                /* renamed from: invoke  reason: collision with other method in class */
                public final void m1843invoke(Result<? extends List<? extends BinanceTokenInfo>> it) {
                    ResourceManager resourceManager;
                    HashMap hashMap;
                    int collectionSizeOrDefault;
                    List mutableList;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ObservableSource loadAvailableSwapTokensBinance$lambda$20(Function1 tmp0, Observable p0) {
    ...
    static /* synthetic */ void loadAvailableOppositeSwapTokensBinance$default(WalletSwapProcessPresenter walletSwapProcessPresenter, String str, boolean z, Callbacks$Callback callbacks$Callback, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            callbacks$Callback = new Callbacks$Callback() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda4
                @Override // com.iMe.fork.utils.Callbacks$Callback
                public final void invoke() {
                    WalletSwapProcessPresenter.loadAvailableOppositeSwapTokensBinance$lambda$23();
                }
            };
        }
    ...
    private final void loadAvailableOppositeSwapTokensBinance(final String str, final boolean z, final Callbacks$Callback callbacks$Callback) {
        if (this.screenType instanceof WalletSwapScreenType.Binance) {
            Observable<Result<List<OutputConvertToken>>> observeOn = this.binanceInternalInteractor.getOppositeTokensForConvertByToken(str).observeOn(this.schedulersProvider.mo1009ui());
            ...
            Observable<R> compose = observeOn.compose(new ObservableTransformer() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda7
                @Override // io.reactivex.ObservableTransformer
                public final ObservableSource apply(Observable observable) {
                    ObservableSource loadAvailableOppositeSwapTokensBinance$lambda$24;
                    loadAvailableOppositeSwapTokensBinance$lambda$24 = WalletSwapProcessPresenter.loadAvailableOppositeSwapTokensBinance$lambda$24(Function1.this, observable);
                    return loadAvailableOppositeSwapTokensBinance$lambda$24;
                }
            });
            Intrinsics.checkNotNullExpressionValue(compose, "private fun loadAvailabl…     .autoDispose()\n    }");
            final BaseView baseView = (BaseView) getViewState();
            Disposable subscribe = compose.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends List<? extends OutputConvertToken>>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$loadAvailableOppositeSwapTokensBinance$$inlined$subscribeWithErrorHandle$default$1
                ...
                /* renamed from: invoke  reason: collision with other method in class */
                public final void m1842invoke(Result<? extends List<? extends OutputConvertToken>> it) {
                    ResourceManager resourceManager;
                    Intrinsics.checkNotNullExpressionValue(it, "it");
                    Result<? extends List<? extends OutputConvertToken>> result = it;
                    if (result instanceof Result.Success) {
                        WalletSwapProcessPresenter.this.binanceAvailableOppositeSwapTokens = TuplesKt.m144to(str, ((Result.Success) result).getData());
                        callbacks$Callback.invoke();
                    } else if (result instanceof Result.Error) {
                        resourceManager = WalletSwapProcessPresenter.this.resourceManager;
                        ((WalletSwapProcessView) WalletSwapProcessPresenter.this.getViewState()).showErrorToast((Result.Error) result, resourceManager);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ObservableSource loadAvailableOppositeSwapTokensBinance$lambda$24(Function1 tmp0, Observable p0) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        Intrinsics.checkNotNullParameter(p0, "p0");
        return (ObservableSource) tmp0.invoke(p0);
    }
        ...
        if (this.screenType instanceof WalletSwapScreenType.Crypto) {
            ...
            Observable observeOn = just.flatMap(new Function() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda8
                ...
                public final Object apply(Object obj) {
                    ObservableSource loadApproveTokensInfo$lambda$28;
                    loadApproveTokensInfo$lambda$28 = WalletSwapProcessPresenter.loadApproveTokensInfo$lambda$28(Function1.this, obj);
                    return loadApproveTokensInfo$lambda$28;
                }
            ...
            Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends List<? extends TokenApproveData>>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$loadApproveTokensInfo$$inlined$subscribeWithErrorHandle$default$1
                ...
                /* renamed from: invoke  reason: collision with other method in class */
                public final void m1841invoke(Result<? extends List<? extends TokenApproveData>> it) {
                    HashMap hashMap;
                    List mutableList;
                    HashMap hashMap2;
                    HashMap hashMap3;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ObservableSource loadApproveTokensInfo$lambda$28(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
    ...
    public final void handleSwapErrors(Result.Error<?> error) {
        ...
        if (status == FirebaseFunctionsErrorHandler.CryptoErrorStatus.SWAP_APPROVED_AMOUNT_NOT_SUFFICIENT) {
            ...
            WalletSwapScreenType walletSwapScreenType = this.screenType;
            if (walletSwapScreenType instanceof WalletSwapScreenType.Binance) {
                ((WalletSwapProcessView) getViewState()).showNotEnoughMoneyErrorDialog(new TokenBuyCoordinatorArgs(null, null, null, null, 8, null));
            } else if (walletSwapScreenType instanceof WalletSwapScreenType.Crypto) {
                TokenDetailed tokenDetailed = this.inputToken;
                Intrinsics.checkNotNull(tokenDetailed);
                ((WalletSwapProcessView) getViewState()).showNotEnoughMoneyErrorDialog(new TokenBuyCoordinatorArgs(tokenDetailed, null, this.swapProtocol, null, 10, null));
            }
        } else {
            ...
            if (status == FirebaseFunctionsErrorHandler.CryptoErrorStatus.SWAP_DIFF_BTW_TOKEN_EXCHANGE_RATES_IS_TOO_BIG || status == FirebaseFunctionsErrorHandler.CryptoErrorStatus.SWAP_QUOTE_NOT_FOUND) {
                ...
                ((WalletSwapProcessView) getViewState()).setInputError(this.resourceManager.getString(C3630R.string.wallet_swap_process_low_amount));
    ...
    public final boolean isAvailableBalanceLessThanAmount(double d) {
        ...
        if (walletSwapScreenType instanceof WalletSwapScreenType.Binance) {
            BinanceTokenBalanceInfo binanceTokenBalanceInfo = this.binanceTokenBalance;
            if (binanceTokenBalanceInfo != null && (spot = binanceTokenBalanceInfo.getSpot()) != null) {
                r2 = Double.valueOf(spot.getTotal());
            }
            orZero = NumberExtKt.orZero(r2);
        } else if (!(walletSwapScreenType instanceof WalletSwapScreenType.Crypto)) {
            throw new NoWhenBranchMatchedException();
        } else {
            TokenBalance tokenBalance = this.tokenBalance;
            orZero = NumberExtKt.orZero(tokenBalance != null ? Double.valueOf(tokenBalance.getTotal()) : null);
        }
        return orZero < d;
    }
    ...
    */
    private final com.iMe.model.dialog.DialogModel getSwapConfirmationDialogModel() {
        /*
            ...
            int r1 = org.telegram.messenger.C3630R.string.wallet_swap_process_confirm_swap_alert_title
            ...
            int r8 = org.telegram.messenger.C3630R.string.wallet_swap_process_confirm_binance_swap_alert_description
        ...
        L66:
            ...
            if (r1 == 0) goto Lf2
            com.iMe.storage.domain.utils.system.ResourceManager r2 = r13.resourceManager
            int r9 = org.telegram.messenger.C3630R.string.wallet_swap_process_confirm_swap_alert_description
            r10 = 6
        ...
        Lf4:
            ...
            int r2 = org.telegram.messenger.C3630R.string.common_cancel
            java.lang.String r1 = r1.getString(r2)
            com.iMe.storage.domain.utils.system.ResourceManager r2 = r13.resourceManager
            int r3 = org.telegram.messenger.C3630R.string.wallet_swap_process_confirm_swap_alert_action
        ...
        L10a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p030ui.wallet.swap.process.WalletSwapProcessPresenter.getSwapConfirmationDialogModel():com.iMe.model.dialog.DialogModel");
    }
    ...
    public final String formatBinanceBalance(BinanceTokenBalanceInfo binanceTokenBalanceInfo) {
        if (binanceTokenBalanceInfo != null) {
            ResourceManager resourceManager = this.resourceManager;
            int i = C3630R.string.binance_convert_balance;
            return resourceManager.getString(i, BinanceTokenBalanceExtKt.getSpotBalanceShortText(binanceTokenBalanceInfo) + " (" + this.resourceManager.getString(C3630R.string.common_max) + ')', BinanceTokenBalanceExtKt.getMarginBalanceShortText(binanceTokenBalanceInfo));
        }
        String string = this.resourceManager.getString(C3630R.string.common_progress_state_title);
        return this.resourceManager.getString(C3630R.string.binance_convert_balance, string, string);
    }
    ...
    private final void subscribeToAmountSubject() {
        Observable<String> observeOn = this.amountSubject.observeOn(this.schedulersProvider.mo1009ui());
        ...
        Observable<String> observeOn2 = observeOn.filter(new Predicate() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda10
        ...
        }).observeOn(this.schedulersProvider.mo1010io()).debounce(300L, TimeUnit.MILLISECONDS).observeOn(this.schedulersProvider.mo1009ui());
            ...
            public final Boolean invoke(String amountText) {
                ...
                if (!(inputTokenApprovalData instanceof TokenApproveData.Allowed)) {
                    ...
                    if (swapUiState.isApproving()) {
                        ...
                        if (isAvailableBalanceLessThanAmount2) {
                            ...
                            walletSwapProcessPresenter2.setInputError(resourceManager2.getString(C3630R.string.wallet_swap_process_insufficient_funds));
                        }
                        z = false;
                        return Boolean.valueOf(z);
                    }
                ...
                if (tokenDetailed == null) {
                    ...
                    if (isAvailableBalanceLessThanAmount) {
                        ...
                        walletSwapProcessPresenter3.setInputError(resourceManager.getString(C3630R.string.wallet_swap_process_insufficient_funds));
                    } else {
        ...
        Observable<String> observeOn3 = observeOn2.filter(new Predicate() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda11
            @Override // io.reactivex.functions.Predicate
            public final boolean test(Object obj) {
                boolean subscribeToAmountSubject$lambda$39;
        ...
        Observable observeOn4 = observeOn3.switchMap(new Function() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda9
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                ObservableSource subscribeToAmountSubject$lambda$40;
                subscribeToAmountSubject$lambda$40 = WalletSwapProcessPresenter.subscribeToAmountSubject$lambda$40(Function1.this, obj);
                return subscribeToAmountSubject$lambda$40;
            }
        }).observeOn(this.schedulersProvider.mo1009ui());
        ...
        Disposable subscribe = observeOn4.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends SwapUiState.Swap>, Unit>() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$subscribeToAmountSubject$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1846invoke(Result<? extends SwapUiState.Swap> it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean subscribeToAmountSubject$lambda$39(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return ((Boolean) tmp0.invoke(obj)).booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final ObservableSource subscribeToAmountSubject$lambda$40(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return (ObservableSource) tmp0.invoke(obj);
    }
