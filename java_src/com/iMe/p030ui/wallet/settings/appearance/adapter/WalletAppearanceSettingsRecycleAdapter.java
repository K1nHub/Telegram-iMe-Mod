...
public final class WalletAppearanceSettingsRecycleAdapter extends BaseQuickAdapter<InterfaceSettingItem, BaseViewHolder> {
    ...
    public WalletAppearanceSettingsRecycleAdapter(ResourceManager resourceManager) {
        super(C3630R.layout.fork_recycle_item_wallet_appearance_settings, null, 2, null);
    ...
    public void convert(BaseViewHolder holder, final InterfaceSettingItem item) {
        ...
        int i2 = C3630R.C3633id.text_setting_description;
        ...
        int i3 = C3630R.C3633id.text_setting_title;
        ...
        int i4 = C3630R.C3633id.image_icon;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setThemedImageColor(themedTextColor2, i4, Theme.key_windowBackgroundWhiteGrayIcon).setImageResource(i4, item.getIcon()), C3630R.C3633id.view_divider, !RecycleViewExtKt.isLastItem(holder, this)).setText(i3, this.resourceManager.getString(item.getTitle())).setText(i2, this.resourceManager.getString(item.getDescription())), C3630R.C3633id.view_switch, new Function1<Switch, Unit>() { // from class: com.iMe.ui.wallet.settings.appearance.adapter.WalletAppearanceSettingsRecycleAdapter$convert$1
    ...
    public void setOnItemClick(View v, int i) {
        ...
        Switch r0 = (Switch) v.findViewById(C3630R.C3633id.view_switch);
