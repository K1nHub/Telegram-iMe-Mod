...
public final class TonFragmentPremiumRecycleAdapter extends BaseNodeAdapter<BaseNode> {
    ...
    protected int getItemType(List<? extends BaseNode> data, int i) {
        ...
        return baseNode instanceof TonFragmentItem.C1533Premium ? IdFabric$ViewTypes.TON_FRAGMENT_PREMIUM : baseNode instanceof GlobalStateItem ? IdFabric$ViewTypes.GLOBAL_STATE : IdFabric$ViewTypes.TON_FRAGMENT_PREMIUM;
    }
}
