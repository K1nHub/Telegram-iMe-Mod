            ...
            if (checkEditTexts2) {
                ...
                for (Object obj : list) {
                    ...
                    if (!Intrinsics.areEqual(((CreateWalletScreenType.WordsCheck) createWalletScreenType2).getSecretWords().get(intValue), ((CreateWalletFragment.NumericEditText) createWalletFragment2.editTexts.get(i)).getText().toString())) {
                        ...
                        String string = resourceManager.getString(C3632R.string.wallet_backup_test_time_alert_title);
                        resourceManager2 = createWalletFragment2.getResourceManager();
                        String string2 = resourceManager2.getString(C3632R.string.wallet_backup_test_time_alert_text);
                        resourceManager3 = createWalletFragment2.getResourceManager();
                        String string3 = resourceManager3.getString(C3632R.string.wallet_backup_test_time_alert_button_see);
                        resourceManager4 = createWalletFragment2.getResourceManager();
                        createWalletFragment2.showAlertDialog(new DialogModel(string, string2, string3, resourceManager4.getString(C3632R.string.wallet_backup_test_time_alert_button_try)), new Callbacks$Callback() { // from class: com.iMe.ui.wallet.crypto.create.CreateWalletFragment$createActionButton$1$1$$ExternalSyntheticLambda1
