...
public final class WalletConnectSessionsRecycleAdapter extends BaseQuickAdapter<WalletConnectSessionItem, BaseViewHolder> {
    public WalletConnectSessionsRecycleAdapter() {
        super(C3634R.layout.fork_recycle_item_wallet_connect_session, null, 2, null);
    }
    ...
    public void convert(BaseViewHolder holder, WalletConnectSessionItem item) {
        ...
        BaseViewHolder rippleForeground = BaseQuickAdapterExtKt.setRippleForeground(holder, C3634R.C3637id.constraint_root, false);
        int i = Theme.key_windowBackgroundWhiteBlackText;
        int i2 = C3634R.C3637id.text_peer_name;
        int i3 = C3634R.C3637id.text_peer_url;
        BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(rippleForeground, i, i2, i3), i2).setText(i2, item.getPeerName()).setText(i3, item.getPeerUrl()), C3634R.C3637id.image_peer_icon, item.getPeerIconUrl(), Integer.valueOf(C3634R.C3636drawable.fork_ic_internal_logo), false, 8, null);
    }
}
