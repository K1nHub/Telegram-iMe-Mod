...
public final class WalletConnectSessionDetailsPresenter extends BasePresenter<WalletConnectSessionDetailsView> {
    ...
    public final DialogModel getDisconnectConfirmationDialogModel() {
        return new DialogModel(LocaleController.getString("AreYouSureSessionTitle", C3630R.string.AreYouSureSessionTitle), LocaleController.getString("TerminateSessionText", C3630R.string.TerminateSessionText), LocaleController.getString("Cancel", C3630R.string.Cancel), LocaleController.getString("Terminate", C3630R.string.Terminate));
    }
