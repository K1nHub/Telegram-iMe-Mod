    ...
    */
    public WalletConnectSessionDetailsBottomSheetDialog(final com.iMe.model.wallet.crypto.wallet_connect.WalletConnectSessionItem r5, final org.telegram.p043ui.ActionBar.BaseFragment r6, kotlin.jvm.functions.Function0<kotlin.Unit> r7) {
        /*
            ...
            r2.<init>()
            java.lang.Class<com.iMe.ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsPresenter> r3 = com.iMe.p030ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p030ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsBottomSheetDialog.<init>(com.iMe.model.wallet.crypto.wallet_connect.WalletConnectSessionItem, org.telegram.ui.ActionBar.BaseFragment, kotlin.jvm.functions.Function0):void");
    }
    ...
    public void setupScreenWithData(String iconUrl, String name, String url, String connectedDate, String address, String network) {
        ...
        binding.viewConnectedCell.setupViewData(getResourceManager().getString(C3632R.string.wallet_connect_session_details_connected), connectedDate, C3632R.C3634drawable.msg_calendar2, true);
        ...
        DetailsIconCellView.setupViewData$default(viewNetworkCell, getResourceManager().getString(C3632R.string.wallet_connect_session_details_network), network, C3632R.C3634drawable.msg_language, false, 8, null);
    }
    ...
    private final void setupColors() {
        ...
        binding.buttonDisconnect.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(4), Theme.getColor(Theme.key_chat_attachAudioBackground), ViewExtKt.withAlpha(Theme.getColor(Theme.key_windowBackgroundWhite), 120)));
    }

    private final void setupTexts() {
        getBinding().buttonDisconnect.setText(LocaleController.getString("Disconnect", C3632R.string.Disconnect));
    }
