...
public final class WalletAccountSettingsFragment extends WalletAuthBaseFragment implements WalletAccountSettingsView {
    ...
    private final void setupActionBar() {
        ...
        c3704ActionBar.setTitle(getResourceManager().getString(C3632R.string.wallet_eth_account_settings_toolbar_title));
        c3704ActionBar.setActionBarMenuOnItemClick(new C3704ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.settings.WalletAccountSettingsFragment$setupActionBar$1$1
