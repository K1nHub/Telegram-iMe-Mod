...
import com.iMe.p030ui.wallet.crypto.settings.custom_tokens.CustomTokensFragment;
import com.iMe.p030ui.wallet.crypto.wallet_connect.WalletConnectFragment;
...
public final class WalletAccountSettingsFragment extends WalletAuthBaseFragment implements WalletAccountSettingsView {
    ...
    @Override // com.iMe.p030ui.wallet.crypto.settings.WalletAccountSettingsView
    ...
    private final void setupActionBar() {
        ...
        c3702ActionBar.setTitle(getResourceManager().getString(C3630R.string.wallet_eth_account_settings_toolbar_title));
        c3702ActionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.settings.WalletAccountSettingsFragment$setupActionBar$1$1
