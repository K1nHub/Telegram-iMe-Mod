...
public final class TokenManagementPresenter extends BasePresenter<TokenManagementView> {
    ...
    public final void onAddressScanned(final String text) {
        ...
        Observable<Result<Boolean>> observeOn = this.cryptoWalletInteractor.isValidAddress(text, NetworksHelper.getNetworkById(this.selectedNetworkItem.getNetworkId()).getBlockchainType()).observeOn(this.schedulersProvider.mo1013ui());
        ...
        Disposable subscribe = withLoadingDialog.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$onAddressScanned$$inlined$subscribeWithErrorHandle$default$1
            ...
            public final void m1665invoke(Result<? extends Boolean> it) {
    ...
    public final void enableToken() {
        Observable<Result<Boolean>> observeOn = this.walletInteractor.setTokenVisibility(getToken(), true).observeOn(this.schedulersProvider.mo1013ui());
    ...
    public final void deleteToken() {
        Observable<Result<Boolean>> observeOn = this.walletInteractor.detachCustomToken(getToken()).observeOn(this.schedulersProvider.mo1013ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "walletInteractor\n       …(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Observable withLoadingDialog = RxExtKt.withLoadingDialog((Observable) observeOn, (BaseView) viewState, false);
    ...
    private final void loadTokenInfo() {
        ...
        Observable<Result<Boolean>> observeOn = this.cryptoWalletInteractor.isValidAddress(this.address, NetworksHelper.getNetworkById(this.selectedNetworkItem.getNetworkId()).getBlockchainType()).observeOn(this.schedulersProvider.mo1014io());
        ...
        Observable flatMap = map.flatMap(new C2146x8acd2b70(new Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>>>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$loadTokenInfo$$inlined$flatMapSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final ObservableSource<? extends Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>> invoke(Result<? extends Boolean> result) {
                ...
                ObservableSource flatMap2 = tokenInfo.flatMap(new C2146x8acd2b70(new Function1<Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>, ObservableSource<? extends Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>>>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$loadTokenInfo$lambda$7$$inlined$flatMapSuccess$1
                    {
                        super(1);
                    }
                    ...
                    public final ObservableSource<? extends Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>> invoke(final Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>> result2) {
                        ...
                        ObservableSource map2 = tokenListsData.map(new C2146x8acd2b70(new Function1<Result<? extends TokenListsData>, Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$loadTokenInfo$lambda$7$lambda$6$$inlined$mapSuccess$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
        ...
        Observable observeOn2 = flatMap.observeOn(this.schedulersProvider.mo1013ui());
        ...
        Disposable subscribe = observeOn2.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>, Unit>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$loadTokenInfo$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1664invoke(Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>> it) {
                ResourceManager resourceManager;
                boolean z2;
                Intrinsics.checkNotNullExpressionValue(it, "it");
