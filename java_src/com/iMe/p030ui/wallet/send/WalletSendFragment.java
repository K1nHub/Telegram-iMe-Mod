...
public final class WalletSendFragment extends WalletAuthBaseFragment implements WalletSendView {
    ...
    public void renderSelectedToken(String tokenText, String tokenLogoUrl, int i, String tokenBalanceText, String insertedAmountInDollarsText) {
        ...
        if (this.screenType == WalletSendScreenType.BINANCE_REPLENISH) {
            binding.inputRecipient.getInputView().setEditHint(getResourceManager().getString(C3630R.string.common_progress_state_title));
        }
    ...
    public void showSuccessSend(String message) {
        ...
        DialogsFactoryKt.showSuccessAlert(this, getResourceManager().getString(C3630R.string.wallet_amount_success_send_title), message, getResourceManager().getString(C3630R.string.common_ok), new Callbacks$Callback() { // from class: com.iMe.ui.wallet.send.WalletSendFragment$$ExternalSyntheticLambda6
    ...
    public void showAlertError(String text) {
        ...
        DialogsFactoryKt.showErrorAlert$default(this, getResourceManager().getString(C3630R.string.common_unexpected_error_title), text, getResourceManager().getString(C3630R.string.common_ok), null, 8, null);
    }

    @Override // com.iMe.p030ui.wallet.send.WalletSendView
    public void showRecipientNotFoundError() {
        DialogsFactoryKt.showSuccessAlert(this, getResourceManager().getString(C3630R.string.wallet_amount_error_invalid_user_title), getResourceManager().getString(C3630R.string.wallet_amount_error_invalid_user_description), getResourceManager().getString(C3630R.string.wallet_amount_error_invalid_user_btn_txt), new Callbacks$Callback() { // from class: com.iMe.ui.wallet.send.WalletSendFragment$$ExternalSyntheticLambda9
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    public void showRecipientWalletNotActivatedError() {
        DialogsFactoryKt.showSuccessAlert(this, getResourceManager().getString(C3630R.string.wallet_amount_error_invalid_user_title), getResourceManager().getString(C3630R.string.wallet_amount_error_user_wallet_not_activated_description), getResourceManager().getString(C3630R.string.wallet_amount_error_invalid_user_btn_txt), new Callbacks$Callback() { // from class: com.iMe.ui.wallet.send.WalletSendFragment$$ExternalSyntheticLambda7
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    public void onSuccessValidation(DialogModel model, boolean z) {
        ...
        Activity parentActivity = getParentActivity();
        Intrinsics.checkNotNullExpressionValue(parentActivity, "parentActivity");
        showDialog(DialogUtils.createCheckBoxAlert$default(parentActivity, model, getResourceManager().getString(C3630R.string.wallet_amount_send_message_checkbox_title), z, new Callbacks$Callback1() { // from class: com.iMe.ui.wallet.send.WalletSendFragment$$ExternalSyntheticLambda2
            @Override // com.iMe.fork.utils.Callbacks$Callback1
            public final void invoke(Object obj) {
    ...
    public void resetScreen() {
        ...
        inputView.setEditHint(getResourceManager().getString(C3630R.string.wallet_amount_send_enter_address_hint));
    ...
    public void updateStateButtonSend(WalletSendPresenter.SendScreenState state) {
        ...
        if (i == 1) {
            transactionActionButtonsView.setActionButtonText(getResourceManager().getString(C3630R.string.wallet_amount_button_txt));
            transactionActionButtonsView.setActionButtonEnabled(false);
        } else if (i == 2) {
            transactionActionButtonsView.setActionButtonText(getResourceManager().getString(C3630R.string.common_progress_state_title));
            transactionActionButtonsView.setActionButtonEnabled(false);
        } else if (i != 3) {
        } else {
            transactionActionButtonsView.setActionButtonText(getResourceManager().getString(C3630R.string.wallet_amount_button_txt));
    ...
    public void setupRecipientInputErrorState(boolean z) {
        ...
        setErrorStateTitledInputFieldView$default(this, titledInputFieldView, getResourceManager().getString(C3630R.string.wallet_amount_send_error_incorrect_address), z, null, 8, null);
    }
    ...
    public void setupTokenInputErrorState(boolean z) {
        ...
        setErrorStateTitledInputFieldView$default(this, titledInputFieldView, getResourceManager().getString(C3630R.string.wallet_amount_send_error_unsupported_token), z, null, 8, null);
    }
    ...
    public void setupAmountInputErrorState(boolean z, String str) {
        ...
        String string = getResourceManager().getString(C3630R.string.wallet_amount_send_error_insufficient_funds);
        if (str == null) {
            str = "";
        }
    ...
    private final void showBalance(String str, String str2) {
        ...
        showBalance$lambda$23$lambda$21.setText(AndroidUtilities.replaceTags(getResourceManager().getString(C3630R.string.wallet_swap_process_my_balance, str)));
    ...
    private final void setupActionBar() {
        ...
        c3702ActionBar.setTitle(getResourceManager().getString(C3630R.string.wallet_user_id_dialog_transfer_action));
        c3702ActionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.send.WalletSendFragment$setupActionBar$1$1
    ...
    private final void setupViews() {
        ...
        rLottieImageView.setAnimation(C3630R.raw.fork_crypto_transfers, 96, 96);
        rLottieImageView.playAnimation();
        TextView textView = binding.textHeader;
        ResourceManager resourceManager = getResourceManager();
        int i2 = WhenMappings.$EnumSwitchMapping$0[this.screenType.ordinal()];
        if (i2 == 1) {
            i = C3630R.string.wallet_banner_slide_crypto_transfers_long_description;
        } else if (i2 == 2) {
            i = C3630R.string.binance_replenish_token_description;
        } else if (i2 != 3) {
            throw new NoWhenBranchMatchedException();
        } else {
            i = C3630R.string.channel_donations_description;
        }
        ...
        String string = getResourceManager().getString(this.isBinanceTokenReplenish ? C3630R.string.common_progress_state_title : C3630R.string.wallet_amount_send_enter_address_hint);
        ...
        String string2 = getResourceManager().getString(C3630R.string.wallet_binance_receive_choose_contact_hint);
        ...
        if (this.screenType == walletSendScreenType2) {
            ...
            ViewExtKt.safeThrottledClick$default(frameLayout, 0L, new Function1<View, Unit>() { // from class: com.iMe.ui.wallet.send.WalletSendFragment$setupViews$1$2$1$2
                ...
                public final void invoke2(View it) {
                    ...
                    walletSendFragment.showAlertError(resourceManager2.getString(C3630R.string.binance_replenish_custom_address_unsupported));
                }
            }, 1, null);
        }
        ...
        String string3 = getResourceManager().getString(C3630R.string.wallet_binance_receive_select_token_hint);
        String string4 = getResourceManager().getString(C3630R.string.wallet_binance_receive_select_token_title);
        ...
        String string5 = getResourceManager().getString(C3630R.string.wallet_transfer_comment_title);
        String string6 = getResourceManager().getString(C3630R.string.wallet_transfer_comment_hint);
        ...
        String string7 = getResourceManager().getString(C3630R.string.wallet_crypto_buy_amount_title);
        String string8 = getResourceManager().getString(C3630R.string.wallet_binance_receive_amount_title);
        ...
        buttonSend.setupViewData(getResourceManager().getString(C3630R.string.wallet_amount_button_txt), (r14 & 2) != 0, (r14 & 4) != 0 ? false : false, (r14 & 8) == 0 ? false : false, (r14 & 16) != 0 ? new Callbacks$Callback() { // from class: com.iMe.ui.custom.TransactionActionButtonsView$$ExternalSyntheticLambda1
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
