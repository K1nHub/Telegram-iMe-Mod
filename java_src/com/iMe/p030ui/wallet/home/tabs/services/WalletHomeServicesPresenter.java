...
public final class WalletHomeServicesPresenter extends BasePresenter<WalletHomeServicesView> {
    ...
    private final List<BaseNode> configureBalancesWithHeaders() {
        ...
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new HeaderItem(this.resourceManager.getString(C3630R.string.wallet_internal_point_basic_services)), new ServicesBasicItem(ServicesCategory.CRYPTOBOXES, C3630R.C3632drawable.fork_ic_internal_point_cryptoboxes, C3630R.string.wallet_internal_point_cryptoboxes_title, C3630R.string.wallet_internal_point_cryptoboxes_subtitle), new ServicesBasicItem(ServicesCategory.STAKING, C3630R.C3632drawable.fork_ic_internal_point_staking, C3630R.string.wallet_internal_point_staking_title, C3630R.string.wallet_internal_point_staking_subtitle), new ServicesBasicItem(ServicesCategory.CHANNELS, C3630R.C3632drawable.fork_ic_internal_point_channels_catalog, C3630R.string.wallet_internal_point_channels_catalog_title, C3630R.string.wallet_internal_point_channels_catalog_subtitle), new ServicesBasicItem(ServicesCategory.NEUROBOTS, C3630R.C3632drawable.fork_ic_internal_point_neurobots_store, C3630R.string.wallet_internal_point_neurobots_store_title, C3630R.string.wallet_internal_point_neurobots_store_subtitle), new HeaderItem(this.resourceManager.getString(C3630R.string.wallet_internal_point_ton_services)), new ServicesBasicItem(ServicesCategory.TELEGRAM_PREMIUM, C3630R.C3632drawable.fork_ic_internal_point_telegram_premium, C3630R.string.wallet_internal_point_telegram_premium_title, C3630R.string.wallet_internal_point_telegram_premium_subtitle), new ServicesBasicItem(ServicesCategory.TELEGRAM_USERNAMES, C3630R.C3632drawable.fork_ic_internal_point_telegram_usernames, C3630R.string.wallet_internal_point_telegram_usernames_title, C3630R.string.wallet_internal_point_telegram_usernames_subtitle), new HeaderItem(this.resourceManager.getString(C3630R.string.wallet_internal_point_subscriptions)), new ServicesBasicItem(ServicesCategory.PREMIUM, C3630R.C3632drawable.fork_ic_internal_point_premium_account, C3630R.string.wallet_internal_point_premium_account_title, C3630R.string.wallet_internal_point_premium_account_subtitle), new ServicesBasicItem(ServicesCategory.ADS, C3630R.C3632drawable.fork_ic_internal_point_ads, C3630R.string.wallet_internal_point_ads_title, C3630R.string.wallet_internal_point_ads_subtitle));
