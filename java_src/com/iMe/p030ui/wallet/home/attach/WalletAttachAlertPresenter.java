...
public final class WalletAttachAlertPresenter extends BasePresenter<WalletAttachAlertView> {
    ...
    private final void getWalletBalance(boolean z) {
        Observable observeOn = WalletInteractor.getWalletBalance$default(this.walletInteractor, z, null, 2, null).distinctUntilChanged().observeOn(this.schedulersProvider.mo1013ui());
