...
import com.iMe.p030ui.wallet.cryptobox.statuses_description.CryptoBoxStatusInfoBottomSheetDialog;
import com.iMe.p030ui.wallet.cryptobox.suspension.CryptoBoxSuspensionBottomSheetDialog;
...
public final class WalletTokenDetailsFragment extends WalletAuthBaseFragment implements WalletTokenDetailsView, NavigationViewConfiguration, TabbedViewPagerDelegate<TabbedFragmentPage<MvpFragment>> {
    ...
    public WalletTokenDetailsFragment(TokenDetailsArgs args) {
        ...
        lazy4 = LazyKt__LazyJVMKt.lazy(new Function0<Integer>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$titleTextTranslationY$2
            ...
            public final Integer invoke() {
                TokenDetailsArgs tokenDetailsArgs;
                tokenDetailsArgs = WalletTokenDetailsFragment.this.args;
                return Integer.valueOf(AndroidUtilities.m107dp(tokenDetailsArgs instanceof TokenDetailsArgs.CryptoBox ? 22 : 26));
            }
        });
        this.titleTextTranslationY$delegate = lazy4;
        this.statusTextColorKey = Theme.key_windowBackgroundWhiteBlueText;
        this.statusTextColorResId = C3632R.C3633color.cryptobox_status_active;
    }
    ...
    public void setupTransactionsScreen(TokenDetailsArgs args) {
        ...
        if (args instanceof TokenDetailsArgs.Binance) {
            ...
            ImageViewExtKt.loadFrom$default(imageLogo2, balance.getToken().getAvatarUrl(), Integer.valueOf(C3632R.C3634drawable.fork_bg_white_circle), false, 4, null);
            ...
            binding.textCryptoWalletAddressTitle.setText(getResourceManager().getString(C3632R.string.wallet_connect_session_details_address));
            ...
            appCompatTextView.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    WalletTokenDetailsFragment.setupTransactionsScreen$lambda$7$lambda$6$lambda$5(WalletTokenDetailsFragment.this, view);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupTransactionsScreen$lambda$7$lambda$6$lambda$5(WalletTokenDetailsFragment this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.getPresenter().onCopyClick();
    }
    ...
    public void setupStakingDetailsScreen(String explorerIconUrl, String logoImageUrl, String titleText, String balanceText, String annualTitleText, String annualValueText, String profitText, boolean z, StakingProgrammeStatus status) {
        ...
        AppCompatImageView imageLogo = binding.imageLogo;
        Intrinsics.checkNotNullExpressionValue(imageLogo, "imageLogo");
        ImageViewExtKt.loadFrom$default(imageLogo, logoImageUrl, Integer.valueOf(C3632R.C3634drawable.fork_bg_white_circle), false, 4, null);
        ...
        binding.textStakingInfo.setText(getResourceManager().getString(C3632R.string.staking_details_info));
        ...
        textDetailCell.setTextAndValue(profitText, getResourceManager().getString(C3632R.string.staking_details_profit), true);
        ...
        textDetailCell2.setTextAndValue(getResourceManager().getString(status.getTextResId()), getResourceManager().getString(C3632R.string.wallet_transaction_details_status_title), false);
    ...
    public void setupCryptoBoxDetailsScreen(String explorerIconUrl, String logoImageUrl, long j, String chatName, String name, String description, String membersText, String balanceText, CryptoBoxStatus status) {
        ...
        ForkFragmentWalletTokenDetailsBinding binding = getBinding();
        AppCompatImageView setupCryptoBoxDetailsScreen$lambda$18$lambda$15 = binding.imageLogo;
        if (logoImageUrl.length() > 0) {
            Intrinsics.checkNotNullExpressionValue(setupCryptoBoxDetailsScreen$lambda$18$lambda$15, "setupCryptoBoxDetailsScreen$lambda$18$lambda$15");
            obj = null;
            r7 = 1;
            ImageViewExtKt.loadFrom$default(setupCryptoBoxDetailsScreen$lambda$18$lambda$15, logoImageUrl, null, false, 6, null);
        } else {
            obj = null;
            r7 = 1;
            AvatarDrawable avatarDrawable = new AvatarDrawable();
            avatarDrawable.setInfo(j, chatName, null);
            setupCryptoBoxDetailsScreen$lambda$18$lambda$15.setBackground(avatarDrawable);
        }
        ...
        binding.textCryptoboxDescriptionTitle.setText(LocaleController.getString("DescriptionPlaceholder", C3632R.string.DescriptionPlaceholder));
        ...
        binding.textCryptoboxInfo.setText(getResourceManager().getString(C3632R.string.cryptobox_details_info));
        binding.viewChatCell.setTextAndValue(chatName, getResourceManager().getString(C3632R.string.cryptobox_details_chat), r7);
        binding.viewMembersCell.setTextAndValue(membersText, getResourceManager().getString(C3632R.string.cryptobox_details_members), r7);
        binding.viewBalanceCell.setTextAndValue(balanceText, getResourceManager().getString(C3632R.string.cryptobox_details_balance), r7);
        this.statusTextColorResId = status.getColorResId();
        TextDetailCell textDetailCell = binding.viewStatusCell;
        textDetailCell.setTextAndValue(getResourceManager().getString(status.getTitleResId()), getResourceManager().getString(C3632R.string.wallet_transaction_details_status_title), false);
        textDetailCell.getImageView().setImageResource(C3632R.C3634drawable.attach_arrow_right);
    ...
    public void renderHorizontalActionButtons(List<HorizontalActionButtonItem> actionsItems) {
        ...
        ForkFragmentWalletTokenDetailsBinding binding = getBinding();
        HorizontalActionButtonsView renderHorizontalActionButtons$lambda$20$lambda$19 = binding.horizontalActionButtons;
        renderHorizontalActionButtons$lambda$20$lambda$19.initButtons(actionsItems);
        Intrinsics.checkNotNullExpressionValue(renderHorizontalActionButtons$lambda$20$lambda$19, "renderHorizontalActionButtons$lambda$20$lambda$19");
        renderHorizontalActionButtons$lambda$20$lambda$19.setVisibility(actionsItems.isEmpty() ^ true ? 0 : 8);
    ...
    public void openSendScreen(TokenItem tokenItem, String networkId) {
        ...
        presentFragment(WalletSendFragment.Companion.newInstance(new TransferScreenArgs(tokenItem, null, null, null, networkId, 14, null), WalletSendScreenType.WALLET_TRANSFER));
    }
    ...
    @Override // com.iMe.p030ui.wallet.home.details.WalletTokenDetailsView
    public void openStakingTransactionScreen(StakingDetailsItem stakingDetails, StakingScreenType screenType) {
        Intrinsics.checkNotNullParameter(stakingDetails, "stakingDetails");
        Intrinsics.checkNotNullParameter(screenType, "screenType");
        presentFragment(StakingTransactionFragment.Companion.newInstance(null, screenType, stakingDetails));
    }
    ...
    public void openBinanceReplenishScreen(TokenItem tokenItem, String networkId) {
        Intrinsics.checkNotNullParameter(tokenItem, "tokenItem");
        Intrinsics.checkNotNullParameter(networkId, "networkId");
        presentFragment(WalletSendFragment.Companion.newInstance(new TransferScreenArgs(tokenItem, null, null, null, networkId, 14, null), WalletSendScreenType.BINANCE_REPLENISH));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void showRequiredWalletCreatedDialog$lambda$21(Callbacks$Callback action) {
    ...
    public void showRequiredWalletCreatedDialog(final Callbacks$Callback action) {
        Intrinsics.checkNotNullParameter(action, "action");
        showDialog(DialogsFactoryKt.createWalletCreatedRequiredDialog(this, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$$ExternalSyntheticLambda5
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                WalletTokenDetailsFragment.showRequiredWalletCreatedDialog$lambda$21(Callbacks$Callback.this);
            }
        }));
    }
    ...
    public void showCryptoBoxRefreshSuccess() {
        DialogsFactoryKt.showSuccessAlert$default(this, getResourceManager().getString(C3632R.string.status_ok), getResourceManager().getString(C3632R.string.cryptobox_refresh_success), getResourceManager().getString(C3632R.string.common_ok), null, 8, null);
    }
    ...
    public void setupRankBadge(boolean z, AccountLevel accountLevel) {
        ...
        AccountLevelBadgeView setupRankBadge$lambda$23 = getBinding().accountRankBadge;
        Intrinsics.checkNotNullExpressionValue(setupRankBadge$lambda$23, "setupRankBadge$lambda$23");
        setupRankBadge$lambda$23.setVisibility(z ? 0 : 8);
        setupRankBadge$lambda$23.setAccountLevel(accountLevel);
    }
    ...
    public void showLevelRequiredDialog(AccountLevel minimalRank, final TokenDetailed token) {
        ...
        Intrinsics.checkNotNullParameter(token, "token");
        DialogsFactoryKt.showStakingLevelRequiredDialog(this, getResourceManager(), minimalRank, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$$ExternalSyntheticLambda6
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                WalletTokenDetailsFragment.showLevelRequiredDialog$lambda$24(WalletTokenDetailsFragment.this, token);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void showLevelRequiredDialog$lambda$24(WalletTokenDetailsFragment this$0, TokenDetailed token) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(token, "$token");
    ...
    public void onSetupNavigationRouter() {
        ...
        tabsView.setElevation(AndroidUtilities.m107dp(2));
        ...
        if (!(tokenDetailsArgs instanceof TokenDetailsArgs.Crypto)) {
            if (!(tokenDetailsArgs instanceof TokenDetailsArgs.Staking)) {
                if (tokenDetailsArgs instanceof TokenDetailsArgs.CryptoBox) {
                    listOf = CollectionsKt__CollectionsJVMKt.listOf(new WalletTokenDetailsNavigationTab(C3632R.C3635id.wallet_token_details_transactions_all, new TabbedFragmentPage(getResourceManager().getString(C3632R.string.wallet_token_details_transactions_all), 0, WalletTransactionsFragment.Companion.newInstance$default(WalletTransactionsFragment.Companion, new WalletTransactionsScreenType.CryptoBoxDetailsTab(((TokenDetailsArgs.CryptoBox) this.args).getCryptoBoxInfo()), null, 2, null), new Function0<View>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$initPageTabs$4
                        /* JADX INFO: Access modifiers changed from: package-private */
                        {
                            super(0);
                        }
                        ...
                        public final View invoke() {
                            ...
                            navigationRouter = WalletTokenDetailsFragment.this.getNavigationRouter();
                            Intrinsics.checkNotNull(navigationRouter, "null cannot be cast to non-null type com.iMe.navigation.common.router.base.BaseNavigationRouter<com.iMe.ui.base.mvp.MvpFragment>");
                            return ((BaseNavigationRouter) navigationRouter).getViewByFragmentId(C3632R.C3635id.wallet_token_details_transactions_all);
                        }
                    }, 2, null)));
                    return listOf;
                }
    ...
    public final void setupColors() {
        ...
        ActionBarMenuItem setupColors$lambda$39$lambda$37 = binding.itemMoreOptions;
        setupColors$lambda$39$lambda$37.redrawPopup(getThemedColor(Theme.key_actionBarDefaultSubmenuBackground));
        setupColors$lambda$39$lambda$37.setPopupItemsColor(getThemedColor(Theme.key_actionBarDefaultSubmenuItem), false);
        setupColors$lambda$39$lambda$37.setPopupItemsColor(getThemedColor(Theme.key_actionBarDefaultSubmenuItemIcon), true);
        setupColors$lambda$39$lambda$37.setupPopupRadialSelectors(getThemedColor(Theme.key_listSelector));
        Intrinsics.checkNotNullExpressionValue(setupColors$lambda$39$lambda$37, "setupColors$lambda$39$lambda$37");
        ViewExtKt.setCircleRippleBackground(setupColors$lambda$39$lambda$37);
        AppCompatTextView textSubtitle = binding.textSubtitle;
        Intrinsics.checkNotNullExpressionValue(textSubtitle, "textSubtitle");
        ViewExtKt.withMediumTypeface(textSubtitle);
        AppCompatTextView setupColors$lambda$39$lambda$38 = binding.textTransactions;
        Intrinsics.checkNotNullExpressionValue(setupColors$lambda$39$lambda$38, "setupColors$lambda$39$lambda$38");
        ViewExtKt.withMediumTypeface(setupColors$lambda$39$lambda$38);
        setupColors$lambda$39$lambda$38.setTextColor(getThemedColor(Theme.key_profile_tabSelectedText));
        ...
        if (tokenDetailsArgs instanceof TokenDetailsArgs.Staking) {
            ...
            if (tokenDetailsArgs instanceof TokenDetailsArgs.Crypto ? true : tokenDetailsArgs instanceof TokenDetailsArgs.Binance) {
                setupCryptoScreenColors();
            }
        }
    }

    private final void setupCryptoScreenColors() {
        ForkFragmentWalletTokenDetailsBinding binding = getBinding();
        binding.linearCryptoInfo.setBackgroundColor(getThemedColor(Theme.key_windowBackgroundWhite));
        AppCompatTextView setupCryptoScreenColors$lambda$41$lambda$40 = binding.textCryptoWalletAddressTitle;
        Intrinsics.checkNotNullExpressionValue(setupCryptoScreenColors$lambda$41$lambda$40, "setupCryptoScreenColors$lambda$41$lambda$40");
        ViewExtKt.withMediumTypeface(setupCryptoScreenColors$lambda$41$lambda$40);
        int i = Theme.key_windowBackgroundWhiteBlueText;
        setupCryptoScreenColors$lambda$41$lambda$40.setTextColor(getThemedColor(i));
        binding.textCryptoWalletAddressValue.setTextColor(getThemedColor(i));
        binding.dividerCrypto.setBackgroundColor(getThemedColor(Theme.key_windowBackgroundGray));
    }
    ...
    private final void setupStakingScreenColors() {
        ...
        AppCompatTextView setupStakingScreenColors$lambda$44$lambda$42 = binding.textStakingInfo;
        Intrinsics.checkNotNullExpressionValue(setupStakingScreenColors$lambda$44$lambda$42, "setupStakingScreenColors$lambda$44$lambda$42");
        ViewExtKt.withMediumTypeface(setupStakingScreenColors$lambda$44$lambda$42);
        int i = Theme.key_profile_tabSelectedText;
        setupStakingScreenColors$lambda$44$lambda$42.setTextColor(getThemedColor(i));
        AppCompatImageView setupStakingScreenColors$lambda$44$lambda$43 = binding.imageStakingInfo;
        Intrinsics.checkNotNullExpressionValue(setupStakingScreenColors$lambda$44$lambda$43, "setupStakingScreenColors$lambda$44$lambda$43");
        ImageViewExtKt.setImageColor(setupStakingScreenColors$lambda$44$lambda$43, getThemedColor(i));
        ViewExtKt.setCircleRippleBackground(setupStakingScreenColors$lambda$44$lambda$43);
    ...
    private final void setupCryptoBoxScreenColors() {
        ...
        AppCompatTextView setupCryptoBoxScreenColors$lambda$49$lambda$45 = binding.textCryptoboxDescriptionTitle;
        Intrinsics.checkNotNullExpressionValue(setupCryptoBoxScreenColors$lambda$49$lambda$45, "setupCryptoBoxScreenColors$lambda$49$lambda$45");
        ViewExtKt.withMediumTypeface(setupCryptoBoxScreenColors$lambda$49$lambda$45);
        int i3 = Theme.key_profile_tabSelectedText;
        setupCryptoBoxScreenColors$lambda$49$lambda$45.setTextColor(getThemedColor(i3));
        ...
        AppCompatTextView setupCryptoBoxScreenColors$lambda$49$lambda$46 = binding.textCryptoboxInfo;
        Intrinsics.checkNotNullExpressionValue(setupCryptoBoxScreenColors$lambda$49$lambda$46, "setupCryptoBoxScreenColors$lambda$49$lambda$46");
        ViewExtKt.withMediumTypeface(setupCryptoBoxScreenColors$lambda$49$lambda$46);
        setupCryptoBoxScreenColors$lambda$49$lambda$46.setTextColor(getThemedColor(i3));
        AppCompatImageView setupCryptoBoxScreenColors$lambda$49$lambda$47 = binding.imageCryptoboxInfo;
        Intrinsics.checkNotNullExpressionValue(setupCryptoBoxScreenColors$lambda$49$lambda$47, "setupCryptoBoxScreenColors$lambda$49$lambda$47");
        ImageViewExtKt.setImageColor(setupCryptoBoxScreenColors$lambda$49$lambda$47, getThemedColor(i3));
        ViewExtKt.setCircleRippleBackground(setupCryptoBoxScreenColors$lambda$49$lambda$47);
        ...
        TextDetailCell setupCryptoBoxScreenColors$lambda$49$lambda$48 = binding.viewStatusCell;
        setupCryptoBoxScreenColors$lambda$49$lambda$48.setupColors(getResourceManager().getColor(this.statusTextColorResId), true, getThemedColor(i5), Integer.valueOf(getThemedColor(Theme.key_windowBackgroundWhiteGrayIcon)));
        Intrinsics.checkNotNullExpressionValue(setupCryptoBoxScreenColors$lambda$49$lambda$48, "setupCryptoBoxScreenColors$lambda$49$lambda$48");
        ViewExtKt.setRippleBackground$default(setupCryptoBoxScreenColors$lambda$49$lambda$48, false, 1, null);
    }
    ...
    private final void setupActionBar() {
        ...
        setupActionBar$lambda$56$lambda$52.setIcon(C3632R.C3634drawable.ic_ab_back);
        ...
        setupActionBar$lambda$56$lambda$52.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3632R.string.AccDescrGoBack));
        ...
        setupActionBar$lambda$56$lambda$55.setIcon(C3632R.C3634drawable.ic_ab_other);
        ...
        setupActionBar$lambda$56$lambda$55.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                WalletTokenDetailsFragment.setupActionBar$lambda$56$lambda$55$lambda$53(ActionBarMenuItem.this, view);
            }
        });
        ...
        setupActionBar$lambda$56$lambda$55.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3632R.string.AccDescrMoreOptions));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupActionBar$lambda$56$lambda$52$lambda$51(WalletTokenDetailsFragment this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.finishFragment();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupActionBar$lambda$56$lambda$55$lambda$53(ActionBarMenuItem this_with, View view) {
        Intrinsics.checkNotNullParameter(this_with, "$this_with");
        this_with.toggleSubMenu();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupActionBar$lambda$56$lambda$55$lambda$54(WalletTokenDetailsFragment this$0, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void setupMenuItems(ActionBarMenuItem actionBarMenuItem) {
        TokenDetailsArgs tokenDetailsArgs = this.args;
        if (tokenDetailsArgs instanceof TokenDetailsArgs.Binance) {
            actionBarMenuItem.addSubItem(IdFabric$Menu.TOKEN_STATISTICS, C3632R.C3634drawable.fork_ic_token_statistic, getResourceManager().getString(C3632R.string.wallet_token_details_distribution_action));
            ...
            if (!token.isCoin()) {
                actionBarMenuItem.addSubItem(IdFabric$Menu.TOKEN_INFORMATION, C3632R.C3634drawable.msg_info, getResourceManager().getString(C3632R.string.wallet_token_details_token_information));
            }
            if (token.getWebsite().length() > 0) {
                actionBarMenuItem.addSubItem(IdFabric$Menu.TOKEN_SITE, C3632R.C3634drawable.fork_ic_web_26, getResourceManager().getString(C3632R.string.wallet_token_details_site_action));
            }
        } else if (tokenDetailsArgs instanceof TokenDetailsArgs.Staking) {
            this.contractItem = actionBarMenuItem.addSubItem(IdFabric$Menu.SMART_CONTRACT, -1, getResourceManager().getString(C3632R.string.staking_details_contract_action));
            actionBarMenuItem.addSubItem(IdFabric$Menu.STAKING_WEBSITE, C3632R.C3634drawable.fork_ic_web_26, getResourceManager().getString(C3632R.string.wallet_token_details_site_action));
        } else if (!(tokenDetailsArgs instanceof TokenDetailsArgs.CryptoBox)) {
            throw new NoWhenBranchMatchedException();
        } else {
            actionBarMenuItem.addSubItem(IdFabric$Menu.COPY, C3632R.C3634drawable.msg_copy, getResourceManager().getString(C3632R.string.cryptobox_copy_name));
            this.contractItem = actionBarMenuItem.addSubItem(IdFabric$Menu.SMART_CONTRACT, -1, getResourceManager().getString(C3632R.string.wallet_transaction_details_action_view_smart_contract));
        }
    }

    private final void setupListeners() {
        ForkFragmentWalletTokenDetailsBinding binding = getBinding();
        binding.getRoot().setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$$ExternalSyntheticLambda3
            @Override // androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener
            public final void onRefresh() {
                WalletTokenDetailsFragment.setupListeners$lambda$60$lambda$59(WalletTokenDetailsFragment.this);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupListeners$lambda$60$lambda$59(WalletTokenDetailsFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void setupViews() {
        ...
        binding.textTransactions.setText(getResourceManager().getString(C3632R.string.wallet_token_details_transactions));
        if (this.args instanceof TokenDetailsArgs.CryptoBox) {
            ...
            setupViews$lambda$63$lambda$62.setPadding(setupViews$lambda$63$lambda$62.getPaddingLeft(), setupViews$lambda$63$lambda$62.getPaddingTop(), AndroidUtilities.m107dp(170), setupViews$lambda$63$lambda$62.getPaddingBottom());
        }
    }
    ...
    private final void setupCollapsingToolbar() {
        ...
        ConstraintLayout setupCollapsingToolbar$lambda$81$lambda$70 = binding.constraintLayoutHeader;
        Intrinsics.checkNotNullExpressionValue(setupCollapsingToolbar$lambda$81$lambda$70, "setupCollapsingToolbar$lambda$81$lambda$70");
        setupCollapsingToolbar$lambda$81$lambda$70.setPadding(setupCollapsingToolbar$lambda$81$lambda$70.getPaddingLeft(), binding.constraintLayoutHeader.getPaddingTop() + AndroidUtilities.statusBarHeight, setupCollapsingToolbar$lambda$81$lambda$70.getPaddingRight(), setupCollapsingToolbar$lambda$81$lambda$70.getPaddingBottom());
        if (!ViewCompat.isLaidOut(setupCollapsingToolbar$lambda$81$lambda$70) || setupCollapsingToolbar$lambda$81$lambda$70.isLayoutRequested()) {
            setupCollapsingToolbar$lambda$81$lambda$70.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$setupCollapsingToolbar$lambda$81$lambda$70$$inlined$doOnLayout$1
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    int measuredHeight = forkFragmentWalletTokenDetailsBinding.toolbar.getMeasuredHeight() + AndroidUtilities.statusBarHeight + AndroidUtilities.m107dp(10);
            ...
            appCompatImageView.setPivotY(appCompatImageView.getPivotX() / 2);
            View view = binding.headerUnderlay;
            int measuredHeight = binding.toolbar.getMeasuredHeight() + AndroidUtilities.statusBarHeight + AndroidUtilities.m107dp(10);
        ...
        binding.appbar.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$$ExternalSyntheticLambda4
            @Override // com.google.android.material.appbar.AppBarLayout.BaseOnOffsetChangedListener
            public final void onOffsetChanged(AppBarLayout appBarLayout, int i) {
                WalletTokenDetailsFragment.setupCollapsingToolbar$lambda$81$lambda$80(ForkFragmentWalletTokenDetailsBinding.this, ref$FloatRef2, this, ref$FloatRef, ref$BooleanRef, appBarLayout, i);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupCollapsingToolbar$lambda$81$lambda$80(ForkFragmentWalletTokenDetailsBinding this_with, Ref$FloatRef lastScrollPercent, WalletTokenDetailsFragment this$0, Ref$FloatRef collapsedTranslationX, final Ref$BooleanRef isHeaderUnderlayAnimating, AppBarLayout appBarLayout, int i) {
        Intrinsics.checkNotNullParameter(this_with, "$this_with");
        ...
        appCompatTextView2.setTranslationY(AndroidUtilities.m107dp(24) * abs);
        ...
        appCompatImageView.setTranslationY(AndroidUtilities.m107dp(22) * abs);
        ...
        if ((view.getScaleY() == 1.0f) && !isHeaderUnderlayAnimating.element) {
            view.animate().scaleY(BitmapDescriptorFactory.HUE_RED).setInterpolator(new AccelerateDecelerateInterpolator()).withStartAction(new Runnable() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    WalletTokenDetailsFragment.setupCollapsingToolbar$lambda$81$lambda$80$lambda$79$lambda$76(Ref$BooleanRef.this);
                }
            }).withEndAction(new Runnable() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsFragment$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    WalletTokenDetailsFragment.setupCollapsingToolbar$lambda$81$lambda$80$lambda$79$lambda$77(Ref$BooleanRef.this);
                }
            }).setDuration(100L);
        } else {
            view.setScaleY(BitmapDescriptorFactory.HUE_RED);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupCollapsingToolbar$lambda$81$lambda$80$lambda$79$lambda$76(Ref$BooleanRef isHeaderUnderlayAnimating) {
        Intrinsics.checkNotNullParameter(isHeaderUnderlayAnimating, "$isHeaderUnderlayAnimating");
        isHeaderUnderlayAnimating.element = true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupCollapsingToolbar$lambda$81$lambda$80$lambda$79$lambda$77(Ref$BooleanRef isHeaderUnderlayAnimating) {
        Intrinsics.checkNotNullParameter(isHeaderUnderlayAnimating, "$isHeaderUnderlayAnimating");
    ...
    private final void showQrReceiveDialog(final String str, final String str2, final String str3) {
        ...
        qRCodeBottomSheet.setupWalletTypeReceive(getResourceManager().getString(C3632R.string.wallet_receive_dialog_title), getResourceManager().getString(C3632R.string.wallet_receive_dialog_btn_text), str);
