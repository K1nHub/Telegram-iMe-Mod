...
public final class WalletTokenDetailsPresenter extends BasePresenter<WalletTokenDetailsView> implements WalletCreateManagerDelegate {
    ...
    public final void changeRankVisibility(boolean z) {
        ...
        Disposable subscribe = scheduleIO.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$changeRankVisibility$$inlined$subscribeWithErrorHandle$default$1
            ...
            public final void m1730invoke(Result<? extends Boolean> it) {
    ...
    public final void startTokenDistributionDialog(BinanceTokenBalanceInfo token) {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new StatisticDiagramModel.DiagramItem[]{new StatisticDiagramModel.DiagramItem(this.resourceManager.getString(C3632R.string.binance_token_details_distribution_spot), Theme.key_statisticChartLine_blue, token.getSpot().getTotal()), new StatisticDiagramModel.DiagramItem(this.resourceManager.getString(C3632R.string.binance_token_details_distribution_margin), Theme.key_statisticChartLine_golden, token.getMargin().getTotal())});
    ...
    public final void showCryptoBoxRefreshConfirmation(final String boxId) {
        ...
        ((WalletTokenDetailsView) getViewState()).showConfirmationDialog(new DialogModel(this.resourceManager.getString(C3632R.string.cryptobox_refresh_message_confirmation_title), this.resourceManager.getString(C3632R.string.cryptobox_refresh_message_confirmation_description), this.resourceManager.getString(C3632R.string.common_cancel), this.resourceManager.getString(C3632R.string.cryptobox_details_restore)), new Callbacks$Callback() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$$ExternalSyntheticLambda5
    ...
    public final void loadStakingDetailedMetadata() {
        TokenDetailsArgs tokenDetailsArgs = this.args;
        if (tokenDetailsArgs instanceof TokenDetailsArgs.Staking) {
            Observable<Result<StakingDetailedMetadata>> observeOn = this.stakingInteractor.getStakingDetails(((TokenDetailsArgs.Staking) tokenDetailsArgs).getStakingDetails().getId()).observeOn(this.schedulersProvider.mo1013ui());
            ...
            Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends StakingDetailedMetadata>, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$loadStakingDetailedMetadata$$inlined$subscribeWithErrorHandle$default$1
                ...
                /* renamed from: invoke  reason: collision with other method in class */
                public final void m1733invoke(Result<? extends StakingDetailedMetadata> it) {
                    ResourceManager resourceManager;
    ...
    public final void reloadCryptoBoxInfo() {
        ...
        if (tokenDetailsArgs instanceof TokenDetailsArgs.CryptoBox) {
            Observable<Result<CryptoBoxInfo>> observeOn = this.cryptoBoxInteractor.getCryptoBoxInfo(((TokenDetailsArgs.CryptoBox) tokenDetailsArgs).getCryptoBoxInfo().getId()).observeOn(this.schedulersProvider.mo1013ui());
            ...
            Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends CryptoBoxInfo>, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$reloadCryptoBoxInfo$$inlined$subscribeWithErrorHandle$default$1
                ...
                /* renamed from: invoke  reason: collision with other method in class */
                public final void m1737invoke(Result<? extends CryptoBoxInfo> it) {
                    ResourceManager resourceManager;
                    RxEventBus rxEventBus;
                    TokenDetailsArgs tokenDetailsArgs2;
                    TokenDetailsArgs tokenDetailsArgs3;
    ...
    private final void loadAccountLevelInfo(final boolean z, final Callbacks$Callback1<AccountLevelInformation> callbacks$Callback1) {
        ...
        Disposable subscribe = compose.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends AccountLevelInformation>, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$loadAccountLevelInfo$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1732invoke(Result<? extends AccountLevelInformation> it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    public final void setupStakingDetailsScreen(StakingDetailsItem stakingDetailsItem) {
        ...
        if (NumberExtKt.isZero(parseFormattedString) || stakingDetailsItem.getAnnualPercentageMode() == StakingAnnualPercentageMode.APY) {
            ...
            string = this.resourceManager.getString(C3632R.string.staking_details_apy);
            ...
            string = this.resourceManager.getString(C3632R.string.staking_details_apr);
        } else {
            str = this.resourceManager.getString(C3632R.string.staking_details_apy_apr_values, stakingDetailsItem.getFormattedAPR(), stakingDetailsItem.getFormattedAPY());
            string = this.resourceManager.getString(C3632R.string.staking_details_apy_apr);
        }
        String str3 = str;
        String str4 = string;
        ...
        if (z) {
            ...
            str2 = this.resourceManager.getString(C3632R.string.staking_details_profit_value, TokenBalanceExtKt.getTotalBalanceShortText(copy2), TokenBalanceExtKt.getDollarsBalanceText(copy2));
        } else {
            str2 = "-";
        }
        String str5 = str2;
    ...
    private final void listenEvents() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<RxEvent, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$listenEvents$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1731invoke(RxEvent it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
                RxEvent rxEvent = it;
    ...
    public final List<HorizontalActionButtonItem> resolveAvailableTokenActions(final TokenDetailsArgs tokenDetailsArgs) {
        ...
        if (tokenDetailsArgs instanceof TokenDetailsArgs.Binance) {
            ...
            if (token.getConvertible()) {
                arrayList.add(new HorizontalActionButtonItem(C3632R.C3634drawable.fork_ic_exchange_27, this.resourceManager.getString(C3632R.string.wallet_token_details_transactions_swap), false, new Function0<Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$resolveAvailableTokenActions$1$1$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
            ...
            if (true ^ token.getReplenishNetworksIds().isEmpty()) {
                arrayList.add(new HorizontalActionButtonItem(C3632R.C3634drawable.fork_ic_buy_28, this.resourceManager.getString(C3632R.string.wallet_token_details_action_buy), false, new Function0<Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$resolveAvailableTokenActions$1$1$2
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
            ...
            if (token.getReceivable()) {
                arrayList.add(new HorizontalActionButtonItem(C3632R.C3634drawable.fork_ic_ask_transfer, this.resourceManager.getString(C3632R.string.wallet_token_details_action_receive), false, new Function0<Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$resolveAvailableTokenActions$1$1$3
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
            ...
            arrayList2.add(new HorizontalActionButtonItem(C3632R.C3634drawable.msg_send, this.resourceManager.getString(C3632R.string.wallet_token_details_details_action_send), false, new Function0<Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$resolveAvailableTokenActions$2$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
            ...
            if (isBuyAvailable(token2.getNetworkId())) {
                arrayList2.add(new HorizontalActionButtonItem(C3632R.C3634drawable.fork_ic_exchange_27, this.resourceManager.getString(C3632R.string.wallet_token_details_transactions_swap), false, new Function0<Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$resolveAvailableTokenActions$2$1$2
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
            ...
            arrayList2.add(new HorizontalActionButtonItem(C3632R.C3634drawable.fork_ic_ask_transfer, this.resourceManager.getString(C3632R.string.wallet_token_details_action_receive), false, new Function0<Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$resolveAvailableTokenActions$2$1$3
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
            ...
            int i = C3632R.C3634drawable.fork_ic_buy_28;
            String string = this.resourceManager.getString(C3632R.string.staking_details_replenish);
            StakingDetailedMetadata stakingDetailedMetadata = this.stakingMetadata;
            ...
            int i2 = C3632R.C3634drawable.fork_ic_ask_transfer;
            String string2 = this.resourceManager.getString(C3632R.string.staking_details_claim);
            StakingDetailedMetadata stakingDetailedMetadata2 = this.stakingMetadata;
            ...
            int i3 = C3632R.C3634drawable.fork_ic_withdraw;
            String string3 = this.resourceManager.getString(C3632R.string.staking_details_withdraw);
            ...
            int i4 = C3632R.C3634drawable.fork_wallet_staking_dashboard_calculator;
            String string4 = this.resourceManager.getString(C3632R.string.staking_dashboard_calculator);
    ...
    private final List<HorizontalActionButtonItem> getCryptoBoxActions(final CryptoBoxInfo cryptoBoxInfo) {
        ...
        if (cryptoBoxInfo.getStatus() == CryptoBoxStatus.ACTIVE) {
            listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new HorizontalActionButtonItem[]{new HorizontalActionButtonItem(C3632R.C3634drawable.msg_block, this.resourceManager.getString(C3632R.string.cryptobox_details_stop), false, new Function0<Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$getCryptoBoxActions$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
            ...
            }, 4, null), new HorizontalActionButtonItem(C3632R.C3634drawable.fork_ic_wallet_restore, this.resourceManager.getString(C3632R.string.cryptobox_details_restore), false, new Function0<Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$getCryptoBoxActions$1$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
    ...
    public final void prepareCryptoBoxSuspension(String str) {
        Observable<Result<CryptoBoxTransactionAction>> observeOn = this.cryptoBoxInteractor.getSuspensionPrepareData(str).observeOn(this.schedulersProvider.mo1013ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoBoxInteractor\n    …(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        ...
        Intrinsics.checkNotNullExpressionValue(withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends CryptoBoxTransactionAction>, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$prepareCryptoBoxSuspension$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1735invoke(Result<? extends CryptoBoxTransactionAction> it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    public final void prepareCryptoBoxMessageRefresh(final String str, long j) {
        ...
        if (longOrNull != null) {
            ...
            Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Pair<? extends Boolean, ? extends Boolean>, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$prepareCryptoBoxMessageRefresh$$inlined$subscribeWithErrorHandle$1
                ...
                /* renamed from: invoke  reason: collision with other method in class */
                public final void m1734invoke(Pair<? extends Boolean, ? extends Boolean> it) {
                    ResourceManager resourceManager;
                    Intrinsics.checkNotNullExpressionValue(it, "it");
                    ...
                    if (!pair.component2().booleanValue()) {
                        resourceManager = WalletTokenDetailsPresenter.this.resourceManager;
                        ((WalletTokenDetailsView) WalletTokenDetailsPresenter.this.getViewState()).showToast(resourceManager.getString(C3632R.string.cryptobox_create_user_not_owner));
                        return;
                    }
                ...
                public final void invoke2(Throwable error) {
                    ...
                    if (message2 == null) {
                        ...
                        message2 = resourceManager.getString(C3632R.string.common_error_unexpected);
                    }
    ...
    private final void refreshCryptoBoxMessage(String str) {
        Observable<Result<Boolean>> observeOn = this.cryptoBoxInteractor.sendMessageRefresh(str).observeOn(this.schedulersProvider.mo1013ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoBoxInteractor\n    …(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Observable withLoadingDialog$default = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null);
        ...
        Intrinsics.checkNotNullExpressionValue(withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$refreshCryptoBoxMessage$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1736invoke(Result<? extends Boolean> it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
                Result<? extends Boolean> result = it;
                if (result instanceof Result.Success) {
    ...
    public final void startBinanceReplenishScreen(final BinanceTokenBalanceInfo binanceTokenBalanceInfo) {
        ...
        if ((info == null || info.isVerified()) ? false : true) {
            ...
            ((WalletTokenDetailsView) getViewState()).showToast(this.resourceManager.getString(C3632R.string.binance_replenish_unsupported_network));
        } else {
            final Ref$ObjectRef ref$ObjectRef = new Ref$ObjectRef();
            ?? disposed = Disposables.disposed();
            Intrinsics.checkNotNullExpressionValue(disposed, "disposed()");
            ref$ObjectRef.element = disposed;
            Observable<Result<List<TokenBalance>>> observeOn = this.walletInteractor.getWalletBalance(true, resolveNetworkIdForReplenish).observeOn(this.schedulersProvider.mo1013ui());
            ...
            ?? subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends List<? extends TokenBalance>>, Unit>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$startBinanceReplenishScreen$$inlined$subscribeWithErrorHandle$default$1
                ...
                /* renamed from: invoke  reason: collision with other method in class */
                public final void m1738invoke(Result<? extends List<? extends TokenBalance>> it) {
                    ResourceManager resourceManager;
                    TokenItem tokenItem;
                    Object obj;
                    ...
                    if (result instanceof Result.Success) {
                        ...
                        if (tokenItem == null) {
                            ...
                            ((WalletTokenDetailsView) this.getViewState()).showToast(resourceManager2.getString(C3632R.string.binance_replenish_no_token_on_balance));
                            return;
                        }
