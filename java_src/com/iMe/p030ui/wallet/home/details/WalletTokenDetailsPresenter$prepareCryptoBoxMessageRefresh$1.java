...
public final class WalletTokenDetailsPresenter$prepareCryptoBoxMessageRefresh$1 extends Lambda implements Function1<TLRPC$Chat, ObservableSource<? extends Pair<? extends Boolean, ? extends Boolean>>> {
    ...
    public final ObservableSource<? extends Pair<Boolean, Boolean>> invoke(final TLRPC$Chat chat) {
        ...
        final C23081 c23081 = new C23081(this.this$0, chat);
    ...
    /* loaded from: classes4.dex */
    public static final class C23081 extends Lambda implements Function1<TLRPC$ChatFull, ObservableSource<? extends Boolean>> {
        ...
        public final ObservableSource<? extends Boolean> invoke(TLRPC$ChatFull chatFull) {
            ...
            final C23091 c23091 = new C23091(this.this$0, this.$chat);
            return userInfoByUsername.flatMap(new Function() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$prepareCryptoBoxMessageRefresh$1$1$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    ...
                    invoke$lambda$1 = WalletTokenDetailsPresenter$prepareCryptoBoxMessageRefresh$1.C23081.invoke$lambda$1(Function1.this, obj);
                    return invoke$lambda$1;
                }
            });
        }
        ...
        /* loaded from: classes4.dex */
        public static final class C23091 extends Lambda implements Function1<TLRPC$User, ObservableSource<? extends Boolean>> {
            final /* synthetic */ TLRPC$Chat $chat;
            final /* synthetic */ WalletTokenDetailsPresenter this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C23091(WalletTokenDetailsPresenter walletTokenDetailsPresenter, TLRPC$Chat tLRPC$Chat) {
                super(1);
                this.this$0 = walletTokenDetailsPresenter;
                this.$chat = tLRPC$Chat;
            }
            ...
            public final ObservableSource<? extends Boolean> invoke(TLRPC$User botUser) {
                ...
                final C23101 c23101 = new Function1<Throwable, TLRPC$ChannelParticipant>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter.prepareCryptoBoxMessageRefresh.1.1.1.1
                    @Override // kotlin.jvm.functions.Function1
                ...
                Observable<TLRPC$ChannelParticipant> onErrorReturn = chatParticipant.onErrorReturn(new Function() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$prepareCryptoBoxMessageRefresh$1$1$1$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        ...
                        invoke$lambda$0 = WalletTokenDetailsPresenter$prepareCryptoBoxMessageRefresh$1.C23081.C23091.invoke$lambda$0(Function1.this, obj);
                        return invoke$lambda$0;
                    }
                });
                final C23112 c23112 = new Function1<TLRPC$ChannelParticipant, Boolean>() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter.prepareCryptoBoxMessageRefresh.1.1.1.2
                    @Override // kotlin.jvm.functions.Function1
                ...
                return onErrorReturn.map(new Function() { // from class: com.iMe.ui.wallet.home.details.WalletTokenDetailsPresenter$prepareCryptoBoxMessageRefresh$1$1$1$$ExternalSyntheticLambda1
                    ...
                    public final Object apply(Object obj) {
                        ...
                        invoke$lambda$1 = WalletTokenDetailsPresenter$prepareCryptoBoxMessageRefresh$1.C23081.C23091.invoke$lambda$1(Function1.this, obj);
                        return invoke$lambda$1;
                    }
                });
            }
