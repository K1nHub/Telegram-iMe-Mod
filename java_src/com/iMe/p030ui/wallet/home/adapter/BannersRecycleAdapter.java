...
public final class BannersRecycleAdapter extends BaseQuickAdapter<SlideItem, BaseViewHolder> {
    ...
    public BannersRecycleAdapter(ResourceManager resourceManager) {
        super(C3630R.layout.fork_recycle_item_wallet_banner_slide, null, 2, null);
    ...
    public final void pauseAnimation() {
        View viewByPosition = getViewByPosition(this.currentAnimatedBanner, C3630R.C3633id.image_banner_image);
    ...
    protected void convert2(BaseViewHolder holder, SlideItem item, List<? extends Object> payloads) {
        ...
        if (firstOrNull instanceof Boolean) {
            BaseQuickAdapterExtKt.applyForView(holder, C3630R.C3633id.image_banner_image, new Function1<RLottieImageView, Unit>() { // from class: com.iMe.ui.wallet.home.adapter.BannersRecycleAdapter$convert$1$1
    ...
    public void convert(final BaseViewHolder holder, final SlideItem item) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        Intrinsics.checkNotNullParameter(item, "item");
        int i = C3630R.C3633id.card_banner_slide;
        ...
        int i3 = C3630R.C3633id.text_banner_title;
        int i4 = C3630R.C3633id.text_banner_description;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedCardBackground, i2, i3, i4), i3).setText(i3, this.resourceManager.getString(item.getSlide().getTitle())).setText(i4, this.resourceManager.getString(item.getSlide().getShortDescription())), C3630R.C3633id.image_banner_image, new Function1<RLottieImageView, Unit>() { // from class: com.iMe.ui.wallet.home.adapter.BannersRecycleAdapter$convert$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
