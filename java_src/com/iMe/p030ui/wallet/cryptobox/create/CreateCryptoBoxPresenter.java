...
public final class CreateCryptoBoxPresenter extends BasePresenter<CreateCryptoBoxView> implements NotificationCenter.NotificationCenterDelegate {
    ...
    public CreateCryptoBoxPresenter(TLRPC$Chat tLRPC$Chat, Network network, CryptoBoxInteractor cryptoBoxInteractor, CryptoPreferenceHelper cryptoPreferenceHelper, ResourceManager resourceManager, RxEventBus rxEventBus, SchedulersProvider schedulersProvider, TelegramControllersGateway telegramControllersGateway, TelegramApi telegramApi, WalletInteractor walletInteractor) {
        ...
        this.walletBotId = AppConfiguration$Bots.getAuthBotId();
        this.walletBotUsername = AppConfiguration$Bots.getAuthBotUsername();
    ...
    public final void onSelectChatClick() {
        ...
        createCryptoBoxView.openSelectChatScreen(tLRPC$Chat != null ? Long.valueOf(tLRPC$Chat.f1600id) : null);
    }
    ...
    public final void onTokenSelected(TokenDetailed selectedToken) {
        ...
        Observable<Result<TokenBalance>> observeOn = this.walletInteractor.getTokenBalance(TokenExtKt.toIndexedToken(selectedToken), true, this.selectedNetworkItem.getNetworkId()).observeOn(this.schedulersProvider.mo1009ui());
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends TokenBalance>, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$onTokenSelected$$inlined$subscribeWithErrorHandle$default$1
            ...
            public final void m1691invoke(Result<? extends TokenBalance> it) {
                ...
                if (result instanceof Result.Success) {
                    ...
                    String string = resourceManager2.getString(C3630R.string.wallet_common_token_name_with_ticker, token.getName(), token.getTicker());
    ...
    public final void onChatSelected(Long l) {
        if (l == null) {
            ((CreateCryptoBoxView) getViewState()).showToast(this.resourceManager.getString(C3630R.string.common_error_unexpected));
            return;
        }
        TLRPC$Chat tLRPC$Chat = this.selectedChat;
        if (tLRPC$Chat != null && (-l.longValue()) == tLRPC$Chat.f1600id) {
            return;
        }
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Boolean, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$onChatSelected$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1690invoke(Boolean it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
                Boolean bool = it;
                if (!TLRPC$Chat.this.creator) {
                    resourceManager = this.resourceManager;
                    ((CreateCryptoBoxView) this.getViewState()).showToast(resourceManager.getString(C3630R.string.cryptobox_create_user_not_owner));
    ...
    public final void onCryptoBoxInfoClick() {
        ...
        if (cryptoBoxCreationRules != null) {
            ((CreateCryptoBoxView) getViewState()).showCryptoBoxInfoDialog(this.resourceManager.getString(C3630R.string.cryptobox_create_cryptobox_information_description, BalanceFormatter.INSTANCE.formatTokenBalance(new BigDecimal(String.valueOf(cryptoBoxCreationRules.getFeePerUser())), cryptoBoxCreationRules.getFeeToken())));
        }
    }
    ...
    public final void onReplenishClick() {
        ...
        createCryptoBoxView.openBuyScreen(new TokenBuyCoordinatorArgs(null, token, SwapProtocol.Companion.resolveByNetworkId(this.cryptoPreferenceHelper.getNetworkId()), null, 9, null));
    }
    ...
    public final void pushCurrentCryptoBoxParamsValues() {
        this.cryptoBoxParamsSubject.onNext(TuplesKt.m144to(NumberExtKt.orZero(this.selectedAmount), Integer.valueOf(NumberExtKt.orZero(this.selectedCapacity))));
    }
    ...
    private final void subscribeToCryptoBoxParamsSubject() {
        ...
        final Function1<Pair<? extends BigDecimal, ? extends Integer>, Result<? extends CryptoBoxCreationRulesItem>> function1 = new Function1<Pair<? extends BigDecimal, ? extends Integer>, Result<? extends CryptoBoxCreationRulesItem>>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$subscribeToCryptoBoxParamsSubject$1
            ...
            public final Result<CryptoBoxCreationRulesItem> invoke2(Pair<? extends BigDecimal, Integer> it) {
                ...
                if (token == null) {
                    ...
                    resourceManager = CreateCryptoBoxPresenter.this.resourceManager;
                    int i = C3630R.string.cryptobox_create_cryptobox_information_amount;
                    ...
                    objArr[1] = StringExtKt.orZero(tokenBalance2 != null ? TokenBalanceExtKt.getInsertedTokenAmountInDollars(tokenBalance2, multiply.doubleValue()) : null);
                    string = resourceManager.getString(i, objArr);
                }
                BalanceFormatter balanceFormatter = BalanceFormatter.INSTANCE;
                return Result.Companion.success(new CryptoBoxCreationRulesItem(balanceFormatter.formatTokenBalance(multiply2, cryptoBoxCreationRules.getFeeToken()), string, balanceFormatter.formatTokenBalance(new BigDecimal(String.valueOf(cryptoBoxCreationRules.getFeePerCryptobox())), cryptoBoxCreationRules.getFeeToken()), balanceFormatter.formatTokenBalance(add, cryptoBoxCreationRules.getFeeToken())));
            }
        };
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends CryptoBoxCreationRulesItem>, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$subscribeToCryptoBoxParamsSubject$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1693invoke(Result<? extends CryptoBoxCreationRulesItem> it) {
                ...
                if (result instanceof Result.Success) {
                    ...
                    if (Intrinsics.areEqual(transactionStep2, TransactionStep.CryptoBoxExecute.INSTANCE)) {
                        CreateCryptoBoxPresenter.setupTransactionAction$default(CreateCryptoBoxPresenter.this, new TransactionStep.Idle(C3630R.string.common_create), null, 2, null);
                    }
                    ...
                    num = CreateCryptoBoxPresenter.this.selectedCapacity;
                    BigDecimal valueOf = BigDecimal.valueOf(NumberExtKt.orZero(num));
                    Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
                    BigDecimal multiply = orZero.multiply(valueOf);
                    Intrinsics.checkNotNullExpressionValue(multiply, "this.multiply(other)");
                    tokenBalance = CreateCryptoBoxPresenter.this.selectedTokenBalance;
                    if (tokenBalance != null) {
                        CreateCryptoBoxPresenter.this.showAmountError(multiply.compareTo(new BigDecimal(String.valueOf(tokenBalance.getTotal()))) > 0);
                    }
                    num2 = CreateCryptoBoxPresenter.this.selectedCapacity;
                    if (num2 != null) {
                        int intValue = num2.intValue();
                        CreateCryptoBoxPresenter createCryptoBoxPresenter = CreateCryptoBoxPresenter.this;
                        cryptoBoxCreationRules = createCryptoBoxPresenter.creationRules;
                        createCryptoBoxPresenter.showCapacityError(intValue < NumberExtKt.orZero(cryptoBoxCreationRules != null ? Integer.valueOf(cryptoBoxCreationRules.getMinimalCapacity()) : null));
                    }
                } else if (result instanceof Result.Error) {
                    ...
                    CreateCryptoBoxPresenter.this.renderCryptoBoxRulesPlaceholderData(C3630R.string.common_error);
                    resourceManager = CreateCryptoBoxPresenter.this.resourceManager;
                    ((CreateCryptoBoxView) CreateCryptoBoxPresenter.this.getViewState()).showErrorToast((Result.Error) result, resourceManager);
                }
            }
    ...
    private final void loadRules() {
        ...
        renderCryptoBoxRulesPlaceholderData(C3630R.string.common_progress_state_title);
        Observable<Result<CryptoBoxCreationRules>> observeOn = this.cryptoBoxInteractor.getCreationRules(this.selectedNetworkItem.getNetworkId()).observeOn(this.schedulersProvider.mo1009ui());
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends CryptoBoxCreationRules>, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$loadRules$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1689invoke(Result<? extends CryptoBoxCreationRules> it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    public final TransactionStep getStepByApprovalStatus(CryptoBoxTokenApprovalStatus cryptoBoxTokenApprovalStatus, String str) {
        ...
        if (i != -1) {
            if (i != 1) {
                if (i != 2) {
                    if (i == 3) {
                        return new TransactionStep.Idle(C3630R.string.common_create);
                    }
    ...
    public final void checkTokenApproval(final TokenDetailed tokenDetailed, final boolean z, final boolean z2) {
        ...
        Observable<R> flatMap = interval.flatMap(new Function() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$$ExternalSyntheticLambda3
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                ObservableSource checkTokenApproval$lambda$14;
                checkTokenApproval$lambda$14 = CreateCryptoBoxPresenter.checkTokenApproval$lambda$14(Function1.this, obj);
                return checkTokenApproval$lambda$14;
            }
        });
        Intrinsics.checkNotNullExpressionValue(flatMap, "private fun checkTokenAp…y { autoDispose() }\n    }");
        Observable flatMap2 = flatMap.flatMap(new C2229x7c925b1e(new Function1<Result<? extends CryptoBoxTokenApprovalInfo>, ObservableSource<? extends Result<? extends Pair<? extends TransactionStep, ? extends FeeType>>>>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$checkTokenApproval$$inlined$flatMapSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            */
            public final io.reactivex.ObservableSource<? extends com.iMe.storage.domain.model.Result<? extends kotlin.Pair<? extends com.iMe.model.staking.TransactionStep, ? extends com.iMe.model.wallet.crypto.send.fee.FeeType>>> invoke(com.iMe.storage.domain.model.Result<? extends com.iMe.storage.domain.model.crypto.cryptobox.CryptoBoxTokenApprovalInfo> r5) {
                /*
                    ...
                    com.iMe.p030ui.wallet.cryptobox.create.CreateCryptoBoxPresenter.access$setFeeTokenApprovalStatus$p(r2, r5)
                    goto L33
                L2e:
                    com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter r2 = r2
                    com.iMe.p030ui.wallet.cryptobox.create.CreateCryptoBoxPresenter.access$setTokenApprovalStatus$p(r2, r5)
                L33:
                    ...
                    if (r2 != 0) goto L47
                    com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter r2 = r2
                    com.iMe.storage.domain.model.crypto.cryptobox.CryptoBoxTokenApprovalStatus r3 = com.iMe.p030ui.wallet.cryptobox.create.CreateCryptoBoxPresenter.access$getFeeTokenApprovalStatus$p(r2)
                    boolean r2 = com.iMe.p030ui.wallet.cryptobox.create.CreateCryptoBoxPresenter.access$isDone(r2, r3)
                    if (r2 == 0) goto L71
                L47:
                    com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter r5 = r2
                    com.iMe.storage.domain.interactor.crypto.cryptobox.CryptoBoxInteractor r5 = com.iMe.p030ui.wallet.cryptobox.create.CreateCryptoBoxPresenter.access$getCryptoBoxInteractor$p(r5)
                    ...
                    com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$checkTokenApproval$lambda$16$$inlined$mapSuccess$1 r1 = new com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$checkTokenApproval$lambda$16$$inlined$mapSuccess$1
                    com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter r2 = r2
                    boolean r3 = r1
                    r1.<init>()
                ...
                L71:
                    ...
                    com.iMe.model.staking.TransactionStep r5 = com.iMe.p030ui.wallet.cryptobox.create.CreateCryptoBoxPresenter.access$getStepByApprovalStatus(r2, r5, r0)
                    kotlin.Pair r5 = kotlin.TuplesKt.m144to(r5, r1)
                ...
                Lae:
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: com.iMe.p030ui.wallet.cryptobox.create.C2208x8ca852e4.invoke(com.iMe.storage.domain.model.Result):io.reactivex.ObservableSource");
            }
        }));
        Intrinsics.checkNotNullExpressionValue(flatMap2, "crossinline body: (T) ->…e.empty()\n        }\n    }");
        Observable observeOn = flatMap2.observeOn(this.schedulersProvider.mo1009ui());
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Pair<? extends TransactionStep, ? extends FeeType>>, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$checkTokenApproval$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1686invoke(Result<? extends Pair<? extends TransactionStep, ? extends FeeType>> it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ObservableSource checkTokenApproval$lambda$14(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return (ObservableSource) tmp0.invoke(obj);
    }
    ...
    public final void onApprovalCheckSuccess(boolean z, TransactionStep transactionStep, FeeType feeType) {
        if (z) {
            ...
            if (isDone(this.feeTokenApprovalStatus)) {
                ...
                TokenDetailed token = tokenBalance != null ? tokenBalance.getToken() : null;
                if (token == null) {
                    transactionStep = new TransactionStep.Idle(C3630R.string.common_create);
                } else {
    ...
    public final void executeTokenApproval() {
        ...
        Observable<Result<String>> observeOn = cryptoBoxInteractor.sendApprovalExecute(cryptoBoxTransactionArgs).observeOn(this.schedulersProvider.mo1009ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoBoxInteractor\n    …(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Observable withLoadingDialog$default = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null);
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends String>, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$executeTokenApproval$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1688invoke(Result<? extends String> it) {
                ResourceManager resourceManager;
                boolean z;
                TokenBalance tokenBalance;
                boolean z2;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onWalletBotAdminRightsRequired$lambda$20(CreateCryptoBoxPresenter this$0, TLRPC$Chat chat) {
    ...
    private final void confirmCryptoboxExecution() {
        ...
        createCryptoBoxView.showConfirmDialog(getCreateConfirmationDialogModel(format, str), new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$$ExternalSyntheticLambda1
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                CreateCryptoBoxPresenter.confirmCryptoboxExecution$lambda$21(CreateCryptoBoxPresenter.this);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void confirmCryptoboxExecution$lambda$21(CreateCryptoBoxPresenter this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.executeAction();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void validatePrepareConditions() {
        BigDecimal bigDecimal;
        Integer num;
        BigDecimal orZero = NumberExtKt.orZero(this.selectedAmount);
        BigDecimal valueOf = BigDecimal.valueOf(NumberExtKt.orZero(this.selectedCapacity));
        ...
        BigDecimal multiply = orZero.multiply(valueOf);
        Intrinsics.checkNotNullExpressionValue(multiply, "this.multiply(other)");
        if (this.selectedTokenBalance == null || (bigDecimal = this.selectedAmount) == null || NumberExtKt.isZero(NumberExtKt.orZero(bigDecimal)) || (num = this.selectedCapacity) == null) {
            return;
        }
        ...
        if (orZero2 >= NumberExtKt.orZero(cryptoBoxCreationRules != null ? Integer.valueOf(cryptoBoxCreationRules.getMinimalCapacity()) : null)) {
            TokenBalance tokenBalance = this.selectedTokenBalance;
            if (new BigDecimal(String.valueOf(NumberExtKt.orZero(tokenBalance != null ? Double.valueOf(tokenBalance.getTotal()) : null))).compareTo(multiply) < 0 || this.selectedChat == null || !isDone(this.feeTokenApprovalStatus) || !isDone(this.tokenApprovalStatus)) {
                return;
            }
            prepareCreation();
        }
    ...
    private final void prepareCreation() {
        ...
        Observable<Result<CryptoBoxTransactionAction>> observeOn = cryptoBoxInteractor.getCreationPrepareData(networkId, address, NumberExtKt.orZero(this.selectedAmount), NumberExtKt.orZero(this.selectedCapacity)).observeOn(this.schedulersProvider.mo1009ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoBoxInteractor\n    …(schedulersProvider.ui())");
        final BaseView baseView = (BaseView) getViewState();
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends CryptoBoxTransactionAction>, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$prepareCreation$$inlined$subscribeWithErrorHandle$default$1
            {
                super(1);
            }
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1692invoke(Result<? extends CryptoBoxTransactionAction> it) {
                ResourceManager resourceManager;
                ResourceManager resourceManager2;
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    private final void executeAction() {
        ...
        Observable<Result<String>> observeOn = this.cryptoBoxInteractor.sendCreationExecute(valueOf.longValue(), this.selectedDescription, cryptoBoxTransactionArgs).observeOn(this.schedulersProvider.mo1009ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoBoxInteractor\n    …(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Observable withLoadingDialog$default = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null);
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends String>, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$executeAction$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1687invoke(Result<? extends String> it) {
                ResourceManager resourceManager;
    ...
    private final DialogModel getApproveConfirmationDialogModel(String str) {
        return new DialogModel(this.resourceManager.getString(C3630R.string.wallet_swap_process_confirm_approve_alert_title), this.resourceManager.getString(C3630R.string.wallet_swap_process_confirm_approve_alert_description, str), this.resourceManager.getString(C3630R.string.common_cancel), this.resourceManager.getString(C3630R.string.wallet_swap_process_confirm_approve_alert_action));
    }

    private final DialogModel getCreateConfirmationDialogModel(String str, String str2) {
        return new DialogModel(this.resourceManager.getString(C3630R.string.profile_twitter_link_confirmation_alert_title), this.resourceManager.getString(C3630R.string.cryptobox_create_confirmation_description, str, str2), this.resourceManager.getString(C3630R.string.common_cancel), this.resourceManager.getString(C3630R.string.cryptobox_action_type_create));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void renderCryptoBoxRulesPlaceholderData(int i) {
        String string = this.resourceManager.getString(i);
        ((CreateCryptoBoxView) getViewState()).renderCryptoBoxCreationRules(new CryptoBoxCreationRulesItem(string, string, string, string), false);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void showAmountError(boolean z) {
        ((CreateCryptoBoxView) getViewState()).setupAmountInputErrorState(z, this.resourceManager.getString(C3630R.string.wallet_amount_send_error_insufficient_funds), FeatureAvailableManager$Token.INSTANCE.isPurchaseAvailable(this.selectedNetworkItem.getNetworkId()) ? this.resourceManager.getString(C3630R.string.wallet_token_details_action_buy) : "");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void showCapacityError(boolean z) {
        String str;
        if (z) {
            ResourceManager resourceManager = this.resourceManager;
            int i = C3630R.string.cryptobox_create_enter_capacity_threshold_error;
        ...
        ((CreateCryptoBoxView) getViewState()).setupCapacityInputErrorState(z, str);
    }
