...
public final class CreateCryptoBoxPresenter$onChatSelected$1 extends Lambda implements Function1<TLRPC$ChatFull, ObservableSource<? extends Boolean>> {
    ...
    public final ObservableSource<? extends Boolean> invoke(TLRPC$ChatFull chatFull) {
        ...
        final C22301 c22301 = new C22301(this.this$0, this.$chat);
    ...
    /* loaded from: classes3.dex */
    public static final class C22301 extends Lambda implements Function1<TLRPC$User, ObservableSource<? extends Boolean>> {
        final /* synthetic */ TLRPC$Chat $chat;
        final /* synthetic */ CreateCryptoBoxPresenter this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22301(CreateCryptoBoxPresenter createCryptoBoxPresenter, TLRPC$Chat tLRPC$Chat) {
            super(1);
            this.this$0 = createCryptoBoxPresenter;
            this.$chat = tLRPC$Chat;
        }
        ...
        public final ObservableSource<? extends Boolean> invoke(TLRPC$User botUser) {
            ...
            final C22311 c22311 = new Function1<Throwable, TLRPC$ChannelParticipant>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter.onChatSelected.1.1.1
                @Override // kotlin.jvm.functions.Function1
            ...
            Observable<TLRPC$ChannelParticipant> onErrorReturn = chatParticipant.onErrorReturn(new Function() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$onChatSelected$1$1$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    ...
                    invoke$lambda$0 = CreateCryptoBoxPresenter$onChatSelected$1.C22301.invoke$lambda$0(Function1.this, obj);
                    return invoke$lambda$0;
                }
            });
            final C22322 c22322 = new Function1<TLRPC$ChannelParticipant, Boolean>() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter.onChatSelected.1.1.2
                @Override // kotlin.jvm.functions.Function1
            ...
            return onErrorReturn.map(new Function() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxPresenter$onChatSelected$1$1$$ExternalSyntheticLambda1
                ...
                public final Object apply(Object obj) {
                    ...
                    invoke$lambda$1 = CreateCryptoBoxPresenter$onChatSelected$1.C22301.invoke$lambda$1(Function1.this, obj);
                    return invoke$lambda$1;
                }
            });
        }
