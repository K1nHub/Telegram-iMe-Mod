...
public final class CryptoBoxesPresenter extends BasePresenter<CryptoBoxesView> {
    ...
    public final void onSelectOrderClick() {
        ...
        DialogModel dialogModel = new DialogModel(this.resourceManager.getString(C3632R.string.choose_tokens_order_type_dialog_title), null, null, this.resourceManager.getString(C3632R.string.common_cancel), 6, null);
    ...
    public final void loadCryptoBoxes(final boolean z) {
        ...
        TLRPC$Chat tLRPC$Chat = this.chat;
        Observable<Result<List<CryptoBoxInfo>>> observeOn = cryptoBoxInteractor.getCryptoBoxesList(tLRPC$Chat != null ? Long.valueOf(ChatExtKt.getBotApiId(tLRPC$Chat)) : null, this.selectedNetworkItem.getNetworkId(), getSelectedOrderType()).observeOn(this.schedulersProvider.mo1013ui());
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends List<? extends CryptoBoxInfo>>, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.CryptoBoxesPresenter$loadCryptoBoxes$$inlined$subscribeWithErrorHandle$default$1
            ...
            public final void m1679invoke(Result<? extends List<? extends CryptoBoxInfo>> it) {
    ...
    private final void listenEvents() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<RxEvent, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.CryptoBoxesPresenter$listenEvents$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1678invoke(RxEvent it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
                RxEvent rxEvent = it;
    ...
    public final void renderCryptoBoxesItems(List<CryptoBoxInfo> list) {
        ...
        if (!this.cryptoBoxesItems.isEmpty()) {
            ...
            renderItems((BaseNode[]) Arrays.copyOf(cryptoBoxItemArr, cryptoBoxItemArr.length), true);
            return;
        }
    ...
    public final List<BaseNode> initRootItems() {
        ...
        noChildNodeArr[0] = new AnimatedHeaderItem(C3632R.raw.fork_cryptoboxes, this.resourceManager.getString(C3632R.string.cryptoboxes_description), new AnimatedHeaderItem.Button(this.resourceManager.getString(C3632R.string.cryptoboxes_create_new), Integer.valueOf(C3632R.C3634drawable.fork_ic_add)));
        TLRPC$Chat tLRPC$Chat = this.chat;
    ...
    private final String initCryptoBoxesListHeaderTitle() {
        return this.resourceManager.getString(this.chat != null ? C3632R.string.cryptoboxes_last_list_title : C3632R.string.cryptoboxes_all_list_title);
    }
    ...
    private final void renderItems(BaseNode[] baseNodeArr, boolean z) {
        ...
        mutableList.add(new SortingListHeaderItem(this.cryptoBoxesListHeaderTitle, z));
    ...
    private final void prepareCryptoBoxCreation(final TLRPC$Chat tLRPC$Chat) {
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Boolean, Unit>() { // from class: com.iMe.ui.wallet.cryptobox.CryptoBoxesPresenter$prepareCryptoBoxCreation$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1680invoke(Boolean it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
                Boolean bool = it;
                if (!TLRPC$Chat.this.creator) {
                    resourceManager = this.resourceManager;
                    ((CryptoBoxesView) this.getViewState()).showToast(resourceManager.getString(C3632R.string.cryptobox_create_user_not_owner));
