...
import com.iMe.p030ui.wallet.staking.operations.StakingOperationsFragment;
import com.iMe.p030ui.wallet.staking.programmes.StakingProgrammesFragment;
...
public final class StakingFragment extends WalletAuthBaseFragment implements StakingView, NavigationViewConfiguration, TabbedViewPagerDelegate<TabbedFragmentPage<MvpFragment>> {
    ...
    @Override // com.iMe.p030ui.wallet.staking.StakingView
    public void onTabSelected(int i) {
        CollapsableHeaderTabbedViewPager collapsableHeaderTabbedViewPager = getBinding().stakingPager;
        if (collapsableHeaderTabbedViewPager.getPager().currentPosition != i) {
    ...
    private final void setupActionBar() {
        ...
        c3704ActionBar.setTitle(getResourceManager().getString(C3632R.string.staking_title));
        c3704ActionBar.setAllowOverlayTitle(true);
        c3704ActionBar.createMenu().addItem(IdFabric$Menu.STAKING_HELP, C3632R.C3634drawable.msg_help);
        c3704ActionBar.setActionBarMenuOnItemClick(new C3704ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.staking.StakingFragment$setupActionBar$1$1
    ...
    public final void showInfoDialog() {
        showDialog(DialogsFactoryKt.createDialogInfoWithAnimation$default(this, 0, null, getResourceManager().getString(C3632R.string.staking_info_description), 8388611, getResourceManager().getString(C3632R.string.staking_info_more), null, 35, null), new DialogInterface.OnDismissListener() { // from class: com.iMe.ui.wallet.staking.StakingFragment$$ExternalSyntheticLambda0
    ...
    public static final void showInfoDialog$lambda$12(StakingFragment this$0, DialogInterface dialogInterface) {
        ...
        Browser.openUrl(this$0.getParentActivity(), this$0.getResourceManager().getString(C3632R.string.staking_info_site_url));
    }
    ...
    private final void setupListeners() {
        getBinding().getRoot().setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.iMe.ui.wallet.staking.StakingFragment$$ExternalSyntheticLambda1
            @Override // androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener
            public final void onRefresh() {
                StakingFragment.setupListeners$lambda$14(StakingFragment.this);
            }
        });
        getDashboardView().setupListeners(new Callbacks$Callback() { // from class: com.iMe.ui.wallet.staking.StakingFragment$$ExternalSyntheticLambda2
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                StakingFragment.setupListeners$lambda$15(StakingFragment.this);
            }
        }, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.staking.StakingFragment$$ExternalSyntheticLambda3
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
