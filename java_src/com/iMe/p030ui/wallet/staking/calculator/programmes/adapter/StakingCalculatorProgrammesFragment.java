...
public final class StakingCalculatorProgrammesFragment extends WalletAuthBaseFragment implements StakingCalculatorProgrammesView {
    ...
    private final void setupActionBar() {
        ...
        c3702ActionBar.setTitle(getResourceManager().getString(C3630R.string.staking_calculator_select_programme));
        c3702ActionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.staking.calculator.programmes.adapter.StakingCalculatorProgrammesFragment$setupActionBar$1$1
