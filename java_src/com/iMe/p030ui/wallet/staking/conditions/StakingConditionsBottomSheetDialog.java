...
public final class StakingConditionsBottomSheetDialog extends MvpBottomSheet implements StakingConditionsView {
    ...
    */
    ...
    private final void setupColors() {
        ...
        binding.buttonOk.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m107dp(4), Theme.getColor(Theme.key_featuredStickers_addButton), ViewExtKt.withAlpha(Theme.getColor(Theme.key_windowBackgroundWhite), 120)));
    }
