...
public final class StakingConditionsPresenter extends BasePresenter<StakingConditionsView> {
    ...
    public void onFirstViewAttach() {
        ...
        String string = this.resourceManager.getString(C3630R.string.staking_details_apy_apr_values, stakingDetailsItem.getFormattedAPR(), stakingDetailsItem.getFormattedAPY());
        ...
        int i = C3630R.string.staking_conditions_fee_value;
