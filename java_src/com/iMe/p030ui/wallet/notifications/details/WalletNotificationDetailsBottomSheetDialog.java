    ...
    */
    public WalletNotificationDetailsBottomSheetDialog(org.telegram.p043ui.ActionBar.BaseFragment r5, com.iMe.model.wallet.notification.NotificationItem r6) {
        /*
            ...
            r2.<init>()
            java.lang.Class<com.iMe.ui.wallet.notifications.details.WalletNotificationDetailsPresenter> r3 = com.iMe.p030ui.wallet.notifications.details.WalletNotificationDetailsPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p030ui.wallet.notifications.details.WalletNotificationDetailsBottomSheetDialog.<init>(org.telegram.ui.ActionBar.BaseFragment, com.iMe.model.wallet.notification.NotificationItem):void");
    }
    ...
    @Override // com.iMe.p030ui.wallet.notifications.details.WalletNotificationDetailsView
    ...
    public void setupMessageClickableLink(String message, String clickableText, final Function0<Unit> action) {
        ...
        if (clickableText.length() > 0) {
            ...
            ViewExtKt.setSubstringClickListener$default(setupMessageClickableLink$lambda$4, clickableText, false, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.notifications.details.WalletNotificationDetailsBottomSheetDialog$$ExternalSyntheticLambda1
