...
public final class WalletSendRecipientPresenter extends BasePresenter<WalletSendRecipientView> {
    ...
    public final ArrayList<SendMessagesHelper.SendingMediaInfo> getSendingMediaInfo() {
        ...
        int i = C3632R.string.wallet_recipient_error_send_message_invitation;
        int i2 = C3632R.string.wallet_backup_secret_words_pdf_title;
        ResourceManager resourceManager2 = this.resourceManager;
        int i3 = C3632R.string.neurobots_store_bot_action_download;
        ...
        sendingMediaInfo.uri = this.resourceManager.getUriDrawable(C3632R.C3634drawable.fork_banner_ime);
    ...
    private final void validateRecipientAddress(String str, boolean z) {
        ...
        Observable<Result<SendCryptoQRData>> observeOn = CryptoHelper.extractAddressAndAmount(str, this.currentNetworkType.getBlockchainType(), this.cryptoWalletInteractor).observeOn(this.schedulersProvider.mo1013ui());
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends SendCryptoQRData>, Unit>() { // from class: com.iMe.ui.wallet.actions.send.recipient.WalletSendRecipientPresenter$validateRecipientAddress$$inlined$subscribeWithErrorHandle$default$1
            ...
            public final void m1620invoke(Result<? extends SendCryptoQRData> it) {
                ...
                if (result instanceof Result.Success) {
                    ...
                    if (!(((SendCryptoQRData) success.getData()).getAddress().length() > 0)) {
                        ...
                        ((WalletSendRecipientView) WalletSendRecipientPresenter.this.getViewState()).showToast(resourceManager.getString(C3632R.string.wallet_recipient_validation_address_error));
                        return;
                    }
