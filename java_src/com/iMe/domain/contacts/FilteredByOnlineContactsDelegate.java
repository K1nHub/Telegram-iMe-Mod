...
public final class FilteredByOnlineContactsDelegate extends BaseController {
    ...
    public final boolean userIsOnline(TLRPC$User tLRPC$User) {
        ...
        return (tLRPC$UserStatus != null && tLRPC$UserStatus.expires > getConnectionsManager().getCurrentTime()) || getMessagesController().onlinePrivacy.containsKey(Long.valueOf(tLRPC$User.f1574id));
    }
}
