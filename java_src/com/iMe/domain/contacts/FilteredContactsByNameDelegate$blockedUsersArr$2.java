...
public final class FilteredContactsByNameDelegate$blockedUsersArr$2 extends Lambda implements Function0<ArrayList<String>> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: FilteredContactsByNameDelegate.kt */
    /* renamed from: com.iMe.domain.contacts.FilteredContactsByNameDelegate$blockedUsersArr$2$1 */
    /* loaded from: classes3.dex */
    public static final class C14101 extends Lambda implements Function1<TLRPC$TL_contact, Boolean> {
        final /* synthetic */ FilteredContactsByNameDelegate this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C14101(FilteredContactsByNameDelegate filteredContactsByNameDelegate) {
            super(1);
            this.this$0 = filteredContactsByNameDelegate;
        }
    ...
    public final ArrayList<String> invoke() {
        ...
        arrCharsByPredicate = filteredContactsByNameDelegate.getArrCharsByPredicate(new C14101(filteredContactsByNameDelegate));
