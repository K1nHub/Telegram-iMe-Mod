...
public final class TelegramControllersGatewayImpl implements TelegramControllersGateway {
    ...
    @Override // com.iMe.gateway.TelegramControllersGateway
    public ConnectionsManager getConnectionsManager(int i) {
        Object telegramControllersGatewayImpl = getInstance(ConnectionsManager.getInstance(getSelectedAccount(i)));
        Intrinsics.checkNotNullExpressionValue(telegramControllersGatewayImpl, "getInstance(ConnectionsM…ccount(selectedAccount)))");
        return (ConnectionsManager) telegramControllersGatewayImpl;
    }
