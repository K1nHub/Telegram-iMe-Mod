...
public final class StakingOperationResponse {
    ...
    public int hashCode() {
        int m1020m = ((((((((((((ProfileData$$ExternalSyntheticBackport0.m1020m(this.f281id) * 31) + this.stakingId) * 31) + this.transaction.hashCode()) * 31) + this.type.hashCode()) * 31) + this.status.hashCode()) * 31) + this.issuer.hashCode()) * 31) + this.issuedAt.hashCode()) * 31;
