package com.iMe.i_staking.p024di;
...
public final class StakingModuleKt {
    ...
    private static Module stakingModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C14771 c14771 = new Function2<Scope, ParametersHolder, Retrofit>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.1
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(Retrofit.class), staking_retrofit, c14771, kind, emptyList));
            ...
            C14782 c14782 = new Function2<Scope, ParametersHolder, OkHttpClient>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(OkHttpClient.class), staking_client, c14782, kind, emptyList2));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C14793 c14793 = new Function2<Scope, ParametersHolder, StakingApi>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(StakingApi.class), null, c14793, kind, emptyList3));
            module.indexPrimaryType(singleInstanceFactory3);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory3);
            }
            new KoinDefinition(module, singleInstanceFactory3);
            C14804 c14804 = new Function2<Scope, ParametersHolder, StakingDataSource>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory4 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(StakingDataSource.class), null, c14804, kind, emptyList4));
            module.indexPrimaryType(singleInstanceFactory4);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory4);
            }
            new KoinDefinition(module, singleInstanceFactory4);
            C14815 c14815 = new Function2<Scope, ParametersHolder, StakingRepository>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory5 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(StakingRepository.class), null, c14815, kind, emptyList5));
            module.indexPrimaryType(singleInstanceFactory5);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory5);
            }
            new KoinDefinition(module, singleInstanceFactory5);
            C14826 c14826 = new Function2<Scope, ParametersHolder, StakingInteractor>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory6 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(StakingInteractor.class), null, c14826, kind, emptyList6));
