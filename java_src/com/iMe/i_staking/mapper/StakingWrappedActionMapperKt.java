    ...
    public static final Pair<String, StakingTransactionAction> mapToDomain(StakingWrappedActionResponse stakingWrappedActionResponse) {
        ...
        try {
            ...
            if (stakingTransactionGas != null) {
                return TuplesKt.m100to(stakingWrappedActionResponse.getWrappedAction(), new StakingTransactionAction(stakingTransactionArgs, stakingTransactionGas));
            }
            throw new Throwable();
        } catch (Exception e) {
            Timber.m4e(e);
            return TuplesKt.m100to(stakingWrappedActionResponse.getWrappedAction(), null);
        }
    }
}
