    ...
    public static final Pair<String, StakingTransactionAction> mapToDomain(StakingWrappedActionResponse stakingWrappedActionResponse) {
        ...
        try {
            ...
            if (stakingTransactionGas != null) {
                ...
                return TuplesKt.m149to(stakingWrappedActionResponse.getWrappedAction(), new StakingTransactionAction(stakingTransactionArgs, stakingTransactionGas));
            }
            throw new Throwable();
        } catch (Exception e) {
            Timber.m6e(e);
            return TuplesKt.m149to(stakingWrappedActionResponse.getWrappedAction(), null);
        }
    }
}
