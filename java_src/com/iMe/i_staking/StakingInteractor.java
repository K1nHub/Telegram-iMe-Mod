...
public final class StakingInteractor {
    ...
    public final Observable<Result<StakingTotalStats>> getStakingTotalStats() {
        Observable<Result<StakingTotalStats>> subscribeOn = this.stakingRepository.getStakingTotalStats().startWith((Observable<Result<StakingTotalStats>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
    ...
    public final Observable<Result<StakingProgrammes>> getStakingProgrammesList(StakingOrderType orderType, Long l) {
        ...
        Observable<Result<StakingProgrammes>> subscribeOn = this.stakingRepository.getStakingProgrammesList(orderType, l).startWith((Observable<Result<StakingProgrammes>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<StakingProgrammes>> getStakingOwnProgrammesList(StakingOrderType orderType, Long l, StakingProgrammesFilterType filterType) {
        ...
        Observable<Result<StakingProgrammes>> subscribeOn = this.stakingRepository.getStakingOwnProgrammesList(orderType, l, filterType).startWith((Observable<Result<StakingProgrammes>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }

    public final Observable<Result<StakingDetailedMetadata>> getStakingDetails(long j) {
        Observable<Result<StakingDetailedMetadata>> subscribeOn = this.stakingRepository.getStakingDetails(j).startWith((Observable<Result<StakingDetailedMetadata>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<StakingApprovalInfo>> getApprovalInfo(long j) {
        Observable<Result<StakingApprovalInfo>> subscribeOn = this.stakingRepository.getApprovalInfo(j).startWith((Observable<Result<StakingApprovalInfo>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Pair<String, StakingTransactionAction>>> sendApprovalPrepare(long j, StakingApprovalTokenType tokenType) {
        ...
        Observable<Result<Pair<String, StakingTransactionAction>>> subscribeOn = this.stakingRepository.sendApprovalPrepare(j, tokenType).startWith((Observable<Result<Pair<String, StakingTransactionAction>>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<StakingOperation>> sendApprovalExecute(String wrappedAction, StakingTransactionArgs args) {
        ...
        Observable<Result<StakingOperation>> subscribeOn = this.stakingRepository.sendApprovalExecute(wrappedAction, args).startWith((Observable<Result<StakingOperation>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Pair<String, StakingTransactionAction>>> sendDepositPrepare(long j, BigDecimal amount) {
        ...
        Observable<Result<Pair<String, StakingTransactionAction>>> subscribeOn = this.stakingRepository.sendDepositPrepare(j, amount).startWith((Observable<Result<Pair<String, StakingTransactionAction>>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<StakingOperation>> sendDepositExecute(String wrappedAction, StakingTransactionArgs args) {
        Intrinsics.checkNotNullParameter(wrappedAction, "wrappedAction");
        Intrinsics.checkNotNullParameter(args, "args");
        Observable<Result<StakingOperation>> subscribeOn = this.stakingRepository.sendDepositExecute(wrappedAction, args).startWith((Observable<Result<StakingOperation>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }

    public final Observable<Result<Pair<String, StakingTransactionAction>>> sendClaimPrepare(long j) {
        Observable<Result<Pair<String, StakingTransactionAction>>> subscribeOn = this.stakingRepository.sendClaimPrepare(j).startWith((Observable<Result<Pair<String, StakingTransactionAction>>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<StakingOperation>> sendClaimExecute(String wrappedAction, StakingTransactionArgs args) {
        Intrinsics.checkNotNullParameter(wrappedAction, "wrappedAction");
        Intrinsics.checkNotNullParameter(args, "args");
        Observable<Result<StakingOperation>> subscribeOn = this.stakingRepository.sendClaimExecute(wrappedAction, args).startWith((Observable<Result<StakingOperation>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Pair<String, StakingTransactionAction>>> sendWithdrawPrepare(long j, BigDecimal amount, boolean z) {
        Intrinsics.checkNotNullParameter(amount, "amount");
        Observable<Result<Pair<String, StakingTransactionAction>>> subscribeOn = this.stakingRepository.sendWithdrawPrepare(j, amount, z).startWith((Observable<Result<Pair<String, StakingTransactionAction>>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<StakingOperation>> sendWithdrawExecute(String wrappedAction, StakingTransactionArgs args) {
        Intrinsics.checkNotNullParameter(wrappedAction, "wrappedAction");
        Intrinsics.checkNotNullParameter(args, "args");
        Observable<Result<StakingOperation>> subscribeOn = this.stakingRepository.sendWithdrawExecute(wrappedAction, args).startWith((Observable<Result<StakingOperation>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo699io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "stakingRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
}
