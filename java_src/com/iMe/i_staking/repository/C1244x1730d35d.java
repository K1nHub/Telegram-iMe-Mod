...
public final class C1244x1730d35d extends Lambda implements Function1<Throwable, Result<? extends StakingProgrammes>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1244x1730d35d(ErrorHandler errorHandler) {
        super(1);
