...
public final class C1248x2d5c7315 extends Lambda implements Function1<Throwable, Result<? extends StakingTotalStats>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1248x2d5c7315(ErrorHandler errorHandler) {
        super(1);
