...
public final class StakingRepositoryImpl implements StakingRepository {
    ...
    public Observable<Result<StakingTotalStats>> getStakingTotalStats() {
        ...
        Observable<R> map = stakingTotalStats.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingTotalStatsResponse>, Result<? extends StakingTotalStats>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingTotalStats$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Observable<Result<StakingTotalStats>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingTotalStats>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingTotalStats$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingProgrammes>> getStakingProgrammesList(StakingOrderType orderType, Long l) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = stakingProgrammesList.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingProgrammesResponse>, Result<? extends StakingProgrammes>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingProgrammesList$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingProgrammes>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingProgrammes>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingProgrammesList$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingProgrammes>> getStakingOwnProgrammesList(StakingOrderType orderType, Long l, StakingProgrammesFilterType filterType) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = stakingOwnProgrammesList.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingProgrammesResponse>, Result<? extends StakingProgrammes>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingOwnProgrammesList$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingProgrammes>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingProgrammes>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingOwnProgrammesList$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingDetailedMetadata>> getStakingDetails(long j) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = stakingDetails.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingDetailedMetadataResponse>, Result<? extends StakingDetailedMetadata>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingDetails$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingDetailedMetadata>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingDetailedMetadata>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingDetails$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingOperationsPaged>> getStakingOperations(Long l, StakingOperationType stakingOperationType, String str, String str2) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = stakingOperations.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingOperationsPagedResponse>, Result<? extends StakingOperationsPaged>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingOperations$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingOperationsPaged>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingOperationsPaged>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getStakingOperations$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingApprovalInfo>> getApprovalInfo(long j) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = approvalInfo.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingApprovalInfoResponse>, Result<? extends StakingApprovalInfo>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getApprovalInfo$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingApprovalInfo>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingApprovalInfo>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$getApprovalInfo$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<Pair<String, StakingTransactionAction>>> sendApprovalPrepare(long j, StakingApprovalTokenType tokenType) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = sendApprovalPrepare.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingWrappedActionResponse>, Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendApprovalPrepare$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<Pair<String, StakingTransactionAction>>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendApprovalPrepare$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingOperation>> sendApprovalExecute(String wrappedAction, StakingTransactionArgs transactionArgs) {
        ...
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingOperation>> onErrorReturn = sendApprovalExecute.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingOperation>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendApprovalExecute$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<Pair<String, StakingTransactionAction>>> sendDepositPrepare(long j, BigDecimal amount) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = sendDepositPrepare.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingWrappedActionResponse>, Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendDepositPrepare$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<Pair<String, StakingTransactionAction>>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendDepositPrepare$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingOperation>> sendDepositExecute(String wrappedAction, StakingTransactionArgs transactionArgs) {
        ...
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingOperation>> onErrorReturn = sendDepositExecute.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingOperation>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendDepositExecute$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<Pair<String, StakingTransactionAction>>> sendClaimPrepare(long j) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = sendClaimPrepare.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingWrappedActionResponse>, Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendClaimPrepare$$inlined$mapSuccess$1
            {
                super(1);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<Pair<String, StakingTransactionAction>>> onErrorReturn = map.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendClaimPrepare$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingOperation>> sendClaimExecute(String wrappedAction, StakingTransactionArgs transactionArgs) {
        ...
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingOperation>> onErrorReturn = sendClaimExecute.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingOperation>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendClaimExecute$$inlined$handleError$1
            {
                super(1);
            }
    ...
    public Observable<Result<Pair<String, StakingTransactionAction>>> sendWithdrawPrepare(long j, BigDecimal amount, boolean z) {
        ...
        final FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler = this.firebaseErrorHandler;
        Observable<R> map = sendWithdrawPrepare.map(new C1491x85ce2865(new Function1<ApiBaseResponse<StakingWrappedActionResponse>, Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendWithdrawPrepare$$inlined$mapSuccess$1
            {
                super(1);
            }
    ...
    public Observable<Result<StakingOperation>> sendWithdrawExecute(String wrappedAction, StakingTransactionArgs transactionArgs) {
        ...
        final ApiErrorHandler apiErrorHandler = this.errorHandler;
        Observable<Result<StakingOperation>> onErrorReturn = sendWithdrawExecute.onErrorReturn(new C1491x85ce2865(new Function1<Throwable, Result<? extends StakingOperation>>() { // from class: com.iMe.i_staking.repository.StakingRepositoryImpl$sendWithdrawExecute$$inlined$handleError$1
            {
                super(1);
            }
