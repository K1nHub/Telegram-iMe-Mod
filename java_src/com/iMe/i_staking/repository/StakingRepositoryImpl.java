...
public final class StakingRepositoryImpl implements StakingRepository {
    ...
    public Observable<Result<StakingTotalStats>> getStakingTotalStats() {
        Observable<R> map = this.stakingApi.getStakingTotalStats().map(new C1513x85ce2865(new StakingRepositoryImpl$getStakingTotalStats$$inlined$mapSuccess$1(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<StakingTotalStats>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new C1512x2d5c7315(this.errorHandler)));
    ...
    public Observable<Result<StakingProgrammes>> getStakingProgrammesList(StakingOrderType orderType, Long l) {
        ...
        Observable<R> map = this.stakingApi.getStakingProgrammesList(new StakingProgrammesRequest(null, l, null, StakingOrderStrategyRequest.Companion.createFromOrderType(orderType), false, 21, null)).map(new C1513x85ce2865(new C1511x8c291be6(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<StakingProgrammes>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new C1510xdc02197b(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Observable<Result<StakingProgrammes>> getStakingOwnProgrammesList(StakingOrderType orderType, Long l, StakingProgrammesFilterType filterType) {
        ...
        Observable<R> map = stakingApi.getStakingOwnProgrammesList(new StakingOwnProgrammesRequest(null, l, null, createFromOrderType, lowerCase, 5, null)).map(new C1513x85ce2865(new C1509xf12a9dc4(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<StakingProgrammes>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new C1508x1730d35d(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Observable<Result<StakingDetailedMetadata>> getStakingDetails(long j) {
        Observable<R> map = this.stakingApi.getStakingDetails(new StakingIdRequest(j)).map(new C1513x85ce2865(new StakingRepositoryImpl$getStakingDetails$$inlined$mapSuccess$1(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<StakingDetailedMetadata>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new StakingRepositoryImpl$getStakingDetails$$inlined$handleError$1(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Observable<Result<StakingOperationsPaged>> getStakingOperations(Long l, StakingOperationType stakingOperationType, NetworkType networkType, String str) {
        Observable<R> map = this.stakingApi.getStakingOperations(new StakingOperationsRequest(l, stakingOperationType, null, networkType, str == null ? null : new StakingOperationsPaginationRequest(str, null, 2, null), 4, null)).map(new C1513x85ce2865(new StakingRepositoryImpl$getStakingOperations$$inlined$mapSuccess$1(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<StakingOperationsPaged>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new C1507xe0f1d7c4(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Observable<Result<StakingApprovalInfo>> getApprovalInfo(long j) {
        Observable<R> map = this.stakingApi.getApprovalInfo(new StakingIdRequest(j)).map(new C1513x85ce2865(new StakingRepositoryImpl$getApprovalInfo$$inlined$mapSuccess$1(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<StakingApprovalInfo>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new StakingRepositoryImpl$getApprovalInfo$$inlined$handleError$1(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Observable<Result<Pair<String, StakingTransactionAction>>> sendApprovalPrepare(long j, StakingApprovalTokenType tokenType) {
        ...
        Observable<R> map = this.stakingApi.sendApprovalPrepare(new StakingApprovalPrepareRequest(j, tokenType.name())).map(new C1513x85ce2865(new StakingRepositoryImpl$sendApprovalPrepare$$inlined$mapSuccess$1(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<Pair<String, StakingTransactionAction>>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new StakingRepositoryImpl$sendApprovalPrepare$$inlined$handleError$1(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Observable<Result<Pair<String, StakingTransactionAction>>> sendDepositPrepare(long j, BigDecimal amount) {
        ...
        Observable<R> map = this.stakingApi.sendDepositPrepare(new StakingDepositPrepareRequest(j, amount)).map(new C1513x85ce2865(new StakingRepositoryImpl$sendDepositPrepare$$inlined$mapSuccess$1(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<Pair<String, StakingTransactionAction>>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new StakingRepositoryImpl$sendDepositPrepare$$inlined$handleError$1(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Observable<Result<Pair<String, StakingTransactionAction>>> sendClaimPrepare(long j) {
        Observable<R> map = this.stakingApi.sendClaimPrepare(new StakingIdRequest(j)).map(new C1513x85ce2865(new StakingRepositoryImpl$sendClaimPrepare$$inlined$mapSuccess$1(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<Pair<String, StakingTransactionAction>>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new StakingRepositoryImpl$sendClaimPrepare$$inlined$handleError$1(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
    ...
    public Observable<Result<Pair<String, StakingTransactionAction>>> sendWithdrawPrepare(long j, BigDecimal amount, boolean z) {
        Intrinsics.checkNotNullParameter(amount, "amount");
        Observable<R> map = this.stakingApi.sendWithdrawPrepare(new StakingWithdrawPrepareRequest(j, amount, z)).map(new C1513x85ce2865(new StakingRepositoryImpl$sendWithdrawPrepare$$inlined$mapSuccess$1(this.firebaseErrorHandler)));
        Intrinsics.checkNotNullExpressionValue(map, "errorHandler: FirebaseFu…response).toError()\n    }");
        Observable<Result<Pair<String, StakingTransactionAction>>> onErrorReturn = map.onErrorReturn(new C1513x85ce2865(new StakingRepositoryImpl$sendWithdrawPrepare$$inlined$handleError$1(this.errorHandler)));
        Intrinsics.checkNotNullExpressionValue(onErrorReturn, "errorHandler: ErrorHandl…ndleError(it).toError() }");
        return onErrorReturn;
    }
