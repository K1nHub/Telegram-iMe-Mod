...
public final class C1564xba2cd8f0 extends Lambda implements Function1<ApiBaseResponse<StakingOperationResponse>, Result<? extends StakingOperation>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1564xba2cd8f0(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
