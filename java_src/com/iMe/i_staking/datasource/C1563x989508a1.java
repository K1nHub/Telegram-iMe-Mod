...
public final class C1563x989508a1 extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends StakingOperation>>> {
    final /* synthetic */ String $wrappedAction$inlined;
    final /* synthetic */ StakingDataSourceImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1563x989508a1(StakingDataSourceImpl stakingDataSourceImpl, String str) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends StakingOperation>> invoke(Result<? extends String> result) {
        ...
        ObservableSource map = sendWithdrawExecute.map(new C1565xdf81e200(new C1564xba2cd8f0(firebaseFunctionsErrorHandler)));
