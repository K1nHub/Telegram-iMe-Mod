...
/* renamed from: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendWithdrawExecute$lambda$7$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1499xba2cd8f0 extends Lambda implements Function1<ApiBaseResponse<StakingOperationResponse>, Result<? extends StakingOperation>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1499xba2cd8f0(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
