...
public final class C1229x96aeb888 extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends StakingOperation>>> {
    final /* synthetic */ String $wrappedAction$inlined;
    final /* synthetic */ StakingDataSourceImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1229x96aeb888(StakingDataSourceImpl stakingDataSourceImpl, String str) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends StakingOperation>> invoke(Result<? extends String> result) {
        ...
        ObservableSource map = sendApprovalExecute.map(new C1236xdf81e200(new C1230x10ce69e3(firebaseFunctionsErrorHandler)));
