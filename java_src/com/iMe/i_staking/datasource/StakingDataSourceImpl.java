...
public final class StakingDataSourceImpl implements StakingDataSource {
    ...
    public Observable<Result<StakingOperation>> sendApprovalExecute(final String wrappedAction, TransactionArgs args) {
        ...
        Observable flatMap = sign(args).flatMap(new C1478xdf81e200(new Function1<Result<? extends String>, ObservableSource<? extends Result<? extends StakingOperation>>>() { // from class: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendApprovalExecute$$inlined$flatMapSuccess$1
            ...
            public final ObservableSource<? extends Result<? extends StakingOperation>> invoke(Result<? extends String> result) {
                ...
                ObservableSource map = sendApprovalExecute.map(new C1478xdf81e200(new Function1<ApiBaseResponse<StakingOperationResponse>, Result<? extends StakingOperation>>() { // from class: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendApprovalExecute$lambda$1$$inlined$mapSuccess$1
                    {
                        super(1);
                    }
    ...
    public Observable<Result<StakingOperation>> sendDepositExecute(final String wrappedAction, TransactionArgs args) {
        Intrinsics.checkNotNullParameter(wrappedAction, "wrappedAction");
        Intrinsics.checkNotNullParameter(args, "args");
        Observable flatMap = sign(args).flatMap(new C1478xdf81e200(new Function1<Result<? extends String>, ObservableSource<? extends Result<? extends StakingOperation>>>() { // from class: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendDepositExecute$$inlined$flatMapSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final ObservableSource<? extends Result<? extends StakingOperation>> invoke(Result<? extends String> result) {
                ...
                firebaseFunctionsErrorHandler = StakingDataSourceImpl.this.firebaseErrorHandler;
                ObservableSource map = sendDepositExecute.map(new C1478xdf81e200(new Function1<ApiBaseResponse<StakingOperationResponse>, Result<? extends StakingOperation>>() { // from class: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendDepositExecute$lambda$3$$inlined$mapSuccess$1
                    {
                        super(1);
                    }
    ...
    public Observable<Result<StakingOperation>> sendClaimExecute(final String wrappedAction, TransactionArgs args) {
        Intrinsics.checkNotNullParameter(wrappedAction, "wrappedAction");
        Intrinsics.checkNotNullParameter(args, "args");
        Observable flatMap = sign(args).flatMap(new C1478xdf81e200(new Function1<Result<? extends String>, ObservableSource<? extends Result<? extends StakingOperation>>>() { // from class: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendClaimExecute$$inlined$flatMapSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final ObservableSource<? extends Result<? extends StakingOperation>> invoke(Result<? extends String> result) {
                ...
                firebaseFunctionsErrorHandler = StakingDataSourceImpl.this.firebaseErrorHandler;
                ObservableSource map = sendClaimExecute.map(new C1478xdf81e200(new Function1<ApiBaseResponse<StakingOperationResponse>, Result<? extends StakingOperation>>() { // from class: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendClaimExecute$lambda$5$$inlined$mapSuccess$1
                    {
                        super(1);
                    }
    ...
    public Observable<Result<StakingOperation>> sendWithdrawExecute(final String wrappedAction, TransactionArgs args) {
        Intrinsics.checkNotNullParameter(wrappedAction, "wrappedAction");
        Intrinsics.checkNotNullParameter(args, "args");
        Observable flatMap = sign(args).flatMap(new C1478xdf81e200(new Function1<Result<? extends String>, ObservableSource<? extends Result<? extends StakingOperation>>>() { // from class: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendWithdrawExecute$$inlined$flatMapSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final ObservableSource<? extends Result<? extends StakingOperation>> invoke(Result<? extends String> result) {
                ...
                firebaseFunctionsErrorHandler = StakingDataSourceImpl.this.firebaseErrorHandler;
                ObservableSource map = sendWithdrawExecute.map(new C1478xdf81e200(new Function1<ApiBaseResponse<StakingOperationResponse>, Result<? extends StakingOperation>>() { // from class: com.iMe.i_staking.datasource.StakingDataSourceImpl$sendWithdrawExecute$lambda$7$$inlined$mapSuccess$1
                    {
                        super(1);
                    }
