...
public final class StakingModuleKt {
    ...
    private static Module stakingModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C15781 c15781 = new Function2<Scope, ParametersHolder, Retrofit>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.1
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(Retrofit.class), staking_retrofit, c15781, kind, emptyList));
            ...
            C15792 c15792 = new Function2<Scope, ParametersHolder, OkHttpClient>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(OkHttpClient.class), staking_client, c15792, kind, emptyList2));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C15803 c15803 = new Function2<Scope, ParametersHolder, StakingApi>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(StakingApi.class), null, c15803, kind, emptyList3));
            module.indexPrimaryType(singleInstanceFactory3);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory3);
            }
            new KoinDefinition(module, singleInstanceFactory3);
            C15814 c15814 = new Function2<Scope, ParametersHolder, StakingDataSource>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory4 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(StakingDataSource.class), null, c15814, kind, emptyList4));
            module.indexPrimaryType(singleInstanceFactory4);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory4);
            }
            new KoinDefinition(module, singleInstanceFactory4);
            C15825 c15825 = new Function2<Scope, ParametersHolder, StakingRepository>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory5 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(StakingRepository.class), null, c15825, kind, emptyList5));
            module.indexPrimaryType(singleInstanceFactory5);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory5);
            }
            new KoinDefinition(module, singleInstanceFactory5);
            C15836 c15836 = new Function2<Scope, ParametersHolder, StakingInteractor>() { // from class: com.iMe.i_staking.di.StakingModuleKt$stakingModule$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory6 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(StakingInteractor.class), null, c15836, kind, emptyList6));
