...
public final class ProfileData {
    ...
    public int hashCode() {
        return (((ProfileData$$ExternalSyntheticBackport0.m1020m(this.userId) * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.chatId)) * 31) + this.dialogIdText.hashCode();
    }
