...
public final class ProfilePresenter extends BasePresenter<ProfileView> {
    ...
    public final void onReattachSocialConfirmed(long j) {
        ...
        Observable scheduleIO = SchedulersExtKt.scheduleIO(RxExtKt.withLoadingDialog$default((Observable) acceptConnection, (BaseView) viewState, false, 2, (Object) null));
        final BaseView baseView = (BaseView) getViewState();
        Disposable subscribe = scheduleIO.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.feature.profile.ProfilePresenter$onReattachSocialConfirmed$$inlined$subscribeWithErrorHandle$default$1
            {
                super(1);
            }
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1188invoke(Result<? extends Boolean> it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
                ProfilePresenter.this.onReattachSocialResult(it);
            }
        }), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Throwable, Unit>() { // from class: com.iMe.feature.profile.ProfilePresenter$onReattachSocialConfirmed$$inlined$subscribeWithErrorHandle$default$2
            {
                super(1);
            }
    ...
    private final void loadAccountLevelInfo() {
        ...
        Disposable subscribe = scheduleIO.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends AccountLevelInformation>, Unit>() { // from class: com.iMe.feature.profile.ProfilePresenter$loadAccountLevelInfo$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1185invoke(Result<? extends AccountLevelInformation> it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    private final void loadSocials() {
        ...
        Disposable subscribe = scheduleIO.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends SocialDomain>, Unit>() { // from class: com.iMe.feature.profile.ProfilePresenter$loadSocials$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1186invoke(Result<? extends SocialDomain> it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    private final void logoutSocialNetwork(SocialNetwork socialNetwork) {
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.feature.profile.ProfilePresenter$logoutSocialNetwork$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1187invoke(Result<? extends Boolean> it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    private final void listenSocialAuthResult() {
        ...
        Observable scheduleIO = SchedulersExtKt.scheduleIO(delay);
        final BaseView baseView = (BaseView) getViewState();
        Disposable subscribe = scheduleIO.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<SocialAuthResult, Unit>() { // from class: com.iMe.feature.profile.ProfilePresenter$listenSocialAuthResult$$inlined$subscribeWithErrorHandle$default$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Unit invoke(SocialAuthResult socialAuthResult) {
                m1184invoke(socialAuthResult);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1184invoke(SocialAuthResult it) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
                ProfilePresenter.this.onSocialAuthResult(it);
            }
        }), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Throwable, Unit>() { // from class: com.iMe.feature.profile.ProfilePresenter$listenSocialAuthResult$$inlined$subscribeWithErrorHandle$default$2
            {
                super(1);
            }
    ...
    private final void showResetConfirmationDialog(SocialNetwork socialNetwork) {
        ((ProfileView) getViewState()).showResetConfirmationDialog(new DialogModel(this.resourceManager.getString(C3419R.string.social_reset_account_title, socialNetwork.getSocialName()), this.resourceManager.getString(C3419R.string.social_reset_account_message, socialNetwork.getSocialName()), this.resourceManager.getString(C3419R.string.social_reset_account_negative_button), this.resourceManager.getString(C3419R.string.social_reset_account_positive_button)), socialNetwork);
    }

    private final void showNeedAuthorizeDialog() {
        ((ProfileView) getViewState()).showNeedAuthorizeDialog(new DialogModel(this.resourceManager.getString(C3419R.string.wallet_crypto_wallet_not_created_dialog_title), this.resourceManager.getString(C3419R.string.wallet_crypto_wallet_not_created_dialog_description), this.resourceManager.getString(C3419R.string.common_cancel), this.resourceManager.getString(C3419R.string.common_ok)));
    }
    ...
    private final void showBeforeDialog(SocialNetwork socialNetwork) {
        ...
        String string = this.resourceManager.getString(C3419R.string.common_ok);
        Locale locale = Locale.ROOT;
        String upperCase = string.toUpperCase(locale);
        Intrinsics.checkNotNullExpressionValue(upperCase, "this as java.lang.String).toUpperCase(Locale.ROOT)");
        String upperCase2 = this.resourceManager.getString(C3419R.string.common_cancel).toUpperCase(locale);
    ...
    private final void showLinkConfirmationDialog(long j) {
        ((ProfileView) getViewState()).showLinkConfirmationDialog(new DialogModel(this.resourceManager.getString(C3419R.string.profile_twitter_link_confirmation_alert_title), this.resourceManager.getString(C3419R.string.profile_twitter_link_confirmation_alert_description), this.resourceManager.getString(C3419R.string.Cancel), this.resourceManager.getString(C3419R.string.common_confirm)), j);
    }
    ...
    private final void startSocialAuth(SocialType socialType) {
        ...
        Disposable subscribe = withLoadingDialog$default.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends SocialAuthDomain>, Unit>() { // from class: com.iMe.feature.profile.ProfilePresenter$startSocialAuth$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1189invoke(Result<? extends SocialAuthDomain> it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
