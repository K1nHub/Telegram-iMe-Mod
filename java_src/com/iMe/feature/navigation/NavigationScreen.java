...
public final class NavigationScreen extends FragmentActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C3417R.layout.fork_navigation_screen);
    ...
    private final void startDestination(NavigationBundle<Parcelable> navigationBundle) {
        ...
        Fragment findFragmentById = getSupportFragmentManager().findFragmentById(C3417R.C3420id.main_content);
        Intrinsics.checkNotNull(findFragmentById, "null cannot be cast to non-null type androidx.navigation.fragment.NavHostFragment");
        NavHostFragment navHostFragment = (NavHostFragment) findFragmentById;
        NavGraph inflate = navHostFragment.getNavController().getNavInflater().inflate(C3417R.C3422navigation.fork_main_nav_graph);
        ...
        if (i == 1) {
            inflate.setStartDestination(C3417R.C3420id.socialAuthScreen);
            ...
            if (i == 3) {
                inflate.setStartDestination(C3417R.C3420id.devSettings);
                return;
            }
            Timber.m7e("NavDirection is skipped: " + navDirection, new Object[0]);
        } else {
            inflate.setStartDestination(C3417R.C3420id.socialWebScreen);
            navHostFragment.getNavController().setGraph(inflate, getIntent().getExtras());
