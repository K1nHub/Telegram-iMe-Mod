...
public final class AuthScreen extends Fragment implements KoinComponent {
    ...
    private final void sideEffects(AuthSideEffects authSideEffects) {
        if (authSideEffects instanceof AuthSideEffects.LoadUrl) {
            ...
            showErrorMessageAndClose(getResource().getString(C3290R.string.social_access_error));
        }
    }
    ...
    public final void showPopupMenu() {
        List mutableListOf;
        String string = getResource().getString(C3290R.string.social_clear_cache_menu_item);
        int i = C3290R.C3292drawable.msg_delete;
        int i2 = Theme.key_color_red;
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new MenuItem(getResource().getString(C3290R.string.social_refresh_page_menu_item), C3290R.C3292drawable.msg_retry, 0, 0, new AuthScreen$showPopupMenu$menuItems$1(getViewModel()), 12, null), new MenuItem(string, i, Theme.getColor(i2), Theme.getColor(i2), new AuthScreen$showPopupMenu$menuItems$2(getViewModel())));
    ...
    public final void showCloseDialog() {
        ...
        DialogUtils.createDialog$default(requireContext, new DialogModel(getString(C3290R.string.social_connect_account_title, capitalizeOnlyFirstSymbol), getString(C3290R.string.social_connect_account_message), getString(C3290R.string.social_connect_account_negative_button), getString(C3290R.string.social_connect_account_positive_button)), new Callbacks$Callback() { // from class: com.iMe.feature.socialMedias.auth.AuthScreen$$ExternalSyntheticLambda0
