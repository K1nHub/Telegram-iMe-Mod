...
public final class C1481x2420976b extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ TwitterSearchPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1481x2420976b(TwitterSearchPresenter twitterSearchPresenter) {
        super(1);
