...
public final class C1490x1f435055 extends Lambda implements Function1<Result<? extends List<? extends BaseNode>>, Unit> {
    ...
    public C1490x1f435055(TwitterSearchPresenter twitterSearchPresenter, boolean z, boolean z2) {
        super(1);
