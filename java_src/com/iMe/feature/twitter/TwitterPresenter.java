...
public final class TwitterPresenter extends BasePresenter<TwitterView> {
    ...
    public final void onResetMenuClicked() {
        ((TwitterView) getViewState()).showResetTwitterDialog(new DialogModel(this.resourceManager.getString(C3290R.string.social_reset_account_title, this.socialNetwork.getSocialName()), this.resourceManager.getString(C3290R.string.social_reset_account_message, this.socialNetwork.getSocialName()), this.resourceManager.getString(C3290R.string.social_reset_account_negative_button), this.resourceManager.getString(C3290R.string.social_reset_account_positive_button)));
    }
