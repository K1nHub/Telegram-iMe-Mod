...
public final class FiltersRecycleAdapter extends BaseQuickAdapter<FilterItem, BaseViewHolder> {
    public FiltersRecycleAdapter() {
        super(C3290R.layout.fork_recycle_item_filter, null, 2, null);
    }
    ...
    public void convert(BaseViewHolder holder, FilterItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(holder, C3290R.C3293id.view_filter, new FiltersRecycleAdapter$convert$1(item));
    }
    ...
    protected void convert2(BaseViewHolder holder, FilterItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(holder, C3290R.C3293id.view_filter, new FiltersRecycleAdapter$convert$2(item));
    }
}
