...
public final class GlobalStateProvider extends BaseNodeProvider<GlobalStateItem> {
    ...
    private final int layoutId = C3558R.layout.fork_recycle_item_global_state;
    ...
    public void convert(BaseViewHolder helper, final GlobalStateItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper, C3558R.C3561id.global_state_layout, new Function1<GlobalStateLayout, Unit>() { // from class: com.iMe.ui.adapter.provider.GlobalStateProvider$convert$1
            ...
            public final void invoke2(GlobalStateLayout applyForView) {
                ...
                if (GlobalStateProvider.this.isWhiteBackground()) {
                    applyForView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                }
                applyForView.setElevation(GlobalStateProvider.this.getCustomElevation());
