...
/* renamed from: com.iMe.ui.adapter.provider.FoundTokenProvider$convert$1 */
/* loaded from: classes.dex */
public final class FoundTokenProvider$convert$1 extends Lambda implements Function1<Switch, Unit> {
    final /* synthetic */ FoundTokenItem $item;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FoundTokenProvider$convert$1(FoundTokenItem foundTokenItem) {
        super(1);
