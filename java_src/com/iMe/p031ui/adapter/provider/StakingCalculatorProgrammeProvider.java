...
public final class StakingCalculatorProgrammeProvider extends BaseNodeProvider<StakingProgrammeItem> {
    ...
    public StakingCalculatorProgrammeProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3473R.layout.fork_recycle_item_staking_calculator_programme;
    ...
    public void convert(BaseViewHolder helper, final StakingProgrammeItem item) {
        ...
        int i4 = C3473R.C3476id.text_apr_value;
        int i5 = C3473R.C3476id.text_apy_value;
        ...
        int i7 = C3473R.C3476id.text_apy_title;
        int i8 = C3473R.C3476id.text_apr_title;
        BaseViewHolder loadImage$default = BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor2, i6, i7, i8), i7, i8, i5, i4), C3473R.C3476id.image_logo, item.getTokenBalance().getToken().getAvatarUrl(), null, false, 12, null);
        int i9 = C3473R.C3476id.image_info;
        BaseViewHolder text = BaseQuickAdapterExtKt.setCircleRippleBackground(BaseQuickAdapterExtKt.setThemedImageColor(loadImage$default, i9, i2), i9).setText(i7, this.resourceManager.getString(C3473R.string.staking_programme_apy));
        BaseViewHolder text2 = text.setText(i5, item.getApy() + '%').setText(i8, this.resourceManager.getString(C3473R.string.staking_programme_apr));
    ...
    public void convert(BaseViewHolder helper, StakingProgrammeItem item, List<? extends Object> payloads) {
        ...
        BaseViewHolder loadImage$default = BaseQuickAdapterExtKt.loadImage$default(helper, C3473R.C3476id.image_logo, item.getTokenBalance().getToken().getAvatarUrl(), null, false, 12, null);
        int i = C3473R.C3476id.text_apy_value;
        BaseViewHolder text = loadImage$default.setText(i, item.getApy() + '%');
        int i2 = C3473R.C3476id.text_apr_value;
        BaseViewHolder text2 = text.setText(i2, item.getApr() + '%').setText(C3473R.C3476id.text_name, item.getName());
        BalanceFormatter balanceFormatter = BalanceFormatter.INSTANCE;
        BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setGone(BaseQuickAdapterExtKt.setGone(text2, NumberExtKt.isZero(balanceFormatter.parseFormattedString(item.getApy())), C3473R.C3476id.text_apy_title, i), NumberExtKt.isZero(balanceFormatter.parseFormattedString(item.getApr())), C3473R.C3476id.text_apr_title, i2), C3473R.C3476id.image_network_icon, NetworksHelper.getNetworkById(item.getTokenBalance().getToken().getNetworkId()).getLogoUrl(), null, false, 12, null);
    }
}
