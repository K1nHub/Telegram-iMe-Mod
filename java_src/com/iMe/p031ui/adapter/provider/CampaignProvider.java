...
public final class CampaignProvider extends BaseNodeProvider<CampaignItem> {
    ...
    private final int layoutId = C3558R.layout.fork_recycle_item_catalog_channel;
