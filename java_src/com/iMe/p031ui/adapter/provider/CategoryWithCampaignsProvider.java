...
public final class CategoryWithCampaignsProvider extends BaseNodeProvider<CategoryWithCampaignsItem> implements KoinComponent {
    ...
    private final int layoutId = C3473R.layout.fork_recycle_item_catalog_category_preview;
    ...
    public final void onViewRecycled(BaseViewHolder holder) {
        ...
        if (BaseQuickAdapterExtKt.isViewType(holder, getItemViewType())) {
            ...
            RecyclerView.LayoutManager layoutManager = ((RecyclerView) holder.getView(C3473R.C3476id.recycle_channels)).getLayoutManager();
    ...
    public void convert(BaseViewHolder helper, CategoryWithCampaignsItem item) {
        ...
        int i = C3473R.C3476id.text_title;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(helper, i, Theme.key_windowBackgroundWhiteGrayText2).setText(i, item.getCategory().getTitle()), i), C3473R.C3476id.recycle_channels, new CategoryWithCampaignsProvider$convert$1(this, helper, item));
    }
}
