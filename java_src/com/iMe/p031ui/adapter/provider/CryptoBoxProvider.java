...
public final class CryptoBoxProvider extends BaseNodeProvider<CryptoBoxItem> {
    ...
    public CryptoBoxProvider(final ResourceManager resourceManager) {
        ...
        this.layoutId = C3473R.layout.fork_recycle_item_cryptobox;
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<Float>() { // from class: com.iMe.ui.adapter.provider.CryptoBoxProvider$networkIconCornerSize$2
            ...
            public final Float invoke() {
                return Float.valueOf(ResourceManager.this.getDimens(C3473R.dimen.icon_size_default) / 2);
            }
        });
    ...
    public void convert(BaseViewHolder helper, final CryptoBoxItem item) {
        ...
        int i5 = C3473R.C3476id.text_status;
        ...
        int i6 = C3473R.C3476id.image_token_logo;
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(text, i3, true ^ isBlank), C3473R.C3476id.image_logo, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.CryptoBoxProvider$convert$1$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public void convert(BaseViewHolder helper, final CryptoBoxItem item, List<? extends Object> payloads) {
        ...
        int i = C3473R.C3476id.text_status;
        BaseViewHolder textColor = helper.setTextColor(i, getContext().getColor(item.getStatusColorResId()));
        int i2 = C3473R.C3476id.image_logo;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.loadImage$default(textColor, i2, item.getChatAvatarUrl(), null, false, 12, null).setText(C3473R.C3476id.text_name, item.getName()).setText(C3473R.C3476id.text_description, item.getDescription()).setText(C3473R.C3476id.text_creation_time, item.getCreationTimeText()).setText(i, item.getStatusText()), i2, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.CryptoBoxProvider$convert$2$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
