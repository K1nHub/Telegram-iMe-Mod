...
public final class TweetProvider extends BaseNodeProvider<TweetItem> implements KoinComponent {
    ...
    public TweetProvider() {
        ...
        this.layoutId = C3290R.layout.fork_recycle_item_tweet;
    }
    ...
    public void convert(BaseViewHolder helper, TweetItem item) {
        ...
        BaseViewHolder themedBackgroundColor = BaseQuickAdapterExtKt.setThemedBackgroundColor(helper, C3290R.C3293id.view_tweet, Theme.key_windowBackgroundWhite);
        ...
        int i9 = C3290R.C3293id.text_retweets_count;
        BaseViewHolder themedTextColor6 = BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor5, i9, i8);
        int i10 = C3290R.C3293id.text_likes_count;
        BaseViewHolder themedImageColor = BaseQuickAdapterExtKt.setThemedImageColor(BaseQuickAdapterExtKt.setThemedImageColor(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor6, i10, i8), C3290R.C3293id.image_comments, i8), C3290R.C3293id.image_retweets, i8);
        int i11 = C3290R.C3293id.image_share;
        BaseViewHolder themedImageColor2 = BaseQuickAdapterExtKt.setThemedImageColor(BaseQuickAdapterExtKt.setThemedImageColor(themedImageColor, i11, i8), C3290R.C3293id.image_menu, i8);
        int i12 = C3290R.C3293id.image_like;
        BaseViewHolder autoSizedCircleRippleBackground = BaseQuickAdapterExtKt.setAutoSizedCircleRippleBackground(themedImageColor2.setImageResource(i12, item.isLiked() ? C3290R.C3292drawable.fork_ic_heart_filled_20 : C3290R.C3292drawable.fork_ic_heart_20), i11);
        if (item.isLiked()) {
            i8 = Theme.key_text_RedRegular;
        }
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.loadImage(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedImageColor(autoSizedCircleRippleBackground, i12, i8), i), C3290R.C3293id.image_avatar, item.getAvatarUrl(), Integer.valueOf(C3290R.C3292drawable.fork_logo_avatar), true).setText(i, item.getAuthorName()).setText(i4, item.getAuthorNickname()).setText(i3, StringExtKt.addTwitterLinks(item.getText())).setText(i7, item.getCommentsCountText()).setText(i9, item.getRetweetsCountText()).setText(i10, item.getLikesCountText()).setText(i6, item.getDate()), i3, TweetProvider$convert$1$1.INSTANCE), C3290R.C3293id.recycler, new TweetProvider$convert$1$2(url, this, item));
    }
    ...
    public void convert(BaseViewHolder helper, TweetItem item, List<? extends Object> payloads) {
        ...
        int i = C3290R.C3293id.image_like;
        BaseQuickAdapterExtKt.loadImage(BaseQuickAdapterExtKt.setThemedImageColor(helper.setImageResource(i, item.isLiked() ? C3290R.C3292drawable.fork_ic_heart_filled_20 : C3290R.C3292drawable.fork_ic_heart_20), i, item.isLiked() ? Theme.key_text_RedRegular : Theme.key_windowBackgroundWhiteGrayText2), C3290R.C3293id.image_avatar, item.getAvatarUrl(), Integer.valueOf(C3290R.C3292drawable.fork_logo_avatar), true).setText(C3290R.C3293id.text_name, item.getAuthorName()).setText(C3290R.C3293id.text_nickname, item.getAuthorNickname()).setText(C3290R.C3293id.text_post, item.getText()).setText(C3290R.C3293id.text_comments_count, item.getCommentsCountText()).setText(C3290R.C3293id.text_retweets_count, item.getRetweetsCountText()).setText(C3290R.C3293id.text_likes_count, item.getLikesCountText()).setText(C3290R.C3293id.text_time, item.getDate());
    }
    ...
    public void onViewAttachedToWindow(BaseViewHolder holder) {
        ...
        BaseQuickAdapterExtKt.applyForView(holder, C3290R.C3293id.text_post, TweetProvider$onViewAttachedToWindow$1.INSTANCE);
    }
    ...
    public final void onBindImage(View view, MediaInfoDomain mediaInfoDomain, final TweetItem tweetItem) {
        ...
        bind.errorBlock.textError.setText(getResource().getString(C3290R.string.error_block_failed_to_load_media));
