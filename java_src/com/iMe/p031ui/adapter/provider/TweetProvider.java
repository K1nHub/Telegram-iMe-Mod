...
public final class TweetProvider extends BaseNodeProvider<TweetItem> implements KoinComponent {
    ...
    public TweetProvider() {
        ...
        this.layoutId = C3419R.layout.fork_recycle_item_tweet;
    }
    ...
    public void convert(BaseViewHolder helper, final TweetItem item) {
        ...
        BaseViewHolder themedBackgroundColor = BaseQuickAdapterExtKt.setThemedBackgroundColor(helper, C3419R.C3422id.view_tweet, Theme.key_windowBackgroundWhite);
        int i = Theme.key_windowBackgroundWhiteBlackText;
        int i2 = C3419R.C3422id.text_name;
        int i3 = C3419R.C3422id.text_post;
        ...
        int i5 = C3419R.C3422id.text_nickname;
        int i6 = C3419R.C3422id.text_time;
        ...
        int i8 = C3419R.C3422id.text_comments_count;
        int i9 = C3419R.C3422id.text_retweets_count;
        int i10 = C3419R.C3422id.text_likes_count;
        BaseViewHolder themedTextColor3 = BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor2, i7, i8, i9, i10);
        int i11 = C3419R.C3422id.image_share;
        BaseViewHolder themedImageColor = BaseQuickAdapterExtKt.setThemedImageColor(themedTextColor3, i7, C3419R.C3422id.image_comments, C3419R.C3422id.image_retweets, i11, C3419R.C3422id.image_menu);
        int i12 = C3419R.C3422id.image_like;
        BaseViewHolder autoSizedCircleRippleBackground = BaseQuickAdapterExtKt.setAutoSizedCircleRippleBackground(themedImageColor.setImageResource(i12, item.isLiked() ? C3419R.C3421drawable.fork_ic_heart_filled_20 : C3419R.C3421drawable.fork_ic_heart_20), i11);
        if (item.isLiked()) {
            i7 = Theme.key_text_RedRegular;
        }
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedImageColor(autoSizedCircleRippleBackground, i12, i7), i2), C3419R.C3422id.image_avatar, item.getAvatarUrl(), Integer.valueOf(C3419R.C3421drawable.fork_logo_avatar), false, 8, null).setText(i2, item.getAuthorName()).setText(i5, item.getAuthorNickname()).setText(i3, StringExtKt.addTwitterLinks(item.getText())).setText(i8, item.getCommentsCountText()).setText(i9, item.getRetweetsCountText()).setText(i10, item.getLikesCountText()).setText(i6, item.getDate()), i3, new Function1<TextView, Unit>() { // from class: com.iMe.ui.adapter.provider.TweetProvider$convert$1$1
        ...
        }), C3419R.C3422id.recycler, new Function1<RecyclerView, Unit>() { // from class: com.iMe.ui.adapter.provider.TweetProvider$convert$1$2
            ...
            public final void invoke2(RecyclerView applyForView) {
                ...
                int i13 = C3419R.layout.fork_recylcer_image_item;
    ...
    public void convert(BaseViewHolder helper, TweetItem item, List<? extends Object> payloads) {
        ...
        int i = C3419R.C3422id.image_like;
        BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setThemedImageColor(helper.setImageResource(i, item.isLiked() ? C3419R.C3421drawable.fork_ic_heart_filled_20 : C3419R.C3421drawable.fork_ic_heart_20), i, item.isLiked() ? Theme.key_text_RedRegular : Theme.key_windowBackgroundWhiteGrayText2), C3419R.C3422id.image_avatar, item.getAvatarUrl(), Integer.valueOf(C3419R.C3421drawable.fork_logo_avatar), false, 8, null).setText(C3419R.C3422id.text_name, item.getAuthorName()).setText(C3419R.C3422id.text_nickname, item.getAuthorNickname()).setText(C3419R.C3422id.text_post, item.getText()).setText(C3419R.C3422id.text_comments_count, item.getCommentsCountText()).setText(C3419R.C3422id.text_retweets_count, item.getRetweetsCountText()).setText(C3419R.C3422id.text_likes_count, item.getLikesCountText()).setText(C3419R.C3422id.text_time, item.getDate());
    }
    ...
    public void onViewAttachedToWindow(BaseViewHolder holder) {
        ...
        BaseQuickAdapterExtKt.applyForView(holder, C3419R.C3422id.text_post, new Function1<TextView, Unit>() { // from class: com.iMe.ui.adapter.provider.TweetProvider$onViewAttachedToWindow$1
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(TextView textView) {
                invoke2(textView);
                return Unit.INSTANCE;
    ...
    public final void onBindImage(View view, MediaInfoDomain mediaInfoDomain, final TweetItem tweetItem) {
        ...
        bind.errorBlock.textError.setText(getResource().getString(C3419R.string.error_block_failed_to_load_media));
