...
public final class StakingOperationProvider extends BaseNodeProvider<StakingOperationItem> {
    ...
    public StakingOperationProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3419R.layout.fork_recycle_item_wallet_transaction;
    ...
    public void convert(BaseViewHolder helper, final StakingOperationItem item) {
        ...
        int i7 = C3419R.C3422id.image_staking_icon;
        BaseViewHolder mediumTypeface = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.loadImage$default(visibleElseGone.setVisible(i7, item.isBadgeVisible()).setImageResource(C3419R.C3422id.image_transaction_type_icon, item.getIcon()), i7, item.getToken().getAvatarUrl(), null, false, 12, null), i3);
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(padding.setText(i4, item.getStatusText(this.resourceManager)).setText(i3, item.getAmount(this.resourceManager)).setText(i5, item.getTransactionTitle(this.resourceManager)), i2, new Function1<TimeWithClockView, Unit>() { // from class: com.iMe.ui.adapter.provider.StakingOperationProvider$convert$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
        ...
        }), i7, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.StakingOperationProvider$convert$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
