...
public final class SelectableHeaderProvider$convert$1 extends Lambda implements Function1<LinearLayout, Unit> {
    ...
    /* loaded from: classes3.dex */
    public static final class C19161 extends Lambda implements Function1<View, Unit> {
        final /* synthetic */ BaseViewHolder $helper;
        final /* synthetic */ SelectableHeaderItem $item;
        final /* synthetic */ SelectableHeaderProvider this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C19161(SelectableHeaderProvider selectableHeaderProvider, SelectableHeaderItem selectableHeaderItem, BaseViewHolder baseViewHolder) {
            super(1);
            this.this$0 = selectableHeaderProvider;
            this.$item = selectableHeaderItem;
            this.$helper = baseViewHolder;
        ...
        public final void invoke2(View it) {
            ...
            this.this$0.popupWindow = PopupFactoryKt.createPopupWithOptions(this.$helper.getView(C3242R.C3245id.text_wallet_header), arrayList, new C19171(this.$helper, this.$item, this.this$0));
        ...
        /* loaded from: classes3.dex */
        public static final class C19171 extends Lambda implements Function2<Integer, String, Unit> {
            final /* synthetic */ BaseViewHolder $helper;
            final /* synthetic */ SelectableHeaderItem $item;
            final /* synthetic */ SelectableHeaderProvider this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C19171(BaseViewHolder baseViewHolder, SelectableHeaderItem selectableHeaderItem, SelectableHeaderProvider selectableHeaderProvider) {
                super(2);
                this.$helper = baseViewHolder;
                this.$item = selectableHeaderItem;
                this.this$0 = selectableHeaderProvider;
            ...
            public final void invoke(int i, String value) {
                ...
                this.$helper.setText(C3242R.C3245id.text_wallet_header, value);
    ...
    public final void invoke2(LinearLayout applyForView) {
        ...
        ViewExtKt.safeThrottledClick$default(applyForView, 0L, new C19161(this.this$0, this.$item, this.$helper), 1, null);
    }
}
