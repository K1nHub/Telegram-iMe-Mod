...
public final class SelectableHeaderProvider$convert$1 extends Lambda implements Function1<LinearLayout, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C19941 extends Lambda implements Function1<View, Unit> {
        final /* synthetic */ BaseViewHolder $helper;
        final /* synthetic */ SelectableHeaderItem $item;
        final /* synthetic */ SelectableHeaderProvider this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C19941(SelectableHeaderProvider selectableHeaderProvider, SelectableHeaderItem selectableHeaderItem, BaseViewHolder baseViewHolder) {
            super(1);
            this.this$0 = selectableHeaderProvider;
            this.$item = selectableHeaderItem;
            this.$helper = baseViewHolder;
        ...
        public final void invoke2(View it) {
            ...
            SelectableHeaderProvider selectableHeaderProvider2 = this.this$0;
            ListPopupWindow createPopupWithOptions$default = PopupFactoryKt.createPopupWithOptions$default(this.$helper.getView(C3417R.C3420id.text_wallet_header), arrayList, Integer.valueOf(AndroidUtilities.m54dp(10)), null, new C19951(this.$helper, this.$item, this.this$0), 4, null);
            createPopupWithOptions$default.show();
            selectableHeaderProvider2.popupWindow = createPopupWithOptions$default;
        }
        ...
        /* loaded from: classes.dex */
        public static final class C19951 extends Lambda implements Function2<Integer, String, Unit> {
            final /* synthetic */ BaseViewHolder $helper;
            final /* synthetic */ SelectableHeaderItem $item;
            final /* synthetic */ SelectableHeaderProvider this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C19951(BaseViewHolder baseViewHolder, SelectableHeaderItem selectableHeaderItem, SelectableHeaderProvider selectableHeaderProvider) {
                super(2);
                this.$helper = baseViewHolder;
                this.$item = selectableHeaderItem;
                this.this$0 = selectableHeaderProvider;
            ...
            public final void invoke(int i, String value) {
                ...
                this.$helper.setText(C3417R.C3420id.text_wallet_header, value);
    ...
    public final void invoke2(LinearLayout applyForView) {
        ...
        ViewExtKt.safeThrottledClick$default(applyForView, 0L, new C19941(this.this$0, this.$item, this.$helper), 1, null);
    }
}
