...
public final class TotalBalanceProvider extends BaseNodeProvider<TotalBalanceItem> {
    ...
    private final int layoutId = C3419R.layout.fork_recycle_item_wallet_crypto_total_balance;
    ...
    public void convert(BaseViewHolder helper, TotalBalanceItem item) {
        ...
        int i = C3419R.C3422id.text_wallet_crypto_total_balance;
        ...
        int i2 = C3419R.C3422id.image_wallet_crypto_eye;
        int i3 = Theme.key_windowBackgroundWhiteGrayText2;
        BaseViewHolder circleRippleBackground = BaseQuickAdapterExtKt.setCircleRippleBackground(BaseQuickAdapterExtKt.setThemedImageColor(text, i2, i3).setImageResource(i2, item.isBalanceHidden() ? C3419R.C3421drawable.fork_wallet_crypto_cipher_eye : C3419R.C3421drawable.fork_filter_icon_eye), i2);
        int i4 = C3419R.C3422id.image_wallet_crypto_tokens_settings;
        int i5 = C3419R.C3422id.image_wallet_order_tokens;
    ...
    public void convert(BaseViewHolder helper, TotalBalanceItem item, List<? extends Object> payloads) {
        ...
        helper.setText(C3419R.C3422id.text_wallet_crypto_total_balance, item.getBalanceText());
    }
}
