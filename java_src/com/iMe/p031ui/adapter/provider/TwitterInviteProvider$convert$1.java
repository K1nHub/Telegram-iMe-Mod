...
public final class TwitterInviteProvider$convert$1 extends Lambda implements Function1<FrameLayout, Unit> {
    ...
    public final void invoke2(FrameLayout applyForView) {
        ...
        stickerSetCell.setText(nickname, resourceManager.getString(C3419R.string.twitter_search_invite_subtitle), C3419R.C3421drawable.fork_drawer_social_twitter, true);
        stickerSetCell.setCustomButtonText(LocaleController.getString("Invite", C3419R.string.Invite));
