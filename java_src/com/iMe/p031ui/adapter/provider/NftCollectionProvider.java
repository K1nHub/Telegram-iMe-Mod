...
public final class NftCollectionProvider extends BaseNodeProvider<NftCollectionItem> {
    ...
    public NftCollectionProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3295R.layout.fork_recycle_item_nft_collection;
    }
    ...
    public void convert(BaseViewHolder helper, NftCollectionItem item) {
        ...
        int i = C3295R.C3298id.card_nft_collection;
        ...
        int i2 = C3295R.C3298id.text_collection_name;
        ...
        int i3 = C3295R.C3298id.text_collection_size;
        ...
        int i4 = C3295R.C3298id.image_arrow;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setRotate(BaseQuickAdapterExtKt.setAlpha(BaseQuickAdapterExtKt.setThemedImageColor(mediumTypeface, i4, Theme.key_windowBackgroundWhiteGrayText2), i4, 0.5f), i4, item.isExpanded() ? BitmapDescriptorFactory.HUE_RED : 270.0f).setText(i3, this.resourceManager.getString(C3295R.string.nft_collection_size, Integer.valueOf(item.getTokens().size()))).setText(i2, item.getCollection().getTitle()), C3295R.C3298id.image_collection_image, new NftCollectionProvider$convert$1(this, item));
    }
    ...
    public void convert(BaseViewHolder helper, NftCollectionItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.setRotate(helper, C3295R.C3298id.image_arrow, item.isExpanded() ? BitmapDescriptorFactory.HUE_RED : 270.0f);
    }
}
