...
public final class BinanceAccountProvider extends BaseNodeProvider<BinanceAccountItem> {
    ...
    public void convert(BaseViewHolder helper, final BinanceAccountItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setCircleRippleBackground(BaseQuickAdapterExtKt.setThemedImageColor(themedTextColor2, i3, Theme.key_dialogIcon), i3), C3419R.C3422id.image_verified, item.getInfo().isVerified()).setText(i2, item.getInfo().getEmail()).setText(i, this.resourceManager.getString(C3419R.string.wallet_binance_pay_id, item.getShortId())), C3419R.C3422id.item_more_options, new BinanceAccountProvider$convert$1(this)), C3419R.C3422id.image_account_avatar, new Function1<BackupImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.BinanceAccountProvider$convert$2
            ...
            public final void invoke2(BackupImageView applyForView) {
                ...
                applyForView.setImageResource(C3419R.C3421drawable.fork_ic_binance_40);
            }
        }), C3419R.C3422id.horizontal_action_buttons, new Function1<HorizontalActionButtonsView, Unit>() { // from class: com.iMe.ui.adapter.provider.BinanceAccountProvider$convert$3
    ...
    public void convert(BaseViewHolder helper, final BinanceAccountItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(helper.setText(C3419R.C3422id.text_account_id, this.resourceManager.getString(C3419R.string.wallet_binance_pay_id, item.getShortId())).setText(C3419R.C3422id.text_account_name, item.getInfo().getEmail()), C3419R.C3422id.image_account_avatar, new Function1<BackupImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.BinanceAccountProvider$convert$4
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(BackupImageView backupImageView) {
                invoke2(backupImageView);
                return Unit.INSTANCE;
        ...
        }), C3419R.C3422id.horizontal_action_buttons, new Function1<HorizontalActionButtonsView, Unit>() { // from class: com.iMe.ui.adapter.provider.BinanceAccountProvider$convert$5
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
