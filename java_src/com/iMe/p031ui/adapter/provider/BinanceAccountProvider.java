...
public final class BinanceAccountProvider extends BaseNodeProvider<BinanceAccountItem> {
    ...
    public void convert(BaseViewHolder helper, BinanceAccountItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setCircleRippleBackground(BaseQuickAdapterExtKt.setThemedImageColor(themedTextColor2, i3, Theme.key_dialogIcon), i3), C3417R.C3420id.image_verified, item.getInfo().isVerified()).setText(i2, item.getInfo().getEmail()).setText(i, this.resourceManager.getString(C3417R.string.wallet_binance_pay_id, item.getShortId())), C3417R.C3420id.item_more_options, new BinanceAccountProvider$convert$1(this)), C3417R.C3420id.image_account_avatar, BinanceAccountProvider$convert$2.INSTANCE), C3417R.C3420id.horizontal_action_buttons, new BinanceAccountProvider$convert$3(item));
    }
    ...
    public void convert(BaseViewHolder helper, BinanceAccountItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(helper.setText(C3417R.C3420id.text_account_id, this.resourceManager.getString(C3417R.string.wallet_binance_pay_id, item.getShortId())).setText(C3417R.C3420id.text_account_name, item.getInfo().getEmail()), C3417R.C3420id.image_account_avatar, BinanceAccountProvider$convert$4.INSTANCE), C3417R.C3420id.horizontal_action_buttons, new BinanceAccountProvider$convert$5(item));
    }
}
