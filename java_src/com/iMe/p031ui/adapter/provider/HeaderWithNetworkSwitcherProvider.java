...
public final class HeaderWithNetworkSwitcherProvider extends BaseNodeProvider<HeaderItemWithNetworkSwitcher> {
    ...
    private final int layoutId = C3242R.layout.fork_recycle_item_wallet_dashboard_header_with_network_switcher;
    ...
    public void convert(BaseViewHolder helper, HeaderItemWithNetworkSwitcher item) {
        ...
        int i2 = C3242R.C3245id.frame_network_type;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setCircleRippleBackground(text.setVisible(i2, item.isNetworkSwitcherVisible()), i2), C3242R.C3245id.view_network_type, new HeaderWithNetworkSwitcherProvider$convert$1(item, this));
    }
    ...
    public void convert(BaseViewHolder helper, HeaderItemWithNetworkSwitcher item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper.setText(C3242R.C3245id.text_wallet_header, item.getTitle()).setVisible(C3242R.C3245id.frame_network_type, item.isNetworkSwitcherVisible()), C3242R.C3245id.view_network_type, new HeaderWithNetworkSwitcherProvider$convert$2(item));
    }
}
