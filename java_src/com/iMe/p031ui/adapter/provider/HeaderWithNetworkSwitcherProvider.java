...
public final class HeaderWithNetworkSwitcherProvider extends BaseNodeProvider<HeaderItemWithNetworkSwitcher> {
    ...
    private final int layoutId = C3417R.layout.fork_recycle_item_wallet_dashboard_header_with_network_switcher;
    ...
    public void convert(BaseViewHolder helper, HeaderItemWithNetworkSwitcher item) {
        ...
        int i2 = C3417R.C3420id.network_type_view;
        BaseQuickAdapterExtKt.applyForView(text.setVisible(i2, item.isNetworkSwitcherVisible()), i2, new HeaderWithNetworkSwitcherProvider$convert$1(item, this));
    }
    ...
    public void convert(BaseViewHolder helper, HeaderItemWithNetworkSwitcher item, List<? extends Object> payloads) {
        ...
        BaseViewHolder text = helper.setText(C3417R.C3420id.text_wallet_header, item.getTitle());
        int i = C3417R.C3420id.network_type_view;
        BaseQuickAdapterExtKt.applyForView(text.setVisible(i, item.isNetworkSwitcherVisible()), i, new HeaderWithNetworkSwitcherProvider$convert$2(item));
    }
}
