...
public final class TokenTransactionProvider extends BaseNodeProvider<TransactionItem> {
    ...
    public void convert(BaseViewHolder helper, TransactionItem item) {
        ...
        BaseViewHolder mediumTypeface = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setVisibleElseGone(themedTextColor4, i6, !RecycleViewExtKt.isLastItem(helper, adapter)).setImageResource(C3295R.C3298id.image_transaction_type_icon, item.getTransactionIcon()), i3);
