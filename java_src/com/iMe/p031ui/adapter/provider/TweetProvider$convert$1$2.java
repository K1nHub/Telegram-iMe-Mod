...
public final class TweetProvider$convert$1$2 extends Lambda implements Function1<RecyclerView, Unit> {
    ...
    public final void invoke2(RecyclerView applyForView) {
        ...
        SimpleInitExtensionsKt.quickInit(applyForView, this.$item.getMediaInfo(), C3290R.layout.fork_recylcer_image_item, new C19891(this.this$0, this.$item));
    }
    ...
    /* loaded from: classes.dex */
    public static final class C19891 extends Lambda implements Function3<View, MediaInfoDomain, Integer, Unit> {
        final /* synthetic */ TweetItem $item;
        final /* synthetic */ TweetProvider this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C19891(TweetProvider tweetProvider, TweetItem tweetItem) {
            super(3);
            this.this$0 = tweetProvider;
            this.$item = tweetItem;
        }
