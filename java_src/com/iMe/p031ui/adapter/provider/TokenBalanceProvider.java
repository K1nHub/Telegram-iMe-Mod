...
public final class TokenBalanceProvider extends BaseNodeProvider<AccountItem.Token> {
    ...
    public void convert(BaseViewHolder helper, AccountItem.Token item) {
        ...
        int i2 = C3242R.C3245id.constraint_trade_info;
        ...
        int i3 = C3242R.C3245id.text_account_title;
        ...
        int i4 = C3242R.C3245id.text_trade_pair;
        int i5 = C3242R.C3245id.text_trade_price;
        int i6 = C3242R.C3245id.text_account_balance_in_dollars;
        ...
        int i7 = C3242R.C3245id.text_trade_percent;
        ...
        int i8 = C3242R.C3245id.text_account_balance;
        BaseViewHolder imageResource = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor3, i8, "chat_messagePanelText"), i8, i4, i7, i5, i6).setImageResource(C3242R.C3245id.image_coin_icon, TokenInfoExtKt.getLogo(item.getBalance().getInfo(), this.cryptoPreferenceHelper.getNetworkType()));
        int i9 = C3242R.C3245id.image_price_direction;
        BaseViewHolder themedImageColor = BaseQuickAdapterExtKt.setThemedImageColor(BaseQuickAdapterExtKt.setThemedImageColor(imageResource.setImageResource(i9, PriceRateExtKt.getPriceDirection(item.getBalance().getPriceRate()).getIcon()), i9, PriceRateExtKt.getPriceDirection(item.getBalance().getPriceRate()).getColor()), C3242R.C3245id.image_trade, "windowBackgroundWhiteGrayText2");
    ...
    public void convert(BaseViewHolder helper, AccountItem.Token item, List<? extends Object> payloads) {
        ...
        MaskFormatter maskFormatter = MaskFormatter.INSTANCE;
        BaseViewHolder text = helper.setText(i, maskFormatter.textOrMask(this.cryptoPreferenceHelper.getCryptoHiddenBalance(), TokenBalanceExtKt.getTotalBalance(balance))).setText(C3242R.C3245id.text_account_balance_in_dollars, maskFormatter.textOrMask(this.cryptoPreferenceHelper.getCryptoHiddenBalance(), TokenBalanceExtKt.getDollarsBalanceText(balance, this.resourceManager)));
        int i2 = C3242R.C3245id.image_price_direction;
        BaseViewHolder imageResource = BaseQuickAdapterExtKt.setThemedImageColor(text.setImageResource(i2, PriceRateExtKt.getPriceDirection(balance.getPriceRate()).getIcon()), i2, PriceRateExtKt.getPriceDirection(balance.getPriceRate()).getColor()).setImageResource(C3242R.C3245id.image_coin_icon, TokenInfoExtKt.getLogo(balance.getInfo(), this.cryptoPreferenceHelper.getNetworkType()));
        int i3 = C3242R.C3245id.text_trade_percent;
        BaseQuickAdapterExtKt.setThemedTextColor(imageResource, i3, PriceRateExtKt.getPriceDirection(balance.getPriceRate()).getColor()).setText(C3242R.C3245id.text_trade_price, TokenBalanceExtKt.getDollarsRateText(balance, this.resourceManager)).setText(i3, this.resourceManager.getString(C3242R.string.wallet_dashboard_balance_24h_rate, Float.valueOf(balance.getPriceRate().getRatePercentageChange24h())));
    }
}
