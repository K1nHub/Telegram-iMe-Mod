...
public final class TokenBalanceProvider extends BaseNodeProvider<AccountItem.Token> {
    ...
    public TokenBalanceProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3473R.layout.fork_recycle_item_wallet_dashboard_account_balance;
    ...
    public void convert(BaseViewHolder helper, final AccountItem.Token item) {
        ...
        int i2 = C3473R.C3476id.constraint_trade_info;
        ...
        int i3 = C3473R.C3476id.text_title;
        ...
        int i5 = C3473R.C3476id.text_trade_pair;
        int i6 = C3473R.C3476id.text_trade_price;
        int i7 = C3473R.C3476id.text_account_balance_in_dollars;
        BaseViewHolder themedTextColor2 = BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i4, i5, i6, i7);
        int i8 = C3473R.C3476id.text_trade_percent;
        ...
        int i9 = C3473R.C3476id.text_subtitle;
        BaseViewHolder loadImage$default = BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor3, i9, Theme.key_chat_messagePanelText), i9, i5, i8, i6, i7), C3473R.C3476id.image_logo, balance.getToken().getAvatarUrl(), null, false, 12, null);
        int i10 = C3473R.C3476id.image_price_direction;
        BaseViewHolder themedImageColor = BaseQuickAdapterExtKt.setThemedImageColor(BaseQuickAdapterExtKt.setThemedImageColor(loadImage$default.setImageResource(i10, TokenBalanceExtKt.getPriceDirection(balance).getIcon()), i10, TokenBalanceExtKt.getPriceDirection(balance).getColorKey()), C3473R.C3476id.image_trade, i4);
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(text.setText(i5, balance.getToken().getTicker() + " / " + TokenDetailed.Companion.getUSD().getName()).setText(i6, TokenBalanceExtKt.getDollarsRateText(balance)).setText(i8, this.resourceManager.getString(C3473R.string.wallet_dashboard_balance_24h_rate, Double.valueOf(balance.getRatePercentageChange24h()))).setText(i7, maskFormatter.textOrMask(item.isBalanceHidden(), TokenBalanceExtKt.getDollarsBalanceText(balance))).setText(C3473R.C3476id.text_coin_ticker, balance.getToken().getTicker()), i2, item.isQuotationVisible()), C3473R.C3476id.image_network_icon, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.TokenBalanceProvider$convert$1$1
            /* JADX INFO: Access modifiers changed from: package-private */
    ...
    public void convert(BaseViewHolder helper, final AccountItem.Token item, List<? extends Object> payloads) {
        ...
        MaskFormatter maskFormatter = MaskFormatter.INSTANCE;
        BaseViewHolder text = helper.setText(i, maskFormatter.textOrMask(item.isBalanceHidden(), TokenBalanceExtKt.getTotalBalance(balance))).setText(C3473R.C3476id.text_account_balance_in_dollars, maskFormatter.textOrMask(item.isBalanceHidden(), TokenBalanceExtKt.getDollarsBalanceText(balance)));
        int i2 = C3473R.C3476id.image_price_direction;
        BaseViewHolder loadImage$default = BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setThemedImageColor(text.setImageResource(i2, TokenBalanceExtKt.getPriceDirection(balance).getIcon()), i2, TokenBalanceExtKt.getPriceDirection(balance).getColorKey()), C3473R.C3476id.image_logo, balance.getToken().getAvatarUrl(), null, false, 12, null);
        int i3 = C3473R.C3476id.text_trade_percent;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setThemedTextColor(loadImage$default, i3, TokenBalanceExtKt.getPriceDirection(balance).getColorKey()).setText(C3473R.C3476id.text_trade_price, TokenBalanceExtKt.getDollarsRateText(balance)).setText(i3, this.resourceManager.getString(C3473R.string.wallet_dashboard_balance_24h_rate, Double.valueOf(balance.getRatePercentageChange24h()))), C3473R.C3476id.image_network_icon, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.TokenBalanceProvider$convert$2$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
