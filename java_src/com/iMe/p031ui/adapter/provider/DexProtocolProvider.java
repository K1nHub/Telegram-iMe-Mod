...
public final class DexProtocolProvider extends BaseNodeProvider<DexProtocolItem> {
    ...
    public void convert(BaseViewHolder helper, DexProtocolItem item) {
        ...
        int i = C3290R.C3293id.card_root;
        ...
        int i2 = C3290R.C3293id.text_title;
        ...
        int i3 = C3290R.C3293id.text_subtitle;
        BaseQuickAdapterExtKt.setForeground(BaseQuickAdapterExtKt.setAlpha(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i3, Theme.key_windowBackgroundWhiteGrayText2).setImageResource(C3290R.C3293id.image_icon, item.getInfo().getLogo()), i2).setText(i2, this.resourceManager.getString(item.getInfo().getName())).setText(i3, this.resourceManager.getString(item.getInfo().getDescription())), C3290R.C3293id.frame_root, item.isEnabled() ? 1.0f : 0.3f), i, item.isEnabled() ? Theme.getSelectorDrawable(false) : null);
    }
}
