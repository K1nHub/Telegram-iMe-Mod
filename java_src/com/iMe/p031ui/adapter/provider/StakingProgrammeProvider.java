...
public final class StakingProgrammeProvider extends BaseNodeProvider<StakingProgrammeItem> {
    ...
    public void convert(BaseViewHolder helper, StakingProgrammeItem item) {
        ...
        int i2 = C3295R.C3298id.staking_info;
        ...
        int i8 = C3295R.C3298id.text_apy_value;
        ...
        int i9 = C3295R.C3298id.text_account_balance_in_dollars;
        ...
        int i10 = C3295R.C3298id.text_apy_title;
        ...
        int i12 = C3295R.C3298id.text_apr_title;
        BaseViewHolder themedTextColor8 = BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor7, i12, i11);
        int i13 = C3295R.C3298id.text_staking_end_title;
        BaseViewHolder imageResource = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor8, i13, i11), i4, i9, i10, i12, i13, i8, i7, i6).setImageResource(C3295R.C3298id.image_coin_icon, TokenInfoExtKt.getLogo(item.getTokenBalance().getInfo(), item.getTokenBalance().getNetworkType()));
        int i14 = C3295R.C3298id.image_network_icon;
        BaseViewHolder text = imageResource.setImageResource(i14, item.getTokenBalance().getNetworkType().getLogo()).setText(i10, this.resourceManager.getString(C3295R.string.staking_programme_apy));
        BaseViewHolder text2 = text.setText(i8, item.getApy() + '%').setText(i12, this.resourceManager.getString(C3295R.string.staking_programme_apr));
        BaseViewHolder gone = BaseQuickAdapterExtKt.setGone(text2.setText(i7, item.getApr() + '%').setText(i13, this.resourceManager.getString(C3295R.string.staking_programme_expires)).setText(i6, item.getEndsAt()).setText(i3, item.getName()).setText(i4, TokenBalanceExtKt.getTotalBalance(item.getTokenBalance())).setText(i9, TokenBalanceExtKt.getDollarsBalanceText(item.getTokenBalance(), this.resourceManager)).setVisible(i14, true).setVisible(i2, true), !item.isParticipated(), i4, i9);
        BalanceFormatter balanceFormatter = BalanceFormatter.INSTANCE;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setGone(BaseQuickAdapterExtKt.setGone(gone, NumberExtKt.isZero(balanceFormatter.parseFormattedString(item.getApy())), i10, i8), NumberExtKt.isZero(balanceFormatter.parseFormattedString(item.getApr())), i12, i7), C3295R.C3298id.text_coin_ticker, new StakingProgrammeProvider$convert$1$1(item, this)), i14, new StakingProgrammeProvider$convert$1$2(this));
    }
    ...
    public void convert(BaseViewHolder helper, StakingProgrammeItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.setThemedTextColor(BaseQuickAdapterExtKt.setThemedTextColor(helper.setText(C3295R.C3298id.text_account_balance, TokenBalanceExtKt.getTotalBalance(item.getTokenBalance())).setText(C3295R.C3298id.text_account_balance_in_dollars, TokenBalanceExtKt.getDollarsBalanceText(item.getTokenBalance(), this.resourceManager)).setImageResource(C3295R.C3298id.image_coin_icon, TokenInfoExtKt.getLogo(item.getTokenBalance().getInfo(), item.getTokenBalance().getNetworkType())), C3295R.C3298id.text_apr_value, item.getPercentageTextColor(StakingAnnualPercentageMode.APR)), C3295R.C3298id.text_apy_value, item.getPercentageTextColor(StakingAnnualPercentageMode.APY));
    }
}
