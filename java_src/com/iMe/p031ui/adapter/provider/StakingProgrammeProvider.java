...
public final class StakingProgrammeProvider extends BaseNodeProvider<StakingProgrammeItem> {
    ...
    public void convert(BaseViewHolder helper, final StakingProgrammeItem item) {
        ...
        int i2 = C3419R.C3422id.staking_info;
        ...
        int i5 = C3419R.C3422id.text_account_balance;
        int i6 = C3419R.C3422id.text_staking_end_value;
        BaseViewHolder themedTextColor2 = BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i4, i5, i6);
        int i7 = C3419R.C3422id.text_apr_value;
        ...
        int i8 = C3419R.C3422id.text_apy_value;
        ...
        int i9 = C3419R.C3422id.text_account_balance_in_dollars;
        ...
        int i11 = C3419R.C3422id.text_apy_title;
        int i12 = C3419R.C3422id.text_apr_title;
        int i13 = C3419R.C3422id.text_staking_end_title;
        BaseViewHolder text = BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor5, i10, i11, i12, i13), i5, i9, i11, i12, i13, i8, i7, i6), C3419R.C3422id.image_coin_icon, item.getTokenBalance().getToken().getAvatarUrl(), null, false, 12, null).setText(i11, this.resourceManager.getString(C3419R.string.staking_programme_apy));
        BaseViewHolder text2 = text.setText(i8, item.getApy() + '%').setText(i12, this.resourceManager.getString(C3419R.string.staking_programme_apr));
        BaseViewHolder text3 = text2.setText(i7, item.getApr() + '%').setText(i13, this.resourceManager.getString(C3419R.string.staking_programme_expires)).setText(i6, item.getEndsAt()).setText(i3, item.getName()).setText(i5, TokenBalanceExtKt.getTotalBalance(item.getTokenBalance())).setText(i9, TokenBalanceExtKt.getDollarsBalanceText(item.getTokenBalance())).setText(C3419R.C3422id.text_coin_ticker, item.getTokenBalance().getToken().getTicker());
        int i14 = C3419R.C3422id.image_network_icon;
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setGone(BaseQuickAdapterExtKt.setGone(gone, NumberExtKt.isZero(balanceFormatter.parseFormattedString(item.getApy())), i11, i8), NumberExtKt.isZero(balanceFormatter.parseFormattedString(item.getApr())), i12, i7), i14, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.StakingProgrammeProvider$convert$1$1
            ...
            public final void invoke2(AppCompatImageView applyForView) {
                ...
                ImageViewExtKt.loadFrom$default(applyForView, NetworksHelper.getNetworkById(StakingProgrammeItem.this.getTokenBalance().getToken().getNetworkId()).getLogoUrl(), null, true, 2, null);
    ...
    public void convert(BaseViewHolder helper, StakingProgrammeItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setThemedTextColor(BaseQuickAdapterExtKt.setThemedTextColor(BaseQuickAdapterExtKt.loadImage$default(helper.setText(C3419R.C3422id.text_account_balance, TokenBalanceExtKt.getTotalBalance(item.getTokenBalance())).setText(C3419R.C3422id.text_account_balance_in_dollars, TokenBalanceExtKt.getDollarsBalanceText(item.getTokenBalance())), C3419R.C3422id.image_coin_icon, item.getTokenBalance().getToken().getAvatarUrl(), null, false, 12, null), C3419R.C3422id.text_apr_value, item.getPercentageTextColor(StakingAnnualPercentageMode.APR)), C3419R.C3422id.text_apy_value, item.getPercentageTextColor(StakingAnnualPercentageMode.APY)), C3419R.C3422id.image_network_icon, NetworksHelper.getNetworkById(item.getTokenBalance().getToken().getNetworkId()).getLogoUrl(), null, false, 12, null);
    }
}
