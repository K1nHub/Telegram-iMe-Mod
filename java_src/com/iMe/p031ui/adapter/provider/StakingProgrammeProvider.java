...
public final class StakingProgrammeProvider extends BaseNodeProvider<StakingProgrammeItem> {
    ...
    public void convert(BaseViewHolder helper, final StakingProgrammeItem item) {
        ...
        int i2 = C3473R.C3476id.staking_info;
        ...
        int i5 = C3473R.C3476id.text_subtitle;
        int i6 = C3473R.C3476id.text_staking_end_value;
        BaseViewHolder themedTextColor2 = BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i4, i5, i6);
        int i7 = C3473R.C3476id.text_apr_value;
        ...
        int i8 = C3473R.C3476id.text_apy_value;
        ...
        int i9 = C3473R.C3476id.text_account_balance_in_dollars;
        ...
        int i11 = C3473R.C3476id.text_apy_title;
        int i12 = C3473R.C3476id.text_apr_title;
        int i13 = C3473R.C3476id.text_staking_end_title;
        BaseViewHolder text = BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor5, i10, i11, i12, i13), i5, i9, i11, i12, i13, i8, i7, i6), C3473R.C3476id.image_logo, item.getTokenBalance().getToken().getAvatarUrl(), null, false, 12, null).setText(i11, this.resourceManager.getString(C3473R.string.staking_programme_apy));
        BaseViewHolder text2 = text.setText(i8, item.getApy() + '%').setText(i12, this.resourceManager.getString(C3473R.string.staking_programme_apr));
        BaseViewHolder text3 = text2.setText(i7, item.getApr() + '%').setText(i13, this.resourceManager.getString(C3473R.string.staking_programme_expires)).setText(i6, item.getEndsAt()).setText(i3, item.getName()).setText(i5, TokenBalanceExtKt.getTotalBalance(item.getTokenBalance())).setText(i9, TokenBalanceExtKt.getDollarsBalanceText(item.getTokenBalance())).setText(C3473R.C3476id.text_coin_ticker, item.getTokenBalance().getToken().getTicker());
        int i14 = C3473R.C3476id.image_network_icon;
    ...
    public void convert(BaseViewHolder helper, StakingProgrammeItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.setThemedTextColor(BaseQuickAdapterExtKt.setThemedTextColor(BaseQuickAdapterExtKt.loadImage$default(helper.setText(C3473R.C3476id.text_subtitle, TokenBalanceExtKt.getTotalBalance(item.getTokenBalance())).setText(C3473R.C3476id.text_account_balance_in_dollars, TokenBalanceExtKt.getDollarsBalanceText(item.getTokenBalance())), C3473R.C3476id.image_logo, item.getTokenBalance().getToken().getAvatarUrl(), null, false, 12, null), C3473R.C3476id.text_apr_value, item.getPercentageTextColor(StakingAnnualPercentageMode.APR)), C3473R.C3476id.text_apy_value, item.getPercentageTextColor(StakingAnnualPercentageMode.APY)), C3473R.C3476id.image_network_icon, NetworksHelper.getNetworkById(item.getTokenBalance().getToken().getNetworkId()).getLogoUrl(), null, false, 12, null);
    }
}
