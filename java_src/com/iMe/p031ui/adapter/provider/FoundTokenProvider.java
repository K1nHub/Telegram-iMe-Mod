...
public final class FoundTokenProvider extends BaseNodeProvider<FoundTokenItem> {
    ...
    public FoundTokenProvider(ResourceManager resourceManager) {
        Lazy lazy;
        Intrinsics.checkNotNullParameter(resourceManager, "resourceManager");
        this.isLastItemDividerVisible = true;
        this.itemViewType = IdFabric$ViewTypes.TOKEN;
        this.layoutId = C3417R.layout.fork_recycle_item_found_token;
        lazy = LazyKt__LazyJVMKt.lazy(new FoundTokenProvider$networkIconCornerSize$2(resourceManager));
    ...
    */
    public void convert(com.chad.library.adapter.base.viewholder.BaseViewHolder r23, com.iMe.model.wallet.home.FoundTokenItem r24) {
        /*
            r22 = this;
            r0 = r22
            r1 = r23
            ...
            int r3 = org.telegram.messenger.C3417R.C3420id.constraint_root
            r4 = 0
            ...
            int r5 = org.telegram.messenger.C3417R.C3420id.text_name
            ...
            int r6 = org.telegram.messenger.C3417R.C3420id.text_address
            ...
            int r9 = org.telegram.messenger.C3417R.C3420id.image_token_icon
            ...
            int r3 = org.telegram.messenger.C3417R.C3420id.image_network_icon
            ...
            int r7 = org.telegram.messenger.C3417R.C3420id.text_ticker
            ...
            int r6 = org.telegram.messenger.C3417R.C3420id.view_switch
            ...
            int r7 = org.telegram.messenger.C3417R.C3420id.divider_horizontal
        ...
        L9b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p031ui.adapter.provider.FoundTokenProvider.convert(com.chad.library.adapter.base.viewholder.BaseViewHolder, com.iMe.model.wallet.home.FoundTokenItem):void");
    }

    public void convert(BaseViewHolder helper, FoundTokenItem item, List<? extends Object> payloads) {
        Intrinsics.checkNotNullParameter(helper, "helper");
        Intrinsics.checkNotNullParameter(item, "item");
        Intrinsics.checkNotNullParameter(payloads, "payloads");
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.loadImage$default(BaseQuickAdapterExtKt.loadImage$default(helper.setText(C3417R.C3420id.text_name, item.getName()).setText(C3417R.C3420id.text_ticker, item.getTicker()), C3417R.C3420id.image_token_icon, item.getTokenLogoUrl(), null, false, 12, null), C3417R.C3420id.image_network_icon, item.getNetworkLogoUrl(), null, false, 12, null), C3417R.C3420id.view_switch, new FoundTokenProvider$convert$3(item));
    }
}
