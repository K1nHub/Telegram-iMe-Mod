...
public final class HeaderProvider extends BaseNodeProvider<HeaderItem> {
    ...
    private final int layoutId = C3417R.layout.fork_recycle_item_wallet_dashboard_header;
    ...
    public void convert(BaseViewHolder helper, HeaderItem item) {
        ...
        int i = C3417R.C3420id.text_wallet_header;
        ...
        int i2 = C3417R.C3420id.frame_root;
