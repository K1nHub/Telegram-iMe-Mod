...
public final class BinanceAccountProvider$convert$1 extends Lambda implements Function1<ActionBarMenuItem, Unit> {
    ...
    public final void invoke2(final ActionBarMenuItem applyForView) {
        ...
        applyForView.setIcon(C3419R.C3421drawable.ic_ab_other);
        ViewExtKt.setCircleRippleBackground(applyForView);
        applyForView.removeAllSubItems();
        int i = IdFabric$Menu.RECEIVE;
        int i2 = C3419R.C3421drawable.fork_ic_ask_transfer_24;
        resourceManager = this.this$0.resourceManager;
        applyForView.addSubItem(i, i2, resourceManager.getString(C3419R.string.wallet_binance_pay_action_receive));
        applyForView.addSubItem(IdFabric$Menu.LOGOUT, C3419R.C3421drawable.msg_leave, LocaleController.getString("LogOut", C3419R.string.LogOut));
        ...
        applyForView.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3419R.string.AccDescrMoreOptions));
    }
