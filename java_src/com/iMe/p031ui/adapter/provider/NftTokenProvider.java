...
public final class NftTokenProvider extends BaseNodeProvider<NftTokenItem> {
    ...
    private final int layoutId = C3419R.layout.fork_recycle_item_nft_token;
    ...
    public void convert(BaseViewHolder helper, final NftTokenItem item) {
        ...
        int i6 = C3419R.C3422id.card_nft_token;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setThemedCardBackground(BaseQuickAdapterExtKt.setRippleForeground(helper, i6, false), i6, Theme.key_windowBackgroundWhite), C3419R.C3422id.nft_root_view, new Function1<NftRootView, Unit>() { // from class: com.iMe.ui.adapter.provider.NftTokenProvider$convert$1
        ...
        }), C3419R.C3422id.image_nft_image, new Function1<BackupImageView, Unit>() { // from class: com.iMe.ui.adapter.provider.NftTokenProvider$convert$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
