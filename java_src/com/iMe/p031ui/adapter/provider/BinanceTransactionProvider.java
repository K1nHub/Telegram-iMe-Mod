...
public final class BinanceTransactionProvider extends BaseNodeProvider<BinanceTransactionItem> {
    ...
    public void convert(BaseViewHolder helper, final BinanceTransactionItem item) {
        ...
        BaseViewHolder mediumTypeface = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setVisibleElseGone(themedTextColor4, i6, !RecycleViewExtKt.isLastItem(helper, adapter)).setImageResource(C3419R.C3422id.image_transaction_type_icon, item.getTransactionIcon()), i3);
        ...
        BaseQuickAdapterExtKt.applyForView(padding.setText(i4, item.getTransactionStatus(this.resourceManager)).setText(i3, item.getAmount()).setText(i5, item.getTransactionTitle(this.resourceManager)), i2, new Function1<TimeWithClockView, Unit>() { // from class: com.iMe.ui.adapter.provider.BinanceTransactionProvider$convert$1
