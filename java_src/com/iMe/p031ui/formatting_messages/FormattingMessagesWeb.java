...
public final class FormattingMessagesWeb extends LinearLayout {
    ...
    */
    public final void updateBackgroundButton(android.view.View r11, boolean r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p031ui.formatting_messages.FormattingMessagesWeb.updateBackgroundButton(android.view.View, boolean):void");
    }
    ...
    public final ImageView initSpoilerButton() {
        ...
        imageView.setPadding(m72dp, m72dp, m72dp, m72dp);
        imageView.setImageResource(C3473R.C3475drawable.fork_wallet_crypto_cipher_eye);
        return imageView;
    }
    ...
    public final LinearLayout initContainerButton() {
        ...
        linearLayout.addView(getCloseButton(), LayoutHelper.createLinear(-2, -2, AndroidUtilities.m72dp(1), 0, 0, 0));
        linearLayout.addView(getBoldButton(), LayoutHelper.createLinear(0, 48, 0.5f, AndroidUtilities.m72dp(1), 0, AndroidUtilities.m72dp(1), 0));
        LinearLayout.LayoutParams createLinear = LayoutHelper.createLinear(0, 48, 0.5f, 0, 0, AndroidUtilities.m72dp(1), 0);
    ...
    */
    private final void updateTextColor(java.util.List<? extends android.view.View> r7) {
        ...
        La8:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p031ui.formatting_messages.FormattingMessagesWeb.updateTextColor(java.util.List):void");
    }
}
