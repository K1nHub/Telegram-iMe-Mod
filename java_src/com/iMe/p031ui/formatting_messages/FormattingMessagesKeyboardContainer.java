package com.iMe.p031ui.formatting_messages;
...
public final class FormattingMessagesKeyboardContainer extends FrameLayout {
    ...
    public FormattingMessagesKeyboardContainer(Context context, EditTextCaption messageEditText, FormattingTextController formattingTextController, Listener listener) {
        ...
        this.view = view;
        updateView();
        addView(view, LayoutHelper.createFrame(-1, AndroidUtilities.m72dp(1), 48));
        addView(getTitleLink(), LayoutHelper.createFrame(-2, -2));
        addView(getLinkContainer(), LayoutHelper.createFrame(-1, -2, 0, AndroidUtilities.m72dp(8), 0, AndroidUtilities.m72dp(8), 0));
    ...
    public final void updateView() {
        ...
        if (this.formattingTextController.getListSpansFlags().size() == 1) {
            if ((this.formattingTextController.getListSpansFlags().get(0).getUrl().length() > 0) && linkText.isEnabled()) {
                ...
                getLinkContainer().setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m73dp(8.0f), Theme.getColor(this.buttonDefaultColor), Theme.getColor(this.buttonPressedColor)));
            }
        }
    ...
    */
    public final void updateBackgroundButton(android.widget.TextView r11, boolean r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p031ui.formatting_messages.FormattingMessagesKeyboardContainer.updateBackgroundButton(android.widget.TextView, boolean):void");
    }
    ...
    public final TextView initTitleLink() {
        ...
        textView.setText(LocaleController.getString(C3473R.string.formatting_link_title));
    ...
    public final ImageView initIconLink() {
        ...
        imageView.setImageResource(C3473R.C3475drawable.msg_link_folder);
        return imageView;
    }
    ...
    public final FormattingMessagesKeyboardContainer$initLinkText$1 initLinkText() {
        ...
        r1.setHint(r1.getContext().getString(C3473R.string.formatting_link_hint_edit_text));
        r1.setCursorColor(Theme.key_featuredStickers_addedIcon);
        r1.setCursorSize(AndroidUtilities.m72dp(20));
        return r1;
    }
    ...
    public final TextView initPastLink() {
        ...
        textView.setPadding(0, 0, AndroidUtilities.m72dp(8), 0);
    ...
    public final ImageView initClearLink() {
        ...
        imageView.setImageResource(C3473R.C3475drawable.msg_delete);
        int m72dp = AndroidUtilities.m72dp(8);
        imageView.setPadding(m72dp, m72dp, m72dp, m72dp);
        return imageView;
    }
    ...
    public final TextView initTitleFormat() {
        TextView textView = new TextView(getContext());
        textView.setGravity(17);
        textView.setText(textView.getContext().getText(C3473R.string.formatting_hint_format));
        textView.setTextSize(1, 14.0f);
        return textView;
    }
    ...
    public final TextView initMonoButton() {
        ...
        textView.setGravity(17);
        textView.setIncludeFontPadding(false);
        textView.setText(LocaleController.getString("Mono", C3473R.string.Mono));
        ViewExtKt.withMediumTypeface(textView);
        textView.setTextSize(1, 18.0f);
    ...
    public final TextView initSpoilerButton() {
        ...
        textView.setGravity(17);
        textView.setIncludeFontPadding(false);
        textView.setText(LocaleController.getString("Spoiler", C3473R.string.Spoiler));
        ViewExtKt.withMediumTypeface(textView);
        textView.setTextSize(1, 18.0f);
    ...
    public final LinearLayout initLinkContainer() {
        ...
        linearLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m73dp(8.0f), Theme.getColor(this.buttonDefaultColor), Theme.getColor(this.buttonPressedColor)));
    ...
    public final LinearLayout initSmallButtons() {
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setOrientation(0);
        linearLayout.addView(getBoldButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m72dp(8), 0, 0, 0));
        linearLayout.addView(getItalicButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m72dp(1), 0, 0, 0));
        linearLayout.addView(getUnderlineButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m72dp(1), 0, 0, 0));
        linearLayout.addView(getStrikeButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m72dp(1), 0, AndroidUtilities.m72dp(8), 0));
        return linearLayout;
    }
    ...
    public final LinearLayout initBigButtons() {
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setOrientation(0);
        linearLayout.addView(getMonoButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m72dp(8), 0, AndroidUtilities.m72dp(2), AndroidUtilities.m72dp(8)));
        linearLayout.addView(getSpoilerButton(), LayoutHelper.createLinear(-2, 60, 1.0f, AndroidUtilities.m72dp(2), 0, AndroidUtilities.m72dp(8), AndroidUtilities.m72dp(8)));
        return linearLayout;
    }
    ...
    protected void onMeasure(int i, int i2) {
        ViewExtKt.setMargins(getTitleLink(), AndroidUtilities.m72dp(50), AndroidUtilities.m72dp(20), 0, 0);
        ...
        ViewExtKt.setMargins(linkContainer, i3, m72dp, marginLayoutParams2 != null ? marginLayoutParams2.rightMargin : 0, 0);
        ViewExtKt.setMargins(getTitleFormat(), AndroidUtilities.m72dp(50), 0, 0, AndroidUtilities.m72dp(163));
        ViewExtKt.setMargins(getSmallButtons(), 0, 0, 0, AndroidUtilities.m72dp(90));
        ViewExtKt.setMargins(getBigButtons(), 0, 0, 0, AndroidUtilities.m72dp(20));
