package com.iMe.p031ui.smartpanel.extension;
...
public final class ImageViewExtKt {
    ...
    public static final void loadFromWithPlaceholderResId(ImageView imageView, String url, Context context, Integer num, boolean z) {
        ...
        if (num != null) {
            ...
            gradientDrawable2.setColor(ColorStateList.valueOf(ContextCompat.getColor(context, C3242R.C3243color.placeholder_color)));
