...
public final class BotSettingsActivity extends MvpFragment {
    ...
    private final ResettableLazy rootView$delegate = ResettableLazyDelegateKt.resettableLazy$default(this, (ResettableLazyManager) null, new Function0<FrameLayout>() { // from class: com.iMe.ui.shop.BotSettingsActivity$rootView$2
        ...
        public final FrameLayout invoke() {
            ...
            initRootView = BotSettingsActivity.this.initRootView();
            return initRootView;
        }
    }, 1, (Object) null);
    private final ResettableLazy listView$delegate = ResettableLazyDelegateKt.resettableLazy$default(this, (ResettableLazyManager) null, new Function0<RecyclerListView>() { // from class: com.iMe.ui.shop.BotSettingsActivity$listView$2
        /* JADX INFO: Access modifiers changed from: package-private */
        {
            super(0);
        }
        ...
        public final RecyclerListView invoke() {
            ...
            initListView = BotSettingsActivity.this.initListView();
            return initListView;
        }
    }, 1, (Object) null);
    private final ResettableLazy listAdapter$delegate = ResettableLazyDelegateKt.resettableLazy$default(this, (ResettableLazyManager) null, new Function0<ListAdapter>() { // from class: com.iMe.ui.shop.BotSettingsActivity$listAdapter$2
        /* JADX INFO: Access modifiers changed from: package-private */
        {
            super(0);
        }
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(LocaleController.getInternalString(C3473R.string.neurobots_settings_screen_title));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.shop.BotSettingsActivity$setupActionBar$1$1
    ...
    public static final void initListView$lambda$9$lambda$8(BotSettingsActivity this$0, View view, int i) {
        ...
        if (view instanceof TextCheckCell) {
            ...
            if (i == this$0.enableBotsRow) {
                ...
                NotificationCenter.getInstance(this$0.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.neuroBotEnableChanged, new Object[0]);
            ...
            NotificationCenter.getInstance(this$0.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botSettingsChanged, new Object[0]);
        }
    }
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.HEADER_CELL && (view instanceof HeaderCell)) {
                ((HeaderCell) view).setText(LocaleController.getInternalString(C3473R.string.neurobots_settings_automatic_response_header));
                ...
                if (i != BotSettingsActivity.this.enableBotsRow) {
                    if (i != BotSettingsActivity.this.autoBotsInPersonalChatsRow) {
                        if (i != BotSettingsActivity.this.autoBotsInGroupsRow) {
                            if (i == BotSettingsActivity.this.showOftenUsedRow) {
                                ((TextCheckCell) view).setTextAndCheck(LocaleController.getInternalString(C3473R.string.neurobots_settings_often_used_enable_item_title), BotSettingsActivity.this.getNeuroBotsController().isShowOftenUsedNeuroBotsEnabled(), z);
                                return;
                            }
                            return;
                        }
                        ((TextCheckCell) view).setTextAndCheck(LocaleController.getInternalString(C3473R.string.neurobots_settings_groups_automatic_response_enable_item_title), BotSettingsActivity.this.getNeuroBotsController().isNeuroBotsAutoEnabledInGroups(), z);
                        return;
                    }
                    ((TextCheckCell) view).setTextAndCheck(LocaleController.getInternalString(C3473R.string.neurobots_settings_chats_automatic_response_enable_item_title), BotSettingsActivity.this.getNeuroBotsController().isNeuroBotsAutoEnabledInPersonalChats(), z);
                    return;
                }
                ((TextCheckCell) view).setTextAndCheck(LocaleController.getInternalString(C3473R.string.neurobots_settings_enable_item_title), BotSettingsActivity.this.getNeuroBotsController().isNeuroBotsEnabled(), z);
            }
        }
    }
}
