...
public final class C2036xbf3f1d4f extends Lambda implements Function1<Object, Boolean> {
    public static final C2036xbf3f1d4f INSTANCE = new C2036xbf3f1d4f();

    public C2036xbf3f1d4f() {
        super(1);
    }
