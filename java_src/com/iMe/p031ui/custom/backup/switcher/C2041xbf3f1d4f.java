...
public final class C2041xbf3f1d4f extends Lambda implements Function1<Object, Boolean> {
    public static final C2041xbf3f1d4f INSTANCE = new C2041xbf3f1d4f();

    public C2041xbf3f1d4f() {
        super(1);
    }
