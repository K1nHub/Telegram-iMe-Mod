...
public final class CryptoboxInfoView extends FrameLayout implements KoinComponent {
    ...
    public final void setupViewData(CryptoBoxCreationRulesItem item, boolean z) {
        ...
        forkContentCryptoboxInfoBinding.textTotalTokensValue.setText(item.getTotalAmountText());
    ...
    public final void setupColors() {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new AppCompatTextView[]{forkContentCryptoboxInfoBinding.textTotalTokensTitle, forkContentCryptoboxInfoBinding.textTotalTokensValue, forkContentCryptoboxInfoBinding.textTotalFeeTitle, forkContentCryptoboxInfoBinding.textTotalFeeValue});
        ...
        AppCompatTextView textTotalTokensTitle = forkContentCryptoboxInfoBinding.textTotalTokensTitle;
        Intrinsics.checkNotNullExpressionValue(textTotalTokensTitle, "textTotalTokensTitle");
        ...
        ViewExtKt.setTextsColor(i, textTotalTokensTitle, textCreationFeeTitle, textTotalUsersFeeTitle, textTotalFeeTitle);
        int i2 = Theme.key_chat_messagePanelText;
        AppCompatTextView textTotalTokensValue = forkContentCryptoboxInfoBinding.textTotalTokensValue;
        Intrinsics.checkNotNullExpressionValue(textTotalTokensValue, "textTotalTokensValue");
        ...
        ViewExtKt.setTextsColor(i2, textTotalTokensValue, textCreationFeeValue, textTotalUsersFeeValue, textTotalFeeValue);
    }
