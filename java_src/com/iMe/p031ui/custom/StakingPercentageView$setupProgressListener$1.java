...
public final class StakingPercentageView$setupProgressListener$1 extends Lambda implements Function1<Float, Unit> {
    ...
    public final void invoke2(Float newProgress) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.iMe.ui.custom.StakingPercentageView$setupProgressListener$1$$ExternalSyntheticLambda0
