...
public final class TopicsAlert extends BottomSheet {
    ...
    public final TextView initSelectTopicTitleTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3473R.string.topics_select));
    ...
    public final TextView initBottomButton(boolean z) {
        ...
        if (z) {
            textView.setText(LocaleController.getString("Create", C3473R.string.Create));
            ...
            textView.setText(LocaleController.getString("Close", C3473R.string.Close));
            textView.setTextColor(getThemedColor(Theme.key_dialogTextBlue2));
            ...
            textView.setText(LocaleController.getInternalString(C3473R.string.topics_remove));
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r7, int r8) {
            /*
                ...
                java.util.List r0 = com.iMe.p031ui.topics.TopicsAlert.access$getTopics(r0)
            ...
            Lad:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.iMe.p031ui.topics.TopicsAlert.ListAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
    }
}
