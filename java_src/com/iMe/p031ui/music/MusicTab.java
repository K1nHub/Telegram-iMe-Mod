...
public enum MusicTab {
    ALBUMS(C3290R.string.music_albums_tab, EmptyCellType.MUSIC_ALBUMS),
    CHANNELS(C3290R.string.music_channels_tab, EmptyCellType.MUSIC_CHANNELS),
    BOTS(C3290R.string.music_bots_tab, EmptyCellType.MUSIC_BOTS),
    DEVICE(C3290R.string.music_device_tab, EmptyCellType.MUSIC_DEVICE);
