...
public final class ProfilePresenter extends BasePresenter<ProfileView> {
    ...
    public final void changeRankVisibility(boolean z) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1981x21fa58d6(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1982x21fa58d7((BaseView) getViewState())));
    ...
    public final void startTwitterAuthFlow() {
        ...
        Observable<Result<SessionTokens>> observeOn = walletSessionInteractor.refreshToken(refreshToken).startWith((Observable<Result<SessionTokens>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "walletSessionInteractor\n…(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1991x3fe6b4ef(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1992x3fe6b4f0((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void acceptTwitterConnection() {
        ...
        Observable<Result<Boolean>> observeOn = this.twitterInteractor.acceptConnection(twitterProfileInfo.getTwitterUserId(), this.profileId).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "twitterInteractor\n      …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1979xa60791c7(this, twitterProfileInfo)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1980xa60791c8((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void declineConnection() {
        ...
        TwitterProfileInfo twitterProfileInfo = this.twitterProfileInfo;
        if (twitterProfileInfo != null) {
            Observable<Result<Boolean>> observeOn = twitterInteractor.declineConnection(twitterProfileInfo.getTwitterUserId(), this.profileId).observeOn(this.schedulersProvider.mo693ui());
            Intrinsics.checkNotNullExpressionValue(observeOn, "twitterInteractor\n      …(schedulersProvider.ui())");
            Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1983x99db2a72(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1984x99db2a73((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
        }
    }
    ...
    public final void logoutTwitter() {
        Observable<Result<Boolean>> observeOn = this.twitterInteractor.logout(this.profileId).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "twitterInteractor\n      …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1989x5e3b2f87(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1990x5e3b2f88((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public void onFirstViewAttach() {
        if (this.userId != 0 && WalletHelper.isAuthorized()) {
    ...
    private final void loadTwitterProfile() {
        Observable<Result<TwitterProfileInfo>> observeOn = getTwitterProfileObservable().observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "getTwitterProfileObserva…(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1987x153b6724(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1988x153b6725((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final void loadAccountLevelInfo() {
        Observable<Result<AccountLevelInformation>> observeOn = this.accountLevelInteractor.getAccountLevelInformation(this.userId).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "accountLevelInteractor\n …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1985xe14e28d3(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1986xe14e28d4((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }

    private final void showVpnWarningDialog() {
        ((ProfileView) getViewState()).showVpnWarningDialog(new DialogModel(this.resourceManager.getString(C3242R.string.profile_twitter_vpn_alert_title), this.resourceManager.getString(C3242R.string.profile_twitter_vpn_alert_description), this.resourceManager.getString(C3242R.string.common_cancel), this.resourceManager.getString(C3242R.string.common_ok)));
    }

    private final void showTwitterBotConfirmationDialog() {
        ((ProfileView) getViewState()).showTwitterBotConfirmationDialogIfNeeded(new DialogModel(this.resourceManager.getString(C3242R.string.profile_twitter_bot_confirmation_alert_title), this.resourceManager.getString(C3242R.string.profile_twitter_bot_confirmation_alert_description, AppConfiguration$Wallet.getWalletBotUsernameWithAT()), this.resourceManager.getString(C3242R.string.common_cancel), LocaleController.getString("Add", C3242R.string.Add)));
    }

    private final void showTwitterUnlinkedErrorDialog() {
        ((ProfileView) getViewState()).showTwitterUnlinkedErrorDialog(new DialogModel(this.resourceManager.getString(C3242R.string.profile_twitter_unlinked_error_alert_title), this.resourceManager.getString(C3242R.string.profile_twitter_unlinked_error_alert_description), this.resourceManager.getString(C3242R.string.profile_twitter_unlinked_error_alert_log_out), this.resourceManager.getString(C3242R.string.profile_twitter_unlinked_error_alert_link)));
    }

    private final void showTwitterLinkConfirmationDialog() {
        ((ProfileView) getViewState()).showTwitterLinkConfirmationDialog(new DialogModel(this.resourceManager.getString(C3242R.string.profile_twitter_link_confirmation_alert_title), this.resourceManager.getString(C3242R.string.profile_twitter_link_confirmation_alert_description), LocaleController.getString("Cancel", C3242R.string.Cancel), this.resourceManager.getString(C3242R.string.common_confirm)));
    }

    private final void showTwitterResetConfirmationDialog() {
        ((ProfileView) getViewState()).showTwitterResetConfirmationDialog(new DialogModel(this.resourceManager.getString(C3242R.string.profile_twitter_reset_confirmation_alert_title), this.resourceManager.getString(C3242R.string.profile_twitter_reset_confirmation_alert_description), LocaleController.getString("Cancel", C3242R.string.Cancel), LocaleController.getString("Reset", C3242R.string.Reset)));
    }
}
