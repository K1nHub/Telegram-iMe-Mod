...
public final class C2062x3fabecbe extends Lambda implements Function1<TLRPC$messages_BotResults, Result<? extends TLRPC$messages_BotResults>> {
    public static final C2062x3fabecbe INSTANCE = new C2062x3fabecbe();

    public C2062x3fabecbe() {
        super(1);
    }
