...
public final class C2063x3fabecbf extends Lambda implements Function1<Throwable, Result<? extends TLRPC$messages_BotResults>> {
    public static final C2063x3fabecbf INSTANCE = new C2063x3fabecbf();

    public C2063x3fabecbf() {
        super(1);
    }
