...
public final class C1996x3fabecbf extends Lambda implements Function1<Throwable, Result<? extends TLRPC$messages_BotResults>> {
    public static final C1996x3fabecbf INSTANCE = new C1996x3fabecbf();

    public C1996x3fabecbf() {
        super(1);
    }
