...
public final class C2056x7bf70dbb extends Lambda implements Function1<Result<? extends TLRPC$messages_BotResults>, Unit> {
    final /* synthetic */ MessageObject $replyMessageObject$inlined;
    final /* synthetic */ ReactionPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2056x7bf70dbb(ReactionPresenter reactionPresenter, MessageObject messageObject) {
        super(1);
    ...
    public final void m1350invoke(Result<? extends TLRPC$messages_BotResults> it) {
