...
public final class C1995x3fabecbe extends Lambda implements Function1<TLRPC$messages_BotResults, Result<? extends TLRPC$messages_BotResults>> {
    public static final C1995x3fabecbe INSTANCE = new C1995x3fabecbe();

    public C1995x3fabecbe() {
        super(1);
    }
