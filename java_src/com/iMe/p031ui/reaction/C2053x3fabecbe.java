...
public final class C2053x3fabecbe extends Lambda implements Function1<TLRPC$messages_BotResults, Result<? extends TLRPC$messages_BotResults>> {
    public static final C2053x3fabecbe INSTANCE = new C2053x3fabecbe();

    public C2053x3fabecbe() {
        super(1);
    }
