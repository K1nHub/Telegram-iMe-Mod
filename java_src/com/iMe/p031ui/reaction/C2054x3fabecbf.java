...
public final class C2054x3fabecbf extends Lambda implements Function1<Throwable, Result<? extends TLRPC$messages_BotResults>> {
    public static final C2054x3fabecbf INSTANCE = new C2054x3fabecbf();

    public C2054x3fabecbf() {
        super(1);
    }
