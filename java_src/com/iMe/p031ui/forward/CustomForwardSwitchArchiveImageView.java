package com.iMe.p031ui.forward;
...
public final class CustomForwardSwitchArchiveImageView extends ImageView {
    ...
    public CustomForwardSwitchArchiveImageView(Context context) {
        ...
        setImageResource(C3242R.C3244drawable.fork_custom_forward_switch_archive);
    }
    ...
    public final boolean toggleArchive() {
        ...
        setImageResource(this.isArchive ? C3242R.C3244drawable.fork_custom_forward_switch_main : C3242R.C3244drawable.fork_custom_forward_switch_archive);
