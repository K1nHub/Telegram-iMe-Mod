...
public final class C2035xb2bce297 extends Lambda implements Function1<DomainRxEvents.DonationAddressUpdated, Unit> {
    final /* synthetic */ ChatPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2035xb2bce297(ChatPresenter chatPresenter) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents.DonationAddressUpdated donationAddressUpdated) {
        m1342invoke(donationAddressUpdated);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1342invoke(DomainRxEvents.DonationAddressUpdated it) {
        ...
        boolean z = false;
        if (tLRPC$Chat != null && donationAddressUpdated.getChatId() == tLRPC$Chat.f1515id) {
            z = true;
        }
        if (z) {
            ...
            chatPresenter.checkIsDonationEnabled(telegramConstants.prepareChatIdForBotAPI(tLRPC$Chat2.f1515id));
        }
    }
}
