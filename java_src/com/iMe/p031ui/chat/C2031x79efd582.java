...
public final class C2031x79efd582 extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ MessageObject $messageObject$inlined;
    final /* synthetic */ ChatPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2031x79efd582(ChatPresenter chatPresenter, MessageObject messageObject) {
        super(1);
    ...
    public final void m1336invoke(Result<? extends String> it) {
