...
public enum DrawerAccountData {
    PHONE(C3419R.string.drawer_profile_cell_alert_phone_number),
    USERNAME(C3419R.string.drawer_profile_cell_alert_username),
    NAME(C3419R.string.drawer_profile_cell_alert_name),
    USER_ID(C3419R.string.drawer_profile_cell_alert_user_id);
