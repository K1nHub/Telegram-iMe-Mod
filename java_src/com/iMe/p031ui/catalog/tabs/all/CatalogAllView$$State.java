...
public class CatalogAllView$$State extends MvpViewState<CatalogAllView> implements CatalogAllView {
    ...
    public class ShowErrorToastCommand<T> extends ViewCommand<CatalogAllView> {
        ...
        ShowErrorToastCommand(CatalogAllView$$State catalogAllView$$State, Result.Error<? extends T> error, ResourceManager resourceManager) {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(CatalogAllView catalogAllView) {
            catalogAllView.showErrorToast(this.result, this.resourceManager);
        }
    }
