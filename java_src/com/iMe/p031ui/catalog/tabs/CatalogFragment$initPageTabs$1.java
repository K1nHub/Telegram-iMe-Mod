...
/* renamed from: com.iMe.ui.catalog.tabs.CatalogFragment$initPageTabs$1 */
/* loaded from: classes3.dex */
public final class CatalogFragment$initPageTabs$1 extends Lambda implements Function0<View> {
    final /* synthetic */ CatalogFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CatalogFragment$initPageTabs$1(CatalogFragment catalogFragment) {
        super(0);
    ...
    public final View invoke() {
        ...
        return ((BaseNavigationRouter) navigationRouter).getViewByFragmentId(C3417R.C3420id.catalog_all);
    }
}
