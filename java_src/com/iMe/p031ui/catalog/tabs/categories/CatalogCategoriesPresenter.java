...
public final class CatalogCategoriesPresenter extends BasePresenter<CatalogCategoriesView> {
    ...
    public final void loadChannels(boolean z) {
        Observable<Result<CampaignsCursored>> observeOn = getChannelsObservable().observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "getChannelsObservable()\n…(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1939xb19ad2ea(this, z)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1940xb19ad2eb(null)));
    ...
    public final void onChannelClick(CampaignItem campaign) {
        ...
        Intrinsics.checkNotNullExpressionValue(RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1943xc0315c98(this, campaign)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1944xc0315c99(null))), "viewState: BaseView? = n…  onError.invoke()\n    })");
    }
    ...
    private final void loadInitial(boolean z) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1941x9d757cd0(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1942x9d757cd1(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final Observable<Result<CampaignsCursored>> getCategoriesObservable(Result<CampaignsCursored> result, boolean z) {
        Observable<Result<List<CategoryWithCounter>>> observeOn = this.catalogInteractor.getCategories(this.chatType, z).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "catalogInteractor\n      …(schedulersProvider.ui())");
        final C1938xf97b28f1 c1938xf97b28f1 = new C1938xf97b28f1(this, result);
        Observable map = observeOn.map(new Function(c1938xf97b28f1) { // from class: com.iMe.ui.catalog.tabs.categories.CatalogCategoriesPresenter$inlined$sam$i$io_reactivex_functions_Function$0
            private final /* synthetic */ Function1 function;

            {
                Intrinsics.checkNotNullParameter(c1938xf97b28f1, "function");
                this.function = c1938xf97b28f1;
            }
    ...
    public final FilterItem getCategoryAll() {
        String upperCase = this.resourceManager.getString(C3242R.string.catalog_all).toUpperCase(Locale.ROOT);
