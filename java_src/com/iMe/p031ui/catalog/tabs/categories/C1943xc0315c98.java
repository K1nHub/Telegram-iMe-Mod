...
public final class C1943xc0315c98 extends Lambda implements Function1<TLRPC$Chat, Unit> {
    final /* synthetic */ CampaignItem $campaign$inlined;
    final /* synthetic */ CatalogCategoriesPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1943xc0315c98(CatalogCategoriesPresenter catalogCategoriesPresenter, CampaignItem campaignItem) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(TLRPC$Chat tLRPC$Chat) {
        m1296invoke(tLRPC$Chat);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1296invoke(TLRPC$Chat it) {
        ChatType chatType;
