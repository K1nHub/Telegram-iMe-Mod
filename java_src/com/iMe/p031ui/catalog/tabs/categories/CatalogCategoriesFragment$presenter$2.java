...
public final class CatalogCategoriesFragment$presenter$2 extends Lambda implements Function0<CatalogCategoriesPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C20181 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ ChatType $chatType;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C20181(ChatType chatType) {
            super(0);
            this.$chatType = chatType;
        }
    ...
    public final CatalogCategoriesPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2017xadaf5059(this.this$0, null, new C20181(this.$chatType)));
