...
public final class ChannelDetailsBottomSheetDialog extends MvpBottomSheet implements ChannelDetailsView {
    ...
    */
    ...
    public void setupCampaignInfo(CampaignItem campaignItem) {
        ...
        ImageViewExtKt.loadFrom$default(imageAvatar, campaignItem.getPhoto(), Integer.valueOf(C3473R.C3475drawable.photo_placeholder_in), false, 4, null);
    ...
    public void setupSubscribeButton(boolean z) {
        ...
        if (i != 1) {
            ...
            if (z) {
                string = LocaleController.getString("JoinGroup", C3473R.string.JoinGroup);
            } else {
                string = LocaleController.getString("LeaveMegaMenu", C3473R.string.LeaveMegaMenu);
            }
        } else if (z) {
            string = LocaleController.getString("ChannelJoin", C3473R.string.ChannelJoin);
        } else {
            string = LocaleController.getString("LeaveChannel", C3473R.string.LeaveChannel);
        }
    ...
    private final void setupViews() {
        ...
        binding.textLanguageTitle.setText(getResourceManager().getString(C3473R.string.catalog_channel_details_language));
        binding.textTags.setText(getResourceManager().getString(C3473R.string.catalog_channel_details_tags));
        setupButtonMore();
    }
    ...
    private final void setupButtonMore() {
        ...
        setupButtonMore$lambda$18.setIcon(C3473R.C3475drawable.ic_ab_other);
        ...
        setupButtonMore$lambda$18.addSubItem(IdFabric$Menu.SHARE, C3473R.C3475drawable.share, LocaleController.getString("ShareLink", C3473R.string.ShareLink));
        setupButtonMore$lambda$18.addSubItem(IdFabric$Menu.COPY, C3473R.C3475drawable.msg_link2, LocaleController.getString("CopyLink", C3473R.string.CopyLink));
        setupButtonMore$lambda$18.addSubItem(IdFabric$Menu.f339QR, C3473R.C3475drawable.msg_qrcode, LocaleController.getString("GetQRCode", C3473R.string.GetQRCode));
        ...
        setupButtonMore$lambda$18.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
    }
