...
final class ChannelDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<ChannelDetailsPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C20071 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ CampaignItem $campaign;
        final /* synthetic */ TLRPC$Chat $chat;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C20071(CampaignItem campaignItem, TLRPC$Chat tLRPC$Chat) {
            super(0);
            this.$campaign = campaignItem;
            this.$chat = tLRPC$Chat;
        }
    ...
    public final ChannelDetailsPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2005xf609b581(this.this$0, null, new C20071(this.$campaign, this.$chat)));
