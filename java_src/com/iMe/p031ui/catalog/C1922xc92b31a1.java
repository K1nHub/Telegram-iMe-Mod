...
public final class C1922xc92b31a1 extends Lambda implements Function1<Result<? extends List<? extends CatalogLanguage>>, Unit> {
    final /* synthetic */ CatalogRootPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1922xc92b31a1(CatalogRootPresenter catalogRootPresenter) {
        super(1);
    ...
    public final void m1288invoke(Result<? extends List<? extends CatalogLanguage>> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            ((CatalogRootView) this.this$0.getViewState()).showErrorToast((Result.Error) result, resourceManager);
        }
    }
}
