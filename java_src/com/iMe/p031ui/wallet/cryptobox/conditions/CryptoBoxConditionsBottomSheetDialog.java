    ...
    */
    public CryptoBoxConditionsBottomSheetDialog(final com.iMe.storage.domain.model.crypto.cryptobox.CryptoBoxInfo r4, final org.telegram.tgnet.TLRPC$Chat r5, org.telegram.p043ui.ActionBar.BaseFragment r6) {
        /*
            ...
            r0.<init>()
            java.lang.Class<com.iMe.ui.wallet.cryptobox.conditions.CryptoBoxConditionsPresenter> r2 = com.iMe.p031ui.wallet.cryptobox.conditions.CryptoBoxConditionsPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p031ui.wallet.cryptobox.conditions.CryptoBoxConditionsBottomSheetDialog.<init>(com.iMe.storage.domain.model.crypto.cryptobox.CryptoBoxInfo, org.telegram.tgnet.TLRPC$Chat, org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    @Override // com.iMe.p031ui.wallet.cryptobox.conditions.CryptoBoxConditionsView
    public void renderScreenData(String tokenLogoUrl, String networkIconUrl, String name, String description, String rewardPerUserText, String membersText, String balanceText, String startDate, Network.Explorer explorer) {
        ...
        viewHeader.setupViewData((r13 & 1) != 0 ? null : tokenLogoUrl, (r13 & 2) != 0 ? null : null, (r13 & 4) != 0 ? null : networkIconUrl, name, description);
        binding.viewRewardPerUserCell.setupViewData(getResourceManager().getString(C3473R.string.cryptobox_conditions_reward_per_user), rewardPerUserText, C3473R.C3475drawable.fork_ic_cryptobox, true);
        binding.viewMembersCell.setupViewData(getResourceManager().getString(C3473R.string.cryptobox_details_members), membersText, C3473R.C3475drawable.msg_groups, true);
        binding.viewBalanceCell.setupViewData(getResourceManager().getString(C3473R.string.cryptobox_details_balance), balanceText, C3473R.C3475drawable.fork_ic_donations_24, true);
        ...
        DetailsIconCellView.setupViewData$default(viewStartDateCell, getResourceManager().getString(C3473R.string.staking_conditions_start), startDate, C3473R.C3475drawable.fork_ic_start, false, 8, null);
        binding.itemMoreOptions.addSubItem(IdFabric$Menu.SCAN_ADDRESS, 0, getResourceManager().getString(C3473R.string.wallet_transaction_details_action_open_etherscan, explorer.getName())).setIcon(explorer.getLogoUrl());
    }
    ...
    public void renderButton(CryptoBoxActionButtonType buttonType) {
        ...
        if (Intrinsics.areEqual(buttonType, CryptoBoxActionButtonType.C1632Ok.INSTANCE)) {
            ...
            if (Intrinsics.areEqual(buttonType, CryptoBoxActionButtonType.Taken.INSTANCE) ? true : Intrinsics.areEqual(buttonType, CryptoBoxActionButtonType.Finished.INSTANCE) ? true : Intrinsics.areEqual(buttonType, CryptoBoxActionButtonType.Stopped.INSTANCE)) {
                num = Integer.valueOf(getResourceManager().getColor(C3473R.C3474color.cell_button_green));
                actionButton.setOverlayColor(num.intValue());
            } else {
                num = null;
            }
    ...
    public final PremiumButtonView initActionButton() {
        return new PremiumButtonView(getContext(), AndroidUtilities.m72dp(4), true);
    }
    ...
    private final void setupViews() {
        ...
        setupViews$lambda$12$lambda$11.setIcon(C3473R.C3475drawable.ic_ab_other);
        ...
        setupViews$lambda$12$lambda$11.addSubItem(IdFabric$Menu.COPY, C3473R.C3475drawable.msg_copy, getResourceManager().getString(C3473R.string.cryptobox_copy_name));
        ...
        setupViews$lambda$12$lambda$11.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
    }
