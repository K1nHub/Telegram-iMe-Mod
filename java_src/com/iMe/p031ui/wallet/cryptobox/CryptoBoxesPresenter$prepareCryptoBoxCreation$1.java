...
import com.iMe.p031ui.wallet.cryptobox.CryptoBoxesPresenter$prepareCryptoBoxCreation$1;
...
public final class CryptoBoxesPresenter$prepareCryptoBoxCreation$1 extends Lambda implements Function1<TLRPC$ChatFull, ObservableSource<? extends Boolean>> {
    ...
    public final ObservableSource<? extends Boolean> invoke(TLRPC$ChatFull chatFull) {
        ...
        final C23131 c23131 = new C23131(this.this$0, this.$chat);
    ...
    /* loaded from: classes4.dex */
    public static final class C23131 extends Lambda implements Function1<TLRPC$User, ObservableSource<? extends Boolean>> {
        final /* synthetic */ TLRPC$Chat $chat;
        final /* synthetic */ CryptoBoxesPresenter this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23131(CryptoBoxesPresenter cryptoBoxesPresenter, TLRPC$Chat tLRPC$Chat) {
            super(1);
            this.this$0 = cryptoBoxesPresenter;
            this.$chat = tLRPC$Chat;
        }
        ...
        public final ObservableSource<? extends Boolean> invoke(TLRPC$User botUser) {
            ...
            final C23141 c23141 = new Function1<Throwable, TLRPC$ChannelParticipant>() { // from class: com.iMe.ui.wallet.cryptobox.CryptoBoxesPresenter.prepareCryptoBoxCreation.1.1.1
                @Override // kotlin.jvm.functions.Function1
            ...
            Observable<TLRPC$ChannelParticipant> onErrorReturn = chatParticipant.onErrorReturn(new Function() { // from class: com.iMe.ui.wallet.cryptobox.CryptoBoxesPresenter$prepareCryptoBoxCreation$1$1$$ExternalSyntheticLambda1
                ...
                public final Object apply(Object obj) {
                    ...
                    invoke$lambda$0 = CryptoBoxesPresenter$prepareCryptoBoxCreation$1.C23131.invoke$lambda$0(Function1.this, obj);
                    return invoke$lambda$0;
                }
            });
            final C23152 c23152 = new Function1<TLRPC$ChannelParticipant, Boolean>() { // from class: com.iMe.ui.wallet.cryptobox.CryptoBoxesPresenter.prepareCryptoBoxCreation.1.1.2
                @Override // kotlin.jvm.functions.Function1
            ...
            return onErrorReturn.map(new Function() { // from class: com.iMe.ui.wallet.cryptobox.CryptoBoxesPresenter$prepareCryptoBoxCreation$1$1$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    ...
                    invoke$lambda$1 = CryptoBoxesPresenter$prepareCryptoBoxCreation$1.C23131.invoke$lambda$1(Function1.this, obj);
                    return invoke$lambda$1;
                }
            });
        }
