...
public final class CryptoBoxSuspensionPresenter extends BasePresenter<CryptoBoxSuspensionView> {
    ...
    public final void onStopClick() {
        Observable<Result<String>> observeOn = this.cryptoBoxInteractor.sendSuspensionExecute(this.transactionAction.getTransaction()).observeOn(this.schedulersProvider.mo716ui());
