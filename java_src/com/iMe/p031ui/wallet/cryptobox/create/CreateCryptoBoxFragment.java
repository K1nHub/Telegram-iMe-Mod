...
public final class CreateCryptoBoxFragment extends WalletAuthBaseFragment implements CreateCryptoBoxView {
    ...
    public static final void setupViews$lambda$36$lambda$33() {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupViews$lambda$36$lambda$34() {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupViews$lambda$36$lambda$35() {
    }
    ...
    @Override // com.iMe.p031ui.wallet.cryptobox.create.CreateCryptoBoxView
    public void renderCryptoBoxInfo(CryptoBoxCreationRulesItem item, boolean z) {
        Intrinsics.checkNotNullParameter(item, "item");
        CryptoboxInfoView renderCryptoBoxInfo$lambda$0 = getBinding().viewCryptoboxInfo;
        Intrinsics.checkNotNullExpressionValue(renderCryptoBoxInfo$lambda$0, "renderCryptoBoxInfo$lambda$0");
        ViewExtKt.visible$default(renderCryptoBoxInfo$lambda$0, false, 1, null);
        renderCryptoBoxInfo$lambda$0.setupViewData(item, z);
    }
    ...
    public void renderSelectedToken(String tokenText, String tokenLogoUrl, int i, String tokenBalanceText) {
        ...
        TextView renderSelectedToken$lambda$4$lambda$3 = binding.textTokenBalance;
        renderSelectedToken$lambda$4$lambda$3.setText(getResourceManager().getString(C3473R.string.wallet_swap_process_my_balance, tokenBalanceText));
        Intrinsics.checkNotNullExpressionValue(renderSelectedToken$lambda$4$lambda$3, "renderSelectedToken$lambda$4$lambda$3");
        ViewExtKt.visible$default(renderSelectedToken$lambda$4$lambda$3, false, 1, null);
    }
    ...
    public void showChooseNetworkDialog(NetworkItem network, List<? extends NetworkItem> availableNetworks) {
        ...
        Callbacks$Callback1<NetworkItem.Crypto> callbacks$Callback1 = new Callbacks$Callback1() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda2
            ...
            public final void invoke(Object obj) {
                CreateCryptoBoxFragment.showChooseNetworkDialog$lambda$6(CreateCryptoBoxFragment.this, (NetworkItem.Crypto) obj);
            }
        };
        Intrinsics.checkNotNullExpressionValue(parentActivity, "parentActivity");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void showChooseNetworkDialog$lambda$6(CreateCryptoBoxFragment this$0, NetworkItem.Crypto crypto) {
    ...
    public void openSelectTokenScreen(String networkId) {
        ...
        presentFragment(WalletSelectTokenFragment.Companion.newInstance(new SelectTokenScreenType.Send(null, 1, null), null, networkId, true, new Callbacks$Callback2() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda5
            ...
            public final void invoke(Object obj, Object obj2) {
                CreateCryptoBoxFragment.openSelectTokenScreen$lambda$7(CreateCryptoBoxFragment.this, (TokenDetailed) obj, (FiatValue) obj2);
            }
        }));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void openSelectTokenScreen$lambda$7(CreateCryptoBoxFragment this$0, TokenDetailed token, FiatValue fiatValue) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public void openSelectChatScreen(Long l) {
        ...
        inviteMembersBottomSheet.setCryptoboxChatSelectionScreen(l, new Callbacks$Callback1() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda3
            @Override // com.iMe.fork.utils.Callbacks$Callback1
            public final void invoke(Object obj) {
                CreateCryptoBoxFragment.openSelectChatScreen$lambda$9$lambda$8(CreateCryptoBoxFragment.this, (Long) obj);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void openSelectChatScreen$lambda$9$lambda$8(CreateCryptoBoxFragment this$0, Long l) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public void renderTransactionActionBlock(TransactionStep transactionStep, FeeType feeType) {
        ...
        TransactionActionButtonsView viewActionButtons = getBinding().viewActionButtons;
        Intrinsics.checkNotNullExpressionValue(viewActionButtons, "viewActionButtons");
        viewActionButtons.setupViewData(transactionStep.getButtonText(getResourceManager()), (r14 & 2) != 0, (r14 & 4) != 0 ? false : false, (r14 & 8) == 0 ? false : false, (r14 & 16) != 0 ? new Callbacks$Callback() { // from class: com.iMe.ui.custom.TransactionActionButtonsView$$ExternalSyntheticLambda1
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                TransactionActionButtonsView.setupViewData$lambda$0();
            }
        } : new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda8
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                CreateCryptoBoxFragment.renderTransactionActionBlock$lambda$12$lambda$10(CreateCryptoBoxFragment.this);
            }
        ...
        FeeView renderTransactionActionBlock$lambda$12$lambda$11 = getBinding().viewFee;
        if (feeType != null) {
            Intrinsics.checkNotNullExpressionValue(renderTransactionActionBlock$lambda$12$lambda$11, "renderTransactionActionBlock$lambda$12$lambda$11");
            ViewExtKt.visible$default(renderTransactionActionBlock$lambda$12$lambda$11, false, 1, null);
            renderTransactionActionBlock$lambda$12$lambda$11.init(this, feeType);
            return;
        }
        Intrinsics.checkNotNullExpressionValue(renderTransactionActionBlock$lambda$12$lambda$11, "renderTransactionActionBlock$lambda$12$lambda$11");
        ViewExtKt.gone$default(renderTransactionActionBlock$lambda$12$lambda$11, false, 1, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void renderTransactionActionBlock$lambda$12$lambda$10(CreateCryptoBoxFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.getPresenter().onActionClick();
    }

    @Override // com.iMe.p031ui.wallet.cryptobox.create.CreateCryptoBoxView
    public void showCryptoBoxInfoDialog(String descriptionText) {
        Intrinsics.checkNotNullParameter(descriptionText, "descriptionText");
        showDialog(DialogsFactoryKt.createInfoBottomSheetDialog$default(this, null, descriptionText, getResourceManager().getString(C3473R.string.common_ok), null, 9, null));
    }
    ...
    public void showCreationSuccess() {
        DialogsFactoryKt.showSuccessAlert(this, getResourceManager().getString(C3473R.string.cryptobox_create_success_title), getResourceManager().getString(C3473R.string.cryptobox_create_success_description), getResourceManager().getString(C3473R.string.common_ok), new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda6
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    public void openAddAdminScreen(long j, TLRPC$Chat chat) {
        Intrinsics.checkNotNullParameter(chat, "chat");
        ChatRightsEditActivity chatRightsEditActivity = new ChatRightsEditActivity(j, chat.f1522id, null, null, null, null, 0, true, true, null);
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.cryptobox_create_title));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$setupActionBar$1$1
    ...
    private final void setupViews() {
        ...
        rLottieImageView.setAnimation(C3473R.raw.fork_new_cryptobox, 100, 100);
        rLottieImageView.playAnimation();
        binding.textHeader.setText(getResourceManager().getString(C3473R.string.cryptobox_create_header));
        binding.textDescription.setText(getResourceManager().getString(C3473R.string.cryptobox_create_description));
        ...
        String string = getResourceManager().getString(C3473R.string.wallet_binance_receive_select_token_hint);
        String string2 = getResourceManager().getString(C3473R.string.wallet_binance_receive_select_token_title);
        int i = C3473R.C3475drawable.fork_ic_select_token_24;
        ...
        inputView.setFieldClickListener(new View.OnClickListener() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                CreateCryptoBoxFragment.setupViews$lambda$36$lambda$19$lambda$18$lambda$17(CreateCryptoBoxFragment.this, view);
            }
        });
        TitledInputFieldView inputAmount = binding.inputAmount;
        Intrinsics.checkNotNullExpressionValue(inputAmount, "inputAmount");
        String string3 = getResourceManager().getString(C3473R.string.cryptobox_create_amount_title);
        String string4 = getResourceManager().getString(C3473R.string.wallet_binance_receive_amount_title);
        int i2 = C3473R.C3475drawable.fork_ic_custom_tokens;
        inputAmount.setTitle(string3);
        LinkActionView inputView2 = inputAmount.getInputView();
        ...
        EditTextBoldCursor setupViews$lambda$36$lambda$23$lambda$22 = inputView2.getEditText();
        setupViews$lambda$36$lambda$23$lambda$22.setInputType(8194);
        Intrinsics.checkNotNullExpressionValue(setupViews$lambda$36$lambda$23$lambda$22, "setupViews$lambda$36$lambda$23$lambda$22");
        ViewExtKt.limitInputLength$default(setupViews$lambda$36$lambda$23$lambda$22, TokenDetailed.Companion.getBNB().getDecimals(), 0, 2, null);
        setupViews$lambda$36$lambda$23$lambda$22.addTextChangedListener(new TextWatcher() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$setupViews$lambda$36$lambda$23$lambda$22$$inlined$doAfterTextChanged$1
        ...
        ViewExtKt.onAction(setupViews$lambda$36$lambda$23$lambda$22, 5, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda10
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                CreateCryptoBoxFragment.setupViews$lambda$36$lambda$23$lambda$22$lambda$21(ForkFragmentCreateCryptoboxBinding.this);
            }
        });
        TitledInputFieldView inputCapacity = binding.inputCapacity;
        Intrinsics.checkNotNullExpressionValue(inputCapacity, "inputCapacity");
        String string5 = getResourceManager().getString(C3473R.string.cryptobox_create_capacity_title);
        String string6 = getResourceManager().getString(C3473R.string.cryptobox_create_capacity_hint);
        int i3 = C3473R.C3475drawable.fork_filter_icon_users;
        inputCapacity.setTitle(string5);
        LinkActionView inputView3 = inputCapacity.getInputView();
        ...
        EditTextBoldCursor setupViews$lambda$36$lambda$26$lambda$25 = inputView3.getEditText();
        setupViews$lambda$36$lambda$26$lambda$25.setInputType(2);
        Intrinsics.checkNotNullExpressionValue(setupViews$lambda$36$lambda$26$lambda$25, "setupViews$lambda$36$lambda$26$lambda$25");
        ViewExtKt.limitInputLength$default(setupViews$lambda$36$lambda$26$lambda$25, 0, 0, 2, null);
        setupViews$lambda$36$lambda$26$lambda$25.addTextChangedListener(new TextWatcher() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$setupViews$lambda$36$lambda$26$lambda$25$$inlined$doAfterTextChanged$1
            @Override // android.text.TextWatcher
        ...
        String string7 = getResourceManager().getString(C3473R.string.cryptobox_create_chat_title);
        String string8 = getResourceManager().getString(C3473R.string.cryptobox_create_chat_hint);
        int i4 = C3473R.C3475drawable.msg_channel;
        ...
        inputView4.setFieldClickListener(new View.OnClickListener() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CreateCryptoBoxFragment.setupViews$lambda$36$lambda$28$lambda$27(CreateCryptoBoxFragment.this, view);
            }
        });
        ...
        String string9 = getResourceManager().getString(C3473R.string.cryptobox_create_description_title);
        String string10 = getResourceManager().getString(C3473R.string.cryptobox_create_description_hint);
        int i5 = C3473R.C3475drawable.msg_edit;
        ...
        EditTextBoldCursor setupViews$lambda$36$lambda$32$lambda$31 = inputView5.getEditText();
        Intrinsics.checkNotNullExpressionValue(setupViews$lambda$36$lambda$32$lambda$31, "setupViews$lambda$36$lambda$32$lambda$31");
        setupViews$lambda$36$lambda$32$lambda$31.addTextChangedListener(new TextWatcher() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$setupViews$lambda$36$lambda$32$lambda$31$$inlined$doAfterTextChanged$1
            @Override // android.text.TextWatcher
        ...
        ViewExtKt.onAction(setupViews$lambda$36$lambda$32$lambda$31, 6, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda9
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                CreateCryptoBoxFragment.setupViews$lambda$36$lambda$32$lambda$31$lambda$30(CreateCryptoBoxFragment.this);
            }
        });
        TransactionActionButtonsView viewActionButtons = binding.viewActionButtons;
        Intrinsics.checkNotNullExpressionValue(viewActionButtons, "viewActionButtons");
        viewActionButtons.setupViewData(getResourceManager().getString(C3473R.string.common_progress_state_title), (r14 & 2) != 0, (r14 & 4) != 0 ? false : false, (r14 & 8) == 0 ? false : false, (r14 & 16) != 0 ? new Callbacks$Callback() { // from class: com.iMe.ui.custom.TransactionActionButtonsView$$ExternalSyntheticLambda1
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                TransactionActionButtonsView.setupViewData$lambda$0();
            }
        } : new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda13
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                CreateCryptoBoxFragment.setupViews$lambda$36$lambda$33();
            }
        }, (r14 & 32) != 0 ? new Callbacks$Callback() { // from class: com.iMe.ui.custom.TransactionActionButtonsView$$ExternalSyntheticLambda2
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
        ...
        } : new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda11
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                CreateCryptoBoxFragment.setupViews$lambda$36$lambda$34();
            }
        ...
        } : new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda12
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                CreateCryptoBoxFragment.setupViews$lambda$36$lambda$35();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupViews$lambda$36$lambda$19$lambda$18$lambda$17(CreateCryptoBoxFragment this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.getPresenter().onSelectTokenClick();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupViews$lambda$36$lambda$23$lambda$22$lambda$21(ForkFragmentCreateCryptoboxBinding this_with) {
        Intrinsics.checkNotNullParameter(this_with, "$this_with");
        this_with.inputCapacity.getInputView().getEditText().requestFocus();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupViews$lambda$36$lambda$28$lambda$27(CreateCryptoBoxFragment this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.getPresenter().onSelectChatClick();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupViews$lambda$36$lambda$32$lambda$31$lambda$30(CreateCryptoBoxFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.getPresenter().onActionClick();
    }
    ...
    private final void setupListeners() {
        ...
        binding.viewCryptoboxInfo.setInfoButtonClickAction(new Callbacks$Callback() { // from class: com.iMe.ui.wallet.cryptobox.create.CreateCryptoBoxFragment$$ExternalSyntheticLambda7
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
                CreateCryptoBoxFragment.setupListeners$lambda$40$lambda$39(CreateCryptoBoxFragment.this);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupListeners$lambda$40$lambda$39(CreateCryptoBoxFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void setupColors() {
        ...
        ViewExtKt.setTextsColor(i, textHeader, textDescription);
