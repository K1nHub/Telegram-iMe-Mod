...
import com.iMe.p031ui.wallet.cryptobox.adapter.diff.CryptoBoxesDiffCallback;
import com.iMe.p031ui.wallet.cryptobox.create.CreateCryptoBoxFragment;
...
public final class CryptoBoxesFragment extends WalletAuthBaseFragment implements CryptoBoxesView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.cryptoboxes_title));
        c3541ActionBar.setAllowOverlayTitle(true);
        Activity parentActivity = getParentActivity();
        Intrinsics.checkNotNullExpressionValue(parentActivity, "parentActivity");
        this.networkTypeView = new NetworkTypeView(parentActivity, null, 0, 6, null);
        ActionBarMenuItem setupActionBar$lambda$4$lambda$3 = c3541ActionBar.createMenu().addItemWithWidth(IdFabric$Menu.NETWORK_SWITCH, 0, -2);
        ...
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.cryptobox.CryptoBoxesFragment$setupActionBar$1$2
    ...
    public static final void setupListeners$lambda$8$lambda$7(CryptoBoxesFragment this$0, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        ...
        int id = view.getId();
        if (id == C3473R.C3476id.button_new_cryptobox) {
            this$0.getPresenter().onCreateCryptoBoxClick();
        } else if (id == C3473R.C3476id.image_order) {
    ...
    private final void setupRecycleView() {
        ...
        globalStateProvider.setCustomElevation(recyclerView.getResources().getDimension(C3473R.dimen.wallet_card_elevation));
