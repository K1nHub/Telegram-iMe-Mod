...
public final class C2380x9b0acc81 extends Lambda implements Function1<Result<? extends List<? extends OutputConvertToken>>, Unit> {
    ...
    public C2380x9b0acc81(WalletSwapProcessPresenter walletSwapProcessPresenter, String str, Callbacks$Callback callbacks$Callback) {
        super(1);
    ...
    public final void m1534invoke(Result<? extends List<? extends OutputConvertToken>> it) {
