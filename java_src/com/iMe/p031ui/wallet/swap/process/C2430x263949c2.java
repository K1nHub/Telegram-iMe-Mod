...
public final class C2430x263949c2 extends Lambda implements Function1<Result<? extends List<? extends BinanceTokenBalanceInfo>>, Unit> {
    final /* synthetic */ TokenDetailed $token$inlined;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2430x263949c2(WalletSwapProcessPresenter walletSwapProcessPresenter, TokenDetailed tokenDetailed) {
        super(1);
    ...
    public final void m1557invoke(Result<? extends List<? extends BinanceTokenBalanceInfo>> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            while (true) {
                ...
                obj = it2.next();
                if (Intrinsics.areEqual(((BinanceTokenBalanceInfo) obj).getAsset(), this.$token$inlined.getTicker())) {
                    break;
                }
            }
