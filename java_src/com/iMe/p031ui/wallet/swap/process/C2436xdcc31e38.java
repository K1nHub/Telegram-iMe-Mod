...
public final class C2436xdcc31e38 extends Lambda implements Function1<Result<? extends CryptoSwapMetadata>, Unit> {
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2436xdcc31e38(WalletSwapProcessPresenter walletSwapProcessPresenter) {
        super(1);
    ...
    public final void m1560invoke(Result<? extends CryptoSwapMetadata> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            this.this$0.selectedSwapFee = new GasPriceItem(TransactionSpeedLevel.MEDIUM, ((CryptoSwapMetadata) success.getData()).getFeeToken(), ((CryptoSwapMetadata) success.getData()).getTransactionParams().getMedium());
