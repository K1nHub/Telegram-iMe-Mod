...
public final class C2381x263949c2 extends Lambda implements Function1<Result<? extends List<? extends BinanceTokenBalanceInfo>>, Unit> {
    final /* synthetic */ SelectableToken $token$inlined;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2381x263949c2(WalletSwapProcessPresenter walletSwapProcessPresenter, SelectableToken selectableToken) {
        super(1);
    ...
    public final void m1535invoke(Result<? extends List<? extends BinanceTokenBalanceInfo>> it) {
