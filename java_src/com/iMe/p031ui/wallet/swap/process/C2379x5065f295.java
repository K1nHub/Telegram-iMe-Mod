...
public final class C2379x5065f295 extends Lambda implements Function1<Result<? extends List<? extends TokenInfo>>, Unit> {
    ...
    public C2379x5065f295(WalletSwapProcessPresenter walletSwapProcessPresenter, NetworkType networkType, Callbacks$Callback callbacks$Callback) {
        super(1);
    ...
    public final void m1534invoke(Result<? extends List<? extends TokenInfo>> it) {
