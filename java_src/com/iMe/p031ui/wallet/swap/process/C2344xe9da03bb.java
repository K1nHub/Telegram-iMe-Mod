...
public final class C2344xe9da03bb extends Lambda implements Function1<Result<? extends TokenBalance>, Unit> {
    final /* synthetic */ TokenCode $token$inlined;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2344xe9da03bb(WalletSwapProcessPresenter walletSwapProcessPresenter, TokenCode tokenCode) {
        super(1);
    ...
    public final void m1517invoke(Result<? extends TokenBalance> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            int i = C3242R.string.wallet_swap_process_my_balance;
            ...
            int i2 = C3242R.string.wallet_swap_process_my_balance;
