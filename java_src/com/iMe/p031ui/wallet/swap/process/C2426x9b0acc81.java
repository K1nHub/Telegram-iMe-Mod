...
public final class C2426x9b0acc81 extends Lambda implements Function1<Result<? extends List<? extends OutputConvertToken>>, Unit> {
    final /* synthetic */ Callbacks$Callback $callback$inlined;
    final /* synthetic */ String $tokenTicker$inlined;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2426x9b0acc81(WalletSwapProcessPresenter walletSwapProcessPresenter, String str, Callbacks$Callback callbacks$Callback) {
        super(1);
        this.this$0 = walletSwapProcessPresenter;
        this.$tokenTicker$inlined = str;
    ...
    public final void m1555invoke(Result<? extends List<? extends OutputConvertToken>> it) {
        ResourceManager resourceManager;
        Intrinsics.checkNotNullExpressionValue(it, "it");
        Result<? extends List<? extends OutputConvertToken>> result = it;
        if (result instanceof Result.Success) {
            this.this$0.binanceAvailableOppositeSelectableSwapTokens = TuplesKt.m85to(this.$tokenTicker$inlined, ((Result.Success) result).getData());
