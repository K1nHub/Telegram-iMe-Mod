...
/* renamed from: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$startSelectTokenDialog$6 */
/* loaded from: classes4.dex */
public final class WalletSwapProcessPresenter$startSelectTokenDialog$6 extends Lambda implements Function1<TokenDetailed, Unit> {
    final /* synthetic */ SwapSide $side;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WalletSwapProcessPresenter$startSelectTokenDialog$6(WalletSwapProcessPresenter walletSwapProcessPresenter, SwapSide swapSide) {
        super(1);
