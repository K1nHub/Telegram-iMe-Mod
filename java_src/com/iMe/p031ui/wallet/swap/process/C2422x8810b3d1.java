...
public final class C2422x8810b3d1 extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2422x8810b3d1(WalletSwapProcessPresenter walletSwapProcessPresenter) {
        super(1);
    ...
    public final void m1553invoke(Result<? extends String> it) {
        Intrinsics.checkNotNullExpressionValue(it, "it");
        Result<? extends String> result = it;
        if (result instanceof Result.Success) {
            this.this$0.renderState(SwapUiState.ApproveInProgress.INSTANCE);
            WalletSwapProcessPresenter.loadApproveTokensInfo$default(this.this$0, true, false, null, 6, null);
