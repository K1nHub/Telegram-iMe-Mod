...
public final class C2352x471dfc16 extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2352x471dfc16(WalletSwapProcessPresenter walletSwapProcessPresenter) {
        super(1);
    ...
    public final void m1521invoke(Result<? extends String> it) {
