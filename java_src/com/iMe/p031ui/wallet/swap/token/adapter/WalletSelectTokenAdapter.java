...
public final class WalletSelectTokenAdapter extends BaseQuickAdapter<SelectableTokenItem, BaseViewHolder> implements LoadMoreModule {
    public WalletSelectTokenAdapter() {
        super(C3419R.layout.fork_recycle_item_wallet_select_token, null, 2, null);
    }
    ...
    protected void convert2(BaseViewHolder holder, SelectableTokenItem item, List<? extends Object> payloads) {
        ...
        int i = C3419R.C3422id.text_token_balance;
        SelectableTokenBalance balance = item.getBalance();
        BaseViewHolder text = holder.setText(i, balance != null ? balance.getTotal() : null).setText(C3419R.C3422id.text_token_title, item.getToken().getName());
        int i2 = C3419R.C3422id.text_token_balance_in_dollars;
        SelectableTokenBalance balance2 = item.getBalance();
        BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setVisibleElseGone(text.setText(i2, balance2 != null ? balance2.getTotalInDollars() : null).setText(C3419R.C3422id.text_coin_ticker, item.getToken().getTicker()), i2, item.isWithBalance()), i, item.isWithBalance());
    }
    ...
    public void convert(BaseViewHolder holder, final SelectableTokenItem item) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        Intrinsics.checkNotNullParameter(item, "item");
        int i = C3419R.C3422id.constraint_root;
        ...
        int i2 = C3419R.C3422id.text_token_title;
        ...
        int i3 = C3419R.C3422id.text_token_balance_in_dollars;
        ...
        int i4 = C3419R.C3422id.text_token_balance;
        ...
        SelectableTokenBalance balance2 = item.getBalance();
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setVisibleElseGone(text.setText(i3, balance2 != null ? balance2.getTotalInDollars() : null).setText(C3419R.C3422id.text_token_ticker, item.getToken().getTicker()), i3, item.isWithBalance()), i4, item.isWithBalance()), C3419R.C3422id.image_token_logo, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.wallet.swap.token.adapter.WalletSelectTokenAdapter$convert$2$1
