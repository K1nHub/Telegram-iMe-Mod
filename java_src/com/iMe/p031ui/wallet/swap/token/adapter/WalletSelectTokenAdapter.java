...
public final class WalletSelectTokenAdapter extends BaseQuickAdapter<SelectableTokenItem, BaseViewHolder> {
    public WalletSelectTokenAdapter() {
        super(C3290R.layout.fork_recycle_item_wallet_select_token, null, 2, null);
    }
    ...
    protected void convert2(BaseViewHolder holder, SelectableTokenItem item, List<? extends Object> payloads) {
        ...
        int i = C3290R.C3293id.text_token_balance;
        SelectableTokenBalance balance = item.getBalance();
        BaseViewHolder text = holder.setText(i, balance != null ? balance.getTotal() : null).setText(C3290R.C3293id.text_token_title, item.getToken().getName());
        int i2 = C3290R.C3293id.text_token_balance_in_dollars;
        SelectableTokenBalance balance2 = item.getBalance();
        BaseQuickAdapterExtKt.applyForView(text.setText(i2, balance2 != null ? balance2.getTotalInDollars() : null).setGone(i2, !item.isWithBalance()).setGone(i, !item.isWithBalance()), C3290R.C3293id.text_token_ticker, new WalletSelectTokenAdapter$convert$1(item));
    }
    ...
    public void convert(BaseViewHolder holder, SelectableTokenItem item) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        Intrinsics.checkNotNullParameter(item, "item");
        int i = C3290R.C3293id.constraint_root;
        ...
        int i2 = C3290R.C3293id.text_token_title;
        ...
        int i3 = C3290R.C3293id.text_token_balance_in_dollars;
        ...
        int i4 = C3290R.C3293id.text_token_balance;
        ...
        SelectableTokenBalance balance2 = item.getBalance();
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setVisibleElseGone(text.setText(i3, balance2 != null ? balance2.getTotalInDollars() : null), i3, item.isWithBalance()), i4, item.isWithBalance()), C3290R.C3293id.text_token_ticker, new WalletSelectTokenAdapter$convert$2(item)), C3290R.C3293id.image_token_logo, new WalletSelectTokenAdapter$convert$3(item));
    }
}
