...
public final class WalletSelectTokenAdapter extends BaseQuickAdapter<SelectableTokenItem, BaseViewHolder> implements LoadMoreModule {
    ...
    public WalletSelectTokenAdapter() {
        super(C3473R.layout.fork_recycle_item_wallet_select_token, null, 2, null);
    }
    ...
    public void convert(BaseViewHolder holder, final SelectableTokenItem item) {
        ...
        int i = C3473R.C3476id.constraint_root;
        ...
        int i2 = C3473R.C3476id.text_token_title;
        ...
        int i3 = C3473R.C3476id.text_token_balance_in_dollars;
        ...
        int i4 = C3473R.C3476id.text_token_balance;
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setVisibleElseGone(text.setText(i3, balance2 != null ? balance2.getTotalInDollars() : null).setText(C3473R.C3476id.text_token_ticker, item.getToken().getTicker()), i3, item.isWithBalance()), i4, item.isWithBalance()), C3473R.C3476id.image_token_logo, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.wallet.swap.token.adapter.WalletSelectTokenAdapter$convert$1$1
    ...
    protected void convert2(BaseViewHolder holder, final SelectableTokenItem item, List<? extends Object> payloads) {
        ...
        int i = C3473R.C3476id.text_token_balance;
        SelectableTokenBalance balance = item.getBalance();
        BaseViewHolder text = holder.setText(i, balance != null ? balance.getTotal() : null).setText(C3473R.C3476id.text_token_title, item.getToken().getName());
        int i2 = C3473R.C3476id.text_token_balance_in_dollars;
        SelectableTokenBalance balance2 = item.getBalance();
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setVisibleElseGone(text.setText(i2, balance2 != null ? balance2.getTotalInDollars() : null).setText(C3473R.C3476id.text_token_ticker, item.getToken().getTicker()), i2, item.isWithBalance()), i, item.isWithBalance()), C3473R.C3476id.image_token_logo, new Function1<AppCompatImageView, Unit>() { // from class: com.iMe.ui.wallet.swap.token.adapter.WalletSelectTokenAdapter$convert$2$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
