...
public final class WalletSwapProtocolsFragment extends WalletTabFragment implements WalletSwapProtocolsView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_navigation_exchange));
        c3541ActionBar.setAllowOverlayTitle(true);
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.swap.WalletSwapProtocolsFragment$setupActionBar$1$1
