...
public final class WalletSwapFeeFragment extends WalletAuthBaseFragment implements WalletSwapFeeView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_swap_transaction_options_toolbar_title));
        c3541ActionBar.setAllowOverlayTitle(true);
        c3541ActionBar.createMenu();
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.swap.fee.WalletSwapFeeFragment$setupActionBar$1$1
    ...
    private final void updateRows() {
        ...
        if (getPresenter().getFeeArgs().getProtocol() != SwapProtocol.ONEINCH_FUSION) {
            ...
            this.slipHeaderRow = -1;
            this.slipChooserRow = -1;
            this.slipInfoRow = -1;
        }
            ...
            try {
                ...
                if (holder.getItemViewType() == IdFabric$ViewTypes.TEXT_INFO_PRIVACY_CELL && (view instanceof TextInfoPrivacyCell)) {
                    if (i == walletSwapFeeFragment.slipInfoRow) {
                        ((TextInfoPrivacyCell) view).setText(walletSwapFeeFragment.getResourceManager().getString(C3473R.string.wallet_swap_transaction_options_slip_description));
                    } else if (i == walletSwapFeeFragment.deadlineInfoRow) {
                        ((TextInfoPrivacyCell) view).setText(walletSwapFeeFragment.getResourceManager().getString(C3473R.string.wallet_swap_transaction_options_deadline_description));
                    } else {
                        ...
                        int i2 = C3473R.string.wallet_amount_send_fee_format;
                    ...
                    ((TextInfoPrivacyCell) view).setBackground(Theme.getThemedDrawable(this.mContext, C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    ...
                    if (i == walletSwapFeeFragment.slipHeaderRow) {
                        ((HeaderCell) view).setText(walletSwapFeeFragment.getResourceManager().getString(C3473R.string.wallet_swap_transaction_options_slip_header));
                    } else if (i == walletSwapFeeFragment.deadlineHeaderRow) {
                        ((HeaderCell) view).setText(walletSwapFeeFragment.getResourceManager().getString(C3473R.string.wallet_swap_transaction_options_deadline_header));
                    } else {
                        ((HeaderCell) view).setText(walletSwapFeeFragment.getResourceManager().getString(C3473R.string.wallet_swap_transaction_options_fee_header));
                    }
