...
public final class C2327x4867fe3b extends Lambda implements Function1<Result<? extends CryptoSwapMetadata>, Unit> {
    final /* synthetic */ WalletSwapFeePresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2327x4867fe3b(WalletSwapFeePresenter walletSwapFeePresenter) {
        super(1);
    ...
    public final void m1500invoke(Result<? extends CryptoSwapMetadata> it) {
