...
public final class WalletSwapFeePresenter extends BasePresenter<WalletSwapFeeView> {
    ...
    private final void subscribeToChangeEvents() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2327x4867fe3b(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2328x4867fe3c(null)));
    ...
    public final String[] initDeadlineTitles() {
        ...
        for (SwapDeadline swapDeadline : deadlineOptions) {
            arrayList.add(this.resourceManager.getString(C3242R.string.wallet_swap_transaction_options_deadline, String.valueOf(swapDeadline.getMinutes())));
        }
        return (String[]) arrayList.toArray(new String[0]);
    }
    ...
    public final String[] initSlipTitles() {
        ...
        for (SwapSlippage swapSlippage : slipOptions) {
            arrayList.add(this.resourceManager.getString(C3242R.string.wallet_swap_transaction_options_slip, StringExtKt.stripZeros$default(String.valueOf(swapSlippage.getPercent()), (char) 0, 1, null)));
        }
        return (String[]) arrayList.toArray(new String[0]);
    }
