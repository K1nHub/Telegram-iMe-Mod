...
public final class WalletHomePresenter extends BasePresenter<WalletHomeView> {
    ...
    private final void listenEvents() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2262x5fff07b7(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2263x5fff07b8(null)));
