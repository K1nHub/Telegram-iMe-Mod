...
public class WalletHomeCryptoView$$State extends MvpViewState<WalletHomeCryptoView> implements WalletHomeCryptoView {
    ...
    @Override // com.iMe.p031ui.wallet.home.tabs.crypto.WalletHomeCryptoView
    public void showSelectTokensOrderTypeDialog(TokenOrderType tokenOrderType, boolean z) {
        ShowSelectTokensOrderTypeDialogCommand showSelectTokensOrderTypeDialogCommand = new ShowSelectTokensOrderTypeDialogCommand(this, tokenOrderType, z);
        this.viewCommands.beforeApply(showSelectTokensOrderTypeDialogCommand);
        if (hasNotView().booleanValue()) {
            return;
        }
        for (View view : this.views) {
            view.showSelectTokensOrderTypeDialog(tokenOrderType, z);
        }
    ...
    public class ShowSelectTokensOrderTypeDialogCommand extends ViewCommand<WalletHomeCryptoView> {
        ...
        ShowSelectTokensOrderTypeDialogCommand(WalletHomeCryptoView$$State walletHomeCryptoView$$State, TokenOrderType tokenOrderType, boolean z) {
