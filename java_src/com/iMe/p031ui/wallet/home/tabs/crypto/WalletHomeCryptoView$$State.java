...
public class WalletHomeCryptoView$$State extends MvpViewState<WalletHomeCryptoView> implements WalletHomeCryptoView {
    ...
    @Override // com.iMe.p031ui.wallet.home.tabs.crypto.WalletHomeCryptoView
    public void showChooseNetworkDialog(Network network, Function1<? super Network, Unit> function1) {
        ShowChooseNetworkDialogCommand showChooseNetworkDialogCommand = new ShowChooseNetworkDialogCommand(this, network, function1);
        this.viewCommands.beforeApply(showChooseNetworkDialogCommand);
        if (hasNotView().booleanValue()) {
            return;
        }
        for (View view : this.views) {
            view.showChooseNetworkDialog(network, function1);
        }
        this.viewCommands.afterApply(showChooseNetworkDialogCommand);
    }

    @Override // com.iMe.p031ui.wallet.home.tabs.crypto.WalletHomeCryptoView
    public void showSelectTokensOrderTypeDialog(TokenOrderType tokenOrderType) {
        ShowSelectTokensOrderTypeDialogCommand showSelectTokensOrderTypeDialogCommand = new ShowSelectTokensOrderTypeDialogCommand(this, tokenOrderType);
        this.viewCommands.beforeApply(showSelectTokensOrderTypeDialogCommand);
        if (hasNotView().booleanValue()) {
            return;
        }
        for (View view : this.views) {
            view.showSelectTokensOrderTypeDialog(tokenOrderType);
        }
    ...
    @Override // com.iMe.p031ui.wallet.home.tabs.crypto.WalletHomeCryptoView
    public void openSendScreen(String str) {
        OpenSendScreenCommand openSendScreenCommand = new OpenSendScreenCommand(this, str);
        this.viewCommands.beforeApply(openSendScreenCommand);
        if (hasNotView().booleanValue()) {
            return;
        }
        for (View view : this.views) {
            view.openSendScreen(str);
        }
    ...
    public class ShowChooseNetworkDialogCommand extends ViewCommand<WalletHomeCryptoView> {
        ...
        ShowChooseNetworkDialogCommand(WalletHomeCryptoView$$State walletHomeCryptoView$$State, Network network, Function1<? super Network, Unit> function1) {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(WalletHomeCryptoView walletHomeCryptoView) {
            walletHomeCryptoView.showChooseNetworkDialog(this.network, this.action);
        }
    }
    ...
    public class ShowSelectTokensOrderTypeDialogCommand extends ViewCommand<WalletHomeCryptoView> {
        ...
        ShowSelectTokensOrderTypeDialogCommand(WalletHomeCryptoView$$State walletHomeCryptoView$$State, TokenOrderType tokenOrderType) {
            super("showSelectTokensOrderTypeDialog", OneExecutionStateStrategy.class);
            this.tokensOrderType = tokenOrderType;
        }

        @Override // moxy.viewstate.ViewCommand
        public void apply(WalletHomeCryptoView walletHomeCryptoView) {
            walletHomeCryptoView.showSelectTokensOrderTypeDialog(this.tokensOrderType);
        }
    }
    ...
    public class OpenSendScreenCommand extends ViewCommand<WalletHomeCryptoView> {
        ...
        OpenSendScreenCommand(WalletHomeCryptoView$$State walletHomeCryptoView$$State, String str) {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(WalletHomeCryptoView walletHomeCryptoView) {
            walletHomeCryptoView.openSendScreen(this.networkId);
        }
    }
