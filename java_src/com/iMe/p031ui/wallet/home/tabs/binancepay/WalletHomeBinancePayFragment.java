...
import com.iMe.p031ui.wallet.home.tabs.binancepay.adapter.diff.BinancePayDiffCallback;
...
public final class WalletHomeBinancePayFragment extends WalletHomeTabFragment implements WalletHomeBinancePayView {
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayListOf = CollectionsKt__CollectionsKt.arrayListOf(new ThemeDescription(getBinding().getRoot(), ThemeDescription.FLAG_BACKGROUND, null, null, null, new ThemeDescription.ThemeDescriptionDelegate() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda9
    ...
    @Override // com.iMe.p031ui.wallet.home.tabs.binancepay.WalletHomeBinancePayView
    ...
    public void showLoginGuideDialog(DialogModel model, final Function0<Unit> action) {
        ...
        Intrinsics.checkNotNullExpressionValue(parentActivity, "parentActivity");
        showDialog(DialogUtils.createDialog$default(parentActivity, model, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda7
    ...
    public void showConfirmLogOutDialog(DialogModel model, final Function0<Unit> action) {
        ...
        Activity parentActivity = getParentActivity();
        Intrinsics.checkNotNullExpressionValue(parentActivity, "parentActivity");
        AlertDialog createDialog$default = DialogUtils.createDialog$default(parentActivity, model, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda6
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    public void openPayScreen() {
        ...
        actionIntroActivity.setQrLoginDelegate(new ActionIntroActivity.ActionIntroQRLoginDelegate() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda10
    ...
    public void openReplenishScreen(String networkId) {
        ...
        presentFragment(ManageLinksActivity.newInstanceForBinanceReplenish(new TransferScreenArgs(null, null, null, null, networkId, 15, null)));
    }
    ...
    public void showRequiredWalletCreatedDialog() {
        showDialog(DialogsFactoryKt.createWalletCreatedRequiredDialog(this, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda5
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    private final void setupListeners() {
        ...
        binancePayRecycleAdapter.getBinanceAccountProvider().setActionBarMenuItemDelegate(new ActionBarMenuItem.ActionBarMenuItemDelegate() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda8
        ...
        binancePayRecycleAdapter.getBannerProvider().setBannerOnItemClickListener(new OnItemClickListener() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda2
            @Override // com.chad.library.adapter.base.listener.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                WalletHomeBinancePayFragment.setupListeners$lambda$14$lambda$10(BinancePayRecycleAdapter.this, this, baseQuickAdapter, view, i);
            }
        });
        binancePayRecycleAdapter.setOnItemClickListener(new OnItemClickListener() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda3
            @Override // com.chad.library.adapter.base.listener.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                WalletHomeBinancePayFragment.setupListeners$lambda$14$lambda$11(BinancePayRecycleAdapter.this, this, baseQuickAdapter, view, i);
            }
        });
        binancePayRecycleAdapter.setOnItemChildClickListener(new OnItemChildClickListener() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda1
            ...
            public final void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                WalletHomeBinancePayFragment.setupListeners$lambda$14$lambda$13(BinancePayRecycleAdapter.this, this, baseQuickAdapter, view, i);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupListeners$lambda$14$lambda$10(BinancePayRecycleAdapter this_with, WalletHomeBinancePayFragment this$0, BaseQuickAdapter baseQuickAdapter, View view, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupListeners$lambda$14$lambda$11(BinancePayRecycleAdapter this_with, WalletHomeBinancePayFragment this$0, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        Intrinsics.checkNotNullParameter(this_with, "$this_with");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(baseQuickAdapter, "<anonymous parameter 0>");
        Intrinsics.checkNotNullParameter(view, "<anonymous parameter 1>");
        ...
        if (baseNode instanceof CardButtonItem) {
            if (((CardButtonItem) baseNode).getId() == C3473R.C3476id.binance_pay_link) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupListeners$lambda$14$lambda$13(BinancePayRecycleAdapter this_with, final WalletHomeBinancePayFragment this$0, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        Intrinsics.checkNotNullParameter(this_with, "$this_with");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(baseQuickAdapter, "<anonymous parameter 0>");
        ...
        BaseNode baseNode = (BaseNode) this_with.getItem(i);
        int id = view.getId();
        if (id == C3473R.C3476id.image_copy) {
        ...
        } else if (id == C3473R.C3476id.image_wallet_crypto_tokens_settings) {
        ...
        } else if (id == C3473R.C3476id.image_wallet_order_tokens) {
            this$0.showDialog(DialogsFactoryKt.createSelectTokensOrderTypeDialog(this$0, this$0.getResourceManager(), this$0.getPresenter().getSelectedTokensOrderType(), false, new Callbacks$Callback1() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.WalletHomeBinancePayFragment$$ExternalSyntheticLambda4
        ...
        } else if (id == C3473R.C3476id.image_wallet_crypto_eye) {
