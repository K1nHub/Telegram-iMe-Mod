...
public final class WalletBinancePayHistoryFragment extends WalletAuthBaseFragment implements WalletBinancePayHistoryView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_binance_pay_action_history));
        c3541ActionBar.setAllowOverlayTitle(true);
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.history.WalletBinancePayHistoryFragment$setupActionBar$1$1
