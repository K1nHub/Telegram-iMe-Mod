...
/* renamed from: com.iMe.ui.wallet.home.tabs.binancepay.receive.WalletReceiveBinancePayPresenter$createCollection$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes4.dex */
public final class C2299xcd7a3035 extends Lambda implements Function1<Result<? extends TLRPC$messages_BotResults>, Unit> {
    final /* synthetic */ BaseFragment $fragment$inlined;
    final /* synthetic */ WalletReceiveBinancePayPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2299xcd7a3035(BaseFragment baseFragment, WalletReceiveBinancePayPresenter walletReceiveBinancePayPresenter) {
        super(1);
    ...
    public final void m1488invoke(Result<? extends TLRPC$messages_BotResults> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            String str = tLRPC$BotInlineResult.f1513id;
            ...
            String string = resourceManager2.getString(C3417R.string.wallet_binance_pay_request_send_success_dialog_title);
            resourceManager3 = this.this$0.resourceManager;
            int i = C3417R.string.wallet_binance_pay_request_send_success_dialog_description;
            ...
            String string3 = resourceManager4.getString(C3417R.string.common_ok);
            final WalletReceiveBinancePayPresenter walletReceiveBinancePayPresenter2 = this.this$0;
            ((WalletReceiveBinancePayView) this.this$0.getViewState()).showCreatedCollectionSuccessDialog(string, string2, string3, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.home.tabs.binancepay.receive.WalletReceiveBinancePayPresenter$createCollection$2$1
