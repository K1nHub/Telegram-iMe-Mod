...
public final class WalletHomeServicesFragment extends WalletHomeTabFragment implements WalletHomeServicesView {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[ServicesCategory.CRYPTOBOXES.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[ServicesCategory.STAKING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[ServicesCategory.ADS.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[ServicesCategory.NEUROBOTS.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[ServicesCategory.PREMIUM.ordinal()] = 6;
    ...
    public static final void setupListeners$lambda$3$lambda$2(WalletHomeServicesFragment this$0, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        ...
        if (baseNode instanceof ServicesBasicItem) {
            switch (WhenMappings.$EnumSwitchMapping$0[((ServicesBasicItem) baseNode).getCategory().ordinal()]) {
                case 1:
                    this$0.presentFragment(CatalogRootFragment.Companion.newInstance());
                    return;
                case 2:
                    this$0.getPresenter().onCryptoBoxesClick();
                    return;
                case 3:
