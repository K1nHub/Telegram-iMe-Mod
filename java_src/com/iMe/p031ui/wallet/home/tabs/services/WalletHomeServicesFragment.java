...
public final class WalletHomeServicesFragment extends WalletHomeTabFragment implements WalletHomeServicesView {
    ...
    /* compiled from: WalletHomeServicesFragment.kt */
    /* renamed from: com.iMe.ui.wallet.home.tabs.services.WalletHomeServicesFragment$WhenMappings */
    /* loaded from: classes4.dex */
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayListOf = CollectionsKt__CollectionsKt.arrayListOf(new ThemeDescription(getBinding().getRoot(), ThemeDescription.FLAG_BACKGROUND, null, null, null, new ThemeDescription.ThemeDescriptionDelegate() { // from class: com.iMe.ui.wallet.home.tabs.services.WalletHomeServicesFragment$$ExternalSyntheticLambda2
    ...
    public void showRequiredWalletCreatedDialog() {
        showDialog(DialogsFactoryKt.createWalletCreatedRequiredDialog(this, BlockchainType.EVM, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.home.tabs.services.WalletHomeServicesFragment$$ExternalSyntheticLambda1
    ...
    private final void setupListeners() {
        getBalancesRecycleAdapter().setOnItemClickListener(new OnItemClickListener() { // from class: com.iMe.ui.wallet.home.tabs.services.WalletHomeServicesFragment$$ExternalSyntheticLambda0
