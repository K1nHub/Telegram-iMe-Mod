...
/* renamed from: com.iMe.ui.wallet.home.tabs.services.WalletHomeServicesFragment$presenter$2 */
...
public final class WalletHomeServicesFragment$presenter$2 extends Lambda implements Function0<WalletHomeServicesPresenter> {
    ...
    public final WalletHomeServicesPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2358x5871c8d8(this.this$0, null, null));
