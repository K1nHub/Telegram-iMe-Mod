...
/* renamed from: com.iMe.ui.wallet.home.attach.WalletAttachAlertPresenter$getWalletTransactions$1 */
...
public final class WalletAttachAlertPresenter$getWalletTransactions$1 extends Lambda implements Function1<Boolean, ObservableSource<? extends Result<? extends List<? extends Transaction>>>> {
    ...
    public WalletAttachAlertPresenter$getWalletTransactions$1(WalletAttachAlertPresenter walletAttachAlertPresenter, TokenDetailed tokenDetailed) {
        super(1);
    ...
    public final ObservableSource<? extends Result<List<Transaction>>> invoke(Boolean it) {
        ...
        List list = (List) hashMap.get(this.$selectedToken.getTicker());
        ...
        return WalletInteractor.getWalletTransactions$default(walletInteractor, false, null, new Token(this.$selectedToken.getAddress(), this.$selectedToken.getNetworkId()), 0, null, 27, null);
    }
}
