...
/* renamed from: com.iMe.ui.wallet.home.attach.WalletAttachAlertPresenter$getWalletTransactions$2 */
...
public final class WalletAttachAlertPresenter$getWalletTransactions$2 extends Lambda implements Function1<Result<? extends List<? extends Transaction>>, Unit> {
    ...
    public WalletAttachAlertPresenter$getWalletTransactions$2(WalletAttachAlertPresenter walletAttachAlertPresenter, TokenDetailed tokenDetailed) {
        super(1);
    ...
    public final void invoke2(Result<? extends List<? extends Transaction>> result) {
        ...
        if (result instanceof Result.Success) {
            ...
            String ticker = this.$selectedToken.getTicker();
