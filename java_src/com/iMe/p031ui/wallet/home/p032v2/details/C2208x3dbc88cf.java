...
public final class C2208x3dbc88cf extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ WalletTokenDetailsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2208x3dbc88cf(WalletTokenDetailsPresenter walletTokenDetailsPresenter) {
        super(1);
