...
public final class C2212xfd1058cc extends Lambda implements Function1<Result<? extends AccountLevelInformation>, Unit> {
    ...
    public C2212xfd1058cc(WalletTokenDetailsPresenter walletTokenDetailsPresenter, Callbacks$Callback1 callbacks$Callback1, boolean z) {
        super(1);
    ...
    public final void m1433invoke(Result<? extends AccountLevelInformation> it) {
