...
public final class C2202x5fff07b7 extends Lambda implements Function1<RxEvent, Unit> {
    final /* synthetic */ WalletHomePresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2202x5fff07b7(WalletHomePresenter walletHomePresenter) {
        super(1);
    ...
    public final void m1425invoke(RxEvent it) {
