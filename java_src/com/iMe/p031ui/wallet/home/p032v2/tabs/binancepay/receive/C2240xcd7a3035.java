...
public final class C2240xcd7a3035 extends Lambda implements Function1<Result<? extends TLRPC$messages_BotResults>, Unit> {
    final /* synthetic */ BaseFragment $fragment$inlined;
    final /* synthetic */ WalletReceiveBinancePayPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2240xcd7a3035(BaseFragment baseFragment, WalletReceiveBinancePayPresenter walletReceiveBinancePayPresenter) {
        super(1);
    ...
    public final void m1452invoke(Result<? extends TLRPC$messages_BotResults> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            String string = resourceManager2.getString(C3242R.string.wallet_binance_pay_request_send_success_dialog_title);
            resourceManager3 = this.this$0.resourceManager;
            int i = C3242R.string.wallet_binance_pay_request_send_success_dialog_description;
            ...
            String string3 = resourceManager4.getString(C3242R.string.common_ok);
