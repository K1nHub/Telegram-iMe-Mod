...
/* renamed from: com.iMe.ui.wallet.home.v2.tabs.crypto.WalletHomeCryptoFragment$openCreateWalletScreen$1 */
...
final class WalletHomeCryptoFragment$openCreateWalletScreen$1 extends Lambda implements Function0<BaseFragment> {
    ...
    public WalletHomeCryptoFragment$openCreateWalletScreen$1(String str, Wallet wallet2) {
        super(0);
        this.$password = str;
        this.$wallet = wallet2;
    }
