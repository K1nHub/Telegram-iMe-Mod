...
public final class C2264x7f5177cb extends Lambda implements Function1<Result<? extends List<? extends BinanceTokenBalanceInfo>>, Unit> {
    final /* synthetic */ WalletHomeBinancePayPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2264x7f5177cb(WalletHomeBinancePayPresenter walletHomeBinancePayPresenter) {
        super(1);
    ...
    public final void m1462invoke(Result<? extends List<? extends BinanceTokenBalanceInfo>> it) {
