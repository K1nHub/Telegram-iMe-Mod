...
@InjectViewState
/* renamed from: com.iMe.ui.wallet.home.v2.tabs.binancepay.WalletHomeBinancePayPresenter */
...
public final class WalletHomeBinancePayPresenter extends BasePresenter<WalletHomeBinancePayView> {
    ...
    /* compiled from: WalletHomeBinancePayPresenter.kt */
    /* renamed from: com.iMe.ui.wallet.home.v2.tabs.binancepay.WalletHomeBinancePayPresenter$WhenMappings */
    /* loaded from: classes3.dex */
    ...
    public final void startBinancePayFlow(AndroidActivityHolder holder, String link) {
        ...
        if (!BinancePayHelper.isProcessBinancePayUrl(link)) {
            ((WalletHomeBinancePayView) getViewState()).showToast(this.resourceManager.getString(C3242R.string.wallet_binance_pay_scan_qr_error));
        } else {
    ...
    public final void getBinanceUserBalances() {
        if (this.binancePayManager.isAuthorized()) {
            ...
            Observable<Result<List<BinanceTokenBalanceInfo>>> doFinally = observeOn.doOnSubscribe(new Consumer() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.WalletHomeBinancePayPresenter$$ExternalSyntheticLambda1
                @Override // io.reactivex.functions.Consumer
                public final void accept(Object obj) {
                    WalletHomeBinancePayPresenter.getBinanceUserBalances$lambda$0(Function1.this, obj);
                }
            }).doFinally(new Action() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.WalletHomeBinancePayPresenter$$ExternalSyntheticLambda0
            ...
            Disposable subscribe = doFinally.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2220x7f5177cb(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2221x7f5177cc((BaseView) getViewState())));
    ...
    public final void loginToBinancePay() {
        this.binanceAPI.authorize(new OAuthParams(AppConfiguration$Binance.INSTANCE.getAUTH_REDIRECT_URL(), "user:pay,user:email,user:address,user:status,asset:ocbs,asset:balance", CryptoExtKt.randomString()), new BinanceListener() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.WalletHomeBinancePayPresenter$loginToBinancePay$1
            ...
            public void onError(int i) {
                ...
                sb.append(resourceManager.getString(C3242R.string.common_error_unexpected));
                sb.append(" (");
                sb.append(i);
                sb.append(')');
    ...
    public final void getAuthTokensByCode(String str) {
        Observable<Result<BinanceAuthTokens>> observeOn = this.binanceInternalInteractor.getAuthTokens(BinancePayAuthType.CODE, str).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "binanceInternalInteracto…(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2218x88e4b599(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2219x88e4b59a((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final void getBinanceUserInfo(boolean z) {
        Observable<Result<BinanceUserInfo>> observeOn = this.binanceInternalInteractor.getUserInfo(z).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "binanceInternalInteracto…(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2222x207b8962(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2223x207b8963((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }

    private final DialogModel getLoginGuideDialogModel() {
        return new DialogModel(this.resourceManager.getString(C3242R.string.wallet_binance_pay_login_title), this.resourceManager.getString(C3242R.string.wallet_binance_pay_login_description), this.resourceManager.getString(C3242R.string.common_cancel), this.resourceManager.getString(C3242R.string.wallet_binance_pay_login_positive_button));
    }
    ...
    private final void renderScreenItems(boolean z, List<BinanceTokenBalanceInfo> list) {
        ...
        spreadBuilder.add(new HeaderItemWithNetworkSwitcher(this.resourceManager.getString(C3242R.string.wallet_binance_pay_account_header), NetworkType.BINANCE_SMART_CHAIN, false));
    ...
    private final BaseNode[] resolveBalancesState(boolean z, List<BinanceTokenBalanceInfo> list) {
        ...
        if (this.binancePayManager.isAuthorized()) {
            ...
            if (i == 1) {
                list2 = CollectionsKt___CollectionsKt.sortedWith(list2, new Comparator() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.WalletHomeBinancePayPresenter$resolveBalancesState$$inlined$sortedBy$1
                ...
                list2 = CollectionsKt___CollectionsKt.sortedWith(list2, new Comparator() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.WalletHomeBinancePayPresenter$resolveBalancesState$$inlined$sortedByDescending$1
                    @Override // java.util.Comparator
                    public final int compare(T t, T t2) {
                        int compareValues;
            ...
            spreadBuilder2.add(new HeaderItem(this.resourceManager.getString(C3242R.string.wallet_binance_pay_balances_header)));
    ...
    private final BaseNode resolveUserState() {
        ...
        return new CardButtonItem(C3242R.C3245id.binance_pay_link, C3242R.C3244drawable.fork_ic_add_account_40, C3242R.string.wallet_binance_pay_login);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final List<HorizontalActionButtonItem> resolveActions() {
        List<HorizontalActionButtonItem> listOf;
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new HorizontalActionButtonItem[]{new HorizontalActionButtonItem(C3242R.C3244drawable.fork_ic_pay_qr_28, this.resourceManager.getString(C3242R.string.wallet_binance_pay_action_pay), false, new WalletHomeBinancePayPresenter$resolveActions$1(this), 4, null), new HorizontalActionButtonItem(C3242R.C3244drawable.fork_ic_buy_28, this.resourceManager.getString(C3242R.string.wallet_token_details_action_buy), false, new WalletHomeBinancePayPresenter$resolveActions$2(this), 4, null), new HorizontalActionButtonItem(C3242R.C3244drawable.fork_ic_exchange_27, this.resourceManager.getString(C3242R.string.wallet_binance_pay_action_convert), false, new WalletHomeBinancePayPresenter$resolveActions$3(this), 4, null), new HorizontalActionButtonItem(C3242R.C3244drawable.fork_ic_transactions_28, this.resourceManager.getString(C3242R.string.wallet_binance_pay_action_history), false, new WalletHomeBinancePayPresenter$resolveActions$4(this), 4, null)});
        return listOf;
    }
    ...
    private final void listenEvents() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2224xc9b19749(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2225xc9b1974a(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final DialogModel getLogOutConfirmDialogModel() {
        ...
        int i = C3242R.string.wallet_binance_logout_confirm_dialog_title;
        return new DialogModel(resourceManager.getString(i), this.resourceManager.getString(C3242R.string.wallet_binance_logout_confirm_dialog_description), this.resourceManager.getString(C3242R.string.common_cancel), this.resourceManager.getString(i));
    }
    ...
    public final void logout() {
        ...
        Observable<Result<Boolean>> observeOn = binanceInternalInteractor.logout(accessToken).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "binanceInternalInteracto…(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2226x9e560893(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2227x9e560894((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
}
