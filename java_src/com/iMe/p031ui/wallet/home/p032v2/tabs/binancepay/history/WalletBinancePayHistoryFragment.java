...
import com.iMe.p031ui.wallet.home.p032v2.tabs.binancepay.history.adapter.diff.BinancePayHistoryDiffCallback;
...
public final class WalletBinancePayHistoryFragment extends WalletAuthFragment implements WalletBinancePayHistoryView {
    ...
    public WalletBinancePayHistoryFragment(ScreenType screenType, String tokenCode) {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2275xc9259482(this, null, null));
    ...
    @Override // com.iMe.p031ui.wallet.home.p032v2.tabs.binancepay.history.WalletBinancePayHistoryView
    ...
    private final void setupActionBar() {
        ...
        c3361ActionBar.setTitle(getResourceManager().getString(C3295R.string.wallet_binance_pay_action_history));
        c3361ActionBar.setAllowOverlayTitle(true);
        c3361ActionBar.setActionBarMenuOnItemClick(new C3361ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.history.WalletBinancePayHistoryFragment$setupActionBar$1$1
    ...
    private final void setupLoadMore(final BinancePayHistoryRecycleAdapter binancePayHistoryRecycleAdapter) {
        ...
        loadMoreModule.setOnLoadMoreListener(new OnLoadMoreListener() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.history.WalletBinancePayHistoryFragment$$ExternalSyntheticLambda2
    ...
    private final void setupListeners() {
        ...
        binding.getRoot().setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.history.WalletBinancePayHistoryFragment$$ExternalSyntheticLambda0
        ...
        getBinancePayHistoryAdapter().setOnItemClickListener(new OnItemClickListener() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.history.WalletBinancePayHistoryFragment$$ExternalSyntheticLambda1
