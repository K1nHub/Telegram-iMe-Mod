...
public final class C2300xe9f7ff8 extends Lambda implements Function1<Result<? extends List<BaseNode>>, Unit> {
    final /* synthetic */ WalletHomeCryptoPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2300xe9f7ff8(WalletHomeCryptoPresenter walletHomeCryptoPresenter) {
        super(1);
    ...
    public final void m1484invoke(Result<? extends List<BaseNode>> it) {
