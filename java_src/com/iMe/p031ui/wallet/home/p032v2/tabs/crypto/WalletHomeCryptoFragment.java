...
public final class WalletHomeCryptoFragment extends WalletHomeTabFragment implements WalletHomeCryptoView {
    ...
    public void openCreateWalletScreen(Wallet wallet2, String password) {
        ...
        if (password.length() > 0) {
            newInstance$default = CreateWalletTutorialFragment.Companion.newInstance(new TutorialType.Backup(new WalletHomeCryptoFragment$openCreateWalletScreen$1(password, wallet2)));
        } else {
