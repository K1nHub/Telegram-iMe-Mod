...
public final class WalletBinancePayHistoryFragment$presenter$2 extends Lambda implements Function0<WalletBinancePayHistoryPresenter> {
    ...
    public static final class C22761 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22761(WalletBinancePayHistoryFragment walletBinancePayHistoryFragment) {
            super(0);
            this.this$0 = walletBinancePayHistoryFragment;
        }
    ...
    public final WalletBinancePayHistoryPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2274xbbe1c0a5(walletBinancePayHistoryFragment, null, new C22761(walletBinancePayHistoryFragment)));
