...
public final class C2260x322e1e4 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ String $address$inlined;
    final /* synthetic */ WalletDonationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2260x322e1e4(WalletDonationsPresenter walletDonationsPresenter, String str) {
        super(1);
