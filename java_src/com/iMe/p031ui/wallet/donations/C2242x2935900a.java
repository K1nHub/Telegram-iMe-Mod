...
public final class C2242x2935900a extends Lambda implements Function1<Result<? extends TokenBalance>, Unit> {
    final /* synthetic */ WalletDonationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2242x2935900a(WalletDonationsPresenter walletDonationsPresenter) {
        super(1);
    ...
    public final void m1442invoke(Result<? extends TokenBalance> it) {
