...
public final class C2248x93b9a39 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ WalletDonationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2248x93b9a39(WalletDonationsPresenter walletDonationsPresenter) {
        super(1);
