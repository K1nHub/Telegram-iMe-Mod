...
public final class C2252x3596b839 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ String $address$inlined;
    final /* synthetic */ WalletDonationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2252x3596b839(WalletDonationsPresenter walletDonationsPresenter, String str) {
        super(1);
    ...
    public final void m1463invoke(Result<? extends Boolean> it) {
        ...
        if (!(result instanceof Result.Success)) {
            ...
            ((WalletDonationsView) this.this$0.getViewState()).showToast(resourceManager2.getString(C3417R.string.channel_donations_incorrect_address_error));
        }
    }
}
