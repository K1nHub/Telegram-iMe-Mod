...
public final class C2256x571632f4 extends Lambda implements Function1<Result<? extends List<? extends Transaction>>, Unit> {
    final /* synthetic */ WalletDonationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2256x571632f4(WalletDonationsPresenter walletDonationsPresenter) {
        super(1);
    ...
    public final void m1465invoke(Result<? extends List<? extends Transaction>> it) {
