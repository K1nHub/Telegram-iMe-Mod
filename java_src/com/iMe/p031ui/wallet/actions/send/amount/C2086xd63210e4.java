...
public final class C2086xd63210e4 extends Lambda implements Function1<Result<? extends TokenBalance>, Unit> {
    final /* synthetic */ TokenCode $code$inlined;
    final /* synthetic */ WalletSendAmountPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2086xd63210e4(WalletSendAmountPresenter walletSendAmountPresenter, TokenCode tokenCode) {
        super(1);
    ...
    public final void m1385invoke(Result<? extends TokenBalance> it) {
