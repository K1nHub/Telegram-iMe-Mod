...
public final class C2097x6b9f8be9 extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ WalletSendAmountPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2097x6b9f8be9(WalletSendAmountPresenter walletSendAmountPresenter) {
        super(1);
    ...
    public final void m1390invoke(Result<? extends String> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (!(((CharSequence) success.getData()).length() > 0)) {
                ...
                ((WalletSendAmountView) this.this$0.getViewState()).showToast(resourceManager.getString(C3295R.string.wallet_recipient_validation_address_error));
                return;
            }
