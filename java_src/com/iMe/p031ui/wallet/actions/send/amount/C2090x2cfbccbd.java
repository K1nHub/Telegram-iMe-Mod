...
public final class C2090x2cfbccbd extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    ...
    public C2090x2cfbccbd(WalletSendAmountPresenter walletSendAmountPresenter, boolean z, TransferArgs transferArgs) {
        super(1);
    ...
    public final void m1387invoke(Result<? extends Boolean> it) {
