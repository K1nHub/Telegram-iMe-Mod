...
public final class C2082xcbcd392d extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ WalletSendAmountPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2082xcbcd392d(WalletSendAmountPresenter walletSendAmountPresenter) {
        super(1);
    ...
    public final void m1383invoke(Result<? extends String> it) {
