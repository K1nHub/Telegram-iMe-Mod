...
public final class C2051x2cfbccbd extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    ...
    public C2051x2cfbccbd(WalletSendAmountPresenter walletSendAmountPresenter, boolean z, TransferArgs transferArgs) {
        super(1);
    ...
    public final void m1368invoke(Result<? extends Boolean> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (this.this$0.getSelectedUser() != null && this.$isNeedSendMessage$inlined) {
                ...
                if (telegramGateway.hasUser(selectedUser.f1567id)) {
