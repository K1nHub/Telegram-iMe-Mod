...
public final class C2105xbc0d2688 extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ WalletSendRecipientPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2105xbc0d2688(WalletSendRecipientPresenter walletSendRecipientPresenter) {
        super(1);
    ...
    public final void m1402invoke(Result<? extends String> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (!(((CharSequence) success.getData()).length() > 0)) {
                ...
                ((WalletSendRecipientView) this.this$0.getViewState()).showToast(resourceManager.getString(C3417R.string.wallet_recipient_validation_address_error));
                return;
            }
