...
public final class StakingFragment extends WalletAuthBaseFragment implements StakingView, NavigationViewConfiguration, TabbedViewPagerDelegate<TabbedFragmentPage<MvpFragment>> {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.staking_title));
        c3541ActionBar.setAllowOverlayTitle(true);
        c3541ActionBar.createMenu().addItem(IdFabric$Menu.STAKING_HELP, C3473R.C3475drawable.msg_help);
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.staking.StakingFragment$setupActionBar$1$1
    ...
    public static final void showInfoDialog$lambda$12(StakingFragment this$0) {
        ...
        Browser.openUrl(this$0.getParentActivity(), this$0.getResourceManager().getString(C3473R.string.staking_info_site_url));
    }
