...
public final class StakingProgrammesFragment$presenter$2 extends Lambda implements Function0<StakingProgrammesPresenter> {
    ...
    public static final class C23951 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23951(StakingProgrammesFragment stakingProgrammesFragment) {
            super(0);
            this.this$0 = stakingProgrammesFragment;
        }
    ...
    public final StakingProgrammesPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2394x7bd24720(stakingProgrammesFragment, null, new C23951(stakingProgrammesFragment)));
