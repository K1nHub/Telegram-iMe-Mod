...
public final class C2308x98688320 extends Lambda implements Function1<Result<? extends AccountLevel>, Unit> {
    ...
    public C2308x98688320(StakingProgrammesPresenter stakingProgrammesPresenter, StakingDetailsItem stakingDetailsItem) {
        super(1);
    ...
    public final void m1487invoke(Result<? extends AccountLevel> it) {
