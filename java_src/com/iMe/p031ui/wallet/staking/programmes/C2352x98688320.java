...
public final class C2352x98688320 extends Lambda implements Function1<Result<? extends AccountLevel>, Unit> {
    ...
    public C2352x98688320(StakingProgrammesPresenter stakingProgrammesPresenter, StakingDetailsItem stakingDetailsItem) {
        super(1);
    ...
    public final void m1508invoke(Result<? extends AccountLevel> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            ((StakingProgrammesView) this.this$0.getViewState()).showErrorToast((Result.Error) result, resourceManager);
        }
    }
}
