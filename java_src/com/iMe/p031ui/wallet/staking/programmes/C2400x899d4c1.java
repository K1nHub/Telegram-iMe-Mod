...
public final class C2400x899d4c1 extends Lambda implements Function1<Result<? extends StakingProgrammes>, Unit> {
    ...
    public C2400x899d4c1(boolean z, StakingProgrammesPresenter stakingProgrammesPresenter, boolean z2, boolean z3) {
        super(1);
    ...
    public final void m1532invoke(Result<? extends StakingProgrammes> it) {
