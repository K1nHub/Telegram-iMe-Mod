...
public final class C2345xee2d436d extends Lambda implements Function1<DomainRxEvents.StakingProgrammesRefresh, Unit> {
    final /* synthetic */ StakingProgrammesPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2345xee2d436d(StakingProgrammesPresenter stakingProgrammesPresenter) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents.StakingProgrammesRefresh stakingProgrammesRefresh) {
        m1505invoke(stakingProgrammesRefresh);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1505invoke(DomainRxEvents.StakingProgrammesRefresh it) {
