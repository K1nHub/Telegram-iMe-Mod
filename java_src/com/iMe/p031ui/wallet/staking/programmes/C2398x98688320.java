...
public final class C2398x98688320 extends Lambda implements Function1<Result<? extends AccountLevel>, Unit> {
    ...
    public C2398x98688320(StakingProgrammesPresenter stakingProgrammesPresenter, StakingDetailsItem stakingDetailsItem) {
        super(1);
    ...
    public final void m1531invoke(Result<? extends AccountLevel> it) {
