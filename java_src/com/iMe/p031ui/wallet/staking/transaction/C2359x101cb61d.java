...
public final class C2359x101cb61d extends Lambda implements Function1<Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>, Unit> {
    final /* synthetic */ StakingTransactionPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2359x101cb61d(StakingTransactionPresenter stakingTransactionPresenter) {
        super(1);
    ...
    public final void m1515invoke(Result<? extends Pair<? extends String, ? extends StakingTransactionAction>> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (status == FirebaseFunctionsErrorHandler.ErrorStatus.NO_ENOUGH_MONEY) {
                ...
                ((StakingTransactionView) this.this$0.getViewState()).showToast(resourceManager6.getString(C3290R.string.staking_replenishment_already_finished));
                ...
                String string = resourceManager4.getString(C3290R.string.staking_profit_error_title);
                resourceManager5 = this.this$0.resourceManager;
                ((StakingTransactionView) this.this$0.getViewState()).showActionError(string, resourceManager5.getString(C3290R.string.staking_profit_overlap_error_description));
                ...
                String string2 = resourceManager2.getString(C3290R.string.staking_withdraw_error_title);
                resourceManager3 = this.this$0.resourceManager;
                ((StakingTransactionView) this.this$0.getViewState()).showActionError(string2, resourceManager3.getString(C3290R.string.staking_withdraw_over_limit_error_description));
            } else {
