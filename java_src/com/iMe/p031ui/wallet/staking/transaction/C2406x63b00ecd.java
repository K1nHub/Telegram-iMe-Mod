...
public final class C2406x63b00ecd extends Lambda implements Function1<Result<? extends StakingOperation>, Unit> {
    final /* synthetic */ StakingTransactionPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2406x63b00ecd(StakingTransactionPresenter stakingTransactionPresenter) {
        super(1);
    ...
    public final void m1538invoke(Result<? extends StakingOperation> it) {
