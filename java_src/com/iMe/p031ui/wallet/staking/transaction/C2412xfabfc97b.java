...
public final class C2412xfabfc97b extends Lambda implements Function1<Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>, Unit> {
    ...
    public C2412xfabfc97b(StakingTransactionPresenter stakingTransactionPresenter, StakingApprovalTokenType stakingApprovalTokenType, StakingDetailsItem stakingDetailsItem) {
        super(1);
    ...
    public final void m1541invoke(Result<? extends Pair<? extends String, ? extends StakingTransactionAction>> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (stakingTransactionAction != null) {
                ...
                StakingTransactionStep.ApprovalNeeded approvalNeeded = this.$tokenType$inlined == StakingApprovalTokenType.STAKING ? new StakingTransactionStep.ApprovalNeeded(this.$data$inlined.getTokenItem().getTicker()) : new StakingTransactionStep.ApprovalNeeded(this.$data$inlined.getFeeTokenItem().getTicker());
