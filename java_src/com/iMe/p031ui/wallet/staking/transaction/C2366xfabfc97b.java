...
public final class C2366xfabfc97b extends Lambda implements Function1<Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>, Unit> {
    ...
    public C2366xfabfc97b(StakingTransactionPresenter stakingTransactionPresenter, StakingApprovalTokenType stakingApprovalTokenType, StakingDetailsItem stakingDetailsItem) {
        super(1);
    ...
    public final void m1518invoke(Result<? extends Pair<? extends String, ? extends StakingTransactionAction>> it) {
