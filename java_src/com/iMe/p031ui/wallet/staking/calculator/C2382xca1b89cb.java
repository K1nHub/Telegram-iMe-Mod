...
public final class C2382xca1b89cb extends Lambda implements Function1<Result<? extends AccountLevel>, Unit> {
    ...
    public C2382xca1b89cb(StakingCalculatorPresenter stakingCalculatorPresenter, StakingDetailsItem stakingDetailsItem) {
        super(1);
    ...
    public final void m1524invoke(Result<? extends AccountLevel> it) {
