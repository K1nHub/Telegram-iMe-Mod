...
public final class C2296x773d9f9f extends Lambda implements Function1<Result<? extends StakingProgrammes>, Unit> {
    ...
    public C2296x773d9f9f(StakingCalculatorProgrammesPresenter stakingCalculatorProgrammesPresenter, boolean z, boolean z2) {
        super(1);
    ...
    public final void m1483invoke(Result<? extends StakingProgrammes> it) {
        List list;
        List list2;
        List<BaseNode> list3;
