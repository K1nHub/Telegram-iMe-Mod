...
public final class C2292xca1b89cb extends Lambda implements Function1<Result<? extends AccountLevel>, Unit> {
    ...
    public C2292xca1b89cb(StakingCalculatorPresenter stakingCalculatorPresenter, StakingDetailsItem stakingDetailsItem) {
        super(1);
    ...
    public final void m1481invoke(Result<? extends AccountLevel> it) {
