...
public final class C2288xf624d8f6 extends Lambda implements Function1<DomainRxEvents.StakingTabRefreshStateChanged, Unit> {
    final /* synthetic */ StakingPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2288xf624d8f6(StakingPresenter stakingPresenter) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents.StakingTabRefreshStateChanged stakingTabRefreshStateChanged) {
        m1477invoke(stakingTabRefreshStateChanged);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1477invoke(DomainRxEvents.StakingTabRefreshStateChanged it) {
