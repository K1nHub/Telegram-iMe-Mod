...
public final class WalletAppearanceSettingsFragment extends WalletAuthBaseFragment implements WalletAppearanceSettingsView {
    ...
    private final void setupActionBar() {
        ...
        c3485ActionBar.setTitle(getResourceManager().getString(C3419R.string.wallet_settings_interface));
        c3485ActionBar.setActionBarMenuOnItemClick(new C3485ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.settings.appearance.WalletAppearanceSettingsFragment$setupActionBar$1$1
