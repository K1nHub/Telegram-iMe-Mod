...
import com.iMe.p031ui.wallet.settings.appearance.networks.WalletNetworksSettingsFragment;
...
public final class WalletAppearanceSettingsFragment extends WalletAuthBaseFragment implements WalletAppearanceSettingsView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_settings_interface));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.settings.appearance.WalletAppearanceSettingsFragment$setupActionBar$1$1
