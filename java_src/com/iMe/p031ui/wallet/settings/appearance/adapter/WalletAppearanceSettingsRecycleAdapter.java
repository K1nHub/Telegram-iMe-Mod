...
public final class WalletAppearanceSettingsRecycleAdapter extends BaseQuickAdapter<InterfaceSettingItem, BaseViewHolder> {
    ...
    public WalletAppearanceSettingsRecycleAdapter(ResourceManager resourceManager) {
        super(C3290R.layout.fork_recycle_item_wallet_appearance_settings, null, 2, null);
    ...
    public void convert(BaseViewHolder holder, InterfaceSettingItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setThemedImageColor(themedTextColor2, i4, Theme.key_windowBackgroundWhiteGrayIcon).setImageResource(i4, item.getIcon()), C3290R.C3293id.view_divider, !RecycleViewExtKt.isLastItem(holder, this)).setText(i3, this.resourceManager.getString(item.getTitle())).setText(i2, this.resourceManager.getString(item.getDescription())), C3290R.C3293id.view_switch, new WalletAppearanceSettingsRecycleAdapter$convert$1(item));
    }
    ...
    public void setOnItemClick(View v, int i) {
        ...
        Switch r0 = (Switch) v.findViewById(C3290R.C3293id.view_switch);
