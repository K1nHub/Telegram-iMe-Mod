...
public final class WalletAppearanceSettingsRecycleAdapter extends BaseQuickAdapter<InterfaceSettingItem, BaseViewHolder> {
    ...
    public WalletAppearanceSettingsRecycleAdapter(ResourceManager resourceManager) {
        super(C3417R.layout.fork_recycle_item_wallet_appearance_settings, null, 2, null);
    ...
    public void convert(BaseViewHolder holder, InterfaceSettingItem item) {
        ...
        int i2 = C3417R.C3420id.text_setting_description;
        ...
        int i3 = C3417R.C3420id.text_setting_title;
        ...
        int i4 = C3417R.C3420id.image_icon;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setThemedImageColor(themedTextColor2, i4, Theme.key_windowBackgroundWhiteGrayIcon).setImageResource(i4, item.getIcon()), C3417R.C3420id.view_divider, !RecycleViewExtKt.isLastItem(holder, this)).setText(i3, this.resourceManager.getString(item.getTitle())).setText(i2, this.resourceManager.getString(item.getDescription())), C3417R.C3420id.view_switch, new WalletAppearanceSettingsRecycleAdapter$convert$1(item));
    }
    ...
    public void setOnItemClick(View v, int i) {
        ...
        Switch r0 = (Switch) v.findViewById(C3417R.C3420id.view_switch);
