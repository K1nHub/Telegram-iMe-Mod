...
import com.iMe.p031ui.wallet.settings.appearance.networks.adapter.diff.NetworksSettingsDiffCallback;
...
public final class WalletNetworksSettingsFragment extends WalletAuthBaseFragment implements WalletNetworksSettingsView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.networks_settings_title));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.settings.appearance.networks.WalletNetworksSettingsFragment$setupActionBar$1$1
        ...
        actionBarMenuItemSearchListener.setSearchFieldHint(getResourceManager().getString(C3473R.string.wallet_network_type_dialog_search_hint));
