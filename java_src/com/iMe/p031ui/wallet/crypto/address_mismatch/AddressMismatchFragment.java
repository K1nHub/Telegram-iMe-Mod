...
public final class AddressMismatchFragment extends WalletAuthBaseFragment implements AddressMismatchView {
    ...
    private final void setupTexts() {
        ...
        binding.textTitle.setText(getResourceManager().getString(C3473R.string.wallet_eth_address_mismatch_title));
        binding.buttonDelete.setText(getResourceManager().getString(C3473R.string.wallet_eth_address_mismatch_btn_delete));
        binding.buttonBackup.setText(getResourceManager().getString(C3473R.string.wallet_eth_address_mismatch_btn_backup));
        AppCompatTextView appCompatTextView = binding.textDescription;
        appCompatTextView.setText(getResourceManager().getString(C3473R.string.wallet_eth_address_mismatch_description));
    ...
    private final void setupImage() {
        ...
        rLottieImageView.setAnimation(C3473R.raw.fork_address_mismatch, ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION);
