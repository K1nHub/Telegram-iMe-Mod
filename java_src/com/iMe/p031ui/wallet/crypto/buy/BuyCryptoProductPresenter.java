...
public final class BuyCryptoProductPresenter extends BasePresenter<BuyCryptoProductView> {
    ...
    public final void loadAvailableProducts() {
        Observable observeOn = SimplexInteractor.getAllAvailablePurchasesQuotes$default(this.simplexInteractor, null, DigitalCurrency.Companion.map(getTokenCode()), this.cryptoPreferenceHelper.getNetworkType(), 1, null).observeOn(this.schedulersProvider.mo698ui());
    ...
    public final void purchase(float f, Currency currency) {
        ...
        Observable observeOn = SimplexInteractor.purchase$default(this.simplexInteractor, null, DigitalCurrency.Companion.map(getTokenCode()), f, currency, this.cryptoPreferenceHelper.getNetworkType(), 1, null).observeOn(this.schedulersProvider.mo698ui());
    ...
    public final void purchase(CryptoBuyItem item) {
        ...
        if (quote != null) {
            Observable observeOn = SimplexInteractor.purchase$default(this.simplexInteractor, null, DigitalCurrency.Companion.map(getTokenCode()), quote.getCryptoMoneyAmount(), (int) quote.getFiatMoneyAmount(), quote.getQuoteId(), this.cryptoPreferenceHelper.getNetworkType(), 1, null).observeOn(this.schedulersProvider.mo698ui());
            Intrinsics.checkNotNullExpressionValue(observeOn, "simplexInteractor\n      …(schedulersProvider.ui())");
            T viewState = getViewState();
            Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
