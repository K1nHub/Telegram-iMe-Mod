...
public final class C2125xb529d506 extends Lambda implements Function1<Result<? extends List<BuyingCryptoQuote>>, Unit> {
    final /* synthetic */ BuyCryptoProductPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2125xb529d506(BuyCryptoProductPresenter buyCryptoProductPresenter) {
        super(1);
    ...
    public final void m1402invoke(Result<? extends List<BuyingCryptoQuote>> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            sortedWith = CollectionsKt___CollectionsKt.sortedWith(CryptoQuotesToCryptoBuyItemUiMappingKt.mapToUI((List) ((Result.Success) result).getData(), tokenInfo), new Comparator() { // from class: com.iMe.ui.wallet.crypto.buy.BuyCryptoProductPresenter$loadAvailableProducts$lambda$3$$inlined$sortedBy$1
