...
public class TokenManagementView$$State extends MvpViewState<TokenManagementView> implements TokenManagementView {
    ...
    public class SetupNetworkCommand extends ViewCommand<TokenManagementView> {
        ...
        SetupNetworkCommand(TokenManagementView$$State tokenManagementView$$State, Network network) {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(TokenManagementView tokenManagementView) {
            tokenManagementView.setupNetwork(this.network);
        }
    }
    ...
    public class ShowChooseNetworkDialogCommand extends ViewCommand<TokenManagementView> {
        ...
        ShowChooseNetworkDialogCommand(TokenManagementView$$State tokenManagementView$$State, Network network, List<Network> list, Function1<? super Network, Unit> function1) {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(TokenManagementView tokenManagementView) {
            tokenManagementView.showChooseNetworkDialog(this.network, this.availableNetworks, this.action);
        }
    }
}
