...
public final class TokenManagementPresenter extends BasePresenter<TokenManagementView> {
    ...
    public TokenManagementPresenter(TokenManagementFragment.ScreenType screenType, CryptoPreferenceHelper cryptoPreferenceHelper, CryptoWalletInteractor cryptoWalletInteractor, ResourceManager resourceManager, RxEventBus rxEventBus, SchedulersProvider schedulersProvider, WalletInteractor walletInteractor) {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<String>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$validationErrorText$2
            ...
            public final String invoke() {
                ...
                return resourceManager2.getString(C3473R.string.wallet_tokens_management_token_address_invalid);
            }
        });
    ...
    public final void onAddressScanned(final String text) {
        ...
        Observable<Result<Boolean>> observeOn = this.cryptoWalletInteractor.isValidAddress(text, NetworksHelper.getNetworkById(this.selectedNetworkItem.getNetworkId()).getBlockchainType()).observeOn(this.schedulersProvider.mo716ui());
        ...
        Disposable subscribe = withLoadingDialog.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$onAddressScanned$$inlined$subscribeWithErrorHandle$default$1
            ...
            public final void m1467invoke(Result<? extends Boolean> it) {
    ...
    public final void enableToken() {
        ...
        Disposable subscribe = withLoadingDialog.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$enableToken$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1465invoke(Result<? extends Boolean> it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
                Result<? extends Boolean> result = it;
                if (result instanceof Result.Success) {
                    TokenManagementPresenter.this.onTokenStatusChanged(C3473R.string.wallet_tokens_management_add_success);
    ...
    public final void deleteToken() {
        ...
        Disposable subscribe = withLoadingDialog.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$deleteToken$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1464invoke(Result<? extends Boolean> it) {
                ResourceManager resourceManager;
                Intrinsics.checkNotNullExpressionValue(it, "it");
                Result<? extends Boolean> result = it;
                if (result instanceof Result.Success) {
                    TokenManagementPresenter.this.onTokenStatusChanged(C3473R.string.wallet_tokens_management_delete_success);
                } else if (result instanceof Result.Error) {
                    resourceManager = TokenManagementPresenter.this.resourceManager;
                    ((TokenManagementView) TokenManagementPresenter.this.getViewState()).showErrorToast((Result.Error) result, resourceManager);
                }
    ...
    private final void loadTokenInfo() {
        ...
        Observable<Result<Boolean>> observeOn = this.cryptoWalletInteractor.isValidAddress(this.address, NetworksHelper.getNetworkById(this.selectedNetworkItem.getNetworkId()).getBlockchainType()).observeOn(this.schedulersProvider.mo717io());
        ...
        Observable flatMap = map.flatMap(new C2251x8acd2b70(new Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>>>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$loadTokenInfo$$inlined$flatMapSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final ObservableSource<? extends Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>> invoke(Result<? extends Boolean> result) {
                ...
                ObservableSource flatMap2 = tokenInfo.flatMap(new C2251x8acd2b70(new Function1<Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>, ObservableSource<? extends Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>>>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$loadTokenInfo$lambda$7$$inlined$flatMapSuccess$1
                    {
                        super(1);
                    }
                    ...
                    public final ObservableSource<? extends Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>> invoke(final Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>> result2) {
                        ...
                        ObservableSource map2 = tokenListsData.map(new C2251x8acd2b70(new Function1<Result<? extends TokenListsData>, Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$loadTokenInfo$lambda$7$lambda$6$$inlined$mapSuccess$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
        ...
        Disposable subscribe = observeOn2.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>>, Unit>() { // from class: com.iMe.ui.wallet.crypto.token.TokenManagementPresenter$loadTokenInfo$$inlined$subscribeWithErrorHandle$default$1
            ...
            /* renamed from: invoke  reason: collision with other method in class */
            public final void m1466invoke(Result<? extends Pair<? extends TokenDetailed, ? extends Boolean>> it) {
                ResourceManager resourceManager;
                boolean z2;
                Intrinsics.checkNotNullExpressionValue(it, "it");
    ...
    private final void showEnableConfirmationDialog() {
        ((TokenManagementView) getViewState()).showEnableConfirmationDialog(new DialogModel(this.resourceManager.getString(C3473R.string.wallet_tokens_management_enable_title), this.resourceManager.getString(C3473R.string.wallet_tokens_management_enable_description), this.resourceManager.getString(C3473R.string.common_cancel), this.resourceManager.getString(C3473R.string.emoji_premium_title_on_alert)));
    }

    private final void showImportConfirmationDialog() {
        ((TokenManagementView) getViewState()).showEnableConfirmationDialog(new DialogModel(this.resourceManager.getString(C3473R.string.wallet_tokens_management_import_confirmation_title), this.resourceManager.getString(C3473R.string.wallet_tokens_management_import_confirmation_description), this.resourceManager.getString(C3473R.string.common_cancel), this.resourceManager.getString(C3473R.string.wallet_tokens_management_import_confirmation_import)));
    }

    private final void showDeleteConfirmationDialog() {
        ((TokenManagementView) getViewState()).showDeleteConfirmationDialog(new DialogModel(this.resourceManager.getString(C3473R.string.wallet_tokens_management_delete_title), this.resourceManager.getString(C3473R.string.wallet_tokens_management_delete_description), this.resourceManager.getString(C3473R.string.common_cancel), this.resourceManager.getString(C3473R.string.favorite_folder_delete)));
    }
}
