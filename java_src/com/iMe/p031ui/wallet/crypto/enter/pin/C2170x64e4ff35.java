...
public final class C2170x64e4ff35 extends Lambda implements Function1<DomainRxEvents.CryptoEvent, Unit> {
    final /* synthetic */ EnterWalletPinFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2170x64e4ff35(EnterWalletPinFragment enterWalletPinFragment) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents.CryptoEvent cryptoEvent) {
        m1419invoke(cryptoEvent);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1419invoke(DomainRxEvents.CryptoEvent it) {
