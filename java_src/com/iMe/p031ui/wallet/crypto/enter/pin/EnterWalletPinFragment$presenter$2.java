...
public final class EnterWalletPinFragment$presenter$2 extends Lambda implements Function0<EnterWalletPinPresenter> {
    ...
    public static final class C21281 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21281(EnterWalletPinFragment enterWalletPinFragment) {
            super(0);
            this.this$0 = enterWalletPinFragment;
        }
    ...
    public final EnterWalletPinPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2125x2e9da3aa(enterWalletPinFragment, null, new C21281(enterWalletPinFragment)));
