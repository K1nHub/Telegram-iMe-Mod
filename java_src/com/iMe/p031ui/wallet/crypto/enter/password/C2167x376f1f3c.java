...
public final class C2167x376f1f3c extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ String $password$inlined;
    final /* synthetic */ EnterWalletPasswordPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2167x376f1f3c(EnterWalletPasswordPresenter enterWalletPasswordPresenter, String str) {
        super(1);
    ...
    public final void m1418invoke(Result<? extends Boolean> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            enterWalletPasswordView.showToast(resourceManager2.getString(C3295R.string.wallet_enter_eth_password_validation_error));
