...
public final class C2157x3099948a extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ EnterWalletPasswordPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2157x3099948a(EnterWalletPasswordPresenter enterWalletPasswordPresenter) {
        super(1);
    ...
    public final void m1427invoke(Result<? extends Boolean> it) {
