...
public final class C2179x42676ad extends Lambda implements Function1<Result<? extends T>, Unit> {
    final /* synthetic */ BlockchainsManagementPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2179x42676ad(BlockchainsManagementPresenter blockchainsManagementPresenter) {
        super(1);
