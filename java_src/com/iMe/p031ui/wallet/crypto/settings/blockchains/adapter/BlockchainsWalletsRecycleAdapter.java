...
public final class BlockchainsWalletsRecycleAdapter extends BaseQuickAdapter<BlockchainWalletItem, BaseViewHolder> {
    ...
    public BlockchainsWalletsRecycleAdapter(ResourceManager resourceManager) {
        super(C3295R.layout.fork_recycle_item_blockchain_wallet, null, 2, null);
    ...
    public void convert(BaseViewHolder holder, BlockchainWalletItem item) {
        ...
        int i3 = C3295R.C3298id.text_address;
        BaseViewHolder imageResource = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i3, i2), i).setText(i, this.resourceManager.getString(item.getBlockchainType().getTitleResId())).setText(i3, item.getAddress()).setImageResource(C3295R.C3298id.image_icon, item.getBlockchainType().getIconResId());
        int i4 = C3295R.C3298id.image_info;
        BaseQuickAdapterExtKt.setThemedBackgroundColor(BaseQuickAdapterExtKt.setCircleRippleBackground(BaseQuickAdapterExtKt.setThemedImageColor(imageResource, i4, Theme.key_actionBarActionModeDefaultIcon), i4), C3295R.C3298id.view_divider, Theme.key_divider);
    }
}
