...
public final class BlockchainsWalletsRecycleAdapter extends BaseQuickAdapter<BlockchainWalletItem, BaseViewHolder> {
    ...
    public BlockchainsWalletsRecycleAdapter(ResourceManager resourceManager) {
        super(C3473R.layout.fork_recycle_item_blockchain_wallet, null, 2, null);
    ...
    public void convert(BaseViewHolder holder, BlockchainWalletItem item) {
        ...
        BaseViewHolder rippleForeground = BaseQuickAdapterExtKt.setRippleForeground(holder, C3473R.C3476id.constraint_root, false);
        int i = Theme.key_windowBackgroundWhiteBlackText;
        int i2 = C3473R.C3476id.text_name;
        int i3 = C3473R.C3476id.text_address;
        BaseViewHolder imageResource = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(rippleForeground, i, i2, i3), i2).setText(i2, this.resourceManager.getString(item.getBlockchainType().getTitleResId())).setText(i3, item.getAddress()).setImageResource(C3473R.C3476id.image_icon, item.getBlockchainType().getIconResId());
        int i4 = C3473R.C3476id.image_info;
        BaseQuickAdapterExtKt.setThemedBackgroundColor(BaseQuickAdapterExtKt.setCircleRippleBackground(BaseQuickAdapterExtKt.setThemedImageColor(imageResource, i4, Theme.key_actionBarActionModeDefaultIcon), i4), C3473R.C3476id.view_divider, Theme.key_divider);
    }
}
