...
public final class BlockchainsManagementFragment extends WalletAuthBaseFragment implements BlockchainsManagementView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_crypto_blockchains_title));
        c3541ActionBar.setAllowOverlayTitle(true);
        c3541ActionBar.createMenu();
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.settings.blockchains.BlockchainsManagementFragment$setupActionBar$1$1
    ...
    public static final void setupListeners$lambda$8$lambda$7$lambda$6(BlockchainsManagementFragment this$0, BlockchainsWalletsRecycleAdapter this_with, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        ...
        if (view.getId() == C3473R.C3476id.image_info) {
    ...
    private final void setupViews() {
        ...
        rLottieImageView.setAnimation(C3473R.raw.fork_multi_networking, 300, 170);
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.playAnimation();
        binding.textWalletsTitle.setText(getResourceManager().getString(C3473R.string.wallet_crypto_blockchains_active_wallets));
        binding.textDescription.setText(getResourceManager().getString(C3473R.string.wallet_crypto_blockchains_description));
        binding.buttonResetAll.setTextAndIcon(getResourceManager().getString(C3473R.string.wallet_reset_all_title), C3473R.C3475drawable.msg_block2, false);
    }
