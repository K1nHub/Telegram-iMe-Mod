...
public final class BlockchainWalletDetailsBottomSheetDialog extends MvpBottomSheet implements BlockchainWalletDetailsView {
    ...
    */
    ...
    public void setupScreenWithData(int i, String title, String subtitle, String createdDate, String address) {
        ...
        binding.viewConnectedCell.setupViewData(getResourceManager().getString(C3242R.string.wallet_details_created), createdDate, C3242R.C3244drawable.msg_calendar2, true);
    ...
    private final void setupActionItem() {
        ...
        setupActionItem$lambda$4.setIcon(C3242R.C3244drawable.ic_ab_other);
        ...
        setupActionItem$lambda$4.addSubItem(IdFabric$Menu.INFO, C3242R.C3244drawable.msg_info, getResourceManager().getString(C3242R.string.wallet_crypto_buy_information_dialog_title));
        setupActionItem$lambda$4.addSubItem(IdFabric$Menu.COPY, C3242R.C3244drawable.msg_copy, getResourceManager().getString(C3242R.string.wallet_transaction_details_action_copy_address));
        ...
        setupActionItem$lambda$4.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3242R.string.AccDescrMoreOptions));
    }
    ...
    private final void setupTexts() {
        ForkContentBlockchainsWalletDetailsBinding binding = getBinding();
        binding.buttonBackup.setText(getResourceManager().getString(C3242R.string.wallet_eth_account_settings_backup_title));
        binding.buttonReset.setText(LocaleController.getString("Reset", C3242R.string.Reset));
    }
