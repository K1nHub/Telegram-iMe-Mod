...
public final class WalletAccountSettingsFragment extends WalletAuthBaseFragment implements WalletAccountSettingsView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_eth_account_settings_toolbar_title));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.settings.WalletAccountSettingsFragment$setupActionBar$1$1
