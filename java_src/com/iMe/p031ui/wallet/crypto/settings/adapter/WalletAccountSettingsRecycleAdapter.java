...
public final class WalletAccountSettingsRecycleAdapter extends BaseQuickAdapter<WalletSettingsItem, BaseViewHolder> {
    ...
    public WalletAccountSettingsRecycleAdapter(ResourceManager resourceManager) {
        super(C3290R.layout.fork_recycle_item_wallet_account_settings, null, 2, null);
    ...
    public void convert(BaseViewHolder holder, WalletSettingsItem item) {
        ...
        BaseQuickAdapterExtKt.setVisibleElseGone(BaseQuickAdapterExtKt.setThemedImageColor(themedTextColor2, i4, Theme.key_windowBackgroundWhiteGrayIcon).setImageResource(i4, item.getIcon()), C3290R.C3293id.view_divider, !RecycleViewExtKt.isLastItem(holder, this)).setText(i3, this.resourceManager.getString(item.getTitle())).setText(i2, this.resourceManager.getString(item.getDescription()));
    }
}
