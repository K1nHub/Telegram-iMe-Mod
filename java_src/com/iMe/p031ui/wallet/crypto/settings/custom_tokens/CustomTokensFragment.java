...
public final class CustomTokensFragment extends WalletAuthBaseFragment implements CustomTokensView {
    ...
    private final void setupActionBar() {
        ...
        createMenu.addItem(IdFabric$Menu.ADD_TOKEN, C3473R.C3475drawable.msg_add);
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.settings.custom_tokens.CustomTokensFragment$setupActionBar$1$2
