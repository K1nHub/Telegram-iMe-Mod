...
public final class C2193xca859c2b extends Lambda implements Function1<Pair<? extends Result<? extends CryptoWalletsInfo>, ? extends Result<? extends Boolean>>, Unit> {
    final /* synthetic */ WalletPrivacySettingPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2193xca859c2b(WalletPrivacySettingPresenter walletPrivacySettingPresenter) {
        super(1);
    ...
    public final void m1445invoke(Pair<? extends Result<? extends CryptoWalletsInfo>, ? extends Result<? extends Boolean>> it) {
        ...
        if (pair.getFirst().isSuccess() && pair.getSecond().isSuccess()) {
            ...
            ((WalletPrivacySettingsView) this.this$0.getViewState()).onSuccessLoadPrivacySettings(allowedUsers, resolveAccessTypeBy, resolveAccessTypeBy2);
        }
    }
}
