...
public final class C2200x88ce73d4 extends Lambda implements Function1<Boolean, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C2200x88ce73d4(WalletPrivacySettingPresenter walletPrivacySettingPresenter, int i, ArrayList<Long> arrayList) {
        super(1);
    ...
    public final ObservableSource<? extends Result<Boolean>> invoke(Boolean isNeedChange) {
        ...
        Observable<Result<Boolean>> manageCryptoPrivacySettings = cryptoPermissionInteractor.manageCryptoPrivacySettings(this.$publicWalletAllowType == 0, this.$allowUsers);
        schedulersProvider = this.this$0.schedulersProvider;
        Observable<Result<Boolean>> observeOn = manageCryptoPrivacySettings.observeOn(schedulersProvider.mo698ui());
        ...
        ObservableSource map = observeOn.map(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new C2198xbd3dff7a((BaseView) viewState, resourceManager)));
