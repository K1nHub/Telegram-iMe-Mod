...
public final class C2192x78f2e5da extends Lambda implements Function1<Result<? extends CryptoWalletsInfo>, Result<? extends CryptoWalletsInfo>> {
    final /* synthetic */ ResourceManager $resourceManager;
    final /* synthetic */ BaseView $viewState;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2192x78f2e5da(BaseView baseView, ResourceManager resourceManager) {
        super(1);
