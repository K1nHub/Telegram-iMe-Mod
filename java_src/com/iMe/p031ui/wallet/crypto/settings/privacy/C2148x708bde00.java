...
public final class C2148x708bde00 extends Lambda implements Function1<List<? extends Result<? extends Boolean>>, Unit> {
    final /* synthetic */ WalletPrivacySettingPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2148x708bde00(WalletPrivacySettingPresenter walletPrivacySettingPresenter) {
        super(1);
    ...
    public final void m1407invoke(List<? extends Result<? extends Boolean>> it) {
