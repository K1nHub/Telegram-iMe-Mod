...
public final class C2188x78f2e5da extends Lambda implements Function1<Result<? extends CryptoWalletInfo>, Result<? extends CryptoWalletInfo>> {
    final /* synthetic */ ResourceManager $resourceManager;
    final /* synthetic */ BaseView $viewState;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2188x78f2e5da(BaseView baseView, ResourceManager resourceManager) {
        super(1);
