...
final class WalletConnectSessionDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletConnectSessionDetailsPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C21791 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletConnectSessionItem $item;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21791(WalletConnectSessionItem walletConnectSessionItem) {
            super(0);
            this.$item = walletConnectSessionItem;
        }
    ...
    public final WalletConnectSessionDetailsPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2177x6c0d24df(this.this$0, null, new C21791(this.$item)));
