...
final class WalletConnectSessionDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletConnectSessionDetailsPresenter> {
    ...
    public static final class C22391 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22391(WalletConnectSessionItem walletConnectSessionItem) {
            super(0);
            this.$item = walletConnectSessionItem;
        }
    ...
    public final WalletConnectSessionDetailsPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2237x6c0d24df(this.this$0, null, new C22391(this.$item)));
