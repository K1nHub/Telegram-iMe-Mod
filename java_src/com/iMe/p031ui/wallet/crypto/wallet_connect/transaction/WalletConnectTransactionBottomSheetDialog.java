...
public final class WalletConnectTransactionBottomSheetDialog extends MvpBottomSheet implements WalletConnectTransactionView {
    ...
    */
    public WalletConnectTransactionBottomSheetDialog(com.iMe.model.wallet.crypto.wallet_connect.WalletConnectTransactionScreenType r5, org.telegram.p044ui.ActionBar.BaseFragment r6) {
        /*
            r4 = this;
            ...
            r2.<init>()
            java.lang.Class<com.iMe.ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionPresenter> r3 = com.iMe.p031ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p031ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionBottomSheetDialog.<init>(com.iMe.model.wallet.crypto.wallet_connect.WalletConnectTransactionScreenType, org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    public void setupScreenWithData(String transactionAmount, String network, String from, String to, String peerUrl) {
        ...
        binding.textNetwork.setTextAndValue(getResourceManager().getString(C3295R.string.wallet_connect_session_details_network), network, true);
        binding.textFrom.setTextAndValue(getResourceManager().getString(C3295R.string.wallet_connect_transaction_from), from, true);
        binding.textTo.setTextAndValue(getResourceManager().getString(C3295R.string.wallet_connect_transaction_to), to, true);
        binding.textPeerUrl.setTextAndValue(getResourceManager().getString(C3295R.string.wallet_connect_transaction_dapp), peerUrl, true);
    ...
    public void onTransactionSuccess() {
        showToast(getResourceManager().getString(C3295R.string.wallet_connect_transaction_success));
        dismiss();
    }
