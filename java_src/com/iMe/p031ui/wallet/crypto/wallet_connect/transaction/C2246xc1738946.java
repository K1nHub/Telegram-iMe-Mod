...
public final class C2246xc1738946 extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ WalletConnectTransactionPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2246xc1738946(WalletConnectTransactionPresenter walletConnectTransactionPresenter) {
        super(1);
    ...
    public final void m1460invoke(Result<? extends String> it) {
