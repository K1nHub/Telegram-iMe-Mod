...
public final class WalletConnectMessageSignPresenter extends BasePresenter<WalletConnectMessageSignView> {
    ...
    public final DialogModel getSendConfirmationDialogModel() {
        return new DialogModel(this.resourceManager.getString(C3473R.string.wallet_connect_message_sign_confirm_title), this.resourceManager.getString(C3473R.string.wallet_connect_message_sign_confirm_description), this.resourceManager.getString(C3473R.string.common_cancel), this.resourceManager.getString(C3473R.string.wallet_connect_transaction_button_sign));
    }
    ...
    private final String getAddressText() {
        ...
        return (eVMWallet == null || (address = eVMWallet.getAddress()) == null || (shortened$default = StringExtKt.shortened$default(address, 0, 1, null)) == null) ? this.resourceManager.getString(C3473R.string.wallet_connect_message_sign_address_hidden) : shortened$default;
    }
}
