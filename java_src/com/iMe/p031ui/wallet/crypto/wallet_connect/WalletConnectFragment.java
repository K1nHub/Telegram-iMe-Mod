...
public final class WalletConnectFragment extends WalletAuthBaseFragment implements WalletConnectView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_connect_title));
        c3541ActionBar.setAllowOverlayTitle(true);
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.wallet_connect.WalletConnectFragment$setupActionBar$1$1
        ...
        ActionBarMenuItem setupActionBar$lambda$2$lambda$1 = c3541ActionBar.createMenu().addItemWithWidth(IdFabric$Menu.NETWORK_SWITCH, 0, -2);
    ...
    private final void setupViews() {
        ...
        Drawable drawable = ContextCompat.getDrawable(getParentActivity(), C3473R.C3475drawable.msg_mini_qr);
        ...
        spannableStringBuilder.append((CharSequence) getResourceManager().getString(C3473R.string.wallet_connect_new_connection));
        bigActionButton.setText(spannableStringBuilder);
        bigActionButton.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m72dp(6), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
        RLottieImageView rLottieImageView = binding.imageHeader;
        updateAnimationColors();
        rLottieImageView.setAutoRepeat(true);
        rLottieImageView.setAnimation(C3473R.raw.fork_wallet_connect, 300, 170, this.colors);
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.playAnimation();
        binding.textSessionsTitle.setText(getResourceManager().getString(C3473R.string.wallet_connect_active_sessions));
        binding.textDescription.setText(getResourceManager().getString(C3473R.string.wallet_connect_description));
        binding.buttonDisconnectAll.setTextAndIcon(getResourceManager().getString(C3473R.string.wallet_connect_terminate_all), C3473R.C3475drawable.msg_block2, false);
    }
