...
public final class C2204x796451d4 extends Lambda implements Function1<DomainRxEvents.NetworkUpdated, Unit> {
    final /* synthetic */ WalletConnectPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2204x796451d4(WalletConnectPresenter walletConnectPresenter) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents.NetworkUpdated networkUpdated) {
        m1432invoke(networkUpdated);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1432invoke(DomainRxEvents.NetworkUpdated it) {
