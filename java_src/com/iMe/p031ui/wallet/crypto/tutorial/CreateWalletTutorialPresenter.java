...
public final class CreateWalletTutorialPresenter extends BasePresenter<CreateWalletTutorialView> {
    ...
    private final List<TutorialPage> getTutorialPages() {
        ...
        if (tutorialType instanceof TutorialType.Intro) {
            mutableListOf2 = CollectionsKt__CollectionsKt.mutableListOf(new TutorialPage(C3242R.raw.fork_non_custodial, C3242R.string.wallet_create_eth_account_tutorial_backup_title, C3242R.string.wallet_create_eth_account_tutorial_backup_description), new TutorialPage(C3242R.raw.fork_tutorial_check_data, C3242R.string.wallet_create_eth_account_tutorial_check_data_title, C3242R.string.wallet_create_eth_account_tutorial_check_data_description), new TutorialPage(C3242R.raw.fork_tutorial_be_carefull, C3242R.string.wallet_create_eth_account_tutorial_carefull_title, C3242R.string.wallet_create_eth_account_tutorial_carefull_description));
            return mutableListOf2;
        } else if (tutorialType instanceof TutorialType.Backup) {
            mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new TutorialPage(C3242R.raw.fork_congratulations, C3242R.string.wallet_dashboard_create_eth_wallet_success_dialog_title, C3242R.string.wallet_dashboard_create_eth_wallet_success_dialog_description), new TutorialPage(C3242R.raw.fork_back_up, C3242R.string.wallet_eth_backup_info_start_dialog_title, C3242R.string.wallet_eth_backup_info_start_dialog_description));
