...
final class CreateWalletTutorialFragment$binding$2 extends Lambda implements Function0<ForkFragmentWalletTutorialBinding> {
    ...
    public final ForkFragmentWalletTutorialBinding invoke() {
        return ForkFragmentWalletTutorialBinding.inflate(BaseFragmentExtKt.getLayoutInflater(this.this$0));
    }
}
