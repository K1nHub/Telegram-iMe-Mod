...
public final class CreateWalletTutorialFragment extends WalletAuthFragment implements CreateWalletTutorialView {
    ...
    private final void setupActionBar() {
        C3306ActionBar setupActionBar$lambda$3 = this.actionBar;
        ...
        setupActionBar$lambda$3.setActionBarMenuOnItemClick(new C3306ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$setupActionBar$1$1
    ...
    public final void handleBackPressed() {
        if (this.tutorialType instanceof TutorialType.Backup) {
            ...
            AlertDialog createDialog$default = DialogUtils.createDialog$default(parentActivity, new DialogModel(getResourceManager().getString(C3242R.string.wallet_backup_quit_alert_title), getResourceManager().getString(C3242R.string.wallet_backup_quit_alert_description), getResourceManager().getString(C3242R.string.wallet_backup_quit_alert_negative_button), getResourceManager().getString(C3242R.string.wallet_backup_quit_alert_positive_button)), new Callbacks$Callback() { // from class: com.iMe.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$$ExternalSyntheticLambda0
        ...
        setupViewPager$lambda$5.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() { // from class: com.iMe.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$setupViewPager$1$1
            ...
            public void onPageSelected(int i) {
                ...
                if (i == lastIndex) {
                    ...
                    onPageSelected$lambda$0.setText(resourceManager2.getString(C3242R.string.common_create));
                    Intrinsics.checkNotNullExpressionValue(onPageSelected$lambda$0, "onPageSelected$lambda$0");
                    ViewExtKt.safeThrottledClick$default(onPageSelected$lambda$0, 0L, new C2157x2903d52b(createWalletTutorialFragment), 1, null);
                    return;
                }
                ...
                onPageSelected$lambda$1.setText(resourceManager.getString(C3242R.string.common_next));
                Intrinsics.checkNotNullExpressionValue(onPageSelected$lambda$1, "onPageSelected$lambda$1");
                ViewExtKt.safeThrottledClick$default(onPageSelected$lambda$1, 0L, new C2158x2903d8ec(createWalletTutorialFragment2), 1, null);
            }
        });
    }

    private final void setupTexts() {
        getBinding().buttonAction.setText(getResourceManager().getString(C3242R.string.common_next));
    }
    ...
    private final void setupListeners() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2154x88dbe126(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2155x88dbe127(null)));
