...
public final class CreateWalletPasswordPresenter extends BasePresenter<CreateWalletPasswordView> {
    ...
    public final boolean validatePassword(String pass) {
        ...
        createWalletPasswordView.showToast(this.resourceManager.getString(C3290R.string.wallet_create_eth_password_validation_length_error));
    ...
    public final void checkPasswordMatch(String confirmPass) {
        ...
        createWalletPasswordView.showToast(this.resourceManager.getString(C3290R.string.wallet_confirm_eth_password_validation_not_match_error));
        createWalletPasswordView.onCodeErrorShake();
    }
    ...
    public final void subscribeOnRxEvents(Runnable onEventAction) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2152xbb8b799f(onEventAction)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2153xbb8b79a0(null)));
