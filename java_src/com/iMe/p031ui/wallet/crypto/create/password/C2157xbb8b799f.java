...
public final class C2157xbb8b799f extends Lambda implements Function1<DomainRxEvents.CryptoEvent, Unit> {
    final /* synthetic */ Runnable $onEventAction$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2157xbb8b799f(Runnable runnable) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents.CryptoEvent cryptoEvent) {
        m1414invoke(cryptoEvent);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1414invoke(DomainRxEvents.CryptoEvent it) {
