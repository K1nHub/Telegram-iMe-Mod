...
public final class C2108x17c7d15b extends Lambda implements Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C2108x17c7d15b(boolean z, CreateWalletPresenter createWalletPresenter, String str) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends Boolean> result) {
        ...
        if (!(result instanceof Result.Success)) {
            ...
            Observable<Result<Wallet>> observeOn = importWallet.observeOn(schedulersProvider.mo693ui());
            Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoWalletInteractor\n …(schedulersProvider.ui())");
            ObservableSource map = observeOn.map(new C2112x9ee4cc57(new C2111x26aadb35()));
