...
public final class C2150x40636172 extends Lambda implements Function1<List<? extends String>, Unit> {
    final /* synthetic */ CreateWalletPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2150x40636172(CreateWalletPresenter createWalletPresenter) {
        super(1);
    ...
    public final void m1412invoke(List<? extends String> it) {
        String str;
