...
/* renamed from: com.iMe.ui.wallet.crypto.create.secret_words_count.SecretWordsCountBottomSheetDialog$presenter$2 */
...
final class SecretWordsCountBottomSheetDialog$presenter$2 extends Lambda implements Function0<SecretWordsCountPresenter> {
    ...
    public final SecretWordsCountPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2117x4b006a38(this.this$0, null, null));
