...
public final class SecretWordsCountBottomSheetDialog extends MvpBottomSheet implements SecretWordsCountView {
    ...
    public SecretWordsCountBottomSheetDialog(Activity parentActivity, Function1<? super Integer, Unit> onWordsCountSelected) {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2162x593128cf(this, null, null));
    ...
    private final void setupColors() {
        ...
        setupColors$lambda$4$lambda$2.setTextColor(getThemedColor(Theme.key_dialogTextBlue2));
        ...
        setupColors$lambda$4$lambda$3.setTextColor(getThemedColor(Theme.key_chats_actionBackground));
    }
    ...
    private final void setTexts() {
        getBinding().textTitle.setText(LocaleController.getInternalString(C3295R.string.wallet_import_change_words_count_dialog_title));
    }
