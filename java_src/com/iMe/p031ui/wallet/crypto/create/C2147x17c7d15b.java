...
public final class C2147x17c7d15b extends Lambda implements Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C2147x17c7d15b(boolean z, CreateWalletPresenter createWalletPresenter, String str) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends Boolean> result) {
        ...
        if (!(result instanceof Result.Success)) {
            ...
            ObservableSource map = observeOn.map(new C2151x9ee4cc57(new C2150x26aadb35()));
