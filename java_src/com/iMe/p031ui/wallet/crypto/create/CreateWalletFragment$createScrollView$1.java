...
public final class CreateWalletFragment$createScrollView$1 extends ScrollView {
    ...
    protected void onScrollChanged(int i, int i2, int i3, int i4) {
        ...
        c3485ActionBar = ((BaseFragment) this.this$0).actionBar;
        boolean z = measuredHeight < c3485ActionBar.getBottom();
        ...
        if (z != (titleTextView3.getTag() == null)) {
            ...
            c3485ActionBar2 = ((BaseFragment) createWalletFragment).actionBar;
            SimpleTextView titleTextView5 = c3485ActionBar2.getTitleTextView();
