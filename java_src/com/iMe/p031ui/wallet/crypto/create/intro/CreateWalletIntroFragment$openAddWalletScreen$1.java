...
/* renamed from: com.iMe.ui.wallet.crypto.create.intro.CreateWalletIntroFragment$openAddWalletScreen$1 */
/* loaded from: classes4.dex */
final class CreateWalletIntroFragment$openAddWalletScreen$1 extends Lambda implements Function0<BaseFragment> {
    final /* synthetic */ String $password;
    final /* synthetic */ Wallet $wallet;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CreateWalletIntroFragment$openAddWalletScreen$1(String str, Wallet wallet2) {
        super(0);
        this.$password = str;
        this.$wallet = wallet2;
    }
