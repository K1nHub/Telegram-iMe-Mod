...
public final class CreateWalletIntroFragment extends WalletCreationBaseFragment implements CreateWalletIntroView {
    ...
    public CreateWalletIntroFragment(final String linkedWalletAddress, WalletCreationType.Initial walletCreationType) {
        ...
        this.toolbar$delegate = ResettableLazyDelegateKt.resettableLazy$default(this, (ResettableLazyManager) null, new Function0<C3541ActionBar>() { // from class: com.iMe.ui.wallet.crypto.create.intro.CreateWalletIntroFragment$toolbar$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
    ...
    private final C3541ActionBar getToolbar() {
        return (C3541ActionBar) this.toolbar$delegate.getValue(this, $$delegatedProperties[2]);
    }
    ...
    public void setupScreenData(TLRPC$User user, String address, Network.Explorer explorer) {
        ...
        binding.textUserId.setText(getResourceManager().getString(C3473R.string.wallet_home_crypto_account_telegram_id, Long.valueOf(user.f1685id)));
    ...
    public final C3541ActionBar initActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(this.walletCreationType.getTitleTextResId()));
        c3541ActionBar.createMenu().addItem(IdFabric$Menu.INFO, C3473R.C3475drawable.msg_info);
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.create.intro.CreateWalletIntroFragment$initActionBar$1$1
    ...
    private final void setupItemMoreOptions(Network.Explorer explorer) {
        ...
        setupItemMoreOptions$lambda$8.setIcon(C3473R.C3475drawable.ic_ab_other);
        ...
        setupItemMoreOptions$lambda$8.addSubItem(IdFabric$Menu.SCAN_ADDRESS, 0, getResourceManager().getString(C3473R.string.wallet_transaction_details_action_open_etherscan, explorer.getName())).setIcon(explorer.getLogoUrl());
        ...
        setupItemMoreOptions$lambda$8.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
    }
    ...
    private final void setupListeners() {
        ...
        C3541ActionBar toolbar = getToolbar();
    ...
    private final void setupViews() {
        ...
        rLottieImageView.setAnimation(C3473R.raw.fork_crypto_wallet, ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        rLottieImageView.playAnimation();
        binding.textTitle.setText(getResourceManager().getString(C3473R.string.wallet_creation_intro_title));
        binding.textDescription.setText(getResourceManager().getString(C3473R.string.wallet_creation_intro_description));
        binding.textLinkedWalletTitle.setText(getResourceManager().getString(C3473R.string.wallet_creation_intro_linked_wallet));
        TextView textView = binding.textPrivacy;
        textView.setMovementMethod(new AndroidUtilities.LinkMovementMethodMy());
        String string = getResourceManager().getString(C3473R.string.wallet_creation_intro_privacy);
        ...
        if (indexOf$default != -1 && lastIndexOf$default != -1 && indexOf$default != lastIndexOf$default) {
            ...
            spannableStringBuilder.setSpan(new URLSpanNoUnderline(LocaleController.getString("PrivacyPolicyUrl", C3473R.string.PrivacyPolicyUrl)), indexOf$default, lastIndexOf$default - 1, 33);
        }
        textView.setText(spannableStringBuilder);
        binding.itemMoreOptions.setIcon(C3473R.C3475drawable.ic_ab_other);
        binding.buttonNext.setIcon(C3473R.C3475drawable.msg_arrow_forward);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void showInfoDialog() {
        showDialog(DialogsFactoryKt.createInfoBottomSheetDialog$default(this, getResourceManager().getString(C3473R.string.wallet_creation_intro_information_title), getResourceManager().getString(C3473R.string.wallet_creation_intro_information_description), getResourceManager().getString(C3473R.string.common_ok), null, 8, null));
    }
