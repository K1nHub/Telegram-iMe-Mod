...
/* renamed from: com.iMe.ui.wallet.crypto.create.CreateWalletFragment$createNewWalletWithPassword$1 */
...
final class CreateWalletFragment$createNewWalletWithPassword$1 extends Lambda implements Function0<BaseFragment> {
    ...
    public CreateWalletFragment$createNewWalletWithPassword$1(String str, Wallet wallet2) {
        super(0);
        this.$password = str;
        this.$wallet = wallet2;
    }
