...
/* renamed from: com.iMe.ui.wallet.crypto.create.CreateWalletFragment$buttonQR$2 */
/* loaded from: classes3.dex */
public final class CreateWalletFragment$buttonQR$2 extends Lambda implements Function0<SecretWordsActionButton> {
    final /* synthetic */ CreateWalletFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CreateWalletFragment$buttonQR$2(CreateWalletFragment createWalletFragment) {
        super(0);
    ...
    public final SecretWordsActionButton invoke() {
        ...
        createQRButton = this.this$0.createQRButton();
