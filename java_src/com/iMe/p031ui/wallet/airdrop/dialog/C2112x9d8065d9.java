...
public final class C2112x9d8065d9 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ WalletAirdropDialogPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2112x9d8065d9(WalletAirdropDialogPresenter walletAirdropDialogPresenter) {
        super(1);
    ...
    public final void m1396invoke(Result<? extends Boolean> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            String string = resourceManager.getString(C3295R.string.airdrop_success_dialog_title);
            resourceManager2 = this.this$0.resourceManager;
            ((WalletAirdropDialogView) this.this$0.getViewState()).onSuccessClaimAirdrop(string, resourceManager2.getString(C3295R.string.airdrop_success_dialog_description));
