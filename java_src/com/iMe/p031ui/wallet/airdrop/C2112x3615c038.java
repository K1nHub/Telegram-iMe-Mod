...
public final class C2112x3615c038 extends Lambda implements Function1<Result<? extends AirdropInfo>, Unit> {
    final /* synthetic */ WalletAirdropPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2112x3615c038(WalletAirdropPresenter walletAirdropPresenter) {
        super(1);
    ...
    public final void m1405invoke(Result<? extends AirdropInfo> it) {
