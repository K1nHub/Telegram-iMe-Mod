...
public final class WalletTransactionDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletTransactionDetailsPresenter> {
    ...
    /* loaded from: classes4.dex */
    public static final class C24771 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletTransactionDetailsBottomSheetDialog this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C24771(WalletTransactionDetailsBottomSheetDialog walletTransactionDetailsBottomSheetDialog) {
            super(0);
            this.this$0 = walletTransactionDetailsBottomSheetDialog;
        }
    ...
    public final WalletTransactionDetailsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2472xf16dbe9f(walletTransactionDetailsBottomSheetDialog, null, new C24771(walletTransactionDetailsBottomSheetDialog)));
