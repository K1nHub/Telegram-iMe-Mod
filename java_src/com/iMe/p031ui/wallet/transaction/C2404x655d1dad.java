...
public final class C2404x655d1dad extends Lambda implements Function1<RxEvent, Unit> {
    final /* synthetic */ WalletTransactionsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2404x655d1dad(WalletTransactionsPresenter walletTransactionsPresenter) {
        super(1);
    ...
    public final void m1544invoke(RxEvent it) {
