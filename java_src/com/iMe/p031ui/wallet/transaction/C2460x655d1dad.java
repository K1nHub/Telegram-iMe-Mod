...
public final class C2460x655d1dad extends Lambda implements Function1<RxEvent, Unit> {
    final /* synthetic */ WalletTransactionsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2460x655d1dad(WalletTransactionsPresenter walletTransactionsPresenter) {
        super(1);
    ...
    public final void m1571invoke(RxEvent it) {
        ...
        if (Intrinsics.areEqual(rxEvent, AppRxEvents.UpdateWalletScreen.INSTANCE) ? true : Intrinsics.areEqual(rxEvent, AppRxEvents.UpdateTransactionScreen.INSTANCE) ? true : Intrinsics.areEqual(rxEvent, DomainRxEvents.WalletReset.INSTANCE) ? true : Intrinsics.areEqual(rxEvent, DomainRxEvents.WalletCreated.INSTANCE) ? true : Intrinsics.areEqual(rxEvent, DomainRxEvents.WalletRestored.INSTANCE) ? true : Intrinsics.areEqual(rxEvent, DomainRxEvents.RefreshTransactions.INSTANCE)) {
            ...
            this.this$0.selectedNetwork = NetworksHelper.getNetworkById(((DomainRxEvents.StakingOperationsReload) rxEvent).getNetworkId());
            WalletTransactionsPresenter.load$default(this.this$0, true, false, null, 6, null);
        }
    }
}
