...
public final class WalletTransactionsFragment extends WalletTabFragment implements WalletTransactionsView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_transactions_toolbar_title));
        c3541ActionBar.setAllowOverlayTitle(true);
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.transaction.WalletTransactionsFragment$setupActionBar$1$1
        ...
        ActionBarMenuItem setupActionBar$lambda$3$lambda$2 = c3541ActionBar.createMenu().addItemWithWidth(IdFabric$Menu.NETWORK_SWITCH, 0, -2);
        ...
        ViewExtKt.setPaddingHorizontal(setupActionBar$lambda$3$lambda$2, AndroidUtilities.m72dp(14));
