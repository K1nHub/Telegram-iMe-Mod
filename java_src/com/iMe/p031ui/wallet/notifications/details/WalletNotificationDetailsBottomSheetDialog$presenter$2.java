...
public final class WalletNotificationDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletNotificationDetailsPresenter> {
    ...
    public static final class C23211 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23211(WalletNotificationDetailsBottomSheetDialog walletNotificationDetailsBottomSheetDialog) {
            super(0);
            this.this$0 = walletNotificationDetailsBottomSheetDialog;
        }
    ...
    public final WalletNotificationDetailsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2319xccf02360(walletNotificationDetailsBottomSheetDialog, null, new C23211(walletNotificationDetailsBottomSheetDialog)));
