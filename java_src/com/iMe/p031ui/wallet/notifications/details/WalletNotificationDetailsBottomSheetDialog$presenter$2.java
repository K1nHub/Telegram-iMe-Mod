...
public final class WalletNotificationDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletNotificationDetailsPresenter> {
    ...
    /* loaded from: classes4.dex */
    public static final class C22821 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletNotificationDetailsBottomSheetDialog this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22821(WalletNotificationDetailsBottomSheetDialog walletNotificationDetailsBottomSheetDialog) {
            super(0);
            this.this$0 = walletNotificationDetailsBottomSheetDialog;
        }
    ...
    public final WalletNotificationDetailsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2280xccf02360(walletNotificationDetailsBottomSheetDialog, null, new C22821(walletNotificationDetailsBottomSheetDialog)));
