...
public final class WalletNotificationsFragment extends WalletAuthBaseFragment implements WalletNotificationsView {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(getResourceManager().getString(C3473R.string.wallet_notifications_toolbar_title));
        c3541ActionBar.setAllowOverlayTitle(true);
        ActionBarMenuItem setupActionBar$lambda$3$lambda$2$lambda$1 = c3541ActionBar.createMenu().addItem(0, C3473R.C3475drawable.ic_ab_other);
        ...
        setupActionBar$lambda$3$lambda$2$lambda$1.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
        setupActionBar$lambda$3$lambda$2$lambda$1.addSubItem(1, C3473R.C3475drawable.fork_ic_folder_tab_read_all_24, getResourceManager().getString(C3473R.string.dialogs_tab_popup_read_all));
        this.optionsMenuItem = setupActionBar$lambda$3$lambda$2$lambda$1;
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.notifications.WalletNotificationsFragment$setupActionBar$1$2
