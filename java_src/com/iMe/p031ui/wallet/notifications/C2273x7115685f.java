...
public final class C2273x7115685f extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ List $notifications$inlined;
    final /* synthetic */ WalletNotificationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2273x7115685f(List list, WalletNotificationsPresenter walletNotificationsPresenter) {
        super(1);
    ...
    public final void m1472invoke(Result<? extends Boolean> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            ((WalletNotificationsView) this.this$0.getViewState()).showToast(this.this$0.getResourceManager().getString(C3242R.string.wallet_notifications_success_mark_all_notification_as_read));
