...
public final class C2314x560e7e8e extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ WalletNotificationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2314x560e7e8e(WalletNotificationsPresenter walletNotificationsPresenter) {
        super(1);
    ...
    public final void m1492invoke(Result<? extends Boolean> it) {
