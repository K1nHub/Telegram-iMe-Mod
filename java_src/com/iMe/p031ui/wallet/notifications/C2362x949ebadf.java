...
public final class C2362x949ebadf extends Lambda implements Function1<Result<? extends List<? extends Notification>>, Unit> {
    final /* synthetic */ boolean $forceUpdate$inlined;
    final /* synthetic */ WalletNotificationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2362x949ebadf(WalletNotificationsPresenter walletNotificationsPresenter, boolean z) {
        super(1);
    ...
    public final void m1513invoke(Result<? extends List<? extends Notification>> it) {
