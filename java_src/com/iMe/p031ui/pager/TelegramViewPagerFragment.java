...
public abstract class TelegramViewPagerFragment extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setOccupyStatusBar(!AndroidUtilities.isTablet());
        c3541ActionBar.setBackButtonImage(C3473R.C3475drawable.ic_ab_back);
        c3541ActionBar.setTitle(getToolbarTitle());
        c3541ActionBar.setExtraHeight(AndroidUtilities.m73dp(getAdditionalActionBarHeight() + 44.0f));
        c3541ActionBar.setAllowOverlayTitle(false);
        c3541ActionBar.setAddToContainer(false);
        c3541ActionBar.setClipContent(true);
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.pager.TelegramViewPagerFragment$setupActionBar$1$1
        ...
        ViewParent parent = c3541ActionBar.getParent();
        ViewGroup viewGroup = parent instanceof ViewGroup ? (ViewGroup) parent : null;
        if (viewGroup != null) {
            viewGroup.removeView(c3541ActionBar);
        }
    }
