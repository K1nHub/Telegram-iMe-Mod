...
public class PhotoView$$State extends MvpViewState<PhotoView> implements PhotoView {
    ...
    public class ShowErrorToastCommand<T> extends ViewCommand<PhotoView> {
        ...
        ShowErrorToastCommand(PhotoView$$State photoView$$State, Result.Error<? extends T> error, ResourceManager resourceManager) {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(PhotoView photoView) {
            photoView.showErrorToast(this.result, this.resourceManager);
        }
    }
