...
public final class RecognitionBottomSheetDialog extends MvpBottomSheet {
    ...
    */
    ...
    private final void setupStyles() {
        ...
        ImageViewExtKt.setImageColor(imageClose, Theme.getColor(i2));
        ...
        ImageViewExtKt.setImageColor(imageServiceLogo, Theme.getColor(i2));
        ...
        ImageViewExtKt.setImageColor(imageCopy, Theme.getColor(i3));
        AppCompatImageView imageShare = binding.imageShare;
        Intrinsics.checkNotNullExpressionValue(imageShare, "imageShare");
        ImageViewExtKt.setImageColor(imageShare, Theme.getColor(i3));
        ...
        ImageViewExtKt.setImageColor(imageTranslate, Theme.getColor(i3));
