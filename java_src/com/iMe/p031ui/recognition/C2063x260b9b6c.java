...
public final class C2063x260b9b6c extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ boolean $withTranslateAdditionalAction$inlined;
    final /* synthetic */ PhotoViewerPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2063x260b9b6c(boolean z, PhotoViewerPresenter photoViewerPresenter) {
        super(1);
    ...
    public final void m1352invoke(Result<? extends String> it) {
