...
public final class ContactsPresenter extends BasePresenter<ContactsView> {
    ...
    public final void deleteSelectedContacts() {
        Completable observeOn = this.contactInteractor.deleteSelectedContacts().observeOn(this.schedulersProvider.mo693ui());
        ...
        }, new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1962x3873914f((BaseView) getViewState(), this)));
