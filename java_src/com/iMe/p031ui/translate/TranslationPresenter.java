...
public final class TranslationPresenter extends BasePresenter<TranslationView> {
    ...
    public final void loadLanguages(boolean z) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2014xba424fcb(this, z)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2015xba424fcc((BaseView) getViewState())));
    ...
    public final void translate(String text, boolean z) {
        ...
        if (isValidToTranslate()) {
            ...
            Observable<Result<Translation>> observeOn = translationInteractor.translate(text, languageCode, this.sourceLanguage.getLanguageCode()).observeOn(this.schedulersProvider.mo693ui());
            Intrinsics.checkNotNullExpressionValue(observeOn, "translationInteractor\n  …(schedulersProvider.ui())");
            Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2016xa655ab44(this, text, z)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2017xa655ab45((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
            return;
        }
    ...
    public final void translateSource(String text, boolean z) {
        ...
        Intrinsics.checkNotNull(languageCode);
        Observable<Result<Translation>> observeOn = translationInteractor.translate(text, languageCode, this.outLanguage.getLanguageCode()).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "translationInteractor\n  …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2018x31d12e3f(this, text)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2019x31d12e40((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
