...
public final class TwitterAuthFragment extends MvpFragment implements TwitterAuthView {
    ...
    public void onTransitionAnimationEnd(boolean z, boolean z2) {
        ...
        mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.m80to(RtspHeaders.AUTHORIZATION, this.token));
    ...
    private final void setupActionBar() {
        ...
        c3306ActionBar.setTitle(getResourceManager().getString(C3242R.string.twitter_auth_title));
        c3306ActionBar.setActionBarMenuOnItemClick(new C3306ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.twitter.auth.TwitterAuthFragment$setupActionBar$1$1
