package com.iMe.p031ui.twitter.search.adapter.diff;
...
/* renamed from: com.iMe.ui.twitter.search.adapter.diff.TwitterSearchDiffCallback */
...
public final class TwitterSearchDiffCallback extends DiffUtil.ItemCallback<BaseNode> {
    ...
    public boolean areItemsTheSame(BaseNode oldItem, BaseNode newItem) {
        ...
        if ((oldItem instanceof TwitterUserItem) && (newItem instanceof TwitterUserItem)) {
            if (((TwitterUserItem) oldItem).getUser().f1567id == ((TwitterUserItem) newItem).getUser().f1567id) {
                return true;
            }
