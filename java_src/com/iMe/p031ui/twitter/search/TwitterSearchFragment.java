...
import com.iMe.p031ui.twitter.search.adapter.diff.TwitterSearchDiffCallback;
...
public final class TwitterSearchFragment extends MvpFragment implements TwitterSearchView {
    ...
    public void showInviteConfirmationDialog(DialogModel dialogModel, final long j) {
        ...
        showDialog(DialogUtils.createDialog$default(context, dialogModel, new Callbacks$Callback() { // from class: com.iMe.ui.twitter.search.TwitterSearchFragment$$ExternalSyntheticLambda3
    ...
    public void showRequestPermissionSuccessDialog(String title, String message, Callbacks$Callback action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        DialogsFactoryKt.showSuccessAlert(this, title, message, getResourceManager().getString(C3242R.string.common_ok), action);
    }
    ...
    private final void setupActionBar() {
        ...
        c3306ActionBar.setTitle(getResourceManager().getString(C3242R.string.wallet_binance_receive_choose_contact_title));
        ActionBarMenuItem actionBarMenuItemSearchListener = c3306ActionBar.createMenu().addItem(IdFabric$Menu.SEARCH_TWITTER, C3242R.C3244drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: com.iMe.ui.twitter.search.TwitterSearchFragment$setupActionBar$1$1
        ...
        actionBarMenuItemSearchListener.setSearchFieldHint(getResourceManager().getString(C3242R.string.twitter_search_hint));
        actionBarMenuItemSearchListener.setContentDescription(LocaleController.getString("Search", C3242R.string.Search));
        this.searchItem = actionBarMenuItemSearchListener;
        c3306ActionBar.setActionBarMenuOnItemClick(new C3306ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.twitter.search.TwitterSearchFragment$setupActionBar$1$3
    ...
    private final void setupLoadMore(TwitterUsersRecycleAdapter twitterUsersRecycleAdapter) {
        ...
        loadMoreModule.setOnLoadMoreListener(new OnLoadMoreListener() { // from class: com.iMe.ui.twitter.search.TwitterSearchFragment$$ExternalSyntheticLambda1
    ...
    private final void setupListeners() {
        ...
        twitterUsersRecycleAdapter.getTwitterInviteProvider().setOnInviteClickAction(new Callbacks$Callback1() { // from class: com.iMe.ui.twitter.search.TwitterSearchFragment$$ExternalSyntheticLambda2
        ...
        twitterUsersRecycleAdapter.setOnItemClickListener(new OnItemClickListener() { // from class: com.iMe.ui.twitter.search.TwitterSearchFragment$$ExternalSyntheticLambda0
    ...
    /* compiled from: TwitterSearchFragment.kt */
    /* renamed from: com.iMe.ui.twitter.search.TwitterSearchFragment$Companion */
    /* loaded from: classes3.dex */
