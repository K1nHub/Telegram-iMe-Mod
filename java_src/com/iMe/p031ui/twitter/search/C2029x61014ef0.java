...
/* renamed from: com.iMe.ui.twitter.search.TwitterSearchPresenter$getSearchObservable$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C2029x61014ef0 extends Lambda implements Function1<Result<? extends List<? extends TwitterUserInfo>>, ObservableSource<? extends Result<? extends List<? extends BaseNode>>>> {
    final /* synthetic */ TwitterSearchPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2029x61014ef0(TwitterSearchPresenter twitterSearchPresenter) {
        super(1);
