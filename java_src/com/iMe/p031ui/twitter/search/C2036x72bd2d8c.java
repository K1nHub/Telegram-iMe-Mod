...
public final class C2036x72bd2d8c extends Lambda implements Function1<Result<? extends List<? extends BaseNode>>, Unit> {
    final /* synthetic */ TwitterSearchPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2036x72bd2d8c(TwitterSearchPresenter twitterSearchPresenter) {
        super(1);
    ...
    public final void m1360invoke(Result<? extends List<? extends BaseNode>> it) {
