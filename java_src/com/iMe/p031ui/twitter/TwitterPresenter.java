...
@InjectViewState
/* renamed from: com.iMe.ui.twitter.TwitterPresenter */
...
public final class TwitterPresenter extends BasePresenter<TwitterView> {
    ...
    public final void loadTweets(boolean z, boolean z2) {
        ...
        Observable<Result<List<TweetInfo>>> observeOn = this.twitterInteractor.getUserTweets(this.telegramProfileId, this.twitterUserId, this.lastItemId).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "twitterInteractor\n      …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2021x586e495a(this, z3, z)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2022x586e495b(null)));
    ...
    private final void subscribeToLikeToggles() {
        Observable<TweetItem> observeOn = this.likeToggleSubject.debounce(200L, TimeUnit.MILLISECONDS).distinctUntilChanged().subscribeOn(this.schedulersProvider.mo694io()).observeOn(this.schedulersProvider.mo693ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "likeToggleSubject\n      …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2023xbd4bb315(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2024xbd4bb316(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
