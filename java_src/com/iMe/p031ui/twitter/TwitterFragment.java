...
import com.iMe.p031ui.twitter.adapter.diff.TweetsDiffCallback;
...
public final class TwitterFragment extends MvpFragment implements TwitterView {
    ...
    @Override // com.iMe.p031ui.twitter.TwitterView
    ...
    private final void setupActionBar() {
        ...
        c3306ActionBar.setTitle(LocaleController.getInternalString(C3242R.string.twitter_title));
        ...
        addItem.addSubItem(IdFabric$Menu.OPEN_IN_TWITTER, C3242R.C3244drawable.fork_drawer_social_twitter, getResourceManager().getString(C3242R.string.twitter_open_in_twitter));
        c3306ActionBar.setActionBarMenuOnItemClick(new C3306ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.twitter.TwitterFragment$setupActionBar$1$2
    ...
    public static final void setupListeners$lambda$14$lambda$13(TweetsRecycleAdapter this_with, TwitterFragment this$0, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        ...
        if ((baseNode instanceof TweetItem) && view.getId() == C3242R.C3245id.image_share) {
