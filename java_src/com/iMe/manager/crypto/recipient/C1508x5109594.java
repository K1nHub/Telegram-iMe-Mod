...
public final class C1508x5109594 extends Lambda implements Function1<Throwable, Result<? extends TLRPC$messages_BotResults>> {
    public static final C1508x5109594 INSTANCE = new C1508x5109594();

    public C1508x5109594() {
        super(1);
    }
