...
public final class C1522x5109593 extends Lambda implements Function1<TLRPC$messages_BotResults, Result<? extends TLRPC$messages_BotResults>> {
    public static final C1522x5109593 INSTANCE = new C1522x5109593();

    public C1522x5109593() {
        super(1);
    }
