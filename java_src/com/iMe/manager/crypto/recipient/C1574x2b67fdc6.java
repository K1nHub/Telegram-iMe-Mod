...
public final class C1574x2b67fdc6 extends Lambda implements Function1<Result<? extends TLRPC$messages_BotResults>, Unit> {
    ...
    public C1574x2b67fdc6(CryptoRecipientManager cryptoRecipientManager, Ref$LongRef ref$LongRef, String str) {
        super(1);
    ...
    public final void m1277invoke(Result<? extends TLRPC$messages_BotResults> it) {
