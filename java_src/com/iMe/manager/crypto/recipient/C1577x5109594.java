...
public final class C1577x5109594 extends Lambda implements Function1<Throwable, Result<? extends TLRPC$messages_BotResults>> {
    public static final C1577x5109594 INSTANCE = new C1577x5109594();

    public C1577x5109594() {
        super(1);
    }
