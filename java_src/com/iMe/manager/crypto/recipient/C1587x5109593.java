...
public final class C1587x5109593 extends Lambda implements Function1<TLRPC$messages_BotResults, Result<? extends TLRPC$messages_BotResults>> {
    public static final C1587x5109593 INSTANCE = new C1587x5109593();

    public C1587x5109593() {
        super(1);
    }
