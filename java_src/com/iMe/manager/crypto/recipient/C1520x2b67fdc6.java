...
public final class C1520x2b67fdc6 extends Lambda implements Function1<Result<? extends TLRPC$messages_BotResults>, Unit> {
    ...
    public C1520x2b67fdc6(CryptoRecipientManager cryptoRecipientManager, Ref$LongRef ref$LongRef, String str) {
        super(1);
    ...
    public final void m1251invoke(Result<? extends TLRPC$messages_BotResults> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            String str = tLRPC$BotInlineResult.f1500id;
            ...
            String string = resourceManager2.getString(C3316R.string.wallet_recipient_request_permission_success_dialog_title);
            resourceManager3 = this.this$0.resourceManager;
            String string2 = resourceManager3.getString(C3316R.string.wallet_recipient_request_permission_success_dialog_description, this.$recipient$inlined);
