...
public final class C1502x4c48b562 extends Lambda implements Function1<Result<? extends AccountInfo>, Unit> {
    ...
    public C1502x4c48b562(CryptoRecipientManager cryptoRecipientManager, String str, BlockchainType blockchainType) {
        super(1);
    ...
    public final void m1241invoke(Result<? extends AccountInfo> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (mapToUI instanceof AddressAccessState.Granted) {
                ...
                String string = resourceManager5.getString(C3242R.string.wallet_amount_error_invalid_user_title);
                resourceManager6 = this.this$0.resourceManager;
                String string2 = resourceManager6.getString(C3242R.string.wallet_recipient_error_dialog_no_eth_address_description);
                resourceManager7 = this.this$0.resourceManager;
                viewState3.showErrorDialog(string, string2, resourceManager7.getString(C3242R.string.wallet_amount_error_invalid_user_btn_txt));
            }
            ...
            if (error.getError().getStatus() == FirebaseFunctionsErrorHandler.ErrorStatus.USER_NOT_FOUND) {
                ...
                String string3 = resourceManager2.getString(C3242R.string.wallet_amount_error_invalid_user_title);
                resourceManager3 = this.this$0.resourceManager;
                String string4 = resourceManager3.getString(C3242R.string.wallet_amount_error_user_wallet_not_activated_description);
                resourceManager4 = this.this$0.resourceManager;
                viewState2.showErrorDialog(string3, string4, resourceManager4.getString(C3242R.string.wallet_amount_error_invalid_user_btn_txt));
                return;
            }
