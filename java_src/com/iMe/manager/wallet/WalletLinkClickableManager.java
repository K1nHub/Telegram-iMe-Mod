...
public final class WalletLinkClickableManager {
    ...
    private final String[] getUserIdAlertOptions(final long j) {
        ...
        pairArr[0] = this.telegramGateway.hasUser(j) ? TuplesKt.m149to(this.resourceManager.getString(C3632R.string.wallet_user_id_dialog_go_to_profile_action), new Function0<Unit>() { // from class: com.iMe.manager.wallet.WalletLinkClickableManager$getUserIdAlertOptions$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
        ...
        pairArr[1] = TuplesKt.m149to(this.resourceManager.getString(C3632R.string.wallet_user_id_dialog_copy_id_action), new Function0<Unit>() { // from class: com.iMe.manager.wallet.WalletLinkClickableManager$getUserIdAlertOptions$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
    ...
    private final String[] getAddressAlertOptions(final String str) {
        ...
        List<Pair<String, Function0<Unit>>> mutableList;
        int collectionSizeOrDefault;
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(TuplesKt.m149to(this.resourceManager.getString(C3632R.string.wallet_token_details_action_copy_address), new Function0<Unit>() { // from class: com.iMe.manager.wallet.WalletLinkClickableManager$getAddressAlertOptions$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
