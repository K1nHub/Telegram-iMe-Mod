...
public final class C1543xf0d1187c extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ Callbacks$Callback $endAction$inlined;
    final /* synthetic */ WalletCreateManager this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1543xf0d1187c(WalletCreateManager walletCreateManager, Callbacks$Callback callbacks$Callback) {
        super(1);
    ...
    public final void m1260invoke(Result<? extends String> it) {
