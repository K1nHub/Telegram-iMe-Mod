...
public final class C1523x6e1faa35 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ List $notificationInformation$inlined;
    final /* synthetic */ PushNotificationsManager this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1523x6e1faa35(List list, PushNotificationsManager pushNotificationsManager) {
        super(1);
    ...
    public final void m1244invoke(Result<? extends Boolean> it) {
