        ...
        if (true ^ arrayList2.isEmpty()) {
            if (!Intrinsics.areEqual(this.preferenceHelper.getPushToken(), str) || z) {
                ...
                Disposable subscribe = doFinally.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.manager.notifications.PushNotificationsManager$sendPushToken$$inlined$subscribeWithErrorHandle$default$1
                    ...
                    public final void m1534invoke(Result<? extends Boolean> it3) {
        ...
        if (UserUtils.isUserActive(Long.parseLong((String) obj2))) {
            switch (WhenMappings.$EnumSwitchMapping$0[NotificationType.Companion.map(str).ordinal()]) {
                ...
                case 3:
                    ...
                    return (PushNotificationModel) globalGson3.fromJson(globalGson3.toJson(map), new TypeToken<PushNotificationModel.CryptoTransfer.C1534In>() { // from class: com.iMe.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$3
                    }.getType());
                case 4:
                ...
                case 5:
                    ...
                    return (PushNotificationModel) globalGson5.fromJson(globalGson5.toJson(map), new TypeToken<PushNotificationModel.Donation.C1535In>() { // from class: com.iMe.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$5
                    }.getType());
                case 6:
