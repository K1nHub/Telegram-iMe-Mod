...
public final class PushNotificationsManager {
        ...
        if (true ^ arrayList2.isEmpty()) {
            if (!Intrinsics.areEqual(this.preferenceHelper.getPushToken(), str) || z) {
                ...
                Disposable subscribe = doFinally.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new Function1<Result<? extends Boolean>, Unit>() { // from class: com.iMe.manager.notifications.PushNotificationsManager$sendPushToken$$inlined$subscribeWithErrorHandle$default$1
                    ...
                    public final void m1299invoke(Result<? extends Boolean> it3) {
        ...
        if (UserUtils.isUserActive(Long.parseLong((String) obj2))) {
            switch (WhenMappings.$EnumSwitchMapping$0[NotificationType.Companion.map(str).ordinal()]) {
                ...
                case 3:
                    ...
                    return (PushNotificationModel) globalGson3.fromJson(globalGson3.toJson(map), new TypeToken<PushNotificationModel.CryptoTransfer.C1633In>() { // from class: com.iMe.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$3
                    }.getType());
                case 4:
                ...
                case 5:
                    ...
                    return (PushNotificationModel) globalGson5.fromJson(globalGson5.toJson(map), new TypeToken<PushNotificationModel.Donation.C1634In>() { // from class: com.iMe.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$5
                    }.getType());
                case 6:
    ...
    private final void showPushNotification(PushNotificationModel pushNotificationModel) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && from.getNotificationChannel("iMe Messenger") == null) {
            from.createNotificationChannel(new NotificationChannel("iMe Messenger", LocaleController.getString("AppName", C3473R.string.AppName), 3));
        }
        Notification build = new NotificationCompat.Builder(ApplicationLoader.applicationContext, "iMe Messenger").setContentTitle(LocaleController.getString("AppName", C3473R.string.AppName)).setContentText(pushNotificationModel.getMessage()).setSmallIcon(C3473R.C3475drawable.fork_notification).setAutoCancel(true).setGroupSummary(true).setGroup(LocaleController.getInternalString(C3473R.string.drawer_wallet_item_title)).setContentIntent(activity).setColor(ContextCompat.getColor(ApplicationLoader.applicationContext, C3473R.C3474color.fork_color)).setCategory("msg").build();
