...
public final class MediaEditManager$openStickerEditor$1$1 extends PhotoViewer.EmptyPhotoViewerProvider {
    ...
    public void sendButtonPressed(int i, VideoEditedInfo videoEditedInfo, final boolean z, final int i2, boolean z2, final String str, boolean z3) {
        ...
        if (z4) {
            ...
            String internalString = LocaleController.getInternalString(C3630R.string.sticker_edit_send_as);
            listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new String[]{LocaleController.getString("AttachGif", C3630R.string.AttachGif), LocaleController.getString("AttachVideo", C3630R.string.AttachVideo)});
