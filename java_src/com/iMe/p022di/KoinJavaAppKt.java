...
import com.iMe.i_staking.p024di.StakingModuleKt;
import com.iMe.storage.data.p025di.DataComponentKt;
import com.iMe.storage.domain.p028di.DomainComponentKt;
    ...
    public static final void start(final Context context) {
        ...
        DefaultContextExtKt.startKoin(new Function1<KoinApplication, Unit>() { // from class: com.iMe.di.KoinJavaAppKt$start$1
            ...
            public final void invoke2(KoinApplication startKoin) {
                ...
                plus4 = CollectionsKt___CollectionsKt.plus((Collection<? extends Object>) ((Collection) plus3), (Object) StakingModuleKt.getStakingModule());
