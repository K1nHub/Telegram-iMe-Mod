...
public final class TelegramModuleKt {
    private static Module telegramModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C13401 c13401 = new Function2<Scope, ParametersHolder, TelegramApi>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1.1
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(TelegramApi.class), null, c13401, kind, emptyList));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C13412 c13412 = new Function2<Scope, ParametersHolder, TelegramGateway>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            InstanceFactory<?> factoryInstanceFactory = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(TelegramGateway.class), null, c13412, kind2, emptyList2));
            module.indexPrimaryType(factoryInstanceFactory);
            new KoinDefinition(module, factoryInstanceFactory);
            C13423 c13423 = new Function2<Scope, ParametersHolder, TelegramControllersGateway>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            InstanceFactory<?> factoryInstanceFactory2 = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(TelegramControllersGateway.class), null, c13423, kind2, emptyList3));
            module.indexPrimaryType(factoryInstanceFactory2);
            new KoinDefinition(module, factoryInstanceFactory2);
            C13434 c13434 = new Function2<Scope, ParametersHolder, MessageLinkCache>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(MessageLinkCache.class), null, c13434, kind, emptyList4));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C13445 c13445 = new Function2<Scope, ParametersHolder, MultiReplyRepository>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(MultiReplyRepository.class), null, c13445, kind, emptyList5));
            module.indexPrimaryType(singleInstanceFactory3);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory3);
            }
            new KoinDefinition(module, singleInstanceFactory3);
            C13456 c13456 = new Function2<Scope, ParametersHolder, MultiReplyInteractor>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            InstanceFactory<?> factoryInstanceFactory3 = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(MultiReplyInteractor.class), null, c13456, kind2, emptyList6));
            module.indexPrimaryType(factoryInstanceFactory3);
            new KoinDefinition(module, factoryInstanceFactory3);
            C13467 c13467 = new Function2<Scope, ParametersHolder, ContactsInteractor>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1.7
                @Override // kotlin.jvm.functions.Function2
            ...
            InstanceFactory<?> factoryInstanceFactory4 = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier7, Reflection.getOrCreateKotlinClass(ContactsInteractor.class), null, c13467, kind2, emptyList7));
            module.indexPrimaryType(factoryInstanceFactory4);
            new KoinDefinition(module, factoryInstanceFactory4);
            C13478 c13478 = new Function2<Scope, ParametersHolder, SelectedContactsDataStore>() { // from class: com.iMe.di.module.TelegramModuleKt$telegramModule$1.8
                @Override // kotlin.jvm.functions.Function2
            ...
            InstanceFactory<?> factoryInstanceFactory5 = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier8, Reflection.getOrCreateKotlinClass(SelectedContactsDataStore.class), null, c13478, kind2, emptyList8));
