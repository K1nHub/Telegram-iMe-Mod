...
public final class FeatureModuleKt {
    private static Module devToolsFeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1
        ...
        public final void invoke2(Module module) {
            ...
            C11911 c11911 = new Function2<Scope, ParametersHolder, DevViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1.1
            ...
            InstanceFactory<?> factoryInstanceFactory = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(DevViewModel.class), null, c11911, kind, emptyList));
            ...
            C11923 c11923 = new Function2<Scope, ParametersHolder, DevUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(DevUseCase.class), null, c11923, kind2, emptyList3));
    ...
    private static Module socialfeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1
        ...
        public final void invoke2(Module module) {
            ...
            List emptyList6;
            Intrinsics.checkNotNullParameter(module, "$this$module");
            C11951 c11951 = new Function2<Scope, ParametersHolder, AuthViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.1
                @Override // kotlin.jvm.functions.Function2
            ...
            Kind kind = Kind.Factory;
            emptyList = CollectionsKt__CollectionsKt.emptyList();
            InstanceFactory<?> factoryInstanceFactory = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(AuthViewModel.class), null, c11951, kind, emptyList));
            module.indexPrimaryType(factoryInstanceFactory);
            new KoinDefinition(module, factoryInstanceFactory);
            C11962 c11962 = new Function2<Scope, ParametersHolder, SocialWebViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            StringQualifier rootScopeQualifier2 = companion.getRootScopeQualifier();
            emptyList2 = CollectionsKt__CollectionsKt.emptyList();
            InstanceFactory<?> factoryInstanceFactory2 = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(SocialWebViewModel.class), null, c11962, kind, emptyList2));
            module.indexPrimaryType(factoryInstanceFactory2);
            new KoinDefinition(module, factoryInstanceFactory2);
            C11973 c11973 = new Function2<Scope, ParametersHolder, SocialRepository>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            Kind kind2 = Kind.Singleton;
            emptyList3 = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(SocialRepository.class), null, c11973, kind2, emptyList3));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C11984 c11984 = new Function2<Scope, ParametersHolder, AuthUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(AuthUseCase.class), null, c11984, kind2, emptyList4));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C11995 c11995 = new Function2<Scope, ParametersHolder, SocialUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(SocialUseCase.class), null, c11995, kind2, emptyList5));
            module.indexPrimaryType(singleInstanceFactory3);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory3);
            }
            new KoinDefinition(module, singleInstanceFactory3);
            C12006 c12006 = new Function2<Scope, ParametersHolder, GroupMembershipUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory4 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(GroupMembershipUseCase.class), null, c12006, kind2, emptyList6));
    ...
    private static Module profileFeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1
        ...
        public final void invoke2(Module module) {
            ...
            List emptyList2;
            Intrinsics.checkNotNullParameter(module, "$this$module");
            C11931 c11931 = new Function2<Scope, ParametersHolder, ProfileRepository>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1.1
                @Override // kotlin.jvm.functions.Function2
            ...
            emptyList = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(ProfileRepository.class), null, c11931, kind, emptyList));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C11942 c11942 = new Function2<Scope, ParametersHolder, ProfileUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            StringQualifier rootScopeQualifier2 = companion.getRootScopeQualifier();
            emptyList2 = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(ProfileUseCase.class), null, c11942, kind, emptyList2));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
