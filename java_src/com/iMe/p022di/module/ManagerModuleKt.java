...
public final class ManagerModuleKt {
    private static Module presentationManagerModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C12481 c12481 = new Function2<Scope, ParametersHolder, PushNotificationsManager>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1.1
            ...
            FactoryInstanceFactory factoryInstanceFactory = new FactoryInstanceFactory(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(PushNotificationsManager.class), null, c12481, kind, emptyList));
            module.indexPrimaryType(factoryInstanceFactory);
            new KoinDefinition(module, factoryInstanceFactory);
            C12492 c12492 = new Function2<Scope, ParametersHolder, CryptoRecipientManager>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            FactoryInstanceFactory factoryInstanceFactory2 = new FactoryInstanceFactory(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(CryptoRecipientManager.class), null, c12492, kind, emptyList2));
            module.indexPrimaryType(factoryInstanceFactory2);
            new KoinDefinition(module, factoryInstanceFactory2);
            C12503 c12503 = new Function2<Scope, ParametersHolder, BinancePayProcessManager>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            FactoryInstanceFactory factoryInstanceFactory3 = new FactoryInstanceFactory(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(BinancePayProcessManager.class), null, c12503, kind, emptyList3));
            module.indexPrimaryType(factoryInstanceFactory3);
            new KoinDefinition(module, factoryInstanceFactory3);
            C12514 c12514 = new Function2<Scope, ParametersHolder, WalletCreateManager>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            FactoryInstanceFactory factoryInstanceFactory4 = new FactoryInstanceFactory(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(WalletCreateManager.class), null, c12514, kind, emptyList4));
