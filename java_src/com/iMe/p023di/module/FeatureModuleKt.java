...
public final class FeatureModuleKt {
    private static Module devToolsFeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1
        ...
        public final void invoke2(Module module) {
            ...
            C12931 c12931 = new Function2<Scope, ParametersHolder, DevViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1.1
            ...
            C12943 c12943 = new Function2<Scope, ParametersHolder, DevUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1.3
                @Override // kotlin.jvm.functions.Function2
    ...
    private static Module socialfeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1
        ...
        public final void invoke2(Module module) {
            ...
            List emptyList6;
            Intrinsics.checkNotNullParameter(module, "$this$module");
            C12971 c12971 = new Function2<Scope, ParametersHolder, AuthViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.1
                @Override // kotlin.jvm.functions.Function2
            ...
            module.indexPrimaryType(factoryInstanceFactory);
            new KoinDefinition(module, factoryInstanceFactory);
            C12982 c12982 = new Function2<Scope, ParametersHolder, SocialWebViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            C12993 c12993 = new Function2<Scope, ParametersHolder, SocialRepository>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            C13004 c13004 = new Function2<Scope, ParametersHolder, AuthUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            new KoinDefinition(module, singleInstanceFactory2);
            C13015 c13015 = new Function2<Scope, ParametersHolder, SocialUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            C13026 c13026 = new Function2<Scope, ParametersHolder, GroupMembershipUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.6
                @Override // kotlin.jvm.functions.Function2
    ...
    private static Module profileFeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1
        ...
        public final void invoke2(Module module) {
            ...
            List emptyList2;
            Intrinsics.checkNotNullParameter(module, "$this$module");
            C12951 c12951 = new Function2<Scope, ParametersHolder, ProfileRepository>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1.1
                @Override // kotlin.jvm.functions.Function2
            ...
            emptyList = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(ProfileRepository.class), null, c12951, kind, emptyList));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C12962 c12962 = new Function2<Scope, ParametersHolder, ProfileUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            StringQualifier rootScopeQualifier2 = companion.getRootScopeQualifier();
            emptyList2 = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(ProfileUseCase.class), null, c12962, kind, emptyList2));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
