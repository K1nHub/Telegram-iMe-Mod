...
public final class FeatureModuleKt {
    private static Module devToolsFeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1
        ...
        public final void invoke2(Module module) {
            ...
            C12951 c12951 = new Function2<Scope, ParametersHolder, DevViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1.1
            ...
            InstanceFactory<?> factoryInstanceFactory = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(DevViewModel.class), null, c12951, kind, emptyList));
            ...
            C12963 c12963 = new Function2<Scope, ParametersHolder, DevUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$devToolsFeature$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(DevUseCase.class), null, c12963, kind2, emptyList3));
    ...
    private static Module socialfeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1
        ...
        public final void invoke2(Module module) {
            ...
            List emptyList6;
            Intrinsics.checkNotNullParameter(module, "$this$module");
            C12991 c12991 = new Function2<Scope, ParametersHolder, AuthViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.1
                @Override // kotlin.jvm.functions.Function2
            ...
            Kind kind = Kind.Factory;
            emptyList = CollectionsKt__CollectionsKt.emptyList();
            InstanceFactory<?> factoryInstanceFactory = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(AuthViewModel.class), null, c12991, kind, emptyList));
            module.indexPrimaryType(factoryInstanceFactory);
            new KoinDefinition(module, factoryInstanceFactory);
            C13002 c13002 = new Function2<Scope, ParametersHolder, SocialWebViewModel>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            StringQualifier rootScopeQualifier2 = companion.getRootScopeQualifier();
            emptyList2 = CollectionsKt__CollectionsKt.emptyList();
            InstanceFactory<?> factoryInstanceFactory2 = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(SocialWebViewModel.class), null, c13002, kind, emptyList2));
            module.indexPrimaryType(factoryInstanceFactory2);
            new KoinDefinition(module, factoryInstanceFactory2);
            C13013 c13013 = new Function2<Scope, ParametersHolder, SocialRepository>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            Kind kind2 = Kind.Singleton;
            emptyList3 = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(SocialRepository.class), null, c13013, kind2, emptyList3));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C13024 c13024 = new Function2<Scope, ParametersHolder, AuthUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(AuthUseCase.class), null, c13024, kind2, emptyList4));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C13035 c13035 = new Function2<Scope, ParametersHolder, SocialUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(SocialUseCase.class), null, c13035, kind2, emptyList5));
            module.indexPrimaryType(singleInstanceFactory3);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory3);
            }
            new KoinDefinition(module, singleInstanceFactory3);
            C13046 c13046 = new Function2<Scope, ParametersHolder, GroupMembershipUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$socialfeature$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory4 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(GroupMembershipUseCase.class), null, c13046, kind2, emptyList6));
    ...
    private static Module profileFeature = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1
        ...
        public final void invoke2(Module module) {
            ...
            List emptyList2;
            Intrinsics.checkNotNullParameter(module, "$this$module");
            C12971 c12971 = new Function2<Scope, ParametersHolder, ProfileRepository>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1.1
                @Override // kotlin.jvm.functions.Function2
            ...
            emptyList = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(ProfileRepository.class), null, c12971, kind, emptyList));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C12982 c12982 = new Function2<Scope, ParametersHolder, ProfileUseCase>() { // from class: com.iMe.di.module.FeatureModuleKt$profileFeature$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            StringQualifier rootScopeQualifier2 = companion.getRootScopeQualifier();
            emptyList2 = CollectionsKt__CollectionsKt.emptyList();
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(ProfileUseCase.class), null, c12982, kind, emptyList2));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
