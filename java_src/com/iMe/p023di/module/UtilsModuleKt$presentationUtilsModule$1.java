...
final class UtilsModuleKt$presentationUtilsModule$1 extends Lambda implements Function1<Module, Unit> {
    ...
    /* loaded from: classes3.dex */
    public static final class C14051 extends Lambda implements Function2<Scope, ParametersHolder, RxEventBus> {
        public static final C14051 INSTANCE = new C14051();
    ...
    /* loaded from: classes3.dex */
    public static final class C14062 extends Lambda implements Function2<Scope, ParametersHolder, ActionGateway> {
        public static final C14062 INSTANCE = new C14062();
    ...
    public final void invoke2(Module module) {
        ...
        C14051 c14051 = C14051.INSTANCE;
        ScopeRegistry.Companion companion = ScopeRegistry.Companion;
        StringQualifier rootScopeQualifier = companion.getRootScopeQualifier();
        Kind kind = Kind.Singleton;
        emptyList = CollectionsKt__CollectionsKt.emptyList();
        SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(RxEventBus.class), null, c14051, kind, emptyList));
        module.indexPrimaryType(singleInstanceFactory);
        if (module.get_createdAtStart()) {
            module.prepareForCreationAtStart(singleInstanceFactory);
        }
        new KoinDefinition(module, singleInstanceFactory);
        C14062 c14062 = C14062.INSTANCE;
        StringQualifier rootScopeQualifier2 = companion.getRootScopeQualifier();
        emptyList2 = CollectionsKt__CollectionsKt.emptyList();
        SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(ActionGateway.class), null, c14062, kind, emptyList2));
        module.indexPrimaryType(singleInstanceFactory2);
        if (module.get_createdAtStart()) {
            module.prepareForCreationAtStart(singleInstanceFactory2);
        }
        new KoinDefinition(module, singleInstanceFactory2);
        C14073 c14073 = C14073.INSTANCE;
        StringQualifier rootScopeQualifier3 = companion.getRootScopeQualifier();
        emptyList3 = CollectionsKt__CollectionsKt.emptyList();
        SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(CustomPriceValidator.class), null, c14073, kind, emptyList3));
    ...
    /* loaded from: classes3.dex */
    public static final class C14073 extends Lambda implements Function2<Scope, ParametersHolder, CustomPriceValidator> {
        public static final C14073 INSTANCE = new C14073();
