...
public final class NavigationModuleKt {
    ...
    private static Module presentationNavigationModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.NavigationModuleKt$presentationNavigationModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C13511 c13511 = new Function2<Scope, ParametersHolder, NavigationRouter<MvpFragment>>() { // from class: com.iMe.di.module.NavigationModuleKt$presentationNavigationModule$1.1
            ...
            InstanceFactory<?> factoryInstanceFactory = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(NavigationRouter.class), common_bottom_navigator, c13511, kind, emptyList));
            module.indexPrimaryType(factoryInstanceFactory);
            new KoinDefinition(module, factoryInstanceFactory);
            StringQualifier common_tabs_navigator = NavigationModuleKt.getCOMMON_TABS_NAVIGATOR();
            C13522 c13522 = new Function2<Scope, ParametersHolder, NavigationRouter<MvpFragment>>() { // from class: com.iMe.di.module.NavigationModuleKt$presentationNavigationModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            InstanceFactory<?> factoryInstanceFactory2 = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(NavigationRouter.class), common_tabs_navigator, c13522, kind, emptyList2));
            module.indexPrimaryType(factoryInstanceFactory2);
            new KoinDefinition(module, factoryInstanceFactory2);
            StringQualifier wallet_root_navigator = NavigationModuleKt.getWALLET_ROOT_NAVIGATOR();
            C13533 c13533 = new Function2<Scope, ParametersHolder, NavigationRouter<WalletTabFragment>>() { // from class: com.iMe.di.module.NavigationModuleKt$presentationNavigationModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            InstanceFactory<?> factoryInstanceFactory3 = new FactoryInstanceFactory<>(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(NavigationRouter.class), wallet_root_navigator, c13533, kind, emptyList3));
            module.indexPrimaryType(factoryInstanceFactory3);
            new KoinDefinition(module, factoryInstanceFactory3);
            C13544 c13544 = new Function2<Scope, ParametersHolder, WalletFlowCoordinator>() { // from class: com.iMe.di.module.NavigationModuleKt$presentationNavigationModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(WalletFlowCoordinator.class), null, c13544, kind2, emptyList4));
            module.indexPrimaryType(singleInstanceFactory);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory);
            }
            new KoinDefinition(module, singleInstanceFactory);
            C13555 c13555 = new Function2<Scope, ParametersHolder, PinCodeCoordinator>() { // from class: com.iMe.di.module.NavigationModuleKt$presentationNavigationModule$1.5
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory2 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier5, Reflection.getOrCreateKotlinClass(PinCodeCoordinator.class), null, c13555, kind2, emptyList5));
            module.indexPrimaryType(singleInstanceFactory2);
            if (module.get_createdAtStart()) {
                module.prepareForCreationAtStart(singleInstanceFactory2);
            }
            new KoinDefinition(module, singleInstanceFactory2);
            C13566 c13566 = new Function2<Scope, ParametersHolder, TokenBuyCoordinator>() { // from class: com.iMe.di.module.NavigationModuleKt$presentationNavigationModule$1.6
                @Override // kotlin.jvm.functions.Function2
            ...
            SingleInstanceFactory<?> singleInstanceFactory3 = new SingleInstanceFactory<>(new BeanDefinition(rootScopeQualifier6, Reflection.getOrCreateKotlinClass(TokenBuyCoordinator.class), null, c13566, kind2, emptyList6));
