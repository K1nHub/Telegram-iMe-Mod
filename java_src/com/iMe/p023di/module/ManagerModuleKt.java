...
public final class ManagerModuleKt {
    private static Module presentationManagerModule = ModuleDSLKt.module$default(false, new Function1<Module, Unit>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1
        ...
        public final void invoke2(Module module) {
            ...
            C13471 c13471 = new Function2<Scope, ParametersHolder, PushNotificationsManager>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1.1
            ...
            FactoryInstanceFactory factoryInstanceFactory = new FactoryInstanceFactory(new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(PushNotificationsManager.class), null, c13471, kind, emptyList));
            module.indexPrimaryType(factoryInstanceFactory);
            new KoinDefinition(module, factoryInstanceFactory);
            C13482 c13482 = new Function2<Scope, ParametersHolder, CryptoRecipientManager>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1.2
                @Override // kotlin.jvm.functions.Function2
            ...
            FactoryInstanceFactory factoryInstanceFactory2 = new FactoryInstanceFactory(new BeanDefinition(rootScopeQualifier2, Reflection.getOrCreateKotlinClass(CryptoRecipientManager.class), null, c13482, kind, emptyList2));
            module.indexPrimaryType(factoryInstanceFactory2);
            new KoinDefinition(module, factoryInstanceFactory2);
            C13493 c13493 = new Function2<Scope, ParametersHolder, BinancePayProcessManager>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1.3
                @Override // kotlin.jvm.functions.Function2
            ...
            FactoryInstanceFactory factoryInstanceFactory3 = new FactoryInstanceFactory(new BeanDefinition(rootScopeQualifier3, Reflection.getOrCreateKotlinClass(BinancePayProcessManager.class), null, c13493, kind, emptyList3));
            module.indexPrimaryType(factoryInstanceFactory3);
            new KoinDefinition(module, factoryInstanceFactory3);
            C13504 c13504 = new Function2<Scope, ParametersHolder, WalletCreateManager>() { // from class: com.iMe.di.module.ManagerModuleKt$presentationManagerModule$1.4
                @Override // kotlin.jvm.functions.Function2
            ...
            FactoryInstanceFactory factoryInstanceFactory4 = new FactoryInstanceFactory(new BeanDefinition(rootScopeQualifier4, Reflection.getOrCreateKotlinClass(WalletCreateManager.class), null, c13504, kind, emptyList4));
