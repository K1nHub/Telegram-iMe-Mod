...
public final class CardButtonItem extends NoChildNode {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CardButtonItem) {
            ...
            return this.f280id == cardButtonItem.f280id && this.icon == cardButtonItem.icon && this.titleResId == cardButtonItem.titleResId;
        }
        return false;
    }

    public int hashCode() {
        return (((this.f280id * 31) + this.icon) * 31) + this.titleResId;
    }

    public String toString() {
        return "CardButtonItem(id=" + this.f280id + ", icon=" + this.icon + ", titleResId=" + this.titleResId + ')';
    }
