...
public final class SelectableHeaderItem extends NoChildNode {
    ...
    public String toString() {
        return "SelectableHeaderItem(id=" + this.f302id + ", icon=" + this.icon + ", titleResId=" + this.titleResId + ", options=" + this.options + ", onSelected=" + this.onSelected + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(SelectableHeaderItem.class, obj != null ? obj.getClass() : null)) {
            ...
            return this.f302id == selectableHeaderItem.f302id && this.icon == selectableHeaderItem.icon && this.titleResId == selectableHeaderItem.titleResId && Intrinsics.areEqual(this.options, selectableHeaderItem.options);
        }
        return false;
    }

    public int hashCode() {
        return Objects.hash(Integer.valueOf(this.f302id), Integer.valueOf(this.icon), Integer.valueOf(this.titleResId), this.options);
    }
}
