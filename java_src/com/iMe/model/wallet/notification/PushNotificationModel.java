...
public abstract class PushNotificationModel {
    ...
    public String mo1540getUserId() {
        return this.userId;
    }

    /* renamed from: getType  reason: collision with other method in class */
    public String mo1539getType() {
        return this.type;
    }

    public long getUserId() {
        return Long.parseLong(mo1540getUserId());
    }

    public NotificationType getType() {
        return NotificationType.Companion.map(mo1539getType());
    }
    ...
    public static final class Unsupported extends PushNotificationModel {
        ...
        public static /* synthetic */ Unsupported copy$default(Unsupported unsupported, String str, String str2, int i, Object obj) {
            if ((i & 1) != 0) {
                str = unsupported.mo1540getUserId();
            }
            if ((i & 2) != 0) {
                str2 = unsupported.mo1539getType();
            }
            return unsupported.copy(str, str2);
        }

        public final String component1() {
            return mo1540getUserId();
        }

        public final String component2() {
            return mo1539getType();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Unsupported) {
                ...
                return Intrinsics.areEqual(mo1540getUserId(), unsupported.mo1540getUserId()) && Intrinsics.areEqual(mo1539getType(), unsupported.mo1539getType());
            }
            return false;
        }

        public int hashCode() {
            return (mo1540getUserId().hashCode() * 31) + mo1539getType().hashCode();
        }

        public String toString() {
            return "Unsupported(userId=" + mo1540getUserId() + ", type=" + mo1539getType() + ')';
        }
    ...
    public static final class Simplex extends PushNotificationModel {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Simplex) {
                ...
                return Intrinsics.areEqual(mo1540getUserId(), simplex.mo1540getUserId()) && Intrinsics.areEqual(mo1539getType(), simplex.mo1539getType()) && Intrinsics.areEqual(this.status, simplex.status) && Intrinsics.areEqual(this.cryptoCode, simplex.cryptoCode) && Intrinsics.areEqual(this.toWalletAddress, simplex.toWalletAddress) && Intrinsics.areEqual(this.amount, simplex.amount) && Intrinsics.areEqual(this.spentCurrency, simplex.spentCurrency) && Intrinsics.areEqual(this.amountToSpent, simplex.amountToSpent);
            }
            return false;
        }

        public int hashCode() {
            return (((((((((((((mo1540getUserId().hashCode() * 31) + mo1539getType().hashCode()) * 31) + this.status.hashCode()) * 31) + this.cryptoCode.hashCode()) * 31) + this.toWalletAddress.hashCode()) * 31) + this.amount.hashCode()) * 31) + this.spentCurrency.hashCode()) * 31) + this.amountToSpent.hashCode();
        }

        public String toString() {
            return "Simplex(userId=" + mo1540getUserId() + ", type=" + mo1539getType() + ", status=" + this.status + ", cryptoCode=" + this.cryptoCode + ", toWalletAddress=" + this.toWalletAddress + ", amount=" + this.amount + ", spentCurrency=" + this.spentCurrency + ", amountToSpent=" + this.amountToSpent + ')';
        }
    ...
    public static final class BinancePayRequestCreated extends PushNotificationModel {
        ...
        public static /* synthetic */ BinancePayRequestCreated copy$default(BinancePayRequestCreated binancePayRequestCreated, String str, String str2, String str3, String str4, String str5, String str6, int i, Object obj) {
            if ((i & 1) != 0) {
                str = binancePayRequestCreated.mo1539getType();
            }
            if ((i & 2) != 0) {
                str2 = binancePayRequestCreated.mo1540getUserId();
            }
            String str7 = str2;
            if ((i & 4) != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof BinancePayRequestCreated) {
                ...
                return Intrinsics.areEqual(mo1539getType(), binancePayRequestCreated.mo1539getType()) && Intrinsics.areEqual(mo1540getUserId(), binancePayRequestCreated.mo1540getUserId()) && Intrinsics.areEqual(this.amount, binancePayRequestCreated.amount) && Intrinsics.areEqual(this.assetCode, binancePayRequestCreated.assetCode) && Intrinsics.areEqual(this.assetName, binancePayRequestCreated.assetName) && Intrinsics.areEqual(this.payerUserId, binancePayRequestCreated.payerUserId);
            }
            return false;
        }

        public int hashCode() {
            return (((((((((mo1539getType().hashCode() * 31) + mo1540getUserId().hashCode()) * 31) + this.amount.hashCode()) * 31) + this.assetCode.hashCode()) * 31) + this.assetName.hashCode()) * 31) + this.payerUserId.hashCode();
        }

        public String toString() {
            return "BinancePayRequestCreated(type=" + mo1539getType() + ", userId=" + mo1540getUserId() + ", amount=" + this.amount + ", assetCode=" + this.assetCode + ", assetName=" + this.assetName + ", payerUserId=" + this.payerUserId + ')';
        }
        ...
        @Override // com.iMe.model.wallet.notification.PushNotificationModel
        public String getMessage() {
            return getString$TMessagesProj_HA_public(C3632R.string.push_notification_wallet_binance_pay_request_created_description, BalanceFormatter.format(Double.valueOf(Double.parseDouble(this.amount)), Integer.valueOf(TokenDetailed.Companion.getBNB().getDecimals())), this.assetCode, mo1540getUserId());
        }
    }
    ...
    public static final class BinancePayRequestStatusUpdated extends PushNotificationModel {
        ...
        public static /* synthetic */ BinancePayRequestStatusUpdated copy$default(BinancePayRequestStatusUpdated binancePayRequestStatusUpdated, String str, String str2, String str3, String str4, String str5, String str6, String str7, int i, Object obj) {
            if ((i & 1) != 0) {
                str = binancePayRequestStatusUpdated.mo1539getType();
            }
            if ((i & 2) != 0) {
                str2 = binancePayRequestStatusUpdated.mo1540getUserId();
            }
            String str8 = str2;
            if ((i & 4) != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof BinancePayRequestStatusUpdated) {
                ...
                return Intrinsics.areEqual(mo1539getType(), binancePayRequestStatusUpdated.mo1539getType()) && Intrinsics.areEqual(mo1540getUserId(), binancePayRequestStatusUpdated.mo1540getUserId()) && Intrinsics.areEqual(this.amount, binancePayRequestStatusUpdated.amount) && Intrinsics.areEqual(this.assetCode, binancePayRequestStatusUpdated.assetCode) && Intrinsics.areEqual(this.assetName, binancePayRequestStatusUpdated.assetName) && Intrinsics.areEqual(this.payerUserId, binancePayRequestStatusUpdated.payerUserId) && Intrinsics.areEqual(this.status, binancePayRequestStatusUpdated.status);
            }
            return false;
        }

        public int hashCode() {
            return (((((((((((mo1539getType().hashCode() * 31) + mo1540getUserId().hashCode()) * 31) + this.amount.hashCode()) * 31) + this.assetCode.hashCode()) * 31) + this.assetName.hashCode()) * 31) + this.payerUserId.hashCode()) * 31) + this.status.hashCode();
        }

        public String toString() {
            return "BinancePayRequestStatusUpdated(type=" + mo1539getType() + ", userId=" + mo1540getUserId() + ", amount=" + this.amount + ", assetCode=" + this.assetCode + ", assetName=" + this.assetName + ", payerUserId=" + this.payerUserId + ", status=" + this.status + ')';
        }
    ...
    public static final class StakingSafeWithdrawalStarted extends PushNotificationModel {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof StakingSafeWithdrawalStarted) {
                ...
                return Intrinsics.areEqual(mo1539getType(), stakingSafeWithdrawalStarted.mo1539getType()) && Intrinsics.areEqual(mo1540getUserId(), stakingSafeWithdrawalStarted.mo1540getUserId()) && Intrinsics.areEqual(this.networkId, stakingSafeWithdrawalStarted.networkId) && Intrinsics.areEqual(this.stakingId, stakingSafeWithdrawalStarted.stakingId) && Intrinsics.areEqual(this.stakingName, stakingSafeWithdrawalStarted.stakingName) && Intrinsics.areEqual(this.stakingToken, stakingSafeWithdrawalStarted.stakingToken) && Intrinsics.areEqual(this.amount, stakingSafeWithdrawalStarted.amount) && Intrinsics.areEqual(this.shouldFinishAt, stakingSafeWithdrawalStarted.shouldFinishAt);
            }
            return false;
        }

        public int hashCode() {
            return (((((((((((((mo1539getType().hashCode() * 31) + mo1540getUserId().hashCode()) * 31) + this.networkId.hashCode()) * 31) + this.stakingId.hashCode()) * 31) + this.stakingName.hashCode()) * 31) + this.stakingToken.hashCode()) * 31) + this.amount.hashCode()) * 31) + this.shouldFinishAt.hashCode();
        }

        public String toString() {
            return "StakingSafeWithdrawalStarted(type=" + mo1539getType() + ", userId=" + mo1540getUserId() + ", networkId=" + this.networkId + ", stakingId=" + this.stakingId + ", stakingName=" + this.stakingName + ", stakingToken=" + this.stakingToken + ", amount=" + this.amount + ", shouldFinishAt=" + this.shouldFinishAt + ')';
        }
    ...
    public static final class StakingSafeWithdrawalFinished extends PushNotificationModel {
        ...
        public static /* synthetic */ StakingSafeWithdrawalFinished copy$default(StakingSafeWithdrawalFinished stakingSafeWithdrawalFinished, String str, String str2, String str3, String str4, String str5, String str6, String str7, int i, Object obj) {
            if ((i & 1) != 0) {
                str = stakingSafeWithdrawalFinished.mo1539getType();
            }
            if ((i & 2) != 0) {
                str2 = stakingSafeWithdrawalFinished.mo1540getUserId();
            }
            String str8 = str2;
            if ((i & 4) != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof StakingSafeWithdrawalFinished) {
                ...
                return Intrinsics.areEqual(mo1539getType(), stakingSafeWithdrawalFinished.mo1539getType()) && Intrinsics.areEqual(mo1540getUserId(), stakingSafeWithdrawalFinished.mo1540getUserId()) && Intrinsics.areEqual(this.networkId, stakingSafeWithdrawalFinished.networkId) && Intrinsics.areEqual(this.stakingId, stakingSafeWithdrawalFinished.stakingId) && Intrinsics.areEqual(this.stakingName, stakingSafeWithdrawalFinished.stakingName) && Intrinsics.areEqual(this.stakingToken, stakingSafeWithdrawalFinished.stakingToken) && Intrinsics.areEqual(this.amount, stakingSafeWithdrawalFinished.amount);
            }
            return false;
        }

        public int hashCode() {
            return (((((((((((mo1539getType().hashCode() * 31) + mo1540getUserId().hashCode()) * 31) + this.networkId.hashCode()) * 31) + this.stakingId.hashCode()) * 31) + this.stakingName.hashCode()) * 31) + this.stakingToken.hashCode()) * 31) + this.amount.hashCode();
        }

        public String toString() {
            return "StakingSafeWithdrawalFinished(type=" + mo1539getType() + ", userId=" + mo1540getUserId() + ", networkId=" + this.networkId + ", stakingId=" + this.stakingId + ", stakingName=" + this.stakingName + ", stakingToken=" + this.stakingToken + ", amount=" + this.amount + ')';
        }
    ...
    public static final class StakingFinished extends PushNotificationModel {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof StakingFinished) {
                ...
                return Intrinsics.areEqual(mo1539getType(), stakingFinished.mo1539getType()) && Intrinsics.areEqual(mo1540getUserId(), stakingFinished.mo1540getUserId()) && Intrinsics.areEqual(this.networkId, stakingFinished.networkId) && Intrinsics.areEqual(this.stakingId, stakingFinished.stakingId) && Intrinsics.areEqual(this.stakingName, stakingFinished.stakingName) && Intrinsics.areEqual(this.stakingToken, stakingFinished.stakingToken) && Intrinsics.areEqual(this.debtAsToken, stakingFinished.debtAsToken) && Intrinsics.areEqual(this.debtAsUsd, stakingFinished.debtAsUsd) && Intrinsics.areEqual(this.profitAsToken, stakingFinished.profitAsToken) && Intrinsics.areEqual(this.profitAsUsd, stakingFinished.profitAsUsd);
            }
            return false;
        }

        public int hashCode() {
            return (((((((((((((((((mo1539getType().hashCode() * 31) + mo1540getUserId().hashCode()) * 31) + this.networkId.hashCode()) * 31) + this.stakingId.hashCode()) * 31) + this.stakingName.hashCode()) * 31) + this.stakingToken.hashCode()) * 31) + this.debtAsToken.hashCode()) * 31) + this.debtAsUsd.hashCode()) * 31) + this.profitAsToken.hashCode()) * 31) + this.profitAsUsd.hashCode();
        }

        public String toString() {
            return "StakingFinished(type=" + mo1539getType() + ", userId=" + mo1540getUserId() + ", networkId=" + this.networkId + ", stakingId=" + this.stakingId + ", stakingName=" + this.stakingName + ", stakingToken=" + this.stakingToken + ", debtAsToken=" + this.debtAsToken + ", debtAsUsd=" + this.debtAsUsd + ", profitAsToken=" + this.profitAsToken + ", profitAsUsd=" + this.profitAsUsd + ')';
        }
    ...
    public static final class Cancel extends CryptoTransfer {
        ...
        public static /* synthetic */ Cancel copy$default(Cancel cancel, String str, String str2, String str3, String str4, int i, Object obj) {
            if ((i & 1) != 0) {
                str = cancel.mo1540getUserId();
            }
            if ((i & 2) != 0) {
                str2 = cancel.mo1539getType();
            }
            if ((i & 4) != 0) {
                str3 = cancel.status;
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Cancel) {
                ...
                return Intrinsics.areEqual(mo1540getUserId(), cancel.mo1540getUserId()) && Intrinsics.areEqual(mo1539getType(), cancel.mo1539getType()) && Intrinsics.areEqual(this.status, cancel.status) && Intrinsics.areEqual(this.txHash, cancel.txHash);
            }
            return false;
        }

        public int hashCode() {
            return (((((mo1540getUserId().hashCode() * 31) + mo1539getType().hashCode()) * 31) + this.status.hashCode()) * 31) + this.txHash.hashCode();
        }

        public String toString() {
            return "Cancel(userId=" + mo1540getUserId() + ", type=" + mo1539getType() + ", status=" + this.status + ", txHash=" + this.txHash + ')';
        }
    ...
    public static final class Approve extends CryptoTransfer {
        ...
        public static /* synthetic */ Approve copy$default(Approve approve, String str, String str2, String str3, String str4, String str5, int i, Object obj) {
            if ((i & 1) != 0) {
                str = approve.mo1540getUserId();
            }
            if ((i & 2) != 0) {
                str2 = approve.mo1539getType();
            }
            String str6 = str2;
            if ((i & 4) != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Approve) {
                ...
                return Intrinsics.areEqual(mo1540getUserId(), approve.mo1540getUserId()) && Intrinsics.areEqual(mo1539getType(), approve.mo1539getType()) && Intrinsics.areEqual(this.cryptoCode, approve.cryptoCode) && Intrinsics.areEqual(this.status, approve.status) && Intrinsics.areEqual(this.txHash, approve.txHash);
            }
            return false;
        }

        public int hashCode() {
            return (((((((mo1540getUserId().hashCode() * 31) + mo1539getType().hashCode()) * 31) + this.cryptoCode.hashCode()) * 31) + this.status.hashCode()) * 31) + this.txHash.hashCode();
        }

        public String toString() {
            return "Approve(userId=" + mo1540getUserId() + ", type=" + mo1539getType() + ", cryptoCode=" + this.cryptoCode + ", status=" + this.status + ", txHash=" + this.txHash + ')';
        }
    ...
    public static abstract class CryptoTransfer extends PushNotificationModel {
        ...
        /* loaded from: classes3.dex */
        public static final class C1534In extends CryptoTransfer {
            private final String amount;
            private final String cryptoCode;
            ...
            public static /* synthetic */ C1534In copy$default(C1534In c1534In, String str, String str2, String str3, String str4, String str5, String str6, int i, Object obj) {
                if ((i & 1) != 0) {
                    str = c1534In.mo1540getUserId();
                }
                if ((i & 2) != 0) {
                    str2 = c1534In.mo1539getType();
                }
                String str7 = str2;
                if ((i & 4) != 0) {
                    str3 = c1534In.cryptoCode;
                }
                String str8 = str3;
                if ((i & 8) != 0) {
                    str4 = c1534In.fromWalletAddress;
                }
                String str9 = str4;
                if ((i & 16) != 0) {
                    str5 = c1534In.toWalletAddress;
                }
                String str10 = str5;
                if ((i & 32) != 0) {
                    str6 = c1534In.amount;
                }
                return c1534In.copy(str, str7, str8, str9, str10, str6);
            }
            ...
            public final C1534In copy(String userId, String type, String cryptoCode, String fromWalletAddress, String toWalletAddress, String amount) {
                Intrinsics.checkNotNullParameter(userId, "userId");
                Intrinsics.checkNotNullParameter(type, "type");
                Intrinsics.checkNotNullParameter(cryptoCode, "cryptoCode");
                ...
                Intrinsics.checkNotNullParameter(toWalletAddress, "toWalletAddress");
                Intrinsics.checkNotNullParameter(amount, "amount");
                return new C1534In(userId, type, cryptoCode, fromWalletAddress, toWalletAddress, amount);
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof C1534In) {
                    C1534In c1534In = (C1534In) obj;
                    return Intrinsics.areEqual(mo1540getUserId(), c1534In.mo1540getUserId()) && Intrinsics.areEqual(mo1539getType(), c1534In.mo1539getType()) && Intrinsics.areEqual(this.cryptoCode, c1534In.cryptoCode) && Intrinsics.areEqual(this.fromWalletAddress, c1534In.fromWalletAddress) && Intrinsics.areEqual(this.toWalletAddress, c1534In.toWalletAddress) && Intrinsics.areEqual(this.amount, c1534In.amount);
                }
                return false;
            }

            public int hashCode() {
                return (((((((((mo1540getUserId().hashCode() * 31) + mo1539getType().hashCode()) * 31) + this.cryptoCode.hashCode()) * 31) + this.fromWalletAddress.hashCode()) * 31) + this.toWalletAddress.hashCode()) * 31) + this.amount.hashCode();
            }

            public String toString() {
                return "In(userId=" + mo1540getUserId() + ", type=" + mo1539getType() + ", cryptoCode=" + this.cryptoCode + ", fromWalletAddress=" + this.fromWalletAddress + ", toWalletAddress=" + this.toWalletAddress + ", amount=" + this.amount + ')';
            }
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C1534In(String userId, String type, String cryptoCode, String fromWalletAddress, String toWalletAddress, String amount) {
                super(userId, type);
                Intrinsics.checkNotNullParameter(userId, "userId");
                Intrinsics.checkNotNullParameter(type, "type");
                Intrinsics.checkNotNullParameter(cryptoCode, "cryptoCode");
        ...
        public static final class Out extends CryptoTransfer {
            ...
            public static /* synthetic */ Out copy$default(Out out, String str, String str2, String str3, String str4, String str5, String str6, String str7, int i, Object obj) {
                if ((i & 1) != 0) {
                    str = out.mo1540getUserId();
                }
                if ((i & 2) != 0) {
                    str2 = out.mo1539getType();
                }
                String str8 = str2;
                if ((i & 4) != 0) {
                    str3 = out.status;
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof Out) {
                    Out out = (Out) obj;
                    return Intrinsics.areEqual(mo1540getUserId(), out.mo1540getUserId()) && Intrinsics.areEqual(mo1539getType(), out.mo1539getType()) && Intrinsics.areEqual(this.status, out.status) && Intrinsics.areEqual(this.cryptoCode, out.cryptoCode) && Intrinsics.areEqual(this.fromWalletAddress, out.fromWalletAddress) && Intrinsics.areEqual(this.toWalletAddress, out.toWalletAddress) && Intrinsics.areEqual(this.amount, out.amount);
                }
                return false;
            }

            public int hashCode() {
                return (((((((((((mo1540getUserId().hashCode() * 31) + mo1539getType().hashCode()) * 31) + this.status.hashCode()) * 31) + this.cryptoCode.hashCode()) * 31) + this.fromWalletAddress.hashCode()) * 31) + this.toWalletAddress.hashCode()) * 31) + this.amount.hashCode();
            }

            public String toString() {
                return "Out(userId=" + mo1540getUserId() + ", type=" + mo1539getType() + ", status=" + this.status + ", cryptoCode=" + this.cryptoCode + ", fromWalletAddress=" + this.fromWalletAddress + ", toWalletAddress=" + this.toWalletAddress + ", amount=" + this.amount + ')';
            }
    ...
    public static abstract class Donation extends PushNotificationModel {
        ...
        /* loaded from: classes3.dex */
        public static final class C1535In extends CryptoTransfer {
            private final String amount;
            private final String cryptoCode;
            private final String fromWalletAddress;
            private final String toWalletAddress;
            ...
            public static /* synthetic */ C1535In copy$default(C1535In c1535In, String str, String str2, String str3, String str4, String str5, String str6, int i, Object obj) {
                if ((i & 1) != 0) {
                    str = c1535In.mo1540getUserId();
                }
                if ((i & 2) != 0) {
                    str2 = c1535In.mo1539getType();
                }
                String str7 = str2;
                if ((i & 4) != 0) {
                    str3 = c1535In.cryptoCode;
                }
                String str8 = str3;
                if ((i & 8) != 0) {
                    str4 = c1535In.fromWalletAddress;
                }
                String str9 = str4;
                if ((i & 16) != 0) {
                    str5 = c1535In.toWalletAddress;
                }
                String str10 = str5;
                if ((i & 32) != 0) {
                    str6 = c1535In.amount;
                }
                return c1535In.copy(str, str7, str8, str9, str10, str6);
            }
            ...
            public final C1535In copy(String userId, String type, String cryptoCode, String fromWalletAddress, String toWalletAddress, String amount) {
                Intrinsics.checkNotNullParameter(userId, "userId");
                Intrinsics.checkNotNullParameter(type, "type");
                Intrinsics.checkNotNullParameter(cryptoCode, "cryptoCode");
                Intrinsics.checkNotNullParameter(fromWalletAddress, "fromWalletAddress");
                Intrinsics.checkNotNullParameter(toWalletAddress, "toWalletAddress");
                Intrinsics.checkNotNullParameter(amount, "amount");
                return new C1535In(userId, type, cryptoCode, fromWalletAddress, toWalletAddress, amount);
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof C1535In) {
                    C1535In c1535In = (C1535In) obj;
                    return Intrinsics.areEqual(mo1540getUserId(), c1535In.mo1540getUserId()) && Intrinsics.areEqual(mo1539getType(), c1535In.mo1539getType()) && Intrinsics.areEqual(this.cryptoCode, c1535In.cryptoCode) && Intrinsics.areEqual(this.fromWalletAddress, c1535In.fromWalletAddress) && Intrinsics.areEqual(this.toWalletAddress, c1535In.toWalletAddress) && Intrinsics.areEqual(this.amount, c1535In.amount);
                }
                return false;
            }
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C1535In(String userId, String type, String cryptoCode, String fromWalletAddress, String toWalletAddress, String amount) {
                super(userId, type);
                Intrinsics.checkNotNullParameter(userId, "userId");
                Intrinsics.checkNotNullParameter(type, "type");
                Intrinsics.checkNotNullParameter(cryptoCode, "cryptoCode");
