...
public final class NotificationItem implements ClickableItem {
    ...
    public String getLinkedText() {
        ...
        return notification instanceof Notification.CryptoTransfer.C2041In ? ((Notification.CryptoTransfer.C2041In) notification).getFromAddress() : notification instanceof Notification.CryptoTransfer.Out ? ((Notification.CryptoTransfer.Out) notification).getToAddress() : notification instanceof Notification.Donation.C2042In ? ((Notification.Donation.C2042In) notification).getFromAddress() : notification instanceof Notification.Donation.Out ? ((Notification.Donation.Out) notification).getToAddress() : "";
    }
