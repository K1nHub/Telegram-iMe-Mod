...
public final class NotificationItem implements ClickableItem {
    ...
    public String getLinkedText() {
        ...
        return notification instanceof Notification.CryptoTransfer.C1958In ? ((Notification.CryptoTransfer.C1958In) notification).getFromAddress() : notification instanceof Notification.CryptoTransfer.Out ? ((Notification.CryptoTransfer.Out) notification).getToAddress() : notification instanceof Notification.Donation.C1959In ? ((Notification.Donation.C1959In) notification).getFromAddress() : notification instanceof Notification.Donation.Out ? ((Notification.Donation.Out) notification).getToAddress() : "";
    }
