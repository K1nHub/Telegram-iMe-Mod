...
public abstract class TonFragmentItem extends NoChildNode {
    ...
    /* loaded from: classes3.dex */
    public static final class C1533Premium extends TonFragmentItem {
        ...
        public final C1533Premium copy(double d, String priceText, String fiatPrice, int i, String discount, boolean z) {
            Intrinsics.checkNotNullParameter(priceText, "priceText");
            Intrinsics.checkNotNullParameter(fiatPrice, "fiatPrice");
            Intrinsics.checkNotNullParameter(discount, "discount");
            return new C1533Premium(d, priceText, fiatPrice, i, discount, z);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof C1533Premium) {
                C1533Premium c1533Premium = (C1533Premium) obj;
                return Double.compare(this.price, c1533Premium.price) == 0 && Intrinsics.areEqual(this.priceText, c1533Premium.priceText) && Intrinsics.areEqual(this.fiatPrice, c1533Premium.fiatPrice) && this.monthsCount == c1533Premium.monthsCount && Intrinsics.areEqual(this.discount, c1533Premium.discount) && this.isChecked == c1533Premium.isChecked;
            }
            return false;
        }
        ...
        public int hashCode() {
            int m1015m = ((((((((StakingDetailedMetadataResponse$$ExternalSyntheticBackport0.m1015m(this.price) * 31) + this.priceText.hashCode()) * 31) + this.fiatPrice.hashCode()) * 31) + this.monthsCount) * 31) + this.discount.hashCode()) * 31;
        ...
        */
        public C1533Premium(double r3, java.lang.String r5, java.lang.String r6, int r7, java.lang.String r8, boolean r9) {
            /*
                r2 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.iMe.model.wallet.fragment.TonFragmentItem.C1533Premium.<init>(double, java.lang.String, java.lang.String, int, java.lang.String, boolean):void");
        }
    }
