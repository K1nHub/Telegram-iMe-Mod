...
public abstract class SelectableToken implements Parcelable {
    ...
    public static abstract class WithLogoUrl extends SelectableToken {
        ...
        @Override // com.iMe.model.wallet.select.SelectableToken
        public String getId() {
            return this.f287id;
        }
        ...
        public static final class Binance extends WithLogoUrl {
            ...
            public void writeToParcel(Parcel out, int i) {
                ...
                out.writeString(this.f288id);
                out.writeString(this.ticker);
                out.writeString(this.name);
                out.writeString(this.logoUrl);
            }

            @Override // com.iMe.model.wallet.select.SelectableToken.WithLogoUrl, com.iMe.model.wallet.select.SelectableToken
            public String getId() {
                return this.f288id;
            }
            ...
            @Override // com.iMe.model.wallet.select.SelectableToken.WithLogoUrl
            public String getLogoUrl() {
                return this.logoUrl;
            }
