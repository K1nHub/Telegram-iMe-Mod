...
public abstract class TransactionsGroup {
    ...
    public static final class All extends TransactionsGroup {
        ...
        private All() {
            super(C3632R.C3635id.wallet_token_details_transactions_all, C3632R.string.wallet_token_details_transactions_all, null);
        }
    }
    ...
    public static final class Incoming extends TransactionsGroup {
        ...
        private Incoming() {
            super(C3632R.C3635id.wallet_token_details_transactions_incoming, C3632R.string.wallet_token_details_transactions_incoming, null);
        }

        @Override // com.iMe.model.wallet.details.TransactionsGroup
        public boolean checkTransaction(Transaction transaction) {
            Intrinsics.checkNotNullParameter(transaction, "transaction");
            return transaction.getDirection() == TransactionDirection.f392IN && ((transaction instanceof Transaction.Transfer) || (transaction instanceof Transaction.Unsupported) || (transaction instanceof Transaction.Crypto.Transfer) || (transaction instanceof Transaction.Refund));
        }
    }
    ...
    public static final class Outgoing extends TransactionsGroup {
        ...
        private Outgoing() {
            super(C3632R.C3635id.wallet_token_details_transactions_outgoing, C3632R.string.wallet_token_details_transactions_outgoing, null);
        }
    ...
    public static final class Swap extends TransactionsGroup {
        ...
        private Swap() {
            super(C3632R.C3635id.wallet_token_details_transactions_swap, C3632R.string.wallet_token_details_transactions_swap, null);
        }
