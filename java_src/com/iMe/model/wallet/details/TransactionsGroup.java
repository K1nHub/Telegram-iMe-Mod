...
public abstract class TransactionsGroup {
    ...
    public static final class All extends TransactionsGroup {
        ...
        private All() {
            super(C3558R.C3561id.wallet_token_details_transactions_all, C3558R.string.wallet_token_details_transactions_all, null);
        }
    }
    ...
    public static final class Incoming extends TransactionsGroup {
        ...
        private Incoming() {
            super(C3558R.C3561id.wallet_token_details_transactions_incoming, C3558R.string.wallet_token_details_transactions_incoming, null);
        }
    ...
    public static final class Outgoing extends TransactionsGroup {
        ...
        private Outgoing() {
            super(C3558R.C3561id.wallet_token_details_transactions_outgoing, C3558R.string.wallet_token_details_transactions_outgoing, null);
        }
    ...
    public static final class Swap extends TransactionsGroup {
        ...
        private Swap() {
            super(C3558R.C3561id.wallet_token_details_transactions_swap, C3558R.string.wallet_token_details_transactions_swap, null);
        }
