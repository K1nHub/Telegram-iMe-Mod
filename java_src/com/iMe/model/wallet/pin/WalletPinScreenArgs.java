...
public final class WalletPinScreenArgs {
    ...
    private final Wallet f2195wallet;
    ...
    public static /* synthetic */ WalletPinScreenArgs copy$default(WalletPinScreenArgs walletPinScreenArgs, String str, String str2, Wallet wallet2, CreatePinCodeScreenType createPinCodeScreenType, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            wallet2 = walletPinScreenArgs.f2195wallet;
        }
        if ((i & 8) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WalletPinScreenArgs) {
            ...
            return Intrinsics.areEqual(this.password, walletPinScreenArgs.password) && Intrinsics.areEqual(this.seed, walletPinScreenArgs.seed) && Intrinsics.areEqual(this.f2195wallet, walletPinScreenArgs.f2195wallet) && Intrinsics.areEqual(this.screenType, walletPinScreenArgs.screenType);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        Wallet wallet2 = this.f2195wallet;
        return ((hashCode + (wallet2 == null ? 0 : wallet2.hashCode())) * 31) + this.screenType.hashCode();
    }

    public String toString() {
        return "WalletPinScreenArgs(password=" + this.password + ", seed=" + this.seed + ", wallet=" + this.f2195wallet + ", screenType=" + this.screenType + ')';
    }
