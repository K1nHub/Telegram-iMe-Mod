...
public final class GasPriceItem implements DialogChooseItem {
    ...
    public String getTitle(ResourceManager resourceManager) {
        ...
        return resourceManager.getString(C3419R.string.wallet_amount_send_fee_title, resourceManager.getString(this.speedLevel.getTitle()), Integer.valueOf(this.info.getDuration()));
    }

    @Override // com.iMe.model.common.DialogChooseItem
    public String getValue(ResourceManager resourceManager) {
        Intrinsics.checkNotNullParameter(resourceManager, "resourceManager");
        return resourceManager.getString(C3419R.string.wallet_amount_send_fee_value, BalanceFormatter.formatBalance(Double.valueOf(this.info.getFee()), Integer.valueOf(this.feeToken.getDecimals())), this.feeToken.getTicker(), BalanceFormatter.formatBalance(Double.valueOf(this.info.getFeeInFiat().getValue()), Integer.valueOf(TokenDetailed.Companion.getUSD().getDecimals())), this.info.getFeeInFiat().getSymbol());
    }
}
