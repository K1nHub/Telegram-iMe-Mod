...
public abstract class WalletSettingsItem {
    ...
    public static final class Main {
        ...
        public static final class CryptoAccount extends WalletSettingsItem {
            ...
            private CryptoAccount() {
                super(C3630R.C3632drawable.msg_openprofile, C3630R.string.wallet_settings_eth_account_title, null, null);
            }
        }
        ...
        public static final class Interface extends WalletSettingsItem {
            ...
            private Interface() {
                super(C3630R.C3632drawable.fork_interface_settings, C3630R.string.wallet_settings_interface_title, null, null);
            }
        }
        ...
        public static final class Help extends WalletSettingsItem {
            ...
            private Help() {
                super(C3630R.C3632drawable.msg_help, C3630R.string.wallet_settings_help_title, null, null);
            }
        }
    ...
    public static final class CryptoAccount {
        ...
        public static final class Blockchains extends WalletSettingsItem {
            ...
            private Blockchains() {
                super(C3630R.C3632drawable.fork_ic_blockchain, C3630R.string.wallet_crypto_blockchains_title, Integer.valueOf(C3630R.string.wallet_crypto_blockchains_item_description), null);
            }
        }
        ...
        public static final class Privacy extends WalletSettingsItem {
            ...
            private Privacy() {
                super(C3630R.C3632drawable.fork_ic_crypto_privacy, C3630R.string.wallet_crypto_privacy_toolbar_title, Integer.valueOf(C3630R.string.wallet_crypto_privacy_item_description), null);
            }
        }
        ...
        public static final class WalletConnect extends WalletSettingsItem {
            ...
            private WalletConnect() {
                super(C3630R.C3632drawable.fork_ic_wallet_connect, C3630R.string.wallet_connect_title, Integer.valueOf(C3630R.string.wallet_connect_subtitle), null);
            }
        }
        ...
        public static final class CustomTokens extends WalletSettingsItem {
            ...
            private CustomTokens() {
                super(C3630R.C3632drawable.fork_ic_custom_tokens, C3630R.string.wallet_custom_tokens_title, Integer.valueOf(C3630R.string.wallet_custom_tokens_subtitle), null);
            }
        }
        ...
        public static final class PinCode extends WalletSettingsItem {
            ...
            private PinCode() {
                super(C3630R.C3632drawable.fork_filter_icon_lock, C3630R.string.wallet_settings_pin_code_title, Integer.valueOf(C3630R.string.wallet_settings_pin_code_subtitle), null);
            }
        }
