...
public abstract class WalletCreationType {
    ...
    public static abstract class Initial extends WalletCreationType {
        ...
        public static final class Create extends Initial {
            ...
            private Create() {
                super(C3632R.C3634drawable.fork_ic_wallet_create, C3632R.string.wallet_dashboard_create_eth_wallet, C3632R.string.wallet_creation_intro_title_create, 0, null);
            }
        }
        ...
        public static final class Import extends Initial {
            ...
            private Import() {
                super(C3632R.C3634drawable.fork_ic_wallet_import, C3632R.string.wallet_dashboard_import_eth_wallet, C3632R.string.wallet_creation_intro_title_import, 1, null);
            }
        }
    ...
    public static final class Activate extends WalletCreationType {
        ...
        public Activate(BlockchainType blockchainType) {
            super(C3632R.C3634drawable.fork_ic_wallet_create, C3632R.string.wallet_dashboard_activate_wallet, null);
