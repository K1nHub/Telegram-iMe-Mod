...
public abstract class GlobalState {
    ...
    public static final class NoInternet extends GlobalState {
        ...
        private NoInternet() {
            super("no_internet_state", C3290R.raw.fork_state_no_internet, C3290R.string.common_no_network_state_title, C3290R.string.common_no_network_state_description, null);
        }
    }
    ...
    public static final class Unexpected extends GlobalState {
        ...
        private Unexpected() {
            super("unexpected_error_state", C3290R.raw.fork_state_unexpected, C3290R.string.common_unexpected_state_title, C3290R.string.common_unexpected_state_description, null);
        }
    }
    ...
    public static final class Progress extends GlobalState {
        ...
        private Progress() {
            super("progress_state", C3290R.raw.fork_state_progress, C3290R.string.common_progress_state_title, C3290R.string.common_progress_state_description, null);
        }
    }
    ...
    public static abstract class Empty extends GlobalState {
        ...
        public static final class Common extends Empty {
            ...
            private Common() {
                super("empty_content_state", C3290R.raw.fork_state_empty_common, C3290R.string.common_empty_state_title, C3290R.string.common_empty_state_description, null);
            }
        }
        ...
        public static final class Balance extends Empty {
            ...
            private Balance() {
                super("empty_balance_state", C3290R.raw.fork_state_empty_balance, C3290R.string.common_empty_state_title, C3290R.string.common_empty_balance_state_description, null);
            }
        }
        ...
        public static final class Staking extends Empty {
            ...
            private Staking() {
                super("empty_staking_state", C3290R.raw.fork_state_empty_balance, C3290R.string.common_empty_state_title, C3290R.string.staking_programmes_empty_state_description, null);
            }
        }
        ...
        public static final class Twitter extends Empty {
            ...
            private Twitter() {
                super("empty_twitter_state", C3290R.raw.fork_state_empty_common, C3290R.string.twitter_empty_state_title, C3290R.string.twitter_empty_state_subtitle, null);
            }
        }
        ...
        public static final class TwitterSearch extends Empty {
            ...
            private TwitterSearch() {
                super("empty_twitter_search_state", C3290R.raw.fork_state_empty_common, C3290R.string.twitter_search_title, C3290R.string.twitter_search_subtitle, null);
            }
        }
    }
}
