...
public abstract class SocialAuthResult {
    ...
    public static final class Success extends SocialAuthResult {
        ...
        public int hashCode() {
            return (this.status.hashCode() * 31) + ProfileData$$ExternalSyntheticBackport0.m1020m(this.socialId);
        }
    ...
    public static final class Verification extends SocialAuthResult {
        ...
        public int hashCode() {
            return ProfileData$$ExternalSyntheticBackport0.m1020m(this.socialId);
        }
