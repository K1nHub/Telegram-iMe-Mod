...
public abstract class SocialAuthResult {
    ...
    public static final class Success extends SocialAuthResult {
        ...
        public int hashCode() {
            return (this.status.hashCode() * 31) + BotsDbModel$$ExternalSyntheticBackport0.m706m(this.socialId);
        }
    ...
    public static final class Verification extends SocialAuthResult {
        ...
        public int hashCode() {
            return BotsDbModel$$ExternalSyntheticBackport0.m706m(this.socialId);
        }
