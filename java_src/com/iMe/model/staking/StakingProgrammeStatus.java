...
public final class StakingProgrammeStatus {
    ...
    public static final StakingProgrammeStatus ACTIVE = new StakingProgrammeStatus("ACTIVE", 0, C3419R.string.staking_details_status_active, Theme.key_chat_inGreenCall);
    public static final StakingProgrammeStatus WITHDRAWAL_AVAILABLE = new StakingProgrammeStatus("WITHDRAWAL_AVAILABLE", 1, C3419R.string.staking_details_status_withdrawal_available, Theme.key_windowBackgroundWhiteBlueText);
    ...
    static {
        int i = C3419R.string.staking_details_status_short_of_funds;
        int i2 = Theme.key_text_RedRegular;
        SHORT_OF_FUNDS = new StakingProgrammeStatus("SHORT_OF_FUNDS", 2, i, i2);
        CLOSED = new StakingProgrammeStatus("CLOSED", 3, C3419R.string.staking_details_status_finished, i2);
        $VALUES = $values();
    }
}
