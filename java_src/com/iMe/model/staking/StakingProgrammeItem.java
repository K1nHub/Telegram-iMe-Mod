...
public final class StakingProgrammeItem extends NoChildNode {
    ...
    public int hashCode() {
        int m1020m = ((ProfileData$$ExternalSyntheticBackport0.m1020m(this.f293id) * 31) + this.name.hashCode()) * 31;
        boolean z = this.isParticipated;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((((((((((m1020m + i) * 31) + this.tokenBalance.hashCode()) * 31) + this.apr.hashCode()) * 31) + this.apy.hashCode()) * 31) + this.annualPercentageMode.hashCode()) * 31) + this.endsAt.hashCode();
    }
