...
public final class CampaignItem extends NoChildNode {
    ...
    public int hashCode() {
        ...
        return ((((((((((((hashCode + i) * 31) + this.language.hashCode()) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m706m(this.membersCount)) * 31) + this.photo.hashCode()) * 31) + this.shortname.hashCode()) * 31) + this.tags.hashCode()) * 31) + this.title.hashCode();
    }
