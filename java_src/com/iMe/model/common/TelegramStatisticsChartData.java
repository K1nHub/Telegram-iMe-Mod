    ...
    */
    ...
    public static final class Colors {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Colors) && Intrinsics.areEqual(this.f269y0, ((Colors) obj).f269y0);
        }

        public int hashCode() {
            return this.f269y0.hashCode();
        }

        public String toString() {
            return "Colors(y0=" + this.f269y0 + ')';
        }
    ...
    public static final class Names {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Names) && Intrinsics.areEqual(this.f270y0, ((Names) obj).f270y0);
        }

        public int hashCode() {
            return this.f270y0.hashCode();
        }

        public String toString() {
            return "Names(y0=" + this.f270y0 + ')';
        }
    ...
    public static final class Types {
        ...
        /* renamed from: x */
        private final String f271x;

        /* renamed from: y0 */
        private final String f272y0;
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Types) {
                ...
                return Intrinsics.areEqual(this.f271x, types.f271x) && Intrinsics.areEqual(this.f272y0, types.f272y0);
            }
            return false;
        }

        public int hashCode() {
            return (this.f271x.hashCode() * 31) + this.f272y0.hashCode();
        }

        public String toString() {
            return "Types(x=" + this.f271x + ", y0=" + this.f272y0 + ')';
        }
