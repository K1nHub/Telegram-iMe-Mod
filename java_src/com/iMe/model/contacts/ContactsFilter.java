...
public enum ContactsFilter {
    ALL(C3558R.C3560drawable.msg_contacts, false),
    ONLINE(C3558R.C3560drawable.fork_ic_online_26, false),
    PREMIUM(C3558R.C3560drawable.photo_star, false),
    MUTUAL(C3558R.C3560drawable.msg_groups, false),
    NOT_MUTUAL(C3558R.C3560drawable.fork_ic_unmutal_users_28, true),
    BLOCKED(C3558R.C3560drawable.msg_block, true);
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String internalString = LocaleController.getInternalString(C3558R.string.contacts_filter_all);
                Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.string.contacts_filter_all)");
                return internalString;
            case 2:
                String internalString2 = LocaleController.getInternalString(C3558R.string.contacts_filter_online);
            ...
            case 3:
                String string = LocaleController.getString("LimitPremium", C3558R.string.LimitPremium);
                Intrinsics.checkNotNullExpressionValue(string, "getString(\"LimitPremium\",R.string.LimitPremium)");
                return string;
            case 4:
                String internalString3 = LocaleController.getInternalString(C3558R.string.contacts_filter_mutual);
            ...
            case 5:
                String internalString4 = LocaleController.getInternalString(C3558R.string.contacts_filter_not_mutual);
            ...
            case 6:
                String internalString5 = LocaleController.getInternalString(C3558R.string.contacts_filter_blocked);
