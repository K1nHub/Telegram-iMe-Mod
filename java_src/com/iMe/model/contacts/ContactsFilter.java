...
public enum ContactsFilter {
    ALL(C3290R.string.contacts_filter_all, C3290R.C3292drawable.msg_contacts, false),
    ONLINE(C3290R.string.contacts_filter_online, C3290R.C3292drawable.fork_ic_online_26, false),
    MUTUAL(C3290R.string.contacts_filter_mutual, C3290R.C3292drawable.msg_groups, false),
    NOT_MUTUAL(C3290R.string.contacts_filter_not_mutual, C3290R.C3292drawable.fork_ic_unmutal_users_28, true),
    BLOCKED(C3290R.string.contacts_filter_blocked, C3290R.C3292drawable.msg_block, true);
