...
public abstract class CryptoBoxActionButtonType {
    ...
    /* loaded from: classes4.dex */
    public static final class C1632Ok extends CryptoBoxActionButtonType {
        public static final C1632Ok INSTANCE = new C1632Ok();

        private C1632Ok() {
            super(C3473R.string.common_ok, null);
        }
    }
    ...
    public static final class Loading extends CryptoBoxActionButtonType {
        ...
        private Loading() {
            super(C3473R.string.common_progress_state_title, null);
        }
    }
    ...
    public static final class InProgress extends CryptoBoxActionButtonType {
        ...
        private InProgress() {
            super(C3473R.string.cryptobox_in_progress, null);
        }
    }
    ...
    public static final class Taken extends CryptoBoxActionButtonType {
        ...
        private Taken() {
            super(C3473R.string.cryptobox_taken, null);
        }
    }
    ...
    public static final class Get extends CryptoBoxActionButtonType {
        ...
        private Get() {
            super(C3473R.string.cryptobox_get, null);
        }
    }
    ...
    public static final class Finished extends CryptoBoxActionButtonType {
        ...
        private Finished() {
            super(C3473R.string.cryptobox_finished, null);
        }
    }
    ...
    public static final class Stopped extends CryptoBoxActionButtonType {
        ...
        private Stopped() {
            super(C3473R.string.cryptobox_stopped, null);
        }
    }
    ...
    public static abstract class WithDescription extends CryptoBoxActionButtonType {
        ...
        public static final class Subscribe extends WithDescription {
            ...
            public Subscribe(String chatName, long j) {
                super(C3473R.string.cryptobox_subscribe, C3473R.string.cryptobox_participation_info_subscribe, null);
        ...
        public static final class CreateWallet extends WithDescription {
            ...
            private CreateWallet() {
                super(C3473R.string.cryptobox_create, C3473R.string.cryptobox_participation_info_create, null);
            }
        }
        ...
        public static final class ActivateWallet extends WithDescription {
            ...
            private ActivateWallet() {
                super(C3473R.string.cryptobox_activate, C3473R.string.cryptobox_participation_info_activate, null);
            }
        }
        ...
        public static final class Forwarded extends WithDescription {
            ...
            private Forwarded() {
                super(C3473R.string.common_ok, C3473R.string.cryptobox_participation_info_forwarded, null);
            }
        }
    }
}
