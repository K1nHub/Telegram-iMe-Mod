...
public abstract class CryptoBoxActionButtonType {
    ...
    /* loaded from: classes3.dex */
    public static final class C1636Ok extends CryptoBoxActionButtonType {
        public static final C1636Ok INSTANCE = new C1636Ok();

        private C1636Ok() {
            super(C3558R.string.common_ok, null);
        }
    }
    ...
    public static final class Loading extends CryptoBoxActionButtonType {
        ...
        private Loading() {
            super(C3558R.string.common_progress_state_title, null);
        }
    }
    ...
    public static final class InProgress extends CryptoBoxActionButtonType {
        ...
        private InProgress() {
            super(C3558R.string.cryptobox_in_progress, null);
        }
    }
    ...
    public static final class Taken extends CryptoBoxActionButtonType {
        ...
        private Taken() {
            super(C3558R.string.cryptobox_taken, null);
        }
    }
    ...
    public static final class Get extends CryptoBoxActionButtonType {
        ...
        private Get() {
            super(C3558R.string.cryptobox_get, null);
        }
    }
    ...
    public static final class Finished extends CryptoBoxActionButtonType {
        ...
        private Finished() {
            super(C3558R.string.cryptobox_finished, null);
        }
    }
    ...
    public static final class Stopped extends CryptoBoxActionButtonType {
        ...
        private Stopped() {
            super(C3558R.string.cryptobox_stopped, null);
        }
    }
    ...
    public static abstract class WithDescription extends CryptoBoxActionButtonType {
        ...
        public static final class Subscribe extends WithDescription {
            ...
            public Subscribe(String chatName, long j) {
                super(C3558R.string.cryptobox_subscribe, C3558R.string.cryptobox_participation_info_subscribe, null);
        ...
        public static final class CreateWallet extends WithDescription {
            ...
            private CreateWallet() {
                super(C3558R.string.cryptobox_create, C3558R.string.cryptobox_participation_info_create, null);
            }
        }
        ...
        public static final class ActivateWallet extends WithDescription {
            ...
            private ActivateWallet() {
                super(C3558R.string.cryptobox_activate, C3558R.string.cryptobox_participation_info_activate, null);
            }
        }
    }
}
