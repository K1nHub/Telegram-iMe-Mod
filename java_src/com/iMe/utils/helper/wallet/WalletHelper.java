...
public final class WalletHelper implements KoinComponent {
    ...
    public static final void showManualAuthDialog(final LaunchActivity launchActivity, final MessageObject botAuthButtonMessage, final Callbacks$Callback activateClickAction) {
        ...
        int i = C3632R.raw.fork_auth;
        String internalString = LocaleController.getInternalString(C3632R.string.auth_dialog_title);
        ...
        String internalString2 = LocaleController.getInternalString(C3632R.string.common_next);
    ...
    private final void showAppUpdateDialog(final LaunchActivity launchActivity) {
        DialogUtils.createDialog$default(launchActivity, new DialogModel(LocaleController.getInternalString(C3632R.string.wallet_app_update_dialog_title), LocaleController.getInternalString(C3632R.string.wallet_app_update_dialog_description), LocaleController.getInternalString(C3632R.string.common_cancel), LocaleController.getInternalString(C3632R.string.wallet_app_update_dialog_action_btn)), new Callbacks$Callback() { // from class: com.iMe.utils.helper.wallet.WalletHelper$$ExternalSyntheticLambda2
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    private final SpannableStringBuilder getAuthSpannableStringBuilder() {
        ...
        List<Object> listOf;
        String descriptionText = LocaleController.getInternalString(C3632R.string.auth_dialog_description);
        ...
        if (indexOf$default != -1 && lastIndexOf$default != -1 && indexOf$default != lastIndexOf$default) {
            ...
            listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new Object[]{new URLSpanNoUnderline(LocaleController.getString("PrivacyPolicyUrl", C3632R.string.PrivacyPolicyUrl)), new ForegroundColorSpan(Theme.getColor(Theme.key_windowBackgroundWhiteLinkText))});
