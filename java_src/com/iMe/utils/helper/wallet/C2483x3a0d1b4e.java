...
public final class C2483x3a0d1b4e extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    public C2483x3a0d1b4e() {
        super(1);
    }
    ...
    public final void m1589invoke(Result<? extends Boolean> it) {
