...
import com.iMe.p032ui.shop.BotSettingsActivity;
...
public final class SmartBotHelper implements KoinComponent {
    ...
    private final void showEnableSmartBotDialog(final Context context) {
        DialogUtils.createDialog$default(context, new DialogModel(getResourceManager().getString(C3316R.string.neurobots_enable_dialog_title), getResourceManager().getString(C3316R.string.neurobots_enable_dialog_description), getResourceManager().getString(C3316R.string.common_cancel), getResourceManager().getString(C3316R.string.neurobots_enable_dialog_positive_btn_text)), new Callbacks$Callback() { // from class: com.iMe.utils.helper.neurobot.SmartBotHelper$$ExternalSyntheticLambda0
