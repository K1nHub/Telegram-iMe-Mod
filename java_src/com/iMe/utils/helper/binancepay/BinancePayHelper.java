...
public final class BinancePayHelper implements KoinComponent {
    ...
    static {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<HashMap<String, String>>() { // from class: com.iMe.utils.helper.binancepay.BinancePayHelper$refererHeader$2
            ...
            public final HashMap<String, String> invoke() {
                ...
                hashMapOf = MapsKt__MapsKt.hashMapOf(TuplesKt.m149to("referer", "https://www.binance.com/"));
                return hashMapOf;
            }
        });
    ...
    public static final void runWithCheckIsBinancePayActivated(final BaseFragment fragment, final Callbacks$Callback callbacks$Callback, Callbacks$Callback action) {
        ...
        DialogModel dialogModel = new DialogModel(LocaleController.getInternalString(C3632R.string.wallet_binance_pay_not_activated_dialog_title), LocaleController.getInternalString(C3632R.string.wallet_binance_pay_not_activated_dialog_description), LocaleController.getInternalString(C3632R.string.common_cancel), LocaleController.getInternalString(C3632R.string.wallet_button_auth_dialog_action_btn));
