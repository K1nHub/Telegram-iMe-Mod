...
public final class BinancePayHelper implements KoinComponent {
    ...
    public static final void runWithCheckIsBinancePayActivated(final BaseFragment fragment, final Callbacks$Callback callbacks$Callback, Callbacks$Callback action) {
        ...
        DialogModel dialogModel = new DialogModel(LocaleController.getInternalString(C3290R.string.wallet_binance_pay_not_activated_dialog_title), LocaleController.getInternalString(C3290R.string.wallet_binance_pay_not_activated_dialog_description), LocaleController.getInternalString(C3290R.string.common_cancel), LocaleController.getInternalString(C3290R.string.wallet_button_auth_dialog_action_btn));
