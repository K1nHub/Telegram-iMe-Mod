...
public final class RecycleViewExtKt {
    ...
    public static final void preventScrollByParent(RecyclerView recyclerView) {
        Intrinsics.checkNotNullParameter(recyclerView, "<this>");
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() { // from class: com.iMe.utils.extentions.common.RecycleViewExtKt$preventScrollByParent$1
    ...
    public static final void setHorizontalRecyclerInPagerScrollHelper(RecyclerView recyclerView) {
        Intrinsics.checkNotNullParameter(recyclerView, "<this>");
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() { // from class: com.iMe.utils.extentions.common.RecycleViewExtKt$setHorizontalRecyclerInPagerScrollHelper$1
            private float lastX;
            private float lastY;
