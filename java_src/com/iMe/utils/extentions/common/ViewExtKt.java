...
public final class ViewExtKt {
    ...
    public static final void setVerticalPadding(View view, Number verticalPadding) {
        ...
        view.setPadding(view.getPaddingLeft(), AndroidUtilities.m108dp(verticalPadding.floatValue()), view.getPaddingRight(), AndroidUtilities.m108dp(verticalPadding.floatValue()));
    }

    public static final void setHorizontalPadding(View view, Number horizontalPadding) {
        Intrinsics.checkNotNullParameter(view, "<this>");
        Intrinsics.checkNotNullParameter(horizontalPadding, "horizontalPadding");
        view.setPadding(AndroidUtilities.m108dp(horizontalPadding.floatValue()), view.getPaddingTop(), AndroidUtilities.m108dp(horizontalPadding.floatValue()), view.getPaddingBottom());
    }
    ...
    public static final void applyDefaultProperties(ViewPager viewPager) {
        ...
        int m108dp = AndroidUtilities.m108dp(24.0f);
        viewPager.setPadding(m108dp, 0, m108dp, 0);
    }
