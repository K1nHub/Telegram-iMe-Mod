...
public final class ContextExtKt {
    ...
    public static final void share(Activity activity, String text) {
        ...
        try {
            ...
            activity.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("ShareTelegram", C3630R.string.ShareTelegram)), 500);
        } catch (Exception e) {
            Timber.m6e(e);
        }
    }
    ...
    public static /* synthetic */ void copyToClipboard$default(String str, String str2, int i, Object obj) {
        if ((i & 2) != 0) {
            str2 = LocaleController.getString("TextCopied", C3630R.string.TextCopied);
