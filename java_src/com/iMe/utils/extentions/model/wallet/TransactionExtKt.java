...
public final class TransactionExtKt {
    ...
    public static final int getIcon(Transaction transaction) {
        ...
        if (transaction.getStatus() == Status.CANCELLED) {
            return C3630R.C3632drawable.fork_ic_transaction_cancelled;
        }
        if (transaction instanceof Transaction.Crypto.Donation) {
            ...
            if (i != 1) {
                if (i == 2 || i == 3) {
                    return C3630R.C3632drawable.fork_ic_transaction_donate_out;
                }
                return TransactionDirectionExtKt.icon(transaction.getDirection());
            }
            return C3630R.C3632drawable.fork_ic_transaction_donate_in;
        }
        ...
        if (transaction instanceof Transaction.Referral ? true : transaction instanceof Transaction.Lottery ? true : transaction instanceof Transaction.Registration) {
            return C3630R.C3632drawable.fork_ic_transaction_bonus;
        }
        if (transaction instanceof Transaction.Purchase) {
            return C3630R.C3632drawable.fork_ic_transaction_purchase;
        }
        if (transaction instanceof Transaction.Crypto.SimplexPurchase) {
            return C3630R.C3632drawable.fork_ic_transaction_simplex;
        }
        ...
        if (transaction instanceof Transaction.Crypto.Swap) {
            switch (WhenMappings.$EnumSwitchMapping$1[transaction.getProcessingType().ordinal()]) {
                case 1:
                case 2:
                    return C3630R.C3632drawable.fork_ic_transaction_uniswap;
                case 3:
                    return C3630R.C3632drawable.fork_ic_transaction_pancakeswap;
                case 4:
                    return C3630R.C3632drawable.fork_ic_transaction_symbiosis;
                case 5:
                case 6:
                    return C3630R.C3632drawable.fork_ic_transaction_1_inch;
                default:
                    return C3630R.C3632drawable.fork_ic_transaction_uniswap;
            }
        }
    ...
    public static final int getCategoryTitle(Transaction transaction) {
        ...
        if (transaction instanceof Transaction.Referral) {
            return C3630R.string.wallet_transactions_type_referral_title;
        }
        if (transaction instanceof Transaction.Lottery) {
            return C3630R.string.wallet_transactions_type_lottery_title;
        }
        if (transaction instanceof Transaction.Registration) {
            return C3630R.string.wallet_transactions_type_welcome_title;
        }
        if (transaction instanceof Transaction.Purchase) {
            return C3630R.string.wallet_transactions_type_in_app_purchase_title;
        }
        if (transaction instanceof Transaction.Crypto.SimplexPurchase) {
            return C3630R.string.wallet_transactions_type_simplex_title;
        }
        if (!(transaction instanceof Transaction.Crypto.Swap)) {
            return transaction instanceof Transaction.Refund ? C3630R.string.wallet_transactions_type_refund_title : transaction.getDirection().getTitle();
        }
        switch (WhenMappings.$EnumSwitchMapping$1[transaction.getProcessingType().ordinal()]) {
            case 1:
            case 2:
                return C3630R.string.wallet_transactions_type_uniswap_title;
            case 3:
                return C3630R.string.wallet_transactions_type_pancakeswap_title;
            case 4:
                return C3630R.string.wallet_transactions_type_symbiosis_title;
            case 5:
                return C3630R.string.wallet_transactions_type_1inch_title;
            case 6:
                return C3630R.string.wallet_transactions_type_1inch_fusion_title;
            default:
                return C3630R.string.wallet_transactions_type_uniswap_title;
        }
    }
