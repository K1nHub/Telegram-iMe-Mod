...
public final class DialogsFactoryKt {
    public static /* synthetic */ Dialog showSuccessAlert$default(BaseFragment baseFragment, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, Callbacks$Callback callbacks$Callback, int i, Object obj) {
        if ((i & 4) != 0) {
            charSequence3 = baseFragment.getParentActivity().getString(C3419R.string.common_ok);
    ...
    public static final Dialog createSuccessAlert(BaseFragment baseFragment, CharSequence title, CharSequence description, CharSequence buttonText, Function2<? super TextView, ? super AlertDialog, Unit> dialogApplyAction, Callbacks$Callback callbacks$Callback) {
        ...
        Intrinsics.checkNotNullParameter(buttonText, "buttonText");
        Intrinsics.checkNotNullParameter(dialogApplyAction, "dialogApplyAction");
        AlertDialog createDialog$default = createDialog$default(baseFragment, C3419R.C3421drawable.fork_ic_alert_success, 0, title, description, buttonText, callbacks$Callback, 2, null);
        AppCompatTextView descriptionView = (AppCompatTextView) createDialog$default.getCustomView().findViewById(C3419R.C3422id.text_alert_description);
    ...
    public static final Dialog createErrorAlert(BaseFragment baseFragment, CharSequence title, CharSequence description, CharSequence buttonText, Function2<? super TextView, ? super AlertDialog, Unit> dialogApplyAction, Callbacks$Callback callbacks$Callback) {
        ...
        Intrinsics.checkNotNullParameter(buttonText, "buttonText");
        Intrinsics.checkNotNullParameter(dialogApplyAction, "dialogApplyAction");
        AlertDialog createDialog$default = createDialog$default(baseFragment, C3419R.C3421drawable.fork_ic_alert_error, 0, title, description, buttonText, callbacks$Callback, 2, null);
        AppCompatTextView descriptionView = (AppCompatTextView) createDialog$default.getCustomView().findViewById(C3419R.C3422id.text_alert_description);
        Intrinsics.checkNotNullExpressionValue(descriptionView, "descriptionView");
        dialogApplyAction.invoke(descriptionView, createDialog$default);
        return createDialog$default;
    ...
    public static final BottomSheet createForgotPinOptionsBottomSheetDialog(BaseFragment baseFragment, DialogInterface.OnClickListener listener) {
        Intrinsics.checkNotNullParameter(baseFragment, "<this>");
        Intrinsics.checkNotNullParameter(listener, "listener");
        String internalString = LocaleController.getInternalString(C3419R.string.wallet_enter_eth_password_forgot_option_restore);
        Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…rd_forgot_option_restore)");
        String internalString2 = LocaleController.getInternalString(C3419R.string.wallet_enter_eth_password_forgot_option_delete);
        Intrinsics.checkNotNullExpressionValue(internalString2, "getInternalString(R.stri…ord_forgot_option_delete)");
        return createOptionsBottomSheetDialog(baseFragment, null, new String[]{internalString, internalString2}, new int[]{C3419R.C3421drawable.fork_ic_wallet_restore, C3419R.C3421drawable.msg_delete}, listener);
    }
    ...
    public static /* synthetic */ BottomSheet createDiagramDialog$default(BaseFragment baseFragment, StatisticDiagramModel statisticDiagramModel, CharSequence charSequence, Function0 function0, int i, Object obj) {
        if ((i & 2) != 0) {
            charSequence = LocaleController.getInternalString(C3419R.string.common_close);
    ...
    public static final AlertDialog createBinanceVerificationRequiredDialog(final BaseFragment baseFragment) {
        ...
        Activity parentActivity = baseFragment.getParentActivity();
        Intrinsics.checkNotNullExpressionValue(parentActivity, "parentActivity");
        return DialogUtils.createDialog$default(parentActivity, new DialogModel(LocaleController.getInternalString(C3419R.string.binance_not_verified_dialog_title), LocaleController.getInternalString(C3419R.string.binance_not_verified_dialog_description), LocaleController.getInternalString(C3419R.string.common_cancel), LocaleController.getInternalString(C3419R.string.binance_not_verified_dialog_positive_btn)), new Callbacks$Callback() { // from class: com.iMe.utils.dialogs.DialogsFactoryKt$$ExternalSyntheticLambda7
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    public static final void createBinanceVerificationRequiredDialog$lambda$28(BaseFragment this_createBinanceVerificationRequiredDialog) {
        ...
        Browser.openUrl(this_createBinanceVerificationRequiredDialog.getParentActivity(), LocaleController.getInternalString(C3419R.string.wallet_binance_verify_profile_website));
    }
    ...
    public static final AlertDialog createWalletCreatedRequiredDialog(BaseFragment baseFragment, BlockchainType blockchainType, Callbacks$Callback positiveAction) {
        ...
        if (blockchainType != null) {
            internalString = blockchainType.name() + ' ' + LocaleController.getInternalString(C3419R.string.wallet_crypto_wallet_not_created_dialog_title);
        } else {
            internalString = LocaleController.getInternalString(C3419R.string.wallet_crypto_wallet_not_created_dialog_title);
        }
        return DialogUtils.createDialog$default(parentActivity, new DialogModel(internalString, LocaleController.getInternalString(C3419R.string.wallet_crypto_wallet_not_created_dialog_description), LocaleController.getInternalString(C3419R.string.common_cancel), LocaleController.getInternalString(C3419R.string.common_ok)), positiveAction, null, 8, null);
    }
    ...
    public static final AlertDialog createSelectTokensOrderTypeDialog(BaseFragment baseFragment, ResourceManager resourceManager, TokenOrderType selectedType, final Callbacks$Callback1<TokenOrderType> onSelected) {
        ...
        DialogModel dialogModel = new DialogModel(resourceManager.getString(C3419R.string.choose_tokens_order_type_dialog_title), null, null, resourceManager.getString(C3419R.string.common_ok), 6, null);
    ...
    public static final void showSelectStakingOrderDialog(BaseFragment baseFragment, ResourceManager resourceManager, StakingOrderType selectedType, final Callbacks$Callback1<StakingOrderType> onSelected) {
        ...
        Intrinsics.checkNotNullParameter(selectedType, "selectedType");
        Intrinsics.checkNotNullParameter(onSelected, "onSelected");
        DialogModel dialogModel = new DialogModel(resourceManager.getString(C3419R.string.choose_tokens_order_type_dialog_title), null, resourceManager.getString(C3419R.string.common_cancel), null, 10, null);
    ...
    public static final void showChatProfileTelegramIdDialog(BaseFragment baseFragment, final Callbacks$Callback onItemSelectedAction) {
        ...
        String internalString = LocaleController.getInternalString(C3419R.string.settings_tools_chat_profile_id_telegram);
        String internalString2 = LocaleController.getInternalString(C3419R.string.settings_tools_chat_profile_id_telegram_description);
        ...
        for (int i = 0; i < length; i++) {
            ...
            arrayList.add(TuplesKt.m103to(LocaleController.getInternalString(chatProfileTelegramIdMode.getTextResId()), Boolean.valueOf(SharedConfig.selectedChatProfileTelegramIdMode == chatProfileTelegramIdMode)));
        }
        baseFragment.showDialog(DialogUtils.createDialogWithRadioCellsList$default(context, new RadioCellsListDialogModel(internalString, internalString2, arrayList, LocaleController.getString("Cancel", C3419R.string.Cancel)), new Callbacks$Callback1() { // from class: com.iMe.utils.dialogs.DialogsFactoryKt$$ExternalSyntheticLambda5
            @Override // com.iMe.fork.utils.Callbacks$Callback1
            public final void invoke(Object obj) {
    ...
    public static /* synthetic */ BottomSheet createInfoBottomSheetDialog$default(BaseFragment baseFragment, String str, String str2, String str3, Callbacks$Callback callbacks$Callback, int i, Object obj) {
        if ((i & 1) != 0) {
            str = LocaleController.getInternalString(C3419R.string.wallet_crypto_buy_information_dialog_title);
    ...
    public static final void showStakingLevelRequiredDialog(BaseFragment baseFragment, ResourceManager resourceManager, AccountLevel minimalRank, Callbacks$Callback onReplenishClickAction) {
        ...
        Context context = baseFragment.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "context");
        baseFragment.showDialog(DialogUtils.createDialog$default(context, new DialogModel(resourceManager.getString(C3419R.string.staking_programme_level_required_title), resourceManager.getString(C3419R.string.staking_programme_level_required_description, minimalRank.name(), resourceManager.getString(minimalRank.getDescriptionResId())), LocaleController.getString("Cancel", C3419R.string.Cancel), resourceManager.getString(C3419R.string.wallet_common_error_not_enough_money_btn_txt)), onReplenishClickAction, null, 8, null));
    }
}
