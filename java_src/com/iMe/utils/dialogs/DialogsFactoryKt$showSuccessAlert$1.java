...
public final class DialogsFactoryKt$showSuccessAlert$1 extends Lambda implements Function2<TextView, AlertDialog, Unit> {
    public static final DialogsFactoryKt$showSuccessAlert$1 INSTANCE = new DialogsFactoryKt$showSuccessAlert$1();

    DialogsFactoryKt$showSuccessAlert$1() {
        super(2);
    }
