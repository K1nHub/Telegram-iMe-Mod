...
public class TopicView extends LinearLayout {
    ...
    public final void setTopic(TopicModel topic, boolean z) {
        ...
        if (topic.getTopicId() == -2) {
            ...
            String internalString = LocaleController.getInternalString(C3316R.string.topics_title_notopic);
    ...
    public final void setArchive(boolean z, boolean z2) {
        ...
        TextView nameTextView = getNameTextView();
        if (z) {
            i = C3316R.string.folder_fab_settings_fab_archive;
        } else {
            i = C3316R.string.main_list;
        }
        ...
        ImageView iconView = getIconView();
        if (z) {
            i2 = C3316R.C3318drawable.fork_custom_forward_switch_archive;
        } else {
            i2 = C3316R.C3318drawable.fork_custom_forward_switch_main;
        }
    ...
    public final void setMessagesContextMenu(boolean z, boolean z2) {
        ...
        this.isActive = z2;
        String title = z ? LocaleController.getInternalString(C3316R.string.settings_interface_message_header) : LocaleController.getString(C3316R.string.MediaTab);
        TextView nameTextView = getNameTextView();
        ...
        ImageView iconView = getIconView();
        if (z) {
            i = C3316R.C3318drawable.fork_settings_chat;
        } else {
            i = C3316R.C3318drawable.fork_cloud_filter_image;
        }
        ...
        if (this.messagesContextMenu != null || this.archive != null || this.isFilter != null) {
            ...
            if (dialogType != null) {
                ...
                if (!z) {
                    ...
                    color = ContextCompat.getColor(getContext(), C3316R.C3317color.fork_color);
                } else {
                    color = Theme.getColor("chats_actionBackground");
                }
            }
