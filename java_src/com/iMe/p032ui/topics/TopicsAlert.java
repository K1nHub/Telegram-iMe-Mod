...
public final class TopicsAlert extends BottomSheet {
    ...
    public final TextView initSelectTopicTitleTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3316R.string.topics_select));
    ...
    public final TextView initBottomButton(boolean z) {
        ...
        if (z) {
            textView.setText(LocaleController.getString("Create", C3316R.string.Create));
            ...
            textView.setText(LocaleController.getString("Close", C3316R.string.Close));
            textView.setTextColor(getThemedColor("dialogTextBlue2"));
            ...
            textView.setText(LocaleController.getInternalString(C3316R.string.topics_remove));
