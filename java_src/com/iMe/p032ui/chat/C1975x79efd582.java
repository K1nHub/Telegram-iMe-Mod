...
public final class C1975x79efd582 extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ MessageObject $messageObject$inlined;
    final /* synthetic */ ChatPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1975x79efd582(ChatPresenter chatPresenter, MessageObject messageObject) {
        super(1);
    ...
    public final void m1317invoke(Result<? extends String> it) {
