...
public final class ChatPresenter extends BasePresenter<ChatView> {
    ...
    public final void getMultiReplyMessage(SparseArray<MessageObject>[] selectedMessages, TLRPC$Chat chat) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1968xb0a521b7(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1969xb0a521b8((BaseView) getViewState())));
    ...
    public final void processVoiceToText(MessageObject messageObject, File file) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1975x79efd582(this, messageObject)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1976x79efd583((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void checkAndSendReaction(Object data, String str, MessageObject messageObject) {
        ...
        if (ReactionHelper.checkBlacklistReaction(selectedAccountIndex)) {
            Disposable subscribe = this.telegramApi.unblockPeer(AppConfiguration$Reaction.getBotId()).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1964xf214bff7(this, data, str, formatUuid, messageObject)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1965xf214bff8((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
            return;
        }
    ...
    public final void acceptTelegramAuthUrlAndGetTokens(String url, TLRPC$TL_messages_requestUrlAuth tLRPC$TL_messages_requestUrlAuth) {
        ...
        Observable observeOn = just.flatMap(new Function() { // from class: com.iMe.ui.chat.ChatPresenter$$ExternalSyntheticLambda0
        ...
        Disposable subscribe = RxExtKt.withLoadingDialog$default(observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1961x5cfaf286(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1962x5cfaf287((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void loadTextTranslateLanguages() {
        ...
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1972x7ed9d4d7(this, supportedLanguage)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1973x7ed9d4d8((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }

    public final DialogModel getOldAuthButtonDialogModel() {
        return new DialogModel(this.resourceManager.getString(C3316R.string.wallet_button_old_auth_dialog_title), this.resourceManager.getString(C3316R.string.wallet_button_old_auth_dialog_description), this.resourceManager.getString(C3316R.string.common_cancel), this.resourceManager.getString(C3316R.string.wallet_button_old_auth_dialog_action_btn));
    }

    public final DialogModel getDownloadMediaFirstDialogModel() {
        return new DialogModel(LocaleController.getString("AppName", C3316R.string.AppName), LocaleController.getString("PleaseDownload", C3316R.string.PleaseDownload), LocaleController.getString("OK", C3316R.string.OK), null, 8, null);
    }
    ...
    public void onFirstViewAttach() {
        ...
        if (isValidChatForDonations()) {
            ...
            checkIsDonationEnabled(telegramConstants.prepareChatIdForBotAPI(tLRPC$Chat.f1502id));
            listenEvents();
        }
    }
    ...
    public final void checkIsDonationEnabled(long j) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1966xfa8e68f4(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1967xfa8e68f5((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final void listenEvents() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1970xb2bce297(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1971xb2bce298(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
