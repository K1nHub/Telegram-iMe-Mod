...
public final class C2013x3fabecbf extends Lambda implements Function1<Throwable, Result<? extends TLRPC$messages_BotResults>> {
    public static final C2013x3fabecbf INSTANCE = new C2013x3fabecbf();

    public C2013x3fabecbf() {
        super(1);
    }
