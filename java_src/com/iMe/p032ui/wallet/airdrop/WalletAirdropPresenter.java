...
public final class WalletAirdropPresenter extends BasePresenter<WalletAirdropView> {
    ...
    private final void listenEvents() {
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2078x38278dff(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2079x38278e00(null))), "viewState: BaseView? = n…  onError.invoke()\n    })");
    }
    ...
    private final void checkAirdropStart(String str) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2076xf724c718(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2077xf724c719((BaseView) getViewState())));
    ...
    private final void registerInAirdrop() {
        ...
        final C2080x38215bb c2080x38215bb = new C2080x38215bb(this);
        Observable flatMap = registerInAirdrop$default.flatMap(new Function(c2080x38215bb) { // from class: com.iMe.ui.wallet.airdrop.WalletAirdropPresenter$inlined$sam$i$io_reactivex_functions_Function$0
            private final /* synthetic */ Function1 function;

            {
                Intrinsics.checkNotNullParameter(c2080x38215bb, "function");
                this.function = c2080x38215bb;
            }
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn, "airdropInteractor\n      …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2081x3615c038(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2082x3615c039((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
