    ...
    */
    public WalletAirdropDialog(org.telegram.p048ui.ActionBar.BaseFragment r5) {
        /*
            ...
            r2.<init>()
            java.lang.Class<com.iMe.ui.wallet.airdrop.dialog.WalletAirdropDialogPresenter> r3 = com.iMe.p032ui.wallet.airdrop.dialog.WalletAirdropDialogPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.airdrop.dialog.WalletAirdropDialog.<init>(org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    @Override // com.iMe.p032ui.base.mvp.MvpAlertDialog
    ...
    @Override // com.iMe.p032ui.wallet.airdrop.dialog.WalletAirdropDialogView
    public void configureDialogState(boolean z, boolean z2, AirdropStep step, int i) {
        ...
        if (i2 == 1) {
            ...
            configureDialogState$lambda$5$lambda$0.setText(getResourceManager().getString(C3316R.string.airdrop_dialog_action_start));
            ...
            configureDialogState$lambda$5$lambda$1.setText(getResourceManager().getString(C3316R.string.airdrop_dialog_action_reject));
            ...
            configureDialogState$lambda$5$lambda$2.setText(getResourceManager().getString(C3316R.string.wallet_dashboard_create_eth_wallet));
            ...
            configureDialogState$lambda$5$lambda$3.setText(getResourceManager().getString(C3316R.string.wallet_dashboard_import_eth_wallet));
            ...
            configureDialogState$lambda$5$lambda$4.setText(getResourceManager().getString(C3316R.string.airdrop_dialog_action_take));
    ...
    private final List<CheckBoxCell> setupCheckBoxViews() {
        ...
        ForkAirdropContentAlertBinding binding = getBinding();
        binding.checkboxAuth.setText(getResourceManager().getString(C3316R.string.airdrop_dialog_auth_description), "", true, false);
        binding.checkboxCreateWallet.setText(getResourceManager().getString(C3316R.string.airdrop_dialog_create_wallet_description), "", true, false);
        binding.checkboxTakeBonus.setText(getResourceManager().getString(C3316R.string.airdrop_dialog_claim_bonus_description), "", true, false);
    ...
    private final void setupImageView() {
        ...
        rLottieImageView.setAnimation(C3316R.C3321raw.fork_lime_airdrop, ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION);
    ...
    private final void setupTitleView() {
        ...
        setupTitleView$lambda$12.setText(getResourceManager().getString(C3316R.string.airdrop_dialog_title));
    ...
    private final void setupDescriptionView(int i) {
        ...
        appCompatTextView.setText(getResourceManager().getString(C3316R.string.airdrop_dialog_description, String.valueOf(i)));
    ...
    private final void setupMenuItem(AirdropStep airdropStep) {
        ...
        actionBarMenuItem.setIcon(C3316R.C3318drawable.ic_ab_other);
        ...
        actionBarMenuItem.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3316R.string.AccDescrMoreOptions));
        actionBarMenuItem.addSubItem(IdFabric$Menu.TOKEN_SITE, C3316R.C3318drawable.fork_ic_settings_help, getResourceManager().getString(C3316R.string.airdrop_dialog_lime_beginner_menu_title));
        if (airdropStep != AirdropStep.INTRO) {
            actionBarMenuItem.addSubItem(IdFabric$Menu.REJECT, C3316R.C3318drawable.ic_close_white, getResourceManager().getString(C3316R.string.airdrop_dialog_action_reject));
        }
    ...
    public static final void setupMenuItem$lambda$16$lambda$15(ActionBarMenuItem this_with, WalletAirdropDialog this$0, int i) {
        ...
        if (i == IdFabric$Menu.TOKEN_SITE) {
            Browser.openUrl(this_with.getContext(), this$0.getResourceManager().getString(C3316R.string.airdrop_dialog_lime_beginner_site));
