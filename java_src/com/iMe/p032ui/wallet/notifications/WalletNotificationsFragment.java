...
import com.iMe.p032ui.wallet.notifications.details.WalletNotificationDetailsBottomSheetDialog;
...
public final class WalletNotificationsFragment extends WalletAuthFragment implements WalletNotificationsView {
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_notifications_toolbar_title));
        c3381ActionBar.setAllowOverlayTitle(true);
        ActionBarMenuItem setupActionBar$lambda$3$lambda$2$lambda$1 = c3381ActionBar.createMenu().addItem(0, C3316R.C3318drawable.ic_ab_other);
        ...
        setupActionBar$lambda$3$lambda$2$lambda$1.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3316R.string.AccDescrMoreOptions));
        setupActionBar$lambda$3$lambda$2$lambda$1.addSubItem(1, C3316R.C3318drawable.fork_ic_folder_tab_read_all_24, getResourceManager().getString(C3316R.string.dialogs_tab_popup_read_all));
        this.optionsMenuItem = setupActionBar$lambda$3$lambda$2$lambda$1;
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.notifications.WalletNotificationsFragment$setupActionBar$1$2
