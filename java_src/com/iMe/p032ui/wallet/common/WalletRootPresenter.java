...
public final class WalletRootPresenter extends BasePresenter<WalletRootView> {
    ...
    public WalletRootPresenter(CryptoAccessManager cryptoAccessManager, CryptoPreferenceHelper cryptoPreferenceHelper, RxEventBus rxEventBus) {
        ...
        this.selectedTabId = C3316R.C3319id.wallet_root_bottom_navigation_home;
    }
    ...
    public void onFirstViewAttach() {
        listenEvents();
        setupNavigation();
        selectTab(C3316R.C3319id.wallet_root_bottom_navigation_home);
    }

    private final boolean isDefaultTabSelected() {
        return this.selectedTabId == C3316R.C3319id.wallet_root_bottom_navigation_home;
    }
    ...
    private final void listenEvents() {
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2090xb1f506fa(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2091xb1f506fb(null))), "viewState: BaseView? = n…  onError.invoke()\n    })");
    }
    ...
    public final void setupNavigation() {
        ...
        Integer valueOf = Integer.valueOf(C3316R.C3319id.wallet_root_bottom_navigation_home);
        Boolean bool = Boolean.TRUE;
        hashMapOf = MapsKt__MapsKt.hashMapOf(TuplesKt.m94to(valueOf, bool), TuplesKt.m94to(Integer.valueOf(C3316R.C3319id.wallet_root_bottom_navigation_exchange), Boolean.valueOf(this.cryptoAccessManager.isAnyWalletCreated())), TuplesKt.m94to(Integer.valueOf(C3316R.C3319id.wallet_root_bottom_navigation_settings), bool));
