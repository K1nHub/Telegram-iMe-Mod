...
public final class WalletTransactionDetailsBottomSheetDialog extends MvpBottomSheet implements WalletTransactionDetailsView {
    ...
    */
    public WalletTransactionDetailsBottomSheetDialog(org.telegram.p048ui.ActionBar.BaseFragment r4, com.iMe.p032ui.wallet.transaction.details.WalletTransactionDetailsBottomSheetDialog.ScreenType r5, com.iMe.fork.utils.Callbacks$Callback1<com.iMe.model.wallet.ActionItem> r6) {
        /*
            r3 = this;
            ...
            r0.<init>()
            java.lang.Class<com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsPresenter> r2 = com.iMe.p032ui.wallet.transaction.details.WalletTransactionDetailsPresenter.class
    ...
    @Override // com.iMe.p032ui.wallet.transaction.details.WalletTransactionDetailsView
    ...
    public void openProfileScreen(long j) {
        ProfileActivity profileActivity = new ProfileActivity(BundleKt.bundleOf(TuplesKt.m94to("user_id", Long.valueOf(j))));
    ...
    public void onSuccessCancelTransaction(String txHash) {
        ...
        showDialog(DialogsFactoryKt.createSuccessAlert$default(this.fragment, getResourceManager().getString(C3316R.string.wallet_cancel_transaction_success_dialog_title), getResourceManager().getString(C3316R.string.wallet_cancel_transaction_success_dialog_description), null, null, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsBottomSheetDialog$$ExternalSyntheticLambda3
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    public void onSuccessBoostTransaction(String txHash) {
        Intrinsics.checkNotNullParameter(txHash, "txHash");
        showDialog(DialogsFactoryKt.createSuccessAlert$default(this.fragment, getResourceManager().getString(C3316R.string.wallet_boost_transaction_success_dialog_title), getResourceManager().getString(C3316R.string.wallet_boost_transaction_success_dialog_description), null, null, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.transaction.details.WalletTransactionDetailsBottomSheetDialog$$ExternalSyntheticLambda2
            @Override // com.iMe.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    private final void setupActionItem() {
        ...
        setupActionItem$lambda$13.setIcon(C3316R.C3318drawable.ic_ab_other);
        ...
        setupActionItem$lambda$13.addSubItem(IdFabric$Menu.SHARE, C3316R.C3318drawable.msg_shareout, getResourceManager().getString(C3316R.string.common_share));
        ...
        setupActionItem$lambda$13.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3316R.string.AccDescrMoreOptions));
    }
    ...
    private final void setupTexts() {
        ForkContentWalletTransactionDetailsLayoutBinding binding = getBinding();
        binding.textActionCancel.setText(getResourceManager().getString(C3316R.string.common_ok));
        binding.textSectionName.setText(getResourceManager().getString(C3316R.string.wallet_transaction_details_section_info));
        binding.textSectionActions.setText(getResourceManager().getString(C3316R.string.wallet_transaction_details_section_actions));
        binding.textFeeTitle.setText(getResourceManager().getString(C3316R.string.wallet_transaction_details_fee_title));
        binding.textProcessingTitle.setText(getResourceManager().getString(C3316R.string.wallet_transaction_details_processing_title));
        binding.textDateTitle.setText(getResourceManager().getString(C3316R.string.wallet_transaction_details_date_title));
        binding.textRecipientTitle.setText(getResourceManager().getString(C3316R.string.wallet_transaction_details_recipient_title));
        binding.textStatusTitle.setText(getResourceManager().getString(C3316R.string.wallet_transaction_details_status_title));
        binding.textCommentTitle.setText(getResourceManager().getString(C3316R.string.wallet_transaction_details_comment_title));
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ WalletTransactionDetailsBottomSheetDialog newInstance$default(Companion companion, BaseFragment baseFragment, ScreenType screenType, Callbacks$Callback1 callbacks$Callback1, int i, Object obj) {
            if ((i & 4) != 0) {
                callbacks$Callback1 = C2391xc5bfbef6.INSTANCE;
            }
            return companion.newInstance(baseFragment, screenType, callbacks$Callback1);
        }
