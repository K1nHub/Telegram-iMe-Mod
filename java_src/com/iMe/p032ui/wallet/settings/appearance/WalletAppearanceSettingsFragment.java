...
public final class WalletAppearanceSettingsFragment extends WalletAuthFragment implements WalletAppearanceSettingsView {
    ...
    public WalletAppearanceSettingsFragment() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2302x1bdf1139(this, null, null));
    ...
    @Override // com.iMe.p032ui.wallet.settings.appearance.WalletAppearanceSettingsView
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_settings_interface));
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.settings.appearance.WalletAppearanceSettingsFragment$setupActionBar$1$1
