...
import com.iMe.p032ui.wallet.crypto.settings.WalletAccountSettingsFragment;
import com.iMe.p032ui.wallet.settings.adapter.WalletSettingsRecycleAdapter;
import com.iMe.p032ui.wallet.settings.appearance.WalletAppearanceSettingsFragment;
...
public final class WalletSettingsFragment extends WalletTabFragment implements WalletSettingsView {
    ...
    @Override // com.iMe.p032ui.wallet.settings.WalletSettingsView
    ...
    private final void setupListeners() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2299x3106d7dd(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2300x3106d7de(null)));
