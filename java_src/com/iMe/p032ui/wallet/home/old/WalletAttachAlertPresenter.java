...
public final class WalletAttachAlertPresenter extends BasePresenter<WalletAttachAlertView> {
    ...
    private final void getWalletBalance(boolean z) {
        ...
        Disposable subscribe = observeOn.subscribe(consumer, new Consumer() { // from class: com.iMe.ui.wallet.home.old.WalletAttachAlertPresenter$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
    ...
    private final void getWalletTransactions(TokenCode tokenCode) {
        ...
        Observable observeOn = just.switchMap(new Function() { // from class: com.iMe.ui.wallet.home.old.WalletAttachAlertPresenter$$ExternalSyntheticLambda4
        ...
        Disposable subscribe = observeOn.subscribe(consumer, new Consumer() { // from class: com.iMe.ui.wallet.home.old.WalletAttachAlertPresenter$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
