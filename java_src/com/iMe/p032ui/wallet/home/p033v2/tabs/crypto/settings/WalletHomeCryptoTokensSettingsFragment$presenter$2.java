...
final class WalletHomeCryptoTokensSettingsFragment$presenter$2 extends Lambda implements Function0<WalletHomeCryptoTokensSettingsPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C22791 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletHomeCryptoTokensSettingsFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22791(WalletHomeCryptoTokensSettingsFragment walletHomeCryptoTokensSettingsFragment) {
            super(0);
            this.this$0 = walletHomeCryptoTokensSettingsFragment;
        }
    ...
    public final WalletHomeCryptoTokensSettingsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2278x3f87ce38(walletHomeCryptoTokensSettingsFragment, null, new C22791(walletHomeCryptoTokensSettingsFragment)));
