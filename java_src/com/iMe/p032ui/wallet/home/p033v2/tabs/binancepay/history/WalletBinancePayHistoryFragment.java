...
import com.iMe.p032ui.wallet.home.p033v2.tabs.binancepay.history.adapter.diff.BinancePayHistoryDiffCallback;
...
public final class WalletBinancePayHistoryFragment extends WalletAuthFragment implements WalletBinancePayHistoryView {
    ...
    public WalletBinancePayHistoryFragment(ScreenType screenType, String tokenCode) {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2246xc9259482(this, null, null));
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_binance_pay_action_history));
        c3381ActionBar.setAllowOverlayTitle(true);
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.home.v2.tabs.binancepay.history.WalletBinancePayHistoryFragment$setupActionBar$1$1
