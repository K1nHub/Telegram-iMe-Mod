...
public final class WalletHomeBinancePayFragment$presenter$2 extends Lambda implements Function0<WalletHomeBinancePayPresenter> {
    ...
    public static final class C22321 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22321(WalletHomeBinancePayFragment walletHomeBinancePayFragment) {
            super(0);
            this.this$0 = walletHomeBinancePayFragment;
        }
    ...
    public final WalletHomeBinancePayPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2231x9b06ddc4(walletHomeBinancePayFragment, null, new C22321(walletHomeBinancePayFragment)));
