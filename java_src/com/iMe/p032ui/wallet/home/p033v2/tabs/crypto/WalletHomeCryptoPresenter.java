...
public final class WalletHomeCryptoPresenter extends BasePresenter<WalletHomeCryptoView> {
    ...
    @Override // com.iMe.p032ui.base.mvp.base.BasePresenter
    ...
    private final void loadAccountInformation() {
        Observable<R> map = this.cryptoWalletInteractor.getLinkedCryptoWalletAddress(getCurrentNetworkType().getBlockchainType()).map(new C2273x21775993(new C2268x3703ab47(this)));
        Intrinsics.checkNotNullExpressionValue(map, "crossinline body: (T) ->…ult as? R\n        }\n    }");
        Observable observeOn = map.observeOn(this.schedulersProvider.mo707ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoWalletInteractor\n …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2269xa8abeb1d(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2270xa8abeb1e((BaseView) getViewState())));
    ...
    private final void loadTokens(boolean z, long j) {
        ...
        Observable<R> map = delay.map(new C2273x21775993(new WalletHomeCryptoPresenter$loadTokens$$inlined$mapSuccess$1(this)));
        Intrinsics.checkNotNullExpressionValue(map, "crossinline body: (T) ->…ult as? R\n        }\n    }");
        Observable observeOn = map.observeOn(this.schedulersProvider.mo707ui());
        ...
        Disposable subscribe = doFinally.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2271xe9f7ff8(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2272xe9f7ff9((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        autoDispose(subscribe, this.mainScreenSubscriptions);
    }
    ...
    private final void listenEvents() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2266x69225658(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2267x69225659(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
    ...
    private final void configureTokensHeader(List<BaseNode> list) {
        ...
        int i = C3316R.C3319id.selectable_token_header;
        int category = this.selectedTokenType.getCategory();
        int i2 = C3316R.C3318drawable.fork_ic_arrow_down_16;
    ...
    private final void configureCryptoAccountHeader(List<BaseNode> list) {
        list.add(new HeaderItemWithNetworkSwitcher(this.resourceManager.getString(C3316R.string.wallet_home_crypto_account), this.cryptoPreferenceHelper.getNetworkType(), false, 4, null));
    }
    ...
    private final List<HorizontalActionButtonItem> resolveActions() {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new HorizontalActionButtonItem[]{new HorizontalActionButtonItem(C3316R.C3318drawable.msg_send, this.resourceManager.getString(C3316R.string.wallet_token_details_details_action_send), this.selectedTokenType.isCrypto(), new WalletHomeCryptoPresenter$resolveActions$1(this)), new HorizontalActionButtonItem(C3316R.C3318drawable.fork_ic_ask_transfer, this.resourceManager.getString(C3316R.string.wallet_binance_pay_action_receive), false, new WalletHomeCryptoPresenter$resolveActions$2(this), 4, null), new HorizontalActionButtonItem(C3316R.C3318drawable.fork_ic_transactions_28, this.resourceManager.getString(C3316R.string.wallet_binance_pay_action_history), this.selectedTokenType.isCrypto(), new WalletHomeCryptoPresenter$resolveActions$3(this))});
        return listOf;
    }
