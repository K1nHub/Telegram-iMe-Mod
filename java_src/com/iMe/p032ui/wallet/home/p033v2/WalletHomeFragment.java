...
import com.iMe.p032ui.wallet.home.p033v2.tabs.binancepay.WalletHomeBinancePayFragment;
import com.iMe.p032ui.wallet.home.p033v2.tabs.crypto.WalletHomeCryptoFragment;
import com.iMe.p032ui.wallet.home.p033v2.tabs.services.WalletHomeServicesFragment;
...
public final class WalletHomeFragment extends WalletTabFragment implements NavigationViewConfiguration, WalletHomeView, TabbedViewPagerDelegate<TabbedFragmentPage<WalletHomeTabFragment>> {
    ...
    @Override // com.iMe.p032ui.wallet.common.BottomNavigationTabFragment, com.iMe.p032ui.base.WalletAuthFragment, com.iMe.p032ui.base.mvp.MvpFragment
    ...
    @Override // com.iMe.p032ui.wallet.common.BottomNavigationTabFragment, com.iMe.p032ui.base.mvp.MvpFragment, org.telegram.p048ui.ActionBar.BaseFragment
    ...
    @Override // com.iMe.p032ui.wallet.common.BottomNavigationTabFragment, com.iMe.p032ui.base.WalletAuthFragment, com.iMe.p032ui.base.mvp.MvpFragment, org.telegram.p048ui.ActionBar.BaseFragment
    ...
    @Override // com.iMe.p032ui.wallet.home.p033v2.WalletHomeView
    ...
    @Override // com.iMe.p032ui.wallet.common.BottomNavigationTabFragment
    ...
    public final List<WalletHomeNavigationTab> initPageTabs() {
        ...
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new WalletHomeNavigationTab(C3316R.C3319id.wallet_home_crypto, new TabbedFragmentPage(getResourceManager().getString(C3316R.string.wallet_home_navigation_crypto), C3316R.C3318drawable.fork_ic_crypto_24, WalletHomeCryptoFragment.Companion.newInstance(), null, 8, null)), new WalletHomeNavigationTab(C3316R.C3319id.wallet_home_binance_pay, new TabbedFragmentPage(getResourceManager().getString(C3316R.string.wallet_home_navigation_binance_pay), C3316R.C3318drawable.fork_ic_binance_pay_24, WalletHomeBinancePayFragment.Companion.newInstance(), null, 8, null)), new WalletHomeNavigationTab(C3316R.C3319id.wallet_home_internal_points, new TabbedFragmentPage(getResourceManager().getString(C3316R.string.wallet_home_navigation_services), C3316R.C3318drawable.fork_ic_points_24, WalletHomeServicesFragment.Companion.newInstance(), null, 8, null)));
