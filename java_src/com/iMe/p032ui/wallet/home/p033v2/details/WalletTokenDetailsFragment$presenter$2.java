...
public final class WalletTokenDetailsFragment$presenter$2 extends Lambda implements Function0<WalletTokenDetailsPresenter> {
    ...
    public static final class C22211 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22211(WalletTokenDetailsFragment walletTokenDetailsFragment) {
            super(0);
            this.this$0 = walletTokenDetailsFragment;
        }
    ...
    public final WalletTokenDetailsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2219x31580ac(walletTokenDetailsFragment, null, new C22211(walletTokenDetailsFragment)));
