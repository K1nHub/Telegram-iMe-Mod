...
public final class C2355x5065f295 extends Lambda implements Function1<Result<? extends List<? extends TokenInfo>>, Unit> {
    ...
    public C2355x5065f295(WalletSwapProcessPresenter walletSwapProcessPresenter, NetworkType networkType, Callbacks$Callback callbacks$Callback) {
        super(1);
    ...
    public final void m1532invoke(Result<? extends List<? extends TokenInfo>> it) {
