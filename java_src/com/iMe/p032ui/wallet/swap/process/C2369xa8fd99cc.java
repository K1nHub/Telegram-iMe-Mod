...
public final class C2369xa8fd99cc extends Lambda implements Function1<Observable<Result<? extends List<? extends OutputConvertToken>>>, ObservableSource<Result<? extends List<? extends OutputConvertToken>>>> {
    final /* synthetic */ boolean $isWithLoading;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2369xa8fd99cc(boolean z, WalletSwapProcessPresenter walletSwapProcessPresenter) {
        super(1);
