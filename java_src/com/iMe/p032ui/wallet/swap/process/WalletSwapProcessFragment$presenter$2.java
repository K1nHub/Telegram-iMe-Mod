...
public final class WalletSwapProcessFragment$presenter$2 extends Lambda implements Function0<WalletSwapProcessPresenter> {
    ...
    /* loaded from: classes4.dex */
    public static final class C23461 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletSwapProcessFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23461(WalletSwapProcessFragment walletSwapProcessFragment) {
            super(0);
            this.this$0 = walletSwapProcessFragment;
        }
    ...
    public final WalletSwapProcessPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2344x3ddaec8b(walletSwapProcessFragment, null, new C23461(walletSwapProcessFragment)));
