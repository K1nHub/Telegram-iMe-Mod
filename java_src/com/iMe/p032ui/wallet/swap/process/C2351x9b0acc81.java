...
public final class C2351x9b0acc81 extends Lambda implements Function1<Result<? extends List<? extends OutputConvertToken>>, Unit> {
    ...
    public C2351x9b0acc81(WalletSwapProcessPresenter walletSwapProcessPresenter, String str, Callbacks$Callback callbacks$Callback) {
        super(1);
    ...
    public final void m1530invoke(Result<? extends List<? extends OutputConvertToken>> it) {
        ResourceManager resourceManager;
        Intrinsics.checkNotNullExpressionValue(it, "it");
        Result<? extends List<? extends OutputConvertToken>> result = it;
        if (result instanceof Result.Success) {
            this.this$0.binanceAvailableOppositeSelectableSwapTokens = TuplesKt.m94to(this.$token$inlined, ((Result.Success) result).getData());
