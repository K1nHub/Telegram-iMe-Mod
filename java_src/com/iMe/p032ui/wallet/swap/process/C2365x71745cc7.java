...
public final class C2365x71745cc7 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2365x71745cc7(WalletSwapProcessPresenter walletSwapProcessPresenter) {
        super(1);
    ...
    public final void m1537invoke(Result<? extends Boolean> it) {
