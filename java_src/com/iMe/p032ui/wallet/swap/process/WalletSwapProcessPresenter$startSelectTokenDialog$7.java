...
/* renamed from: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$startSelectTokenDialog$7 */
/* loaded from: classes4.dex */
public final class WalletSwapProcessPresenter$startSelectTokenDialog$7 extends Lambda implements Function1<SelectableToken, Unit> {
    final /* synthetic */ SwapSide $side;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WalletSwapProcessPresenter$startSelectTokenDialog$7(WalletSwapProcessPresenter walletSwapProcessPresenter, SwapSide swapSide) {
        super(1);
