...
public final class WalletSwapProcessPresenter extends BasePresenter<WalletSwapProcessView> {
    ...
    public final void approve() {
        ...
        if (isValidForApprove() && (resolveApproveArgs = resolveApproveArgs()) != null) {
            ...
            Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2347x8810b3d1(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2348x8810b3d2((BaseView) getViewState())));
    ...
    public final DialogModel getApproveTokenDescriptionModel() {
        return new DialogModel(this.resourceManager.getString(C3316R.string.wallet_swap_process_what_is_approve), this.resourceManager.getString(C3316R.string.wallet_swap_process_what_is_approve_dialog_description), null, this.resourceManager.getString(C3316R.string.common_ok), 4, null);
    }

    public final DialogModel getApproveConfirmationDialogModel() {
        String string = this.resourceManager.getString(C3316R.string.wallet_swap_process_confirm_approve_alert_title);
        ResourceManager resourceManager = this.resourceManager;
        int i = C3316R.string.wallet_swap_process_confirm_approve_alert_description;
        ...
        objArr[0] = ticker;
        return new DialogModel(string, resourceManager.getString(i, objArr), this.resourceManager.getString(C3316R.string.common_cancel), this.resourceManager.getString(C3316R.string.wallet_swap_process_confirm_approve_alert_action));
    }
    ...
    public final void startSelectTokenDialog(final SwapSide side) {
        ...
        if (screenType instanceof WalletSwapProcessFragment.ScreenType.Binance) {
            ...
            if (i == 1) {
                ...
                if (this.inputToken == null) {
                    ((WalletSwapProcessView) getViewState()).showToast(this.resourceManager.getString(C3316R.string.wallet_swap_process_give_token_validation));
                    return;
                }
    ...
    public final void setupSwapInformation() {
        WalletSwapProcessFragment.ScreenType screenType = this.screenType;
        if (screenType instanceof WalletSwapProcessFragment.ScreenType.Binance) {
            ((WalletSwapProcessView) getViewState()).setupScreenForSwap(this.resourceManager.getString(C3316R.string.binance_convert_toolbar_title), this.resourceManager.getString(C3316R.string.binance_convert_description), C3316R.C3318drawable.fork_ic_bnb_logo, false, WalletSwapProcessFragment.NetworkSwitchType.GLOBAL);
        } else if (screenType instanceof WalletSwapProcessFragment.ScreenType.Crypto) {
    ...
    private final Pair<WalletSwapProcessFragment.NetworkSwitchType, Boolean> getNetworkSwitchState() {
        ...
        if (i != 1) {
            if (i == 2 || i == 3 || i == 4) {
                ...
                WalletSwapProcessFragment.ScreenType screenType = this.screenType;
                return TuplesKt.m94to(networkSwitchType, Boolean.valueOf(((screenType instanceof WalletSwapProcessFragment.ScreenType.Crypto) && ((WalletSwapProcessFragment.ScreenType.Crypto) screenType).getForcedNetworkType() == null) ? false : false));
            }
            return TuplesKt.m94to(WalletSwapProcessFragment.NetworkSwitchType.GLOBAL, Boolean.FALSE);
        }
        return TuplesKt.m94to(WalletSwapProcessFragment.NetworkSwitchType.CROSS_CHAIN, Boolean.TRUE);
    }
    ...
    private final void swapCrypto() {
        ...
        if (isValidForCryptoSwap() && (resolveSwapArgs = resolveSwapArgs()) != null) {
            ...
            T viewState = getViewState();
            Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
            Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2367x471dfc16(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2368x471dfc17((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
        }
    }
    ...
    private final void swapBinance() {
        if (isValidForBinanceSwap()) {
            ...
            T viewState = getViewState();
            Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
            Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2365x71745cc7(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2366x71745cc8((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
        }
    }
    ...
    private final void prepareForSwapBinance(String str, String str2, String str3) {
        if (isValidForPrepareSwap(str)) {
            ...
            T viewState = getViewState();
            Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
            Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2361x90737ee5(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2362x90737ee6((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
        }
    }
    ...
    private final void prepareForSwapCrypto(String str, String str2, String str3, SwapProtocol swapProtocol) {
        if (isValidForPrepareSwap(str)) {
            ...
            T viewState = getViewState();
            Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
            Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2363xdcc31e38(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2364xdcc31e39((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
        }
    }
    ...
    private final void loadBalanceBinance(SelectableToken selectableToken) {
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn, "binanceInternalInteracto…(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2357x263949c2(this, selectableToken)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2358x263949c3((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final void loadBalanceCrypto(TokenCode tokenCode) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2359xe9da03bb(this, tokenCode)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2360xe9da03bc((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final void loadAvailableSwapTokensCrypto(SwapSide swapSide, boolean z, Callbacks$Callback callbacks$Callback) {
        if (this.screenType instanceof WalletSwapProcessFragment.ScreenType.Crypto) {
            ...
            Observable<Result<List<TokenInfo>>> observeOn = this.swapInteractor.getAvailableTokensToSwap(selectedNetworkTypeBySwapSide, this.swapProtocol).observeOn(this.schedulersProvider.mo707ui());
            ...
            Disposable subscribe = compose.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2355x5065f295(this, selectedNetworkTypeBySwapSide, callbacks$Callback)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2356x5065f296((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
        }
    }
    ...
    private final void loadAvailableSwapTokensBinance(boolean z, Callbacks$Callback callbacks$Callback) {
        if (this.screenType instanceof WalletSwapProcessFragment.ScreenType.Binance) {
            Observable<Result<List<BinanceTokenInfo>>> observeOn = this.binanceInternalInteractor.getTokensForConvert().observeOn(this.schedulersProvider.mo707ui());
            ...
            Intrinsics.checkNotNullExpressionValue(compose, "private fun loadAvailabl…     .autoDispose()\n    }");
            Disposable subscribe = compose.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2353x912b3628(this, callbacks$Callback)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2354x912b3629((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
        }
    }
    ...
    private final void loadAvailableOppositeSwapTokensBinance(String str, boolean z, Callbacks$Callback callbacks$Callback) {
        if (this.screenType instanceof WalletSwapProcessFragment.ScreenType.Binance) {
            Observable<Result<List<OutputConvertToken>>> observeOn = this.binanceInternalInteractor.getOppositeTokensForConvertByToken(str).observeOn(this.schedulersProvider.mo707ui());
            final C2369xa8fd99cc c2369xa8fd99cc = new C2369xa8fd99cc(z, this);
            ...
            Intrinsics.checkNotNullExpressionValue(compose, "private fun loadAvailabl…     .autoDispose()\n    }");
            Disposable subscribe = compose.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2351x9b0acc81(this, str, callbacks$Callback)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2352x9b0acc82((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
            BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
        }
    }
    ...
    private final void loadApproveTokensInfo(boolean z, final boolean z2) {
        ...
        if (this.screenType instanceof WalletSwapProcessFragment.ScreenType.Crypto) {
            ...
            }).observeOn(this.schedulersProvider.mo707ui()).doFinally(new Action() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessPresenter$$ExternalSyntheticLambda11
            ...
            Disposable subscribe = doFinally.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2349x9faf7813(this, selectedNetworkTypeBySwapSide$default, z, z2)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2350x9faf7814((BaseView) getViewState())));
            Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
    ...
    private final boolean isValidForPrepareSwap(String str) {
        ...
        if (selectableToken == null) {
            ...
            SelectableToken selectableToken2 = this.outputToken;
            if (selectableToken2 == null) {
                ((WalletSwapProcessView) getViewState()).showToast(this.resourceManager.getString(C3316R.string.wallet_swap_process_receive_token_amount_validation));
            } else if (Intrinsics.areEqual(selectableToken, selectableToken2)) {
                ((WalletSwapProcessView) getViewState()).showToast(this.resourceManager.getString(C3316R.string.wallet_swap_process_diff_tokens_validation));
            } else {
                if (!(str.length() == 0)) {
                    ...
                    if (!(doubleOrNull != null && NumberExtKt.isZero(doubleOrNull))) {
                        if (isAvailableBalanceLessThanAmount(str)) {
                            ...
                            ((WalletSwapProcessView) getViewState()).showToast(this.resourceManager.getString(C3316R.string.wallet_swap_process_approve_info_not_loaded_yet_validation));
                            loadApproveTokensInfo(false, true);
                        }
                    }
                }
                ((WalletSwapProcessView) getViewState()).showToast(this.resourceManager.getString(C3316R.string.wallet_amount_enter_valid_amount_title));
            }
        }
        z = false;
    ...
    */
    private final boolean isValidForApprove() {
        ...
        L55:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.swap.process.WalletSwapProcessPresenter.isValidForApprove():boolean");
    }
    ...
    private final DialogModel getSwapConfirmationDialogModel() {
        String string;
        String string2 = this.resourceManager.getString(C3316R.string.wallet_swap_process_confirm_swap_alert_title);
        WalletSwapProcessFragment.ScreenType screenType = this.screenType;
        if (screenType instanceof WalletSwapProcessFragment.ScreenType.Binance) {
            ResourceManager resourceManager = this.resourceManager;
            int i = C3316R.string.wallet_swap_process_confirm_swap_alert_description;
            ...
            int i2 = C3316R.string.wallet_swap_process_confirm_swap_alert_description;
            CryptoSwapMetadata cryptoSwapMetadata = this.swapMetadata;
            Intrinsics.checkNotNull(cryptoSwapMetadata);
            BigDecimal amountIn = cryptoSwapMetadata.getAmountIn();
            CryptoSwapMetadata cryptoSwapMetadata2 = this.swapMetadata;
        ...
        return new DialogModel(string2, string, this.resourceManager.getString(C3316R.string.common_cancel), this.resourceManager.getString(C3316R.string.wallet_swap_process_confirm_swap_alert_action));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final String formatBinanceBalance(BinanceTokenBalanceInfo binanceTokenBalanceInfo) {
        return this.resourceManager.getString(C3316R.string.binance_convert_balance, BinanceTokenBalanceExtKt.getSpotBalanceShortText(binanceTokenBalanceInfo), BinanceTokenBalanceExtKt.getMarginBalanceShortText(binanceTokenBalanceInfo));
    }
