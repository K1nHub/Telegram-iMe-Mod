...
import com.iMe.p032ui.wallet.swap.fee.WalletSwapFeeFragment;
import com.iMe.p032ui.wallet.swap.token.WalletSelectTokenFragment;
...
public final class WalletSwapProcessFragment extends WalletAuthFragment implements WalletSwapProcessView {
    ...
    @Override // com.iMe.p032ui.wallet.swap.process.WalletSwapProcessView
    ...
    public void onTokenSelected(SwapSide side, SelectableToken token, int i, int i2, NetworkType networkType) {
        ...
        if (i3 == 1) {
            ...
            onTokenSelected$lambda$5$lambda$3.setHint(getResourceManager().getString(C3316R.string.wallet_amount_input_hint, token.getTicker()));
    ...
    public void renderState(SwapUiState state) {
        ...
        if (state instanceof SwapUiState.NeedApprove) {
            ...
            actionButton.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_button_approve));
            ...
            binding.textToDescription.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_to_description));
            ...
            if (screenType instanceof ScreenType.Binance) {
                string = getResourceManager().getString(C3316R.string.binance_convert_button_calculate);
            } else if (!(screenType instanceof ScreenType.Crypto)) {
                throw new NoWhenBranchMatchedException();
            } else {
                string = getResourceManager().getString(C3316R.string.wallet_swap_process_button_calculate);
            }
            ...
            if (swap instanceof SwapUiState.Swap.Binance) {
                ...
                int i = C3316R.string.wallet_swap_process_fee_price_value;
                ...
                CountDownTimer countDownTimer = new CountDownTimer() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessFragment$renderState$1$5$1
                    ...
                    {
                        super(C0482C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS, 1000L);
                    }
                    ...
                    public void onTick(long j) {
                        ...
                        sb.append(resourceManager2.getString(C3316R.string.wallet_swap_process_button_exchange));
                        sb.append(" (");
                ...
                actionButton3.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_button_exchange));
                ...
                actionButton4.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_button_exchange));
            ...
            actionButton5.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_button_approving));
            ...
            actionButton6.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_button_calculate));
            ...
            binding.textFromDescription.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_from_description));
            binding.textToDescription.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_to_description));
    ...
    public void showNotEnoughMoneyBinanceErrorDialog() {
        DialogsFactoryKt.showErrorAlert$default(this, getResourceManager().getString(C3316R.string.wallet_common_error_not_enough_money_title), getResourceManager().getString(C3316R.string.binance_convert_not_enough_money_error_description), getResourceManager().getString(C3316R.string.common_ok), null, 8, null);
    }

    @Override // com.iMe.p032ui.wallet.swap.process.WalletSwapProcessView
    public void showSuccessSwapAlert() {
        DialogsFactoryKt.showSuccessAlert$default(this, getResourceManager().getString(C3316R.string.wallet_swap_process_swap_success_title), getResourceManager().getString(C3316R.string.wallet_swap_process_swap_success_description), null, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessFragment$$ExternalSyntheticLambda9
    ...
    public void showSuccessApproveAlert() {
        DialogsFactoryKt.showSuccessAlert$default(this, getResourceManager().getString(C3316R.string.wallet_swap_process_approve_success_title), getResourceManager().getString(C3316R.string.wallet_swap_process_approve_success_description), null, null, 12, null);
    }
    ...
    public void showMinMaxInputValues(SelectableToken token, OutputConvertToken information) {
        ...
        ResourceManager resourceManager = getResourceManager();
        int i = C3316R.string.binance_convert_min_max_convert_value;
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.createMenu();
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.swap.process.WalletSwapProcessFragment$setupActionBar$1$1
        ...
        ActionBarMenuItem setupActionBar$lambda$28$lambda$27$lambda$26 = c3381ActionBar.createMenu().addItemWithWidth(IdFabric$Menu.NETWORK_SWITCH, 0, -2);
    ...
    private final void setupTexts() {
        ...
        ResourceManager resourceManager = getResourceManager();
        int i = C3316R.string.wallet_swap_process_select_placeholder;
        appCompatTextView.setText(resourceManager.getString(i));
        binding.textSelectToToken.setText(getResourceManager().getString(i));
        binding.textToToken.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_to_title));
        binding.textFromToken.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_from_title));
        binding.buttonAction.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_button_calculate));
        binding.textWhatIsApprove.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_what_is_approve));
    }
