package com.iMe.p032ui.wallet.swap.token.adapter;
...
/* renamed from: com.iMe.ui.wallet.swap.token.adapter.WalletSelectTokenAdapter$convert$2 */
/* loaded from: classes4.dex */
final class WalletSelectTokenAdapter$convert$2 extends Lambda implements Function1<CoinTickerView, Unit> {
    final /* synthetic */ SelectableTokenItem $item;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WalletSelectTokenAdapter$convert$2(SelectableTokenItem selectableTokenItem) {
        super(1);
