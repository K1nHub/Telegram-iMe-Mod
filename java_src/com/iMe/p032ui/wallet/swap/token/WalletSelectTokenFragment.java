...
import com.iMe.p032ui.wallet.swap.token.adapter.diff.SelectTokenDiffCallback;
...
public final class WalletSelectTokenFragment extends WalletAuthFragment implements WalletSelectTokenView {
    ...
    @Override // com.iMe.p032ui.wallet.swap.token.WalletSelectTokenView
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_swap_process_select_token_header));
        c3381ActionBar.setAllowOverlayTitle(true);
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.swap.token.WalletSelectTokenFragment$setupActionBar$1$1
