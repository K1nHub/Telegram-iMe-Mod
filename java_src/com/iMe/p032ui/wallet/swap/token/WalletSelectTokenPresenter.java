...
public final class WalletSelectTokenPresenter extends BasePresenter<WalletSelectTokenView> {
    ...
    private final void loadBinanceBalances() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2372xe8a4a06a(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2373xe8a4a06b((BaseView) getViewState())));
    ...
    private final void loadInternalBalances() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2374x58d117dd(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2375x58d117de((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
