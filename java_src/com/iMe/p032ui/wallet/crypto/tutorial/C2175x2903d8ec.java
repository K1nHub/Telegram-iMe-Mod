...
final class C2175x2903d8ec extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ CreateWalletTutorialFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2175x2903d8ec(CreateWalletTutorialFragment createWalletTutorialFragment) {
        super(1);
