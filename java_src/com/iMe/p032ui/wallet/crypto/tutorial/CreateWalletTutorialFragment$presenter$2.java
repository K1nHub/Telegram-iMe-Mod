...
public final class CreateWalletTutorialFragment$presenter$2 extends Lambda implements Function0<CreateWalletTutorialPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C21731 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ CreateWalletTutorialFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21731(CreateWalletTutorialFragment createWalletTutorialFragment) {
            super(0);
            this.this$0 = createWalletTutorialFragment;
        }
    ...
    public final CreateWalletTutorialPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2170x25a74f5b(createWalletTutorialFragment, null, new C21731(createWalletTutorialFragment)));
