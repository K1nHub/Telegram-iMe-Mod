...
public final class C2169x88ce73d4 extends Lambda implements Function1<Boolean, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C2169x88ce73d4(WalletPrivacySettingPresenter walletPrivacySettingPresenter, int i, ArrayList<Long> arrayList) {
        super(1);
    ...
    public final ObservableSource<? extends Result<Boolean>> invoke(Boolean isNeedChange) {
        ...
        Observable map = observeOn.map(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new C2167xbd3dff7a((BaseView) viewState, resourceManager)));
