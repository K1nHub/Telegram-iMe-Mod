...
import com.iMe.p032ui.wallet.crypto.wallet_connect.WalletConnectFragment;
...
public final class WalletAccountSettingsFragment extends WalletAuthFragment implements WalletAccountSettingsView {
    ...
    @Override // com.iMe.p032ui.wallet.crypto.settings.WalletAccountSettingsView
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_eth_account_settings_toolbar_title));
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.settings.WalletAccountSettingsFragment$setupActionBar$1$1
    ...
    private final void setupListeners() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2149xdd3a1942(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2150xdd3a1943(null)));
