...
import com.iMe.p032ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog;
...
public final class BlockchainsManagementFragment extends WalletAuthFragment implements BlockchainsManagementView {
    ...
    public void openBackupScreen(List<String> secretWords, String address) {
        ...
        PinCodeCoordinator.start$default(pinCodeCoordinator, parentLayout, CreateWalletFragment.Companion.newInstance(new CreateWalletScreenType.SecretWords(secretWords, address, null, null, 12, null)), null, false, 12, null);
    }
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_crypto_blockchains_title));
        c3381ActionBar.setAllowOverlayTitle(true);
        c3381ActionBar.createMenu();
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.settings.blockchains.BlockchainsManagementFragment$setupActionBar$1$1
    ...
    public static final void setupListeners$lambda$8$lambda$7$lambda$6(BlockchainsManagementFragment this$0, BlockchainsWalletsRecycleAdapter this_with, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        ...
        if (view.getId() == C3316R.C3319id.image_info) {
    ...
    private final void setupViews() {
        ...
        rLottieImageView.setAnimation(C3316R.C3321raw.fork_multi_networking, 300, 170);
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.playAnimation();
        binding.textWalletsTitle.setText(getResourceManager().getString(C3316R.string.wallet_crypto_blockchains_active_wallets));
        binding.textDescription.setText(getResourceManager().getString(C3316R.string.wallet_crypto_blockchains_description));
        binding.buttonResetAll.setTextAndIcon(getResourceManager().getString(C3316R.string.wallet_reset_all_title), C3316R.C3318drawable.msg_block2, false);
    }
