...
public final class BlockchainWalletDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<BlockchainWalletDetailsPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C21591 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ BlockchainWalletDetailsBottomSheetDialog this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21591(BlockchainWalletDetailsBottomSheetDialog blockchainWalletDetailsBottomSheetDialog) {
            super(0);
            this.this$0 = blockchainWalletDetailsBottomSheetDialog;
        }
    ...
    public final BlockchainWalletDetailsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2157xac57dd17(blockchainWalletDetailsBottomSheetDialog, null, new C21591(blockchainWalletDetailsBottomSheetDialog)));
