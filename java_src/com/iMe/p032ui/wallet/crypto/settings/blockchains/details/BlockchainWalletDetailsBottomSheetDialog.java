    ...
    */
    public BlockchainWalletDetailsBottomSheetDialog(org.telegram.p048ui.ActionBar.BaseFragment r3, com.iMe.model.wallet.crypto.settings.BlockchainWalletItem r4, kotlin.jvm.functions.Function1<? super com.iMe.model.wallet.crypto.settings.BlockchainWalletItem, kotlin.Unit> r5, kotlin.jvm.functions.Function1<? super com.iMe.model.wallet.crypto.settings.BlockchainWalletItem, kotlin.Unit> r6, com.iMe.model.dialog.DialogModel r7) {
        /*
            ...
            r7.<init>()
            java.lang.Class<com.iMe.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsPresenter> r0 = com.iMe.p032ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog.<init>(org.telegram.ui.ActionBar.BaseFragment, com.iMe.model.wallet.crypto.settings.BlockchainWalletItem, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, com.iMe.model.dialog.DialogModel):void");
    }
    ...
    @Override // com.iMe.p032ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsView
    public void setupScreenWithData(int i, String title, String subtitle, String createdDate, String address) {
        ...
        binding.viewConnectedCell.setupViewData(getResourceManager().getString(C3316R.string.wallet_details_created), createdDate, C3316R.C3318drawable.msg_calendar2, true);
    ...
    private final void setupActionItem() {
        ...
        setupActionItem$lambda$4.setIcon(C3316R.C3318drawable.ic_ab_other);
        ...
        setupActionItem$lambda$4.addSubItem(IdFabric$Menu.INFO, C3316R.C3318drawable.msg_info, getResourceManager().getString(C3316R.string.wallet_crypto_buy_information_dialog_title));
        setupActionItem$lambda$4.addSubItem(IdFabric$Menu.COPY, C3316R.C3318drawable.msg_copy, getResourceManager().getString(C3316R.string.wallet_transaction_details_action_copy_address));
        ...
        setupActionItem$lambda$4.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3316R.string.AccDescrMoreOptions));
    }
    ...
    private final void setupTexts() {
        ForkContentBlockchainsWalletDetailsBinding binding = getBinding();
        binding.buttonBackup.setText(getResourceManager().getString(C3316R.string.wallet_eth_account_settings_backup_title));
        binding.buttonReset.setText(LocaleController.getString("Reset", C3316R.string.Reset));
    }
