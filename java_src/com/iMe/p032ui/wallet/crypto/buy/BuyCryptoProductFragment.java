...
import com.iMe.p032ui.wallet.crypto.buy.customPrice.CryptoBuyCustomPriceBottomSheetDialog;
import com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment;
...
public final class BuyCryptoProductFragment extends WalletAuthFragment implements BuyCryptoProductView {
    ...
    @Override // com.iMe.p032ui.wallet.crypto.buy.BuyCryptoProductView
    ...
    public void showSuccessPurchase() {
        DialogsFactoryKt.showSuccessAlert$default(this, getResourceManager().getString(C3316R.string.wallet_crypto_buy_success_dialog_title), getResourceManager().getString(C3316R.string.wallet_crypto_buy_success_dialog_description), null, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.crypto.buy.BuyCryptoProductFragment$$ExternalSyntheticLambda2
    ...
    public void showErrorPurchase(String orderId) {
        ...
        DialogsFactoryKt.showErrorAlert$default(this, getResourceManager().getString(C3316R.string.common_unexpected_error_title), getResourceManager().getString(C3316R.string.wallet_crypto_buy_error_dialog_description, orderId), null, new BuyCryptoProductFragment$showErrorPurchase$1(orderId), null, 20, null);
    }
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_buy_toolbar_title));
        c3381ActionBar.setAllowOverlayTitle(true);
        c3381ActionBar.createMenu();
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.buy.BuyCryptoProductFragment$setupActionBar$1$1
    ...
    public static final class Companion {
        ...
        public final BuyCryptoProductFragment newInstance(TokenCode tokenCode) {
            ...
            Pair[] pairArr = {TuplesKt.m94to("token_code", tokenCode.getName())};
