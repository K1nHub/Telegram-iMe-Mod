...
public final class CryptoBuyCustomPricePresenter extends BasePresenter<CryptoBuyCustomPriceView> {
    ...
    private final DialogModel getConfirmationDialogModel(float f) {
        return new DialogModel(this.resourceManager.getString(C3316R.string.wallet_crypto_buy_confirm_dialog_title), this.resourceManager.getString(C3316R.string.wallet_crypto_buy_confirm_dialog_description, BalanceFormatter.formatBalance(Float.valueOf(f), this.minItem.getTokenInfo().getDecimals()), this.resourceManager.getString(this.minItem.getTokenInfo().getShortName())), this.resourceManager.getString(C3316R.string.common_cancel), this.resourceManager.getString(C3316R.string.wallet_crypto_buy_confirm_dialog_action_txt));
    }
