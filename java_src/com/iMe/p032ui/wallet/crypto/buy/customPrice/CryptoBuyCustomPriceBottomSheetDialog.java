...
public final class CryptoBuyCustomPriceBottomSheetDialog extends MvpBottomSheet implements CryptoBuyCustomPriceView {
    ...
    */
    public CryptoBuyCustomPriceBottomSheetDialog(org.telegram.p048ui.ActionBar.BaseFragment r4, com.iMe.model.wallet.crypto.buy.CryptoBuyItem r5, kotlin.jvm.functions.Function2<? super java.lang.Float, ? super com.iMe.storage.domain.model.crypto.simplex.Currency, kotlin.Unit> r6) {
        /*
            r3 = this;
            ...
            r0.<init>()
            java.lang.Class<com.iMe.ui.wallet.crypto.buy.customPrice.CryptoBuyCustomPricePresenter> r2 = com.iMe.p032ui.wallet.crypto.buy.customPrice.CryptoBuyCustomPricePresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.crypto.buy.customPrice.CryptoBuyCustomPriceBottomSheetDialog.<init>(org.telegram.ui.ActionBar.BaseFragment, com.iMe.model.wallet.crypto.buy.CryptoBuyItem, kotlin.jvm.functions.Function2):void");
    }
    ...
    */
    public void configureExchangeState(float r5, float r6, com.iMe.storage.domain.model.crypto.simplex.Currency r7, com.iMe.storage.domain.model.crypto.simplex.Currency r8) {
        ...
        L43:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.crypto.buy.customPrice.CryptoBuyCustomPriceBottomSheetDialog.configureExchangeState(float, float, com.iMe.storage.domain.model.crypto.simplex.Currency, com.iMe.storage.domain.model.crypto.simplex.Currency):void");
    }
    ...
    public void resetInputError() {
        ...
        appCompatTextView.setText(getResourceManager().getString(C3316R.string.wallet_crypto_buy_custom_price_dialog_action));
    }
    ...
    private final void setupActionBar() {
        ForkContentWalletCryptoBuyCustomPriceLayoutBinding binding = getBinding();
        binding.imageBack.setImageResource(C3316R.C3318drawable.ic_ab_back);
        binding.textTitle.setText(getResourceManager().getString(C3316R.string.wallet_crypto_buy_custom_price_dialog_toolbar_title));
    }
