...
final class BuyCryptoProductFragment$presenter$2 extends Lambda implements Function0<BuyCryptoProductPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C20961 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ BuyCryptoProductFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C20961(BuyCryptoProductFragment buyCryptoProductFragment) {
            super(0);
            this.this$0 = buyCryptoProductFragment;
        }
    ...
    public final BuyCryptoProductPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2095xc111d906(buyCryptoProductFragment, null, new C20961(buyCryptoProductFragment)));
