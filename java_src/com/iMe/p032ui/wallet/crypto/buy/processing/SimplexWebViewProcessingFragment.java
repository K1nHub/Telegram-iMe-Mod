    ...
    */
    public void onActivityResultFragment(int r3, int r4, android.content.Intent r5) {
        ...
        L40:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.onActivityResultFragment(int, int, android.content.Intent):void");
    }
            ...
            */
            public boolean onShowFileChooser(android.webkit.WebView r3, android.webkit.ValueCallback<android.net.Uri[]> r4, android.webkit.WebChromeClient.FileChooserParams r5) {
                /*
                    ...
                    com.iMe.ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment r3 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.this
                    android.webkit.ValueCallback r3 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.access$getMFilePathCallback$p(r3)
                    r5 = 0
                    if (r3 == 0) goto L1b
                    r3.onReceiveValue(r5)
                L1b:
                    com.iMe.ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment r3 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.this
                    com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.access$setMFilePathCallback$p(r3, r4)
                    android.content.Intent r3 = new android.content.Intent
                    java.lang.String r4 = "android.media.action.IMAGE_CAPTURE"
                    r3.<init>(r4)
                    com.iMe.ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment r4 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.this
                    android.app.Activity r4 = r4.getParentActivity()
                    android.content.pm.PackageManager r4 = r4.getPackageManager()
                    android.content.ComponentName r4 = r3.resolveActivity(r4)
                    if (r4 == 0) goto L75
                    com.iMe.ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment r4 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.this     // Catch: java.io.IOException -> L4b
                    java.io.File r4 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.access$createImageFile(r4)     // Catch: java.io.IOException -> L4b
                    java.lang.String r0 = "PhotoPath"
                    com.iMe.ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment r1 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.this     // Catch: java.io.IOException -> L49
                    java.lang.String r1 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.access$getMCameraPhotoPath$p(r1)     // Catch: java.io.IOException -> L49
                ...
                L50:
                    if (r4 == 0) goto L76
                    com.iMe.ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment r5 = com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.this
                    ...
                    com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment.access$setMCameraPhotoPath$p(r5, r0)
                ...
                L76:
                    ...
                    return r4
                */
                throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment$setupWebView$1$2.onShowFileChooser(android.webkit.WebView, android.webkit.ValueCallback, android.webkit.WebChromeClient$FileChooserParams):boolean");
            }
        });
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_crypto_buy_processing_toolbar_title));
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.buy.processing.SimplexWebViewProcessingFragment$setupActionBar$1$1
    ...
    public static final class Companion {
        ...
        public final SimplexWebViewProcessingFragment newInstance(String url, Function1<? super PaymentResult, Unit> resultDelegate) {
            Intrinsics.checkNotNullParameter(url, "url");
            Intrinsics.checkNotNullParameter(resultDelegate, "resultDelegate");
            return (SimplexWebViewProcessingFragment) BaseFragmentExtKt.withArgs(new SimplexWebViewProcessingFragment(resultDelegate), TuplesKt.m94to("url_arg", url));
        }
    }
}
