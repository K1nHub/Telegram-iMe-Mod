...
public final class EnterWalletPinFragment extends WalletAuthFragment implements EnterWalletPinView {
    ...
    @Override // com.iMe.p032ui.wallet.crypto.enter.pin.EnterWalletPinView
    ...
    private final void setupActionBar() {
        ...
        setupActionBar$lambda$1.setImageResource(C3316R.C3318drawable.ic_ab_back);
    ...
    private final void setupPasscodeView() {
        ...
        passcodeView.setWalletDelegate(new PasscodeView.WalletDelegate() { // from class: com.iMe.ui.wallet.crypto.enter.pin.EnterWalletPinFragment$setupPasscodeView$1$1
            @Override // org.telegram.p048ui.Components.PasscodeView.WalletDelegate
    ...
    private final void setupListeners() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2143x64e4ff35(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2144x64e4ff36(null)));
