...
public final class EnterWalletPinFragment$presenter$2 extends Lambda implements Function0<EnterWalletPinPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C21451 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ EnterWalletPinFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21451(EnterWalletPinFragment enterWalletPinFragment) {
            super(0);
            this.this$0 = enterWalletPinFragment;
        }
    ...
    public final EnterWalletPinPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2142x2e9da3aa(enterWalletPinFragment, null, new C21451(enterWalletPinFragment)));
