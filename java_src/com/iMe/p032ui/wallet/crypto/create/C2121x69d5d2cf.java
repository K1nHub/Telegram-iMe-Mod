...
public final class C2121x69d5d2cf extends Lambda implements Function1<Result<? extends Wallet>, Unit> {
    final /* synthetic */ CreateWalletPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2121x69d5d2cf(CreateWalletPresenter createWalletPresenter) {
        super(1);
    ...
    public final void m1407invoke(Result<? extends Wallet> it) {
