...
/* renamed from: com.iMe.ui.wallet.crypto.create.CreateWalletFragment$createButtonTextView$1$1 */
            ...
            if (checkEditTexts2) {
                ...
                for (Object obj : list) {
                    ...
                    if (!Intrinsics.areEqual(((CreateWalletScreenType.WordsCheck) createWalletFragment2.currentType).getSecretWords().get(((Number) obj).intValue()), ((CreateWalletFragment.NumericEditText) createWalletFragment2.editTexts.get(i)).getText().toString())) {
                        createWalletFragment2.showAlertDialog(new DialogModel(LocaleController.getInternalString(C3316R.string.wallet_backup_test_time_alert_title), LocaleController.getInternalString(C3316R.string.wallet_backup_test_time_alert_text), LocaleController.getInternalString(C3316R.string.wallet_backup_test_time_alert_button_see), LocaleController.getInternalString(C3316R.string.wallet_backup_test_time_alert_button_try)), C2112xc3945669.INSTANCE, new Callbacks$Callback() { // from class: com.iMe.ui.wallet.crypto.create.CreateWalletFragment$createButtonTextView$1$1$$ExternalSyntheticLambda0
