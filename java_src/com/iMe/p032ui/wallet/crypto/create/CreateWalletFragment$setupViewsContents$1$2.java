...
import com.iMe.p032ui.wallet.crypto.create.secret_words_count.SecretWordsCountBottomSheetDialog;
import kotlin.Unit;
...
public final class CreateWalletFragment$setupViewsContents$1$2 extends Lambda implements Function0<Unit> {
    ...
    /* loaded from: classes3.dex */
    public static final class C21181 extends Lambda implements Function1<Integer, Unit> {
        final /* synthetic */ CreateWalletFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21181(CreateWalletFragment createWalletFragment) {
            super(1);
            this.this$0 = createWalletFragment;
        }
    ...
    public final void invoke2() {
        ...
        createWalletFragment.showDialog(companion.newInstance(parentActivity, new C21181(this.this$0)));
    }
}
