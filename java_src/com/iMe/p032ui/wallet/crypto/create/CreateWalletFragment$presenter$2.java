...
public final class CreateWalletFragment$presenter$2 extends Lambda implements Function0<CreateWalletPresenter> {
    ...
    public static final class C21171 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21171(CreateWalletFragment createWalletFragment) {
            super(0);
            this.this$0 = createWalletFragment;
        }
    ...
    public final CreateWalletPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2114x4f1f4719(createWalletFragment, null, new C21171(createWalletFragment)));
