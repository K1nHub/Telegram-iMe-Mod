...
public final class C2124xa2ffd3d8 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    ...
    public C2124xa2ffd3d8(CreateWalletPresenter createWalletPresenter, boolean z, String str, String str2) {
        super(1);
    ...
    public final void m1408invoke(Result<? extends Boolean> it) {
