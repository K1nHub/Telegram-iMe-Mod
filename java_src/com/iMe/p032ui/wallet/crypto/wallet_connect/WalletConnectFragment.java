...
import com.iMe.p032ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsBottomSheetDialog;
...
public final class WalletConnectFragment extends WalletAuthFragment implements WalletConnectView {
    ...
    @Override // com.iMe.p032ui.wallet.crypto.wallet_connect.WalletConnectView
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_connect_title));
        c3381ActionBar.setAllowOverlayTitle(true);
        c3381ActionBar.createMenu();
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.crypto.wallet_connect.WalletConnectFragment$setupActionBar$1$1
        ...
        ActionBarMenu createMenu = c3381ActionBar.createMenu();
        Activity parentActivity = getParentActivity();
        Intrinsics.checkNotNullExpressionValue(parentActivity, "parentActivity");
    ...
    private final void setupViews() {
        ...
        Drawable drawable = ContextCompat.getDrawable(getParentActivity(), C3316R.C3318drawable.msg_mini_qr);
        ...
        spannableStringBuilder.append((CharSequence) getResourceManager().getString(C3316R.string.wallet_connect_new_connection));
        ...
        rLottieImageView.setAnimation(C3316R.C3321raw.fork_wallet_connect, 300, 170, this.colors);
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.playAnimation();
        binding.textSessionsTitle.setText(getResourceManager().getString(C3316R.string.wallet_connect_active_sessions));
        binding.textDescription.setText(getResourceManager().getString(C3316R.string.wallet_connect_description));
        binding.buttonDisconnectAll.setTextAndIcon(getResourceManager().getString(C3316R.string.wallet_connect_terminate_all), C3316R.C3318drawable.msg_block2, false);
    }
