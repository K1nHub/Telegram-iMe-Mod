    ...
    */
    public WalletConnectMessageSignBottomSheetDialog(long r10, com.iMe.model.wallet.crypto.wallet_connect.WalletConnectSessionItem r12, com.trustwallet.walletconnect.models.ethereum.WCEthereumSignMessage r13, com.iMe.storage.domain.manager.wallet_connect.WalletConnectManager r14, org.telegram.p048ui.ActionBar.BaseFragment r15) {
        /*
            ...
            r12.<init>()
            java.lang.Class<com.iMe.ui.wallet.crypto.wallet_connect.message_sign.WalletConnectMessageSignPresenter> r13 = com.iMe.p032ui.wallet.crypto.wallet_connect.message_sign.WalletConnectMessageSignPresenter.class
    ...
    @Override // com.iMe.p032ui.wallet.crypto.wallet_connect.message_sign.WalletConnectMessageSignView
    public void setupScreenWithData(String message, String from, String peerUrl) {
        ...
        binding.textFrom.setTextAndValue(from, getResourceManager().getString(C3316R.string.wallet_connect_transaction_from), true);
        binding.textPeerUrl.setTextAndValue(peerUrl, getResourceManager().getString(C3316R.string.wallet_connect_transaction_dapp), false);
    }
    ...
    private final void setupViews() {
        ...
        binding.buttonProcess.setText(getResourceManager().getString(C3316R.string.wallet_connect_transaction_button_sign));
