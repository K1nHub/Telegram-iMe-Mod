...
final class WalletConnectMessageSignBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletConnectMessageSignPresenter> {
    ...
    public static final class C21861 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21861(long j, WalletConnectSessionItem walletConnectSessionItem, WCEthereumSignMessage wCEthereumSignMessage, WalletConnectManager walletConnectManager) {
            super(0);
            this.$requestId = j;
            this.$sessionItem = walletConnectSessionItem;
            this.$message = wCEthereumSignMessage;
    ...
    public final WalletConnectMessageSignPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2183xe2ff69b5(this.this$0, null, new C21861(this.$requestId, this.$sessionItem, this.$message, this.$walletConnectManager)));
