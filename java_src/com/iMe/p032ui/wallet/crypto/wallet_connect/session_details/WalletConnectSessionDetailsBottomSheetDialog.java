...
import com.iMe.p032ui.custom.DetailsIconCellView;
...
public final class WalletConnectSessionDetailsBottomSheetDialog extends MvpBottomSheet implements WalletConnectSessionDetailsView {
    ...
    */
    public WalletConnectSessionDetailsBottomSheetDialog(com.iMe.model.wallet.crypto.wallet_connect.WalletConnectSessionItem r5, org.telegram.p048ui.ActionBar.BaseFragment r6, kotlin.jvm.functions.Function0<kotlin.Unit> r7) {
        /*
            r4 = this;
            ...
            r2.<init>()
            java.lang.Class<com.iMe.ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsPresenter> r3 = com.iMe.p032ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsBottomSheetDialog.<init>(com.iMe.model.wallet.crypto.wallet_connect.WalletConnectSessionItem, org.telegram.ui.ActionBar.BaseFragment, kotlin.jvm.functions.Function0):void");
    }
    ...
    @Override // com.iMe.p032ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsView
    public void setupScreenWithData(String iconUrl, String name, String url, String connectedDate, String address, String network) {
        ...
        binding.viewConnectedCell.setupViewData(getResourceManager().getString(C3316R.string.wallet_connect_session_details_connected), connectedDate, C3316R.C3318drawable.msg_calendar2, true);
        binding.viewAddressCell.setupViewData(getResourceManager().getString(C3316R.string.wallet_connect_session_details_address), address, C3316R.C3318drawable.fork_ic_nav_wallet_24, true);
        ...
        DetailsIconCellView.setupViewData$default(viewNetworkCell, getResourceManager().getString(C3316R.string.wallet_connect_session_details_network), network, C3316R.C3318drawable.msg_language, false, 8, null);
    }
    ...
    private final void setupTexts() {
        getBinding().buttonDisconnect.setText(LocaleController.getString("Disconnect", C3316R.string.Disconnect));
    }
