...
public final class WalletConnectSessionDetailsPresenter extends BasePresenter<WalletConnectSessionDetailsView> {
    ...
    public final DialogModel getDisconnectConfirmationDialogModel() {
        return new DialogModel(LocaleController.getString("AreYouSureSessionTitle", C3316R.string.AreYouSureSessionTitle), LocaleController.getString("TerminateSessionText", C3316R.string.TerminateSessionText), LocaleController.getString("Cancel", C3316R.string.Cancel), LocaleController.getString("Terminate", C3316R.string.Terminate));
    }
