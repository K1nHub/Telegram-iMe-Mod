    ...
    */
    public WalletConnectNewSessionBottomSheetDialog(com.trustwallet.walletconnect.WCSessionStoreItem r6, org.telegram.p048ui.ActionBar.BaseFragment r7) {
        /*
            ...
            r3.<init>()
            java.lang.Class<com.iMe.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionPresenter> r4 = com.iMe.p032ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog.<init>(com.trustwallet.walletconnect.WCSessionStoreItem, org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    @Override // com.iMe.p032ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionView
    public void setupScreenWithData(String iconUrl, String name, String url, String address, String network) {
        ...
        binding.viewHeader.setupViewData(iconUrl, getResourceManager().getString(C3316R.string.wallet_connect_new_session_title, name), url);
        binding.viewWalletCell.setupViewData(getResourceManager().getString(C3316R.string.wallet_connect_new_session_wallet), address, C3316R.C3318drawable.fork_ic_nav_wallet_24, true);
        binding.viewNetworkCell.setupViewData(getResourceManager().getString(C3316R.string.wallet_connect_session_details_network), network, C3316R.C3318drawable.msg_language, true);
    }
    ...
    private final void setupViews() {
        ForkContentWalletConnectNewSessionBinding binding = getBinding();
        binding.textViewBalance.setText(getResourceManager().getString(C3316R.string.wallet_connect_new_session_view_balance));
        binding.textTransactionsApproval.setText(getResourceManager().getString(C3316R.string.wallet_connect_new_transactions_approval));
        binding.buttonConnect.setText(getResourceManager().getString(C3316R.string.wallet_connect_new_connection));
        ActionBarMenuItem actionBarMenuItem = getBinding().buttonClose;
        actionBarMenuItem.setLongClickEnabled(false);
        actionBarMenuItem.setIcon(C3316R.C3318drawable.ic_close_white);
    }
