...
public final class WalletConnectPresenter extends BasePresenter<WalletConnectView> {
    ...
    public final DialogModel getDisconnectAllConfirmationDialogModel() {
        return new DialogModel(LocaleController.getString("AreYouSureSessionsTitle", C3316R.string.AreYouSureSessionsTitle), this.resourceManager.getString(C3316R.string.wallet_connect_terminate_all_description), LocaleController.getString("Cancel", C3316R.string.Cancel), LocaleController.getString("Terminate", C3316R.string.Terminate));
    }
    ...
    private final void subscribeToEvents() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2177x796451d4(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2178x796451d5(null)));
    ...
    private final void subscribeToSessionList() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2179xd4a7409f(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2180xd4a740a0((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
