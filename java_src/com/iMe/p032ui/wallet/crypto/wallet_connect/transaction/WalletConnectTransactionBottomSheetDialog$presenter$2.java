...
public final class WalletConnectTransactionBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletConnectTransactionPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C22021 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletConnectTransactionBottomSheetDialog this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22021(WalletConnectTransactionBottomSheetDialog walletConnectTransactionBottomSheetDialog) {
            super(0);
            this.this$0 = walletConnectTransactionBottomSheetDialog;
        }
    ...
    public final WalletConnectTransactionPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2199x15774caf(walletConnectTransactionBottomSheetDialog, null, new C22021(walletConnectTransactionBottomSheetDialog)));
