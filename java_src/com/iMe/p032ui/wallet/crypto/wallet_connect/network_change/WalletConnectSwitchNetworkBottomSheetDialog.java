...
public final class WalletConnectSwitchNetworkBottomSheetDialog extends MvpBottomSheet implements WalletConnectSwitchNetworkView {
    ...
    */
    public WalletConnectSwitchNetworkBottomSheetDialog(long r9, com.iMe.model.wallet.crypto.wallet_connect.WalletConnectSessionItem r11, com.iMe.storage.domain.model.crypto.NetworkType r12, org.telegram.p048ui.ActionBar.BaseFragment r13) {
        /*
            r8 = this;
            ...
            r11.<init>()
            java.lang.Class<com.iMe.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkPresenter> r12 = com.iMe.p032ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog.<init>(long, com.iMe.model.wallet.crypto.wallet_connect.WalletConnectSessionItem, com.iMe.storage.domain.model.crypto.NetworkType, org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    @Override // com.iMe.p032ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkView
    public void setupScreenWithData(String iconUrl, String name, String url, int i, String networkName) {
        ...
        binding.viewHeader.setupViewData(iconUrl, getResourceManager().getString(C3316R.string.wallet_connect_switch_network_title, name), url);
        binding.viewNetworkCell.setupViewData(getResourceManager().getString(C3316R.string.wallet_connect_session_details_network), networkName, i, true);
    }
    ...
    private final void setupViews() {
        ...
        binding.buttonChangeNetwork.setText(getResourceManager().getString(C3316R.string.wallet_connect_switch_network));
