...
public final class C2062xebaea40e extends Lambda implements Function1<Result<? extends List<? extends BinanceTokenInfo>>, Unit> {
    final /* synthetic */ Callbacks$Callback $action$inlined;
    final /* synthetic */ WalletSendAmountPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2062xebaea40e(WalletSendAmountPresenter walletSendAmountPresenter, Callbacks$Callback callbacks$Callback) {
        super(1);
    ...
    public final void m1381invoke(Result<? extends List<? extends BinanceTokenInfo>> it) {
