...
public final class WalletSendAmountPresenter extends BasePresenter<WalletSendAmountView> {
    ...
    public final String getActionButtonTextByState() {
        ...
        if (i2 == 1) {
            i = C3316R.string.wallet_amount_button_txt;
        } else if (i2 != 2) {
            throw new NoWhenBranchMatchedException();
        } else {
            i = C3316R.string.wallet_amount_button_calculate;
        }
    ...
    public final void validateSend(String rawAmount) {
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2072x61dc80d6(this, obj)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2073x61dc80d7(null))), "viewState: BaseView? = n…  onError.invoke()\n    })");
    }
    ...
    public final void send(String amount) {
        ...
        if (formatTransferArgs != null) {
            if (isWalletTransfer() || isBinanceReplenish()) {
                ...
                ((WalletSendAmountView) getViewState()).showToast(this.resourceManager.getString(C3316R.string.wallet_feature_not_available));
                return;
            }
        }
        ((WalletSendAmountView) getViewState()).showToast(this.resourceManager.getString(C3316R.string.wallet_feature_not_available));
    ...
    public final void validateRecipientAddress(String address) {
        ...
        Observable<Result<String>> observeOn = CryptoHelper.extractAddress(address, this.selectedNetworkType.getBlockchainType(), this.cryptoWalletInteractor).observeOn(this.schedulersProvider.mo707ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "extractAddress(\n        …(schedulersProvider.ui())");
        Intrinsics.checkNotNullExpressionValue(observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2070x6b9f8be9(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2071x6b9f8bea(null))), "viewState: BaseView? = n…  onError.invoke()\n    })");
    }
    ...
    private final void getBinanceAddressesForReplenish(TokenCode tokenCode) {
        ...
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2060xcbcd392d(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2061xcbcd392e((BaseView) getViewState())));
    ...
    private final void getBinanceAvailableTokensForReplenish(NetworkType networkType, Callbacks$Callback callbacks$Callback) {
        ...
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2062xebaea40e(this, callbacks$Callback)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2063xebaea40f((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final void calculateFeeForDonationsTransaction(long j, String str) {
        ...
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2056x998569d4(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2057x998569d5((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final SelectableToken resolveTokenArg() {
        ...
        if (!isSupportTokenOnNetwork(this.args.getCode())) {
            ((WalletSendAmountView) getViewState()).showToast(this.resourceManager.getString(C3316R.string.wallet_amount_send_unsupported_token_on_network_error));
            return null;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0068, code lost:
        if (r3.hasUser(r2.f1642id) != false) goto L24;
     */
    /*
    ...
    */
    public final void resolveAction(java.lang.String r7) {
        /*
            ...
            int[] r1 = com.iMe.p032ui.wallet.actions.send.amount.WalletSendAmountPresenter.WhenMappings.$EnumSwitchMapping$0
            int r0 = r0.ordinal()
            r0 = r1[r0]
            r1 = 1
            if (r0 == r1) goto L4f
        ...
        L4f:
            ...
            com.iMe.ui.wallet.actions.send.amount.WalletSendAmountView r0 = (com.iMe.p032ui.wallet.actions.send.amount.WalletSendAmountView) r0
        ...
        L6f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.actions.send.amount.WalletSendAmountPresenter.resolveAction(java.lang.String):void");
    }

    private final DialogModel getSendConfirmationDialogModel(String str) {
        return new DialogModel(this.resourceManager.getString(C3316R.string.wallet_amount_confirm_alert_title), getConfirmMessage(str), this.resourceManager.getString(C3316R.string.common_cancel), this.resourceManager.getString(C3316R.string.wallet_amount_confirm_alert_ok_btn));
    }
    ...
    private final void calculateFeeForTransaction(String str, String str2) {
        ...
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2058x2c16008d(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2059x2c16008e((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final void sendDonation(long j, TransferArgs.EVM evm) {
        ...
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog((Observable) observeOn, (BaseView) viewState, false).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2066xd0cb0852(this, evm)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2067xd0cb0853((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }

    private final void transferTokens(TransferArgs transferArgs, boolean z) {
        Observable<Result<Boolean>> observeOn = this.walletInteractor.sendTokens(getSelectedTokenCode(), transferArgs, this.selectedNetworkType.getBlockchainType()).observeOn(this.schedulersProvider.mo707ui());
        Intrinsics.checkNotNullExpressionValue(observeOn, "walletInteractor\n       …(schedulersProvider.ui())");
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog((Observable) observeOn, (BaseView) viewState, false).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2068x2cfbccbd(this, z, transferArgs)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2069x2cfbccbe((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    private final String getConfirmMessage(String str) {
        return this.resourceManager.getString(C3316R.string.wallet_amount_send_confirm_alert_description, BalanceFormatter.formatBalance(Double.valueOf(Double.parseDouble(str)), getSelectedTokenInfo().getDecimals()), this.resourceManager.getString(getSelectedTokenInfo().getShortName()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final String getSuccessMessage(double d) {
        return this.resourceManager.getString(C3316R.string.wallet_amount_success_send_description, BalanceFormatter.formatBalance(Double.valueOf(d), getSelectedTokenInfo().getDecimals()), this.resourceManager.getString(getSelectedTokenInfo().getShortName()));
    }
    ...
    private final void loadBalance(TokenCode tokenCode) {
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn, "walletInteractor\n       …(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2064xd63210e4(this, tokenCode)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2065xd63210e5((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void sendMessageToChat(long j, long j2, double d) {
        ...
        String string = this.resourceManager.getString(C3316R.string.wallet_amount_send_message_processing_name);
        ...
        if (user != null) {
            ...
            if (!(str == null || str.length() == 0)) {
                ...
                String string2 = this.resourceManager.getString(C3316R.string.wallet_amount_send_message_id);
        ...
        if (user2 != null) {
            ...
            if (!(str3 == null || str3.length() == 0)) {
                ...
                String string3 = this.resourceManager.getString(C3316R.string.wallet_amount_send_message_id);
    ...
    private final String formatMessageToUser(long j, double d, long j2, long j3) {
        ResourceManager resourceManager = this.resourceManager;
        int i = C3316R.string.wallet_amount_send_message_payload;
