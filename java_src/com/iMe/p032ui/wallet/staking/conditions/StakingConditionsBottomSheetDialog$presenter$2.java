...
final class StakingConditionsBottomSheetDialog$presenter$2 extends Lambda implements Function0<StakingConditionsPresenter> {
    ...
    /* loaded from: classes4.dex */
    public static final class C23171 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ StakingDetailsItem $stakingDetails;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23171(StakingDetailsItem stakingDetailsItem) {
            super(0);
            this.$stakingDetails = stakingDetailsItem;
        }
    ...
    public final StakingConditionsPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2315x8466ed51(this.this$0, null, new C23171(this.$stakingDetails)));
