...
public final class StakingConditionsBottomSheetDialog extends MvpBottomSheet implements StakingConditionsView {
    ...
    */
    public StakingConditionsBottomSheetDialog(com.iMe.model.staking.StakingDetailsItem r5, org.telegram.p048ui.ActionBar.BaseFragment r6) {
        /*
            r4 = this;
            ...
            r2.<init>()
            java.lang.Class<com.iMe.ui.wallet.staking.conditions.StakingConditionsPresenter> r3 = com.iMe.p032ui.wallet.staking.conditions.StakingConditionsPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.wallet.staking.conditions.StakingConditionsBottomSheetDialog.<init>(com.iMe.model.staking.StakingDetailsItem, org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    public void setupScreenWithData(int i, int i2, String name, String author, String annualPercentage, String startDate, String completionDate, String compoundThreshold, String plannedWithdrawalFeeText, String immediateWithdrawalFeeText, String finishedFeeText) {
        ...
        binding.viewAnnualPercentageCell.setupViewData(getResourceManager().getString(C3316R.string.staking_details_apy_apr), annualPercentage, C3316R.C3318drawable.fork_ic_percent, true);
        binding.viewStartDateCell.setupViewData(getResourceManager().getString(C3316R.string.staking_conditions_start), startDate, C3316R.C3318drawable.fork_ic_start, true);
        binding.viewCompletionDateCell.setupViewData(getResourceManager().getString(C3316R.string.staking_conditions_completion), completionDate, C3316R.C3318drawable.fork_ic_done_24, true);
        binding.viewThresholdCell.setupViewData(getResourceManager().getString(C3316R.string.staking_conditions_compound_threshold), compoundThreshold, C3316R.C3318drawable.fork_ic_donations_24, true);
        binding.viewPlannedWithdrawalFeeCell.setupViewData(getResourceManager().getString(C3316R.string.staking_conditions_planned_withdrawal), plannedWithdrawalFeeText, C3316R.C3318drawable.fork_ic_transactions_24, true);
        binding.viewImmediateWithdrawalFeeCell.setupViewData(getResourceManager().getString(C3316R.string.staking_conditions_immediate_withdrawal), immediateWithdrawalFeeText, C3316R.C3318drawable.fork_ic_ask_transfer_24, true);
        ...
        DetailsIconCellView.setupViewData$default(viewFinishedFeeCell, getResourceManager().getString(C3316R.string.staking_conditions_end_output), finishedFeeText, C3316R.C3318drawable.fork_ic_end_24, false, 8, null);
    }
    ...
    private final void setupTexts() {
        getBinding().buttonOk.setText(LocaleController.getString("OK", C3316R.string.OK));
    }
