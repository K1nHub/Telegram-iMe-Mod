...
public final class StakingOperationsFragment extends WalletAuthFragment implements StakingOperationsView, NavigationViewConfiguration, TabbedViewPagerDelegate<TabbedFragmentPage<MvpFragment>> {
    ...
    @Override // com.iMe.p032ui.wallet.staking.operations.StakingOperationsView
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_transactions_toolbar_title));
        c3381ActionBar.setAllowOverlayTitle(true);
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.wallet.staking.operations.StakingOperationsFragment$setupActionBar$1$1
        ...
        ActionBarMenuItem setupActionBar$lambda$13$lambda$12 = c3381ActionBar.createMenu().addItemWithWidth(IdFabric$Menu.NETWORK_SWITCH, 0, -2);
