...
import com.iMe.p032ui.wallet.staking.programmes.adapter.diff.StakingProgrammesDiffCallback;
...
public final class StakingProgrammesFragment extends WalletAuthFragment implements StakingProgrammesView {
    ...
    @Override // com.iMe.p032ui.wallet.staking.programmes.StakingProgrammesView
    ...
    public static final void setupListeners$lambda$11$lambda$10(StakingProgrammesFragment this$0, BaseQuickAdapter baseQuickAdapter, View view, int i) {
        ...
        int id = view.getId();
        if (id == C3316R.C3319id.image_header_right_button) {
            this$0.getPresenter().showSelectStakingOrderTypeDialog();
        } else if (id == C3316R.C3319id.image_info) {
            this$0.showStakingFiltersInfoDialog();
        }
    }

    private final void showStakingFiltersInfoDialog() {
        showDialog(DialogsFactoryKt.createInfoBottomSheetDialog$default(this, getResourceManager().getString(C3316R.string.staking_programmes_filters_info_title), getResourceManager().getString(C3316R.string.staking_programmes_filters_info_description), getResourceManager().getString(C3316R.string.common_ok), null, 8, null));
    }
