...
public final class StakingCalculatorProgrammesPresenter extends BasePresenter<StakingCalculatorProgrammesView> {
    ...
    public final void loadStakingProgrammes(boolean z, boolean z2) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2311x773d9f9f(this, z3, z)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2312x773d9fa0(null)));
