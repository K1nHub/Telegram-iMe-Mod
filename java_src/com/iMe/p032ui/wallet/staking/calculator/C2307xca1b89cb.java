...
public final class C2307xca1b89cb extends Lambda implements Function1<Result<? extends AccountLevel>, Unit> {
    ...
    public C2307xca1b89cb(StakingCalculatorPresenter stakingCalculatorPresenter, StakingDetailsItem stakingDetailsItem) {
        super(1);
    ...
    public final void m1498invoke(Result<? extends AccountLevel> it) {
