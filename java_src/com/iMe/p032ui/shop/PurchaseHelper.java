...
public final class PurchaseHelper {
    ...
    public final void preloadPurchasesInfo() {
        Single<List<String>> observeOn = this.aigramBotsManager.getAvailableSkus().subscribeOn(Schedulers.m688io()).observeOn(AndroidSchedulers.mainThread());
    ...
    public final void storeProductsInfo() {
        Completable observeOn = this.aigramBotsManager.storeActualPurchases(getProducts()).subscribeOn(Schedulers.m688io()).observeOn(AndroidSchedulers.mainThread());
