...
public final class FeeView extends FrameLayout implements KoinComponent {
    ...
    public final void displayFee(GasPriceItem gasPriceItem) {
        ...
        forkContentFeeBinding.textTimeValue.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_fee_duration_value, Integer.valueOf(gasPriceItem.getInfo().getDuration())));
    }
    ...
    private final void setupTexts() {
        ForkContentFeeBinding forkContentFeeBinding = this.binding;
        forkContentFeeBinding.textFeeTitle.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_fee_price));
        forkContentFeeBinding.textTimeTitle.setText(getResourceManager().getString(C3316R.string.wallet_swap_process_fee_duration));
    }
