...
public final class ChooseRecipientOptionsView extends FrameLayout implements KoinComponent {
    ...
    private final void setMixedClickListener(final View view, Function1<? super View, Unit> function1) {
        ...
        view.setOnTouchListener(new View.OnTouchListener() { // from class: com.iMe.ui.custom.ChooseRecipientOptionsView$$ExternalSyntheticLambda0
    ...
    private final void setupViews() {
        ...
        setupViews$lambda$8$lambda$5.setText(LocaleController.getString("Contacts", C3316R.string.Contacts));
        Intrinsics.checkNotNullExpressionValue(setupViews$lambda$8$lambda$5, "setupViews$lambda$8$lambda$5");
        setSizedStartIcon(setupViews$lambda$8$lambda$5, C3316R.C3318drawable.fork_drawer_social_telegram);
        TextView setupViews$lambda$8$lambda$6 = forkContentWalletChooseRecipientOptionsBinding.textTwitter;
        setupViews$lambda$8$lambda$6.setText(getResourceManager().getString(C3316R.string.drawer_social_network_twitter));
        Intrinsics.checkNotNullExpressionValue(setupViews$lambda$8$lambda$6, "setupViews$lambda$8$lambda$6");
        setSizedStartIcon(setupViews$lambda$8$lambda$6, C3316R.C3318drawable.fork_drawer_social_twitter);
        TextView setupViews$lambda$8$lambda$7 = forkContentWalletChooseRecipientOptionsBinding.textQr;
        setupViews$lambda$8$lambda$7.setText(getResourceManager().getString(C3316R.string.wallet_backup_secret_words_qr_title));
        Intrinsics.checkNotNullExpressionValue(setupViews$lambda$8$lambda$7, "setupViews$lambda$8$lambda$7");
        setSizedStartIcon(setupViews$lambda$8$lambda$7, C3316R.C3318drawable.msg_qrcode);
    }
