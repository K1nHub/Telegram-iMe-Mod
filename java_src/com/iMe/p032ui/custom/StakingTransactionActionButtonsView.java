...
public final class StakingTransactionActionButtonsView extends FrameLayout {
    ...
    public final void setupViewData(String actionText, boolean z, boolean z2, final Callbacks$Callback onActionClickAction, final Callbacks$Callback onConditionsClickAction, final Callbacks$Callback onApproveInfoClickAction) {
        ...
        bigActionButton.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.ui.custom.StakingTransactionActionButtonsView$$ExternalSyntheticLambda2
        ...
        setupViewData$lambda$6$lambda$3.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.ui.custom.StakingTransactionActionButtonsView$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        setupViewData$lambda$6$lambda$5.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.ui.custom.StakingTransactionActionButtonsView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void setupView() {
        ...
        forkContentStakingTransactionActionsBinding.buttonConditions.setText(LocaleController.getInternalString(C3316R.string.staking_deposit_conditions));
        forkContentStakingTransactionActionsBinding.buttonApproveInfo.setText(LocaleController.getInternalString(C3316R.string.wallet_swap_process_what_is_approve));
