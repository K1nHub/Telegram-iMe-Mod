...
public final class StakingPercentageView extends FrameLayout implements KoinComponent {
    ...
    public final void setupViewData(StakingAnnualPercentageData stakingAnnualPercentageData, Callbacks$Callback onInfoClickAction) {
        ...
        ViewExtKt.safeThrottledClick$default(imageInfo, 0L, new StakingPercentageView$setupViewData$1$1(onInfoClickAction), 1, null);
        if (stakingAnnualPercentageData == null) {
            return;
        }
        AppCompatTextView appCompatTextView = forkContentStakingCompoundBinding.textApr;
        appCompatTextView.setText(LocaleController.getInternalString(C3316R.string.staking_programme_apr) + getAnnualPercentageText(stakingAnnualPercentageData.getApr()));
        AppCompatTextView appCompatTextView2 = forkContentStakingCompoundBinding.textApy;
        appCompatTextView2.setText(LocaleController.getInternalString(C3316R.string.staking_programme_apy) + getAnnualPercentageText(stakingAnnualPercentageData.getApy()));
