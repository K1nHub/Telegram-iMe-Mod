...
public class StakingDashboardView extends FrameLayout implements KoinComponent {
    ...
    private final void showLoading() {
        ...
        TextView textView = forkContentStakingDashboardBinding.textStakedValue;
        ResourceManager resourceManager = getResourceManager();
        int i = C3316R.string.common_progress_state_title;
    ...
    private final void setupViews() {
        ...
        ForkContentStakingDashboardBinding forkContentStakingDashboardBinding = this.binding;
        forkContentStakingDashboardBinding.textHeader.setText(getResourceManager().getString(C3316R.string.staking_dashboard_header));
        forkContentStakingDashboardBinding.viewDiagram.setCustomSize(AndroidUtilities.m50dp(75));
        forkContentStakingDashboardBinding.textStakedTitle.setText(getResourceManager().getString(C3316R.string.staking_dashboard_staked_title));
        forkContentStakingDashboardBinding.textProfitTitle.setText(getResourceManager().getString(C3316R.string.staking_dashboard_profit_title));
        HorizontalActionButtonsView horizontalActionButtonsView = forkContentStakingDashboardBinding.horizontalActionButtons;
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new HorizontalActionButtonItem[]{new HorizontalActionButtonItem(C3316R.C3318drawable.fork_wallet_staking_dashboard_calculator, getResourceManager().getString(C3316R.string.staking_dashboard_calculator), false, new StakingDashboardView$setupViews$1$1(this), 4, null), new HorizontalActionButtonItem(C3316R.C3318drawable.fork_wallet_staking_dashboard_history, getResourceManager().getString(C3316R.string.staking_dashboard_history), false, new StakingDashboardView$setupViews$1$2(this), 4, null)});
