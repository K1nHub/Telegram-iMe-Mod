...
public final class BackupWordSwitcher extends MvpFrameLayout implements KoinComponent, BackupWordSwitcherMvpView {
    ...
    public final void applyColors() {
        ...
        filter = SequencesKt___SequencesKt.filter(ViewGroupKt.getChildren(constraintWords), C1981xbf3f1d4f.INSTANCE);
    ...
    @Override // com.iMe.p032ui.custom.backup.switcher.BackupWordSwitcherMvpView
    public void setupTitle(int i) {
        this.binding.textTitle.setText(getResourceManager().getString(C3316R.string.wallet_eth_backup_confirm_word_description, Integer.valueOf(i)));
    }
