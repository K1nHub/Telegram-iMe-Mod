...
public final class C2015x1018a95b extends Lambda implements Function1<Result<? extends List<? extends RecognizedImageModel>>, Unit> {
    final /* synthetic */ PhotoViewerPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2015x1018a95b(PhotoViewerPresenter photoViewerPresenter) {
        super(1);
    ...
    public final void m1338invoke(Result<? extends List<? extends RecognizedImageModel>> it) {
