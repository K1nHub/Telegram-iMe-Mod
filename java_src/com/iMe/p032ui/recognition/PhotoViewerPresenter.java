...
public final class PhotoViewerPresenter extends BasePresenter<PhotoView> {
    ...
    public final void getPhotoText(Bitmap imageBitmap, boolean z) {
        ...
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2017x260b9b6c(z, this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2018x260b9b6d((BaseView) getViewState())));
    ...
    public final void getPhotoObjects(Bitmap photo) {
        ...
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2015x1018a95b(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2016x1018a95c((BaseView) getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
}
