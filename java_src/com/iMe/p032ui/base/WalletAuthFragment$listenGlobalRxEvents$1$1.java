...
final class WalletAuthFragment$listenGlobalRxEvents$1$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        WalletHelper.safeRunWalletScreen$default(walletAuthFragment, walletAuthFragment.getResourceManager().getString(C3316R.string.wallet_auth_dialog_secure_description), null, null, 6, null);
    }
}
