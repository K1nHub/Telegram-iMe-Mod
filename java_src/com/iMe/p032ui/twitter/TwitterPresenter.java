...
public final class TwitterPresenter extends BasePresenter<TwitterView> {
    ...
    public final void loadTweets(boolean z, boolean z2) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2038x586e495a(this, z3, z)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2039x586e495b(null)));
    ...
    private final void subscribeToLikeToggles() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2040xbd4bb315(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2041xbd4bb316(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
