...
import com.iMe.p032ui.twitter.search.adapter.diff.TwitterSearchDiffCallback;
...
public final class TwitterSearchFragment extends MvpFragment implements TwitterSearchView {
    ...
    public void showRequestPermissionSuccessDialog(String title, String message, Callbacks$Callback action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        DialogsFactoryKt.showSuccessAlert(this, title, message, getResourceManager().getString(C3316R.string.common_ok), action);
    }
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.wallet_binance_receive_choose_contact_title));
        ActionBarMenuItem actionBarMenuItemSearchListener = c3381ActionBar.createMenu().addItem(IdFabric$Menu.SEARCH_TWITTER, C3316R.C3318drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: com.iMe.ui.twitter.search.TwitterSearchFragment$setupActionBar$1$1
        ...
        actionBarMenuItemSearchListener.setSearchFieldHint(getResourceManager().getString(C3316R.string.twitter_search_hint));
        actionBarMenuItemSearchListener.setContentDescription(LocaleController.getString("Search", C3316R.string.Search));
        this.searchItem = actionBarMenuItemSearchListener;
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.twitter.search.TwitterSearchFragment$setupActionBar$1$3
