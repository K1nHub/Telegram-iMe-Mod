...
@InjectViewState
/* renamed from: com.iMe.ui.twitter.search.TwitterSearchPresenter */
...
public final class TwitterSearchPresenter extends BasePresenter<TwitterSearchView> {
    ...
    public final void searchByQuery(boolean z) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2049x1f435055(this, z2, z)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2050x1f435056(null)));
    ...
    public final void onUserClick(TwitterUserItem twitterUserItem) {
        ...
        Intrinsics.checkNotNullExpressionValue(RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2047x18d788a(twitterUserItem, this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2048x18d788b(null))), "viewState: BaseView? = n…  onError.invoke()\n    })");
    }
    ...
    public final void onInviteClick(TwitterInviteItem twitterInviteItem) {
        ...
        ((TwitterSearchView) getViewState()).showInviteConfirmationDialog(new DialogModel(this.resourceManager.getString(C3316R.string.twitter_search_invite_confirmation_title), this.resourceManager.getString(C3316R.string.twitter_search_invite_confirmation_description, twitterInviteItem.getNickname()), LocaleController.getString("Cancel", C3316R.string.Cancel), LocaleController.getString("Send", C3316R.string.Send)), twitterInviteItem.getId());
    }
    ...
    public final void sendInvite(long j) {
        ...
        T viewState = getViewState();
        Intrinsics.checkNotNullExpressionValue(viewState, "viewState");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2051x2420976b(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2052x2420976c(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void processSelectedRecipient(String id, String address) {
        ...
        while (true) {
            ...
            obj = it.next();
            long j = ((TwitterUserItem) obj).getUser().f1642id;
    ...
    private final void subscribeToQueryChanges() {
        ...
        Observable observeOn = debounce.map(new Function() { // from class: com.iMe.ui.twitter.search.TwitterSearchPresenter$$ExternalSyntheticLambda2
        ...
        Observable observeOn2 = observeOn.filter(new Predicate() { // from class: com.iMe.ui.twitter.search.TwitterSearchPresenter$$ExternalSyntheticLambda3
        ...
        Observable observeOn3 = observeOn2.switchMap(new Function() { // from class: com.iMe.ui.twitter.search.TwitterSearchPresenter$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
        ...
        Disposable subscribe = observeOn3.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2053x72bd2d8c(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2054x72bd2d8d(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final Observable<Result<List<BaseNode>>> getSearchObservable() {
        ...
        final C2046x61014ef0 c2046x61014ef0 = new C2046x61014ef0(this);
        Observable<R> flatMap = searchUsersByUsername.flatMap(new Function(c2046x61014ef0) { // from class: com.iMe.ui.twitter.search.TwitterSearchPresenter$inlined$sam$i$io_reactivex_functions_Function$0
            private final /* synthetic */ Function1 function;

            {
                Intrinsics.checkNotNullParameter(c2046x61014ef0, "function");
                this.function = c2046x61014ef0;
            }
    ...
    public final Observable<Result<List<BaseNode>>> flatMapSearchResult(Result<? extends List<TwitterUserInfo>> result) {
        ...
        Observable map = observeOn.map(new Function() { // from class: com.iMe.ui.twitter.search.TwitterSearchPresenter$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
    ...
    /* compiled from: TwitterSearchPresenter.kt */
    /* renamed from: com.iMe.ui.twitter.search.TwitterSearchPresenter$Companion */
    /* loaded from: classes3.dex */
