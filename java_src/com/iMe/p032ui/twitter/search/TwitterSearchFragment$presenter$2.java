...
final class TwitterSearchFragment$presenter$2 extends Lambda implements Function0<TwitterSearchPresenter> {
    ...
    public static final class C20451 extends Lambda implements Function0<ParametersHolder> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C20451(BlockchainType blockchainType) {
            super(0);
            this.$blockchainType = blockchainType;
        }
    ...
    public final TwitterSearchPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2044xf65f4133(this.this$0, null, new C20451(this.$blockchainType)));
