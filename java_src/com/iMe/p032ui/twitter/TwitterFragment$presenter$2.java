...
final class TwitterFragment$presenter$2 extends Lambda implements Function0<TwitterPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C20371 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ long $telegramProfileId;
        final /* synthetic */ long $twitterUserId;
        final /* synthetic */ String $twitterUserNickname;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C20371(long j, long j2, String str) {
            super(0);
            this.$telegramProfileId = j;
            this.$twitterUserId = j2;
            this.$twitterUserNickname = str;
    ...
    public final TwitterPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new TwitterFragment$presenter$2$invoke$$inlined$inject$default$1(this.this$0, null, new C20371(this.$telegramProfileId, this.$twitterUserId, this.$twitterUserNickname)));
