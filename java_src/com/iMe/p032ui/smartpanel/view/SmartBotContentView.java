package com.iMe.p032ui.smartpanel.view;
...
import com.iMe.p032ui.smartpanel.adapter.SmartBotContentAdapter;
...
import com.iMe.p032ui.smartpanel.model.content.TabBotMediaAnswerItem;
...
public final class SmartBotContentView extends FrameLayout implements SmartBotContentAdapter.OnLoadGifListener {
    ...
    public SmartBotContentView(final Context context, SmartBotTab content, BotResponseType currentBotResponseType, final SmartBotsView.Listener listener, long j) {
            ...
            protected Size getSizeForItem(int i) {
                ...
                if (media != null) {
                    ...
                    if (tLRPC$Document != null) {
                        ...
                        size3.width = closestPhotoSizeWithSize != null ? closestPhotoSizeWithSize.f1533w : 100;
                        size3.height = closestPhotoSizeWithSize != null ? closestPhotoSizeWithSize.f1532h : 100;
                        ...
                        while (i2 < size4) {
                            ...
                            if ((tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeVideo)) {
                                ...
                                size5.width = tLRPC$DocumentAttribute.f1513w;
                                size5.height = tLRPC$DocumentAttribute.f1512h;
                                break;
                            }
                            i2++;
                        }
                        ...
                        if (tLRPC$WebDocument != null) {
                            ...
                            while (i2 < size6) {
                                ...
                                if ((tLRPC$DocumentAttribute2 instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute2 instanceof TLRPC$TL_documentAttributeVideo)) {
                                    ...
                                    size7.width = tLRPC$DocumentAttribute2.f1513w;
                                    size7.height = tLRPC$DocumentAttribute2.f1512h;
                                    break;
                                }
                                i2++;
                            }
                            ...
                            if (tLRPC$WebDocument2 != null) {
                                ...
                                while (i2 < size8) {
                                    ...
                                    if ((tLRPC$DocumentAttribute3 instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute3 instanceof TLRPC$TL_documentAttributeVideo)) {
                                        ...
                                        size9.width = tLRPC$DocumentAttribute3.f1513w;
                                        size9.height = tLRPC$DocumentAttribute3.f1512h;
                                        break;
                                    }
                                    i2++;
                                }
                                ...
                                if (tLRPC$Photo != null) {
                                    ...
                                    if (closestPhotoSizeWithSize2 != null) {
                                        ...
                                        size10.width = closestPhotoSizeWithSize2.f1533w;
                                        size10.height = closestPhotoSizeWithSize2.f1532h;
                                    }
                                }
                            }
                        }
            ...
            */
            public org.telegram.p048ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r5, org.telegram.tgnet.TLRPC$FileLocation r6, int r7, boolean r8) {
                /*
                    ...
                    r5 = 0
                    if (r7 < 0) goto L83
                    com.iMe.ui.smartpanel.view.SmartBotContentView r6 = com.iMe.p032ui.smartpanel.view.SmartBotContentView.this
                    com.iMe.ui.smartpanel.adapter.SmartBotContentAdapter r6 = com.iMe.p032ui.smartpanel.view.SmartBotContentView.access$getListViewAdapter$p(r6)
                ...
                L14:
                    ...
                    com.iMe.ui.smartpanel.view.SmartBotContentView r8 = com.iMe.p032ui.smartpanel.view.SmartBotContentView.this
                    com.iMe.ui.smartpanel.adapter.SmartBotContentAdapter r8 = com.iMe.p032ui.smartpanel.view.SmartBotContentView.access$getListViewAdapter$p(r8)
                ...
                L30:
                    if (r0 >= r6) goto L83
                    com.iMe.ui.smartpanel.view.SmartBotContentView r1 = com.iMe.p032ui.smartpanel.view.SmartBotContentView.this
                    org.telegram.ui.Components.RecyclerListView r1 = com.iMe.p032ui.smartpanel.view.SmartBotContentView.access$getListView$p(r1)
                ...
                L53:
                    ...
                    r5 = r5[r7]
                    r6.viewY = r5
                    com.iMe.ui.smartpanel.view.SmartBotContentView r5 = com.iMe.p032ui.smartpanel.view.SmartBotContentView.this
                    org.telegram.ui.Components.RecyclerListView r5 = com.iMe.p032ui.smartpanel.view.SmartBotContentView.access$getListView$p(r5)
                    r6.parentView = r5
                    r6.imageReceiver = r2
                ...
                L83:
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.smartpanel.view.SmartBotContentView$gifContextProvider$1.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
        ...
        textView.setText(LocaleController.getInternalString(C3316R.string.chat_send_panel_neurobot_not_have_gifs));
        textView.setTextColor(ContextCompat.getColor(context, C3316R.C3317color.gray_message));
    ...
    @Override // com.iMe.p032ui.smartpanel.adapter.SmartBotContentAdapter.OnLoadGifListener
