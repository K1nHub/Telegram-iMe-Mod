...
public abstract class TelegramViewPagerFragment extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setOccupyStatusBar(!AndroidUtilities.isTablet());
        c3381ActionBar.setBackButtonImage(C3316R.C3318drawable.ic_ab_back);
        c3381ActionBar.setTitle(getToolbarTitle());
        c3381ActionBar.setExtraHeight(AndroidUtilities.m51dp(getAdditionalActionBarHeight() + 44.0f));
        c3381ActionBar.setAllowOverlayTitle(false);
        c3381ActionBar.setAddToContainer(false);
        c3381ActionBar.setClipContent(true);
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.pager.TelegramViewPagerFragment$setupActionBar$1$1
        ...
        ViewParent parent = c3381ActionBar.getParent();
        ViewGroup viewGroup = parent instanceof ViewGroup ? (ViewGroup) parent : null;
        if (viewGroup != null) {
            viewGroup.removeView(c3381ActionBar);
        }
    }
