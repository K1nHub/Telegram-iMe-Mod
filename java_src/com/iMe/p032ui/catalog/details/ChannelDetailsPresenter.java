...
public final class ChannelDetailsPresenter extends BasePresenter<ChannelDetailsView> {
    ...
    public final void onSubscribeClick() {
        ...
        Disposable subscribe = flatMap.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1940x14036c9b(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1941x14036c9c(null)));
    ...
    public final void createChannelQr() {
        ((ChannelDetailsView) getViewState()).showChannelQr(this.chat.f1502id);
    }
