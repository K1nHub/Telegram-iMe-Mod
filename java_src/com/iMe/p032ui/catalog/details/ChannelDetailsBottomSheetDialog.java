...
import com.iMe.p032ui.custom.ChannelTagView;
...
public final class ChannelDetailsBottomSheetDialog extends MvpBottomSheet implements ChannelDetailsView {
    ...
    */
    public ChannelDetailsBottomSheetDialog(com.iMe.model.catalog.CampaignItem r3, org.telegram.tgnet.TLRPC$Chat r4, com.iMe.storage.domain.model.catalog.ChatType r5, org.telegram.p048ui.ActionBar.BaseFragment r6) {
        /*
            r2 = this;
            ...
            r6.<init>()
            java.lang.Class<com.iMe.ui.catalog.details.ChannelDetailsPresenter> r0 = com.iMe.p032ui.catalog.details.ChannelDetailsPresenter.class
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.p032ui.catalog.details.ChannelDetailsBottomSheetDialog.<init>(com.iMe.model.catalog.CampaignItem, org.telegram.tgnet.TLRPC$Chat, com.iMe.storage.domain.model.catalog.ChatType, org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    public void setupCampaignInfo(CampaignItem campaignItem) {
        ...
        ImageViewExtKt.loadFromWithPlaceholderResId(imageAvatar, photo, context, Integer.valueOf(C3316R.C3318drawable.photo_placeholder_in), true);
    ...
    public void setupSubscribeButton(boolean z) {
        ...
        if (i != 1) {
            ...
            if (z) {
                string = LocaleController.getString("JoinGroup", C3316R.string.JoinGroup);
            } else {
                string = LocaleController.getString("LeaveMegaMenu", C3316R.string.LeaveMegaMenu);
            }
        } else if (z) {
            string = LocaleController.getString("ChannelJoin", C3316R.string.ChannelJoin);
        } else {
            string = LocaleController.getString("LeaveChannel", C3316R.string.LeaveChannel);
        }
    ...
    private final void setupViews() {
        ...
        binding.textLanguageTitle.setText(getResourceManager().getString(C3316R.string.catalog_channel_details_language));
        binding.textTags.setText(getResourceManager().getString(C3316R.string.catalog_channel_details_tags));
        setupButtonMore();
    }
    ...
    private final void setupButtonMore() {
        ...
        setupButtonMore$lambda$18.setIcon(C3316R.C3318drawable.ic_ab_other);
        ...
        setupButtonMore$lambda$18.addSubItem(IdFabric$Menu.SHARE, C3316R.C3318drawable.share, LocaleController.getString("ShareLink", C3316R.string.ShareLink));
        setupButtonMore$lambda$18.addSubItem(IdFabric$Menu.COPY, C3316R.C3318drawable.msg_link2, LocaleController.getString("CopyLink", C3316R.string.CopyLink));
        setupButtonMore$lambda$18.addSubItem(IdFabric$Menu.f254QR, C3316R.C3318drawable.msg_qrcode, LocaleController.getString("GetQRCode", C3316R.string.GetQRCode));
        ...
        setupButtonMore$lambda$18.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3316R.string.AccDescrMoreOptions));
    }
