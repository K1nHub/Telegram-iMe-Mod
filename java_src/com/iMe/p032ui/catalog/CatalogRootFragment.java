...
import com.iMe.p032ui.wallet.common.BottomNavigationDelegate;
...
public final class CatalogRootFragment extends MvpFragment implements BottomNavigationDelegate, CatalogRootView, NavigationViewConfiguration {
    ...
    @Override // com.iMe.p032ui.wallet.common.BottomNavigationDelegate
    ...
    @Override // com.iMe.p032ui.catalog.CatalogRootView
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(getResourceManager().getString(C3316R.string.catalog_title));
        c3381ActionBar.setAllowOverlayTitle(true);
        c3381ActionBar.createMenu().addItem(IdFabric$Menu.LANGUAGE, C3316R.C3318drawable.msg_language);
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.ui.catalog.CatalogRootFragment$setupActionBar$1$1
    ...
    public final List<NavigationTab<CatalogFragment>> initTabs() {
        ...
        int i = C3316R.C3319id.catalog_root_bottom_navigation_channels;
        CatalogFragment.Companion companion = CatalogFragment.Companion;
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new NavigationTab(i, companion.newInstance(ChatType.CHANNEL)), new NavigationTab(C3316R.C3319id.catalog_root_bottom_navigation_groups, companion.newInstance(ChatType.GROUP)));
    ...
    private final void setupBottomNavigationBar() {
        ...
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new MenuItem(C3316R.C3319id.catalog_root_bottom_navigation_channels, getResourceManager().getString(C3316R.string.catalog_navigation_channels), C3316R.C3318drawable.fork_filter_icon_channel, true, getResourceManager().getColor(17170443), false, 32, null), new MenuItem(C3316R.C3319id.catalog_root_bottom_navigation_groups, getResourceManager().getString(C3316R.string.catalog_navigation_groups), C3316R.C3318drawable.msg_groups, true, getResourceManager().getColor(17170443), false, 32, null));
