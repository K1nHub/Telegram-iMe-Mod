...
public final class CatalogRootPresenter extends BasePresenter<CatalogRootView> implements NotificationCenter.NotificationCenterDelegate {
    ...
    public CatalogRootPresenter(CatalogInteractor catalogInteractor, PreferenceHelper preferenceHelper, ResourceManager resourceManager, SchedulersProvider schedulersProvider, TelegramControllersGateway telegramControllersGateway) {
        ...
        this.selectedTabId = C3316R.C3319id.catalog_root_bottom_navigation_channels;
    ...
    public void onFirstViewAttach() {
        selectTab(C3316R.C3319id.catalog_root_bottom_navigation_channels);
    ...
    private final void loadLanguages() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1935xc92b31a1(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1936xc92b31a2(null)));
    ...
    public final LocaleController.LocaleInfo getAllLanguagesLocaleInfo() {
        ...
        localeInfo.name = this.resourceManager.getString(C3316R.string.catalog_all);
        localeInfo.nameEnglish = this.resourceManager.getString(C3316R.string.catalog_all_languages);
