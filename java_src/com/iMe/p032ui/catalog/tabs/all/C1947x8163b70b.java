...
public final class C1947x8163b70b extends Lambda implements Function1<TLRPC$Chat, Unit> {
    final /* synthetic */ CampaignItem $campaign$inlined;
    final /* synthetic */ CatalogAllPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1947x8163b70b(CatalogAllPresenter catalogAllPresenter, CampaignItem campaignItem) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(TLRPC$Chat tLRPC$Chat) {
        m1307invoke(tLRPC$Chat);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1307invoke(TLRPC$Chat it) {
        ChatType chatType;
