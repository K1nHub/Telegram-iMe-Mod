...
import com.iMe.p032ui.catalog.tabs.all.CatalogAllFragment;
import com.iMe.p032ui.catalog.tabs.categories.CatalogCategoriesFragment;
import com.iMe.p032ui.catalog.tabs.user_channels.CatalogUserChannelsFragment;
import com.iMe.p032ui.wallet.common.BottomNavigationTabFragment;
...
public final class CatalogFragment extends BottomNavigationTabFragment implements CatalogView, NavigationViewConfiguration, TabbedViewPagerDelegate<TabbedFragmentPage<CatalogTabFragment>> {
    ...
    @Override // com.iMe.p032ui.catalog.tabs.CatalogView
    ...
    public final List<CatalogNavigationTab> initPageTabs() {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new CatalogNavigationTab[]{new CatalogNavigationTab(C3316R.C3319id.catalog_all, new TabbedFragmentPage(getResourceManager().getString(C3316R.string.catalog_all), 0, CatalogAllFragment.Companion.newInstance(this.chatType), new CatalogFragment$initPageTabs$1(this), 2, null)), new CatalogNavigationTab(C3316R.C3319id.catalog_categories, new TabbedFragmentPage(getResourceManager().getString(C3316R.string.catalog_categories), 0, CatalogCategoriesFragment.Companion.newInstance(this.chatType), new CatalogFragment$initPageTabs$2(this), 2, null)), new CatalogNavigationTab(C3316R.C3319id.catalog_user_channels, new TabbedFragmentPage(getResourceManager().getString(C3316R.string.catalog_user_channels), 0, CatalogUserChannelsFragment.Companion.newInstance(this.chatType), new CatalogFragment$initPageTabs$3(this), 2, null))});
