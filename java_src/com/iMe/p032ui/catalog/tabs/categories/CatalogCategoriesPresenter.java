...
public final class CatalogCategoriesPresenter extends BasePresenter<CatalogCategoriesView> {
    ...
    public final void loadChannels(boolean z) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1952xb19ad2ea(this, z)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1953xb19ad2eb(null)));
    ...
    public final void onChannelClick(CampaignItem campaign) {
        ...
        Intrinsics.checkNotNullExpressionValue(RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1956xc0315c98(this, campaign)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1957xc0315c99(null))), "viewState: BaseView? = n…  onError.invoke()\n    })");
    }
    ...
    private final void loadInitial(boolean z) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1954x9d757cd0(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1955x9d757cd1(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final Observable<Result<CampaignsCursored>> getCategoriesObservable(Result<CampaignsCursored> result, boolean z) {
        ...
        final C1951xf97b28f1 c1951xf97b28f1 = new C1951xf97b28f1(this, result);
        Observable map = observeOn.map(new Function(c1951xf97b28f1) { // from class: com.iMe.ui.catalog.tabs.categories.CatalogCategoriesPresenter$inlined$sam$i$io_reactivex_functions_Function$0
            private final /* synthetic */ Function1 function;

            {
                Intrinsics.checkNotNullParameter(c1951xf97b28f1, "function");
                this.function = c1951xf97b28f1;
            }
    ...
    public final FilterItem getCategoryAll() {
        String upperCase = this.resourceManager.getString(C3316R.string.catalog_all).toUpperCase(Locale.ROOT);
