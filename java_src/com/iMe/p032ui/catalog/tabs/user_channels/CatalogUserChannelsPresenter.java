...
public final class CatalogUserChannelsPresenter extends BasePresenter<CatalogUserChannelsView> {
    ...
    private final void showItems() {
        ...
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new CreateCampaignItem(C3316R.C3318drawable.fork_ic_add_account_40, C3316R.string.catalog_user_channels_create));
