...
public final class BinanceTransactionProvider extends BaseNodeProvider<BinanceTransactionItem> {
    ...
    public void convert(BaseViewHolder helper, BinanceTransactionItem item) {
        ...
        BaseViewHolder mediumTypeface = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setVisibleElseGone(themedTextColor4, i6, !RecycleViewExtKt.isLastItem(helper, adapter)).setImageResource(C3316R.C3319id.image_transaction_type_icon, item.getTransactionIcon()), i3);
