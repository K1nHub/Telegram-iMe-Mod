...
public final class BinanceAccountProvider$convert$1 extends Lambda implements Function1<ActionBarMenuItem, Unit> {
    ...
    public final void invoke2(final ActionBarMenuItem applyForView) {
        ...
        applyForView.setIcon(C3316R.C3318drawable.ic_ab_other);
        ViewExtKt.setCircleRippleBackground(applyForView);
        applyForView.removeAllSubItems();
        int i = IdFabric$Menu.RECEIVE;
        int i2 = C3316R.C3318drawable.fork_ic_ask_transfer_24;
        resourceManager = this.this$0.resourceManager;
        applyForView.addSubItem(i, i2, resourceManager.getString(C3316R.string.wallet_binance_pay_action_receive));
        applyForView.addSubItem(IdFabric$Menu.LOGOUT, C3316R.C3318drawable.msg_leave, LocaleController.getString("LogOut", C3316R.string.LogOut));
        ...
        applyForView.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3316R.string.AccDescrMoreOptions));
    }
