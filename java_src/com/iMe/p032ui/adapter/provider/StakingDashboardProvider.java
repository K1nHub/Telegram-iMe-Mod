...
public final class StakingDashboardProvider extends BaseNodeProvider<StakingDashboardItem> {
    ...
    private final int layoutId = C3316R.layout.fork_recycle_item_staking_dashboard;
    ...
    public void convert(BaseViewHolder helper, StakingDashboardItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper, C3316R.C3319id.view_staking_dashboard, new StakingDashboardProvider$convert$1(item, this));
    }
    ...
    public void convert(BaseViewHolder helper, StakingDashboardItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper, C3316R.C3319id.view_staking_dashboard, new StakingDashboardProvider$convert$2(item));
    }
}
