...
public final class C1982x46f36637 extends Lambda implements Function1<Result<? extends SearchResponse>, Unit> {
    final /* synthetic */ String $page$inlined;
    final /* synthetic */ EmojiViewPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1982x46f36637(EmojiViewPresenter emojiViewPresenter, String str) {
        super(1);
    ...
    public final void m1321invoke(Result<? extends SearchResponse> it) {
