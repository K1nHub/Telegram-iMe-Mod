...
public final class EmojiViewPresenter extends BasePresenter<EmojiViewView> {
    ...
    public final void loadKiklikoTags() {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1984x8b56867d(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1985x8b56867e(null)));
    ...
    public final void searchByKeyword(String keyword, String page) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1992xae9d3566(this, keyword, page)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1993xae9d3567(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
    ...
    public final void searchByTag(String tag, String page) {
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn, "kiklikoInteractor.search…(schedulersProvider.ui())");
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1994xbea5fe97(this, tag, page)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1995xbea5fe98(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        this.lastSearchDisposable = subscribe;
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void getTrending(String page) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1982x46f36637(this, page)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1983x46f36638(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        this.lastSearchDisposable = subscribe;
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void onGifWasSent(String slug) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1988x605e6f86()), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1989x605e6f87(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void onGifPreviewAsOpened(String slug) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1986x1baa1388()), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1987x1baa1389(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
    ...
    public final void report(String slug, String reason) {
        ...
        Disposable subscribe = observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1990xb31cfe()), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1991xb31cff(null)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        BasePresenter.autoDispose$default(this, subscribe, null, 1, null);
    }
}
