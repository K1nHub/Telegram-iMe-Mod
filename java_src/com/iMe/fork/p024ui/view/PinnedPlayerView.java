...
public class PinnedPlayerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public PinnedPlayerView(final Context context, INavigationLayout iNavigationLayout, LaunchActivity launchActivity) {
        ...
        int i2 = C3473R.C3475drawable.ic_ab_other;
        ...
        int i4 = C3473R.C3475drawable.chats_unpin;
        int i5 = C3473R.string.DialogUnpin;
        ...
        actionBarMenuItem.addSubItem(i6, C3473R.C3475drawable.msg_calls_minimize, LocaleController.getString("VoipGroupMinimizeStream", C3473R.string.VoipGroupMinimizeStream));
        ...
        this.repeatSongItem = actionBarMenuItem2.addSubItem(3, C3473R.C3475drawable.player_new_repeatone, LocaleController.getString("RepeatSong", C3473R.string.RepeatSong));
        this.repeatListItem = actionBarMenuItem2.addSubItem(4, C3473R.C3475drawable.player_new_repeatall, LocaleController.getString("RepeatList", C3473R.string.RepeatList));
        this.shuffleListItem = actionBarMenuItem2.addSubItem(2, C3473R.C3475drawable.player_new_shuffle, LocaleController.getString("ShuffleList", C3473R.string.ShuffleList));
        this.reverseOrderItem = actionBarMenuItem2.addSubItem(1, C3473R.C3475drawable.player_new_order, LocaleController.getString("ReverseOrder", C3473R.string.ReverseOrder));
        frameLayout2.addView(actionBarMenuItem2, LayoutHelper.createFrame(48, 48, 51));
        C15648 c15648 = new C15648(context, scaledTouchSlop);
        this.prevButton = c15648;
        c15648.setScaleType(ImageView.ScaleType.CENTER);
        int i8 = C3473R.raw.player_prev;
        c15648.setAnimation(i8, 20, 20);
        c15648.setContentDescription(LocaleController.getString("AccDescrPrevious", C3473R.string.AccDescrPrevious));
        frameLayout2.addView(c15648, LayoutHelper.createFrame(48, 48, 51));
        ...
        C15679 c15679 = new C15679(context, scaledTouchSlop);
        this.nextButton = c15679;
        c15679.setScaleType(ImageView.ScaleType.CENTER);
        c15679.setAnimation(i8, 20, 20);
        c15679.setRotation(180.0f);
        c15679.setContentDescription(LocaleController.getString("Next", C3473R.string.Next));
        frameLayout2.addView(c15679, LayoutHelper.createFrame(48, 48, 51));
        ...
        View[] viewArr = {actionBarMenuItem2, c15648, imageView, c15679, actionBarMenuItem3};
        ...
        actionBarMenuItem3.addSubItem(i6, C3473R.C3475drawable.pip_video_expand, LocaleController.getString("VoipGroupExpandStream", C3473R.string.VoipGroupExpandStream));
        ...
        actionBarMenuItem3.addSubItem(1, C3473R.C3475drawable.msg_forward, LocaleController.getString("Forward", C3473R.string.Forward));
        actionBarMenuItem3.addSubItem(IdFabric$Menu.MESSAGE_SAVE_CLOUD, C3473R.C3475drawable.fork_forward_cloud, LocaleController.getInternalString(C3473R.string.chat_message_popup_option_forward_cloud));
        actionBarMenuItem3.addSubItem(2, C3473R.C3475drawable.msg_shareout, LocaleController.getString("ShareFile", C3473R.string.ShareFile));
        actionBarMenuItem3.addSubItem(5, C3473R.C3475drawable.msg_download, LocaleController.getString("SaveToMusic", C3473R.string.SaveToMusic));
        actionBarMenuItem3.addSubItem(4, C3473R.C3475drawable.msg_message, LocaleController.getString("ShowInChat", C3473R.string.ShowInChat));
        ...
        actionBarMenuItem3.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3473R.string.AccDescrMoreOptions));
    ...
    /* loaded from: classes4.dex */
    class C15648 extends RLottieImageView {
        ...
        C15648(Context context, float f) {
            super(context);
            ...
            this.pressedRunnable = new Runnable() { // from class: com.iMe.fork.ui.view.PinnedPlayerView.8.1
                @Override // java.lang.Runnable
                public void run() {
                    C15648 c15648 = C15648.this;
                    int i = c15648.pressedCount + 1;
                    c15648.pressedCount = i;
                    if (i != 1) {
                        if (i == 2) {
                    ...
                    C15648.this.lastTime = System.currentTimeMillis();
                    AndroidUtilities.runOnUIThread(this, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                    AndroidUtilities.runOnUIThread(C15648.this.backSeek);
                }
            };
            this.backSeek = new Runnable() { // from class: com.iMe.fork.ui.view.PinnedPlayerView.8.2
                ...
                public void run() {
                    ...
                    if (duration != 0 && duration != C0479C.TIME_UNSET) {
                        ...
                        long currentTimeMillis = System.currentTimeMillis();
                        C15648 c15648 = C15648.this;
                        long j = currentTimeMillis - c15648.lastTime;
                        c15648.lastTime = currentTimeMillis;
                        long j2 = currentTimeMillis - c15648.lastUpdateTime;
                        int i = c15648.pressedCount;
                        ...
                        if (PinnedPlayerView.this.rewindingState == -1) {
                            C15648 c156482 = C15648.this;
                            if (c156482.pressedCount > 0) {
                                if (j2 > 200 || PinnedPlayerView.this.rewindingProgress == BitmapDescriptorFactory.HUE_RED) {
                                    C15648 c156483 = C15648.this;
                                    c156483.lastUpdateTime = currentTimeMillis;
                                ...
                                C15648 c156484 = C15648.this;
                                if (c156484.pressedCount <= 0 || PinnedPlayerView.this.rewindingProgress <= BitmapDescriptorFactory.HUE_RED) {
                                    return;
                                }
                                AndroidUtilities.runOnUIThread(C15648.this.backSeek, 16L);
                                return;
                            }
                            return;
                        }
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r10) {
            ...
            Le0:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.iMe.fork.p024ui.view.PinnedPlayerView.C15648.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    /* loaded from: classes4.dex */
    class C15679 extends RLottieImageView {
        boolean pressed;
        private final Runnable pressedRunnable;
        float startX;
        float startY;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C15679(Context context, float f) {
            super(context);
            this.val$touchSlop = f;
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r7) {
            ...
            Le0:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.iMe.fork.p024ui.view.PinnedPlayerView.C15679.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    private void updateToggleThemeItem() {
        ...
        if (isCurrentThemeDark) {
            i = C3473R.string.ThemeDay;
            str = "ThemeDay";
        } else {
            i = C3473R.string.ThemeNight;
            str = "ThemeNight";
        }
