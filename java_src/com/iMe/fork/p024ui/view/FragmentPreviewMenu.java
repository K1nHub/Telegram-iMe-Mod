...
public final class FragmentPreviewMenu extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public FragmentPreviewMenu(INavigationLayout parentActionBarLayout, BaseFragment previewFragment, Theme.ResourcesProvider resourcesProvider) {
        super(parentActionBarLayout.getView().getContext(), C3242R.C3244drawable.popup_fixed_alert, resourcesProvider);
        Lazy lazy;
        Lazy lazy2;
    ...
    public final ActionBarMenuSubItem initOpenItem() {
        ...
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Open", C3242R.string.Open), C3242R.C3244drawable.msg_message);
    ...
    public final ActionBarMenuSubItem initCloseItem() {
        ...
        actionBarMenuSubItem.setMinimumWidth(160);
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Close", C3242R.string.Close), C3242R.C3244drawable.poll_remove);
