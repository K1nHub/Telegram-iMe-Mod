...
public final class FragmentPreviewMenu extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public FragmentPreviewMenu(INavigationLayout parentActionBarLayout, BaseFragment previewFragment, Theme.ResourcesProvider resourcesProvider) {
        super(parentActionBarLayout.getView().getContext(), C3473R.C3475drawable.popup_fixed_alert, resourcesProvider);
        Lazy lazy;
        Lazy lazy2;
    ...
    public final ActionBarMenuSubItem initOpenItem() {
        ...
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("AccDescrOpenChat", C3473R.string.AccDescrOpenChat), C3473R.C3475drawable.msg_message);
    ...
    public final ActionBarMenuSubItem initCloseItem() {
        ...
        actionBarMenuSubItem.setMinimumWidth(160);
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Back", C3473R.string.Back), C3473R.C3475drawable.ic_ab_back);
