...
public final class FragmentPreviewMenu extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public FragmentPreviewMenu(INavigationLayout parentActionBarLayout, BaseFragment previewFragment, Theme.ResourcesProvider resourcesProvider) {
        super(parentActionBarLayout.getView().getContext(), C3558R.C3560drawable.popup_fixed_alert, resourcesProvider);
        Lazy lazy;
        Lazy lazy2;
    ...
    public final ActionBarMenuSubItem initOpenItem() {
        ...
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("AccDescrOpenChat", C3558R.string.AccDescrOpenChat), C3558R.C3560drawable.msg_message);
    ...
    public final ActionBarMenuSubItem initCloseItem() {
        ...
        actionBarMenuSubItem.setMinimumWidth(160);
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString("Back", C3558R.string.Back), C3558R.C3560drawable.ic_ab_back);
