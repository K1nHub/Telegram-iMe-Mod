...
public final class RecentChatsDialogTypeSettingsActivity extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(LocaleController.getInternalString(C3473R.string.settings_interface_recent_chats));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.RecentChatsDialogTypeSettingsActivity$setupActionBar$1$1
