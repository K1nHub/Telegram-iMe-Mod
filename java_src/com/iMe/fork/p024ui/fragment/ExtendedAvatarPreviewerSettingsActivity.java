...
public final class ExtendedAvatarPreviewerSettingsActivity extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(LocaleController.getInternalString(C3473R.string.settings_interface_chat_user_options_by_avatar_click_subtitle));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.ExtendedAvatarPreviewerSettingsActivity$setupActionBar$1$1
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.TEXT_CHECK_CELL && (view instanceof TextCheckCell)) {
                ...
                if (i == ExtendedAvatarPreviewerSettingsActivity.this.enableRow) {
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3473R.string.settings_interface_chat_user_options_by_avatar_click_subtitle), SharedConfig.isExtendedAvatarPreviewerEnabled, needDivider);
                    return;
                }
                textCheckCell.setType(0);
                textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3473R.string.settings_interface_chat_user_options_by_avatar_click_title), SharedConfig.isExtendedAvatarPreviewerByTapEnabled, needDivider);
                ...
                if (i == extendedAvatarPreviewerSettingsActivity.enableSectionRow && !SharedConfig.isExtendedAvatarPreviewerEnabled) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(extendedAvatarPreviewerSettingsActivity.getParentActivity(), C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    textInfoPrivacyCell.setText(LocaleController.getInternalString(C3473R.string.settings_interface_chat_user_options_by_avatar_click_hint));
                    textInfoPrivacyCell.setFixedSize(0);
                    return;
                }
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(extendedAvatarPreviewerSettingsActivity.getParentActivity(), C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                ...
                if (i == ExtendedAvatarPreviewerSettingsActivity.this.itemsHeaderRow) {
                    ((HeaderCell) view).setText(LocaleController.getInternalString(C3473R.string.wallet_transaction_details_section_actions));
                }
