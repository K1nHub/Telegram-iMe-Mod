...
public final class C1523xcb29bd9c extends Lambda implements Function1<DialogType, Unit> {
    ...
    public C1523xcb29bd9c(ChatAttachAlertButtonsSettingsActivity chatAttachAlertButtonsSettingsActivity, ChatAttachAlertButtonsSettingsActivity.ListAdapter listAdapter) {
        super(1);
