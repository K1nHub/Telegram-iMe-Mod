...
public final class AllChatsTabSettingsActivity extends MvpFragment {
    ...
    private final ResettableLazy rootView$delegate = ResettableLazyDelegateKt.resettableLazy$default(this, (ResettableLazyManager) null, new Function0<FrameLayout>() { // from class: com.iMe.fork.ui.fragment.AllChatsTabSettingsActivity$rootView$2
        ...
        public final FrameLayout invoke() {
            ...
            initRootView = AllChatsTabSettingsActivity.this.initRootView();
            return initRootView;
        }
    }, 1, (Object) null);
    private final ResettableLazy listView$delegate = ResettableLazyDelegateKt.resettableLazy$default(this, (ResettableLazyManager) null, new Function0<RecyclerListView>() { // from class: com.iMe.fork.ui.fragment.AllChatsTabSettingsActivity$listView$2
        /* JADX INFO: Access modifiers changed from: package-private */
        {
            super(0);
        }
        ...
        public final RecyclerListView invoke() {
            ...
            initListView = AllChatsTabSettingsActivity.this.initListView();
            return initListView;
        }
    }, 1, (Object) null);
    private final ResettableLazy listAdapter$delegate = ResettableLazyDelegateKt.resettableLazy$default(this, (ResettableLazyManager) null, new Function0<ListAdapter>() { // from class: com.iMe.fork.ui.fragment.AllChatsTabSettingsActivity$listAdapter$2
        /* JADX INFO: Access modifiers changed from: package-private */
        {
            super(0);
        }
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(LocaleController.getInternalString(C3473R.string.folder_tabs_all_chats_tab_settings_item_title));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.AllChatsTabSettingsActivity$setupActionBar$1$1
    ...
    public static final void initListView$lambda$9$lambda$8(final AllChatsTabSettingsActivity this$0, View view, int i) {
        ...
        if (view instanceof TextCheckCell) {
            ...
            if (i == this$0.enableRow) {
                ...
                this$0.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.mainUserInfoChanged, new Object[0]);
            ...
            if (itemViewType == IdFabric$ViewTypes.TEXT_CHECK_CELL && (view instanceof TextCheckCell)) {
                ...
                if (i != allChatsTabSettingsActivity.enableRow) {
                    if (i == allChatsTabSettingsActivity.iconInsteadTitleRow) {
                        ...
                        textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3473R.string.all_chats_tab_settings_icon_instead_text_item_title), allChatsTabSettingsActivity.getFiltersController().isIconInsteadAllChatsTabTitleEnabled(), needDivider);
                        return;
                    }
                    return;
                }
                textCheckCell.setType(1);
                textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3473R.string.all_chats_tab_settings_enable_item_title), allChatsTabSettingsActivity.getFiltersController().isAllChatsTabEnabled(), needDivider);
                ...
                if (i != allChatsTabSettingsActivity2.enableSectionRow) {
                    if (i == allChatsTabSettingsActivity2.fabsSectionRow) {
                        textInfoPrivacyCell.setText(LocaleController.getInternalString(C3473R.string.create_folder_change_fab_section_description));
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(allChatsTabSettingsActivity2.getParentActivity(), C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    }
                } else if (allChatsTabSettingsActivity2.getFiltersController().isAllChatsTabEnabled()) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(allChatsTabSettingsActivity2.getParentActivity(), C3473R.C3475drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    textInfoPrivacyCell.setText(null);
                    textInfoPrivacyCell.setFixedSize(12);
                } else {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(allChatsTabSettingsActivity2.getParentActivity(), C3473R.C3475drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    textInfoPrivacyCell.setText(LocaleController.getInternalString(C3473R.string.all_chats_tab_settings_enable_item_hint));
                }
                ...
                if (i == AllChatsTabSettingsActivity.this.iconInsteadTitleHeaderRow) {
                    headerCell.setText(LocaleController.getInternalString(C3473R.string.all_chats_tab_settings_icon_instead_text_header));
                }
