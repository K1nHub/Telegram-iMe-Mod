...
public final class SettingsToolsActivity extends MvpFragment {
    ...
    public final StickerEmptyView initEmptyView() {
        ...
        stickerEmptyView.title.setText(LocaleController.getString("SettingsNoResults", C3473R.string.SettingsNoResults));
    ...
    private final void setupActionBar() {
        ...
        c3541ActionBar.setTitle(LocaleController.getInternalString(C3473R.string.settings_tools));
        c3541ActionBar.setActionBarMenuOnItemClick(new C3541ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.SettingsToolsActivity$setupActionBar$1$1
