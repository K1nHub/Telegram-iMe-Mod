...
public final class SelectedFilesBottomSheet extends BottomSheet {
    ...
    public final TextView initTitleTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3473R.string.multiple_files_sending_selected));
    ...
    public static final void openFile$lambda$16(final FileItem fileItem, final SelectedFilesBottomSheet this$0) {
        ...
        if (m1659exceptionOrNullimpl != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.iMe.fork.ui.dialog.SelectedFilesBottomSheet$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    SelectedFilesBottomSheet.openFile$lambda$16$lambda$13$lambda$12(m1659exceptionOrNullimpl);
                }
            });
        }
    ...
    public final class FileView extends LinearLayout {
        ...
        public final ImageView initImageView() {
            ...
            CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m72dp(44), C3473R.C3475drawable.msg_round_file_s);
        ...
        public final ImageView initDeleteButton() {
            ...
            imageView.setContentDescription(LocaleController.getString("Delete", C3473R.string.Delete));
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            imageView.setImageResource(C3473R.C3475drawable.input_clear);
