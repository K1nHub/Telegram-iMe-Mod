...
public final class ForwardCloudBottomSheet extends BottomSheet {
    ...
    public final TextView initTitleTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3473R.string.cloud_albums_bottom_sheet_title));
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public final long getAlbumId(int i) {
            ...
            return this.cloudAlbums.get(i - this.albumsStartRow).f1528id;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (i == this.newAlbumRow) {
                ...
                Drawable drawable = AppCompatResources.getDrawable(this.context, C3473R.C3475drawable.poll_add_circle);
                Drawable drawable2 = AppCompatResources.getDrawable(this.context, C3473R.C3475drawable.poll_add_plus);
                ...
                bottomSheetCell.setTextAndIcon(LocaleController.getInternalString(C3473R.string.cloud_albums_bottom_sheet_create_new_album), combinedDrawable);
