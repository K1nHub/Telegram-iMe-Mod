...
/* renamed from: com.iMe.fork.ui.dialog.ForwardCloudBottomSheet$listView$2 */
/* loaded from: classes3.dex */
public final class ForwardCloudBottomSheet$listView$2 extends Lambda implements Function0<ForwardCloudBottomSheet$initListView$1> {
    final /* synthetic */ ForwardCloudBottomSheet this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ForwardCloudBottomSheet$listView$2(ForwardCloudBottomSheet forwardCloudBottomSheet) {
        super(0);
