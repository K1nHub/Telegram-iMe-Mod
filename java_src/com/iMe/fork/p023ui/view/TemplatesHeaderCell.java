...
public final class TemplatesHeaderCell extends LinearLayout {
    ...
    public final void bind(int i, final BotCommandsMenuView.BotCommandsAdapter.TemplatesDelegate templatesDelegate) {
        ...
        headerTextView.setText(LocaleController.getInternalString(i > 0 ? C3632R.string.chat_templates : C3632R.string.chat_templates_list_header));
        ...
        sortButton.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m107dp(48), 0, Theme.getColor(Theme.key_listSelector)));
    ...
    public final ActionBarMenuItem initSortButton() {
        ...
        actionBarMenuItem.setAdditionalYOffset(-AndroidUtilities.m107dp(10));
        actionBarMenuItem.setAdditionalXOffset(AndroidUtilities.m107dp(10));
