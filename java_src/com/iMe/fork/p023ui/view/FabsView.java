...
public final class FabsView extends FrameLayout {
    ...
    public final void updateColors() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            gradientDrawable.setStroke(AndroidUtilities.m107dp(1), Theme.getColor(Theme.key_windowBackgroundWhite));
            gradientDrawable.setColor(Theme.getColor(Theme.key_chats_actionBackground));
            gradientDrawable.setSize(AndroidUtilities.m107dp(36), AndroidUtilities.m107dp(36));
