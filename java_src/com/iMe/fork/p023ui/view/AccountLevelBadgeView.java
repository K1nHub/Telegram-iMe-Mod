...
public final class AccountLevelBadgeView extends LinearLayout {
    ...
    public AccountLevelBadgeView(Context context, AttributeSet attributeSet, int i) {
        ...
        setPadding(AndroidUtilities.m108dp(4.0f), 0, AndroidUtilities.m108dp(14.0f), 0);
    ...
    public final void setAccountLevel(AccountLevel accountLevel) {
        ...
        setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m108dp(19.0f), ContextCompat.getColor(getContext(), accountLevel.getColorResId())));
    }

    @Override // android.widget.LinearLayout, android.view.View
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 0), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m108dp(20.0f), 1073741824));
    }
