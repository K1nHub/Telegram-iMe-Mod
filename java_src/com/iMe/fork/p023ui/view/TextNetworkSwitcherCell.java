...
public final class TextNetworkSwitcherCell extends FrameLayout {
    ...
    public final void setNetworkType(NetworkItem networkItem) {
        Intrinsics.checkNotNullParameter(networkItem, "networkItem");
        getNetworkTypeView().setNetwork(networkItem);
    }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m108dp(50.0f), 1073741824));
    }
