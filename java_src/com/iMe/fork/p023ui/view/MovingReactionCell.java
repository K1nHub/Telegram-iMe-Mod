...
public final class MovingReactionCell extends FrameLayout {
    ...
    public final void setEmoji(String str, boolean z) {
        this.emojiValue = str;
        getEmojiTextView().setText(Emoji.replaceEmoji((CharSequence) str, getEmojiTextView().getPaint().getFontMetricsInt(), AndroidUtilities.m107dp(24), false));
        this.needDivider = z;
        setWillNotDraw(!z);
    }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m108dp(getValueTextView().getVisibility() == 0 ? 64.0f : 48.0f) + (this.needDivider ? 1 : 0), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            canvas.drawLine(AndroidUtilities.m108dp(62.0f), getMeasuredHeight() - 1.0f, getMeasuredWidth(), getMeasuredHeight() - 1.0f, Theme.dividerPaint);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Type inference failed for: r1v0, types: [org.telegram.ui.Components.EditTextEffects, com.iMe.fork.ui.view.MovingReactionCell$initEditText$1, android.widget.TextView, org.telegram.ui.Components.EditTextBoldCursor, android.widget.EditText] */
