...
public final class ImageRadioCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        getRadioButton().measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(22), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(22), 1073741824));
        getImageView().measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(30), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(30), 1073741824));
