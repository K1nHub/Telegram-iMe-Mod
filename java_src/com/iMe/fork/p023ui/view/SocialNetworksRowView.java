...
public final class SocialNetworksRowView extends LinearLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        canvas.drawLine(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.m107dp(AndroidUtilities.getShadowHeight()), Theme.dividerPaint);
    }
