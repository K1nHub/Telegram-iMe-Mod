...
public final class ChatAttachAlertButtonCell extends LinearLayout {
    ...
    public final void setButton(ChatAttachAlertButton button, boolean z, boolean z2) {
        ...
        this.lottieImageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m107dp(46), button.getBackgroundColor()));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m107dp(48) + (this.needDivider ? 1 : 0), 1073741824));
    }
