...
public final class SettingsHelpBottomSheet extends BottomSheet {
    ...
    public SettingsHelpBottomSheet(ScreenType screenType, BaseFragment fragment) {
        ...
        pairArr[0] = TuplesKt.m144to(LocaleController.getInternalString(C3630R.string.settings_help_alert_support_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[1] = TuplesKt.m144to(LocaleController.getInternalString(C3630R.string.settings_help_alert_group_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[2] = TuplesKt.m144to(LocaleController.getInternalString(C3630R.string.settings_help_alert_lime_group_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$3
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[3] = TuplesKt.m144to(LocaleController.getInternalString(C3630R.string.settings_help_alert_channel_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$4
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2() {
                Browser.openUrl(SettingsHelpBottomSheet.this.getContext(), LocaleController.getInternalString(C3630R.string.settings_help_alert_channel_username));
            }
        });
        pairArr[4] = TuplesKt.m144to(LocaleController.getInternalString(C3630R.string.settings_help_alert_faq_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$5
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2() {
                Browser.openUrl(SettingsHelpBottomSheet.this.getContext(), LocaleController.getInternalString(C3630R.string.settings_help_alert_faq_url));
            }
        });
        pairArr[5] = TuplesKt.m144to(LocaleController.getString("PrivacyPolicy", C3630R.string.PrivacyPolicy), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$6
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2() {
                Browser.openUrl(SettingsHelpBottomSheet.this.getContext(), LocaleController.getInternalString(C3630R.string.PrivacyPolicyUrl));
            }
        });
        ScreenType screenType2 = ScreenType.COMMON_SETTINGS;
        pairArr[6] = screenType == screenType2 ? TuplesKt.m144to(LocaleController.getString("AskAQuestion", C3630R.string.AskAQuestion), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$7
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[7] = screenType == screenType2 ? TuplesKt.m144to(LocaleController.getString("TelegramFeatures", C3630R.string.TelegramFeatures), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$8
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2() {
                Browser.openUrl(SettingsHelpBottomSheet.this.getContext(), LocaleController.getString("TelegramFeaturesUrl", C3630R.string.TelegramFeaturesUrl));
            }
        }) : null;
        ...
        setTitle(LocaleController.getString("SettingsHelp", C3630R.string.SettingsHelp), true);
    }
    ...
    public final AlertDialog createSocialNetworkAlert(final DrawerSocialNetwork drawerSocialNetwork) {
        ...
        String string2 = LocaleController.getString("CopyLink", C3630R.string.CopyLink);
