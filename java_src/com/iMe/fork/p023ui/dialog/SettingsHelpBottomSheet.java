...
public final class SettingsHelpBottomSheet extends BottomSheet {
    ...
    public SettingsHelpBottomSheet(ScreenType screenType, BaseFragment fragment) {
        ...
        pairArr[0] = TuplesKt.m149to(LocaleController.getInternalString(C3632R.string.settings_help_alert_support_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[1] = TuplesKt.m149to(LocaleController.getInternalString(C3632R.string.settings_help_alert_group_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[2] = TuplesKt.m149to(LocaleController.getInternalString(C3632R.string.settings_help_alert_lime_group_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$3
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[3] = TuplesKt.m149to(LocaleController.getInternalString(C3632R.string.settings_help_alert_channel_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$4
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[4] = TuplesKt.m149to(LocaleController.getInternalString(C3632R.string.settings_help_alert_faq_item_title), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$5
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[5] = TuplesKt.m149to(LocaleController.getString("PrivacyPolicy", C3632R.string.PrivacyPolicy), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$6
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[6] = screenType == screenType2 ? TuplesKt.m149to(LocaleController.getString("AskAQuestion", C3632R.string.AskAQuestion), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$7
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        pairArr[7] = screenType == screenType2 ? TuplesKt.m149to(LocaleController.getString("TelegramFeatures", C3632R.string.TelegramFeatures), new Function0<Unit>() { // from class: com.iMe.fork.ui.dialog.SettingsHelpBottomSheet$items$8
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
