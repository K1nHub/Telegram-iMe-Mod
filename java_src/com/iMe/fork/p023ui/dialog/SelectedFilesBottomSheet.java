...
public final class SelectedFilesBottomSheet extends BottomSheet {
    ...
    public static final void openFile$lambda$16(final FileItem fileItem, final SelectedFilesBottomSheet this$0) {
        ...
        if (m1946exceptionOrNullimpl != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.iMe.fork.ui.dialog.SelectedFilesBottomSheet$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    SelectedFilesBottomSheet.openFile$lambda$16$lambda$13$lambda$12(m1946exceptionOrNullimpl);
                }
            });
        }
    ...
    private final class RootView extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int m107dp = AndroidUtilities.m107dp(110) + (SelectedFilesBottomSheet.this.files.size() * AndroidUtilities.m107dp(60)) + ((BottomSheet) SelectedFilesBottomSheet.this).backgroundPaddingTop + AndroidUtilities.statusBarHeight;
            int i3 = size / 5;
            int i4 = ((float) m107dp) < ((float) i3) * 3.2f ? 0 : i3 * 2;
            if (i4 != 0 && m107dp < size) {
                i4 -= size - m107dp;
            }
            if (i4 == 0) {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int m107dp = (SelectedFilesBottomSheet.this.scrollOffsetY - ((BottomSheet) SelectedFilesBottomSheet.this).backgroundPaddingTop) + AndroidUtilities.m107dp(6);
            int m107dp2 = (SelectedFilesBottomSheet.this.scrollOffsetY - ((BottomSheet) SelectedFilesBottomSheet.this).backgroundPaddingTop) - AndroidUtilities.m107dp(13);
            int measuredHeight = getMeasuredHeight() + AndroidUtilities.m107dp(15) + ((BottomSheet) SelectedFilesBottomSheet.this).backgroundPaddingTop;
            ...
            this.rect.set((getMeasuredWidth() - m107dp3) / 2, i4, (getMeasuredWidth() + m107dp3) / 2, i4 + AndroidUtilities.m107dp(4));
    ...
    public final class FileView extends LinearLayout {
        ...
        public FileView(SelectedFilesBottomSheet selectedFilesBottomSheet, Context context) {
            ...
            com.tbuonomo.viewpagerdotsindicator.ViewExtKt.setPaddingHorizontal(this, AndroidUtilities.m107dp(16));
            com.tbuonomo.viewpagerdotsindicator.ViewExtKt.setPaddingVertical(this, AndroidUtilities.m107dp(8));
            setGravity(16);
        ...
        public final ImageView initImageView() {
            ...
            CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m107dp(44), C3632R.C3634drawable.msg_round_file_s);
