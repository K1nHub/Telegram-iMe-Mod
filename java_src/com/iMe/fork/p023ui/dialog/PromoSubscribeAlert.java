...
public final class PromoSubscribeAlert extends AlertDialog.Builder {
    ...
    public PromoSubscribeAlert(LaunchActivity activity, int i) {
        ...
        int m108dp = AndroidUtilities.m108dp(30.0f);
        setTopImagePaddings(0, m108dp, AndroidUtilities.m108dp(16.0f), m108dp);
    ...
    public static final void initChatsView$lambda$11$lambda$10$lambda$9$lambda$8(PromoSubscribeAlert this$0, View view) {
        ...
        launchActivity.lambda$runLinkRequest$94(new ChatActivity(BundleKt.bundleOf(TuplesKt.m149to("chat_id", Long.valueOf(-((PromoSubscribeChat) tag).getId())))));
    }
    ...
    public final TextView initSkipButton() {
        ...
        textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView.setGravity(17);
        textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m108dp(6.0f), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
        textView.setTextSize(1, 14.0f);
