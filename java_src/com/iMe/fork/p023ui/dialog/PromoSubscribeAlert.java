...
public final class PromoSubscribeAlert extends AlertDialog.Builder {
    ...
    public PromoSubscribeAlert(LaunchActivity activity, int i) {
        ...
        setTopHeight(166);
        setTopImage(C3630R.C3632drawable.fork_promo_subscribe_dialog_icon, Theme.getColor(Theme.key_windowBackgroundGray));
        int m103dp = AndroidUtilities.m103dp(30.0f);
        setTopImagePaddings(0, m103dp, AndroidUtilities.m103dp(16.0f), m103dp);
    ...
    public final TextView initTitleTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3630R.string.dialog_promo_subscribe_title));
    ...
    public final TextView initSubtitleTextView() {
        TextView textView = new TextView(getContext());
        textView.setText(LocaleController.getInternalString(C3630R.string.dialog_promo_subscribe_subtitle));
    ...
    public static final void initChatsView$lambda$11$lambda$10$lambda$9$lambda$8(PromoSubscribeAlert this$0, View view) {
        ...
        launchActivity.lambda$runLinkRequest$83(new ChatActivity(BundleKt.bundleOf(TuplesKt.m144to("chat_id", Long.valueOf(-((PromoSubscribeChat) tag).getId())))));
    }
    ...
    public final LinearLayout initNotShowAgainCheckBoxContainer() {
        ...
        textView.setText(LocaleController.getInternalString(C3630R.string.common_not_show_again));
    ...
    public final TextView initSkipButton() {
        TextView textView = new TextView(getContext());
        String string = LocaleController.getString("Close", C3630R.string.Close);
        ...
        textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView.setGravity(17);
        textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m103dp(6.0f), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
        textView.setTextSize(1, 14.0f);
