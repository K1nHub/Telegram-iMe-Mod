...
public final class TokenListsBottomSheet extends BottomSheet {
    ...
    public TokenListsBottomSheet(Context context, List<TokenListInfo> tokenLists, Callbacks$Callback onInfoClickAction) {
        ...
        final int m106px = AndroidUtilities.m106px(getActionBarHeight());
        ...
        if (!ViewCompat.isLaidOut(actionBar) || actionBar.isLayoutRequested()) {
            actionBar.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.iMe.fork.ui.dialog.TokenListsBottomSheet$_init_$lambda$1$$inlined$doOnLayout$1
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    TokenListsBottomSheet.RootView.this.addView(this.getTopShadow(), LayoutHelper.createFrame(-1, AndroidUtilities.getShadowHeight(), 48, 0, m106px, 0, 0));
                }
            });
        } else {
    ...
    public final class RootView extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            TokenListsBottomSheet.this.itemWidth = AndroidUtilities.m106px(View.MeasureSpec.getSize(i)) - 12;
            ViewExtKt.setHorizontalPadding(this, 6);
            int m107dp = AndroidUtilities.m107dp(62) + (((int) Math.ceil(TokenListsBottomSheet.this.tokenLists.size())) * AndroidUtilities.m107dp(56)) + ((BottomSheet) TokenListsBottomSheet.this).backgroundPaddingTop + AndroidUtilities.statusBarHeight;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int m107dp = (TokenListsBottomSheet.this.scrollOffsetY - ((BottomSheet) TokenListsBottomSheet.this).backgroundPaddingTop) + AndroidUtilities.m107dp(6);
            int m107dp2 = (TokenListsBottomSheet.this.scrollOffsetY - ((BottomSheet) TokenListsBottomSheet.this).backgroundPaddingTop) - AndroidUtilities.m107dp(13);
            int measuredHeight = getMeasuredHeight() + AndroidUtilities.m107dp(15) + ((BottomSheet) TokenListsBottomSheet.this).backgroundPaddingTop;
