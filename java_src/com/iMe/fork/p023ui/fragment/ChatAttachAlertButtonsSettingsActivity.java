...
public final class ChatAttachAlertButtonsSettingsActivity extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3702ActionBar.setTitle(LocaleController.getInternalString(C3630R.string.settings_interface_chat_attach_alert_buttons));
        c3702ActionBar.setActionBarMenuOnItemClick(new C3702ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.ChatAttachAlertButtonsSettingsActivity$setupActionBar$1$1
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.CHAT_ATTACH_ALERT_BUTTON && (view instanceof ChatAttachAlertButtonCell)) {
                ...
                if (i == ChatAttachAlertButtonsSettingsActivity.this.botsHeaderRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("FilterBots", C3630R.string.FilterBots));
                }
                ...
                if (i != ChatAttachAlertButtonsSettingsActivity.this.walletBotRow) {
                    if (i == ChatAttachAlertButtonsSettingsActivity.this.botSuggestionsRow) {
                        ((TextCheckCell) view).setTextAndCheck(LocaleController.getInternalString(C3630R.string.chat_attach_alert_bot_buttons), ChatAttachAlertButtonsSettingsActivity.this.newSuggest, z);
                        return;
                    }
                    return;
                }
                ((TextCheckCell) view).setTextAndCheck(LocaleController.getInternalString(C3630R.string.drawer_wallet_bot), SharedConfig.isChatAttachAlertWalletBotEnabled, z);
            }
        }
    }
}
