...
public final class SortingFilterSettingsActivity extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3704ActionBar.setTitle(LocaleController.getInternalString(C3632R.string.folder_tabs_sorting_settings));
        c3704ActionBar.setActionBarMenuOnItemClick(new C3704ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.SortingFilterSettingsActivity$setupActionBar$1$1
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
            ...
            if ((view instanceof TextCheckCell) && itemViewType == IdFabric$ViewTypes.TEXT_CHECK_CELL) {
                ...
                if (i == sortingFilterSettingsActivity2.enableSectionRow && sortingFilterSettingsActivity2.getFiltersController().isSortingEnabled(sortingFilterSettingsActivity2.getCurrentArchive())) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(this.mContext, C3632R.C3634drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    textInfoPrivacyCell.setText(null);
                    textInfoPrivacyCell.setFixedSize(12);
                    return;
                }
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(this.mContext, C3632R.C3634drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                textInfoPrivacyCell.setText(LocaleController.getInternalString(i == sortingFilterSettingsActivity2.enableSectionRow ? C3632R.string.sorting_settings_enable_item_hint : C3632R.string.sorting_settings_drag_and_drop_hint));
