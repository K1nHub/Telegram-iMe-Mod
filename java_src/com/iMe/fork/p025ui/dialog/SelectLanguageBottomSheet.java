...
public final class SelectLanguageBottomSheet extends BottomSheet {
    ...
    public final SelectLanguageBottomSheet$initSearchView$1 initSearchView() {
        ...
        r2.setHint(LocaleController.getInternalString(C3316R.string.translation_search_language));
        return r2;
    }
    ...
    public final TextView initCancelButton() {
        ...
        textView.setText(LocaleController.getString("Cancel", C3316R.string.Cancel));
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX WARN: Type inference failed for: r3v4, types: [android.widget.LinearLayout, com.iMe.fork.ui.dialog.SelectLanguageBottomSheet$EmptyView] */
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.LANGUAGE) {
                ...
                textCellWithRightImage.setRightIcon(C3316R.C3318drawable.ic_ab_done, Theme.getColor("chats_actionBackground"));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: SelectLanguageBottomSheet.kt */
    /* renamed from: com.iMe.fork.ui.dialog.SelectLanguageBottomSheet$EmptyView */
    /* loaded from: classes3.dex */
    public static final class EmptyView extends LinearLayout {
        ...
        public EmptyView(Context context) {
            ...
            rLottieImageView.setAnimation(C3316R.C3321raw.fork_catalog_empty, 100, 100);
            ...
            textView.setGravity(17);
            textView.setText(LocaleController.getInternalString(C3316R.string.translation_search_language_empty));
