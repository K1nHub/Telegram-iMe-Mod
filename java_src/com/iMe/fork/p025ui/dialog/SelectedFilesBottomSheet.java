...
public final class SelectedFilesBottomSheet extends BottomSheet {
    ...
    public final TextView initTitleTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3316R.string.multiple_files_sending_selected));
    ...
    public final TextView initSaveButton() {
        ...
        textView.setText(LocaleController.getString("Save", C3316R.string.Save));
    ...
    public static final void openFile$lambda$16(final FileItem fileItem, final SelectedFilesBottomSheet this$0) {
        ...
        final Throwable m1572exceptionOrNullimpl = Result.m1572exceptionOrNullimpl(m1571constructorimpl);
        if (m1572exceptionOrNullimpl != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.iMe.fork.ui.dialog.SelectedFilesBottomSheet$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    SelectedFilesBottomSheet.openFile$lambda$16$lambda$13$lambda$12(m1572exceptionOrNullimpl);
                }
            });
        }
        if (Result.m1574isSuccessimpl(m1571constructorimpl)) {
            Unit unit = (Unit) m1571constructorimpl;
    ...
    public final class FileView extends LinearLayout {
        ...
        public final ImageView initImageView() {
            ...
            CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m50dp(44), C3316R.C3318drawable.msg_round_file_s);
        ...
        public final ImageView initDeleteButton() {
            ...
            imageView.setContentDescription(LocaleController.getString("Delete", C3316R.string.Delete));
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            imageView.setImageResource(C3316R.C3318drawable.input_clear);
