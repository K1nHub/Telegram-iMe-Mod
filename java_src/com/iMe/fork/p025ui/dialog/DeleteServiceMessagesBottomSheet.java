...
import p035j$.time.temporal.ChronoUnit;
/* compiled from: DeleteServiceMessagesBottomSheet.kt */
/* renamed from: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet */
...
public final class DeleteServiceMessagesBottomSheet extends BottomSheet {
    ...
    /* compiled from: DeleteServiceMessagesBottomSheet.kt */
    /* renamed from: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$WhenMappings */
    /* loaded from: classes3.dex */
    ...
    public final TextView initTitleTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3316R.string.service_messages));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Type inference failed for: r1v0, types: [com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$initListView$1, android.view.View, androidx.recyclerview.widget.RecyclerView, android.view.ViewGroup, org.telegram.ui.Components.RecyclerListView] */
    public final DeleteServiceMessagesBottomSheet$initListView$1 initListView() {
        final Context context = getContext();
        ?? r1 = new RecyclerListView(context) { // from class: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$initListView$1
        ...
        r1.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$$ExternalSyntheticLambda2
    ...
    public final FrameLayout initButtonsLayout() {
        ...
        if (!ViewCompat.isLaidOut(frameLayout) || frameLayout.isLayoutRequested()) {
            frameLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$initButtonsLayout$lambda$7$$inlined$doOnLayout$1
    ...
    private final void runShadowAnimation(final boolean z) {
        ...
        animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$runShadowAnimation$1$1
    ...
    public final void showPeriodSelectionDialog() {
        ...
        builder.setTitle(LocaleController.getInternalString(C3316R.string.erasing_period));
        ...
        builder.setItems((CharSequence[]) arrayList.toArray(new CharSequence[0]), new DialogInterface.OnClickListener() { // from class: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$$ExternalSyntheticLambda0
    ...
    public final TextView[] getBottomDialogButtons(final Runnable runnable) {
        ...
        for (int i = 0; i < 2; i++) {
            final Context context = getContext();
            AppCompatTextView appCompatTextView = new AppCompatTextView(context) { // from class: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$getBottomDialogButtons$1
            ...
            if (i == 0) {
                string = LocaleController.getString("Cancel", C3316R.string.Cancel);
            } else {
                string = LocaleController.getString("Delete", C3316R.string.Delete);
            }
    ...
    public static final void getBottomDialogButtons$lambda$12$lambda$11(Runnable onFiltersSelectionConfirmedAction, DeleteServiceMessagesBottomSheet this$0, View v) {
        ...
        if (AndroidUtilities.isServiceRunning(ServiceMessagesRemovingService.class)) {
            String internalString = LocaleController.getInternalString(C3316R.string.already_removing);
    ...
    public final String getServiceMessageTypeStringByCode(int i) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[ServiceMessageType.Companion.getByCode(i, this.isChannel).ordinal()]) {
            case 1:
                string = LocaleController.getString("ActionCreateGroup", C3316R.string.ActionCreateGroup);
                break;
            case 2:
                if (this.isChannel) {
                    string = LocaleController.getString("ActionChannelChangedTitle", C3316R.string.ActionChannelChangedTitle);
                    break;
                } else {
                    string = LocaleController.getString("ActionChangedTitle", C3316R.string.ActionChangedTitle);
                    break;
                }
            case 3:
                if (this.isChannel) {
                    string = LocaleController.getString("ActionChannelChangedPhoto", C3316R.string.ActionChannelChangedPhoto);
                    break;
                } else {
                    string = LocaleController.getString("ActionChangedPhoto", C3316R.string.ActionChangedPhoto);
                    break;
                }
            case 4:
                if (this.isChannel) {
                    string = LocaleController.getString("ActionChannelRemovedPhoto", C3316R.string.ActionChannelRemovedPhoto);
                    break;
                } else {
                    string = LocaleController.getString("ActionRemovedPhoto", C3316R.string.ActionRemovedPhoto);
                    break;
                }
            case 5:
                string = LocaleController.formatStringInternal(C3316R.string.service_messages_variants, LocaleController.getString("ActionAddUserSelfMega", C3316R.string.ActionAddUserSelfMega), LocaleController.getString("ActionAddUser", C3316R.string.ActionAddUser));
                break;
            case 6:
                string = LocaleController.getString("ActionLeftUser", C3316R.string.ActionLeftUser);
                break;
            case 7:
                string = LocaleController.getString("ActionInviteUser", C3316R.string.ActionInviteUser);
                break;
            case 8:
                string = LocaleController.getString("ActionPinnedNoText", C3316R.string.ActionPinnedNoText);
                break;
            case 9:
                string = LocaleController.formatString("ActionUserScored", C3316R.string.ActionUserScored, "...");
                break;
            case 10:
                string = LocaleController.formatString("PaymentSuccessfullyPaid", C3316R.string.PaymentSuccessfullyPaid, "...", "...", "...");
                break;
            case 11:
                string = LocaleController.getString("ActionTakeScreenshoot", C3316R.string.ActionTakeScreenshoot);
                break;
            case 12:
                string = LocaleController.formatString("ActionUserWithinRadius", C3316R.string.ActionUserWithinRadius, "...");
                break;
            case 13:
                if (this.isChannel) {
                    string = LocaleController.formatStringInternal(C3316R.string.service_messages_variants, LocaleController.getString("ActionGroupCallJustStarted", C3316R.string.ActionGroupCallStarted), LocaleController.formatString("ActionChannelCallEnded", C3316R.string.ActionChannelCallEnded, "..."));
                    break;
                } else {
                    string = LocaleController.formatStringInternal(C3316R.string.service_messages_variants, LocaleController.getString("ActionGroupCallStarted", C3316R.string.ActionGroupCallStarted), LocaleController.formatString("ActionGroupCallEndedBy", C3316R.string.ActionGroupCallEndedBy, "..."));
                    break;
                }
            case 14:
                string = LocaleController.formatString("ActionGroupCallScheduled", C3316R.string.ActionGroupCallScheduled, "...");
                break;
            case 15:
                string = LocaleController.getString("ActionGroupCallInvited", C3316R.string.ActionGroupCallInvited);
                break;
            case 16:
                string = LocaleController.formatString("MessageLifetimeChanged", C3316R.string.MessageLifetimeChanged, "...", "...");
                break;
            case 17:
                if (this.isChannel) {
                    string = LocaleController.getString("ActionTTLChannelChanged", C3316R.string.ActionTTLChannelChanged);
                    break;
                } else {
                    string = LocaleController.formatString("ActionTTLChanged", C3316R.string.ActionTTLChanged, "...");
                    break;
                }
            default:
                string = "";
    ...
    /* compiled from: DeleteServiceMessagesBottomSheet.kt */
    /* renamed from: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$ErasingPeriod */
    /* loaded from: classes3.dex */
    public static final class ErasingPeriod {
        ...
        public static final ErasingPeriod ALL_TIME = new ErasingPeriod("ALL_TIME", 4, 4, 0, C3316R.string.period_all_time);
        ...
        static {
            long j = 1000;
            DAY = new ErasingPeriod("DAY", 0, 0, (int) (ChronoUnit.DAYS.getDuration().toMillis() / j), C3316R.string.period_last_day);
            WEEK = new ErasingPeriod("WEEK", 1, 1, (int) (ChronoUnit.WEEKS.getDuration().toMillis() / j), C3316R.string.period_last_week);
            MONTH = new ErasingPeriod("MONTH", 2, 2, (int) (ChronoUnit.MONTHS.getDuration().toMillis() / j), C3316R.string.period_last_month);
            YEAR = new ErasingPeriod("YEAR", 3, 3, (int) (ChronoUnit.YEARS.getDuration().toMillis() / j), C3316R.string.period_last_year);
        }

        /* compiled from: DeleteServiceMessagesBottomSheet.kt */
        /* renamed from: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$ErasingPeriod$Companion */
        /* loaded from: classes3.dex */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: DeleteServiceMessagesBottomSheet.kt */
    /* renamed from: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$ServiceMessagesTypesAdapter */
    /* loaded from: classes3.dex */
    public final class ServiceMessagesTypesAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerListView.Holder onCreateViewHolder(ViewGroup parent, int i) {
            ...
            if (i == IdFabric$ViewTypes.TEXT_CHECK) {
                ...
                view = new TextCheckBoxCell(context2) { // from class: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$ServiceMessagesTypesAdapter$onCreateViewHolder$2
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.TEXT_CHECK && (view instanceof TextCheckCell)) {
                ((TextCheckCell) view).setTextAndCheck(LocaleController.getInternalString(C3316R.string.service_messages_all), this.this$0.selectedFiltersCodes.contains(Integer.valueOf(ServiceMessageType.ALL.getCode(this.this$0.isChannel))), true);
    ...
    /* compiled from: DeleteServiceMessagesBottomSheet.kt */
    /* renamed from: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$CustomContainerView */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: DeleteServiceMessagesBottomSheet.kt */
    /* renamed from: com.iMe.fork.ui.dialog.DeleteServiceMessagesBottomSheet$Companion */
    /* loaded from: classes3.dex */
    public static final class Companion {
        public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
            this();
