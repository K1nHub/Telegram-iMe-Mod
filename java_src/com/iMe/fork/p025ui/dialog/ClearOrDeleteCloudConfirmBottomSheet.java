...
public final class ClearOrDeleteCloudConfirmBottomSheet extends BottomSheet {
    ...
    public ClearOrDeleteCloudConfirmBottomSheet(BaseFragment fragment, boolean z, Runnable onPassed) {
        ...
        if (z) {
            setTitle(LocaleController.getString("ClearHistory", C3316R.string.ClearHistory), true);
        } else {
            setTitle(LocaleController.getString("DeleteChatUser", C3316R.string.DeleteChatUser), true);
        }
    ...
    public final EditTextBoldCursor initInputEditText() {
        ...
        editTextBoldCursor.setHint(LocaleController.getInternalString(C3316R.string.cloud_clear_or_delete_captcha_alert_message));
    ...
    public final ReportAlert.BottomSheetCell initDoneButton() {
        ...
        bottomSheetCell.setText(LocaleController.getInternalString(C3316R.string.cloud_clear_or_delete_captcha_alert_positive_button));
