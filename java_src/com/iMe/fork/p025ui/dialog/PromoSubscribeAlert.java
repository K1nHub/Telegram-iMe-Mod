...
public final class PromoSubscribeAlert extends AlertDialog.Builder {
    ...
    public PromoSubscribeAlert(LaunchActivity activity, int i) {
        ...
        setTopHeight(166);
        setTopImage(C3316R.C3318drawable.fork_promo_subscribe_dialog_icon, Theme.getColor("windowBackgroundGray"));
    ...
    public final TextView initTitleTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3316R.string.dialog_promo_subscribe_title));
    ...
    public final TextView initSubtitleTextView() {
        TextView textView = new TextView(getContext());
        textView.setText(LocaleController.getInternalString(C3316R.string.dialog_promo_subscribe_subtitle));
    ...
    public static final void initChatsView$lambda$11$lambda$10$lambda$9$lambda$8(PromoSubscribeAlert this$0, View view) {
        ...
        launchActivity.lambda$runLinkRequest$86(new ChatActivity(BundleKt.bundleOf(TuplesKt.m94to("chat_id", Long.valueOf(-((PromoSubscribeChat) tag).getId())))));
    }
    ...
    public final LinearLayout initNotShowAgainCheckBoxContainer() {
        ...
        textView.setText(LocaleController.getInternalString(C3316R.string.common_not_show_again));
    ...
    public final TextView initSkipButton() {
        TextView textView = new TextView(getContext());
        String string = LocaleController.getString("Close", C3316R.string.Close);
