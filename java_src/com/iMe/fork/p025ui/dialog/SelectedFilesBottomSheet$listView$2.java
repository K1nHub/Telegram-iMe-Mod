...
/* renamed from: com.iMe.fork.ui.dialog.SelectedFilesBottomSheet$listView$2 */
/* loaded from: classes3.dex */
public final class SelectedFilesBottomSheet$listView$2 extends Lambda implements Function0<SelectedFilesBottomSheet$initListView$1> {
    final /* synthetic */ SelectedFilesBottomSheet this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SelectedFilesBottomSheet$listView$2(SelectedFilesBottomSheet selectedFilesBottomSheet) {
        super(0);
