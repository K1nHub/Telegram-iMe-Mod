...
import com.iMe.fork.p025ui.view.MediaSwitchTopicsBar;
import com.iMe.fork.p025ui.view.SortingFilterCell;
...
public final class CombineContextMenuActivity extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(LocaleController.getInternalString(C3316R.string.settings_interface_message_context_menu));
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.CombineContextMenuActivity$setupActionBar$1$1
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if ((view instanceof TextCheckCell) && itemViewType == IdFabric$ViewTypes.TEXT_CHECK) {
                ...
                textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_message_popup_aggregator), this.this$0.getToolsController().isMessagePopupAggregatorEnabled(), z);
