...
import com.iMe.fork.p025ui.view.ChatAttachAlertButtonCell;
...
public final class ChatAttachAlertButtonsSettingsActivity extends MvpFragment {
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(LocaleController.getInternalString(C3316R.string.settings_interface_chat_attach_alert_buttons));
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.ChatAttachAlertButtonsSettingsActivity$setupActionBar$1$1
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerListView.Holder onCreateViewHolder(ViewGroup parent, int i) {
            ...
            if (i == IdFabric$ViewTypes.TOPICS_BAR) {
                ...
                DialogTypeTopicsBar dialogTypeTopicsBar2 = new DialogTypeTopicsBar(parentActivity, list, ChatAttachAlertButtonsSettingsActivity.this.getCurrentDialogType(), new C1458xcb29bd9c(ChatAttachAlertButtonsSettingsActivity.this, this));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.CHAT_ATTACH_ALERT_BUTTON && (view instanceof ChatAttachAlertButtonCell)) {
                ...
                ((TextCheckCell) view).setTextAndCheck(LocaleController.getInternalString(C3316R.string.chat_attach_alert_bot_buttons), ChatAttachAlertButtonsSettingsActivity.this.newSuggest, needDivider);
            }
        }
    }
}
