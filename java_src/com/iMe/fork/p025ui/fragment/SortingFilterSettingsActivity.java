...
import com.iMe.fork.p025ui.view.ArchiveSwitchTopicsBar;
...
public final class SortingFilterSettingsActivity extends BaseFragment {
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(LocaleController.getInternalString(C3316R.string.folder_tabs_sorting_settings));
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.SortingFilterSettingsActivity$setupActionBar$1$1
    ...
    */
    private final void updateChatSwipeAction() {
        ...
        L42:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.fork.p025ui.fragment.SortingFilterSettingsActivity.updateChatSwipeAction():void");
    }
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
            ...
            if ((view instanceof TextCheckCell) && itemViewType == IdFabric$ViewTypes.TEXT_CHECK) {
                ...
                textInfoPrivacyCell.setText(LocaleController.getInternalString(i == sortingFilterSettingsActivity2.enableSectionRow ? C3316R.string.sorting_settings_enable_item_hint : C3316R.string.sorting_settings_drag_and_drop_hint));
