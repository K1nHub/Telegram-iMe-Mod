...
public final class C1458xcb29bd9c extends Lambda implements Function1<DialogType, Unit> {
    ...
    public C1458xcb29bd9c(ChatAttachAlertButtonsSettingsActivity chatAttachAlertButtonsSettingsActivity, ChatAttachAlertButtonsSettingsActivity.ListAdapter listAdapter) {
        super(1);
