...
public final class ReactionsSettingsActivity extends BaseFragment {
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(LocaleController.getString("Reactions", C3316R.string.Reactions));
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.ReactionsSettingsActivity$setupActionBar$1$1
    ...
    public final RecyclerListView initListView() {
        ...
        recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: com.iMe.fork.ui.fragment.ReactionsSettingsActivity$$ExternalSyntheticLambda3
            ...
            public final void onItemClick(View view, int i, float f, float f2) {
                ReactionsSettingsActivity.initListView$lambda$6$lambda$5(ReactionsSettingsActivity.this, view, i, f, f2);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initListView$lambda$6$lambda$5(ReactionsSettingsActivity this$0, View view, int i, float f, float f2) {
    ...
    private final void showChooseMessagePopupReactionsEnabledDialogTypesBottomSheet() {
        ...
        builder.setTitle(LocaleController.getInternalString(C3316R.string.settings_interface_message_popup_items), true);
        boolean z = false;
        ...
        for (Object obj : list) {
            ...
            textCheckBoxCell.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.fork.ui.fragment.ReactionsSettingsActivity$$ExternalSyntheticLambda2
                ...
                public final void onClick(View view) {
                    ReactionsSettingsActivity.m714x1354851b(TextCheckBoxCell.this, view);
                }
            });
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.fork.ui.fragment.ReactionsSettingsActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ReactionsSettingsActivity.m713x1f1a0f8c(BottomSheet.Builder.this, view);
            }
        });
        ...
        textView2.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.fork.ui.fragment.ReactionsSettingsActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ReactionsSettingsActivity.m712x48e37510(arrayList, builder, this, view);
            }
        });
    ...
    public static final void m714x1354851b(TextCheckBoxCell this_apply, View view) {
    ...
    public static final void m713x1f1a0f8c(BottomSheet.Builder builder, View view) {
    ...
    public static final void m712x48e37510(List cells, BottomSheet.Builder builder, ReactionsSettingsActivity this$0, View view) {
        Sequence asSequence;
        Sequence filter;
        Sequence map;
        Set set;
        ...
        filter = SequencesKt___SequencesKt.filter(asSequence, C1467xecddff80.INSTANCE);
        map = SequencesKt___SequencesKt.map(filter, C1468xecddff81.INSTANCE);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.TEXT_CHECK && (view instanceof TextCheckCell)) {
                ...
                if (i == ReactionsSettingsActivity.this.enableRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString("EnableReactions", C3316R.string.EnableReactions), SharedConfig.isReactionsEnabled, needDivider);
                }
                ...
                if (i == reactionsSettingsActivity.enableSectionRow && !SharedConfig.isReactionsEnabled) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(reactionsSettingsActivity.getParentActivity(), C3316R.C3318drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                    textInfoPrivacyCell.setText(LocaleController.getInternalString(C3316R.string.settings_reactions_enable_hint));
                    textInfoPrivacyCell.setFixedSize(0);
                    return;
                }
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawable(reactionsSettingsActivity.getParentActivity(), C3316R.C3318drawable.greydivider, "windowBackgroundGrayShadow"));
                ...
                NotificationsCheckCell notificationsCheckCell = (NotificationsCheckCell) view;
                String internalString2 = LocaleController.getInternalString(C3316R.string.settings_tools_message_popup_reactions);
                if (z) {
                ...
                textSettingsCell.setText(LocaleController.getString("DoubleTapSetting", C3316R.string.DoubleTapSetting), needDivider);
                if (reactionsSettingsActivity2.getForkCommonController().isQuickReactionEnabled()) {
                    ...
                    textSettingsCell.setValue(LocaleController.getInternalString(C3316R.string.common_off));
                }
