...
import com.iMe.fork.p025ui.dialog.DrawerHeaderSettingsBottomSheet;
import com.iMe.fork.p025ui.dialog.DrawerItemsSettingsBottomSheet;
...
public final class SettingsToolsCategoryActivity extends MvpFragment {
    ...
    public final String getHint(int i) {
        if (i == this.customSharingRow) {
            return LocaleController.getInternalString(C3316R.string.settings_tools_custom_sharing_hint);
        }
        if (i == this.multiReplyRow) {
            return LocaleController.getInternalString(C3316R.string.settings_tools_multi_reply_hint);
        }
        if (i == this.cloudAlbumsRow) {
            return LocaleController.getInternalString(C3316R.string.settings_tools_cloud_albums_hint);
        }
        if (i == this.sendPopupReactionsRow) {
            return LocaleController.getInternalString(C3316R.string.settings_tools_send_popup_reactions_hint);
        }
        return null;
    }
    ...
    public static final void initListView$lambda$12$lambda$11(final SettingsToolsCategoryActivity this$0, View view, final int i, float f, float f2) {
        ...
        if (view instanceof TextCheckCell) {
            ...
            if (i == this$0.chatProfileTelegramIdRow) {
                ...
                this$0.showDialog(AlertsCreator.createChooseTemplatesModeDialog(this$0.getParentActivity(), true), new DialogInterface.OnDismissListener() { // from class: com.iMe.fork.ui.fragment.SettingsToolsCategoryActivity$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnDismissListener
                    public final void onDismiss(DialogInterface dialogInterface) {
    ...
    private final void setupActionBar() {
        ...
        c3381ActionBar.setTitle(this.category.getTitle());
        c3381ActionBar.setActionBarMenuOnItemClick(new C3381ActionBar.ActionBarMenuOnItemClick() { // from class: com.iMe.fork.ui.fragment.SettingsToolsCategoryActivity$setupActionBar$1$1
    ...
    private final AlertDialog createChooseSelectedIconHolidayDesignSideMenuDialog() {
        ...
        builder.setTitle(LocaleController.getInternalString(C3316R.string.settings_tools_design_icon));
        ...
        for (int i = 0; i < length; i++) {
            ...
            radioColorCell.setOnClickListener(new View.OnClickListener() { // from class: com.iMe.fork.ui.fragment.SettingsToolsCategoryActivity$$ExternalSyntheticLambda3
                ...
                public final void onClick(View view) {
                    SettingsToolsCategoryActivity.m711x12572646(AlertDialog.Builder.this, view);
                }
            });
    ...
    public static final void m711x12572646(AlertDialog.Builder builder, View view) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.TEXT_CHECK && (view instanceof TextCheckCell)) {
                ...
                if (i == SettingsToolsCategoryActivity.this.customizationAutoOpenForwardingOptionsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.auto_open_forwarding_options), SharedConfig.isOpenForwardingOptionsAutomaticallyEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.customSharingRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_tools_custom_sharing), SharedConfig.isCustomSharingModeEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.multiReplyRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_tools_multi_reply), SharedConfig.isMultiReplyEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatListActionBarAccountSwitchRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_action_bar_account_switch), SharedConfig.isActionBarAccountSwitchEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatListActionBarMenuRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_action_bar_menu), SharedConfig.isMainActionBarMenuEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.proxyButtonForceVisibleRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_proxy_button_in_toolbar), SharedConfig.isProxyButtonForceVisible, z2);
                } else if (i == SettingsToolsCategoryActivity.this.cloudAlbumsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_tools_cloud_albums), SharedConfig.isCloudAlbumsEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatBottomPanelRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_bottom_panel_in_channel), SettingsToolsCategoryActivity.this.getToolsController().isShowChannelBottomPanel(), z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatHideKeyboardOnScrollRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_chat_hide_keyboard_on_scroll), SharedConfig.isHideChatKeyboardOnScrollEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatThemesEnableRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_chat_themes), SharedConfig.isChatThemesEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatMemoryRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_tools_remember_chat), SettingsToolsCategoryActivity.this.getToolsController().isRememberLastDialogEnabled(), z2);
                } else if (i == SettingsToolsCategoryActivity.this.sendPopupReactionsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_tools_send_popup_reactions), SharedConfig.isReactionsInSendPopupEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.confirmationCallsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_calls_confirmation), SharedConfig.isCallsConfirmationEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.confirmationDeleteCloudRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_delete_cloud_confirmation), SharedConfig.isDeleteCloudConfirmationEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.confirmationDeleteTwoSideRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_revoke_by_default), SettingsToolsCategoryActivity.this.getToolsController().isRevokeByDefault(), z2);
                } else if (i == SettingsToolsCategoryActivity.this.confirmationSendingGifRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_sending_gif_confirmation), SharedConfig.isSendingGifConfirmationEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.confirmationSendingStickerRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_sending_sticker_confirmation), SharedConfig.isSendingStickerConfirmationEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.confirmationSpeakWithoutHoldRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_speak_without_hold), SharedConfig.isSpeakWithoutHoldEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.confirmationVideoSpeakWithoutHoldRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_video_speak_without_hold), SharedConfig.isVideoSpeakWithoutHoldEnabled, z2);
                } else if (i == SettingsToolsCategoryActivity.this.messageWidePostsRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getInternalString(C3316R.string.settings_interface_wide_posts_in_channel), SettingsToolsCategoryActivity.this.getToolsController().isChannelWidePostsEnabled(), z2);
                }
                ...
                if (i == SettingsToolsCategoryActivity.this.drawerHeaderSettingsRow) {
                    ((TextCell) view).setText(LocaleController.getInternalString(C3316R.string.settings_interface_drawer_account_info), z2);
                } else if (i == SettingsToolsCategoryActivity.this.drawerItemsRow) {
                    ((TextCell) view).setText(LocaleController.getInternalString(C3316R.string.settings_interface_drawer_items), z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatFolderAndChatSortingRow) {
                    ((TextCell) view).setText(LocaleController.getString("FilterAvailableTitle", C3316R.string.FilterAvailableTitle), z2);
                } else if (i == SettingsToolsCategoryActivity.this.settingsTopicsRow) {
                    ((TextCell) view).setText(LocaleController.getInternalString(C3316R.string.topics), z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatAttachMenuButtonsRow) {
                    ((TextCell) view).setText(LocaleController.getInternalString(C3316R.string.settings_interface_chat_attach_alert_buttons), z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatExtendedAvatarPreviewerRow) {
                    ((TextCell) view).setText(LocaleController.getInternalString(C3316R.string.settings_interface_chat_user_options_by_avatar_click_subtitle), z2);
                } else if (i == SettingsToolsCategoryActivity.this.reactionSettingsRow) {
                    ((TextCell) view).setText(LocaleController.getString("Reactions", C3316R.string.Reactions), z2);
                } else if (i == SettingsToolsCategoryActivity.this.messagesTranslate) {
                    ((TextCell) view).setTextAndIcon(LocaleController.getInternalString(C3316R.string.settings_tools_translator), C3316R.C3318drawable.msg_translate, z2);
                } else if (i == SettingsToolsCategoryActivity.this.messagesContextMenu) {
                    ((TextCell) view).setTextAndIcon(LocaleController.getInternalString(C3316R.string.settings_interface_message_context_menu), C3316R.C3318drawable.fork_settings_context_menu, z2);
                } else if (i == SettingsToolsCategoryActivity.this.sendMessages) {
                    ((TextCell) view).setTextAndIcon(LocaleController.getInternalString(C3316R.string.sending_settings_send), C3316R.C3318drawable.msg_send, z2);
                }
                ...
                if (i == SettingsToolsCategoryActivity.this.chatProfileTelegramIdRow) {
                    ((TextSettingsCell) view).setTextAndValue(LocaleController.getInternalString(C3316R.string.settings_tools_chat_profile_id_telegram), LocaleController.getInternalString(SharedConfig.selectedChatProfileTelegramIdMode.getTextResId()), z2);
                } else if (i == SettingsToolsCategoryActivity.this.chatsTemplatesRow) {
                    ((TextSettingsCell) view).setTextAndValue(LocaleController.getInternalString(C3316R.string.chat_templates), LocaleController.getInternalString(SharedConfig.selectedTemplatesMode.getTextResId()), z2);
                } else if (i == SettingsToolsCategoryActivity.this.confirmationVideoVoiceCameraRow) {
                    ((TextSettingsCell) view).setTextAndValue(LocaleController.getInternalString(C3316R.string.settings_interface_video_voice_camera), LocaleController.getInternalString(SharedConfig.selectedVideoVoiceCamera.getShortTextResId()), z2);
                } else if (i == SettingsToolsCategoryActivity.this.drawerHolidayIconType) {
                    ((TextSettingsCell) view).setTextAndValue(LocaleController.getInternalString(C3316R.string.settings_tools_design_icon), SharedConfig.drawerHolidayIconType.getTitle(), z2);
                }
                ...
                if (i != SettingsToolsCategoryActivity.this.chatMultiPanelRow) {
                    if (i != SettingsToolsCategoryActivity.this.chatSwipeToGoToNextUnreadDialogRow) {
                        if (i == SettingsToolsCategoryActivity.this.chatListRecentChatsRow) {
                            str2 = LocaleController.getInternalString(C3316R.string.settings_interface_recent_chats);
                            ...
                            if (z) {
                                ...
                                if (dialogTypesSettingsRecentChats.isEmpty()) {
                                    str = LocaleController.getInternalString(C3316R.string.settings_interface_multi_panel_no_buttons);
                                } else {
                                    str = TextUtils.join(", ", dialogTypesSettingsRecentChats);
                                }
                            } else {
                                str = LocaleController.getInternalString(C3316R.string.folder_tabs_sorting_settings_item_value_off);
                            }
                        } else {
                            str = null;
                        }
                    } else {
                        str2 = LocaleController.getInternalString(C3316R.string.settings_interface_swipe_to_next_unread_dialog);
                    ...
                    str2 = LocaleController.getInternalString(C3316R.string.settings_multi_panel_item_title);
