...
public final class MovingReactionCell extends FrameLayout {
    ...
    public final void updateUrlButton(UrlButton urlButton) {
        ...
        if (urlButton.getTitle().length() == 0) {
            getEditText().setHint(LocaleController.getInternalString(C3316R.string.chat_reaction_enter_the_title));
        }
        TextView valueTextView = getValueTextView();
        String url = urlButton.getUrl();
        if (url.length() == 0) {
            url = LocaleController.getInternalString(C3316R.string.chat_reaction_link_not_added);
        }
    ...
    public final MovingReactionCell$initEditText$1 initEditText() {
        ...
        r1.setHint(LocaleController.getInternalString(C3316R.string.chat_reaction_enter_the_title));
    ...
    public final ImageView initMoveImageView() {
        ...
        imageView.setImageResource(C3316R.C3318drawable.poll_reorder);
        return imageView;
    }
    ...
    public final TextView initValueTextView() {
        ...
        textView.setText(LocaleController.getInternalString(C3316R.string.chat_reaction_link_not_added));
    ...
    public final ImageView initDeleteImageView() {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor("stickers_menu"), PorterDuff.Mode.MULTIPLY));
        imageView.setClickable(true);
        imageView.setImageResource(C3316R.C3318drawable.delete);
        return imageView;
    }
    ...
    public final ImageView initLinkImageView() {
        ...
        imageView.setImageResource(C3316R.C3318drawable.msg_link);
        return imageView;
    }
