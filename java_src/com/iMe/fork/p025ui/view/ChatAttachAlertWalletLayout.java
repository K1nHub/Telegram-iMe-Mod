...
import com.iMe.fork.p025ui.view.ChatAttachAlertWalletLayout;
...
import com.iMe.p032ui.wallet.home.old.WalletAttachAlertView;
import com.iMe.p032ui.wallet.transaction.adapter.WalletTransactionsRecycleAdapter;
import com.iMe.p032ui.wallet.transaction.adapter.diff.TransactionDiffCallback;
...
public final class ChatAttachAlertWalletLayout extends ChatAttachAlert.AttachAlertLayout implements WalletAttachAlertView {
        ...
        recyclerListView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.iMe.fork.ui.view.ChatAttachAlertWalletLayout$1$3
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                ...
                if (i == 0) {
                    ...
                    if (((((ChatAttachAlert.AttachAlertLayout) ChatAttachAlertWalletLayout.this).parentAlert.scrollOffsetY[0] - backgroundPaddingTop) - m51dp) + backgroundPaddingTop >= C3381ActionBar.getCurrentActionBarHeight() || (holder = (RecyclerListView.Holder) recyclerListView.findViewHolderForAdapterPosition(1)) == null || holder.itemView.getTop() <= AndroidUtilities.m51dp(53.0f)) {
                        return;
                    }
    ...
    public void showRequestPermissionSuccessDialog(String title, String message, Callbacks$Callback action) {
        ...
        BaseFragment baseFragment = this.parentAlert.getBaseFragment();
        Intrinsics.checkNotNullExpressionValue(baseFragment, "parentAlert.baseFragment");
        Dialog createSuccessAlert$default = DialogsFactoryKt.createSuccessAlert$default(baseFragment, title, message, getResourceManager().getString(C3316R.string.common_ok), null, action, 8, null);
    ...
    public void onMenuItemClick(int i) {
        if (i == 40) {
            ...
            if (this.selectedBalance != null) {
                ...
                TokenBalance tokenBalance = this.selectedBalance;
                Intrinsics.checkNotNull(tokenBalance);
                presenter.resolveTokenAction(tokenBalance.getCode(), String.valueOf(currentUser.f1642id));
                return;
            }
            showToast(getResourceManager().getString(C3316R.string.transfer_via_wallet_transfer_empty_selected_account));
        }
    }
    ...
    */
    public void onPreMeasure(int r4, int r5) {
        ...
        L5c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iMe.fork.p025ui.view.ChatAttachAlertWalletLayout.onPreMeasure(int, int):void");
    }
    ...
    public void onShow(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        this.parentAlert.actionBar.setTitle(LocaleController.getInternalString(C3316R.string.transfer_via_wallet_toolbar_title));
        ...
        String internalString = LocaleController.getInternalString(C3316R.string.transfer_via_wallet_action_item);
    ...
    public void onHide() {
        ...
        String string = LocaleController.getString("Create", C3316R.string.Create);
    ...
    public final class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType == IdFabric$ViewTypes.HEADER) {
                ...
                if (i == chatAttachAlertWalletLayout.sendHeaderRow) {
                    ...
                    headerCell.setText(LocaleController.getInternalString(C3316R.string.transfer_via_wallet_transfer_title));
                    return;
                }
                ...
                if (i != chatAttachAlertWalletLayout.accountsHeaderRow) {
                    if (i == chatAttachAlertWalletLayout.transactionsHeaderRow) {
                        headerCell.setText(LocaleController.getInternalString(C3316R.string.transfer_via_wallet_transaction_title));
                        return;
                    }
                    return;
                }
                headerCell.setText(LocaleController.getInternalString(C3316R.string.transfer_via_wallet_my_accounts_title));
                ...
                if (i == chatAttachAlertWalletLayout2.chooseAccountHintRow) {
                    ...
                    String internalString = LocaleController.getInternalString(C3316R.string.transfer_via_wallet_choose_account_hint);
                ...
                ((GlobalStateLayout) holder.itemView.findViewById(C3316R.C3319id.global_state_layout)).setInternalState(this.this$0.transactionState);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
            ...
            if (i == IdFabric$ViewTypes.HEADER) {
                ...
                imageRadioCell = LayoutInflater.from(((ChatAttachAlert.AttachAlertLayout) this.this$0).parentAlert.getBaseFragment().getParentActivity()).inflate(C3316R.layout.fork_recycle_item_wallet_attach_transactions, parent, false);
                final ChatAttachAlertWalletLayout chatAttachAlertWalletLayout2 = this.this$0;
                RecyclerView recyclerView = (RecyclerView) imageRadioCell.findViewById(C3316R.C3319id.recycle_transactions);
                ...
                ((GlobalStateLayout) imageRadioCell.findViewById(C3316R.C3319id.global_state_layout)).setRetryButtonClickListener(new ChatAttachAlertWalletLayout$ListAdapter$onCreateViewHolder$3$2$1(chatAttachAlertWalletLayout2));
            } else {
