...
public final class LockedSectionsController extends BaseController {
    ...
    public LockedSectionsController(int i) {
        ...
        mutableMapOf = MapsKt__MapsKt.mutableMapOf(TuplesKt.m149to(LockedSection.ARCHIVE, new SectionPasscodeData(0, null, null, false, false, 0, 0L, 0L, 0, 0, AnalyticsListener.EVENT_DRM_KEYS_LOADED, null)), TuplesKt.m149to(LockedSection.CLOUD, new SectionPasscodeData(0, null, null, false, false, 0, 0L, 0L, 0, 0, AnalyticsListener.EVENT_DRM_KEYS_LOADED, null)));
    ...
    public final void cleanup() {
        ...
        for (LockedSection lockedSection : values) {
            arrayList.add(TuplesKt.m149to(lockedSection, new SectionPasscodeData(0, null, null, false, false, 0, 0L, 0L, 0, 0, AnalyticsListener.EVENT_DRM_KEYS_LOADED, null)));
        }
