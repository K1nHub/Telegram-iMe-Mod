...
public enum MessagePopupItem {
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String internalString = LocaleController.getInternalString(C3316R.string.chat_message_popup_option_forward_cloud);
                Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…pup_option_forward_cloud)");
                return internalString;
            case 2:
                String string = LocaleController.getString("ShareFile", C3316R.string.ShareFile);
                Intrinsics.checkNotNullExpressionValue(string, "getString(\"ShareFile\", R.string.ShareFile)");
                return string;
            case 3:
                String internalString2 = LocaleController.getInternalString(C3316R.string.settings_interface_message_popup_item_forward_messengers);
            ...
            case 4:
                String internalString3 = LocaleController.getInternalString(C3316R.string.chat_long_action_translate);
            ...
            case 5:
                String internalString4 = LocaleController.getInternalString(C3316R.string.chat_message_popup_option_copy_part);
            ...
            case 6:
                String internalString5 = LocaleController.getInternalString(C3316R.string.chat_message_popup_option_copy_image);
            ...
            case 7:
                String internalString6 = LocaleController.getInternalString(C3316R.string.message_document_file_save_as);
