...
public final class SortingFilter {
    ...
    static {
        int i = C3558R.string.sorting_settings_tab_unread_chats_item_title;
        int i2 = C3558R.C3560drawable.fork_filter_icon_bubble_point;
        int i3 = C3558R.C3560drawable.fork_filter_icon_bubble_point_filled;
        ...
        int i4 = C3558R.string.sorting_settings_tab_personal_chats_item_title;
        int i5 = C3558R.C3560drawable.fork_filter_icon_user;
        int i6 = C3558R.C3560drawable.fork_filter_icon_user_filled;
        ...
        int i7 = C3558R.string.sorting_settings_tab_groups_item_title;
        int i8 = C3558R.C3560drawable.fork_filter_icon_users;
        int i9 = C3558R.C3560drawable.fork_filter_icon_users_filled;
        ...
        int i10 = C3558R.string.sorting_settings_tab_channels_item_title;
        int i11 = C3558R.C3560drawable.fork_filter_icon_channel;
        int i12 = C3558R.C3560drawable.fork_filter_icon_channel_filled;
        ...
        int i13 = C3558R.string.sorting_settings_tab_bots_item_title;
        int i14 = C3558R.C3560drawable.fork_filter_icon_bot;
        int i15 = C3558R.C3560drawable.fork_filter_icon_bot_filled;
        ...
        int i16 = C3558R.string.sorting_settings_tab_admin_item_title;
        int i17 = C3558R.C3560drawable.fork_filter_icon_chat_admin;
        int i18 = C3558R.C3560drawable.fork_filter_icon_chat_admin_filled;
        ...
        int i19 = C3558R.string.sorting_settings_tab_owner_item_title;
        int i20 = C3558R.C3560drawable.fork_filter_icon_owner;
        int i21 = C3558R.C3560drawable.fork_filter_icon_owner_filled;
        ...
        int i22 = C3558R.string.sorting_settings_tab_private_groups_item_title;
        int i23 = C3558R.C3560drawable.fork_filter_icon_private_groups;
        int i24 = C3558R.C3560drawable.fork_filter_icon_private_groups_filled;
        ...
        int i25 = C3558R.string.sorting_settings_tab_public_groups_item_title;
        int i26 = C3558R.C3560drawable.fork_filter_icon_public_groups;
        int i27 = C3558R.C3560drawable.fork_filter_icon_public_groups_filled;
        ...
        MENTIONED_CHATS = new SortingFilter("MENTIONED_CHATS", 9, C3558R.string.sorting_settings_tab_mentioned_chats, C3558R.C3560drawable.fork_filter_icon_mentionbutton, C3558R.C3560drawable.fork_filter_icon_mentionbutton_filled, filterFab, true, MessagesController.DIALOG_FILTER_FLAG_MENTIONED | MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED, false, 11, false);
        int i28 = C3558R.string.sorting_settings_tab_live_chats;
        LIVE_CHATS = new SortingFilter("LIVE_CHATS", 10, i28, C3558R.C3560drawable.fork_filter_icon_voicechat, C3558R.C3560drawable.fork_filter_icon_voicechat_filled, filterFab, true, MessagesController.DIALOG_FILTER_FLAG_LIVE_CHAT | MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_ARCHIVED, false, 12, false);
        int i29 = C3558R.string.sorting_settings_tab_deleted_users;
        int i30 = C3558R.C3560drawable.fork_ic_ghost_26;
        int i31 = C3558R.C3560drawable.fork_ic_ghost_filled_26;
        ...
        int i32 = C3558R.string.sorting_settings_tab_secret_chats_item_title;
        int i33 = C3558R.C3560drawable.fork_filter_icon_lock;
        int i34 = C3558R.C3560drawable.fork_filter_icon_lock_filled;
        ...
        DRAFTS = new SortingFilter("DRAFTS", 13, C3558R.string.sorting_settings_tab_drafts, C3558R.C3560drawable.fork_filter_icon_drafts, C3558R.C3560drawable.fork_filter_icon_drafts_filled, FilterFab.CLEAR_DRAFTS, false, MessagesController.DIALOG_FILTER_FLAG_DRAFTS, false, 13, false);
        int i35 = C3558R.string.settings_tools_cloud_albums;
        int i36 = C3558R.C3560drawable.fork_filter_icon_albums;
        int i37 = C3558R.C3560drawable.fork_filter_icon_albums_filled;
        ...
        ARCHIVE_LIVE_CHATS = new SortingFilter("ARCHIVE_LIVE_CHATS", 24, i28, C3558R.C3560drawable.msg_voicechat, C3558R.C3560drawable.msg_voicechat2, filterFab, false, MessagesController.DIALOG_FILTER_FLAG_LIVE_CHAT | MessagesController.DIALOG_FILTER_FLAG_ONLY_ARCHIVED, false, 12, true);
