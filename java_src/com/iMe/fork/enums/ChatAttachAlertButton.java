...
public enum ChatAttachAlertButton {
    DOCUMENTS(C3316R.C3321raw.attach_file, "chat_attachFileBackground"),
    WALLET(C3316R.C3321raw.fork_attach_wallet, "iMe_chat_attach_walletBackground"),
    BINANCE(C3316R.C3321raw.fork_attach_binance, "iMe_chat_attach_binanceBackground"),
    GEO(C3316R.C3321raw.attach_location, "chat_attachLocationBackground"),
    POLL(C3316R.C3321raw.attach_poll, "chat_attachPollBackground"),
    MUSIC(C3316R.C3321raw.attach_music, "chat_attachAudioBackground"),
    CONTACT(C3316R.C3321raw.attach_contact, "chat_attachContactBackground");
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String string = LocaleController.getString("ChatDocument", C3316R.string.ChatDocument);
                Intrinsics.checkNotNullExpressionValue(string, "getString(\"ChatDocument\", R.string.ChatDocument)");
                return string;
            case 2:
                String internalString = LocaleController.getInternalString(C3316R.string.drawer_wallet_item_title);
                Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…drawer_wallet_item_title)");
                return internalString;
            case 3:
                String internalString2 = LocaleController.getInternalString(C3316R.string.wallet_binance_attach_title);
            ...
            case 4:
                String string2 = LocaleController.getString("ChatLocation", C3316R.string.ChatLocation);
                Intrinsics.checkNotNullExpressionValue(string2, "getString(\"ChatLocation\", R.string.ChatLocation)");
                return string2;
            case 5:
                String string3 = LocaleController.getString("Poll", C3316R.string.Poll);
                Intrinsics.checkNotNullExpressionValue(string3, "getString(\"Poll\", R.string.Poll)");
                return string3;
            case 6:
                String string4 = LocaleController.getString("AttachMusic", C3316R.string.AttachMusic);
                Intrinsics.checkNotNullExpressionValue(string4, "getString(\"AttachMusic\", R.string.AttachMusic)");
                return string4;
            case 7:
                String string5 = LocaleController.getString("AttachContact", C3316R.string.AttachContact);
