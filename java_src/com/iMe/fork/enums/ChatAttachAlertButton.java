...
public enum ChatAttachAlertButton {
    DOCUMENTS(C3290R.raw.attach_file, Theme.key_chat_attachFileBackground),
    WALLET(C3290R.raw.fork_attach_wallet, Theme.key_chat_attachWalletBackground),
    BINANCE(C3290R.raw.fork_attach_binance, Theme.key_chat_attachBinanceBackground),
    GEO(C3290R.raw.attach_location, Theme.key_chat_attachLocationBackground),
    POLL(C3290R.raw.attach_poll, Theme.key_chat_attachPollBackground),
    MUSIC(C3290R.raw.attach_music, Theme.key_chat_attachAudioBackground),
    CONTACT(C3290R.raw.attach_contact, Theme.key_chat_attachContactBackground);
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String string = LocaleController.getString("ChatDocument", C3290R.string.ChatDocument);
                Intrinsics.checkNotNullExpressionValue(string, "getString(\"ChatDocument\", R.string.ChatDocument)");
                return string;
            case 2:
                String internalString = LocaleController.getInternalString(C3290R.string.drawer_wallet_item_title);
                Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…drawer_wallet_item_title)");
                return internalString;
            case 3:
                String internalString2 = LocaleController.getInternalString(C3290R.string.wallet_binance_attach_title);
            ...
            case 4:
                String string2 = LocaleController.getString("ChatLocation", C3290R.string.ChatLocation);
                Intrinsics.checkNotNullExpressionValue(string2, "getString(\"ChatLocation\", R.string.ChatLocation)");
                return string2;
            case 5:
                String string3 = LocaleController.getString("Poll", C3290R.string.Poll);
                Intrinsics.checkNotNullExpressionValue(string3, "getString(\"Poll\", R.string.Poll)");
                return string3;
            case 6:
                String string4 = LocaleController.getString("AttachMusic", C3290R.string.AttachMusic);
                Intrinsics.checkNotNullExpressionValue(string4, "getString(\"AttachMusic\", R.string.AttachMusic)");
                return string4;
            case 7:
                String string5 = LocaleController.getString("AttachContact", C3290R.string.AttachContact);
