...
public enum DrawerSocialNetwork {
    TELEGRAM(C3316R.C3318drawable.fork_drawer_social_telegram, C3316R.string.drawer_social_network_telegram),
    TWITTER(C3316R.C3318drawable.fork_drawer_social_twitter, C3316R.string.drawer_social_network_twitter),
    YOUTUBE(C3316R.C3318drawable.fork_drawer_social_youtube, C3316R.string.drawer_social_network_youtube),
    APP_STORE(C3316R.C3318drawable.fork_drawer_social_app_store, C3316R.string.drawer_social_network_app_store),
    GOOGLE_PLAY(C3316R.C3318drawable.fork_drawer_social_google_play, C3316R.string.drawer_social_network_google_play),
    SITE(C3316R.C3318drawable.fork_drawer_social_site, C3316R.string.drawer_social_network_site);
    ...
    public final String url() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String internalString = LocaleController.getInternalString(C3316R.string.settings_help_alert_channel_username);
