...
public enum DrawerSocialNetwork {
    TELEGRAM(C3630R.C3632drawable.fork_drawer_social_telegram, C3630R.string.drawer_social_network_telegram),
    TWITTER(C3630R.C3632drawable.fork_drawer_social_twitter, C3630R.string.drawer_social_network_twitter),
    YOUTUBE(C3630R.C3632drawable.fork_drawer_social_youtube, C3630R.string.drawer_social_network_youtube),
    APP_STORE(C3630R.C3632drawable.fork_drawer_social_app_store, C3630R.string.drawer_social_network_app_store),
    GOOGLE_PLAY(C3630R.C3632drawable.fork_drawer_social_google_play, C3630R.string.drawer_social_network_google_play),
    SITE(C3630R.C3632drawable.fork_drawer_social_site, C3630R.string.drawer_social_network_site);
    ...
    public final String url() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String internalString = LocaleController.getInternalString(C3630R.string.settings_help_alert_channel_username);
