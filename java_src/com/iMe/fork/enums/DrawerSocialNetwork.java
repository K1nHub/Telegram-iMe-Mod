...
public enum DrawerSocialNetwork {
    TELEGRAM(C3634R.C3636drawable.fork_drawer_social_telegram, C3634R.string.drawer_social_network_telegram),
    TWITTER(C3634R.C3636drawable.fork_drawer_social_twitter, C3634R.string.drawer_social_network_twitter),
    YOUTUBE(C3634R.C3636drawable.fork_drawer_social_youtube, C3634R.string.drawer_social_network_youtube),
    APP_STORE(C3634R.C3636drawable.fork_drawer_social_app_store, C3634R.string.drawer_social_network_app_store),
    GOOGLE_PLAY(C3634R.C3636drawable.fork_drawer_social_google_play, C3634R.string.drawer_social_network_google_play),
    SITE(C3634R.C3636drawable.fork_drawer_social_site, C3634R.string.drawer_social_network_site);
    ...
    public final String url() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String internalString = LocaleController.getInternalString(C3634R.string.settings_help_alert_channel_username);
