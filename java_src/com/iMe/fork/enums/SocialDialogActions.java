...
public final class SocialDialogActions {
    ...
    static {
        int i = C3417R.C3419drawable.msg_openin;
        ...
        int i2 = C3417R.C3419drawable.msg_copy;
        String string2 = LocaleController.getString("Copy", C3417R.string.Copy);
        ...
        int i3 = C3417R.C3419drawable.msg_delete;
        String string3 = LocaleController.getString("Reset", C3417R.string.Reset);
