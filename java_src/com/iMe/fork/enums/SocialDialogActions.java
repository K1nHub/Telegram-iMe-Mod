...
public final class SocialDialogActions {
    ...
    static {
        int i = C3419R.C3421drawable.msg_openin;
        ...
        int i2 = C3419R.C3421drawable.msg_copy;
        String string2 = LocaleController.getString("Copy", C3419R.string.Copy);
        ...
        int i3 = C3419R.C3421drawable.msg_delete;
        String string3 = LocaleController.getString("Reset", C3419R.string.Reset);
