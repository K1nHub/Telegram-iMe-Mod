...
public final class SocialDialogActions {
    ...
    static {
        int i = C3558R.C3560drawable.msg_openin;
        ...
        int i2 = C3558R.C3560drawable.msg_copy;
        String string2 = LocaleController.getString("Copy", C3558R.string.Copy);
        ...
        int i3 = C3558R.C3560drawable.msg_delete;
        String string3 = LocaleController.getString("Reset", C3558R.string.Reset);
