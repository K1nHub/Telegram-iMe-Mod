...
public enum ChatsGroupCreationFilter {
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String string = LocaleController.getString("AllChats", C3630R.string.AllChats);
                Intrinsics.checkNotNullExpressionValue(string, "getString(\"AllChats\", R.string.AllChats)");
                return string;
            case 2:
                String internalString = LocaleController.getInternalString(C3630R.string.sorting_settings_tab_personal_chats_item_title);
                Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…ersonal_chats_item_title)");
                return internalString;
            case 3:
                String internalString2 = LocaleController.getInternalString(C3630R.string.sorting_settings_tab_groups_item_title);
            ...
            case 4:
                String internalString3 = LocaleController.getInternalString(C3630R.string.sorting_settings_tab_private_groups_item_title);
            ...
            case 5:
                String internalString4 = LocaleController.getInternalString(C3630R.string.sorting_settings_tab_public_groups_item_title);
            ...
            case 6:
                String internalString5 = LocaleController.getInternalString(C3630R.string.sorting_settings_tab_channels_item_title);
            ...
            case 7:
                String internalString6 = LocaleController.getInternalString(C3630R.string.sorting_settings_tab_admin_item_title);
            ...
            case 8:
                String internalString7 = LocaleController.getInternalString(C3630R.string.sorting_settings_tab_owner_item_title);
            ...
            case 9:
                String internalString8 = LocaleController.getInternalString(C3630R.string.sorting_settings_tab_bots_item_title);
