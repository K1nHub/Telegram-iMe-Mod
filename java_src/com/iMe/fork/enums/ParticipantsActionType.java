...
public final class ParticipantsActionType {
    ...
    static {
        int i = C3419R.string.profile_group_filter_confirm_remove_message;
        int i2 = C3419R.string.Delete;
        DELETE = new ParticipantsActionType("DELETE", 0, i, "Delete", i2);
        UNBLOCK = new ParticipantsActionType("UNBLOCK", 1, C3419R.string.profile_group_filter_confirm_unban_message, "Delete", i2);
        ParticipantsActionType participantsActionType = new ParticipantsActionType("RETURN", 2, C3419R.string.profile_group_filter_confirm_return_message, "UserRestrictionsInviteUsers", C3419R.string.UserRestrictionsInviteUsers);
