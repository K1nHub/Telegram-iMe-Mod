...
public enum ChatProfileTelegramIdMode {
    ...
    public final String getTitle() {
        ...
        if (i == 1) {
            String internalString = LocaleController.getInternalString(C3632R.string.settings_tools_chat_profile_id_telegram_telegram_api);
            Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…id_telegram_telegram_api)");
            return internalString;
        } else if (i == 2) {
            String internalString2 = LocaleController.getInternalString(C3632R.string.settings_tools_chat_profile_id_telegram_bot_api);
            ...
            String string = LocaleController.getString("Disable", C3632R.string.Disable);
