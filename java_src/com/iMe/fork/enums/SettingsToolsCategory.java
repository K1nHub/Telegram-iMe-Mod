...
public enum SettingsToolsCategory {
    SETTINGS_CUSTOMIZATION(C3630R.C3632drawable.msg_customize),
    SETTINGS_SIDE_MENU(C3630R.C3632drawable.fork_settings_menu),
    SETTINGS_BASIC_TOOLBAR(C3630R.C3632drawable.fork_interface_settings),
    SETTINGS_CHAT_PROFILE(C3630R.C3632drawable.msg_openprofile),
    SETTINGS_CLOUD(C3630R.C3632drawable.fork_drawer_cloud),
    SETTINGS_CHAT_LIST_VIEW(C3630R.C3632drawable.fork_ic_chats_list),
    SETTINGS_CHATS(C3630R.C3632drawable.msg_msgbubble3),
    SETTINGS_MESSAGES(C3630R.C3632drawable.fork_settings_chat),
    SETTINGS_REACTIONS_BUTTON(C3630R.C3632drawable.fork_filter_icon_heart),
    SETTINGS_CONFIRMATION(C3630R.C3632drawable.msg_block2);
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            ...
            case 6:
                String string = LocaleController.getString("ChatList", C3630R.string.ChatList);
