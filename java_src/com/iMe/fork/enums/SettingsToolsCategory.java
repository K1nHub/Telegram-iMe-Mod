...
public enum SettingsToolsCategory {
    SETTINGS_CUSTOMIZATION(C3632R.C3634drawable.msg_customize),
    SETTINGS_SIDE_MENU(C3632R.C3634drawable.fork_settings_menu),
    SETTINGS_BASIC_TOOLBAR(C3632R.C3634drawable.fork_interface_settings),
    SETTINGS_CHAT_PROFILE(C3632R.C3634drawable.msg_openprofile),
    SETTINGS_CLOUD(C3632R.C3634drawable.fork_drawer_cloud),
    SETTINGS_CHAT_LIST_VIEW(C3632R.C3634drawable.fork_ic_chats_list),
    SETTINGS_CHATS(C3632R.C3634drawable.msg_msgbubble3),
    SETTINGS_MESSAGES(C3632R.C3634drawable.fork_settings_chat),
    SETTINGS_REACTIONS_BUTTON(C3632R.C3634drawable.fork_filter_icon_heart),
    SETTINGS_CONFIRMATION(C3632R.C3634drawable.msg_block2);
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            ...
            case 6:
                String string = LocaleController.getString("ChatList", C3632R.string.ChatList);
