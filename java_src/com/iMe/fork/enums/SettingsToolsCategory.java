...
public enum SettingsToolsCategory {
    SETTINGS_CUSTOMIZATION(C3242R.C3244drawable.msg_customize),
    SETTINGS_SIDE_MENU(C3242R.C3244drawable.fork_settings_menu),
    SETTINGS_BASIC_TOOLBAR(C3242R.C3244drawable.fork_interface_settings),
    SETTINGS_CHAT_PROFILE(C3242R.C3244drawable.msg_openprofile),
    SETTINGS_CLOUD(C3242R.C3244drawable.fork_drawer_cloud),
    SETTINGS_CHAT_LIST_VIEW(C3242R.C3244drawable.fork_ic_chats_list),
    SETTINGS_CHATS(C3242R.C3244drawable.msg_msgbubble3),
    SETTINGS_MESSAGES(C3242R.C3244drawable.fork_settings_chat),
    SETTINGS_REACTIONS_BUTTON(C3242R.C3244drawable.fork_filter_icon_heart),
    SETTINGS_CONFIRMATION(C3242R.C3244drawable.msg_block2);
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String internalString = LocaleController.getInternalString(C3242R.string.settings_tools_customization);
                Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…ings_tools_customization)");
                return internalString;
            case 2:
                String internalString2 = LocaleController.getInternalString(C3242R.string.settings_interface_drawer_header);
            ...
            case 3:
                String internalString3 = LocaleController.getInternalString(C3242R.string.settings_tools_base_toolbar);
            ...
            case 4:
                String internalString4 = LocaleController.getInternalString(C3242R.string.settings_tools_chat_profile);
            ...
            case 5:
                String internalString5 = LocaleController.getInternalString(C3242R.string.folder_fab_settings_fab_cloud);
            ...
            case 6:
                String string = LocaleController.getString("ChatList", C3242R.string.ChatList);
                Intrinsics.checkNotNullExpressionValue(string, "getString(\"ChatList\", R.string.ChatList)");
                return string;
            case 7:
                String internalString6 = LocaleController.getInternalString(C3242R.string.settings_interface_chat_header);
            ...
            case 8:
                String internalString7 = LocaleController.getInternalString(C3242R.string.settings_interface_message_header);
            ...
            case 9:
                String internalString8 = LocaleController.getInternalString(C3242R.string.settings_tools_reactions);
            ...
            case 10:
                String internalString9 = LocaleController.getInternalString(C3242R.string.settings_interface_confirmation_header);
