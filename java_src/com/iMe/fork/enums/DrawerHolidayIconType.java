...
public enum DrawerHolidayIconType {
    ...
    public final String getTitle() {
        ...
        if (i == 1) {
            String string = LocaleController.getString("Default", C3295R.string.Default);
            Intrinsics.checkNotNullExpressionValue(string, "getString(\"Default\", R.string.Default)");
            return string;
        } else if (i == 2) {
            String internalString = LocaleController.getInternalString(C3295R.string.setting_tools_drawer_holiday_icon_menu_ny);
            Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…wer_holiday_icon_menu_ny)");
            return internalString;
        } else if (i == 3) {
            String internalString2 = LocaleController.getInternalString(C3295R.string.setting_tools_drawer_holiday_icon_menu_14);
            ...
            String internalString3 = LocaleController.getInternalString(C3295R.string.setting_tools_drawer_holiday_icon_menu_hw);
            ...
            String string2 = LocaleController.getString("PhoneMain", C3295R.string.PhoneMain);
