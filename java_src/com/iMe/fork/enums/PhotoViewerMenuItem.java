...
public enum PhotoViewerMenuItem {
    PHOTO_TEXT(C3316R.string.photo_viewer_open_recognize_text),
    PHOTO_INFO(C3316R.string.photo_viewer_open_recognize_photo),
    FORWARD_MESSENGERS(C3316R.string.settings_interface_message_popup_item_forward_messengers),
    TRANSLATE(C3316R.string.chat_long_action_translate),
    COPY_IMAGE(C3316R.string.photo_viewer_image_copy),
    CLEAR_CACHE(C3316R.string.photo_viewer_clear_cache);
