...
public enum SentMessageFont {
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String string = LocaleController.getString("Regular", C3419R.string.Regular);
                Intrinsics.checkNotNullExpressionValue(string, "getString(\"Regular\", R.string.Regular)");
                return string;
            case 2:
                String string2 = LocaleController.getString("Bold", C3419R.string.Bold);
                Intrinsics.checkNotNullExpressionValue(string2, "getString(\"Bold\", R.string.Bold)");
                return string2;
            case 3:
                String string3 = LocaleController.getString("Italic", C3419R.string.Italic);
                Intrinsics.checkNotNullExpressionValue(string3, "getString(\"Italic\", R.string.Italic)");
                return string3;
            case 4:
                String string4 = LocaleController.getString("Underline", C3419R.string.Underline);
                Intrinsics.checkNotNullExpressionValue(string4, "getString(\"Underline\", R.string.Underline)");
                return string4;
            case 5:
                String string5 = LocaleController.getString("Strike", C3419R.string.Strike);
                Intrinsics.checkNotNullExpressionValue(string5, "getString(\"Strike\", R.string.Strike)");
                return string5;
            case 6:
                String string6 = LocaleController.getString("Mono", C3419R.string.Mono);
                Intrinsics.checkNotNullExpressionValue(string6, "getString(\"Mono\", R.string.Mono)");
                return string6;
            case 7:
                String string7 = LocaleController.getString("Spoiler", C3419R.string.Spoiler);
