...
public enum ExtendedAvatarPreviewerItem {
    MENTION_BY_NAME(null, C3316R.string.chat_avatar_previewer_mention_by_name, C3316R.C3318drawable.fork_avatar_previewer_mention_by_name),
    MENTION("Mention", C3316R.string.Mention, C3316R.C3318drawable.msg_mention),
    COPY_ID(null, C3316R.string.wallet_user_id_dialog_copy_id_action, C3316R.C3318drawable.fork_avatar_previewer_copy_id),
    COPY_USERNAME(null, C3316R.string.wallet_channel_name_dialog_copy_id_action, C3316R.C3318drawable.fork_avatar_previewer_copy_username),
    OPEN_PROFILE("OpenProfile", C3316R.string.OpenProfile, C3316R.C3318drawable.msg_openprofile),
    SEND_MESSAGE("SendMessage", C3316R.string.SendMessage, C3316R.C3318drawable.msg_discussion),
    USER_MESSAGES(null, C3316R.string.chat_avatar_previewer_user_messages, C3316R.C3318drawable.fork_filter_icon_bubbles),
    TRANSFER(null, C3316R.string.wallet_user_id_dialog_transfer_action, C3316R.C3318drawable.fork_avatar_previewer_transfer),
    ADD_TO_CONTACTS("AddContact", C3316R.string.AddContact, C3316R.C3318drawable.msg_addcontact),
    REMOVE_CONTACT("DeleteContact", C3316R.string.DeleteContact, C3316R.C3318drawable.msg_delete),
    REMOVE_FROM_GROUP("KickFromGroup", C3316R.string.KickFromGroup, C3316R.C3318drawable.msg_remove);
