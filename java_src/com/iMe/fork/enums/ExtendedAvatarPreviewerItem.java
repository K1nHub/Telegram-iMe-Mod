...
public enum ExtendedAvatarPreviewerItem {
    MENTION_BY_NAME(null, C3558R.string.chat_avatar_previewer_mention_by_name, C3558R.C3560drawable.fork_avatar_previewer_mention_by_name),
    MENTION("Mention", C3558R.string.Mention, C3558R.C3560drawable.msg_mention),
    COPY_ID(null, C3558R.string.wallet_user_id_dialog_copy_id_action, C3558R.C3560drawable.fork_avatar_previewer_copy_id),
    COPY_USERNAME(null, C3558R.string.wallet_channel_name_dialog_copy_id_action, C3558R.C3560drawable.fork_avatar_previewer_copy_username),
    OPEN_PROFILE("OpenProfile", C3558R.string.OpenProfile, C3558R.C3560drawable.msg_openprofile),
    SEND_MESSAGE("SendMessage", C3558R.string.SendMessage, C3558R.C3560drawable.msg_discussion),
    USER_MESSAGES(null, C3558R.string.chat_avatar_previewer_user_messages, C3558R.C3560drawable.fork_filter_icon_bubbles),
    TRANSFER(null, C3558R.string.wallet_user_id_dialog_transfer_action, C3558R.C3560drawable.fork_avatar_previewer_transfer),
    ADD_TO_CONTACTS("AddContact", C3558R.string.AddContact, C3558R.C3560drawable.msg_addcontact),
    REMOVE_CONTACT("DeleteContact", C3558R.string.DeleteContact, C3558R.C3560drawable.msg_delete),
    REMOVE_FROM_GROUP("KickFromGroup", C3558R.string.KickFromGroup, C3558R.C3560drawable.msg_remove);
