...
public enum ExtendedAvatarPreviewerItem {
    MENTION_BY_NAME(null, C3242R.string.chat_avatar_previewer_mention_by_name, C3242R.C3244drawable.fork_avatar_previewer_mention_by_name),
    MENTION("Mention", C3242R.string.Mention, C3242R.C3244drawable.msg_mention),
    COPY_ID(null, C3242R.string.wallet_user_id_dialog_copy_id_action, C3242R.C3244drawable.fork_avatar_previewer_copy_id),
    COPY_USERNAME(null, C3242R.string.wallet_channel_name_dialog_copy_id_action, C3242R.C3244drawable.fork_avatar_previewer_copy_username),
    OPEN_PROFILE("OpenProfile", C3242R.string.OpenProfile, C3242R.C3244drawable.msg_openprofile),
    SEND_MESSAGE("SendMessage", C3242R.string.SendMessage, C3242R.C3244drawable.msg_discussion),
    USER_MESSAGES(null, C3242R.string.chat_avatar_previewer_user_messages, C3242R.C3244drawable.fork_filter_icon_bubbles),
    TRANSFER(null, C3242R.string.wallet_user_id_dialog_transfer_action, C3242R.C3244drawable.fork_avatar_previewer_transfer),
    ADD_TO_CONTACTS("AddContact", C3242R.string.AddContact, C3242R.C3244drawable.msg_addcontact),
    REMOVE_CONTACT("DeleteContact", C3242R.string.DeleteContact, C3242R.C3244drawable.msg_delete),
    REMOVE_FROM_GROUP("KickFromGroup", C3242R.string.KickFromGroup, C3242R.C3244drawable.msg_remove);
