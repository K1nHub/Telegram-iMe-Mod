...
public enum ExtendedAvatarPreviewerItem {
    MENTION_BY_NAME(null, C3419R.string.chat_avatar_previewer_mention_by_name, C3419R.C3421drawable.fork_avatar_previewer_mention_by_name),
    MENTION("Mention", C3419R.string.Mention, C3419R.C3421drawable.msg_mention),
    COPY_ID(null, C3419R.string.wallet_user_id_dialog_copy_id_action, C3419R.C3421drawable.fork_avatar_previewer_copy_id),
    COPY_USERNAME(null, C3419R.string.wallet_channel_name_dialog_copy_id_action, C3419R.C3421drawable.fork_avatar_previewer_copy_username),
    OPEN_PROFILE("OpenProfile", C3419R.string.OpenProfile, C3419R.C3421drawable.msg_openprofile),
    SEND_MESSAGE("SendMessage", C3419R.string.SendMessage, C3419R.C3421drawable.msg_discussion),
    USER_MESSAGES(null, C3419R.string.chat_avatar_previewer_user_messages, C3419R.C3421drawable.fork_filter_icon_bubbles),
    TRANSFER(null, C3419R.string.wallet_user_id_dialog_transfer_action, C3419R.C3421drawable.fork_avatar_previewer_transfer),
    ADD_TO_CONTACTS("AddContact", C3419R.string.AddContact, C3419R.C3421drawable.msg_addcontact),
    REMOVE_CONTACT("DeleteContact", C3419R.string.DeleteContact, C3419R.C3421drawable.msg_delete),
    REMOVE_FROM_GROUP("KickFromGroup", C3419R.string.KickFromGroup, C3419R.C3421drawable.msg_remove);
