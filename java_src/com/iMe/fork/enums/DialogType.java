...
public final class DialogType {
    ...
    static {
        ...
        List listOf7;
        List listOf8;
        int i = C3419R.string.multi_panel_settings_section_header_chats;
        int i2 = C3419R.string.pull_to_go_to_next_unread_personal_chat;
        int i3 = C3419R.string.release_to_go_to_next_unread_personal_chat;
        int i4 = C3419R.string.pull_to_go_to_unread_archived_personal_chats;
        int i5 = C3419R.string.release_to_go_to_unread_archived_personal_chats;
        int i6 = C3419R.string.no_unread_personal_chats;
        int i7 = C3419R.C3421drawable.fork_topic_user;
        int i8 = C3419R.C3420color.dialog_type_personal_chat;
        ...
        int i9 = C3419R.string.multi_panel_settings_section_header_groups;
        int i10 = C3419R.string.pull_to_go_to_next_unread_group;
        int i11 = C3419R.string.release_to_go_to_next_unread_group;
        int i12 = C3419R.string.pull_to_go_to_unread_archived_groups;
        int i13 = C3419R.string.release_to_go_to_unread_archived_groups;
        int i14 = C3419R.string.no_unread_groups;
        int i15 = C3419R.C3421drawable.fork_topic_group;
        int i16 = C3419R.C3420color.dialog_type_group;
        MultiPanelButton multiPanelButton7 = MultiPanelButton.RECENT_ACTIONS;
        listOf3 = CollectionsKt__CollectionsKt.listOf((Object[]) new MultiPanelButton[]{multiPanelButton, MultiPanelButton.MEMBERS, multiPanelButton2, multiPanelButton7, multiPanelButton3, multiPanelButton4, multiPanelButton5, multiPanelButton6});
        ...
        int i17 = C3419R.string.multi_panel_settings_section_header_channels;
        int i18 = C3419R.C3421drawable.fork_topic_channel;
        int i19 = C3419R.C3420color.dialog_type_channel;
        listOf5 = CollectionsKt__CollectionsKt.listOf((Object[]) new MultiPanelButton[]{multiPanelButton, MultiPanelButton.SUBSCRIBERS, multiPanelButton2, multiPanelButton7, multiPanelButton3, multiPanelButton4, multiPanelButton5, multiPanelButton6});
        ...
        int i20 = C3419R.string.multi_panel_settings_section_header_bots;
        int i21 = C3419R.string.pull_to_go_to_next_unread_bot;
        int i22 = C3419R.string.release_to_go_to_next_unread_bot;
        int i23 = C3419R.string.pull_to_go_to_unread_archived_bots;
        int i24 = C3419R.string.release_to_go_to_unread_archived_bots;
        int i25 = C3419R.string.no_unread_bots;
        int i26 = C3419R.C3421drawable.msg_folders_bots;
        int i27 = C3419R.C3420color.dialog_type_bot;
