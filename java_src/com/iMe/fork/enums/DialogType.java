...
public final class DialogType {
    ...
    static {
        ...
        List listOf7;
        List listOf8;
        int i = C3417R.string.multi_panel_settings_section_header_chats;
        int i2 = C3417R.string.pull_to_go_to_next_unread_personal_chat;
        int i3 = C3417R.string.release_to_go_to_next_unread_personal_chat;
        int i4 = C3417R.string.pull_to_go_to_unread_archived_personal_chats;
        int i5 = C3417R.string.release_to_go_to_unread_archived_personal_chats;
        int i6 = C3417R.string.no_unread_personal_chats;
        int i7 = C3417R.C3419drawable.fork_topic_user;
        int i8 = C3417R.C3418color.dialog_type_personal_chat;
        ...
        int i9 = C3417R.string.multi_panel_settings_section_header_groups;
        int i10 = C3417R.string.pull_to_go_to_next_unread_group;
        int i11 = C3417R.string.release_to_go_to_next_unread_group;
        int i12 = C3417R.string.pull_to_go_to_unread_archived_groups;
        int i13 = C3417R.string.release_to_go_to_unread_archived_groups;
        int i14 = C3417R.string.no_unread_groups;
        int i15 = C3417R.C3419drawable.fork_topic_group;
        int i16 = C3417R.C3418color.dialog_type_group;
        ...
        int i17 = C3417R.string.multi_panel_settings_section_header_channels;
        int i18 = C3417R.C3419drawable.fork_topic_channel;
        int i19 = C3417R.C3418color.dialog_type_channel;
        ...
        int i20 = C3417R.string.multi_panel_settings_section_header_bots;
        int i21 = C3417R.string.pull_to_go_to_next_unread_bot;
        int i22 = C3417R.string.release_to_go_to_next_unread_bot;
        int i23 = C3417R.string.pull_to_go_to_unread_archived_bots;
        int i24 = C3417R.string.release_to_go_to_unread_archived_bots;
        int i25 = C3417R.string.no_unread_bots;
        int i26 = C3417R.C3419drawable.msg_folders_bots;
        int i27 = C3417R.C3418color.dialog_type_bot;
