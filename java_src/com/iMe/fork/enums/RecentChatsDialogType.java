...
public enum RecentChatsDialogType {
    ...
    public final String getTitle() {
        ...
        if (i == 1) {
            String internalString = LocaleController.getInternalString(C3316R.string.multi_panel_settings_section_header_chats);
            Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.stri…ngs_section_header_chats)");
            return internalString;
        } else if (i == 2) {
            String internalString2 = LocaleController.getInternalString(C3316R.string.multi_panel_settings_section_header_groups);
            ...
            String internalString3 = LocaleController.getInternalString(C3316R.string.multi_panel_settings_section_header_channels);
            ...
            String internalString4 = LocaleController.getInternalString(C3316R.string.multi_panel_settings_section_header_bots);
            ...
            String string = LocaleController.getString("Topics", C3316R.string.Topics);
