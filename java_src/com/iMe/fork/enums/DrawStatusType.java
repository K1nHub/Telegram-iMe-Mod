...
public enum DrawStatusType {
    UNREAD_COUNT_CHATS(C3634R.string.recent_chats_new_messages),
    MENTIONS(C3634R.string.recent_chats_mentions),
    REACTION(C3634R.string.recent_chats_reactions),
    ONLINE_USER(C3634R.string.recent_chats_online_status),
    LIVE_VIDEO(C3634R.string.recent_chats_live);
