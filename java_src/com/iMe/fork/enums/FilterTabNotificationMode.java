...
public enum FilterTabNotificationMode {
    HIDDEN(C3290R.string.folder_tabs_notification_mode_value_hidden),
    NUMBER(C3290R.string.folder_tabs_notification_mode_value_default),
    POINT(C3290R.string.folder_tabs_notification_mode_value_points);
