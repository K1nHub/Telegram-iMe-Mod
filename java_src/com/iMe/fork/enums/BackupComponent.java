...
public enum BackupComponent {
    ...
    public final String getTitle() {
        switch (WhenMappings.$EnumSwitchMapping$0[ordinal()]) {
            case 1:
                String internalString = LocaleController.getInternalString(C3473R.string.settings_tools);
                Intrinsics.checkNotNullExpressionValue(internalString, "getInternalString(R.string.settings_tools)");
                return internalString;
            case 2:
                String internalString2 = LocaleController.getInternalString(C3473R.string.backup_component_multi_panel);
            ...
            case 3:
                String internalString3 = LocaleController.getInternalString(C3473R.string.backup_component_filters);
            ...
            case 4:
                String internalString4 = LocaleController.getInternalString(C3473R.string.backup_component_sorting);
            ...
            case 5:
                String internalString5 = LocaleController.getInternalString(C3473R.string.backup_component_albums);
            ...
            case 6:
                String internalString6 = LocaleController.getInternalString(C3473R.string.cloud_filter_music);
            ...
            case 7:
                String internalString7 = LocaleController.getInternalString(C3473R.string.backup_component_translation);
            ...
            case 8:
                String string = LocaleController.getString("ProfileStories", C3473R.string.ProfileStories);
                Intrinsics.checkNotNullExpressionValue(string, "getString(\"ProfileStorie… R.string.ProfileStories)");
                return string;
            case 9:
                String internalString8 = LocaleController.getInternalString(C3473R.string.chat_templates);
                Intrinsics.checkNotNullExpressionValue(internalString8, "getInternalString(R.string.chat_templates)");
                return internalString8;
            case 10:
                String internalString9 = LocaleController.getInternalString(C3473R.string.backup_component_topics);
            ...
            case 11:
                String internalString10 = LocaleController.getInternalString(C3473R.string.hidden_chats_title);
            ...
            case 12:
                String internalString11 = LocaleController.getInternalString(C3473R.string.settings_interface_recent_chats);
