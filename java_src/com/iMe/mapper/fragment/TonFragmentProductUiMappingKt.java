...
public final class TonFragmentProductUiMappingKt {
    private static final String formatTimeLeft(String str) {
        ...
        if (NumberExtKt.isZero(Long.valueOf(minutes))) {
            sb = LocaleController.getInternalString(C3630R.string.fragment_username_details_time_left_less_than_minute);
        } else {
        ...
        String formatStringInternal = LocaleController.formatStringInternal(C3630R.string.fragment_username_details_time_left, sb);
    ...
    public static final List<TonFragmentItem.Product> mapTonFragmentProductToUi(List<TonFragmentProduct> list, ResourceManager resourceManager) {
        ...
        for (TonFragmentProduct tonFragmentProduct : list) {
            ...
            String string = resourceManager.getString(C3630R.string.fragment_premium_product_price, tonFragmentProduct.getPrice());
    ...
    public static final List<TonFragmentItem.C1529Premium> mapPremiumPlanToUi(List<PremiumPlan> list, ResourceManager resourceManager) {
        int collectionSizeOrDefault;
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(resourceManager, "resourceManager");
        collectionSizeOrDefault = CollectionsKt__IterablesKt.collectionSizeOrDefault(list, 10);
