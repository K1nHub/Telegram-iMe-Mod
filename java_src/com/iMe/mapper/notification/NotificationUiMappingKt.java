...
public final class NotificationUiMappingKt {
    ...
    public static final PushNotificationModel mapToPushNotification(Notification notification) {
        ...
        if (notification instanceof Notification.CryptoTransfer.C1918In) {
            Notification.CryptoTransfer.C1918In c1918In = (Notification.CryptoTransfer.C1918In) notification;
            String name = c1918In.getTokenCode().getName();
            String amount = c1918In.getAmount();
            String toAddress = c1918In.getToAddress();
            return new PushNotificationModel.CryptoTransfer.C1547In(notification.getUserId(), notification.getType().name(), name, c1918In.getFromAddress(), toAddress, amount);
        ...
        } else if (notification instanceof Notification.Donation.C1919In) {
            Notification.Donation.C1919In c1919In = (Notification.Donation.C1919In) notification;
            String name3 = c1919In.getTokenCode().getName();
            String amount3 = c1919In.getAmount();
            String toAddress3 = c1919In.getToAddress();
            return new PushNotificationModel.Donation.C1548In(notification.getUserId(), notification.getType().name(), name3, c1919In.getFromAddress(), toAddress3, amount3);
