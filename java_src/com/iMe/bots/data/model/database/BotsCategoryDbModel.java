...
public final class BotsCategoryDbModel {
    ...
    public static /* synthetic */ BotsCategoryDbModel copy$default(BotsCategoryDbModel botsCategoryDbModel, String str, String str2, int i, List list, Map map, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = botsCategoryDbModel.f242id;
        }
        if ((i2 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BotsCategoryDbModel) {
            ...
            return Intrinsics.areEqual(this.f242id, botsCategoryDbModel.f242id) && Intrinsics.areEqual(this.title, botsCategoryDbModel.title) && this.priority == botsCategoryDbModel.priority && Intrinsics.areEqual(this.tags, botsCategoryDbModel.tags) && Intrinsics.areEqual(this.locales, botsCategoryDbModel.locales);
        }
        return false;
    }

    public int hashCode() {
        return (((((((this.f242id.hashCode() * 31) + this.title.hashCode()) * 31) + this.priority) * 31) + this.tags.hashCode()) * 31) + this.locales.hashCode();
    }

    public String toString() {
        return "BotsCategoryDbModel(id=" + this.f242id + ", title=" + this.title + ", priority=" + this.priority + ", tags=" + this.tags + ", locales=" + this.locales + ')';
    }
