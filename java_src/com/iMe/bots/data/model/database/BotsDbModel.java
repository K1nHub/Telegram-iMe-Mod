...
public final class BotsDbModel {
    ...
    public int hashCode() {
        ...
        String str = this.sku;
        int hashCode2 = (((((((((((((((((((((((((((((((((((((((((((((hashCode + (str == null ? 0 : str.hashCode())) * 31) + this.lang.hashCode()) * 31) + this.avatarOriginal.hashCode()) * 31) + this.avatarRounded.hashCode()) * 31) + this.titleLocales.hashCode()) * 31) + this.descriptionLocales.hashCode()) * 31) + this.title.hashCode()) * 31) + this.description.hashCode()) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.installs)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.priority)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.reviews)) * 31) + Float.floatToIntBits(this.rating)) * 31) + this.ownRating) * 31) + this.installLogged) * 31) + this.useAssets) * 31) + this.botUpdated) * 31) + this.tags.hashCode()) * 31) + this.file.hashCode()) * 31) + this.hash.hashCode()) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.phrases)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m716m(this.themes)) * 31) + this.created.hashCode()) * 31) + this.updated.hashCode()) * 31;
