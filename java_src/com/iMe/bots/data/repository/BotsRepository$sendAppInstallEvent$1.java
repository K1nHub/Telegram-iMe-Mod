...
public final class BotsRepository$sendAppInstallEvent$1 extends Lambda implements Function1<Response<String>, CompletableSource> {
    public static final BotsRepository$sendAppInstallEvent$1 INSTANCE = new BotsRepository$sendAppInstallEvent$1();

    BotsRepository$sendAppInstallEvent$1() {
        super(1);
    }
