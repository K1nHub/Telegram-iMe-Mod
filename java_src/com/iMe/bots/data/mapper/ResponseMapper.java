...
public final class ResponseMapper {
    ...
    public ResponseMapper(BotsRepository repository, Context context) {
        ...
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.m85to("23.02", Integer.valueOf(R$drawable.bot_avatar_23_02)), TuplesKt.m85to("08.03", Integer.valueOf(R$drawable.bot_avatar_08_03)), TuplesKt.m85to("01.04", Integer.valueOf(R$drawable.bot_avatar_01_04)), TuplesKt.m85to("12.04", Integer.valueOf(R$drawable.bot_avatar_12_04)), TuplesKt.m85to("28.04", Integer.valueOf(R$drawable.bot_avatar_28_04)), TuplesKt.m85to("01.05", Integer.valueOf(R$drawable.bot_avatar_01_05)), TuplesKt.m85to("09.05", Integer.valueOf(R$drawable.bot_avatar_09_05)));
        this.holidays = mapOf;
