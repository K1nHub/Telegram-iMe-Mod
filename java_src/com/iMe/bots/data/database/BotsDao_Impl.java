...
public final class BotsDao_Impl extends BotsDao {
    ...
    public BotsDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfBotsDbModel = new EntityInsertionAdapter<BotsDbModel>(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.1
        ...
        this.__insertionAdapterOfBotsDbModel_1 = new EntityInsertionAdapter<BotsDbModel>(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<BotsDbModel>(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__updateAdapterOfBotsDbModel = new EntityDeletionOrUpdateAdapter<BotsDbModel>(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new SharedSQLiteStatement(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.5
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE from BotsDbModel";
            }
        };
        this.__preparedStmtOfUpdateBot = new SharedSQLiteStatement(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.6
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "UPDATE  BotsDbModel SET hash =? , botUpdated =?, useAssets=? WHERE id=?";
            }
        };
        this.__preparedStmtOfResetDownloads = new SharedSQLiteStatement(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.7
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "UPDATE BotsDbModel set status=? WHERE status =?";
            }
        };
        this.__preparedStmtOfSaveOwnRating = new SharedSQLiteStatement(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.8
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "UPDATE BotsDbModel SET ownRating = ? WHERE id = ?";
            }
        };
        new SharedSQLiteStatement(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.9
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "UPDATE BotsDbModel SET installLogged = 1 WHERE id = ?";
            }
        };
        new SharedSQLiteStatement(this, __db) { // from class: com.iMe.bots.data.database.BotsDao_Impl.10
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
