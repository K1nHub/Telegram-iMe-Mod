...
public final class AiBotsManager {
    ...
    public final void rebuildActiveBotsList() {
        Single<List<AigramBot>> observeOn = this.botsRepository.getActiveBotsList().subscribeOn(Schedulers.m688io()).observeOn(AndroidSchedulers.mainThread());
    ...
    public final void sendAppInstalledEvent(final long j, final AppInstalledCallback callback) {
        ...
        Completable subscribeOn = this.botsRepository.sendAppInstallEvent(j).subscribeOn(Schedulers.m688io());
    ...
    public final void sendBotInstalledEvent(final String str, final long j) {
        Completable subscribeOn = this.botsRepository.sendBotInstallEvent(str, j).subscribeOn(Schedulers.m688io());
    ...
    public final void sendBotRatingEvent(String botId, long j, int i) {
        Intrinsics.checkNotNullParameter(botId, "botId");
        Single<Integer> subscribeOn = this.botsRepository.sendBotRating(botId, j, i).subscribeOn(Schedulers.m688io());
    ...
    public final Observable<List<SmartBotCategory>> getCategories(String language) {
        Intrinsics.checkNotNullParameter(language, "language");
        Single<QuerySnapshot> observeOn = this.botsRepository.getCategoriesInfo().subscribeOn(Schedulers.m688io()).observeOn(Schedulers.m688io());
    ...
    public final void listenForRemoteBotUpdates(FirebaseSnapshotCallback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        Observable<QuerySnapshot> observeOn = this.botsRepository.getRemoteBotUpdates().subscribeOn(Schedulers.m688io()).observeOn(Schedulers.m688io());
    ...
    public final void fetchTags() {
        Single<QuerySnapshot> observeOn = this.botsRepository.getTagsInfo().subscribeOn(Schedulers.m688io()).observeOn(Schedulers.m688io());
    ...
    public final void downloadPurchase(String sku, long j) {
        ...
        Single<BotsDbModel> observeOn = this.botsRepository.getBotBySku(sku).subscribeOn(Schedulers.m688io()).observeOn(Schedulers.m688io());
    ...
    public final void disableBot(final String botId) {
        Intrinsics.checkNotNullParameter(botId, "botId");
        Completable observeOn = updateBotStatus(botId, BotStatus.DISABLED).subscribeOn(Schedulers.m688io()).observeOn(AndroidSchedulers.mainThread());
    ...
    public final void startBotDownloading(final String botId, final String title, final String downloadLink, long j) {
        ...
        }).subscribeOn(Schedulers.m688io()).observeOn(Schedulers.m688io());
    ...
    public final void handleDownloadCompletion(final long j) {
        ...
        Completable subscribeOn = unzip(absolutePath, absolutePath2).subscribeOn(Schedulers.m688io());
    ...
    private final void cleanDownloads(final Function0<Unit> function0) {
        ...
        Completable doFinally = this.botsRepository.resetDownloads().subscribeOn(Schedulers.m688io()).observeOn(AndroidSchedulers.mainThread()).doFinally(new Action() { // from class: com.iMe.bots.usecase.AiBotsManager$$ExternalSyntheticLambda10
            @Override // io.reactivex.functions.Action
            public final void run() {
