...
public final class SmartBotCategory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SmartBotCategory) {
            ...
            return Intrinsics.areEqual(this.f335id, smartBotCategory.f335id) && Intrinsics.areEqual(this.title, smartBotCategory.title) && this.priority == smartBotCategory.priority && Intrinsics.areEqual(this.tags, smartBotCategory.tags);
        }
        return false;
    }

    public int hashCode() {
        return (((((this.f335id.hashCode() * 31) + this.title.hashCode()) * 31) + this.priority) * 31) + this.tags.hashCode();
    }

    public String toString() {
        return "SmartBotCategory(id=" + this.f335id + ", title=" + this.title + ", priority=" + this.priority + ", tags=" + this.tags + ')';
    }
