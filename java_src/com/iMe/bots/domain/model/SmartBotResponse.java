...
public final class SmartBotResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SmartBotResponse) {
            ...
            return Intrinsics.areEqual(this.f336id, smartBotResponse.f336id) && Intrinsics.areEqual(this.name, smartBotResponse.name) && this.localAvatar == smartBotResponse.localAvatar && Intrinsics.areEqual(this.remoteAvatar, smartBotResponse.remoteAvatar) && Intrinsics.areEqual(this.tag, smartBotResponse.tag) && Intrinsics.areEqual(this.gif, smartBotResponse.gif) && Intrinsics.areEqual(this.link, smartBotResponse.link) && Intrinsics.areEqual(this.answers, smartBotResponse.answers);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((this.f336id.hashCode() * 31) + this.name.hashCode()) * 31) + this.localAvatar) * 31) + this.remoteAvatar.hashCode()) * 31) + this.tag.hashCode()) * 31) + this.gif.hashCode()) * 31) + this.link.hashCode()) * 31) + this.answers.hashCode();
    }

    public String toString() {
        return "SmartBotResponse(id=" + this.f336id + ", name=" + this.name + ", localAvatar=" + this.localAvatar + ", remoteAvatar=" + this.remoteAvatar + ", tag=" + this.tag + ", gif=" + this.gif + ", link=" + this.link + ", answers=" + this.answers + ')';
    }
