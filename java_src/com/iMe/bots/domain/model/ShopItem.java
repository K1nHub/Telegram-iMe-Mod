...
public final class ShopItem {
    ...
    public int hashCode() {
        ...
        String str = this.sku;
        int hashCode2 = (((((((((((((((((((((((((((((hashCode + (str == null ? 0 : str.hashCode())) * 31) + this.avatar.hashCode()) * 31) + this.language.hashCode()) * 31) + this.title.hashCode()) * 31) + this.description.hashCode()) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.installs)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.priority)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.reviews)) * 31) + Float.floatToIntBits(this.rating)) * 31) + this.ownRating) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.phrases)) * 31) + BotsDbModel$$ExternalSyntheticBackport0.m724m(this.themes)) * 31) + this.created.hashCode()) * 31) + this.updated.hashCode()) * 31) + this.tags.hashCode()) * 31;
