...
public final class DialogC0382a extends Dialog {
    ...
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0383a implements View.OnClickListener {
        View$OnClickListenerC0383a() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            DialogC0382a.this.dismiss();
            DialogC0382a.this.f62c.invoke();
        }
    }

    /* renamed from: com.binance.android.opensdk.a.a$b */
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0384b implements View.OnClickListener {
        View$OnClickListenerC0384b() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            DialogC0382a.this.dismiss();
            DialogC0382a.this.f63d.invoke();
        }
    }

    /* renamed from: com.binance.android.opensdk.a.a$c */
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0385c implements View.OnClickListener {
        View$OnClickListenerC0385c() {
        }
    ...
    public DialogC0382a(Context context, Integer num, int i, Function0<Unit> loginWithAppAction, Function0<Unit> loginWithWebAction) {
        super(context);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((TextView) findViewById(i)).setOnClickListener(new View$OnClickListenerC0383a());
        ((TextView) findViewById(R$id.tvLoginWeb)).setOnClickListener(new View$OnClickListenerC0384b());
        ((TextView) findViewById(R$id.tvClose)).setOnClickListener(new View$OnClickListenerC0385c());
    }
}
