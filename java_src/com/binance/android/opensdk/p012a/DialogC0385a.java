...
public final class DialogC0385a extends Dialog {
    ...
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0386a implements View.OnClickListener {
        View$OnClickListenerC0386a() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            DialogC0385a.this.dismiss();
            DialogC0385a.this.f57c.invoke();
        }
    }

    /* renamed from: com.binance.android.opensdk.a.a$b */
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0387b implements View.OnClickListener {
        View$OnClickListenerC0387b() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            DialogC0385a.this.dismiss();
            DialogC0385a.this.f58d.invoke();
        }
    }

    /* renamed from: com.binance.android.opensdk.a.a$c */
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0388c implements View.OnClickListener {
        View$OnClickListenerC0388c() {
        }
    ...
    public DialogC0385a(Context context, Integer num, int i, Function0<Unit> loginWithAppAction, Function0<Unit> loginWithWebAction) {
        super(context);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((TextView) findViewById(i)).setOnClickListener(new View$OnClickListenerC0386a());
        ((TextView) findViewById(R$id.tvLoginWeb)).setOnClickListener(new View$OnClickListenerC0387b());
        ((TextView) findViewById(R$id.tvClose)).setOnClickListener(new View$OnClickListenerC0388c());
    }
}
