...
public final class DialogC0380a extends Dialog {
    ...
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0381a implements View.OnClickListener {
        View$OnClickListenerC0381a() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            DialogC0380a.this.dismiss();
            DialogC0380a.this.f62c.invoke();
        }
    }

    /* renamed from: com.binance.android.opensdk.a.a$b */
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0382b implements View.OnClickListener {
        View$OnClickListenerC0382b() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            DialogC0380a.this.dismiss();
            DialogC0380a.this.f63d.invoke();
        }
    }

    /* renamed from: com.binance.android.opensdk.a.a$c */
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0383c implements View.OnClickListener {
        View$OnClickListenerC0383c() {
        }
    ...
    public DialogC0380a(Context context, Integer num, int i, Function0<Unit> loginWithAppAction, Function0<Unit> loginWithWebAction) {
        super(context);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((TextView) findViewById(i)).setOnClickListener(new View$OnClickListenerC0381a());
        ((TextView) findViewById(R$id.tvLoginWeb)).setOnClickListener(new View$OnClickListenerC0382b());
        ((TextView) findViewById(R$id.tvClose)).setOnClickListener(new View$OnClickListenerC0383c());
    }
}
