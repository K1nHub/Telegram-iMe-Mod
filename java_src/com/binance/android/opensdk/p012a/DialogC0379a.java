...
public final class DialogC0379a extends Dialog {
    ...
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0380a implements View.OnClickListener {
        View$OnClickListenerC0380a() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            DialogC0379a.this.dismiss();
            DialogC0379a.this.f57c.invoke();
        }
    }

    /* renamed from: com.binance.android.opensdk.a.a$b */
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0381b implements View.OnClickListener {
        View$OnClickListenerC0381b() {
        }

        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            DialogC0379a.this.dismiss();
            DialogC0379a.this.f58d.invoke();
        }
    }

    /* renamed from: com.binance.android.opensdk.a.a$c */
    /* loaded from: classes.dex */
    static final class View$OnClickListenerC0382c implements View.OnClickListener {
        View$OnClickListenerC0382c() {
        }
    ...
    public DialogC0379a(Context context, Integer num, int i, Function0<Unit> loginWithAppAction, Function0<Unit> loginWithWebAction) {
        super(context);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((TextView) findViewById(i)).setOnClickListener(new View$OnClickListenerC0380a());
        ((TextView) findViewById(R$id.tvLoginWeb)).setOnClickListener(new View$OnClickListenerC0381b());
        ((TextView) findViewById(R$id.tvClose)).setOnClickListener(new View$OnClickListenerC0382c());
    }
}
