...
public final class C0382d {
    /* renamed from: a */
    private static final Signature m810a(PackageInfo packageInfo) {
    ...
    /* renamed from: a */
    public static final String m812a(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        String packageName = context.getPackageName();
        Intrinsics.checkExpressionValueIsNotNull(packageName, "context.packageName");
        return m811a(context, packageName);
    }

    /* renamed from: a */
    private static final String m811a(Context context, String str) {
        Signature signature;
        try {
            if (Build.VERSION.SDK_INT >= 28) {
                PackageInfo packageInfo = context.getPackageManager().getPackageInfo(str, C0470C.BUFFER_FLAG_FIRST_SAMPLE);
                Intrinsics.checkExpressionValueIsNotNull(packageInfo, "context.packageManager.g…FICATES\n                )");
                signature = m810a(packageInfo);
            } else {
