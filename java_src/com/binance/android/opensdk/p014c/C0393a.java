...
public final class C0393a {
    /* renamed from: a */
    public static final AppStatus m835a(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        return !m834a(context, "com.binance.dev") ? AppStatus.UnInstalled : m830c(context) < ((float) 1) ? AppStatus.UnSupported : AppStatus.Supported;
    }

    /* renamed from: a */
    public static final String m836a() {
    ...
    /* renamed from: a */
    public static final boolean m834a(Context context, String packageName) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    /* renamed from: a */
    public static final boolean m833a(OAuthParams oAuthParams) {
        boolean isBlank;
        ...
        if (isBlank) {
            C0394b.m829a("redirectUri cannot be null");
            return false;
        }
        return true;
    }
    ...
    */
    public static final boolean m832a(java.lang.String r2) {
        /*
            r0 = 0
            r1 = 1
            if (r2 == 0) goto Ld
        ...
        Le:
            ...
            com.binance.android.opensdk.p014c.C0394b.m829a(r2)
            return r0
        L16:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.binance.android.opensdk.p014c.C0393a.m832a(java.lang.String):boolean");
    }

    /* renamed from: b */
    public static final String m831b(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    /* renamed from: c */
    public static final float m830c(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        try {
