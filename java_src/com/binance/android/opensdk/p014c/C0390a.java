...
public final class C0390a {
    /* renamed from: a */
    public static final AppStatus m1135a(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        return !m1134a(context, "com.binance.dev") ? AppStatus.UnInstalled : m1130c(context) < ((float) 1) ? AppStatus.UnSupported : AppStatus.Supported;
    }

    /* renamed from: a */
    public static final String m1136a() {
    ...
    /* renamed from: a */
    public static final boolean m1134a(Context context, String packageName) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    /* renamed from: a */
    public static final boolean m1133a(OAuthParams oAuthParams) {
        boolean isBlank;
        ...
        if (isBlank) {
            C0391b.m1129a("redirectUri cannot be null");
            return false;
        }
        return true;
    }
    ...
    */
    public static final boolean m1132a(java.lang.String r2) {
        /*
            r0 = 0
            r1 = 1
            if (r2 == 0) goto Ld
        ...
        Le:
            ...
            com.binance.android.opensdk.p014c.C0391b.m1129a(r2)
            return r0
        L16:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.binance.android.opensdk.p014c.C0390a.m1132a(java.lang.String):boolean");
    }

    /* renamed from: b */
    public static final String m1131b(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    /* renamed from: c */
    public static final float m1130c(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        try {
