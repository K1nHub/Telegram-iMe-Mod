...
public final class C0379a {
    /* renamed from: a */
    public static final AppStatus m820a(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        return !m819a(context, "com.binance.dev") ? AppStatus.UnInstalled : m815c(context) < ((float) 1) ? AppStatus.UnSupported : AppStatus.Supported;
    }

    /* renamed from: a */
    public static final String m821a() {
    ...
    /* renamed from: a */
    public static final boolean m819a(Context context, String packageName) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    /* renamed from: a */
    public static final boolean m818a(OAuthParams oAuthParams) {
        boolean isBlank;
        ...
        if (isBlank) {
            C0380b.m814a("redirectUri cannot be null");
            return false;
        }
        return true;
    }
    ...
    */
    public static final boolean m817a(java.lang.String r2) {
        /*
            r0 = 0
            r1 = 1
            if (r2 == 0) goto Ld
        ...
        Le:
            ...
            com.binance.android.opensdk.p014c.C0380b.m814a(r2)
            return r0
        L16:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.binance.android.opensdk.p014c.C0379a.m817a(java.lang.String):boolean");
    }

    /* renamed from: b */
    public static final String m816b(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    /* renamed from: c */
    public static final float m815c(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        try {
