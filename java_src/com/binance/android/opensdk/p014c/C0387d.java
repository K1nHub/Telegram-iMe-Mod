...
public final class C0387d {
    /* renamed from: a */
    private static final Signature m1124a(PackageInfo packageInfo) {
    ...
    /* renamed from: a */
    public static final String m1126a(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        String packageName = context.getPackageName();
        Intrinsics.checkExpressionValueIsNotNull(packageName, "context.packageName");
        return m1125a(context, packageName);
    }

    /* renamed from: a */
    private static final String m1125a(Context context, String str) {
        Signature signature;
        try {
            if (Build.VERSION.SDK_INT >= 28) {
                PackageInfo packageInfo = context.getPackageManager().getPackageInfo(str, C0479C.BUFFER_FLAG_FIRST_SAMPLE);
                Intrinsics.checkExpressionValueIsNotNull(packageInfo, "context.packageManager.g…FICATES\n                )");
                signature = m1124a(packageInfo);
            } else {
            ...
            return C0386c.m1127a(byteArray);
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
