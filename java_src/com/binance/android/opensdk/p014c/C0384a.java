...
public final class C0384a {
    /* renamed from: a */
    public static final AppStatus m824a(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        return !m823a(context, "com.binance.dev") ? AppStatus.UnInstalled : m819c(context) < ((float) 1) ? AppStatus.UnSupported : AppStatus.Supported;
    }

    /* renamed from: a */
    public static final String m825a() {
    ...
    /* renamed from: a */
    public static final boolean m823a(Context context, String packageName) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    /* renamed from: a */
    public static final boolean m822a(OAuthParams oAuthParams) {
        boolean isBlank;
        ...
        if (isBlank) {
            C0385b.m818a("redirectUri cannot be null");
            return false;
        }
        return true;
    }
    ...
    */
    public static final boolean m821a(java.lang.String r2) {
        /*
            r0 = 0
            r1 = 1
            if (r2 == 0) goto Ld
        ...
        Le:
            ...
            com.binance.android.opensdk.p014c.C0385b.m818a(r2)
            return r0
        L16:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.binance.android.opensdk.p014c.C0384a.m821a(java.lang.String):boolean");
    }

    /* renamed from: b */
    public static final String m820b(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    /* renamed from: c */
    public static final float m819c(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        try {
