...
import com.binance.android.opensdk.p012a.DialogC0382a;
import com.binance.android.opensdk.p014c.C0390a;
import com.binance.android.opensdk.p014c.C0393d;
...
public final class C0386a implements BinanceAPI {
    ...
    public static final class C0388b extends Lambda implements Function0<Unit> {
        ...
        C0388b(String str, OAuthParams oAuthParams, ChallengeParams challengeParams) {
            super(0);
            this.f72b = str;
        ...
        /* renamed from: invoke  reason: avoid collision after fix types in other method */
        public final void invoke2() {
            C0386a.this.m1142a(this.f72b, this.f73c, this.f74d);
        }
    }
    ...
    private final void m1146a(OAuthParams oAuthParams, ChallengeParams challengeParams, BinanceListener binanceListener, boolean z) {
        int i;
        String m1131b = C0390a.m1131b(this.f69c);
        if (m1131b == null || !C0390a.m1132a(m1131b)) {
            i = XiaomiUtilities.OP_BLUETOOTH_CHANGE;
        } else if (C0390a.m1133a(oAuthParams)) {
            AppStatus m1135a = C0390a.m1135a(this.f69c);
            if (m1135a != AppStatus.Supported || z) {
                new DialogC0382a(this.f69c, Integer.valueOf(z ? R$string.binance_opensdk_login_failed_tips : R$string.binance_opensdk_login_to_connect), m1135a == AppStatus.UnInstalled ? R$string.binance_opensdk_download : R$string.binance_opensdk_upgrade, new C0387a(), new C0388b(m1131b, oAuthParams, challengeParams)).show();
                return;
            } else {
    ...
    /* renamed from: a */
    static /* synthetic */ void m1144a(C0386a c0386a, OAuthParams oAuthParams, ChallengeParams challengeParams, BinanceListener binanceListener, boolean z, int i, Object obj) {
        if ((i & 8) != 0) {
            z = false;
        }
        c0386a.m1146a(oAuthParams, challengeParams, binanceListener, z);
    }
    ...
    public final void m1142a(String str, OAuthParams oAuthParams, ChallengeParams challengeParams) {
        ...
        sb.append(C0390a.m1136a());
        sb.append("/oauth/authorize?response_type=code&client_id=");
        sb.append(str);
        m1137b = C0389b.m1137b(oAuthParams);
        sb.append(m1137b);
        m1138b = C0389b.m1138b(challengeParams);
        sb.append(m1138b);
    ...
    private final void m1141a(String str, OAuthParams oAuthParams, ChallengeParams challengeParams, BinanceListener binanceListener) {
        ...
        intent.putExtra("binance_opensdk_signature", C0393d.m1127a(this.f69c));
