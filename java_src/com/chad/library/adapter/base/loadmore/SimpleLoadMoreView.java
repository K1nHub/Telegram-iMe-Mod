...
public final class SimpleLoadMoreView extends BaseLoadMoreView implements KoinComponent {
    ...
    public View getRootView(ViewGroup parent) {
        ...
        return AdapterUtilsKt.getItemView(parent, C3473R.layout.fork_brvah_quick_view_load_more);
    }

    @Override // com.chad.library.adapter.base.loadmore.BaseLoadMoreView
    public View getLoadingView(BaseViewHolder holder) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        View view = holder.getView(C3473R.C3476id.load_more_loading_view);
        View findViewById = view.findViewById(C3473R.C3476id.loading_progress);
        ...
        TextView textView = (TextView) view.findViewById(C3473R.C3476id.loading_text);
        textView.setText(getResourceManager().getString(C3473R.string.common_progress_state_title));
    ...
    public View getLoadComplete(BaseViewHolder holder) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        View view = holder.getView(C3473R.C3476id.load_more_load_complete_view);
        TextView textView = (TextView) view.findViewById(C3473R.C3476id.tv_load_complete);
        textView.setText(getResourceManager().getString(C3473R.string.brvah_load_complete));
    ...
    public View getLoadEndView(BaseViewHolder holder) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        View view = holder.getView(C3473R.C3476id.load_more_load_end_view);
        TextView textView = (TextView) view.findViewById(C3473R.C3476id.tv_load_end);
        textView.setText(getResourceManager().getString(C3473R.string.brvah_load_end));
        textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText2));
        return view;
    }
    ...
    public View getLoadFailView(BaseViewHolder holder) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        View view = holder.getView(C3473R.C3476id.load_more_load_fail_view);
        TextView textView = (TextView) view.findViewById(C3473R.C3476id.tv_prompt);
        textView.setGravity(17);
        textView.setText(getResourceManager().getString(C3473R.string.brvah_load_failed));
        textView.setTextColor(Theme.getColor(Theme.key_chat_messagePanelText));
        return view;
    }
}
