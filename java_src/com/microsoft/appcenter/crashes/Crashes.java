...
public class Crashes extends AbstractAppCenterService {
    ...
    /* loaded from: classes4.dex */
    public class RunnableC26441 implements Runnable {
    }
            ...
            */
            public void run() {
                ...
                L101:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.microsoft.appcenter.crashes.Crashes.RunnableC264712.run():void");
            }
        });
    }
    ...
    private static class DefaultCrashesListener extends AbstractCrashesListener {
        ...
        /* synthetic */ DefaultCrashesListener(RunnableC26441 runnableC26441) {
            this();
        }
    }
    ...
    public static class ErrorLogReport {
        ...
        /* synthetic */ ErrorLogReport(ManagedErrorLog managedErrorLog, ErrorReport errorReport, RunnableC26441 runnableC26441) {
