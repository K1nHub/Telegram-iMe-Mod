...
public class Crashes extends AbstractAppCenterService {
    ...
    /* loaded from: classes4.dex */
    public class RunnableC25781 implements Runnable {
    }
            ...
            */
            public void run() {
                ...
                L102:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.microsoft.appcenter.crashes.Crashes.RunnableC258112.run():void");
            }
        });
    }
    ...
    private static class DefaultCrashesListener extends AbstractCrashesListener {
        ...
        /* synthetic */ DefaultCrashesListener(RunnableC25781 runnableC25781) {
            this();
        }
    }
    ...
    public static class ErrorLogReport {
        ...
        /* synthetic */ ErrorLogReport(ManagedErrorLog managedErrorLog, ErrorReport errorReport, RunnableC25781 runnableC25781) {
