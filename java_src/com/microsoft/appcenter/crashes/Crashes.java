...
public class Crashes extends AbstractAppCenterService {
    ...
    /* loaded from: classes4.dex */
    public class RunnableC25051 implements Runnable {
    }
            ...
            */
            public void run() {
                ...
                L101:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.microsoft.appcenter.crashes.Crashes.RunnableC250812.run():void");
            }
        });
    }
    ...
    private static class DefaultCrashesListener extends AbstractCrashesListener {
        ...
        /* synthetic */ DefaultCrashesListener(RunnableC25051 runnableC25051) {
            this();
        }
    }
    ...
    public static class ErrorLogReport {
        ...
        /* synthetic */ ErrorLogReport(ManagedErrorLog managedErrorLog, ErrorReport errorReport, RunnableC25051 runnableC25051) {
