...
public class SessionContext {
    ...
    public synchronized void addSession(UUID sessionId) {
        ...
        this.mSessions.put(Long.valueOf(currentTimeMillis), new SessionInfo(currentTimeMillis, sessionId, this.mAppLaunchTimestamp));
    ...
    public synchronized SessionInfo getSessionAt(long timestamp) {
        Map.Entry<Long, SessionInfo> floorEntry = this.mSessions.floorEntry(Long.valueOf(timestamp));
        if (floorEntry != null) {
