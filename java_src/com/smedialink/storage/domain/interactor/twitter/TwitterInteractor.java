...
public final class TwitterInteractor {
    ...
    public final Observable<Result<Boolean>> acceptConnection(long j, long j2) {
        ...
        Observable<Result<Boolean>> subscribeOn = handleTokenError(startWith, this.twitterRepository.acceptConnection(j, j2), j2).subscribeOn(this.schedulersProvider.mo707io());
    ...
    public final Observable<Result<Boolean>> declineConnection(long j, long j2) {
        ...
        Intrinsics.checkNotNullExpressionValue(startWith, "twitterRepository\n      …artWith(Result.loading())");
        Observable<Result<Boolean>> subscribeOn = handleTokenError(startWith, this.twitterRepository.declineConnection(j, j2), j2).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Boolean>> logout(long j) {
        ...
        Intrinsics.checkNotNullExpressionValue(startWith, "twitterRepository\n      …artWith(Result.loading())");
        Observable<Result<Boolean>> subscribeOn = handleTokenError(startWith, this.twitterRepository.logout(j), j).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<TwitterProfileInfo>> getSelfTwitterProfile(long j) {
        ...
        Intrinsics.checkNotNullExpressionValue(startWith, "twitterRepository\n      …artWith(Result.loading())");
        Observable<Result<TwitterProfileInfo>> subscribeOn = handleTokenError(startWith, this.twitterRepository.getSelfTwitterProfile(j), j).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<TwitterProfileInfo>> getSelfChatTwitterProfile(long j) {
        ...
        Intrinsics.checkNotNullExpressionValue(startWith, "twitterRepository\n      …artWith(Result.loading())");
        Observable<Result<TwitterProfileInfo>> subscribeOn = handleTokenError(startWith, this.twitterRepository.getSelfChatTwitterProfile(j), j).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }

    public final Observable<Result<TwitterProfileInfo>> getUserTwitterProfile(long j) {
        Observable<Result<TwitterProfileInfo>> subscribeOn = this.twitterRepository.getUserTwitterProfile(j).startWith((Observable<Result<TwitterProfileInfo>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }

    public final Observable<Result<List<TweetInfo>>> getUserTweets(long j, long j2, Long l) {
        Observable<Result<List<TweetInfo>>> subscribeOn = this.twitterRepository.getUserTweets(j, j2, l).startWith((Observable<Result<List<TweetInfo>>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<List<TwitterUserInfo>>> searchUsersByUsername(String usernameQuery, int i) {
        ...
        Observable<Result<List<TwitterUserInfo>>> subscribeOn = this.twitterRepository.searchUsersByUsername(usernameQuery, i).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<TwitterProfileInfo>> getUserByUsername(String username) {
        ...
        Observable<Result<TwitterProfileInfo>> subscribeOn = this.twitterRepository.getUserByUsername(username).startWith((Observable<Result<TwitterProfileInfo>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }

    public final Observable<Result<Boolean>> sendInvite(long j, long j2) {
        Observable<Result<Boolean>> subscribeOn = this.twitterRepository.sendInvite(j, j2).startWith((Observable<Result<Boolean>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "twitterRepository\n      …(schedulersProvider.io())");
        return subscribeOn;
    }
