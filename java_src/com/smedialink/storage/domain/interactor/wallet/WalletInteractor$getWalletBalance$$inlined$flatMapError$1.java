    ...
    public final ObservableSource<? extends Result<? extends List<? extends TokenBalance>>> invoke(Result<? extends List<? extends TokenBalance>> result) {
        ...
        if (result instanceof Result.Error) {
            ...
            if (contains) {
                ...
                Observable<R> flatMap = activateWallet.flatMap(new Function(walletInteractor$getWalletBalance$1$1) { // from class: com.smedialink.storage.domain.interactor.wallet.WalletInteractor$sam$io_reactivex_functions_Function$0
