...
/* renamed from: com.smedialink.storage.domain.interactor.wallet.WalletSessionInteractor$refreshToken$lambda$1$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1844x36b1d932 extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends Boolean>>> {
    final /* synthetic */ WalletSessionInteractor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1844x36b1d932(WalletSessionInteractor walletSessionInteractor) {
        super(1);
