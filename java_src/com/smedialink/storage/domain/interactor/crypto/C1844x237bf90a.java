...
/* renamed from: com.smedialink.storage.domain.interactor.crypto.CryptoWalletInteractor$getCreatePinCodeObservable$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1844x237bf90a extends Lambda implements Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Wallet>>> {
    final /* synthetic */ Observable $mapperObservable$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1844x237bf90a(Observable observable) {
        super(1);
