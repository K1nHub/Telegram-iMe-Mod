...
public final class C1854x37fea2f2 extends Lambda implements Function1<Result<? extends Boolean>, Result<? extends AccountLevelInformation>> {
    ...
    public C1854x37fea2f2(Result result, long j, AccountLevelInteractor accountLevelInteractor) {
        super(1);
