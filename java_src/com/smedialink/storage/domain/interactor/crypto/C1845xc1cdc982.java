...
public final class C1845xc1cdc982 extends Lambda implements Function1<Result<? extends CryptoWalletInfo>, ObservableSource<? extends Result<? extends String>>> {
    final /* synthetic */ BlockchainType $blockchainType$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1845xc1cdc982(BlockchainType blockchainType) {
        super(1);
