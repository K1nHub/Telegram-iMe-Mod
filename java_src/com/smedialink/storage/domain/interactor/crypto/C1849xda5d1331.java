...
/* renamed from: com.smedialink.storage.domain.interactor.crypto.CryptoWalletInteractor$linkWalletAddressWithCheck$lambda$22$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1849xda5d1331 extends Lambda implements Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C1849xda5d1331(CryptoWalletInteractor cryptoWalletInteractor, Wallet wallet2, NetworkType networkType) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends Boolean> result) {
        ...
        Observable<Result<Boolean>> subscribeOn = linkWallet.subscribeOn(schedulersProvider.mo707io());
