...
/* renamed from: com.smedialink.storage.domain.interactor.crypto.CryptoWalletInteractor$activateBip39BasedWallet$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1842xfb32ecc7 extends Lambda implements Function1<Result<? extends List<? extends Wallet>>, ObservableSource<? extends Result<? extends Wallet>>> {
    public C1842xfb32ecc7() {
        super(1);
    }
    ...
    public final ObservableSource<? extends Result<? extends Wallet>> invoke(Result<? extends List<? extends Wallet>> result) {
        ...
        if (!(result instanceof Result.Success)) {
            if (result instanceof Result.Error) {
                ...
                Intrinsics.checkNotNull(error$default2, "null cannot be cast to non-null type R of com.smedialink.storage.domain.utils.extentions.ObservableExtKt.flatMapSuccess");
