...
public final class C1834x237bf90a extends Lambda implements Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Wallet>>> {
    final /* synthetic */ Observable $mapperObservable$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1834x237bf90a(Observable observable) {
        super(1);
