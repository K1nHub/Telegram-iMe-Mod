...
public final class CryptoWalletInteractor {
    ...
    private final Observable<Result<Wallet>> withAllBip39BasedWalletsActivationCheck(Observable<Result<Wallet>> observable, BlockchainType blockchainType) {
        Observable flatMap = observable.flatMap(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1850xc8c5d4ec(blockchainType, this)));
    ...
    public final Observable<Result<Wallet>> activateBip39BasedWallet(BlockchainType blockchainType) {
        ...
        Observable flatMap = importBib39BasedWallets(listOf).flatMap(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1842xfb32ecc7()));
        Intrinsics.checkNotNullExpressionValue(flatMap, "crossinline body: (T) ->…e.empty()\n        }\n    }");
        return flatMap;
    }
    ...
    public final Observable<Result<String>> getLinkedCryptoWalletAddress(BlockchainType blockchainType) {
        Intrinsics.checkNotNullParameter(blockchainType, "blockchainType");
        Observable<R> flatMap = this.cryptoWalletRepository.getLinkedCryptoWalletInfo().flatMap(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1845xc1cdc982(blockchainType)));
        Intrinsics.checkNotNullExpressionValue(flatMap, "crossinline body: (T) ->…e.empty()\n        }\n    }");
        Observable<Result<String>> subscribeOn = flatMap.subscribeOn(this.schedulersProvider.mo707io());
    ...
    public final Observable<Result<Boolean>> isPasswordForWallet(String password, BlockchainType blockchainType) {
        Intrinsics.checkNotNullParameter(password, "password");
        Intrinsics.checkNotNullParameter(blockchainType, "blockchainType");
        Observable<Result<Boolean>> subscribeOn = this.cryptoLocalWalletRepository.isValidPasswordForWallet(password, blockchainType).subscribeOn(this.schedulersProvider.mo707io());
    ...
    public final Observable<Result<String>> generateMnemonic(String guid, String password) {
        Intrinsics.checkNotNullParameter(guid, "guid");
        Intrinsics.checkNotNullParameter(password, "password");
        Observable<Result<String>> subscribeOn = this.cryptoLocalWalletRepository.generateMnemonic(guid, password, this.cryptoPreferenceHelper.getCurrentBlockchainType()).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoLocalWalletReposit…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Boolean>> isValidSeed(String seed, BlockchainType blockchainType) {
        Intrinsics.checkNotNullParameter(seed, "seed");
        Intrinsics.checkNotNullParameter(blockchainType, "blockchainType");
        Observable<Result<Boolean>> subscribeOn = this.cryptoLocalWalletRepository.isValidSeed(seed, blockchainType).startWith((Observable<Result<Boolean>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoLocalWalletReposit…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Boolean>> isValidRestoredAddress(String seed, String address, BlockchainType blockchainType) {
        ...
        Intrinsics.checkNotNullParameter(address, "address");
        Intrinsics.checkNotNullParameter(blockchainType, "blockchainType");
        Observable<Result<Boolean>> subscribeOn = this.cryptoLocalWalletRepository.isValidRestoredAddress(seed, address, blockchainType).startWith((Observable<Result<Boolean>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo707io());
        Intrinsics.checkNotNullExpressionValue(subscribeOn, "cryptoLocalWalletReposit…(schedulersProvider.io())");
        return subscribeOn;
    }
    ...
    public final Observable<Result<Boolean>> deleteWallet(BlockchainType blockchainType, boolean z, boolean z2) {
        ...
        Observable<Result<Boolean>> subscribeOn = doOnNext.startWith((Observable) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo707io());
    ...
    public final Observable<Result<Boolean>> deleteAllWallets(boolean z) {
        ...
        if (CollectionExtKt.isSingletonList(arrayList2)) {
            ...
            finalObservable = Observable.zip(arrayList2, new Function() { // from class: com.smedialink.storage.domain.interactor.crypto.CryptoWalletInteractor$$ExternalSyntheticLambda1
        ...
        Observable<Result<Boolean>> doOnNext = finalObservable.doOnNext(new ObservableExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1843x5e7d6f0b(this)));
        Intrinsics.checkNotNullExpressionValue(doOnNext, "crossinline body: (T) ->…ult as T)\n        }\n    }");
        return doOnNext;
    }
    ...
    private final Observable<Result<Wallet>> recreateWallet(String str, String str2, BlockchainType blockchainType) {
        ...
        Observable<Result<Wallet>> finalObservable = map.subscribeOn(this.schedulersProvider.mo707io());
        if (!(str2.length() == 0)) {
        ...
        Intrinsics.checkNotNullExpressionValue(doOnNext, "crossinline body: (T) ->…ult as T)\n        }\n    }");
        Observable<Result<Wallet>> subscribeOn = withAllBip39BasedWalletsActivationCheck(doOnNext, blockchainType).startWith((Observable<Result<Wallet>>) Result.Companion.loading$default(Result.Companion, null, 1, null)).subscribeOn(this.schedulersProvider.mo707io());
    ...
    private final Observable<Result<List<Wallet>>> importBib39BasedWallets(List<? extends BlockchainType> list) {
        ...
        for (BlockchainType blockchainType : list) {
            Observable<R> flatMap = this.cryptoLocalWalletRepository.importWallet(this.cryptoPreferenceHelper.getLastLoggedInGuid(), mnemonic, walletPassword, blockchainType).flatMap(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1846x3c514ad4(this)));
            Intrinsics.checkNotNullExpressionValue(flatMap, "crossinline body: (T) ->…e.empty()\n        }\n    }");
            arrayList.add(flatMap.subscribeOn(this.schedulersProvider.mo707io()));
        }
        ...
        Observable<Result<List<Wallet>>> subscribeOn = Observable.zip(arrayList, new Function() { // from class: com.smedialink.storage.domain.interactor.crypto.CryptoWalletInteractor$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
    ...
    private final Observable<Result<Wallet>> createWallet(String str, String str2, BlockchainType blockchainType) {
        ...
        Intrinsics.checkNotNullExpressionValue(flatMap, "crossinline body: (T) ->…e.empty()\n        }\n    }");
        Observable<Result<Wallet>> finalObservable = flatMap.subscribeOn(this.schedulersProvider.mo707io());
        if (!(str2.length() == 0)) {
    ...
    private final Observable<Result<Wallet>> getCreatePinCodeObservable(String str, String str2, String str3, Observable<Result<Wallet>> observable) {
        Observable flatMap = this.pinCodeInteractor.createPinCode(str, str2, str3).flatMap(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1844x237bf90a(observable)));
        Intrinsics.checkNotNullExpressionValue(flatMap, "crossinline body: (T) ->…e.empty()\n        }\n    }");
        return flatMap;
    }
    ...
    public final Observable<Result<Wallet>> linkWalletAddressWithCheck(Wallet wallet2) {
        Observable<R> flatMap = getLinkedCryptoWalletAddress(wallet2.getBlockchainType()).flatMap(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1847xffacd658(this, wallet2)));
        Intrinsics.checkNotNullExpressionValue(flatMap, "crossinline body: (T) ->…e.empty()\n        }\n    }");
        Observable map = flatMap.map(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1848x3cb7ddbf(wallet2)));
        Intrinsics.checkNotNullExpressionValue(map, "crossinline body: (T) ->…ult as? R\n        }\n    }");
        Observable<Result<Wallet>> subscribeOn = map.subscribeOn(this.schedulersProvider.mo707io());
    ...
    */
    public final io.reactivex.Observable<com.smedialink.storage.domain.model.Result<java.lang.Boolean>> unlinkWalletIfNeed(java.lang.String r1, com.smedialink.storage.domain.model.crypto.NetworkType r2) {
        /*
            r0 = this;
            if (r1 == 0) goto Lb
        ...
        Lc:
            ...
            com.smedialink.storage.domain.model.Result$Companion r2 = com.smedialink.storage.domain.model.Result.Companion
            com.smedialink.storage.domain.model.Result r1 = r2.success(r1)
            io.reactivex.Observable r1 = io.reactivex.Observable.just(r1)
            java.lang.String r2 = "just(this)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r2)
            goto L26
        L20:
            com.smedialink.storage.domain.repository.crypto.CryptoWalletRepository r1 = r0.cryptoWalletRepository
            io.reactivex.Observable r1 = r1.unlinkWallet(r2)
        L26:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.storage.domain.interactor.crypto.CryptoWalletInteractor.unlinkWalletIfNeed(java.lang.String, com.smedialink.storage.domain.model.crypto.NetworkType):io.reactivex.Observable");
    }
}
