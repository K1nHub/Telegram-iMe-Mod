...
public final class TwitterAccountData {
    ...
    public int hashCode() {
        return (((((((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.twitterId) * 31) + this.twitterUsername.hashCode()) * 31) + this.accessToken.hashCode()) * 31) + this.refreshToken.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.tokenValidUntil);
    }
