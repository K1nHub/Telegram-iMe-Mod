...
public final class PreferenceTwitterTelegramIdMappedData {
    ...
    private final Map<Long, TwitterAccountData> getData() {
        ...
        return (Map) gson.fromJson(string, new TypeToken<Map<Long, ? extends TwitterAccountData>>() { // from class: com.smedialink.storage.domain.model.twitter.PreferenceTwitterTelegramIdMappedData$special$$inlined$fromJsonTokenType$1
        }.getType());
    }
