...
public final class TwitterProfileInfo {
    ...
    public int hashCode() {
        int m716m = ((((((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.twitterUserId) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.twitterUserIdInDatabase)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.telegramUserId)) * 31) + this.twitterUserName.hashCode()) * 31;
