package com.smedialink.storage.domain.model.dialogs;
...
public final class DialogTranslationSettings {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((hashCode + i2) * 31) + this.outTextTranslateLangCode.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.dialogId)) * 31;
