...
public final class Campaign {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Campaign) {
            ...
            return Intrinsics.areEqual(this.category, campaign.category) && Intrinsics.areEqual(this.channel, campaign.channel) && Intrinsics.areEqual(this.countries, campaign.countries) && Intrinsics.areEqual(this.createdAt, campaign.createdAt) && this.f315id == campaign.f315id && Intrinsics.areEqual(this.invalidReason, campaign.invalidReason) && Intrinsics.areEqual(this.language, campaign.language) && this.status == campaign.status && Intrinsics.areEqual(this.tags, campaign.tags);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((this.category.hashCode() * 31) + this.channel.hashCode()) * 31) + this.countries.hashCode()) * 31) + this.createdAt.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.f315id)) * 31) + this.invalidReason.hashCode()) * 31) + this.language.hashCode()) * 31) + this.status.hashCode()) * 31) + this.tags.hashCode();
    }

    public String toString() {
        return "Campaign(category=" + this.category + ", channel=" + this.channel + ", countries=" + this.countries + ", createdAt=" + this.createdAt + ", id=" + this.f315id + ", invalidReason=" + this.invalidReason + ", language=" + this.language + ", status=" + this.status + ", tags=" + this.tags + ')';
    }
