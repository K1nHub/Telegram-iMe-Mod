...
public abstract class Transaction {
    ...
    public static class Crypto extends Transaction {
        ...
        public static final class Donation extends Transfer {
            ...
            @Override // com.smedialink.storage.domain.model.wallet.transaction.Transaction.Crypto.Transfer, com.smedialink.storage.domain.model.wallet.transaction.Transaction.Crypto
            public String getTxHash() {
                return this.txHash;
            }

            @Override // com.smedialink.storage.domain.model.wallet.transaction.Transaction.Crypto.Transfer
        ...
        public static class Transfer extends Crypto {
            ...
            @Override // com.smedialink.storage.domain.model.wallet.transaction.Transaction.Crypto
            public String getTxHash() {
                return this.txHash;
            }
