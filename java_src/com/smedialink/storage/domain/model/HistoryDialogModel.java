...
public final class HistoryDialogModel {
    ...
    public int hashCode() {
        int m716m = ((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.dialogId) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.creationDate)) * 31;
