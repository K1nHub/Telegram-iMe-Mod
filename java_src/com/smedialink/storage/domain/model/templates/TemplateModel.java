package com.smedialink.storage.domain.model.templates;
...
public final class TemplateModel {
    ...
    public int hashCode() {
        int m716m = ((((((((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.messageId) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.groupId)) * 31) + this.name.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.creationDate)) * 31) + this.usageRating) * 31;
        boolean z = this.sent;
        int i = z;
        if (z != 0) {
            i = 1;
