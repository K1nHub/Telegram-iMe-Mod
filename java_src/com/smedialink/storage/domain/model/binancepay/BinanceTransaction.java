...
public abstract class BinanceTransaction {
    ...
    public static final class Unsupported extends BinanceTransaction {
        ...
        @Override // com.smedialink.storage.domain.model.binancepay.BinanceTransaction
        public String getOrderId() {
            return this.orderId;
        }
    ...
    public static final class Pay extends BinanceTransaction {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Pay) {
                Pay pay = (Pay) obj;
                return Intrinsics.areEqual(getOrderId(), pay.getOrderId()) && Intrinsics.areEqual(getTransactionId(), pay.getTransactionId()) && Intrinsics.areEqual(getPayerUserId(), pay.getPayerUserId()) && Intrinsics.areEqual(getInitiatorUserId(), pay.getInitiatorUserId()) && Intrinsics.areEqual(Double.valueOf(getAmount()), Double.valueOf(pay.getAmount())) && Intrinsics.areEqual(getAsset(), pay.getAsset()) && Intrinsics.areEqual(getAssetName(), pay.getAssetName()) && Intrinsics.areEqual(getAssetLogo(), pay.getAssetLogo()) && getDirection() == pay.getDirection() && getType() == pay.getType() && getStatus() == pay.getStatus() && Intrinsics.areEqual(getCreatedAt(), pay.getCreatedAt()) && Intrinsics.areEqual(this.clientTradeNo, pay.clientTradeNo);
            }
            return false;
        }
    ...
    public static final class Convert extends BinanceTransaction {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Convert) {
                ...
                return Intrinsics.areEqual(getOrderId(), convert.getOrderId()) && Intrinsics.areEqual(getTransactionId(), convert.getTransactionId()) && Intrinsics.areEqual(getPayerUserId(), convert.getPayerUserId()) && Intrinsics.areEqual(getInitiatorUserId(), convert.getInitiatorUserId()) && Intrinsics.areEqual(Double.valueOf(getAmount()), Double.valueOf(convert.getAmount())) && Intrinsics.areEqual(getAsset(), convert.getAsset()) && Intrinsics.areEqual(getAssetName(), convert.getAssetName()) && Intrinsics.areEqual(getAssetLogo(), convert.getAssetLogo()) && getDirection() == convert.getDirection() && getType() == convert.getType() && getStatus() == convert.getStatus() && Intrinsics.areEqual(getCreatedAt(), convert.getCreatedAt()) && Intrinsics.areEqual(Double.valueOf(this.inputAmount), Double.valueOf(convert.inputAmount)) && Intrinsics.areEqual(Double.valueOf(this.outputAmount), Double.valueOf(convert.outputAmount)) && Intrinsics.areEqual(this.inputAssetCode, convert.inputAssetCode) && Intrinsics.areEqual(this.outputAssetCode, convert.outputAssetCode) && Intrinsics.areEqual(this.inputAssetShortName, convert.inputAssetShortName) && Intrinsics.areEqual(this.outputAssetShortName, convert.outputAssetShortName);
            }
            return false;
        }
