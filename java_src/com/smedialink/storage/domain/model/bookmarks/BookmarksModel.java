package com.smedialink.storage.domain.model.bookmarks;
...
public final class BookmarksModel {
    ...
    public int hashCode() {
        return (this.messageIds.hashCode() * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.dialogId);
    }
