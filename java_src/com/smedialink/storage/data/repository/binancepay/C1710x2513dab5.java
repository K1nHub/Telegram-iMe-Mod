...
public final class C1710x2513dab5 extends Lambda implements Function1<ApiBaseResponse<List<? extends BinanceGetConvertOppositeSupportTokensResponse>>, Result<? extends List<? extends OutputConvertToken>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1710x2513dab5(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
