...
public final class C1717xe5e8bbcf extends Lambda implements Function1<Throwable, Result<? extends List<? extends BinanceTransaction>>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1717xe5e8bbcf(ErrorHandler errorHandler) {
        super(1);
