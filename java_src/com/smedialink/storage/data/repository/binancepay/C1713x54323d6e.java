...
public final class C1713x54323d6e extends Lambda implements Function1<Throwable, Result<? extends List<? extends BinanceTokenInfo>>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1713x54323d6e(ErrorHandler errorHandler) {
        super(1);
