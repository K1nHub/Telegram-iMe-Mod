...
/* renamed from: com.smedialink.storage.data.repository.binancepay.BinanceInternalRepositoryImpl$getTokensForConvert$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1720xc5934260 extends Lambda implements Function1<ApiBaseResponse<List<? extends BinanceGetConvertSupportTokensResponse>>, Result<? extends List<? extends BinanceTokenInfo>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1720xc5934260(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
