...
public final class CryptoLocalWalletRepositoryImpl implements CryptoLocalWalletRepository {
    ...
    public Observable<Result<List<Wallet>>> unlockAllWallets(String oldGuid, String newGuid, String password) {
        ...
        Observable<Result<List<Wallet>>> zip = Observable.zip(arrayList2, new Function() { // from class: com.smedialink.storage.data.repository.crypto.CryptoLocalWalletRepositoryImpl$$ExternalSyntheticLambda2
    ...
    public Observable<Result<Boolean>> isValidSeed(final String seed, BlockchainType blockchainType) {
        ...
        if (i == 1 || i == 2) {
            ...
            fromCallable = generateAddressByMnemonic.map(new Function() { // from class: com.smedialink.storage.data.repository.crypto.CryptoLocalWalletRepositoryImpl$$ExternalSyntheticLambda0
                @Override // io.reactivex.functions.Function
                public final Object apply(Object obj) {
        ...
        Observable<Result<Boolean>> onErrorReturn = fromCallable.onErrorReturn(new Function() { // from class: com.smedialink.storage.data.repository.crypto.CryptoLocalWalletRepositoryImpl$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
