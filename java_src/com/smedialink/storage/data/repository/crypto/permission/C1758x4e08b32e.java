...
public final class C1758x4e08b32e extends Lambda implements Function1<ApiBaseResponse<Object>, Result<? extends Boolean>> {
    ...
    public C1758x4e08b32e(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler, CryptoPermissionRepositoryImpl cryptoPermissionRepositoryImpl, boolean z, List list) {
        super(1);
    ...
    public final Result<Boolean> invoke(ApiBaseResponse<Object> response) {
        ...
        CryptoWalletInfo copy$default = walletInfo != null ? CryptoWalletInfo.copy$default(walletInfo, null, null, this.$isAllowForEveryone$inlined, this.$whitelistUsers$inlined, 3, null) : null;
