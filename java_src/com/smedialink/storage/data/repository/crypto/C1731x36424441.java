...
public final class C1731x36424441 extends Lambda implements Function1<Result<? extends Wallet>, Result<? extends List<? extends Wallet>>> {
    final /* synthetic */ String $password$inlined;
    final /* synthetic */ CryptoLocalWalletRepositoryImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1731x36424441(CryptoLocalWalletRepositoryImpl cryptoLocalWalletRepositoryImpl, String str) {
        super(1);
    ...
    public final Result<? extends List<? extends Wallet>> invoke(Result<? extends Wallet> result) {
        ...
        cryptoAccessManager.setWallet(wallet, this.$password$inlined);
