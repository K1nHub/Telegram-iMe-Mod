...
public final class C1740xd55ff52f extends Lambda implements Function1<Throwable, Result<? extends List<? extends Transaction>>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1740xd55ff52f(ErrorHandler errorHandler) {
        super(1);
