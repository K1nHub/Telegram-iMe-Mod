...
/* renamed from: com.smedialink.storage.data.repository.crypto.donations.DonationsRepositoryImpl$getDonationWalletBalance$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1743x958a7381 extends Lambda implements Function1<ApiBaseResponse<WalletBalancesResponse>, Result<? extends TokenBalance>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1743x958a7381(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
