    ...
    public final Result<? extends Boolean> invoke(Result<? extends Boolean> result) {
        ...
        if (result instanceof Result.Error) {
            ...
            if (!Intrinsics.areEqual(error.getError().getStatus(), this.$errorStatus)) {
                ...
                Intrinsics.checkNotNull(error$default, "null cannot be cast to non-null type R of com.smedialink.storage.domain.utils.extentions.ObservableExtKt.mapError");
