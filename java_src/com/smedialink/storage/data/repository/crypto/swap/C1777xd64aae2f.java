...
/* renamed from: com.smedialink.storage.data.repository.crypto.swap.SwapRepositoryImpl$getAvailableTokensToSwap$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1777xd64aae2f extends Lambda implements Function1<ApiBaseResponse<AvailableSwapTokensResponse>, Result<? extends List<? extends TokenInfo>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1777xd64aae2f(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
