...
public final class C1737x2157d0e9 extends Lambda implements Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C1737x2157d0e9(CryptoLocalWalletRepositoryImpl cryptoLocalWalletRepositoryImpl, String str, BlockchainType blockchainType, String str2) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends Boolean> result) {
        ...
        ObservableSource map = cryptoWalletsManager.generateAddressByMnemonic(this.$seed$inlined, this.$blockchainType$inlined).map(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1738x5a3cb788(this.$linkedAddress$inlined)));
