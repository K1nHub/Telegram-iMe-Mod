...
public final class C1761x9951f988 extends Lambda implements Function1<ApiBaseResponse<PasswordByPinCodeRequest>, ObservableSource<? extends Result<? extends String>>> {
    ...
    public C1761x9951f988(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler, PinCodeRepositoryImpl pinCodeRepositoryImpl, boolean z, String str) {
        super(1);
    ...
    /* loaded from: classes3.dex */
    public static final class C17621 extends Lambda implements Function1<String, Result<? extends String>> {
        public static final C17621 INSTANCE = new C17621();
    ...
    public final ObservableSource<? extends Result<String>> invoke(ApiBaseResponse<PasswordByPinCodeRequest> response) {
        ...
        if (this.$shouldUnlockWallet$inlined) {
            ...
            Observable<R> map = cryptoLocalWalletRepository.unlockAllWallets(str, str, aesDecrypt).map(new ObservableExtKt$sam$i$io_reactivex_functions_Function$0(new C1764x713d6224(aesDecrypt)));
        ...
        return just.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(C17621.INSTANCE));
    }
}
