...
/* renamed from: com.smedialink.storage.data.repository.crypto.CryptoLocalWalletRepositoryImpl$createWallet$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1734x33bae8b9 extends Lambda implements Function1<Result<? extends Wallet>, Result<? extends Wallet>> {
    final /* synthetic */ String $password$inlined;
    final /* synthetic */ CryptoLocalWalletRepositoryImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1734x33bae8b9(CryptoLocalWalletRepositoryImpl cryptoLocalWalletRepositoryImpl, String str) {
        super(1);
