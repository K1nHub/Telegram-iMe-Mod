...
/* renamed from: com.smedialink.storage.data.repository.wallet.WalletRepositoryImpl$getWalletTransactionHistory$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1817x5cdbb371 extends Lambda implements Function1<ApiBaseResponse<WalletTransactionsResponse>, Result<? extends List<? extends Transaction>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1817x5cdbb371(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
