...
public final class WalletRepositoryImpl$getTokensBalance$$inlined$flatMapSuccess$1 extends Lambda implements Function1<ApiBaseResponse<WalletBalancesResponse>, ObservableSource<? extends Result<? extends List<? extends TokenBalance>>>> {
    ...
    /* compiled from: FirebaseExt.kt */
    /* renamed from: com.smedialink.storage.data.repository.wallet.WalletRepositoryImpl$getTokensBalance$$inlined$flatMapSuccess$1$1 */
    /* loaded from: classes3.dex */
    public static final class C18101 extends Lambda implements Function1<List<? extends TokenBalance>, Result<? extends List<? extends TokenBalance>>> {
    ...
    public final ObservableSource<? extends Result<List<? extends TokenBalance>>> invoke(ApiBaseResponse<WalletBalancesResponse> response) {
        ...
        sortedWith = CollectionsKt___CollectionsKt.sortedWith(arrayList, new Comparator() { // from class: com.smedialink.storage.data.repository.wallet.WalletRepositoryImpl$getTokensBalance$lambda$13$$inlined$sortedBy$1
        ...
        Completable subscribeOn = rxInsert.subscribeOn(schedulersProvider.mo707io());
        ...
        return andThen.map(new FirebaseExtKt$sam$i$io_reactivex_functions_Function$0(C18101.INSTANCE));
    }
}
