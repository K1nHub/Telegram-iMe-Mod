...
public final class C1809x8820c924 extends Lambda implements Function1<Throwable, Result<? extends CryptoTransferMetadata>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1809x8820c924(ErrorHandler errorHandler) {
        super(1);
