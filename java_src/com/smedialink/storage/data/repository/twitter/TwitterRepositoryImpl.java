...
public final class TwitterRepositoryImpl implements TwitterRepository {
    ...
    */
    public final void updateAccountUsername(long r12, java.lang.String r14) {
        /*
            r11 = this;
            com.smedialink.storage.domain.storage.TwitterPreferenceHelper r0 = r11.twitterPreferenceHelper
            com.smedialink.storage.domain.model.twitter.PreferenceTwitterTelegramIdMappedData r0 = r0.getAccountsData()
            com.smedialink.storage.domain.model.twitter.TwitterAccountData r1 = r11.getTwitterAccountDataById(r12)
            if (r1 == 0) goto L20
            r2 = 0
            r5 = 0
            r6 = 0
            ...
            r10 = 0
            r4 = r14
            com.smedialink.storage.domain.model.twitter.TwitterAccountData r14 = com.smedialink.storage.domain.model.twitter.TwitterAccountData.copy$default(r1, r2, r4, r5, r6, r7, r9, r10)
            if (r14 != 0) goto L1d
            goto L20
        L1d:
            r0.put(r12, r14)
        L20:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.storage.data.repository.twitter.TwitterRepositoryImpl.updateAccountUsername(long, java.lang.String):void");
    }
}
