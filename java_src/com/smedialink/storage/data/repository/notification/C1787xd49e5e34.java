...
/* renamed from: com.smedialink.storage.data.repository.notification.PushNotificationRepositoryImpl$getNotifications$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1787xd49e5e34 extends Lambda implements Function1<ApiBaseResponse<List<? extends NotificationResponse>>, Result<? extends List<? extends Notification>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1787xd49e5e34(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
