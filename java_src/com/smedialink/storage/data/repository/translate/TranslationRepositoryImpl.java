...
public final class TranslationRepositoryImpl implements TranslationRepository {
    ...
    public Observable<Result<Translation>> translate(String text, String str, String targetLanguage) {
        ...
        Observable observable = fromIterable.concatMap(new Function() { // from class: com.smedialink.storage.data.repository.translate.TranslationRepositoryImpl$$ExternalSyntheticLambda1
        ...
        Observable map = observable.map(new Function() { // from class: com.smedialink.storage.data.repository.translate.TranslationRepositoryImpl$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj2) {
