...
public final class C1796x9906889f extends Lambda implements Function1<Throwable, Result<? extends List<? extends RecognizedImageModel>>> {
    final /* synthetic */ ErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1796x9906889f(ErrorHandler errorHandler) {
        super(1);
