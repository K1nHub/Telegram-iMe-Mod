...
/* renamed from: com.smedialink.storage.data.repository.recognition.GoogleServicesRepositoryImpl$getPhotoObjects$$inlined$mapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1789xab083842 extends Lambda implements Function1<ApiBaseResponse<ImageToObjectsResponse>, Result<? extends List<? extends RecognizedImageModel>>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;
    final /* synthetic */ File $file$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1789xab083842(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler, File file) {
        super(1);
