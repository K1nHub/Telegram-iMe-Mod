...
public class FirebaseFunctionsErrorHandler implements ErrorHandler<ApiBaseResponse<?>> {
    ...
    public ErrorModel handleError(ApiBaseResponse<?> apiBaseResponse) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[GlobalApiErrorCode.Companion.map(apiBaseResponse == null ? null : apiBaseResponse.getCode()).ordinal()]) {
            case 1:
        ...
        return new ErrorModel(apiBaseResponse == null ? null : apiBaseResponse.getMessage(), iErrorStatus, null);
    }
}
