...
public final class TwitterUserResponse {
    ...
    public int hashCode() {
        int m716m = ((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.twitterUserId) * 31) + this.twitterUserName.hashCode()) * 31;
        Long l = this.telegramUserId;
        int hashCode = (m716m + (l == null ? 0 : l.hashCode())) * 31;
