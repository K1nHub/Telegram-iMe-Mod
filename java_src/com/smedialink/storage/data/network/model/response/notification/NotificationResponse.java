...
public final class NotificationResponse {
    ...
    public int hashCode() {
        int hashCode = ((((this.f306id.hashCode() * 31) + this.userId.hashCode()) * 31) + this.amount.hashCode()) * 31;
        boolean z = this.read;
        int i = z;
        if (z != 0) {
            i = 1;
    ...
    public String toString() {
        return "NotificationResponse(id=" + this.f306id + ", userId=" + this.userId + ", amount=" + this.amount + ", read=" + this.read + ", linkedUserId=" + ((Object) this.linkedUserId) + ", linkedObjectId=" + ((Object) this.linkedObjectId) + ", type=" + this.type + ", date=" + this.date + ", status=" + ((Object) this.status) + ", cryptoCode=" + ((Object) this.cryptoCode) + ", fromWalletAddress=" + ((Object) this.fromWalletAddress) + ", toWalletAddress=" + ((Object) this.toWalletAddress) + ", txHash=" + ((Object) this.txHash) + ", networkType=" + ((Object) this.networkType) + ", spentCurrency=" + ((Object) this.spentCurrency) + ", amountToSpent=" + ((Object) this.amountToSpent) + ", assetCode=" + ((Object) this.assetCode) + ", assetName=" + ((Object) this.assetName) + ", payerUserId=" + ((Object) this.payerUserId) + ", stakingId=" + this.stakingId + ", stakingName=" + this.stakingName + ", stakingAuthor=" + this.stakingAuthor + ", stakingWebsite=" + this.stakingWebsite + ", stakingAPY=" + this.stakingAPY + ", stakingAPR=" + this.stakingAPR + ", stakingEndsAt=" + this.stakingEndsAt + ", stakingToken=" + this.stakingToken + ", shouldFinishAt=" + ((Object) this.shouldFinishAt) + ", debtAsToken=" + this.debtAsToken + ", debtAsUsd=" + this.debtAsUsd + ", profitAsToken=" + this.profitAsToken + ", profitAsUsd=" + this.profitAsUsd + ')';
    }
