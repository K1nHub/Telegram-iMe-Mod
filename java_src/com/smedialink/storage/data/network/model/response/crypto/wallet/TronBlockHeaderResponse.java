...
public final class TronBlockHeaderResponse {
    ...
    public int hashCode() {
        return (((((((((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.number) * 31) + this.txTrieRoot.hashCode()) * 31) + this.witnessAddress.hashCode()) * 31) + this.parentHash.hashCode()) * 31) + this.version) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.timestamp);
    }
