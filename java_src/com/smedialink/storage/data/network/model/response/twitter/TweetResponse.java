...
public final class TweetResponse {
    ...
    public int hashCode() {
        int m716m = ((((((((((((((((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.f309id) * 31) + this.userFullName.hashCode()) * 31) + this.userName.hashCode()) * 31) + this.avatarUrl.hashCode()) * 31) + this.likes) * 31) + this.quotes) * 31) + this.retweets) * 31) + this.text.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.createdAt)) * 31;
    ...
    public String toString() {
        return "TweetResponse(id=" + this.f309id + ", userFullName=" + this.userFullName + ", userName=" + this.userName + ", avatarUrl=" + this.avatarUrl + ", likes=" + this.likes + ", quotes=" + this.quotes + ", retweets=" + this.retweets + ", text=" + this.text + ", createdAt=" + this.createdAt + ", likedByMe=" + this.likedByMe + ')';
    }
