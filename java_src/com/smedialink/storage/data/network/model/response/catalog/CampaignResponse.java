...
public final class CampaignResponse {
    ...
    public String toString() {
        return "CampaignResponse(category=" + this.category + ", channel=" + this.channel + ", countries=" + this.countries + ", createdAt=" + this.createdAt + ", id=" + this.f295id + ", invalidReason=" + ((Object) this.invalidReason) + ", language=" + this.language + ", status=" + this.status + ", tags=" + this.tags + ')';
    }
