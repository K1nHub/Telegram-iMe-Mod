package com.smedialink.storage.data.network.model.request.crypto.wallet_connect;
...
public final class GetParamsForCryptoTransactionRequest {
    ...
    public String toString() {
        return "GetParamsForCryptoTransactionRequest(from=" + this.from + ", to=" + this.f293to + ", value=" + this.value + ", data=" + this.data + ", gas=" + this.gas + ", gasPrice=" + this.gasPrice + ", nonce=" + this.nonce + ", networkType=" + this.networkType + ')';
    }
