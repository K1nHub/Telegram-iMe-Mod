...
public final class BoostMappingKt {
    ...
    */
    public static final com.smedialink.storage.domain.model.crypto.send.TransactionArgs mapToDomain(com.smedialink.storage.data.network.model.response.crypto.boost.GetBoostTransactionDataResponse r39, com.smedialink.storage.domain.manager.crypto.CryptoAccessManager r40) {
        /*
