package com.smedialink.storage.data.manager.auth;
...
public final class AuthManagerImpl implements AuthManager {
    ...
    public void logout() {
        ...
        cryptoPreferenceHelper.remove(BasePreferenceHelper.DefaultImpls.withTgAccount$default(cryptoPreferenceHelper, "auth_session", null, 2, null));
    }
