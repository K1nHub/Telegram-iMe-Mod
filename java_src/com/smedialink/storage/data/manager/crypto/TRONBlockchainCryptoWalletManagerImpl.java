...
public final class TRONBlockchainCryptoWalletManagerImpl extends BlockchainCryptoWalletManager {
    ...
    public Observable<Result<String>> generateAddressByMnemonic(final String mnemonic) {
        Intrinsics.checkNotNullParameter(mnemonic, "mnemonic");
        Observable fromCallable = Observable.fromCallable(new Callable() { // from class: com.smedialink.storage.data.manager.crypto.TRONBlockchainCryptoWalletManagerImpl$$ExternalSyntheticLambda2
        ...
        final C1700x29f55e4 c1700x29f55e4 = C1700x29f55e4.INSTANCE;
        Observable<Result<String>> onErrorReturn = fromCallable.onErrorReturn(new Function() { // from class: com.smedialink.storage.data.manager.crypto.TRONBlockchainCryptoWalletManagerImpl$$ExternalSyntheticLambda1
    ...
    public Observable<Result<String>> generateMnemonic(String guid, String password) {
        ...
        Observable<Result<String>> onErrorReturn = fromCallable.onErrorReturn(new Function() { // from class: com.smedialink.storage.data.manager.crypto.TRONBlockchainCryptoWalletManagerImpl$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
