package com.smedialink.storage.data.manager.review;
...
public final class AppReviewManager {
    ...
    private final boolean isNeedRequestReview() {
        ...
        if (requestAppReviewMetadata.isAnyRequestsBefore()) {
            return DateExtKt.isDaysAgo(5, requestAppReviewMetadata.getLastRequestTime()) && requestAppReviewMetadata.getCount() < 2;
        }
