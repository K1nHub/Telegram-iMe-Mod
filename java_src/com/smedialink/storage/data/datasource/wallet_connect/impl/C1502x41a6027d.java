...
public final class C1502x41a6027d extends Lambda implements Function1<ApiBaseResponse<TransactionResponse>, Result<? extends String>> {
    final /* synthetic */ FirebaseFunctionsErrorHandler $errorHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1502x41a6027d(FirebaseFunctionsErrorHandler firebaseFunctionsErrorHandler) {
        super(1);
