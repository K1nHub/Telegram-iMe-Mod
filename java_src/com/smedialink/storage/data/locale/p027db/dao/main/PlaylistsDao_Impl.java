...
/* renamed from: com.smedialink.storage.data.locale.db.dao.main.PlaylistsDao_Impl */
...
public final class PlaylistsDao_Impl extends PlaylistsDao {
    ...
    public PlaylistsDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfPlaylistsDb = new EntityInsertionAdapter<PlaylistsDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.PlaylistsDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<PlaylistsDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.PlaylistsDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<PlaylistsDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.PlaylistsDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfDeleteAllPlaylistsByUserId = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.PlaylistsDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.smedialink.storage.data.locale.p027db.dao.main.PlaylistsDao
