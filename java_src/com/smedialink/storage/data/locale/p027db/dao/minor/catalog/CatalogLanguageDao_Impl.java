...
/* renamed from: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogLanguageDao_Impl */
...
public final class CatalogLanguageDao_Impl extends CatalogLanguageDao {
    ...
    public CatalogLanguageDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfCatalogLanguageDb = new EntityInsertionAdapter<CatalogLanguageDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogLanguageDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<CatalogLanguageDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogLanguageDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<CatalogLanguageDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogLanguageDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogLanguageDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    public Completable rxInsert(final List<? extends CatalogLanguageDb> obj) {
        return Completable.fromCallable(new Callable<Void>() { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogLanguageDao_Impl.7
    ...
    @Override // com.smedialink.storage.data.locale.p027db.dao.minor.catalog.CatalogLanguageDao
    public Single<List<CatalogLanguageDb>> getLanguages() {
        ...
        return RxRoom.createSingle(new Callable<List<CatalogLanguageDb>>() { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogLanguageDao_Impl.11
            @Override // java.util.concurrent.Callable
