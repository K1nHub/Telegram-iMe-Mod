...
/* renamed from: com.smedialink.storage.data.locale.db.dao.main.DialogTranslationSettingsDao_Impl */
...
public final class DialogTranslationSettingsDao_Impl extends DialogTranslationSettingsDao {
    ...
    public DialogTranslationSettingsDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfDialogTranslationSettingsDb = new EntityInsertionAdapter<DialogTranslationSettingsDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.DialogTranslationSettingsDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<DialogTranslationSettingsDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.DialogTranslationSettingsDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<DialogTranslationSettingsDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.DialogTranslationSettingsDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfDeleteAllTranslationSettingsByUserId = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.DialogTranslationSettingsDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.smedialink.storage.data.locale.p027db.dao.main.DialogTranslationSettingsDao
