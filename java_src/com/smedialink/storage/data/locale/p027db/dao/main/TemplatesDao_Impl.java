...
/* renamed from: com.smedialink.storage.data.locale.db.dao.main.TemplatesDao_Impl */
...
public final class TemplatesDao_Impl extends TemplatesDao {
    ...
    public TemplatesDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfTemplatesDb = new EntityInsertionAdapter<TemplatesDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TemplatesDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<TemplatesDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TemplatesDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<TemplatesDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TemplatesDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfClearAllTemplates = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TemplatesDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.smedialink.storage.data.locale.p027db.dao.main.TemplatesDao
