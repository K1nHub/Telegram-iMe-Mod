...
/* renamed from: com.smedialink.storage.data.locale.db.dao.main.HistoryDialogDao_Impl */
...
public final class HistoryDialogDao_Impl extends HistoryDialogDao {
    ...
    public HistoryDialogDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfHistoryDialogDb = new EntityInsertionAdapter<HistoryDialogDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.HistoryDialogDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<HistoryDialogDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.HistoryDialogDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<HistoryDialogDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.HistoryDialogDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.HistoryDialogDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "UPDATE HistoryDialogDb SET creationDate = ? WHERE dialogId = ?";
            }
        };
        this.__preparedStmtOfClearRecentChatHistory = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.HistoryDialogDao_Impl.5
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM HistoryDialogDb WHERE isPinned = ?";
            }
        };
        this.__preparedStmtOfRemoveRecentChatHistory = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.HistoryDialogDao_Impl.6
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM HistoryDialogDb WHERE userId = ? AND dialogId = ?";
            }
        };
        this.__preparedStmtOfUpdatePinned = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.HistoryDialogDao_Impl.7
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.smedialink.storage.data.locale.p027db.dao.main.HistoryDialogDao
