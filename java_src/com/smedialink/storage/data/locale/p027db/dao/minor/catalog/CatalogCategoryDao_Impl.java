...
/* renamed from: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogCategoryDao_Impl */
...
public final class CatalogCategoryDao_Impl extends CatalogCategoryDao {
    ...
    public CatalogCategoryDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfCatalogCategoryDb = new EntityInsertionAdapter<CatalogCategoryDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogCategoryDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<CatalogCategoryDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogCategoryDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<CatalogCategoryDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogCategoryDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfRxDeleteCategories = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogCategoryDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    public Completable rxInsert(final List<? extends CatalogCategoryDb> obj) {
        return Completable.fromCallable(new Callable<Void>() { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogCategoryDao_Impl.7
    ...
    @Override // com.smedialink.storage.data.locale.p027db.dao.minor.catalog.CatalogCategoryDao
    public Completable rxDeleteCategories() {
        return Completable.fromCallable(new Callable<Void>() { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogCategoryDao_Impl.10
            @Override // java.util.concurrent.Callable
            public Void call() throws Exception {
    ...
    public Single<List<CatalogCategoryDb>> getCategories() {
        ...
        return RxRoom.createSingle(new Callable<List<CatalogCategoryDb>>() { // from class: com.smedialink.storage.data.locale.db.dao.minor.catalog.CatalogCategoryDao_Impl.11
            @Override // java.util.concurrent.Callable
