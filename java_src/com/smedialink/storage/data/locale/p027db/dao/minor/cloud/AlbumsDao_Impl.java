...
/* renamed from: com.smedialink.storage.data.locale.db.dao.minor.cloud.AlbumsDao_Impl */
...
public final class AlbumsDao_Impl extends AlbumsDao {
    ...
    public AlbumsDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfCloudAlbumDb = new EntityInsertionAdapter<CloudAlbumDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.cloud.AlbumsDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<CloudAlbumDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.cloud.AlbumsDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<CloudAlbumDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.cloud.AlbumsDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfDeleteByAlbumId = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.cloud.AlbumsDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM CloudAlbumDb WHERE userId = ? AND albumId = ?";
            }
        };
        this.__preparedStmtOfDeleteAllAlbumsByUserId = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.minor.cloud.AlbumsDao_Impl.5
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.smedialink.storage.data.locale.p027db.dao.minor.cloud.AlbumsDao
