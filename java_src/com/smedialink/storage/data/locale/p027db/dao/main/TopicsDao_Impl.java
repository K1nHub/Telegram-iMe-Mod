...
/* renamed from: com.smedialink.storage.data.locale.db.dao.main.TopicsDao_Impl */
...
public final class TopicsDao_Impl extends TopicsDao {
    ...
    public TopicsDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfTopicDb = new EntityInsertionAdapter<TopicDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TopicsDao_Impl.1
        ...
        new EntityDeletionOrUpdateAdapter<TopicDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TopicsDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        new EntityDeletionOrUpdateAdapter<TopicDb>(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TopicsDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
        ...
        this.__preparedStmtOfRemoveTopic = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TopicsDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM TopicDb WHERE userId = ? AND topicId = ?";
            }
        };
        this.__preparedStmtOfRemoveTopics = new SharedSQLiteStatement(this, __db) { // from class: com.smedialink.storage.data.locale.db.dao.main.TopicsDao_Impl.5
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.smedialink.storage.data.locale.p027db.dao.main.TopicsDao
