...
/* renamed from: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations */
...
public final class AppMainDatabaseMigrations {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_1_2$1] */
    /* JADX WARN: Type inference failed for: r10v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_11_12$1] */
    /* JADX WARN: Type inference failed for: r11v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_12_13$1] */
    /* JADX WARN: Type inference failed for: r12v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_13_14$1] */
    /* JADX WARN: Type inference failed for: r13v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_14_15$1] */
    /* JADX WARN: Type inference failed for: r1v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_2_3$1] */
    /* JADX WARN: Type inference failed for: r2v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_3_4$1] */
    /* JADX WARN: Type inference failed for: r3v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_4_5$1] */
    /* JADX WARN: Type inference failed for: r4v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_5_6$1] */
    /* JADX WARN: Type inference failed for: r5v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_6_7$1] */
    /* JADX WARN: Type inference failed for: r6v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_7_8$1] */
    /* JADX WARN: Type inference failed for: r7v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_8_9$1] */
    /* JADX WARN: Type inference failed for: r8v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_9_10$1] */
    /* JADX WARN: Type inference failed for: r9v0, types: [com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_10_11$1] */
    static {
        ?? r0 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_1_2$1
        ...
        MIGRATION_1_2 = r0;
        ?? r1 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_2_3$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_2_3 = r1;
        ?? r2 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_3_4$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_3_4 = r2;
        ?? r3 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_4_5$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_4_5 = r3;
        ?? r4 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_5_6$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_5_6 = r4;
        ?? r5 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_6_7$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_6_7 = r5;
        ?? r6 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_7_8$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_7_8 = r6;
        ?? r7 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_8_9$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_9_10 = r8;
        ?? r9 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_10_11$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_10_11 = r9;
        ?? r10 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_11_12$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_11_12 = r10;
        ?? r11 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_12_13$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_12_13 = r11;
        ?? r12 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_13_14$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
        ...
        MIGRATION_13_14 = r12;
        ?? r13 = new Migration() { // from class: com.smedialink.storage.data.locale.db.migration.AppMainDatabaseMigrations$MIGRATION_14_15$1
            @Override // androidx.room.migration.Migration
            public void migrate(SupportSQLiteDatabase database) {
                Intrinsics.checkNotNullParameter(database, "database");
