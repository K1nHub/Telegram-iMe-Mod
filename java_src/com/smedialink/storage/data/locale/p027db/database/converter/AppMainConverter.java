package com.smedialink.storage.data.locale.p027db.database.converter;
...
/* renamed from: com.smedialink.storage.data.locale.db.database.converter.AppMainConverter */
...
public final class AppMainConverter {
    ...
    /* compiled from: AppMainConverter.kt */
    /* renamed from: com.smedialink.storage.data.locale.db.database.converter.AppMainConverter$Companion */
    /* loaded from: classes3.dex */
    public static final class Companion {
        ...
        public final List<Long> convertStringToLongList(String str) {
            ...
            return (List) AppMainConverter.gson.fromJson(str, new TypeToken<List<Long>>() { // from class: com.smedialink.storage.data.locale.db.database.converter.AppMainConverter$Companion$convertStringToLongList$$inlined$fromJsonTokenType$1
            }.getType());
        }
        ...
        public final List<Integer> convertStringToIntList(String str) {
            Intrinsics.checkNotNullParameter(str, "str");
            return (List) AppMainConverter.gson.fromJson(str, new TypeToken<List<Integer>>() { // from class: com.smedialink.storage.data.locale.db.database.converter.AppMainConverter$Companion$convertStringToIntList$$inlined$fromJsonTokenType$1
            }.getType());
        }
