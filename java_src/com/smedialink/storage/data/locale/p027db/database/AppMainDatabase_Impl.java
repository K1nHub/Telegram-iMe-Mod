...
import com.smedialink.storage.data.locale.p027db.dao.main.BookmarksDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.main.DialogTranslationSettingsDao;
import com.smedialink.storage.data.locale.p027db.dao.main.DialogTranslationSettingsDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.main.FiltersDao;
import com.smedialink.storage.data.locale.p027db.dao.main.FiltersDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.main.HistoryDialogDao;
import com.smedialink.storage.data.locale.p027db.dao.main.HistoryDialogDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.main.PlaylistsDao;
import com.smedialink.storage.data.locale.p027db.dao.main.PlaylistsDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.main.TemplatesDao;
import com.smedialink.storage.data.locale.p027db.dao.main.TemplatesDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.main.TopicsDao;
import com.smedialink.storage.data.locale.p027db.dao.main.TopicsDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.minor.wallet.WalletConnectSessionsDao;
import com.smedialink.storage.data.locale.p027db.dao.minor.wallet.WalletConnectSessionsDao_Impl;
...
/* renamed from: com.smedialink.storage.data.locale.db.database.AppMainDatabase_Impl */
...
public final class AppMainDatabase_Impl extends AppMainDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(15) { // from class: com.smedialink.storage.data.locale.db.database.AppMainDatabase_Impl.1
            ...
            public void createAllTables(SupportSQLiteDatabase _db) {
                ...
                _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '994e7f15e3505c9ef787432b912dde6a')");
            }
            ...
            protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                if (!tableInfo.equals(read)) {
                    return new RoomOpenHelper.ValidationResult(false, "FilterSettingsDb(com.smedialink.storage.data.locale.db.model.filter.FilterSettingsDb).\n Expected:\n" + tableInfo + "\n Found:\n" + read);
                }
                ...
                if (!tableInfo2.equals(read2)) {
                    return new RoomOpenHelper.ValidationResult(false, "DialogTranslationSettingsDb(com.smedialink.storage.data.locale.db.model.translation.DialogTranslationSettingsDb).\n Expected:\n" + tableInfo2 + "\n Found:\n" + read2);
                }
                ...
                if (!tableInfo3.equals(read3)) {
                    return new RoomOpenHelper.ValidationResult(false, "TopicDb(com.smedialink.storage.data.locale.db.model.topics.TopicDb).\n Expected:\n" + tableInfo3 + "\n Found:\n" + read3);
                }
                ...
                if (!tableInfo4.equals(read4)) {
                    return new RoomOpenHelper.ValidationResult(false, "WalletConnectSessionDb(com.smedialink.storage.data.locale.db.model.wallet.WalletConnectSessionDb).\n Expected:\n" + tableInfo4 + "\n Found:\n" + read4);
                }
                ...
                if (!tableInfo5.equals(read5)) {
                    return new RoomOpenHelper.ValidationResult(false, "TemplatesDb(com.smedialink.storage.data.locale.db.model.templates.TemplatesDb).\n Expected:\n" + tableInfo5 + "\n Found:\n" + read5);
                }
                ...
                if (!tableInfo6.equals(read6)) {
                    return new RoomOpenHelper.ValidationResult(false, "BookmarksDb(com.smedialink.storage.data.locale.db.model.bookmarks.BookmarksDb).\n Expected:\n" + tableInfo6 + "\n Found:\n" + read6);
                }
                ...
                if (!tableInfo7.equals(read7)) {
                    return new RoomOpenHelper.ValidationResult(false, "PlaylistsDb(com.smedialink.storage.data.locale.db.model.music.PlaylistsDb).\n Expected:\n" + tableInfo7 + "\n Found:\n" + read7);
                }
                ...
                if (!tableInfo8.equals(read8)) {
                    return new RoomOpenHelper.ValidationResult(false, "HistoryDialogDb(com.smedialink.storage.data.locale.db.model.recent_chats.HistoryDialogDb).\n Expected:\n" + tableInfo8 + "\n Found:\n" + read8);
                }
                return new RoomOpenHelper.ValidationResult(true, null);
            }
        }, "994e7f15e3505c9ef787432b912dde6a", "4536f47c68816406037587c0e0f33017")).build());
    }

    @Override // androidx.room.RoomDatabase
    protected InvalidationTracker createInvalidationTracker() {
        return new InvalidationTracker(this, new HashMap(0), new HashMap(0), "FilterSettingsDb", "DialogTranslationSettingsDb", "TopicDb", "WalletConnectSessionDb", "TemplatesDb", "BookmarksDb", "PlaylistsDb", "HistoryDialogDb");
    }
    ...
    @Override // com.smedialink.storage.data.locale.p027db.database.AppMainDatabase
