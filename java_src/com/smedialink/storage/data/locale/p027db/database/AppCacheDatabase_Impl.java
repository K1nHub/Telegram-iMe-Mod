...
import com.smedialink.storage.data.locale.p027db.dao.minor.catalog.CatalogCategoryDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.minor.catalog.CatalogLanguageDao;
import com.smedialink.storage.data.locale.p027db.dao.minor.catalog.CatalogLanguageDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.minor.cloud.AlbumsDao;
import com.smedialink.storage.data.locale.p027db.dao.minor.cloud.AlbumsDao_Impl;
import com.smedialink.storage.data.locale.p027db.dao.minor.wallet.WalletTokenBalanceDao;
import com.smedialink.storage.data.locale.p027db.dao.minor.wallet.WalletTokenBalanceDao_Impl;
...
/* renamed from: com.smedialink.storage.data.locale.db.database.AppCacheDatabase_Impl */
...
public final class AppCacheDatabase_Impl extends AppCacheDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(7) { // from class: com.smedialink.storage.data.locale.db.database.AppCacheDatabase_Impl.1
            ...
            protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                if (!tableInfo.equals(read)) {
                    return new RoomOpenHelper.ValidationResult(false, "CatalogCategoryDb(com.smedialink.storage.data.locale.db.model.catalog.CatalogCategoryDb).\n Expected:\n" + tableInfo + "\n Found:\n" + read);
                }
                ...
                if (!tableInfo2.equals(read2)) {
                    return new RoomOpenHelper.ValidationResult(false, "CatalogLanguageDb(com.smedialink.storage.data.locale.db.model.catalog.CatalogLanguageDb).\n Expected:\n" + tableInfo2 + "\n Found:\n" + read2);
                }
                ...
                if (!tableInfo3.equals(read3)) {
                    return new RoomOpenHelper.ValidationResult(false, "CloudAlbumDb(com.smedialink.storage.data.locale.db.model.cloud.CloudAlbumDb).\n Expected:\n" + tableInfo3 + "\n Found:\n" + read3);
                }
                ...
                if (!tableInfo4.equals(read4)) {
                    return new RoomOpenHelper.ValidationResult(false, "WalletTokenBalanceDb(com.smedialink.storage.data.locale.db.model.wallet.WalletTokenBalanceDb).\n Expected:\n" + tableInfo4 + "\n Found:\n" + read4);
                }
    ...
    @Override // com.smedialink.storage.data.locale.p027db.database.AppCacheDatabase
