package com.smedialink.storage.data.locale.p027db.model.bookmarks;
...
/* renamed from: com.smedialink.storage.data.locale.db.model.bookmarks.BookmarksDb */
...
public final class BookmarksDb {
    ...
    public int hashCode() {
        return (((this.messageIds.hashCode() * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.dialogId)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.userId);
    }
