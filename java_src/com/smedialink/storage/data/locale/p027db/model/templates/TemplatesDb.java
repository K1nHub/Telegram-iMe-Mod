package com.smedialink.storage.data.locale.p027db.model.templates;
...
/* renamed from: com.smedialink.storage.data.locale.db.model.templates.TemplatesDb */
...
public final class TemplatesDb {
    ...
    public int hashCode() {
        int m716m = ((((((((((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.userId) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.messageId)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.groupId)) * 31) + this.templateName.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.creationDate)) * 31) + this.usageRating) * 31;
        boolean z = this.sent;
        int i = z;
        if (z != 0) {
            i = 1;
