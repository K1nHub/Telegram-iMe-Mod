package com.smedialink.storage.data.locale.p027db.model.translation;
...
/* renamed from: com.smedialink.storage.data.locale.db.model.translation.DialogTranslationSettingsDb */
...
public final class DialogTranslationSettingsDb {
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.outTextTranslateTargetLangCode.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.dialogId)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.userId);
    }
