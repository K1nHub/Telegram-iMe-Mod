package com.smedialink.storage.data.locale.p027db.model.recent_chats;
...
/* renamed from: com.smedialink.storage.data.locale.db.model.recent_chats.HistoryDialogDb */
...
public final class HistoryDialogDb {
    ...
    public int hashCode() {
        int m716m = ((((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.userId) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.dialogId)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.creationDate)) * 31;
