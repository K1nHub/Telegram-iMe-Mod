            ...
            switch (i5) {
                case 1:
                    if (preferences.contains(TelegramPreferenceKeys.User.isSortingChatsEnabled())) {
                        ...
                        edit.putInt(TelegramPreferenceKeys.User.buildSortingTabPositionKey(SortingFilter.PRIVATE_GROUPS), i6 + 1);
                        ...
                        for (SortingFilter sortingFilter3 : SortingFilter.Companion.getSortingFilters(r3)) {
                            ...
                            if (string != null) {
                                ...
                                if (string2 != null) {
                                    ...
                                    Set<FilterFab> mapOldPreferenceJsonToEnums = Intrinsics.areEqual(string, FabDataBackup.OLD_MULTI_FAB_ID) ? FilterFab.Companion.mapOldPreferenceJsonToEnums(string2) : SetsKt__SetsJVMKt.setOf(FilterFab.Companion.findByOldPreferenceId(string));
                ...
                case 4:
                    if (preferences.contains(TelegramPreferenceKeys.User.isMultiPanelEnabled())) {
                        ...
                        int i7 = preferences.getInt(TelegramPreferenceKeys.User.buildMultiPanelButtonPositionKey(multiPanelButton, dialogType), r3);
                        for (MultiPanelButton multiPanelButton2 : dialogType.getMultiPanelButtons()) {
                            if (multiPanelButton2 != MultiPanelButton.CACHE) {
                                ...
                                int i8 = preferences.getInt(TelegramPreferenceKeys.User.buildMultiPanelButtonPositionKey(multiPanelButton2, dialogType2), r3);
                                if (i8 >= i7) {
                                    edit3.putInt(TelegramPreferenceKeys.User.buildMultiPanelButtonPositionKey(multiPanelButton2, dialogType2), i8 + 1);
                                }
                            }
                        }
                        MultiPanelButton multiPanelButton3 = MultiPanelButton.CACHE;
                        DialogType dialogType3 = DialogType.BOT;
                        edit3.putInt(TelegramPreferenceKeys.User.buildMultiPanelButtonPositionKey(multiPanelButton3, dialogType3), i7);
