...
public final class NotificationUiMappingKt {
    ...
    public static final PushNotificationModel mapToPushNotification(Notification notification) {
        ...
        if (notification instanceof Notification.CryptoTransfer.C1860In) {
            Notification.CryptoTransfer.C1860In c1860In = (Notification.CryptoTransfer.C1860In) notification;
            String name = c1860In.getTokenCode().getName();
            String amount = c1860In.getAmount();
            String toAddress = c1860In.getToAddress();
            return new PushNotificationModel.CryptoTransfer.C1489In(notification.getUserId(), notification.getType().name(), name, c1860In.getFromAddress(), toAddress, amount);
        ...
        } else if (notification instanceof Notification.Donation.C1861In) {
            Notification.Donation.C1861In c1861In = (Notification.Donation.C1861In) notification;
            String name3 = c1861In.getTokenCode().getName();
            String amount3 = c1861In.getAmount();
            String toAddress3 = c1861In.getToAddress();
            return new PushNotificationModel.Donation.C1490In(notification.getUserId(), notification.getType().name(), name3, c1861In.getFromAddress(), toAddress3, amount3);
