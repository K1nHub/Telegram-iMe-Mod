...
public final class CampaignItem extends NoChildNode {
    ...
    public int hashCode() {
        int hashCode = ((((this.category.hashCode() * 31) + this.description.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.f262id)) * 31;
        boolean z = this.isVerified;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((((((((((((hashCode + i) * 31) + this.language.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.membersCount)) * 31) + this.photo.hashCode()) * 31) + this.shortname.hashCode()) * 31) + this.tags.hashCode()) * 31) + this.title.hashCode();
    }

    public String toString() {
        return "CampaignItem(category=" + this.category + ", description=" + this.description + ", id=" + this.f262id + ", isVerified=" + this.isVerified + ", language=" + this.language + ", membersCount=" + this.membersCount + ", photo=" + this.photo + ", shortname=" + this.shortname + ", tags=" + this.tags + ", title=" + this.title + ')';
    }
