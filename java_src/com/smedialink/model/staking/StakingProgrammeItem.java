...
public final class StakingProgrammeItem extends NoChildNode {
    ...
    public int hashCode() {
        int m716m = ((StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.f272id) * 31) + this.name.hashCode()) * 31;
        boolean z = this.isParticipated;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((((((((((m716m + i) * 31) + this.tokenBalance.hashCode()) * 31) + this.apr.hashCode()) * 31) + this.apy.hashCode()) * 31) + this.annualPercentageMode.hashCode()) * 31) + this.endsAt.hashCode();
    }

    public String toString() {
        return "StakingProgrammeItem(id=" + this.f272id + ", name=" + this.name + ", isParticipated=" + this.isParticipated + ", tokenBalance=" + this.tokenBalance + ", apr=" + this.apr + ", apy=" + this.apy + ", annualPercentageMode=" + this.annualPercentageMode + ", endsAt=" + this.endsAt + ')';
    }
    ...
    public final String getPercentageTextColor(StakingAnnualPercentageMode annualPercentageMode) {
        Intrinsics.checkNotNullParameter(annualPercentageMode, "annualPercentageMode");
        return this.annualPercentageMode == annualPercentageMode ? "windowBackgroundWhiteBlueText" : "windowBackgroundWhiteBlackText";
    }
}
