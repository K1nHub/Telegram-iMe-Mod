...
public abstract class TwitterAuthResult {
    ...
    public static final class Success extends TwitterAuthResult {
        ...
        public int hashCode() {
            return (((((((((this.accessToken.hashCode() * 31) + this.refreshToken.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.expiresIn)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.twitterUserId)) * 31) + this.twitterUsername.hashCode()) * 31) + this.status.hashCode();
        }
