...
public abstract class TransactionActionItem implements ActionItem {
    ...
    public static final class Send extends TransactionActionItem {
        ...
        private Send() {
            super(C3158R.string.wallet_token_details_details_action_send, C3158R.C3160drawable.msg_send, null, 4, null);
        }
    }
    ...
    public static final class Support extends TransactionActionItem {
        ...
        private Support() {
            super(C3158R.string.wallet_token_details_action_simplex_support, C3158R.C3160drawable.msg_help, null, 4, null);
        }
    }
    ...
    public static final class Profile extends TransactionActionItem {
        ...
        private Profile() {
            super(C3158R.string.wallet_transaction_details_action_open_profile, C3158R.C3160drawable.msg_openprofile, null, 4, null);
        }
    }
    ...
    public static final class Copy extends TransactionActionItem {
        ...
        public Copy(int i) {
            super(i, C3158R.C3160drawable.fork_ic_id_28, null, 4, null);
            this.title = i;
        }
    ...
    public static final class Cancel extends TransactionActionItem {
        ...
        private Cancel() {
            super(C3158R.string.wallet_transaction_details_action_cancel, C3158R.C3160drawable.fork_cancel_transaction, null, 4, null);
        }
    }
    ...
    public static final class Boost extends TransactionActionItem {
        ...
        private Boost() {
            super(C3158R.string.wallet_transaction_details_action_boost, C3158R.C3160drawable.fork_ic_speed_up_transaction, null, 4, null);
        }
    }
}
