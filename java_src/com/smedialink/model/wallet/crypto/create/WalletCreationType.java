...
public abstract class WalletCreationType {
    ...
    public static abstract class Initial extends WalletCreationType {
        ...
        @Override // com.smedialink.model.wallet.crypto.create.WalletCreationType
        public int getIconResId() {
            return this.iconResId;
        }
        ...
        public static final class Create extends Initial {
            ...
            private Create() {
                super(C3301R.C3303drawable.fork_ic_wallet_create, C3301R.string.wallet_dashboard_create_eth_wallet, 0, null);
            }
        }
        ...
        public static final class Import extends Initial {
            ...
            private Import() {
                super(C3301R.C3303drawable.fork_ic_wallet_import, C3301R.string.wallet_dashboard_import_eth_wallet, 1, null);
            }
        }
        ...
        public static final class Restore extends Initial {
            ...
            private Restore() {
                super(C3301R.C3303drawable.fork_ic_wallet_restore, C3301R.string.wallet_dashboard_restore_eth_wallet, 2, null);
            }
        }
    ...
    public static final class Activate extends WalletCreationType {
        ...
        public Activate(BlockchainType blockchainType) {
            super(C3301R.C3303drawable.fork_ic_wallet_create, C3301R.string.wallet_dashboard_activate_wallet, null);
