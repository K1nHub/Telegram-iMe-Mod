package com.smedialink.model.wallet.crypto.settings;
...
public abstract class WalletSettingsItem {
    ...
    public static final class Blockchains extends WalletSettingsItem {
        ...
        private Blockchains() {
            super(C3158R.C3160drawable.fork_ic_blockchain, C3158R.string.wallet_crypto_blockchains_title, C3158R.string.wallet_crypto_blockchains_item_description, null);
        }
    }
    ...
    public static final class Privacy extends WalletSettingsItem {
        ...
        private Privacy() {
            super(C3158R.C3160drawable.fork_ic_crypto_privacy, C3158R.string.wallet_crypto_privacy_toolbar_title, C3158R.string.wallet_crypto_privacy_item_description, null);
        }
    }
    ...
    public static final class WalletConnect extends WalletSettingsItem {
        ...
        private WalletConnect() {
            super(C3158R.C3160drawable.fork_ic_wallet_connect, C3158R.string.wallet_connect_title, C3158R.string.wallet_connect_subtitle, null);
        }
    }
    ...
    public static final class PinCode extends WalletSettingsItem {
        ...
        private PinCode() {
            super(C3158R.C3160drawable.fork_filter_icon_lock, C3158R.string.wallet_settings_pin_code_title, C3158R.string.wallet_settings_pin_code_subtitle, null);
        }
    }
}
