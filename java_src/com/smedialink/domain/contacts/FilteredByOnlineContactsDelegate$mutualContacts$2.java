...
public final class FilteredByOnlineContactsDelegate$mutualContacts$2 extends Lambda implements Function0<ArrayList<TLRPC$TL_contact>> {
    final /* synthetic */ FilteredByOnlineContactsDelegate this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FilteredByOnlineContactsDelegate$mutualContacts$2(FilteredByOnlineContactsDelegate filteredByOnlineContactsDelegate) {
        super(0);
