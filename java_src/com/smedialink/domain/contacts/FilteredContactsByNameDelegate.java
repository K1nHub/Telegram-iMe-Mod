...
public final class FilteredContactsByNameDelegate extends BaseController {
    ...
    public final ArrayList<String> getArrCharsByPredicate(Function1<? super TLRPC$TL_contact, Boolean> function1) {
        ...
        sortedWith = CollectionsKt___CollectionsKt.sortedWith(linkedHashMap.keySet(), new Comparator() { // from class: com.smedialink.domain.contacts.FilteredContactsByNameDelegate$getArrCharsByPredicate$$inlined$sortedBy$1
