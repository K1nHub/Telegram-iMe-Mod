    ...
    public State validate(Float f, CustomPriceArgs args) {
        ...
        if (fromCurrency instanceof DigitalCurrency) {
            if (f.floatValue() > args.getLimits().getMaxCryptoAmount()) {
                ...
                int i = C3158R.string.wallet_crypto_buy_custom_price_dialog_validation_max_input;
                ...
                int i2 = C3158R.string.wallet_crypto_buy_custom_price_dialog_validation_min_input;
            ...
            if (f.floatValue() > args.getLimits().getMaxFiatAmount()) {
                ...
                int i3 = C3158R.string.wallet_crypto_buy_custom_price_dialog_validation_max_input;
                ...
                int i4 = C3158R.string.wallet_crypto_buy_custom_price_dialog_validation_min_input;
