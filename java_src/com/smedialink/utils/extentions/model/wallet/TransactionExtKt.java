...
public final class TransactionExtKt {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            iArr[TransactionDirection.f366IN.ordinal()] = 1;
    ...
    public static final int getIcon(Transaction transaction) {
        ...
        if (transaction.getStatus() == Status.CANCELLED) {
            return C3158R.C3160drawable.fork_ic_transaction_cancelled;
        }
        if (transaction instanceof Transaction.Crypto.Donation) {
            ...
            if (i != 1) {
                if (i == 2 || i == 3) {
                    return C3158R.C3160drawable.fork_ic_transaction_donate_out;
                }
                return TransactionDirectionExtKt.icon(transaction.getDirection());
            }
            return C3158R.C3160drawable.fork_ic_transaction_donate_in;
        }
        ...
        if (transaction instanceof Transaction.Referral ? true : transaction instanceof Transaction.Lottery ? true : transaction instanceof Transaction.Registration) {
            return C3158R.C3160drawable.fork_ic_transaction_bonus;
        }
        if (transaction instanceof Transaction.Purchase) {
            return C3158R.C3160drawable.fork_ic_transaction_purchase;
        }
        if (transaction instanceof Transaction.Crypto.SimplexPurchase) {
            return C3158R.C3160drawable.fork_ic_transaction_simplex;
        }
        if (transaction instanceof Transaction.Crypto.Approve) {
            return C3158R.C3160drawable.fork_ic_transaction_approve;
        }
        if (transaction instanceof Transaction.Crypto.Swap) {
            ...
            if (i2 == 1 || i2 == 2) {
                return C3158R.C3160drawable.fork_ic_transaction_uniswap;
            }
            if (i2 != 3) {
                if (i2 != 4) {
                    if (i2 == 5) {
                        return C3158R.C3160drawable.fork_ic_transaction_symbiosis;
                    }
                    return C3158R.C3160drawable.fork_ic_transaction_uniswap;
                }
                return C3158R.C3160drawable.fork_ic_transaction_1_inch;
            }
            return C3158R.C3160drawable.fork_ic_transaction_pancakeswap;
        }
        return TransactionDirectionExtKt.icon(transaction.getDirection());
    }
    ...
    public static final int getCategoryTitle(Transaction transaction) {
        ...
        if (transaction instanceof Transaction.Referral) {
            return C3158R.string.wallet_transactions_type_referral_title;
        }
        if (transaction instanceof Transaction.Lottery) {
            return C3158R.string.wallet_transactions_type_lottery_title;
        }
        if (transaction instanceof Transaction.Registration) {
            return C3158R.string.wallet_transactions_type_welcome_title;
        }
        if (transaction instanceof Transaction.Purchase) {
            return C3158R.string.wallet_transactions_type_in_app_purchase_title;
        }
        if (transaction instanceof Transaction.Crypto.SimplexPurchase) {
            return C3158R.string.wallet_transactions_type_simplex_title;
        }
        if (!(transaction instanceof Transaction.Crypto.Swap)) {
            return transaction instanceof Transaction.Refund ? C3158R.string.wallet_transactions_type_refund_title : transaction.getDirection().getTitle();
        }
        int i = WhenMappings.$EnumSwitchMapping$1[transaction.getProcessingType().ordinal()];
        if (i == 1 || i == 2) {
            return C3158R.string.wallet_transactions_type_uniswap_title;
        }
        if (i != 3) {
            if (i != 4) {
                if (i == 5) {
                    return C3158R.string.wallet_transactions_type_symbiosis_title;
                }
                return C3158R.string.wallet_transactions_type_uniswap_title;
            }
            return C3158R.string.wallet_transactions_type_1inch_title;
        }
        return C3158R.string.wallet_transactions_type_pancakeswap_title;
    }
}
