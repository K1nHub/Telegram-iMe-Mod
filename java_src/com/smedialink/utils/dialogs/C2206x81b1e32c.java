...
public final class C2206x81b1e32c extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ BottomSheet $bottomSheet;
    final /* synthetic */ Callbacks$Callback $onButtonClickAction;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2206x81b1e32c(Callbacks$Callback callbacks$Callback, BottomSheet bottomSheet) {
        super(1);
