...
public final class DialogsFactoryKt$createErrorAlert$1 extends Lambda implements Function2<TextView, AlertDialog, Unit> {
    public static final DialogsFactoryKt$createErrorAlert$1 INSTANCE = new DialogsFactoryKt$createErrorAlert$1();

    DialogsFactoryKt$createErrorAlert$1() {
        super(2);
    }
