...
import com.smedialink.bots.data.model.response.ClassifierResponse;
import com.smedialink.bots.data.model.response.HolidaysResponse;
import com.smedialink.bots.domain.ResourceFactory;
import com.smedialink.bots.extensions.InputStreamExtKt;
import java.io.File;
...
public final class JsonResourceFactory implements ResourceFactory {
    ...
    @Override // com.smedialink.bots.domain.ResourceFactory
    public List<Response> getHolidaysResponses(String botId, boolean z) {
        ...
        Object fromJson = this.gson.fromJson(readText$default, new TypeToken<List<? extends HolidaysResponse>>() { // from class: com.smedialink.bots.data.factory.JsonResourceFactory$getHolidaysResponses$responsesType$1
        }.getType());
    ...
    public Map<Integer, String> getBotWordsBag(String botId, boolean z) {
        ...
        Object fromJson = this.gson.fromJson(readText$default, new TypeToken<ClassifierResponse>() { // from class: com.smedialink.bots.data.factory.JsonResourceFactory$getBotWordsBag$responsesType$1
        }.getType());
        Intrinsics.checkNotNullExpressionValue(fromJson, "gson.fromJson(jsonString, responsesType)");
        ...
        for (Object obj : words) {
            ...
            arrayList.add(TuplesKt.m100to(Integer.valueOf(i), (String) obj));
            i = i2;
        }
    ...
    public List<Response> getBotResponsesList(String botId, boolean z) {
        ...
        Object fromJson = this.gson.fromJson(readText$default, new TypeToken<ClassifierResponse>() { // from class: com.smedialink.bots.data.factory.JsonResourceFactory$getBotResponsesList$responsesType$1
        }.getType());
        Intrinsics.checkNotNullExpressionValue(fromJson, "gson.fromJson(jsonString, responsesType)");
    ...
    public Map<Integer, String> getIntentValidatorWordsBag(String botId, int i, boolean z) {
        ...
        Object fromJson = this.gson.fromJson(readText$default, new TypeToken<ClassifierResponse>() { // from class: com.smedialink.bots.data.factory.JsonResourceFactory$getIntentValidatorWordsBag$responsesType$1
        }.getType());
        Intrinsics.checkNotNullExpressionValue(fromJson, "gson.fromJson(jsonString, responsesType)");
        List<String> words = ((ClassifierResponse) fromJson).getWords();
        collectionSizeOrDefault = CollectionsKt__IterablesKt.collectionSizeOrDefault(words, 10);
        ...
        for (Object obj : words) {
            ...
            arrayList.add(TuplesKt.m100to(Integer.valueOf(i2), (String) obj));
            i2 = i3;
        }
        map = MapsKt__MapsKt.toMap(arrayList);
        return map;
    ...
    public Map<Integer, String> getIntentValidatorResponses(String botId, int i, boolean z) {
        ...
        Object fromJson = this.gson.fromJson(readText$default, new TypeToken<ClassifierResponse>() { // from class: com.smedialink.bots.data.factory.JsonResourceFactory$getIntentValidatorResponses$responsesType$1
        }.getType());
        Intrinsics.checkNotNullExpressionValue(fromJson, "gson.fromJson(jsonString, responsesType)");
        List<ClassifierResponse.ClassifierItem> classes = ((ClassifierResponse) fromJson).getClasses();
        collectionSizeOrDefault = CollectionsKt__IterablesKt.collectionSizeOrDefault(classes, 10);
        ...
        for (Object obj : classes) {
            ...
            arrayList.add(TuplesKt.m100to(Integer.valueOf(i2), ((ClassifierResponse.ClassifierItem) obj).getTag()));
            i2 = i3;
        }
        map = MapsKt__MapsKt.toMap(arrayList);
        return map;
