...
public final class BotsCategoryDao_Impl extends BotsCategoryDao {
    ...
    public BotsCategoryDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfBotsCategoryDbModel = new EntityInsertionAdapter<BotsCategoryDbModel>(this, __db) { // from class: com.smedialink.bots.data.database.BotsCategoryDao_Impl.1
    ...
    @Override // com.smedialink.bots.data.database.BotsCategoryDao
    ...
    public Flowable<List<BotsCategoryDbModel>> getAll() {
        ...
        return RxRoom.createFlowable(this.__db, false, new String[]{"BotsCategoryDbModel"}, new Callable<List<BotsCategoryDbModel>>() { // from class: com.smedialink.bots.data.database.BotsCategoryDao_Impl.2
