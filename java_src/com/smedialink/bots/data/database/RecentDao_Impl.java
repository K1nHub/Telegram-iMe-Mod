...
public final class RecentDao_Impl extends RecentDao {
    ...
    public RecentDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfRecentDbModel = new EntityInsertionAdapter<RecentDbModel>(this, __db) { // from class: com.smedialink.bots.data.database.RecentDao_Impl.1
    ...
    @Override // com.smedialink.bots.data.database.RecentDao
