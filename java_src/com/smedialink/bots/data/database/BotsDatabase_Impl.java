...
public final class BotsDatabase_Impl extends BotsDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(13) { // from class: com.smedialink.bots.data.database.BotsDatabase_Impl.1
            ...
            protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                if (!tableInfo.equals(read)) {
                    return new RoomOpenHelper.ValidationResult(false, "BotsCategoryDbModel(com.smedialink.bots.data.model.database.BotsCategoryDbModel).\n Expected:\n" + tableInfo + "\n Found:\n" + read);
                }
                ...
                if (!tableInfo2.equals(read2)) {
                    return new RoomOpenHelper.ValidationResult(false, "BotsDbModel(com.smedialink.bots.data.model.database.BotsDbModel).\n Expected:\n" + tableInfo2 + "\n Found:\n" + read2);
                }
                ...
                if (!tableInfo3.equals(read3)) {
                    return new RoomOpenHelper.ValidationResult(false, "TagDbModel(com.smedialink.bots.data.model.database.TagDbModel).\n Expected:\n" + tableInfo3 + "\n Found:\n" + read3);
                }
                ...
                if (!tableInfo4.equals(read4)) {
                    return new RoomOpenHelper.ValidationResult(false, "HolidaysDbModel(com.smedialink.bots.data.model.database.HolidaysDbModel).\n Expected:\n" + tableInfo4 + "\n Found:\n" + read4);
                }
                ...
                if (!tableInfo5.equals(read5)) {
                    return new RoomOpenHelper.ValidationResult(false, "RecentDbModel(com.smedialink.bots.data.model.database.RecentDbModel).\n Expected:\n" + tableInfo5 + "\n Found:\n" + read5);
                }
    ...
    @Override // com.smedialink.bots.data.database.BotsDatabase
