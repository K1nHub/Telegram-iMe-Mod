...
public final class BotsTagDao_Impl extends BotsTagDao {
    ...
    public BotsTagDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfTagDbModel = new EntityInsertionAdapter<TagDbModel>(this, __db) { // from class: com.smedialink.bots.data.database.BotsTagDao_Impl.1
    ...
    @Override // com.smedialink.bots.data.database.BotsTagDao
