...
public final class HolidaysDao_Impl extends HolidaysDao {
    ...
    public HolidaysDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfHolidaysDbModel = new EntityInsertionAdapter<HolidaysDbModel>(this, __db) { // from class: com.smedialink.bots.data.database.HolidaysDao_Impl.1
    ...
    @Override // com.smedialink.bots.data.database.HolidaysDao
