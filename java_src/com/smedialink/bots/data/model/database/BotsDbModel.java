...
public final class BotsDbModel {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BotsDbModel) {
            ...
            return Intrinsics.areEqual(this.f249id, botsDbModel.f249id) && Intrinsics.areEqual(this.sku, botsDbModel.sku) && this.lang == botsDbModel.lang && Intrinsics.areEqual(this.avatarOriginal, botsDbModel.avatarOriginal) && Intrinsics.areEqual(this.avatarRounded, botsDbModel.avatarRounded) && Intrinsics.areEqual(this.titleLocales, botsDbModel.titleLocales) && Intrinsics.areEqual(this.descriptionLocales, botsDbModel.descriptionLocales) && Intrinsics.areEqual(this.title, botsDbModel.title) && Intrinsics.areEqual(this.description, botsDbModel.description) && this.installs == botsDbModel.installs && this.priority == botsDbModel.priority && this.reviews == botsDbModel.reviews && Intrinsics.areEqual(Float.valueOf(this.rating), Float.valueOf(botsDbModel.rating)) && this.ownRating == botsDbModel.ownRating && this.installLogged == botsDbModel.installLogged && this.useAssets == botsDbModel.useAssets && this.botUpdated == botsDbModel.botUpdated && Intrinsics.areEqual(this.tags, botsDbModel.tags) && Intrinsics.areEqual(this.file, botsDbModel.file) && Intrinsics.areEqual(this.hash, botsDbModel.hash) && this.phrases == botsDbModel.phrases && this.themes == botsDbModel.themes && Intrinsics.areEqual(this.created, botsDbModel.created) && Intrinsics.areEqual(this.updated, botsDbModel.updated) && Intrinsics.areEqual(this.price, botsDbModel.price) && this.type == botsDbModel.type && this.status == botsDbModel.status;
        }
        return false;
    }

    public int hashCode() {
        int hashCode = this.f249id.hashCode() * 31;
        String str = this.sku;
        int hashCode2 = (((((((((((((((((((((((((((((((((((((((((((((hashCode + (str == null ? 0 : str.hashCode())) * 31) + this.lang.hashCode()) * 31) + this.avatarOriginal.hashCode()) * 31) + this.avatarRounded.hashCode()) * 31) + this.titleLocales.hashCode()) * 31) + this.descriptionLocales.hashCode()) * 31) + this.title.hashCode()) * 31) + this.description.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.installs)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.priority)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.reviews)) * 31) + Float.floatToIntBits(this.rating)) * 31) + this.ownRating) * 31) + this.installLogged) * 31) + this.useAssets) * 31) + this.botUpdated) * 31) + this.tags.hashCode()) * 31) + this.file.hashCode()) * 31) + this.hash.hashCode()) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.phrases)) * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.themes)) * 31) + this.created.hashCode()) * 31) + this.updated.hashCode()) * 31;
        String str2 = this.price;
        return ((((hashCode2 + (str2 != null ? str2.hashCode() : 0)) * 31) + this.type.hashCode()) * 31) + this.status.hashCode();
    }

    public String toString() {
        return "BotsDbModel(id=" + this.f249id + ", sku=" + ((Object) this.sku) + ", lang=" + this.lang + ", avatarOriginal=" + this.avatarOriginal + ", avatarRounded=" + this.avatarRounded + ", titleLocales=" + this.titleLocales + ", descriptionLocales=" + this.descriptionLocales + ", title=" + this.title + ", description=" + this.description + ", installs=" + this.installs + ", priority=" + this.priority + ", reviews=" + this.reviews + ", rating=" + this.rating + ", ownRating=" + this.ownRating + ", installLogged=" + this.installLogged + ", useAssets=" + this.useAssets + ", botUpdated=" + this.botUpdated + ", tags=" + this.tags + ", file=" + this.file + ", hash=" + this.hash + ", phrases=" + this.phrases + ", themes=" + this.themes + ", created=" + this.created + ", updated=" + this.updated + ", price=" + ((Object) this.price) + ", type=" + this.type + ", status=" + this.status + ')';
    }
    ...
    */
    public /* synthetic */ BotsDbModel(java.lang.String r37, java.lang.String r38, com.smedialink.bots.domain.model.BotLanguage r39, java.lang.String r40, java.lang.String r41, java.util.Map r42, java.util.Map r43, java.lang.String r44, java.lang.String r45, long r46, long r48, long r50, float r52, int r53, int r54, int r55, int r56, java.util.List r57, java.lang.String r58, java.lang.String r59, long r60, long r62, java.util.Date r64, java.util.Date r65, java.lang.String r66, com.smedialink.bots.data.model.BotType r67, com.smedialink.bots.data.model.BotStatus r68, int r69, kotlin.jvm.internal.DefaultConstructorMarker r70) {
        /*
            Method dump skipped, instructions count: 293
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.bots.data.model.database.BotsDbModel.<init>(java.lang.String, java.lang.String, com.smedialink.bots.domain.model.BotLanguage, java.lang.String, java.lang.String, java.util.Map, java.util.Map, java.lang.String, java.lang.String, long, long, long, float, int, int, int, int, java.util.List, java.lang.String, java.lang.String, long, long, java.util.Date, java.util.Date, java.lang.String, com.smedialink.bots.data.model.BotType, com.smedialink.bots.data.model.BotStatus, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
