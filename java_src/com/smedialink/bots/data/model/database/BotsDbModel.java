...
public final class BotsDbModel {
    ...
    public String toString() {
        return "BotsDbModel(id=" + this.f249id + ", sku=" + this.sku + ", lang=" + this.lang + ", avatarOriginal=" + this.avatarOriginal + ", avatarRounded=" + this.avatarRounded + ", titleLocales=" + this.titleLocales + ", descriptionLocales=" + this.descriptionLocales + ", title=" + this.title + ", description=" + this.description + ", installs=" + this.installs + ", priority=" + this.priority + ", reviews=" + this.reviews + ", rating=" + this.rating + ", ownRating=" + this.ownRating + ", installLogged=" + this.installLogged + ", useAssets=" + this.useAssets + ", botUpdated=" + this.botUpdated + ", tags=" + this.tags + ", file=" + this.file + ", hash=" + this.hash + ", phrases=" + this.phrases + ", themes=" + this.themes + ", created=" + this.created + ", updated=" + this.updated + ", price=" + this.price + ", type=" + this.type + ", status=" + this.status + ')';
    }
