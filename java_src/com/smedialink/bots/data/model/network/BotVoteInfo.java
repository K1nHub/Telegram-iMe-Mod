...
public final class BotVoteInfo {
    ...
    public int hashCode() {
        return (((((this.userId.hashCode() * 31) + StakingApprovalPrepareRequest$$ExternalSyntheticBackport0.m716m(this.created)) * 31) + this.name.hashCode()) * 31) + this.rating.hashCode();
    }
