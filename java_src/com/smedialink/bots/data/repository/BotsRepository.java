...
public final class BotsRepository {
    ...
    public final Single<List<String>> getSkus() {
        Single<List<String>> create = Single.create(new SingleOnSubscribe() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda10
    ...
    public final Completable sendAppInstallEvent(long j) {
        ...
        Completable flatMapCompletable = appInstall.flatMapCompletable(new Function() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda21
    ...
    public final Completable sendBotInstallEvent(String botId, long j) {
        ...
        Completable flatMapCompletable = botInstall.flatMapCompletable(new Function() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda19
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
    ...
    public final Single<Integer> sendBotRating(final String botId, long j, int i) {
        ...
        Single<R> flatMap = voteForBot.flatMap(new Function() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda20
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
        ...
        Single<Integer> onErrorReturn = flatMap.doOnSuccess(new Consumer() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda15
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                BotsRepository.sendBotRating$lambda$5(Function1.this, obj);
            }
        }).onErrorReturn(new Function() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda16
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
    ...
    public final Completable fetchVotes(long j) {
        ...
        Completable subscribeOn = botsVoting.flatMapCompletable(new Function() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda17
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
    ...
    public final Single<List<AigramBot>> getActiveBotsList() {
        Single<List<AigramBot>> create = Single.create(new SingleOnSubscribe() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda9
            @Override // io.reactivex.SingleOnSubscribe
            public final void subscribe(SingleEmitter singleEmitter) {
    ...
    */
    public static final void updateBotStatus$lambda$14(com.smedialink.bots.data.repository.BotsRepository r38, java.lang.String r39, com.smedialink.bots.data.model.BotStatus r40) {
        /*
            r0 = r38
            r1 = r39
        ...
        L5b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.bots.data.repository.BotsRepository.updateBotStatus$lambda$14(com.smedialink.bots.data.repository.BotsRepository, java.lang.String, com.smedialink.bots.data.model.BotStatus):void");
    }
    ...
    public final Completable updateRemoteBotHash(final String botId) {
        Intrinsics.checkNotNullParameter(botId, "botId");
        Single observeOn = Single.create(new SingleOnSubscribe() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda11
            @Override // io.reactivex.SingleOnSubscribe
            public final void subscribe(SingleEmitter singleEmitter) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:94:0x019e, code lost:
        if ((r5 != null ? r5.getStatus() : null) == com.smedialink.bots.data.model.BotStatus.UPDATE_AVAILABLE) goto L82;
     */
    ...
    */
    ...
    public final Single<QuerySnapshot> getTagsInfo() {
        Single<QuerySnapshot> create = Single.create(new SingleOnSubscribe() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda7
            @Override // io.reactivex.SingleOnSubscribe
            public final void subscribe(SingleEmitter singleEmitter) {
    ...
    public static final void getTagsInfo$lambda$25(BotsRepository this$0, final SingleEmitter emitter) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(emitter, "emitter");
        Task<QuerySnapshot> addOnFailureListener = this$0.remoteDatabase.collection("tags").get().addOnFailureListener(new OnFailureListener() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda0
        ...
        addOnFailureListener.addOnSuccessListener(new OnSuccessListener() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda3
    ...
    public static final void getCategoriesInfo$lambda$30(BotsRepository this$0, final SingleEmitter emitter) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(emitter, "emitter");
        Task<QuerySnapshot> addOnFailureListener = this$0.remoteDatabase.collection("bot_categories").get().addOnFailureListener(new OnFailureListener() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.OnFailureListener
            public final void onFailure(Exception exc) {
        ...
        addOnFailureListener.addOnSuccessListener(new OnSuccessListener() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
    ...
    public final Completable storePurchasesInfo(final List<ShopProduct> products) {
        ...
        Completable fromAction = Completable.fromAction(new Action() { // from class: com.smedialink.bots.data.repository.BotsRepository$$ExternalSyntheticLambda14
            @Override // io.reactivex.functions.Action
            public final void run() {
