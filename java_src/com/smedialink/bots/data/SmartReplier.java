...
public final class SmartReplier implements Replier, CoroutineScope {
    ...
    @Override // com.smedialink.bots.domain.Replier
    ...
    public final List<SmartBotResponse> buildBotsList(List<Response> list, long j) {
        ...
        if (!arrayList2.isEmpty()) {
            sortedWith = CollectionsKt___CollectionsKt.sortedWith(arrayList2, new Comparator() { // from class: com.smedialink.bots.data.SmartReplier$buildBotsList$$inlined$sortedByDescending$1
