...
public final class SmartTag {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SmartTag) {
            ...
            return Intrinsics.areEqual(this.f255id, smartTag.f255id) && Intrinsics.areEqual(this.title, smartTag.title) && this.hidden == smartTag.hidden;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f255id.hashCode() * 31) + this.title.hashCode()) * 31;
    ...
    public String toString() {
        return "SmartTag(id=" + this.f255id + ", title=" + this.title + ", hidden=" + this.hidden + ')';
    }
