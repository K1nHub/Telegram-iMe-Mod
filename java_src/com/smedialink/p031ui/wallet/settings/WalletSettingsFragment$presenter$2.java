...
/* renamed from: com.smedialink.ui.wallet.settings.WalletSettingsFragment$presenter$2 */
...
final class WalletSettingsFragment$presenter$2 extends Lambda implements Function0<WalletSettingsPresenter> {
    ...
    public final WalletSettingsPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2103xd32e4252(this.this$0, null, null));
