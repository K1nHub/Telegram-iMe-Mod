...
/* renamed from: com.smedialink.ui.wallet.airdrop.dialog.WalletAirdropDialogPresenter$getTokensByAirdrop$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C2013x9d8065d9 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ WalletAirdropDialogPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2013x9d8065d9(WalletAirdropDialogPresenter walletAirdropDialogPresenter) {
        super(1);
    ...
    public final void m1295invoke(Result<? extends Boolean> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            String string = resourceManager.getString(C3286R.string.airdrop_success_dialog_title);
            resourceManager2 = this.this$0.resourceManager;
            ((WalletAirdropDialogView) this.this$0.getViewState()).onSuccessClaimAirdrop(string, resourceManager2.getString(C3286R.string.airdrop_success_dialog_description));
