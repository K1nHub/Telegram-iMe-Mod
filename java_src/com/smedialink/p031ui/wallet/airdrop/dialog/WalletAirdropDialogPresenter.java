...
public final class WalletAirdropDialogPresenter extends BasePresenter<WalletAirdropDialogView> {
    ...
    public final void getTokensByAirdrop(String requestId) {
        ...
        final C2026x61f5919c c2026x61f5919c = new C2026x61f5919c(this);
        Observable flatMap = checkAirdropStart$default.flatMap(new Function(c2026x61f5919c) { // from class: com.smedialink.ui.wallet.airdrop.dialog.WalletAirdropDialogPresenter$inlined$sam$i$io_reactivex_functions_Function$0
            private final /* synthetic */ Function1 function;

            {
                Intrinsics.checkNotNullParameter(c2026x61f5919c, "function");
                this.function = c2026x61f5919c;
            }
        ...
        Disposable subscribe = RxExtKt.withLoadingDialog$default(observeOn, (BaseView) viewState, false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2027x9d8065d9(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2028x9d8065da((BaseView) getViewState())));
