...
public final class C2247xdeaf3e3c extends Lambda implements Function1<Result<? extends StakingTotalStats>, Unit> {
    final /* synthetic */ boolean $isInitialLoad$inlined;
    final /* synthetic */ StakingPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2247xdeaf3e3c(StakingPresenter stakingPresenter, boolean z) {
        super(1);
    ...
    public final void m1405invoke(Result<? extends StakingTotalStats> it) {
