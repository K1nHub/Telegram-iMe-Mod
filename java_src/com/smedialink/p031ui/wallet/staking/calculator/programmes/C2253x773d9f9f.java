...
/* renamed from: com.smedialink.ui.wallet.staking.calculator.programmes.StakingCalculatorProgrammesPresenter$loadStakingProgrammes$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C2253x773d9f9f extends Lambda implements Function1<Result<? extends StakingProgrammes>, Unit> {
    ...
    public C2253x773d9f9f(StakingCalculatorProgrammesPresenter stakingCalculatorProgrammesPresenter, boolean z, boolean z2) {
        super(1);
    ...
    public final void m1408invoke(Result<? extends StakingProgrammes> it) {
        List list;
        List list2;
        List<BaseNode> list3;
