...
/* renamed from: com.smedialink.ui.wallet.staking.operations.StakingOperationsFragment$presenter$2 */
...
final class StakingOperationsFragment$presenter$2 extends Lambda implements Function0<StakingOperationsPresenter> {
    ...
    public final StakingOperationsPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2260x92f0fb2b(this.this$0, null, null));
