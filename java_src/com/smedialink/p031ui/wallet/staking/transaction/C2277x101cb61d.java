...
/* renamed from: com.smedialink.ui.wallet.staking.transaction.StakingTransactionPresenter$prepareAction$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C2277x101cb61d extends Lambda implements Function1<Result<? extends Pair<? extends String, ? extends StakingTransactionAction>>, Unit> {
    final /* synthetic */ StakingTransactionPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2277x101cb61d(StakingTransactionPresenter stakingTransactionPresenter) {
        super(1);
    ...
    public final void m1422invoke(Result<? extends Pair<? extends String, ? extends StakingTransactionAction>> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (status == FirebaseFunctionsErrorHandler.ErrorStatus.NO_ENOUGH_MONEY) {
                ...
                ((StakingTransactionView) this.this$0.getViewState()).showToast(resourceManager5.getString(C3301R.string.staking_replenishment_already_finished));
                ...
                String string = resourceManager3.getString(C3301R.string.staking_profit_error_title);
                resourceManager4 = this.this$0.resourceManager;
                ((StakingTransactionView) this.this$0.getViewState()).showActionError(string, resourceManager4.getString(C3301R.string.staking_profit_overlap_error_description));
            } else if (status == FirebaseFunctionsErrorHandler.StakingErrorStatus.ERR_STAKING_WITHDRAWAL_OVER_LIMIT) {
                resourceManager = this.this$0.resourceManager;
                String string2 = resourceManager.getString(C3301R.string.staking_withdraw_error_title);
                resourceManager2 = this.this$0.resourceManager;
                ((StakingTransactionView) this.this$0.getViewState()).showActionError(string2, resourceManager2.getString(C3301R.string.staking_withdraw_over_limit_error_description));
            } else {
