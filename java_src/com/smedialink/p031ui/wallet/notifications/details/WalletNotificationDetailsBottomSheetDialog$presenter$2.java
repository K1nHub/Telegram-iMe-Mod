...
/* renamed from: com.smedialink.ui.wallet.notifications.details.WalletNotificationDetailsBottomSheetDialog$presenter$2 */
...
public final class WalletNotificationDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletNotificationDetailsPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C22391 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletNotificationDetailsBottomSheetDialog this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22391(WalletNotificationDetailsBottomSheetDialog walletNotificationDetailsBottomSheetDialog) {
            super(0);
            this.this$0 = walletNotificationDetailsBottomSheetDialog;
        }
    ...
    public final WalletNotificationDetailsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2237xccf02360(walletNotificationDetailsBottomSheetDialog, null, new C22391(walletNotificationDetailsBottomSheetDialog)));
