...
public final class C2218x560e7e8e extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ WalletNotificationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2218x560e7e8e(WalletNotificationsPresenter walletNotificationsPresenter) {
        super(1);
