...
public final class C2228x949ebadf extends Lambda implements Function1<Result<? extends List<? extends Notification>>, Unit> {
    final /* synthetic */ boolean $forceUpdate$inlined;
    final /* synthetic */ WalletNotificationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2228x949ebadf(WalletNotificationsPresenter walletNotificationsPresenter, boolean z) {
        super(1);
    ...
    public final void m1392invoke(Result<? extends List<? extends Notification>> it) {
