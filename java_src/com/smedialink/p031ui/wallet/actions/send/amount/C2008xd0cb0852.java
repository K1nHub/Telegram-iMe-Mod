...
public final class C2008xd0cb0852 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ TransferArgs.EVM $transferArgs$inlined;
    final /* synthetic */ WalletSendAmountPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2008xd0cb0852(WalletSendAmountPresenter walletSendAmountPresenter, TransferArgs.EVM evm) {
        super(1);
    ...
    public final void m1301invoke(Result<? extends Boolean> it) {
