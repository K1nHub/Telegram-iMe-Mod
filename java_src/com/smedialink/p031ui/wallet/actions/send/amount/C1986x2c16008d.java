...
public final class C1986x2c16008d extends Lambda implements Function1<Result<? extends CryptoTransferMetadata>, Unit> {
    final /* synthetic */ WalletSendAmountPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1986x2c16008d(WalletSendAmountPresenter walletSendAmountPresenter) {
        super(1);
    ...
    public final void m1281invoke(Result<? extends CryptoTransferMetadata> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            walletSendAmountPresenter.sendMode = sendMode != null ? sendMode.intValue() : 3;
            this.this$0.configureFees((CryptoTransferMetadata) success.getData());
