...
/* renamed from: com.smedialink.ui.wallet.swap.WalletSwapProtocolsFragment$presenter$2 */
...
public final class WalletSwapProtocolsFragment$presenter$2 extends Lambda implements Function0<WalletSwapProtocolsPresenter> {
    ...
    public final WalletSwapProtocolsPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2281x4e80c69f(this.this$0, null, null));
