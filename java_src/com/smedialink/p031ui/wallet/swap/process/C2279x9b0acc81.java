...
public final class C2279x9b0acc81 extends Lambda implements Function1<Result<? extends List<? extends OutputConvertToken>>, Unit> {
    ...
    public C2279x9b0acc81(WalletSwapProcessPresenter walletSwapProcessPresenter, String str, Callbacks$Callback callbacks$Callback) {
        super(1);
    ...
    public final void m1418invoke(Result<? extends List<? extends OutputConvertToken>> it) {
        ResourceManager resourceManager;
        Intrinsics.checkNotNullExpressionValue(it, "it");
        Result<? extends List<? extends OutputConvertToken>> result = it;
        if (result instanceof Result.Success) {
            this.this$0.binanceAvailableOppositeSelectableSwapTokens = TuplesKt.m100to(this.$token$inlined, ((Result.Success) result).getData());
