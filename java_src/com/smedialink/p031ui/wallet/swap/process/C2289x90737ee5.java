...
/* renamed from: com.smedialink.ui.wallet.swap.process.WalletSwapProcessPresenter$prepareForSwapBinance$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C2289x90737ee5 extends Lambda implements Function1<Result<? extends BinanceConvertQuote>, Unit> {
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2289x90737ee5(WalletSwapProcessPresenter walletSwapProcessPresenter) {
        super(1);
    ...
    public final void m1423invoke(Result<? extends BinanceConvertQuote> it) {
