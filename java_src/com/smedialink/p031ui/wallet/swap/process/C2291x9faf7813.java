...
public final class C2291x9faf7813 extends Lambda implements Function1<Result<? extends List<? extends CryptoTokenApproveMetadata>>, Unit> {
    ...
    public C2291x9faf7813(WalletSwapProcessPresenter walletSwapProcessPresenter, NetworkType networkType, boolean z, boolean z2) {
        super(1);
    ...
    public final void m1433invoke(Result<? extends List<? extends CryptoTokenApproveMetadata>> it) {
        HashMap hashMap;
