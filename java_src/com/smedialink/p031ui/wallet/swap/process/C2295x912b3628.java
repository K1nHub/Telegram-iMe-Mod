...
public final class C2295x912b3628 extends Lambda implements Function1<Result<? extends List<? extends BinanceTokenInfo>>, Unit> {
    final /* synthetic */ Callbacks$Callback $action$inlined;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2295x912b3628(WalletSwapProcessPresenter walletSwapProcessPresenter, Callbacks$Callback callbacks$Callback) {
        super(1);
    ...
    public final void m1435invoke(Result<? extends List<? extends BinanceTokenInfo>> it) {
