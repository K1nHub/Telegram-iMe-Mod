...
public final class C2301xe9da03bb extends Lambda implements Function1<Result<? extends TokenBalance>, Unit> {
    final /* synthetic */ TokenCode $token$inlined;
    final /* synthetic */ WalletSwapProcessPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2301xe9da03bb(WalletSwapProcessPresenter walletSwapProcessPresenter, TokenCode tokenCode) {
        super(1);
    ...
    public final void m1438invoke(Result<? extends TokenBalance> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            int i = C3301R.string.wallet_swap_process_my_balance;
            ...
            int i2 = C3301R.string.wallet_swap_process_my_balance;
