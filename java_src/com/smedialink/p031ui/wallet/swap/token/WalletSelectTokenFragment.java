...
public final class WalletSelectTokenFragment extends WalletAuthFragment implements WalletSelectTokenView {
    ...
    private final void setupActionBar() {
        ...
        c3366ActionBar.setTitle(getResourceManager().getString(C3301R.string.wallet_swap_process_select_token_header));
        c3366ActionBar.setAllowOverlayTitle(true);
        c3366ActionBar.setActionBarMenuOnItemClick(new C3366ActionBar.ActionBarMenuOnItemClick() { // from class: com.smedialink.ui.wallet.swap.token.WalletSelectTokenFragment$setupActionBar$1$1
