...
public final class WalletTransactionsFragment$presenter$2 extends Lambda implements Function0<WalletTransactionsPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C23211 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletTransactionsFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23211(WalletTransactionsFragment walletTransactionsFragment) {
            super(0);
            this.this$0 = walletTransactionsFragment;
        }
    ...
    public final WalletTransactionsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2320xe8acc4e0(walletTransactionsFragment, null, new C23211(walletTransactionsFragment)));
