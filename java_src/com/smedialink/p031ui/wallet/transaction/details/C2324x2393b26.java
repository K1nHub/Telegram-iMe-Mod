...
public final class C2324x2393b26 extends Lambda implements Function0<Float> {
    final /* synthetic */ WalletTransactionDetailsBottomSheetDialog this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2324x2393b26(WalletTransactionDetailsBottomSheetDialog walletTransactionDetailsBottomSheetDialog) {
        super(0);
    ...
    public final Float invoke() {
        return Float.valueOf(this.this$0.getContext().getResources().getDimension(C3286R.dimen.icon_size_default) / 2);
    }
}
