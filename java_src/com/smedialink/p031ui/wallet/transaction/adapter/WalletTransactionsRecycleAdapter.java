package com.smedialink.p031ui.wallet.transaction.adapter;
...
/* renamed from: com.smedialink.ui.wallet.transaction.adapter.WalletTransactionsRecycleAdapter */
...
public final class WalletTransactionsRecycleAdapter extends BaseNodeAdapter<BaseNode> implements LoadMoreModule {
    ...
    public WalletTransactionsRecycleAdapter(StakingOperationProvider stakingOperationProvider, GlobalStateProvider globalStateProvider, HeaderProvider headerProvider, TokenTransactionProvider tokenTransactionProvider) {
        super(null, 1, null);
