...
/* renamed from: com.smedialink.ui.wallet.crypto.address_mismatch.AddressMismatchFragment$presenter$2 */
...
final class AddressMismatchFragment$presenter$2 extends Lambda implements Function0<AddressMismatchPresenter> {
    ...
    public final AddressMismatchPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2034xf22f97ac(this.this$0, null, null));
