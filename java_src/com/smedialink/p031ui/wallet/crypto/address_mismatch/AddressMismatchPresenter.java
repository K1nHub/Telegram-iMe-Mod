...
public final class AddressMismatchPresenter extends BasePresenter<AddressMismatchView> {
    ...
    public final DialogModel getDeleteWalletDialogModel() {
        return new DialogModel(this.resourceManager.getString(C3301R.string.wallet_enter_eth_password_delete_wallet_dialog_title), this.resourceManager.getString(C3301R.string.wallet_enter_eth_password_delete_wallet_dialog_description), this.resourceManager.getString(C3301R.string.common_cancel), this.resourceManager.getString(C3301R.string.wallet_enter_eth_password_delete_wallet_dialog_submit_btn));
    }
    ...
    public final void deleteActiveWallet(long j) {
        Observable observeOn = CryptoWalletInteractor.deleteWallet$default(this.cryptoWalletInteractor, this.cryptoPreferenceHelper.getCurrentBlockchainType(), false, false, 4, null).observeOn(this.schedulersProvider.mo706ui());
        ...
        Consumer consumer = new Consumer() { // from class: com.smedialink.ui.wallet.crypto.address_mismatch.AddressMismatchPresenter$$ExternalSyntheticLambda1
    ...
    private final void listenEvents() {
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn.subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2035x4b3c3661(this)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C2036x4b3c3662(null))), "viewState: BaseView? = n…  onError.invoke()\n    })");
    }
}
