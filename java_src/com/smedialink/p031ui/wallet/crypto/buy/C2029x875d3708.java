...
/* renamed from: com.smedialink.ui.wallet.crypto.buy.BuyCryptoProductPresenter$purchase$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C2029x875d3708 extends Lambda implements Function1<Result<? extends BuyingCryptoPayment>, Unit> {
    final /* synthetic */ BuyCryptoProductPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2029x875d3708(BuyCryptoProductPresenter buyCryptoProductPresenter) {
        super(1);
    ...
    public final void m1303invoke(Result<? extends BuyingCryptoPayment> it) {
