...
public final class C2080x3b75c083 extends Lambda implements Function1<DomainRxEvents.CryptoEvent, Unit> {
    final /* synthetic */ Runnable $onEventAction$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2080x3b75c083(Runnable runnable) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents.CryptoEvent cryptoEvent) {
        m1332invoke(cryptoEvent);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1332invoke(DomainRxEvents.CryptoEvent it) {
