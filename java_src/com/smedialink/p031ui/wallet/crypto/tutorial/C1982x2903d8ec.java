...
/* renamed from: com.smedialink.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$setupViewPager$1$1$onPageSelected$2$1 */
/* loaded from: classes3.dex */
final class C1982x2903d8ec extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ CreateWalletTutorialFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1982x2903d8ec(CreateWalletTutorialFragment createWalletTutorialFragment) {
        super(1);
