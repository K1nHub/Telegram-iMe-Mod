...
public final class CreateWalletTutorialFragment extends WalletAuthFragment implements CreateWalletTutorialView {
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayListOf = CollectionsKt__CollectionsKt.arrayListOf(new ThemeDescription(this.actionBar, ThemeDescription.FLAG_BACKGROUND, null, null, null, null, "windowBackgroundWhite"), new ThemeDescription(this.actionBar, ThemeDescription.FLAG_AB_ITEMSCOLOR, null, null, null, null, "windowBackgroundWhiteGrayIcon"), new ThemeDescription(this.actionBar, ThemeDescription.FLAG_AB_SELECTORCOLOR, null, null, null, null, "actionBarWhiteSelector"), new ThemeDescription(getBinding().getRoot(), ThemeDescription.FLAG_BACKGROUND, null, null, null, new ThemeDescription.ThemeDescriptionDelegate() { // from class: com.smedialink.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$$ExternalSyntheticLambda1
            ...
            public final void didSetColor() {
                CreateWalletTutorialFragment.m1614getThemeDescriptions$lambda0(CreateWalletTutorialFragment.this);
            }
        ...
        }, "windowBackgroundWhite"), new ThemeDescription(null, 0, null, null, null, new ThemeDescription.ThemeDescriptionDelegate() { // from class: com.smedialink.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$$ExternalSyntheticLambda2
            @Override // org.telegram.p048ui.ActionBar.ThemeDescription.ThemeDescriptionDelegate
            public final void didSetColor() {
                CreateWalletTutorialFragment.m1615getThemeDescriptions$lambda2(CreateWalletTutorialFragment.this);
            }
    ...
    public static final void m1614getThemeDescriptions$lambda0(CreateWalletTutorialFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.getTutorialAdapter().notifyDataSetChanged();
    }

    /* renamed from: getThemeDescriptions$lambda-2 */
    public static final void m1615getThemeDescriptions$lambda2(CreateWalletTutorialFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void setupActionBar() {
        ...
        Intrinsics.checkNotNullExpressionValue(c3222ActionBar, "");
        ActionBarExtKt.applyColorsWithWhiteBackground(c3222ActionBar);
        ...
        c3222ActionBar.setActionBarMenuOnItemClick(new C3222ActionBar.ActionBarMenuOnItemClick() { // from class: com.smedialink.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$setupActionBar$1$1
    ...
    public final void handleBackPressed() {
        if (this.tutorialType instanceof TutorialType.Backup) {
            ...
            AlertDialog createDialog$default = DialogUtils.createDialog$default(parentActivity, new DialogModel(getResourceManager().getString(C3158R.string.wallet_backup_quit_alert_title), getResourceManager().getString(C3158R.string.wallet_backup_quit_alert_description), getResourceManager().getString(C3158R.string.wallet_backup_quit_alert_negative_button), getResourceManager().getString(C3158R.string.wallet_backup_quit_alert_positive_button)), new Callbacks$Callback() { // from class: com.smedialink.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$$ExternalSyntheticLambda0
    ...
    private final void setupViewPager() {
        WrapContentViewPager wrapContentViewPager = getBinding().viewPagerTutorial;
        wrapContentViewPager.setAdapter(getTutorialAdapter());
        Intrinsics.checkNotNullExpressionValue(wrapContentViewPager, "");
        ViewExtKt.applyDefaultProperties(wrapContentViewPager);
        getBinding().dotsIndicatorTutorial.setViewPager(wrapContentViewPager);
        wrapContentViewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() { // from class: com.smedialink.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$setupViewPager$1$1
            ...
            public void onPageSelected(int i) {
                ...
                if (i == lastIndex) {
                    ...
                    ActionButton actionButton = binding2.buttonAction;
                    ...
                    actionButton.setText(resourceManager2.getString(C3158R.string.common_create));
                    Intrinsics.checkNotNullExpressionValue(actionButton, "");
                    ViewExtKt.safeThrottledClick$default(actionButton, 0L, new C1981x2903d52b(createWalletTutorialFragment), 1, null);
                    return;
                }
                ...
                actionButton2.setText(resourceManager.getString(C3158R.string.common_next));
                Intrinsics.checkNotNullExpressionValue(actionButton2, "");
                ViewExtKt.safeThrottledClick$default(actionButton2, 0L, new C1982x2903d8ec(createWalletTutorialFragment2), 1, null);
            }
        });
    }

    private final void setupTexts() {
        getBinding().buttonAction.setText(getResourceManager().getString(C3158R.string.common_next));
    }
    ...
    private final void setupListeners() {
        ...
        Disposable subscribe = observeOn.subscribe(new Consumer() { // from class: com.smedialink.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$setupListeners$$inlined$subscribeWithErrorHandle$default$1
        ...
        }, new Consumer() { // from class: com.smedialink.ui.wallet.crypto.tutorial.CreateWalletTutorialFragment$setupListeners$$inlined$subscribeWithErrorHandle$default$2
            @Override // io.reactivex.functions.Consumer
