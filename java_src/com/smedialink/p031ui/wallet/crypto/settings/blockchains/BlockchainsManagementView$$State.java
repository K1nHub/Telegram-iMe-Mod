...
/* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State */
...
public class BlockchainsManagementView$$State extends MvpViewState<BlockchainsManagementView> implements BlockchainsManagementView {
    ...
    @Override // com.smedialink.p031ui.wallet.crypto.settings.blockchains.BlockchainsManagementView
    public void openBackupScreen(List<String> list, String str) {
        OpenBackupScreenCommand openBackupScreenCommand = new OpenBackupScreenCommand(this, list, str);
        this.viewCommands.beforeApply(openBackupScreenCommand);
        if (hasNotView().booleanValue()) {
            return;
        }
        for (View view : this.views) {
            view.openBackupScreen(list, str);
        }
    ...
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State$SetupWalletsItemsCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: BlockchainsManagementView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State$ShowResetAllWalletsConfirmationDialogCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: BlockchainsManagementView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State$ShowWalletDetailsDialogCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: BlockchainsManagementView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State$ShowWalletInfoDialogCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: BlockchainsManagementView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State$OpenBackupScreenCommand */
    /* loaded from: classes3.dex */
    public class OpenBackupScreenCommand extends ViewCommand<BlockchainsManagementView> {
        ...
        OpenBackupScreenCommand(BlockchainsManagementView$$State blockchainsManagementView$$State, List<String> list, String str) {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(BlockchainsManagementView blockchainsManagementView) {
            blockchainsManagementView.openBackupScreen(this.secretWords, this.address);
        }
    }

    /* compiled from: BlockchainsManagementView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State$ShowToastCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: BlockchainsManagementView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State$ShowLoadingDialogCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: BlockchainsManagementView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.BlockchainsManagementView$$State$FinishScreenCommand */
    /* loaded from: classes3.dex */
