...
/* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$presenter$2 */
...
public final class BlockchainWalletDetailsBottomSheetDialog$presenter$2 extends Lambda implements Function0<BlockchainWalletDetailsPresenter> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: BlockchainWalletDetailsBottomSheetDialog.kt */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$presenter$2$1 */
    /* loaded from: classes3.dex */
    public static final class C19721 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ BlockchainWalletDetailsBottomSheetDialog this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C19721(BlockchainWalletDetailsBottomSheetDialog blockchainWalletDetailsBottomSheetDialog) {
            super(0);
            this.this$0 = blockchainWalletDetailsBottomSheetDialog;
        }
    ...
    public final BlockchainWalletDetailsPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C1970xac57dd17(blockchainWalletDetailsBottomSheetDialog, null, new C19721(blockchainWalletDetailsBottomSheetDialog)));
