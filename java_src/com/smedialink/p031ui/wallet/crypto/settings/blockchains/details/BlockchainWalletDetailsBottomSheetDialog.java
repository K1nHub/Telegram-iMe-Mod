...
/* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog */
...
public final class BlockchainWalletDetailsBottomSheetDialog extends MvpBottomSheet implements BlockchainWalletDetailsView {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(BlockchainWalletDetailsBottomSheetDialog.class, "presenter", "getPresenter()Lcom/smedialink/ui/wallet/crypto/settings/blockchains/details/BlockchainWalletDetailsPresenter;", 0)), Reflection.property1(new PropertyReference1Impl(BlockchainWalletDetailsBottomSheetDialog.class, "binding", "getBinding()Lorg/telegram/messenger/databinding/ForkContentBlockchainsWalletDetailsBinding;", 0))};
    ...
    */
    public BlockchainWalletDetailsBottomSheetDialog(org.telegram.p048ui.ActionBar.BaseFragment r3, com.smedialink.model.wallet.crypto.settings.BlockchainWalletItem r4, kotlin.jvm.functions.Function1<? super com.smedialink.model.wallet.crypto.settings.BlockchainWalletItem, kotlin.Unit> r5, kotlin.jvm.functions.Function1<? super com.smedialink.model.wallet.crypto.settings.BlockchainWalletItem, kotlin.Unit> r6, com.smedialink.model.dialog.DialogModel r7) {
        /*
            r2 = this;
            ...
            com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$presenter$2 r4 = new com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$presenter$2
            r4.<init>(r2)
            ...
            r7.<init>()
            java.lang.Class<com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsPresenter> r0 = com.smedialink.p031ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsPresenter.class
            ...
            com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$special$$inlined$inject$default$1 r5 = new com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$special$$inlined$inject$default$1
            r6 = 0
            r5.<init>(r2, r6, r6)
            kotlin.Lazy r4 = kotlin.LazyKt.lazy(r4, r5)
            r2.resourceManager$delegate = r4
            com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$binding$2 r4 = new com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$binding$2
            r4.<init>(r3)
            com.smedialink.utils.extentions.delegate.ResettableLazy r3 = com.smedialink.utils.extentions.delegate.ResettableLazyDelegateKt.resettableLazy$default(r2, r6, r4, r1, r6)
            r2.binding$delegate = r3
            r3 = 0
            r2.setApplyBottomPadding(r3)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.p031ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog.<init>(org.telegram.ui.ActionBar.BaseFragment, com.smedialink.model.wallet.crypto.settings.BlockchainWalletItem, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, com.smedialink.model.dialog.DialogModel):void");
    }
    ...
    public void setupScreenWithData(int i, String title, String subtitle, String createdDate, String address) {
        ...
        binding.viewConnectedCell.setupViewData(getResourceManager().getString(C3301R.string.wallet_details_created), createdDate, C3301R.C3303drawable.msg_calendar2, true);
    ...
    public void showResetWalletConfirmationDialog(DialogModel dialogModel) {
        ...
        AlertDialog createDialog$default = DialogUtils.createDialog$default(context, dialogModel, new Callbacks$Callback() { // from class: com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$$ExternalSyntheticLambda1
    ...
    private final void setupActionItem() {
        ...
        setupActionItem$lambda$4.setIcon(C3301R.C3303drawable.ic_ab_other);
        ...
        setupActionItem$lambda$4.addSubItem(IdFabric$Menu.INFO, C3301R.C3303drawable.msg_info, getResourceManager().getString(C3301R.string.wallet_crypto_buy_information_dialog_title));
        setupActionItem$lambda$4.addSubItem(IdFabric$Menu.COPY, C3301R.C3303drawable.msg_copy, getResourceManager().getString(C3301R.string.wallet_transaction_details_action_copy_address));
        ...
        setupActionItem$lambda$4.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C3301R.string.AccDescrMoreOptions));
    }
    ...
    private final void setupTexts() {
        ForkContentBlockchainsWalletDetailsBinding binding = getBinding();
        binding.buttonBackup.setText(getResourceManager().getString(C3301R.string.wallet_eth_account_settings_backup_title));
        binding.buttonReset.setText(LocaleController.getString("Reset", C3301R.string.Reset));
    }
    ...
    /* compiled from: BlockchainWalletDetailsBottomSheetDialog.kt */
    /* renamed from: com.smedialink.ui.wallet.crypto.settings.blockchains.details.BlockchainWalletDetailsBottomSheetDialog$Companion */
    /* loaded from: classes3.dex */
