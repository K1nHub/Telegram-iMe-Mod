...
/* renamed from: com.smedialink.ui.wallet.crypto.settings.WalletAccountSettingsFragment$setupListeners$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C2077xdd3a1942 extends Lambda implements Function1<DomainRxEvents, Unit> {
    final /* synthetic */ WalletAccountSettingsFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2077xdd3a1942(WalletAccountSettingsFragment walletAccountSettingsFragment) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents domainRxEvents) {
        m1320invoke(domainRxEvents);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1320invoke(DomainRxEvents it) {
