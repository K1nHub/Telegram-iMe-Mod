...
/* renamed from: com.smedialink.ui.wallet.crypto.settings.privacy.WalletPrivacySettingPresenter$saveAccountRankSettingsObservable$1 */
/* loaded from: classes3.dex */
public final class C2096x1efe2092 extends Lambda implements Function1<Boolean, ObservableSource<? extends Result<? extends Boolean>>> {
    final /* synthetic */ int $accountRankAllowType;
    final /* synthetic */ WalletPrivacySettingPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2096x1efe2092(WalletPrivacySettingPresenter walletPrivacySettingPresenter, int i) {
        super(1);
    ...
    public final ObservableSource<? extends Result<Boolean>> invoke(Boolean isNeedChange) {
        ...
        Observable<Result<Boolean>> observeOn = changeLevelVisibility.observeOn(schedulersProvider.mo707ui());
        ...
        ObservableSource map = observeOn.map(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new C2092xe2eac0b8((BaseView) viewState, resourceManager)));
