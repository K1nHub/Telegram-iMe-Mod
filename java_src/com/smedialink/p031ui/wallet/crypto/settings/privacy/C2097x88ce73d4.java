...
/* renamed from: com.smedialink.ui.wallet.crypto.settings.privacy.WalletPrivacySettingPresenter$saveWalletAddressSettingsObservable$1 */
/* loaded from: classes3.dex */
public final class C2097x88ce73d4 extends Lambda implements Function1<Boolean, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C2097x88ce73d4(WalletPrivacySettingPresenter walletPrivacySettingPresenter, int i, ArrayList<Long> arrayList) {
        super(1);
    ...
    public final ObservableSource<? extends Result<Boolean>> invoke(Boolean isNeedChange) {
        ...
        Observable observeOn = manageCryptoPrivacySettings$default.observeOn(schedulersProvider.mo707ui());
        ...
        Observable map = observeOn.map(new RxExtKt$sam$i$io_reactivex_functions_Function$0(new C2095xbd3dff7a((BaseView) viewState, resourceManager)));
