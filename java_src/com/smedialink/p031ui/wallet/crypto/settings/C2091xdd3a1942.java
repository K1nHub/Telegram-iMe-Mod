...
public final class C2091xdd3a1942 extends Lambda implements Function1<DomainRxEvents, Unit> {
    final /* synthetic */ WalletAccountSettingsFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2091xdd3a1942(WalletAccountSettingsFragment walletAccountSettingsFragment) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DomainRxEvents domainRxEvents) {
        m1336invoke(domainRxEvents);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1336invoke(DomainRxEvents it) {
