...
public final class SecretWordsCountAdapter extends BaseQuickAdapter<Integer, BaseViewHolder> {
    ...
    public SecretWordsCountAdapter(ResourceManager resourceManager) {
        super(C3301R.layout.fork_recycle_item_wallet_secret_words_count, null, 2, null);
    ...
    protected void convert(BaseViewHolder holder, int i) {
        ...
        int i2 = C3301R.C3304id.text_words_count;
        BaseQuickAdapterExtKt.setThemedTextColor(BaseQuickAdapterExtKt.setThemedBackgroundColor(BaseQuickAdapterExtKt.setRippleForeground(holder, i2, false), i2, "windowBackgroundWhite"), i2, "dialogTextBlack").setText(i2, this.resourceManager.getString(C3301R.string.wallet_import_words_count, Integer.valueOf(i)));
    }
}
