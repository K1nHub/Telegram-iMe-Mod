...
/* renamed from: com.smedialink.ui.wallet.crypto.create.CreateWalletFragment$editTextContainer$2 */
/* loaded from: classes3.dex */
public final class CreateWalletFragment$editTextContainer$2 extends Lambda implements Function0<LinearLayout> {
    final /* synthetic */ CreateWalletFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CreateWalletFragment$editTextContainer$2(CreateWalletFragment createWalletFragment) {
        super(0);
