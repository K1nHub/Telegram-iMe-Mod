...
public final class C2066xa2ffd3d8 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    ...
    public C2066xa2ffd3d8(CreateWalletPresenter createWalletPresenter, boolean z, String str, String str2) {
        super(1);
    ...
    public final void m1327invoke(Result<? extends Boolean> it) {
