...
/* renamed from: com.smedialink.ui.wallet.crypto.create.pin.CreateWalletPinPresenter$validatePin$$inlined$subscribeWithErrorHandle$default$3 */
/* loaded from: classes3.dex */
public final class C2074xe4b01fa8 extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ CreateWalletPinPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2074xe4b01fa8(CreateWalletPinPresenter createWalletPinPresenter) {
        super(1);
    ...
    public final void m1330invoke(Result<? extends String> it) {
