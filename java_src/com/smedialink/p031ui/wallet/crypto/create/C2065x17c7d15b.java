...
public final class C2065x17c7d15b extends Lambda implements Function1<Result<? extends Boolean>, ObservableSource<? extends Result<? extends Boolean>>> {
    ...
    public C2065x17c7d15b(boolean z, CreateWalletPresenter createWalletPresenter, String str) {
        super(1);
    ...
    public final ObservableSource<? extends Result<? extends Boolean>> invoke(Result<? extends Boolean> result) {
        ...
        if (!(result instanceof Result.Success)) {
            ...
            Observable<Result<Wallet>> observeOn = createWallet.observeOn(schedulersProvider.mo706ui());
            Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoWalletInteractor\n …(schedulersProvider.ui())");
            ObservableSource map = observeOn.map(new C2069x9ee4cc57(new C2068x9247a8b3()));
