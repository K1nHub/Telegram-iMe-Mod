...
import com.smedialink.p031ui.wallet.crypto.create.secret_words_count.SecretWordsCountBottomSheetDialog;
import kotlin.Unit;
...
/* renamed from: com.smedialink.ui.wallet.crypto.create.CreateWalletFragment$setupViewsContents$1$2 */
...
public final class CreateWalletFragment$setupViewsContents$1$2 extends Lambda implements Function0<Unit> {
    ...
    /* loaded from: classes3.dex */
    public static final class C20601 extends Lambda implements Function1<Integer, Unit> {
        final /* synthetic */ CreateWalletFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C20601(CreateWalletFragment createWalletFragment) {
            super(1);
            this.this$0 = createWalletFragment;
        }
    ...
    public final void invoke2() {
        ...
        createWalletFragment.showDialog(companion.newInstance(parentActivity, new C20601(this.this$0)));
    }
}
