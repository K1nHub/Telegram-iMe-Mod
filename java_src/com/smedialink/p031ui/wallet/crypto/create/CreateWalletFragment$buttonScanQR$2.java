...
/* renamed from: com.smedialink.ui.wallet.crypto.create.CreateWalletFragment$buttonScanQR$2 */
/* loaded from: classes3.dex */
public final class CreateWalletFragment$buttonScanQR$2 extends Lambda implements Function0<SecretWordsActionButton> {
    final /* synthetic */ CreateWalletFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CreateWalletFragment$buttonScanQR$2(CreateWalletFragment createWalletFragment) {
        super(0);
    ...
    public final SecretWordsActionButton invoke() {
        ...
        createScanQRButton = this.this$0.createScanQRButton();
