...
public final class C2043x1c919b66 extends Lambda implements Function1<DomainRxEvents.CryptoEvent, Unit> {
    final /* synthetic */ CreateWalletFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2043x1c919b66(CreateWalletFragment createWalletFragment) {
        super(1);
    ...
    public final void m1307invoke(DomainRxEvents.CryptoEvent it) {
        ...
        if (cryptoEvent instanceof DomainRxEvents.SuccessRecreateWalletByPassword ? true : cryptoEvent instanceof DomainRxEvents.SuccessResetWallet ? true : cryptoEvent instanceof DomainRxEvents.SuccessRestoreWallet) {
            if (((CreateWalletFragment.ScreenType.Import) this.this$0.currentType).getPassword().length() == 0) {
