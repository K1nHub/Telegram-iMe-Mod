...
/* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.WalletConnectFragment$presenter$2 */
...
final class WalletConnectFragment$presenter$2 extends Lambda implements Function0<WalletConnectPresenter> {
    ...
    public final WalletConnectPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C1983x61ee5e3d(this.this$0, null, null));
