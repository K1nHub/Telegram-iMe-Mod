...
/* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionView$$State */
...
public class WalletConnectTransactionView$$State extends MvpViewState<WalletConnectTransactionView> implements WalletConnectTransactionView {
    ...
    /* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionView$$State$OnTransactionSuccessCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: WalletConnectTransactionView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionView$$State$SetupScreenWithDataCommand */
    /* loaded from: classes3.dex */
    public class SetupScreenWithDataCommand extends ViewCommand<WalletConnectTransactionView> {
        ...
        @Override // moxy.viewstate.ViewCommand
        public void apply(WalletConnectTransactionView walletConnectTransactionView) {
            walletConnectTransactionView.setupScreenWithData(this.transactionAmount, this.network, this.from, this.f380to, this.peerUrl);
        }
    }

    /* compiled from: WalletConnectTransactionView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionView$$State$ShowFeeCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: WalletConnectTransactionView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionView$$State$ShowToastCommand */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: WalletConnectTransactionView$$State.java */
    /* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.transaction.WalletConnectTransactionView$$State$ShowLoadingDialogCommand */
    /* loaded from: classes3.dex */
