...
final class WalletConnectSwitchNetworkBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletConnectSwitchNetworkPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C21311 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ NetworkType $networkType;
        final /* synthetic */ long $requestId;
        final /* synthetic */ WalletConnectSessionItem $sessionItem;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21311(long j, WalletConnectSessionItem walletConnectSessionItem, NetworkType networkType) {
            super(0);
            this.$requestId = j;
            this.$sessionItem = walletConnectSessionItem;
            this.$networkType = networkType;
    ...
    public final WalletConnectSwitchNetworkPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2129x9d76e16b(this.this$0, null, new C21311(this.$requestId, this.$sessionItem, this.$networkType)));
