...
/* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog */
...
public final class WalletConnectSwitchNetworkBottomSheetDialog extends MvpBottomSheet implements WalletConnectSwitchNetworkView {
    ...
    */
    public WalletConnectSwitchNetworkBottomSheetDialog(long r9, com.smedialink.model.wallet.crypto.wallet_connect.WalletConnectSessionItem r11, com.smedialink.storage.domain.model.crypto.NetworkType r12, org.telegram.p048ui.ActionBar.BaseFragment r13) {
        /*
            r8 = this;
            ...
            r1 = 1
            r8.<init>(r0, r1)
            com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog$presenter$2 r0 = new com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog$presenter$2
            r2 = r0
            r3 = r8
            r4 = r9
            r6 = r11
            ...
            r11.<init>()
            java.lang.Class<com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkPresenter> r12 = com.smedialink.p031ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkPresenter.class
            ...
            org.koin.mp.KoinPlatformTools r9 = org.koin.p047mp.KoinPlatformTools.INSTANCE
            kotlin.LazyThreadSafetyMode r9 = r9.defaultLazyMode()
            com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog$special$$inlined$inject$default$1 r10 = new com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog$special$$inlined$inject$default$1
            r11 = 0
            r10.<init>(r8, r11, r11)
            kotlin.Lazy r9 = kotlin.LazyKt.lazy(r9, r10)
            r8.resourceManager$delegate = r9
            com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog$binding$2 r9 = new com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog$binding$2
            r9.<init>(r13)
            com.smedialink.utils.extentions.delegate.ResettableLazy r9 = com.smedialink.utils.extentions.delegate.ResettableLazyDelegateKt.resettableLazy$default(r8, r11, r9, r1, r11)
            r8.binding$delegate = r9
            r9 = 0
            r8.setApplyBottomPadding(r9)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.p031ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog.<init>(long, com.smedialink.model.wallet.crypto.wallet_connect.WalletConnectSessionItem, com.smedialink.storage.domain.model.crypto.NetworkType, org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    @Override // com.smedialink.p031ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkView
    public void setupScreenWithData(String iconUrl, String name, String url, int i, String networkName) {
        ...
        binding.viewHeader.setupViewData(iconUrl, getResourceManager().getString(C3301R.string.wallet_connect_switch_network_title, name), url);
        binding.viewNetworkCell.setupViewData(getResourceManager().getString(C3301R.string.wallet_connect_session_details_network), networkName, i, true);
    }
    ...
    private final void setupViews() {
        ...
        binding.buttonChangeNetwork.setText(getResourceManager().getString(C3301R.string.wallet_connect_switch_network));
    ...
    /* compiled from: WalletConnectSwitchNetworkBottomSheetDialog.kt */
    /* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.network_change.WalletConnectSwitchNetworkBottomSheetDialog$Companion */
    /* loaded from: classes3.dex */
