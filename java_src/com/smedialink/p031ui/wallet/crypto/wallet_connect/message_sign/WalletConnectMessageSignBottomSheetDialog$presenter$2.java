...
final class WalletConnectMessageSignBottomSheetDialog$presenter$2 extends Lambda implements Function0<WalletConnectMessageSignPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C21281 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WCEthereumSignMessage $message;
        final /* synthetic */ long $requestId;
        final /* synthetic */ WalletConnectSessionItem $sessionItem;
        final /* synthetic */ WalletConnectManager $walletConnectManager;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C21281(long j, WalletConnectSessionItem walletConnectSessionItem, WCEthereumSignMessage wCEthereumSignMessage, WalletConnectManager walletConnectManager) {
            super(0);
            this.$requestId = j;
            this.$sessionItem = walletConnectSessionItem;
            this.$message = wCEthereumSignMessage;
    ...
    public final WalletConnectMessageSignPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2125xe2ff69b5(this.this$0, null, new C21281(this.$requestId, this.$sessionItem, this.$message, this.$walletConnectManager)));
