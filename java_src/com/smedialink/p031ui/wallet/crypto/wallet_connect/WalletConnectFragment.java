...
import com.smedialink.p031ui.wallet.crypto.wallet_connect.session_details.WalletConnectSessionDetailsBottomSheetDialog;
...
/* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.WalletConnectFragment */
/* loaded from: classes3.dex */
public final class WalletConnectFragment extends WalletAuthFragment implements WalletConnectView {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(WalletConnectFragment.class, "presenter", "getPresenter()Lcom/smedialink/ui/wallet/crypto/wallet_connect/WalletConnectPresenter;", 0)), Reflection.property1(new PropertyReference1Impl(WalletConnectFragment.class, "binding", "getBinding()Lorg/telegram/messenger/databinding/ForkFragmentWalletConnectBinding;", 0))};
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: com.smedialink.ui.wallet.crypto.wallet_connect.WalletConnectFragment$$ExternalSyntheticLambda3
    ...
    private final void setupListeners() {
        ...
        com.smedialink.utils.extentions.common.ViewExtKt.safeThrottledClick$default(buttonConnect, 0L, new WalletConnectFragment$setupListeners$1$1(this), 1, null);
        ...
        com.smedialink.utils.extentions.common.ViewExtKt.safeThrottledClick$default(buttonDisconnectAll, 0L, new WalletConnectFragment$setupListeners$1$2(this), 1, null);
        RLottieImageView imageHeader = binding.imageHeader;
        Intrinsics.checkNotNullExpressionValue(imageHeader, "imageHeader");
        com.smedialink.utils.extentions.common.ViewExtKt.safeThrottledClick$default(imageHeader, 0L, new WalletConnectFragment$setupListeners$1$3(this), 1, null);
    ...
    private final void openQRScan() {
        CameraScanActivity.showAsSheet((BaseFragment) this, true, 1, new CameraScanActivity.CameraScanActivityDelegate() { // from class: com.smedialink.ui.wallet.crypto.wallet_connect.WalletConnectFragment$openQRScan$1
    ...
    public final void showDisconnectAllConfirmationDialog() {
        ...
        AlertDialog createDialog$default = DialogUtils.createDialog$default(parentActivity, disconnectAllConfirmationDialogModel, new Callbacks$Callback() { // from class: com.smedialink.ui.wallet.crypto.wallet_connect.WalletConnectFragment$$ExternalSyntheticLambda2
    ...
    /* compiled from: WalletConnectFragment.kt */
    /* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.WalletConnectFragment$Companion */
    /* loaded from: classes3.dex */
