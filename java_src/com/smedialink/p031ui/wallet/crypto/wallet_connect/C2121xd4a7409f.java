...
public final class C2121xd4a7409f extends Lambda implements Function1<Result<? extends List<? extends WCSessionStoreItem>>, Unit> {
    final /* synthetic */ WalletConnectPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2121xd4a7409f(WalletConnectPresenter walletConnectPresenter) {
        super(1);
    ...
    public final void m1343invoke(Result<? extends List<? extends WCSessionStoreItem>> it) {
