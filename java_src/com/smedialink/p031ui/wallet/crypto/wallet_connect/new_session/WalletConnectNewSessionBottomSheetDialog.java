...
/* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog */
...
public final class WalletConnectNewSessionBottomSheetDialog extends MvpBottomSheet implements WalletConnectNewSessionView {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(WalletConnectNewSessionBottomSheetDialog.class, "presenter", "getPresenter()Lcom/smedialink/ui/wallet/crypto/wallet_connect/new_session/WalletConnectNewSessionPresenter;", 0)), Reflection.property1(new PropertyReference1Impl(WalletConnectNewSessionBottomSheetDialog.class, "binding", "getBinding()Lorg/telegram/messenger/databinding/ForkContentWalletConnectNewSessionBinding;", 0))};
    ...
    */
    public WalletConnectNewSessionBottomSheetDialog(com.trustwallet.walletconnect.WCSessionStoreItem r6, org.telegram.p048ui.ActionBar.BaseFragment r7) {
        /*
            r5 = this;
            ...
            r1 = 1
            r5.<init>(r0, r1)
            com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog$presenter$2 r0 = new com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog$presenter$2
            r0.<init>(r5, r6)
            ...
            r3.<init>()
            java.lang.Class<com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionPresenter> r4 = com.smedialink.p031ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionPresenter.class
            ...
            org.koin.mp.KoinPlatformTools r6 = org.koin.p047mp.KoinPlatformTools.INSTANCE
            kotlin.LazyThreadSafetyMode r6 = r6.defaultLazyMode()
            com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog$special$$inlined$inject$default$1 r0 = new com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog$special$$inlined$inject$default$1
            r2 = 0
            r0.<init>(r5, r2, r2)
            kotlin.Lazy r6 = kotlin.LazyKt.lazy(r6, r0)
            r5.resourceManager$delegate = r6
            com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog$binding$2 r6 = new com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog$binding$2
            r6.<init>(r7)
            com.smedialink.utils.extentions.delegate.ResettableLazy r6 = com.smedialink.utils.extentions.delegate.ResettableLazyDelegateKt.resettableLazy$default(r5, r2, r6, r1, r2)
            r5.binding$delegate = r6
            r6 = 0
            r5.setApplyBottomPadding(r6)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.p031ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog.<init>(com.trustwallet.walletconnect.WCSessionStoreItem, org.telegram.ui.ActionBar.BaseFragment):void");
    }
    ...
    public void setupScreenWithData(String iconUrl, String name, String url, String address, String network) {
        ...
        binding.viewHeader.setupViewData(iconUrl, getResourceManager().getString(C3286R.string.wallet_connect_new_session_title, name), url);
        binding.viewWalletCell.setupViewData(getResourceManager().getString(C3286R.string.wallet_connect_new_session_wallet), address, C3286R.C3288drawable.fork_ic_nav_wallet_24, true);
        binding.viewNetworkCell.setupViewData(getResourceManager().getString(C3286R.string.wallet_connect_session_details_network), network, C3286R.C3288drawable.msg_language, true);
    }
    ...
    private final void setupViews() {
        ForkContentWalletConnectNewSessionBinding binding = getBinding();
        binding.textViewBalance.setText(getResourceManager().getString(C3286R.string.wallet_connect_new_session_view_balance));
        binding.textTransactionsApproval.setText(getResourceManager().getString(C3286R.string.wallet_connect_new_transactions_approval));
        binding.buttonConnect.setText(getResourceManager().getString(C3286R.string.wallet_connect_new_connection));
    ...
    /* compiled from: WalletConnectNewSessionBottomSheetDialog.kt */
    /* renamed from: com.smedialink.ui.wallet.crypto.wallet_connect.new_session.WalletConnectNewSessionBottomSheetDialog$Companion */
    /* loaded from: classes3.dex */
