...
public final class C2135x82948e4f extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ WalletDonationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2135x82948e4f(WalletDonationsPresenter walletDonationsPresenter) {
        super(1);
    ...
    public final void m1332invoke(Result<? extends String> it) {
