...
public final class C2137x23f668db extends Lambda implements Function1<Result<? extends String>, Unit> {
    final /* synthetic */ WalletDonationsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2137x23f668db(WalletDonationsPresenter walletDonationsPresenter) {
        super(1);
    ...
    public final void m1333invoke(Result<? extends String> it) {
        String str;
