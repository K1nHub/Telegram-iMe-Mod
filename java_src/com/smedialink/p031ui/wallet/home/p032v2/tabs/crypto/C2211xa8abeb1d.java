...
public final class C2211xa8abeb1d extends Lambda implements Function1<Result<? extends List<BaseNode>>, Unit> {
    final /* synthetic */ WalletHomeCryptoPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2211xa8abeb1d(WalletHomeCryptoPresenter walletHomeCryptoPresenter) {
        super(1);
    ...
    public final void m1385invoke(Result<? extends List<BaseNode>> it) {
