...
/* renamed from: com.smedialink.ui.wallet.home.v2.tabs.binancepay.history.WalletBinancePayHistoryFragment$presenter$2 */
...
public final class WalletBinancePayHistoryFragment$presenter$2 extends Lambda implements Function0<WalletBinancePayHistoryPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C20541 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ WalletBinancePayHistoryFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C20541(WalletBinancePayHistoryFragment walletBinancePayHistoryFragment) {
            super(0);
            this.this$0 = walletBinancePayHistoryFragment;
        }
    ...
    public final WalletBinancePayHistoryPresenter invoke() {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C2052xbbe1c0a5(walletBinancePayHistoryFragment, null, new C20541(walletBinancePayHistoryFragment)));
