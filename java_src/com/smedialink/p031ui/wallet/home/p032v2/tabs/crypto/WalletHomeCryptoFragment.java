...
import com.smedialink.p031ui.wallet.crypto.address_mismatch.AddressMismatchFragment;
...
import com.smedialink.p031ui.wallet.home.p032v2.tabs.crypto.WalletHomeCryptoView;
...
/* renamed from: com.smedialink.ui.wallet.home.v2.tabs.crypto.WalletHomeCryptoFragment */
/* loaded from: classes3.dex */
public final class WalletHomeCryptoFragment extends WalletHomeTabFragment implements WalletHomeCryptoView {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(WalletHomeCryptoFragment.class, "presenter", "getPresenter()Lcom/smedialink/ui/wallet/home/v2/tabs/crypto/WalletHomeCryptoPresenter;", 0)), Reflection.property1(new PropertyReference1Impl(WalletHomeCryptoFragment.class, "binding", "getBinding()Lorg/telegram/messenger/databinding/ForkFragmentWalletHomeCryptoBinding;", 0)), Reflection.property1(new PropertyReference1Impl(WalletHomeCryptoFragment.class, "mediaEditManager", "getMediaEditManager()Lcom/smedialink/manager/common/MediaEditManager;", 0))};
    ...
    public void showSelectOptionsDialog(String str, String[] strArr, DialogInterface.OnClickListener onClickListener) {
        WalletHomeCryptoView.DefaultImpls.showSelectOptionsDialog(this, str, strArr, onClickListener);
    }
    ...
    public void showQrReceiveDialog(final String address, BlockchainType blockchainType) {
        ...
        QRCodeBottomSheet qRCodeBottomSheet = new QRCodeBottomSheet(address, parentActivity, formatAddressQR) { // from class: com.smedialink.ui.wallet.home.v2.tabs.crypto.WalletHomeCryptoFragment$showQrReceiveDialog$1
    ...
    private final void openNftDetails(View view) {
        ContentPreviewViewer.getInstanceForNft(getMediaEditManager()).showInstantly(view, 0, new ContentPreviewViewer.ContentPreviewViewerDelegate() { // from class: com.smedialink.ui.wallet.home.v2.tabs.crypto.WalletHomeCryptoFragment$openNftDetails$1
    ...
    /* compiled from: WalletHomeCryptoFragment.kt */
    /* renamed from: com.smedialink.ui.wallet.home.v2.tabs.crypto.WalletHomeCryptoFragment$Companion */
    /* loaded from: classes3.dex */
