...
/* renamed from: com.smedialink.ui.wallet.home.v2.tabs.binancepay.history.WalletBinancePayHistoryPresenter$loadTransactions$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C2194x6d7572a3 extends Lambda implements Function1<Result<? extends List<? extends BinanceTransaction>>, Unit> {
    final /* synthetic */ boolean $forceUpdate$inlined;
    final /* synthetic */ WalletBinancePayHistoryPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2194x6d7572a3(WalletBinancePayHistoryPresenter walletBinancePayHistoryPresenter, boolean z) {
        super(1);
    ...
    public final void m1372invoke(Result<? extends List<? extends BinanceTransaction>> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            ((WalletBinancePayHistoryView) this.this$0.getViewState()).showToast(error2.getMessage(resourceManager));
        }
    }
}
