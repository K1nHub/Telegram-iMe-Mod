...
@InjectViewState
/* renamed from: com.smedialink.ui.wallet.home.v2.tabs.crypto.settings.WalletHomeCryptoTokensSettingsPresenter */
    ...
    private final List<SelectableToken> resolveTokens() {
        ...
        if (!(screenType instanceof WalletHomeCryptoTokensSettingsFragment.ScreenType.Binance)) {
            if (screenType instanceof WalletHomeCryptoTokensSettingsFragment.ScreenType.Crypto) {
                ...
                sortedWith = CollectionsKt___CollectionsKt.sortedWith(SelectableMappingKt.mapToSelectable(arrayList, this.resourceManager, this.currentNetworkType), new Comparator() { // from class: com.smedialink.ui.wallet.home.v2.tabs.crypto.settings.WalletHomeCryptoTokensSettingsPresenter$resolveTokens$$inlined$sortedBy$2
        ...
        sortedWith2 = CollectionsKt___CollectionsKt.sortedWith(((WalletHomeCryptoTokensSettingsFragment.ScreenType.Binance) screenType).getTokens(), new Comparator() { // from class: com.smedialink.ui.wallet.home.v2.tabs.crypto.settings.WalletHomeCryptoTokensSettingsPresenter$resolveTokens$$inlined$sortedBy$1
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                int compareValues;
