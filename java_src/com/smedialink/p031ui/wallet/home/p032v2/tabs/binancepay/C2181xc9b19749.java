...
public final class C2181xc9b19749 extends Lambda implements Function1<RxEvent, Unit> {
    final /* synthetic */ WalletHomeBinancePayPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2181xc9b19749(WalletHomeBinancePayPresenter walletHomeBinancePayPresenter) {
        super(1);
    ...
    public final void m1367invoke(RxEvent it) {
