...
public final class C2196x3703ab47 extends Lambda implements Function1<Result<? extends String>, Result<? extends List<BaseNode>>> {
    final /* synthetic */ WalletHomeCryptoPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2196x3703ab47(WalletHomeCryptoPresenter walletHomeCryptoPresenter) {
        super(1);
