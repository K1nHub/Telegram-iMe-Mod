...
public final class BannersRecycleAdapter extends BaseQuickAdapter<SlideItem, BaseViewHolder> {
    ...
    public BannersRecycleAdapter(ResourceManager resourceManager) {
        super(C3301R.layout.fork_recycle_item_wallet_banner_slide, null, 2, null);
    ...
    public final void pauseAnimation() {
        View viewByPosition = getViewByPosition(this.currentAnimatedBanner, C3301R.C3304id.image_banner_image);
    ...
    protected void convert2(BaseViewHolder holder, SlideItem item, List<? extends Object> payloads) {
        ...
        if (firstOrNull instanceof Boolean) {
            BaseQuickAdapterExtKt.applyForView(holder, C3301R.C3304id.image_banner_image, new BannersRecycleAdapter$convert$1$1(firstOrNull));
        }
    }
    ...
    public void convert(BaseViewHolder holder, SlideItem item) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        Intrinsics.checkNotNullParameter(item, "item");
        int i = C3301R.C3304id.card_banner_slide;
        ...
        int i2 = C3301R.C3304id.text_banner_title;
        int i3 = C3301R.C3304id.text_banner_description;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedCardBackground, "chat_messagePanelText", i2, i3), i2).setText(i2, this.resourceManager.getString(item.getSlide().getTitle())).setText(i3, this.resourceManager.getString(item.getSlide().getShortDescription())), C3301R.C3304id.image_banner_image, new BannersRecycleAdapter$convert$2(item, holder, this));
    }
