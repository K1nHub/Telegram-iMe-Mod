...
public enum DrawerAccountData {
    PHONE(C3158R.string.drawer_profile_cell_alert_phone_number),
    USERNAME(C3158R.string.drawer_profile_cell_alert_username),
    NAME(C3158R.string.drawer_profile_cell_alert_name),
    USER_ID(C3158R.string.drawer_profile_cell_alert_user_id);
    ...
    /* compiled from: DrawerAccountData.kt */
    /* renamed from: com.smedialink.ui.drawer.DrawerAccountData$Companion */
    /* loaded from: classes3.dex */
