package com.smedialink.p031ui.smartpanel.view;
...
import com.smedialink.p031ui.smartpanel.adapter.SmartBotContentAdapter;
...
/* renamed from: com.smedialink.ui.smartpanel.view.SmartBotContentView */
...
public final class SmartBotContentView extends FrameLayout implements SmartBotContentAdapter.OnLoadGifListener {
    ...
    /* compiled from: SmartBotContentView.kt */
    /* renamed from: com.smedialink.ui.smartpanel.view.SmartBotContentView$BotResponseType */
    /* loaded from: classes3.dex */
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [com.smedialink.ui.smartpanel.view.SmartBotContentView$gifContextProvider$1] */
    public SmartBotContentView(final Context context, SmartBotTab content, BotResponseType currentBotResponseType, final SmartBotsView.Listener listener, long j) {
        ...
        ExtendedGridLayoutManager extendedGridLayoutManager = new ExtendedGridLayoutManager(context) { // from class: com.smedialink.ui.smartpanel.view.SmartBotContentView$listViewLayoutManager$1
            ...
            protected Size getSizeForItem(int i) {
                ...
                if (media != null) {
                    ...
                    if (tLRPC$Document != null) {
                        ...
                        size3.width = closestPhotoSizeWithSize != null ? closestPhotoSizeWithSize.f1531w : 100;
                        size3.height = closestPhotoSizeWithSize != null ? closestPhotoSizeWithSize.f1530h : 100;
                        ...
                        while (i2 < size4) {
                            ...
                            if ((tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute instanceof TLRPC$TL_documentAttributeVideo)) {
                                ...
                                size5.width = tLRPC$DocumentAttribute.f1511w;
                                size5.height = tLRPC$DocumentAttribute.f1510h;
                                break;
                            }
                            i2++;
                        }
                        ...
                        if (tLRPC$WebDocument != null) {
                            ...
                            while (i2 < size6) {
                                ...
                                if ((tLRPC$DocumentAttribute2 instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute2 instanceof TLRPC$TL_documentAttributeVideo)) {
                                    ...
                                    size7.width = tLRPC$DocumentAttribute2.f1511w;
                                    size7.height = tLRPC$DocumentAttribute2.f1510h;
                                    break;
                                }
                                i2++;
                            }
                            ...
                            if (tLRPC$WebDocument2 != null) {
                                ...
                                while (i2 < size8) {
                                    ...
                                    if ((tLRPC$DocumentAttribute3 instanceof TLRPC$TL_documentAttributeImageSize) || (tLRPC$DocumentAttribute3 instanceof TLRPC$TL_documentAttributeVideo)) {
                                        ...
                                        size9.width = tLRPC$DocumentAttribute3.f1511w;
                                        size9.height = tLRPC$DocumentAttribute3.f1510h;
                                        break;
                                    }
                                    i2++;
                                }
                                ...
                                if (tLRPC$Photo != null) {
                                    ...
                                    if (closestPhotoSizeWithSize2 != null) {
                                        ...
                                        size10.width = closestPhotoSizeWithSize2.f1531w;
                                        size10.height = closestPhotoSizeWithSize2.f1530h;
                                    }
                                }
                            }
                        }
        ...
        this.gifContextProvider = new PhotoViewer.EmptyPhotoViewerProvider() { // from class: com.smedialink.ui.smartpanel.view.SmartBotContentView$gifContextProvider$1
            ...
            */
            public org.telegram.p048ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r5, org.telegram.tgnet.TLRPC$FileLocation r6, int r7, boolean r8) {
                /*
                    r4 = this;
                    r5 = 0
                    if (r7 < 0) goto L83
                    com.smedialink.ui.smartpanel.view.SmartBotContentView r6 = com.smedialink.p031ui.smartpanel.view.SmartBotContentView.this
                    com.smedialink.ui.smartpanel.adapter.SmartBotContentAdapter r6 = com.smedialink.p031ui.smartpanel.view.SmartBotContentView.access$getListViewAdapter$p(r6)
                ...
                L14:
                    ...
                    com.smedialink.ui.smartpanel.view.SmartBotContentView r8 = com.smedialink.p031ui.smartpanel.view.SmartBotContentView.this
                    com.smedialink.ui.smartpanel.adapter.SmartBotContentAdapter r8 = com.smedialink.p031ui.smartpanel.view.SmartBotContentView.access$getListViewAdapter$p(r8)
                ...
                L30:
                    if (r0 >= r6) goto L83
                    com.smedialink.ui.smartpanel.view.SmartBotContentView r1 = com.smedialink.p031ui.smartpanel.view.SmartBotContentView.this
                    org.telegram.ui.Components.RecyclerListView r1 = com.smedialink.p031ui.smartpanel.view.SmartBotContentView.access$getListView$p(r1)
                    android.view.View r1 = r1.getChildAt(r0)
                    boolean r2 = r1 instanceof org.telegram.p048ui.Cells.ContextLinkCell
                    if (r2 == 0) goto L52
                    r2 = r1
                    org.telegram.ui.Cells.ContextLinkCell r2 = (org.telegram.p048ui.Cells.ContextLinkCell) r2
                ...
                L53:
                    ...
                    r5 = r5[r7]
                    r6.viewY = r5
                    com.smedialink.ui.smartpanel.view.SmartBotContentView r5 = com.smedialink.p031ui.smartpanel.view.SmartBotContentView.this
                    org.telegram.ui.Components.RecyclerListView r5 = com.smedialink.p031ui.smartpanel.view.SmartBotContentView.access$getListView$p(r5)
                    r6.parentView = r5
                    r6.imageReceiver = r2
                ...
                L83:
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: com.smedialink.p031ui.smartpanel.view.SmartBotContentView$gifContextProvider$1.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
        ...
        textView.setText(LocaleController.getInternalString(C3301R.string.chat_send_panel_neurobot_not_have_gifs));
        textView.setTextColor(ContextCompat.getColor(context, C3301R.C3302color.gray_message));
        textView.setTextSize(14.0f);
        textView.setVisibility(8);
        recyclerListView.setAdapter(smartBotContentAdapter);
        recyclerListView.setLayoutManager(extendedGridLayoutManager);
        recyclerListView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: com.smedialink.ui.smartpanel.view.SmartBotContentView.1
            ...
            public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
                ...
                if (Intrinsics.areEqual(parent.getLayoutManager(), SmartBotContentView.this.listViewLayoutManager)) {
                    ...
                    if (SmartBotContentView.this.listViewAdapter.getItem(childAdapterPosition) instanceof TabBotMediaAnswerItem) {
                        outRect.top = AndroidUtilities.m51dp(2.0f);
                        outRect.right = SmartBotContentView.this.listViewLayoutManager.isLastInRow(childAdapterPosition) ? 0 : AndroidUtilities.m51dp(2.0f);
                    }
                }
            }
        });
        recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: com.smedialink.ui.smartpanel.view.SmartBotContentView$$ExternalSyntheticLambda0
        ...
        recyclerListView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.smedialink.ui.smartpanel.view.SmartBotContentView.3
        ...
        extendedGridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: com.smedialink.ui.smartpanel.view.SmartBotContentView.4
    ...
    /* compiled from: SmartBotContentView.kt */
    /* renamed from: com.smedialink.ui.smartpanel.view.SmartBotContentView$Companion */
    /* loaded from: classes3.dex */
    ...
    @Override // com.smedialink.p031ui.smartpanel.adapter.SmartBotContentAdapter.OnLoadGifListener
