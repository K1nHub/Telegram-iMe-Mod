...
import com.smedialink.p031ui.twitter.adapter.diff.TweetsDiffCallback;
...
public final class TwitterFragment extends MvpFragment implements TwitterView {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(TwitterFragment.class, "presenter", "getPresenter()Lcom/smedialink/ui/twitter/TwitterPresenter;", 0)), Reflection.property1(new PropertyReference1Impl(TwitterFragment.class, "binding", "getBinding()Lorg/telegram/messenger/databinding/ForkFragmentTwitterBinding;", 0))};
    ...
    private final void setupLoadMore(TweetsRecycleAdapter tweetsRecycleAdapter) {
        ...
        loadMoreModule.setOnLoadMoreListener(new OnLoadMoreListener() { // from class: com.smedialink.ui.twitter.TwitterFragment$$ExternalSyntheticLambda2
    ...
    private final void setupListeners() {
        ...
        tweetsRecycleAdapter.setOnItemChildClickListener(new OnItemChildClickListener() { // from class: com.smedialink.ui.twitter.TwitterFragment$$ExternalSyntheticLambda1
        ...
        getBinding().getRoot().setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.smedialink.ui.twitter.TwitterFragment$$ExternalSyntheticLambda0
    ...
    /* compiled from: TwitterFragment.kt */
    /* renamed from: com.smedialink.ui.twitter.TwitterFragment$Companion */
    /* loaded from: classes3.dex */
