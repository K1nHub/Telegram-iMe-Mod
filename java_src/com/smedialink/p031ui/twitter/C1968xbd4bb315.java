...
public final class C1968xbd4bb315 extends Lambda implements Function1<TweetItem, Unit> {
    final /* synthetic */ TwitterPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1968xbd4bb315(TwitterPresenter twitterPresenter) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(TweetItem tweetItem) {
        m1270invoke(tweetItem);
        return Unit.INSTANCE;
    }

    /* renamed from: invoke  reason: collision with other method in class */
    public final void m1270invoke(TweetItem it) {
