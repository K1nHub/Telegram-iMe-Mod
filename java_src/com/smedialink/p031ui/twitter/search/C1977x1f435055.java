...
public final class C1977x1f435055 extends Lambda implements Function1<Result<? extends List<? extends BaseNode>>, Unit> {
    ...
    public C1977x1f435055(TwitterSearchPresenter twitterSearchPresenter, boolean z, boolean z2) {
        super(1);
    ...
    public final void m1275invoke(Result<? extends List<? extends BaseNode>> it) {
