...
final class TwitterSearchFragment$presenter$2 extends Lambda implements Function0<TwitterSearchPresenter> {
    ...
    /* loaded from: classes3.dex */
    public static final class C19871 extends Lambda implements Function0<ParametersHolder> {
        final /* synthetic */ BlockchainType $blockchainType;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C19871(BlockchainType blockchainType) {
            super(0);
            this.$blockchainType = blockchainType;
        }
    ...
    public final TwitterSearchPresenter invoke() {
        Lazy lazy;
        lazy = LazyKt__LazyJVMKt.lazy(KoinPlatformTools.INSTANCE.defaultLazyMode(), new C1986xf65f4133(this.this$0, null, new C19871(this.$blockchainType)));
