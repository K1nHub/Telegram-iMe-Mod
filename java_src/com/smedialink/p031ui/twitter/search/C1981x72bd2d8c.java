...
/* renamed from: com.smedialink.ui.twitter.search.TwitterSearchPresenter$subscribeToQueryChanges$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C1981x72bd2d8c extends Lambda implements Function1<Result<? extends List<? extends BaseNode>>, Unit> {
    final /* synthetic */ TwitterSearchPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1981x72bd2d8c(TwitterSearchPresenter twitterSearchPresenter) {
        super(1);
    ...
    public final void m1277invoke(Result<? extends List<? extends BaseNode>> it) {
