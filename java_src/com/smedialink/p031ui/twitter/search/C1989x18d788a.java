...
public final class C1989x18d788a extends Lambda implements Function1<Result<? extends TwitterProfileInfo>, Unit> {
    final /* synthetic */ TwitterUserItem $twitterUserItem$inlined;
    final /* synthetic */ TwitterSearchPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1989x18d788a(TwitterUserItem twitterUserItem, TwitterSearchPresenter twitterSearchPresenter) {
        super(1);
    ...
    public final void m1290invoke(Result<? extends TwitterProfileInfo> it) {
        ...
        if (result instanceof Result.Success) {
            if (((TwitterProfileInfo) ((Result.Success) result).getData()).getTelegramUserId() != this.$twitterUserItem$inlined.getUser().f1640id) {
                resourceManager2 = this.this$0.resourceManager;
                ((TwitterSearchView) this.this$0.getViewState()).showToast(resourceManager2.getString(C3301R.string.common_error_unexpected));
                return;
            }
            TwitterSearchPresenter twitterSearchPresenter = this.this$0;
            String valueOf = String.valueOf(this.$twitterUserItem$inlined.getUser().f1640id);
