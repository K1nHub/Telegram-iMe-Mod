...
public final class C1993x2420976b extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ TwitterSearchPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1993x2420976b(TwitterSearchPresenter twitterSearchPresenter) {
        super(1);
    ...
    public final void m1292invoke(Result<? extends Boolean> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            ((TwitterSearchView) this.this$0.getViewState()).showToast(resourceManager3.getString(C3301R.string.twitter_search_invite_success));
            ...
            if (error.getError().getStatus() == FirebaseFunctionsErrorHandler.TwitterErrorStatus.TWITTER_USER_DISABLED_DIRECT_MESSAGES) {
                ...
                ((TwitterSearchView) this.this$0.getViewState()).showToast(resourceManager2.getString(C3301R.string.twitter_search_invite_direct_messages_error));
                return;
            }
