...
public final class TwitterAuthPresenter extends BasePresenter<TwitterAuthView> {
        ...
        if (lastPathSegment != null) {
            ...
            if (hashCode != -1867169789) {
                if (hashCode == 3135262 && lastPathSegment.equals("fail")) {
                    ...
                    failure = (TwitterAuthResult) globalGson.fromJson(globalGson.toJson(linkedHashMap), new TypeToken<TwitterAuthResult.Failure>() { // from class: com.smedialink.ui.twitter.auth.TwitterAuthPresenter$processAuthResult$$inlined$toDataClass$default$2
                    }.getType());
                }
            } else if (lastPathSegment.equals("success")) {
                Gson globalGson2 = GsonExtKt.getGlobalGson();
                failure = (TwitterAuthResult) globalGson2.fromJson(globalGson2.toJson(linkedHashMap), new TypeToken<TwitterAuthResult.Success>() { // from class: com.smedialink.ui.twitter.auth.TwitterAuthPresenter$processAuthResult$$inlined$toDataClass$default$1
                }.getType());
            }
    ...
    /* compiled from: TwitterAuthPresenter.kt */
    /* renamed from: com.smedialink.ui.twitter.auth.TwitterAuthPresenter$Companion */
    /* loaded from: classes3.dex */
