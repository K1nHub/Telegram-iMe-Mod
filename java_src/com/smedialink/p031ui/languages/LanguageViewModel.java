...
public final class LanguageViewModel {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LanguageViewModel) {
            ...
            return Intrinsics.areEqual(this.f369id, languageViewModel.f369id) && Intrinsics.areEqual(this.name, languageViewModel.name) && this.checked == languageViewModel.checked;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f369id.hashCode() * 31) + this.name.hashCode()) * 31;
    ...
    public String toString() {
        return "LanguageViewModel(id=" + this.f369id + ", name=" + this.name + ", checked=" + this.checked + ')';
    }
