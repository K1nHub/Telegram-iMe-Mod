...
/* renamed from: com.smedialink.ui.recognition.RecognitionBottomSheetDialog */
...
public final class RecognitionBottomSheetDialog extends MvpBottomSheet {
    ...
    /* compiled from: RecognitionBottomSheetDialog.kt */
    /* renamed from: com.smedialink.ui.recognition.RecognitionBottomSheetDialog$TranslationDelegate */
    /* loaded from: classes3.dex */
    ...
    */
    public RecognitionBottomSheetDialog(org.telegram.p048ui.ActionBar.BaseFragment r3, java.lang.String r4, com.smedialink.p031ui.recognition.RecognitionBottomSheetDialog.TranslationDelegate r5, int r6, int r7) {
        /*
            r2 = this;
            ...
            com.smedialink.ui.recognition.RecognitionBottomSheetDialog$special$$inlined$inject$default$1 r4 = new com.smedialink.ui.recognition.RecognitionBottomSheetDialog$special$$inlined$inject$default$1
            r5 = 0
            r4.<init>(r2, r5, r5)
            kotlin.Lazy r3 = kotlin.LazyKt.lazy(r3, r4)
            r2.resourceManager$delegate = r3
            com.smedialink.ui.recognition.RecognitionBottomSheetDialog$binding$2 r3 = new com.smedialink.ui.recognition.RecognitionBottomSheetDialog$binding$2
            r3.<init>(r2)
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.p031ui.recognition.RecognitionBottomSheetDialog.<init>(org.telegram.ui.ActionBar.BaseFragment, java.lang.String, com.smedialink.ui.recognition.RecognitionBottomSheetDialog$TranslationDelegate, int, int):void");
    }
    ...
    private final void setupStyles() {
        ...
        ForkTextRecognitionContentLayoutBinding binding = getBinding();
        binding.textRecognitionContainer.setBackgroundColor(Theme.getColor("windowBackgroundWhite"));
        ...
        ViewExtKt.setImageColor(imageClose, Theme.getColor("chat_status"));
        binding.textCompany.setTextColor(Theme.getColor("chat_status"));
        ...
        ViewExtKt.setImageColor(imageServiceLogo, Theme.getColor("chat_status"));
        ...
        ViewExtKt.setImageColor(imageCopy, Theme.getColor("chats_actionBackground"));
        AppCompatImageView imageShare = binding.imageShare;
        Intrinsics.checkNotNullExpressionValue(imageShare, "imageShare");
        ViewExtKt.setImageColor(imageShare, Theme.getColor("chats_actionBackground"));
        ...
        ViewExtKt.setImageColor(imageTranslate, Theme.getColor("chats_actionBackground"));
    ...
    /* compiled from: RecognitionBottomSheetDialog.kt */
    /* renamed from: com.smedialink.ui.recognition.RecognitionBottomSheetDialog$Companion */
    /* loaded from: classes3.dex */
