...
/* renamed from: com.smedialink.ui.recognition.PhotoViewerPresenter$getPhotoObjects$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C1957x1018a95b extends Lambda implements Function1<Result<? extends List<? extends RecognizedImageModel>>, Unit> {
    final /* synthetic */ PhotoViewerPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1957x1018a95b(PhotoViewerPresenter photoViewerPresenter) {
        super(1);
    ...
    public final void m1257invoke(Result<? extends List<? extends RecognizedImageModel>> it) {
