...
public final class C1954x3fabecbe extends Lambda implements Function1<TLRPC$messages_BotResults, Result<? extends TLRPC$messages_BotResults>> {
    public static final C1954x3fabecbe INSTANCE = new C1954x3fabecbe();

    public C1954x3fabecbe() {
        super(1);
    }
