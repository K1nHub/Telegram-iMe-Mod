...
public final class C1941x3fabecbf extends Lambda implements Function1<Throwable, Result<? extends TLRPC$messages_BotResults>> {
    public static final C1941x3fabecbf INSTANCE = new C1941x3fabecbf();

    public C1941x3fabecbf() {
        super(1);
    }
