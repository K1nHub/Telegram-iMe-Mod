...
/* renamed from: com.smedialink.ui.translate.TranslationPresenter$loadLanguages$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C1973xba424fcb extends Lambda implements Function1<Result<? extends List<TranslationLanguage>>, Unit> {
    final /* synthetic */ boolean $isSourceLanguage$inlined;
    final /* synthetic */ TranslationPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1973xba424fcb(TranslationPresenter translationPresenter, boolean z) {
        super(1);
    ...
    public final void m1281invoke(Result<? extends List<TranslationLanguage>> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            ((TranslationView) this.this$0.getViewState()).showToast(error.getMessage(resourceManager));
        }
    }
}
