...
public final class C1959xba424fcb extends Lambda implements Function1<Result<? extends List<TranslationLanguage>>, Unit> {
    final /* synthetic */ boolean $isSourceLanguage$inlined;
    final /* synthetic */ TranslationPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1959xba424fcb(TranslationPresenter translationPresenter, boolean z) {
        super(1);
    ...
    public final void m1265invoke(Result<? extends List<TranslationLanguage>> it) {
