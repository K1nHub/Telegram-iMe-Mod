...
public final class StakingProgrammeProvider extends BaseNodeProvider<StakingProgrammeItem> {
    ...
    public void convert(BaseViewHolder helper, StakingProgrammeItem item) {
        ...
        int i2 = C3301R.C3304id.staking_info;
        ...
        int i4 = C3301R.C3304id.text_account_balance;
        int i5 = C3301R.C3304id.text_staking_end_value;
        ...
        int i6 = C3301R.C3304id.text_apr_value;
        ...
        int i7 = C3301R.C3304id.text_apy_value;
        ...
        int i8 = C3301R.C3304id.text_account_balance_in_dollars;
        ...
        int i9 = C3301R.C3304id.text_apy_title;
        int i10 = C3301R.C3304id.text_apr_title;
        int i11 = C3301R.C3304id.text_staking_end_title;
        BaseViewHolder imageResource = BaseQuickAdapterExtKt.setMediumTypeface(BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor5, "windowBackgroundWhiteGrayText", i9, i10, i11), i4, i8, i9, i10, i11, i7, i6, i5).setImageResource(C3301R.C3304id.image_coin_icon, TokenInfoExtKt.getLogo(item.getTokenBalance().getInfo(), item.getTokenBalance().getNetworkType()));
        int i12 = C3301R.C3304id.image_network_icon;
        BaseViewHolder text = imageResource.setImageResource(i12, item.getTokenBalance().getNetworkType().getLogo()).setText(i9, this.resourceManager.getString(C3301R.string.staking_programme_apy));
        BaseViewHolder text2 = text.setText(i7, item.getApy() + '%').setText(i10, this.resourceManager.getString(C3301R.string.staking_programme_apr));
        BaseViewHolder gone = BaseQuickAdapterExtKt.setGone(text2.setText(i6, item.getApr() + '%').setText(i11, this.resourceManager.getString(C3301R.string.staking_programme_expires)).setText(i5, item.getEndsAt()).setText(i3, item.getName()).setText(i4, TokenBalanceExtKt.getTotalBalance(item.getTokenBalance())).setText(i8, TokenBalanceExtKt.getDollarsBalanceText(item.getTokenBalance(), this.resourceManager)).setVisible(i12, true).setVisible(i2, true), !item.isParticipated(), i4, i8);
        BalanceFormatter balanceFormatter = BalanceFormatter.INSTANCE;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setGone(BaseQuickAdapterExtKt.setGone(gone, NumberExtKt.isZero(balanceFormatter.parseFormattedString(item.getApy())), i9, i7), NumberExtKt.isZero(balanceFormatter.parseFormattedString(item.getApr())), i10, i6), C3301R.C3304id.text_coin_ticker, new StakingProgrammeProvider$convert$1$1(item, this)), i12, new StakingProgrammeProvider$convert$1$2(this));
    }
    ...
    public void convert(BaseViewHolder helper, StakingProgrammeItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.setThemedTextColor(BaseQuickAdapterExtKt.setThemedTextColor(helper.setText(C3301R.C3304id.text_account_balance, TokenBalanceExtKt.getTotalBalance(item.getTokenBalance())).setText(C3301R.C3304id.text_account_balance_in_dollars, TokenBalanceExtKt.getDollarsBalanceText(item.getTokenBalance(), this.resourceManager)).setImageResource(C3301R.C3304id.image_coin_icon, TokenInfoExtKt.getLogo(item.getTokenBalance().getInfo(), item.getTokenBalance().getNetworkType())), C3301R.C3304id.text_apr_value, item.getPercentageTextColor(StakingAnnualPercentageMode.APR)), C3301R.C3304id.text_apy_value, item.getPercentageTextColor(StakingAnnualPercentageMode.APY));
    }
}
