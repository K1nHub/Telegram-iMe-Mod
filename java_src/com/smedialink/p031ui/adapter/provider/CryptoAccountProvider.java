...
/* renamed from: com.smedialink.ui.adapter.provider.CryptoAccountProvider */
...
public final class CryptoAccountProvider extends BaseNodeProvider<CryptoAccountItem> {
    ...
    public CryptoAccountProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3158R.layout.fork_recycle_item_wallet_account;
    }
    ...
    public void convert(BaseViewHolder helper, CryptoAccountItem item) {
        ...
        BaseViewHolder themedCardBackground = BaseQuickAdapterExtKt.setThemedCardBackground(helper, C3158R.C3161id.card_crypto_account, "windowBackgroundWhite");
        int i = C3158R.C3161id.text_account_id;
        BaseViewHolder themedTextColor = BaseQuickAdapterExtKt.setThemedTextColor(themedCardBackground, i, "chat_messagePanelText");
        int i2 = C3158R.C3161id.text_account_name;
        BaseViewHolder themedTextColor2 = BaseQuickAdapterExtKt.setThemedTextColor(themedTextColor, i2, "chats_actionBackground");
        int i3 = C3158R.C3161id.image_copy;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setCircleRippleBackground(BaseQuickAdapterExtKt.setThemedImageColor(themedTextColor2, i3, "dialogIcon"), i3).setText(i2, this.resourceManager.getString(C3158R.string.wallet_home_crypto_account_telegram_id, Long.valueOf(item.getUser().f1633id))).setText(i, StringExtKt.shortened$default(item.getAddress(), 0, 1, null)), C3158R.C3161id.item_more_options, new CryptoAccountProvider$convert$1(this, item)), C3158R.C3161id.image_account_avatar, new CryptoAccountProvider$convert$2(item)), C3158R.C3161id.horizontal_action_buttons, new CryptoAccountProvider$convert$3(item));
    }
    ...
    public void convert(BaseViewHolder helper, CryptoAccountItem item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper.setText(C3158R.C3161id.text_account_id, StringExtKt.shortened$default(item.getAddress(), 0, 1, null)), C3158R.C3161id.item_more_options, new CryptoAccountProvider$convert$4(this, item));
    }
    ...
    public final void setupMenuItems(ActionBarMenuItem actionBarMenuItem, NetworkType networkType, String str) {
        ...
        if (networkType == NetworkType.THE_OPEN_NETWORK) {
            ...
            checkBoxCell.setText(Intrinsics.stringPlus(this.resourceManager.getString(C3158R.string.wallet_ton_address_v3r2), " "), StringExtKt.shortened(str, 4), true, false);
        ...
        actionBarMenuItem.addSubItem(i2, scannerIcon, resourceManager.getString(C3158R.string.wallet_transaction_details_action_open_etherscan, resourceManager.getString(networkType.getScannerName())));
    }
}
