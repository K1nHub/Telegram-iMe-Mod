...
public final class BannerProvider extends BaseNodeProvider<BannerItem> {
    ...
    public BannerProvider(BannersRecycleAdapter bannersRecycleAdapter) {
        ...
        this.layoutId = C3301R.layout.fork_recycle_item_wallet_banners;
    ...
    public final void onViewRecycled(BaseViewHolder holder) {
        ...
        if (BaseQuickAdapterExtKt.isViewType(holder, getItemViewType())) {
            RecyclerView.LayoutManager layoutManager = ((RecyclerView) holder.getView(C3301R.C3304id.recycle_banners)).getLayoutManager();
    ...
    public void convert(BaseViewHolder helper, BannerItem item) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.applyForView(helper, C3301R.C3304id.recycle_banners, new BannerProvider$convert$1(this, item)), C3301R.C3304id.banner_slide_indicator, new BannerProvider$convert$2(helper));
    }
}
