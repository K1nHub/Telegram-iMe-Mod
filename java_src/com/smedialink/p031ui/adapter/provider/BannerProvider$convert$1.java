...
/* renamed from: com.smedialink.ui.adapter.provider.BannerProvider$convert$1 */
...
public final class BannerProvider$convert$1 extends Lambda implements Function1<RecyclerView, Unit> {
    ...
    public final void invoke2(RecyclerView applyForView) {
        ...
        RecycleViewExtKt.attachSnapHelperWithListener$default(applyForView, pagerSnapHelper, null, new OnSnapPositionChangeListener() { // from class: com.smedialink.ui.adapter.provider.BannerProvider$convert$1.3
            @Override // com.smedialink.utils.listeners.OnSnapPositionChangeListener
