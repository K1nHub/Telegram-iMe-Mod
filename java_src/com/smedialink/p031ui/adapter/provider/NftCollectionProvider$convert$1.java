...
/* renamed from: com.smedialink.ui.adapter.provider.NftCollectionProvider$convert$1 */
...
public final class NftCollectionProvider$convert$1 extends Lambda implements Function1<BackupImageView, Unit> {
    ...
    public final void invoke2(BackupImageView applyForView) {
        ...
        applyForView.setRoundRadius((int) resourceManager.getDimens(C3158R.dimen.telegram_avatar_size_medium));
        NftTokenItem nftTokenItem = (NftTokenItem) CollectionsKt.firstOrNull(this.$item.getTokens());
        String str = null;
        if (nftTokenItem != null && (token = nftTokenItem.getToken()) != null) {
            str = token.getImage();
        }
        if (str == null) {
            str = "";
        }
        applyForView.setImage(str, "50_50", str, "50_50");
    }
}
