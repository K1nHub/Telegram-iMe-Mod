...
/* renamed from: com.smedialink.ui.adapter.provider.TweetDatesProvider$convert$1 */
...
final class TweetDatesProvider$convert$1 extends Lambda implements Function1<TextView, Unit> {
    ...
    public final void invoke2(final TextView applyForView) {
        ...
        applyForView.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.smedialink.ui.adapter.provider.TweetDatesProvider$convert$1$invoke$$inlined$doOnLayout$1
