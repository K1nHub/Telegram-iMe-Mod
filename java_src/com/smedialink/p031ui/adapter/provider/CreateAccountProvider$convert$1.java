...
/* renamed from: com.smedialink.ui.adapter.provider.CreateAccountProvider$convert$1 */
/* loaded from: classes3.dex */
final class CreateAccountProvider$convert$1 extends Lambda implements Function1<HorizontalActionButtonsView, Unit> {
    final /* synthetic */ AccountItem.Create $item;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CreateAccountProvider$convert$1(AccountItem.Create create) {
        super(1);
        this.$item = create;
    }
