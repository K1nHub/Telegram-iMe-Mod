...
/* renamed from: com.smedialink.ui.adapter.provider.BinanceTransactionProvider$convert$1 */
...
final class BinanceTransactionProvider$convert$1 extends Lambda implements Function1<TimeWithClockView, Unit> {
    ...
    public BinanceTransactionProvider$convert$1(BinanceTransactionItem binanceTransactionItem) {
        super(1);
        this.$item = binanceTransactionItem;
    }
