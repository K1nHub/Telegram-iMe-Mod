...
/* renamed from: com.smedialink.ui.adapter.provider.HeaderWithNetworkSwitcherProvider$convert$1 */
...
public final class HeaderWithNetworkSwitcherProvider$convert$1 extends Lambda implements Function1<NetworkTypeView, Unit> {
    ...
    public final void invoke2(NetworkTypeView applyForView) {
        ...
        if (ViewCompat.isLaidOut(applyForView) && !applyForView.isLayoutRequested()) {
            ...
            applyForView.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.smedialink.ui.adapter.provider.HeaderWithNetworkSwitcherProvider$convert$1$invoke$$inlined$doOnLayout$1
