...
public final class StakingOperationProvider extends BaseNodeProvider<StakingOperationItem> {
    ...
    public StakingOperationProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3158R.layout.fork_recycle_item_wallet_transaction;
    ...
    public void convert(BaseViewHolder helper, StakingOperationItem item) {
        ...
        int i7 = C3158R.C3161id.image_staking_icon;
        BaseViewHolder mediumTypeface = BaseQuickAdapterExtKt.setMediumTypeface(visibleElseGone.setVisible(i7, item.isBadgeVisible()).setImageResource(C3158R.C3161id.image_transaction_type_icon, item.getIcon()).setImageResource(i7, item.getStakingIconResId()), i3);
