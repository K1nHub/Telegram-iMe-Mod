...
public final class CreateAccountProvider extends BaseNodeProvider<AccountItem.Create> {
    ...
    private final int layoutId = C3286R.layout.fork_recycle_item_wallet_dashboard_account_empty;
    ...
    public void convert(BaseViewHolder helper, AccountItem.Create item) {
        ...
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setForeground(BaseQuickAdapterExtKt.setAlpha(BaseQuickAdapterExtKt.setThemedCardBackground(helper, i, "windowBackgroundWhite"), C3286R.C3289id.frame_root, 1.0f), i, Theme.getSelectorDrawable(false)), C3286R.C3289id.horizontal_action_buttons, new CreateAccountProvider$convert$1(item));
    }
    ...
    public void convert(BaseViewHolder helper, AccountItem.Create item, List<? extends Object> payloads) {
        ...
        BaseQuickAdapterExtKt.applyForView(helper, C3286R.C3289id.horizontal_action_buttons, new CreateAccountProvider$convert$2(item));
    }
}
