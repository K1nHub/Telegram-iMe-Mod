...
public final class SelectableHeaderProvider extends BaseNodeProvider<SelectableHeaderItem> {
    ...
    public SelectableHeaderProvider(ResourceManager resourceManager) {
        ...
        this.layoutId = C3286R.layout.fork_recycle_item_wallet_dashboard_header_with_icon;
    }
    ...
    public void convert(BaseViewHolder helper, SelectableHeaderItem item) {
        ...
        int i2 = C3286R.C3289id.header_info_icon;
        BaseQuickAdapterExtKt.applyForView(BaseQuickAdapterExtKt.setThemedImageColor(text.setImageResource(i2, item.getIcon()), i2, "windowBackgroundWhiteGrayText2"), C3286R.C3289id.linear_root, new SelectableHeaderProvider$convert$1(this, item, helper));
    }
    ...
    public void convert(BaseViewHolder helper, SelectableHeaderItem item, List<? extends Object> payloads) {
        ...
        helper.setText(C3286R.C3289id.text_wallet_header, this.resourceManager.getString(item.getTitleResId()));
    }
}
