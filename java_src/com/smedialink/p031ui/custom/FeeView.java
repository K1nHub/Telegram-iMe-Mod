...
import com.smedialink.mapper.crypto.FeeUiMappingKt;
...
/* renamed from: com.smedialink.ui.custom.FeeView */
...
public final class FeeView extends FrameLayout implements KoinComponent {
    ...
    public final void displayFee(GasPriceItem gasPriceItem) {
        ...
        forkContentFeeBinding.textTimeValue.setText(getResourceManager().getString(C3301R.string.wallet_swap_process_fee_duration_value, Integer.valueOf(gasPriceItem.getInfo().getDuration())));
    }
    ...
    private final void setupTexts() {
        ForkContentFeeBinding forkContentFeeBinding = this.binding;
        forkContentFeeBinding.textFeeTitle.setText(getResourceManager().getString(C3301R.string.wallet_swap_process_fee_price));
        forkContentFeeBinding.textTimeTitle.setText(getResourceManager().getString(C3301R.string.wallet_swap_process_fee_duration));
    }

    /* compiled from: FeeView.kt */
    /* renamed from: com.smedialink.ui.custom.FeeView$ChooseFeeType */
    /* loaded from: classes3.dex */
    public static abstract class ChooseFeeType {
        ...
        /* compiled from: FeeView.kt */
        /* renamed from: com.smedialink.ui.custom.FeeView$ChooseFeeType$Custom */
        /* loaded from: classes3.dex */
        ...
        /* compiled from: FeeView.kt */
        /* renamed from: com.smedialink.ui.custom.FeeView$ChooseFeeType$Default */
        /* loaded from: classes3.dex */
