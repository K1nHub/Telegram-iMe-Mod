...
/* renamed from: com.smedialink.ui.custom.cells.TextDetailWithRankCell */
...
public final class TextDetailWithRankCell extends TextDetailCell {
    ...
    public TextDetailWithRankCell(Context context) {
        super(context);
        Lazy lazy;
        Intrinsics.checkNotNullParameter(context, "context");
        lazy = LazyKt__LazyJVMKt.lazy(new TextDetailWithRankCell$badgeView$2(context));
    ...
    /* compiled from: TextDetailWithRankCell.kt */
    /* renamed from: com.smedialink.ui.custom.cells.TextDetailWithRankCell$Companion */
    /* loaded from: classes3.dex */
