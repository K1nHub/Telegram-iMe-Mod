...
/* renamed from: com.smedialink.ui.base.mvp.MvpAlertDialog */
...
public abstract class MvpAlertDialog extends AlertDialog implements MvpDelegateHolder, KoinComponent, BaseView {
    ...
    public MvpAlertDialog(Context context) {
        ...
        this.mvpBaseDelegate = new MvpBaseDelegate<MvpAlertDialog>() { // from class: com.smedialink.ui.base.mvp.MvpAlertDialog$mvpBaseDelegate$1
    ...
    @Override // org.telegram.p048ui.ActionBar.AlertDialog, android.app.Dialog
