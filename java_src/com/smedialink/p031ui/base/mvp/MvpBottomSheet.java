...
/* renamed from: com.smedialink.ui.base.mvp.MvpBottomSheet */
...
public abstract class MvpBottomSheet extends BottomSheet implements MvpDelegateHolder, KoinComponent, BaseView {
    ...
    public MvpBottomSheet(Context context, boolean z) {
        ...
        this.mvpBaseDelegate = new MvpBaseDelegate<MvpBottomSheet>() { // from class: com.smedialink.ui.base.mvp.MvpBottomSheet$mvpBaseDelegate$1
