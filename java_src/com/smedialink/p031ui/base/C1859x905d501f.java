...
public final class C1859x905d501f extends Lambda implements Function1<RxEvent, Unit> {
    final /* synthetic */ WalletAuthFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1859x905d501f(WalletAuthFragment walletAuthFragment) {
        super(1);
    ...
    public final void m1199invoke(RxEvent it) {
