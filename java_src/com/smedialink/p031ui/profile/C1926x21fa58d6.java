...
public final class C1926x21fa58d6 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ ProfilePresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1926x21fa58d6(ProfilePresenter profilePresenter) {
        super(1);
    ...
    public final void m1234invoke(Result<? extends Boolean> it) {
