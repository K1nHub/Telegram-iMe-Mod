...
public final class C1928x99db2a72 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ ProfilePresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1928x99db2a72(ProfilePresenter profilePresenter) {
        super(1);
    ...
    public final void m1235invoke(Result<? extends Boolean> it) {
