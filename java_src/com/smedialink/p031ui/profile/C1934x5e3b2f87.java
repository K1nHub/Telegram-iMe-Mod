...
public final class C1934x5e3b2f87 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ ProfilePresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1934x5e3b2f87(ProfilePresenter profilePresenter) {
        super(1);
    ...
    public final void m1238invoke(Result<? extends Boolean> it) {
