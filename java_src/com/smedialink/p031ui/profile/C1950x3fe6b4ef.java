...
public final class C1950x3fe6b4ef extends Lambda implements Function1<Result<? extends SessionTokens>, Unit> {
    final /* synthetic */ ProfilePresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1950x3fe6b4ef(ProfilePresenter profilePresenter) {
        super(1);
    ...
    public final void m1255invoke(Result<? extends SessionTokens> it) {
