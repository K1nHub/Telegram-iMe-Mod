...
import com.smedialink.model.catalog.CatalogNavigationTab;
...
import com.smedialink.p031ui.catalog.tabs.all.CatalogAllFragment;
import com.smedialink.p031ui.catalog.tabs.categories.CatalogCategoriesFragment;
import com.smedialink.p031ui.catalog.tabs.user_channels.CatalogUserChannelsFragment;
import com.smedialink.p031ui.wallet.common.BottomNavigationTabFragment;
...
/* renamed from: com.smedialink.ui.catalog.tabs.CatalogFragment */
...
public final class CatalogFragment extends BottomNavigationTabFragment implements CatalogView, NavigationViewConfiguration, TabbedViewPagerDelegate<TabbedFragmentPage<CatalogTabFragment>> {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(CatalogFragment.class, "presenter", "getPresenter()Lcom/smedialink/ui/catalog/tabs/CatalogPresenter;", 0)), Reflection.property1(new PropertyReference1Impl(CatalogFragment.class, "binding", "getBinding()Lorg/telegram/messenger/databinding/ForkFragmentCatalogTabsBinding;", 0))};
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayListOf = CollectionsKt__CollectionsKt.arrayListOf(new ThemeDescription(getBinding().getRoot(), ThemeDescription.FLAG_BACKGROUND, null, null, null, new ThemeDescription.ThemeDescriptionDelegate() { // from class: com.smedialink.ui.catalog.tabs.CatalogFragment$$ExternalSyntheticLambda0
    ...
    public final List<CatalogNavigationTab> initPageTabs() {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new CatalogNavigationTab[]{new CatalogNavigationTab(C3158R.C3161id.catalog_all, new TabbedFragmentPage(getResourceManager().getString(C3158R.string.catalog_all), 0, CatalogAllFragment.Companion.newInstance(this.chatType), new CatalogFragment$initPageTabs$1(this), 2, null)), new CatalogNavigationTab(C3158R.C3161id.catalog_categories, new TabbedFragmentPage(getResourceManager().getString(C3158R.string.catalog_categories), 0, CatalogCategoriesFragment.Companion.newInstance(this.chatType), new CatalogFragment$initPageTabs$2(this), 2, null)), new CatalogNavigationTab(C3158R.C3161id.catalog_user_channels, new TabbedFragmentPage(getResourceManager().getString(C3158R.string.catalog_user_channels), 0, CatalogUserChannelsFragment.Companion.newInstance(this.chatType), new CatalogFragment$initPageTabs$3(this), 2, null))});
    ...
    /* compiled from: CatalogFragment.kt */
    /* renamed from: com.smedialink.ui.catalog.tabs.CatalogFragment$Companion */
    /* loaded from: classes3.dex */
