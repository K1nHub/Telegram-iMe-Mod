...
/* renamed from: com.smedialink.ui.catalog.details.ChannelDetailsPresenter$onSubscribeClick$$inlined$subscribeWithErrorHandle$default$1 */
/* loaded from: classes3.dex */
public final class C1868x14036c9b extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ ChannelDetailsPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1868x14036c9b(ChannelDetailsPresenter channelDetailsPresenter) {
        super(1);
    ...
    public final void m1203invoke(Boolean it) {
