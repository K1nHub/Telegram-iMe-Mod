...
public final class C1908xfa8e68f4 extends Lambda implements Function1<Result<? extends Boolean>, Unit> {
    final /* synthetic */ ChatPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1908xfa8e68f4(ChatPresenter chatPresenter) {
        super(1);
    ...
    public final void m1232invoke(Result<? extends Boolean> it) {
