        ...
        if (UserUtils.isUserActive(Long.parseLong((String) obj2))) {
            switch (WhenMappings.$EnumSwitchMapping$0[NotificationType.Companion.map(str).ordinal()]) {
                case 1:
                    ...
                    return (PushNotificationModel) globalGson.fromJson(globalGson.toJson(map), new TypeToken<PushNotificationModel.Cancel>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$1
                    }.getType());
                case 2:
                    Gson globalGson2 = GsonExtKt.getGlobalGson();
                    return (PushNotificationModel) globalGson2.fromJson(globalGson2.toJson(map), new TypeToken<PushNotificationModel.CryptoTransfer.Out>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$2
                    }.getType());
                case 3:
                ...
                case 4:
                    ...
                    return (PushNotificationModel) globalGson4.fromJson(globalGson4.toJson(map), new TypeToken<PushNotificationModel.Donation.Out>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$4
                    }.getType());
                case 5:
                ...
                case 6:
                    ...
                    return (PushNotificationModel) globalGson6.fromJson(globalGson6.toJson(map), new TypeToken<PushNotificationModel.Simplex>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$6
                    }.getType());
                case 7:
                    Gson globalGson7 = GsonExtKt.getGlobalGson();
                    return (PushNotificationModel) globalGson7.fromJson(globalGson7.toJson(map), new TypeToken<PushNotificationModel.BinancePayRequestCreated>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$7
                    }.getType());
                case 8:
                    Gson globalGson8 = GsonExtKt.getGlobalGson();
                    return (PushNotificationModel) globalGson8.fromJson(globalGson8.toJson(map), new TypeToken<PushNotificationModel.BinancePayRequestStatusUpdated>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$8
                    }.getType());
                case 9:
                    Gson globalGson9 = GsonExtKt.getGlobalGson();
                    return (PushNotificationModel) globalGson9.fromJson(globalGson9.toJson(map), new TypeToken<PushNotificationModel.Approve>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$9
                    }.getType());
                case 10:
                    Gson globalGson10 = GsonExtKt.getGlobalGson();
                    return (PushNotificationModel) globalGson10.fromJson(globalGson10.toJson(map), new TypeToken<PushNotificationModel.StakingSafeWithdrawalStarted>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$10
                    }.getType());
                case 11:
                    Gson globalGson11 = GsonExtKt.getGlobalGson();
                    return (PushNotificationModel) globalGson11.fromJson(globalGson11.toJson(map), new TypeToken<PushNotificationModel.StakingSafeWithdrawalFinished>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$11
                    }.getType());
                case 12:
                    Gson globalGson12 = GsonExtKt.getGlobalGson();
                    return (PushNotificationModel) globalGson12.fromJson(globalGson12.toJson(map), new TypeToken<PushNotificationModel.StakingStarted>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$12
                    }.getType());
                case 13:
                    Gson globalGson13 = GsonExtKt.getGlobalGson();
                    return (PushNotificationModel) globalGson13.fromJson(globalGson13.toJson(map), new TypeToken<PushNotificationModel.StakingFinished>() { // from class: com.smedialink.manager.notifications.PushNotificationsManager$convertMapParamsToModel$$inlined$toDataClass$default$13
                    }.getType());
                default:
                    return null;
            }
