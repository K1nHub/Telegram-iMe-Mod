package com.smedialink.manager.contacts;
...
public final class SelectedContactsDataStore {
    ...
    public final synchronized List<Long> getSelectedIdsAsList() {
        Sequence asSequence;
        List<Long> list;
        asSequence = SequencesKt__SequencesKt.asSequence(new LongIterator() { // from class: com.smedialink.manager.contacts.SelectedContactsDataStore$getSelectedIdsAsList$1
            private int index;
