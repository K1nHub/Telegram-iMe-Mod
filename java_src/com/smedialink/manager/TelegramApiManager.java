...
public final class TelegramApiManager implements TelegramApi {
    ...
    public static final void getChatInfoByUsername$lambda$1(final TelegramApiManager this$0, String correctUsername, final ObservableEmitter emitter) {
        ...
        ConnectionsManager.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).sendRequest(tLRPC$TL_contacts_resolveUsername, new RequestDelegate() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda17
    ...
    public Observable<List<TLRPC$User>> getUsersByIds(final List<Long> usersIds) {
        ...
        Observable<List<TLRPC$User>> subscribeOn = Observable.create(new ObservableOnSubscribe() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda6
            @Override // io.reactivex.ObservableOnSubscribe
            public final void subscribe(ObservableEmitter observableEmitter) {
    ...
    public static final void getUsersByIds$lambda$7(List usersIds, final TelegramApiManager this$0, final ObservableEmitter emitter) {
        ...
        tLRPC$TL_users_getUsers.f1636id = CollectionsUtilsKt.toArrayList(arrayList);
        ConnectionsManager.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).sendRequest(tLRPC$TL_users_getUsers, new RequestDelegate() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda16
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public static final void subscribeToChannel$lambda$11(final TLRPC$Chat channel, TelegramApiManager this$0, final ObservableEmitter emitter) {
        ...
        if (ChatObject.isNotInChat(channel)) {
            MessagesController.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).addUserToChat(channel.f1499id, UserConfig.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).getCurrentUser(), 0, null, null, new Runnable() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda10
    ...
    public Observable<TLRPC$Chat> unsubscribeFromChannel(final TLRPC$Chat channel) {
        Intrinsics.checkNotNullParameter(channel, "channel");
        Observable<TLRPC$Chat> subscribeOn = Observable.create(new ObservableOnSubscribe() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda8
            @Override // io.reactivex.ObservableOnSubscribe
            public final void subscribe(ObservableEmitter observableEmitter) {
    ...
    public static final void unsubscribeFromChannel$lambda$13(final TLRPC$Chat channel, TelegramApiManager this$0, final ObservableEmitter emitter) {
        ...
        MessagesController.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).deleteParticipantFromChat(channel.f1499id, UserConfig.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).getCurrentUser(), channel, false, false, new Runnable() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static final void acceptUrlAuth$lambda$16(TelegramApiManager this$0, TLRPC$TL_messages_acceptUrlAuth req, final String buttonUrl, final TLRPC$TL_messages_requestUrlAuth buttonReq, final ObservableEmitter emitter) {
        ...
        Intrinsics.checkNotNullParameter(buttonReq, "$buttonReq");
        Intrinsics.checkNotNullParameter(emitter, "emitter");
        ConnectionsManager.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).sendRequest(req, new RequestDelegate() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda18
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public static final void getInlineBot$lambda$19(TelegramApiManager this$0, TLRPC$TL_messages_getInlineBotResults req, final ObservableEmitter emitter) {
        ...
        Intrinsics.checkNotNullParameter(req, "$req");
        Intrinsics.checkNotNullParameter(emitter, "emitter");
        ConnectionsManager.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).sendRequest(req, new RequestDelegate() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda15
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public Observable<Boolean> unblockPeer(long j) {
        ...
        tLRPC$TL_contacts_unblock.f1549id = inputPeer;
    ...
    public static final void getMessageLinkPattern$lambda$28(TelegramApiManager this$0, MessageObject message, TLRPC$Chat currentChat, final ObservableEmitter emitter) {
        ...
        tLRPC$TL_channels_exportMessageLink.f1537id = message.getId();
    ...
    public static final void getMessageLinkPattern$lambda$28$lambda$27(final ObservableEmitter emitter, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        Intrinsics.checkNotNullParameter(emitter, "$emitter");
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static final void deleteUsers$lambda$30(TelegramApiManager this$0, ArrayList users, final CompletableEmitter source) {
        ...
        ContactsController.getInstance(this$0.telegramGateway.getSelectedAccountIndex()).deleteContact(users, false, new Callbacks$Callback1() { // from class: com.smedialink.manager.TelegramApiManager$$ExternalSyntheticLambda12
