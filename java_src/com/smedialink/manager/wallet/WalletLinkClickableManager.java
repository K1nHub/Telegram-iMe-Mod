...
public final class WalletLinkClickableManager {
    ...
    private final String[] getUserIdAlertOptions(long j) {
        ...
        pairArr[0] = this.telegramGateway.hasUser(j) ? TuplesKt.m99to(this.resourceManager.getString(C3301R.string.wallet_user_id_dialog_go_to_profile_action), new WalletLinkClickableManager$getUserIdAlertOptions$1(this, j)) : null;
        pairArr[1] = TuplesKt.m99to(this.resourceManager.getString(C3301R.string.wallet_user_id_dialog_copy_id_action), new WalletLinkClickableManager$getUserIdAlertOptions$2(this, j));
        pairArr[2] = TuplesKt.m99to(this.resourceManager.getString(C3301R.string.wallet_user_id_dialog_transfer_action), new WalletLinkClickableManager$getUserIdAlertOptions$3(this, j));
    ...
    private final String[] getAddressAlertOptions(String str) {
        ...
        pairArr[0] = TuplesKt.m99to(this.resourceManager.getString(C3301R.string.wallet_token_details_action_copy_address), new WalletLinkClickableManager$getAddressAlertOptions$1(this, str));
        pairArr[1] = isTransferAvailable(this.clickableItem.getTokenCode()) ? TuplesKt.m99to(this.resourceManager.getString(C3301R.string.wallet_user_id_dialog_transfer_action), new WalletLinkClickableManager$getAddressAlertOptions$2(this)) : null;
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(pairArr);
        filterNotNull = CollectionsKt___CollectionsKt.filterNotNull(mutableListOf);
        mutableList = CollectionsKt___CollectionsKt.toMutableList((Collection) filterNotNull);
        this.dialogsOptions = mutableList;
