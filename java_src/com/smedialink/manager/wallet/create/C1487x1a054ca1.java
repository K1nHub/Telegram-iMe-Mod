...
public final class C1487x1a054ca1 extends Lambda implements Function1<Result<? extends String>, Unit> {
    ...
    public C1487x1a054ca1(WalletCreateManager walletCreateManager, WalletCreationType.Initial initial, String str) {
        super(1);
    ...
    public final void m1173invoke(Result<? extends String> it) {
