...
public final class WalletCreateManager {
    ...
    public void startWalletCreationFlow(final WalletCreationType walletCreationType) {
        ...
        viewState.showAnimatedDialog(getAnimatedSpannableDialogModelByType(walletCreationType), new Callbacks$Callback() { // from class: com.smedialink.manager.wallet.create.WalletCreateManager$$ExternalSyntheticLambda2
            @Override // org.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    public static final void startWalletCreationFlow$lambda$3$lambda$1(WalletCreateManagerView this_with, final WalletCreateManager this$0, final WalletCreationType walletCreationType) {
        ...
        Intrinsics.checkNotNullParameter(walletCreationType, "$walletCreationType");
        this_with.showAnimatedDialog(this$0.getAnimatedSpannableDialogModelByType(walletCreationType), new Callbacks$Callback() { // from class: com.smedialink.manager.wallet.create.WalletCreateManager$$ExternalSyntheticLambda3
            @Override // org.fork.utils.Callbacks$Callback
            public final void invoke() {
    ...
    public boolean isRestoreAvailable() {
        ...
        return !Intrinsics.areEqual(wallet != null ? wallet.getAddress() : null, getLinkedCryptoWalletAddress());
    }
    ...
    public void startChooseWalletOptionsFlow(BlockchainType blockchainType) {
        ...
        loadCryptoInformation(new Callbacks$Callback() { // from class: com.smedialink.manager.wallet.create.WalletCreateManager$$ExternalSyntheticLambda1
            @Override // org.fork.utils.Callbacks$Callback
            public final void invoke() {
                WalletCreateManager.startChooseWalletOptionsFlow$lambda$6(WalletCreateManager.this);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void startChooseWalletOptionsFlow$lambda$6(final WalletCreateManager this$0) {
        List listOfNotNull;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        WalletCreateManagerView viewState = this$0.getViewState();
        String string = this$0.resourceManager.getString(C3286R.string.wallet_dashboard_create_start_dialog_title);
        String[] strArr = new String[3];
        strArr[0] = this$0.resourceManager.getString(C3286R.string.wallet_dashboard_create_eth_wallet);
        strArr[1] = this$0.resourceManager.getString(C3286R.string.wallet_dashboard_import_eth_wallet);
        strArr[2] = this$0.isRestoreAvailable() ? this$0.resourceManager.getString(C3286R.string.wallet_dashboard_restore_eth_wallet) : null;
        listOfNotNull = CollectionsKt__CollectionsKt.listOfNotNull(strArr);
        viewState.showSelectOptionsDialog(string, (String[]) listOfNotNull.toArray(new String[0]), new DialogInterface.OnClickListener() { // from class: com.smedialink.manager.wallet.create.WalletCreateManager$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                WalletCreateManager.startChooseWalletOptionsFlow$lambda$6$lambda$5(WalletCreateManager.this, dialogInterface, i);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void startChooseWalletOptionsFlow$lambda$6$lambda$5(WalletCreateManager this$0, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public void loadCryptoInformation(Callbacks$Callback endAction) {
        ...
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) getViewState(), false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1483xf0d1187c(this, endAction)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1484xf0d1187d(getViewState())));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        com.smedialink.storage.data.utils.extentions.RxExtKt.autoDispose(subscribe, this.subscriptions);
    }

    private final void prepareCreateWalletFlow(WalletCreationType walletCreationType) {
        ...
        Intrinsics.checkNotNullExpressionValue(observeOn, "cryptoWalletInteractor\n …(schedulersProvider.ui())");
        Disposable subscribe = RxExtKt.withLoadingDialog$default((Observable) observeOn, (BaseView) getViewState(), false, 2, (Object) null).subscribe(new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1485x1a054ca1(this, walletCreationType, walletPassword)), new RxExtKt$sam$i$io_reactivex_functions_Consumer$0(new C1486x1a054ca2(this.viewState)));
        Intrinsics.checkNotNullExpressionValue(subscribe, "viewState: BaseView? = n…  onError.invoke()\n    })");
        com.smedialink.storage.data.utils.extentions.RxExtKt.autoDispose(subscribe, this.subscriptions);
    }
    ...
    private final AnimatedSpannableDialogModel getCreateWalletAnimatedSpannableDialogModel() {
        ...
        int indexOf$default;
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new CharacterStyle[]{new URLSpanReplacement(this.resourceManager.getString(C3286R.string.wallet_dashboard_create_start_dialog_description_privacy_link)), new ForegroundColorSpan(this.resourceManager.getColor(C3286R.C3287color.crypto_product_custom))});
        SpannableStringBuilder valueOf = SpannableStringBuilder.valueOf(this.resourceManager.getString(C3286R.string.wallet_dashboard_create_start_dialog_description_privacy));
        for (CharacterStyle characterStyle : listOf) {
            valueOf.setSpan(characterStyle, 0, valueOf.length(), 33);
        }
        SpannableStringBuilder description = SpannableStringBuilder.valueOf(this.resourceManager.getString(C3286R.string.wallet_dashboard_create_start_dialog_description));
        ...
        int i = C3286R.C3291raw.fork_crypto_wallet;
        String string = this.resourceManager.getString(C3286R.string.wallet_dashboard_create_start_dialog_title);
        Intrinsics.checkNotNullExpressionValue(description, "description");
        return new AnimatedSpannableDialogModel(i, string, description, this.resourceManager.getString(C3286R.string.common_next));
    }

    private final AnimatedSpannableDialogModel getImportWalletAnimatedSpannableDialogModel() {
        return new AnimatedSpannableDialogModel(C3286R.C3291raw.fork_wallet_import, this.resourceManager.getString(C3286R.string.wallet_dashboard_import_start_dialog_title), new SpannableStringBuilder(this.resourceManager.getString(C3286R.string.wallet_dashboard_import_start_dialog_description)), this.resourceManager.getString(C3286R.string.common_next));
    }
    ...
    private final DialogModel getCreateWalletWarningDialogModel() {
        String string = this.resourceManager.getString(C3286R.string.wallet_dashboard_eth_wallet_warning_dialog_title);
        ResourceManager resourceManager = this.resourceManager;
        int i = C3286R.string.wallet_dashboard_create_eth_wallet_warning_dialog_description;
        ...
        return new DialogModel(string, resourceManager.getString(i, objArr), this.resourceManager.getString(C3286R.string.common_cancel), this.resourceManager.getString(C3286R.string.wallet_dashboard_create_eth_wallet_warning_dialog_action_button));
    }

    private final DialogModel getImportWalletWarningDialogModel() {
        String string = this.resourceManager.getString(C3286R.string.wallet_dashboard_eth_wallet_warning_dialog_title);
        ResourceManager resourceManager = this.resourceManager;
        int i = C3286R.string.wallet_dashboard_import_eth_wallet_warning_dialog_description;
        Object[] objArr = new Object[1];
        String linkedCryptoWalletAddress = getLinkedCryptoWalletAddress();
        if (linkedCryptoWalletAddress == null) {
            linkedCryptoWalletAddress = "";
        ...
        objArr[0] = linkedCryptoWalletAddress;
        return new DialogModel(string, resourceManager.getString(i, objArr), this.resourceManager.getString(C3286R.string.common_cancel), this.resourceManager.getString(C3286R.string.wallet_dashboard_import_eth_wallet_warning_dialog_action_button));
    }

    private final DialogModel getRestoreWalletWarningDialogModel() {
        String string = this.resourceManager.getString(C3286R.string.wallet_dashboard_eth_wallet_warning_dialog_title);
        ResourceManager resourceManager = this.resourceManager;
        int i = C3286R.string.wallet_dashboard_restore_eth_wallet_warning_dialog_description;
        Object[] objArr = new Object[1];
        String linkedCryptoWalletAddress = getLinkedCryptoWalletAddress();
        if (linkedCryptoWalletAddress == null) {
            linkedCryptoWalletAddress = "";
        ...
        objArr[0] = linkedCryptoWalletAddress;
        return new DialogModel(string, resourceManager.getString(i, objArr), this.resourceManager.getString(C3286R.string.common_cancel), this.resourceManager.getString(C3286R.string.wallet_dashboard_restore_eth_wallet_warning_dialog_action_button));
    }
}
