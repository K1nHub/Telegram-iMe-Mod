...
public final class C1459x4c48b562 extends Lambda implements Function1<Result<? extends AccountInfo>, Unit> {
    ...
    public C1459x4c48b562(CryptoRecipientManager cryptoRecipientManager, String str, BlockchainType blockchainType) {
        super(1);
    ...
    public final void m1166invoke(Result<? extends AccountInfo> it) {
        ...
        if (result instanceof Result.Success) {
            ...
            if (mapToUI instanceof AddressAccessState.Granted) {
                ...
                viewState4.showRequestPermissionDialog(str, requestPermissionDialogModel, new Callbacks$Callback() { // from class: com.smedialink.manager.crypto.recipient.CryptoRecipientManager$loadAddressInfoById$1$1
