...
/* renamed from: com.smedialink.manager.crypto.recipient.CryptoRecipientManager$requestAddressPermission$$inlined$flatMapSuccess$1 */
/* loaded from: classes3.dex */
public final class C1461xd1623ac9 extends Lambda implements Function1<Result<? extends String>, ObservableSource<? extends Result<? extends TLRPC$messages_BotResults>>> {
    ...
    public C1461xd1623ac9(String str, Ref$LongRef ref$LongRef, CryptoRecipientManager cryptoRecipientManager) {
        super(1);
    ...
    */
    public final io.reactivex.ObservableSource<? extends com.smedialink.storage.domain.model.Result<? extends org.telegram.tgnet.TLRPC$messages_BotResults>> invoke(com.smedialink.storage.domain.model.Result<? extends java.lang.String> r10) {
        /*
            r9 = this;
            ...
            r4 = -1
            if (r0 == 0) goto L2c
            com.smedialink.manager.crypto.recipient.CryptoRecipientManager r6 = r9.this$0
        ...
        L2d:
            ...
            com.smedialink.manager.crypto.recipient.CryptoRecipientManager$requestAddressPermission$lambda$0$$inlined$wrapAsResult$1 r0 = com.smedialink.manager.crypto.recipient.C1464x5109593.INSTANCE
            com.smedialink.manager.crypto.recipient.CryptoRecipientManager$inlined$sam$i$io_reactivex_functions_Function$0 r1 = new com.smedialink.manager.crypto.recipient.CryptoRecipientManager$inlined$sam$i$io_reactivex_functions_Function$0
            r1.<init>(r0)
            io.reactivex.Observable r10 = r10.map(r1)
            com.smedialink.manager.crypto.recipient.CryptoRecipientManager$requestAddressPermission$lambda$0$$inlined$wrapAsResult$2 r0 = com.smedialink.manager.crypto.recipient.C1465x5109594.INSTANCE
            com.smedialink.manager.crypto.recipient.CryptoRecipientManager$inlined$sam$i$io_reactivex_functions_Function$0 r1 = new com.smedialink.manager.crypto.recipient.CryptoRecipientManager$inlined$sam$i$io_reactivex_functions_Function$0
            r1.<init>(r0)
        ...
        Lb4:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smedialink.manager.crypto.recipient.C1461xd1623ac9.invoke(com.smedialink.storage.domain.model.Result):io.reactivex.ObservableSource");
    }
}
