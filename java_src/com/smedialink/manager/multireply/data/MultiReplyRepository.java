...
public final class MultiReplyRepository {
    ...
    public final Single<MessageLinkPattern> requestPattern(MessageObject message, TLRPC$Chat currentChat) {
        ...
        Single<MessageLinkPattern> subscribeOn = Observable.concat(this.messageLinkCache.getLinkPatternFromCache(currentChat.f1500id), getLinkPatternFromApi(message, currentChat)).firstOrError().subscribeOn(this.schedulersProvider.mo707io());
