...
public final class GlProgramLocation {
    ...
    private GlProgramLocation(int i, Type type, String str) {
        ...
        if (i2 == 1) {
            glGetAttribLocation = GLES20.glGetAttribLocation(UInt.m1974constructorimpl(i), str);
        } else if (i2 != 2) {
            throw new NoWhenBranchMatchedException();
        } else {
            glGetAttribLocation = GLES20.glGetUniformLocation(UInt.m1974constructorimpl(i), str);
        }
        this.value = glGetAttribLocation;
        Egloo.checkGlProgramLocation(glGetAttribLocation, str);
        this.uvalue = UInt.m1974constructorimpl(glGetAttribLocation);
    }
    ...
    public final int m1889getUvaluepVg5ArA$library_release() {
        return this.uvalue;
    }
