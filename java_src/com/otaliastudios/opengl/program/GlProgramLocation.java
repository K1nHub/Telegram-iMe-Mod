...
public final class GlProgramLocation {
    ...
    private GlProgramLocation(int i, Type type, String str) {
        ...
        if (i2 == 1) {
            glGetAttribLocation = GLES20.glGetAttribLocation(UInt.m1972constructorimpl(i), str);
        } else if (i2 != 2) {
            throw new NoWhenBranchMatchedException();
        } else {
            glGetAttribLocation = GLES20.glGetUniformLocation(UInt.m1972constructorimpl(i), str);
        }
        this.value = glGetAttribLocation;
        Egloo.checkGlProgramLocation(glGetAttribLocation, str);
        this.uvalue = UInt.m1972constructorimpl(glGetAttribLocation);
    }
    ...
    public final int m1887getUvaluepVg5ArA$library_release() {
        return this.uvalue;
    }
