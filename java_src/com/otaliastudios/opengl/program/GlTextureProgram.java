...
public class GlTextureProgram extends GlProgram {
    ...
    public void onPreDraw(GlDrawable drawable, float[] modelViewProjectionMatrix) {
        ...
        GLES20.glEnableVertexAttribArray(glProgramLocation2.m1651getUvaluepVg5ArA$library_release());
        Egloo.checkGlError("glEnableVertexAttribArray");
        GLES20.glVertexAttribPointer(glProgramLocation2.m1651getUvaluepVg5ArA$library_release(), 2, GlKt.getGL_FLOAT(), false, drawable.getVertexStride(), (Buffer) drawable.getVertexArray());
        ...
        GLES20.glEnableVertexAttribArray(glProgramLocation3.m1651getUvaluepVg5ArA$library_release());
        Egloo.checkGlError("glEnableVertexAttribArray");
        GLES20.glVertexAttribPointer(glProgramLocation3.m1651getUvaluepVg5ArA$library_release(), 2, GlKt.getGL_FLOAT(), false, drawable.getVertexStride(), (Buffer) this.textureCoordsBuffer);
        Egloo.checkGlError("glVertexAttribPointer");
    }
    ...
    public void onPostDraw(GlDrawable drawable) {
        ...
        GLES20.glDisableVertexAttribArray(this.vertexPositionHandle.m1651getUvaluepVg5ArA$library_release());
        GlProgramLocation glProgramLocation = this.textureCoordsHandle;
        if (glProgramLocation != null) {
            GLES20.glDisableVertexAttribArray(glProgramLocation.m1651getUvaluepVg5ArA$library_release());
        }
        GlTexture glTexture = this.texture;
        if (glTexture != null) {
            glTexture.unbind();
