...
public class Engine {
    ...
    private double computeProgress() {
        ...
        Logger logger = LOG;
        logger.m684v("computeProgress - readUs:" + totalReadUs + ", totalUs:" + totalDurationUs);
    ...
    public void compress(GIFOptions gIFOptions) throws InterruptedException {
        ...
        Logger logger = LOG;
        logger.m684v("Duration (us): " + getTotalDurationUs());
        boolean z = false;
        long j = 0L;
        while (!z) {
            try {
                Logger logger2 = LOG;
                logger2.m684v("new loop: " + j);
                ...
                if (j % 10 == 0) {
                    ...
                    logger2.m684v("progress:" + computeProgress);
