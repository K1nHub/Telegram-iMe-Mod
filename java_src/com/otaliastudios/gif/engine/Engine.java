...
public class Engine {
    ...
    private double computeProgress() {
        ...
        Logger logger = LOG;
        logger.m1004v("computeProgress - readUs:" + totalReadUs + ", totalUs:" + totalDurationUs);
    ...
    public void compress(GIFOptions gIFOptions) throws InterruptedException {
        ...
        Logger logger = LOG;
        logger.m1004v("Duration (us): " + getTotalDurationUs());
        boolean z = false;
        long j = 0L;
        while (!z) {
            try {
                Logger logger2 = LOG;
                logger2.m1004v("new loop: " + j);
                ...
                if (j % 10 == 0) {
                    ...
                    logger2.m1004v("progress:" + computeProgress);
