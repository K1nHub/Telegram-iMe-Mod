...
public abstract class VideoFrameDropper {
    ...
    private static class Dropper1 extends VideoFrameDropper {
        ...
        private Dropper1(int i, int i2) {
            ...
            logger.m1003i("inFrameRateReciprocal:" + this.mInFrameRateReciprocal + " outFrameRateReciprocal:" + this.mOutFrameRateReciprocal);
        }
        ...
        public boolean shouldRenderFrame(long j) {
            ...
            if (i == 0) {
                Logger logger = VideoFrameDropper.LOG;
                logger.m1001v("RENDERING (first frame) - frameRateReciprocalSum:" + this.mFrameRateReciprocalSum);
                return true;
            }
            double d2 = this.mOutFrameRateReciprocal;
            if (d <= d2) {
                Logger logger2 = VideoFrameDropper.LOG;
                logger2.m1001v("DROPPING - frameRateReciprocalSum:" + this.mFrameRateReciprocalSum);
                return false;
            }
            this.mFrameRateReciprocalSum = d - d2;
            Logger logger3 = VideoFrameDropper.LOG;
            logger3.m1001v("RENDERING - frameRateReciprocalSum:" + this.mFrameRateReciprocalSum);
            return true;
        }
    }
}
