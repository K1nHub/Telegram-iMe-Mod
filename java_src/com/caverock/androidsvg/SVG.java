...
public class SVG {
    ...
    public static class Length implements Cloneable {
        ...
        public float floatValueX(SVGAndroidRenderer sVGAndroidRenderer) {
            switch (C04661.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()]) {
                case 1:
                    return this.value;
                case 2:
        ...
        public float floatValue(float f) {
            int i = C04661.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()];
            if (i == 1) {
                return this.value;
            }
            switch (i) {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C04661 {
