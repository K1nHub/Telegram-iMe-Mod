...
public class CSSParser {
        ...
        public String toString() {
            ...
            if (list != null) {
                for (Attrib attrib : list) {
                    ...
                    int i = C04621.$SwitchMap$com$caverock$androidsvg$CSSParser$AttribOp[attrib.operation.ordinal()];
                    if (i == 1) {
                        sb.append('=');
    ...
    public static class Selector {
        ...
        /* synthetic */ Selector(C04621 c04621) {
            this();
        }
    ...
    public static class CSSTextScanner extends SVGParser.TextScanner {
        ...
        */
        ...
        private void parsePseudoClass(Selector selector, SimpleSelector simpleSelector) throws CSSParseException {
            ...
            switch (C04621.$SwitchMap$com$caverock$androidsvg$CSSParser$PseudoClassIdents[fromString.ordinal()]) {
                case 1:
    ...
    public static class PseudoClassRoot implements PseudoClass {
        ...
        /* synthetic */ PseudoClassRoot(C04621 c04621) {
            this();
        }
    ...
    public static class PseudoClassEmpty implements PseudoClass {
        ...
        /* synthetic */ PseudoClassEmpty(C04621 c04621) {
            this();
        }
    ...
    public static class PseudoClassTarget implements PseudoClass {
        ...
        /* synthetic */ PseudoClassTarget(C04621 c04621) {
            this();
        }
