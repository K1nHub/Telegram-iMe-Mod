            ...
            public void run() {
                ...
                if (now + j2 >= j3) {
                    ...
                    if (now < j3 + j4 + j2) {
                        ...
                        this.f434sd.replace(Worker.this.schedule(this, j - now, timeUnit));
                    }
                }
