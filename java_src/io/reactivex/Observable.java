...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    /* renamed from: as */
    public final <R> R m690as(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final <U extends Collection<? super T>> Observable<U> buffer(int i, int i2, Callable<U> callable) {
        ObjectHelper.verifyPositive(i, NotificationBadge.NewHtcHomeBadger.COUNT);
    ...
    /* renamed from: to */
    public final <R> R m689to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C25681.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
    ...
    public final Observable<Observable<T>> window(long j, long j2, int i) {
        ObjectHelper.verifyPositive(j, NotificationBadge.NewHtcHomeBadger.COUNT);
    ...
    public final Observable<Observable<T>> window(long j, TimeUnit timeUnit, Scheduler scheduler, long j2, boolean z, int i) {
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.verifyPositive(j2, NotificationBadge.NewHtcHomeBadger.COUNT);
