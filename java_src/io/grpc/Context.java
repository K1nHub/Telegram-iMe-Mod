...
public class Context {
    ...
    /* loaded from: classes6.dex */
    class RunnableC26431 implements Runnable {
    }
    ...
    static AbstractC2644Storage storage() {
    ...
    public static final class LazyStorage {
        static final AbstractC2644Storage storage;
        ...
        private static AbstractC2644Storage createStorage(AtomicReference<? super ClassNotFoundException> atomicReference) {
            try {
                return (AbstractC2644Storage) Class.forName("io.grpc.override.ContextStorageOverride").asSubclass(AbstractC2644Storage.class).getConstructor(new Class[0]).newInstance(new Object[0]);
    ...
    /* loaded from: classes6.dex */
    public static abstract class AbstractC2644Storage {
    ...
    public final class ParentListener implements CancellationListener {
        ...
        /* synthetic */ ParentListener(Context context, RunnableC26431 runnableC26431) {
            this();
        }
