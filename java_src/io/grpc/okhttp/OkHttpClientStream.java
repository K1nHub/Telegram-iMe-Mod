...
public class OkHttpClientStream extends AbstractClientStream {
    ...
    public class TransportState extends Http2ClientStreamTransportState {
        ...
        public void start(int i) {
            Preconditions.checkState(OkHttpClientStream.this.f520id == -1, "the stream has been started with id %s", i);
            OkHttpClientStream.this.f520id = i;
            OkHttpClientStream.this.state.onStreamAllocated();
            if (this.canStart) {
                this.frameWriter.synStream(OkHttpClientStream.this.useGet, false, OkHttpClientStream.this.f520id, 0, this.requestHeaders);
                OkHttpClientStream.this.statsTraceCtx.clientOutboundHeaders();
                this.requestHeaders = null;
                if (this.pendingData.size() > 0) {
                    this.outboundFlow.data(this.pendingDataHasEndOfStream, OkHttpClientStream.this.f520id, this.pendingData, this.flushPendingData);
                }
                this.canStart = false;
            }
        }
        ...
        public void bytesRead(int i) {
            ...
            if (i2 <= i3 * 0.5f) {
                ...
                this.frameWriter.windowUpdate(OkHttpClientStream.this.m700id(), i4);
            }
        }
        ...
        public void transportDataReceived(Buffer buffer, boolean z) {
            ...
            this.window = size;
            if (size < 0) {
                this.frameWriter.rstStream(OkHttpClientStream.this.m700id(), ErrorCode.FLOW_CONTROL_ERROR);
                this.transport.finishStream(OkHttpClientStream.this.m700id(), Status.INTERNAL.withDescription("Received data size exceeded our receiving window size"), ClientStreamListener.RpcProgress.PROCESSED, false, null, null);
                return;
            }
        ...
        private void onEndOfStream() {
            if (!isOutboundClosed()) {
                this.transport.finishStream(OkHttpClientStream.this.m700id(), null, ClientStreamListener.RpcProgress.PROCESSED, false, ErrorCode.CANCEL, null);
            } else {
                this.transport.finishStream(OkHttpClientStream.this.m700id(), null, ClientStreamListener.RpcProgress.PROCESSED, false, null, null);
            }
        }
        ...
        public void cancel(Status status, boolean z, Metadata metadata) {
            ...
            this.transport.finishStream(OkHttpClientStream.this.m700id(), status, ClientStreamListener.RpcProgress.PROCESSED, z, ErrorCode.CANCEL, metadata);
        }
        ...
        public void sendBuffer(Buffer buffer, boolean z, boolean z2) {
            ...
            Preconditions.checkState(OkHttpClientStream.this.m700id() != -1, "streamId should be set");
            this.outboundFlow.data(z, OkHttpClientStream.this.m700id(), buffer, z2);
        }
