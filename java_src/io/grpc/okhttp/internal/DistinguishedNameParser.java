...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        if (i3 >= i4) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f427dn);
        }
        this.end = i3;
        if (this.chars[i3] == ' ') {
            while (true) {
    ...
    */
    ...
    private int getByte(int i) {
        ...
        int i4 = i + 1;
        if (i4 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f427dn);
        }
        char[] cArr = this.chars;
        char c = cArr[i];
        if (c >= '0' && c <= '9') {
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f427dn.toCharArray();
