...
public final class Metadata {
    ...
    public static abstract class Key<T> {
        ...
        /* renamed from: of */
        public static <T> Key<T> m1001of(String str, AsciiMarshaller<T> asciiMarshaller) {
            return m1000of(str, false, asciiMarshaller);
        }

        /* renamed from: of */
        static <T> Key<T> m1000of(String str, boolean z, AsciiMarshaller<T> asciiMarshaller) {
