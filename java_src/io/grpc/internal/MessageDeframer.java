...
public class MessageDeframer implements Closeable, Deframer {
    ...
    private void deliver() {
        ...
        while (true) {
            try {
                ...
                int i = C26821.$SwitchMap$io$grpc$internal$MessageDeframer$State[this.state.ordinal()];
                if (i == 1) {
                    processHeader();
                } else if (i == 2) {
                    processBody();
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C26821 {
    ...
    public static class SingleMessageProducer implements StreamListener.MessageProducer {
        ...
        /* synthetic */ SingleMessageProducer(InputStream inputStream, C26821 c26821) {
            this(inputStream);
        }
