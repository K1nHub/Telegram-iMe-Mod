...
public class GzipInflatingBuffer implements Closeable {
    ...
    public class GzipMetadataReader {
        ...
        /* synthetic */ GzipMetadataReader(GzipInflatingBuffer gzipInflatingBuffer, C25041 c25041) {
            this();
        }
    ...
    */
    public int inflateBytes(byte[] r7, int r8, int r9) throws java.util.zip.DataFormatException, java.util.zip.ZipException {
        ...
        Lc:
            ...
            int r4 = r9 - r3
            if (r4 <= 0) goto L77
            int[] r2 = io.grpc.internal.GzipInflatingBuffer.C25041.$SwitchMap$io$grpc$internal$GzipInflatingBuffer$State
