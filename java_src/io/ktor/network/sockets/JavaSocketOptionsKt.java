...
public final class JavaSocketOptionsKt {
    ...
    public static final void assignOptions(SelectableChannel selectableChannel, SocketOptions options) {
        ...
        if (selectableChannel instanceof SocketChannel) {
            if (!TypeOfService.m1909equalsimpl0(options.m1907getTypeOfServicezieKYfw(), TypeOfService.Companion.m1910getUNDEFINEDzieKYfw())) {
                if (java7NetworkApisAvailable) {
                    ((SocketChannel) selectableChannel).setOption((SocketOption<SocketOption>) StandardSocketOptions.IP_TOS, (SocketOption) Integer.valueOf(options.m1907getTypeOfServicezieKYfw() & 255));
                } else {
                    ((SocketChannel) selectableChannel).socket().setTrafficClass(options.m1907getTypeOfServicezieKYfw() & 255);
                }
            }
        ...
        if (selectableChannel instanceof DatagramChannel) {
            if (!TypeOfService.m1909equalsimpl0(options.m1907getTypeOfServicezieKYfw(), TypeOfService.Companion.m1910getUNDEFINEDzieKYfw())) {
                if (java7NetworkApisAvailable) {
                    ((DatagramChannel) selectableChannel).setOption((SocketOption<SocketOption>) StandardSocketOptions.IP_TOS, (SocketOption) Integer.valueOf(options.m1907getTypeOfServicezieKYfw() & 255));
                } else {
                    ((DatagramChannel) selectableChannel).socket().setTrafficClass(options.m1907getTypeOfServicezieKYfw() & 255);
                }
            }
            if (options.getReuseAddress()) {
                if (java7NetworkApisAvailable) {
