...
@DebugMetadata(m148c = "io.ktor.network.sockets.CIOWriterKt$attachForWritingDirectImpl$1", m147f = "CIOWriter.kt", m146l = {86}, m145m = "invokeSuspend")
...
public final class CIOWriterKt$attachForWritingDirectImpl$1 extends SuspendLambda implements Function2<ReaderScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                C26591 c26591 = new C26591(this.$socketOptions, readerScope, byteChannel, this.$nioChannel, this.$selectable, this.$selector, null);
                this.label = 1;
                if (byteChannel.lookAheadSuspend(c26591, this) == coroutine_suspended) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: CIOWriter.kt */
    @DebugMetadata(m148c = "io.ktor.network.sockets.CIOWriterKt$attachForWritingDirectImpl$1$1", m147f = "CIOWriter.kt", m146l = {99, 111, 111}, m145m = "invokeSuspend")
    /* renamed from: io.ktor.network.sockets.CIOWriterKt$attachForWritingDirectImpl$1$1 */
    /* loaded from: classes4.dex */
    public static final class C26591 extends SuspendLambda implements Function2<LookAheadSuspendSession, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C26591(SocketOptions.TCPClientSocketOptions tCPClientSocketOptions, ReaderScope readerScope, ByteChannel byteChannel, WritableByteChannel writableByteChannel, Selectable selectable, SelectorManager selectorManager, Continuation<? super C26591> continuation) {
            super(2, continuation);
            this.$socketOptions = tCPClientSocketOptions;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C26591 c26591 = new C26591(this.$socketOptions, this.$$this$reader, this.$channel, this.$nioChannel, this.$selectable, this.$selector, continuation);
            c26591.L$0 = obj;
            return c26591;
        }
        ...
        public final Object invoke(LookAheadSuspendSession lookAheadSuspendSession, Continuation<? super Unit> continuation) {
            return ((C26591) create(lookAheadSuspendSession, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r19) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: io.ktor.network.sockets.CIOWriterKt$attachForWritingDirectImpl$1.C26591.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
}
