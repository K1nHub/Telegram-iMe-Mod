...
final class LockFreeMPSCQueueCore<E> {
    ...
    private final LockFreeMPSCQueueCore<E> allocateNextCopy(long j) {
        ...
        while (true) {
            ...
            if ((i & i3) != (i2 & i3)) {
                ...
                lockFreeMPSCQueueCore._state = Companion.m999wo(j, 1152921504606846976L);
                return lockFreeMPSCQueueCore;
            }
        }
    }
    ...
    public static final class Companion {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: wo */
        public final long m999wo(long j, long j2) {
            return j & (~j2);
        }
        ...
        public final long updateHead(long j, int i) {
            return m999wo(j, 1073741823L) | (i << 0);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public final long updateTail(long j, int i) {
            return m999wo(j, 1152921503533105152L) | (i << 30);
        }
    }
