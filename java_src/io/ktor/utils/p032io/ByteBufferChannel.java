...
public class ByteBufferChannel implements ByteChannel, ByteReadChannel, ByteWriteChannel, LookAheadSuspendSession {
            ...
            */
            public final java.lang.Object invoke(kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
                ...
                L24:
                    ...
                    java.lang.Object r1 = kotlin.Result.m1943constructorimpl(r1)
                    r10.resumeWith(r1)
                    goto L6c
                L38:
                    io.ktor.utils.io.ByteBufferChannel r1 = io.ktor.utils.p032io.ByteBufferChannel.this
    ...
    */
    ...
    public final void resumeReadOp() {
        ...
        if (continuation != null) {
            ...
            if (cause != null) {
                ...
                continuation.resumeWith(Result.m1943constructorimpl(ResultKt.createFailure(cause)));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            continuation.resumeWith(Result.m1943constructorimpl(Boolean.TRUE));
        }
    }
    ...
    private final void resumeWriteOp() {
        ...
        writeOp.resumeWith(Result.m1943constructorimpl(createFailure));
    }
    ...
    private final void resumeClosed(Throwable th) {
        ...
        if (continuation != null) {
            if (th != null) {
                ...
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m1943constructorimpl(valueOf));
            }
        }
        ...
        if (continuation2 != null) {
            ...
            continuation2.resumeWith(Result.m1943constructorimpl(ResultKt.createFailure(th)));
        }
    }
    ...
    */
    public final void writeSuspendBlock(int r6, kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit> r7) {
        ...
        L16:
            ...
            java.lang.Object r0 = kotlin.Result.m1943constructorimpl(r0)
            r7.resumeWith(r0)
            goto L54
        L28:
