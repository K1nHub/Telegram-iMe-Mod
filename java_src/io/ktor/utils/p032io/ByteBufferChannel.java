...
public class ByteBufferChannel implements ByteChannel, ByteReadChannel, ByteWriteChannel, LookAheadSuspendSession {
    ...
    */
    ...
    public final void resumeReadOp() {
        ...
        if (continuation != null) {
            ...
            if (cause != null) {
                ...
                continuation.resumeWith(Result.m1935constructorimpl(ResultKt.createFailure(cause)));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            continuation.resumeWith(Result.m1935constructorimpl(Boolean.TRUE));
        }
    }
    ...
    private final void resumeWriteOp() {
        ...
        writeOp.resumeWith(Result.m1935constructorimpl(createFailure));
    }
    ...
    private final void resumeClosed(Throwable th) {
        ...
        if (continuation != null) {
            if (th != null) {
                ...
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m1935constructorimpl(valueOf));
            }
        }
        ...
        if (continuation2 != null) {
            ...
            continuation2.resumeWith(Result.m1935constructorimpl(ResultKt.createFailure(th)));
        }
    }
    ...
    */
    public final void writeSuspendBlock(int r6, kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit> r7) {
        ...
        L16:
            ...
            java.lang.Object r0 = kotlin.Result.m1935constructorimpl(r0)
            r7.resumeWith(r0)
            goto L54
        L28:
