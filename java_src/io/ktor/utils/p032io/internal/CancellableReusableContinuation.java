...
public final class CancellableReusableContinuation<T> implements Continuation<T> {
    ...
    public final void close(T value) {
        ...
        resumeWith(Result.m1943constructorimpl(value));
    ...
    public final void close(Throwable cause) {
        ...
        Result.Companion companion = Result.Companion;
        resumeWith(Result.m1943constructorimpl(ResultKt.createFailure(cause)));
        JobRelation jobRelation = (JobRelation) jobCancellationHandler$FU.getAndSet(this, null);
        if (jobRelation != null) {
            jobRelation.dispose();
        }
    ...
    public final void resumeWithExceptionContinuationOnly(Job job, Throwable th) {
        ...
        Result.Companion companion = Result.Companion;
        continuation.resumeWith(Result.m1943constructorimpl(ResultKt.createFailure(th)));
    }
    ...
    public void resumeWith(Object obj) {
        ...
        do {
            obj2 = this.state;
            if (obj2 == null) {
                obj3 = Result.m1946exceptionOrNullimpl(obj);
                if (obj3 == null) {
