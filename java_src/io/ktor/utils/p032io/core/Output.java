...
public abstract class Output implements Appendable, Closeable {
    ...
    protected abstract void mo1920flush62zg_DM(ByteBuffer byteBuffer, int i, int i2);

    public Output(ObjectPool<ChunkBuffer> pool) {
        Intrinsics.checkNotNullParameter(pool, "pool");
        this.pool = pool;
        this.tailMemory = Memory.Companion.m1915getEmptySK3TCg8();
    }
    ...
    public final ByteBuffer m1922getTailMemorySK3TCg8$ktor_io() {
    ...
    private final void flushChain() {
        ...
        do {
            try {
                mo1920flush62zg_DM(chunkBuffer.m1919getMemorySK3TCg8(), chunkBuffer.getReadPosition(), chunkBuffer.getWritePosition() - chunkBuffer.getReadPosition());
    ...
    private final void appendChainImpl(ChunkBuffer chunkBuffer, ChunkBuffer chunkBuffer2, int i) {
        ...
        this.chainedSize += i;
        this.tailMemory = chunkBuffer2.m1919getMemorySK3TCg8();
    ...
    private final void appendCharFallback(char c) {
        ...
        try {
            ByteBuffer m1919getMemorySK3TCg8 = prepareWriteHead.m1919getMemorySK3TCg8();
            int writePosition = prepareWriteHead.getWritePosition();
            if (c >= 0 && c < 128) {
                m1919getMemorySK3TCg8.put(writePosition, (byte) c);
                i = 1;
            } else {
                if (128 <= c && c < 2048) {
                    m1919getMemorySK3TCg8.put(writePosition, (byte) (((c >> 6) & 31) | PsExtractor.AUDIO_STREAM));
                    m1919getMemorySK3TCg8.put(writePosition + 1, (byte) ((c & '?') | 128));
                    i = 2;
                } else {
                    if (2048 <= c && c < 0) {
                        m1919getMemorySK3TCg8.put(writePosition, (byte) (((c >> '\f') & 15) | 224));
                        m1919getMemorySK3TCg8.put(writePosition + 1, (byte) (((c >> 6) & 63) | 128));
                        m1919getMemorySK3TCg8.put(writePosition + 2, (byte) ((c & '?') | 128));
                    } else {
                        if (!(0 <= c && c < 0)) {
                            UTF8Kt.malformedCodePoint(c);
                            throw new KotlinNothingValueException();
                        }
                        m1919getMemorySK3TCg8.put(writePosition, (byte) (((c >> 18) & 7) | PsExtractor.VIDEO_STREAM_MASK));
                        m1919getMemorySK3TCg8.put(writePosition + 1, (byte) (((c >> '\f') & 63) | 128));
                        m1919getMemorySK3TCg8.put(writePosition + 2, (byte) (((c >> 6) & 63) | 128));
                        m1919getMemorySK3TCg8.put(writePosition + 3, (byte) ((c & '?') | 128));
                        i = 4;
                    }
                }
            }
