...
public final class DefaultBufferPool extends DefaultPool<ChunkBuffer> {
    ...
    public ChunkBuffer produceInstance() {
        return new ChunkBuffer(this.allocator.mo1903allocgFvZug(this.bufferSize), null, this, null);
    }
    ...
    public void disposeInstance(ChunkBuffer instance) {
        ...
        this.allocator.mo1904free3GNKZMM(instance.m1912getMemorySK3TCg8());
    ...
    public void validateInstance(ChunkBuffer instance) {
        ...
        if (!(((long) instance.m1912getMemorySK3TCg8().limit()) == ((long) this.bufferSize))) {
            StringBuilder sb = new StringBuilder();
            sb.append("Buffer size mismatch. Expected: ");
            sb.append(this.bufferSize);
            sb.append(", actual: ");
            sb.append(instance.m1912getMemorySK3TCg8().limit());
