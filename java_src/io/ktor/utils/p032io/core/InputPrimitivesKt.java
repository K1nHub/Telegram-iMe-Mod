...
public final class InputPrimitivesKt {
    ...
    public static final int readInt(Input input) {
        ...
        return input.m1922getHeadMemorySK3TCg8().getInt(headPosition);
    }
    ...
    public static final long readLong(Input input) {
        ...
        return input.m1922getHeadMemorySK3TCg8().getLong(headPosition);
    }
    ...
    public static final short readShort(Input input) {
        ...
        return input.m1922getHeadMemorySK3TCg8().getShort(headPosition);
    }
}
