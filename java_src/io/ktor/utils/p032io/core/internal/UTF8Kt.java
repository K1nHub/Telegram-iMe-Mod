...
public final class UTF8Kt {
    ...
    public static final int m1930encodeUTF8lBXzO7A(ByteBuffer encodeUTF8, CharSequence text, int i, int i2, int i3, int i4) {
        int coerceAtMost;
        ...
        while (i6 < coerceAtMost && i5 < min) {
            ...
            if ((65408 & charAt) == 0) {
                ...
                return m1931encodeUTF8Stage1Vm9B2pQ(encodeUTF8, text, i7 - 1, min, i, i6, coerceAtMost, i3);
            }
        }
        return EncodeResult.m1927constructorimpl(UShort.m2019constructorimpl((short) (i5 - i)), UShort.m2019constructorimpl((short) (i6 - i3)));
    }

    /* renamed from: encodeUTF8Stage1-Vm9B2pQ  reason: not valid java name */
    private static final int m1931encodeUTF8Stage1Vm9B2pQ(ByteBuffer byteBuffer, CharSequence charSequence, int i, int i2, int i3, int i4, int i5, int i6) {
        int i7 = i5 - 3;
        int i8 = i;
        int i9 = i4;
        while (i7 - i9 > 0 && i8 < i2) {
        ...
        if (i9 == i7) {
            return m1932encodeUTF8Stage2Vm9B2pQ(byteBuffer, charSequence, i8, i2, i3, i9, i5, i6);
        }
        return EncodeResult.m1927constructorimpl(UShort.m2019constructorimpl((short) (i8 - i3)), UShort.m2019constructorimpl((short) (i9 - i6)));
    }

    /* renamed from: encodeUTF8Stage2-Vm9B2pQ  reason: not valid java name */
    private static final int m1932encodeUTF8Stage2Vm9B2pQ(ByteBuffer byteBuffer, CharSequence charSequence, int i, int i2, int i3, int i4, int i5, int i6) {
        int i7;
        int i8 = i;
        int i9 = i4;
        while (true) {
