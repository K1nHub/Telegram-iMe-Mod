    ...
    public static final byte[] x25519(byte[] scalar, byte[] point, byte[] output, int i) {
        ...
        if (Arrays.equals(point, BASEPOINT)) {
            ...
            if (output.length != 32) {
                ...
                m1989constructorimpl = (int) ULong.m1989constructorimpl(ULong.m1989constructorimpl(ULong.m1989constructorimpl(UInt.m1967constructorimpl(i2 ^ 0) & 4294967295L) - ULong.m1989constructorimpl(1L)) >>> 63);
            }
            if (!(m1989constructorimpl != 1)) {
