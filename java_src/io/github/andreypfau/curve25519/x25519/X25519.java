    ...
    public static final byte[] x25519(byte[] scalar, byte[] point, byte[] output, int i) {
        ...
        if (Arrays.equals(point, BASEPOINT)) {
            ...
            if (output.length != 32) {
                ...
                m1997constructorimpl = (int) ULong.m1997constructorimpl(ULong.m1997constructorimpl(ULong.m1997constructorimpl(UInt.m1975constructorimpl(i2 ^ 0) & 4294967295L) - ULong.m1997constructorimpl(1L)) >>> 63);
            }
            if (!(m1997constructorimpl != 1)) {
