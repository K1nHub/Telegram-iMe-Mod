...
public final class CompletedPoint {
    ...
    public final CompletedPoint m1904double(ProjectivePoint pp) {
        Intrinsics.checkNotNullParameter(pp, "pp");
        return Companion.m1905double(pp, this);
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: double  reason: not valid java name */
        public final CompletedPoint m1905double(ProjectivePoint pp, CompletedPoint output) {
            Intrinsics.checkNotNullParameter(pp, "pp");
