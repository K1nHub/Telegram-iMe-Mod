...
.method resolveInternal()V
    ...
    .line 275
    invoke-static {v3}, Lio/grpc/internal/DnsNameResolver;->access$700(Lio/grpc/internal/DnsNameResolver;)Z
    ...
    invoke-virtual {v2, v0}, Lio/grpc/NameResolver$ResolutionResult$Builder;->setAddresses(Ljava/util/List;)Lio/grpc/NameResolver$ResolutionResult$Builder;
    ...
    .line 304
    iget-object v3, v1, Lio/grpc/internal/DnsNameResolver$ResolutionResults;->balancerAddresses:Ljava/util/List;
    ...
    iget-object v4, v1, Lio/grpc/internal/DnsNameResolver$ResolutionResults;->balancerAddresses:Ljava/util/List;
    ...
    invoke-virtual {v3, v1}, Lio/grpc/NameResolver$ServiceConfigParser;->parseServiceConfig(Ljava/util/Map;)Lio/grpc/NameResolver$ConfigOrError;

    move-result-object v3

    .line 320
    invoke-virtual {v0, v3}, Lio/grpc/NameResolver$ResolutionResult$Builder;->setServiceConfig(Lio/grpc/NameResolver$ConfigOrError;)Lio/grpc/NameResolver$ResolutionResult$Builder;
