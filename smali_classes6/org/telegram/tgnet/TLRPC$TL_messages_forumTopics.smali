...
.method public static TLdeserialize(Lorg/telegram/tgnet/AbstractSerializedData;IZ)Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;
    ...
    invoke-virtual {p1, p0, p2}, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->readParams(Lorg/telegram/tgnet/AbstractSerializedData;Z)V
...
.method public readParams(Lorg/telegram/tgnet/AbstractSerializedData;Z)V
    ...
    :cond_3
    iget-object v7, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->topics:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-object v7, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->messages:Ljava/util/ArrayList;
    ...
    :cond_b
    iget-object v7, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->chats:Ljava/util/ArrayList;
    ...
    :cond_f
    iget-object v3, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->users:Ljava/util/ArrayList;
...
.method public serializeToStream(Lorg/telegram/tgnet/AbstractSerializedData;)V
    ...
    iget-boolean v0, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->order_by_create_date:Z
    ...
    iget-object v1, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->topics:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->topics:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->messages:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->messages:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->chats:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->chats:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->users:Ljava/util/ArrayList;
    ...
    :cond_4
    iget v0, p0, Lorg/telegram/tgnet/TLRPC$TL_messages_forumTopics;->pts:I
