...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 321
    iget-object v14, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->selection1Animated:Lorg/telegram/ui/Components/AnimatedFloat;

    goto :goto_1

    :cond_0
    iget-object v14, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->selection2Animated:Lorg/telegram/ui/Components/AnimatedFloat;

    :goto_1
    iget-object v15, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->selection:[I
    ...
    .line 324
    invoke-static {v14, v15, v6}, Lorg/telegram/messenger/AndroidUtilities;->lerp(IIF)I

    move-result v8

    .line 329
    iget-object v14, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->rect:Landroid/graphics/RectF;
    ...
    invoke-virtual {v14, v15, v7, v4, v5}, Landroid/graphics/RectF;->set(FFFF)V

    .line 330
    iget-object v4, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->rect:Landroid/graphics/RectF;
    ...
    .line 331
    iget-object v4, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->rectPaint:Landroid/graphics/Paint;

    sget v5, Lorg/telegram/ui/ActionBar/Theme;->key_listSelector:I

    iget-object v7, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->resourcesProvider:Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;

    invoke-static {v5, v7}, Lorg/telegram/ui/ActionBar/Theme;->getColor(ILorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)I

    move-result v5

    invoke-static {v10, v3, v6}, Lorg/telegram/messenger/AndroidUtilities;->lerp(FFF)F
    ...
    iget-object v7, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->rectPaint:Landroid/graphics/Paint;
    ...
    .line 338
    iget-object v8, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->drawables:[Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v8, v6, v7, v15, v14}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    .line 339
    iget-object v6, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->drawables:[Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->selection:[I
    ...
    invoke-virtual {v6, v8, v12, v4, v13}, Landroid/graphics/RectF;->set(FFFF)V
    ...
    invoke-virtual {v4, v6, v8}, Landroid/graphics/RectF;->inset(FF)V
    ...
    invoke-virtual {v1, v4, v6, v8, v9}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {v1, v14, v14, v9, v3}, Landroid/graphics/Canvas;->scale(FFFF)V

    .line 372
    iget v3, v0, Lorg/telegram/ui/Components/EmojiColorPickerWindow$EmojiColorPickerView;->emojiSize:I

    add-int v9, v8, v3

    add-int/2addr v3, v7

    invoke-virtual {v5, v8, v7, v9, v3}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
