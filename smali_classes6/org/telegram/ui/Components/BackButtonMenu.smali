...
.method public static show(Lorg/telegram/ui/ActionBar/BaseFragment;Landroid/view/View;JJLorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)Lorg/telegram/ui/ActionBar/ActionBarPopupWindow;
    ...
    invoke-direct {v2, v9, v5}, Lorg/telegram/ui/ActionBar/ActionBarPopupWindow$ActionBarPopupWindowLayout;-><init>(Landroid/content/Context;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)V
    ...
    invoke-virtual {v13, v6}, Landroid/widget/FrameLayout;->setMinimumWidth(I)V
    ...
    .line 94
    invoke-virtual {v6, v1}, Lorg/telegram/ui/Components/BackupImageView;->setRoundRadius(I)V
    ...
    .line 108
    invoke-virtual {v3, v10}, Lorg/telegram/ui/Components/AvatarDrawable;->setScaleSize(F)V
    ...
    .line 112
    iget-wide v10, v15, Lorg/telegram/tgnet/TLRPC$Chat;->id:J

    invoke-static {v7, v10, v11}, Lorg/telegram/messenger/ChatObject;->isTemplatesChat(IJ)Z
    ...
    .line 113
    invoke-virtual {v3, v10}, Lorg/telegram/ui/Components/AvatarDrawable;->setAvatarType(I)V

    .line 114
    invoke-virtual {v6, v3}, Lorg/telegram/ui/Components/BackupImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v3, v11, v15}, Lorg/telegram/ui/Components/AvatarDrawable;->setInfo(ILorg/telegram/tgnet/TLRPC$Chat;)V

    .line 119
    iget-object v11, v15, Lorg/telegram/tgnet/TLRPC$Chat;->photo:Lorg/telegram/tgnet/TLRPC$ChatPhoto;

    if-eqz v11, :cond_7

    iget-object v11, v11, Lorg/telegram/tgnet/TLRPC$ChatPhoto;->strippedBitmap:Landroid/graphics/drawable/BitmapDrawable;
    ...
    .line 122
    invoke-static {v15, v11}, Lorg/telegram/messenger/ImageLocation;->getForChat(Lorg/telegram/tgnet/TLRPC$Chat;I)Lorg/telegram/messenger/ImageLocation;

    move-result-object v14

    invoke-virtual {v6, v14, v10, v3, v15}, Lorg/telegram/ui/Components/BackupImageView;->setImage(Lorg/telegram/messenger/ImageLocation;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/Object;)V
    ...
    .line 126
    iget-object v11, v14, Lorg/telegram/tgnet/TLRPC$User;->photo:Lorg/telegram/tgnet/TLRPC$UserProfilePhoto;

    if-eqz v11, :cond_9

    iget-object v11, v11, Lorg/telegram/tgnet/TLRPC$UserProfilePhoto;->strippedBitmap:Landroid/graphics/drawable/BitmapDrawable;
    ...
    const-string v10, "SavedMessages"
    ...
    invoke-virtual {v3, v11, v14}, Lorg/telegram/ui/Components/AvatarDrawable;->setInfo(ILorg/telegram/tgnet/TLRPC$User;)V

    const/4 v15, 0x1

    .line 140
    invoke-static {v14, v15}, Lorg/telegram/messenger/ImageLocation;->getForUser(Lorg/telegram/tgnet/TLRPC$User;I)Lorg/telegram/messenger/ImageLocation;

    move-result-object v11

    invoke-virtual {v6, v11, v10, v3, v14}, Lorg/telegram/ui/Components/BackupImageView;->setImage(Lorg/telegram/messenger/ImageLocation;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/Object;)V
    ...
    invoke-virtual {v3, v7, v14}, Lorg/telegram/ui/Components/AvatarDrawable;->setInfo(ILorg/telegram/tgnet/TLRPC$User;)V
    ...
    invoke-virtual {v6, v3, v10, v11, v14}, Lorg/telegram/ui/Components/BackupImageView;->setImage(Lorg/telegram/messenger/ImageLocation;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/Object;)V
    ...
    invoke-virtual {v6, v7, v3}, Lorg/telegram/ui/Components/BackupImageView;->setSize(II)V
    ...
    invoke-direct {v3, v7, v10}, Landroid/graphics/PorterDuffColorFilter;-><init>(ILandroid/graphics/PorterDuff$Mode;)V

    invoke-virtual {v6, v3}, Lorg/telegram/ui/Components/BackupImageView;->setColorFilter(Landroid/graphics/ColorFilter;)V

    .line 152
    sget v3, Lorg/telegram/messenger/R$string;->AllChats:I

    const-string v6, "AllChats"
    ...
    invoke-direct {v3, v4, v12, v8, v0}, Lorg/telegram/ui/Components/BackButtonMenu$$ExternalSyntheticLambda0;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Lorg/telegram/ui/Components/BackButtonMenu$PulledDialog;Lorg/telegram/ui/ActionBar/INavigationLayout;Lorg/telegram/ui/ActionBar/BaseFragment;)V
    ...
    invoke-virtual {v1, v3, v7}, Landroid/widget/FrameLayout;->setTag(ILjava/lang/Object;)V
