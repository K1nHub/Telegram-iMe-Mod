...
.method public setGiftLinkToUserText(JLorg/telegram/messenger/Utilities$Callback;)V
    ...
    sget v3, Lorg/telegram/messenger/R$string;->BoostingGiftLink:I

    const/4 v4, 0x0

    new-array v5, v4, [Ljava/lang/Object;

    const-string v6, "BoostingGiftLink"
    ...
    :try_start_0
    const-string v3, "BoostingLinkAllowsToUser"

    .line 182
    sget v5, Lorg/telegram/messenger/R$string;->BoostingLinkAllowsToUser:I
    ...
    invoke-virtual {v6, p1}, Lorg/telegram/messenger/MessagesController;->getUser(Ljava/lang/Long;)Lorg/telegram/tgnet/TLRPC$User;
    ...
    iget-object v7, p0, Lorg/telegram/ui/Components/Premium/boosts/cells/HeaderCell;->subtitleView:Lorg/telegram/ui/Components/LinkSpanDrawable$LinksTextView;
    ...
    invoke-static {v6, v7, v8, v4}, Lorg/telegram/messenger/Emoji;->replaceEmoji(Ljava/lang/CharSequence;Landroid/graphics/Paint$FontMetricsInt;IZ)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, p3, p1}, Lorg/telegram/ui/Components/Premium/boosts/cells/HeaderCell$$ExternalSyntheticLambda0;-><init>(Lorg/telegram/messenger/Utilities$Callback;Lorg/telegram/tgnet/TLRPC$User;)V
    ...
    .line 192
    invoke-static {p2, v0, v4, v1, p1}, Lorg/telegram/messenger/AndroidUtilities;->replaceSingleTag(Ljava/lang/String;IILjava/lang/Runnable;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)Landroid/text/SpannableStringBuilder;
