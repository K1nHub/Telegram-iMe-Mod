...
.method public getViewAt(I)Landroid/widget/RemoteViews;
    ...
    :try_start_1
    iget-wide v3, v9, Lorg/telegram/tgnet/TLRPC$Chat;->id:J

    invoke-static {v10, v3, v4}, Lorg/telegram/messenger/ChatObject;->isTemplatesChat(IJ)Z
    ...
    invoke-direct {v0, v10, v3, v3}, Landroid/graphics/BitmapShader;-><init>(Landroid/graphics/Bitmap;Landroid/graphics/Shader$TileMode;Landroid/graphics/Shader$TileMode;)V

    .line 169
    iget-object v3, v1, Lorg/telegram/messenger/ContactsRemoteViewsFactory;->roundPaint:Landroid/graphics/Paint;
    ...
    iput-object v3, v1, Lorg/telegram/messenger/ContactsRemoteViewsFactory;->roundPaint:Landroid/graphics/Paint;
    ...
    iput-object v3, v1, Lorg/telegram/messenger/ContactsRemoteViewsFactory;->bitmapRect:Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v9, v9, v3, v4}, Landroid/graphics/RectF;->set(FFFF)V
    ...
    invoke-virtual {v14, v0, v3, v4, v9}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 196
    sget v3, Lorg/telegram/messenger/R$id;->contacts_widget_item_badge1:I

    goto :goto_e

    :cond_16
    sget v3, Lorg/telegram/messenger/R$id;->contacts_widget_item_badge2:I
    ...
    invoke-virtual {v5, v0, v3}, Landroid/widget/RemoteViews;->setViewVisibility(II)V
