...
# direct methods
.method public static synthetic $r8$lambda$7dYNWFvbKIyGVJU7hMkUCbpJf3I(Lorg/telegram/messenger/TranslateController;Lorg/telegram/messenger/TranslateController$PendingTranslation;JLorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$TL_error;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lorg/telegram/messenger/TranslateController;->lambda$pushToTranslate$14(Lorg/telegram/messenger/TranslateController$PendingTranslation;JLorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$TL_error;)V

    return-void
.end method

.method public static synthetic $r8$lambda$9w1MmtFC_Kxbx1lmEO1L0-sbAnM(Lorg/telegram/messenger/TranslateController;JLorg/telegram/messenger/TranslateController$PendingTranslation;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lorg/telegram/messenger/TranslateController;->lambda$pushToTranslate$15(JLorg/telegram/messenger/TranslateController$PendingTranslation;)V
...
.method public static synthetic $r8$lambda$RvM_pmZHUYtWwnXf4d9FfCxKXOU(Lorg/telegram/messenger/TranslateController;J)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lorg/telegram/messenger/TranslateController;->lambda$checkDialogTranslatable$12(J)V
...
.method public static synthetic $r8$lambda$z4EzhOYUtVHwdeY_CMGGDXzFdKY(Lorg/telegram/messenger/TranslateController;Lorg/telegram/messenger/TranslateController$PendingTranslation;Lorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$TL_error;J)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lorg/telegram/messenger/TranslateController;->lambda$pushToTranslate$13(Lorg/telegram/messenger/TranslateController$PendingTranslation;Lorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$TL_error;J)V
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v76, "ro"

    const-string/jumbo v77, "ru"

    const-string/jumbo v78, "sm"

    const-string v79, "gd"

    const-string/jumbo v80, "sr"

    const-string/jumbo v81, "st"

    const-string/jumbo v82, "sn"

    const-string/jumbo v83, "sd"

    const-string/jumbo v84, "si"

    const-string/jumbo v85, "sk"

    const-string/jumbo v86, "sl"

    const-string/jumbo v87, "so"

    const-string v88, "es"

    const-string/jumbo v89, "su"

    const-string/jumbo v90, "sw"

    const-string/jumbo v91, "sv"

    const-string/jumbo v92, "tl"

    const-string/jumbo v93, "tg"

    const-string/jumbo v94, "ta"

    const-string/jumbo v95, "tt"

    const-string/jumbo v96, "te"

    const-string/jumbo v97, "th"

    const-string/jumbo v98, "tr"

    const-string/jumbo v99, "tk"

    const-string/jumbo v100, "uk"

    const-string/jumbo v101, "ur"

    const-string/jumbo v102, "ug"

    const-string/jumbo v103, "uz"

    const-string/jumbo v104, "vi"

    const-string v105, "cy"

    const-string/jumbo v106, "xh"

    const-string/jumbo v107, "yi"

    const-string/jumbo v108, "yo"

    const-string/jumbo v109, "zu"
...
.method private checkLanguage(Lorg/telegram/messenger/MessageObject;)V
    ...
    .line 600
    invoke-virtual {p0, v7, v8}, Lorg/telegram/messenger/TranslateController;->isDialogTranslatable(J)Z
    ...
    .line 603
    :cond_3
    iget-object v1, p0, Lorg/telegram/messenger/TranslateController;->pendingLanguageChecks:Ljava/util/ArrayList;
    ...
    iget-object v9, v1, Lorg/telegram/tgnet/TLRPC$Message;->message:Ljava/lang/String;

    new-instance v10, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda14;
    ...
    new-instance v11, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda13;

    move-object v1, v11

    invoke-direct/range {v1 .. v6}, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda13;-><init>(Lorg/telegram/messenger/TranslateController;Lorg/telegram/messenger/MessageObject;JI)V

    invoke-static {v9, v10, v11}, Lorg/telegram/messenger/LanguageDetector;->detectLanguage(Ljava/lang/String;Lorg/telegram/messenger/LanguageDetector$StringCallback;Lorg/telegram/messenger/LanguageDetector$ExceptionCallback;)V
...
.method private checkTranslation(Lorg/telegram/messenger/MessageObject;ZZ)V
    ...
    .line 484
    new-instance p2, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda15;
    ...
    invoke-direct/range {v1 .. v6}, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda15;-><init>(Lorg/telegram/messenger/TranslateController;Lorg/telegram/messenger/MessageObject;ZJ)V
...
.method public static getLanguages()Ljava/util/ArrayList;
    ...
    .line 299
    new-instance v2, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda10;

    invoke-direct {v2, v1}, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda10;-><init>(Landroid/icu/text/Collator;)V
    ...
    .line 301
    :cond_2
    sget-object v1, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda12;->INSTANCE:Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda12;
...
.method public static getLocales()Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v0}, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda11;-><init>(Lorg/telegram/messenger/LocaleController$LocaleInfo;)V
...
.method private synthetic lambda$checkDialogTranslatable$12(J)V
    .locals 3
...
.method private synthetic lambda$pushToTranslate$13(Lorg/telegram/messenger/TranslateController$PendingTranslation;Lorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$TL_error;J)V
    .locals 6
...
.method private synthetic lambda$pushToTranslate$14(Lorg/telegram/messenger/TranslateController$PendingTranslation;JLorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$TL_error;)V
    .locals 8
    ...
    invoke-direct/range {v0 .. v6}, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda9;-><init>(Lorg/telegram/messenger/TranslateController;Lorg/telegram/messenger/TranslateController$PendingTranslation;Lorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$TL_error;J)V
...
.method private synthetic lambda$pushToTranslate$15(JLorg/telegram/messenger/TranslateController$PendingTranslation;)V
    .locals 3
    ...
    new-instance v2, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda16;

    invoke-direct {v2, p0, p3, p1, p2}, Lorg/telegram/messenger/TranslateController$$ExternalSyntheticLambda16;-><init>(Lorg/telegram/messenger/TranslateController;Lorg/telegram/messenger/TranslateController$PendingTranslation;J)V
