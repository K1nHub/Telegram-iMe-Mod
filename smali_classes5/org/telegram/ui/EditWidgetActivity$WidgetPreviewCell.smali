...
.method public updateDialogs()V
    ...
    invoke-virtual {v0, v14, v14, v10, v11}, Landroid/graphics/RectF;->set(FFFF)V

    move-object v0, v3

    .line 331
    iget-object v10, v1, Lorg/telegram/ui/EditWidgetActivity$WidgetPreviewCell;->bitmapRect:Landroid/graphics/RectF;
    ...
    invoke-virtual {v4, v10, v11, v7, v14}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    iget-wide v10, v2, Lorg/telegram/tgnet/TLRPC$Dialog;->id:J
    ...
    .line 417
    :goto_15
    invoke-virtual {v8, v6, v10}, Ljava/lang/String;->replace(CC)Ljava/lang/String;
    ...
    invoke-virtual {v6, v0, v8, v10, v11}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
    :try_end_1
    ...
    .line 429
    :goto_17
    invoke-virtual {v11, v6, v10}, Ljava/lang/String;->replace(CC)Ljava/lang/String;
    ...
    invoke-virtual {v8, v0, v6, v3, v4}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
    :try_end_2
    ...
    iput-wide v10, v7, Lorg/telegram/tgnet/TLRPC$Dialog;->id:J
    ...
    invoke-virtual {v3, v13, v9}, Lorg/telegram/messenger/FileLoader;->getPathToAttach(Lorg/telegram/tgnet/TLObject;Z)Ljava/io/File;
    ...
    .line 578
    invoke-virtual {v15, v9}, Landroid/graphics/Bitmap;->eraseColor(I)V
    ...
    invoke-direct {v3, v8}, Lorg/telegram/ui/Components/AvatarDrawable;-><init>(Lorg/telegram/tgnet/TLRPC$Chat;)V
    ...
    invoke-static {v9, v12, v13}, Lorg/telegram/messenger/ChatObject;->isTemplatesChat(IJ)Z
    ...
    .line 597
    :goto_30
    invoke-virtual {v3, v8, v8, v14, v14}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    .line 598
    invoke-virtual {v3, v0}, Lorg/telegram/ui/Components/AvatarDrawable;->draw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {v8, v3, v9, v9}, Landroid/graphics/BitmapShader;-><init>(Landroid/graphics/Bitmap;Landroid/graphics/Shader$TileMode;Landroid/graphics/Shader$TileMode;)V
    ...
    .line 605
    iget-object v8, v1, Lorg/telegram/ui/EditWidgetActivity$WidgetPreviewCell;->bitmapRect:Landroid/graphics/RectF;
    ...
    :try_start_7
    invoke-virtual {v8, v13, v13, v9, v12}, Landroid/graphics/RectF;->set(FFFF)V
    ...
    invoke-virtual {v0, v8, v9, v3, v12}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    sget v7, Lorg/telegram/messenger/R$id;->contacts_widget_item_badge_bg1:I

    goto :goto_38

    :cond_5a
    sget v7, Lorg/telegram/messenger/R$id;->contacts_widget_item_badge_bg2:I
