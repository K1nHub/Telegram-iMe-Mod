...
.method public constructor <init>(Landroid/content/Context;Lorg/telegram/tgnet/TLRPC$Chat;Z)V
    ...
    const-string/jumbo v3, "voipgroup_inviteMembersBackground"
    ...
    const-string/jumbo v8, "voipgroup_nameText"
    ...
    sget v9, Lorg/telegram/messenger/R$string;->VoipRecordStart:I

    const-string v10, "VoipRecordStart"
    ...
    invoke-static {v9, v2, v8}, Lorg/telegram/ui/ActionBar/Theme;->createSimpleSelectorRoundRectDrawable(III)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    invoke-virtual {v3, v8}, Landroid/widget/TextView;->setForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v3, v2, v9, v2, v8}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    invoke-static {v10, v4, v9}, Lorg/telegram/ui/Components/LayoutHelper;->createFrame(III)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 225
    :goto_5
    iget-object v4, v0, Lorg/telegram/ui/Components/GroupCallRecordAlert;->titles:[Landroid/widget/TextView;
    ...
    invoke-virtual {v4, v9, v2, v8, v2}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    .line 233
    iget-object v4, v0, Lorg/telegram/ui/Components/GroupCallRecordAlert;->titlesLayout:Landroid/widget/LinearLayout;
    ...
    const-string v9, "VoipRecordAudio"
    ...
    const-string v9, "VoipRecordPortrait"
    ...
    const-string v9, "VoipRecordLandscape"
