...
.method public constructor <init>(Landroid/content/Context;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;I)V
    ...
    const-string/jumbo p2, "windowBackgroundWhiteGrayText"
...
.method private buildThemeParams()Lorg/json/JSONObject;
    ...
    const-string/jumbo v2, "theme_params"
...
.method private notifyThemeChanged()V
    ...
    const-string/jumbo v1, "theme_changed"
...
.method private onEventReceived(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :sswitch_0
    const-string/jumbo v6, "web_app_expand"
    ...
    :sswitch_1
    const-string/jumbo v6, "web_app_set_background_color"
    ...
    :sswitch_2
    const-string/jumbo v6, "web_app_set_header_color"
    ...
    :sswitch_3
    const-string/jumbo v6, "web_app_setup_main_button"
    ...
    :sswitch_4
    const-string/jumbo v6, "web_app_trigger_haptic_feedback"
    ...
    :sswitch_5
    const-string/jumbo v6, "web_app_setup_back_button"
    ...
    :sswitch_6
    const-string/jumbo v6, "web_app_data_send"
    ...
    :sswitch_7
    const-string/jumbo v6, "web_app_read_text_from_clipboard"
    ...
    :sswitch_8
    const-string/jumbo v6, "web_app_ready"
    ...
    :sswitch_9
    const-string/jumbo v6, "web_app_close"
    ...
    :sswitch_a
    const-string/jumbo v6, "web_app_open_tg_link"
    ...
    :sswitch_b
    const-string/jumbo v6, "web_app_request_viewport"
    ...
    :sswitch_c
    const-string/jumbo v6, "web_app_request_theme"
    ...
    :sswitch_d
    const-string/jumbo v6, "web_app_request_phone"
    ...
    :sswitch_e
    const-string/jumbo v6, "web_app_open_scan_qr_popup"
    ...
    :sswitch_f
    const-string/jumbo v6, "web_app_setup_closing_behavior"
    ...
    :sswitch_10
    const-string/jumbo v6, "web_app_open_invoice"
    ...
    :sswitch_11
    const-string/jumbo v6, "web_app_open_popup"
    ...
    :sswitch_12
    const-string/jumbo v6, "web_app_open_link"
    ...
    :sswitch_13
    const-string/jumbo v6, "web_app_close_scan_qr_popup"
    ...
    :cond_1f
    const-string/jumbo v3, "selection_change"
    ...
    const-string/jumbo v3, "try_instant_view"
...
.method public loadFlickerAndSettingsItem(IJLorg/telegram/ui/ActionBar/ActionBarMenuSubItem;)V
    ...
    const-string/jumbo p3, "windowBackgroundGray"
...
.method public restoreButtonData()V
    ...
    const-string/jumbo v1, "web_app_setup_main_button"
