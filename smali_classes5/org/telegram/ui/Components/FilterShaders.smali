...
.method private static fragmentShaderForOptimizedBlurOfRadius(IF)Ljava/lang/String;
    ...
    const-string/jumbo v7, "uniform sampler2D sourceImage;\n"

    .line 186
    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v7, "uniform highp float texelWidthOffset;\n"

    .line 187
    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v7, "uniform highp float texelHeightOffset;\n"
    ...
    const-string/jumbo v9, "varying highp vec2 blurCoordinates[%d];\n"
    ...
    const-string/jumbo v8, "void main()\n"
    ...
    const-string/jumbo v9, "sum += texture2D(sourceImage, blurCoordinates[0]) * %f;\n"
    ...
    const-string/jumbo v9, "sum += texture2D(sourceImage, blurCoordinates[%d]) * %f;\n"
    ...
    const-string/jumbo v10, "sum += texture2D(sourceImage, blurCoordinates[0] + singleStepOffset * %f) * %f;\n"
    ...
    const-string/jumbo v9, "sum += texture2D(sourceImage, blurCoordinates[0] - singleStepOffset * %f) * %f;\n"
...
.method public static loadShader(ILjava/lang/String;)I
    ...
    const-string/jumbo v1, "shader code:\n "
...
.method private static vertexShaderForOptimizedBlurOfRadius(IF)Ljava/lang/String;
    ...
    const-string/jumbo v6, "uniform float texelWidthOffset;\n"

    .line 150
    invoke-virtual {v0, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v6, "uniform float texelHeightOffset;\n"
    ...
    const-string/jumbo v8, "varying vec2 blurCoordinates[%d];\n"
    ...
    const-string/jumbo v6, "vec2 singleStepOffset = vec2(texelWidthOffset, texelHeightOffset);\n"
...
.method public create()Z
    ...
    const-string/jumbo v12, "sourceImage"
    ...
    const-string/jumbo v13, "vignette"
    ...
    const-string/jumbo v13, "skipTone"
    ...
    const-string/jumbo v13, "shadowsTintIntensity"
    ...
    const-string/jumbo v13, "shadowsTintColor"
    ...
    const-string/jumbo v13, "sharpen"
    ...
    :goto_2
    const-string/jumbo v15, "sampler2D"

    if-eqz v7, :cond_4

    const-string/jumbo v7, "samplerExternalOES"
    ...
    :goto_7
    const-string/jumbo v11, "videoMatrix"
    ...
    const-string/jumbo v2, "toneCurveTexture"
