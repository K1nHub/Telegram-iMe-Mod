...
.method public constructor <init>(Lorg/telegram/ui/ActionBar/BaseFragment;Landroid/content/Context;ZLjava/lang/Integer;IZLorg/telegram/ui/ActionBar/Theme$ResourcesProvider;II)V
    ...
    invoke-virtual {v11, v2, v0, v1, v5}, Landroid/widget/FrameLayout;->setPadding(IIII)V
    ...
    invoke-virtual {v0, v7}, Landroid/widget/FrameLayout;->setElevation(F)V
    ...
    .line 659
    :goto_1d
    invoke-virtual {v0, v3}, Lorg/telegram/ui/Components/EmojiTabsStrip;->setPaddingLeft(F)V
    ...
    .line 661
    iget-object v4, v11, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->contentView:Landroid/widget/FrameLayout;
    ...
    .line 663
    :goto_1e
    iget-object v4, v11, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->cachedEmojiTabs:[Lorg/telegram/ui/Components/EmojiTabsStrip;
    ...
    invoke-virtual {v0, v4, v2, v6, v9}, Landroid/view/ViewGroup;->setPadding(IIII)V
...
.method private updateRows(ZZZ)V
    ...
    iget v15, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->currentAccount:I
    ...
    invoke-virtual {v15, v2}, Lorg/telegram/messenger/MediaDataController;->getRecentStickersNoCopy(I)Ljava/util/ArrayList;
    ...
    .line 3275
    :goto_3
    iget-object v15, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->recentStickers:Ljava/util/ArrayList;
    ...
    .line 3276
    iget-object v15, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->rowHashCodes:Ljava/util/ArrayList;
    ...
    iget-object v15, v2, Lorg/telegram/tgnet/TLRPC$TL_emojiList;->document_id:Ljava/util/ArrayList;
    ...
    iget-wide v14, v5, Lorg/telegram/tgnet/TLRPC$Document;->id:J
    ...
    invoke-direct {v9, v14, v8}, Lorg/telegram/ui/Components/AnimatedEmojiSpan;-><init>(Lorg/telegram/tgnet/TLRPC$Document;Landroid/graphics/Paint$FontMetricsInt;)V
    ...
    iget-object v14, v2, Lorg/telegram/tgnet/TLRPC$TL_emojiList;->document_id:Ljava/util/ArrayList;
    ...
    iget-object v5, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->recentReactionsToSet:Ljava/util/List;
    ...
    .line 3358
    iget-object v5, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->topReactions:Ljava/util/ArrayList;
    ...
    .line 3370
    iput v5, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->topReactionsEndRow:I
    ...
    iget-wide v14, v12, Lorg/telegram/ui/Components/Reactions/ReactionsLayoutInBubble$VisibleReaction;->hash:J
    ...
    :goto_19
    invoke-virtual {v5, v9, v13}, Lorg/telegram/messenger/MediaDataController;->getStickerSet(Lorg/telegram/tgnet/TLRPC$InputStickerSet;Z)Lorg/telegram/tgnet/TLRPC$TL_messages_stickerSet;
    ...
    invoke-virtual {v9}, Lorg/telegram/messenger/MediaDataController;->getDefaultChannelEmojiStatuses()Ljava/util/ArrayList;

    move-result-object v9

    .line 3415
    :goto_1a
    iget-object v10, v5, Lorg/telegram/tgnet/TLRPC$messages_StickerSet;->documents:Ljava/util/ArrayList;
    ...
    .line 3416
    :goto_1b
    iget-object v12, v5, Lorg/telegram/tgnet/TLRPC$messages_StickerSet;->documents:Ljava/util/ArrayList;
    ...
    iget-object v15, v5, Lorg/telegram/tgnet/TLRPC$messages_StickerSet;->documents:Ljava/util/ArrayList;
    ...
    invoke-direct {v14, v15, v8}, Lorg/telegram/ui/Components/AnimatedEmojiSpan;-><init>(Lorg/telegram/tgnet/TLRPC$Document;Landroid/graphics/Paint$FontMetricsInt;)V
    ...
    iget-boolean v14, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->includeEmpty:Z
    ...
    invoke-direct {v12, v14, v15, v8}, Lorg/telegram/ui/Components/AnimatedEmojiSpan;-><init>(JLandroid/graphics/Paint$FontMetricsInt;)V
    ...
    iget-boolean v5, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->recentExpanded:Z
    ...
    .line 3490
    iget-object v15, v14, Lorg/telegram/tgnet/TLRPC$messages_StickerSet;->set:Lorg/telegram/tgnet/TLRPC$StickerSet;
    ...
    .line 3493
    :cond_3d
    iget v15, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->type:I
    ...
    if-ne v15, v8, :cond_3f

    :cond_3e
    invoke-static {v14}, Lorg/telegram/messenger/MessageObject;->isTextColorSet(Lorg/telegram/tgnet/TLRPC$TL_messages_stickerSet;)Z
    ...
    :cond_40
    iget-object v8, v14, Lorg/telegram/tgnet/TLRPC$messages_StickerSet;->set:Lorg/telegram/tgnet/TLRPC$StickerSet;

    iget-boolean v8, v8, Lorg/telegram/tgnet/TLRPC$StickerSet;->channel_emoji_status:Z
    ...
    iget-boolean v15, v8, Lorg/telegram/tgnet/TLRPC$StickerSet;->emojis:Z

    if-nez v15, :cond_42

    iget-boolean v15, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->showStickers:Z

    if-eqz v15, :cond_43

    :cond_42
    iget-object v15, v0, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->installedEmojiSets:Ljava/util/ArrayList;
    ...
    iget-object v11, v14, Lorg/telegram/tgnet/TLRPC$messages_StickerSet;->set:Lorg/telegram/tgnet/TLRPC$StickerSet;
    ...
    .line 3506
    iput-boolean v13, v8, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->installed:Z
    ...
    .line 3508
    iput-boolean v13, v8, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->expanded:Z

    .line 3509
    invoke-static {v14}, Lorg/telegram/messenger/MessageObject;->isPremiumEmojiPack(Lorg/telegram/tgnet/TLRPC$TL_messages_stickerSet;)Z
    ...
    iput-object v11, v8, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->set:Lorg/telegram/tgnet/TLRPC$StickerSet;

    .line 3511
    iget-object v11, v14, Lorg/telegram/tgnet/TLRPC$messages_StickerSet;->documents:Ljava/util/ArrayList;

    invoke-direct {v0, v11, v4}, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->filter(Ljava/util/ArrayList;Ljava/util/HashSet;)Ljava/util/ArrayList;

    move-result-object v11

    iput-object v11, v8, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->documents:Ljava/util/ArrayList;
    ...
    iget-object v12, v8, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->documents:Ljava/util/ArrayList;
    ...
    iget-object v14, v8, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->documents:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v8, v2, v13}, Lorg/telegram/messenger/MediaDataController;->getStickerSet(Lorg/telegram/tgnet/TLRPC$InputStickerSet;Ljava/lang/Integer;Z)Lorg/telegram/tgnet/TLRPC$TL_messages_stickerSet;
    ...
    invoke-virtual {v9, v14, v15}, Landroid/util/SparseIntArray;->put(II)V
    ...
    .line 3569
    iput-boolean v13, v9, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->featured:Z
    ...
    .line 3572
    invoke-direct {v0, v8, v4}, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->filter(Ljava/util/ArrayList;Ljava/util/HashSet;)Ljava/util/ArrayList;

    move-result-object v2

    iput-object v2, v9, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->documents:Ljava/util/ArrayList;
    ...
    iget-object v14, v9, Lorg/telegram/ui/Components/EmojiView$EmojiPack;->documents:Ljava/util/ArrayList;
...
.method public onEmojiClick(Landroid/view/View;Lorg/telegram/ui/Components/AnimatedEmojiSpan;)V
    ...
    iput-wide v4, v1, Lorg/telegram/tgnet/TLRPC$TL_emojiStatus;->document_id:J
    ...
    invoke-virtual {v5, v1}, Lorg/telegram/messenger/MediaDataController;->pushRecentEmojiStatus(Lorg/telegram/tgnet/TLRPC$EmojiStatus;)V
    ...
    invoke-virtual {p0, p1, p2, v4, v0}, Lorg/telegram/ui/SelectAnimatedEmojiDialog;->onEmojiSelected(Landroid/view/View;Ljava/lang/Long;Lorg/telegram/tgnet/TLRPC$Document;Ljava/lang/Integer;)V
    ...
    invoke-direct {v1, p0, p1, p2, v4}, Lorg/telegram/ui/SelectAnimatedEmojiDialog$$ExternalSyntheticLambda20;-><init>(Lorg/telegram/ui/SelectAnimatedEmojiDialog;Landroid/view/View;Lorg/telegram/ui/Components/AnimatedEmojiSpan;Lorg/telegram/tgnet/TLRPC$Document;)V
